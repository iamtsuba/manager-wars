...
Cette action est irréversible.`))return;const o=document.getElementById("fix-old-faces-btn");o&&(o.disabled=!0,o.textContent="⏳ En cours...");try{const{data:l,error:a}=await _.from("players").select("id, country_code, face").like("face","public/faces/%");if(a){n(a.message,"error");return}if(!(l!=null&&l.length)){n("Aucun joueur avec l'ancien format — rien à faire ✅","success");return}const{data:m}=await _.from("players").select("face").not("face","is",null),p=new Set((m||[]).map(u=>u.face).filter(u=>u&&!u.startsWith("public/faces/")));let h=0,i=0;for(const u of l){const r=await _e(u.country_code,p);if(!r){i++;continue}const{error:g}=await _.from("players").update({face:r}).eq("id",u.id);if(g){i++;continue}p.add(r),h++}n(`${h} photo(s) réattribuée(s)${i?`, ${i} échec(s)`:""} ✅`,i?"error":"success")}finally{o&&(o.disabled=!1,o.textContent="🖼️ Réattribuer anciennes photos")}}async function Pt(e,t){await se(e,t)}async function se(e,t,n=null){var i,u,r,g,y;const{toast:o}=t;n||(n={search:((i=document.getElementById("search-players"))==null?void 0:i.value)||"",job:((u=document.getElementById("filter-job"))==null?void 0:u.value)||"",rarity:((r=document.getElementById("filter-rarity"))==null?void 0:r.value)||"",club:((g=document.getElementById("filter-club"))==null?void 0:g.value)||"",country:((y=document.getElementById("filter-country"))==null?void 0:y.value)||""});const[{data:l,error:a},{data:m}]=await Promise.all([_.from("players").select("*, clubs(id,encoded_name,logo_url)"),_.from("clubs").select("id,encoded_name").order("encoded_name")]);if(a){e.innerHTML=`<p style="color:red">${a.message}</p>`;return}const p={GK:0,DEF:1,MIL:2,ATT:3},h=(l||[]).sort((s,f)=>{const d=(p[s.job]??4)-(p[f.job]??4);return d!==0?d:(s.surname_real||"").localeCompare(f.surname_real||"")});Ft(e,h,m||[],t,n)}function Ft(e,t,n,o,l=null){var u,r;const{toast:a}=o;if(e.innerHTML=`
    ...
    </div>`,m(re),document.getElementById("search-clubs").addEventListener("input",p=>{const h=p.target.value.toLowerCase();m(re.filter(i=>i.real_name.toLowerCase().includes(h)||i.encoded_name.toLowerCase().includes(h)))}),document.getElementById("add-club-btn").addEventListener("click",()=>je(null,e,t));function m(p){const h=document.getElementById("clubs-list");if(!p.length){h.innerHTML='<p style="color:var(--tile-fg-dim);padding:20px;text-align:center">Aucun club.</p>';return}h.innerHTML=p.map(i=>{const u=st(i),r=i.logo_url?`<img src="${i.logo_url}" style="width:36px;height:36px;object-fit:contain;border-radius:8px;flex-shrink:0">`:`<div style="width:36px;height:36px;background:linear-gradient(135deg,${u.color1},${u.color2});border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:9px;font-weight:900;flex-shrink:0">${i.encoded_name.slice(0,3)}</div>`,g=n[i.id]||0;return`
      ...
      <div style="border-top:1px solid var(--tile-border);padding-top:12px">
        ...
        <div style="display:flex;gap:12px;align-items:flex-start;flex-wrap:wrap">
          <div style="flex:1;min-width:200px;display:flex;flex-direction:column;gap:8px">
            ...
            ${[["Couleur 1","m-kit-color1",a.color1,!1],["Couleur 2","m-kit-color2",a.color2,!1],["Couleur 3","m-kit-color3",a.color3,!0],["Short","m-kit-shorts",a.shorts,!1],["Chaussettes","m-kit-socks",a.socks,!1]].map(([c,x,w,k])=>`
  ...
  `,(d=document.getElementById("m-logo-file"))==null||d.addEventListener("change",c=>{var k;const x=(k=c.target.files)==null?void 0:k[0];if(!x)return;const w=new FileReader;w.onload=()=>{document.getElementById("logo-preview").innerHTML=`<img src="${w.result}" style="width:100%;height:100%;object-fit:contain">`},w.readAsDataURL(x)}),ne();function i(){var k,L;const c=((k=document.getElementById("m-kit-style"))==null?void 0:k.value)||"uni",x=((L=Me[c])==null?void 0:L.colors)===3,w=document.getElementById("wrap-m-kit-color3");w&&(w.style.display=x?"":"none")}i(),["m-kit-color1","m-kit-color2","m-kit-color3","m-kit-shorts","m-kit-socks"].forEach(c=>{const x=document.getElementById(c),w=document.getElementById(c+"-txt");!x||!w||(x.addEventListener("input",()=>{w.value=x.value,ne()}),w.addEventListener("input",()=>{const k=w.value.trim();/^#[0-9a-fA-F]{6}$/.test(k)&&(x.value=k,ne())}),w.addEventListener("change",()=>{let k=w.value.trim();k.startsWith("#")||(k="#"+k),/^#[0-9a-fA-F]{6}$/.test(k)&&(x.value=k,w.value=k,ne())}))}),(b=document.getElementById("m-kit-style"))==null||b.addEventListener("change",()=>{i(),ne()});const u=document.getElementById("m-real"),r=document.getElementById("m-encoded");function g(){if(!u||!r||r.value)return;const c=u.value.trim().split(/\s+/),x=c.length===1?c[0].toUpperCase().slice(0,6):c.filter(w=>w.length>2).map(w=>w[0].toUpperCase()).join("")||c[0].toUpperCase().slice(0,4);r.value=x}u==null||u.addEventListener("input",g),(I=document.getElementById("auto-encode-btn"))==null||I.addEventListener("click",()=>{r&&(r.value=""),g()}),($=document.getElementById("m-save"))==null||$.addEventListener("click",()=>an(e,l,t,n));const y=document.getElementById("m-gen-squad"),s=document.getElementById("m-gen-strong-label");function f(){if(s&&(s.style.display=y!=null&&y.checked?"flex":"none",!(y!=null&&y.checked))){const c=document.getElementById("m-gen-strong");c&&(c.checked=!1)}}y==null||y.addEventListener("change",f),f(),(E=document.getElementById("btn-gen-squad-panel"))==null||E.addEventListener("click",()=>{Xt(e,n,t)}),(v=document.getElementById("btn-gen-one-player"))==null||v.addEventListener("click",()=>{tn(e,n)}),l&&$e(e.id)}async function $e(e){const{data:t}=await _.from("players").select("*, clubs(encoded_name, logo_url, kit_style, kit_color1, kit_color2, kit_color3, kit_shorts, kit_socks)").eq("club_id",e).order("surname_real"),n=document.getElementById("club-players-grid"),o=document.getElementById("club-players-count");if(o&&(o.textContent=(t||[]).length),!!n){if(!(t!=null&&t.length)){n.innerHTML='<div style="color:var(--tile-fg-dim);padding:20px;font-size:13px">Aucun joueur dans ce club.</div>';return}n.innerHTML=t.map(l=>Ee(l,{width:100})).join("")}}function Xt(e,t,n){const{openModal:o,closeModal:l,toast:a}=t;o(`⚽ Générer — ${e.real_name}`,`<div style="display:flex;flex-direction:column;gap:14px">
...
`).replace(/\r/g,`
`);const t=e.split(`
`).filter(m=>m.trim());if(t.length<2)return[];const n=t[0],o=n.split(";").length>n.split(",").length?";":",",l=Oe(n,o).map(m=>m.trim().replace(/^\uFEFF/,"").toLowerCase()),a=[];for(let m=1;m<t.length;m++){if(!t[m].trim())continue;const p=Oe(t[m],o),h={};l.forEach((i,u)=>{h[i]=(p[u]||"").trim()}),!Object.values(h).every(i=>!i)&&a.push(h)}return a}function Oe(e,t=","){const n=[];let o="",l=!1;for(let a=0;a<e.length;a++){const m=e[a];l?m==='"'?e[a+1]==='"'?(o+='"',a++):l=!1:o+=m:m==='"'?l=!0:m===t?(n.push(o),o=""):o+=m}return n.push(o),n}const bn={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function vn(e,{toast:t}){const n=Object.keys(me);let o=n[0];const{data:l}=await _.from("formation_links_overrides").select("formation, links"),a={};(l||[]).forEach(u=>{a[u.formation]=u.links});let m=new Set;function p(u,r){return[u,r].sort().join("-")}function h(u){const r=a[u]||me[u]||[];m=new Set(r.map(([g,y])=>p(g,y)))}h(o),e.innerHTML=`
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;gap:12px;flex-wrap:wrap">
  ...
  `;function i(){const u=Mt[o]||{},r=ze(o),g=320,y=400,s=22;function f(E){const v=u[E];return v?{x:v.x*g,y:v.y*y}:null}let d=`<svg width="${g}" height="${y}" viewBox="0 0 ${g} ${y}" xmlns="http://www.w3.org/2000/svg" style="display:block">`;r.forEach(([E,v],c)=>{const x=f(E),w=f(v);if(!x||!w)return;const k=p(E,v),L=m.has(k),B=L?"#3b82f6":"#999",A=L?.95:.35,S=L?4:3;d+=`<line x1="${x.x}" y1="${x.y}" x2="${w.x}" y2="${w.y}"
        stroke="transparent" stroke-width="14" class="link-hit" data-key="${k}" style="cursor:pointer"/>`,d+=`<line x1="${x.x}" y1="${x.y}" x2="${w.x}" y2="${w.y}"
        stroke="${B}" stroke-width="${S}" stroke-dasharray="${L?"none":"4,3"}"
        opacity="${A}" pointer-events="none" data-line-key="${k}"/>`});for(const E of Object.keys(u)){const v=f(E);if(!v)continue;const c=E.replace(/\d+/,""),x=bn[c]||"#555";d+=`<circle cx="${v.x}" cy="${v.y}" r="${s}" fill="${x}" stroke="rgba(255,255,255,0.7)" stroke-width="2" pointer-events="none"/>`,d+=`<text x="${v.x}" y="${v.y+4}" text-anchor="middle" font-size="10" font-weight="900" fill="white" font-family="Arial Black,Arial" pointer-events="none">${E}</text>`}d+="</svg>",document.getElementById("field-wrap").innerHTML=d;const b=document.getElementById("links-list");b.innerHTML=r.map(([E,v])=>{const c=p(E,v),x=m.has(c);return`
    ...
    <div style="display:flex;gap:16px;height:calc(100vh - 56px);overflow:hidden;padding:16px">
      ...
      <div style="flex:1;overflow-y:auto">
        ...
        <div id="ts-list" style="display:flex;flex-direction:column;gap:10px">
          ...
          </div>`).join("")+"</div>",h.querySelectorAll("[data-pick]").forEach(L=>{L.addEventListener("click",()=>{a&&(a.value=L.dataset.pick),i(),h.style.display="none"})})}catch(c){h.innerHTML='<div style="color:#cc2222;font-size:12px">Erreur chargement : '+c.message+"</div>"}}),(E=document.getElementById("ts-color"))==null||E.addEventListener("input",c=>{const x=document.getElementById("ts-color-hex");x&&(x.value=c.target.value)}),(v=document.getElementById("ts-color-hex"))==null||v.addEventListener("input",c=>{const x=c.target.value;if(/^#[0-9a-fA-F]{6}$/.test(x)){const w=document.getElementById("ts-color");w&&(w.value=x)}}),e.querySelectorAll("[data-edit-row]").forEach(c=>{const x=(t||[]).find(w=>w.id===c.dataset.editRow);x&&c.addEventListener("click",()=>He(x))}),e.querySelectorAll("[data-delete]").forEach(c=>{c.addEventListener("click",async()=>{confirm("Supprimer cette étape ?")&&(await _.from("tutorial_steps").delete().eq("id",c.dataset.delete),W(e))})}),e.querySelectorAll("[data-toggle]").forEach(c=>{c.addEventListener("click",async()=>{const x=(t||[]).find(w=>w.id===c.dataset.toggle);x&&(await _.from("tutorial_steps").update({is_active:!x.is_active}).eq("id",x.id),W(e))})}),e.querySelectorAll("[data-up]").forEach(c=>{c.addEventListener("click",async()=>{const x=t||[],w=x.findIndex(k=>k.id===c.dataset.up);w<=0||(await Promise.all([_.from("tutorial_steps").update({step_order:x[w-1].step_order}).eq("id",x[w].id),_.from("tutorial_steps").update({step_order:x[w].step_order}).eq("id",x[w-1].id)]),W(e))})}),e.querySelectorAll("[data-down]").forEach(c=>{c.addEventListener("click",async()=>{const x=t||[],w=x.findIndex(k=>k.id===c.dataset.down);w<0||w>=x.length-1||(await Promise.all([_.from("tutorial_steps").update({step_order:x[w+1].step_order}).eq("id",x[w].id),_.from("tutorial_steps").update({step_order:x[w].step_order}).eq("id",x[w+1].id)]),W(e))})})}function Cn(e){return`
  ...
  `);const i=()=>{var x,w,k,L,B,A,S;const y=((x=document.getElementById("st-name"))==null?void 0:x.value)||"NOM DU STADE",s=(k=(w=document.getElementById("st-image"))==null?void 0:w.value)==null?void 0:k.trim(),f=(B=(L=document.getElementById("st-country"))==null?void 0:L.value)==null?void 0:B.trim(),d=document.getElementById("st-club"),b=(d==null?void 0:d.selectedIndex)||0,I=d&&b>0?d.options[b].text:"",$=((S=(A=d==null?void 0:d.options[b])==null?void 0:A.getAttribute)==null?void 0:S.call(A,"data-logo"))||"";let E=null;s?E=s.startsWith("http")?s:`${yt}icons/${s}`:$?E=$:f&&(E=`https://flagsapi.com/${f.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`);const v=I||f||"—",c=document.getElementById("st-preview-card");c&&(c.innerHTML=Qe(y,E,`${v}<br>+10 ⭐`,{width:140}))};i(),["st-name","st-club","st-country","st-image"].forEach(y=>{var s,f;(s=document.getElementById(y))==null||s.addEventListener("input",i),(f=document.getElementById(y))==null||f.addEventListener("change",i)}),(u=document.getElementById("st-cancel"))==null||u.addEventListener("click",()=>a()),(r=document.getElementById("st-save"))==null||r.addEventListener("click",async()=>{const y=document.getElementById("st-name").value.trim(),s=document.getElementById("st-club").value||null,f=document.getElementById("st-country").value.trim().toUpperCase()||null,d=document.getElementById("st-image").value.trim()||null;if(!y){m("Le nom est obligatoire","error");return}const b={name:y,club_id:s,country_code:f,image_url:d},{error:I}=e?await _.from("stadium_definitions").update(b).eq("id",e.id):await _.from("stadium_definitions").insert(b);if(I){m("Erreur : "+I.message,"error");return}m(e?"Stade modifié ✅":"Stade créé ✅","success"),a(),ve(n,o)}),(g=document.getElementById("st-delete"))==null||g.addEventListener("click",async()=>{confirm("Supprimer ce stade ?")&&(await _.from("stadium_definitions").delete().eq("id",e.id),m("Stade supprimé","success"),a(),ve(n,o))})}const H=[{value:"game_changer",label:"⚡ Game Changer",border:"#7a28b8",bg:"linear-gradient(135deg,#4a0080,#7a28b8)"},{value:"ultra_game_changer",label:"💎 Ultra Game Changer",border:"#00bcd4",bg:"linear-gradient(135deg,#006080,#00bcd4)"}],Dn=[{value:"purple",label:"Violet",hex:"#7a28b8"},{value:"light_blue",label:"Bleu clair",hex:"#00bcd4"}],G=[{value:"BOOST_STAT",label:"⚡ Boost stats (+N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"DEBUFF_STAT",label:"💀 Debuff stats (-N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"GRAY_PLAYER",label:"❄️ Griser un joueur",hasValue:!1,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"REVIVE_PLAYER",label:"💫 Ressusciter un joueur",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"REMOVE_GOAL",label:"🚫 Retirer un but adverse",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_GOAL_DRAW",label:"⚽ +1 but si duel nul",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_SUB",label:"🔄 Ajouter un remplacement",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"CUSTOM",label:"🛠️ Effet custom (hardcodé)",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1}],Ke=["GK","DEF","MIL","ATT"];async function Nn(e,t){await Be(e,t)}async function Be(e,t){var o;const{data:n}=await _.from("gc_definitions").select("*").order("sort_order").order("created_at");e.innerHTML=`
    ...
    <div style="display:flex;justify-content:center;margin-bottom:16px;padding:20px;background:#1a1a2e;border-radius:12px">
      <div id="gc-modal-preview">${fe(p.name||"?",p.image_url?`/icons/${p.image_url}`:null,(H.find(d=>d.value===p.gc_type)||H[0]).label.split(" ")[0],p.effect||"",{width:150})}</div>
    </div>
  ...
  `);const r=()=>{var c,x,w,k,L;const d=((c=document.getElementById("gc-name"))==null?void 0:c.value)||"?",b=((x=document.getElementById("gc-effect"))==null?void 0:x.value)||"",I=((w=document.getElementById("gc-type"))==null?void 0:w.value)||"game_changer",$=(L=(k=document.getElementById("gc-image-url"))==null?void 0:k.value)==null?void 0:L.trim(),E=H.find(B=>B.value===I)||H[0],v=document.getElementById("gc-modal-preview");v&&(v.innerHTML=fe(d,$?`/icons/${$}`:null,E.label.split(" ")[0],b,{width:150}))};["gc-name","gc-effect","gc-type","gc-image-url"].forEach(d=>{var b,I;(b=document.getElementById(d))==null||b.addEventListener("input",r),(I=document.getElementById(d))==null||I.addEventListener("change",r)}),(g=document.getElementById("gc-effect-type"))==null||g.addEventListener("change",()=>{const d=document.getElementById("gc-effect-type").value,b=G.find($=>$.value===d)||G[0],I=document.getElementById("gc-params-wrap");I.innerHTML=`
    ...
    </div>`}),(y=document.getElementById("btn-pick-gc-icon"))==null||y.addEventListener("click",async()=>{var b;const d=document.getElementById("gc-icon-picker");if(d){if(d.style.display!=="none"){d.style.display="none";return}d.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',d.style.display="block";try{const $=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),E=Array.isArray($)?$.filter(c=>c.name.startsWith("gamechanger-")&&/\.(png|jpg|svg|webp)$/i.test(c.name)):[];if(!E.length){d.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucun fichier "gamechanger-*" trouvé dans public/icons/</div>';return}const v=((b=document.getElementById("gc-image-url"))==null?void 0:b.value)||"";d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
        ${E.map(c=>`
    ...
    </div>`,(E=document.getElementById("create-season-btn"))==null||E.addEventListener("click",()=>{Ve(null,{toast:n,openModal:o,closeModal:l,reload:()=>Y(e,t)})}),e.querySelectorAll("[data-edit]").forEach(v=>{const c=h.find(x=>x.id==v.dataset.edit);v.addEventListener("click",()=>{Ve(c,{toast:n,openModal:o,closeModal:l,reload:()=>Y(e,t)})})}),e.querySelectorAll("[data-activate]").forEach(v=>{v.addEventListener("click",async()=>{const c=parseInt(v.dataset.activate);if(!confirm("Activer cette saison ? La saison actuellement active sera désactivée."))return;const{error:x}=await _.from("ranked_seasons").update({is_active:!1}).neq("id",0);if(x){n(x.message,"error");return}const{error:w}=await _.from("ranked_seasons").update({is_active:!0}).eq("id",c);if(w){n(w.message,"error");return}await _.from("users").update({current_season_id:c}).gt("placement_matches",0),n("Saison activée ✅","success"),Y(e,t)})}),e.querySelectorAll("[data-deactivate]").forEach(v=>{v.addEventListener("click",async()=>{if(!confirm("Désactiver la saison active ? Le mode Ranked sera suspendu."))return;const{error:c}=await _.from("ranked_seasons").update({is_active:!1}).eq("id",parseInt(v.dataset.deactivate));if(c){n(c.message,"error");return}n("Saison désactivée","success"),Y(e,t)})}),e.querySelectorAll("[data-delete]").forEach(v=>{v.addEventListener("click",async()=>{if(!confirm("Supprimer cette saison archivée ?"))return;const{error:c}=await _.from("ranked_seasons").delete().eq("id",parseInt(v.dataset.delete));if(c){n(c.message,"error");return}n("Saison supprimée","success"),Y(e,t)})})}function Ve(e,{toast:t,openModal:n,closeModal:o,reload:l}){const a=!!e,m=new Date().toISOString().slice(0,16),p=new Date(Date.now()+90*864e5).toISOString().slice(0,16),h=e?new Date(e.start_at).toISOString().slice(0,16):m,i=e?new Date(e.end_at).toISOString().slice(0,16):p,u=(e==null?void 0:e.name)||"";n(a?"✏️ Modifier la saison":"➕ Nouvelle saison",`<div style="display:flex;flex-direction:column;gap:14px">
      <div class="form-group">
