import{s as _,r as he,a as Ee,A as bt,l as vt,g as xt,K as Te,D as z,b as ht,S as Et,c as R,H as _t,R as wt,e as ce,d as We,f as It,h as kt,E as $t,i as Bt,N as Lt,M as At,B as St,j as Ct,F as ue,k as Me,m as Tt,n as Ze,o as ge,p as Mt}from"./special-cards-lEGt-tGs.js";async function zt(e){var h;const[{count:t},{count:n},{count:i},{count:s},{count:a},{data:m}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password")]),u=m||"";e.innerHTML=`
