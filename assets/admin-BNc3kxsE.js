import{s as y,e as Y,g as Ie,K as Be,D as S,S as Re,a as A,H as Ne,R as Pe,b as Le,r as qe,c as Oe,E as Fe,d as De,N as He,M as Ue,B as Ge,F as ie,f as pe,h as Ve,i as Ke}from"./formation-links-CBa_FAsd.js";async function Ye(e){const[{count:i},{count:t},{count:n},{count:s},{count:l}]=await Promise.all([y.from("players").select("*",{count:"exact",head:!0}),y.from("clubs").select("*",{count:"exact",head:!0}),y.from("users").select("*",{count:"exact",head:!0}),y.from("cards").select("*",{count:"exact",head:!0}),y.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
