import{s as w,r as Ne,g as Pe,K as Ee,D as S,S as tt,a as j,H as nt,R as it,e as ue,b as qe,c as ot,d as at,E as rt,f as lt,N as st,M as dt,B as ct,h as pt,F as me,i as we,j as ut,k as mt}from"./formation-links-CynTqB0k.js";async function gt(e){const[{count:t},{count:n},{count:i},{count:p},{count:d}]=await Promise.all([w.from("players").select("*",{count:"exact",head:!0}),w.from("clubs").select("*",{count:"exact",head:!0}),w.from("users").select("*",{count:"exact",head:!0}),w.from("cards").select("*",{count:"exact",head:!0}),w.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ...
      <div style="flex:1;min-width:300px;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          <div class="form-group">
            <label>Nom</label>
            <input id="pm-real" value="${(e==null?void 0:e.surname_real)||(e!=null&&e.surname_real?e.surname_real.charAt(0).toUpperCase()+e.surname_real.slice(1).toLowerCase():"")}" placeholder="Silva">
          </div>
        </div>
    ...
    <div class="card-panel">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${p.map(l=>{var s,o,r,u;const b=(s=l.card)==null?void 0:s.player,a=b?`${b.firstname} ${b.surname_real}`:((o=l.card)==null?void 0:o.card_type)||"—",f={active:"#1A6B3C",sold:"#D4A017",cancelled:"#aaa"};return`<tr>
