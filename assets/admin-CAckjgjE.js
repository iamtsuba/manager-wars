import{s as _,i as Et,r as Ee,a as _e,A as _t,l as wt,g as $t,K as Me,D as z,b as It,S as kt,c as R,H as Lt,R as At,e as ue,d as Qe,f as Bt,h as St,E as Tt,j as Ct,N as Mt,M as zt,B as Rt,k as jt,F as ge,m as ze,n as Dt,o as Xe,p as ye,q as Pt}from"./special-cards-DHf0qDdw.js";async function et(e){var o;const[{count:t},{count:n},{count:i},{count:c},{count:l},{data:g},{data:x}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password"),_.from("app_feature_flags").select("*").order("key")]),E=g||"";e.innerHTML=`
