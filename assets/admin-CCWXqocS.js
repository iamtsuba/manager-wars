import{s as _,i as Et,r as Ee,a as _e,A as _t,l as wt,g as $t,K as Me,D as z,b as It,S as kt,c as R,H as Lt,R as At,e as ue,d as Qe,f as Bt,h as St,E as Tt,j as Ct,N as Mt,M as zt,B as Rt,k as jt,F as ge,m as ze,n as Dt,o as Xe,p as ye,q as Pt}from"./special-cards-Deqf4LjR.js";async function et(e){var o;const[{count:t},{count:n},{count:i},{count:c},{count:l},{data:g},{data:x}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password"),_.from("app_feature_flags").select("*").order("key")]),E=g||"";e.innerHTML=`
...
Cette action est irréversible.`))return;const i=document.getElementById("fix-old-faces-btn");i&&(i.disabled=!0,i.textContent="⏳ En cours...");try{const{data:c,error:l}=await _.from("players").select("id, country_code, face").like("face","public/faces/%");if(l){n(l.message,"error");return}if(!(c!=null&&c.length)){n("Aucun joueur avec l'ancien format — rien à faire ✅","success");return}const{data:g}=await _.from("players").select("face").not("face","is",null),x=new Set((g||[]).map(s=>s.face).filter(s=>s&&!s.startsWith("public/faces/")));let E=0,o=0;for(const s of c){const a=await _e(s.country_code,x);if(!a){o++;continue}const{error:r}=await _.from("players").update({face:a}).eq("id",s.id);if(r){o++;continue}x.add(a),E++}n(`${E} photo(s) réattribuée(s)${o?`, ${o} échec(s)`:""} ✅`,o?"error":"success")}finally{i&&(i.disabled=!1,i.textContent="🖼️ Réattribuer anciennes photos")}}async function Ut(e,t){await se(e,t)}async function se(e,t,n=null){var o,s,a,r,u;const{toast:i}=t;n||(n={search:((o=document.getElementById("search-players"))==null?void 0:o.value)||"",job:((s=document.getElementById("filter-job"))==null?void 0:s.value)||"",rarity:((a=document.getElementById("filter-rarity"))==null?void 0:a.value)||"",club:((r=document.getElementById("filter-club"))==null?void 0:r.value)||"",country:((u=document.getElementById("filter-country"))==null?void 0:u.value)||""});const[{data:c,error:l},{data:g}]=await Promise.all([_.from("players").select("*, clubs(id,encoded_name,logo_url)"),_.from("clubs").select("id,encoded_name").order("encoded_name")]);if(l){e.innerHTML=`<p style="color:red">${l.message}</p>`;return}const x={GK:0,DEF:1,MIL:2,ATT:3},E=(c||[]).sort((p,f)=>{const m=(x[p.job]??4)-(x[f.job]??4);return m!==0?m:(p.surname_real||"").localeCompare(f.surname_real||"")});Ht(e,E,g||[],t,n)}function Ht(e,t,n,i,c=null){var s,a;const{toast:l}=i;if(e.innerHTML=`
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
            ${[["GK","pm-g","note_g"],["DEF","pm-d","note_d"],["MIL","pm-m","note_m"],["ATT","pm-a","note_a"]].map(([p,f,m])=>`
              <div class="form-group" style="text-align:center">
                <label style="color:${Nt[p]};font-weight:700">${p}</label>
  ...
  `,(m=document.getElementById("m-logo-file"))==null||m.addEventListener("change",v=>{var I;const d=(I=v.target.files)==null?void 0:I[0];if(!d)return;const $=new FileReader;$.onload=()=>{document.getElementById("logo-preview").innerHTML=`<img src="${$.result}" style="width:100%;height:100%;object-fit:contain">`},$.readAsDataURL(d)}),(b=document.getElementById("m-open-flag-builder"))==null||b.addEventListener("click",()=>{nn(n)}),ne();function o(){var I,A;const v=((I=document.getElementById("m-kit-style"))==null?void 0:I.value)||"uni",d=((A=Me[v])==null?void 0:A.colors)===3,$=document.getElementById("wrap-m-kit-color3");$&&($.style.display=d?"":"none")}o(),["m-kit-color1","m-kit-color2","m-kit-color3","m-kit-shorts","m-kit-socks"].forEach(v=>{const d=document.getElementById(v),$=document.getElementById(v+"-txt");!d||!$||(d.addEventListener("input",()=>{$.value=d.value,ne()}),$.addEventListener("input",()=>{const I=$.value.trim();/^#[0-9a-fA-F]{6}$/.test(I)&&(d.value=I,ne())}),$.addEventListener("change",()=>{let I=$.value.trim();I.startsWith("#")||(I="#"+I),/^#[0-9a-fA-F]{6}$/.test(I)&&(d.value=I,$.value=I,ne())}))}),(L=document.getElementById("m-kit-style"))==null||L.addEventListener("change",()=>{o(),ne()});const s=document.getElementById("m-real"),a=document.getElementById("m-encoded");function r(){if(!s||!a||a.value)return;const v=s.value.trim().split(/\s+/),d=v.length===1?v[0].toUpperCase().slice(0,6):v.filter($=>$.length>2).map($=>$[0].toUpperCase()).join("")||v[0].toUpperCase().slice(0,4);a.value=d}s==null||s.addEventListener("input",r),(k=document.getElementById("auto-encode-btn"))==null||k.addEventListener("click",()=>{a&&(a.value=""),r()}),(y=document.getElementById("m-save"))==null||y.addEventListener("click",()=>dn(e,c,t,n));const u=document.getElementById("m-gen-squad"),p=document.getElementById("m-gen-strong-label");function f(){if(p&&(p.style.display=u!=null&&u.checked?"flex":"none",!(u!=null&&u.checked))){const v=document.getElementById("m-gen-strong");v&&(v.checked=!1)}}u==null||u.addEventListener("change",f),f(),(w=document.getElementById("btn-gen-squad-panel"))==null||w.addEventListener("click",()=>{an(e,n,t)}),(h=document.getElementById("btn-gen-one-player"))==null||h.addEventListener("click",()=>{rn(e,n)}),c&&Ie(e.id)}async function Ie(e){const{data:t}=await _.from("players").select("*, clubs(encoded_name, logo_url, kit_style, kit_color1, kit_color2, kit_color3, kit_shorts, kit_socks)").eq("club_id",e).order("surname_real"),n=document.getElementById("club-players-grid"),i=document.getElementById("club-players-count");if(i&&(i.textContent=(t||[]).length),!!n){if(!(t!=null&&t.length)){n.innerHTML='<div style="color:var(--tile-fg-dim);padding:20px;font-size:13px">Aucun joueur dans ce club.</div>';return}n.innerHTML=t.map(c=>Ee(c,{width:100})).join("")}}function an(e,t,n){const{openModal:i,closeModal:c,toast:l}=t;i(`⚽ Générer — ${e.real_name}`,`<div style="display:flex;flex-direction:column;gap:14px">
        ...
        <div style="display:grid;grid-template-columns:1fr 120px;gap:16px;align-items:start">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
            ...
            <div>
              ...
              <select id="av-hair">${g("av-hair",St,R.hair)}</select>
            </div>
            <div>
            ...
            <div>
              ...
              <select id="av-eyebrows">${g("av-eyebrows",Tt,R.eyebrows)}</select>
            </div>
            <div>
              <label>Yeux</label>
              <select id="av-eyes">${g("av-eyes",Ct,R.eyes)}</select>
            </div>
            <div>
              <label>Nez</label>
              <select id="av-nose">${g("av-nose",Mt,R.nose)}</select>
            </div>
            <div>
              <label>Bouche</label>
              <select id="av-mouth">${g("av-mouth",zt,R.mouth)}</select>
            </div>
            <div>
              <label>Barbe</label>
              <select id="av-beard">${g("av-beard",Rt,R.beard)}</select>
            </div>
          </div>
  ...
  `,o(E),document.getElementById("search-users").addEventListener("input",s=>{const a=s.target.value.toLowerCase();o(E.filter(r=>{var u;return r.pseudo.toLowerCase().includes(a)||((u=r.club_name)==null?void 0:u.toLowerCase().includes(a))}))});function o(s){document.getElementById("users-tbody").innerHTML=s.map(a=>{const r=a.mmr??1e3,u=a.mmr_deviation??350,p=a.placement_matches??0,f=jt(r),m=a.ranked_wins??0,b=a.ranked_losses??0,L=a.ranked_draws??0,k=m+b+L,y=k>0?Math.round(m/k*100):null,w=p<10,h=u<80?"#1A6B3C":u<150?"#e67e22":"#bb2020";return`
        <tr>
          <td>
...
`).replace(/\r/g,`
`);const t=e.split(`
`).filter(g=>g.trim());if(t.length<2)return[];const n=t[0],i=n.split(";").length>n.split(",").length?";":",",c=Oe(n,i).map(g=>g.trim().replace(/^\uFEFF/,"").toLowerCase()),l=[];for(let g=1;g<t.length;g++){if(!t[g].trim())continue;const x=Oe(t[g],i),E={};c.forEach((o,s)=>{E[o]=(x[s]||"").trim()}),!Object.values(E).every(o=>!o)&&l.push(E)}return l}function Oe(e,t=","){const n=[];let i="",c=!1;for(let l=0;l<e.length;l++){const g=e[l];c?g==='"'?e[l+1]==='"'?(i+='"',l++):c=!1:i+=g:g==='"'?c=!0:g===t?(n.push(i),i=""):i+=g}return n.push(i),n}const En={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function _n(e,{toast:t}){const n=Object.keys(ge);let i=n[0];const{data:c}=await _.from("formation_links_overrides").select("formation, links"),l={};(c||[]).forEach(s=>{l[s.formation]=s.links});let g=new Set;function x(s,a){return[s,a].sort().join("-")}function E(s){const a=l[s]||ge[s]||[];g=new Set(a.map(([r,u])=>x(r,u)))}E(i),e.innerHTML=`
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;gap:12px;flex-wrap:wrap">
  ...
  `;function o(){const s=Dt[i]||{},a=ze(i),r=320,u=400,p=22;function f(y){const w=s[y];return w?{x:w.x*r,y:w.y*u}:null}let m=`<svg width="${r}" height="${u}" viewBox="0 0 ${r} ${u}" xmlns="http://www.w3.org/2000/svg" style="display:block">`;a.forEach(([y,w],h)=>{const v=f(y),d=f(w);if(!v||!d)return;const $=x(y,w),I=g.has($),A=I?"#3b82f6":"#999",B=I?.95:.35,S=I?4:3;m+=`<line x1="${v.x}" y1="${v.y}" x2="${d.x}" y2="${d.y}"
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="f-price-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${In.map(p=>`<option value="${p.value}" ${a.price_type===p.value?"selected":""}>${p.label}</option>`).join("")}
            </select>
          </div>
        ...
        ${i.length===0?'<div style="text-align:center;padding:16px;color:#aaa;font-size:13px">Aucun taux. Cliquez + Ligne.</div>':i.map((p,f)=>`
          <div style="display:grid;grid-template-columns:2fr 1.5fr 50px 50px 60px 32px;gap:4px;align-items:center;margin-bottom:6px;padding:6px;background:#f9f9f9;border-radius:6px" data-rate-idx="${f}">
            <select class="rate-type" data-idx="${f}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${wn.map(m=>`<option value="${m.value}" ${p.card_type===m.value?"selected":""}>${m.label}</option>`).join("")}
            </select>
            <select class="rate-rarity" data-idx="${f}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${$n.map(m=>`<option value="${m.value}" ${(p.rarity||"")===m.value?"selected":""}>${m.label}</option>`).join("")}
            </select>
    ...
    </div>`,document.getElementById("add-config").addEventListener("click",()=>Ue(null)),document.getElementById("form-cancel").addEventListener("click",()=>{document.getElementById("config-form").style.display="none"}),document.getElementById("form-save").addEventListener("click",()=>Bn(e)),e.querySelectorAll("[data-edit]").forEach(i=>{const c=(t||[]).find(l=>l.id===i.dataset.edit);c&&i.addEventListener("click",()=>Ue(c))}),e.querySelectorAll("[data-delete]").forEach(i=>{i.addEventListener("click",async()=>{confirm("Supprimer cette règle ?")&&(await _.from("sell_price_configs").delete().eq("id",i.dataset.delete),await ke(e))})})}function An(e){const t=yt.find(n=>n.value===e.rarity);return`
    ...
    </tr>`}function Ue(e){document.getElementById("config-form").style.display="block",document.getElementById("form-title").textContent=e?"Modifier la règle":"Nouvelle règle",document.getElementById("form-id").value=(e==null?void 0:e.id)||"",document.getElementById("form-rarity").value=(e==null?void 0:e.rarity)||"normal",document.getElementById("form-price").value=(e==null?void 0:e.price)||1e3,document.getElementById("form-note-min").value=(e==null?void 0:e.note_min)??1,document.getElementById("form-note-max").value=(e==null?void 0:e.note_max)??10,document.getElementById("config-form").scrollIntoView({behavior:"smooth"})}async function Bn(e){const t=document.getElementById("form-id").value,n=document.getElementById("form-rarity").value,i=parseInt(document.getElementById("form-price").value)||0,c=parseInt(document.getElementById("form-note-min").value)||1,l=parseInt(document.getElementById("form-note-max").value)||10;if(c>l){alert("Note min doit être ≤ note max");return}const g={rarity:n,price:i,note_min:c,note_max:l,updated_at:new Date().toISOString()};let x;if(t?{error:x}=await _.from("sell_price_configs").update(g).eq("id",t):{error:x}=await _.from("sell_price_configs").insert(g),x){alert("Erreur : "+x.message);return}document.getElementById("config-form").style.display="none",await ke(e)}async function Sn(e){await Le(e)}async function Le(e){const{data:t}=await _.from("patch_notes").select("*").order("published_at",{ascending:!1});e.innerHTML=`
    ...
    </div>`,document.getElementById("add-article").addEventListener("click",()=>He(null)),document.getElementById("form-cancel").addEventListener("click",()=>{document.getElementById("article-form").style.display="none"}),document.getElementById("form-save").addEventListener("click",()=>Mn(e)),e.querySelectorAll("[data-edit-row]").forEach(n=>{const i=(t||[]).find(c=>c.id===n.dataset.editRow);i&&n.addEventListener("click",()=>He(i))}),e.querySelectorAll("[data-delete]").forEach(n=>{n.addEventListener("click",async()=>{confirm("Supprimer cet article ?")&&(await _.from("patch_notes").delete().eq("id",n.dataset.delete),await Le(e))})})}function Tn(e){const t=new Date(e.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"short",year:"numeric"});return`
  ...
  `);const o=()=>{var v,d,$,I,A,B,S;const u=((v=document.getElementById("st-name"))==null?void 0:v.value)||"NOM DU STADE",p=($=(d=document.getElementById("st-image"))==null?void 0:d.value)==null?void 0:$.trim(),f=(A=(I=document.getElementById("st-country"))==null?void 0:I.value)==null?void 0:A.trim(),m=document.getElementById("st-club"),b=(m==null?void 0:m.selectedIndex)||0,L=m&&b>0?m.options[b].text:"",k=((S=(B=m==null?void 0:m.options[b])==null?void 0:B.getAttribute)==null?void 0:S.call(B,"data-logo"))||"";let y=null;p?y=p.startsWith("http")?p:`${vt}icons/${p}`:k?y=k:f&&(y=`https://flagsapi.com/${f.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`);const w=L||f||"—",h=document.getElementById("st-preview-card");h&&(h.innerHTML=Xe(u,y,`${w}<br>+10 ⭐`,{width:140}))};o(),["st-name","st-club","st-country","st-image"].forEach(u=>{var p,f;(p=document.getElementById(u))==null||p.addEventListener("input",o),(f=document.getElementById(u))==null||f.addEventListener("change",o)}),(s=document.getElementById("st-cancel"))==null||s.addEventListener("click",()=>l()),(a=document.getElementById("st-save"))==null||a.addEventListener("click",async()=>{const u=document.getElementById("st-name").value.trim(),p=document.getElementById("st-club").value||null,f=document.getElementById("st-country").value.trim().toUpperCase()||null,m=document.getElementById("st-image").value.trim()||null;if(!u){g("Le nom est obligatoire","error");return}const b={name:u,club_id:p,country_code:f,image_url:m},{error:L}=e?await _.from("stadium_definitions").update(b).eq("id",e.id):await _.from("stadium_definitions").insert(b);if(L){g("Erreur : "+L.message,"error");return}g(e?"Stade modifié ✅":"Stade créé ✅","success"),l(),ce(n,i)}),(r=document.getElementById("st-delete"))==null||r.addEventListener("click",async()=>{confirm("Supprimer ce stade ?")&&(await _.from("stadium_definitions").delete().eq("id",e.id),g("Stade supprimé","success"),l(),ce(n,i))})}const q=[{value:"game_changer",label:"⚡ Game Changer",border:"#7a28b8",bg:"linear-gradient(135deg,#4a0080,#7a28b8)"},{value:"ultra_game_changer",label:"💎 Ultra Game Changer",border:"#00bcd4",bg:"linear-gradient(135deg,#006080,#00bcd4)"}],Fn=[{value:"purple",label:"Violet",hex:"#7a28b8"},{value:"light_blue",label:"Bleu clair",hex:"#00bcd4"}],G=[{value:"BOOST_STAT",label:"⚡ Boost stats (+N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"DEBUFF_STAT",label:"💀 Debuff stats (-N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"GRAY_PLAYER",label:"❄️ Griser un joueur",hasValue:!1,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"REVIVE_PLAYER",label:"💫 Ressusciter un joueur",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"REMOVE_GOAL",label:"🚫 Retirer un but adverse",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_GOAL_DRAW",label:"⚽ +1 but si duel nul",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_SUB",label:"🔄 Ajouter un remplacement",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"CUSTOM",label:"🛠️ Effet custom (hardcodé)",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1}],Ke=["GK","DEF","MIL","ATT"];async function On(e,t){await Ae(e,t)}async function Ae(e,t){var i;const{data:n}=await _.from("gc_definitions").select("*").order("sort_order").order("created_at");e.innerHTML=`
    ...
    </div>`,(i=document.getElementById("gc-add-btn"))==null||i.addEventListener("click",()=>Je(null,e,t)),e.querySelectorAll("[data-edit-gc]").forEach(c=>{c.addEventListener("click",()=>{const l=(n||[]).find(g=>g.id===c.dataset.editGc);l&&Je(l,e,t)})}),e.querySelectorAll(".btn-del-gc").forEach(c=>{c.addEventListener("click",async l=>{l.stopPropagation(),confirm("Supprimer cette carte Game Changer ?")&&(await _.from("gc_definitions").delete().eq("id",c.dataset.del),Ae(e,t))})})}function Un(e){const t=q.find(c=>c.value===e.gc_type)||q[0],n=e.image_url?`/icons/${e.image_url}`:null,i=ye(e.name||"?",n,t.label.split(" ")[0],e.effect||"",{width:130});return`<div data-edit-gc="${e.id}" style="position:relative;cursor:pointer">
    ${i}
    <div style="position:absolute;top:4px;left:4px;z-index:10;display:flex;gap:3px">
