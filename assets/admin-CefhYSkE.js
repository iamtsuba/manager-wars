import{s as _,r as Ee,a as _e,A as ht,l as Et,g as _t,K as Me,D as z,b as wt,S as It,c as R,H as $t,R as kt,e as ue,d as Qe,f as Lt,h as At,E as Bt,i as St,N as Tt,M as Ct,B as Mt,j as zt,F as ge,k as ze,m as Rt,n as Xe,o as ye,p as jt}from"./special-cards-Cc3e36Hs.js";async function Dt(e){var x;const[{count:t},{count:n},{count:a},{count:d},{count:r},{data:g}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password")]),v=g||"";e.innerHTML=`
