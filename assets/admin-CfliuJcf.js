import{s as k,i as Ft,C as ye,a as Ae,r as le,b as qt,g as qe,c as Ot,_ as yt,A as Gt,l as Ut,K as Ye,D as J,d as Ht,S as Kt,e as X,H as Vt,f as Jt,h as Yt,E as Wt,j as Zt,N as Xt,M as Qt,B as en,k as bt,m as tn,F as Ee,n as Oe,o as Ie,p as nn,q as an,t as Ce,u as We,T as be}from"./match-shared-BPr03YEd.js";const on={normal:"#cccccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function vt(e){var l;const[{count:n},{count:t},{count:i},{count:r},{count:a},{data:v},{data:$}]=await Promise.all([k.from("players").select("*",{count:"exact",head:!0}),k.from("clubs").select("*",{count:"exact",head:!0}),k.from("users").select("*",{count:"exact",head:!0}),k.from("stadium_definitions").select("*",{count:"exact",head:!0}),k.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),k.rpc("get_signup_password"),k.from("app_feature_flags").select("*").order("key")]),w=v||"";e.innerHTML=`
