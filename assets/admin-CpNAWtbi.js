import{s as _,i as Et,r as _e,a as we,A as _t,l as wt,g as It,K as ze,D as R,b as $t,S as kt,c as D,H as Lt,R as At,e as pe,d as Qe,f as Bt,h as St,E as Ct,j as Tt,N as Mt,M as zt,B as Rt,k as Dt,F as ge,m as Re,n as jt,o as Xe,p as be,q as Nt}from"./special-cards-Deqf4LjR.js";async function et(e){var o;const[{count:t},{count:n},{count:i},{count:d},{count:s},{data:g},{data:x}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password"),_.from("app_feature_flags").select("*").order("key")]),E=g||"";e.innerHTML=`
