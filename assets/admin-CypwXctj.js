import{s as w,r as Pe,g as Ne,K as Ee,D as M,a as et,S as tt,b as T,H as nt,R as it,e as ue,c as Fe,d as ot,f as at,E as rt,h as lt,N as st,M as dt,B as ct,i as pt,F as me,j as we,k as ut,l as mt,m as gt,n as ft}from"./special-cards-C3vbItfI.js";async function bt(e){const[{count:t},{count:n},{count:o},{count:p},{count:d}]=await Promise.all([w.from("players").select("*",{count:"exact",head:!0}),w.from("clubs").select("*",{count:"exact",head:!0}),w.from("users").select("*",{count:"exact",head:!0}),w.from("cards").select("*",{count:"exact",head:!0}),w.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:24px">
      ${ee("🃏","Joueurs (cartes)",t??"–","#1A6B3C")}
      ${ee("🏟️","Clubs",n??"–","#D4A017")}
      ${ee("👥","Managers",o??"–","#7a28b8")}
  ...
  `,window.adminNav=c=>{var l;(l=document.querySelector(`[data-page="${c}"]`))==null||l.click()}}function ee(e,t,n,o){return`<div class="card-panel" style="text-align:center">
  ...
  </div>`}const Ge="/",He={normal:"Normal",pepite:"Pépite",papyte:"Papyte",legende:"Légende"},yt={GK:"#aaaaaa",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};let te=null;async function vt(){if(te)return te;try{te=await(await fetch(Ge+"faces-manifest.json")).json()}catch{te={}}return te}async function xt(e,t){await de(e,t)}async function de(e,t,n=null){var a,g,s,r,i;const{toast:o}=t;n||(n={search:((a=document.getElementById("search-players"))==null?void 0:a.value)||"",job:((g=document.getElementById("filter-job"))==null?void 0:g.value)||"",rarity:((s=document.getElementById("filter-rarity"))==null?void 0:s.value)||"",club:((r=document.getElementById("filter-club"))==null?void 0:r.value)||"",country:((i=document.getElementById("filter-country"))==null?void 0:i.value)||""});const[{data:p,error:d},{data:c}]=await Promise.all([w.from("players").select("*, clubs(id,encoded_name,logo_url)"),w.from("clubs").select("id,encoded_name").order("encoded_name")]);if(d){e.innerHTML=`<p style="color:red">${d.message}</p>`;return}const l={GK:0,DEF:1,MIL:2,ATT:3},f=(p||[]).sort((b,h)=>{const E=(l[b.job]??4)-(l[h.job]??4);return E!==0?E:(b.surname_real||"").localeCompare(h.surname_real||"")});ht(e,f,c||[],t,n)}function ht(e,t,n,o,p=null){var g,s;const{toast:d}=o;if(e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:10px">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ...
        <select id="filter-rarity" style="width:110px">
          ...
          ${Object.entries(He).map(([r,i])=>`<option value="${r}">${i}</option>`).join("")}
        </select>
    ...
    </div>`,p){const r=p,i=b=>document.getElementById(b);r.search&&i("search-players")&&(i("search-players").value=r.search),r.job&&i("filter-job")&&(i("filter-job").value=r.job),r.rarity&&i("filter-rarity")&&(i("filter-rarity").value=r.rarity),r.club&&i("filter-club")&&(i("filter-club").value=r.club),r.country&&i("filter-country")&&(i("filter-country").value=r.country)}if(p){const r=p,i=b=>document.getElementById(b);r.search&&i("search-players")&&(i("search-players").value=r.search),r.job&&i("filter-job")&&(i("filter-job").value=r.job),r.rarity&&i("filter-rarity")&&(i("filter-rarity").value=r.rarity),r.club&&i("filter-club")&&(i("filter-club").value=r.club),r.country&&i("filter-country")&&(i("filter-country").value=r.country)}function c(){const r=document.getElementById("search-players").value.toLowerCase(),i=document.getElementById("filter-job").value,b=document.getElementById("filter-rarity").value,h=document.getElementById("filter-club").value,E=document.getElementById("filter-country").value;return t.filter(m=>(!r||`${m.firstname} ${m.surname_real}`.toLowerCase().includes(r))&&(!i||m.job===i)&&(!b||m.rarity===b)&&(!h||m.club_id===h)&&(!E||m.country_code===E))}const l=new Set;function f(){const r=document.getElementById("bulk-bar"),i=document.getElementById("bulk-count");r&&(r.style.display=l.size>0?"flex":"none",i&&(i.textContent=`${l.size} joueur(s) sélectionné(s)`))}function a(){const r=c();document.getElementById("count-label").textContent=`${r.length} joueur(s)`;const i=document.getElementById("players-list");if(!r.length){i.innerHTML='<div style="color:var(--gray-600);padding:20px;text-align:center">Aucun joueur.</div>';return}i.innerHTML=r.map(b=>{const h={...b,clubs:b.clubs,face:b.face||null},E=Pe(h,{width:120});return`<div style="position:relative;cursor:pointer" data-edit="${b.id}">
        ${E}
      ...
      </div>`}).join(""),i.querySelectorAll("[data-edit]").forEach(b=>{b.addEventListener("click",()=>{const h=t.find(E=>E.id===b.dataset.edit);h&&_e(h,n,e,o)})}),i.querySelectorAll(".btn-del-player").forEach(b=>{b.addEventListener("click",async h=>{if(h.stopPropagation(),!confirm("Supprimer ce joueur ?"))return;const{error:E}=await w.from("players").delete().eq("id",b.dataset.del);E?d(E.message,"error"):(d("Joueur supprimé ✅","success"),de(e,o))})})}a(),document.getElementById("search-players").addEventListener("input",a),document.getElementById("filter-job").addEventListener("change",a),document.getElementById("filter-rarity").addEventListener("change",a),document.getElementById("filter-club").addEventListener("change",a),document.getElementById("filter-country").addEventListener("change",a),(g=document.getElementById("bulk-cancel-btn"))==null||g.addEventListener("click",()=>{l.clear(),f(),a()}),(s=document.getElementById("bulk-delete-btn"))==null||s.addEventListener("click",async()=>{var h,E,m,$,k;if(!l.size||!confirm(`Supprimer ${l.size} joueur(s) ?`))return;const r=[...l],{error:i}=await w.from("players").delete().in("id",r);if(i){d(i.message,"error");return}d(`${r.length} joueur(s) supprimé(s) ✅`,"success"),l.clear();const b={search:((h=document.getElementById("search-players"))==null?void 0:h.value)||"",job:((E=document.getElementById("filter-job"))==null?void 0:E.value)||"",rarity:((m=document.getElementById("filter-rarity"))==null?void 0:m.value)||"",club:(($=document.getElementById("filter-club"))==null?void 0:$.value)||"",country:((k=document.getElementById("filter-country"))==null?void 0:k.value)||""};de(e,o,b)}),document.getElementById("add-player-btn").addEventListener("click",()=>_e(null,n,e,o))}async function _e(e,t,n,o){const{toast:p,openModal:d,closeModal:c}=o,l=!!e,f=await vt(),{data:a}=await w.from("players").select("face").not("face","is",null),g=new Set((a||[]).map(i=>i.face?i.face.replace("public/faces/",""):null).filter(Boolean));e!=null&&e.face&&g.delete(e.face);const s='<option value="">— Club —</option>'+t.map(i=>`<option value="${i.id}" ${(e==null?void 0:e.club_id)===i.id?"selected":""}>${i.encoded_name}</option>`).join(""),r=Object.keys(f).map(i=>{var b;return`<option value="${i}" ${(e==null?void 0:e.ethnie)===i||!(e!=null&&e.ethnie)&&((b=e==null?void 0:e.face)!=null&&b.startsWith(i))?"selected":""}>${i}</option>`}).join("");d(l?`✏️ ${e.firstname} ${e.surname_real}`:"➕ Nouveau joueur",`<div style="display:flex;gap:20px;align-items:flex-start">
      ...
      <div style="flex:1;min-width:300px;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
          <div class="form-group">
            <label>Poste 1</label>
            <select id="pm-job">
              ${["GK","DEF","MIL","ATT"].map(i=>`<option value="${i}" ${(e==null?void 0:e.job)===i?"selected":""}>${i}</option>`).join("")}
            </select>
          </div>
          <div class="form-group">
            <label>Poste 2</label>
            <select id="pm-job2">
              ...
              ${["GK","DEF","MIL","ATT"].map(i=>`<option value="${i}" ${(e==null?void 0:e.job2)===i?"selected":""}>${i}</option>`).join("")}
            </select>
          </div>
          <div class="form-group">
            <label>Rareté</label>
            <select id="pm-rarity">
              ${["normal","pepite","papyte","legende"].map(i=>`<option value="${i}" ${(e==null?void 0:e.rarity)===i?"selected":""}>${He[i]}</option>`).join("")}
            </select>
          </div>
          <div class="form-group">
            <label>Pays</label>
            <select id="pm-country">
              ${["FR","DE","ES","PT","IT","GB","NL","BE","DK","SE","NO","PL","CH","AT","CZ","HR","RS","AL","TR","AR","BR","UY","CO","MX","CL","PE","EC","MA","DZ","TN","EG","NG","SN","CI","CM","GH","ML","GN","CD","AO","ZA","KE","JP","KR","CN","VN","TH","ID","PH","US","CA","AU","RU","UA","GR","RO","BG","IR","SA","AE","IN","PK","BD"].map(i=>`<option value="${i}" ${((e==null?void 0:e.country_code)||"FR")===i?"selected":""}>${i}</option>`).join("")}
            </select>
          </div>
        </div>
        ...
        <div style="border-top:1px solid var(--gray-200);padding-top:10px">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
            ${[["GK","pm-g","note_g"],["DEF","pm-d","note_d"],["MIL","pm-m","note_m"],["ATT","pm-a","note_a"]].map(([i,b,h])=>`
              <div class="form-group" style="text-align:center">
                <label style="color:${yt[i]};font-weight:700">${i}</label>
    ...
    <div id="clubs-list" style="display:flex;flex-direction:column;gap:8px"></div>`,c(re),document.getElementById("search-clubs").addEventListener("input",l=>{const f=l.target.value.toLowerCase();c(re.filter(a=>a.real_name.toLowerCase().includes(f)||a.encoded_name.toLowerCase().includes(f)))}),document.getElementById("add-club-btn").addEventListener("click",()=>$e(null,e,t));function c(l){const f=document.getElementById("clubs-list");if(!l.length){f.innerHTML='<p style="color:var(--gray-600);padding:20px">Aucun club.</p>';return}f.innerHTML=l.map(a=>{const g=Ke(a),s=Ne(g,a.id).replace("<svg ",'<svg style="width:40px;height:48px" '),r=a.logo_url?`<img src="${a.logo_url}" style="width:40px;height:40px;object-fit:contain;border-radius:8px">`:`<div style="width:40px;height:40px;background:linear-gradient(135deg,${g.color1},${g.color2});border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:900">${a.encoded_name.slice(0,3)}</div>`,i=n[a.id]||0;return`
        <div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,0.08)">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="font-size:11px;margin-top:2px;color:${i===0?"#e67e22":"var(--gray-600)"}">
              ${i===0?"⚠️ Aucun joueur":`👥 ${i} joueur${i>1?"s":""}`}
            </div>
          </div>
          ${s}
          <div style="display:flex;flex-direction:column;gap:4px;flex-shrink:0">
            ${i===0?`<button class="btn btn-primary btn-sm" data-gen="${a.id}" data-cc="${a.country_code}" data-name="${a.real_name}" title="Générer joueurs">⚽</button>`:""}
            <button class="btn btn-ghost btn-sm" data-edit="${a.id}">✏️</button>
            <button class="btn btn-danger btn-sm" data-del="${a.id}">🗑️</button>
          </div>
        </div>`}).join(""),f.querySelectorAll("[data-gen]").forEach(a=>{a.addEventListener("click",async()=>{confirm(`Générer 20 joueurs pour ${a.dataset.name} ?`)&&(a.disabled=!0,a.textContent="⏳",await Ue(a.dataset.gen,a.dataset.cc,o),ce(e,t))})}),f.querySelectorAll("[data-edit]").forEach(a=>{const g=re.find(s=>s.id===a.dataset.edit);a.addEventListener("click",()=>$e(g,e,t))}),f.querySelectorAll("[data-del]").forEach(a=>{a.addEventListener("click",async()=>{if(!confirm("Supprimer ce club ?"))return;const{error:g}=await w.from("clubs").delete().eq("id",a.dataset.del);g?o(g.message,"error"):(o("Club supprimé","success"),ce(e,t))})})}}function $e(e,t,n){const{toast:o,openModal:p,closeModal:d}=n,c=!!e,l=e?Ke(e):{...M},f=Object.entries(Ee).map(([g,s])=>`<option value="${g}" ${l.style===g?"selected":""}>${s.label}</option>`).join(""),a=qe.map(g=>`<option value="${g}" ${((e==null?void 0:e.country_code)||"FR")===g?"selected":""}>${g}</option>`).join("");p(c?`✏️ ${e.real_name}`:"➕ Nouveau club",`<div style="display:flex;flex-direction:column;gap:14px">
      ...
      <div style="border-top:1px solid var(--gray-200);padding-top:12px">
        ...
        <div style="display:flex;gap:12px;align-items:flex-start">
          ...
          <div style="flex:1;display:flex;flex-direction:column;gap:8px">
            ...
            ${[["Couleur 1","m-kit-color1",l.color1,!1],["Couleur 2","m-kit-color2",l.color2,!1],["Couleur 3","m-kit-color3",l.color3,!0],["Short","m-kit-shorts",l.shorts,!1],["Chaussettes","m-kit-socks",l.socks,!1]].map(([g,s,r,i])=>`
              <div class="form-group" id="wrap-${s}" ${i?'style="display:none"':""}>
                <label>${g}</label>
    ...
    </div>`),setTimeout(()=>{var b,h,E;ne();function g(){var x,u;const m=((x=document.getElementById("m-kit-style"))==null?void 0:x.value)||"uni",$=((u=Ee[m])==null?void 0:u.colors)===3,k=document.getElementById("wrap-m-kit-color3");k&&(k.style.display=$?"":"none")}g(),["m-kit-color1","m-kit-color2","m-kit-color3","m-kit-shorts","m-kit-socks"].forEach(m=>{const $=document.getElementById(m),k=document.getElementById(m+"-txt");!$||!k||($.addEventListener("input",()=>{k.value=$.value,ne()}),k.addEventListener("input",()=>{const x=k.value.trim();/^#[0-9a-fA-F]{6}$/.test(x)&&($.value=x,ne())}),k.addEventListener("change",()=>{let x=k.value.trim();x.startsWith("#")||(x="#"+x),/^#[0-9a-fA-F]{6}$/.test(x)&&($.value=x,k.value=x,ne())}))}),(b=document.getElementById("m-kit-style"))==null||b.addEventListener("change",()=>{g(),ne()});const s=document.getElementById("m-real"),r=document.getElementById("m-encoded");function i(){if(!s||!r||r.value)return;const m=s.value.trim().split(/\s+/),$=m.length===1?m[0].toUpperCase().slice(0,6):m.filter(k=>k.length>2).map(k=>k[0].toUpperCase()).join("")||m[0].toUpperCase().slice(0,4);r.value=$}s==null||s.addEventListener("input",i),(h=document.getElementById("auto-encode-btn"))==null||h.addEventListener("click",()=>{r&&(r.value=""),i()}),(E=document.getElementById("m-save"))==null||E.addEventListener("click",()=>Mt(e,c,t,n))},50)}function Ve(){var e,t,n,o,p,d;return{style:((e=document.getElementById("m-kit-style"))==null?void 0:e.value)||"uni",color1:((t=document.getElementById("m-kit-color1"))==null?void 0:t.value)||"#1A6B3C",color2:((n=document.getElementById("m-kit-color2"))==null?void 0:n.value)||"#ffffff",color3:((o=document.getElementById("m-kit-color3"))==null?void 0:o.value)||"#000000",shorts:((p=document.getElementById("m-kit-shorts"))==null?void 0:p.value)||"#111111",socks:((d=document.getElementById("m-kit-socks"))==null?void 0:d.value)||"#ffffff"}}function ne(){const e=document.getElementById("kit-preview-wrap");e&&(e.innerHTML=Ne(Ve(),"modal"))}async function Mt(e,t,n,o){var m,$,k,x,u,y;const{toast:p,closeModal:d}=o,c=document.getElementById("m-error"),l=document.getElementById("m-save"),f=(m=document.getElementById("m-real"))==null?void 0:m.value.trim(),a=($=document.getElementById("m-encoded"))==null?void 0:$.value.trim().toUpperCase(),g=(k=document.getElementById("m-country"))==null?void 0:k.value.trim().toUpperCase(),s=((x=document.getElementById("m-logo"))==null?void 0:x.value.trim())||null,r=((u=document.getElementById("m-gen-stadium"))==null?void 0:u.checked)??!1,i=((y=document.getElementById("m-gen-squad"))==null?void 0:y.checked)??!1,b=Ve();if(!f){c.textContent="Le nom du club est requis.";return}if(!a){c.textContent="Le nom encodé est requis.";return}if(!g){c.textContent="Le pays est requis.";return}l.disabled=!0,l.textContent="Enregistrement…";const h={real_name:f,encoded_name:a,country_code:g,logo_url:s,kit_style:b.style,kit_color1:b.color1,kit_color2:b.color2,kit_color3:b.color3,kit_shorts:b.shorts,kit_socks:b.socks};let E=e==null?void 0:e.id;if(t){const{error:v}=await w.from("clubs").update(h).eq("id",E);if(v){c.textContent=v.message,l.disabled=!1,l.textContent="💾 Enregistrer";return}}else{const{data:v,error:_}=await w.from("clubs").insert(h).select().single();if(_){c.textContent=_.message,l.disabled=!1,l.textContent="✅ Créer le club";return}if(E=v.id,r){l.textContent="🏟️ Création du stade…";const{data:B,error:I}=await w.from("stadium_definitions").insert({name:`Stade de ${f}`,club_id:E,country_code:g}).select().single();I?console.warn("[Stadium] Erreur def stade:",I.message):B&&await w.from("cards").insert({card_type:"stadium",stadium_id:B.id})}i&&(l.textContent="⚽ Génération des joueurs…",await Ue(E,g,p))}p(t?"Club modifié ✅":"Club créé ✅","success"),d(),ce(n,o)}const Tt=["normal","pepite","papyte","legende"],Ie=["GK","DEF","MIL","ATT"],jt=[["MA","Maroc"],["FR","France"],["AR","Argentine"],["PT","Portugal"],["BR","Brésil"],["ES","Espagne"],["DE","Allemagne"],["GB","Angleterre"],["IT","Italie"],["CM","Cameroun"],["SN","Sénégal"],["NG","Nigéria"],["DK","Danemark"],["NL","Pays-Bas"],["BE","Belgique"],["CI","Côte d'Ivoire"],["AL","Albanie"],["HR","Croatie"],["RS","Serbie"],["TR","Turquie"],["MW","Malawi"]];let U={...T},le=[];async function Rt(e,{toast:t}){const{data:n}=await w.from("clubs").select("id,encoded_name,logo_url,kit_style,kit_color1,kit_color2,kit_shorts,kit_socks").order("encoded_name");le=n||[],U={...T},e.innerHTML=Ft(le),Pt(e,le,t),N()}function Be(){var n;const e=((n=document.getElementById("cb-surname-real"))==null?void 0:n.value)||"",t=document.getElementById("cb-surname-enc");t&&(t.value=ue(e))}function Dt(){var n;const e=(n=document.getElementById("cb-club"))==null?void 0:n.value,t=le.find(o=>String(o.id)===String(e));return t?{style:t.kit_style||M.style,color1:t.kit_color1||M.color1,color2:t.kit_color2||M.color2,shorts:t.kit_shorts||M.shorts,socks:t.kit_socks||M.socks}:{...M}}function N(){var r,i,b,h;const e=E=>{var m;return((m=document.getElementById(E))==null?void 0:m.value)||""},t={firstname:e("cb-firstname"),surname_real:e("cb-surname-enc")||ue(e("cb-surname-real")),country_code:e("cb-country"),club_encoded_name:((i=(r=document.getElementById("cb-club"))==null?void 0:r.selectedOptions[0])==null?void 0:i.text)||"",job:e("cb-job"),job2:e("cb-job2")||null,note_g:parseInt(e("cb-note-g"))||0,note_d:parseInt(e("cb-note-d"))||0,note_m:parseInt(e("cb-note-m"))||0,note_a:parseInt(e("cb-note-a"))||0,rarity:e("cb-rarity")},n=Dt(),o=document.getElementById("cb-club"),p=((h=(b=o==null?void 0:o.selectedOptions[0])==null?void 0:b.dataset)==null?void 0:h.logo)||null,d=Fe(U,n,120),c=`data:image/svg+xml;charset=utf-8,${encodeURIComponent(d)}`,l=ot(t,{portraitUrl:c,clubLogoUrl:p,showNotes:!0}),f=document.getElementById("card-preview");f&&(f.innerHTML=l);const a=document.getElementById("avatar-preview-wrap");a&&(a.innerHTML=d);const g=e("cb-surname-real"),s=document.getElementById("encode-summary");s&&g&&(s.textContent=`${e("cb-firstname")} ${g} → ${e("cb-firstname")} ${t.surname_real}`)}function Je(){const e=t=>{var n;return((n=document.getElementById(t))==null?void 0:n.value)||""};U={skin:e("av-skin"),hair:e("av-hair"),hairColor:e("av-hairColor"),eyes:e("av-eyes"),nose:e("av-nose"),mouth:e("av-mouth"),eyebrows:e("av-eyebrows"),beard:e("av-beard")}}function Pt(e,t,n){var p,d,c,l,f;e.querySelectorAll("input,select").forEach(a=>{a.addEventListener("input",N),a.addEventListener("change",N)});const o=["av-skin","av-hair","av-hairColor","av-eyes","av-nose","av-mouth","av-eyebrows","av-beard"];o.forEach(a=>{var g;(g=document.getElementById(a))==null||g.addEventListener("change",()=>{Je(),N()})}),(p=document.getElementById("cb-surname-real"))==null||p.addEventListener("input",()=>{Be(),N()}),(d=document.getElementById("btn-encode"))==null||d.addEventListener("click",()=>{Be(),N()}),(c=document.getElementById("cb-club"))==null||c.addEventListener("change",N),(l=document.getElementById("btn-save-player"))==null||l.addEventListener("click",()=>Nt(n)),(f=document.getElementById("btn-reset"))==null||f.addEventListener("click",()=>{e.querySelectorAll("input").forEach(a=>a.value=""),e.querySelectorAll("select").forEach(a=>a.selectedIndex=0),U={...T},o.forEach(a=>{const g=a.replace("av-",""),s=document.getElementById(a);s&&(s.value=T[g]||"")}),N()})}async function Nt(e){const t=c=>{var l;return((l=document.getElementById(c))==null?void 0:l.value)||""},n=t("cb-surname-real").trim(),o=t("cb-surname-enc").trim()||ue(n);if(!t("cb-firstname")||!n||!t("cb-country")||!t("cb-job")){e("Remplissez les champs obligatoires (prénom, nom, pays, poste)","error");return}Je();const p={firstname:t("cb-firstname").trim(),surname_real:n,surname_real:o,country_code:t("cb-country"),club_id:t("cb-club")||null,job:t("cb-job"),job2:t("cb-job2")||null,note_g:parseInt(t("cb-note-g"))||0,note_d:parseInt(t("cb-note-d"))||0,note_m:parseInt(t("cb-note-m"))||0,note_a:parseInt(t("cb-note-a"))||0,rarity:t("cb-rarity")||"normal",note_min:parseInt(t("cb-note-min"))||null,note_max:parseInt(t("cb-note-max"))||null,sell_price:parseInt(t("cb-price"))||0,avatar_config:U,skin:U.skin||"blanc",hair:U.hairColor||"marron",hair_length:"court"},{error:d}=await w.from("players").insert(p);if(d){e("Erreur: "+d.message,"error");return}e(`✅ Joueur "${p.firstname} ${p.surname_real}" enregistré !`,"success")}function Ft(e){const t=jt.map(([a,g])=>`<option value="${a}">${g} (${a})</option>`).join(""),n='<option value="">— Sélectionner un club —</option>'+e.map(a=>`<option value="${a.id}" data-logo="${a.logo_url||""}">${a.encoded_name}</option>`).join(""),o=Ie.map(a=>`<option value="${a}">${a}</option>`).join(""),p='<option value="">Aucun</option>'+Ie.map(a=>`<option value="${a}">${a}</option>`).join(""),d=Tt.map(a=>`<option value="${a}">${a.charAt(0).toUpperCase()+a.slice(1)}</option>`).join(""),c=(a,g,s)=>Object.entries(g).map(([r,i])=>`<option value="${r}" ${r===(s||"")?"selected":""}>${i.label}</option>`).join(""),l=Object.keys(tt).map(a=>`<option value="${a}" ${a===T.skin?"selected":""}>${a.charAt(0).toUpperCase()+a.slice(1)}</option>`).join(""),f=Object.keys(nt).map(a=>`<option value="${a}" ${a===T.hairColor?"selected":""}>${a.charAt(0).toUpperCase()+a.slice(1)}</option>`).join("");return`
        ...
        <div style="display:grid;grid-template-columns:1fr 120px;gap:16px;align-items:start">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
            ...
            <div>
              ...
              <select id="av-hair">${c("av-hair",at,T.hair)}</select>
            </div>
            <div>
            ...
            <div>
              ...
              <select id="av-eyebrows">${c("av-eyebrows",rt,T.eyebrows)}</select>
            </div>
            <div>
              <label>Yeux</label>
              <select id="av-eyes">${c("av-eyes",lt,T.eyes)}</select>
            </div>
            <div>
              <label>Nez</label>
              <select id="av-nose">${c("av-nose",st,T.nose)}</select>
            </div>
            <div>
              <label>Bouche</label>
              <select id="av-mouth">${c("av-mouth",dt,T.mouth)}</select>
            </div>
            <div>
              <label>Barbe</label>
              <select id="av-beard">${c("av-beard",ct,T.beard)}</select>
            </div>
          </div>
  ...
  `}async function We(e,{toast:t}){const{data:n,error:o}=await w.from("users").select("id,pseudo,club_name,credits,level,wins,draws,losses,trophies_top1,trophies_top2,trophies_top3,is_admin,created_at,mmr,mmr_deviation,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").order("created_at",{ascending:!1});if(o){e.innerHTML=`<p style="color:red">${o.message}</p>`;return}const p=n||[];e.innerHTML=`
  ...
  `,d(p),document.getElementById("search-users").addEventListener("input",c=>{const l=c.target.value.toLowerCase();d(p.filter(f=>{var a;return f.pseudo.toLowerCase().includes(l)||((a=f.club_name)==null?void 0:a.toLowerCase().includes(l))}))});function d(c){document.getElementById("users-tbody").innerHTML=c.map(l=>{const f=l.mmr??1e3,a=l.mmr_deviation??350,g=l.placement_matches??0,s=pt(f),r=l.ranked_wins??0,i=l.ranked_losses??0,b=l.ranked_draws??0,h=r+i+b,E=h>0?Math.round(r/h*100):null,m=g<10,$=a<80?"#1A6B3C":a<150?"#e67e22":"#bb2020";return`
        <tr>
          <td>
          ...
          <td style="font-size:12px">
            ...
            ${m?`<div style="font-size:10px;color:#e67e22">${g}/10 placement${g<10?` (${10-g} restants)`:""}</div>`:`<div style="font-size:10px;color:var(--gray-600)">${r}V ${b}N ${i}D${E!==null?` · ${E}% WR`:""}</div>`}
          </td>
        ...
        </tr>`}).join(""),document.querySelectorAll("[data-toggle-admin]").forEach(l=>{l.addEventListener("click",async()=>{const f=l.dataset.isAdmin!=="true";if(!confirm(`Voulez-vous ${f?"rendre admin":"retirer le rôle admin"} de ce Manager ?`))return;const{error:a}=await w.from("users").update({is_admin:f}).eq("id",l.dataset.toggleAdmin);a?t(a.message,"error"):(t("Rôle mis à jour ✅","success"),We(e,{toast:t}))})})}}async function Ye(e,{toast:t}){const{data:n,error:o}=await w.from("market_listings").select(`
    ...
    `).order("listed_at",{ascending:!1}).limit(100);if(o){e.innerHTML=`<p style="color:red">${o.message}</p>`;return}const p=n||[],d=p.filter(l=>l.status==="active").length,c=p.filter(l=>l.status==="sold").length;e.innerHTML=`
    ...
    <div class="card-panel">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${p.map(l=>{var s,r,i,b;const f=(s=l.card)==null?void 0:s.player,a=f?`${f.firstname} ${f.surname_real}`:((r=l.card)==null?void 0:r.card_type)||"—",g={active:"#1A6B3C",sold:"#D4A017",cancelled:"#aaa"};return`<tr>
                <td><b>${a}</b>${f?`<div style="font-size:10px;color:#999">${f.rarity} · ${f.job}</div>`:""}</td>
                <td style="font-size:12px">${((i=l.seller)==null?void 0:i.pseudo)||"—"}</td>
  ...
  `,document.querySelectorAll("[data-cancel]").forEach(l=>{l.addEventListener("click",async()=>{if(!confirm("Annuler cette annonce ?"))return;const{error:f}=await w.from("market_listings").update({status:"cancelled"}).eq("id",l.dataset.cancel);f?t(f.message,"error"):(t("Annonce annulée","success"),Ye(e,{toast:t}))})})}async function Gt(e,{toast:t}){e.innerHTML=`
...
`)}),document.getElementById("export-clubs").addEventListener("click",async()=>{const{data:n,error:o}=await w.from("clubs").select("real_name,encoded_name,country_code,logo_url").order("encoded_name");if(o){t(o.message,"error");return}if(!n||n.length===0){t("Aucun club à exporter","info");return}let p=`real_name,encoded_name,country_code,logo_url
`;n.forEach(d=>{p+=[d.real_name,d.encoded_name,d.country_code,d.logo_url||""].map(Se).join(",")+`
`}),oe("clubs_export.csv",p),t(`${n.length} clubs exportés`,"success")}),document.getElementById("export-players").addEventListener("click",async()=>{const{data:n,error:o}=await w.from("players").select("firstname,surname_real,surname_real,country_code,job,job2,note_g,note_d,note_m,note_a,rarity,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name)").order("surname_real");if(o){t(o.message,"error");return}if(!n||n.length===0){t("Aucun joueur à exporter","info");return}let p=`firstname,surname_real,surname_real,country_code,club_encoded_name,job,job2,note_g,note_d,note_m,note_a,rarity,note_min,note_max,skin,hair,hair_length,sell_price
...
`}),oe("players_export.csv",p),t(`${n.length} joueurs exportés`,"success")}),document.getElementById("import-clubs").addEventListener("change",async n=>{const o=n.target.files[0];if(!o)return;const p=document.getElementById("clubs-import-result");p.innerHTML='<span style="color:var(--gray-600)">Import en cours...</span>';try{const d=await o.text(),c=Le(d);if(c.length===0){p.innerHTML='<span style="color:#c0392b">Fichier vide</span>';return}let l=0,f=0;const a=[];for(const g of c){if(!g.real_name||!g.encoded_name||!g.country_code){f++,a.push(`Ligne ignorée (champs manquants): ${g.real_name||"?"}`);continue}const s={real_name:g.real_name,encoded_name:g.encoded_name.toUpperCase(),country_code:g.country_code.toUpperCase().slice(0,2),logo_url:g.logo_url||null},{error:r}=await w.from("clubs").upsert(s,{onConflict:"encoded_name"});r?(f++,a.push(`${g.encoded_name}: ${r.message}`)):l++}p.innerHTML=`<div style="color:var(--green)">✅ ${l} clubs importés</div>
        ${f>0?`<div style="color:#c0392b">❌ ${f} erreurs</div><div style="font-size:11px;color:var(--gray-600);max-height:100px;overflow-y:auto">${a.slice(0,10).join("<br>")}</div>`:""}`,t(`${l} clubs importés`,"success")}catch(d){p.innerHTML=`<span style="color:#c0392b">Erreur : ${d.message}</span>`}n.target.value=""}),document.getElementById("import-players").addEventListener("change",async n=>{const o=n.target.files[0];if(!o)return;const p=document.getElementById("players-import-result");p.innerHTML='<span style="color:var(--gray-600)">Import en cours...</span>';try{const d=await o.text(),c=Le(d);if(c.length===0){p.innerHTML='<span style="color:#c0392b">Fichier vide</span>';return}const{data:l}=await w.from("clubs").select("id,encoded_name"),f={};(l||[]).forEach(m=>{f[m.encoded_name.toUpperCase()]=m.id});let a=0,g=0;const s=[],r=["GK","DEF","MIL","ATT"],i=["normal","pepite","papyte","legende"],b=["blanc","metisse","typ","noir"],h=["blond","marron","noir","chauve"],E=["rase","court","milong","long"];for(const m of c){if(!m.firstname||!m.surname_real||!m.country_code||!m.job){g++,s.push(`Ligne ignorée (champs requis manquants): ${m.firstname||"?"}`);continue}if(!r.includes(m.job)){g++,s.push(`${m.firstname}: job invalide "${m.job}"`);continue}const $=m.club_encoded_name&&f[m.club_encoded_name.toUpperCase()]||null,k={firstname:m.firstname,surname_real:m.surname_real,surname_real:m.surname_real||ue(m.surname_real),country_code:m.country_code.toUpperCase().slice(0,2),club_id:$,job:m.job,job2:r.includes(m.job2)?m.job2:null,note_g:parseInt(m.note_g)||0,note_d:parseInt(m.note_d)||0,note_m:parseInt(m.note_m)||0,note_a:parseInt(m.note_a)||0,rarity:i.includes(m.rarity)?m.rarity:"normal",note_min:m.note_min!==""&&m.note_min!=null?parseInt(m.note_min):null,note_max:m.note_max!==""&&m.note_max!=null?parseInt(m.note_max):null,skin:b.includes(m.skin)?m.skin:"blanc",hair:h.includes(m.hair)?m.hair:"noir",hair_length:E.includes(m.hair_length)?m.hair_length:"court",sell_price:parseInt(m.sell_price)||0},{error:x}=await w.from("players").insert(k);x?(g++,s.push(`${m.firstname} ${m.surname_real}: ${x.message}`)):a++}p.innerHTML=`<div style="color:var(--green)">✅ ${a} joueurs importés</div>
...
`)?'"'+t.replace(/"/g,'""')+'"':t}function oe(e,t){const n=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(n),p=document.createElement("a");p.href=o,p.download=e,p.click(),URL.revokeObjectURL(o)}function Le(e){e=e.replace(/^\uFEFF/,"").replace(/\r\n/g,`
`).replace(/\r/g,`
`);const t=e.split(`
`).filter(c=>c.trim());if(t.length<2)return[];const n=t[0],o=n.split(";").length>n.split(",").length?";":",",p=Ce(n,o).map(c=>c.trim().replace(/^\uFEFF/,"").toLowerCase()),d=[];for(let c=1;c<t.length;c++){if(!t[c].trim())continue;const l=Ce(t[c],o),f={};p.forEach((a,g)=>{f[a]=(l[g]||"").trim()}),!Object.values(f).every(a=>!a)&&d.push(f)}return d}function Ce(e,t=","){const n=[];let o="",p=!1;for(let d=0;d<e.length;d++){const c=e[d];p?c==='"'?e[d+1]==='"'?(o+='"',d++):p=!1:o+=c:c==='"'?p=!0:c===t?(n.push(o),o=""):o+=c}return n.push(o),n}const Ht={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function qt(e,{toast:t}){const n=Object.keys(me);let o=n[0];const{data:p}=await w.from("formation_links_overrides").select("formation, links"),d={};(p||[]).forEach(g=>{d[g.formation]=g.links});let c=new Set;function l(g,s){return[g,s].sort().join("-")}function f(g){const s=d[g]||me[g]||[];c=new Set(s.map(([r,i])=>l(r,i)))}f(o),e.innerHTML=`
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;gap:12px;flex-wrap:wrap">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <select id="formation-select" style="padding:6px 10px;font-size:14px;border-radius:8px;border:1.5px solid #ccc">
          ${n.map(g=>`<option value="${g}" ${g===o?"selected":""}>${g}</option>`).join("")}
        </select>
  ...
  `;function a(){const g=ut[o]||{},s=we(o),r=320,i=400,b=22;function h(x){const u=g[x];return u?{x:u.x*r,y:u.y*i}:null}let E=`<svg width="${r}" height="${i}" viewBox="0 0 ${r} ${i}" xmlns="http://www.w3.org/2000/svg" style="display:block">`;s.forEach(([x,u],y)=>{const v=h(x),_=h(u);if(!v||!_)return;const B=l(x,u),I=c.has(B),S=I?"#3b82f6":"#999",L=I?.95:.35,z=I?4:3;E+=`<line x1="${v.x}" y1="${v.y}" x2="${_.x}" y2="${_.y}"
        ...
        opacity="${L}" pointer-events="none" data-line-key="${B}"/>`});for(const x of Object.keys(g)){const u=h(x);if(!u)continue;const y=x.replace(/\d+/,""),v=Ht[y]||"#555";E+=`<circle cx="${u.x}" cy="${u.y}" r="${b}" fill="${v}" stroke="rgba(255,255,255,0.7)" stroke-width="2" pointer-events="none"/>`,E+=`<text x="${u.x}" y="${u.y+4}" text-anchor="middle" font-size="10" font-weight="900" fill="white" font-family="Arial Black,Arial" pointer-events="none">${x}</text>`}E+="</svg>",document.getElementById("field-wrap").innerHTML=E;const m=document.getElementById("links-list");m.innerHTML=s.map(([x,u])=>{const y=l(x,u),v=c.has(y);return`
        ...
        </button>`}).join("");const $=e.querySelector('div[style*="font-weight:700;font-size:13px;margin-bottom:8px"]');$&&($.textContent=`Liens (${c.size}/${s.length} actifs)`);function k(x){c.has(x)?c.delete(x):c.add(x),a()}e.querySelectorAll(".link-hit").forEach(x=>{x.addEventListener("click",()=>k(x.dataset.key))}),e.querySelectorAll(".link-toggle").forEach(x=>{x.addEventListener("click",()=>k(x.dataset.key))})}a(),document.getElementById("formation-select").addEventListener("change",g=>{o=g.target.value,f(o),a()}),document.getElementById("reset-btn").addEventListener("click",()=>{const g=me[o]||[];c=new Set(g.map(([s,r])=>l(s,r))),a(),t("Liens réinitialisés aux valeurs par défaut (non sauvegardé)","info")}),document.getElementById("save-btn").addEventListener("click",async()=>{const s=we(o).filter(([i,b])=>c.has(l(i,b))),{error:r}=await w.from("formation_links_overrides").upsert({formation:o,links:s,updated_at:new Date().toISOString()});if(r){t(r.message,"error");return}d[o]=s,t(`Liens enregistrés pour ${o} (${s.length} actifs)`,"success")})}const Ot=[{value:"player",label:"Joueur"},{value:"formation",label:"Formation"},{value:"game_changer",label:"Game Changer"},{value:"ultra_game_changer",label:"Ultra Game Changer"},{value:"game_helper",label:"Game Helper"},{value:"stadium",label:"🏟️ Stade"}],Ut=[{value:"",label:"Toutes"},{value:"normal",label:"Normal"},{value:"pepite",label:"Pépite"},{value:"papyte",label:"Papyte"},{value:"legende",label:"Légende"}],Kt=[{value:"credits",label:"Crédits"},{value:"pub",label:"Publicité"},{value:"free",label:"Gratuit"}];async function Vt(e){e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">Chargement...</div>';const{data:t}=await w.from("booster_configs").select("*").order("sort_order");let n=null,o=[],p=null;const d=()=>window.innerWidth<700;async function c(){if(!n){o=[];return}if(n!==p){const{data:s}=await w.from("booster_drop_rates").select("*").eq("booster_id",n).order("sort_order");o=s||[],p=n}}function l(){return`
    ...
    </div>`;const r=o.reduce((b,h)=>b+Number(h.percentage||0),0),i=Math.abs(r-100)<.1;return`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="f-price-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${Kt.map(b=>`<option value="${b.value}" ${s.price_type===b.value?"selected":""}>${b.label}</option>`).join("")}
            </select>
          </div>
      ...
      <div style="background:#fff;border-radius:10px;padding:14px;margin-bottom:14px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;flex-wrap:wrap;gap:8px">
          <div>
            ...
            <span style="margin-left:10px;font-size:12px;color:${i?"#27ae60":"#e74c3c"};font-weight:700">
              Total : ${r.toFixed(1)}% ${i?"✅":"⚠️"}
            </span>
          </div>
        ...
        ${o.length===0?'<div style="text-align:center;padding:16px;color:#aaa;font-size:13px">Aucun taux. Cliquez + Ligne.</div>':o.map((b,h)=>`
          <div style="display:grid;grid-template-columns:2fr 1.5fr 50px 50px 60px 32px;gap:4px;align-items:center;margin-bottom:6px;padding:6px;background:#f9f9f9;border-radius:6px" data-rate-idx="${h}">
            <select class="rate-type" data-idx="${h}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${Ot.map(E=>`<option value="${E.value}" ${b.card_type===E.value?"selected":""}>${E.label}</option>`).join("")}
            </select>
            <select class="rate-rarity" data-idx="${h}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${Ut.map(E=>`<option value="${E.value}" ${(b.rarity||"")===E.value?"selected":""}>${E.label}</option>`).join("")}
            </select>
    ...
    </div>`}async function a(s=!1){s||await c();const r=!n&&d(),i=n&&d();e.innerHTML=`
    <div style="display:flex;height:calc(100vh - 56px);overflow:hidden">
      ${!d()||r||!n?l():""}
      ${!d()||i?f():""}
    </div>`,g()}function g(){var i,b,h,E,m,$,k;const s=x=>e.querySelector(x);e.querySelectorAll(".booster-row").forEach(x=>{x.addEventListener("click",u=>{u.target.closest(".btn-delete")||(n=x.dataset.id,p=null,a())})}),(i=s("#btn-back"))==null||i.addEventListener("click",()=>{n=null,a()}),(b=s("#btn-new"))==null||b.addEventListener("click",async()=>{const x=prompt("Nom du nouveau booster :");if(!(x!=null&&x.trim()))return;const{data:u,error:y}=await w.from("booster_configs").insert({name:x.trim(),price_type:"credits",price_credits:1e3,card_count:5}).select().single();if(y){alert(y.message);return}t.push(u),n=u.id,p=null,a()}),e.querySelectorAll(".btn-delete").forEach(x=>{x.addEventListener("click",async u=>{if(u.stopPropagation(),!confirm("Supprimer ce booster ?"))return;await w.from("booster_configs").delete().eq("id",x.dataset.id);const y=t.findIndex(v=>v.id===x.dataset.id);y>-1&&t.splice(y,1),n===x.dataset.id&&(n=null,p=null),a()})}),(h=s("#btn-cancel"))==null||h.addEventListener("click",()=>{n=null,a()}),(E=s("#f-price-type"))==null||E.addEventListener("change",x=>{const u=s("#credits-field");u&&(u.style.opacity=x.target.value!=="credits"?"0.4":"1")}),(m=s("#btn-pick-icon"))==null||m.addEventListener("click",async()=>{var u;const x=s("#icon-picker-grid");if(x){if(x.style.display!=="none"){x.style.display="none";return}x.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',x.style.display="block";try{const v=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),_=Array.isArray(v)?v.filter(I=>I.name.startsWith("booster")&&/\.(png|jpg|svg|webp)$/i.test(I.name)):[];if(!_.length){x.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucune icône "booster*" trouvée.</div>';return}const B=((u=s("#f-image-url"))==null?void 0:u.value)||"";x.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
          ${_.map(I=>`
        ...
        </div>`,x.querySelectorAll(".icon-pick-item").forEach(I=>{I.addEventListener("click",()=>{const S=s("#f-image-url");S&&(S.value=I.dataset.name),x.style.display="none"})})}catch(y){x.innerHTML=`<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Erreur API GitHub : ${y.message}</div>`}}});function r(){e.querySelectorAll("[data-rate-idx]").forEach(x=>{var y,v,_,B,I;const u=Number(x.dataset.rateIdx);u>=0&&u<o.length&&(o[u].card_type=((y=x.querySelector(".rate-type"))==null?void 0:y.value)||"player",o[u].rarity=((v=x.querySelector(".rate-rarity"))==null?void 0:v.value)||null,o[u].note_min=Number((_=x.querySelector(".rate-note-min"))==null?void 0:_.value)||null,o[u].note_max=Number((B=x.querySelector(".rate-note-max"))==null?void 0:B.value)||null,o[u].percentage=Number((I=x.querySelector(".rate-pct"))==null?void 0:I.value)||0)})}($=s("#btn-add-rate"))==null||$.addEventListener("click",()=>{r(),o.push({id:null,booster_id:n,card_type:"player",rarity:"normal",note_min:null,note_max:null,percentage:10,sort_order:o.length}),a(!0)}),e.querySelectorAll(".btn-del-rate").forEach(x=>{x.addEventListener("click",()=>{r(),o.splice(Number(x.dataset.idx),1),a(!0)})}),(k=s("#btn-save"))==null||k.addEventListener("click",async()=>{var B,I,S,L,z,A,P,F,G,H,R,q,j;const x=(t||[]).find(C=>C.id===n);if(!x)return;const u=[];e.querySelectorAll("[data-rate-idx]").forEach(C=>{var W,Y,Z,X,Q;const K=Number(C.dataset.rateIdx);u.push({booster_id:n,card_type:((W=C.querySelector(".rate-type"))==null?void 0:W.value)||"player",rarity:((Y=C.querySelector(".rate-rarity"))==null?void 0:Y.value)||null,note_min:Number((Z=C.querySelector(".rate-note-min"))==null?void 0:Z.value)||null,note_max:Number((X=C.querySelector(".rate-note-max"))==null?void 0:X.value)||null,percentage:Number((Q=C.querySelector(".rate-pct"))==null?void 0:Q.value)||0,sort_order:K});const D=u[u.length-1];D.rarity||(D.rarity=null),D.note_min||(D.note_min=null),D.note_max||(D.note_max=null)});const y=u.reduce((C,K)=>C+K.percentage,0);if(u.length&&Math.abs(y-100)>.5){alert(`La somme doit faire 100% (actuellement ${y.toFixed(1)}%)`);return}const v={name:((I=(B=s("#f-name"))==null?void 0:B.value)==null?void 0:I.trim())||x.name,image_url:((L=(S=s("#f-image-url"))==null?void 0:S.value)==null?void 0:L.trim())||null,price_type:(z=s("#f-price-type"))==null?void 0:z.value,price_credits:Number((A=s("#f-price-credits"))==null?void 0:A.value)||0,card_count:Number((P=s("#f-card-count"))==null?void 0:P.value)||5,is_active:((F=s("#f-active"))==null?void 0:F.checked)??x.is_active,allow_duplicates:((G=s("#f-allow-dup"))==null?void 0:G.checked)??!0,sort_order:Number((H=s("#f-sort"))==null?void 0:H.value)||0,max_per_user:(R=s("#f-max-per-user"))!=null&&R.value?Number(s("#f-max-per-user").value):null,available_from:((q=s("#f-available-from"))==null?void 0:q.value)||null,available_until:((j=s("#f-available-until"))==null?void 0:j.value)||null},{error:_}=await w.from("booster_configs").update(v).eq("id",n);if(_){alert(_.message);return}if(Object.assign(x,v),await w.from("booster_drop_rates").delete().eq("booster_id",n),u.length){const{error:C}=await w.from("booster_drop_rates").insert(u);if(C){alert(C.message);return}}o=u,p=n,alert("✅ Booster enregistré !"),a(!0)})}a()}const Ze=[{value:"normal",label:"Normal",color:"#888"},{value:"pepite",label:"Pépite",color:"#D4A017"},{value:"papyte",label:"Papyte",color:"#909090"},{value:"legende",label:"Légende",color:"#7a28b8"}];async function Jt(e){await fe(e)}async function fe(e){const{data:t,error:n}=await w.from("sell_price_configs").select("*").order("rarity").order("note_min");if(n){e.innerHTML=`<div style="padding:24px;color:red">Erreur : ${n.message}</div>`;return}e.innerHTML=`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px">
          <div>
            ...
            <select id="form-rarity" style="width:100%;padding:9px;border:1.5px solid #ddd;border-radius:8px;font-size:14px">
              ${Ze.map(o=>`<option value="${o.value}">${o.label}</option>`).join("")}
            </select>
          </div>
          <div>
    ...
    </div>`,document.getElementById("add-config").addEventListener("click",()=>ze(null)),document.getElementById("form-cancel").addEventListener("click",()=>{document.getElementById("config-form").style.display="none"}),document.getElementById("form-save").addEventListener("click",()=>Yt(e)),e.querySelectorAll("[data-edit]").forEach(o=>{const p=(t||[]).find(d=>d.id===o.dataset.edit);p&&o.addEventListener("click",()=>ze(p))}),e.querySelectorAll("[data-delete]").forEach(o=>{o.addEventListener("click",async()=>{confirm("Supprimer cette règle ?")&&(await w.from("sell_price_configs").delete().eq("id",o.dataset.delete),await fe(e))})})}function Wt(e){const t=Ze.find(n=>n.value===e.rarity);return`
    ...
    </tr>`}function ze(e){document.getElementById("config-form").style.display="block",document.getElementById("form-title").textContent=e?"Modifier la règle":"Nouvelle règle",document.getElementById("form-id").value=(e==null?void 0:e.id)||"",document.getElementById("form-rarity").value=(e==null?void 0:e.rarity)||"normal",document.getElementById("form-price").value=(e==null?void 0:e.price)||1e3,document.getElementById("form-note-min").value=(e==null?void 0:e.note_min)??1,document.getElementById("form-note-max").value=(e==null?void 0:e.note_max)??10,document.getElementById("config-form").scrollIntoView({behavior:"smooth"})}async function Yt(e){const t=document.getElementById("form-id").value,n=document.getElementById("form-rarity").value,o=parseInt(document.getElementById("form-price").value)||0,p=parseInt(document.getElementById("form-note-min").value)||1,d=parseInt(document.getElementById("form-note-max").value)||10;if(p>d){alert("Note min doit être ≤ note max");return}const c={rarity:n,price:o,note_min:p,note_max:d,updated_at:new Date().toISOString()};let l;if(t?{error:l}=await w.from("sell_price_configs").update(c).eq("id",t):{error:l}=await w.from("sell_price_configs").insert(c),l){alert("Erreur : "+l.message);return}document.getElementById("config-form").style.display="none",await fe(e)}async function Zt(e){await be(e)}async function be(e){const{data:t}=await w.from("patch_notes").select("*").order("published_at",{ascending:!1});e.innerHTML=`
    <div style="padding:20px;max-width:760px;margin:0 auto">
      ...
      <div id="articles-list" style="display:flex;flex-direction:column;gap:12px">
        ${(t||[]).map(n=>Xt(n)).join("")||`<div style="color:#aaa;padding:24px;text-align:center">Aucun article pour l'instant.</div>`}
      </div>
    ...
    </div>`,document.getElementById("add-article").addEventListener("click",()=>Ae(null)),document.getElementById("form-cancel").addEventListener("click",()=>{document.getElementById("article-form").style.display="none"}),document.getElementById("form-save").addEventListener("click",()=>Qt(e)),e.querySelectorAll("[data-edit]").forEach(n=>{const o=(t||[]).find(p=>p.id===n.dataset.edit);o&&n.addEventListener("click",()=>Ae(o))}),e.querySelectorAll("[data-delete]").forEach(n=>{n.addEventListener("click",async()=>{confirm("Supprimer cet article ?")&&(await w.from("patch_notes").delete().eq("id",n.dataset.delete),await be(e))})})}function Xt(e){const t=new Date(e.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"short",year:"numeric"});return`
    ...
    </div>`}function Ae(e){const t=document.getElementById("article-form");t.style.display="block",document.getElementById("form-title").textContent=e?"Modifier l'article":"Nouvel article",document.getElementById("form-id").value=(e==null?void 0:e.id)||"",document.getElementById("form-art-title").value=(e==null?void 0:e.title)||"",document.getElementById("form-art-desc").value=(e==null?void 0:e.description)||"",document.getElementById("form-art-img").value=(e==null?void 0:e.image_url)||"",document.getElementById("form-art-pub").checked=e?e.is_published:!0;const n=new Date((e==null?void 0:e.published_at)||Date.now()),o=new Date(n.getTime()-n.getTimezoneOffset()*6e4).toISOString().slice(0,16);document.getElementById("form-art-date").value=o,t.scrollIntoView({behavior:"smooth"})}async function Qt(e){const t=document.getElementById("form-id").value,n=document.getElementById("form-art-title").value.trim(),o=document.getElementById("form-art-desc").value.trim(),p=document.getElementById("form-art-img").value.trim()||null,d=document.getElementById("form-art-pub").checked,c=document.getElementById("form-art-date").value;if(!n){alert("Le titre est obligatoire.");return}if(!o){alert("La description est obligatoire.");return}const l=c?new Date(c).toISOString():new Date().toISOString(),f={title:n,description:o,image_url:p,is_published:d,published_at:l};let a;if(t?{error:a}=await w.from("patch_notes").update(f).eq("id",t):{error:a}=await w.from("patch_notes").insert(f),a){alert("Erreur : "+a.message);return}document.getElementById("article-form").style.display="none",await be(e)}async function en(e){await J(e)}async function J(e){var g,s,r,i,b,h,E,m,$,k,x,u;const{data:t}=await w.from("tutorial_steps").select("*").order("step_order");e.innerHTML=`
    <div style="padding:20px;max-width:820px;margin:0 auto">
      ...
      <div id="ts-form" style="display:none;margin-top:24px;background:#fff;border-radius:12px;padding:20px;box-shadow:0 1px 8px rgba(0,0,0,0.1)">
        ...
        <div style="display:flex;gap:10px">
    ...
    </div>`,(g=document.getElementById("ts-add"))==null||g.addEventListener("click",()=>Me(null,(t==null?void 0:t.length)||0)),(s=document.getElementById("ts-reset"))==null||s.addEventListener("click",async()=>{if(!confirm("Remettre tutorial_done = false pour TOUS les joueurs ? Ils reverront le tutoriel à leur prochaine connexion."))return;const{error:y}=await w.from("users").update({tutorial_done:!1}).neq("id","00000000-0000-0000-0000-000000000000");alert(y?"Erreur : "+y.message:"✅ Tutorial_done réinitialisé pour tous les joueurs.")}),(r=document.getElementById("ts-cancel"))==null||r.addEventListener("click",Xe),(i=document.getElementById("ts-save"))==null||i.addEventListener("click",()=>on(e)),(b=document.getElementById("ts-preview-btn"))==null||b.addEventListener("click",nn);const n=document.getElementById("ts-editor"),o=()=>{const y=document.getElementById("ts-content");y&&n&&(y.value=n.innerHTML)};n==null||n.addEventListener("input",o),n==null||n.addEventListener("blur",o);const p=()=>{document.activeElement!==n&&(n==null||n.focus())};(h=document.getElementById("ts-toolbar"))==null||h.querySelectorAll("[data-cmd]").forEach(y=>{y.addEventListener("mousedown",v=>{v.preventDefault(),p();const _=y.dataset.cmd;_.startsWith("formatBlock:")?document.execCommand("formatBlock",!1,_.split(":")[1]):document.execCommand(_,!1,null),o()})}),(E=document.getElementById("ts-insert-color"))==null||E.addEventListener("mousedown",y=>{y.preventDefault(),p();const v=prompt("Couleur hex (ex: #D4A017 pour or, #1A6B3C pour vert, #cc2222 pour rouge) :");v&&(document.execCommand("foreColor",!1,v),o())}),(m=document.getElementById("ts-clear-format"))==null||m.addEventListener("mousedown",y=>{y.preventDefault(),p(),document.execCommand("removeFormat",!1,null),o()}),n==null||n.addEventListener("focus",()=>{n&&(n.style.borderColor="#1A6B3C")}),n==null||n.addEventListener("blur",()=>{n&&(n.style.borderColor="#ddd")});const d=document.getElementById("ts-image"),c=document.getElementById("ts-img-preview"),l=document.getElementById("ts-img-preview-el"),f=document.getElementById("ts-img-picker-grid"),a=()=>{var v;const y=(v=d==null?void 0:d.value)==null?void 0:v.trim();if(y){const _="/";l.src=`${_}icons/${y}`,c.style.display="block"}else c.style.display="none"};d==null||d.addEventListener("input",a),($=document.getElementById("ts-img-clear"))==null||$.addEventListener("click",()=>{d&&(d.value=""),c.style.display="none",f.style.display="none"}),(k=document.getElementById("ts-img-pick"))==null||k.addEventListener("click",async()=>{if(f.style.display!=="none"){f.style.display="none";return}f.innerHTML='<div style="color:#aaa;font-size:12px">Chargement…</div>',f.style.display="block";try{const v=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),_=Array.isArray(v)?v.filter(I=>I.name.startsWith("tuto_")):[];if(!_.length){f.innerHTML='<div style="color:#aaa;font-size:12px">Aucun fichier tuto_* trouvé dans /icons/.<br>Uploade des images nommées tuto_xxx.png dans public/icons/</div>';return}const B="/";f.innerHTML='<div style="display:flex;flex-wrap:wrap;gap:8px">'+_.map(I=>`
          ...
          </div>`).join("")+"</div>",f.querySelectorAll("[data-pick]").forEach(I=>{I.addEventListener("click",()=>{d&&(d.value=I.dataset.pick),a(),f.style.display="none"})})}catch(y){f.innerHTML='<div style="color:#cc2222;font-size:12px">Erreur chargement : '+y.message+"</div>"}}),(x=document.getElementById("ts-color"))==null||x.addEventListener("input",y=>{const v=document.getElementById("ts-color-hex");v&&(v.value=y.target.value)}),(u=document.getElementById("ts-color-hex"))==null||u.addEventListener("input",y=>{const v=y.target.value;if(/^#[0-9a-fA-F]{6}$/.test(v)){const _=document.getElementById("ts-color");_&&(_.value=v)}}),e.querySelectorAll("[data-edit]").forEach(y=>{const v=(t||[]).find(_=>_.id===y.dataset.edit);v&&y.addEventListener("click",()=>Me(v))}),e.querySelectorAll("[data-delete]").forEach(y=>{y.addEventListener("click",async()=>{confirm("Supprimer cette étape ?")&&(await w.from("tutorial_steps").delete().eq("id",y.dataset.delete),J(e))})}),e.querySelectorAll("[data-toggle]").forEach(y=>{y.addEventListener("click",async()=>{const v=(t||[]).find(_=>_.id===y.dataset.toggle);v&&(await w.from("tutorial_steps").update({is_active:!v.is_active}).eq("id",v.id),J(e))})}),e.querySelectorAll("[data-up]").forEach(y=>{y.addEventListener("click",async()=>{const v=t||[],_=v.findIndex(B=>B.id===y.dataset.up);_<=0||(await Promise.all([w.from("tutorial_steps").update({step_order:v[_-1].step_order}).eq("id",v[_].id),w.from("tutorial_steps").update({step_order:v[_].step_order}).eq("id",v[_-1].id)]),J(e))})}),e.querySelectorAll("[data-down]").forEach(y=>{y.addEventListener("click",async()=>{const v=t||[],_=v.findIndex(B=>B.id===y.dataset.down);_<0||_>=v.length-1||(await Promise.all([w.from("tutorial_steps").update({step_order:v[_+1].step_order}).eq("id",v[_].id),w.from("tutorial_steps").update({step_order:v[_].step_order}).eq("id",v[_+1].id)]),J(e))})})}function tn(e){return`
  <div style="background:#fff;border-radius:10px;padding:12px 16px;box-shadow:0 1px 4px rgba(0,0,0,0.08);display:flex;align-items:center;gap:12px">
  ...
  </div>`}function Me(e,t=0){document.getElementById("ts-form").style.display="block",document.getElementById("ts-form-title").textContent=e?"Modifier l'étape":"Nouvelle étape",document.getElementById("ts-id").value=(e==null?void 0:e.id)||"",document.getElementById("ts-emoji").value=(e==null?void 0:e.emoji)||"⚽",document.getElementById("ts-title").value=(e==null?void 0:e.title)||"",document.getElementById("ts-content").value=(e==null?void 0:e.content)||"";const n=document.getElementById("ts-editor");n&&(n.innerHTML=(e==null?void 0:e.content)||"<p>Texte de l'étape…</p>"),document.getElementById("ts-order").value=(e==null?void 0:e.step_order)??t,document.getElementById("ts-active").checked=e?e.is_active:!0;const o=(e==null?void 0:e.color)||"#1A6B3C";document.getElementById("ts-color").value=o,document.getElementById("ts-color-hex").value=o;const p=(e==null?void 0:e.image_url)||"",d=document.getElementById("ts-image");d&&(d.value=p);const c=document.getElementById("ts-img-preview"),l=document.getElementById("ts-img-preview-el");if(p&&c&&l){const f="/";l.src=`${f}icons/${p}`,c.style.display="block"}else c&&(c.style.display="none");document.getElementById("ts-img-picker-grid").style.display="none",document.getElementById("ts-preview-area").innerHTML="",document.getElementById("ts-form").scrollIntoView({behavior:"smooth"})}function Xe(){document.getElementById("ts-form").style.display="none",document.getElementById("ts-preview-area").innerHTML=""}function nn(){var a,g;const e=document.getElementById("ts-emoji").value||"⚽",t=document.getElementById("ts-title").value||"Titre",n=document.getElementById("ts-editor"),o=n?n.innerHTML:document.getElementById("ts-content").value||"",p=document.getElementById("ts-color-hex").value||"#1A6B3C",d=(g=(a=document.getElementById("ts-image"))==null?void 0:a.value)==null?void 0:g.trim(),l=d?`<div style="padding:0 20px 12px;text-align:center"><img src="/icons/${d}" style="max-height:140px;max-width:100%;border-radius:10px;object-fit:contain"></div>`:"",f=document.getElementById("ts-preview-area");f.innerHTML=`
    ...
    <div style="background:rgba(0,0,0,0.5);border-radius:14px;padding:12px;margin-bottom:8px">
      <div style="background:#fff;border-radius:16px;overflow:hidden;max-width:380px;margin:0 auto;box-shadow:0 16px 48px rgba(0,0,0,0.4)">
        ...
        ${l}
        <div style="padding:${d?"4":"14"}px 20px 18px;font-size:13px;color:#333;line-height:1.7">${o}</div>
    ...
    </div>`,f.querySelectorAll("ul,ol").forEach(s=>{s.style.paddingLeft="20px",s.style.margin="6px 0"}),f.querySelectorAll("li").forEach(s=>{s.style.marginBottom="4px"}),f.querySelectorAll("p").forEach(s=>{s.style.marginBottom="8px"})}async function on(e){var s,r;const t=document.getElementById("ts-id").value,n=document.getElementById("ts-emoji").value.trim()||"⚽",o=document.getElementById("ts-title").value.trim(),p=document.getElementById("ts-editor"),d=(p?p.innerHTML:document.getElementById("ts-content").value).trim(),c=document.getElementById("ts-color-hex").value.trim()||"#1A6B3C",l=parseInt(document.getElementById("ts-order").value)||0,f=document.getElementById("ts-active").checked;if(!o||!d){alert("Titre et contenu sont obligatoires.");return}const a={emoji:n,title:o,content:d,color:c,step_order:l,is_active:f,image_url:((r=(s=document.getElementById("ts-image"))==null?void 0:s.value)==null?void 0:r.trim())||null};let g;if(t?{error:g}=await w.from("tutorial_steps").update(a).eq("id",t):{error:g}=await w.from("tutorial_steps").insert(a),g){alert("Erreur : "+g.message);return}Xe(),J(e)}const an="/",rn=[["MA","Maroc"],["FR","France"],["AR","Argentine"],["PT","Portugal"],["BR","Brésil"],["ES","Espagne"],["DE","Allemagne"],["GB","Angleterre"],["IT","Italie"],["CM","Cameroun"],["SN","Sénégal"],["NG","Nigéria"],["DK","Danemark"],["NL","Pays-Bas"],["BE","Belgique"],["CI","Côte d'Ivoire"],["AL","Albanie"],["HR","Croatie"],["RS","Serbie"],["TR","Turquie"],["MW","Malawi"],["GH","Ghana"],["ZA","Afrique du Sud"],["EG","Égypte"],["US","États-Unis"],["MX","Mexique"],["CO","Colombie"],["UY","Uruguay"],["CL","Chili"],["JP","Japon"],["KR","Corée du Sud"],["CN","Chine"],["AU","Australie"],["SW","Suisse"],["SE","Suède"],["NO","Norvège"],["PL","Pologne"]];async function ln(e){await ye(e)}async function ye(e){var o,p,d,c;const[{data:t},{data:n}]=await Promise.all([w.from("stadium_definitions").select("*, club:clubs(encoded_name, logo_url)").order("name"),w.from("clubs").select("id, encoded_name, logo_url").order("encoded_name")]);e.innerHTML=`
    <div style="padding:20px;max-width:820px;margin:0 auto">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px" id="st-list">
        ${(t||[]).map(l=>sn(l)).join("")||'<div style="color:#aaa;padding:24px;text-align:center">Aucun stade créé.</div>'}
      </div>
          ...
          <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
            ...
            <div>
              ...
              <select id="st-country" style="width:100%;box-sizing:border-box;padding:9px;border:1.5px solid #ddd;border-radius:8px;font-size:13px;background:#fff">
                ...
                ${rn.map(([l,f])=>`<option value="${l}">${f} (${l})</option>`).join("")}
              </select>
            </div>
            <div>
    ...
    </div>`,(o=document.getElementById("st-add-btn"))==null||o.addEventListener("click",()=>Te(null)),(p=document.getElementById("st-cancel"))==null||p.addEventListener("click",()=>{document.getElementById("st-form").style.display="none"}),(d=document.getElementById("st-save"))==null||d.addEventListener("click",()=>dn(e)),(c=document.getElementById("st-preview-btn"))==null||c.addEventListener("click",()=>se()),["st-name","st-club","st-country","st-image"].forEach(l=>{var f,a;(f=document.getElementById(l))==null||f.addEventListener("input",se),(a=document.getElementById(l))==null||a.addEventListener("change",se)}),e.querySelectorAll("[data-edit]").forEach(l=>{const f=(t||[]).find(a=>a.id===l.dataset.edit);f&&l.addEventListener("click",()=>Te(f))}),e.querySelectorAll("[data-delete]").forEach(l=>{l.addEventListener("click",async()=>{confirm("Supprimer ce stade ?")&&(await w.from("stadium_definitions").delete().eq("id",l.dataset.delete),ye(e))})})}function sn(e){var n,o;let t;return(n=e.club)!=null&&n.logo_url?t=`<img src="${e.club.logo_url}" style="width:32px;height:32px;object-fit:contain">`:e.country_code?t=`<img src="https://flagsapi.com/${e.country_code.slice(0,2).toUpperCase()}/flat/32.png" style="width:32px;height:24px;object-fit:contain;border-radius:3px" onerror="this.style.display='none'">`:t='<span style="font-size:20px">🌍</span>',`
    <div style="background:#fff;border-radius:10px;padding:12px 16px;box-shadow:0 1px 4px rgba(0,0,0,0.08);display:flex;align-items:center;gap:12px">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:11px;color:#888">${((o=e.club)==null?void 0:o.encoded_name)||e.country_code||"—"}</div>
      </div>
      <button data-edit="${e.id}" class="btn btn-ghost btn-sm">✏️</button>
      <button data-delete="${e.id}" class="btn btn-ghost btn-sm" style="color:#cc2222">🗑️</button>
    </div>`}function Te(e,t){var o,p;document.getElementById("st-form").style.display="block",document.getElementById("st-form-title").textContent=e?"Modifier le stade":"Nouveau stade",document.getElementById("st-id").value=(e==null?void 0:e.id)||"",document.getElementById("st-name").value=(e==null?void 0:e.name)||"",document.getElementById("st-club").value=(e==null?void 0:e.club_id)||"";const n=document.getElementById("st-country");n&&(n.value=(e==null?void 0:e.country_code)||""),document.getElementById("st-image").value=(e==null?void 0:e.image_url)||"",document.getElementById("st-preview-card").innerHTML="",se((o=e==null?void 0:e.club)==null?void 0:o.logo_url,(p=e==null?void 0:e.club)==null?void 0:p.encoded_name),document.getElementById("st-form").scrollIntoView({behavior:"smooth"})}function se(){var a,g,s,r,i,b,h;const e=((a=document.getElementById("st-name"))==null?void 0:a.value)||"NOM DU STADE",t=(s=(g=document.getElementById("st-image"))==null?void 0:g.value)==null?void 0:s.trim(),n=(i=(r=document.getElementById("st-country"))==null?void 0:r.value)==null?void 0:i.trim(),o=document.getElementById("st-club"),p=(o==null?void 0:o.selectedIndex)||0,d=o&&p>0?o.options[p].text:"",c=((h=(b=o==null?void 0:o.options[p])==null?void 0:b.getAttribute)==null?void 0:h.call(b,"data-logo"))||"";let l=null;t?l=`${an}icons/${t}`:c?l=c:n&&(l=`https://flagsapi.com/${n.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`);const f=d||n||"—";document.getElementById("st-preview-card").innerHTML=mt(e,l,`${f}<br>+10 ⭐`,{width:140})}async function dn(e){const t=document.getElementById("st-id").value,n=document.getElementById("st-name").value.trim(),o=document.getElementById("st-club").value||null,p=document.getElementById("st-country").value.trim().toUpperCase()||null,d=document.getElementById("st-image").value.trim()||null;if(!n){alert("Le nom est obligatoire");return}const c={name:n,club_id:o,country_code:p,image_url:d},{error:l}=t?await w.from("stadium_definitions").update(c).eq("id",t):await w.from("stadium_definitions").insert(c);if(l){alert("Erreur : "+l.message);return}document.getElementById("st-form").style.display="none",ye(e)}const O=[{value:"game_changer",label:"⚡ Game Changer",border:"#7a28b8",bg:"linear-gradient(135deg,#4a0080,#7a28b8)"},{value:"ultra_game_changer",label:"💎 Ultra Game Changer",border:"#00bcd4",bg:"linear-gradient(135deg,#006080,#00bcd4)"}],ie=[{value:"purple",label:"Violet",hex:"#7a28b8"},{value:"light_blue",label:"Bleu clair",hex:"#00bcd4"}];async function cn(e){e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">Chargement...</div>';const{data:t}=await w.from("gc_definitions").select("*").order("sort_order").order("created_at");let n=null;const o=[{value:"BOOST_STAT",label:"⚡ Boost stats (+N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"DEBUFF_STAT",label:"💀 Debuff stats (-N)",hasValue:!0,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"GRAY_PLAYER",label:"❄️ Griser un joueur",hasValue:!1,hasTarget:!0,hasCount:!0,hasRoles:!0},{value:"REVIVE_PLAYER",label:"💫 Ressusciter un joueur",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"REMOVE_GOAL",label:"🚫 Retirer un but adverse",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_GOAL_DRAW",label:"⚽ +1 but si duel nul",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1},{value:"ADD_SUB",label:"🔄 Ajouter un remplacement",hasValue:!1,hasTarget:!1,hasCount:!0,hasRoles:!1},{value:"CUSTOM",label:"🛠️ Effet custom (hardcodé)",hasValue:!1,hasTarget:!1,hasCount:!1,hasRoles:!1}],p=["GK","DEF","MIL","ATT"],d=()=>window.innerWidth<700,c=r=>e.querySelector(r);function l(r,i=130){if(!r)return"";const b=O.find(E=>E.value===r.gc_type)||O[0],h=r.image_url?`/icons/${r.image_url}`:null;return gt(r.name||"?",h,b.label.split(" ")[0],r.effect||"",{width:i})}function f(){return`
    <div id="gc-list" style="background:#fff;${d()?"":"border-right:1px solid #e0e0e0;width:280px;flex-shrink:0;"}overflow-y:auto;height:100%">
      ...
      ${(t||[]).map(r=>{const i=O.find(h=>h.value===r.gc_type)||O[0],b=ie.find(h=>h.value===r.color)||ie[0];return`
        <div class="gc-row" data-id="${r.id}"
          ...
          <div style="width:36px;height:50px;border-radius:5px;border:2px solid ${b.hex};background:${i.bg};display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">
            ${r.image_url?`<img src="/icons/${r.image_url}" style="width:28px;height:28px;object-fit:contain">`:i.label.split(" ")[0]}
          </div>
          <div style="flex:1;min-width:0">
            <div style="font-size:13px;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${r.name}</div>
            <div style="font-size:11px;color:#888">${i.label} · ${r.is_active?"✅ Actif":"⛔ Inactif"}</div>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;flex-shrink:0">
    ...
    </div>`}function a(){const r=n?(t||[]).find(i=>i.id===n):null;return r?(O.find(i=>i.value===r.gc_type)||O[0],ie.find(i=>i.value===r.color)||ie[0],`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="gc-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${O.map(i=>`<option value="${i.value}" ${r.gc_type===i.value?"selected":""}>${i.label}</option>`).join("")}
            </select>
          </div>
          <div>
            ...
            <select id="gc-color" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${ie.map(i=>`<option value="${i.value}" ${r.color===i.value?"selected":""}>${i.label}</option>`).join("")}
            </select>
          </div>
        </div>
        ...
        <div style="border-top:1px solid #eee;padding-top:12px;margin-top:4px">
          ...
          <div>
            ...
            <select id="gc-effect-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px;margin-bottom:10px">
              ${o.map(i=>`<option value="${i.value}" ${(r.effect_type||"BOOST_STAT")===i.value?"selected":""}>${i.label}</option>`).join("")}
            </select>
          </div>
          ${(()=>{const i=r.effect_params||{},b=o.find(h=>h.value===(r.effect_type||"BOOST_STAT"))||o[0];return`
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
              ${b.hasValue?`<div>
                <label style="font-size:10px;color:#666;font-weight:700;display:block;margin-bottom:3px">VALEUR (+N)</label>
                <input id="gc-p-value" type="number" min="1" max="5" value="${i.value||2}" style="width:100%;padding:7px;border:1px solid #ddd;border-radius:4px;font-size:13px;box-sizing:border-box">
              </div>`:""}
              ${b.hasCount?`<div>
                <label style="font-size:10px;color:#666;font-weight:700;display:block;margin-bottom:3px">NB JOUEURS</label>
                <input id="gc-p-count" type="number" min="1" max="11" value="${i.count||1}" style="width:100%;padding:7px;border:1px solid #ddd;border-radius:4px;font-size:13px;box-sizing:border-box">
              </div>`:""}
              ${b.hasTarget?`<div>
                ...
                <select id="gc-p-target" style="width:100%;padding:7px;border:1px solid #ddd;border-radius:4px;font-size:13px">
                  <option value="home" ${(i.target||"home")==="home"?"selected":""}>Mon équipe</option>
                  <option value="opponent" ${i.target==="opponent"?"selected":""}>Équipe adverse</option>
                </select>
              </div>`:""}
              ${b.hasRoles?`<div>
                ...
                <div style="display:flex;gap:4px;flex-wrap:wrap">
                  ${p.map(h=>`<label style="display:flex;align-items:center;gap:2px;font-size:11px;cursor:pointer">
                    <input type="checkbox" class="gc-p-role" value="${h}" ${!i.roles||i.roles.includes(h)?"checked":""}> ${h}
                  </label>`).join("")}
                </div>
              </div>`:""}
            </div>`})()}
    ...
    <div style="display:flex;height:calc(100vh - 56px);overflow:hidden">
      ${!d()||!n?f():""}
      ${!d()||n?a():""}
    </div>`,s()}function s(){var r,i,b,h,E;e.querySelectorAll(".gc-row").forEach(m=>{m.addEventListener("click",$=>{$.target.closest(".btn-toggle-gc,.btn-delete-gc")||(n=m.dataset.id,g())})}),(r=c("#btn-gc-back"))==null||r.addEventListener("click",()=>{n=null,g()}),(i=c("#btn-cancel-gc"))==null||i.addEventListener("click",()=>{n=null,g()}),(b=c("#btn-new-gc"))==null||b.addEventListener("click",async()=>{const m=prompt("Nom de la carte Game Changer :");if(!(m!=null&&m.trim()))return;const{data:$,error:k}=await w.from("gc_definitions").insert({name:m.trim(),gc_type:"game_changer",color:"purple"}).select().single();if(k){alert(k.message);return}t.push($),n=$.id,g()}),e.querySelectorAll(".btn-toggle-gc").forEach(m=>{m.addEventListener("click",async $=>{$.stopPropagation();const k=m.dataset.active!=="true";await w.from("gc_definitions").update({is_active:k}).eq("id",m.dataset.id);const x=t.find(u=>u.id===m.dataset.id);x&&(x.is_active=k),g()})}),e.querySelectorAll(".btn-delete-gc").forEach(m=>{m.addEventListener("click",async $=>{if($.stopPropagation(),!confirm("Supprimer cette carte Game Changer ?"))return;await w.from("gc_definitions").delete().eq("id",m.dataset.id);const k=t.findIndex(x=>x.id===m.dataset.id);k>-1&&t.splice(k,1),n===m.dataset.id&&(n=null),g()})}),(h=c("#btn-pick-gc-icon"))==null||h.addEventListener("click",async()=>{var $;const m=c("#gc-icon-picker");if(m){if(m.style.display!=="none"){m.style.display="none";return}m.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',m.style.display="block";try{const x=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),u=Array.isArray(x)?x.filter(v=>v.name.startsWith("gamechanger-")&&/\.(png|jpg|svg|webp)$/i.test(v.name)):[];if(!u.length){m.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucun fichier "gamechanger-*" trouvé dans public/icons/</div>';return}const y=(($=c("#gc-image-url"))==null?void 0:$.value)||"";m.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
          ${u.map(v=>`
    ...
    <div style="display:flex;flex-direction:column;gap:20px">
      ...
      <div class="card-panel" style="background:linear-gradient(135deg,#0a3d1e,#1a6b3c20);border:1.5px solid #1A6B3C40">
        ...
        <div style="display:flex;flex-direction:column;gap:4px">
          ${r.map(u=>{const y=E[u],v=s.length>0?Math.round(y/s.length*100):0;return`
              <div style="display:flex;align-items:center;gap:8px;font-size:12px">
                <span style="width:80px">${h[u]} ${i[u]}</span>
    ...
    </div>`,(x=document.getElementById("create-season-btn"))==null||x.addEventListener("click",()=>{je(null,{toast:n,openModal:o,closeModal:p,reload:()=>V(e,t)})}),e.querySelectorAll("[data-edit]").forEach(u=>{const y=f.find(v=>v.id==u.dataset.edit);u.addEventListener("click",()=>{je(y,{toast:n,openModal:o,closeModal:p,reload:()=>V(e,t)})})}),e.querySelectorAll("[data-activate]").forEach(u=>{u.addEventListener("click",async()=>{const y=parseInt(u.dataset.activate);if(!confirm("Activer cette saison ? La saison actuellement active sera désactivée."))return;const{error:v}=await w.from("ranked_seasons").update({is_active:!1}).neq("id",0);if(v){n(v.message,"error");return}const{error:_}=await w.from("ranked_seasons").update({is_active:!0}).eq("id",y);if(_){n(_.message,"error");return}await w.from("users").update({current_season_id:y}).gt("placement_matches",0),n("Saison activée ✅","success"),V(e,t)})}),e.querySelectorAll("[data-deactivate]").forEach(u=>{u.addEventListener("click",async()=>{if(!confirm("Désactiver la saison active ? Le mode Ranked sera suspendu."))return;const{error:y}=await w.from("ranked_seasons").update({is_active:!1}).eq("id",parseInt(u.dataset.deactivate));if(y){n(y.message,"error");return}n("Saison désactivée","success"),V(e,t)})}),e.querySelectorAll("[data-delete]").forEach(u=>{u.addEventListener("click",async()=>{if(!confirm("Supprimer cette saison archivée ?"))return;const{error:y}=await w.from("ranked_seasons").delete().eq("id",parseInt(u.dataset.delete));if(y){n(y.message,"error");return}n("Saison supprimée","success"),V(e,t)})})}function je(e,{toast:t,openModal:n,closeModal:o,reload:p}){const d=!!e,c=new Date().toISOString().slice(0,16),l=new Date(Date.now()+90*864e5).toISOString().slice(0,16),f=e?new Date(e.start_at).toISOString().slice(0,16):c,a=e?new Date(e.end_at).toISOString().slice(0,16):l,g=(e==null?void 0:e.name)||"";n(d?"✏️ Modifier la saison":"➕ Nouvelle saison",`<div style="display:flex;flex-direction:column;gap:14px">
      <div class="form-group">
    ...
    </div>`);function s(){var E,m;const r=(E=document.getElementById("season-start"))==null?void 0:E.value,i=(m=document.getElementById("season-end"))==null?void 0:m.value,b=document.getElementById("season-duration");if(!r||!i||!b)return;const h=Math.round((new Date(i)-new Date(r))/864e5);b.textContent=h>0?`Durée : ${h} jour${h>1?"s":""}`:"⚠️ La fin doit être après le début",b.style.color=h>0?"var(--gray-600)":"#bb2020"}setTimeout(()=>{var r,i,b;(r=document.getElementById("season-start"))==null||r.addEventListener("input",s),(i=document.getElementById("season-end"))==null||i.addEventListener("input",s),s(),(b=document.getElementById("season-save-btn"))==null||b.addEventListener("click",async()=>{var y,v,_;const h=(y=document.getElementById("season-name"))==null?void 0:y.value.trim(),E=(v=document.getElementById("season-start"))==null?void 0:v.value,m=(_=document.getElementById("season-end"))==null?void 0:_.value,$=document.getElementById("season-error");if(!h){$.textContent="Le nom est requis.";return}if(!E){$.textContent="La date de début est requise.";return}if(!m){$.textContent="La date de fin est requise.";return}if(new Date(m)<=new Date(E)){$.textContent="La date de fin doit être après le début.";return}const k=document.getElementById("season-save-btn");k.disabled=!0,k.textContent="Enregistrement…";const x={name:h,start_at:new Date(E).toISOString(),end_at:new Date(m).toISOString()};let u;if(d?{error:u}=await w.from("ranked_seasons").update(x).eq("id",e.id):{error:u}=await w.from("ranked_seasons").insert({...x,is_active:!1}),u){$.textContent=u.message,k.disabled=!1,k.textContent=d?"💾 Enregistrer":"✅ Créer la saison";return}t(d?"Saison modifiée ✅":"Saison créée ✅","success"),o(),p()})},50)}ft(Fe);function un(e,t="info"){const n=document.getElementById("toast");n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},3e3)}function mn(e,t,n=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=n,document.getElementById("modal-overlay").classList.remove("hidden")}function ge(){document.getElementById("modal-overlay").classList.add("hidden")}const Re={dashboard:{title:"Dashboard",fn:bt},players:{title:"Joueurs & Cartes",fn:xt},clubs:{title:"Clubs",fn:zt},"card-builder":{title:"Card Builder",fn:Rt},users:{title:"Managers",fn:We},market:{title:"Marché des transferts",fn:Ye},"import-export":{title:"Import / Export CSV",fn:Gt},formations:{title:"Formations & Liens",fn:qt},"boosters-config":{title:"Boosters",fn:Vt},"sell-price":{title:"Prix vente directe",fn:Jt},journal:{title:"Journal",fn:Zt},tutorial:{title:"Tutoriel",fn:en},stadiums:{title:"Stades",fn:ln},"gc-cards":{title:"Game Changers",fn:cn},"ranked-seasons":{title:"Saisons Ranked",fn:pn}};async function pe(e){document.querySelectorAll(".admin-sidebar nav a").forEach(p=>{p.classList.toggle("active",p.dataset.page===e)});const t=document.getElementById("mobile-page-select");t&&(t.value=e);const n=Re[e]||Re.dashboard;document.getElementById("page-title").textContent=n.title;const o=document.getElementById("page-content");o.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">Chargement…</div>';try{await n.fn(o,{toast:un,openModal:mn,closeModal:ge,navigate:pe})}catch(p){o.innerHTML=`<div style="padding:40px;color:#c0392b">Erreur: ${p.message}</div>`,console.error(p)}}async function gn(){var t;const{data:{session:e}}=await w.auth.getSession();e&&await De(e.user),document.getElementById("auth-btn").addEventListener("click",async()=>{const n=document.getElementById("auth-email").value.trim(),o=document.getElementById("auth-password").value,p=document.getElementById("auth-error");if(p.textContent="",!n||!o){p.textContent="Remplissez tous les champs.";return}const{data:d,error:c}=await w.auth.signInWithPassword({email:n,password:o});if(c){p.textContent=c.message;return}await De(d.user)}),document.getElementById("auth-password").addEventListener("keydown",n=>{n.key==="Enter"&&document.getElementById("auth-btn").click()}),document.getElementById("logout-btn").addEventListener("click",async()=>{await w.auth.signOut(),document.getElementById("auth-screen").style.display="flex",document.getElementById("admin-app").style.display="none"}),document.getElementById("modal-close").addEventListener("click",ge),document.getElementById("modal-overlay").addEventListener("click",n=>{n.target===n.currentTarget&&ge()}),document.querySelectorAll(".admin-sidebar nav a").forEach(n=>{n.addEventListener("click",o=>{o.preventDefault(),pe(n.dataset.page)})}),(t=document.getElementById("mobile-page-select"))==null||t.addEventListener("change",n=>{pe(n.target.value)})}async function De(e){const{data:t,error:n}=await w.from("users").select("*").eq("id",e.id).single(),o=document.getElementById("auth-error");if(n||!t){o.textContent="Profil introuvable.";return}if(!t.is_admin){o.textContent="Accès refusé. Vous n'êtes pas administrateur.",await w.auth.signOut();return}document.getElementById("auth-screen").style.display="none",document.getElementById("admin-app").style.display="flex",document.getElementById("admin-user").textContent=`Admin: ${t.pseudo}`,pe("dashboard")}gn();
