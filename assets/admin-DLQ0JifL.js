import{s as w,r as Ne,a as Fe,A as tt,l as nt,g as it,b as Ge,K as we,D as T,S as ot,c as R,H as at,R as rt,e as ue,d as He,f as lt,h as st,E as dt,i as ct,N as pt,M as ut,B as mt,j as gt,F as me,k as _e,m as ft,n as bt,o as yt,p as vt}from"./special-cards-DZxbxWIu.js";async function xt(e){const[{count:t},{count:n},{count:i},{count:p},{count:s}]=await Promise.all([w.from("players").select("*",{count:"exact",head:!0}),w.from("clubs").select("*",{count:"exact",head:!0}),w.from("users").select("*",{count:"exact",head:!0}),w.from("cards").select("*",{count:"exact",head:!0}),w.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
