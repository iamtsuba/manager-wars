        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
          ${[["GK","pm-g","note_g"],["DEF","pm-d","note_d"],["MIL","pm-m","note_m"],["ATT","pm-a","note_a"]].map(([a,l,u])=>`
            <div class="form-group" style="text-align:center">
              ...
              <input id="${l}" type="number" min="1" max="20" value="${(e==null?void 0:e[u])||1}" style="text-align:center;font-size:18px;font-weight:900;padding:6px 4px">
            </div>`).join("")}
        </div>
