import{s as _,r as Ee,a as _e,A as vt,l as xt,g as ht,K as Me,D as z,b as Et,S as _t,c as R,H as wt,R as It,e as pe,d as Ze,f as $t,h as kt,E as Lt,i as Bt,N as At,M as St,B as Ct,j as Tt,F as me,k as ze,m as Mt,n as Qe,o as fe,p as zt}from"./special-cards-CuDZ8qxo.js";async function Rt(e){var h;const[{count:t},{count:n},{count:o},{count:l},{count:r},{data:g}]=await Promise.all([_.from("players").select("*",{count:"exact",head:!0}),_.from("clubs").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}),_.from("stadium_definitions").select("*",{count:"exact",head:!0}),_.from("users").select("*",{count:"exact",head:!0}).gt("last_seen_at",new Date(Date.now()-18e4).toISOString()),_.rpc("get_signup_password")]),b=g||"";e.innerHTML=`
  ...
  `,window.adminNav=i=>{var m;(m=document.querySelector(`[data-page="${i}"]`))==null||m.click()},(h=document.getElementById("signup-pwd-save"))==null||h.addEventListener("click",async()=>{const i=document.getElementById("signup-pwd-input").value.trim(),m=document.getElementById("signup-pwd-status");if(!i){m.textContent="Le code ne peut pas être vide.",m.style.color="#ff6b6b";return}const a=document.getElementById("signup-pwd-save");a.disabled=!0,a.textContent="⏳...";const{error:s}=await _.rpc("set_signup_password",{new_password:i});if(a.disabled=!1,a.textContent="💾 Enregistrer",s){m.textContent=s.message,m.style.color="#ff6b6b";return}m.textContent="✅ Code mis à jour.",m.style.color="#2ecc71"})}const Xe={normal:"Normal",pepite:"Pépite",papyte:"Papyte",legende:"Légende"},jt={GK:"#aaaaaa",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function Dt(){const e={};for(const t of vt)e[t]=await xt(t);return e}async function Nt(e,t){const{toast:n}=t;if(!confirm(`Réattribuer une nouvelle photo à tous les joueurs ayant encore l'ancien format de chemin (public/faces/...) ?

Cette action est irréversible.`))return;const o=document.getElementById("fix-old-faces-btn");o&&(o.disabled=!0,o.textContent="⏳ En cours...");try{const{data:l,error:r}=await _.from("players").select("id, country_code, face").like("face","public/faces/%");if(r){n(r.message,"error");return}if(!(l!=null&&l.length)){n("Aucun joueur avec l'ancien format — rien à faire ✅","success");return}const{data:g}=await _.from("players").select("face").not("face","is",null),b=new Set((g||[]).map(m=>m.face).filter(m=>m&&!m.startsWith("public/faces/")));let h=0,i=0;for(const m of l){const a=await _e(m.country_code,b);if(!a){i++;continue}const{error:s}=await _.from("players").update({face:a}).eq("id",m.id);if(s){i++;continue}b.add(a),h++}n(`${h} photo(s) réattribuée(s)${i?`, ${i} échec(s)`:""} ✅`,i?"error":"success")}finally{o&&(o.disabled=!1,o.textContent="🖼️ Réattribuer anciennes photos")}}async function Pt(e,t){await se(e,t)}async function se(e,t,n=null){var i,m,a,s,p;const{toast:o}=t;n||(n={search:((i=document.getElementById("search-players"))==null?void 0:i.value)||"",job:((m=document.getElementById("filter-job"))==null?void 0:m.value)||"",rarity:((a=document.getElementById("filter-rarity"))==null?void 0:a.value)||"",club:((s=document.getElementById("filter-club"))==null?void 0:s.value)||"",country:((p=document.getElementById("filter-country"))==null?void 0:p.value)||""});const[{data:l,error:r},{data:g}]=await Promise.all([_.from("players").select("*, clubs(id,encoded_name,logo_url)"),_.from("clubs").select("id,encoded_name").order("encoded_name")]);if(r){e.innerHTML=`<p style="color:red">${r.message}</p>`;return}const b={GK:0,DEF:1,MIL:2,ATT:3},h=(l||[]).sort((d,f)=>{const c=(b[d.job]??4)-(b[f.job]??4);return c!==0?c:(d.surname_real||"").localeCompare(f.surname_real||"")});Ft(e,h,g||[],t,n)}function Ft(e,t,n,o,l=null){var m,a;const{toast:r}=o;if(e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:10px">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ...
        <select id="filter-rarity" style="width:110px">
          ...
          ${Object.entries(Xe).map(([s,p])=>`<option value="${s}">${p}</option>`).join("")}
        </select>
    ...
    </div>`,l){const s=l,p=d=>document.getElementById(d);s.search&&p("search-players")&&(p("search-players").value=s.search),s.job&&p("filter-job")&&(p("filter-job").value=s.job),s.rarity&&p("filter-rarity")&&(p("filter-rarity").value=s.rarity),s.club&&p("filter-club")&&(p("filter-club").value=s.club),s.country&&p("filter-country")&&(p("filter-country").value=s.country)}if(l){const s=l,p=d=>document.getElementById(d);s.search&&p("search-players")&&(p("search-players").value=s.search),s.job&&p("filter-job")&&(p("filter-job").value=s.job),s.rarity&&p("filter-rarity")&&(p("filter-rarity").value=s.rarity),s.club&&p("filter-club")&&(p("filter-club").value=s.club),s.country&&p("filter-country")&&(p("filter-country").value=s.country)}function g(){const s=document.getElementById("search-players").value.toLowerCase(),p=document.getElementById("filter-job").value,d=document.getElementById("filter-rarity").value,f=document.getElementById("filter-club").value,c=document.getElementById("filter-country").value;return t.filter(y=>(!s||`${y.firstname} ${y.surname_real}`.toLowerCase().includes(s))&&(!p||y.job===p)&&(!d||y.rarity===d)&&(!f||y.club_id===f)&&(!c||y.country_code===c))}const b=new Set;function h(){const s=document.getElementById("bulk-bar"),p=document.getElementById("bulk-count");s&&(s.style.display=b.size>0?"flex":"none",p&&(p.textContent=`${b.size} joueur(s) sélectionné(s)`))}function i(){const s=g();document.getElementById("count-label").textContent=`${s.length} joueur(s)`;const p=document.getElementById("players-list");if(!s.length){p.innerHTML='<div style="color:var(--gray-600);padding:20px;text-align:center">Aucun joueur.</div>';return}p.innerHTML=s.map(d=>{const f={...d,clubs:d.clubs,face:d.face||null},c=Ee(f,{width:120});return`<div style="position:relative;cursor:pointer" data-edit="${d.id}">
        ${c}
      ...
      </div>`}).join(""),p.querySelectorAll("[data-edit]").forEach(d=>{d.addEventListener("click",()=>{const f=t.find(c=>c.id===d.dataset.edit);f&&Re(f,n,e,o)})}),p.querySelectorAll(".btn-del-player").forEach(d=>{d.addEventListener("click",async f=>{if(f.stopPropagation(),!confirm("Supprimer ce joueur ?"))return;const{error:c}=await _.from("players").delete().eq("id",d.dataset.del);c?r(c.message,"error"):(r("Joueur supprimé ✅","success"),se(e,o))})})}i(),document.getElementById("search-players").addEventListener("input",i),document.getElementById("filter-job").addEventListener("change",i),document.getElementById("filter-rarity").addEventListener("change",i),document.getElementById("filter-club").addEventListener("change",i),document.getElementById("filter-country").addEventListener("change",i),(m=document.getElementById("bulk-cancel-btn"))==null||m.addEventListener("click",()=>{b.clear(),h(),i()}),(a=document.getElementById("bulk-delete-btn"))==null||a.addEventListener("click",async()=>{var f,c,y,I,$;if(!b.size||!confirm(`Supprimer ${b.size} joueur(s) ?`))return;const s=[...b],{error:p}=await _.from("players").delete().in("id",s);if(p){r(p.message,"error");return}r(`${s.length} joueur(s) supprimé(s) ✅`,"success"),b.clear();const d={search:((f=document.getElementById("search-players"))==null?void 0:f.value)||"",job:((c=document.getElementById("filter-job"))==null?void 0:c.value)||"",rarity:((y=document.getElementById("filter-rarity"))==null?void 0:y.value)||"",club:((I=document.getElementById("filter-club"))==null?void 0:I.value)||"",country:(($=document.getElementById("filter-country"))==null?void 0:$.value)||""};se(e,o,d)}),document.getElementById("add-player-btn").addEventListener("click",()=>Re(null,n,e,o)),document.getElementById("fix-old-faces-btn").addEventListener("click",()=>Nt(e,o))}async function Re(e,t,n,o){const{toast:l,openModal:r,closeModal:g}=o,b=!!e,h=await Dt(),{data:i}=await _.from("players").select("face").not("face","is",null),m=new Set((i||[]).map(d=>d.face).filter(Boolean));e!=null&&e.face&&m.delete(e.face);const a='<option value="">— Club —</option>'+t.map(d=>`<option value="${d.id}" ${(e==null?void 0:e.club_id)===d.id?"selected":""}>${d.encoded_name}</option>`).join(""),s=e!=null&&e.face?e.face.split("/")[0]:"",p=Object.keys(h).map(d=>`<option value="${d}" ${s===d?"selected":""}>${d}</option>`).join("");r(b?`✏️ ${e.firstname} ${e.surname_real}`:"➕ Nouveau joueur",`<div style="display:flex;gap:20px;align-items:flex-start">
      ...
      <div style="flex:1;min-width:300px;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="border-top:1px solid var(--gray-200);padding-top:10px">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
            ${[["GK","pm-g","note_g"],["DEF","pm-d","note_d"],["MIL","pm-m","note_m"],["ATT","pm-a","note_a"]].map(([d,f,c])=>`
              <div class="form-group" style="text-align:center">
                <label style="color:${jt[d]};font-weight:700">${d}</label>
    ...
    </div>`,g(re),document.getElementById("search-clubs").addEventListener("input",b=>{const h=b.target.value.toLowerCase();g(re.filter(i=>i.real_name.toLowerCase().includes(h)||i.encoded_name.toLowerCase().includes(h)))}),document.getElementById("add-club-btn").addEventListener("click",()=>je(null,e,t));function g(b){const h=document.getElementById("clubs-list");if(!b.length){h.innerHTML='<p style="color:var(--tile-fg-dim);padding:20px;text-align:center">Aucun club.</p>';return}const i={};b.forEach(s=>{const p=s.country_code||"—";i[p]||(i[p]=[]),i[p].push(s)});const m=Object.keys(i).sort(),a=s=>{const p=st(s),d=s.logo_url?`<img src="${s.logo_url}" style="width:36px;height:36px;object-fit:contain;border-radius:8px;flex-shrink:0">`:`<div style="width:36px;height:36px;background:linear-gradient(135deg,${p.color1},${p.color2});border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:9px;font-weight:900;flex-shrink:0">${s.encoded_name.slice(0,3)}</div>`,f=n[s.id]||0;return`
    ...
    `).join(""),h.querySelectorAll(".club-row").forEach(s=>{s.addEventListener("click",()=>{const p=re.find(d=>d.id===s.dataset.clubId);p&&je(p,e,t),h.querySelectorAll(".club-row").forEach(d=>d.style.background="var(--tile-bg)"),s.style.background="rgba(26,107,60,0.18)"})}),h.querySelectorAll(".btn-del-club").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm("Supprimer ce club ?"))return;const{error:p}=await _.from("clubs").delete().eq("id",s.dataset.del);p?o(p.message,"error"):(o("Club supprimé","success"),ue(e,t))})})}}async function je(e,t,n){var c,y,I,$,E,v;const{toast:o}=n,l=!!e,r=e?st(e):{...z},g=document.getElementById("club-panel");if(!g)return;const b=Object.entries(Me).map(([u,x])=>`<option value="${u}" ${r.style===u?"selected":""}>${x.label}</option>`).join(""),h=we.map(u=>`<option value="${u}" ${((e==null?void 0:e.country_code)||"FR")===u?"selected":""}>${u}</option>`).join("");g.style.display="block",g.style.alignItems="",g.style.justifyContent="",g.innerHTML=`
  ...
  `,b(g),document.getElementById("search-users").addEventListener("input",h=>{const i=h.target.value.toLowerCase();b(g.filter(m=>{var a;return m.pseudo.toLowerCase().includes(i)||((a=m.club_name)==null?void 0:a.toLowerCase().includes(i))}))});function b(h){document.getElementById("users-tbody").innerHTML=h.map(i=>{const m=i.mmr??1e3,a=i.mmr_deviation??350,s=i.placement_matches??0,p=Tt(m),d=i.ranked_wins??0,f=i.ranked_losses??0,c=i.ranked_draws??0,y=d+f+c,I=y>0?Math.round(d/y*100):null,$=s<10,E=a<80?"#1A6B3C":a<150?"#e67e22":"#bb2020";return`
        <tr>
          <td>
          ...
          <td style="font-size:12px">
            ...
            ${$?`<div style="font-size:10px;color:#e67e22">${s}/10 placement${s<10?` (${10-s} restants)`:""}</div>`:`<div style="font-size:10px;color:var(--gray-600)">${d}V ${c}N ${f}D${I!==null?` · ${I}% WR`:""}</div>`}
          </td>
    ...
    <div class="card-panel">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${r.map(i=>{var p,d,f,c;const m=(p=i.card)==null?void 0:p.player,a=m?`${m.firstname} ${m.surname_real}`:((d=i.card)==null?void 0:d.card_type)||"—",s={active:"#1A6B3C",sold:"#D4A017",cancelled:"#888"};return`<tr>
...
`).filter(g=>g.trim());if(t.length<2)return[];const n=t[0],o=n.split(";").length>n.split(",").length?";":",",l=Oe(n,o).map(g=>g.trim().replace(/^\uFEFF/,"").toLowerCase()),r=[];for(let g=1;g<t.length;g++){if(!t[g].trim())continue;const b=Oe(t[g],o),h={};l.forEach((i,m)=>{h[i]=(b[m]||"").trim()}),!Object.values(h).every(i=>!i)&&r.push(h)}return r}function Oe(e,t=","){const n=[];let o="",l=!1;for(let r=0;r<e.length;r++){const g=e[r];l?g==='"'?e[r+1]==='"'?(o+='"',r++):l=!1:o+=g:g==='"'?l=!0:g===t?(n.push(o),o=""):o+=g}return n.push(o),n}const bn={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function vn(e,{toast:t}){const n=Object.keys(me);let o=n[0];const{data:l}=await _.from("formation_links_overrides").select("formation, links"),r={};(l||[]).forEach(m=>{r[m.formation]=m.links});let g=new Set;function b(m,a){return[m,a].sort().join("-")}function h(m){const a=r[m]||me[m]||[];g=new Set(a.map(([s,p])=>b(s,p)))}h(o),e.innerHTML=`
  ...
  `;function i(){const m=Mt[o]||{},a=ze(o),s=320,p=400,d=22;function f(E){const v=m[E];return v?{x:v.x*s,y:v.y*p}:null}let c=`<svg width="${s}" height="${p}" viewBox="0 0 ${s} ${p}" xmlns="http://www.w3.org/2000/svg" style="display:block">`;a.forEach(([E,v],u)=>{const x=f(E),w=f(v);if(!x||!w)return;const k=b(E,v),L=g.has(k),B=L?"#3b82f6":"#999",A=L?.95:.35,S=L?4:3;c+=`<line x1="${x.x}" y1="${x.y}" x2="${w.x}" y2="${w.y}"
    ...
    </div>`;const s=o.reduce((d,f)=>d+Number(f.percentage||0),0),p=Math.abs(s-100)<.1;return`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="f-price-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${En.map(d=>`<option value="${d.value}" ${a.price_type===d.value?"selected":""}>${d.label}</option>`).join("")}
            </select>
          </div>
        ...
        ${o.length===0?'<div style="text-align:center;padding:16px;color:#aaa;font-size:13px">Aucun taux. Cliquez + Ligne.</div>':o.map((d,f)=>`
          <div style="display:grid;grid-template-columns:2fr 1.5fr 50px 50px 60px 32px;gap:4px;align-items:center;margin-bottom:6px;padding:6px;background:#f9f9f9;border-radius:6px" data-rate-idx="${f}">
            <select class="rate-type" data-idx="${f}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${xn.map(c=>`<option value="${c.value}" ${d.card_type===c.value?"selected":""}>${c.label}</option>`).join("")}
            </select>
            <select class="rate-rarity" data-idx="${f}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${hn.map(c=>`<option value="${c.value}" ${(d.rarity||"")===c.value?"selected":""}>${c.label}</option>`).join("")}
            </select>
    ...
    </div>`}async function i(a=!1){a||await g();const s=!n&&r(),p=n&&r();e.innerHTML=`
    <div style="display:flex;height:calc(100vh - 56px);overflow:hidden">
      ${!r()||s||!n?b():""}
      ${!r()||p?h():""}
    </div>`,m()}function m(){var p,d,f,c,y,I,$;const a=E=>e.querySelector(E);e.querySelectorAll(".booster-row").forEach(E=>{E.addEventListener("click",v=>{v.target.closest(".btn-delete")||(n=E.dataset.id,l=null,i())})}),(p=a("#btn-back"))==null||p.addEventListener("click",()=>{n=null,i()}),(d=a("#btn-new"))==null||d.addEventListener("click",async()=>{const E=prompt("Nom du nouveau booster :");if(!(E!=null&&E.trim()))return;const{data:v,error:u}=await _.from("booster_configs").insert({name:E.trim(),price_type:"credits",price_credits:1e3,card_count:5}).select().single();if(u){alert(u.message);return}t.push(v),n=v.id,l=null,i()}),e.querySelectorAll(".btn-delete").forEach(E=>{E.addEventListener("click",async v=>{if(v.stopPropagation(),!confirm("Supprimer ce booster ?"))return;await _.from("booster_configs").delete().eq("id",E.dataset.id);const u=t.findIndex(x=>x.id===E.dataset.id);u>-1&&t.splice(u,1),n===E.dataset.id&&(n=null,l=null),i()})}),(f=a("#btn-cancel"))==null||f.addEventListener("click",()=>{n=null,i()}),(c=a("#f-price-type"))==null||c.addEventListener("change",E=>{const v=a("#credits-field");v&&(v.style.opacity=E.target.value!=="credits"?"0.4":"1")}),(y=a("#btn-pick-icon"))==null||y.addEventListener("click",async()=>{var v;const E=a("#icon-picker-grid");if(E){if(E.style.display!=="none"){E.style.display="none";return}E.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',E.style.display="block";try{const x=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),w=Array.isArray(x)?x.filter(L=>L.name.startsWith("booster")&&/\.(png|jpg|svg|webp)$/i.test(L.name)):[];if(!w.length){E.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucune icône "booster*" trouvée.</div>';return}const k=((v=a("#f-image-url"))==null?void 0:v.value)||"";E.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
          ${w.map(L=>`
  ...
  <div data-edit-row="${e.id}" style="background:#fff;border-radius:10px;padding:12px 16px;box-shadow:0 1px 4px rgba(0,0,0,0.08);display:flex;align-items:center;gap:12px;cursor:pointer">
    ...
    </div>`,h.querySelectorAll("ul,ol").forEach(a=>{a.style.paddingLeft="20px",a.style.margin="6px 0"}),h.querySelectorAll("li").forEach(a=>{a.style.marginBottom="4px"}),h.querySelectorAll("p").forEach(a=>{a.style.marginBottom="8px"})}async function Mn(e){var a,s;const t=document.getElementById("ts-id").value,n=document.getElementById("ts-emoji").value.trim()||"⚽",o=document.getElementById("ts-title").value.trim(),l=document.getElementById("ts-editor"),r=(l?l.innerHTML:document.getElementById("ts-content").value).trim(),g=document.getElementById("ts-color-hex").value.trim()||"#1A6B3C",b=parseInt(document.getElementById("ts-order").value)||0,h=document.getElementById("ts-active").checked;if(!o||!r){alert("Titre et contenu sont obligatoires.");return}const i={emoji:n,title:o,content:r,color:g,step_order:b,is_active:h,image_url:((s=(a=document.getElementById("ts-image"))==null?void 0:a.value)==null?void 0:s.trim())||null};let m;if(t?{error:m}=await _.from("tutorial_steps").update(i).eq("id",t):{error:m}=await _.from("tutorial_steps").insert(i),m){alert("Erreur : "+m.message);return}ft(),W(e)}const yt="/",zn=[["MA","Maroc"],["FR","France"],["AR","Argentine"],["PT","Portugal"],["BR","Brésil"],["ES","Espagne"],["DE","Allemagne"],["GB","Angleterre"],["IT","Italie"],["CM","Cameroun"],["SN","Sénégal"],["NG","Nigéria"],["DK","Danemark"],["NL","Pays-Bas"],["BE","Belgique"],["CI","Côte d'Ivoire"],["AL","Albanie"],["HR","Croatie"],["RS","Serbie"],["TR","Turquie"],["MW","Malawi"],["GH","Ghana"],["ZA","Afrique du Sud"],["EG","Égypte"],["US","États-Unis"],["MX","Mexique"],["CO","Colombie"],["UY","Uruguay"],["CL","Chili"],["JP","Japon"],["KR","Corée du Sud"],["CN","Chine"],["AU","Australie"],["SW","Suisse"],["SE","Suède"],["NO","Norvège"],["PL","Pologne"]];async function Rn(e,t){await ve(e,t)}async function ve(e,t){var l;const[{data:n},{data:o}]=await Promise.all([_.from("stadium_definitions").select("*, club:clubs(encoded_name, logo_url)").order("name"),_.from("clubs").select("id, encoded_name, logo_url").order("encoded_name")]);e.innerHTML=`
    ...
    ${o}
  </div>`}function qe(e,t,n,o){var m,a,s;const{openModal:l,closeModal:r,toast:g}=o,b=`
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div>
          ...
          <select id="st-country">
            ...
            ${zn.map(([p,d])=>`<option value="${p}" ${(e==null?void 0:e.country_code)===p?"selected":""}>${d} (${p})</option>`).join("")}
          </select>
        </div>
        <div>
  ...
  </div>`}function Je(e,t,n){var s,p,d,f;const{openModal:o,closeModal:l,toast:r}=n,g=!e,b=e||{name:"",gc_type:"game_changer",color:"purple",effect:"",image_url:"",sort_order:0,is_active:!0,effect_type:"BOOST_STAT",effect_params:{}},h=(()=>{const c=b.effect_params||{},y=G.find(I=>I.value===(b.effect_type||"BOOST_STAT"))||G[0];return`
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ${y.hasValue?`<div>
    ...
    <div style="display:flex;flex-direction:column;gap:20px">
      ...
      <div class="card-panel" style="background:linear-gradient(135deg,#0a3d1e,#1a6b3c20);border:1.5px solid #1A6B3C40">
        ...
        <div style="display:flex;flex-direction:column;gap:4px">
          ${s.map(v=>{const u=c[v],x=a.length>0?Math.round(u/a.length*100):0;return`
