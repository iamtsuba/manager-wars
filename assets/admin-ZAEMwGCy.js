import{s as w,r as Ne,g as Pe,K as Ee,D as S,S as tt,a as j,H as nt,R as it,e as ue,b as qe,c as ot,d as at,E as rt,f as lt,N as st,M as dt,B as ct,h as pt,F as me,i as we,j as ut,k as mt}from"./formation-links-TDtFd05S.js";async function ft(e){const[{count:t},{count:n},{count:i},{count:p},{count:d}]=await Promise.all([w.from("players").select("*",{count:"exact",head:!0}),w.from("clubs").select("*",{count:"exact",head:!0}),w.from("users").select("*",{count:"exact",head:!0}),w.from("cards").select("*",{count:"exact",head:!0}),w.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
