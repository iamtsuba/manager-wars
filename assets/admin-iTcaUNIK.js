import{s as h,r as je,g as Re,K as ye,D as A,S as Ze,a as C,H as Xe,R as Qe,e as re,b as De,c as et,E as tt,d as nt,N as it,M as ot,B as at,f as rt,F as se,h as he,i as lt,j as st}from"./formation-links-BZe0pGr4.js";async function dt(e){const[{count:n},{count:t},{count:i},{count:p},{count:d}]=await Promise.all([h.from("players").select("*",{count:"exact",head:!0}),h.from("clubs").select("*",{count:"exact",head:!0}),h.from("users").select("*",{count:"exact",head:!0}),h.from("cards").select("*",{count:"exact",head:!0}),h.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:24px">
      ${Y("🃏","Joueurs (cartes)",n??"–","#1A6B3C")}
      ${Y("🏟️","Clubs",t??"–","#D4A017")}
      ${Y("👥","Managers",i??"–","#7a28b8")}
  ...
  `,window.adminNav=s=>{var a;(a=document.querySelector(`[data-page="${s}"]`))==null||a.click()}}function Y(e,n,t,i){return`<div class="card-panel" style="text-align:center">
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ...
      <div id="players-list" style="display:flex;flex-direction:column;gap:6px"></div>
    </div>`;function d(){const o=document.getElementById("search-players").value.toLowerCase(),c=document.getElementById("filter-job").value,u=document.getElementById("filter-rarity").value,f=document.getElementById("filter-club").value,E=document.getElementById("filter-country").value;return n.filter(w=>(!o||`${w.firstname} ${w.surname_encoded} ${w.surname_real||""}`.toLowerCase().includes(o))&&(!c||w.job===c)&&(!u||w.rarity===u)&&(!f||w.club_id===f)&&(!E||w.country_code===E))}const s=new Set;function a(){const o=document.getElementById("bulk-bar"),c=document.getElementById("bulk-count");o&&(s.size>0?(o.style.display="flex",c.textContent=`${s.size} joueur(s) sélectionné(s)`):o.style.display="none")}function m(){const o=d();document.getElementById("count-label").textContent=`${o.length} joueur(s)`;const c=document.getElementById("players-list");if(!o.length){c.innerHTML='<div style="color:var(--gray-600);padding:20px;text-align:center">Aucun joueur.</div>';return}c.innerHTML=o.map(u=>{const f=ct[u.rarity]||"#aaa",E=Ne[u.job]||"#aaa",w=s.has(u.id);return`
        <div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;${w?"border:2px solid #bb2020;background:rgba(187,32,32,0.05)":""}">
          ...
          <!-- Note + poste -->
          <div style="flex-shrink:0;width:40px;height:40px;border-radius:10px;border:2px solid ${f};
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="font-size:10px;color:${f};font-weight:700;margin-top:2px">${de[u.rarity]||u.rarity}</div>
          </div>
          <!-- Notes secondaires -->
...
<input type="hidden" id="pm-enc" value="${(e==null?void 0:e.surname_encoded)||""}">
        <div class="form-group">
          <label>Pays</label>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:8px">
          ${[["GK","pm-g","note_g"],["DEF","pm-d","note_d"],["MIL","pm-m","note_m"],["ATT","pm-a","note_a"]].map(([l,o,c])=>`
            <div class="form-group" style="text-align:center">
              <label style="color:${Ne[l]};font-weight:700">${l}</label>
    ...
    </div>`),setTimeout(()=>{var f,E,w;W();function l(){var x,g;const b=((x=document.getElementById("m-kit-style"))==null?void 0:x.value)||"uni",k=((g=ye[b])==null?void 0:g.colors)===3,$=document.getElementById("wrap-m-kit-color3");$&&($.style.display=k?"":"none")}l(),["m-kit-color1","m-kit-color2","m-kit-color3","m-kit-shorts","m-kit-socks"].forEach(b=>{const k=document.getElementById(b),$=document.getElementById(b+"-txt");!k||!$||(k.addEventListener("input",()=>{$.value=k.value,W()}),$.addEventListener("input",()=>{const x=$.value.trim();/^#[0-9a-fA-F]{6}$/.test(x)&&(k.value=x,W())}),$.addEventListener("change",()=>{let x=$.value.trim();x.startsWith("#")||(x="#"+x),/^#[0-9a-fA-F]{6}$/.test(x)&&(k.value=x,$.value=x,W())}))}),(f=document.getElementById("m-kit-style"))==null||f.addEventListener("change",()=>{l(),W()});const o=document.getElementById("m-real"),c=document.getElementById("m-encoded");function u(){if(!o||!c||c.value)return;const b=o.value.trim().split(/\s+/),k=b.length===1?b[0].toUpperCase().slice(0,6):b.filter($=>$.length>2).map($=>$[0].toUpperCase()).join("")||b[0].toUpperCase().slice(0,4);c.value=k}o==null||o.addEventListener("input",u),(E=document.getElementById("auto-encode-btn"))==null||E.addEventListener("click",()=>{c&&(c.value=""),u()}),(w=document.getElementById("m-save"))==null||w.addEventListener("click",()=>It(e,s,n,t))},50)}function Ge(){var e,n,t,i,p,d;return{style:((e=document.getElementById("m-kit-style"))==null?void 0:e.value)||"uni",color1:((n=document.getElementById("m-kit-color1"))==null?void 0:n.value)||"#1A6B3C",color2:((t=document.getElementById("m-kit-color2"))==null?void 0:t.value)||"#ffffff",color3:((i=document.getElementById("m-kit-color3"))==null?void 0:i.value)||"#000000",shorts:((p=document.getElementById("m-kit-shorts"))==null?void 0:p.value)||"#111111",socks:((d=document.getElementById("m-kit-socks"))==null?void 0:d.value)||"#ffffff"}}function W(){const e=document.getElementById("kit-preview-wrap");e&&(e.innerHTML=Re(Ge(),"modal"))}async function It(e,n,t,i){var b,k,$,x,g,v;const{toast:p,closeModal:d}=i,s=document.getElementById("m-error"),a=document.getElementById("m-save"),m=(b=document.getElementById("m-real"))==null?void 0:b.value.trim(),r=(k=document.getElementById("m-encoded"))==null?void 0:k.value.trim().toUpperCase(),l=($=document.getElementById("m-country"))==null?void 0:$.value.trim().toUpperCase(),o=((x=document.getElementById("m-logo"))==null?void 0:x.value.trim())||null,c=((g=document.getElementById("m-gen-stadium"))==null?void 0:g.checked)??!1,u=((v=document.getElementById("m-gen-squad"))==null?void 0:v.checked)??!1,f=Ge();if(!m){s.textContent="Le nom du club est requis.";return}if(!r){s.textContent="Le nom encodé est requis.";return}if(!l){s.textContent="Le pays est requis.";return}a.disabled=!0,a.textContent="Enregistrement…";const E={real_name:m,encoded_name:r,country_code:l,logo_url:o,kit_style:f.style,kit_color1:f.color1,kit_color2:f.color2,kit_color3:f.color3,kit_shorts:f.shorts,kit_socks:f.socks};let w=e==null?void 0:e.id;if(n){const{error:y}=await h.from("clubs").update(E).eq("id",w);if(y){s.textContent=y.message,a.disabled=!1,a.textContent="💾 Enregistrer";return}}else{const{data:y,error:_}=await h.from("clubs").insert(E).select().single();if(_){s.textContent=_.message,a.disabled=!1,a.textContent="✅ Créer le club";return}if(w=y.id,c){a.textContent="🏟️ Création du stade…";const{data:L,error:I}=await h.from("stadium_definitions").insert({name:`Stade de ${m}`,club_id:w,country_code:l}).select().single();I?console.warn("[Stadium] Erreur def stade:",I.message):L&&await h.from("cards").insert({card_type:"stadium",stadium_id:L.id})}u&&(a.textContent="⚽ Génération des joueurs…",await Fe(w,l,p))}p(n?"Club modifié ✅":"Club créé ✅","success"),d(),oe(t,i)}const Lt=["normal","pepite","papyte","legende"],_e=["GK","DEF","MIL","ATT"],Bt=[["MA","Maroc"],["FR","France"],["AR","Argentine"],["PT","Portugal"],["BR","Brésil"],["ES","Espagne"],["DE","Allemagne"],["GB","Angleterre"],["IT","Italie"],["CM","Cameroun"],["SN","Sénégal"],["NG","Nigéria"],["DK","Danemark"],["NL","Pays-Bas"],["BE","Belgique"],["CI","Côte d'Ivoire"],["AL","Albanie"],["HR","Croatie"],["RS","Serbie"],["TR","Turquie"],["MW","Malawi"]];let N={...C},te=[];async function zt(e,{toast:n}){const{data:t}=await h.from("clubs").select("id,encoded_name,logo_url,kit_style,kit_color1,kit_color2,kit_shorts,kit_socks").order("encoded_name");te=t||[],N={...C},e.innerHTML=Tt(te),Ct(e,te,n),j()}function $e(){var t;const e=((t=document.getElementById("cb-surname-real"))==null?void 0:t.value)||"",n=document.getElementById("cb-surname-enc");n&&(n.value=re(e))}function At(){var t;const e=(t=document.getElementById("cb-club"))==null?void 0:t.value,n=te.find(i=>String(i.id)===String(e));return n?{style:n.kit_style||A.style,color1:n.kit_color1||A.color1,color2:n.kit_color2||A.color2,shorts:n.kit_shorts||A.shorts,socks:n.kit_socks||A.socks}:{...A}}function j(){var c,u,f,E;const e=w=>{var b;return((b=document.getElementById(w))==null?void 0:b.value)||""},n={firstname:e("cb-firstname"),surname_encoded:e("cb-surname-enc")||re(e("cb-surname-real")),country_code:e("cb-country"),club_encoded_name:((u=(c=document.getElementById("cb-club"))==null?void 0:c.selectedOptions[0])==null?void 0:u.text)||"",job:e("cb-job"),job2:e("cb-job2")||null,note_g:parseInt(e("cb-note-g"))||0,note_d:parseInt(e("cb-note-d"))||0,note_m:parseInt(e("cb-note-m"))||0,note_a:parseInt(e("cb-note-a"))||0,rarity:e("cb-rarity")},t=At(),i=document.getElementById("cb-club"),p=((E=(f=i==null?void 0:i.selectedOptions[0])==null?void 0:f.dataset)==null?void 0:E.logo)||null,d=De(N,t,120),s=`data:image/svg+xml;charset=utf-8,${encodeURIComponent(d)}`,a=je(n,{portraitUrl:s,clubLogoUrl:p,showNotes:!0}),m=document.getElementById("card-preview");m&&(m.innerHTML=a);const r=document.getElementById("avatar-preview-wrap");r&&(r.innerHTML=d);const l=e("cb-surname-real"),o=document.getElementById("encode-summary");o&&l&&(o.textContent=`${e("cb-firstname")} ${l} → ${e("cb-firstname")} ${n.surname_encoded}`)}function Ue(){const e=n=>{var t;return((t=document.getElementById(n))==null?void 0:t.value)||""};N={skin:e("av-skin"),hair:e("av-hair"),hairColor:e("av-hairColor"),eyes:e("av-eyes"),nose:e("av-nose"),mouth:e("av-mouth"),eyebrows:e("av-eyebrows"),beard:e("av-beard")}}function Ct(e,n,t){var p,d,s,a,m;e.querySelectorAll("input,select").forEach(r=>{r.addEventListener("input",j),r.addEventListener("change",j)});const i=["av-skin","av-hair","av-hairColor","av-eyes","av-nose","av-mouth","av-eyebrows","av-beard"];i.forEach(r=>{var l;(l=document.getElementById(r))==null||l.addEventListener("change",()=>{Ue(),j()})}),(p=document.getElementById("cb-surname-real"))==null||p.addEventListener("input",()=>{$e(),j()}),(d=document.getElementById("btn-encode"))==null||d.addEventListener("click",()=>{$e(),j()}),(s=document.getElementById("cb-club"))==null||s.addEventListener("change",j),(a=document.getElementById("btn-save-player"))==null||a.addEventListener("click",()=>St(t)),(m=document.getElementById("btn-reset"))==null||m.addEventListener("click",()=>{e.querySelectorAll("input").forEach(r=>r.value=""),e.querySelectorAll("select").forEach(r=>r.selectedIndex=0),N={...C},i.forEach(r=>{const l=r.replace("av-",""),o=document.getElementById(r);o&&(o.value=C[l]||"")}),j()})}async function St(e){const n=s=>{var a;return((a=document.getElementById(s))==null?void 0:a.value)||""},t=n("cb-surname-real").trim(),i=n("cb-surname-enc").trim()||re(t);if(!n("cb-firstname")||!t||!n("cb-country")||!n("cb-job")){e("Remplissez les champs obligatoires (prénom, nom, pays, poste)","error");return}Ue();const p={firstname:n("cb-firstname").trim(),surname_real:t,surname_encoded:i,country_code:n("cb-country"),club_id:n("cb-club")||null,job:n("cb-job"),job2:n("cb-job2")||null,note_g:parseInt(n("cb-note-g"))||0,note_d:parseInt(n("cb-note-d"))||0,note_m:parseInt(n("cb-note-m"))||0,note_a:parseInt(n("cb-note-a"))||0,rarity:n("cb-rarity")||"normal",note_min:parseInt(n("cb-note-min"))||null,note_max:parseInt(n("cb-note-max"))||null,sell_price:parseInt(n("cb-price"))||0,avatar_config:N,skin:N.skin||"blanc",hair:N.hairColor||"marron",hair_length:"court"},{error:d}=await h.from("players").insert(p);if(d){e("Erreur: "+d.message,"error");return}e(`✅ Joueur "${p.firstname} ${p.surname_encoded}" enregistré !`,"success")}function Tt(e){const n=Bt.map(([r,l])=>`<option value="${r}">${l} (${r})</option>`).join(""),t='<option value="">— Sélectionner un club —</option>'+e.map(r=>`<option value="${r.id}" data-logo="${r.logo_url||""}">${r.encoded_name}</option>`).join(""),i=_e.map(r=>`<option value="${r}">${r}</option>`).join(""),p='<option value="">Aucun</option>'+_e.map(r=>`<option value="${r}">${r}</option>`).join(""),d=Lt.map(r=>`<option value="${r}">${r.charAt(0).toUpperCase()+r.slice(1)}</option>`).join(""),s=(r,l,o)=>Object.entries(l).map(([c,u])=>`<option value="${c}" ${c===(o||"")?"selected":""}>${u.label}</option>`).join(""),a=Object.keys(Ze).map(r=>`<option value="${r}" ${r===C.skin?"selected":""}>${r.charAt(0).toUpperCase()+r.slice(1)}</option>`).join(""),m=Object.keys(Xe).map(r=>`<option value="${r}" ${r===C.hairColor?"selected":""}>${r.charAt(0).toUpperCase()+r.slice(1)}</option>`).join("");return`
  ...
  `,d(p),document.getElementById("search-users").addEventListener("input",s=>{const a=s.target.value.toLowerCase();d(p.filter(m=>{var r;return m.pseudo.toLowerCase().includes(a)||((r=m.club_name)==null?void 0:r.toLowerCase().includes(a))}))});function d(s){document.getElementById("users-tbody").innerHTML=s.map(a=>{const m=a.mmr??1e3,r=a.mmr_deviation??350,l=a.placement_matches??0,o=rt(m),c=a.ranked_wins??0,u=a.ranked_losses??0,f=a.ranked_draws??0,E=c+u+f,w=E>0?Math.round(c/E*100):null,b=l<10,k=r<80?"#1A6B3C":r<150?"#e67e22":"#bb2020";return`
        <tr>
          ...
          <td style="font-size:12px">
            ...
            ${b?`<div style="font-size:10px;color:#e67e22">${l}/10 placement${l<10?` (${10-l} restants)`:""}</div>`:`<div style="font-size:10px;color:var(--gray-600)">${c}V ${f}N ${u}D${w!==null?` · ${w}% WR`:""}</div>`}
          </td>
    ...
    <div class="card-panel">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${p.map(a=>{var o,c,u,f;const m=(o=a.card)==null?void 0:o.player,r=m?`${m.firstname} ${m.surname_encoded}`:((c=a.card)==null?void 0:c.card_type)||"—",l={active:"#1A6B3C",sold:"#D4A017",cancelled:"#aaa"};return`<tr>
...
`)?'"'+n.replace(/"/g,'""')+'"':n}function X(e,n){const t=new Blob(["\uFEFF"+n],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(t),p=document.createElement("a");p.href=i,p.download=e,p.click(),URL.revokeObjectURL(i)}function Ie(e){e=e.replace(/^\uFEFF/,"").replace(/\r\n/g,`
`).replace(/\r/g,`
`);const n=e.split(`
`).filter(s=>s.trim());if(n.length<2)return[];const t=n[0],i=t.split(";").length>t.split(",").length?";":",",p=Le(t,i).map(s=>s.trim().replace(/^\uFEFF/,"").toLowerCase()),d=[];for(let s=1;s<n.length;s++){if(!n[s].trim())continue;const a=Le(n[s],i),m={};p.forEach((r,l)=>{m[r]=(a[l]||"").trim()}),!Object.values(m).every(r=>!r)&&d.push(m)}return d}function Le(e,n=","){const t=[];let i="",p=!1;for(let d=0;d<e.length;d++){const s=e[d];p?s==='"'?e[d+1]==='"'?(i+='"',d++):p=!1:i+=s:s==='"'?p=!0:s===n?(t.push(i),i=""):i+=s}return t.push(i),t}const jt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};async function Rt(e,{toast:n}){const t=Object.keys(se);let i=t[0];const{data:p}=await h.from("formation_links_overrides").select("formation, links"),d={};(p||[]).forEach(l=>{d[l.formation]=l.links});let s=new Set;function a(l,o){return[l,o].sort().join("-")}function m(l){const o=d[l]||se[l]||[];s=new Set(o.map(([c,u])=>a(c,u)))}m(i),e.innerHTML=`
  ...
  `;function r(){const l=lt[i]||{},o=he(i),c=320,u=400,f=22;function E(x){const g=l[x];return g?{x:g.x*c,y:g.y*u}:null}let w=`<svg width="${c}" height="${u}" viewBox="0 0 ${c} ${u}" xmlns="http://www.w3.org/2000/svg" style="display:block">`;o.forEach(([x,g],v)=>{const y=E(x),_=E(g);if(!y||!_)return;const L=a(x,g),I=s.has(L),z=I?"#3b82f6":"#999",S=I?.95:.35,T=I?4:3;w+=`<line x1="${y.x}" y1="${y.y}" x2="${_.x}" y2="${_.y}"
        ...
        opacity="${S}" pointer-events="none" data-line-key="${L}"/>`});for(const x of Object.keys(l)){const g=E(x);if(!g)continue;const v=x.replace(/\d+/,""),y=jt[v]||"#555";w+=`<circle cx="${g.x}" cy="${g.y}" r="${f}" fill="${y}" stroke="rgba(255,255,255,0.7)" stroke-width="2" pointer-events="none"/>`,w+=`<text x="${g.x}" y="${g.y+4}" text-anchor="middle" font-size="10" font-weight="900" fill="white" font-family="Arial Black,Arial" pointer-events="none">${x}</text>`}w+="</svg>",document.getElementById("field-wrap").innerHTML=w;const b=document.getElementById("links-list");b.innerHTML=o.map(([x,g])=>{const v=a(x,g),y=s.has(v);return`
    ...
    </div>`}function m(){const o=t?(n||[]).find(f=>f.id===t):null;if(!o)return`<div style="display:flex;align-items:center;justify-content:center;flex:1;color:#bbb;font-size:14px;padding:40px;text-align:center">
      ← Sélectionnez un booster ou créez-en un nouveau
    </div>`;const c=i.reduce((f,E)=>f+Number(E.percentage||0),0),u=Math.abs(c-100)<.1;return`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="f-price-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${qt.map(f=>`<option value="${f.value}" ${o.price_type===f.value?"selected":""}>${f.label}</option>`).join("")}
            </select>
          </div>
        ...
        ${i.length===0?'<div style="text-align:center;padding:16px;color:#aaa;font-size:13px">Aucun taux. Cliquez + Ligne.</div>':i.map((f,E)=>`
          <div style="display:grid;grid-template-columns:2fr 1.5fr 50px 50px 60px 32px;gap:4px;align-items:center;margin-bottom:6px;padding:6px;background:#f9f9f9;border-radius:6px" data-rate-idx="${E}">
            <select class="rate-type" data-idx="${E}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${Dt.map(w=>`<option value="${w.value}" ${f.card_type===w.value?"selected":""}>${w.label}</option>`).join("")}
            </select>
            <select class="rate-rarity" data-idx="${E}" style="padding:6px 4px;border:1px solid #ddd;border-radius:4px;font-size:12px;width:100%">
              ${Nt.map(w=>`<option value="${w.value}" ${(f.rarity||"")===w.value?"selected":""}>${w.label}</option>`).join("")}
            </select>
    ...
    <div style="display:flex;height:calc(100vh - 56px);overflow:hidden">
      ${!d()||c||!t?a():""}
      ${!d()||u?m():""}
    </div>`,l()}function l(){var u,f,E,w,b,k,$;const o=x=>e.querySelector(x);e.querySelectorAll(".booster-row").forEach(x=>{x.addEventListener("click",g=>{g.target.closest(".btn-delete")||(t=x.dataset.id,p=null,r())})}),(u=o("#btn-back"))==null||u.addEventListener("click",()=>{t=null,r()}),(f=o("#btn-new"))==null||f.addEventListener("click",async()=>{const x=prompt("Nom du nouveau booster :");if(!(x!=null&&x.trim()))return;const{data:g,error:v}=await h.from("booster_configs").insert({name:x.trim(),price_type:"credits",price_credits:1e3,card_count:5}).select().single();if(v){alert(v.message);return}n.push(g),t=g.id,p=null,r()}),e.querySelectorAll(".btn-delete").forEach(x=>{x.addEventListener("click",async g=>{if(g.stopPropagation(),!confirm("Supprimer ce booster ?"))return;await h.from("booster_configs").delete().eq("id",x.dataset.id);const v=n.findIndex(y=>y.id===x.dataset.id);v>-1&&n.splice(v,1),t===x.dataset.id&&(t=null,p=null),r()})}),(E=o("#btn-cancel"))==null||E.addEventListener("click",()=>{t=null,r()}),(w=o("#f-price-type"))==null||w.addEventListener("change",x=>{const g=o("#credits-field");g&&(g.style.opacity=x.target.value!=="credits"?"0.4":"1")}),(b=o("#btn-pick-icon"))==null||b.addEventListener("click",async()=>{var g;const x=o("#icon-picker-grid");if(x){if(x.style.display!=="none"){x.style.display="none";return}x.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',x.style.display="block";try{const y=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),_=Array.isArray(y)?y.filter(I=>I.name.startsWith("booster")&&/\.(png|jpg|svg|webp)$/i.test(I.name)):[];if(!_.length){x.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucune icône "booster*" trouvée.</div>';return}const L=((g=o("#f-image-url"))==null?void 0:g.value)||"";x.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
          ${_.map(I=>`
        ...
        </div>`,x.querySelectorAll(".icon-pick-item").forEach(I=>{I.addEventListener("click",()=>{const z=o("#f-image-url");z&&(z.value=I.dataset.name),x.style.display="none"})})}catch(v){x.innerHTML=`<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Erreur API GitHub : ${v.message}</div>`}}});function c(){e.querySelectorAll("[data-rate-idx]").forEach(x=>{var v,y,_,L,I;const g=Number(x.dataset.rateIdx);g>=0&&g<i.length&&(i[g].card_type=((v=x.querySelector(".rate-type"))==null?void 0:v.value)||"player",i[g].rarity=((y=x.querySelector(".rate-rarity"))==null?void 0:y.value)||null,i[g].note_min=Number((_=x.querySelector(".rate-note-min"))==null?void 0:_.value)||null,i[g].note_max=Number((L=x.querySelector(".rate-note-max"))==null?void 0:L.value)||null,i[g].percentage=Number((I=x.querySelector(".rate-pct"))==null?void 0:I.value)||0)})}(k=o("#btn-add-rate"))==null||k.addEventListener("click",()=>{c(),i.push({id:null,booster_id:t,card_type:"player",rarity:"normal",note_min:null,note_max:null,percentage:10,sort_order:i.length}),r(!0)}),e.querySelectorAll(".btn-del-rate").forEach(x=>{x.addEventListener("click",()=>{c(),i.splice(Number(x.dataset.idx),1),r(!0)})}),($=o("#btn-save"))==null||$.addEventListener("click",async()=>{var L,I,z,S,T,F,H,G,U,V,K,J,M;const x=(n||[]).find(B=>B.id===t);if(!x)return;const g=[];e.querySelectorAll("[data-rate-idx]").forEach(B=>{var ge,fe,be,xe,ve;const le=Number(B.dataset.rateIdx);g.push({booster_id:t,card_type:((ge=B.querySelector(".rate-type"))==null?void 0:ge.value)||"player",rarity:((fe=B.querySelector(".rate-rarity"))==null?void 0:fe.value)||null,note_min:Number((be=B.querySelector(".rate-note-min"))==null?void 0:be.value)||null,note_max:Number((xe=B.querySelector(".rate-note-max"))==null?void 0:xe.value)||null,percentage:Number((ve=B.querySelector(".rate-pct"))==null?void 0:ve.value)||0,sort_order:le});const q=g[g.length-1];q.rarity||(q.rarity=null),q.note_min||(q.note_min=null),q.note_max||(q.note_max=null)});const v=g.reduce((B,le)=>B+le.percentage,0);if(g.length&&Math.abs(v-100)>.5){alert(`La somme doit faire 100% (actuellement ${v.toFixed(1)}%)`);return}const y={name:((I=(L=o("#f-name"))==null?void 0:L.value)==null?void 0:I.trim())||x.name,image_url:((S=(z=o("#f-image-url"))==null?void 0:z.value)==null?void 0:S.trim())||null,price_type:(T=o("#f-price-type"))==null?void 0:T.value,price_credits:Number((F=o("#f-price-credits"))==null?void 0:F.value)||0,card_count:Number((H=o("#f-card-count"))==null?void 0:H.value)||5,is_active:((G=o("#f-active"))==null?void 0:G.checked)??x.is_active,allow_duplicates:((U=o("#f-allow-dup"))==null?void 0:U.checked)??!0,sort_order:Number((V=o("#f-sort"))==null?void 0:V.value)||0,max_per_user:(K=o("#f-max-per-user"))!=null&&K.value?Number(o("#f-max-per-user").value):null,available_from:((J=o("#f-available-from"))==null?void 0:J.value)||null,available_until:((M=o("#f-available-until"))==null?void 0:M.value)||null},{error:_}=await h.from("booster_configs").update(y).eq("id",t);if(_){alert(_.message);return}if(Object.assign(x,y),await h.from("booster_drop_rates").delete().eq("booster_id",t),g.length){const{error:B}=await h.from("booster_drop_rates").insert(g);if(B){alert(B.message);return}}i=g,p=t,alert("✅ Booster enregistré !"),r(!0)})}r()}const Je=[{value:"normal",label:"Normal",color:"#888"},{value:"pepite",label:"Pépite",color:"#D4A017"},{value:"papyte",label:"Papyte",color:"#909090"},{value:"legende",label:"Légende",color:"#7a28b8"}];async function Ot(e){await pe(e)}async function pe(e){const{data:n,error:t}=await h.from("sell_price_configs").select("*").order("rarity").order("note_min");if(t){e.innerHTML=`<div style="padding:24px;color:red">Erreur : ${t.message}</div>`;return}e.innerHTML=`
  ...
  <div style="background:#fff;border-radius:10px;padding:12px 16px;box-shadow:0 1px 4px rgba(0,0,0,0.08);display:flex;align-items:center;gap:12px">
    ...
    <div style="background:rgba(0,0,0,0.3);border-radius:6px;padding:4px 6px;text-align:center;margin-top:4px">
      ...
      <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:4px">
        ${c.image_url?`<img src="/icons/${c.image_url}" style="max-height:${w}px;max-width:90%;object-fit:contain">`:`<div style="font-size:${Math.round(u*.3)}px">${f.label.split(" ")[0]}</div>`}
      </div>
    ...
    <div id="gc-list" style="background:#fff;${d()?"":"border-right:1px solid #e0e0e0;width:280px;flex-shrink:0;"}overflow-y:auto;height:100%">
      ...
      ${(n||[]).map(c=>{const u=R.find(E=>E.value===c.gc_type)||R[0],f=D.find(E=>E.value===c.color)||D[0];return`
        <div class="gc-row" data-id="${c.id}"
          ...
          <div style="width:36px;height:50px;border-radius:5px;border:2px solid ${f.hex};background:${u.bg};display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">
    ...
    </div>`}function r(){const c=t?(n||[]).find(f=>f.id===t):null;if(!c)return`<div style="flex:1;display:flex;align-items:center;justify-content:center;color:#bbb;font-size:14px;padding:40px;text-align:center">
      ← Sélectionnez une carte ou créez-en une nouvelle
    </div>`;const u=R.find(f=>f.value===c.gc_type)||R[0];return D.find(f=>f.value===c.color)||D[0],`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          <div>
            ...
            <select id="gc-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${R.map(f=>`<option value="${f.value}" ${c.gc_type===f.value?"selected":""}>${f.label}</option>`).join("")}
            </select>
          </div>
          <div>
            ...
            <select id="gc-color" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px">
              ${D.map(f=>`<option value="${f.value}" ${c.color===f.value?"selected":""}>${f.label}</option>`).join("")}
            </select>
          </div>
        </div>
        ...
        <div style="border-top:1px solid #eee;padding-top:12px;margin-top:4px">
          ...
          <div>
            ...
            <select id="gc-effect-type" style="width:100%;padding:9px;border:1px solid #ddd;border-radius:6px;font-size:13px;margin-bottom:10px">
              ${i.map(f=>`<option value="${f.value}" ${(c.effect_type||"BOOST_STAT")===f.value?"selected":""}>${f.label}</option>`).join("")}
            </select>
          </div>
          ${(()=>{const f=c.effect_params||{},E=i.find(w=>w.value===(c.effect_type||"BOOST_STAT"))||i[0];return`
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
              ${E.hasValue?`<div>
    ...
    <div style="display:flex;height:calc(100vh - 56px);overflow:hidden">
      ${!d()||!t?m():""}
      ${!d()||t?r():""}
    </div>`,o()}function o(){var c,u,f,E,w;e.querySelectorAll(".gc-row").forEach(b=>{b.addEventListener("click",k=>{k.target.closest(".btn-toggle-gc,.btn-delete-gc")||(t=b.dataset.id,l())})}),(c=s("#btn-gc-back"))==null||c.addEventListener("click",()=>{t=null,l()}),(u=s("#btn-cancel-gc"))==null||u.addEventListener("click",()=>{t=null,l()}),(f=s("#btn-new-gc"))==null||f.addEventListener("click",async()=>{const b=prompt("Nom de la carte Game Changer :");if(!(b!=null&&b.trim()))return;const{data:k,error:$}=await h.from("gc_definitions").insert({name:b.trim(),gc_type:"game_changer",color:"purple"}).select().single();if($){alert($.message);return}n.push(k),t=k.id,l()}),e.querySelectorAll(".btn-toggle-gc").forEach(b=>{b.addEventListener("click",async k=>{k.stopPropagation();const $=b.dataset.active!=="true";await h.from("gc_definitions").update({is_active:$}).eq("id",b.dataset.id);const x=n.find(g=>g.id===b.dataset.id);x&&(x.is_active=$),l()})}),e.querySelectorAll(".btn-delete-gc").forEach(b=>{b.addEventListener("click",async k=>{if(k.stopPropagation(),!confirm("Supprimer cette carte Game Changer ?"))return;await h.from("gc_definitions").delete().eq("id",b.dataset.id);const $=n.findIndex(x=>x.id===b.dataset.id);$>-1&&n.splice($,1),t===b.dataset.id&&(t=null),l()})}),(E=s("#btn-pick-gc-icon"))==null||E.addEventListener("click",async()=>{var k;const b=s("#gc-icon-picker");if(b){if(b.style.display!=="none"){b.style.display="none";return}b.innerHTML='<div style="padding:10px;text-align:center;color:#888;font-size:12px">⏳ Chargement...</div>',b.style.display="block";try{const x=await(await fetch("https://api.github.com/repos/iamtsuba/manager-wars/contents/public/icons")).json(),g=Array.isArray(x)?x.filter(y=>y.name.startsWith("gamechanger-")&&/\.(png|jpg|svg|webp)$/i.test(y.name)):[];if(!g.length){b.innerHTML='<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Aucun fichier "gamechanger-*" trouvé dans public/icons/</div>';return}const v=((k=s("#gc-image-url"))==null?void 0:k.value)||"";b.innerHTML=`<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:8px">
          ${g.map(y=>`
        ...
        </div>`,b.querySelectorAll(".gc-icon-item").forEach(y=>{y.addEventListener("click",()=>{const _=s("#gc-image-url");_&&(_.value=y.dataset.name),b.style.display="none"})})}catch($){b.innerHTML=`<div style="padding:10px;text-align:center;color:#e74c3c;font-size:12px">Erreur API GitHub : ${$.message}</div>`}}}),(w=s("#btn-save-gc"))==null||w.addEventListener("click",async()=>{var y,_,L,I,z,S,T,F,H,G,U,V,K,J;const b=n.find(M=>M.id===t);if(!b)return;const k=i.find(M=>{var B;return M.value===(((B=s("#gc-effect-type"))==null?void 0:B.value)||"BOOST_STAT")})||i[0],$=k.hasRoles?[...e.querySelectorAll(".gc-p-role:checked")].map(M=>M.value):null,x={...k.hasValue?{value:Number((y=s("#gc-p-value"))==null?void 0:y.value)||2}:{},...k.hasCount?{count:Number((_=s("#gc-p-count"))==null?void 0:_.value)||1}:{},...k.hasTarget?{target:((L=s("#gc-p-target"))==null?void 0:L.value)||"home"}:{},...k.hasRoles?{roles:$!=null&&$.length?$:null}:{}},g={name:((z=(I=s("#gc-name"))==null?void 0:I.value)==null?void 0:z.trim())||b.name,effect:((T=(S=s("#gc-effect"))==null?void 0:S.value)==null?void 0:T.trim())||null,image_url:((H=(F=s("#gc-image-url"))==null?void 0:F.value)==null?void 0:H.trim())||null,gc_type:((G=s("#gc-type"))==null?void 0:G.value)||"game_changer",color:((U=s("#gc-color"))==null?void 0:U.value)||"purple",sort_order:Number((V=s("#gc-sort"))==null?void 0:V.value)||0,is_active:((K=s("#gc-active"))==null?void 0:K.checked)??b.is_active,effect_type:((J=s("#gc-effect-type"))==null?void 0:J.value)||"BOOST_STAT",effect_params:x},{error:v}=await h.from("gc_definitions").update(g).eq("id",t);if(v){alert(v.message);return}Object.assign(b,g),alert("✅ Carte enregistrée !"),l()})}l()}async function an(e,{toast:n,openModal:t,closeModal:i}){await P(e,{toast:n,openModal:t,closeModal:i})}async function P(e,n){var x;const{toast:t,openModal:i,closeModal:p}=n,[{data:d,error:s},{data:a}]=await Promise.all([h.from("ranked_seasons").select("*").order("start_at",{ascending:!1}),h.from("users").select("mmr,rank_tier,placement_matches").gte("placement_matches",1)]);if(s){e.innerHTML=`<p style="color:red">${s.message}</p>`;return}const m=d||[],r=m.find(g=>g.is_active),l=(a||[]).filter(g=>(g.placement_matches||0)>=1),o=l.filter(g=>(g.placement_matches||0)>=10),c=["bronze","silver","gold","platinum","diamond","master"],u={bronze:"Bronze",silver:"Argent",gold:"Or",platinum:"Platine",diamond:"Diamant",master:"Maître"},f={bronze:"#cd7f32",silver:"#a0a0a0",gold:"#D4A017",platinum:"#00e5ff",diamond:"#5b9bd5",master:"#9b59b6"},E={bronze:"🥉",silver:"🥈",gold:"🥇",platinum:"💎",diamond:"🔷",master:"👑"},w={};c.forEach(g=>{w[g]=0}),o.forEach(g=>{const v=g.rank_tier||"bronze";w[v]!==void 0&&w[v]++});const b=o.length?Math.round(o.reduce((g,v)=>g+(v.mmr||1e3),0)/o.length):0;function k(g){return g?new Date(g).toLocaleDateString("fr",{day:"numeric",month:"short",year:"numeric"}):"—"}function $(g){const v=new Date;return g.is_active?'<span style="background:#1A6B3C;color:#fff;padding:2px 8px;border-radius:10px;font-size:11px;font-weight:700">● ACTIVE</span>':new Date(g.end_at)<v?'<span style="background:#555;color:#ccc;padding:2px 8px;border-radius:10px;font-size:11px">Terminée</span>':'<span style="background:#e67e22;color:#fff;padding:2px 8px;border-radius:10px;font-size:11px">À venir</span>'}e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:20px">
      ...
      <div class="card-panel" style="background:linear-gradient(135deg,#0a3d1e,#1a6b3c20);border:1.5px solid #1A6B3C40">
        ...
        <div style="display:flex;flex-direction:column;gap:4px">
          ${c.map(g=>{const v=w[g],y=o.length>0?Math.round(v/o.length*100):0;return`
              <div style="display:flex;align-items:center;gap:8px;font-size:12px">
                <span style="width:80px">${E[g]} ${u[g]}</span>
                <div style="flex:1;background:rgba(255,255,255,0.08);border-radius:4px;height:14px;overflow:hidden">
                  <div style="height:100%;width:${y}%;background:${f[g]};border-radius:4px;transition:width 0.5s"></div>
                </div>
          ...
          <table>
            ...
            <tbody id="seasons-tbody">
              ${m.length===0?'<tr><td colspan="6" style="text-align:center;color:var(--gray-600);padding:24px">Aucune saison créée.</td></tr>':m.map(g=>{const v=Math.round((new Date(g.end_at)-new Date(g.start_at))/864e5),y=new Date(g.end_at)<new Date&&!g.is_active;return`
                    <tr>
                      <td><b>${g.name}</b></td>
                      <td style="font-size:12px">${k(g.start_at)}</td>
                      <td style="font-size:12px">${k(g.end_at)}</td>
    ...
    </div>`,(x=document.getElementById("create-season-btn"))==null||x.addEventListener("click",()=>{Se(null,{toast:t,openModal:i,closeModal:p,reload:()=>P(e,n)})}),e.querySelectorAll("[data-edit]").forEach(g=>{const v=m.find(y=>y.id==g.dataset.edit);g.addEventListener("click",()=>{Se(v,{toast:t,openModal:i,closeModal:p,reload:()=>P(e,n)})})}),e.querySelectorAll("[data-activate]").forEach(g=>{g.addEventListener("click",async()=>{const v=parseInt(g.dataset.activate);if(!confirm("Activer cette saison ? La saison actuellement active sera désactivée."))return;const{error:y}=await h.from("ranked_seasons").update({is_active:!1}).neq("id",0);if(y){t(y.message,"error");return}const{error:_}=await h.from("ranked_seasons").update({is_active:!0}).eq("id",v);if(_){t(_.message,"error");return}await h.from("users").update({current_season_id:v}).gt("placement_matches",0),t("Saison activée ✅","success"),P(e,n)})}),e.querySelectorAll("[data-deactivate]").forEach(g=>{g.addEventListener("click",async()=>{if(!confirm("Désactiver la saison active ? Le mode Ranked sera suspendu."))return;const{error:v}=await h.from("ranked_seasons").update({is_active:!1}).eq("id",parseInt(g.dataset.deactivate));if(v){t(v.message,"error");return}t("Saison désactivée","success"),P(e,n)})}),e.querySelectorAll("[data-delete]").forEach(g=>{g.addEventListener("click",async()=>{if(!confirm("Supprimer cette saison archivée ?"))return;const{error:v}=await h.from("ranked_seasons").delete().eq("id",parseInt(g.dataset.delete));if(v){t(v.message,"error");return}t("Saison supprimée","success"),P(e,n)})})}function Se(e,{toast:n,openModal:t,closeModal:i,reload:p}){const d=!!e,s=new Date().toISOString().slice(0,16),a=new Date(Date.now()+90*864e5).toISOString().slice(0,16),m=e?new Date(e.start_at).toISOString().slice(0,16):s,r=e?new Date(e.end_at).toISOString().slice(0,16):a,l=(e==null?void 0:e.name)||"";t(d?"✏️ Modifier la saison":"➕ Nouvelle saison",`<div style="display:flex;flex-direction:column;gap:14px">
      <div class="form-group">
