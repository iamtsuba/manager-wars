import{s as E,r as Pe,a as Ue,A as nt,l as it,g as ot,b as Oe,K as we,D as R,S as at,c as D,H as rt,R as lt,e as ue,d as Ge,f as st,h as dt,E as ct,i as pt,N as ut,M as mt,B as gt,j as ft,F as me,k as ke,m as bt,n as yt,o as xt,p as vt}from"./special-cards-q1oKjNQl.js";async function ht(e){var y;const[{count:t},{count:n},{count:i},{count:u},{count:d},{data:p}]=await Promise.all([E.from("players").select("*",{count:"exact",head:!0}),E.from("clubs").select("*",{count:"exact",head:!0}),E.from("users").select("*",{count:"exact",head:!0}),E.from("cards").select("*",{count:"exact",head:!0}),E.from("matches").select("*",{count:"exact",head:!0}),E.rpc("get_signup_password")]),l=p||"";e.innerHTML=`
