import{s as E,r as De,g as Pe,K as Ee,D as S,S as et,a as j,H as tt,R as nt,e as ue,b as qe,c as it,d as ot,E as at,f as rt,N as lt,M as st,B as dt,h as ct,F as me,i as we,j as pt,k as ut,l as mt,m as ft}from"./special-cards-Cm3c_QdR.js";async function gt(e){const[{count:t},{count:n},{count:i},{count:p},{count:d}]=await Promise.all([E.from("players").select("*",{count:"exact",head:!0}),E.from("clubs").select("*",{count:"exact",head:!0}),E.from("users").select("*",{count:"exact",head:!0}),E.from("cards").select("*",{count:"exact",head:!0}),E.from("matches").select("*",{count:"exact",head:!0})]);e.innerHTML=`
