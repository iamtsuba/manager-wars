...
import{s as v,j as hi,q as In,t as Ht,u as Ri,F as Oi,o as tt,n as ei,g as At,r as ze,m as Mt,v as Ai,w as uo,T as Li,p as fo,x as mo,d as go}from"./special-cards-lEGt-tGs.js";const xo="/";function cn(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,l,c,f,b;const o=n==="login";if(e.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const l=document.getElementById("logo-preview"),c=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();l&&(l.style.background=a,l.style.borderColor=o),c&&(c.textContent=x,c.style.color=o)}document.getElementById("color1").addEventListener("input",l=>{o=l.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",l=>{a=l.target.value,document.getElementById("swatch2").style.background=a,s()});function d(l){document.querySelectorAll(".setup-step").forEach(c=>c.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("step1-error");if(c.textContent="",l.length<3){c.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",l).maybeSingle();if(f){c.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),c=document.getElementById("step2-error");if(c.textContent="",l.length<2){c.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",l).maybeSingle();if(f){c.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await v.from("users").insert({id:t.user.id,pseudo:l,club_name:c,club_color1:o,club_color2:a,credits:1e4});if(x)throw x;await yo(t.user.id),await r(),n(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function yo(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const ho="modulepreload",vo=function(e){return"/"+e},pn={},Hi=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=vo(d),d in pn)return;pn[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const f=document.createElement("link");if(f.rel=l?"stylesheet":ho,l||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),l)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},ti="#1A6B3C",ii="#cc2222",wo="#D4A017",un="#888";async function _o(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`,l.querySelectorAll("[data-stats]").forEach(x=>{x.addEventListener("click",()=>Eo(e,x.dataset.stats,x.dataset.friendName))}),l.querySelectorAll("[data-match]").forEach(x=>{x.addEventListener("click",async()=>{const g=x.dataset.friendId,p=x.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:y}=await v.from("friend_match_invites").select("id").eq("inviter_id",g).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!y;console.log("[Friends] clic match",{fid:g,fname:p,isAccepting:w}),n("match",{matchMode:"friend",friendId:g,friendName:p,isAccepting:w})})})}function ko(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||ti,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    ${Vi()}`,document.body.appendChild(l);const f=()=>l.remove();l.querySelector("#pending-close").addEventListener("click",f),l.addEventListener("click",b=>{b.target===l&&f()}),l.querySelectorAll("[data-accept]").forEach(b=>{b.addEventListener("click",async()=>{const{error:x}=await v.from("friendships").update({status:"accepted"}).eq("id",b.dataset.accept);if(x){t("Erreur : "+x.message,"error");return}b.closest("div[style]").remove(),t("✅ Ami accepté !","success"),zn(e,t,n),i&&i()})}),l.querySelectorAll("[data-decline]").forEach(b=>{b.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",b.dataset.decline),b.closest("div[style]").remove(),t("Demande refusée","info"),i&&i()})})}async function Eo(e,t,i){const n=e.user.id,[r,o]=[n,t].sort(),a=n===r,{data:s}=await v.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",o).single(),d=e.profile.club_name||e.profile.pseudo||"Moi",l=s||{},c=a?l.wins_p1||0:l.wins_p2||0,f=a?l.wins_p2||0:l.wins_p1||0,b=l.draws||0,x=a?l.goals_p1||0:l.goals_p2||0,g=a?l.goals_p2||0:l.goals_p1||0,p=a?l.gc_used_p1||0:l.gc_used_p2||0,u=a?l.gc_used_p2||0:l.gc_used_p1||0,y=l.matches_total||0,w=(E,m,C,$=ti,S=ii)=>`
  ...
  <div class="home-dark" id="home-dark">
  ...
  </div>`,requestAnimationFrame(()=>{var b,x,g,p,u;const d=((b=window.visualViewport)==null?void 0:b.height)||window.innerHeight,l=((x=document.querySelector(".top-nav"))==null?void 0:x.offsetHeight)||56,c=((g=document.querySelector(".bottom-nav"))==null?void 0:g.offsetHeight)||60;if(e.querySelector(".home-inner")){const y=d-l-c;e.querySelector(".home-dark").style.minHeight=y+"px"}if(window.innerWidth<768){const y=((p=e.querySelector(".home-hero"))==null?void 0:p.offsetHeight)||60,w=e.querySelector(".ranked-tile");e.querySelector(".play-grid");const h=((u=e.querySelector(".home-footer"))==null?void 0:u.offsetHeight)||44,E=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((Q,ie)=>{var R;return Q+(((R=document.getElementById(ie))==null?void 0:R.offsetHeight)||0)},0),m=12*5,C=d-l-c-y-h-E-m-32,$=Math.max(80,Math.round(C*.28)),S=Math.max(160,Math.round(C*.72)),G=Math.floor((S-10)/2);w&&(w.style.minHeight=w.style.maxHeight=$+"px"),e.querySelectorAll(".play-tile").forEach(Q=>{Q.style.minHeight=Q.style.height=G+"px"}),e.querySelectorAll(".play-tile .play-icon").forEach(Q=>{Q.style.height=Math.round(G*.55)+"px"})}}),(o=document.getElementById("nav-rankings"))==null||o.addEventListener("click",()=>i("rankings")),(a=document.getElementById("nav-matches"))==null||a.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(d=>{d.addEventListener("click",()=>{d.style.transform="scale(.96)",setTimeout(()=>d.style.transform="",180);const l=d.dataset.action;if(l==="match-ai"){Mo(i);return}if(l==="match-random"){i("match",{matchMode:"random"});return}if(l==="match-friend"){i("friends");return}if(l==="mini-league"){i("mini-league");return}if(l==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()}),(s=document.getElementById("try-home2-btn"))==null||s.addEventListener("click",()=>i("home2")),jn(t,n),Ao(t,n,i),Cn(t,n,i),Io(t,n))}async function Io(e,t){const i=e.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(n!=null&&n.length))return;const r=n.reduce((a,s)=>a+(s.prize_amount||0),0),o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2200",o.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    `,document.head.appendChild(l)}const r=Co.map(l=>`
    ...
    `,document.body.appendChild(o),o.querySelector("#home2-chrome-settings-btn").addEventListener("click",()=>e("settings")),o.querySelector("#home2-chrome-credits").addEventListener("click",()=>e("boosters")));let a=document.getElementById("home2-mobile-top");a||(a=document.createElement("div"),a.id="home2-mobile-top",a.className="home2-mobile-top",a.innerHTML=`
      <div class="home2-chrome-logo"><img src="${n}logo-withname.png" alt="Manager Wars"></div>
      <div class="home2-chrome-right">
        <div class="home2-chrome-credits" id="home2-mobtop-credits">💰 ${(t.credits||0).toLocaleString("fr")}</div>
    ...
    `,document.body.appendChild(a),a.querySelector("#home2-mobtop-settings-btn").addEventListener("click",()=>e("settings")),a.querySelector("#home2-mobtop-credits").addEventListener("click",()=>e("boosters")));let s=document.getElementById("home2-mobile-bottom");s||(s=document.createElement("div"),s.id="home2-mobile-bottom",s.className="home2-mobile-bottom",s.innerHTML=r,document.body.appendChild(s)),document.querySelectorAll(".home2-chrome-tab").forEach(l=>{l._v2Bound||(l._v2Bound=!0,l.addEventListener("click",()=>{document.querySelectorAll(".home2-chrome-tab").forEach(c=>c.classList.remove("active")),document.querySelectorAll(`.home2-chrome-tab[data-key="${l.dataset.key}"]`).forEach(c=>c.classList.add("active")),e(l.dataset.route)}))}),document.querySelectorAll(".home2-chrome-tab").forEach(l=>l.classList.toggle("active",l.dataset.key===i));const d=`💰 ${(t.credits||0).toLocaleString("fr")}`;document.getElementById("home2-chrome-credits")&&(document.getElementById("home2-chrome-credits").textContent=d),document.getElementById("home2-mobtop-credits")&&(document.getElementById("home2-mobtop-credits").textContent=d),requestAnimationFrame(()=>{const l=window.innerWidth<1024;document.documentElement.style.setProperty("--v2-top-height",(l?a.offsetHeight:o.offsetHeight)+"px"),document.documentElement.style.setProperty("--v2-bottom-height",s.offsetHeight+"px")})}function jo(){var e,t,i,n;(e=document.getElementById("home2-chrome-header"))==null||e.remove(),(t=document.getElementById("home2-mobile-top"))==null||t.remove(),(i=document.getElementById("home2-mobile-bottom"))==null||i.remove(),(n=document.getElementById("home2-chrome-style"))==null||n.remove()}function Bo(e){if(!e)return"";const t=Date.now()-new Date(e).getTime(),i=Math.floor(t/6e4);if(i<1)return"à l'instant";if(i<60)return`il y a ${i}min`;const n=Math.floor(i/60);if(n<24)return`il y a ${n}h`;const r=Math.floor(n/24);return r<7?`il y a ${r}j`:new Date(e).toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})}function qo(e,t){if(!isFinite(t.max))return"";const i=t.max-t.min+1,n=Math.floor((e-t.min)/(i/3));return["III","II","I"][Math.min(2,Math.max(0,n))]}async function Do(e){const{data:t}=await v.from("users").select("id,pseudo,club_name,mmr").order("mmr",{ascending:!1}).limit(5),i=t||[],n=i.some(o=>o.id===e);let r=null;if(!n){const{data:o}=await v.from("users").select("mmr").eq("id",e).single();if(o){const{count:a}=await v.from("users").select("id",{count:"exact",head:!0}).gt("mmr",o.mmr||0);r=(a||0)+1}}return{list:i,iAmInTop:n,myPosition:r}}async function Fo(e=4){const{data:t}=await v.from("patch_notes").select("id,title,description,image_url,published_at").eq("is_published",!0).order("published_at",{ascending:!1}).limit(e);return t||[]}async function Po(){const{data:e}=await v.from("booster_configs").select("id,name,icon,price_type,price_credits,card_count").eq("is_active",!0).order("created_at",{ascending:!1}).limit(5);return e||[]}async function Go(){const{data:e}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(n=>{const r=new Date(n.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close-v2").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}async function No(e,{state:t,navigate:i,toast:n}){var m,C,$,S,G,Q,ie;const r=t.profile;if(!r)return;const o="/icons/";Bn(i,r,"home2",o);const a=r.mmr??1e3,s=hi(a),d=qo(a,s),l=In(a),c=isFinite(s.max)?s.max+1:null,[{list:f,iAmInTop:b,myPosition:x},g,p]=await Promise.all([Do(r.id),Fo(5),Po()]),u=(R,T)=>`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Bo(R.published_at)}</div>
      </div>
    </div>`;let w=0;const h=R=>`
    <div class="promo-icon-wrap">
      <img src="${o}${R.icon||"nav-boosters.png"}" class="promo-icon" onerror="this.style.display='none'">
    </div>
  ...
  <div class="home-dark" id="home-dark">
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-center">
          ...
          <div class="promo-banner" id="promo-banner">
            ...
            ${p.length>1?`<div class="promo-dots">${p.map((R,T)=>`<div class="promo-dot ${T===0?"active":""}" data-dot="${T}"></div>`).join("")}</div>`:""}
          </div>`:""}
        </div>
  ...
  </div>`,requestAnimationFrame(()=>{var de,me;const R=((de=window.visualViewport)==null?void 0:de.height)||window.innerHeight,T=window.innerWidth<1024;let I=0;if(T){const j=document.getElementById("home2-mobile-top"),V=document.getElementById("home2-mobile-bottom");I=((j==null?void 0:j.offsetHeight)||0)+((V==null?void 0:V.offsetHeight)||0)}else I=((me=document.getElementById("home2-chrome-header"))==null?void 0:me.offsetHeight)||0;const K=R-I,W=e.querySelector(".home-dark");W&&(W.style.minHeight=K+"px")});const E=()=>{const R=document.getElementById("mode-indicator");R&&(R.textContent=window.innerWidth>=1024?"🖥️ Mode PC":"📱 Mode Mobile")};if(E(),window.addEventListener("resize",E),(m=document.getElementById("nav-profile-btn"))==null||m.addEventListener("click",()=>i("settings")),(C=document.getElementById("nav-rankings-link"))==null||C.addEventListener("click",()=>i("rankings")),($=document.getElementById("nav-rankings-cta"))==null||$.addEventListener("click",()=>i("rankings")),(S=document.getElementById("rank-inline-link-btn"))==null||S.addEventListener("click",()=>i("rankings")),(G=document.getElementById("nav-journal-link"))==null||G.addEventListener("click",()=>Go()),e.querySelectorAll("[data-action]").forEach(R=>{R.addEventListener("click",()=>{R.style.transform="scale(.96)",setTimeout(()=>R.style.transform="",180);const T=R.dataset.action;if(T==="match-ai"){Fn(i,t);return}if(T==="match-random"){i("match",{matchMode:"random"});return}if(T==="match-friend"){i("friends");return}if(T==="mini-league"){i("mini-league");return}if(T==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),p.length>1){const R=document.getElementById("promo-slide-content"),T=()=>Array.from(document.querySelectorAll(".promo-dot")),I=K=>{w=K,R&&(R.innerHTML=h(p[w])),T().forEach((W,de)=>W.classList.toggle("active",de===w))};setInterval(()=>I((w+1)%p.length),5e3),document.querySelectorAll(".promo-dot").forEach(K=>{K.addEventListener("click",()=>I(Number(K.dataset.dot)))})}(Q=document.getElementById("promo-cta-btn"))==null||Q.addEventListener("click",()=>i("boosters")),(ie=document.getElementById("back-to-v1-btn"))==null||ie.addEventListener("click",()=>{jo(),i("home")}),Dn(t,n),Uo(t,n,i),qn(t,n,i),Ro(t,n)}async function Ro(e,t){const i=e.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(n!=null&&n.length))return;const r=n.reduce((a,s)=>a+(s.prize_amount||0),0),o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2200",o.innerHTML=`<div class="modal" style="max-width:400px">
    <div class="modal-header"><h2 style="color:#1A6B3C">🏆 Gains à récupérer</h2></div>
    <div class="modal-body" style="padding:18px 20px">
      <p style="font-size:14px;color:#555;margin:0 0 14px">Tu as terminé sur le podium de ${n.length>1?"plusieurs mini leagues":"une mini league"} !</p>
      <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px">
  ...
  </div>`,document.body.appendChild(o),o.querySelector("#claim-later-btn").addEventListener("click",()=>o.remove()),o.querySelector("#claim-all-btn").addEventListener("click",async a=>{const s=a.currentTarget;s.disabled=!0,s.textContent="...";let d=0;for(const l of n){const{data:c}=await v.rpc("claim_mini_league_prize",{p_league_id:l.league_id,p_user_id:i});c!=null&&c.success&&!c.already_claimed&&(d+=c.prize||0)}if(d>0){e.profile.credits=(e.profile.credits||0)+d;const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${e.profile.credits.toLocaleString("fr")}`),t(`💰 +${d.toLocaleString("fr")} cr. récupérés !`,"success")}o.remove()})}async function qn(e,t,i){const n=document.getElementById("ongoing-match-banner");if(!n)return;const r=e.profile.id,{data:o}=await v.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(o!=null&&o.length)){n.innerHTML="";return}const a=o.map(d=>d.home_id===r?d.away_id:d.home_id).filter(Boolean);let s={};if(a.length){const{data:d}=await v.from("users").select("id, pseudo, club_name").in("id",a);(d||[]).forEach(l=>{s[l.id]=l.club_name||l.pseudo})}n.innerHTML=o.map(d=>{const l=d.home_id===r?d.away_id:d.home_id,c=s[l]||"Adversaire",f=d.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
      <div style="background:rgba(255,255,255,0.15);border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0">⚽</div>
      <div style="flex:1;min-width:0">
        <div style="font-size:13px;font-weight:900">${f?"🏆 Mini League":d.mode==="friend"?"Match ami":"Match"} en cours</div>
        <div style="font-size:11px;opacity:0.8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">vs ${c}</div>
      ...
      <button data-resume="${d.id}" data-mini="${f?"1":""}" style="width:38px;height:38px;border-radius:50%;border:none;background:#22c55e;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">⚽</button>
      <button data-abandon="${d.id}" data-opp="${l}" style="width:38px;height:38px;border-radius:50%;border:none;background:#cc2222;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">✕</button>
    </div>`}).join(""),n.querySelectorAll("[data-resume]").forEach(d=>{d.addEventListener("click",async()=>{const l=document.getElementById("page-content")||document.getElementById("app");if(d.dataset.mini==="1"){const{data:c}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",d.dataset.resume).single();c?i("match-mini-league",{mlMatchId:c.id,leagueId:c.league_id}):i("mini-league")}else{const{resumePvpMatch:c}=await Hi(async()=>{const{resumePvpMatch:f}=await Promise.resolve().then(()=>io);return{resumePvpMatch:f}},void 0);c(l,{state:e,navigate:i,toast:t,openModal:null,closeModal:null,refreshProfile:null},d.dataset.resume)}})}),n.querySelectorAll("[data-abandon]").forEach(d=>{d.addEventListener("click",()=>{Ho(async()=>{await Oo(d.dataset.abandon,d.dataset.opp,r),t("Match abandonné (défaite 3-0)","info"),qn(e,t,i)})})})}async function Oo(e,t,i){Tt();const{data:n}=await v.from("matches").select("home_id, away_id, game_state, mode").eq("id",e).single();if(!n)return;const r=n.home_id===i,o=r?0:3,a=r?3:0,s=n.game_state||{};s.p1Score=o,s.p2Score=a,s.phase="finished",s.forfeit=!0,await v.from("matches").update({status:"finished",forfeit:!0,winner_id:t,home_score:o,away_score:a,game_state:s}).eq("id",e),n.mode==="mini_league"&&await v.from("mini_league_matches").update({status:"finished",home_score:o,away_score:a}).eq("match_id",e)}function Ho(e){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`<div class="modal" style="max-width:340px">
    <div class="modal-body" style="padding:26px 22px 20px;text-align:center">
      <div style="font-size:40px;margin-bottom:8px">⚠️</div>
      <div style="font-size:17px;font-weight:900;margin-bottom:6px;color:#1a1a1a">Abandonner le match ?</div>
      <div style="font-size:13px;color:#666;margin-bottom:18px">Tu perdras par forfait <b>3-0</b>.</div>
  ...
  </div>`,document.body.appendChild(t),t.querySelector("#ab-cancel").addEventListener("click",()=>t.remove()),t.querySelector("#ab-ok").addEventListener("click",()=>{t.remove(),e()}),t.addEventListener("click",i=>{i.target===t&&t.remove()})}async function Uo(e,t,i){var s,d,l,c;const n=document.getElementById("match-invite-banner");if(!n)return;const{data:r}=await v.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",e.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!r){n.innerHTML="";return}const o=((s=r.inviter)==null?void 0:s.club_name)||((d=r.inviter)==null?void 0:d.pseudo)||"?",a=r.inviter_id;n.innerHTML=`<div id="match-invite-btn" style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(26,10,46,0.8),rgba(74,26,138,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(122,40,184,0.4);cursor:pointer;box-shadow:0 3px 12px rgba(74,10,138,0.3)">
    <div style="background:rgba(255,255,255,0.15);border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0">⚽</div>
    <div style="flex:1"><div style="font-size:13px;font-weight:900">${o} t'invite à jouer !</div><div style="font-size:11px;opacity:0.75">Accepter la partie ?</div></div>
    <div style="display:flex;gap:8px">
      <button id="match-inv-accept" style="padding:6px 12px;border-radius:8px;border:none;background:#22c55e;color:#fff;font-size:12px;font-weight:900;cursor:pointer">Jouer !</button>
  ...
  </div>`,(l=document.getElementById("match-inv-accept"))==null||l.addEventListener("click",()=>{n.innerHTML="",i("match",{matchMode:"friend",friendId:a,friendName:o,isAccepting:!0})}),(c=document.getElementById("match-inv-decline"))==null||c.addEventListener("click",async()=>{await v.from("friend_match_invites").update({status:"declined"}).eq("id",r.id),n.innerHTML="",t("Invitation refusée","info")})}async function Dn(e,t){const i=document.getElementById("friend-requests-banner");if(!i)return;const{data:n,error:r}=await v.from("friendships").select("id, requester:users!requester_id(pseudo, club_name)").eq("addressee_id",e.user.id).eq("status","pending");if(r||!(n!=null&&n.length)){i.innerHTML="";return}const o=n.length,a=n.slice(0,2).map(d=>{var l;return((l=d.requester)==null?void 0:l.pseudo)||"?"}).join(", "),s=o>2?` +${o-2}`:"";i.innerHTML=`<div id="friend-req-btn" style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(26,107,60,0.6),rgba(42,157,92,0.4));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);cursor:pointer;box-shadow:0 3px 12px rgba(26,107,60,0.25)">
    <div style="background:rgba(255,255,255,0.15);border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0">👥</div>
    <div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:900">${o} demande${o>1?"s":""} d'ami${o>1?"s":""}</div><div style="font-size:11px;opacity:0.85;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${a}${s}</div></div>
    <div style="font-size:20px;flex-shrink:0">›</div>
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>Ui(e,t,()=>Dn(e,t)))}async function Fn(e,t){const i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:420px;border-radius:18px;overflow:hidden">
    ...
    <div class="modal-body" style="padding:16px">
  ...
  </div>`,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",n),i.addEventListener("click",l=>{l.target===i&&n()});const[{data:r},{data:o}]=await Promise.all([v.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),v.from("user_solo_progress").select("unlocked_level").eq("user_id",t.profile.id).maybeSingle()]),a=(o==null?void 0:o.unlocked_level)||1,s=r||[],d=document.getElementById("solo-levels-list");if(d){if(!s.length){d.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}d.innerHTML=s.map(l=>{const c=l.level_number>a,f=l.level_number===a,b=c?"#f0f0f0":f?"#eefaf2":"#f7f7f7",x=c?"#ddd":f?"#bfe8cf":"#e0e0e0",g=c?"#999":"#12401f";return`
      ...
      </div>`}).join(""),d.querySelectorAll(".solo-level-card").forEach(l=>{l.dataset.locked!=="true"&&(l.addEventListener("mouseenter",()=>{l.style.transform="translateY(-1px)"}),l.addEventListener("mouseleave",()=>{l.style.transform=""}),l.addEventListener("click",()=>{n(),e("match",{matchMode:"solo",soloLevel:Number(l.dataset.level)})}))})}}async function Ko(e,{state:t,navigate:i,toast:n}){const r=t.profile;if(!r)return;const o="/icons/";Bn(i,r,"game",o),e.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${ze(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter(k=>k.card_type==="player"&&k.player),c=(s||[]).filter(k=>k.card_type==="game_changer"),f=(s||[]).filter(k=>k.card_type==="formation"),b=(s||[]).filter(k=>k.card_type==="stadium"),{data:x}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach(k=>{g[k.name]=k});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(k=>{u[k.id]=k}),b.forEach(k=>{k.stadium_def&&(u[k.stadium_id]=k.stadium_def)});const y=Object.keys(Oi),w=Object.keys(je),h={};l.forEach(k=>{const M=k.player.id;h[M]=(h[M]||0)+1}),new Set(Object.keys(h).map(k=>String(k)));const E=new Set(f.map(k=>k.formation)),m=new Set(c.map(k=>k.gc_type));let C="player",$="Tous",S="",G=!1;function Q(){return[...l].sort((k,M)=>{const O=si.indexOf(k.player.job),F=si.indexOf(M.player.job);return O!==F?O-F:(k.player.surname_real||"").localeCompare(M.player.surname_real||"")})}function ie(){return[...d||[]].sort((k,M)=>{const O=si.indexOf(k.job),F=si.indexOf(M.job);return O!==F?O-F:(k.surname_real||"").localeCompare(M.surname_real||"")})}function R(){return Q().filter(k=>{const M=k.player,O=$==="Tous"||M.job===$,F=!S||`${M.firstname} ${M.surname_real}`.toLowerCase().includes(S);return O&&F})}function T(){return ie().filter(k=>{const M=$==="Tous"||k.job===$,O=!S||`${k.firstname} ${k.surname_real}`.toLowerCase().includes(S);return M&&O})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(M){const O=document.getElementById(M);if(!O)return;O.addEventListener("wheel",ne=>{Math.abs(ne.deltaY)<=Math.abs(ne.deltaX)||(ne.preventDefault(),O.scrollLeft+=ne.deltaY)},{passive:!1});let F=!1,Y=0,q=0,H=!1,le=!1;O.addEventListener("mousedown",ne=>{F=!0,H=!1,Y=ne.pageX,q=O.scrollLeft}),window.addEventListener("mouseup",()=>{F=!1,H&&(O.style.cursor="",le=!0),H=!1}),window.addEventListener("mousemove",ne=>{if(!F)return;const fe=ne.pageX-Y;!H&&Math.abs(fe)<6||(H=!0,O.style.cursor="grabbing",ne.preventDefault(),O.scrollLeft=q-fe)}),O.addEventListener("click",ne=>{le&&(ne.stopPropagation(),ne.preventDefault(),le=!1)},!0)}("col-grid");function I(){const k=document.getElementById("col-filters");k&&(C==="player"?(k.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",M=>{S=M.target.value.toLowerCase(),K()}),e.querySelectorAll(".filter-btn").forEach(M=>{M.addEventListener("click",()=>{$=M.dataset.job,I(),K()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{G=!G,I(),K()})):(k.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{G=!G,I(),K()})))}function K(){const k=document.getElementById("col-grid");k&&(C==="player"?V(k):C==="formation"?ue(k):C==="stadium"?ce(k):pe(k))}function W(k,M,O,F,Y,q=0){const H=document.getElementById("col-grid"),le=document.getElementById("col-big");if(!H||!le)return;var ne=0;function fe(){var ct;const we=window.innerWidth>=768,he=document.getElementById("col-big"),Te=document.getElementById("col-gap"),Se=((ct=document.getElementById("col-grid"))==null?void 0:ct.parentElement)||null,Be=he?he.closest(".page"):null;if(he&&Se&&Be){let Ee=0;Array.from(Be.children).forEach(function(B){B!==he&&B!==Se&&B!==Te&&(Ee+=B.offsetHeight)});const Ce=Math.max(0,Be.clientHeight-Ee),qe=Math.round(Ce*(q/100)),Ge=Math.max(0,Ce-qe),_=we?50/71:45/63,L=Math.round(Ge*_),A=Math.max(0,Ge-L);Te&&(Te.style.height=qe+"px"),he.style.flex="none",he.style.height=L+"px",he.style.minHeight="0",Se.style.flex="none",Se.style.height=A+"px",Se.style.minHeight="0",Se.style.display="flex",Se.style.overflow="hidden"}const $e=document.getElementById("col-grid");$e&&($e.style.height="100%",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.width="100%"),le.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+M(k[ne])+"</div>";var _t=le.querySelector("[data-card-id],[data-form-id],[data-gc-id]");_t&&_t.addEventListener("click",function(){F(k[ne])}),requestAnimationFrame(function(){var Ee=document.getElementById("big-card-inner");if(!(!Ee||!le)){var Ce=le.clientHeight,qe=le.clientWidth-16,Ge=Ee.offsetHeight,_=Ee.offsetWidth;if(Ge>0&&_>0&&Ce>40){var L=Math.min(Ce/Ge,qe/_);Ee.style.transform="scale("+L.toFixed(3)+")",Ee.style.transformOrigin="center center"}}}),H.innerHTML=k.map(function(Ee,Ce){var qe=Ce===ne,Ge="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Ge+'">'+O(Ee,qe)+"</div>"}).join(""),H.querySelectorAll(".col-mini-item").forEach(function(Ee){Ee.addEventListener("click",function(){ne=Number(Ee.dataset.idx),fe(),Ee.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var Ee=$e?$e.clientHeight:0,Ce=H.querySelector(".col-mini-item > div");if(!(!Ee||!Ce)){var qe=Ce.style.zoom;Ce.style.zoom="1";var Ge=Ce.offsetHeight;if(Ce.style.zoom=qe,!(Ge<=0)){var _=Ee/Ge;H.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=_.toFixed(4)})}}})}fe()}function de(k,M){var O=window.innerWidth>=768?.76:.54,F;if(!k||k._fake){var Y=k?k.player:null;if(!Y)return"";F=bn(Y)}else F=Ii(k,"");var q=k&&!k._fake?h[k.player&&k.player.id]||1:0,H=q>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+q+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+O+';pointer-events:none;line-height:0">'+H+F+"</div>"}function me(k,M,O){var F=O>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+O+"</div>":"",Y=!!M,q=Ai(k,Mt[k],{width:160});return Y||(q='<div style="filter:grayscale(1);opacity:0.5">'+q+"</div>"),"<div "+(M?'data-form-id="'+M.id+'"':"")+' style="position:relative;cursor:pointer">'+F+q+"</div>"}function j(k,M){var O=window.innerWidth>=768?.76:.54,F=Ai(k,Mt[k],{width:140});return M||(F='<div style="filter:grayscale(1);opacity:0.45">'+F+"</div>"),'<div style="display:inline-block;zoom:'+O+';line-height:0;pointer-events:none">'+F+"</div>"}function V(k){if(G){const M=T();if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const O=M.map(F=>l.find(Y=>Y.player.id===F.id)||{_fake:!0,player:F,id:"fake-"+F.id});W(O,F=>F._fake?bn(F.player):Ii(F,""),F=>F._fake?de({player:F.player,id:"x",_fake:!0}):de(F),F=>{F._fake||yn(F,l,h,t)})}else{const M=R();if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const O={};M.forEach(Y=>{const q=Y.player.id;O[q]||(O[q]=[]),O[q].push(Y)});const F=Object.values(O).map(Y=>Jo(Y));W(F,Y=>{const q=h[Y.player.id]||1,H=q>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${q}</div>`:"",ne=l.filter(fe=>fe.player.id===Y.player.id&&fe.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Ii(Y,H+ne)},Y=>de(Y),Y=>yn(Y,l,h,t))}}function ue(k){const M=G?y:[...E];if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const O=M.map(F=>({formation:F,card:f.find(Y=>Y.formation===F)||null,owned:E.has(F)}));W(O,({formation:F,card:Y,owned:q})=>me(F,q?Y:null,q?f.filter(H=>H.formation===F).length:0),({formation:F,owned:Y})=>j(F,Y),({card:F,owned:Y})=>{Y&&F&&tr(F,f,t,o)},"#1A6B3C",5)}function pe(k){const M=Object.keys(g),O=G?M.length?M:w:[...m];if(!O.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const F=O.map(Y=>({type:Y,gc:je[Y]||{icon:"⚡",desc:""},def:g[Y]||null,owned:m.has(Y),card:c.find(q=>q.gc_type===Y)||null}));W(F,({type:Y,gc:q,def:H,owned:le,card:ne})=>{var $e;const fe=(H==null?void 0:H.name)||Y,we=le?c.filter(_t=>_t.gc_type===Y).length:0,he=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Te=(H==null?void 0:H.effect)||q.desc||"",Se=H!=null&&H.image_url?`/icons/${H.image_url}`:(($e=H==null?void 0:H.club)==null?void 0:$e.logo_url)||(H!=null&&H.country_code?`https://flagsapi.com/${H.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=tt(fe,Se,q.icon,Te,{width:160,onClick:le});return le||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${le&&ne?`data-gc-id="${ne.id}" data-gc-type="${Y}"`:""} style="position:relative">${he}${Be}</div>`},({type:Y,gc:q,def:H,owned:le})=>{const ne=window.innerWidth>=768?.76:.54,fe=(H==null?void 0:H.name)||Y,we=(H==null?void 0:H.effect)||q.desc||"",he=H!=null&&H.image_url?`/icons/${H.image_url}`:null;let Te=tt(fe,he,q.icon,we,{width:140});return le||(Te=`<div style="filter:grayscale(1);opacity:0.45">${Te}</div>`),`<div style="display:inline-block;zoom:${ne};line-height:0;pointer-events:none">${Te}</div>`},({type:Y,owned:q,def:H})=>{q&&er(Y,H,o)},"#7a28b8",5)}function ce(k){const M="#4FC3F7",O="/";if(!b.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const F={};b.forEach(q=>{const H=q.stadium_id||"?";(F[H]=F[H]||[]).push(q)});const Y=Object.entries(F).map(([q,H])=>({sid:q,def:u[q]||null,count:H.length,card:H[0]}));W(Y,({def:q,count:H})=>{var Te,Se;const le=(q==null?void 0:q.name)||"?",ne=((Te=q==null?void 0:q.club)==null?void 0:Te.encoded_name)||(q==null?void 0:q.country_code)||"—",fe=q!=null&&q.image_url?`${O}icons/${q.image_url}`:((Se=q==null?void 0:q.club)==null?void 0:Se.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=H>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${H}</div>`:"",he=`${ne}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${we}${ei(le,fe,he,{width:160})}</div>`},({def:q})=>{var he,Te;const H=window.innerWidth>=768?.76:.54,le=(q==null?void 0:q.name)||"?",ne=((he=q==null?void 0:q.club)==null?void 0:he.encoded_name)||(q==null?void 0:q.country_code)||"—",fe=q!=null&&q.image_url?`${O}icons/${q.image_url}`:((Te=q==null?void 0:q.club)==null?void 0:Te.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=`${ne}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${H};line-height:0;pointer-events:none">${ei(le,fe,we,{width:140})}</div>`},null,M,5)}e.querySelectorAll(".col-tab-btn").forEach(k=>{k.addEventListener("click",()=>{C=k.dataset.tab,$="Tous",S="",G=!1,e.querySelectorAll(".col-tab-btn").forEach(M=>{const O=M.dataset.tab===C;M.style.borderBottomColor=O?"var(--green)":"transparent",M.style.color=O?"var(--green)":"var(--tile-fg-dim)"}),I(),K()})}),I(),K()}function er(e,t,i){const n=je[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.name)||e,o=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${tt(r,a,n.icon,o,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const li=1e3;function tr(e,t,i,n){var g,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:d}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=Mt[l]||{},w=Oi[l]||[],h=290,E=360,m=20;function C(S){const G=y[S];return G?{x:G.x*h,y:G.y*E}:null}let $=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[S,G]of w){const Q=C(S),ie=C(G);!Q||!ie||($+=`<line x1="${Q.x}" y1="${Q.y}" x2="${ie.x}" y2="${ie.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const S of Object.keys(y)){const G=C(S);if(!G)continue;const Q=S.replace(/\d+/,""),ie=c[Q]||"#555";$+=`<circle cx="${G.x}" cy="${G.y}" r="${m}" fill="${ie}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,$+=`<text x="${G.x}" y="${G.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${Q}</text>`}return $+="</svg>",$}const b=t.filter(y=>y.formation===l);b.length;const x=!e.is_for_sale;n(`Formation ${l}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${li.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=b.find(h=>!h.is_for_sale)||b[0];if(!y){o("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",y.id),await v.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await v.from("cards").delete().eq("id",y.id);if(w){o(w.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+li}).eq("id",r.profile.id),await d(),o(`+${li.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){o("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",e.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:y}),o("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),s("collection")})}async function yn(e,t,i,n){var me,j,V,ue,pe,ce;const{state:r,toast:o,openModal:a,closeModal:s,navigate:d,refreshProfile:l}=n,c=e.player,f=t.filter(k=>k.player.id===c.id),b=f.length,x=e.evolution_bonus||0,g=Math.max((Number(c.note_g)||0)+(c.job==="GK"||c.job2==="GK"?x:0),(Number(c.note_d)||0)+(c.job==="DEF"||c.job2==="DEF"?x:0),(Number(c.note_m)||0)+(c.job==="MIL"||c.job2==="MIL"?x:0),(Number(c.note_a)||0)+(c.job==="ATT"||c.job2==="ATT"?x:0)),p=c.rarity||"normal",{data:u}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((me=u==null?void 0:u[0])==null?void 0:me.price)??Xo[p];const y=c.rarity!=="legende";At(c);const w=di(c,c.job)+x,h=c.job2?di(c,c.job2)+(di(c,c.job2)>0?x:0):null;Ti[c.job],c.job2&&Ti[c.job2];const E=Yo[c.rarity]||"#ccc";Qo[c.country_code]||c.country_code;const m=e.evolution_bonus||0,$=w+m,S=h||0,G=S>0?S+m:0,Q=f.map(k=>k.id);let ie={};if(Q.length){const{data:k}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",Q).order("transferred_at",{ascending:!0});(k||[]).forEach(M=>{ie[M.card_id]||(ie[M.card_id]=[]),ie[M.card_id].push(M)})}const R=Q.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${f.filter(k=>k.id!==e.id).map((k,M)=>{const O=ie[k.id]||[],F=k.is_for_sale,Y=O.length?O[O.length-1]:null,q=k.evolution_bonus||0,H=Y?Y.source==="booster"?"Booster":Y.price?Y.price.toLocaleString("fr")+" cr.":"—":"—",le=Y?new Date(Y.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",ne=80,fe=Math.round(ne*657/507),we=ze({...c,_evolution_bonus:q},{width:ne});return`
            <div class="exemplaire-row" data-card-id="${k.id}" data-card-idx="${M}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${k.id}" data-evo="${q}" data-note="${di(c,c.job)}"
                ${F?"disabled":""}
                style="display:none">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${$}${c.job2&&S>0?` / ${G}`:""}`:`Note actuelle : ${$}${c.job2&&S>0?` / ${G}`:""}`}
            </div>
          </div>
      ...
      <!-- Carte visuelle -->
      ${ze({...c,_evolution_bonus:x},{width:160})}
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        <div>
          ...
          <div style="font-weight:700;color:${c.rarity==="normal"?"#555":c.rarity==="papyte"?"#707070":E}">${c.rarity.toUpperCase()}</div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([k,M])=>{const O=Ti[k],F=k==="GK"?"#fff":O,Y=k===c.job||k===c.job2,q=(Number(M)||0)+(Y&&m>0?m:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
    ...
    ${R}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",s);let T=new Set;const I=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function K(){let k=0;return document.querySelectorAll(".expl-check:checked").forEach(M=>{if(M.dataset.id===e.id)return;const F=Number(M.dataset.evo)||0,Y=Number(M.dataset.note)||0;k+=Y+F}),Math.round(k*I)}const W=()=>{const k=T.size,M=document.getElementById("sell-action-panel");if(!M)return;M.style.display=k>0?"block":"none",document.getElementById("sell-selected-count").textContent=k;const O=document.getElementById("evolve-btn");if(O){const F=K();O.textContent=F>0?`⬆️ Évoluer (+${F})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(k=>{k.addEventListener("change",()=>{const M=k.dataset.id;k.checked?T.add(M):T.delete(M);const O=k.closest(".exemplaire-row");if(O){const F=O.querySelector(".expl-sel-overlay"),Y=O.querySelector(".expl-sel-check");F&&(F.style.display=k.checked?"block":"none"),Y&&(Y.style.display=k.checked?"flex":"none"),O.style.transform=k.checked?"scale(1.05)":"scale(1)"}W()})}),document.querySelectorAll(".exemplaire-row").forEach(k=>{k.addEventListener("click",M=>{if(M.target.tagName==="INPUT")return;const O=k.querySelector(".expl-check");O&&!O.disabled&&(O.checked=!O.checked,O.dispatchEvent(new Event("change")))})}),(V=document.getElementById("evolve-btn"))==null||V.addEventListener("click",async()=>{if(b<=1)return;const k=[...T];if(!k.length)return;if(T.has(e.id)){const ne=document.createElement("div");ne.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ne.innerHTML=`
        ...
        </div>`,document.body.appendChild(fe),fe.querySelector("#sac-cancel").addEventListener("click",()=>{fe.remove(),ne(!1)}),fe.querySelector("#sac-ok").addEventListener("click",()=>{fe.remove(),ne(!0)}),fe.addEventListener("click",we=>{we.target===fe&&(fe.remove(),ne(!1))})}))return;if(M.length){await v.from("market_listings").delete().in("card_id",M),await v.from("deck_cards").delete().in("card_id",M),await v.from("transfer_history").delete().in("card_id",M),await v.from("decks").update({stadium_card_id:null}).in("stadium_card_id",M);const{error:ne}=await v.from("cards").delete().in("id",M);if(ne){o("Erreur suppression : "+ne.message,"error");return}}const H=(e.evolution_bonus||0)+F,{error:le}=await v.from("cards").update({evolution_bonus:H}).eq("id",e.id);if(le){o("Erreur évolution : "+le.message,"error");return}o(`⬆️ ${c.firstname} ${c.surname_real} : note ${w} → ${w+H} (+${F}) !`,"success",4e3),s(),d("collection")});async function de(k){const{data:M}=await v.from("sell_price_configs").select("price_min, price_max").eq("rarity",c.rarity).lte("note_min",w).gte("note_max",w).order("note_max",{ascending:!0}).limit(1).maybeSingle();return M?k<M.price_min||k>M.price_max?{ok:!1,min:M.price_min,max:M.price_max}:{ok:!0}:{ok:!0}}(ue=document.getElementById("market-sell-btn"))==null||ue.addEventListener("click",async()=>{var H;const k=[...T];if(!k.length){o("Sélectionne au moins un exemplaire","warning");return}const M=parseInt((H=document.getElementById("sell-market-price"))==null?void 0:H.value);if(!M||M<1){o("Prix invalide","error");return}const O=await de(M);if(!O.ok){o(`Prix hors grille : entre ${O.min.toLocaleString("fr")} et ${O.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:F}=await v.from("cards").update({is_for_sale:!0,sale_price:M}).in("id",k);if(F){o(F.message,"error");return}const Y=k.map(le=>({seller_id:r.profile.id,card_id:le,price:M,status:"active"})),{error:q}=await v.from("market_listings").insert(Y);q&&console.warn("[Market] insert listings:",q.message),o(`${k.length} carte${k.length>1?"s":""} mise${k.length>1?"s":""} en vente à ${M.toLocaleString("fr")} cr. chacune !`,"success"),s(),d("collection")}),(pe=document.getElementById("single-sell-btn"))==null||pe.addEventListener("click",async()=>{var Y;const k=parseInt((Y=document.getElementById("single-sell-price"))==null?void 0:Y.value);if(!k||k<1){o("Prix invalide","error");return}const M=await de(k);if(!M.ok){o(`Prix hors grille : entre ${M.min.toLocaleString("fr")} et ${M.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:O}=await v.from("cards").update({is_for_sale:!0,sale_price:k}).eq("id",e.id);if(O){o(O.message,"error");return}const{error:F}=await v.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:k,status:"active"});F&&console.warn("[Market] insert listing:",F.message),o(`Carte mise en vente à ${k.toLocaleString("fr")} cr. !`,"success"),s(),d("collection")}),(ce=document.getElementById("cancel-sell-btn"))==null||ce.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),d("collection")})}function hn(e,t=""){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(n);const r=n.querySelector("#pm-input");r.focus(),r.select();const o=a=>{n.remove(),i(a)};n.querySelector("#pm-ok").addEventListener("click",()=>o(r.value.trim()||null)),n.querySelector("#pm-cancel").addEventListener("click",()=>o(null)),n.querySelector("#pm-cancel2").addEventListener("click",()=>o(null)),n.addEventListener("click",a=>{a.target===n&&o(null)}),r.addEventListener("keydown",a=>{a.key==="Enter"&&o(r.value.trim()||null),a.key==="Escape"&&o(null)})})}function ir(e,t=!1){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:380px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${l.map(u=>{const y={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
                ${ze({...y,_evolution_bonus:y._evolution_bonus||0},{width:90,showStad:!0,stadDef:d})}
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${l.map(u=>{const y={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
                  ${ze({...y,_evolution_bonus:y._evolution_bonus||0},{width:44,showStad:!0,stadDef:d})}
                  <button data-remove-sub="${u.id}"
  ...
  </div>`;const c=window.innerWidth>=900,f=e.querySelector(".deck-pc-layout"),b=e.querySelector(".deck-mobile-layout");f&&(f.style.display=c?"block":"none"),b&&(b.style.display=c?"none":"block"),nr(e,t,r,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const x=()=>{const{openModal:u,closeModal:y}=i,w=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const E=wn(t.formation),m={};E.forEach(C=>{t.slots[C]&&(m[C]=t.slots[C])}),t.slots=m,y(),wt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>or(t,e,i))),e.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>sr(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{t.subs=t.subs.filter(y=>y!==u.dataset.removeSub),wt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>ar(t,e,i)))}function nr(e,t,i,n){var h,E,m;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=t.stadiumCards)==null?void 0:h.find(C=>C.id===t.stadiumCardId),s=a&&((E=t.stadDefMap)==null?void 0:E[a.stadium_id])||null,d=Mt[t.formation]||{},l=Ri(t.formation)||[],c={};for(const C of i){const $=t.slots[C],S=$?t.playerCards.find(G=>G.id===$):null;S!=null&&S.player?c[C]={...S.player,_evolution_bonus:S.evolution_bonus||0,face:S.player.face||null}:c[C]=null}const f=window.innerWidth>=900,b=f?window.innerWidth-280:window.innerWidth-20,x=f?Math.min(b,860):b,g=Math.round(f?x*.82:x*.85),p=f?84:44;let u="";for(const[C,$]of l){const S=d[C],G=d[$];if(!S||!G)continue;const Q=S.x*x,ie=Math.round(.03*g+S.y*.85*g),R=G.x*x,T=Math.round(.03*g+G.y*.85*g),I=c[C],K=c[$],W=Ht(I,K);W==="#ff3333"||W==="#cc2222"?u+=`<line x1="${Q.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${R.toFixed(1)}" y2="${T.toFixed(1)}" stroke="${W}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${Q.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${R.toFixed(1)}" y2="${T.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${Q.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${R.toFixed(1)}" y2="${T.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const C of i){const $=d[C];if(!$)continue;const S=c[C],G=$.x*x;$.y*g;const Q=Math.round(.03*g+$.y*(.85*g)),ie=Math.round(G-p/2),R=Math.round(Q-w/2);if(S){const T=C.replace(/\d+/,""),I=s&&(s.club_id&&String(S.club_id)===String(s.club_id)||s.country_code&&S.country_code===s.country_code),K=ze({...S,_evolution_bonus:S._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:T});I&&((m=s.club)!=null&&m.logo_url||s.image_url),y+=`<div style="position:absolute;left:${ie}px;top:${R}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${C}">
        <div style="position:relative">${K}</div>
      </div>`}else{const T=C.replace(/\d+/,"");y+=`<div style="position:absolute;left:${ie}px;top:${R}px;width:${p}px;height:${w}px;
    ...
    <div style="position:relative;width:${x}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(C=>{C.addEventListener("click",()=>rr(C.dataset.pos,t,e,n))})}function or(e,t,i){var a;const{openModal:n,closeModal:r}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(y=document.getElementById("close-selector"))==null||y.addEventListener("click",o),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete t.slots[e],o(),wt(i,t,n)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{t.slots[e]=h.dataset.cardId,o(),wt(i,t,n)})})}function ar(e,t,i){var c,f,b;const{openModal:n,closeModal:r}=i,o=(c=e.stadiumCards)==null?void 0:c.find(x=>x.id===e.stadiumCardId),a=o&&((f=e.stadDefMap)==null?void 0:f[o.stadium_id])||null,s=new Set;Object.keys(e.slots).forEach(x=>{var u;const g=e.slots[x];if(!g)return;const p=e.playerCards.find(y=>y.id===g);(u=p==null?void 0:p.player)!=null&&u.id&&s.add(p.player.id)}),e.subs.forEach(x=>{var p;const g=e.playerCards.find(u=>u.id===x);(p=g==null?void 0:g.player)!=null&&p.id&&s.add(g.player.id)});const d=new Set,l=e.playerCards.filter(x=>{var g,p,u;return s.has((g=x.player)==null?void 0:g.id)||d.has((p=x.player)==null?void 0:p.id)?!1:(d.add((u=x.player)==null?void 0:u.id),!0)});n("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(b=document.getElementById("close-sub-selector"))==null||b.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(x=>{x.addEventListener("click",()=>{e.subs.push(x.dataset.cardId),r(),wt(t,e,i)})})}async function sr(e,t){const{state:i,toast:n,navigate:r}=t,o=e.formationCards.find(d=>d.formation===e.formation),a=(o==null?void 0:o.id)||e.formationCardId;await v.from("decks").update({formation:e.formation,formation_card_id:a||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await v.from("deck_cards").delete().eq("deck_id",e.deckId);const s=[];if(Object.entries(e.slots).forEach(([d,l],c)=>{s.push({deck_id:e.deckId,card_id:l,position:d,is_starter:!0,slot_order:c})}),e.subs.forEach((d,l)=>{s.push({deck_id:e.deckId,card_id:d,position:`SUB${l+1}`,is_starter:!1,slot_order:100+l})}),s.length>0){const{error:d}=await v.from("deck_cards").insert(s);if(d){n(d.message,"error");return}}n("Deck enregistré ✅","success"),r("decks")}function wn(e){const t=fi[e]||fi["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}async function On(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await v.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const n=i.filter(a=>!(a.available_from&&t<a.available_from||a.available_until&&t>a.available_until));if(!n.length)return[];let r=n;if(e){const a=n.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await v.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",a.map(l=>l.id)),d={};(s||[]).forEach(l=>{d[l.booster_id]=(d[l.booster_id]||0)+1}),r=n.filter(l=>l.max_per_user==null?!0:(d[l.id]||0)<l.max_per_user)}}if(!r.length)return[];const{data:o}=await v.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(o||[]).filter(s=>s.booster_id===a.id)}))}async function dr(e,t){const{data:i}=await v.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await v.from("booster_claims").insert({user_id:e,booster_id:t})}function lr(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,r)=>n+Number(r.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const Hn=()=>Object.keys(Mt),cr=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],ji={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function pr(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return ze({...t,_evolution_bonus:i},{width:140})}function Un(e){var r;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((r=Object.entries(t).sort((o,a)=>a[1]-o[1])[0])==null?void 0:r[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function ur(e,{state:t,navigate:i,toast:n}){var f,b,x;const r=((f=t.profile)==null?void 0:f.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await On((b=t.user)==null?void 0:b.id)).map(Un)}catch(g){console.warn("Erreur chargement boosters DB, fallback hardcodé",g)}o.length||(o=cr.map(g=>({...g,rates:[],isPub:g.id==="players_pub"})));const a=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(g=>g.data||[]),s=new Set(a.filter(g=>g.card_type==="stadium").map(g=>g.stadium_id)),d=new Set(a.filter(g=>g.card_type==="formation").map(g=>g.formation)),l=new Set(a.filter(g=>g.card_type==="game_changer").map(g=>g.gc_type)),c={};for(const g of o){if(g.allow_duplicates!==!1||!((x=g.rates)!=null&&x.length))continue;const p=[...new Set((g.rates||[]).map(y=>y.card_type))];let u=!1;for(const y of p)if(y==="stadium"){const{data:w}=await v.from("stadium_definitions").select("id");if((w||[]).some(h=>!s.has(h.id))){u=!0;break}}else if(y==="game_changer"){const{data:w}=await v.from("gc_definitions").select("name").eq("is_active",!0);if((w||[]).some(h=>!l.has(h.name))){u=!0;break}}else if(y==="formation"){const{FORMATION_LINKS:w}=await Hi(async()=>{const{FORMATION_LINKS:h}=await import("./special-cards-lEGt-tGs.js").then(E=>E.y);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(w).some(h=>!d.has(h))){u=!0;break}}else{u=!0;break}u||(c[g.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(g=>{g.addEventListener("click",async()=>{const p=o.find(u=>u.id===g.dataset.booster);if(p){g.style.opacity="0.5",g.style.pointerEvents="none";try{await fr(p,{state:t,toast:n,navigate:i,container:e})}catch(u){n(u.message,"error"),g.style.opacity="",g.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(g=>{g.addEventListener("click",p=>{p.stopPropagation();const u=o.find(y=>y.id===g.dataset.boosterId);br(u)})})}async function fr(e,{state:t,toast:i,navigate:n,container:r}){var f,b;if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}e.isPub&&await hr();const{data:o}=await v.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),a=new Set((o||[]).filter(x=>x.card_type==="player").map(x=>x.player_id)),s=new Set((o||[]).filter(x=>x.card_type==="formation").map(x=>x.formation));let d=[],l=null;try{if((f=e.rates)!=null&&f.length)d=await Bi(t.profile,e);else{const x=e.type||"player";x==="player"?d=await Kn(t.profile,e.cardCount,e.cost):x==="game_changer"?d=await Vn(t.profile,e.cardCount,e.cost):x==="formation"?d=await Yn(t.profile,e.cost):d=await Bi(t.profile,e)}}catch(x){l=x.message||String(x),console.error("[Booster] Erreur:",x)}if(d!=null&&d.length&&e._boosterId&&await dr(t.user.id,e._boosterId),!(d!=null&&d.length)){const x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",x.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${l||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(x),(b=x.querySelector("#anim-close-err"))==null||b.addEventListener("click",()=>x.remove());return}d.forEach(x=>{x.card_type==="player"&&x.player?x.isDuplicate=a.has(x.player.id):x.card_type==="formation"&&(x.isDuplicate=s.has(x.formation))});const{data:c}=await v.from("users").select("*").eq("id",t.profile.id).single();c&&(t.profile=c),Wn(d,e,n)}function mr(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function mt(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function gr(e,t){let i;switch(t){case"legende":i=e.filter(n=>n.rarity==="legende"),i.length||(i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte")),i.length||(i=e.filter(n=>mt(n)>=6));break;case"special":i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte"),i.length||(i=e.filter(n=>mt(n)>=6));break;case"normal_high":i=e.filter(n=>n.rarity==="normal"&&mt(n)>=6),i.length||(i=e.filter(n=>mt(n)>=6));break;default:i=e.filter(n=>n.rarity==="normal"&&mt(n)>=1&&mt(n)<=5),i.length||(i=e.filter(n=>n.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function Bi(e,t){if(t.cost>0){const{error:b}=await v.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(b)throw b}const i=t.allow_duplicates!==!1;let n=[];const{data:r,error:o}=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.id);if(o){const{data:b}=await v.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",e.id);n=b||[]}else n=r||[];const a=new Set(n.filter(b=>b.card_type==="player").map(b=>b.player_id)),s=new Set(n.filter(b=>b.card_type==="formation").map(b=>b.formation)),d=new Set(n.filter(b=>b.card_type==="game_changer").map(b=>b.gc_type)),l=new Set(n.filter(b=>b.card_type==="stadium").map(b=>b.stadium_id).filter(Boolean)),c=new Set,f=[];for(let b=0;b<(t.cardCount||5);b++){const x=lr(t.rates);if(x){if(x.card_type==="player"){const g=$=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[$]||$,p=x.rarity?g(x.rarity):null;let u=v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);p&&(u=u.eq("rarity",p));const{data:y}=await u;let w=y||[];if((x.note_min||x.note_max)&&(w=w.filter($=>{const S=Math.max(Number($.note_g)||0,Number($.note_d)||0,Number($.note_m)||0,Number($.note_a)||0);return(!x.note_min||S>=x.note_min)&&(!x.note_max||S<=x.note_max)})),w.length||(x.note_min||x.note_max?(w=y||[],console.warn("[Booster] Aucun joueur avec note",x.note_min,"-",x.note_max,"— fallback rareté uniquement")):w=y||[]),!w.length)continue;let h=w.filter($=>!c.has($.id));if(i)h.length||(h=w);else if(h=h.filter($=>!a.has($.id)),!h.length)continue;const E=h[Math.floor(Math.random()*h.length)];c.add(E.id);const m=a.has(E.id),{data:C}=await v.from("cards").insert({owner_id:e.id,player_id:E.id,card_type:"player"}).select().single();C&&(f.push({...C,player:E,isDuplicate:m}),v.rpc("record_transfer",{p_card_id:C.id,p_player_id:E.id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(x.card_type==="game_changer"){const{data:g}=await v.from("gc_definitions").select("id,name,color,effect,image_url,gc_type").eq("is_active",!0).eq("gc_type","game_changer"),p=g!=null&&g.length?g:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],u=i?p:p.filter(E=>!d.has(E.name));if(!i&&!u.length)continue;const y=u[Math.floor(Math.random()*u.length)],w=y.name,{data:h}=await v.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:w,gc_definition_id:y.id||null}).select().single();h&&f.push({...h,_gcDef:y})}else if(x.card_type==="formation"){const g=Hn(),p=i?g:g.filter(h=>!s.has(h));if(!i&&!p.length)continue;const u=p[Math.floor(Math.random()*p.length)],y=s.has(u),{data:w}=await v.from("cards").insert({owner_id:e.id,card_type:"formation",formation:u}).select();w!=null&&w[0]&&f.push({...w[0],isDuplicate:y})}else if(x.card_type==="stadium"){const{data:g,error:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(p){console.error("[Booster] stadium_definitions:",p.message);continue}if(!(g!=null&&g.length)){console.warn("[Booster] Aucun stade en DB");continue}const u=i?g:g.filter(E=>!l.has(E.id));if(!i&&!u.length)continue;const y=u[Math.floor(Math.random()*u.length)],{data:w,error:h}=await v.from("cards").insert({owner_id:e.id,card_type:"stadium",stadium_id:y.id}).select("id,card_type,stadium_id").single();if(h){console.error("[Booster] insert stadium card:",h.message);continue}w&&f.push({...w,rarity:"normal",_stadiumDef:y})}}}return f}async function Kn(e,t,i){if(i>0){const{error:l}=await v.from("users").update({credits:e.credits-i}).eq("id",e.id);if(l)throw l}const{data:n}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(n!=null&&n.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const r=n.filter(l=>l.job==="GK"),o=n.filter(l=>l.job!=="GK"),a=!e.first_booster_opened&&r.length>0,s=[];for(let l=0;l<t;l++){const c=l===0&&a?r:l===0?o:n,f=mr(),b=gr(c,f);b&&s.push(b)}a&&await v.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:d}=await v.from("cards").insert(s.map(l=>({owner_id:e.id,player_id:l.id,card_type:"player"}))).select();return(d||[]).forEach((l,c)=>{v.rpc("record_transfer",{p_card_id:l.id,p_player_id:s[c].id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),s.map((l,c)=>({...d[c],player:l}))}async function Vn(e,t,i){const{error:n}=await v.from("users").update({credits:e.credits-i}).eq("id",e.id);if(n)throw n;const{data:r}=await v.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),o=r!=null&&r.length?r:Object.keys(ji).map(f=>({name:f,gc_type:"game_changer"})),a=Array.from({length:t},()=>o[Math.floor(Math.random()*o.length)]),s=a.map(f=>({owner_id:e.id,card_type:"game_changer",gc_type:f.name,gc_definition_id:f.id||null})),{data:d,error:l}=await v.from("cards").insert(s).select();return l&&console.error("[Booster GC] Erreur insert:",l.message,l),(d||[]).map((f,b)=>({...f,_gcDef:a[b]||null}))}async function Yn(e,t){const{error:i}=await v.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const{data:n}=await v.from("cards").select("formation").eq("owner_id",e.id).eq("card_type","formation"),r=new Set((n||[]).map(c=>c.formation)),o=Hn(),a=o[Math.floor(Math.random()*o.length)],s=r.has(a),{data:d,error:l}=await v.from("cards").insert({owner_id:e.id,card_type:"formation",formation:a}).select();return l&&console.error("[Booster Formation] Erreur insert:",l.message,l),(d||[]).map(c=>({...c,isDuplicate:s}))}function Wn(e,t,i,n=null){var R,T;if(!e||e.length===0){const I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",I.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.5)">Erreur lors du tirage (permissions DB ou colonne manquante)</div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(I),(R=I.querySelector("#anim-close-err"))==null||R.addEventListener("click",()=>I.remove());return}e=[...e].sort((I,K)=>{const W=I.player?mt(I.player):-1;return(K.player?mt(K.player):-1)-W});const r=document.createElement("div");r.id="booster-anim-overlay",r.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=I=>I.touches&&I.touches[0]?I.touches[0].clientX:I.clientX;function c(I){o||(d=!0,s.style.opacity="1",f(I))}function f(I){if(!d||o)return;const K=a.getBoundingClientRect(),W=l(I)-K.left,de=Math.max(0,Math.min(1,W/K.width));s.style.width=de*K.width+"px",de>=.82&&x()}function b(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function x(){var K;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(K=document.getElementById("cut-flash"))==null||K.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const I=document.getElementById("cut-hint");I&&(I.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",c),window.addEventListener("pointermove",f),window.addEventListener("pointerup",b),a.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",b);let g=0,p=!1;const u=new Set;function y(I){g=I,document.getElementById("reveal-phase").style.display="flex",w(),h(I,0),S()}function w(){const I=document.getElementById("card-dots");I&&(I.innerHTML=e.map((K,W)=>`<div class="card-dot" data-i="${W}" style="width:8px;height:8px;border-radius:50%;background:${W===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),I.querySelectorAll(".card-dot").forEach(K=>K.addEventListener("click",()=>m(parseInt(K.dataset.i)))))}function h(I,K){var k,M;const W=e[I],de=document.getElementById("card-counter"),me=document.getElementById("card-track");de&&(de.textContent=`Carte ${I+1} / ${e.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=I===e.length-1?"flex":"none");const V=W.card_type==="player"&&((k=W.player)==null?void 0:k.rarity)==="legende",ue=!u.has(I);u.add(I);let pe=0;if(W.card_type==="player"&&W.player){const O=W.player,F=O.job||"ATT";pe=(Number(F==="GK"?O.note_g:F==="DEF"?O.note_d:F==="MIL"?O.note_m:O.note_a)||0)+(W.evolution_bonus||0)}const ce=O=>{me.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${V?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${xr(W)}</div>
        ...
        </div>`;const F=document.getElementById("current-card-wrap");K!==0?(F.style.transition="none",F.style.transform=`translateX(${K>0?100:-100}%)`,requestAnimationFrame(()=>{F.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",F.style.transform="translateX(0)"})):F.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),O||V?Q():ie(),w()};ue&&(((M=W.player)==null?void 0:M.rarity)==="legende"||pe>=18)&&W.card_type==="player"&&W.player?E(W,()=>ce(!0)):ce(!1)}function E(I,K){var we;p=!0;const W=I.player,de=`https://flagsapi.com/${W.country_code}/flat/64.png`,me=(we=W.clubs)==null?void 0:we.logo_url,j=At(W),V=W.job||"ATT",ue=Number(V==="GK"?W.note_g:V==="DEF"?W.note_d:V==="MIL"?W.note_m:W.note_a)||0,pe=I.evolution_bonus||0,ce=ue+pe,k=ce>=18&&ce<=20,M=ce>=18,O=document.getElementById("walkout-overlay"),F=document.getElementById("walkout-stage");if(!O||!F){p=!1,K();return}let Y=null;k&&(Y=Xi("/sounds/Legendary.mp3",.8)),O.style.display="flex";const q=()=>{const he=F.firstElementChild;he&&(he.classList.remove("wo-in"),he.classList.add("wo-out"))},H=1800,le=400;F.innerHTML=`<img class="wo-in" src="${de}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(q,H),setTimeout(()=>{var he;F.innerHTML=me?`<img class="wo-in" src="${me}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((he=W.clubs)==null?void 0:he.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},H+le),setTimeout(q,H*2+le),setTimeout(()=>{F.innerHTML=j?`<img class="wo-in" src="${j}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(H+le)*2),setTimeout(q,(H+le)*2+H);const fe=M?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[V]||"#fff";setTimeout(()=>{F.innerHTML=`<div class="wo-in" style="
        ...
        ${ce}
      </div>`,M&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(H+le)*3),setTimeout(q,(H+le)*3+H),setTimeout(()=>{O.style.display="none",F.innerHTML="",p=!1,Y&&!k&&Y.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),K()},(H+le)*4)}function m(I){if(p||I<0||I>=e.length||I===g)return;const K=I>g?1:-1;g=I,h(I,K)}function C(){m(g+1)}function $(){m(g-1)}function S(){const I=document.getElementById("card-viewport");if(!I||I._swipeBound)return;I._swipeBound=!0;let K=0,W=0,de=0,me=!1;const j=k=>k.touches?k.touches[0].clientX:k.clientX,V=k=>k.touches?k.touches[0].clientY:k.clientY,ue=k=>{me=!0,K=j(k),W=V(k),de=0},pe=k=>{if(!me)return;de=j(k)-K;const M=V(k)-W;if(Math.abs(de)<Math.abs(M))return;const O=document.getElementById("current-card-wrap");O&&(O.style.transition="none",O.style.transform=`translateX(${de*.6}px) rotate(${de*.02}deg)`)},ce=()=>{if(!me)return;me=!1;const k=document.getElementById("current-card-wrap"),M=55;de<=-M&&g<e.length-1?C():de>=M&&g>0?$():k&&(k.style.transition="transform .2s ease",k.style.transform="translateX(0)")};I.addEventListener("pointerdown",ue),I.addEventListener("pointermove",pe),I.addEventListener("pointerup",ce),I.addEventListener("pointercancel",ce),I.addEventListener("touchstart",ue,{passive:!0}),I.addEventListener("touchmove",pe,{passive:!0}),I.addEventListener("touchend",ce),I.addEventListener("click",k=>{if(Math.abs(de)>8)return;const M=I.getBoundingClientRect();k.clientX-M.left>M.width/2?C():$()})}let G=null;function Q(){const I=document.getElementById("fireworks-canvas");if(!I)return;I.width=window.innerWidth,I.height=window.innerHeight;const K=I.getContext("2d"),W=[];function de(){const j=Math.random()*I.width,V=Math.random()*I.height*.6,ue=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],pe=ue[Math.floor(Math.random()*ue.length)];for(let ce=0;ce<60;ce++){const k=Math.PI*2/60*ce,M=2+Math.random()*5;W.push({x:j,y:V,vx:Math.cos(k)*M,vy:Math.sin(k)*M,alpha:1,color:pe,size:2+Math.random()*3})}}de(),G=setInterval(de,600);function me(){if(document.getElementById("fireworks-canvas")){K.clearRect(0,0,I.width,I.height);for(let j=W.length-1;j>=0;j--){const V=W[j];if(V.x+=V.vx,V.y+=V.vy+.08,V.vy*=.98,V.alpha-=.018,V.alpha<=0){W.splice(j,1);continue}K.globalAlpha=V.alpha,K.fillStyle=V.color,K.beginPath(),K.arc(V.x,V.y,V.size,0,Math.PI*2),K.fill()}K.globalAlpha=1,(G!==null||W.length>0)&&requestAnimationFrame(me)}}me()}function ie(){G!==null&&(clearInterval(G),G=null);const I=document.getElementById("fireworks-canvas");I&&I.getContext("2d").clearRect(0,0,I.width,I.height)}if(n){const I=document.getElementById("reveal-btns");I&&(I.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(T=document.getElementById("reveal-next"))==null||T.addEventListener("click",()=>{ie(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ie(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ie(),r.remove(),i("boosters")})}function xr(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return pr(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.name)||e.gc_type||"Game Changer",s=(o==null?void 0:o.effect)||((t=ji[e.gc_type])==null?void 0:t.desc)||"",d=o!=null&&o.image_url?`/icons/${o.image_url}`:null,l=((i=ji[e.gc_type])==null?void 0:i.icon)||"⚡";return tt(a,d,l,s,{width:170})}if(e.card_type==="formation")return Ai(e.formation,Mt[e.formation],{width:160});if(e.card_type==="stadium"){const o=e._stadiumDef,a=(o==null?void 0:o.name)||"Stade",s=((n=o==null?void 0:o.club)==null?void 0:n.encoded_name)||(o==null?void 0:o.country_code)||"—",d=o!=null&&o.image_url?`/icons/${o.image_url}`:((r=o==null?void 0:o.club)==null?void 0:r.logo_url)||(o!=null&&o.country_code?`https://flagsapi.com/${o.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),l=`${s}<br>+10 ⭐ joueurs alliés`;return ei(a,d,l,{width:170})}return'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function br(e){var t,i;if((t=e==null?void 0:e.rates)!=null&&t.length){const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:4000;padding:16px";const r={normal:"#ccc",pepite:"#D4A017",pépite:"#D4A017",papyte:"#909090",legende:"#7a28b8",légende:"#7a28b8"},o={player:"Joueur",formation:"Formation",game_changer:"Game Changer",game_helper:"Game Helper"};n.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const c=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",t.user.id)};async function f(){var w;if(l>=d||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",t.user.id),r&&await r(),n("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const g=a[0],{data:p}=await v.from("users").select("*").eq("id",t.user.id).single();p&&(t.profile=p);let u=[];try{if(g.type==="formation")u=await Yn(t.profile,0);else if(g.type==="game_changer")u=await Vn(t.profile,g.count||3,0);else if(s&&((w=s.rates)!=null&&w.length)){const h={...s,cost:0,cardCount:g.count||s.cardCount||5};u=await Bi(t.profile,h),g.guaranteeGK&&!t.profile.first_booster_opened&&(u.some(m=>m.player&&m.player.job==="GK")||await wr(t.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",t.profile.id))}else u=await Kn(t.profile,g.count||5,0)}catch(h){n(h.message||"Erreur ouverture booster","error");return}a.shift(),l++,await c();const y=g.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:g.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${l}/${d})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};Wn(u,y,i,()=>{f()})}(x=document.getElementById("onboard-start"))==null||x.addEventListener("click",()=>f())}async function wr(e,t){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const n=i[Math.floor(Math.random()*i.length)],r=t.findIndex(a=>a.player);if(r===-1)return;const o=t[r];await v.from("cards").update({player_id:n.id}).eq("id",o.id),t[r]={...o,player_id:n.id,player:n}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Nt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},_r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function It(e,t,i,n,r){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",r)}function qi(e,t){var o,a;const i=e.player,n=e.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?n:0)+(i.job2==="GK"&&r>0?n:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?n:0)+(i.job2==="DEF"&&r>0?n:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?n:0)+(i.job2==="MIL"&&r>0?n:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?n:0)+(i.job2==="ATT"&&r>0?n:0),evolution_bonus:n,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((o=i.clubs)==null?void 0:o.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function ri(e,t){if(!t||!e)return e;const{club_id:i,country_code:n}=t;return Object.values(e).forEach(r=>{Array.isArray(r)&&r.forEach(o=>{const a=i&&String(o.club_id)===String(i),s=n&&String(o.country_code)===String(n);(a||s)&&(o.stadiumBonus=!0)})}),e}function mi(e,t){if(!t||!(e!=null&&e.length))return e;const{club_id:i,country_code:n}=t;return e.forEach(r=>{if(!r)return;const o=i&&String(r.club_id)===String(i),a=n&&String(r.country_code)===String(n);(o||a)&&(r.stadiumBonus=!0)}),e}function xt(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Xn(){const e=Math.random()*100;return e<10?10:e<30?5:3}function gi(e,t){const i=Nt[t]||Nt["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const s=e.filter(l=>l.position&&l.position.replace(/\d+$/,"")===a).sort((l,c)=>parseInt(l.position.replace(/\D+/g,""),10)-parseInt(c.position.replace(/\D+/g,""),10)).map(l=>({...l,_line:a})),d=xt(s.length);s.forEach((l,c)=>{l._col=d[c]}),n[a]=s}return n}const o=[...e];for(const a of["GK","DEF","MIL","ATT"]){const s=[];for(let l=0;l<i[a];l++){let c=o.findIndex(f=>f.job===a);if(c===-1&&(c=o.findIndex(f=>f.job2===a)),c===-1&&(c=0),o[c]){const f={...o[c],_line:a};s.push(f),o.splice(c,1)}}const d=xt(s.length);s.forEach((l,c)=>{l._col=d[c]}),n[a]=s}return n}function st(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function it(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function vi(e,t,i){const r=new Set,o=t.filter(c=>{const f=c.gc_type||c.id;return r.has(f)?!1:(r.add(f),!0)});let a=[];function s(c,f){const b=c._gcDef,x=(b==null?void 0:b.name)||c.gc_type,g=b!=null&&b.image_url?`/icons/${b.image_url}`:null,p=tt(x,g,"⚡",(b==null?void 0:b.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${c.id}"
    ...
    </div>`}const d=c=>{e.style.overflow="",e.style.height="",e.style.display="",e.style.flexDirection="",i(c)};function l(){var f,b,x;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const c=a.length>0;e.innerHTML=`
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(g=>{g.addEventListener("click",()=>{const p=g.dataset.id,u=o.find(w=>w.id===p);if(!u)return;const y=a.findIndex(w=>w.gc_type===u.gc_type);y>-1?a.splice(y,1):a.length<3&&a.push(u),l()})}),(f=e.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{c&&d(a)}),(b=e.querySelector("#gc-no-gc"))==null||b.addEventListener("click",()=>d([])),(x=e.querySelector("#gc-reset"))==null||x.addEventListener("click",()=>{a.length&&(a=[],l())})}l()}function kr(e,t){var r;const i=((r=t==null?void 0:t.state)==null?void 0:r.params)||{},n=e||i.matchMode||"vs_ai_easy";return n==="friend"?`Match vs ${i.friendName||"Ami"}`:n==="random"?"Match vs Random":n==="ranked"?"Match Classé":n==="mini_league"||n==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${n.replace("vs_ai_","").toUpperCase()}`}async function $r(e,t,i){const{state:n,navigate:r}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",n.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){It(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=o.map(b=>b.id),{data:s}=await v.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),d=[...new Set((s||[]).filter(b=>{var x,g;return((x=b.card)==null?void 0:x.card_type)==="stadium"&&((g=b.card)==null?void 0:g.stadium_id)}).map(b=>b.card.stadium_id))],l={};if(d.length){const{data:b}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(b||[]).forEach(x=>{l[x.id]=x}),(s||[]).forEach(x=>{var g,p;((g=x.card)==null?void 0:g.card_type)==="stadium"&&((p=x.card)!=null&&p.stadium_id)&&(x.card._stadiumDef=l[x.card.stadium_id]||null)})}let c=0;function f(){var m,C,$,S,G,Q,ie;const b=o[c],x=(s||[]).filter(R=>R.deck_id===b.id),g=x.filter(R=>{var T;return R.is_starter&&((T=R.card)==null?void 0:T.player)}).map(R=>qi(R.card,R.position)),p=x.find(R=>{var T;return((T=R.card)==null?void 0:T.card_type)==="formation"}),u=b.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let y=g.length>=11?gi(g,u):null,w=((C=b.stadium_card)==null?void 0:C.stadium_def)||null;w&&y&&(y=ri(y,w));const h=g.length>=11;st(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <!-- Pagination -->
      ${o.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${o.map((R,T)=>`<div style="width:6px;height:6px;border-radius:50%;background:${T===c?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function R(){const T=e.querySelector(".deck-preview-wrap"),I=e.querySelector("#deck-swipe-zone");if(!T||!I||!y)return;const K=I.clientWidth>=900,W=Math.max(200,I.clientHeight-(K?60:40)),me=Math.max(200,I.clientWidth-16),j=K?Math.min(117,Math.max(52,Math.round(me*.22))):Math.max(44,Math.round(me*.168));if(W<220||me<220){requestAnimationFrame(R);return}const V=K?null:Math.round(j*.55);T.innerHTML=Rt(y,u,null,[],me,W,[],V),T.style.cssText=`width:${me}px;height:${W}px;overflow:hidden;margin:${K?0:60}px auto 0`;const ue=T.querySelector("svg");ue&&(ue.style.cssText="display:block;width:100%;height:100%",ue.setAttribute("preserveAspectRatio",K?"xMidYMid meet":"none"))})),(S=document.getElementById("prev-deck"))==null||S.addEventListener("click",()=>{c>0&&(c--,f())}),(G=document.getElementById("next-deck"))==null||G.addEventListener("click",()=>{c<o.length-1&&(c++,f())}),(Q=document.getElementById("validate-deck"))==null||Q.addEventListener("click",()=>{if(!h)return;const R=t.state.params||{};t.navigate("match",{...R,matchMode:R.matchMode||i,deckId:b.id})}),(ie=document.getElementById("cancel-deck-select"))==null||ie.addEventListener("click",()=>{it(e),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let R=0,T=0;E.addEventListener("touchstart",I=>{R=I.touches[0].clientX,T=I.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",I=>{const K=I.changedTouches[0].clientX-R,W=I.changedTouches[0].clientY-T;Math.abs(K)<40||Math.abs(K)<Math.abs(W)||(K<0&&c<o.length-1?(c++,f()):K>0&&c>0&&(c--,f()))},{passive:!0})}}f()}function vt(e,t=44,i=58,n=null){return ze(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Je(e,t,i,n,r){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,d)=>{const l=s._line||s.job||"MIL";let c=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(l==="ATT"||l==="MIL")||n==="defense"&&(l==="GK"||l==="DEF"||l==="MIL")?c+=10:n||(c+=10)),a+=ze(s,{width:40,role:l,extraNote:c}),d<o.length-1){const f=o[d+1],b=Gn(s,f,r)?Ht(s,f):null;a+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function wi(e,t,i,n,r=310,o=310,a=[],s=null){const d=Mt[t]||{},l=Ri(t)||Oi[t]||[],c={},f=["ATT","MIL","DEF","GK"];for(const y of f)(e[y]||[]).forEach((h,E)=>{c[`${y}${E+1}`]=h});function b(y){const w=d[y];return w?{x:w.x*r,y:w.y*o}:null}let x="";for(const[y,w]of l){const h=b(y),E=b(w);if(!h||!E)continue;const m=c[y],C=c[w],$=Ht(m,C);$==="#00ff88"||$==="#FFD700"?(x+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),p=Math.round(g*657/507);for(const[y,w]of Object.entries(c)){const h=b(y);if(!h||!w)continue;const E=y.replace(/[0-9]/g,""),m=a.includes(w.cardId),C=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,$=n.includes(w.cardId);let S=w.boost||0,G=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(S+=10,G=!0):i||(S+=10,G=!0));const Q=Math.round(h.x-g/2),ie=Math.round(h.y-p/2);if(w.used){x+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${Q}" y="${ie}" width="${g}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const R=ze({...w,_evolution_bonus:0,stadiumBonus:!1},{width:g,showStad:!1,stadDef:null,role:E,extraNote:S,_cardOffset:30,_forceStadColor:G}),T=$?`position:absolute;top:30px;left:0;width:${g}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";x+=`<foreignObject x="${Q-2}" y="${ie-30}" width="${g+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${R}
        ${$?`<div style="${T}"></div>`:""}
      </div>
    </foreignObject>`,C&&(x+=`<rect x="${Q}" y="${ie}" width="${g}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const u=s!==null?s:Math.round(Math.max(g*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${r+u*2} ${o+u*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${x}
  </svg>`}function Rt(e,t,i,n,r=300,o=300,a=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${wi(e,t,i,n,r,o,a,s)}
  </div>`}async function _i(e,t,i,n){var C;const{state:r,navigate:o,toast:a}=t;st(e);const s=r.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return $r(e,t,i);const d=s.deckId;let l,c,f,b;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",d).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]);l=$[0].data,f=$[0].error,c=$[1].data,b=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),It(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(f||b){console.error("[Match] Erreur Supabase:",f||b),It(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const x=(c||[]).filter($=>{var S;return $.is_starter&&((S=$.card)==null?void 0:S.player)}).map($=>qi($.card,$.position)),g=(c||[]).filter($=>{var S;return!$.is_starter&&((S=$.card)==null?void 0:S.player)}).map($=>qi($.card,$.position));if(x.length<11){It(e,"⚠️",`Deck incomplet (${x.length}/11).`,"Compléter",()=>o("decks"));return}const p=(c||[]).find($=>{var S;return((S=$.card)==null?void 0:S.card_type)==="formation"}),u=(l==null?void 0:l.formation)||((C=p==null?void 0:p.card)==null?void 0:C.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(S=>S.name===$.gc_type||S.id===$.gc_definition_id))||null}));let m=null;if(l!=null&&l.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",l.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:S}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=S||null}}n({deckId:d,formation:u,starters:x,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function zt(){return Math.min(window.innerWidth-40,860)}function Gt(){return Math.round(zt()*1.1)}function Jn(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:At(e)}}function Er(e,t,i,n="Adversaire"){An("/sounds/match-opening.mp3",.3);const r=zt(),o=Gt();return`
    ...
    </div>`}function Qn(e){var o,a,s;if(!e)return"";const t=d=>d?ze({...d,_evolution_bonus:0},{width:52,role:d._line||d.job,showStad:!!d.stadiumBonus,extraNote:d.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    </div>`}function Qe(e,t,i,n,r){Xi("/sounds/goal.mp3",.7);const o=document.getElementById("goal-anim-overlay");o&&o.remove();const a=document.createElement("div");a.id="goal-anim-overlay",a.style.cssText=`
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(d)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function Lr(e,t,i){const n=document.getElementById("sub-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function Zn(e,t){const i=Pe(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function bt(e,t){return e.reduce((i,n)=>i+Zn(n,t),0)}function yt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Ht(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function xi(e,t,i,n,r){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ht(o,e[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",l=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Zn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
      ...
      <div class="duel-score-line duel-score-line-${n}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${bt(e,r)} + ${yt(e)} liens = <b style="color:#fff">${bt(e,r)+yt(e)}</b>
      </div>
    </div>`}async function Tr(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await _i(e,t,r,async({deckId:s,formation:d,starters:l,subsRaw:c,gcCardsEnriched:f,gcDefs:b,stadiumDef:x})=>{try{let g=gi(l,d);x&&(g=ri(g,x),mi(c,x));const p=await Ir(d,o),u=p.lines||p,y=async w=>{try{const h=a==="vs_ai_club"?"club":a,{data:E,error:m}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:h,home_deck_id:s,status:"in_progress"}).select().single();if(m){console.error("[MatchIA] Erreur création match:",m),It(e,"⚠️","Impossible de créer le match ("+m.message+").","Retour",()=>t.navigate("home"));return}const C=p.stadiumDef||null;C&&u&&(ri(u,C),mi(p.subs||[],C));const $={gcDefs:b||[],matchId:E==null?void 0:E.id,mode:a,difficulty:o,formation:d,homeTeam:g,aiTeam:u,homeSubs:c,subsUsed:0,maxSubs:Math.min(c.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:C,homeScore:0,aiScore:0,gcCards:w,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Sr(e,$,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),It(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!f.length){y([]);return}vi(e,f,y)}catch(g){console.error("[MatchIA] Exception setup:",g),It(e,"⚠️","Erreur de préparation du match : "+g.message,"Retour",()=>t.navigate("home"))}})}async function Ir(e,t){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:zr(e),subs:[],gcCards:[],stadiumDef:null};const n=Nt[e]||Nt["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(y,w,h){var E,m;return o.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!o.has($.id)),h=i.filter($=>$.job!==y&&!o.has($.id)),E=[...w,...h],m=[];for(let $=0;$<n[y];$++){const S=E[$];S&&m.push(a(S,y,$))}const C=xt(m.length);m.forEach(($,S)=>{$._col=C[S]}),r[y]=m}const d=i.filter(y=>!o.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),f=Object.keys(je).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var h,E;return{id:"ai-gc-"+w,gc_type:y,name:((h=je[y])==null?void 0:h.name)||y,icon:((E=je[y])==null?void 0:E.icon)||"⚡"}}),b=Object.values(r).flat(),x={};b.forEach(y=>{y.club_id&&(x[y.club_id]=(x[y.club_id]||0)+1)});const g=(u=Object.entries(x).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:r,subs:d,gcCards:f,stadiumDef:p}}function zr(e){const t=Nt[e]||Nt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let d=0;d<t[o];d++){const l=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?l:2,note_d:o==="DEF"?l:2,note_m:o==="MIL"?l:2,note_a:o==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=xt(a.length);a.forEach((d,l)=>{d._col=s[l]}),i[o]=a}return i}function Sr(e,t,i){var r;An("/sounds/match-opening.mp3",.3);const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const o=e.querySelector(".opponent-preview-wrap"),a=e.querySelector("#opponent-swipe-zone");if(!o||!a)return;const s=a.clientWidth>=900,d=Math.max(200,a.clientHeight-(s?8:40)),l=Math.max(200,a.clientWidth-(s?8:16)),c=s?null:Math.round(Math.max(44,Math.round(l*.168))*.55);o.innerHTML=Rt(t.aiTeam,t.formation,null,[],l,d,[],c),o.style.cssText=`width:${l}px;height:${d}px;overflow:hidden;flex-shrink:0`;const f=o.querySelector("svg");f&&(f.style.cssText="display:block;width:100%;height:100%",f.setAttribute("preserveAspectRatio",s?"xMidYMid meet":"none"))})),setTimeout(()=>Ar(e,t,i),5e3)}const Ke=e=>Jn(e);function Ar(e,t,i){const n=t.homeTeam.MIL||[],r=t.aiTeam.MIL||[],o=t.stadiumDef||null,a=t.aiStadiumDef||null,s=bt(n,o)+yt(n),d=bt(r,a)+yt(r),l=s>=d;e.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const V=t.pendingAttack;let ue="";if(t.selected.length>0){const pe=t.selected.map(k=>({...(t.homeTeam[k._role]||[]).find(O=>O.cardId===k.cardId)||k,_line:k._role})),ce=oi(pe,t.modifiers.home,t.formation);ue=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
    ...
    ${(()=>{const j=window.innerWidth>=700,V=(q,H,le)=>{var Se,Be;const ne=(t.gcDefs||[]).find($e=>$e.name===q.gc_type),fe=(ne==null?void 0:ne.name)||q.gc_type,we=(ne==null?void 0:ne.effect)||((Se=je[q.gc_type])==null?void 0:Se.desc)||"",he=ne!=null&&ne.image_url?`/icons/${ne.image_url}`:null,Te=((Be=je[q.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${q.id}" data-gc-type="${q.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${tt(fe,he,Te,we,{width:H})}
        </div>`},ue=(q,H)=>{var le;return`<div id="boost-card"
          style="box-sizing:border-box;width:${q}px;height:${H}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(H*.04)}px;text-align:center;flex-shrink:0">
            ...
            <div style="font-size:${Math.round(H*.09)}px;color:#000;font-weight:900">+${(le=t.boostCard)==null?void 0:le.value}</div>
          </div>`},pe=(q,H)=>H?ue(95,162):V(q,95),ce=(q,H)=>H?ue(68,116):V(q,68),k=j?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",M=w?`<button id="btn-results" style="${k};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:p?`<div style="${k};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:m?`<button id="btn-pass" style="${k};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:u?`<button id="btn-action" style="${k};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:y?`<button id="btn-action" style="${k};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${k};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,O=u||y?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",F=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${j?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
        ${o.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':o.map(q=>`<div class="sub-btn-col" data-sub-id="${q.cardId}" style="cursor:pointer;flex-shrink:0">${vt(q,76,100)}</div>`).join("")}
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Rt(t.homeTeam,t.formation,t.phase,n,j?1300:zt(),j?600:Gt(),g)}
        </div>
      </div>`;return j?`
  ...
  <div id="match-history-panel">
  ...
  </div>`;function S(){const j=e.querySelector(".match-screen");if(!j)return;const V=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);j.style.bottom="auto",j.style.height=V+"px",j.style.minHeight=V+"px",j.style.maxHeight=V+"px",j.style.overflow="hidden";const ue=e.querySelector("#mobile-action-bar"),pe=e.querySelector("#mobile-play-area");ue&&pe&&(pe.style.paddingBottom=ue.offsetHeight+"px")}if(S(),setTimeout(S,120),setTimeout(S,400),setTimeout(S,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",S),window.visualViewport.addEventListener("scroll",S)),window.addEventListener("resize",S)),function(){const V=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!V)return;const ue=V.closest("#match-terrain-wrap");ue&&(ue.style.cssText="position:relative;width:100%;height:100%;padding:0"),V.removeAttribute("width"),V.removeAttribute("height"),V.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",V.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const j=e.querySelector(".terrain-wrapper svg");if(j){const V=j.closest("#match-terrain-wrap");V&&(V.style.cssText="position:relative;width:100%;height:100%;padding:0"),j.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),t.phase==="attack"||t.phase==="defense"){let j=!1,V=30;const ue=()=>document.getElementById("match-timer"),pe=()=>{const ce=ue();if(!ce)return;const k=String(Math.floor(V/60)).padStart(2,"0"),M=String(V%60).padStart(2,"0");ce.textContent=` ${k}:${M}`,ce.style.color=j?"#ff2222":"#ff9500",ce.style.fontWeight="900"};pe(),t._timerInt=setInterval(()=>{if(V--,V<0)if(!j)j=!0,V=15,pe(),Mn("/sounds/timer-urgent.mp3",.6);else{clearInterval(t._timerInt),t._timerInt=null,Ue(),t.homeScore=0,t.aiScore=3;const ce=document.createElement("div");ce.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",ce.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(ce),setTimeout(()=>{ce.remove(),ht(e,t,i)},2500)}else pe()},1e3)}(Q=document.getElementById("match-quit"))==null||Q.addEventListener("click",()=>{it(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,ht(e,t,i))}),(ie=document.getElementById("view-ai"))==null||ie.addEventListener("click",()=>Rr(t,i)),(R=document.getElementById("toggle-history"))==null||R.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.add("open")}),(T=document.getElementById("close-history"))==null||T.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.remove("open")}),(I=document.getElementById("btn-action"))==null||I.addEventListener("click",()=>{t.selected.length!==0&&(u?Cr(e,t,i):y&&jr(e,t,i))}),(K=document.getElementById("btn-results"))==null||K.addEventListener("click",()=>ht(e,t,i)),(W=document.getElementById("btn-pass"))==null||W.addEventListener("click",()=>{if(t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Di(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(e,t,i);return}t.phase="ai-attack",ke(e,t,i),setTimeout(()=>Zi(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(j=>{j.addEventListener("click",()=>Mr(j,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(j=>{j.addEventListener("click",()=>zi(e,t,i,null,j.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(j=>{u?j.addEventListener("click",()=>Fr(j.dataset.gcId,j.dataset.gcType,e,t,i)):(j.style.opacity="0.35",j.style.cursor="default",j.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(de=document.getElementById("boost-card"))==null||de.addEventListener("click",()=>Nr(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(j=>{j.addEventListener("click",()=>zi(e,t,i,j.dataset.subId))}),(me=document.getElementById("sub-btn-main"))==null||me.addEventListener("click",()=>zi(e,t,i))}function Mr(e,t,i,n){const r=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(d=>d.cardId===r);s&&t.selected.push({...s,_role:o,_line:o})}ke(i,t,n)}function Qi(e,t,i){e.matchId&&v.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function Cr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),Qi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const a=(t.homeTeam[o._role]||[]).find(d=>d.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...a,_line:o._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=ni(n,t.modifiers.home,t.formation);t.pendingAttack={...r,players:[...n],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",ke(e,t,i),setTimeout(()=>Dr(e,t,i),1200)}function jr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),Qi(t,i,i.state.profile.id);const n=t.stadiumDef||null,r=t.selected.map(d=>{const l=(t.homeTeam[d._role]||[]).find(f=>f.cardId===d.cardId)||d,c=l.stadiumBonus||n&&(n.club_id&&String(l.club_id)===String(n.club_id)||n.country_code&&l.country_code===n.country_code)||!1;return{...l,_line:d._role,stadiumBonus:c}}),o=oi(r,t.modifiers.home,t.formation);t.selected.forEach(d=>{const l=(t.homeTeam[d._role]||[]).find(c=>c.cardId===d.cardId);l&&(l.used=!0)});const a=Ji(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>Ke(d)),homePlayers:t.selected.map(d=>{const l=(t.homeTeam[d._role]||[]).find(c=>c.cardId===d.cardId)||d;return Ke(l)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,ke(e,t,i),Qe(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,St(e,t,i,"home-attack")}function Br(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(d=>d.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(d=>!e.aiUsedSubIds.includes(d.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],r=i.find(d=>d.job===n.job)||i[0],o={...r,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(d=>d.cardId===n.cardId);s!==-1&&(a[s]=o),e.aiUsedSubIds.push(r.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function qr(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(r=>!e.aiUsedGc.includes(r.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),je[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function Zi(e,t,i){Qi(t,i,null),Br(t),qr(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(c=>!c.used),r=!1;if(!n.length){const c=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(b=>!b.used),f=Ot(t.homeTeam);if(f||c.length===0){const b=(t.aiTeam.DEF||[]).filter(g=>!g.used),x=(t.aiTeam.GK||[]).filter(g=>!g.used);n=f?b.length?b:x:[...b,...x],r=!0}}const o=Rn(n,"attack",t.difficulty);if(!o.length){Fi(e,t,i);return}r&&o.forEach(c=>{c._line=c._line||c.job,c.note_a=Math.max(1,Number(c.note_a)||0)});const a=ni(o,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:o,side:"ai"},o.forEach(c=>{c.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${o.map(c=>c.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(c=>!c.used),l=(t.homeSubs||[]).filter(c=>!(t.usedSubIds||[]).includes(c.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!l){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&Ot(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,bi(e,t,i,"ai",o[0]);return}t.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(b=>Ke(b)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(f),t.pendingAttack=null,ke(e,t,i),Qe(f.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}t.phase="defense",ke(e,t,i)}function Dr(e,t,i){var l,c;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=Rn(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(t.aiTeam[f]||[]).filter(b=>!b.used)).length){const f=((l=t.pendingAttack)==null?void 0:l.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,bi(e,t,i,"home",f[0]);return}t.homeScore++;const x={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(g=>Ke(g)),homeTotal:((c=t.pendingAttack)==null?void 0:c.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(x),t.modifiers.ai={},t.pendingAttack=null,ke(e,t,i),Qe(x.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}const a=r.length>0?oi(r,t.modifiers.ai,t.formation).total:0;r.forEach(f=>{f.used=!0});const s=Ji(t.pendingAttack.total,a,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(f=>Ke(f)),aiPlayers:r.map(f=>Ke(f)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(s.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,ke(e,t,i),Qe(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,St(e,t,i,"ai-attack")}function St(e,t,i,n){if(t.round++,!eo(e,t,i)){if(en(t)){ht(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used))){Fi(e,t,i);return}t.phase="attack",ke(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used))){Fi(e,t,i);return}t.phase="ai-attack",ke(e,t,i),setTimeout(()=>Zi(e,t,i),800)}}}function Ot(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function _n(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(r=>!r.used));return t&&!i}function eo(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(_n(t.homeTeam)&&Ot(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.homeScore++,bi(e,t,i,"home",n),!0):!1}if(_n(t.aiTeam)&&Ot(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.aiScore++,bi(e,t,i,"ai",n),!0):!1}return!1}function bi(e,t,i,n,r){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ke(r)]:[],aiPlayers:n==="ai"?[Ke(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const a=(s,d)=>new Promise(l=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${d};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(l,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,ke(e,t,i),Qe([Ke(r)],t.homeScore,t.aiScore,n==="home",()=>{if(en(t)){ht(e,t,i);return}St(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function en(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used));return!t&&!i}function Di(e,t){return!(["MIL","ATT"].some(r=>(e[r]||[]).some(o=>!o.used))||Ot(t)||!["MIL","ATT"].some(r=>(t[r]||[]).some(o=>!o.used)))}function Fi(e,t,i){if(!eo(e,t,i)){if(en(t)){ht(e,t,i);return}if(Di(t.homeTeam,t.aiTeam)&&Di(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(e,t,i);return}t.phase="attack",ke(e,t,i)}}function zi(e,t,i,n=null,r=null){var x,g;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,u])=>(u||[]).filter(y=>y.used).map(y=>({...y,_line:y._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){$t("Aucun joueur utilisé à remplacer");return}if(!a.length){$t("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===r));const d=((x=o[s])==null?void 0:x._line)||((g=o[s])==null?void 0:g.job);let l=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===d)),c=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function b(){var m,C,$,S,G,Q;const p=o[s],u=a[l],y=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(y*1.35),h=ie=>`background:rgba(255,255,255,0.12);border:none;color:${ie?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ie?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(C=f.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,b())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<o.length-1&&(s++,b())}),(S=f.querySelector("#in-up"))==null||S.addEventListener("click",()=>{l>0&&(l--,b())}),(G=f.querySelector("#in-down"))==null||G.addEventListener("click",()=>{l<a.length-1&&(l++,b())});const E=(ie,R,T,I)=>{const K=f.querySelector("#"+ie);if(!K)return;let W=0;K.addEventListener("touchstart",de=>{W=de.touches[0].clientY},{passive:!0}),K.addEventListener("touchend",de=>{const me=de.changedTouches[0].clientY-W;if(Math.abs(me)<30)return;const j=R();me<0&&j<I-1?(T(j+1),b()):me>0&&j>0&&(T(j-1),b())},{passive:!0})};E("in-panel",()=>l,ie=>l=ie,a.length),E("out-panel",()=>s,ie=>s=ie,o.length),(Q=f.querySelector("#sub-confirm"))==null||Q.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),c)return;c=!0;const R=o[s],T=a[l];if(!R||!T)return;let I=null,K=-1;for(const[de,me]of Object.entries(t.homeTeam)){const j=(me||[]).findIndex(V=>V.cardId===R.cardId);if(j!==-1){I=de,K=j;break}}if(K===-1||!I){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const W={...T,_line:I,_col:R._col||0,used:!1,boost:0};t.homeTeam[I].splice(K,1,W),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(T.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:R.name,firstname:R.firstname,note:Pe(R,I),portrait:At(R),job:R.job,country_code:R.country_code,rarity:R.rarity,clubName:R.clubName,clubLogo:R.clubLogo},inPlayer:{name:T.name,firstname:T.firstname,note:Pe(T,I),portrait:At(T),job:T.job,country_code:T.country_code,rarity:T.rarity,clubName:T.clubName,clubLogo:T.clubLogo},text:`🔄 ${T.firstname} ${T.name} remplace ${R.firstname} ${R.name}`}),f.remove(),Lr(R,T,()=>ke(e,t,i))})}document.body.appendChild(f),b()}function Fr(e,t,i,n,r){var b,x;const o=(n.gcDefs||[]).find(g=>g.name===t),a=je[t]||{icon:"⚡",desc:"Carte spéciale."},s=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||a.desc,l=o!=null&&o.image_url?`/icons/${o.image_url}`:null,c=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${tt(s,l,c,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(b=f.querySelector("#gc-back"))==null||b.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),Gr(e,t,i,n,r)})}function ci(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var l,c;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(f=>{const b=f._line||f.job||"MIL",x=s.find(p=>p.cardId===f.cardId),g=ze({...f,_evolution_bonus:0},{width:90,showStad:!0,role:b,extraNote:f.boost||0});return`<div class="gc-pick-item" data-cid="${f.cardId}"
    ...
    </div>`,(l=a.querySelector("#gc-picker-close"))==null||l.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(f=>{f.addEventListener("click",()=>{const b=f.dataset.cid,x=e.find(p=>p.cardId===b);if(!x)return;const g=s.findIndex(p=>p.cardId===b);g>-1?s.splice(g,1):s.length<t&&s.push(x),d()})}),(c=a.querySelector("#gc-picker-confirm"))==null||c.addEventListener("click",()=>{a.remove(),o(s)})}d(),document.body.appendChild(a)}const Pr={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},n,r,o)=>{const a=Object.entries(n.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,d])=>d.filter(l=>!l.used).map(l=>({...l,_line:s})));return a.length?(ci(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,r,n,s=>{s.forEach(d=>{const l=(n.homeTeam[d._line]||[]).find(c=>c.cardId===d.cardId);l&&(l.boost=(l.boost||0)+e,n.log.push({text:`⚡ +${e} sur ${l.name}`,type:"info"}))}),ke(r,n,o)}),!0):(n.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),ke(r,n,o),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:n="ai"},r,o,a)=>{const s=n==="home"?r.homeTeam:r.aiTeam,d=n==="ai"?"adverse":"allié",l=Object.entries(s).filter(([c])=>!i.length||i.includes(c)).flatMap(([c,f])=>f.filter(b=>!b.used).map(b=>({...b,_line:c})));return l.length?(ci(l,t,`Choisir ${t} joueur(s) ${d}(s) à débuffer (-${e})`,o,r,c=>{c.forEach(f=>{const x=((n==="home"?r.homeTeam:r.aiTeam)[f._line]||[]).find(g=>g.cardId===f.cardId);x&&(x.boost=(x.boost||0)-e,r.log.push({text:`🎯 -${e} sur ${x.name}${n==="ai"?" (IA)":""}`,type:"info"}))}),ke(o,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${d} disponible`,type:"info"}),ke(o,r,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},n,r,o)=>{const a=i==="home"?n.homeTeam:n.aiTeam,s=i==="ai"?"adverse":"allié",d=Object.entries(a).filter(([l])=>!t.length||t.includes(l)).flatMap(([l,c])=>c.filter(f=>!f.used).map(f=>({...f,_line:l})));return d.length?(ci(d,e,`Choisir ${e} joueur(s) ${s}(s) à exclure`,r,n,l=>{l.forEach(c=>{const b=((i==="home"?n.homeTeam:n.aiTeam)[c._line]||[]).find(x=>x.cardId===c.cardId);b&&(b.used=!0,n.log.push({text:`❌ ${b.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),ke(r,n,o)}),!0):(n.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),ke(r,n,o),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,n,r)=>{const o=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,s])=>s.filter(d=>d.used).map(d=>({...d,_line:a})));return o.length?(ci(o,e,`Choisir ${e} joueur(s) à ressusciter`,n,i,a=>{a.forEach(s=>{const d=(i.homeTeam[s._line]||[]).find(l=>l.cardId===s.cardId);d&&(d.used=!1,i.log.push({text:`💫 ${d.name} ressuscité !`,type:"info"}))}),ke(n,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),ke(n,i,r),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Gr(e,t,i,n,r){n.usedGc.push(e);const o=n.gcDefs||[],a=o.find(d=>d.name===t)||o.find(d=>{var l;return((l=d.name)==null?void 0:l.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const d=Pr[a.effect_type];d?d(a.effect_params||{},n,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const d=Object.entries(n.homeTeam).flatMap(([l,c])=>(c||[]).filter(f=>f.used).map(f=>({...f,_line:l})));d.length?(d[0].used=!1,n.log.push({text:`💫 ${d[0].name} ressuscité !`,type:"info"})):n.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const d=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(l=>!l.used);if(d.length){const l=d.sort((c,f)=>Pe(f,"ATT")-Pe(c,"ATT"))[0];l.used=!0,n.log.push({text:`❄️ ${l.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",e).then(()=>{}),s&&ke(i,n,r)}function Nr(e,t,i){const n=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${_r[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Pe(r,r._line||r.job)}</div>
          <div style="flex:1"><b>${r.firstname} ${r.name}</b><div style="font-size:11px;color:#888">${r._line||r.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(d=>d.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),ke(e,t,i)})})}async function ht(e,t,i){var c,f;Tt(),Ue(),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=Vo(t.mode,a);t.matchId&&await v.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const d={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?d.wins=(n.profile.wins||0)+1:o?d.draws=(n.profile.draws||0)+1:d.losses=(n.profile.losses||0)+1,await v.from("users").update(d).eq("id",n.profile.id),await i.refreshProfile();const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",l.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(l),(c=document.getElementById("res-home"))==null||c.addEventListener("click",()=>{l.remove(),it(e),i.navigate("home")}),(f=document.getElementById("res-replay"))==null||f.addEventListener("click",()=>{l.remove(),it(e),i.navigate("match",{matchMode:t.mode})})}function Rr(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${wi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Or={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function Hr(e){const t=e.job||"ATT";return Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}async function Ur(e,t){!e||!t||await Promise.all([kn(e,"win"),kn(t,"loss")])}async function kn(e,t){const{data:i}=await v.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",e).eq("card_type","player");if(!(i!=null&&i.length))return;const n=i.filter(r=>{var o,a;return((o=r.player)==null?void 0:o.rarity)==="pepite"||((a=r.player)==null?void 0:a.rarity)==="papyte"});n.length&&await Promise.all(n.map(r=>{const o=Or[r.player.rarity],a=t==="win"?o.win:o.loss,s=r.player.note_min??1,d=r.player.note_max??10,l=Hr(r.player),c=r.current_note??l,f=Math.min(d,Math.max(s,c+a));return v.from("cards").update({current_note:f}).eq("id",r.id)}))}const Dt=e=>Jn(e);async function Ct(e,t,i,n,r={}){return to(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function Kr(e,t,i){const{data:n}=await v.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;let o=null,a=null;if(n.mode==="mini_league"){const{data:s}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(o=s.league_id,a=s.id)}return to(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,o,a)}async function to(e,t,i,n,r=[],o=[],a=!1,s=null,d=null,l=null,c=null,f=null){const{state:b,navigate:x,toast:g}=t,p=n?"p1":"p2",u=n?"p2":"p1",y=(r||[]).map(_=>_.id),w=(r||[]).map(_=>({id:_.id,gc_type:_.gc_type,_gcDef:_._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await v.from("matches").select("*").eq("id",i).single();if(!h){g("Match introuvable","error"),x("home");return}async function E(){var be,ve;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:_,error:L},{data:A,error:B},{data:z},{data:N}]=await Promise.all([v.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),v.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),v.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),v.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",B==null?void 0:B.message,"p1D:",(be=_==null?void 0:_.starters)==null?void 0:be.length,"p2D:",(ve=A==null?void 0:A.starters)==null?void 0:ve.length);const D=oe=>{const Le=Number(oe.evolution_bonus)||0;return{cardId:oe.card_id,position:oe.position,id:oe.id,firstname:oe.firstname,name:oe.surname_real,country_code:oe.country_code,club_id:oe.club_id,job:oe.job,job2:oe.job2,note_g:(Number(oe.note_g)||0)+(oe.job==="GK"||oe.job2==="GK"&&Number(oe.note_g)>0?Le:0),note_d:(Number(oe.note_d)||0)+(oe.job==="DEF"||oe.job2==="DEF"&&Number(oe.note_d)>0?Le:0),note_m:(Number(oe.note_m)||0)+(oe.job==="MIL"||oe.job2==="MIL"&&Number(oe.note_m)>0?Le:0),note_a:(Number(oe.note_a)||0)+(oe.job==="ATT"||oe.job2==="ATT"&&Number(oe.note_a)>0?Le:0),evolution_bonus:Le,rarity:oe.rarity,skin:oe.skin,hair:oe.hair,hair_length:oe.hair_length,face:oe.face||null,clubName:oe.club_encoded_name||null,clubLogo:oe.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},P=((_==null?void 0:_.starters)||[]).map(oe=>D(oe)),U=((A==null?void 0:A.starters)||[]).map(oe=>D(oe)),J=(_==null?void 0:_.formation)||"4-4-2",te=(A==null?void 0:A.formation)||"4-4-2";let ee=gi(P,J),Z=gi(U,te);const re=((_==null?void 0:_.subs)||[]).map(oe=>D(oe)),ae=((A==null?void 0:A.subs)||[]).map(oe=>D(oe)),xe=(_==null?void 0:_.stadium_def)||(n?d:null),se=(A==null?void 0:A.stadium_def)||(n?null:d);return xe&&(ee=ri(ee,xe),mi(re,xe)),se&&(Z=ri(Z,se),mi(ae,se)),{p1Team:ee,p2Team:Z,p1Subs:re,p2Subs:ae,p1Formation:J,p2Formation:te,p1Name:(z==null?void 0:z.club_name)||(z==null?void 0:z.pseudo)||"Joueur 1",p2Name:(N==null?void 0:N.club_name)||(N==null?void 0:N.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?y:[],gc_p2:n?[]:y,gcCardsFull_p1:n?w:[],gcCardsFull_p2:n?[]:w,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let m=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!m,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",b.profile.id),!m)if(n){m=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((m==null?void 0:m.p1Team)||{}));const{data:_}=await v.from("matches").select("game_state").eq("id",i).single();!(_!=null&&_.game_state)||!Object.keys(_.game_state).length?await v.from("matches").update({game_state:m,turn_user_id:h.home_id}).eq("id",i):m=_.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let _=0;_<30&&!m;_++){await new Promise(A=>setTimeout(A,400));const{data:L}=await v.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(m=L.game_state),_%5===0&&console.log("[PvP] away - poll",_,"game_state:",!!(L!=null&&L.game_state))}if(!m){g("Erreur de synchronisation","error"),x("home");return}m.gc_p2=y,m.gcCardsFull_p2=w,await v.from("matches").update({game_state:m}).eq("id",i)}let C=!1,$=null,S=!1;const G=new Set,Q=new Set;async function ie(_){var te,ee;Tt();try{v.removeChannel(R)}catch{}const L=m[p+"Score"]||0,A=m[u+"Score"]||0;let B,z;_.winner_id?(B=_.winner_id===b.profile.id,z=!1):_.forfeit?(B=L>A,z=!1):(z=L===A,B=L>A);let N="";if(a&&n)try{const{data:Z}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:re}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(Z&&re){const ae=B?1:z?.5:0,xe=1-ae,se=Z.placement_matches<10,be=re.placement_matches<10,ve=computeGlicko2(Z.mmr,Z.mmr_deviation,Z.mmr_volatility,re.mmr,re.mmr_deviation,ae===1?1:ae===0?0:.5,se),oe=computeGlicko2(re.mmr,re.mmr_deviation,re.mmr_volatility,Z.mmr,Z.mmr_deviation,xe===1?1:xe===0?0:.5,be);await v.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:z?null:B?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:ve.delta,p_away_delta:oe.delta,p_home_new_rd:ve.newRd,p_away_new_rd:oe.newRd,p_home_new_vol:ve.newSigma,p_away_new_vol:oe.newSigma});const Le=ve.delta,Ne=ve.newMmr,Ie=getTier(Ne),Ve=Le>=0?"+":"",Oe=Le>=0?"#4caf50":"#ff6b6b",nt=getTier(Z.mmr);N=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Ie.id!==nt.id?`<div style="font-size:20px;font-weight:900;color:${Ie.color}">
                    ${Ne>Z.mmr?"📈":"📉"} ${nt.emoji} ${nt.label} → ${Ie.emoji} ${Ie.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ne>Z.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Le>=0?"📈":"📉"}</div>
            ...
            </div>`}}catch(Z){console.error("[Ranked] MMR update error:",Z)}(te=document.getElementById("pvp-end-overlay"))==null||te.remove();const D=document.createElement("div");D.id="pvp-end-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const P=z?"🤝":B?"🏆":"😞",U=z?"MATCH NUL":B?"VICTOIRE !":"DÉFAITE",J=z?"#fff":B?"#FFD700":"#ff6b6b";D.innerHTML=`
      ...
      <div style="font-size:18px">${m[p+"Name"]} ${L} – ${A} ${m[u+"Name"]}</div>
      ${_.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${B?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${N}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${c?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(ee=D.querySelector("#pvp-end-home"))==null||ee.addEventListener("click",()=>{D.remove(),it(e),c?x("mini-league",{openLeagueId:c}):x(a?"ranked":"home")})}const R=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var A;const L=_.new;try{if(L.status==="finished"||L.forfeit){if(C)return;C=!0,$&&(clearInterval($),$=null),Ue(),L.game_state&&(m=L.game_state),ie(L);return}if(L.game_state){const B=m;m=L.game_state;const z=m._lastGC;if(z&&z.seq&&!Q.has(z.seq)&&(Q.add(z.seq),z.by!==p)){k(z.type,z.by,()=>V());return}const N=B[p+"Score"]||0,D=B[u+"Score"]||0,P=m[p+"Score"]||0,U=m[u+"Score"]||0,J=P>N,te=U>D;if((J||te)&&!G.has(m.round)){G.add(m.round);const ee=[...m.log||[]].reverse().find(ae=>ae.isGoal),Z=((ee==null?void 0:ee.homePlayers)||[]).map(ae=>({name:ae.name,note:ae.note,portrait:ae.portrait,job:ae.job}));!!((A=ee==null?void 0:ee.text)!=null&&A.includes("DERNIER CORNER"))?we().then(()=>{Qe(Z,P,U,J,()=>V())}):Qe(Z,P,U,J,()=>V());return}V()}}catch(B){console.error("[PvP] crash:",B)}}).subscribe();async function T(_){Object.assign(m,_),m.lastActionAt=new Date().toISOString();const{error:L}=await v.from("matches").update({game_state:m}).eq("id",i);L&&g("Erreur de synchronisation","error");try{V()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function I(){if(C)return;C=!0,Tt(),Ue(),$&&(clearInterval($),$=null);const _=n?h.away_id:h.home_id,L=n?"p2":"p1",A=n?"p1":"p2",B={...m,[L+"Score"]:3,[A+"Score"]:0,phase:"finished"},z=B.p1Score||0,N=B.p2Score||0;try{await v.from("matches").update({game_state:B}).eq("id",i);const{data:D,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:z,p_away_score:N,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await v.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{v.removeChannel(R)}catch{}setTimeout(()=>{it(e),c?x("mini-league",{openLeagueId:c}):x("home")},800)}const K={BOOST_STAT:({value:_=1,count:L=1,roles:A=[]},B,z)=>{const N=B[p+"Team"],D=Object.entries(N).filter(([P])=>!A.length||A.includes(P)).flatMap(([P,U])=>U.filter(J=>!J.used).map(J=>({...J,_line:P})));if(!D.length){B.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(B);return}W(D,L,`Choisir ${L} joueur(s) à booster (+${_})`,P=>{P.forEach(U=>{const J=(N[U._line]||[]).find(te=>te.cardId===U.cardId);J&&(J.boost=(J.boost||0)+_,B.log.push({text:`⚡ +${_} sur ${J.name}`,type:"info"}))}),B[p+"Team"]=N,z(B)})},DEBUFF_STAT:({value:_=1,count:L=1,roles:A=[],target:B="ai"},z,N)=>{const D=B==="home"?p:u,P=z[D+"Team"],U=B==="home"?"allié":"adverse",J=Object.entries(P).filter(([te])=>!A.length||A.includes(te)).flatMap(([te,ee])=>ee.map(Z=>({...Z,_line:te})));if(!J.length){z.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),N(z);return}W(J,L,`Choisir ${L} joueur(s) ${U}(s) (-${_})`,te=>{te.forEach(ee=>{const Z=(P[ee._line]||[]).find(re=>re.cardId===ee.cardId);Z&&(Z.boost=(Z.boost||0)-_,z.log.push({text:`🎯 -${_} sur ${Z.name}`,type:"info"}))}),z[D+"Team"]=P,N(z)})},GRAY_PLAYER:({count:_=1,roles:L=[],target:A="ai"},B,z)=>{const N=A==="home"?p:u,D=B[N+"Team"],P=A==="home"?"allié":"adverse",U=Object.entries(D).filter(([J])=>!L.length||L.includes(J)).flatMap(([J,te])=>te.filter(ee=>!ee.used).map(ee=>({...ee,_line:J})));if(!U.length){B.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),z(B);return}W(U,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,J=>{const te="usedCardIds_"+N,ee=new Set(B[te]||[]);J.forEach(Z=>{const re=(D[Z._line]||[]).find(ae=>ae.cardId===Z.cardId);re&&(re.used=!0,ee.add(Z.cardId),B.log.push({text:`❌ ${re.name} exclu !`,type:"info"}))}),B[te]=[...ee],B[N+"Team"]=D,z(B)})},REVIVE_PLAYER:({count:_=1,roles:L=[]},A,B)=>{const z=A[p+"Team"],N=Object.entries(z).filter(([D])=>!L.length||L.includes(D)).flatMap(([D,P])=>P.filter(U=>U.used).map(U=>({...U,_line:D})));if(!N.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),B(A);return}W(N,_,`Choisir ${_} joueur(s) à ressusciter`,D=>{D.forEach(P=>{const U=(z[P._line]||[]).find(J=>J.cardId===P.cardId);U&&(U.used=!1,A.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),A[p+"Team"]=z,B(A)})},REMOVE_GOAL:({},_,L)=>{const A=u+"Score";_[A]>0?(_[A]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(_)},ADD_GOAL_DRAW:({},_,L)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(_)},ADD_SUB:({value:_=1},L,A)=>{L.maxSubs=(L.maxSubs||3)+_,L.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),A(L)},CUSTOM:({},_,L)=>L(_)};function W(_,L,A,B){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let N=[];function D(){var U,J;const P=_.map(te=>{const ee=te._line||te.job||"MIL",Z=N.find(ae=>ae.cardId===te.cardId),re=ze({...te,_evolution_bonus:0},{width:90,showStad:!0,role:ee,extraNote:te.boost||0});return`<div class="pp-item" data-cid="${te.cardId}"
        ...
        </div>`,(U=z.querySelector("#pp-close"))==null||U.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(te=>{te.addEventListener("click",()=>{const ee=te.dataset.cid,Z=_.find(ae=>ae.cardId===ee),re=N.findIndex(ae=>ae.cardId===ee);Z&&(re>-1?N.splice(re,1):N.length<L&&N.push(Z),D())})}),(J=z.querySelector("#pp-confirm"))==null||J.addEventListener("click",()=>{z.remove(),B(N)})}D(),document.body.appendChild(z)}async function de(_,L){const B=(m["gcCardsFull_"+p]||[]).find(P=>P.id===_),z=(B==null?void 0:B._gcDef)||(m.gcDefs||[]).find(P=>{var U;return P.name===L||((U=P.name)==null?void 0:U.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),N=[...m["usedGc_"+p]||[],_],D={type:L,by:p,seq:(m._gcAnimSeq||0)+1};Q.add(D.seq),k(L,p,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const U=K[z.effect_type];if(U){const J={...m};U(z.effect_params||{},J,async te=>{te["usedGc_"+p]=N,te._lastGC=D,te._gcAnimSeq=D.seq,await T(te)});return}}const P={...m};switch(L){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=u+"Score";P[U]>0&&(P[U]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=N,P._lastGC=D,P._gcAnimSeq=D.seq,await T(P)})}function me(_,L){const A="usedCardIds_"+_,B=new Set(m[A]||[]);L.forEach(z=>B.add(z)),m[A]=[...B]}function j(){for(const _ of["p1","p2"]){const L=new Set(m["usedCardIds_"+_]||[]),A=m[_+"Team"];if(A)for(const B of["GK","DEF","MIL","ATT"])(A[B]||[]).forEach(z=>{z.used=L.has(z.cardId)})}}function V(){var on,rn,an,sn,dn,ln;if(m.phase==="reveal")return ue();if(m.phase==="midfield")return ce();if(m.phase==="finished")return Ge();const _=m[p+"Team"],L=m[u+"Team"];j();const A=m[p+"Score"],B=m[u+"Score"],z=m[p+"Name"],N=m[u+"Name"],D=m.phase===p+"-attack",P=m.phase===p+"-defense",U=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],J=U.map(X=>X.cardId),te=window.innerWidth>=700,ee=m[p+"Subs"]||[],Z=m["usedSubIds_"+p]||[],re=ee.filter(X=>!Z.includes(X.cardId)),ae=m["gcCardsFull_"+p]||[],xe=m["usedGc_"+p]||[],se=ae.filter(X=>!xe.includes(X.id)),be=m.boostOwner===p&&!m.boostUsed,ve=[..._.MIL||[],..._.ATT||[]].filter(X=>!X.used),oe=[...L.MIL||[],...L.ATT||[]].filter(X=>!X.used),Le=!$e(L),Ne=ve.length===0&&oe.length===0&&!Le,Ie=(_.DEF||[]).filter(X=>!X.used),Ve=(_.GK||[]).filter(X=>!X.used);let Oe=[];D&&ve.length===0&&(Le?(Oe=Ie.map(X=>X.cardId),Ie.length===0&&(Oe=Oe.concat(Ve.map(X=>X.cardId)))):Ne&&(Oe=[...Ie,...Ve].map(X=>X.cardId)));function nt(X,ge,Ae){var Me,ft;const _e=X._gcDef,qt=(_e==null?void 0:_e.name)||X.gc_type,at=(_e==null?void 0:_e.effect)||((Me=je[X.gc_type])==null?void 0:Me.desc)||"",Fe=_e!=null&&_e.image_url?`/icons/${_e.image_url}`:null,Re=((ft=je[X.gc_type])==null?void 0:ft.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      </div>`}const De=(X,ge)=>ge?Ut(95,162):nt(X,95),Ye=(X,ge)=>ge?Ut(68,116):nt(X,68),He=te?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",pt=D?ct(p)?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${U.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${He};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:P?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${U.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${N}</div>`,ot=D&&!ct(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':D||P?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${U.length}/3 sélectionné(s)</div>`:"",jt=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${te?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${re.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':re.map(X=>`<div class="pvp-sub-btn" data-sub-id="${X.cardId}" style="cursor:pointer;flex-shrink:0">${vt(X,te?76:44,te?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Rt(_,m[p+"Formation"],ut,J,te?1300:zt(),te?600:Gt(),Oe)}
      </div>
    </div>`,rt=m[p+"Team"],po=(()=>{var ge,Ae,_e,qt,at;if(P&&((ge=m.pendingAttack)!=null&&ge.players)){const Fe=m.pendingAttack;let Re="";if(U.length>0){const Me=U.map(We=>{const Kt=(rt[We._role]||[]).find(Ei=>Ei.cardId===We.cardId)||We,Vt=rt[We._role]||[],ai=Vt.findIndex(Ei=>Ei.cardId===We.cardId),$i=xt(Vt.length),Yt=ai>=0?$i[ai]:Kt._col??1;return{...Kt,_line:We._role,_col:Yt}}),ft=oi(Me,((Ae=m.modifiers)==null?void 0:Ae[p])||{},m[p+"Formation"]);Re=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
        ...
        </div>`}const X=(m.log||[]).slice(-1)[0];return X?'<div style="padding:2px 4px">'+Qn(X)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),nn=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Rt(_,m[p+"Formation"],ut,J,zt(),Gt(),Oe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
          <div style="display:flex;gap:6px;overflow-x:auto;align-items:flex-end;min-height:96px;padding-bottom:2px">
            ${se.map(X=>Ye(X,!1)).join("")}
            ${be?Ye(null,!0):""}
      ...
      </div>`;function Bt(){const X=e.querySelector(".match-screen");if(!X)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=ge+"px",X.style.minHeight=ge+"px",X.style.maxHeight=ge+"px",X.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),_e=e.querySelector("#mobile-play-area");Ae&&_e&&(_e.style.paddingBottom=Ae.offsetHeight+"px")}if(Bt(),setTimeout(Bt,120),setTimeout(Bt,400),S||(S=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Bt),window.visualViewport.addEventListener("scroll",Bt)),window.addEventListener("resize",Bt)),function(){const ge=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ge)return;const Ae=ge.closest("#match-terrain-wrap");Ae&&(Ae.style.cssText="position:relative;width:100%;height:100%;padding:0"),ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const ge=X.closest("#match-terrain-wrap");ge&&(ge.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!D&&!P)return;const ge=X.dataset.cardId,Ae=X.dataset.role,_e=(_[Ae]||[]).find(Re=>Re.cardId===ge);if(!_e||_e.used)return;const qt=Oe.includes(ge);if(D&&!["MIL","ATT"].includes(Ae)&&!qt)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const at=m["selected_"+p],Fe=at.findIndex(Re=>Re.cardId===ge);Fe>-1?at.splice(Fe,1):at.length<3&&at.push({..._e,_role:Ae}),V()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>F(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>F())}),(on=e.querySelector("#pvp-sub-open"))==null||on.addEventListener("click",()=>F()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{D?X.addEventListener("click",()=>M(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(rn=e.querySelector("#pvp-boost-card"))==null||rn.addEventListener("click",()=>O()),(an=e.querySelector("#pvp-action"))==null||an.addEventListener("click",X=>{D?X.currentTarget.dataset.pass==="1"||!ct(p)?le():Te():P&&Se()}),(sn=e.querySelector("#pvp-quit"))==null||sn.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&I()}),(dn=e.querySelector("#pvp-view-opp"))==null||dn.addEventListener("click",()=>q()),(ln=e.querySelector("#pvp-toggle-history"))==null||ln.addEventListener("click",()=>H()),$&&(clearInterval($),$=null),Ue(),(D||P)&&!C){let X=30,ge=!1;const Ae=()=>document.getElementById("pvp-timer"),_e=()=>{Ae()&&(Ae().textContent=X+"s",Ae().style.color=ge?"#ff4444":"#fff")};_e(),$=setInterval(()=>{X--,X<0?ge?(clearInterval($),$=null,Ue(),D&&!ct(p)?le():I()):(ge=!0,X=15,_e(),Mn("/sounds/timer-urgent.mp3",.6)):_e()},1e3)}}function ue(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    </div>`;const N=(re,ae)=>e.querySelectorAll(re).forEach((xe,se)=>{setTimeout(()=>{xe.style.opacity="1",xe.style.transform="translateY(0) scale(1)"},ae+se*90)});N(".duel-card-me",150),N(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((re,ae)=>setTimeout(()=>{re.style.opacity="1"},ae*70)),900),setTimeout(()=>{const re=e.querySelector("#pvp-vs");re&&(re.style.opacity="1",re.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(ae=>ae.style.opacity="1")},1250);function D(re,ae,xe){const se=document.getElementById(re);if(!se)return;const be=performance.now(),ve=oe=>{const Le=Math.min(1,(oe-be)/xe);se.textContent=Math.round(ae*(1-Math.pow(1-Le,3))),Le<1?requestAnimationFrame(ve):se.textContent=ae};requestAnimationFrame(ve)}setTimeout(()=>{D("pvp-score-me",A,800),D("pvp-score-opp",B,800)},1500);const P=m.p1Team.MIL||[],U=m.p2Team.MIL||[],J=bt(P)+yt(P),te=bt(U)+yt(U),ee=J>=te?"p1":"p2";let Z=m.boostValue;Z==null&&(Z=Xn(),m.boostValue=Z,m.boostOwner=ee,m.boostUsed=!1),pe=!0,setTimeout(()=>{const re=e.querySelector("#duel-row-"+(z?"me":"opp")),ae=e.querySelector("#duel-row-"+(z?"opp":"me")),xe=document.getElementById("pvp-score-me"),se=document.getElementById("pvp-score-opp"),be=z?xe:se,ve=z?se:xe;be&&(be.style.fontSize="80px",be.style.color=z?"#FFD700":"#ff6b6b",be.style.animation="duelPulse .5s ease"+(z?",duelGlow 1.5s ease infinite .5s":"")),ve&&(ve.style.opacity="0.25"),setTimeout(()=>{re&&(re.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",re.style.zIndex="5"),setTimeout(()=>{const oe=document.getElementById("duel-shock");oe&&(oe.style.animation="shockwave .5s ease-out forwards"),ae&&(ae.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Ie;const oe=document.getElementById("pvp-duel-finale");if(!oe)return;const Le=m.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+Z+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ne=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;oe.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(z?"⚽ "+m[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+m[u+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Le+Ne,oe.style.transition="opacity .45s ease",oe.style.opacity="1",oe.style.pointerEvents="auto",(Ie=document.getElementById("pvp-start-match"))==null||Ie.addEventListener("click",async()=>{const Ve=ee;await T({phase:Ve+"-attack",attacker:Ve,round:1,boostValue:Z,boostUsed:!1,boostOwner:Ve})})},600)},700)},2800)}function k(_,L,A){var ae,xe;const B=(m.gcDefs||[]).find(se=>{var be;return se.name===_||((be=se.name)==null?void 0:be.toLowerCase().trim())===(_==null?void 0:_.toLowerCase().trim())}),z={purple:"#b06ce0",light_blue:"#00d4ef"}[B==null?void 0:B.color]||"#b06ce0",N=(B==null?void 0:B.name)||_,D=(B==null?void 0:B.effect)||((ae=je[_])==null?void 0:ae.desc)||"",P=B!=null&&B.image_url?`/icons/${B.image_url}`:null,U=((xe=je[_])==null?void 0:xe.icon)||"⚡",te=L===p?"Vous":m[L+"Name"]||"Adversaire",ee=document.createElement("div");ee.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",ee.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:${z};letter-spacing:3px;text-transform:uppercase;font-weight:700;animation:gcLabel .4s ease both">${te} joue une carte</div>
      <div style="animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        ${tt(N,P,U,D,{width:200})}
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(ee);let Z=!1;const re=()=>{Z||(Z=!0,ee.remove(),setTimeout(()=>A&&A(),50))};ee.addEventListener("click",re),setTimeout(re,3e3)}function M(_,L){var te,ee,Z,re;const B=(m["gcCardsFull_"+p]||[]).find(ae=>ae.id===_),z=B==null?void 0:B._gcDef,N=(z==null?void 0:z.name)||L,D=(z==null?void 0:z.effect)||((te=je[L])==null?void 0:te.desc)||"Carte spéciale.",P=z!=null&&z.image_url?`/icons/${z.image_url}`:null,U=((ee=je[L])==null?void 0:ee.icon)||"⚡",J=document.createElement("div");J.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",J.innerHTML=`
      ${tt(N,P,U,D,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(J),(Z=J.querySelector("#pvp-gc-back"))==null||Z.addEventListener("click",()=>J.remove()),(re=J.querySelector("#pvp-gc-use"))==null||re.addEventListener("click",()=>{J.remove(),de(_,L)})}function O(){var B;const _=m[p+"Team"],L=Object.entries(_).flatMap(([z,N])=>(N||[]).filter(D=>!D.used).map(D=>({...D,_line:z})));if(!L.length)return;const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",A.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(z=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",D=Pe(z,z._line)+(z.boost||0);return`<div class="bp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${N};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(A),(B=A.querySelector("#bp-close"))==null||B.addEventListener("click",()=>A.remove()),A.querySelectorAll(".bp-item").forEach(z=>{z.addEventListener("click",async()=>{const N=z.dataset.cid,D=L.find(U=>U.cardId===N);if(!D)return;const P=(_[D._line]||[]).find(U=>U.cardId===N);P&&(P.boost=(P.boost||0)+m.boostValue),A.remove(),await T({[p+"Team"]:_,boostUsed:!0})})})}function F(_=null){var re,ae;if(!(m.phase===p+"-attack")){g("Remplacement uniquement avant votre attaque","warning");return}const A=m[p+"Team"],B=m["usedSubIds_"+p]||[],z=m.maxSubs||3;if(B.length>=z){g(`Maximum ${z} remplacements atteint`,"warning");return}const N=Object.entries(A).flatMap(([xe,se])=>(se||[]).filter(be=>be.used).map(be=>({...be,_line:xe}))),D=(m[p+"Subs"]||[]).filter(xe=>!B.includes(xe.cardId));if(!N.length){g("Aucun joueur utilisé à remplacer","warning");return}if(!D.length){g("Aucun remplaçant disponible","warning");return}let P=Math.max(0,N.findIndex(xe=>xe.cardId===_));const U=((re=N[P])==null?void 0:re._line)||((ae=N[P])==null?void 0:ae.job);let J=Math.max(0,D.findIndex(xe=>xe.job===U)),te=!1;const ee=document.createElement("div");ee.id="pvp-sub-overlay",ee.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function Z(){var Ne,Ie,Ve,Oe,nt,Ut;const xe=N[P],se=D[J],be=Math.min(130,Math.round((window.innerWidth-90)/2)),ve=Math.round(be*1.35),oe=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;ee.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(Ne=ee.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>ee.remove()),(Ie=ee.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{P>0&&(P--,Z())}),(Ve=ee.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{P<N.length-1&&(P++,Z())}),(Oe=ee.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{J>0&&(J--,Z())}),(nt=ee.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{J<D.length-1&&(J++,Z())});const Le=(De,Ye,He,pt)=>{const ot=ee.querySelector("#"+De);if(!ot)return;let jt=0;ot.addEventListener("touchstart",ut=>{jt=ut.touches[0].clientY},{passive:!0}),ot.addEventListener("touchend",ut=>{const kt=ut.changedTouches[0].clientY-jt;if(Math.abs(kt)<30)return;const rt=Ye();kt<0&&rt<pt-1?(He(rt+1),Z()):kt>0&&rt>0&&(He(rt-1),Z())},{passive:!0})};Le("pin-panel",()=>J,De=>J=De,D.length),Le("pout-panel",()=>P,De=>P=De,N.length),(Ut=ee.querySelector("#psub-confirm"))==null||Ut.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),te)return;te=!0;const Ye=N[P],He=D[J];if(!Ye||!He)return;const pt=Ye._line,ot=(A[pt]||[]).findIndex(kt=>kt.cardId===Ye.cardId);if(ot===-1){g("Erreur : joueur introuvable","error"),ee.remove();return}const jt={...He,_line:pt,position:Ye.position,used:!1,boost:0};A[pt].splice(ot,1,jt);const ut=[...B,He.cardId];ee.remove(),Y(Ye,He,async()=>{await T({[p+"Team"]:A,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(ee),Z()}function Y(_,L,A){const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(U,J,te)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(L),(A=L.querySelector("#pvp-hist-close"))==null||A.addEventListener("click",()=>L.remove())}async function le(){if(m.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",L=(m.round||0)+1,A=[...m.log||[]];A.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const B=Ee(m),z=ct(_),N=B||!z?"finished":_+"-attack";await T({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:N,attacker:_,round:L,log:A}),N==="finished"&&await qe(m)}function ne(_){const L=(_.GK||[]).some(B=>!B.used),A=["DEF","MIL","ATT"].some(B=>(_[B]||[]).some(z=>!z.used));return L&&!A}function fe(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ne(_.p1Team)&&!$e(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(L=>!L.used)}:ne(_.p2Team)&&!$e(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(L=>!L.used)}:null}async function we(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const L=(A,B)=>new Promise(z=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${B};letter-spacing:2px;animation:lcFade 1.4s ease both">${A}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(z,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function he(_,L){const{side:A,gk:B}=_;if(!B)return;const z=A+"Score",N=(L[z]||0)+1;B.used=!0;const D=[...L.log||[]];D.push({type:"duel",isGoal:!0,homeScored:A===p,homePlayers:A==="p1"?[Dt(B)]:[],aiPlayers:A==="p2"?[Dt(B)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[A+"Name"]} marque !`});const P=(L.round||0)+1,U=A==="p1"?"p2":"p1",J={...L,[z]:N},te=Ee(J);G.add(P),await we();const ee=A===p?N:L[p+"Score"]||0,Z=A===p?L[u+"Score"]||0:N;Qe([Dt(B)],ee,Z,A===p,async()=>{await T({[z]:N,log:D,round:P,pendingAttack:null,phase:te?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),te&&await qe({...m,[z]:N})})}async function Te(){const _=m[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(N=>(m[u+"Team"][N]||[]).some(D=>!D.used)),A=(m["selected_"+p]||[]).map(N=>{const D=(_[N._role]||[]).find(ae=>ae.cardId===N.cardId)||N,P=["GK","DEF"].includes(N._role),U=_[N._role]||[],J=U.findIndex(ae=>ae.cardId===N.cardId),te=xt(U.length),ee=J>=0?te[J]:D._col??1,Z=m.stadiumDef||m.homeStadiumDef||null,re=D.stadiumBonus||Z&&(Z.club_id&&String(D.club_id)===String(Z.club_id)||Z.country_code&&D.country_code===Z.country_code)||!1;return{...D,_line:N._role,_col:ee,stadiumBonus:re,...P?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!A.length)return;const B=ni(A,m.modifiers[p]||{},m[p+"Formation"]);me(p,A.map(N=>N.cardId)),A.forEach(N=>{const D=(_[N._role]||[]).find(P=>P.cardId===N.cardId);D&&(D.used=!0)}),m["selected_"+p]=[],V();const z=[...m.log||[]];if(L){if(A.length===1&&(A[0]._line==="GK"||A[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await he({side:p,gk:A[0]},{...m,[p+"Team"]:_,log:z});return}const D=(m[p+"Score"]||0)+1,P=A.map(Z=>Dt(Z));z.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:B.total,aiTotal:0});const U=(m.round||0)+1,J=p==="p1"?"p2":"p1",te={...m,[p+"Team"]:_,[p+"Score"]:D},ee=Ee(te);G.add(U),Qe(P,D,m[u+"Score"]||0,!0,async()=>{await T({[p+"Team"]:_,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ee?"finished":J+"-attack",attacker:J,round:U,log:z}),ee&&await qe({...m,[p+"Score"]:D})});return}z.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${B.total})`}),await T({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],pendingAttack:{...B,players:A,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:z})}async function Se(){const _=m[p+"Team"],L=(m["selected_"+p]||[]).map(se=>{const be=(_[se._role]||[]).find(Ie=>Ie.cardId===se.cardId)||se,ve=_[se._role]||[],oe=ve.findIndex(Ie=>Ie.cardId===se.cardId),Le=xt(ve.length),Ne=oe>=0?Le[oe]:be._col??1;return{...be,_line:se._role,_col:Ne}}),A=oi(L,m.modifiers[p]||{},m[p+"Formation"]);me(p,L.map(se=>se.cardId)),L.forEach(se=>{const be=(_[se._role]||[]).find(ve=>ve.cardId===se.cardId);be&&(be.used=!0)}),m["selected_"+p]=[],V();const B=Ji(m.pendingAttack.total,A.total,m.modifiers[p]||{}),z=m.pendingAttack.side,N=B==="attack"||(B==null?void 0:B.goal),D=z==="p1"?"p2":"p1",P=(m.round||0)+1,U=(m.pendingAttack.players||[]).map(se=>Dt(se)),J=[...m.log||[]];J.push({type:"duel",isGoal:N,homeScored:N&&z===p,text:N?`⚽ BUT de ${m[z+"Name"]} ! (${m.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${A.total})`,homePlayers:U,aiPlayers:L.map(se=>Dt(se)),homeTotal:m.pendingAttack.total,aiTotal:A.total});const te=N?(m[z+"Score"]||0)+1:m[z+"Score"]||0,ee={...m,[p+"Team"]:_,[z+"Score"]:te},Z=Ee(ee),re=Z?"finished":D+"-attack",ae=!Z&&!N?fe(ee):null,xe=async()=>{if(ae){await he(ae,ee);return}await T({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],[z+"Score"]:te,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:re,attacker:D,round:P,log:J}),(re==="finished"||Z)&&await qe({...m,[z+"Score"]:te})};if(N){const se=z===p,be=se?te:m[p+"Score"]||0,ve=se?m[u+"Score"]||0:te;G.add(P),Qe(U,be,ve,se,xe)}else await xe()}function Be(_){return["MIL","ATT"].some(L=>(_[L]||[]).some(A=>!A.used))}function $e(_){return["GK","DEF","MIL","ATT"].some(L=>(_[L]||[]).some(A=>!A.used))}function _t(_){return $e(_)&&!Be(_)}function ct(_){const L=m[_+"Team"],A=m[(_==="p1"?"p2":"p1")+"Team"];return!!(Be(L)||_t(L)&&!$e(A)||_t(L)&&!Be(A)&&$e(A))}function Ee(_){return!$e(_.p1Team)&&!$e(_.p2Team)}function Ce(_){const L=_.p1Score||0,A=_.p2Score||0;return L===A?null:L>A?h.home_id:h.away_id}async function qe(_){Tt(),Ue();try{const L=Ce(_),A=L?h.home_id===L?h.away_id:h.home_id:null,B=_.p1Score||0,z=_.p2Score||0,{data:N,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:B,p_away_score:z,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}L&&A&&Ur(L,A).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof l=="function")try{await l({homeScore:B,awayScore:z,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Ge(){var z;const _=m[p+"Score"],L=m[u+"Score"],A=_>L,B=_===L;st(e),e.innerHTML=`
    ...
    </div>`,(z=document.getElementById("pvp-home"))==null||z.addEventListener("click",()=>{try{v.removeChannel(R)}catch{}it(e),c?x("mini-league",{openLeagueId:c}):x("home")})}V()}async function Pi(e,t,i=!1){var s,d;const{state:n,navigate:r,toast:o}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await _i(e,t,i?"ranked":"random",async({deckId:l,formation:c,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{st(e);const u=async y=>{await Yr(e,t,l,c,f,b,y||[],g,p,i,a)};if(!(x!=null&&x.length)){await u([]);return}vi(e,x,u)})}async function Vr(e,t,i){return Kr(e,t,i)}async function Yr(e,t,i,n,r,o,a=[],s=[],d=null,l=!1,c=null){var ie,R;const{state:f,navigate:b,toast:x}=t,g=(c==null?void 0:c.mmr)??((ie=f.profile)==null?void 0:ie.mmr)??1e3,p=l?hi(g):null,u=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;e.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(T){console.error("[Matchmaking] cancel error:",T)}};(R=document.getElementById("cancel-mm"))==null||R.addEventListener("click",async()=>{await m(),it(e),b("home")});const C=async(T,I)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Ct(e,t,T,I,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:l,rankedData:c,onMatchEnd:l?Wr:null}))},$=f.user.id,{data:S,error:G}=l?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(G||!(S!=null&&S.success)){console.error("[Matchmaking] try_matchmake error:",G||S),x("Erreur de matchmaking","error"),it(e),b("home");return}if(S.matched){await C(S.match_id,!1);return}const Q=async()=>{if(w)return;const{data:T}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(T==null?void 0:T.status)==="matched"&&T.match_id&&await C(T.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},T=>{const I=T.new;I.status==="matched"&&I.match_id&&C(I.match_id,!0)}).subscribe(),E=setInterval(Q,3e3),setTimeout(()=>{w||m()},12e4)}async function Wr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:d,matchId:l}=e,c=i.user.id,f=o===c,b=r===c,{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",c).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:o).single();if(x&&g){const p=uo(x.mmr,x.mmr_rd,x.mmr_v,g.mmr,g.mmr_rd,b?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:b?v.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:v.sql`mmr_losses + 1`}).eq("id",c),n(b?`+MMR ↑ ${Math.round(p.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-p.mmr)}`,b?"success":"error",4e3)}}const io=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Pi,resumePvpMatch:Vr},Symbol.toStringTag,{value:"Module"}));async function Xr(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",d=!!o.isAccepting;await _i(e,t,"friend",async({deckId:l,formation:c,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{st(e);const u=async y=>{const w=y||[];d?await Qr(e,t,l,w,g,p):await Jr(e,t,l,w,g,p,a,s)};if(!(x!=null&&x.length)){await u([]);return}vi(e,x,u)})}async function Jr(e,t,i,n,r,o,a,s){var w;const{state:d,navigate:l,toast:c}=t,f=d.user.id,{data:b,error:x}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!b){console.error("[Friend] Erreur création invitation:",x),c("Impossible de créer l'invitation","error"),l("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function ro(e,t,i,n){var f;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await ra(),s===null))return;const{data:d,error:l}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(l||!(d!=null&&d.success)){console.error("[MiniLeague] join_mini_league:",l||d),r((d==null?void 0:d.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:b}=await v.from("users").select("credits").eq("id",a).single();o.profile&&b&&(o.profile.credits=b.credits)}const c=document.getElementById("nav-credits");c&&(c.textContent=`💰 ${(((f=o.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),lt(e,t,i)}async function aa(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(b=>{const x=document.createElement("div");x.className="modal-overlay",x.style.zIndex="2100",x.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(x),x.querySelector("#lv-ok").onclick=()=>{x.remove(),b(!0)},x.querySelector("#lv-cancel").onclick=()=>{x.remove(),b(!1)}}))return;const{data:d,error:l}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(l||!(d!=null&&d.success)){r((d==null?void 0:d.error)||"Erreur lors de la désinscription","error");return}const c=d.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+c);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${c.toLocaleString("fr")} cr. remboursés`,"success"),et(e,t,"waiting")}async function Gi(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),et(e,t,r)}async function sa(e,t,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),et(e,t,"archived")}async function lt(e,t,i){var E,m,C,$,S,G,Q,ie,R;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:d}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await et(e,t);return}const l=(s||[]).some(T=>T.user_id===o),c=a.creator_id===o,f=(s||[]).map(T=>T.user).filter(Boolean),b=ua(f,d||[]),x=(d||[]).filter(T=>T.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,u=x.length>0&&x.every(T=>T.status==="finished"||T.status==="bye"),y=a.current_day>=a.total_days,w=(s||[]).find(T=>T.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Xt};border:1px solid ${Jt};border-radius:12px;padding:16px">
        ...
        ${f.map(T=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${Lt}">
            <div style="width:36px;height:36px;border-radius:50%;background:${T.club_color2||no};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${T.club_color1||"#fff"}">${(T.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:${Xt};border:1px solid ${Jt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((T,I)=>{const K=g>0&&a.status==="finished"?I===0?Math.floor(g*.7):I===1?Math.floor(g*.2):I===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${T.userId===o?"background:rgba(74,222,128,0.08);":""}">
              ...
              <td style="text-align:center;color:${Et}">${T.played}</td><td style="text-align:center;color:${Et}">${T.won}-${T.drawn}-${T.lost}</td>
      ...
      <div style="background:${Xt};border:1px solid ${Jt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(T,I)=>I+1).reverse().map(T=>{const I=(d||[]).filter(K=>K.matchday===T);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ze};margin-bottom:6px">Journée ${T}</div>${I.map(K=>$n(K,f,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>et(e,t,h)),(m=document.getElementById("ml-refresh"))==null||m.addEventListener("click",async T=>{const I=T.currentTarget;I.style.opacity="0.5",await lt(e,t,i)}),(C=document.getElementById("ml-start-btn"))==null||C.addEventListener("click",()=>da(e,t,a,f)),($=document.getElementById("ml-next-day"))==null||$.addEventListener("click",()=>la(e,t,i)),(S=document.getElementById("ml-join-now"))==null||S.addEventListener("click",()=>ro(e,t,i,a.type)),(G=document.getElementById("ml-leave-btn"))==null||G.addEventListener("click",()=>aa(e,t,i,p)),(Q=document.getElementById("ml-delete-btn"))==null||Q.addEventListener("click",()=>Gi(e,t,i,a.name,"waiting")),(ie=document.getElementById("ml-delete-now"))==null||ie.addEventListener("click",()=>Gi(e,t,i,a.name,h)),(R=document.getElementById("ml-archive-btn"))==null||R.addEventListener("click",()=>sa(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(T=>{T.addEventListener("click",()=>{const I=x.find(K=>K.id===T.dataset.playMatch);I&&t.navigate("match-mini-league",{mlMatchId:I.id,leagueId:i})})}),a.status==="finished"&&w){const T=b.findIndex(I=>I.userId===o);T>=0&&T<3&&w.prize_amount>0&&!w.prize_claimed&&setTimeout(()=>ca(e,t,a,w,T),400)}}function $n(e,t,i,n,r=!1){const o=f=>t.find(b=>b.id===f);if(e.is_bye){const f=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${Et};text-align:center">🔵 ${(f==null?void 0:f.club_name)||(f==null?void 0:f.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),d=e.home_id===i||e.away_id===i,l=d&&e.status==="pending"&&n&&!r,c=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${d?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${d?"rgba(74,222,128,0.35)":Lt}">
    ...
    <div style="font-size:13px;font-weight:900;min-width:50px;text-align:center;color:${e.status==="finished"?"#4ade80":Ze}">${c}</div>
  ...
  </div>`}async function da(e,t,i,n){const{toast:r,state:o}=t,a=pa(n.map(l=>l.id),i.mode),s=[];a.forEach((l,c)=>l.forEach(f=>s.push({league_id:i.id,matchday:c+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:d}=await v.from("mini_league_matches").insert(s);if(d){r("Erreur calendrier : "+d.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),lt(e,t,i.id)}async function la(e,t,i){const{data:n}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){lt(e,t,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),lt(e,t,i)}async function ca(e,t,i,n,r){var b,x;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],d=["🥇","🥈","🥉"][r],l=n.prize_amount||s[r]||0,c=n.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    </div>`;let c=!1;const f=async u=>{if(!c){if(c=!0,clearInterval(g),x)try{x.unsubscribe()}catch{}u&&await Ct(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(c=!0,clearInterval(g),x)try{x.unsubscribe()}catch{}l("mini-league",{openLeagueId:n}),d()});const b=async()=>{if(c)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},x=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&f(u.new.match_id)}).subscribe(),g=setInterval(b,3e3);b()})}const ma="/",ga=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function xa(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var c,f,b;const s=t[n],d=n===t.length-1,l=Math.round((n+1)/t.length*100);r.innerHTML=`
    ...
    `,r.querySelectorAll("ul,ol").forEach(x=>{x.style.paddingLeft="20px",x.style.marginTop="6px",x.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(x=>{x.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(x=>{x.style.marginBottom="8px"}),(c=r.querySelector("#tuto-prev"))==null||c.addEventListener("click",()=>{n--,o()}),(f=r.querySelector("#tuto-next"))==null||f.addEventListener("click",()=>{d?a():(n++,o())}),(b=r.querySelector("#tuto-skip"))==null||b.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),e!=null&&e.id&&await v.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(r),o()}async function ba(e,t,i){if(!e||e.tutorial_done)return;let n=[];const{data:r,error:o}=await v.rpc("get_tutorial_steps");if(!o&&(r==null?void 0:r.length)>0)n=r,console.log(`[Tutorial] RPC OK → ${n.length} étapes`);else{const{data:s,error:d}=await v.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!d&&(s==null?void 0:s.length)>0?(n=s,console.log(`[Tutorial] Direct OK → ${n.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${o==null?void 0:o.message}, Direct: ${d==null?void 0:d.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=n.length>0?n.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):ga;xa(e,a,()=>t("boosters"))}const Ln={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function pi(e,t,i=0){return t?(Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0)+(t===e.job||t===e.job2?i:0):0}async function ya(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await tn(e,t)}async function tn(e,t){const{state:i,toast:n}=t,{data:r}=await v.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function b(p){var S,G,Q,ie;const u=(S=p.card)==null?void 0:S.player;if(!u)return"";const y=((G=p.card)==null?void 0:G.evolution_bonus)||0,w=pi(u,u.job,y),h=u.job2?pi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,C=Ln[u.job]||"#bbb",$=u.job2?Ln[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${m?`<img src="${m}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(Q=u.clubs)!=null&&Q.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
    ...
    </div>`,document.body.appendChild(r);const o=s=>{r.remove(),s&&t()};r.querySelector("#buy-cancel").addEventListener("click",()=>o(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>o(!0)),r.addEventListener("click",s=>{s.target===r&&o(!1)})}async function wa(e,t,i){const{toast:n}=i,{data:r}=await v.from("market_listings").select("card_id").eq("id",e).single();if(await v.from("market_listings").update({status:"cancelled"}).eq("id",e),r!=null&&r.card_id){const{count:o}=await v.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");o||await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}n("Annonce retirée","success"),tn(t,i)}async function _a(e,t){var x,g,p,u,y;const{state:i,navigate:n}=t,r=((g=(x=t==null?void 0:t.state)==null?void 0:x.params)==null?void 0:g.tab)||"ranked";e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:o},{data:a},{data:s}]=await Promise.all([v.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").gte("placement_matches",1).order("mmr",{ascending:!1}).limit(100),v.rpc("get_mini_league_leaderboard"),v.rpc("get_random_leaderboard")]);let d=r;const l=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",c=w=>w<3?"#000":"#fff";function f(){var E,m,C;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=d==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const h=document.getElementById("rankings-list");if(h){if(d==="ranked"){const $=o||[];h.innerHTML=$.length>0?$.map((S,G)=>{const Q=hi(S.mmr??1e3),ie=(S.ranked_wins||0)+(S.ranked_losses||0)+(S.ranked_draws||0),R=ie>0?Math.round((S.ranked_wins||0)/ie*100):0,T=S.id===i.profile.id,I=(S.placement_matches||0)<10;return`
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${T?"border:2px solid var(--yellow)":""}">
            ...
            <div style="flex:1;min-width:0">
              ...
              <div style="font-size:11px;color:var(--tile-fg-dim)">${S.club_name} · ${Q.label}</div>
            </div>
            <div style="text-align:right;flex-shrink:0">
              <div style="font-size:20px">${I?"❓":Q.emoji}</div>
              <div style="font-size:11px;font-weight:700;color:${Q.color}">${I?"Placement":Q.label}</div>
              ${I?"":`<div style="font-size:10px;color:var(--tile-fg-dim)">${R}% WR</div>`}
            </div>
        ...
        <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${S.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${l(G)};color:${c(G)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${G<3?"16":"13"}px">${G<3?["🥇","🥈","🥉"][G]:G+1}</div>
          <div style="flex:1;min-width:0">
  ...
  <div class="page">
    ...
    </div>`,(C=document.getElementById("ranked-back"))==null||C.addEventListener("click",()=>n("home"));return}const d=s.mmr??1e3,l=s.mmr_deviation??350,c=s.mmr_volatility??.06,f=s.placement_matches??0,b=f<10,x=Math.max(0,10-f),g=hi(d),p=In(d),u=Li.findIndex(Q=>Q.id===g.id),y=Li[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=Li.map(Q=>`
  ...
  </div>`}fo(go);const ye={user:null,profile:null,page:"home",params:{}};function Ft(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Ea(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ni(){document.getElementById("modal-overlay").classList.add("hidden")}async function Qt(){if(!ye.user)return;const{data:e}=await v.from("users").select("*").eq("id",ye.user.id).single();e&&(ye.profile=e)}const ao="mw_theme";function so(){return localStorage.getItem(ao)||"dark"}function La(e){var t;localStorage.setItem(ao,e),Ta(e),(t=ye.profile)!=null&&t.id&&v.from("users").update({theme:e}).eq("id",ye.profile.id).then(()=>{})}function Ta(e){document.documentElement.setAttribute("data-theme",e)}function Pt(e,t={}){ye.page=e,ye.params=t,lo()}async function lo(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ye.page)});const t=document.getElementById("nav-credits");t&&ye.profile&&(t.textContent=`💰 ${(ye.profile.credits||0).toLocaleString("fr")}`);const i={state:ye,navigate:Pt,toast:Ft,openModal:Ea,closeModal:Ni,refreshProfile:Qt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ye.page){case"home":await mn(e,i);break;case"home2":await No(e,i);break;case"game":await Ko(e,i);break;case"settings":await Pn(e,i);break;case"collection":await Zo(e,i);break;case"decks":await Ci(e,i);break;case"boosters":await ur(e,i);break;case"ranked":await ka(e,i);break;case"match":{const s=ye.params&&ye.params.matchMode||"vs_ai_easy";s==="random"?await Pi(e,i,!1):s==="ranked"?await Pi(e,i,!0):s==="friend"?await Xr(e,i,(n=ye.params)==null?void 0:n.friendId,(r=ye.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await En(e,i,(o=ye.params)==null?void 0:o.mlMatchId,(a=ye.params)==null?void 0:a.leagueId):await Tr(e,i);break}case"market":await ya(e,i);break;case"rankings":await _a(e,i);break;case"matches":await $a(e,i);break;case"friends":await _o(e,i);break;case"mini-league":await ea(e,i);break;case"match-mini-league":{const s=ye.params||{};await En(e,i,s.mlMatchId,s.leagueId);break}default:await mn(e,i)}}function Ia(){var n,r;const e=document.getElementById("app"),t=ye.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.26-0043" style="cursor:pointer">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function Aa(){document.documentElement.setAttribute("data-theme",so()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ni()}),document.getElementById("modal-close").addEventListener("click",Ni);const{data:{session:e}}=await v.auth.getSession();if(!e){Tn(),Sa(document.getElementById("app"),{onPlay:()=>cn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft})});return}ye.user=e.user,await Qt(),Tn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),mo(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ye.profile){bo(document.getElementById("app"),{state:ye,navigate:async()=>{await Qt(),Si()},toast:Ft,refreshProfile:Qt});return}const t=Array.isArray(ye.profile.pending_boosters)?ye.profile.pending_boosters:[];if(!ye.profile.onboarding_done&&t.length>0){vr(document.getElementById("app"),{state:ye,navigate:()=>Si(),toast:Ft,refreshProfile:Qt});return}Si(),setTimeout(()=>ba(ye.profile,Pt,Ft),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(ye.user=null,ye.profile=null,document.getElementById("app").innerHTML="",cn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft}))})}function Ma(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function ki(){const e=document.getElementById("app");e&&(e.style.height=Ma()+"px")}window.addEventListener("resize",ki);window.addEventListener("orientationchange",()=>setTimeout(ki,150));window.visualViewport&&window.visualViewport.addEventListener("resize",ki);function Si(){const e=()=>{var i;(i=ye.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ye.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",ki(),Ia(),lo()}function Tn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function co(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
