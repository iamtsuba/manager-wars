...
import{s as T,F as ki,i as Ht,k as eo,l as nt,m as ji,f as Nt,n as Lo,T as ci,j as Io,o as Mo,b as jo}from"./formation-links-BZe0pGr4.js";const Co="/";function Ci(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,m,a,o,y;const s=n==="login";e.innerHTML=`
  ...
  <div style="position:absolute;left:${se}px;top:${ve}px;width:${we}px;height:${_e}px;z-index:3;
    ...
    ${Ai(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(H=>H.card_type==="player"&&H.player),o=(l||[]).filter(H=>H.card_type==="game_changer"),y=(l||[]).filter(H=>H.card_type==="formation"),p=(l||[]).filter(H=>H.card_type==="stadium"),{data:x}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(x||[]).forEach(H=>{_[H.name]=H});const{data:f}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(f||[]).forEach(H=>{c[H.id]=H}),p.forEach(H=>{H.stadium_def&&(c[H.stadium_id]=H.stadium_def)});const z=Object.keys(ki),u=Object.keys(He),M={};a.forEach(H=>{const ee=H.player.id;M[ee]=(M[ee]||0)+1}),new Set(Object.keys(M).map(H=>String(H)));const F=new Set(y.map(H=>H.formation)),C=new Set(o.map(H=>H.gc_type));let q="player",j="Tous",N="",X=!1;function K(){return[...a].sort((H,ee)=>{const xe=Yt.indexOf(H.player.job),le=Yt.indexOf(ee.player.job);return xe!==le?xe-le:(H.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function re(){return[...m||[]].sort((H,ee)=>{const xe=Yt.indexOf(H.job),le=Yt.indexOf(ee.job);return xe!==le?xe-le:(H.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function oe(){return K().filter(H=>{const ee=H.player,xe=j==="Tous"||ee.job===j,le=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&le})}function Z(){return re().filter(H=>{const ee=j==="Tous"||H.job===j,xe=!N||`${H.firstname} ${H.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`},({def:ie,count:ue})=>{var Ge,Se;const Le=window.innerWidth>=768?.76:.54,Ie=(ie==null?void 0:ie.name)||"?",Ce=((Ge=ie==null?void 0:ie.club)==null?void 0:Ge.encoded_name)||(ie==null?void 0:ie.country_code)||"—",Ae=ie!=null&&ie.image_url?`${xe}icons/${ie.image_url}`:((Se=ie==null?void 0:ie.club)==null?void 0:Se.logo_url)||(ie!=null&&ie.country_code?`https://flagsapi.com/${ie.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),qe=Ae?`<img src="${Ae}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${Le};line-height:0;pointer-events:none">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${y.map((se,pe)=>{const de=oe[se.id]||[],H=se.is_for_sale,ee=de.length?de[de.length-1]:null,le=(o.rarity==="pepite"||o.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
