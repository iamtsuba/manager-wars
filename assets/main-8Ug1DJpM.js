...
import{s as v,j as ki,q as zo,t as Kt,u as Ki,F as Vi,o as it,n as Ot,g as Ct,r as Se,m as wt,v as gi,w as Mo,T as zi,p as xn,x as bn,d as yn}from"./special-cards-lEGt-tGs.js";const hn="/";function uo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,s,d,c,l,f,b;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=n),l&&(l.textContent=x,l.style.color=n)}document.getElementById("color1").addEventListener("input",c=>{n=c.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await v.from("users").insert({id:e.user.id,pseudo:c,club_name:l,club_color1:n,club_color2:a,credits:1e4});if(x)throw x;await wn(e.user.id),await r(),o(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function wn(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const _n="modulepreload",kn=function(t){return"/"+t},fo={},Co=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=kn(d),d in fo)return;fo[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":_n,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},jo="mw_sound_volume";function Yi(){const t=localStorage.getItem(jo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function $n(t){localStorage.setItem(jo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Wi(){return Yi()===0}function xi(t){return Math.max(0,Math.min(1,t*(Yi()/100)))}function Xi(t,e=1){if(Wi())return null;try{const i=new Audio(t);return i.volume=xi(e),i.play().catch(()=>{}),i}catch{return null}}let xt=null,qi=null,mo=.3;function Bo(t,e=.3){if(mo=e,xt&&qi===t&&!xt.paused){xt.volume=xi(mo);return}if(Gt(),!Wi())try{const i=new Audio(t);i.loop=!0,i.volume=xi(e),i.play().catch(()=>{}),xt=i,qi=t}catch{}}function Gt(){if(xt)try{xt.pause(),xt.currentTime=0}catch{}xt=null,qi=null}let Qt=null;function qo(t,e=.6){if(Ue(),!Wi())try{const i=new Audio(t);i.volume=xi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ue(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const En=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"game",route:"game",label:"GAME",emoji:"🎮"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Do(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const l=document.createElement("style");l.id="home2-chrome-style",l.textContent=`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Ln(O.published_at)}</div>
      </div>
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const s=a.dataset.action;if(s==="match-ai"){No(i,e);return}if(s==="match-random"){$t(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Oo(t,e){var f;const{state:i,navigate:o}=e,r=un(),n=Yi(),a=(f=i==null?void 0:i.profile)==null?void 0:f.is_admin,s="2026.07.27-1311";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Se(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(M=>M.card_type==="player"&&M.player),l=(s||[]).filter(M=>M.card_type==="game_changer"),f=(s||[]).filter(M=>M.card_type==="formation"),b=(s||[]).filter(M=>M.card_type==="stadium"),{data:x}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach(M=>{g[M.name]=M});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(M=>{u[M.id]=M}),b.forEach(M=>{M.stadium_def&&(u[M.stadium_id]=M.stadium_def)});const y=Object.keys(Vi),w=Object.keys(ze),h={};c.forEach(M=>{const Y=M.player.id;h[Y]=(h[Y]||0)+1}),new Set(Object.keys(h).map(M=>String(M)));const E=new Set(f.map(M=>M.formation)),m=new Set(l.map(M=>M.gc_type));let I="player",$="Tous",S="",F=!1;function O(){return[...c].sort((M,Y)=>{const q=di.indexOf(M.player.job),j=di.indexOf(Y.player.job);return q!==j?q-j:(M.player.surname_real||"").localeCompare(Y.player.surname_real||"")})}function K(){return[...d||[]].sort((M,Y)=>{const q=di.indexOf(M.job),j=di.indexOf(Y.job);return q!==j?q-j:(M.surname_real||"").localeCompare(Y.surname_real||"")})}function X(){return O().filter(M=>{const Y=M.player,q=$==="Tous"||Y.job===$,j=!S||`${Y.firstname} ${Y.surname_real}`.toLowerCase().includes(S);return q&&j})}function A(){return K().filter(M=>{const Y=$==="Tous"||M.job===$,q=!S||`${M.firstname} ${M.surname_real}`.toLowerCase().includes(S);return Y&&q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",Y=>{S=Y.target.value.toLowerCase(),H()}),t.querySelectorAll(".filter-btn").forEach(Y=>{Y.addEventListener("click",()=>{$=Y.dataset.job,_(),H()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{F=!F,_(),H()})):(M.innerHTML=`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${S}${l.job2&&F>0?` / ${O}`:""}`:`Note actuelle : ${S}${l.job2&&F>0?` / ${O}`:""}`}
            </div>
          </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(de=document.getElementById("close-detail"))==null||de.addEventListener("click",s);let _=new Set;const H=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function J(){let q=0;return document.querySelectorAll(".expl-check:checked").forEach(j=>{if(j.dataset.id===t.id)return;const C=Number(j.dataset.evo)||0,R=Number(j.dataset.note)||0;q+=R+C}),Math.round(q*H)}const re=()=>{const q=_.size,j=document.getElementById("sell-action-panel");if(!j)return;j.style.display=q>0?"block":"none",document.getElementById("sell-selected-count").textContent=q;const W=document.getElementById("evolve-btn");if(W){const C=J();W.textContent=C>0?`⬆️ Évoluer (+${C})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(q=>{q.addEventListener("change",()=>{const j=q.dataset.id;q.checked?_.add(j):_.delete(j);const W=q.closest(".exemplaire-row");if(W){const C=W.querySelector(".expl-sel-overlay"),R=W.querySelector(".expl-sel-check");C&&(C.style.display=q.checked?"block":"none"),R&&(R.style.display=q.checked?"flex":"none"),W.style.transform=q.checked?"scale(1.05)":"scale(1)"}re()})}),document.querySelectorAll(".exemplaire-row").forEach(q=>{q.addEventListener("click",j=>{if(j.target.tagName==="INPUT")return;const W=q.querySelector(".expl-check");W&&!W.disabled&&(W.checked=!W.checked,W.dispatchEvent(new Event("change")))})}),(me=document.getElementById("evolve-btn"))==null||me.addEventListener("click",async()=>{if(b<=1)return;const q=[..._];if(!q.length)return;if(_.has(t.id)){const ge=document.createElement("div");ge.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ge.innerHTML=`
    ...
    </div>`,document.body.appendChild(o);const r=n=>{o.remove(),i(n)};o.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),o.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),o.addEventListener("click",n=>{n.target===o&&r(!1)})})}const bi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Di(t,e){const{state:i,navigate:o,toast:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{e.formation=h.dataset.forma;const E=_o(e.formation),m={};E.forEach(I=>{e.slots[I]&&(m[I]=e.slots[I])}),e.slots=m,y(),_t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Zn(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>ir(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),_t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>tr(e,t,i)))}function Qn(t,e,i,o){var h,E,m;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(h=e.stadiumCards)==null?void 0:h.find(I=>I.id===e.stadiumCardId),s=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,d=wt[e.formation]||{},c=Ki(e.formation)||[],l={};for(const I of i){const $=e.slots[I],S=$?e.playerCards.find(F=>F.id===$):null;S!=null&&S.player?l[I]={...S.player,_evolution_bonus:S.evolution_bonus||0,face:S.player.face||null}:l[I]=null}const f=window.innerWidth>=900,b=f?window.innerWidth-280:window.innerWidth-20,x=f?Math.min(b,860):b,g=Math.round(f?x*.82:x*.85),p=f?84:44;let u="";for(const[I,$]of c){const S=d[I],F=d[$];if(!S||!F)continue;const O=S.x*x,K=Math.round(.03*g+S.y*.85*g),X=F.x*x,A=Math.round(.03*g+F.y*.85*g),_=l[I],H=l[$],J=Kt(_,H);J==="#ff3333"||J==="#cc2222"?u+=`<line x1="${O.toFixed(1)}" y1="${K.toFixed(1)}" x2="${X.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${O.toFixed(1)}" y1="${K.toFixed(1)}" x2="${X.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${O.toFixed(1)}" y1="${K.toFixed(1)}" x2="${X.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const I of i){const $=d[I];if(!$)continue;const S=l[I],F=$.x*x;$.y*g;const O=Math.round(.03*g+$.y*(.85*g)),K=Math.round(F-p/2),X=Math.round(O-w/2);if(S){const A=I.replace(/\d+/,""),_=s&&(s.club_id&&String(S.club_id)===String(s.club_id)||s.country_code&&S.country_code===s.country_code),H=Se({...S,_evolution_bonus:S._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:A});_&&((m=s.club)!=null&&m.logo_url||s.image_url),y+=`<div style="position:absolute;left:${K}px;top:${X}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${I}">
        <div style="position:relative">${H}</div>
      </div>`}else{const A=I.replace(/\d+/,"");y+=`<div style="position:absolute;left:${K}px;top:${X}px;width:${p}px;height:${w}px;
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function X(){const A=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!A||!_||!y)return;const H=_.clientWidth>=900,J=Math.max(200,_.clientHeight-(H?60:40)),le=Math.max(200,_.clientWidth-16),B=H?Math.min(117,Math.max(52,Math.round(le*.22))):Math.max(44,Math.round(le*.168));if(J<220||le<220){requestAnimationFrame(X);return}const U=H?null:Math.round(B*.55);A.innerHTML=Ht(y,u,null,[],le,J,[],U),A.style.cssText=`width:${le}px;height:${J}px;overflow:hidden;margin:${H?0:60}px auto 0`;const de=A.querySelector("svg");de&&(de.style.cssText="display:block;width:100%;height:100%",de.setAttribute("preserveAspectRatio",H?"xMidYMid meet":"none"))})),(S=document.getElementById("prev-deck"))==null||S.addEventListener("click",()=>{l>0&&(l--,f())}),(F=document.getElementById("next-deck"))==null||F.addEventListener("click",()=>{l<n.length-1&&(l++,f())}),(O=document.getElementById("validate-deck"))==null||O.addEventListener("click",()=>{if(!h)return;const X=e.state.params||{};e.navigate("match",{...X,matchMode:X.matchMode||i,deckId:b.id})}),(K=document.getElementById("cancel-deck-select"))==null||K.addEventListener("click",()=>{Ke(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let X=0,A=0;E.addEventListener("touchstart",_=>{X=_.touches[0].clientX,A=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const H=_.changedTouches[0].clientX-X,J=_.changedTouches[0].clientY-A;Math.abs(H)<40||Math.abs(H)<Math.abs(J)||(H<0&&l<n.length-1?(l++,f()):H>0&&l>0&&(l--,f()))},{passive:!0})}}f()}function vt(t,e=44,i=58,o=null){return Se(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function Qe(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,d)=>{const c=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(c==="ATT"||c==="MIL")||o==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?l+=10:o||(l+=10)),a+=Se(s,{width:40,role:c,extraNote:l}),d<n.length-1){const f=n[d+1],b=Ho(s,f,r)?Kt(s,f):null;a+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Li(t,e,i,o,r=310,n=310,a=[],s=null){const d=wt[e]||{},c=Ki(e)||Vi[e]||[],l={},f=["ATT","MIL","DEF","GK"];for(const y of f)(t[y]||[]).forEach((h,E)=>{l[`${y}${E+1}`]=h});function b(y){const w=d[y];return w?{x:w.x*r,y:w.y*n}:null}let x="";for(const[y,w]of c){const h=b(y),E=b(w);if(!h||!E)continue;const m=l[y],I=l[w],$=Kt(m,I);$==="#00ff88"||$==="#FFD700"?(x+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function nn(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function bt(t,e){return t.reduce((i,o)=>i+nn(o,e),0)}function yt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Kt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function vi(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const s=a<t.length-1?Kt(n,t[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return nn(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function _r(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",s=o.soloLevel||1,d=r.replace("vs_ai_",""),c=r;let l=null;if(n){const{data:x}=await v.from("solo_levels").select("*").eq("level_number",s).maybeSingle();l=x||{level_number:s,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const f=o.rankedData||null;let b=null;if(a){const x=(f==null?void 0:f.mmr)??1e3;b={target_note_avg:Math.min(20,Math.max(1,Math.round(x/100))),nb_liens_jaune:3,nb_liens_vert:2,nb_joueurs_stade:3}}await Ii(t,e,r,async({deckId:x,formation:g,starters:p,subsRaw:u,gcCardsEnriched:y,gcDefs:w,stadiumDef:h})=>{try{let E=hi(p,g);h&&(E=si(E,h),yi(u,h));const m=n?await $o(g,l):a?await $o(g,b):await kr(g,d),I=m.lines||m,$=async S=>{try{const F=c==="vs_ai_club"||c==="solo"?"club":c,{data:O,error:K}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:F,home_deck_id:x,status:"in_progress"}).select().single();if(K){console.error("[MatchIA] Erreur création match:",K),At(t,"⚠️","Impossible de créer le match ("+K.message+").","Retour",()=>e.navigate("home"));return}const X=m.stadiumDef||null;X&&I&&(si(I,X),yi(m.subs||[],X));const A={gcDefs:w||[],matchId:O==null?void 0:O.id,mode:c,difficulty:d,formation:g,isSolo:n,soloLevel:s,soloLevelConfig:l,isRankedAI:a,rankedAIData:f,homeTeam:E,aiTeam:I,homeSubs:u,subsUsed:0,maxSubs:Math.min(u.length,3),aiSubs:m.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((m.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:m.gcCards||[],aiUsedGc:[],aiStadiumDef:X,homeScore:0,aiScore:0,gcCards:S,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};$r(t,A,e)}catch(F){console.error("[MatchIA] Exception launchMatch:",F),At(t,"⚠️","Erreur au lancement du match : "+F.message,"Retour",()=>e.navigate("home"))}};if(!y.length){$([]);return}Ei(t,y,$)}catch(E){console.error("[MatchIA] Exception setup:",E),At(t,"⚠️","Erreur de préparation du match : "+E.message,"Retour",()=>e.navigate("home"))}})}async function kr(t,e){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:rn(t),subs:[],gcCards:[],stadiumDef:null};const o=kt[t]||kt["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(y,w,h){var E,m;return n.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!n.has($.id)),h=i.filter($=>$.job!==y&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[y];$++){const S=E[$];S&&m.push(a(S,y,$))}const I=st(m.length);m.forEach(($,S)=>{$._col=I[S]}),r[y]=m}const d=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),f=Object.keys(ze).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var h,E;return{id:"ai-gc-"+w,gc_type:y,name:((h=ze[y])==null?void 0:h.name)||y,icon:((E=ze[y])==null?void 0:E.icon)||"⚡"}}),b=Object.values(r).flat(),x={};b.forEach(y=>{y.club_id&&(x[y.club_id]=(x[y.club_id]||0)+1)});const g=(u=Object.entries(x).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:r,subs:d,gcCards:f,stadiumDef:p}}function ko(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function ui(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(ko(r)-e)-Math.abs(ko(n)-e));return o.slice(0,Math.min(i,o.length))}async function $o(t,e){var X,A;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:rn(t),subs:[],gcCards:[],stadiumDef:null};const s={};a.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const d=((X=Object.entries(s).sort((_,H)=>H[1]-_[1])[0])==null?void 0:X[0])||null,c=d?a.filter(_=>_.club_id===d):[],l=((A=c[0])==null?void 0:A.country_code)||null,f=l?a.filter(_=>_.country_code===l&&_.club_id!==d):[],b=Math.min(c.length,Math.max(2,r+1),16),x=Math.min(f.length,Math.max(0,o),16-b),g=[],p=new Set;ui(c,i,b).forEach(_=>{g.push(_),p.add(_.id)}),ui(f,i,x).forEach(_=>{g.push(_),p.add(_.id)});const u=Math.max(0,16-g.length),y=a.filter(_=>!p.has(_.id));ui(y,i,u).forEach(_=>{g.push(_),p.add(_.id)});const w=kt[t]||kt["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,H,J){var re,le;return E.add(_.id),{cardId:"ai-"+_.id+"-"+J,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((re=_.clubs)==null?void 0:re.encoded_name)||null,clubLogo:((le=_.clubs)==null?void 0:le.logo_url)||null,boost:0,used:!1,_line:H}}for(const _ of["GK","DEF","MIL","ATT"]){const H=g.filter(U=>U.job===_&&!E.has(U.id)),J=g.filter(U=>U.job!==_&&!E.has(U.id)),re=[...H,...J],le=[];for(let U=0;U<w[_];U++){const de=re[U];de&&le.push(m(de,_,U))}const B=st(le.length);le.forEach((U,de)=>{U._col=B[de]}),h[_]=le}let I=g.filter(_=>!E.has(_.id));if(I.length<5){const _=a.filter(H=>!E.has(H.id)&&!I.some(J=>J.id===H.id));I=I.concat(ui(_,i,5-I.length))}const $=I.slice(0,5).map((_,H)=>m(_,_.job,100+H)),O=Object.keys(ze).sort(()=>Math.random()-.5).slice(0,3).map((_,H)=>{var J,re;return{id:"ai-gc-"+H,gc_type:_,name:((J=ze[_])==null?void 0:J.name)||_,icon:((re=ze[_])==null?void 0:re.icon)||"⚡"}});let K=null;if(n>0&&d){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",d).single();_&&(K={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:O,stadiumDef:K}}function rn(t){const e=kt[t]||kt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let d=0;d<e[n];d++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?c:2,note_d:n==="DEF"?c:2,note_m:n==="MIL"?c:2,note_a:n==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const s=st(a.length);a.forEach((d,c)=>{d._col=s[c]}),i[n]=a}return i}function $r(t,e,i){var r;Bo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div id="match-history-panel">
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(I=f.querySelector("#out-up"))==null||I.addEventListener("click",()=>{s>0&&(s--,b())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<n.length-1&&(s++,b())}),(S=f.querySelector("#in-up"))==null||S.addEventListener("click",()=>{c>0&&(c--,b())}),(F=f.querySelector("#in-down"))==null||F.addEventListener("click",()=>{c<a.length-1&&(c++,b())});const E=(K,X,A,_)=>{const H=f.querySelector("#"+K);if(!H)return;let J=0;H.addEventListener("touchstart",re=>{J=re.touches[0].clientY},{passive:!0}),H.addEventListener("touchend",re=>{const le=re.changedTouches[0].clientY-J;if(Math.abs(le)<30)return;const B=X();le<0&&B<_-1?(A(B+1),b()):le>0&&B>0&&(A(B-1),b())},{passive:!0})};E("in-panel",()=>c,K=>c=K,a.length),E("out-panel",()=>s,K=>s=K,n.length),(O=f.querySelector("#sub-confirm"))==null||O.addEventListener("click",K=>{if(K.preventDefault(),K.stopPropagation(),l)return;l=!0;const X=n[s],A=a[c];if(!X||!A)return;let _=null,H=-1;for(const[re,le]of Object.entries(e.homeTeam)){const B=(le||[]).findIndex(U=>U.cardId===X.cardId);if(B!==-1){_=re,H=B;break}}if(H===-1||!_){It("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const J={...A,_line:_,_col:X._col||0,used:!1,boost:0};e.homeTeam[_].splice(H,1,J),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(A.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:X.name,firstname:X.firstname,note:Pe(X,_),portrait:Ct(X),job:X.job,country_code:X.country_code,rarity:X.rarity,clubName:X.clubName,clubLogo:X.clubLogo},inPlayer:{name:A.name,firstname:A.firstname,note:Pe(A,_),portrait:Ct(A),job:A.job,country_code:A.country_code,rarity:A.rarity,clubName:A.clubName,clubLogo:A.clubLogo},text:`🔄 ${A.firstname} ${A.name} remplace ${X.firstname} ${X.name}`}),f.remove(),wr(X,A,()=>$e(t,e,i))})}document.body.appendChild(f),b()}function Mr(t,e,i,o,r){var b,x;const n=(o.gcDefs||[]).find(g=>g.name===e),a=ze[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,d=(n==null?void 0:n.effect)||a.desc,c=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${it(s,c,l,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(b=f.querySelector("#gc-back"))==null||b.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),jr(t,e,i,o,r)})}function fi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var c,l;a.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[a]||[]).find(d=>d.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),$e(t,e,i)})})}async function ht(t,e,i){var f,b,x,g,p;Gt(),Ue(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",s=e.isSolo&&((f=e.soloLevelConfig)!=null&&f.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):Rn(e.mode,a);if(e.isSolo&&r)try{const{data:u}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),y=(u==null?void 0:u.unlocked_level)||1;e.soloLevel>=y&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(u){console.warn("[Solo] Erreur mise à jour progression:",u.message)}let d=null;if(e.isRankedAI)try{const{data:u}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",o.profile.id).single();if(u){const y=u.mmr??1e3,w=u.mmr_rd??350,h=u.mmr_v??.06,E=r?1:n?.5:0,m=((b=e.rankedAIData)==null?void 0:b.isPlacement)||!1,I=Mo(y,w,h,y,350,E,m);await v.from("users").update({mmr:I.mmr,mmr_rd:I.rd,mmr_v:I.v}).eq("id",o.profile.id),d=Math.round(I.mmr-y)}}catch(u){console.warn("[RankedAI] Erreur mise à jour MMR:",u.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const c={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};r?c.wins=(o.profile.wins||0)+1:n?c.draws=(o.profile.draws||0)+1:c.losses=(o.profile.losses||0)+1,await v.from("users").update(c).eq("id",o.profile.id),await i.refreshProfile();const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",l.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(Ge=te.querySelector("#psub-close"))==null||Ge.addEventListener("click",()=>te.remove()),(Te=te.querySelector("#pout-up"))==null||Te.addEventListener("click",()=>{N>0&&(N--,ee())}),(Ye=te.querySelector("#pout-down"))==null||Ye.addEventListener("click",()=>{N<G.length-1&&(N++,ee())}),(Oe=te.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{Z>0&&(Z--,ee())}),(ot=te.querySelector("#pin-down"))==null||ot.addEventListener("click",()=>{Z<P.length-1&&(Z++,ee())});const Ie=(De,We,He,ut)=>{const nt=te.querySelector("#"+De);if(!nt)return;let Bt=0;nt.addEventListener("touchstart",ft=>{Bt=ft.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",ft=>{const Lt=ft.changedTouches[0].clientY-Bt;if(Math.abs(Lt)<30)return;const rt=We();Lt<0&&rt<ut-1?(He(rt+1),ee()):Lt>0&&rt>0&&(He(rt-1),ee())},{passive:!0})};Ie("pin-panel",()=>Z,De=>Z=De,P.length),Ie("pout-panel",()=>N,De=>N=De,G.length),(Vt=te.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ie)return;ie=!0;const We=G[N],He=P[Z];if(!We||!He)return;const ut=We._line,nt=(z[ut]||[]).findIndex(Lt=>Lt.cardId===We.cardId);if(nt===-1){g("Erreur : joueur introuvable","error"),te.remove();return}const Bt={...He,_line:ut,position:We.position,used:!1,boost:0};z[ut].splice(nt,1,Bt);const ft=[...D,He.cardId];te.remove(),W(We,He,async()=>{await A({[p+"Team"]:z,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:ft})})})}document.body.appendChild(te),ee()}function W(k,L,z){const D={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const G=(V,Z,ie)=>`<div style="text-align:center">
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(X)}catch{}Ke(t),l?x("mini-league",{openLeagueId:l}):x("home")})}U()}async function Oi(t,e,i=!1){var s,d;const{state:o,navigate:r,toast:n}=e,a=i&&((d=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await Ii(t,e,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{lt(t);const u=async y=>{await Rr(t,e,c,l,f,b,y||[],g,p,i,a)};if(!(x!=null&&x.length)){await u([]);return}Ei(t,x,u)})}async function Gr(t,e,i){return Nr(t,e,i)}async function Rr(t,e,i,o,r,n,a=[],s=[],d=null,c=!1,l=null){var K,X;const{state:f,navigate:b,toast:x}=e,g=(l==null?void 0:l.mmr)??((K=f.profile)==null?void 0:K.mmr)??1e3,p=c?ki(g):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(A){console.error("[Matchmaking] cancel error:",A)}};(X=document.getElementById("cancel-mm"))==null||X.addEventListener("click",async()=>{await m(),Ke(t),b("home")});const I=async(A,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await jt(t,e,A,_,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?Or:null}))},$=f.user.id,{data:S,error:F}=c?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(F||!(S!=null&&S.success)){console.error("[Matchmaking] try_matchmake error:",F||S),x("Erreur de matchmaking","error"),Ke(t),b("home");return}if(S.matched){await I(S.match_id,!1);return}const O=async()=>{if(w)return;const{data:A}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(A==null?void 0:A.status)==="matched"&&A.match_id&&await I(A.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},A=>{const _=A.new;_.status==="matched"&&_.match_id&&I(_.match_id,!0)}).subscribe(),E=setInterval(O,3e3),c?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(A){console.error("[Matchmaking] cancel error:",A)}x("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),b("match",{matchMode:"ranked_ai",rankedData:l})}},2e4):setTimeout(()=>{w||m()},12e4)}async function Or(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:s,awayScore:d,matchId:c}=t,l=i.user.id,f=n===l,b=r===l,{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:n).single();if(x&&g){const p=Mo(x.mmr,x.mmr_rd,x.mmr_v,g.mmr,g.mmr_rd,b?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:b?v.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(b?`+MMR ↑ ${Math.round(p.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-p.mmr)}`,b?"success":"error",4e3)}}const Hr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Oi,resumePvpMatch:Gr},Symbol.toStringTag,{value:"Module"}));async function Ur(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,s=n.friendName||"Ami",d=!!n.isAccepting;await Ii(t,e,"friend",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{lt(t);const u=async y=>{const w=y||[];d?await Vr(t,e,c,w,g,p):await Kr(t,e,c,w,g,p,a,s)};if(!(x!=null&&x.length)){await u([]);return}Ei(t,x,u)})}async function Kr(t,e,i,o,r,n,a,s){var w;const{state:d,navigate:c,toast:l}=e,f=d.user.id,{data:b,error:x}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!b){console.error("[Friend] Erreur création invitation:",x),l("Impossible de créer l'invitation","error"),c("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`,document.body.appendChild(x),x.querySelector("#lv-ok").onclick=()=>{x.remove(),b(!0)},x.querySelector("#lv-cancel").onclick=()=>{x.remove(),b(!1)}}))return;const{data:d,error:c}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(d!=null&&d.success)){r((d==null?void 0:d.error)||"Erreur lors de la désinscription","error");return}const l=d.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+l);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),tt(t,e,"waiting")}async function Hi(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),tt(t,e,r)}async function ia(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),tt(t,e,"archived")}async function ct(t,e,i){var E,m,I,$,S,F,O,K,X;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:s},{data:d}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await tt(t,e);return}const c=(s||[]).some(A=>A.user_id===n),l=a.creator_id===n,f=(s||[]).map(A=>A.user).filter(Boolean),b=sa(f,d||[]),x=(d||[]).filter(A=>A.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,u=x.length>0&&x.every(A=>A.status==="finished"||A.status==="bye"),y=a.current_day>=a.total_days,w=(s||[]).find(A=>A.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((A,_)=>{const H=g>0&&a.status==="finished"?_===0?Math.floor(g*.7):_===1?Math.floor(g*.2):_===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${St};${A.userId===n?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(A,_)=>_+1).reverse().map(A=>{const _=(d||[]).filter(H=>H.matchday===A);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${et};margin-bottom:6px">Journée ${A}</div>${_.map(H=>Io(H,f,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`}async function oa(t,e,i,o){const{toast:r,state:n}=e,a=aa(o.map(c=>c.id),i.mode),s=[];a.forEach((c,l)=>c.forEach(f=>s.push({league_id:i.id,matchday:l+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:d}=await v.from("mini_league_matches").insert(s);if(d){r("Erreur calendrier : "+d.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ct(t,e,i.id)}async function na(t,e,i){const{data:o}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(o.current_day||0)+1;if(r>(o.total_days||0)){ct(t,e,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),e.toast(`Journée ${r} commencée !`,"success"),ct(t,e,i)}async function ra(t,e,i,o,r){var b,x;const{state:n,toast:a}=e,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],d=["🥇","🥈","🥉"][r],c=o.prize_amount||s[r]||0,l=o.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function pa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,f,b;const s=e[o],d=o===e.length-1,c=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function b(p){var S,F,O,K;const u=(S=p.card)==null?void 0:S.player;if(!u)return"";const y=((F=p.card)==null?void 0:F.evolution_bonus)||0,w=mi(u,u.job,y),h=u.job2?mi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,I=So[u.job]||"#bbb",$=u.job2?So[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
    ...
    </div>`,document.body.appendChild(r);const n=s=>{r.remove(),s&&e()};r.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),r.addEventListener("click",s=>{s.target===r&&n(!1)})}async function xa(t,e,i){const{toast:o}=i,{data:r}=await v.from("market_listings").select("card_id").eq("id",t).single();if(await v.from("market_listings").update({status:"cancelled"}).eq("id",t),r!=null&&r.card_id){const{count:n}=await v.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");n||await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}o("Annonce retirée","success"),oo(e,i)}async function ba(t,e){var x,g,p,u,y;const{state:i,navigate:o}=e,r=((g=(x=e==null?void 0:e.state)==null?void 0:x.params)==null?void 0:g.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:a},{data:s}]=await Promise.all([v.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").gte("placement_matches",1).order("mmr",{ascending:!1}).limit(100),v.rpc("get_mini_league_leaderboard"),v.rpc("get_random_leaderboard")]);let d=r;const c=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",l=w=>w<3?"#000":"#fff";function f(){var E,m,I;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=d==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const h=document.getElementById("rankings-list");if(h){if(d==="ranked"){const $=n||[];h.innerHTML=$.length>0?$.map((S,F)=>{const O=ki(S.mmr??1e3),K=(S.ranked_wins||0)+(S.ranked_losses||0)+(S.ranked_draws||0),X=K>0?Math.round((S.ranked_wins||0)/K*100):0,A=S.id===i.profile.id,_=(S.placement_matches||0)<10;return`
          ...
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(d==="mini-league"){const $=a||[];h.innerHTML=$.length>0?$.map((S,F)=>`
  ...
  <div class="page">
    ...
    </div>`,(I=document.getElementById("ranked-back"))==null||I.addEventListener("click",()=>o("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,f=s.placement_matches??0,b=f<10,x=Math.max(0,10-f),g=ki(d),p=zo(d),u=zi.findIndex(O=>O.id===g.id),y=zi[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=zi.map(O=>`
  ...
  </div>`}xn(yn);const ve={user:null,profile:null,page:"home",params:{}};function Pt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function va(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ui(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const pn="mw_theme";function un(){return localStorage.getItem(pn)||"dark"}function wa(t){var e;localStorage.setItem(pn,t),_a(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function _a(t){document.documentElement.setAttribute("data-theme",t)}function Nt(t,e={}){ve.page=t,ve.params=e,fn()}async function fn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Nt,toast:Pt,openModal:va,closeModal:Ui,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Mi(t,i);break;case"home2":await Mi(t,i);break;case"game":await Gn(t,i);break;case"settings":await Oo(t,i);break;case"collection":await Yn(t,i);break;case"decks":await Di(t,i);break;case"boosters":await sr(t,i);break;case"ranked":await ya(t,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Oi(t,i,!1):s==="ranked"?await Oi(t,i,!0):s==="friend"?await Ur(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await To(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await _r(t,i);break}case"market":await fa(t,i);break;case"rankings":await ba(t,i);break;case"matches":await ha(t,i);break;case"friends":await Dn(t,i);break;case"mini-league":await Wr(t,i);break;case"match-mini-league":{const s=ve.params||{};await To(t,i,s.mlMatchId,s.leagueId);break}default:await Mi(t,i)}}function ka(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.27-1311" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),Nt(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Nt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Nt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>$a()),(r=document.getElementById("settings-btn"))==null||r.addEventListener("click",()=>Nt("settings"))}async function $a(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const r=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${r}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function La(){document.documentElement.setAttribute("data-theme",un()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ui()}),document.getElementById("modal-close").addEventListener("click",Ui);const{data:{session:t}}=await v.auth.getSession();if(!t){Ao(),Ea(document.getElementById("app"),{onPlay:()=>uo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt})});return}ve.user=t.user,await ti(),Ao();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(r=>{o[r.formation]=r.links}),bn(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){vn(document.getElementById("app"),{state:ve,navigate:async()=>{await ti(),Bi()},toast:Pt,refreshProfile:ti});return}const e=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&e.length>0){gr(document.getElementById("app"),{state:ve,navigate:()=>Bi(),toast:Pt,refreshProfile:ti});return}Bi(),setTimeout(()=>ua(ve.profile,Nt,Pt),800),v.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",uo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt}))})}function Ia(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Ti(){const t=document.getElementById("app");t&&(t.style.height=Ia()+"px")}window.addEventListener("resize",Ti);window.addEventListener("orientationchange",()=>setTimeout(Ti,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Ti);function Bi(){const t=()=>{var i;(i=ve.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Ti(),ka(),fn()}function Ao(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function mn(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
