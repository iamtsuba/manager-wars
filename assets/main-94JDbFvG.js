...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",d);let G=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function pe(){let F=0;return document.querySelectorAll(".expl-check:checked").forEach(H=>{if(H.dataset.id===t.id)return;const ce=Number(H.dataset.evo)||0,be=Number(H.dataset.note)||0;F+=be+ce}),Math.round(F*le)}const M=()=>{const F=G.size,H=document.getElementById("sell-action-panel");if(!H)return;H.style.display=F>0?"block":"none",document.getElementById("sell-selected-count").textContent=F;const ae=document.getElementById("evolve-btn");if(ae){const ce=pe();ae.textContent=ce>0?`⬆️ Évoluer (+${ce})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(F=>{F.addEventListener("change",()=>{const H=F.dataset.id;F.checked?G.add(H):G.delete(H);const ae=F.closest(".exemplaire-row");if(ae){const ce=ae.querySelector(".expl-sel-overlay"),be=ae.querySelector(".expl-sel-check");ce&&(ce.style.display=F.checked?"block":"none"),be&&(be.style.display=F.checked?"flex":"none"),ae.style.transform=F.checked?"scale(1.05)":"scale(1)"}M()})}),document.querySelectorAll(".exemplaire-row").forEach(F=>{F.addEventListener("click",H=>{if(H.target.tagName==="INPUT")return;const ae=F.querySelector(".expl-check");ae&&!ae.disabled&&(ae.checked=!ae.checked,ae.dispatchEvent(new Event("change")))})}),(V=document.getElementById("evolve-btn"))==null||V.addEventListener("click",async()=>{if(b<=1)return;const F=[...G];if(!F.length)return;if(G.has(t.id)){const ye=document.createElement("div");ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ye.innerHTML=`
  ...
  <div id="match-history-panel">
      ...
      ${Mi(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${je.id!==rt.id?`<div style="font-size:20px;font-weight:900;color:${je.color}">
                  ...
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ne>ee.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Ae>=0?"📈":"📉"}</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(ie);let ee=!1;const se=()=>{ee||(ee=!0,ie.remove(),setTimeout(()=>z&&z(),50))};ie.addEventListener("click",se),setTimeout(se,3e3)}function j(k,S){var oe,ie,ee,se;const C=(m["gcCardsFull_"+f]||[]).find(fe=>fe.id===k),A=C==null?void 0:C._gcDef,R=(A==null?void 0:A.name)||S,q=(A==null?void 0:A.effect)||((oe=Oe[S])==null?void 0:oe.desc)||"Carte spéciale.",D=A!=null&&A.image_url?`/icons/${A.image_url}`:null,U=((ie=Oe[S])==null?void 0:ie.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ...
      </div>`,(Ne=ie.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>ie.remove()),(je=ie.querySelector("#pout-up"))==null||je.addEventListener("click",()=>{D>0&&(D--,ee())}),(Xe=ie.querySelector("#pout-down"))==null||Xe.addEventListener("click",()=>{D<R.length-1&&(D++,ee())}),(Ue=ie.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{Z>0&&(Z--,ee())}),(rt=ie.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{Z<q.length-1&&(Z++,ee())});const Ae=(Fe,Je,Ke,gt)=>{const at=ie.querySelector("#"+Fe);if(!at)return;let Pt=0;at.addEventListener("touchstart",xt=>{Pt=xt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",xt=>{const Tt=xt.changedTouches[0].clientY-Pt;if(Math.abs(Tt)<30)return;const st=Je();Tt<0&&st<gt-1?(Ke(st+1),ee()):Tt>0&&st>0&&(Ke(st-1),ee())},{passive:!0})};Ae("pin-panel",()=>Z,Fe=>Z=Fe,q.length),Ae("pout-panel",()=>D,Fe=>D=Fe,R.length),(Xt=ie.querySelector("#psub-confirm"))==null||Xt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),oe)return;oe=!0;const Je=R[D],Ke=q[Z];if(!Je||!Ke)return;const gt=Je._line,at=(z[gt]||[]).findIndex(Tt=>Tt.cardId===Je.cardId);if(at===-1){x("Erreur : joueur introuvable","error"),ie.remove();return}const Pt={...Ke,_line:gt,position:Je.position,used:!1,boost:0};z[gt].splice(at,1,Pt);const xt=[...C,Ke.cardId];ie.remove(),te(Je,Ke,async()=>{await L({[f+"Team"]:z,[y+"Team"]:m[y+"Team"],["usedSubIds_"+f]:xt})})})}document.body.appendChild(ie),ee()}function te(k,S,z){const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const R=(U,Z,oe)=>`<div style="text-align:center">
    ...
    </div>`,(A=document.getElementById("pvp-home"))==null||A.addEventListener("click",()=>{try{h.removeChannel(K)}catch{}Ye(t),l?g("mini-league",{openLeagueId:l}):g("home")})}O()}async function Xi(t,e,i=!1){var d,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:c.rankedData)||null;await Ci(t,e,i?"ranked":"random",async({deckId:s,formation:l,starters:p,subsRaw:b,gcCardsEnriched:g,gcDefs:x,stadiumDef:f})=>{ct(t);const y=async u=>{await la(t,e,s,l,p,b,u||[],x,f,i,a)};if(!(g!=null&&g.length)){await y([]);return}zi(t,g,y)})}async function da(t,e,i){return sa(t,e,i)}async function la(t,e,i,o,r,n,a=[],d=[],c=null,s=!1,l=null){var W,K;const{state:p,navigate:b,toast:g}=e,x=(l==null?void 0:l.mmr)??((W=p.profile)==null?void 0:W.mmr)??1e3,f=s?zt(x):null,y=s?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",u=s?(f==null?void 0:f.color)||"#D4A017":"#FFD700";let w=!1,v=null,E=null;t.innerHTML=`
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.31-2320" style="cursor:pointer">
