...
import{s as T,F as $i,i as Ut,k as Vi,l as ot,m as Ii,f as Nt,n as vn,T as li,j as wn,o as _n,b as $n}from"./formation-links-BZe0pGr4.js";const kn="/";function Mi(e,{navigate:t,toast:i}){let o="login";const d=()=>{var r,l,f,a,n,x;const s=o==="login";e.innerHTML=`
  ...
  `,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",o),i.addEventListener("click",d=>{d.target===i&&o()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{o(),e("match",{matchMode:d.dataset.mode})})})}const Bt="/",Bi={GK:Bt+"cards/card-GK.png",DEF:Bt+"cards/card-DEF.png",MIL:Bt+"cards/card-MIL.png",ATT:Bt+"cards/card-ATT.png"},Gn={GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"};function Pn(e){if(!(e!=null&&e.face))return null;const t=e.face.replace(/^public\//,"").replace(/^\//,"");return Bt+t}function Nn(e){return!e||e.length<2?null:`https://flagsapi.com/${e.slice(0,2).toUpperCase()}/flat/64.png`}function Rn(e){var o;const t="https://fcnwclxlkytdfjotqkta.supabase.co",i=((o=e==null?void 0:e.clubs)==null?void 0:o.logo_url)||(e==null?void 0:e.clubLogo);return i?i.startsWith("http")?i:`${t}/storage/v1/object/public/assets/clubs/${i}`:null}function Fi(e,t,i=0){if(!t)return 0;const d="note_"+({GK:"g",DEF:"d",MIL:"m",ATT:"a"}[t]||t.toLowerCase());return(Number(e[d])||0)+(t===e.job||t===e.job2?i:0)}function On(e,t){return t?t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code:!1}function zt(e,t={}){var de;const{width:i=160,showStad:o=!1,stadDef:d=null,used:s=!1,extraNote:r=0}=t;if(!e)return`<div style="width:${i}px;height:${Math.round(i*657/507)}px;border-radius:8px;background:#111;opacity:0.3"></div>`;const l=i/507,f=Math.round(i*657/507),a=O=>Math.round(O*l),n=O=>a(O)+"px",x=e._line||e.job||"MIL",p=Gn[x]||"#D4A017",h=Bi[x]||Bi.MIL,_=e._evolution_bonus??e.evolution_bonus??0,u=o&&(e.stadiumBonus||On(e,d))?10:0,c=Fi(e,x,_)+r+u,A=u>0?"#4fc3f7":p,m=e.job2&&e.job2!==x?e.job2:null,I=m?Fi(e,m,_)+r+u:null,C=Pn(e),j=Nn(e.country_code),D=Rn(e),q=(e.firstname||"").toUpperCase(),N=(e.surname_encoded||e.name||"").toUpperCase(),V=s?"opacity:0.35;":"",K=N.length>11?34:N.length>8?42:50,ae=a(155),ne=a(260),J=a(235),R=a(390),G=a(180),re=a(100),me=a(309),_e=a(85),ve=a(95),we=a(435),Ee=a(38),se=a(374),pe=a(6);return`<div style="position:relative;width:${i}px;height:${f+(u>0?a(22):0)}px;flex-shrink:0;${V}user-select:none">
  ...
  <div style="position:absolute;top:${n(48)};left:0;right:0;text-align:center;z-index:4;padding:0 ${n(50)}">
    <span style="font-size:${n(20)};font-weight:700;color:${p};letter-spacing:${n(2)};line-height:1;text-shadow:0 1px 4px #000;display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${q}</span>
  </div>
  ...
  ${C?`<img src="${C}"
    ...
    width:${ne}px;height:${J}px;object-fit:cover;object-position:top center;z-index:2"
  ...
  <div style="position:absolute;left:${se}px;top:${we}px;width:${ve}px;height:${_e}px;z-index:3;
    ...
    ${zt(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(O=>O.card_type==="player"&&O.player),n=(l||[]).filter(O=>O.card_type==="game_changer"),x=(l||[]).filter(O=>O.card_type==="formation"),p=(l||[]).filter(O=>O.card_type==="stadium"),{data:h}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(h||[]).forEach(O=>{_[O.name]=O});const{data:u}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(u||[]).forEach(O=>{c[O.id]=O}),p.forEach(O=>{O.stadium_def&&(c[O.stadium_id]=O.stadium_def)});const A=Object.keys($i),m=Object.keys(Oe),I={};a.forEach(O=>{const ee=O.player.id;I[ee]=(I[ee]||0)+1}),new Set(Object.keys(I).map(O=>String(O)));const C=new Set(x.map(O=>O.formation)),j=new Set(n.map(O=>O.gc_type));let D="player",q="Tous",N="",V=!1;function K(){return[...a].sort((O,ee)=>{const xe=Wt.indexOf(O.player.job),le=Wt.indexOf(ee.player.job);return xe!==le?xe-le:(O.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function ae(){return[...f||[]].sort((O,ee)=>{const xe=Wt.indexOf(O.job),le=Wt.indexOf(ee.job);return xe!==le?xe-le:(O.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function ne(){return K().filter(O=>{const ee=O.player,xe=q==="Tous"||ee.job===q,le=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&le})}function J(){return ae().filter(O=>{const ee=q==="Tous"||O.job===q,xe=!N||`${O.firstname} ${O.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(O=>{O.addEventListener("click",()=>{D=O.dataset.tab,q="Tous",N="",V=!1,e.querySelectorAll(".col-tab-btn").forEach(ee=>{const xe=ee.dataset.tab===D;ee.style.borderBottomColor=xe?"var(--green)":"transparent",ee.style.color=xe?"var(--green)":"var(--gray-600)"}),R(),G()})}),R(),G()}function eo(e,t,i){const o=Oe[e]||{icon:"⚡",desc:"Effet spécial."},d=(t==null?void 0:t.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[t==null?void 0:t.color]||s.purple,f=r[t==null?void 0:t.color]||r.purple,a=(t==null?void 0:t.name)||e,n=(t==null?void 0:t.effect)||o.desc,x=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Jt=1e3;function to(e,t,i,o){var _,u,c;const{state:d,toast:s,closeModal:r,navigate:l,refreshProfile:f}=i,a=e.formation,n={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function x(){const A=Ut[a]||{},m=$i[a]||[],I=290,C=360,j=20;function D(N){const V=A[N];return V?{x:V.x*I,y:V.y*C}:null}let q=`<svg width="${I}" height="${C}" viewBox="0 0 ${I} ${C}" xmlns="http://www.w3.org/2000/svg">`;for(const[N,V]of m){const K=D(N),ae=D(V);!K||!ae||(q+=`<line x1="${K.x}" y1="${K.y}" x2="${ae.x}" y2="${ae.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const N of Object.keys(A)){const V=D(N);if(!V)continue;const K=N.replace(/\d+/,""),ae=n[K]||"#555";q+=`<circle cx="${V.x}" cy="${V.y}" r="${j}" fill="${ae}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,q+=`<text x="${V.x}" y="${V.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${K}</text>`}return q+="</svg>",q}const p=t.filter(A=>A.formation===a);p.length;const h=!e.is_for_sale;o(`Formation ${a}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(_=document.getElementById("direct-sell-form-btn"))==null||_.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${a} pour ${Jt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const A=p.find(I=>!I.is_for_sale)||p[0];if(!A){s("Aucune carte à vendre","error");return}await T.from("market_listings").delete().eq("card_id",A.id),await T.from("transfer_history").delete().eq("card_id",A.id);const{error:m}=await T.from("cards").delete().eq("id",A.id);if(m){s(m.message,"error");return}await T.from("users").update({credits:(d.profile.credits||0)+Jt}).eq("id",d.profile.id),await f(),s(`+${Jt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),l("collection")}),(u=document.getElementById("market-sell-form-btn"))==null||u.addEventListener("click",async()=>{const A=parseInt(document.getElementById("sell-price-form").value);if(!A||A<1){s("Prix invalide","error");return}await T.from("cards").update({is_for_sale:!0,sale_price:A}).eq("id",e.id),await T.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:A}),s("Carte mise en vente sur le marché !","success"),r(),l("collection")}),(c=document.getElementById("cancel-sell-form-btn"))==null||c.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),r(),l("collection")})}async function Ni(e,t,i,o){var me,_e,ve,we,Ee;const{state:d,toast:s,openModal:r,closeModal:l,navigate:f,refreshProfile:a}=o,n=e.player,x=t.filter(se=>se.player.id===n.id),p=x.length,h=e.evolution_bonus||0,_=Math.max((Number(n.note_g)||0)+(n.job==="GK"||n.job2==="GK"?h:0),(Number(n.note_d)||0)+(n.job==="DEF"||n.job2==="DEF"?h:0),(Number(n.note_m)||0)+(n.job==="MIL"||n.job2==="MIL"?h:0),(Number(n.note_a)||0)+(n.job==="ATT"||n.job2==="ATT"?h:0)),u=n.rarity||"normal",{data:c}=await T.from("sell_price_configs").select("*").eq("rarity",u).lte("note_min",_).gte("note_max",_).order("note_min",{ascending:!1}).limit(1);((me=c==null?void 0:c[0])==null?void 0:me.price)??Yn[u];const A=n.rarity!=="legende";Qn(n);const m=((n.rarity==="pepite"||n.rarity==="papyte")&&e.current_note!=null?e.current_note:pi(n,n.job))+h,I=n.rarity==="pepite"||n.rarity==="papyte",C=n.job2?(I?nn(e,Jn(n.job2)):pi(n,n.job2))+(pi(n,n.job2)>0?h:0):null;ci[n.job],n.job2&&ci[n.job2];const j=Kn[n.rarity]||"#ccc";Xn[n.country_code]||n.country_code;const D=e.evolution_bonus||0,N=m+D,V=C||0,K=V>0?V+D:0,ae=x.map(se=>se.id);let ne={};if(ae.length){const{data:se}=await T.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",ae).order("transferred_at",{ascending:!0});(se||[]).forEach(pe=>{ne[pe.card_id]||(ne[pe.card_id]=[]),ne[pe.card_id].push(pe)})}const J=se=>{const pe=se.transferred_at?new Date(se.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",de=se.source==="booster"?"Booster":se.price?se.price.toLocaleString("fr"):"—";return`
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${x.map((se,pe)=>{const de=ne[se.id]||[],O=se.is_for_sale,ee=de.length?de[de.length-1]:null,le=(n.rarity==="pepite"||n.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
      ...
      <!-- Carte visuelle -->
      ${zt({...n,_evolution_bonus:h},{width:160})}
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",l);let G=new Set;const re=()=>{const se=G.size,pe=document.getElementById("sell-action-panel");if(!pe)return;pe.style.display=se>0?"block":"none",document.getElementById("sell-selected-count").textContent=se;const de=document.getElementById("evolve-btn");de&&(de.textContent=`⬆️ Évoluer ${se>1?"(+"+se+")":""}`)};document.querySelectorAll(".expl-check").forEach(se=>{se.addEventListener("change",()=>{const pe=se.dataset.id;se.checked?G.add(pe):G.delete(pe);const de=se.closest(".exemplaire-row");de&&(de.style.borderColor=se.checked?"#1A6B3C":"#eee"),re()})}),document.querySelectorAll(".exemplaire-row").forEach(se=>{se.addEventListener("click",pe=>{if(pe.target.closest("button")||pe.target.tagName==="INPUT")return;const de=se.querySelector(".expl-check");de&&!de.disabled&&(de.checked=!de.checked,de.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(se=>{se.addEventListener("click",pe=>{pe.stopPropagation();const de=document.querySelector(`.expl-hist[data-hist="${se.dataset.idx}"]`);de&&(de.style.display=de.style.display==="none"?"flex":"none")})}),(ve=document.getElementById("evolve-btn"))==null||ve.addEventListener("click",async()=>{if(p<=1)return;const se=[...G];if(!se.length)return;if(G.has(e.id)){const ge=document.createElement("div");ge.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ge.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
      ...
      <div style="display:flex;gap:16px;align-items:flex-start">
        ...
        <div style="flex:1;min-width:0">
          ...
          <div style="display:flex;gap:8px;align-items:flex-end;overflow-x:auto;padding-bottom:4px" id="subs-list">
            ${a.map(_=>{const u={..._.player,_evolution_bonus:_.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                ${zt({...u,_evolution_bonus:u._evolution_bonus||0},{width:55,showStad:!0,stadDef:f})}
            ...
            ${t.subs.length<5?'<div id="add-sub-btn" style="width:34px;height:47px;border:2px dashed rgba(255,255,255,0.3);border-radius:5px;display:flex;align-items:center;justify-content:center;font-size:18px;color:rgba(255,255,255,0.4);cursor:pointer;flex-shrink:0">+</div>':""}
          </div>
        </div>
        <!-- Stade : à droite -->
        <div style="flex-shrink:0;text-align:center">
          ...
          <div id="add-stad-btn" style="cursor:pointer">
            ${l?(()=>{var A;const _=t.stadDefMap[l.stadium_id],u=_!=null&&_.image_url?"/icons/"+_.image_url:null,c=((A=_==null?void 0:_.club)==null?void 0:A.logo_url)||null;return`<div style="position:relative;width:65px;height:85px;border-radius:8px;background:linear-gradient(135deg,#1a3a6b,#0a1a3a);border:2px solid #E87722;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;overflow:hidden">
                ${u?`<img src="${u}" style="width:100%;height:100%;object-fit:cover;position:absolute;inset:0;opacity:0.4">`:""}
  ...
  </div>`,io(e,t,d,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",_=>{t.formation=_.target.value;const u=Oi(t.formation),c={};u.forEach(A=>{t.slots[A]&&(c[A]=t.slots[A])}),t.slots=c,bt(e,t,i)}),(p=document.getElementById("add-stad-btn"))==null||p.addEventListener("click",()=>{no(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>ao(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(_=>{_.addEventListener("click",()=>{t.subs=t.subs.filter(u=>u!==_.dataset.removeSub),bt(e,t,i)})}),(h=document.getElementById("add-sub-btn"))==null||h.addEventListener("click",()=>{ro(t,e,i)})}function io(e,t,i,o){var A,m;const d=e.querySelector("#deck-field");if(!d)return;const s=(A=t.stadiumCards)==null?void 0:A.find(I=>I.id===t.stadiumCardId),r=s&&((m=t.stadDefMap)==null?void 0:m[s.stadium_id])||null,l=Ut[t.formation]||{},f=Vi(t.formation)||[],a={};for(const I of i){const C=t.slots[I],j=C?t.playerCards.find(D=>D.id===C):null;j!=null&&j.player?a[I]={...j.player,_evolution_bonus:j.evolution_bonus||0,face:j.player.face||null}:a[I]=null}const n=window.innerWidth>=768,x=n?560:window.innerWidth-32,p=n?680:Math.round((window.innerWidth-32)*1.55),h=n?88:48;let _="";for(const[I,C]of f){const j=l[I],D=l[C];if(!j||!D)continue;const q=j.x*x,N=j.y*p,V=D.x*x,K=D.y*p,ae=a[I],ne=a[C],J=ot(ae,ne);J==="#ff3333"||J==="#cc2222"?_+=`<line x1="${q.toFixed(1)}" y1="${N.toFixed(1)}" x2="${V.toFixed(1)}" y2="${K.toFixed(1)}" stroke="${J}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(_+=`<line x1="${q.toFixed(1)}" y1="${N.toFixed(1)}" x2="${V.toFixed(1)}" y2="${K.toFixed(1)}" stroke="${J}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,_+=`<line x1="${q.toFixed(1)}" y1="${N.toFixed(1)}" x2="${V.toFixed(1)}" y2="${K.toFixed(1)}" stroke="${J}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let u="";const c=Math.round(h*657/507);for(const I of i){const C=l[I];if(!C)continue;const j=a[I],D=C.x*x,q=C.y*p,N=Math.round(D-h/2),V=Math.round(q-c/2);if(j){const K=zt({...j,_evolution_bonus:j._evolution_bonus||0},{width:h,showStad:!0,stadDef:r});u+=`<div style="position:absolute;left:${N}px;top:${V}px;cursor:pointer;z-index:2" class="deck-slot-hit" data-pos="${I}">${K}</div>`}else{const K=I.replace(/\d+/,"");u+=`<div style="position:absolute;left:${N}px;top:${V}px;width:${h}px;height:${c}px;
    ...
    <div style="position:relative;width:${x}px;height:${p}px;margin:0 auto">
      ...
      ${u}
    </div>`,d.querySelectorAll(".deck-slot-hit").forEach(I=>{I.addEventListener("click",()=>oo(I.dataset.pos,t,e,o))})}function no(e,t,i){var r;const{openModal:o,closeModal:d}=i,s=e.stadiumCards||[];o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!s||s.length===0){kt(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>d("decks"));return}const r=s.map(p=>p.id),{data:l}=await T.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),f=[...new Set((l||[]).filter(p=>{var h,_;return((h=p.card)==null?void 0:h.card_type)==="stadium"&&((_=p.card)==null?void 0:_.stadium_id)}).map(p=>p.card.stadium_id))],a={};if(f.length){const{data:p}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(p||[]).forEach(h=>{a[h.id]=h}),(l||[]).forEach(h=>{var _,u;((_=h.card)==null?void 0:_.card_type)==="stadium"&&((u=h.card)!=null&&u.stadium_id)&&(h.card._stadiumDef=a[h.card.stadium_id]||null)})}let n=0;function x(){var j,D,q,N,V,K,ae;const p=s[n],h=(l||[]).filter(ne=>ne.deck_id===p.id),_=h.filter(ne=>{var J;return ne.is_starter&&((J=ne.card)==null?void 0:J.player)}).map(ne=>hi(ne.card,ne.position)),u=h.find(ne=>{var J;return((J=ne.card)==null?void 0:J.card_type)==="formation"}),c=p.formation||((j=u==null?void 0:u.card)==null?void 0:j.formation)||"4-4-2";let A=_.length>=11?ht(_,c):null,m=((D=p.stadium_card)==null?void 0:D.stadium_def)||null;m&&A&&(A=Et(A,m));const I=_.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">
        ${s.map((ne,J)=>`<div style="width:7px;height:7px;border-radius:50%;background:${J===n?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}
      </div>`:""}
      ...
      <div style="padding:10px 14px 16px;flex-shrink:0;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,function(){const J=e.querySelector(".deck-preview-wrap svg");J&&(J.removeAttribute("width"),J.removeAttribute("height"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",J.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),(N=document.getElementById("prev-deck"))==null||N.addEventListener("click",()=>{n>0&&(n--,x())}),(V=document.getElementById("next-deck"))==null||V.addEventListener("click",()=>{n<s.length-1&&(n++,x())}),(K=document.getElementById("validate-deck"))==null||K.addEventListener("click",()=>{if(!I)return;const ne=t.state.params||{};t.navigate("match",{...ne,matchMode:ne.matchMode||i,deckId:p.id})}),(ae=document.getElementById("cancel-deck-select"))==null||ae.addEventListener("click",()=>{Ve(e),d("home")});const C=document.getElementById("deck-swipe-zone");if(C){let ne=0,J=0;C.addEventListener("touchstart",R=>{ne=R.touches[0].clientX,J=R.touches[0].clientY},{passive:!0}),C.addEventListener("touchend",R=>{const G=R.changedTouches[0].clientX-ne,re=R.changedTouches[0].clientY-J;Math.abs(G)<40||Math.abs(G)<Math.abs(re)||(G<0&&n<s.length-1?(n++,x()):G>0&&n>0&&(n--,x()))},{passive:!0})}}x()}function ko(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function Xe(e,t=44,i=58,o=null){return zt(e,{width:t,showStad:!!o,stadDef:o,used:e==null?void 0:e.used})}function it(e,t,i){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let d='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,r)=>{if(d+=Xe(s,40,52),r<o.length-1){const l=ot(s,o[r+1]);d+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(d+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),d+="</div>",d}function Eo(e){return!e||e.length<2?null:`https://flagsapi.com/${e.slice(0,2).toUpperCase()}/flat/64.png`}function To(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function lt(e,t,i,o,d=310,s=310,r=[]){var I;const l=Ut[t]||{},f=Vi(t)||$i[t]||[],a={},n=["ATT","MIL","DEF","GK"];for(const C of n)(e[C]||[]).forEach((D,q)=>{a[`${C}${q+1}`]=D});function x(C){const j=l[C];return j?{x:j.x*d,y:j.y*s}:null}let p="";for(const[C,j]of f){const D=x(C),q=x(j);if(!D||!q)continue;const N=a[C],V=a[j],K=ot(N,V);K==="#00ff88"||K==="#FFD700"?(p+=`<line x1="${D.x.toFixed(1)}" y1="${D.y.toFixed(1)}" x2="${q.x.toFixed(1)}" y2="${q.y.toFixed(1)}"
        ...
        stroke="${K}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const h=48,_=64,u=13,c=16,A={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[C,j]of Object.entries(a)){const D=x(C);if(!D||!j)continue;const q=C.replace(/[0-9]/g,""),N=Ht[q]||"#555",V=r.includes(j.cardId),K=i==="attack"&&(["MIL","ATT"].includes(q)||V)&&!j.used||i==="defense"&&["GK","DEF","MIL"].includes(q)&&!j.used,ae=o.includes(j.cardId);let ne;i==="attack"?ne=V?Math.max(1,Number(j.note_a)||0):q==="MIL"?Number(j.note_m)||0:Number(j.note_a)||0:i==="defense"?ne=q==="GK"?Number(j.note_g)||0:q==="MIL"?Number(j.note_m)||0:Number(j.note_d)||0:ne=Number(q==="GK"?j.note_g:q==="DEF"?j.note_d:q==="MIL"?j.note_m:j.note_a)||0,ne=ne+(j.boost||0),j.stadiumBonus&&(i==="attack"&&(q==="ATT"||q==="MIL")||i==="defense"&&(q==="GK"||q==="DEF"||q==="MIL")?ne+=10:i||(ne+=10));const J=(D.x-h/2).toFixed(1),R=(D.y-_/2).toFixed(1),G=A[j==null?void 0:j.rarity]||A.normal;if(j.used){const se=typeof import.meta<"u"&&"/"||"/",de=`${typeof window<"u"&&((I=window.location)==null?void 0:I.origin)||""}${se}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="#161616"/>`,p+=`<image href="${de}" xlink:href="${de}" x="${J}" y="${R}" width="${h}" height="${_}" preserveAspectRatio="xMidYMid slice"/>`,p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="none" stroke="${G}" stroke-width="2" opacity="0.7"/>`,p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${j.cardId}" data-role="${q}" style="cursor:pointer"/>`;continue}const re=ae?.45:1,me=ae?"#FFD700":G,_e=ae?3:(j==null?void 0:j.rarity)==="legende"||(j==null?void 0:j.rarity)==="légende"||(j==null?void 0:j.rarity)==="pepite"||(j==null?void 0:j.rarity)==="pépite"?2.5:2,ve=_-u-c;p+=`<defs><clipPath id="cp-${C}"><rect x="${J}" y="${(D.y-_/2+u).toFixed(1)}" width="${h}" height="${ve}"/></clipPath></defs>`,p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="${N}" opacity="${re}"/>`;const we=He(j);we&&(p+=`<image href="${we}" xlink:href="${we}" x="${J}" y="${(D.y-_/2+u).toFixed(1)}" width="${h}" height="${ve}" clip-path="url(#cp-${C})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${J}" y="${R}" width="${h}" height="${u}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${D.x.toFixed(1)}" y="${(D.y-_/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(j.name||"").slice(0,9)}</text>`;const Ee=(D.y+_/2-c).toFixed(1);p+=`<rect x="${J}" y="${Ee}" width="${h}" height="${c}" fill="rgba(255,255,255,0.92)"/>`;{const se=Eo(j.country_code);se?p+=`<image href="${se}" xlink:href="${se}" x="${(D.x-20).toFixed(1)}" y="${(D.y+_/2-c+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(D.x-13).toFixed(1)}" y="${(D.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${To(j.country_code)}</text>`;const pe=j.stadiumBonus?"#E87722":"#111";p+=`<text x="${D.x.toFixed(1)}" y="${(D.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${pe}" font-family="Arial Black">${ne}</text>`;const de=ko(j);de?p+=`<image href="${de}" xlink:href="${de}" x="${(D.x+h/2-14).toFixed(1)}" y="${(D.y+_/2-c+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:j.clubName&&(p+=`<text x="${(D.x+14).toFixed(1)}" y="${(D.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(j.clubName||"").slice(0,3).toUpperCase()}</text>`),j.stadiumBonus&&(p+=`<rect x="${(D.x-h/2).toFixed(1)}" y="${(D.y-_/2).toFixed(1)}" width="${h}" height="${_}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="${ae?"rgba(255,255,255,0.12)":"none"}" stroke="${me}" stroke-width="${_e}" opacity="${re}"/>`,K&&(p+=`<rect x="${J}" y="${R}" width="${h}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${ae?"selected":""}" data-card-id="${j.cardId}" data-role="${q}" style="cursor:pointer"/>`)}const m=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-m} ${-m} ${d+m*2} ${s+m*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  ...
  </div>`}async function si(e,t,i,o){var D;const{state:d,navigate:s,toast:r}=t;et(e);const l=d.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!l.deckId)return $o(e,t,i);const f=l.deckId;let a,n,x,p;try{const q=await Promise.all([T.from("decks").select("formation,name,stadium_card_id").eq("id",f).single(),T.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",f).order("slot_order")]);a=q[0].data,x=q[0].error,n=q[1].data,p=q[1].error}catch(q){console.error("[Match] Exception chargement deck:",q),kt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>s("home"));return}if(x||p){console.error("[Match] Erreur Supabase:",x||p),kt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>s("home"));return}const h=(n||[]).filter(q=>{var N;return q.is_starter&&((N=q.card)==null?void 0:N.player)}).map(q=>hi(q.card,q.position)),_=(n||[]).filter(q=>{var N;return!q.is_starter&&((N=q.card)==null?void 0:N.player)}).map(q=>hi(q.card,q.position));if(h.length<11){kt(e,"⚠️",`Deck incomplet (${h.length}/11).`,"Compléter",()=>s("decks"));return}const u=(n||[]).find(q=>{var N;return((N=q.card)==null?void 0:N.card_type)==="formation"}),c=(a==null?void 0:a.formation)||((D=u==null?void 0:u.card)==null?void 0:D.formation)||"4-4-2",{data:A,error:m}=await T.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",d.profile.id).eq("card_type","game_changer"),{data:I}=await T.from("gc_definitions").select("*").eq("is_active",!0),C=(A||[]).map(q=>({...q,_gcDef:(I==null?void 0:I.find(N=>N.name===q.gc_type||N.id===q.gc_definition_id))||null}));let j=null;if(a!=null&&a.stadium_card_id){const{data:q}=await T.from("cards").select("stadium_id").eq("id",a.stadium_card_id).single();if(q!=null&&q.stadium_id){const{data:N}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",q.stadium_id).single();j=N||null}}o({deckId:f,formation:c,starters:h,subsRaw:_,gcCardsEnriched:C,gcDefs:I||[],stadiumDef:j})}async function zo(e,t){const{state:i}=t,d=(i.params||{}).matchMode||"vs_ai_easy",s=d.replace("vs_ai_",""),r=d;await si(e,t,d,async({deckId:l,formation:f,starters:a,subsRaw:n,gcCardsEnriched:x,gcDefs:p,stadiumDef:h})=>{try{let _=ht(a,f);h&&(_=Et(_,h),jt(n,h));const u=await So(f,s),c=u.lines||u,A=async m=>{try{const{data:I,error:C}=await T.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:l,status:"in_progress"}).select().single();if(C){console.error("[MatchIA] Erreur création match:",C),kt(e,"⚠️","Impossible de créer le match ("+C.message+").","Retour",()=>t.navigate("home"));return}const j=u.stadiumDef||null;j&&c&&(Et(c,j),jt(u.subs||[],j));const D={gcDefs:p||[],matchId:I==null?void 0:I.id,mode:r,difficulty:s,formation:f,homeTeam:_,aiTeam:c,homeSubs:n,subsUsed:0,maxSubs:Math.min(n.length,3),aiSubs:u.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((u.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:u.gcCards||[],aiUsedGc:[],aiStadiumDef:j,homeScore:0,aiScore:0,gcCards:m,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Lo(e,D,t)}catch(I){console.error("[MatchIA] Exception launchMatch:",I),kt(e,"⚠️","Erreur au lancement du match : "+I.message,"Retour",()=>t.navigate("home"))}};if(!x.length){A([]);return}ai(e,x,A)}catch(_){console.error("[MatchIA] Exception setup:",_),kt(e,"⚠️","Erreur de préparation du match : "+_.message,"Retour",()=>t.navigate("home"))}})}async function So(e,t){var c;const{data:i}=await T.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Ao(e),subs:[],gcCards:[],stadiumDef:null};const o=Mt[e]||Mt["4-4-2"],d={GK:[],DEF:[],MIL:[],ATT:[]},s=new Set;function r(A,m,I){var C,j;return s.add(A.id),{cardId:"ai-"+A.id+"-"+I,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:Number(A.note_g)||0,note_d:Number(A.note_d)||0,note_m:Number(A.note_m)||0,note_a:Number(A.note_a)||0,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:((C=A.clubs)==null?void 0:C.encoded_name)||null,clubLogo:((j=A.clubs)==null?void 0:j.logo_url)||null,boost:0,used:!1,_line:m}}for(const A of["GK","DEF","MIL","ATT"]){const m=i.filter(q=>q.job===A&&!s.has(q.id)),I=i.filter(q=>q.job!==A&&!s.has(q.id)),C=[...m,...I],j=[];for(let q=0;q<o[A];q++){const N=C[q];N&&j.push(r(N,A,q))}const D=st(j.length);j.forEach((q,N)=>{q._col=D[N]}),d[A]=j}const f=i.filter(A=>!s.has(A.id)).slice(0,5).map((A,m)=>r(A,A.job,100+m)),x=Object.keys(Oe).sort(()=>Math.random()-.5).slice(0,3).map((A,m)=>{var I,C;return{id:"ai-gc-"+m,gc_type:A,name:((I=Oe[A])==null?void 0:I.name)||A,icon:((C=Oe[A])==null?void 0:C.icon)||"⚡"}}),p=Object.values(d).flat(),h={};p.forEach(A=>{A.club_id&&(h[A.club_id]=(h[A.club_id]||0)+1)});const _=(c=Object.entries(h).sort((A,m)=>m[1]-A[1])[0])==null?void 0:c[0];let u=null;if(_){const{data:A}=await T.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",_).single();A&&(u={club_id:A.id,country_code:null,name:A.encoded_name+" Stadium",club:{encoded_name:A.encoded_name,logo_url:A.logo_url}})}return{lines:d,subs:f,gcCards:x,stadiumDef:u}}function Ao(e){const t=Mt[e]||Mt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let d=0;for(const s of["GK","DEF","MIL","ATT"]){const r=[];for(let f=0;f<t[s];f++){const a=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+d,id:"fake-"+d,firstname:"IA",name:o[d%o.length],country_code:"XX",club_id:null,job:s,job2:null,note_g:s==="GK"?a:2,note_d:s==="DEF"?a:2,note_m:s==="MIL"?a:2,note_a:s==="ATT"?a:2,rarity:"normal",boost:0,used:!1,_line:s}),d++}const l=st(r.length);r.forEach((f,a)=>{f._col=l[a]}),i[s]=r}return i}function Lo(e,t,i){var o;e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${m.map((q,N)=>{const V=N<m.length-1?ot(q,m[N+1]):null,K=!V||V==="#ff3333"||V==="#cc2222",ae=V==="#00ff88"?"+2":V==="#FFD700"?"+1":"";l(q,D),q.stadiumBonus||D&&(D.club_id&&String(q.club_id)===String(D.club_id)||D.country_code&&(q.country_code,D.country_code));const ne=q.evolution_bonus||q._evolution_bonus||0;return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const re=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const G=t.log[t.log.length-1];return G?'<div style="padding:2px 4px">'+Mo(G)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const f=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",f),setTimeout(f,3500)}async function Gt(e,t,i){var n,x;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:o}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,r=d?"victoire":s?"nul":"defaite",l=Hn(t.mode,r);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const f={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};d?f.wins=(o.profile.wins||0)+1:s?f.draws=(o.profile.draws||0)+1:f.losses=(o.profile.losses||0)+1,await T.from("users").update(f).eq("id",o.profile.id),await i.refreshProfile();const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",a.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const C=async(N=!0)=>{_=!0,u&&(T.removeChannel(u),u=null),N&&await T.rpc("cancel_matchmaking",{p_user_id:x.profile.id}).catch(()=>{})};(q=document.getElementById("mm-cancel"))==null||q.addEventListener("click",async()=>{try{await C(!0)}catch{}Ve(e),p("home")});const j=async(N,V,K)=>{if(_)return;_=!0,u&&(T.removeChannel(u),u=null);const ae=document.getElementById("mm-status");ae&&(ae.textContent="Adversaire trouvé !"),await new Promise(ne=>setTimeout(ne,600)),e.isConnected&&gn(e,t,N,K,r,l,a,n,f)};if(a){const N=[{range:50,delay:0},{range:100,delay:15e3},{range:200,delay:3e4},{range:400,delay:45e3},{range:800,delay:6e4}];let V=0,K=!1;const ae=async()=>{if(_||K)return;const{range:ne}=N[V],J=document.getElementById("mm-range");J&&(J.textContent=`Plage MMR : ±${ne}`);const{data:R,error:G}=await T.rpc("try_matchmake_ranked",{p_user_id:x.profile.id,p_deck_id:i,p_mmr:c,p_range:ne});if(console.log("[Ranked] try_matchmake_ranked result:",R,"error:",JSON.stringify(G)),_)return;if(G||!(R!=null&&R.success)){h("Erreur matchmaking ranked","error"),Ve(e),p("home");return}if(R.matched){K=!0,j(R.match_id,R.opponent_id,!1);return}const re=document.getElementById("mm-status");if(re&&(re.textContent="En attente d'un adversaire..."),u||(u=T.channel("matchmaking-"+x.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${x.profile.id}`},me=>{const _e=me.new;_e.status==="matched"&&_e.match_id&&!K&&(K=!0,j(_e.match_id,_e.matched_with,!0))}).subscribe()),V<N.length-1){const me=N[V+1].delay-N[V].delay;V++,setTimeout(()=>{!_&&!K&&ae()},me)}};await ae()}else{const{data:N,error:V}=await T.rpc("try_matchmake",{p_user_id:x.profile.id,p_deck_id:i});if(V||!(N!=null&&N.success)){h("Erreur de matchmaking","error"),Ve(e),p("home");return}if(N.matched){j(N.match_id,N.opponent_id,!1);return}const K=document.getElementById("mm-status");K&&(K.textContent="En attente d'un autre joueur..."),u=T.channel("matchmaking-"+x.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${x.profile.id}`},ae=>{const ne=ae.new;ne.status==="matched"&&ne.match_id&&j(ne.match_id,ne.matched_with,!0)}).subscribe()}}async function Ko(e,t,i){const{state:o,navigate:d,toast:s}=t;try{(T.getChannels?T.getChannels():[]).forEach(a=>{const n=a.topic||"";(n.includes("matchmaking")||n.includes("pvp-match")||n.includes("friend-invite"))&&T.removeChannel(a)})}catch{}const{data:r}=await T.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!r){s("Match introuvable","error"),d("home");return}if(r.status==="finished"){s("Ce match est terminé","info"),d("home");return}const l=r.home_id===o.profile.id;gn(e,t,i,l,[],[])}async function gn(e,t,i,o,d=[],s=[],r=!1,l=null,f=null){const{state:a,navigate:n,toast:x}=t,p=o?"p1":"p2",h=o?"p2":"p1",_=(d||[]).map($=>$.id),u=(d||[]).map($=>({id:$.id,gc_type:$.gc_type,_gcDef:$._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:c}=await T.from("matches").select("*").eq("id",i).single();if(!c){x("Match introuvable","error"),n("home");return}async function A(){var W,te;console.log("[PvP] buildGameState match:",{id:c.id,home_deck_id:c.home_deck_id,away_deck_id:c.away_deck_id,mode:c.mode,is_ranked:c.is_ranked});const[{data:$,error:g},{data:y,error:b},{data:v},{data:w}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:c.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:c.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",c.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",c.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",g==null?void 0:g.message,"p2:",b==null?void 0:b.message,"p1D:",(W=$==null?void 0:$.starters)==null?void 0:W.length,"p2D:",(te=y==null?void 0:y.starters)==null?void 0:te.length);const k=Z=>{const fe=Number(Z.evolution_bonus)||0;return{cardId:Z.card_id,position:Z.position,id:Z.id,firstname:Z.firstname,name:Z.surname_encoded,country_code:Z.country_code,club_id:Z.club_id,job:Z.job,job2:Z.job2,note_g:(Number(Z.note_g)||0)+(Z.job==="GK"||Z.job2==="GK"&&Number(Z.note_g)>0?fe:0),note_d:(Number(Z.note_d)||0)+(Z.job==="DEF"||Z.job2==="DEF"&&Number(Z.note_d)>0?fe:0),note_m:(Number(Z.note_m)||0)+(Z.job==="MIL"||Z.job2==="MIL"&&Number(Z.note_m)>0?fe:0),note_a:(Number(Z.note_a)||0)+(Z.job==="ATT"||Z.job2==="ATT"&&Number(Z.note_a)>0?fe:0),evolution_bonus:fe,rarity:Z.rarity,skin:Z.skin,hair:Z.hair,hair_length:Z.hair_length,clubName:Z.club_encoded_name||null,clubLogo:Z.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},z=(($==null?void 0:$.starters)||[]).map(Z=>k(Z)),E=((y==null?void 0:y.starters)||[]).map(Z=>k(Z)),L=($==null?void 0:$.formation)||"4-4-2",S=(y==null?void 0:y.formation)||"4-4-2";let M=ht(z,L),F=ht(E,S);const Y=(($==null?void 0:$.subs)||[]).map(Z=>k(Z)),X=((y==null?void 0:y.subs)||[]).map(Z=>k(Z)),U=($==null?void 0:$.stadium_def)||(o?f:null),P=(y==null?void 0:y.stadium_def)||(o?null:f);return U&&(M=Et(M,U),jt(Y,U)),P&&(F=Et(F,P),jt(X,P)),{p1Team:M,p2Team:F,p1Subs:Y,p2Subs:X,p1Formation:L,p2Formation:S,p1Name:(v==null?void 0:v.club_name)||(v==null?void 0:v.pseudo)||"Joueur 1",p2Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?_:[],gc_p2:o?[]:_,gcCardsFull_p1:o?u:[],gcCardsFull_p2:o?[]:u,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let m=c.game_state&&Object.keys(c.game_state).length?c.game_state:null;if(console.log("[PvP] init - amIHome:",o,"gameState exists:",!!m,"match.status:",c.status,"home_id:",c.home_id,"away_id:",c.away_id,"myId:",a.profile.id),!m)if(o){m=await A(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((m==null?void 0:m.p1Team)||{}));const{data:$}=await T.from("matches").select("game_state").eq("id",i).single();!($!=null&&$.game_state)||!Object.keys($.game_state).length?await T.from("matches").update({game_state:m,turn_user_id:c.home_id}).eq("id",i):m=$.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let $=0;$<30&&!m;$++){await new Promise(y=>setTimeout(y,400));const{data:g}=await T.from("matches").select("game_state").eq("id",i).single();g!=null&&g.game_state&&Object.keys(g.game_state).length&&(m=g.game_state),$%5===0&&console.log("[PvP] away - poll",$,"game_state:",!!(g!=null&&g.game_state))}if(!m){x("Erreur de synchronisation","error"),n("home");return}m.gc_p2=_,m.gcCardsFull_p2=u,await T.from("matches").update({game_state:m}).eq("id",i)}let I=!1,C=null,j=!1;const D=new Set,q=new Set;async function N($){var S,M;try{T.removeChannel(V)}catch{}const g=m[p+"Score"]||0,y=m[h+"Score"]||0;let b,v;$.winner_id?(b=$.winner_id===a.profile.id,v=!1):$.forfeit?(b=g>y,v=!1):(v=g===y,b=g>y);let w="";if(r&&o)try{const{data:F}=await T.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.home_id).single(),{data:Y}=await T.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.away_id).single();if(F&&Y){const X=b?1:v?.5:0,U=1-X,P=F.placement_matches<10,W=Y.placement_matches<10,te=Ii(F.mmr,F.mmr_deviation,F.mmr_volatility,Y.mmr,Y.mmr_deviation,X===1?1:X===0?0:.5,P),Z=Ii(Y.mmr,Y.mmr_deviation,Y.mmr_volatility,F.mmr,F.mmr_deviation,U===1?1:U===0?0:.5,W);await T.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:v?null:b?c.home_id:c.away_id,p_home_id:c.home_id,p_away_id:c.away_id,p_home_delta:te.delta,p_away_delta:Z.delta,p_home_new_rd:te.newRd,p_away_new_rd:Z.newRd,p_home_new_vol:te.newSigma,p_away_new_vol:Z.newSigma});const fe=te.delta,ye=te.newMmr,be=Nt(ye),ke=fe>=0?"+":"",Be=fe>=0?"#4caf50":"#ff6b6b",Fe=Nt(F.mmr);w=`
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct($,m[p+"Formation"],Ne,L,300,300,fe)}
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-end;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
              ${(Q.homePlayers||[]).map(oe=>at(oe)).join("")}
            </div>
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
        ...
        </div>`}if(k&&((oe=m.pendingAttack)!=null&&oe.players)){const he=m.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function Pe(){const Q=e.querySelector(".match-screen");if(!Q)return;const H=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);Q.style.height=H+"px",Q.style.minHeight=H+"px",Q.style.maxHeight=H+"px",Q.style.overflow="hidden";const oe=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");oe&&he&&(he.style.paddingBottom=oe.offsetHeight+"px")}if(Pe(),setTimeout(Pe,120),setTimeout(Pe,400),j||(j=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Pe),window.visualViewport.addEventListener("scroll",Pe)),window.addEventListener("resize",Pe)),function(){const H=e.querySelector(".terrain-wrapper svg");H&&(H.removeAttribute("width"),H.removeAttribute("height"),H.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",H.setAttribute("viewBox","-26 -26 352 352"),H.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(Q=>{Q.addEventListener("click",()=>{if(!k&&!z)return;const H=Q.dataset.cardId,oe=Q.dataset.role,he=($[oe]||[]).find(tt=>tt.cardId===H);if(!he||he.used)return;const $e=fe.includes(H);if(k&&!["MIL","ATT"].includes(oe)&&!$e)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const Qe=m["selected_"+p],Ze=Qe.findIndex(tt=>tt.cardId===H);Ze>-1?Qe.splice(Ze,1):Qe.length<3&&Qe.push({...he,_role:oe}),me()})}),e.querySelectorAll(".match-used-hit").forEach(Q=>{Q.addEventListener("click",()=>O(Q.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(Q=>{Q.addEventListener("click",()=>O())}),(We=e.querySelector("#pvp-sub-open"))==null||We.addEventListener("click",()=>O()),e.querySelectorAll(".pvp-gc-mini").forEach(Q=>{Q.addEventListener("click",()=>pe(Q.dataset.gcId,Q.dataset.gcType))}),(nt=e.querySelector("#pvp-boost-card"))==null||nt.addEventListener("click",()=>de()),(pt=e.querySelector("#pvp-action"))==null||pt.addEventListener("click",Q=>{k?Q.currentTarget.dataset.pass==="1"||!Te(p)?ge():ie():z&&ue()}),(ut=e.querySelector("#pvp-quit"))==null||ut.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&ae()}),(ft=e.querySelector("#pvp-view-opp"))==null||ft.addEventListener("click",()=>xe()),(ce=e.querySelector("#pvp-toggle-history"))==null||ce.addEventListener("click",()=>le()),C&&(clearInterval(C),C=null),(k||z)&&!I){let Q=30,H=!1;const oe=()=>document.getElementById("pvp-timer"),he=()=>{oe()&&(oe().textContent=Q+"s",oe().style.color=H?"#ff4444":"#fff")};he(),C=setInterval(()=>{Q--,Q<0?H?(clearInterval(C),C=null,k&&!Te(p)?ge():ae()):(H=!0,Q=15,he()):he()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <div style="width:min(90vw,420px)">${lt(m[h+"Team"],m[h+"Formation"],null,[],300,300)}</div>
    </div>`,p==="p1"&&setTimeout(async()=>{await K({phase:"midfield"})},5e3)}let ve=!1;function we(){if(ve)return;const $=m[p+"Team"].MIL||[],g=m[h+"Team"].MIL||[];function y(P){return P.reduce((W,te)=>W+Se(te,"MIL"),0)}function b(P){let W=0;for(let te=0;te<P.length-1;te++){const Z=ot(P[te],P[te+1]);Z==="#00ff88"?W+=2:Z==="#FFD700"&&(W+=1)}return W}const v=y($)+b($),w=y(g)+b(g),k=v>=w;function z(P,W,te){return`<div id="duel-row-${te}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${P.map((Z,fe)=>{const ye=fe<P.length-1?ot(Z,P[fe+1]):null,be=!ye||ye==="#ff3333"||ye==="#cc2222",ke=ye==="#00ff88"?"+2":ye==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${te}" data-idx="${fe}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(L=v.querySelector("#pvp-end-home"))==null||L.addEventListener("click",()=>{v.remove(),Ve(e),l("home")})}const N=T.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},B=>{const $=B.new;try{if($.status==="finished"||$.forfeit){if(c)return;c=!0,I&&(clearInterval(I),I=null),$.game_state&&(u=$.game_state),q($);return}if($.game_state){const g=u;u=$.game_state;const y=u._lastGC;if(y&&y.seq&&!D.has(y.seq)&&(D.add(y.seq),y.by!==a)){Ee(y.type,y.by,()=>re());return}const b=g[a+"Score"]||0,v=g[n+"Score"]||0,w=u[a+"Score"]||0,k=u[n+"Score"]||0,z=w>b,E=k>v;if((z||E)&&!j.has(u.round)){j.add(u.round);const L=[...u.log||[]].reverse().find(M=>M.isGoal),S=((L==null?void 0:L.homePlayers)||[]).map(M=>({name:M.name,note:M.note,portrait:M.portrait,job:M.job}));we(S,w,k,z,()=>re());return}re()}}catch(g){console.error("[PvP] crash:",g)}}).subscribe();async function V(B){Object.assign(u,B),u.lastActionAt=new Date().toISOString();const{error:$}=await T.from("matches").update({game_state:u}).eq("id",i);$&&f("Erreur de synchronisation","error");try{re()}catch(g){console.error("[PvP] renderPvpScreen crash:",g)}}async function K(){if(c)return;c=!0,I&&(clearInterval(I),I=null);const B=o?h.away_id:h.home_id,$=o?"p2":"p1",g=o?"p1":"p2",y={...u,[$+"Score"]:3,[g+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:B,home_score:y.p1Score||0,away_score:y.p2Score||0,game_state:y}).eq("id",i)}catch{}try{T.removeChannel(N)}catch{}setTimeout(()=>{Ve(e),l("home")},800)}const ae={BOOST_STAT:({value:B=1,count:$=1,roles:g=[]},y,b)=>{const v=y[a+"Team"],w=Object.entries(v).filter(([k])=>!g.length||g.includes(k)).flatMap(([k,z])=>z.filter(E=>!E.used).map(E=>({...E,_line:k})));if(!w.length){y.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),b(y);return}ne(w,$,`Choisir ${$} joueur(s) à booster (+${B})`,k=>{k.forEach(z=>{const E=(v[z._line]||[]).find(L=>L.cardId===z.cardId);E&&(E.boost=(E.boost||0)+B,y.log.push({text:`⚡ +${B} sur ${E.name}`,type:"info"}))}),y[a+"Team"]=v,b(y)})},DEBUFF_STAT:({value:B=1,count:$=1,roles:g=[],target:y="ai"},b,v)=>{const w=y==="home"?a:n,k=b[w+"Team"],z=y==="home"?"allié":"adverse",E=Object.entries(k).filter(([L])=>!g.length||g.includes(L)).flatMap(([L,S])=>S.map(M=>({...M,_line:L})));if(!E.length){b.log.push({text:`🎯 Aucun joueur ${z}`,type:"info"}),v(b);return}ne(E,$,`Choisir ${$} joueur(s) ${z}(s) (-${B})`,L=>{L.forEach(S=>{const M=(k[S._line]||[]).find(F=>F.cardId===S.cardId);M&&(M.boost=(M.boost||0)-B,b.log.push({text:`🎯 -${B} sur ${M.name}`,type:"info"}))}),b[w+"Team"]=k,v(b)})},GRAY_PLAYER:({count:B=1,roles:$=[],target:g="ai"},y,b)=>{const v=g==="home"?a:n,w=y[v+"Team"],k=g==="home"?"allié":"adverse",z=Object.entries(w).filter(([E])=>!$.length||$.includes(E)).flatMap(([E,L])=>L.filter(S=>!S.used).map(S=>({...S,_line:E})));if(!z.length){y.log.push({text:`❌ Aucun joueur ${k}`,type:"info"}),b(y);return}ne(z,B,`Choisir ${B} joueur(s) ${k}(s) à exclure`,E=>{const L="usedCardIds_"+v,S=new Set(y[L]||[]);E.forEach(M=>{const F=(w[M._line]||[]).find(Y=>Y.cardId===M.cardId);F&&(F.used=!0,S.add(M.cardId),y.log.push({text:`❌ ${F.name} exclu !`,type:"info"}))}),y[L]=[...S],y[v+"Team"]=w,b(y)})},REVIVE_PLAYER:({count:B=1,roles:$=[]},g,y)=>{const b=g[a+"Team"],v=Object.entries(b).filter(([w])=>!$.length||$.includes(w)).flatMap(([w,k])=>k.filter(z=>z.used).map(z=>({...z,_line:w})));if(!v.length){g.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),y(g);return}ne(v,B,`Choisir ${B} joueur(s) à ressusciter`,w=>{w.forEach(k=>{const z=(b[k._line]||[]).find(E=>E.cardId===k.cardId);z&&(z.used=!1,g.log.push({text:`💫 ${z.name} ressuscité !`,type:"info"}))}),g[a+"Team"]=b,y(g)})},REMOVE_GOAL:({},B,$)=>{const g=n+"Score";B[g]>0?(B[g]--,B.log.push({text:"🚫 Dernier but annulé !",type:"info"})):B.log.push({text:"🚫 Aucun but à annuler",type:"info"}),$(B)},ADD_GOAL_DRAW:({},B,$)=>{B[a+"Score"]===B[n+"Score"]?(B[a+"Score"]++,B.log.push({text:"🎯 But bonus !",type:"info"})):B.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),$(B)},ADD_SUB:({value:B=1},$,g)=>{$.maxSubs=($.maxSubs||3)+B,$.log.push({text:`🔄 +${B} remplacement(s)`,type:"info"}),g($)},CUSTOM:({},B,$)=>$(B)};function ne(B,$,g,y){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var z,E;const k=B.map(L=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",M=Se(L,L._line)+(L.boost||0),Y=v.find(U=>U.cardId===L.cardId)?"#FFD700":"rgba(255,255,255,0.25)",X=L.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Y};background:${S};overflow:hidden;cursor:pointer;${X}">
        ...
        </div>`,(z=b.querySelector("#pp-close"))==null||z.addEventListener("click",()=>b.remove()),b.querySelectorAll(".pp-item").forEach(L=>{L.addEventListener("click",()=>{const S=L.dataset.cid,M=B.find(Y=>Y.cardId===S),F=v.findIndex(Y=>Y.cardId===S);M&&(F>-1?v.splice(F,1):v.length<$&&v.push(M),w())})}),(E=b.querySelector("#pp-confirm"))==null||E.addEventListener("click",()=>{b.remove(),y(v)})}w(),document.body.appendChild(b)}async function J(B,$){const y=(u["gcCardsFull_"+a]||[]).find(k=>k.id===B),b=(y==null?void 0:y._gcDef)||(u.gcDefs||[]).find(k=>{var z;return k.name===$||((z=k.name)==null?void 0:z.toLowerCase().trim())===($==null?void 0:$.toLowerCase().trim())}),v=[...u["usedGc_"+a]||[],B],w={type:$,by:a,seq:(u._gcAnimSeq||0)+1};D.add(w.seq),Ee($,a,async()=>{if(b!=null&&b.effect_type&&b.effect_type!=="CUSTOM"){const z=ae[b.effect_type];if(z){const E={...u};z(b.effect_params||{},E,async L=>{L["usedGc_"+a]=v,L._lastGC=w,L._gcAnimSeq=w.seq,await V(L)});return}}const k={...u};switch($){case"Remplacement+":k.maxSubs=(k.maxSubs||3)+1,k.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const z=n+"Score";k[z]>0&&(k[z]--,k.log.push({text:"🚫 But annulé",type:"info"}));break}}k["usedGc_"+a]=v,k._lastGC=w,k._gcAnimSeq=w.seq,await V(k)})}function R(B,$){const g="usedCardIds_"+B,y=new Set(u[g]||[]);$.forEach(b=>y.add(b)),u[g]=[...y]}function G(){for(const B of["p1","p2"]){const $=new Set(u["usedCardIds_"+B]||[]),g=u[B+"Team"];if(g)for(const y of["GK","DEF","MIL","ATT"])(g[y]||[]).forEach(b=>{b.used=$.has(b.cardId)})}}function re(){var Pe,We,nt,pt,ut,ft;if(u.phase==="reveal")return me();if(u.phase==="midfield")return ve();if(u.phase==="finished")return ze();const B=u[a+"Team"],$=u[n+"Team"];G();const g=u[a+"Score"],y=u[n+"Score"],b=u[a+"Name"],v=u[n+"Name"],w=u.phase===a+"-attack",k=u.phase===a+"-defense",z=Array.isArray(u["selected_"+a])?u["selected_"+a]:[],E=z.map(ce=>ce.cardId),L=window.innerWidth>=700,S=u[a+"Subs"]||[],M=u["usedSubIds_"+a]||[],F=S.filter(ce=>!M.includes(ce.cardId)),Y=u["gcCardsFull_"+a]||[],X=u["usedGc_"+a]||[],U=Y.filter(ce=>!X.includes(ce.id)),P=u.boostOwner===a&&!u.boostUsed,W=!["GK","DEF","MIL","ATT"].some(ce=>($[ce]||[]).some(Q=>!Q.used)),te=[...B.MIL||[],...B.ATT||[]].filter(ce=>!ce.used),Z=w&&W&&te.length===0?[...B.GK||[],...B.DEF||[]].filter(ce=>!ce.used).map(ce=>ce.cardId):[];function fe(ce,Q,H){var mt,$t;const oe=ce._gcDef,he={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[oe==null?void 0:oe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",$e={purple:"#b06ce0",light_blue:"#00d4ef"}[oe==null?void 0:oe.color]||"#b06ce0",Qe=(oe==null?void 0:oe.name)||ce.gc_type,Ze=(oe==null?void 0:oe.effect)||((mt=Oe[ce.gc_type])==null?void 0:mt.desc)||"",tt=oe!=null&&oe.image_url?`/icons/${oe.image_url}`:null,rt=(($t=Oe[ce.gc_type])==null?void 0:$t.icon)||"⚡",wt=Math.round(H*.22),_t=Math.round(H*.22),dt=H-wt-_t,gt=Qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ce.id}" data-gc-type="${ce.gc_type}"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct(B,u[a+"Formation"],Ae,E,300,300,Z)}
      </div>
        ...
        </div>`}if(w&&((H=u.pendingAttack)!=null&&H.players)){const oe=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function Re(){const ce=e.querySelector(".match-screen");if(!ce)return;const Q=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ce.style.height=Q+"px",ce.style.minHeight=Q+"px",ce.style.maxHeight=Q+"px",ce.style.overflow="hidden";const H=e.querySelector("#mobile-action-bar"),oe=e.querySelector("#mobile-play-area");H&&oe&&(oe.style.paddingBottom=H.offsetHeight+"px")}if(Re(),setTimeout(Re,120),setTimeout(Re,400),C||(C=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Re),window.visualViewport.addEventListener("scroll",Re)),window.addEventListener("resize",Re)),function(){const Q=e.querySelector(".terrain-wrapper svg");Q&&(Q.removeAttribute("width"),Q.removeAttribute("height"),Q.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Q.setAttribute("viewBox","-26 -26 352 352"),Q.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(ce=>{ce.addEventListener("click",()=>{if(!w&&!k)return;const Q=ce.dataset.cardId,H=ce.dataset.role,oe=(B[H]||[]).find(Ze=>Ze.cardId===Q);if(!oe||oe.used)return;const he=Z.includes(Q);if(w&&!["MIL","ATT"].includes(H)&&!he)return;Array.isArray(u["selected_"+a])||(u["selected_"+a]=[]);const $e=u["selected_"+a],Qe=$e.findIndex(Ze=>Ze.cardId===Q);Qe>-1?$e.splice(Qe,1):$e.length<3&&$e.push({...oe,_role:H}),re()})}),e.querySelectorAll(".match-used-hit").forEach(ce=>{ce.addEventListener("click",()=>de(ce.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ce=>{ce.addEventListener("click",()=>de())}),(Pe=e.querySelector("#pvp-sub-open"))==null||Pe.addEventListener("click",()=>de()),e.querySelectorAll(".pvp-gc-mini").forEach(ce=>{ce.addEventListener("click",()=>se(ce.dataset.gcId,ce.dataset.gcType))}),(We=e.querySelector("#pvp-boost-card"))==null||We.addEventListener("click",()=>pe()),(nt=e.querySelector("#pvp-action"))==null||nt.addEventListener("click",ce=>{w?ce.currentTarget.dataset.pass==="1"||!Ce(a)?le():ge():k&&ie()}),(pt=e.querySelector("#pvp-quit"))==null||pt.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&K()}),(ut=e.querySelector("#pvp-view-opp"))==null||ut.addEventListener("click",()=>ee()),(ft=e.querySelector("#pvp-toggle-history"))==null||ft.addEventListener("click",()=>xe()),I&&(clearInterval(I),I=null),(w||k)&&!c){let ce=30,Q=!1;const H=()=>document.getElementById("pvp-timer"),oe=()=>{H()&&(H().textContent=ce+"s",H().style.color=Q?"#ff4444":"#fff")};oe(),I=setInterval(()=>{ce--,ce<0?Q?(clearInterval(I),I=null,w&&!Ce(a)?le():K()):(Q=!0,ce=15,oe()):oe()},1e3)}}function me(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let z=!1;const E=()=>{z||(z=!0,v.remove(),setTimeout(()=>b(),50))};v.addEventListener("click",E),setTimeout(E,3500)}function Ee(B,$,g){var X,U;const y=(u.gcDefs||[]).find(P=>{var W;return P.name===B||((W=P.name)==null?void 0:W.toLowerCase().trim())===(B==null?void 0:B.toLowerCase().trim())}),b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",w=(y==null?void 0:y.name)||B,k=(y==null?void 0:y.effect)||((X=Oe[B])==null?void 0:X.desc)||"",z=y!=null&&y.image_url?`/icons/${y.image_url}`:null,E=((U=Oe[B])==null?void 0:U.icon)||"⚡",S=$===a?"Vous":u[$+"Name"]||"Adversaire",M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",M.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(fe=S.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>S.remove()),(ye=S.querySelector("#pout-up"))==null||ye.addEventListener("click",()=>{k>0&&(k--,M())}),(be=S.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{k<v.length-1&&(k++,M())}),(ke=S.querySelector("#pin-up"))==null||ke.addEventListener("click",()=>{E>0&&(E--,M())}),(Be=S.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{E<w.length-1&&(E++,M())});const Z=(Me,je,Ae,Ne)=>{const Ue=S.querySelector("#"+Me);if(!Ue)return;let Ye=0;Ue.addEventListener("touchstart",Ke=>{Ye=Ke.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ke=>{const Re=Ke.changedTouches[0].clientY-Ye;if(Math.abs(Re)<30)return;const Pe=je();Re<0&&Pe<Ne-1?(Ae(Pe+1),M()):Re>0&&Pe>0&&(Ae(Pe-1),M())},{passive:!0})};Z("pin-panel",()=>E,Me=>E=Me,w.length),Z("pout-panel",()=>k,Me=>k=Me,v.length),(Fe=S.querySelector("#psub-confirm"))==null||Fe.addEventListener("click",async Me=>{if(Me.preventDefault(),Me.stopPropagation(),L)return;L=!0;const je=v[k],Ae=w[E];if(!je||!Ae)return;const Ne=je._line,Ue=(g[Ne]||[]).findIndex(Re=>Re.cardId===je.cardId);if(Ue===-1){f("Erreur : joueur introuvable","error"),S.remove();return}const Ye={...Ae,_line:Ne,position:je.position,used:!1,boost:0};g[Ne].splice(Ue,1,Ye);const Ke=[...y,Ae.cardId];S.remove(),O(je,Ae,async()=>{await V({[a+"Team"]:g,[n+"Team"]:u[n+"Team"],["usedSubIds_"+a]:Ke})})})}document.body.appendChild(S),M()}function O(B,$,g){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(z,E,L)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild($),(y=$.querySelector("#pvp-hist-close"))==null||y.addEventListener("click",()=>$.remove())}async function le(){if(u.phase!==a+"-attack")return;const B=a==="p1"?"p2":"p1",$=(u.round||0)+1,g=[...u.log||[]];g.push({type:"info",text:`⏭️ ${u[a+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const y=Te(u),b=Ce(B),v=y||!b?"finished":B+"-attack";await V({["selected_"+a]:[],modifiers:{...u.modifiers,[a]:{}},pendingAttack:null,phase:v,attacker:B,round:$,log:g}),v==="finished"&&await Ge(u)}async function ge(){const B=u[a+"Team"],$=!["GK","DEF","MIL","ATT"].some(v=>(u[n+"Team"][v]||[]).some(w=>!w.used)),g=(u["selected_"+a]||[]).map(v=>{const w=(B[v._role]||[]).find(M=>M.cardId===v.cardId)||v,k=$&&["GK","DEF"].includes(v._role),z=B[v._role]||[],E=z.findIndex(M=>M.cardId===v.cardId),L=st(z.length),S=E>=0?L[E]:w._col??1;return{...w,_line:v._role,_col:S,...k?{note_a:Math.max(1,Number(w.note_a)||0)}:{}}});if(!g.length)return;const y=Kt(g,u.modifiers[a]||{});R(a,g.map(v=>v.cardId)),g.forEach(v=>{const w=(B[v._role]||[]).find(k=>k.cardId===v.cardId);w&&(w.used=!0)}),u["selected_"+a]=[],re();const b=[...u.log||[]];if($){const v=(u[a+"Score"]||0)+1,w=g.map(S=>({name:S.name,note:Se(S,S._line||"ATT"),portrait:He(S),job:S.job}));b.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:w,homeTotal:y.total,aiTotal:0});const k=(u.round||0)+1,z=a==="p1"?"p2":"p1",E={...u,[a+"Team"]:B,[a+"Score"]:v},L=Te(E);j.add(k),we(w,v,u[n+"Score"]||0,!0,async()=>{await V({[a+"Team"]:B,[a+"Score"]:v,["selected_"+a]:[],modifiers:{...u.modifiers,[a]:{}},pendingAttack:null,phase:L?"finished":z+"-attack",attacker:z,round:k,log:b}),L&&await Ge({...u,[a+"Score"]:v})});return}b.push({type:"pending",text:`⚔️ ${u[a+"Name"]} attaque (${y.total})`}),await V({[a+"Team"]:B,[n+"Team"]:u[n+"Team"],pendingAttack:{...y,players:g,side:a},["selected_"+a]:[],modifiers:{...u.modifiers,[a]:{}},phase:n+"-defense",log:b})}async function ie(){const B=u[a+"Team"],$=(u["selected_"+a]||[]).map(X=>{const U=(B[X._role]||[]).find(fe=>fe.cardId===X.cardId)||X,P=B[X._role]||[],W=P.findIndex(fe=>fe.cardId===X.cardId),te=st(P.length),Z=W>=0?te[W]:U._col??1;return{...U,_line:X._role,_col:Z}}),g=Vt($,u.modifiers[a]||{});R(a,$.map(X=>X.cardId)),$.forEach(X=>{const U=(B[X._role]||[]).find(P=>P.cardId===X.cardId);U&&(U.used=!0)}),u["selected_"+a]=[],re();const y=Yt(u.pendingAttack.total,g.total,u.modifiers[a]||{}),b=u.pendingAttack.side,v=y==="attack"||(y==null?void 0:y.goal),w=b==="p1"?"p2":"p1",k=(u.round||0)+1,z=(u.pendingAttack.players||[]).map(X=>({name:X.name,note:Se(X,X._line||"ATT"),portrait:He(X),job:X.job})),E=[...u.log||[]];E.push({type:"duel",isGoal:v,homeScored:v&&b===a,text:v?`⚽ BUT de ${u[b+"Name"]} ! (${u.pendingAttack.total} vs ${g.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${g.total})`,homePlayers:z,aiPlayers:$.map(X=>({name:X.name,note:Se(X,X._line||"DEF"),portrait:He(X),job:X.job})),homeTotal:u.pendingAttack.total,aiTotal:g.total});const L=v?(u[b+"Score"]||0)+1:u[b+"Score"]||0,S={...u,[a+"Team"]:B,[b+"Score"]:L},M=Te(S),F=M?"finished":w+"-attack",Y=async()=>{await V({[a+"Team"]:B,[n+"Team"]:u[n+"Team"],[b+"Score"]:L,["selected_"+a]:[],modifiers:{...u.modifiers,[a]:{}},pendingAttack:null,phase:F,attacker:w,round:k,log:E}),(F==="finished"||M)&&await Ge({...u,[b+"Score"]:L})};if(v){const X=b===a,U=X?L:u[a+"Score"]||0,P=X?u[n+"Score"]||0:L;j.add(k),we(z,U,P,X,Y)}else await Y()}function ue(B){return["MIL","ATT"].some($=>(B[$]||[]).some(g=>!g.used))}function Le(B){return["GK","DEF","MIL","ATT"].some($=>(B[$]||[]).some(g=>!g.used))}function Ie(B){return Le(B)&&!ue(B)}function Ce(B){const $=u[B+"Team"],g=u[(B==="p1"?"p2":"p1")+"Team"];return!!(ue($)||!Le(g)&&Ie($))}function Te(B){const $=["MIL","ATT"].some(E=>(B.p1Team[E]||[]).some(L=>!L.used)),g=["MIL","ATT"].some(E=>(B.p2Team[E]||[]).some(L=>!L.used)),y=Le(B.p1Team),b=Le(B.p2Team);return!$&&!(!b&&y)&&(!g&&!(!y&&b))}function qe(B){const $=B.p1Score||0,g=B.p2Score||0;return $===g?null:$>g?h.home_id:h.away_id}async function Ge(B){try{const $=qe(B),g=$?h.home_id===$?h.away_id:h.home_id:null;await T.from("matches").update({status:"finished",winner_id:$,home_score:B.p1Score||0,away_score:B.p2Score||0}).eq("id",i),$&&g&&zi($,g).catch(()=>{})}catch($){console.error("[PvP] finishMatch:",$)}}function ze(){var b;const B=u[a+"Score"],$=u[n+"Score"],g=B>$,y=B===$;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(J,R)=>R+1).reverse().map(J=>{const R=(f||[]).filter(G=>G.matchday===J);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${J}</div>${R.map(G=>Hi(G,x,s,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(k),(M=k.querySelector("#pvp-end-home"))==null||M.addEventListener("click",()=>{k.remove(),Ve(e),a?l("mini-league",{openLeagueId:a}):l("mini-league")})}const V=T.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},g=>{const y=g.new;try{if(y.status==="finished"||y.forfeit){if(A||(A=!0,C&&(clearInterval(C),C=null),y.game_state&&(c=y.game_state),c.phase==="finished"&&!y.forfeit&&document.getElementById("pvp-home")))return;N(y);return}if(y.game_state){const b=c;c=y.game_state;const v=c._lastGC;if(v&&v.seq&&!q.has(v.seq)&&(q.add(v.seq),v.by!==n)){se(v.type,v.by,()=>me());return}const w=b[n+"Score"]||0,k=b[x+"Score"]||0,z=c[n+"Score"]||0,E=c[x+"Score"]||0,L=z>w,S=E>k;if((L||S)&&!D.has(c.round)){D.add(c.round);const M=[...c.log||[]].reverse().find(Y=>Y.isGoal),F=((M==null?void 0:M.homePlayers)||[]).map(Y=>({name:Y.name,note:Y.note,portrait:Y.portrait,job:Y.job}));Ee(F,z,E,L,()=>me());return}me()}}catch(b){console.error("[PvP] crash:",b)}}).subscribe();async function K(g){Object.assign(c,g),c.lastActionAt=new Date().toISOString();const{error:y}=await T.from("matches").update({game_state:c}).eq("id",i);y&&f("Erreur de synchronisation","error");try{me()}catch(b){console.error("[PvP] renderPvpScreen crash:",b)}}async function ae(){if(A)return;A=!0,C&&(clearInterval(C),C=null);const g=o?_.away_id:_.home_id,y=o?"p2":"p1",b=o?"p1":"p2",v={...c,[y+"Score"]:3,[b+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:g,home_score:v.p1Score||0,away_score:v.p2Score||0,game_state:v}).eq("id",i)}catch{}try{T.removeChannel(V)}catch{}setTimeout(()=>{Ve(e),l("mini-league")},800)}const ne={BOOST_STAT:({value:g=1,count:y=1,roles:b=[]},v,w)=>{const k=v[n+"Team"],z=Object.entries(k).filter(([E])=>!b.length||b.includes(E)).flatMap(([E,L])=>L.filter(S=>!S.used).map(S=>({...S,_line:E})));if(!z.length){v.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),w(v);return}J(z,y,`Choisir ${y} joueur(s) à booster (+${g})`,E=>{E.forEach(L=>{const S=(k[L._line]||[]).find(M=>M.cardId===L.cardId);S&&(S.boost=(S.boost||0)+g,v.log.push({text:`⚡ +${g} sur ${S.name}`,type:"info"}))}),v[n+"Team"]=k,w(v)})},DEBUFF_STAT:({value:g=1,count:y=1,roles:b=[],target:v="ai"},w,k)=>{const z=v==="home"?n:x,E=w[z+"Team"],L=v==="home"?"allié":"adverse",S=Object.entries(E).filter(([M])=>!b.length||b.includes(M)).flatMap(([M,F])=>F.map(Y=>({...Y,_line:M})));if(!S.length){w.log.push({text:`🎯 Aucun joueur ${L}`,type:"info"}),k(w);return}J(S,y,`Choisir ${y} joueur(s) ${L}(s) (-${g})`,M=>{M.forEach(F=>{const Y=(E[F._line]||[]).find(X=>X.cardId===F.cardId);Y&&(Y.boost=(Y.boost||0)-g,w.log.push({text:`🎯 -${g} sur ${Y.name}`,type:"info"}))}),w[z+"Team"]=E,k(w)})},GRAY_PLAYER:({count:g=1,roles:y=[],target:b="ai"},v,w)=>{const k=b==="home"?n:x,z=v[k+"Team"],E=b==="home"?"allié":"adverse",L=Object.entries(z).filter(([S])=>!y.length||y.includes(S)).flatMap(([S,M])=>M.filter(F=>!F.used).map(F=>({...F,_line:S})));if(!L.length){v.log.push({text:`❌ Aucun joueur ${E}`,type:"info"}),w(v);return}J(L,g,`Choisir ${g} joueur(s) ${E}(s) à exclure`,S=>{const M="usedCardIds_"+k,F=new Set(v[M]||[]);S.forEach(Y=>{const X=(z[Y._line]||[]).find(U=>U.cardId===Y.cardId);X&&(X.used=!0,F.add(Y.cardId),v.log.push({text:`❌ ${X.name} exclu !`,type:"info"}))}),v[M]=[...F],v[k+"Team"]=z,w(v)})},REVIVE_PLAYER:({count:g=1,roles:y=[]},b,v)=>{const w=b[n+"Team"],k=Object.entries(w).filter(([z])=>!y.length||y.includes(z)).flatMap(([z,E])=>E.filter(L=>L.used).map(L=>({...L,_line:z})));if(!k.length){b.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),v(b);return}J(k,g,`Choisir ${g} joueur(s) à ressusciter`,z=>{z.forEach(E=>{const L=(w[E._line]||[]).find(S=>S.cardId===E.cardId);L&&(L.used=!1,b.log.push({text:`💫 ${L.name} ressuscité !`,type:"info"}))}),b[n+"Team"]=w,v(b)})},REMOVE_GOAL:({},g,y)=>{const b=x+"Score";g[b]>0?(g[b]--,g.log.push({text:"🚫 Dernier but annulé !",type:"info"})):g.log.push({text:"🚫 Aucun but à annuler",type:"info"}),y(g)},ADD_GOAL_DRAW:({},g,y)=>{g[n+"Score"]===g[x+"Score"]?(g[n+"Score"]++,g.log.push({text:"🎯 But bonus !",type:"info"})):g.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),y(g)},ADD_SUB:({value:g=1},y,b)=>{y.maxSubs=(y.maxSubs||3)+g,y.log.push({text:`🔄 +${g} remplacement(s)`,type:"info"}),b(y)},CUSTOM:({},g,y)=>y(g)};function J(g,y,b,v){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let k=[];function z(){var L,S;const E=g.map(M=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[M._line]||"#555",Y=Se(M,M._line)+(M.boost||0),U=k.find(W=>W.cardId===M.cardId)?"#FFD700":"rgba(255,255,255,0.25)",P=M.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${M.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${U};background:${F};overflow:hidden;cursor:pointer;${P}">
        ...
        </div>`,(L=w.querySelector("#pp-close"))==null||L.addEventListener("click",()=>w.remove()),w.querySelectorAll(".pp-item").forEach(M=>{M.addEventListener("click",()=>{const F=M.dataset.cid,Y=g.find(U=>U.cardId===F),X=k.findIndex(U=>U.cardId===F);Y&&(X>-1?k.splice(X,1):k.length<y&&k.push(Y),z())})}),(S=w.querySelector("#pp-confirm"))==null||S.addEventListener("click",()=>{w.remove(),v(k)})}z(),document.body.appendChild(w)}async function R(g,y){const v=(c["gcCardsFull_"+n]||[]).find(E=>E.id===g),w=(v==null?void 0:v._gcDef)||(c.gcDefs||[]).find(E=>{var L;return E.name===y||((L=E.name)==null?void 0:L.toLowerCase().trim())===(y==null?void 0:y.toLowerCase().trim())}),k=[...c["usedGc_"+n]||[],g],z={type:y,by:n,seq:(c._gcAnimSeq||0)+1};q.add(z.seq),se(y,n,async()=>{if(w!=null&&w.effect_type&&w.effect_type!=="CUSTOM"){const L=ne[w.effect_type];if(L){const S={...c};L(w.effect_params||{},S,async M=>{M["usedGc_"+n]=k,M._lastGC=z,M._gcAnimSeq=z.seq,await K(M)});return}}const E={...c};switch(y){case"Remplacement+":E.maxSubs=(E.maxSubs||3)+1,E.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const L=x+"Score";E[L]>0&&(E[L]--,E.log.push({text:"🚫 But annulé",type:"info"}));break}}E["usedGc_"+n]=k,E._lastGC=z,E._gcAnimSeq=z.seq,await K(E)})}function G(g,y){const b="usedCardIds_"+g,v=new Set(c[b]||[]);y.forEach(w=>v.add(w)),c[b]=[...v]}function re(){for(const g of["p1","p2"]){const y=new Set(c["usedCardIds_"+g]||[]),b=c[g+"Team"];if(b)for(const v of["GK","DEF","MIL","ATT"])(b[v]||[]).forEach(w=>{w.used=y.has(w.cardId)})}}function me(){var nt,pt,ut,ft,ce,Q;if(c.phase==="reveal")return _e();if(c.phase==="midfield")return we();if(c.phase==="finished")return B();const g=c[n+"Team"],y=c[x+"Team"];re();const b=c[n+"Score"],v=c[x+"Score"],w=c[n+"Name"],k=c[x+"Name"],z=c.phase===n+"-attack",E=c.phase===n+"-defense",L=Array.isArray(c["selected_"+n])?c["selected_"+n]:[],S=L.map(H=>H.cardId),M=window.innerWidth>=700,F=c[n+"Subs"]||[],Y=c["usedSubIds_"+n]||[],X=F.filter(H=>!Y.includes(H.cardId)),U=c["gcCardsFull_"+n]||[],P=c["usedGc_"+n]||[],W=U.filter(H=>!P.includes(H.id)),te=c.boostOwner===n&&!c.boostUsed,Z=!["GK","DEF","MIL","ATT"].some(H=>(y[H]||[]).some(oe=>!oe.used)),fe=[...g.MIL||[],...g.ATT||[]].filter(H=>!H.used),ye=z&&Z&&fe.length===0?[...g.GK||[],...g.DEF||[]].filter(H=>!H.used).map(H=>H.cardId):[];function be(H,oe,he){var Ct,Li;const $e=H._gcDef,Qe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[$e==null?void 0:$e.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ze={purple:"#b06ce0",light_blue:"#00d4ef"}[$e==null?void 0:$e.color]||"#b06ce0",tt=($e==null?void 0:$e.name)||H.gc_type,rt=($e==null?void 0:$e.effect)||((Ct=Oe[H.gc_type])==null?void 0:Ct.desc)||"",wt=$e!=null&&$e.image_url?`/icons/${$e.image_url}`:null,_t=((Li=Oe[H.gc_type])==null?void 0:Li.icon)||"⚡",dt=Math.round(he*.22),gt=Math.round(he*.22),mt=he-dt-gt,$t=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${H.id}" data-gc-type="${H.gc_type}"
        ...
        <div style="height:${dt}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${$t}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${oe-6}px">${tt}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${mt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${wt?`<img src="${wt}" style="max-width:${oe-10}px;max-height:${mt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(mt*.55)}px">${_t}</span>`}
        </div>
      ...
      </div>`}function ke(H,oe){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${H}px;height:${oe}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(oe*.04)}px;text-align:center;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct(g,c[n+"Formation"],Ue,S,300,300,ye)}
    ...
    </div>`;function Ke(H){if(H.type==="duel"&&(H.homeTotal!=null||H.aiTotal!=null)){const oe=(H.homeTotal||0)>=(H.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            ...
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
              <div style="font-size:${oe?20:14}px;font-weight:900;color:${oe?"#FFD700":"rgba(255,255,255,0.4)"};line-height:1">${H.homeTotal}</div>
              <div style="font-size:8px;color:rgba(255,255,255,0.3);margin:1px 0">VS</div>
              <div style="font-size:${oe?14:20}px;font-weight:900;color:${oe?"rgba(255,255,255,0.4)":"#ff6b6b"};line-height:1">${H.aiTotal}</div>
            </div>
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-start;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
        ...
        </div>`}return`<div style="font-size:11px;color:${H.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${H.type==="goal"?700:400};padding:3px 2px">${H.text||""}</div>`}const Re=(()=>{var oe,he;if(E&&((oe=c.pendingAttack)!=null&&oe.players)){const $e=c.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;function We(){const H=e.querySelector(".match-screen");if(!H)return;const oe=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);H.style.height=oe+"px",H.style.minHeight=oe+"px",H.style.maxHeight=oe+"px",H.style.overflow="hidden";const he=e.querySelector("#mobile-action-bar"),$e=e.querySelector("#mobile-play-area");he&&$e&&($e.style.paddingBottom=he.offsetHeight+"px")}if(We(),setTimeout(We,120),setTimeout(We,400),j||(j=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",We),window.visualViewport.addEventListener("scroll",We)),window.addEventListener("resize",We)),function(){const oe=e.querySelector(".terrain-wrapper svg");oe&&(oe.removeAttribute("width"),oe.removeAttribute("height"),oe.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",oe.setAttribute("viewBox","-26 -26 352 352"),oe.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(H=>{H.addEventListener("click",()=>{if(!z&&!E)return;const oe=H.dataset.cardId,he=H.dataset.role,$e=(g[he]||[]).find(rt=>rt.cardId===oe);if(!$e||$e.used)return;const Qe=ye.includes(oe);if(z&&!["MIL","ATT"].includes(he)&&!Qe)return;Array.isArray(c["selected_"+n])||(c["selected_"+n]=[]);const Ze=c["selected_"+n],tt=Ze.findIndex(rt=>rt.cardId===oe);tt>-1?Ze.splice(tt,1):Ze.length<3&&Ze.push({...$e,_role:he}),me()})}),e.querySelectorAll(".match-used-hit").forEach(H=>{H.addEventListener("click",()=>O(H.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(H=>{H.addEventListener("click",()=>O())}),(nt=e.querySelector("#pvp-sub-open"))==null||nt.addEventListener("click",()=>O()),e.querySelectorAll(".pvp-gc-mini").forEach(H=>{H.addEventListener("click",()=>pe(H.dataset.gcId,H.dataset.gcType))}),(pt=e.querySelector("#pvp-boost-card"))==null||pt.addEventListener("click",()=>de()),(ut=e.querySelector("#pvp-action"))==null||ut.addEventListener("click",H=>{z?H.currentTarget.dataset.pass==="1"||!Te(n)?ge():ie():E&&ue()}),(ft=e.querySelector("#pvp-quit"))==null||ft.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&ae()}),(ce=e.querySelector("#pvp-view-opp"))==null||ce.addEventListener("click",()=>xe()),(Q=e.querySelector("#pvp-toggle-history"))==null||Q.addEventListener("click",()=>le()),C&&(clearInterval(C),C=null),(z||E)&&!A){let H=30,oe=!1;const he=()=>document.getElementById("pvp-timer"),$e=()=>{he()&&(he().textContent=H+"s",he().style.color=oe?"#ff4444":"#fff")};$e(),C=setInterval(()=>{H--,H<0?oe?(clearInterval(C),C=null,z&&!Te(n)?ge():ae()):(oe=!0,H=15,$e()):$e()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let f="buy";const a=()=>{var u,c,A,m,I,C,j;return{name:(((u=document.getElementById("flt-name"))==null?void 0:u.value)||"").toLowerCase().trim(),club:(((c=document.getElementById("flt-club"))==null?void 0:c.value)||"").toLowerCase().trim(),country:(((A=document.getElementById("flt-country"))==null?void 0:A.value)||"").toLowerCase().trim(),job:((m=document.getElementById("flt-job"))==null?void 0:m.value)||"",rarity:((I=document.getElementById("flt-rarity"))==null?void 0:I.value)||"",note1:parseInt((C=document.getElementById("flt-note1"))==null?void 0:C.value)||0,note2:parseInt((j=document.getElementById("flt-note2"))==null?void 0:j.value)||0}};function n(u){const c=a();return u.filter(A=>{var V,K,ae;const m=(V=A.card)==null?void 0:V.player;if(!m)return!1;const I=`${m.firstname} ${m.surname_encoded}`.toLowerCase(),C=(((K=m.clubs)==null?void 0:K.encoded_name)||"").toLowerCase(),j=(m.country_code||"").toLowerCase(),D=((ae=A.card)==null?void 0:ae.evolution_bonus)||0,q=St(m,m.job,D),N=m.job2?St(m,m.job2,D):0;return!(c.name&&!I.includes(c.name)||c.club&&!C.includes(c.club)||c.country&&!j.includes(c.country)||c.job&&m.job!==c.job||c.rarity&&m.rarity!==c.rarity||c.note1&&q<c.note1||c.note2&&N<c.note2)})}function x(u){var N,V,K,ae;const c=(N=u.card)==null?void 0:N.player;if(!c)return"";const A=((V=u.card)==null?void 0:V.evolution_bonus)||0,m=St(c,c.job,A),I=c.job2?St(c,c.job2,A):0,C=(i.profile.credits||0)>=u.price,j=c.country_code?`https://flagsapi.com/${c.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,D=Qt[c.job]||"#bbb",q=c.job2?Qt[c.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="font-size:10px;color:#999;margin-top:1px">Vendeur : ${((ae=u.seller)==null?void 0:ae.pseudo)||"—"}</div>
      </div>
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:14px;font-weight:900;color:#D4A017">${u.price.toLocaleString("fr")}</div>
        <button class="btn btn-primary btn-sm" data-buy="${u.id}" ${C?"":"disabled"} style="margin-top:4px;font-size:11px;padding:4px 10px">${C?"Acheter":"Trop cher"}</button>
      </div>
    </div>`}function p(u){var N,V,K,ae;const c=(N=u.card)==null?void 0:N.player;if(!c)return"";const A=((V=u.card)==null?void 0:V.evolution_bonus)||0,m=St(c,c.job,A),I=c.job2?St(c,c.job2,A):0,C=u.status==="sold",j=c.country_code?`https://flagsapi.com/${c.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,D=Qt[c.job]||"#bbb",q=c.job2?Qt[c.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${C?"opacity:0.7":""}">
      ${j?`<img src="${j}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(K=c.clubs)!=null&&K.logo_url?`<img src="${c.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${D};display:flex;align-items:center;justify-content:center">
