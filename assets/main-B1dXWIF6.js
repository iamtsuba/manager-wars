...
import{s as v,t as Uo,u as Ko,n as ut,g as Bt,p as nt,v as si,o as Ut,r as Ae,k as At,w as Gi,x as Ft,y as Ii,F as zi,z as Vo,T as Di,q as Tn,C as In,d as zn}from"./special-cards-DNsLLa5x.js";const An="/";function ko(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,d,c,s,l,p,b;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),d=document.getElementById("pack-blade");let c=!1;const s=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function l(_){n||(c=!0,d.style.opacity="1",p(_))}function p(_){if(!c||n)return;const N=a.getBoundingClientRect(),G=s(_)-N.left,le=Math.max(0,Math.min(1,G/N.width));d.style.width=le*N.width+"px",le>=.82&&g()}function b(){n||(c=!1,d.style.transition="width .2s ease, opacity .2s ease",d.style.width="0",d.style.opacity="0",setTimeout(()=>{n||(d.style.transition="")},220))}function g(){var N;if(n)return;n=!0,c=!1,d.style.width="100%",d.style.opacity="1",(N=document.getElementById("cut-flash"))==null||N.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{d.style.opacity="0",document.getElementById("pack-phase").style.display="none",u(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",p),window.addEventListener("pointerup",b),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",p,{passive:!0}),window.addEventListener("touchend",b);let x=0,f=!1;const y=new Set;function u(_){x=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),I()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((N,G)=>`<div class="card-dot" data-i="${G}" style="width:8px;height:8px;border-radius:50%;background:${G===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(N=>N.addEventListener("click",()=>m(parseInt(N.dataset.i)))))}function h(_,N){var de,j;const G=t[_],le=document.getElementById("card-counter"),pe=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${t.length}`);const M=document.getElementById("reveal-btns");M&&(M.style.display=_===t.length-1?"flex":"none");const O=G.card_type==="player"&&((de=G.player)==null?void 0:de.rarity)==="legende",ue=!y.has(_);y.add(_);let xe=0;if(G.card_type==="player"&&G.player){const W=G.player,ee=W.job||"ATT";xe=(Number(ee==="GK"?W.note_g:ee==="DEF"?W.note_d:ee==="MIL"?W.note_m:W.note_a)||0)+(G.evolution_bonus||0)}const ge=W=>{pe.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${O?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Kn(G)}</div>
        ...
        </div>`;const ee=document.getElementById("current-card-wrap");N!==0?(ee.style.transition="none",ee.style.transform=`translateX(${N>0?100:-100}%)`,requestAnimationFrame(()=>{ee.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ee.style.transform="translateX(0)"})):ee.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),W||O?V():Y(),w()};ue&&(((j=G.player)==null?void 0:j.rarity)==="legende"||xe>=18)&&G.card_type==="player"&&G.player?E(G,()=>ge(!0)):ge(!1)}function E(_,N){var ae;f=!0;const G=_.player,le=`https://flagsapi.com/${G.country_code}/flat/64.png`,pe=(ae=G.clubs)==null?void 0:ae.logo_url,M=Bt(G),O=G.job||"ATT",ue=Number(O==="GK"?G.note_g:O==="DEF"?G.note_d:O==="MIL"?G.note_m:G.note_a)||0,xe=_.evolution_bonus||0,ge=ue+xe,de=ge>=18&&ge<=20,j=ge>=18,W=document.getElementById("walkout-overlay"),ee=document.getElementById("walkout-stage");if(!W||!ee){f=!1,N();return}let ie=null;de&&(ie=to("/sounds/Legendary.mp3",.8)),W.style.display="flex";const X=()=>{const ce=ee.firstElementChild;ce&&(ce.classList.remove("wo-in"),ce.classList.add("wo-out"))},P=1800,J=400;ee.innerHTML=`<img class="wo-in" src="${le}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(X,P),setTimeout(()=>{var ce;ee.innerHTML=pe?`<img class="wo-in" src="${pe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ce=G.clubs)==null?void 0:ce.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},P+J),setTimeout(X,P*2+J),setTimeout(()=>{ee.innerHTML=M?`<img class="wo-in" src="${M}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(P+J)*2),setTimeout(X,(P+J)*2+P);const H=j?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[O]||"#fff";setTimeout(()=>{ee.innerHTML=`<div class="wo-in" style="
        ...
        ${ge}
      </div>`,j&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(P+J)*3),setTimeout(X,(P+J)*3+P),setTimeout(()=>{W.style.display="none",ee.innerHTML="",f=!1,ie&&!de&&ie.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),N()},(P+J)*4)}function m(_){if(f||_<0||_>=t.length||_===x)return;const N=_>x?1:-1;x=_,h(_,N)}function T(){m(x+1)}function $(){m(x-1)}function I(){const _=document.getElementById("card-viewport");if(!_||_._swipeBound)return;_._swipeBound=!0;let N=0,G=0,le=0,pe=!1;const M=de=>de.touches?de.touches[0].clientX:de.clientX,O=de=>de.touches?de.touches[0].clientY:de.clientY,ue=de=>{pe=!0,N=M(de),G=O(de),le=0},xe=de=>{if(!pe)return;le=M(de)-N;const j=O(de)-G;if(Math.abs(le)<Math.abs(j))return;const W=document.getElementById("current-card-wrap");W&&(W.style.transition="none",W.style.transform=`translateX(${le*.6}px) rotate(${le*.02}deg)`)},ge=()=>{if(!pe)return;pe=!1;const de=document.getElementById("current-card-wrap"),j=55;le<=-j&&x<t.length-1?T():le>=j&&x>0?$():de&&(de.style.transition="transform .2s ease",de.style.transform="translateX(0)")};_.addEventListener("pointerdown",ue),_.addEventListener("pointermove",xe),_.addEventListener("pointerup",ge),_.addEventListener("pointercancel",ge),_.addEventListener("touchstart",ue,{passive:!0}),_.addEventListener("touchmove",xe,{passive:!0}),_.addEventListener("touchend",ge),_.addEventListener("click",de=>{if(Math.abs(le)>8)return;const j=_.getBoundingClientRect();de.clientX-j.left>j.width/2?T():$()})}let B=null;function V(){const _=document.getElementById("fireworks-canvas");if(!_)return;_.width=window.innerWidth,_.height=window.innerHeight;const N=_.getContext("2d"),G=[];function le(){const M=Math.random()*_.width,O=Math.random()*_.height*.6,ue=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],xe=ue[Math.floor(Math.random()*ue.length)];for(let ge=0;ge<60;ge++){const de=Math.PI*2/60*ge,j=2+Math.random()*5;G.push({x:M,y:O,vx:Math.cos(de)*j,vy:Math.sin(de)*j,alpha:1,color:xe,size:2+Math.random()*3})}}le(),B=setInterval(le,600);function pe(){if(document.getElementById("fireworks-canvas")){N.clearRect(0,0,_.width,_.height);for(let M=G.length-1;M>=0;M--){const O=G[M];if(O.x+=O.vx,O.y+=O.vy+.08,O.vy*=.98,O.alpha-=.018,O.alpha<=0){G.splice(M,1);continue}N.globalAlpha=O.alpha,N.fillStyle=O.color,N.beginPath(),N.arc(O.x,O.y,O.size,0,Math.PI*2),N.fill()}N.globalAlpha=1,(B!==null||G.length>0)&&requestAnimationFrame(pe)}}pe()}function Y(){B!==null&&(clearInterval(B),B=null);const _=document.getElementById("fireworks-canvas");_&&_.getContext("2d").clearRect(0,0,_.width,_.height)}if(o){const _=document.getElementById("reveal-btns");_&&(_.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(L=document.getElementById("reveal-next"))==null||L.addEventListener("click",()=>{Y(),r.remove(),o()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{Y(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{Y(),r.remove(),i("boosters")})}function Kn(t){var e,i,o,r;if(t.card_type==="player"&&t.player)return Rn(t);if(t.card_type==="game_changer"){const n=t._gcDef,a=(n==null?void 0:n.name)||t.gc_type||"Game Changer",d=(n==null?void 0:n.effect)||((e=Hi[t.gc_type])==null?void 0:e.desc)||"",c=n!=null&&n.image_url?`/icons/${n.image_url}`:null,s=((i=Hi[t.gc_type])==null?void 0:i.icon)||"⚡";return nt(a,c,s,d,{width:170})}if(t.card_type==="formation")return si(t.formation,ut[t.formation],{width:160});if(t.card_type==="stadium"){const n=t._stadiumDef,a=(n==null?void 0:n.name)||"Stade",d=((o=n==null?void 0:n.club)==null?void 0:o.encoded_name)||(n==null?void 0:n.country_code)||"—",c=n!=null&&n.image_url?`/icons/${n.image_url}`:((r=n==null?void 0:n.club)==null?void 0:r.logo_url)||(n!=null&&n.country_code?`https://flagsapi.com/${n.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),s=`${d}<br>+10 ⭐ joueurs alliés`;return Ut(a,c,s,{width:170})}return'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function Vn(t){var e,i;if((e=t==null?void 0:t.rates)!=null&&e.length){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:4000;padding:16px";const r={normal:"#ccc",pepite:"#D4A017",pépite:"#D4A017",papyte:"#909090",legende:"#7a28b8",légende:"#7a28b8"},n={player:"Joueur",formation:"Formation",game_changer:"Game Changer",game_helper:"Game Helper"};o.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",e.user.id)};async function p(){var w;if(s>=c||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),r&&await r(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const x=a[0],{data:f}=await v.from("users").select("*").eq("id",e.user.id).single();f&&(e.profile=f);let y=[];try{if(x.type==="formation")y=await ro(e.profile,0);else if(x.type==="game_changer")y=await no(e.profile,x.count||3,0);else if(d&&((w=d.rates)!=null&&w.length)){const h={...d,cost:0,cardCount:x.count||d.cardCount||5};y=await _i(e.profile,h),x.guaranteeGK&&!e.profile.first_booster_opened&&(y.some(m=>m.player&&m.player.job==="GK")||await Jn(e.profile,y),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else y=await oo(e.profile,x.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}a.shift(),s++,await l();const u=x.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:x.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${s}/${c})`,img:(d==null?void 0:d.img)||"/icons/booster-players.png"};ao(y,u,i,()=>{p()})}(g=document.getElementById("onboard-start"))==null||g.addEventListener("click",()=>p())}async function Jn(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],r=e.findIndex(a=>a.player);if(r===-1)return;const n=e[r];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[r]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Qn="/",en=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function tn(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,p,b;const d=e[o],c=o===e.length-1,s=Math.round((o+1)/e.length*100);r.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${d.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${Qn}icons/${d.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `;try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(p){console.warn("[AdSense]",p)}let s=e;const l=setInterval(()=>{s--;const p=a.querySelector("#credits-ad-cd");p&&(p.textContent=s),s<=0&&(clearInterval(l),c())},1e3)}function c(){var p,b;const s=a.querySelector("#credits-ad-status"),l=a.querySelector("#credits-ad-next-zone");n<t?(s&&(s.textContent="Publicité terminée ✅"),l&&(l.innerHTML=`
        ...
        </button>`),(b=a.querySelector("#credits-ad-claim-btn"))==null||b.addEventListener("click",async()=>{const g=a.querySelector("#credits-ad-claim-btn");g.disabled=!0,g.textContent="⏳...";const x=(o.credits||0)+i,{error:f}=await v.from("users").update({credits:x}).eq("id",o.id);if(f){r(f.message,"error"),g.disabled=!1;return}o.credits=x,Wt(x),r(`+${i.toLocaleString("fr")} crédits ✅`,"success"),a.remove()}))}d()}async function on(t,e,i){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:9999;padding:16px",document.body.appendChild(o);async function r(){var c;const{data:n}=await v.from("pending_rewards").select(`*,
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Fi(t,{state:e,navigate:i,toast:o}){var m,T,$,I,B,V,Y,K;const r=e.profile;if(!r)return;const n="/icons/";Yt(i,r,"home2",n,o);const a=r.mmr??1e3,d=At(a),c=or(a,d),s=Gi(a),l=isFinite(d.max)?d.max+1:null,[{list:p,iAmInTop:b,myPosition:g},x,f,{count:y}]=await Promise.all([nr(r.id),rr(5),ar(),v.from("pending_rewards").select("*",{count:"exact",head:!0}).eq("user_id",r.id).eq("claimed",!1)]),u=(L,_)=>`
    <div class="rk-row ${L.id===r.id?"rk-row-me":""}">
      <div class="rk-pos ${_<3?"rk-pos-top"+(_+1):""}">${_<3?["🥇","🥈","🥉"][_]:_+1}</div>
      <div class="rk-name ${L.id===r.id?"rk-name-me":""}">${L.pseudo}</div>
    ...
    </div>`;let h=0;const E=L=>`
    <div class="promo-icon-wrap">
      <img src="${n}${L.icon||"nav-boosters.png"}" class="promo-icon" onerror="this.style.display='none'">
    </div>
  ...
  <div class="home-dark" id="home-dark">
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-center">
          ...
          <div class="promo-banner" id="promo-banner">
            ...
            ${f.length>1?`<div class="promo-dots">${f.map((L,_)=>`<div class="promo-dot ${_===0?"active":""}" data-dot="${_}"></div>`).join("")}</div>`:""}
          </div>`:""}
        </div>
  ...
  </div>`,requestAnimationFrame(()=>{var pe,M;const L=((pe=window.visualViewport)==null?void 0:pe.height)||window.innerHeight,_=window.innerWidth<1024;let N=0;if(_){const O=document.getElementById("home2-mobile-top"),ue=document.getElementById("home2-mobile-bottom");N=((O==null?void 0:O.offsetHeight)||0)+((ue==null?void 0:ue.offsetHeight)||0)}else N=((M=document.getElementById("home2-chrome-header"))==null?void 0:M.offsetHeight)||0;const G=L-N,le=t.querySelector(".home-dark");le&&(le.style.minHeight=G+"px")}),(m=document.getElementById("nav-profile-btn"))==null||m.addEventListener("click",()=>i("settings")),(T=document.getElementById("nav-rankings-link"))==null||T.addEventListener("click",()=>i("rankings")),($=document.getElementById("nav-rankings-cta"))==null||$.addEventListener("click",()=>i("rankings")),(I=document.getElementById("rank-inline-link-btn"))==null||I.addEventListener("click",()=>i("rankings")),(B=document.getElementById("nav-journal-link"))==null||B.addEventListener("click",()=>sr()),t.querySelectorAll("[data-action]").forEach(L=>{L.addEventListener("click",()=>{L.style.transform="scale(.96)",setTimeout(()=>L.style.transform="",180);const _=L.dataset.action;if(_==="match-ai"){an(i,e);return}if(_==="match-random"){mt(),i("match",{matchMode:"random"});return}if(_==="match-friend"){i("friends");return}if(_==="mini-league"){i("mini-league");return}if(_==="ranked"){i("ranked");return}o("Bientôt disponible","info")})}),f.length>1){const L=document.getElementById("promo-slide-content"),_=()=>Array.from(document.querySelectorAll(".promo-dot")),N=G=>{h=G,L&&(L.innerHTML=E(f[h])),_().forEach((le,pe)=>le.classList.toggle("active",pe===h))};setInterval(()=>N((h+1)%f.length),5e3),document.querySelectorAll(".promo-dot").forEach(G=>{G.addEventListener("click",()=>N(Number(G.dataset.dot)))})}(V=document.getElementById("promo-cta-btn"))==null||V.addEventListener("click",()=>i("boosters")),rn(e,o),(Y=document.getElementById("home-tutorial-tab"))==null||Y.addEventListener("click",()=>{so(e.profile,i,o)}),(K=document.getElementById("pending-rewards-banner"))==null||K.addEventListener("click",()=>{on(e,o,i)}),pr(e,o,i),nn(e,o,i),dr(e,o)}async function dr(t,e){const i=t.profile.id,{data:o}=await v.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(o!=null&&o.length))return;const r=o.reduce((a,d)=>a+(d.prize_amount||0),0),n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2200",n.innerHTML=`<div class="modal" style="max-width:400px">
  ...
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>dn(t,e,()=>rn(t,e)))}async function an(t,e){const i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:420px;border-radius:18px;overflow:hidden">
    ...
    </div>`,s.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>xr(t,g.dataset.stats,g.dataset.friendName))}),s.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const x=g.dataset.friendId,f=g.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const y=t.user.id,{data:u}=await v.from("friend_match_invites").select("id").eq("inviter_id",x).eq("invitee_id",y).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!u;console.log("[Friends] clic match",{fid:x,fname:f,isAccepting:w}),mt(),o("match",{matchMode:"friend",friendId:x,friendName:f,isAccepting:w})})})}function mr(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",r=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||di,a=t.club_color1||"#ffffff",d=t.last_seen_at?new Date(t.last_seen_at):null,c=d&&Date.now()-d.getTime()<3*60*1e3;return`
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const d=a.dataset.action;if(d==="match-ai"){an(i,e);return}if(d==="match-random"){mt(),i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function ln(t,e){var y,u,w;const{state:i,navigate:o,toast:r}=e,n=ai(),a=Zi(),d=(y=i==null?void 0:i.profile)==null?void 0:y.is_admin,c="2026.07.31-1034";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Ae(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),s=(d||[]).filter(j=>j.card_type==="player"&&j.player),l=(d||[]).filter(j=>j.card_type==="game_changer"),p=(d||[]).filter(j=>j.card_type==="formation"),b=(d||[]).filter(j=>j.card_type==="stadium"),{data:g}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(g||[]).forEach(j=>{x[j.name]=j});const{data:f}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),y={};(f||[]).forEach(j=>{y[j.id]=j}),b.forEach(j=>{j.stadium_def&&(y[j.stadium_id]=j.stadium_def)});const u=Object.keys(zi),w=Object.keys(Oe),h={};s.forEach(j=>{const W=j.player.id;h[W]=(h[W]||0)+1}),new Set(Object.keys(h).map(j=>String(j)));const E=new Set(p.map(j=>j.formation)),m=new Set(l.map(j=>j.gc_type));let T="player",$="Tous",I="",B=!1,V=!1;function Y(){return[...s].sort((j,W)=>{const ee=mi.indexOf(j.player.job),ie=mi.indexOf(W.player.job);return ee!==ie?ee-ie:(j.player.surname_real||"").localeCompare(W.player.surname_real||"")})}function K(){return[...c||[]].sort((j,W)=>{const ee=mi.indexOf(j.job),ie=mi.indexOf(W.job);return ee!==ie?ee-ie:(j.surname_real||"").localeCompare(W.surname_real||"")})}function L(){return Y().filter(j=>{const W=j.player,ee=$==="Tous"||W.job===$,ie=!I||`${W.firstname} ${W.surname_real}`.toLowerCase().includes(I);return ee&&ie})}function _(){return K().filter(j=>{const W=$==="Tous"||j.job===$,ee=!I||`${j.firstname} ${j.surname_real}`.toLowerCase().includes(I);return W&&ee})}t.innerHTML=`
  ...
  </div>`,function(W){const ee=document.getElementById(W);if(!ee)return;ee.addEventListener("wheel",H=>{Math.abs(H.deltaY)<=Math.abs(H.deltaX)||(H.preventDefault(),ee.scrollLeft+=H.deltaY)},{passive:!1});let ie=!1,X=0,P=0,J=!1,F=!1;ee.addEventListener("mousedown",H=>{ie=!0,J=!1,X=H.pageX,P=ee.scrollLeft}),window.addEventListener("mouseup",()=>{ie=!1,J&&(ee.style.cursor="",F=!0),J=!1}),window.addEventListener("mousemove",H=>{if(!ie)return;const ae=H.pageX-X;!J&&Math.abs(ae)<6||(J=!0,ee.style.cursor="grabbing",H.preventDefault(),ee.scrollLeft=P-ae)}),ee.addEventListener("click",H=>{F&&(H.stopPropagation(),H.preventDefault(),F=!1)},!0)}("col-grid");function N(){const j=document.getElementById("col-filters");j&&(T==="player"?(j.innerHTML=`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${V}${l.job2&&Y>0?` / ${K}`:""}`:`Note actuelle : ${V}${l.job2&&Y>0?` / ${K}`:""}`}
            </div>
          </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",d);let G=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function pe(){let F=0;return document.querySelectorAll(".expl-check:checked").forEach(H=>{if(H.dataset.id===t.id)return;const ce=Number(H.dataset.evo)||0,be=Number(H.dataset.note)||0;F+=be+ce}),Math.round(F*le)}const M=()=>{const F=G.size,H=document.getElementById("sell-action-panel");if(!H)return;H.style.display=F>0?"block":"none",document.getElementById("sell-selected-count").textContent=F;const ae=document.getElementById("evolve-btn");if(ae){const ce=pe();ae.textContent=ce>0?`⬆️ Évoluer (+${ce})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(F=>{F.addEventListener("change",()=>{const H=F.dataset.id;F.checked?G.add(H):G.delete(H);const ae=F.closest(".exemplaire-row");if(ae){const ce=ae.querySelector(".expl-sel-overlay"),be=ae.querySelector(".expl-sel-check");ce&&(ce.style.display=F.checked?"block":"none"),be&&(be.style.display=F.checked?"flex":"none"),ae.style.transform=F.checked?"scale(1.05)":"scale(1)"}M()})}),document.querySelectorAll(".exemplaire-row").forEach(F=>{F.addEventListener("click",H=>{if(H.target.tagName==="INPUT")return;const ae=F.querySelector(".expl-check");ae&&!ae.disabled&&(ae.checked=!ae.checked,ae.dispatchEvent(new Event("change")))})}),(W=document.getElementById("evolve-btn"))==null||W.addEventListener("click",async()=>{if(b<=1)return;const F=[...G];if(!F.length)return;if(G.has(t.id)){const ye=document.createElement("div");ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ye.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(b=document.getElementById("close-sub-selector"))==null||b.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{t.subs.push(g.dataset.cardId),r(),Lt(e,t,i)})})}async function fn(t){const e=t.formationCards.find(r=>r.formation===t.formation),i=(e==null?void 0:e.id)||t.formationCardId;await v.from("decks").update({formation:t.formation,formation_card_id:i||null,stadium_card_id:t.stadiumCardId||null}).eq("id",t.deckId),await v.from("deck_cards").delete().eq("deck_id",t.deckId);const o=[];return Object.entries(t.slots).forEach(([r,n],a)=>{o.push({deck_id:t.deckId,card_id:n,position:r,is_starter:!0,slot_order:a})}),t.subs.forEach((r,n)=>{o.push({deck_id:t.deckId,card_id:r,position:`SUB${n+1}`,is_starter:!1,slot_order:100+n})}),o.length>0?await v.from("deck_cards").insert(o):{error:null}}let Ki=null;function Mr(t,e){const{toast:i}=e;clearTimeout(Ki),document.querySelectorAll(".autosave-indicator").forEach(r=>{r.textContent="⏳ Enregistrement...",r.style.opacity="1",r.style.color=""}),Ki=setTimeout(async()=>{const{error:r}=await fn(t),n=document.querySelectorAll(".autosave-indicator");if(r){n.forEach(a=>{a.textContent="⚠️ Erreur d'enregistrement",a.style.color="#ff6b6b"}),i(r.message,"error");return}n.forEach(a=>{a.textContent="✅ Enregistré",a.style.color="",setTimeout(()=>{a.style.opacity="0"},1500)})},600)}async function Cr(t,e){const{toast:i,navigate:o}=e;clearTimeout(Ki);const{error:r}=await fn(t);if(r){i(r.message,"error");return}i("Deck enregistré ✅","success"),o("decks")}function qo(t){const e=ki[t]||ki["4-4-2"],i=["GK1"];for(let o=1;o<=e.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=e.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=e.ATT;o++)i.push(`ATT${o}`);return i}const St={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},jr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ct(t,e,i,o,r){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(e.phase==="defense"&&e.pendingAttack){const O=e.pendingAttack;let ue="";if(e.selected.length>0){const xe=e.selected.map(de=>({...(e.homeTeam[de._role]||[]).find(W=>W.cardId===de.cardId)||de,_line:de._role})),ge=pi(xe,e.modifiers.home,e.formation);ue=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${et((O.players||[]).map(xe=>({...xe,used:!1})),"#ff6b6b",O.total,"attack",e.formation)}</div>
            ${ue}
          ...
          </div>`}if(e.phase==="attack"&&e.selected.length>0){const O=e.selected.map(xe=>{const ge=(e.homeTeam[xe._role]||[]).find(j=>j.cardId===xe.cardId)||xe,de=["GK","DEF"].includes(xe._role);return{...ge,_line:xe._role,...de?{note_a:Math.max(1,Number(ge.note_a)||0)}:{}}}),ue=ci(O,e.modifiers.home,e.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${et(O.map(xe=>({...xe,used:!1})),"#FFD700",ue.total,"attack",e.formation)}</div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${e.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...e.log].reverse().map(M=>{var O,ue,xe;if(M.type==="duel"){const ge=M.isGoal,de=M.homeScored?"#FFD700":ge?"#ff6b6b":"rgba(255,255,255,0.3)",j=M.homeScored?"⚽ BUT !":ge?"⚽ BUT IA !":(O=M.homePlayers)!=null&&O.length?"⚔️ Attaque":"🛡️ Défense",W=(M.homeTotal??0)>=(M.aiTotal??0);return`<div style="padding:8px;border-radius:8px;background:${ge?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${de};margin-bottom:4px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const d=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(d){d.boost=(d.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Ie(t,e,i)})})}async function kt(t,e,i){var b,g,x,f;Ot(),Ve(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",d=e.isSolo&&((b=e.soloLevelConfig)!=null&&b.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):yr(e.mode,a);if(e.isSolo&&r)try{const{data:y}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),u=(y==null?void 0:y.unlocked_level)||1;e.soloLevel>=u&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(y){console.warn("[Solo] Erreur mise à jour progression:",y.message)}const c="00000000-0000-0000-0000-000000000000";let s=null;if(e.isRankedAI)try{const{data:y}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(y){const u=y.mmr??1e3,w=y.mmr_deviation??350,h=y.mmr_volatility??.06,E=r?1:n?.5:0,m=(y.placement_matches??0)<10,T=Vo(u,w,h,u,350,E,m),$=n?null:r?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:T.delta,p_away_delta:0,p_home_new_rd:T.newRd,p_away_new_rd:350,p_home_new_vol:T.newSigma,p_away_new_vol:.06}),s=T.delta}}catch(y){console.warn("[RankedAI] Erreur mise à jour MMR:",y.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",e.matchId);const l={credits:(o.profile.credits||0)+d,matches_played:(o.profile.matches_played||0)+1};r?l.wins=(o.profile.wins||0)+1:n?l.draws=(o.profile.draws||0)+1:l.losses=(o.profile.losses||0)+1,await v.from("users").update(l).eq("id",o.profile.id),await i.refreshProfile();const p=document.createElement("div");p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",p.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
      ...
      ${R}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(oe=q.querySelector("#pvp-end-home"))==null||oe.addEventListener("click",()=>{q.remove(),Ye(t),l?g("mini-league",{openLeagueId:l}):g(a?"ranked":"home")})}const K=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{var A;const S=k.new;try{if(S.status==="finished"||S.forfeit){if(T)return;T=!0,$&&(clearInterval($),$=null),Ve(),S.game_state&&(m=S.game_state),Y(S);return}if(S.game_state){const C=m;m=S.game_state;const z=m._lastGC;if(z&&z.seq&&!V.has(z.seq)&&(V.add(z.seq),z.by!==f)){de(z.type,z.by,()=>O());return}const R=C[f+"Score"]||0,q=C[y+"Score"]||0,D=m[f+"Score"]||0,U=m[y+"Score"]||0,Z=D>R,ne=U>q;if((Z||ne)&&!B.has(m.round)){B.add(m.round);const oe=[...m.log||[]].reverse().find(fe=>fe.isGoal),te=((oe==null?void 0:oe.homePlayers)||[]).map(fe=>({name:fe.name,note:fe.note,portrait:fe.portrait,job:fe.job}));!!((A=oe==null?void 0:oe.text)!=null&&A.includes("DERNIER CORNER"))?ae().then(()=>{tt(te,D,U,Z,()=>O())}):tt(te,D,U,Z,()=>O());return}O()}}catch(C){console.error("[PvP] crash:",C)}}).subscribe();async function L(k){Object.assign(m,k),m.lastActionAt=new Date().toISOString();const{error:S}=await v.from("matches").update({game_state:m}).eq("id",i);S&&x("Erreur de synchronisation","error");try{O()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function _(){if(T)return;T=!0,Ot(),Ve(),$&&(clearInterval($),$=null);const k=o?h.away_id:h.home_id,S=o?"p2":"p1",A=o?"p1":"p2",C={...m,[S+"Score"]:3,[A+"Score"]:0,phase:"finished"},z=C.p1Score||0,R=C.p2Score||0;try{await v.from("matches").update({game_state:C}).eq("id",i);const{data:q,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:z,p_away_score:R,p_forfeit:!0});if(D&&console.error("[PvP] finish_pvp_match (forfeit):",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await v.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{v.removeChannel(K)}catch{}setTimeout(()=>{Ye(t),l?g("mini-league",{openLeagueId:l}):g("home")},800)}const N={BOOST_STAT:({value:k=1,count:S=1,roles:A=[]},C,z)=>{const R=C[f+"Team"],q=Object.entries(R).filter(([D])=>!A.length||A.includes(D)).flatMap(([D,U])=>U.filter(Z=>!Z.used).map(Z=>({...Z,_line:D})));if(!q.length){C.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(C);return}G(q,S,`Choisir ${S} joueur(s) à booster (+${k})`,D=>{D.forEach(U=>{const Z=(R[U._line]||[]).find(ne=>ne.cardId===U.cardId);Z&&(Z.boost=(Z.boost||0)+k,C.log.push({text:`⚡ +${k} sur ${Z.name}`,type:"info"}))}),C[f+"Team"]=R,z(C)})},DEBUFF_STAT:({value:k=1,count:S=1,roles:A=[],target:C="ai"},z,R)=>{const q=C==="home"?f:y,D=z[q+"Team"],U=C==="home"?"allié":"adverse",Z=Object.entries(D).filter(([ne])=>!A.length||A.includes(ne)).flatMap(([ne,oe])=>oe.map(te=>({...te,_line:ne})));if(!Z.length){z.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),R(z);return}G(Z,S,`Choisir ${S} joueur(s) ${U}(s) (-${k})`,ne=>{ne.forEach(oe=>{const te=(D[oe._line]||[]).find(se=>se.cardId===oe.cardId);te&&(te.boost=(te.boost||0)-k,z.log.push({text:`🎯 -${k} sur ${te.name}`,type:"info"}))}),z[q+"Team"]=D,R(z)})},GRAY_PLAYER:({count:k=1,roles:S=[],target:A="ai"},C,z)=>{const R=A==="home"?f:y,q=C[R+"Team"],D=A==="home"?"allié":"adverse",U=Object.entries(q).filter(([Z])=>!S.length||S.includes(Z)).flatMap(([Z,ne])=>ne.filter(oe=>!oe.used).map(oe=>({...oe,_line:Z})));if(!U.length){C.log.push({text:`❌ Aucun joueur ${D}`,type:"info"}),z(C);return}G(U,k,`Choisir ${k} joueur(s) ${D}(s) à exclure`,Z=>{const ne="usedCardIds_"+R,oe=new Set(C[ne]||[]);Z.forEach(te=>{const se=(q[te._line]||[]).find(fe=>fe.cardId===te.cardId);se&&(se.used=!0,oe.add(te.cardId),C.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),C[ne]=[...oe],C[R+"Team"]=q,z(C)})},REVIVE_PLAYER:({count:k=1,roles:S=[]},A,C)=>{const z=A[f+"Team"],R=Object.entries(z).filter(([q])=>!S.length||S.includes(q)).flatMap(([q,D])=>D.filter(U=>U.used).map(U=>({...U,_line:q})));if(!R.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),C(A);return}G(R,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(D=>{const U=(z[D._line]||[]).find(Z=>Z.cardId===D.cardId);U&&(U.used=!1,A.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),A[f+"Team"]=z,C(A)})},REMOVE_GOAL:({},k,S)=>{const A=y+"Score";k[A]>0?(k[A]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),S(k)},ADD_GOAL_DRAW:({},k,S)=>{k[f+"Score"]===k[y+"Score"]?(k[f+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),S(k)},ADD_SUB:({value:k=1},S,A)=>{S.maxSubs=(S.maxSubs||3)+k,S.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),A(S)},CUSTOM:({},k,S)=>S(k)};function G(k,S,A,C){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let R=[];function q(){var U,Z;const D=k.map(ne=>{const oe=ne._line||ne.job||"MIL",te=R.find(fe=>fe.cardId===ne.cardId),se=Ae({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:oe,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(U=z.querySelector("#pp-close"))==null||U.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const oe=ne.dataset.cid,te=k.find(fe=>fe.cardId===oe),se=R.findIndex(fe=>fe.cardId===oe);te&&(se>-1?R.splice(se,1):R.length<S&&R.push(te),q())})}),(Z=z.querySelector("#pp-confirm"))==null||Z.addEventListener("click",()=>{z.remove(),C(R)})}q(),document.body.appendChild(z)}async function le(k,S){const C=(m["gcCardsFull_"+f]||[]).find(D=>D.id===k),z=(C==null?void 0:C._gcDef)||(m.gcDefs||[]).find(D=>{var U;return D.name===S||((U=D.name)==null?void 0:U.toLowerCase().trim())===(S==null?void 0:S.toLowerCase().trim())}),R=[...m["usedGc_"+f]||[],k],q={type:S,by:f,seq:(m._gcAnimSeq||0)+1};V.add(q.seq),de(S,f,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const U=N[z.effect_type];if(U){const Z={...m};U(z.effect_params||{},Z,async ne=>{ne["usedGc_"+f]=R,ne._lastGC=q,ne._gcAnimSeq=q.seq,await L(ne)});return}}const D={...m};switch(S){case"Remplacement+":D.maxSubs=(D.maxSubs||3)+1,D.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=y+"Score";D[U]>0&&(D[U]--,D.log.push({text:"🚫 But annulé",type:"info"}));break}}D["usedGc_"+f]=R,D._lastGC=q,D._gcAnimSeq=q.seq,await L(D)})}function pe(k,S){const A="usedCardIds_"+k,C=new Set(m[A]||[]);S.forEach(z=>C.add(z)),m[A]=[...C]}function M(){for(const k of["p1","p2"]){const S=new Set(m["usedCardIds_"+k]||[]),A=m[k+"Team"];if(A)for(const C of["GK","DEF","MIL","ATT"])(A[C]||[]).forEach(z=>{z.used=S.has(z.cardId)})}}function O(){var bo,yo,ho,vo,wo,_o;if(m.phase==="reveal")return ue();if(m.phase==="midfield")return ge();if(m.phase==="finished")return He();const k=m[f+"Team"],S=m[y+"Team"];M();const A=m[f+"Score"],C=m[y+"Score"],z=m[f+"Name"],R=m[y+"Name"],q=m.phase===f+"-attack",D=m.phase===f+"-defense",U=Array.isArray(m["selected_"+f])?m["selected_"+f]:[],Z=U.map(Q=>Q.cardId),ne=window.innerWidth>=700,oe=m[f+"Subs"]||[],te=m["usedSubIds_"+f]||[],se=oe.filter(Q=>!te.includes(Q.cardId)),fe=m["gcCardsFull_"+f]||[],we=m["usedGc_"+f]||[],me=fe.filter(Q=>!we.includes(Q.id)),_e=m.boostOwner===f&&!m.boostUsed,$e=[...k.MIL||[],...k.ATT||[]].filter(Q=>!Q.used),re=[...S.MIL||[],...S.ATT||[]].filter(Q=>!Q.used),ze=!Se(S),Ne=$e.length===0&&re.length===0&&!ze,je=(k.DEF||[]).filter(Q=>!Q.used),Xe=(k.GK||[]).filter(Q=>!Q.used);let Ue=[];q&&$e.length===0&&(ze?(Ue=je.map(Q=>Q.cardId),je.length===0&&(Ue=Ue.concat(Xe.map(Q=>Q.cardId)))):Ne&&(Ue=[...je,...Xe].map(Q=>Q.cardId)));function rt(Q,ve,qe){var Be,bt;const Te=Q._gcDef,Nt=(Te==null?void 0:Te.name)||Q.gc_type,dt=(Te==null?void 0:Te.effect)||((Be=Oe[Q.gc_type])==null?void 0:Be.desc)||"",Pe=Te!=null&&Te.image_url?`/icons/${Te.image_url}`:null,Ge=((bt=Oe[Q.gc_type])==null?void 0:bt.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${Q.id}" data-gc-type="${Q.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}const Q=(m.log||[]).slice(-1)[0];return Q?'<div style="padding:2px 4px">'+xn(Q)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),xo=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(oe);let te=!1;const se=()=>{te||(te=!0,oe.remove(),setTimeout(()=>A&&A(),50))};oe.addEventListener("click",se),setTimeout(se,3e3)}function j(k,S){var ne,oe,te,se;const C=(m["gcCardsFull_"+f]||[]).find(fe=>fe.id===k),z=C==null?void 0:C._gcDef,R=(z==null?void 0:z.name)||S,q=(z==null?void 0:z.effect)||((ne=Oe[S])==null?void 0:ne.desc)||"Carte spéciale.",D=z!=null&&z.image_url?`/icons/${z.image_url}`:null,U=((oe=Oe[S])==null?void 0:oe.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ...
      </div>`,document.body.appendChild(A),(C=A.querySelector("#bp-close"))==null||C.addEventListener("click",()=>A.remove()),A.querySelectorAll(".bp-item").forEach(z=>{z.addEventListener("click",async()=>{const R=z.dataset.cid,q=S.find(U=>U.cardId===R);if(!q)return;const D=(k[q._line]||[]).find(U=>U.cardId===R);D&&(D.boost=(D.boost||0)+m.boostValue),A.remove(),await L({[f+"Team"]:k,boostUsed:!0})})})}function ee(k=null){var se,fe;if(!(m.phase===f+"-attack")){x("Remplacement uniquement avant votre attaque","warning");return}const A=m[f+"Team"],C=m["usedSubIds_"+f]||[],z=m.maxSubs||3;if(C.length>=z){x(`Maximum ${z} remplacements atteint`,"warning");return}const R=Object.entries(A).flatMap(([we,me])=>(me||[]).filter(_e=>_e.used).map(_e=>({..._e,_line:we}))),q=(m[f+"Subs"]||[]).filter(we=>!C.includes(we.cardId));if(!R.length){x("Aucun joueur utilisé à remplacer","warning");return}if(!q.length){x("Aucun remplaçant disponible","warning");return}let D=Math.max(0,R.findIndex(we=>we.cardId===k));const U=((se=R[D])==null?void 0:se._line)||((fe=R[D])==null?void 0:fe.job);let Z=Math.max(0,q.findIndex(we=>we.job===U)),ne=!1;const oe=document.createElement("div");oe.id="pvp-sub-overlay",oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function te(){var Ne,je,Xe,Ue,rt,Xt;const we=R[D],me=q[Z],_e=Math.min(130,Math.round((window.innerWidth-90)/2)),$e=Math.round(_e*1.35),re=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;oe.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <button id="pout-down" style="${re(D>=R.length-1)}" ${D>=R.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${D+1}/${R.length}</div>
        </div>
      </div>
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(Ne=oe.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>oe.remove()),(je=oe.querySelector("#pout-up"))==null||je.addEventListener("click",()=>{D>0&&(D--,te())}),(Xe=oe.querySelector("#pout-down"))==null||Xe.addEventListener("click",()=>{D<R.length-1&&(D++,te())}),(Ue=oe.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{Z>0&&(Z--,te())}),(rt=oe.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{Z<q.length-1&&(Z++,te())});const ze=(Fe,Je,Ke,gt)=>{const at=oe.querySelector("#"+Fe);if(!at)return;let Pt=0;at.addEventListener("touchstart",xt=>{Pt=xt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",xt=>{const Tt=xt.changedTouches[0].clientY-Pt;if(Math.abs(Tt)<30)return;const st=Je();Tt<0&&st<gt-1?(Ke(st+1),te()):Tt>0&&st>0&&(Ke(st-1),te())},{passive:!0})};ze("pin-panel",()=>Z,Fe=>Z=Fe,q.length),ze("pout-panel",()=>D,Fe=>D=Fe,R.length),(Xt=oe.querySelector("#psub-confirm"))==null||Xt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),ne)return;ne=!0;const Je=R[D],Ke=q[Z];if(!Je||!Ke)return;const gt=Je._line,at=(A[gt]||[]).findIndex(Tt=>Tt.cardId===Je.cardId);if(at===-1){x("Erreur : joueur introuvable","error"),oe.remove();return}const Pt={...Ke,_line:gt,position:Je.position,used:!1,boost:0};A[gt].splice(at,1,Pt);const xt=[...C,Ke.cardId];oe.remove(),ie(Je,Ke,async()=>{await L({[f+"Team"]:A,[y+"Team"]:m[y+"Team"],["usedSubIds_"+f]:xt})})})}document.body.appendChild(oe),te()}function ie(k,S,A){const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const R=(U,Z,ne)=>`<div style="text-align:center">
      ...
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(z,1400)});await S("⚽ DERNIER CORNER","#FFD700"),await S("🧤 LE GARDIEN MONTE !","#4fc3f7"),k.remove()}async function ce(k,S){const{side:A,gk:C}=k;if(!C)return;const z=A+"Score",R=(S[z]||0)+1;C.used=!0;const q=[...S.log||[]];q.push({type:"duel",isGoal:!0,homeScored:A===f,homePlayers:A==="p1"?[Gt(C)]:[],aiPlayers:A==="p2"?[Gt(C)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${S[A+"Name"]} marque !`});const D=(S.round||0)+1,U=A==="p1"?"p2":"p1",Z={...S,[z]:R},ne=De(Z);B.add(D),await ae();const oe=A===f?R:S[f+"Score"]||0,te=A===f?S[y+"Score"]||0:R;tt([Gt(C)],oe,te,A===f,async()=>{await L({[z]:R,log:q,round:D,pendingAttack:null,phase:ne?"finished":U+"-attack",attacker:U,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}}}),ne&&await Ce({...m,[z]:R})})}async function be(){const k=m[f+"Team"],S=!["GK","DEF","MIL","ATT"].some(R=>(m[y+"Team"][R]||[]).some(q=>!q.used)),A=(m["selected_"+f]||[]).map(R=>{const q=(k[R._role]||[]).find(fe=>fe.cardId===R.cardId)||R,D=["GK","DEF"].includes(R._role),U=k[R._role]||[],Z=U.findIndex(fe=>fe.cardId===R.cardId),ne=lt(U.length),oe=Z>=0?ne[Z]:q._col??1,te=m.stadiumDef||m.homeStadiumDef||null,se=q.stadiumBonus||te&&(te.club_id&&String(q.club_id)===String(te.club_id)||te.country_code&&q.country_code===te.country_code)||!1;return{...q,_line:R._role,_col:oe,stadiumBonus:se,...D?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!A.length)return;const C=ci(A,m.modifiers[f]||{},m[f+"Formation"]);pe(f,A.map(R=>R.cardId)),A.forEach(R=>{const q=(k[R._role]||[]).find(D=>D.cardId===R.cardId);q&&(q.used=!0)}),m["selected_"+f]=[],O();const z=[...m.log||[]];if(S){if(A.length===1&&(A[0]._line==="GK"||A[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await ce({side:f,gk:A[0]},{...m,[f+"Team"]:k,log:z});return}const q=(m[f+"Score"]||0)+1,D=A.map(te=>Gt(te));z.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:D,homeTotal:C.total,aiTotal:0});const U=(m.round||0)+1,Z=f==="p1"?"p2":"p1",ne={...m,[f+"Team"]:k,[f+"Score"]:q},oe=De(ne);B.add(U),tt(D,q,m[y+"Score"]||0,!0,async()=>{await L({[f+"Team"]:k,[f+"Score"]:q,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},pendingAttack:null,phase:oe?"finished":Z+"-attack",attacker:Z,round:U,log:z}),oe&&await Ce({...m,[f+"Score"]:q})});return}z.push({type:"pending",text:`⚔️ ${m[f+"Name"]} attaque (${C.total})`}),await L({[f+"Team"]:k,[y+"Team"]:m[y+"Team"],pendingAttack:{...C,players:A,side:f},["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},phase:y+"-defense",log:z})}async function ke(){const k=m[f+"Team"],S=(m["selected_"+f]||[]).map(me=>{const _e=(k[me._role]||[]).find(je=>je.cardId===me.cardId)||me,$e=k[me._role]||[],re=$e.findIndex(je=>je.cardId===me.cardId),ze=lt($e.length),Ne=re>=0?ze[re]:_e._col??1;return{..._e,_line:me._role,_col:Ne}}),A=pi(S,m.modifiers[f]||{},m[f+"Formation"]);pe(f,S.map(me=>me.cardId)),S.forEach(me=>{const _e=(k[me._role]||[]).find($e=>$e.cardId===me.cardId);_e&&(_e.used=!0)}),m["selected_"+f]=[],O();const C=po(m.pendingAttack.total,A.total,m.modifiers[f]||{}),z=m.pendingAttack.side,R=C==="attack"||(C==null?void 0:C.goal),q=z==="p1"?"p2":"p1",D=(m.round||0)+1,U=(m.pendingAttack.players||[]).map(me=>Gt(me)),Z=[...m.log||[]];Z.push({type:"duel",isGoal:R,homeScored:R&&z===f,text:R?`⚽ BUT de ${m[z+"Name"]} ! (${m.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${A.total})`,homePlayers:U,aiPlayers:S.map(me=>Gt(me)),homeTotal:m.pendingAttack.total,aiTotal:A.total});const ne=R?(m[z+"Score"]||0)+1:m[z+"Score"]||0,oe={...m,[f+"Team"]:k,[z+"Score"]:ne},te=De(oe),se=te?"finished":q+"-attack",fe=!te&&!R?H(oe):null,we=async()=>{if(fe){await ce(fe,oe);return}await L({[f+"Team"]:k,[y+"Team"]:m[y+"Team"],[z+"Score"]:ne,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},pendingAttack:null,phase:se,attacker:q,round:D,log:Z}),(se==="finished"||te)&&await Ce({...m,[z+"Score"]:ne})};if(R){const me=z===f,_e=me?ne:m[f+"Score"]||0,$e=me?m[y+"Score"]||0:ne;B.add(D),tt(U,_e,$e,me,we)}else await we()}function Ee(k){return["MIL","ATT"].some(S=>(k[S]||[]).some(A=>!A.used))}function Se(k){return["GK","DEF","MIL","ATT"].some(S=>(k[S]||[]).some(A=>!A.used))}function ye(k){return Se(k)&&!Ee(k)}function Le(k){const S=m[k+"Team"],A=m[(k==="p1"?"p2":"p1")+"Team"];return!!(Ee(S)||ye(S)&&!Se(A)||ye(S)&&!Ee(A)&&Se(A))}function De(k){return!Se(k.p1Team)&&!Se(k.p2Team)}function Me(k){const S=k.p1Score||0,A=k.p2Score||0;return S===A?null:S>A?h.home_id:h.away_id}async function Ce(k){Ot(),Ve();try{const S=Me(k),A=S?h.home_id===S?h.away_id:h.home_id:null,C=k.p1Score||0,z=k.p2Score||0,{data:R,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:S,p_home_score:C,p_away_score:z,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(D){console.error("[PvP] check_and_finish_mini_league:",D)}S&&A&&ra(S,A).catch(()=>{});try{const{data:D}=await v.rpc("apply_match_rewards",{p_match_id:i});D!=null&&D.success&&!(D!=null&&D.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(D){console.error("[PvP] apply_match_rewards:",D)}if(typeof s=="function")try{await s({homeScore:C,awayScore:z,winnerId:S,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(D){console.error("[PvP] onMatchEnd:",D)}}catch(S){console.error("[PvP] finishMatch:",S)}}function He(){var z;const k=m[f+"Score"],S=m[y+"Score"],A=k>S,C=k===S;ct(t),t.innerHTML=`
    ...
    </div>`,(z=document.getElementById("pvp-home"))==null||z.addEventListener("click",()=>{try{v.removeChannel(K)}catch{}Ye(t),l?g("mini-league",{openLeagueId:l}):g("home")})}O()}async function Xi(t,e,i=!1){var d,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:c.rankedData)||null;await Ci(t,e,i?"ranked":"random",async({deckId:s,formation:l,starters:p,subsRaw:b,gcCardsEnriched:g,gcDefs:x,stadiumDef:f})=>{ct(t);const y=async u=>{await da(t,e,s,l,p,b,u||[],x,f,i,a)};if(!(g!=null&&g.length)){await y([]);return}Ai(t,g,y)})}async function sa(t,e,i){return aa(t,e,i)}async function da(t,e,i,o,r,n,a=[],d=[],c=null,s=!1,l=null){var Y,K;const{state:p,navigate:b,toast:g}=e,x=(l==null?void 0:l.mmr)??((Y=p.profile)==null?void 0:Y.mmr)??1e3,f=s?At(x):null,y=s?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",u=s?(f==null?void 0:f.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Mt}">
      ${w.map(m=>`<button class="ml-tab" data-tab="${m.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===m.key?wn:"transparent"};background:none;font-size:12px;font-weight:${i===m.key?"900":"600"};color:${i===m.key?"#4ade80":ma};cursor:pointer">${m.label}${m.count?` (${m.count})`:""}</button>`).join("")}
    </div>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let s="buy";const l=()=>{var y,u,w,h,E,m,T;return{name:(((y=document.getElementById("flt-name"))==null?void 0:y.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((w=document.getElementById("flt-country"))==null?void 0:w.value)||"").toLowerCase().trim(),job:((h=document.getElementById("flt-job"))==null?void 0:h.value)||"",rarity:((E=document.getElementById("flt-rarity"))==null?void 0:E.value)||"",note1:parseInt((m=document.getElementById("flt-note1"))==null?void 0:m.value)||0,note2:parseInt((T=document.getElementById("flt-note2"))==null?void 0:T.value)||0}};function p(y){const u=l();return y.filter(w=>{var V,Y,K;const h=(V=w.card)==null?void 0:V.player;if(!h)return!1;const E=`${h.firstname} ${h.surname_real}`.toLowerCase(),m=(((Y=h.clubs)==null?void 0:Y.encoded_name)||"").toLowerCase(),T=(h.country_code||"").toLowerCase(),$=((K=w.card)==null?void 0:K.evolution_bonus)||0,I=hi(h,h.job,$),B=h.job2?hi(h,h.job2,$):0;return!(u.name&&!E.includes(u.name)||u.club&&!m.includes(u.club)||u.country&&!T.includes(u.country)||u.job&&h.job!==u.job||u.rarity&&h.rarity!==u.rarity||u.note1&&I<u.note1||u.note2&&B<u.note2)})}function b(y){var m,T,$;const u=(m=y.card)==null?void 0:m.player;if(!u)return"";const w=((T=y.card)==null?void 0:T.evolution_bonus)||0,h=(i.profile.credits||0)>=y.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function g(y){var Y,K,L,_;const u=(Y=y.card)==null?void 0:Y.player;if(!u)return"";const w=((K=y.card)==null?void 0:K.evolution_bonus)||0,h=hi(u,u.job,w),E=u.job2?hi(u,u.job2,w):0,m=y.status==="sold",T=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,$=Go[u.job]||"#bbb",I=u.job2?Go[u.job2]||"#bbb":null,B=u.job==="GK"?"#fff":$,V=u.job2==="GK"?"#fff":I;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${m?"opacity:0.7":""}">
  ...
  </div>`,p(),(f=document.getElementById("tab-ranked"))==null||f.addEventListener("click",()=>{c="ranked",p()}),(y=document.getElementById("tab-mini-league"))==null||y.addEventListener("click",()=>{c="mini-league",p()}),(u=document.getElementById("tab-random"))==null||u.addEventListener("click",()=>{c="random",p()})}async function ja(t,e){var T,$,I,B;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:d}]=await Promise.all([v.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),v.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!d){r("Erreur chargement profil","error"),o("home");return}if(!a){const V=d.mmr??1e3,Y=At(V);Gi(V);const K=Math.round(1e3+(V-1e3)*.5),L=At(K),{data:_}=await v.from("users").select("id, pseudo, club_name, mmr, rank_tier").order("mmr",{ascending:!1}).limit(100),N=(_||[]).findIndex(G=>G.id===d.id)+1;t.innerHTML=`
  ...
  </div>`}Tn(zn);const he={user:null,profile:null,page:"home",params:{}};function yt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ba(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Qi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ni(){if(!he.user)return;const{data:t}=await v.from("users").select("*").eq("id",he.user.id).single();t&&(he.profile=t)}const $n="mw_theme";function ai(){return localStorage.getItem($n)||"dark"}function Oo(t){var e;localStorage.setItem($n,t),vi(t),(e=he.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",he.profile.id).then(()=>{})}function vi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=he.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=he.profile)==null?void 0:i.club_color2)||"#080d08"))}function $t(t,e={}){he.page=t,he.params=e,En()}async function En(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===he.page)});const e=document.getElementById("nav-credits");e&&he.profile&&(e.textContent=`💰 ${(he.profile.credits||0).toLocaleString("fr")}`);const i={state:he,navigate:$t,toast:yt,openModal:Ba,closeModal:Qi,refreshProfile:ni};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',he.page){case"home":await Fi(t,i);break;case"home2":await Fi(t,i);break;case"game":await br(t,i);break;case"settings":await ln(t,i);break;case"collection":await $r(t,i);break;case"decks":await Ui(t,i);break;case"boosters":await Gn(t,i);break;case"ranked":await ja(t,i);break;case"match":{const d=he.params&&he.params.matchMode||"vs_ai_easy";d==="random"?await Xi(t,i,!1):d==="ranked"?await Xi(t,i,!0):d==="friend"?await pa(t,i,(o=he.params)==null?void 0:o.friendId,(r=he.params)==null?void 0:r.friendName):d==="mini_league"||d==="mini-league"?await No(t,i,(n=he.params)==null?void 0:n.mlMatchId,(a=he.params)==null?void 0:a.leagueId):await Pr(t,i);break}case"market":await Ia(t,i);break;case"rankings":await Ca(t,i);break;case"matches":await qa(t,i);break;case"friends":await fr(t,i);break;case"mini-league":await ga(t,i);break;case"match-mini-league":{const d=he.params||{};await No(t,i,d.mlMatchId,d.leagueId);break}default:await Fi(t,i)}}function Da(){var o,r;const t=document.getElementById("app"),e=he.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.31-1034" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),$t(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>$t("home")),document.getElementById("nav-credits").addEventListener("click",()=>$t("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>Fa()),(r=document.getElementById("settings-btn"))==null||r.addEventListener("click",()=>$t("settings"))}async function Fa(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const r=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${r}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Ra(){vi(ai()),document.getElementById("modal-overlay").addEventListener("click",o=>{o.target===o.currentTarget&&Qi()}),document.getElementById("modal-close").addEventListener("click",Qi);const{data:{session:t}}=await v.auth.getSession();if(!t){Ho(),Pa(document.getElementById("app"),{onPlay:()=>ko(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:yt})});return}he.user=t.user,await ni(),vi(ai()),Ho();try{const{data:o}=await v.from("formation_links_overrides").select("formation, links"),r={};(o||[]).forEach(n=>{r[n.formation]=n.links}),In(r)}catch(o){console.warn("Impossible de charger les overrides de formation:",o)}if(!he.profile){Mn(document.getElementById("app"),{state:he,navigate:async()=>{await ni(),vi(ai()),Ni()},toast:yt,refreshProfile:ni});return}const e=Array.isArray(he.profile.pending_boosters)?he.profile.pending_boosters:[];if(!he.profile.onboarding_done&&e.length>0){Xn(document.getElementById("app"),{state:he,toast:yt,refreshProfile:ni,navigate:()=>{Ni(),setTimeout(()=>Lo(he.profile,$t,yt),800)}});return}Ni(),new URLSearchParams(location.search).get("tutorial")==="1"?(history.replaceState({},"",location.pathname),setTimeout(()=>so(he.profile,$t,yt),800)):setTimeout(()=>Lo(he.profile,$t,yt),800),v.auth.onAuthStateChange(async(o,r)=>{o==="SIGNED_OUT"&&(he.user=null,he.profile=null,document.getElementById("app").innerHTML="",ko(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:yt}))})}function Na(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function ji(){const t=document.getElementById("app");t&&(t.style.height=Na()+"px")}window.addEventListener("resize",ji);window.addEventListener("orientationchange",()=>setTimeout(ji,150));window.visualViewport&&window.visualViewport.addEventListener("resize",ji);function Ni(){const t=()=>{var i;(i=he.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",he.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",ji(),Da(),En()}function Ho(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function Ln(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
