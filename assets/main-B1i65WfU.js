import{s as $,l as ae,F as Ge,b as xe,c as st,d as Mt}from"./formation-links-CDBKB_z4.js";function Ye(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(a);let d=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(d)return;d=!0;const f=document.getElementById("pack-visual");f.classList.add("shaking"),setTimeout(()=>{f.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",s(0)},600)},500)});let o=0;function s(f){o=f;const m=document.getElementById("reveal-phase");m.style.display="flex",l(f)}function l(f){var T;const m=e[f],y=document.getElementById("card-counter"),h=document.getElementById("single-card-slot"),_=document.getElementById("card-tap-hint");y&&(y.textContent=`Carte ${f+1} / ${e.length}`),_&&(_.textContent=f<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const b=it(m),x=m.card_type==="player"&&((T=m.player)==null?void 0:T.rarity)==="legende";h.innerHTML=`
      ...
      </div>`,x&&c();const w=document.getElementById("current-card-wrap");let I=!1;w.addEventListener("click",()=>{if(I)return;I=!0;const g=f+1;g<e.length?(w.style.transition="all 0.25s ease",w.style.transform="translateX(-120%) rotate(-15deg)",w.style.opacity="0",setTimeout(()=>l(g),250)):r()})}function r(){p(),document.getElementById("reveal-phase").style.display="none";const f=document.getElementById("recap-phase");f.style.display="flex";const m=document.getElementById("recap-grid");m.innerHTML=e.map((y,h)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const ui="simulation",bt="VOTRE_ZONE_ID";function fi(){switch(ui){case"propellerads":return gi();case"adsense":return xi();default:return Ne()}}function Ne(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
    ...
    </div>`}function s(){var r,n;e.style.overflow="hidden";const l=e.clientHeight||e.getBoundingClientRect().height;e.style.height=l+"px",e.innerHTML=`
    <div style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px">
        ${t.map(c=>{const p=d.find(u=>u.id===c.id);return`<div style="position:relative">${o(c,!!p)}</div>`}).join("")}
      </div>
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(c=>{c.addEventListener("click",()=>{const p=c.dataset.id,u=d.findIndex(f=>f.id===p);if(u>-1)d.splice(u,1);else{if(d.length>=3)return;const f=t.find(m=>m.id===p);f&&d.push(f)}s()})}),(r=e.querySelector("#gc-sel-confirm"))==null||r.addEventListener("click",()=>{d.length&&i(d)}),(n=e.querySelector("#gc-sel-skip"))==null||n.addEventListener("click",()=>{i([])})}s()}async function wi(e,t,i){const{state:a,navigate:d}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await $.from("decks").select("id,name,is_active,formation").eq("owner_id",a.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){vt(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>d("decks"));return}const s=o.map(c=>c.id),{data:l}=await $.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let r=0;function n(){var b,x,w,I,T;const c=o[r],p=(l||[]).filter(g=>g.deck_id===c.id),u=p.filter(g=>{var v;return g.is_starter&&((v=g.card)==null?void 0:v.player)}).map(g=>je(g.card)),f=p.find(g=>{var v;return((v=g.card)==null?void 0:v.card_type)==="formation"}),m=c.formation||((b=f==null?void 0:f.card)==null?void 0:b.formation)||"4-4-2",y=u.length>=11?wt(u,m):null,h=u.length>=11;e.innerHTML=`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>_i(e,t,i),5e3)}function _i(e,t,i){const a=t.homeTeam.MIL||[],d=t.aiTeam.MIL||[];function o(p){return p.reduce((u,f)=>u+H(f,"MIL"),0)}function s(p){let u=0;for(let f=0;f<p.length-1;f++){const m=ae(p[f],p[f+1]);m==="#00ff88"?u+=2:m==="#FFD700"&&(u+=1)}return u}const l=o(a)+s(a),r=o(d)+s(d),n=l>=r;function c(p,u,f){return`<div style="text-align:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((m,y)=>{const h=W(m),_=y<p.length-1?ae(m,p[y+1]):null,b=_&&_!=="#ff3333"&&_!=="#cc2222";return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
      ...
      `,n&&(t.boostCard={value:m})}t.attacker=n?"home":"ai",t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:a.map(m=>({name:m.name,note:H(m,"MIL"),portrait:W(m),job:m.job,country_code:m.country_code,rarity:m.rarity,clubName:m.clubName,clubLogo:m.clubLogo})),aiPlayers:d.map(m=>({name:m.name,note:H(m,"MIL"),portrait:W(m),job:m.job,country_code:m.country_code,rarity:m.rarity,clubName:m.clubName,clubLogo:m.clubLogo})),homeTotal:l,aiTotal:r,text:`Duel milieu : ${t.clubName} ${l} – ${r} IA → ${n?t.clubName+" attaque":"IA attaque"}`}),setTimeout(()=>{var y,h;const m=(y=t.boostCard)==null?void 0:y.value;e.innerHTML=`
  ...
  `;function l(r){const n=document.getElementById("mkt-content"),c=r==="buy"?s:o;if(c.length===0){n.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(p=>{var h,_,b;const u=(h=p.card)==null?void 0:h.player;if(!u)return"";const f=u.job==="GK"?u.note_g:u.job==="DEF"?u.note_d:u.job==="MIL"?u.note_m:u.note_a,m=Bi[u.rarity],y=(i.profile.credits||0)>=p.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
