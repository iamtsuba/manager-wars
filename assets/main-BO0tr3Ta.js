...
import{s as h,j as hi,q as In,t as Ut,u as Oi,F as Hi,o as tt,n as ti,g as At,r as Ie,m as Mt,v as Mi,w as co,T as Ti,p as po,x as uo,d as fo}from"./special-cards-q1oKjNQl.js";const mo="/";function pn(e,{navigate:t,toast:i}){let n="login";const o=()=>{var a,s,d,c,l,f,b;const r=n==="login";if(e.innerHTML=`
  ...
  `;function s(){var g;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=r),l&&(l.textContent=x,l.style.color=r)}document.getElementById("color1").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch1").style.background=r,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await h.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await h.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await h.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:r,club_color2:a,credits:1e4});if(x)throw x;await xo(t.user.id),await o(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function xo(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await h.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const bo="modulepreload",yo=function(e){return"/"+e},un={},Ui=function(t,i,n){let o=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));o=Promise.allSettled(i.map(d=>{if(d=yo(d),d in un)return;un[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":bo,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return o.then(a=>{for(const s of a||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},ii="#1A6B3C",ni="#cc2222",vo="#D4A017",fn="#888";async function ho(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${b.map(({friendshipId:x,friend:g})=>wo(g,x)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(x=>{x.addEventListener("click",()=>ko(e,x.dataset.stats,x.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(x=>{x.addEventListener("click",async()=>{const g=x.dataset.friendId,p=x.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:y}=await h.from("friend_match_invites").select("id").eq("inviter_id",g).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!y;console.log("[Friends] clic match",{fid:g,fname:p,isAccepting:w}),n("match",{matchMode:"friend",friendId:g,friendName:p,isAccepting:w})})})}function wo(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",o=(n||i).slice(0,2).toUpperCase(),r=e.club_color2||ii,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
  ...
  <div class="home-dark" id="home-dark">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close-v2").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}async function Fo(e,{state:t,navigate:i,toast:n}){var m,M,k,I,F,W,te,Z,A,T,V,J,ue,fe,C,Y,pe;const o=t.profile;if(!o)return;const r="/icons/",a=o.mmr??1e3,s=hi(a),d=Co(a,s),c=In(a),l=isFinite(s.max)?s.max+1:null,[{list:f,iAmInTop:b,myPosition:x},g,p]=await Promise.all([jo(o.id),Bo(5),qo()]),u=(B,O)=>`
    <div class="rk-row ${B.id===o.id?"rk-row-me":""}">
      <div class="rk-pos ${O<3?"rk-pos-top"+(O+1):""}">${O<3?["🥇","🥈","🥉"][O]:O+1}</div>
      <div class="rk-name ${B.id===o.id?"rk-name-me":""}">${B.pseudo}</div>
      <div class="rk-rp">${(B.mmr??0).toLocaleString("fr")} RP</div>
    </div>`,y=B=>`
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Mo(B.published_at)}</div>
      </div>
    </div>`;let w=0;const v=B=>`
    <div class="promo-icon-wrap">
      <img src="${r}${B.icon||"nav-boosters.png"}" class="promo-icon" onerror="this.style.display='none'">
    </div>
  ...
  <div class="home-dark" id="home-dark">
    <div class="home-inner">
      ...
      <div class="home2-header">
        ...
        <div class="home2-tabs-row">
          <a class="home2-tab active" id="tab-home"><img src="${r}nav-home.png" class="nav-icon">HOME</a>
          <a class="home2-tab" id="tab-cards"><img src="${r}nav-collection.png" class="nav-icon">CARDS</a>
          <a class="home2-tab" id="tab-decks"><img src="${r}nav-decks.png" class="nav-icon">DECKS</a>
          <a class="home2-tab" id="tab-boosters"><img src="${r}nav-boosters.png" class="nav-icon">BOOSTERS</a>
          <a class="home2-tab" id="tab-market"><img src="${r}nav-market.png" class="nav-icon">MERCATO</a>
        </div>
        <div class="home2-header-right">
          <button class="home2-settings-btn" id="header-settings-btn">⚙️</button>
          <div class="home2-credits" id="header-credits">💰 ${(o.credits||0).toLocaleString("fr")}</div>
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-center">
          ...
          <div class="promo-banner" id="promo-banner">
            ...
            ${p.length>1?`<div class="promo-dots">${p.map((B,O)=>`<div class="promo-dot ${O===0?"active":""}" data-dot="${O}"></div>`).join("")}</div>`:""}
          </div>`:""}
        </div>
  ...
  </div>`,requestAnimationFrame(()=>{var D;const B=((D=window.visualViewport)==null?void 0:D.height)||window.innerHeight,O=document.querySelector(".top-nav"),$=document.querySelector(".bottom-nav"),q=O&&O.offsetParent!==null?O.offsetHeight:0,U=$&&$.offsetParent!==null?$.offsetHeight:0,H=B-q-U,oe=e.querySelector(".home-dark");oe&&(oe.style.minHeight=H+"px")});const E=()=>{const B=document.getElementById("mode-indicator");B&&(B.textContent=window.innerWidth>=1024?"🖥️ Mode PC":"📱 Mode Mobile")};if(E(),window.addEventListener("resize",E),(m=document.getElementById("tab-home"))==null||m.addEventListener("click",()=>i("home2")),(M=document.getElementById("header-settings-btn"))==null||M.addEventListener("click",()=>i("settings")),(k=document.getElementById("header-credits"))==null||k.addEventListener("click",()=>i("boosters")),(I=document.getElementById("header-add-btn"))==null||I.addEventListener("click",()=>i("boosters")),(F=document.getElementById("tab-cards"))==null||F.addEventListener("click",()=>i("collection")),(W=document.getElementById("tab-decks"))==null||W.addEventListener("click",()=>i("decks")),(te=document.getElementById("tab-boosters"))==null||te.addEventListener("click",()=>i("boosters")),(Z=document.getElementById("tab-market"))==null||Z.addEventListener("click",()=>i("market")),(A=document.getElementById("nav-settings-btn"))==null||A.addEventListener("click",()=>i("settings")),(T=document.getElementById("nav-edit-btn"))==null||T.addEventListener("click",()=>i("settings")),(V=document.getElementById("nav-profile-btn"))==null||V.addEventListener("click",()=>i("settings")),(J=document.getElementById("nav-rankings-link"))==null||J.addEventListener("click",()=>i("rankings")),(ue=document.getElementById("nav-rankings-cta"))==null||ue.addEventListener("click",()=>i("rankings")),(fe=document.getElementById("rank-inline-link-btn"))==null||fe.addEventListener("click",()=>i("rankings")),(C=document.getElementById("nav-journal-link"))==null||C.addEventListener("click",()=>Do()),e.querySelectorAll("[data-action]").forEach(B=>{B.addEventListener("click",()=>{B.style.transform="scale(.96)",setTimeout(()=>B.style.transform="",180);const O=B.dataset.action;if(O==="match-ai"){Oo(i);return}if(O==="match-random"){i("match",{matchMode:"random"});return}if(O==="match-friend"){i("friends");return}if(O==="mini-league"){i("mini-league");return}if(O==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),p.length>1){const B=document.getElementById("promo-slide-content"),O=()=>Array.from(document.querySelectorAll(".promo-dot")),$=q=>{w=q,B&&(B.innerHTML=v(p[w])),O().forEach((U,H)=>U.classList.toggle("active",H===w))};setInterval(()=>$((w+1)%p.length),5e3),document.querySelectorAll(".promo-dot").forEach(q=>{q.addEventListener("click",()=>$(Number(q.dataset.dot)))})}(Y=document.getElementById("promo-cta-btn"))==null||Y.addEventListener("click",()=>i("boosters")),document.getElementById("logout-btn").addEventListener("click",async()=>{await h.auth.signOut(),window.location.reload()}),(pe=document.getElementById("back-to-v1-btn"))==null||pe.addEventListener("click",()=>i("home")),qn(t,n),No(t,n,i),Bn(t,n,i),Po(t,n)}async function Po(e,t){const i=e.profile.id,{data:n}=await h.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(n!=null&&n.length))return;const o=n.reduce((a,s)=>a+(s.prize_amount||0),0),r=document.createElement("div");r.className="modal-overlay",r.style.zIndex="2200",r.innerHTML=`<div class="modal" style="max-width:400px">
    <div class="modal-header"><h2 style="color:#1A6B3C">🏆 Gains à récupérer</h2></div>
    <div class="modal-body" style="padding:18px 20px">
      <p style="font-size:14px;color:#555;margin:0 0 14px">Tu as terminé sur le podium de ${n.length>1?"plusieurs mini leagues":"une mini league"} !</p>
      <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px">
      ...
      <button data-resume="${d.id}" data-mini="${f?"1":""}" style="width:38px;height:38px;border-radius:50%;border:none;background:#22c55e;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">⚽</button>
      <button data-abandon="${d.id}" data-opp="${c}" style="width:38px;height:38px;border-radius:50%;border:none;background:#cc2222;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">✕</button>
    </div>`}).join(""),n.querySelectorAll("[data-resume]").forEach(d=>{d.addEventListener("click",async()=>{const c=document.getElementById("page-content")||document.getElementById("app");if(d.dataset.mini==="1"){const{data:l}=await h.from("mini_league_matches").select("id, league_id").eq("match_id",d.dataset.resume).single();l?i("match-mini-league",{mlMatchId:l.id,leagueId:l.league_id}):i("mini-league")}else{const{resumePvpMatch:l}=await Ui(async()=>{const{resumePvpMatch:f}=await Promise.resolve().then(()=>eo);return{resumePvpMatch:f}},void 0);l(c,{state:e,navigate:i,toast:t,openModal:null,closeModal:null,refreshProfile:null},d.dataset.resume)}})}),n.querySelectorAll("[data-abandon]").forEach(d=>{d.addEventListener("click",()=>{Go(async()=>{await Ro(d.dataset.abandon,d.dataset.opp,o),t("Match abandonné (défaite 3-0)","info"),Bn(e,t,i)})})})}async function Ro(e,t,i){Tt();const{data:n}=await h.from("matches").select("home_id, away_id, game_state, mode").eq("id",e).single();if(!n)return;const o=n.home_id===i,r=o?0:3,a=o?3:0,s=n.game_state||{};s.p1Score=r,s.p2Score=a,s.phase="finished",s.forfeit=!0,await h.from("matches").update({status:"finished",forfeit:!0,winner_id:t,home_score:r,away_score:a,game_state:s}).eq("id",e),n.mode==="mini_league"&&await h.from("mini_league_matches").update({status:"finished",home_score:r,away_score:a}).eq("match_id",e)}function Go(e){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`<div class="modal" style="max-width:340px">
    <div class="modal-body" style="padding:26px 22px 20px;text-align:center">
      <div style="font-size:40px;margin-bottom:8px">⚠️</div>
      <div style="font-size:17px;font-weight:900;margin-bottom:6px;color:#1a1a1a">Abandonner le match ?</div>
      <div style="font-size:13px;color:#666;margin-bottom:18px">Tu perdras par forfait <b>3-0</b>.</div>
  ...
  </div>`,document.body.appendChild(t),t.querySelector("#ab-cancel").addEventListener("click",()=>t.remove()),t.querySelector("#ab-ok").addEventListener("click",()=>{t.remove(),e()}),t.addEventListener("click",i=>{i.target===t&&t.remove()})}async function No(e,t,i){var s,d,c,l;const n=document.getElementById("match-invite-banner");if(!n)return;const{data:o}=await h.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",e.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!o){n.innerHTML="";return}const r=((s=o.inviter)==null?void 0:s.club_name)||((d=o.inviter)==null?void 0:d.pseudo)||"?",a=o.inviter_id;n.innerHTML=`<div id="match-invite-btn" style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(26,10,46,0.8),rgba(74,26,138,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(122,40,184,0.4);cursor:pointer;box-shadow:0 3px 12px rgba(74,10,138,0.3)">
    <div style="background:rgba(255,255,255,0.15);border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0">⚽</div>
    <div style="flex:1"><div style="font-size:13px;font-weight:900">${r} t'invite à jouer !</div><div style="font-size:11px;opacity:0.75">Accepter la partie ?</div></div>
    <div style="display:flex;gap:8px">
      <button id="match-inv-accept" style="padding:6px 12px;border-radius:8px;border:none;background:#22c55e;color:#fff;font-size:12px;font-weight:900;cursor:pointer">Jouer !</button>
    ...
    <div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:900">${r} demande${r>1?"s":""} d'ami${r>1?"s":""}</div><div style="font-size:11px;opacity:0.85;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${a}${s}</div></div>
    <div style="font-size:20px;flex-shrink:0">›</div>
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>Ki(e,t,()=>qn(e,t)))}function Oo(e){const t=[{mode:"vs_ai_easy",label:"Facile",desc:"Pour découvrir le jeu",credits:"500",icon:"🟢",bg:"#eefaf2",border:"#bfe8cf",iconBg:"#1A6B3C",text:"#12401f"},{mode:"vs_ai_medium",label:"Moyen",desc:"Un défi équilibré",credits:"1 000",icon:"🟡",bg:"#fdf7e6",border:"#f0dd9e",iconBg:"#D4A017",text:"#5c4408"},{mode:"vs_ai_hard",label:"Difficile",desc:"Réservé aux experts",credits:"1 500",icon:"🔴",bg:"#fdecec",border:"#f3bcbc",iconBg:"#bb2020",text:"#5c1010"}],i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:400px;border-radius:18px;overflow:hidden">
    <div class="modal-header"><h2>Choisir la difficulté</h2><button class="btn-icon" id="diff-cancel">✕</button></div>
    <div class="modal-body" style="padding:16px">
      <div style="display:flex;flex-direction:column;gap:10px">
        ${t.map(o=>`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Ie(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),b=(s||[]).filter($=>$.card_type==="stadium"),{data:x}=await h.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach($=>{g[$.name]=$});const{data:p}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),b.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const y=Object.keys(Hi),w=Object.keys(je),v={};c.forEach($=>{const q=$.player.id;v[q]=(v[q]||0)+1}),new Set(Object.keys(v).map($=>String($)));const E=new Set(f.map($=>$.formation)),m=new Set(l.map($=>$.gc_type));let M="player",k="Tous",I="",F=!1;function W(){return[...c].sort(($,q)=>{const U=di.indexOf($.player.job),H=di.indexOf(q.player.job);return U!==H?U-H:($.player.surname_real||"").localeCompare(q.player.surname_real||"")})}function te(){return[...d||[]].sort(($,q)=>{const U=di.indexOf($.job),H=di.indexOf(q.job);return U!==H?U-H:($.surname_real||"").localeCompare(q.surname_real||"")})}function Z(){return W().filter($=>{const q=$.player,U=k==="Tous"||q.job===k,H=!I||`${q.firstname} ${q.surname_real}`.toLowerCase().includes(I);return U&&H})}function A(){return te().filter($=>{const q=k==="Tous"||$.job===k,U=!I||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(I);return q&&U})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(q){const U=document.getElementById(q);if(!U)return;U.addEventListener("wheel",de=>{Math.abs(de.deltaY)<=Math.abs(de.deltaX)||(de.preventDefault(),U.scrollLeft+=de.deltaY)},{passive:!1});let H=!1,oe=0,D=0,G=!1,se=!1;U.addEventListener("mousedown",de=>{H=!0,G=!1,oe=de.pageX,D=U.scrollLeft}),window.addEventListener("mouseup",()=>{H=!1,G&&(U.style.cursor="",se=!0),G=!1}),window.addEventListener("mousemove",de=>{if(!H)return;const he=de.pageX-oe;!G&&Math.abs(he)<6||(G=!0,U.style.cursor="grabbing",de.preventDefault(),U.scrollLeft=D-he)}),U.addEventListener("click",de=>{se&&(de.stopPropagation(),de.preventDefault(),se=!1)},!0)}("col-grid");function T(){const $=document.getElementById("col-filters");$&&(M==="player"?($.innerHTML=`
        ...
        <div style="display:flex;gap:6px;overflow-x:auto;padding-bottom:2px;align-items:center">
          ${Ko.map(q=>`
            <button class="filter-btn" data-job="${q}"
              style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
                border:1.5px solid ${q===k?"var(--green)":"var(--tile-border)"};
                background:${q===k?"var(--green)":"#fff"};
                color:${q===k?"#fff":"var(--tile-fg-dim)"}">
              ${q}
            </button>`).join("")}
          <button id="show-all-btn"
            style="flex-shrink:0;margin-left:auto;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
              ...
              color:${F?"#111":"var(--tile-fg-dim)"}; font-size:18px; padding:5px 10px">
            ${F?"👁️":"🚫👁️"}
          </button>
        </div>`,document.getElementById("col-search").addEventListener("input",q=>{I=q.target.value.toLowerCase(),V()}),e.querySelectorAll(".filter-btn").forEach(q=>{q.addEventListener("click",()=>{k=q.dataset.job,T(),V()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{F=!F,T(),V()})):($.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{F=!F,T(),V()})))}function V(){const $=document.getElementById("col-grid");$&&(M==="player"?Y($):M==="formation"?pe($):M==="stadium"?O($):B($))}function J($,q,U,H,oe,D=0){const G=document.getElementById("col-grid"),se=document.getElementById("col-big");if(!G||!se)return;var de=0;function he(){var ct;const Te=window.innerWidth>=768,ve=document.getElementById("col-big"),ze=document.getElementById("col-gap"),Se=((ct=document.getElementById("col-grid"))==null?void 0:ct.parentElement)||null,Be=ve?ve.closest(".page"):null;if(ve&&Se&&Be){let $e=0;Array.from(Be.children).forEach(function(j){j!==ve&&j!==Se&&j!==ze&&($e+=j.offsetHeight)});const Ce=Math.max(0,Be.clientHeight-$e),qe=Math.round(Ce*(D/100)),Re=Math.max(0,Ce-qe),_=Te?50/71:45/63,L=Math.round(Re*_),S=Math.max(0,Re-L);ze&&(ze.style.height=qe+"px"),ve.style.flex="none",ve.style.height=L+"px",ve.style.minHeight="0",Se.style.flex="none",Se.style.height=S+"px",Se.style.minHeight="0",Se.style.display="flex",Se.style.overflow="hidden"}const ke=document.getElementById("col-grid");ke&&(ke.style.height="100%",ke.style.flexShrink="0",ke.style.overflowX="auto",ke.style.overflowY="hidden",ke.style.alignItems="center",ke.style.width="100%"),se.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+q($[de])+"</div>";var _t=se.querySelector("[data-card-id],[data-form-id],[data-gc-id]");_t&&_t.addEventListener("click",function(){H($[de])}),requestAnimationFrame(function(){var $e=document.getElementById("big-card-inner");if(!(!$e||!se)){var Ce=se.clientHeight,qe=se.clientWidth-16,Re=$e.offsetHeight,_=$e.offsetWidth;if(Re>0&&_>0&&Ce>40){var L=Math.min(Ce/Re,qe/_);$e.style.transform="scale("+L.toFixed(3)+")",$e.style.transformOrigin="center center"}}}),G.innerHTML=$.map(function($e,Ce){var qe=Ce===de,Re="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Re+'">'+U($e,qe)+"</div>"}).join(""),G.querySelectorAll(".col-mini-item").forEach(function($e){$e.addEventListener("click",function(){de=Number($e.dataset.idx),he(),$e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var $e=ke?ke.clientHeight:0,Ce=G.querySelector(".col-mini-item > div");if(!(!$e||!Ce)){var qe=Ce.style.zoom;Ce.style.zoom="1";var Re=Ce.offsetHeight;if(Ce.style.zoom=qe,!(Re<=0)){var _=$e/Re;G.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=_.toFixed(4)})}}})}he()}function ue($,q){var U=window.innerWidth>=768?.76:.54,H;if(!$||$._fake){var oe=$?$.player:null;if(!oe)return"";H=yn(oe)}else H=zi($,"");var D=$&&!$._fake?v[$.player&&$.player.id]||1:0,G=D>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+D+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+U+';pointer-events:none;line-height:0">'+G+H+"</div>"}function fe($,q,U){var H=U>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+U+"</div>":"",oe=!!q,D=Mi($,Mt[$],{width:160});return oe||(D='<div style="filter:grayscale(1);opacity:0.5">'+D+"</div>"),"<div "+(q?'data-form-id="'+q.id+'"':"")+' style="position:relative;cursor:pointer">'+H+D+"</div>"}function C($,q){var U=window.innerWidth>=768?.76:.54,H=Mi($,Mt[$],{width:140});return q||(H='<div style="filter:grayscale(1);opacity:0.45">'+H+"</div>"),'<div style="display:inline-block;zoom:'+U+';line-height:0;pointer-events:none">'+H+"</div>"}function Y($){if(F){const q=A();if(!q.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const U=q.map(H=>c.find(oe=>oe.player.id===H.id)||{_fake:!0,player:H,id:"fake-"+H.id});J(U,H=>H._fake?yn(H.player):zi(H,""),H=>H._fake?ue({player:H.player,id:"x",_fake:!0}):ue(H),H=>{H._fake||vn(H,c,v,t)})}else{const q=Z();if(!q.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const U={};q.forEach(oe=>{const D=oe.player.id;U[D]||(U[D]=[]),U[D].push(oe)});const H=Object.values(U).map(oe=>Yo(oe));J(H,oe=>{const D=v[oe.player.id]||1,G=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",de=c.filter(he=>he.player.id===oe.player.id&&he.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return zi(oe,G+de)},oe=>ue(oe),oe=>vn(oe,c,v,t))}}function pe($){const q=F?y:[...E];if(!q.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const U=q.map(H=>({formation:H,card:f.find(oe=>oe.formation===H)||null,owned:E.has(H)}));J(U,({formation:H,card:oe,owned:D})=>fe(H,D?oe:null,D?f.filter(G=>G.formation===H).length:0),({formation:H,owned:oe})=>C(H,oe),({card:H,owned:oe})=>{oe&&H&&Qo(H,f,t,r)},"#1A6B3C",5)}function B($){const q=Object.keys(g),U=F?q.length?q:w:[...m];if(!U.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const H=U.map(oe=>({type:oe,gc:je[oe]||{icon:"⚡",desc:""},def:g[oe]||null,owned:m.has(oe),card:l.find(D=>D.gc_type===oe)||null}));J(H,({type:oe,gc:D,def:G,owned:se,card:de})=>{var ke;const he=(G==null?void 0:G.name)||oe,Te=se?l.filter(_t=>_t.gc_type===oe).length:0,ve=Te>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Te}</div>`:"",ze=(G==null?void 0:G.effect)||D.desc||"",Se=G!=null&&G.image_url?`/icons/${G.image_url}`:((ke=G==null?void 0:G.club)==null?void 0:ke.logo_url)||(G!=null&&G.country_code?`https://flagsapi.com/${G.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=tt(he,Se,D.icon,ze,{width:160,onClick:se});return se||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${se&&de?`data-gc-id="${de.id}" data-gc-type="${oe}"`:""} style="position:relative">${ve}${Be}</div>`},({type:oe,gc:D,def:G,owned:se})=>{const de=window.innerWidth>=768?.76:.54,he=(G==null?void 0:G.name)||oe,Te=(G==null?void 0:G.effect)||D.desc||"",ve=G!=null&&G.image_url?`/icons/${G.image_url}`:null;let ze=tt(he,ve,D.icon,Te,{width:140});return se||(ze=`<div style="filter:grayscale(1);opacity:0.45">${ze}</div>`),`<div style="display:inline-block;zoom:${de};line-height:0;pointer-events:none">${ze}</div>`},({type:oe,owned:D,def:G})=>{D&&Jo(oe,G,r)},"#7a28b8",5)}function O($){const q="#4FC3F7",U="/";if(!b.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const H={};b.forEach(D=>{const G=D.stadium_id||"?";(H[G]=H[G]||[]).push(D)});const oe=Object.entries(H).map(([D,G])=>({sid:D,def:u[D]||null,count:G.length,card:G[0]}));J(oe,({def:D,count:G})=>{var ze,Se;const se=(D==null?void 0:D.name)||"?",de=((ze=D==null?void 0:D.club)==null?void 0:ze.encoded_name)||(D==null?void 0:D.country_code)||"—",he=D!=null&&D.image_url?`${U}icons/${D.image_url}`:((Se=D==null?void 0:D.club)==null?void 0:Se.logo_url)||(D!=null&&D.country_code?`https://flagsapi.com/${D.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Te=G>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${G}</div>`:"",ve=`${de}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${Te}${ti(se,he,ve,{width:160})}</div>`},({def:D})=>{var ve,ze;const G=window.innerWidth>=768?.76:.54,se=(D==null?void 0:D.name)||"?",de=((ve=D==null?void 0:D.club)==null?void 0:ve.encoded_name)||(D==null?void 0:D.country_code)||"—",he=D!=null&&D.image_url?`${U}icons/${D.image_url}`:((ze=D==null?void 0:D.club)==null?void 0:ze.logo_url)||(D!=null&&D.country_code?`https://flagsapi.com/${D.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Te=`${de}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${G};line-height:0;pointer-events:none">${ti(se,he,Te,{width:140})}</div>`},null,q,5)}e.querySelectorAll(".col-tab-btn").forEach($=>{$.addEventListener("click",()=>{M=$.dataset.tab,k="Tous",I="",F=!1,e.querySelectorAll(".col-tab-btn").forEach(q=>{const U=q.dataset.tab===M;q.style.borderBottomColor=U?"var(--green)":"transparent",q.style.color=U?"var(--green)":"var(--tile-fg-dim)"}),T(),V()})}),T(),V()}function Jo(e,t,i){const n=je[e]||{icon:"⚡",desc:"Effet spécial."},o=(t==null?void 0:t.name)||e,r=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${tt(o,a,n.icon,r,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ci=1e3;function Qo(e,t,i,n){var g,p,u;const{state:o,toast:r,closeModal:a,navigate:s,refreshProfile:d}=i,c=e.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=Mt[c]||{},w=Hi[c]||[],v=290,E=360,m=20;function M(I){const F=y[I];return F?{x:F.x*v,y:F.y*E}:null}let k=`<svg width="${v}" height="${E}" viewBox="0 0 ${v} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[I,F]of w){const W=M(I),te=M(F);!W||!te||(k+=`<line x1="${W.x}" y1="${W.y}" x2="${te.x}" y2="${te.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const I of Object.keys(y)){const F=M(I);if(!F)continue;const W=I.replace(/\d+/,""),te=l[W]||"#555";k+=`<circle cx="${F.x}" cy="${F.y}" r="${m}" fill="${te}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,k+=`<text x="${F.x}" y="${F.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${W}</text>`}return k+="</svg>",k}const b=t.filter(y=>y.formation===c);b.length;const x=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${c} pour ${ci.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=b.find(v=>!v.is_for_sale)||b[0];if(!y){r("Aucune carte à vendre","error");return}await h.from("market_listings").delete().eq("card_id",y.id),await h.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await h.from("cards").delete().eq("id",y.id);if(w){r(w.message,"error");return}await h.from("users").update({credits:(o.profile.credits||0)+ci}).eq("id",o.profile.id),await d(),r(`+${ci.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){r("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",e.id),await h.from("market_listings").insert({seller_id:o.profile.id,card_id:e.id,price:y}),r("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),r("Annonce retirée","success"),a(),s("collection")})}async function vn(e,t,i,n){var ue,fe,C,Y,pe;const{state:o,toast:r,openModal:a,closeModal:s,navigate:d,refreshProfile:c}=n,l=e.player,f=t.filter(B=>B.player.id===l.id),b=f.length,x=e.evolution_bonus||0,g=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?x:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?x:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?x:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?x:0)),p=l.rarity||"normal",{data:u}=await h.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((ue=u==null?void 0:u[0])==null?void 0:ue.price)??Vo[p];const y=l.rarity!=="legende";At(l);const w=li(l,l.job)+x,v=l.job2?li(l,l.job2)+(li(l,l.job2)>0?x:0):null;Ii[l.job],l.job2&&Ii[l.job2];const E=Uo[l.rarity]||"#ccc";Wo[l.country_code]||l.country_code;const m=e.evolution_bonus||0,k=w+m,I=v||0,F=I>0?I+m:0,W=f.map(B=>B.id);let te={};if(W.length){const{data:B}=await h.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",W).order("transferred_at",{ascending:!0});(B||[]).forEach(O=>{te[O.card_id]||(te[O.card_id]=[]),te[O.card_id].push(O)})}const Z=W.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${f.filter(B=>B.id!==e.id).map((B,O)=>{const $=te[B.id]||[],q=B.is_for_sale,U=$.length?$[$.length-1]:null,H=B.evolution_bonus||0,oe=U?U.source==="booster"?"Booster":U.price?U.price.toLocaleString("fr")+" cr.":"—":"—",D=U?new Date(U.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",G=80,se=Math.round(G*657/507),de=Ie({...l,_evolution_bonus:H},{width:G});return`
            <div class="exemplaire-row" data-card-id="${B.id}" data-card-idx="${O}"
              style="position:relative;cursor:${q?"not-allowed":"pointer"};opacity:${q?.55:1};transition:transform .1s">
              <!-- Checkbox cachée -->
              <input type="checkbox" class="expl-check"
                data-id="${B.id}" data-evo="${H}" data-note="${li(l,l.job)}"
                ${q?"disabled":""}
                style="display:none">
              ...
              <div class="expl-mini-card" style="position:relative;width:${G}px;height:${se}px;border-radius:8px;overflow:hidden">
                ...
                ${q?'<div style="position:absolute;top:0;right:0;background:#e67e22;color:#fff;font-size:6px;font-weight:900;padding:2px 4px;border-radius:0 6px 0 4px;z-index:12">VENTE</div>':""}
              </div>
              <!-- Source + date -->
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${k}${l.job2&&I>0?` / ${F}`:""}`:`Note actuelle : ${k}${l.job2&&I>0?` / ${F}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([B,O])=>{const $=Ii[B],q=B==="GK"?"#fff":$,U=B===l.job||B===l.job2,H=(Number(O)||0)+(U&&m>0?m:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${$};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${q};font-family:Arial Black,Arial;line-height:1">${H}</span>
                </div>
                <span style="font-size:10px;font-weight:700;color:${q}">${B}</span>
              </div>`}).join("")}
          </div>
        </div>
        <div>
    ...
    ${Z}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(fe=document.getElementById("close-detail"))==null||fe.addEventListener("click",s);let A=new Set;const T=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function V(){let B=0;return document.querySelectorAll(".expl-check:checked").forEach(O=>{if(O.dataset.id===e.id)return;const q=Number(O.dataset.evo)||0,U=Number(O.dataset.note)||0;B+=U+q}),Math.round(B*T)}const J=()=>{const B=A.size,O=document.getElementById("sell-action-panel");if(!O)return;O.style.display=B>0?"block":"none",document.getElementById("sell-selected-count").textContent=B;const $=document.getElementById("evolve-btn");if($){const q=V();$.textContent=q>0?`⬆️ Évoluer (+${q})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(B=>{B.addEventListener("change",()=>{const O=B.dataset.id;B.checked?A.add(O):A.delete(O);const $=B.closest(".exemplaire-row");if($){const q=$.querySelector(".expl-sel-overlay"),U=$.querySelector(".expl-sel-check");q&&(q.style.display=B.checked?"block":"none"),U&&(U.style.display=B.checked?"flex":"none"),$.style.transform=B.checked?"scale(1.05)":"scale(1)"}J()})}),document.querySelectorAll(".exemplaire-row").forEach(B=>{B.addEventListener("click",O=>{if(O.target.tagName==="INPUT")return;const $=B.querySelector(".expl-check");$&&!$.disabled&&($.checked=!$.checked,$.dispatchEvent(new Event("change")))})}),(C=document.getElementById("evolve-btn"))==null||C.addEventListener("click",async()=>{if(b<=1)return;const B=[...A];if(!B.length)return;if(A.has(e.id)){const G=document.createElement("div");G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",G.innerHTML=`
        ...
        </div>`,document.body.appendChild(G),G.querySelector("#err-close").addEventListener("click",()=>G.remove()),G.addEventListener("click",se=>{se.target===G&&G.remove()});return}const O=B.filter(G=>G!==e.id);if(!O.length){r("Sélectionne des copies à sacrifier","warning");return}const $=O.reduce((G,se)=>{const de=document.querySelector(`.expl-check[data-id="${se}"]`),he=de&&Number(de.dataset.evo)||0,Te=de&&Number(de.dataset.note)||0;return G+Te+he},0),q=Math.round($*T),U=l.rarity==="pepite"?" (+30% pépite ✨)":l.rarity==="papyte"?" (-30% papyte)":"";if(!await new Promise(G=>{const se=document.createElement("div");se.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",se.innerHTML=`
        <div style="background:var(--tile-bg);border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            ➕ Brut : <strong>+${$}</strong>${U?`<span style="font-size:11px;color:#888"> ${U}</span>`:""}<br>
            ⬆️ Bonus final : <strong style="color:#1A6B3C">+${q}</strong><br>
            📈 Évolution : <strong>${e.evolution_bonus||0}</strong> → <strong style="color:#1A6B3C">${(e.evolution_bonus||0)+q}</strong><br>
            📊 Note finale : <strong>${w}</strong> → <strong style="color:#1A6B3C">${w+q}</strong>
            ${v&&v>0?`<br>📊 Note 2 finale : <strong>${v}</strong> → <strong style="color:#1A6B3C">${v+q}</strong>`:""}
          </div>
        ...
        </div>`,document.body.appendChild(se),se.querySelector("#sac-cancel").addEventListener("click",()=>{se.remove(),G(!1)}),se.querySelector("#sac-ok").addEventListener("click",()=>{se.remove(),G(!0)}),se.addEventListener("click",de=>{de.target===se&&(se.remove(),G(!1))})}))return;if(O.length){await h.from("market_listings").delete().in("card_id",O),await h.from("deck_cards").delete().in("card_id",O),await h.from("transfer_history").delete().in("card_id",O),await h.from("decks").update({stadium_card_id:null}).in("stadium_card_id",O);const{error:G}=await h.from("cards").delete().in("id",O);if(G){r("Erreur suppression : "+G.message,"error");return}}const oe=(e.evolution_bonus||0)+q,{error:D}=await h.from("cards").update({evolution_bonus:oe}).eq("id",e.id);if(D){r("Erreur évolution : "+D.message,"error");return}r(`⬆️ ${l.firstname} ${l.surname_real} : note ${w} → ${w+oe} (+${q}) !`,"success",4e3),s(),d("collection")}),(Y=document.getElementById("market-sell-btn"))==null||Y.addEventListener("click",async()=>{var H;const B=[...A];if(!B.length){r("Sélectionne au moins un exemplaire","warning");return}const O=parseInt((H=document.getElementById("sell-market-price"))==null?void 0:H.value);if(!O||O<1){r("Prix invalide","error");return}const{error:$}=await h.from("cards").update({is_for_sale:!0,sale_price:O}).in("id",B);if($){r($.message,"error");return}const q=B.map(oe=>({seller_id:o.profile.id,card_id:oe,price:O,status:"active"})),{error:U}=await h.from("market_listings").insert(q);U&&console.warn("[Market] insert listings:",U.message),r(`${B.length} carte${B.length>1?"s":""} mise${B.length>1?"s":""} en vente à ${O.toLocaleString("fr")} cr. chacune !`,"success"),s(),d("collection")}),(pe=document.getElementById("cancel-sell-btn"))==null||pe.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),r("Annonce retirée","success"),s(),d("collection")})}function hn(e,t=""){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
  ...
  </div>`;const l=window.innerWidth>=900,f=e.querySelector(".deck-pc-layout"),b=e.querySelector(".deck-mobile-layout");f&&(f.style.display=l?"block":"none"),b&&(b.style.display=l?"none":"block"),er(e,t,o,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const x=()=>{const{openModal:u,closeModal:y}=i,w=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(v=>{v.addEventListener("click",()=>{t.formation=v.dataset.forma;const E=_n(t.formation),m={};E.forEach(M=>{t.slots[M]&&(m[M]=t.slots[M])}),t.slots=m,y(),wt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>tr(t,e,i))),e.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>or(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{t.subs=t.subs.filter(y=>y!==u.dataset.removeSub),wt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>nr(t,e,i)))}function er(e,t,i,n){var v,E,m;const o=window.innerWidth>=900,r=e.querySelector(o?"#deck-field-pc":"#deck-field-mobile");if(!r)return;const a=(v=t.stadiumCards)==null?void 0:v.find(M=>M.id===t.stadiumCardId),s=a&&((E=t.stadDefMap)==null?void 0:E[a.stadium_id])||null,d=Mt[t.formation]||{},c=Oi(t.formation)||[],l={};for(const M of i){const k=t.slots[M],I=k?t.playerCards.find(F=>F.id===k):null;I!=null&&I.player?l[M]={...I.player,_evolution_bonus:I.evolution_bonus||0,face:I.player.face||null}:l[M]=null}const f=window.innerWidth>=900,b=f?window.innerWidth-280:window.innerWidth-20,x=f?Math.min(b,860):b,g=Math.round(f?x*.82:x*.85),p=f?84:44;let u="";for(const[M,k]of c){const I=d[M],F=d[k];if(!I||!F)continue;const W=I.x*x,te=Math.round(.03*g+I.y*.85*g),Z=F.x*x,A=Math.round(.03*g+F.y*.85*g),T=l[M],V=l[k],J=Ut(T,V);J==="#ff3333"||J==="#cc2222"?u+=`<line x1="${W.toFixed(1)}" y1="${te.toFixed(1)}" x2="${Z.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${W.toFixed(1)}" y1="${te.toFixed(1)}" x2="${Z.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${W.toFixed(1)}" y1="${te.toFixed(1)}" x2="${Z.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${J}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const M of i){const k=d[M];if(!k)continue;const I=l[M],F=k.x*x;k.y*g;const W=Math.round(.03*g+k.y*(.85*g)),te=Math.round(F-p/2),Z=Math.round(W-w/2);if(I){const A=M.replace(/\d+/,""),T=s&&(s.club_id&&String(I.club_id)===String(s.club_id)||s.country_code&&I.country_code===s.country_code),V=Ie({...I,_evolution_bonus:I._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:A});T&&((m=s.club)!=null&&m.logo_url||s.image_url),y+=`<div style="position:absolute;left:${te}px;top:${Z}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${M}">
        <div style="position:relative">${V}</div>
      </div>`}else{const A=M.replace(/\d+/,"");y+=`<div style="position:absolute;left:${te}px;top:${Z}px;width:${p}px;height:${w}px;
    ...
    <div style="position:relative;width:${x}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,r.querySelectorAll(".deck-slot-hit").forEach(M=>{M.addEventListener("click",()=>ir(M.dataset.pos,t,e,n))})}function tr(e,t,i){var a;const{openModal:n,closeModal:o}=i,r=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`),(a=document.getElementById("stad-none"))==null||a.addEventListener("click",()=>{e.stadiumCardId=null,o(),wt(t,e,i)}),document.querySelectorAll(".stad-choice").forEach(s=>{s.addEventListener("click",()=>{e.stadiumCardId=s.dataset.stadId,o(),wt(t,e,i)})})}function ir(e,t,i,n){var g,p,u,y,w;const{openModal:o,closeModal:r}=n,a=e.replace(/\d+/,""),s=(g=t.stadiumCards)==null?void 0:g.find(v=>v.id===t.stadiumCardId),d=s&&((p=t.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=t.slots[e],l=c?t.playerCards.find(v=>v.id===c):null;(u=l==null?void 0:l.player)==null||u.id;const f=new Set;Object.entries(t.slots).forEach(([v,E])=>{var M;if(v===e||!E)return;const m=t.playerCards.find(k=>k.id===E);(M=m==null?void 0:m.player)!=null&&M.id&&f.add(m.player.id)}),t.subs.forEach(v=>{var m;const E=t.playerCards.find(M=>M.id===v);(m=E==null?void 0:E.player)!=null&&m.id&&f.add(E.player.id)});const b=new Set,x=t.playerCards.filter(v=>{const E=v.player;return!(E.job===a||E.job2===a)||f.has(E.id)||b.has(E.id)?!1:(b.add(E.id),!0)});x.sort((v,E)=>{const m=v.evolution_bonus||0,M=E.evolution_bonus||0,k=(a==="GK"?v.player.note_g:a==="DEF"?v.player.note_d:a==="MIL"?v.player.note_m:v.player.note_a)+(a===v.player.job||a===v.player.job2?m:0);return(a==="GK"?E.player.note_g:a==="DEF"?E.player.note_d:a==="MIL"?E.player.note_m:E.player.note_a)+(a===E.player.job||a===E.player.job2?M:0)-k}),o(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${x.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+x.map(v=>{const E={...v.player,_evolution_bonus:v.evolution_bonus||0};return`<div class="player-option" data-card-id="${v.id}" style="cursor:pointer">
  ...
  `,document.body.appendChild(o);let r=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=T=>T.touches&&T.touches[0]?T.touches[0].clientX:T.clientX;function l(T){r||(d=!0,s.style.opacity="1",f(T))}function f(T){if(!d||r)return;const V=a.getBoundingClientRect(),J=c(T)-V.left,ue=Math.max(0,Math.min(1,J/V.width));s.style.width=ue*V.width+"px",ue>=.82&&x()}function b(){r||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{r||(s.style.transition="")},220))}function x(){var V;if(r)return;r=!0,d=!1,s.style.width="100%",s.style.opacity="1",(V=document.getElementById("cut-flash"))==null||V.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const T=document.getElementById("cut-hint");T&&(T.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",f),window.addEventListener("pointerup",b),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",b);let g=0,p=!1;const u=new Set;function y(T){g=T,document.getElementById("reveal-phase").style.display="flex",w(),v(T,0),I()}function w(){const T=document.getElementById("card-dots");T&&(T.innerHTML=e.map((V,J)=>`<div class="card-dot" data-i="${J}" style="width:8px;height:8px;border-radius:50%;background:${J===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),T.querySelectorAll(".card-dot").forEach(V=>V.addEventListener("click",()=>m(parseInt(V.dataset.i)))))}function v(T,V){var $,q;const J=e[T],ue=document.getElementById("card-counter"),fe=document.getElementById("card-track");ue&&(ue.textContent=`Carte ${T+1} / ${e.length}`);const C=document.getElementById("reveal-btns");C&&(C.style.display=T===e.length-1?"flex":"none");const Y=J.card_type==="player"&&(($=J.player)==null?void 0:$.rarity)==="legende",pe=!u.has(T);u.add(T);let B=0;if(J.card_type==="player"&&J.player){const U=J.player,H=U.job||"ATT";B=(Number(H==="GK"?U.note_g:H==="DEF"?U.note_d:H==="MIL"?U.note_m:U.note_a)||0)+(J.evolution_bonus||0)}const O=U=>{fe.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${Y?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${fr(J)}</div>
        ...
        </div>`;const H=document.getElementById("current-card-wrap");V!==0?(H.style.transition="none",H.style.transform=`translateX(${V>0?100:-100}%)`,requestAnimationFrame(()=>{H.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",H.style.transform="translateX(0)"})):H.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),U||Y?W():te(),w()};pe&&(((q=J.player)==null?void 0:q.rarity)==="legende"||B>=18)&&J.card_type==="player"&&J.player?E(J,()=>O(!0)):O(!1)}function E(T,V){var Te;p=!0;const J=T.player,ue=`https://flagsapi.com/${J.country_code}/flat/64.png`,fe=(Te=J.clubs)==null?void 0:Te.logo_url,C=At(J),Y=J.job||"ATT",pe=Number(Y==="GK"?J.note_g:Y==="DEF"?J.note_d:Y==="MIL"?J.note_m:J.note_a)||0,B=T.evolution_bonus||0,O=pe+B,$=O>=18&&O<=20,q=O>=18,U=document.getElementById("walkout-overlay"),H=document.getElementById("walkout-stage");if(!U||!H){p=!1,V();return}let oe=null;$&&(oe=Ji("/sounds/Legendary.mp3",.8)),U.style.display="flex";const D=()=>{const ve=H.firstElementChild;ve&&(ve.classList.remove("wo-in"),ve.classList.add("wo-out"))},G=1800,se=400;H.innerHTML=`<img class="wo-in" src="${ue}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(D,G),setTimeout(()=>{var ve;H.innerHTML=fe?`<img class="wo-in" src="${fe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ve=J.clubs)==null?void 0:ve.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},G+se),setTimeout(D,G*2+se),setTimeout(()=>{H.innerHTML=C?`<img class="wo-in" src="${C}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(G+se)*2),setTimeout(D,(G+se)*2+G);const he=q?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[Y]||"#fff";setTimeout(()=>{H.innerHTML=`<div class="wo-in" style="
        font-size:${q?"120px":"90px"};font-weight:900;color:${he};
        ...
        ${O}
      </div>`,q&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(G+se)*3),setTimeout(D,(G+se)*3+G),setTimeout(()=>{U.style.display="none",H.innerHTML="",p=!1,oe&&!$&&oe.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),V()},(G+se)*4)}function m(T){if(p||T<0||T>=e.length||T===g)return;const V=T>g?1:-1;g=T,v(T,V)}function M(){m(g+1)}function k(){m(g-1)}function I(){const T=document.getElementById("card-viewport");if(!T||T._swipeBound)return;T._swipeBound=!0;let V=0,J=0,ue=0,fe=!1;const C=$=>$.touches?$.touches[0].clientX:$.clientX,Y=$=>$.touches?$.touches[0].clientY:$.clientY,pe=$=>{fe=!0,V=C($),J=Y($),ue=0},B=$=>{if(!fe)return;ue=C($)-V;const q=Y($)-J;if(Math.abs(ue)<Math.abs(q))return;const U=document.getElementById("current-card-wrap");U&&(U.style.transition="none",U.style.transform=`translateX(${ue*.6}px) rotate(${ue*.02}deg)`)},O=()=>{if(!fe)return;fe=!1;const $=document.getElementById("current-card-wrap"),q=55;ue<=-q&&g<e.length-1?M():ue>=q&&g>0?k():$&&($.style.transition="transform .2s ease",$.style.transform="translateX(0)")};T.addEventListener("pointerdown",pe),T.addEventListener("pointermove",B),T.addEventListener("pointerup",O),T.addEventListener("pointercancel",O),T.addEventListener("touchstart",pe,{passive:!0}),T.addEventListener("touchmove",B,{passive:!0}),T.addEventListener("touchend",O),T.addEventListener("click",$=>{if(Math.abs(ue)>8)return;const q=T.getBoundingClientRect();$.clientX-q.left>q.width/2?M():k()})}let F=null;function W(){const T=document.getElementById("fireworks-canvas");if(!T)return;T.width=window.innerWidth,T.height=window.innerHeight;const V=T.getContext("2d"),J=[];function ue(){const C=Math.random()*T.width,Y=Math.random()*T.height*.6,pe=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],B=pe[Math.floor(Math.random()*pe.length)];for(let O=0;O<60;O++){const $=Math.PI*2/60*O,q=2+Math.random()*5;J.push({x:C,y:Y,vx:Math.cos($)*q,vy:Math.sin($)*q,alpha:1,color:B,size:2+Math.random()*3})}}ue(),F=setInterval(ue,600);function fe(){if(document.getElementById("fireworks-canvas")){V.clearRect(0,0,T.width,T.height);for(let C=J.length-1;C>=0;C--){const Y=J[C];if(Y.x+=Y.vx,Y.y+=Y.vy+.08,Y.vy*=.98,Y.alpha-=.018,Y.alpha<=0){J.splice(C,1);continue}V.globalAlpha=Y.alpha,V.fillStyle=Y.color,V.beginPath(),V.arc(Y.x,Y.y,Y.size,0,Math.PI*2),V.fill()}V.globalAlpha=1,(F!==null||J.length>0)&&requestAnimationFrame(fe)}}fe()}function te(){F!==null&&(clearInterval(F),F=null);const T=document.getElementById("fireworks-canvas");T&&T.getContext("2d").clearRect(0,0,T.width,T.height)}if(n){const T=document.getElementById("reveal-btns");T&&(T.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(A=document.getElementById("reveal-next"))==null||A.addEventListener("click",()=>{te(),o.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{te(),o.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{te(),o.remove(),i("boosters")})}function fr(e){var t,i,n,o;if(e.card_type==="player"&&e.player)return dr(e);if(e.card_type==="game_changer"){const r=e._gcDef,a=(r==null?void 0:r.name)||e.gc_type||"Game Changer",s=(r==null?void 0:r.effect)||((t=Bi[e.gc_type])==null?void 0:t.desc)||"",d=r!=null&&r.image_url?`/icons/${r.image_url}`:null,c=((i=Bi[e.gc_type])==null?void 0:i.icon)||"⚡";return tt(a,d,c,s,{width:170})}if(e.card_type==="formation")return Mi(e.formation,Mt[e.formation],{width:160});if(e.card_type==="stadium"){const r=e._stadiumDef,a=(r==null?void 0:r.name)||"Stade",s=((n=r==null?void 0:r.club)==null?void 0:n.encoded_name)||(r==null?void 0:r.country_code)||"—",d=r!=null&&r.image_url?`/icons/${r.image_url}`:((o=r==null?void 0:r.club)==null?void 0:o.logo_url)||(r!=null&&r.country_code?`https://flagsapi.com/${r.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),c=`${s}<br>+10 ⭐ joueurs alliés`;return ti(a,d,c,{width:170})}return'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function mr(e){var t,i;if((t=e==null?void 0:e.rates)!=null&&t.length){const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:4000;padding:16px";const o={normal:"#ccc",pepite:"#D4A017",pépite:"#D4A017",papyte:"#909090",legende:"#7a28b8",légende:"#7a28b8"},r={player:"Joueur",formation:"Formation",game_changer:"Game Changer",game_helper:"Game Helper"};n.innerHTML=`
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}gr()}function gr(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function xr(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),d=[...new Set((s||[]).filter(b=>{var x,g;return((x=b.card)==null?void 0:x.card_type)==="stadium"&&((g=b.card)==null?void 0:g.stadium_id)}).map(b=>b.card.stadium_id))],c={};if(d.length){const{data:b}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(b||[]).forEach(x=>{c[x.id]=x}),(s||[]).forEach(x=>{var g,p;((g=x.card)==null?void 0:g.card_type)==="stadium"&&((p=x.card)!=null&&p.stadium_id)&&(x.card._stadiumDef=c[x.card.stadium_id]||null)})}let l=0;function f(){var m,M,k,I,F,W,te;const b=r[l],x=(s||[]).filter(Z=>Z.deck_id===b.id),g=x.filter(Z=>{var A;return Z.is_starter&&((A=Z.card)==null?void 0:A.player)}).map(Z=>Di(Z.card,Z.position)),p=x.find(Z=>{var A;return((A=Z.card)==null?void 0:A.card_type)==="formation"}),u=b.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let y=g.length>=11?xi(g,u):null,w=((M=b.stadium_card)==null?void 0:M.stadium_def)||null;w&&y&&(y=ai(y,w));const v=g.length>=11;st(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        <div style="padding:8px 16px;background:rgba(0,0,0,0.4);text-align:center">
          <div style="font-size:10px;opacity:.6;letter-spacing:2px;text-transform:uppercase">${hr(i,t)}</div>
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Z(){const A=e.querySelector(".deck-preview-wrap"),T=e.querySelector("#deck-swipe-zone");if(!A||!T||!y)return;const V=T.clientWidth>=900,J=Math.max(200,T.clientHeight-(V?60:40)),fe=Math.max(200,T.clientWidth-16),C=V?Math.min(117,Math.max(52,Math.round(fe*.22))):Math.max(44,Math.round(fe*.168));if(J<220||fe<220){requestAnimationFrame(Z);return}const Y=V?null:Math.round(C*.55);A.innerHTML=Ot(y,u,null,[],fe,J,[],Y),A.style.cssText=`width:${fe}px;height:${J}px;overflow:hidden;margin:${V?0:60}px auto 0`;const pe=A.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",V?"xMidYMid meet":"none"))})),(I=document.getElementById("prev-deck"))==null||I.addEventListener("click",()=>{l>0&&(l--,f())}),(F=document.getElementById("next-deck"))==null||F.addEventListener("click",()=>{l<r.length-1&&(l++,f())}),(W=document.getElementById("validate-deck"))==null||W.addEventListener("click",()=>{if(!v)return;const Z=t.state.params||{};t.navigate("match",{...Z,matchMode:Z.matchMode||i,deckId:b.id})}),(te=document.getElementById("cancel-deck-select"))==null||te.addEventListener("click",()=>{it(e),o("home")});const E=document.getElementById("deck-swipe-zone");if(E){let Z=0,A=0;E.addEventListener("touchstart",T=>{Z=T.touches[0].clientX,A=T.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",T=>{const V=T.changedTouches[0].clientX-Z,J=T.changedTouches[0].clientY-A;Math.abs(V)<40||Math.abs(V)<Math.abs(J)||(V<0&&l<r.length-1?(l++,f()):V>0&&l>0&&(l--,f()))},{passive:!0})}}f()}function ht(e,t=44,i=58,n=null){return Ie(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Je(e,t,i,n,o){if(!(e!=null&&e.length))return"";const r=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return r.forEach((s,d)=>{const c=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(c==="ATT"||c==="MIL")||n==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?l+=10:n||(l+=10)),a+=Ie(s,{width:40,role:c,extraNote:l}),d<r.length-1){const f=r[d+1],b=Fn(s,f,o)?Ut(s,f):null;a+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function _i(e,t,i,n,o=310,r=310,a=[],s=null){const d=Mt[t]||{},c=Oi(t)||Hi[t]||[],l={},f=["ATT","MIL","DEF","GK"];for(const y of f)(e[y]||[]).forEach((v,E)=>{l[`${y}${E+1}`]=v});function b(y){const w=d[y];return w?{x:w.x*o,y:w.y*r}:null}let x="";for(const[y,w]of c){const v=b(y),E=b(w);if(!v||!E)continue;const m=l[y],M=l[w],k=Ut(m,M);k==="#00ff88"||k==="#FFD700"?(x+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${k}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,x+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${k}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):x+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${k}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(o*.225)),117):Math.max(44,Math.round(o*.168)),p=Math.round(g*657/507);for(const[y,w]of Object.entries(l)){const v=b(y);if(!v||!w)continue;const E=y.replace(/[0-9]/g,""),m=a.includes(w.cardId),M=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,k=n.includes(w.cardId);let I=w.boost||0,F=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(I+=10,F=!0):i||(I+=10,F=!0));const W=Math.round(v.x-g/2),te=Math.round(v.y-p/2);if(w.used){x+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${W}" y="${te}" width="${g}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const Z=Ie({...w,_evolution_bonus:0,stadiumBonus:!1},{width:g,showStad:!1,stadDef:null,role:E,extraNote:I,_cardOffset:30,_forceStadColor:F}),A=k?`position:absolute;top:30px;left:0;width:${g}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";x+=`<foreignObject x="${W-2}" y="${te-30}" width="${g+8}" height="${p+60}" style="overflow:visible">
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(d)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),o==null||o()},400)},1800)}function kr(e,t,i){const n=document.getElementById("sub-anim-overlay");n&&n.remove();const o=document.createElement("div");o.id="sub-anim-overlay",o.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,o.textContent=e,!document.getElementById("game-toast-style")){const r=document.createElement("style");r.id="game-toast-style",r.textContent=`
      ...
      }`,document.head.appendChild(r)}document.body.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transition="opacity 0.3s",setTimeout(()=>o.remove(),300)},i)}function Jn(e,t){const i=Pe(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function bt(e,t){return e.reduce((i,n)=>i+Jn(n,t),0)}function yt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Ut(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function bi(e,t,i,n,o){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
    ...
    </div>`}async function $r(e,t){const{state:i}=t,o=(i.params||{}).matchMode||"vs_ai_easy",r=o.replace("vs_ai_",""),a=o;await ki(e,t,o,async({deckId:s,formation:d,starters:c,subsRaw:l,gcCardsEnriched:f,gcDefs:b,stadiumDef:x})=>{try{let g=xi(c,d);x&&(g=ai(g,x),gi(l,x));const p=await Er(d,r),u=p.lines||p,y=async w=>{try{const v=a==="vs_ai_club"?"club":a,{data:E,error:m}=await h.from("matches").insert({home_id:i.profile.id,away_id:null,mode:v,home_deck_id:s,status:"in_progress"}).select().single();if(m){console.error("[MatchIA] Erreur création match:",m),It(e,"⚠️","Impossible de créer le match ("+m.message+").","Retour",()=>t.navigate("home"));return}const M=p.stadiumDef||null;M&&u&&(ai(u,M),gi(p.subs||[],M));const k={gcDefs:b||[],matchId:E==null?void 0:E.id,mode:a,difficulty:r,formation:d,homeTeam:g,aiTeam:u,homeSubs:l,subsUsed:0,maxSubs:Math.min(l.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:M,homeScore:0,aiScore:0,gcCards:w,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Tr(e,k,t)}catch(v){console.error("[MatchIA] Exception launchMatch:",v),It(e,"⚠️","Erreur au lancement du match : "+v.message,"Retour",()=>t.navigate("home"))}};if(!f.length){y([]);return}wi(e,f,y)}catch(g){console.error("[MatchIA] Exception setup:",g),It(e,"⚠️","Erreur de préparation du match : "+g.message,"Retour",()=>t.navigate("home"))}})}async function Er(e,t){var u;const{data:i}=await h.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Lr(e),subs:[],gcCards:[],stadiumDef:null};const n=Nt[e]||Nt["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},r=new Set;function a(y,w,v){var E,m;return r.add(y.id),{cardId:"ai-"+y.id+"-"+v,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter(k=>k.job===y&&!r.has(k.id)),v=i.filter(k=>k.job!==y&&!r.has(k.id)),E=[...w,...v],m=[];for(let k=0;k<n[y];k++){const I=E[k];I&&m.push(a(I,y,k))}const M=xt(m.length);m.forEach((k,I)=>{k._col=M[I]}),o[y]=m}const d=i.filter(y=>!r.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),f=Object.keys(je).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var v,E;return{id:"ai-gc-"+w,gc_type:y,name:((v=je[y])==null?void 0:v.name)||y,icon:((E=je[y])==null?void 0:E.icon)||"⚡"}}),b=Object.values(o).flat(),x={};b.forEach(y=>{y.club_id&&(x[y.club_id]=(x[y.club_id]||0)+1)});const g=(u=Object.entries(x).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await h.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:o,subs:d,gcCards:f,stadiumDef:p}}function Lr(e){const t=Nt[e]||Nt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let o=0;for(const r of["GK","DEF","MIL","ATT"]){const a=[];for(let d=0;d<t[r];d++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+o,id:"fake-"+o,firstname:"IA",name:n[o%n.length],country_code:"XX",club_id:null,job:r,job2:null,note_g:r==="GK"?c:2,note_d:r==="DEF"?c:2,note_m:r==="MIL"?c:2,note_a:r==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:r}),o++}const s=xt(a.length);a.forEach((d,c)=>{d._col=s[c]}),i[r]=a}return i}function Tr(e,t,i){var o;An("/sounds/match-opening.mp3",.3);const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const Y=t.pendingAttack;let pe="";if(t.selected.length>0){const B=t.selected.map($=>({...(t.homeTeam[$._role]||[]).find(U=>U.cardId===$.cardId)||$,_line:$._role})),O=ri(B,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Je(B.map($=>({...$,used:!1})),"#3a7bd5",O.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Je((Y.players||[]).map(B=>({...B,used:!1})),"#ff6b6b",Y.total,"attack",t.formation)}</div>
            ${pe}
          ...
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const Y=t.selected.map(B=>{const O=(t.homeTeam[B._role]||[]).find(q=>q.cardId===B.cardId)||B,$=["GK","DEF"].includes(B._role);return{...O,_line:B._role,...$?{note_a:Math.max(1,Number(O.note_a)||0)}:{}}}),pe=oi(Y,t.modifiers.home,t.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Je(Y.map(B=>({...B,used:!1})),"#FFD700",pe.total,"attack",t.formation)}</div>
    ...
    ${(()=>{const C=window.innerWidth>=700,Y=(D,G,se)=>{var Se,Be;const de=(t.gcDefs||[]).find(ke=>ke.name===D.gc_type),he=(de==null?void 0:de.name)||D.gc_type,Te=(de==null?void 0:de.effect)||((Se=je[D.gc_type])==null?void 0:Se.desc)||"",ve=de!=null&&de.image_url?`/icons/${de.image_url}`:null,ze=((Be=je[D.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${D.id}" data-gc-type="${D.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${tt(he,ve,ze,Te,{width:G})}
        </div>`},pe=(D,G)=>{var se;return`<div id="boost-card"
          style="box-sizing:border-box;width:${D}px;height:${G}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(G*.04)}px;text-align:center;flex-shrink:0">
          ...
          </div>`},B=(D,G)=>G?pe(95,162):Y(D,95),O=(D,G)=>G?pe(68,116):Y(D,68),$=C?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",q=w?`<button id="btn-results" style="${$};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:p?`<div style="${$};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:m?`<button id="btn-pass" style="${$};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:u?`<button id="btn-action" style="${$};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:y?`<button id="btn-action" style="${$};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${$};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,U=u||y?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",H=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${C?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
        ${r.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':r.map(D=>`<div class="sub-btn-col" data-sub-id="${D.cardId}" style="cursor:pointer;flex-shrink:0">${ht(D,76,100)}</div>`).join("")}
      </div>`,oe=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Ot(t.homeTeam,t.formation,t.phase,n,C?1300:zt(),C?600:Gt(),g)}
        </div>
      </div>`;return C?`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(C=>{var Y,pe,B;if(C.type==="duel"){const O=C.isGoal,$=C.homeScored?"#FFD700":O?"#ff6b6b":"rgba(255,255,255,0.3)",q=C.homeScored?"⚽ BUT !":O?"⚽ BUT IA !":(Y=C.homePlayers)!=null&&Y.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${O?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${$};margin-bottom:4px">
                <div style="font-size:9px;color:${$};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${q}</div>
                ...
                ${(B=C.aiPlayers)!=null&&B.length?`<div style="opacity:0.7">${Je(C.aiPlayers,"#ff6b6b",C.aiTotal,void 0,t.formation)}</div>`:""}
  ...
  </div>`;function I(){const C=e.querySelector(".match-screen");if(!C)return;const Y=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);C.style.bottom="auto",C.style.height=Y+"px",C.style.minHeight=Y+"px",C.style.maxHeight=Y+"px",C.style.overflow="hidden";const pe=e.querySelector("#mobile-action-bar"),B=e.querySelector("#mobile-play-area");pe&&B&&(B.style.paddingBottom=pe.offsetHeight+"px")}if(I(),setTimeout(I,120),setTimeout(I,400),setTimeout(I,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",I),window.visualViewport.addEventListener("scroll",I)),window.addEventListener("resize",I)),function(){const Y=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!Y)return;const pe=Y.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),Y.removeAttribute("width"),Y.removeAttribute("height"),Y.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Y.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const C=e.querySelector(".terrain-wrapper svg");if(C){const Y=C.closest("#match-terrain-wrap");Y&&(Y.style.cssText="position:relative;width:100%;height:100%;padding:0"),C.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),t.phase==="attack"||t.phase==="defense"){let C=!1,Y=30;const pe=()=>document.getElementById("match-timer"),B=()=>{const O=pe();if(!O)return;const $=String(Math.floor(Y/60)).padStart(2,"0"),q=String(Y%60).padStart(2,"0");O.textContent=` ${$}:${q}`,O.style.color=C?"#ff2222":"#ff9500",O.style.fontWeight="900"};B(),t._timerInt=setInterval(()=>{if(Y--,Y<0)if(!C)C=!0,Y=15,B(),Mn("/sounds/timer-urgent.mp3",.6);else{clearInterval(t._timerInt),t._timerInt=null,Ue(),t.homeScore=0,t.aiScore=3;const O=document.createElement("div");O.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",O.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(O),setTimeout(()=>{O.remove(),vt(e,t,i)},2500)}else B()},1e3)}(W=document.getElementById("match-quit"))==null||W.addEventListener("click",()=>{it(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,vt(e,t,i))}),(te=document.getElementById("view-ai"))==null||te.addEventListener("click",()=>Pr(t,i)),(Z=document.getElementById("toggle-history"))==null||Z.addEventListener("click",()=>{var C;(C=document.getElementById("match-history-panel"))==null||C.classList.add("open")}),(A=document.getElementById("close-history"))==null||A.addEventListener("click",()=>{var C;(C=document.getElementById("match-history-panel"))==null||C.classList.remove("open")}),(T=document.getElementById("btn-action"))==null||T.addEventListener("click",()=>{t.selected.length!==0&&(u?Sr(e,t,i):y&&Ar(e,t,i))}),(V=document.getElementById("btn-results"))==null||V.addEventListener("click",()=>vt(e,t,i)),(J=document.getElementById("btn-pass"))==null||J.addEventListener("click",()=>{if(t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Fi(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),vt(e,t,i);return}t.phase="ai-attack",_e(e,t,i),setTimeout(()=>en(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(C=>{C.addEventListener("click",()=>zr(C,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(C=>{C.addEventListener("click",()=>Si(e,t,i,null,C.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(C=>{u?C.addEventListener("click",()=>Br(C.dataset.gcId,C.dataset.gcType,e,t,i)):(C.style.opacity="0.35",C.style.cursor="default",C.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(ue=document.getElementById("boost-card"))==null||ue.addEventListener("click",()=>Fr(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(C=>{C.addEventListener("click",()=>Si(e,t,i,C.dataset.subId))}),(fe=document.getElementById("sub-btn-main"))==null||fe.addEventListener("click",()=>Si(e,t,i))}function zr(e,t,i,n){const o=e.dataset.cardId,r=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===o);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[r]||[]).find(d=>d.cardId===o);s&&t.selected.push({...s,_role:r,_line:r})}_e(i,t,n)}function Zi(e,t,i){e.matchId&&h.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function Sr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),Zi(t,i,i.state.profile.id);const n=t.selected.map(r=>{const a=(t.homeTeam[r._role]||[]).find(d=>d.cardId===r.cardId)||r,s=["GK","DEF"].includes(r._role);return{...a,_line:r._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),o=oi(n,t.modifiers.home,t.formation);t.pendingAttack={...o,players:[...n],side:"home"},t.selected.forEach(r=>{const a=(t.homeTeam[r._role]||[]).find(s=>s.cardId===r.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${o.total} (base ${o.base}${o.links?` +${o.links} liens`:""}) — ${t.selected.map(r=>r.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",_e(e,t,i),setTimeout(()=>jr(e,t,i),1200)}function Ar(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ue(),Zi(t,i,i.state.profile.id);const n=t.stadiumDef||null,o=t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(f=>f.cardId===d.cardId)||d,l=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:d._role,stadiumBonus:l}}),r=ri(o,t.modifiers.home,t.formation);t.selected.forEach(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);c&&(c.used=!0)});const a=Qi(t.pendingAttack.total,r.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>Ke(d)),homePlayers:t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return Ke(c)}),homeTotal:r.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${r.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,_e(e,t,i),Qe(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${r.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,St(e,t,i,"home-attack")}function Mr(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(d=>d.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(d=>!e.aiUsedSubIds.includes(d.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],o=i.find(d=>d.job===n.job)||i[0],r={...o,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(d=>d.cardId===n.cardId);s!==-1&&(a[s]=r),e.aiUsedSubIds.push(o.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${o.firstname} ${o.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function Cr(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(o=>!e.aiUsedGc.includes(o.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),je[i.gc_type],i.gc_type){case"Boost+2":{const o=Object.values(e.aiTeam).flat().filter(r=>!r.used);if(o.length){const r=o[Math.floor(Math.random()*o.length)];r.boost=(r.boost||0)+2}break}case"Boost+3":{const o=Object.values(e.aiTeam).flat().filter(r=>!r.used);if(o.length){const r=o[Math.floor(Math.random()*o.length)];r.boost=(r.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function en(e,t,i){Zi(t,i,null),Mr(t),Cr(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(l=>!l.used),o=!1;if(!n.length){const l=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(b=>!b.used),f=Ht(t.homeTeam);if(f||l.length===0){const b=(t.aiTeam.DEF||[]).filter(g=>!g.used),x=(t.aiTeam.GK||[]).filter(g=>!g.used);n=f?b.length?b:x:[...b,...x],o=!0}}const r=Rn(n,"attack",t.difficulty);if(!r.length){Pi(e,t,i);return}o&&r.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const a=oi(r,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:r,side:"ai"},r.forEach(l=>{l.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${r.map(l=>l.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used),c=(t.homeSubs||[]).filter(l=>!(t.usedSubIds||[]).includes(l.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(r.length===1&&(r[0]._line==="GK"||r[0].job==="GK")&&Ht(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,yi(e,t,i,"ai",r[0]);return}t.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:r.map(b=>Ke(b)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(f),t.pendingAttack=null,_e(e,t,i),Qe(f.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}t.phase="defense",_e(e,t,i)}function jr(e,t,i){var c,l;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],o=Rn(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(t.aiTeam[f]||[]).filter(b=>!b.used)).length){const f=((c=t.pendingAttack)==null?void 0:c.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,yi(e,t,i,"home",f[0]);return}t.homeScore++;const x={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(g=>Ke(g)),homeTotal:((l=t.pendingAttack)==null?void 0:l.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(x),t.modifiers.ai={},t.pendingAttack=null,_e(e,t,i),Qe(x.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}const a=o.length>0?ri(o,t.modifiers.ai,t.formation).total:0;o.forEach(f=>{f.used=!0});const s=Qi(t.pendingAttack.total,a,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(f=>Ke(f)),aiPlayers:o.map(f=>Ke(f)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(s.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,_e(e,t,i),Qe(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,St(e,t,i,"ai-attack")}function St(e,t,i,n){if(t.round++,!Qn(e,t,i)){if(tn(t)){vt(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(r=>(t.homeTeam[r]||[]).some(a=>!a.used))){Pi(e,t,i);return}t.phase="attack",_e(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(r=>(t.aiTeam[r]||[]).some(a=>!a.used))){Pi(e,t,i);return}t.phase="ai-attack",_e(e,t,i),setTimeout(()=>en(e,t,i),800)}}}function Ht(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function kn(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(o=>!o.used));return t&&!i}function Qn(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(kn(t.homeTeam)&&Ht(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(o=>!o.used);return n?(n.used=!0,t.homeScore++,yi(e,t,i,"home",n),!0):!1}if(kn(t.aiTeam)&&Ht(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(o=>!o.used);return n?(n.used=!0,t.aiScore++,yi(e,t,i,"ai",n),!0):!1}return!1}function yi(e,t,i,n,o){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ke(o)]:[],aiPlayers:n==="ai"?[Ke(o)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(r);const a=(s,d)=>new Promise(c=>{r.innerHTML=`<div style="font-size:32px;font-weight:900;color:${d};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),r.remove(),t.pendingAttack=null,_e(e,t,i),Qe([Ke(o)],t.homeScore,t.aiScore,n==="home",()=>{if(tn(t)){vt(e,t,i);return}St(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function tn(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(o=>!o.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(o=>!o.used));return!t&&!i}function Fi(e,t){return!(["MIL","ATT"].some(o=>(e[o]||[]).some(r=>!r.used))||Ht(t)||!["MIL","ATT"].some(o=>(t[o]||[]).some(r=>!r.used)))}function Pi(e,t,i){if(!Qn(e,t,i)){if(tn(t)){vt(e,t,i);return}if(Fi(t.homeTeam,t.aiTeam)&&Fi(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),vt(e,t,i);return}t.phase="attack",_e(e,t,i)}}function Si(e,t,i,n=null,o=null){var x,g;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const r=Object.entries(t.homeTeam).flatMap(([p,u])=>(u||[]).filter(y=>y.used).map(y=>({...y,_line:y._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!r.length){$t("Aucun joueur utilisé à remplacer");return}if(!a.length){$t("Aucun remplaçant disponible");return}let s=Math.max(0,r.findIndex(p=>p.cardId===o));const d=((x=r[s])==null?void 0:x._line)||((g=r[s])==null?void 0:g.job);let c=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===d)),l=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function b(){var m,M,k,I,F,W;const p=r[s],u=a[c],y=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(y*1.35),v=te=>`background:rgba(255,255,255,0.12);border:none;color:${te?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${te?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(M=f.querySelector("#out-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,b())}),(k=f.querySelector("#out-down"))==null||k.addEventListener("click",()=>{s<r.length-1&&(s++,b())}),(I=f.querySelector("#in-up"))==null||I.addEventListener("click",()=>{c>0&&(c--,b())}),(F=f.querySelector("#in-down"))==null||F.addEventListener("click",()=>{c<a.length-1&&(c++,b())});const E=(te,Z,A,T)=>{const V=f.querySelector("#"+te);if(!V)return;let J=0;V.addEventListener("touchstart",ue=>{J=ue.touches[0].clientY},{passive:!0}),V.addEventListener("touchend",ue=>{const fe=ue.changedTouches[0].clientY-J;if(Math.abs(fe)<30)return;const C=Z();fe<0&&C<T-1?(A(C+1),b()):fe>0&&C>0&&(A(C-1),b())},{passive:!0})};E("in-panel",()=>c,te=>c=te,a.length),E("out-panel",()=>s,te=>s=te,r.length),(W=f.querySelector("#sub-confirm"))==null||W.addEventListener("click",te=>{if(te.preventDefault(),te.stopPropagation(),l)return;l=!0;const Z=r[s],A=a[c];if(!Z||!A)return;let T=null,V=-1;for(const[ue,fe]of Object.entries(t.homeTeam)){const C=(fe||[]).findIndex(Y=>Y.cardId===Z.cardId);if(C!==-1){T=ue,V=C;break}}if(V===-1||!T){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const J={...A,_line:T,_col:Z._col||0,used:!1,boost:0};t.homeTeam[T].splice(V,1,J),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(A.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Z.name,firstname:Z.firstname,note:Pe(Z,T),portrait:At(Z),job:Z.job,country_code:Z.country_code,rarity:Z.rarity,clubName:Z.clubName,clubLogo:Z.clubLogo},inPlayer:{name:A.name,firstname:A.firstname,note:Pe(A,T),portrait:At(A),job:A.job,country_code:A.country_code,rarity:A.rarity,clubName:A.clubName,clubLogo:A.clubLogo},text:`🔄 ${A.firstname} ${A.name} remplace ${Z.firstname} ${Z.name}`}),f.remove(),kr(Z,A,()=>_e(e,t,i))})}document.body.appendChild(f),b()}function Br(e,t,i,n,o){var b,x;const r=(n.gcDefs||[]).find(g=>g.name===t),a=je[t]||{icon:"⚡",desc:"Carte spéciale."},s=(r==null?void 0:r.name)||t,d=(r==null?void 0:r.effect)||a.desc,c=r!=null&&r.image_url?`/icons/${r.image_url}`:null,l=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${tt(s,c,l,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(b=f.querySelector("#gc-back"))==null||b.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),Dr(e,t,i,n,o)})}function pi(e,t,i,n,o,r){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var c,l;a.innerHTML=`
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(l=document.getElementById("res-home"))==null||l.addEventListener("click",()=>{c.remove(),it(e),i.navigate("home")}),(f=document.getElementById("res-replay"))==null||f.addEventListener("click",()=>{c.remove(),it(e),i.navigate("match",{matchMode:t.mode})})}function Pr(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${_i(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Rr={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function Gr(e){const t=e.job||"ATT";return Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}async function Nr(e,t){!e||!t||await Promise.all([$n(e,"win"),$n(t,"loss")])}async function $n(e,t){const{data:i}=await h.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",e).eq("card_type","player");if(!(i!=null&&i.length))return;const n=i.filter(o=>{var r,a;return((r=o.player)==null?void 0:r.rarity)==="pepite"||((a=o.player)==null?void 0:a.rarity)==="papyte"});n.length&&await Promise.all(n.map(o=>{const r=Rr[o.player.rarity],a=t==="win"?r.win:r.loss,s=o.player.note_min??1,d=o.player.note_max??10,c=Gr(o.player),l=o.current_note??c,f=Math.min(d,Math.max(s,l+a));return h.from("cards").update({current_note:f}).eq("id",o.id)}))}const Dt=e=>Wn(e);async function Ct(e,t,i,n,o={}){return Zn(e,t,i,n,o.myGC||[],o.gcDefs||[],o.isRanked||!1,o.rankedData||null,o.stadiumDef||null,o.onMatchEnd||null,o.mlLeagueId||null,o.mlMatchId||null)}async function Or(e,t,i){const{data:n}=await h.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const o=n.home_id===t.state.user.id;let r=null,a=null;if(n.mode==="mini_league"){const{data:s}=await h.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(r=s.league_id,a=s.id)}return Zn(e,t,i,o,[],[],n.is_ranked||!1,null,null,null,r,a)}async function Zn(e,t,i,n,o=[],r=[],a=!1,s=null,d=null,c=null,l=null,f=null){const{state:b,navigate:x,toast:g}=t,p=n?"p1":"p2",u=n?"p2":"p1",y=(o||[]).map(_=>_.id),w=(o||[]).map(_=>({id:_.id,gc_type:_.gc_type,_gcDef:_._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:v}=await h.from("matches").select("*").eq("id",i).single();if(!v){g("Match introuvable","error"),x("home");return}async function E(){var xe,ye;console.log("[PvP] buildGameState match:",{id:v.id,home_deck_id:v.home_deck_id,away_deck_id:v.away_deck_id,mode:v.mode,is_ranked:v.is_ranked});const[{data:_,error:L},{data:S,error:j},{data:z},{data:N}]=await Promise.all([h.rpc("get_deck_for_match",{p_deck_id:v.home_deck_id}),h.rpc("get_deck_for_match",{p_deck_id:v.away_deck_id}),h.from("users").select("id,pseudo,club_name").eq("id",v.home_id).single(),h.from("users").select("id,pseudo,club_name").eq("id",v.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",j==null?void 0:j.message,"p1D:",(xe=_==null?void 0:_.starters)==null?void 0:xe.length,"p2D:",(ye=S==null?void 0:S.starters)==null?void 0:ye.length);const P=re=>{const Ee=Number(re.evolution_bonus)||0;return{cardId:re.card_id,position:re.position,id:re.id,firstname:re.firstname,name:re.surname_real,country_code:re.country_code,club_id:re.club_id,job:re.job,job2:re.job2,note_g:(Number(re.note_g)||0)+(re.job==="GK"||re.job2==="GK"&&Number(re.note_g)>0?Ee:0),note_d:(Number(re.note_d)||0)+(re.job==="DEF"||re.job2==="DEF"&&Number(re.note_d)>0?Ee:0),note_m:(Number(re.note_m)||0)+(re.job==="MIL"||re.job2==="MIL"&&Number(re.note_m)>0?Ee:0),note_a:(Number(re.note_a)||0)+(re.job==="ATT"||re.job2==="ATT"&&Number(re.note_a)>0?Ee:0),evolution_bonus:Ee,rarity:re.rarity,skin:re.skin,hair:re.hair,hair_length:re.hair_length,face:re.face||null,clubName:re.club_encoded_name||null,clubLogo:re.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},R=((_==null?void 0:_.starters)||[]).map(re=>P(re)),K=((S==null?void 0:S.starters)||[]).map(re=>P(re)),Q=(_==null?void 0:_.formation)||"4-4-2",ne=(S==null?void 0:S.formation)||"4-4-2";let ie=xi(R,Q),ee=xi(K,ne);const ae=((_==null?void 0:_.subs)||[]).map(re=>P(re)),le=((S==null?void 0:S.subs)||[]).map(re=>P(re)),ge=(_==null?void 0:_.stadium_def)||(n?d:null),ce=(S==null?void 0:S.stadium_def)||(n?null:d);return ge&&(ie=ai(ie,ge),gi(ae,ge)),ce&&(ee=ai(ee,ce),gi(le,ce)),{p1Team:ie,p2Team:ee,p1Subs:ae,p2Subs:le,p1Formation:Q,p2Formation:ne,p1Name:(z==null?void 0:z.club_name)||(z==null?void 0:z.pseudo)||"Joueur 1",p2Name:(N==null?void 0:N.club_name)||(N==null?void 0:N.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?y:[],gc_p2:n?[]:y,gcCardsFull_p1:n?w:[],gcCardsFull_p2:n?[]:w,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:r||[],lastActionAt:new Date().toISOString()}}let m=v.game_state&&Object.keys(v.game_state).length?v.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!m,"match.status:",v.status,"home_id:",v.home_id,"away_id:",v.away_id,"myId:",b.profile.id),!m)if(n){m=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((m==null?void 0:m.p1Team)||{}));const{data:_}=await h.from("matches").select("game_state").eq("id",i).single();!(_!=null&&_.game_state)||!Object.keys(_.game_state).length?await h.from("matches").update({game_state:m,turn_user_id:v.home_id}).eq("id",i):m=_.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let _=0;_<30&&!m;_++){await new Promise(S=>setTimeout(S,400));const{data:L}=await h.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(m=L.game_state),_%5===0&&console.log("[PvP] away - poll",_,"game_state:",!!(L!=null&&L.game_state))}if(!m){g("Erreur de synchronisation","error"),x("home");return}m.gc_p2=y,m.gcCardsFull_p2=w,await h.from("matches").update({game_state:m}).eq("id",i)}let M=!1,k=null,I=!1;const F=new Set,W=new Set;async function te(_){var ne,ie;Tt();try{h.removeChannel(Z)}catch{}const L=m[p+"Score"]||0,S=m[u+"Score"]||0;let j,z;_.winner_id?(j=_.winner_id===b.profile.id,z=!1):_.forfeit?(j=L>S,z=!1):(z=L===S,j=L>S);let N="";if(a&&n)try{const{data:ee}=await h.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.home_id).single(),{data:ae}=await h.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.away_id).single();if(ee&&ae){const le=j?1:z?.5:0,ge=1-le,ce=ee.placement_matches<10,xe=ae.placement_matches<10,ye=computeGlicko2(ee.mmr,ee.mmr_deviation,ee.mmr_volatility,ae.mmr,ae.mmr_deviation,le===1?1:le===0?0:.5,ce),re=computeGlicko2(ae.mmr,ae.mmr_deviation,ae.mmr_volatility,ee.mmr,ee.mmr_deviation,ge===1?1:ge===0?0:.5,xe);await h.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:z?null:j?v.home_id:v.away_id,p_home_id:v.home_id,p_away_id:v.away_id,p_home_delta:ye.delta,p_away_delta:re.delta,p_home_new_rd:ye.newRd,p_away_new_rd:re.newRd,p_home_new_vol:ye.newSigma,p_away_new_vol:re.newSigma});const Ee=ye.delta,Ge=ye.newMmr,Le=getTier(Ge),Ve=Ee>=0?"+":"",Oe=Ee>=0?"#4caf50":"#ff6b6b",nt=getTier(ee.mmr);N=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Le.id!==nt.id?`<div style="font-size:20px;font-weight:900;color:${Le.color}">
                    ${Ge>ee.mmr?"📈":"📉"} ${nt.emoji} ${nt.label} → ${Le.emoji} ${Le.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ge>ee.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Ee>=0?"📈":"📉"}</div>
            ...
            </div>`}}catch(ee){console.error("[Ranked] MMR update error:",ee)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const P=document.createElement("div");P.id="pvp-end-overlay",P.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const R=z?"🤝":j?"🏆":"😞",K=z?"MATCH NUL":j?"VICTOIRE !":"DÉFAITE",Q=z?"#fff":j?"#FFD700":"#ff6b6b";P.innerHTML=`
      <div style="font-size:64px">${R}</div>
      <div style="font-size:26px;font-weight:900;color:${Q}">${K}</div>
      ...
      ${N}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(P),(ie=P.querySelector("#pvp-end-home"))==null||ie.addEventListener("click",()=>{P.remove(),it(e),l?x("mini-league",{openLeagueId:l}):x(a?"ranked":"home")})}const Z=h.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var S;const L=_.new;try{if(L.status==="finished"||L.forfeit){if(M)return;M=!0,k&&(clearInterval(k),k=null),Ue(),L.game_state&&(m=L.game_state),te(L);return}if(L.game_state){const j=m;m=L.game_state;const z=m._lastGC;if(z&&z.seq&&!W.has(z.seq)&&(W.add(z.seq),z.by!==p)){$(z.type,z.by,()=>Y());return}const N=j[p+"Score"]||0,P=j[u+"Score"]||0,R=m[p+"Score"]||0,K=m[u+"Score"]||0,Q=R>N,ne=K>P;if((Q||ne)&&!F.has(m.round)){F.add(m.round);const ie=[...m.log||[]].reverse().find(le=>le.isGoal),ee=((ie==null?void 0:ie.homePlayers)||[]).map(le=>({name:le.name,note:le.note,portrait:le.portrait,job:le.job}));!!((S=ie==null?void 0:ie.text)!=null&&S.includes("DERNIER CORNER"))?Te().then(()=>{Qe(ee,R,K,Q,()=>Y())}):Qe(ee,R,K,Q,()=>Y());return}Y()}}catch(j){console.error("[PvP] crash:",j)}}).subscribe();async function A(_){Object.assign(m,_),m.lastActionAt=new Date().toISOString();const{error:L}=await h.from("matches").update({game_state:m}).eq("id",i);L&&g("Erreur de synchronisation","error");try{Y()}catch(S){console.error("[PvP] renderPvpScreen crash:",S)}}async function T(){if(M)return;M=!0,Tt(),Ue(),k&&(clearInterval(k),k=null);const _=n?v.away_id:v.home_id,L=n?"p2":"p1",S=n?"p1":"p2",j={...m,[L+"Score"]:3,[S+"Score"]:0,phase:"finished"},z=j.p1Score||0,N=j.p2Score||0;try{await h.from("matches").update({game_state:j}).eq("id",i);const{data:P,error:R}=await h.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:z,p_away_score:N,p_forfeit:!0});if(R&&console.error("[PvP] finish_pvp_match (forfeit):",R),l)try{await h.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await h.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{h.removeChannel(Z)}catch{}setTimeout(()=>{it(e),l?x("mini-league",{openLeagueId:l}):x("home")},800)}const V={BOOST_STAT:({value:_=1,count:L=1,roles:S=[]},j,z)=>{const N=j[p+"Team"],P=Object.entries(N).filter(([R])=>!S.length||S.includes(R)).flatMap(([R,K])=>K.filter(Q=>!Q.used).map(Q=>({...Q,_line:R})));if(!P.length){j.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(j);return}J(P,L,`Choisir ${L} joueur(s) à booster (+${_})`,R=>{R.forEach(K=>{const Q=(N[K._line]||[]).find(ne=>ne.cardId===K.cardId);Q&&(Q.boost=(Q.boost||0)+_,j.log.push({text:`⚡ +${_} sur ${Q.name}`,type:"info"}))}),j[p+"Team"]=N,z(j)})},DEBUFF_STAT:({value:_=1,count:L=1,roles:S=[],target:j="ai"},z,N)=>{const P=j==="home"?p:u,R=z[P+"Team"],K=j==="home"?"allié":"adverse",Q=Object.entries(R).filter(([ne])=>!S.length||S.includes(ne)).flatMap(([ne,ie])=>ie.map(ee=>({...ee,_line:ne})));if(!Q.length){z.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),N(z);return}J(Q,L,`Choisir ${L} joueur(s) ${K}(s) (-${_})`,ne=>{ne.forEach(ie=>{const ee=(R[ie._line]||[]).find(ae=>ae.cardId===ie.cardId);ee&&(ee.boost=(ee.boost||0)-_,z.log.push({text:`🎯 -${_} sur ${ee.name}`,type:"info"}))}),z[P+"Team"]=R,N(z)})},GRAY_PLAYER:({count:_=1,roles:L=[],target:S="ai"},j,z)=>{const N=S==="home"?p:u,P=j[N+"Team"],R=S==="home"?"allié":"adverse",K=Object.entries(P).filter(([Q])=>!L.length||L.includes(Q)).flatMap(([Q,ne])=>ne.filter(ie=>!ie.used).map(ie=>({...ie,_line:Q})));if(!K.length){j.log.push({text:`❌ Aucun joueur ${R}`,type:"info"}),z(j);return}J(K,_,`Choisir ${_} joueur(s) ${R}(s) à exclure`,Q=>{const ne="usedCardIds_"+N,ie=new Set(j[ne]||[]);Q.forEach(ee=>{const ae=(P[ee._line]||[]).find(le=>le.cardId===ee.cardId);ae&&(ae.used=!0,ie.add(ee.cardId),j.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),j[ne]=[...ie],j[N+"Team"]=P,z(j)})},REVIVE_PLAYER:({count:_=1,roles:L=[]},S,j)=>{const z=S[p+"Team"],N=Object.entries(z).filter(([P])=>!L.length||L.includes(P)).flatMap(([P,R])=>R.filter(K=>K.used).map(K=>({...K,_line:P})));if(!N.length){S.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),j(S);return}J(N,_,`Choisir ${_} joueur(s) à ressusciter`,P=>{P.forEach(R=>{const K=(z[R._line]||[]).find(Q=>Q.cardId===R.cardId);K&&(K.used=!1,S.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),S[p+"Team"]=z,j(S)})},REMOVE_GOAL:({},_,L)=>{const S=u+"Score";_[S]>0?(_[S]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(_)},ADD_GOAL_DRAW:({},_,L)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(_)},ADD_SUB:({value:_=1},L,S)=>{L.maxSubs=(L.maxSubs||3)+_,L.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),S(L)},CUSTOM:({},_,L)=>L(_)};function J(_,L,S,j){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let N=[];function P(){var K,Q;const R=_.map(ne=>{const ie=ne._line||ne.job||"MIL",ee=N.find(le=>le.cardId===ne.cardId),ae=Ie({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:ie,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(K=z.querySelector("#pp-close"))==null||K.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const ie=ne.dataset.cid,ee=_.find(le=>le.cardId===ie),ae=N.findIndex(le=>le.cardId===ie);ee&&(ae>-1?N.splice(ae,1):N.length<L&&N.push(ee),P())})}),(Q=z.querySelector("#pp-confirm"))==null||Q.addEventListener("click",()=>{z.remove(),j(N)})}P(),document.body.appendChild(z)}async function ue(_,L){const j=(m["gcCardsFull_"+p]||[]).find(R=>R.id===_),z=(j==null?void 0:j._gcDef)||(m.gcDefs||[]).find(R=>{var K;return R.name===L||((K=R.name)==null?void 0:K.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),N=[...m["usedGc_"+p]||[],_],P={type:L,by:p,seq:(m._gcAnimSeq||0)+1};W.add(P.seq),$(L,p,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const K=V[z.effect_type];if(K){const Q={...m};K(z.effect_params||{},Q,async ne=>{ne["usedGc_"+p]=N,ne._lastGC=P,ne._gcAnimSeq=P.seq,await A(ne)});return}}const R={...m};switch(L){case"Remplacement+":R.maxSubs=(R.maxSubs||3)+1,R.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const K=u+"Score";R[K]>0&&(R[K]--,R.log.push({text:"🚫 But annulé",type:"info"}));break}}R["usedGc_"+p]=N,R._lastGC=P,R._gcAnimSeq=P.seq,await A(R)})}function fe(_,L){const S="usedCardIds_"+_,j=new Set(m[S]||[]);L.forEach(z=>j.add(z)),m[S]=[...j]}function C(){for(const _ of["p1","p2"]){const L=new Set(m["usedCardIds_"+_]||[]),S=m[_+"Team"];if(S)for(const j of["GK","DEF","MIL","ATT"])(S[j]||[]).forEach(z=>{z.used=L.has(z.cardId)})}}function Y(){var rn,an,sn,dn,ln,cn;if(m.phase==="reveal")return pe();if(m.phase==="midfield")return O();if(m.phase==="finished")return Re();const _=m[p+"Team"],L=m[u+"Team"];C();const S=m[p+"Score"],j=m[u+"Score"],z=m[p+"Name"],N=m[u+"Name"],P=m.phase===p+"-attack",R=m.phase===p+"-defense",K=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],Q=K.map(X=>X.cardId),ne=window.innerWidth>=700,ie=m[p+"Subs"]||[],ee=m["usedSubIds_"+p]||[],ae=ie.filter(X=>!ee.includes(X.cardId)),le=m["gcCardsFull_"+p]||[],ge=m["usedGc_"+p]||[],ce=le.filter(X=>!ge.includes(X.id)),xe=m.boostOwner===p&&!m.boostUsed,ye=[..._.MIL||[],..._.ATT||[]].filter(X=>!X.used),re=[...L.MIL||[],...L.ATT||[]].filter(X=>!X.used),Ee=!ke(L),Ge=ye.length===0&&re.length===0&&!Ee,Le=(_.DEF||[]).filter(X=>!X.used),Ve=(_.GK||[]).filter(X=>!X.used);let Oe=[];P&&ye.length===0&&(Ee?(Oe=Le.map(X=>X.cardId),Le.length===0&&(Oe=Oe.concat(Ve.map(X=>X.cardId)))):Ge&&(Oe=[...Le,...Ve].map(X=>X.cardId)));function nt(X,me,Ae){var Me,ft;const we=X._gcDef,qt=(we==null?void 0:we.name)||X.gc_type,at=(we==null?void 0:we.effect)||((Me=je[X.gc_type])==null?void 0:Me.desc)||"",Fe=we!=null&&we.image_url?`/icons/${we.image_url}`:null,Ne=((ft=je[X.gc_type])==null?void 0:ft.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      </div>`}const De=(X,me)=>me?Kt(95,162):nt(X,95),Ye=(X,me)=>me?Kt(68,116):nt(X,68),He=ne?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",pt=P?ct(p)?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${K.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${He};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:R?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${K.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${N}</div>`,ot=P&&!ct(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':P||R?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${K.length}/3 sélectionné(s)</div>`:"",jt=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${ne?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${ae.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':ae.map(X=>`<div class="pvp-sub-btn" data-sub-id="${X.cardId}" style="cursor:pointer;flex-shrink:0">${ht(X,ne?76:44,ne?100:58)}</div>`).join("")}
    </div>`,ut=P?"attack":R?"defense":"idle",kt=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ot(_,m[p+"Formation"],ut,Q,ne?1300:zt(),ne?600:Gt(),Oe)}
      </div>
    </div>`,rt=m[p+"Team"],lo=(()=>{var me,Ae,we,qt,at;if(R&&((me=m.pendingAttack)!=null&&me.players)){const Fe=m.pendingAttack;let Ne="";if(K.length>0){const Me=K.map(We=>{const Vt=(rt[We._role]||[]).find(Li=>Li.cardId===We.cardId)||We,Yt=rt[We._role]||[],si=Yt.findIndex(Li=>Li.cardId===We.cardId),Ei=xt(Yt.length),Wt=si>=0?Ei[si]:Vt._col??1;return{...Vt,_line:We._role,_col:Wt}}),ft=ri(Me,((Ae=m.modifiers)==null?void 0:Ae[p])||{},m[p+"Formation"]);Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
        ...
        </div>`}const X=(m.log||[]).slice(-1)[0];return X?'<div style="padding:2px 4px">'+Xn(X)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),on=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Ot(_,m[p+"Formation"],ut,Q,zt(),Gt(),Oe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
          <div style="display:flex;gap:6px;overflow-x:auto;align-items:flex-end;min-height:96px;padding-bottom:2px">
            ...
            ${xe?Ye(null,!0):""}
            <div id="pvp-sub-open" style="cursor:${P&&ae.length>0?"pointer":"default"};flex-shrink:0;box-sizing:border-box;width:68px;height:95px;border-radius:10px;border:2px solid ${P&&ae.length>0?"rgba(255,255,255,0.5)":"rgba(255,255,255,0.15)"};background:${P&&ae.length>0?"rgba(60,60,60,0.9)":"rgba(40,40,40,0.5)"};display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;opacity:${P&&ae.length>0?1:.4}">
              <div style="display:flex;gap:6px;align-items:center">
                <div style="text-align:center">
                  <div style="font-size:7px;color:#00ff88;font-weight:700;letter-spacing:1px">IN</div>
      ...
      </div>`;function Bt(){const X=e.querySelector(".match-screen");if(!X)return;const me=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=me+"px",X.style.minHeight=me+"px",X.style.maxHeight=me+"px",X.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),we=e.querySelector("#mobile-play-area");Ae&&we&&(we.style.paddingBottom=Ae.offsetHeight+"px")}if(Bt(),setTimeout(Bt,120),setTimeout(Bt,400),I||(I=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Bt),window.visualViewport.addEventListener("scroll",Bt)),window.addEventListener("resize",Bt)),function(){const me=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!me)return;const Ae=me.closest("#match-terrain-wrap");Ae&&(Ae.style.cssText="position:relative;width:100%;height:100%;padding:0"),me.removeAttribute("width"),me.removeAttribute("height"),me.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",me.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const me=X.closest("#match-terrain-wrap");me&&(me.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!P&&!R)return;const me=X.dataset.cardId,Ae=X.dataset.role,we=(_[Ae]||[]).find(Ne=>Ne.cardId===me);if(!we||we.used)return;const qt=Oe.includes(me);if(P&&!["MIL","ATT"].includes(Ae)&&!qt)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const at=m["selected_"+p],Fe=at.findIndex(Ne=>Ne.cardId===me);Fe>-1?at.splice(Fe,1):at.length<3&&at.push({...we,_role:Ae}),Y()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>H(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>H())}),(rn=e.querySelector("#pvp-sub-open"))==null||rn.addEventListener("click",()=>H()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{P?X.addEventListener("click",()=>q(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(an=e.querySelector("#pvp-boost-card"))==null||an.addEventListener("click",()=>U()),(sn=e.querySelector("#pvp-action"))==null||sn.addEventListener("click",X=>{P?X.currentTarget.dataset.pass==="1"||!ct(p)?se():ze():R&&Se()}),(dn=e.querySelector("#pvp-quit"))==null||dn.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&T()}),(ln=e.querySelector("#pvp-view-opp"))==null||ln.addEventListener("click",()=>D()),(cn=e.querySelector("#pvp-toggle-history"))==null||cn.addEventListener("click",()=>G()),k&&(clearInterval(k),k=null),Ue(),(P||R)&&!M){let X=30,me=!1;const Ae=()=>document.getElementById("pvp-timer"),we=()=>{Ae()&&(Ae().textContent=X+"s",Ae().style.color=me?"#ff4444":"#fff")};we(),k=setInterval(()=>{X--,X<0?me?(clearInterval(k),k=null,Ue(),P&&!ct(p)?se():T()):(me=!0,X=15,we(),Mn("/sounds/timer-urgent.mp3",.6)):we()},1e3)}}function pe(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${bi(_,m[p+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
        <div id="pvp-score-me" style="font-size:48px;font-weight:900;color:#D4A017;transition:all .5s ease">0</div>
        <div id="pvp-vs" style="font-size:14px;color:rgba(255,255,255,.4);letter-spacing:3px;opacity:0">VS</div>
        <div id="pvp-score-opp" style="font-size:48px;font-weight:900;color:rgba(255,255,255,.7);transition:all .5s ease">0</div>
      </div>
      ${bi(L,m[u+"Name"]||"Adversaire","#e03030","opp",null)}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const N=(ae,le)=>e.querySelectorAll(ae).forEach((ge,ce)=>{setTimeout(()=>{ge.style.opacity="1",ge.style.transform="translateY(0) scale(1)"},le+ce*90)});N(".duel-card-me",150),N(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((ae,le)=>setTimeout(()=>{ae.style.opacity="1"},le*70)),900),setTimeout(()=>{const ae=e.querySelector("#pvp-vs");ae&&(ae.style.opacity="1",ae.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(le=>le.style.opacity="1")},1250);function P(ae,le,ge){const ce=document.getElementById(ae);if(!ce)return;const xe=performance.now(),ye=re=>{const Ee=Math.min(1,(re-xe)/ge);ce.textContent=Math.round(le*(1-Math.pow(1-Ee,3))),Ee<1?requestAnimationFrame(ye):ce.textContent=le};requestAnimationFrame(ye)}setTimeout(()=>{P("pvp-score-me",S,800),P("pvp-score-opp",j,800)},1500);const R=m.p1Team.MIL||[],K=m.p2Team.MIL||[],Q=bt(R)+yt(R),ne=bt(K)+yt(K),ie=Q>=ne?"p1":"p2";let ee=m.boostValue;ee==null&&(ee=Yn(),m.boostValue=ee,m.boostOwner=ie,m.boostUsed=!1),B=!0,setTimeout(()=>{const ae=e.querySelector("#duel-row-"+(z?"me":"opp")),le=e.querySelector("#duel-row-"+(z?"opp":"me")),ge=document.getElementById("pvp-score-me"),ce=document.getElementById("pvp-score-opp"),xe=z?ge:ce,ye=z?ce:ge;xe&&(xe.style.fontSize="80px",xe.style.color=z?"#FFD700":"#ff6b6b",xe.style.animation="duelPulse .5s ease"+(z?",duelGlow 1.5s ease infinite .5s":"")),ye&&(ye.style.opacity="0.25"),setTimeout(()=>{ae&&(ae.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ae.style.zIndex="5"),setTimeout(()=>{const re=document.getElementById("duel-shock");re&&(re.style.animation="shockwave .5s ease-out forwards"),le&&(le.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Le;const re=document.getElementById("pvp-duel-finale");if(!re)return;const Ee=m.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+ee+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ge=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;re.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(z?"⚽ "+m[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+m[u+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Ee+Ge,re.style.transition="opacity .45s ease",re.style.opacity="1",re.style.pointerEvents="auto",(Le=document.getElementById("pvp-start-match"))==null||Le.addEventListener("click",async()=>{const Ve=ie;await A({phase:Ve+"-attack",attacker:Ve,round:1,boostValue:ee,boostUsed:!1,boostOwner:Ve})})},600)},700)},2800)}function $(_,L,S){var le,ge;const j=(m.gcDefs||[]).find(ce=>{var xe;return ce.name===_||((xe=ce.name)==null?void 0:xe.toLowerCase().trim())===(_==null?void 0:_.toLowerCase().trim())}),z={purple:"#b06ce0",light_blue:"#00d4ef"}[j==null?void 0:j.color]||"#b06ce0",N=(j==null?void 0:j.name)||_,P=(j==null?void 0:j.effect)||((le=je[_])==null?void 0:le.desc)||"",R=j!=null&&j.image_url?`/icons/${j.image_url}`:null,K=((ge=je[_])==null?void 0:ge.icon)||"⚡",ne=L===p?"Vous":m[L+"Name"]||"Adversaire",ie=document.createElement("div");ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",ie.innerHTML=`
      <style>
      ...
      <div style="animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        ${tt(N,R,K,P,{width:200})}
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(ie);let ee=!1;const ae=()=>{ee||(ee=!0,ie.remove(),setTimeout(()=>S&&S(),50))};ie.addEventListener("click",ae),setTimeout(ae,3e3)}function q(_,L){var ne,ie,ee,ae;const j=(m["gcCardsFull_"+p]||[]).find(le=>le.id===_),z=j==null?void 0:j._gcDef,N=(z==null?void 0:z.name)||L,P=(z==null?void 0:z.effect)||((ne=je[L])==null?void 0:ne.desc)||"Carte spéciale.",R=z!=null&&z.image_url?`/icons/${z.image_url}`:null,K=((ie=je[L])==null?void 0:ie.icon)||"⚡",Q=document.createElement("div");Q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Q.innerHTML=`
      ${tt(N,R,K,P,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(Q),(ee=Q.querySelector("#pvp-gc-back"))==null||ee.addEventListener("click",()=>Q.remove()),(ae=Q.querySelector("#pvp-gc-use"))==null||ae.addEventListener("click",()=>{Q.remove(),ue(_,L)})}function U(){var j;const _=m[p+"Team"],L=Object.entries(_).flatMap(([z,N])=>(N||[]).filter(P=>!P.used).map(P=>({...P,_line:z})));if(!L.length)return;const S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",S.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(z=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",P=Pe(z,z._line)+(z.boost||0);return`<div class="bp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${N};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(S),(j=S.querySelector("#bp-close"))==null||j.addEventListener("click",()=>S.remove()),S.querySelectorAll(".bp-item").forEach(z=>{z.addEventListener("click",async()=>{const N=z.dataset.cid,P=L.find(K=>K.cardId===N);if(!P)return;const R=(_[P._line]||[]).find(K=>K.cardId===N);R&&(R.boost=(R.boost||0)+m.boostValue),S.remove(),await A({[p+"Team"]:_,boostUsed:!0})})})}function H(_=null){var ae,le;if(!(m.phase===p+"-attack")){g("Remplacement uniquement avant votre attaque","warning");return}const S=m[p+"Team"],j=m["usedSubIds_"+p]||[],z=m.maxSubs||3;if(j.length>=z){g(`Maximum ${z} remplacements atteint`,"warning");return}const N=Object.entries(S).flatMap(([ge,ce])=>(ce||[]).filter(xe=>xe.used).map(xe=>({...xe,_line:ge}))),P=(m[p+"Subs"]||[]).filter(ge=>!j.includes(ge.cardId));if(!N.length){g("Aucun joueur utilisé à remplacer","warning");return}if(!P.length){g("Aucun remplaçant disponible","warning");return}let R=Math.max(0,N.findIndex(ge=>ge.cardId===_));const K=((ae=N[R])==null?void 0:ae._line)||((le=N[R])==null?void 0:le.job);let Q=Math.max(0,P.findIndex(ge=>ge.job===K)),ne=!1;const ie=document.createElement("div");ie.id="pvp-sub-overlay",ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function ee(){var Ge,Le,Ve,Oe,nt,Kt;const ge=N[R],ce=P[Q],xe=Math.min(130,Math.round((window.innerWidth-90)/2)),ye=Math.round(xe*1.35),re=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;ie.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${ce?ht({...ce,used:!1,boost:0},xe,ye):"<div>—</div>"}</div>
          <button id="pin-down" style="${re(Q>=P.length-1)}" ${Q>=P.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${Q+1}/${P.length}</div>
        </div>
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          <div style="font-size:9px;color:#ff6b6b;letter-spacing:2px;text-transform:uppercase;font-weight:700">Joueur qui sort</div>
          <button id="pout-up" style="${re(R===0)}" ${R===0?"disabled":""}>▲</button>
          <div>${ge?ht({...ge,used:!1,boost:0},xe,ye):"<div>—</div>"}</div>
          <button id="pout-down" style="${re(R>=N.length-1)}" ${R>=N.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${R+1}/${N.length}</div>
        </div>
      </div>
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(Ge=ie.querySelector("#psub-close"))==null||Ge.addEventListener("click",()=>ie.remove()),(Le=ie.querySelector("#pout-up"))==null||Le.addEventListener("click",()=>{R>0&&(R--,ee())}),(Ve=ie.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{R<N.length-1&&(R++,ee())}),(Oe=ie.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{Q>0&&(Q--,ee())}),(nt=ie.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{Q<P.length-1&&(Q++,ee())});const Ee=(De,Ye,He,pt)=>{const ot=ie.querySelector("#"+De);if(!ot)return;let jt=0;ot.addEventListener("touchstart",ut=>{jt=ut.touches[0].clientY},{passive:!0}),ot.addEventListener("touchend",ut=>{const kt=ut.changedTouches[0].clientY-jt;if(Math.abs(kt)<30)return;const rt=Ye();kt<0&&rt<pt-1?(He(rt+1),ee()):kt>0&&rt>0&&(He(rt-1),ee())},{passive:!0})};Ee("pin-panel",()=>Q,De=>Q=De,P.length),Ee("pout-panel",()=>R,De=>R=De,N.length),(Kt=ie.querySelector("#psub-confirm"))==null||Kt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ne)return;ne=!0;const Ye=N[R],He=P[Q];if(!Ye||!He)return;const pt=Ye._line,ot=(S[pt]||[]).findIndex(kt=>kt.cardId===Ye.cardId);if(ot===-1){g("Erreur : joueur introuvable","error"),ie.remove();return}const jt={...He,_line:pt,position:Ye.position,used:!1,boost:0};S[pt].splice(ot,1,jt);const ut=[...j,He.cardId];ie.remove(),oe(Ye,He,async()=>{await A({[p+"Team"]:S,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(ie),ee()}function oe(_,L,S){const j={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(K,Q,ne)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${Q};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${ne}</div>
      <div style="width:70px;height:70px;border-radius:50%;background:${j[K.job]||"#555"};border:3px solid ${Q};position:relative;overflow:hidden;margin:0 auto">
        ${At(K)?`<img src="${At(K)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(_),(L=_.querySelector("#pvp-opp-close"))==null||L.addEventListener("click",()=>_.remove())}function G(){var S;const _=m.log||[],L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",L.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(S=L.querySelector("#pvp-hist-close"))==null||S.addEventListener("click",()=>L.remove())}async function se(){if(m.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",L=(m.round||0)+1,S=[...m.log||[]];S.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const j=$e(m),z=ct(_),N=j||!z?"finished":_+"-attack";await A({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:N,attacker:_,round:L,log:S}),N==="finished"&&await qe(m)}function de(_){const L=(_.GK||[]).some(j=>!j.used),S=["DEF","MIL","ATT"].some(j=>(_[j]||[]).some(z=>!z.used));return L&&!S}function he(_){return(_.p1Score||0)!==(_.p2Score||0)?null:de(_.p1Team)&&!ke(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(L=>!L.used)}:de(_.p2Team)&&!ke(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(L=>!L.used)}:null}async function Te(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const L=(S,j)=>new Promise(z=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${j};letter-spacing:2px;animation:lcFade 1.4s ease both">${S}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(z,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function ve(_,L){const{side:S,gk:j}=_;if(!j)return;const z=S+"Score",N=(L[z]||0)+1;j.used=!0;const P=[...L.log||[]];P.push({type:"duel",isGoal:!0,homeScored:S===p,homePlayers:S==="p1"?[Dt(j)]:[],aiPlayers:S==="p2"?[Dt(j)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[S+"Name"]} marque !`});const R=(L.round||0)+1,K=S==="p1"?"p2":"p1",Q={...L,[z]:N},ne=$e(Q);F.add(R),await Te();const ie=S===p?N:L[p+"Score"]||0,ee=S===p?L[u+"Score"]||0:N;Qe([Dt(j)],ie,ee,S===p,async()=>{await A({[z]:N,log:P,round:R,pendingAttack:null,phase:ne?"finished":K+"-attack",attacker:K,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),ne&&await qe({...m,[z]:N})})}async function ze(){const _=m[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(N=>(m[u+"Team"][N]||[]).some(P=>!P.used)),S=(m["selected_"+p]||[]).map(N=>{const P=(_[N._role]||[]).find(le=>le.cardId===N.cardId)||N,R=["GK","DEF"].includes(N._role),K=_[N._role]||[],Q=K.findIndex(le=>le.cardId===N.cardId),ne=xt(K.length),ie=Q>=0?ne[Q]:P._col??1,ee=m.stadiumDef||m.homeStadiumDef||null,ae=P.stadiumBonus||ee&&(ee.club_id&&String(P.club_id)===String(ee.club_id)||ee.country_code&&P.country_code===ee.country_code)||!1;return{...P,_line:N._role,_col:ie,stadiumBonus:ae,...R?{note_a:Math.max(1,Number(P.note_a)||0)}:{}}});if(!S.length)return;const j=oi(S,m.modifiers[p]||{},m[p+"Formation"]);fe(p,S.map(N=>N.cardId)),S.forEach(N=>{const P=(_[N._role]||[]).find(R=>R.cardId===N.cardId);P&&(P.used=!0)}),m["selected_"+p]=[],Y();const z=[...m.log||[]];if(L){if(S.length===1&&(S[0]._line==="GK"||S[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await ve({side:p,gk:S[0]},{...m,[p+"Team"]:_,log:z});return}const P=(m[p+"Score"]||0)+1,R=S.map(ee=>Dt(ee));z.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:R,homeTotal:j.total,aiTotal:0});const K=(m.round||0)+1,Q=p==="p1"?"p2":"p1",ne={...m,[p+"Team"]:_,[p+"Score"]:P},ie=$e(ne);F.add(K),Qe(R,P,m[u+"Score"]||0,!0,async()=>{await A({[p+"Team"]:_,[p+"Score"]:P,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ie?"finished":Q+"-attack",attacker:Q,round:K,log:z}),ie&&await qe({...m,[p+"Score"]:P})});return}z.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${j.total})`}),await A({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],pendingAttack:{...j,players:S,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:z})}async function Se(){const _=m[p+"Team"],L=(m["selected_"+p]||[]).map(ce=>{const xe=(_[ce._role]||[]).find(Le=>Le.cardId===ce.cardId)||ce,ye=_[ce._role]||[],re=ye.findIndex(Le=>Le.cardId===ce.cardId),Ee=xt(ye.length),Ge=re>=0?Ee[re]:xe._col??1;return{...xe,_line:ce._role,_col:Ge}}),S=ri(L,m.modifiers[p]||{},m[p+"Formation"]);fe(p,L.map(ce=>ce.cardId)),L.forEach(ce=>{const xe=(_[ce._role]||[]).find(ye=>ye.cardId===ce.cardId);xe&&(xe.used=!0)}),m["selected_"+p]=[],Y();const j=Qi(m.pendingAttack.total,S.total,m.modifiers[p]||{}),z=m.pendingAttack.side,N=j==="attack"||(j==null?void 0:j.goal),P=z==="p1"?"p2":"p1",R=(m.round||0)+1,K=(m.pendingAttack.players||[]).map(ce=>Dt(ce)),Q=[...m.log||[]];Q.push({type:"duel",isGoal:N,homeScored:N&&z===p,text:N?`⚽ BUT de ${m[z+"Name"]} ! (${m.pendingAttack.total} vs ${S.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${S.total})`,homePlayers:K,aiPlayers:L.map(ce=>Dt(ce)),homeTotal:m.pendingAttack.total,aiTotal:S.total});const ne=N?(m[z+"Score"]||0)+1:m[z+"Score"]||0,ie={...m,[p+"Team"]:_,[z+"Score"]:ne},ee=$e(ie),ae=ee?"finished":P+"-attack",le=!ee&&!N?he(ie):null,ge=async()=>{if(le){await ve(le,ie);return}await A({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],[z+"Score"]:ne,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:P,round:R,log:Q}),(ae==="finished"||ee)&&await qe({...m,[z+"Score"]:ne})};if(N){const ce=z===p,xe=ce?ne:m[p+"Score"]||0,ye=ce?m[u+"Score"]||0:ne;F.add(R),Qe(K,xe,ye,ce,ge)}else await ge()}function Be(_){return["MIL","ATT"].some(L=>(_[L]||[]).some(S=>!S.used))}function ke(_){return["GK","DEF","MIL","ATT"].some(L=>(_[L]||[]).some(S=>!S.used))}function _t(_){return ke(_)&&!Be(_)}function ct(_){const L=m[_+"Team"],S=m[(_==="p1"?"p2":"p1")+"Team"];return!!(Be(L)||_t(L)&&!ke(S)||_t(L)&&!Be(S)&&ke(S))}function $e(_){return!ke(_.p1Team)&&!ke(_.p2Team)}function Ce(_){const L=_.p1Score||0,S=_.p2Score||0;return L===S?null:L>S?v.home_id:v.away_id}async function qe(_){Tt(),Ue();try{const L=Ce(_),S=L?v.home_id===L?v.away_id:v.home_id:null,j=_.p1Score||0,z=_.p2Score||0,{data:N,error:P}=await h.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:j,p_away_score:z,p_forfeit:!1});if(P&&console.error("[PvP] finish_pvp_match:",P),l)try{await h.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(R){console.error("[PvP] check_and_finish_mini_league:",R)}L&&S&&Nr(L,S).catch(()=>{});try{const{data:R}=await h.rpc("apply_match_rewards",{p_match_id:i});R!=null&&R.success&&!(R!=null&&R.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(R){console.error("[PvP] apply_match_rewards:",R)}if(typeof c=="function")try{await c({homeScore:j,awayScore:z,winnerId:L,homeId:v.home_id,awayId:v.away_id,matchId:i})}catch(R){console.error("[PvP] onMatchEnd:",R)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Re(){var z;const _=m[p+"Score"],L=m[u+"Score"],S=_>L,j=_===L;st(e),e.innerHTML=`
    ...
    </div>`,(z=document.getElementById("pvp-home"))==null||z.addEventListener("click",()=>{try{h.removeChannel(Z)}catch{}it(e),l?x("mini-league",{openLeagueId:l}):x("home")})}Y()}async function Ri(e,t,i=!1){var s,d;const{state:n,navigate:o,toast:r}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await ki(e,t,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{st(e);const u=async y=>{await Ur(e,t,c,l,f,b,y||[],g,p,i,a)};if(!(x!=null&&x.length)){await u([]);return}wi(e,x,u)})}async function Hr(e,t,i){return Or(e,t,i)}async function Ur(e,t,i,n,o,r,a=[],s=[],d=null,c=!1,l=null){var te,Z;const{state:f,navigate:b,toast:x}=t,g=(l==null?void 0:l.mmr)??((te=f.profile)==null?void 0:te.mmr)??1e3,p=c?hi(g):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,v=null,E=null;e.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,v&&(v.unsubscribe(),v=null),E&&(clearInterval(E),E=null);try{await h.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(A){console.error("[Matchmaking] cancel error:",A)}};(Z=document.getElementById("cancel-mm"))==null||Z.addEventListener("click",async()=>{await m(),it(e),b("home")});const M=async(A,T)=>{w||(w=!0,v&&(v.unsubscribe(),v=null),E&&(clearInterval(E),E=null),await Ct(e,t,A,T,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?Kr:null}))},k=f.user.id,{data:I,error:F}=c?await h.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:g}):await h.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(F||!(I!=null&&I.success)){console.error("[Matchmaking] try_matchmake error:",F||I),x("Erreur de matchmaking","error"),it(e),b("home");return}if(I.matched){await M(I.match_id,!1);return}const W=async()=>{if(w)return;const{data:A}=await h.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(A==null?void 0:A.status)==="matched"&&A.match_id&&await M(A.match_id,!0)};v=h.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},A=>{const T=A.new;T.status==="matched"&&T.match_id&&M(T.match_id,!0)}).subscribe(),E=setInterval(W,3e3),setTimeout(()=>{w||m()},12e4)}async function Kr(e,t){const{state:i,toast:n}=t,{winnerId:o,homeId:r,awayId:a,homeScore:s,awayScore:d,matchId:c}=e,l=i.user.id,f=r===l,b=o===l,{data:x}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:r).single();if(x&&g){const p=co(x.mmr,x.mmr_rd,x.mmr_v,g.mmr,g.mmr_rd,b?1:0);await h.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:b?h.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:h.sql`mmr_losses + 1`}).eq("id",l),n(b?`+MMR ↑ ${Math.round(p.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-p.mmr)}`,b?"success":"error",4e3)}}const eo=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ri,resumePvpMatch:Hr},Symbol.toStringTag,{value:"Module"}));async function Vr(e,t){const{state:i,navigate:n,toast:o}=t,r=i.params||{},a=r.friendId||null,s=r.friendName||"Ami",d=!!r.isAccepting;await ki(e,t,"friend",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{st(e);const u=async y=>{const w=y||[];d?await Wr(e,t,c,w,g,p):await Yr(e,t,c,w,g,p,a,s)};if(!(x!=null&&x.length)){await u([]);return}wi(e,x,u)})}async function Yr(e,t,i,n,o,r,a,s){var w;const{state:d,navigate:c,toast:l}=t,f=d.user.id,{data:b,error:x}=await h.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!b){console.error("[Friend] Erreur création invitation:",x),l("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Lt}">
      ${w.map(m=>`<button class="ml-tab" data-tab="${m.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===m.key?to:"transparent"};background:none;font-size:12px;font-weight:${i===m.key?"900":"600"};color:${i===m.key?"#4ade80":Xr};cursor:pointer">${m.label}${m.count?` (${m.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Qr(x,y,o):i==="active"?Zr(g,o):ea(u,o,s)}
    </div>
  </div>`,(v=document.getElementById("ml-create-btn"))==null||v.addEventListener("click",()=>ta(e,t)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>et(e,t,i)),e.querySelectorAll(".ml-tab").forEach(m=>m.addEventListener("click",()=>et(e,t,m.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(m=>m.addEventListener("click",()=>lt(e,t,m.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(m=>m.addEventListener("click",M=>{M.stopPropagation(),no(e,t,m.dataset.join,m.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(m=>m.addEventListener("click",M=>{M.stopPropagation(),Gi(e,t,m.dataset.delete,m.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(m=>m.addEventListener("click",async M=>{M.stopPropagation(),m.disabled=!0,m.textContent="...";const{data:k,error:I}=await h.rpc("claim_mini_league_prize",{p_league_id:m.dataset.claimLeague,p_user_id:n.profile.id});if(I||!(k!=null&&k.success)){t.toast((k==null?void 0:k.error)||"Erreur lors de la récupération","error"),et(e,t,i);return}if(!k.already_claimed){n.profile.credits=(n.profile.credits||0)+k.prize;const F=document.getElementById("nav-credits");F&&(F.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${k.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}et(e,t,i)}))}function vi(e,t,i=!1,n=null){var d,c;const o=e.creator_id===t,r=e.pot||0,a=((c=(d=e.mini_league_members)==null?void 0:d[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Jt};border:1px solid ${s?"rgba(212,160,23,0.5)":Qt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Jt};border:1px solid ${Qt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((A,T)=>{const V=g>0&&a.status==="finished"?T===0?Math.floor(g*.7):T===1?Math.floor(g*.2):T===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${A.userId===r?"background:rgba(74,222,128,0.08);":""}">
              ...
              ${g>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${dt}">${V?V.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
  ...
  </div>`;const v=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>et(e,t,v)),(m=document.getElementById("ml-refresh"))==null||m.addEventListener("click",async A=>{const T=A.currentTarget;T.style.opacity="0.5",await lt(e,t,i)}),(M=document.getElementById("ml-start-btn"))==null||M.addEventListener("click",()=>ra(e,t,a,f)),(k=document.getElementById("ml-next-day"))==null||k.addEventListener("click",()=>aa(e,t,i)),(I=document.getElementById("ml-join-now"))==null||I.addEventListener("click",()=>no(e,t,i,a.type)),(F=document.getElementById("ml-leave-btn"))==null||F.addEventListener("click",()=>na(e,t,i,p)),(W=document.getElementById("ml-delete-btn"))==null||W.addEventListener("click",()=>Gi(e,t,i,a.name,"waiting")),(te=document.getElementById("ml-delete-now"))==null||te.addEventListener("click",()=>Gi(e,t,i,a.name,v)),(Z=document.getElementById("ml-archive-btn"))==null||Z.addEventListener("click",()=>oa(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(A=>{A.addEventListener("click",()=>{const T=x.find(V=>V.id===A.dataset.playMatch);T&&t.navigate("match-mini-league",{mlMatchId:T.id,leagueId:i})})}),a.status==="finished"&&w){const A=b.findIndex(T=>T.userId===r);A>=0&&A<3&&w.prize_amount>0&&!w.prize_claimed&&setTimeout(()=>sa(e,t,a,w,A),400)}}function En(e,t,i,n,o=!1){const r=f=>t.find(b=>b.id===f);if(e.is_bye){const f=r(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${Et};text-align:center">🔵 ${(f==null?void 0:f.club_name)||(f==null?void 0:f.pseudo)||"?"} exempté(e)</div>`}const a=r(e.home_id),s=r(e.away_id),d=e.home_id===i||e.away_id===i,c=d&&e.status==="pending"&&n&&!o,l=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${d?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${d?"rgba(74,222,128,0.35)":Lt}">
  ...
  </div>`}async function ra(e,t,i,n){const{toast:o,state:r}=t,a=da(n.map(c=>c.id),i.mode),s=[];a.forEach((c,l)=>c.forEach(f=>s.push({league_id:i.id,matchday:l+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:d}=await h.from("mini_league_matches").insert(s);if(d){o("Erreur calendrier : "+d.message,"error");return}await h.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),o(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),lt(e,t,i.id)}async function aa(e,t,i){const{data:n}=await h.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),o=(n.current_day||0)+1;if(o>(n.total_days||0)){lt(e,t,i);return}await h.from("mini_leagues").update({current_day:o}).eq("id",i),t.toast(`Journée ${o} commencée !`,"success"),lt(e,t,i)}async function sa(e,t,i,n,o){var b,x;const{state:r,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],d=["🥇","🥈","🥉"][o],c=n.prize_amount||s[o]||0,l=n.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function fa(e,t,i){let n=0;const o=document.createElement("div");o.id="tutorial-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const r=()=>{var l,f,b;const s=t[n],d=n===t.length-1,c=Math.round((n+1)/t.length*100);o.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let d="buy";const c=()=>{var p,u,y,w,v,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((y=document.getElementById("flt-country"))==null?void 0:y.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((v=document.getElementById("flt-rarity"))==null?void 0:v.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function l(p){const u=c();return p.filter(y=>{var F,W,te;const w=(F=y.card)==null?void 0:F.player;if(!w)return!1;const v=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((W=w.clubs)==null?void 0:W.encoded_name)||"").toLowerCase(),m=(w.country_code||"").toLowerCase(),M=((te=y.card)==null?void 0:te.evolution_bonus)||0,k=Ft(w,w.job,M),I=w.job2?Ft(w,w.job2,M):0;return!(u.name&&!v.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!m.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&k<u.note1||u.note2&&I<u.note2)})}function f(p){var I,F,W,te;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const y=((F=p.card)==null?void 0:F.evolution_bonus)||0,w=Ft(u,u.job,y),v=u.job2?Ft(u,u.job2,y):0,E=(i.profile.credits||0)>=p.price,m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ui[u.job]||"#bbb",k=u.job2?ui[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function b(p){var I,F,W,te;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const y=((F=p.card)==null?void 0:F.evolution_bonus)||0,w=Ft(u,u.job,y),v=u.job2?Ft(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ui[u.job]||"#bbb",k=u.job2?ui[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${m?`<img src="${m}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(W=u.clubs)!=null&&W.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
    ...
    </div>`}function x(){const p=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(p){if(u.style.display=d==="buy"?"flex":"none",d==="buy"){const y=l(a);p.innerHTML=y.length?y.map(f).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const y=s.filter(v=>v.status==="active").sort((v,E)=>new Date(E.listed_at)-new Date(v.listed_at)),w=s.filter(v=>v.status==="sold").sort((v,E)=>new Date(E.sold_at||E.listed_at)-new Date(v.sold_at||v.listed_at));p.innerHTML=(y.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${y.length})</div>`+y.map(b).join(""):"")+(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${w.length})</div>`+w.map(b).join(""):"")+(!y.length&&!w.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(y=>y.addEventListener("click",()=>xa(y.dataset.buy,a,e,t))),p.querySelectorAll("[data-cancel]").forEach(y=>y.addEventListener("click",()=>ya(y.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{d=p.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(u=>{const y=u===p;u.style.background=y?"var(--green)":"var(--tile-bg)",u.style.color=y?"#fff":"var(--tile-fg-dim)",u.style.borderColor=y?"var(--green)":"var(--tile-border)"}),x()})});let g;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var u;(u=document.getElementById(p))==null||u.addEventListener("input",()=>{clearTimeout(g),g=setTimeout(x,250)})}),x()}async function xa(e,t,i,n){const{state:o,toast:r,refreshProfile:a}=n,s=t.find(l=>l.id===e);if(!s)return;const d=s.price;if((o.profile.credits||0)<d){r("Crédits insuffisants","error");return}ba(s,async()=>{const{error:l}=await h.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:o.profile.id});if(l){r("Erreur achat : "+l.message,"error");return}await a();const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r("✅ Carte achetée !","success"),await nn(i,n)})}function ba(e,t){var a;const i=(a=e.card)==null?void 0:a.player,n=i?`${i.firstname} ${i.surname_real}`:"cette carte",o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",o.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
          ...
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${A?"border:2px solid var(--yellow)":""}">
            ...
            <div style="text-align:right;flex-shrink:0">
              <div style="font-size:20px">${T?"❓":W.emoji}</div>
              <div style="font-size:11px;font-weight:700;color:${W.color}">${T?"Placement":W.label}</div>
              ${T?"":`<div style="font-size:10px;color:var(--tile-fg-dim)">${Z}% WR</div>`}
            </div>
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(d==="mini-league"){const k=a||[];v.innerHTML=k.length>0?k.map((I,F)=>`
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const k=s||[];v.innerHTML=k.length>0?k.map((I,F)=>`
        <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${I.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${c(F)};color:${l(F)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${F<3?"16":"13"}px">${F<3?["🥇","🥈","🥉"][F]:F+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${I.pseudo}</div>
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>n("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,f=s.placement_matches??0,b=f<10,x=Math.max(0,10-f),g=hi(d),p=In(d),u=Ti.findIndex(W=>W.id===g.id),y=Ti[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},v=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=v>0?Math.round((s.ranked_wins||0)/v*100):0,m=Ti.map(W=>`
  ...
  </div>`,(k=document.getElementById("ranked-back"))==null||k.addEventListener("click",()=>n("home")),(I=document.getElementById("ranked-leaderboard-btn"))==null||I.addEventListener("click",()=>n("rankings",{tab:"ranked"})),(F=document.getElementById("ranked-play-btn"))==null||F.addEventListener("click",()=>{n("match",{matchMode:"ranked",rankedData:{mmr:d,rd:c,sigma:l,isPlacement:b}})})}async function wa(e,{state:t,navigate:i,toast:n}){const o=t.profile;if(!o)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:r}=await h.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${o.id},away_id.eq.${o.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},s=(r||[]).filter(l=>l.status==="finished"),d=(r||[]).filter(l=>l.status==="in_progress");function c(l){const f=l.home_id===o.id;f?l.home_score:l.away_score,f?l.away_score:l.home_score;const b=l.winner_id===o.id,x=l.home_score===l.away_score&&l.status==="finished",g=l.status!=="finished"?"…":x?"N":b?"V":"D",p=l.status!=="finished"||x?"#888":b?"#1A6B3C":"#c0392b";let u=a[l.mode]||l.mode;l.away_id===null&&!u.startsWith("IA")&&(u="IA");const w=l.home_id===o.id?l.away:l.home;let v;l.away_id===null?v=u:w?v=`${w.club_name||w.pseudo} (${w.pseudo})`:v="Adversaire";let E="";l.status==="in_progress"&&Date.now()-new Date(l.created_at).getTime()>3600*1e3&&(E=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const m=new Date(l.created_at),M=m.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+m.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),k=l.status==="finished"?`${l.home_score} - ${l.away_score}`:`${l.home_score||0} - ${l.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
  ...
  </div>`}po(fo);const be={user:null,profile:null,page:"home",params:{}};function Pt(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function _a(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ni(){document.getElementById("modal-overlay").classList.add("hidden")}async function Zt(){if(!be.user)return;const{data:e}=await h.from("users").select("*").eq("id",be.user.id).single();e&&(be.profile=e)}const oo="mw_theme";function ro(){return localStorage.getItem(oo)||"dark"}function ka(e){var t;localStorage.setItem(oo,e),$a(e),(t=be.profile)!=null&&t.id&&h.from("users").update({theme:e}).eq("id",be.profile.id).then(()=>{})}function $a(e){document.documentElement.setAttribute("data-theme",e)}function Rt(e,t={}){be.page=e,be.params=t,ao()}async function ao(){var n,o,r,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===be.page)});const t=document.getElementById("nav-credits");t&&be.profile&&(t.textContent=`💰 ${(be.profile.credits||0).toLocaleString("fr")}`);const i={state:be,navigate:Rt,toast:Pt,openModal:_a,closeModal:Ni,refreshProfile:Zt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',be.page){case"home":await gn(e,i);break;case"home2":await Fo(e,i);break;case"settings":await Dn(e,i);break;case"collection":await Xo(e,i);break;case"decks":await ji(e,i);break;case"boosters":await lr(e,i);break;case"ranked":await ha(e,i);break;case"match":{const s=be.params&&be.params.matchMode||"vs_ai_easy";s==="random"?await Ri(e,i,!1):s==="ranked"?await Ri(e,i,!0):s==="friend"?await Vr(e,i,(n=be.params)==null?void 0:n.friendId,(o=be.params)==null?void 0:o.friendName):s==="mini_league"||s==="mini-league"?await Ln(e,i,(r=be.params)==null?void 0:r.mlMatchId,(a=be.params)==null?void 0:a.leagueId):await $r(e,i);break}case"market":await ga(e,i);break;case"rankings":await va(e,i);break;case"matches":await wa(e,i);break;case"friends":await ho(e,i);break;case"mini-league":await Jr(e,i);break;case"match-mini-league":{const s=be.params||{};await Ln(e,i,s.mlMatchId,s.leagueId);break}default:await gn(e,i)}}function Ea(){var n,o;const e=document.getElementById("app"),t=be.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.23-1350" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(r=>{r.addEventListener("click",a=>{a.preventDefault(),Rt(r.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Rt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Rt("boosters")),(n=document.getElementById("journal-btn"))==null||n.addEventListener("click",()=>La()),(o=document.getElementById("settings-btn"))==null||o.addEventListener("click",()=>Rt("settings"))}async function La(){const{data:e}=await h.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(n=>{const o=new Date(n.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${n.image_url?`<img src="${n.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${o}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${n.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${n.description}</div>
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}function Ta(e,{onPlay:t}){var n;const i="/icons/";e.style.cssText="",e.innerHTML=`
  <style>
    #public-landing{
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function Ia(){document.documentElement.setAttribute("data-theme",ro()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ni()}),document.getElementById("modal-close").addEventListener("click",Ni);const{data:{session:e}}=await h.auth.getSession();if(!e){Tn(),Ta(document.getElementById("app"),{onPlay:()=>pn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt})});return}be.user=e.user,await Zt(),Tn();try{const{data:i}=await h.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(o=>{n[o.formation]=o.links}),uo(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!be.profile){go(document.getElementById("app"),{state:be,navigate:async()=>{await Zt(),Ai()},toast:Pt,refreshProfile:Zt});return}const t=Array.isArray(be.profile.pending_boosters)?be.profile.pending_boosters:[];if(!be.profile.onboarding_done&&t.length>0){br(document.getElementById("app"),{state:be,navigate:()=>Ai(),toast:Pt,refreshProfile:Zt});return}Ai(),setTimeout(()=>ma(be.profile,Rt,Pt),800),h.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(be.user=null,be.profile=null,document.getElementById("app").innerHTML="",pn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt}))})}function za(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function $i(){const e=document.getElementById("app");e&&(e.style.height=za()+"px")}window.addEventListener("resize",$i);window.addEventListener("orientationchange",()=>setTimeout($i,150));window.visualViewport&&window.visualViewport.addEventListener("resize",$i);function Ai(){const e=()=>{var i;(i=be.user)!=null&&i.id&&h.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",be.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",$i(),Ea(),ao()}function Tn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function so(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}Ia().catch(e=>{console.error("Échec du démarrage:",e),so()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&so("Le serveur met trop de temps à répondre.")},12e3);
