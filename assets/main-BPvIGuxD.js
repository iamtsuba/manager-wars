...
import{s as E,F as hi,h as Pt,j as Wi,l as at,i as So,k as Lo,b as Io}from"./formation-links-Dnttc-Cp.js";const Mo="/manager-wars/";function Ii(e,{navigate:t,toast:i}){let s="login";const l=()=>{var a,p,u,n,o,m;const d=s==="login";e.innerHTML=`
    <div style="
  ...
  `,e.querySelectorAll("[data-nav]").forEach(p=>{p.addEventListener("click",u=>{u.preventDefault(),i(p.dataset.nav)})}),(d=document.getElementById("nav-rankings"))==null||d.addEventListener("click",()=>i("rankings")),(a=document.getElementById("nav-matches"))==null||a.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(p=>{p.addEventListener("click",()=>{p.classList.add("tapped"),setTimeout(()=>p.classList.remove("tapped"),200);const u=p.dataset.action;if(u==="match-ai"){Ko(i);return}if(u==="match-random"){i("match",{matchMode:"random"});return}if(u==="match-friend"){i("friends");return}if(u==="mini-league"){i("mini-league");return}if(u==="ranked"){ctx.toast("Mode Ranked — Bientôt disponible !","info");return}s("Bientôt disponible","info")})}),window.innerWidth<768&&requestAnimationFrame(()=>{var Y,B,D,j,K,oe;const p=((Y=window.visualViewport)==null?void 0:Y.height)||window.innerHeight,u=((B=document.querySelector(".top-nav"))==null?void 0:B.offsetHeight)||56,n=((D=document.querySelector(".bottom-nav"))==null?void 0:D.offsetHeight)||60,o=((j=e.querySelector(".hero-compact"))==null?void 0:j.offsetHeight)||52,m=e.querySelector(".ranked-banner");e.querySelector(".play-grid");const b=((oe=(K=e.querySelector("#logout-btn"))==null?void 0:K.closest("div"))==null?void 0:oe.offsetHeight)||44,g=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((de,N)=>{var W;return de+(((W=document.getElementById(N))==null?void 0:W.offsetHeight)||0)},0),T=14*5,r=p-u-n-o-b-g-T,c=Math.max(80,Math.round(r*.28)),I=Math.max(160,Math.round(r*.72)),L=Math.floor((I-10)/2);m&&(m.style.minHeight=m.style.maxHeight=c+"px"),e.querySelectorAll(".play-grid .play-card").forEach(de=>{de.style.minHeight=de.style.height=L+"px"});const G=Math.round(L*.55);e.querySelectorAll(".play-card .play-icon").forEach(de=>{de.style.height=G+"px"})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await E.auth.signOut(),window.location.reload()}),eo(t,s),Uo(t,s,i),Qi(t,s,i))}async function Qi(e,t,i){const s=document.getElementById("ongoing-match-banner");if(!s)return;const l=e.profile.id,{data:d}=await E.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${l},away_id.eq.${l}`).order("created_at",{ascending:!1});if(!(d!=null&&d.length)){s.innerHTML="";return}const a=d.map(u=>u.home_id===l?u.away_id:u.home_id).filter(Boolean);let p={};if(a.length){const{data:u}=await E.from("users").select("id, pseudo, club_name").in("id",a);(u||[]).forEach(n=>{p[n.id]=n.club_name||n.pseudo})}s.innerHTML=d.map(u=>{const n=u.home_id===l?u.away_id:u.home_id,o=p[n]||"Adversaire",m=u.mode==="mini_league";return`
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#ab-cancel").addEventListener("click",()=>t.remove()),t.querySelector("#ab-ok").addEventListener("click",()=>{t.remove(),e()}),t.addEventListener("click",i=>{i.target===t&&t.remove()})}async function Uo(e,t,i){var p,u,n,o;const s=document.getElementById("match-invite-banner");if(!s)return;const{data:l}=await E.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",e.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!l){s.innerHTML="";return}const d=((p=l.inviter)==null?void 0:p.club_name)||((u=l.inviter)==null?void 0:u.pseudo)||"?",a=l.inviter_id;s.innerHTML=`
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{oe=!oe,P(),re()})))}function re(){const X=document.getElementById("col-grid");X&&(D==="player"?we(X):D==="formation"?Ae(X):D==="stadium"?xe(X):Ie(X))}function pe(X,ne,ge,J,Z){const U=document.getElementById("col-grid"),se=document.getElementById("col-big");if(!U||!se)return;var he=0;function Se(){const Me=window.innerWidth>=768,be=document.getElementById("col-big"),ze=document.getElementById("col-grid");Me&&be&&(be.style.minHeight="420px",be.style.flex="1 1 auto"),Me&&ze&&(ze.style.height=Math.round(310*.76+16)+"px",ze.style.flexShrink="0",ze.style.overflowX="auto",ze.style.overflowY="hidden",ze.style.alignItems="center",ze.style.padding="8px 16px"),se.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ne(X[he])+"</div>";var M=se.querySelector("[data-card-id],[data-form-id],[data-gc-id]");M&&M.addEventListener("click",function(){J(X[he])}),requestAnimationFrame(function(){var q=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!q||!se)){var w=se.clientHeight-8,k=se.clientWidth-24,f=q.offsetHeight,x=q.offsetWidth;if(f>0&&x>0&&w>40){var y=Me?2.2:1,h=Math.min(w/f,k/x,y);q.style.transform="scale("+h.toFixed(3)+")",q.style.transformOrigin="top center"}}}),U.innerHTML=X.map(function(q,w){var k=w===he,f="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(k?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+w+'" style="'+f+'">'+ge(q,k)+"</div>"}).join(""),U.querySelectorAll(".col-mini-item").forEach(function(q){q.addEventListener("click",function(){he=Number(q.dataset.idx),Se(),q.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Se()}function ye(X){var ne=window.innerWidth>=768?.76:.54,ge;if(!X||X._fake){var J=X?X.player:null;if(!J)return"";ge=Fi(J)}else ge=di(X,"");return'<div style="display:inline-block;zoom:'+ne+';pointer-events:none;line-height:0">'+ge+"</div>"}function Le(X,ne,ge){ne=ne||100,ge=ge||140;var J=Pt[X]||{},Z={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},U=Math.max(3,Math.round(ne*.06)),se=Object.entries(J).map(function(Se){var Me=Se[0],be=Se[1],ze=Me.replace(/\d+$/,""),M=Z[ze]||"#888",q=Math.round(be.x*ne),w=Math.round(be.y*ge);return'<circle cx="'+q+'" cy="'+w+'" r="'+U+'" fill="'+M+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),he=Math.max(1,Math.round(ne/50));return'<svg viewBox="0 0 '+ne+" "+ge+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ne+'" height="'+ge+'" fill="#1A6B3C"/><rect x="'+Math.round(ne*.2)+'" y="'+Math.round(ge*.02)+'" width="'+Math.round(ne*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+he+'"/><line x1="0" y1="'+Math.round(ge*.5)+'" x2="'+ne+'" y2="'+Math.round(ge*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+he+'"/><ellipse cx="'+Math.round(ne*.5)+'" cy="'+Math.round(ge*.5)+'" rx="'+Math.round(ne*.18)+'" ry="'+Math.round(ge*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+he+'"/><rect x="'+Math.round(ne*.2)+'" y="'+Math.round(ge*.82)+'" width="'+Math.round(ne*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+he+'"/>'+se+"</svg>"}function ve(X,ne,ge){var J=ge>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+ge+"</div>":"",Z=ne?'data-form-id="'+ne.id+'"':"",U=X.length>7?14:X.length>5?16:19,se=!!ne;return"<div "+Z+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(se?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(se?"":"filter:grayscale(1);opacity:0.5")+'">'+J+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(se?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+U+"px;font-weight:900;color:"+(se?"#1A6B3C":"#aaa")+';line-height:1">'+X+'</div></div><div style="flex:1;overflow:hidden;background:'+(se?"#1A6B3C":"#ccc")+'">'+Le(X,140,220)+"</div></div>"}function _e(X,ne){var ge=window.innerWidth>=768?.76:.54,J=140,Z=305,U=Math.round(Z*.22),se=Z-U,he=X.length>7?10:13,Se=Le(X,J,se),Me=ne?"1.5px solid #2a7a40":"1px solid #ddd",be=ne?"":"filter:grayscale(1);opacity:0.45;",ze=ne?"#1A6B3C":"#bbb",M="#fff";return'<div style="display:inline-block;zoom:'+ge+';line-height:0;pointer-events:none"><div style="width:'+J+"px;height:"+Z+"px;border-radius:6px;border:"+Me+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+be+'"><div style="height:'+U+"px;background:"+ze+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+he+"px;font-weight:900;color:"+M+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(J-4)+'px">'+X+'</span></div><div style="height:'+se+'px;overflow:hidden;flex-shrink:0">'+Se+"</div></div></div>"}function we(X){if(oe){const ne=H();if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const ge=ne.map(J=>n.find(Z=>Z.player.id===J.id)||{_fake:!0,player:J,id:"fake-"+J.id});pe(ge,J=>J._fake?Fi(J.player):di(J,""),J=>J._fake?ye({player:J.player,id:"x",_fake:!0}):ye(J),J=>{J._fake||Di(J,n,G,t)})}else{const ne=W();if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const ge={};ne.forEach(Z=>{const U=Z.player.id;ge[U]||(ge[U]=[]),ge[U].push(Z)});const J=Object.values(ge).map(Z=>Xo(Z));pe(J,Z=>{const U=G[Z.player.id]||1,se=U>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${U}</div>`:"",Se=n.filter(Me=>Me.player.id===Z.player.id&&Me.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return di(Z,se+Se)},Z=>ye(Z),Z=>Di(Z,n,G,t))}}function Ae(X){const ne=oe?I:[...Y];if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const ge=ne.map(J=>({formation:J,card:m.find(Z=>Z.formation===J)||null,owned:Y.has(J)}));pe(ge,({formation:J,card:Z,owned:U})=>ve(J,U?Z:null,U?m.filter(se=>se.formation===J).length:0),({formation:J,owned:Z})=>_e(J,Z),({card:J,owned:Z})=>{Z&&J&&en(J,m,t,d)})}function Ie(X){const ne=Object.keys(T),ge=oe?ne.length?ne:L:[...B];if(!ge.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const J=ge.map(Z=>({type:Z,gc:Ve[Z]||{icon:"⚡",desc:""},def:T[Z]||null,owned:B.has(Z),card:o.find(U=>U.gc_type===Z)||null}));pe(J,({type:Z,gc:U,def:se,owned:he,card:Se})=>{var y;const Me=he?o.filter(h=>h.gc_type===Z).length:0,be=Me>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Me}</div>`:"",ze=(se==null?void 0:se.gc_type)==="ultra_game_changer",M={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},q={purple:"#b06ce0",light_blue:"#00d4ef"},w=M[se==null?void 0:se.color]||M.purple,k=q[se==null?void 0:se.color]||q.purple,f=(se==null?void 0:se.effect)||U.desc||"",x=se!=null&&se.image_url?`/manager-wars/icons/${se.image_url}`:((y=se==null?void 0:se.club)==null?void 0:y.logo_url)||(se!=null&&se.country_code?`https://flagcdn.com/w80/${se.country_code.toLowerCase()}.png`:null);return he&&Se?`<div data-gc-id="${Se.id}" data-gc-type="${Z}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${k};background:${w};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${k}66;cursor:pointer">
          ${be}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${x?`<img src="${x}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${U.icon}</span>`}
          </div>
        ...
        </div>`},({def:U,count:se})=>{var M,q;const he=window.innerWidth>=768?.76:.54,Se=(U==null?void 0:U.name)||"?",Me=((M=U==null?void 0:U.club)==null?void 0:M.encoded_name)||(U==null?void 0:U.country_code)||"—",be=U!=null&&U.image_url?`${ge}icons/${U.image_url}`:((q=U==null?void 0:U.club)==null?void 0:q.logo_url)||(U!=null&&U.country_code?`https://flagcdn.com/w80/${U.country_code.toLowerCase()}.png`:null),ze=be?`<img src="${be}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${he};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(X=>{X.addEventListener("click",()=>{D=X.dataset.tab,j="Tous",K="",oe=!1,e.querySelectorAll(".col-tab-btn").forEach(ne=>{const ge=ne.dataset.tab===D;ne.style.borderBottomColor=ge?"var(--green)":"transparent",ne.style.color=ge?"var(--green)":"var(--gray-600)"}),P(),re()})}),P(),re()}function Qo(e,t,i){const s=Ve[e]||{icon:"⚡",desc:"Effet spécial."},l=(t==null?void 0:t.gc_type)==="ultra_game_changer",d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},p=d[t==null?void 0:t.color]||d.purple,u=a[t==null?void 0:t.color]||a.purple,n=(t==null?void 0:t.name)||e,o=(t==null?void 0:t.effect)||s.desc,m=t!=null&&t.image_url?`/manager-wars/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      <div style="background:${p};border-radius:16px;border:2px solid ${u};
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Vt=1e3;function en(e,t,i,s){var T,r,c;const{state:l,toast:d,closeModal:a,navigate:p,refreshProfile:u}=i,n=e.formation,o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function m(){const I=Pt[n]||{},L=hi[n]||[],G=290,Y=360,B=20;function D(K){const oe=I[K];return oe?{x:oe.x*G,y:oe.y*Y}:null}let j=`<svg width="${G}" height="${Y}" viewBox="0 0 ${G} ${Y}" xmlns="http://www.w3.org/2000/svg">`;for(const[K,oe]of L){const de=D(K),N=D(oe);!de||!N||(j+=`<line x1="${de.x}" y1="${de.y}" x2="${N.x}" y2="${N.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const K of Object.keys(I)){const oe=D(K);if(!oe)continue;const de=K.replace(/\d+/,""),N=o[de]||"#555";j+=`<circle cx="${oe.x}" cy="${oe.y}" r="${B}" fill="${N}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,j+=`<text x="${oe.x}" y="${oe.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${de}</text>`}return j+="</svg>",j}const b=t.filter(I=>I.formation===n);b.length;const g=!e.is_for_sale;s(`Formation ${n}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${m.map((J,Z)=>{const U=pe[J.id]||[],se=J.is_for_sale,he=U.length?U[U.length-1]:null,Me=(o.rarity==="pepite"||o.rarity==="papyte")&&J.current_note!=null?` (☆${J.current_note})`:"";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",p);let ve=new Set;const _e=()=>{const J=ve.size,Z=document.getElementById("sell-action-panel");if(!Z)return;Z.style.display=J>0?"block":"none",document.getElementById("sell-selected-count").textContent=J;const U=document.getElementById("evolve-btn");U&&(U.textContent=`⬆️ Évoluer ${J>1?"(+"+J+")":""}`)};document.querySelectorAll(".expl-check").forEach(J=>{J.addEventListener("change",()=>{const Z=J.dataset.id;J.checked?ve.add(Z):ve.delete(Z);const U=J.closest(".exemplaire-row");U&&(U.style.borderColor=J.checked?"#1A6B3C":"#eee"),_e()})}),document.querySelectorAll(".exemplaire-row").forEach(J=>{J.addEventListener("click",Z=>{if(Z.target.closest("button")||Z.target.tagName==="INPUT")return;const U=J.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(J=>{J.addEventListener("click",Z=>{Z.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${J.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(X=document.getElementById("evolve-btn"))==null||X.addEventListener("click",async()=>{if(b<=1)return;const J=[...ve];if(!J.length)return;if(ve.has(e.id)){const be=document.createElement("div");be.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",be.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            ${B&&B>0?`<br>📈 Note 2 : <strong>${B+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${B+(e.evolution_bonus||0)+Z.length*U}</strong>`:""}
  ...
  </div>`,on(e,t,l,i),document.getElementById("builder-back").addEventListener("click",()=>s("decks")),document.getElementById("formation-select").addEventListener("change",o=>{t.formation=o.target.value;const m=Pi(t.formation),b={};m.forEach(g=>{t.slots[g]&&(b[g]=t.slots[g])}),t.slots=b,Lt(e,t,i)}),(u=document.getElementById("stadium-select"))==null||u.addEventListener("change",o=>{t.stadiumCardId=o.target.value||null}),document.getElementById("save-deck").addEventListener("click",()=>an(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(o=>{o.addEventListener("click",()=>{t.subs=t.subs.filter(m=>m!==o.dataset.removeSub),Lt(e,t,i)})}),(n=document.getElementById("add-sub-btn"))==null||n.addEventListener("click",()=>{rn(t,e,i)})}function on(e,t,i,s){var G,Y,B;const l=e.querySelector("#deck-field");if(!l)return;const d=(G=t.stadiumCards)==null?void 0:G.find(D=>D.id===t.stadiumCardId),a=d&&((Y=t.stadDefMap)==null?void 0:Y[d.stadium_id])||null,p=Pt[t.formation]||{},u=Wi(t.formation)||[],n={};for(const D of i){const j=t.slots[D],K=j?t.playerCards.find(oe=>oe.id===j):null;n[D]=K?K.player:null}const o=300,m=300,b=48,g=64,T=13,r=16,c=38;function I(D){const j=p[D];return j?{x:j.x*o,y:j.y*m}:null}let L="";for(const[D,j]of u){const K=I(D),oe=I(j);if(!K||!oe)continue;const de=n[D]?{...n[D],club_id:n[D].club_id,country_code:n[D].country_code,rarity:n[D].rarity}:null,N=n[j]?{...n[j],club_id:n[j].club_id,country_code:n[j].country_code,rarity:n[j].rarity}:null,W=at(de,N);W==="#ff3333"||W==="#cc2222"?L+=`<line x1="${K.x.toFixed(1)}" y1="${K.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(L+=`<line x1="${K.x.toFixed(1)}" y1="${K.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,L+=`<line x1="${K.x.toFixed(1)}" y1="${K.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const D of i){const j=I(D);if(!j)continue;const K=n[D],oe=D.replace(/\d+/,""),de=vt[oe]||"#555",N=(j.x-b/2).toFixed(1),W=(j.y-g/2).toFixed(1),H={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[K==null?void 0:K.rarity]||"#aaa";if(K){const P=ii(K),re=co(K),pe=lo(K.country_code),ye=((B=K.card)==null?void 0:B.evolution_bonus)||K.evolution_bonus||0,Le=(Number(oe==="GK"?K.note_g:oe==="DEF"?K.note_d:oe==="MIL"?K.note_m:K.note_a)||0)+(oe===K.job||oe===K.job2?ye:0),ve=a&&(a.club_id&&String(K.club_id)===String(a.club_id)||a.country_code&&K.country_code===a.country_code),_e=ve?Le+10:Le,we=g-T-r;L+=`<defs><clipPath id="dcp-${D}"><rect x="${N}" y="${(j.y-g/2+T).toFixed(1)}" width="${b}" height="${we}"/></clipPath></defs>`,L+=`<rect x="${N}" y="${W}" width="${b}" height="${g}" rx="5" fill="${de}"/>`,P&&(L+=`<image href="${P}" x="${N}" y="${(j.y-g/2+T).toFixed(1)}" width="${b}" height="${we}" clip-path="url(#dcp-${D})" preserveAspectRatio="xMidYMin slice"/>`),L+=`<rect x="${N}" y="${W}" width="${b}" height="${T}" fill="rgba(255,255,255,0.93)"/>`,L+=`<text x="${j.x.toFixed(1)}" y="${(j.y-g/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(K.surname_encoded||"").slice(0,9)}</text>`;const Ae=(j.y+g/2-r).toFixed(1);L+=`<rect x="${N}" y="${Ae}" width="${b}" height="${r}" fill="rgba(255,255,255,0.93)"/>`,pe&&(L+=`<image href="${pe}" x="${(j.x-21).toFixed(1)}" y="${(j.y+g/2-r+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),L+=`<text x="${j.x.toFixed(1)}" y="${(j.y+g/2-r/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${_e}</text>`,re&&(L+=`<image href="${re}" x="${(j.x+b/2-14).toFixed(1)}" y="${(j.y+g/2-r+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),L+=`<rect x="${N}" y="${W}" width="${b}" height="${g}" rx="5" fill="none" stroke="${ve?"#E87722":H}" stroke-width="${ve?"2.5":"2"}"/>`,ve&&(L+=`<rect x="${(j.x+b/2-13).toFixed(1)}" y="${W}" width="13" height="9" rx="3" fill="#E87722"/>`,L+=`<text x="${(j.x+b/2-6.5).toFixed(1)}" y="${(j.y-g/2+4.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="900" fill="#fff" font-family="Arial">+10</text>`)}else L+=`<rect x="${N}" y="${W}" width="${b}" height="${g}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,L+=`<text x="${j.x.toFixed(1)}" y="${j.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,L+=`<text x="${j.x.toFixed(1)}" y="${(j.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${oe}</text>`;L+=`<rect x="${N}" y="${W}" width="${b}" height="${g}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${D}" style="cursor:pointer"/>`}l.innerHTML=`<svg viewBox="${-c} ${-c} ${o+c*2} ${m+c*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${L}</svg>`,l.querySelectorAll(".deck-slot-hit").forEach(D=>{D.addEventListener("click",()=>nn(D.dataset.pos,t,e,s))})}function nn(e,t,i,s){var b,g,T;const{openModal:l,closeModal:d}=s,a=e.replace(/\d+/,""),p=t.slots[e],u=p?t.playerCards.find(r=>r.id===p):null;(b=u==null?void 0:u.player)==null||b.id;const n=new Set;Object.entries(t.slots).forEach(([r,c])=>{var L;if(r===e||!c)return;const I=t.playerCards.find(G=>G.id===c);(L=I==null?void 0:I.player)!=null&&L.id&&n.add(I.player.id)}),t.subs.forEach(r=>{var I;const c=t.playerCards.find(L=>L.id===r);(I=c==null?void 0:c.player)!=null&&I.id&&n.add(c.player.id)});const o=new Set,m=t.playerCards.filter(r=>{const c=r.player;return!(c.job===a||c.job2===a)||n.has(c.id)||o.has(c.id)?!1:(o.add(c.id),!0)});m.sort((r,c)=>{card!=null&&card.evolution_bonus;const I=r.evolution_bonus||0,L=c.evolution_bonus||0,G=(a==="GK"?r.player.note_g:a==="DEF"?r.player.note_d:a==="MIL"?r.player.note_m:r.player.note_a)+(a===r.player.job||a===r.player.job2?I:0);return(a==="GK"?c.player.note_g:a==="DEF"?c.player.note_d:a==="MIL"?c.player.note_m:c.player.note_a)+(a===c.player.job||a===c.player.job2?L:0)-G}),l(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${m.length>0?m.map(r=>{var B,D;const c=r.player,I=card.evolution_bonus||0,L=(a==="GK"?c.note_g:a==="DEF"?c.note_d:a==="MIL"?c.note_m:c.note_a)+(a===c.job||a===c.job2?I:0),G=ii(c),Y={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[c.rarity];return`<div class="player-option" data-card-id="${r.id}"
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${d.map(g=>{const T=g.cost===0||l>=g.cost,r=o[g.id]===!0;return`<div class="booster-card ${!T||r?"disabled":""}" data-booster="${g.id}" style="position:relative">
            ...
            <div class="icon"><img src="${g.img}" alt="${g.name}" style="height:64px;width:auto;display:block;margin:0 auto" onerror="this.src='/manager-wars/icons/booster-players.png'"></div>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(g=>{g.addEventListener("click",async()=>{const T=d.find(r=>r.id===g.dataset.booster);if(T){g.style.opacity="0.5",g.style.pointerEvents="none";try{await gn(T,{state:t,toast:s,navigate:i,container:e})}catch(r){s(r.message,"error"),g.style.opacity="",g.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(g=>{g.addEventListener("click",T=>{T.stopPropagation();const r=d.find(c=>c.id===g.dataset.boosterId);bn(r)})})}async function gn(e,{state:t,toast:i,navigate:s,container:l}){var m,b;if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}if(e.isPub)try{await wn()}catch(g){i(g.message||"Regardez la pub entièrement pour ouvrir le booster","error");return}const{data:d}=await E.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),a=new Set((d||[]).filter(g=>g.card_type==="player").map(g=>g.player_id)),p=new Set((d||[]).filter(g=>g.card_type==="formation").map(g=>g.formation));let u=[],n=null;try{if((m=e.rates)!=null&&m.length)u=await gi(t.profile,e);else{const g=e.type||"player";g==="player"?u=await go(t.profile,e.cardCount,e.cost):g==="game_changer"?u=await mo(t.profile,e.cardCount,e.cost):g==="formation"?u=await xo(t.profile,e.cost):u=await gi(t.profile,e)}}catch(g){n=g.message||String(g),console.error("[Booster] Erreur:",g)}if(!(u!=null&&u.length)){const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",g.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${n||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(g),(b=g.querySelector("#anim-close-err"))==null||b.addEventListener("click",()=>g.remove());return}u.forEach(g=>{g.card_type==="player"&&g.player?g.isDuplicate=a.has(g.player.id):g.card_type==="formation"&&(g.isDuplicate=p.has(g.formation))});const{data:o}=await E.from("users").select("*").eq("id",t.profile.id).single();o&&(t.profile=o),yo(u,e,s)}function mn(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function mt(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function xn(e,t){let i;switch(t){case"legende":i=e.filter(s=>s.rarity==="legende"),i.length||(i=e.filter(s=>s.rarity==="pepite"||s.rarity==="papyte")),i.length||(i=e.filter(s=>mt(s)>=6));break;case"special":i=e.filter(s=>s.rarity==="pepite"||s.rarity==="papyte"),i.length||(i=e.filter(s=>mt(s)>=6));break;case"normal_high":i=e.filter(s=>s.rarity==="normal"&&mt(s)>=6),i.length||(i=e.filter(s=>mt(s)>=6));break;default:i=e.filter(s=>s.rarity==="normal"&&mt(s)>=1&&mt(s)<=5),i.length||(i=e.filter(s=>s.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function gi(e,t){if(t.cost>0){const{error:o}=await E.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(o)throw o}const i=t.allow_duplicates!==!1,{data:s}=await E.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.id),l=new Set((s||[]).filter(o=>o.card_type==="player").map(o=>o.player_id)),d=new Set((s||[]).filter(o=>o.card_type==="formation").map(o=>o.formation)),a=new Set((s||[]).filter(o=>o.card_type==="game_changer").map(o=>o.gc_type)),p=new Set((s||[]).filter(o=>o.card_type==="stadium").map(o=>o.stadium_id)),u=new Set,n=[];for(let o=0;o<(t.cardCount||5);o++){const m=sn(t.rates);if(m){if(m.card_type==="player"){const b=B=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[B]||B,g=m.rarity?b(m.rarity):null;let T=E.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);g&&(T=T.eq("rarity",g));const{data:r}=await T;let c=r||[];if((m.note_min||m.note_max)&&(c=c.filter(B=>{const D=Math.max(Number(B.note_g)||0,Number(B.note_d)||0,Number(B.note_m)||0,Number(B.note_a)||0);return(!m.note_min||D>=m.note_min)&&(!m.note_max||D<=m.note_max)})),c.length||(m.note_min||m.note_max?(c=r||[],console.warn("[Booster] Aucun joueur avec note",m.note_min,"-",m.note_max,"— fallback rareté uniquement")):c=r||[]),!c.length)continue;let I=c.filter(B=>!u.has(B.id));if(i)I.length||(I=c);else if(I=I.filter(B=>!l.has(B.id)),!I.length)continue;const L=I[Math.floor(Math.random()*I.length)];u.add(L.id);const G=l.has(L.id),{data:Y}=await E.from("cards").insert({owner_id:e.id,player_id:L.id,card_type:"player"}).select().single();Y&&(n.push({...Y,player:L,isDuplicate:G}),E.rpc("record_transfer",{p_card_id:Y.id,p_player_id:L.id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(m.card_type==="game_changer"){const{data:b}=await E.from("gc_definitions").select("id,name").eq("is_active",!0).eq("gc_type","game_changer"),g=b!=null&&b.length?b:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],T=i?g:g.filter(L=>!a.has(L.name));if(!i&&!T.length)continue;const c=T[Math.floor(Math.random()*T.length)].name,{data:I}=await E.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:c}).select().single();I&&n.push(I)}else if(m.card_type==="formation"){const b=uo(),g=i?b:b.filter(I=>!d.has(I));if(!i&&!g.length)continue;const T=g[Math.floor(Math.random()*g.length)],r=d.has(T),{data:c}=await E.from("cards").insert({owner_id:e.id,card_type:"formation",formation:T}).select();c!=null&&c[0]&&n.push({...c[0],isDuplicate:r})}else if(m.card_type==="stadium"){const{data:b,error:g}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(g){console.error("[Booster] stadium_definitions:",g.message);continue}if(!(b!=null&&b.length)){console.warn("[Booster] Aucun stade en DB");continue}const T=i?b:b.filter(L=>!p.has(L.id));if(!i&&!T.length)continue;const r=T[Math.floor(Math.random()*T.length)],{data:c,error:I}=await E.from("cards").insert({owner_id:e.id,card_type:"stadium",stadium_id:r.id}).select("id,card_type,stadium_id").single();if(I){console.error("[Booster] insert stadium card:",I.message);continue}c&&n.push({...c,rarity:"normal",_stadiumDef:r})}}}return n}async function go(e,t,i){if(i>0){const{error:n}=await E.from("users").update({credits:e.credits-i}).eq("id",e.id);if(n)throw n}const{data:s}=await E.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(s!=null&&s.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const l=s.filter(n=>n.job==="GK"),d=s.filter(n=>n.job!=="GK"),a=!e.first_booster_opened&&l.length>0,p=[];for(let n=0;n<t;n++){const o=n===0&&a?l:n===0?d:s,m=mn(),b=xn(o,m);b&&p.push(b)}a&&await E.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:u}=await E.from("cards").insert(p.map(n=>({owner_id:e.id,player_id:n.id,card_type:"player"}))).select();return(u||[]).forEach((n,o)=>{E.rpc("record_transfer",{p_card_id:n.id,p_player_id:p[o].id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),p.map((n,o)=>({...u[o],player:n}))}async function mo(e,t,i){const{error:s}=await E.from("users").update({credits:e.credits-i}).eq("id",e.id);if(s)throw s;const{data:l}=await E.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),d=l!=null&&l.length?l:Object.keys(fi).map(o=>({name:o,gc_type:"game_changer"})),a=Array.from({length:t},()=>{const o=d[Math.floor(Math.random()*d.length)];return{owner_id:e.id,card_type:"game_changer",gc_type:o.name,gc_definition_id:o.id||null}}),{data:p,error:u}=await E.from("cards").insert(a).select();return u&&console.error("[Booster GC] Erreur insert:",u.message,u),(p||[]).map(o=>{const m=l==null?void 0:l.find(b=>b.name===o.gc_type||b.id===o.gc_definition_id);return{...o,_gcDef:m||null}})}async function xo(e,t){const{error:i}=await E.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const{data:s}=await E.from("cards").select("formation").eq("owner_id",e.id).eq("card_type","formation"),l=new Set((s||[]).map(o=>o.formation)),d=uo(),a=d[Math.floor(Math.random()*d.length)],p=l.has(a),{data:u,error:n}=await E.from("cards").insert({owner_id:e.id,card_type:"formation",formation:a}).select();return n&&console.error("[Booster Formation] Erreur insert:",n.message,n),(u||[]).map(o=>({...o,isDuplicate:p}))}function yo(e,t,i,s=null){var W,H;if(!e||e.length===0){const P=document.createElement("div");P.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",P.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
  ...
  `,document.body.appendChild(l);let d=!1;const a=document.getElementById("pack-cut-zone"),p=document.getElementById("pack-blade");let u=!1;const n=P=>P.touches&&P.touches[0]?P.touches[0].clientX:P.clientX;function o(P){d||(u=!0,p.style.opacity="1",m(P))}function m(P){if(!u||d)return;const re=a.getBoundingClientRect(),pe=n(P)-re.left,ye=Math.max(0,Math.min(1,pe/re.width));p.style.width=ye*re.width+"px",ye>=.82&&g()}function b(){d||(u=!1,p.style.transition="width .2s ease, opacity .2s ease",p.style.width="0",p.style.opacity="0",setTimeout(()=>{d||(p.style.transition="")},220))}function g(){var re;if(d)return;d=!0,u=!1,p.style.width="100%",p.style.opacity="1",(re=document.getElementById("cut-flash"))==null||re.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const P=document.getElementById("cut-hint");P&&(P.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{p.style.opacity="0",document.getElementById("pack-phase").style.display="none",I(0)},620)}a.addEventListener("pointerdown",o),window.addEventListener("pointermove",m),window.addEventListener("pointerup",b),a.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",b);let T=0,r=!1;const c=new Set;function I(P){T=P,document.getElementById("reveal-phase").style.display="flex",L(),G(P,0),K()}function L(){const P=document.getElementById("card-dots");P&&(P.innerHTML=e.map((re,pe)=>`<div class="card-dot" data-i="${pe}" style="width:8px;height:8px;border-radius:50%;background:${pe===T?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),P.querySelectorAll(".card-dot").forEach(re=>re.addEventListener("click",()=>B(parseInt(re.dataset.i)))))}function G(P,re){var xe;const pe=e[P],ye=document.getElementById("card-counter"),Le=document.getElementById("card-track");ye&&(ye.textContent=`Carte ${P+1} / ${e.length}`);const ve=document.getElementById("reveal-btns");ve&&(ve.style.display=P===e.length-1?"flex":"none");const _e=pe.card_type==="player"&&((xe=pe.player)==null?void 0:xe.rarity)==="legende",we=!c.has(P);c.add(P);let Ae=0;if(pe.card_type==="player"&&pe.player){const X=pe.player,ne=X.job||"ATT";Ae=Number(ne==="GK"?X.note_g:ne==="DEF"?X.note_d:ne==="MIL"?X.note_m:X.note_a)||0}const Ie=X=>{Le.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}const u=o=>{e.style.overflow="",e.style.height="",e.style.display="",e.style.flexDirection="",i(o)};function n(){var m,b,g;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const o=a.length>0;e.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),u=[...new Set((p||[]).filter(b=>{var g,T;return((g=b.card)==null?void 0:g.card_type)==="stadium"&&((T=b.card)==null?void 0:T.stadium_id)}).map(b=>b.card.stadium_id))],n={};if(u.length){const{data:b}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",u);(b||[]).forEach(g=>{n[g.id]=g}),(p||[]).forEach(g=>{var T,r;((T=g.card)==null?void 0:T.card_type)==="stadium"&&((r=g.card)!=null&&r.stadium_id)&&(g.card._stadiumDef=n[g.card.stadium_id]||null)})}let o=0;function m(){var B,D,j,K,oe,de,N;const b=d[o],g=(p||[]).filter(W=>W.deck_id===b.id),T=g.filter(W=>{var H;return W.is_starter&&((H=W.card)==null?void 0:H.player)}).map(W=>mi(W.card,W.position)),r=g.find(W=>{var H;return((H=W.card)==null?void 0:H.card_type)==="formation"}),c=b.formation||((B=r==null?void 0:r.card)==null?void 0:B.formation)||"4-4-2";let I=T.length>=11?yt(T,c):null,L=((D=b.stadium_card)==null?void 0:D.stadium_def)||null;L&&I&&(I=Ht(I,L));const G=T.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${m}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      <span style="font-size:${m-2}px;font-weight:900;color:#111;font-family:Arial Black,Arial">${e!=null&&e.used?"–":u}</span>
      ${l?`<img src="${l}" style="width:${m-4}px;height:${m-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,m-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${de}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=48,T=64,r=13,c=16,I={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[Y,B]of Object.entries(n)){const D=m(Y);if(!D||!B)continue;const j=Y.replace(/[0-9]/g,""),K=Mt[j]||"#555",oe=a.includes(B.cardId),de=i==="attack"&&(["MIL","ATT"].includes(j)||oe)&&!B.used||i==="defense"&&["GK","DEF","MIL"].includes(j)&&!B.used,N=s.includes(B.cardId);let W;i==="attack"?W=oe?Math.max(1,Number(B.note_a)||0):j==="MIL"?Number(B.note_m)||0:Number(B.note_a)||0:i==="defense"?W=j==="GK"?Number(B.note_g)||0:j==="MIL"?Number(B.note_m)||0:Number(B.note_d)||0:W=Number(j==="GK"?B.note_g:j==="DEF"?B.note_d:j==="MIL"?B.note_m:B.note_a)||0,W=W+(B.boost||0),B.stadiumBonus&&(i==="attack"&&(j==="ATT"||j==="MIL")||i==="defense"&&(j==="GK"||j==="DEF"||j==="MIL")?W+=10:i||(W+=10));const H=(D.x-g/2).toFixed(1),P=(D.y-T/2).toFixed(1),re=I[B==null?void 0:B.rarity]||I.normal;if(B.used){const Ae=typeof import.meta<"u"&&"/manager-wars/"||"/",xe=`${typeof window<"u"&&((G=window.location)==null?void 0:G.origin)||""}${Ae}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="#161616"/>`,b+=`<image href="${xe}" xlink:href="${xe}" x="${H}" y="${P}" width="${g}" height="${T}" preserveAspectRatio="xMidYMid slice"/>`,b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="none" stroke="${re}" stroke-width="2" opacity="0.7"/>`,b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${B.cardId}" data-role="${j}" style="cursor:pointer"/>`;continue}const pe=N?.45:1,ye=N?"#FFD700":re,Le=N?3:(B==null?void 0:B.rarity)==="legende"||(B==null?void 0:B.rarity)==="légende"||(B==null?void 0:B.rarity)==="pepite"||(B==null?void 0:B.rarity)==="pépite"?2.5:2,ve=T-r-c;b+=`<defs><clipPath id="cp-${Y}"><rect x="${H}" y="${(D.y-T/2+r).toFixed(1)}" width="${g}" height="${ve}"/></clipPath></defs>`,b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="${K}" opacity="${pe}"/>`;const _e=Pe(B);_e&&(b+=`<image href="${_e}" xlink:href="${_e}" x="${H}" y="${(D.y-T/2+r).toFixed(1)}" width="${g}" height="${ve}" clip-path="url(#cp-${Y})" preserveAspectRatio="xMidYMin slice"/>`),b+=`<rect x="${H}" y="${P}" width="${g}" height="${r}" rx="4" fill="rgba(255,255,255,0.92)"/>`,b+=`<text x="${D.x.toFixed(1)}" y="${(D.y-T/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(B.name||"").slice(0,9)}</text>`;const we=(D.y+T/2-c).toFixed(1);b+=`<rect x="${H}" y="${we}" width="${g}" height="${c}" fill="rgba(255,255,255,0.92)"/>`;{const Ae=Zt(B.country_code);Ae?b+=`<image href="${Ae}" xlink:href="${Ae}" x="${(D.x-20).toFixed(1)}" y="${(D.y+T/2-c+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:b+=`<text x="${(D.x-13).toFixed(1)}" y="${(D.y+T/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${vo(B.country_code)}</text>`;const Ie=B.stadiumBonus?"#E87722":"#111";b+=`<text x="${D.x.toFixed(1)}" y="${(D.y+T/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${Ie}" font-family="Arial Black">${W}</text>`;const xe=ho(B);xe?b+=`<image href="${xe}" xlink:href="${xe}" x="${(D.x+g/2-14).toFixed(1)}" y="${(D.y+T/2-c+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:B.clubName&&(b+=`<text x="${(D.x+14).toFixed(1)}" y="${(D.y+T/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(B.clubName||"").slice(0,3).toUpperCase()}</text>`),B.stadiumBonus&&(b+=`<rect x="${(D.x-g/2).toFixed(1)}" y="${(D.y-T/2).toFixed(1)}" width="${g}" height="${T}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="${N?"rgba(255,255,255,0.12)":"none"}" stroke="${ye}" stroke-width="${Le}" opacity="${pe}"/>`,de&&(b+=`<rect x="${H}" y="${P}" width="${g}" height="${T}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${N?"selected":""}" data-card-id="${B.cardId}" data-role="${j}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${l+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${b}
  ...
  </div>`}async function ai(e,t,i,s){var D;const{state:l,navigate:d,toast:a}=t;et(e);const p=l.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!p.deckId)return An(e,t,i);const u=p.deckId;let n,o,m,b;try{const j=await Promise.all([E.from("decks").select("formation,name,stadium_card_id").eq("id",u).single(),E.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",u).order("slot_order")]);n=j[0].data,m=j[0].error,o=j[1].data,b=j[1].error}catch(j){console.error("[Match] Exception chargement deck:",j),wt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>d("home"));return}if(m||b){console.error("[Match] Erreur Supabase:",m||b),wt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>d("home"));return}const g=(o||[]).filter(j=>{var K;return j.is_starter&&((K=j.card)==null?void 0:K.player)}).map(j=>mi(j.card,j.position)),T=(o||[]).filter(j=>{var K;return!j.is_starter&&((K=j.card)==null?void 0:K.player)}).map(j=>mi(j.card,j.position));if(g.length<11){wt(e,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>d("decks"));return}const r=(o||[]).find(j=>{var K;return((K=j.card)==null?void 0:K.card_type)==="formation"}),c=(n==null?void 0:n.formation)||((D=r==null?void 0:r.card)==null?void 0:D.formation)||"4-4-2",{data:I,error:L}=await E.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",l.profile.id).eq("card_type","game_changer"),{data:G}=await E.from("gc_definitions").select("*").eq("is_active",!0),Y=(I||[]).map(j=>({...j,_gcDef:(G==null?void 0:G.find(K=>K.name===j.gc_type||K.id===j.gc_definition_id))||null}));let B=null;if(n!=null&&n.stadium_card_id){const{data:j}=await E.from("cards").select("stadium_id").eq("id",n.stadium_card_id).single();if(j!=null&&j.stadium_id){const{data:K}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",j.stadium_id).single();B=K||null}}s({deckId:u,formation:c,starters:g,subsRaw:T,gcCardsEnriched:Y,gcDefs:G||[],stadiumDef:B})}async function zn(e,t){const{state:i}=t,l=(i.params||{}).matchMode||"vs_ai_easy",d=l.replace("vs_ai_",""),a=l;await ai(e,t,l,async({deckId:p,formation:u,starters:n,subsRaw:o,gcCardsEnriched:m,gcDefs:b,stadiumDef:g})=>{try{let T=yt(n,u);g&&(T=Ht(T,g),oi(o,g));const r=await Sn(u,d),c=async I=>{try{const{data:L,error:G}=await E.from("matches").insert({home_id:i.profile.id,away_id:null,mode:a,home_deck_id:p,status:"in_progress"}).select().single();if(G){console.error("[MatchIA] Erreur création match:",G),wt(e,"⚠️","Impossible de créer le match ("+G.message+").","Retour",()=>t.navigate("home"));return}const Y={gcDefs:b||[],matchId:L==null?void 0:L.id,mode:a,difficulty:d,formation:u,homeTeam:T,aiTeam:r,homeSubs:o,subsUsed:0,maxSubs:Math.min(o.length,3),homeScore:0,aiScore:0,gcCards:I,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};In(e,Y,t)}catch(L){console.error("[MatchIA] Exception launchMatch:",L),wt(e,"⚠️","Erreur au lancement du match : "+L.message,"Retour",()=>t.navigate("home"))}};if(!m.length){c([]);return}ri(e,m,c)}catch(T){console.error("[MatchIA] Exception setup:",T),wt(e,"⚠️","Erreur de préparation du match : "+T.message,"Retour",()=>t.navigate("home"))}})}async function Sn(e,t){var a,p;const{data:i}=await E.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return Ln(e);const s=It[e]||It["4-4-2"],l={GK:[],DEF:[],MIL:[],ATT:[]},d=[...i];for(const u of["GK","DEF","MIL","ATT"]){const n=d.filter(T=>T.job===u),o=d.filter(T=>T.job!==u),m=[...n,...o],b=[];for(let T=0;T<s[u];T++){const r=m[T]||d[T];r&&b.push({cardId:"ai-"+r.id+"-"+T,id:r.id,firstname:r.firstname,name:r.surname_encoded,country_code:r.country_code,club_id:r.club_id,job:r.job,job2:r.job2,note_g:Number(r.note_g)||0,note_d:Number(r.note_d)||0,note_m:Number(r.note_m)||0,note_a:Number(r.note_a)||0,rarity:r.rarity,skin:r.skin,hair:r.hair,hair_length:r.hair_length,clubName:((a=r.clubs)==null?void 0:a.encoded_name)||null,clubLogo:((p=r.clubs)==null?void 0:p.logo_url)||null,boost:0,used:!1,_line:u})}const g=lt(b.length);b.forEach((T,r)=>{T._col=g[r]}),l[u]=b}return l}function Ln(e){const t=It[e]||It["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},s=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let l=0;for(const d of["GK","DEF","MIL","ATT"]){const a=[];for(let u=0;u<t[d];u++){const n=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+l,id:"fake-"+l,firstname:"IA",name:s[l%s.length],country_code:"XX",club_id:null,job:d,job2:null,note_g:d==="GK"?n:2,note_d:d==="DEF"?n:2,note_m:d==="MIL"?n:2,note_a:d==="ATT"?n:2,rarity:"normal",boost:0,used:!1,_line:d}),l++}const p=lt(a.length);a.forEach((u,n)=>{u._col=p[n]}),i[d]=a}return i}function In(e,t,i){e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${r.map((G,Y)=>{const B=Y<r.length-1?at(G,r[Y+1]):null,D=!B||B==="#ff3333"||B==="#cc2222",j=B==="#00ff88"?"+2":B==="#FFD700"?"+1":"";return`
          ...
          ${Y<r.length-1?`<div class="duel-link duel-link-${L}" data-idx="${Y}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${D?"rgba(255,255,255,0.12)":B};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${D?"none":`0 0 8px ${B}`}">
            ${j?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${B}">${j}</span>`:""}
          </div>`:""}
          `}).join("")}
      </div>
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
  </div>`;const m=()=>{const r=(c,I)=>e.querySelectorAll(c).forEach((L,G)=>{setTimeout(()=>{L.style.opacity="1",L.style.transform="translateY(0) scale(1)"},I+G*90)});r(".duel-card-home",150),r(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((c,I)=>{setTimeout(()=>{c.style.opacity="1"},I*70)}),900),setTimeout(()=>{const c=e.querySelector("#vs-label");c&&(c.style.opacity="1",c.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(I=>I.style.opacity="1")},1250),setTimeout(()=>{b("score-home",p,800),b("score-ai",u,800)},1500)};function b(r,c,I){const L=document.getElementById(r);if(!L)return;const G=performance.now(),Y=B=>{const D=Math.min(1,(B-G)/I);L.textContent=Math.round(c*(1-Math.pow(1-D,3))),D<1?requestAnimationFrame(Y):L.textContent=c};requestAnimationFrame(Y)}requestAnimationFrame(m),t.attacker=n?"home":"ai";const g=n?ni():null;n&&(t.boostCard={value:g}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:s.map(r=>({name:r.name,note:je(r,"MIL"),portrait:Pe(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiPlayers:l.map(r=>({name:r.name,note:je(r,"MIL"),portrait:Pe(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),homeTotal:p,aiTotal:u,text:`Duel milieu : ${t.clubName} ${p} – ${u} IA → ${n?t.clubName+" attaque":"IA attaque"}`});const T=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Xe(e,t,i),t.attacker==="ai"&&setTimeout(()=>xi(e,t,i),800)};setTimeout(()=>{const r=document.getElementById("score-home"),c=document.getElementById("score-ai"),I=document.getElementById(n?"duel-row-home":"duel-row-ai"),L=document.getElementById(n?"duel-row-ai":"duel-row-home"),G=n?r:c,Y=n?c:r;G&&(G.style.fontSize="80px",G.style.color=n?"#FFD700":"#ff6b6b",G.style.animation="duelPulse .5s ease"+(n?", duelGlow 1.5s ease infinite .5s":"")),Y&&(Y.style.opacity="0.25"),setTimeout(()=>{I&&(I.style.transformOrigin="center",I.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",I.style.zIndex="5"),setTimeout(()=>{var D;const B=document.getElementById("duel-shock");if(B){const j=(D=L||I)==null?void 0:D.getBoundingClientRect(),K=e.querySelector(".match-screen").getBoundingClientRect();j&&(B.style.top=j.top-K.top+j.height/2+"px"),B.style.animation="shockwave .5s ease-out forwards"}L&&(L.style.transformOrigin="center",L.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var D;const B=document.getElementById("duel-finale");B&&(B.innerHTML=`
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,B.style.transition="opacity .45s ease",B.style.opacity="1",B.style.pointerEvents="auto",(D=document.getElementById("start-match-btn"))==null||D.addEventListener("click",T))},600)},700)},2800)}function jn(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const N=window.innerWidth>=700,W=(we,Ae,Ie)=>{var be,ze;const xe=(t.gcDefs||[]).find(M=>M.name===we.gc_type),X={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[xe==null?void 0:xe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ne={purple:"#b06ce0",light_blue:"#00d4ef"}[xe==null?void 0:xe.color]||"#b06ce0",ge=(xe==null?void 0:xe.name)||we.gc_type,J=(xe==null?void 0:xe.effect)||((be=Ve[we.gc_type])==null?void 0:be.desc)||"",Z=xe!=null&&xe.image_url?`/manager-wars/icons/${xe.image_url}`:null,U=((ze=Ve[we.gc_type])==null?void 0:ze.icon)||"⚡",se=Math.round(Ie*.22),he=Math.round(Ie*.22),Se=Ie-se-he,Me=ge.length>12?7:9;return`<div class="gc-mini" data-gc-id="${we.id}" data-gc-type="${we.gc_type}"
          ...
          <div style="height:${Se}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Z?`<img src="${Z}" style="max-width:${Ae-10}px;max-height:${Se-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Se*.55)}px">${U}</span>`}
          </div>
  ...
  `,document.body.appendChild(s);let o=!1;const m=()=>{o||(o=!0,s.remove(),i())};s.addEventListener("click",m),setTimeout(m,2e3)}function jt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function li(e,t,i,s=null,l=null){var g,T;if(t.phase!=="attack"){jt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){jt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([r,c])=>(c||[]).filter(I=>I.used).map(I=>({...I,_line:I._line||r}))),a=t.homeSubs.filter(r=>!t.usedSubIds.includes(r.cardId));if(!d.length){jt("Aucun joueur utilisé à remplacer");return}if(!a.length){jt("Aucun remplaçant disponible");return}let p=Math.max(0,d.findIndex(r=>r.cardId===l));const u=((g=d[p])==null?void 0:g._line)||((T=d[p])==null?void 0:T.job);let n=s?Math.max(0,a.findIndex(r=>r.cardId===s)):Math.max(0,a.findIndex(r=>r.job===u)),o=!1;const m=document.createElement("div");m.id="sub-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function b(){var B,D,j,K,oe,de;const r=d[p],c=a[n],I=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(I*1.35),G=N=>`background:rgba(255,255,255,0.12);border:none;color:${N?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${N?"default":"pointer"};flex-shrink:0`;m.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <button id="out-up" style="${G(p===0)}" ${p===0?"disabled":""}>▲</button>
        <div>${r?Ye({...r,used:!1,boost:0},I,L):"<div>—</div>"}</div>
        <button id="out-down" style="${G(p>=d.length-1)}" ${p>=d.length-1?"disabled":""}>▼</button>
        <div style="font-size:10px;color:rgba(255,255,255,0.35)">${p+1}/${d.length}</div>
      </div>
    </div>
    <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
      <button id="sub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
    </div>`,(B=m.querySelector("#sub-close"))==null||B.addEventListener("click",()=>m.remove()),(D=m.querySelector("#out-up"))==null||D.addEventListener("click",()=>{p>0&&(p--,b())}),(j=m.querySelector("#out-down"))==null||j.addEventListener("click",()=>{p<d.length-1&&(p++,b())}),(K=m.querySelector("#in-up"))==null||K.addEventListener("click",()=>{n>0&&(n--,b())}),(oe=m.querySelector("#in-down"))==null||oe.addEventListener("click",()=>{n<a.length-1&&(n++,b())});const Y=(N,W,H,P)=>{const re=m.querySelector("#"+N);if(!re)return;let pe=0;re.addEventListener("touchstart",ye=>{pe=ye.touches[0].clientY},{passive:!0}),re.addEventListener("touchend",ye=>{const Le=ye.changedTouches[0].clientY-pe;if(Math.abs(Le)<30)return;const ve=W();Le<0&&ve<P-1?(H(ve+1),b()):Le>0&&ve>0&&(H(ve-1),b())},{passive:!0})};Y("in-panel",()=>n,N=>n=N,a.length),Y("out-panel",()=>p,N=>p=N,d.length),(de=m.querySelector("#sub-confirm"))==null||de.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),o)return;o=!0;const W=d[p],H=a[n];if(!W||!H)return;let P=null,re=-1;for(const[ye,Le]of Object.entries(t.homeTeam)){const ve=(Le||[]).findIndex(_e=>_e.cardId===W.cardId);if(ve!==-1){P=ye,re=ve;break}}if(re===-1||!P){jt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),m.remove();return}const pe={...H,_line:P,_col:W._col||0,used:!1,boost:0};t.homeTeam[P].splice(re,1,pe),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(H.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:W.name,firstname:W.firstname,note:je(W,P),portrait:Pe(W),job:W.job,country_code:W.country_code,rarity:W.rarity,clubName:W.clubName,clubLogo:W.clubLogo},inPlayer:{name:H.name,firstname:H.firstname,note:je(H,P),portrait:Pe(H),job:H.job,country_code:H.country_code,rarity:H.rarity,clubName:H.clubName,clubLogo:H.clubLogo},text:`🔄 ${H.firstname} ${H.name} remplace ${W.firstname} ${W.name}`}),m.remove(),Dn(W,H,()=>Xe(e,t,i))})}document.body.appendChild(m),b()}function Gn(e,t,i,s,l){var T,r;const d=(s.gcDefs||[]).find(c=>c.name===t),a=Ve[t]||{icon:"⚡",desc:"Carte spéciale."},p={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",u={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",n=(d==null?void 0:d.name)||t,o=(d==null?void 0:d.effect)||a.desc,m=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,b=a.icon||"⚡",g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",g.innerHTML=`
    <!-- Carte design Collection -->
    <div style="width:190px;border-radius:16px;border:3px solid ${u};background:${p};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${u}66">
    ...
    </div>`,document.body.appendChild(g),(T=g.querySelector("#gc-back"))==null||T.addEventListener("click",()=>g.remove()),(r=g.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{g.remove(),Nn(e,t,i,s,l)})}function Yt(e,t,i,s,l,d){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let p=[];function u(){var n,o;a.innerHTML=`
    ...
    </div>`,(n=a.querySelector("#gc-picker-close"))==null||n.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(m=>{m.addEventListener("click",()=>{const b=m.dataset.cid,g=e.find(r=>r.cardId===b);if(!g)return;const T=p.findIndex(r=>r.cardId===b);T>-1?p.splice(T,1):p.length<t&&p.push(g),u()})}),(o=a.querySelector("#gc-picker-confirm"))==null||o.addEventListener("click",()=>{a.remove(),d(p)})}u(),document.body.appendChild(a)}const Pn={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},s,l,d)=>{const a=Object.entries(s.homeTeam).filter(([p])=>!i.length||i.includes(p)).flatMap(([p,u])=>u.filter(n=>!n.used).map(n=>({...n,_line:p})));return a.length?(Yt(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,l,s,p=>{p.forEach(u=>{const n=(s.homeTeam[u._line]||[]).find(o=>o.cardId===u.cardId);n&&(n.boost=(n.boost||0)+e,s.log.push({text:`⚡ +${e} sur ${n.name}`,type:"info"}))}),Xe(l,s,d)}),!0):(s.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Xe(l,s,d),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:s="ai"},l,d,a)=>{const p=s==="home"?l.homeTeam:l.aiTeam,u=s==="ai"?"adverse":"allié",n=Object.entries(p).filter(([o])=>!i.length||i.includes(o)).flatMap(([o,m])=>m.filter(b=>!b.used).map(b=>({...b,_line:o})));return n.length?(Yt(n,t,`Choisir ${t} joueur(s) ${u}(s) à débuffer (-${e})`,d,l,o=>{o.forEach(m=>{const g=((s==="home"?l.homeTeam:l.aiTeam)[m._line]||[]).find(T=>T.cardId===m.cardId);g&&(g.boost=(g.boost||0)-e,l.log.push({text:`🎯 -${e} sur ${g.name}${s==="ai"?" (IA)":""}`,type:"info"}))}),Xe(d,l,a)}),!0):(l.log.push({text:`🎯 Aucun joueur ${u} disponible`,type:"info"}),Xe(d,l,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},s,l,d)=>{const a=i==="home"?s.homeTeam:s.aiTeam,p=i==="ai"?"adverse":"allié",u=Object.entries(a).filter(([n])=>!t.length||t.includes(n)).flatMap(([n,o])=>o.filter(m=>!m.used).map(m=>({...m,_line:n})));return u.length?(Yt(u,e,`Choisir ${e} joueur(s) ${p}(s) à exclure`,l,s,n=>{n.forEach(o=>{const b=((i==="home"?s.homeTeam:s.aiTeam)[o._line]||[]).find(g=>g.cardId===o.cardId);b&&(b.used=!0,s.log.push({text:`❌ ${b.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Xe(l,s,d)}),!0):(s.log.push({text:`❌ Aucun joueur ${p} à exclure`,type:"info"}),Xe(l,s,d),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,s,l)=>{const d=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,p])=>p.filter(u=>u.used).map(u=>({...u,_line:a})));return d.length?(Yt(d,e,`Choisir ${e} joueur(s) à ressusciter`,s,i,a=>{a.forEach(p=>{const u=(i.homeTeam[p._line]||[]).find(n=>n.cardId===p.cardId);u&&(u.used=!1,i.log.push({text:`💫 ${u.name} ressuscité !`,type:"info"}))}),Xe(s,i,l)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Xe(s,i,l),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Nn(e,t,i,s,l){s.usedGc.push(e);const d=s.gcDefs||[],a=d.find(u=>u.name===t)||d.find(u=>{var n;return((n=u.name)==null?void 0:n.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let p=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const u=Pn[a.effect_type];u?u(a.effect_params||{},s,i,l)||(p=!0):(l.toast(`Effet "${a.effect_type}" non implémenté`,"error"),p=!0)}else{switch(t){case"Double attaque":s.modifiers.home.doubleAttack=!0,s.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":s.modifiers.home.shield=!0,s.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const u=Object.entries(s.homeTeam).flatMap(([n,o])=>(o||[]).filter(m=>m.used).map(m=>({...m,_line:n})));u.length?(u[0].used=!1,s.log.push({text:`💫 ${u[0].name} ressuscité !`,type:"info"})):s.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":s.modifiers.ai.stolenNote=(s.modifiers.ai.stolenNote||0)+1,s.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const u=[...s.aiTeam.ATT||[],...s.aiTeam.MIL||[]].filter(n=>!n.used);if(u.length){const n=u.sort((o,m)=>je(m,"ATT")-je(o,"ATT"))[0];n.used=!0,s.log.push({text:`❄️ ${n.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":s.maxSubs++,s.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}p=!0}E.from("cards").delete().eq("id",e).then(()=>{}),p&&Xe(i,s,l)}function Rn(e,t,i){const s=Object.values(t.homeTeam).flat().filter(l=>!l.used);if(!s.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(l=>{l.addEventListener("click",()=>{const d=l.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const p=(t.homeTeam[a]||[]).find(u=>u.cardId===d);if(p){p.boost=(p.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${p.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Xe(e,t,i)})})}function Qt(e,t,i,s,l){const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const a=Array.from({length:10},(n,o)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let p=!1;const u=()=>{p||(p=!0,d.remove(),setTimeout(()=>l(),50))};d.addEventListener("click",u),setTimeout(u,3500)}async function Bt(e,t,i){var o,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,l=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,a=l?"victoire":d?"nul":"defaite",p=Vo(t.mode,a);t.matchId&&await E.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:l?s.profile.id:null,home_credits_reward:p,played_at:new Date().toISOString()}).eq("id",t.matchId);const u={credits:(s.profile.credits||0)+p,matches_played:(s.profile.matches_played||0)+1};l?u.wins=(s.profile.wins||0)+1:d?u.draws=(s.profile.draws||0)+1:u.losses=(s.profile.losses||0)+1,await E.from("users").update(u).eq("id",s.profile.id),await i.refreshProfile();const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",n.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const T=async(Y=!0)=>{b=!0,g&&(E.removeChannel(g),g=null),Y&&await E.rpc("cancel_matchmaking",{p_user_id:n.profile.id}).catch(()=>{})};(G=document.getElementById("mm-cancel"))==null||G.addEventListener("click",async()=>{try{await T(!0)}catch{}We(e),o("home")});const r=async(Y,B,D)=>{if(b)return;b=!0,g&&(E.removeChannel(g),g=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(K=>setTimeout(K,600)),e.isConnected&&$o(e,t,Y,D,a,p)},{data:c,error:I}=await E.rpc("try_matchmake",{p_user_id:n.profile.id,p_deck_id:i});if(I||!(c!=null&&c.success)){m("Erreur de matchmaking","error"),We(e),o("home");return}if(c.matched){r(c.match_id,c.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),g=E.channel("matchmaking-"+n.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${n.profile.id}`},Y=>{const B=Y.new;B.status==="matched"&&B.match_id&&r(B.match_id,B.matched_with,!0)}).subscribe()}async function Un(e,t,i){const{state:s,navigate:l,toast:d}=t;try{(E.getChannels?E.getChannels():[]).forEach(n=>{const o=n.topic||"";(o.includes("matchmaking")||o.includes("pvp-match")||o.includes("friend-invite"))&&E.removeChannel(n)})}catch{}const{data:a}=await E.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!a){d("Match introuvable","error"),l("home");return}if(a.status==="finished"){d("Ce match est terminé","info"),l("home");return}const p=a.home_id===s.profile.id;$o(e,t,i,p,[],[])}async function $o(e,t,i,s,l=[],d=[]){const{state:a,navigate:p,toast:u}=t,n=s?"p1":"p2",o=s?"p2":"p1",m=(l||[]).map(M=>M.id),b=(l||[]).map(M=>({id:M.id,gc_type:M.gc_type,_gcDef:M._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await E.from("matches").select("*").eq("id",i).single();if(!g){u("Match introuvable","error"),p("home");return}async function T(){const[{data:M},{data:q},{data:w},{data:k}]=await Promise.all([E.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),E.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),E.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),E.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),f=A=>{const S=Number(A.evolution_bonus)||0;return{cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:(Number(A.note_g)||0)+(A.job==="GK"||A.job2==="GK"&&Number(A.note_g)>0?S:0),note_d:(Number(A.note_d)||0)+(A.job==="DEF"||A.job2==="DEF"&&Number(A.note_d)>0?S:0),note_m:(Number(A.note_m)||0)+(A.job==="MIL"||A.job2==="MIL"&&Number(A.note_m)>0?S:0),note_a:(Number(A.note_a)||0)+(A.job==="ATT"||A.job2==="ATT"&&Number(A.note_a)>0?S:0),evolution_bonus:S,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},x=((M==null?void 0:M.starters)||[]).map(A=>f(A)),y=((q==null?void 0:q.starters)||[]).map(A=>f(A)),h=(M==null?void 0:M.formation)||"4-4-2",v=(q==null?void 0:q.formation)||"4-4-2";let _=yt(x,h),z=yt(y,v);const $=((M==null?void 0:M.subs)||[]).map(A=>f(A));return stadiumDef&&s&&(_=Ht(_,stadiumDef),oi($,stadiumDef)),{p1Team:_,p2Team:z,p1Subs:$,p2Subs:((q==null?void 0:q.subs)||[]).map(A=>f(A)),p1Formation:h,p2Formation:v,p1Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 1",p2Name:(k==null?void 0:k.club_name)||(k==null?void 0:k.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?m:[],gc_p2:s?[]:m,gcCardsFull_p1:s?b:[],gcCardsFull_p2:s?[]:b,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!r)if(s){r=await T();const{data:M}=await E.from("matches").select("game_state").eq("id",i).single();!(M!=null&&M.game_state)||!Object.keys(M.game_state).length?await E.from("matches").update({game_state:r,turn_user_id:g.home_id}).eq("id",i):r=M.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let M=0;M<30&&!r;M++){await new Promise(w=>setTimeout(w,400));const{data:q}=await E.from("matches").select("game_state").eq("id",i).single();q!=null&&q.game_state&&Object.keys(q.game_state).length&&(r=q.game_state)}if(!r){u("Erreur de synchronisation","error"),p("home");return}r.gc_p2=m,r.gcCardsFull_p2=b,await E.from("matches").update({game_state:r}).eq("id",i)}let c=!1,I=null,L=!1;const G=new Set,Y=new Set;function B(M){var _,z;try{E.removeChannel(D)}catch{}const q=r[n+"Score"]||0,w=r[o+"Score"]||0;let k,f;M.winner_id?(k=M.winner_id===a.profile.id,f=!1):M.forfeit?(k=q>w,f=!1):(f=q===w,k=q>w),(_=document.getElementById("pvp-end-overlay"))==null||_.remove();const x=document.createElement("div");x.id="pvp-end-overlay",x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const y=f?"🤝":k?"🏆":"😞",h=f?"MATCH NUL":k?"VICTOIRE !":"DÉFAITE",v=f?"#fff":k?"#FFD700":"#ff6b6b";x.innerHTML=`
      <div style="font-size:64px">${y}</div>
      <div style="font-size:26px;font-weight:900;color:${v}">${h}</div>
      <div style="font-size:18px">${r[n+"Name"]} ${q} – ${w} ${r[o+"Name"]}</div>
      ${M.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${k?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(x),(z=x.querySelector("#pvp-end-home"))==null||z.addEventListener("click",()=>{x.remove(),We(e),p("home")})}const D=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},M=>{const q=M.new;try{if(q.status==="finished"||q.forfeit){if(c)return;c=!0,I&&(clearInterval(I),I=null),q.game_state&&(r=q.game_state),B(q);return}if(q.game_state){const w=r;r=q.game_state;const k=r._lastGC;if(k&&k.seq&&!Y.has(k.seq)&&(Y.add(k.seq),k.by!==n)){ve(k.type,k.by,()=>P());return}const f=w[n+"Score"]||0,x=w[o+"Score"]||0,y=r[n+"Score"]||0,h=r[o+"Score"]||0,v=y>f,_=h>x;if((v||_)&&!G.has(r.round)){G.add(r.round);const z=[...r.log||[]].reverse().find(A=>A.isGoal),$=((z==null?void 0:z.homePlayers)||[]).map(A=>({name:A.name,note:A.note,portrait:A.portrait,job:A.job}));Le($,y,h,v,()=>P());return}P()}}catch(w){console.error("[PvP] crash:",w)}}).subscribe();async function j(M){Object.assign(r,M),r.lastActionAt=new Date().toISOString();const{error:q}=await E.from("matches").update({game_state:r}).eq("id",i);q&&u("Erreur de synchronisation","error");try{P()}catch(w){console.error("[PvP] renderPvpScreen crash:",w)}}async function K(){if(c)return;c=!0,I&&(clearInterval(I),I=null);const M=s?g.away_id:g.home_id,q=s?"p2":"p1",w=s?"p1":"p2",k={...r,[q+"Score"]:3,[w+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:M,home_score:k.p1Score||0,away_score:k.p2Score||0,game_state:k}).eq("id",i)}catch{}try{E.removeChannel(D)}catch{}setTimeout(()=>{We(e),p("home")},800)}const oe={BOOST_STAT:({value:M=1,count:q=1,roles:w=[]},k,f)=>{const x=k[n+"Team"],y=Object.entries(x).filter(([h])=>!w.length||w.includes(h)).flatMap(([h,v])=>v.filter(_=>!_.used).map(_=>({..._,_line:h})));if(!y.length){k.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),f(k);return}de(y,q,`Choisir ${q} joueur(s) à booster (+${M})`,h=>{h.forEach(v=>{const _=(x[v._line]||[]).find(z=>z.cardId===v.cardId);_&&(_.boost=(_.boost||0)+M,k.log.push({text:`⚡ +${M} sur ${_.name}`,type:"info"}))}),k[n+"Team"]=x,f(k)})},DEBUFF_STAT:({value:M=1,count:q=1,roles:w=[],target:k="ai"},f,x)=>{const y=k==="home"?n:o,h=f[y+"Team"],v=k==="home"?"allié":"adverse",_=Object.entries(h).filter(([z])=>!w.length||w.includes(z)).flatMap(([z,$])=>$.map(A=>({...A,_line:z})));if(!_.length){f.log.push({text:`🎯 Aucun joueur ${v}`,type:"info"}),x(f);return}de(_,q,`Choisir ${q} joueur(s) ${v}(s) (-${M})`,z=>{z.forEach($=>{const A=(h[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.boost=(A.boost||0)-M,f.log.push({text:`🎯 -${M} sur ${A.name}`,type:"info"}))}),f[y+"Team"]=h,x(f)})},GRAY_PLAYER:({count:M=1,roles:q=[],target:w="ai"},k,f)=>{const x=w==="home"?n:o,y=k[x+"Team"],h=w==="home"?"allié":"adverse",v=Object.entries(y).filter(([_])=>!q.length||q.includes(_)).flatMap(([_,z])=>z.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){k.log.push({text:`❌ Aucun joueur ${h}`,type:"info"}),f(k);return}de(v,M,`Choisir ${M} joueur(s) ${h}(s) à exclure`,_=>{const z="usedCardIds_"+x,$=new Set(k[z]||[]);_.forEach(A=>{const S=(y[A._line]||[]).find(C=>C.cardId===A.cardId);S&&(S.used=!0,$.add(A.cardId),k.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),k[z]=[...$],k[x+"Team"]=y,f(k)})},REVIVE_PLAYER:({count:M=1,roles:q=[]},w,k)=>{const f=w[n+"Team"],x=Object.entries(f).filter(([y])=>!q.length||q.includes(y)).flatMap(([y,h])=>h.filter(v=>v.used).map(v=>({...v,_line:y})));if(!x.length){w.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),k(w);return}de(x,M,`Choisir ${M} joueur(s) à ressusciter`,y=>{y.forEach(h=>{const v=(f[h._line]||[]).find(_=>_.cardId===h.cardId);v&&(v.used=!1,w.log.push({text:`💫 ${v.name} ressuscité !`,type:"info"}))}),w[n+"Team"]=f,k(w)})},REMOVE_GOAL:({},M,q)=>{const w=o+"Score";M[w]>0?(M[w]--,M.log.push({text:"🚫 Dernier but annulé !",type:"info"})):M.log.push({text:"🚫 Aucun but à annuler",type:"info"}),q(M)},ADD_GOAL_DRAW:({},M,q)=>{M[n+"Score"]===M[o+"Score"]?(M[n+"Score"]++,M.log.push({text:"🎯 But bonus !",type:"info"})):M.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),q(M)},ADD_SUB:({value:M=1},q,w)=>{q.maxSubs=(q.maxSubs||3)+M,q.log.push({text:`🔄 +${M} remplacement(s)`,type:"info"}),w(q)},CUSTOM:({},M,q)=>q(M)};function de(M,q,w,k){const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let x=[];function y(){var v,_;const h=M.map(z=>{const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",A=je(z,z._line)+(z.boost||0),C=x.find(R=>R.cardId===z.cardId)?"#FFD700":"rgba(255,255,255,0.25)",F=z.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${C};background:${$};overflow:hidden;cursor:pointer;${F}">
        ...
        <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
          ...
          <span style="font-size:12px;color:rgba(255,255,255,0.5)">${x.length}/${q}</span>
        ...
        <div style="padding:12px;background:rgba(0,0,0,0.4);flex-shrink:0">
          <button id="pp-confirm" ${x.length===0?'disabled style="opacity:0.4"':""} style="width:100%;padding:13px;border-radius:10px;border:none;background:#7a28b8;color:#fff;font-size:15px;font-weight:900;cursor:pointer">
            ✅ Confirmer (${x.length}/${q})
          </button>
        </div>`,(v=f.querySelector("#pp-close"))==null||v.addEventListener("click",()=>f.remove()),f.querySelectorAll(".pp-item").forEach(z=>{z.addEventListener("click",()=>{const $=z.dataset.cid,A=M.find(C=>C.cardId===$),S=x.findIndex(C=>C.cardId===$);A&&(S>-1?x.splice(S,1):x.length<q&&x.push(A),y())})}),(_=f.querySelector("#pp-confirm"))==null||_.addEventListener("click",()=>{f.remove(),k(x)})}y(),document.body.appendChild(f)}async function N(M,q){const k=(r["gcCardsFull_"+n]||[]).find(h=>h.id===M),f=(k==null?void 0:k._gcDef)||(r.gcDefs||[]).find(h=>{var v;return h.name===q||((v=h.name)==null?void 0:v.toLowerCase().trim())===(q==null?void 0:q.toLowerCase().trim())}),x=[...r["usedGc_"+n]||[],M],y={type:q,by:n,seq:(r._gcAnimSeq||0)+1};Y.add(y.seq),ve(q,n,async()=>{if(f!=null&&f.effect_type&&f.effect_type!=="CUSTOM"){const v=oe[f.effect_type];if(v){const _={...r};v(f.effect_params||{},_,async z=>{z["usedGc_"+n]=x,z._lastGC=y,z._gcAnimSeq=y.seq,await j(z)});return}}const h={...r};switch(q){case"Remplacement+":h.maxSubs=(h.maxSubs||3)+1,h.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const v=o+"Score";h[v]>0&&(h[v]--,h.log.push({text:"🚫 But annulé",type:"info"}));break}}h["usedGc_"+n]=x,h._lastGC=y,h._gcAnimSeq=y.seq,await j(h)})}function W(M,q){const w="usedCardIds_"+M,k=new Set(r[w]||[]);q.forEach(f=>k.add(f)),r[w]=[...k]}function H(){for(const M of["p1","p2"]){const q=new Set(r["usedCardIds_"+M]||[]),w=r[M+"Team"];if(w)for(const k of["GK","DEF","MIL","ATT"])(w[k]||[]).forEach(f=>{f.used=q.has(f.cardId)})}}function P(){var Ue,Je,Ze,Qe,nt,gt;if(r.phase==="reveal")return re();if(r.phase==="midfield")return ye();if(r.phase==="finished")return ze();const M=r[n+"Team"],q=r[o+"Team"];H();const w=r[n+"Score"],k=r[o+"Score"],f=r[n+"Name"],x=r[o+"Name"],y=r.phase===n+"-attack",h=r.phase===n+"-defense",v=Array.isArray(r["selected_"+n])?r["selected_"+n]:[],_=v.map(le=>le.cardId),z=window.innerWidth>=700,$=r[n+"Subs"]||[],A=r["usedSubIds_"+n]||[],S=$.filter(le=>!A.includes(le.cardId)),C=r["gcCardsFull_"+n]||[],F=r["usedGc_"+n]||[],R=C.filter(le=>!F.includes(le.id)),O=r.boostOwner===n&&!r.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(le=>(q[le]||[]).some(Ee=>!Ee.used)),V=[...M.MIL||[],...M.ATT||[]].filter(le=>!le.used),ie=y&&Q&&V.length===0?[...M.GK||[],...M.DEF||[]].filter(le=>!le.used).map(le=>le.cardId):[];function ae(le,Ee,te){var pt,ht;const ue=le._gcDef,ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ue==null?void 0:ue.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ce={purple:"#b06ce0",light_blue:"#00d4ef"}[ue==null?void 0:ue.color]||"#b06ce0",Be=(ue==null?void 0:ue.name)||le.gc_type,Te=(ue==null?void 0:ue.effect)||((pt=Ve[le.gc_type])==null?void 0:pt.desc)||"",tt=ue!=null&&ue.image_url?`/manager-wars/icons/${ue.image_url}`:null,it=((ht=Ve[le.gc_type])==null?void 0:ht.icon)||"⚡",rt=Math.round(te*.22),st=Math.round(te*.22),ct=te-rt-st,$t=Be.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${le.id}" data-gc-type="${le.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(x);let v=!1;const _=()=>{v||(v=!0,x.remove(),setTimeout(()=>f(),50))};x.addEventListener("click",_),setTimeout(_,3500)}function ve(M,q,w){var F,R;const k=(r.gcDefs||[]).find(O=>{var Q;return O.name===M||((Q=O.name)==null?void 0:Q.toLowerCase().trim())===(M==null?void 0:M.toLowerCase().trim())}),f={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[k==null?void 0:k.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",x={purple:"#b06ce0",light_blue:"#00d4ef"}[k==null?void 0:k.color]||"#b06ce0",y=(k==null?void 0:k.name)||M,h=(k==null?void 0:k.effect)||((F=Ve[M])==null?void 0:F.desc)||"",v=k!=null&&k.image_url?`/manager-wars/icons/${k.image_url}`:null,_=((R=Ve[M])==null?void 0:R.icon)||"⚡",$=q===n?"Vous":r[q+"Name"]||"Adversaire",A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",A.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(A);let S=!1;const C=()=>{S||(S=!0,A.remove(),setTimeout(()=>w&&w(),50))};A.addEventListener("click",C),setTimeout(C,3e3)}function _e(M,q){var A,S,C,F;const k=(r["gcCardsFull_"+n]||[]).find(R=>R.id===M),f=k==null?void 0:k._gcDef,x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[f==null?void 0:f.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",y={purple:"#b06ce0",light_blue:"#00d4ef"}[f==null?void 0:f.color]||"#b06ce0",h=(f==null?void 0:f.name)||q,v=(f==null?void 0:f.effect)||((A=Ve[q])==null?void 0:A.desc)||"Carte spéciale.",_=f!=null&&f.image_url?`/manager-wars/icons/${f.image_url}`:null,z=((S=Ve[q])==null?void 0:S.icon)||"⚡",$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",$.innerHTML=`
      ...
      </div>`,document.body.appendChild($),(C=$.querySelector("#pvp-gc-back"))==null||C.addEventListener("click",()=>$.remove()),(F=$.querySelector("#pvp-gc-use"))==null||F.addEventListener("click",()=>{$.remove(),N(M,q)})}function we(){var k;const M=r[n+"Team"],q=Object.entries(M).flatMap(([f,x])=>(x||[]).filter(y=>!y.used).map(y=>({...y,_line:f})));if(!q.length)return;const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",w.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${r.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${q.map(f=>{const x={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[f._line]||"#555",y=je(f,f._line)+(f.boost||0);return`<div class="bp-item" data-cid="${f.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${x};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(w),(k=w.querySelector("#bp-close"))==null||k.addEventListener("click",()=>w.remove()),w.querySelectorAll(".bp-item").forEach(f=>{f.addEventListener("click",async()=>{const x=f.dataset.cid,y=q.find(v=>v.cardId===x);if(!y)return;const h=(M[y._line]||[]).find(v=>v.cardId===x);h&&(h.boost=(h.boost||0)+r.boostValue),w.remove(),await j({[n+"Team"]:M,boostUsed:!0})})})}function Ae(M=null){var S,C;if(!(r.phase===n+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const w=r[n+"Team"],k=r["usedSubIds_"+n]||[],f=r.maxSubs||3;if(k.length>=f){u(`Maximum ${f} remplacements atteint`,"warning");return}const x=Object.entries(w).flatMap(([F,R])=>(R||[]).filter(O=>O.used).map(O=>({...O,_line:F}))),y=(r[n+"Subs"]||[]).filter(F=>!k.includes(F.cardId));if(!x.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!y.length){u("Aucun remplaçant disponible","warning");return}let h=Math.max(0,x.findIndex(F=>F.cardId===M));const v=((S=x[h])==null?void 0:S._line)||((C=x[h])==null?void 0:C.job);let _=Math.max(0,y.findIndex(F=>F.job===v)),z=!1;const $=document.createElement("div");$.id="pvp-sub-overlay",$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function A(){var ae,fe,me,$e,ke,qe;const F=x[h],R=y[_],O=Math.min(130,Math.round((window.innerWidth-90)/2)),Q=Math.round(O*1.35),V=Ce=>`background:rgba(255,255,255,0.12);border:none;color:${Ce?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Ce?"default":"pointer"};flex-shrink:0`;$.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(f);let y=!1;const h=()=>{y||(y=!0,f.remove(),setTimeout(()=>w(),50))};f.addEventListener("click",h),setTimeout(h,2200)}function xe(){var q;const M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",M.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${r[o+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(r[o+"Team"],r[o+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(M),(q=M.querySelector("#pvp-opp-close"))==null||q.addEventListener("click",()=>M.remove())}function X(){var w;const M=r.log||[],q=document.createElement("div");q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",q.innerHTML=`
      ...
      </div>`,document.body.appendChild(q),(w=q.querySelector("#pvp-hist-close"))==null||w.addEventListener("click",()=>q.remove())}async function ne(){if(r.phase!==n+"-attack")return;const M=n==="p1"?"p2":"p1",q=(r.round||0)+1,w=[...r.log||[]];w.push({type:"info",text:`⏭️ ${r[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const k=Se(r),f=he(M),x=k||!f?"finished":M+"-attack";await j({["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:x,attacker:M,round:q,log:w}),x==="finished"&&await be(r)}async function ge(){const M=r[n+"Team"],q=!["GK","DEF","MIL","ATT"].some(x=>(r[o+"Team"][x]||[]).some(y=>!y.used)),w=(r["selected_"+n]||[]).map(x=>{const y=(M[x._role]||[]).find(A=>A.cardId===x.cardId)||x,h=q&&["GK","DEF"].includes(x._role),v=M[x._role]||[],_=v.findIndex(A=>A.cardId===x.cardId),z=lt(v.length),$=_>=0?z[_]:y._col??1;return{...y,_line:x._role,_col:$,...h?{note_a:Math.max(1,Number(y.note_a)||0)}:{}}});if(!w.length)return;const k=Nt(w,r.modifiers[n]||{});W(n,w.map(x=>x.cardId)),w.forEach(x=>{const y=(M[x._role]||[]).find(h=>h.cardId===x.cardId);y&&(y.used=!0)}),r["selected_"+n]=[],P();const f=[...r.log||[]];if(q){const x=(r[n+"Score"]||0)+1,y=w.map($=>({name:$.name,note:je($,$._line||"ATT"),portrait:Pe($),job:$.job}));f.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:y,homeTotal:k.total,aiTotal:0});const h=(r.round||0)+1,v=n==="p1"?"p2":"p1",_={...r,[n+"Team"]:M,[n+"Score"]:x},z=Se(_);G.add(h),Le(y,x,r[o+"Score"]||0,!0,async()=>{await j({[n+"Team"]:M,[n+"Score"]:x,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:z?"finished":v+"-attack",attacker:v,round:h,log:f}),z&&await be({...r,[n+"Score"]:x})});return}f.push({type:"pending",text:`⚔️ ${r[n+"Name"]} attaque (${k.total})`}),await j({[n+"Team"]:M,[o+"Team"]:r[o+"Team"],pendingAttack:{...k,players:w,side:n},["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},phase:o+"-defense",log:f})}async function J(){const M=r[n+"Team"],q=(r["selected_"+n]||[]).map(F=>{const R=(M[F._role]||[]).find(ae=>ae.cardId===F.cardId)||F,O=M[F._role]||[],Q=O.findIndex(ae=>ae.cardId===F.cardId),V=lt(O.length),ie=Q>=0?V[Q]:R._col??1;return{...R,_line:F._role,_col:ie}}),w=Rt(q,r.modifiers[n]||{});W(n,q.map(F=>F.cardId)),q.forEach(F=>{const R=(M[F._role]||[]).find(O=>O.cardId===F.cardId);R&&(R.used=!0)}),r["selected_"+n]=[],P();const k=Ot(r.pendingAttack.total,w.total,r.modifiers[n]||{}),f=r.pendingAttack.side,x=k==="attack"||(k==null?void 0:k.goal),y=f==="p1"?"p2":"p1",h=(r.round||0)+1,v=(r.pendingAttack.players||[]).map(F=>({name:F.name,note:je(F,F._line||"ATT"),portrait:Pe(F),job:F.job})),_=[...r.log||[]];_.push({type:"duel",isGoal:x,homeScored:x&&f===n,text:x?`⚽ BUT de ${r[f+"Name"]} ! (${r.pendingAttack.total} vs ${w.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${w.total})`,homePlayers:v,aiPlayers:q.map(F=>({name:F.name,note:je(F,F._line||"DEF"),portrait:Pe(F),job:F.job})),homeTotal:r.pendingAttack.total,aiTotal:w.total});const z=x?(r[f+"Score"]||0)+1:r[f+"Score"]||0,$={...r,[n+"Team"]:M,[f+"Score"]:z},A=Se($),S=A?"finished":y+"-attack",C=async()=>{await j({[n+"Team"]:M,[o+"Team"]:r[o+"Team"],[f+"Score"]:z,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:S,attacker:y,round:h,log:_}),(S==="finished"||A)&&await be({...r,[f+"Score"]:z})};if(x){const F=f===n,R=F?z:r[n+"Score"]||0,O=F?r[o+"Score"]||0:z;G.add(h),Le(v,R,O,F,C)}else await C()}function Z(M){return["MIL","ATT"].some(q=>(M[q]||[]).some(w=>!w.used))}function U(M){return["GK","DEF","MIL","ATT"].some(q=>(M[q]||[]).some(w=>!w.used))}function se(M){return U(M)&&!Z(M)}function he(M){const q=r[M+"Team"],w=r[(M==="p1"?"p2":"p1")+"Team"];return!!(Z(q)||!U(w)&&se(q))}function Se(M){const q=["MIL","ATT"].some(_=>(M.p1Team[_]||[]).some(z=>!z.used)),w=["MIL","ATT"].some(_=>(M.p2Team[_]||[]).some(z=>!z.used)),k=U(M.p1Team),f=U(M.p2Team);return!q&&!(!f&&k)&&(!w&&!(!k&&f))}function Me(M){const q=M.p1Score||0,w=M.p2Score||0;return q===w?null:q>w?g.home_id:g.away_id}async function be(M){try{const q=Me(M),w=q?g.home_id===q?g.away_id:g.home_id:null;await E.from("matches").update({status:"finished",winner_id:q,home_score:M.p1Score||0,away_score:M.p2Score||0}).eq("id",i),q&&w&&updateEvolutiveCards(q,w).catch(()=>{})}catch(q){console.error("[PvP] finishMatch:",q)}}function ze(){var f;const M=r[n+"Score"],q=r[o+"Score"],w=M>q,k=M===q;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(f=document.getElementById("pvp-home"))==null||f.addEventListener("click",()=>{try{E.removeChannel(D)}catch{}We(e),p("home")})}P()}const Kn=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:_o,resumePvpMatch:Un},Symbol.toStringTag,{value:"Module"}));async function Vn(e,t,i,s){var l,d;try{const a=(d=(l=t==null?void 0:t.state)==null?void 0:l.profile)==null?void 0:d.id;try{(E.getChannels?E.getChannels():[]).forEach(u=>{const n=u.topic||"";(n.includes("matchmaking")||n.includes("pvp-match"))&&E.removeChannel(u)})}catch(p){console.warn("[FriendMatch] cleanup canaux:",p)}a&&(await E.rpc("cancel_matchmaking",{p_user_id:a}).catch(()=>{}),await E.from("matchmaking_queue").delete().eq("user_id",a).then(()=>{},()=>{}))}catch{}await ai(e,t,"random",({deckId:a,formation:p,starters:u,subsRaw:n,gcCardsEnriched:o,gcDefs:m,stadiumDef:b})=>{const g=T=>Yn(e,t,a,p,u,n,T,m||[],i,s);if(!o.length){g([]);return}ri(e,o,g)})}async function Yn(e,t,i,s,l,d,a=[],p=[],u,n){var oe;const{state:o,navigate:m,toast:b}=t,g=o.profile.id;let T=!1,r=null;et(e);try{await E.rpc("cancel_matchmaking",{p_user_id:g})}catch{}try{await E.from("matchmaking_queue").delete().eq("user_id",g)}catch{}const c=(de,N,W,H)=>{var P;e.innerHTML=`
      ...
      </div>`,(P=document.getElementById("lobby-cancel"))==null||P.addEventListener("click",async()=>{T=!0,r&&(E.removeChannel(r),r=null),W&&await E.from("friend_match_invites").update({status:"declined"}).eq("id",W),We(e),m("home")})},I=async(de,N)=>{T=!0,r&&(E.removeChannel(r),r=null),await new Promise(W=>setTimeout(W,600)),e.isConnected&&Wn(e,t,de,N,a,p)},{data:L}=await E.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${g},invitee_id.eq.${u}),and(inviter_id.eq.${u},invitee_id.eq.${g})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let G,Y;if(L&&L.inviter_id===u)Y=!1,G=L.id,await E.from("friend_match_invites").update({invitee_deck_id:i,invitee_ready:!0,status:"accepted"}).eq("id",G);else{Y=!0;const{data:de,error:N}=await E.from("friend_match_invites").insert({inviter_id:g,invitee_id:u,friend_id:u,inviter_deck_id:i,inviter_ready:!0,status:"pending"}).select().single();if(N||!de){b("Erreur création invitation","error"),We(e),m("home");return}G=de.id}if(c(!0,!Y,G),!Y){const de={home_id:u,away_id:g,home_deck_id:L.inviter_deck_id,away_deck_id:i,status:"active",mode:"friend"},N=await E.from("matches").insert(de).select().single(),W=N.data;if(!W){b("Erreur création match: "+(((oe=N.error)==null?void 0:oe.message)||""),"error"),We(e),m("home");return}await E.from("friend_match_invites").update({match_id:W.id,status:"matched"}).eq("id",G),I(W.id,!1);return}let B=!1;const D=de=>{T||B||(de.status==="matched"&&de.match_id?(B=!0,clearInterval(j),clearInterval(K),I(de.match_id,!0)):de.status==="declined"?(clearInterval(j),clearInterval(K),b(`${n} a décliné l'invitation`,"warning"),We(e),m("home")):de.invitee_ready&&c(!0,!0,G))},j=setInterval(()=>{if(T){clearInterval(j);return}E.from("matchmaking_queue").delete().eq("user_id",g).then(()=>{},()=>{})},3e3),K=setInterval(async()=>{if(T||B){clearInterval(K);return}const{data:de}=await E.from("friend_match_invites").select("*").eq("id",G).maybeSingle();de&&D(de)},1200);r=E.channel("friend-invite-"+G).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${G}`},de=>D(de.new)).subscribe()}async function Wn(e,t,i,s,l=[],d=[]){const{state:a,navigate:p,toast:u}=t,n=s?"p1":"p2",o=s?"p2":"p1",m=(l||[]).map(w=>w.id),b=(l||[]).map(w=>({id:w.id,gc_type:w.gc_type,_gcDef:w._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await E.from("matches").select("*").eq("id",i).single();if(!g){u("Match introuvable","error"),p("home");return}async function T(){const[{data:w},{data:k},{data:f},{data:x}]=await Promise.all([E.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),E.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),E.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),E.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),y=$=>{const A=Number($.evolution_bonus)||0;return{cardId:$.card_id,position:$.position,id:$.id,firstname:$.firstname,name:$.surname_encoded,country_code:$.country_code,club_id:$.club_id,job:$.job,job2:$.job2,note_g:(Number($.note_g)||0)+($.job==="GK"||$.job2==="GK"&&Number($.note_g)>0?A:0),note_d:(Number($.note_d)||0)+($.job==="DEF"||$.job2==="DEF"&&Number($.note_d)>0?A:0),note_m:(Number($.note_m)||0)+($.job==="MIL"||$.job2==="MIL"&&Number($.note_m)>0?A:0),note_a:(Number($.note_a)||0)+($.job==="ATT"||$.job2==="ATT"&&Number($.note_a)>0?A:0),evolution_bonus:A,rarity:$.rarity,skin:$.skin,hair:$.hair,hair_length:$.hair_length,clubName:$.club_encoded_name||null,clubLogo:$.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},h=((w==null?void 0:w.starters)||[]).map($=>y($)),v=((k==null?void 0:k.starters)||[]).map($=>y($)),_=(w==null?void 0:w.formation)||"4-4-2",z=(k==null?void 0:k.formation)||"4-4-2";return{p1Team:(()=>{const $=yt(h,_);return stadiumDef?Ht($,stadiumDef):$})(),p2Team:yt(v,z),p1Subs:(()=>{const $=((w==null?void 0:w.subs)||[]).map(A=>y(A));return stadiumDef&&oi($,stadiumDef),$})(),p2Subs:((k==null?void 0:k.subs)||[]).map($=>y($)),p1Formation:_,p2Formation:z,p1Name:(f==null?void 0:f.club_name)||(f==null?void 0:f.pseudo)||"Joueur 1",p2Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?m:[],gc_p2:s?[]:m,gcCardsFull_p1:s?b:[],gcCardsFull_p2:s?[]:b,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!r)if(s){r=await T();const{data:w}=await E.from("matches").select("game_state").eq("id",i).single();!(w!=null&&w.game_state)||!Object.keys(w.game_state).length?await E.from("matches").update({game_state:r,turn_user_id:g.home_id}).eq("id",i):r=w.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let w=0;w<60&&!r;w++){await new Promise(f=>setTimeout(f,400));const{data:k}=await E.from("matches").select("game_state").eq("id",i).single();k!=null&&k.game_state&&Object.keys(k.game_state).length&&(r=k.game_state)}if(!r){u("Erreur de synchronisation","error"),p("home");return}r.gc_p2=m,r.gcCardsFull_p2=b,await E.from("matches").update({game_state:r}).eq("id",i)}let c=!1,I=!1,L=!1,G=null,Y=!1;const B=new Set,D=new Set;function j(w){var $,A;try{E.removeChannel(K)}catch{}const k=r[n+"Score"]||0,f=r[o+"Score"]||0;if(!L){L=!0;const S=w.winner_id||(k>f?a.profile.id:f>k?"opp":null),C=S===a.profile.id?"win":S?"loss":null;C&&ti(()=>Promise.resolve().then(()=>no),void 0).then(F=>F.applyOwnEvolution(a.profile.id,C)).catch(()=>{})}if(!I){const S=r.p1Score||0,C=r.p2Score||0,F=(r.usedGc_p1||[]).length,R=(r.usedGc_p2||[]).length,O=w.winner_id||(S>C?g.home_id:C>S?g.away_id:null);(O?a.profile.id===O:a.profile.id<(s?g.away_id:g.home_id))&&(I=!0,Zi({player1Id:g.home_id,player2Id:g.away_id,score1:S,score2:C,gc1:F,gc2:R}).catch(V=>console.warn("[FriendMatch] updateStats:",V)))}let x,y;w.winner_id?(x=w.winner_id===a.profile.id,y=!1):w.forfeit?(x=k>f,y=!1):(y=k===f,x=k>f),($=document.getElementById("pvp-end-overlay"))==null||$.remove();const h=document.createElement("div");h.id="pvp-end-overlay",h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":x?"🏆":"😞",_=y?"MATCH NUL":x?"VICTOIRE !":"DÉFAITE",z=y?"#fff":x?"#FFD700":"#ff6b6b";h.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(h),(A=h.querySelector("#pvp-end-home"))==null||A.addEventListener("click",()=>{h.remove(),We(e),p("home")})}const K=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{const k=w.new;try{if(k.status==="finished"||k.forfeit){if(c)return;c=!0,G&&(clearInterval(G),G=null),k.game_state&&(r=k.game_state),j(k);return}if(k.game_state){const f=r;r=k.game_state;const x=r._lastGC;if(x&&x.seq&&!D.has(x.seq)&&(D.add(x.seq),x.by!==n)){we(x.type,x.by,()=>pe());return}const y=f[n+"Score"]||0,h=f[o+"Score"]||0,v=r[n+"Score"]||0,_=r[o+"Score"]||0,z=v>y,$=_>h;if((z||$)&&!B.has(r.round)){B.add(r.round);const A=[...r.log||[]].reverse().find(C=>C.isGoal),S=((A==null?void 0:A.homePlayers)||[]).map(C=>({name:C.name,note:C.note,portrait:C.portrait,job:C.job}));_e(S,v,_,z,()=>pe());return}pe()}}catch(f){console.error("[PvP] crash:",f)}}).subscribe();async function oe(w){Object.assign(r,w),r.lastActionAt=new Date().toISOString();const{error:k}=await E.from("matches").update({game_state:r}).eq("id",i);k&&u("Erreur de synchronisation","error");try{pe()}catch(f){console.error("[PvP] renderPvpScreen crash:",f)}}async function de(){if(c)return;c=!0,G&&(clearInterval(G),G=null);const w=s?g.away_id:g.home_id,k=s?"p2":"p1",f=s?"p1":"p2",x={...r,[k+"Score"]:3,[f+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:w,home_score:x.p1Score||0,away_score:x.p2Score||0,game_state:x}).eq("id",i)}catch{}try{E.removeChannel(K)}catch{}setTimeout(()=>{We(e),p("home")},800)}const N={BOOST_STAT:({value:w=1,count:k=1,roles:f=[]},x,y)=>{const h=x[n+"Team"],v=Object.entries(h).filter(([_])=>!f.length||f.includes(_)).flatMap(([_,z])=>z.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){x.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(x);return}W(v,k,`Choisir ${k} joueur(s) à booster (+${w})`,_=>{_.forEach(z=>{const $=(h[z._line]||[]).find(A=>A.cardId===z.cardId);$&&($.boost=($.boost||0)+w,x.log.push({text:`⚡ +${w} sur ${$.name}`,type:"info"}))}),x[n+"Team"]=h,y(x)})},DEBUFF_STAT:({value:w=1,count:k=1,roles:f=[],target:x="ai"},y,h)=>{const v=x==="home"?n:o,_=y[v+"Team"],z=x==="home"?"allié":"adverse",$=Object.entries(_).filter(([A])=>!f.length||f.includes(A)).flatMap(([A,S])=>S.map(C=>({...C,_line:A})));if(!$.length){y.log.push({text:`🎯 Aucun joueur ${z}`,type:"info"}),h(y);return}W($,k,`Choisir ${k} joueur(s) ${z}(s) (-${w})`,A=>{A.forEach(S=>{const C=(_[S._line]||[]).find(F=>F.cardId===S.cardId);C&&(C.boost=(C.boost||0)-w,y.log.push({text:`🎯 -${w} sur ${C.name}`,type:"info"}))}),y[v+"Team"]=_,h(y)})},GRAY_PLAYER:({count:w=1,roles:k=[],target:f="ai"},x,y)=>{const h=f==="home"?n:o,v=x[h+"Team"],_=f==="home"?"allié":"adverse",z=Object.entries(v).filter(([$])=>!k.length||k.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!z.length){x.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),y(x);return}W(z,w,`Choisir ${w} joueur(s) ${_}(s) à exclure`,$=>{const A="usedCardIds_"+h,S=new Set(x[A]||[]);$.forEach(C=>{const F=(v[C._line]||[]).find(R=>R.cardId===C.cardId);F&&(F.used=!0,S.add(C.cardId),x.log.push({text:`❌ ${F.name} exclu !`,type:"info"}))}),x[A]=[...S],x[h+"Team"]=v,y(x)})},REVIVE_PLAYER:({count:w=1,roles:k=[]},f,x)=>{const y=f[n+"Team"],h=Object.entries(y).filter(([v])=>!k.length||k.includes(v)).flatMap(([v,_])=>_.filter(z=>z.used).map(z=>({...z,_line:v})));if(!h.length){f.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),x(f);return}W(h,w,`Choisir ${w} joueur(s) à ressusciter`,v=>{v.forEach(_=>{const z=(y[_._line]||[]).find($=>$.cardId===_.cardId);z&&(z.used=!1,f.log.push({text:`💫 ${z.name} ressuscité !`,type:"info"}))}),f[n+"Team"]=y,x(f)})},REMOVE_GOAL:({},w,k)=>{const f=o+"Score";w[f]>0?(w[f]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),k(w)},ADD_GOAL_DRAW:({},w,k)=>{w[n+"Score"]===w[o+"Score"]?(w[n+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),k(w)},ADD_SUB:({value:w=1},k,f)=>{k.maxSubs=(k.maxSubs||3)+w,k.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),f(k)},CUSTOM:({},w,k)=>k(w)};function W(w,k,f,x){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let h=[];function v(){var z,$;const _=w.map(A=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",C=je(A,A._line)+(A.boost||0),R=h.find(Q=>Q.cardId===A.cardId)?"#FFD700":"rgba(255,255,255,0.25)",O=A.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${R};background:${S};overflow:hidden;cursor:pointer;${O}">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(C);let F=!1;const R=()=>{F||(F=!0,C.remove(),setTimeout(()=>f&&f(),50))};C.addEventListener("click",R),setTimeout(R,3e3)}function Ae(w,k){var C,F,R,O;const x=(r["gcCardsFull_"+n]||[]).find(Q=>Q.id===w),y=x==null?void 0:x._gcDef,h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",_=(y==null?void 0:y.name)||k,z=(y==null?void 0:y.effect)||((C=Ve[k])==null?void 0:C.desc)||"Carte spéciale.",$=y!=null&&y.image_url?`/manager-wars/icons/${y.image_url}`:null,A=((F=Ve[k])==null?void 0:F.icon)||"⚡",S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(f),(x=f.querySelector("#bp-close"))==null||x.addEventListener("click",()=>f.remove()),f.querySelectorAll(".bp-item").forEach(y=>{y.addEventListener("click",async()=>{const h=y.dataset.cid,v=k.find(z=>z.cardId===h);if(!v)return;const _=(w[v._line]||[]).find(z=>z.cardId===h);_&&(_.boost=(_.boost||0)+r.boostValue),f.remove(),await oe({[n+"Team"]:w,boostUsed:!0})})})}function xe(w=null){var F,R;if(!(r.phase===n+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const f=r[n+"Team"],x=r["usedSubIds_"+n]||[],y=r.maxSubs||3;if(x.length>=y){u(`Maximum ${y} remplacements atteint`,"warning");return}const h=Object.entries(f).flatMap(([O,Q])=>(Q||[]).filter(V=>V.used).map(V=>({...V,_line:O}))),v=(r[n+"Subs"]||[]).filter(O=>!x.includes(O.cardId));if(!h.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!v.length){u("Aucun remplaçant disponible","warning");return}let _=Math.max(0,h.findIndex(O=>O.cardId===w));const z=((F=h[_])==null?void 0:F._line)||((R=h[_])==null?void 0:R.job);let $=Math.max(0,v.findIndex(O=>O.job===z)),A=!1;const S=document.createElement("div");S.id="pvp-sub-overlay",S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function C(){var me,$e,ke,qe,Ce,Re;const O=h[_],Q=v[$],V=Math.min(130,Math.round((window.innerWidth-90)/2)),ie=Math.round(V*1.35),ae=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;S.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(y);let v=!1;const _=()=>{v||(v=!0,y.remove(),setTimeout(()=>f(),50))};y.addEventListener("click",_),setTimeout(_,2200)}function ne(){var k;const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",w.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${r[o+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(r[o+"Team"],r[o+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(w),(k=w.querySelector("#pvp-opp-close"))==null||k.addEventListener("click",()=>w.remove())}function ge(){var x;const w=r.log||[],k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const f=y=>{var v,_,z;if(y.type==="duel"){const $=y.isGoal,A=y.homeScored&&n==="p1"||!y.homeScored&&$&&n==="p2",S=y.homeScored?"#FFD700":$?"#ff6b6b":"rgba(255,255,255,0.3)",C=$?A?"⚽ BUT !":"⚽ BUT adversaire !":(v=y.homePlayers)!=null&&v.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${$?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${S};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild(k),(x=k.querySelector("#pvp-hist-close"))==null||x.addEventListener("click",()=>k.remove())}async function J(){if(r.phase!==n+"-attack")return;const w=n==="p1"?"p2":"p1",k=(r.round||0)+1,f=[...r.log||[]];f.push({type:"info",text:`⏭️ ${r[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const x=be(r),y=Me(w),h=x||!y?"finished":w+"-attack";await oe({["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:h,attacker:w,round:k,log:f}),h==="finished"&&await M(r)}async function Z(){const w=r[n+"Team"],k=!["GK","DEF","MIL","ATT"].some(h=>(r[o+"Team"][h]||[]).some(v=>!v.used)),f=(r["selected_"+n]||[]).map(h=>{const v=(w[h._role]||[]).find(C=>C.cardId===h.cardId)||h,_=k&&["GK","DEF"].includes(h._role),z=w[h._role]||[],$=z.findIndex(C=>C.cardId===h.cardId),A=lt(z.length),S=$>=0?A[$]:v._col??1;return{...v,_line:h._role,_col:S,..._?{note_a:Math.max(1,Number(v.note_a)||0)}:{}}});if(!f.length)return;const x=Nt(f,r.modifiers[n]||{});P(n,f.map(h=>h.cardId)),f.forEach(h=>{const v=(w[h._role]||[]).find(_=>_.cardId===h.cardId);v&&(v.used=!0)}),r["selected_"+n]=[],pe();const y=[...r.log||[]];if(k){const h=(r[n+"Score"]||0)+1,v=f.map(S=>({name:S.name,note:je(S,S._line||"ATT"),portrait:Pe(S),job:S.job}));y.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:v,homeTotal:x.total,aiTotal:0});const _=(r.round||0)+1,z=n==="p1"?"p2":"p1",$={...r,[n+"Team"]:w,[n+"Score"]:h},A=be($);B.add(_),_e(v,h,r[o+"Score"]||0,!0,async()=>{await oe({[n+"Team"]:w,[n+"Score"]:h,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:A?"finished":z+"-attack",attacker:z,round:_,log:y}),A&&await M({...r,[n+"Score"]:h})});return}y.push({type:"pending",text:`⚔️ ${r[n+"Name"]} attaque (${x.total})`}),await oe({[n+"Team"]:w,[o+"Team"]:r[o+"Team"],pendingAttack:{...x,players:f,side:n},["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},phase:o+"-defense",log:y})}async function U(){const w=r[n+"Team"],k=(r["selected_"+n]||[]).map(O=>{const Q=(w[O._role]||[]).find(me=>me.cardId===O.cardId)||O,V=w[O._role]||[],ie=V.findIndex(me=>me.cardId===O.cardId),ae=lt(V.length),fe=ie>=0?ae[ie]:Q._col??1;return{...Q,_line:O._role,_col:fe}}),f=Rt(k,r.modifiers[n]||{});P(n,k.map(O=>O.cardId)),k.forEach(O=>{const Q=(w[O._role]||[]).find(V=>V.cardId===O.cardId);Q&&(Q.used=!0)}),r["selected_"+n]=[],pe();const x=Ot(r.pendingAttack.total,f.total,r.modifiers[n]||{}),y=r.pendingAttack.side,h=x==="attack"||(x==null?void 0:x.goal),v=y==="p1"?"p2":"p1",_=(r.round||0)+1,z=(r.pendingAttack.players||[]).map(O=>({name:O.name,note:je(O,O._line||"ATT"),portrait:Pe(O),job:O.job})),$=[...r.log||[]];$.push({type:"duel",isGoal:h,homeScored:h&&y===n,text:h?`⚽ BUT de ${r[y+"Name"]} ! (${r.pendingAttack.total} vs ${f.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${f.total})`,homePlayers:z,aiPlayers:k.map(O=>({name:O.name,note:je(O,O._line||"DEF"),portrait:Pe(O),job:O.job})),homeTotal:r.pendingAttack.total,aiTotal:f.total});const A=h?(r[y+"Score"]||0)+1:r[y+"Score"]||0,S={...r,[n+"Team"]:w,[y+"Score"]:A},C=be(S),F=C?"finished":v+"-attack",R=async()=>{await oe({[n+"Team"]:w,[o+"Team"]:r[o+"Team"],[y+"Score"]:A,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:F,attacker:v,round:_,log:$}),(F==="finished"||C)&&await M({...r,[y+"Score"]:A})};if(h){const O=y===n,Q=O?A:r[n+"Score"]||0,V=O?r[o+"Score"]||0:A;B.add(_),_e(z,Q,V,O,R)}else await R()}function se(w){return["MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function he(w){return["GK","DEF","MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function Se(w){return he(w)&&!se(w)}function Me(w){const k=r[w+"Team"],f=r[(w==="p1"?"p2":"p1")+"Team"];return!!(se(k)||!he(f)&&Se(k))}function be(w){const k=["MIL","ATT"].some($=>(w.p1Team[$]||[]).some(A=>!A.used)),f=["MIL","ATT"].some($=>(w.p2Team[$]||[]).some(A=>!A.used)),x=he(w.p1Team),y=he(w.p2Team);return!k&&!(!y&&x)&&(!f&&!(!x&&y))}function ze(w){const k=w.p1Score||0,f=w.p2Score||0;return k===f?null:k>f?g.home_id:g.away_id}async function M(w){try{const k=ze(w),f=k?g.home_id===k?g.away_id:g.home_id:null;await E.from("matches").update({status:"finished",winner_id:k,home_score:w.p1Score||0,away_score:w.p2Score||0}).eq("id",i),k&&f&&ki(k,f).catch(()=>{})}catch(k){console.error("[PvP] finishMatch:",k)}}function q(){var y;const w=r[n+"Score"],k=r[o+"Score"],f=w>k,x=w===k;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  </div>`,(I=document.getElementById("ml-create-btn"))==null||I.addEventListener("click",()=>er(e,t)),e.querySelectorAll(".ml-tab").forEach(L=>L.addEventListener("click",()=>_t(e,t,L.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(L=>L.addEventListener("click",()=>bt(e,t,L.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(L=>L.addEventListener("click",G=>{G.stopPropagation(),ko(e,t,L.dataset.join,L.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(L=>L.addEventListener("click",G=>{G.stopPropagation(),yi(e,t,L.dataset.delete,L.dataset.name,i)}))}function ei(e,t,i=!1){var a,p;const s=e.creator_id===t,l=e.pot||0,d=((p=(a=e.mini_league_members)==null?void 0:a[0])==null?void 0:p.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((H,P)=>{const re=T>0&&a.status==="finished"?P===0?Math.floor(T*.7):P===1?Math.floor(T*.2):P===2?Math.floor(T*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${H.userId===d?"background:#f0fdf4;":""}">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(H,P)=>P+1).reverse().map(H=>{const P=(u||[]).filter(re=>re.matchday===H);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${H}</div>${P.map(re=>Oi(re,m,d,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const G=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((Y=document.getElementById("ml-back"))==null||Y.addEventListener("click",()=>_t(e,t,G)),(B=document.getElementById("ml-start-btn"))==null||B.addEventListener("click",()=>nr(e,t,a,m)),(D=document.getElementById("ml-next-day"))==null||D.addEventListener("click",()=>rr(e,t,i)),(j=document.getElementById("ml-finish-btn"))==null||j.addEventListener("click",()=>Eo(e,t,i,T,b,m)),(K=document.getElementById("ml-join-now"))==null||K.addEventListener("click",()=>ko(e,t,i,a.type)),(oe=document.getElementById("ml-leave-btn"))==null||oe.addEventListener("click",()=>ir(e,t,i,r)),(de=document.getElementById("ml-delete-btn"))==null||de.addEventListener("click",()=>yi(e,t,i,a.name,"waiting")),(N=document.getElementById("ml-delete-now"))==null||N.addEventListener("click",()=>yi(e,t,i,a.name,G)),(W=document.getElementById("ml-archive-btn"))==null||W.addEventListener("click",()=>or(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(H=>{H.addEventListener("click",()=>{const P=g.find(re=>re.id===H.dataset.playMatch);P&&t.navigate("match-mini-league",{mlMatchId:P.id,leagueId:i})})}),a.status==="finished"&&L){const H=b.findIndex(P=>P.userId===d);H>=0&&H<3&&L.prize_amount>0&&setTimeout(()=>ar(e,t,a,L,H),400)}}function Oi(e,t,i,s,l=!1){const d=m=>t.find(b=>b.id===m);if(e.is_bye){const m=d(e.home_id);return`<div style="padding:8px;border-radius:8px;background:#f9f9f9;margin-bottom:6px;font-size:12px;color:#888;text-align:center">🔵 ${(m==null?void 0:m.club_name)||(m==null?void 0:m.pseudo)||"?"} exempté(e)</div>`}const a=d(e.home_id),p=d(e.away_id),u=e.home_id===i||e.away_id===i,n=u&&e.status==="pending"&&s&&!l,o=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${u?"#f0fdf4":"#f9f9f9"};margin-bottom:6px;border:1px solid ${u?"#86efac":"#f0f0f0"}">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:20px;background:linear-gradient(180deg,#0a1628,#1a0a2e);padding:24px;text-align:center;color:#fff">
        ...
        <button id="lobby-cancel" style="padding:10px 24px;border-radius:10px;border:1.5px solid rgba(255,255,255,0.2);background:transparent;color:rgba(255,255,255,0.6);font-size:13px;cursor:pointer">Annuler</button>
        <style>@keyframes lobbyPulse{0%,100%{opacity:1}50%{opacity:0.4}}</style>
      </div>`,(K=document.getElementById("lobby-cancel"))==null||K.addEventListener("click",()=>{T=!0,clearInterval(r),We(e),m("mini-league")})},B=async(D,j)=>{T=!0,clearInterval(r),await new Promise(K=>setTimeout(K,600)),e.isConnected&&lr(e,t,D,j,a,p)};if(Y(),I){let D=c.match_id;if(!D){const{data:K,error:oe}=await E.from("matches").insert({home_id:g,away_id:G,home_deck_id:i,away_deck_id:null,status:"active",mode:"mini_league"}).select().single();if(oe||!K){b("Erreur création match","error"),We(e),m("mini-league");return}D=K.id,await E.from("mini_league_matches").update({match_id:D,status:"playing"}).eq("id",u)}const j=D;r=setInterval(async()=>{if(T){clearInterval(r);return}const{data:K}=await E.from("matches").select("away_deck_id").eq("id",j).single();K!=null&&K.away_deck_id&&(clearInterval(r),B(j,!0))},1500)}else{let D=c.match_id;r=setInterval(async()=>{if(T){clearInterval(r);return}const{data:j}=await E.from("mini_league_matches").select("match_id").eq("id",u).single();j!=null&&j.match_id&&(clearInterval(r),D=j.match_id,await E.from("matches").update({away_deck_id:i}).eq("id",D),B(D,!1))},1500)}}async function lr(e,t,i,s,l=[],d=[]){var k;const{state:a,navigate:p,toast:u}=t,n=((k=a.params)==null?void 0:k.leagueId)||null,o=s?"p1":"p2",m=s?"p2":"p1",b=(l||[]).map(f=>f.id),g=(l||[]).map(f=>({id:f.id,gc_type:f.gc_type,_gcDef:f._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:T}=await E.from("matches").select("*").eq("id",i).single();if(!T){u("Match introuvable","error"),p("mini-league");return}async function r(){const[{data:f},{data:x},{data:y},{data:h}]=await Promise.all([E.rpc("get_deck_for_match",{p_deck_id:T.home_deck_id}),E.rpc("get_deck_for_match",{p_deck_id:T.away_deck_id}),E.from("users").select("id,pseudo,club_name").eq("id",T.home_id).single(),E.from("users").select("id,pseudo,club_name").eq("id",T.away_id).single()]),v=S=>{const C=Number(S.evolution_bonus)||0;return{cardId:S.card_id,position:S.position,id:S.id,firstname:S.firstname,name:S.surname_encoded,country_code:S.country_code,club_id:S.club_id,job:S.job,job2:S.job2,note_g:(Number(S.note_g)||0)+(S.job==="GK"||S.job2==="GK"&&Number(S.note_g)>0?C:0),note_d:(Number(S.note_d)||0)+(S.job==="DEF"||S.job2==="DEF"&&Number(S.note_d)>0?C:0),note_m:(Number(S.note_m)||0)+(S.job==="MIL"||S.job2==="MIL"&&Number(S.note_m)>0?C:0),note_a:(Number(S.note_a)||0)+(S.job==="ATT"||S.job2==="ATT"&&Number(S.note_a)>0?C:0),evolution_bonus:C,rarity:S.rarity,skin:S.skin,hair:S.hair,hair_length:S.hair_length,clubName:S.club_encoded_name||null,clubLogo:S.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},_=((f==null?void 0:f.starters)||[]).map(S=>v(S)),z=((x==null?void 0:x.starters)||[]).map(S=>v(S)),$=(f==null?void 0:f.formation)||"4-4-2",A=(x==null?void 0:x.formation)||"4-4-2";return{p1Team:(()=>{const S=yt(_,$);return stadiumDef?Ht(S,stadiumDef):S})(),p2Team:yt(z,A),p1Subs:(()=>{const S=((f==null?void 0:f.subs)||[]).map(C=>v(C));return stadiumDef&&oi(S,stadiumDef),S})(),p2Subs:((x==null?void 0:x.subs)||[]).map(S=>v(S)),p1Formation:$,p2Formation:A,p1Name:(y==null?void 0:y.club_name)||(y==null?void 0:y.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?b:[],gc_p2:s?[]:b,gcCardsFull_p1:s?g:[],gcCardsFull_p2:s?[]:g,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let c=T.game_state&&Object.keys(T.game_state).length?T.game_state:null;if(!c)if(s){c=await r();const{data:f}=await E.from("matches").select("game_state").eq("id",i).single();!(f!=null&&f.game_state)||!Object.keys(f.game_state).length?await E.from("matches").update({game_state:c,turn_user_id:T.home_id}).eq("id",i):c=f.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let f=0;f<60&&!c;f++){await new Promise(y=>setTimeout(y,400));const{data:x}=await E.from("matches").select("game_state").eq("id",i).single();x!=null&&x.game_state&&Object.keys(x.game_state).length&&(c=x.game_state)}if(!c){u("Erreur de synchronisation","error"),p("mini-league");return}c.gc_p2=b,c.gcCardsFull_p2=g,await E.from("matches").update({game_state:c}).eq("id",i)}let I=!1,L=!1,G=!1,Y=null,B=!1;const D=new Set,j=new Set;function K(f){var S,C;try{E.removeChannel(oe)}catch{}const x=c[o+"Score"]||0,y=c[m+"Score"]||0;if(!G){G=!0;const F=f.winner_id||(x>y?a.profile.id:y>x?"opp":null),R=F===a.profile.id?"win":F?"loss":null;R&&ti(()=>Promise.resolve().then(()=>no),void 0).then(O=>O.applyOwnEvolution(a.profile.id,R)).catch(()=>{})}if(!L){const F=c.p1Score||0,R=c.p2Score||0,O=(c.usedGc_p1||[]).length,Q=(c.usedGc_p2||[]).length,V=f.winner_id||(F>R?T.home_id:R>F?T.away_id:null);(V?a.profile.id===V:a.profile.id<(s?T.away_id:T.home_id))&&(L=!0,Zi({player1Id:T.home_id,player2Id:T.away_id,score1:F,score2:R,gc1:O,gc2:Q}).catch(ae=>console.warn("[FriendMatch] updateStats:",ae)))}let h,v;f.winner_id?(h=f.winner_id===a.profile.id,v=!1):f.forfeit?(h=x>y,v=!1):(v=x===y,h=x>y),(S=document.getElementById("pvp-end-overlay"))==null||S.remove();const _=document.createElement("div");_.id="pvp-end-overlay",_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const z=v?"🤝":h?"🏆":"😞",$=v?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",A=v?"#fff":h?"#FFD700":"#ff6b6b";_.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(_),(C=_.querySelector("#pvp-end-home"))==null||C.addEventListener("click",()=>{_.remove(),We(e),n?p("mini-league",{openLeagueId:n}):p("mini-league")})}const oe=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},f=>{const x=f.new;try{if(x.status==="finished"||x.forfeit){if(I||(I=!0,Y&&(clearInterval(Y),Y=null),x.game_state&&(c=x.game_state),c.phase==="finished"&&!x.forfeit&&document.getElementById("pvp-home")))return;K(x);return}if(x.game_state){const y=c;c=x.game_state;const h=c._lastGC;if(h&&h.seq&&!j.has(h.seq)&&(j.add(h.seq),h.by!==o)){Ae(h.type,h.by,()=>ye());return}const v=y[o+"Score"]||0,_=y[m+"Score"]||0,z=c[o+"Score"]||0,$=c[m+"Score"]||0,A=z>v,S=$>_;if((A||S)&&!D.has(c.round)){D.add(c.round);const C=[...c.log||[]].reverse().find(R=>R.isGoal),F=((C==null?void 0:C.homePlayers)||[]).map(R=>({name:R.name,note:R.note,portrait:R.portrait,job:R.job}));we(F,z,$,A,()=>ye());return}ye()}}catch(y){console.error("[PvP] crash:",y)}}).subscribe();async function de(f){Object.assign(c,f),c.lastActionAt=new Date().toISOString();const{error:x}=await E.from("matches").update({game_state:c}).eq("id",i);x&&u("Erreur de synchronisation","error");try{ye()}catch(y){console.error("[PvP] renderPvpScreen crash:",y)}}async function N(){if(I)return;I=!0,Y&&(clearInterval(Y),Y=null);const f=s?T.away_id:T.home_id,x=s?"p2":"p1",y=s?"p1":"p2",h={...c,[x+"Score"]:3,[y+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:f,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",i)}catch{}try{E.removeChannel(oe)}catch{}setTimeout(()=>{We(e),p("mini-league")},800)}const W={BOOST_STAT:({value:f=1,count:x=1,roles:y=[]},h,v)=>{const _=h[o+"Team"],z=Object.entries(_).filter(([$])=>!y.length||y.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!z.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(h);return}H(z,x,`Choisir ${x} joueur(s) à booster (+${f})`,$=>{$.forEach(A=>{const S=(_[A._line]||[]).find(C=>C.cardId===A.cardId);S&&(S.boost=(S.boost||0)+f,h.log.push({text:`⚡ +${f} sur ${S.name}`,type:"info"}))}),h[o+"Team"]=_,v(h)})},DEBUFF_STAT:({value:f=1,count:x=1,roles:y=[],target:h="ai"},v,_)=>{const z=h==="home"?o:m,$=v[z+"Team"],A=h==="home"?"allié":"adverse",S=Object.entries($).filter(([C])=>!y.length||y.includes(C)).flatMap(([C,F])=>F.map(R=>({...R,_line:C})));if(!S.length){v.log.push({text:`🎯 Aucun joueur ${A}`,type:"info"}),_(v);return}H(S,x,`Choisir ${x} joueur(s) ${A}(s) (-${f})`,C=>{C.forEach(F=>{const R=($[F._line]||[]).find(O=>O.cardId===F.cardId);R&&(R.boost=(R.boost||0)-f,v.log.push({text:`🎯 -${f} sur ${R.name}`,type:"info"}))}),v[z+"Team"]=$,_(v)})},GRAY_PLAYER:({count:f=1,roles:x=[],target:y="ai"},h,v)=>{const _=y==="home"?o:m,z=h[_+"Team"],$=y==="home"?"allié":"adverse",A=Object.entries(z).filter(([S])=>!x.length||x.includes(S)).flatMap(([S,C])=>C.filter(F=>!F.used).map(F=>({...F,_line:S})));if(!A.length){h.log.push({text:`❌ Aucun joueur ${$}`,type:"info"}),v(h);return}H(A,f,`Choisir ${f} joueur(s) ${$}(s) à exclure`,S=>{const C="usedCardIds_"+_,F=new Set(h[C]||[]);S.forEach(R=>{const O=(z[R._line]||[]).find(Q=>Q.cardId===R.cardId);O&&(O.used=!0,F.add(R.cardId),h.log.push({text:`❌ ${O.name} exclu !`,type:"info"}))}),h[C]=[...F],h[_+"Team"]=z,v(h)})},REVIVE_PLAYER:({count:f=1,roles:x=[]},y,h)=>{const v=y[o+"Team"],_=Object.entries(v).filter(([z])=>!x.length||x.includes(z)).flatMap(([z,$])=>$.filter(A=>A.used).map(A=>({...A,_line:z})));if(!_.length){y.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(y);return}H(_,f,`Choisir ${f} joueur(s) à ressusciter`,z=>{z.forEach($=>{const A=(v[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.used=!1,y.log.push({text:`💫 ${A.name} ressuscité !`,type:"info"}))}),y[o+"Team"]=v,h(y)})},REMOVE_GOAL:({},f,x)=>{const y=m+"Score";f[y]>0?(f[y]--,f.log.push({text:"🚫 Dernier but annulé !",type:"info"})):f.log.push({text:"🚫 Aucun but à annuler",type:"info"}),x(f)},ADD_GOAL_DRAW:({},f,x)=>{f[o+"Score"]===f[m+"Score"]?(f[o+"Score"]++,f.log.push({text:"🎯 But bonus !",type:"info"})):f.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),x(f)},ADD_SUB:({value:f=1},x,y)=>{x.maxSubs=(x.maxSubs||3)+f,x.log.push({text:`🔄 +${f} remplacement(s)`,type:"info"}),y(x)},CUSTOM:({},f,x)=>x(f)};function H(f,x,y,h){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let _=[];function z(){var A,S;const $=f.map(C=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[C._line]||"#555",R=je(C,C._line)+(C.boost||0),Q=_.find(ie=>ie.cardId===C.cardId)?"#FFD700":"rgba(255,255,255,0.25)",V=C.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${C.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Q};background:${F};overflow:hidden;cursor:pointer;${V}">
        ...
        </div>`,(A=v.querySelector("#pp-close"))==null||A.addEventListener("click",()=>v.remove()),v.querySelectorAll(".pp-item").forEach(C=>{C.addEventListener("click",()=>{const F=C.dataset.cid,R=f.find(Q=>Q.cardId===F),O=_.findIndex(Q=>Q.cardId===F);R&&(O>-1?_.splice(O,1):_.length<x&&_.push(R),z())})}),(S=v.querySelector("#pp-confirm"))==null||S.addEventListener("click",()=>{v.remove(),h(_)})}z(),document.body.appendChild(v)}async function P(f,x){const h=(c["gcCardsFull_"+o]||[]).find($=>$.id===f),v=(h==null?void 0:h._gcDef)||(c.gcDefs||[]).find($=>{var A;return $.name===x||((A=$.name)==null?void 0:A.toLowerCase().trim())===(x==null?void 0:x.toLowerCase().trim())}),_=[...c["usedGc_"+o]||[],f],z={type:x,by:o,seq:(c._gcAnimSeq||0)+1};j.add(z.seq),Ae(x,o,async()=>{if(v!=null&&v.effect_type&&v.effect_type!=="CUSTOM"){const A=W[v.effect_type];if(A){const S={...c};A(v.effect_params||{},S,async C=>{C["usedGc_"+o]=_,C._lastGC=z,C._gcAnimSeq=z.seq,await de(C)});return}}const $={...c};switch(x){case"Remplacement+":$.maxSubs=($.maxSubs||3)+1,$.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const A=m+"Score";$[A]>0&&($[A]--,$.log.push({text:"🚫 But annulé",type:"info"}));break}}$["usedGc_"+o]=_,$._lastGC=z,$._gcAnimSeq=z.seq,await de($)})}function re(f,x){const y="usedCardIds_"+f,h=new Set(c[y]||[]);x.forEach(v=>h.add(v)),c[y]=[...h]}function pe(){for(const f of["p1","p2"]){const x=new Set(c["usedCardIds_"+f]||[]),y=c[f+"Team"];if(y)for(const h of["GK","DEF","MIL","ATT"])(y[h]||[]).forEach(v=>{v.used=x.has(v.cardId)})}}function ye(){var nt,gt,le,Ee,te,ue;if(c.phase==="reveal")return Le();if(c.phase==="midfield")return _e();if(c.phase==="finished")return w();const f=c[o+"Team"],x=c[m+"Team"];pe();const y=c[o+"Score"],h=c[m+"Score"],v=c[o+"Name"],_=c[m+"Name"],z=c.phase===o+"-attack",$=c.phase===o+"-defense",A=Array.isArray(c["selected_"+o])?c["selected_"+o]:[],S=A.map(ee=>ee.cardId),C=window.innerWidth>=700,F=c[o+"Subs"]||[],R=c["usedSubIds_"+o]||[],O=F.filter(ee=>!R.includes(ee.cardId)),Q=c["gcCardsFull_"+o]||[],V=c["usedGc_"+o]||[],ie=Q.filter(ee=>!V.includes(ee.id)),ae=c.boostOwner===o&&!c.boostUsed,fe=!["GK","DEF","MIL","ATT"].some(ee=>(x[ee]||[]).some(ce=>!ce.used)),me=[...f.MIL||[],...f.ATT||[]].filter(ee=>!ee.used),$e=z&&fe&&me.length===0?[...f.GK||[],...f.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function ke(ee,ce,Be){var Si,Li;const Te=ee._gcDef,tt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[Te==null?void 0:Te.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",it={purple:"#b06ce0",light_blue:"#00d4ef"}[Te==null?void 0:Te.color]||"#b06ce0",rt=(Te==null?void 0:Te.name)||ee.gc_type,st=(Te==null?void 0:Te.effect)||((Si=Ve[ee.gc_type])==null?void 0:Si.desc)||"",ct=Te!=null&&Te.image_url?`/manager-wars/icons/${Te.image_url}`:null,$t=((Li=Ve[ee.gc_type])==null?void 0:Li.icon)||"⚡",pt=Math.round(Be*.22),ht=Math.round(Be*.22),kt=Be-pt-ht,Ut=rt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(f,c[o+"Formation"],Ne,S,300,300,$e)}
      </div>
    ...
    </div>`,o==="p1"&&setTimeout(async()=>{await de({phase:"midfield"})},5e3)}let ve=!1;function _e(){if(ve)return;const f=c[o+"Team"].MIL||[],x=c[m+"Team"].MIL||[];function y(ie){return ie.reduce((ae,fe)=>ae+je(fe,"MIL"),0)}function h(ie){let ae=0;for(let fe=0;fe<ie.length-1;fe++){const me=at(ie[fe],ie[fe+1]);me==="#00ff88"?ae+=2:me==="#FFD700"&&(ae+=1)}return ae}const v=y(f)+h(f),_=y(x)+h(x),z=v>=_;function $(ie,ae,fe){return`<div id="duel-row-${fe}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let A=!1;const S=()=>{A||(A=!0,_.remove(),setTimeout(()=>v(),50))};_.addEventListener("click",S),setTimeout(S,3500)}function Ae(f,x,y){var V,ie;const h=(c.gcDefs||[]).find(ae=>{var fe;return ae.name===f||((fe=ae.name)==null?void 0:fe.toLowerCase().trim())===(f==null?void 0:f.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",z=(h==null?void 0:h.name)||f,$=(h==null?void 0:h.effect)||((V=Ve[f])==null?void 0:V.desc)||"",A=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,S=((ie=Ve[f])==null?void 0:ie.icon)||"⚡",F=x===o?"Vous":c[x+"Name"]||"Adversaire",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",R.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(R);let O=!1;const Q=()=>{O||(O=!0,R.remove(),setTimeout(()=>y&&y(),50))};R.addEventListener("click",Q),setTimeout(Q,3e3)}function Ie(f,x){var R,O,Q,V;const h=(c["gcCardsFull_"+o]||[]).find(ie=>ie.id===f),v=h==null?void 0:h._gcDef,_={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",z={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",$=(v==null?void 0:v.name)||x,A=(v==null?void 0:v.effect)||((R=Ve[x])==null?void 0:R.desc)||"Carte spéciale.",S=v!=null&&v.image_url?`/manager-wars/icons/${v.image_url}`:null,C=((O=Ve[x])==null?void 0:O.icon)||"⚡",F=document.createElement("div");F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",F.innerHTML=`
      ...
      </div>`,document.body.appendChild(y),(h=y.querySelector("#bp-close"))==null||h.addEventListener("click",()=>y.remove()),y.querySelectorAll(".bp-item").forEach(v=>{v.addEventListener("click",async()=>{const _=v.dataset.cid,z=x.find(A=>A.cardId===_);if(!z)return;const $=(f[z._line]||[]).find(A=>A.cardId===_);$&&($.boost=($.boost||0)+c.boostValue),y.remove(),await de({[o+"Team"]:f,boostUsed:!0})})})}function X(f=null){var O,Q;if(!(c.phase===o+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const y=c[o+"Team"],h=c["usedSubIds_"+o]||[],v=c.maxSubs||3;if(h.length>=v){u(`Maximum ${v} remplacements atteint`,"warning");return}const _=Object.entries(y).flatMap(([V,ie])=>(ie||[]).filter(ae=>ae.used).map(ae=>({...ae,_line:V}))),z=(c[o+"Subs"]||[]).filter(V=>!h.includes(V.cardId));if(!_.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!z.length){u("Aucun remplaçant disponible","warning");return}let $=Math.max(0,_.findIndex(V=>V.cardId===f));const A=((O=_[$])==null?void 0:O._line)||((Q=_[$])==null?void 0:Q.job);let S=Math.max(0,z.findIndex(V=>V.job===A)),C=!1;const F=document.createElement("div");F.id="pvp-sub-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function R(){var ke,qe,Ce,Re,Fe,Oe;const V=_[$],ie=z[S],ae=Math.min(130,Math.round((window.innerWidth-90)/2)),fe=Math.round(ae*1.35),me=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;F.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,document.body.appendChild(x),(h=x.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>x.remove())}async function Z(){if(c.phase!==o+"-attack")return;const f=o==="p1"?"p2":"p1",x=(c.round||0)+1,y=[...c.log||[]];y.push({type:"info",text:`⏭️ ${c[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const h=ze(c),v=be(f),_=h||!v?"finished":f+"-attack";await de({["selected_"+o]:[],modifiers:{...c.modifiers,[o]:{}},pendingAttack:null,phase:_,attacker:f,round:x,log:y}),_==="finished"&&await q(c)}async function U(){const f=c[o+"Team"],x=!["GK","DEF","MIL","ATT"].some(_=>(c[m+"Team"][_]||[]).some(z=>!z.used)),y=(c["selected_"+o]||[]).map(_=>{const z=(f[_._role]||[]).find(R=>R.cardId===_.cardId)||_,$=x&&["GK","DEF"].includes(_._role),A=f[_._role]||[],S=A.findIndex(R=>R.cardId===_.cardId),C=lt(A.length),F=S>=0?C[S]:z._col??1;return{...z,_line:_._role,_col:F,...$?{note_a:Math.max(1,Number(z.note_a)||0)}:{}}});if(!y.length)return;const h=Nt(y,c.modifiers[o]||{});re(o,y.map(_=>_.cardId)),y.forEach(_=>{const z=(f[_._role]||[]).find($=>$.cardId===_.cardId);z&&(z.used=!0)}),c["selected_"+o]=[],ye();const v=[...c.log||[]];if(x){const _=(c[o+"Score"]||0)+1,z=y.map(F=>({name:F.name,note:je(F,F._line||"ATT"),portrait:Pe(F),job:F.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:z,homeTotal:h.total,aiTotal:0});const $=(c.round||0)+1,A=o==="p1"?"p2":"p1",S={...c,[o+"Team"]:f,[o+"Score"]:_},C=ze(S);D.add($),we(z,_,c[m+"Score"]||0,!0,async()=>{await de({[o+"Team"]:f,[o+"Score"]:_,["selected_"+o]:[],modifiers:{...c.modifiers,[o]:{}},pendingAttack:null,phase:C?"finished":A+"-attack",attacker:A,round:$,log:v}),C&&await q({...c,[o+"Score"]:_})});return}v.push({type:"pending",text:`⚔️ ${c[o+"Name"]} attaque (${h.total})`}),await de({[o+"Team"]:f,[m+"Team"]:c[m+"Team"],pendingAttack:{...h,players:y,side:o},["selected_"+o]:[],modifiers:{...c.modifiers,[o]:{}},phase:m+"-defense",log:v})}async function se(){const f=c[o+"Team"],x=(c["selected_"+o]||[]).map(V=>{const ie=(f[V._role]||[]).find(ke=>ke.cardId===V.cardId)||V,ae=f[V._role]||[],fe=ae.findIndex(ke=>ke.cardId===V.cardId),me=lt(ae.length),$e=fe>=0?me[fe]:ie._col??1;return{...ie,_line:V._role,_col:$e}}),y=Rt(x,c.modifiers[o]||{});re(o,x.map(V=>V.cardId)),x.forEach(V=>{const ie=(f[V._role]||[]).find(ae=>ae.cardId===V.cardId);ie&&(ie.used=!0)}),c["selected_"+o]=[],ye();const h=Ot(c.pendingAttack.total,y.total,c.modifiers[o]||{}),v=c.pendingAttack.side,_=h==="attack"||(h==null?void 0:h.goal),z=v==="p1"?"p2":"p1",$=(c.round||0)+1,A=(c.pendingAttack.players||[]).map(V=>({name:V.name,note:je(V,V._line||"ATT"),portrait:Pe(V),job:V.job})),S=[...c.log||[]];S.push({type:"duel",isGoal:_,homeScored:_&&v===o,text:_?`⚽ BUT de ${c[v+"Name"]} ! (${c.pendingAttack.total} vs ${y.total})`:`✋ Attaque stoppée (${c.pendingAttack.total} vs ${y.total})`,homePlayers:A,aiPlayers:x.map(V=>({name:V.name,note:je(V,V._line||"DEF"),portrait:Pe(V),job:V.job})),homeTotal:c.pendingAttack.total,aiTotal:y.total});const C=_?(c[v+"Score"]||0)+1:c[v+"Score"]||0,F={...c,[o+"Team"]:f,[v+"Score"]:C},R=ze(F),O=R?"finished":z+"-attack",Q=async()=>{await de({[o+"Team"]:f,[m+"Team"]:c[m+"Team"],[v+"Score"]:C,["selected_"+o]:[],modifiers:{...c.modifiers,[o]:{}},pendingAttack:null,phase:O,attacker:z,round:$,log:S}),(O==="finished"||R)&&await q({...c,[v+"Score"]:C})};if(_){const V=v===o,ie=V?C:c[o+"Score"]||0,ae=V?c[m+"Score"]||0:C;D.add($),we(A,ie,ae,V,Q)}else await Q()}function he(f){return["MIL","ATT"].some(x=>(f[x]||[]).some(y=>!y.used))}function Se(f){return["GK","DEF","MIL","ATT"].some(x=>(f[x]||[]).some(y=>!y.used))}function Me(f){return Se(f)&&!he(f)}function be(f){const x=c[f+"Team"],y=c[(f==="p1"?"p2":"p1")+"Team"];return!!(he(x)||!Se(y)&&Me(x))}function ze(f){const x=["MIL","ATT"].some(S=>(f.p1Team[S]||[]).some(C=>!C.used)),y=["MIL","ATT"].some(S=>(f.p2Team[S]||[]).some(C=>!C.used)),h=Se(f.p1Team),v=Se(f.p2Team);return!x&&!(!v&&h)&&(!y&&!(!h&&v))}function M(f){const x=f.p1Score||0,y=f.p2Score||0;return x===y?null:x>y?T.home_id:T.away_id}async function q(f){try{const x=M(f),y=x?T.home_id===x?T.away_id:T.home_id:null,h=f.p1Score||0,v=f.p2Score||0;await E.from("matches").update({status:"finished",winner_id:x,home_score:h,away_score:v}).eq("id",i);const{data:_}=await E.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(_){await E.from("mini_league_matches").update({home_score:h,away_score:v,status:"finished"}).eq("id",_.id);const{data:z}=await E.from("mini_league_matches").select("id, status").eq("league_id",_.league_id).eq("matchday",_.matchday);if((z||[]).every(A=>A.status==="finished"||A.status==="bye")){const{data:A}=await E.from("mini_leagues").select("current_day,total_days").eq("id",_.league_id).single();if(A){const S=(A.current_day||0)+1,C=S>(A.total_days||0);await E.from("mini_leagues").update({current_day:C?A.total_days:S,status:C?"finished":"active"}).eq("id",_.league_id)}}}x&&y&&ki(x,y).catch(()=>{})}catch(x){console.error("[ML] finishMatch:",x)}}function w(){var v;if(I&&document.getElementById("pvp-end-overlay"))return;I=!0;const f=c[o+"Score"],x=c[m+"Score"],y=f>x,h=f===x;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(v=document.getElementById("pvp-home"))==null||v.addEventListener("click",()=>{try{E.removeChannel(oe)}catch{}We(e),p("mini-league",n?{openLeagueId:n}:{})})}ye()}const cr="/manager-wars/",pr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ur(e,t,i){let s=0;const l=document.createElement("div");l.id="tutorial-overlay",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const d=()=>{var o,m,b;const p=t[s],u=s===t.length-1,n=Math.round((s+1)/t.length*100);l.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let u="buy";const n=()=>{var r,c,I,L,G,Y,B;return{name:(((r=document.getElementById("flt-name"))==null?void 0:r.value)||"").toLowerCase().trim(),club:(((c=document.getElementById("flt-club"))==null?void 0:c.value)||"").toLowerCase().trim(),country:(((I=document.getElementById("flt-country"))==null?void 0:I.value)||"").toLowerCase().trim(),job:((L=document.getElementById("flt-job"))==null?void 0:L.value)||"",rarity:((G=document.getElementById("flt-rarity"))==null?void 0:G.value)||"",note1:parseInt((Y=document.getElementById("flt-note1"))==null?void 0:Y.value)||0,note2:parseInt((B=document.getElementById("flt-note2"))==null?void 0:B.value)||0}};function o(r){const c=n();return r.filter(I=>{var K,oe;const L=(K=I.card)==null?void 0:K.player;if(!L)return!1;const G=`${L.firstname} ${L.surname_encoded}`.toLowerCase(),Y=(((oe=L.clubs)==null?void 0:oe.encoded_name)||"").toLowerCase(),B=(L.country_code||"").toLowerCase(),D=Et(L,L.job),j=L.job2?Et(L,L.job2):0;return!(c.name&&!G.includes(c.name)||c.club&&!Y.includes(c.club)||c.country&&!B.includes(c.country)||c.job&&L.job!==c.job||c.rarity&&L.rarity!==c.rarity||c.note1&&D<c.note1||c.note2&&j<c.note2)})}function m(r){var B,D,j,K;const c=(B=r.card)==null?void 0:B.player;if(!c)return"";const I=((D=r.card)==null?void 0:D.evolution_bonus)||0,L=Et(c,c.job,I),G=c.job2?Et(c,c.job2,I):0,Y=(i.profile.credits||0)>=r.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ui(c.rarity)}
      ${Wt(L,c.job)}
      ${Wt(G,c.job2||null)}
      ${Ki(c.country_code)}
      ${Vi((j=c.clubs)==null?void 0:j.logo_url)}
      <div style="flex:1;min-width:0">
    ...
    </div>`}function b(r){var B,D,j,K;const c=(B=r.card)==null?void 0:B.player;if(!c)return"";const I=((D=r.card)==null?void 0:D.evolution_bonus)||0,L=Et(c,c.job,I),G=c.job2?Et(c,c.job2,I):0,Y=r.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${Y?"opacity:0.7":""}">
      ${Ui(c.rarity)}
      ${Wt(L,c.job)}
      ${Wt(G,c.job2||null)}
      ${Ki(c.country_code)}
    ...
    </div>`}function g(){const r=document.getElementById("mkt-content"),c=document.getElementById("mkt-filters");if(r){if(c.style.display=u==="buy"?"flex":"none",u==="buy"){const I=o(a);r.innerHTML=I.length?I.map(m).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const I=p.filter(G=>G.status==="active").sort((G,Y)=>new Date(Y.listed_at)-new Date(G.listed_at)),L=p.filter(G=>G.status==="sold").sort((G,Y)=>new Date(Y.sold_at||Y.listed_at)-new Date(G.sold_at||G.listed_at));r.innerHTML=(I.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${I.length})</div>`+I.map(b).join(""):"")+(L.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${L.length})</div>`+L.map(b).join(""):"")+(!I.length&&!L.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}r.querySelectorAll("[data-buy]").forEach(I=>I.addEventListener("click",()=>xr(I.dataset.buy,a,e,t))),r.querySelectorAll("[data-cancel]").forEach(I=>I.addEventListener("click",()=>br(I.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(r=>{r.addEventListener("click",()=>{u=r.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(c=>{const I=c===r;c.style.background=I?"var(--green)":"#fff",c.style.color=I?"#fff":"var(--gray-600)",c.style.borderColor=I?"var(--green)":"var(--gray-200)"}),g()})});let T;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(r=>{var c;(c=document.getElementById(r))==null||c.addEventListener("input",()=>{clearTimeout(T),T=setTimeout(g,250)})}),g()}async function xr(e,t,i,s){const{state:l,toast:d,refreshProfile:a}=s,p=t.find(o=>o.id===e);if(!p)return;const u=p.price;if((l.profile.credits||0)<u){d("Crédits insuffisants","error");return}yr(p,async()=>{const{error:o}=await E.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:l.profile.id});if(o){d("Erreur achat : "+o.message,"error");return}await a();const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(l.profile.credits||0).toLocaleString("fr")}`),d("✅ Carte achetée !","success"),await zi(i,s)})}function yr(e,t){var a;const i=(a=e.card)==null?void 0:a.player,s=i?`${i.firstname} ${i.surname_encoded}`:"cette carte",l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",l.innerHTML=`
  ...
  `}async function vr(e,{state:t,navigate:i,toast:s}){const l=t.profile;if(!l)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await E.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      ...
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${l.id},away_id.eq.${l.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},p=(d||[]).filter(o=>o.status==="finished"),u=(d||[]).filter(o=>o.status==="in_progress");function n(o){const m=o.home_id===l.id;m?o.home_score:o.away_score,m?o.away_score:o.home_score;const b=o.winner_id===l.id,g=o.home_score===o.away_score&&o.status==="finished",T=o.status!=="finished"?"…":g?"N":b?"V":"D",r=o.status!=="finished"||g?"#888":b?"#1A6B3C":"#c0392b";let c=a[o.mode]||o.mode;o.away_id===null&&!c.startsWith("IA")&&(c="IA");const L=o.home_id===l.id?o.away:o.home;let G;o.away_id===null?G=c:L?G=`${L.club_name||L.pseudo} (${L.pseudo})`:G="Adversaire";let Y="";o.status==="in_progress"&&Date.now()-new Date(o.created_at).getTime()>3600*1e3&&(Y=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const B=new Date(o.created_at),D=B.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+B.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),j=o.status==="finished"?`${o.home_score} - ${o.away_score}`:`${o.home_score||0} - ${o.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
