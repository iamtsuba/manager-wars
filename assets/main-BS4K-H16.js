const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/match-shared-DdXvn4r3.js","assets/match-shared-D_M6t_P4.css"])))=>i.map(i=>d[i]);
import{w as Ji,s as h,x as Ho,F as _t,g as Ct,o as it,m as ai,n as Ot,r as qe,k as Lt,y as Fi,G as Oe,t as Xi,z as Uo,C as Li,q as Qi,I as jt,J as Si,L as Ri,p as hi,O as vi,P as Ci,Q as Ii,T as Ht,U as si,V as St,W as Ko,X as li,Y as Qe,Z as di,_ as wt,$ as ot,a0 as In,a1 as Vo,a2 as Zi,a3 as Tn,a4 as Yo,a5 as It,a6 as ji,v as An,a7 as Mn,d as Cn}from"./match-shared-DdXvn4r3.js";const jn="/";async function _o(t,{navigate:e,toast:i}){let o="login";const r=await Ji("signup_access_code_required"),n=()=>{var d,l,s,c,m,y,x,g;const a=o==="login";if(t.innerHTML=`
    <div style="
    ...
    </style>`,(d=document.getElementById("tab-login-btn"))==null||d.addEventListener("click",()=>{o="login",n()}),(l=document.getElementById("tab-reg-btn"))==null||l.addEventListener("click",()=>{o="register",n()}),a){(s=document.getElementById("login-password"))==null||s.addEventListener("keydown",u=>{var w;u.key==="Enter"&&((w=document.getElementById("login-btn"))==null||w.click())});let f=null,b=!1;r&&((c=document.getElementById("login-access-code"))==null||c.addEventListener("input",u=>{const w=u.target.value,v=document.getElementById("login-access-code-status"),$=document.getElementById("login-btn");if(clearTimeout(f),b=!1,$&&($.disabled=!0,$.style.opacity="0.45",$.style.cursor="not-allowed"),!w){v&&(v.textContent="");return}v&&(v.textContent="⏳ Vérification…",v.style.color="rgba(255,255,255,0.4)"),f=setTimeout(async()=>{const{data:p,error:T}=await h.rpc("check_signup_password",{input_password:w});if(T){v&&(v.textContent="Erreur de vérification.",v.style.color="#f87171");return}b=!!p,v&&(v.textContent=b?"✅ Code valide":"❌ Code incorrect",v.style.color=b?"#4ade80":"#f87171"),$&&($.disabled=!b,$.style.opacity=b?"1":"0.45",$.style.cursor=b?"pointer":"not-allowed")},400)})),(m=document.getElementById("login-btn"))==null||m.addEventListener("click",async()=>{var I;const u=document.getElementById("login-email").value.trim(),w=document.getElementById("login-password").value,v=((I=document.getElementById("login-access-code"))==null?void 0:I.value)||"",$=document.getElementById("login-error");if($.textContent="",!u||!w){$.textContent="Remplissez tous les champs.";return}if(r){const{data:M}=await h.rpc("check_signup_password",{input_password:v});if(!M){$.textContent="Code d'accès incorrect.";return}}const p=document.getElementById("login-btn");p.textContent="⏳ Connexion…",p.disabled=!0;const{error:T}=await h.auth.signInWithPassword({email:u,password:w});if(p.textContent="⚽ Se connecter",p.disabled=!1,T){$.textContent=T.message.includes("Invalid")?"Email ou mot de passe incorrect.":T.message;return}window.location.reload()})}else{(y=document.getElementById("reg-confirm"))==null||y.addEventListener("keydown",u=>{var w;u.key==="Enter"&&((w=document.getElementById("reg-btn"))==null||w.click())});let f=null,b=!1;r&&((x=document.getElementById("reg-access-code"))==null||x.addEventListener("input",u=>{const w=u.target.value,v=document.getElementById("access-code-status"),$=document.getElementById("reg-btn");if(clearTimeout(f),b=!1,$&&($.disabled=!0,$.style.opacity="0.45",$.style.cursor="not-allowed"),!w){v&&(v.textContent="");return}v&&(v.textContent="⏳ Vérification…",v.style.color="rgba(255,255,255,0.4)"),f=setTimeout(async()=>{const{data:p,error:T}=await h.rpc("check_signup_password",{input_password:w});if(T){v&&(v.textContent="Erreur de vérification.",v.style.color="#f87171");return}b=!!p,v&&(v.textContent=b?"✅ Code valide":"❌ Code incorrect",v.style.color=b?"#4ade80":"#f87171"),$&&($.disabled=!b,$.style.opacity=b?"1":"0.45",$.style.cursor=b?"pointer":"not-allowed")},400)})),(g=document.getElementById("reg-btn"))==null||g.addEventListener("click",async()=>{var O;const u=document.getElementById("reg-email").value.trim(),w=document.getElementById("reg-password").value,v=document.getElementById("reg-confirm").value,$=((O=document.getElementById("reg-access-code"))==null?void 0:O.value)||"",p=document.getElementById("reg-error");if(p.textContent="",!u||!w||!v){p.textContent="Remplissez tous les champs.";return}if(!u.includes("@")||!u.includes(".")){p.textContent="Adresse email invalide.";return}if(w.length<6){p.textContent="Mot de passe trop court (min. 6 caractères).";return}if(w!==v){p.textContent="Les mots de passe ne correspondent pas.";return}if(r){const{data:Y}=await h.rpc("check_signup_password",{input_password:$});if(!Y){p.textContent="Code d'accès incorrect.";return}}const T=document.getElementById("reg-btn");T.textContent="⏳ Création…",T.disabled=!0;const{data:I,error:M}=await h.auth.signUp({email:u,password:w});if(T.textContent="🚀 Créer mon compte",T.disabled=!1,M){M.message.includes("already registered")||M.message.includes("already exists")||M.message.includes("User already")?p.textContent="Un compte existe déjà avec cette adresse email.":p.textContent=M.message;return}if(I!=null&&I.user&&Array.isArray(I.user.identities)&&I.user.identities.length===0){p.textContent="Un compte existe déjà avec cette adresse email.";return}i("Compte créé ! Connecte-toi pour commencer.","success",4e3),o="login",n(),setTimeout(()=>{const Y=document.getElementById("login-email");Y&&(Y.value=u)},50)})}};n()}function qn(t,{state:e,navigate:i,toast:o,refreshProfile:r}){let n="#1A6B3C",a="#D4A017";t.innerHTML=`
  ...
  `,document.body.appendChild(n);let a=!1;const d=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let s=!1;const c=S=>S.touches&&S.touches[0]?S.touches[0].clientX:S.clientX;function m(S){a||(s=!0,l.style.opacity="1",y(S))}function y(S){if(!s||a)return;const X=d.getBoundingClientRect(),R=c(S)-X.left,ie=Math.max(0,Math.min(1,R/X.width));l.style.width=ie*X.width+"px",ie>=.82&&g()}function x(){a||(s=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{a||(l.style.transition="")},220))}function g(){var X;if(a)return;a=!0,s=!1,l.style.width="100%",l.style.opacity="1",(X=document.getElementById("cut-flash"))==null||X.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const S=document.getElementById("cut-hint");S&&(S.style.opacity="0"),d.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",w(0)},620)}d.addEventListener("pointerdown",m),window.addEventListener("pointermove",y),window.addEventListener("pointerup",x),d.addEventListener("touchstart",m,{passive:!0}),window.addEventListener("touchmove",y,{passive:!0}),window.addEventListener("touchend",x);let f=0,b=!1;const u=new Set;function w(S){f=S,document.getElementById("reveal-phase").style.display="flex",v(),$(S,0),O()}function v(){const S=document.getElementById("card-dots");S&&(S.innerHTML=t.map((X,R)=>`<div class="card-dot" data-i="${R}" style="width:8px;height:8px;border-radius:50%;background:${R===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),S.querySelectorAll(".card-dot").forEach(X=>X.addEventListener("click",()=>T(parseInt(X.dataset.i)))))}function $(S,X){var xe,me;const R=t[S],ie=document.getElementById("card-counter"),fe=document.getElementById("card-track");ie&&(ie.textContent=`Carte ${S+1} / ${t.length}`);const he=document.getElementById("reveal-btns");he&&(he.style.display=S===t.length-1?"flex":"none");const be=R.card_type==="player"&&((xe=R.player)==null?void 0:xe.rarity)==="legende",je=!u.has(S);if(u.add(S),R.card_type==="player"&&R.player){const ke=R.player,k=ke.job||"ATT";(Number(k==="GK"?ke.note_g:k==="DEF"?ke.note_d:k==="MIL"?ke.note_m:ke.note_a)||0)+(R.evolution_bonus||0)}const Be=ke=>{fe.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${be?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Wn(R)}</div>
        ...
        </div>`;const k=document.getElementById("current-card-wrap");X!==0?(k.style.transition="none",k.style.transform=`translateX(${X>0?100:-100}%)`,requestAnimationFrame(()=>{k.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",k.style.transform="translateX(0)"})):k.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),ke||be?Z():Q(),v()};je&&((me=R.player)==null?void 0:me.rarity)==="legende"&&R.card_type==="player"&&R.player?p(R,()=>Be(!0)):Be(!1)}function p(S,X){var ae;b=!0;const R=S.player,ie=`https://flagsapi.com/${R.country_code}/flat/64.png`,fe=(ae=R.clubs)==null?void 0:ae.logo_url,he=Ct(R),be=R.job||"ATT",je=Number(be==="GK"?R.note_g:be==="DEF"?R.note_d:be==="MIL"?R.note_m:R.note_a)||0,Be=S.evolution_bonus||0,xe=je+Be,me=R.rarity==="legende",ke=xe>=18,k=document.getElementById("walkout-overlay"),j=document.getElementById("walkout-stage");if(!k||!j){b=!1,X();return}let K=null;me&&(K=io("/sounds/Legendary.mp3",.8)),k.style.display="flex";const G=()=>{const ue=j.firstElementChild;ue&&(ue.classList.remove("wo-in"),ue.classList.add("wo-out"))},V=1800,N=400;j.innerHTML=`<img class="wo-in" src="${ie}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(G,V),setTimeout(()=>{var ue;j.innerHTML=fe?`<img class="wo-in" src="${fe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ue=R.clubs)==null?void 0:ue.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},V+N),setTimeout(G,V*2+N),setTimeout(()=>{j.innerHTML=he?`<img class="wo-in" src="${he}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(V+N)*2),setTimeout(G,(V+N)*2+V);const de=ke?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[be]||"#fff";setTimeout(()=>{j.innerHTML=`<div class="wo-in" style="
        font-size:${ke?"120px":"90px"};font-weight:900;color:${de};
        font-family:Arial Black,Arial;line-height:1;
        text-shadow:0 0 30px ${de}, 0 0 60px ${de};
        ${ke?"animation:woGlow 0.8s ease-in-out infinite;":""}">
        ${xe}
      </div>`,ke&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(V+N)*3),setTimeout(G,(V+N)*3+V),setTimeout(()=>{k.style.display="none",j.innerHTML="",b=!1,K&&!me&&K.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),X()},(V+N)*4)}function T(S){if(b||S<0||S>=t.length||S===f)return;const X=S>f?1:-1;f=S,$(S,X)}function I(){T(f+1)}function M(){T(f-1)}function O(){const S=document.getElementById("card-viewport");if(!S||S._swipeBound)return;S._swipeBound=!0;let X=0,R=0,ie=0,fe=!1;const he=me=>me.touches?me.touches[0].clientX:me.clientX,be=me=>me.touches?me.touches[0].clientY:me.clientY,je=me=>{fe=!0,X=he(me),R=be(me),ie=0},Be=me=>{if(!fe)return;ie=he(me)-X;const ke=be(me)-R;if(Math.abs(ie)<Math.abs(ke))return;const k=document.getElementById("current-card-wrap");k&&(k.style.transition="none",k.style.transform=`translateX(${ie*.6}px) rotate(${ie*.02}deg)`)},xe=()=>{if(!fe)return;fe=!1;const me=document.getElementById("current-card-wrap"),ke=55;ie<=-ke&&f<t.length-1?I():ie>=ke&&f>0?M():me&&(me.style.transition="transform .2s ease",me.style.transform="translateX(0)")};S.addEventListener("pointerdown",je),S.addEventListener("pointermove",Be),S.addEventListener("pointerup",xe),S.addEventListener("pointercancel",xe),S.addEventListener("touchstart",je,{passive:!0}),S.addEventListener("touchmove",Be,{passive:!0}),S.addEventListener("touchend",xe),S.addEventListener("click",me=>{if(Math.abs(ie)>8)return;const ke=S.getBoundingClientRect();me.clientX-ke.left>ke.width/2?I():M()})}let Y=null;function Z(){const S=document.getElementById("fireworks-canvas");if(!S)return;S.width=window.innerWidth,S.height=window.innerHeight;const X=S.getContext("2d"),R=[];function ie(){const he=Math.random()*S.width,be=Math.random()*S.height*.6,je=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],Be=je[Math.floor(Math.random()*je.length)];for(let xe=0;xe<60;xe++){const me=Math.PI*2/60*xe,ke=2+Math.random()*5;R.push({x:he,y:be,vx:Math.cos(me)*ke,vy:Math.sin(me)*ke,alpha:1,color:Be,size:2+Math.random()*3})}}ie(),Y=setInterval(ie,600);function fe(){if(document.getElementById("fireworks-canvas")){X.clearRect(0,0,S.width,S.height);for(let he=R.length-1;he>=0;he--){const be=R[he];if(be.x+=be.vx,be.y+=be.vy+.08,be.vy*=.98,be.alpha-=.018,be.alpha<=0){R.splice(he,1);continue}X.globalAlpha=be.alpha,X.fillStyle=be.color,X.beginPath(),X.arc(be.x,be.y,be.size,0,Math.PI*2),X.fill()}X.globalAlpha=1,(Y!==null||R.length>0)&&requestAnimationFrame(fe)}}fe()}function Q(){Y!==null&&(clearInterval(Y),Y=null);const S=document.getElementById("fireworks-canvas");S&&S.getContext("2d").clearRect(0,0,S.width,S.height)}if(o){const S=document.getElementById("reveal-btns");S&&(S.style.flexDirection="row",S.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(H=document.getElementById("reveal-next"))==null||H.addEventListener("click",()=>{Q(),n.remove(),o()})}else{const S=document.getElementById("reveal-reopen"),X=e.cost||0,R=Number((B=(le=r==null?void 0:r.state)==null?void 0:le.profile)==null?void 0:B.credits)||0,ie=!X||R>=X;if(S)if(r){S.textContent=`🎁 Ouvrir un autre booster${X?` (${X.toLocaleString("fr")} cr.)`:""}`;const fe=be=>{S.disabled=!0,S.style.opacity="0.45",S.style.cursor="not-allowed",be&&(S.title=be)};ie||fe("Crédits insuffisants");const he=((pe=e._raw)==null?void 0:pe.max_per_user)??null;ie&&he!=null&&((C=(ve=r==null?void 0:r.state)==null?void 0:ve.user)!=null&&C.id)&&h.from("booster_claims").select("id",{count:"exact",head:!0}).eq("user_id",r.state.user.id).eq("booster_id",e._boosterId).then(({count:be})=>{(be||0)>=he&&fe(`Quota atteint (${he} max.)`)}),S.addEventListener("click",()=>{S.disabled||(Q(),n.remove(),tn(e,{state:r.state,toast:r.toast,navigate:i,container:r.container}))})}else S.textContent="🎁 Ouvrir un autre booster",S.addEventListener("click",()=>{Q(),n.remove(),i("boosters")});document.getElementById("reveal-collection").addEventListener("click",()=>{Q(),n.remove(),i("collection")}),document.getElementById("reveal-shop").addEventListener("click",()=>{Q(),n.remove(),i("boosters")})}}function Wn(t){var e,i,o,r;if(t.card_type==="player"&&t.player)return On(t);if(t.card_type==="game_changer"){const n=t._gcDef,a=(n==null?void 0:n.name)||t.gc_type||"Game Changer",d=(n==null?void 0:n.effect)||((e=Gi[t.gc_type])==null?void 0:e.desc)||"",l=n!=null&&n.image_url?`/icons/${n.image_url}`:null,s=((i=Gi[t.gc_type])==null?void 0:i.icon)||"⚡";return it(a,l,s,d,{width:170})}if(t.card_type==="formation")return ai(t.formation,_t[t.formation],{width:160});if(t.card_type==="stadium"){const n=t._stadiumDef,a=(n==null?void 0:n.name)||"Stade",d=((o=n==null?void 0:n.club)==null?void 0:o.encoded_name)||(n==null?void 0:n.country_code)||"—",l=n!=null&&n.image_url?`/icons/${n.image_url}`:((r=n==null?void 0:n.club)==null?void 0:r.logo_url)||(n!=null&&n.country_code?`https://flagsapi.com/${n.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),s=`${d}<br>+10 ⭐ joueurs alliés`;return Ot(a,l,s,{width:170})}return'<div style="width:140px;height:200px;background:#333;border-radius:12px"></div>'}function Jn(t){var e,i;if((e=t==null?void 0:t.rates)!=null&&e.length){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;z-index:4000;padding:16px";const r={normal:"#ccc",pepite:"#D4A017",pépite:"#D4A017",papyte:"#909090",legende:"#7a28b8",légende:"#7a28b8"},n={player:"Joueur",formation:"Formation",game_changer:"Game Changer",game_helper:"Game Helper"};o.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    `,document.head.appendChild(m)}const n=tr.map(m=>`
    ...
    `;try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(m){console.warn("[AdSense]",m)}let s=e;const c=setInterval(()=>{s--;const m=a.querySelector("#credits-ad-cd");m&&(m.textContent=s),s<=0&&(clearInterval(c),l())},1e3)}function l(){var m,y;const s=a.querySelector("#credits-ad-status"),c=a.querySelector("#credits-ad-next-zone");n<t?(s&&(s.textContent="Publicité terminée ✅"),c&&(c.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function qi(t,{state:e,navigate:i,toast:o,openModal:r,closeModal:n}){var I,M,O,Y,Z,Q;const a=e.profile;if(!a)return;const d="/icons/";Kt(i,a,"home2",d,o);const l=a.mmr??1e3,s=Lt(l),c=rr(l,s),m=Fi(l),y=isFinite(s.max)?s.max+1:null,[{list:x,iAmInTop:g,myPosition:f},b,u,{count:w}]=await Promise.all([ar(a.id),sr(5),lr(),h.from("pending_rewards").select("*",{count:"exact",head:!0}).eq("user_id",a.id).eq("claimed",!1)]),v=(z,H)=>`
    <div class="rk-row ${z.id===a.id?"rk-row-me":""}">
      <div class="rk-pos ${H<3?"rk-pos-top"+(H+1):""}">${H<3?["🥇","🥈","🥉"][H]:H+1}</div>
      <div class="rk-name ${z.id===a.id?"rk-name-me":""}">${z.pseudo}</div>
      <div class="rk-rp">${(z.mmr??0).toLocaleString("fr")} RP</div>
    </div>`,$=z=>`
    <div class="news-item">
      ${z.image_url?`<img src="${z.image_url}" class="news-thumb" onerror="this.style.display='none'">`:'<div class="news-thumb news-thumb-fallback">📰</div>'}
      <div class="news-body">
        <div class="news-title">${z.title}</div>
        <div class="news-desc">${z.description||""}</div>
        <div class="news-time">${nr(z.published_at)}</div>
      </div>
    </div>`;let p=0;const T=z=>`
    <div class="promo-icon-wrap">
      <img src="${d}${z.icon||"nav-boosters.png"}" class="promo-icon" onerror="this.style.display='none'">
    </div>
    <div class="promo-info">
      <div class="promo-kicker">NOUVEAU BOOSTER</div>
      <div class="promo-title">${z.name}</div>
      <div class="promo-desc">${z.card_count||5} cartes · ${z.price_type==="pub"?"Pub gratuite":(z.price_credits||0).toLocaleString("fr")+" cr."}</div>
    </div>`;if(t.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-center">
          ...
          <div class="promo-banner" id="promo-banner">
            ...
            ${u.length>1?`<div class="promo-dots">${u.map((z,H)=>`<div class="promo-dot ${H===0?"active":""}" data-dot="${H}"></div>`).join("")}</div>`:""}
          </div>`:""}
        </div>
  ...
  </div>`,requestAnimationFrame(()=>{var ve,C;const z=((ve=window.visualViewport)==null?void 0:ve.height)||window.innerHeight,H=window.innerWidth<1024;let le=0;if(H){const S=document.getElementById("home2-mobile-top"),X=document.getElementById("home2-mobile-bottom");le=((S==null?void 0:S.offsetHeight)||0)+((X==null?void 0:X.offsetHeight)||0)}else le=((C=document.getElementById("home2-chrome-header"))==null?void 0:C.offsetHeight)||0;const B=z-le,pe=t.querySelector(".home-dark");pe&&(pe.style.minHeight=B+"px")}),(I=document.getElementById("nav-rankings-link"))==null||I.addEventListener("click",()=>i("rankings")),(M=document.getElementById("nav-rankings-cta"))==null||M.addEventListener("click",()=>i("rankings")),(O=document.getElementById("rank-inline-link-btn"))==null||O.addEventListener("click",()=>i("rankings")),(Y=document.getElementById("nav-journal-link"))==null||Y.addEventListener("click",()=>dr()),t.querySelectorAll("[data-action]").forEach(z=>{z.addEventListener("click",()=>{z.style.transform="scale(.96)",setTimeout(()=>z.style.transform="",180);const H=z.dataset.action;if(H==="match-ai"){sn(i,e);return}if(H==="match-random"){ct(),i("match",{matchMode:"random"});return}if(H==="match-friend"){i("friends");return}if(H==="mini-league"){i("mini-league");return}if(H==="ranked"){i("ranked");return}o("Bientôt disponible","info")})}),u.length>1){const z=document.getElementById("promo-slide-content"),H=()=>Array.from(document.querySelectorAll(".promo-dot")),le=B=>{p=B,z&&(z.innerHTML=T(u[p])),H().forEach((pe,ve)=>pe.classList.toggle("active",ve===p))};setInterval(()=>le((p+1)%u.length),5e3),document.querySelectorAll(".promo-dot").forEach(B=>{B.addEventListener("click",()=>le(Number(B.dataset.dot)))})}(Z=document.getElementById("promo-cta-btn"))==null||Z.addEventListener("click",()=>i("boosters")),an(e,o),(Q=document.getElementById("pending-rewards-banner"))==null||Q.addEventListener("click",()=>{nn(e,o,i)}),fr(e,o,i),rn(e,o,i),cr(e,o)}async function cr(t,e){const i=t.profile.id,{data:o}=await h.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(o!=null&&o.length))return;const r=o.reduce((a,d)=>a+(d.prize_amount||0),0),n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2200",n.innerHTML=`<div class="modal" style="max-width:400px">
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",s=>{s.target===i&&o()});const[{data:r},{data:n}]=await Promise.all([h.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),h.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),a=(n==null?void 0:n.unlocked_level)||1,d=r||[],l=document.getElementById("solo-levels-list");if(l){if(!d.length){l.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}l.innerHTML=d.map(s=>{const c=s.level_number>a,m=s.level_number===a,y=c?"#f0f0f0":m?"#eefaf2":"#f7f7f7",x=c?"#ddd":m?"#bfe8cf":"#e0e0e0",g=c?"#999":"#12401f";return`
      <div class="solo-level-card" data-level="${s.level_number}" data-locked="${c}"
        style="cursor:${c?"not-allowed":"pointer"};display:flex;align-items:center;gap:14px;padding:14px 16px;border-radius:14px;background:${y};border:1px solid ${x};opacity:${c?.6:1};transition:transform .12s ease">
    ...
    ${co()}`,document.body.appendChild(s);const m=()=>s.remove();s.querySelector("#pending-close").addEventListener("click",m),s.addEventListener("click",y=>{y.target===s&&m()}),s.querySelectorAll("[data-accept]").forEach(y=>{y.addEventListener("click",async()=>{const{error:x}=await h.from("friendships").update({status:"accepted"}).eq("id",y.dataset.accept);if(x){e("Erreur : "+x.message,"error");return}y.closest("div[style]").remove(),e("✅ Ami accepté !","success"),ln(t,e,o),i&&i()})}),s.querySelectorAll("[data-decline]").forEach(y=>{y.addEventListener("click",async()=>{await h.from("friendships").delete().eq("id",y.dataset.decline),y.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function hr(t,e,i){const o=t.user.id,[r,n]=[o,e].sort(),a=o===r,{data:d}=await h.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",n).single(),l=t.profile.club_name||t.profile.pseudo||"Moi",s=d||{},c=a?s.wins_p1||0:s.wins_p2||0,m=a?s.wins_p2||0:s.wins_p1||0,y=s.draws||0,x=a?s.goals_p1||0:s.goals_p2||0,g=a?s.goals_p2||0:s.goals_p1||0,f=a?s.gc_used_p1||0:s.gc_used_p2||0,b=a?s.gc_used_p2||0:s.gc_used_p1||0,u=s.matches_total||0,w=($,p,T,I=ci,M=pi)=>`
  ...
  <div class="game-page">
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function pn(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var c,m,y;const d=e[o],l=o===e.length-1,s=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`,t.querySelectorAll("[data-theme-choice]").forEach(v=>{v.addEventListener("click",()=>{Go(v.dataset.themeChoice),fn(t,e)})});const s=t.querySelector("#team-color1"),c=t.querySelector("#team-color2"),m=t.querySelector("#team-preview"),y=()=>{m&&(m.style.background=`linear-gradient(135deg, ${s.value} 50%, ${c.value} 50%)`)};y(),s==null||s.addEventListener("input",y),c==null||c.addEventListener("input",y),(u=t.querySelector("#team-save"))==null||u.addEventListener("click",async()=>{const v=t.querySelector("#team-error"),$=t.querySelector("#team-save"),p=t.querySelector("#team-club-name").value.trim();if(p.length<2){v.textContent="Nom de club trop court.";return}$.disabled=!0,$.textContent="⏳ Enregistrement...",v.textContent="";const{error:T}=await h.from("users").update({club_name:p,club_color1:s.value,club_color2:c.value}).eq("id",i.profile.id);if($.disabled=!1,$.textContent="💾 Enregistrer",T){v.textContent=T.message;return}i.profile.club_name=p,i.profile.club_color1=s.value,i.profile.club_color2=c.value,v.style.color="#2ecc71",v.textContent="✅ Modifications enregistrées.",ri()==="club"&&Go("club")});const x=t.querySelector("#volume-slider"),g=t.querySelector("#volume-label");let f=null;x.addEventListener("input",()=>{Fn(Number(x.value)),g.textContent=`${x.value}%`,f&&(f.volume=Math.max(0,Math.min(1,Number(x.value)/100)))}),t.querySelector("#volume-test").addEventListener("click",()=>{f=io("/sounds/match-opening.mp3",1)}),(w=t.querySelector("#settings-tutorial"))==null||w.addEventListener("click",()=>{un(i.profile,o,r)}),t.querySelector("#settings-logout").addEventListener("click",async()=>{await h.auth.signOut(),window.location.reload()})}const _r={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Qt={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},So=["GK","DEF","MIL","ATT"],kr=["Tous","GK","DEF","MIL","ATT"],$r={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function Io(t){const e=t.player;return e?(e.rarity,Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)):null}function Er(t){return t.length?t.reduce((e,i)=>Io(i)>Io(e)?i:e,t[0]):t[0]}const zr={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function mi(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Bi(t,e=""){const i=t.player;if(!i)return"";const o=t.evolution_bonus||0,r={...i,_evolution_bonus:o},n=e?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${e}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${t.id}">
    ${n}
    ${qe(r,{width:140})}
    ...
    ${qe(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),s=(d||[]).filter(k=>k.card_type==="player"&&k.player),c=(d||[]).filter(k=>k.card_type==="game_changer"),m=(d||[]).filter(k=>k.card_type==="formation"),y=(d||[]).filter(k=>k.card_type==="stadium"),{data:x}=await h.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach(k=>{g[k.name]=k});const{data:f}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),b={};(f||[]).forEach(k=>{b[k.id]=k}),y.forEach(k=>{k.stadium_def&&(b[k.stadium_id]=k.stadium_def)});const u=Object.keys(Xi),w=Object.keys(Oe),v={};s.forEach(k=>{const j=k.player.id;v[j]=(v[j]||0)+1}),new Set(Object.keys(v).map(k=>String(k)));const $=new Set(m.map(k=>k.formation)),p=new Set(c.map(k=>k.gc_type));let T="player",I="Tous",M="",O=!1,Y=!1,Z=new Set,Q=new Set,z="job";function H(k){return k.job==="GK"?Number(k.note_g)||0:k.job==="DEF"?Number(k.note_d)||0:k.job==="MIL"?Number(k.note_m)||0:Number(k.note_a)||0}function le(k,j){return z==="note_desc"?[...k].sort((K,G)=>H(j(G))-H(j(K))):z==="note_asc"?[...k].sort((K,G)=>H(j(K))-H(j(G))):[...k].sort((K,G)=>{const V=j(K),N=j(G),W=So.indexOf(V.job),de=So.indexOf(N.job);return W!==de?W-de:(V.surname_real||"").localeCompare(N.surname_real||"")})}function B(){return le(s,k=>k.player)}function pe(){return le(l||[],k=>k)}function ve(k){return(!Z.size||Z.has(k.country_code))&&(!Q.size||Q.has(k.club_id))}function C(){return B().filter(k=>{const j=k.player,K=I==="Tous"||j.job===I,G=!M||`${j.firstname} ${j.surname_real}`.toLowerCase().includes(M);return K&&G&&ve(j)})}function S(){return pe().filter(k=>{const j=I==="Tous"||k.job===I,K=!M||`${k.firstname} ${k.surname_real}`.toLowerCase().includes(M);return j&&K&&ve(k)})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(j){const K=document.getElementById(j);if(!K)return;K.addEventListener("wheel",ae=>{Math.abs(ae.deltaY)<=Math.abs(ae.deltaX)||(ae.preventDefault(),K.scrollLeft+=ae.deltaY)},{passive:!1});let G=!1,V=0,N=0,W=!1,de=!1;K.addEventListener("mousedown",ae=>{G=!0,W=!1,V=ae.pageX,N=K.scrollLeft}),window.addEventListener("mouseup",()=>{G=!1,W&&(K.style.cursor="",de=!0),W=!1}),window.addEventListener("mousemove",ae=>{if(!G)return;const ue=ae.pageX-V;!W&&Math.abs(ue)<6||(W=!0,K.style.cursor="grabbing",ae.preventDefault(),K.scrollLeft=N-ue)}),K.addEventListener("click",ae=>{de&&(ae.stopPropagation(),ae.preventDefault(),de=!1)},!0)}("col-grid");function X(){const k=document.getElementById("col-filters");k&&(T==="player"?(k.innerHTML=`
        ...
        <div style="display:flex;gap:6px;overflow-x:auto;padding-bottom:2px;align-items:center">
          ...
          <button id="sort-note-btn" title="Trier par note"
            style="flex-shrink:0;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
              border:1.5px solid ${z!=="job"?"var(--green)":"var(--tile-border)"};
              background:${z!=="job"?"var(--green)":"#fff"};
              color:${z!=="job"?"#fff":"#555"}">
            ⇅ Note${z==="note_desc"?" ↓":z==="note_asc"?" ↑":""}
          </button>
          ...
          <button id="show-all-btn"
            style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
              ...
              color:${O?"#111":"#555"}; font-size:18px; padding:5px 10px">
            ${O?"👁️":"🚫👁️"}
          </button>
        </div>`,document.getElementById("col-search").addEventListener("input",j=>{M=j.target.value.toLowerCase(),ie()}),t.querySelectorAll(".filter-btn").forEach(j=>{j.addEventListener("click",()=>{I=j.dataset.job,X(),ie()})}),document.getElementById("dupes-only-btn").addEventListener("click",()=>{Y=!Y,X(),ie()}),document.getElementById("show-all-btn").addEventListener("click",()=>{O=!O,X(),ie()}),document.getElementById("sort-note-btn").addEventListener("click",()=>{z=z==="job"?"note_desc":z==="note_desc"?"note_asc":"job",X(),ie()}),document.getElementById("country-filter-btn").addEventListener("click",()=>{R("country","🌍 Filtrer par pays",e)}),document.getElementById("club-filter-btn").addEventListener("click",()=>{R("club","🏟️ Filtrer par club",e)})):(k.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{O=!O,X(),ie()})))}function R(k,j,K){var ue,Se,Ae;const G=k==="country",V=G?Z:Q,N=O?l||[]:s.map(ye=>ye.player);let W;if(G){const ye=new Map;N.forEach(we=>{we!=null&&we.country_code&&!ye.has(we.country_code)&&ye.set(we.country_code,we.country_code)}),W=[...ye.keys()].sort().map(we=>({value:we,label:we}))}else{const ye=new Map;N.forEach(we=>{var _;we!=null&&we.club_id&&!ye.has(we.club_id)&&ye.set(we.club_id,((_=we.clubs)==null?void 0:_.encoded_name)||we.club_id)}),W=[...ye.entries()].sort((we,_)=>we[1].localeCompare(_[1])).map(([we,_])=>({value:we,label:_}))}const de=`
      ...
      </div>`;K.openModal(j,de,'<button class="btn btn-primary" id="mf-apply" style="width:100%">Appliquer</button>'),(ue=document.getElementById("mf-all"))==null||ue.addEventListener("click",()=>{document.querySelectorAll(".mf-check").forEach(ye=>ye.checked=!0)}),(Se=document.getElementById("mf-none"))==null||Se.addEventListener("click",()=>{document.querySelectorAll(".mf-check").forEach(ye=>ye.checked=!1)}),(Ae=document.getElementById("mf-apply"))==null||Ae.addEventListener("click",()=>{V.clear(),document.querySelectorAll(".mf-check:checked").forEach(ye=>V.add(ye.value)),K.closeModal(),X(),ie()})}function ie(){const k=document.getElementById("col-grid");k&&(T==="player"?Be(k):T==="formation"?xe(k):T==="stadium"?ke(k):me(k))}function fe(k,j,K,G,V,N=0){const W=document.getElementById("col-grid"),de=document.getElementById("col-big");if(!W||!de)return;var ae=0;function ue(){var q;const Se=window.innerWidth>=768,Ae=document.getElementById("col-big"),ye=document.getElementById("col-gap"),we=((q=document.getElementById("col-grid"))==null?void 0:q.parentElement)||null,_=Ae?Ae.closest(".page"):null;if(Ae&&we&&_){let L=0;Array.from(_.children).forEach(function(te){te!==Ae&&te!==we&&te!==ye&&(L+=te.offsetHeight)});const P=Math.max(0,_.clientHeight-L),D=Math.round(P*(N/100)),F=Math.max(0,P-D),U=Se?50/71:45/63,J=Math.round(F*U),ne=Math.max(0,F-J);ye&&(ye.style.height=D+"px"),Ae.style.flex="none",Ae.style.height=J+"px",Ae.style.minHeight="0",we.style.flex="none",we.style.height=ne+"px",we.style.minHeight="0",we.style.display="flex",we.style.overflow="hidden"}const E=document.getElementById("col-grid");E&&(E.style.height="100%",E.style.flexShrink="0",E.style.overflowX="auto",E.style.overflowY="hidden",E.style.alignItems="center",E.style.width="100%"),de.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+j(k[ae])+"</div>";var A=de.querySelector("[data-card-id],[data-form-id],[data-gc-id]");A&&A.addEventListener("click",function(){G(k[ae])}),requestAnimationFrame(function(){var L=document.getElementById("big-card-inner");if(!(!L||!de)){var P=de.clientHeight,D=de.clientWidth-16,F=L.offsetHeight,U=L.offsetWidth;if(F>0&&U>0&&P>40){var J=Math.min(P/F,D/U);L.style.transform="scale("+J.toFixed(3)+")",L.style.transformOrigin="center center"}}}),W.innerHTML=k.map(function(L,P){var D=P===ae,F="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(D?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+P+'" style="'+F+'">'+K(L,D)+"</div>"}).join(""),W.querySelectorAll(".col-mini-item").forEach(function(L){L.addEventListener("click",function(){ae=Number(L.dataset.idx),ue(),L.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var L=E?E.clientHeight:0,P=W.querySelector(".col-mini-item > div");if(!(!L||!P)){var D=P.style.zoom;P.style.zoom="1";var F=P.offsetHeight;if(P.style.zoom=D,!(F<=0)){var U=L/F;W.querySelectorAll(".col-mini-item > div").forEach(function(J){J.style.zoom=U.toFixed(4)})}}})}ue()}function he(k,j){var K=window.innerWidth>=768?.76:.54,G;if(!k||k._fake){var V=k?k.player:null;if(!V)return"";G=To(V)}else G=Bi(k,"");var N=k&&!k._fake?v[k.player&&k.player.id]||1:0,W=N>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+N+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+K+';pointer-events:none;line-height:0">'+W+G+"</div>"}function be(k,j,K){var G=K>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+K+"</div>":"",V=!!j,N=ai(k,_t[k],{width:160});return V||(N='<div style="filter:grayscale(1);opacity:0.5">'+N+"</div>"),"<div "+(j?'data-form-id="'+j.id+'"':"")+' style="position:relative;cursor:pointer">'+G+N+"</div>"}function je(k,j){var K=window.innerWidth>=768?.76:.54,G=ai(k,_t[k],{width:140});return j||(G='<div style="filter:grayscale(1);opacity:0.45">'+G+"</div>"),'<div style="display:inline-block;zoom:'+K+';line-height:0;pointer-events:none">'+G+"</div>"}function Be(k){if(O){const j=S();if(!j.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const K=j.map(G=>s.find(V=>V.player.id===G.id)||{_fake:!0,player:G,id:"fake-"+G.id});fe(K,G=>G._fake?To(G.player):Bi(G,""),G=>G._fake?he({player:G.player,id:"x",_fake:!0}):he(G),G=>{G._fake||Ao(G,s,v,e)})}else{const j=C();if(!j.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const K={};j.forEach(V=>{const N=V.player.id;K[N]||(K[N]=[]),K[N].push(V)});const G=Object.values(K).map(V=>Er(V)).filter(V=>!Y||(v[V.player.id]||1)>1);if(Y&&!G.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte en plusieurs exemplaires.</div>';return}fe(G,V=>{const N=v[V.player.id]||1,W=N>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${N}</div>`:"",ae=s.filter(ue=>ue.player.id===V.player.id&&ue.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Bi(V,W+ae)},V=>he(V),V=>Ao(V,s,v,e))}}function xe(k){const j=O?u:[...$];if(!j.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const K=j.map(G=>({formation:G,card:m.find(V=>V.formation===G)||null,owned:$.has(G)}));fe(K,({formation:G,card:V,owned:N})=>be(G,N?V:null,N?m.filter(W=>W.formation===G).length:0),({formation:G,owned:V})=>je(G,V),({card:G,owned:V})=>{V&&G&&Ir(G,m,e,n)},"#1A6B3C",5)}function me(k){const j=Object.keys(g),K=O?j.length?j:w:[...p];if(!K.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const G=K.map(V=>({type:V,gc:Oe[V]||{icon:"⚡",desc:""},def:g[V]||null,owned:p.has(V),card:c.find(N=>N.gc_type===V)||null}));fe(G,({type:V,gc:N,def:W,owned:de,card:ae})=>{var E;const ue=(W==null?void 0:W.name)||V,Se=de?c.filter(A=>A.gc_type===V).length:0,Ae=Se>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Se}</div>`:"",ye=(W==null?void 0:W.effect)||N.desc||"",we=W!=null&&W.image_url?`/icons/${W.image_url}`:((E=W==null?void 0:W.club)==null?void 0:E.logo_url)||(W!=null&&W.country_code?`https://flagsapi.com/${W.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let _=it(ue,we,N.icon,ye,{width:160,onClick:de});return de||(_=`<div style="filter:grayscale(1);opacity:0.5">${_}</div>`),`<div ${de&&ae?`data-gc-id="${ae.id}" data-gc-type="${V}"`:""} style="position:relative">${Ae}${_}</div>`},({type:V,gc:N,def:W,owned:de})=>{const ae=window.innerWidth>=768?.76:.54,ue=(W==null?void 0:W.name)||V,Se=(W==null?void 0:W.effect)||N.desc||"",Ae=W!=null&&W.image_url?`/icons/${W.image_url}`:null;let ye=it(ue,Ae,N.icon,Se,{width:140});return de||(ye=`<div style="filter:grayscale(1);opacity:0.45">${ye}</div>`),`<div style="display:inline-block;zoom:${ae};line-height:0;pointer-events:none">${ye}</div>`},({type:V,owned:N,def:W})=>{N&&Sr(V,W,n)},"#7a28b8",5)}function ke(k){const j="#4FC3F7",K="/";if(!y.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const G={};y.forEach(N=>{const W=N.stadium_id||"?";(G[W]=G[W]||[]).push(N)});const V=Object.entries(G).map(([N,W])=>({sid:N,def:b[N]||null,count:W.length,card:W[0]}));fe(V,({def:N,count:W})=>{var ye,we;const de=(N==null?void 0:N.name)||"?",ae=((ye=N==null?void 0:N.club)==null?void 0:ye.encoded_name)||(N==null?void 0:N.country_code)||"—",ue=N!=null&&N.image_url?`${K}icons/${N.image_url}`:((we=N==null?void 0:N.club)==null?void 0:we.logo_url)||(N!=null&&N.country_code?`https://flagsapi.com/${N.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Se=W>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${W}</div>`:"",Ae=`${ae}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${Se}${Ot(de,ue,Ae,{width:160})}</div>`},({def:N})=>{var Ae,ye;const W=window.innerWidth>=768?.76:.54,de=(N==null?void 0:N.name)||"?",ae=((Ae=N==null?void 0:N.club)==null?void 0:Ae.encoded_name)||(N==null?void 0:N.country_code)||"—",ue=N!=null&&N.image_url?`${K}icons/${N.image_url}`:((ye=N==null?void 0:N.club)==null?void 0:ye.logo_url)||(N!=null&&N.country_code?`https://flagsapi.com/${N.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Se=`${ae}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${W};line-height:0;pointer-events:none">${Ot(de,ue,Se,{width:140})}</div>`},null,j,5)}t.querySelectorAll(".col-tab-btn").forEach(k=>{k.addEventListener("click",()=>{T=k.dataset.tab,I="Tous",M="",O=!1,t.querySelectorAll(".col-tab-btn").forEach(j=>{const K=j.dataset.tab===T;j.style.borderBottomColor=K?"var(--green)":"transparent",j.style.color=K?"var(--green)":"var(--tile-fg-dim)"}),X(),ie()})}),X(),ie()}function Sr(t,e,i){const o=Oe[t]||{icon:"⚡",desc:"Effet spécial."},r=(e==null?void 0:e.name)||t,n=(e==null?void 0:e.effect)||o.desc,a=e!=null&&e.image_url?`/icons/${e.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${it(r,a,o.icon,n,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const gi=1e3;function Ir(t,e,i,o){var g,f,b;const{state:r,toast:n,closeModal:a,navigate:d,refreshProfile:l}=i,s=t.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function m(){const u=_t[s]||{},w=Xi[s]||[],v=290,$=360,p=20;function T(M){const O=u[M];return O?{x:O.x*v,y:O.y*$}:null}let I=`<svg width="${v}" height="${$}" viewBox="0 0 ${v} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[M,O]of w){const Y=T(M),Z=T(O);!Y||!Z||(I+=`<line x1="${Y.x}" y1="${Y.y}" x2="${Z.x}" y2="${Z.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const M of Object.keys(u)){const O=T(M);if(!O)continue;const Y=M.replace(/\d+/,""),Z=c[Y]||"#555";I+=`<circle cx="${O.x}" cy="${O.y}" r="${p}" fill="${Z}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,I+=`<text x="${O.x}" y="${O.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${Y}</text>`}return I+="</svg>",I}const y=e.filter(u=>u.formation===s);y.length;const x=!t.is_for_sale;o(`Formation ${s}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${s} pour ${gi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const u=y.find(v=>!v.is_for_sale)||y[0];if(!u){n("Aucune carte à vendre","error");return}await h.from("market_listings").delete().eq("card_id",u.id),await h.from("transfer_history").delete().eq("card_id",u.id);const{error:w}=await h.from("cards").delete().eq("id",u.id);if(w){n(w.message,"error");return}await h.from("users").update({credits:(r.profile.credits||0)+gi}).eq("id",r.profile.id),await l(),n(`+${gi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(f=document.getElementById("market-sell-form-btn"))==null||f.addEventListener("click",async()=>{const u=parseInt(document.getElementById("sell-price-form").value);if(!u||u<1){n("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:u}).eq("id",t.id),await h.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:u}),n("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(b=document.getElementById("cancel-sell-form-btn"))==null||b.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),d("collection")})}async function Ao(t,e,i,o){var X,R,ie,fe,he,be,je,Be,xe,me,ke;const{state:r,toast:n,openModal:a,closeModal:d,navigate:l,refreshProfile:s}=o,c=t.player,m=e.filter(k=>k.player.id===c.id),y=m.length,x=t.evolution_bonus||0,g=Math.max((Number(c.note_g)||0)+(c.job==="GK"||c.job2==="GK"?x:0),(Number(c.note_d)||0)+(c.job==="DEF"||c.job2==="DEF"?x:0),(Number(c.note_m)||0)+(c.job==="MIL"||c.job2==="MIL"?x:0),(Number(c.note_a)||0)+(c.job==="ATT"||c.job2==="ATT"?x:0)),f=c.rarity||"normal",{data:b}=await h.from("sell_price_configs").select("*").eq("rarity",f).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1),u=((X=b==null?void 0:b[0])==null?void 0:X.price)??$r[f]??1e3,w=((R=b==null?void 0:b[0])==null?void 0:R.price_min)??null,v=((ie=b==null?void 0:b[0])==null?void 0:ie.price_max)??null;Ct(c);const $=mi(c,c.job)+x,p=c.job2?mi(c,c.job2)+(mi(c,c.job2)>0?x:0):null;Qt[c.job],c.job2&&Qt[c.job2];const T=_r[c.rarity]||"#ccc",I=zr[c.country_code]||c.country_code||"",M=t.evolution_bonus||0,Y=$+M,Z=p||0,Q=Z>0?Z+M:0,z=m.map(k=>k.id);let H={};if(z.length){const{data:k}=await h.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",z).order("transferred_at",{ascending:!0});(k||[]).forEach(j=>{H[j.card_id]||(H[j.card_id]=[]),H[j.card_id].push(j)})}const le=z.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${m.filter(k=>k.id!==t.id).map((k,j)=>{const K=H[k.id]||[],G=k.is_for_sale,V=K.length?K[K.length-1]:null,N=k.evolution_bonus||0,W=V?V.source==="booster"?"Booster":V.price?V.price.toLocaleString("fr")+" cr.":"—":"—",de=V?new Date(V.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",ae=80,ue=Math.round(ae*657/507),Se=qe({...c,_evolution_bonus:N},{width:ae});return`
            <div class="exemplaire-row" data-card-id="${k.id}" data-card-idx="${j}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${k.id}" data-evo="${N}" data-note="${mi(c,c.job)}"
                ${G?"disabled":""}
                style="display:none">
              <!-- Wrapper exactement aux dimensions de la carte -->
              <div class="expl-mini-card" style="position:relative;width:${ae}px;height:${ue}px;border-radius:8px;overflow:hidden">
                ${Se}
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${Y}${c.job2&&Z>0?` / ${Q}`:""}`:`Note actuelle : ${Y}${c.job2&&Z>0?` / ${Q}`:""}`}
            </div>
          </div>
      ...
      <!-- Carte visuelle -->
      ${qe({...c,_evolution_bonus:x},{width:160})}
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([k,j])=>{const K=Qt[k],G=k==="GK"?"#fff":K,V=k===c.job||k===c.job2,N=(Number(j)||0)+(V&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${K};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${G};font-family:Arial Black,Arial;line-height:1">${N}</span>
                </div>
    ...
    ${le}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(he=document.getElementById("close-detail"))==null||he.addEventListener("click",d);let B=new Set;const pe=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function ve(){let k=0;return document.querySelectorAll(".expl-check:checked").forEach(j=>{if(j.dataset.id===t.id)return;const G=Number(j.dataset.evo)||0,V=Number(j.dataset.note)||0;k+=V+G}),Math.round(k*pe)}const C=()=>{const k=B.size,j=document.getElementById("sell-action-panel");if(!j)return;j.style.display=k>0?"block":"none",document.getElementById("sell-selected-count").textContent=k;const K=document.getElementById("evolve-btn");if(K){const G=ve();K.textContent=G>0?`⬆️ Évoluer (+${G})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(k=>{k.addEventListener("change",()=>{const j=k.dataset.id;k.checked?B.add(j):B.delete(j);const K=k.closest(".exemplaire-row");if(K){const G=K.querySelector(".expl-sel-overlay"),V=K.querySelector(".expl-sel-check");G&&(G.style.display=k.checked?"block":"none"),V&&(V.style.display=k.checked?"flex":"none"),K.style.transform=k.checked?"scale(1.05)":"scale(1)"}C()})}),document.querySelectorAll(".exemplaire-row").forEach(k=>{k.addEventListener("click",j=>{if(j.target.tagName==="INPUT")return;const K=k.querySelector(".expl-check");K&&!K.disabled&&(K.checked=!K.checked,K.dispatchEvent(new Event("change")))})}),(be=document.getElementById("evolve-btn"))==null||be.addEventListener("click",async()=>{if(y<=1)return;const k=[...B];if(!k.length)return;if(B.has(t.id)){const ae=document.createElement("div");ae.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ae.innerHTML=`
        ...
        </div>`,document.body.appendChild(ae),ae.querySelector("#err-close").addEventListener("click",()=>ae.remove()),ae.addEventListener("click",ue=>{ue.target===ae&&ae.remove()});return}const j=k.filter(ae=>ae!==t.id);if(!j.length){n("Sélectionne des copies à sacrifier","warning");return}const K=j.reduce((ae,ue)=>{const Se=document.querySelector(`.expl-check[data-id="${ue}"]`),Ae=Se&&Number(Se.dataset.evo)||0,ye=Se&&Number(Se.dataset.note)||0;return ae+ye+Ae},0),G=Math.round(K*pe),V=c.rarity==="pepite"?" (+30% pépite ✨)":c.rarity==="papyte"?" (-30% papyte)":"";if(!await new Promise(ae=>{const ue=document.createElement("div");ue.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ue.innerHTML=`
        ...
        </div>`,document.body.appendChild(ue),ue.querySelector("#sac-cancel").addEventListener("click",()=>{ue.remove(),ae(!1)}),ue.querySelector("#sac-ok").addEventListener("click",()=>{ue.remove(),ae(!0)}),ue.addEventListener("click",Se=>{Se.target===ue&&(ue.remove(),ae(!1))})}))return;if(j.length){await h.from("market_listings").delete().in("card_id",j),await h.from("deck_cards").delete().in("card_id",j),await h.from("transfer_history").delete().in("card_id",j),await h.from("decks").update({stadium_card_id:null}).in("stadium_card_id",j);const{error:ae}=await h.from("cards").delete().in("id",j);if(ae){n("Erreur suppression : "+ae.message,"error");return}}const W=(t.evolution_bonus||0)+G,{error:de}=await h.from("cards").update({evolution_bonus:W}).eq("id",t.id);if(de){n("Erreur évolution : "+de.message,"error");return}n(`⬆️ ${c.firstname} ${c.surname_real} : note ${$} → ${$+W} (+${G}) !`,"success",4e3),d(),l("collection")});async function S(k){const{data:j}=await h.from("sell_price_configs").select("price_min, price_max").eq("rarity",c.rarity).lte("note_min",$).gte("note_max",$).order("note_max",{ascending:!0}).limit(1).maybeSingle();return j?k<j.price_min||k>j.price_max?{ok:!1,min:j.price_min,max:j.price_max}:{ok:!0}:{ok:!0}}(je=document.getElementById("market-sell-btn"))==null||je.addEventListener("click",async()=>{var W;const k=[...B];if(!k.length){n("Sélectionne au moins un exemplaire","warning");return}const j=parseInt((W=document.getElementById("sell-market-price"))==null?void 0:W.value);if(!j||j<1){n("Prix invalide","error");return}const K=await S(j);if(!K.ok){n(`Prix hors grille : entre ${K.min.toLocaleString("fr")} et ${K.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:G}=await h.from("cards").update({is_for_sale:!0,sale_price:j}).in("id",k);if(G){n(G.message,"error");return}const V=k.map(de=>({seller_id:r.profile.id,card_id:de,price:j,status:"active"})),{error:N}=await h.from("market_listings").insert(V);N&&console.warn("[Market] insert listings:",N.message),n(`${k.length} carte${k.length>1?"s":""} mise${k.length>1?"s":""} en vente à ${j.toLocaleString("fr")} cr. chacune !`,"success"),d(),l("collection")}),(Be=document.getElementById("single-sell-btn"))==null||Be.addEventListener("click",async()=>{var V;const k=parseInt((V=document.getElementById("single-sell-price"))==null?void 0:V.value);if(!k||k<1){n("Prix invalide","error");return}const j=await S(k);if(!j.ok){n(`Prix hors grille : entre ${j.min.toLocaleString("fr")} et ${j.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:K}=await h.from("cards").update({is_for_sale:!0,sale_price:k}).eq("id",t.id);if(K){n(K.message,"error");return}const{error:G}=await h.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:k,status:"active"});G&&console.warn("[Market] insert listing:",G.message),n(`Carte mise en vente à ${k.toLocaleString("fr")} cr. !`,"success"),d(),l("collection")}),(xe=document.getElementById("single-direct-sell-btn"))==null||xe.addEventListener("click",async()=>{const k=w??u;if(!confirm(`Vendre cette carte immédiatement pour ${k.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;await h.from("market_listings").delete().eq("card_id",t.id),await h.from("transfer_history").delete().eq("card_id",t.id);const{error:j}=await h.from("cards").delete().eq("id",t.id);if(j){n(j.message,"error");return}await h.from("users").update({credits:(r.profile.credits||0)+k}).eq("id",r.profile.id),await s(),n(`+${k.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),d(),l("collection")}),(me=document.getElementById("market-direct-sell-btn"))==null||me.addEventListener("click",async()=>{const k=[...B];if(!k.length){n("Sélectionne au moins un exemplaire","warning");return}const K=(w??u)*k.length;if(!confirm(`Vendre ${k.length} carte${k.length>1?"s":""} immédiatement pour ${K.toLocaleString("fr")} crédits au total ? Cette action est irréversible.`))return;await h.from("market_listings").delete().in("card_id",k),await h.from("transfer_history").delete().in("card_id",k);const{error:G}=await h.from("cards").delete().in("id",k);if(G){n(G.message,"error");return}await h.from("users").update({credits:(r.profile.credits||0)+K}).eq("id",r.profile.id),await s(),n(`+${K.toLocaleString("fr")} crédits ! ${k.length} carte${k.length>1?"s":""} vendue${k.length>1?"s":""}.`,"success"),d(),l("collection")}),(ke=document.getElementById("cancel-sell-btn"))==null||ke.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),d(),l("collection")})}function Mo(t,e=""){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),l=(a||[]).filter(u=>u.card_type==="player"&&u.player),s=(a||[]).filter(u=>u.card_type==="formation"),c=(d||[]).filter(u=>u.card_type==="stadium"),m=[...new Set(c.map(u=>u.stadium_id).filter(Boolean))];let y={};if(c.forEach(u=>{u.stadium_def&&u.stadium_id&&(y[u.stadium_id]=u.stadium_def)}),m.length&&Object.keys(y).length<m.length){const{data:u}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",m);(u||[]).forEach(w=>{y[w.id]=w})}const x=s.map(u=>u.formation).filter(Boolean),{data:g}=await h.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let f=n.formation||"4-4-2";x.length>0&&!x.includes(f)&&(f=x[0]);const b={deckId:t,name:n.name,formation:f,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:l,formationCards:s,stadiumCards:c,stadDefMap:y,availableFormations:x};(g||[]).forEach(u=>{u.is_starter?b.slots[u.position]=u.card_id:b.subs.includes(u.card_id)||b.subs.push(u.card_id)}),kt(e,b,i,!0)}function kt(t,e,i,o=!1){var f,b;const{navigate:r}=i;o||qr(e,i),ki[e.formation];const n=jo(e.formation),a=n.filter(u=>e.slots[u]).length,d=e.availableFormations.length>0?e.availableFormations:Object.keys(ki),l=(f=e.stadiumCards)==null?void 0:f.find(u=>u.id===e.stadiumCardId),s=l&&((b=e.stadDefMap)==null?void 0:b[l.stadium_id])||null,c=e.subs.map(u=>e.playerCards.find(w=>w.id===u)).filter(Boolean);c.length!==e.subs.length&&(e.subs=c.map(u=>u.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;const m=window.innerWidth>=900,y=t.querySelector(".deck-pc-layout"),x=t.querySelector(".deck-mobile-layout");y&&(y.style.display=m?"block":"none"),x&&(x.style.display=m?"none":"block"),t.querySelectorAll("#save-deck").forEach(u=>{u.closest(".page-body").style.display=m?"none":"block"}),Ar(t,e,n,i),t.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>r("decks")));const g=()=>{const{openModal:u,closeModal:w}=i,$=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
    ...
    </div>`;u("⚽ Choisir une formation",$),document.querySelectorAll("#modal-body [data-forma]").forEach(p=>{p.addEventListener("click",()=>{e.formation=p.dataset.forma;const T=jo(e.formation),I={};T.forEach(M=>{e.slots[M]&&(I[M]=e.slots[M])}),e.slots=I,w(),kt(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",g)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Mr(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>Br(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(w=>w!==u.dataset.removeSub),kt(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>jr(e,t,i)))}function Ar(t,e,i,o){var v,$,p;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(v=e.stadiumCards)==null?void 0:v.find(T=>T.id===e.stadiumCardId),d=a&&(($=e.stadDefMap)==null?void 0:$[a.stadium_id])||null,l=_t[e.formation]||{},s=Uo(e.formation)||[],c={};for(const T of i){const I=e.slots[T],M=I?e.playerCards.find(O=>O.id===I):null;M!=null&&M.player?c[T]={...M.player,_evolution_bonus:M.evolution_bonus||0,face:M.player.face||null}:c[T]=null}const m=window.innerWidth>=900,y=m?window.innerWidth-280:window.innerWidth-20,x=m?Math.min(y,860):y,g=Math.round(m?x*.82:x*.85),f=m?84:44;let b="";for(const[T,I]of s){const M=l[T],O=l[I];if(!M||!O)continue;const Y=M.x*x,Z=Math.round(.03*g+M.y*.85*g),Q=O.x*x,z=Math.round(.03*g+O.y*.85*g),H=c[T],le=c[I],B=Li(H,le);B==="#ff3333"||B==="#cc2222"?b+=`<line x1="${Y.toFixed(1)}" y1="${Z.toFixed(1)}" x2="${Q.toFixed(1)}" y2="${z.toFixed(1)}" stroke="${B}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(b+=`<line x1="${Y.toFixed(1)}" y1="${Z.toFixed(1)}" x2="${Q.toFixed(1)}" y2="${z.toFixed(1)}" stroke="${B}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,b+=`<line x1="${Y.toFixed(1)}" y1="${Z.toFixed(1)}" x2="${Q.toFixed(1)}" y2="${z.toFixed(1)}" stroke="${B}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let u="";const w=Math.round(f*657/507);for(const T of i){const I=l[T];if(!I)continue;const M=c[T],O=I.x*x;I.y*g;const Y=Math.round(.03*g+I.y*(.85*g)),Z=Math.round(O-f/2),Q=Math.round(Y-w/2);if(M){const z=T.replace(/\d+/,""),H=d&&(d.club_id&&String(M.club_id)===String(d.club_id)||d.country_code&&M.country_code===d.country_code),le=qe({...M,_evolution_bonus:M._evolution_bonus||0},{width:f,showStad:!0,stadDef:d,role:z});H&&((p=d.club)!=null&&p.logo_url||d.image_url),u+=`<div style="position:absolute;left:${Z}px;top:${Q}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${T}">
        <div style="position:relative">${le}</div>
      </div>`}else{const z=T.replace(/\d+/,"");u+=`<div style="position:absolute;left:${Z}px;top:${Q}px;width:${f}px;height:${w}px;
    ...
    <div style="position:relative;width:${x}px;height:${g}px;margin:0 auto">
      <svg style="position:absolute;inset:0;width:100%;height:100%;pointer-events:none" viewBox="0 0 ${x} ${g}">${b}</svg>
      ${u}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(u=document.getElementById("close-selector"))==null||u.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),kt(i,e,o)}),document.querySelectorAll(".player-option").forEach(v=>{v.addEventListener("click",()=>{e.slots[t]=v.dataset.cardId,n(),kt(i,e,o)})})}function jr(t,e,i){var c,m,y;const{openModal:o,closeModal:r}=i,n=(c=t.stadiumCards)==null?void 0:c.find(x=>x.id===t.stadiumCardId),a=n&&((m=t.stadDefMap)==null?void 0:m[n.stadium_id])||null,d=new Set;Object.keys(t.slots).forEach(x=>{var b;const g=t.slots[x];if(!g)return;const f=t.playerCards.find(u=>u.id===g);(b=f==null?void 0:f.player)!=null&&b.id&&d.add(f.player.id)}),t.subs.forEach(x=>{var f;const g=t.playerCards.find(b=>b.id===x);(f=g==null?void 0:g.player)!=null&&f.id&&d.add(g.player.id)});const l=new Set,s=t.playerCards.filter(x=>{var g,f,b;return d.has((g=x.player)==null?void 0:g.id)||l.has((f=x.player)==null?void 0:f.id)?!1:(l.add((b=x.player)==null?void 0:b.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`}async function Pr(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",d=o.soloLevel||1,l=r.replace("vs_ai_",""),s=r;let c=null;if(n){const{data:g}=await h.from("solo_levels").select("*").eq("level_number",d).maybeSingle();c=g||{level_number:d,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const m=o.rankedData||null,y=o.presetSetup||null;async function x({deckId:g,formation:f,starters:b,subsRaw:u,gcCardsEnriched:w,gcDefs:v,stadiumDef:$}){try{let p=Ri(b,f);$&&(p=hi(p,$),vi(u,$));let T=null;if(a){const Z=Rr(p)+Nr(p)*10,{jaune:Q,vert:z}=Gr(p,f),H=[.9,1,1.2],le=H[Math.floor(Math.random()*H.length)],B=Math.max(11,Math.round(Z*le));T={target_note_avg:Math.max(1,Math.round(B/11)),target_total_note:B,nb_liens_jaune:Q,nb_liens_vert:z,nb_joueurs_stade:$?3:0,_variance:le}}const I=c&&{...c,target_total_note:Math.max(11,Math.round((Number(c.target_note_avg)||10)*11))},M=n?await Bo(f,I):a?await Bo(f,T):await Fr(f,l),O=M.lines||M,Y=async Z=>{try{const Q=s==="vs_ai_club"||s==="solo"||s==="ranked_ai"?"club":s,{data:z,error:H}=await h.from("matches").insert({home_id:i.profile.id,away_id:null,mode:Q,home_deck_id:g,status:"in_progress"}).select().single();if(H){console.error("[MatchIA] Erreur création match:",H),Ci(t,"⚠️","Impossible de créer le match ("+H.message+").","Retour",()=>e.navigate("home"));return}const le=M.stadiumDef||null;le&&O&&(hi(O,le),vi(M.subs||[],le));const B={gcDefs:v||[],matchId:z==null?void 0:z.id,mode:s,difficulty:l,formation:f,isSolo:n,soloLevel:d,soloLevelConfig:c,isRankedAI:a,rankedAIData:m,homeTeam:p,aiTeam:O,homeSubs:u,subsUsed:0,maxSubs:Math.min(u.length,3),aiSubs:M.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((M.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:M.gcCards||[],aiUsedGc:[],aiGcTarget:M.gcTarget||2,aiStadiumDef:le,homeScore:0,aiScore:0,gcCards:Z,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Or(t,B,e)}catch(Q){console.error("[MatchIA] Exception launchMatch:",Q),Ci(t,"⚠️","Erreur au lancement du match : "+Q.message,"Retour",()=>e.navigate("home"))}};if(a&&y){Y(y.gcCardsEnriched||[]);return}if(!w.length){Y([]);return}Ii(t,w,Y)}catch(p){console.error("[MatchIA] Exception setup:",p),Ci(t,"⚠️","Erreur de préparation du match : "+p.message,"Retour",()=>e.navigate("home"))}}y?await x(y):await Si(t,e,r,x)}async function Fr(t,e){var b;const{data:i}=await h.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:hn(t),subs:[],gcCards:[],stadiumDef:null};const o=Ht[t]||Ht["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(u,w,v){var $,p;return n.add(u.id),{cardId:"ai-"+u.id+"-"+v,id:u.id,firstname:u.firstname,name:u.surname_real,country_code:u.country_code,club_id:u.club_id,job:u.job,job2:u.job2,note_g:Number(u.note_g)||0,note_d:Number(u.note_d)||0,note_m:Number(u.note_m)||0,note_a:Number(u.note_a)||0,rarity:u.rarity,skin:u.skin,hair:u.hair,hair_length:u.hair_length,face:u.face,clubName:(($=u.clubs)==null?void 0:$.encoded_name)||null,clubLogo:((p=u.clubs)==null?void 0:p.logo_url)||null,boost:0,used:!1,_line:w}}for(const u of["GK","DEF","MIL","ATT"]){const w=i.filter(I=>I.job===u&&!n.has(I.id)),v=i.filter(I=>I.job!==u&&!n.has(I.id)),$=[...w,...v],p=[];for(let I=0;I<o[u];I++){const M=$[I];M&&p.push(a(M,u,I))}const T=St(p.length);p.forEach((I,M)=>{I._col=T[M]}),r[u]=p}const l=i.filter(u=>!n.has(u.id)).slice(0,5).map((u,w)=>a(u,u.job,100+w)),{data:s}=await h.from("gc_definitions").select("*").eq("is_active",!0),m=[...s||[]].sort(()=>Math.random()-.5).slice(0,3).map((u,w)=>({id:"ai-gc-"+w,gc_type:u.name,name:u.name,icon:"⚡",effect_type:u.effect_type,effect_params:u.effect_params||{}})),y=Object.values(r).flat(),x={};y.forEach(u=>{u.club_id&&(x[u.club_id]=(x[u.club_id]||0)+1)});const g=(b=Object.entries(x).sort((u,w)=>w[1]-u[1])[0])==null?void 0:b[0];let f=null;if(g){const{data:u}=await h.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();u&&(f={club_id:u.id,country_code:null,name:u.encoded_name+" Stadium",club:{encoded_name:u.encoded_name,logo_url:u.logo_url}})}return{lines:r,subs:l,gcCards:m,stadiumDef:f}}function Rr(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Nr(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{o!=null&&o.stadiumBonus&&e++});return e}function Gr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((d,l)=>{i[`${a}${l+1}`]=d});const o=Uo(e)||Xi[e]||[];let r=0,n=0;for(const[a,d]of o){const l=i[a],s=i[d];if(!l||!s)continue;const c=Li(l,s);c==="#00ff88"?n++:c==="#FFD700"&&r++}return{jaune:r,vert:n}}function qo(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Zt(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(qo(r)-e)-Math.abs(qo(n)-e));return o.slice(0,Math.min(i,o.length))}async function Bo(t,e){var H,le;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await h.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:hn(t),subs:[],gcCards:[],stadiumDef:null};const d={};a.forEach(B=>{B.club_id&&(d[B.club_id]=(d[B.club_id]||0)+1)});const l=((H=Object.entries(d).sort((B,pe)=>pe[1]-B[1])[0])==null?void 0:H[0])||null,s=l?a.filter(B=>B.club_id===l):[],c=((le=s[0])==null?void 0:le.country_code)||null,m=c?a.filter(B=>B.country_code===c&&B.club_id!==l):[],y=Math.min(s.length,Math.max(2,r+1),16),x=Math.min(m.length,Math.max(0,o),16-y),g=[],f=new Set;Zt(s,i,y).forEach(B=>{g.push(B),f.add(B.id)}),Zt(m,i,x).forEach(B=>{g.push(B),f.add(B.id)});const b=Math.max(0,16-g.length),u=a.filter(B=>!f.has(B.id));Zt(u,i,b).forEach(B=>{g.push(B),f.add(B.id)});const w=Ht[t]||Ht["4-4-2"],v={GK:[],DEF:[],MIL:[],ATT:[]},$=new Set;function p(B,pe,ve){var C,S;return $.add(B.id),{cardId:"ai-"+B.id+"-"+ve,id:B.id,firstname:B.firstname,name:B.surname_real,country_code:B.country_code,club_id:B.club_id,job:B.job,job2:B.job2,note_g:Number(B.note_g)||0,note_d:Number(B.note_d)||0,note_m:Number(B.note_m)||0,note_a:Number(B.note_a)||0,rarity:B.rarity,skin:B.skin,hair:B.hair,hair_length:B.hair_length,face:B.face,clubName:((C=B.clubs)==null?void 0:C.encoded_name)||null,clubLogo:((S=B.clubs)==null?void 0:S.logo_url)||null,boost:0,used:!1,_line:pe}}for(const B of["GK","DEF","MIL","ATT"]){let pe=g.filter(R=>R.job===B&&!$.has(R.id));if(B==="GK"&&!pe.length){const R=a.filter(ie=>ie.job==="GK"&&!$.has(ie.id));R.length&&(pe=Zt(R,i,1))}const ve=g.filter(R=>R.job!==B&&!$.has(R.id)),C=[...pe,...ve],S=[];for(let R=0;R<w[B];R++){const ie=C[R];ie&&S.push(p(ie,B,R))}const X=St(S.length);S.forEach((R,ie)=>{R._col=X[ie]}),v[B]=S}let T=g.filter(B=>!$.has(B.id));if(T.length<5){const B=a.filter(pe=>!$.has(pe.id)&&!T.some(ve=>ve.id===pe.id));T=T.concat(Zt(B,i,5-T.length))}const I=T.slice(0,5).map((B,pe)=>p(B,B.job,100+pe)),M=Number(e==null?void 0:e.target_total_note)||0;if(M>0){const B={GK:"note_g",DEF:"note_d",MIL:"note_m",ATT:"note_a"},pe=[];for(const C of["GK","DEF","MIL","ATT"])(v[C]||[]).forEach(S=>pe.push({p:S,key:B[C]}));const ve=pe.reduce((C,S)=>C+(Number(S.p[S.key])||0),0);if(ve>0&&pe.length){const C=M/ve;pe.forEach(R=>{R.p[R.key]=Math.max(1,Math.round((Number(R.p[R.key])||0)*C))});let S=M-pe.reduce((R,ie)=>R+ie.p[ie.key],0),X=0;for(;S!==0&&X++<500;){const R=pe[Math.floor(Math.random()*pe.length)];S>0?(R.p[R.key]++,S--):R.p[R.key]>1&&(R.p[R.key]--,S++)}I.forEach(R=>{const ie=B[R.job]||"note_m";R[ie]=Math.max(1,Math.round((Number(R[ie])||0)*C))})}}const{data:O}=await h.from("gc_definitions").select("*").eq("is_active",!0),Z=[...O||[]].sort(()=>Math.random()-.5).slice(0,3).map((B,pe)=>({id:"ai-gc-"+pe,gc_type:B.name,name:B.name,icon:"⚡",effect_type:B.effect_type,effect_params:B.effect_params||{}}));let Q=null;if(n>0&&l){const{data:B}=await h.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",l).single();B&&(Q={club_id:B.id,country_code:null,name:B.encoded_name+" Stadium",club:{encoded_name:B.encoded_name,logo_url:B.logo_url}})}const z=1+Math.floor(Math.random()*3);return{lines:v,subs:I,gcCards:Z,stadiumDef:Q,gcTarget:z}}function hn(t){const e=Ht[t]||Ht["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<e[n];l++){const s=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?s:2,note_d:n==="DEF"?s:2,note_m:n==="MIL"?s:2,note_a:n==="ATT"?s:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const d=St(a.length);a.forEach((l,s)=>{l._col=d[s]}),i[n]=a}return i}function Or(t,e,i){var r;Xo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:clamp(6px,1.5vh,20px);padding:clamp(8px,1.5vw,24px);background:#0a3d1e">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,$.style.transition="opacity .45s ease",$.style.opacity="1",$.style.pointerEvents="auto",(p=document.getElementById("start-match-btn"))==null||p.addEventListener("click",x))},600)},700)},2800)}function Ie(t,e,i){var Y,Z,Q,z,H,le,B,pe,ve;const o=e.selected.map(C=>C.cardId),r=e.usedSubIds||[],n=e.homeSubs.filter(C=>!r.includes(C.cardId)),d=Object.values(e.homeTeam).flat().filter(C=>C.used).length>0&&n.length>0&&e.subsUsed<e.maxSubs,l=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(C=>!C.used),s=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(C=>!C.used),c=Ut(e.aiTeam),m=l.length===0&&s.length===0&&!c,y=(e.homeTeam.DEF||[]).filter(C=>!C.used),x=(e.homeTeam.GK||[]).filter(C=>!C.used);let g=[];e.phase==="attack"&&l.length===0&&(c?(g=y.map(C=>C.cardId),y.length===0&&(g=g.concat(x.map(C=>C.cardId)))):m&&(g=[...y,...x].map(C=>C.cardId))),e.log[e.log.length-1];const f=e.phase==="ai-attack"||e.phase==="ai-defense",b=e.phase==="attack",u=e.phase==="defense",w=e.phase==="finished",$=(e.homeSubs||[]).filter(C=>!(e.usedSubIds||[]).includes(C.cardId)).length>0&&e.subsUsed<e.maxSubs,p=b&&l.length===0&&g.length===0&&!$,T=e.gcCards.filter(C=>!e.usedGc.includes(C.id)),I=e.boostCard&&!e.boostUsed;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column",t.innerHTML=`
  <style>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(e.phase==="defense"&&e.pendingAttack){const S=e.pendingAttack;let X="";if(e.selected.length>0){const R=e.selected.map(fe=>({...(e.homeTeam[fe._role]||[]).find(be=>be.cardId===fe.cardId)||fe,_line:fe._role})),ie=li(R,e.modifiers.home,e.formation);X=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Qe(R.map(fe=>({...fe,used:!1})),"#3a7bd5",ie.total,"defense",e.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Qe((S.players||[]).map(X=>({...X,used:!1})),"#00ff88",S.total,"attack",e.formation)}</div>
          </div>`}if(e.phase==="attack"&&e.selected.length>0){const S=e.selected.map(R=>{const ie=(e.homeTeam[R._role]||[]).find(he=>he.cardId===R.cardId)||R,fe=["GK","DEF"].includes(R._role);return{...ie,_line:R._role,...fe?{note_a:Math.max(1,Number(ie.note_a)||0)}:{}}}),X=di(S,e.modifiers.home,e.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Qe(S.map(R=>({...R,used:!1})),"#FFD700",X.total,"attack",e.formation)}</div>
          </div>`}const C=e.log[e.log.length-1];return C?'<div style="padding:2px 4px">'+bn(C)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const C=window.innerWidth>=700,S=(xe,me,ke)=>{var N,W;const k=(e.gcDefs||[]).find(de=>de.name===xe.gc_type),j=(k==null?void 0:k.name)||xe.gc_type,K=(k==null?void 0:k.effect)||((N=Oe[xe.gc_type])==null?void 0:N.desc)||"",G=k!=null&&k.image_url?`/icons/${k.image_url}`:null,V=((W=Oe[xe.gc_type])==null?void 0:W.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${xe.id}" data-gc-type="${xe.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${it(j,G,V,K,{width:me})}
        </div>`},X=(xe,me)=>{var ke;return`<div id="boost-card"
          style="box-sizing:border-box;width:${xe}px;height:${me}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(me*.04)}px;text-align:center;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${e.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...e.log].reverse().map(C=>{var S,X,R;if(C.type==="duel"){const ie=C.isGoal,fe=C.homeScored?"#FFD700":ie?"#ff6b6b":"rgba(255,255,255,0.3)",he=C.homeScored?"⚽ BUT !":ie?"⚽ BUT IA !":(S=C.homePlayers)!=null&&S.length?"⚔️ Attaque":"🛡️ Défense",be=(C.homeTotal??0)>=(C.aiTotal??0);return`<div style="padding:8px;border-radius:8px;background:${ie?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${fe};margin-bottom:4px">
                ...
                <div style="display:flex;align-items:center;justify-content:center;gap:10px">
                  ${(X=C.aiPlayers)!=null&&X.length?`<div style="flex:1;display:flex;justify-content:flex-end;opacity:0.75">${Qe(C.aiPlayers,"#ff6b6b",void 0,void 0,e.formation)}</div>`:'<div style="flex:1"></div>'}
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${C.outPlayer?wt({...C.outPlayer,used:!0,_line:C.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${C.inPlayer?wt({...C.inPlayer,_line:C.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
    ...
    </div>`,document.body.appendChild(o),setTimeout(()=>{o.remove(),e()},2100)}function uo(t,e,i){po(e,i,null),Yr(e,()=>{Jr(e,()=>{Ie(t,e,i),Qr(t,e,i)})})}function Qr(t,e,i){let o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(l=>!l.used),r=!1;if(!o.length){const l=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(c=>!c.used),s=Ut(e.homeTeam);if(s||l.length===0){const c=(e.aiTeam.DEF||[]).filter(y=>!y.used),m=(e.aiTeam.GK||[]).filter(y=>!y.used);o=s?c.length?c:m:[...c,...m],r=!0}}const n=Yo(o,"attack",e.difficulty);if(!n.length){Ki(t,e,i);return}r&&n.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const a=di(n,e.modifiers.ai,e.formation);if(e.pendingAttack={...a,players:n,side:"ai"},n.forEach(l=>{l.used=!0}),e.log.push({text:`🤖 IA attaque : ${a.total} (${n.map(l=>l.name).join(", ")})`,type:"info"}),e.modifiers.ai={},[...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(l=>!l.used).length===0){if(n.length===1&&(n[0]._line==="GK"||n[0].job==="GK")&&Ut(e.homeTeam)&&e.homeScore===e.aiScore){e.aiScore++,Ei(t,e,i,"ai",n[0]);return}e.aiScore++;const s={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:n.map(c=>Ve(c)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};e.log.push(s),e.pendingAttack=null,Ie(t,e,i),Ze(s.aiPlayers,e.homeScore,e.aiScore,!1,()=>{Mt(t,e,i,"home-attack")});return}e.phase="defense",Ie(t,e,i)}function Zr(t,e,i){var s,c;const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],r=Yo(o,"defense",e.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(m=>(e.aiTeam[m]||[]).filter(y=>!y.used)).length){const m=((s=e.pendingAttack)==null?void 0:s.players)||[];if(m.length===1&&(m[0]._line==="GK"||m[0].job==="GK")&&e.homeScore===e.aiScore){e.homeScore++,Ei(t,e,i,"home",m[0]);return}e.homeScore++;const x={type:"duel",isGoal:!0,homeScored:!0,homePlayers:m.map(g=>Ve(g)),homeTotal:((c=e.pendingAttack)==null?void 0:c.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};e.log.push(x),e.modifiers.ai={},e.pendingAttack=null,Ie(t,e,i),Ze(x.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}const a=r.length>0?li(r,e.modifiers.ai,e.formation).total:0;r.forEach(m=>{m.used=!0});const d=Zi(e.pendingAttack.total,a,e.modifiers.ai),l={type:"duel",title:"Attaque",homePlayers:(e.pendingAttack.players||[]).map(m=>Ve(m)),aiPlayers:r.map(m=>Ve(m)),homeTotal:e.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(d.shielded)l.text="🛡️ Bouclier IA !",e.log.push(l);else if(d.goal){e.homeScore++,l.isGoal=!0,l.homeScored=!0,l.text=`⚽ BUT ! (${e.pendingAttack.total} > ${a})`,e.log.push(l),e.modifiers.ai={},e.pendingAttack=null,Ie(t,e,i),Ze(l.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}else l.text=`🧤 IA défend (${a} ≥ ${e.pendingAttack.total})`,e.log.push(l);e.modifiers.ai={},e.pendingAttack=null,Mt(t,e,i,"ai-attack")}function Mt(t,e,i,o){if(e.round++,!vn(t,e,i)){if(fo(e)){ht(t,e,i);return}if(o==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(a=>!a.used))){Ki(t,e,i);return}e.phase="attack",Ie(t,e,i)}else{if(!["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(a=>!a.used))){Ki(t,e,i);return}e.phase="ai-attack",Ie(t,e,i),setTimeout(()=>uo(t,e,i),800)}}}function Ut(t){return!["GK","DEF","MIL","ATT"].some(e=>(t[e]||[]).some(i=>!i.used))}function Do(t){const e=(t.GK||[]).some(o=>!o.used),i=["DEF","MIL","ATT"].some(o=>(t[o]||[]).some(r=>!r.used));return e&&!i}function vn(t,e,i){if(e.homeScore!==e.aiScore)return!1;if(Do(e.homeTeam)&&Ut(e.aiTeam)){const o=(e.homeTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.homeScore++,Ei(t,e,i,"home",o),!0):!1}if(Do(e.aiTeam)&&Ut(e.homeTeam)){const o=(e.aiTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.aiScore++,Ei(t,e,i,"ai",o),!0):!1}return!1}function Ei(t,e,i,o,r){e.log.push({type:"duel",isGoal:!0,homeScored:o==="home",homePlayers:o==="home"?[Ve(r)]:[],aiPlayers:o==="ai"?[Ve(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${o==="home"?"":"adverse "}marque !`});const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(n);const a=(d,l)=>new Promise(s=>{n.innerHTML=`<div style="font-size:32px;font-weight:900;color:${l};letter-spacing:2px;animation:lcFade 1.4s ease both">${d}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(s,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),n.remove(),e.pendingAttack=null,Ie(t,e,i),Ze([Ve(r)],e.homeScore,e.aiScore,o==="home",()=>{if(fo(e)){ht(t,e,i);return}Mt(t,e,i,o==="home"?"ai-attack":"home-attack")})))()}function fo(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used));return!e&&!i}function Ui(t,e){return!(["MIL","ATT"].some(r=>(t[r]||[]).some(n=>!n.used))||Ut(e)||!["MIL","ATT"].some(r=>(e[r]||[]).some(n=>!n.used)))}function Ki(t,e,i){if(!vn(t,e,i)){if(fo(e)){ht(t,e,i);return}if(Ui(e.homeTeam,e.aiTeam)&&Ui(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(t,e,i);return}e.phase="attack",Ie(t,e,i)}}function Di(t,e,i,o=null,r=null){var x,g;if(e.phase!=="attack"){Et("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(e.usedSubIds||(e.usedSubIds=[]),e.subsUsed>=e.maxSubs){Et(`Maximum ${e.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const n=Object.entries(e.homeTeam).flatMap(([f,b])=>(b||[]).filter(u=>u.used).map(u=>({...u,_line:u._line||f}))),a=e.homeSubs.filter(f=>!e.usedSubIds.includes(f.cardId));if(!n.length){Et("Aucun joueur utilisé à remplacer");return}if(!a.length){Et("Aucun remplaçant disponible");return}let d=Math.max(0,n.findIndex(f=>f.cardId===r));const l=((x=n[d])==null?void 0:x._line)||((g=n[d])==null?void 0:g.job);let s=o?Math.max(0,a.findIndex(f=>f.cardId===o)):Math.max(0,a.findIndex(f=>f.job===l)),c=!1;const m=document.createElement("div");m.id="sub-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function y(){var p,T,I,M,O,Y;const f=n[d],b=a[s],u=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(u*1.35),v=Z=>`background:rgba(255,255,255,0.12);border:none;color:${Z?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Z?"default":"pointer"};flex-shrink:0`;m.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${f?wt({...f,used:!1,boost:0},u,w):"<div>—</div>"}</div>
    ...
    </div>`,(p=m.querySelector("#sub-close"))==null||p.addEventListener("click",()=>m.remove()),(T=m.querySelector("#out-up"))==null||T.addEventListener("click",()=>{d>0&&(d--,y())}),(I=m.querySelector("#out-down"))==null||I.addEventListener("click",()=>{d<n.length-1&&(d++,y())}),(M=m.querySelector("#in-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,y())}),(O=m.querySelector("#in-down"))==null||O.addEventListener("click",()=>{s<a.length-1&&(s++,y())});const $=(Z,Q,z,H)=>{const le=m.querySelector("#"+Z);if(!le)return;let B=0;le.addEventListener("touchstart",pe=>{B=pe.touches[0].clientY},{passive:!0}),le.addEventListener("touchend",pe=>{const ve=pe.changedTouches[0].clientY-B;if(Math.abs(ve)<30)return;const C=Q();ve<0&&C<H-1?(z(C+1),y()):ve>0&&C>0&&(z(C-1),y())},{passive:!0})};$("in-panel",()=>s,Z=>s=Z,a.length),$("out-panel",()=>d,Z=>d=Z,n.length),(Y=m.querySelector("#sub-confirm"))==null||Y.addEventListener("click",Z=>{if(Z.preventDefault(),Z.stopPropagation(),c)return;c=!0;const Q=n[d],z=a[s];if(!Q||!z)return;let H=null,le=-1;for(const[pe,ve]of Object.entries(e.homeTeam)){const C=(ve||[]).findIndex(S=>S.cardId===Q.cardId);if(C!==-1){H=pe,le=C;break}}if(le===-1||!H){Et("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),m.remove();return}const B={...z,_line:H,_col:Q._col||0,used:!1,boost:0};e.homeTeam[H].splice(le,1,B),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(z.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:Q.name,firstname:Q.firstname,note:jt(Q,H),portrait:Ct(Q),job:Q.job,country_code:Q.country_code,rarity:Q.rarity,clubName:Q.clubName,clubLogo:Q.clubLogo},inPlayer:{name:z.name,firstname:z.firstname,note:jt(z,H),portrait:Ct(z),job:z.job,country_code:z.country_code,rarity:z.rarity,clubName:z.clubName,clubLogo:z.clubLogo},text:`🔄 ${z.firstname} ${z.name} remplace ${Q.firstname} ${Q.name}`}),m.remove(),yn(Q,z,()=>Ie(t,e,i))})}document.body.appendChild(m),y()}function ea(t,e,i,o,r){var y,x;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},d=(n==null?void 0:n.name)||e,l=(n==null?void 0:n.effect)||a.desc,s=n!=null&&n.image_url?`/icons/${n.image_url}`:null,c=a.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ${it(d,s,c,l,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(m),(y=m.querySelector("#gc-back"))==null||y.addEventListener("click",()=>m.remove()),(x=m.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{m.remove(),ia(t,e,i,o,r)})}function bi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let d=[];function l(){var s,c;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(m=>{const y=m._line||m.job||"MIL",x=d.find(f=>f.cardId===m.cardId),g=qe({...m,_evolution_bonus:0},{width:90,showStad:!0,role:y,extraNote:m.boost||0});return`<div class="gc-pick-item" data-cid="${m.cardId}"
          style="position:relative;border-radius:8px;${x?"outline:3px solid #FFD700;outline-offset:2px;":""}cursor:pointer;flex-shrink:0;${m.used?"opacity:0.3;pointer-events:none":""}">
          ${g}
        </div>`}).join("")}
    </div>
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
    ...
    </div>`,document.body.appendChild(m),(x=document.getElementById("res-home"))==null||x.addEventListener("click",()=>{m.remove(),ot(t),i.navigate("home")}),(g=document.getElementById("res-replay"))==null||g.addEventListener("click",async()=>{if(m.remove(),ot(t),e.isRankedAI){const{data:b}=await h.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",i.state.profile.id).single();ct(),i.navigate("match",{matchMode:"ranked",rankedData:{mmr:(b==null?void 0:b.mmr)??1e3,rd:(b==null?void 0:b.mmr_deviation)??350,sigma:(b==null?void 0:b.mmr_volatility)??.06,isPlacement:((b==null?void 0:b.placement_matches)??0)<10}});return}i.navigate("match",e.isSolo?{matchMode:e.mode,soloLevel:e.soloLevel}:{matchMode:e.mode})}),(f=document.getElementById("res-next-level"))==null||f.addEventListener("click",()=>{m.remove(),ot(t),i.navigate("match",{matchMode:"solo",soloLevel:e.soloLevel+1})})}function na(t,e){e.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${Qi(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ra={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function aa(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}async function sa(t,e){!t||!e||await Promise.all([Po(t,"win"),Po(e,"loss")])}async function Po(t,e){const{data:i}=await h.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",t).eq("card_type","player");if(!(i!=null&&i.length))return;const o=i.filter(r=>{var n,a;return((n=r.player)==null?void 0:n.rarity)==="pepite"||((a=r.player)==null?void 0:a.rarity)==="papyte"});o.length&&await Promise.all(o.map(r=>{const n=ra[r.player.rarity],a=e==="win"?n.win:n.loss,d=r.player.note_min??1,l=r.player.note_max??10,s=aa(r.player),c=r.current_note??s,m=Math.min(l,Math.max(d,c+a));return h.from("cards").update({current_note:m}).eq("id",r.id)}))}const Rt=t=>gn(t);async function qt(t,e,i,o,r={}){return wn(t,e,i,o,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function la(t,e,i){const{data:o}=await h.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!o){e.toast("Match introuvable","error"),e.navigate("home");return}const r=o.home_id===e.state.user.id;let n=null,a=null;if(o.mode==="mini_league"){const{data:d}=await h.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();d&&(n=d.league_id,a=d.id)}return wn(t,e,i,r,[],[],o.is_ranked||!1,null,null,null,n,a)}async function wn(t,e,i,o,r=[],n=[],a=!1,d=null,l=null,s=null,c=null,m=null){const{state:y,navigate:x,toast:g}=e,f=o?"p1":"p2",b=o?"p2":"p1",u=(r||[]).map(_=>_.id),w=(r||[]).map(_=>({id:_.id,gc_type:_.gc_type,_gcDef:_._gcDef||null}));t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:v}=await h.from("matches").select("*").eq("id",i).single();if(!v){g("Match introuvable","error"),x("home");return}async function $(){var ze,Le;console.log("[PvP] buildGameState match:",{id:v.id,home_deck_id:v.home_deck_id,away_deck_id:v.away_deck_id,mode:v.mode,is_ranked:v.is_ranked});const[{data:_,error:E},{data:A,error:q},{data:L},{data:P}]=await Promise.all([h.rpc("get_deck_for_match",{p_deck_id:v.home_deck_id}),h.rpc("get_deck_for_match",{p_deck_id:v.away_deck_id}),h.from("users").select("id,pseudo,club_name").eq("id",v.home_id).single(),h.from("users").select("id,pseudo,club_name").eq("id",v.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",E==null?void 0:E.message,"p2:",q==null?void 0:q.message,"p1D:",(ze=_==null?void 0:_.starters)==null?void 0:ze.length,"p2D:",(Le=A==null?void 0:A.starters)==null?void 0:Le.length);const D=re=>{const Me=Number(re.evolution_bonus)||0;return{cardId:re.card_id,position:re.position,id:re.id,firstname:re.firstname,name:re.surname_real,country_code:re.country_code,club_id:re.club_id,job:re.job,job2:re.job2,note_g:(Number(re.note_g)||0)+(re.job==="GK"||re.job2==="GK"&&Number(re.note_g)>0?Me:0),note_d:(Number(re.note_d)||0)+(re.job==="DEF"||re.job2==="DEF"&&Number(re.note_d)>0?Me:0),note_m:(Number(re.note_m)||0)+(re.job==="MIL"||re.job2==="MIL"&&Number(re.note_m)>0?Me:0),note_a:(Number(re.note_a)||0)+(re.job==="ATT"||re.job2==="ATT"&&Number(re.note_a)>0?Me:0),evolution_bonus:Me,rarity:re.rarity,skin:re.skin,hair:re.hair,hair_length:re.hair_length,face:re.face||null,clubName:re.club_encoded_name||null,clubLogo:re.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},F=((_==null?void 0:_.starters)||[]).map(re=>D(re)),U=((A==null?void 0:A.starters)||[]).map(re=>D(re)),J=(_==null?void 0:_.formation)||"4-4-2",ne=(A==null?void 0:A.formation)||"4-4-2";let te=Ri(F,J),oe=Ri(U,ne);const se=((_==null?void 0:_.subs)||[]).map(re=>D(re)),ce=((A==null?void 0:A.subs)||[]).map(re=>D(re)),Ee=(_==null?void 0:_.stadium_def)||(o?l:null),ge=(A==null?void 0:A.stadium_def)||(o?null:l);return Ee&&(te=hi(te,Ee),vi(se,Ee)),ge&&(oe=hi(oe,ge),vi(ce,ge)),{p1Team:te,p2Team:oe,p1Subs:se,p2Subs:ce,p1Formation:J,p2Formation:ne,p1Name:(L==null?void 0:L.club_name)||(L==null?void 0:L.pseudo)||"Joueur 1",p2Name:(P==null?void 0:P.club_name)||(P==null?void 0:P.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?u:[],gc_p2:o?[]:u,gcCardsFull_p1:o?w:[],gcCardsFull_p2:o?[]:w,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:n||[],lastActionAt:new Date().toISOString()}}let p=v.game_state&&Object.keys(v.game_state).length?v.game_state:null;if(console.log("[PvP] init - amIHome:",o,"gameState exists:",!!p,"match.status:",v.status,"home_id:",v.home_id,"away_id:",v.away_id,"myId:",y.profile.id),!p)if(o){p=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((p==null?void 0:p.p1Team)||{}));const{data:_}=await h.from("matches").select("game_state").eq("id",i).single();!(_!=null&&_.game_state)||!Object.keys(_.game_state).length?await h.from("matches").update({game_state:p,turn_user_id:v.home_id}).eq("id",i):p=_.game_state}else{t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let _=0;_<30&&!p;_++){await new Promise(A=>setTimeout(A,400));const{data:E}=await h.from("matches").select("game_state").eq("id",i).single();E!=null&&E.game_state&&Object.keys(E.game_state).length&&(p=E.game_state),_%5===0&&console.log("[PvP] away - poll",_,"game_state:",!!(E!=null&&E.game_state))}if(!p){g("Erreur de synchronisation","error"),x("home");return}p.gc_p2=u,p.gcCardsFull_p2=w,await h.from("matches").update({game_state:p}).eq("id",i)}let T=!1,I=null,M=!1;const O=new Set,Y=new Set;async function Z(_){var ne,te;Nt();try{h.removeChannel(Q)}catch{}const E=p[f+"Score"]||0,A=p[b+"Score"]||0;let q,L;_.winner_id?(q=_.winner_id===y.profile.id,L=!1):_.forfeit?(q=E>A,L=!1):(L=E===A,q=E>A);let P="";if(a&&o)try{const{data:oe}=await h.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.home_id).single(),{data:se}=await h.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.away_id).single();if(oe&&se){const ce=q?1:L?.5:0,Ee=1-ce,ge=oe.placement_matches<10,ze=se.placement_matches<10,Le=computeGlicko2(oe.mmr,oe.mmr_deviation,oe.mmr_volatility,se.mmr,se.mmr_deviation,ce===1?1:ce===0?0:.5,ge),re=computeGlicko2(se.mmr,se.mmr_deviation,se.mmr_volatility,oe.mmr,oe.mmr_deviation,Ee===1?1:Ee===0?0:.5,ze);await h.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:L?null:q?v.home_id:v.away_id,p_home_id:v.home_id,p_away_id:v.away_id,p_home_delta:Le.delta,p_away_delta:re.delta,p_home_new_rd:Le.newRd,p_away_new_rd:re.newRd,p_home_new_vol:Le.newSigma,p_away_new_vol:re.newSigma});const Me=Le.delta,Ne=Le.newMmr,Ce=getTier(Ne),Ye=Me>=0?"+":"",He=Me>=0?"#4caf50":"#ff6b6b",nt=getTier(oe.mmr);P=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Ce.id!==nt.id?`<div style="font-size:20px;font-weight:900;color:${Ce.color}">
                    ${Ne>oe.mmr?"📈":"📉"} ${nt.emoji} ${nt.label} → ${Ce.emoji} ${Ce.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ne>oe.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Me>=0?"📈":"📉"}</div>
                   <div style="font-size:18px;font-weight:900;color:${Ce.color}">${Ce.emoji} ${Ce.label}</div>`}
              ${ge?`<div style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:6px">Match de placement (${oe.placement_matches+1}/10)</div>`:""}
            </div>`}}catch(oe){console.error("[Ranked] MMR update error:",oe)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const D=document.createElement("div");D.id="pvp-end-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const F=L?"🤝":q?"🏆":"😞",U=L?"MATCH NUL":q?"VICTOIRE !":"DÉFAITE",J=L?"#fff":q?"#FFD700":"#ff6b6b";D.innerHTML=`
      ...
      <div style="font-size:18px">${p[f+"Name"]} ${E} – ${A} ${p[b+"Name"]}</div>
      ${_.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${q?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${P}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${c?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(te=D.querySelector("#pvp-end-home"))==null||te.addEventListener("click",()=>{D.remove(),ot(t),c?x("mini-league",{openLeagueId:c}):x(a?"ranked":"home")})}const Q=h.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var A;const E=_.new;try{if(E.status==="finished"||E.forfeit){if(T)return;T=!0,I&&(clearInterval(I),I=null),Ke(),E.game_state&&(p=E.game_state),Z(E);return}if(E.game_state){const q=p;p=E.game_state;const L=p._lastGC;if(L&&L.seq&&!Y.has(L.seq)&&(Y.add(L.seq),L.by!==f)){fe(L.type,L.by,()=>S());return}const P=q[f+"Score"]||0,D=q[b+"Score"]||0,F=p[f+"Score"]||0,U=p[b+"Score"]||0,J=F>P,ne=U>D;if((J||ne)&&!O.has(p.round)){O.add(p.round);const te=[...p.log||[]].reverse().find(ce=>ce.isGoal),oe=((te==null?void 0:te.homePlayers)||[]).map(ce=>({name:ce.name,note:ce.note,portrait:ce.portrait,job:ce.job}));!!((A=te==null?void 0:te.text)!=null&&A.includes("DERNIER CORNER"))?K().then(()=>{Ze(oe,F,U,J,()=>S())}):Ze(oe,F,U,J,()=>S());return}S()}}catch(q){console.error("[PvP] crash:",q)}}).subscribe();async function z(_){Object.assign(p,_),p.lastActionAt=new Date().toISOString();const{error:E}=await h.from("matches").update({game_state:p}).eq("id",i);E&&g("Erreur de synchronisation","error");try{S()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function H(){if(T)return;T=!0,Nt(),Ke(),I&&(clearInterval(I),I=null);const _=o?v.away_id:v.home_id,E=o?"p2":"p1",A=o?"p1":"p2",q={...p,[E+"Score"]:3,[A+"Score"]:0,phase:"finished"},L=q.p1Score||0,P=q.p2Score||0;try{await h.from("matches").update({game_state:q}).eq("id",i);const{data:D,error:F}=await h.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:L,p_away_score:P,p_forfeit:!0});if(F&&console.error("[PvP] finish_pvp_match (forfeit):",F),c)try{await h.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await h.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{h.removeChannel(Q)}catch{}setTimeout(()=>{ot(t),c?x("mini-league",{openLeagueId:c}):x("home")},800)}const le={BOOST_STAT:({value:_=1,count:E=1,roles:A=[]},q,L)=>{const P=q[f+"Team"],D=Object.entries(P).filter(([F])=>!A.length||A.includes(F)).flatMap(([F,U])=>U.filter(J=>!J.used).map(J=>({...J,_line:F})));if(!D.length){q.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),L(q);return}B(D,E,`Choisir ${E} joueur(s) à booster (+${_})`,F=>{F.forEach(U=>{const J=(P[U._line]||[]).find(ne=>ne.cardId===U.cardId);J&&(J.boost=(J.boost||0)+_,q.log.push({text:`⚡ +${_} sur ${J.name}`,type:"info"}))}),q[f+"Team"]=P,L(q)})},DEBUFF_STAT:({value:_=1,count:E=1,roles:A=[],target:q="ai"},L,P)=>{const D=q==="home"?f:b,F=L[D+"Team"],U=q==="home"?"allié":"adverse",J=Object.entries(F).filter(([ne])=>!A.length||A.includes(ne)).flatMap(([ne,te])=>te.map(oe=>({...oe,_line:ne})));if(!J.length){L.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),P(L);return}B(J,E,`Choisir ${E} joueur(s) ${U}(s) (-${_})`,ne=>{ne.forEach(te=>{const oe=(F[te._line]||[]).find(se=>se.cardId===te.cardId);oe&&(oe.boost=(oe.boost||0)-_,L.log.push({text:`🎯 -${_} sur ${oe.name}`,type:"info"}))}),L[D+"Team"]=F,P(L)})},GRAY_PLAYER:({count:_=1,roles:E=[],target:A="ai"},q,L)=>{const P=A==="home"?f:b,D=q[P+"Team"],F=A==="home"?"allié":"adverse",U=Object.entries(D).filter(([J])=>!E.length||E.includes(J)).flatMap(([J,ne])=>ne.filter(te=>!te.used).map(te=>({...te,_line:J})));if(!U.length){q.log.push({text:`❌ Aucun joueur ${F}`,type:"info"}),L(q);return}B(U,_,`Choisir ${_} joueur(s) ${F}(s) à exclure`,J=>{const ne="usedCardIds_"+P,te=new Set(q[ne]||[]);J.forEach(oe=>{const se=(D[oe._line]||[]).find(ce=>ce.cardId===oe.cardId);se&&(se.used=!0,te.add(oe.cardId),q.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),q[ne]=[...te],q[P+"Team"]=D,L(q)})},REVIVE_PLAYER:({count:_=1,roles:E=[]},A,q)=>{const L=A[f+"Team"],P=Object.entries(L).filter(([D])=>!E.length||E.includes(D)).flatMap(([D,F])=>F.filter(U=>U.used).map(U=>({...U,_line:D})));if(!P.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),q(A);return}B(P,_,`Choisir ${_} joueur(s) à ressusciter`,D=>{D.forEach(F=>{const U=(L[F._line]||[]).find(J=>J.cardId===F.cardId);U&&(U.used=!1,A.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),A[f+"Team"]=L,q(A)})},REMOVE_GOAL:({},_,E)=>{const A=b+"Score";_[A]>0?(_[A]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(_)},ADD_GOAL_DRAW:({},_,E)=>{_[f+"Score"]===_[b+"Score"]?(_[f+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(_)},ADD_SUB:({value:_=1},E,A)=>{E.maxSubs=(E.maxSubs||3)+_,E.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),A(E)},CUSTOM:({},_,E)=>E(_)};function B(_,E,A,q){const L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let P=[];function D(){var U,J;const F=_.map(ne=>{const te=ne._line||ne.job||"MIL",oe=P.find(ce=>ce.cardId===ne.cardId),se=qe({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:te,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(U=L.querySelector("#pp-close"))==null||U.addEventListener("click",()=>L.remove()),L.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const te=ne.dataset.cid,oe=_.find(ce=>ce.cardId===te),se=P.findIndex(ce=>ce.cardId===te);oe&&(se>-1?P.splice(se,1):P.length<E&&P.push(oe),D())})}),(J=L.querySelector("#pp-confirm"))==null||J.addEventListener("click",()=>{L.remove(),q(P)})}D(),document.body.appendChild(L)}async function pe(_,E){const q=(p["gcCardsFull_"+f]||[]).find(F=>F.id===_),L=(q==null?void 0:q._gcDef)||(p.gcDefs||[]).find(F=>{var U;return F.name===E||((U=F.name)==null?void 0:U.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),P=[...p["usedGc_"+f]||[],_],D={type:E,by:f,seq:(p._gcAnimSeq||0)+1};Y.add(D.seq),fe(E,f,async()=>{if(L!=null&&L.effect_type&&L.effect_type!=="CUSTOM"){const U=le[L.effect_type];if(U){const J={...p};U(L.effect_params||{},J,async ne=>{ne["usedGc_"+f]=P,ne._lastGC=D,ne._gcAnimSeq=D.seq,await z(ne)});return}}const F={...p};switch(E){case"Remplacement+":F.maxSubs=(F.maxSubs||3)+1,F.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=b+"Score";F[U]>0&&(F[U]--,F.log.push({text:"🚫 But annulé",type:"info"}));break}}F["usedGc_"+f]=P,F._lastGC=D,F._gcAnimSeq=D.seq,await z(F)})}function ve(_,E){const A="usedCardIds_"+_,q=new Set(p[A]||[]);E.forEach(L=>q.add(L)),p[A]=[...q]}function C(){for(const _ of["p1","p2"]){const E=new Set(p["usedCardIds_"+_]||[]),A=p[_+"Team"];if(A)for(const q of["GK","DEF","MIL","ATT"])(A[q]||[]).forEach(L=>{L.used=E.has(L.cardId)})}}function S(){var bo,yo,xo,ho,vo,wo;if(p.phase==="reveal")return X();if(p.phase==="midfield")return ie();if(p.phase==="finished")return we();const _=p[f+"Team"],E=p[b+"Team"];C();const A=p[f+"Score"],q=p[b+"Score"],L=p[f+"Name"],P=p[b+"Name"],D=p.phase===f+"-attack",F=p.phase===f+"-defense",U=Array.isArray(p["selected_"+f])?p["selected_"+f]:[],J=U.map(ee=>ee.cardId),ne=window.innerWidth>=700,te=p[f+"Subs"]||[],oe=p["usedSubIds_"+f]||[],se=te.filter(ee=>!oe.includes(ee.cardId)),ce=p["gcCardsFull_"+f]||[],Ee=p["usedGc_"+f]||[],ge=ce.filter(ee=>!Ee.includes(ee.id)),ze=p.boostOwner===f&&!p.boostUsed,Le=[..._.MIL||[],..._.ATT||[]].filter(ee=>!ee.used),re=[...E.MIL||[],...E.ATT||[]].filter(ee=>!ee.used),Me=!de(E),Ne=Le.length===0&&re.length===0&&!Me,Ce=(_.DEF||[]).filter(ee=>!ee.used),Ye=(_.GK||[]).filter(ee=>!ee.used);let He=[];D&&Le.length===0&&(Me?(He=Ce.map(ee=>ee.cardId),Ce.length===0&&(He=He.concat(Ye.map(ee=>ee.cardId)))):Ne&&(He=[...Ce,...Ye].map(ee=>ee.cardId)));function nt(ee,$e,De){var Pe,ft;const Te=ee._gcDef,Pt=(Te==null?void 0:Te.name)||ee.gc_type,st=(Te==null?void 0:Te.effect)||((Pe=Oe[ee.gc_type])==null?void 0:Pe.desc)||"",Re=Te!=null&&Te.image_url?`/icons/${Te.image_url}`:null,Ge=((ft=Oe[ee.gc_type])==null?void 0:ft.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}" style="flex-shrink:0;cursor:pointer">
        ${it(Pt,Re,Ge,st,{width:$e})}
      </div>`}function Yt(ee,$e){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${ee}px;height:${$e}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round($e*.04)}px;text-align:center;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${si(_,p[f+"Formation"],ut,J,ne?1300:At(),ne?600:Gt(),He)}
      </div>
    </div>`,at=p[f+"Team"],Sn=(()=>{var $e,De,Te,Pt,st;if(F&&(($e=p.pendingAttack)!=null&&$e.players)){const Re=p.pendingAttack;let Ge="";if(U.length>0){const Pe=U.map(Je=>{const Wt=(at[Je._role]||[]).find(Mi=>Mi.cardId===Je.cardId)||Je,Jt=at[Je._role]||[],ui=Jt.findIndex(Mi=>Mi.cardId===Je.cardId),Ai=St(Jt.length),Xt=ui>=0?Ai[ui]:Wt._col??1;return{...Wt,_line:Je._role,_col:Xt}}),ft=li(Pe,((De=p.modifiers)==null?void 0:De[f])||{},p[f+"Formation"]);Ge=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
        ...
        </div>`}if(D&&!((Pt=p.pendingAttack)!=null&&Pt.players)&&U.length>0){const Re=U.map(Pe=>{const ft=(at[Pe._role]||[]).find(Xt=>Xt.cardId===Pe.cardId)||Pe,Je=["GK","DEF"].includes(Pe._role),Wt=at[Pe._role]||[],Jt=Wt.findIndex(Xt=>Xt.cardId===Pe.cardId),ui=St(Wt.length),Ai=Jt>=0?ui[Jt]:ft._col??1;return{...ft,_line:Pe._role,_col:Ai,...Je?{note_a:Math.max(1,Number(ft.note_a)||0)}:{}}}),Ge=di(Re,((st=p.modifiers)==null?void 0:st[f])||{},p[f+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
        ...
        </div>`}const ee=(p.log||[]).slice(-1)[0];return ee?'<div style="padding:2px 4px">'+bn(ee)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),go=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      </div>`;function Dt(){const ee=t.querySelector(".match-screen");if(!ee)return;const $e=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ee.style.height=$e+"px",ee.style.minHeight=$e+"px",ee.style.maxHeight=$e+"px",ee.style.overflow="hidden";const De=t.querySelector("#mobile-action-bar"),Te=t.querySelector("#mobile-play-area");De&&Te&&(Te.style.paddingBottom=De.offsetHeight+"px")}if(Dt(),setTimeout(Dt,120),setTimeout(Dt,400),M||(M=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Dt),window.visualViewport.addEventListener("scroll",Dt)),window.addEventListener("resize",Dt)),function(){const $e=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!$e)return;const De=$e.closest("#match-terrain-wrap");De&&(De.style.cssText="position:relative;width:100%;height:100%;padding:0"),$e.removeAttribute("width"),$e.removeAttribute("height"),$e.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",$e.setAttribute("preserveAspectRatio","xMidYMid meet")}(),p._pvpResizeBound||(p._pvpResizeBound=!0,window.addEventListener("resize",()=>{const ee=t.querySelector(".terrain-wrapper svg");if(ee){const $e=ee.closest("#match-terrain-wrap");$e&&($e.style.cssText="position:relative;width:100%;height:100%;padding:0"),ee.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t.querySelectorAll(".match-slot-hit").forEach(ee=>{ee.addEventListener("click",()=>{if(!D&&!F)return;const $e=ee.dataset.cardId,De=ee.dataset.role,Te=(_[De]||[]).find(Ge=>Ge.cardId===$e);if(!Te||Te.used)return;const Pt=He.includes($e);if(D&&!["MIL","ATT"].includes(De)&&!Pt)return;Array.isArray(p["selected_"+f])||(p["selected_"+f]=[]);const st=p["selected_"+f],Re=st.findIndex(Ge=>Ge.cardId===$e);Re>-1?st.splice(Re,1):st.length<3&&st.push({...Te,_role:De}),S()})}),t.querySelectorAll(".match-used-hit").forEach(ee=>{ee.addEventListener("click",()=>je(ee.dataset.cardId))}),t.querySelectorAll(".pvp-sub-btn").forEach(ee=>{ee.addEventListener("click",()=>je())}),(bo=t.querySelector("#pvp-sub-open"))==null||bo.addEventListener("click",()=>je()),t.querySelectorAll(".pvp-gc-mini").forEach(ee=>{D?ee.addEventListener("click",()=>he(ee.dataset.gcId,ee.dataset.gcType)):(ee.style.opacity="0.35",ee.style.cursor="default",ee.addEventListener("click",()=>Et("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(yo=t.querySelector("#pvp-boost-card"))==null||yo.addEventListener("click",()=>be()),(xo=t.querySelector("#pvp-action"))==null||xo.addEventListener("click",ee=>{D?ee.currentTarget.dataset.pass==="1"||!ue(f)?ke():V():F&&N()}),(ho=t.querySelector("#pvp-quit"))==null||ho.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&H()}),(vo=t.querySelector("#pvp-view-opp"))==null||vo.addEventListener("click",()=>xe()),(wo=t.querySelector("#pvp-toggle-history"))==null||wo.addEventListener("click",()=>me()),I&&(clearInterval(I),I=null),Ke(),(D||F)&&!T){let ee=30,$e=!1;const De=()=>document.getElementById("pvp-timer"),Te=()=>{De()&&(De().textContent=ee+"s",De().style.color=$e?"#ff4444":"#fff")};Te(),I=setInterval(()=>{ee--,ee<0?$e?(clearInterval(I),I=null,Ke(),D&&!ue(f)?ke():H()):($e=!0,ee=15,Te(),Qo("/sounds/timer-urgent.mp3",.6)):Te()},1e3)}}function X(){It(t),t.innerHTML=`
    ...
    </div>`;const _=t.querySelector("svg"),E=_==null?void 0:_.closest("#match-terrain-wrap");E&&(E.style.cssText="position:relative;width:100%;height:100%;padding:0"),_&&(_.removeAttribute("width"),_.removeAttribute("height"),_.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",_.setAttribute("preserveAspectRatio","xMidYMid meet")),f==="p1"&&setTimeout(async()=>{await z({phase:"midfield"})},5e3)}let R=!1;function ie(){if(R)return;const _=p[f+"Team"].MIL||[],E=p[b+"Team"].MIL||[],A=yt(_)+xt(_),q=yt(E)+xt(E),L=A>=q;It(t),t.innerHTML=`
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${$i(_,p[f+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
        <div id="pvp-score-me" style="font-size:48px;font-weight:900;color:#D4A017;transition:all .5s ease">0</div>
        <div id="pvp-vs" style="font-size:14px;color:rgba(255,255,255,.4);letter-spacing:3px;opacity:0">VS</div>
        <div id="pvp-score-opp" style="font-size:48px;font-weight:900;color:rgba(255,255,255,.7);transition:all .5s ease">0</div>
      </div>
      ${$i(E,p[b+"Name"]||"Adversaire","#e03030","opp",null)}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const P=(se,ce)=>t.querySelectorAll(se).forEach((Ee,ge)=>{setTimeout(()=>{Ee.style.opacity="1",Ee.style.transform="translateY(0) scale(1)"},ce+ge*90)});P(".duel-card-me",150),P(".duel-card-opp",500),setTimeout(()=>t.querySelectorAll(".duel-link").forEach((se,ce)=>setTimeout(()=>{se.style.opacity="1"},ce*70)),900),setTimeout(()=>{const se=t.querySelector("#pvp-vs");se&&(se.style.opacity="1",se.style.animation="vsFlash .5s ease"),t.querySelectorAll(".duel-score-line").forEach(ce=>ce.style.opacity="1")},1250);function D(se,ce,Ee){const ge=document.getElementById(se);if(!ge)return;const ze=performance.now(),Le=re=>{const Me=Math.min(1,(re-ze)/Ee);ge.textContent=Math.round(ce*(1-Math.pow(1-Me,3))),Me<1?requestAnimationFrame(Le):ge.textContent=ce};requestAnimationFrame(Le)}setTimeout(()=>{D("pvp-score-me",A,800),D("pvp-score-opp",q,800)},1500);const F=p.p1Team.MIL||[],U=p.p2Team.MIL||[],J=yt(F)+xt(F),ne=yt(U)+xt(U),te=J>=ne?"p1":"p2";let oe=p.boostValue;oe==null&&(oe=Ko(),p.boostValue=oe,p.boostOwner=te,p.boostUsed=!1),R=!0,setTimeout(()=>{const se=t.querySelector("#duel-row-"+(L?"me":"opp")),ce=t.querySelector("#duel-row-"+(L?"opp":"me")),Ee=document.getElementById("pvp-score-me"),ge=document.getElementById("pvp-score-opp"),ze=L?Ee:ge,Le=L?ge:Ee;ze&&(ze.style.fontSize="80px",ze.style.color=L?"#FFD700":"#ff6b6b",ze.style.animation="duelPulse .5s ease"+(L?",duelGlow 1.5s ease infinite .5s":"")),Le&&(Le.style.opacity="0.25"),setTimeout(()=>{se&&(se.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",se.style.zIndex="5"),setTimeout(()=>{const re=document.getElementById("duel-shock");re&&(re.style.animation="shockwave .5s ease-out forwards"),ce&&(ce.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Ce;const re=document.getElementById("pvp-duel-finale");if(!re)return;const Me=p.boostOwner===f?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+oe+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ne=f==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;re.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(L?"⚽ "+p[f+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+p[b+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Me+Ne,re.style.transition="opacity .45s ease",re.style.opacity="1",re.style.pointerEvents="auto",(Ce=document.getElementById("pvp-start-match"))==null||Ce.addEventListener("click",async()=>{const Ye=te;await z({phase:Ye+"-attack",attacker:Ye,round:1,boostValue:oe,boostUsed:!1,boostOwner:Ye})})},600)},700)},2800)}function fe(_,E,A){var ce,Ee;const q=(p.gcDefs||[]).find(ge=>{var ze;return ge.name===_||((ze=ge.name)==null?void 0:ze.toLowerCase().trim())===(_==null?void 0:_.toLowerCase().trim())}),L={purple:"#b06ce0",light_blue:"#00d4ef"}[q==null?void 0:q.color]||"#b06ce0",P=(q==null?void 0:q.name)||_,D=(q==null?void 0:q.effect)||((ce=Oe[_])==null?void 0:ce.desc)||"",F=q!=null&&q.image_url?`/icons/${q.image_url}`:null,U=((Ee=Oe[_])==null?void 0:Ee.icon)||"⚡",ne=E===f?"Vous":p[E+"Name"]||"Adversaire",te=document.createElement("div");te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",te.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:${L};letter-spacing:3px;text-transform:uppercase;font-weight:700;animation:gcLabel .4s ease both">${ne} joue une carte</div>
      <div style="animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        ${it(P,F,U,D,{width:200})}
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(te);let oe=!1;const se=()=>{oe||(oe=!0,te.remove(),setTimeout(()=>A&&A(),50))};te.addEventListener("click",se),setTimeout(se,3e3)}function he(_,E){var ne,te,oe,se;const q=(p["gcCardsFull_"+f]||[]).find(ce=>ce.id===_),L=q==null?void 0:q._gcDef,P=(L==null?void 0:L.name)||E,D=(L==null?void 0:L.effect)||((ne=Oe[E])==null?void 0:ne.desc)||"Carte spéciale.",F=L!=null&&L.image_url?`/icons/${L.image_url}`:null,U=((te=Oe[E])==null?void 0:te.icon)||"⚡",J=document.createElement("div");J.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",J.innerHTML=`
      ${it(P,F,U,D,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(J),(oe=J.querySelector("#pvp-gc-back"))==null||oe.addEventListener("click",()=>J.remove()),(se=J.querySelector("#pvp-gc-use"))==null||se.addEventListener("click",()=>{J.remove(),pe(_,E)})}function be(){var q;const _=p[f+"Team"],E=Object.entries(_).flatMap(([L,P])=>(P||[]).filter(D=>!D.used).map(D=>({...D,_line:L})));if(!E.length)return;const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",A.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${E.map(L=>{const P={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",D=jt(L,L._line)+(L.boost||0);return`<div class="bp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${P};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(A),(q=A.querySelector("#bp-close"))==null||q.addEventListener("click",()=>A.remove()),A.querySelectorAll(".bp-item").forEach(L=>{L.addEventListener("click",async()=>{const P=L.dataset.cid,D=E.find(U=>U.cardId===P);if(!D)return;const F=(_[D._line]||[]).find(U=>U.cardId===P);F&&(F.boost=(F.boost||0)+p.boostValue),A.remove(),await z({[f+"Team"]:_,boostUsed:!0})})})}function je(_=null){var se,ce;if(!(p.phase===f+"-attack")){g("Remplacement uniquement avant votre attaque","warning");return}const A=p[f+"Team"],q=p["usedSubIds_"+f]||[],L=p.maxSubs||3;if(q.length>=L){g(`Maximum ${L} remplacements atteint`,"warning");return}const P=Object.entries(A).flatMap(([Ee,ge])=>(ge||[]).filter(ze=>ze.used).map(ze=>({...ze,_line:Ee}))),D=(p[f+"Subs"]||[]).filter(Ee=>!q.includes(Ee.cardId));if(!P.length){g("Aucun joueur utilisé à remplacer","warning");return}if(!D.length){g("Aucun remplaçant disponible","warning");return}let F=Math.max(0,P.findIndex(Ee=>Ee.cardId===_));const U=((se=P[F])==null?void 0:se._line)||((ce=P[F])==null?void 0:ce.job);let J=Math.max(0,D.findIndex(Ee=>Ee.job===U)),ne=!1;const te=document.createElement("div");te.id="pvp-sub-overlay",te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function oe(){var Ne,Ce,Ye,He,nt,Yt;const Ee=P[F],ge=D[J],ze=Math.min(130,Math.round((window.innerWidth-90)/2)),Le=Math.round(ze*1.35),re=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;te.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
        <div style="flex:1;font-size:15px;font-weight:900;color:#fff">🔄 Remplacement (${q.length}/${L})</div>
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${ge?wt({...ge,used:!1,boost:0},ze,Le):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${Ee?wt({...Ee,used:!1,boost:0},ze,Le):"<div>—</div>"}</div>
      ...
      </div>`,(Ne=te.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>te.remove()),(Ce=te.querySelector("#pout-up"))==null||Ce.addEventListener("click",()=>{F>0&&(F--,oe())}),(Ye=te.querySelector("#pout-down"))==null||Ye.addEventListener("click",()=>{F<P.length-1&&(F++,oe())}),(He=te.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{J>0&&(J--,oe())}),(nt=te.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{J<D.length-1&&(J++,oe())});const Me=(Fe,We,Ue,pt)=>{const rt=te.querySelector("#"+Fe);if(!rt)return;let Bt=0;rt.addEventListener("touchstart",ut=>{Bt=ut.touches[0].clientY},{passive:!0}),rt.addEventListener("touchend",ut=>{const $t=ut.changedTouches[0].clientY-Bt;if(Math.abs($t)<30)return;const at=We();$t<0&&at<pt-1?(Ue(at+1),oe()):$t>0&&at>0&&(Ue(at-1),oe())},{passive:!0})};Me("pin-panel",()=>J,Fe=>J=Fe,D.length),Me("pout-panel",()=>F,Fe=>F=Fe,P.length),(Yt=te.querySelector("#psub-confirm"))==null||Yt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),ne)return;ne=!0;const We=P[F],Ue=D[J];if(!We||!Ue)return;const pt=We._line,rt=(A[pt]||[]).findIndex($t=>$t.cardId===We.cardId);if(rt===-1){g("Erreur : joueur introuvable","error"),te.remove();return}const Bt={...Ue,_line:pt,position:We.position,used:!1,boost:0};A[pt].splice(rt,1,Bt);const ut=[...q,Ue.cardId];te.remove(),Be(We,Ue,async()=>{await z({[f+"Team"]:A,[b+"Team"]:p[b+"Team"],["usedSubIds_"+f]:ut})})})}document.body.appendChild(te),oe()}function Be(_,E,A){const q={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const P=(U,J,ne)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${J};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${ne}</div>
      <div style="width:70px;height:70px;border-radius:50%;background:${q[U.job]||"#555"};border:3px solid ${J};position:relative;overflow:hidden;margin:0 auto">
      ...
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(_),(E=_.querySelector("#pvp-opp-close"))==null||E.addEventListener("click",()=>_.remove())}function me(){var A;const _=p.log||[],E=document.createElement("div");E.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",E.innerHTML=`
      ...
      </div>`,document.body.appendChild(E),(A=E.querySelector("#pvp-hist-close"))==null||A.addEventListener("click",()=>E.remove())}async function ke(){if(p.phase!==f+"-attack")return;const _=f==="p1"?"p2":"p1",E=(p.round||0)+1,A=[...p.log||[]];A.push({type:"info",text:`⏭️ ${p[f+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const q=Se(p),L=ue(_),P=q||!L?"finished":_+"-attack";await z({["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:P,attacker:_,round:E,log:A}),P==="finished"&&await ye(p)}function k(_){const E=(_.GK||[]).some(q=>!q.used),A=["DEF","MIL","ATT"].some(q=>(_[q]||[]).some(L=>!L.used));return E&&!A}function j(_){return(_.p1Score||0)!==(_.p2Score||0)?null:k(_.p1Team)&&!de(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:k(_.p2Team)&&!de(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function K(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(A,q)=>new Promise(L=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${q};letter-spacing:2px;animation:lcFade 1.4s ease both">${A}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(L,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function G(_,E){const{side:A,gk:q}=_;if(!q)return;const L=A+"Score",P=(E[L]||0)+1;q.used=!0;const D=[...E.log||[]];D.push({type:"duel",isGoal:!0,homeScored:A===f,homePlayers:A==="p1"?[Rt(q)]:[],aiPlayers:A==="p2"?[Rt(q)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[A+"Name"]} marque !`});const F=(E.round||0)+1,U=A==="p1"?"p2":"p1",J={...E,[L]:P},ne=Se(J);O.add(F),await K();const te=A===f?P:E[f+"Score"]||0,oe=A===f?E[b+"Score"]||0:P;Ze([Rt(q)],te,oe,A===f,async()=>{await z({[L]:P,log:D,round:F,pendingAttack:null,phase:ne?"finished":U+"-attack",attacker:U,["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}}}),ne&&await ye({...p,[L]:P})})}async function V(){const _=p[f+"Team"],E=!["GK","DEF","MIL","ATT"].some(P=>(p[b+"Team"][P]||[]).some(D=>!D.used)),A=(p["selected_"+f]||[]).map(P=>{const D=(_[P._role]||[]).find(ce=>ce.cardId===P.cardId)||P,F=["GK","DEF"].includes(P._role),U=_[P._role]||[],J=U.findIndex(ce=>ce.cardId===P.cardId),ne=St(U.length),te=J>=0?ne[J]:D._col??1,oe=p.stadiumDef||p.homeStadiumDef||null,se=D.stadiumBonus||oe&&(oe.club_id&&String(D.club_id)===String(oe.club_id)||oe.country_code&&D.country_code===oe.country_code)||!1;return{...D,_line:P._role,_col:te,stadiumBonus:se,...F?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!A.length)return;const q=di(A,p.modifiers[f]||{},p[f+"Formation"]);ve(f,A.map(P=>P.cardId)),A.forEach(P=>{const D=(_[P._role]||[]).find(F=>F.cardId===P.cardId);D&&(D.used=!0)}),p["selected_"+f]=[],S();const L=[...p.log||[]];if(E){if(A.length===1&&(A[0]._line==="GK"||A[0].job==="GK")&&(p.p1Score||0)===(p.p2Score||0)){await G({side:f,gk:A[0]},{...p,[f+"Team"]:_,log:L});return}const D=(p[f+"Score"]||0)+1,F=A.map(oe=>Rt(oe));L.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:F,homeTotal:q.total,aiTotal:0});const U=(p.round||0)+1,J=f==="p1"?"p2":"p1",ne={...p,[f+"Team"]:_,[f+"Score"]:D},te=Se(ne);O.add(U),Ze(F,D,p[b+"Score"]||0,!0,async()=>{await z({[f+"Team"]:_,[f+"Score"]:D,["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:te?"finished":J+"-attack",attacker:J,round:U,log:L}),te&&await ye({...p,[f+"Score"]:D})});return}L.push({type:"pending",text:`⚔️ ${p[f+"Name"]} attaque (${q.total})`}),await z({[f+"Team"]:_,[b+"Team"]:p[b+"Team"],pendingAttack:{...q,players:A,side:f},["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},phase:b+"-defense",log:L})}async function N(){const _=p[f+"Team"],E=(p["selected_"+f]||[]).map(ge=>{const ze=(_[ge._role]||[]).find(Ce=>Ce.cardId===ge.cardId)||ge,Le=_[ge._role]||[],re=Le.findIndex(Ce=>Ce.cardId===ge.cardId),Me=St(Le.length),Ne=re>=0?Me[re]:ze._col??1;return{...ze,_line:ge._role,_col:Ne}}),A=li(E,p.modifiers[f]||{},p[f+"Formation"]);ve(f,E.map(ge=>ge.cardId)),E.forEach(ge=>{const ze=(_[ge._role]||[]).find(Le=>Le.cardId===ge.cardId);ze&&(ze.used=!0)}),p["selected_"+f]=[],S();const q=Zi(p.pendingAttack.total,A.total,p.modifiers[f]||{}),L=p.pendingAttack.side,P=q==="attack"||(q==null?void 0:q.goal),D=L==="p1"?"p2":"p1",F=(p.round||0)+1,U=(p.pendingAttack.players||[]).map(ge=>Rt(ge)),J=[...p.log||[]];J.push({type:"duel",isGoal:P,homeScored:P&&L===f,text:P?`⚽ BUT de ${p[L+"Name"]} ! (${p.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${A.total})`,homePlayers:U,aiPlayers:E.map(ge=>Rt(ge)),homeTotal:p.pendingAttack.total,aiTotal:A.total});const ne=P?(p[L+"Score"]||0)+1:p[L+"Score"]||0,te={...p,[f+"Team"]:_,[L+"Score"]:ne},oe=Se(te),se=oe?"finished":D+"-attack",ce=!oe&&!P?j(te):null,Ee=async()=>{if(ce){await G(ce,te);return}await z({[f+"Team"]:_,[b+"Team"]:p[b+"Team"],[L+"Score"]:ne,["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:se,attacker:D,round:F,log:J}),(se==="finished"||oe)&&await ye({...p,[L+"Score"]:ne})};if(P){const ge=L===f,ze=ge?ne:p[f+"Score"]||0,Le=ge?p[b+"Score"]||0:ne;O.add(F),Ze(U,ze,Le,ge,Ee)}else await Ee()}function W(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(A=>!A.used))}function de(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(A=>!A.used))}function ae(_){return de(_)&&!W(_)}function ue(_){const E=p[_+"Team"],A=p[(_==="p1"?"p2":"p1")+"Team"];return!!(W(E)||ae(E)&&!de(A)||ae(E)&&!W(A)&&de(A))}function Se(_){return!de(_.p1Team)&&!de(_.p2Team)}function Ae(_){const E=_.p1Score||0,A=_.p2Score||0;return E===A?null:E>A?v.home_id:v.away_id}async function ye(_){Nt(),Ke();try{const E=Ae(_),A=E?v.home_id===E?v.away_id:v.home_id:null,q=_.p1Score||0,L=_.p2Score||0,{data:P,error:D}=await h.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:q,p_away_score:L,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),c)try{await h.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(F){console.error("[PvP] check_and_finish_mini_league:",F)}E&&A&&sa(E,A).catch(()=>{});try{const{data:F}=await h.rpc("apply_match_rewards",{p_match_id:i});F!=null&&F.success&&!(F!=null&&F.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(F){console.error("[PvP] apply_match_rewards:",F)}if(typeof s=="function")try{await s({homeScore:q,awayScore:L,winnerId:E,homeId:v.home_id,awayId:v.away_id,matchId:i})}catch(F){console.error("[PvP] onMatchEnd:",F)}}catch(E){console.error("[PvP] finishMatch:",E)}}function we(){var L;const _=p[f+"Score"],E=p[b+"Score"],A=_>E,q=_===E;It(t),t.innerHTML=`
    ...
    </div>`,(L=document.getElementById("pvp-home"))==null||L.addEventListener("click",()=>{try{h.removeChannel(Q)}catch{}ot(t),c?x("mini-league",{openLeagueId:c}):x("home")})}S()}async function Vi(t,e,i=!1){var d,l;const{state:o,navigate:r,toast:n}=e,a=i&&((l=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:l.rankedData)||null;await Si(t,e,i?"ranked":"random",async({deckId:s,formation:c,starters:m,subsRaw:y,gcCardsEnriched:x,gcDefs:g,stadiumDef:f})=>{It(t);const b=async u=>{await ca(t,e,s,c,m,y,u||[],g,f,i,a)};if(!(x!=null&&x.length)){await b([]);return}Ii(t,x,b)})}async function da(t,e,i){return la(t,e,i)}async function ca(t,e,i,o,r,n,a=[],d=[],l=null,s=!1,c=null){var Z,Q;const{state:m,navigate:y,toast:x}=e,g=(c==null?void 0:c.mmr)??((Z=m.profile)==null?void 0:Z.mmr)??1e3,f=s?Lt(g):null,b=s?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",u=s?(f==null?void 0:f.color)||"#D4A017":"#FFD700";let w=!1,v=null,$=null;t.innerHTML=`
    ...
    </div>`;const p=async()=>{w=!0,v&&(v.unsubscribe(),v=null),$&&(clearInterval($),$=null);try{await h.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(z){console.error("[Matchmaking] cancel error:",z)}};(Q=document.getElementById("cancel-mm"))==null||Q.addEventListener("click",async()=>{await p(),ot(t),y("home")});const T=async(z,H)=>{w||(w=!0,v&&(v.unsubscribe(),v=null),$&&(clearInterval($),$=null),await qt(t,e,z,H,{myGC:a,gcDefs:d,stadiumDef:l,isRanked:s,rankedData:c,onMatchEnd:s?pa:null}))},I=m.user.id,{data:M,error:O}=s?await h.rpc("try_matchmake_ranked",{p_user_id:I,p_deck_id:i,p_mmr:g,p_range:200}):await h.rpc("try_matchmake",{p_user_id:I,p_deck_id:i});if(O||!(M!=null&&M.success)){console.error("[Matchmaking] try_matchmake error:",O||M),x("Erreur de matchmaking","error"),ot(t),y("home");return}if(M.matched){await T(M.match_id,!1);return}const Y=async()=>{if(w)return;const{data:z}=await h.from("matchmaking_queue").select("status, match_id").eq("user_id",I).maybeSingle();(z==null?void 0:z.status)==="matched"&&z.match_id&&await T(z.match_id,!0)};v=h.channel(`mm_${I}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${I}`},z=>{const H=z.new;H.status==="matched"&&H.match_id&&T(H.match_id,!0)}).subscribe(),$=setInterval(Y,3e3),s?setTimeout(async()=>{if(!w){w=!0,v&&(v.unsubscribe(),v=null),$&&(clearInterval($),$=null);try{await h.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(z){console.error("[Matchmaking] cancel error:",z)}x("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),y("match",{matchMode:"ranked_ai",rankedData:c,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:d,stadiumDef:l}})}},2e4):setTimeout(()=>{w||p()},12e4)}async function pa(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:d,awayScore:l,matchId:s}=t,c=i.user.id,m=n===c,y=r===c,{data:x}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",c).single(),{data:g}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",m?a:n).single();if(x&&g){const f=Vo(x.mmr,x.mmr_rd,x.mmr_v,g.mmr,g.mmr_rd,y?1:0);await h.from("users").update({mmr:f.mmr,mmr_rd:f.rd,mmr_v:f.v,mmr_wins:y?h.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:h.sql`mmr_losses + 1`}).eq("id",c),o(y?`+MMR ↑ ${Math.round(f.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-f.mmr)}`,y?"success":"error",4e3)}}const ua=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Vi,resumePvpMatch:da},Symbol.toStringTag,{value:"Module"}));async function fa(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,d=n.friendName||"Ami",l=!!n.isAccepting;await Si(t,e,"friend",async({deckId:s,formation:c,starters:m,subsRaw:y,gcCardsEnriched:x,gcDefs:g,stadiumDef:f})=>{It(t);const b=async u=>{const w=u||[];l?await ga(t,e,s,w,g,f):await ma(t,e,s,w,g,f,a,d)};if(!(x!=null&&x.length)){await b([]);return}Ii(t,x,b)})}async function ma(t,e,i,o,r,n,a,d){var w;const{state:l,navigate:s,toast:c}=e,m=l.user.id,{data:y,error:x}=await h.from("friend_match_invites").insert({inviter_id:m,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!y){console.error("[Friend] Erreur création invitation:",x),c("Impossible de créer l'invitation","error"),s("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${ti};border:1px solid ${ii};border-radius:12px;padding:16px">
        ...
        <div style="font-size:12px;color:${zt};margin-bottom:10px">💰 ${f} cr./joueur → Pot estimé : ${(f*m.length).toLocaleString("fr")} cr. (🥇${Math.floor(f*m.length*.7).toLocaleString("fr")} · 🥈${Math.floor(f*m.length*.2).toLocaleString("fr")} · 🥉${Math.floor(f*m.length*.1).toLocaleString("fr")})</div>
        ${m.map(z=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${Tt}">
            <div style="width:36px;height:36px;border-radius:50%;background:${z.club_color2||_n};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${z.club_color1||"#fff"}">${(z.pseudo||"?").slice(0,2).toUpperCase()}</div>
            <div style="flex:1"><div style="font-size:13px;font-weight:700;color:${Xe}">${z.club_name||z.pseudo}</div><div style="font-size:11px;color:${et}">@${z.pseudo}</div></div>
      ...
      <div style="background:${ti};border:1px solid ${ii};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((z,H)=>{const le=g>0&&a.status==="finished"?H===0?Math.floor(g*.7):H===1?Math.floor(g*.2):H===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${Tt};${z.userId===n?"background:rgba(74,222,128,0.08);":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${H===0?lt:H<3?"#4ade80":zt}">${["🥇","🥈","🥉"][H]||H+1}</td>
              <td style="padding:7px 3px"><div style="font-weight:700;color:${Xe}">${z.clubName}</div><div style="font-size:10px;color:${et}">@${z.pseudo}</div></td>
              <td style="text-align:center;color:${zt}">${z.played}</td><td style="text-align:center;color:${zt}">${z.won}-${z.drawn}-${z.lost}</td>
              ...
              ${g>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${lt}">${le?le.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:${ti};border:1px solid ${ii};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(z,H)=>H+1).reverse().map(z=>{const H=(l||[]).filter(le=>le.matchday===z);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${et};margin-bottom:6px">Journée ${z}</div>${H.map(le=>Fo(le,m,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const v=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if(($=document.getElementById("ml-back"))==null||$.addEventListener("click",()=>tt(t,e,v)),(p=document.getElementById("ml-refresh"))==null||p.addEventListener("click",async z=>{const H=z.currentTarget;H.style.opacity="0.5",await dt(t,e,i)}),(T=document.getElementById("ml-start-btn"))==null||T.addEventListener("click",()=>Ea(t,e,a,m)),(I=document.getElementById("ml-next-day"))==null||I.addEventListener("click",()=>za(t,e,i)),(M=document.getElementById("ml-join-now"))==null||M.addEventListener("click",()=>$n(t,e,i,a.type)),(O=document.getElementById("ml-leave-btn"))==null||O.addEventListener("click",()=>ka(t,e,i,f)),(Y=document.getElementById("ml-delete-btn"))==null||Y.addEventListener("click",()=>Yi(t,e,i,a.name,"waiting")),(Z=document.getElementById("ml-delete-now"))==null||Z.addEventListener("click",()=>Yi(t,e,i,a.name,v)),(Q=document.getElementById("ml-archive-btn"))==null||Q.addEventListener("click",()=>$a(t,e,i)),t.querySelectorAll("[data-play-match]").forEach(z=>{z.addEventListener("click",()=>{const H=x.find(le=>le.id===z.dataset.playMatch);H&&(ct(),e.navigate("match-mini-league",{mlMatchId:H.id,leagueId:i}))})}),a.status==="finished"&&w){const z=y.findIndex(H=>H.userId===n);z>=0&&z<3&&w.prize_amount>0&&!w.prize_claimed&&setTimeout(()=>La(t,e,a,w,z),400)}}function Fo(t,e,i,o,r=!1){const n=m=>e.find(y=>y.id===m);if(t.is_bye){const m=n(t.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${zt};text-align:center">🔵 ${(m==null?void 0:m.club_name)||(m==null?void 0:m.pseudo)||"?"} exempté(e)</div>`}const a=n(t.home_id),d=n(t.away_id),l=t.home_id===i||t.away_id===i,s=l&&t.status==="pending"&&o&&!r,c=t.status==="finished"?`${t.home_score} - ${t.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${l?"rgba(74,222,128,0.35)":Tt}">
    ...
    </div>`;let c=!1;const m=async b=>{if(!c){if(c=!0,clearInterval(g),x)try{x.unsubscribe()}catch{}b&&await qt(t,e,b,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:d}),l()}};(f=document.getElementById("wait-back"))==null||f.addEventListener("click",()=>{if(c=!0,clearInterval(g),x)try{x.unsubscribe()}catch{}s("mini-league",{openLeagueId:o}),l()});const y=async()=>{if(c)return;const{data:b}=await h.from("mini_league_matches").select("match_id").eq("id",i).single();b!=null&&b.match_id&&m(b.match_id)},x=h.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},b=>{var u;(u=b.new)!=null&&u.match_id&&m(b.new.match_id)}).subscribe(),g=setInterval(y,3e3);y()})}const No={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function yi(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function Aa(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await mo(t,e)}async function mo(t,e){const{state:i,toast:o,navigate:r}=e;Kt(r,i.profile,"market","/icons/",o);const{data:n}=await h.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let s="buy";const c=()=>{var b,u,w,v,$,p,T;return{name:(((b=document.getElementById("flt-name"))==null?void 0:b.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((w=document.getElementById("flt-country"))==null?void 0:w.value)||"").toLowerCase().trim(),job:((v=document.getElementById("flt-job"))==null?void 0:v.value)||"",rarity:(($=document.getElementById("flt-rarity"))==null?void 0:$.value)||"",note1:parseInt((p=document.getElementById("flt-note1"))==null?void 0:p.value)||0,note2:parseInt((T=document.getElementById("flt-note2"))==null?void 0:T.value)||0}};function m(b){const u=c();return b.filter(w=>{var Y,Z,Q;const v=(Y=w.card)==null?void 0:Y.player;if(!v)return!1;const $=`${v.firstname} ${v.surname_real}`.toLowerCase(),p=(((Z=v.clubs)==null?void 0:Z.encoded_name)||"").toLowerCase(),T=(v.country_code||"").toLowerCase(),I=((Q=w.card)==null?void 0:Q.evolution_bonus)||0,M=yi(v,v.job,I),O=v.job2?yi(v,v.job2,I):0;return!(u.name&&!$.includes(u.name)||u.club&&!p.includes(u.club)||u.country&&!T.includes(u.country)||u.job&&v.job!==u.job||u.rarity&&v.rarity!==u.rarity||u.note1&&M<u.note1||u.note2&&O<u.note2)})}function y(b){var p,T,I;const u=(p=b.card)==null?void 0:p.player;if(!u)return"";const w=((T=b.card)==null?void 0:T.evolution_bonus)||0,v=(i.profile.credits||0)>=b.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function x(b){var Z,Q,z,H;const u=(Z=b.card)==null?void 0:Z.player;if(!u)return"";const w=((Q=b.card)==null?void 0:Q.evolution_bonus)||0,v=yi(u,u.job,w),$=u.job2?yi(u,u.job2,w):0,p=b.status==="sold",T=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,I=No[u.job]||"#bbb",M=u.job2?No[u.job2]||"#bbb":null,O=u.job==="GK"?"#fff":I,Y=u.job2==="GK"?"#fff":M;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${p?"opacity:0.7":""}">
      ...
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${I};display:flex;align-items:center;justify-content:center">
          <span style="font-size:14px;font-weight:900;color:${O};font-family:Arial Black,Arial">${v}</span>
        </div>
        ${$?`<div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
          <span style="font-size:14px;font-weight:900;color:${Y};font-family:Arial Black,Arial">${$}</span>
        </div>`:""}
      </div>
      <div style="flex:1;min-width:0">
    ...
    </div>`}function g(){const b=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(b){if(u.style.display=s==="buy"?"flex":"none",s==="buy"){const w=m(d);b.innerHTML=w.length?`<div class="mkt-buy-grid">${w.map(y).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const w=l.filter($=>$.status==="active").sort(($,p)=>new Date(p.listed_at)-new Date($.listed_at)),v=l.filter($=>$.status==="sold").sort(($,p)=>new Date(p.sold_at||p.listed_at)-new Date($.sold_at||$.listed_at));b.innerHTML=(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${w.length})</div>`+w.map(x).join(""):"")+(v.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${v.length})</div>`+v.map(x).join(""):"")+(!w.length&&!v.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}b.querySelectorAll("[data-buy]").forEach(w=>w.addEventListener("click",()=>Ma(w.dataset.buy,d,t,e))),b.querySelectorAll("[data-cancel]").forEach(w=>w.addEventListener("click",()=>ja(w.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(b=>{b.addEventListener("click",()=>{s=b.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(u=>{const w=u===b;u.style.background=w?"var(--green)":"var(--tile-bg)",u.style.color=w?"#fff":"var(--tile-fg-dim)",u.style.borderColor=w?"var(--green)":"var(--tile-border)"}),g()})});let f;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(b=>{var u;(u=document.getElementById(b))==null||u.addEventListener("input",()=>{clearTimeout(f),f=setTimeout(g,250)})}),g()}async function Ma(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,d=e.find(c=>c.id===t);if(!d)return;const l=d.price;if((r.profile.credits||0)<l){n("Crédits insuffisants","error");return}Ca(d,async()=>{const{error:c}=await h.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:r.profile.id});if(c){n("Erreur achat : "+c.message,"error");return}await a();const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await mo(i,o)})}function Ca(t,e){var a;const i=(a=t.card)==null?void 0:a.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
    ...
    </div>`,document.body.appendChild(r);const n=d=>{r.remove(),d&&e()};r.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),r.addEventListener("click",d=>{d.target===r&&n(!1)})}async function ja(t,e,i){const{toast:o}=i,{data:r}=await h.from("market_listings").select("card_id").eq("id",t).single();if(await h.from("market_listings").update({status:"cancelled"}).eq("id",t),r!=null&&r.card_id){const{count:n}=await h.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");n||await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}o("Annonce retirée","success"),mo(e,i)}async function qa(t,e){var x,g,f,b,u;const{state:i,navigate:o}=e,r=((g=(x=e==null?void 0:e.state)==null?void 0:x.params)==null?void 0:g.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:a},{data:d}]=await Promise.all([h.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").order("mmr",{ascending:!1}).limit(100),h.rpc("get_mini_league_leaderboard"),h.rpc("get_random_leaderboard")]);let l=r;const s=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",c=w=>w<3?"#000":"#fff";function m(){var $,p,T;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=l==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const v=document.getElementById("rankings-list");if(v){if(l==="ranked"){const I=n||[];v.innerHTML=I.length>0?I.map((M,O)=>{const Y=Lt(M.mmr??1e3),Z=(M.ranked_wins||0)+(M.ranked_losses||0)+(M.ranked_draws||0),Q=Z>0?Math.round((M.ranked_wins||0)/Z*100):0,z=M.id===i.profile.id,H=(M.placement_matches||0)<10;return`
          <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${z?"border:2px solid var(--yellow)":""}">
            <div style="width:32px;height:32px;border-radius:50%;background:${O<3?["#D4A017","#a0a0a0","#cd7f32"][O]:"rgba(255,255,255,0.08)"};color:${O<3?"#000":"var(--tile-fg-on-page)"};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${O<3?"16":"13"}px">${O<3?["🥇","🥈","🥉"][O]:O+1}</div>
            <div style="flex:1;min-width:0">
              ...
              <div style="font-size:11px;color:var(--tile-fg-dim)">${M.club_name} · ${Y.label}</div>
            </div>
            <div style="text-align:right;flex-shrink:0">
              <div style="font-size:20px">${H?"❓":Y.emoji}</div>
              <div style="font-size:11px;font-weight:700;color:${Y.color}">${H?"Placement":Y.label}</div>
              ${H?"":`<div style="font-size:10px;color:var(--tile-fg-dim)">${Q}% WR</div>`}
            </div>
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(l==="mini-league"){const I=a||[];v.innerHTML=I.length>0?I.map((M,O)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${M.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${s(O)};color:${c(O)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${O<3?"16":"13"}px">${O<3?["🥇","🥈","🥉"][O]:O+1}</div>
          <div style="flex:1;min-width:0">
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const I=d||[];v.innerHTML=I.length>0?I.map((M,O)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${M.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${s(O)};color:${c(O)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${O<3?"16":"13"}px">${O<3?["🥇","🥈","🥉"][O]:O+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${M.pseudo}</div>
  ...
  <div class="page">
  ...
  </div>`,m(),(f=document.getElementById("tab-ranked"))==null||f.addEventListener("click",()=>{l="ranked",m()}),(b=document.getElementById("tab-mini-league"))==null||b.addEventListener("click",()=>{l="mini-league",m()}),(u=document.getElementById("tab-random"))==null||u.addEventListener("click",()=>{l="random",m()})}async function Ba(t,e){var T,I,M,O;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:d}]=await Promise.all([h.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),h.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!d){r("Erreur chargement profil","error"),o("home");return}if(!a){const Y=d.mmr??1e3,Z=Lt(Y);Fi(Y);const Q=Math.round(1e3+(Y-1e3)*.5),z=Lt(Q),{data:H}=await h.from("users").select("id, pseudo, club_name, mmr, rank_tier").order("mmr",{ascending:!1}).limit(100),le=(H||[]).findIndex(B=>B.id===d.id)+1;t.innerHTML=`
    <div style="min-height:100%;background:linear-gradient(160deg,#1a1a1a,#2a2a2a);padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
      ...
      <div style="background:rgba(0,0,0,0.3);border-radius:16px;padding:18px;text-align:center;border:2px solid ${Z.color}40">
        ...
        <div style="font-size:12px;color:rgba(255,255,255,0.4);margin-top:4px">MMR ${Y} ${le?`· #${le} au classement général`:""}</div>
      </div>
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:320px;overflow-y:auto">
          ${(H||[]).map((B,pe)=>{const ve=Lt(B.mmr??1e3),C=B.id===d.id;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;
              background:${C?"rgba(212,160,23,0.15)":"rgba(0,0,0,0.25)"};
              border:1px solid ${C?"#D4A017":"transparent"}">
              <div style="width:26px;text-align:center;font-size:12px;font-weight:900;color:rgba(255,255,255,0.5)">#${pe+1}</div>
              <div style="font-size:18px">${ve.emoji}</div>
              <div style="flex:1;min-width:0">
              ...
              <div style="font-size:13px;font-weight:900;color:${ve.color}">${B.mmr??1e3}</div>
      ...
      <div style="background:rgba(0,0,0,0.3);border-radius:16px;padding:18px;border:1.5px dashed rgba(255,255,255,0.2)">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:24px">
          <div style="text-align:center;opacity:.6">
            ...
            <div style="font-size:12px;font-weight:700;color:${Z.color}">${Y}</div>
          </div>
          ...
          <div style="text-align:center">
            ...
            <div style="font-size:14px;font-weight:900;color:${z.color}">${Q}</div>
          </div>
        </div>
    ...
    </div>`,(T=document.getElementById("ranked-back"))==null||T.addEventListener("click",()=>o("home"));return}const l=d.mmr??1e3,s=d.mmr_deviation??350,c=d.mmr_volatility??.06,m=d.placement_matches??0,y=m<10,x=Math.max(0,10-m),g=Lt(l),f=Fi(l),b=ji.findIndex(Y=>Y.id===g.id),u=ji[b+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},v=(d.ranked_wins||0)+(d.ranked_losses||0)+(d.ranked_draws||0),$=v>0?Math.round((d.ranked_wins||0)/v*100):0,p=ji.map(Y=>`
    <div style="display:flex;flex-direction:column;align-items:center;gap:2px;opacity:${g.id===Y.id?1:.35};
      transform:${g.id===Y.id?"scale(1.15)":"scale(1)"};transition:all 0.3s">
      <div style="font-size:${g.id===Y.id?"28px":"20px"}">${Y.emoji}</div>
      <div style="font-size:9px;color:${Y.color};font-weight:${g.id===Y.id?"900":"400"};letter-spacing:0.5px">${Y.label.toUpperCase()}</div>
    </div>
  `).join("");t.innerHTML=`
  ...
  </div>`}An(Cn);const _e={user:null,profile:null,page:"home",params:{}};function mt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Pa(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Wi(){document.getElementById("modal-overlay").classList.add("hidden")}async function oi(){if(!_e.user)return;const{data:t}=await h.from("users").select("*").eq("id",_e.user.id).single();t&&(_e.profile=t)}const En="mw_theme";function ri(){return localStorage.getItem(En)||"dark"}function Go(t){var e;localStorage.setItem(En,t),xi(t),(e=_e.profile)!=null&&e.id&&h.from("users").update({theme:t}).eq("id",_e.profile.id).then(()=>{})}function xi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=_e.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=_e.profile)==null?void 0:i.club_color2)||"#080d08"))}function vt(t,e={}){_e.page=t,_e.params=e,zn()}async function zn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===_e.page)});const e=document.getElementById("nav-credits");e&&_e.profile&&(e.textContent=`💰 ${(_e.profile.credits||0).toLocaleString("fr")}`);const i={state:_e,navigate:vt,toast:mt,openModal:Pa,closeModal:Wi,refreshProfile:oi};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',_e.page){case"home":await qi(t,i);break;case"home2":await qi(t,i);break;case"game":await vr(t,i);break;case"settings":await fn(t,i);break;case"collection":await Lr(t,i);break;case"decks":await Oi(t,i);break;case"boosters":await Un(t,i);break;case"ranked":await Ba(t,i);break;case"match":{const d=_e.params&&_e.params.matchMode||"vs_ai_easy";d==="random"?await Vi(t,i,!1):d==="ranked"?await Vi(t,i,!0):d==="friend"?await fa(t,i,(o=_e.params)==null?void 0:o.friendId,(r=_e.params)==null?void 0:r.friendName):d==="mini_league"||d==="mini-league"?await Ro(t,i,(n=_e.params)==null?void 0:n.mlMatchId,(a=_e.params)==null?void 0:a.leagueId):await Pr(t,i);break}case"market":await Aa(t,i);break;case"rankings":await qa(t,i);break;case"matches":await Da(t,i);break;case"friends":await br(t,i);break;case"mini-league":await ya(t,i);break;case"match-mini-league":{const d=_e.params||{};await Ro(t,i,d.mlMatchId,d.leagueId);break}default:await qi(t,i)}}function Fa(){var o,r;const t=document.getElementById("app"),e=_e.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.08.02-1202" style="cursor:pointer">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Ga(){xi(ri()),document.getElementById("modal-overlay").addEventListener("click",o=>{o.target===o.currentTarget&&Wi()}),document.getElementById("modal-close").addEventListener("click",Wi);const{data:{session:t}}=await h.auth.getSession();if(!t){Oo(),Na(document.getElementById("app"),{onPlay:()=>_o(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:mt})});return}_e.user=t.user,await oi(),xi(ri()),Oo();try{const{data:o}=await h.from("formation_links_overrides").select("formation, links"),r={};(o||[]).forEach(n=>{r[n.formation]=n.links}),Mn(r)}catch(o){console.warn("Impossible de charger les overrides de formation:",o)}if(!_e.profile){qn(document.getElementById("app"),{state:_e,navigate:async()=>{await oi(),xi(ri()),Pi()},toast:mt,refreshProfile:oi});return}h.rpc("heartbeat").then(()=>{}).catch(()=>{}),setInterval(()=>{h.rpc("heartbeat").then(()=>{}).catch(()=>{})},45e3);const e=Array.isArray(_e.profile.pending_boosters)?_e.profile.pending_boosters:[];if(!_e.profile.onboarding_done&&e.length>0){Zn(document.getElementById("app"),{state:_e,toast:mt,refreshProfile:oi,navigate:()=>{Pi(),setTimeout(()=>Lo(_e.profile,vt,mt),800)}});return}Pi(),new URLSearchParams(location.search).get("tutorial")==="1"?(history.replaceState({},"",location.pathname),setTimeout(()=>un(_e.profile,vt,mt),800)):setTimeout(()=>Lo(_e.profile,vt,mt),800),h.auth.onAuthStateChange(async(o,r)=>{o==="SIGNED_OUT"&&(_e.user=null,_e.profile=null,document.getElementById("app").innerHTML="",_o(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:mt}))})}function Oa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Ti(){const t=document.getElementById("app");t&&(t.style.height=Oa()+"px")}window.addEventListener("resize",Ti);window.addEventListener("orientationchange",()=>setTimeout(Ti,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Ti);function Pi(){const t=()=>{var i;(i=_e.user)!=null&&i.id&&h.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",_e.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Ti(),Fa(),zn()}function Oo(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function Ln(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
