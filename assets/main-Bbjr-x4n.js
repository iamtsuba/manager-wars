  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,M(),Y()})))}function Y(){const O=document.getElementById("col-grid");O&&(F==="player"?he(O):F==="formation"?xe(O):ge(O))}function ne(O,H,S,B,R){R=R||"#7a28b8";const ie=document.getElementById("col-grid"),ee=document.getElementById("col-big");if(!ie||!ee)return;var $e=0;function _e(){const ke=window.innerWidth>=768,Me=document.getElementById("col-big"),Te=document.getElementById("col-grid");ke&&Me&&(Me.style.minHeight="420px",Me.style.flex="1 1 auto"),ke&&Te&&(Te.style.height="200px",Te.style.flexShrink="0",Te.style.overflowX="auto",Te.style.overflowY="hidden"),ee.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+H(O[$e])+"</div>";var Ae=ee.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ae&&Ae.addEventListener("click",function(){B(O[$e])}),requestAnimationFrame(function(){var Ee=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!Ee||!ee)){var Ce=ee.clientHeight-8,He=ee.clientWidth-24,E=Ee.offsetHeight,u=Ee.offsetWidth;if(E>0&&u>0&&Ce>40){var m=Math.min(Ce/E,He/u,1);Ee.style.transform="scale("+m.toFixed(3)+")",Ee.style.transformOrigin="top center"}}}),ie.innerHTML=O.map(function(Ee,Ce){return'<div class="col-mini-item" data-idx="'+Ce+'" style="flex-shrink:0;cursor:pointer;border-radius:8px;border:1.5px solid '+(Ce===$e?R:"transparent")+';transition:border-color .15s;overflow:hidden">'+S(Ee,Ce===$e)+"</div>"}).join(""),ie.querySelectorAll(".col-mini-item").forEach(function(Ee){Ee.addEventListener("click",function(){$e=Number(Ee.dataset.idx),_e(),Ee.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function D(O){var H=.54,S=Math.round(140*H),B=Math.round(310*H),R;if(!O||O._fake){var ie=O?O.player:null;if(!ie)return"";R=$i(ie)}else R=Vt(O,"");return'<div style="width:'+S+"px;height:"+B+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+H+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+R+"</div></div>"}function Q(O,H,S){H=H||100,S=S||140;var B=zt[O]||{},R={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ie=Math.max(3,Math.round(H*.06)),ee=Object.entries(B).map(function(_e){var ke=_e[0],Me=_e[1],Te=ke.replace(/\d+$/,""),Ae=R[Te]||"#888",Ee=Math.round(Me.x*H),Ce=Math.round(Me.y*S);return'<circle cx="'+Ee+'" cy="'+Ce+'" r="'+ie+'" fill="'+Ae+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),$e=Math.max(1,Math.round(H/50));return'<svg viewBox="0 0 '+H+" "+S+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+H+'" height="'+S+'" fill="#1A6B3C"/><rect x="'+Math.round(H*.2)+'" y="'+Math.round(S*.02)+'" width="'+Math.round(H*.6)+'" height="'+Math.round(S*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+$e+'"/><line x1="0" y1="'+Math.round(S*.5)+'" x2="'+H+'" y2="'+Math.round(S*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+$e+'"/><ellipse cx="'+Math.round(H*.5)+'" cy="'+Math.round(S*.5)+'" rx="'+Math.round(H*.18)+'" ry="'+Math.round(S*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+$e+'"/><rect x="'+Math.round(H*.2)+'" y="'+Math.round(S*.82)+'" width="'+Math.round(H*.6)+'" height="'+Math.round(S*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+$e+'"/>'+ee+"</svg>"}function ae(O,H,S){var B=S>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+S+"</div>":"",R=H?'data-form-id="'+H.id+'"':"",ie=O.length>7?14:O.length>5?16:19,ee=!!H;return"<div "+R+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ee?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ee?"":"filter:grayscale(1);opacity:0.5")+'">'+B+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ee?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ie+"px;font-weight:900;color:"+(ee?"#1A6B3C":"#aaa")+';line-height:1">'+O+'</div></div><div style="flex:1;overflow:hidden;background:'+(ee?"#1A6B3C":"#ccc")+'">'+Q(O,140,220)+"</div></div>"}function pe(O,H){var S=.54,B=Math.round(140*S),R=Math.round(305*S),ie=Math.round(R*.22),ee=R-ie,$e=O.length>7?5:7,_e=Q(O,B,ee),ke=H?"1.5px solid #2a7a40":"1px solid #ddd",Me=H?"":"filter:grayscale(1);opacity:0.45;",Te=H?"#1A6B3C":"#bbb",Ae="#fff";return'<div style="width:'+B+"px;height:"+R+"px;border-radius:6px;border:"+ke+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Me+'"><div style="height:'+ie+"px;background:"+Te+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+$e+"px;font-weight:900;color:"+Ae+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(B-4)+'px">'+O+'</span></div><div style="height:'+ee+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div>"}function he(O){if(j){const H=re();if(!H.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const S=H.map(B=>i.find(R=>R.player.id===B.id)||{_fake:!0,player:B,id:"fake-"+B.id});ne(S,B=>B._fake?$i(B.player):Vt(B,""),B=>B._fake?D({player:B.player,id:"x",_fake:!0}):D(B),B=>{B._fake||ki(B,i,$,t)},"#1A6B3C")}else{const H=ce();if(!H.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const S={};H.forEach(R=>{const ie=R.player.id;S[ie]||(S[ie]=[]),S[ie].push(R)});const B=Object.values(S).map(R=>Mn(R));ne(B,R=>{const ie=$[R.player.id]||1,ee=ie>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ie}</div>`:"",_e=i.filter(ke=>ke.player.id===R.player.id&&ke.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Vt(R,ee+_e)},R=>D(R),R=>ki(R,i,$,t),"#1A6B3C")}}function xe(O){const H=j?k:[...L];if(!H.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const S=H.map(B=>({formation:B,card:f.find(R=>R.formation===B)||null,owned:L.has(B)}));ne(S,({formation:B,card:R,owned:ie})=>ae(B,ie?R:null,ie?f.filter(ee=>ee.formation===B).length:0),({formation:B,owned:R})=>pe(B,R),({card:B,owned:R})=>{R&&B&&jn(B,f,t,d)},"#1A6B3C")}function ge(O){const H=Object.keys(g),S=j?H.length?H:o:[...z];if(!S.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const B=S.map(R=>({type:R,gc:Ne[R]||{icon:"⚡",desc:""},def:g[R]||null,owned:z.has(R),card:r.find(ie=>ie.gc_type===R)||null}));ne(B,({type:R,gc:ie,def:ee,owned:$e,card:_e})=>{const ke=$e?r.filter(m=>m.gc_type===R).length:0,Me=ke>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ke}</div>`:"",Te=(ee==null?void 0:ee.gc_type)==="ultra_game_changer",Ae={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Ee={purple:"#b06ce0",light_blue:"#00d4ef"},Ce=Ae[ee==null?void 0:ee.color]||Ae.purple,He=Ee[ee==null?void 0:ee.color]||Ee.purple,E=(ee==null?void 0:ee.effect)||ie.desc||"",u=ee!=null&&ee.image_url?`/manager-wars/icons/${ee.image_url}`:null;return $e&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${R}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${He};background:${Ce};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${He}66;cursor:pointer">
          ${Me}
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${f.map((S,B)=>{const R=M[S.id]||[],ie=S.is_for_sale,ee=R.length?R[R.length-1]:null,_e=(r.rarity==="pepite"||r.rarity==="papyte")&&S.current_note!=null?` (☆${S.current_note})`:"";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let D=new Set;const Q=()=>{const S=D.size,B=document.getElementById("sell-action-panel");B&&(B.style.display=S>0?"block":"none",document.getElementById("sell-selected-count").textContent=S,document.getElementById("sell-direct-total").textContent=(S*$).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(S=>{S.addEventListener("change",()=>{const B=S.dataset.id;S.checked?D.add(B):D.delete(B);const R=S.closest(".exemplaire-row");R&&(R.style.borderColor=S.checked?"#1A6B3C":"#eee"),Q()})}),document.querySelectorAll(".exemplaire-row").forEach(S=>{S.addEventListener("click",B=>{if(B.target.closest("button")||B.target.tagName==="INPUT")return;const R=S.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(S=>{S.addEventListener("click",B=>{B.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${S.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(ge=document.getElementById("direct-sell-btn"))==null||ge.addEventListener("click",async()=>{const S=[...D];if(!S.length)return;const B=S.length*$;if(!confirm(`Vendre ${S.length} carte${S.length>1?"s":""} ${r.surname_encoded} pour ${B.toLocaleString("fr")} crédits ? Action irréversible.`))return;await _.from("market_listings").delete().in("card_id",S),await _.from("transfer_history").delete().in("card_id",S);const{error:R}=await _.from("cards").delete().in("id",S);if(R){d(R.message,"error");return}await _.from("users").update({credits:(p.profile.credits||0)+B}).eq("id",p.profile.id),await i();const ie=document.getElementById("nav-credits");ie&&(ie.textContent=`💰 ${(p.profile.credits||0).toLocaleString("fr")}`),d(`+${B.toLocaleString("fr")} crédits ! ${S.length} carte${S.length>1?"s":""} vendue${S.length>1?"s":""}.`,"success"),l(),c("collection")}),(O=document.getElementById("market-sell-btn"))==null||O.addEventListener("click",async()=>{var $e;const S=[...D];if(!S.length){d("Sélectionne au moins un exemplaire","warning");return}const B=parseInt(($e=document.getElementById("sell-market-price"))==null?void 0:$e.value);if(!B||B<1){d("Prix invalide","error");return}const{error:R}=await _.from("cards").update({is_for_sale:!0,sale_price:B}).in("id",S);if(R){d(R.message,"error");return}const ie=S.map(_e=>({seller_id:p.profile.id,card_id:_e,price:B,status:"active"})),{error:ee}=await _.from("market_listings").insert(ie);ee&&console.warn("[Market] insert listings:",ee.message),d(`${S.length} carte${S.length>1?"s":""} mise${S.length>1?"s":""} en vente à ${B.toLocaleString("fr")} cr. chacune !`,"success"),l(),c("collection")}),(H=document.getElementById("cancel-sell-btn"))==null||H.addEventListener("click",async()=>{await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await _.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),l(),c("collection")})}const Gt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},rt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ut(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const n=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${n}.png`}function Hi(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Ui(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(n=e==null?void 0:e.clubs)!=null&&n.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Bn(e,t=44,n=58){var g;const a=e?Ut(e):null,p=e?Ui(e):null,d=Hi(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",l=rt[s]||"#555",c={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(n*.19),f=Math.round(n*.25),x=n-r-f;return e?`<div style="width:${t}px;height:${n}px;border-radius:5px;border:2px solid ${c};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const M=window.innerWidth>=700,Y=(O,H,S)=>{var Ce,He;const B=(t.gcDefs||[]).find(E=>E.name===O.gc_type),R={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[B==null?void 0:B.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ie={purple:"#b06ce0",light_blue:"#00d4ef"}[B==null?void 0:B.color]||"#b06ce0",ee=(B==null?void 0:B.name)||O.gc_type,$e=(B==null?void 0:B.effect)||((Ce=Ne[O.gc_type])==null?void 0:Ce.desc)||"",_e=B!=null&&B.image_url?`/manager-wars/icons/${B.image_url}`:null,ke=((He=Ne[O.gc_type])==null?void 0:He.icon)||"⚡",Me=Math.round(S*.22),Te=Math.round(S*.22),Ae=S-Me-Te,Ee=ee.length>12?7:9;return`<div class="gc-mini" data-gc-id="${O.id}" data-gc-type="${O.gc_type}"
          ...
          <div style="height:${Me}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ee}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${H-6}px">${ee}</span>
          ...
          <div style="height:${Ae}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${_e?`<img src="${_e}" style="max-width:${H-10}px;max-height:${Ae-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Ae*.55)}px">${ke}</span>`}
          </div>
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const c=()=>{l||(l=!0,d.remove(),setTimeout(()=>p(),50))};d.addEventListener("click",c),setTimeout(c,3500)}async function At(e,t,n){var r,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=n,p=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=p?"victoire":d?"nul":"defaite",l=Tn(t.mode,s);t.matchId&&await _.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:p?a.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(a.profile.credits||0)+l,matches_played:(a.profile.matches_played||0)+1};p?c.wins=(a.profile.wins||0)+1:d?c.draws=(a.profile.draws||0)+1:c.losses=(a.profile.losses||0)+1,await _.from("users").update(c).eq("id",a.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    </div>`,i==="p1"&&setTimeout(async()=>{await P({phase:"midfield"})},5e3)}let ae=!1;function pe(){if(ae)return;const E=o[i+"Team"].MIL||[],u=o[r+"Team"].MIL||[];function m(U){return U.reduce((V,Z)=>V+we(Z,"MIL"),0)}function h(U){let V=0;for(let Z=0;Z<U.length-1;Z++){const de=Ze(U[Z],U[Z+1]);de==="#00ff88"?V+=2:de==="#FFD700"&&(V+=1)}return V}const y=m(E)+h(E),b=m(u)+h(u),v=y>=b;function w(U,V,Z){return`<div id="duel-row-${Z}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(b);let I=!1;const A=()=>{I||(I=!0,b.remove(),setTimeout(()=>y(),50))};b.addEventListener("click",A),setTimeout(A,3500)}function xe(E,u,m){var J,U;const h=(o.gcDefs||[]).find(V=>{var Z;return V.name===E||((Z=V.name)==null?void 0:Z.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),y={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",v=(h==null?void 0:h.name)||E,w=(h==null?void 0:h.effect)||((J=Ne[E])==null?void 0:J.desc)||"",I=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,A=((U=Ne[E])==null?void 0:U.icon)||"⚡",C=u===i?"Vous":o[u+"Name"]||"Adversaire",N=document.createElement("div");N.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",N.innerHTML=`
      <style>
      ...
      <div style="width:min(90vw,420px)">${st(o[r+"Team"],o[r+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(E),(u=E.querySelector("#pvp-opp-close"))==null||u.addEventListener("click",()=>E.remove())}function R(){var m;const E=o.log||[],u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",u.innerHTML=`
    ...
    </div>`,Ge=w?"attack":I?"defense":"idle",Re=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let A=!1;const T=()=>{A||(A=!0,v.remove(),setTimeout(()=>b(),50))};v.addEventListener("click",T),setTimeout(T,3500)}function ge(u,m,h){var U,V;const y=(o.gcDefs||[]).find(Z=>{var de;return Z.name===u||((de=Z.name)==null?void 0:de.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",w=(y==null?void 0:y.name)||u,I=(y==null?void 0:y.effect)||((U=Ne[u])==null?void 0:U.desc)||"",A=y!=null&&y.image_url?`/manager-wars/icons/${y.image_url}`:null,T=((V=Ne[u])==null?void 0:V.icon)||"⚡",N=m===i?"Vous":o[m+"Name"]||"Adversaire",W=document.createElement("div");W.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",W.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(me=N.querySelector("#psub-close"))==null||me.addEventListener("click",()=>N.remove()),(be=N.querySelector("#pout-up"))==null||be.addEventListener("click",()=>{I>0&&(I--,W())}),(je=N.querySelector("#pout-down"))==null||je.addEventListener("click",()=>{I<v.length-1&&(I++,W())}),(Pe=N.querySelector("#pin-up"))==null||Pe.addEventListener("click",()=>{T>0&&(T--,W())}),(De=N.querySelector("#pin-down"))==null||De.addEventListener("click",()=>{T<w.length-1&&(T++,W())});const fe=(Le,Fe,Ge,Re)=>{const Ue=N.querySelector("#"+Le);if(!Ue)return;let Ke=0;Ue.addEventListener("touchstart",Be=>{Ke=Be.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Be=>{const qe=Be.changedTouches[0].clientY-Ke;if(Math.abs(qe)<30)return;const Qe=Fe();qe<0&&Qe<Re-1?(Ge(Qe+1),W()):qe>0&&Qe>0&&(Ge(Qe-1),W())},{passive:!0})};fe("pin-panel",()=>T,Le=>T=Le,w.length),fe("pout-panel",()=>I,Le=>I=Le,v.length),(Ie=N.querySelector("#psub-confirm"))==null||Ie.addEventListener("click",async Le=>{if(Le.preventDefault(),Le.stopPropagation(),C)return;C=!0;const Fe=v[I],Ge=w[T];if(!Fe||!Ge)return;const Re=Fe._line,Ue=(h[Re]||[]).findIndex(qe=>qe.cardId===Fe.cardId);if(Ue===-1){c("Erreur : joueur introuvable","error"),N.remove();return}const Ke={...Ge,_line:Re,position:Fe.position,used:!1,boost:0};h[Re].splice(Ue,1,Ke);const Be=[...y,Ge.cardId];N.remove(),B(Fe,Ge,async()=>{await te({[i+"Team"]:h,[r+"Team"]:o[r+"Team"],["usedSubIds_"+i]:Be})})})}document.body.appendChild(N),W()}function B(u,m,h){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(A,T,C)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(b);let w=!1;const I=()=>{w||(w=!0,b.remove(),setTimeout(()=>h(),50))};b.addEventListener("click",I),setTimeout(I,2200)}function R(){var m;const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",u.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${o[r+"Name"]}</div>
      <div style="width:min(90vw,420px)">${st(o[r+"Team"],o[r+"Formation"],null,[],300,300)}</div>
      ...
      </div>`,document.body.appendChild(m),(h=m.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>m.remove())}async function ee(){if(o.phase!==i+"-attack")return;const u=i==="p1"?"p2":"p1",m=(o.round||0)+1,h=[...o.log||[]];h.push({type:"info",text:`⏭️ ${o[i+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const y=Ee(o),b=Ae(u),v=y||!b?"finished":u+"-attack";await te({["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:v,attacker:u,round:m,log:h}),v==="finished"&&await He(o)}async function $e(){const u=o[i+"Team"],m=!["GK","DEF","MIL","ATT"].some(v=>(o[r+"Team"][v]||[]).some(w=>!w.used)),h=(o["selected_"+i]||[]).map(v=>{const w=(u[v._role]||[]).find(W=>W.cardId===v.cardId)||v,I=m&&["GK","DEF"].includes(v._role),A=u[v._role]||[],T=A.findIndex(W=>W.cardId===v.cardId),C=ot(A.length),N=T>=0?C[T]:w._col??1;return{...w,_line:v._role,_col:N,...I?{note_a:Math.max(1,Number(w.note_a)||0)}:{}}});if(!h.length)return;const y=Rt(h,o.modifiers[i]||{});ne(i,h.map(v=>v.cardId)),h.forEach(v=>{const w=(u[v._role]||[]).find(I=>I.cardId===v.cardId);w&&(w.used=!0)}),o["selected_"+i]=[],Q();const b=[...o.log||[]];if(m){const v=(o[i+"Score"]||0)+1,w=h.map(N=>({name:N.name,note:we(N,N._line||"ATT"),portrait:ze(N),job:N.job}));b.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:w,homeTotal:y.total,aiTotal:0});const I=(o.round||0)+1,A=i==="p1"?"p2":"p1",T={...o,[i+"Team"]:u,[i+"Score"]:v},C=Ee(T);K.add(I),xe(w,v,o[r+"Score"]||0,!0,async()=>{await te({[i+"Team"]:u,[i+"Score"]:v,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:C?"finished":A+"-attack",attacker:A,round:I,log:b}),C&&await He({...o,[i+"Score"]:v})});return}b.push({type:"pending",text:`⚔️ ${o[i+"Name"]} attaque (${y.total})`}),await te({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],pendingAttack:{...y,players:h,side:i},["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},phase:r+"-defense",log:b})}async function _e(){const u=o[i+"Team"],m=(o["selected_"+i]||[]).map(U=>{const V=(u[U._role]||[]).find(me=>me.cardId===U.cardId)||U,Z=u[U._role]||[],de=Z.findIndex(me=>me.cardId===U.cardId),ue=ot(Z.length),fe=de>=0?ue[de]:V._col??1;return{...V,_line:U._role,_col:fe}}),h=Ot(m,o.modifiers[i]||{});ne(i,m.map(U=>U.cardId)),m.forEach(U=>{const V=(u[U._role]||[]).find(Z=>Z.cardId===U.cardId);V&&(V.used=!0)}),o["selected_"+i]=[],Q();const y=Ht(o.pendingAttack.total,h.total,o.modifiers[i]||{}),b=o.pendingAttack.side,v=y==="attack"||(y==null?void 0:y.goal),w=b==="p1"?"p2":"p1",I=(o.round||0)+1,A=(o.pendingAttack.players||[]).map(U=>({name:U.name,note:we(U,U._line||"ATT"),portrait:ze(U),job:U.job})),T=[...o.log||[]];T.push({type:"duel",isGoal:v,homeScored:v&&b===i,text:v?`⚽ BUT de ${o[b+"Name"]} ! (${o.pendingAttack.total} vs ${h.total})`:`✋ Attaque stoppée (${o.pendingAttack.total} vs ${h.total})`,homePlayers:A,aiPlayers:m.map(U=>({name:U.name,note:we(U,U._line||"DEF"),portrait:ze(U),job:U.job})),homeTotal:o.pendingAttack.total,aiTotal:h.total});const C=v?(o[b+"Score"]||0)+1:o[b+"Score"]||0,N={...o,[i+"Team"]:u,[b+"Score"]:C},W=Ee(N),le=W?"finished":w+"-attack",J=async()=>{await te({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],[b+"Score"]:C,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:le,attacker:w,round:I,log:T}),(le==="finished"||W)&&await He({...o,[b+"Score"]:C})};if(v){const U=b===i,V=U?C:o[i+"Score"]||0,Z=U?o[r+"Score"]||0:C;K.add(I),xe(A,V,Z,U,J)}else await J()}function ke(u){return["MIL","ATT"].some(m=>(u[m]||[]).some(h=>!h.used))}function Me(u){return["GK","DEF","MIL","ATT"].some(m=>(u[m]||[]).some(h=>!h.used))}function Te(u){return Me(u)&&!ke(u)}function Ae(u){const m=o[u+"Team"],h=o[(u==="p1"?"p2":"p1")+"Team"];return!!(ke(m)||!Me(h)&&Te(m))}function Ee(u){const m=["MIL","ATT"].some(T=>(u.p1Team[T]||[]).some(C=>!C.used)),h=["MIL","ATT"].some(T=>(u.p2Team[T]||[]).some(C=>!C.used)),y=Me(u.p1Team),b=Me(u.p2Team);return!m&&!(!b&&y)&&(!h&&!(!y&&b))}function Ce(u){const m=u.p1Score||0,h=u.p2Score||0;return m===h?null:m>h?g.home_id:g.away_id}async function He(u){try{const m=Ce(u),h=m?g.home_id===m?g.away_id:g.home_id:null;await _.from("matches").update({status:"finished",winner_id:m,home_score:u.p1Score||0,away_score:u.p2Score||0}).eq("id",n),m&&h&&Ni(m,h).catch(()=>{})}catch(m){console.error("[PvP] finishMatch:",m)}}function E(){var b;const u=o[i+"Score"],m=o[r+"Score"],h=u>m,y=u===m;Xe(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
