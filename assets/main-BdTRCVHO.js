...
import{s as v,j as hi,q as zn,t as Ht,u as Ni,F as Oi,o as tt,n as ei,g as At,r as Te,m as Mt,v as Ai,w as uo,T as Li,p as fo,x as mo,d as go}from"./special-cards-lEGt-tGs.js";const xo="/";function cn(e,{navigate:t,toast:i}){let n="login";const o=()=>{var a,s,d,l,c,f,b;const r=n==="login";if(e.innerHTML=`
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-center">
          ...
          <div class="promo-banner" id="promo-banner">
            ...
            ${p.length>1?`<div class="promo-dots">${p.map((L,I)=>`<div class="promo-dot ${I===0?"active":""}" data-dot="${I}"></div>`).join("")}</div>`:""}
          </div>`:""}
        </div>
  ...
  </div>`,requestAnimationFrame(()=>{var me,j;const L=((me=window.visualViewport)==null?void 0:me.height)||window.innerHeight,I=window.innerWidth<1024;let U=0;if(I){const K=document.getElementById("home2-mobile-top"),le=document.getElementById("home2-mobile-bottom");U=((K==null?void 0:K.offsetHeight)||0)+((le==null?void 0:le.offsetHeight)||0)}else U=((j=document.getElementById("home2-chrome-header"))==null?void 0:j.offsetHeight)||0;const V=L-U,de=e.querySelector(".home-dark");de&&(de.style.minHeight=V+"px")});const E=()=>{const L=document.getElementById("mode-indicator");L&&(L.textContent=window.innerWidth>=1024?"🖥️ Mode PC":"📱 Mode Mobile")};if(E(),window.addEventListener("resize",E),(m=document.getElementById("nav-edit-btn"))==null||m.addEventListener("click",()=>i("settings")),(C=document.getElementById("nav-profile-btn"))==null||C.addEventListener("click",()=>i("settings")),($=document.getElementById("nav-rankings-link"))==null||$.addEventListener("click",()=>i("rankings")),(S=document.getElementById("nav-rankings-cta"))==null||S.addEventListener("click",()=>i("rankings")),(G=document.getElementById("rank-inline-link-btn"))==null||G.addEventListener("click",()=>i("rankings")),(J=document.getElementById("nav-journal-link"))==null||J.addEventListener("click",()=>Go()),e.querySelectorAll("[data-action]").forEach(L=>{L.addEventListener("click",()=>{L.style.transform="scale(.96)",setTimeout(()=>L.style.transform="",180);const I=L.dataset.action;if(I==="match-ai"){Fn(i);return}if(I==="match-random"){i("match",{matchMode:"random"});return}if(I==="match-friend"){i("friends");return}if(I==="mini-league"){i("mini-league");return}if(I==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),p.length>1){const L=document.getElementById("promo-slide-content"),I=()=>Array.from(document.querySelectorAll(".promo-dot")),U=V=>{w=V,L&&(L.innerHTML=h(p[w])),I().forEach((de,me)=>de.classList.toggle("active",me===w))};setInterval(()=>U((w+1)%p.length),5e3),document.querySelectorAll(".promo-dot").forEach(V=>{V.addEventListener("click",()=>U(Number(V.dataset.dot)))})}(ie=document.getElementById("promo-cta-btn"))==null||ie.addEventListener("click",()=>i("boosters")),(Q=document.getElementById("back-to-v1-btn"))==null||Q.addEventListener("click",()=>{jo(),i("home")}),Dn(t,n),Uo(t,n,i),qn(t,n,i),No(t,n)}async function No(e,t){const i=e.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(n!=null&&n.length))return;const o=n.reduce((a,s)=>a+(s.prize_amount||0),0),r=document.createElement("div");r.className="modal-overlay",r.style.zIndex="2200",r.innerHTML=`<div class="modal" style="max-width:400px">
    <div class="modal-header"><h2 style="color:#1A6B3C">🏆 Gains à récupérer</h2></div>
    <div class="modal-body" style="padding:18px 20px">
      <p style="font-size:14px;color:#555;margin:0 0 14px">Tu as terminé sur le podium de ${n.length>1?"plusieurs mini leagues":"une mini league"} !</p>
      <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px">
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(M){const N=document.getElementById(M);if(!N)return;N.addEventListener("wheel",ne=>{Math.abs(ne.deltaY)<=Math.abs(ne.deltaX)||(ne.preventDefault(),N.scrollLeft+=ne.deltaY)},{passive:!1});let F=!1,Y=0,q=0,O=!1,ce=!1;N.addEventListener("mousedown",ne=>{F=!0,O=!1,Y=ne.pageX,q=N.scrollLeft}),window.addEventListener("mouseup",()=>{F=!1,O&&(N.style.cursor="",ce=!0),O=!1}),window.addEventListener("mousemove",ne=>{if(!F)return;const fe=ne.pageX-Y;!O&&Math.abs(fe)<6||(O=!0,N.style.cursor="grabbing",ne.preventDefault(),N.scrollLeft=q-fe)}),N.addEventListener("click",ne=>{ce&&(ne.stopPropagation(),ne.preventDefault(),ce=!1)},!0)}("col-grid");function I(){const k=document.getElementById("col-filters");k&&(C==="player"?(k.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",M=>{S=M.target.value.toLowerCase(),U()}),e.querySelectorAll(".filter-btn").forEach(M=>{M.addEventListener("click",()=>{$=M.dataset.job,I(),U()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{G=!G,I(),U()})):(k.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{G=!G,I(),U()})))}function U(){const k=document.getElementById("col-grid");k&&(C==="player"?K(k):C==="formation"?le(k):C==="stadium"?pe(k):ue(k))}function V(k,M,N,F,Y,q=0){const O=document.getElementById("col-grid"),ce=document.getElementById("col-big");if(!O||!ce)return;var ne=0;function fe(){var ct;const we=window.innerWidth>=768,he=document.getElementById("col-big"),Ie=document.getElementById("col-gap"),Se=((ct=document.getElementById("col-grid"))==null?void 0:ct.parentElement)||null,Be=he?he.closest(".page"):null;if(he&&Se&&Be){let Ee=0;Array.from(Be.children).forEach(function(B){B!==he&&B!==Se&&B!==Ie&&(Ee+=B.offsetHeight)});const Ce=Math.max(0,Be.clientHeight-Ee),qe=Math.round(Ce*(q/100)),Ge=Math.max(0,Ce-qe),_=we?50/71:45/63,z=Math.round(Ge*_),A=Math.max(0,Ge-z);Ie&&(Ie.style.height=qe+"px"),he.style.flex="none",he.style.height=z+"px",he.style.minHeight="0",Se.style.flex="none",Se.style.height=A+"px",Se.style.minHeight="0",Se.style.display="flex",Se.style.overflow="hidden"}const $e=document.getElementById("col-grid");$e&&($e.style.height="100%",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.width="100%"),ce.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+M(k[ne])+"</div>";var _t=ce.querySelector("[data-card-id],[data-form-id],[data-gc-id]");_t&&_t.addEventListener("click",function(){F(k[ne])}),requestAnimationFrame(function(){var Ee=document.getElementById("big-card-inner");if(!(!Ee||!ce)){var Ce=ce.clientHeight,qe=ce.clientWidth-16,Ge=Ee.offsetHeight,_=Ee.offsetWidth;if(Ge>0&&_>0&&Ce>40){var z=Math.min(Ce/Ge,qe/_);Ee.style.transform="scale("+z.toFixed(3)+")",Ee.style.transformOrigin="center center"}}}),O.innerHTML=k.map(function(Ee,Ce){var qe=Ce===ne,Ge="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Ge+'">'+N(Ee,qe)+"</div>"}).join(""),O.querySelectorAll(".col-mini-item").forEach(function(Ee){Ee.addEventListener("click",function(){ne=Number(Ee.dataset.idx),fe(),Ee.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var Ee=$e?$e.clientHeight:0,Ce=O.querySelector(".col-mini-item > div");if(!(!Ee||!Ce)){var qe=Ce.style.zoom;Ce.style.zoom="1";var Ge=Ce.offsetHeight;if(Ce.style.zoom=qe,!(Ge<=0)){var _=Ee/Ge;O.querySelectorAll(".col-mini-item > div").forEach(function(z){z.style.zoom=_.toFixed(4)})}}})}fe()}function de(k,M){var N=window.innerWidth>=768?.76:.54,F;if(!k||k._fake){var Y=k?k.player:null;if(!Y)return"";F=bn(Y)}else F=zi(k,"");var q=k&&!k._fake?h[k.player&&k.player.id]||1:0,O=q>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+q+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+N+';pointer-events:none;line-height:0">'+O+F+"</div>"}function me(k,M,N){var F=N>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+N+"</div>":"",Y=!!M,q=Ai(k,Mt[k],{width:160});return Y||(q='<div style="filter:grayscale(1);opacity:0.5">'+q+"</div>"),"<div "+(M?'data-form-id="'+M.id+'"':"")+' style="position:relative;cursor:pointer">'+F+q+"</div>"}function j(k,M){var N=window.innerWidth>=768?.76:.54,F=Ai(k,Mt[k],{width:140});return M||(F='<div style="filter:grayscale(1);opacity:0.45">'+F+"</div>"),'<div style="display:inline-block;zoom:'+N+';line-height:0;pointer-events:none">'+F+"</div>"}function K(k){if(G){const M=L();if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const N=M.map(F=>l.find(Y=>Y.player.id===F.id)||{_fake:!0,player:F,id:"fake-"+F.id});V(N,F=>F._fake?bn(F.player):zi(F,""),F=>F._fake?de({player:F.player,id:"x",_fake:!0}):de(F),F=>{F._fake||yn(F,l,h,t)})}else{const M=Q();if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const N={};M.forEach(Y=>{const q=Y.player.id;N[q]||(N[q]=[]),N[q].push(Y)});const F=Object.values(N).map(Y=>Jo(Y));V(F,Y=>{const q=h[Y.player.id]||1,O=q>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${q}</div>`:"",ne=l.filter(fe=>fe.player.id===Y.player.id&&fe.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return zi(Y,O+ne)},Y=>de(Y),Y=>yn(Y,l,h,t))}}function le(k){const M=G?y:[...E];if(!M.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const N=M.map(F=>({formation:F,card:f.find(Y=>Y.formation===F)||null,owned:E.has(F)}));V(N,({formation:F,card:Y,owned:q})=>me(F,q?Y:null,q?f.filter(O=>O.formation===F).length:0),({formation:F,owned:Y})=>j(F,Y),({card:F,owned:Y})=>{Y&&F&&tr(F,f,t,r)},"#1A6B3C",5)}function ue(k){const M=Object.keys(g),N=G?M.length?M:w:[...m];if(!N.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const F=N.map(Y=>({type:Y,gc:je[Y]||{icon:"⚡",desc:""},def:g[Y]||null,owned:m.has(Y),card:c.find(q=>q.gc_type===Y)||null}));V(F,({type:Y,gc:q,def:O,owned:ce,card:ne})=>{var $e;const fe=(O==null?void 0:O.name)||Y,we=ce?c.filter(_t=>_t.gc_type===Y).length:0,he=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Ie=(O==null?void 0:O.effect)||q.desc||"",Se=O!=null&&O.image_url?`/icons/${O.image_url}`:(($e=O==null?void 0:O.club)==null?void 0:$e.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=tt(fe,Se,q.icon,Ie,{width:160,onClick:ce});return ce||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${ce&&ne?`data-gc-id="${ne.id}" data-gc-type="${Y}"`:""} style="position:relative">${he}${Be}</div>`},({type:Y,gc:q,def:O,owned:ce})=>{const ne=window.innerWidth>=768?.76:.54,fe=(O==null?void 0:O.name)||Y,we=(O==null?void 0:O.effect)||q.desc||"",he=O!=null&&O.image_url?`/icons/${O.image_url}`:null;let Ie=tt(fe,he,q.icon,we,{width:140});return ce||(Ie=`<div style="filter:grayscale(1);opacity:0.45">${Ie}</div>`),`<div style="display:inline-block;zoom:${ne};line-height:0;pointer-events:none">${Ie}</div>`},({type:Y,owned:q,def:O})=>{q&&er(Y,O,r)},"#7a28b8",5)}function pe(k){const M="#4FC3F7",N="/";if(!b.length){k.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const F={};b.forEach(q=>{const O=q.stadium_id||"?";(F[O]=F[O]||[]).push(q)});const Y=Object.entries(F).map(([q,O])=>({sid:q,def:u[q]||null,count:O.length,card:O[0]}));V(Y,({def:q,count:O})=>{var Ie,Se;const ce=(q==null?void 0:q.name)||"?",ne=((Ie=q==null?void 0:q.club)==null?void 0:Ie.encoded_name)||(q==null?void 0:q.country_code)||"—",fe=q!=null&&q.image_url?`${N}icons/${q.image_url}`:((Se=q==null?void 0:q.club)==null?void 0:Se.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"",he=`${ne}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${we}${ei(ce,fe,he,{width:160})}</div>`},({def:q})=>{var he,Ie;const O=window.innerWidth>=768?.76:.54,ce=(q==null?void 0:q.name)||"?",ne=((he=q==null?void 0:q.club)==null?void 0:he.encoded_name)||(q==null?void 0:q.country_code)||"—",fe=q!=null&&q.image_url?`${N}icons/${q.image_url}`:((Ie=q==null?void 0:q.club)==null?void 0:Ie.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=`${ne}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${O};line-height:0;pointer-events:none">${ei(ce,fe,we,{width:140})}</div>`},null,M,5)}e.querySelectorAll(".col-tab-btn").forEach(k=>{k.addEventListener("click",()=>{C=k.dataset.tab,$="Tous",S="",G=!1,e.querySelectorAll(".col-tab-btn").forEach(M=>{const N=M.dataset.tab===C;M.style.borderBottomColor=N?"var(--green)":"transparent",M.style.color=N?"var(--green)":"var(--tile-fg-dim)"}),I(),U()})}),I(),U()}function er(e,t,i){const n=je[e]||{icon:"⚡",desc:"Effet spécial."},o=(t==null?void 0:t.name)||e,r=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${tt(o,a,n.icon,r,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const li=1e3;function tr(e,t,i,n){var g,p,u;const{state:o,toast:r,closeModal:a,navigate:s,refreshProfile:d}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=Mt[l]||{},w=Oi[l]||[],h=290,E=360,m=20;function C(S){const G=y[S];return G?{x:G.x*h,y:G.y*E}:null}let $=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[S,G]of w){const J=C(S),ie=C(G);!J||!ie||($+=`<line x1="${J.x}" y1="${J.y}" x2="${ie.x}" y2="${ie.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const S of Object.keys(y)){const G=C(S);if(!G)continue;const J=S.replace(/\d+/,""),ie=c[J]||"#555";$+=`<circle cx="${G.x}" cy="${G.y}" r="${m}" fill="${ie}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,$+=`<text x="${G.x}" y="${G.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${J}</text>`}return $+="</svg>",$}const b=t.filter(y=>y.formation===l);b.length;const x=!e.is_for_sale;n(`Formation ${l}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${f.filter(k=>k.id!==e.id).map((k,M)=>{const N=ie[k.id]||[],F=k.is_for_sale,Y=N.length?N[N.length-1]:null,q=k.evolution_bonus||0,O=Y?Y.source==="booster"?"Booster":Y.price?Y.price.toLocaleString("fr")+" cr.":"—":"—",ce=Y?new Date(Y.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",ne=80,fe=Math.round(ne*657/507),we=Te({...c,_evolution_bonus:q},{width:ne});return`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([k,M])=>{const N=Ii[k],F=k==="GK"?"#fff":N,Y=k===c.job||k===c.job2,q=(Number(M)||0)+(Y&&m>0?m:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",s);let L=new Set;const I=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function U(){let k=0;return document.querySelectorAll(".expl-check:checked").forEach(M=>{if(M.dataset.id===e.id)return;const F=Number(M.dataset.evo)||0,Y=Number(M.dataset.note)||0;k+=Y+F}),Math.round(k*I)}const V=()=>{const k=L.size,M=document.getElementById("sell-action-panel");if(!M)return;M.style.display=k>0?"block":"none",document.getElementById("sell-selected-count").textContent=k;const N=document.getElementById("evolve-btn");if(N){const F=U();N.textContent=F>0?`⬆️ Évoluer (+${F})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(k=>{k.addEventListener("change",()=>{const M=k.dataset.id;k.checked?L.add(M):L.delete(M);const N=k.closest(".exemplaire-row");if(N){const F=N.querySelector(".expl-sel-overlay"),Y=N.querySelector(".expl-sel-check");F&&(F.style.display=k.checked?"block":"none"),Y&&(Y.style.display=k.checked?"flex":"none"),N.style.transform=k.checked?"scale(1.05)":"scale(1)"}V()})}),document.querySelectorAll(".exemplaire-row").forEach(k=>{k.addEventListener("click",M=>{if(M.target.tagName==="INPUT")return;const N=k.querySelector(".expl-check");N&&!N.disabled&&(N.checked=!N.checked,N.dispatchEvent(new Event("change")))})}),(K=document.getElementById("evolve-btn"))==null||K.addEventListener("click",async()=>{if(b<=1)return;const k=[...L];if(!k.length)return;if(L.has(e.id)){const ne=document.createElement("div");ne.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ne.innerHTML=`
        ...
        </div>`,document.body.appendChild(fe),fe.querySelector("#sac-cancel").addEventListener("click",()=>{fe.remove(),ne(!1)}),fe.querySelector("#sac-ok").addEventListener("click",()=>{fe.remove(),ne(!0)}),fe.addEventListener("click",we=>{we.target===fe&&(fe.remove(),ne(!1))})}))return;if(M.length){await v.from("market_listings").delete().in("card_id",M),await v.from("deck_cards").delete().in("card_id",M),await v.from("transfer_history").delete().in("card_id",M),await v.from("decks").update({stadium_card_id:null}).in("stadium_card_id",M);const{error:ne}=await v.from("cards").delete().in("id",M);if(ne){r("Erreur suppression : "+ne.message,"error");return}}const O=(e.evolution_bonus||0)+F,{error:ce}=await v.from("cards").update({evolution_bonus:O}).eq("id",e.id);if(ce){r("Erreur évolution : "+ce.message,"error");return}r(`⬆️ ${c.firstname} ${c.surname_real} : note ${w} → ${w+O} (+${F}) !`,"success",4e3),s(),d("collection")});async function de(k){const{data:M}=await v.from("sell_price_configs").select("price_min, price_max").eq("rarity",c.rarity).lte("note_min",w).gte("note_max",w).order("note_max",{ascending:!0}).limit(1).maybeSingle();return M?k<M.price_min||k>M.price_max?{ok:!1,min:M.price_min,max:M.price_max}:{ok:!0}:{ok:!0}}(le=document.getElementById("market-sell-btn"))==null||le.addEventListener("click",async()=>{var O;const k=[...L];if(!k.length){r("Sélectionne au moins un exemplaire","warning");return}const M=parseInt((O=document.getElementById("sell-market-price"))==null?void 0:O.value);if(!M||M<1){r("Prix invalide","error");return}const N=await de(M);if(!N.ok){r(`Prix hors grille : entre ${N.min.toLocaleString("fr")} et ${N.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:F}=await v.from("cards").update({is_for_sale:!0,sale_price:M}).in("id",k);if(F){r(F.message,"error");return}const Y=k.map(ce=>({seller_id:o.profile.id,card_id:ce,price:M,status:"active"})),{error:q}=await v.from("market_listings").insert(Y);q&&console.warn("[Market] insert listings:",q.message),r(`${k.length} carte${k.length>1?"s":""} mise${k.length>1?"s":""} en vente à ${M.toLocaleString("fr")} cr. chacune !`,"success"),s(),d("collection")}),(ue=document.getElementById("single-sell-btn"))==null||ue.addEventListener("click",async()=>{var Y;const k=parseInt((Y=document.getElementById("single-sell-price"))==null?void 0:Y.value);if(!k||k<1){r("Prix invalide","error");return}const M=await de(k);if(!M.ok){r(`Prix hors grille : entre ${M.min.toLocaleString("fr")} et ${M.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:N}=await v.from("cards").update({is_for_sale:!0,sale_price:k}).eq("id",e.id);if(N){r(N.message,"error");return}const{error:F}=await v.from("market_listings").insert({seller_id:o.profile.id,card_id:e.id,price:k,status:"active"});F&&console.warn("[Market] insert listing:",F.message),r(`Carte mise en vente à ${k.toLocaleString("fr")} cr. !`,"success"),s(),d("collection")}),(pe=document.getElementById("cancel-sell-btn"))==null||pe.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),r("Annonce retirée","success"),s(),d("collection")})}function hn(e,t=""){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  `,document.body.appendChild(o);let r=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=I=>I.touches&&I.touches[0]?I.touches[0].clientX:I.clientX;function c(I){r||(d=!0,s.style.opacity="1",f(I))}function f(I){if(!d||r)return;const U=a.getBoundingClientRect(),V=l(I)-U.left,de=Math.max(0,Math.min(1,V/U.width));s.style.width=de*U.width+"px",de>=.82&&x()}function b(){r||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{r||(s.style.transition="")},220))}function x(){var U;if(r)return;r=!0,d=!1,s.style.width="100%",s.style.opacity="1",(U=document.getElementById("cut-flash"))==null||U.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const I=document.getElementById("cut-hint");I&&(I.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",c),window.addEventListener("pointermove",f),window.addEventListener("pointerup",b),a.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",b);let g=0,p=!1;const u=new Set;function y(I){g=I,document.getElementById("reveal-phase").style.display="flex",w(),h(I,0),S()}function w(){const I=document.getElementById("card-dots");I&&(I.innerHTML=e.map((U,V)=>`<div class="card-dot" data-i="${V}" style="width:8px;height:8px;border-radius:50%;background:${V===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),I.querySelectorAll(".card-dot").forEach(U=>U.addEventListener("click",()=>m(parseInt(U.dataset.i)))))}function h(I,U){var k,M;const V=e[I],de=document.getElementById("card-counter"),me=document.getElementById("card-track");de&&(de.textContent=`Carte ${I+1} / ${e.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=I===e.length-1?"flex":"none");const K=V.card_type==="player"&&((k=V.player)==null?void 0:k.rarity)==="legende",le=!u.has(I);u.add(I);let ue=0;if(V.card_type==="player"&&V.player){const N=V.player,F=N.job||"ATT";ue=(Number(F==="GK"?N.note_g:F==="DEF"?N.note_d:F==="MIL"?N.note_m:N.note_a)||0)+(V.evolution_bonus||0)}const pe=N=>{me.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <!-- Pagination -->
      ${r.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${r.map((Q,L)=>`<div style="width:6px;height:6px;border-radius:50%;background:${L===c?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Q(){const L=e.querySelector(".deck-preview-wrap"),I=e.querySelector("#deck-swipe-zone");if(!L||!I||!y)return;const U=I.clientWidth>=900,V=Math.max(200,I.clientHeight-(U?60:40)),me=Math.max(200,I.clientWidth-16),j=U?Math.min(117,Math.max(52,Math.round(me*.22))):Math.max(44,Math.round(me*.168));if(V<220||me<220){requestAnimationFrame(Q);return}const K=U?null:Math.round(j*.55);L.innerHTML=Nt(y,u,null,[],me,V,[],K),L.style.cssText=`width:${me}px;height:${V}px;overflow:hidden;margin:${U?0:60}px auto 0`;const le=L.querySelector("svg");le&&(le.style.cssText="display:block;width:100%;height:100%",le.setAttribute("preserveAspectRatio",U?"xMidYMid meet":"none"))})),(S=document.getElementById("prev-deck"))==null||S.addEventListener("click",()=>{c>0&&(c--,f())}),(G=document.getElementById("next-deck"))==null||G.addEventListener("click",()=>{c<r.length-1&&(c++,f())}),(J=document.getElementById("validate-deck"))==null||J.addEventListener("click",()=>{if(!h)return;const Q=t.state.params||{};t.navigate("match",{...Q,matchMode:Q.matchMode||i,deckId:b.id})}),(ie=document.getElementById("cancel-deck-select"))==null||ie.addEventListener("click",()=>{it(e),o("home")});const E=document.getElementById("deck-swipe-zone");if(E){let Q=0,L=0;E.addEventListener("touchstart",I=>{Q=I.touches[0].clientX,L=I.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",I=>{const U=I.changedTouches[0].clientX-Q,V=I.changedTouches[0].clientY-L;Math.abs(U)<40||Math.abs(U)<Math.abs(V)||(U<0&&c<r.length-1?(c++,f()):U>0&&c>0&&(c--,f()))},{passive:!0})}}f()}function vt(e,t=44,i=58,n=null){return Te(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Je(e,t,i,n,o){if(!(e!=null&&e.length))return"";const r=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return r.forEach((s,d)=>{const l=s._line||s.job||"MIL";let c=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(l==="ATT"||l==="MIL")||n==="defense"&&(l==="GK"||l==="DEF"||l==="MIL")?c+=10:n||(c+=10)),a+=Te(s,{width:40,role:l,extraNote:c}),d<r.length-1){const f=r[d+1],b=Gn(s,f,o)?Ht(s,f):null;a+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function wi(e,t,i,n,o=310,r=310,a=[],s=null){const d=Mt[t]||{},l=Ni(t)||Oi[t]||[],c={},f=["ATT","MIL","DEF","GK"];for(const y of f)(e[y]||[]).forEach((h,E)=>{c[`${y}${E+1}`]=h});function b(y){const w=d[y];return w?{x:w.x*o,y:w.y*r}:null}let x="";for(const[y,w]of l){const h=b(y),E=b(w);if(!h||!E)continue;const m=c[y],C=c[w],$=Ht(m,C);$==="#00ff88"||$==="#FFD700"?(x+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const K=t.pendingAttack;let le="";if(t.selected.length>0){const ue=t.selected.map(k=>({...(t.homeTeam[k._role]||[]).find(N=>N.cardId===k.cardId)||k,_line:k._role})),pe=oi(ue,t.modifiers.home,t.formation);le=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Je(ue.map(k=>({...k,used:!1})),"#3a7bd5",pe.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Je((K.players||[]).map(ue=>({...ue,used:!1})),"#ff6b6b",K.total,"attack",t.formation)}</div>
            ${le}
          </div>`}if(t.phase==="ai-defense"&&t.pendingAttack){const K=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
            <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
            <div style="display:flex;justify-content:center">${Je((K.players||[]).map(le=>({...le,used:!1})),"#00ff88",K.total,"attack",t.formation)}</div>
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const K=t.selected.map(ue=>{const pe=(t.homeTeam[ue._role]||[]).find(M=>M.cardId===ue.cardId)||ue,k=["GK","DEF"].includes(ue._role);return{...pe,_line:ue._role,...k?{note_a:Math.max(1,Number(pe.note_a)||0)}:{}}}),le=ni(K,t.modifiers.home,t.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Je(K.map(ue=>({...ue,used:!1})),"#FFD700",le.total,"attack",t.formation)}</div>
    ...
    ${(()=>{const j=window.innerWidth>=700,K=(q,O,ce)=>{var Se,Be;const ne=(t.gcDefs||[]).find($e=>$e.name===q.gc_type),fe=(ne==null?void 0:ne.name)||q.gc_type,we=(ne==null?void 0:ne.effect)||((Se=je[q.gc_type])==null?void 0:Se.desc)||"",he=ne!=null&&ne.image_url?`/icons/${ne.image_url}`:null,Ie=((Be=je[q.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${q.id}" data-gc-type="${q.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${tt(fe,he,Ie,we,{width:O})}
        </div>`},le=(q,O)=>{var ce;return`<div id="boost-card"
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(j=>{var K,le,ue;if(j.type==="duel"){const pe=j.isGoal,k=j.homeScored?"#FFD700":pe?"#ff6b6b":"rgba(255,255,255,0.3)",M=j.homeScored?"⚽ BUT !":pe?"⚽ BUT IA !":(K=j.homePlayers)!=null&&K.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${pe?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${k};margin-bottom:4px">
                <div style="font-size:9px;color:${k};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${M}</div>
                ${(le=j.homePlayers)!=null&&le.length?`<div style="margin-bottom:3px">${Je(j.homePlayers,"rgba(255,255,255,0.7)",j.homeTotal,void 0,t.formation)}</div>`:""}
                ${(ue=j.aiPlayers)!=null&&ue.length?`<div style="opacity:0.7">${Je(j.aiPlayers,"#ff6b6b",j.aiTotal,void 0,t.formation)}</div>`:""}
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(C=f.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,b())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<r.length-1&&(s++,b())}),(S=f.querySelector("#in-up"))==null||S.addEventListener("click",()=>{l>0&&(l--,b())}),(G=f.querySelector("#in-down"))==null||G.addEventListener("click",()=>{l<a.length-1&&(l++,b())});const E=(ie,Q,L,I)=>{const U=f.querySelector("#"+ie);if(!U)return;let V=0;U.addEventListener("touchstart",de=>{V=de.touches[0].clientY},{passive:!0}),U.addEventListener("touchend",de=>{const me=de.changedTouches[0].clientY-V;if(Math.abs(me)<30)return;const j=Q();me<0&&j<I-1?(L(j+1),b()):me>0&&j>0&&(L(j-1),b())},{passive:!0})};E("in-panel",()=>l,ie=>l=ie,a.length),E("out-panel",()=>s,ie=>s=ie,r.length),(J=f.querySelector("#sub-confirm"))==null||J.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),c)return;c=!0;const Q=r[s],L=a[l];if(!Q||!L)return;let I=null,U=-1;for(const[de,me]of Object.entries(t.homeTeam)){const j=(me||[]).findIndex(K=>K.cardId===Q.cardId);if(j!==-1){I=de,U=j;break}}if(U===-1||!I){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const V={...L,_line:I,_col:Q._col||0,used:!1,boost:0};t.homeTeam[I].splice(U,1,V),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(L.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Q.name,firstname:Q.firstname,note:Pe(Q,I),portrait:At(Q),job:Q.job,country_code:Q.country_code,rarity:Q.rarity,clubName:Q.clubName,clubLogo:Q.clubLogo},inPlayer:{name:L.name,firstname:L.firstname,note:Pe(L,I),portrait:At(L),job:L.job,country_code:L.country_code,rarity:L.rarity,clubName:L.clubName,clubLogo:L.clubLogo},text:`🔄 ${L.firstname} ${L.name} remplace ${Q.firstname} ${Q.name}`}),f.remove(),Lr(Q,L,()=>ke(e,t,i))})}document.body.appendChild(f),b()}function Fr(e,t,i,n,o){var b,x;const r=(n.gcDefs||[]).find(g=>g.name===t),a=je[t]||{icon:"⚡",desc:"Carte spéciale."},s=(r==null?void 0:r.name)||t,d=(r==null?void 0:r.effect)||a.desc,l=r!=null&&r.image_url?`/icons/${r.image_url}`:null,c=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${wi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            </div>`}}catch(Z){console.error("[Ranked] MMR update error:",Z)}(te=document.getElementById("pvp-end-overlay"))==null||te.remove();const D=document.createElement("div");D.id="pvp-end-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const P=T?"🤝":B?"🏆":"😞",H=T?"MATCH NUL":B?"VICTOIRE !":"DÉFAITE",X=T?"#fff":B?"#FFD700":"#ff6b6b";D.innerHTML=`
      ...
      ${R}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${c?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(ee=D.querySelector("#pvp-end-home"))==null||ee.addEventListener("click",()=>{D.remove(),it(e),c?x("mini-league",{openLeagueId:c}):x(a?"ranked":"home")})}const Q=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var A;const z=_.new;try{if(z.status==="finished"||z.forfeit){if(C)return;C=!0,$&&(clearInterval($),$=null),Ue(),z.game_state&&(m=z.game_state),ie(z);return}if(z.game_state){const B=m;m=z.game_state;const T=m._lastGC;if(T&&T.seq&&!J.has(T.seq)&&(J.add(T.seq),T.by!==p)){k(T.type,T.by,()=>K());return}const R=B[p+"Score"]||0,D=B[u+"Score"]||0,P=m[p+"Score"]||0,H=m[u+"Score"]||0,X=P>R,te=H>D;if((X||te)&&!G.has(m.round)){G.add(m.round);const ee=[...m.log||[]].reverse().find(ae=>ae.isGoal),Z=((ee==null?void 0:ee.homePlayers)||[]).map(ae=>({name:ae.name,note:ae.note,portrait:ae.portrait,job:ae.job}));!!((A=ee==null?void 0:ee.text)!=null&&A.includes("DERNIER CORNER"))?we().then(()=>{Qe(Z,P,H,X,()=>K())}):Qe(Z,P,H,X,()=>K());return}K()}}catch(B){console.error("[PvP] crash:",B)}}).subscribe();async function L(_){Object.assign(m,_),m.lastActionAt=new Date().toISOString();const{error:z}=await v.from("matches").update({game_state:m}).eq("id",i);z&&g("Erreur de synchronisation","error");try{K()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function I(){if(C)return;C=!0,It(),Ue(),$&&(clearInterval($),$=null);const _=n?h.away_id:h.home_id,z=n?"p2":"p1",A=n?"p1":"p2",B={...m,[z+"Score"]:3,[A+"Score"]:0,phase:"finished"},T=B.p1Score||0,R=B.p2Score||0;try{await v.from("matches").update({game_state:B}).eq("id",i);const{data:D,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:T,p_away_score:R,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(H){console.error("[PvP] check_and_finish_mini_league (forfeit):",H)}try{const{data:H}=await v.rpc("apply_match_rewards",{p_match_id:i});H!=null&&H.success&&!(H!=null&&H.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(H){console.error("[PvP] apply_match_rewards (forfeit):",H)}}catch{}try{v.removeChannel(Q)}catch{}setTimeout(()=>{it(e),c?x("mini-league",{openLeagueId:c}):x("home")},800)}const U={BOOST_STAT:({value:_=1,count:z=1,roles:A=[]},B,T)=>{const R=B[p+"Team"],D=Object.entries(R).filter(([P])=>!A.length||A.includes(P)).flatMap(([P,H])=>H.filter(X=>!X.used).map(X=>({...X,_line:P})));if(!D.length){B.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(B);return}V(D,z,`Choisir ${z} joueur(s) à booster (+${_})`,P=>{P.forEach(H=>{const X=(R[H._line]||[]).find(te=>te.cardId===H.cardId);X&&(X.boost=(X.boost||0)+_,B.log.push({text:`⚡ +${_} sur ${X.name}`,type:"info"}))}),B[p+"Team"]=R,T(B)})},DEBUFF_STAT:({value:_=1,count:z=1,roles:A=[],target:B="ai"},T,R)=>{const D=B==="home"?p:u,P=T[D+"Team"],H=B==="home"?"allié":"adverse",X=Object.entries(P).filter(([te])=>!A.length||A.includes(te)).flatMap(([te,ee])=>ee.map(Z=>({...Z,_line:te})));if(!X.length){T.log.push({text:`🎯 Aucun joueur ${H}`,type:"info"}),R(T);return}V(X,z,`Choisir ${z} joueur(s) ${H}(s) (-${_})`,te=>{te.forEach(ee=>{const Z=(P[ee._line]||[]).find(re=>re.cardId===ee.cardId);Z&&(Z.boost=(Z.boost||0)-_,T.log.push({text:`🎯 -${_} sur ${Z.name}`,type:"info"}))}),T[D+"Team"]=P,R(T)})},GRAY_PLAYER:({count:_=1,roles:z=[],target:A="ai"},B,T)=>{const R=A==="home"?p:u,D=B[R+"Team"],P=A==="home"?"allié":"adverse",H=Object.entries(D).filter(([X])=>!z.length||z.includes(X)).flatMap(([X,te])=>te.filter(ee=>!ee.used).map(ee=>({...ee,_line:X})));if(!H.length){B.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),T(B);return}V(H,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,X=>{const te="usedCardIds_"+R,ee=new Set(B[te]||[]);X.forEach(Z=>{const re=(D[Z._line]||[]).find(ae=>ae.cardId===Z.cardId);re&&(re.used=!0,ee.add(Z.cardId),B.log.push({text:`❌ ${re.name} exclu !`,type:"info"}))}),B[te]=[...ee],B[R+"Team"]=D,T(B)})},REVIVE_PLAYER:({count:_=1,roles:z=[]},A,B)=>{const T=A[p+"Team"],R=Object.entries(T).filter(([D])=>!z.length||z.includes(D)).flatMap(([D,P])=>P.filter(H=>H.used).map(H=>({...H,_line:D})));if(!R.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),B(A);return}V(R,_,`Choisir ${_} joueur(s) à ressusciter`,D=>{D.forEach(P=>{const H=(T[P._line]||[]).find(X=>X.cardId===P.cardId);H&&(H.used=!1,A.log.push({text:`💫 ${H.name} ressuscité !`,type:"info"}))}),A[p+"Team"]=T,B(A)})},REMOVE_GOAL:({},_,z)=>{const A=u+"Score";_[A]>0?(_[A]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),z(_)},ADD_GOAL_DRAW:({},_,z)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),z(_)},ADD_SUB:({value:_=1},z,A)=>{z.maxSubs=(z.maxSubs||3)+_,z.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),A(z)},CUSTOM:({},_,z)=>z(_)};function V(_,z,A,B){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let R=[];function D(){var H,X;const P=_.map(te=>{const ee=te._line||te.job||"MIL",Z=R.find(ae=>ae.cardId===te.cardId),re=Te({...te,_evolution_bonus:0},{width:90,showStad:!0,role:ee,extraNote:te.boost||0});return`<div class="pp-item" data-cid="${te.cardId}"
        ...
        </div>`,(H=T.querySelector("#pp-close"))==null||H.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(te=>{te.addEventListener("click",()=>{const ee=te.dataset.cid,Z=_.find(ae=>ae.cardId===ee),re=R.findIndex(ae=>ae.cardId===ee);Z&&(re>-1?R.splice(re,1):R.length<z&&R.push(Z),D())})}),(X=T.querySelector("#pp-confirm"))==null||X.addEventListener("click",()=>{T.remove(),B(R)})}D(),document.body.appendChild(T)}async function de(_,z){const B=(m["gcCardsFull_"+p]||[]).find(P=>P.id===_),T=(B==null?void 0:B._gcDef)||(m.gcDefs||[]).find(P=>{var H;return P.name===z||((H=P.name)==null?void 0:H.toLowerCase().trim())===(z==null?void 0:z.toLowerCase().trim())}),R=[...m["usedGc_"+p]||[],_],D={type:z,by:p,seq:(m._gcAnimSeq||0)+1};J.add(D.seq),k(z,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const H=U[T.effect_type];if(H){const X={...m};H(T.effect_params||{},X,async te=>{te["usedGc_"+p]=R,te._lastGC=D,te._gcAnimSeq=D.seq,await L(te)});return}}const P={...m};switch(z){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const H=u+"Score";P[H]>0&&(P[H]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=R,P._lastGC=D,P._gcAnimSeq=D.seq,await L(P)})}function me(_,z){const A="usedCardIds_"+_,B=new Set(m[A]||[]);z.forEach(T=>B.add(T)),m[A]=[...B]}function j(){for(const _ of["p1","p2"]){const z=new Set(m["usedCardIds_"+_]||[]),A=m[_+"Team"];if(A)for(const B of["GK","DEF","MIL","ATT"])(A[B]||[]).forEach(T=>{T.used=z.has(T.cardId)})}}function K(){var on,rn,an,sn,dn,ln;if(m.phase==="reveal")return le();if(m.phase==="midfield")return pe();if(m.phase==="finished")return Ge();const _=m[p+"Team"],z=m[u+"Team"];j();const A=m[p+"Score"],B=m[u+"Score"],T=m[p+"Name"],R=m[u+"Name"],D=m.phase===p+"-attack",P=m.phase===p+"-defense",H=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],X=H.map(W=>W.cardId),te=window.innerWidth>=700,ee=m[p+"Subs"]||[],Z=m["usedSubIds_"+p]||[],re=ee.filter(W=>!Z.includes(W.cardId)),ae=m["gcCardsFull_"+p]||[],xe=m["usedGc_"+p]||[],se=ae.filter(W=>!xe.includes(W.id)),be=m.boostOwner===p&&!m.boostUsed,ve=[..._.MIL||[],..._.ATT||[]].filter(W=>!W.used),oe=[...z.MIL||[],...z.ATT||[]].filter(W=>!W.used),Le=!$e(z),Re=ve.length===0&&oe.length===0&&!Le,ze=(_.DEF||[]).filter(W=>!W.used),Ve=(_.GK||[]).filter(W=>!W.used);let Oe=[];D&&ve.length===0&&(Le?(Oe=ze.map(W=>W.cardId),ze.length===0&&(Oe=Oe.concat(Ve.map(W=>W.cardId)))):Re&&(Oe=[...ze,...Ve].map(W=>W.cardId)));function nt(W,ge,Ae){var Me,ft;const _e=W._gcDef,qt=(_e==null?void 0:_e.name)||W.gc_type,at=(_e==null?void 0:_e.effect)||((Me=je[W.gc_type])==null?void 0:Me.desc)||"",Fe=_e!=null&&_e.image_url?`/icons/${_e.image_url}`:null,Ne=((ft=je[W.gc_type])==null?void 0:ft.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${W.id}" data-gc-type="${W.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Nt(_,m[p+"Formation"],ut,X,te?1300:Tt(),te?600:Gt(),Oe)}
      </div>
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Nt(_,m[p+"Formation"],ut,X,Tt(),Gt(),Oe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Bt(){const W=e.querySelector(".match-screen");if(!W)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);W.style.height=ge+"px",W.style.minHeight=ge+"px",W.style.maxHeight=ge+"px",W.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),_e=e.querySelector("#mobile-play-area");Ae&&_e&&(_e.style.paddingBottom=Ae.offsetHeight+"px")}if(Bt(),setTimeout(Bt,120),setTimeout(Bt,400),S||(S=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Bt),window.visualViewport.addEventListener("scroll",Bt)),window.addEventListener("resize",Bt)),function(){const ge=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ge)return;const Ae=ge.closest("#match-terrain-wrap");Ae&&(Ae.style.cssText="position:relative;width:100%;height:100%;padding:0"),ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const W=e.querySelector(".terrain-wrapper svg");if(W){const ge=W.closest("#match-terrain-wrap");ge&&(ge.style.cssText="position:relative;width:100%;height:100%;padding:0"),W.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(W=>{W.addEventListener("click",()=>{if(!D&&!P)return;const ge=W.dataset.cardId,Ae=W.dataset.role,_e=(_[Ae]||[]).find(Ne=>Ne.cardId===ge);if(!_e||_e.used)return;const qt=Oe.includes(ge);if(D&&!["MIL","ATT"].includes(Ae)&&!qt)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const at=m["selected_"+p],Fe=at.findIndex(Ne=>Ne.cardId===ge);Fe>-1?at.splice(Fe,1):at.length<3&&at.push({..._e,_role:Ae}),K()})}),e.querySelectorAll(".match-used-hit").forEach(W=>{W.addEventListener("click",()=>F(W.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(W=>{W.addEventListener("click",()=>F())}),(on=e.querySelector("#pvp-sub-open"))==null||on.addEventListener("click",()=>F()),e.querySelectorAll(".pvp-gc-mini").forEach(W=>{D?W.addEventListener("click",()=>M(W.dataset.gcId,W.dataset.gcType)):(W.style.opacity="0.35",W.style.cursor="default",W.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(rn=e.querySelector("#pvp-boost-card"))==null||rn.addEventListener("click",()=>N()),(an=e.querySelector("#pvp-action"))==null||an.addEventListener("click",W=>{D?W.currentTarget.dataset.pass==="1"||!ct(p)?ce():Ie():P&&Se()}),(sn=e.querySelector("#pvp-quit"))==null||sn.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&I()}),(dn=e.querySelector("#pvp-view-opp"))==null||dn.addEventListener("click",()=>q()),(ln=e.querySelector("#pvp-toggle-history"))==null||ln.addEventListener("click",()=>O()),$&&(clearInterval($),$=null),Ue(),(D||P)&&!C){let W=30,ge=!1;const Ae=()=>document.getElementById("pvp-timer"),_e=()=>{Ae()&&(Ae().textContent=W+"s",Ae().style.color=ge?"#ff4444":"#fff")};_e(),$=setInterval(()=>{W--,W<0?ge?(clearInterval($),$=null,Ue(),D&&!ct(p)?ce():I()):(ge=!0,W=15,_e(),Mn("/sounds/timer-urgent.mp3",.6)):_e()},1e3)}}function le(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(ee);let Z=!1;const re=()=>{Z||(Z=!0,ee.remove(),setTimeout(()=>A&&A(),50))};ee.addEventListener("click",re),setTimeout(re,3e3)}function M(_,z){var te,ee,Z,re;const B=(m["gcCardsFull_"+p]||[]).find(ae=>ae.id===_),T=B==null?void 0:B._gcDef,R=(T==null?void 0:T.name)||z,D=(T==null?void 0:T.effect)||((te=je[z])==null?void 0:te.desc)||"Carte spéciale.",P=T!=null&&T.image_url?`/icons/${T.image_url}`:null,H=((ee=je[z])==null?void 0:ee.icon)||"⚡",X=document.createElement("div");X.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",X.innerHTML=`
      ${tt(R,P,H,D,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(X),(Z=X.querySelector("#pvp-gc-back"))==null||Z.addEventListener("click",()=>X.remove()),(re=X.querySelector("#pvp-gc-use"))==null||re.addEventListener("click",()=>{X.remove(),de(_,z)})}function N(){var B;const _=m[p+"Team"],z=Object.entries(_).flatMap(([T,R])=>(R||[]).filter(D=>!D.used).map(D=>({...D,_line:T})));if(!z.length)return;const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",A.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${z.map(T=>{const R={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",D=Pe(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${R};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(z),(A=z.querySelector("#pvp-hist-close"))==null||A.addEventListener("click",()=>z.remove())}async function ce(){if(m.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",z=(m.round||0)+1,A=[...m.log||[]];A.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const B=Ee(m),T=ct(_),R=B||!T?"finished":_+"-attack";await L({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:R,attacker:_,round:z,log:A}),R==="finished"&&await qe(m)}function ne(_){const z=(_.GK||[]).some(B=>!B.used),A=["DEF","MIL","ATT"].some(B=>(_[B]||[]).some(T=>!T.used));return z&&!A}function fe(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ne(_.p1Team)&&!$e(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(z=>!z.used)}:ne(_.p2Team)&&!$e(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(z=>!z.used)}:null}async function we(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const z=(A,B)=>new Promise(T=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${B};letter-spacing:2px;animation:lcFade 1.4s ease both">${A}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await z("⚽ DERNIER CORNER","#FFD700"),await z("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function he(_,z){const{side:A,gk:B}=_;if(!B)return;const T=A+"Score",R=(z[T]||0)+1;B.used=!0;const D=[...z.log||[]];D.push({type:"duel",isGoal:!0,homeScored:A===p,homePlayers:A==="p1"?[Dt(B)]:[],aiPlayers:A==="p2"?[Dt(B)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${z[A+"Name"]} marque !`});const P=(z.round||0)+1,H=A==="p1"?"p2":"p1",X={...z,[T]:R},te=Ee(X);G.add(P),await we();const ee=A===p?R:z[p+"Score"]||0,Z=A===p?z[u+"Score"]||0:R;Qe([Dt(B)],ee,Z,A===p,async()=>{await L({[T]:R,log:D,round:P,pendingAttack:null,phase:te?"finished":H+"-attack",attacker:H,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),te&&await qe({...m,[T]:R})})}async function Ie(){const _=m[p+"Team"],z=!["GK","DEF","MIL","ATT"].some(R=>(m[u+"Team"][R]||[]).some(D=>!D.used)),A=(m["selected_"+p]||[]).map(R=>{const D=(_[R._role]||[]).find(ae=>ae.cardId===R.cardId)||R,P=["GK","DEF"].includes(R._role),H=_[R._role]||[],X=H.findIndex(ae=>ae.cardId===R.cardId),te=xt(H.length),ee=X>=0?te[X]:D._col??1,Z=m.stadiumDef||m.homeStadiumDef||null,re=D.stadiumBonus||Z&&(Z.club_id&&String(D.club_id)===String(Z.club_id)||Z.country_code&&D.country_code===Z.country_code)||!1;return{...D,_line:R._role,_col:ee,stadiumBonus:re,...P?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!A.length)return;const B=ni(A,m.modifiers[p]||{},m[p+"Formation"]);me(p,A.map(R=>R.cardId)),A.forEach(R=>{const D=(_[R._role]||[]).find(P=>P.cardId===R.cardId);D&&(D.used=!0)}),m["selected_"+p]=[],K();const T=[...m.log||[]];if(z){if(A.length===1&&(A[0]._line==="GK"||A[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await he({side:p,gk:A[0]},{...m,[p+"Team"]:_,log:T});return}const D=(m[p+"Score"]||0)+1,P=A.map(Z=>Dt(Z));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:B.total,aiTotal:0});const H=(m.round||0)+1,X=p==="p1"?"p2":"p1",te={...m,[p+"Team"]:_,[p+"Score"]:D},ee=Ee(te);G.add(H),Qe(P,D,m[u+"Score"]||0,!0,async()=>{await L({[p+"Team"]:_,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ee?"finished":X+"-attack",attacker:X,round:H,log:T}),ee&&await qe({...m,[p+"Score"]:D})});return}T.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${B.total})`}),await L({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],pendingAttack:{...B,players:A,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Se(){const _=m[p+"Team"],z=(m["selected_"+p]||[]).map(se=>{const be=(_[se._role]||[]).find(ze=>ze.cardId===se.cardId)||se,ve=_[se._role]||[],oe=ve.findIndex(ze=>ze.cardId===se.cardId),Le=xt(ve.length),Re=oe>=0?Le[oe]:be._col??1;return{...be,_line:se._role,_col:Re}}),A=oi(z,m.modifiers[p]||{},m[p+"Formation"]);me(p,z.map(se=>se.cardId)),z.forEach(se=>{const be=(_[se._role]||[]).find(ve=>ve.cardId===se.cardId);be&&(be.used=!0)}),m["selected_"+p]=[],K();const B=Ji(m.pendingAttack.total,A.total,m.modifiers[p]||{}),T=m.pendingAttack.side,R=B==="attack"||(B==null?void 0:B.goal),D=T==="p1"?"p2":"p1",P=(m.round||0)+1,H=(m.pendingAttack.players||[]).map(se=>Dt(se)),X=[...m.log||[]];X.push({type:"duel",isGoal:R,homeScored:R&&T===p,text:R?`⚽ BUT de ${m[T+"Name"]} ! (${m.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${A.total})`,homePlayers:H,aiPlayers:z.map(se=>Dt(se)),homeTotal:m.pendingAttack.total,aiTotal:A.total});const te=R?(m[T+"Score"]||0)+1:m[T+"Score"]||0,ee={...m,[p+"Team"]:_,[T+"Score"]:te},Z=Ee(ee),re=Z?"finished":D+"-attack",ae=!Z&&!R?fe(ee):null,xe=async()=>{if(ae){await he(ae,ee);return}await L({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],[T+"Score"]:te,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:re,attacker:D,round:P,log:X}),(re==="finished"||Z)&&await qe({...m,[T+"Score"]:te})};if(R){const se=T===p,be=se?te:m[p+"Score"]||0,ve=se?m[u+"Score"]||0:te;G.add(P),Qe(H,be,ve,se,xe)}else await xe()}function Be(_){return["MIL","ATT"].some(z=>(_[z]||[]).some(A=>!A.used))}function $e(_){return["GK","DEF","MIL","ATT"].some(z=>(_[z]||[]).some(A=>!A.used))}function _t(_){return $e(_)&&!Be(_)}function ct(_){const z=m[_+"Team"],A=m[(_==="p1"?"p2":"p1")+"Team"];return!!(Be(z)||_t(z)&&!$e(A)||_t(z)&&!Be(A)&&$e(A))}function Ee(_){return!$e(_.p1Team)&&!$e(_.p2Team)}function Ce(_){const z=_.p1Score||0,A=_.p2Score||0;return z===A?null:z>A?h.home_id:h.away_id}async function qe(_){It(),Ue();try{const z=Ce(_),A=z?h.home_id===z?h.away_id:h.home_id:null,B=_.p1Score||0,T=_.p2Score||0,{data:R,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:z,p_home_score:B,p_away_score:T,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}z&&A&&Ur(z,A).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof l=="function")try{await l({homeScore:B,awayScore:T,winnerId:z,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(z){console.error("[PvP] finishMatch:",z)}}function Ge(){var T;const _=m[p+"Score"],z=m[u+"Score"],A=_>z,B=_===z;st(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(Q)}catch{}it(e),c?x("mini-league",{openLeagueId:c}):x("home")})}K()}async function Pi(e,t,i=!1){var s,d;const{state:n,navigate:o,toast:r}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await _i(e,t,i?"ranked":"random",async({deckId:l,formation:c,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{st(e);const u=async y=>{await Yr(e,t,l,c,f,b,y||[],g,p,i,a)};if(!(x!=null&&x.length)){await u([]);return}vi(e,x,u)})}async function Vr(e,t,i){return Kr(e,t,i)}async function Yr(e,t,i,n,o,r,a=[],s=[],d=null,l=!1,c=null){var ie,Q;const{state:f,navigate:b,toast:x}=t,g=(c==null?void 0:c.mmr)??((ie=f.profile)==null?void 0:ie.mmr)??1e3,p=l?hi(g):null,u=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;e.innerHTML=`
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Xt};border:1px solid ${Jt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((L,I)=>{const U=g>0&&a.status==="finished"?I===0?Math.floor(g*.7):I===1?Math.floor(g*.2):I===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${L.userId===r?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${Xt};border:1px solid ${Jt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(L,I)=>I+1).reverse().map(L=>{const I=(d||[]).filter(U=>U.matchday===L);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ze};margin-bottom:6px">Journée ${L}</div>${I.map(U=>$n(U,f,r,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
          ...
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${L?"border:2px solid var(--yellow)":""}">
            ...
            <div style="text-align:right;flex-shrink:0">
              ...
              ${I?"":`<div style="font-size:10px;color:var(--tile-fg-dim)">${Q}% WR</div>`}
            </div>
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.25-2358" style="cursor:pointer">
