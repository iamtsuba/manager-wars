...
import{s as v,j as Li,q as Do,t as Dt,u as Ii,F as Ti,o as nt,n as Ht,g as qt,r as ze,m as ut,v as ni,w as Fo,T as qi,p as _n,x as kn,d as $n}from"./special-cards-YynorolH.js";const En="/";function go(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,d,c,l,s,u,y;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function d(){var g;const l=document.getElementById("logo-preview"),s=document.getElementById("logo-initials"),u=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",y=u.trim().split(" ").filter(Boolean),b=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():u.slice(0,2).toUpperCase();l&&(l.style.background=a,l.style.borderColor=n),s&&(s.textContent=b,s.style.color=n)}document.getElementById("color1").addEventListener("input",l=>{n=l.target.value,document.getElementById("swatch1").style.background=n,d()}),document.getElementById("color2").addEventListener("input",l=>{a=l.target.value,document.getElementById("swatch2").style.background=a,d()});function c(l){document.querySelectorAll(".setup-step").forEach(s=>s.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&d()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),s=document.getElementById("step1-error");if(s.textContent="",l.length<3){s.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await v.from("users").select("id").eq("pseudo",l).maybeSingle();if(u){s.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),s=document.getElementById("step2-error");if(s.textContent="",l.length<2){s.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await v.from("users").select("id").eq("club_name",l).maybeSingle();if(u){s.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),s=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),y=document.getElementById("step3-finish");u.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:l,club_name:s,club_color1:n,club_color2:a,credits:15e3});if(b)throw b;await In(e.user.id),await r(),o(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){u.textContent=b.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function In(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Tn="modulepreload",Sn=function(t){return"/"+t},bo={},Po=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=Sn(c),c in bo)return;bo[c]=!0;const l=c.endsWith(".css"),s=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${s}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Tn,l||(u.as="script"),u.crossOrigin="",u.href=c,d&&u.setAttribute("nonce",d),document.head.appendChild(u),l)return new Promise((y,b)=>{u.addEventListener("load",y),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return r.then(a=>{for(const d of a||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})},No="mw_sound_volume";function Ji(){const t=localStorage.getItem(No);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function An(t){localStorage.setItem(No,String(Math.max(0,Math.min(100,Math.round(t)))))}function Qi(){return Ji()===0}function hi(t){return Math.max(0,Math.min(1,t*(Ji()/100)))}function Zi(t,e=1){if(Qi())return null;try{const i=new Audio(t);return i.volume=hi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Ni=null,xo=.3;function Ro(t,e=.3){if(xo=e,ht&&Ni===t&&!ht.paused){ht.volume=hi(xo);return}if(Gt(),!Qi())try{const i=new Audio(t);i.loop=!0,i.volume=hi(e),i.play().catch(()=>{}),ht=i,Ni=t}catch{}}function Gt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Ni=null}let Qt=null;function Go(t,e=.6){if(Ke(),!Qi())try{const i=new Audio(t);i.volume=hi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const zn=[{key:"home2",route:"home2",label:"ACCUEIL",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARTES",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"EQUIPES",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOUTIQUE",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Oo(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const s=document.createElement("style");s.id="home2-chrome-style",s.textContent=`
    ...
    `,document.body.appendChild(n),n.querySelector("#home2-chrome-settings-btn").addEventListener("click",()=>t("settings")),n.querySelector("#home2-chrome-credits").addEventListener("click",()=>yo(state,toast)));let a=document.getElementById("home2-mobile-top");a||(a=document.createElement("div"),a.id="home2-mobile-top",a.className="home2-mobile-top",a.innerHTML=`
      <div class="home2-chrome-logo"><img src="${o}logo-withname.png" alt="Manager Wars"></div>
      <div class="home2-chrome-right">
    ...
    `;try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(u){console.warn("[AdSense]",u)}let l=e;const s=setInterval(()=>{l--;const u=a.querySelector("#credits-ad-cd");u&&(u.textContent=l),l<=0&&(clearInterval(s),c())},1e3)}function c(){var u,y;const l=a.querySelector("#credits-ad-status"),s=a.querySelector("#credits-ad-next-zone");n<t?(l&&(l.textContent="Publicité terminée ✅"),s&&(s.innerHTML=`
        <button id="credits-ad-next-btn" class="btn btn-primary" style="width:100%;padding:12px;font-size:14px">
          Suivant (${n}/${t}) →
        </button>`),(u=a.querySelector("#credits-ad-next-btn"))==null||u.addEventListener("click",()=>{n++,d()})):(l&&(l.textContent="Toutes les publicités ont été vues ✅"),s&&(s.innerHTML=`
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",l=>{l.target===i&&o()});const[{data:r},{data:n}]=await Promise.all([v.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),v.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),a=(n==null?void 0:n.unlocked_level)||1,d=r||[],c=document.getElementById("solo-levels-list");if(c){if(!d.length){c.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}c.innerHTML=d.map(l=>{const s=l.level_number>a,u=l.level_number===a,y=s?"#f0f0f0":u?"#eefaf2":"#f7f7f7",b=s?"#ddd":u?"#bfe8cf":"#e0e0e0",g=s?"#999":"#12401f";return`
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const d=a.dataset.action;if(d==="match-ai"){Ko(i,e);return}if(d==="match-random"){mt(),i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Wo(t,e){var p,x;const{state:i,navigate:o}=e,r=oi(),n=Ji(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,d="2026.07.29-1042";t.innerHTML=`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(K=document.getElementById("close-detail"))==null||K.addEventListener("click",d);let W=new Set;const de=s.rarity==="pepite"?1.3:s.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(Y=>{if(Y.dataset.id===t.id)return;const se=Number(Y.dataset.evo)||0,ge=Number(Y.dataset.note)||0;z+=ge+se}),Math.round(z*de)}const j=()=>{const z=W.size,Y=document.getElementById("sell-action-panel");if(!Y)return;Y.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const Y=z.dataset.id;z.checked?W.add(Y):W.delete(Y);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",Y=>{if(Y.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(y<=1)return;const z=[...W];if(!z.length)return;if(W.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
      ...
      <div style="display:flex;gap:0;min-height:600px">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${s.map(f=>{const w={...f.player,_evolution_bonus:f.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
        ...
        <div style="display:flex;gap:6px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${s.map(f=>{const w={...f.player,_evolution_bonus:f.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}const c=s=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(s)};function l(){var u,y,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const s=a.length>0;t.innerHTML=`
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function V(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!f)return;const R=_.clientWidth>=900,W=Math.max(200,_.clientHeight-(R?60:40)),ce=Math.max(200,_.clientWidth-16),j=R?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(W<220||ce<220){requestAnimationFrame(V);return}const H=R?null:Math.round(j*.55);I.innerHTML=Ut(f,x,null,[],ce,W,[],H),I.style.cssText=`width:${ce}px;height:${W}px;overflow:hidden;margin:${R?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",R?"xMidYMid meet":"none"))})),(T=document.getElementById("prev-deck"))==null||T.addEventListener("click",()=>{s>0&&(s--,u())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{s<n.length-1&&(s++,u())}),(G=document.getElementById("validate-deck"))==null||G.addEventListener("click",()=>{if(!h)return;const V=e.state.params||{};e.navigate("match",{...V,matchMode:V.matchMode||i,deckId:y.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let V=0,I=0;E.addEventListener("touchstart",_=>{V=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const R=_.changedTouches[0].clientX-V,W=_.changedTouches[0].clientY-I;Math.abs(R)<40||Math.abs(R)<Math.abs(W)||(R<0&&s<n.length-1?(s++,u()):R>0&&s>0&&(s--,u()))},{passive:!0})}}u()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((d,c)=>{const l=d._line||d.job||"MIL";let s=d.boost||0;if(d.stadiumBonus&&(o==="attack"&&(l==="ATT"||l==="MIL")||o==="defense"&&(l==="GK"||l==="DEF"||l==="MIL")?s+=10:o||(s+=10)),a+=ze({...d,_evolution_bonus:0,evolution_bonus:0},{width:40,role:l,extraNote:s}),c<n.length-1){const u=n[c+1],y=Xo(d,u,r)?Dt(d,u):null;a+=`<div style="width:7px;height:3px;background:${!y||y==="#ff3333"||y==="#cc2222"?"rgba(255,255,255,0.12)":y};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Ai(t,e,i,o,r=310,n=310,a=[],d=null){const c=ut[e]||{},l=Ii(e)||Ti[e]||[],s={},u=["ATT","MIL","DEF","GK"];for(const f of u)(t[f]||[]).forEach((h,E)=>{s[`${f}${E+1}`]=h});function y(f){const w=c[f];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[f,w]of l){const h=y(f),E=y(w);if(!h||!E)continue;const m=s[f],S=s[w],$=Dt(m,S);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
  ...
  <div id="match-history-panel">
    ...
    </div>`,(A=document.getElementById("pvp-home"))==null||A.addEventListener("click",()=>{try{v.removeChannel(V)}catch{}Ve(t),s?b("mini-league",{openLeagueId:s}):b("home")})}H()}async function Yi(t,e,i=!1){var d,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:c.rankedData)||null;await zi(t,e,i?"ranked":"random",async({deckId:l,formation:s,starters:u,subsRaw:y,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const x=async f=>{await ea(t,e,l,s,u,y,f||[],g,p,i,a)};if(!(b!=null&&b.length)){await x([]);return}Si(t,b,x)})}async function Zr(t,e,i){return Qr(t,e,i)}async function ea(t,e,i,o,r,n,a=[],d=[],c=null,l=!1,s=null){var O,V;const{state:u,navigate:y,toast:b}=e,g=(s==null?void 0:s.mmr)??((O=u.profile)==null?void 0:O.mmr)??1e3,p=l?Li(g):null,x=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",f=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(V=document.getElementById("cancel-mm"))==null||V.addEventListener("click",async()=>{await m(),Ve(t),y("home")});const S=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Bt(t,e,I,_,{myGC:a,gcDefs:d,stadiumDef:c,isRanked:l,rankedData:s,onMatchEnd:l?ta:null}))},$=u.user.id,{data:T,error:P}=l?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(T!=null&&T.success)){console.error("[Matchmaking] try_matchmake error:",P||T),b("Erreur de matchmaking","error"),Ve(t),y("home");return}if(T.matched){await S(T.match_id,!1);return}const G=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await S(I.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&S(_.match_id,!0)}).subscribe(),E=setInterval(G,3e3),l?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),y("match",{matchMode:"ranked_ai",rankedData:s,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:d,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function ta(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:d,awayScore:c,matchId:l}=t,s=i.user.id,u=n===s,y=r===s,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",s).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",u?a:n).single();if(b&&g){const p=Fo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,y?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?v.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:v.sql`mmr_losses + 1`}).eq("id",s),o(y?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,y?"success":"error",4e3)}}const ia=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Yi,resumePvpMatch:Zr},Symbol.toStringTag,{value:"Module"}));async function oa(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,d=n.friendName||"Ami",c=!!n.isAccepting;await zi(t,e,"friend",async({deckId:l,formation:s,starters:u,subsRaw:y,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const x=async f=>{const w=f||[];c?await ra(t,e,l,w,g,p):await na(t,e,l,w,g,p,a,d)};if(!(b!=null&&b.length)){await x([]);return}Si(t,b,x)})}async function na(t,e,i,o,r,n,a,d){var w;const{state:c,navigate:l,toast:s}=e,u=c.user.id,{data:y,error:b}=await v.from("friend_match_invites").insert({inviter_id:u,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!y){console.error("[Friend] Erreur création invitation:",b),s("Impossible de créer l'invitation","error"),l("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${s&&u.length>=2?`<button id="ml-start-btn" class="btn btn-primary" style="width:100%;margin-top:14px;padding:12px">🚀 Lancer (prélève ${p} cr. × ${u.length})</button>`:""}
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${b.map(I=>zo(I,u,n,l)).join("")}
        ${s&&x&&!f?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
      </div>`:""}
    ...
    </div>`;let s=!1;const u=async x=>{if(!s){if(s=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}x&&await Bt(t,e,x,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:d}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(s=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}l("mini-league",{openLeagueId:o}),c()});const y=async()=>{if(s)return;const{data:x}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();x!=null&&x.match_id&&u(x.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},x=>{var f;(f=x.new)!=null&&f.match_id&&u(x.new.match_id)}).subscribe(),g=setInterval(y,3e3);y()})}const wa="/",_a=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ka(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var s,u,y;const d=e[o],c=o===e.length-1,l=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  </div>`;let c="buy";const l=()=>{var p,x,f,w,h,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((x=document.getElementById("flt-club"))==null?void 0:x.value)||"").toLowerCase().trim(),country:(((f=document.getElementById("flt-country"))==null?void 0:f.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function s(p){const x=l();return p.filter(f=>{var P,G,O;const w=(P=f.card)==null?void 0:P.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((G=w.clubs)==null?void 0:G.encoded_name)||"").toLowerCase(),m=(w.country_code||"").toLowerCase(),S=((O=f.card)==null?void 0:O.evolution_bonus)||0,$=xi(w,w.job,S),T=w.job2?xi(w,w.job2,S):0;return!(x.name&&!h.includes(x.name)||x.club&&!E.includes(x.club)||x.country&&!m.includes(x.country)||x.job&&w.job!==x.job||x.rarity&&w.rarity!==x.rarity||x.note1&&$<x.note1||x.note2&&T<x.note2)})}function u(p){var E,m,S;const x=(E=p.card)==null?void 0:E.player;if(!x)return"";const f=((m=p.card)==null?void 0:m.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
  ...
  <div style="min-height:100%;background:${w[g.id]};padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
    ...
    <div style="display:flex;flex-direction:column;gap:10px;margin-top:auto;padding-top:8px">
      ...
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${r.id},away_id.eq.${r.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},d=(n||[]).filter(s=>s.status==="finished"),c=(n||[]).filter(s=>s.status==="in_progress");function l(s){const u=s.home_id===r.id;u?s.home_score:s.away_score,u?s.away_score:s.home_score;const y=s.winner_id===r.id,b=s.home_score===s.away_score&&s.status==="finished",g=s.status!=="finished"?"…":b?"N":y?"V":"D",p=s.status!=="finished"||b?"#888":y?"#1A6B3C":"#c0392b";let x=a[s.mode]||s.mode;s.away_id===null&&!x.startsWith("IA")&&(x="IA");const w=s.home_id===r.id?s.away:s.home;let h;s.away_id===null?h=x:w?h=`${w.club_name||w.pseudo} (${w.pseudo})`:h="Adversaire";let E="";s.status==="in_progress"&&Date.now()-new Date(s.created_at).getTime()>3600*1e3&&(E=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const m=new Date(s.created_at),S=m.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+m.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),$=s.status==="finished"?`${s.home_score} - ${s.away_score}`:`${s.home_score||0} - ${s.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.29-1042" style="cursor:pointer">
