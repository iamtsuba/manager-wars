import{s as T,l as Ze,j as Ii,F as oi,h as Mt,i as Zi,k as en,b as tn}from"./formation-links-CEzN0rcz.js";function xi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  <div style="text-align:center;flex-shrink:0;width:38px">
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const m=async(F=!0)=>{f=!0,g&&(T.removeChannel(g),g=null),F&&await T.rpc("cancel_matchmaking",{p_user_id:c.profile.id}).catch(()=>{})};(L=document.getElementById("mm-cancel"))==null||L.addEventListener("click",async()=>{try{await m(!0)}catch{}Oe(e),i("home")});const $=async(F,P,j)=>{if(f)return;f=!0,g&&(T.removeChannel(g),g=null);const C=document.getElementById("mm-status");C&&(C.textContent="Adversaire trouvé !"),await new Promise(D=>setTimeout(D,600)),e.isConnected&&Fi(e,t,F,j,d,l)},{data:o,error:_}=await T.rpc("try_matchmake",{p_user_id:c.profile.id,p_deck_id:n});if(_||!(o!=null&&o.success)){a("Erreur de matchmaking","error"),Oe(e),i("home");return}if(o.matched){$(o.match_id,o.opponent_id,!1);return}const M=document.getElementById("mm-status");M&&(M.textContent="En attente d'un autre joueur..."),g=T.channel("matchmaking-"+c.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${c.profile.id}`},F=>{const P=F.new;P.status==="matched"&&P.match_id&&$(P.match_id,P.matched_with,!0)}).subscribe()}async function xn(e,t,n){const{state:r,navigate:p,toast:s}=t;try{(T.getChannels?T.getChannels():[]).forEach(i=>{const a=i.topic||"";(a.includes("matchmaking")||a.includes("pvp-match")||a.includes("friend-invite"))&&T.removeChannel(i)})}catch{}const{data:d}=await T.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!d){s("Match introuvable","error"),p("home");return}if(d.status==="finished"){s("Ce match est terminé","info"),p("home");return}const l=d.home_id===r.profile.id;Fi(e,t,n,l,[],[])}async function Fi(e,t,n,r,p=[],s=[]){const{state:d,navigate:l,toast:c}=t,i=r?"p1":"p2",a=r?"p2":"p1",f=(p||[]).map(A=>A.id),g=(p||[]).map(A=>({id:A.id,gc_type:A.gc_type,_gcDef:A._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:m}=await T.from("matches").select("*").eq("id",n).single();if(!m){c("Match introuvable","error"),l("home");return}async function $(){const[{data:A},{data:u},{data:x},{data:h}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:m.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:m.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",m.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",m.away_id).single()]),y=k=>({cardId:k.card_id,position:k.position,id:k.id,firstname:k.firstname,name:k.surname_encoded,country_code:k.country_code,club_id:k.club_id,job:k.job,job2:k.job2,note_g:Number(k.note_g)||0,note_d:Number(k.note_d)||0,note_m:Number(k.note_m)||0,note_a:Number(k.note_a)||0,rarity:k.rarity,skin:k.skin,hair:k.hair,hair_length:k.hair_length,clubName:k.club_encoded_name||null,clubLogo:k.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),b=((A==null?void 0:A.starters)||[]).map(k=>y(k)),v=((u==null?void 0:u.starters)||[]).map(k=>y(k)),w=(A==null?void 0:A.formation)||"4-4-2",I=(u==null?void 0:u.formation)||"4-4-2";return{p1Team:ft(b,w),p2Team:ft(v,I),p1Subs:((A==null?void 0:A.subs)||[]).map(k=>y(k)),p2Subs:((u==null?void 0:u.subs)||[]).map(k=>y(k)),p1Formation:w,p2Formation:I,p1Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:r?f:[],gc_p2:r?[]:f,gcCardsFull_p1:r?g:[],gcCardsFull_p2:r?[]:g,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let o=m.game_state&&Object.keys(m.game_state).length?m.game_state:null;if(!o)if(r){o=await $();const{data:A}=await T.from("matches").select("game_state").eq("id",n).single();!(A!=null&&A.game_state)||!Object.keys(A.game_state).length?await T.from("matches").update({game_state:o,turn_user_id:m.home_id}).eq("id",n):o=A.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let A=0;A<30&&!o;A++){await new Promise(x=>setTimeout(x,400));const{data:u}=await T.from("matches").select("game_state").eq("id",n).single();u!=null&&u.game_state&&Object.keys(u.game_state).length&&(o=u.game_state)}if(!o){c("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=g,await T.from("matches").update({game_state:o}).eq("id",n)}let _=!1,M=null,L=!1;const F=new Set,P=new Set;function j(A){var k,E;try{T.removeChannel(C)}catch{}const u=o[i+"Score"]||0,x=o[a+"Score"]||0;let h,y;A.winner_id?(h=A.winner_id===d.profile.id,y=!1):A.forfeit?(h=u>x,y=!1):(y=u===x,h=u>x),(k=document.getElementById("pvp-end-overlay"))==null||k.remove();const b=document.createElement("div");b.id="pvp-end-overlay",b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":h?"🏆":"😞",w=y?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=y?"#fff":h?"#FFD700":"#ff6b6b";b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(E=b.querySelector("#pvp-end-home"))==null||E.addEventListener("click",()=>{b.remove(),Oe(e),l("home")})}const C=T.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},A=>{const u=A.new;try{if(u.status==="finished"||u.forfeit){if(_)return;_=!0,M&&(clearInterval(M),M=null),u.game_state&&(o=u.game_state),j(u);return}if(u.game_state){const x=o;o=u.game_state;const h=o._lastGC;if(h&&h.seq&&!P.has(h.seq)&&(P.add(h.seq),h.by!==i)){xe(h.type,h.by,()=>B());return}const y=x[i+"Score"]||0,b=x[a+"Score"]||0,v=o[i+"Score"]||0,w=o[a+"Score"]||0,I=v>y,k=w>b;if((I||k)&&!F.has(o.round)){F.add(o.round);const E=[...o.log||[]].reverse().find(G=>G.isGoal),S=((E==null?void 0:E.homePlayers)||[]).map(G=>({name:G.name,note:G.note,portrait:G.portrait,job:G.job}));he(S,v,w,I,()=>B());return}B()}}catch(x){console.error("[PvP] crash:",x)}}).subscribe();async function D(A){Object.assign(o,A),o.lastActionAt=new Date().toISOString();const{error:u}=await T.from("matches").update({game_state:o}).eq("id",n);u&&c("Erreur de synchronisation","error");try{B()}catch(x){console.error("[PvP] renderPvpScreen crash:",x)}}async function ne(){if(_)return;_=!0,M&&(clearInterval(M),M=null);const A=r?m.away_id:m.home_id,u=r?"p2":"p1",x=r?"p1":"p2",h={...o,[u+"Score"]:3,[x+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:A,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",n)}catch{}try{T.removeChannel(C)}catch{}setTimeout(()=>{Oe(e),l("home")},800)}const ue={BOOST_STAT:({value:A=1,count:u=1,roles:x=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!x.length||x.includes(w)).flatMap(([w,I])=>I.filter(k=>!k.used).map(k=>({...k,_line:w})));if(!v.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(h);return}te(v,u,`Choisir ${u} joueur(s) à booster (+${A})`,w=>{w.forEach(I=>{const k=(b[I._line]||[]).find(E=>E.cardId===I.cardId);k&&(k.boost=(k.boost||0)+A,h.log.push({text:`⚡ +${A} sur ${k.name}`,type:"info"}))}),h[i+"Team"]=b,y(h)})},DEBUFF_STAT:({value:A=1,count:u=1,roles:x=[],target:h="ai"},y,b)=>{const v=h==="home"?i:a,w=y[v+"Team"],I=h==="home"?"allié":"adverse",k=Object.entries(w).filter(([E])=>!x.length||x.includes(E)).flatMap(([E,S])=>S.filter(G=>!G.used).map(G=>({...G,_line:E})));if(!k.length){y.log.push({text:`🎯 Aucun joueur ${I}`,type:"info"}),b(y);return}te(k,u,`Choisir ${u} joueur(s) ${I}(s) (-${A})`,E=>{E.forEach(S=>{const G=(w[S._line]||[]).find(Q=>Q.cardId===S.cardId);G&&(G.boost=(G.boost||0)-A,y.log.push({text:`🎯 -${A} sur ${G.name}`,type:"info"}))}),y[v+"Team"]=w,b(y)})},GRAY_PLAYER:({count:A=1,roles:u=[],target:x="ai"},h,y)=>{const b=x==="home"?i:a,v=h[b+"Team"],w=x==="home"?"allié":"adverse",I=Object.entries(v).filter(([k])=>!u.length||u.includes(k)).flatMap(([k,E])=>E.filter(S=>!S.used).map(S=>({...S,_line:k})));if(!I.length){h.log.push({text:`❌ Aucun joueur ${w}`,type:"info"}),y(h);return}te(I,A,`Choisir ${A} joueur(s) ${w}(s) à exclure`,k=>{k.forEach(E=>{const S=(v[E._line]||[]).find(G=>G.cardId===E.cardId);S&&(S.used=!0,h.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),h[b+"Team"]=v,y(h)})},REVIVE_PLAYER:({count:A=1,roles:u=[]},x,h)=>{const y=x[i+"Team"],b=Object.entries(y).filter(([v])=>!u.length||u.includes(v)).flatMap(([v,w])=>w.filter(I=>I.used).map(I=>({...I,_line:v})));if(!b.length){x.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(x);return}te(b,A,`Choisir ${A} joueur(s) à ressusciter`,v=>{v.forEach(w=>{const I=(y[w._line]||[]).find(k=>k.cardId===w.cardId);I&&(I.used=!1,x.log.push({text:`💫 ${I.name} ressuscité !`,type:"info"}))}),x[i+"Team"]=y,h(x)})},REMOVE_GOAL:({},A,u)=>{const x=a+"Score";A[x]>0?(A[x]--,A.log.push({text:"🚫 Dernier but annulé !",type:"info"})):A.log.push({text:"🚫 Aucun but à annuler",type:"info"}),u(A)},ADD_GOAL_DRAW:({},A,u)=>{A[i+"Score"]===A[a+"Score"]?(A[i+"Score"]++,A.log.push({text:"🎯 But bonus !",type:"info"})):A.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),u(A)},ADD_SUB:({value:A=1},u,x)=>{u.maxSubs=(u.maxSubs||3)+A,u.log.push({text:`🔄 +${A} remplacement(s)`,type:"info"}),x(u)},CUSTOM:({},A,u)=>u(A)};function te(A,u,x,h){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function v(){var I,k;const w=A.map(E=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E._line]||"#555",G=we(E,E._line)+(E.boost||0),le=b.find(N=>N.cardId===E.cardId)?"#FFD700":"rgba(255,255,255,0.25)",Z=E.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${E.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${le};background:${S};overflow:hidden;cursor:pointer;${Z}">
        ...
        </div>`,(I=y.querySelector("#pp-close"))==null||I.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(E=>{E.addEventListener("click",()=>{const S=E.dataset.cid,G=A.find(le=>le.cardId===S),Q=b.findIndex(le=>le.cardId===S);G&&(Q>-1?b.splice(Q,1):b.length<u&&b.push(G),v())})}),(k=y.querySelector("#pp-confirm"))==null||k.addEventListener("click",()=>{y.remove(),h(b)})}v(),document.body.appendChild(y)}async function z(A,u){const h=(o["gcCardsFull_"+i]||[]).find(w=>w.id===A),y=(h==null?void 0:h._gcDef)||(o.gcDefs||[]).find(w=>{var I;return w.name===u||((I=w.name)==null?void 0:I.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b=[...o["usedGc_"+i]||[],A],v={type:u,by:i,seq:(o._gcAnimSeq||0)+1};P.add(v.seq),xe(u,i,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const I=ue[y.effect_type];if(I){const k={...o};I(y.effect_params||{},k,async E=>{E["usedGc_"+i]=b,E._lastGC=v,E._gcAnimSeq=v.seq,await D(E)});return}}const w={...o};switch(u){case"Remplacement+":w.maxSubs=(w.maxSubs||3)+1,w.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const I=a+"Score";w[I]>0&&(w[I]--,w.log.push({text:"🚫 But annulé",type:"info"}));break}}w["usedGc_"+i]=b,w._lastGC=v,w._gcAnimSeq=v.seq,await D(w)})}function K(A,u){const x="usedCardIds_"+A,h=new Set(o[x]||[]);u.forEach(y=>h.add(y)),o[x]=[...h]}function ie(){for(const A of["p1","p2"]){const u=new Set(o["usedCardIds_"+A]||[]),x=o[A+"Team"];if(x)for(const h of["GK","DEF","MIL","ATT"])(x[h]||[]).forEach(y=>{y.used=u.has(y.cardId)})}}function B(){var Fe,Qe,mt,xt,yt,ht;if(o.phase==="reveal")return X();if(o.phase==="midfield")return de();if(o.phase==="finished")return He();const A=o[i+"Team"],u=o[a+"Team"];ie();const x=o[i+"Score"],h=o[a+"Score"],y=o[i+"Name"],b=o[a+"Name"],v=o.phase===i+"-attack",w=o.phase===i+"-defense",I=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],k=I.map(W=>W.cardId),E=window.innerWidth>=700,S=o[i+"Subs"]||[],G=o["usedSubIds_"+i]||[],Q=S.filter(W=>!G.includes(W.cardId)),le=o["gcCardsFull_"+i]||[],Z=o["usedGc_"+i]||[],N=le.filter(W=>!Z.includes(W.id)),U=o.boostOwner===i&&!o.boostUsed,ee=!["GK","DEF","MIL","ATT"].some(W=>(u[W]||[]).some(q=>!q.used)),se=[...A.MIL||[],...A.ATT||[]].filter(W=>!W.used),ce=v&&ee&&se.length===0?[...A.GK||[],...A.DEF||[]].filter(W=>!W.used).map(W=>W.cardId):[];function pe(W,q,oe){var jt,wt;const ae=W._gcDef,me={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ae==null?void 0:ae.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ye={purple:"#b06ce0",light_blue:"#00d4ef"}[ae==null?void 0:ae.color]||"#b06ce0",We=(ae==null?void 0:ae.name)||W.gc_type,Je=(ae==null?void 0:ae.effect)||((jt=Ge[W.gc_type])==null?void 0:jt.desc)||"",et=ae!=null&&ae.image_url?`/manager-wars/icons/${ae.image_url}`:null,St=((wt=Ge[W.gc_type])==null?void 0:wt.icon)||"⚡",Ct=Math.round(oe*.22),bt=Math.round(oe*.22),lt=oe-Ct-bt,vt=We.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${W.id}" data-gc-type="${W.gc_type}"
    ...
    </div>`,(y=document.getElementById("pvp-home"))==null||y.addEventListener("click",()=>{try{T.removeChannel(C)}catch{}Oe(e),l("home")})}B()}const yn="2026.06.28-1100";async function bi(e,{state:t,navigate:n,toast:r}){var s,d;const p=t.profile;p&&(e.innerHTML=`
  <div class="page">
    <div class="page-body">
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const c=()=>{l||(l=!0,s.remove(),setTimeout(()=>p(),50))};s.addEventListener("click",c),setTimeout(c,3500)}async function Tt(e,t,n){var a,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:r}=n,p=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,d=p?"victoire":s?"nul":"defaite",l=pn(t.mode,d);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:p?r.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(r.profile.credits||0)+l,matches_played:(r.profile.matches_played||0)+1};p?c.wins=(r.profile.wins||0)+1:s?c.draws=(r.profile.draws||0)+1:c.losses=(r.profile.losses||0)+1,await T.from("users").update(c).eq("id",r.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      </div>`,(B=document.getElementById("lobby-cancel"))==null||B.addEventListener("click",async()=>{$=!0,o&&(T.removeChannel(o),o=null),K&&await T.from("friend_match_invites").update({status:"declined"}).eq("id",K),Oe(e),f("home")})},M=async(te,z)=>{$=!0,o&&(T.removeChannel(o),o=null),await new Promise(K=>setTimeout(K,600)),e.isConnected&&xo(e,t,te,z,d,l)},{data:L}=await T.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${m},invitee_id.eq.${c}),and(inviter_id.eq.${c},invitee_id.eq.${m})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let F,P;if(L&&L.inviter_id===c)P=!1,F=L.id,await T.from("friend_match_invites").update({invitee_deck_id:n,invitee_ready:!0,status:"accepted"}).eq("id",F);else{P=!0;const{data:te,error:z}=await T.from("friend_match_invites").insert({inviter_id:m,invitee_id:c,friend_id:c,inviter_deck_id:n,inviter_ready:!0,status:"pending"}).select().single();if(z||!te){g("Erreur création invitation","error"),Oe(e),f("home");return}F=te.id}if(_(!0,!P,F),!P){const te={home_id:c,away_id:m,home_deck_id:L.inviter_deck_id,away_deck_id:n,status:"active",mode:"friend"},z=await T.from("matches").insert(te).select().single(),K=z.data;if(!K){g("Erreur création match: "+(((ue=z.error)==null?void 0:ue.message)||""),"error"),Oe(e),f("home");return}await T.from("friend_match_invites").update({match_id:K.id,status:"matched"}).eq("id",F),M(K.id,!1);return}let j=!1;const C=te=>{$||j||(te.status==="matched"&&te.match_id?(j=!0,clearInterval(D),clearInterval(ne),M(te.match_id,!0)):te.status==="declined"?(clearInterval(D),clearInterval(ne),g(`${i} a décliné l'invitation`,"warning"),Oe(e),f("home")):te.invitee_ready&&_(!0,!0,F))},D=setInterval(()=>{if($){clearInterval(D);return}T.from("matchmaking_queue").delete().eq("user_id",m).then(()=>{},()=>{})},3e3),ne=setInterval(async()=>{if($||j){clearInterval(ne);return}const{data:te}=await T.from("friend_match_invites").select("*").eq("id",F).maybeSingle();te&&C(te)},1200);o=T.channel("friend-invite-"+F).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${F}`},te=>C(te.new)).subscribe()}async function xo(e,t,n,r,p=[],s=[]){const{state:d,navigate:l,toast:c}=t,i=r?"p1":"p2",a=r?"p2":"p1",f=(p||[]).map(u=>u.id),g=(p||[]).map(u=>({id:u.id,gc_type:u.gc_type,_gcDef:u._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:m}=await T.from("matches").select("*").eq("id",n).single();if(!m){c("Match introuvable","error"),l("home");return}async function $(){const[{data:u},{data:x},{data:h},{data:y}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:m.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:m.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",m.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",m.away_id).single()]),b=E=>({cardId:E.card_id,position:E.position,id:E.id,firstname:E.firstname,name:E.surname_encoded,country_code:E.country_code,club_id:E.club_id,job:E.job,job2:E.job2,note_g:Number(E.note_g)||0,note_d:Number(E.note_d)||0,note_m:Number(E.note_m)||0,note_a:Number(E.note_a)||0,rarity:E.rarity,skin:E.skin,hair:E.hair,hair_length:E.hair_length,clubName:E.club_encoded_name||null,clubLogo:E.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),v=((u==null?void 0:u.starters)||[]).map(E=>b(E)),w=((x==null?void 0:x.starters)||[]).map(E=>b(E)),I=(u==null?void 0:u.formation)||"4-4-2",k=(x==null?void 0:x.formation)||"4-4-2";return{p1Team:ft(v,I),p2Team:ft(w,k),p1Subs:((u==null?void 0:u.subs)||[]).map(E=>b(E)),p2Subs:((x==null?void 0:x.subs)||[]).map(E=>b(E)),p1Formation:I,p2Formation:k,p1Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 1",p2Name:(y==null?void 0:y.club_name)||(y==null?void 0:y.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:r?f:[],gc_p2:r?[]:f,gcCardsFull_p1:r?g:[],gcCardsFull_p2:r?[]:g,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let o=m.game_state&&Object.keys(m.game_state).length?m.game_state:null;if(!o)if(r){o=await $();const{data:u}=await T.from("matches").select("game_state").eq("id",n).single();!(u!=null&&u.game_state)||!Object.keys(u.game_state).length?await T.from("matches").update({game_state:o,turn_user_id:m.home_id}).eq("id",n):o=u.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let u=0;u<60&&!o;u++){await new Promise(h=>setTimeout(h,400));const{data:x}=await T.from("matches").select("game_state").eq("id",n).single();x!=null&&x.game_state&&Object.keys(x.game_state).length&&(o=x.game_state)}if(!o){c("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=g,await T.from("matches").update({game_state:o}).eq("id",n)}let _=!1,M=!1,L=null,F=!1;const P=new Set,j=new Set;function C(u){var E,S;try{T.removeChannel(D)}catch{}const x=o[i+"Score"]||0,h=o[a+"Score"]||0;if(r&&!M){M=!0;const G=o.p1Score||0,Q=o.p2Score||0,le=(o.usedGc_p1||[]).length,Z=(o.usedGc_p2||[]).length;cn({player1Id:m.home_id,player2Id:m.away_id,score1:G,score2:Q,gc1:le,gc2:Z}).catch(N=>console.warn("[FriendMatch] updateStats:",N))}let y,b;u.winner_id?(y=u.winner_id===d.profile.id,b=!1):u.forfeit?(y=x>h,b=!1):(b=x===h,y=x>h),(E=document.getElementById("pvp-end-overlay"))==null||E.remove();const v=document.createElement("div");v.id="pvp-end-overlay",v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const w=b?"🤝":y?"🏆":"😞",I=b?"MATCH NUL":y?"VICTOIRE !":"DÉFAITE",k=b?"#fff":y?"#FFD700":"#ff6b6b";v.innerHTML=`
