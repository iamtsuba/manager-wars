import{s as E,F as bi,h as Pt,j as Wi,l as at,i as So,k as Lo,b as Io}from"./formation-links-DJC25wD7.js";const Mo="/manager-wars/";function Ii(e,{navigate:t,toast:i}){let s="login";const c=()=>{var a,l,p,o,n,g;const d=s==="login";e.innerHTML=`
  ...
  </div>`}function Fi(e){const t=e.job||"ATT",i=vt(e,t),s=Ei[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),o=(l||[]).filter(W=>W.card_type==="player"&&W.player),n=(l||[]).filter(W=>W.card_type==="game_changer"),g=(l||[]).filter(W=>W.card_type==="formation"),v=(l||[]).filter(W=>W.card_type==="stadium"),{data:y}=await E.from("gc_definitions").select("name,gc_type,color,effect,image_url"),z={};(y||[]).forEach(W=>{z[W.name]=W});const{data:r}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(r||[]).forEach(W=>{u[W.id]=W}),v.forEach(W=>{W.stadium_def&&(u[W.stadium_id]=W.stadium_def)});const M=Object.keys(bi),L=Object.keys(Ke),N={};o.forEach(W=>{const ie=W.player.id;N[ie]=(N[ie]||0)+1}),new Set(Object.keys(N).map(W=>String(W)));const Y=new Set(g.map(W=>W.formation)),j=new Set(n.map(W=>W.gc_type));let F="player",B="Tous",Q="",de=!1;function se(){return[...o].sort((W,ie)=>{const ge=Vt.indexOf(W.player.job),K=Vt.indexOf(ie.player.job);return ge!==K?ge-K:(W.player.surname_encoded||"").localeCompare(ie.player.surname_encoded||"")})}function P(){return[...p||[]].sort((W,ie)=>{const ge=Vt.indexOf(W.job),K=Vt.indexOf(ie.job);return ge!==K?ge-K:(W.surname_encoded||"").localeCompare(ie.surname_encoded||"")})}function J(){return se().filter(W=>{const ie=W.player,ge=B==="Tous"||ie.job===B,K=!Q||`${ie.firstname} ${ie.surname_encoded}`.toLowerCase().includes(Q);return ge&&K})}function H(){return P().filter(W=>{const ie=B==="Tous"||W.job===B,ge=!Q||`${W.firstname} ${W.surname_encoded}`.toLowerCase().includes(Q);return ie&&ge})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
          ...
          ${Wo.map(ie=>`
            <button class="filter-btn" data-job="${ie}"
              style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
                border:1.5px solid ${ie===B?"var(--green)":"var(--gray-200)"};
                background:${ie===B?"var(--green)":"#fff"};
                color:${ie===B?"#fff":"var(--gray-600)"}">
              ${ie}
            </button>`).join("")}
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",ie=>{Q=ie.target.value.toLowerCase(),oe()}),e.querySelectorAll(".filter-btn").forEach(ie=>{ie.addEventListener("click",()=>{B=ie.dataset.job,G(),oe()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{de=!de,G(),oe()})):(W.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{de=!de,G(),oe()})))}function oe(){const W=document.getElementById("col-grid");W&&(F==="player"?ke(W):F==="formation"?Te(W):F==="stadium"?xe(W):Le(W))}function pe(W,ie,ge,K,ne){const U=document.getElementById("col-grid"),re=document.getElementById("col-big");if(!U||!re)return;var be=0;function Ae(){const ze=window.innerWidth>=768,Me=document.getElementById("col-big"),De=document.getElementById("col-grid");ze&&Me&&(Me.style.minHeight="420px",Me.style.flex="1 1 auto"),ze&&De&&(De.style.height=Math.round(310*.76+16)+"px",De.style.flexShrink="0",De.style.overflowX="auto",De.style.overflowY="hidden",De.style.alignItems="center",De.style.padding="8px 16px"),re.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ie(W[be])+"</div>";var I=re.querySelector("[data-card-id],[data-form-id],[data-gc-id]");I&&I.addEventListener("click",function(){K(W[be])}),requestAnimationFrame(function(){var C=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!C||!re)){var w=re.clientHeight-8,k=re.clientWidth-24,f=C.offsetHeight,m=C.offsetWidth;if(f>0&&m>0&&w>40){var x=ze?2.2:1,b=Math.min(w/f,k/m,x);C.style.transform="scale("+b.toFixed(3)+")",C.style.transformOrigin="top center"}}}),U.innerHTML=W.map(function(C,w){var k=w===be,f="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(k?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+w+'" style="'+f+'">'+ge(C,k)+"</div>"}).join(""),U.querySelectorAll(".col-mini-item").forEach(function(C){C.addEventListener("click",function(){be=Number(C.dataset.idx),Ae(),C.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Ae()}function ye(W){var ie=window.innerWidth>=768?.76:.54,ge;if(!W||W._fake){var K=W?W.player:null;if(!K)return"";ge=Fi(K)}else ge=si(W,"");return'<div style="display:inline-block;zoom:'+ie+';pointer-events:none;line-height:0">'+ge+"</div>"}function Se(W,ie,ge){ie=ie||100,ge=ge||140;var K=Pt[W]||{},ne={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},U=Math.max(3,Math.round(ie*.06)),re=Object.entries(K).map(function(Ae){var ze=Ae[0],Me=Ae[1],De=ze.replace(/\d+$/,""),I=ne[De]||"#888",C=Math.round(Me.x*ie),w=Math.round(Me.y*ge);return'<circle cx="'+C+'" cy="'+w+'" r="'+U+'" fill="'+I+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),be=Math.max(1,Math.round(ie/50));return'<svg viewBox="0 0 '+ie+" "+ge+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ie+'" height="'+ge+'" fill="#1A6B3C"/><rect x="'+Math.round(ie*.2)+'" y="'+Math.round(ge*.02)+'" width="'+Math.round(ie*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+be+'"/><line x1="0" y1="'+Math.round(ge*.5)+'" x2="'+ie+'" y2="'+Math.round(ge*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+be+'"/><ellipse cx="'+Math.round(ie*.5)+'" cy="'+Math.round(ge*.5)+'" rx="'+Math.round(ie*.18)+'" ry="'+Math.round(ge*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+be+'"/><rect x="'+Math.round(ie*.2)+'" y="'+Math.round(ge*.82)+'" width="'+Math.round(ie*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+be+'"/>'+re+"</svg>"}function he(W,ie,ge){var K=ge>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+ge+"</div>":"",ne=ie?'data-form-id="'+ie.id+'"':"",U=W.length>7?14:W.length>5?16:19,re=!!ie;return"<div "+ne+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(re?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(re?"":"filter:grayscale(1);opacity:0.5")+'">'+K+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(re?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+U+"px;font-weight:900;color:"+(re?"#1A6B3C":"#aaa")+';line-height:1">'+W+'</div></div><div style="flex:1;overflow:hidden;background:'+(re?"#1A6B3C":"#ccc")+'">'+Se(W,140,220)+"</div></div>"}function ve(W,ie){var ge=window.innerWidth>=768?.76:.54,K=140,ne=305,U=Math.round(ne*.22),re=ne-U,be=W.length>7?10:13,Ae=Se(W,K,re),ze=ie?"1.5px solid #2a7a40":"1px solid #ddd",Me=ie?"":"filter:grayscale(1);opacity:0.45;",De=ie?"#1A6B3C":"#bbb",I="#fff";return'<div style="display:inline-block;zoom:'+ge+';line-height:0;pointer-events:none"><div style="width:'+K+"px;height:"+ne+"px;border-radius:6px;border:"+ze+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Me+'"><div style="height:'+U+"px;background:"+De+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+be+"px;font-weight:900;color:"+I+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(K-4)+'px">'+W+'</span></div><div style="height:'+re+'px;overflow:hidden;flex-shrink:0">'+Ae+"</div></div></div>"}function ke(W){if(de){const ie=H();if(!ie.length){W.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const ge=ie.map(K=>o.find(ne=>ne.player.id===K.id)||{_fake:!0,player:K,id:"fake-"+K.id});pe(ge,K=>K._fake?Fi(K.player):si(K,""),K=>K._fake?ye({player:K.player,id:"x",_fake:!0}):ye(K),K=>{K._fake||Di(K,o,N,t)})}else{const ie=J();if(!ie.length){W.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const ge={};ie.forEach(ne=>{const U=ne.player.id;ge[U]||(ge[U]=[]),ge[U].push(ne)});const K=Object.values(ge).map(ne=>Xo(ne));pe(K,ne=>{const U=N[ne.player.id]||1,re=U>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${U}</div>`:"",Ae=o.filter(ze=>ze.player.id===ne.player.id&&ze.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return si(ne,re+Ae)},ne=>ye(ne),ne=>Di(ne,o,N,t))}}function Te(W){const ie=de?M:[...Y];if(!ie.length){W.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const ge=ie.map(K=>({formation:K,card:g.find(ne=>ne.formation===K)||null,owned:Y.has(K)}));pe(ge,({formation:K,card:ne,owned:U})=>he(K,U?ne:null,U?g.filter(re=>re.formation===K).length:0),({formation:K,owned:ne})=>ve(K,ne),({card:K,owned:ne})=>{ne&&K&&en(K,g,t,d)})}function Le(W){const ie=Object.keys(z),ge=de?ie.length?ie:L:[...j];if(!ge.length){W.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const K=ge.map(ne=>({type:ne,gc:Ke[ne]||{icon:"⚡",desc:""},def:z[ne]||null,owned:j.has(ne),card:n.find(U=>U.gc_type===ne)||null}));pe(K,({type:ne,gc:U,def:re,owned:be,card:Ae})=>{var x;const ze=be?n.filter(b=>b.gc_type===ne).length:0,Me=ze>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ze}</div>`:"",De=(re==null?void 0:re.gc_type)==="ultra_game_changer",I={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},C={purple:"#b06ce0",light_blue:"#00d4ef"},w=I[re==null?void 0:re.color]||I.purple,k=C[re==null?void 0:re.color]||C.purple,f=(re==null?void 0:re.effect)||U.desc||"",m=re!=null&&re.image_url?`/manager-wars/icons/${re.image_url}`:((x=re==null?void 0:re.club)==null?void 0:x.logo_url)||(re!=null&&re.country_code?`https://flagcdn.com/w80/${re.country_code.toLowerCase()}.png`:null);return be&&Ae?`<div data-gc-id="${Ae.id}" data-gc-type="${ne}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${k};background:${w};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${k}66;cursor:pointer">
          ${Me}
          <div style="padding:10px 12px;background:rgba(255,255,255,0.14);text-align:center">
            <div style="font-size:${ne.length>14?10:13}px;font-weight:900;color:#fff;letter-spacing:.5px;text-transform:uppercase">${ne}</div>
          ...
          <div style="padding:10px 12px;background:rgba(0,0,0,0.05);text-align:center"><div style="font-size:13px;font-weight:900;color:#888;text-transform:uppercase">${ne}</div></div>
        ...
        </div>`},({type:ne,gc:U,def:re,owned:be})=>{const Ae=window.innerWidth>=768?.76:.54,ze={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Me={purple:"#9b59b6",light_blue:"#00bcd4"},De=ze[re==null?void 0:re.color]||ze.purple,I=Me[re==null?void 0:re.color]||Me.purple,C=re!=null&&re.image_url?`/manager-wars/icons/${re.image_url}`:null;return be?`<div style="display:inline-block;zoom:${Ae};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${De};border:1px solid ${I};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${ne}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${C?`<img src="${C}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${U.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((re==null?void 0:re.effect)||U.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${Ae};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${U.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${ne}</span></div></div>`},({type:ne,owned:U,def:re})=>{U&&Qo(ne,re,d)})}function xe(W){const ie="#E87722",ge="/manager-wars/";if(!v.length){W.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const K={};v.forEach(U=>{const re=U.stadium_id||"?";(K[re]=K[re]||[]).push(U)});const ne=Object.entries(K).map(([U,re])=>({sid:U,def:u[U]||null,count:re.length,card:re[0]}));pe(ne,({def:U,count:re})=>{var I,C;const be=(U==null?void 0:U.name)||"?",Ae=((I=U==null?void 0:U.club)==null?void 0:I.encoded_name)||(U==null?void 0:U.country_code)||"—",ze=U!=null&&U.image_url?`${ge}icons/${U.image_url}`:((C=U==null?void 0:U.club)==null?void 0:C.logo_url)||(U!=null&&U.country_code?`https://flagcdn.com/w80/${U.country_code.toLowerCase()}.png`:null),Me=ze?`<img src="${ze}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',De=re>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${re}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${ie},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${ie}66">
          ${De}
          <div style="padding:8px 10px;background:rgba(0,0,0,0.25);text-align:center">
            ...
            <div style="font-size:12px;font-weight:900;color:#fff;margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${be}</div>
          </div>
          ...
          <div style="padding:8px 12px;background:rgba(0,0,0,0.3);text-align:center">
            <div style="font-size:11px;color:rgba(255,255,255,0.85);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${Ae}</div>
            <div style="font-size:13px;font-weight:900;color:#FFD700;margin-top:2px">+10 ⭐ joueurs alliés</div>
          </div>
        </div>`},({def:U,count:re})=>{var I,C;const be=window.innerWidth>=768?.76:.54,Ae=(U==null?void 0:U.name)||"?",ze=((I=U==null?void 0:U.club)==null?void 0:I.encoded_name)||(U==null?void 0:U.country_code)||"—",Me=U!=null&&U.image_url?`${ge}icons/${U.image_url}`:((C=U==null?void 0:U.club)==null?void 0:C.logo_url)||(U!=null&&U.country_code?`https://flagcdn.com/w80/${U.country_code.toLowerCase()}.png`:null),De=Me?`<img src="${Me}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${be};line-height:0;pointer-events:none">
          <div style="width:140px;height:310px;border-radius:8px;background:linear-gradient(160deg,${ie},#c45a00);border:1px solid #c45a00;display:flex;flex-direction:column;overflow:hidden">
            <div style="height:48px;background:rgba(0,0,0,0.25);display:flex;align-items:center;justify-content:center;flex-direction:column;padding:4px 6px">
              ...
              <div style="font-size:12px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px;margin-top:2px">${Ae}</div>
            </div>
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(W=>{W.addEventListener("click",()=>{F=W.dataset.tab,B="Tous",Q="",de=!1,e.querySelectorAll(".col-tab-btn").forEach(ie=>{const ge=ie.dataset.tab===F;ie.style.borderBottomColor=ge?"var(--green)":"transparent",ie.style.color=ge?"var(--green)":"var(--gray-600)"}),G(),oe()})}),G(),oe()}function Qo(e,t,i){const s=Ke[e]||{icon:"⚡",desc:"Effet spécial."},c=(t==null?void 0:t.gc_type)==="ultra_game_changer",d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},l=d[t==null?void 0:t.color]||d.purple,p=a[t==null?void 0:t.color]||a.purple,o=(t==null?void 0:t.name)||e,n=(t==null?void 0:t.effect)||s.desc,g=t!=null&&t.image_url?`/manager-wars/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Kt=1e3;function en(e,t,i,s){var z,r,u;const{state:c,toast:d,closeModal:a,navigate:l,refreshProfile:p}=i,o=e.formation,n={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function g(){const M=Pt[o]||{},L=bi[o]||[],N=290,Y=360,j=20;function F(Q){const de=M[Q];return de?{x:de.x*N,y:de.y*Y}:null}let B=`<svg width="${N}" height="${Y}" viewBox="0 0 ${N} ${Y}" xmlns="http://www.w3.org/2000/svg">`;for(const[Q,de]of L){const se=F(Q),P=F(de);!se||!P||(B+=`<line x1="${se.x}" y1="${se.y}" x2="${P.x}" y2="${P.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const Q of Object.keys(M)){const de=F(Q);if(!de)continue;const se=Q.replace(/\d+/,""),P=n[se]||"#555";B+=`<circle cx="${de.x}" cy="${de.y}" r="${j}" fill="${P}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,B+=`<text x="${de.x}" y="${de.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${se}</text>`}return B+="</svg>",B}const v=t.filter(M=>M.formation===o);v.length;const y=!e.is_for_sale;s(`Formation ${o}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;background:#f9f9f9;border-radius:8px;padding:8px 12px;gap:8px">
      ...
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:13px;font-weight:700;color:${K.source==="booster"?"var(--gray-600)":"var(--yellow)"}">${U}</div>
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${g.map((K,ne)=>{const U=pe[K.id]||[],re=K.is_for_sale,be=U.length?U[U.length-1]:null,ze=(n.rarity==="pepite"||n.rarity==="papyte")&&K.current_note!=null?` (☆${K.current_note})`:"";return`
            <div data-card-id="${K.id}" data-card-idx="${ne}" class="exemplaire-row"
              style="border:2px solid #eee;border-radius:10px;padding:10px;cursor:pointer;transition:border-color .15s;${re?"opacity:0.6":""}">
              <div style="display:flex;align-items:center;gap:10px">
                <input type="checkbox" class="expl-check" data-id="${K.id}" ${re?"disabled":""} style="width:18px;height:18px;cursor:pointer;accent-color:#1A6B3C;flex-shrink:0">
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${ne+1}${ze}${re?" 🏷️ En vente":""}</div>
                  ${be?`<div style="font-size:11px;color:#888;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                    ${be.club_name} · ${be.source==="booster"?"Booster":be.price?be.price.toLocaleString("fr")+" cr.":"—"}
                  </div>`:""}
                </div>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${J}${n.job2&&H>0?` / ${G}`:""}`:`Note actuelle : ${J}${n.job2&&H>0?` / ${G}`:""}`}
            </div>
          </div>
        ...
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="position:relative;height:80px;background:#f2e8d2;display:flex;flex-direction:column;align-items:center">
            ...
            <svg width="32" height="31" viewBox="0 0 32 31" style="position:absolute;top:50px;z-index:2;display:block">
              ...
              <text x="16" y="20" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${j}</text>
            </svg>`:""}
          </div>
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${(Te=n.clubs)!=null&&Te.logo_url?`<img src="${n.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((Le=n.clubs)==null?void 0:Le.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        <div>
          ...
          <div style="font-weight:700;color:${Q}">${n.rarity.toUpperCase()}</div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",n.note_g],["DEF",n.note_d],["MIL",n.note_m],["ATT",n.note_a]].map(([K,ne])=>{const U=qt[K],re=Number(ne)||0;return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px">
                <svg width="38" height="37" viewBox="0 0 38 37" style="display:block">
                  ...
                  <text x="19" y="23" text-anchor="middle" font-size="13" font-weight="900" fill="white" font-family="Arial Black,Arial">${re}</text>
                </svg>
    ...
    ${Se}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let he=new Set;const ve=()=>{const K=he.size,ne=document.getElementById("sell-action-panel");ne&&(ne.style.display=K>0?"block":"none",document.getElementById("sell-selected-count").textContent=K,document.getElementById("sell-direct-total").textContent=(K*u).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(K=>{K.addEventListener("change",()=>{const ne=K.dataset.id;K.checked?he.add(ne):he.delete(ne);const U=K.closest(".exemplaire-row");U&&(U.style.borderColor=K.checked?"#1A6B3C":"#eee"),ve()})}),document.querySelectorAll(".exemplaire-row").forEach(K=>{K.addEventListener("click",ne=>{if(ne.target.closest("button")||ne.target.tagName==="INPUT")return;const U=K.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(K=>{K.addEventListener("click",ne=>{ne.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${K.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(W=document.getElementById("evolve-btn"))==null||W.addEventListener("click",async()=>{const K=he.size===1?playerCards.find(De=>he.has(De.id)):e;if(!K)return;const ne=K.evolution_bonus||0,U=K.player,re=(U.rarity==="pepite"||U.rarity==="papyte")&&K.current_note!=null?K.current_note:vt(U,U.job),be=U.job2?vt(U,U.job2):0,Ae=ne+1,{error:ze}=await E.from("cards").update({evolution_bonus:Ae}).eq("id",K.id);if(ze){d("Erreur évolution : "+ze.message,"error");return}const Me=[`⬆️ ${U.firstname} ${U.surname_encoded} évolué !`,`Note principale : ${re} → ${re+1}`];be>0&&Me.push(`Note secondaire : ${be+ne} → ${be+Ae}`),d(Me.join(" · "),"success",4e3),l(),p("collection")}),(ie=document.getElementById("market-sell-btn"))==null||ie.addEventListener("click",async()=>{var Ae;const K=[...he];if(!K.length){d("Sélectionne au moins un exemplaire","warning");return}const ne=parseInt((Ae=document.getElementById("sell-market-price"))==null?void 0:Ae.value);if(!ne||ne<1){d("Prix invalide","error");return}const{error:U}=await E.from("cards").update({is_for_sale:!0,sale_price:ne}).in("id",K);if(U){d(U.message,"error");return}const re=K.map(ze=>({seller_id:c.profile.id,card_id:ze,price:ne,status:"active"})),{error:be}=await E.from("market_listings").insert(re);be&&console.warn("[Market] insert listings:",be.message),d(`${K.length} carte${K.length>1?"s":""} mise${K.length>1?"s":""} en vente à ${ne.toLocaleString("fr")} cr. chacune !`,"success"),l(),p("collection")}),(ge=document.getElementById("cancel-sell-btn"))==null||ge.addEventListener("click",async()=>{await E.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await E.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),l(),p("collection")})}const Xt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},wt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ti(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function lo(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function co(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function tn(e,t=44,i=58){var y;const s=e?ti(e):null,c=e?co(e):null,d=lo(e==null?void 0:e.country_code),a=(e==null?void 0:e.job)||"MIL",l=wt[a]||"#555",p={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",o=Number(a==="GK"?e==null?void 0:e.note_g:a==="DEF"?e==null?void 0:e.note_d:a==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,n=Math.round(i*.19),g=Math.round(i*.25),v=i-n-g;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${p};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,on(e,t,c,i),document.getElementById("builder-back").addEventListener("click",()=>s("decks")),document.getElementById("formation-select").addEventListener("change",n=>{t.formation=n.target.value;const g=Pi(t.formation),v={};g.forEach(y=>{t.slots[y]&&(v[y]=t.slots[y])}),t.slots=v,Lt(e,t,i)}),(p=document.getElementById("stadium-select"))==null||p.addEventListener("change",n=>{t.stadiumCardId=n.target.value||null}),document.getElementById("save-deck").addEventListener("click",()=>an(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(n=>{n.addEventListener("click",()=>{t.subs=t.subs.filter(g=>g!==n.dataset.removeSub),Lt(e,t,i)})}),(o=document.getElementById("add-sub-btn"))==null||o.addEventListener("click",()=>{rn(t,e,i)})}function on(e,t,i,s){var N,Y;const c=e.querySelector("#deck-field");if(!c)return;const d=(N=t.stadiumCards)==null?void 0:N.find(j=>j.id===t.stadiumCardId),a=d&&((Y=t.stadDefMap)==null?void 0:Y[d.stadium_id])||null,l=Pt[t.formation]||{},p=Wi(t.formation)||[],o={};for(const j of i){const F=t.slots[j],B=F?t.playerCards.find(Q=>Q.id===F):null;o[j]=B?B.player:null}const n=300,g=300,v=48,y=64,z=13,r=16,u=38;function M(j){const F=l[j];return F?{x:F.x*n,y:F.y*g}:null}let L="";for(const[j,F]of p){const B=M(j),Q=M(F);if(!B||!Q)continue;const de=o[j]?{...o[j],club_id:o[j].club_id,country_code:o[j].country_code,rarity:o[j].rarity}:null,se=o[F]?{...o[F],club_id:o[F].club_id,country_code:o[F].country_code,rarity:o[F].rarity}:null,P=at(de,se);P==="#ff3333"||P==="#cc2222"?L+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${Q.x.toFixed(1)}" y2="${Q.y.toFixed(1)}" stroke="${P}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(L+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${Q.x.toFixed(1)}" y2="${Q.y.toFixed(1)}" stroke="${P}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,L+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${Q.x.toFixed(1)}" y2="${Q.y.toFixed(1)}" stroke="${P}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const j of i){const F=M(j);if(!F)continue;const B=o[j],Q=j.replace(/\d+/,""),de=wt[Q]||"#555",se=(F.x-v/2).toFixed(1),P=(F.y-y/2).toFixed(1),J={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[B==null?void 0:B.rarity]||"#aaa";if(B){const H=ti(B),G=co(B),oe=lo(B.country_code),pe=Number(Q==="GK"?B.note_g:Q==="DEF"?B.note_d:Q==="MIL"?B.note_m:B.note_a)||0,ye=a&&(a.club_id&&String(B.club_id)===String(a.club_id)||a.country_code&&B.country_code===a.country_code),Se=ye?pe+10:pe,he=y-z-r;L+=`<defs><clipPath id="dcp-${j}"><rect x="${se}" y="${(F.y-y/2+z).toFixed(1)}" width="${v}" height="${he}"/></clipPath></defs>`,L+=`<rect x="${se}" y="${P}" width="${v}" height="${y}" rx="5" fill="${de}"/>`,H&&(L+=`<image href="${H}" x="${se}" y="${(F.y-y/2+z).toFixed(1)}" width="${v}" height="${he}" clip-path="url(#dcp-${j})" preserveAspectRatio="xMidYMin slice"/>`),L+=`<rect x="${se}" y="${P}" width="${v}" height="${z}" fill="rgba(255,255,255,0.93)"/>`,L+=`<text x="${F.x.toFixed(1)}" y="${(F.y-y/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(B.surname_encoded||"").slice(0,9)}</text>`;const ve=(F.y+y/2-r).toFixed(1);L+=`<rect x="${se}" y="${ve}" width="${v}" height="${r}" fill="rgba(255,255,255,0.93)"/>`,oe&&(L+=`<image href="${oe}" x="${(F.x-21).toFixed(1)}" y="${(F.y+y/2-r+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),L+=`<text x="${F.x.toFixed(1)}" y="${(F.y+y/2-r/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Se}</text>`,G&&(L+=`<image href="${G}" x="${(F.x+v/2-14).toFixed(1)}" y="${(F.y+y/2-r+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),L+=`<rect x="${se}" y="${P}" width="${v}" height="${y}" rx="5" fill="none" stroke="${ye?"#E87722":J}" stroke-width="${ye?"2.5":"2"}"/>`,ye&&(L+=`<rect x="${(F.x+v/2-13).toFixed(1)}" y="${P}" width="13" height="9" rx="3" fill="#E87722"/>`,L+=`<text x="${(F.x+v/2-6.5).toFixed(1)}" y="${(F.y-y/2+4.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="900" fill="#fff" font-family="Arial">+10</text>`)}else L+=`<rect x="${se}" y="${P}" width="${v}" height="${y}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,L+=`<text x="${F.x.toFixed(1)}" y="${F.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,L+=`<text x="${F.x.toFixed(1)}" y="${(F.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${Q}</text>`;L+=`<rect x="${se}" y="${P}" width="${v}" height="${y}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${j}" style="cursor:pointer"/>`}c.innerHTML=`<svg viewBox="${-u} ${-u} ${n+u*2} ${g+u*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${L}</svg>`,c.querySelectorAll(".deck-slot-hit").forEach(j=>{j.addEventListener("click",()=>nn(j.dataset.pos,t,e,s))})}function nn(e,t,i,s){var v,y,z;const{openModal:c,closeModal:d}=s,a=e.replace(/\d+/,""),l=t.slots[e],p=l?t.playerCards.find(r=>r.id===l):null;(v=p==null?void 0:p.player)==null||v.id;const o=new Set;Object.entries(t.slots).forEach(([r,u])=>{var L;if(r===e||!u)return;const M=t.playerCards.find(N=>N.id===u);(L=M==null?void 0:M.player)!=null&&L.id&&o.add(M.player.id)}),t.subs.forEach(r=>{var M;const u=t.playerCards.find(L=>L.id===r);(M=u==null?void 0:u.player)!=null&&M.id&&o.add(u.player.id)});const n=new Set,g=t.playerCards.filter(r=>{const u=r.player;return!(u.job===a||u.job2===a)||o.has(u.id)||n.has(u.id)?!1:(n.add(u.id),!0)});g.sort((r,u)=>{const M=a==="GK"?r.player.note_g:a==="DEF"?r.player.note_d:a==="MIL"?r.player.note_m:r.player.note_a;return(a==="GK"?u.player.note_g:a==="DEF"?u.player.note_d:a==="MIL"?u.player.note_m:u.player.note_a)-M}),c(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${g.length>0?g.map(r=>{var Y,j;const u=r.player,M=a==="GK"?u.note_g:a==="DEF"?u.note_d:a==="MIL"?u.note_m:u.note_a,L=ti(u),N={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[u.rarity];return`<div class="player-option" data-card-id="${r.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <!-- Portrait -->
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${wt[a]}">
            ${L?`<img src="${L}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${wt[a]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${a}</div>`}
          </div>
          <!-- Infos -->
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(Y=u.clubs)!=null&&Y.logo_url?`<img src="${u.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((j=u.clubs)==null?void 0:j.encoded_name)||"—"}</span>`}
              <span style="font-size:10px;color:var(--gray-600)">${u.country_code}</span>
            </div>
          </div>
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${wt[a]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${N};flex-shrink:0">
            ${M}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(y=document.getElementById("close-selector"))==null||y.addEventListener("click",d),(z=document.getElementById("remove-player"))==null||z.addEventListener("click",()=>{delete t.slots[e],d(),Lt(i,t,s)}),document.querySelectorAll(".player-option").forEach(r=>{r.addEventListener("click",()=>{t.slots[e]=r.dataset.cardId,d(),Lt(i,t,s)})})}function rn(e,t,i){var p;const{openModal:s,closeModal:c}=i,d=new Set;Object.values(e.slots).filter(Boolean).forEach(o=>{var g;const n=e.playerCards.find(v=>v.id===o);(g=n==null?void 0:n.player)!=null&&g.id&&d.add(n.player.id)}),e.subs.forEach(o=>{var g;const n=e.playerCards.find(v=>v.id===o);(g=n==null?void 0:n.player)!=null&&g.id&&d.add(n.player.id)});const a=new Set,l=e.playerCards.filter(o=>{var n,g,v;return d.has((n=o.player)==null?void 0:n.id)||a.has((g=o.player)==null?void 0:g.id)?!1:(a.add((v=o.player)==null?void 0:v.id),!0)});s("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${l.length>0?l.map(o=>{var y;const n=o.player,g=ti(n),v=n.job==="GK"?n.note_g:n.job==="DEF"?n.note_d:n.job==="MIL"?n.note_m:n.note_a;return`<div class="player-option" data-card-id="${o.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
          <div style="width:40px;height:40px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${wt[n.job]}">
  ...
  `,document.body.appendChild(c);let d=!1;const a=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let p=!1;const o=G=>G.touches&&G.touches[0]?G.touches[0].clientX:G.clientX;function n(G){d||(p=!0,l.style.opacity="1",g(G))}function g(G){if(!p||d)return;const oe=a.getBoundingClientRect(),pe=o(G)-oe.left,ye=Math.max(0,Math.min(1,pe/oe.width));l.style.width=ye*oe.width+"px",ye>=.82&&y()}function v(){d||(p=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{d||(l.style.transition="")},220))}function y(){var oe;if(d)return;d=!0,p=!1,l.style.width="100%",l.style.opacity="1",(oe=document.getElementById("cut-flash"))==null||oe.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const G=document.getElementById("cut-hint");G&&(G.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",M(0)},620)}a.addEventListener("pointerdown",n),window.addEventListener("pointermove",g),window.addEventListener("pointerup",v),a.addEventListener("touchstart",n,{passive:!0}),window.addEventListener("touchmove",g,{passive:!0}),window.addEventListener("touchend",v);let z=0,r=!1;const u=new Set;function M(G){z=G,document.getElementById("reveal-phase").style.display="flex",L(),N(G,0),Q()}function L(){const G=document.getElementById("card-dots");G&&(G.innerHTML=e.map((oe,pe)=>`<div class="card-dot" data-i="${pe}" style="width:8px;height:8px;border-radius:50%;background:${pe===z?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),G.querySelectorAll(".card-dot").forEach(oe=>oe.addEventListener("click",()=>j(parseInt(oe.dataset.i)))))}function N(G,oe){var xe;const pe=e[G],ye=document.getElementById("card-counter"),Se=document.getElementById("card-track");ye&&(ye.textContent=`Carte ${G+1} / ${e.length}`);const he=document.getElementById("reveal-btns");he&&(he.style.display=G===e.length-1?"flex":"none");const ve=pe.card_type==="player"&&((xe=pe.player)==null?void 0:xe.rarity)==="legende",ke=!u.has(G);u.add(G);let Te=0;if(pe.card_type==="player"&&pe.player){const W=pe.player,ie=W.job||"ATT";Te=Number(ie==="GK"?W.note_g:ie==="DEF"?W.note_d:ie==="MIL"?W.note_m:W.note_a)||0}const Le=W=>{Se.innerHTML=`
        ...
        </div>`;const ie=document.getElementById("current-card-wrap");oe!==0?(ie.style.transition="none",ie.style.transform=`translateX(${oe>0?100:-100}%)`,requestAnimationFrame(()=>{ie.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ie.style.transform="translateX(0)"})):ie.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),W||ve?se():P(),L()};ke&&Te>6&&pe.card_type==="player"&&pe.player?Y(pe,()=>Le(!0)):Le(!1)}function Y(G,oe){var Te;r=!0;const pe=G.player,ye=`https://flagsapi.com/${pe.country_code}/flat/64.png`,Se=(Te=pe.clubs)==null?void 0:Te.logo_url,he=document.getElementById("walkout-overlay"),ve=document.getElementById("walkout-stage");if(!he||!ve){r=!1,oe();return}he.style.display="flex";const ke=()=>{const Le=ve.firstElementChild;Le&&(Le.classList.remove("wo-in"),Le.classList.add("wo-out"))};ve.innerHTML=`<img class="wo-in" src="${ye}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(ke,2e3),setTimeout(()=>{var Le;ve.innerHTML=Se?`<img class="wo-in" src="${Se}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((Le=pe.clubs)==null?void 0:Le.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(ke,4450),setTimeout(()=>{he.style.display="none",ve.innerHTML="",r=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),oe()},4900)}function j(G){if(r||G<0||G>=e.length||G===z)return;const oe=G>z?1:-1;z=G,N(G,oe)}function F(){j(z+1)}function B(){j(z-1)}function Q(){const G=document.getElementById("card-viewport");if(!G||G._swipeBound)return;G._swipeBound=!0;let oe=0,pe=0,ye=0,Se=!1;const he=xe=>xe.touches?xe.touches[0].clientX:xe.clientX,ve=xe=>xe.touches?xe.touches[0].clientY:xe.clientY,ke=xe=>{Se=!0,oe=he(xe),pe=ve(xe),ye=0},Te=xe=>{if(!Se)return;ye=he(xe)-oe;const W=ve(xe)-pe;if(Math.abs(ye)<Math.abs(W))return;const ie=document.getElementById("current-card-wrap");ie&&(ie.style.transition="none",ie.style.transform=`translateX(${ye*.6}px) rotate(${ye*.02}deg)`)},Le=()=>{if(!Se)return;Se=!1;const xe=document.getElementById("current-card-wrap"),W=55;ye<=-W&&z<e.length-1?F():ye>=W&&z>0?B():xe&&(xe.style.transition="transform .2s ease",xe.style.transform="translateX(0)")};G.addEventListener("pointerdown",ke),G.addEventListener("pointermove",Te),G.addEventListener("pointerup",Le),G.addEventListener("pointercancel",Le),G.addEventListener("touchstart",ke,{passive:!0}),G.addEventListener("touchmove",Te,{passive:!0}),G.addEventListener("touchend",Le),G.addEventListener("click",xe=>{if(Math.abs(ye)>8)return;const W=G.getBoundingClientRect();xe.clientX-W.left>W.width/2?F():B()})}let de=null;function se(){const G=document.getElementById("fireworks-canvas");if(!G)return;G.width=window.innerWidth,G.height=window.innerHeight;const oe=G.getContext("2d"),pe=[];function ye(){const he=Math.random()*G.width,ve=Math.random()*G.height*.6,ke=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],Te=ke[Math.floor(Math.random()*ke.length)];for(let Le=0;Le<60;Le++){const xe=Math.PI*2/60*Le,W=2+Math.random()*5;pe.push({x:he,y:ve,vx:Math.cos(xe)*W,vy:Math.sin(xe)*W,alpha:1,color:Te,size:2+Math.random()*3})}}ye(),de=setInterval(ye,600);function Se(){if(document.getElementById("fireworks-canvas")){oe.clearRect(0,0,G.width,G.height);for(let he=pe.length-1;he>=0;he--){const ve=pe[he];if(ve.x+=ve.vx,ve.y+=ve.vy+.08,ve.vy*=.98,ve.alpha-=.018,ve.alpha<=0){pe.splice(he,1);continue}oe.globalAlpha=ve.alpha,oe.fillStyle=ve.color,oe.beginPath(),oe.arc(ve.x,ve.y,ve.size,0,Math.PI*2),oe.fill()}oe.globalAlpha=1,(de!==null||pe.length>0)&&requestAnimationFrame(Se)}}Se()}function P(){de!==null&&(clearInterval(de),de=null);const G=document.getElementById("fireworks-canvas");G&&G.getContext("2d").clearRect(0,0,G.width,G.height)}if(s){const G=document.getElementById("reveal-btns");G&&(G.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(H=document.getElementById("reveal-next"))==null||H.addEventListener("click",()=>{P(),c.remove(),s()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{P(),c.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{P(),c.remove(),i("boosters")})}function yn(e){var t,i,s,c;if(e.card_type==="player"&&e.player)return un(e);if(e.card_type==="game_changer"){const d=e._gcDef,a=(d==null?void 0:d.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},p={purple:"#b06ce0",light_blue:"#00d4ef"},o=l[d==null?void 0:d.color]||l.purple,n=p[d==null?void 0:d.color]||p.purple,g=(d==null?void 0:d.name)||e.gc_type||"Game Changer",v=(d==null?void 0:d.effect)||((t=ui[e.gc_type])==null?void 0:t.desc)||"",y=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,z=((i=ui[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${o};border-radius:14px;border:3px solid ${n};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${n}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",s.profile.id).order("created_at",{ascending:!1});if(!d||d.length===0){_t(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>c("decks"));return}const a=d.map(v=>v.id),{data:l}=await E.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),p=[...new Set((l||[]).filter(v=>{var y,z;return((y=v.card)==null?void 0:y.card_type)==="stadium"&&((z=v.card)==null?void 0:z.stadium_id)}).map(v=>v.card.stadium_id))],o={};if(p.length){const{data:v}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",p);(v||[]).forEach(y=>{o[y.id]=y}),(l||[]).forEach(y=>{var z,r;((z=y.card)==null?void 0:z.card_type)==="stadium"&&((r=y.card)!=null&&r.stadium_id)&&(y.card._stadiumDef=o[y.card.stadium_id]||null)})}let n=0;function g(){var j,F,B,Q,de,se,P;const v=d[n],y=(l||[]).filter(J=>J.deck_id===v.id),z=y.filter(J=>{var H;return J.is_starter&&((H=J.card)==null?void 0:H.player)}).map(J=>gi(J.card,J.position)),r=y.find(J=>{var H;return((H=J.card)==null?void 0:H.card_type)==="formation"}),u=v.formation||((j=r==null?void 0:r.card)==null?void 0:j.formation)||"4-4-2";let M=z.length>=11?yt(z,u):null,L=((F=v.stadium_card)==null?void 0:F.stadium_def)||null;L&&M&&(M=Ht(M,L));const N=z.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">
        ${d.map((J,H)=>`<div style="width:7px;height:7px;border-radius:50%;background:${H===n?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}
      </div>`:""}
  ...
  </div>`}function ot(e,t,i){if(!(e!=null&&e.length))return"";const s=e.slice(0,5);let c='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return s.forEach((d,a)=>{if(c+=Ye(d,40,52),a<s.length-1){const l=at(d,s[a+1]);c+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(c+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),c+="</div>",c}function Zt(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function vo(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function ut(e,t,i,s,c=310,d=310,a=[]){var N;const l=Pt[t]||{},p=Wi(t)||bi[t]||[],o={},n=["ATT","MIL","DEF","GK"];for(const Y of n)(e[Y]||[]).forEach((F,B)=>{o[`${Y}${B+1}`]=F});function g(Y){const j=l[Y];return j?{x:j.x*c,y:j.y*d}:null}let v="";for(const[Y,j]of p){const F=g(Y),B=g(j);if(!F||!B)continue;const Q=o[Y],de=o[j],se=at(Q,de);se==="#00ff88"||se==="#FFD700"?(v+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${B.x.toFixed(1)}" y2="${B.y.toFixed(1)}"
        stroke="${se}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,v+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${B.x.toFixed(1)}" y2="${B.y.toFixed(1)}"
        stroke="${se}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):v+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${B.x.toFixed(1)}" y2="${B.y.toFixed(1)}"
        stroke="${se}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const y=48,z=64,r=13,u=16,M={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[Y,j]of Object.entries(o)){const F=g(Y);if(!F||!j)continue;const B=Y.replace(/[0-9]/g,""),Q=Mt[B]||"#555",de=a.includes(j.cardId),se=i==="attack"&&(["MIL","ATT"].includes(B)||de)&&!j.used||i==="defense"&&["GK","DEF","MIL"].includes(B)&&!j.used,P=s.includes(j.cardId);let J;i==="attack"?J=de?Math.max(1,Number(j.note_a)||0):B==="MIL"?Number(j.note_m)||0:Number(j.note_a)||0:i==="defense"?J=B==="GK"?Number(j.note_g)||0:B==="MIL"?Number(j.note_m)||0:Number(j.note_d)||0:J=Number(B==="GK"?j.note_g:B==="DEF"?j.note_d:B==="MIL"?j.note_m:j.note_a)||0,J=J+(j.boost||0),j.stadiumBonus&&(i==="attack"&&(B==="ATT"||B==="MIL")||i==="defense"&&(B==="GK"||B==="DEF"||B==="MIL")?J+=10:i||(J+=10));const H=(F.x-y/2).toFixed(1),G=(F.y-z/2).toFixed(1),oe=M[j==null?void 0:j.rarity]||M.normal;if(j.used){const Te=typeof import.meta<"u"&&"/manager-wars/"||"/",xe=`${typeof window<"u"&&((N=window.location)==null?void 0:N.origin)||""}${Te}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="#161616"/>`,v+=`<image href="${xe}" xlink:href="${xe}" x="${H}" y="${G}" width="${y}" height="${z}" preserveAspectRatio="xMidYMid slice"/>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="none" stroke="${oe}" stroke-width="2" opacity="0.7"/>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${j.cardId}" data-role="${B}" style="cursor:pointer"/>`;continue}const pe=P?.45:1,ye=P?"#FFD700":oe,Se=P?3:(j==null?void 0:j.rarity)==="legende"||(j==null?void 0:j.rarity)==="légende"||(j==null?void 0:j.rarity)==="pepite"||(j==null?void 0:j.rarity)==="pépite"?2.5:2,he=z-r-u;v+=`<defs><clipPath id="cp-${Y}"><rect x="${H}" y="${(F.y-z/2+r).toFixed(1)}" width="${y}" height="${he}"/></clipPath></defs>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="${Q}" opacity="${pe}"/>`;const ve=Pe(j);ve&&(v+=`<image href="${ve}" xlink:href="${ve}" x="${H}" y="${(F.y-z/2+r).toFixed(1)}" width="${y}" height="${he}" clip-path="url(#cp-${Y})" preserveAspectRatio="xMidYMin slice"/>`),v+=`<rect x="${H}" y="${G}" width="${y}" height="${r}" rx="4" fill="rgba(255,255,255,0.92)"/>`,v+=`<text x="${F.x.toFixed(1)}" y="${(F.y-z/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(j.name||"").slice(0,9)}</text>`;const ke=(F.y+z/2-u).toFixed(1);v+=`<rect x="${H}" y="${ke}" width="${y}" height="${u}" fill="rgba(255,255,255,0.92)"/>`;{const Te=Zt(j.country_code);Te?v+=`<image href="${Te}" xlink:href="${Te}" x="${(F.x-20).toFixed(1)}" y="${(F.y+z/2-u+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:v+=`<text x="${(F.x-13).toFixed(1)}" y="${(F.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${vo(j.country_code)}</text>`;const Le=j.stadiumBonus?"#E87722":"#111";v+=`<text x="${F.x.toFixed(1)}" y="${(F.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${Le}" font-family="Arial Black">${J}</text>`;const xe=ho(j);xe?v+=`<image href="${xe}" xlink:href="${xe}" x="${(F.x+y/2-14).toFixed(1)}" y="${(F.y+z/2-u+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:j.clubName&&(v+=`<text x="${(F.x+14).toFixed(1)}" y="${(F.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(j.clubName||"").slice(0,3).toUpperCase()}</text>`),j.stadiumBonus&&(v+=`<rect x="${(F.x-y/2).toFixed(1)}" y="${(F.y-z/2).toFixed(1)}" width="${y}" height="${z}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="${P?"rgba(255,255,255,0.12)":"none"}" stroke="${ye}" stroke-width="${Se}" opacity="${pe}"/>`,se&&(v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${P?"selected":""}" data-card-id="${j.cardId}" data-role="${B}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${c+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${v}
  ...
  </div>`}async function ri(e,t,i,s){var F;const{state:c,navigate:d,toast:a}=t;et(e);const l=c.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!l.deckId)return An(e,t,i);const p=l.deckId;let o,n,g,v;try{const B=await Promise.all([E.from("decks").select("formation,name,stadium_card_id").eq("id",p).single(),E.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",p).order("slot_order")]);o=B[0].data,g=B[0].error,n=B[1].data,v=B[1].error}catch(B){console.error("[Match] Exception chargement deck:",B),_t(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>d("home"));return}if(g||v){console.error("[Match] Erreur Supabase:",g||v),_t(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>d("home"));return}const y=(n||[]).filter(B=>{var Q;return B.is_starter&&((Q=B.card)==null?void 0:Q.player)}).map(B=>gi(B.card,B.position)),z=(n||[]).filter(B=>{var Q;return!B.is_starter&&((Q=B.card)==null?void 0:Q.player)}).map(B=>gi(B.card,B.position));if(y.length<11){_t(e,"⚠️",`Deck incomplet (${y.length}/11).`,"Compléter",()=>d("decks"));return}const r=(n||[]).find(B=>{var Q;return((Q=B.card)==null?void 0:Q.card_type)==="formation"}),u=(o==null?void 0:o.formation)||((F=r==null?void 0:r.card)==null?void 0:F.formation)||"4-4-2",{data:M,error:L}=await E.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",c.profile.id).eq("card_type","game_changer"),{data:N}=await E.from("gc_definitions").select("*").eq("is_active",!0),Y=(M||[]).map(B=>({...B,_gcDef:(N==null?void 0:N.find(Q=>Q.name===B.gc_type||Q.id===B.gc_definition_id))||null}));let j=null;if(o!=null&&o.stadium_card_id){const{data:B}=await E.from("cards").select("stadium_id").eq("id",o.stadium_card_id).single();if(B!=null&&B.stadium_id){const{data:Q}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",B.stadium_id).single();j=Q||null}}s({deckId:p,formation:u,starters:y,subsRaw:z,gcCardsEnriched:Y,gcDefs:N||[],stadiumDef:j})}async function zn(e,t){const{state:i}=t,c=(i.params||{}).matchMode||"vs_ai_easy",d=c.replace("vs_ai_",""),a=c;await ri(e,t,c,async({deckId:l,formation:p,starters:o,subsRaw:n,gcCardsEnriched:g,gcDefs:v,stadiumDef:y})=>{try{let z=yt(o,p);y&&(z=Ht(z,y),ii(n,y));const r=await Sn(p,d),u=async M=>{try{const{data:L,error:N}=await E.from("matches").insert({home_id:i.profile.id,away_id:null,mode:a,home_deck_id:l,status:"in_progress"}).select().single();if(N){console.error("[MatchIA] Erreur création match:",N),_t(e,"⚠️","Impossible de créer le match ("+N.message+").","Retour",()=>t.navigate("home"));return}const Y={gcDefs:v||[],matchId:L==null?void 0:L.id,mode:a,difficulty:d,formation:p,homeTeam:z,aiTeam:r,homeSubs:n,subsUsed:0,maxSubs:Math.min(n.length,3),homeScore:0,aiScore:0,gcCards:M,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};In(e,Y,t)}catch(L){console.error("[MatchIA] Exception launchMatch:",L),_t(e,"⚠️","Erreur au lancement du match : "+L.message,"Retour",()=>t.navigate("home"))}};if(!g.length){u([]);return}ni(e,g,u)}catch(z){console.error("[MatchIA] Exception setup:",z),_t(e,"⚠️","Erreur de préparation du match : "+z.message,"Retour",()=>t.navigate("home"))}})}async function Sn(e,t){var a,l;const{data:i}=await E.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return Ln(e);const s=It[e]||It["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},d=[...i];for(const p of["GK","DEF","MIL","ATT"]){const o=d.filter(z=>z.job===p),n=d.filter(z=>z.job!==p),g=[...o,...n],v=[];for(let z=0;z<s[p];z++){const r=g[z]||d[z];r&&v.push({cardId:"ai-"+r.id+"-"+z,id:r.id,firstname:r.firstname,name:r.surname_encoded,country_code:r.country_code,club_id:r.club_id,job:r.job,job2:r.job2,note_g:Number(r.note_g)||0,note_d:Number(r.note_d)||0,note_m:Number(r.note_m)||0,note_a:Number(r.note_a)||0,rarity:r.rarity,skin:r.skin,hair:r.hair,hair_length:r.hair_length,clubName:((a=r.clubs)==null?void 0:a.encoded_name)||null,clubLogo:((l=r.clubs)==null?void 0:l.logo_url)||null,boost:0,used:!1,_line:p})}const y=lt(v.length);v.forEach((z,r)=>{z._col=y[r]}),c[p]=v}return c}function Ln(e){const t=It[e]||It["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},s=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const d of["GK","DEF","MIL","ATT"]){const a=[];for(let p=0;p<t[d];p++){const o=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:s[c%s.length],country_code:"XX",club_id:null,job:d,job2:null,note_g:d==="GK"?o:2,note_d:d==="DEF"?o:2,note_m:d==="MIL"?o:2,note_a:d==="ATT"?o:2,rarity:"normal",boost:0,used:!1,_line:d}),c++}const l=lt(a.length);a.forEach((p,o)=>{p._col=l[o]}),i[d]=a}return i}function In(e,t,i){e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${r.map((N,Y)=>{const j=Y<r.length-1?at(N,r[Y+1]):null,F=!j||j==="#ff3333"||j==="#cc2222",B=j==="#00ff88"?"+2":j==="#FFD700"?"+1":"";return`
          <div class="duel-card duel-card-${L}" data-idx="${Y}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${Ye({...N,note:Ie(N,"MIL"),_line:"MIL"},58,78)}
          </div>
          ${Y<r.length-1?`<div class="duel-link duel-link-${L}" data-idx="${Y}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${F?"rgba(255,255,255,0.12)":j};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${F?"none":`0 0 8px ${j}`}">
            ${B?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${j}">${B}</span>`:""}
          </div>`:""}
          `}).join("")}
      </div>
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,j.style.transition="opacity .45s ease",j.style.opacity="1",j.style.pointerEvents="auto",(F=document.getElementById("start-match-btn"))==null||F.addEventListener("click",z))},600)},700)},2800)}function jn(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const J=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${ot((J.players||[]).map(H=>({...H,used:!1})),"#ff6b6b",J.total)}
            ...
            ${ot((J.players||[]).map(H=>({...H,used:!1})),"#00ff88",J.total)}
    ...
    ${(()=>{const P=window.innerWidth>=700,J=(ke,Te,Le)=>{var Me,De;const xe=(t.gcDefs||[]).find(I=>I.name===ke.gc_type),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[xe==null?void 0:xe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ie={purple:"#b06ce0",light_blue:"#00d4ef"}[xe==null?void 0:xe.color]||"#b06ce0",ge=(xe==null?void 0:xe.name)||ke.gc_type,K=(xe==null?void 0:xe.effect)||((Me=Ke[ke.gc_type])==null?void 0:Me.desc)||"",ne=xe!=null&&xe.image_url?`/manager-wars/icons/${xe.image_url}`:null,U=((De=Ke[ke.gc_type])==null?void 0:De.icon)||"⚡",re=Math.round(Le*.22),be=Math.round(Le*.22),Ae=Le-re-be,ze=ge.length>12?7:9;return`<div class="gc-mini" data-gc-id="${ke.id}" data-gc-type="${ke.gc_type}"
          style="box-sizing:border-box;width:${Te}px;height:${Le}px;border-radius:10px;border:2px solid ${ie};background:${W};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${re}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${ze}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${Te-6}px">${ge}</span>
          ...
          <div style="height:${Ae}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${ne?`<img src="${ne}" style="max-width:${Te-10}px;max-height:${Ae-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Ae*.55)}px">${U}</span>`}
          </div>
        ...
        </div>`},H=(ke,Te)=>{var Le;return`<div id="boost-card"
          style="box-sizing:border-box;width:${ke}px;height:${Te}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(Te*.04)}px;text-align:center;flex-shrink:0">
            <div style="font-size:${Math.round(Te*.2)}px">⚡</div>
            <div style="font-size:${Math.round(Te*.09)}px;color:#000;font-weight:900">+${(Le=t.boostCard)==null?void 0:Le.value}</div>
          </div>`},G=(ke,Te)=>Te?H(130,175):J(ke,130,175),oe=(ke,Te)=>Te?H(68,95):J(ke,68,95),pe=P?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ye=z?`<button id="btn-results" style="${pe};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:g?`<div style="${pe};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:v?`<button id="btn-action" style="${pe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:y?`<button id="btn-action" style="${pe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${pe};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,Se=v||y?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",he=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${P?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
        ${d.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':d.map(ke=>`<div class="sub-btn-col" data-sub-id="${ke.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(ke,76,100)}</div>`).join("")}
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(P=>{var J,H,G;if(P.type==="duel"){const oe=P.isGoal,pe=P.homeScored?"#FFD700":oe?"#ff6b6b":"rgba(255,255,255,0.3)",ye=P.homeScored?"⚽ BUT !":oe?"⚽ BUT IA !":(J=P.homePlayers)!=null&&J.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${oe?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${pe};margin-bottom:4px">
  ...
  `,document.body.appendChild(s);let n=!1;const g=()=>{n||(n=!0,s.remove(),i())};s.addEventListener("click",g),setTimeout(g,2e3)}function jt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function di(e,t,i,s=null,c=null){var y,z;if(t.phase!=="attack"){jt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){jt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([r,u])=>(u||[]).filter(M=>M.used).map(M=>({...M,_line:M._line||r}))),a=t.homeSubs.filter(r=>!t.usedSubIds.includes(r.cardId));if(!d.length){jt("Aucun joueur utilisé à remplacer");return}if(!a.length){jt("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(r=>r.cardId===c));const p=((y=d[l])==null?void 0:y._line)||((z=d[l])==null?void 0:z.job);let o=s?Math.max(0,a.findIndex(r=>r.cardId===s)):Math.max(0,a.findIndex(r=>r.job===p)),n=!1;const g=document.createElement("div");g.id="sub-overlay",g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function v(){var j,F,B,Q,de,se;const r=d[l],u=a[o],M=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(M*1.35),N=P=>`background:rgba(255,255,255,0.12);border:none;color:${P?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${P?"default":"pointer"};flex-shrink:0`;g.innerHTML=`
    ...
    </div>`,(j=g.querySelector("#sub-close"))==null||j.addEventListener("click",()=>g.remove()),(F=g.querySelector("#out-up"))==null||F.addEventListener("click",()=>{l>0&&(l--,v())}),(B=g.querySelector("#out-down"))==null||B.addEventListener("click",()=>{l<d.length-1&&(l++,v())}),(Q=g.querySelector("#in-up"))==null||Q.addEventListener("click",()=>{o>0&&(o--,v())}),(de=g.querySelector("#in-down"))==null||de.addEventListener("click",()=>{o<a.length-1&&(o++,v())});const Y=(P,J,H,G)=>{const oe=g.querySelector("#"+P);if(!oe)return;let pe=0;oe.addEventListener("touchstart",ye=>{pe=ye.touches[0].clientY},{passive:!0}),oe.addEventListener("touchend",ye=>{const Se=ye.changedTouches[0].clientY-pe;if(Math.abs(Se)<30)return;const he=J();Se<0&&he<G-1?(H(he+1),v()):Se>0&&he>0&&(H(he-1),v())},{passive:!0})};Y("in-panel",()=>o,P=>o=P,a.length),Y("out-panel",()=>l,P=>l=P,d.length),(se=g.querySelector("#sub-confirm"))==null||se.addEventListener("click",P=>{if(P.preventDefault(),P.stopPropagation(),n)return;n=!0;const J=d[l],H=a[o];if(!J||!H)return;let G=null,oe=-1;for(const[ye,Se]of Object.entries(t.homeTeam)){const he=(Se||[]).findIndex(ve=>ve.cardId===J.cardId);if(he!==-1){G=ye,oe=he;break}}if(oe===-1||!G){jt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),g.remove();return}const pe={...H,_line:G,_col:J._col||0,used:!1,boost:0};t.homeTeam[G].splice(oe,1,pe),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(H.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:J.name,firstname:J.firstname,note:Ie(J,G),portrait:Pe(J),job:J.job,country_code:J.country_code,rarity:J.rarity,clubName:J.clubName,clubLogo:J.clubLogo},inPlayer:{name:H.name,firstname:H.firstname,note:Ie(H,G),portrait:Pe(H),job:H.job,country_code:H.country_code,rarity:H.rarity,clubName:H.clubName,clubLogo:H.clubLogo},text:`🔄 ${H.firstname} ${H.name} remplace ${J.firstname} ${J.name}`}),g.remove(),Dn(J,H,()=>Xe(e,t,i))})}document.body.appendChild(g),v()}function Gn(e,t,i,s,c){var z,r;const d=(s.gcDefs||[]).find(u=>u.name===t),a=Ke[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",p={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",o=(d==null?void 0:d.name)||t,n=(d==null?void 0:d.effect)||a.desc,g=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,v=a.icon||"⚡",y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",y.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${s.map(c=>`
        <div class="player-boost-opt" data-card-id="${c.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Mt[c.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Ie(c,c._line||c.job)}</div>
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const p=()=>{l||(l=!0,d.remove(),setTimeout(()=>c(),50))};d.addEventListener("click",p),setTimeout(p,3500)}async function Bt(e,t,i){var n,g;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,c=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,a=c?"victoire":d?"nul":"defaite",l=Ko(t.mode,a);t.matchId&&await E.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?s.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(s.profile.credits||0)+l,matches_played:(s.profile.matches_played||0)+1};c?p.wins=(s.profile.wins||0)+1:d?p.draws=(s.profile.draws||0)+1:p.losses=(s.profile.losses||0)+1,await E.from("users").update(p).eq("id",s.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const z=async(Y=!0)=>{v=!0,y&&(E.removeChannel(y),y=null),Y&&await E.rpc("cancel_matchmaking",{p_user_id:o.profile.id}).catch(()=>{})};(N=document.getElementById("mm-cancel"))==null||N.addEventListener("click",async()=>{try{await z(!0)}catch{}We(e),n("home")});const r=async(Y,j,F)=>{if(v)return;v=!0,y&&(E.removeChannel(y),y=null);const B=document.getElementById("mm-status");B&&(B.textContent="Adversaire trouvé !"),await new Promise(Q=>setTimeout(Q,600)),e.isConnected&&$o(e,t,Y,F,a,l)},{data:u,error:M}=await E.rpc("try_matchmake",{p_user_id:o.profile.id,p_deck_id:i});if(M||!(u!=null&&u.success)){g("Erreur de matchmaking","error"),We(e),n("home");return}if(u.matched){r(u.match_id,u.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),y=E.channel("matchmaking-"+o.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${o.profile.id}`},Y=>{const j=Y.new;j.status==="matched"&&j.match_id&&r(j.match_id,j.matched_with,!0)}).subscribe()}async function Un(e,t,i){const{state:s,navigate:c,toast:d}=t;try{(E.getChannels?E.getChannels():[]).forEach(o=>{const n=o.topic||"";(n.includes("matchmaking")||n.includes("pvp-match")||n.includes("friend-invite"))&&E.removeChannel(o)})}catch{}const{data:a}=await E.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!a){d("Match introuvable","error"),c("home");return}if(a.status==="finished"){d("Ce match est terminé","info"),c("home");return}const l=a.home_id===s.profile.id;$o(e,t,i,l,[],[])}async function $o(e,t,i,s,c=[],d=[]){const{state:a,navigate:l,toast:p}=t,o=s?"p1":"p2",n=s?"p2":"p1",g=(c||[]).map(I=>I.id),v=(c||[]).map(I=>({id:I.id,gc_type:I.gc_type,_gcDef:I._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:y}=await E.from("matches").select("*").eq("id",i).single();if(!y){p("Match introuvable","error"),l("home");return}async function z(){const[{data:I},{data:C},{data:w},{data:k}]=await Promise.all([E.rpc("get_deck_for_match",{p_deck_id:y.home_deck_id}),E.rpc("get_deck_for_match",{p_deck_id:y.away_deck_id}),E.from("users").select("id,pseudo,club_name").eq("id",y.home_id).single(),E.from("users").select("id,pseudo,club_name").eq("id",y.away_id).single()]),f=A=>({cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:Number(A.note_g)||0,note_d:Number(A.note_d)||0,note_m:Number(A.note_m)||0,note_a:Number(A.note_a)||0,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),m=((I==null?void 0:I.starters)||[]).map(A=>f(A)),x=((C==null?void 0:C.starters)||[]).map(A=>f(A)),b=(I==null?void 0:I.formation)||"4-4-2",h=(C==null?void 0:C.formation)||"4-4-2";let _=yt(m,b),T=yt(x,h);const $=((I==null?void 0:I.subs)||[]).map(A=>f(A));return stadiumDef&&s&&(_=Ht(_,stadiumDef),ii($,stadiumDef)),{p1Team:_,p2Team:T,p1Subs:$,p2Subs:((C==null?void 0:C.subs)||[]).map(A=>f(A)),p1Formation:b,p2Formation:h,p1Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 1",p2Name:(k==null?void 0:k.club_name)||(k==null?void 0:k.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?g:[],gc_p2:s?[]:g,gcCardsFull_p1:s?v:[],gcCardsFull_p2:s?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=y.game_state&&Object.keys(y.game_state).length?y.game_state:null;if(!r)if(s){r=await z();const{data:I}=await E.from("matches").select("game_state").eq("id",i).single();!(I!=null&&I.game_state)||!Object.keys(I.game_state).length?await E.from("matches").update({game_state:r,turn_user_id:y.home_id}).eq("id",i):r=I.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let I=0;I<30&&!r;I++){await new Promise(w=>setTimeout(w,400));const{data:C}=await E.from("matches").select("game_state").eq("id",i).single();C!=null&&C.game_state&&Object.keys(C.game_state).length&&(r=C.game_state)}if(!r){p("Erreur de synchronisation","error"),l("home");return}r.gc_p2=g,r.gcCardsFull_p2=v,await E.from("matches").update({game_state:r}).eq("id",i)}let u=!1,M=null,L=!1;const N=new Set,Y=new Set;function j(I){var _,T;try{E.removeChannel(F)}catch{}const C=r[o+"Score"]||0,w=r[n+"Score"]||0;let k,f;I.winner_id?(k=I.winner_id===a.profile.id,f=!1):I.forfeit?(k=C>w,f=!1):(f=C===w,k=C>w),(_=document.getElementById("pvp-end-overlay"))==null||_.remove();const m=document.createElement("div");m.id="pvp-end-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const x=f?"🤝":k?"🏆":"😞",b=f?"MATCH NUL":k?"VICTOIRE !":"DÉFAITE",h=f?"#fff":k?"#FFD700":"#ff6b6b";m.innerHTML=`
      <div style="font-size:64px">${x}</div>
      <div style="font-size:26px;font-weight:900;color:${h}">${b}</div>
      <div style="font-size:18px">${r[o+"Name"]} ${C} – ${w} ${r[n+"Name"]}</div>
      ${I.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${k?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(m),(T=m.querySelector("#pvp-end-home"))==null||T.addEventListener("click",()=>{m.remove(),We(e),l("home")})}const F=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},I=>{const C=I.new;try{if(C.status==="finished"||C.forfeit){if(u)return;u=!0,M&&(clearInterval(M),M=null),C.game_state&&(r=C.game_state),j(C);return}if(C.game_state){const w=r;r=C.game_state;const k=r._lastGC;if(k&&k.seq&&!Y.has(k.seq)&&(Y.add(k.seq),k.by!==o)){he(k.type,k.by,()=>G());return}const f=w[o+"Score"]||0,m=w[n+"Score"]||0,x=r[o+"Score"]||0,b=r[n+"Score"]||0,h=x>f,_=b>m;if((h||_)&&!N.has(r.round)){N.add(r.round);const T=[...r.log||[]].reverse().find(A=>A.isGoal),$=((T==null?void 0:T.homePlayers)||[]).map(A=>({name:A.name,note:A.note,portrait:A.portrait,job:A.job}));Se($,x,b,h,()=>G());return}G()}}catch(w){console.error("[PvP] crash:",w)}}).subscribe();async function B(I){Object.assign(r,I),r.lastActionAt=new Date().toISOString();const{error:C}=await E.from("matches").update({game_state:r}).eq("id",i);C&&p("Erreur de synchronisation","error");try{G()}catch(w){console.error("[PvP] renderPvpScreen crash:",w)}}async function Q(){if(u)return;u=!0,M&&(clearInterval(M),M=null);const I=s?y.away_id:y.home_id,C=s?"p2":"p1",w=s?"p1":"p2",k={...r,[C+"Score"]:3,[w+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:I,home_score:k.p1Score||0,away_score:k.p2Score||0,game_state:k}).eq("id",i)}catch{}try{E.removeChannel(F)}catch{}setTimeout(()=>{We(e),l("home")},800)}const de={BOOST_STAT:({value:I=1,count:C=1,roles:w=[]},k,f)=>{const m=k[o+"Team"],x=Object.entries(m).filter(([b])=>!w.length||w.includes(b)).flatMap(([b,h])=>h.filter(_=>!_.used).map(_=>({..._,_line:b})));if(!x.length){k.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),f(k);return}se(x,C,`Choisir ${C} joueur(s) à booster (+${I})`,b=>{b.forEach(h=>{const _=(m[h._line]||[]).find(T=>T.cardId===h.cardId);_&&(_.boost=(_.boost||0)+I,k.log.push({text:`⚡ +${I} sur ${_.name}`,type:"info"}))}),k[o+"Team"]=m,f(k)})},DEBUFF_STAT:({value:I=1,count:C=1,roles:w=[],target:k="ai"},f,m)=>{const x=k==="home"?o:n,b=f[x+"Team"],h=k==="home"?"allié":"adverse",_=Object.entries(b).filter(([T])=>!w.length||w.includes(T)).flatMap(([T,$])=>$.map(A=>({...A,_line:T})));if(!_.length){f.log.push({text:`🎯 Aucun joueur ${h}`,type:"info"}),m(f);return}se(_,C,`Choisir ${C} joueur(s) ${h}(s) (-${I})`,T=>{T.forEach($=>{const A=(b[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.boost=(A.boost||0)-I,f.log.push({text:`🎯 -${I} sur ${A.name}`,type:"info"}))}),f[x+"Team"]=b,m(f)})},GRAY_PLAYER:({count:I=1,roles:C=[],target:w="ai"},k,f)=>{const m=w==="home"?o:n,x=k[m+"Team"],b=w==="home"?"allié":"adverse",h=Object.entries(x).filter(([_])=>!C.length||C.includes(_)).flatMap(([_,T])=>T.filter($=>!$.used).map($=>({...$,_line:_})));if(!h.length){k.log.push({text:`❌ Aucun joueur ${b}`,type:"info"}),f(k);return}se(h,I,`Choisir ${I} joueur(s) ${b}(s) à exclure`,_=>{const T="usedCardIds_"+m,$=new Set(k[T]||[]);_.forEach(A=>{const S=(x[A._line]||[]).find(q=>q.cardId===A.cardId);S&&(S.used=!0,$.add(A.cardId),k.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),k[T]=[...$],k[m+"Team"]=x,f(k)})},REVIVE_PLAYER:({count:I=1,roles:C=[]},w,k)=>{const f=w[o+"Team"],m=Object.entries(f).filter(([x])=>!C.length||C.includes(x)).flatMap(([x,b])=>b.filter(h=>h.used).map(h=>({...h,_line:x})));if(!m.length){w.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),k(w);return}se(m,I,`Choisir ${I} joueur(s) à ressusciter`,x=>{x.forEach(b=>{const h=(f[b._line]||[]).find(_=>_.cardId===b.cardId);h&&(h.used=!1,w.log.push({text:`💫 ${h.name} ressuscité !`,type:"info"}))}),w[o+"Team"]=f,k(w)})},REMOVE_GOAL:({},I,C)=>{const w=n+"Score";I[w]>0?(I[w]--,I.log.push({text:"🚫 Dernier but annulé !",type:"info"})):I.log.push({text:"🚫 Aucun but à annuler",type:"info"}),C(I)},ADD_GOAL_DRAW:({},I,C)=>{I[o+"Score"]===I[n+"Score"]?(I[o+"Score"]++,I.log.push({text:"🎯 But bonus !",type:"info"})):I.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),C(I)},ADD_SUB:({value:I=1},C,w)=>{C.maxSubs=(C.maxSubs||3)+I,C.log.push({text:`🔄 +${I} remplacement(s)`,type:"info"}),w(C)},CUSTOM:({},I,C)=>C(I)};function se(I,C,w,k){const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let m=[];function x(){var h,_;const b=I.map(T=>{const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",A=Ie(T,T._line)+(T.boost||0),q=m.find(R=>R.cardId===T.cardId)?"#FFD700":"rgba(255,255,255,0.25)",D=T.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${q};background:${$};overflow:hidden;cursor:pointer;${D}">
        ...
        <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
          ...
          <span style="font-size:12px;color:rgba(255,255,255,0.5)">${m.length}/${C}</span>
        ...
        <div style="padding:12px;background:rgba(0,0,0,0.4);flex-shrink:0">
          <button id="pp-confirm" ${m.length===0?'disabled style="opacity:0.4"':""} style="width:100%;padding:13px;border-radius:10px;border:none;background:#7a28b8;color:#fff;font-size:15px;font-weight:900;cursor:pointer">
            ✅ Confirmer (${m.length}/${C})
          </button>
        </div>`,(h=f.querySelector("#pp-close"))==null||h.addEventListener("click",()=>f.remove()),f.querySelectorAll(".pp-item").forEach(T=>{T.addEventListener("click",()=>{const $=T.dataset.cid,A=I.find(q=>q.cardId===$),S=m.findIndex(q=>q.cardId===$);A&&(S>-1?m.splice(S,1):m.length<C&&m.push(A),x())})}),(_=f.querySelector("#pp-confirm"))==null||_.addEventListener("click",()=>{f.remove(),k(m)})}x(),document.body.appendChild(f)}async function P(I,C){const k=(r["gcCardsFull_"+o]||[]).find(b=>b.id===I),f=(k==null?void 0:k._gcDef)||(r.gcDefs||[]).find(b=>{var h;return b.name===C||((h=b.name)==null?void 0:h.toLowerCase().trim())===(C==null?void 0:C.toLowerCase().trim())}),m=[...r["usedGc_"+o]||[],I],x={type:C,by:o,seq:(r._gcAnimSeq||0)+1};Y.add(x.seq),he(C,o,async()=>{if(f!=null&&f.effect_type&&f.effect_type!=="CUSTOM"){const h=de[f.effect_type];if(h){const _={...r};h(f.effect_params||{},_,async T=>{T["usedGc_"+o]=m,T._lastGC=x,T._gcAnimSeq=x.seq,await B(T)});return}}const b={...r};switch(C){case"Remplacement+":b.maxSubs=(b.maxSubs||3)+1,b.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const h=n+"Score";b[h]>0&&(b[h]--,b.log.push({text:"🚫 But annulé",type:"info"}));break}}b["usedGc_"+o]=m,b._lastGC=x,b._gcAnimSeq=x.seq,await B(b)})}function J(I,C){const w="usedCardIds_"+I,k=new Set(r[w]||[]);C.forEach(f=>k.add(f)),r[w]=[...k]}function H(){for(const I of["p1","p2"]){const C=new Set(r["usedCardIds_"+I]||[]),w=r[I+"Team"];if(w)for(const k of["GK","DEF","MIL","ATT"])(w[k]||[]).forEach(f=>{f.used=C.has(f.cardId)})}}function G(){var Ue,Je,Ze,Qe,nt,gt;if(r.phase==="reveal")return oe();if(r.phase==="midfield")return ye();if(r.phase==="finished")return De();const I=r[o+"Team"],C=r[n+"Team"];H();const w=r[o+"Score"],k=r[n+"Score"],f=r[o+"Name"],m=r[n+"Name"],x=r.phase===o+"-attack",b=r.phase===o+"-defense",h=Array.isArray(r["selected_"+o])?r["selected_"+o]:[],_=h.map(le=>le.cardId),T=window.innerWidth>=700,$=r[o+"Subs"]||[],A=r["usedSubIds_"+o]||[],S=$.filter(le=>!A.includes(le.cardId)),q=r["gcCardsFull_"+o]||[],D=r["usedGc_"+o]||[],R=q.filter(le=>!D.includes(le.id)),O=r.boostOwner===o&&!r.boostUsed,X=!["GK","DEF","MIL","ATT"].some(le=>(C[le]||[]).some($e=>!$e.used)),V=[...I.MIL||[],...I.ATT||[]].filter(le=>!le.used),te=x&&X&&V.length===0?[...I.GK||[],...I.DEF||[]].filter(le=>!le.used).map(le=>le.cardId):[];function ae(le,$e,ee){var pt,ht;const ue=le._gcDef,Z={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ue==null?void 0:ue.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ce={purple:"#b06ce0",light_blue:"#00d4ef"}[ue==null?void 0:ue.color]||"#b06ce0",qe=(ue==null?void 0:ue.name)||le.gc_type,Ee=(ue==null?void 0:ue.effect)||((pt=Ke[le.gc_type])==null?void 0:pt.desc)||"",tt=ue!=null&&ue.image_url?`/manager-wars/icons/${ue.image_url}`:null,it=((ht=Ke[le.gc_type])==null?void 0:ht.icon)||"⚡",rt=Math.round(ee*.22),st=Math.round(ee*.22),ct=ee-rt-st,kt=qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${le.id}" data-gc-type="${le.gc_type}"
        style="box-sizing:border-box;width:${$e}px;height:${ee}px;border-radius:10px;border:2px solid ${ce};background:${Z};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${rt}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${kt}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${$e-6}px">${qe}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${ct}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${tt?`<img src="${tt}" style="max-width:${$e-10}px;max-height:${ct-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(ct*.55)}px">${it}</span>`}
        </div>
      ...
      </div>`}function fe(le,$e){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${le}px;height:${$e}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round($e*.04)}px;text-align:center;flex-shrink:0">
        <div style="font-size:${Math.round($e*.2)}px">⚡</div>
        <div style="font-size:${Math.round($e*.09)}px;color:#000;font-weight:900">+${r.boostValue}</div>
      </div>`}const me=(le,$e)=>$e?fe(130,175):ae(le,130,175),we=(le,$e)=>$e?fe(68,95):ae(le,68,95),_e=T?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Ce=x?be(o)?`<button id="pvp-action" style="${_e};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${h.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${_e};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:b?`<button id="pvp-action" style="${_e};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${h.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${m}</div>`,je=x&&!be(o)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':x||b?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${h.length}/3 sélectionné(s)</div>`:"",Re=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${T?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${S.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':S.map(le=>`<div class="pvp-sub-btn" data-sub-id="${le.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(le,T?76:44,T?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(I,r[o+"Formation"],Be,_,300,300,te)}
      </div>
    </div>`;function Fe(le){if(le.type==="duel"&&(le.homeTotal!=null||le.aiTotal!=null)){const $e=(le.homeTotal||0)>=(le.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-end;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
              ${(le.homePlayers||[]).map(ee=>dt(ee)).join("")}
            </div>
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
              <div style="font-size:${$e?20:14}px;font-weight:900;color:${$e?"#FFD700":"rgba(255,255,255,0.4)"};line-height:1">${le.homeTotal}</div>
              <div style="font-size:8px;color:rgba(255,255,255,0.3);margin:1px 0">VS</div>
              <div style="font-size:${$e?14:20}px;font-weight:900;color:${$e?"rgba(255,255,255,0.4)":"#ff6b6b"};line-height:1">${le.aiTotal}</div>
            </div>
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-start;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
              ${(le.aiPlayers||[]).map(ee=>dt(ee)).join("")}
            </div>
          </div>
          ${le.isGoal?`<div style="text-align:center;font-size:11px;color:#FFD700;font-weight:900;margin-top:3px">${le.homeScored,"⚽ BUT !"}</div>`:""}
        </div>`}return`<div style="font-size:11px;color:${le.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${le.type==="goal"?700:400};padding:3px 2px">${le.text||""}</div>`}const Ve=(()=>{var $e,ee;if(b&&(($e=r.pendingAttack)!=null&&$e.players)){const ue=r.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
        ...
        </div>`}if(x&&((ee=r.pendingAttack)!=null&&ee.players)){const ue=r.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          ${ot((ue.players||[]).map(Z=>({...Z,used:!1})),"#00ff88",ue.total)}
        </div>`}const le=(r.log||[]).slice(-1)[0];return le?'<div style="padding:2px 4px">'+Fe(le)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),Ne=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      </div>`;function He(){const le=e.querySelector(".match-screen");if(!le)return;const $e=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);le.style.height=$e+"px",le.style.minHeight=$e+"px",le.style.maxHeight=$e+"px",le.style.overflow="hidden";const ee=e.querySelector("#mobile-action-bar"),ue=e.querySelector("#mobile-play-area");ee&&ue&&(ue.style.paddingBottom=ee.offsetHeight+"px")}if(He(),setTimeout(He,120),setTimeout(He,400),L||(L=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",He),window.visualViewport.addEventListener("scroll",He)),window.addEventListener("resize",He)),function(){const $e=e.querySelector(".terrain-wrapper svg");$e&&($e.removeAttribute("width"),$e.removeAttribute("height"),$e.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",$e.setAttribute("viewBox","-26 -26 352 352"),$e.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(le=>{le.addEventListener("click",()=>{if(!x&&!b)return;const $e=le.dataset.cardId,ee=le.dataset.role,ue=(I[ee]||[]).find(Ee=>Ee.cardId===$e);if(!ue||ue.used)return;const Z=te.includes($e);if(x&&!["MIL","ATT"].includes(ee)&&!Z)return;Array.isArray(r["selected_"+o])||(r["selected_"+o]=[]);const ce=r["selected_"+o],qe=ce.findIndex(Ee=>Ee.cardId===$e);qe>-1?ce.splice(qe,1):ce.length<3&&ce.push({...ue,_role:ee}),G()})}),e.querySelectorAll(".match-used-hit").forEach(le=>{le.addEventListener("click",()=>Te(le.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(le=>{le.addEventListener("click",()=>Te())}),(Ue=e.querySelector("#pvp-sub-open"))==null||Ue.addEventListener("click",()=>Te()),e.querySelectorAll(".pvp-gc-mini").forEach(le=>{le.addEventListener("click",()=>ve(le.dataset.gcId,le.dataset.gcType))}),(Je=e.querySelector("#pvp-boost-card"))==null||Je.addEventListener("click",()=>ke()),(Ze=e.querySelector("#pvp-action"))==null||Ze.addEventListener("click",le=>{x?le.currentTarget.dataset.pass==="1"||!be(o)?ie():ge():b&&K()}),(Qe=e.querySelector("#pvp-quit"))==null||Qe.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&Q()}),(nt=e.querySelector("#pvp-view-opp"))==null||nt.addEventListener("click",()=>xe()),(gt=e.querySelector("#pvp-toggle-history"))==null||gt.addEventListener("click",()=>W()),M&&(clearInterval(M),M=null),(x||b)&&!u){let le=30,$e=!1;const ee=()=>document.getElementById("pvp-timer"),ue=()=>{ee()&&(ee().textContent=le+"s",ee().style.color=$e?"#ff4444":"#fff")};ue(),M=setInterval(()=>{le--,le<0?$e?(clearInterval(M),M=null,x&&!be(o)?ie():Q()):($e=!0,le=15,ue()):ue()},1e3)}}function oe(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
    </div>`,o==="p1"&&setTimeout(async()=>{await B({phase:"midfield"})},5e3)}let pe=!1;function ye(){if(pe)return;const I=r[o+"Team"].MIL||[],C=r[n+"Team"].MIL||[];function w(R){return R.reduce((O,X)=>O+Ie(X,"MIL"),0)}function k(R){let O=0;for(let X=0;X<R.length-1;X++){const V=at(R[X],R[X+1]);V==="#00ff88"?O+=2:V==="#FFD700"&&(O+=1)}return O}const f=w(I)+k(I),m=w(C)+k(C),x=f>=m;function b(R,O,X){return`<div id="duel-row-${X}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${R.map((V,te)=>{const ae=te<R.length-1?at(V,R[te+1]):null,fe=!ae||ae==="#ff3333"||ae==="#cc2222",me=ae==="#00ff88"?"+2":ae==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${X}" data-idx="${te}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...V,note:Ie(V,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${te<R.length-1?`<div class="duel-link duel-link-${X}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${fe?"rgba(255,255,255,0.12)":ae};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${fe?"none":`0 0 8px ${ae}`}">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${b(C,r[n+"Name"]||"Adversaire","opp")}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const h=(R,O)=>e.querySelectorAll(R).forEach((X,V)=>{setTimeout(()=>{X.style.opacity="1",X.style.transform="translateY(0) scale(1)"},O+V*90)});h(".duel-card-me",150),h(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((R,O)=>setTimeout(()=>{R.style.opacity="1"},O*70)),900),setTimeout(()=>{const R=e.querySelector("#pvp-vs");R&&(R.style.opacity="1",R.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(O=>O.style.opacity="1")},1250);function _(R,O,X){const V=document.getElementById(R);if(!V)return;const te=performance.now(),ae=fe=>{const me=Math.min(1,(fe-te)/X);V.textContent=Math.round(O*(1-Math.pow(1-me,3))),me<1?requestAnimationFrame(ae):V.textContent=O};requestAnimationFrame(ae)}setTimeout(()=>{_("pvp-score-me",f,800),_("pvp-score-opp",m,800)},1500);const T=r.p1Team.MIL||[],$=r.p2Team.MIL||[],A=w(T)+k(T),S=w($)+k($),q=A>=S?"p1":"p2";let D=r.boostValue;D==null&&(D=oi(),r.boostValue=D,r.boostOwner=q,r.boostUsed=!1),pe=!0,setTimeout(()=>{const R=e.querySelector("#duel-row-"+(x?"me":"opp")),O=e.querySelector("#duel-row-"+(x?"opp":"me")),X=document.getElementById("pvp-score-me"),V=document.getElementById("pvp-score-opp"),te=x?X:V,ae=x?V:X;te&&(te.style.fontSize="80px",te.style.color=x?"#FFD700":"#ff6b6b",te.style.animation="duelPulse .5s ease"+(x?",duelGlow 1.5s ease infinite .5s":"")),ae&&(ae.style.opacity="0.25"),setTimeout(()=>{R&&(R.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",R.style.zIndex="5"),setTimeout(()=>{const fe=document.getElementById("duel-shock");fe&&(fe.style.animation="shockwave .5s ease-out forwards"),O&&(O.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var _e;const fe=document.getElementById("pvp-duel-finale");if(!fe)return;const me=r.boostOwner===o?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+D+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",we=o==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;fe.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(x?"⚽ "+r[o+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+r[n+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+me+we,fe.style.transition="opacity .45s ease",fe.style.opacity="1",fe.style.pointerEvents="auto",(_e=document.getElementById("pvp-start-match"))==null||_e.addEventListener("click",async()=>{const Ce=q;await B({phase:Ce+"-attack",attacker:Ce,round:1,boostValue:D,boostUsed:!1,boostOwner:Ce})})},600)},700)},2800)}function Se(I,C,w,k,f){const m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const x=Array.from({length:10},(T,$)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${$%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][$%8]}</div>`).join(""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};m.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(m);let h=!1;const _=()=>{h||(h=!0,m.remove(),setTimeout(()=>f(),50))};m.addEventListener("click",_),setTimeout(_,3500)}function he(I,C,w){var D,R;const k=(r.gcDefs||[]).find(O=>{var X;return O.name===I||((X=O.name)==null?void 0:X.toLowerCase().trim())===(I==null?void 0:I.toLowerCase().trim())}),f={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[k==null?void 0:k.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",m={purple:"#b06ce0",light_blue:"#00d4ef"}[k==null?void 0:k.color]||"#b06ce0",x=(k==null?void 0:k.name)||I,b=(k==null?void 0:k.effect)||((D=Ke[I])==null?void 0:D.desc)||"",h=k!=null&&k.image_url?`/manager-wars/icons/${k.image_url}`:null,_=((R=Ke[I])==null?void 0:R.icon)||"⚡",$=C===o?"Vous":r[C+"Name"]||"Adversaire",A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",A.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(A);let S=!1;const q=()=>{S||(S=!0,A.remove(),setTimeout(()=>w&&w(),50))};A.addEventListener("click",q),setTimeout(q,3e3)}function ve(I,C){var A,S,q,D;const k=(r["gcCardsFull_"+o]||[]).find(R=>R.id===I),f=k==null?void 0:k._gcDef,m={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[f==null?void 0:f.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",x={purple:"#b06ce0",light_blue:"#00d4ef"}[f==null?void 0:f.color]||"#b06ce0",b=(f==null?void 0:f.name)||C,h=(f==null?void 0:f.effect)||((A=Ke[C])==null?void 0:A.desc)||"Carte spéciale.",_=f!=null&&f.image_url?`/manager-wars/icons/${f.image_url}`:null,T=((S=Ke[C])==null?void 0:S.icon)||"⚡",$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",$.innerHTML=`
      ...
      </div>`,document.body.appendChild($),(q=$.querySelector("#pvp-gc-back"))==null||q.addEventListener("click",()=>$.remove()),(D=$.querySelector("#pvp-gc-use"))==null||D.addEventListener("click",()=>{$.remove(),P(I,C)})}function ke(){var k;const I=r[o+"Team"],C=Object.entries(I).flatMap(([f,m])=>(m||[]).filter(x=>!x.used).map(x=>({...x,_line:f})));if(!C.length)return;const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",w.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${r.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${C.map(f=>{const m={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[f._line]||"#555",x=Ie(f,f._line)+(f.boost||0);return`<div class="bp-item" data-cid="${f.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${m};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(w),(k=w.querySelector("#bp-close"))==null||k.addEventListener("click",()=>w.remove()),w.querySelectorAll(".bp-item").forEach(f=>{f.addEventListener("click",async()=>{const m=f.dataset.cid,x=C.find(h=>h.cardId===m);if(!x)return;const b=(I[x._line]||[]).find(h=>h.cardId===m);b&&(b.boost=(b.boost||0)+r.boostValue),w.remove(),await B({[o+"Team"]:I,boostUsed:!0})})})}function Te(I=null){var S,q;if(!(r.phase===o+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const w=r[o+"Team"],k=r["usedSubIds_"+o]||[],f=r.maxSubs||3;if(k.length>=f){p(`Maximum ${f} remplacements atteint`,"warning");return}const m=Object.entries(w).flatMap(([D,R])=>(R||[]).filter(O=>O.used).map(O=>({...O,_line:D}))),x=(r[o+"Subs"]||[]).filter(D=>!k.includes(D.cardId));if(!m.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!x.length){p("Aucun remplaçant disponible","warning");return}let b=Math.max(0,m.findIndex(D=>D.cardId===I));const h=((S=m[b])==null?void 0:S._line)||((q=m[b])==null?void 0:q.job);let _=Math.max(0,x.findIndex(D=>D.job===h)),T=!1;const $=document.createElement("div");$.id="pvp-sub-overlay",$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function A(){var ae,fe,me,we,_e,Ce;const D=m[b],R=x[_],O=Math.min(130,Math.round((window.innerWidth-90)/2)),X=Math.round(O*1.35),V=je=>`background:rgba(255,255,255,0.12);border:none;color:${je?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${je?"default":"pointer"};flex-shrink:0`;$.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(ae=$.querySelector("#psub-close"))==null||ae.addEventListener("click",()=>$.remove()),(fe=$.querySelector("#pout-up"))==null||fe.addEventListener("click",()=>{b>0&&(b--,A())}),(me=$.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{b<m.length-1&&(b++,A())}),(we=$.querySelector("#pin-up"))==null||we.addEventListener("click",()=>{_>0&&(_--,A())}),(_e=$.querySelector("#pin-down"))==null||_e.addEventListener("click",()=>{_<x.length-1&&(_++,A())});const te=(je,Re,Be,Oe)=>{const Fe=$.querySelector("#"+je);if(!Fe)return;let Ve=0;Fe.addEventListener("touchstart",Ne=>{Ve=Ne.touches[0].clientY},{passive:!0}),Fe.addEventListener("touchend",Ne=>{const He=Ne.changedTouches[0].clientY-Ve;if(Math.abs(He)<30)return;const Ue=Re();He<0&&Ue<Oe-1?(Be(Ue+1),A()):He>0&&Ue>0&&(Be(Ue-1),A())},{passive:!0})};te("pin-panel",()=>_,je=>_=je,x.length),te("pout-panel",()=>b,je=>b=je,m.length),(Ce=$.querySelector("#psub-confirm"))==null||Ce.addEventListener("click",async je=>{if(je.preventDefault(),je.stopPropagation(),T)return;T=!0;const Re=m[b],Be=x[_];if(!Re||!Be)return;const Oe=Re._line,Fe=(w[Oe]||[]).findIndex(He=>He.cardId===Re.cardId);if(Fe===-1){p("Erreur : joueur introuvable","error"),$.remove();return}const Ve={...Be,_line:Oe,position:Re.position,used:!1,boost:0};w[Oe].splice(Fe,1,Ve);const Ne=[...k,Be.cardId];$.remove(),Le(Re,Be,async()=>{await B({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],["usedSubIds_"+o]:Ne})})})}document.body.appendChild($),A()}function Le(I,C,w){const k={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const m=(h,_,T)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(f);let x=!1;const b=()=>{x||(x=!0,f.remove(),setTimeout(()=>w(),50))};f.addEventListener("click",b),setTimeout(b,2200)}function xe(){var C;const I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",I.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${r[n+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(I),(C=I.querySelector("#pvp-opp-close"))==null||C.addEventListener("click",()=>I.remove())}function W(){var w;const I=r.log||[],C=document.createElement("div");C.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",C.innerHTML=`
      ...
      </div>`,document.body.appendChild(C),(w=C.querySelector("#pvp-hist-close"))==null||w.addEventListener("click",()=>C.remove())}async function ie(){if(r.phase!==o+"-attack")return;const I=o==="p1"?"p2":"p1",C=(r.round||0)+1,w=[...r.log||[]];w.push({type:"info",text:`⏭️ ${r[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const k=Ae(r),f=be(I),m=k||!f?"finished":I+"-attack";await B({["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:m,attacker:I,round:C,log:w}),m==="finished"&&await Me(r)}async function ge(){const I=r[o+"Team"],C=!["GK","DEF","MIL","ATT"].some(m=>(r[n+"Team"][m]||[]).some(x=>!x.used)),w=(r["selected_"+o]||[]).map(m=>{const x=(I[m._role]||[]).find(A=>A.cardId===m.cardId)||m,b=C&&["GK","DEF"].includes(m._role),h=I[m._role]||[],_=h.findIndex(A=>A.cardId===m.cardId),T=lt(h.length),$=_>=0?T[_]:x._col??1;return{...x,_line:m._role,_col:$,...b?{note_a:Math.max(1,Number(x.note_a)||0)}:{}}});if(!w.length)return;const k=Nt(w,r.modifiers[o]||{});J(o,w.map(m=>m.cardId)),w.forEach(m=>{const x=(I[m._role]||[]).find(b=>b.cardId===m.cardId);x&&(x.used=!0)}),r["selected_"+o]=[],G();const f=[...r.log||[]];if(C){const m=(r[o+"Score"]||0)+1,x=w.map($=>({name:$.name,note:Ie($,$._line||"ATT"),portrait:Pe($),job:$.job}));f.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:x,homeTotal:k.total,aiTotal:0});const b=(r.round||0)+1,h=o==="p1"?"p2":"p1",_={...r,[o+"Team"]:I,[o+"Score"]:m},T=Ae(_);N.add(b),Se(x,m,r[n+"Score"]||0,!0,async()=>{await B({[o+"Team"]:I,[o+"Score"]:m,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:T?"finished":h+"-attack",attacker:h,round:b,log:f}),T&&await Me({...r,[o+"Score"]:m})});return}f.push({type:"pending",text:`⚔️ ${r[o+"Name"]} attaque (${k.total})`}),await B({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],pendingAttack:{...k,players:w,side:o},["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},phase:n+"-defense",log:f})}async function K(){const I=r[o+"Team"],C=(r["selected_"+o]||[]).map(D=>{const R=(I[D._role]||[]).find(ae=>ae.cardId===D.cardId)||D,O=I[D._role]||[],X=O.findIndex(ae=>ae.cardId===D.cardId),V=lt(O.length),te=X>=0?V[X]:R._col??1;return{...R,_line:D._role,_col:te}}),w=Rt(C,r.modifiers[o]||{});J(o,C.map(D=>D.cardId)),C.forEach(D=>{const R=(I[D._role]||[]).find(O=>O.cardId===D.cardId);R&&(R.used=!0)}),r["selected_"+o]=[],G();const k=Ot(r.pendingAttack.total,w.total,r.modifiers[o]||{}),f=r.pendingAttack.side,m=k==="attack"||(k==null?void 0:k.goal),x=f==="p1"?"p2":"p1",b=(r.round||0)+1,h=(r.pendingAttack.players||[]).map(D=>({name:D.name,note:Ie(D,D._line||"ATT"),portrait:Pe(D),job:D.job})),_=[...r.log||[]];_.push({type:"duel",isGoal:m,homeScored:m&&f===o,text:m?`⚽ BUT de ${r[f+"Name"]} ! (${r.pendingAttack.total} vs ${w.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${w.total})`,homePlayers:h,aiPlayers:C.map(D=>({name:D.name,note:Ie(D,D._line||"DEF"),portrait:Pe(D),job:D.job})),homeTotal:r.pendingAttack.total,aiTotal:w.total});const T=m?(r[f+"Score"]||0)+1:r[f+"Score"]||0,$={...r,[o+"Team"]:I,[f+"Score"]:T},A=Ae($),S=A?"finished":x+"-attack",q=async()=>{await B({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],[f+"Score"]:T,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:S,attacker:x,round:b,log:_}),(S==="finished"||A)&&await Me({...r,[f+"Score"]:T})};if(m){const D=f===o,R=D?T:r[o+"Score"]||0,O=D?r[n+"Score"]||0:T;N.add(b),Se(h,R,O,D,q)}else await q()}function ne(I){return["MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function U(I){return["GK","DEF","MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function re(I){return U(I)&&!ne(I)}function be(I){const C=r[I+"Team"],w=r[(I==="p1"?"p2":"p1")+"Team"];return!!(ne(C)||!U(w)&&re(C))}function Ae(I){const C=["MIL","ATT"].some(_=>(I.p1Team[_]||[]).some(T=>!T.used)),w=["MIL","ATT"].some(_=>(I.p2Team[_]||[]).some(T=>!T.used)),k=U(I.p1Team),f=U(I.p2Team);return!C&&!(!f&&k)&&(!w&&!(!k&&f))}function ze(I){const C=I.p1Score||0,w=I.p2Score||0;return C===w?null:C>w?y.home_id:y.away_id}async function Me(I){try{const C=ze(I),w=C?y.home_id===C?y.away_id:y.home_id:null;await E.from("matches").update({status:"finished",winner_id:C,home_score:I.p1Score||0,away_score:I.p2Score||0}).eq("id",i),C&&w&&updateEvolutiveCards(C,w).catch(()=>{})}catch(C){console.error("[PvP] finishMatch:",C)}}function De(){var f;const I=r[o+"Score"],C=r[n+"Score"],w=I>C,k=I===C;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(A=b.querySelector("#pvp-end-home"))==null||A.addEventListener("click",()=>{b.remove(),We(e),l("home")})}const Q=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{const k=w.new;try{if(k.status==="finished"||k.forfeit){if(u)return;u=!0,N&&(clearInterval(N),N=null),k.game_state&&(r=k.game_state),B(k);return}if(k.game_state){const f=r;r=k.game_state;const m=r._lastGC;if(m&&m.seq&&!F.has(m.seq)&&(F.add(m.seq),m.by!==o)){ke(m.type,m.by,()=>pe());return}const x=f[o+"Score"]||0,b=f[n+"Score"]||0,h=r[o+"Score"]||0,_=r[n+"Score"]||0,T=h>x,$=_>b;if((T||$)&&!j.has(r.round)){j.add(r.round);const A=[...r.log||[]].reverse().find(q=>q.isGoal),S=((A==null?void 0:A.homePlayers)||[]).map(q=>({name:q.name,note:q.note,portrait:q.portrait,job:q.job}));ve(S,h,_,T,()=>pe());return}pe()}}catch(f){console.error("[PvP] crash:",f)}}).subscribe();async function de(w){Object.assign(r,w),r.lastActionAt=new Date().toISOString();const{error:k}=await E.from("matches").update({game_state:r}).eq("id",i);k&&p("Erreur de synchronisation","error");try{pe()}catch(f){console.error("[PvP] renderPvpScreen crash:",f)}}async function se(){if(u)return;u=!0,N&&(clearInterval(N),N=null);const w=s?y.away_id:y.home_id,k=s?"p2":"p1",f=s?"p1":"p2",m={...r,[k+"Score"]:3,[f+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:w,home_score:m.p1Score||0,away_score:m.p2Score||0,game_state:m}).eq("id",i)}catch{}try{E.removeChannel(Q)}catch{}setTimeout(()=>{We(e),l("home")},800)}const P={BOOST_STAT:({value:w=1,count:k=1,roles:f=[]},m,x)=>{const b=m[o+"Team"],h=Object.entries(b).filter(([_])=>!f.length||f.includes(_)).flatMap(([_,T])=>T.filter($=>!$.used).map($=>({...$,_line:_})));if(!h.length){m.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),x(m);return}J(h,k,`Choisir ${k} joueur(s) à booster (+${w})`,_=>{_.forEach(T=>{const $=(b[T._line]||[]).find(A=>A.cardId===T.cardId);$&&($.boost=($.boost||0)+w,m.log.push({text:`⚡ +${w} sur ${$.name}`,type:"info"}))}),m[o+"Team"]=b,x(m)})},DEBUFF_STAT:({value:w=1,count:k=1,roles:f=[],target:m="ai"},x,b)=>{const h=m==="home"?o:n,_=x[h+"Team"],T=m==="home"?"allié":"adverse",$=Object.entries(_).filter(([A])=>!f.length||f.includes(A)).flatMap(([A,S])=>S.map(q=>({...q,_line:A})));if(!$.length){x.log.push({text:`🎯 Aucun joueur ${T}`,type:"info"}),b(x);return}J($,k,`Choisir ${k} joueur(s) ${T}(s) (-${w})`,A=>{A.forEach(S=>{const q=(_[S._line]||[]).find(D=>D.cardId===S.cardId);q&&(q.boost=(q.boost||0)-w,x.log.push({text:`🎯 -${w} sur ${q.name}`,type:"info"}))}),x[h+"Team"]=_,b(x)})},GRAY_PLAYER:({count:w=1,roles:k=[],target:f="ai"},m,x)=>{const b=f==="home"?o:n,h=m[b+"Team"],_=f==="home"?"allié":"adverse",T=Object.entries(h).filter(([$])=>!k.length||k.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!T.length){m.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),x(m);return}J(T,w,`Choisir ${w} joueur(s) ${_}(s) à exclure`,$=>{const A="usedCardIds_"+b,S=new Set(m[A]||[]);$.forEach(q=>{const D=(h[q._line]||[]).find(R=>R.cardId===q.cardId);D&&(D.used=!0,S.add(q.cardId),m.log.push({text:`❌ ${D.name} exclu !`,type:"info"}))}),m[A]=[...S],m[b+"Team"]=h,x(m)})},REVIVE_PLAYER:({count:w=1,roles:k=[]},f,m)=>{const x=f[o+"Team"],b=Object.entries(x).filter(([h])=>!k.length||k.includes(h)).flatMap(([h,_])=>_.filter(T=>T.used).map(T=>({...T,_line:h})));if(!b.length){f.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),m(f);return}J(b,w,`Choisir ${w} joueur(s) à ressusciter`,h=>{h.forEach(_=>{const T=(x[_._line]||[]).find($=>$.cardId===_.cardId);T&&(T.used=!1,f.log.push({text:`💫 ${T.name} ressuscité !`,type:"info"}))}),f[o+"Team"]=x,m(f)})},REMOVE_GOAL:({},w,k)=>{const f=n+"Score";w[f]>0?(w[f]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),k(w)},ADD_GOAL_DRAW:({},w,k)=>{w[o+"Score"]===w[n+"Score"]?(w[o+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),k(w)},ADD_SUB:({value:w=1},k,f)=>{k.maxSubs=(k.maxSubs||3)+w,k.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),f(k)},CUSTOM:({},w,k)=>k(w)};function J(w,k,f,m){const x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function h(){var T,$;const _=w.map(A=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",q=Ie(A,A._line)+(A.boost||0),R=b.find(X=>X.cardId===A.cardId)?"#FFD700":"rgba(255,255,255,0.25)",O=A.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${R};background:${S};overflow:hidden;cursor:pointer;${O}">
        ...
        </div>`,(T=x.querySelector("#pp-close"))==null||T.addEventListener("click",()=>x.remove()),x.querySelectorAll(".pp-item").forEach(A=>{A.addEventListener("click",()=>{const S=A.dataset.cid,q=w.find(R=>R.cardId===S),D=b.findIndex(R=>R.cardId===S);q&&(D>-1?b.splice(D,1):b.length<k&&b.push(q),h())})}),($=x.querySelector("#pp-confirm"))==null||$.addEventListener("click",()=>{x.remove(),m(b)})}h(),document.body.appendChild(x)}async function H(w,k){const m=(r["gcCardsFull_"+o]||[]).find(_=>_.id===w),x=(m==null?void 0:m._gcDef)||(r.gcDefs||[]).find(_=>{var T;return _.name===k||((T=_.name)==null?void 0:T.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),b=[...r["usedGc_"+o]||[],w],h={type:k,by:o,seq:(r._gcAnimSeq||0)+1};F.add(h.seq),ke(k,o,async()=>{if(x!=null&&x.effect_type&&x.effect_type!=="CUSTOM"){const T=P[x.effect_type];if(T){const $={...r};T(x.effect_params||{},$,async A=>{A["usedGc_"+o]=b,A._lastGC=h,A._gcAnimSeq=h.seq,await de(A)});return}}const _={...r};switch(k){case"Remplacement+":_.maxSubs=(_.maxSubs||3)+1,_.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const T=n+"Score";_[T]>0&&(_[T]--,_.log.push({text:"🚫 But annulé",type:"info"}));break}}_["usedGc_"+o]=b,_._lastGC=h,_._gcAnimSeq=h.seq,await de(_)})}function G(w,k){const f="usedCardIds_"+w,m=new Set(r[f]||[]);k.forEach(x=>m.add(x)),r[f]=[...m]}function oe(){for(const w of["p1","p2"]){const k=new Set(r["usedCardIds_"+w]||[]),f=r[w+"Team"];if(f)for(const m of["GK","DEF","MIL","ATT"])(f[m]||[]).forEach(x=>{x.used=k.has(x.cardId)})}}function pe(){var Ze,Qe,nt,gt,le,$e;if(r.phase==="reveal")return ye();if(r.phase==="midfield")return he();if(r.phase==="finished")return C();const w=r[o+"Team"],k=r[n+"Team"];oe();const f=r[o+"Score"],m=r[n+"Score"],x=r[o+"Name"],b=r[n+"Name"],h=r.phase===o+"-attack",_=r.phase===o+"-defense",T=Array.isArray(r["selected_"+o])?r["selected_"+o]:[],$=T.map(ee=>ee.cardId),A=window.innerWidth>=700,S=r[o+"Subs"]||[],q=r["usedSubIds_"+o]||[],D=S.filter(ee=>!q.includes(ee.cardId)),R=r["gcCardsFull_"+o]||[],O=r["usedGc_"+o]||[],X=R.filter(ee=>!O.includes(ee.id)),V=r.boostOwner===o&&!r.boostUsed,te=!["GK","DEF","MIL","ATT"].some(ee=>(k[ee]||[]).some(ue=>!ue.used)),ae=[...w.MIL||[],...w.ATT||[]].filter(ee=>!ee.used),fe=h&&te&&ae.length===0?[...w.GK||[],...w.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function me(ee,ue,Z){var Et,Ut;const ce=ee._gcDef,qe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ee={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",tt=(ce==null?void 0:ce.name)||ee.gc_type,it=(ce==null?void 0:ce.effect)||((Et=Ke[ee.gc_type])==null?void 0:Et.desc)||"",rt=ce!=null&&ce.image_url?`/manager-wars/icons/${ce.image_url}`:null,st=((Ut=Ke[ee.gc_type])==null?void 0:Ut.icon)||"⚡",ct=Math.round(Z*.22),kt=Math.round(Z*.22),pt=Z-ct-kt,ht=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
        style="box-sizing:border-box;width:${ue}px;height:${Z}px;border-radius:10px;border:2px solid ${Ee};background:${qe};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      </div>`}function we(ee,ue){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${ee}px;height:${ue}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(ue*.04)}px;text-align:center;flex-shrink:0">
      ...
      </div>`}const _e=(ee,ue)=>ue?we(130,175):me(ee,130,175),Ce=(ee,ue)=>ue?we(68,95):me(ee,68,95),je=A?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Re=h?ze(o)?`<button id="pvp-action" style="${je};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${T.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${je};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:_?`<button id="pvp-action" style="${je};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${T.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${b}</div>`,Be=h&&!ze(o)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':h||_?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${T.length}/3 sélectionné(s)</div>`:"",Oe=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${A?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${D.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':D.map(ee=>`<div class="pvp-sub-btn" data-sub-id="${ee.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(ee,A?76:44,A?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(w,r[o+"Formation"],Fe,$,300,300,fe)}
      </div>
    </div>`;function Ne(ee){if(ee.type==="duel"&&(ee.homeTotal!=null||ee.aiTotal!=null)){const ue=(ee.homeTotal||0)>=(ee.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            ...
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
              <div style="font-size:${ue?20:14}px;font-weight:900;color:${ue?"#FFD700":"rgba(255,255,255,0.4)"};line-height:1">${ee.homeTotal}</div>
              <div style="font-size:8px;color:rgba(255,255,255,0.3);margin:1px 0">VS</div>
              <div style="font-size:${ue?14:20}px;font-weight:900;color:${ue?"rgba(255,255,255,0.4)":"#ff6b6b"};line-height:1">${ee.aiTotal}</div>
            </div>
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-start;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
          ...
          ${ot((ce.players||[]).map(qe=>({...qe,used:!1})),"#ff6b6b",ce.total)}
        </div>`}if(h&&((Z=r.pendingAttack)!=null&&Z.players)){const ce=r.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          ${ot((ce.players||[]).map(qe=>({...qe,used:!1})),"#00ff88",ce.total)}
        </div>`}const ee=(r.log||[]).slice(-1)[0];return ee?'<div style="padding:2px 4px">'+Ne(ee)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),Ue=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
        <button id="pvp-quit" style="width:34px;height:34px;border-radius:50%;background:rgba(220,50,50,0.7);border:none;color:#fff;font-size:16px;cursor:pointer;flex-shrink:0">✕</button>
        <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px">
      ...
      </div>`;function Je(){const ee=e.querySelector(".match-screen");if(!ee)return;const ue=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ee.style.height=ue+"px",ee.style.minHeight=ue+"px",ee.style.maxHeight=ue+"px",ee.style.overflow="hidden";const Z=e.querySelector("#mobile-action-bar"),ce=e.querySelector("#mobile-play-area");Z&&ce&&(ce.style.paddingBottom=Z.offsetHeight+"px")}if(Je(),setTimeout(Je,120),setTimeout(Je,400),Y||(Y=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Je),window.visualViewport.addEventListener("scroll",Je)),window.addEventListener("resize",Je)),function(){const ue=e.querySelector(".terrain-wrapper svg");ue&&(ue.removeAttribute("width"),ue.removeAttribute("height"),ue.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ue.setAttribute("viewBox","-26 -26 352 352"),ue.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(ee=>{ee.addEventListener("click",()=>{if(!h&&!_)return;const ue=ee.dataset.cardId,Z=ee.dataset.role,ce=(w[Z]||[]).find(it=>it.cardId===ue);if(!ce||ce.used)return;const qe=fe.includes(ue);if(h&&!["MIL","ATT"].includes(Z)&&!qe)return;Array.isArray(r["selected_"+o])||(r["selected_"+o]=[]);const Ee=r["selected_"+o],tt=Ee.findIndex(it=>it.cardId===ue);tt>-1?Ee.splice(tt,1):Ee.length<3&&Ee.push({...ce,_role:Z}),pe()})}),e.querySelectorAll(".match-used-hit").forEach(ee=>{ee.addEventListener("click",()=>xe(ee.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ee=>{ee.addEventListener("click",()=>xe())}),(Ze=e.querySelector("#pvp-sub-open"))==null||Ze.addEventListener("click",()=>xe()),e.querySelectorAll(".pvp-gc-mini").forEach(ee=>{ee.addEventListener("click",()=>Te(ee.dataset.gcId,ee.dataset.gcType))}),(Qe=e.querySelector("#pvp-boost-card"))==null||Qe.addEventListener("click",()=>Le()),(nt=e.querySelector("#pvp-action"))==null||nt.addEventListener("click",ee=>{h?ee.currentTarget.dataset.pass==="1"||!ze(o)?K():ne():_&&U()}),(gt=e.querySelector("#pvp-quit"))==null||gt.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&se()}),(le=e.querySelector("#pvp-view-opp"))==null||le.addEventListener("click",()=>ie()),($e=e.querySelector("#pvp-toggle-history"))==null||$e.addEventListener("click",()=>ge()),N&&(clearInterval(N),N=null),(h||_)&&!u){let ee=30,ue=!1;const Z=()=>document.getElementById("pvp-timer"),ce=()=>{Z()&&(Z().textContent=ee+"s",Z().style.color=ue?"#ff4444":"#fff")};ce(),N=setInterval(()=>{ee--,ee<0?ue?(clearInterval(N),N=null,h&&!ze(o)?K():se()):(ue=!0,ee=15,ce()):ce()},1e3)}}function ye(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      <div style="font-size:20px;font-weight:900;color:#ff6b6b">${r[n+"Name"]||"Adversaire"}</div>
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
    </div>`,o==="p1"&&setTimeout(async()=>{await de({phase:"midfield"})},5e3)}let Se=!1;function he(){if(Se)return;const w=r[o+"Team"].MIL||[],k=r[n+"Team"].MIL||[];function f(X){return X.reduce((V,te)=>V+Ie(te,"MIL"),0)}function m(X){let V=0;for(let te=0;te<X.length-1;te++){const ae=at(X[te],X[te+1]);ae==="#00ff88"?V+=2:ae==="#FFD700"&&(V+=1)}return V}const x=f(w)+m(w),b=f(k)+m(k),h=x>=b;function _(X,V,te){return`<div id="duel-row-${te}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${X.map((ae,fe)=>{const me=fe<X.length-1?at(ae,X[fe+1]):null,we=!me||me==="#ff3333"||me==="#cc2222",_e=me==="#00ff88"?"+2":me==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${te}" data-idx="${fe}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...ae,note:Ie(ae,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${fe<X.length-1?`<div class="duel-link duel-link-${te}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${we?"rgba(255,255,255,0.12)":me};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${we?"none":`0 0 8px ${me}`}">
              ${_e?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${me}">${_e}</span>`:""}
            </div>`:""}`}).join("")}
        </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const T=(X,V)=>e.querySelectorAll(X).forEach((te,ae)=>{setTimeout(()=>{te.style.opacity="1",te.style.transform="translateY(0) scale(1)"},V+ae*90)});T(".duel-card-me",150),T(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((X,V)=>setTimeout(()=>{X.style.opacity="1"},V*70)),900),setTimeout(()=>{const X=e.querySelector("#pvp-vs");X&&(X.style.opacity="1",X.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(V=>V.style.opacity="1")},1250);function $(X,V,te){const ae=document.getElementById(X);if(!ae)return;const fe=performance.now(),me=we=>{const _e=Math.min(1,(we-fe)/te);ae.textContent=Math.round(V*(1-Math.pow(1-_e,3))),_e<1?requestAnimationFrame(me):ae.textContent=V};requestAnimationFrame(me)}setTimeout(()=>{$("pvp-score-me",x,800),$("pvp-score-opp",b,800)},1500);const A=r.p1Team.MIL||[],S=r.p2Team.MIL||[],q=f(A)+m(A),D=f(S)+m(S),R=q>=D?"p1":"p2";let O=r.boostValue;O==null&&(O=oi(),r.boostValue=O,r.boostOwner=R,r.boostUsed=!1),Se=!0,setTimeout(()=>{const X=e.querySelector("#duel-row-"+(h?"me":"opp")),V=e.querySelector("#duel-row-"+(h?"opp":"me")),te=document.getElementById("pvp-score-me"),ae=document.getElementById("pvp-score-opp"),fe=h?te:ae,me=h?ae:te;fe&&(fe.style.fontSize="80px",fe.style.color=h?"#FFD700":"#ff6b6b",fe.style.animation="duelPulse .5s ease"+(h?",duelGlow 1.5s ease infinite .5s":"")),me&&(me.style.opacity="0.25"),setTimeout(()=>{X&&(X.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",X.style.zIndex="5"),setTimeout(()=>{const we=document.getElementById("duel-shock");we&&(we.style.animation="shockwave .5s ease-out forwards"),V&&(V.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var je;const we=document.getElementById("pvp-duel-finale");if(!we)return;const _e=r.boostOwner===o?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+O+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ce=o==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;we.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(h?"⚽ "+r[o+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+r[n+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+_e+Ce,we.style.transition="opacity .45s ease",we.style.opacity="1",we.style.pointerEvents="auto",(je=document.getElementById("pvp-start-match"))==null||je.addEventListener("click",async()=>{const Re=R;await de({phase:Re+"-attack",attacker:Re,round:1,boostValue:O,boostUsed:!1,boostOwner:Re})})},600)},700)},2800)}function ve(w,k,f,m,x){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const h=Array.from({length:10},(A,S)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${S%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][S%8]}</div>`).join(""),_={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};b.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(b);let T=!1;const $=()=>{T||(T=!0,b.remove(),setTimeout(()=>x(),50))};b.addEventListener("click",$),setTimeout($,3500)}function ke(w,k,f){var O,X;const m=(r.gcDefs||[]).find(V=>{var te;return V.name===w||((te=V.name)==null?void 0:te.toLowerCase().trim())===(w==null?void 0:w.toLowerCase().trim())}),x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[m==null?void 0:m.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[m==null?void 0:m.color]||"#b06ce0",h=(m==null?void 0:m.name)||w,_=(m==null?void 0:m.effect)||((O=Ke[w])==null?void 0:O.desc)||"",T=m!=null&&m.image_url?`/manager-wars/icons/${m.image_url}`:null,$=((X=Ke[w])==null?void 0:X.icon)||"⚡",S=k===o?"Vous":r[k+"Name"]||"Adversaire",q=document.createElement("div");q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",q.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      </div>`,document.body.appendChild(f),(m=f.querySelector("#bp-close"))==null||m.addEventListener("click",()=>f.remove()),f.querySelectorAll(".bp-item").forEach(x=>{x.addEventListener("click",async()=>{const b=x.dataset.cid,h=k.find(T=>T.cardId===b);if(!h)return;const _=(w[h._line]||[]).find(T=>T.cardId===b);_&&(_.boost=(_.boost||0)+r.boostValue),f.remove(),await de({[o+"Team"]:w,boostUsed:!0})})})}function xe(w=null){var D,R;if(!(r.phase===o+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const f=r[o+"Team"],m=r["usedSubIds_"+o]||[],x=r.maxSubs||3;if(m.length>=x){p(`Maximum ${x} remplacements atteint`,"warning");return}const b=Object.entries(f).flatMap(([O,X])=>(X||[]).filter(V=>V.used).map(V=>({...V,_line:O}))),h=(r[o+"Subs"]||[]).filter(O=>!m.includes(O.cardId));if(!b.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!h.length){p("Aucun remplaçant disponible","warning");return}let _=Math.max(0,b.findIndex(O=>O.cardId===w));const T=((D=b[_])==null?void 0:D._line)||((R=b[_])==null?void 0:R.job);let $=Math.max(0,h.findIndex(O=>O.job===T)),A=!1;const S=document.createElement("div");S.id="pvp-sub-overlay",S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function q(){var me,we,_e,Ce,je,Re;const O=b[_],X=h[$],V=Math.min(130,Math.round((window.innerWidth-90)/2)),te=Math.round(V*1.35),ae=Be=>`background:rgba(255,255,255,0.12);border:none;color:${Be?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Be?"default":"pointer"};flex-shrink:0`;S.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${X?Ye({...X,used:!1,boost:0},V,te):"<div>—</div>"}</div>
          <button id="pin-down" style="${ae($>=h.length-1)}" ${$>=h.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${$+1}/${h.length}</div>
        </div>
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          <div style="font-size:9px;color:#ff6b6b;letter-spacing:2px;text-transform:uppercase;font-weight:700">Joueur qui sort</div>
          <button id="pout-up" style="${ae(_===0)}" ${_===0?"disabled":""}>▲</button>
          <div>${O?Ye({...O,used:!1,boost:0},V,te):"<div>—</div>"}</div>
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(me=S.querySelector("#psub-close"))==null||me.addEventListener("click",()=>S.remove()),(we=S.querySelector("#pout-up"))==null||we.addEventListener("click",()=>{_>0&&(_--,q())}),(_e=S.querySelector("#pout-down"))==null||_e.addEventListener("click",()=>{_<b.length-1&&(_++,q())}),(Ce=S.querySelector("#pin-up"))==null||Ce.addEventListener("click",()=>{$>0&&($--,q())}),(je=S.querySelector("#pin-down"))==null||je.addEventListener("click",()=>{$<h.length-1&&($++,q())});const fe=(Be,Oe,Fe,Ve)=>{const Ne=S.querySelector("#"+Be);if(!Ne)return;let He=0;Ne.addEventListener("touchstart",Ue=>{He=Ue.touches[0].clientY},{passive:!0}),Ne.addEventListener("touchend",Ue=>{const Je=Ue.changedTouches[0].clientY-He;if(Math.abs(Je)<30)return;const Ze=Oe();Je<0&&Ze<Ve-1?(Fe(Ze+1),q()):Je>0&&Ze>0&&(Fe(Ze-1),q())},{passive:!0})};fe("pin-panel",()=>$,Be=>$=Be,h.length),fe("pout-panel",()=>_,Be=>_=Be,b.length),(Re=S.querySelector("#psub-confirm"))==null||Re.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),A)return;A=!0;const Oe=b[_],Fe=h[$];if(!Oe||!Fe)return;const Ve=Oe._line,Ne=(f[Ve]||[]).findIndex(Je=>Je.cardId===Oe.cardId);if(Ne===-1){p("Erreur : joueur introuvable","error"),S.remove();return}const He={...Fe,_line:Ve,position:Oe.position,used:!1,boost:0};f[Ve].splice(Ne,1,He);const Ue=[...m,Fe.cardId];S.remove(),W(Oe,Fe,async()=>{await de({[o+"Team"]:f,[n+"Team"]:r[n+"Team"],["usedSubIds_"+o]:Ue})})})}document.body.appendChild(S),q()}function W(w,k,f){const m={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const b=(T,$,A)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(x);let h=!1;const _=()=>{h||(h=!0,x.remove(),setTimeout(()=>f(),50))};x.addEventListener("click",_),setTimeout(_,2200)}function ie(){var k;const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",w.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${r[n+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(w),(k=w.querySelector("#pvp-opp-close"))==null||k.addEventListener("click",()=>w.remove())}function ge(){var m;const w=r.log||[],k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const f=x=>{var h,_,T;if(x.type==="duel"){const $=x.isGoal,A=x.homeScored&&o==="p1"||!x.homeScored&&$&&o==="p2",S=x.homeScored?"#FFD700":$?"#ff6b6b":"rgba(255,255,255,0.3)",q=$?A?"⚽ BUT !":"⚽ BUT adversaire !":(h=x.homePlayers)!=null&&h.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${$?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${S};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild(k),(m=k.querySelector("#pvp-hist-close"))==null||m.addEventListener("click",()=>k.remove())}async function K(){if(r.phase!==o+"-attack")return;const w=o==="p1"?"p2":"p1",k=(r.round||0)+1,f=[...r.log||[]];f.push({type:"info",text:`⏭️ ${r[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const m=Me(r),x=ze(w),b=m||!x?"finished":w+"-attack";await de({["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:b,attacker:w,round:k,log:f}),b==="finished"&&await I(r)}async function ne(){const w=r[o+"Team"],k=!["GK","DEF","MIL","ATT"].some(b=>(r[n+"Team"][b]||[]).some(h=>!h.used)),f=(r["selected_"+o]||[]).map(b=>{const h=(w[b._role]||[]).find(q=>q.cardId===b.cardId)||b,_=k&&["GK","DEF"].includes(b._role),T=w[b._role]||[],$=T.findIndex(q=>q.cardId===b.cardId),A=lt(T.length),S=$>=0?A[$]:h._col??1;return{...h,_line:b._role,_col:S,..._?{note_a:Math.max(1,Number(h.note_a)||0)}:{}}});if(!f.length)return;const m=Nt(f,r.modifiers[o]||{});G(o,f.map(b=>b.cardId)),f.forEach(b=>{const h=(w[b._role]||[]).find(_=>_.cardId===b.cardId);h&&(h.used=!0)}),r["selected_"+o]=[],pe();const x=[...r.log||[]];if(k){const b=(r[o+"Score"]||0)+1,h=f.map(S=>({name:S.name,note:Ie(S,S._line||"ATT"),portrait:Pe(S),job:S.job}));x.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:h,homeTotal:m.total,aiTotal:0});const _=(r.round||0)+1,T=o==="p1"?"p2":"p1",$={...r,[o+"Team"]:w,[o+"Score"]:b},A=Me($);j.add(_),ve(h,b,r[n+"Score"]||0,!0,async()=>{await de({[o+"Team"]:w,[o+"Score"]:b,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:A?"finished":T+"-attack",attacker:T,round:_,log:x}),A&&await I({...r,[o+"Score"]:b})});return}x.push({type:"pending",text:`⚔️ ${r[o+"Name"]} attaque (${m.total})`}),await de({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],pendingAttack:{...m,players:f,side:o},["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},phase:n+"-defense",log:x})}async function U(){const w=r[o+"Team"],k=(r["selected_"+o]||[]).map(O=>{const X=(w[O._role]||[]).find(me=>me.cardId===O.cardId)||O,V=w[O._role]||[],te=V.findIndex(me=>me.cardId===O.cardId),ae=lt(V.length),fe=te>=0?ae[te]:X._col??1;return{...X,_line:O._role,_col:fe}}),f=Rt(k,r.modifiers[o]||{});G(o,k.map(O=>O.cardId)),k.forEach(O=>{const X=(w[O._role]||[]).find(V=>V.cardId===O.cardId);X&&(X.used=!0)}),r["selected_"+o]=[],pe();const m=Ot(r.pendingAttack.total,f.total,r.modifiers[o]||{}),x=r.pendingAttack.side,b=m==="attack"||(m==null?void 0:m.goal),h=x==="p1"?"p2":"p1",_=(r.round||0)+1,T=(r.pendingAttack.players||[]).map(O=>({name:O.name,note:Ie(O,O._line||"ATT"),portrait:Pe(O),job:O.job})),$=[...r.log||[]];$.push({type:"duel",isGoal:b,homeScored:b&&x===o,text:b?`⚽ BUT de ${r[x+"Name"]} ! (${r.pendingAttack.total} vs ${f.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${f.total})`,homePlayers:T,aiPlayers:k.map(O=>({name:O.name,note:Ie(O,O._line||"DEF"),portrait:Pe(O),job:O.job})),homeTotal:r.pendingAttack.total,aiTotal:f.total});const A=b?(r[x+"Score"]||0)+1:r[x+"Score"]||0,S={...r,[o+"Team"]:w,[x+"Score"]:A},q=Me(S),D=q?"finished":h+"-attack",R=async()=>{await de({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],[x+"Score"]:A,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:D,attacker:h,round:_,log:$}),(D==="finished"||q)&&await I({...r,[x+"Score"]:A})};if(b){const O=x===o,X=O?A:r[o+"Score"]||0,V=O?r[n+"Score"]||0:A;j.add(_),ve(T,X,V,O,R)}else await R()}function re(w){return["MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function be(w){return["GK","DEF","MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function Ae(w){return be(w)&&!re(w)}function ze(w){const k=r[w+"Team"],f=r[(w==="p1"?"p2":"p1")+"Team"];return!!(re(k)||!be(f)&&Ae(k))}function Me(w){const k=["MIL","ATT"].some($=>(w.p1Team[$]||[]).some(A=>!A.used)),f=["MIL","ATT"].some($=>(w.p2Team[$]||[]).some(A=>!A.used)),m=be(w.p1Team),x=be(w.p2Team);return!k&&!(!x&&m)&&(!f&&!(!m&&x))}function De(w){const k=w.p1Score||0,f=w.p2Score||0;return k===f?null:k>f?y.home_id:y.away_id}async function I(w){try{const k=De(w),f=k?y.home_id===k?y.away_id:y.home_id:null;await E.from("matches").update({status:"finished",winner_id:k,home_score:w.p1Score||0,away_score:w.p2Score||0}).eq("id",i),k&&f&&ki(k,f).catch(()=>{})}catch(k){console.error("[PvP] finishMatch:",k)}}function C(){var x;const w=r[o+"Score"],k=r[n+"Score"],f=w>k,m=w===k;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:#fff;border-bottom:1px solid #eee">
      ${u.map(L=>`<button class="ml-tab" data-tab="${L.key}" style="flex:1;padding:10px 4px;border:none;border-bottom:2px solid ${i===L.key?St:"transparent"};background:none;font-size:12px;font-weight:${i===L.key?"900":"600"};color:${i===L.key?St:"#888"};cursor:pointer">${L.label}${L.count?` (${L.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Xn(v,r,c):i==="active"?Zn(y,c):Qn(z,c)}
    </div>
  </div>`,(M=document.getElementById("ml-create-btn"))==null||M.addEventListener("click",()=>er(e,t)),e.querySelectorAll(".ml-tab").forEach(L=>L.addEventListener("click",()=>$t(e,t,L.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(L=>L.addEventListener("click",()=>bt(e,t,L.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(L=>L.addEventListener("click",N=>{N.stopPropagation(),ko(e,t,L.dataset.join,L.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(L=>L.addEventListener("click",N=>{N.stopPropagation(),xi(e,t,L.dataset.delete,L.dataset.name,i)}))}function ei(e,t,i=!1){var a,l;const s=e.creator_id===t,c=e.pot||0,d=((l=(a=e.mini_league_members)==null?void 0:a[0])==null?void 0:l.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${g.map(H=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #f5f5f5">
            <div style="width:36px;height:36px;border-radius:50%;background:${H.club_color2||St};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${H.club_color1||"#fff"}">${(H.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${v.map((H,G)=>{const oe=z>0&&a.status==="finished"?G===0?Math.floor(z*.7):G===1?Math.floor(z*.2):G===2?Math.floor(z*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${H.userId===d?"background:#f0fdf4;":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${G===0?xt:G<3?St:"#555"}">${["🥇","🥈","🥉"][G]||G+1}</td>
              ...
              <td style="text-align:center;color:${H.goalDiff>=0?St:"#cc2222"}">${H.goalDiff>=0?"+":""}${H.goalDiff}</td>
              <td style="text-align:center;font-weight:900;font-size:14px">${H.points}</td>
              ${z>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${xt}">${oe?oe.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(H,G)=>G+1).reverse().map(H=>{const G=(p||[]).filter(oe=>oe.matchday===H);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${H}</div>${G.map(oe=>Oi(oe,g,d,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const N=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((Y=document.getElementById("ml-back"))==null||Y.addEventListener("click",()=>$t(e,t,N)),(j=document.getElementById("ml-start-btn"))==null||j.addEventListener("click",()=>nr(e,t,a,g)),(F=document.getElementById("ml-next-day"))==null||F.addEventListener("click",()=>rr(e,t,i)),(B=document.getElementById("ml-finish-btn"))==null||B.addEventListener("click",()=>Eo(e,t,i,z,v,g)),(Q=document.getElementById("ml-join-now"))==null||Q.addEventListener("click",()=>ko(e,t,i,a.type)),(de=document.getElementById("ml-leave-btn"))==null||de.addEventListener("click",()=>ir(e,t,i,r)),(se=document.getElementById("ml-delete-btn"))==null||se.addEventListener("click",()=>xi(e,t,i,a.name,"waiting")),(P=document.getElementById("ml-delete-now"))==null||P.addEventListener("click",()=>xi(e,t,i,a.name,N)),(J=document.getElementById("ml-archive-btn"))==null||J.addEventListener("click",()=>or(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(H=>{H.addEventListener("click",()=>{const G=y.find(oe=>oe.id===H.dataset.playMatch);G&&t.navigate("match-mini-league",{mlMatchId:G.id,leagueId:i})})}),a.status==="finished"&&L){const H=v.findIndex(G=>G.userId===d);H>=0&&H<3&&L.prize_amount>0&&setTimeout(()=>ar(e,t,a,L,H),400)}}function Oi(e,t,i,s,c=!1){const d=g=>t.find(v=>v.id===g);if(e.is_bye){const g=d(e.home_id);return`<div style="padding:8px;border-radius:8px;background:#f9f9f9;margin-bottom:6px;font-size:12px;color:#888;text-align:center">🔵 ${(g==null?void 0:g.club_name)||(g==null?void 0:g.pseudo)||"?"} exempté(e)</div>`}const a=d(e.home_id),l=d(e.away_id),p=e.home_id===i||e.away_id===i,o=p&&e.status==="pending"&&s&&!c,n=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${p?"#f0fdf4":"#f9f9f9"};margin-bottom:6px;border:1px solid ${p?"#86efac":"#f0f0f0"}">
    ...
    <div style="font-size:13px;font-weight:900;min-width:50px;text-align:center;color:${e.status==="finished"?St:"#999"}">${n}</div>
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(_),(q=_.querySelector("#pvp-end-home"))==null||q.addEventListener("click",()=>{_.remove(),We(e),o?l("mini-league",{openLeagueId:o}):l("mini-league")})}const de=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},f=>{const m=f.new;try{if(m.status==="finished"||m.forfeit){if(M||(M=!0,Y&&(clearInterval(Y),Y=null),m.game_state&&(u=m.game_state),u.phase==="finished"&&!m.forfeit&&document.getElementById("pvp-home")))return;Q(m);return}if(m.game_state){const x=u;u=m.game_state;const b=u._lastGC;if(b&&b.seq&&!B.has(b.seq)&&(B.add(b.seq),b.by!==n)){Te(b.type,b.by,()=>ye());return}const h=x[n+"Score"]||0,_=x[g+"Score"]||0,T=u[n+"Score"]||0,$=u[g+"Score"]||0,A=T>h,S=$>_;if((A||S)&&!F.has(u.round)){F.add(u.round);const q=[...u.log||[]].reverse().find(R=>R.isGoal),D=((q==null?void 0:q.homePlayers)||[]).map(R=>({name:R.name,note:R.note,portrait:R.portrait,job:R.job}));ke(D,T,$,A,()=>ye());return}ye()}}catch(x){console.error("[PvP] crash:",x)}}).subscribe();async function se(f){Object.assign(u,f),u.lastActionAt=new Date().toISOString();const{error:m}=await E.from("matches").update({game_state:u}).eq("id",i);m&&p("Erreur de synchronisation","error");try{ye()}catch(x){console.error("[PvP] renderPvpScreen crash:",x)}}async function P(){if(M)return;M=!0,Y&&(clearInterval(Y),Y=null);const f=s?z.away_id:z.home_id,m=s?"p2":"p1",x=s?"p1":"p2",b={...u,[m+"Score"]:3,[x+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:f,home_score:b.p1Score||0,away_score:b.p2Score||0,game_state:b}).eq("id",i)}catch{}try{E.removeChannel(de)}catch{}setTimeout(()=>{We(e),l("mini-league")},800)}const J={BOOST_STAT:({value:f=1,count:m=1,roles:x=[]},b,h)=>{const _=b[n+"Team"],T=Object.entries(_).filter(([$])=>!x.length||x.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!T.length){b.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),h(b);return}H(T,m,`Choisir ${m} joueur(s) à booster (+${f})`,$=>{$.forEach(A=>{const S=(_[A._line]||[]).find(q=>q.cardId===A.cardId);S&&(S.boost=(S.boost||0)+f,b.log.push({text:`⚡ +${f} sur ${S.name}`,type:"info"}))}),b[n+"Team"]=_,h(b)})},DEBUFF_STAT:({value:f=1,count:m=1,roles:x=[],target:b="ai"},h,_)=>{const T=b==="home"?n:g,$=h[T+"Team"],A=b==="home"?"allié":"adverse",S=Object.entries($).filter(([q])=>!x.length||x.includes(q)).flatMap(([q,D])=>D.map(R=>({...R,_line:q})));if(!S.length){h.log.push({text:`🎯 Aucun joueur ${A}`,type:"info"}),_(h);return}H(S,m,`Choisir ${m} joueur(s) ${A}(s) (-${f})`,q=>{q.forEach(D=>{const R=($[D._line]||[]).find(O=>O.cardId===D.cardId);R&&(R.boost=(R.boost||0)-f,h.log.push({text:`🎯 -${f} sur ${R.name}`,type:"info"}))}),h[T+"Team"]=$,_(h)})},GRAY_PLAYER:({count:f=1,roles:m=[],target:x="ai"},b,h)=>{const _=x==="home"?n:g,T=b[_+"Team"],$=x==="home"?"allié":"adverse",A=Object.entries(T).filter(([S])=>!m.length||m.includes(S)).flatMap(([S,q])=>q.filter(D=>!D.used).map(D=>({...D,_line:S})));if(!A.length){b.log.push({text:`❌ Aucun joueur ${$}`,type:"info"}),h(b);return}H(A,f,`Choisir ${f} joueur(s) ${$}(s) à exclure`,S=>{const q="usedCardIds_"+_,D=new Set(b[q]||[]);S.forEach(R=>{const O=(T[R._line]||[]).find(X=>X.cardId===R.cardId);O&&(O.used=!0,D.add(R.cardId),b.log.push({text:`❌ ${O.name} exclu !`,type:"info"}))}),b[q]=[...D],b[_+"Team"]=T,h(b)})},REVIVE_PLAYER:({count:f=1,roles:m=[]},x,b)=>{const h=x[n+"Team"],_=Object.entries(h).filter(([T])=>!m.length||m.includes(T)).flatMap(([T,$])=>$.filter(A=>A.used).map(A=>({...A,_line:T})));if(!_.length){x.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),b(x);return}H(_,f,`Choisir ${f} joueur(s) à ressusciter`,T=>{T.forEach($=>{const A=(h[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.used=!1,x.log.push({text:`💫 ${A.name} ressuscité !`,type:"info"}))}),x[n+"Team"]=h,b(x)})},REMOVE_GOAL:({},f,m)=>{const x=g+"Score";f[x]>0?(f[x]--,f.log.push({text:"🚫 Dernier but annulé !",type:"info"})):f.log.push({text:"🚫 Aucun but à annuler",type:"info"}),m(f)},ADD_GOAL_DRAW:({},f,m)=>{f[n+"Score"]===f[g+"Score"]?(f[n+"Score"]++,f.log.push({text:"🎯 But bonus !",type:"info"})):f.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),m(f)},ADD_SUB:({value:f=1},m,x)=>{m.maxSubs=(m.maxSubs||3)+f,m.log.push({text:`🔄 +${f} remplacement(s)`,type:"info"}),x(m)},CUSTOM:({},f,m)=>m(f)};function H(f,m,x,b){const h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let _=[];function T(){var A,S;const $=f.map(q=>{const D={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[q._line]||"#555",R=Ie(q,q._line)+(q.boost||0),X=_.find(te=>te.cardId===q.cardId)?"#FFD700":"rgba(255,255,255,0.25)",V=q.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${q.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${X};background:${D};overflow:hidden;cursor:pointer;${V}">
        ...
        </div>`,(A=h.querySelector("#pp-close"))==null||A.addEventListener("click",()=>h.remove()),h.querySelectorAll(".pp-item").forEach(q=>{q.addEventListener("click",()=>{const D=q.dataset.cid,R=f.find(X=>X.cardId===D),O=_.findIndex(X=>X.cardId===D);R&&(O>-1?_.splice(O,1):_.length<m&&_.push(R),T())})}),(S=h.querySelector("#pp-confirm"))==null||S.addEventListener("click",()=>{h.remove(),b(_)})}T(),document.body.appendChild(h)}async function G(f,m){const b=(u["gcCardsFull_"+n]||[]).find($=>$.id===f),h=(b==null?void 0:b._gcDef)||(u.gcDefs||[]).find($=>{var A;return $.name===m||((A=$.name)==null?void 0:A.toLowerCase().trim())===(m==null?void 0:m.toLowerCase().trim())}),_=[...u["usedGc_"+n]||[],f],T={type:m,by:n,seq:(u._gcAnimSeq||0)+1};B.add(T.seq),Te(m,n,async()=>{if(h!=null&&h.effect_type&&h.effect_type!=="CUSTOM"){const A=J[h.effect_type];if(A){const S={...u};A(h.effect_params||{},S,async q=>{q["usedGc_"+n]=_,q._lastGC=T,q._gcAnimSeq=T.seq,await se(q)});return}}const $={...u};switch(m){case"Remplacement+":$.maxSubs=($.maxSubs||3)+1,$.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const A=g+"Score";$[A]>0&&($[A]--,$.log.push({text:"🚫 But annulé",type:"info"}));break}}$["usedGc_"+n]=_,$._lastGC=T,$._gcAnimSeq=T.seq,await se($)})}function oe(f,m){const x="usedCardIds_"+f,b=new Set(u[x]||[]);m.forEach(h=>b.add(h)),u[x]=[...b]}function pe(){for(const f of["p1","p2"]){const m=new Set(u["usedCardIds_"+f]||[]),x=u[f+"Team"];if(x)for(const b of["GK","DEF","MIL","ATT"])(x[b]||[]).forEach(h=>{h.used=m.has(h.cardId)})}}function ye(){var nt,gt,le,$e,ee,ue;if(u.phase==="reveal")return Se();if(u.phase==="midfield")return ve();if(u.phase==="finished")return w();const f=u[n+"Team"],m=u[g+"Team"];pe();const x=u[n+"Score"],b=u[g+"Score"],h=u[n+"Name"],_=u[g+"Name"],T=u.phase===n+"-attack",$=u.phase===n+"-defense",A=Array.isArray(u["selected_"+n])?u["selected_"+n]:[],S=A.map(Z=>Z.cardId),q=window.innerWidth>=700,D=u[n+"Subs"]||[],R=u["usedSubIds_"+n]||[],O=D.filter(Z=>!R.includes(Z.cardId)),X=u["gcCardsFull_"+n]||[],V=u["usedGc_"+n]||[],te=X.filter(Z=>!V.includes(Z.id)),ae=u.boostOwner===n&&!u.boostUsed,fe=!["GK","DEF","MIL","ATT"].some(Z=>(m[Z]||[]).some(ce=>!ce.used)),me=[...f.MIL||[],...f.ATT||[]].filter(Z=>!Z.used),we=T&&fe&&me.length===0?[...f.GK||[],...f.DEF||[]].filter(Z=>!Z.used).map(Z=>Z.cardId):[];function _e(Z,ce,qe){var Si,Li;const Ee=Z._gcDef,tt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[Ee==null?void 0:Ee.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",it={purple:"#b06ce0",light_blue:"#00d4ef"}[Ee==null?void 0:Ee.color]||"#b06ce0",rt=(Ee==null?void 0:Ee.name)||Z.gc_type,st=(Ee==null?void 0:Ee.effect)||((Si=Ke[Z.gc_type])==null?void 0:Si.desc)||"",ct=Ee!=null&&Ee.image_url?`/manager-wars/icons/${Ee.image_url}`:null,kt=((Li=Ke[Z.gc_type])==null?void 0:Li.icon)||"⚡",pt=Math.round(qe*.22),ht=Math.round(qe*.22),Et=qe-pt-ht,Ut=rt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${Z.id}" data-gc-type="${Z.gc_type}"
        style="box-sizing:border-box;width:${ce}px;height:${qe}px;border-radius:10px;border:2px solid ${it};background:${tt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      </div>`}function Ce(Z,ce){return`<div id="pvp-boost-card"
      ...
      </div>`}const je=(Z,ce)=>ce?Ce(130,175):_e(Z,130,175),Re=(Z,ce)=>ce?Ce(68,95):_e(Z,68,95),Be=q?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Oe=T?Me(n)?`<button id="pvp-action" style="${Be};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${A.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Be};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:$?`<button id="pvp-action" style="${Be};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${A.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${_}</div>`,Fe=T&&!Me(n)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':T||$?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${A.length}/3 sélectionné(s)</div>`:"",Ve=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${q?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${O.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':O.map(Z=>`<div class="pvp-sub-btn" data-sub-id="${Z.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(Z,q?76:44,q?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(f,u[n+"Formation"],Ne,S,300,300,we)}
      </div>
    </div>`;function Ue(Z){if(Z.type==="duel"&&(Z.homeTotal!=null||Z.aiTotal!=null)){const ce=(Z.homeTotal||0)>=(Z.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          ${ot((Ee.players||[]).map(tt=>({...tt,used:!1})),"#ff6b6b",Ee.total)}
        </div>`}if(T&&((qe=u.pendingAttack)!=null&&qe.players)){const Ee=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          ${ot((Ee.players||[]).map(tt=>({...tt,used:!1})),"#00ff88",Ee.total)}
      ...
      </div>`;function Qe(){const Z=e.querySelector(".match-screen");if(!Z)return;const ce=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);Z.style.height=ce+"px",Z.style.minHeight=ce+"px",Z.style.maxHeight=ce+"px",Z.style.overflow="hidden";const qe=e.querySelector("#mobile-action-bar"),Ee=e.querySelector("#mobile-play-area");qe&&Ee&&(Ee.style.paddingBottom=qe.offsetHeight+"px")}if(Qe(),setTimeout(Qe,120),setTimeout(Qe,400),j||(j=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Qe),window.visualViewport.addEventListener("scroll",Qe)),window.addEventListener("resize",Qe)),function(){const ce=e.querySelector(".terrain-wrapper svg");ce&&(ce.removeAttribute("width"),ce.removeAttribute("height"),ce.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ce.setAttribute("viewBox","-26 -26 352 352"),ce.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(Z=>{Z.addEventListener("click",()=>{if(!T&&!$)return;const ce=Z.dataset.cardId,qe=Z.dataset.role,Ee=(f[qe]||[]).find(st=>st.cardId===ce);if(!Ee||Ee.used)return;const tt=we.includes(ce);if(T&&!["MIL","ATT"].includes(qe)&&!tt)return;Array.isArray(u["selected_"+n])||(u["selected_"+n]=[]);const it=u["selected_"+n],rt=it.findIndex(st=>st.cardId===ce);rt>-1?it.splice(rt,1):it.length<3&&it.push({...Ee,_role:qe}),ye()})}),e.querySelectorAll(".match-used-hit").forEach(Z=>{Z.addEventListener("click",()=>W(Z.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(Z=>{Z.addEventListener("click",()=>W())}),(nt=e.querySelector("#pvp-sub-open"))==null||nt.addEventListener("click",()=>W()),e.querySelectorAll(".pvp-gc-mini").forEach(Z=>{Z.addEventListener("click",()=>Le(Z.dataset.gcId,Z.dataset.gcType))}),(gt=e.querySelector("#pvp-boost-card"))==null||gt.addEventListener("click",()=>xe()),(le=e.querySelector("#pvp-action"))==null||le.addEventListener("click",Z=>{T?Z.currentTarget.dataset.pass==="1"||!Me(n)?ne():U():$&&re()}),($e=e.querySelector("#pvp-quit"))==null||$e.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&P()}),(ee=e.querySelector("#pvp-view-opp"))==null||ee.addEventListener("click",()=>ge()),(ue=e.querySelector("#pvp-toggle-history"))==null||ue.addEventListener("click",()=>K()),Y&&(clearInterval(Y),Y=null),(T||$)&&!M){let Z=30,ce=!1;const qe=()=>document.getElementById("pvp-timer"),Ee=()=>{qe()&&(qe().textContent=Z+"s",qe().style.color=ce?"#ff4444":"#fff")};Ee(),Y=setInterval(()=>{Z--,Z<0?ce?(clearInterval(Y),Y=null,T&&!Me(n)?ne():P()):(ce=!0,Z=15,Ee()):Ee()},1e3)}}function Se(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <div style="width:min(90vw,420px)">${ut(u[g+"Team"],u[g+"Formation"],null,[],300,300)}</div>
    </div>`,n==="p1"&&setTimeout(async()=>{await se({phase:"midfield"})},5e3)}let he=!1;function ve(){if(he)return;const f=u[n+"Team"].MIL||[],m=u[g+"Team"].MIL||[];function x(te){return te.reduce((ae,fe)=>ae+Ie(fe,"MIL"),0)}function b(te){let ae=0;for(let fe=0;fe<te.length-1;fe++){const me=at(te[fe],te[fe+1]);me==="#00ff88"?ae+=2:me==="#FFD700"&&(ae+=1)}return ae}const h=x(f)+b(f),_=x(m)+b(m),T=h>=_;function $(te,ae,fe){return`<div id="duel-row-${fe}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${te.map((me,we)=>{const _e=we<te.length-1?at(me,te[we+1]):null,Ce=!_e||_e==="#ff3333"||_e==="#cc2222",je=_e==="#00ff88"?"+2":_e==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${fe}" data-idx="${we}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...me,note:Ie(me,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${we<te.length-1?`<div class="duel-link duel-link-${fe}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${Ce?"rgba(255,255,255,0.12)":_e};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${Ce?"none":`0 0 8px ${_e}`}">
              ${je?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${_e}">${je}</span>`:""}
            </div>`:""}`}).join("")}
        </div>
        <div class="duel-score-line duel-score-line-${fe}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
          Score: ${x(te)} + ${b(te)} liens = <b style="color:#fff">${x(te)+b(te)}</b>
        </div>
      </div>`}et(e),e.innerHTML=`
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      <style>
      ...
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const A=(te,ae)=>e.querySelectorAll(te).forEach((fe,me)=>{setTimeout(()=>{fe.style.opacity="1",fe.style.transform="translateY(0) scale(1)"},ae+me*90)});A(".duel-card-me",150),A(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((te,ae)=>setTimeout(()=>{te.style.opacity="1"},ae*70)),900),setTimeout(()=>{const te=e.querySelector("#pvp-vs");te&&(te.style.opacity="1",te.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(ae=>ae.style.opacity="1")},1250);function S(te,ae,fe){const me=document.getElementById(te);if(!me)return;const we=performance.now(),_e=Ce=>{const je=Math.min(1,(Ce-we)/fe);me.textContent=Math.round(ae*(1-Math.pow(1-je,3))),je<1?requestAnimationFrame(_e):me.textContent=ae};requestAnimationFrame(_e)}setTimeout(()=>{S("pvp-score-me",h,800),S("pvp-score-opp",_,800)},1500);const q=u.p1Team.MIL||[],D=u.p2Team.MIL||[],R=x(q)+b(q),O=x(D)+b(D),X=R>=O?"p1":"p2";let V=u.boostValue;V==null&&(V=oi(),u.boostValue=V,u.boostOwner=X,u.boostUsed=!1),he=!0,setTimeout(()=>{const te=e.querySelector("#duel-row-"+(T?"me":"opp")),ae=e.querySelector("#duel-row-"+(T?"opp":"me")),fe=document.getElementById("pvp-score-me"),me=document.getElementById("pvp-score-opp"),we=T?fe:me,_e=T?me:fe;we&&(we.style.fontSize="80px",we.style.color=T?"#FFD700":"#ff6b6b",we.style.animation="duelPulse .5s ease"+(T?",duelGlow 1.5s ease infinite .5s":"")),_e&&(_e.style.opacity="0.25"),setTimeout(()=>{te&&(te.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",te.style.zIndex="5"),setTimeout(()=>{const Ce=document.getElementById("duel-shock");Ce&&(Ce.style.animation="shockwave .5s ease-out forwards"),ae&&(ae.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Be;const Ce=document.getElementById("pvp-duel-finale");if(!Ce)return;const je=u.boostOwner===n?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+V+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Re=n==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;Ce.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(T?"⚽ "+u[n+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+u[g+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+je+Re,Ce.style.transition="opacity .45s ease",Ce.style.opacity="1",Ce.style.pointerEvents="auto",(Be=document.getElementById("pvp-start-match"))==null||Be.addEventListener("click",async()=>{const Oe=X;await se({phase:Oe+"-attack",attacker:Oe,round:1,boostValue:V,boostUsed:!1,boostOwner:Oe})})},600)},700)},2800)}function ke(f,m,x,b,h){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const T=Array.from({length:10},(q,D)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${D%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][D%8]}</div>`).join(""),$={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};_.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let A=!1;const S=()=>{A||(A=!0,_.remove(),setTimeout(()=>h(),50))};_.addEventListener("click",S),setTimeout(S,3500)}function Te(f,m,x){var V,te;const b=(u.gcDefs||[]).find(ae=>{var fe;return ae.name===f||((fe=ae.name)==null?void 0:fe.toLowerCase().trim())===(f==null?void 0:f.toLowerCase().trim())}),h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",T=(b==null?void 0:b.name)||f,$=(b==null?void 0:b.effect)||((V=Ke[f])==null?void 0:V.desc)||"",A=b!=null&&b.image_url?`/manager-wars/icons/${b.image_url}`:null,S=((te=Ke[f])==null?void 0:te.icon)||"⚡",D=m===n?"Vous":u[m+"Name"]||"Adversaire",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",R.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(R);let O=!1;const X=()=>{O||(O=!0,R.remove(),setTimeout(()=>x&&x(),50))};R.addEventListener("click",X),setTimeout(X,3e3)}function Le(f,m){var R,O,X,V;const b=(u["gcCardsFull_"+n]||[]).find(te=>te.id===f),h=b==null?void 0:b._gcDef,_={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",T={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",$=(h==null?void 0:h.name)||m,A=(h==null?void 0:h.effect)||((R=Ke[m])==null?void 0:R.desc)||"Carte spéciale.",S=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,q=((O=Ke[m])==null?void 0:O.icon)||"⚡",D=document.createElement("div");D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",D.innerHTML=`
      ...
      </div>`,document.body.appendChild(x),(b=x.querySelector("#bp-close"))==null||b.addEventListener("click",()=>x.remove()),x.querySelectorAll(".bp-item").forEach(h=>{h.addEventListener("click",async()=>{const _=h.dataset.cid,T=m.find(A=>A.cardId===_);if(!T)return;const $=(f[T._line]||[]).find(A=>A.cardId===_);$&&($.boost=($.boost||0)+u.boostValue),x.remove(),await se({[n+"Team"]:f,boostUsed:!0})})})}function W(f=null){var O,X;if(!(u.phase===n+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const x=u[n+"Team"],b=u["usedSubIds_"+n]||[],h=u.maxSubs||3;if(b.length>=h){p(`Maximum ${h} remplacements atteint`,"warning");return}const _=Object.entries(x).flatMap(([V,te])=>(te||[]).filter(ae=>ae.used).map(ae=>({...ae,_line:V}))),T=(u[n+"Subs"]||[]).filter(V=>!b.includes(V.cardId));if(!_.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!T.length){p("Aucun remplaçant disponible","warning");return}let $=Math.max(0,_.findIndex(V=>V.cardId===f));const A=((O=_[$])==null?void 0:O._line)||((X=_[$])==null?void 0:X.job);let S=Math.max(0,T.findIndex(V=>V.job===A)),q=!1;const D=document.createElement("div");D.id="pvp-sub-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function R(){var _e,Ce,je,Re,Be,Oe;const V=_[$],te=T[S],ae=Math.min(130,Math.round((window.innerWidth-90)/2)),fe=Math.round(ae*1.35),me=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;D.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${te?Ye({...te,used:!1,boost:0},ae,fe):"<div>—</div>"}</div>
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(_e=D.querySelector("#psub-close"))==null||_e.addEventListener("click",()=>D.remove()),(Ce=D.querySelector("#pout-up"))==null||Ce.addEventListener("click",()=>{$>0&&($--,R())}),(je=D.querySelector("#pout-down"))==null||je.addEventListener("click",()=>{$<_.length-1&&($++,R())}),(Re=D.querySelector("#pin-up"))==null||Re.addEventListener("click",()=>{S>0&&(S--,R())}),(Be=D.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{S<T.length-1&&(S++,R())});const we=(Fe,Ve,Ne,He)=>{const Ue=D.querySelector("#"+Fe);if(!Ue)return;let Je=0;Ue.addEventListener("touchstart",Ze=>{Je=Ze.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ze=>{const Qe=Ze.changedTouches[0].clientY-Je;if(Math.abs(Qe)<30)return;const nt=Ve();Qe<0&&nt<He-1?(Ne(nt+1),R()):Qe>0&&nt>0&&(Ne(nt-1),R())},{passive:!0})};we("pin-panel",()=>S,Fe=>S=Fe,T.length),we("pout-panel",()=>$,Fe=>$=Fe,_.length),(Oe=D.querySelector("#psub-confirm"))==null||Oe.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),q)return;q=!0;const Ve=_[$],Ne=T[S];if(!Ve||!Ne)return;const He=Ve._line,Ue=(x[He]||[]).findIndex(Qe=>Qe.cardId===Ve.cardId);if(Ue===-1){p("Erreur : joueur introuvable","error"),D.remove();return}const Je={...Ne,_line:He,position:Ve.position,used:!1,boost:0};x[He].splice(Ue,1,Je);const Ze=[...b,Ne.cardId];D.remove(),ie(Ve,Ne,async()=>{await se({[n+"Team"]:x,[g+"Team"]:u[g+"Team"],["usedSubIds_"+n]:Ze})})})}document.body.appendChild(D),R()}function ie(f,m,x){const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const _=(A,S,q)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${ut(u[g+"Team"],u[g+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(f),(m=f.querySelector("#pvp-opp-close"))==null||m.addEventListener("click",()=>f.remove())}function K(){var b;const f=u.log||[],m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const x=h=>{var T,$,A;if(h.type==="duel"){const S=h.isGoal,q=h.homeScored&&n==="p1"||!h.homeScored&&S&&n==="p2",D=h.homeScored?"#FFD700":S?"#ff6b6b":"rgba(255,255,255,0.3)",R=S?q?"⚽ BUT !":"⚽ BUT adversaire !":(T=h.homePlayers)!=null&&T.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${S?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${D};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild(m),(b=m.querySelector("#pvp-hist-close"))==null||b.addEventListener("click",()=>m.remove())}async function ne(){if(u.phase!==n+"-attack")return;const f=n==="p1"?"p2":"p1",m=(u.round||0)+1,x=[...u.log||[]];x.push({type:"info",text:`⏭️ ${u[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const b=De(u),h=Me(f),_=b||!h?"finished":f+"-attack";await se({["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:_,attacker:f,round:m,log:x}),_==="finished"&&await C(u)}async function U(){const f=u[n+"Team"],m=!["GK","DEF","MIL","ATT"].some(_=>(u[g+"Team"][_]||[]).some(T=>!T.used)),x=(u["selected_"+n]||[]).map(_=>{const T=(f[_._role]||[]).find(R=>R.cardId===_.cardId)||_,$=m&&["GK","DEF"].includes(_._role),A=f[_._role]||[],S=A.findIndex(R=>R.cardId===_.cardId),q=lt(A.length),D=S>=0?q[S]:T._col??1;return{...T,_line:_._role,_col:D,...$?{note_a:Math.max(1,Number(T.note_a)||0)}:{}}});if(!x.length)return;const b=Nt(x,u.modifiers[n]||{});oe(n,x.map(_=>_.cardId)),x.forEach(_=>{const T=(f[_._role]||[]).find($=>$.cardId===_.cardId);T&&(T.used=!0)}),u["selected_"+n]=[],ye();const h=[...u.log||[]];if(m){const _=(u[n+"Score"]||0)+1,T=x.map(D=>({name:D.name,note:Ie(D,D._line||"ATT"),portrait:Pe(D),job:D.job}));h.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:T,homeTotal:b.total,aiTotal:0});const $=(u.round||0)+1,A=n==="p1"?"p2":"p1",S={...u,[n+"Team"]:f,[n+"Score"]:_},q=De(S);F.add($),ke(T,_,u[g+"Score"]||0,!0,async()=>{await se({[n+"Team"]:f,[n+"Score"]:_,["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:q?"finished":A+"-attack",attacker:A,round:$,log:h}),q&&await C({...u,[n+"Score"]:_})});return}h.push({type:"pending",text:`⚔️ ${u[n+"Name"]} attaque (${b.total})`}),await se({[n+"Team"]:f,[g+"Team"]:u[g+"Team"],pendingAttack:{...b,players:x,side:n},["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},phase:g+"-defense",log:h})}async function re(){const f=u[n+"Team"],m=(u["selected_"+n]||[]).map(V=>{const te=(f[V._role]||[]).find(_e=>_e.cardId===V.cardId)||V,ae=f[V._role]||[],fe=ae.findIndex(_e=>_e.cardId===V.cardId),me=lt(ae.length),we=fe>=0?me[fe]:te._col??1;return{...te,_line:V._role,_col:we}}),x=Rt(m,u.modifiers[n]||{});oe(n,m.map(V=>V.cardId)),m.forEach(V=>{const te=(f[V._role]||[]).find(ae=>ae.cardId===V.cardId);te&&(te.used=!0)}),u["selected_"+n]=[],ye();const b=Ot(u.pendingAttack.total,x.total,u.modifiers[n]||{}),h=u.pendingAttack.side,_=b==="attack"||(b==null?void 0:b.goal),T=h==="p1"?"p2":"p1",$=(u.round||0)+1,A=(u.pendingAttack.players||[]).map(V=>({name:V.name,note:Ie(V,V._line||"ATT"),portrait:Pe(V),job:V.job})),S=[...u.log||[]];S.push({type:"duel",isGoal:_,homeScored:_&&h===n,text:_?`⚽ BUT de ${u[h+"Name"]} ! (${u.pendingAttack.total} vs ${x.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${x.total})`,homePlayers:A,aiPlayers:m.map(V=>({name:V.name,note:Ie(V,V._line||"DEF"),portrait:Pe(V),job:V.job})),homeTotal:u.pendingAttack.total,aiTotal:x.total});const q=_?(u[h+"Score"]||0)+1:u[h+"Score"]||0,D={...u,[n+"Team"]:f,[h+"Score"]:q},R=De(D),O=R?"finished":T+"-attack",X=async()=>{await se({[n+"Team"]:f,[g+"Team"]:u[g+"Team"],[h+"Score"]:q,["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:O,attacker:T,round:$,log:S}),(O==="finished"||R)&&await C({...u,[h+"Score"]:q})};if(_){const V=h===n,te=V?q:u[n+"Score"]||0,ae=V?u[g+"Score"]||0:q;F.add($),ke(A,te,ae,V,X)}else await X()}function be(f){return["MIL","ATT"].some(m=>(f[m]||[]).some(x=>!x.used))}function Ae(f){return["GK","DEF","MIL","ATT"].some(m=>(f[m]||[]).some(x=>!x.used))}function ze(f){return Ae(f)&&!be(f)}function Me(f){const m=u[f+"Team"],x=u[(f==="p1"?"p2":"p1")+"Team"];return!!(be(m)||!Ae(x)&&ze(m))}function De(f){const m=["MIL","ATT"].some(S=>(f.p1Team[S]||[]).some(q=>!q.used)),x=["MIL","ATT"].some(S=>(f.p2Team[S]||[]).some(q=>!q.used)),b=Ae(f.p1Team),h=Ae(f.p2Team);return!m&&!(!h&&b)&&(!x&&!(!b&&h))}function I(f){const m=f.p1Score||0,x=f.p2Score||0;return m===x?null:m>x?z.home_id:z.away_id}async function C(f){try{const m=I(f),x=m?z.home_id===m?z.away_id:z.home_id:null,b=f.p1Score||0,h=f.p2Score||0;await E.from("matches").update({status:"finished",winner_id:m,home_score:b,away_score:h}).eq("id",i);const{data:_}=await E.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(_){await E.from("mini_league_matches").update({home_score:b,away_score:h,status:"finished"}).eq("id",_.id);const{data:T}=await E.from("mini_league_matches").select("id, status").eq("league_id",_.league_id).eq("matchday",_.matchday);if((T||[]).every(A=>A.status==="finished"||A.status==="bye")){const{data:A}=await E.from("mini_leagues").select("current_day,total_days").eq("id",_.league_id).single();if(A){const S=(A.current_day||0)+1,q=S>(A.total_days||0);await E.from("mini_leagues").update({current_day:q?A.total_days:S,status:q?"finished":"active"}).eq("id",_.league_id)}}}m&&x&&ki(m,x).catch(()=>{})}catch(m){console.error("[ML] finishMatch:",m)}}function w(){var h;if(M&&document.getElementById("pvp-end-overlay"))return;M=!0;const f=u[n+"Score"],m=u[g+"Score"],x=f>m,b=f===m;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(h=document.getElementById("pvp-home"))==null||h.addEventListener("click",()=>{try{E.removeChannel(de)}catch{}We(e),l("mini-league",o?{openLeagueId:o}:{})})}ye()}const cr="/manager-wars/",pr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let p="buy";const o=()=>{var r,u,M,L,N,Y,j;return{name:(((r=document.getElementById("flt-name"))==null?void 0:r.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((M=document.getElementById("flt-country"))==null?void 0:M.value)||"").toLowerCase().trim(),job:((L=document.getElementById("flt-job"))==null?void 0:L.value)||"",rarity:((N=document.getElementById("flt-rarity"))==null?void 0:N.value)||"",note1:parseInt((Y=document.getElementById("flt-note1"))==null?void 0:Y.value)||0,note2:parseInt((j=document.getElementById("flt-note2"))==null?void 0:j.value)||0}};function n(r){const u=o();return r.filter(M=>{var Q,de;const L=(Q=M.card)==null?void 0:Q.player;if(!L)return!1;const N=`${L.firstname} ${L.surname_encoded}`.toLowerCase(),Y=(((de=L.clubs)==null?void 0:de.encoded_name)||"").toLowerCase(),j=(L.country_code||"").toLowerCase(),F=Tt(L,L.job),B=L.job2?Tt(L,L.job2):0;return!(u.name&&!N.includes(u.name)||u.club&&!Y.includes(u.club)||u.country&&!j.includes(u.country)||u.job&&L.job!==u.job||u.rarity&&L.rarity!==u.rarity||u.note1&&F<u.note1||u.note2&&B<u.note2)})}function g(r){var Y,j,F;const u=(Y=r.card)==null?void 0:Y.player;if(!u)return"";const M=Tt(u,u.job),L=u.job2?Tt(u,u.job2):0,N=(i.profile.credits||0)>=r.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ui(u.rarity)}
      ${Wt(M,u.job)}
      ${Wt(L,u.job2||null)}
      ${Vi(u.country_code)}
      ${Ki((j=u.clubs)==null?void 0:j.logo_url)}
      <div style="flex:1;min-width:0">
    ...
    </div>`}function v(r){var Y,j,F;const u=(Y=r.card)==null?void 0:Y.player;if(!u)return"";const M=Tt(u,u.job),L=u.job2?Tt(u,u.job2):0,N=r.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${N?"opacity:0.7":""}">
      ${Ui(u.rarity)}
      ${Wt(M,u.job)}
      ${Wt(L,u.job2||null)}
      ${Vi(u.country_code)}
  ...
  </div>`}So(Io);const Ge={user:null,profile:null,page:"home",params:{}};function At(e,t="info",i=3e3){const s=document.getElementById("toast");s&&(s.textContent=e,s.className=`show ${t}`,clearTimeout(s._t),s._t=setTimeout(()=>{s.className=""},i))}function wr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function yi(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ct(){if(!Ge.user)return;const{data:e}=await E.from("users").select("*").eq("id",Ge.user.id).single();e&&(Ge.profile=e)}function Ft(e,t={}){Ge.page=e,Ge.params=t,Ao()}async function Ao(){var s,c,d,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(l=>{l.classList.toggle("active",l.dataset.page===Ge.page)});const t=document.getElementById("nav-credits");t&&Ge.profile&&(t.textContent=`💰 ${(Ge.profile.credits||0).toLocaleString("fr")}`);const i={state:Ge,navigate:Ft,toast:At,openModal:wr,closeModal:yi,refreshProfile:Ct};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',Ge.page){case"home":await Ci(e,i);break;case"collection":await Zo(e,i);break;case"decks":await pi(e,i);break;case"boosters":await fn(e,i);break;case"match":{const l=Ge.params&&Ge.params.matchMode||"vs_ai_easy";l==="random"?await _o(e,i):l==="friend"?await Kn(e,i,(s=Ge.params)==null?void 0:s.friendId,(c=Ge.params)==null?void 0:c.friendName):l==="mini-league"?await Hi(e,i,(d=Ge.params)==null?void 0:d.mlMatchId,(a=Ge.params)==null?void 0:a.leagueId):await zn(e,i);break}case"market":await mr(e,i);break;case"rankings":await hr(e,i);break;case"matches":await vr(e,i);break;case"friends":await Do(e,i);break;case"mini-league":await Jn(e,i);break;case"match-mini-league":{const l=Ge.params||{};await Hi(e,i,l.mlMatchId,l.leagueId);break}default:await Ci(e,i)}}function _r(){var s;const e=document.getElementById("app"),t=Ge.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
