import{s as A,F as ui,h as Ft,j as Ri,l as it,i as vn,k as wn,b as _n}from"./formation-links-DJC25wD7.js";function _i(e,{navigate:t,toast:o}){e.innerHTML=`
  ...
  `;function s(){var j;const i=document.getElementById("logo-preview"),r=document.getElementById("logo-initials"),y=((j=document.getElementById("setup-club"))==null?void 0:j.value)||"MW",$=y.trim().split(" ").filter(Boolean),v=$.length>=2?($[0][0]+$[1][0]).toUpperCase():y.slice(0,2).toUpperCase();i&&(i.style.background=d,i.style.borderColor=l),r&&(r.textContent=v,r.style.color=l)}document.getElementById("color1").addEventListener("input",i=>{l=i.target.value,document.getElementById("swatch1").style.background=l,s()}),document.getElementById("color2").addEventListener("input",i=>{d=i.target.value,document.getElementById("swatch2").style.background=d,s()});function u(i){document.querySelectorAll(".setup-step").forEach(r=>r.classList.remove("active")),document.getElementById(`step-${i}`).classList.add("active"),document.getElementById("step-num").textContent=i,document.getElementById("progress-fill").style.width=`${Math.round(i/3*100)}%`,i===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("step1-error");if(r.textContent="",i.length<3){r.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:y}=await A.from("users").select("id").eq("pseudo",i).maybeSingle();if(y){r.textContent="Ce pseudo est déjà pris.";return}u(2)}),document.getElementById("step2-back").addEventListener("click",()=>u(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const i=document.getElementById("setup-club").value.trim(),r=document.getElementById("step2-error");if(r.textContent="",i.length<2){r.textContent="Nom trop court (min. 2 caractères).";return}const{data:y}=await A.from("users").select("id").eq("club_name",i).maybeSingle();if(y){r.textContent="Ce nom de club est déjà pris.";return}u(3)}),document.getElementById("step3-back").addEventListener("click",()=>u(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("setup-club").value.trim(),y=document.getElementById("step3-error"),$=document.getElementById("step3-finish");y.textContent="",$.disabled=!0,$.textContent="Création en cours…";try{const{error:v}=await A.from("users").insert({id:t.user.id,pseudo:i,club_name:r,club_color1:l,club_color2:d,credits:1e4});if(v)throw v;await kn(t.user.id),await c(),a(`Bienvenue ${i} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(v){y.textContent=v.message,$.disabled=!1,$.textContent="🚀 Créer mon profil !"}})}async function kn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await A.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(o){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",o)}}const En="modulepreload",Tn=function(e){return"/manager-wars/"+e},$i={},Oi=function(t,o,a){let c=Promise.resolve();if(o&&o.length>0){document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),s=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));c=Promise.allSettled(o.map(u=>{if(u=Tn(u),u in $i)return;$i[u]=!0;const i=u.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${r}`))return;const y=document.createElement("link");if(y.rel=i?"stylesheet":En,i||(y.as="script"),y.crossOrigin="",y.href=u,s&&y.setAttribute("nonce",s),document.head.appendChild(y),i)return new Promise(($,v)=>{y.addEventListener("load",$),y.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function l(d){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=d,window.dispatchEvent(s),!s.defaultPrevented)throw d}return c.then(d=>{for(const s of d||[])s.status==="rejected"&&l(s.reason);return t().catch(l)})},Mt="#1A6B3C",jt="#cc2222",An="#D4A017",ki="#888";async function zn(e,t){const{state:o,toast:a}=t;e.innerHTML=`
    ...
    ${gi()}`,document.body.appendChild(i);const y=()=>i.remove();i.querySelector("#pending-close").addEventListener("click",y),i.addEventListener("click",$=>{$.target===i&&y()}),i.querySelectorAll("[data-accept]").forEach($=>{$.addEventListener("click",async()=>{const{error:v}=await A.from("friendships").update({status:"accepted"}).eq("id",$.dataset.accept);if(v){t("Erreur : "+v.message,"error");return}$.closest("div[style]").remove(),t("✅ Ami accepté !","success"),Hi(e,t,a),o&&o()})}),i.querySelectorAll("[data-decline]").forEach($=>{$.addEventListener("click",async()=>{await A.from("friendships").delete().eq("id",$.dataset.decline),$.closest("div[style]").remove(),t("Demande refusée","info"),o&&o()})})}async function Ln(e,t,o){const a=e.user.id,[c,l]=[a,t].sort(),d=a===c,{data:s}=await A.from("friend_match_stats").select("*").eq("player1_id",c).eq("player2_id",l).single(),u=e.profile.club_name||e.profile.pseudo||"Moi",i=s||{},r=d?i.wins_p1||0:i.wins_p2||0,y=d?i.wins_p2||0:i.wins_p1||0,$=i.draws||0,v=d?i.goals_p1||0:i.goals_p2||0,j=d?i.goals_p2||0:i.goals_p1||0,n=d?i.gc_used_p1||0:i.gc_used_p2||0,E=d?i.gc_used_p2||0:i.gc_used_p1||0,I=i.matches_total||0,L=(R,F,C,H=Mt,te=jt)=>`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(be=document.getElementById("close-detail"))==null||be.addEventListener("click",s);let U=new Set;const oe=()=>{const G=U.size,N=document.getElementById("sell-action-panel");N&&(N.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G,document.getElementById("sell-direct-total").textContent=(G*E).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const N=G.dataset.id;G.checked?U.add(N):U.delete(N);const Z=G.closest(".exemplaire-row");Z&&(Z.style.borderColor=G.checked?"#1A6B3C":"#eee"),oe()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",N=>{if(N.target.closest("button")||N.target.tagName==="INPUT")return;const Z=G.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",N=>{N.stopPropagation();const Z=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);Z&&(Z.style.display=Z.style.display==="none"?"flex":"none")})}),(xe=document.getElementById("direct-sell-btn"))==null||xe.addEventListener("click",async()=>{const G=[...U];if(!G.length)return;const N=G.length*E;if(!confirm(`Vendre ${G.length} carte${G.length>1?"s":""} ${r.surname_encoded} pour ${N.toLocaleString("fr")} crédits ? Action irréversible.`))return;await A.from("market_listings").delete().in("card_id",G),await A.from("transfer_history").delete().in("card_id",G);const{error:Z}=await A.from("cards").delete().in("id",G);if(Z){l(Z.message,"error");return}await A.from("users").update({credits:(c.profile.credits||0)+N}).eq("id",c.profile.id),await i();const ue=document.getElementById("nav-credits");ue&&(ue.textContent=`💰 ${(c.profile.credits||0).toLocaleString("fr")}`),l(`+${N.toLocaleString("fr")} crédits ! ${G.length} carte${G.length>1?"s":""} vendue${G.length>1?"s":""}.`,"success"),s(),u("collection")}),(Y=document.getElementById("market-sell-btn"))==null||Y.addEventListener("click",async()=>{var Se;const G=[...U];if(!G.length){l("Sélectionne au moins un exemplaire","warning");return}const N=parseInt((Se=document.getElementById("sell-market-price"))==null?void 0:Se.value);if(!N||N<1){l("Prix invalide","error");return}const{error:Z}=await A.from("cards").update({is_for_sale:!0,sale_price:N}).in("id",G);if(Z){l(Z.message,"error");return}const ue=G.map(Ie=>({seller_id:c.profile.id,card_id:Ie,price:N,status:"active"})),{error:se}=await A.from("market_listings").insert(ue);se&&console.warn("[Market] insert listings:",se.message),l(`${G.length} carte${G.length>1?"s":""} mise${G.length>1?"s":""} en vente à ${N.toLocaleString("fr")} cr. chacune !`,"success"),s(),u("collection")}),(X=document.getElementById("cancel-sell-btn"))==null||X.addEventListener("click",async()=>{await A.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await A.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),s(),u("collection")})}const Kt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},bt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Xt(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const o=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${o}.png`}function tn(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function nn(e){var o;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(o=e==null?void 0:e.clubs)!=null&&o.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Un(e,t=44,o=58){var v;const a=e?Xt(e):null,c=e?nn(e):null,l=tn(e==null?void 0:e.country_code),d=(e==null?void 0:e.job)||"MIL",s=bt[d]||"#555",u={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(d==="GK"?e==null?void 0:e.note_g:d==="DEF"?e==null?void 0:e.note_d:d==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(o*.19),y=Math.round(o*.25),$=o-r-y;return e?`<div style="width:${t}px;height:${o}px;border-radius:5px;border:2px solid ${u};background:${s};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`}async function ei(e,t,o,a){var F;const{state:c,navigate:l,toast:d}=t;Ze(e);const s=c.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return yo(e,t,o);const u=s.deckId;let i,r,y,$;try{const C=await Promise.all([A.from("decks").select("formation,name").eq("id",u).single(),A.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",u).order("slot_order")]);i=C[0].data,y=C[0].error,r=C[1].data,$=C[1].error}catch(C){console.error("[Match] Exception chargement deck:",C),vt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>l("home"));return}if(y||$){console.error("[Match] Erreur Supabase:",y||$),vt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>l("home"));return}const v=(r||[]).filter(C=>{var H;return C.is_starter&&((H=C.card)==null?void 0:H.player)}).map(C=>di(C.card,C.position)),j=(r||[]).filter(C=>{var H;return!C.is_starter&&((H=C.card)==null?void 0:H.player)}).map(C=>di(C.card,C.position));if(v.length<11){vt(e,"⚠️",`Deck incomplet (${v.length}/11).`,"Compléter",()=>l("decks"));return}const n=(r||[]).find(C=>{var H;return((H=C.card)==null?void 0:H.card_type)==="formation"}),E=(i==null?void 0:i.formation)||((F=n==null?void 0:n.card)==null?void 0:F.formation)||"4-4-2",{data:I,error:L}=await A.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",c.profile.id).eq("card_type","game_changer"),{data:z}=await A.from("gc_definitions").select("*").eq("is_active",!0),R=(I||[]).map(C=>({...C,_gcDef:(z==null?void 0:z.find(H=>H.name===C.gc_type||H.id===C.gc_definition_id))||null}));a({deckId:u,formation:E,starters:v,subsRaw:j,gcCardsEnriched:R,gcDefs:z||[]})}async function ho(e,t){const{state:o}=t,c=(o.params||{}).matchMode||"vs_ai_easy",l=c.replace("vs_ai_",""),d=c;await ei(e,t,c,async({deckId:s,formation:u,starters:i,subsRaw:r,gcCardsEnriched:y,gcDefs:$})=>{try{const v=mt(i,u),j=await bo(u,l),n=async E=>{try{const{data:I,error:L}=await A.from("matches").insert({home_id:o.profile.id,away_id:null,mode:d,home_deck_id:s,status:"in_progress"}).select().single();if(L){console.error("[MatchIA] Erreur création match:",L),vt(e,"⚠️","Impossible de créer le match ("+L.message+").","Retour",()=>t.navigate("home"));return}const z={gcDefs:$||[],matchId:I==null?void 0:I.id,mode:d,difficulty:l,formation:u,homeTeam:v,aiTeam:j,homeSubs:r,subsUsed:0,maxSubs:Math.min(r.length,3),homeScore:0,aiScore:0,gcCards:E,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:o.profile.club_name||"Vous"};wo(e,z,t)}catch(I){console.error("[MatchIA] Exception launchMatch:",I),vt(e,"⚠️","Erreur au lancement du match : "+I.message,"Retour",()=>t.navigate("home"))}};if(!y.length){n([]);return}Qt(e,y,n)}catch(v){console.error("[MatchIA] Exception setup:",v),vt(e,"⚠️","Erreur de préparation du match : "+v.message,"Retour",()=>t.navigate("home"))}})}async function bo(e,t){var d,s;const{data:o}=await A.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!o||o.length<11)return vo(e);const a=kt[e]||kt["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},l=[...o];for(const u of["GK","DEF","MIL","ATT"]){const i=l.filter(j=>j.job===u),r=l.filter(j=>j.job!==u),y=[...i,...r],$=[];for(let j=0;j<a[u];j++){const n=y[j]||l[j];n&&$.push({cardId:"ai-"+n.id+"-"+j,id:n.id,firstname:n.firstname,name:n.surname_encoded,country_code:n.country_code,club_id:n.club_id,job:n.job,job2:n.job2,note_g:Number(n.note_g)||0,note_d:Number(n.note_d)||0,note_m:Number(n.note_m)||0,note_a:Number(n.note_a)||0,rarity:n.rarity,skin:n.skin,hair:n.hair,hair_length:n.hair_length,clubName:((d=n.clubs)==null?void 0:d.encoded_name)||null,clubLogo:((s=n.clubs)==null?void 0:s.logo_url)||null,boost:0,used:!1,_line:u})}const v=rt($.length);$.forEach((j,n)=>{j._col=v[n]}),c[u]=$}return c}function vo(e){const t=kt[e]||kt["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},a=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const l of["GK","DEF","MIL","ATT"]){const d=[];for(let u=0;u<t[l];u++){const i=3+Math.floor(Math.random()*5);d.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:a[c%a.length],country_code:"XX",club_id:null,job:l,job2:null,note_g:l==="GK"?i:2,note_d:l==="DEF"?i:2,note_m:l==="MIL"?i:2,note_a:l==="ATT"?i:2,rarity:"normal",boost:0,used:!1,_line:l}),c++}const s=rt(d.length);d.forEach((u,i)=>{u._col=s[i]}),o[l]=d}return o}function wo(e,t,o){e.innerHTML=`
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,F.style.transition="opacity .45s ease",F.style.opacity="1",F.style.pointerEvents="auto",(C=document.getElementById("start-match-btn"))==null||C.addEventListener("click",j))},600)},700)},2800)}function $o(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const D=window.innerWidth>=700,ie=(Y,X,G)=>{var Ve,Je;const N=(t.gcDefs||[]).find(M=>M.name===Y.gc_type),Z={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[N==null?void 0:N.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ue={purple:"#b06ce0",light_blue:"#00d4ef"}[N==null?void 0:N.color]||"#b06ce0",se=(N==null?void 0:N.name)||Y.gc_type,Se=(N==null?void 0:N.effect)||((Ve=Re[Y.gc_type])==null?void 0:Ve.desc)||"",Ie=N!=null&&N.image_url?`/manager-wars/icons/${N.image_url}`:null,Ce=((Je=Re[Y.gc_type])==null?void 0:Je.icon)||"⚡",Pe=Math.round(G*.22),Ae=Math.round(G*.22),Be=G-Pe-Ae,Te=se.length>12?7:9;return`<div class="gc-mini" data-gc-id="${Y.id}" data-gc-type="${Y.gc_type}"
  ...
  `,document.body.appendChild(a);let r=!1;const y=()=>{r||(r=!0,a.remove(),o())};a.addEventListener("click",y),setTimeout(y,2e3)}function At(e,t="rgba(0,0,0,0.8)"){const o=document.createElement("div");o.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,o.textContent=e,document.body.appendChild(o),setTimeout(()=>o.remove(),2200)}function ni(e,t,o,a=null,c=null){var v,j;if(t.phase!=="attack"){At("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){At(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const l=Object.entries(t.homeTeam).flatMap(([n,E])=>(E||[]).filter(I=>I.used).map(I=>({...I,_line:I._line||n}))),d=t.homeSubs.filter(n=>!t.usedSubIds.includes(n.cardId));if(!l.length){At("Aucun joueur utilisé à remplacer");return}if(!d.length){At("Aucun remplaçant disponible");return}let s=Math.max(0,l.findIndex(n=>n.cardId===c));const u=((v=l[s])==null?void 0:v._line)||((j=l[s])==null?void 0:j.job);let i=a?Math.max(0,d.findIndex(n=>n.cardId===a)):Math.max(0,d.findIndex(n=>n.job===u)),r=!1;const y=document.createElement("div");y.id="sub-overlay",y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function $(){var F,C,H,te,le,ae;const n=l[s],E=d[i],I=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(I*1.35),z=D=>`background:rgba(255,255,255,0.12);border:none;color:${D?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${D?"default":"pointer"};flex-shrink:0`;y.innerHTML=`
    ...
    </div>`,document.body.appendChild(v),(j=v.querySelector("#gc-back"))==null||j.addEventListener("click",()=>v.remove()),(n=v.querySelector("#gc-use"))==null||n.addEventListener("click",()=>{v.remove(),Lo(e,t,o,a,c)})}function Rt(e,t,o,a,c,l){const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function u(){var i,r;d.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(l);let s=!1;const u=()=>{s||(s=!0,l.remove(),setTimeout(()=>c(),50))};l.addEventListener("click",u),setTimeout(u,3500)}async function Lt(e,t,o){var r,y;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=o,c=t.homeScore>t.aiScore,l=t.homeScore===t.aiScore,d=c?"victoire":l?"nul":"defaite",s=Bn(t.mode,d);t.matchId&&await A.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const u={credits:(a.profile.credits||0)+s,matches_played:(a.profile.matches_played||0)+1};c?u.wins=(a.profile.wins||0)+1:l?u.draws=(a.profile.draws||0)+1:u.losses=(a.profile.losses||0)+1,await A.from("users").update(u).eq("id",a.profile.id),await o.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(de=T.querySelector("#psub-close"))==null||de.addEventListener("click",()=>T.remove()),(fe=T.querySelector("#pout-up"))==null||fe.addEventListener("click",()=>{h>0&&(h--,S())}),(me=T.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{h<x.length-1&&(h++,S())}),(ve=T.querySelector("#pin-up"))==null||ve.addEventListener("click",()=>{_>0&&(_--,S())}),(ze=T.querySelector("#pin-down"))==null||ze.addEventListener("click",()=>{_<m.length-1&&(_++,S())});const re=(ke,Ee,$e,Fe)=>{const Ge=T.querySelector("#"+ke);if(!Ge)return;let Oe=0;Ge.addEventListener("touchstart",Ne=>{Oe=Ne.touches[0].clientY},{passive:!0}),Ge.addEventListener("touchend",Ne=>{const qe=Ne.changedTouches[0].clientY-Oe;if(Math.abs(qe)<30)return;const Le=Ee();qe<0&&Le<Fe-1?($e(Le+1),S()):qe>0&&Le>0&&($e(Le-1),S())},{passive:!0})};re("pin-panel",()=>_,ke=>_=ke,m.length),re("pout-panel",()=>h,ke=>h=ke,x.length),(De=T.querySelector("#psub-confirm"))==null||De.addEventListener("click",async ke=>{if(ke.preventDefault(),ke.stopPropagation(),k)return;k=!0;const Ee=x[h],$e=m[_];if(!Ee||!$e)return;const Fe=Ee._line,Ge=(p[Fe]||[]).findIndex(qe=>qe.cardId===Ee.cardId);if(Ge===-1){u("Erreur : joueur introuvable","error"),T.remove();return}const Oe={...$e,_line:Fe,position:Ee.position,used:!1,boost:0};p[Fe].splice(Ge,1,Oe);const Ne=[...f,$e.cardId];T.remove(),G(Ee,$e,async()=>{await H({[i+"Team"]:p,[r+"Team"]:n[r+"Team"],["usedSubIds_"+i]:Ne})})})}document.body.appendChild(T),S()}function G(M,b,p){const f={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const x=(w,_,k)=>`<div style="text-align:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(fe=S.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>S.remove()),(me=S.querySelector("#pout-up"))==null||me.addEventListener("click",()=>{w>0&&(w--,q())}),(ve=S.querySelector("#pout-down"))==null||ve.addEventListener("click",()=>{w<m.length-1&&(w++,q())}),(ze=S.querySelector("#pin-up"))==null||ze.addEventListener("click",()=>{k>0&&(k--,q())}),(De=S.querySelector("#pin-down"))==null||De.addEventListener("click",()=>{k<h.length-1&&(k++,q())});const de=(Ee,$e,Fe,Ge)=>{const Oe=S.querySelector("#"+Ee);if(!Oe)return;let Ne=0;Oe.addEventListener("touchstart",qe=>{Ne=qe.touches[0].clientY},{passive:!0}),Oe.addEventListener("touchend",qe=>{const Le=qe.changedTouches[0].clientY-Ne;if(Math.abs(Le)<30)return;const He=$e();Le<0&&He<Ge-1?(Fe(He+1),q()):Le>0&&He>0&&(Fe(He-1),q())},{passive:!0})};de("pin-panel",()=>k,Ee=>k=Ee,h.length),de("pout-panel",()=>w,Ee=>w=Ee,m.length),(ke=S.querySelector("#psub-confirm"))==null||ke.addEventListener("click",async Ee=>{if(Ee.preventDefault(),Ee.stopPropagation(),T)return;T=!0;const $e=m[w],Fe=h[k];if(!$e||!Fe)return;const Ge=$e._line,Oe=(f[Ge]||[]).findIndex(Le=>Le.cardId===$e.cardId);if(Oe===-1){u("Erreur : joueur introuvable","error"),S.remove();return}const Ne={...Fe,_line:Ge,position:$e.position,used:!1,boost:0};f[Ge].splice(Oe,1,Ne);const qe=[...g,Fe.cardId];S.remove(),N($e,Fe,async()=>{await te({[i+"Team"]:f,[r+"Team"]:n[r+"Team"],["usedSubIds_"+i]:qe})})})}document.body.appendChild(S),q()}function N(b,p,f){const g={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const m=(_,k,T)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${g[_.job]||"#555"};border:3px solid ${k};position:relative;overflow:hidden;margin:0 auto">
        ${je(_)?`<img src="${je(_)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
          ...
          <tbody>
            ${v.map((z,R)=>`
              <tr style="border-bottom:1px solid #f5f5f5;${z.userId===d?"background:#f0fdf4;":""}">
                <td style="padding:8px 4px 8px 0;font-weight:700;color:${R===0?Po:R<3?Ut:"#555"}">${R+1}</td>
  ...
  </div>`,(n=document.getElementById("ml-back"))==null||n.addEventListener("click",()=>ci(e,t)),(E=document.getElementById("ml-start-btn"))==null||E.addEventListener("click",()=>Oo(e,t,s,$)),(I=document.getElementById("ml-next-day"))==null||I.addEventListener("click",()=>Uo(e,t,o)),(L=document.getElementById("ml-join-now"))==null||L.addEventListener("click",()=>yn(e,t,o,s.type)),e.querySelectorAll("[data-play-match]").forEach(z=>{z.addEventListener("click",()=>{const R=j.find(F=>F.id===z.dataset.playMatch);R&&Vo(e,t,R,s)})})}function qi(e,t,o,a,c=!1){const l=y=>t.find($=>$.id===y);if(e.is_bye){const y=l(e.home_id);return`<div style="padding:8px 10px;border-radius:8px;background:#f9f9f9;margin-bottom:6px;font-size:12px;color:#888;text-align:center">
    ...
    </div>`,Ge=w?"attack":_?"defense":"idle",Oe=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}return`<div style="font-size:11px;color:${P.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${P.type==="goal"?700:400};padding:3px 2px">${P.text||""}</div>`}const qe=(()=>{var ee,ge;if(_&&((ee=n.pendingAttack)!=null&&ee.players)){const ye=n.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(me=q.querySelector("#psub-close"))==null||me.addEventListener("click",()=>q.remove()),(ve=q.querySelector("#pout-up"))==null||ve.addEventListener("click",()=>{_>0&&(_--,W())}),(ze=q.querySelector("#pout-down"))==null||ze.addEventListener("click",()=>{_<h.length-1&&(_++,W())}),(De=q.querySelector("#pin-up"))==null||De.addEventListener("click",()=>{T>0&&(T--,W())}),(ke=q.querySelector("#pin-down"))==null||ke.addEventListener("click",()=>{T<w.length-1&&(T++,W())});const fe=($e,Fe,Ge,Oe)=>{const Ne=q.querySelector("#"+$e);if(!Ne)return;let qe=0;Ne.addEventListener("touchstart",Le=>{qe=Le.touches[0].clientY},{passive:!0}),Ne.addEventListener("touchend",Le=>{const He=Le.changedTouches[0].clientY-qe;if(Math.abs(He)<30)return;const et=Fe();He<0&&et<Oe-1?(Ge(et+1),W()):He>0&&et>0&&(Ge(et-1),W())},{passive:!0})};fe("pin-panel",()=>T,$e=>T=$e,w.length),fe("pout-panel",()=>_,$e=>_=$e,h.length),(Ee=q.querySelector("#psub-confirm"))==null||Ee.addEventListener("click",async $e=>{if($e.preventDefault(),$e.stopPropagation(),S)return;S=!0;const Fe=h[_],Ge=w[T];if(!Fe||!Ge)return;const Oe=Fe._line,Ne=(g[Oe]||[]).findIndex(He=>He.cardId===Fe.cardId);if(Ne===-1){u("Erreur : joueur introuvable","error"),q.remove();return}const qe={...Ge,_line:Oe,position:Fe.position,used:!1,boost:0};g[Oe].splice(Ne,1,qe);const Le=[...x,Ge.cardId];q.remove(),Z(Fe,Ge,async()=>{await le({[i+"Team"]:g,[r+"Team"]:n[r+"Team"],["usedSubIds_"+i]:Le})})})}document.body.appendChild(q),W()}function Z(p,f,g){const x={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const h=(k,T,S)=>`<div style="text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
      ...
      ${Ot(L,E.job2||null)}
      ${Gi(E.country_code)}
      ${Pi((F=E.clubs)==null?void 0:F.logo_url)}
      <div style="flex:1;min-width:0">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(c=>{c.addEventListener("click",l=>{l.preventDefault(),Vt(c.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Vt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Vt("boosters")),(a=document.getElementById("journal-btn"))==null||a.addEventListener("click",()=>rr())}async function rr(){const{data:e}=await A.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const o=(e||[]).map(a=>{const c=new Date(a.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",a=>{a.target===t&&t.remove()})}async function ar(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",o=>{o.target===o.currentTarget&&pi()}),document.getElementById("modal-close").addEventListener("click",pi);const{data:{session:e}}=await A.auth.getSession();if(!e){Ni(),_i(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:zt});return}Me.user=e.user,await St(),Ni();try{const{data:o}=await A.from("formation_links_overrides").select("formation, links"),a={};(o||[]).forEach(c=>{a[c.formation]=c.links}),wn(a)}catch(o){console.warn("Impossible de charger les overrides de formation:",o)}if(!Me.profile){$n(document.getElementById("app"),{state:Me,navigate:async()=>{await St(),oi()},toast:zt,refreshProfile:St});return}const t=Array.isArray(Me.profile.pending_boosters)?Me.profile.pending_boosters:[];if(!Me.profile.onboarding_done&&t.length>0){go(document.getElementById("app"),{state:Me,navigate:()=>oi(),toast:zt,refreshProfile:St});return}oi(),A.auth.onAuthStateChange(async(o,a)=>{o==="SIGNED_OUT"&&(Me.user=null,Me.profile=null,document.getElementById("app").innerHTML="",_i(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:zt}))})}function sr(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function ti(){const e=document.getElementById("app");e&&(e.style.height=sr()+"px")}window.addEventListener("resize",ti);window.addEventListener("orientationchange",()=>setTimeout(ti,150));window.visualViewport&&window.visualViewport.addEventListener("resize",ti);function oi(){const e=()=>{var o;(o=Me.user)!=null&&o.id&&A.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",Me.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",ti(),or(),hn()}function Ni(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function bn(e){var a;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const o=document.createElement("div");o.id="boot-error",o.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",o.innerHTML=`
