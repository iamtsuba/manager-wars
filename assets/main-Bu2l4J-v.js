...
import{s as v,j as vi,q as In,t as Ut,u as Oi,F as Hi,o as tt,n as ti,g as St,r as Te,m as Mt,v as Mi,w as fo,T as zi,p as mo,x as go,d as xo}from"./special-cards-q1oKjNQl.js";const bo="/";function pn(e,{navigate:t,toast:i}){let n="login";const o=()=>{var a,s,d,c,l,f,b;const r=n==="login";if(e.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=r),l&&(l.textContent=x,l.style.color=r)}document.getElementById("color1").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch1").style.background=r,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:r,club_color2:a,credits:1e4});if(x)throw x;await ho(t.user.id),await o(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function ho(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const vo="modulepreload",wo=function(e){return"/"+e},un={},Ui=function(t,i,n){let o=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));o=Promise.allSettled(i.map(d=>{if(d=wo(d),d in un)return;un[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":vo,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return o.then(a=>{for(const s of a||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},ii="#1A6B3C",ni="#cc2222",_o="#D4A017",fn="#888";async function ko(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const Sn="mw_sound_volume";function Wi(){const e=localStorage.getItem(Sn);if(e===null)return 100;const t=parseInt(e,10);return Number.isFinite(t)?Math.max(0,Math.min(100,t)):100}function zo(e){localStorage.setItem(Sn,String(Math.max(0,Math.min(100,Math.round(e)))))}function Xi(){return Wi()===0}function fi(e){return Math.max(0,Math.min(1,e*(Wi()/100)))}function Ji(e,t=1){if(Xi())return null;try{const i=new Audio(e);return i.volume=fi(t),i.play().catch(()=>{}),i}catch{return null}}let gt=null,Ci=null,mn=.3;function Mn(e,t=.3){if(mn=t,gt&&Ci===e&&!gt.paused){gt.volume=fi(mn);return}if(zt(),!Xi())try{const i=new Audio(e);i.loop=!0,i.volume=fi(t),i.play().catch(()=>{}),gt=i,Ci=e}catch{}}function zt(){if(gt)try{gt.pause(),gt.currentTime=0}catch{}gt=null,Ci=null}let Xt=null;function Cn(e,t=.6){if(Ue(),!Xi())try{const i=new Audio(e);i.volume=fi(t),i.play().catch(()=>{}),Xt=i}catch{}}function Ue(){if(Xt)try{Xt.pause(),Xt.currentTime=0}catch{}Xt=null}const To="2026.07.23-1602";async function gn(e,{state:t,navigate:i,toast:n}){var r,a,s;const o=t.profile;o&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(fe=document.getElementById("close-detail"))==null||fe.addEventListener("click",s);let E=new Set;const L=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function K(){let U=0;return document.querySelectorAll(".expl-check:checked").forEach(V=>{if(V.dataset.id===e.id)return;const F=Number(V.dataset.evo)||0,H=Number(V.dataset.note)||0;U+=H+F}),Math.round(U*L)}const Y=()=>{const U=E.size,V=document.getElementById("sell-action-panel");if(!V)return;V.style.display=U>0?"block":"none",document.getElementById("sell-selected-count").textContent=U;const z=document.getElementById("evolve-btn");if(z){const F=K();z.textContent=F>0?`⬆️ Évoluer (+${F})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(U=>{U.addEventListener("change",()=>{const V=U.dataset.id;U.checked?E.add(V):E.delete(V);const z=U.closest(".exemplaire-row");if(z){const F=z.querySelector(".expl-sel-overlay"),H=z.querySelector(".expl-sel-check");F&&(F.style.display=U.checked?"block":"none"),H&&(H.style.display=U.checked?"flex":"none"),z.style.transform=U.checked?"scale(1.05)":"scale(1)"}Y()})}),document.querySelectorAll(".exemplaire-row").forEach(U=>{U.addEventListener("click",V=>{if(V.target.tagName==="INPUT")return;const z=U.querySelector(".expl-check");z&&!z.disabled&&(z.checked=!z.checked,z.dispatchEvent(new Event("change")))})}),(C=document.getElementById("evolve-btn"))==null||C.addEventListener("click",async()=>{if(b<=1)return;const U=[...E];if(!U.length)return;if(E.has(e.id)){const G=document.createElement("div");G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",G.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const C=window.innerWidth>=700,W=(q,G,se)=>{var Ae,Be;const de=(t.gcDefs||[]).find(ke=>ke.name===q.gc_type),ve=(de==null?void 0:de.name)||q.gc_type,ze=(de==null?void 0:de.effect)||((Ae=je[q.gc_type])==null?void 0:Ae.desc)||"",he=de!=null&&de.image_url?`/icons/${de.image_url}`:null,Ie=((Be=je[q.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${q.id}" data-gc-type="${q.gc_type}" style="flex-shrink:0;cursor:pointer">
  ...
  <div id="match-history-panel">
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${_i(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            </div>`}}catch(ee){console.error("[Ranked] MMR update error:",ee)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const D=document.createElement("div");D.id="pvp-end-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const P=A?"🤝":j?"🏆":"😞",O=A?"MATCH NUL":j?"VICTOIRE !":"DÉFAITE",Q=A?"#fff":j?"#FFD700":"#ff6b6b";D.innerHTML=`
      ...
      ${R}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(ie=D.querySelector("#pvp-end-home"))==null||ie.addEventListener("click",()=>{D.remove(),it(e),l?x("mini-league",{openLeagueId:l}):x(a?"ranked":"home")})}const Z=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var S;const T=_.new;try{if(T.status==="finished"||T.forfeit){if(M)return;M=!0,k&&(clearInterval(k),k=null),Ue(),T.game_state&&(m=T.game_state),te(T);return}if(T.game_state){const j=m;m=T.game_state;const A=m._lastGC;if(A&&A.seq&&!X.has(A.seq)&&(X.add(A.seq),A.by!==p)){z(A.type,A.by,()=>W());return}const R=j[p+"Score"]||0,D=j[u+"Score"]||0,P=m[p+"Score"]||0,O=m[u+"Score"]||0,Q=P>R,ne=O>D;if((Q||ne)&&!B.has(m.round)){B.add(m.round);const ie=[...m.log||[]].reverse().find(le=>le.isGoal),ee=((ie==null?void 0:ie.homePlayers)||[]).map(le=>({name:le.name,note:le.note,portrait:le.portrait,job:le.job}));!!((S=ie==null?void 0:ie.text)!=null&&S.includes("DERNIER CORNER"))?ze().then(()=>{Qe(ee,P,O,Q,()=>W())}):Qe(ee,P,O,Q,()=>W());return}W()}}catch(j){console.error("[PvP] crash:",j)}}).subscribe();async function E(_){Object.assign(m,_),m.lastActionAt=new Date().toISOString();const{error:T}=await v.from("matches").update({game_state:m}).eq("id",i);T&&g("Erreur de synchronisation","error");try{W()}catch(S){console.error("[PvP] renderPvpScreen crash:",S)}}async function L(){if(M)return;M=!0,zt(),Ue(),k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,T=n?"p2":"p1",S=n?"p1":"p2",j={...m,[T+"Score"]:3,[S+"Score"]:0,phase:"finished"},A=j.p1Score||0,R=j.p2Score||0;try{await v.from("matches").update({game_state:j}).eq("id",i);const{data:D,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:A,p_away_score:R,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(O){console.error("[PvP] check_and_finish_mini_league (forfeit):",O)}try{const{data:O}=await v.rpc("apply_match_rewards",{p_match_id:i});O!=null&&O.success&&!(O!=null&&O.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(O){console.error("[PvP] apply_match_rewards (forfeit):",O)}}catch{}try{v.removeChannel(Z)}catch{}setTimeout(()=>{it(e),l?x("mini-league",{openLeagueId:l}):x("home")},800)}const K={BOOST_STAT:({value:_=1,count:T=1,roles:S=[]},j,A)=>{const R=j[p+"Team"],D=Object.entries(R).filter(([P])=>!S.length||S.includes(P)).flatMap(([P,O])=>O.filter(Q=>!Q.used).map(Q=>({...Q,_line:P})));if(!D.length){j.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),A(j);return}Y(D,T,`Choisir ${T} joueur(s) à booster (+${_})`,P=>{P.forEach(O=>{const Q=(R[O._line]||[]).find(ne=>ne.cardId===O.cardId);Q&&(Q.boost=(Q.boost||0)+_,j.log.push({text:`⚡ +${_} sur ${Q.name}`,type:"info"}))}),j[p+"Team"]=R,A(j)})},DEBUFF_STAT:({value:_=1,count:T=1,roles:S=[],target:j="ai"},A,R)=>{const D=j==="home"?p:u,P=A[D+"Team"],O=j==="home"?"allié":"adverse",Q=Object.entries(P).filter(([ne])=>!S.length||S.includes(ne)).flatMap(([ne,ie])=>ie.map(ee=>({...ee,_line:ne})));if(!Q.length){A.log.push({text:`🎯 Aucun joueur ${O}`,type:"info"}),R(A);return}Y(Q,T,`Choisir ${T} joueur(s) ${O}(s) (-${_})`,ne=>{ne.forEach(ie=>{const ee=(P[ie._line]||[]).find(ae=>ae.cardId===ie.cardId);ee&&(ee.boost=(ee.boost||0)-_,A.log.push({text:`🎯 -${_} sur ${ee.name}`,type:"info"}))}),A[D+"Team"]=P,R(A)})},GRAY_PLAYER:({count:_=1,roles:T=[],target:S="ai"},j,A)=>{const R=S==="home"?p:u,D=j[R+"Team"],P=S==="home"?"allié":"adverse",O=Object.entries(D).filter(([Q])=>!T.length||T.includes(Q)).flatMap(([Q,ne])=>ne.filter(ie=>!ie.used).map(ie=>({...ie,_line:Q})));if(!O.length){j.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),A(j);return}Y(O,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,Q=>{const ne="usedCardIds_"+R,ie=new Set(j[ne]||[]);Q.forEach(ee=>{const ae=(D[ee._line]||[]).find(le=>le.cardId===ee.cardId);ae&&(ae.used=!0,ie.add(ee.cardId),j.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),j[ne]=[...ie],j[R+"Team"]=D,A(j)})},REVIVE_PLAYER:({count:_=1,roles:T=[]},S,j)=>{const A=S[p+"Team"],R=Object.entries(A).filter(([D])=>!T.length||T.includes(D)).flatMap(([D,P])=>P.filter(O=>O.used).map(O=>({...O,_line:D})));if(!R.length){S.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),j(S);return}Y(R,_,`Choisir ${_} joueur(s) à ressusciter`,D=>{D.forEach(P=>{const O=(A[P._line]||[]).find(Q=>Q.cardId===P.cardId);O&&(O.used=!1,S.log.push({text:`💫 ${O.name} ressuscité !`,type:"info"}))}),S[p+"Team"]=A,j(S)})},REMOVE_GOAL:({},_,T)=>{const S=u+"Score";_[S]>0?(_[S]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),T(_)},ADD_GOAL_DRAW:({},_,T)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),T(_)},ADD_SUB:({value:_=1},T,S)=>{T.maxSubs=(T.maxSubs||3)+_,T.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),S(T)},CUSTOM:({},_,T)=>T(_)};function Y(_,T,S,j){const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let R=[];function D(){var O,Q;const P=_.map(ne=>{const ie=ne._line||ne.job||"MIL",ee=R.find(le=>le.cardId===ne.cardId),ae=Te({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:ie,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(O=A.querySelector("#pp-close"))==null||O.addEventListener("click",()=>A.remove()),A.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const ie=ne.dataset.cid,ee=_.find(le=>le.cardId===ie),ae=R.findIndex(le=>le.cardId===ie);ee&&(ae>-1?R.splice(ae,1):R.length<T&&R.push(ee),D())})}),(Q=A.querySelector("#pp-confirm"))==null||Q.addEventListener("click",()=>{A.remove(),j(R)})}D(),document.body.appendChild(A)}async function pe(_,T){const j=(m["gcCardsFull_"+p]||[]).find(P=>P.id===_),A=(j==null?void 0:j._gcDef)||(m.gcDefs||[]).find(P=>{var O;return P.name===T||((O=P.name)==null?void 0:O.toLowerCase().trim())===(T==null?void 0:T.toLowerCase().trim())}),R=[...m["usedGc_"+p]||[],_],D={type:T,by:p,seq:(m._gcAnimSeq||0)+1};X.add(D.seq),z(T,p,async()=>{if(A!=null&&A.effect_type&&A.effect_type!=="CUSTOM"){const O=K[A.effect_type];if(O){const Q={...m};O(A.effect_params||{},Q,async ne=>{ne["usedGc_"+p]=R,ne._lastGC=D,ne._gcAnimSeq=D.seq,await E(ne)});return}}const P={...m};switch(T){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const O=u+"Score";P[O]>0&&(P[O]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=R,P._lastGC=D,P._gcAnimSeq=D.seq,await E(P)})}function fe(_,T){const S="usedCardIds_"+_,j=new Set(m[S]||[]);T.forEach(A=>j.add(A)),m[S]=[...j]}function C(){for(const _ of["p1","p2"]){const T=new Set(m["usedCardIds_"+_]||[]),S=m[_+"Team"];if(S)for(const j of["GK","DEF","MIL","ATT"])(S[j]||[]).forEach(A=>{A.used=T.has(A.cardId)})}}function W(){var rn,an,sn,dn,ln,cn;if(m.phase==="reveal")return ue();if(m.phase==="midfield")return V();if(m.phase==="finished")return Ge();const _=m[p+"Team"],T=m[u+"Team"];C();const S=m[p+"Score"],j=m[u+"Score"],A=m[p+"Name"],R=m[u+"Name"],D=m.phase===p+"-attack",P=m.phase===p+"-defense",O=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],Q=O.map(J=>J.cardId),ne=window.innerWidth>=700,ie=m[p+"Subs"]||[],ee=m["usedSubIds_"+p]||[],ae=ie.filter(J=>!ee.includes(J.cardId)),le=m["gcCardsFull_"+p]||[],ge=m["usedGc_"+p]||[],ce=le.filter(J=>!ge.includes(J.id)),xe=m.boostOwner===p&&!m.boostUsed,ye=[..._.MIL||[],..._.ATT||[]].filter(J=>!J.used),oe=[...T.MIL||[],...T.ATT||[]].filter(J=>!J.used),Ee=!ke(T),Re=ye.length===0&&oe.length===0&&!Ee,Le=(_.DEF||[]).filter(J=>!J.used),Ve=(_.GK||[]).filter(J=>!J.used);let Oe=[];D&&ye.length===0&&(Ee?(Oe=Le.map(J=>J.cardId),Le.length===0&&(Oe=Oe.concat(Ve.map(J=>J.cardId)))):Re&&(Oe=[...Le,...Ve].map(J=>J.cardId)));function nt(J,me,Se){var Me,ft;const we=J._gcDef,qt=(we==null?void 0:we.name)||J.gc_type,at=(we==null?void 0:we.effect)||((Me=je[J.gc_type])==null?void 0:Me.desc)||"",Fe=we!=null&&we.image_url?`/icons/${we.image_url}`:null,Ne=((ft=je[J.gc_type])==null?void 0:ft.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${J.id}" data-gc-type="${J.gc_type}" style="flex-shrink:0;cursor:pointer">
    ...
    </div>`,rt=m[p+"Team"],uo=(()=>{var me,Se,we,qt,at;if(P&&((me=m.pendingAttack)!=null&&me.players)){const Fe=m.pendingAttack;let Ne="";if(O.length>0){const Me=O.map(We=>{const Vt=(rt[We._role]||[]).find(Li=>Li.cardId===We.cardId)||We,Yt=rt[We._role]||[],si=Yt.findIndex(Li=>Li.cardId===We.cardId),Ei=xt(Yt.length),Wt=si>=0?Ei[si]:Vt._col??1;return{...Vt,_line:We._role,_col:Wt}}),ft=ri(Me,((Se=m.modifiers)==null?void 0:Se[p])||{},m[p+"Formation"]);Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
      ...
      </div>`;function Bt(){const J=e.querySelector(".match-screen");if(!J)return;const me=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);J.style.height=me+"px",J.style.minHeight=me+"px",J.style.maxHeight=me+"px",J.style.overflow="hidden";const Se=e.querySelector("#mobile-action-bar"),we=e.querySelector("#mobile-play-area");Se&&we&&(we.style.paddingBottom=Se.offsetHeight+"px")}if(Bt(),setTimeout(Bt,120),setTimeout(Bt,400),I||(I=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Bt),window.visualViewport.addEventListener("scroll",Bt)),window.addEventListener("resize",Bt)),function(){const me=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!me)return;const Se=me.closest("#match-terrain-wrap");Se&&(Se.style.cssText="position:relative;width:100%;height:100%;padding:0"),me.removeAttribute("width"),me.removeAttribute("height"),me.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",me.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const J=e.querySelector(".terrain-wrapper svg");if(J){const me=J.closest("#match-terrain-wrap");me&&(me.style.cssText="position:relative;width:100%;height:100%;padding:0"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(J=>{J.addEventListener("click",()=>{if(!D&&!P)return;const me=J.dataset.cardId,Se=J.dataset.role,we=(_[Se]||[]).find(Ne=>Ne.cardId===me);if(!we||we.used)return;const qt=Oe.includes(me);if(D&&!["MIL","ATT"].includes(Se)&&!qt)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const at=m["selected_"+p],Fe=at.findIndex(Ne=>Ne.cardId===me);Fe>-1?at.splice(Fe,1):at.length<3&&at.push({...we,_role:Se}),W()})}),e.querySelectorAll(".match-used-hit").forEach(J=>{J.addEventListener("click",()=>N(J.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(J=>{J.addEventListener("click",()=>N())}),(rn=e.querySelector("#pvp-sub-open"))==null||rn.addEventListener("click",()=>N()),e.querySelectorAll(".pvp-gc-mini").forEach(J=>{D?J.addEventListener("click",()=>F(J.dataset.gcId,J.dataset.gcType)):(J.style.opacity="0.35",J.style.cursor="default",J.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(an=e.querySelector("#pvp-boost-card"))==null||an.addEventListener("click",()=>H()),(sn=e.querySelector("#pvp-action"))==null||sn.addEventListener("click",J=>{D?J.currentTarget.dataset.pass==="1"||!ct(p)?se():Ie():P&&Ae()}),(dn=e.querySelector("#pvp-quit"))==null||dn.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&L()}),(ln=e.querySelector("#pvp-view-opp"))==null||ln.addEventListener("click",()=>q()),(cn=e.querySelector("#pvp-toggle-history"))==null||cn.addEventListener("click",()=>G()),k&&(clearInterval(k),k=null),Ue(),(D||P)&&!M){let J=30,me=!1;const Se=()=>document.getElementById("pvp-timer"),we=()=>{Se()&&(Se().textContent=J+"s",Se().style.color=me?"#ff4444":"#fff")};we(),k=setInterval(()=>{J--,J<0?me?(clearInterval(k),k=null,Ue(),D&&!ct(p)?se():L()):(me=!0,J=15,we(),Cn("/sounds/timer-urgent.mp3",.6)):we()},1e3)}}function ue(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${T.map(A=>{const R={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",D=Pe(A,A._line)+(A.boost||0);return`<div class="bp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${R};overflow:hidden;cursor:pointer">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${j[O.job]||"#555"};border:3px solid ${Q};position:relative;overflow:hidden;margin:0 auto">
        ${St(O)?`<img src="${St(O)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      </div>`,document.body.appendChild(T),(S=T.querySelector("#pvp-hist-close"))==null||S.addEventListener("click",()=>T.remove())}async function se(){if(m.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",T=(m.round||0)+1,S=[...m.log||[]];S.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const j=$e(m),A=ct(_),R=j||!A?"finished":_+"-attack";await E({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:R,attacker:_,round:T,log:S}),R==="finished"&&await qe(m)}function de(_){const T=(_.GK||[]).some(j=>!j.used),S=["DEF","MIL","ATT"].some(j=>(_[j]||[]).some(A=>!A.used));return T&&!S}function ve(_){return(_.p1Score||0)!==(_.p2Score||0)?null:de(_.p1Team)&&!ke(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(T=>!T.used)}:de(_.p2Team)&&!ke(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(T=>!T.used)}:null}async function ze(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const T=(S,j)=>new Promise(A=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${j};letter-spacing:2px;animation:lcFade 1.4s ease both">${S}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(A,1400)});await T("⚽ DERNIER CORNER","#FFD700"),await T("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function he(_,T){const{side:S,gk:j}=_;if(!j)return;const A=S+"Score",R=(T[A]||0)+1;j.used=!0;const D=[...T.log||[]];D.push({type:"duel",isGoal:!0,homeScored:S===p,homePlayers:S==="p1"?[Dt(j)]:[],aiPlayers:S==="p2"?[Dt(j)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${T[S+"Name"]} marque !`});const P=(T.round||0)+1,O=S==="p1"?"p2":"p1",Q={...T,[A]:R},ne=$e(Q);B.add(P),await ze();const ie=S===p?R:T[p+"Score"]||0,ee=S===p?T[u+"Score"]||0:R;Qe([Dt(j)],ie,ee,S===p,async()=>{await E({[A]:R,log:D,round:P,pendingAttack:null,phase:ne?"finished":O+"-attack",attacker:O,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),ne&&await qe({...m,[A]:R})})}async function Ie(){const _=m[p+"Team"],T=!["GK","DEF","MIL","ATT"].some(R=>(m[u+"Team"][R]||[]).some(D=>!D.used)),S=(m["selected_"+p]||[]).map(R=>{const D=(_[R._role]||[]).find(le=>le.cardId===R.cardId)||R,P=["GK","DEF"].includes(R._role),O=_[R._role]||[],Q=O.findIndex(le=>le.cardId===R.cardId),ne=xt(O.length),ie=Q>=0?ne[Q]:D._col??1,ee=m.stadiumDef||m.homeStadiumDef||null,ae=D.stadiumBonus||ee&&(ee.club_id&&String(D.club_id)===String(ee.club_id)||ee.country_code&&D.country_code===ee.country_code)||!1;return{...D,_line:R._role,_col:ie,stadiumBonus:ae,...P?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!S.length)return;const j=oi(S,m.modifiers[p]||{},m[p+"Formation"]);fe(p,S.map(R=>R.cardId)),S.forEach(R=>{const D=(_[R._role]||[]).find(P=>P.cardId===R.cardId);D&&(D.used=!0)}),m["selected_"+p]=[],W();const A=[...m.log||[]];if(T){if(S.length===1&&(S[0]._line==="GK"||S[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await he({side:p,gk:S[0]},{...m,[p+"Team"]:_,log:A});return}const D=(m[p+"Score"]||0)+1,P=S.map(ee=>Dt(ee));A.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:j.total,aiTotal:0});const O=(m.round||0)+1,Q=p==="p1"?"p2":"p1",ne={...m,[p+"Team"]:_,[p+"Score"]:D},ie=$e(ne);B.add(O),Qe(P,D,m[u+"Score"]||0,!0,async()=>{await E({[p+"Team"]:_,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ie?"finished":Q+"-attack",attacker:Q,round:O,log:A}),ie&&await qe({...m,[p+"Score"]:D})});return}A.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${j.total})`}),await E({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],pendingAttack:{...j,players:S,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:A})}async function Ae(){const _=m[p+"Team"],T=(m["selected_"+p]||[]).map(ce=>{const xe=(_[ce._role]||[]).find(Le=>Le.cardId===ce.cardId)||ce,ye=_[ce._role]||[],oe=ye.findIndex(Le=>Le.cardId===ce.cardId),Ee=xt(ye.length),Re=oe>=0?Ee[oe]:xe._col??1;return{...xe,_line:ce._role,_col:Re}}),S=ri(T,m.modifiers[p]||{},m[p+"Formation"]);fe(p,T.map(ce=>ce.cardId)),T.forEach(ce=>{const xe=(_[ce._role]||[]).find(ye=>ye.cardId===ce.cardId);xe&&(xe.used=!0)}),m["selected_"+p]=[],W();const j=Qi(m.pendingAttack.total,S.total,m.modifiers[p]||{}),A=m.pendingAttack.side,R=j==="attack"||(j==null?void 0:j.goal),D=A==="p1"?"p2":"p1",P=(m.round||0)+1,O=(m.pendingAttack.players||[]).map(ce=>Dt(ce)),Q=[...m.log||[]];Q.push({type:"duel",isGoal:R,homeScored:R&&A===p,text:R?`⚽ BUT de ${m[A+"Name"]} ! (${m.pendingAttack.total} vs ${S.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${S.total})`,homePlayers:O,aiPlayers:T.map(ce=>Dt(ce)),homeTotal:m.pendingAttack.total,aiTotal:S.total});const ne=R?(m[A+"Score"]||0)+1:m[A+"Score"]||0,ie={...m,[p+"Team"]:_,[A+"Score"]:ne},ee=$e(ie),ae=ee?"finished":D+"-attack",le=!ee&&!R?ve(ie):null,ge=async()=>{if(le){await he(le,ie);return}await E({[p+"Team"]:_,[u+"Team"]:m[u+"Team"],[A+"Score"]:ne,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:D,round:P,log:Q}),(ae==="finished"||ee)&&await qe({...m,[A+"Score"]:ne})};if(R){const ce=A===p,xe=ce?ne:m[p+"Score"]||0,ye=ce?m[u+"Score"]||0:ne;B.add(P),Qe(O,xe,ye,ce,ge)}else await ge()}function Be(_){return["MIL","ATT"].some(T=>(_[T]||[]).some(S=>!S.used))}function ke(_){return["GK","DEF","MIL","ATT"].some(T=>(_[T]||[]).some(S=>!S.used))}function _t(_){return ke(_)&&!Be(_)}function ct(_){const T=m[_+"Team"],S=m[(_==="p1"?"p2":"p1")+"Team"];return!!(Be(T)||_t(T)&&!ke(S)||_t(T)&&!Be(S)&&ke(S))}function $e(_){return!ke(_.p1Team)&&!ke(_.p2Team)}function Ce(_){const T=_.p1Score||0,S=_.p2Score||0;return T===S?null:T>S?h.home_id:h.away_id}async function qe(_){zt(),Ue();try{const T=Ce(_),S=T?h.home_id===T?h.away_id:h.home_id:null,j=_.p1Score||0,A=_.p2Score||0,{data:R,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:T,p_home_score:j,p_away_score:A,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}T&&S&&Kr(T,S).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof c=="function")try{await c({homeScore:j,awayScore:A,winnerId:T,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(T){console.error("[PvP] finishMatch:",T)}}function Ge(){var A;const _=m[p+"Score"],T=m[u+"Score"],S=_>T,j=_===T;st(e),e.innerHTML=`
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.23-1602" style="cursor:pointer">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function Ma(){document.documentElement.setAttribute("data-theme",lo()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ni()}),document.getElementById("modal-close").addEventListener("click",Ni);const{data:{session:e}}=await v.auth.getSession();if(!e){Tn(),Sa(document.getElementById("app"),{onPlay:()=>pn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt})});return}be.user=e.user,await Zt(),Tn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(o=>{n[o.formation]=o.links}),go(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!be.profile){yo(document.getElementById("app"),{state:be,navigate:async()=>{await Zt(),Si()},toast:Pt,refreshProfile:Zt});return}const t=Array.isArray(be.profile.pending_boosters)?be.profile.pending_boosters:[];if(!be.profile.onboarding_done&&t.length>0){wr(document.getElementById("app"),{state:be,navigate:()=>Si(),toast:Pt,refreshProfile:Zt});return}Si(),setTimeout(()=>ya(be.profile,Gt,Pt),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(be.user=null,be.profile=null,document.getElementById("app").innerHTML="",pn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Pt}))})}function Ca(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function $i(){const e=document.getElementById("app");e&&(e.style.height=Ca()+"px")}window.addEventListener("resize",$i);window.addEventListener("orientationchange",()=>setTimeout($i,150));window.visualViewport&&window.visualViewport.addEventListener("resize",$i);function Si(){const e=()=>{var i;(i=be.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",be.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",$i(),Ia(),co()}function Tn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function po(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
