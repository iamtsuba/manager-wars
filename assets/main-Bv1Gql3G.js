import{s as _,l as ne,F as Ge,b as fe,c as st,d as Mt}from"./formation-links-CDBKB_z4.js";function Ye(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{x=!x,B(),S()})))}function S(){const I=document.getElementById("col-grid");I&&(g==="player"?Te(I):g==="formation"?xe(I):me(I))}function D(I,E,j,C,M){M=M||"#7a28b8";const F=document.getElementById("col-grid"),z=document.getElementById("col-big");if(!F||!z)return;var q=0;function O(){z.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+E(I[q])+"</div>";var P=z.querySelector("[data-card-id],[data-form-id],[data-gc-id]");P&&P.addEventListener("click",function(){C(I[q])}),requestAnimationFrame(function(){var N=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!N||!z)){var U=z.clientHeight-8,W=z.clientWidth-24,J=N.offsetHeight,X=N.offsetWidth;if(J>0&&X>0&&U>40){var ee=Math.min(U/J,W/X,1);N.style.transform="scale("+ee.toFixed(3)+")",N.style.transformOrigin="top center"}}}),F.innerHTML=I.map(function(N,U){return'<div class="col-mini-item" data-idx="'+U+'" style="flex-shrink:0;cursor:pointer;border-radius:8px;border:1.5px solid '+(U===q?M:"transparent")+';transition:border-color .15s;overflow:hidden">'+j(N,U===q)+"</div>"}).join(""),F.querySelectorAll(".col-mini-item").forEach(function(N){N.addEventListener("click",function(){q=Number(N.dataset.idx),O(),N.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}O()}function R(I){var E=.54,j=Math.round(140*E),C=Math.round(310*E),M;if(!I||I._fake){var F=I?I.player:null;if(!F)return"";M=Xe(F)}else M=Le(I,"");return'<div style="width:'+j+"px;height:"+C+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+E+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+M+"</div></div>"}function Y(I,E,j){E=E||100,j=j||140;var C=fe[I]||{},M={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},F=Math.max(3,Math.round(E*.06)),z=Object.entries(C).map(function(O){var P=O[0],N=O[1],U=P.replace(/\d+$/,""),W=M[U]||"#888",J=Math.round(N.x*E),X=Math.round(N.y*j);return'<circle cx="'+J+'" cy="'+X+'" r="'+F+'" fill="'+W+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),q=Math.max(1,Math.round(E/50));return'<svg viewBox="0 0 '+E+" "+j+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+E+'" height="'+j+'" fill="#1A6B3C"/><rect x="'+Math.round(E*.2)+'" y="'+Math.round(j*.02)+'" width="'+Math.round(E*.6)+'" height="'+Math.round(j*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+q+'"/><line x1="0" y1="'+Math.round(j*.5)+'" x2="'+E+'" y2="'+Math.round(j*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+q+'"/><ellipse cx="'+Math.round(E*.5)+'" cy="'+Math.round(j*.5)+'" rx="'+Math.round(E*.18)+'" ry="'+Math.round(j*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+q+'"/><rect x="'+Math.round(E*.2)+'" y="'+Math.round(j*.82)+'" width="'+Math.round(E*.6)+'" height="'+Math.round(j*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+q+'"/>'+z+"</svg>"}function Q(I,E,j){var C=j>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+j+"</div>":"",M=E?'data-form-id="'+E.id+'"':"",F=I.length>7?14:I.length>5?16:19,z=!!E;return"<div "+M+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(z?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(z?"":"filter:grayscale(1);opacity:0.5")+'">'+C+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(z?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+F+"px;font-weight:900;color:"+(z?"#1A6B3C":"#aaa")+';line-height:1">'+I+'</div></div><div style="flex:1;overflow:hidden;background:'+(z?"#1A6B3C":"#ccc")+'">'+Y(I,140,220)+"</div></div>"}function ge(I,E){var j=.54,C=Math.round(140*j),M=Math.round(305*j),F=Math.round(M*.22),z=M-F,q=I.length>7?5:7,O=Y(I,C,z),P=E?"1.5px solid #2a7a40":"1px solid #ddd",N=E?"":"filter:grayscale(1);opacity:0.45;",U=E?"#1A6B3C":"#bbb",W="#fff";return'<div style="width:'+C+"px;height:"+M+"px;border-radius:6px;border:"+P+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+N+'"><div style="height:'+F+"px;background:"+U+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+q+"px;font-weight:900;color:"+W+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(C-4)+'px">'+I+'</span></div><div style="height:'+z+'px;overflow:hidden;flex-shrink:0">'+O+"</div></div>"}function Te(I){if(x){const E=L();if(!E.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const j=E.map(C=>n.find(M=>M.player.id===C.id)||{_fake:!0,player:C,id:"fake-"+C.id});D(j,C=>C._fake?Xe(C.player):Le(C,""),C=>C._fake?R({player:C.player,id:"x",_fake:!0}):R(C),C=>{C._fake||Ze(C,n,h,t)},"#1A6B3C")}else{const E=A();if(!E.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const j={},C=[];E.forEach(M=>{j[M.player.id]||(j[M.player.id]=!0,C.push(M))}),D(C,M=>{const F=h[M.player.id]||1,z=F>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${F}</div>`:"",O=n.filter(P=>P.player.id===M.player.id&&P.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Le(M,z+O)},M=>R(M),M=>Ze(M,n,h,t),"#1A6B3C")}}function xe(I){const E=x?m:[...k];if(!E.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const j=E.map(C=>({formation:C,card:p.find(M=>M.formation===C)||null,owned:k.has(C)}));D(j,({formation:C,card:M,owned:F})=>Q(C,F?M:null,F?p.filter(z=>z.formation===C).length:0),({formation:C,owned:M})=>ge(C,M),({card:C,owned:M})=>{M&&C&&Nt(C,p,t,o)},"#1A6B3C")}function me(I){const E=Object.keys(f),j=x?E.length?E:y:[...b];if(!j.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const C=j.map(M=>({type:M,gc:ce[M]||{icon:"⚡",desc:""},def:f[M]||null,owned:b.has(M),card:c.find(F=>F.gc_type===M)||null}));D(C,({type:M,gc:F,def:z,owned:q,card:O})=>{const P=q?c.filter(Lt=>Lt.gc_type===M).length:0,N=P>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${P}</div>`:"",U=(z==null?void 0:z.gc_type)==="ultra_game_changer",W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},J={purple:"#b06ce0",light_blue:"#00d4ef"},X=W[z==null?void 0:z.color]||W.purple,ee=J[z==null?void 0:z.color]||J.purple,ye=(z==null?void 0:z.effect)||F.desc||"",Ve=z!=null&&z.image_url?`/manager-wars/icons/${z.image_url}`:null;return q&&O?`<div data-gc-id="${O.id}" data-gc-type="${M}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${ee};background:${X};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${ee}66;cursor:pointer">
          ${N}
        ...
        </div>`},({type:M,gc:F,def:z,owned:q})=>q?(()=>{const O=Math.round(75.60000000000001),P=Math.round(310*.54),N=Math.round(P*.65),U=Math.round(P*.18),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},J={purple:"#9b59b6",light_blue:"#00bcd4"},X=W[z==null?void 0:z.color]||W.purple,ee=J[z==null?void 0:z.color]||J.purple,ye=z!=null&&z.image_url?`/manager-wars/icons/${z.image_url}`:null;return`<div style="width:${O}px;height:${P}px;border-radius:8px;background:${X};border:1px solid ${ee};display:flex;flex-direction:column;overflow:hidden"><div style="height:${U}px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:7px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${O-6}px">${M}</span></div><div style="height:${N}px;display:flex;align-items:center;justify-content:center">${ye?`<img src="${ye}" style="max-width:${O-8}px;max-height:${N-4}px;object-fit:contain">`:`<span style="font-size:24px">${F.icon}</span>`}</div><div style="flex:1;display:flex;align-items:center;justify-content:center"><span style="font-size:7px;color:rgba(255,255,255,0.7);text-align:center;padding:0 2px">${((z==null?void 0:z.effect)||F.desc||"").slice(0,20)}</span></div></div>`})():(()=>{const O=Math.round(75.60000000000001),P=Math.round(310*.54);return`<div style="width:${O}px;height:${P}px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:22px">${F.icon}</span><span style="font-size:7px;color:#aaa;margin-top:4px;text-align:center;padding:0 4px">${M}</span></div>`})(),({type:M,owned:F})=>{F&&Gt(M,o)},"#7a28b8")}e.querySelectorAll(".col-tab-btn").forEach(I=>{I.addEventListener("click",()=>{g=I.dataset.tab,w="Tous",T="",x=!1,e.querySelectorAll(".col-tab-btn").forEach(E=>{const j=E.dataset.tab===g;E.style.borderBottomColor=j?"var(--green)":"transparent",E.style.color=j?"var(--green)":"var(--gray-600)"}),B(),S()})}),B(),S()}function Gt(e,t){const i=ce[e]||{icon:"⚡",desc:"Effet spécial."};t("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
  ...
  </div>`,setTimeout(()=>_i(e,t,i),5e3)}function _i(e,t,i){const a=t.homeTeam.MIL||[],d=t.aiTeam.MIL||[];function o(p){return p.reduce((u,f)=>u+H(f,"MIL"),0)}function s(p){let u=0;for(let f=0;f<p.length-1;f++){const m=ne(p[f],p[f+1]);m==="#00ff88"?u+=2:m==="#FFD700"&&(u+=1)}return u}const l=o(a)+s(a),r=o(d)+s(d),n=l>=r;function c(p,u,f){return`<div style="text-align:center">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
      ...
      `,n&&(t.boostCard={value:m})}t.attacker=n?"home":"ai",t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:a.map(m=>({name:m.name,note:H(m,"MIL"),portrait:V(m),job:m.job,country_code:m.country_code,rarity:m.rarity,clubName:m.clubName,clubLogo:m.clubLogo})),aiPlayers:d.map(m=>({name:m.name,note:H(m,"MIL"),portrait:V(m),job:m.job,country_code:m.country_code,rarity:m.rarity,clubName:m.clubName,clubLogo:m.clubLogo})),homeTotal:l,aiTotal:r,text:`Duel milieu : ${t.clubName} ${l} – ${r} IA → ${n?t.clubName+" attaque":"IA attaque"}`}),setTimeout(()=>{var y,h;const m=(y=t.boostCard)==null?void 0:y.value;e.innerHTML=`
  ...
  <div style="text-align:center;flex-shrink:0;width:38px">
    ...
    <div style="display:flex;align-items:center;gap:4px;${t?"flex-direction:row-reverse":""};background:rgba(255,255,255,0.04);border-radius:8px;padding:5px 8px;border:1px solid rgba(255,255,255,0.07)">
      ...
      ${ve(e.inPlayer||{})}
    </div>`}return`<div style="font-size:11px;color:${e.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${e.type==="goal"?700:400};padding:3px 2px">${e.text||""}</div>`}function K(e,t,i){var m,y,h,k,b,g,w,T;const a=t.selected.map(x=>x.cardId),d=t.usedSubIds||[],o=t.homeSubs.filter(x=>!d.includes(x.cardId));Object.values(t.homeTeam).flat().filter(x=>x.used).length>0&&o.length>0&&t.subsUsed<t.maxSubs,t.log[t.log.length-1];const l=t.phase==="ai-attack"||t.phase==="ai-defense",r=t.phase==="attack",n=t.phase==="defense",c=t.phase==="finished",p=t.gcCards.filter(x=>!t.usedGc.includes(x.id)),u=t.boostCard&&!t.boostUsed;if(e.style.overflow="hidden",e.innerHTML=`
  <style>
  ...
  `,document.body.appendChild(a);let c=!1;const p=()=>{c||(c=!0,a.remove(),i())};a.addEventListener("click",p),setTimeout(p,2e3)}function le(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function ot(e,t,i,a=null){if(t.phase!=="attack"){le("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){le(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!d.length){le("Aucun joueur utilisé à remplacer");return}if(!o.length){le("Aucun remplaçant disponible");return}let s=0,l=Math.max(0,o.findIndex(p=>p.cardId===a)),r=!1;const n=document.createElement("div");n.id="sub-overlay",n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function c(){var k,b,g,w,T,x;const p=d[s],u=o[l],f=Math.min(130,Math.round((window.innerWidth-90)/2)),m=Math.round(f*1.35),y=v=>`background:rgba(255,255,255,0.12);border:none;color:${v?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${v?"default":"pointer"};flex-shrink:0`;n.innerHTML=`
    ...
    </div>`,(k=n.querySelector("#sub-close"))==null||k.addEventListener("click",()=>n.remove()),(b=n.querySelector("#out-up"))==null||b.addEventListener("click",()=>{s>0&&(s--,c())}),(g=n.querySelector("#out-down"))==null||g.addEventListener("click",()=>{s<d.length-1&&(s++,c())}),(w=n.querySelector("#in-up"))==null||w.addEventListener("click",()=>{l>0&&(l--,c())}),(T=n.querySelector("#in-down"))==null||T.addEventListener("click",()=>{l<o.length-1&&(l++,c())});const h=(v,$,A,L)=>{const B=n.querySelector("#"+v);if(!B)return;let S=0;B.addEventListener("touchstart",D=>{S=D.touches[0].clientY},{passive:!0}),B.addEventListener("touchend",D=>{const R=D.changedTouches[0].clientY-S;if(Math.abs(R)<30)return;const Y=$();R<0&&Y<L-1?(A(Y+1),c()):R>0&&Y>0&&(A(Y-1),c())},{passive:!0})};h("in-panel",()=>l,v=>l=v,o.length),h("out-panel",()=>s,v=>s=v,d.length),(x=n.querySelector("#sub-confirm"))==null||x.addEventListener("click",v=>{if(v.preventDefault(),v.stopPropagation(),r)return;r=!0;const $=d[s],A=o[l];if(!$||!A)return;let L=null,B=-1;for(const[D,R]of Object.entries(t.homeTeam)){const Y=(R||[]).findIndex(Q=>Q.cardId===$.cardId);if(Y!==-1){L=D,B=Y;break}}if(B===-1||!L){le("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),n.remove();return}const S={...A,_line:L,_col:$._col||0,used:!1,boost:0};t.homeTeam[L].splice(B,1,S),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(A.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:$.name,firstname:$.firstname,note:H($,L),portrait:V($),job:$.job,country_code:$.country_code,rarity:$.rarity,clubName:$.clubName,clubLogo:$.clubLogo},inPlayer:{name:A.name,firstname:A.firstname,note:H(A,L),portrait:V(A),job:A.job,country_code:A.country_code,rarity:A.rarity,clubName:A.clubName,clubLogo:A.clubLogo},text:`🔄 ${A.firstname} ${A.name} remplace ${$.firstname} ${$.name}`}),n.remove(),Li($,A,()=>K(e,t,i))})}document.body.appendChild(n),c()}function Mi(e,t,i,a,d){var l,r;const o=ce[t]||{icon:"⚡",desc:"Carte spéciale."},s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;align-items:center;justify-content:center;padding:24px",s.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
      ${e.map(p=>{const u=p._line||p.job||"MIL",f={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[u]||"#555",m=H(p,u)+(p.boost||0),y=l.find(h=>h.cardId===p.cardId);return`<div class="gc-pick-item" data-cid="${p.cardId}"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${a.map(d=>`
        <div class="player-boost-opt" data-card-id="${d.cardId}"
          ...
          <div style="width:32px;height:32px;background:${se[d.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${H(d,d._line||d.job)}</div>
