import{s as k,l as Q,F as Ae,b as ye,c as Ye,d as xt}from"./formation-links-BrrCMBql.js";function Fe(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(i);const a=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",a),i.addEventListener("click",d=>{d.target===i&&a()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{a(),e("match",{matchMode:d.dataset.mode})})})}const re={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function F(e,t){if(!e)return 0;switch(t){case"GK":return Number(e.note_g)||0;case"DEF":return Number(e.note_d)||0;case"MIL":return Number(e.note_m)||0;case"ATT":return Number(e.note_a)||0;default:return 0}}function We(e){let t=0;for(let i=0;i<e.length-1;i++){const a=e[i],d=e[i+1];if(!a||!d)continue;const o=Q(a,d);o==="#00ff88"?t+=2:o==="#FFD700"&&(t+=1)}return t}function Je(e,t={}){const i=e.reduce((o,s)=>{const l=s._line||s.job;return o+(Number(l==="MIL"?s.note_m:s.note_a)||0)+(Number(s.boost)||0)},0),a=We(e);let d=i+a;return t.doubleAttack&&(d*=2),t.stolenNote&&(d-=t.stolenNote),{base:i,links:a,total:Math.max(0,d)}}function Xe(e,t={}){const i=e.reduce((o,s)=>{const l=s._line||s.job;let r=0;return l==="GK"?r=Number(s.note_g)||0:l==="MIL"?r=Number(s.note_m)||0:r=Number(s.note_d)||0,o+r+(Number(s.boost)||0)},0),a=We(e);let d=i+a;return t.stolenNote&&(d-=t.stolenNote),{base:i,links:a,total:Math.max(0,d)}}function Qe(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function Ze(e,t,i="easy"){const a=e.filter(s=>!s.used);if(!a.length)return[];const d=[...a].sort((s,l)=>{const r=t==="attack"?F(s,"ATT"):s._line==="GK"?F(s,"GK"):F(s,"DEF");return(t==="attack"?F(l,"ATT"):l._line==="GK"?F(l,"GK"):F(l,"DEF"))-r});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return d.slice(0,Math.min(o,d.length,3))}function vt(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const et={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},ge={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},de=["GK","DEF","MIL","ATT"],wt=["Tous","GK","DEF","MIL","ATT"],$t={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},Te={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function tt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ae(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Ne(e,t=""){var p,f;const i=e.player;if(!i)return"";const a=i.job||"ATT",d=ge[a],o=et[i.rarity]||"#ccc",s=ae(i,a),l=i.job2?ae(i,i.job2):null,r=i.job2?ge[i.job2]:null,n=tt(i),c=Te[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function _t(e){const t=e.job||"ATT",i=ae(e,t),a=Te[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function kt(e,t){var K,ie;const{state:i,navigate:a,toast:d,openModal:o,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await k.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),n=(l||[]).filter(A=>A.card_type==="player"&&A.player),c=(l||[]).filter(A=>A.card_type==="game_changer"),p=(l||[]).filter(A=>A.card_type==="formation"),f=Object.keys(Ae),u=Object.keys(re),m={};n.forEach(A=>{const L=A.player.id;m[L]=(m[L]||0)+1});const x=new Set(Object.keys(m).map(A=>String(A))),b=new Set(p.map(A=>A.formation)),$=new Set(c.map(A=>A.gc_type));let y="player",g="Tous",w="",E=!1;function h(){return[...n].sort((A,L)=>{const M=de.indexOf(A.player.job),j=de.indexOf(L.player.job);return M!==j?M-j:(A.player.surname_encoded||"").localeCompare(L.player.surname_encoded||"")})}function v(){return[...r||[]].sort((A,L)=>{const M=de.indexOf(A.job),j=de.indexOf(L.job);return M!==j?M-j:(A.surname_encoded||"").localeCompare(L.surname_encoded||"")})}function _(){return h().filter(A=>{const L=A.player,M=g==="Tous"||L.job===g,j=!w||`${L.firstname} ${L.surname_encoded}`.toLowerCase().includes(w);return M&&j})}function T(){return v().filter(A=>{const L=g==="Tous"||A.job===g,M=!w||`${A.firstname} ${A.surname_encoded}`.toLowerCase().includes(w);return L&&M})}e.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div id="col-grid" style="width:100%;min-height:100px;user-select:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{E=!E,I(),z()})))}function z(){const A=document.getElementById("col-grid");A&&(y==="player"?G(A):y==="formation"?q(A):O(A))}function C(A){return'<div style="scroll-snap-align:center;flex-shrink:0">'+A+"</div>"}function G(A){if(E){const L=T();if(!L.length){A.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}A.innerHTML=L.map(M=>{if(x.has(String(M.id))){const S=n.find(V=>V.player.id===M.id),N=m[M.id]||1,P=N>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${N}</div>`:"",U=n.filter(V=>V.player.id===M.id&&V.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return C(Ne(S,P+U))}return C(_t(M))}).join("")}else{const L=_();if(!L.length){A.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const M={},j=[];L.forEach(S=>{M[S.player.id]||(M[S.player.id]=!0,j.push(S))}),A.innerHTML=j.map(S=>{const N=m[S.player.id]||1,P=N>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${N}</div>`:"",U=n.filter(V=>V.player.id===S.player.id&&V.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return C(Ne(S,P+U))}).join(""),A.querySelectorAll("[data-card-id]").forEach(S=>{S.addEventListener("click",()=>{const N=n.find(P=>P.id===S.dataset.cardId);N&&At(N,n,m,t)})})}}function q(A){const L=E?f:[...b];if(!L.length){A.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}A.innerHTML=L.map(M=>{const j=b.has(M),S=j?p.find(H=>H.formation===M):null,N=j?p.filter(H=>H.formation===M).length:0,P=N>1?`<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${N}</div>`:"";return C(j&&S?`<div data-form-id="${S.id}" style="position:relative;background:linear-gradient(135deg,#1A6B3C,#2a8f52);border:2px solid #2a8f52;border-radius:12px;padding:16px;color:#fff;width:140px;display:flex;flex-direction:column;gap:6px;align-items:center;text-align:center;cursor:pointer">${P}<div style="font-size:36px">🏟️</div><div style="font-size:8px;background:rgba(255,255,255,0.2);padding:2px 8px;border-radius:10px">FORMATION</div><div style="font-weight:900;font-size:16px">${M}</div></div>`:`<div style="background:#eee;border:2px solid #ddd;border-radius:12px;padding:16px;color:#aaa;width:140px;display:flex;flex-direction:column;gap:6px;align-items:center;text-align:center;filter:grayscale(1);opacity:0.45"><div style="font-size:36px">🏟️</div><div style="font-size:8px;background:rgba(0,0,0,0.1);padding:2px 8px;border-radius:10px">FORMATION</div><div style="font-weight:900;font-size:16px">${M}</div></div>`)}).join(""),A.querySelectorAll("[data-form-id]").forEach(M=>{M.addEventListener("click",()=>{const j=p.find(S=>S.id===M.dataset.formId);j&&It(j,p,t,o)})})}function O(A){const L=E?u:[...$];if(!L.length){A.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}A.innerHTML=L.map(M=>{const j=re[M]||{icon:"⚡",desc:""},S=$.has(M),N=S?c.find(U=>U.gc_type===M):null,P=S?c.filter(U=>U.gc_type===M).length:0,H=P>1?`<div style="position:absolute;top:4px;right:4px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${P}</div>`:"";return C(S&&N?`<div data-gc-id="${N.id}" data-gc-type="${M}" style="position:relative;background:linear-gradient(135deg,#3d0a7a,#7a28b8);border:2px solid #9b59b6;border-radius:12px;padding:16px 12px;color:#fff;width:130px;display:flex;flex-direction:column;gap:6px;align-items:center;text-align:center;cursor:pointer">${H}<div style="font-size:36px">${j.icon}</div><div style="font-size:8px;background:rgba(255,255,255,0.2);padding:2px 8px;border-radius:10px">GAME CHANGER</div><div style="font-weight:900;font-size:13px">${M}</div><div style="font-size:9px;color:rgba(255,255,255,0.7)">${j.desc.slice(0,40)}</div></div>`:`<div style="background:#eee;border:2px dashed #ccc;border-radius:12px;padding:16px 12px;color:#aaa;width:130px;display:flex;flex-direction:column;gap:6px;align-items:center;text-align:center;filter:grayscale(1);opacity:0.45"><div style="font-size:36px">${j.icon}</div><div style="font-size:8px;background:rgba(0,0,0,0.1);padding:2px 8px;border-radius:10px">GAME CHANGER</div><div style="font-weight:900;font-size:13px">${M}</div></div>`)}).join(""),A.querySelectorAll("[data-gc-id]").forEach(M=>{M.addEventListener("click",()=>Et(M.dataset.gcType,o))})}e.querySelectorAll(".col-tab-btn").forEach(A=>{A.addEventListener("click",()=>{y=A.dataset.tab,g="Tous",w="",E=!1,e.querySelectorAll(".col-tab-btn").forEach(L=>{const M=L.dataset.tab===y;L.style.borderBottomColor=M?"var(--green)":"transparent",L.style.color=M?"var(--green)":"var(--gray-600)"}),I(),z()})}),I(),z(),(K=document.getElementById("col-prev"))==null||K.addEventListener("click",()=>{const A=document.getElementById("col-grid");A&&A.scrollBy({left:-160,behavior:"smooth"})}),(ie=document.getElementById("col-next"))==null||ie.addEventListener("click",()=>{const A=document.getElementById("col-grid");A&&A.scrollBy({left:160,behavior:"smooth"})})}function Et(e,t){const i=re[e]||{icon:"⚡",desc:"Effet spécial."};t("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const oe=1e3;function It(e,t,i,a){var x,b,$;const{state:d,toast:o,closeModal:s,navigate:l,refreshProfile:r}=i,n=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function p(){const y=ye[n]||{},g=Ae[n]||[],w=290,E=360,h=20;function v(T){const I=y[T];return I?{x:I.x*w,y:I.y*E}:null}let _=`<svg width="${w}" height="${E}" viewBox="0 0 ${w} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[T,I]of g){const z=v(T),C=v(I);!z||!C||(_+=`<line x1="${z.x}" y1="${z.y}" x2="${C.x}" y2="${C.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const T of Object.keys(y)){const I=v(T);if(!I)continue;const z=T.replace(/\d+/,""),C=c[z]||"#555";_+=`<circle cx="${I.x}" cy="${I.y}" r="${h}" fill="${C}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,_+=`<text x="${I.x}" y="${I.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${z}</text>`}return _+="</svg>",_}const f=t.filter(y=>y.formation===n),u=f.length,m=!e.is_for_sale;a(`Formation ${n}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(x=document.getElementById("direct-sell-form-btn"))==null||x.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${n} pour ${oe.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=f.find(w=>!w.is_for_sale)||f[0];if(!y){o("Aucune carte à vendre","error");return}const{error:g}=await k.from("cards").delete().eq("id",y.id);if(g){o(g.message,"error");return}await k.from("users").update({credits:(d.profile.credits||0)+oe}).eq("id",d.profile.id),await r(),o(`+${oe.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),l("collection")}),(b=document.getElementById("market-sell-form-btn"))==null||b.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){o("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",e.id),await k.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:y}),o("Carte mise en vente sur le marché !","success"),s(),l("collection")}),($=document.getElementById("cancel-sell-form-btn"))==null||$.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),l("collection")})}function At(e,t,i,a){var h,v,_,T,I,z;const{state:d,toast:o,openModal:s,closeModal:l,navigate:r,refreshProfile:n}=a,c=e.player,p=t.filter(C=>C.player.id===c.id),f=p.length,u=$t[c.rarity]||1e3,m=c.rarity!=="legende",x=tt(c),b=ae(c,c.job),$=c.job2?ae(c,c.job2):null,y=ge[c.job]||"#1A6B3C",g=c.job2?ge[c.job2]:null,w=et[c.rarity]||"#ccc",E=Te[c.country_code]||c.country_code||"";s(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_=document.getElementById("close-detail"))==null||_.addEventListener("click",l),(T=document.getElementById("direct-sell-btn"))==null||T.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${u.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const C=p.find(q=>!q.is_for_sale)||p[0];if(!C){o("Aucune carte à vendre","error");return}const{error:G}=await k.from("cards").delete().eq("id",C.id);if(G){o(G.message,"error");return}await k.from("users").update({credits:(d.profile.credits||0)+u}).eq("id",d.profile.id),await n(),o(`+${u.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),r("collection")}),(I=document.getElementById("market-sell-btn"))==null||I.addEventListener("click",async()=>{const C=parseInt(document.getElementById("sell-price").value);if(!C||C<1){o("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:C}).eq("id",e.id),await k.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:C}),o("Carte mise en vente sur le marché !","success"),l(),r("collection")}),(z=document.getElementById("cancel-sell-btn"))==null||z.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),l(),r("collection")})}const me={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function he(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function it(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ot(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Tt(e,t=44,i=58){var u;const a=e?he(e):null,d=e?ot(e):null,o=it(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",l=Y[s]||"#555",r={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",n=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,c=Math.round(i*.19),p=Math.round(i*.25),f=i-c-p;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${r};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=prompt("Nom du deck :",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!s)return;const{data:l,error:r}=await k.from("decks").insert({owner_id:i.profile.id,name:s}).select().single();if(r){d(r.message,"error");return}d("Deck créé !","success"),Re(l.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(s=>{s.addEventListener("click",()=>Re(s.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(s=>{s.addEventListener("click",async()=>{const l=prompt("Nouveau nom :",s.dataset.name);if(!l||l===s.dataset.name)return;const{error:r}=await k.from("decks").update({name:l}).eq("id",s.dataset.rename);if(r){d(r.message,"error");return}d("Deck renommé !","success"),ve(e,t)})}),e.querySelectorAll("[data-delete]").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${s.dataset.name}" ? Cette action est irréversible.`))return;await k.from("deck_cards").delete().eq("deck_id",s.dataset.delete);const{error:l}=await k.from("decks").delete().eq("id",s.dataset.delete);if(l){d(l.message,"error");return}d("Deck supprimé.","success"),ve(e,t)})})}async function Re(e,t,i){const{state:a,toast:d}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await k.from("decks").select("*").eq("id",e).single(),{data:s}=await k.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",a.profile.id),l=(s||[]).filter(u=>u.card_type==="player"&&u.player),r=(s||[]).filter(u=>u.card_type==="formation"),n=r.map(u=>u.formation).filter(Boolean),{data:c}=await k.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";n.length>0&&!n.includes(p)&&(p=n[0]);const f={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:r,availableFormations:n};(c||[]).forEach(u=>{u.is_starter?f.slots[u.position]=u.card_id:f.subs.includes(u.card_id)||f.subs.push(u.card_id)}),Z(t,f,i)}function Z(e,t,i){var r;const{navigate:a}=i;me[t.formation];const d=qe(t.formation),o=d.filter(n=>t.slots[n]).length,s=t.availableFormations.length>0?t.availableFormations:Object.keys(me),l=t.subs.map(n=>t.playerCards.find(c=>c.id===n)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div class="page">
  ...
  </div>`,Lt(e,t,d,i),document.getElementById("builder-back").addEventListener("click",()=>a("decks")),document.getElementById("formation-select").addEventListener("change",n=>{t.formation=n.target.value;const c=qe(t.formation),p={};c.forEach(f=>{t.slots[f]&&(p[f]=t.slots[f])}),t.slots=p,Z(e,t,i)}),document.getElementById("save-deck").addEventListener("click",()=>Ct(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(n=>{n.addEventListener("click",()=>{t.subs=t.subs.filter(c=>c!==n.dataset.removeSub),Z(e,t,i)})}),(r=document.getElementById("add-sub-btn"))==null||r.addEventListener("click",()=>{zt(t,e,i)})}function Lt(e,t,i,a){const d=e.querySelector("#deck-field");if(!d)return;const o=ye[t.formation]||{},s=Ye(t.formation)||[],l={};for(const $ of i){const y=t.slots[$],g=y?t.playerCards.find(w=>w.id===y):null;l[$]=g?g.player:null}const r=300,n=300,c=48,p=64,f=13,u=16,m=38;function x($){const y=o[$];return y?{x:y.x*r,y:y.y*n}:null}let b="";for(const[$,y]of s){const g=x($),w=x(y);if(!g||!w)continue;const E=l[$]?{...l[$],club_id:l[$].club_id,country_code:l[$].country_code,rarity:l[$].rarity}:null,h=l[y]?{...l[y],club_id:l[y].club_id,country_code:l[y].country_code,rarity:l[y].rarity}:null,v=Q(E,h);v==="#ff3333"||v==="#cc2222"?b+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${w.x.toFixed(1)}" y2="${w.y.toFixed(1)}" stroke="${v}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(b+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${w.x.toFixed(1)}" y2="${w.y.toFixed(1)}" stroke="${v}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,b+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${w.x.toFixed(1)}" y2="${w.y.toFixed(1)}" stroke="${v}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const $ of i){const y=x($);if(!y)continue;const g=l[$],w=$.replace(/\d+/,""),E=Y[w]||"#555",h=(y.x-c/2).toFixed(1),v=(y.y-p/2).toFixed(1),_={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[g==null?void 0:g.rarity]||"#aaa";if(g){const T=he(g),I=ot(g),z=it(g.country_code),C=Number(w==="GK"?g.note_g:w==="DEF"?g.note_d:w==="MIL"?g.note_m:g.note_a)||0,G=p-f-u;b+=`<defs><clipPath id="dcp-${$}"><rect x="${h}" y="${(y.y-p/2+f).toFixed(1)}" width="${c}" height="${G}"/></clipPath></defs>`,b+=`<rect x="${h}" y="${v}" width="${c}" height="${p}" rx="5" fill="${E}"/>`,T&&(b+=`<image href="${T}" x="${h}" y="${(y.y-p/2+f).toFixed(1)}" width="${c}" height="${G}" clip-path="url(#dcp-${$})" preserveAspectRatio="xMidYMin slice"/>`),b+=`<rect x="${h}" y="${v}" width="${c}" height="${f}" fill="rgba(255,255,255,0.93)"/>`,b+=`<text x="${y.x.toFixed(1)}" y="${(y.y-p/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(g.surname_encoded||"").slice(0,9)}</text>`;const q=(y.y+p/2-u).toFixed(1);b+=`<rect x="${h}" y="${q}" width="${c}" height="${u}" fill="rgba(255,255,255,0.93)"/>`,z&&(b+=`<image href="${z}" x="${(y.x-21).toFixed(1)}" y="${(y.y+p/2-u+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),b+=`<text x="${y.x.toFixed(1)}" y="${(y.y+p/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${C}</text>`,I&&(b+=`<image href="${I}" x="${(y.x+c/2-14).toFixed(1)}" y="${(y.y+p/2-u+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),b+=`<rect x="${h}" y="${v}" width="${c}" height="${p}" rx="5" fill="none" stroke="${_}" stroke-width="2"/>`}else b+=`<rect x="${h}" y="${v}" width="${c}" height="${p}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,b+=`<text x="${y.x.toFixed(1)}" y="${y.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,b+=`<text x="${y.x.toFixed(1)}" y="${(y.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${w}</text>`;b+=`<rect x="${h}" y="${v}" width="${c}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${$}" style="cursor:pointer"/>`}d.innerHTML=`<svg viewBox="${-m} ${-m} ${r+m*2} ${n+m*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${b}</svg>`,d.querySelectorAll(".deck-slot-hit").forEach($=>{$.addEventListener("click",()=>Mt($.dataset.pos,t,e,a))})}function Mt(e,t,i,a){var f,u,m;const{openModal:d,closeModal:o}=a,s=e.replace(/\d+/,""),l=t.slots[e],r=l?t.playerCards.find(x=>x.id===l):null;(f=r==null?void 0:r.player)==null||f.id;const n=new Set;Object.entries(t.slots).forEach(([x,b])=>{var y;if(x===e||!b)return;const $=t.playerCards.find(g=>g.id===b);(y=$==null?void 0:$.player)!=null&&y.id&&n.add($.player.id)}),t.subs.forEach(x=>{var $;const b=t.playerCards.find(y=>y.id===x);($=b==null?void 0:b.player)!=null&&$.id&&n.add(b.player.id)});const c=new Set,p=t.playerCards.filter(x=>{const b=x.player;return!(b.job===s||b.job2===s)||n.has(b.id)||c.has(b.id)?!1:(c.add(b.id),!0)});p.sort((x,b)=>{const $=s==="GK"?x.player.note_g:s==="DEF"?x.player.note_d:s==="MIL"?x.player.note_m:x.player.note_a;return(s==="GK"?b.player.note_g:s==="DEF"?b.player.note_d:s==="MIL"?b.player.note_m:b.player.note_a)-$}),d(`Choisir ${s} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${p.length>0?p.map(x=>{var w,E;const b=x.player,$=s==="GK"?b.note_g:s==="DEF"?b.note_d:s==="MIL"?b.note_m:b.note_a,y=he(b),g={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[b.rarity];return`<div class="player-option" data-card-id="${x.id}"
          ...
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${Y[s]}">
            ${y?`<img src="${y}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${Y[s]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${s}</div>`}
          </div>
          <!-- Infos -->
  ...
  `,document.body.appendChild(a);let d=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(d)return;d=!0;const u=document.getElementById("pack-visual");u.classList.add("shaking"),setTimeout(()=>{u.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",s(0)},600)},500)});let o=0;function s(u){o=u;const m=document.getElementById("reveal-phase");m.style.display="flex",l(u)}function l(u){var h;const m=e[u],x=document.getElementById("card-counter"),b=document.getElementById("single-card-slot"),$=document.getElementById("card-tap-hint");x&&(x.textContent=`Carte ${u+1} / ${e.length}`),$&&($.textContent=u<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const y=Pe(m),g=m.card_type==="player"&&((h=m.player)==null?void 0:h.rarity)==="legende";b.innerHTML=`
      ...
      </div>`,g&&c();const w=document.getElementById("current-card-wrap");let E=!1;w.addEventListener("click",()=>{if(E)return;E=!0;const v=u+1;v<e.length?(w.style.transition="all 0.25s ease",w.style.transform="translateX(-120%) rotate(-15deg)",w.style.opacity="0",setTimeout(()=>l(v),250)):r()})}function r(){p(),document.getElementById("reveal-phase").style.display="none";const u=document.getElementById("recap-phase");u.style.display="flex";const m=document.getElementById("recap-grid");m.innerHTML=e.map((x,b)=>`
      ...
      <div style="padding:6px 8px;background:rgba(0,0,0,0.3);text-align:center">
        <div style="font-size:9px;color:rgba(255,255,255,0.85);line-height:1.3">${((o==null?void 0:o.effect)||((d=we[e.gc_type])==null?void 0:d.desc)||"").slice(0,55)}</div>
      </div>
      ...
      </div>`,document.body.appendChild(a),a.addEventListener("click",s=>{s.target===a&&a.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>a.remove());return}Zt()}function Zt(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const ei="simulation",at="VOTRE_ZONE_ID";function ti(){switch(ei){case"propellerads":return ii();case"adsense":return oi();default:return Le()}}function Le(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const a=setInterval(()=>{i--;const d=document.getElementById("ad-cd"),o=document.getElementById("ad-skip");d&&(d.textContent=i),o&&(o.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(a),o&&(o.disabled=!1,o.style.cssText=o.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),o==null||o.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function ii(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(Le());window.propeller.push({zone_id:at,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function oi(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(Le());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:at,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const ee={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},te={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function st(e,t,i,a,d){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${a}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",d)}function R(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function $e(e){var i,a;const t=e.player;return{cardId:e.id,id:t.id,firstname:t.firstname,name:t.surname_encoded,country_code:t.country_code,club_id:t.club_id,job:t.job,job2:t.job2,note_g:Number(t.note_g)||0,note_d:Number(t.note_d)||0,note_m:Number(t.note_m)||0,note_a:Number(t.note_a)||0,rarity:t.rarity,skin:t.skin,hair:t.hair,hair_length:t.hair_length,clubName:((i=t.clubs)==null?void 0:i.encoded_name)||null,clubLogo:((a=t.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Me(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function ni(){const e=Math.random()*100;return e<.1?4:e<5?3:e<20?2:1}function dt(e,t){const i=ee[t]||ee["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},d=[...e];for(const o of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<i[o];r++){let n=d.findIndex(c=>c.job===o);if(n===-1&&(n=d.findIndex(c=>c.job2===o)),n===-1&&(n=0),d[n]){const c={...d[n],_line:o};s.push(c),d.splice(n,1)}}const l=Me(s.length);s.forEach((r,n)=>{r._col=l[n]}),a[o]=s}return a}async function ri(e,t){var s,l;const{data:i}=await k.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return ai(e);const a=ee[e]||ee["4-4-2"],d={GK:[],DEF:[],MIL:[],ATT:[]},o=[...i];for(const r of["GK","DEF","MIL","ATT"]){const n=o.filter(m=>m.job===r),c=o.filter(m=>m.job!==r),p=[...n,...c],f=[];for(let m=0;m<a[r];m++){const x=p[m]||o[m];x&&f.push({cardId:"ai-"+x.id+"-"+m,id:x.id,firstname:x.firstname,name:x.surname_encoded,country_code:x.country_code,club_id:x.club_id,job:x.job,job2:x.job2,note_g:Number(x.note_g)||0,note_d:Number(x.note_d)||0,note_m:Number(x.note_m)||0,note_a:Number(x.note_a)||0,rarity:x.rarity,skin:x.skin,hair:x.hair,hair_length:x.hair_length,clubName:((s=x.clubs)==null?void 0:s.encoded_name)||null,clubLogo:((l=x.clubs)==null?void 0:l.logo_url)||null,boost:0,used:!1,_line:r})}const u=Me(f.length);f.forEach((m,x)=>{m._col=u[x]}),d[r]=f}return d}function ai(e){const t=ee[e]||ee["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},a=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let d=0;for(const o of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<t[o];r++){const n=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+d,id:"fake-"+d,firstname:"IA",name:a[d%a.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?n:2,note_d:o==="DEF"?n:2,note_m:o==="MIL"?n:2,note_a:o==="ATT"?n:2,rarity:"normal",boost:0,used:!1,_line:o}),d++}const l=Me(s.length);s.forEach((r,n)=>{r._col=l[n]}),i[o]=s}return i}async function si(e,t){var h;const{state:i,navigate:a,toast:d}=t,o=i.params||{};e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const s=o.matchMode||"vs_ai_easy",l=s.replace("vs_ai_",""),r=s;if(!o.deckId)return li(e,t,s);const n=o.deckId,[{data:c},{data:p}]=await Promise.all([k.from("decks").select("formation,name").eq("id",n).single(),k.from("deck_cards").select(`position, is_starter, slot_order,
        card:cards(id, card_type, formation,
          player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
            note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
            clubs(encoded_name,logo_url)))`).eq("deck_id",n).order("slot_order")]),f=(p||[]).filter(v=>{var _;return v.is_starter&&((_=v.card)==null?void 0:_.player)}).map(v=>$e(v.card)),u=(p||[]).filter(v=>{var _;return!v.is_starter&&((_=v.card)==null?void 0:_.player)}).map(v=>$e(v.card));if(f.length<11){st(e,"⚠️",`Deck incomplet (${f.length}/11).`,"Compléter",()=>a("decks"));return}const m=(p||[]).find(v=>{var _;return((_=v.card)==null?void 0:_.card_type)==="formation"}),x=(c==null?void 0:c.formation)||((h=m==null?void 0:m.card)==null?void 0:h.formation)||"4-4-2",{data:b}=await k.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",i.profile.id).eq("card_type","game_changer"),{data:$}=await k.from("gc_definitions").select("*").eq("is_active",!0),y=(b||[]).map(v=>({...v,_gcDef:($==null?void 0:$.find(_=>_.name===v.gc_type||_.id===v.gc_definition_id))||null})),g=dt(f,x),w=await ri(x),E=async v=>{const{data:_}=await k.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:n,status:"in_progress"}).select().single(),T={gcDefs:$||[],matchId:_==null?void 0:_.id,mode:r,difficulty:l,formation:x,homeTeam:g,aiTeam:w,homeSubs:u,subsUsed:0,maxSubs:Math.min(u.length,3),homeScore:0,aiScore:0,gcCards:v,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};ci(e,T,t)};if(!y.length){E([]);return}di(e,y,E)}function di(e,t,i){let d=[];function o(l,r){const n=l._gcDef,c={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},p={purple:"#9b59b6",light_blue:"#00bcd4"},f=c[n==null?void 0:n.color]||c.purple,u=p[n==null?void 0:n.color]||p.purple;return`<div class="gc-select-card" data-id="${l.id}"
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center">
        ${x?`<div style="width:min(98vw, calc(100dvh - 400px));overflow:hidden;flex-shrink:0">${pt(x,m,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;min-height:100%;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div style="width:min(90vw,420px)">${ze(t.aiTeam,t.formation,null,[],300,300)}</div>
    <div style="font-size:15px;color:rgba(255,255,255,0.7)">
      <span class="loading-dots">Chargement</span>
    </div>
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>pi(e,t,i),5e3)}function pi(e,t,i){const a=t.homeTeam.MIL||[],d=t.aiTeam.MIL||[];function o(p){return p.reduce((f,u)=>f+F(u,"MIL"),0)}function s(p){let f=0;for(let u=0;u<p.length-1;u++){const m=Q(p[u],p[u+1]);m==="#00ff88"?f+=2:m==="#FFD700"&&(f+=1)}return f}const l=o(a)+s(a),r=o(d)+s(d),n=l>=r;function c(p,f,u){return`<div style="text-align:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((m,x)=>{const b=R(m),$=x<p.length-1?Q(m,p[x+1]):null,y=$&&$!=="#ff3333"&&$!=="#cc2222";return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;min-height:100%;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
      ...
      </div>`,(b=document.getElementById("start-match-btn"))==null||b.addEventListener("click",()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",D(e,t,i),t.attacker==="ai"&&setTimeout(()=>ke(e,t,i),800)})},100)},5e3)}function lt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function J(e,t=44,i=58){if(!e)return`<div style="width:${t}px;height:${i}px;border:1.5px dashed rgba(255,255,255,0.2);border-radius:5px"></div>`;const a=typeof e.portrait=="string"&&e.portrait.startsWith("http")?e.portrait:R(e),d=lt(e),o=e._line||e.job||"MIL",s=te[o]||"#555",l={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",r=e.note!==void 0?Number(e.note)||0:(Number(F(e,o))||0)+(e.boost||0),n=ct(e==null?void 0:e.country_code),c=Math.round(i*.19),p=Math.round(i*.25),f=i-Math.round(i*.19)-Math.round(i*.25),u=e!=null&&e.used?.28:1;return`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${l};background:${s};position:relative;overflow:hidden;flex-shrink:0;opacity:${u}">
    <div style="position:absolute;top:0;left:0;right:0;height:${c}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:center;z-index:2">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ${_e(e==null?void 0:e.country_code)?`<img src="${_e(e.country_code)}" style="width:${p+2}px;height:${p-3}px;object-fit:cover;border-radius:1px">`:`<span style="font-size:${p-4}px">${n}</span>`}
      ...
      ${d?`<img src="${d}" style="width:${p-4}px;height:${p-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,p-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
  ...
  </div>`}function le(e,t,i){if(!(e!=null&&e.length))return"";const a=e.slice(0,5);let d='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return a.forEach((o,s)=>{if(d+=J(o,40,52),s<a.length-1){const l=Q(o,a[s+1]);d+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(d+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),d+="</div>",d}function _e(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ct(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function ze(e,t,i,a,d=310,o=310){const s=ye[t]||{},l=Ye(t)||Ae[t]||[],r={},n=["ATT","MIL","DEF","GK"];for(const y of n)(e[y]||[]).forEach((w,E)=>{r[`${y}${E+1}`]=w});function c(y){const g=s[y];return g?{x:g.x*d,y:g.y*o}:null}let p="";for(const[y,g]of l){const w=c(y),E=c(g);if(!w||!E)continue;const h=r[y],v=r[g],_=Q(h,v);_==="#00ff88"||_==="#FFD700"?(p+=`<line x1="${w.x.toFixed(1)}" y1="${w.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${_}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const f=48,u=64,m=13,x=16,b={normal:"#aaaaaa",pépite:"#D4A017",papyte:"#111111",légende:"#7a28b8"};for(const[y,g]of Object.entries(r)){const w=c(y);if(!w||!g)continue;const E=y.replace(/[0-9]/g,""),h=te[E]||"#555",v=i==="attack"&&["MIL","ATT"].includes(E)&&!g.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!g.used,_=a.includes(g.cardId);let T;i==="attack"?T=E==="MIL"?Number(g.note_m)||0:Number(g.note_a)||0:i==="defense"?T=E==="GK"?Number(g.note_g)||0:E==="MIL"?Number(g.note_m)||0:Number(g.note_d)||0:T=Number(E==="GK"?g.note_g:E==="DEF"?g.note_d:E==="MIL"?g.note_m:g.note_a)||0,T=T+(g.boost||0);const I=(w.x-f/2).toFixed(1),z=(w.y-u/2).toFixed(1),C=g.used?.25:1,G=b[g==null?void 0:g.rarity]||b.normal,q=_?"#ff3030":G,O=_?3:(g==null?void 0:g.rarity)==="légende"||(g==null?void 0:g.rarity)==="pépite"?2.5:2,K=u-m-x;p+=`<defs><clipPath id="cp-${y}"><rect x="${I}" y="${(w.y-u/2+m).toFixed(1)}" width="${f}" height="${K}"/></clipPath></defs>`,p+=`<rect x="${I}" y="${z}" width="${f}" height="${u}" rx="5" fill="${h}" opacity="${C}"/>`;const ie=R(g);ie&&!g.used&&(p+=`<image href="${ie}" x="${I}" y="${(w.y-u/2+m).toFixed(1)}" width="${f}" height="${K}" clip-path="url(#cp-${y})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${I}" y="${z}" width="${f}" height="${m}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${w.x.toFixed(1)}" y="${(w.y-u/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(g.name||"").slice(0,9)}</text>`;const A=(w.y+u/2-x).toFixed(1);if(p+=`<rect x="${I}" y="${A}" width="${f}" height="${x}" fill="rgba(255,255,255,0.92)"/>`,g.used)p+=`<text x="${w.x.toFixed(1)}" y="${(w.y+u/2-x/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="13" font-weight="900" fill="rgba(0,0,0,0.4)" font-family="Arial Black">–</text>`;else{const L=_e(g.country_code);L?p+=`<image href="${L}" x="${(w.x-20).toFixed(1)}" y="${(w.y+u/2-x+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(w.x-13).toFixed(1)}" y="${(w.y+u/2-x/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${ct(g.country_code)}</text>`,p+=`<text x="${w.x.toFixed(1)}" y="${(w.y+u/2-x/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${T}</text>`;const M=lt(g);M?p+=`<image href="${M}" x="${(w.x+f/2-14).toFixed(1)}" y="${(w.y+u/2-x+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:g.clubName&&(p+=`<text x="${(w.x+14).toFixed(1)}" y="${(w.y+u/2-x/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(g.clubName||"").slice(0,3).toUpperCase()}</text>`),g.boost&&(p+=`<rect x="${(w.x+f/2-12).toFixed(1)}" y="${(w.y-u/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,p+=`<text x="${(w.x+f/2-5).toFixed(1)}" y="${(w.y-u/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${g.boost}</text>`)}p+=`<rect x="${I}" y="${z}" width="${f}" height="${u}" rx="5" fill="${_?"rgba(255,255,255,0.12)":"none"}" stroke="${q}" stroke-width="${O}" opacity="${C}"/>`,v&&(p+=`<rect x="${I}" y="${z}" width="${f}" height="${u}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${_?"selected":""}" data-card-id="${g.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const $=38;return`<svg viewBox="${-$} ${-$} ${d+$*2} ${o+$*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  </svg>`}function pt(e,t,i,a,d=300,o=300){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${ze(e,t,i,a,d,o)}
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);max-height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;position:relative">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const v=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${le((v.players||[]).map(_=>({..._,used:!1})),"#ff6b6b",v.total)}
            ...
            ${le((v.players||[]).map(_=>({..._,used:!1})),"#00ff88",v.total)}
    ...
    <div style="display:flex;flex:1;min-height:0;overflow:hidden">
      ...
      <div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;align-items:center;justify-content:center" id="match-field">
        <div class="terrain-wrapper" style="overflow:hidden;flex-shrink:0">
          ${pt(t.homeTeam,t.formation,t.phase,a,300,300)}
        </div>
      </div>
    </div>
      ...
      <div style="flex:1;display:grid;grid-template-columns:repeat(4,1fr);gap:3px;align-content:start">
        ${p.map(h=>{var v;return`
          <div class="gc-mini" data-gc-id="${h.id}" data-gc-type="${h.gc_type}"
            ...
            <div style="font-size:16px">${((v=re[h.gc_type])==null?void 0:v.icon)||"⚡"}</div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(h=>{var v,_,T;if(h.type==="duel"){const I=h.isGoal,z=h.homeScored?"#FFD700":I?"#ff6b6b":"rgba(255,255,255,0.3)",C=h.homeScored?"⚽ BUT !":I?"⚽ BUT IA !":(v=h.homePlayers)!=null&&v.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${I?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${z};margin-bottom:4px">
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${h.outPlayer?J({...h.outPlayer,used:!0,_line:h.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${h.inPlayer?J({...h.inPlayer,_line:h.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
  ...
  </div>`,requestAnimationFrame(()=>{const h=e.querySelector("#match-field"),v=e.querySelector(".terrain-wrapper");if(!h||!v)return;const _=h.clientHeight||h.offsetHeight,T=h.clientWidth||h.offsetWidth,I=Math.min(_,T)||280;v.style.width=I+"px",v.style.height=I+"px"}),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let h=!1,v=30;const _=()=>document.getElementById("match-timer"),T=()=>{const I=_();if(!I)return;const z=String(Math.floor(v/60)).padStart(2,"0"),C=String(v%60).padStart(2,"0");I.textContent=` ${z}:${C}`,I.style.color=h?"#ff2222":"#ff9500",I.style.fontWeight="900"};T(),t._timerInt=setInterval(()=>{if(v--,v<0)if(!h)h=!0,v=15,T();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",I.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(I),setTimeout(()=>{I.remove(),X(e,t,i)},2500)}else T()},1e3)}(m=document.getElementById("match-quit"))==null||m.addEventListener("click",()=>{confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,X(e,t,i))}),(x=document.getElementById("view-ai"))==null||x.addEventListener("click",()=>wi(t,i)),(b=document.getElementById("toggle-history"))==null||b.addEventListener("click",()=>{var h;(h=document.getElementById("match-history-panel"))==null||h.classList.add("open")}),($=document.getElementById("close-history"))==null||$.addEventListener("click",()=>{var h;(h=document.getElementById("match-history-panel"))==null||h.classList.remove("open")}),(y=document.getElementById("btn-action"))==null||y.addEventListener("click",()=>{t.selected.length!==0&&(r?gi(e,t,i):n&&mi(e,t,i))}),(g=document.getElementById("btn-results"))==null||g.addEventListener("click",()=>X(e,t,i)),e.querySelectorAll(".match-slot-hit").forEach(h=>{h.addEventListener("click",()=>ui(h,t,e,i))}),e.querySelectorAll(".gc-mini").forEach(h=>{h.addEventListener("click",()=>hi(h.dataset.gcId,h.dataset.gcType,e,t,i))}),(w=document.getElementById("boost-card"))==null||w.addEventListener("click",()=>vi(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(h=>{h.addEventListener("click",()=>Ke(e,t,i,h.dataset.subId))}),(E=document.getElementById("sub-btn-main"))==null||E.addEventListener("click",()=>Ke(e,t,i))}function ui(e,t,i,a){const d=e.dataset.cardId,o=e.dataset.role,s=t.selected.findIndex(l=>l.cardId===d);if(s!==-1)t.selected.splice(s,1);else{if(t.selected.length>=3){a.toast("Maximum 3 joueurs","error");return}const l=(t.homeTeam[o]||[]).find(r=>r.cardId===d);l&&t.selected.push({...l,_role:o,_line:o})}D(i,t,a)}function Ce(e,t,i){e.matchId&&k.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function gi(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ce(t,i,i.state.profile.id);const a=t.selected.map(o=>({...o,_line:o._role})),d=Je(a,t.modifiers.home);t.pendingAttack={...d,players:[...t.selected],side:"home"},t.selected.forEach(o=>{const s=(t.homeTeam[o._role]||[]).find(l=>l.cardId===o.cardId);s&&(s.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${d.total} (base ${d.base}${d.links?` +${d.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",D(e,t,i),setTimeout(()=>xi(e,t,i),1200)}function mi(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Ce(t,i,i.state.profile.id);const a=t.selected.map(l=>({...l,_line:l._role})),d=Xe(a,t.modifiers.home);t.selected.forEach(l=>{const r=(t.homeTeam[l._role]||[]).find(n=>n.cardId===l.cardId);r&&(r.used=!0)});const o=Qe(t.pendingAttack.total,d.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>({name:l.name,note:l._line==="MIL"?l.note_m:l.note_a,portrait:R(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo})),homePlayers:t.selected.map(l=>{const r=(t.homeTeam[l._role]||[]).find(n=>n.cardId===l.cardId)||l;return{name:r.name,note:r._line==="GK"?r.note_g:r._line==="MIL"?r.note_m:r.note_d,portrait:R(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo}}),homeTotal:d.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(o.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(o.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${d.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,D(e,t,i),je(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{se(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${d.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,se(e,t,i,"home-attack")}function ke(e,t,i){Ce(t,i,null);const a=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],d=Ze(a,"attack",t.difficulty);if(!d.length){ut(e,t,i);return}const o=Je(d,t.modifiers.ai);t.pendingAttack={...o,players:d,side:"ai"},d.forEach(n=>{n.used=!0}),t.log.push({text:`🤖 IA attaque : ${o.total} (${d.map(n=>n.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(n=>!n.used),r=(t.homeSubs||[]).filter(n=>!(t.usedSubIds||[]).includes(n.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!r){t.aiScore++;const n={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:d.map(c=>({name:c.name,note:c._line==="MIL"?c.note_m:c.note_a,portrait:R(c),job:c.job,country_code:c.country_code,rarity:c.rarity,clubName:c.clubName,clubLogo:c.clubLogo})),aiTotal:o.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(n),t.pendingAttack=null,D(e,t,i),je(n.aiPlayers,t.homeScore,t.aiScore,!1,()=>{se(e,t,i,"home-attack")});return}t.phase="defense",D(e,t,i)}function xi(e,t,i){const a=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],d=Ze(a,"defense",t.difficulty),o=d.length>0?Xe(d,t.modifiers.ai).total:0;d.forEach(r=>{r.used=!0});const s=Qe(t.pendingAttack.total,o,t.modifiers.ai),l={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(r=>({name:r.name,note:r._line==="MIL"?r.note_m:r.note_a,portrait:R(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiPlayers:d.map(r=>({name:r.name,note:r._line==="GK"?r.note_g:r._line==="MIL"?r.note_m:r.note_d,portrait:R(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),homeTotal:t.pendingAttack.total,aiTotal:o,isGoal:!1,homeScored:!1,text:""};if(s.shielded)l.text="🛡️ Bouclier IA !",t.log.push(l);else if(s.goal){t.homeScore++,l.isGoal=!0,l.homeScored=!0,l.text=`⚽ BUT ! (${t.pendingAttack.total} > ${o})`,t.log.push(l),t.modifiers.ai={},t.pendingAttack=null,D(e,t,i),je(l.homePlayers,t.homeScore,t.aiScore,!0,()=>{se(e,t,i,"ai-attack")});return}else l.text=`🧤 IA défend (${o} ≥ ${t.pendingAttack.total})`,t.log.push(l);t.modifiers.ai={},t.pendingAttack=null,se(e,t,i,"ai-attack")}function se(e,t,i,a){if(t.round++,ft(t)){X(e,t,i);return}if(a==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(o=>!o.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(s=>!s.used).length){X(e,t,i);return}t.phase="ai-attack",D(e,t,i),setTimeout(()=>ke(e,t,i),800);return}t.phase="attack",D(e,t,i)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(o=>!o.used).length){ut(e,t,i);return}t.phase="ai-attack",D(e,t,i),setTimeout(()=>ke(e,t,i),800)}}function ft(e){const t=["MIL","ATT","GK","DEF"].some(a=>(e.homeTeam[a]||[]).some(d=>!d.used)),i=["MIL","ATT","GK","DEF"].some(a=>(e.aiTeam[a]||[]).some(d=>!d.used));return!t&&!i}function ut(e,t,i){ft(t)?X(e,t,i):(t.phase="attack",D(e,t,i))}function yi(e,t,i){const a=document.createElement("div");a.style.cssText=`
    position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:800;
    display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;
    animation:subFadeIn 0.2s ease;
  `;const d=R(e),o=R(t),s=te[e.job]||"#555",l=te[t.job]||"#555",r=e.job==="GK"?e.note_g:e.job==="DEF"?e.note_d:e.job==="MIL"?e.note_m:e.note_a,n=t.job==="GK"?t.note_g:t.job==="DEF"?t.note_d:t.job==="MIL"?t.note_m:t.note_a;a.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(a);let c=!1;const p=()=>{c||(c=!0,a.remove(),i())};a.addEventListener("click",p),setTimeout(p,2e3)}function ne(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Ke(e,t,i,a=null){if(t.phase!=="attack"){ne("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){ne(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!d.length){ne("Aucun joueur utilisé à remplacer");return}if(!o.length){ne("Aucun remplaçant disponible");return}let s=0,l=Math.max(0,o.findIndex(p=>p.cardId===a)),r=!1;const n=document.createElement("div");n.id="sub-overlay",n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function c(){var $,y,g,w,E,h;const p=d[s],f=o[l],u=Math.min(130,Math.round((window.innerWidth-90)/2)),m=Math.round(u*1.35),x=v=>`background:rgba(255,255,255,0.12);border:none;color:${v?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${v?"default":"pointer"};flex-shrink:0`;n.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${f?J({...f,used:!1,boost:0},u,m):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?J({...p,used:!1,boost:0},u,m):"<div>—</div>"}</div>
    ...
    </div>`,($=n.querySelector("#sub-close"))==null||$.addEventListener("click",()=>n.remove()),(y=n.querySelector("#out-up"))==null||y.addEventListener("click",()=>{s>0&&(s--,c())}),(g=n.querySelector("#out-down"))==null||g.addEventListener("click",()=>{s<d.length-1&&(s++,c())}),(w=n.querySelector("#in-up"))==null||w.addEventListener("click",()=>{l>0&&(l--,c())}),(E=n.querySelector("#in-down"))==null||E.addEventListener("click",()=>{l<o.length-1&&(l++,c())});const b=(v,_,T,I)=>{const z=n.querySelector("#"+v);if(!z)return;let C=0;z.addEventListener("touchstart",G=>{C=G.touches[0].clientY},{passive:!0}),z.addEventListener("touchend",G=>{const q=G.changedTouches[0].clientY-C;if(Math.abs(q)<30)return;const O=_();q<0&&O<I-1?(T(O+1),c()):q>0&&O>0&&(T(O-1),c())},{passive:!0})};b("in-panel",()=>l,v=>l=v,o.length),b("out-panel",()=>s,v=>s=v,d.length),(h=n.querySelector("#sub-confirm"))==null||h.addEventListener("click",v=>{if(v.preventDefault(),v.stopPropagation(),r)return;r=!0;const _=d[s],T=o[l];if(!_||!T)return;let I=null,z=-1;for(const[G,q]of Object.entries(t.homeTeam)){const O=(q||[]).findIndex(K=>K.cardId===_.cardId);if(O!==-1){I=G,z=O;break}}if(z===-1||!I){ne("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),n.remove();return}const C={...T,_line:I,_col:_._col||0,used:!1,boost:0};t.homeTeam[I].splice(z,1,C),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(T.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:_.name,firstname:_.firstname,note:F(_,I),portrait:R(_),job:_.job,country_code:_.country_code,rarity:_.rarity,clubName:_.clubName,clubLogo:_.clubLogo},inPlayer:{name:T.name,firstname:T.firstname,note:F(T,I),portrait:R(T),job:T.job,country_code:T.country_code,rarity:T.rarity,clubName:T.clubName,clubLogo:T.clubLogo},text:`🔄 ${T.firstname} ${T.name} remplace ${_.firstname} ${_.name}`}),n.remove(),yi(_,T,()=>D(e,t,i))})}document.body.appendChild(n),c()}function hi(e,t,i,a,d){var l,r;const o=re[t]||{icon:"⚡",desc:"Carte spéciale."},s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;align-items:center;justify-content:center;padding:24px",s.innerHTML=`
    ...
    </div>`,document.body.appendChild(s),(l=s.querySelector("#gc-back"))==null||l.addEventListener("click",()=>s.remove()),(r=s.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{s.remove(),bi(e,t,i,a,d)})}function be(e,t,i,a,d,o){const s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let l=[];function r(){var n,c;s.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${a.map(d=>`
        <div class="player-boost-opt" data-card-id="${d.cardId}"
          ...
          <div style="width:32px;height:32px;background:${te[d.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${F(d,d._line||d.job)}</div>
          <div style="flex:1"><b>${d.firstname} ${d.name}</b><div style="font-size:11px;color:#888">${d._line||d.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(d=>{d.addEventListener("click",()=>{const o=d.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const l=(t.homeTeam[s]||[]).find(r=>r.cardId===o);if(l){l.boost=(l.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),D(e,t,i)})})}function je(e,t,i,a,d){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const s=Array.from({length:10},(n,c)=>`
  ...
  <div style="display:flex;gap:10px;animation:scoreIn 0.4s ease 1s both;position:relative;z-index:1">
    ${e.map(n=>`
    <div style="text-align:center">
      <div style="width:50px;height:50px;border-radius:50%;background:${te[n.job]||"#555"};border:2px solid #FFD700;position:relative;overflow:hidden;margin:0 auto">
  ...
  </div>`}const B={user:null,profile:null,page:"home",params:{}};function pe(e,t="info",i=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},i))}function Li(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ee(){document.getElementById("modal-overlay").classList.add("hidden")}async function fe(){if(!B.user)return;const{data:e}=await k.from("users").select("*").eq("id",B.user.id).single();e&&(B.profile=e)}const Se="mw_theme";function xe(){return localStorage.getItem(Se)||"light"}function Mi(e){var t;localStorage.setItem(Se,e),Ie(e),(t=B.profile)!=null&&t.id&&k.from("users").update({theme:e}).eq("id",B.profile.id).then(()=>{})}function Ie(e){document.documentElement.setAttribute("data-theme",e)}function ue(e,t={}){B.page=e,B.params=t,mt()}async function mt(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(a=>{a.classList.toggle("active",a.dataset.page===B.page)});const t=document.getElementById("nav-credits");t&&B.profile&&(t.textContent=`💰 ${(B.profile.credits||0).toLocaleString("fr")}`);const i={state:B,navigate:ue,toast:pe,openModal:Li,closeModal:Ee,refreshProfile:fe};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',B.page){case"home":await Ge(e,i);break;case"collection":await kt(e,i);break;case"decks":await ve(e,i);break;case"boosters":await Pt(e,i);break;case"match":await si(e,i);break;case"market":await _i(e,i);break;case"rankings":await Ai(e,i);break;case"matches":await Ti(e,i);break;default:await Ge(e,i)}}function zi(){const e=document.getElementById("app"),t=B.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(a=>{a.addEventListener("click",d=>{d.preventDefault(),ue(a.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>ue("home")),document.getElementById("nav-credits").addEventListener("click",()=>ue("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const d=xe()==="dark"?"light":"dark";Mi(d),He(d)}),He(xe())}function He(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function Ci(){Ie(xe()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&Ee()}),document.getElementById("modal-close").addEventListener("click",Ee);const{data:{session:e}}=await k.auth.getSession();if(!e){Ve(),Fe(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:pe});return}B.user=e.user,await fe(),Ve();try{const{data:t}=await k.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(a=>{i[a.formation]=a.links}),xt(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!B.profile){yt(document.getElementById("app"),{state:B,navigate:async()=>{await fe(),Ue()},toast:pe,refreshProfile:fe});return}B.profile.theme&&B.profile.theme!==xe()&&(localStorage.setItem(Se,B.profile.theme),Ie(B.profile.theme)),Ue(),k.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(B.user=null,B.profile=null,document.getElementById("app").innerHTML="",Fe(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:pe}))})}function Ue(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",zi(),mt()}function Ve(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}Ci();
