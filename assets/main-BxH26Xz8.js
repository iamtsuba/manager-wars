import{s as $,F as Xe,b as Ie,c as jt,l as fe,d as ri}from"./formation-links-CDBKB_z4.js";function vt(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(i);const s=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",s),i.addEventListener("click",c=>{c.target===i&&s()}),i.querySelectorAll("[data-mode]").forEach(c=>{c.addEventListener("click",()=>{s(),e("match",{matchMode:c.dataset.mode})})})}const de={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function te(e,t){if(!e)return 0;switch(t){case"GK":return Number(e.note_g)||0;case"DEF":return Number(e.note_d)||0;case"MIL":return Number(e.note_m)||0;case"ATT":return Number(e.note_a)||0;default:return 0}}const _t=["ATT","MIL","DEF","GK"];function Bt(e){let t=0;const i=e.length;for(let s=0;s<i;s++)for(let c=s+1;c<i;c++){const o=e[s],a=e[c];if(!o||!a)continue;const d=o._col!==void 0&&a._col!==void 0&&o._col===a._col,l=o._col!==void 0&&a._col!==void 0&&Math.abs(o._col-a._col)===1,n=_t.indexOf(o._line),r=_t.indexOf(a._line),p=Math.abs(n-r)===1;(o._line===a._line&&l||d&&p)&&(o.country_code&&a.country_code&&o.country_code===a.country_code&&t++,o.club_id&&a.club_id&&o.club_id===a.club_id&&t++)}return t}function Ze(e,t={}){const i=e.reduce((o,a)=>{const d=a._line||a.job;return o+(Number(d==="MIL"?a.note_m:a.note_a)||0)+(a.boost||0)},0),s=Bt(e);let c=i+s;return t.doubleAttack&&(c*=2),t.stolenNote&&(c-=t.stolenNote),{base:i,links:s,total:Math.max(0,c)}}function Qe(e,t={}){const i=e.reduce((o,a)=>{const d=a._line||a.job;let l=0;return d==="GK"?l=Number(a.note_g)||0:d==="MIL"?l=Number(a.note_m)||0:l=Number(a.note_d)||0,o+l+(a.boost||0)},0),s=Bt(e);let c=i+s;return t.stolenNote&&(c-=t.stolenNote),{base:i,links:s,total:Math.max(0,c)}}function et(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function Ft(e,t,i="easy"){const s=e.filter(a=>!a.used);if(!s.length)return[];const c=[...s].sort((a,d)=>{const l=t==="attack"?te(a,"ATT"):a._line==="GK"?te(a,"GK"):te(a,"DEF");return(t==="attack"?te(d,"ATT"):d._line==="GK"?te(d,"GK"):te(d,"DEF"))-l});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return c.slice(0,Math.min(o,c.length,3))}function ci(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const Dt={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Fe={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},Me=["GK","DEF","MIL","ATT"],pi=["Tous","GK","DEF","MIL","ATT"],ui={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},tt={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Gt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function $e(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Pe(e,t=""){var p,g;const i=e.player;if(!i)return"";const s=i.job||"ATT",c=Fe[s],o=Dt[i.rarity]||"#ccc",a=$e(i,s),d=i.job2?$e(i,i.job2):null,l=i.job2?Fe[i.job2]:null,n=Gt(i),r=tt[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function $t(e){const t=e.job||"ATT",i=$e(e,t),s=tt[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),n=(d||[]).filter(_=>_.card_type==="player"&&_.player),r=(d||[]).filter(_=>_.card_type==="game_changer"),p=(d||[]).filter(_=>_.card_type==="formation"),{data:g}=await $.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(g||[]).forEach(_=>{f[_.name]=_});const y=Object.keys(Xe),u=Object.keys(de),h={};n.forEach(_=>{const b=_.player.id;h[b]=(h[b]||0)+1}),new Set(Object.keys(h).map(_=>String(_)));const L=new Set(p.map(_=>_.formation)),v=new Set(r.map(_=>_.gc_type));let x="player",k="Tous",F="",m=!1;function A(){return[...n].sort((_,b)=>{const C=Me.indexOf(_.player.job),E=Me.indexOf(b.player.job);return C!==E?C-E:(_.player.surname_encoded||"").localeCompare(b.player.surname_encoded||"")})}function M(){return[...l||[]].sort((_,b)=>{const C=Me.indexOf(_.job),E=Me.indexOf(b.job);return C!==E?C-E:(_.surname_encoded||"").localeCompare(b.surname_encoded||"")})}function q(){return A().filter(_=>{const b=_.player,C=k==="Tous"||b.job===k,E=!F||`${b.firstname} ${b.surname_encoded}`.toLowerCase().includes(F);return C&&E})}function G(){return M().filter(_=>{const b=k==="Tous"||_.job===k,C=!F||`${_.firstname} ${_.surname_encoded}`.toLowerCase().includes(F);return b&&C})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function O(){const _=document.getElementById("col-filters");_&&(x==="player"?(_.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",b=>{F=b.target.value.toLowerCase(),V()}),e.querySelectorAll(".filter-btn").forEach(b=>{b.addEventListener("click",()=>{k=b.dataset.job,O(),V()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{m=!m,O(),V()})):(_.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{m=!m,O(),V()})))}function V(){const _=document.getElementById("col-grid");_&&(x==="player"?z(_):x==="formation"?N(_):D(_))}function Z(_,b,C,E,w){w=w||"#7a28b8";const B=document.getElementById("col-grid"),I=document.getElementById("col-big");if(!B||!I)return;var R=0;function j(){I.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+b(_[R])+"</div>";var H=I.querySelector("[data-card-id],[data-form-id],[data-gc-id]");H&&H.addEventListener("click",function(){E(_[R])}),requestAnimationFrame(function(){var K=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!K||!I)){var Q=I.clientHeight-8,ie=I.clientWidth-24,re=K.offsetHeight,ae=K.offsetWidth;if(re>0&&ae>0&&Q>40){var se=Math.min(Q/re,ie/ae,1);K.style.transform="scale("+se.toFixed(3)+")",K.style.transformOrigin="top center"}}}),B.innerHTML=_.map(function(K,Q){return'<div class="col-mini-item" data-idx="'+Q+'" style="flex-shrink:0;cursor:pointer;border-radius:8px;border:1.5px solid '+(Q===R?w:"transparent")+';transition:border-color .15s;overflow:hidden">'+C(K,Q===R)+"</div>"}).join(""),B.querySelectorAll(".col-mini-item").forEach(function(K){K.addEventListener("click",function(){R=Number(K.dataset.idx),j(),K.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}j()}function Y(_){var b=.54,C=Math.round(140*b),E=Math.round(310*b),w;if(!_||_._fake){var B=_?_.player:null;if(!B)return"";w=$t(B)}else w=Pe(_,"");return'<div style="width:'+C+"px;height:"+E+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+b+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+w+"</div></div>"}function U(_,b,C){b=b||100,C=C||140;var E=Ie[_]||{},w={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},B=Math.max(3,Math.round(b*.06)),I=Object.entries(E).map(function(j){var H=j[0],K=j[1],Q=H.replace(/\d+$/,""),ie=w[Q]||"#888",re=Math.round(K.x*b),ae=Math.round(K.y*C);return'<circle cx="'+re+'" cy="'+ae+'" r="'+B+'" fill="'+ie+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),R=Math.max(1,Math.round(b/50));return'<svg viewBox="0 0 '+b+" "+C+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+b+'" height="'+C+'" fill="#1A6B3C"/><rect x="'+Math.round(b*.2)+'" y="'+Math.round(C*.02)+'" width="'+Math.round(b*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+R+'"/><line x1="0" y1="'+Math.round(C*.5)+'" x2="'+b+'" y2="'+Math.round(C*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+R+'"/><ellipse cx="'+Math.round(b*.5)+'" cy="'+Math.round(C*.5)+'" rx="'+Math.round(b*.18)+'" ry="'+Math.round(C*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+R+'"/><rect x="'+Math.round(b*.2)+'" y="'+Math.round(C*.82)+'" width="'+Math.round(b*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+R+'"/>'+I+"</svg>"}function T(_,b,C){var E=C>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+C+"</div>":"",w=b?'data-form-id="'+b.id+'"':"",B=_.length>7?14:_.length>5?16:19,I=!!b;return"<div "+w+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(I?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(I?"":"filter:grayscale(1);opacity:0.5")+'">'+E+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(I?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+B+"px;font-weight:900;color:"+(I?"#1A6B3C":"#aaa")+';line-height:1">'+_+'</div></div><div style="flex:1;overflow:hidden;background:'+(I?"#1A6B3C":"#ccc")+'">'+U(_,140,220)+"</div></div>"}function S(_,b){var C=.54,E=Math.round(140*C),w=Math.round(305*C),B=Math.round(w*.22),I=w-B,R=_.length>7?5:7,j=U(_,E,I),H=b?"1.5px solid #2a7a40":"1px solid #ddd",K=b?"":"filter:grayscale(1);opacity:0.45;",Q=b?"#1A6B3C":"#bbb",ie="#fff";return'<div style="width:'+E+"px;height:"+w+"px;border-radius:6px;border:"+H+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+K+'"><div style="height:'+B+"px;background:"+Q+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+R+"px;font-weight:900;color:"+ie+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(E-4)+'px">'+_+'</span></div><div style="height:'+I+'px;overflow:hidden;flex-shrink:0">'+j+"</div></div>"}function z(_){if(m){const b=G();if(!b.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const C=b.map(E=>n.find(w=>w.player.id===E.id)||{_fake:!0,player:E,id:"fake-"+E.id});Z(C,E=>E._fake?$t(E.player):Pe(E,""),E=>E._fake?Y({player:E.player,id:"x",_fake:!0}):Y(E),E=>{E._fake||kt(E,n,h,t)},"#1A6B3C")}else{const b=q();if(!b.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const C={},E=[];b.forEach(w=>{C[w.player.id]||(C[w.player.id]=!0,E.push(w))}),Z(E,w=>{const B=h[w.player.id]||1,I=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",j=n.filter(H=>H.player.id===w.player.id&&H.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Pe(w,I+j)},w=>Y(w),w=>kt(w,n,h,t),"#1A6B3C")}}function N(_){const b=m?y:[...L];if(!b.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const C=b.map(E=>({formation:E,card:p.find(w=>w.formation===E)||null,owned:L.has(E)}));Z(C,({formation:E,card:w,owned:B})=>T(E,B?w:null,B?p.filter(I=>I.formation===E).length:0),({formation:E,owned:w})=>S(E,w),({card:E,owned:w})=>{w&&E&&xi(E,p,t,o)},"#1A6B3C")}function D(_){const b=Object.keys(f),C=m?b.length?b:u:[...v];if(!C.length){_.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const E=C.map(w=>({type:w,gc:de[w]||{icon:"⚡",desc:""},def:f[w]||null,owned:v.has(w),card:r.find(B=>B.gc_type===w)||null}));Z(E,({type:w,gc:B,def:I,owned:R,card:j})=>{const H=R?r.filter(Te=>Te.gc_type===w).length:0,K=H>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${H}</div>`:"",Q=(I==null?void 0:I.gc_type)==="ultra_game_changer",ie={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},re={purple:"#b06ce0",light_blue:"#00d4ef"},ae=ie[I==null?void 0:I.color]||ie.purple,se=re[I==null?void 0:I.color]||re.purple,ge=(I==null?void 0:I.effect)||B.desc||"",xe=I!=null&&I.image_url?`/manager-wars/icons/${I.image_url}`:null;return R&&j?`<div data-gc-id="${j.id}" data-gc-type="${w}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${se};background:${ae};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${se}66;cursor:pointer">
          ${K}
        ...
        </div>`},({type:w,gc:B,def:I,owned:R})=>R?(()=>{const j=Math.round(75.60000000000001),H=Math.round(310*.54),K=Math.round(H*.65),Q=Math.round(H*.18),ie={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},re={purple:"#9b59b6",light_blue:"#00bcd4"},ae=ie[I==null?void 0:I.color]||ie.purple,se=re[I==null?void 0:I.color]||re.purple,ge=I!=null&&I.image_url?`/manager-wars/icons/${I.image_url}`:null;return`<div style="width:${j}px;height:${H}px;border-radius:8px;background:${ae};border:1px solid ${se};display:flex;flex-direction:column;overflow:hidden"><div style="height:${Q}px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:7px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${j-6}px">${w}</span></div><div style="height:${K}px;display:flex;align-items:center;justify-content:center">${ge?`<img src="${ge}" style="max-width:${j-8}px;max-height:${K-4}px;object-fit:contain">`:`<span style="font-size:24px">${B.icon}</span>`}</div><div style="flex:1;display:flex;align-items:center;justify-content:center"><span style="font-size:7px;color:rgba(255,255,255,0.7);text-align:center;padding:0 2px">${((I==null?void 0:I.effect)||B.desc||"").slice(0,20)}</span></div></div>`})():(()=>{const j=Math.round(75.60000000000001),H=Math.round(310*.54);return`<div style="width:${j}px;height:${H}px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:22px">${B.icon}</span><span style="font-size:7px;color:#aaa;margin-top:4px;text-align:center;padding:0 4px">${w}</span></div>`})(),({type:w,owned:B,def:I})=>{B&&gi(w,I,o)},"#7a28b8")}e.querySelectorAll(".col-tab-btn").forEach(_=>{_.addEventListener("click",()=>{x=_.dataset.tab,k="Tous",F="",m=!1,e.querySelectorAll(".col-tab-btn").forEach(b=>{const C=b.dataset.tab===x;b.style.borderBottomColor=C?"var(--green)":"transparent",b.style.color=C?"var(--green)":"var(--gray-600)"}),O(),V()})}),O(),V()}function gi(e,t,i){const s=de[e]||{icon:"⚡",desc:"Effet spécial."},c=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},d=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,n=(t==null?void 0:t.name)||e,r=(t==null?void 0:t.effect)||s.desc,p=t!=null&&t.image_url?`/manager-wars/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const be=1e3;function xi(e,t,i,s){var u,h,L;const{state:c,toast:o,closeModal:a,navigate:d,refreshProfile:l}=i,n=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function p(){const v=Ie[n]||{},x=Xe[n]||[],k=290,F=360,m=20;function A(q){const G=v[q];return G?{x:G.x*k,y:G.y*F}:null}let M=`<svg width="${k}" height="${F}" viewBox="0 0 ${k} ${F}" xmlns="http://www.w3.org/2000/svg">`;for(const[q,G]of x){const O=A(q),V=A(G);!O||!V||(M+=`<line x1="${O.x}" y1="${O.y}" x2="${V.x}" y2="${V.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const q of Object.keys(v)){const G=A(q);if(!G)continue;const O=q.replace(/\d+/,""),V=r[O]||"#555";M+=`<circle cx="${G.x}" cy="${G.y}" r="${m}" fill="${V}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,M+=`<text x="${G.x}" y="${G.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${O}</text>`}return M+="</svg>",M}const g=t.filter(v=>v.formation===n),f=g.length,y=!e.is_for_sale;s(`Formation ${n}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(u=document.getElementById("direct-sell-form-btn"))==null||u.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${n} pour ${be.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const v=g.find(k=>!k.is_for_sale)||g[0];if(!v){o("Aucune carte à vendre","error");return}const{error:x}=await $.from("cards").delete().eq("id",v.id);if(x){o(x.message,"error");return}await $.from("users").update({credits:(c.profile.credits||0)+be}).eq("id",c.profile.id),await l(),o(`+${be.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(h=document.getElementById("market-sell-form-btn"))==null||h.addEventListener("click",async()=>{const v=parseInt(document.getElementById("sell-price-form").value);if(!v||v<1){o("Prix invalide","error");return}await $.from("cards").update({is_for_sale:!0,sale_price:v}).eq("id",e.id),await $.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:v}),o("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(L=document.getElementById("cancel-sell-form-btn"))==null||L.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),d("collection")})}async function kt(e,t,i,s){var M,q,G,O,V,Z;const{state:c,toast:o,openModal:a,closeModal:d,navigate:l,refreshProfile:n}=s,r=e.player,p=t.filter(Y=>Y.player.id===r.id),g=p.length,f=ui[r.rarity]||1e3,y=r.rarity!=="legende",u=Gt(r),h=$e(r,r.job),L=r.job2?$e(r,r.job2):null,v=Fe[r.job]||"#1A6B3C",x=r.job2?Fe[r.job2]:null,k=Dt[r.rarity]||"#ccc",F=tt[r.country_code]||r.country_code||"",{data:m}=await $.from("transfer_history").select("club_name, manager_name, source, price, transferred_at").eq("player_id",r.id).order("transferred_at",{ascending:!0}),A=m&&m.length?`
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(G=document.getElementById("close-detail"))==null||G.addEventListener("click",d),(O=document.getElementById("direct-sell-btn"))==null||O.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${r.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const Y=p.find(T=>!T.is_for_sale)||p[0];if(!Y){o("Aucune carte à vendre","error");return}const{error:U}=await $.from("cards").delete().eq("id",Y.id);if(U){o(U.message,"error");return}await $.from("users").update({credits:(c.profile.credits||0)+f}).eq("id",c.profile.id),await n(),o(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),d(),l("collection")}),(V=document.getElementById("market-sell-btn"))==null||V.addEventListener("click",async()=>{const Y=parseInt(document.getElementById("sell-price").value);if(!Y||Y<1){o("Prix invalide","error");return}await $.from("cards").update({is_for_sale:!0,sale_price:Y}).eq("id",e.id),await $.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:Y}),o("Carte mise en vente sur le marché !","success"),d(),l("collection")}),(Z=document.getElementById("cancel-sell-btn"))==null||Z.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),d(),l("collection")})}const De={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},pe={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ne(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function qt(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Rt(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function mi(e,t=44,i=58){var f;const s=e?Ne(e):null,c=e?Rt(e):null,o=qt(e==null?void 0:e.country_code),a=(e==null?void 0:e.job)||"MIL",d=pe[a]||"#555",l={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",n=Number(a==="GK"?e==null?void 0:e.note_g:a==="DEF"?e==null?void 0:e.note_d:a==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(i*.19),p=Math.round(i*.25),g=i-r-p;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${l};background:${d};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`:`<div style="width:${t}px;height:${i}px;border:2px dashed rgba(255,255,255,0.3);border-radius:5px;display:flex;align-items:center;justify-content:center;font-size:20px;color:rgba(255,255,255,0.3)">+</div>`}async function He(e,t){const{state:i,navigate:s,toast:c}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await $.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  <div class="page">
  ...
  <div class="page">
  ...
  </div>`,yi(e,t,c,i),document.getElementById("builder-back").addEventListener("click",()=>s("decks")),document.getElementById("formation-select").addEventListener("change",n=>{t.formation=n.target.value;const r=At(t.formation),p={};r.forEach(g=>{t.slots[g]&&(p[g]=t.slots[g])}),t.slots=p,ve(e,t,i)}),document.getElementById("save-deck").addEventListener("click",()=>bi(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(n=>{n.addEventListener("click",()=>{t.subs=t.subs.filter(r=>r!==n.dataset.removeSub),ve(e,t,i)})}),(l=document.getElementById("add-sub-btn"))==null||l.addEventListener("click",()=>{vi(t,e,i)})}function yi(e,t,i,s){const c=e.querySelector("#deck-field");if(!c)return;const o=Ie[t.formation]||{},a=jt(t.formation)||[],d={};for(const L of i){const v=t.slots[L],x=v?t.playerCards.find(k=>k.id===v):null;d[L]=x?x.player:null}const l=300,n=300,r=48,p=64,g=13,f=16,y=38;function u(L){const v=o[L];return v?{x:v.x*l,y:v.y*n}:null}let h="";for(const[L,v]of a){const x=u(L),k=u(v);if(!x||!k)continue;const F=d[L]?{...d[L],club_id:d[L].club_id,country_code:d[L].country_code,rarity:d[L].rarity}:null,m=d[v]?{...d[v],club_id:d[v].club_id,country_code:d[v].country_code,rarity:d[v].rarity}:null,A=fe(F,m);A==="#ff3333"||A==="#cc2222"?h+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${k.x.toFixed(1)}" y2="${k.y.toFixed(1)}" stroke="${A}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(h+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${k.x.toFixed(1)}" y2="${k.y.toFixed(1)}" stroke="${A}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,h+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${k.x.toFixed(1)}" y2="${k.y.toFixed(1)}" stroke="${A}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const L of i){const v=u(L);if(!v)continue;const x=d[L],k=L.replace(/\d+/,""),F=pe[k]||"#555",m=(v.x-r/2).toFixed(1),A=(v.y-p/2).toFixed(1),M={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[x==null?void 0:x.rarity]||"#aaa";if(x){const q=Ne(x),G=Rt(x),O=qt(x.country_code),V=Number(k==="GK"?x.note_g:k==="DEF"?x.note_d:k==="MIL"?x.note_m:x.note_a)||0,Z=p-g-f;h+=`<defs><clipPath id="dcp-${L}"><rect x="${m}" y="${(v.y-p/2+g).toFixed(1)}" width="${r}" height="${Z}"/></clipPath></defs>`,h+=`<rect x="${m}" y="${A}" width="${r}" height="${p}" rx="5" fill="${F}"/>`,q&&(h+=`<image href="${q}" x="${m}" y="${(v.y-p/2+g).toFixed(1)}" width="${r}" height="${Z}" clip-path="url(#dcp-${L})" preserveAspectRatio="xMidYMin slice"/>`),h+=`<rect x="${m}" y="${A}" width="${r}" height="${g}" fill="rgba(255,255,255,0.93)"/>`,h+=`<text x="${v.x.toFixed(1)}" y="${(v.y-p/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(x.surname_encoded||"").slice(0,9)}</text>`;const Y=(v.y+p/2-f).toFixed(1);h+=`<rect x="${m}" y="${Y}" width="${r}" height="${f}" fill="rgba(255,255,255,0.93)"/>`,O&&(h+=`<image href="${O}" x="${(v.x-21).toFixed(1)}" y="${(v.y+p/2-f+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),h+=`<text x="${v.x.toFixed(1)}" y="${(v.y+p/2-f/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${V}</text>`,G&&(h+=`<image href="${G}" x="${(v.x+r/2-14).toFixed(1)}" y="${(v.y+p/2-f+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),h+=`<rect x="${m}" y="${A}" width="${r}" height="${p}" rx="5" fill="none" stroke="${M}" stroke-width="2"/>`}else h+=`<rect x="${m}" y="${A}" width="${r}" height="${p}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,h+=`<text x="${v.x.toFixed(1)}" y="${v.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,h+=`<text x="${v.x.toFixed(1)}" y="${(v.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${k}</text>`;h+=`<rect x="${m}" y="${A}" width="${r}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${L}" style="cursor:pointer"/>`}c.innerHTML=`<svg viewBox="${-y} ${-y} ${l+y*2} ${n+y*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${h}</svg>`,c.querySelectorAll(".deck-slot-hit").forEach(L=>{L.addEventListener("click",()=>hi(L.dataset.pos,t,e,s))})}function hi(e,t,i,s){var g,f,y;const{openModal:c,closeModal:o}=s,a=e.replace(/\d+/,""),d=t.slots[e],l=d?t.playerCards.find(u=>u.id===d):null;(g=l==null?void 0:l.player)==null||g.id;const n=new Set;Object.entries(t.slots).forEach(([u,h])=>{var v;if(u===e||!h)return;const L=t.playerCards.find(x=>x.id===h);(v=L==null?void 0:L.player)!=null&&v.id&&n.add(L.player.id)}),t.subs.forEach(u=>{var L;const h=t.playerCards.find(v=>v.id===u);(L=h==null?void 0:h.player)!=null&&L.id&&n.add(h.player.id)});const r=new Set,p=t.playerCards.filter(u=>{const h=u.player;return!(h.job===a||h.job2===a)||n.has(h.id)||r.has(h.id)?!1:(r.add(h.id),!0)});p.sort((u,h)=>{const L=a==="GK"?u.player.note_g:a==="DEF"?u.player.note_d:a==="MIL"?u.player.note_m:u.player.note_a;return(a==="GK"?h.player.note_g:a==="DEF"?h.player.note_d:a==="MIL"?h.player.note_m:h.player.note_a)-L}),c(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${p.length>0?p.map(u=>{var k,F;const h=u.player,L=a==="GK"?h.note_g:a==="DEF"?h.note_d:a==="MIL"?h.note_m:h.note_a,v=Ne(h),x={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[h.rarity];return`<div class="player-option" data-card-id="${u.id}"
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(k=h.clubs)!=null&&k.logo_url?`<img src="${h.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((F=h.clubs)==null?void 0:F.encoded_name)||"—"}</span>`}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",o),(y=document.getElementById("remove-player"))==null||y.addEventListener("click",()=>{delete t.slots[e],o(),ve(i,t,s)}),document.querySelectorAll(".player-option").forEach(u=>{u.addEventListener("click",()=>{t.slots[e]=u.dataset.cardId,o(),ve(i,t,s)})})}function vi(e,t,i){var l;const{openModal:s,closeModal:c}=i,o=new Set;Object.values(e.slots).filter(Boolean).forEach(n=>{var p;const r=e.playerCards.find(g=>g.id===n);(p=r==null?void 0:r.player)!=null&&p.id&&o.add(r.player.id)}),e.subs.forEach(n=>{var p;const r=e.playerCards.find(g=>g.id===n);(p=r==null?void 0:r.player)!=null&&p.id&&o.add(r.player.id)});const a=new Set,d=e.playerCards.filter(n=>{var r,p,g;return o.has((r=n.player)==null?void 0:r.id)||a.has((p=n.player)==null?void 0:p.id)?!1:(a.add((g=n.player)==null?void 0:g.id),!0)});s("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${d.length>0?d.map(n=>{var f;const r=n.player,p=Ne(r),g=r.job==="GK"?r.note_g:r.job==="DEF"?r.note_d:r.job==="MIL"?r.note_m:r.note_a;return`<div class="player-option" data-card-id="${n.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const Oi="simulation",Pt="VOTRE_ZONE_ID";function Pi(){switch(Oi){case"propellerads":return Hi();case"adsense":return Ki();default:return it()}}function it(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const s=setInterval(()=>{i--;const c=document.getElementById("ad-cd"),o=document.getElementById("ad-skip");c&&(c.textContent=i),o&&(o.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(s),o&&(o.disabled=!1,o.style.cssText=o.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),o==null||o.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function Hi(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(it());window.propeller.push({zone_id:Pt,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function Ki(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(it());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:Pt,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const Lt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Ht={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ce(e,t,i,s,c){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${s}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",c)}function oe(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Ue(e,t){var s,c;const i=e.player;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_encoded,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:Number(i.note_g)||0,note_d:Number(i.note_d)||0,note_m:Number(i.note_m)||0,note_a:Number(i.note_a)||0,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,clubName:((s=i.clubs)==null?void 0:s.encoded_name)||null,clubLogo:((c=i.clubs)==null?void 0:c.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Ge(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Kt(){const e=Math.random()*100;return e<10?3:e<30?2:1}function qe(e,t){const i=Lt[t]||Lt["4-4-2"],s={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const d=e.filter(n=>n.position&&n.position.replace(/\d+$/,"")===a).sort((n,r)=>parseInt(n.position.replace(/\D+/g,""),10)-parseInt(r.position.replace(/\D+/g,""),10)).map(n=>({...n,_line:a})),l=Ge(d.length);d.forEach((n,r)=>{n._col=l[r]}),s[a]=d}return s}const o=[...e];for(const a of["GK","DEF","MIL","ATT"]){const d=[];for(let n=0;n<i[a];n++){let r=o.findIndex(p=>p.job===a);if(r===-1&&(r=o.findIndex(p=>p.job2===a)),r===-1&&(r=0),o[r]){const p={...o[r],_line:a};d.push(p),o.splice(r,1)}}const l=Ge(d.length);d.forEach((n,r)=>{n._col=l[r]}),s[a]=d}return s}function Ut(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"})}function le(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden})}function Vt(e,t,i){const c=new Set,o=t.filter(r=>{const p=r.gc_type||r.id;return c.has(p)?!1:(c.add(p),!0)});let a=[];function d(r,p){const g=r._gcDef,f={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},y={purple:"#9b59b6",light_blue:"#00bcd4"},u=f[g==null?void 0:g.color]||f.purple,h=y[g==null?void 0:g.color]||y.purple;return`<div class="gc-select-card" data-id="${r.id}"
    ...
    </div>`}const l=r=>{e.style.overflow="",e.style.height="",e.style.display="",e.style.flexDirection="",i(r)};function n(){var p,g,f;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const r=a.length===3;e.innerHTML=`
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center;padding:4px">
        ${u?`<div class="deck-preview-wrap" style="aspect-ratio:1/1;max-width:100%;max-height:100%;width:auto;height:100%;overflow:hidden">${Ee(u,y,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
  ...
  </div>`}function _e(e,t,i){if(!(e!=null&&e.length))return"";const s=e.slice(0,5);let c='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return s.forEach((o,a)=>{if(c+=ue(o,40,52),a<s.length-1){const d=fe(o,s[a+1]);c+=`<div style="width:7px;height:3px;background:${d==="#ff3333"||d==="#cc2222"?"rgba(255,255,255,0.12)":d};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(c+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),c+="</div>",c}function Ve(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Wt(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function ke(e,t,i,s,c=310,o=310){const a=Ie[t]||{},d=jt(t)||Xe[t]||[],l={},n=["ATT","MIL","DEF","GK"];for(const v of n)(e[v]||[]).forEach((k,F)=>{l[`${v}${F+1}`]=k});function r(v){const x=a[v];return x?{x:x.x*c,y:x.y*o}:null}let p="";for(const[v,x]of d){const k=r(v),F=r(x);if(!k||!F)continue;const m=l[v],A=l[x],M=fe(m,A);M==="#00ff88"||M==="#FFD700"?(p+=`<line x1="${k.x.toFixed(1)}" y1="${k.y.toFixed(1)}" x2="${F.x.toFixed(1)}" y2="${F.y.toFixed(1)}"
        stroke="${M}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,p+=`<line x1="${k.x.toFixed(1)}" y1="${k.y.toFixed(1)}" x2="${F.x.toFixed(1)}" y2="${F.y.toFixed(1)}"
        stroke="${M}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):p+=`<line x1="${k.x.toFixed(1)}" y1="${k.y.toFixed(1)}" x2="${F.x.toFixed(1)}" y2="${F.y.toFixed(1)}"
        stroke="${M}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=48,f=64,y=13,u=16,h={normal:"#aaaaaa",pépite:"#D4A017",papyte:"#111111",légende:"#7a28b8"};for(const[v,x]of Object.entries(l)){const k=r(v);if(!k||!x)continue;const F=v.replace(/[0-9]/g,""),m=Ht[F]||"#555",A=i==="attack"&&["MIL","ATT"].includes(F)&&!x.used||i==="defense"&&["GK","DEF","MIL"].includes(F)&&!x.used,M=s.includes(x.cardId);let q;i==="attack"?q=F==="MIL"?Number(x.note_m)||0:Number(x.note_a)||0:i==="defense"?q=F==="GK"?Number(x.note_g)||0:F==="MIL"?Number(x.note_m)||0:Number(x.note_d)||0:q=Number(F==="GK"?x.note_g:F==="DEF"?x.note_d:F==="MIL"?x.note_m:x.note_a)||0,q=q+(x.boost||0);const G=(k.x-g/2).toFixed(1),O=(k.y-f/2).toFixed(1),V=x.used?.25:1,Z=h[x==null?void 0:x.rarity]||h.normal,Y=M?"#ff3030":Z,U=M?3:(x==null?void 0:x.rarity)==="légende"||(x==null?void 0:x.rarity)==="pépite"?2.5:2,T=f-y-u;p+=`<defs><clipPath id="cp-${v}"><rect x="${G}" y="${(k.y-f/2+y).toFixed(1)}" width="${g}" height="${T}"/></clipPath></defs>`,p+=`<rect x="${G}" y="${O}" width="${g}" height="${f}" rx="5" fill="${m}" opacity="${V}"/>`;const S=oe(x);S&&!x.used&&(p+=`<image href="${S}" x="${G}" y="${(k.y-f/2+y).toFixed(1)}" width="${g}" height="${T}" clip-path="url(#cp-${v})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${G}" y="${O}" width="${g}" height="${y}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${k.x.toFixed(1)}" y="${(k.y-f/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(x.name||"").slice(0,9)}</text>`;const z=(k.y+f/2-u).toFixed(1);if(p+=`<rect x="${G}" y="${z}" width="${g}" height="${u}" fill="rgba(255,255,255,0.92)"/>`,x.used)p+=`<text x="${k.x.toFixed(1)}" y="${(k.y+f/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="13" font-weight="900" fill="rgba(0,0,0,0.4)" font-family="Arial Black">–</text>`;else{const N=Ve(x.country_code);N?p+=`<image href="${N}" x="${(k.x-20).toFixed(1)}" y="${(k.y+f/2-u+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(k.x-13).toFixed(1)}" y="${(k.y+f/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${Wt(x.country_code)}</text>`,p+=`<text x="${k.x.toFixed(1)}" y="${(k.y+f/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${q}</text>`;const D=Yt(x);D?p+=`<image href="${D}" x="${(k.x+g/2-14).toFixed(1)}" y="${(k.y+f/2-u+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:x.clubName&&(p+=`<text x="${(k.x+14).toFixed(1)}" y="${(k.y+f/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(x.clubName||"").slice(0,3).toUpperCase()}</text>`),x.boost&&(p+=`<rect x="${(k.x+g/2-12).toFixed(1)}" y="${(k.y-f/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,p+=`<text x="${(k.x+g/2-5).toFixed(1)}" y="${(k.y-f/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${x.boost}</text>`)}p+=`<rect x="${G}" y="${O}" width="${g}" height="${f}" rx="5" fill="${M?"rgba(255,255,255,0.12)":"none"}" stroke="${Y}" stroke-width="${U}" opacity="${V}"/>`,A&&(p+=`<rect x="${G}" y="${O}" width="${g}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${M?"selected":""}" data-card-id="${x.cardId}" data-role="${F}" style="cursor:pointer"/>`)}const L=38;return`<svg viewBox="${-L} ${-L} ${c+L*2} ${o+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  ...
  </div>`}async function Jt(e,t,i,s){var F;const{state:c,navigate:o,toast:a}=t;Ut();const d=c.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!d.deckId)return Ui(e,t,i);const l=d.deckId;let n,r,p,g;try{const m=await Promise.all([$.from("decks").select("formation,name").eq("id",l).single(),$.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]);n=m[0].data,p=m[0].error,r=m[1].data,g=m[1].error}catch(m){console.error("[Match] Exception chargement deck:",m),Ce(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(p||g){console.error("[Match] Erreur Supabase:",p||g),Ce(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const f=(r||[]).filter(m=>{var A;return m.is_starter&&((A=m.card)==null?void 0:A.player)}).map(m=>Ue(m.card,m.position)),y=(r||[]).filter(m=>{var A;return!m.is_starter&&((A=m.card)==null?void 0:A.player)}).map(m=>Ue(m.card,m.position));if(f.length<11){Ce(e,"⚠️",`Deck incomplet (${f.length}/11).`,"Compléter",()=>o("decks"));return}const u=(r||[]).find(m=>{var A;return((A=m.card)==null?void 0:A.card_type)==="formation"}),h=(n==null?void 0:n.formation)||((F=u==null?void 0:u.card)==null?void 0:F.formation)||"4-4-2",{data:L,error:v}=await $.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",c.profile.id).eq("card_type","game_changer"),{data:x}=await $.from("gc_definitions").select("*").eq("is_active",!0),k=(L||[]).map(m=>({...m,_gcDef:(x==null?void 0:x.find(A=>A.name===m.gc_type||A.id===m.gc_definition_id))||null}));s({deckId:l,formation:h,starters:f,subsRaw:y,gcCardsEnriched:k,gcDefs:x||[]})}async function Vi(e,t){const{state:i}=t,c=(i.params||{}).matchMode||"vs_ai_easy",o=c.replace("vs_ai_",""),a=c;await Jt(e,t,c,async({deckId:d,formation:l,starters:n,subsRaw:r,gcCardsEnriched:p,gcDefs:g})=>{const f=qe(n,l),y=await Yi(l),u=async h=>{const{data:L}=await $.from("matches").insert({home_id:i.profile.id,away_id:null,mode:a,home_deck_id:d,status:"in_progress"}).select().single(),v={gcDefs:g||[],matchId:L==null?void 0:L.id,mode:a,difficulty:o,formation:l,homeTeam:f,aiTeam:y,homeSubs:r,subsUsed:0,maxSubs:Math.min(r.length,3),homeScore:0,aiScore:0,gcCards:h,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Ji(e,v,t)};if(!p.length){u([]);return}Vt(e,p,u)})}async function Yi(e,t){var a,d;const{data:i}=await $.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return Wi(e);const s=FORMATIONS[e]||FORMATIONS["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},o=[...i];for(const l of["GK","DEF","MIL","ATT"]){const n=o.filter(y=>y.job===l),r=o.filter(y=>y.job!==l),p=[...n,...r],g=[];for(let y=0;y<s[l];y++){const u=p[y]||o[y];u&&g.push({cardId:"ai-"+u.id+"-"+y,id:u.id,firstname:u.firstname,name:u.surname_encoded,country_code:u.country_code,club_id:u.club_id,job:u.job,job2:u.job2,note_g:Number(u.note_g)||0,note_d:Number(u.note_d)||0,note_m:Number(u.note_m)||0,note_a:Number(u.note_a)||0,rarity:u.rarity,skin:u.skin,hair:u.hair,hair_length:u.hair_length,clubName:((a=u.clubs)==null?void 0:a.encoded_name)||null,clubLogo:((d=u.clubs)==null?void 0:d.logo_url)||null,boost:0,used:!1,_line:l})}const f=Ge(g.length);g.forEach((y,u)=>{y._col=f[u]}),c[l]=g}return c}function Wi(e){const t=FORMATIONS[e]||FORMATIONS["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},s=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<t[o];l++){const n=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:s[c%s.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?n:2,note_d:o==="DEF"?n:2,note_m:o==="MIL"?n:2,note_a:o==="ATT"?n:2,rarity:"normal",boost:0,used:!1,_line:o}),c++}const d=Ge(a.length);a.forEach((l,n)=>{l._col=d[n]}),i[o]=a}return i}function Ji(e,t,i){e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>Xi(e,t,i),5e3)}function Xi(e,t,i){const s=t.homeTeam.MIL||[],c=t.aiTeam.MIL||[];function o(p){return p.reduce((g,f)=>g+te(f,"MIL"),0)}function a(p){let g=0;for(let f=0;f<p.length-1;f++){const y=fe(p[f],p[f+1]);y==="#00ff88"?g+=2:y==="#FFD700"&&(g+=1)}return g}const d=o(s)+a(s),l=o(c)+a(c),n=d>=l;function r(p,g,f){return`<div style="text-align:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((y,u)=>{const h=oe(y),L=u<p.length-1?fe(y,p[u+1]):null,v=L&&L!=="#ff3333"&&L!=="#cc2222";return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
      ...
      </div>`,(h=document.getElementById("start-match-btn"))==null||h.addEventListener("click",()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",ne(e,t,i),t.attacker==="ai"&&setTimeout(()=>Ye(e,t,i),800)})},100)},5e3)}function Zi(e){if(e.type==="duel"){const t=e.homeTotal>=e.aiTotal;return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;height:100%;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const A=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${_e((A.players||[]).map(M=>({...M,used:!1})),"#ff6b6b",A.total)}
            ...
            ${_e((A.players||[]).map(M=>({...M,used:!1})),"#00ff88",A.total)}
    ...
    ${(()=>{const m=window.innerWidth>=700,A=(U,T,S)=>{var j,H;const z=(t.gcDefs||[]).find(K=>K.name===U.gc_type),N={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[z==null?void 0:z.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",D={purple:"#b06ce0",light_blue:"#00d4ef"}[z==null?void 0:z.color]||"#b06ce0",_=(z==null?void 0:z.name)||U.gc_type,b=(z==null?void 0:z.effect)||((j=de[U.gc_type])==null?void 0:j.desc)||"",C=z!=null&&z.image_url?`/manager-wars/icons/${z.image_url}`:null,E=((H=de[U.gc_type])==null?void 0:H.icon)||"⚡",w=Math.round(S*.22),B=Math.round(S*.22),I=S-w-B,R=_.length>12?7:9;return`<div class="gc-mini" data-gc-id="${U.id}" data-gc-type="${U.gc_type}"
          style="width:${T}px;height:${S}px;border-radius:10px;border:2px solid ${D};background:${N};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${w}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${R}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${T-6}px">${_}</span>
          ...
          <div style="height:${I}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${C?`<img src="${C}" style="max-width:${T-10}px;max-height:${I-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(I*.55)}px">${E}</span>`}
          </div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(m=>{var A,M,q;if(m.type==="duel"){const G=m.isGoal,O=m.homeScored?"#FFD700":G?"#ff6b6b":"rgba(255,255,255,0.3)",V=m.homeScored?"⚽ BUT !":G?"⚽ BUT IA !":(A=m.homePlayers)!=null&&A.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${G?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${O};margin-bottom:4px">
                <div style="font-size:9px;color:${O};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${V}</div>
                ${(M=m.homePlayers)!=null&&M.length?`<div style="margin-bottom:3px">${_e(m.homePlayers,"rgba(255,255,255,0.7)",m.homeTotal)}</div>`:""}
                ${(q=m.aiPlayers)!=null&&q.length?`<div style="opacity:0.7">${_e(m.aiPlayers,"#ff6b6b",m.aiTotal)}</div>`:""}
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${m.outPlayer?ue({...m.outPlayer,used:!0,_line:m.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${m.inPlayer?ue({...m.inPlayer,_line:m.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
  ...
  </div>`,function(){const A=e.querySelector(".terrain-wrapper svg");if(!A)return;A.removeAttribute("width"),A.removeAttribute("height"),A.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",A.setAttribute("viewBox","-26 -26 352 352"),A.setAttribute("preserveAspectRatio","xMidYMid meet");const M=e.querySelector(".match-screen");if(M){const q=e.clientHeight;q>50&&(M.style.height=q+"px",M.style.overflow="hidden")}}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const m=e.querySelector(".terrain-wrapper svg");m&&(m.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0")})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let m=!1,A=30;const M=()=>document.getElementById("match-timer"),q=()=>{const G=M();if(!G)return;const O=String(Math.floor(A/60)).padStart(2,"0"),V=String(A%60).padStart(2,"0");G.textContent=` ${O}:${V}`,G.style.color=m?"#ff2222":"#ff9500",G.style.fontWeight="900"};q(),t._timerInt=setInterval(()=>{if(A--,A<0)if(!m)m=!0,A=15,q();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const G=document.createElement("div");G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",G.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(G),setTimeout(()=>{G.remove(),he(e,t,i)},2500)}else q()},1e3)}(y=document.getElementById("match-quit"))==null||y.addEventListener("click",()=>{le(),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,he(e,t,i))}),(u=document.getElementById("view-ai"))==null||u.addEventListener("click",()=>so(t,i)),(h=document.getElementById("toggle-history"))==null||h.addEventListener("click",()=>{var m;(m=document.getElementById("match-history-panel"))==null||m.classList.add("open")}),(L=document.getElementById("close-history"))==null||L.addEventListener("click",()=>{var m;(m=document.getElementById("match-history-panel"))==null||m.classList.remove("open")}),(v=document.getElementById("btn-action"))==null||v.addEventListener("click",()=>{t.selected.length!==0&&(l?eo(e,t,i):n&&to(e,t,i))}),(x=document.getElementById("btn-results"))==null||x.addEventListener("click",()=>he(e,t,i)),e.querySelectorAll(".match-slot-hit").forEach(m=>{m.addEventListener("click",()=>Qi(m,t,e,i))}),e.querySelectorAll(".gc-mini").forEach(m=>{m.addEventListener("click",()=>no(m.dataset.gcId,m.dataset.gcType,e,t,i))}),(k=document.getElementById("boost-card"))==null||k.addEventListener("click",()=>ao(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(m=>{m.addEventListener("click",()=>Mt(e,t,i,m.dataset.subId))}),(F=document.getElementById("sub-btn-main"))==null||F.addEventListener("click",()=>Mt(e,t,i))}function Qi(e,t,i,s){const c=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(d=>d.cardId===c);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){s.toast("Maximum 3 joueurs","error");return}const d=(t.homeTeam[o]||[]).find(l=>l.cardId===c);d&&t.selected.push({...d,_role:o,_line:o})}ne(i,t,s)}function ot(e,t,i){e.matchId&&$.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function eo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),ot(t,i,i.state.profile.id);const s=t.selected.map(o=>({...o,_line:o._role})),c=Ze(s,t.modifiers.home);t.pendingAttack={...c,players:[...t.selected],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(d=>d.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${c.total} (base ${c.base}${c.links?` +${c.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",ne(e,t,i),setTimeout(()=>io(e,t,i),1200)}function to(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),ot(t,i,i.state.profile.id);const s=t.selected.map(d=>({...d,_line:d._role})),c=Qe(s,t.modifiers.home);t.selected.forEach(d=>{const l=(t.homeTeam[d._role]||[]).find(n=>n.cardId===d.cardId);l&&(l.used=!0)});const o=et(t.pendingAttack.total,c.total,t.modifiers.home),a={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>({name:d.name,note:d._line==="MIL"?d.note_m:d.note_a,portrait:oe(d),job:d.job,country_code:d.country_code,rarity:d.rarity,clubName:d.clubName,clubLogo:d.clubLogo})),homePlayers:t.selected.map(d=>{const l=(t.homeTeam[d._role]||[]).find(n=>n.cardId===d.cardId)||d;return{name:l.name,note:l._line==="GK"?l.note_g:l._line==="MIL"?l.note_m:l.note_d,portrait:oe(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo}}),homeTotal:c.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(o.shielded)a.text="🛡️ Bouclier ! But annulé.",t.log.push(a);else if(o.goal){t.aiScore++,a.isGoal=!0,a.homeScored=!1,a.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${c.total})`,t.log.push(a),t.selected=[],t.modifiers.home={},t.pendingAttack=null,ne(e,t,i),nt(a.aiPlayers,t.homeScore,t.aiScore,!1,()=>{Ae(e,t,i,"home-attack")});return}else a.text=`🧤 Défense réussie ! (${c.total} ≥ ${t.pendingAttack.total})`,t.log.push(a);t.selected=[],t.modifiers.home={},t.pendingAttack=null,Ae(e,t,i,"home-attack")}function Ye(e,t,i){ot(t,i,null);const s=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],c=Ft(s,"attack",t.difficulty);if(!c.length){Zt(e,t,i);return}const o=Ze(c,t.modifiers.ai);t.pendingAttack={...o,players:c,side:"ai"},c.forEach(n=>{n.used=!0}),t.log.push({text:`🤖 IA attaque : ${o.total} (${c.map(n=>n.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const a=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(n=>!n.used),l=(t.homeSubs||[]).filter(n=>!(t.usedSubIds||[]).includes(n.cardId)).length>0&&t.subsUsed<t.maxSubs;if(a.length===0&&!l){t.aiScore++;const n={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:c.map(r=>({name:r.name,note:r._line==="MIL"?r.note_m:r.note_a,portrait:oe(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiTotal:o.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(n),t.pendingAttack=null,ne(e,t,i),nt(n.aiPlayers,t.homeScore,t.aiScore,!1,()=>{Ae(e,t,i,"home-attack")});return}t.phase="defense",ne(e,t,i)}function io(e,t,i){const s=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],c=Ft(s,"defense",t.difficulty),o=c.length>0?Qe(c,t.modifiers.ai).total:0;c.forEach(l=>{l.used=!0});const a=et(t.pendingAttack.total,o,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(l=>({name:l.name,note:l._line==="MIL"?l.note_m:l.note_a,portrait:oe(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo})),aiPlayers:c.map(l=>({name:l.name,note:l._line==="GK"?l.note_g:l._line==="MIL"?l.note_m:l.note_d,portrait:oe(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo})),homeTotal:t.pendingAttack.total,aiTotal:o,isGoal:!1,homeScored:!1,text:""};if(a.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(a.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${o})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,ne(e,t,i),nt(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{Ae(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${o} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,Ae(e,t,i,"ai-attack")}function Ae(e,t,i,s){if(t.round++,Xt(t)){he(e,t,i);return}if(s==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(o=>!o.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(a=>!a.used).length){he(e,t,i);return}t.phase="ai-attack",ne(e,t,i),setTimeout(()=>Ye(e,t,i),800);return}t.phase="attack",ne(e,t,i)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(o=>!o.used).length){Zt(e,t,i);return}t.phase="ai-attack",ne(e,t,i),setTimeout(()=>Ye(e,t,i),800)}}function Xt(e){const t=["MIL","ATT","GK","DEF"].some(s=>(e.homeTeam[s]||[]).some(c=>!c.used)),i=["MIL","ATT","GK","DEF"].some(s=>(e.aiTeam[s]||[]).some(c=>!c.used));return!t&&!i}function Zt(e,t,i){Xt(t)?he(e,t,i):(t.phase="attack",ne(e,t,i))}function oo(e,t,i){const s=document.createElement("div");s.style.cssText=`
  ...
  `,document.body.appendChild(s);let r=!1;const p=()=>{r||(r=!0,s.remove(),i())};s.addEventListener("click",p),setTimeout(p,2e3)}function we(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Mt(e,t,i,s=null){if(t.phase!=="attack"){we("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){we(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const c=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!c.length){we("Aucun joueur utilisé à remplacer");return}if(!o.length){we("Aucun remplaçant disponible");return}let a=0,d=Math.max(0,o.findIndex(p=>p.cardId===s)),l=!1;const n=document.createElement("div");n.id="sub-overlay",n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function r(){var L,v,x,k,F,m;const p=c[a],g=o[d],f=Math.min(130,Math.round((window.innerWidth-90)/2)),y=Math.round(f*1.35),u=A=>`background:rgba(255,255,255,0.12);border:none;color:${A?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${A?"default":"pointer"};flex-shrink:0`;n.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${g?ue({...g,used:!1,boost:0},f,y):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?ue({...p,used:!1,boost:0},f,y):"<div>—</div>"}</div>
    ...
    </div>`,(L=n.querySelector("#sub-close"))==null||L.addEventListener("click",()=>n.remove()),(v=n.querySelector("#out-up"))==null||v.addEventListener("click",()=>{a>0&&(a--,r())}),(x=n.querySelector("#out-down"))==null||x.addEventListener("click",()=>{a<c.length-1&&(a++,r())}),(k=n.querySelector("#in-up"))==null||k.addEventListener("click",()=>{d>0&&(d--,r())}),(F=n.querySelector("#in-down"))==null||F.addEventListener("click",()=>{d<o.length-1&&(d++,r())});const h=(A,M,q,G)=>{const O=n.querySelector("#"+A);if(!O)return;let V=0;O.addEventListener("touchstart",Z=>{V=Z.touches[0].clientY},{passive:!0}),O.addEventListener("touchend",Z=>{const Y=Z.changedTouches[0].clientY-V;if(Math.abs(Y)<30)return;const U=M();Y<0&&U<G-1?(q(U+1),r()):Y>0&&U>0&&(q(U-1),r())},{passive:!0})};h("in-panel",()=>d,A=>d=A,o.length),h("out-panel",()=>a,A=>a=A,c.length),(m=n.querySelector("#sub-confirm"))==null||m.addEventListener("click",A=>{if(A.preventDefault(),A.stopPropagation(),l)return;l=!0;const M=c[a],q=o[d];if(!M||!q)return;let G=null,O=-1;for(const[Z,Y]of Object.entries(t.homeTeam)){const U=(Y||[]).findIndex(T=>T.cardId===M.cardId);if(U!==-1){G=Z,O=U;break}}if(O===-1||!G){we("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),n.remove();return}const V={...q,_line:G,_col:M._col||0,used:!1,boost:0};t.homeTeam[G].splice(O,1,V),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(q.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:M.name,firstname:M.firstname,note:te(M,G),portrait:oe(M),job:M.job,country_code:M.country_code,rarity:M.rarity,clubName:M.clubName,clubLogo:M.clubLogo},inPlayer:{name:q.name,firstname:q.firstname,note:te(q,G),portrait:oe(q),job:q.job,country_code:q.country_code,rarity:q.rarity,clubName:q.clubName,clubLogo:q.clubLogo},text:`🔄 ${q.firstname} ${q.name} remplace ${M.firstname} ${M.name}`}),n.remove(),oo(M,q,()=>ne(e,t,i))})}document.body.appendChild(n),r()}function no(e,t,i,s,c){var y,u;const o=(s.gcDefs||[]).find(h=>h.name===t),a=de[t]||{icon:"⚡",desc:"Carte spéciale."},d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",n=(o==null?void 0:o.name)||t,r=(o==null?void 0:o.effect)||a.desc,p=o!=null&&o.image_url?`/manager-wars/icons/${o.image_url}`:null,g=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(c=>{c.addEventListener("click",()=>{const o=c.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const d=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(d){d.boost=(d.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),ne(e,t,i)})})}function nt(e,t,i,s,c){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const a=Array.from({length:10},(n,r)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(o);let d=!1;const l=()=>{d||(d=!0,o.remove(),setTimeout(()=>c(),50))};o.addEventListener("click",l),setTimeout(l,3500)}async function he(e,t,i){var r,p;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,c=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=c?"victoire":o?"nul":"defaite",d=ci(t.mode,a);t.matchId&&await $.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?s.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(s.profile.credits||0)+d,matches_played:(s.profile.matches_played||0)+1};c?l.wins=(s.profile.wins||0)+1:o?l.draws=(s.profile.draws||0)+1:l.losses=(s.profile.losses||0)+1,await $.from("users").update(l).eq("id",s.profile.id),await i.refreshProfile();const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",n.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const f=()=>document.getElementById("mm-status"),y=async(x=!0)=>{p=!0,g&&($.removeChannel(g),g=null),x&&await $.rpc("cancel_matchmaking",{p_user_id:l.profile.id}).catch(()=>{})};(v=document.getElementById("mm-cancel"))==null||v.addEventListener("click",async()=>{try{await y(!0)}catch(x){console.warn("[Matchmaking] cleanup error:",x)}le(),n("home")});const u=async(x,k,F)=>{p||(p=!0,g&&($.removeChannel(g),g=null),f()&&(f().textContent="Adversaire trouvé !"),await new Promise(m=>setTimeout(m,600)),e.isConnected!==!1&&po(e,t,x,F,a,d))},{data:h,error:L}=await $.rpc("try_matchmake",{p_user_id:l.profile.id,p_deck_id:i});if(L||!(h!=null&&h.success)){r("Erreur de matchmaking","error"),le(),n("home");return}if(h.matched){u(h.match_id,h.opponent_id,!1);return}f()&&(f().textContent="En attente d'un autre joueur..."),g=$.channel("matchmaking-"+l.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${l.profile.id}`},x=>{const k=x.new;k.status==="matched"&&k.match_id&&u(k.match_id,k.matched_with,!0)}).subscribe()}async function po(e,t,i,s,c=[],o=[]){const{state:a,navigate:d,toast:l}=t,n=s?"p1":"p2",r=s?"p2":"p1",p=(c||[]).map(T=>T.id),g=(c||[]).map(T=>({id:T.id,gc_type:T.gc_type,_gcDef:T._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation du match...</div>';const{data:f}=await $.from("matches").select("*").eq("id",i).single();if(!f){l("Match introuvable","error"),d("home");return}async function y(){const[{data:T,error:S},{data:z,error:N},{data:D},{data:_}]=await Promise.all([$.rpc("get_deck_for_match",{p_deck_id:f.home_deck_id}),$.rpc("get_deck_for_match",{p_deck_id:f.away_deck_id}),$.from("users").select("id,pseudo,club_name").eq("id",f.home_id).single(),$.from("users").select("id,pseudo,club_name").eq("id",f.away_id).single()]);S&&console.error("[PvP] get_deck_for_match p1 error:",S),N&&console.error("[PvP] get_deck_for_match p2 error:",N);function b(j,H){return{cardId:j.card_id,position:H||j.position,id:j.id,firstname:j.firstname,name:j.surname_encoded,country_code:j.country_code,club_id:j.club_id,job:j.job,job2:j.job2,note_g:Number(j.note_g)||0,note_d:Number(j.note_d)||0,note_m:Number(j.note_m)||0,note_a:Number(j.note_a)||0,rarity:j.rarity,skin:j.skin,hair:j.hair,hair_length:j.hair_length,clubName:j.club_encoded_name||null,clubLogo:j.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}}const C=((T==null?void 0:T.starters)||[]).map(j=>b(j,j.position)),E=((z==null?void 0:z.starters)||[]).map(j=>b(j,j.position)),w=((T==null?void 0:T.subs)||[]).map(j=>b(j,j.position)),B=((z==null?void 0:z.subs)||[]).map(j=>b(j,j.position)),I=(T==null?void 0:T.formation)||"4-4-2",R=(z==null?void 0:z.formation)||"4-4-2";return console.log("[PvP] p1Formation:",I,"p1 starters:",C.length,"positions:",C.map(j=>j.position)),console.log("[PvP] p2Formation:",R,"p2 starters:",E.length,"positions:",E.map(j=>j.position)),{p1Team:qe(C,I),p2Team:qe(E,R),p1Subs:w,p2Subs:B,p1Formation:I,p2Formation:R,p1Name:(D==null?void 0:D.club_name)||(D==null?void 0:D.pseudo)||"Joueur 1",p2Name:(_==null?void 0:_.club_name)||(_==null?void 0:_.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?p:[],gc_p2:s?[]:p,gcCardsFull_p1:s?g:[],gcCardsFull_p2:s?[]:g,gcReady_p1:!0,gcReady_p2:!0,usedGc_p1:[],usedGc_p2:[],lastActionAt:new Date().toISOString()}}let u=f.game_state&&Object.keys(f.game_state).length?f.game_state:null;if(!u)if(s){u=await y();const{data:T}=await $.from("matches").select("game_state").eq("id",i).single();!(T!=null&&T.game_state)||!Object.keys(T.game_state).length?await $.from("matches").update({game_state:u,turn_user_id:f.home_id}).eq("id",i):u=T.game_state}else{e.innerHTML=`<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation avec l'adversaire...</div>`;for(let T=0;T<30&&!u;T++){await new Promise(z=>setTimeout(z,400));const{data:S}=await $.from("matches").select("game_state").eq("id",i).single();S!=null&&S.game_state&&Object.keys(S.game_state).length&&(u=S.game_state)}if(!u){l("Erreur de synchronisation","error"),d("home");return}u.gc_p2=p,u.gcCardsFull_p2=g,await $.from("matches").update({game_state:u}).eq("id",i)}let h=!1;function L(T){var C;try{$.removeChannel(v)}catch{}const S=a.profile.id,z=T.winner_id===S,N=!!T.forfeit,D=u[n+"Score"]??0,_=u[r+"Score"]??0,b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center",b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(C=b.querySelector("#pvp-end-home"))==null||C.addEventListener("click",()=>{b.remove(),le(),d("home")})}const v=$.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},T=>{const S=T.new;try{if(S.status==="finished"||S.forfeit){if(h)return;h=!0,u._timerInt&&(clearInterval(u._timerInt),u._timerInt=null),S.game_state&&(u=S.game_state),L(S);return}S.game_state&&(u=S.game_state,F())}catch(z){console.error("[PvP] Realtime render crash:",z,"gameState:",u)}}).subscribe();async function x(T){Object.assign(u,T),u.lastActionAt=new Date().toISOString();const{error:S}=await $.from("matches").update({game_state:u}).eq("id",i);S&&(console.error("[PvP] pushState DB error:",S.message,S),l("Erreur de synchronisation : "+S.message,"error"));try{F()}catch(z){console.error("[PvP] renderPvpScreen crash après pushState:",z),l("Erreur d'affichage : "+z.message,"error")}}async function k(){if(h)return;h=!0,u._timerInt&&(clearInterval(u._timerInt),u._timerInt=null);const T=s?f.away_id:f.home_id;try{await $.from("matches").update({status:"finished",forfeit:!0,winner_id:T}).eq("id",i)}catch(S){console.warn("[PvP] forfeit DB error:",S)}try{$.removeChannel(v)}catch{}le(),d("home")}function F(){var lt,ct,pt,ut,ft;const T=u[n+"Team"];u[r+"Team"];const S=u[n+"Score"],z=u[r+"Score"],N=u[n+"Name"],D=u[r+"Name"];if(u.phase==="gc-select")return m();if(u.phase==="reveal")return A();if(u.phase==="midfield")return M();if(u.phase==="finished")return Z();const _=u.phase===n+"-attack",b=u.phase===n+"-defense",C=u.phase===r+"-attack"||u.phase===r+"-defense",E=Array.isArray(u["selected_"+n])?u["selected_"+n]:[],w=E.map(P=>P.cardId);e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const B=window.innerWidth>=700,I=u[n+"Subs"]||[],R=u["usedSubIds_"+n]||[],j=I.filter(P=>!R.includes(P.cardId)),H=u["gcCardsFull_"+n]||[],K=u["usedGc_"+n]||[],Q=H.filter(P=>!K.includes(P.id)),ie=u.boostOwner===n&&!u.boostUsed,re=(P,J,ee)=>{var yt,ht;const W=P._gcDef,ce={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[W==null?void 0:W.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Le={purple:"#b06ce0",light_blue:"#00d4ef"}[W==null?void 0:W.color]||"#b06ce0",me=(W==null?void 0:W.name)||P.gc_type,ii=(W==null?void 0:W.effect)||((yt=de[P.gc_type])==null?void 0:yt.desc)||"",gt=W!=null&&W.image_url?`/manager-wars/icons/${W.image_url}`:null,oi=((ht=de[P.gc_type])==null?void 0:ht.icon)||"⚡",xt=Math.round(ee*.22),mt=Math.round(ee*.22),Oe=ee-xt-mt,ni=me.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${P.id}" data-gc-type="${P.gc_type}"
        style="width:${J}px;height:${ee}px;border-radius:10px;border:2px solid ${Le};background:${ce};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${xt}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${ni}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${J-6}px">${me}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${Oe}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${gt?`<img src="${gt}" style="max-width:${J-10}px;max-height:${Oe-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Oe*.55)}px">${oi}</span>`}
        </div>
      ...
      </div>`},ae=(P,J)=>`<div id="pvp-boost-card" style="width:${P}px;height:${J}px;flex-shrink:0;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px">
      ...
      <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
        ...
        </div>`;const J=Array.isArray(u.log)?u.log:[],ee=J[J.length-1];return ee?`<div style="padding:7px 10px;border-left:3px solid ${ee.type==="goal"?"#FFD700":ee.type==="stop"?"#00ff88":ee.type==="attack"?"#ff6b6b":"rgba(255,255,255,0.6)"};font-size:12px;color:#fff">${ee.text||""}</div>`:'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),ti=(Array.isArray(u.log)?u.log:[]).length,dt=`
      <!-- Score -->
      ...
      <div class="match-screen" style="display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;height:100%;width:100%">
        ...
        <div style="flex-shrink:0;background:rgba(0,0,0,0.35);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px">
          <div style="display:flex;gap:6px;overflow-x:auto;align-items:flex-end;min-height:96px;padding-bottom:2px">
            ${Q.map(J=>re(J,68,95)).join("")}
            ${ie?ae(68,95):""}
          </div>
          <div>${Te}${st}</div>
        </div>
      </div>`;const P=e.querySelector(".terrain-wrapper");P&&(P.innerHTML=Ee(T,u[n+"Formation"],_?"attack":b?"defense":"idle",w,300,300))}if(e.querySelectorAll(".match-slot-hit").forEach(P=>{P.addEventListener("click",()=>{if(!_&&!b)return;const J=P.dataset.cardId,ee=P.dataset.role,W=(T[ee]||[]).find(me=>me.cardId===J);if(!W||W.used)return;Array.isArray(u["selected_"+n])||(u["selected_"+n]=[]);const ce=u["selected_"+n],Le=ce.findIndex(me=>me.cardId===J);Le>-1?ce.splice(Le,1):ce.length<3&&ce.push({...W,_role:ee}),F()})}),(lt=e.querySelector("#pvp-boost-card"))==null||lt.addEventListener("click",()=>{q()}),e.querySelectorAll(".pvp-gc-mini").forEach(P=>{P.addEventListener("click",()=>{V(P.dataset.gcId,P.dataset.gcType)})}),(ct=e.querySelector("#pvp-action"))==null||ct.addEventListener("click",()=>{_?Y():b&&U()}),(pt=e.querySelector("#pvp-quit"))==null||pt.addEventListener("click",()=>{confirm("Quitter le match ? Vous perdrez par forfait.")&&k()}),(ut=e.querySelector("#pvp-view-opp"))==null||ut.addEventListener("click",()=>{O()}),(ft=e.querySelector("#pvp-toggle-history"))==null||ft.addEventListener("click",()=>{G()}),function(){const J=e.querySelector(".terrain-wrapper svg");J&&(J.removeAttribute("width"),J.removeAttribute("height"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",J.setAttribute("viewBox","-26 -26 352 352"),J.setAttribute("preserveAspectRatio","xMidYMid meet"));const ee=e.querySelector(".match-screen");if(ee){const W=e.clientHeight;W>50&&(ee.style.height=W+"px",ee.style.maxHeight=W+"px",ee.style.overflow="hidden")}}(),u._timerInt&&(clearInterval(u._timerInt),u._timerInt=null),(_||b)&&!h){let P=30,J=!1;const ee=()=>document.getElementById("pvp-timer"),W=()=>{ee()&&(ee().textContent=P+"s",ee().style.color=J?"#ff4444":"#fff")};W(),u._timerInt=setInterval(()=>{P--,P<0?J?(clearInterval(u._timerInt),u._timerInt=null,k()):(J=!0,P=15,W()):W()},1e3)}}function m(){var b;const T=u["gcReady_"+n],S=u["gcReady_"+r];Array.isArray(u["gc_"+n])||(u["gc_"+n]=[]);let z=u["gc_"+n];const N=3;function D(C,E){const w=C._gcDef,B={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},I={purple:"#9b59b6",light_blue:"#00bcd4"},R=B[w==null?void 0:w.color]||B.purple,j=I[w==null?void 0:w.color]||I.purple;return`<div class="pvp-gc-card" data-id="${C.id}"
    ...
    </div>`,T)return;const _=n==="p1"?f.home_id:f.away_id;$.from("cards").select("id,gc_type").eq("owner_id",_).eq("card_type","game_changer").then(async({data:C})=>{const{data:E}=await $.from("gc_definitions").select("*").eq("is_active",!0),w=new Set,B=(C||[]).filter(R=>w.has(R.gc_type)?!1:(w.add(R.gc_type),!0)).map(R=>({...R,_gcDef:(E==null?void 0:E.find(j=>j.name===R.gc_type))||null})),I=document.getElementById("pvp-gc-grid");if(I){if(!B.length){I.innerHTML='<div style="color:rgba(255,255,255,0.4);font-size:13px;text-align:center;margin-top:30px">Aucune carte Game Changer disponible.</div>';return}I.innerHTML=B.map(R=>D(R,z.includes(R.id))).join(""),I.querySelectorAll(".pvp-gc-card").forEach(R=>{R.addEventListener("click",()=>{const j=R.dataset.id,H=z.indexOf(j);H>-1?z.splice(H,1):z.length<N&&z.push(j),F()})})}}),(b=e.querySelector("#pvp-gc-validate"))==null||b.addEventListener("click",async()=>{const C=n==="p1"?f.home_id:f.away_id,{data:E}=await $.from("cards").select("id,gc_type").eq("owner_id",C).eq("card_type","game_changer").in("id",z),{data:w}=await $.from("gc_definitions").select("*").eq("is_active",!0),B=(E||[]).map(I=>({...I,_gcDef:(w==null?void 0:w.find(R=>R.name===I.gc_type))||null}));await x({["gcReady_"+n]:!0,["gcCardsFull_"+n]:B}),u["gcReady_"+r]&&await x({phase:"reveal"})})}function A(){e.style.overflow="hidden",e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
    </div>`,n==="p1"&&setTimeout(async()=>{await x({phase:"midfield"})},5e3)}function M(){const T=u[n+"Team"].MIL||[],S=u[r+"Team"].MIL||[];function z(E){return E.reduce((w,B)=>w+te(B,"MIL"),0)}function N(E){let w=0;for(let B=0;B<E.length-1;B++){const I=fe(E[B],E[B+1]);I==="#00ff88"?w+=2:I==="#FFD700"&&(w+=1)}return w}const D=z(T)+N(T),_=z(S)+N(S),b=D>=_;function C(E,w,B){return`<div style="text-align:center">
        <div style="font-size:10px;color:rgba(255,255,255,0.5);letter-spacing:2px;margin-bottom:8px;text-transform:uppercase">${w}</div>
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${E.map((I,R)=>{const j=oe(I),H=R<E.length-1?fe(I,E[R+1]):null,K=H&&H!=="#ff3333"&&H!=="#cc2222";return`
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div id="pvp-midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
    </div>`,setTimeout(()=>{const E=document.getElementById("pvp-score-me"),w=document.getElementById("pvp-score-opp"),B=document.getElementById("pvp-midfield-result");E&&w&&(b?(E.style.fontSize="80px",E.style.color="#FFD700",w.style.opacity="0.25"):(w.style.fontSize="80px",w.style.color="#ff6b6b",E.style.opacity="0.25"));const I=u.p1Team.MIL||[],R=u.p2Team.MIL||[],j=z(I)+N(I),H=z(R)+N(R),K=j>=H?"p1":"p2";u[K+"Name"];let Q=u.boostValue;Q==null&&(Q=Kt(),u.boostValue=Q,u.boostOwner=K,u.boostUsed=!1),B&&(B.style.opacity="1",B.innerHTML=`<div style="font-size:20px;font-weight:900;margin-bottom:10px">
        ...
        <div style="background:rgba(135,206,235,0.15);border:2px solid #87CEEB;border-radius:14px;padding:14px 24px;display:inline-block;margin-top:4px" id="pvp-boost-display">
          ...
          <div style="font-size:10px;color:rgba(135,206,235,0.7)">Applicable sur n'importe quel joueur</div>
        </div>`:""}`),setTimeout(async()=>{if(n!=="p1")return;const ie=K;await x({phase:ie+"-attack",attacker:ie,round:1,boostValue:u.boostValue,boostUsed:!1,boostOwner:ie})},1800)},600)}function q(){var N;const T=u[n+"Team"],S=Object.entries(T).flatMap(([D,_])=>(_||[]).filter(b=>!b.used).map(b=>({...b,_line:D})));if(!S.length)return;const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",z.innerHTML=`
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${S.map(D=>{const _={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[D._line]||"#555",b=te(D,D._line)+(D.boost||0);return`<div class="boost-pick-item" data-cid="${D.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${_};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(z),(N=z.querySelector("#boost-picker-close"))==null||N.addEventListener("click",()=>z.remove()),z.querySelectorAll(".boost-pick-item").forEach(D=>{D.addEventListener("click",async()=>{const _=D.dataset.cid,b=S.find(w=>w.cardId===_);if(!b)return;const C=u[n+"Team"],E=(C[b._line]||[]).find(w=>w.cardId===_);E&&(E.boost=(E.boost||0)+u.boostValue),z.remove(),await x({[n+"Team"]:C,boostUsed:!0})})})}function G(){var z;const T=Array.isArray(u.log)?u.log:[],S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",S.innerHTML=`
      <div style="display:flex;align-items:center;padding:14px 16px;border-bottom:1px solid rgba(255,255,255,0.1);flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">📋 Historique du match</div>
        <button id="pvp-hist-close" style="background:none;border:none;color:rgba(255,255,255,0.6);font-size:20px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
        ${T.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...T].reverse().map(N=>`<div style="padding:8px 10px;border-radius:8px;background:rgba(255,255,255,0.04);border-left:3px solid ${N.type==="goal"?"#FFD700":N.type==="defense"?"#00ff88":"rgba(255,255,255,0.5)"}">
                <div style="font-size:12px;color:#fff">${N.text||""}</div>
              </div>`).join("")}
      </div>`,document.body.appendChild(S),(z=S.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>S.remove())}function O(){var S;const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",T.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${u[r+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ke(u[r+"Team"],u[r+"Formation"],null,[],300,300)}</div>
      <button id="pvp-view-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(T),(S=T.querySelector("#pvp-view-opp-close"))==null||S.addEventListener("click",()=>T.remove())}function V(T,S){var j,H;const N=(u["gcCardsFull_"+n]||[]).find(K=>K.id===T),D=N==null?void 0:N._gcDef,_=de[S]||{icon:"⚡",desc:"Carte spéciale."},b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[D==null?void 0:D.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",C={purple:"#b06ce0",light_blue:"#00d4ef"}[D==null?void 0:D.color]||"#b06ce0",E=(D==null?void 0:D.name)||S,w=(D==null?void 0:D.effect)||_.desc,B=D!=null&&D.image_url?`/manager-wars/icons/${D.image_url}`:null,I=_.icon||"⚡",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",R.innerHTML=`
      ...
      </div>`,document.body.appendChild(R),(j=R.querySelector("#pvp-gc-back"))==null||j.addEventListener("click",()=>R.remove()),(H=R.querySelector("#pvp-gc-use"))==null||H.addEventListener("click",async()=>{R.remove();const K=u["usedGc_"+n]||[];K.push(T),await x({["usedGc_"+n]:K})})}function Z(){var D;const T=u[n+"Score"],S=u[r+"Score"],z=T>S,N=T===S;e.style.overflow="hidden",e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <div style="font-size:32px;font-weight:900;color:#FFD700">${T} - ${S}</div>
    ...
    </div>`,(D=document.getElementById("pvp-home"))==null||D.addEventListener("click",()=>{$.removeChannel(v),le(),d("home")})}async function Y(){const T=(u["selected_"+n]||[]).map(N=>({...N,_line:N._role}));if(!T.length)return;const S=Ze(T,u.modifiers[n]||{});T.forEach(N=>{const D=(u[n+"Team"][N._role]||[]).find(_=>_.cardId===N.cardId);D&&(D.used=!0)});const z=Array.isArray(u.log)?u.log:[];z.push({type:"attack",text:`⚔️ ${u[n+"Name"]} attaque (${S.total})`,players:T,total:S.total,side:n}),await x({pendingAttack:{...S,players:T,side:n},["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},phase:r+"-defense",log:z})}async function U(){const T=(u["selected_"+n]||[]).map(B=>({...B,_line:B._role})),S=Qe(T,u.modifiers[n]||{});T.forEach(B=>{const I=(u[n+"Team"][B._role]||[]).find(R=>R.cardId===B.cardId);I&&(I.used=!0)});const z=et(u.pendingAttack.total,S.total,u.modifiers[n]||{}),N=u.pendingAttack.side,D=z==="attack",_=u[N+"Score"]+(D?1:0),b=N==="p1"?"p2":"p1",C=(u.round||0)+1,E=C>10,w=Array.isArray(u.log)?u.log:[];w.push({type:"defense",text:`🛡️ ${u[n+"Name"]} défend (${S.total})`,players:T,total:S.total,side:n}),w.push({type:D?"goal":"stop",text:D?`⚽ BUT de ${u[N+"Name"]} ! (${u.pendingAttack.total} vs ${S.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${S.total})`}),await x({[N+"Score"]:_,["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:E?"finished":b+"-attack",attacker:b,round:C,log:w}),E&&await $.from("matches").update({status:"finished"}).eq("id",i)}F()}const uo={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function fo(e,t){const{state:i,toast:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await rt(e,t)}async function rt(e,t){const{state:i,toast:s}=t,{data:c}=await $.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(n){const r=document.getElementById("mkt-content"),p=n==="buy"?a:d;if(p.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${g.map(f=>{var x,k,F,m;const y=(x=f.card)==null?void 0:x.player;if(!y)return"";const u=y.job==="GK"?y.note_g:y.job==="DEF"?y.note_d:y.job==="MIL"?y.note_m:y.note_a,h=uo[y.rarity],L=(i.profile.credits||0)>=f.price,v=f.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${v?"opacity:0.65":""}">
  ...
  </div>`}const X={user:null,profile:null,page:"home",params:{}};function Se(e,t="info",i=3e3){const s=document.getElementById("toast");s&&(s.textContent=e,s.className=`show ${t}`,clearTimeout(s._t),s._t=setTimeout(()=>{s.className=""},i))}function vo(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function We(){document.getElementById("modal-overlay").classList.add("hidden")}async function je(){if(!X.user)return;const{data:e}=await $.from("users").select("*").eq("id",X.user.id).single();e&&(X.profile=e)}const at="mw_theme";function Re(){return localStorage.getItem(at)||"light"}function bo(e){var t;localStorage.setItem(at,e),Je(e),(t=X.profile)!=null&&t.id&&$.from("users").update({theme:e}).eq("id",X.profile.id).then(()=>{})}function Je(e){document.documentElement.setAttribute("data-theme",e)}function Be(e,t={}){X.page=e,X.params=t,Qt()}async function Qt(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===X.page)});const t=document.getElementById("nav-credits");t&&X.profile&&(t.textContent=`💰 ${(X.profile.credits||0).toLocaleString("fr")}`);const i={state:X,navigate:Be,toast:Se,openModal:vo,closeModal:We,refreshProfile:je};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',X.page){case"home":await wt(e,i);break;case"collection":await fi(e,i);break;case"decks":await He(e,i);break;case"boosters":await zi(e,i);break;case"match":{(X.params&&X.params.matchMode||"vs_ai_easy")==="random"?await lo(e,i):await Vi(e,i);break}case"market":await fo(e,i);break;case"rankings":await yo(e,i);break;case"matches":await ho(e,i);break;default:await wt(e,i)}}function wo(){const e=document.getElementById("app"),t=X.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(s=>{s.addEventListener("click",c=>{c.preventDefault(),Be(s.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Be("home")),document.getElementById("nav-credits").addEventListener("click",()=>Be("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const c=Re()==="dark"?"light":"dark";bo(c),zt(c)}),zt(Re())}function zt(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function _o(){Je(Re()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&We()}),document.getElementById("modal-close").addEventListener("click",We);const{data:{session:e}}=await $.auth.getSession();if(!e){St(),vt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Se});return}X.user=e.user,await je(),St();try{const{data:t}=await $.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(s=>{i[s.formation]=s.links}),ri(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!X.profile){ai(document.getElementById("app"),{state:X,navigate:async()=>{await je(),Ct()},toast:Se,refreshProfile:je});return}X.profile.theme&&X.profile.theme!==Re()&&(localStorage.setItem(at,X.profile.theme),Je(X.profile.theme)),Ct(),$.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(X.user=null,X.profile=null,document.getElementById("app").innerHTML="",vt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Se}))})}function Ct(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",wo(),Qt()}function St(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}_o();
