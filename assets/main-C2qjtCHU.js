import{s as T,F as xi,h as Nt,j as Yi,l as at,i as zn,k as Ln,b as Sn}from"./formation-links-DJC25wD7.js";const In="/manager-wars/";function Li(e,{navigate:t,toast:i}){let a="login";const c=()=>{var s,d,p,n,o,f;const l=a==="login";e.innerHTML=`
    <div style="
  ...
  `;function d(){var A;const n=document.getElementById("logo-preview"),o=document.getElementById("logo-initials"),f=((A=document.getElementById("setup-club"))==null?void 0:A.value)||"MW",v=f.trim().split(" ").filter(Boolean),w=v.length>=2?(v[0][0]+v[1][0]).toUpperCase():f.slice(0,2).toUpperCase();n&&(n.style.background=s,n.style.borderColor=l),o&&(o.textContent=w,o.style.color=l)}document.getElementById("color1").addEventListener("input",n=>{l=n.target.value,document.getElementById("swatch1").style.background=l,d()}),document.getElementById("color2").addEventListener("input",n=>{s=n.target.value,document.getElementById("swatch2").style.background=s,d()});function p(n){document.querySelectorAll(".setup-step").forEach(o=>o.classList.remove("active")),document.getElementById(`step-${n}`).classList.add("active"),document.getElementById("step-num").textContent=n,document.getElementById("progress-fill").style.width=`${Math.round(n/3*100)}%`,n===3&&d()}document.getElementById("step1-next").addEventListener("click",async()=>{const n=document.getElementById("setup-pseudo").value.trim(),o=document.getElementById("step1-error");if(o.textContent="",n.length<3){o.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await T.from("users").select("id").eq("pseudo",n).maybeSingle();if(f){o.textContent="Ce pseudo est déjà pris.";return}p(2)}),document.getElementById("step2-back").addEventListener("click",()=>p(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const n=document.getElementById("setup-club").value.trim(),o=document.getElementById("step2-error");if(o.textContent="",n.length<2){o.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await T.from("users").select("id").eq("club_name",n).maybeSingle();if(f){o.textContent="Ce nom de club est déjà pris.";return}p(3)}),document.getElementById("step3-back").addEventListener("click",()=>p(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const n=document.getElementById("setup-pseudo").value.trim(),o=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),v=document.getElementById("step3-finish");f.textContent="",v.disabled=!0,v.textContent="Création en cours…";try{const{error:w}=await T.from("users").insert({id:t.user.id,pseudo:n,club_name:o,club_color1:l,club_color2:s,credits:1e4});if(w)throw w;await Cn(t.user.id),await c(),a(`Bienvenue ${n} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(w){f.textContent=w.message,v.disabled=!1,v.textContent="🚀 Créer mon profil !"}})}async function Cn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await T.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const jn="modulepreload",qn=function(e){return"/manager-wars/"+e},Si={},yi=function(t,i,a){let c=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),d=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));c=Promise.allSettled(i.map(p=>{if(p=qn(p),p in Si)return;Si[p]=!0;const n=p.endsWith(".css"),o=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${o}`))return;const f=document.createElement("link");if(f.rel=n?"stylesheet":jn,n||(f.as="script"),f.crossOrigin="",f.href=p,d&&f.setAttribute("nonce",d),document.head.appendChild(f),n)return new Promise((v,w)=>{f.addEventListener("load",v),f.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${p}`)))})}))}function l(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return c.then(s=>{for(const d of s||[])d.status==="rejected"&&l(d.reason);return t().catch(l)})},Dt="#1A6B3C",Gt="#cc2222",Bn="#D4A017",Ii="#888";async function Fn(e,t){const{state:i,toast:a}=t;e.innerHTML=`
    ...
    </style>`}async function Xi({player1Id:e,player2Id:t,score1:i,score2:a,gc1:c,gc2:l}){const[s,d]=[e,t].sort(),p=e!==s,n=p?a:i,o=p?i:a,f=p?l:c,v=p?c:l,w=n>o?1:0,A=o>n?1:0,r=n===o?1:0,{data:u}=await T.from("friend_match_stats").select("*").eq("player1_id",s).eq("player2_id",d).single();u?await T.from("friend_match_stats").update({wins_p1:u.wins_p1+w,wins_p2:u.wins_p2+A,draws:u.draws+r,goals_p1:u.goals_p1+n,goals_p2:u.goals_p2+o,gc_used_p1:u.gc_used_p1+f,gc_used_p2:u.gc_used_p2+v,matches_total:u.matches_total+1}).eq("player1_id",s).eq("player2_id",d):await T.from("friend_match_stats").insert({player1_id:s,player2_id:d,wins_p1:w,wins_p2:A,draws:r,goals_p1:n,goals_p2:o,gc_used_p1:f,gc_used_p2:v,matches_total:1})}const Nn="2026.07.02-1202";async function Mi(e,{state:t,navigate:i,toast:a}){var l,s;const c=t.profile;c&&(e.innerHTML=`
  <style>
  ...
  </div>`}function Bi(e){const t=e.job||"ATT",i=Pt(e,t),a=$i[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function Jn(e,t){const{state:i,navigate:a,toast:c,openModal:l,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await T.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),n=(d||[]).filter(Y=>Y.card_type==="player"&&Y.player),o=(d||[]).filter(Y=>Y.card_type==="game_changer"),f=(d||[]).filter(Y=>Y.card_type==="formation"),{data:v}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),w={};(v||[]).forEach(Y=>{w[Y.name]=Y});const A=Object.keys(xi),r=Object.keys(Ue),u={};n.forEach(Y=>{const J=Y.player.id;u[J]=(u[J]||0)+1}),new Set(Object.keys(u).map(Y=>String(Y)));const I=new Set(f.map(Y=>Y.formation)),z=new Set(o.map(Y=>Y.gc_type));let C="player",H="Tous",F="",j=!1;function U(){return[...n].sort((Y,J)=>{const N=Vt.indexOf(Y.player.job),R=Vt.indexOf(J.player.job);return N!==R?N-R:(Y.player.surname_encoded||"").localeCompare(J.player.surname_encoded||"")})}function oe(){return[...p||[]].sort((Y,J)=>{const N=Vt.indexOf(Y.job),R=Vt.indexOf(J.job);return N!==R?N-R:(Y.surname_encoded||"").localeCompare(J.surname_encoded||"")})}function ce(){return U().filter(Y=>{const J=Y.player,N=H==="Tous"||J.job===H,R=!F||`${J.firstname} ${J.surname_encoded}`.toLowerCase().includes(F);return N&&R})}function re(){return oe().filter(Y=>{const J=H==="Tous"||Y.job===H,N=!F||`${Y.firstname} ${Y.surname_encoded}`.toLowerCase().includes(F);return J&&N})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",J=>{F=J.target.value.toLowerCase(),ie()}),e.querySelectorAll(".filter-btn").forEach(J=>{J.addEventListener("click",()=>{H=J.dataset.job,D(),ie()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,D(),ie()})):(Y.innerHTML=`
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(A=document.getElementById("direct-sell-form-btn"))==null||A.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${n} pour ${Kt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const I=v.find(C=>!C.is_for_sale)||v[0];if(!I){l("Aucune carte à vendre","error");return}await T.from("market_listings").delete().eq("card_id",I.id),await T.from("transfer_history").delete().eq("card_id",I.id);const{error:z}=await T.from("cards").delete().eq("id",I.id);if(z){l(z.message,"error");return}await T.from("users").update({credits:(c.profile.credits||0)+Kt}).eq("id",c.profile.id),await p(),l(`+${Kt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),d("collection")}),(r=document.getElementById("market-sell-form-btn"))==null||r.addEventListener("click",async()=>{const I=parseInt(document.getElementById("sell-price-form").value);if(!I||I<1){l("Prix invalide","error");return}await T.from("cards").update({is_for_sale:!0,sale_price:I}).eq("id",e.id),await T.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:I}),l("Carte mise en vente sur le marché !","success"),s(),d("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),s(),d("collection")})}async function Fi(e,t,i,a){var fe,xe,Ee,_e,he,Y,J;const{state:c,toast:l,openModal:s,closeModal:d,navigate:p,refreshProfile:n}=a,o=e.player,f=t.filter(N=>N.player.id===o.id),v=f.length,w=Math.max(Number(o.note_g)||0,Number(o.note_d)||0,Number(o.note_m)||0,Number(o.note_a)||0),A=o.rarity||"normal",{data:r}=await T.from("sell_price_configs").select("*").eq("rarity",A).lte("note_min",w).gte("note_max",w).order("note_min",{ascending:!1}).limit(1),u=((fe=r==null?void 0:r[0])==null?void 0:fe.price)??Yn[A]??1e3,I=o.rarity!=="legende",z=sn(o),C=(o.rarity==="pepite"||o.rarity==="papyte")&&e.current_note!=null?e.current_note:Pt(o,o.job),H=o.rarity==="pepite"||o.rarity==="papyte",F=o.job2?H?vi(e,an(o.job2)):Pt(o,o.job2):null,j=qt[o.job]||"#1A6B3C",U=o.job2?qt[o.job2]:null,oe=rn[o.rarity]||"#ccc",ce=$i[o.country_code]||o.country_code||"",re=f.map(N=>N.id);let D={};if(re.length){const{data:N}=await T.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",re).order("transferred_at",{ascending:!0});(N||[]).forEach(R=>{D[R.card_id]||(D[R.card_id]=[]),D[R.card_id].push(R)})}const ie=N=>{const R=N.transferred_at?new Date(N.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",Q=N.source==="booster"?"Booster":N.price?N.price.toLocaleString("fr"):"—";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",d);let G=new Set;const se=()=>{const N=G.size,R=document.getElementById("sell-action-panel");R&&(R.style.display=N>0?"block":"none",document.getElementById("sell-selected-count").textContent=N,document.getElementById("sell-direct-total").textContent=(N*u).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(N=>{N.addEventListener("change",()=>{const R=N.dataset.id;N.checked?G.add(R):G.delete(R);const Q=N.closest(".exemplaire-row");Q&&(Q.style.borderColor=N.checked?"#1A6B3C":"#eee"),se()})}),document.querySelectorAll(".exemplaire-row").forEach(N=>{N.addEventListener("click",R=>{if(R.target.closest("button")||R.target.tagName==="INPUT")return;const Q=N.querySelector(".expl-check");Q&&!Q.disabled&&(Q.checked=!Q.checked,Q.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(N=>{N.addEventListener("click",R=>{R.stopPropagation();const Q=document.querySelector(`.expl-hist[data-hist="${N.dataset.idx}"]`);Q&&(Q.style.display=Q.style.display==="none"?"flex":"none")})}),(he=document.getElementById("direct-sell-btn"))==null||he.addEventListener("click",async()=>{const N=[...G];if(!N.length)return;const R=N.length*u;if(!confirm(`Vendre ${N.length} carte${N.length>1?"s":""} ${o.surname_encoded} pour ${R.toLocaleString("fr")} crédits ? Action irréversible.`))return;await T.from("market_listings").delete().in("card_id",N),await T.from("transfer_history").delete().in("card_id",N);const{error:Q}=await T.from("cards").delete().in("id",N);if(Q){l(Q.message,"error");return}await T.from("users").update({credits:(c.profile.credits||0)+R}).eq("id",c.profile.id),await n();const ge=document.getElementById("nav-credits");ge&&(ge.textContent=`💰 ${(c.profile.credits||0).toLocaleString("fr")}`),l(`+${R.toLocaleString("fr")} crédits ! ${N.length} carte${N.length>1?"s":""} vendue${N.length>1?"s":""}.`,"success"),d(),p("collection")}),(Y=document.getElementById("market-sell-btn"))==null||Y.addEventListener("click",async()=>{var Me;const N=[...G];if(!N.length){l("Sélectionne au moins un exemplaire","warning");return}const R=parseInt((Me=document.getElementById("sell-market-price"))==null?void 0:Me.value);if(!R||R<1){l("Prix invalide","error");return}const{error:Q}=await T.from("cards").update({is_for_sale:!0,sale_price:R}).in("id",N);if(Q){l(Q.message,"error");return}const ge=N.map(Ce=>({seller_id:c.profile.id,card_id:Ce,price:R,status:"active"})),{error:pe}=await T.from("market_listings").insert(ge);pe&&console.warn("[Market] insert listings:",pe.message),l(`${N.length} carte${N.length>1?"s":""} mise${N.length>1?"s":""} en vente à ${R.toLocaleString("fr")} cr. chacune !`,"success"),d(),p("collection")}),(J=document.getElementById("cancel-sell-btn"))==null||J.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),d(),p("collection")})}const Xt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},vt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ti(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function dn(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ln(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Qn(e,t=44,i=58){var w;const a=e?ti(e):null,c=e?ln(e):null,l=dn(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",d=vt[s]||"#555",p={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",n=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,o=Math.round(i*.19),f=Math.round(i*.25),v=i-o-f;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${p};background:${d};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
      ...
      ${f.length>0?f.map(r=>{var H,F;const u=r.player,I=s==="GK"?u.note_g:s==="DEF"?u.note_d:s==="MIL"?u.note_m:u.note_a,z=ti(u),C={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[u.rarity];return`<div class="player-option" data-card-id="${r.id}"
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(H=u.clubs)!=null&&H.logo_url?`<img src="${u.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((F=u.clubs)==null?void 0:F.encoded_name)||"—"}</span>`}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(w=document.getElementById("close-selector"))==null||w.addEventListener("click",l),(A=document.getElementById("remove-player"))==null||A.addEventListener("click",()=>{delete t.slots[e],l(),Lt(i,t,a)}),document.querySelectorAll(".player-option").forEach(r=>{r.addEventListener("click",()=>{t.slots[e]=r.dataset.cardId,l(),Lt(i,t,a)})})}function io(e,t,i){var p;const{openModal:a,closeModal:c}=i,l=new Set;Object.values(e.slots).filter(Boolean).forEach(n=>{var f;const o=e.playerCards.find(v=>v.id===n);(f=o==null?void 0:o.player)!=null&&f.id&&l.add(o.player.id)}),e.subs.forEach(n=>{var f;const o=e.playerCards.find(v=>v.id===n);(f=o==null?void 0:o.player)!=null&&f.id&&l.add(o.player.id)});const s=new Set,d=e.playerCards.filter(n=>{var o,f,v;return l.has((o=n.player)==null?void 0:o.id)||s.has((f=n.player)==null?void 0:f.id)?!1:(s.add((v=n.player)==null?void 0:v.id),!0)});a("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${d.length>0?d.map(n=>{var w;const o=n.player,f=ti(o),v=o.job==="GK"?o.note_g:o.job==="DEF"?o.note_d:o.job==="MIL"?o.note_m:o.note_a;return`<div class="player-option" data-card-id="${n.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let p=0;function n(){var z,C,H,F,j;const o=l[p],f=(d||[]).filter(U=>U.deck_id===o.id),v=f.filter(U=>{var oe;return U.is_starter&&((oe=U.card)==null?void 0:oe.player)}).map(U=>ui(U.card,U.position)),w=f.find(U=>{var oe;return((oe=U.card)==null?void 0:oe.card_type)==="formation"}),A=o.formation||((z=w==null?void 0:w.card)==null?void 0:z.formation)||"4-4-2",r=v.length>=11?yt(v,A):null,u=v.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${f}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${c?`<img src="${c}" style="width:${f-4}px;height:${f-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,f-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${re}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const w=48,A=64,r=13,u=16,I={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[H,F]of Object.entries(n)){const j=f(H);if(!j||!F)continue;const U=H.replace(/[0-9]/g,""),oe=It[U]||"#555",ce=s.includes(F.cardId),re=i==="attack"&&(["MIL","ATT"].includes(U)||ce)&&!F.used||i==="defense"&&["GK","DEF","MIL"].includes(U)&&!F.used,D=a.includes(F.cardId);let ie;i==="attack"?ie=ce?Math.max(1,Number(F.note_a)||0):U==="MIL"?Number(F.note_m)||0:Number(F.note_a)||0:i==="defense"?ie=U==="GK"?Number(F.note_g)||0:U==="MIL"?Number(F.note_m)||0:Number(F.note_d)||0:ie=Number(U==="GK"?F.note_g:U==="DEF"?F.note_d:U==="MIL"?F.note_m:F.note_a)||0,ie=ie+(F.boost||0);const W=(j.x-w/2).toFixed(1),G=(j.y-A/2).toFixed(1),se=I[F==null?void 0:F.rarity]||I.normal;if(F.used){const J=typeof import.meta<"u"&&"/manager-wars/"||"/",R=`${typeof window<"u"&&((C=window.location)==null?void 0:C.origin)||""}${J}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="#161616"/>`,v+=`<image href="${R}" xlink:href="${R}" x="${W}" y="${G}" width="${w}" height="${A}" preserveAspectRatio="xMidYMid slice"/>`,v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="none" stroke="${se}" stroke-width="2" opacity="0.7"/>`,v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${F.cardId}" data-role="${U}" style="cursor:pointer"/>`;continue}const fe=D?.45:1,xe=D?"#FFD700":se,Ee=D?3:(F==null?void 0:F.rarity)==="legende"||(F==null?void 0:F.rarity)==="légende"||(F==null?void 0:F.rarity)==="pepite"||(F==null?void 0:F.rarity)==="pépite"?2.5:2,_e=A-r-u;v+=`<defs><clipPath id="cp-${H}"><rect x="${W}" y="${(j.y-A/2+r).toFixed(1)}" width="${w}" height="${_e}"/></clipPath></defs>`,v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="${oe}" opacity="${fe}"/>`;const he=qe(F);he&&(v+=`<image href="${he}" xlink:href="${he}" x="${W}" y="${(j.y-A/2+r).toFixed(1)}" width="${w}" height="${_e}" clip-path="url(#cp-${H})" preserveAspectRatio="xMidYMin slice"/>`),v+=`<rect x="${W}" y="${G}" width="${w}" height="${r}" rx="4" fill="rgba(255,255,255,0.92)"/>`,v+=`<text x="${j.x.toFixed(1)}" y="${(j.y-A/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(F.name||"").slice(0,9)}</text>`;const Y=(j.y+A/2-u).toFixed(1);v+=`<rect x="${W}" y="${Y}" width="${w}" height="${u}" fill="rgba(255,255,255,0.92)"/>`;{const J=Zt(F.country_code);J?v+=`<image href="${J}" xlink:href="${J}" x="${(j.x-20).toFixed(1)}" y="${(j.y+A/2-u+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:v+=`<text x="${(j.x-13).toFixed(1)}" y="${(j.y+A/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${hn(F.country_code)}</text>`,v+=`<text x="${j.x.toFixed(1)}" y="${(j.y+A/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${ie}</text>`;const N=bn(F);N?v+=`<image href="${N}" xlink:href="${N}" x="${(j.x+w/2-14).toFixed(1)}" y="${(j.y+A/2-u+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:F.clubName&&(v+=`<text x="${(j.x+14).toFixed(1)}" y="${(j.y+A/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(F.clubName||"").slice(0,3).toUpperCase()}</text>`),F.boost&&(v+=`<rect x="${(j.x+w/2-12).toFixed(1)}" y="${(j.y-A/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,v+=`<text x="${(j.x+w/2-5).toFixed(1)}" y="${(j.y-A/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${F.boost}</text>`)}v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="${D?"rgba(255,255,255,0.12)":"none"}" stroke="${xe}" stroke-width="${Ee}" opacity="${fe}"/>`,re&&(v+=`<rect x="${W}" y="${G}" width="${w}" height="${A}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${D?"selected":""}" data-card-id="${F.cardId}" data-role="${U}" style="cursor:pointer"/>`)}const z=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-z} ${-z} ${c+z*2} ${l+z*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${v}
  ...
  </div>`}async function oi(e,t,i,a){var F;const{state:c,navigate:l,toast:s}=t;et(e);const d=c.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!d.deckId)return Eo(e,t,i);const p=d.deckId;let n,o,f,v;try{const j=await Promise.all([T.from("decks").select("formation,name").eq("id",p).single(),T.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",p).order("slot_order")]);n=j[0].data,f=j[0].error,o=j[1].data,v=j[1].error}catch(j){console.error("[Match] Exception chargement deck:",j),wt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>l("home"));return}if(f||v){console.error("[Match] Erreur Supabase:",f||v),wt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>l("home"));return}const w=(o||[]).filter(j=>{var U;return j.is_starter&&((U=j.card)==null?void 0:U.player)}).map(j=>ui(j.card,j.position)),A=(o||[]).filter(j=>{var U;return!j.is_starter&&((U=j.card)==null?void 0:U.player)}).map(j=>ui(j.card,j.position));if(w.length<11){wt(e,"⚠️",`Deck incomplet (${w.length}/11).`,"Compléter",()=>l("decks"));return}const r=(o||[]).find(j=>{var U;return((U=j.card)==null?void 0:U.card_type)==="formation"}),u=(n==null?void 0:n.formation)||((F=r==null?void 0:r.card)==null?void 0:F.formation)||"4-4-2",{data:I,error:z}=await T.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",c.profile.id).eq("card_type","game_changer"),{data:C}=await T.from("gc_definitions").select("*").eq("is_active",!0),H=(I||[]).map(j=>({...j,_gcDef:(C==null?void 0:C.find(U=>U.name===j.gc_type||U.id===j.gc_definition_id))||null}));a({deckId:p,formation:u,starters:w,subsRaw:A,gcCardsEnriched:H,gcDefs:C||[]})}async function To(e,t){const{state:i}=t,c=(i.params||{}).matchMode||"vs_ai_easy",l=c.replace("vs_ai_",""),s=c;await oi(e,t,c,async({deckId:d,formation:p,starters:n,subsRaw:o,gcCardsEnriched:f,gcDefs:v})=>{try{const w=yt(n,p),A=await Ao(p,l),r=async u=>{try{const{data:I,error:z}=await T.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single();if(z){console.error("[MatchIA] Erreur création match:",z),wt(e,"⚠️","Impossible de créer le match ("+z.message+").","Retour",()=>t.navigate("home"));return}const C={gcDefs:v||[],matchId:I==null?void 0:I.id,mode:s,difficulty:l,formation:p,homeTeam:w,aiTeam:A,homeSubs:o,subsUsed:0,maxSubs:Math.min(o.length,3),homeScore:0,aiScore:0,gcCards:u,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Lo(e,C,t)}catch(I){console.error("[MatchIA] Exception launchMatch:",I),wt(e,"⚠️","Erreur au lancement du match : "+I.message,"Retour",()=>t.navigate("home"))}};if(!f.length){r([]);return}ni(e,f,r)}catch(w){console.error("[MatchIA] Exception setup:",w),wt(e,"⚠️","Erreur de préparation du match : "+w.message,"Retour",()=>t.navigate("home"))}})}async function Ao(e,t){var s,d;const{data:i}=await T.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return zo(e);const a=St[e]||St["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},l=[...i];for(const p of["GK","DEF","MIL","ATT"]){const n=l.filter(A=>A.job===p),o=l.filter(A=>A.job!==p),f=[...n,...o],v=[];for(let A=0;A<a[p];A++){const r=f[A]||l[A];r&&v.push({cardId:"ai-"+r.id+"-"+A,id:r.id,firstname:r.firstname,name:r.surname_encoded,country_code:r.country_code,club_id:r.club_id,job:r.job,job2:r.job2,note_g:Number(r.note_g)||0,note_d:Number(r.note_d)||0,note_m:Number(r.note_m)||0,note_a:Number(r.note_a)||0,rarity:r.rarity,skin:r.skin,hair:r.hair,hair_length:r.hair_length,clubName:((s=r.clubs)==null?void 0:s.encoded_name)||null,clubLogo:((d=r.clubs)==null?void 0:d.logo_url)||null,boost:0,used:!1,_line:p})}const w=lt(v.length);v.forEach((A,r)=>{A._col=w[r]}),c[p]=v}return c}function zo(e){const t=St[e]||St["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},a=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const l of["GK","DEF","MIL","ATT"]){const s=[];for(let p=0;p<t[l];p++){const n=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:a[c%a.length],country_code:"XX",club_id:null,job:l,job2:null,note_g:l==="GK"?n:2,note_d:l==="DEF"?n:2,note_m:l==="MIL"?n:2,note_a:l==="ATT"?n:2,rarity:"normal",boost:0,used:!1,_line:l}),c++}const d=lt(s.length);s.forEach((p,n)=>{p._col=d[n]}),i[l]=s}return i}function Lo(e,t,i){e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${r.map((C,H)=>{const F=H<r.length-1?at(C,r[H+1]):null,j=!F||F==="#ff3333"||F==="#cc2222",U=F==="#00ff88"?"+2":F==="#FFD700"?"+1":"";return`
          ...
          ${H<r.length-1?`<div class="duel-link duel-link-${z}" data-idx="${H}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${j?"rgba(255,255,255,0.12)":F};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${j?"none":`0 0 8px ${F}`}">
            ${U?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${F}">${U}</span>`:""}
          </div>`:""}
          `}).join("")}
      </div>
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,F.style.transition="opacity .45s ease",F.style.opacity="1",F.style.pointerEvents="auto",(j=document.getElementById("start-match-btn"))==null||j.addEventListener("click",A))},600)},700)},2800)}function Io(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const D=window.innerWidth>=700,ie=(Y,J,N)=>{var Re,Ze;const R=(t.gcDefs||[]).find(M=>M.name===Y.gc_type),Q={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[R==null?void 0:R.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ge={purple:"#b06ce0",light_blue:"#00d4ef"}[R==null?void 0:R.color]||"#b06ce0",pe=(R==null?void 0:R.name)||Y.gc_type,Me=(R==null?void 0:R.effect)||((Re=Ue[Y.gc_type])==null?void 0:Re.desc)||"",Ce=R!=null&&R.image_url?`/manager-wars/icons/${R.image_url}`:null,Fe=((Ze=Ue[Y.gc_type])==null?void 0:Ze.icon)||"⚡",Ve=Math.round(N*.22),Se=Math.round(N*.22),Ne=N-Ve-Se,Ie=pe.length>12?7:9;return`<div class="gc-mini" data-gc-id="${Y.id}" data-gc-type="${Y.gc_type}"
          ...
          <div style="height:${Ne}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Ce?`<img src="${Ce}" style="max-width:${J-10}px;max-height:${Ne-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Ne*.55)}px">${Fe}</span>`}
          </div>
  ...
  `,document.body.appendChild(a);let o=!1;const f=()=>{o||(o=!0,a.remove(),i())};a.addEventListener("click",f),setTimeout(f,2e3)}function Mt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function si(e,t,i,a=null,c=null){var w,A;if(t.phase!=="attack"){Mt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){Mt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const l=Object.entries(t.homeTeam).flatMap(([r,u])=>(u||[]).filter(I=>I.used).map(I=>({...I,_line:I._line||r}))),s=t.homeSubs.filter(r=>!t.usedSubIds.includes(r.cardId));if(!l.length){Mt("Aucun joueur utilisé à remplacer");return}if(!s.length){Mt("Aucun remplaçant disponible");return}let d=Math.max(0,l.findIndex(r=>r.cardId===c));const p=((w=l[d])==null?void 0:w._line)||((A=l[d])==null?void 0:A.job);let n=a?Math.max(0,s.findIndex(r=>r.cardId===a)):Math.max(0,s.findIndex(r=>r.job===p)),o=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function v(){var F,j,U,oe,ce,re;const r=l[d],u=s[n],I=Math.min(130,Math.round((window.innerWidth-90)/2)),z=Math.round(I*1.35),C=D=>`background:rgba(255,255,255,0.12);border:none;color:${D?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${D?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,document.body.appendChild(w),(A=w.querySelector("#gc-back"))==null||A.addEventListener("click",()=>w.remove()),(r=w.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{w.remove(),Go(e,t,i,a,c)})}function Yt(e,t,i,a,c,l){const s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let d=[];function p(){var n,o;s.innerHTML=`
    ...
    </div>`,(n=s.querySelector("#gc-picker-close"))==null||n.addEventListener("click",()=>s.remove()),s.querySelectorAll(".gc-pick-item").forEach(f=>{f.addEventListener("click",()=>{const v=f.dataset.cid,w=e.find(r=>r.cardId===v);if(!w)return;const A=d.findIndex(r=>r.cardId===v);A>-1?d.splice(A,1):d.length<t&&d.push(w),p()})}),(o=s.querySelector("#gc-picker-confirm"))==null||o.addEventListener("click",()=>{s.remove(),l(d)})}p(),document.body.appendChild(s)}const Do={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},a,c,l)=>{const s=Object.entries(a.homeTeam).filter(([d])=>!i.length||i.includes(d)).flatMap(([d,p])=>p.filter(n=>!n.used).map(n=>({...n,_line:d})));return s.length?(Yt(s,t,`Choisir ${t} joueur(s) à booster (+${e})`,c,a,d=>{d.forEach(p=>{const n=(a.homeTeam[p._line]||[]).find(o=>o.cardId===p.cardId);n&&(n.boost=(n.boost||0)+e,a.log.push({text:`⚡ +${e} sur ${n.name}`,type:"info"}))}),Je(c,a,l)}),!0):(a.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Je(c,a,l),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:a="ai"},c,l,s)=>{const d=a==="home"?c.homeTeam:c.aiTeam,p=a==="ai"?"adverse":"allié",n=Object.entries(d).filter(([o])=>!i.length||i.includes(o)).flatMap(([o,f])=>f.filter(v=>!v.used).map(v=>({...v,_line:o})));return n.length?(Yt(n,t,`Choisir ${t} joueur(s) ${p}(s) à débuffer (-${e})`,l,c,o=>{o.forEach(f=>{const w=((a==="home"?c.homeTeam:c.aiTeam)[f._line]||[]).find(A=>A.cardId===f.cardId);w&&(w.boost=(w.boost||0)-e,c.log.push({text:`🎯 -${e} sur ${w.name}${a==="ai"?" (IA)":""}`,type:"info"}))}),Je(l,c,s)}),!0):(c.log.push({text:`🎯 Aucun joueur ${p} disponible`,type:"info"}),Je(l,c,s),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},a,c,l)=>{const s=i==="home"?a.homeTeam:a.aiTeam,d=i==="ai"?"adverse":"allié",p=Object.entries(s).filter(([n])=>!t.length||t.includes(n)).flatMap(([n,o])=>o.filter(f=>!f.used).map(f=>({...f,_line:n})));return p.length?(Yt(p,e,`Choisir ${e} joueur(s) ${d}(s) à exclure`,c,a,n=>{n.forEach(o=>{const v=((i==="home"?a.homeTeam:a.aiTeam)[o._line]||[]).find(w=>w.cardId===o.cardId);v&&(v.used=!0,a.log.push({text:`❌ ${v.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Je(c,a,l)}),!0):(a.log.push({text:`❌ Aucun joueur ${d} à exclure`,type:"info"}),Je(c,a,l),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,a,c)=>{const l=Object.entries(i.homeTeam).filter(([s])=>!t.length||t.includes(s)).flatMap(([s,d])=>d.filter(p=>p.used).map(p=>({...p,_line:s})));return l.length?(Yt(l,e,`Choisir ${e} joueur(s) à ressusciter`,a,i,s=>{s.forEach(d=>{const p=(i.homeTeam[d._line]||[]).find(n=>n.cardId===d.cardId);p&&(p.used=!1,i.log.push({text:`💫 ${p.name} ressuscité !`,type:"info"}))}),Je(a,i,c)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Je(a,i,c),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Go(e,t,i,a,c){a.usedGc.push(e);const l=a.gcDefs||[],s=l.find(p=>p.name===t)||l.find(p=>{var n;return((n=p.name)==null?void 0:n.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let d=!1;if(s!=null&&s.effect_type&&s.effect_type!=="CUSTOM"){const p=Do[s.effect_type];p?p(s.effect_params||{},a,i,c)||(d=!0):(c.toast(`Effet "${s.effect_type}" non implémenté`,"error"),d=!0)}else{switch(t){case"Double attaque":a.modifiers.home.doubleAttack=!0,a.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":a.modifiers.home.shield=!0,a.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const p=Object.entries(a.homeTeam).flatMap(([n,o])=>(o||[]).filter(f=>f.used).map(f=>({...f,_line:n})));p.length?(p[0].used=!1,a.log.push({text:`💫 ${p[0].name} ressuscité !`,type:"info"})):a.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":a.modifiers.ai.stolenNote=(a.modifiers.ai.stolenNote||0)+1,a.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const p=[...a.aiTeam.ATT||[],...a.aiTeam.MIL||[]].filter(n=>!n.used);if(p.length){const n=p.sort((o,f)=>$e(f,"ATT")-$e(o,"ATT"))[0];n.used=!0,a.log.push({text:`❄️ ${n.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":a.maxSubs++,a.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}d=!0}T.from("cards").delete().eq("id",e).then(()=>{}),d&&Je(i,a,c)}function Po(e,t,i){const a=Object.values(t.homeTeam).flat().filter(c=>!c.used);if(!a.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(l);let d=!1;const p=()=>{d||(d=!0,l.remove(),setTimeout(()=>c(),50))};l.addEventListener("click",p),setTimeout(p,3500)}async function Bt(e,t,i){var o,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=i,c=t.homeScore>t.aiScore,l=t.homeScore===t.aiScore,s=c?"victoire":l?"nul":"defaite",d=Vn(t.mode,s);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(a.profile.credits||0)+d,matches_played:(a.profile.matches_played||0)+1};c?p.wins=(a.profile.wins||0)+1:l?p.draws=(a.profile.draws||0)+1:p.losses=(a.profile.losses||0)+1,await T.from("users").update(p).eq("id",a.profile.id),await i.refreshProfile();const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",n.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const w=async(C=!0)=>{f=!0,v&&(T.removeChannel(v),v=null),C&&await T.rpc("cancel_matchmaking",{p_user_id:p.profile.id}).catch(()=>{})};(z=document.getElementById("mm-cancel"))==null||z.addEventListener("click",async()=>{try{await w(!0)}catch{}Ye(e),n("home")});const A=async(C,H,F)=>{if(f)return;f=!0,v&&(T.removeChannel(v),v=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(U=>setTimeout(U,600)),e.isConnected&&_n(e,t,C,F,s,d)},{data:r,error:u}=await T.rpc("try_matchmake",{p_user_id:p.profile.id,p_deck_id:i});if(u||!(r!=null&&r.success)){o("Erreur de matchmaking","error"),Ye(e),n("home");return}if(r.matched){A(r.match_id,r.opponent_id,!1);return}const I=document.getElementById("mm-status");I&&(I.textContent="En attente d'un autre joueur..."),v=T.channel("matchmaking-"+p.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${p.profile.id}`},C=>{const H=C.new;H.status==="matched"&&H.match_id&&A(H.match_id,H.matched_with,!0)}).subscribe()}async function Oo(e,t,i){const{state:a,navigate:c,toast:l}=t;try{(T.getChannels?T.getChannels():[]).forEach(n=>{const o=n.topic||"";(o.includes("matchmaking")||o.includes("pvp-match")||o.includes("friend-invite"))&&T.removeChannel(n)})}catch{}const{data:s}=await T.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!s){l("Match introuvable","error"),c("home");return}if(s.status==="finished"){l("Ce match est terminé","info"),c("home");return}const d=s.home_id===a.profile.id;_n(e,t,i,d,[],[])}async function _n(e,t,i,a,c=[],l=[]){const{state:s,navigate:d,toast:p}=t,n=a?"p1":"p2",o=a?"p2":"p1",f=(c||[]).map(M=>M.id),v=(c||[]).map(M=>({id:M.id,gc_type:M.gc_type,_gcDef:M._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:w}=await T.from("matches").select("*").eq("id",i).single();if(!w){p("Match introuvable","error"),d("home");return}async function A(){const[{data:M},{data:P},{data:_},{data:$}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:w.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:w.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",w.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",w.away_id).single()]),g=h=>({cardId:h.card_id,position:h.position,id:h.id,firstname:h.firstname,name:h.surname_encoded,country_code:h.country_code,club_id:h.club_id,job:h.job,job2:h.job2,note_g:Number(h.note_g)||0,note_d:Number(h.note_d)||0,note_m:Number(h.note_m)||0,note_a:Number(h.note_a)||0,rarity:h.rarity,skin:h.skin,hair:h.hair,hair_length:h.hair_length,clubName:h.club_encoded_name||null,clubLogo:h.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),m=((M==null?void 0:M.starters)||[]).map(h=>g(h)),x=((P==null?void 0:P.starters)||[]).map(h=>g(h)),y=(M==null?void 0:M.formation)||"4-4-2",b=(P==null?void 0:P.formation)||"4-4-2";return{p1Team:yt(m,y),p2Team:yt(x,b),p1Subs:((M==null?void 0:M.subs)||[]).map(h=>g(h)),p2Subs:((P==null?void 0:P.subs)||[]).map(h=>g(h)),p1Formation:y,p2Formation:b,p1Name:(_==null?void 0:_.club_name)||(_==null?void 0:_.pseudo)||"Joueur 1",p2Name:($==null?void 0:$.club_name)||($==null?void 0:$.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?f:[],gc_p2:a?[]:f,gcCardsFull_p1:a?v:[],gcCardsFull_p2:a?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:l||[],lastActionAt:new Date().toISOString()}}let r=w.game_state&&Object.keys(w.game_state).length?w.game_state:null;if(!r)if(a){r=await A();const{data:M}=await T.from("matches").select("game_state").eq("id",i).single();!(M!=null&&M.game_state)||!Object.keys(M.game_state).length?await T.from("matches").update({game_state:r,turn_user_id:w.home_id}).eq("id",i):r=M.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let M=0;M<30&&!r;M++){await new Promise(_=>setTimeout(_,400));const{data:P}=await T.from("matches").select("game_state").eq("id",i).single();P!=null&&P.game_state&&Object.keys(P.game_state).length&&(r=P.game_state)}if(!r){p("Erreur de synchronisation","error"),d("home");return}r.gc_p2=f,r.gcCardsFull_p2=v,await T.from("matches").update({game_state:r}).eq("id",i)}let u=!1,I=null,z=!1;const C=new Set,H=new Set;function F(M){var h,E;try{T.removeChannel(j)}catch{}const P=r[n+"Score"]||0,_=r[o+"Score"]||0;let $,g;M.winner_id?($=M.winner_id===s.profile.id,g=!1):M.forfeit?($=P>_,g=!1):(g=P===_,$=P>_),(h=document.getElementById("pvp-end-overlay"))==null||h.remove();const m=document.createElement("div");m.id="pvp-end-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const x=g?"🤝":$?"🏆":"😞",y=g?"MATCH NUL":$?"VICTOIRE !":"DÉFAITE",b=g?"#fff":$?"#FFD700":"#ff6b6b";m.innerHTML=`
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}const ae=(r.log||[]).slice(-1)[0];return ae?'<div style="padding:2px 4px">'+Le(ae)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),Be=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(m);let b=!1;const h=()=>{b||(b=!0,m.remove(),setTimeout(()=>g(),50))};m.addEventListener("click",h),setTimeout(h,3500)}function _e(M,P,_){var B,O;const $=(r.gcDefs||[]).find(V=>{var X;return V.name===M||((X=V.name)==null?void 0:X.toLowerCase().trim())===(M==null?void 0:M.toLowerCase().trim())}),g={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[$==null?void 0:$.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",m={purple:"#b06ce0",light_blue:"#00d4ef"}[$==null?void 0:$.color]||"#b06ce0",x=($==null?void 0:$.name)||M,y=($==null?void 0:$.effect)||((B=Ue[M])==null?void 0:B.desc)||"",b=$!=null&&$.image_url?`/manager-wars/icons/${$.image_url}`:null,h=((O=Ue[M])==null?void 0:O.icon)||"⚡",k=P===n?"Vous":r[P+"Name"]||"Adversaire",L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",L.innerHTML=`
      <style>
      ...
      </div>`,document.body.appendChild(_),($=_.querySelector("#bp-close"))==null||$.addEventListener("click",()=>_.remove()),_.querySelectorAll(".bp-item").forEach(g=>{g.addEventListener("click",async()=>{const m=g.dataset.cid,x=P.find(b=>b.cardId===m);if(!x)return;const y=(M[x._line]||[]).find(b=>b.cardId===m);y&&(y.boost=(y.boost||0)+r.boostValue),_.remove(),await U({[n+"Team"]:M,boostUsed:!0})})})}function J(M=null){var S,q;if(!(r.phase===n+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const _=r[n+"Team"],$=r["usedSubIds_"+n]||[],g=r.maxSubs||3;if($.length>=g){p(`Maximum ${g} remplacements atteint`,"warning");return}const m=Object.entries(_).flatMap(([B,O])=>(O||[]).filter(V=>V.used).map(V=>({...V,_line:B}))),x=(r[n+"Subs"]||[]).filter(B=>!$.includes(B.cardId));if(!m.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!x.length){p("Aucun remplaçant disponible","warning");return}let y=Math.max(0,m.findIndex(B=>B.cardId===M));const b=((S=m[y])==null?void 0:S._line)||((q=m[y])==null?void 0:q.job);let h=Math.max(0,x.findIndex(B=>B.job===b)),E=!1;const k=document.createElement("div");k.id="pvp-sub-overlay",k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function L(){var ne,ue,me,ye,be,Te;const B=m[y],O=x[h],V=Math.min(130,Math.round((window.innerWidth-90)/2)),X=Math.round(V*1.35),K=ke=>`background:rgba(255,255,255,0.12);border:none;color:${ke?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ke?"default":"pointer"};flex-shrink:0`;k.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${B?Ke({...B,used:!1,boost:0},V,X):"<div>—</div>"}</div>
      ...
      </div>`,(ne=k.querySelector("#psub-close"))==null||ne.addEventListener("click",()=>k.remove()),(ue=k.querySelector("#pout-up"))==null||ue.addEventListener("click",()=>{y>0&&(y--,L())}),(me=k.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{y<m.length-1&&(y++,L())}),(ye=k.querySelector("#pin-up"))==null||ye.addEventListener("click",()=>{h>0&&(h--,L())}),(be=k.querySelector("#pin-down"))==null||be.addEventListener("click",()=>{h<x.length-1&&(h++,L())});const te=(ke,De,ze,Ge)=>{const Le=k.querySelector("#"+ke);if(!Le)return;let He=0;Le.addEventListener("touchstart",Be=>{He=Be.touches[0].clientY},{passive:!0}),Le.addEventListener("touchend",Be=>{const Pe=Be.changedTouches[0].clientY-He;if(Math.abs(Pe)<30)return;const Oe=De();Pe<0&&Oe<Ge-1?(ze(Oe+1),L()):Pe>0&&Oe>0&&(ze(Oe-1),L())},{passive:!0})};te("pin-panel",()=>h,ke=>h=ke,x.length),te("pout-panel",()=>y,ke=>y=ke,m.length),(Te=k.querySelector("#psub-confirm"))==null||Te.addEventListener("click",async ke=>{if(ke.preventDefault(),ke.stopPropagation(),E)return;E=!0;const De=m[y],ze=x[h];if(!De||!ze)return;const Ge=De._line,Le=(_[Ge]||[]).findIndex(Pe=>Pe.cardId===De.cardId);if(Le===-1){p("Erreur : joueur introuvable","error"),k.remove();return}const He={...ze,_line:Ge,position:De.position,used:!1,boost:0};_[Ge].splice(Le,1,He);const Be=[...$,ze.cardId];k.remove(),N(De,ze,async()=>{await U({[n+"Team"]:_,[o+"Team"]:r[o+"Team"],["usedSubIds_"+n]:Be})})})}document.body.appendChild(k),L()}function N(M,P,_){const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const m=(b,h,E)=>`<div style="text-align:center">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(g=document.getElementById("pvp-home"))==null||g.addEventListener("click",()=>{try{T.removeChannel(j)}catch{}Ye(e),d("home")})}G()}const Ho=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:wn,resumePvpMatch:Oo},Symbol.toStringTag,{value:"Module"}));async function Uo(e,t,i,a){var c,l;try{const s=(l=(c=t==null?void 0:t.state)==null?void 0:c.profile)==null?void 0:l.id;try{(T.getChannels?T.getChannels():[]).forEach(p=>{const n=p.topic||"";(n.includes("matchmaking")||n.includes("pvp-match"))&&T.removeChannel(p)})}catch(d){console.warn("[FriendMatch] cleanup canaux:",d)}s&&(await T.rpc("cancel_matchmaking",{p_user_id:s}).catch(()=>{}),await T.from("matchmaking_queue").delete().eq("user_id",s).then(()=>{},()=>{}))}catch{}await oi(e,t,"random",({deckId:s,formation:d,starters:p,subsRaw:n,gcCardsEnriched:o,gcDefs:f})=>{const v=w=>Vo(e,t,s,d,p,n,w,f||[],i,a);if(!o.length){v([]);return}ni(e,o,v)})}async function Vo(e,t,i,a,c,l,s=[],d=[],p,n){var ce;const{state:o,navigate:f,toast:v}=t,w=o.profile.id;let A=!1,r=null;et(e);try{await T.rpc("cancel_matchmaking",{p_user_id:w})}catch{}try{await T.from("matchmaking_queue").delete().eq("user_id",w)}catch{}const u=(re,D,ie,W)=>{var G;e.innerHTML=`
      ...
      ${B.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':B.map(ee=>`<div class="pvp-sub-btn" data-sub-id="${ee.cardId}" style="cursor:pointer;flex-shrink:0">${Ke(ee,L?76:44,L?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    </div>`;function Be(ee){if(ee.type==="duel"&&(ee.homeTotal!=null||ee.aiTotal!=null)){const le=(ee.homeTotal||0)>=(ee.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
        ...
        </div>`}const ee=(r.log||[]).slice(-1)[0];return ee?'<div style="padding:2px 4px">'+Be(ee)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),Oe=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
        <button id="pvp-quit" style="width:34px;height:34px;border-radius:50%;background:rgba(220,50,50,0.7);border:none;color:#fff;font-size:16px;cursor:pointer;flex-shrink:0">✕</button>
        <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px">
  ...
  </div>`,(I=document.getElementById("ml-create-btn"))==null||I.addEventListener("click",()=>Zo(e,t)),e.querySelectorAll(".ml-tab").forEach(z=>z.addEventListener("click",()=>_t(e,t,z.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(z=>z.addEventListener("click",()=>bt(e,t,z.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(z=>z.addEventListener("click",C=>{C.stopPropagation(),$n(e,t,z.dataset.join,z.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(z=>z.addEventListener("click",C=>{C.stopPropagation(),gi(e,t,z.dataset.delete,z.dataset.name,i)}))}function ei(e,t,i=!1){var s,d;const a=e.creator_id===t,c=e.pot||0,l=((d=(s=e.mini_league_members)==null?void 0:s[0])==null?void 0:d.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`,Be=E?"attack":k?"defense":"idle",Pe=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(g,u[o+"Formation"],Be,S,300,300,ye)}
      </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(be=B.querySelector("#psub-close"))==null||be.addEventListener("click",()=>B.remove()),(Te=B.querySelector("#pout-up"))==null||Te.addEventListener("click",()=>{k>0&&(k--,O())}),(ke=B.querySelector("#pout-down"))==null||ke.addEventListener("click",()=>{k<h.length-1&&(k++,O())}),(De=B.querySelector("#pin-up"))==null||De.addEventListener("click",()=>{S>0&&(S--,O())}),(ze=B.querySelector("#pin-down"))==null||ze.addEventListener("click",()=>{S<E.length-1&&(S++,O())});const ye=(Le,He,Be,Pe)=>{const Oe=B.querySelector("#"+Le);if(!Oe)return;let We=0;Oe.addEventListener("touchstart",Xe=>{We=Xe.touches[0].clientY},{passive:!0}),Oe.addEventListener("touchend",Xe=>{const Qe=Xe.changedTouches[0].clientY-We;if(Math.abs(Qe)<30)return;const ot=He();Qe<0&&ot<Pe-1?(Be(ot+1),O()):Qe>0&&ot>0&&(Be(ot-1),O())},{passive:!0})};ye("pin-panel",()=>S,Le=>S=Le,E.length),ye("pout-panel",()=>k,Le=>k=Le,h.length),(Ge=B.querySelector("#psub-confirm"))==null||Ge.addEventListener("click",async Le=>{if(Le.preventDefault(),Le.stopPropagation(),q)return;q=!0;const He=h[k],Be=E[S];if(!He||!Be)return;const Pe=He._line,Oe=(x[Pe]||[]).findIndex(Qe=>Qe.cardId===He.cardId);if(Oe===-1){p("Erreur : joueur introuvable","error"),B.remove();return}const We={...Be,_line:Pe,position:He.position,used:!1,boost:0};x[Pe].splice(Oe,1,We);const Xe=[...y,Be.cardId];B.remove(),ge(He,Be,async()=>{await re({[o+"Team"]:x,[f+"Team"]:u[f+"Team"],["usedSubIds_"+o]:Xe})})})}document.body.appendChild(B),O()}function ge(g,m,x){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const h=(L,S,q)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${ut(u[f+"Team"],u[f+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(g),(m=g.querySelector("#pvp-opp-close"))==null||m.addEventListener("click",()=>g.remove())}function Me(){var y;const g=u.log||[],m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const x=b=>{var E,k,L;if(b.type==="duel"){const S=b.isGoal,q=b.homeScored&&o==="p1"||!b.homeScored&&S&&o==="p2",B=b.homeScored?"#FFD700":S?"#ff6b6b":"rgba(255,255,255,0.3)",O=S?q?"⚽ BUT !":"⚽ BUT adversaire !":(E=b.homePlayers)!=null&&E.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${S?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${B};margin-bottom:4px">
    ...
    </div>`,(b=document.getElementById("pvp-home"))==null||b.addEventListener("click",()=>{try{T.removeChannel(ce)}catch{}Ye(e),d("mini-league",n?{openLeagueId:n}:{})})}xe()}const Ct=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function dr(e,t,i){let a=0;const c=document.createElement("div");c.id="tutorial-overlay",c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const l=()=>{var o,f,v;const d=Ct[a],p=a===Ct.length-1,n=Math.round((a+1)/Ct.length*100);c.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <div style="padding:24px 24px 0;text-align:center">
          ...
          <div style="font-size:11px;color:#aaa">${a+1} / ${Ct.length}</div>
        </div>
        <!-- Image optionnelle -->
        ${d.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${BASE}icons/${d.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let p="buy";const n=()=>{var r,u,I,z,C,H,F;return{name:(((r=document.getElementById("flt-name"))==null?void 0:r.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((I=document.getElementById("flt-country"))==null?void 0:I.value)||"").toLowerCase().trim(),job:((z=document.getElementById("flt-job"))==null?void 0:z.value)||"",rarity:((C=document.getElementById("flt-rarity"))==null?void 0:C.value)||"",note1:parseInt((H=document.getElementById("flt-note1"))==null?void 0:H.value)||0,note2:parseInt((F=document.getElementById("flt-note2"))==null?void 0:F.value)||0}};function o(r){const u=n();return r.filter(I=>{var oe,ce;const z=(oe=I.card)==null?void 0:oe.player;if(!z)return!1;const C=`${z.firstname} ${z.surname_encoded}`.toLowerCase(),H=(((ce=z.clubs)==null?void 0:ce.encoded_name)||"").toLowerCase(),F=(z.country_code||"").toLowerCase(),j=Et(z,z.job),U=z.job2?Et(z,z.job2):0;return!(u.name&&!C.includes(u.name)||u.club&&!H.includes(u.club)||u.country&&!F.includes(u.country)||u.job&&z.job!==u.job||u.rarity&&z.rarity!==u.rarity||u.note1&&j<u.note1||u.note2&&U<u.note2)})}function f(r){var H,F,j;const u=(H=r.card)==null?void 0:H.player;if(!u)return"";const I=Et(u,u.job),z=u.job2?Et(u,u.job2):0,C=(i.profile.credits||0)>=r.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Hi(u.rarity)}
      ${Wt(I,u.job)}
      ${Wt(z,u.job2||null)}
      ${Ui(u.country_code)}
      ${Vi((F=u.clubs)==null?void 0:F.logo_url)}
      <div style="flex:1;min-width:0">
    ...
    </div>`}function v(r){var H,F,j;const u=(H=r.card)==null?void 0:H.player;if(!u)return"";const I=Et(u,u.job),z=u.job2?Et(u,u.job2):0,C=r.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${C?"opacity:0.7":""}">
      ${Hi(u.rarity)}
      ${Wt(I,u.job)}
      ${Wt(z,u.job2||null)}
      ${Ui(u.country_code)}
    ...
    </div>`,document.body.appendChild(c);const l=d=>{c.remove(),d&&t()};c.querySelector("#buy-cancel").addEventListener("click",()=>l(!1)),c.querySelector("#buy-ok").addEventListener("click",()=>l(!0)),c.addEventListener("click",d=>{d.target===c&&l(!1)})}async function gr(e,t,i){const{toast:a}=i,{data:c}=await T.from("market_listings").select("card_id").eq("id",e).single();if(await T.from("market_listings").update({status:"cancelled"}).eq("id",e),c!=null&&c.card_id){const{count:l}=await T.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",c.card_id).eq("status","active");l||await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",c.card_id)}a("Annonce retirée","success"),Ti(t,i)}async function mr(e,{state:t,navigate:i,toast:a}){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:c}=await T.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);e.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  </div>`}zn(Sn);const je={user:null,profile:null,page:"home",params:{}};function Tt(e,t="info",i=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},i))}function yr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function mi(){document.getElementById("modal-overlay").classList.add("hidden")}async function jt(){if(!je.user)return;const{data:e}=await T.from("users").select("*").eq("id",je.user.id).single();e&&(je.profile=e)}function Ft(e,t={}){je.page=e,je.params=t,Tn()}async function Tn(){var a,c,l,s;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===je.page)});const t=document.getElementById("nav-credits");t&&je.profile&&(t.textContent=`💰 ${(je.profile.credits||0).toLocaleString("fr")}`);const i={state:je,navigate:Ft,toast:Tt,openModal:yr,closeModal:mi,refreshProfile:jt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',je.page){case"home":await Mi(e,i);break;case"collection":await Jn(e,i);break;case"decks":await li(e,i);break;case"boosters":await po(e,i);break;case"match":{const d=je.params&&je.params.matchMode||"vs_ai_easy";d==="random"?await wn(e,i):d==="friend"?await Uo(e,i,(a=je.params)==null?void 0:a.friendId,(c=je.params)==null?void 0:c.friendName):d==="mini-league"?await Oi(e,i,(l=je.params)==null?void 0:l.mlMatchId,(s=je.params)==null?void 0:s.leagueId):await To(e,i);break}case"market":await pr(e,i);break;case"rankings":await mr(e,i);break;case"matches":await xr(e,i);break;case"friends":await Fn(e,i);break;case"mini-league":await Yo(e,i);break;case"match-mini-league":{const d=je.params||{};await Oi(e,i,d.mlMatchId,d.leagueId);break}default:await Mi(e,i)}}function br(){var a;const e=document.getElementById("app"),t=je.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
