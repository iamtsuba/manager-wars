...
import{s as w,F as di,r as Se,j as Mt,l as Hi,m as vt,h as li,n as hn,o as vn,T as Vt,k as wn,p as _n,b as kn}from"./formation-links-TDtFd05S.js";const $n="/";function Si(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,l,c,d,u;const o=n==="login";e.innerHTML=`
  ...
  `;function s(){var f;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(u){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(u){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await Ln(t.user.id),await a(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function Ln(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Tn="modulepreload",zn=function(e){return"/"+e},Ii={},Ui=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(l=>{if(l=zn(l),l in Ii)return;Ii[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":Tn,c||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),c)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Tt="#1A6B3C",zt="#cc2222",Sn="#D4A017",Mi="#888";async function In(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const jn="2026.07.16-0049";async function Ai(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    ${Se(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(z=>z.card_type==="player"&&z.player),d=(s||[]).filter(z=>z.card_type==="game_changer"),u=(s||[]).filter(z=>z.card_type==="formation"),g=(s||[]).filter(z=>z.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(z=>{f[z.name]=z});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(z=>{x[z.id]=z}),g.forEach(z=>{z.stadium_def&&(x[z.stadium_id]=z.stadium_def)});const b=Object.keys(di),v=Object.keys(Me),h={};c.forEach(z=>{const C=z.player.id;h[C]=(h[C]||0)+1}),new Set(Object.keys(h).map(z=>String(z)));const $=new Set(u.map(z=>z.formation)),y=new Set(d.map(z=>z.gc_type));let j="player",E="Tous",G="",N=!1;function ie(){return[...c].sort((z,C)=>{const F=Ct.indexOf(z.player.job),V=Ct.indexOf(C.player.job);return F!==V?F-V:(z.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function te(){return[...l||[]].sort((z,C)=>{const F=Ct.indexOf(z.job),V=Ct.indexOf(C.job);return F!==V?F-V:(z.surname_real||"").localeCompare(C.surname_real||"")})}function Z(){return ie().filter(z=>{const C=z.player,F=E==="Tous"||C.job===E,V=!G||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(G);return F&&V})}function A(){return te().filter(z=>{const C=E==="Tous"||z.job===E,F=!G||`${z.firstname} ${z.surname_real}`.toLowerCase().includes(G);return C&&F})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",C=>{G=C.target.value.toLowerCase(),I()}),e.querySelectorAll(".filter-btn").forEach(C=>{C.addEventListener("click",()=>{E=C.dataset.job,_(),I()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,_(),I()})):(z.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,_(),I()})))}function I(){const z=document.getElementById("col-grid");z&&(j==="player"?Te(z):j==="formation"?K(z):j==="stadium"?R(z):Q(z))}function H(z,C,F,V,U){const B=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!B||!O)return;var _e=0;function ke(){const ve=window.innerWidth>=768,me=document.getElementById("col-big"),$e=document.getElementById("col-grid");ve&&me&&(me.style.minHeight="420px",me.style.flex="1 1 auto"),ve&&$e&&($e.style.height=Math.round(310*.76+16)+"px",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+C(z[_e])+"</div>";var Ee=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ee&&Ee.addEventListener("click",function(){V(z[_e])}),requestAnimationFrame(function(){var be=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!be||!O)){var Ce=O.clientHeight-8,qe=O.clientWidth-24,Ke=be.offsetHeight,k=be.offsetWidth;if(Ke>0&&k>0&&Ce>40){var L=ve?2.2:1.6,S=Math.min(Ce/Ke,qe/k,L);be.style.transform="scale("+S.toFixed(3)+")",be.style.transformOrigin="top center"}}}),B.innerHTML=z.map(function(be,Ce){var qe=Ce===_e,Ke="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Ke+'">'+F(be,qe)+"</div>"}).join(""),B.querySelectorAll(".col-mini-item").forEach(function(be){be.addEventListener("click",function(){_e=Number(be.dataset.idx),ke(),be.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}ke()}function le(z){var C=window.innerWidth>=768?.76:.54,F;if(!z||z._fake){var V=z?z.player:null;if(!V)return"";F=Bi(V)}else F=Xt(z,"");return'<div style="display:inline-block;zoom:'+C+';pointer-events:none;line-height:0">'+F+"</div>"}function se(z,C,F){C=C||100,F=F||140;var V=Mt[z]||{},U={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},B=Math.max(3,Math.round(C*.06)),O=Object.entries(V).map(function(ke){var ve=ke[0],me=ke[1],$e=ve.replace(/\d+$/,""),Ee=U[$e]||"#888",be=Math.round(me.x*C),Ce=Math.round(me.y*F);return'<circle cx="'+be+'" cy="'+Ce+'" r="'+B+'" fill="'+Ee+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),_e=Math.max(1,Math.round(C/50));return'<svg viewBox="0 0 '+C+" "+F+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+C+'" height="'+F+'" fill="#1A6B3C"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(F*.02)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(F*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+_e+'"/><line x1="0" y1="'+Math.round(F*.5)+'" x2="'+C+'" y2="'+Math.round(F*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+_e+'"/><ellipse cx="'+Math.round(C*.5)+'" cy="'+Math.round(F*.5)+'" rx="'+Math.round(C*.18)+'" ry="'+Math.round(F*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+_e+'"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(F*.82)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(F*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+_e+'"/>'+O+"</svg>"}function pe(z,C,F){var V=F>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+F+"</div>":"",U=C?'data-form-id="'+C.id+'"':"",B=z.length>7?14:z.length>5?16:19,O=!!C;return"<div "+U+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+V+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+B+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+z+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+se(z,140,220)+"</div></div>"}function de(z,C){var F=window.innerWidth>=768?.76:.54,V=140,U=305,B=Math.round(U*.22),O=U-B,_e=z.length>7?10:13,ke=se(z,V,O),ve=C?"1.5px solid #2a7a40":"1px solid #ddd",me=C?"":"filter:grayscale(1);opacity:0.45;",$e=C?"#1A6B3C":"#bbb",Ee="#fff";return'<div style="display:inline-block;zoom:'+F+';line-height:0;pointer-events:none"><div style="width:'+V+"px;height:"+U+"px;border-radius:6px;border:"+ve+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+me+'"><div style="height:'+B+"px;background:"+$e+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+_e+"px;font-weight:900;color:"+Ee+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(V-4)+'px">'+z+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+ke+"</div></div></div>"}function Te(z){if(N){const C=A();if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const F=C.map(V=>c.find(U=>U.player.id===V.id)||{_fake:!0,player:V,id:"fake-"+V.id});H(F,V=>V._fake?Bi(V.player):Xt(V,""),V=>V._fake?le({player:V.player,id:"x",_fake:!0}):le(V),V=>{V._fake||qi(V,c,h,t)})}else{const C=Z();if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const F={};C.forEach(U=>{const B=U.player.id;F[B]||(F[B]=[]),F[B].push(U)});const V=Object.values(F).map(U=>Un(U));H(V,U=>{const B=h[U.player.id]||1,O=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",ke=c.filter(ve=>ve.player.id===U.player.id&&ve.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Xt(U,O+ke)},U=>le(U),U=>qi(U,c,h,t))}}function K(z){const C=N?b:[...$];if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const F=C.map(V=>({formation:V,card:u.find(U=>U.formation===V)||null,owned:$.has(V)}));H(F,({formation:V,card:U,owned:B})=>pe(V,B?U:null,B?u.filter(O=>O.formation===V).length:0),({formation:V,owned:U})=>de(V,U),({card:V,owned:U})=>{U&&V&&Jn(V,u,t,o)})}function Q(z){const C=Object.keys(f),F=N?C.length?C:v:[...y];if(!F.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const V=F.map(U=>({type:U,gc:Me[U]||{icon:"⚡",desc:""},def:f[U]||null,owned:y.has(U),card:d.find(B=>B.gc_type===U)||null}));H(V,({type:U,gc:B,def:O,owned:_e,card:ke})=>{var L;const ve=_e?d.filter(S=>S.gc_type===U).length:0,me=ve>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ve}</div>`:"",$e=(O==null?void 0:O.gc_type)==="ultra_game_changer",Ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},be={purple:"#b06ce0",light_blue:"#00d4ef"},Ce=Ee[O==null?void 0:O.color]||Ee.purple,qe=be[O==null?void 0:O.color]||be.purple,Ke=(O==null?void 0:O.effect)||B.desc||"",k=O!=null&&O.image_url?`/icons/${O.image_url}`:((L=O==null?void 0:O.club)==null?void 0:L.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return _e&&ke?`<div data-gc-id="${ke.id}" data-gc-type="${U}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${qe};background:${Ce};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${qe}66;cursor:pointer">
          ${me}
        ...
        </div>`},({type:U,gc:B,def:O,owned:_e})=>{const ke=window.innerWidth>=768?.76:.54,ve={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},me={purple:"#9b59b6",light_blue:"#00bcd4"},$e=ve[O==null?void 0:O.color]||ve.purple,Ee=me[O==null?void 0:O.color]||me.purple,be=O!=null&&O.image_url?`/icons/${O.image_url}`:null;return _e?`<div style="display:inline-block;zoom:${ke};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${$e};border:1px solid ${Ee};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${U}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${be?`<img src="${be}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${B.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((O==null?void 0:O.effect)||B.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${ke};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${B.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${U}</span></div></div>`},({type:U,owned:B,def:O})=>{B&&Xn(U,O,o)})}function R(z){const C="#E87722",F="/";if(!g.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const V={};g.forEach(B=>{const O=B.stadium_id||"?";(V[O]=V[O]||[]).push(B)});const U=Object.entries(V).map(([B,O])=>({sid:B,def:x[B]||null,count:O.length,card:O[0]}));H(U,({def:B,count:O})=>{var Ee,be;const _e=(B==null?void 0:B.name)||"?",ke=((Ee=B==null?void 0:B.club)==null?void 0:Ee.encoded_name)||(B==null?void 0:B.country_code)||"—",ve=B!=null&&B.image_url?`${F}icons/${B.image_url}`:((be=B==null?void 0:B.club)==null?void 0:be.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),me=ve?`<img src="${ve}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',$e=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${C},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${C}66">
          ${$e}
        ...
        </div>`},({def:B,count:O})=>{var Ee,be;const _e=window.innerWidth>=768?.76:.54,ke=(B==null?void 0:B.name)||"?",ve=((Ee=B==null?void 0:B.club)==null?void 0:Ee.encoded_name)||(B==null?void 0:B.country_code)||"—",me=B!=null&&B.image_url?`${F}icons/${B.image_url}`:((be=B==null?void 0:B.club)==null?void 0:be.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),$e=me?`<img src="${me}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${_e};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(z=>{z.addEventListener("click",()=>{j=z.dataset.tab,E="Tous",G="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(C=>{const F=C.dataset.tab===j;C.style.borderBottomColor=F?"var(--green)":"transparent",C.style.color=F?"var(--green)":"var(--gray-600)"}),_(),I()})}),_(),I()}function Xn(e,t,i){const n=Me[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=r[t==null?void 0:t.color]||r.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=1e3;function Jn(e,t,i,n){var f,p,x;const{state:a,toast:o,closeModal:r,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const b=Mt[c]||{},v=di[c]||[],h=290,$=360,y=20;function j(G){const N=b[G];return N?{x:N.x*h,y:N.y*$}:null}let E=`<svg width="${h}" height="${$}" viewBox="0 0 ${h} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[G,N]of v){const ie=j(G),te=j(N);!ie||!te||(E+=`<line x1="${ie.x}" y1="${ie.y}" x2="${te.x}" y2="${te.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const G of Object.keys(b)){const N=j(G);if(!N)continue;const ie=G.replace(/\d+/,""),te=d[ie]||"#555";E+=`<circle cx="${N.x}" cy="${N.y}" r="${y}" fill="${te}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,E+=`<text x="${N.x}" y="${N.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${ie}</text>`}return E+="</svg>",E}const g=t.filter(b=>b.formation===c);g.length;const m=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((K,Q)=>{const R=Z[K.id]||[],z=K.is_for_sale,C=R.length?R[R.length-1]:null,V=(d.rarity==="pepite"||d.rarity==="papyte")&&K.current_note!=null?` (☆${K.current_note})`:"";return`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([K,Q])=>{const R=Yt[K],z=K==="GK"?"#fff":R,C=K===d.job||K===d.job2,F=(Number(Q)||0)+(C&&j>0?j:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(se=document.getElementById("close-detail"))==null||se.addEventListener("click",s);let I=new Set;const H=()=>{const K=I.size,Q=document.getElementById("sell-action-panel");if(!Q)return;Q.style.display=K>0?"block":"none",document.getElementById("sell-selected-count").textContent=K;const R=document.getElementById("evolve-btn");R&&(R.textContent=`⬆️ Évoluer ${K>1?"(+"+K+")":""}`)};document.querySelectorAll(".expl-check").forEach(K=>{K.addEventListener("change",()=>{const Q=K.dataset.id;K.checked?I.add(Q):I.delete(Q);const R=K.closest(".exemplaire-row");R&&(R.style.borderColor=K.checked?"#1A6B3C":"#eee"),H()})}),document.querySelectorAll(".exemplaire-row").forEach(K=>{K.addEventListener("click",Q=>{if(Q.target.closest("button")||Q.target.tagName==="INPUT")return;const R=K.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(K=>{K.addEventListener("click",Q=>{Q.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${K.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(pe=document.getElementById("evolve-btn"))==null||pe.addEventListener("click",async()=>{if(g<=1)return;const K=[...I];if(!K.length)return;if(I.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body" style="padding-bottom:20px">
    ...
    </div>`;x("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const $=Fi(t.formation),y={};$.forEach(j=>{t.slots[j]&&(y[j]=t.slots[j])}),t.slots=y,b(),Ze(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(x=>x.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(x=>x.addEventListener("click",()=>Zn(t,e,i))),e.querySelectorAll("#save-deck").forEach(x=>x.addEventListener("click",()=>io(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(x=>{x.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==x.dataset.removeSub),Ze(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(x=>x.addEventListener("click",()=>to(t,e,i)))}function Qn(e,t,i,n){var h,$;const a=window.innerWidth>=900,o=e.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const r=(h=t.stadiumCards)==null?void 0:h.find(y=>y.id===t.stadiumCardId),s=r&&(($=t.stadDefMap)==null?void 0:$[r.stadium_id])||null,l=Mt[t.formation]||{},c=Hi(t.formation)||[],d={};for(const y of i){const j=t.slots[y],E=j?t.playerCards.find(G=>G.id===j):null;E!=null&&E.player?d[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:d[y]=null}const u=window.innerWidth>=900,g=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(g,860):g,f=Math.round(u?m*.82:m*.85),p=u?84:44;let x="";for(const[y,j]of c){const E=l[y],G=l[j];if(!E||!G)continue;const N=E.x*m,ie=Math.round(.03*f+E.y*.85*f),te=G.x*m,Z=Math.round(.03*f+G.y*.85*f),A=d[y],_=d[j],I=vt(A,_);I==="#ff3333"||I==="#cc2222"?x+=`<line x1="${N.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${I}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${N.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${I}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${N.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${I}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const v=Math.round(p*657/507);for(const y of i){const j=l[y];if(!j)continue;const E=d[y],G=j.x*m;j.y*f;const N=Math.round(.03*f+j.y*(.85*f)),ie=Math.round(G-p/2),te=Math.round(N-v/2);if(E){const Z=y.replace(/\d+/,""),A=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),_=Se({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:Z});b+=`<div style="position:absolute;left:${ie}px;top:${te}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
      ...
      </div>`}else{const Z=y.replace(/\d+/,"");b+=`<div style="position:absolute;left:${ie}px;top:${te}px;width:${p}px;height:${v}px;
  ...
  `,document.body.appendChild(a);let o=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function d(_){o||(l=!0,s.style.opacity="1",u(_))}function u(_){if(!l||o)return;const I=r.getBoundingClientRect(),H=c(_)-I.left,le=Math.max(0,Math.min(1,H/I.width));s.style.width=le*I.width+"px",le>=.82&&m()}function g(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var I;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(I=document.getElementById("cut-flash"))==null||I.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}r.addEventListener("pointerdown",d),window.addEventListener("pointermove",u),window.addEventListener("pointerup",g),r.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",g);let f=0,p=!1;const x=new Set;function b(_){f=_,document.getElementById("reveal-phase").style.display="flex",v(),h(_,0),G()}function v(){const _=document.getElementById("card-dots");_&&(_.innerHTML=e.map((I,H)=>`<div class="card-dot" data-i="${H}" style="width:8px;height:8px;border-radius:50%;background:${H===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(I=>I.addEventListener("click",()=>y(parseInt(I.dataset.i)))))}function h(_,I){var R,z;const H=e[_],le=document.getElementById("card-counter"),se=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${e.length}`);const pe=document.getElementById("reveal-btns");pe&&(pe.style.display=_===e.length-1?"flex":"none");const de=H.card_type==="player"&&((R=H.player)==null?void 0:R.rarity)==="legende",Te=!x.has(_);x.add(_);let K=0;if(H.card_type==="player"&&H.player){const C=H.player,F=C.job||"ATT";K=Number(F==="GK"?C.note_g:F==="DEF"?C.note_d:F==="MIL"?C.note_m:C.note_a)||0}const Q=C=>{se.innerHTML=`
        ...
        </div>`;const F=document.getElementById("current-card-wrap");I!==0?(F.style.transition="none",F.style.transform=`translateX(${I>0?100:-100}%)`,requestAnimationFrame(()=>{F.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",F.style.transform="translateX(0)"})):F.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),C||de?ie():te(),v()};Te&&(((z=H.player)==null?void 0:z.rarity)==="legende"||K>=8)&&H.card_type==="player"&&H.player?$(H,()=>Q(!0)):Q(!1)}function $(_,I){var ve;p=!0;const H=_.player,le=`https://flagsapi.com/${H.country_code}/flat/64.png`,se=(ve=H.clubs)==null?void 0:ve.logo_url,pe=H.face?"/"+H.face.replace(/^public\//,"").replace(/^\//,""):null,de=H.job||"ATT",Te=Number(de==="GK"?H.note_g:de==="DEF"?H.note_d:de==="MIL"?H.note_m:H.note_a)||0,K=_.evolution_bonus||0,Q=Te+K,R=H.rarity==="legende",z=Q>=18,C=document.getElementById("walkout-overlay"),F=document.getElementById("walkout-stage");if(!C||!F){p=!1,I();return}let V=null;R&&(V=new Audio("/sounds/Legendary.mp3"),V.volume=.8,V.play().catch(()=>{})),C.style.display="flex";const U=()=>{const me=F.firstElementChild;me&&(me.classList.remove("wo-in"),me.classList.add("wo-out"))},B=1800,O=400;F.innerHTML=`<img class="wo-in" src="${le}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(U,B),setTimeout(()=>{var me;F.innerHTML=se?`<img class="wo-in" src="${se}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((me=H.clubs)==null?void 0:me.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},B+O),setTimeout(U,B*2+O),setTimeout(()=>{F.innerHTML=pe?`<img class="wo-in" src="${pe}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(B+O)*2),setTimeout(U,(B+O)*2+B);const ke=z?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[de]||"#fff";setTimeout(()=>{F.innerHTML=`<div class="wo-in" style="
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),l=[...new Set((s||[]).filter(g=>{var m,f;return((m=g.card)==null?void 0:m.card_type)==="stadium"&&((f=g.card)==null?void 0:f.stadium_id)}).map(g=>g.card.stadium_id))],c={};if(l.length){const{data:g}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",l);(g||[]).forEach(m=>{c[m.id]=m}),(s||[]).forEach(m=>{var f,p;((f=m.card)==null?void 0:f.card_type)==="stadium"&&((p=m.card)!=null&&p.stadium_id)&&(m.card._stadiumDef=c[m.card.stadium_id]||null)})}let d=0;function u(){var y,j,E,G,N,ie,te;const g=o[d],m=(s||[]).filter(Z=>Z.deck_id===g.id),f=m.filter(Z=>{var A;return Z.is_starter&&((A=Z.card)==null?void 0:A.player)}).map(Z=>ii(Z.card,Z.position)),p=m.find(Z=>{var A;return((A=Z.card)==null?void 0:A.card_type)==="formation"}),x=g.formation||((y=p==null?void 0:p.card)==null?void 0:y.formation)||"4-4-2";let b=f.length>=11?Gt(f,x):null,v=((j=g.stadium_card)==null?void 0:j.stadium_def)||null;v&&b&&(b=It(b,v));const h=f.length>=11;Ue(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Z(){const A=e.querySelector(".deck-preview-wrap"),_=e.querySelector("#deck-swipe-zone");if(!A||!_||!b)return;const I=_.clientWidth>=900,H=Math.max(200,_.clientHeight-(I?60:40)),se=Math.max(200,_.clientWidth-16),pe=I?Math.min(117,Math.max(52,Math.round(se*.22))):Math.max(44,Math.round(se*.168));if(H<220||se<220){requestAnimationFrame(Z);return}const de=I?null:Math.round(pe*.55);A.innerHTML=bt(b,x,null,[],se,H,[],de),A.style.cssText=`width:${se}px;height:${H}px;overflow:hidden;margin:${I?0:60}px auto 0`;const Te=A.querySelector("svg");Te&&(Te.style.cssText="display:block;width:100%;height:100%",Te.setAttribute("preserveAspectRatio",I?"xMidYMid meet":"none"))})),(G=document.getElementById("prev-deck"))==null||G.addEventListener("click",()=>{d>0&&(d--,u())}),(N=document.getElementById("next-deck"))==null||N.addEventListener("click",()=>{d<o.length-1&&(d++,u())}),(ie=document.getElementById("validate-deck"))==null||ie.addEventListener("click",()=>{if(!h)return;const Z=t.state.params||{};t.navigate("match",{...Z,matchMode:Z.matchMode||i,deckId:g.id})}),(te=document.getElementById("cancel-deck-select"))==null||te.addEventListener("click",()=>{Ne(e),a("home")});const $=document.getElementById("deck-swipe-zone");if($){let Z=0,A=0;$.addEventListener("touchstart",_=>{Z=_.touches[0].clientX,A=_.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",_=>{const I=_.changedTouches[0].clientX-Z,H=_.changedTouches[0].clientY-A;Math.abs(I)<40||Math.abs(I)<Math.abs(H)||(I<0&&d<o.length-1?(d++,u()):I>0&&d>0&&(d--,u()))},{passive:!0})}}u()}function Je(e,t=44,i=58,n=null){return Se(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function ut(e,t,i){if(!(e!=null&&e.length))return"";const n=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((o,r)=>{const s=o._line||o.job||"MIL";if(a+=Se(o,{width:40,role:s,extraNote:o.boost||0}),r<n.length-1){const l=vt(o,n[r+1]);a+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Pt(e,t,i,n,a=310,o=310,r=[],s=null){const l=Mt[t]||{},c=Hi(t)||di[t]||[],d={},u=["ATT","MIL","DEF","GK"];for(const b of u)(e[b]||[]).forEach((h,$)=>{d[`${b}${$+1}`]=h});function g(b){const v=l[b];return v?{x:v.x*a,y:v.y*o}:null}let m="";for(const[b,v]of c){const h=g(b),$=g(v);if(!h||!$)continue;const y=d[b],j=d[v],E=vt(y,j);E==="#00ff88"||E==="#FFD700"?(m+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
        ...
        stroke="${E}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const f=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(a*.225)),117):Math.max(44,Math.round(a*.168)),p=Math.round(f*657/507);for(const[b,v]of Object.entries(d)){const h=g(b);if(!h||!v)continue;const $=b.replace(/[0-9]/g,""),y=r.includes(v.cardId),j=i==="attack"&&(["MIL","ATT"].includes($)||y)&&!v.used||i==="defense"&&["GK","DEF","MIL"].includes($)&&!v.used,E=n.includes(v.cardId);let G=v.boost||0,N=!1;v.stadiumBonus&&(i==="attack"&&($==="ATT"||$==="MIL")||i==="defense"&&($==="GK"||$==="DEF"||$==="MIL")?(G+=10,N=!0):i||(G+=10,N=!0));const ie=Math.round(h.x-f/2),te=Math.round(h.y-p/2);if(v.used){m+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${ie}" y="${te}" width="${f}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${v.cardId}" data-role="${$}" style="cursor:pointer"/>`;continue}const Z=Se({...v,_evolution_bonus:0,stadiumBonus:!1},{width:f,showStad:!1,stadDef:null,role:$,extraNote:G,_cardOffset:30,_forceStadColor:N}),A=E?`position:absolute;top:30px;left:0;width:${f}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";m+=`<foreignObject x="${ie-2}" y="${te-30}" width="${f+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${Z}
        ${E?`<div style="${A}"></div>`:""}
      </div>
    </foreignObject>`,j&&(m+=`<rect x="${ie}" y="${te}" width="${f}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${v.cardId}" data-role="${$}" style="cursor:pointer"/>`)}const x=s!==null?s:Math.round(Math.max(f*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-x} ${-x} ${a+x*2} ${o+x*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${m}
  </svg>`}function bt(e,t,i,n,a=300,o=300,r=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Pt(e,t,i,n,a,o,r,s)}
  </div>`}async function At(e,t,i,n){var j;const{state:a,navigate:o,toast:r}=t;Ue(e);const s=a.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return wo(e,t,i);const l=s.deckId;let c,d,u,g;try{const E=await Promise.all([w.from("decks").select("formation,name,stadium_card_id").eq("id",l).single(),w.from("deck_cards").select(`position, is_starter, slot_order,
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const _=window.innerWidth>=700,I=(R,z,C)=>{var be,Ce;const F=(t.gcDefs||[]).find(qe=>qe.name===R.gc_type),V={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[F==null?void 0:F.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",U={purple:"#b06ce0",light_blue:"#00d4ef"}[F==null?void 0:F.color]||"#b06ce0",B=(F==null?void 0:F.name)||R.gc_type,O=(F==null?void 0:F.effect)||((be=Me[R.gc_type])==null?void 0:be.desc)||"",_e=F!=null&&F.image_url?`/icons/${F.image_url}`:null,ke=((Ce=Me[R.gc_type])==null?void 0:Ce.icon)||"⚡",ve=Math.round(C*.22),me=Math.round(C*.22),$e=C-ve-me,Ee=B.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${z}px;height:${C}px;border-radius:10px;border:2px solid ${U};background:${V};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${ve}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ee}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${z-6}px">${B}</span>
  ...
  <div id="match-history-panel">
    ...
    </div>`,p==="p1"&&setTimeout(async()=>{await A({phase:"midfield"})},5e3)}let K=!1;function Q(){if(K)return;const k=y[p+"Team"].MIL||[],L=y[x+"Team"].MIL||[],S=milScore(k)+milLinks(k),M=milScore(L)+milLinks(L),T=S>=M;function D(ae,oe,ue){return`<div id="duel-row-${ue}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="width:min(90vw,420px)">${Pt(y[x+"Team"],y[x+"Formation"],null,[],rt(),ft())}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(k),(L=k.querySelector("#pvp-opp-close"))==null||L.addEventListener("click",()=>k.remove())}function B(){var S;const k=y.log||[],L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",L.innerHTML=`
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${u.map(A=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #f5f5f5">
            <div style="width:36px;height:36px;border-radius:50%;background:${A.club_color2||mt};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${A.club_color1||"#fff"}">${(A.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${g.map((A,_)=>{const I=f>0&&r.status==="finished"?_===0?Math.floor(f*.7):_===1?Math.floor(f*.2):_===2?Math.floor(f*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${A.userId===o?"background:#f0fdf4;":""}">
              ...
              <td style="text-align:center;color:${A.goalDiff>=0?mt:"#cc2222"}">${A.goalDiff>=0?"+":""}${A.goalDiff}</td>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(A,_)=>_+1).reverse().map(A=>{const _=(l||[]).filter(I=>I.matchday===A);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${A}</div>${_.map(I=>Ri(I,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let l="buy";const c=()=>{var p,x,b,v,h,$,y;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((x=document.getElementById("flt-club"))==null?void 0:x.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((v=document.getElementById("flt-job"))==null?void 0:v.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt(($=document.getElementById("flt-note1"))==null?void 0:$.value)||0,note2:parseInt((y=document.getElementById("flt-note2"))==null?void 0:y.value)||0}};function d(p){const x=c();return p.filter(b=>{var N,ie,te;const v=(N=b.card)==null?void 0:N.player;if(!v)return!1;const h=`${v.firstname} ${v.surname_real}`.toLowerCase(),$=(((ie=v.clubs)==null?void 0:ie.encoded_name)||"").toLowerCase(),y=(v.country_code||"").toLowerCase(),j=((te=b.card)==null?void 0:te.evolution_bonus)||0,E=ct(v,v.job,j),G=v.job2?ct(v,v.job2,j):0;return!(x.name&&!h.includes(x.name)||x.club&&!$.includes(x.club)||x.country&&!y.includes(x.country)||x.job&&v.job!==x.job||x.rarity&&v.rarity!==x.rarity||x.note1&&E<x.note1||x.note2&&G<x.note2)})}function u(p){var G,N,ie,te;const x=(G=p.card)==null?void 0:G.player;if(!x)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,v=ct(x,x.job,b),h=x.job2?ct(x,x.job2,b):0,$=(i.profile.credits||0)>=p.price,y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,j=qt[x.job]||"#bbb",E=x.job2?qt[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function g(p){var G,N,ie,te;const x=(G=p.card)==null?void 0:G.player;if(!x)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,v=ct(x,x.job,b),h=x.job2?ct(x,x.job2,b):0,$=p.status==="sold",y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,j=qt[x.job]||"#bbb",E=x.job2?qt[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ie=x.clubs)!=null&&ie.logo_url?`<img src="${x.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${j};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=r||[];f.innerHTML=b.length>0?b.map((v,h)=>{const $=li(v.mmr??1e3),y=(v.ranked_wins||0)+(v.ranked_losses||0)+(v.ranked_draws||0),j=y>0?Math.round((v.ranked_wins||0)/y*100):0,E=v.id===i.profile.id,G=(v.placement_matches||0)<10;return`
