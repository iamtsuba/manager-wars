...
import{s as w,F as si,r as Ie,j as It,l as Gi,m as bt,h as di,n as mn,o as xn,T as Yt,k as yn,p as bn,b as hn}from"./formation-links-TDtFd05S.js";const vn="/";function Li(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,d,l,c,u;const o=n==="login";e.innerHTML=`
  ...
  `;function s(){var f;const l=document.getElementById("logo-preview"),c=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();l&&(l.style.background=r,l.style.borderColor=o),c&&(c.textContent=m,c.style.color=o)}document.getElementById("color1").addEventListener("input",l=>{o=l.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",l=>{r=l.target.value,document.getElementById("swatch2").style.background=r,s()});function d(l){document.querySelectorAll(".setup-step").forEach(c=>c.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("step1-error");if(c.textContent="",l.length<3){c.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",l).maybeSingle();if(u){c.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),c=document.getElementById("step2-error");if(c.textContent="",l.length<2){c.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",l).maybeSingle();if(u){c.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:l,club_name:c,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await _n(t.user.id),await a(),n(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function _n(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const kn="modulepreload",$n=function(e){return"/"+e},Ti={},Ri=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(d=>{if(d=$n(d),d in Ti)return;Ti[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":kn,l||(u.as="script"),u.crossOrigin="",u.href=d,s&&u.setAttribute("nonce",s),document.head.appendChild(u),l)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Lt="#1A6B3C",Tt="#cc2222",En="#D4A017",zi="#888";async function Ln(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const In="2026.07.15-2119";async function Ai(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    ${Ie(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter(T=>T.card_type==="player"&&T.player),c=(s||[]).filter(T=>T.card_type==="game_changer"),u=(s||[]).filter(T=>T.card_type==="formation"),g=(s||[]).filter(T=>T.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(T=>{f[T.name]=T});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(T=>{x[T.id]=T}),g.forEach(T=>{T.stadium_def&&(x[T.stadium_id]=T.stadium_def)});const b=Object.keys(si),h=Object.keys(Me),v={};l.forEach(T=>{const M=T.player.id;v[M]=(v[M]||0)+1}),new Set(Object.keys(v).map(T=>String(T)));const k=new Set(u.map(T=>T.formation)),y=new Set(c.map(T=>T.gc_type));let C="player",E="Tous",P="",N=!1;function te(){return[...l].sort((T,M)=>{const R=Ct.indexOf(T.player.job),H=Ct.indexOf(M.player.job);return R!==H?R-H:(T.player.surname_real||"").localeCompare(M.player.surname_real||"")})}function ne(){return[...d||[]].sort((T,M)=>{const R=Ct.indexOf(T.job),H=Ct.indexOf(M.job);return R!==H?R-H:(T.surname_real||"").localeCompare(M.surname_real||"")})}function ee(){return te().filter(T=>{const M=T.player,R=E==="Tous"||M.job===E,H=!P||`${M.firstname} ${M.surname_real}`.toLowerCase().includes(P);return R&&H})}function q(){return ne().filter(T=>{const M=E==="Tous"||T.job===E,R=!P||`${T.firstname} ${T.surname_real}`.toLowerCase().includes(P);return M&&R})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function A(){const T=document.getElementById("col-filters");T&&(C==="player"?(T.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",M=>{P=M.target.value.toLowerCase(),$()}),e.querySelectorAll(".filter-btn").forEach(M=>{M.addEventListener("click",()=>{E=M.dataset.job,A(),$()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,A(),$()})):(T.innerHTML=`
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(T=>{T.addEventListener("click",()=>{C=T.dataset.tab,E="Tous",P="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(M=>{const R=M.dataset.tab===C;M.style.borderBottomColor=R?"var(--green)":"transparent",M.style.color=R?"var(--green)":"var(--gray-600)"}),A(),$()})}),A(),$()}function Kn(e,t,i){const n=Me[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=r[t==null?void 0:t.color]||r.purple,l=(t==null?void 0:t.name)||e,c=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=1e3;function Vn(e,t,i,n){var f,p,x;const{state:a,toast:o,closeModal:r,navigate:s,refreshProfile:d}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const b=It[l]||{},h=si[l]||[],v=290,k=360,y=20;function C(P){const N=b[P];return N?{x:N.x*v,y:N.y*k}:null}let E=`<svg width="${v}" height="${k}" viewBox="0 0 ${v} ${k}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,N]of h){const te=C(P),ne=C(N);!te||!ne||(E+=`<line x1="${te.x}" y1="${te.y}" x2="${ne.x}" y2="${ne.y}"
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(pe=document.getElementById("close-detail"))==null||pe.addEventListener("click",s);let $=new Set;const F=()=>{const K=$.size,Q=document.getElementById("sell-action-panel");if(!Q)return;Q.style.display=K>0?"block":"none",document.getElementById("sell-selected-count").textContent=K;const V=document.getElementById("evolve-btn");V&&(V.textContent=`⬆️ Évoluer ${K>1?"(+"+K+")":""}`)};document.querySelectorAll(".expl-check").forEach(K=>{K.addEventListener("change",()=>{const Q=K.dataset.id;K.checked?$.add(Q):$.delete(Q);const V=K.closest(".exemplaire-row");V&&(V.style.borderColor=K.checked?"#1A6B3C":"#eee"),F()})}),document.querySelectorAll(".exemplaire-row").forEach(K=>{K.addEventListener("click",Q=>{if(Q.target.closest("button")||Q.target.tagName==="INPUT")return;const V=K.querySelector(".expl-check");V&&!V.disabled&&(V.checked=!V.checked,V.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(K=>{K.addEventListener("click",Q=>{Q.stopPropagation();const V=document.querySelector(`.expl-hist[data-hist="${K.dataset.idx}"]`);V&&(V.style.display=V.style.display==="none"?"flex":"none")})}),(le=document.getElementById("evolve-btn"))==null||le.addEventListener("click",async()=>{if(g<=1)return;const K=[...$];if(!K.length)return;if($.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
  ...
  `,document.body.appendChild(a);let o=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=A=>A.touches&&A.touches[0]?A.touches[0].clientX:A.clientX;function c(A){o||(d=!0,s.style.opacity="1",u(A))}function u(A){if(!d||o)return;const $=r.getBoundingClientRect(),F=l(A)-$.left,ae=Math.max(0,Math.min(1,F/$.width));s.style.width=ae*$.width+"px",ae>=.82&&m()}function g(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var $;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",($=document.getElementById("cut-flash"))==null||$.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const A=document.getElementById("cut-hint");A&&(A.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}r.addEventListener("pointerdown",c),window.addEventListener("pointermove",u),window.addEventListener("pointerup",g),r.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",g);let f=0,p=!1;const x=new Set;function b(A){f=A,document.getElementById("reveal-phase").style.display="flex",h(),v(A,0),P()}function h(){const A=document.getElementById("card-dots");A&&(A.innerHTML=e.map(($,F)=>`<div class="card-dot" data-i="${F}" style="width:8px;height:8px;border-radius:50%;background:${F===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),A.querySelectorAll(".card-dot").forEach($=>$.addEventListener("click",()=>y(parseInt($.dataset.i)))))}function v(A,$){var V,T;const F=e[A],ae=document.getElementById("card-counter"),pe=document.getElementById("card-track");ae&&(ae.textContent=`Carte ${A+1} / ${e.length}`);const le=document.getElementById("reveal-btns");le&&(le.style.display=A===e.length-1?"flex":"none");const se=F.card_type==="player"&&((V=F.player)==null?void 0:V.rarity)==="legende",ke=!x.has(A);x.add(A);let K=0;if(F.card_type==="player"&&F.player){const M=F.player,R=M.job||"ATT";K=Number(R==="GK"?M.note_g:R==="DEF"?M.note_d:R==="MIL"?M.note_m:M.note_a)||0}const Q=M=>{pe.innerHTML=`
        ...
        ${Q}
      </div>`,T&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(j+O)*3),setTimeout(U,(j+O)*3+j),setTimeout(()=>{M.style.display="none",R.innerHTML="",p=!1,H&&!V&&H.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),$()},(j+O)*4)}function y(A){if(p||A<0||A>=e.length||A===f)return;const $=A>f?1:-1;f=A,v(A,$)}function C(){y(f+1)}function E(){y(f-1)}function P(){const A=document.getElementById("card-viewport");if(!A||A._swipeBound)return;A._swipeBound=!0;let $=0,F=0,ae=0,pe=!1;const le=V=>V.touches?V.touches[0].clientX:V.clientX,se=V=>V.touches?V.touches[0].clientY:V.clientY,ke=V=>{pe=!0,$=le(V),F=se(V),ae=0},K=V=>{if(!pe)return;ae=le(V)-$;const T=se(V)-F;if(Math.abs(ae)<Math.abs(T))return;const M=document.getElementById("current-card-wrap");M&&(M.style.transition="none",M.style.transform=`translateX(${ae*.6}px) rotate(${ae*.02}deg)`)},Q=()=>{if(!pe)return;pe=!1;const V=document.getElementById("current-card-wrap"),T=55;ae<=-T&&f<e.length-1?C():ae>=T&&f>0?E():V&&(V.style.transition="transform .2s ease",V.style.transform="translateX(0)")};A.addEventListener("pointerdown",ke),A.addEventListener("pointermove",K),A.addEventListener("pointerup",Q),A.addEventListener("pointercancel",Q),A.addEventListener("touchstart",ke,{passive:!0}),A.addEventListener("touchmove",K,{passive:!0}),A.addEventListener("touchend",Q),A.addEventListener("click",V=>{if(Math.abs(ae)>8)return;const T=A.getBoundingClientRect();V.clientX-T.left>T.width/2?C():E()})}let N=null;function te(){const A=document.getElementById("fireworks-canvas");if(!A)return;A.width=window.innerWidth,A.height=window.innerHeight;const $=A.getContext("2d"),F=[];function ae(){const le=Math.random()*A.width,se=Math.random()*A.height*.6,ke=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],K=ke[Math.floor(Math.random()*ke.length)];for(let Q=0;Q<60;Q++){const V=Math.PI*2/60*Q,T=2+Math.random()*5;F.push({x:le,y:se,vx:Math.cos(V)*T,vy:Math.sin(V)*T,alpha:1,color:K,size:2+Math.random()*3})}}ae(),N=setInterval(ae,600);function pe(){if(document.getElementById("fireworks-canvas")){$.clearRect(0,0,A.width,A.height);for(let le=F.length-1;le>=0;le--){const se=F[le];if(se.x+=se.vx,se.y+=se.vy+.08,se.vy*=.98,se.alpha-=.018,se.alpha<=0){F.splice(le,1);continue}$.globalAlpha=se.alpha,$.fillStyle=se.color,$.beginPath(),$.arc(se.x,se.y,se.size,0,Math.PI*2),$.fill()}$.globalAlpha=1,(N!==null||F.length>0)&&requestAnimationFrame(pe)}}pe()}function ne(){N!==null&&(clearInterval(N),N=null);const A=document.getElementById("fireworks-canvas");A&&A.getContext("2d").clearRect(0,0,A.width,A.height)}if(n){const A=document.getElementById("reveal-btns");A&&(A.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(q=document.getElementById("reveal-next"))==null||q.addEventListener("click",()=>{ne(),a.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ne(),a.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ne(),a.remove(),i("boosters")})}function so(e){var t,i,n,a;if(e.card_type==="player"&&e.player)return io(e);if(e.card_type==="game_changer"){const o=e._gcDef,r=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},d={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[o==null?void 0:o.color]||s.purple,c=d[o==null?void 0:o.color]||d.purple,u=(o==null?void 0:o.name)||e.gc_type||"Game Changer",g=(o==null?void 0:o.effect)||((t=ti[e.gc_type])==null?void 0:t.desc)||"",m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,f=((i=ti[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${l};border-radius:14px;border:3px solid ${c};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${c}88;flex-shrink:0">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const $=window.innerWidth>=700,F=(T,M,R)=>{var je,Be;const H=(t.gcDefs||[]).find(Fe=>Fe.name===T.gc_type),U={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[H==null?void 0:H.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",j={purple:"#b06ce0",light_blue:"#00d4ef"}[H==null?void 0:H.color]||"#b06ce0",O=(H==null?void 0:H.name)||T.gc_type,Ee=(H==null?void 0:H.effect)||((je=Me[T.gc_type])==null?void 0:je.desc)||"",_e=H!=null&&H.image_url?`/icons/${H.image_url}`:null,we=((Be=Me[T.gc_type])==null?void 0:Be.icon)||"⚡",me=Math.round(R*.22),Le=Math.round(R*.22),$e=R-me-Le,he=O.length>12?7:9;return`<div class="gc-mini" data-gc-id="${T.id}" data-gc-type="${T.gc_type}"
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map($=>{var F,ae,pe;if($.type==="duel"){const le=$.isGoal,se=$.homeScored?"#FFD700":le?"#ff6b6b":"rgba(255,255,255,0.3)",ke=$.homeScored?"⚽ BUT !":le?"⚽ BUT IA !":(F=$.homePlayers)!=null&&F.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${le?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${se};margin-bottom:4px">
                <div style="font-size:9px;color:${se};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${ke}</div>
                ${(ae=$.homePlayers)!=null&&ae.length?`<div style="margin-bottom:3px">${pt($.homePlayers,"rgba(255,255,255,0.7)",$.homeTotal)}</div>`:""}
    ...
    </div>`,(y=u.querySelector("#sub-close"))==null||y.addEventListener("click",()=>u.remove()),(C=u.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,g())}),(E=u.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,g())}),(P=u.querySelector("#in-up"))==null||P.addEventListener("click",()=>{l>0&&(l--,g())}),(N=u.querySelector("#in-down"))==null||N.addEventListener("click",()=>{l<r.length-1&&(l++,g())});const k=(ne,ee,q,A)=>{const $=u.querySelector("#"+ne);if(!$)return;let F=0;$.addEventListener("touchstart",ae=>{F=ae.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",ae=>{const pe=ae.changedTouches[0].clientY-F;if(Math.abs(pe)<30)return;const le=ee();pe<0&&le<A-1?(q(le+1),g()):pe>0&&le>0&&(q(le-1),g())},{passive:!0})};k("in-panel",()=>l,ne=>l=ne,r.length),k("out-panel",()=>s,ne=>s=ne,o.length),(te=u.querySelector("#sub-confirm"))==null||te.addEventListener("click",ne=>{if(ne.preventDefault(),ne.stopPropagation(),c)return;c=!0;const ee=o[s],q=r[l];if(!ee||!q)return;let A=null,$=-1;for(const[ae,pe]of Object.entries(t.homeTeam)){const le=(pe||[]).findIndex(se=>se.cardId===ee.cardId);if(le!==-1){A=ae,$=le;break}}if($===-1||!A){_t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const F={...q,_line:A,_col:ee._col||0,used:!1,boost:0};t.homeTeam[A].splice($,1,F),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(q.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:ee.name,firstname:ee.firstname,note:Ce(ee,A),portrait:zt(ee),job:ee.job,country_code:ee.country_code,rarity:ee.rarity,clubName:ee.clubName,clubLogo:ee.clubLogo},inPlayer:{name:q.name,firstname:q.firstname,note:Ce(q,A),portrait:zt(q),job:q.job,country_code:q.country_code,rarity:q.rarity,clubName:q.clubName,clubLogo:q.clubLogo},text:`🔄 ${q.firstname} ${q.name} remplace ${ee.firstname} ${ee.name}`}),u.remove(),ho(ee,q,()=>Te(e,t,i))})}document.body.appendChild(u),g()}function Mo(e,t,i,n,a){var f,p;const o=(n.gcDefs||[]).find(x=>x.name===t),r=Me[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",d={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",l=(o==null?void 0:o.name)||t,c=(o==null?void 0:o.effect)||r.desc,u=o!=null&&o.image_url?`/icons/${o.image_url}`:null,g=r.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(B),(re=B.querySelector("#pvp-end-home"))==null||re.addEventListener("click",()=>{B.remove(),Ue(e),m(r?"ranked":"home")})}const ee=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{const L=_.new;try{if(L.status==="finished"||L.forfeit){if(C)return;C=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),ne(L);return}if(L.game_state){const I=y;y=L.game_state;const S=y._lastGC;if(S&&S.seq&&!te.has(S.seq)&&(te.add(S.seq),S.by!==p)){V(S.type,S.by,()=>se());return}const z=I[p+"Score"]||0,D=I[x+"Score"]||0,B=y[p+"Score"]||0,G=y[x+"Score"]||0,Y=B>z,W=G>D;if((Y||W)&&!N.has(y.round)){N.add(y.round);const X=[...y.log||[]].reverse().find(J=>J.isGoal),re=((X==null?void 0:X.homePlayers)||[]).map(J=>({name:J.name,note:J.note,portrait:J.portrait,job:J.job}));at(re,B,G,Y,()=>se());return}se()}}catch(I){console.error("[PvP] crash:",I)}}).subscribe();async function q(_){Object.assign(y,_),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{se()}catch(I){console.error("[PvP] renderPvpScreen crash:",I)}}async function A(){if(C)return;C=!0,E&&(clearInterval(E),E=null);const _=n?v.away_id:v.home_id,L=n?"p2":"p1",I=n?"p1":"p2",S={...y,[L+"Score"]:3,[I+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:_,home_score:S.p1Score||0,away_score:S.p2Score||0,game_state:S}).eq("id",i)}catch{}try{w.removeChannel(ee)}catch{}setTimeout(()=>{Ue(e),m("home")},800)}const $={BOOST_STAT:({value:_=1,count:L=1,roles:I=[]},S,z)=>{const D=S[p+"Team"],B=Object.entries(D).filter(([G])=>!I.length||I.includes(G)).flatMap(([G,Y])=>Y.filter(W=>!W.used).map(W=>({...W,_line:G})));if(!B.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(S);return}F(B,L,`Choisir ${L} joueur(s) à booster (+${_})`,G=>{G.forEach(Y=>{const W=(D[Y._line]||[]).find(X=>X.cardId===Y.cardId);W&&(W.boost=(W.boost||0)+_,S.log.push({text:`⚡ +${_} sur ${W.name}`,type:"info"}))}),S[p+"Team"]=D,z(S)})},DEBUFF_STAT:({value:_=1,count:L=1,roles:I=[],target:S="ai"},z,D)=>{const B=S==="home"?p:x,G=z[B+"Team"],Y=S==="home"?"allié":"adverse",W=Object.entries(G).filter(([X])=>!I.length||I.includes(X)).flatMap(([X,re])=>re.map(J=>({...J,_line:X})));if(!W.length){z.log.push({text:`🎯 Aucun joueur ${Y}`,type:"info"}),D(z);return}F(W,L,`Choisir ${L} joueur(s) ${Y}(s) (-${_})`,X=>{X.forEach(re=>{const J=(G[re._line]||[]).find(ce=>ce.cardId===re.cardId);J&&(J.boost=(J.boost||0)-_,z.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),z[B+"Team"]=G,D(z)})},GRAY_PLAYER:({count:_=1,roles:L=[],target:I="ai"},S,z)=>{const D=I==="home"?p:x,B=S[D+"Team"],G=I==="home"?"allié":"adverse",Y=Object.entries(B).filter(([W])=>!L.length||L.includes(W)).flatMap(([W,X])=>X.filter(re=>!re.used).map(re=>({...re,_line:W})));if(!Y.length){S.log.push({text:`❌ Aucun joueur ${G}`,type:"info"}),z(S);return}F(Y,_,`Choisir ${_} joueur(s) ${G}(s) à exclure`,W=>{const X="usedCardIds_"+D,re=new Set(S[X]||[]);W.forEach(J=>{const ce=(B[J._line]||[]).find(de=>de.cardId===J.cardId);ce&&(ce.used=!0,re.add(J.cardId),S.log.push({text:`❌ ${ce.name} exclu !`,type:"info"}))}),S[X]=[...re],S[D+"Team"]=B,z(S)})},REVIVE_PLAYER:({count:_=1,roles:L=[]},I,S)=>{const z=I[p+"Team"],D=Object.entries(z).filter(([B])=>!L.length||L.includes(B)).flatMap(([B,G])=>G.filter(Y=>Y.used).map(Y=>({...Y,_line:B})));if(!D.length){I.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(I);return}F(D,_,`Choisir ${_} joueur(s) à ressusciter`,B=>{B.forEach(G=>{const Y=(z[G._line]||[]).find(W=>W.cardId===G.cardId);Y&&(Y.used=!1,I.log.push({text:`💫 ${Y.name} ressuscité !`,type:"info"}))}),I[p+"Team"]=z,S(I)})},REMOVE_GOAL:({},_,L)=>{const I=x+"Score";_[I]>0?(_[I]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(_)},ADD_GOAL_DRAW:({},_,L)=>{_[p+"Score"]===_[x+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(_)},ADD_SUB:({value:_=1},L,I)=>{L.maxSubs=(L.maxSubs||3)+_,L.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),I(L)},CUSTOM:({},_,L)=>L(_)};function F(_,L,I,S){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let D=[];function B(){var Y,W;const G=_.map(X=>{const re={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[X._line]||"#555",J=Ce(X,X._line)+(X.boost||0),de=D.find(ue=>ue.cardId===X.cardId)?"#FFD700":"rgba(255,255,255,0.25)",oe=X.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${X.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${de};background:${re};overflow:hidden;cursor:pointer;${oe}">
        ...
        </div>`,(Y=z.querySelector("#pp-close"))==null||Y.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(X=>{X.addEventListener("click",()=>{const re=X.dataset.cid,J=_.find(de=>de.cardId===re),ce=D.findIndex(de=>de.cardId===re);J&&(ce>-1?D.splice(ce,1):D.length<L&&D.push(J),B())})}),(W=z.querySelector("#pp-confirm"))==null||W.addEventListener("click",()=>{z.remove(),S(D)})}B(),document.body.appendChild(z)}async function ae(_,L){const S=(y["gcCardsFull_"+p]||[]).find(G=>G.id===_),z=(S==null?void 0:S._gcDef)||(y.gcDefs||[]).find(G=>{var Y;return G.name===L||((Y=G.name)==null?void 0:Y.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),D=[...y["usedGc_"+p]||[],_],B={type:L,by:p,seq:(y._gcAnimSeq||0)+1};te.add(B.seq),V(L,p,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const Y=$[z.effect_type];if(Y){const W={...y};Y(z.effect_params||{},W,async X=>{X["usedGc_"+p]=D,X._lastGC=B,X._gcAnimSeq=B.seq,await q(X)});return}}const G={...y};switch(L){case"Remplacement+":G.maxSubs=(G.maxSubs||3)+1,G.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const Y=x+"Score";G[Y]>0&&(G[Y]--,G.log.push({text:"🚫 But annulé",type:"info"}));break}}G["usedGc_"+p]=D,G._lastGC=B,G._gcAnimSeq=B.seq,await q(G)})}function pe(_,L){const I="usedCardIds_"+_,S=new Set(y[I]||[]);L.forEach(z=>S.add(z)),y[I]=[...S]}function le(){for(const _ of["p1","p2"]){const L=new Set(y["usedCardIds_"+_]||[]),I=y[_+"Team"];if(I)for(const S of["GK","DEF","MIL","ATT"])(I[S]||[]).forEach(z=>{z.used=L.has(z.cardId)})}}function se(){var Ve,it,yi,bi,hi,vi;if(y.phase==="reveal")return ke();if(y.phase==="midfield")return Q();if(y.phase==="finished")return Fe();const _=y[p+"Team"],L=y[x+"Team"];le();const I=y[p+"Score"],S=y[x+"Score"],z=y[p+"Name"],D=y[x+"Name"],B=y.phase===p+"-attack",G=y.phase===p+"-defense",Y=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],W=Y.map(ie=>ie.cardId),X=window.innerWidth>=700,re=y[p+"Subs"]||[],J=y["usedSubIds_"+p]||[],ce=re.filter(ie=>!J.includes(ie.cardId)),de=y["gcCardsFull_"+p]||[],oe=y["usedGc_"+p]||[],ue=de.filter(ie=>!oe.includes(ie.id)),fe=y.boostOwner===p&&!y.boostUsed,xe=!["GK","DEF","MIL","ATT"].some(ie=>(L[ie]||[]).some(ge=>!ge.used)),Z=[..._.MIL||[],..._.ATT||[]].filter(ie=>!ie.used),be=B&&xe&&Z.length===0?[..._.GK||[],..._.DEF||[]].filter(ie=>!ie.used).map(ie=>ie.cardId):[];function ze(ie,ge,Ae){var $i,Ei;const ye=ie._gcDef,nt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ye==null?void 0:ye.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",dt={purple:"#b06ce0",light_blue:"#00d4ef"}[ye==null?void 0:ye.color]||"#b06ce0",vt=(ye==null?void 0:ye.name)||ie.gc_type,wt=(ye==null?void 0:ye.effect)||(($i=Me[ie.gc_type])==null?void 0:$i.desc)||"",wi=ye!=null&&ye.image_url?`/icons/${ye.image_url}`:null,fn=((Ei=Me[ie.gc_type])==null?void 0:Ei.icon)||"⚡",_i=Math.round(Ae*.22),ki=Math.round(Ae*.22),Vt=Ae-_i-ki,gn=vt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ie.id}" data-gc-type="${ie.gc_type}"
        style="box-sizing:border-box;width:${ge}px;height:${Ae}px;border-radius:10px;border:2px solid ${dt};background:${nt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    </div>`,Ke=(()=>{var ge,Ae;if(G&&((ge=y.pendingAttack)!=null&&ge.players)){const ye=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
        ...
        </div>`}if(B&&((Ae=y.pendingAttack)!=null&&Ae.players)){const ye=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function De(){const ie=e.querySelector(".match-screen");if(!ie)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ie.style.height=ge+"px",ie.style.minHeight=ge+"px",ie.style.maxHeight=ge+"px",ie.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),ye=e.querySelector("#mobile-play-area");Ae&&ye&&(ye.style.paddingBottom=Ae.offsetHeight+"px")}if(De(),setTimeout(De,120),setTimeout(De,400),P||(P=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",De),window.visualViewport.addEventListener("scroll",De)),window.addEventListener("resize",De)),function(){const ge=e.querySelector(".terrain-wrapper svg");ge&&(ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("viewBox","-26 -26 352 352"),ge.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(ie=>{ie.addEventListener("click",()=>{if(!B&&!G)return;const ge=ie.dataset.cardId,Ae=ie.dataset.role,ye=(_[Ae]||[]).find(wt=>wt.cardId===ge);if(!ye||ye.used)return;const nt=be.includes(ge);if(B&&!["MIL","ATT"].includes(Ae)&&!nt)return;Array.isArray(y["selected_"+p])||(y["selected_"+p]=[]);const dt=y["selected_"+p],vt=dt.findIndex(wt=>wt.cardId===ge);vt>-1?dt.splice(vt,1):dt.length<3&&dt.push({...ye,_role:Ae}),se()})}),e.querySelectorAll(".match-used-hit").forEach(ie=>{ie.addEventListener("click",()=>R(ie.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ie=>{ie.addEventListener("click",()=>R())}),(Ve=e.querySelector("#pvp-sub-open"))==null||Ve.addEventListener("click",()=>R()),e.querySelectorAll(".pvp-gc-mini").forEach(ie=>{ie.addEventListener("click",()=>T(ie.dataset.gcId,ie.dataset.gcType))}),(it=e.querySelector("#pvp-boost-card"))==null||it.addEventListener("click",()=>M()),(yi=e.querySelector("#pvp-action"))==null||yi.addEventListener("click",ie=>{B?ie.currentTarget.dataset.pass==="1"||!$e(p)?O():Ee():G&&_e()}),(bi=e.querySelector("#pvp-quit"))==null||bi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&A()}),(hi=e.querySelector("#pvp-view-opp"))==null||hi.addEventListener("click",()=>U()),(vi=e.querySelector("#pvp-toggle-history"))==null||vi.addEventListener("click",()=>j()),E&&(clearInterval(E),E=null),(B||G)&&!C){let ie=30,ge=!1;const Ae=()=>document.getElementById("pvp-timer"),ye=()=>{Ae()&&(Ae().textContent=ie+"s",Ae().style.color=ge?"#ff4444":"#fff")};ye(),E=setInterval(()=>{ie--,ie<0?ge?(clearInterval(E),E=null,B&&!$e(p)?O():A()):(ge=!0,ie=15,ye()):ye()},1e3)}}function ke(){He(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="width:min(90vw,420px)">${Rt(y[x+"Team"],y[x+"Formation"],null,[],ot(),ut())}</div>
    </div>`,p==="p1"&&setTimeout(async()=>{await q({phase:"midfield"})},5e3)}let K=!1;function Q(){if(K)return;const _=y[p+"Team"].MIL||[],L=y[x+"Team"].MIL||[],I=milScore(_)+milLinks(_),S=milScore(L)+milLinks(L),z=I>=S;function D(de,oe,ue){return`<div id="duel-row-${ue}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${de.map((fe,xe)=>{const Z=xe<de.length-1?bt(fe,de[xe+1]):null,be=!Z||Z==="#ff3333"||Z==="#cc2222",ze=Z==="#00ff88"?"+2":Z==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${ue}" data-idx="${xe}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${g.map((q,A)=>{const $=f>0&&r.status==="finished"?A===0?Math.floor(f*.7):A===1?Math.floor(f*.2):A===2?Math.floor(f*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${q.userId===o?"background:#f0fdf4;":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${A===0?We:A<3?gt:"#555"}">${["🥇","🥈","🥉"][A]||A+1}</td>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(q,A)=>A+1).reverse().map(q=>{const A=(d||[]).filter($=>$.matchday===q);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${q}</div>${A.map($=>Di($,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function g(p){var P,N,te,ne;const x=(P=p.card)==null?void 0:P.player;if(!x)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,h=lt(x,x.job,b),v=x.job2?lt(x,x.job2,b):0,k=p.status==="sold",y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,C=qt[x.job]||"#bbb",E=x.job2?qt[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${k?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(te=x.clubs)!=null&&te.logo_url?`<img src="${x.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${C};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=r||[];f.innerHTML=b.length>0?b.map((h,v)=>{const k=di(h.mmr??1e3),y=(h.ranked_wins||0)+(h.ranked_losses||0)+(h.ranked_draws||0),C=y>0?Math.round((h.ranked_wins||0)/y*100):0,E=h.id===i.profile.id,P=(h.placement_matches||0)<10;return`
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${E?"border:2px solid var(--yellow)":""}">
            ...
            <div style="text-align:right;flex-shrink:0">
              <div style="font-size:20px">${P?"❓":k.emoji}</div>
              <div style="font-size:11px;font-weight:700;color:${k.color}">${P?"Placement":k.label}</div>
