...
import{s as z,F as $i,i as Ut,k as Vi,l as ot,m as Ii,f as Nt,n as vn,T as li,j as wn,o as _n,b as $n}from"./formation-links-BZe0pGr4.js";const kn="/";function Mi(e,{navigate:t,toast:i}){let o="login";const d=()=>{var r,l,u,a,n,x;const s=o==="login";e.innerHTML=`
    <div style="
    ...
    </style>`,(r=document.getElementById("tab-login-btn"))==null||r.addEventListener("click",()=>{o="login",d()}),(l=document.getElementById("tab-reg-btn"))==null||l.addEventListener("click",()=>{o="register",d()}),s?((u=document.getElementById("login-password"))==null||u.addEventListener("keydown",f=>{var h;f.key==="Enter"&&((h=document.getElementById("login-btn"))==null||h.click())}),(a=document.getElementById("login-btn"))==null||a.addEventListener("click",async()=>{const f=document.getElementById("login-email").value.trim(),h=document.getElementById("login-password").value,_=document.getElementById("login-error");if(_.textContent="",!f||!h){_.textContent="Remplissez tous les champs.";return}const m=document.getElementById("login-btn");m.textContent="⏳ Connexion…",m.disabled=!0;const{error:c}=await z.auth.signInWithPassword({email:f,password:h});if(m.textContent="⚽ Se connecter",m.disabled=!1,c){_.textContent=c.message.includes("Invalid")?"Email ou mot de passe incorrect.":c.message;return}window.location.reload()})):((n=document.getElementById("reg-confirm"))==null||n.addEventListener("keydown",f=>{var h;f.key==="Enter"&&((h=document.getElementById("reg-btn"))==null||h.click())}),(x=document.getElementById("reg-btn"))==null||x.addEventListener("click",async()=>{const f=document.getElementById("reg-email").value.trim(),h=document.getElementById("reg-password").value,_=document.getElementById("reg-confirm").value,m=document.getElementById("reg-error");if(m.textContent="",!f||!h||!_){m.textContent="Remplissez tous les champs.";return}if(h.length<6){m.textContent="Mot de passe trop court (min. 6 caractères).";return}if(h!==_){m.textContent="Les mots de passe ne correspondent pas.";return}const c=document.getElementById("reg-btn");c.textContent="⏳ Création…",c.disabled=!0;const{error:T}=await z.auth.signUp({email:f,password:h});if(c.textContent="🚀 Créer mon compte",c.disabled=!1,T){m.textContent=T.message;return}i("Compte créé ! Connecte-toi pour commencer.","success",4e3),o="login",d(),setTimeout(()=>{const p=document.getElementById("login-email");p&&(p.value=f)},50)}))};d()}function En(e,{state:t,navigate:i,toast:o,refreshProfile:d}){let s="#1A6B3C",r="#D4A017";e.innerHTML=`
  ...
  `;function l(){var _;const a=document.getElementById("logo-preview"),n=document.getElementById("logo-initials"),x=((_=document.getElementById("setup-club"))==null?void 0:_.value)||"MW",f=x.trim().split(" ").filter(Boolean),h=f.length>=2?(f[0][0]+f[1][0]).toUpperCase():x.slice(0,2).toUpperCase();a&&(a.style.background=r,a.style.borderColor=s),n&&(n.textContent=h,n.style.color=s)}document.getElementById("color1").addEventListener("input",a=>{s=a.target.value,document.getElementById("swatch1").style.background=s,l()}),document.getElementById("color2").addEventListener("input",a=>{r=a.target.value,document.getElementById("swatch2").style.background=r,l()});function u(a){document.querySelectorAll(".setup-step").forEach(n=>n.classList.remove("active")),document.getElementById(`step-${a}`).classList.add("active"),document.getElementById("step-num").textContent=a,document.getElementById("progress-fill").style.width=`${Math.round(a/3*100)}%`,a===3&&l()}document.getElementById("step1-next").addEventListener("click",async()=>{const a=document.getElementById("setup-pseudo").value.trim(),n=document.getElementById("step1-error");if(n.textContent="",a.length<3){n.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:x}=await z.from("users").select("id").eq("pseudo",a).maybeSingle();if(x){n.textContent="Ce pseudo est déjà pris.";return}u(2)}),document.getElementById("step2-back").addEventListener("click",()=>u(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const a=document.getElementById("setup-club").value.trim(),n=document.getElementById("step2-error");if(n.textContent="",a.length<2){n.textContent="Nom trop court (min. 2 caractères).";return}const{data:x}=await z.from("users").select("id").eq("club_name",a).maybeSingle();if(x){n.textContent="Ce nom de club est déjà pris.";return}u(3)}),document.getElementById("step3-back").addEventListener("click",()=>u(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const a=document.getElementById("setup-pseudo").value.trim(),n=document.getElementById("setup-club").value.trim(),x=document.getElementById("step3-error"),f=document.getElementById("step3-finish");x.textContent="",f.disabled=!0,f.textContent="Création en cours…";try{const{error:h}=await z.from("users").insert({id:t.user.id,pseudo:a,club_name:n,club_color1:s,club_color2:r,credits:1e4});if(h)throw h;await Tn(t.user.id),await d(),o(`Bienvenue ${a} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(h){x.textContent=h.message,f.disabled=!1,f.textContent="🚀 Créer mon profil !"}})}async function Tn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await z.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const zn="modulepreload",Sn=function(e){return"/"+e},ji={},oi=function(t,i,o){let d=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));d=Promise.allSettled(i.map(u=>{if(u=Sn(u),u in ji)return;ji[u]=!0;const a=u.endsWith(".css"),n=a?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${n}`))return;const x=document.createElement("link");if(x.rel=a?"stylesheet":zn,a||(x.as="script"),x.crossOrigin="",x.href=u,l&&x.setAttribute("nonce",l),document.head.appendChild(x),a)return new Promise((f,h)=>{x.addEventListener("load",f),x.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${u}`)))})}))}function s(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return d.then(r=>{for(const l of r||[])l.status==="rejected"&&s(l.reason);return t().catch(s)})},Rt="#1A6B3C",Ot="#cc2222",An="#D4A017",Ci="#888";async function Ln(e,t){const{state:i,toast:o}=t;e.innerHTML=`
    ...
    </div>`,await Yi(i,o,t),document.getElementById("btn-add-friend").addEventListener("click",()=>Mn(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Wi(i,o,null,t))}async function Yi(e,t,i={}){const{navigate:o}=i,d=e.user.id,{data:s,error:r}=await z.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${d},addressee_id.eq.${d}`),{count:l}=await z.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",d).eq("status","pending"),u=document.getElementById("pending-badge");u&&(l>0?(u.style.display="flex",u.textContent=l):u.style.display="none");const a=document.getElementById("friends-list");if(!a)return;if(r){console.error("[Friends] Erreur:",r),a.innerHTML=`<div style="color:${Ot};text-align:center;padding:16px">Erreur chargement : ${r.message}</div>`;return}const n=(s||[]).map(h=>h.requester_id===d?h.addressee_id:h.requester_id);let x={};if(n.length){const{data:h}=await z.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",n);(h||[]).forEach(_=>{x[_.id]=_})}const f=(s||[]).map(h=>({friendshipId:h.id,friend:x[h.requester_id===d?h.addressee_id:h.requester_id]||{pseudo:"?"}}));if(!f.length){a.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${f.map(({friendshipId:h,friend:_})=>In(_,h)).join("")}
    ...
    ${Ei()}`,document.body.appendChild(i);const o=i.querySelector("#friend-pseudo-input"),d=i.querySelector("#add-friend-error"),s=()=>i.remove();o.focus(),i.querySelector("#add-cancel").addEventListener("click",s),i.addEventListener("click",r=>{r.target===i&&s()}),i.querySelector("#add-ok").addEventListener("click",async()=>{const r=o.value.trim();if(!r){d.textContent="Entre un pseudo";return}d.textContent="";const{data:l}=await z.from("users").select("id, pseudo").ilike("pseudo",r).single();if(!l){d.textContent="Utilisateur introuvable";return}if(l.id===e.user.id){d.textContent="Tu ne peux pas t'ajouter toi-même";return}const{data:u}=await z.from("friendships").select("id, status").or(`and(requester_id.eq.${e.user.id},addressee_id.eq.${l.id}),and(requester_id.eq.${l.id},addressee_id.eq.${e.user.id})`).single();if(u){const n=u.status==="accepted"?"Vous êtes déjà amis !":u.status==="pending"?"Demande déjà envoyée":"Une demande existe déjà";d.textContent=n;return}const{error:a}=await z.from("friendships").insert({requester_id:e.user.id,addressee_id:l.id,status:"pending"});if(a){d.textContent="Erreur : "+a.message;return}s(),t(`✅ Demande envoyée à ${l.pseudo} !`,"success")})}async function Wi(e,t,i=null,o={}){const d=e.user.id,{data:s}=await z.from("friendships").select("id, requester_id").eq("addressee_id",d).eq("status","pending").order("created_at",{ascending:!1}),r=(s||[]).map(f=>f.requester_id);let l={};if(r.length){const{data:f}=await z.from("users").select("id, pseudo, club_name").in("id",r);(f||[]).forEach(h=>{l[h.id]=h})}const u=(s||[]).map(f=>({...f,requester:l[f.requester_id]||{pseudo:"?"}})),a=ki(),n=u||[];a.innerHTML=`
    <div class="popup-box">
      ...
      ${n.length?`<div style="display:flex;flex-direction:column;gap:8px;max-height:50vh;overflow-y:auto;margin-bottom:14px">
            ${n.map(f=>{var h,_,m;return`
              <div style="display:flex;align-items:center;gap:10px;background:#f9f9f9;border-radius:10px;padding:10px 12px">
                <div style="flex:1;font-size:14px;font-weight:700">${((h=f.requester)==null?void 0:h.club_name)||((_=f.requester)==null?void 0:_.pseudo)||"?"}
    ...
    ${Ei()}`,document.body.appendChild(a);const x=()=>a.remove();a.querySelector("#pending-close").addEventListener("click",x),a.addEventListener("click",f=>{f.target===a&&x()}),a.querySelectorAll("[data-accept]").forEach(f=>{f.addEventListener("click",async()=>{const{error:h}=await z.from("friendships").update({status:"accepted"}).eq("id",f.dataset.accept);if(h){t("Erreur : "+h.message,"error");return}f.closest("div[style]").remove(),t("✅ Ami accepté !","success"),Yi(e,t,o),i&&i()})}),a.querySelectorAll("[data-decline]").forEach(f=>{f.addEventListener("click",async()=>{await z.from("friendships").delete().eq("id",f.dataset.decline),f.closest("div[style]").remove(),t("Demande refusée","info"),i&&i()})})}async function jn(e,t,i){const o=e.user.id,[d,s]=[o,t].sort(),r=o===d,{data:l}=await z.from("friend_match_stats").select("*").eq("player1_id",d).eq("player2_id",s).single(),u=e.profile.club_name||e.profile.pseudo||"Moi",a=l||{},n=r?a.wins_p1||0:a.wins_p2||0,x=r?a.wins_p2||0:a.wins_p1||0,f=a.draws||0,h=r?a.goals_p1||0:a.goals_p2||0,_=r?a.goals_p2||0:a.goals_p1||0,m=r?a.gc_used_p1||0:a.gc_used_p2||0,c=r?a.gc_used_p2||0:a.gc_used_p1||0,T=a.matches_total||0,p=(B,C,P,j=Rt,N=Ot)=>`
    ...
    </style>`}async function Ji({player1Id:e,player2Id:t,score1:i,score2:o,gc1:d,gc2:s}){const[r,l]=[e,t].sort(),u=e!==r,a=u?o:i,n=u?i:o,x=u?s:d,f=u?d:s,h=a>n?1:0,_=n>a?1:0,m=a===n?1:0,{data:c}=await z.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",l).single();c?await z.from("friend_match_stats").update({wins_p1:c.wins_p1+h,wins_p2:c.wins_p2+_,draws:c.draws+m,goals_p1:c.goals_p1+a,goals_p2:c.goals_p2+n,gc_used_p1:c.gc_used_p1+x,gc_used_p2:c.gc_used_p2+f,matches_total:c.matches_total+1}).eq("player1_id",r).eq("player2_id",l):await z.from("friend_match_stats").insert({player1_id:r,player2_id:l,wins_p1:h,wins_p2:_,draws:m,goals_p1:a,goals_p2:n,gc_used_p1:x,gc_used_p2:f,matches_total:1})}const Cn="2026.07.07-2255";async function qi(e,{state:t,navigate:i,toast:o}){var s,r;const d=t.profile;d&&(e.innerHTML=`
  <style>
  ...
  `,e.querySelectorAll("[data-nav]").forEach(l=>{l.addEventListener("click",u=>{u.preventDefault(),i(l.dataset.nav)})}),(s=document.getElementById("nav-rankings"))==null||s.addEventListener("click",()=>i("rankings")),(r=document.getElementById("nav-matches"))==null||r.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(l=>{l.addEventListener("click",()=>{l.classList.add("tapped"),setTimeout(()=>l.classList.remove("tapped"),200);const u=l.dataset.action;if(u==="match-ai"){Dn(i);return}if(u==="match-random"){i("match",{matchMode:"random"});return}if(u==="match-friend"){i("friends");return}if(u==="mini-league"){i("mini-league");return}if(u==="ranked"){i("ranked");return}o("Bientôt disponible","info")})}),window.innerWidth<768&&requestAnimationFrame(()=>{var B,C,P,j,N,V;const l=((B=window.visualViewport)==null?void 0:B.height)||window.innerHeight,u=((C=document.querySelector(".top-nav"))==null?void 0:C.offsetHeight)||56,a=((P=document.querySelector(".bottom-nav"))==null?void 0:P.offsetHeight)||60,n=((j=e.querySelector(".hero-compact"))==null?void 0:j.offsetHeight)||52,x=e.querySelector(".ranked-banner");e.querySelector(".play-grid");const f=((V=(N=e.querySelector("#logout-btn"))==null?void 0:N.closest("div"))==null?void 0:V.offsetHeight)||44,h=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((K,oe)=>{var ie;return K+(((ie=document.getElementById(oe))==null?void 0:ie.offsetHeight)||0)},0),_=14*5,m=l-u-a-n-f-h-_,c=Math.max(80,Math.round(m*.28)),T=Math.max(160,Math.round(m*.72)),p=Math.floor((T-10)/2);x&&(x.style.minHeight=x.style.maxHeight=c+"px"),e.querySelectorAll(".play-grid .play-card").forEach(K=>{K.style.minHeight=K.style.height=p+"px"});const I=Math.round(p*.55);e.querySelectorAll(".play-card .play-icon").forEach(K=>{K.style.height=I+"px"})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await z.auth.signOut(),window.location.reload()}),Qi(t,o),Fn(t,o,i),Xi(t,o,i))}async function Xi(e,t,i){const o=document.getElementById("ongoing-match-banner");if(!o)return;const d=e.profile.id,{data:s}=await z.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${d},away_id.eq.${d}`).order("created_at",{ascending:!1});if(!(s!=null&&s.length)){o.innerHTML="";return}const r=s.map(u=>u.home_id===d?u.away_id:u.home_id).filter(Boolean);let l={};if(r.length){const{data:u}=await z.from("users").select("id, pseudo, club_name").in("id",r);(u||[]).forEach(a=>{l[a.id]=a.club_name||a.pseudo})}o.innerHTML=s.map(u=>{const a=u.home_id===d?u.away_id:u.home_id,n=l[a]||"Adversaire",x=u.mode==="mini_league";return`
    ...
    </div>`,(a=document.getElementById("match-inv-accept"))==null||a.addEventListener("click",()=>{o.innerHTML="",i("match",{matchMode:"friend",friendId:r,friendName:s})}),(n=document.getElementById("match-inv-decline"))==null||n.addEventListener("click",async()=>{await z.from("friend_match_invites").update({status:"declined"}).eq("id",d.id),o.innerHTML="",t("Invitation refusée","info")})}async function Qi(e,t){const i=document.getElementById("friend-requests-banner");if(!i)return;const{data:o,error:d}=await z.from("friendships").select("id, requester:users!requester_id(pseudo, club_name)").eq("addressee_id",e.user.id).eq("status","pending");if(d||!(o!=null&&o.length)){i.innerHTML="";return}const s=o.length,r=o.slice(0,2).map(u=>{var a;return((a=u.requester)==null?void 0:a.pseudo)||"?"}).join(", "),l=s>2?` +${s-2}`:"";i.innerHTML=`
  ...
  <div style="position:absolute;top:${n(48)};left:0;right:0;text-align:center;z-index:4;padding:0 ${n(50)}">
    <span style="font-size:${n(20)};font-weight:700;color:${f};letter-spacing:${n(2)};line-height:1;text-shadow:0 1px 4px #000;display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${j}</span>
  </div>
  ...
  <div style="position:absolute;top:${n(80)};left:0;right:0;text-align:center;z-index:4;padding:0 ${n(10)}">
    <span style="font-size:${n(K)};font-weight:900;color:#fff;line-height:1;text-shadow:0 2px 8px #000;font-family:Arial Black,Arial;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block">${N}</span>
  </div>

  <!-- Portrait : top aligné sous le bandeau, bas = haut octogone -->
  ${B?`<img src="${B}"
    style="position:absolute;top:${oe}px;left:50%;transform:translateX(-50%);
    width:${ie}px;height:${Q}px;object-fit:cover;object-position:top center;z-index:2"
    onerror="this.style.display='none'">`:""}

  <!-- Note principale : centrée dans l'octogone du template -->
  <div style="position:absolute;left:${re}px;top:${R}px;width:${me}px;height:${D}px;
    z-index:4;display:flex;flex-direction:column;align-items:center;justify-content:center">
    <span style="font-size:${n(80)};font-weight:900;color:${T};font-family:Arial Black,Arial;line-height:1;text-shadow:0 2px 8px rgba(0,0,0,0.9)">${c}</span>
  </div>
  ...
  <div style="position:absolute;left:${se}px;top:${we}px;width:${ve}px;height:${_e}px;z-index:3;
    ...
    ${bt(e,{width:140})}
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),{data:u}=await z.from("players").select(`id, firstname, surname_encoded, country_code, club_id, job, job2,
      note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length,
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(O=>O.card_type==="player"&&O.player),n=(l||[]).filter(O=>O.card_type==="game_changer"),x=(l||[]).filter(O=>O.card_type==="formation"),f=(l||[]).filter(O=>O.card_type==="stadium"),{data:h}=await z.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(h||[]).forEach(O=>{_[O.name]=O});const{data:m}=await z.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(m||[]).forEach(O=>{c[O.id]=O}),f.forEach(O=>{O.stadium_def&&(c[O.stadium_id]=O.stadium_def)});const T=Object.keys($i),p=Object.keys(Oe),I={};a.forEach(O=>{const ee=O.player.id;I[ee]=(I[ee]||0)+1}),new Set(Object.keys(I).map(O=>String(O)));const B=new Set(x.map(O=>O.formation)),C=new Set(n.map(O=>O.gc_type));let P="player",j="Tous",N="",V=!1;function K(){return[...a].sort((O,ee)=>{const xe=Wt.indexOf(O.player.job),le=Wt.indexOf(ee.player.job);return xe!==le?xe-le:(O.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function oe(){return[...u||[]].sort((O,ee)=>{const xe=Wt.indexOf(O.job),le=Wt.indexOf(ee.job);return xe!==le?xe-le:(O.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function ie(){return K().filter(O=>{const ee=O.player,xe=j==="Tous"||ee.job===j,le=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&le})}function Q(){return oe().filter(O=>{const ee=j==="Tous"||O.job===j,xe=!N||`${O.firstname} ${O.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function R(){const O=document.getElementById("col-filters");O&&(P==="player"?(O.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",ee=>{N=ee.target.value.toLowerCase(),D()}),e.querySelectorAll(".filter-btn").forEach(ee=>{ee.addEventListener("click",()=>{j=ee.dataset.job,R(),D()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{V=!V,R(),D()})):(O.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{V=!V,R(),D()})))}function D(){const O=document.getElementById("col-grid");O&&(P==="player"?Ee(O):P==="formation"?se(O):P==="stadium"?de(O):pe(O))}function re(O,ee,xe,le,ge){const ne=document.getElementById("col-grid"),ue=document.getElementById("col-big");if(!ne||!ue)return;var Le=0;function Ie(){const Ce=window.innerWidth>=768,Te=document.getElementById("col-big"),qe=document.getElementById("col-grid");Ce&&Te&&(Te.style.minHeight="420px",Te.style.flex="1 1 auto"),Ce&&qe&&(qe.style.height=Math.round(310*.76+16)+"px",qe.style.flexShrink="0",qe.style.overflowX="auto",qe.style.overflowY="hidden",qe.style.alignItems="center",qe.style.padding="8px 16px"),ue.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ee(O[Le])+"</div>";var Pe=ue.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Pe&&Pe.addEventListener("click",function(){le(O[Le])}),requestAnimationFrame(function(){var ze=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!ze||!ue)){var q=ue.clientHeight-8,$=ue.clientWidth-24,g=ze.offsetHeight,y=ze.offsetWidth;if(g>0&&y>0&&q>40){var b=Ce?2.2:1,v=Math.min(q/g,$/y,b);ze.style.transform="scale("+v.toFixed(3)+")",ze.style.transformOrigin="top center"}}}),ne.innerHTML=O.map(function(ze,q){var $=q===Le,g="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+($?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+q+'" style="'+g+'">'+xe(ze,$)+"</div>"}).join(""),ne.querySelectorAll(".col-mini-item").forEach(function(ze){ze.addEventListener("click",function(){Le=Number(ze.dataset.idx),Ie(),ze.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Ie()}function me(O){var ee=window.innerWidth>=768?.76:.54,xe;if(!O||O._fake){var le=O?O.player:null;if(!le)return"";xe=Gi(le)}else xe=ui(O,"");return'<div style="display:inline-block;zoom:'+ee+';pointer-events:none;line-height:0">'+xe+"</div>"}function _e(O,ee,xe){ee=ee||100,xe=xe||140;var le=Ut[O]||{},ge={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ne=Math.max(3,Math.round(ee*.06)),ue=Object.entries(le).map(function(Ie){var Ce=Ie[0],Te=Ie[1],qe=Ce.replace(/\d+$/,""),Pe=ge[qe]||"#888",ze=Math.round(Te.x*ee),q=Math.round(Te.y*xe);return'<circle cx="'+ze+'" cy="'+q+'" r="'+ne+'" fill="'+Pe+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),Le=Math.max(1,Math.round(ee/50));return'<svg viewBox="0 0 '+ee+" "+xe+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ee+'" height="'+xe+'" fill="#1A6B3C"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.02)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/><line x1="0" y1="'+Math.round(xe*.5)+'" x2="'+ee+'" y2="'+Math.round(xe*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><ellipse cx="'+Math.round(ee*.5)+'" cy="'+Math.round(xe*.5)+'" rx="'+Math.round(ee*.18)+'" ry="'+Math.round(xe*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.82)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/>'+ue+"</svg>"}function ve(O,ee,xe){var le=xe>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+xe+"</div>":"",ge=ee?'data-form-id="'+ee.id+'"':"",ne=O.length>7?14:O.length>5?16:19,ue=!!ee;return"<div "+ge+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ue?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ue?"":"filter:grayscale(1);opacity:0.5")+'">'+le+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ue?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ne+"px;font-weight:900;color:"+(ue?"#1A6B3C":"#aaa")+';line-height:1">'+O+'</div></div><div style="flex:1;overflow:hidden;background:'+(ue?"#1A6B3C":"#ccc")+'">'+_e(O,140,220)+"</div></div>"}function we(O,ee){var xe=window.innerWidth>=768?.76:.54,le=140,ge=305,ne=Math.round(ge*.22),ue=ge-ne,Le=O.length>7?10:13,Ie=_e(O,le,ue),Ce=ee?"1.5px solid #2a7a40":"1px solid #ddd",Te=ee?"":"filter:grayscale(1);opacity:0.45;",qe=ee?"#1A6B3C":"#bbb",Pe="#fff";return'<div style="display:inline-block;zoom:'+xe+';line-height:0;pointer-events:none"><div style="width:'+le+"px;height:"+ge+"px;border-radius:6px;border:"+Ce+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Te+'"><div style="height:'+ne+"px;background:"+qe+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+Le+"px;font-weight:900;color:"+Pe+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(le-4)+'px">'+O+'</span></div><div style="height:'+ue+'px;overflow:hidden;flex-shrink:0">'+Ie+"</div></div></div>"}function Ee(O){if(V){const ee=Q();if(!ee.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const xe=ee.map(le=>a.find(ge=>ge.player.id===le.id)||{_fake:!0,player:le,id:"fake-"+le.id});re(xe,le=>le._fake?Gi(le.player):ui(le,""),le=>le._fake?me({player:le.player,id:"x",_fake:!0}):me(le),le=>{le._fake||Ni(le,a,I,t)})}else{const ee=ie();if(!ee.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const xe={};ee.forEach(ge=>{const ne=ge.player.id;xe[ne]||(xe[ne]=[]),xe[ne].push(ge)});const le=Object.values(xe).map(ge=>Wn(ge));re(le,ge=>{const ne=I[ge.player.id]||1,ue=ne>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ne}</div>`:"",Ie=a.filter(Ce=>Ce.player.id===ge.player.id&&Ce.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ui(ge,ue+Ie)},ge=>me(ge),ge=>Ni(ge,a,I,t))}}function se(O){const ee=V?T:[...B];if(!ee.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const xe=ee.map(le=>({formation:le,card:x.find(ge=>ge.formation===le)||null,owned:B.has(le)}));re(xe,({formation:le,card:ge,owned:ne})=>ve(le,ne?ge:null,ne?x.filter(ue=>ue.formation===le).length:0),({formation:le,owned:ge})=>we(le,ge),({card:le,owned:ge})=>{ge&&le&&to(le,x,t,s)})}function pe(O){const ee=Object.keys(_),xe=V?ee.length?ee:p:[...C];if(!xe.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const le=xe.map(ge=>({type:ge,gc:Oe[ge]||{icon:"⚡",desc:""},def:_[ge]||null,owned:C.has(ge),card:n.find(ne=>ne.gc_type===ge)||null}));re(le,({type:ge,gc:ne,def:ue,owned:Le,card:Ie})=>{var b;const Ce=Le?n.filter(v=>v.gc_type===ge).length:0,Te=Ce>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ce}</div>`:"",qe=(ue==null?void 0:ue.gc_type)==="ultra_game_changer",Pe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ze={purple:"#b06ce0",light_blue:"#00d4ef"},q=Pe[ue==null?void 0:ue.color]||Pe.purple,$=ze[ue==null?void 0:ue.color]||ze.purple,g=(ue==null?void 0:ue.effect)||ne.desc||"",y=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:((b=ue==null?void 0:ue.club)==null?void 0:b.logo_url)||(ue!=null&&ue.country_code?`https://flagsapi.com/${ue.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Le&&Ie?`<div data-gc-id="${Ie.id}" data-gc-type="${ge}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${$};background:${q};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${$}66;cursor:pointer">
          ${Te}
        ...
        </div>`},({type:ge,gc:ne,def:ue,owned:Le})=>{const Ie=window.innerWidth>=768?.76:.54,Ce={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Te={purple:"#9b59b6",light_blue:"#00bcd4"},qe=Ce[ue==null?void 0:ue.color]||Ce.purple,Pe=Te[ue==null?void 0:ue.color]||Te.purple,ze=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:null;return Le?`<div style="display:inline-block;zoom:${Ie};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${qe};border:1px solid ${Pe};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${ge}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${ze?`<img src="${ze}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${ne.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((ue==null?void 0:ue.effect)||ne.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${Ie};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${ne.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${ge}</span></div></div>`},({type:ge,owned:ne,def:ue})=>{ne&&eo(ge,ue,s)})}function de(O){const ee="#E87722",xe="/";if(!f.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const le={};f.forEach(ne=>{const ue=ne.stadium_id||"?";(le[ue]=le[ue]||[]).push(ne)});const ge=Object.entries(le).map(([ne,ue])=>({sid:ne,def:c[ne]||null,count:ue.length,card:ue[0]}));re(ge,({def:ne,count:ue})=>{var Pe,ze;const Le=(ne==null?void 0:ne.name)||"?",Ie=((Pe=ne==null?void 0:ne.club)==null?void 0:Pe.encoded_name)||(ne==null?void 0:ne.country_code)||"—",Ce=ne!=null&&ne.image_url?`${xe}icons/${ne.image_url}`:((ze=ne==null?void 0:ne.club)==null?void 0:ze.logo_url)||(ne!=null&&ne.country_code?`https://flagsapi.com/${ne.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Te=Ce?`<img src="${Ce}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',qe=ue>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ue}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${ee},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${ee}66">
          ${qe}
        ...
        </div>`},({def:ne,count:ue})=>{var Pe,ze;const Le=window.innerWidth>=768?.76:.54,Ie=(ne==null?void 0:ne.name)||"?",Ce=((Pe=ne==null?void 0:ne.club)==null?void 0:Pe.encoded_name)||(ne==null?void 0:ne.country_code)||"—",Te=ne!=null&&ne.image_url?`${xe}icons/${ne.image_url}`:((ze=ne==null?void 0:ne.club)==null?void 0:ze.logo_url)||(ne!=null&&ne.country_code?`https://flagsapi.com/${ne.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),qe=Te?`<img src="${Te}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${Le};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(O=>{O.addEventListener("click",()=>{P=O.dataset.tab,j="Tous",N="",V=!1,e.querySelectorAll(".col-tab-btn").forEach(ee=>{const xe=ee.dataset.tab===P;ee.style.borderBottomColor=xe?"var(--green)":"transparent",ee.style.color=xe?"var(--green)":"var(--gray-600)"}),R(),D()})}),R(),D()}function eo(e,t,i){const o=Oe[e]||{icon:"⚡",desc:"Effet spécial."},d=(t==null?void 0:t.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[t==null?void 0:t.color]||s.purple,u=r[t==null?void 0:t.color]||r.purple,a=(t==null?void 0:t.name)||e,n=(t==null?void 0:t.effect)||o.desc,x=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Jt=1e3;function to(e,t,i,o){var _,m,c;const{state:d,toast:s,closeModal:r,navigate:l,refreshProfile:u}=i,a=e.formation,n={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function x(){const T=Ut[a]||{},p=$i[a]||[],I=290,B=360,C=20;function P(N){const V=T[N];return V?{x:V.x*I,y:V.y*B}:null}let j=`<svg width="${I}" height="${B}" viewBox="0 0 ${I} ${B}" xmlns="http://www.w3.org/2000/svg">`;for(const[N,V]of p){const K=P(N),oe=P(V);!K||!oe||(j+=`<line x1="${K.x}" y1="${K.y}" x2="${oe.x}" y2="${oe.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const N of Object.keys(T)){const V=P(N);if(!V)continue;const K=N.replace(/\d+/,""),oe=n[K]||"#555";j+=`<circle cx="${V.x}" cy="${V.y}" r="${C}" fill="${oe}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,j+=`<text x="${V.x}" y="${V.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${K}</text>`}return j+="</svg>",j}const f=t.filter(T=>T.formation===a);f.length;const h=!e.is_for_sale;o(`Formation ${a}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(_=document.getElementById("direct-sell-form-btn"))==null||_.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${a} pour ${Jt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const T=f.find(I=>!I.is_for_sale)||f[0];if(!T){s("Aucune carte à vendre","error");return}await z.from("market_listings").delete().eq("card_id",T.id),await z.from("transfer_history").delete().eq("card_id",T.id);const{error:p}=await z.from("cards").delete().eq("id",T.id);if(p){s(p.message,"error");return}await z.from("users").update({credits:(d.profile.credits||0)+Jt}).eq("id",d.profile.id),await u(),s(`+${Jt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),l("collection")}),(m=document.getElementById("market-sell-form-btn"))==null||m.addEventListener("click",async()=>{const T=parseInt(document.getElementById("sell-price-form").value);if(!T||T<1){s("Prix invalide","error");return}await z.from("cards").update({is_for_sale:!0,sale_price:T}).eq("id",e.id),await z.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:T}),s("Carte mise en vente sur le marché !","success"),r(),l("collection")}),(c=document.getElementById("cancel-sell-form-btn"))==null||c.addEventListener("click",async()=>{await z.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await z.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),r(),l("collection")})}async function Ni(e,t,i,o){var me,_e,ve,we,Ee;const{state:d,toast:s,openModal:r,closeModal:l,navigate:u,refreshProfile:a}=o,n=e.player,x=t.filter(se=>se.player.id===n.id),f=x.length,h=e.evolution_bonus||0,_=Math.max((Number(n.note_g)||0)+(n.job==="GK"||n.job2==="GK"?h:0),(Number(n.note_d)||0)+(n.job==="DEF"||n.job2==="DEF"?h:0),(Number(n.note_m)||0)+(n.job==="MIL"||n.job2==="MIL"?h:0),(Number(n.note_a)||0)+(n.job==="ATT"||n.job2==="ATT"?h:0)),m=n.rarity||"normal",{data:c}=await z.from("sell_price_configs").select("*").eq("rarity",m).lte("note_min",_).gte("note_max",_).order("note_min",{ascending:!1}).limit(1);((me=c==null?void 0:c[0])==null?void 0:me.price)??Yn[m];const T=n.rarity!=="legende";Qn(n);const p=((n.rarity==="pepite"||n.rarity==="papyte")&&e.current_note!=null?e.current_note:pi(n,n.job))+h,I=n.rarity==="pepite"||n.rarity==="papyte",B=n.job2?(I?nn(e,Jn(n.job2)):pi(n,n.job2))+(pi(n,n.job2)>0?h:0):null;ci[n.job],n.job2&&ci[n.job2];const C=Kn[n.rarity]||"#ccc";Xn[n.country_code]||n.country_code;const P=e.evolution_bonus||0,N=p+P,V=B||0,K=V>0?V+P:0,oe=x.map(se=>se.id);let ie={};if(oe.length){const{data:se}=await z.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",oe).order("transferred_at",{ascending:!0});(se||[]).forEach(pe=>{ie[pe.card_id]||(ie[pe.card_id]=[]),ie[pe.card_id].push(pe)})}const Q=se=>{const pe=se.transferred_at?new Date(se.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",de=se.source==="booster"?"Booster":se.price?se.price.toLocaleString("fr"):"—";return`
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${x.map((se,pe)=>{const de=ie[se.id]||[],O=se.is_for_sale,ee=de.length?de[de.length-1]:null,le=(n.rarity==="pepite"||n.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        <div>
          ...
          <div style="font-weight:700;color:${C}">${n.rarity.toUpperCase()}</div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",n.note_g],["DEF",n.note_d],["MIL",n.note_m],["ATT",n.note_a]].map(([se,pe])=>{const de=ci[se],O=se==="GK"?"#fff":de,ee=se===n.job||se===n.job2,xe=(Number(pe)||0)+(ee&&P>0?P:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",l);let D=new Set;const re=()=>{const se=D.size,pe=document.getElementById("sell-action-panel");if(!pe)return;pe.style.display=se>0?"block":"none",document.getElementById("sell-selected-count").textContent=se;const de=document.getElementById("evolve-btn");de&&(de.textContent=`⬆️ Évoluer ${se>1?"(+"+se+")":""}`)};document.querySelectorAll(".expl-check").forEach(se=>{se.addEventListener("change",()=>{const pe=se.dataset.id;se.checked?D.add(pe):D.delete(pe);const de=se.closest(".exemplaire-row");de&&(de.style.borderColor=se.checked?"#1A6B3C":"#eee"),re()})}),document.querySelectorAll(".exemplaire-row").forEach(se=>{se.addEventListener("click",pe=>{if(pe.target.closest("button")||pe.target.tagName==="INPUT")return;const de=se.querySelector(".expl-check");de&&!de.disabled&&(de.checked=!de.checked,de.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(se=>{se.addEventListener("click",pe=>{pe.stopPropagation();const de=document.querySelector(`.expl-hist[data-hist="${se.dataset.idx}"]`);de&&(de.style.display=de.style.display==="none"?"flex":"none")})}),(ve=document.getElementById("evolve-btn"))==null||ve.addEventListener("click",async()=>{if(f<=1)return;const se=[...D];if(!se.length)return;if(D.has(e.id)){const ge=document.createElement("div");ge.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ge.innerHTML=`
        ...
        </div>`,document.body.appendChild(ne),ne.querySelector("#sac-cancel").addEventListener("click",()=>{ne.remove(),ge(!1)}),ne.querySelector("#sac-ok").addEventListener("click",()=>{ne.remove(),ge(!0)}),ne.addEventListener("click",ue=>{ue.target===ne&&(ne.remove(),ge(!1))})}))return;if(pe.length){await z.from("market_listings").delete().in("card_id",pe),await z.from("deck_cards").delete().in("card_id",pe),await z.from("transfer_history").delete().in("card_id",pe),await z.from("decks").update({stadium_card_id:null}).in("stadium_card_id",pe);const{error:ge}=await z.from("cards").delete().in("id",pe);if(ge){s("Erreur suppression : "+ge.message,"error");return}}const ee=(e.evolution_bonus||0)+pe.length*de,{error:xe}=await z.from("cards").update({evolution_bonus:ee}).eq("id",e.id);if(xe){s("Erreur évolution : "+xe.message,"error");return}const le=p+ee;s(`⬆️ ${n.firstname} ${n.surname_encoded} : note ${p+e.evolution_bonus||p} → ${le}${pe.length?` · ${pe.length} copie${pe.length>1?"s":""} sacrifiée${pe.length>1?"s":""}`:""} !`,"success",4e3),l(),u("collection")}),(we=document.getElementById("market-sell-btn"))==null||we.addEventListener("click",async()=>{var xe;const se=[...D];if(!se.length){s("Sélectionne au moins un exemplaire","warning");return}const pe=parseInt((xe=document.getElementById("sell-market-price"))==null?void 0:xe.value);if(!pe||pe<1){s("Prix invalide","error");return}const{error:de}=await z.from("cards").update({is_for_sale:!0,sale_price:pe}).in("id",se);if(de){s(de.message,"error");return}const O=se.map(le=>({seller_id:d.profile.id,card_id:le,price:pe,status:"active"})),{error:ee}=await z.from("market_listings").insert(O);ee&&console.warn("[Market] insert listings:",ee.message),s(`${se.length} carte${se.length>1?"s":""} mise${se.length>1?"s":""} en vente à ${pe.toLocaleString("fr")} cr. chacune !`,"success"),l(),u("collection")}),(Ee=document.getElementById("cancel-sell-btn"))==null||Ee.addEventListener("click",async()=>{await z.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await z.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),l(),u("collection")})}const ei={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Dt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function rn(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}async function xi(e,t){const{state:i,navigate:o,toast:d}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await z.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=prompt("Nom du deck :",`Deck ${((s==null?void 0:s.length)||0)+1}`);if(!r)return;const{data:l,error:u}=await z.from("decks").insert({owner_id:i.profile.id,name:r}).select().single();if(u){d(u.message,"error");return}d("Deck créé !","success"),Ri(l.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(r=>{r.addEventListener("click",()=>Ri(r.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(r=>{r.addEventListener("click",async()=>{const l=prompt("Nouveau nom :",r.dataset.name);if(!l||l===r.dataset.name)return;const{error:u}=await z.from("decks").update({name:l}).eq("id",r.dataset.rename);if(u){d(u.message,"error");return}d("Deck renommé !","success"),xi(e,t)})}),e.querySelectorAll("[data-delete]").forEach(r=>{r.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${r.dataset.name}" ? Cette action est irréversible.`))return;await z.from("deck_cards").delete().eq("deck_id",r.dataset.delete);const{error:l}=await z.from("decks").delete().eq("id",r.dataset.delete);if(l){d(l.message,"error");return}d("Deck supprimé.","success"),xi(e,t)})})}async function Ri(e,t,i){const{state:o,toast:d}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await z.from("decks").select("*").eq("id",e).single(),{data:r}=await z.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length, face,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),{data:l}=await z.from("cards").select(`id, card_type, stadium_id,
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),u=(r||[]).filter(T=>T.card_type==="player"&&T.player),a=(r||[]).filter(T=>T.card_type==="formation"),n=(l||[]).filter(T=>T.card_type==="stadium"),x=[...new Set(n.map(T=>T.stadium_id).filter(Boolean))];let f={};if(n.forEach(T=>{T.stadium_def&&T.stadium_id&&(f[T.stadium_id]=T.stadium_def)}),x.length&&Object.keys(f).length<x.length){const{data:T}=await z.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",x);(T||[]).forEach(p=>{f[p.id]=p})}const h=a.map(T=>T.formation).filter(Boolean),{data:_}=await z.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let m=s.formation||"4-4-2";h.length>0&&!h.includes(m)&&(m=h[0]);const c={deckId:e,name:s.name,formation:m,formationCardId:s.formation_card_id,stadiumCardId:s.stadium_card_id||null,slots:{},subs:[],playerCards:u,formationCards:a,stadiumCards:n,stadDefMap:f,availableFormations:h};(_||[]).forEach(T=>{T.is_starter?c.slots[T.position]=T.card_id:c.subs.includes(T.card_id)||c.subs.push(T.card_id)}),ht(t,c,i)}function ht(e,t,i){var h,_,m,c;const{navigate:o}=i;ei[t.formation];const d=Oi(t.formation),s=d.filter(T=>t.slots[T]).length,r=t.availableFormations.length>0?t.availableFormations:Object.keys(ei),l=(h=t.stadiumCards)==null?void 0:h.find(T=>T.id===t.stadiumCardId),u=l&&((_=t.stadDefMap)==null?void 0:_[l.stadium_id])||null,a=t.subs.map(T=>t.playerCards.find(p=>p.id===T)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    <div style="padding:10px 16px;background:#fff;border-bottom:1px solid var(--gray-200)">
      ...
      <select id="formation-select" style="width:100%;padding:7px;border-radius:6px;border:1.5px solid var(--gray-200)">
        ${r.map(T=>`<option value="${T}" ${T===t.formation?"selected":""}>${T}</option>`).join("")}
      </select>
    </div>
      ...
      <div style="display:flex;gap:0;min-height:600px">
        ...
        <div style="width:140px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:16px 8px;gap:12px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div id="add-stad-btn" style="cursor:pointer">
            ${l?(()=>{var I;const T=t.stadDefMap[l.stadium_id],p=((I=T==null?void 0:T.club)==null?void 0:I.logo_url)||null;return`<div style="width:100px;height:130px;border-radius:8px;background:linear-gradient(135deg,#1a3a6b,#0a1a3a);border:2px solid #E87722;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
                ${p?`<img src="${p}" style="width:48px;height:48px;object-fit:contain">`:'<span style="font-size:36px">🏟️</span>'}
                <span style="font-size:10px;font-weight:700;color:#E87722;text-align:center;padding:0 4px">${((T==null?void 0:T.name)||"Stade").slice(0,14)}</span>
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${a.map(T=>{const p={...T.player,_evolution_bonus:T.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                ${bt({...p,_evolution_bonus:p._evolution_bonus||0},{width:90,showStad:!0,stadDef:u})}
                <button data-remove-sub="${T.id}"
        ...
        <div style="display:flex;gap:10px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:4px;align-items:flex-end;flex-wrap:nowrap;overflow-x:auto" id="subs-list">
              ${a.map(T=>{const p={...T.player,_evolution_bonus:T.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                  ${bt({...p,_evolution_bonus:p._evolution_bonus||0},{width:44,showStad:!0,stadDef:u})}
                  <button data-remove-sub="${T.id}"
          ...
          <div style="flex-shrink:0;text-align:center">
            ...
            <div id="add-stad-btn" style="cursor:pointer">
              ${l?(()=>{var I;const T=t.stadDefMap[l.stadium_id],p=((I=T==null?void 0:T.club)==null?void 0:I.logo_url)||null;return`<div style="width:50px;height:65px;border-radius:6px;background:linear-gradient(135deg,#1a3a6b,#0a1a3a);border:2px solid #E87722;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px">
                  ${p?`<img src="${p}" style="width:26px;height:26px;object-fit:contain">`:'<span style="font-size:18px">🏟️</span>'}
                  <span style="font-size:7px;font-weight:700;color:#E87722;text-align:center;padding:0 2px">${((T==null?void 0:T.name)||"Stade").slice(0,10)}</span>
  ...
  </div>`;const n=window.innerWidth>=768,x=e.querySelector(".deck-pc-layout"),f=e.querySelector(".deck-mobile-layout");x&&(x.style.display=n?"block":"none"),f&&(f.style.display=n?"none":"block"),io(e,t,d,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",T=>{t.formation=T.target.value;const p=Oi(t.formation),I={};p.forEach(B=>{t.slots[B]&&(I[B]=t.slots[B])}),t.slots=I,ht(e,t,i)}),(m=document.getElementById("add-stad-btn"))==null||m.addEventListener("click",()=>{no(t,e,i)}),document.getElementById("save-deck").addEventListener("click",()=>ao(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(T=>{T.addEventListener("click",()=>{t.subs=t.subs.filter(p=>p!==T.dataset.removeSub),ht(e,t,i)})}),(c=document.getElementById("add-sub-btn"))==null||c.addEventListener("click",()=>{ro(t,e,i)})}function io(e,t,i,o){var I,B;const d=window.innerWidth>=768,s=e.querySelector(d?"#deck-field-pc":"#deck-field-mobile");if(!s)return;const r=(I=t.stadiumCards)==null?void 0:I.find(C=>C.id===t.stadiumCardId),l=r&&((B=t.stadDefMap)==null?void 0:B[r.stadium_id])||null,u=Ut[t.formation]||{},a=Vi(t.formation)||[],n={};for(const C of i){const P=t.slots[C],j=P?t.playerCards.find(N=>N.id===P):null;j!=null&&j.player?n[C]={...j.player,_evolution_bonus:j.evolution_bonus||0,face:j.player.face||null}:n[C]=null}const x=window.innerWidth>=768,f=x?window.innerWidth-180:window.innerWidth-20,h=x?Math.min(f,800):f,_=Math.round(x?h*1.3:h*1.35),m=x?80:44;let c="";for(const[C,P]of a){const j=u[C],N=u[P];if(!j||!N)continue;const V=j.x*h,K=j.y*_,oe=N.x*h,ie=N.y*_,Q=n[C],R=n[P],D=ot(Q,R);D==="#ff3333"||D==="#cc2222"?c+=`<line x1="${V.toFixed(1)}" y1="${K.toFixed(1)}" x2="${oe.toFixed(1)}" y2="${ie.toFixed(1)}" stroke="${D}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(c+=`<line x1="${V.toFixed(1)}" y1="${K.toFixed(1)}" x2="${oe.toFixed(1)}" y2="${ie.toFixed(1)}" stroke="${D}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,c+=`<line x1="${V.toFixed(1)}" y1="${K.toFixed(1)}" x2="${oe.toFixed(1)}" y2="${ie.toFixed(1)}" stroke="${D}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let T="";const p=Math.round(m*657/507);for(const C of i){const P=u[C];if(!P)continue;const j=n[C],N=P.x*h,V=P.y*_,K=Math.round(N-m/2),oe=Math.round(V-p/2);if(j){const ie=bt({...j,_evolution_bonus:j._evolution_bonus||0},{width:m,showStad:!0,stadDef:l});T+=`<div style="position:absolute;left:${K}px;top:${oe}px;cursor:pointer;z-index:2" class="deck-slot-hit" data-pos="${C}">${ie}</div>`}else{const ie=C.replace(/\d+/,"");T+=`<div style="position:absolute;left:${K}px;top:${oe}px;width:${m}px;height:${p}px;
    ...
    <div style="position:relative;width:${h}px;height:${_}px;margin:0 auto">
      ...
      ${T}
    </div>`,s.querySelectorAll(".deck-slot-hit").forEach(C=>{C.addEventListener("click",()=>oo(C.dataset.pos,t,e,o))})}function no(e,t,i){var r;const{openModal:o,closeModal:d}=i,s=e.stadiumCards||[];o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${s.map(l=>{var f;const u=e.stadDefMap[l.stadium_id],a=((f=u==null?void 0:u.club)==null?void 0:f.logo_url)||null,n=u!=null&&u.image_url?"/icons/"+u.image_url:null,x=e.stadiumCardId===l.id;return`<div class="stad-choice" data-stad-id="${l.id}" style="cursor:pointer;width:70px;text-align:center">
    ...
    </div>`),(r=document.getElementById("stad-none"))==null||r.addEventListener("click",()=>{e.stadiumCardId=null,d(),ht(t,e,i)}),document.querySelectorAll(".stad-choice").forEach(l=>{l.addEventListener("click",()=>{e.stadiumCardId=l.dataset.stadId,d(),ht(t,e,i)})})}function oo(e,t,i,o){var f,h,_;const{openModal:d,closeModal:s}=o,r=e.replace(/\d+/,""),l=t.slots[e],u=l?t.playerCards.find(m=>m.id===l):null;(f=u==null?void 0:u.player)==null||f.id;const a=new Set;Object.entries(t.slots).forEach(([m,c])=>{var p;if(m===e||!c)return;const T=t.playerCards.find(I=>I.id===c);(p=T==null?void 0:T.player)!=null&&p.id&&a.add(T.player.id)}),t.subs.forEach(m=>{var T;const c=t.playerCards.find(p=>p.id===m);(T=c==null?void 0:c.player)!=null&&T.id&&a.add(c.player.id)});const n=new Set,x=t.playerCards.filter(m=>{const c=m.player;return!(c.job===r||c.job2===r)||a.has(c.id)||n.has(c.id)?!1:(n.add(c.id),!0)});x.sort((m,c)=>{const T=m.evolution_bonus||0,p=c.evolution_bonus||0,I=(r==="GK"?m.player.note_g:r==="DEF"?m.player.note_d:r==="MIL"?m.player.note_m:m.player.note_a)+(r===m.player.job||r===m.player.job2?T:0);return(r==="GK"?c.player.note_g:r==="DEF"?c.player.note_d:r==="MIL"?c.player.note_m:c.player.note_a)+(r===c.player.job||r===c.player.job2?p:0)-I}),d(`Choisir ${r} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${x.length>0?x.map(m=>{var C,P;const c=m.player,T=m.evolution_bonus||0,p=(r==="GK"?c.note_g:r==="DEF"?c.note_d:r==="MIL"?c.note_m:c.note_a)+(r===c.job||r===c.job2?T:0),I=rn(c),B={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[c.rarity];return`<div class="player-option" data-card-id="${m.id}"
          ...
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${Dt[r]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${B};flex-shrink:0">
            ${p}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(h=document.getElementById("close-selector"))==null||h.addEventListener("click",s),(_=document.getElementById("remove-player"))==null||_.addEventListener("click",()=>{delete t.slots[e],s(),ht(i,t,o)}),document.querySelectorAll(".player-option").forEach(m=>{m.addEventListener("click",()=>{t.slots[e]=m.dataset.cardId,s(),ht(i,t,o)})})}function ro(e,t,i){var u;const{openModal:o,closeModal:d}=i,s=new Set;Object.keys(e.slots).forEach(a=>{var f;const n=e.slots[a];if(!n)return;const x=e.playerCards.find(h=>h.id===n);(f=x==null?void 0:x.player)!=null&&f.id&&s.add(x.player.id)}),e.subs.forEach(a=>{var x;const n=e.playerCards.find(f=>f.id===a);(x=n==null?void 0:n.player)!=null&&x.id&&s.add(n.player.id)});const r=new Set,l=e.playerCards.filter(a=>{var n,x,f;return s.has((n=a.player)==null?void 0:n.id)||r.has((x=a.player)==null?void 0:x.id)?!1:(r.add((f=a.player)==null?void 0:f.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${l.length>0?l.map(a=>{var h;const n=a.player,x=rn(n),f=(n.job==="GK"?n.note_g:n.job==="DEF"?n.note_d:n.job==="MIL"?n.note_m:n.note_a)+(a.evolution_bonus||0);return`<div class="player-option" data-card-id="${a.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(u=document.getElementById("close-sub-selector"))==null||u.addEventListener("click",d),document.querySelectorAll(".player-option").forEach(a=>{a.addEventListener("click",()=>{e.subs.push(a.dataset.cardId),d(),ht(t,e,i)})})}async function ao(e,t){const{state:i,toast:o,navigate:d}=t,s=e.formationCards.find(u=>u.formation===e.formation),r=(s==null?void 0:s.id)||e.formationCardId;await z.from("decks").update({formation:e.formation,formation_card_id:r||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await z.from("deck_cards").delete().eq("deck_id",e.deckId);const l=[];if(Object.entries(e.slots).forEach(([u,a],n)=>{l.push({deck_id:e.deckId,card_id:a,position:u,is_starter:!0,slot_order:n})}),e.subs.forEach((u,a)=>{l.push({deck_id:e.deckId,card_id:u,position:`SUB${a+1}`,is_starter:!1,slot_order:100+a})}),l.length>0){const{error:u}=await z.from("deck_cards").insert(l);if(u){o(u.message,"error");return}}o("Deck enregistré ✅","success"),d("decks")}function Oi(e){const t=ei[e]||ei["4-4-2"],i=["GK1"];for(let o=1;o<=t.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=t.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=t.ATT;o++)i.push(`ATT${o}`);return i}async function an(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await z.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const o=i.filter(r=>!(r.available_from&&t<r.available_from||r.available_until&&t>r.available_until));if(!o.length)return[];let d=o;if(e){const r=o.filter(l=>l.max_per_user!=null);if(r.length){const{data:l}=await z.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",r.map(a=>a.id)),u={};(l||[]).forEach(a=>{u[a.booster_id]=(u[a.booster_id]||0)+1}),d=o.filter(a=>a.max_per_user==null?!0:(u[a.id]||0)<a.max_per_user)}}if(!d.length)return[];const{data:s}=await z.from("booster_drop_rates").select("*").in("booster_id",d.map(r=>r.id)).order("sort_order");return d.map(r=>({...r,rates:(s||[]).filter(l=>l.booster_id===r.id)}))}async function so(e,t){const{data:i}=await z.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await z.from("booster_claims").insert({user_id:e,booster_id:t})}function lo(e){if(!(e!=null&&e.length))return null;const t=e.reduce((o,d)=>o+Number(d.percentage),0);let i=Math.random()*t;for(const o of e)if(i-=Number(o.percentage),i<=0)return o;return e[e.length-1]}const sn=()=>Object.keys(Ut),co=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],yi={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function po(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return bt({...t,_evolution_bonus:i},{width:140})}function dn(e){var d;const t={};(e.rates||[]).forEach(s=>{t[s.card_type]=(t[s.card_type]||0)+Number(s.percentage||0)});const i=((d=Object.entries(t).sort((s,r)=>r[1]-s[1])[0])==null?void 0:d[0])||"player",o=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+o,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function uo(e,{state:t,navigate:i,toast:o}){var x,f,h;const d=((x=t.profile)==null?void 0:x.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let s=[];try{s=(await an((f=t.user)==null?void 0:f.id)).map(dn)}catch(_){console.warn("Erreur chargement boosters DB, fallback hardcodé",_)}s.length||(s=co.map(_=>({..._,rates:[],isPub:_.id==="players_pub"})));const r=await z.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(_=>_.data||[]),l=new Set(r.filter(_=>_.card_type==="stadium").map(_=>_.stadium_id)),u=new Set(r.filter(_=>_.card_type==="formation").map(_=>_.formation)),a=new Set(r.filter(_=>_.card_type==="game_changer").map(_=>_.gc_type)),n={};for(const _ of s){if(_.allow_duplicates!==!1||!((h=_.rates)!=null&&h.length))continue;const m=[...new Set((_.rates||[]).map(T=>T.card_type))];let c=!1;for(const T of m)if(T==="stadium"){const{data:p}=await z.from("stadium_definitions").select("id");if((p||[]).some(I=>!l.has(I.id))){c=!0;break}}else if(T==="game_changer"){const{data:p}=await z.from("gc_definitions").select("name").eq("is_active",!0);if((p||[]).some(I=>!a.has(I.name))){c=!0;break}}else if(T==="formation"){const{FORMATION_LINKS:p}=await oi(async()=>{const{FORMATION_LINKS:I}=await import("./formation-links-BZe0pGr4.js").then(B=>B.p);return{FORMATION_LINKS:I}},__vite__mapDeps([0,1]));if(Object.keys(p).some(I=>!u.has(I))){c=!0;break}}else{c=!0;break}c||(n[_.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(_=>{_.addEventListener("click",async()=>{const m=s.find(c=>c.id===_.dataset.booster);if(m){_.style.opacity="0.5",_.style.pointerEvents="none";try{await fo(m,{state:t,toast:o,navigate:i,container:e})}catch(c){o(c.message,"error"),_.style.opacity="",_.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(_=>{_.addEventListener("click",m=>{m.stopPropagation();const c=s.find(T=>T.id===_.dataset.boosterId);yo(c)})})}async function fo(e,{state:t,toast:i,navigate:o,container:d}){var x,f;if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}e.isPub&&await ho();const{data:s}=await z.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),r=new Set((s||[]).filter(h=>h.card_type==="player").map(h=>h.player_id)),l=new Set((s||[]).filter(h=>h.card_type==="formation").map(h=>h.formation));let u=[],a=null;try{if((x=e.rates)!=null&&x.length)u=await bi(t.profile,e);else{const h=e.type||"player";h==="player"?u=await ln(t.profile,e.cardCount,e.cost):h==="game_changer"?u=await cn(t.profile,e.cardCount,e.cost):h==="formation"?u=await pn(t.profile,e.cost):u=await bi(t.profile,e)}}catch(h){a=h.message||String(h),console.error("[Booster] Erreur:",h)}if(u!=null&&u.length&&e._boosterId&&await so(t.user.id,e._boosterId),!(u!=null&&u.length)){const h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",h.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${a||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(h),(f=h.querySelector("#anim-close-err"))==null||f.addEventListener("click",()=>h.remove());return}u.forEach(h=>{h.card_type==="player"&&h.player?h.isDuplicate=r.has(h.player.id):h.card_type==="formation"&&(h.isDuplicate=l.has(h.formation))});const{data:n}=await z.from("users").select("*").eq("id",t.profile.id).single();n&&(t.profile=n),un(u,e,o)}function go(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function xt(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function mo(e,t){let i;switch(t){case"legende":i=e.filter(o=>o.rarity==="legende"),i.length||(i=e.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=e.filter(o=>xt(o)>=6));break;case"special":i=e.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=e.filter(o=>xt(o)>=6));break;case"normal_high":i=e.filter(o=>o.rarity==="normal"&&xt(o)>=6),i.length||(i=e.filter(o=>xt(o)>=6));break;default:i=e.filter(o=>o.rarity==="normal"&&xt(o)>=1&&xt(o)<=5),i.length||(i=e.filter(o=>o.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function bi(e,t){if(t.cost>0){const{error:f}=await z.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(f)throw f}const i=t.allow_duplicates!==!1;let o=[];const{data:d,error:s}=await z.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.id);if(s){const{data:f}=await z.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",e.id);o=f||[]}else o=d||[];const r=new Set(o.filter(f=>f.card_type==="player").map(f=>f.player_id)),l=new Set(o.filter(f=>f.card_type==="formation").map(f=>f.formation)),u=new Set(o.filter(f=>f.card_type==="game_changer").map(f=>f.gc_type)),a=new Set(o.filter(f=>f.card_type==="stadium").map(f=>f.stadium_id).filter(Boolean)),n=new Set,x=[];for(let f=0;f<(t.cardCount||5);f++){const h=lo(t.rates);if(h){if(h.card_type==="player"){const _=j=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[j]||j,m=h.rarity?_(h.rarity):null;let c=z.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);m&&(c=c.eq("rarity",m));const{data:T}=await c;let p=T||[];if((h.note_min||h.note_max)&&(p=p.filter(j=>{const N=Math.max(Number(j.note_g)||0,Number(j.note_d)||0,Number(j.note_m)||0,Number(j.note_a)||0);return(!h.note_min||N>=h.note_min)&&(!h.note_max||N<=h.note_max)})),p.length||(h.note_min||h.note_max?(p=T||[],console.warn("[Booster] Aucun joueur avec note",h.note_min,"-",h.note_max,"— fallback rareté uniquement")):p=T||[]),!p.length)continue;let I=p.filter(j=>!n.has(j.id));if(i)I.length||(I=p);else if(I=I.filter(j=>!r.has(j.id)),!I.length)continue;const B=I[Math.floor(Math.random()*I.length)];n.add(B.id);const C=r.has(B.id),{data:P}=await z.from("cards").insert({owner_id:e.id,player_id:B.id,card_type:"player"}).select().single();P&&(x.push({...P,player:B,isDuplicate:C}),z.rpc("record_transfer",{p_card_id:P.id,p_player_id:B.id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(h.card_type==="game_changer"){const{data:_}=await z.from("gc_definitions").select("id,name").eq("is_active",!0).eq("gc_type","game_changer"),m=_!=null&&_.length?_:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],c=i?m:m.filter(B=>!u.has(B.name));if(!i&&!c.length)continue;const p=c[Math.floor(Math.random()*c.length)].name,{data:I}=await z.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:p}).select().single();I&&x.push(I)}else if(h.card_type==="formation"){const _=sn(),m=i?_:_.filter(I=>!l.has(I));if(!i&&!m.length)continue;const c=m[Math.floor(Math.random()*m.length)],T=l.has(c),{data:p}=await z.from("cards").insert({owner_id:e.id,card_type:"formation",formation:c}).select();p!=null&&p[0]&&x.push({...p[0],isDuplicate:T})}else if(h.card_type==="stadium"){const{data:_,error:m}=await z.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(m){console.error("[Booster] stadium_definitions:",m.message);continue}if(!(_!=null&&_.length)){console.warn("[Booster] Aucun stade en DB");continue}const c=i?_:_.filter(B=>!a.has(B.id));if(!i&&!c.length)continue;const T=c[Math.floor(Math.random()*c.length)],{data:p,error:I}=await z.from("cards").insert({owner_id:e.id,card_type:"stadium",stadium_id:T.id}).select("id,card_type,stadium_id").single();if(I){console.error("[Booster] insert stadium card:",I.message);continue}p&&x.push({...p,rarity:"normal",_stadiumDef:T})}}}return x}async function ln(e,t,i){if(i>0){const{error:a}=await z.from("users").update({credits:e.credits-i}).eq("id",e.id);if(a)throw a}const{data:o}=await z.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const d=o.filter(a=>a.job==="GK"),s=o.filter(a=>a.job!=="GK"),r=!e.first_booster_opened&&d.length>0,l=[];for(let a=0;a<t;a++){const n=a===0&&r?d:a===0?s:o,x=go(),f=mo(n,x);f&&l.push(f)}r&&await z.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:u}=await z.from("cards").insert(l.map(a=>({owner_id:e.id,player_id:a.id,card_type:"player"}))).select();return(u||[]).forEach((a,n)=>{z.rpc("record_transfer",{p_card_id:a.id,p_player_id:l[n].id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),l.map((a,n)=>({...u[n],player:a}))}async function cn(e,t,i){const{error:o}=await z.from("users").update({credits:e.credits-i}).eq("id",e.id);if(o)throw o;const{data:d}=await z.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),s=d!=null&&d.length?d:Object.keys(yi).map(n=>({name:n,gc_type:"game_changer"})),r=Array.from({length:t},()=>{const n=s[Math.floor(Math.random()*s.length)];return{owner_id:e.id,card_type:"game_changer",gc_type:n.name,gc_definition_id:n.id||null}}),{data:l,error:u}=await z.from("cards").insert(r).select();return u&&console.error("[Booster GC] Erreur insert:",u.message,u),(l||[]).map(n=>{const x=d==null?void 0:d.find(f=>f.name===n.gc_type||f.id===n.gc_definition_id);return{...n,_gcDef:x||null}})}async function pn(e,t){const{error:i}=await z.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const{data:o}=await z.from("cards").select("formation").eq("owner_id",e.id).eq("card_type","formation"),d=new Set((o||[]).map(n=>n.formation)),s=sn(),r=s[Math.floor(Math.random()*s.length)],l=d.has(r),{data:u,error:a}=await z.from("cards").insert({owner_id:e.id,card_type:"formation",formation:r}).select();return a&&console.error("[Booster Formation] Erreur insert:",a.message,a),(u||[]).map(n=>({...n,isDuplicate:l}))}function un(e,t,i,o=null){var ie,Q;if(!e||e.length===0){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",R.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.5)">Erreur lors du tirage (permissions DB ou colonne manquante)</div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(R),(ie=R.querySelector("#anim-close-err"))==null||ie.addEventListener("click",()=>R.remove());return}e=[...e].sort((R,D)=>{const re=R.player?xt(R.player):-1;return(D.player?xt(D.player):-1)-re});const d=document.createElement("div");d.id="booster-anim-overlay",d.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(d);let s=!1;const r=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let u=!1;const a=R=>R.touches&&R.touches[0]?R.touches[0].clientX:R.clientX;function n(R){s||(u=!0,l.style.opacity="1",x(R))}function x(R){if(!u||s)return;const D=r.getBoundingClientRect(),re=a(R)-D.left,me=Math.max(0,Math.min(1,re/D.width));l.style.width=me*D.width+"px",me>=.82&&h()}function f(){s||(u=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{s||(l.style.transition="")},220))}function h(){var D;if(s)return;s=!0,u=!1,l.style.width="100%",l.style.opacity="1",(D=document.getElementById("cut-flash"))==null||D.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const R=document.getElementById("cut-hint");R&&(R.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",T(0)},620)}r.addEventListener("pointerdown",n),window.addEventListener("pointermove",x),window.addEventListener("pointerup",f),r.addEventListener("touchstart",n,{passive:!0}),window.addEventListener("touchmove",x,{passive:!0}),window.addEventListener("touchend",f);let _=0,m=!1;const c=new Set;function T(R){_=R,document.getElementById("reveal-phase").style.display="flex",p(),I(R,0),N()}function p(){const R=document.getElementById("card-dots");R&&(R.innerHTML=e.map((D,re)=>`<div class="card-dot" data-i="${re}" style="width:8px;height:8px;border-radius:50%;background:${re===_?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),R.querySelectorAll(".card-dot").forEach(D=>D.addEventListener("click",()=>C(parseInt(D.dataset.i)))))}function I(R,D){var de;const re=e[R],me=document.getElementById("card-counter"),_e=document.getElementById("card-track");me&&(me.textContent=`Carte ${R+1} / ${e.length}`);const ve=document.getElementById("reveal-btns");ve&&(ve.style.display=R===e.length-1?"flex":"none");const we=re.card_type==="player"&&((de=re.player)==null?void 0:de.rarity)==="legende",Ee=!c.has(R);c.add(R);let se=0;if(re.card_type==="player"&&re.player){const O=re.player,ee=O.job||"ATT";se=Number(ee==="GK"?O.note_g:ee==="DEF"?O.note_d:ee==="MIL"?O.note_m:O.note_a)||0}const pe=O=>{_e.innerHTML=`
        ...
        </div>`;const ee=document.getElementById("current-card-wrap");D!==0?(ee.style.transition="none",ee.style.transform=`translateX(${D>0?100:-100}%)`,requestAnimationFrame(()=>{ee.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ee.style.transform="translateX(0)"})):ee.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),O||we?K():oe(),p()};Ee&&se>6&&re.card_type==="player"&&re.player?B(re,()=>pe(!0)):pe(!1)}function B(R,D){var se;m=!0;const re=R.player,me=`https://flagsapi.com/${re.country_code}/flat/64.png`,_e=(se=re.clubs)==null?void 0:se.logo_url,ve=document.getElementById("walkout-overlay"),we=document.getElementById("walkout-stage");if(!ve||!we){m=!1,D();return}ve.style.display="flex";const Ee=()=>{const pe=we.firstElementChild;pe&&(pe.classList.remove("wo-in"),pe.classList.add("wo-out"))};we.innerHTML=`<img class="wo-in" src="${me}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(Ee,2e3),setTimeout(()=>{var pe;we.innerHTML=_e?`<img class="wo-in" src="${_e}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((pe=re.clubs)==null?void 0:pe.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(Ee,4450),setTimeout(()=>{ve.style.display="none",we.innerHTML="",m=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),D()},4900)}function C(R){if(m||R<0||R>=e.length||R===_)return;const D=R>_?1:-1;_=R,I(R,D)}function P(){C(_+1)}function j(){C(_-1)}function N(){const R=document.getElementById("card-viewport");if(!R||R._swipeBound)return;R._swipeBound=!0;let D=0,re=0,me=0,_e=!1;const ve=de=>de.touches?de.touches[0].clientX:de.clientX,we=de=>de.touches?de.touches[0].clientY:de.clientY,Ee=de=>{_e=!0,D=ve(de),re=we(de),me=0},se=de=>{if(!_e)return;me=ve(de)-D;const O=we(de)-re;if(Math.abs(me)<Math.abs(O))return;const ee=document.getElementById("current-card-wrap");ee&&(ee.style.transition="none",ee.style.transform=`translateX(${me*.6}px) rotate(${me*.02}deg)`)},pe=()=>{if(!_e)return;_e=!1;const de=document.getElementById("current-card-wrap"),O=55;me<=-O&&_<e.length-1?P():me>=O&&_>0?j():de&&(de.style.transition="transform .2s ease",de.style.transform="translateX(0)")};R.addEventListener("pointerdown",Ee),R.addEventListener("pointermove",se),R.addEventListener("pointerup",pe),R.addEventListener("pointercancel",pe),R.addEventListener("touchstart",Ee,{passive:!0}),R.addEventListener("touchmove",se,{passive:!0}),R.addEventListener("touchend",pe),R.addEventListener("click",de=>{if(Math.abs(me)>8)return;const O=R.getBoundingClientRect();de.clientX-O.left>O.width/2?P():j()})}let V=null;function K(){const R=document.getElementById("fireworks-canvas");if(!R)return;R.width=window.innerWidth,R.height=window.innerHeight;const D=R.getContext("2d"),re=[];function me(){const ve=Math.random()*R.width,we=Math.random()*R.height*.6,Ee=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],se=Ee[Math.floor(Math.random()*Ee.length)];for(let pe=0;pe<60;pe++){const de=Math.PI*2/60*pe,O=2+Math.random()*5;re.push({x:ve,y:we,vx:Math.cos(de)*O,vy:Math.sin(de)*O,alpha:1,color:se,size:2+Math.random()*3})}}me(),V=setInterval(me,600);function _e(){if(document.getElementById("fireworks-canvas")){D.clearRect(0,0,R.width,R.height);for(let ve=re.length-1;ve>=0;ve--){const we=re[ve];if(we.x+=we.vx,we.y+=we.vy+.08,we.vy*=.98,we.alpha-=.018,we.alpha<=0){re.splice(ve,1);continue}D.globalAlpha=we.alpha,D.fillStyle=we.color,D.beginPath(),D.arc(we.x,we.y,we.size,0,Math.PI*2),D.fill()}D.globalAlpha=1,(V!==null||re.length>0)&&requestAnimationFrame(_e)}}_e()}function oe(){V!==null&&(clearInterval(V),V=null);const R=document.getElementById("fireworks-canvas");R&&R.getContext("2d").clearRect(0,0,R.width,R.height)}if(o){const R=document.getElementById("reveal-btns");R&&(R.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(Q=document.getElementById("reveal-next"))==null||Q.addEventListener("click",()=>{oe(),d.remove(),o()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{oe(),d.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{oe(),d.remove(),i("boosters")})}function xo(e){var t,i,o,d;if(e.card_type==="player"&&e.player)return po(e);if(e.card_type==="game_changer"){const s=e._gcDef,r=(s==null?void 0:s.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},u={purple:"#b06ce0",light_blue:"#00d4ef"},a=l[s==null?void 0:s.color]||l.purple,n=u[s==null?void 0:s.color]||u.purple,x=(s==null?void 0:s.name)||e.gc_type||"Game Changer",f=(s==null?void 0:s.effect)||((t=yi[e.gc_type])==null?void 0:t.desc)||"",h=s!=null&&s.image_url?`/icons/${s.image_url}`:null,_=((i=yi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${a};border-radius:14px;border:3px solid ${n};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${n}88;flex-shrink:0">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function ho(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const o=setInterval(()=>{i--;const d=document.getElementById("mw-ad-cd");d&&(d.textContent=i),i<=0&&(clearInterval(o),t.remove(),e(!0))},1e3)})}async function vo(e,{state:t,navigate:i,toast:o,refreshProfile:d}){var f,h;const{data:s}=await z.from("users").select("*").eq("id",t.user.id).single();s&&(t.profile=s);let r=Array.isArray((f=t.profile)==null?void 0:f.pending_boosters)?[...t.profile.pending_boosters]:[];if(!r.length){await z.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let l=null;try{const m=(await an()).find(c=>(c.name||"").toLowerCase().includes("new player"));m&&(l=dn(m))}catch(_){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',_)}const u=r.length;let a=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}const u=n=>{e.style.overflow="",e.style.height="",e.style.display="",e.style.flexDirection="",i(n)};function a(){var x,f,h;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const n=r.length>0;e.innerHTML=`
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(_=>{_.addEventListener("click",()=>{const m=_.dataset.id,c=s.find(p=>p.id===m);if(!c)return;const T=r.findIndex(p=>p.gc_type===c.gc_type);T>-1?r.splice(T,1):r.length<3&&r.push(c),a()})}),(x=e.querySelector("#gc-launch"))==null||x.addEventListener("click",()=>{n&&u(r)}),(f=e.querySelector("#gc-no-gc"))==null||f.addEventListener("click",()=>u([])),(h=e.querySelector("#gc-reset"))==null||h.addEventListener("click",()=>{r.length&&(r=[],a())})}a()}function _o(e){var o;const t=((o=e==null?void 0:e.state)==null?void 0:o.params)||{},i=t.matchMode||"vs_ai_easy";return i==="friend"?`Match vs ${t.friendName||"Ami"}`:i==="random"?"Match vs Random":`Match vs IA — ${i.replace("vs_ai_","").toUpperCase()}`}async function $o(e,t,i){const{state:o,navigate:d}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await z.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!s||s.length===0){Et(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>d("decks"));return}const r=s.map(f=>f.id),{data:l}=await z.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),u=[...new Set((l||[]).filter(f=>{var h,_;return((h=f.card)==null?void 0:h.card_type)==="stadium"&&((_=f.card)==null?void 0:_.stadium_id)}).map(f=>f.card.stadium_id))],a={};if(u.length){const{data:f}=await z.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",u);(f||[]).forEach(h=>{a[h.id]=h}),(l||[]).forEach(h=>{var _,m;((_=h.card)==null?void 0:_.card_type)==="stadium"&&((m=h.card)!=null&&m.stadium_id)&&(h.card._stadiumDef=a[h.card.stadium_id]||null)})}let n=0;function x(){var C,P,j,N,V,K,oe;const f=s[n],h=(l||[]).filter(ie=>ie.deck_id===f.id),_=h.filter(ie=>{var Q;return ie.is_starter&&((Q=ie.card)==null?void 0:Q.player)}).map(ie=>hi(ie.card,ie.position)),m=h.find(ie=>{var Q;return((Q=ie.card)==null?void 0:Q.card_type)==="formation"}),c=f.formation||((C=m==null?void 0:m.card)==null?void 0:C.formation)||"4-4-2";let T=_.length>=11?vt(_,c):null,p=((P=f.stadium_card)==null?void 0:P.stadium_def)||null;p&&T&&(T=Tt(T,p));const I=_.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center;padding:4px">
        ${T?`<div class="deck-preview-wrap" style="aspect-ratio:1/1;max-width:100%;max-height:100%;width:auto;height:100%;overflow:hidden">${ct(T,c,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
    ...
    </div>`,function(){const Q=e.querySelector(".deck-preview-wrap svg");Q&&(Q.removeAttribute("width"),Q.removeAttribute("height"),Q.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Q.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),(N=document.getElementById("prev-deck"))==null||N.addEventListener("click",()=>{n>0&&(n--,x())}),(V=document.getElementById("next-deck"))==null||V.addEventListener("click",()=>{n<s.length-1&&(n++,x())}),(K=document.getElementById("validate-deck"))==null||K.addEventListener("click",()=>{if(!I)return;const ie=t.state.params||{};t.navigate("match",{...ie,matchMode:ie.matchMode||i,deckId:f.id})}),(oe=document.getElementById("cancel-deck-select"))==null||oe.addEventListener("click",()=>{Ve(e),d("home")});const B=document.getElementById("deck-swipe-zone");if(B){let ie=0,Q=0;B.addEventListener("touchstart",R=>{ie=R.touches[0].clientX,Q=R.touches[0].clientY},{passive:!0}),B.addEventListener("touchend",R=>{const D=R.changedTouches[0].clientX-ie,re=R.changedTouches[0].clientY-Q;Math.abs(D)<40||Math.abs(D)<Math.abs(re)||(D<0&&n<s.length-1?(n++,x()):D>0&&n>0&&(n--,x()))},{passive:!0})}}x()}function ko(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function Xe(e,t=44,i=58,o=null){return bt(e,{width:t,showStad:!!o,stadDef:o,used:e==null?void 0:e.used})}function it(e,t,i){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let d='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,r)=>{if(d+=Xe(s,40,52),r<o.length-1){const l=ot(s,o[r+1]);d+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(d+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),d+="</div>",d}function Eo(e){return!e||e.length<2?null:`https://flagsapi.com/${e.slice(0,2).toUpperCase()}/flat/64.png`}function To(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function lt(e,t,i,o,d=310,s=310,r=[]){var I;const l=Ut[t]||{},u=Vi(t)||$i[t]||[],a={},n=["ATT","MIL","DEF","GK"];for(const B of n)(e[B]||[]).forEach((P,j)=>{a[`${B}${j+1}`]=P});function x(B){const C=l[B];return C?{x:C.x*d,y:C.y*s}:null}let f="";for(const[B,C]of u){const P=x(B),j=x(C);if(!P||!j)continue;const N=a[B],V=a[C],K=ot(N,V);K==="#00ff88"||K==="#FFD700"?(f+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${K}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,f+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${K}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):f+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${K}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const h=48,_=64,m=13,c=16,T={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[B,C]of Object.entries(a)){const P=x(B);if(!P||!C)continue;const j=B.replace(/[0-9]/g,""),N=Ht[j]||"#555",V=r.includes(C.cardId),K=i==="attack"&&(["MIL","ATT"].includes(j)||V)&&!C.used||i==="defense"&&["GK","DEF","MIL"].includes(j)&&!C.used,oe=o.includes(C.cardId);let ie;i==="attack"?ie=V?Math.max(1,Number(C.note_a)||0):j==="MIL"?Number(C.note_m)||0:Number(C.note_a)||0:i==="defense"?ie=j==="GK"?Number(C.note_g)||0:j==="MIL"?Number(C.note_m)||0:Number(C.note_d)||0:ie=Number(j==="GK"?C.note_g:j==="DEF"?C.note_d:j==="MIL"?C.note_m:C.note_a)||0,ie=ie+(C.boost||0),C.stadiumBonus&&(i==="attack"&&(j==="ATT"||j==="MIL")||i==="defense"&&(j==="GK"||j==="DEF"||j==="MIL")?ie+=10:i||(ie+=10));const Q=(P.x-h/2).toFixed(1),R=(P.y-_/2).toFixed(1),D=T[C==null?void 0:C.rarity]||T.normal;if(C.used){const se=typeof import.meta<"u"&&"/"||"/",de=`${typeof window<"u"&&((I=window.location)==null?void 0:I.origin)||""}${se}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="#161616"/>`,f+=`<image href="${de}" xlink:href="${de}" x="${Q}" y="${R}" width="${h}" height="${_}" preserveAspectRatio="xMidYMid slice"/>`,f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="none" stroke="${D}" stroke-width="2" opacity="0.7"/>`,f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`;continue}const re=oe?.45:1,me=oe?"#FFD700":D,_e=oe?3:(C==null?void 0:C.rarity)==="legende"||(C==null?void 0:C.rarity)==="légende"||(C==null?void 0:C.rarity)==="pepite"||(C==null?void 0:C.rarity)==="pépite"?2.5:2,ve=_-m-c;f+=`<defs><clipPath id="cp-${B}"><rect x="${Q}" y="${(P.y-_/2+m).toFixed(1)}" width="${h}" height="${ve}"/></clipPath></defs>`,f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="${N}" opacity="${re}"/>`;const we=He(C);we&&(f+=`<image href="${we}" xlink:href="${we}" x="${Q}" y="${(P.y-_/2+m).toFixed(1)}" width="${h}" height="${ve}" clip-path="url(#cp-${B})" preserveAspectRatio="xMidYMin slice"/>`),f+=`<rect x="${Q}" y="${R}" width="${h}" height="${m}" rx="4" fill="rgba(255,255,255,0.92)"/>`,f+=`<text x="${P.x.toFixed(1)}" y="${(P.y-_/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(C.name||"").slice(0,9)}</text>`;const Ee=(P.y+_/2-c).toFixed(1);f+=`<rect x="${Q}" y="${Ee}" width="${h}" height="${c}" fill="rgba(255,255,255,0.92)"/>`;{const se=Eo(C.country_code);se?f+=`<image href="${se}" xlink:href="${se}" x="${(P.x-20).toFixed(1)}" y="${(P.y+_/2-c+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:f+=`<text x="${(P.x-13).toFixed(1)}" y="${(P.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${To(C.country_code)}</text>`;const pe=C.stadiumBonus?"#E87722":"#111";f+=`<text x="${P.x.toFixed(1)}" y="${(P.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${pe}" font-family="Arial Black">${ie}</text>`;const de=ko(C);de?f+=`<image href="${de}" xlink:href="${de}" x="${(P.x+h/2-14).toFixed(1)}" y="${(P.y+_/2-c+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:C.clubName&&(f+=`<text x="${(P.x+14).toFixed(1)}" y="${(P.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(C.clubName||"").slice(0,3).toUpperCase()}</text>`),C.stadiumBonus&&(f+=`<rect x="${(P.x-h/2).toFixed(1)}" y="${(P.y-_/2).toFixed(1)}" width="${h}" height="${_}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="${oe?"rgba(255,255,255,0.12)":"none"}" stroke="${me}" stroke-width="${_e}" opacity="${re}"/>`,K&&(f+=`<rect x="${Q}" y="${R}" width="${h}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${oe?"selected":""}" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`)}const p=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-p} ${-p} ${d+p*2} ${s+p*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${f}
  ...
  </div>`}async function si(e,t,i,o){var P;const{state:d,navigate:s,toast:r}=t;et(e);const l=d.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!l.deckId)return $o(e,t,i);const u=l.deckId;let a,n,x,f;try{const j=await Promise.all([z.from("decks").select("formation,name,stadium_card_id").eq("id",u).single(),z.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",u).order("slot_order")]);a=j[0].data,x=j[0].error,n=j[1].data,f=j[1].error}catch(j){console.error("[Match] Exception chargement deck:",j),Et(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>s("home"));return}if(x||f){console.error("[Match] Erreur Supabase:",x||f),Et(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>s("home"));return}const h=(n||[]).filter(j=>{var N;return j.is_starter&&((N=j.card)==null?void 0:N.player)}).map(j=>hi(j.card,j.position)),_=(n||[]).filter(j=>{var N;return!j.is_starter&&((N=j.card)==null?void 0:N.player)}).map(j=>hi(j.card,j.position));if(h.length<11){Et(e,"⚠️",`Deck incomplet (${h.length}/11).`,"Compléter",()=>s("decks"));return}const m=(n||[]).find(j=>{var N;return((N=j.card)==null?void 0:N.card_type)==="formation"}),c=(a==null?void 0:a.formation)||((P=m==null?void 0:m.card)==null?void 0:P.formation)||"4-4-2",{data:T,error:p}=await z.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",d.profile.id).eq("card_type","game_changer"),{data:I}=await z.from("gc_definitions").select("*").eq("is_active",!0),B=(T||[]).map(j=>({...j,_gcDef:(I==null?void 0:I.find(N=>N.name===j.gc_type||N.id===j.gc_definition_id))||null}));let C=null;if(a!=null&&a.stadium_card_id){const{data:j}=await z.from("cards").select("stadium_id").eq("id",a.stadium_card_id).single();if(j!=null&&j.stadium_id){const{data:N}=await z.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",j.stadium_id).single();C=N||null}}o({deckId:u,formation:c,starters:h,subsRaw:_,gcCardsEnriched:B,gcDefs:I||[],stadiumDef:C})}async function zo(e,t){const{state:i}=t,d=(i.params||{}).matchMode||"vs_ai_easy",s=d.replace("vs_ai_",""),r=d;await si(e,t,d,async({deckId:l,formation:u,starters:a,subsRaw:n,gcCardsEnriched:x,gcDefs:f,stadiumDef:h})=>{try{let _=vt(a,u);h&&(_=Tt(_,h),jt(n,h));const m=await So(u,s),c=m.lines||m,T=async p=>{try{const{data:I,error:B}=await z.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:l,status:"in_progress"}).select().single();if(B){console.error("[MatchIA] Erreur création match:",B),Et(e,"⚠️","Impossible de créer le match ("+B.message+").","Retour",()=>t.navigate("home"));return}const C=m.stadiumDef||null;C&&c&&(Tt(c,C),jt(m.subs||[],C));const P={gcDefs:f||[],matchId:I==null?void 0:I.id,mode:r,difficulty:s,formation:u,homeTeam:_,aiTeam:c,homeSubs:n,subsUsed:0,maxSubs:Math.min(n.length,3),aiSubs:m.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((m.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:m.gcCards||[],aiUsedGc:[],aiStadiumDef:C,homeScore:0,aiScore:0,gcCards:p,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Lo(e,P,t)}catch(I){console.error("[MatchIA] Exception launchMatch:",I),Et(e,"⚠️","Erreur au lancement du match : "+I.message,"Retour",()=>t.navigate("home"))}};if(!x.length){T([]);return}ai(e,x,T)}catch(_){console.error("[MatchIA] Exception setup:",_),Et(e,"⚠️","Erreur de préparation du match : "+_.message,"Retour",()=>t.navigate("home"))}})}async function So(e,t){var c;const{data:i}=await z.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Ao(e),subs:[],gcCards:[],stadiumDef:null};const o=Mt[e]||Mt["4-4-2"],d={GK:[],DEF:[],MIL:[],ATT:[]},s=new Set;function r(T,p,I){var B,C;return s.add(T.id),{cardId:"ai-"+T.id+"-"+I,id:T.id,firstname:T.firstname,name:T.surname_encoded,country_code:T.country_code,club_id:T.club_id,job:T.job,job2:T.job2,note_g:Number(T.note_g)||0,note_d:Number(T.note_d)||0,note_m:Number(T.note_m)||0,note_a:Number(T.note_a)||0,rarity:T.rarity,skin:T.skin,hair:T.hair,hair_length:T.hair_length,clubName:((B=T.clubs)==null?void 0:B.encoded_name)||null,clubLogo:((C=T.clubs)==null?void 0:C.logo_url)||null,boost:0,used:!1,_line:p}}for(const T of["GK","DEF","MIL","ATT"]){const p=i.filter(j=>j.job===T&&!s.has(j.id)),I=i.filter(j=>j.job!==T&&!s.has(j.id)),B=[...p,...I],C=[];for(let j=0;j<o[T];j++){const N=B[j];N&&C.push(r(N,T,j))}const P=st(C.length);C.forEach((j,N)=>{j._col=P[N]}),d[T]=C}const u=i.filter(T=>!s.has(T.id)).slice(0,5).map((T,p)=>r(T,T.job,100+p)),x=Object.keys(Oe).sort(()=>Math.random()-.5).slice(0,3).map((T,p)=>{var I,B;return{id:"ai-gc-"+p,gc_type:T,name:((I=Oe[T])==null?void 0:I.name)||T,icon:((B=Oe[T])==null?void 0:B.icon)||"⚡"}}),f=Object.values(d).flat(),h={};f.forEach(T=>{T.club_id&&(h[T.club_id]=(h[T.club_id]||0)+1)});const _=(c=Object.entries(h).sort((T,p)=>p[1]-T[1])[0])==null?void 0:c[0];let m=null;if(_){const{data:T}=await z.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",_).single();T&&(m={club_id:T.id,country_code:null,name:T.encoded_name+" Stadium",club:{encoded_name:T.encoded_name,logo_url:T.logo_url}})}return{lines:d,subs:u,gcCards:x,stadiumDef:m}}function Ao(e){const t=Mt[e]||Mt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let d=0;for(const s of["GK","DEF","MIL","ATT"]){const r=[];for(let u=0;u<t[s];u++){const a=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+d,id:"fake-"+d,firstname:"IA",name:o[d%o.length],country_code:"XX",club_id:null,job:s,job2:null,note_g:s==="GK"?a:2,note_d:s==="DEF"?a:2,note_m:s==="MIL"?a:2,note_a:s==="ATT"?a:2,rarity:"normal",boost:0,used:!1,_line:s}),d++}const l=st(r.length);r.forEach((u,a)=>{u._col=l[a]}),i[s]=r}return i}function Lo(e,t,i){var o;e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>Io(e,t,i),5e3)}function Io(e,t,i){const o=t.homeTeam.MIL||[],d=t.aiTeam.MIL||[],s=t.stadiumDef||null,r=t.aiStadiumDef||null;function l(p,I){const B=Se(p,"MIL"),C=p.evolution_bonus||p._evolution_bonus||0,P=p.job==="MIL"||p.job2==="MIL"?C:0,j=p.stadiumBonus||I&&(I.club_id&&String(p.club_id)===String(I.club_id)||I.country_code&&p.country_code===I.country_code)?10:0;return B+P+j}function u(p,I){return p.reduce((B,C)=>B+l(C,I),0)}function a(p){let I=0;for(let B=0;B<p.length-1;B++){const C=ot(p[B],p[B+1]);C==="#00ff88"?I+=2:C==="#FFD700"&&(I+=1)}return I}const n=u(o,s)+a(o),x=u(d,r)+a(d),f=n>=x;function h(p,I,B,C,P){return`<div id="duel-row-${C}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((j,N)=>{const V=N<p.length-1?ot(j,p[N+1]):null,K=!V||V==="#ff3333"||V==="#cc2222",oe=V==="#00ff88"?"+2":V==="#FFD700"?"+1":"";l(j,P),j.stadiumBonus||P&&(P.club_id&&String(j.club_id)===String(P.club_id)||P.country_code&&(j.country_code,P.country_code));const ie=j.evolution_bonus||j._evolution_bonus||0;return`
          ...
          ${N<p.length-1?`<div class="duel-link duel-link-${C}" data-idx="${N}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${K?"rgba(255,255,255,0.12)":V};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${K?"none":`0 0 8px ${V}`}">
      ...
      <div class="duel-score-line duel-score-line-${C}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${u(p,P)} + ${a(p)} liens = <b style="color:#fff">${u(p,P)+a(p)}</b>
      </div>
    </div>`}e.innerHTML=`
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
  </div>`;const _=()=>{const p=(I,B)=>e.querySelectorAll(I).forEach((C,P)=>{setTimeout(()=>{C.style.opacity="1",C.style.transform="translateY(0) scale(1)"},B+P*90)});p(".duel-card-home",150),p(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((I,B)=>{setTimeout(()=>{I.style.opacity="1"},B*70)}),900),setTimeout(()=>{const I=e.querySelector("#vs-label");I&&(I.style.opacity="1",I.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(B=>B.style.opacity="1")},1250),setTimeout(()=>{m("score-home",n,800),m("score-ai",x,800)},1500)};function m(p,I,B){const C=document.getElementById(p);if(!C)return;const P=performance.now(),j=N=>{const V=Math.min(1,(N-P)/B);C.textContent=Math.round(I*(1-Math.pow(1-V,3))),V<1?requestAnimationFrame(j):C.textContent=I};requestAnimationFrame(j)}requestAnimationFrame(_),t.attacker=f?"home":"ai";const c=f?ri():null;f&&(t.boostCard={value:c}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:o.map(p=>({name:p.name,note:Se(p,"MIL"),portrait:He(p),job:p.job,country_code:p.country_code,rarity:p.rarity,clubName:p.clubName,clubLogo:p.clubLogo})),aiPlayers:d.map(p=>({name:p.name,note:Se(p,"MIL"),portrait:He(p),job:p.job,country_code:p.country_code,rarity:p.rarity,clubName:p.clubName,clubLogo:p.clubLogo})),homeTotal:n,aiTotal:x,text:`Duel milieu : ${t.clubName} ${n} – ${x} IA → ${f?t.clubName+" attaque":"IA attaque"}`});const T=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Je(e,t,i),t.attacker==="ai"&&setTimeout(()=>ti(e,t,i),800)};setTimeout(()=>{const p=document.getElementById("score-home"),I=document.getElementById("score-ai"),B=document.getElementById(f?"duel-row-home":"duel-row-ai"),C=document.getElementById(f?"duel-row-ai":"duel-row-home"),P=f?p:I,j=f?I:p;P&&(P.style.fontSize="80px",P.style.color=f?"#FFD700":"#ff6b6b",P.style.animation="duelPulse .5s ease"+(f?", duelGlow 1.5s ease infinite .5s":"")),j&&(j.style.opacity="0.25"),setTimeout(()=>{B&&(B.style.transformOrigin="center",B.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",B.style.zIndex="5"),setTimeout(()=>{var V;const N=document.getElementById("duel-shock");if(N){const K=(V=C||B)==null?void 0:V.getBoundingClientRect(),oe=e.querySelector(".match-screen").getBoundingClientRect();K&&(N.style.top=K.top-oe.top+K.height/2+"px"),N.style.animation="shockwave .5s ease-out forwards"}C&&(C.style.transformOrigin="center",C.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var V;const N=document.getElementById("duel-finale");N&&(N.innerHTML=`
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,N.style.transition="opacity .45s ease",N.style.opacity="1",N.style.pointerEvents="auto",(V=document.getElementById("start-match-btn"))==null||V.addEventListener("click",T))},600)},700)},2800)}function Mo(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
    ...
    <div style="display:flex;align-items:center;gap:4px;${t?"flex-direction:row-reverse":""};background:rgba(255,255,255,0.04);border-radius:8px;padding:5px 8px;border:1px solid rgba(255,255,255,0.07)">
      ...
      ${at(e.inPlayer||{})}
    </div>`}return`<div style="font-size:11px;color:${e.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${e.type==="goal"?700:400};padding:3px 2px">${e.text||""}</div>`}function Je(e,t,i){var P,j,N,V,K,oe,ie,Q,R;const o=t.selected.map(D=>D.cardId),d=t.usedSubIds||[],s=t.homeSubs.filter(D=>!d.includes(D.cardId)),l=Object.values(t.homeTeam).flat().filter(D=>D.used).length>0&&s.length>0&&t.subsUsed<t.maxSubs,u=!["GK","DEF","MIL","ATT"].some(D=>(t.aiTeam[D]||[]).some(re=>!re.used)),a=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(D=>!D.used),n=t.phase==="attack"&&u&&a.length===0?[...t.homeTeam.GK||[],...t.homeTeam.DEF||[]].filter(D=>!D.used).map(D=>D.cardId):[];t.log[t.log.length-1];const x=t.phase==="ai-attack"||t.phase==="ai-defense",f=t.phase==="attack",h=t.phase==="defense",_=t.phase==="finished",c=(t.homeSubs||[]).filter(D=>!(t.usedSubIds||[]).includes(D.cardId)).length>0&&t.subsUsed<t.maxSubs,T=f&&a.length===0&&!c,p=t.gcCards.filter(D=>!t.usedGc.includes(D.id)),I=t.boostCard&&!t.boostUsed;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column",e.innerHTML=`
  <style>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const re=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const D=t.log[t.log.length-1];return D?'<div style="padding:2px 4px">'+Mo(D)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const D=window.innerWidth>=700,re=(O,ee,xe)=>{var q,$;const le=(t.gcDefs||[]).find(g=>g.name===O.gc_type),ge={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[le==null?void 0:le.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ne={purple:"#b06ce0",light_blue:"#00d4ef"}[le==null?void 0:le.color]||"#b06ce0",ue=(le==null?void 0:le.name)||O.gc_type,Le=(le==null?void 0:le.effect)||((q=Oe[O.gc_type])==null?void 0:q.desc)||"",Ie=le!=null&&le.image_url?`/icons/${le.image_url}`:null,Ce=(($=Oe[O.gc_type])==null?void 0:$.icon)||"⚡",Te=Math.round(xe*.22),qe=Math.round(xe*.22),Pe=xe-Te-qe,ze=ue.length>12?7:9;return`<div class="gc-mini" data-gc-id="${O.id}" data-gc-type="${O.gc_type}"
          style="box-sizing:border-box;width:${ee}px;height:${xe}px;border-radius:10px;border:2px solid ${ne};background:${ge};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          ...
          </div>`},_e=(O,ee)=>ee?me(130,175):re(O,130,175),ve=(O,ee)=>ee?me(68,95):re(O,68,95),we=D?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Ee=_?`<button id="btn-results" style="${we};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:x?`<div style="${we};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:T?`<button id="btn-pass" style="${we};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:f?`<button id="btn-action" style="${we};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:h?`<button id="btn-action" style="${we};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${we};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,se=f||h?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",pe=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${D?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(D=>{var re,me,_e;if(D.type==="duel"){const ve=D.isGoal,we=D.homeScored?"#FFD700":ve?"#ff6b6b":"rgba(255,255,255,0.3)",Ee=D.homeScored?"⚽ BUT !":ve?"⚽ BUT IA !":(re=D.homePlayers)!=null&&re.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${ve?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${we};margin-bottom:4px">
                <div style="font-size:9px;color:${we};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${Ee}</div>
                ${(me=D.homePlayers)!=null&&me.length?`<div style="margin-bottom:3px">${it(D.homePlayers,"rgba(255,255,255,0.7)",D.homeTotal)}</div>`:""}
  ...
  `,document.body.appendChild(o);let n=!1;const x=()=>{n||(n=!0,o.remove(),i())};o.addEventListener("click",x),setTimeout(x,2e3)}function qt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function fi(e,t,i,o=null,d=null){var h,_;if(t.phase!=="attack"){qt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){qt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const s=Object.entries(t.homeTeam).flatMap(([m,c])=>(c||[]).filter(T=>T.used).map(T=>({...T,_line:T._line||m}))),r=t.homeSubs.filter(m=>!t.usedSubIds.includes(m.cardId));if(!s.length){qt("Aucun joueur utilisé à remplacer");return}if(!r.length){qt("Aucun remplaçant disponible");return}let l=Math.max(0,s.findIndex(m=>m.cardId===d));const u=((h=s[l])==null?void 0:h._line)||((_=s[l])==null?void 0:_.job);let a=o?Math.max(0,r.findIndex(m=>m.cardId===o)):Math.max(0,r.findIndex(m=>m.job===u)),n=!1;const x=document.createElement("div");x.id="sub-overlay",x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function f(){var C,P,j,N,V,K;const m=s[l],c=r[a],T=Math.min(130,Math.round((window.innerWidth-90)/2)),p=Math.round(T*1.35),I=oe=>`background:rgba(255,255,255,0.12);border:none;color:${oe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${oe?"default":"pointer"};flex-shrink:0`;x.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${m?Xe({...m,used:!1,boost:0},T,p):"<div>—</div>"}</div>
    ...
    </div>`,(C=x.querySelector("#sub-close"))==null||C.addEventListener("click",()=>x.remove()),(P=x.querySelector("#out-up"))==null||P.addEventListener("click",()=>{l>0&&(l--,f())}),(j=x.querySelector("#out-down"))==null||j.addEventListener("click",()=>{l<s.length-1&&(l++,f())}),(N=x.querySelector("#in-up"))==null||N.addEventListener("click",()=>{a>0&&(a--,f())}),(V=x.querySelector("#in-down"))==null||V.addEventListener("click",()=>{a<r.length-1&&(a++,f())});const B=(oe,ie,Q,R)=>{const D=x.querySelector("#"+oe);if(!D)return;let re=0;D.addEventListener("touchstart",me=>{re=me.touches[0].clientY},{passive:!0}),D.addEventListener("touchend",me=>{const _e=me.changedTouches[0].clientY-re;if(Math.abs(_e)<30)return;const ve=ie();_e<0&&ve<R-1?(Q(ve+1),f()):_e>0&&ve>0&&(Q(ve-1),f())},{passive:!0})};B("in-panel",()=>a,oe=>a=oe,r.length),B("out-panel",()=>l,oe=>l=oe,s.length),(K=x.querySelector("#sub-confirm"))==null||K.addEventListener("click",oe=>{if(oe.preventDefault(),oe.stopPropagation(),n)return;n=!0;const ie=s[l],Q=r[a];if(!ie||!Q)return;let R=null,D=-1;for(const[me,_e]of Object.entries(t.homeTeam)){const ve=(_e||[]).findIndex(we=>we.cardId===ie.cardId);if(ve!==-1){R=me,D=ve;break}}if(D===-1||!R){qt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),x.remove();return}const re={...Q,_line:R,_col:ie._col||0,used:!1,boost:0};t.homeTeam[R].splice(D,1,re),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(Q.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:ie.name,firstname:ie.firstname,note:Se(ie,R),portrait:He(ie),job:ie.job,country_code:ie.country_code,rarity:ie.rarity,clubName:ie.clubName,clubLogo:ie.clubLogo},inPlayer:{name:Q.name,firstname:Q.firstname,note:Se(Q,R),portrait:He(Q),job:Q.job,country_code:Q.country_code,rarity:Q.rarity,clubName:Q.clubName,clubLogo:Q.clubLogo},text:`🔄 ${Q.firstname} ${Q.name} remplace ${ie.firstname} ${ie.name}`}),x.remove(),Po(ie,Q,()=>Je(e,t,i))})}document.body.appendChild(x),f()}function Go(e,t,i,o,d){var _,m;const s=(o.gcDefs||[]).find(c=>c.name===t),r=Oe[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[s==null?void 0:s.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",u={purple:"#b06ce0",light_blue:"#00d4ef"}[s==null?void 0:s.color]||"#b06ce0",a=(s==null?void 0:s.name)||t,n=(s==null?void 0:s.effect)||r.desc,x=s!=null&&s.image_url?`/icons/${s.image_url}`:null,f=r.icon||"⚡",h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",h.innerHTML=`
    ...
    <div style="width:190px;border-radius:16px;border:3px solid ${u};background:${l};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${u}66">
      ...
      <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
        ${x?`<img src="${x}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${f}</span>`}
      </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
      ${e.map(x=>{const f=x._line||x.job||"MIL",h={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[f]||"#555",_=Se(x,f)+(x.boost||0),m=l.find(c=>c.cardId===x.cardId);return`<div class="gc-pick-item" data-cid="${x.cardId}"
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const u=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",u),setTimeout(u,3500)}async function Pt(e,t,i){var n,x;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:o}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,r=d?"victoire":s?"nul":"defaite",l=Hn(t.mode,r);t.matchId&&await z.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const u={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};d?u.wins=(o.profile.wins||0)+1:s?u.draws=(o.profile.draws||0)+1:u.losses=(o.profile.losses||0)+1,await z.from("users").update(u).eq("id",o.profile.id),await i.refreshProfile();const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",a.innerHTML=`
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}async function vi(e,t,i=!1){var d,s,r,l;try{const u=(s=(d=t==null?void 0:t.state)==null?void 0:d.profile)==null?void 0:s.id;try{(z.getChannels?z.getChannels():[]).forEach(n=>{const x=n.topic||"";(x.includes("matchmaking")||x.includes("pvp-match")||x.includes("friend-invite"))&&z.removeChannel(n)})}catch(a){console.warn("[Random] cleanup canaux:",a)}u&&await z.rpc("cancel_matchmaking",{p_user_id:u}).catch(()=>{})}catch{}const o=i&&((l=(r=t==null?void 0:t.state)==null?void 0:r.params)==null?void 0:l.rankedData)||null;await si(e,t,"random",({deckId:u,formation:a,starters:n,subsRaw:x,gcCardsEnriched:f,gcDefs:h,stadiumDef:_})=>{const m=c=>Uo(e,t,u,a,n,x,c,h||[],_,i,o);if(!f.length){m([]);return}ai(e,f,m)})}async function Uo(e,t,i,o,d,s,r=[],l=[],u=null,a=!1,n=null){var P,j;const{state:x,navigate:f,toast:h}=t;let _=!1,m=null;et(e);const c=(n==null?void 0:n.mmr)??((P=x.profile)==null?void 0:P.mmr)??1e3,T=a?Nt(c):null,p=a?"linear-gradient(180deg,#1a0030,#0a1628)":"linear-gradient(180deg,#0a1628,#1a0a2e)",I=a?(T==null?void 0:T.color)||"#D4A017":"#FFD700";e.innerHTML=`
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:24px;background:${p};padding:24px;text-align:center">
      ${a?`<div style="font-size:36px">${(T==null?void 0:T.emoji)||"⚽"}</div>`:""}
      ...
      ${a?`<div style="font-size:13px;color:${(T==null?void 0:T.color)||"#D4A017"}">${(T==null?void 0:T.emoji)||"⚔️"} ${(T==null?void 0:T.label)||"Ranked"}</div>`:""}
      <div id="mm-status" style="font-size:13px;color:rgba(255,255,255,0.5)">Connexion au matchmaking</div>
      <div id="mm-range" style="display:none"></div>
      <button id="mm-cancel" style="margin-top:12px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.25);background:transparent;color:rgba(255,255,255,0.7);font-size:14px;cursor:pointer">Annuler</button>
    </div>
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const B=async(N=!0)=>{_=!0,m&&(z.removeChannel(m),m=null),N&&await z.rpc("cancel_matchmaking",{p_user_id:x.profile.id}).catch(()=>{})};(j=document.getElementById("mm-cancel"))==null||j.addEventListener("click",async()=>{try{await B(!0)}catch{}Ve(e),f("home")});const C=async(N,V,K)=>{if(_)return;_=!0,m&&(z.removeChannel(m),m=null);const oe=document.getElementById("mm-status");oe&&(oe.textContent="Adversaire trouvé !"),await new Promise(ie=>setTimeout(ie,600)),e.isConnected&&gn(e,t,N,K,r,l,a,n,u)};if(a){const N=[{range:50,delay:0},{range:100,delay:15e3},{range:200,delay:3e4},{range:400,delay:45e3},{range:800,delay:6e4}];let V=0,K=!1;const oe=async()=>{if(_||K)return;const{range:ie}=N[V],Q=document.getElementById("mm-range");Q&&(Q.textContent=`Plage MMR : ±${ie}`);const{data:R,error:D}=await z.rpc("try_matchmake_ranked",{p_user_id:x.profile.id,p_deck_id:i,p_mmr:c,p_range:ie});if(console.log("[Ranked] try_matchmake_ranked result:",R,"error:",JSON.stringify(D)),_)return;if(D||!(R!=null&&R.success)){h("Erreur matchmaking ranked","error"),Ve(e),f("home");return}if(R.matched){K=!0,C(R.match_id,R.opponent_id,!1);return}const re=document.getElementById("mm-status");if(re&&(re.textContent="En attente d'un adversaire..."),m||(m=z.channel("matchmaking-"+x.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${x.profile.id}`},me=>{const _e=me.new;_e.status==="matched"&&_e.match_id&&!K&&(K=!0,C(_e.match_id,_e.matched_with,!0))}).subscribe()),V<N.length-1){const me=N[V+1].delay-N[V].delay;V++,setTimeout(()=>{!_&&!K&&oe()},me)}};await oe()}else{const{data:N,error:V}=await z.rpc("try_matchmake",{p_user_id:x.profile.id,p_deck_id:i});if(V||!(N!=null&&N.success)){h("Erreur de matchmaking","error"),Ve(e),f("home");return}if(N.matched){C(N.match_id,N.opponent_id,!1);return}const K=document.getElementById("mm-status");K&&(K.textContent="En attente d'un autre joueur..."),m=z.channel("matchmaking-"+x.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${x.profile.id}`},oe=>{const ie=oe.new;ie.status==="matched"&&ie.match_id&&C(ie.match_id,ie.matched_with,!0)}).subscribe()}}async function Ko(e,t,i){const{state:o,navigate:d,toast:s}=t;try{(z.getChannels?z.getChannels():[]).forEach(a=>{const n=a.topic||"";(n.includes("matchmaking")||n.includes("pvp-match")||n.includes("friend-invite"))&&z.removeChannel(a)})}catch{}const{data:r}=await z.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!r){s("Match introuvable","error"),d("home");return}if(r.status==="finished"){s("Ce match est terminé","info"),d("home");return}const l=r.home_id===o.profile.id;gn(e,t,i,l,[],[])}async function gn(e,t,i,o,d=[],s=[],r=!1,l=null,u=null){const{state:a,navigate:n,toast:x}=t,f=o?"p1":"p2",h=o?"p2":"p1",_=(d||[]).map($=>$.id),m=(d||[]).map($=>({id:$.id,gc_type:$.gc_type,_gcDef:$._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:c}=await z.from("matches").select("*").eq("id",i).single();if(!c){x("Match introuvable","error"),n("home");return}async function T(){var W,te;console.log("[PvP] buildGameState match:",{id:c.id,home_deck_id:c.home_deck_id,away_deck_id:c.away_deck_id,mode:c.mode,is_ranked:c.is_ranked});const[{data:$,error:g},{data:y,error:b},{data:v},{data:w}]=await Promise.all([z.rpc("get_deck_for_match",{p_deck_id:c.home_deck_id}),z.rpc("get_deck_for_match",{p_deck_id:c.away_deck_id}),z.from("users").select("id,pseudo,club_name").eq("id",c.home_id).single(),z.from("users").select("id,pseudo,club_name").eq("id",c.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",g==null?void 0:g.message,"p2:",b==null?void 0:b.message,"p1D:",(W=$==null?void 0:$.starters)==null?void 0:W.length,"p2D:",(te=y==null?void 0:y.starters)==null?void 0:te.length);const k=Z=>{const fe=Number(Z.evolution_bonus)||0;return{cardId:Z.card_id,position:Z.position,id:Z.id,firstname:Z.firstname,name:Z.surname_encoded,country_code:Z.country_code,club_id:Z.club_id,job:Z.job,job2:Z.job2,note_g:(Number(Z.note_g)||0)+(Z.job==="GK"||Z.job2==="GK"&&Number(Z.note_g)>0?fe:0),note_d:(Number(Z.note_d)||0)+(Z.job==="DEF"||Z.job2==="DEF"&&Number(Z.note_d)>0?fe:0),note_m:(Number(Z.note_m)||0)+(Z.job==="MIL"||Z.job2==="MIL"&&Number(Z.note_m)>0?fe:0),note_a:(Number(Z.note_a)||0)+(Z.job==="ATT"||Z.job2==="ATT"&&Number(Z.note_a)>0?fe:0),evolution_bonus:fe,rarity:Z.rarity,skin:Z.skin,hair:Z.hair,hair_length:Z.hair_length,clubName:Z.club_encoded_name||null,clubLogo:Z.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},S=(($==null?void 0:$.starters)||[]).map(Z=>k(Z)),E=((y==null?void 0:y.starters)||[]).map(Z=>k(Z)),L=($==null?void 0:$.formation)||"4-4-2",A=(y==null?void 0:y.formation)||"4-4-2";let M=vt(S,L),F=vt(E,A);const Y=(($==null?void 0:$.subs)||[]).map(Z=>k(Z)),J=((y==null?void 0:y.subs)||[]).map(Z=>k(Z)),U=($==null?void 0:$.stadium_def)||(o?u:null),G=(y==null?void 0:y.stadium_def)||(o?null:u);return U&&(M=Tt(M,U),jt(Y,U)),G&&(F=Tt(F,G),jt(J,G)),{p1Team:M,p2Team:F,p1Subs:Y,p2Subs:J,p1Formation:L,p2Formation:A,p1Name:(v==null?void 0:v.club_name)||(v==null?void 0:v.pseudo)||"Joueur 1",p2Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?_:[],gc_p2:o?[]:_,gcCardsFull_p1:o?m:[],gcCardsFull_p2:o?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let p=c.game_state&&Object.keys(c.game_state).length?c.game_state:null;if(console.log("[PvP] init - amIHome:",o,"gameState exists:",!!p,"match.status:",c.status,"home_id:",c.home_id,"away_id:",c.away_id,"myId:",a.profile.id),!p)if(o){p=await T(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((p==null?void 0:p.p1Team)||{}));const{data:$}=await z.from("matches").select("game_state").eq("id",i).single();!($!=null&&$.game_state)||!Object.keys($.game_state).length?await z.from("matches").update({game_state:p,turn_user_id:c.home_id}).eq("id",i):p=$.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let $=0;$<30&&!p;$++){await new Promise(y=>setTimeout(y,400));const{data:g}=await z.from("matches").select("game_state").eq("id",i).single();g!=null&&g.game_state&&Object.keys(g.game_state).length&&(p=g.game_state),$%5===0&&console.log("[PvP] away - poll",$,"game_state:",!!(g!=null&&g.game_state))}if(!p){x("Erreur de synchronisation","error"),n("home");return}p.gc_p2=_,p.gcCardsFull_p2=m,await z.from("matches").update({game_state:p}).eq("id",i)}let I=!1,B=null,C=!1;const P=new Set,j=new Set;async function N($){var A,M;try{z.removeChannel(V)}catch{}const g=p[f+"Score"]||0,y=p[h+"Score"]||0;let b,v;$.winner_id?(b=$.winner_id===a.profile.id,v=!1):$.forfeit?(b=g>y,v=!1):(v=g===y,b=g>y);let w="";if(r&&o)try{const{data:F}=await z.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.home_id).single(),{data:Y}=await z.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.away_id).single();if(F&&Y){const J=b?1:v?.5:0,U=1-J,G=F.placement_matches<10,W=Y.placement_matches<10,te=Ii(F.mmr,F.mmr_deviation,F.mmr_volatility,Y.mmr,Y.mmr_deviation,J===1?1:J===0?0:.5,G),Z=Ii(Y.mmr,Y.mmr_deviation,Y.mmr_volatility,F.mmr,F.mmr_deviation,U===1?1:U===0?0:.5,W);await z.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:v?null:b?c.home_id:c.away_id,p_home_id:c.home_id,p_away_id:c.away_id,p_home_delta:te.delta,p_away_delta:Z.delta,p_home_new_rd:te.newRd,p_away_new_rd:Z.newRd,p_home_new_vol:te.newSigma,p_away_new_vol:Z.newSigma});const fe=te.delta,ye=te.newMmr,be=Nt(ye),ke=fe>=0?"+":"",Be=fe>=0?"#4caf50":"#ff6b6b",Fe=Nt(F.mmr);w=`
            ...
            </div>`}}catch(F){console.error("[Ranked] MMR update error:",F)}(A=document.getElementById("pvp-end-overlay"))==null||A.remove();const k=document.createElement("div");k.id="pvp-end-overlay",k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const S=v?"🤝":b?"🏆":"😞",E=v?"MATCH NUL":b?"VICTOIRE !":"DÉFAITE",L=v?"#fff":b?"#FFD700":"#ff6b6b";k.innerHTML=`
      ...
      <div style="font-size:18px">${p[f+"Name"]} ${g} – ${y} ${p[h+"Name"]}</div>
      ${$.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${b?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${w}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(k),(M=k.querySelector("#pvp-end-home"))==null||M.addEventListener("click",()=>{k.remove(),Ve(e),n(r?"ranked":"home")})}const V=z.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},$=>{const g=$.new;try{if(g.status==="finished"||g.forfeit){if(I)return;I=!0,B&&(clearInterval(B),B=null),g.game_state&&(p=g.game_state),N(g);return}if(g.game_state){const y=p;p=g.game_state;const b=p._lastGC;if(b&&b.seq&&!j.has(b.seq)&&(j.add(b.seq),b.by!==f)){se(b.type,b.by,()=>me());return}const v=y[f+"Score"]||0,w=y[h+"Score"]||0,k=p[f+"Score"]||0,S=p[h+"Score"]||0,E=k>v,L=S>w;if((E||L)&&!P.has(p.round)){P.add(p.round);const A=[...p.log||[]].reverse().find(F=>F.isGoal),M=((A==null?void 0:A.homePlayers)||[]).map(F=>({name:F.name,note:F.note,portrait:F.portrait,job:F.job}));Ee(M,k,S,E,()=>me());return}me()}}catch(y){console.error("[PvP] crash:",y)}}).subscribe();async function K($){Object.assign(p,$),p.lastActionAt=new Date().toISOString();const{error:g}=await z.from("matches").update({game_state:p}).eq("id",i);g&&x("Erreur de synchronisation","error");try{me()}catch(y){console.error("[PvP] renderPvpScreen crash:",y)}}async function oe(){if(I)return;I=!0,B&&(clearInterval(B),B=null);const $=o?c.away_id:c.home_id,g=o?"p2":"p1",y=o?"p1":"p2",b={...p,[g+"Score"]:3,[y+"Score"]:0,phase:"finished"};try{await z.from("matches").update({status:"finished",forfeit:!0,winner_id:$,home_score:b.p1Score||0,away_score:b.p2Score||0,game_state:b}).eq("id",i)}catch{}try{z.removeChannel(V)}catch{}setTimeout(()=>{Ve(e),n("home")},800)}const ie={BOOST_STAT:({value:$=1,count:g=1,roles:y=[]},b,v)=>{const w=b[f+"Team"],k=Object.entries(w).filter(([S])=>!y.length||y.includes(S)).flatMap(([S,E])=>E.filter(L=>!L.used).map(L=>({...L,_line:S})));if(!k.length){b.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(b);return}Q(k,g,`Choisir ${g} joueur(s) à booster (+${$})`,S=>{S.forEach(E=>{const L=(w[E._line]||[]).find(A=>A.cardId===E.cardId);L&&(L.boost=(L.boost||0)+$,b.log.push({text:`⚡ +${$} sur ${L.name}`,type:"info"}))}),b[f+"Team"]=w,v(b)})},DEBUFF_STAT:({value:$=1,count:g=1,roles:y=[],target:b="ai"},v,w)=>{const k=b==="home"?f:h,S=v[k+"Team"],E=b==="home"?"allié":"adverse",L=Object.entries(S).filter(([A])=>!y.length||y.includes(A)).flatMap(([A,M])=>M.map(F=>({...F,_line:A})));if(!L.length){v.log.push({text:`🎯 Aucun joueur ${E}`,type:"info"}),w(v);return}Q(L,g,`Choisir ${g} joueur(s) ${E}(s) (-${$})`,A=>{A.forEach(M=>{const F=(S[M._line]||[]).find(Y=>Y.cardId===M.cardId);F&&(F.boost=(F.boost||0)-$,v.log.push({text:`🎯 -${$} sur ${F.name}`,type:"info"}))}),v[k+"Team"]=S,w(v)})},GRAY_PLAYER:({count:$=1,roles:g=[],target:y="ai"},b,v)=>{const w=y==="home"?f:h,k=b[w+"Team"],S=y==="home"?"allié":"adverse",E=Object.entries(k).filter(([L])=>!g.length||g.includes(L)).flatMap(([L,A])=>A.filter(M=>!M.used).map(M=>({...M,_line:L})));if(!E.length){b.log.push({text:`❌ Aucun joueur ${S}`,type:"info"}),v(b);return}Q(E,$,`Choisir ${$} joueur(s) ${S}(s) à exclure`,L=>{const A="usedCardIds_"+w,M=new Set(b[A]||[]);L.forEach(F=>{const Y=(k[F._line]||[]).find(J=>J.cardId===F.cardId);Y&&(Y.used=!0,M.add(F.cardId),b.log.push({text:`❌ ${Y.name} exclu !`,type:"info"}))}),b[A]=[...M],b[w+"Team"]=k,v(b)})},REVIVE_PLAYER:({count:$=1,roles:g=[]},y,b)=>{const v=y[f+"Team"],w=Object.entries(v).filter(([k])=>!g.length||g.includes(k)).flatMap(([k,S])=>S.filter(E=>E.used).map(E=>({...E,_line:k})));if(!w.length){y.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),b(y);return}Q(w,$,`Choisir ${$} joueur(s) à ressusciter`,k=>{k.forEach(S=>{const E=(v[S._line]||[]).find(L=>L.cardId===S.cardId);E&&(E.used=!1,y.log.push({text:`💫 ${E.name} ressuscité !`,type:"info"}))}),y[f+"Team"]=v,b(y)})},REMOVE_GOAL:({},$,g)=>{const y=h+"Score";$[y]>0?($[y]--,$.log.push({text:"🚫 Dernier but annulé !",type:"info"})):$.log.push({text:"🚫 Aucun but à annuler",type:"info"}),g($)},ADD_GOAL_DRAW:({},$,g)=>{$[f+"Score"]===$[h+"Score"]?($[f+"Score"]++,$.log.push({text:"🎯 But bonus !",type:"info"})):$.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),g($)},ADD_SUB:({value:$=1},g,y)=>{g.maxSubs=(g.maxSubs||3)+$,g.log.push({text:`🔄 +${$} remplacement(s)`,type:"info"}),y(g)},CUSTOM:({},$,g)=>g($)};function Q($,g,y,b){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let w=[];function k(){var E,L;const S=$.map(A=>{const M={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",F=Se(A,A._line)+(A.boost||0),J=w.find(G=>G.cardId===A.cardId)?"#FFD700":"rgba(255,255,255,0.25)",U=A.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${J};background:${M};overflow:hidden;cursor:pointer;${U}">
        ...
        </div>`,(E=v.querySelector("#pp-close"))==null||E.addEventListener("click",()=>v.remove()),v.querySelectorAll(".pp-item").forEach(A=>{A.addEventListener("click",()=>{const M=A.dataset.cid,F=$.find(J=>J.cardId===M),Y=w.findIndex(J=>J.cardId===M);F&&(Y>-1?w.splice(Y,1):w.length<g&&w.push(F),k())})}),(L=v.querySelector("#pp-confirm"))==null||L.addEventListener("click",()=>{v.remove(),b(w)})}k(),document.body.appendChild(v)}async function R($,g){const b=(p["gcCardsFull_"+f]||[]).find(S=>S.id===$),v=(b==null?void 0:b._gcDef)||(p.gcDefs||[]).find(S=>{var E;return S.name===g||((E=S.name)==null?void 0:E.toLowerCase().trim())===(g==null?void 0:g.toLowerCase().trim())}),w=[...p["usedGc_"+f]||[],$],k={type:g,by:f,seq:(p._gcAnimSeq||0)+1};j.add(k.seq),se(g,f,async()=>{if(v!=null&&v.effect_type&&v.effect_type!=="CUSTOM"){const E=ie[v.effect_type];if(E){const L={...p};E(v.effect_params||{},L,async A=>{A["usedGc_"+f]=w,A._lastGC=k,A._gcAnimSeq=k.seq,await K(A)});return}}const S={...p};switch(g){case"Remplacement+":S.maxSubs=(S.maxSubs||3)+1,S.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const E=h+"Score";S[E]>0&&(S[E]--,S.log.push({text:"🚫 But annulé",type:"info"}));break}}S["usedGc_"+f]=w,S._lastGC=k,S._gcAnimSeq=k.seq,await K(S)})}function D($,g){const y="usedCardIds_"+$,b=new Set(p[y]||[]);g.forEach(v=>b.add(v)),p[y]=[...b]}function re(){for(const $ of["p1","p2"]){const g=new Set(p["usedCardIds_"+$]||[]),y=p[$+"Team"];if(y)for(const b of["GK","DEF","MIL","ATT"])(y[b]||[]).forEach(v=>{v.used=g.has(v.cardId)})}}function me(){var We,nt,pt,ut,ft,ce;if(p.phase==="reveal")return _e();if(p.phase==="midfield")return we();if(p.phase==="finished")return q();const $=p[f+"Team"],g=p[h+"Team"];re();const y=p[f+"Score"],b=p[h+"Score"],v=p[f+"Name"],w=p[h+"Name"],k=p.phase===f+"-attack",S=p.phase===f+"-defense",E=Array.isArray(p["selected_"+f])?p["selected_"+f]:[],L=E.map(X=>X.cardId),A=window.innerWidth>=700,M=p[f+"Subs"]||[],F=p["usedSubIds_"+f]||[],Y=M.filter(X=>!F.includes(X.cardId)),J=p["gcCardsFull_"+f]||[],U=p["usedGc_"+f]||[],G=J.filter(X=>!U.includes(X.id)),W=p.boostOwner===f&&!p.boostUsed,te=!["GK","DEF","MIL","ATT"].some(X=>(g[X]||[]).some(H=>!H.used)),Z=[...$.MIL||[],...$.ATT||[]].filter(X=>!X.used),fe=k&&te&&Z.length===0?[...$.GK||[],...$.DEF||[]].filter(X=>!X.used).map(X=>X.cardId):[];function ye(X,H,ae){var kt,Ct;const he=X._gcDef,$e={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Qe={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",Ze=(he==null?void 0:he.name)||X.gc_type,tt=(he==null?void 0:he.effect)||((kt=Oe[X.gc_type])==null?void 0:kt.desc)||"",rt=he!=null&&he.image_url?`/icons/${he.image_url}`:null,_t=((Ct=Oe[X.gc_type])==null?void 0:Ct.icon)||"⚡",$t=Math.round(ae*.22),dt=Math.round(ae*.22),gt=ae-$t-dt,mt=Ze.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
      ...
      </div>`}const ke=(X,H)=>H?be(130,175):ye(X,130,175),Be=(X,H)=>H?be(68,95):ye(X,68,95),Fe=A?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Me=k?Te(f)?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${E.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Fe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:S?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${E.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${w}</div>`,je=k&&!Te(f)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':k||S?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${E.length}/3 sélectionné(s)</div>`:"",Ae=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${A?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${Y.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':Y.map(X=>`<div class="pvp-sub-btn" data-sub-id="${X.cardId}" style="cursor:pointer;flex-shrink:0">${Xe(X,A?76:44,A?100:58)}</div>`).join("")}
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct($,p[f+"Formation"],Ne,L,300,300,fe)}
      </div>
        ...
        </div>`}return`<div style="font-size:11px;color:${X.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${X.type==="goal"?700:400};padding:3px 2px">${X.text||""}</div>`}const Ke=(()=>{var H,ae;if(S&&((H=p.pendingAttack)!=null&&H.players)){const he=p.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;function Ge(){const X=e.querySelector(".match-screen");if(!X)return;const H=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=H+"px",X.style.minHeight=H+"px",X.style.maxHeight=H+"px",X.style.overflow="hidden";const ae=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");ae&&he&&(he.style.paddingBottom=ae.offsetHeight+"px")}if(Ge(),setTimeout(Ge,120),setTimeout(Ge,400),C||(C=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Ge),window.visualViewport.addEventListener("scroll",Ge)),window.addEventListener("resize",Ge)),function(){const H=e.querySelector(".terrain-wrapper svg");H&&(H.removeAttribute("width"),H.removeAttribute("height"),H.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",H.setAttribute("viewBox","-26 -26 352 352"),H.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!k&&!S)return;const H=X.dataset.cardId,ae=X.dataset.role,he=($[ae]||[]).find(tt=>tt.cardId===H);if(!he||he.used)return;const $e=fe.includes(H);if(k&&!["MIL","ATT"].includes(ae)&&!$e)return;Array.isArray(p["selected_"+f])||(p["selected_"+f]=[]);const Qe=p["selected_"+f],Ze=Qe.findIndex(tt=>tt.cardId===H);Ze>-1?Qe.splice(Ze,1):Qe.length<3&&Qe.push({...he,_role:ae}),me()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>O(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>O())}),(We=e.querySelector("#pvp-sub-open"))==null||We.addEventListener("click",()=>O()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{X.addEventListener("click",()=>pe(X.dataset.gcId,X.dataset.gcType))}),(nt=e.querySelector("#pvp-boost-card"))==null||nt.addEventListener("click",()=>de()),(pt=e.querySelector("#pvp-action"))==null||pt.addEventListener("click",X=>{k?X.currentTarget.dataset.pass==="1"||!Te(f)?ge():ne():S&&ue()}),(ut=e.querySelector("#pvp-quit"))==null||ut.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&oe()}),(ft=e.querySelector("#pvp-view-opp"))==null||ft.addEventListener("click",()=>xe()),(ce=e.querySelector("#pvp-toggle-history"))==null||ce.addEventListener("click",()=>le()),B&&(clearInterval(B),B=null),(k||S)&&!I){let X=30,H=!1;const ae=()=>document.getElementById("pvp-timer"),he=()=>{ae()&&(ae().textContent=X+"s",ae().style.color=H?"#ff4444":"#fff")};he(),B=setInterval(()=>{X--,X<0?H?(clearInterval(B),B=null,k&&!Te(f)?ge():oe()):(H=!0,X=15,he()):he()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${$!=null&&$.length?`<div style="display:flex;gap:10px;animation:scoreIn .4s ease 1s both;position:relative;z-index:1">
        ${$.map(A=>`<div style="text-align:center">
          <div style="width:50px;height:50px;border-radius:50%;background:${S[A.job]||"#555"};border:2px solid #FFD700;position:relative;overflow:hidden;margin:0 auto">
            ${A.portrait?`<img src="${A.portrait}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
          </div>
          <div style="font-size:8px;color:rgba(255,255,255,0.7);margin-top:3px">${(A.name||"").slice(0,8)}</div>
        </div>`).join("")}
      </div>`:""}
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(w);let E=!1;const L=()=>{E||(E=!0,w.remove(),setTimeout(()=>v(),50))};w.addEventListener("click",L),setTimeout(L,3500)}function se($,g,y){var U,G;const b=(p.gcDefs||[]).find(W=>{var te;return W.name===$||((te=W.name)==null?void 0:te.toLowerCase().trim())===($==null?void 0:$.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",k=(b==null?void 0:b.name)||$,S=(b==null?void 0:b.effect)||((U=Oe[$])==null?void 0:U.desc)||"",E=b!=null&&b.image_url?`/icons/${b.image_url}`:null,L=((G=Oe[$])==null?void 0:G.icon)||"⚡",M=g===f?"Vous":p[g+"Name"]||"Adversaire",F=document.createElement("div");F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",F.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(F);let Y=!1;const J=()=>{Y||(Y=!0,F.remove(),setTimeout(()=>y&&y(),50))};F.addEventListener("click",J),setTimeout(J,3e3)}function pe($,g){var F,Y,J,U;const b=(p["gcCardsFull_"+f]||[]).find(G=>G.id===$),v=b==null?void 0:b._gcDef,w={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",k={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",S=(v==null?void 0:v.name)||g,E=(v==null?void 0:v.effect)||((F=Oe[g])==null?void 0:F.desc)||"Carte spéciale.",L=v!=null&&v.image_url?`/icons/${v.image_url}`:null,A=((Y=Oe[g])==null?void 0:Y.icon)||"⚡",M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",M.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${k};background:${w};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${k}66">
        ...
        <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${L?`<img src="${L}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${A}</span>`}
        </div>
        <div style="padding:10px;background:rgba(0,0,0,0.38);text-align:center">
      ...
      </div>`,document.body.appendChild(y),(b=y.querySelector("#bp-close"))==null||b.addEventListener("click",()=>y.remove()),y.querySelectorAll(".bp-item").forEach(v=>{v.addEventListener("click",async()=>{const w=v.dataset.cid,k=g.find(E=>E.cardId===w);if(!k)return;const S=($[k._line]||[]).find(E=>E.cardId===w);S&&(S.boost=(S.boost||0)+p.boostValue),y.remove(),await K({[f+"Team"]:$,boostUsed:!0})})})}function O($=null){var Y,J;if(!(p.phase===f+"-attack")){x("Remplacement uniquement avant votre attaque","warning");return}const y=p[f+"Team"],b=p["usedSubIds_"+f]||[],v=p.maxSubs||3;if(b.length>=v){x(`Maximum ${v} remplacements atteint`,"warning");return}const w=Object.entries(y).flatMap(([U,G])=>(G||[]).filter(W=>W.used).map(W=>({...W,_line:U}))),k=(p[f+"Subs"]||[]).filter(U=>!b.includes(U.cardId));if(!w.length){x("Aucun joueur utilisé à remplacer","warning");return}if(!k.length){x("Aucun remplaçant disponible","warning");return}let S=Math.max(0,w.findIndex(U=>U.cardId===$));const E=((Y=w[S])==null?void 0:Y._line)||((J=w[S])==null?void 0:J.job);let L=Math.max(0,k.findIndex(U=>U.job===E)),A=!1;const M=document.createElement("div");M.id="pvp-sub-overlay",M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function F(){var ye,be,ke,Be,Fe,Me;const U=w[S],G=k[L],W=Math.min(130,Math.round((window.innerWidth-90)/2)),te=Math.round(W*1.35),Z=je=>`background:rgba(255,255,255,0.12);border:none;color:${je?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${je?"default":"pointer"};flex-shrink:0`;M.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(ye=M.querySelector("#psub-close"))==null||ye.addEventListener("click",()=>M.remove()),(be=M.querySelector("#pout-up"))==null||be.addEventListener("click",()=>{S>0&&(S--,F())}),(ke=M.querySelector("#pout-down"))==null||ke.addEventListener("click",()=>{S<w.length-1&&(S++,F())}),(Be=M.querySelector("#pin-up"))==null||Be.addEventListener("click",()=>{L>0&&(L--,F())}),(Fe=M.querySelector("#pin-down"))==null||Fe.addEventListener("click",()=>{L<k.length-1&&(L++,F())});const fe=(je,Ae,Ne,Ue)=>{const Ye=M.querySelector("#"+je);if(!Ye)return;let Ke=0;Ye.addEventListener("touchstart",Re=>{Ke=Re.touches[0].clientY},{passive:!0}),Ye.addEventListener("touchend",Re=>{const Ge=Re.changedTouches[0].clientY-Ke;if(Math.abs(Ge)<30)return;const We=Ae();Ge<0&&We<Ue-1?(Ne(We+1),F()):Ge>0&&We>0&&(Ne(We-1),F())},{passive:!0})};fe("pin-panel",()=>L,je=>L=je,k.length),fe("pout-panel",()=>S,je=>S=je,w.length),(Me=M.querySelector("#psub-confirm"))==null||Me.addEventListener("click",async je=>{if(je.preventDefault(),je.stopPropagation(),A)return;A=!0;const Ae=w[S],Ne=k[L];if(!Ae||!Ne)return;const Ue=Ae._line,Ye=(y[Ue]||[]).findIndex(Ge=>Ge.cardId===Ae.cardId);if(Ye===-1){x("Erreur : joueur introuvable","error"),M.remove();return}const Ke={...Ne,_line:Ue,position:Ae.position,used:!1,boost:0};y[Ue].splice(Ye,1,Ke);const Re=[...b,Ne.cardId];M.remove(),ee(Ae,Ne,async()=>{await K({[f+"Team"]:y,[h+"Team"]:p[h+"Team"],["usedSubIds_"+f]:Re})})})}document.body.appendChild(M),F()}function ee($,g,y){const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const w=(E,L,A)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${L};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${A}</div>
      ...
      </div>`,document.body.appendChild(g),(y=g.querySelector("#pvp-hist-close"))==null||y.addEventListener("click",()=>g.remove())}async function ge(){if(p.phase!==f+"-attack")return;const $=f==="p1"?"p2":"p1",g=(p.round||0)+1,y=[...p.log||[]];y.push({type:"info",text:`⏭️ ${p[f+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const b=qe(p),v=Te($),w=b||!v?"finished":$+"-attack";await K({["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:w,attacker:$,round:g,log:y}),w==="finished"&&await ze(p)}async function ne(){const $=p[f+"Team"],g=!["GK","DEF","MIL","ATT"].some(w=>(p[h+"Team"][w]||[]).some(k=>!k.used)),y=(p["selected_"+f]||[]).map(w=>{const k=($[w._role]||[]).find(F=>F.cardId===w.cardId)||w,S=g&&["GK","DEF"].includes(w._role),E=$[w._role]||[],L=E.findIndex(F=>F.cardId===w.cardId),A=st(E.length),M=L>=0?A[L]:k._col??1;return{...k,_line:w._role,_col:M,...S?{note_a:Math.max(1,Number(k.note_a)||0)}:{}}});if(!y.length)return;const b=Kt(y,p.modifiers[f]||{});D(f,y.map(w=>w.cardId)),y.forEach(w=>{const k=($[w._role]||[]).find(S=>S.cardId===w.cardId);k&&(k.used=!0)}),p["selected_"+f]=[],me();const v=[...p.log||[]];if(g){const w=(p[f+"Score"]||0)+1,k=y.map(M=>({name:M.name,note:Se(M,M._line||"ATT"),portrait:He(M),job:M.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:k,homeTotal:b.total,aiTotal:0});const S=(p.round||0)+1,E=f==="p1"?"p2":"p1",L={...p,[f+"Team"]:$,[f+"Score"]:w},A=qe(L);P.add(S),Ee(k,w,p[h+"Score"]||0,!0,async()=>{await K({[f+"Team"]:$,[f+"Score"]:w,["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:A?"finished":E+"-attack",attacker:E,round:S,log:v}),A&&await ze({...p,[f+"Score"]:w})});return}v.push({type:"pending",text:`⚔️ ${p[f+"Name"]} attaque (${b.total})`}),await K({[f+"Team"]:$,[h+"Team"]:p[h+"Team"],pendingAttack:{...b,players:y,side:f},["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},phase:h+"-defense",log:v})}async function ue(){const $=p[f+"Team"],g=(p["selected_"+f]||[]).map(U=>{const G=($[U._role]||[]).find(ye=>ye.cardId===U.cardId)||U,W=$[U._role]||[],te=W.findIndex(ye=>ye.cardId===U.cardId),Z=st(W.length),fe=te>=0?Z[te]:G._col??1;return{...G,_line:U._role,_col:fe}}),y=Vt(g,p.modifiers[f]||{});D(f,g.map(U=>U.cardId)),g.forEach(U=>{const G=($[U._role]||[]).find(W=>W.cardId===U.cardId);G&&(G.used=!0)}),p["selected_"+f]=[],me();const b=Yt(p.pendingAttack.total,y.total,p.modifiers[f]||{}),v=p.pendingAttack.side,w=b==="attack"||(b==null?void 0:b.goal),k=v==="p1"?"p2":"p1",S=(p.round||0)+1,E=(p.pendingAttack.players||[]).map(U=>({name:U.name,note:Se(U,U._line||"ATT"),portrait:He(U),job:U.job})),L=[...p.log||[]];L.push({type:"duel",isGoal:w,homeScored:w&&v===f,text:w?`⚽ BUT de ${p[v+"Name"]} ! (${p.pendingAttack.total} vs ${y.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${y.total})`,homePlayers:E,aiPlayers:g.map(U=>({name:U.name,note:Se(U,U._line||"DEF"),portrait:He(U),job:U.job})),homeTotal:p.pendingAttack.total,aiTotal:y.total});const A=w?(p[v+"Score"]||0)+1:p[v+"Score"]||0,M={...p,[f+"Team"]:$,[v+"Score"]:A},F=qe(M),Y=F?"finished":k+"-attack",J=async()=>{await K({[f+"Team"]:$,[h+"Team"]:p[h+"Team"],[v+"Score"]:A,["selected_"+f]:[],modifiers:{...p.modifiers,[f]:{}},pendingAttack:null,phase:Y,attacker:k,round:S,log:L}),(Y==="finished"||F)&&await ze({...p,[v+"Score"]:A})};if(w){const U=v===f,G=U?A:p[f+"Score"]||0,W=U?p[h+"Score"]||0:A;P.add(S),Ee(E,G,W,U,J)}else await J()}function Le($){return["MIL","ATT"].some(g=>($[g]||[]).some(y=>!y.used))}function Ie($){return["GK","DEF","MIL","ATT"].some(g=>($[g]||[]).some(y=>!y.used))}function Ce($){return Ie($)&&!Le($)}function Te($){const g=p[$+"Team"],y=p[($==="p1"?"p2":"p1")+"Team"];return!!(Le(g)||!Ie(y)&&Ce(g))}function qe($){const g=["MIL","ATT"].some(L=>($.p1Team[L]||[]).some(A=>!A.used)),y=["MIL","ATT"].some(L=>($.p2Team[L]||[]).some(A=>!A.used)),b=Ie($.p1Team),v=Ie($.p2Team);return!g&&!(!v&&b)&&(!y&&!(!b&&v))}function Pe($){const g=$.p1Score||0,y=$.p2Score||0;return g===y?null:g>y?c.home_id:c.away_id}async function ze($){try{const g=Pe($),y=g?c.home_id===g?c.away_id:c.home_id:null;await z.from("matches").update({status:"finished",winner_id:g,home_score:$.p1Score||0,away_score:$.p2Score||0}).eq("id",i),g&&y&&updateEvolutiveCards(g,y).catch(()=>{})}catch(g){console.error("[PvP] finishMatch:",g)}}function q(){var v;const $=p[f+"Score"],g=p[h+"Score"],y=$>g,b=$===g;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(v=document.getElementById("pvp-home"))==null||v.addEventListener("click",()=>{try{z.removeChannel(V)}catch{}Ve(e),n("home")})}me()}const Vo=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:vi,resumePvpMatch:Ko},Symbol.toStringTag,{value:"Module"}));async function Yo(e,t,i,o){var d,s;try{const r=(s=(d=t==null?void 0:t.state)==null?void 0:d.profile)==null?void 0:s.id;try{(z.getChannels?z.getChannels():[]).forEach(u=>{const a=u.topic||"";(a.includes("matchmaking")||a.includes("pvp-match"))&&z.removeChannel(u)})}catch(l){console.warn("[FriendMatch] cleanup canaux:",l)}r&&(await z.rpc("cancel_matchmaking",{p_user_id:r}).catch(()=>{}),await z.from("matchmaking_queue").delete().eq("user_id",r).then(()=>{},()=>{}))}catch{}await si(e,t,"random",({deckId:r,formation:l,starters:u,subsRaw:a,gcCardsEnriched:n,gcDefs:x,stadiumDef:f})=>{const h=_=>Wo(e,t,r,l,u,a,_,x||[],i,o);if(!n.length){h([]);return}ai(e,n,h)})}async function Wo(e,t,i,o,d,s,r=[],l=[],u,a){var V;const{state:n,navigate:x,toast:f}=t,h=n.profile.id;let _=!1,m=null;et(e);try{await z.rpc("cancel_matchmaking",{p_user_id:h})}catch{}try{await z.from("matchmaking_queue").delete().eq("user_id",h)}catch{}const c=(K,oe,ie,Q)=>{var R;e.innerHTML=`
      ...
      </div>`,(R=document.getElementById("lobby-cancel"))==null||R.addEventListener("click",async()=>{_=!0,m&&(z.removeChannel(m),m=null),ie&&await z.from("friend_match_invites").update({status:"declined"}).eq("id",ie),Ve(e),x("home")})},T=async(K,oe)=>{_=!0,m&&(z.removeChannel(m),m=null),await new Promise(ie=>setTimeout(ie,600)),e.isConnected&&Jo(e,t,K,oe,r,l)},{data:p}=await z.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${h},invitee_id.eq.${u}),and(inviter_id.eq.${u},invitee_id.eq.${h})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let I,B;if(p&&p.inviter_id===u)B=!1,I=p.id,await z.from("friend_match_invites").update({invitee_deck_id:i,invitee_ready:!0,status:"accepted"}).eq("id",I);else{B=!0;const{data:K,error:oe}=await z.from("friend_match_invites").insert({inviter_id:h,invitee_id:u,friend_id:u,inviter_deck_id:i,inviter_ready:!0,status:"pending"}).select().single();if(oe||!K){f("Erreur création invitation","error"),Ve(e),x("home");return}I=K.id}if(c(!0,!B,I),!B){const K={home_id:u,away_id:h,home_deck_id:p.inviter_deck_id,away_deck_id:i,status:"active",mode:"friend"},oe=await z.from("matches").insert(K).select().single(),ie=oe.data;if(!ie){f("Erreur création match: "+(((V=oe.error)==null?void 0:V.message)||""),"error"),Ve(e),x("home");return}await z.from("friend_match_invites").update({match_id:ie.id,status:"matched"}).eq("id",I),T(ie.id,!1);return}let C=!1;const P=K=>{_||C||(K.status==="matched"&&K.match_id?(C=!0,clearInterval(j),clearInterval(N),T(K.match_id,!0)):K.status==="declined"?(clearInterval(j),clearInterval(N),f(`${a} a décliné l'invitation`,"warning"),Ve(e),x("home")):K.invitee_ready&&c(!0,!0,I))},j=setInterval(()=>{if(_){clearInterval(j);return}z.from("matchmaking_queue").delete().eq("user_id",h).then(()=>{},()=>{})},3e3),N=setInterval(async()=>{if(_||C){clearInterval(N);return}const{data:K}=await z.from("friend_match_invites").select("*").eq("id",I).maybeSingle();K&&P(K)},1200);m=z.channel("friend-invite-"+I).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${I}`},K=>P(K.new)).subscribe()}async function Jo(e,t,i,o,d=[],s=[]){const{state:r,navigate:l,toast:u}=t,a=o?"p1":"p2",n=o?"p2":"p1",x=(d||[]).map(q=>q.id),f=(d||[]).map(q=>({id:q.id,gc_type:q.gc_type,_gcDef:q._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await z.from("matches").select("*").eq("id",i).single();if(!h){u("Match introuvable","error"),l("home");return}async function _(){const[{data:q},{data:$},{data:g},{data:y}]=await Promise.all([z.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),z.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),z.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),z.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]),b=E=>{const L=Number(E.evolution_bonus)||0;return{cardId:E.card_id,position:E.position,id:E.id,firstname:E.firstname,name:E.surname_encoded,country_code:E.country_code,club_id:E.club_id,job:E.job,job2:E.job2,note_g:(Number(E.note_g)||0)+(E.job==="GK"||E.job2==="GK"&&Number(E.note_g)>0?L:0),note_d:(Number(E.note_d)||0)+(E.job==="DEF"||E.job2==="DEF"&&Number(E.note_d)>0?L:0),note_m:(Number(E.note_m)||0)+(E.job==="MIL"||E.job2==="MIL"&&Number(E.note_m)>0?L:0),note_a:(Number(E.note_a)||0)+(E.job==="ATT"||E.job2==="ATT"&&Number(E.note_a)>0?L:0),evolution_bonus:L,rarity:E.rarity,skin:E.skin,hair:E.hair,hair_length:E.hair_length,clubName:E.club_encoded_name||null,clubLogo:E.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},v=((q==null?void 0:q.starters)||[]).map(E=>b(E)),w=(($==null?void 0:$.starters)||[]).map(E=>b(E)),k=(q==null?void 0:q.formation)||"4-4-2",S=($==null?void 0:$.formation)||"4-4-2";return{p1Team:(()=>{const E=vt(v,k);return stadiumDef?Tt(E,stadiumDef):E})(),p2Team:vt(w,S),p1Subs:(()=>{const E=((q==null?void 0:q.subs)||[]).map(L=>b(L));return stadiumDef&&jt(E,stadiumDef),E})(),p2Subs:(($==null?void 0:$.subs)||[]).map(E=>b(E)),p1Formation:k,p2Formation:S,p1Name:(g==null?void 0:g.club_name)||(g==null?void 0:g.pseudo)||"Joueur 1",p2Name:(y==null?void 0:y.club_name)||(y==null?void 0:y.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?x:[],gc_p2:o?[]:x,gcCardsFull_p1:o?f:[],gcCardsFull_p2:o?[]:f,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let m=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(!m)if(o){m=await _();const{data:q}=await z.from("matches").select("game_state").eq("id",i).single();!(q!=null&&q.game_state)||!Object.keys(q.game_state).length?await z.from("matches").update({game_state:m,turn_user_id:h.home_id}).eq("id",i):m=q.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let q=0;q<60&&!m;q++){await new Promise(g=>setTimeout(g,400));const{data:$}=await z.from("matches").select("game_state").eq("id",i).single();$!=null&&$.game_state&&Object.keys($.game_state).length&&(m=$.game_state)}if(!m){u("Erreur de synchronisation","error"),l("home");return}m.gc_p2=x,m.gcCardsFull_p2=f,await z.from("matches").update({game_state:m}).eq("id",i)}let c=!1,T=!1,p=!1,I=null,B=!1;const C=new Set,P=new Set;function j(q){var E,L;try{z.removeChannel(N)}catch{}const $=m[a+"Score"]||0,g=m[n+"Score"]||0;if(!p){p=!0;const A=q.winner_id||($>g?r.profile.id:g>$?"opp":null),M=A===r.profile.id?"win":A?"loss":null;M&&oi(()=>Promise.resolve().then(()=>on),void 0).then(F=>F.applyOwnEvolution(r.profile.id,M)).catch(()=>{})}if(!T){const A=m.p1Score||0,M=m.p2Score||0,F=(m.usedGc_p1||[]).length,Y=(m.usedGc_p2||[]).length,J=q.winner_id||(A>M?h.home_id:M>A?h.away_id:null);(J?r.profile.id===J:r.profile.id<(o?h.away_id:h.home_id))&&(T=!0,Ji({player1Id:h.home_id,player2Id:h.away_id,score1:A,score2:M,gc1:F,gc2:Y}).catch(G=>console.warn("[FriendMatch] updateStats:",G)))}let y,b;q.winner_id?(y=q.winner_id===r.profile.id,b=!1):q.forfeit?(y=$>g,b=!1):(b=$===g,y=$>g),(E=document.getElementById("pvp-end-overlay"))==null||E.remove();const v=document.createElement("div");v.id="pvp-end-overlay",v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const w=b?"🤝":y?"🏆":"😞",k=b?"MATCH NUL":y?"VICTOIRE !":"DÉFAITE",S=b?"#fff":y?"#FFD700":"#ff6b6b";v.innerHTML=`
      <div style="font-size:64px">${w}</div>
      <div style="font-size:26px;font-weight:900;color:${S}">${k}</div>
      <div style="font-size:18px">${m[a+"Name"]} ${$} – ${g} ${m[n+"Name"]}</div>
      ${q.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${y?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(L=v.querySelector("#pvp-end-home"))==null||L.addEventListener("click",()=>{v.remove(),Ve(e),l("home")})}const N=z.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},q=>{const $=q.new;try{if($.status==="finished"||$.forfeit){if(c)return;c=!0,I&&(clearInterval(I),I=null),$.game_state&&(m=$.game_state),j($);return}if($.game_state){const g=m;m=$.game_state;const y=m._lastGC;if(y&&y.seq&&!P.has(y.seq)&&(P.add(y.seq),y.by!==a)){Ee(y.type,y.by,()=>re());return}const b=g[a+"Score"]||0,v=g[n+"Score"]||0,w=m[a+"Score"]||0,k=m[n+"Score"]||0,S=w>b,E=k>v;if((S||E)&&!C.has(m.round)){C.add(m.round);const L=[...m.log||[]].reverse().find(M=>M.isGoal),A=((L==null?void 0:L.homePlayers)||[]).map(M=>({name:M.name,note:M.note,portrait:M.portrait,job:M.job}));we(A,w,k,S,()=>re());return}re()}}catch(g){console.error("[PvP] crash:",g)}}).subscribe();async function V(q){Object.assign(m,q),m.lastActionAt=new Date().toISOString();const{error:$}=await z.from("matches").update({game_state:m}).eq("id",i);$&&u("Erreur de synchronisation","error");try{re()}catch(g){console.error("[PvP] renderPvpScreen crash:",g)}}async function K(){if(c)return;c=!0,I&&(clearInterval(I),I=null);const q=o?h.away_id:h.home_id,$=o?"p2":"p1",g=o?"p1":"p2",y={...m,[$+"Score"]:3,[g+"Score"]:0,phase:"finished"};try{await z.from("matches").update({status:"finished",forfeit:!0,winner_id:q,home_score:y.p1Score||0,away_score:y.p2Score||0,game_state:y}).eq("id",i)}catch{}try{z.removeChannel(N)}catch{}setTimeout(()=>{Ve(e),l("home")},800)}const oe={BOOST_STAT:({value:q=1,count:$=1,roles:g=[]},y,b)=>{const v=y[a+"Team"],w=Object.entries(v).filter(([k])=>!g.length||g.includes(k)).flatMap(([k,S])=>S.filter(E=>!E.used).map(E=>({...E,_line:k})));if(!w.length){y.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),b(y);return}ie(w,$,`Choisir ${$} joueur(s) à booster (+${q})`,k=>{k.forEach(S=>{const E=(v[S._line]||[]).find(L=>L.cardId===S.cardId);E&&(E.boost=(E.boost||0)+q,y.log.push({text:`⚡ +${q} sur ${E.name}`,type:"info"}))}),y[a+"Team"]=v,b(y)})},DEBUFF_STAT:({value:q=1,count:$=1,roles:g=[],target:y="ai"},b,v)=>{const w=y==="home"?a:n,k=b[w+"Team"],S=y==="home"?"allié":"adverse",E=Object.entries(k).filter(([L])=>!g.length||g.includes(L)).flatMap(([L,A])=>A.map(M=>({...M,_line:L})));if(!E.length){b.log.push({text:`🎯 Aucun joueur ${S}`,type:"info"}),v(b);return}ie(E,$,`Choisir ${$} joueur(s) ${S}(s) (-${q})`,L=>{L.forEach(A=>{const M=(k[A._line]||[]).find(F=>F.cardId===A.cardId);M&&(M.boost=(M.boost||0)-q,b.log.push({text:`🎯 -${q} sur ${M.name}`,type:"info"}))}),b[w+"Team"]=k,v(b)})},GRAY_PLAYER:({count:q=1,roles:$=[],target:g="ai"},y,b)=>{const v=g==="home"?a:n,w=y[v+"Team"],k=g==="home"?"allié":"adverse",S=Object.entries(w).filter(([E])=>!$.length||$.includes(E)).flatMap(([E,L])=>L.filter(A=>!A.used).map(A=>({...A,_line:E})));if(!S.length){y.log.push({text:`❌ Aucun joueur ${k}`,type:"info"}),b(y);return}ie(S,q,`Choisir ${q} joueur(s) ${k}(s) à exclure`,E=>{const L="usedCardIds_"+v,A=new Set(y[L]||[]);E.forEach(M=>{const F=(w[M._line]||[]).find(Y=>Y.cardId===M.cardId);F&&(F.used=!0,A.add(M.cardId),y.log.push({text:`❌ ${F.name} exclu !`,type:"info"}))}),y[L]=[...A],y[v+"Team"]=w,b(y)})},REVIVE_PLAYER:({count:q=1,roles:$=[]},g,y)=>{const b=g[a+"Team"],v=Object.entries(b).filter(([w])=>!$.length||$.includes(w)).flatMap(([w,k])=>k.filter(S=>S.used).map(S=>({...S,_line:w})));if(!v.length){g.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),y(g);return}ie(v,q,`Choisir ${q} joueur(s) à ressusciter`,w=>{w.forEach(k=>{const S=(b[k._line]||[]).find(E=>E.cardId===k.cardId);S&&(S.used=!1,g.log.push({text:`💫 ${S.name} ressuscité !`,type:"info"}))}),g[a+"Team"]=b,y(g)})},REMOVE_GOAL:({},q,$)=>{const g=n+"Score";q[g]>0?(q[g]--,q.log.push({text:"🚫 Dernier but annulé !",type:"info"})):q.log.push({text:"🚫 Aucun but à annuler",type:"info"}),$(q)},ADD_GOAL_DRAW:({},q,$)=>{q[a+"Score"]===q[n+"Score"]?(q[a+"Score"]++,q.log.push({text:"🎯 But bonus !",type:"info"})):q.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),$(q)},ADD_SUB:({value:q=1},$,g)=>{$.maxSubs=($.maxSubs||3)+q,$.log.push({text:`🔄 +${q} remplacement(s)`,type:"info"}),g($)},CUSTOM:({},q,$)=>$(q)};function ie(q,$,g,y){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var S,E;const k=q.map(L=>{const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",M=Se(L,L._line)+(L.boost||0),Y=v.find(U=>U.cardId===L.cardId)?"#FFD700":"rgba(255,255,255,0.25)",J=L.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Y};background:${A};overflow:hidden;cursor:pointer;${J}">
        ...
        </div>`,(S=b.querySelector("#pp-close"))==null||S.addEventListener("click",()=>b.remove()),b.querySelectorAll(".pp-item").forEach(L=>{L.addEventListener("click",()=>{const A=L.dataset.cid,M=q.find(Y=>Y.cardId===A),F=v.findIndex(Y=>Y.cardId===A);M&&(F>-1?v.splice(F,1):v.length<$&&v.push(M),w())})}),(E=b.querySelector("#pp-confirm"))==null||E.addEventListener("click",()=>{b.remove(),y(v)})}w(),document.body.appendChild(b)}async function Q(q,$){const y=(m["gcCardsFull_"+a]||[]).find(k=>k.id===q),b=(y==null?void 0:y._gcDef)||(m.gcDefs||[]).find(k=>{var S;return k.name===$||((S=k.name)==null?void 0:S.toLowerCase().trim())===($==null?void 0:$.toLowerCase().trim())}),v=[...m["usedGc_"+a]||[],q],w={type:$,by:a,seq:(m._gcAnimSeq||0)+1};P.add(w.seq),Ee($,a,async()=>{if(b!=null&&b.effect_type&&b.effect_type!=="CUSTOM"){const S=oe[b.effect_type];if(S){const E={...m};S(b.effect_params||{},E,async L=>{L["usedGc_"+a]=v,L._lastGC=w,L._gcAnimSeq=w.seq,await V(L)});return}}const k={...m};switch($){case"Remplacement+":k.maxSubs=(k.maxSubs||3)+1,k.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const S=n+"Score";k[S]>0&&(k[S]--,k.log.push({text:"🚫 But annulé",type:"info"}));break}}k["usedGc_"+a]=v,k._lastGC=w,k._gcAnimSeq=w.seq,await V(k)})}function R(q,$){const g="usedCardIds_"+q,y=new Set(m[g]||[]);$.forEach(b=>y.add(b)),m[g]=[...y]}function D(){for(const q of["p1","p2"]){const $=new Set(m["usedCardIds_"+q]||[]),g=m[q+"Team"];if(g)for(const y of["GK","DEF","MIL","ATT"])(g[y]||[]).forEach(b=>{b.used=$.has(b.cardId)})}}function re(){var Ge,We,nt,pt,ut,ft;if(m.phase==="reveal")return me();if(m.phase==="midfield")return ve();if(m.phase==="finished")return ze();const q=m[a+"Team"],$=m[n+"Team"];D();const g=m[a+"Score"],y=m[n+"Score"],b=m[a+"Name"],v=m[n+"Name"],w=m.phase===a+"-attack",k=m.phase===a+"-defense",S=Array.isArray(m["selected_"+a])?m["selected_"+a]:[],E=S.map(ce=>ce.cardId),L=window.innerWidth>=700,A=m[a+"Subs"]||[],M=m["usedSubIds_"+a]||[],F=A.filter(ce=>!M.includes(ce.cardId)),Y=m["gcCardsFull_"+a]||[],J=m["usedGc_"+a]||[],U=Y.filter(ce=>!J.includes(ce.id)),G=m.boostOwner===a&&!m.boostUsed,W=!["GK","DEF","MIL","ATT"].some(ce=>($[ce]||[]).some(X=>!X.used)),te=[...q.MIL||[],...q.ATT||[]].filter(ce=>!ce.used),Z=w&&W&&te.length===0?[...q.GK||[],...q.DEF||[]].filter(ce=>!ce.used).map(ce=>ce.cardId):[];function fe(ce,X,H){var mt,kt;const ae=ce._gcDef,he={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ae==null?void 0:ae.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",$e={purple:"#b06ce0",light_blue:"#00d4ef"}[ae==null?void 0:ae.color]||"#b06ce0",Qe=(ae==null?void 0:ae.name)||ce.gc_type,Ze=(ae==null?void 0:ae.effect)||((mt=Oe[ce.gc_type])==null?void 0:mt.desc)||"",tt=ae!=null&&ae.image_url?`/icons/${ae.image_url}`:null,rt=((kt=Oe[ce.gc_type])==null?void 0:kt.icon)||"⚡",_t=Math.round(H*.22),$t=Math.round(H*.22),dt=H-_t-$t,gt=Qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ce.id}" data-gc-type="${ce.gc_type}"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct(q,m[a+"Formation"],Ae,E,300,300,Z)}
      </div>
        ...
        </div>`}return`<div style="font-size:11px;color:${ce.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${ce.type==="goal"?700:400};padding:3px 2px">${ce.text||""}</div>`}const Ye=(()=>{var X,H;if(k&&((X=m.pendingAttack)!=null&&X.players)){const ae=m.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
        ...
        </div>`}if(w&&((H=m.pendingAttack)!=null&&H.players)){const ae=m.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          ${it((ae.players||[]).map(he=>({...he,used:!1})),"#00ff88",ae.total)}
        </div>`}const ce=(m.log||[]).slice(-1)[0];return ce?'<div style="padding:2px 4px">'+Ue(ce)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),Ke=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
        <button id="pvp-quit" style="width:34px;height:34px;border-radius:50%;background:rgba(220,50,50,0.7);border:none;color:#fff;font-size:16px;cursor:pointer;flex-shrink:0">✕</button>
        <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let S=!1;const E=()=>{S||(S=!0,v.remove(),setTimeout(()=>b(),50))};v.addEventListener("click",E),setTimeout(E,3500)}function Ee(q,$,g){var J,U;const y=(m.gcDefs||[]).find(G=>{var W;return G.name===q||((W=G.name)==null?void 0:W.toLowerCase().trim())===(q==null?void 0:q.toLowerCase().trim())}),b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",w=(y==null?void 0:y.name)||q,k=(y==null?void 0:y.effect)||((J=Oe[q])==null?void 0:J.desc)||"",S=y!=null&&y.image_url?`/icons/${y.image_url}`:null,E=((U=Oe[q])==null?void 0:U.icon)||"⚡",A=$===a?"Vous":m[$+"Name"]||"Adversaire",M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",M.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(M);let F=!1;const Y=()=>{F||(F=!0,M.remove(),setTimeout(()=>g&&g(),50))};M.addEventListener("click",Y),setTimeout(Y,3e3)}function se(q,$){var M,F,Y,J;const y=(m["gcCardsFull_"+a]||[]).find(U=>U.id===q),b=y==null?void 0:y._gcDef,v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",k=(b==null?void 0:b.name)||$,S=(b==null?void 0:b.effect)||((M=Oe[$])==null?void 0:M.desc)||"Carte spéciale.",E=b!=null&&b.image_url?`/icons/${b.image_url}`:null,L=((F=Oe[$])==null?void 0:F.icon)||"⚡",A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",A.innerHTML=`
      ...
      </div>`,document.body.appendChild(g),(y=g.querySelector("#bp-close"))==null||y.addEventListener("click",()=>g.remove()),g.querySelectorAll(".bp-item").forEach(b=>{b.addEventListener("click",async()=>{const v=b.dataset.cid,w=$.find(S=>S.cardId===v);if(!w)return;const k=(q[w._line]||[]).find(S=>S.cardId===v);k&&(k.boost=(k.boost||0)+m.boostValue),g.remove(),await V({[a+"Team"]:q,boostUsed:!0})})})}function de(q=null){var F,Y;if(!(m.phase===a+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const g=m[a+"Team"],y=m["usedSubIds_"+a]||[],b=m.maxSubs||3;if(y.length>=b){u(`Maximum ${b} remplacements atteint`,"warning");return}const v=Object.entries(g).flatMap(([J,U])=>(U||[]).filter(G=>G.used).map(G=>({...G,_line:J}))),w=(m[a+"Subs"]||[]).filter(J=>!y.includes(J.cardId));if(!v.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!w.length){u("Aucun remplaçant disponible","warning");return}let k=Math.max(0,v.findIndex(J=>J.cardId===q));const S=((F=v[k])==null?void 0:F._line)||((Y=v[k])==null?void 0:Y.job);let E=Math.max(0,w.findIndex(J=>J.job===S)),L=!1;const A=document.createElement("div");A.id="pvp-sub-overlay",A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function M(){var fe,ye,be,ke,Be,Fe;const J=v[k],U=w[E],G=Math.min(130,Math.round((window.innerWidth-90)/2)),W=Math.round(G*1.35),te=Me=>`background:rgba(255,255,255,0.12);border:none;color:${Me?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Me?"default":"pointer"};flex-shrink:0`;A.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(fe=A.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>A.remove()),(ye=A.querySelector("#pout-up"))==null||ye.addEventListener("click",()=>{k>0&&(k--,M())}),(be=A.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{k<v.length-1&&(k++,M())}),(ke=A.querySelector("#pin-up"))==null||ke.addEventListener("click",()=>{E>0&&(E--,M())}),(Be=A.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{E<w.length-1&&(E++,M())});const Z=(Me,je,Ae,Ne)=>{const Ue=A.querySelector("#"+Me);if(!Ue)return;let Ye=0;Ue.addEventListener("touchstart",Ke=>{Ye=Ke.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ke=>{const Re=Ke.changedTouches[0].clientY-Ye;if(Math.abs(Re)<30)return;const Ge=je();Re<0&&Ge<Ne-1?(Ae(Ge+1),M()):Re>0&&Ge>0&&(Ae(Ge-1),M())},{passive:!0})};Z("pin-panel",()=>E,Me=>E=Me,w.length),Z("pout-panel",()=>k,Me=>k=Me,v.length),(Fe=A.querySelector("#psub-confirm"))==null||Fe.addEventListener("click",async Me=>{if(Me.preventDefault(),Me.stopPropagation(),L)return;L=!0;const je=v[k],Ae=w[E];if(!je||!Ae)return;const Ne=je._line,Ue=(g[Ne]||[]).findIndex(Re=>Re.cardId===je.cardId);if(Ue===-1){u("Erreur : joueur introuvable","error"),A.remove();return}const Ye={...Ae,_line:Ne,position:je.position,used:!1,boost:0};g[Ne].splice(Ue,1,Ye);const Ke=[...y,Ae.cardId];A.remove(),O(je,Ae,async()=>{await V({[a+"Team"]:g,[n+"Team"]:m[n+"Team"],["usedSubIds_"+a]:Ke})})})}document.body.appendChild(A),M()}function O(q,$,g){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(S,E,L)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${lt(m[n+"Team"],m[n+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(q),($=q.querySelector("#pvp-opp-close"))==null||$.addEventListener("click",()=>q.remove())}function xe(){var y;const q=m.log||[],$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const g=b=>{var w,k,S;if(b.type==="duel"){const E=b.isGoal,L=b.homeScored&&a==="p1"||!b.homeScored&&E&&a==="p2",A=b.homeScored?"#FFD700":E?"#ff6b6b":"rgba(255,255,255,0.3)",M=E?L?"⚽ BUT !":"⚽ BUT adversaire !":(w=b.homePlayers)!=null&&w.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${E?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${A};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild($),(y=$.querySelector("#pvp-hist-close"))==null||y.addEventListener("click",()=>$.remove())}async function le(){if(m.phase!==a+"-attack")return;const q=a==="p1"?"p2":"p1",$=(m.round||0)+1,g=[...m.log||[]];g.push({type:"info",text:`⏭️ ${m[a+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const y=Te(m),b=Ce(q),v=y||!b?"finished":q+"-attack";await V({["selected_"+a]:[],modifiers:{...m.modifiers,[a]:{}},pendingAttack:null,phase:v,attacker:q,round:$,log:g}),v==="finished"&&await Pe(m)}async function ge(){const q=m[a+"Team"],$=!["GK","DEF","MIL","ATT"].some(v=>(m[n+"Team"][v]||[]).some(w=>!w.used)),g=(m["selected_"+a]||[]).map(v=>{const w=(q[v._role]||[]).find(M=>M.cardId===v.cardId)||v,k=$&&["GK","DEF"].includes(v._role),S=q[v._role]||[],E=S.findIndex(M=>M.cardId===v.cardId),L=st(S.length),A=E>=0?L[E]:w._col??1;return{...w,_line:v._role,_col:A,...k?{note_a:Math.max(1,Number(w.note_a)||0)}:{}}});if(!g.length)return;const y=Kt(g,m.modifiers[a]||{});R(a,g.map(v=>v.cardId)),g.forEach(v=>{const w=(q[v._role]||[]).find(k=>k.cardId===v.cardId);w&&(w.used=!0)}),m["selected_"+a]=[],re();const b=[...m.log||[]];if($){const v=(m[a+"Score"]||0)+1,w=g.map(A=>({name:A.name,note:Se(A,A._line||"ATT"),portrait:He(A),job:A.job}));b.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:w,homeTotal:y.total,aiTotal:0});const k=(m.round||0)+1,S=a==="p1"?"p2":"p1",E={...m,[a+"Team"]:q,[a+"Score"]:v},L=Te(E);C.add(k),we(w,v,m[n+"Score"]||0,!0,async()=>{await V({[a+"Team"]:q,[a+"Score"]:v,["selected_"+a]:[],modifiers:{...m.modifiers,[a]:{}},pendingAttack:null,phase:L?"finished":S+"-attack",attacker:S,round:k,log:b}),L&&await Pe({...m,[a+"Score"]:v})});return}b.push({type:"pending",text:`⚔️ ${m[a+"Name"]} attaque (${y.total})`}),await V({[a+"Team"]:q,[n+"Team"]:m[n+"Team"],pendingAttack:{...y,players:g,side:a},["selected_"+a]:[],modifiers:{...m.modifiers,[a]:{}},phase:n+"-defense",log:b})}async function ne(){const q=m[a+"Team"],$=(m["selected_"+a]||[]).map(J=>{const U=(q[J._role]||[]).find(fe=>fe.cardId===J.cardId)||J,G=q[J._role]||[],W=G.findIndex(fe=>fe.cardId===J.cardId),te=st(G.length),Z=W>=0?te[W]:U._col??1;return{...U,_line:J._role,_col:Z}}),g=Vt($,m.modifiers[a]||{});R(a,$.map(J=>J.cardId)),$.forEach(J=>{const U=(q[J._role]||[]).find(G=>G.cardId===J.cardId);U&&(U.used=!0)}),m["selected_"+a]=[],re();const y=Yt(m.pendingAttack.total,g.total,m.modifiers[a]||{}),b=m.pendingAttack.side,v=y==="attack"||(y==null?void 0:y.goal),w=b==="p1"?"p2":"p1",k=(m.round||0)+1,S=(m.pendingAttack.players||[]).map(J=>({name:J.name,note:Se(J,J._line||"ATT"),portrait:He(J),job:J.job})),E=[...m.log||[]];E.push({type:"duel",isGoal:v,homeScored:v&&b===a,text:v?`⚽ BUT de ${m[b+"Name"]} ! (${m.pendingAttack.total} vs ${g.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${g.total})`,homePlayers:S,aiPlayers:$.map(J=>({name:J.name,note:Se(J,J._line||"DEF"),portrait:He(J),job:J.job})),homeTotal:m.pendingAttack.total,aiTotal:g.total});const L=v?(m[b+"Score"]||0)+1:m[b+"Score"]||0,A={...m,[a+"Team"]:q,[b+"Score"]:L},M=Te(A),F=M?"finished":w+"-attack",Y=async()=>{await V({[a+"Team"]:q,[n+"Team"]:m[n+"Team"],[b+"Score"]:L,["selected_"+a]:[],modifiers:{...m.modifiers,[a]:{}},pendingAttack:null,phase:F,attacker:w,round:k,log:E}),(F==="finished"||M)&&await Pe({...m,[b+"Score"]:L})};if(v){const J=b===a,U=J?L:m[a+"Score"]||0,G=J?m[n+"Score"]||0:L;C.add(k),we(S,U,G,J,Y)}else await Y()}function ue(q){return["MIL","ATT"].some($=>(q[$]||[]).some(g=>!g.used))}function Le(q){return["GK","DEF","MIL","ATT"].some($=>(q[$]||[]).some(g=>!g.used))}function Ie(q){return Le(q)&&!ue(q)}function Ce(q){const $=m[q+"Team"],g=m[(q==="p1"?"p2":"p1")+"Team"];return!!(ue($)||!Le(g)&&Ie($))}function Te(q){const $=["MIL","ATT"].some(E=>(q.p1Team[E]||[]).some(L=>!L.used)),g=["MIL","ATT"].some(E=>(q.p2Team[E]||[]).some(L=>!L.used)),y=Le(q.p1Team),b=Le(q.p2Team);return!$&&!(!b&&y)&&(!g&&!(!y&&b))}function qe(q){const $=q.p1Score||0,g=q.p2Score||0;return $===g?null:$>g?h.home_id:h.away_id}async function Pe(q){try{const $=qe(q),g=$?h.home_id===$?h.away_id:h.home_id:null;await z.from("matches").update({status:"finished",winner_id:$,home_score:q.p1Score||0,away_score:q.p2Score||0}).eq("id",i),$&&g&&zi($,g).catch(()=>{})}catch($){console.error("[PvP] finishMatch:",$)}}function ze(){var b;const q=m[a+"Score"],$=m[n+"Score"],g=q>$,y=q===$;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-home" style="padding:16px 40px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏠 Retour</button>
    </div>`,(b=document.getElementById("pvp-home"))==null||b.addEventListener("click",()=>{try{z.removeChannel(N)}catch{}Ve(e),l("home")})}re()}const It="#1A6B3C",yt="#D4A017";async function Xo(e,t){var o;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=t.state.params)==null?void 0:o.openLeagueId;if(i){t.state.params.openLeagueId=null,await wt(e,t,i);return}await zt(e,t)}async function zt(e,t,i="waiting"){var T;const{state:o}=t,d=o.profile.id,{data:s}=await z.from("mini_league_members").select("league_id").eq("user_id",d),r=(s||[]).map(p=>p.league_id),{data:l,error:u}=await z.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),a=u?(await z.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:l||[],x=(r.length?await z.from("mini_leagues").select("*, mini_league_members(count)").in("id",r).order("created_at",{ascending:!1}):{data:[]}).data||[],f=x.filter(p=>p.status==="waiting"&&!p.is_archived),h=x.filter(p=>p.status==="active"&&!p.is_archived),_=x.filter(p=>p.is_archived||p.status==="finished"),m=a.filter(p=>!r.includes(p.id)),c=[{key:"waiting",label:"🟡 En attente",count:f.length+m.length},{key:"active",label:"🟢 En cours",count:h.length},{key:"archived",label:"📁 Archivées",count:_.length}];e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Qo(f,m,d):i==="active"?Zo(h,d):er(_,d)}
    </div>
  </div>`,(T=document.getElementById("ml-create-btn"))==null||T.addEventListener("click",()=>tr(e,t)),e.querySelectorAll(".ml-tab").forEach(p=>p.addEventListener("click",()=>zt(e,t,p.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(p=>p.addEventListener("click",()=>wt(e,t,p.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(p=>p.addEventListener("click",I=>{I.stopPropagation(),mn(e,t,p.dataset.join,p.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(p=>p.addEventListener("click",I=>{I.stopPropagation(),wi(e,t,p.dataset.delete,p.dataset.name,i)}))}function ni(e,t,i=!1){var r,l;const o=e.creator_id===t,d=e.pot||0,s=((l=(r=e.mini_league_members)==null?void 0:r[0])==null?void 0:l.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),o=d=>{t.remove(),e(d)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",d=>{d.key==="Enter"&&o(i.value.trim())}),t.addEventListener("click",d=>{d.target===t&&o(null)})})}async function mn(e,t,i,o){const{toast:d,state:s}=t,r=s.profile.id,{data:l}=await z.from("mini_leagues").select("password,status,entry_fee,pot,max_players").eq("id",i).single();if(!l){d("Mini League introuvable","error");return}if(l.status!=="waiting"){d("Cette Mini League a déjà démarré","warning");return}const{count:u}=await z.from("mini_league_members").select("id",{count:"exact",head:!0}).eq("league_id",i);if(u>=l.max_players){d("La Mini League est complète","warning");return}if(o==="private"){const m=await ir();if(m===null)return;if(l.password!==m){d("Mot de passe incorrect","error");return}}const a=l.entry_fee||100,{data:n}=await z.from("users").select("credits").eq("id",r).single();if(((n==null?void 0:n.credits)||0)<a){d(`Crédits insuffisants — il te faut ${a.toLocaleString("fr")} cr. (solde : ${((n==null?void 0:n.credits)||0).toLocaleString("fr")} cr.)`,"error");return}const{error:x}=await z.from("mini_league_members").insert({league_id:i,user_id:r});if(x){d("Erreur inscription : "+x.message,"error");return}const{error:f}=await z.from("users").update({credits:n.credits-a}).eq("id",r),{error:h}=await z.from("mini_leagues").update({pot:(l.pot||0)+a}).eq("id",i);(f||h)&&console.error("Erreur post-inscription:",f,h),s.profile&&(s.profile.credits=n.credits-a);const _=document.getElementById("nav-credits");_&&(_.textContent=`💰 ${(s.profile.credits||0).toLocaleString("fr")}`),d(`✅ Inscrit ! −${a.toLocaleString("fr")} cr. · Pot : ${((l.pot||0)+a).toLocaleString("fr")} cr.`,"success"),wt(e,t,i)}async function nr(e,t,i,o){const{toast:d,state:s}=t,r=s.profile.id;if(!confirm(`Te désinscrire et récupérer ${o.toLocaleString("fr")} cr. ?`))return;const{data:l}=await z.from("mini_leagues").select("pot,status").eq("id",i).single();if(!l||l.status!=="waiting"){d("Impossible — la league a déjà démarré","error");return}const{data:u}=await z.from("users").select("credits").eq("id",r).single();await z.from("mini_leagues").update({pot:Math.max(0,(l.pot||0)-o)}).eq("id",i),await z.from("users").update({credits:((u==null?void 0:u.credits)||0)+o}).eq("id",r),await z.from("mini_league_members").delete().eq("league_id",i).eq("user_id",r),s.profile&&(s.profile.credits=((u==null?void 0:u.credits)||0)+o);const a=document.getElementById("nav-credits");a&&(a.textContent=`💰 ${(s.profile.credits||0).toLocaleString("fr")}`),d(`↩️ Désinscrit · +${o.toLocaleString("fr")} cr. remboursés`,"success"),zt(e,t,"waiting")}async function wi(e,t,i,o,d){const{toast:s}=t;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await z.from("mini_league_matches").delete().eq("league_id",i),await z.from("mini_league_members").delete().eq("league_id",i);const{error:r}=await z.from("mini_leagues").delete().eq("id",i);if(r){s("Erreur suppression ("+r.message+")","error");return}s("Mini League supprimée avec succès","success"),zt(e,t,d)}async function or(e,t,i){await z.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),zt(e,t,"archived")}async function wt(e,t,i){var B,C,P,j,N,V,K,oe,ie;const{state:o,toast:d}=t,s=o.profile.id,[{data:r},{data:l},{data:u}]=await Promise.all([z.from("mini_leagues").select("*").eq("id",i).single(),z.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),z.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!r){d("Introuvable","error"),await zt(e,t);return}const a=(l||[]).some(Q=>Q.user_id===s),n=r.creator_id===s,x=(l||[]).map(Q=>Q.user).filter(Boolean),f=yn(x,u||[]),h=(u||[]).filter(Q=>Q.matchday===r.current_day),_=r.pot||0,m=r.entry_fee||100,c=h.length>0&&h.every(Q=>Q.status==="finished"||Q.status==="bye"),T=r.current_day>=r.total_days,p=(l||[]).find(Q=>Q.user_id===s);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${n&&c&&!T?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
        ${n&&c&&T?'<button id="ml-finish-btn" class="btn btn-primary" style="width:100%;margin-top:12px;background:#7a28b8">🏆 Terminer et distribuer le pot</button>':""}
      </div>`:""}
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${f.map((Q,R)=>{const D=_>0&&r.status==="finished"?R===0?Math.floor(_*.7):R===1?Math.floor(_*.2):R===2?Math.floor(_*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${Q.userId===s?"background:#f0fdf4;":""}">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(Q,R)=>R+1).reverse().map(Q=>{const R=(u||[]).filter(D=>D.matchday===Q);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${Q}</div>${R.map(D=>Hi(D,x,s,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const I=r.status==="waiting"?"waiting":r.status==="active"?"active":"archived";if((B=document.getElementById("ml-back"))==null||B.addEventListener("click",()=>zt(e,t,I)),(C=document.getElementById("ml-start-btn"))==null||C.addEventListener("click",()=>rr(e,t,r,x)),(P=document.getElementById("ml-next-day"))==null||P.addEventListener("click",()=>ar(e,t,i)),(j=document.getElementById("ml-finish-btn"))==null||j.addEventListener("click",()=>xn(e,t,i,_,f,x)),(N=document.getElementById("ml-join-now"))==null||N.addEventListener("click",()=>mn(e,t,i,r.type)),(V=document.getElementById("ml-leave-btn"))==null||V.addEventListener("click",()=>nr(e,t,i,m)),(K=document.getElementById("ml-delete-btn"))==null||K.addEventListener("click",()=>wi(e,t,i,r.name,"waiting")),(oe=document.getElementById("ml-delete-now"))==null||oe.addEventListener("click",()=>wi(e,t,i,r.name,I)),(ie=document.getElementById("ml-archive-btn"))==null||ie.addEventListener("click",()=>or(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(Q=>{Q.addEventListener("click",()=>{const R=h.find(D=>D.id===Q.dataset.playMatch);R&&t.navigate("match-mini-league",{mlMatchId:R.id,leagueId:i})})}),r.status==="finished"&&p){const Q=f.findIndex(R=>R.userId===s);Q>=0&&Q<3&&p.prize_amount>0&&setTimeout(()=>sr(e,t,r,p,Q),400)}}function Hi(e,t,i,o,d=!1){const s=x=>t.find(f=>f.id===x);if(e.is_bye){const x=s(e.home_id);return`<div style="padding:8px;border-radius:8px;background:#f9f9f9;margin-bottom:6px;font-size:12px;color:#888;text-align:center">🔵 ${(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"?"} exempté(e)</div>`}const r=s(e.home_id),l=s(e.away_id),u=e.home_id===i||e.away_id===i,a=u&&e.status==="pending"&&o&&!d,n=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${u?"#f0fdf4":"#f9f9f9"};margin-bottom:6px;border:1px solid ${u?"#86efac":"#f0f0f0"}">
  ...
  </div>`}async function rr(e,t,i,o){const{toast:d,state:s}=t,r=dr(o.map(a=>a.id),i.mode),l=[];r.forEach((a,n)=>a.forEach(x=>l.push({league_id:i.id,matchday:n+1,home_id:x.home||x.bye,away_id:x.away||null,is_bye:!!x.bye,status:x.bye?"bye":"pending"})));const{error:u}=await z.from("mini_league_matches").insert(l);if(u){d("Erreur calendrier : "+u.message,"error");return}await z.from("mini_leagues").update({status:"active",current_day:1,total_days:r.length}).eq("id",i.id),d(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),wt(e,t,i.id)}async function ar(e,t,i){const{data:o}=await z.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),d=(o.current_day||0)+1;if(d>(o.total_days||0)){await xn(e,t,i,o.pot||0,null,null);return}await z.from("mini_leagues").update({current_day:d}).eq("id",i),t.toast(`Journée ${d} commencée !`,"success"),wt(e,t,i)}async function xn(e,t,i,o,d,s){const{toast:r,state:l}=t;let u=d,a=s;if(!u){const{data:x}=await z.from("mini_league_matches").select("*").eq("league_id",i),{data:f}=await z.from("mini_league_members").select("*, user:users(id,pseudo,club_name)").eq("league_id",i);a=(f||[]).map(h=>h.user).filter(Boolean),u=yn(a,x||[])}const n=[Math.floor(o*.7),Math.floor(o*.2),Math.floor(o*.1)];await Promise.all(u.slice(0,3).map((x,f)=>n[f]?z.from("mini_league_members").update({prize_amount:n[f],prize_claimed:!1}).eq("league_id",i).eq("user_id",x.userId):Promise.resolve())),await z.from("mini_leagues").update({status:"finished"}).eq("id",i),r("🏆 Mini League terminée ! Les gagnants peuvent récupérer leurs crédits.","success"),wt(e,t,i)}async function sr(e,t,i,o,d){var f,h;const{state:s,toast:r}=t,l=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],u=["🥇","🥈","🥉"][d],a=o.prize_amount||l[d]||0,n=o.prize_claimed,x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",x.innerHTML=`
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
    ...
    </div>`,document.body.appendChild(x),(f=x.querySelector("#prize-close"))==null||f.addEventListener("click",()=>x.remove()),x.addEventListener("click",_=>{_.target===x&&x.remove()}),(h=x.querySelector("#claim-prize-btn"))==null||h.addEventListener("click",async()=>{const{data:_}=await z.from("users").select("credits").eq("id",s.profile.id).single();await z.from("users").update({credits:((_==null?void 0:_.credits)||0)+a}).eq("id",s.profile.id),await z.from("mini_league_members").update({prize_claimed:!0}).eq("league_id",i.id).eq("user_id",s.profile.id),s.profile&&(s.profile.credits=((_==null?void 0:_.credits)||0)+a);const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${s.profile.credits.toLocaleString("fr")}`),r(`💰 +${a.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success"),x.remove(),wt(e,t,i.id)})}function dr(e,t){const o=e.length%2===0?[...e]:[...e,null],d=o.length;let s=o.slice(1);const r=[];for(let l=0;l<d-1;l++){const u=[],a=[o[0],...s];for(let n=0;n<d/2;n++){const x=a[n],f=a[d-1-n];x===null?u.push({bye:f}):f===null?u.push({bye:x}):u.push({home:x,away:f})}r.push(u),s=[s[s.length-1],...s.slice(0,-1)]}return t==="aller-retour"?[...r,...r.map(l=>l.map(u=>u.bye?u:{home:u.away,away:u.home}))]:r}function yn(e,t){const i={};return e.forEach(o=>{i[o.id]={userId:o.id,pseudo:o.pseudo,clubName:o.club_name||o.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),t.filter(o=>o.status==="finished"&&!o.is_bye&&o.home_score!=null).forEach(o=>{const d=i[o.home_id],s=i[o.away_id];!d||!s||(d.played++,s.played++,d.goalsFor+=o.home_score,d.goalsAgainst+=o.away_score,s.goalsFor+=o.away_score,s.goalsAgainst+=o.home_score,o.home_score>o.away_score?(d.won++,d.points+=3,s.lost++):o.home_score<o.away_score?(s.won++,s.points+=3,d.lost++):(d.drawn++,d.points++,s.drawn++,s.points++),d.goalDiff=d.goalsFor-d.goalsAgainst,s.goalDiff=s.goalsFor-s.goalsAgainst)}),Object.values(i).sort((o,d)=>d.points-o.points||d.goalDiff-o.goalDiff||d.goalsFor-o.goalsFor)}async function Ui(e,t,i,o){var d,s;t.state.params={...t.state.params,matchMode:"mini-league",mlMatchId:i,leagueId:o};try{const r=(s=(d=t==null?void 0:t.state)==null?void 0:d.profile)==null?void 0:s.id;try{(z.getChannels?z.getChannels():[]).forEach(u=>{const a=u.topic||"";(a.includes("matchmaking")||a.includes("pvp-match"))&&z.removeChannel(u)})}catch(l){console.warn("[FriendMatch] cleanup canaux:",l)}r&&(await z.rpc("cancel_matchmaking",{p_user_id:r}).catch(()=>{}),await z.from("matchmaking_queue").delete().eq("user_id",r).then(()=>{},()=>{}))}catch{}await si(e,t,"random",({deckId:r,formation:l,starters:u,subsRaw:a,gcCardsEnriched:n,gcDefs:x,stadiumDef:f})=>{const h=_=>lr(e,t,r,l,u,a,_,x||[],i);if(!n.length){h([]);return}ai(e,n,h)})}async function lr(e,t,i,o,d,s,r=[],l=[],u,a){const{state:n,navigate:x,toast:f}=t,h=n.profile.id;let _=!1,m=null;et(e);try{await z.rpc("cancel_matchmaking",{p_user_id:h})}catch{}try{await z.from("matchmaking_queue").delete().eq("user_id",h)}catch{}const{data:c}=await z.from("mini_league_matches").select("*, home:users!home_id(id,pseudo,club_name), away:users!away_id(id,pseudo,club_name)").eq("id",u).single();if(!c){f("Match introuvable","error"),Ve(e),x("mini-league");return}if(c.home_id!==h&&c.away_id!==h){f("Tu ne fais pas partie de ce match","error"),Ve(e),x("mini-league");return}const T=c.home_id===h,p=T?c.away:c.home,I=T?c.away_id:c.home_id,B=(P,j)=>{var N;e.innerHTML=`
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:20px;background:linear-gradient(180deg,#0a1628,#1a0a2e);padding:24px;text-align:center;color:#fff">
        ...
        <button id="lobby-cancel" style="padding:10px 24px;border-radius:10px;border:1.5px solid rgba(255,255,255,0.2);background:transparent;color:rgba(255,255,255,0.6);font-size:13px;cursor:pointer">Annuler</button>
        <style>@keyframes lobbyPulse{0%,100%{opacity:1}50%{opacity:0.4}}</style>
      </div>`,(N=document.getElementById("lobby-cancel"))==null||N.addEventListener("click",()=>{_=!0,clearInterval(m),Ve(e),x("mini-league")})},C=async(P,j)=>{_=!0,clearInterval(m),await new Promise(N=>setTimeout(N,600)),e.isConnected&&cr(e,t,P,j,r,l)};if(B(),T){let P=c.match_id;if(!P){const{data:N,error:V}=await z.from("matches").insert({home_id:h,away_id:I,home_deck_id:i,away_deck_id:null,status:"active",mode:"mini_league"}).select().single();if(V||!N){f("Erreur création match","error"),Ve(e),x("mini-league");return}P=N.id,await z.from("mini_league_matches").update({match_id:P,status:"playing"}).eq("id",u)}const j=P;m=setInterval(async()=>{if(_){clearInterval(m);return}const{data:N}=await z.from("matches").select("away_deck_id").eq("id",j).single();N!=null&&N.away_deck_id&&(clearInterval(m),C(j,!0))},1500)}else{let P=c.match_id;m=setInterval(async()=>{if(_){clearInterval(m);return}const{data:j}=await z.from("mini_league_matches").select("match_id").eq("id",u).single();j!=null&&j.match_id&&(clearInterval(m),P=j.match_id,await z.from("matches").update({away_deck_id:i}).eq("id",P),C(P,!1))},1500)}}async function cr(e,t,i,o,d=[],s=[]){var $;const{state:r,navigate:l,toast:u}=t,a=(($=r.params)==null?void 0:$.leagueId)||null,n=o?"p1":"p2",x=o?"p2":"p1",f=(d||[]).map(g=>g.id),h=(d||[]).map(g=>({id:g.id,gc_type:g.gc_type,_gcDef:g._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:_}=await z.from("matches").select("*").eq("id",i).single();if(!_){u("Match introuvable","error"),l("mini-league");return}async function m(){const[{data:g},{data:y},{data:b},{data:v}]=await Promise.all([z.rpc("get_deck_for_match",{p_deck_id:_.home_deck_id}),z.rpc("get_deck_for_match",{p_deck_id:_.away_deck_id}),z.from("users").select("id,pseudo,club_name").eq("id",_.home_id).single(),z.from("users").select("id,pseudo,club_name").eq("id",_.away_id).single()]),w=A=>{const M=Number(A.evolution_bonus)||0;return{cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:(Number(A.note_g)||0)+(A.job==="GK"||A.job2==="GK"&&Number(A.note_g)>0?M:0),note_d:(Number(A.note_d)||0)+(A.job==="DEF"||A.job2==="DEF"&&Number(A.note_d)>0?M:0),note_m:(Number(A.note_m)||0)+(A.job==="MIL"||A.job2==="MIL"&&Number(A.note_m)>0?M:0),note_a:(Number(A.note_a)||0)+(A.job==="ATT"||A.job2==="ATT"&&Number(A.note_a)>0?M:0),evolution_bonus:M,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},k=((g==null?void 0:g.starters)||[]).map(A=>w(A)),S=((y==null?void 0:y.starters)||[]).map(A=>w(A)),E=(g==null?void 0:g.formation)||"4-4-2",L=(y==null?void 0:y.formation)||"4-4-2";return{p1Team:(()=>{const A=vt(k,E);return stadiumDef?Tt(A,stadiumDef):A})(),p2Team:vt(S,L),p1Subs:(()=>{const A=((g==null?void 0:g.subs)||[]).map(M=>w(M));return stadiumDef&&jt(A,stadiumDef),A})(),p2Subs:((y==null?void 0:y.subs)||[]).map(A=>w(A)),p1Formation:E,p2Formation:L,p1Name:(b==null?void 0:b.club_name)||(b==null?void 0:b.pseudo)||"Joueur 1",p2Name:(v==null?void 0:v.club_name)||(v==null?void 0:v.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?f:[],gc_p2:o?[]:f,gcCardsFull_p1:o?h:[],gcCardsFull_p2:o?[]:h,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let c=_.game_state&&Object.keys(_.game_state).length?_.game_state:null;if(!c)if(o){c=await m();const{data:g}=await z.from("matches").select("game_state").eq("id",i).single();!(g!=null&&g.game_state)||!Object.keys(g.game_state).length?await z.from("matches").update({game_state:c,turn_user_id:_.home_id}).eq("id",i):c=g.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let g=0;g<60&&!c;g++){await new Promise(b=>setTimeout(b,400));const{data:y}=await z.from("matches").select("game_state").eq("id",i).single();y!=null&&y.game_state&&Object.keys(y.game_state).length&&(c=y.game_state)}if(!c){u("Erreur de synchronisation","error"),l("mini-league");return}c.gc_p2=f,c.gcCardsFull_p2=h,await z.from("matches").update({game_state:c}).eq("id",i)}let T=!1,p=!1,I=!1,B=null,C=!1;const P=new Set,j=new Set;function N(g){var A,M;try{z.removeChannel(V)}catch{}const y=c[n+"Score"]||0,b=c[x+"Score"]||0;if(!I){I=!0;const F=g.winner_id||(y>b?r.profile.id:b>y?"opp":null),Y=F===r.profile.id?"win":F?"loss":null;Y&&oi(()=>Promise.resolve().then(()=>on),void 0).then(J=>J.applyOwnEvolution(r.profile.id,Y)).catch(()=>{})}if(!p){const F=c.p1Score||0,Y=c.p2Score||0,J=(c.usedGc_p1||[]).length,U=(c.usedGc_p2||[]).length,G=g.winner_id||(F>Y?_.home_id:Y>F?_.away_id:null);(G?r.profile.id===G:r.profile.id<(o?_.away_id:_.home_id))&&(p=!0,Ji({player1Id:_.home_id,player2Id:_.away_id,score1:F,score2:Y,gc1:J,gc2:U}).catch(te=>console.warn("[FriendMatch] updateStats:",te)))}let v,w;g.winner_id?(v=g.winner_id===r.profile.id,w=!1):g.forfeit?(v=y>b,w=!1):(w=y===b,v=y>b),(A=document.getElementById("pvp-end-overlay"))==null||A.remove();const k=document.createElement("div");k.id="pvp-end-overlay",k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const S=w?"🤝":v?"🏆":"😞",E=w?"MATCH NUL":v?"VICTOIRE !":"DÉFAITE",L=w?"#fff":v?"#FFD700":"#ff6b6b";k.innerHTML=`
      <div style="font-size:64px">${S}</div>
      <div style="font-size:26px;font-weight:900;color:${L}">${E}</div>
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(k),(M=k.querySelector("#pvp-end-home"))==null||M.addEventListener("click",()=>{k.remove(),Ve(e),a?l("mini-league",{openLeagueId:a}):l("mini-league")})}const V=z.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},g=>{const y=g.new;try{if(y.status==="finished"||y.forfeit){if(T||(T=!0,B&&(clearInterval(B),B=null),y.game_state&&(c=y.game_state),c.phase==="finished"&&!y.forfeit&&document.getElementById("pvp-home")))return;N(y);return}if(y.game_state){const b=c;c=y.game_state;const v=c._lastGC;if(v&&v.seq&&!j.has(v.seq)&&(j.add(v.seq),v.by!==n)){se(v.type,v.by,()=>me());return}const w=b[n+"Score"]||0,k=b[x+"Score"]||0,S=c[n+"Score"]||0,E=c[x+"Score"]||0,L=S>w,A=E>k;if((L||A)&&!P.has(c.round)){P.add(c.round);const M=[...c.log||[]].reverse().find(Y=>Y.isGoal),F=((M==null?void 0:M.homePlayers)||[]).map(Y=>({name:Y.name,note:Y.note,portrait:Y.portrait,job:Y.job}));Ee(F,S,E,L,()=>me());return}me()}}catch(b){console.error("[PvP] crash:",b)}}).subscribe();async function K(g){Object.assign(c,g),c.lastActionAt=new Date().toISOString();const{error:y}=await z.from("matches").update({game_state:c}).eq("id",i);y&&u("Erreur de synchronisation","error");try{me()}catch(b){console.error("[PvP] renderPvpScreen crash:",b)}}async function oe(){if(T)return;T=!0,B&&(clearInterval(B),B=null);const g=o?_.away_id:_.home_id,y=o?"p2":"p1",b=o?"p1":"p2",v={...c,[y+"Score"]:3,[b+"Score"]:0,phase:"finished"};try{await z.from("matches").update({status:"finished",forfeit:!0,winner_id:g,home_score:v.p1Score||0,away_score:v.p2Score||0,game_state:v}).eq("id",i)}catch{}try{z.removeChannel(V)}catch{}setTimeout(()=>{Ve(e),l("mini-league")},800)}const ie={BOOST_STAT:({value:g=1,count:y=1,roles:b=[]},v,w)=>{const k=v[n+"Team"],S=Object.entries(k).filter(([E])=>!b.length||b.includes(E)).flatMap(([E,L])=>L.filter(A=>!A.used).map(A=>({...A,_line:E})));if(!S.length){v.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),w(v);return}Q(S,y,`Choisir ${y} joueur(s) à booster (+${g})`,E=>{E.forEach(L=>{const A=(k[L._line]||[]).find(M=>M.cardId===L.cardId);A&&(A.boost=(A.boost||0)+g,v.log.push({text:`⚡ +${g} sur ${A.name}`,type:"info"}))}),v[n+"Team"]=k,w(v)})},DEBUFF_STAT:({value:g=1,count:y=1,roles:b=[],target:v="ai"},w,k)=>{const S=v==="home"?n:x,E=w[S+"Team"],L=v==="home"?"allié":"adverse",A=Object.entries(E).filter(([M])=>!b.length||b.includes(M)).flatMap(([M,F])=>F.map(Y=>({...Y,_line:M})));if(!A.length){w.log.push({text:`🎯 Aucun joueur ${L}`,type:"info"}),k(w);return}Q(A,y,`Choisir ${y} joueur(s) ${L}(s) (-${g})`,M=>{M.forEach(F=>{const Y=(E[F._line]||[]).find(J=>J.cardId===F.cardId);Y&&(Y.boost=(Y.boost||0)-g,w.log.push({text:`🎯 -${g} sur ${Y.name}`,type:"info"}))}),w[S+"Team"]=E,k(w)})},GRAY_PLAYER:({count:g=1,roles:y=[],target:b="ai"},v,w)=>{const k=b==="home"?n:x,S=v[k+"Team"],E=b==="home"?"allié":"adverse",L=Object.entries(S).filter(([A])=>!y.length||y.includes(A)).flatMap(([A,M])=>M.filter(F=>!F.used).map(F=>({...F,_line:A})));if(!L.length){v.log.push({text:`❌ Aucun joueur ${E}`,type:"info"}),w(v);return}Q(L,g,`Choisir ${g} joueur(s) ${E}(s) à exclure`,A=>{const M="usedCardIds_"+k,F=new Set(v[M]||[]);A.forEach(Y=>{const J=(S[Y._line]||[]).find(U=>U.cardId===Y.cardId);J&&(J.used=!0,F.add(Y.cardId),v.log.push({text:`❌ ${J.name} exclu !`,type:"info"}))}),v[M]=[...F],v[k+"Team"]=S,w(v)})},REVIVE_PLAYER:({count:g=1,roles:y=[]},b,v)=>{const w=b[n+"Team"],k=Object.entries(w).filter(([S])=>!y.length||y.includes(S)).flatMap(([S,E])=>E.filter(L=>L.used).map(L=>({...L,_line:S})));if(!k.length){b.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),v(b);return}Q(k,g,`Choisir ${g} joueur(s) à ressusciter`,S=>{S.forEach(E=>{const L=(w[E._line]||[]).find(A=>A.cardId===E.cardId);L&&(L.used=!1,b.log.push({text:`💫 ${L.name} ressuscité !`,type:"info"}))}),b[n+"Team"]=w,v(b)})},REMOVE_GOAL:({},g,y)=>{const b=x+"Score";g[b]>0?(g[b]--,g.log.push({text:"🚫 Dernier but annulé !",type:"info"})):g.log.push({text:"🚫 Aucun but à annuler",type:"info"}),y(g)},ADD_GOAL_DRAW:({},g,y)=>{g[n+"Score"]===g[x+"Score"]?(g[n+"Score"]++,g.log.push({text:"🎯 But bonus !",type:"info"})):g.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),y(g)},ADD_SUB:({value:g=1},y,b)=>{y.maxSubs=(y.maxSubs||3)+g,y.log.push({text:`🔄 +${g} remplacement(s)`,type:"info"}),b(y)},CUSTOM:({},g,y)=>y(g)};function Q(g,y,b,v){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let k=[];function S(){var L,A;const E=g.map(M=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[M._line]||"#555",Y=Se(M,M._line)+(M.boost||0),U=k.find(W=>W.cardId===M.cardId)?"#FFD700":"rgba(255,255,255,0.25)",G=M.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${M.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${U};background:${F};overflow:hidden;cursor:pointer;${G}">
        ...
        </div>`,(L=w.querySelector("#pp-close"))==null||L.addEventListener("click",()=>w.remove()),w.querySelectorAll(".pp-item").forEach(M=>{M.addEventListener("click",()=>{const F=M.dataset.cid,Y=g.find(U=>U.cardId===F),J=k.findIndex(U=>U.cardId===F);Y&&(J>-1?k.splice(J,1):k.length<y&&k.push(Y),S())})}),(A=w.querySelector("#pp-confirm"))==null||A.addEventListener("click",()=>{w.remove(),v(k)})}S(),document.body.appendChild(w)}async function R(g,y){const v=(c["gcCardsFull_"+n]||[]).find(E=>E.id===g),w=(v==null?void 0:v._gcDef)||(c.gcDefs||[]).find(E=>{var L;return E.name===y||((L=E.name)==null?void 0:L.toLowerCase().trim())===(y==null?void 0:y.toLowerCase().trim())}),k=[...c["usedGc_"+n]||[],g],S={type:y,by:n,seq:(c._gcAnimSeq||0)+1};j.add(S.seq),se(y,n,async()=>{if(w!=null&&w.effect_type&&w.effect_type!=="CUSTOM"){const L=ie[w.effect_type];if(L){const A={...c};L(w.effect_params||{},A,async M=>{M["usedGc_"+n]=k,M._lastGC=S,M._gcAnimSeq=S.seq,await K(M)});return}}const E={...c};switch(y){case"Remplacement+":E.maxSubs=(E.maxSubs||3)+1,E.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const L=x+"Score";E[L]>0&&(E[L]--,E.log.push({text:"🚫 But annulé",type:"info"}));break}}E["usedGc_"+n]=k,E._lastGC=S,E._gcAnimSeq=S.seq,await K(E)})}function D(g,y){const b="usedCardIds_"+g,v=new Set(c[b]||[]);y.forEach(w=>v.add(w)),c[b]=[...v]}function re(){for(const g of["p1","p2"]){const y=new Set(c["usedCardIds_"+g]||[]),b=c[g+"Team"];if(b)for(const v of["GK","DEF","MIL","ATT"])(b[v]||[]).forEach(w=>{w.used=y.has(w.cardId)})}}function me(){var nt,pt,ut,ft,ce,X;if(c.phase==="reveal")return _e();if(c.phase==="midfield")return we();if(c.phase==="finished")return q();const g=c[n+"Team"],y=c[x+"Team"];re();const b=c[n+"Score"],v=c[x+"Score"],w=c[n+"Name"],k=c[x+"Name"],S=c.phase===n+"-attack",E=c.phase===n+"-defense",L=Array.isArray(c["selected_"+n])?c["selected_"+n]:[],A=L.map(H=>H.cardId),M=window.innerWidth>=700,F=c[n+"Subs"]||[],Y=c["usedSubIds_"+n]||[],J=F.filter(H=>!Y.includes(H.cardId)),U=c["gcCardsFull_"+n]||[],G=c["usedGc_"+n]||[],W=U.filter(H=>!G.includes(H.id)),te=c.boostOwner===n&&!c.boostUsed,Z=!["GK","DEF","MIL","ATT"].some(H=>(y[H]||[]).some(ae=>!ae.used)),fe=[...g.MIL||[],...g.ATT||[]].filter(H=>!H.used),ye=S&&Z&&fe.length===0?[...g.GK||[],...g.DEF||[]].filter(H=>!H.used).map(H=>H.cardId):[];function be(H,ae,he){var Ct,Li;const $e=H._gcDef,Qe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[$e==null?void 0:$e.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ze={purple:"#b06ce0",light_blue:"#00d4ef"}[$e==null?void 0:$e.color]||"#b06ce0",tt=($e==null?void 0:$e.name)||H.gc_type,rt=($e==null?void 0:$e.effect)||((Ct=Oe[H.gc_type])==null?void 0:Ct.desc)||"",_t=$e!=null&&$e.image_url?`/icons/${$e.image_url}`:null,$t=((Li=Oe[H.gc_type])==null?void 0:Li.icon)||"⚡",dt=Math.round(he*.22),gt=Math.round(he*.22),mt=he-dt-gt,kt=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${H.id}" data-gc-type="${H.gc_type}"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct(g,c[n+"Formation"],Ue,A,300,300,ye)}
      </div>
      ...
      </div>`;function We(){const H=e.querySelector(".match-screen");if(!H)return;const ae=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);H.style.height=ae+"px",H.style.minHeight=ae+"px",H.style.maxHeight=ae+"px",H.style.overflow="hidden";const he=e.querySelector("#mobile-action-bar"),$e=e.querySelector("#mobile-play-area");he&&$e&&($e.style.paddingBottom=he.offsetHeight+"px")}if(We(),setTimeout(We,120),setTimeout(We,400),C||(C=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",We),window.visualViewport.addEventListener("scroll",We)),window.addEventListener("resize",We)),function(){const ae=e.querySelector(".terrain-wrapper svg");ae&&(ae.removeAttribute("width"),ae.removeAttribute("height"),ae.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ae.setAttribute("viewBox","-26 -26 352 352"),ae.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(H=>{H.addEventListener("click",()=>{if(!S&&!E)return;const ae=H.dataset.cardId,he=H.dataset.role,$e=(g[he]||[]).find(rt=>rt.cardId===ae);if(!$e||$e.used)return;const Qe=ye.includes(ae);if(S&&!["MIL","ATT"].includes(he)&&!Qe)return;Array.isArray(c["selected_"+n])||(c["selected_"+n]=[]);const Ze=c["selected_"+n],tt=Ze.findIndex(rt=>rt.cardId===ae);tt>-1?Ze.splice(tt,1):Ze.length<3&&Ze.push({...$e,_role:he}),me()})}),e.querySelectorAll(".match-used-hit").forEach(H=>{H.addEventListener("click",()=>O(H.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(H=>{H.addEventListener("click",()=>O())}),(nt=e.querySelector("#pvp-sub-open"))==null||nt.addEventListener("click",()=>O()),e.querySelectorAll(".pvp-gc-mini").forEach(H=>{H.addEventListener("click",()=>pe(H.dataset.gcId,H.dataset.gcType))}),(pt=e.querySelector("#pvp-boost-card"))==null||pt.addEventListener("click",()=>de()),(ut=e.querySelector("#pvp-action"))==null||ut.addEventListener("click",H=>{S?H.currentTarget.dataset.pass==="1"||!Te(n)?ge():ne():E&&ue()}),(ft=e.querySelector("#pvp-quit"))==null||ft.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&oe()}),(ce=e.querySelector("#pvp-view-opp"))==null||ce.addEventListener("click",()=>xe()),(X=e.querySelector("#pvp-toggle-history"))==null||X.addEventListener("click",()=>le()),B&&(clearInterval(B),B=null),(S||E)&&!T){let H=30,ae=!1;const he=()=>document.getElementById("pvp-timer"),$e=()=>{he()&&(he().textContent=H+"s",he().style.color=ae?"#ff4444":"#fff")};$e(),B=setInterval(()=>{H--,H<0?ae?(clearInterval(B),B=null,S&&!Te(n)?ge():oe()):(ae=!0,H=15,$e()):$e()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(k);let L=!1;const A=()=>{L||(L=!0,k.remove(),setTimeout(()=>w(),50))};k.addEventListener("click",A),setTimeout(A,3500)}function se(g,y,b){var G,W;const v=(c.gcDefs||[]).find(te=>{var Z;return te.name===g||((Z=te.name)==null?void 0:Z.toLowerCase().trim())===(g==null?void 0:g.toLowerCase().trim())}),w={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",k={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",S=(v==null?void 0:v.name)||g,E=(v==null?void 0:v.effect)||((G=Oe[g])==null?void 0:G.desc)||"",L=v!=null&&v.image_url?`/icons/${v.image_url}`:null,A=((W=Oe[g])==null?void 0:W.icon)||"⚡",F=y===n?"Vous":c[y+"Name"]||"Adversaire",Y=document.createElement("div");Y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",Y.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(F),(U=F.querySelector("#pvp-gc-back"))==null||U.addEventListener("click",()=>F.remove()),(G=F.querySelector("#pvp-gc-use"))==null||G.addEventListener("click",()=>{F.remove(),R(g,y)})}function de(){var v;const g=c[n+"Team"],y=Object.entries(g).flatMap(([w,k])=>(k||[]).filter(S=>!S.used).map(S=>({...S,_line:w})));if(!y.length)return;const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",b.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${c.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${y.map(w=>{const k={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[w._line]||"#555",S=Se(w,w._line)+(w.boost||0);return`<div class="bp-item" data-cid="${w.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${k};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(b),(v=b.querySelector("#bp-close"))==null||v.addEventListener("click",()=>b.remove()),b.querySelectorAll(".bp-item").forEach(w=>{w.addEventListener("click",async()=>{const k=w.dataset.cid,S=y.find(L=>L.cardId===k);if(!S)return;const E=(g[S._line]||[]).find(L=>L.cardId===k);E&&(E.boost=(E.boost||0)+c.boostValue),b.remove(),await K({[n+"Team"]:g,boostUsed:!0})})})}function O(g=null){var J,U;if(!(c.phase===n+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const b=c[n+"Team"],v=c["usedSubIds_"+n]||[],w=c.maxSubs||3;if(v.length>=w){u(`Maximum ${w} remplacements atteint`,"warning");return}const k=Object.entries(b).flatMap(([G,W])=>(W||[]).filter(te=>te.used).map(te=>({...te,_line:G}))),S=(c[n+"Subs"]||[]).filter(G=>!v.includes(G.cardId));if(!k.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!S.length){u("Aucun remplaçant disponible","warning");return}let E=Math.max(0,k.findIndex(G=>G.cardId===g));const L=((J=k[E])==null?void 0:J._line)||((U=k[E])==null?void 0:U.job);let A=Math.max(0,S.findIndex(G=>G.job===L)),M=!1;const F=document.createElement("div");F.id="pvp-sub-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function Y(){var be,ke,Be,Fe,Me,je;const G=k[E],W=S[A],te=Math.min(130,Math.round((window.innerWidth-90)/2)),Z=Math.round(te*1.35),fe=Ae=>`background:rgba(255,255,255,0.12);border:none;color:${Ae?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Ae?"default":"pointer"};flex-shrink:0`;F.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          <div style="font-size:9px;color:#00ff88;letter-spacing:2px;text-transform:uppercase;font-weight:700">Joueur qui entre</div>
          <button id="pin-up" style="${fe(A===0)}" ${A===0?"disabled":""}>▲</button>
          <div>${W?Xe({...W,used:!1,boost:0},te,Z):"<div>—</div>"}</div>
          <button id="pin-down" style="${fe(A>=S.length-1)}" ${A>=S.length-1?"disabled":""}>▼</button>
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(be=F.querySelector("#psub-close"))==null||be.addEventListener("click",()=>F.remove()),(ke=F.querySelector("#pout-up"))==null||ke.addEventListener("click",()=>{E>0&&(E--,Y())}),(Be=F.querySelector("#pout-down"))==null||Be.addEventListener("click",()=>{E<k.length-1&&(E++,Y())}),(Fe=F.querySelector("#pin-up"))==null||Fe.addEventListener("click",()=>{A>0&&(A--,Y())}),(Me=F.querySelector("#pin-down"))==null||Me.addEventListener("click",()=>{A<S.length-1&&(A++,Y())});const ye=(Ae,Ne,Ue,Ye)=>{const Ke=F.querySelector("#"+Ae);if(!Ke)return;let Re=0;Ke.addEventListener("touchstart",Ge=>{Re=Ge.touches[0].clientY},{passive:!0}),Ke.addEventListener("touchend",Ge=>{const We=Ge.changedTouches[0].clientY-Re;if(Math.abs(We)<30)return;const nt=Ne();We<0&&nt<Ye-1?(Ue(nt+1),Y()):We>0&&nt>0&&(Ue(nt-1),Y())},{passive:!0})};ye("pin-panel",()=>A,Ae=>A=Ae,S.length),ye("pout-panel",()=>E,Ae=>E=Ae,k.length),(je=F.querySelector("#psub-confirm"))==null||je.addEventListener("click",async Ae=>{if(Ae.preventDefault(),Ae.stopPropagation(),M)return;M=!0;const Ne=k[E],Ue=S[A];if(!Ne||!Ue)return;const Ye=Ne._line,Ke=(b[Ye]||[]).findIndex(We=>We.cardId===Ne.cardId);if(Ke===-1){u("Erreur : joueur introuvable","error"),F.remove();return}const Re={...Ue,_line:Ye,position:Ne.position,used:!1,boost:0};b[Ye].splice(Ke,1,Re);const Ge=[...v,Ue.cardId];F.remove(),ee(Ne,Ue,async()=>{await K({[n+"Team"]:b,[x+"Team"]:c[x+"Team"],["usedSubIds_"+n]:Ge})})})}document.body.appendChild(F),Y()}function ee(g,y,b){const v={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const k=(L,A,M)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${A};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${M}</div>
      <div style="width:70px;height:70px;border-radius:50%;background:${v[L.job]||"#555"};border:3px solid ${A};position:relative;overflow:hidden;margin:0 auto">
      ...
      <div style="width:min(90vw,420px)">${lt(c[x+"Team"],c[x+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(g),(y=g.querySelector("#pvp-opp-close"))==null||y.addEventListener("click",()=>g.remove())}function le(){var v;const g=c.log||[],y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const b=w=>{var S,E,L;if(w.type==="duel"){const A=w.isGoal,M=w.homeScored&&n==="p1"||!w.homeScored&&A&&n==="p2",F=w.homeScored?"#FFD700":A?"#ff6b6b":"rgba(255,255,255,0.3)",Y=A?M?"⚽ BUT !":"⚽ BUT adversaire !":(S=w.homePlayers)!=null&&S.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${A?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${F};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild(y),(v=y.querySelector("#pvp-hist-close"))==null||v.addEventListener("click",()=>y.remove())}async function ge(){if(c.phase!==n+"-attack")return;const g=n==="p1"?"p2":"p1",y=(c.round||0)+1,b=[...c.log||[]];b.push({type:"info",text:`⏭️ ${c[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const v=qe(c),w=Te(g),k=v||!w?"finished":g+"-attack";await K({["selected_"+n]:[],modifiers:{...c.modifiers,[n]:{}},pendingAttack:null,phase:k,attacker:g,round:y,log:b}),k==="finished"&&await ze(c)}async function ne(){const g=c[n+"Team"],y=!["GK","DEF","MIL","ATT"].some(k=>(c[x+"Team"][k]||[]).some(S=>!S.used)),b=(c["selected_"+n]||[]).map(k=>{const S=(g[k._role]||[]).find(Y=>Y.cardId===k.cardId)||k,E=y&&["GK","DEF"].includes(k._role),L=g[k._role]||[],A=L.findIndex(Y=>Y.cardId===k.cardId),M=st(L.length),F=A>=0?M[A]:S._col??1;return{...S,_line:k._role,_col:F,...E?{note_a:Math.max(1,Number(S.note_a)||0)}:{}}});if(!b.length)return;const v=Kt(b,c.modifiers[n]||{});D(n,b.map(k=>k.cardId)),b.forEach(k=>{const S=(g[k._role]||[]).find(E=>E.cardId===k.cardId);S&&(S.used=!0)}),c["selected_"+n]=[],me();const w=[...c.log||[]];if(y){const k=(c[n+"Score"]||0)+1,S=b.map(F=>({name:F.name,note:Se(F,F._line||"ATT"),portrait:He(F),job:F.job}));w.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:S,homeTotal:v.total,aiTotal:0});const E=(c.round||0)+1,L=n==="p1"?"p2":"p1",A={...c,[n+"Team"]:g,[n+"Score"]:k},M=qe(A);P.add(E),Ee(S,k,c[x+"Score"]||0,!0,async()=>{await K({[n+"Team"]:g,[n+"Score"]:k,["selected_"+n]:[],modifiers:{...c.modifiers,[n]:{}},pendingAttack:null,phase:M?"finished":L+"-attack",attacker:L,round:E,log:w}),M&&await ze({...c,[n+"Score"]:k})});return}w.push({type:"pending",text:`⚔️ ${c[n+"Name"]} attaque (${v.total})`}),await K({[n+"Team"]:g,[x+"Team"]:c[x+"Team"],pendingAttack:{...v,players:b,side:n},["selected_"+n]:[],modifiers:{...c.modifiers,[n]:{}},phase:x+"-defense",log:w})}async function ue(){const g=c[n+"Team"],y=(c["selected_"+n]||[]).map(G=>{const W=(g[G._role]||[]).find(be=>be.cardId===G.cardId)||G,te=g[G._role]||[],Z=te.findIndex(be=>be.cardId===G.cardId),fe=st(te.length),ye=Z>=0?fe[Z]:W._col??1;return{...W,_line:G._role,_col:ye}}),b=Vt(y,c.modifiers[n]||{});D(n,y.map(G=>G.cardId)),y.forEach(G=>{const W=(g[G._role]||[]).find(te=>te.cardId===G.cardId);W&&(W.used=!0)}),c["selected_"+n]=[],me();const v=Yt(c.pendingAttack.total,b.total,c.modifiers[n]||{}),w=c.pendingAttack.side,k=v==="attack"||(v==null?void 0:v.goal),S=w==="p1"?"p2":"p1",E=(c.round||0)+1,L=(c.pendingAttack.players||[]).map(G=>({name:G.name,note:Se(G,G._line||"ATT"),portrait:He(G),job:G.job})),A=[...c.log||[]];A.push({type:"duel",isGoal:k,homeScored:k&&w===n,text:k?`⚽ BUT de ${c[w+"Name"]} ! (${c.pendingAttack.total} vs ${b.total})`:`✋ Attaque stoppée (${c.pendingAttack.total} vs ${b.total})`,homePlayers:L,aiPlayers:y.map(G=>({name:G.name,note:Se(G,G._line||"DEF"),portrait:He(G),job:G.job})),homeTotal:c.pendingAttack.total,aiTotal:b.total});const M=k?(c[w+"Score"]||0)+1:c[w+"Score"]||0,F={...c,[n+"Team"]:g,[w+"Score"]:M},Y=qe(F),J=Y?"finished":S+"-attack",U=async()=>{await K({[n+"Team"]:g,[x+"Team"]:c[x+"Team"],[w+"Score"]:M,["selected_"+n]:[],modifiers:{...c.modifiers,[n]:{}},pendingAttack:null,phase:J,attacker:S,round:E,log:A}),(J==="finished"||Y)&&await ze({...c,[w+"Score"]:M})};if(k){const G=w===n,W=G?M:c[n+"Score"]||0,te=G?c[x+"Score"]||0:M;P.add(E),Ee(L,W,te,G,U)}else await U()}function Le(g){return["MIL","ATT"].some(y=>(g[y]||[]).some(b=>!b.used))}function Ie(g){return["GK","DEF","MIL","ATT"].some(y=>(g[y]||[]).some(b=>!b.used))}function Ce(g){return Ie(g)&&!Le(g)}function Te(g){const y=c[g+"Team"],b=c[(g==="p1"?"p2":"p1")+"Team"];return!!(Le(y)||!Ie(b)&&Ce(y))}function qe(g){const y=["MIL","ATT"].some(A=>(g.p1Team[A]||[]).some(M=>!M.used)),b=["MIL","ATT"].some(A=>(g.p2Team[A]||[]).some(M=>!M.used)),v=Ie(g.p1Team),w=Ie(g.p2Team);return!y&&!(!w&&v)&&(!b&&!(!v&&w))}function Pe(g){const y=g.p1Score||0,b=g.p2Score||0;return y===b?null:y>b?_.home_id:_.away_id}async function ze(g){try{const y=Pe(g),b=y?_.home_id===y?_.away_id:_.home_id:null,v=g.p1Score||0,w=g.p2Score||0;await z.from("matches").update({status:"finished",winner_id:y,home_score:v,away_score:w}).eq("id",i);const{data:k}=await z.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(k){await z.from("mini_league_matches").update({home_score:v,away_score:w,status:"finished"}).eq("id",k.id);const{data:S}=await z.from("mini_league_matches").select("id, status").eq("league_id",k.league_id).eq("matchday",k.matchday);if((S||[]).every(L=>L.status==="finished"||L.status==="bye")){const{data:L}=await z.from("mini_leagues").select("current_day,total_days").eq("id",k.league_id).single();if(L){const A=(L.current_day||0)+1,M=A>(L.total_days||0);await z.from("mini_leagues").update({current_day:M?L.total_days:A,status:M?"finished":"active"}).eq("id",k.league_id)}}}y&&b&&zi(y,b).catch(()=>{})}catch(y){console.error("[ML] finishMatch:",y)}}function q(){var w;if(T&&document.getElementById("pvp-end-overlay"))return;T=!0;const g=c[n+"Score"],y=c[x+"Score"],b=g>y,v=g===y;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(w=document.getElementById("pvp-home"))==null||w.addEventListener("click",()=>{try{z.removeChannel(V)}catch{}Ve(e),l("mini-league",a?{openLeagueId:a}:{})})}me()}const pr="/",ur=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function fr(e,t,i){let o=0;const d=document.createElement("div");d.id="tutorial-overlay",d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const s=()=>{var n,x,f;const l=t[o],u=o===t.length-1,a=Math.round((o+1)/t.length*100);d.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let u="buy";const a=()=>{var m,c,T,p,I,B,C;return{name:(((m=document.getElementById("flt-name"))==null?void 0:m.value)||"").toLowerCase().trim(),club:(((c=document.getElementById("flt-club"))==null?void 0:c.value)||"").toLowerCase().trim(),country:(((T=document.getElementById("flt-country"))==null?void 0:T.value)||"").toLowerCase().trim(),job:((p=document.getElementById("flt-job"))==null?void 0:p.value)||"",rarity:((I=document.getElementById("flt-rarity"))==null?void 0:I.value)||"",note1:parseInt((B=document.getElementById("flt-note1"))==null?void 0:B.value)||0,note2:parseInt((C=document.getElementById("flt-note2"))==null?void 0:C.value)||0}};function n(m){const c=a();return m.filter(T=>{var V,K,oe;const p=(V=T.card)==null?void 0:V.player;if(!p)return!1;const I=`${p.firstname} ${p.surname_encoded}`.toLowerCase(),B=(((K=p.clubs)==null?void 0:K.encoded_name)||"").toLowerCase(),C=(p.country_code||"").toLowerCase(),P=((oe=T.card)==null?void 0:oe.evolution_bonus)||0,j=St(p,p.job,P),N=p.job2?St(p,p.job2,P):0;return!(c.name&&!I.includes(c.name)||c.club&&!B.includes(c.club)||c.country&&!C.includes(c.country)||c.job&&p.job!==c.job||c.rarity&&p.rarity!==c.rarity||c.note1&&j<c.note1||c.note2&&N<c.note2)})}function x(m){var N,V,K,oe;const c=(N=m.card)==null?void 0:N.player;if(!c)return"";const T=((V=m.card)==null?void 0:V.evolution_bonus)||0,p=St(c,c.job,T),I=c.job2?St(c,c.job2,T):0,B=(i.profile.credits||0)>=m.price,C=c.country_code?`https://flagsapi.com/${c.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,P=Qt[c.job]||"#bbb",j=c.job2?Qt[c.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
      ...
      <div style="text-align:right;flex-shrink:0">
        ...
        <button class="btn btn-primary btn-sm" data-buy="${m.id}" ${B?"":"disabled"} style="margin-top:4px;font-size:11px;padding:4px 10px">${B?"Acheter":"Trop cher"}</button>
      </div>
    </div>`}function f(m){var N,V,K,oe;const c=(N=m.card)==null?void 0:N.player;if(!c)return"";const T=((V=m.card)==null?void 0:V.evolution_bonus)||0,p=St(c,c.job,T),I=c.job2?St(c,c.job2,T):0,B=m.status==="sold",C=c.country_code?`https://flagsapi.com/${c.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,P=Qt[c.job]||"#bbb",j=c.job2?Qt[c.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${B?"opacity:0.7":""}">
      ${C?`<img src="${C}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(K=c.clubs)!=null&&K.logo_url?`<img src="${c.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${P};display:flex;align-items:center;justify-content:center">
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="font-size:10px;color:${B?"#22c55e":"#999"};margin-top:1px">
          ${B?`✅ Vendu à ${((oe=m.buyer)==null?void 0:oe.pseudo)||"—"} · ${m.sold_at?new Date(m.sold_at).toLocaleDateString("fr"):""}`:`🟢 En vente depuis le ${new Date(m.listed_at).toLocaleDateString("fr")}`}
        </div>
      </div>
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:14px;font-weight:900;color:#D4A017">${m.price.toLocaleString("fr")}</div>
        ${B?'<span style="font-size:10px;font-weight:700;color:#fff;background:#22c55e;padding:3px 8px;border-radius:10px;display:inline-block;margin-top:4px">VENDU</span>':`<button class="btn btn-danger btn-sm" data-cancel="${m.id}" style="margin-top:4px;font-size:11px;padding:4px 10px">Retirer</button>`}
      </div>
    </div>`}function h(){const m=document.getElementById("mkt-content"),c=document.getElementById("mkt-filters");if(m){if(c.style.display=u==="buy"?"flex":"none",u==="buy"){const T=n(r);m.innerHTML=T.length?T.map(x).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const T=l.filter(I=>I.status==="active").sort((I,B)=>new Date(B.listed_at)-new Date(I.listed_at)),p=l.filter(I=>I.status==="sold").sort((I,B)=>new Date(B.sold_at||B.listed_at)-new Date(I.sold_at||I.listed_at));m.innerHTML=(T.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${T.length})</div>`+T.map(f).join(""):"")+(p.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${p.length})</div>`+p.map(f).join(""):"")+(!T.length&&!p.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}m.querySelectorAll("[data-buy]").forEach(T=>T.addEventListener("click",()=>xr(T.dataset.buy,r,e,t))),m.querySelectorAll("[data-cancel]").forEach(T=>T.addEventListener("click",()=>br(T.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(m=>{m.addEventListener("click",()=>{u=m.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(c=>{const T=c===m;c.style.background=T?"var(--green)":"#fff",c.style.color=T?"#fff":"var(--gray-600)",c.style.borderColor=T?"var(--green)":"var(--gray-200)"}),h()})});let _;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(m=>{var c;(c=document.getElementById(m))==null||c.addEventListener("input",()=>{clearTimeout(_),_=setTimeout(h,250)})}),h()}async function xr(e,t,i,o){const{state:d,toast:s,refreshProfile:r}=o,l=t.find(n=>n.id===e);if(!l)return;const u=l.price;if((d.profile.credits||0)<u){s("Crédits insuffisants","error");return}yr(l,async()=>{const{error:n}=await z.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:d.profile.id});if(n){s("Erreur achat : "+n.message,"error");return}await r();const x=document.getElementById("nav-credits");x&&(x.textContent=`💰 ${(d.profile.credits||0).toLocaleString("fr")}`),s("✅ Carte achetée !","success"),await Ai(i,o)})}function yr(e,t){var r;const i=(r=e.card)==null?void 0:r.player,o=i?`${i.firstname} ${i.surname_encoded}`:"cette carte",d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",d.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const T=r||[];_.innerHTML=T.length>0?T.map((p,I)=>{const B=Nt(p.mmr??1e3),C=(p.ranked_wins||0)+(p.ranked_losses||0)+(p.ranked_draws||0),P=C>0?Math.round((p.ranked_wins||0)/C*100):0,j=p.id===i.profile.id,N=(p.placement_matches||0)<10;return`
  ...
  </div>`,u(),(f=document.getElementById("tab-global"))==null||f.addEventListener("click",()=>{l="global",u()}),(h=document.getElementById("tab-ranked"))==null||h.addEventListener("click",()=>{l="ranked",u()})}async function vr(e,t){var P,j,N,V;const{state:i,navigate:o,toast:d}=t,s=i.profile;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:r},{data:l}]=await Promise.all([z.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),z.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",s.id).single()]);if(!l){d("Erreur chargement profil","error"),o("home");return}if(!r){e.innerHTML=`
  ...
  <div style="min-height:100%;background:${p[_.id]};padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
    ...
    <div style="background:rgba(0,0,0,0.3);border-radius:12px;padding:12px 16px">
      ...
      <div style="text-align:center;font-size:11px;color:rgba(255,255,255,0.4);margin-top:4px">${m}% vers ${T?T.label:"Maître"}</div>
    </div>`:""}
  ...
  </div>`,(j=document.getElementById("ranked-back"))==null||j.addEventListener("click",()=>o("home")),(N=document.getElementById("ranked-leaderboard-btn"))==null||N.addEventListener("click",()=>o("rankings",{tab:"ranked"})),(V=document.getElementById("ranked-play-btn"))==null||V.addEventListener("click",()=>{o("match",{matchMode:"ranked",rankedData:{mmr:u,rd:a,sigma:n,isPlacement:f}})})}async function wr(e,{state:t,navigate:i,toast:o}){const d=t.profile;if(!d)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await z.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${d.id},away_id.eq.${d.id}`).order("created_at",{ascending:!1}).limit(50),r={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},l=(s||[]).filter(n=>n.status==="finished"),u=(s||[]).filter(n=>n.status==="in_progress");function a(n){const x=n.home_id===d.id;x?n.home_score:n.away_score,x?n.away_score:n.home_score;const f=n.winner_id===d.id,h=n.home_score===n.away_score&&n.status==="finished",_=n.status!=="finished"?"…":h?"N":f?"V":"D",m=n.status!=="finished"||h?"#888":f?"#1A6B3C":"#c0392b";let c=r[n.mode]||n.mode;n.away_id===null&&!c.startsWith("IA")&&(c="IA");const p=n.home_id===d.id?n.away:n.home;let I;n.away_id===null?I=c:p?I=`${p.club_name||p.pseudo} (${p.pseudo})`:I="Adversaire";let B="";n.status==="in_progress"&&Date.now()-new Date(n.created_at).getTime()>3600*1e3&&(B=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const C=new Date(n.created_at),P=C.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+C.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),j=n.status==="finished"?`${n.home_score} - ${n.away_score}`:`${n.home_score||0} - ${n.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
        <div style="font-size:13px;font-weight:600">${I}${B}</div>
        <div style="font-size:11px;color:var(--gray-600)">${c} · ${P}${n.status==="in_progress"?" · en cours":""}</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(d=>{d.addEventListener("click",s=>{s.preventDefault(),Gt(d.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Gt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Gt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>kr())}async function kr(){const{data:e}=await z.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(o=>{const d=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",o=>{o.target===t&&t.remove()})}async function Er(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&_i()}),document.getElementById("modal-close").addEventListener("click",_i);const{data:{session:e}}=await z.auth.getSession();if(!e){Ki(),Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:At});return}De.user=e.user,await Ft(),Ki();try{const{data:i}=await z.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(d=>{o[d.formation]=d.links}),_n(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!De.profile){En(document.getElementById("app"),{state:De,navigate:async()=>{await Ft(),gi()},toast:At,refreshProfile:Ft});return}const t=Array.isArray(De.profile.pending_boosters)?De.profile.pending_boosters:[];if(!De.profile.onboarding_done&&t.length>0){vo(document.getElementById("app"),{state:De,navigate:()=>gi(),toast:At,refreshProfile:Ft});return}gi(),setTimeout(()=>gr(De.profile,Gt,At),800),z.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(De.user=null,De.profile=null,document.getElementById("app").innerHTML="",Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:At}))})}function Tr(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function di(){const e=document.getElementById("app");e&&(e.style.height=Tr()+"px")}window.addEventListener("resize",di);window.addEventListener("orientationchange",()=>setTimeout(di,150));window.visualViewport&&window.visualViewport.addEventListener("resize",di);function gi(){const e=()=>{var i;(i=De.user)!=null&&i.id&&z.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",De.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",di(),$r(),bn()}function Ki(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function hn(e){var o;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
