import{s as g}from"./supabase-z_u0vv5N.js";function ve(t,{navigate:e,toast:i}){t.innerHTML=`
  ...
  <div class="page">
    ...
    </div>`;const h=document.getElementById("deck-rows");a.forEach((m,b)=>{var C;const x=((C=m[0])==null?void 0:C.replace(/\d+/,""))||"ATT",_=document.createElement("div");_.style.cssText="display:flex;align-items:center;justify-content:center;gap:0;position:relative",_.dataset.lineIdx=b,m.forEach((M,A)=>{const I=d(M),E=q[x],S=I?f(I,x):null,G=I?ae(I):null,B=document.createElement("div");if(B.className=I?"formation-slot filled":"formation-slot",B.dataset.pos=M,B.dataset.lineIdx=b,B.dataset.slotIdx=A,B.style.cssText=`border-color:${I?E:"rgba(255,255,255,0.4)"};background:${I?E:"transparent"};cursor:pointer;position:relative;width:${k}px;height:${y}px;flex-shrink:0;`,I&&G){const j=document.createElement("img");j.src=G,j.style.cssText="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;border-radius:6px;opacity:0.75",B.appendChild(j)}if(I?B.innerHTML+=`
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(p=document.getElementById("close-selector"))==null||p.addEventListener("click",o),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],o(),O(i,e,n)}),document.querySelectorAll(".player-option").forEach(k=>{k.addEventListener("click",()=>{e.slots[t]=k.dataset.cardId,o(),O(i,e,n)})})}function lt(t,e,i){var s;const{openModal:n,closeModal:r}=i,o=new Set;Object.values(t.slots).filter(Boolean).forEach(d=>{var f;const c=t.playerCards.find(u=>u.id===d);(f=c==null?void 0:c.player)!=null&&f.id&&o.add(c.player.id)}),t.subs.forEach(d=>{var f;const c=t.playerCards.find(u=>u.id===d);(f=c==null?void 0:c.player)!=null&&f.id&&o.add(c.player.id)});const a=new Set,l=t.playerCards.filter(d=>{var c,f,u;return o.has((c=d.player)==null?void 0:c.id)||a.has((f=d.player)==null?void 0:f.id)?!1:(a.add((u=d.player)==null?void 0:u.id),!0)});n("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${f.map((w,k)=>{const y=De(w),v=k<f.length-1?Z(w,f[k+1]):null;return`
          <div style="width:52px;height:52px;border-radius:8px;background:${p};position:relative;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,0.3)">
            ...
            <div style="position:relative;z-index:1;font-size:15px;font-weight:900;color:#fff;text-shadow:0 1px 3px #000">${T(w,"MIL")}</div>
  ...
  <div class="match-screen">
    ...
    <div class="match-field" id="match-field">
      ${Lt(e.homeTeam,e.formation,e.phase,r)}
    </div>
