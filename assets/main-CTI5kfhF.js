...
import{s as v,l as Ut,m as qi,F as Di,r as Se,j as Rt,h as Fi,n as Qn,o as Zn,T as bi,k as eo,p as to,b as io}from"./formation-links-Bb-Ce4un.js";const no="/";function nn(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,m;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var x;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),m=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",y=m.trim().split(" ").filter(Boolean),f=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():m.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=f,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(m){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(m){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),y=document.getElementById("step3-finish");m.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:f}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(f)throw f;await ro(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(f){m.textContent=f.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function ro(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const ao="modulepreload",so=function(e){return"/"+e},on={},wn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=so(d),d in on)return;on[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":ao,c||(m.as="script"),m.crossOrigin="",m.href=d,s&&m.setAttribute("nonce",s),document.head.appendChild(m),c)return new Promise((y,f)=>{m.addEventListener("load",y),m.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Jt="#1A6B3C",Qt="#cc2222",lo="#D4A017",rn="#888";async function co(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`}function uo(e,t){const i=Pi();i.innerHTML=`
    <div class="popup-box">
    ...
    ${Gi()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",E=>{E.target===h&&h.remove()})}function Pi(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function Gi(){return`
    <style>
      .popup-box {
    ...
    </style>`}const mo="2026.07.21-1200";async function an(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`}function ln(e,t,i,n={}){const{width:r=140,onClick:o}=n,a=Math.round(r*Ni),s=Oi.stadium,d=Math.max(8,Math.round(r*(e&&e.length>16?.058:.072))),c=Math.max(7,Math.round(r*.062));return`<div class="special-card special-card-stadium" style="position:relative;width:${r}px;height:${a}px;flex-shrink:0;${o?"cursor:pointer":""}">
    <img src="${Hi("stadium")}" style="position:absolute;inset:0;width:100%;height:100%;z-index:0;pointer-events:none" alt="">
  ...
  </div>`}const To={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},hi={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},ni=["GK","DEF","MIL","ATT"],zo=["Tous","GK","DEF","MIL","ATT"],Io={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function pn(e){const t=e.player;if(!t)return null;const i=t.rarity;return(i==="pepite"||i==="papyte")&&e.current_note!=null?e.current_note:Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function So(e){return e.length?e.reduce((t,i)=>pn(i)>pn(t)?i:t,e[0]):e[0]}function Ao(e){return e==="GK"?"note_g":e==="DEF"?"note_d":e==="MIL"?"note_m":"note_a"}const Mo={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Co(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function vi(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function wi(e,t=""){const i=e.player;if(!i)return"";const n=e.evolution_bonus||0,r={...i,_evolution_bonus:n},o=t?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${t}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${e.id}">
    ${o}
    ${Se(r,{width:140})}
    ...
    ${Se(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),m=(s||[]).filter($=>$.card_type==="formation"),y=(s||[]).filter($=>$.card_type==="stadium"),{data:f}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(f||[]).forEach($=>{x[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),y.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const b=Object.keys(Di),w=Object.keys(Be),h={};c.forEach($=>{const R=$.player.id;h[R]=(h[R]||0)+1}),new Set(Object.keys(h).map($=>String($)));const E=new Set(m.map($=>$.formation)),g=new Set(l.map($=>$.gc_type));let M="player",k="Tous",S="",q=!1;function te(){return[...c].sort(($,R)=>{const V=ni.indexOf($.player.job),U=ni.indexOf(R.player.job);return V!==U?V-U:($.player.surname_real||"").localeCompare(R.player.surname_real||"")})}function ie(){return[...d||[]].sort(($,R)=>{const V=ni.indexOf($.job),U=ni.indexOf(R.job);return V!==U?V-U:($.surname_real||"").localeCompare(R.surname_real||"")})}function ee(){return te().filter($=>{const R=$.player,V=k==="Tous"||R.job===k,U=!S||`${R.firstname} ${R.surname_real}`.toLowerCase().includes(S);return V&&U})}function j(){return ie().filter($=>{const R=k==="Tous"||$.job===k,V=!S||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(S);return R&&V})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",R=>{S=R.target.value.toLowerCase(),K()}),e.querySelectorAll(".filter-btn").forEach(R=>{R.addEventListener("click",()=>{k=R.dataset.job,z(),K()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{q=!q,z(),K()})):($.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{q=!q,z(),K()})))}function K(){const $=document.getElementById("col-grid");$&&(M==="player"?Y($):M==="formation"?ue($):M==="stadium"?H($):G($))}function X($,R,V,U,re,B=0){const N=document.getElementById("col-grid"),pe=document.getElementById("col-big");if(!N||!pe)return;var de=0;function we(){var Ne;const Ae=window.innerWidth>=768,ve=document.getElementById("col-big"),ze=document.getElementById("col-gap"),Me=((Ne=document.getElementById("col-grid"))==null?void 0:Ne.parentElement)||null,Pe=ve?ve.closest(".page"):null;if(ve&&Me&&Pe){let ke=0;Array.from(Pe.children).forEach(function(A){A!==ve&&A!==Me&&A!==ze&&(ke+=A.offsetHeight)});const Ie=Math.max(0,Pe.clientHeight-ke),Ce=Math.round(Ie*(B/100)),qe=Math.max(0,Ie-Ce),_=Ae?50/71:45/63,L=Math.round(qe*_),I=Math.max(0,qe-L);ze&&(ze.style.height=Ce+"px"),ve.style.flex="none",ve.style.height=L+"px",ve.style.minHeight="0",Me.style.flex="none",Me.style.height=I+"px",Me.style.minHeight="0",Me.style.display="flex",Me.style.overflow="hidden"}const _e=document.getElementById("col-grid");_e&&(_e.style.height="100%",_e.style.flexShrink="0",_e.style.overflowX="auto",_e.style.overflowY="hidden",_e.style.alignItems="center",_e.style.width="100%"),pe.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+R($[de])+"</div>";var Ye=pe.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ye&&Ye.addEventListener("click",function(){U($[de])}),requestAnimationFrame(function(){var ke=document.getElementById("big-card-inner");if(!(!ke||!pe)){var Ie=pe.clientHeight,Ce=pe.clientWidth-16,qe=ke.offsetHeight,_=ke.offsetWidth;if(qe>0&&_>0&&Ie>40){var L=Math.min(Ie/qe,Ce/_);ke.style.transform="scale("+L.toFixed(3)+")",ke.style.transformOrigin="center center"}}}),N.innerHTML=$.map(function(ke,Ie){var Ce=Ie===de,qe="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Ce?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ie+'" style="'+qe+'">'+V(ke,Ce)+"</div>"}).join(""),N.querySelectorAll(".col-mini-item").forEach(function(ke){ke.addEventListener("click",function(){de=Number(ke.dataset.idx),we(),ke.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var ke=_e?_e.clientHeight:0,Ie=N.querySelector(".col-mini-item > div");if(!(!ke||!Ie)){var Ce=Ie.style.zoom;Ie.style.zoom="1";var qe=Ie.offsetHeight;if(Ie.style.zoom=Ce,!(qe<=0)){var _=ke/qe;N.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=_.toFixed(4)})}}})}we()}function ce($){var R=window.innerWidth>=768?.76:.54,V;if(!$||$._fake){var U=$?$.player:null;if(!U)return"";V=un(U)}else V=wi($,"");return'<div style="display:inline-block;zoom:'+R+';pointer-events:none;line-height:0">'+V+"</div>"}function fe($,R,V){var U=V>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+V+"</div>":"",re=!!R,B=cn($,Rt[$],{width:160});return re||(B='<div style="filter:grayscale(1);opacity:0.5">'+B+"</div>"),"<div "+(R?'data-form-id="'+R.id+'"':"")+' style="position:relative;cursor:pointer">'+U+B+"</div>"}function C($,R){var V=window.innerWidth>=768?.76:.54,U=cn($,Rt[$],{width:140});return R||(U='<div style="filter:grayscale(1);opacity:0.45">'+U+"</div>"),'<div style="display:inline-block;zoom:'+V+';line-height:0;pointer-events:none">'+U+"</div>"}function Y($){if(q){const R=j();if(!R.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const V=R.map(U=>c.find(re=>re.player.id===U.id)||{_fake:!0,player:U,id:"fake-"+U.id});X(V,U=>U._fake?un(U.player):wi(U,""),U=>U._fake?ce({player:U.player,id:"x",_fake:!0}):ce(U),U=>{U._fake||fn(U,c,h,t)})}else{const R=ee();if(!R.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const V={};R.forEach(re=>{const B=re.player.id;V[B]||(V[B]=[]),V[B].push(re)});const U=Object.values(V).map(re=>So(re));X(U,re=>{const B=h[re.player.id]||1,N=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",de=c.filter(we=>we.player.id===re.player.id&&we.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return wi(re,N+de)},re=>ce(re),re=>fn(re,c,h,t))}}function ue($){const R=q?b:[...E];if(!R.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const V=R.map(U=>({formation:U,card:m.find(re=>re.formation===U)||null,owned:E.has(U)}));X(V,({formation:U,card:re,owned:B})=>fe(U,B?re:null,B?m.filter(N=>N.formation===U).length:0),({formation:U,owned:re})=>C(U,re),({card:U,owned:re})=>{re&&U&&qo(U,m,t,o)},"#1A6B3C",5)}function G($){const R=Object.keys(x),V=q?R.length?R:w:[...g];if(!V.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const U=V.map(re=>({type:re,gc:Be[re]||{icon:"⚡",desc:""},def:x[re]||null,owned:g.has(re),card:l.find(B=>B.gc_type===re)||null}));X(U,({type:re,gc:B,def:N,owned:pe,card:de})=>{var _e;const we=(N==null?void 0:N.name)||re,Ae=pe?l.filter(Ye=>Ye.gc_type===re).length:0,ve=Ae>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ae}</div>`:"",ze=(N==null?void 0:N.effect)||B.desc||"",Me=N!=null&&N.image_url?`/icons/${N.image_url}`:((_e=N==null?void 0:N.club)==null?void 0:_e.logo_url)||(N!=null&&N.country_code?`https://flagsapi.com/${N.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Pe=Li(we,Me,B.icon,ze,{width:160,onClick:pe});return pe||(Pe=`<div style="filter:grayscale(1);opacity:0.5">${Pe}</div>`),`<div ${pe&&de?`data-gc-id="${de.id}" data-gc-type="${re}"`:""} style="position:relative">${ve}${Pe}</div>`},({type:re,gc:B,def:N,owned:pe})=>{const de=window.innerWidth>=768?.76:.54,we=(N==null?void 0:N.name)||re,Ae=(N==null?void 0:N.effect)||B.desc||"",ve=N!=null&&N.image_url?`/icons/${N.image_url}`:null;let ze=Li(we,ve,B.icon,Ae,{width:140});return pe||(ze=`<div style="filter:grayscale(1);opacity:0.45">${ze}</div>`),`<div style="display:inline-block;zoom:${de};line-height:0;pointer-events:none">${ze}</div>`},({type:re,owned:B,def:N})=>{B&&Bo(re,N,o)},"#7a28b8",5)}function H($){const R="#4FC3F7",V="/";if(!y.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const U={};y.forEach(B=>{const N=B.stadium_id||"?";(U[N]=U[N]||[]).push(B)});const re=Object.entries(U).map(([B,N])=>({sid:B,def:u[B]||null,count:N.length,card:N[0]}));X(re,({def:B,count:N})=>{var ze,Me;const pe=(B==null?void 0:B.name)||"?",de=((ze=B==null?void 0:B.club)==null?void 0:ze.encoded_name)||(B==null?void 0:B.country_code)||"—",we=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((Me=B==null?void 0:B.club)==null?void 0:Me.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Ae=N>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${N}</div>`:"",ve=`${de}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${Ae}${ln(pe,we,ve,{width:160})}</div>`},({def:B})=>{var ve,ze;const N=window.innerWidth>=768?.76:.54,pe=(B==null?void 0:B.name)||"?",de=((ve=B==null?void 0:B.club)==null?void 0:ve.encoded_name)||(B==null?void 0:B.country_code)||"—",we=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((ze=B==null?void 0:B.club)==null?void 0:ze.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Ae=`${de}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${N};line-height:0;pointer-events:none">${ln(pe,we,Ae,{width:140})}</div>`},null,R,5)}e.querySelectorAll(".col-tab-btn").forEach($=>{$.addEventListener("click",()=>{M=$.dataset.tab,k="Tous",S="",q=!1,e.querySelectorAll(".col-tab-btn").forEach(R=>{const V=R.dataset.tab===M;R.style.borderBottomColor=V?"var(--green)":"transparent",R.style.color=V?"var(--green)":"var(--tile-fg-dim)"}),z(),K()})}),z(),K()}function Bo(e,t,i){const n=Be[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.name)||e,o=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${Li(r,a,n.icon,o,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const oi=1e3;function qo(e,t,i,n){var x,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:d}=i,c=e.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function m(){const b=Rt[c]||{},w=Di[c]||[],h=290,E=360,g=20;function M(S){const q=b[S];return q?{x:q.x*h,y:q.y*E}:null}let k=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[S,q]of w){const te=M(S),ie=M(q);!te||!ie||(k+=`<line x1="${te.x}" y1="${te.y}" x2="${ie.x}" y2="${ie.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const S of Object.keys(b)){const q=M(S);if(!q)continue;const te=S.replace(/\d+/,""),ie=l[te]||"#555";k+=`<circle cx="${q.x}" cy="${q.y}" r="${g}" fill="${ie}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,k+=`<text x="${q.x}" y="${q.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${te}</text>`}return k+="</svg>",k}const y=t.filter(b=>b.formation===c);y.length;const f=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([G,H])=>{const $=hi[G],R=G==="GK"?"#fff":$,V=G===l.job||G===l.job2,U=(Number(H)||0)+(V&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(fe=document.getElementById("close-detail"))==null||fe.addEventListener("click",s);let K=new Set;const X=()=>{const G=K.size,H=document.getElementById("sell-action-panel");if(!H)return;H.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G;const $=document.getElementById("evolve-btn");$&&($.textContent=`⬆️ Évoluer ${G>1?"(+"+G+")":""}`)};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const H=G.dataset.id;G.checked?K.add(H):K.delete(H);const $=G.closest(".exemplaire-row");$&&($.style.borderColor=G.checked?"#1A6B3C":"#eee"),X()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",H=>{if(H.target.closest("button")||H.target.tagName==="INPUT")return;const $=G.querySelector(".expl-check");$&&!$.disabled&&($.checked=!$.checked,$.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",H=>{H.stopPropagation();const $=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);$&&($.style.display=$.style.display==="none"?"flex":"none")})}),(C=document.getElementById("evolve-btn"))==null||C.addEventListener("click",async()=>{if(y<=1)return;const G=[...K];if(!G.length)return;if(K.has(e.id)){const B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",B.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const r=o=>{n.remove(),i(o)};n.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),n.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),n.addEventListener("click",o=>{o.target===n&&r(!1)})})}const si={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Ti(e,t){const{state:i,navigate:n,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const E=xn(t.formation),g={};E.forEach(M=>{t.slots[M]&&(g[M]=t.slots[M])}),t.slots=g,b(),wt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",f)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Po(t,e,i))),e.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>No(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==u.dataset.removeSub),wt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>Ro(t,e,i)))}function Fo(e,t,i,n){var h,E,g;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=t.stadiumCards)==null?void 0:h.find(M=>M.id===t.stadiumCardId),s=a&&((E=t.stadDefMap)==null?void 0:E[a.stadium_id])||null,d=Rt[t.formation]||{},c=qi(t.formation)||[],l={};for(const M of i){const k=t.slots[M],S=k?t.playerCards.find(q=>q.id===k):null;S!=null&&S.player?l[M]={...S.player,_evolution_bonus:S.evolution_bonus||0,face:S.player.face||null}:l[M]=null}const m=window.innerWidth>=900,y=m?window.innerWidth-280:window.innerWidth-20,f=m?Math.min(y,860):y,x=Math.round(m?f*.82:f*.85),p=m?84:44;let u="";for(const[M,k]of c){const S=d[M],q=d[k];if(!S||!q)continue;const te=S.x*f,ie=Math.round(.03*x+S.y*.85*x),ee=q.x*f,j=Math.round(.03*x+q.y*.85*x),z=l[M],K=l[k],X=Ut(z,K);X==="#ff3333"||X==="#cc2222"?u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const w=Math.round(p*657/507);for(const M of i){const k=d[M];if(!k)continue;const S=l[M],q=k.x*f;k.y*x;const te=Math.round(.03*x+k.y*(.85*x)),ie=Math.round(q-p/2),ee=Math.round(te-w/2);if(S){const j=M.replace(/\d+/,""),z=s&&(s.club_id&&String(S.club_id)===String(s.club_id)||s.country_code&&S.country_code===s.country_code),K=Se({...S,_evolution_bonus:S._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:j}),X=z&&(((g=s.club)==null?void 0:g.logo_url)||s.image_url)||null,ce=Math.round(p*.34),fe=z?`<div style="position:absolute;top:2px;right:2px;width:${ce}px;height:${ce}px;border-radius:50%;background:rgba(0,0,0,0.6);border:1.5px solid #4FC3F7;display:flex;align-items:center;justify-content:center;overflow:hidden;z-index:6">${X?`<img src="${X}" style="width:100%;height:100%;object-fit:cover">`:`<span style="font-size:${Math.round(ce*.6)}px;line-height:1">🏟️</span>`}</div>`:"";b+=`<div style="position:absolute;left:${ie}px;top:${ee}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${M}">
    ...
    <div style="position:relative;width:${f}px;height:${x}px;margin:0 auto">
      ...
      ${b}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(M=>{M.addEventListener("click",()=>Go(M.dataset.pos,t,e,n))})}function Po(e,t,i){var a;const{openModal:n,closeModal:r}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=z=>z.touches&&z.touches[0]?z.touches[0].clientX:z.clientX;function l(z){o||(d=!0,s.style.opacity="1",m(z))}function m(z){if(!d||o)return;const K=a.getBoundingClientRect(),X=c(z)-K.left,ce=Math.max(0,Math.min(1,X/K.width));s.style.width=ce*K.width+"px",ce>=.82&&f()}function y(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function f(){var K;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(K=document.getElementById("cut-flash"))==null||K.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const z=document.getElementById("cut-hint");z&&(z.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",m),window.addEventListener("pointerup",y),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",y);let x=0,p=!1;const u=new Set;function b(z){x=z,document.getElementById("reveal-phase").style.display="flex",w(),h(z,0),S()}function w(){const z=document.getElementById("card-dots");z&&(z.innerHTML=e.map((K,X)=>`<div class="card-dot" data-i="${X}" style="width:8px;height:8px;border-radius:50%;background:${X===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),z.querySelectorAll(".card-dot").forEach(K=>K.addEventListener("click",()=>g(parseInt(K.dataset.i)))))}function h(z,K){var $,R;const X=e[z],ce=document.getElementById("card-counter"),fe=document.getElementById("card-track");ce&&(ce.textContent=`Carte ${z+1} / ${e.length}`);const C=document.getElementById("reveal-btns");C&&(C.style.display=z===e.length-1?"flex":"none");const Y=X.card_type==="player"&&(($=X.player)==null?void 0:$.rarity)==="legende",ue=!u.has(z);u.add(z);let G=0;if(X.card_type==="player"&&X.player){const V=X.player,U=V.job||"ATT";G=Number(U==="GK"?V.note_g:U==="DEF"?V.note_d:U==="MIL"?V.note_m:V.note_a)||0}const H=V=>{fe.innerHTML=`
        ...
        ${H}
      </div>`,R&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(N+pe)*3),setTimeout(B,(N+pe)*3+N),setTimeout(()=>{V.style.display="none",U.innerHTML="",p=!1,re&&!$&&re.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),K()},(N+pe)*4)}function g(z){if(p||z<0||z>=e.length||z===x)return;const K=z>x?1:-1;x=z,h(z,K)}function M(){g(x+1)}function k(){g(x-1)}function S(){const z=document.getElementById("card-viewport");if(!z||z._swipeBound)return;z._swipeBound=!0;let K=0,X=0,ce=0,fe=!1;const C=$=>$.touches?$.touches[0].clientX:$.clientX,Y=$=>$.touches?$.touches[0].clientY:$.clientY,ue=$=>{fe=!0,K=C($),X=Y($),ce=0},G=$=>{if(!fe)return;ce=C($)-K;const R=Y($)-X;if(Math.abs(ce)<Math.abs(R))return;const V=document.getElementById("current-card-wrap");V&&(V.style.transition="none",V.style.transform=`translateX(${ce*.6}px) rotate(${ce*.02}deg)`)},H=()=>{if(!fe)return;fe=!1;const $=document.getElementById("current-card-wrap"),R=55;ce<=-R&&x<e.length-1?M():ce>=R&&x>0?k():$&&($.style.transition="transform .2s ease",$.style.transform="translateX(0)")};z.addEventListener("pointerdown",ue),z.addEventListener("pointermove",G),z.addEventListener("pointerup",H),z.addEventListener("pointercancel",H),z.addEventListener("touchstart",ue,{passive:!0}),z.addEventListener("touchmove",G,{passive:!0}),z.addEventListener("touchend",H),z.addEventListener("click",$=>{if(Math.abs(ce)>8)return;const R=z.getBoundingClientRect();$.clientX-R.left>R.width/2?M():k()})}let q=null;function te(){const z=document.getElementById("fireworks-canvas");if(!z)return;z.width=window.innerWidth,z.height=window.innerHeight;const K=z.getContext("2d"),X=[];function ce(){const C=Math.random()*z.width,Y=Math.random()*z.height*.6,ue=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],G=ue[Math.floor(Math.random()*ue.length)];for(let H=0;H<60;H++){const $=Math.PI*2/60*H,R=2+Math.random()*5;X.push({x:C,y:Y,vx:Math.cos($)*R,vy:Math.sin($)*R,alpha:1,color:G,size:2+Math.random()*3})}}ce(),q=setInterval(ce,600);function fe(){if(document.getElementById("fireworks-canvas")){K.clearRect(0,0,z.width,z.height);for(let C=X.length-1;C>=0;C--){const Y=X[C];if(Y.x+=Y.vx,Y.y+=Y.vy+.08,Y.vy*=.98,Y.alpha-=.018,Y.alpha<=0){X.splice(C,1);continue}K.globalAlpha=Y.alpha,K.fillStyle=Y.color,K.beginPath(),K.arc(Y.x,Y.y,Y.size,0,Math.PI*2),K.fill()}K.globalAlpha=1,(q!==null||X.length>0)&&requestAnimationFrame(fe)}}fe()}function ie(){q!==null&&(clearInterval(q),q=null);const z=document.getElementById("fireworks-canvas");z&&z.getContext("2d").clearRect(0,0,z.width,z.height)}if(n){const z=document.getElementById("reveal-btns");z&&(z.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(j=document.getElementById("reveal-next"))==null||j.addEventListener("click",()=>{ie(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ie(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ie(),r.remove(),i("boosters")})}function Jo(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return Ko(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},d={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,l=d[o==null?void 0:o.color]||d.purple,m=(o==null?void 0:o.name)||e.gc_type||"Game Changer",y=(o==null?void 0:o.effect)||((t=zi[e.gc_type])==null?void 0:t.desc)||"",f=o!=null&&o.image_url?`/icons/${o.image_url}`:null,x=((i=zi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${l};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${l}88;flex-shrink:0">
    ...
    </div>`;if(e.card_type==="stadium"){const o=e._stadiumDef,a=(o==null?void 0:o.name)||"Stade",s=((n=o==null?void 0:o.club)==null?void 0:n.encoded_name)||(o==null?void 0:o.country_code)||"—",d=o!=null&&o.image_url?`/icons/${o.image_url}`:((r=o==null?void 0:o.club)==null?void 0:r.logo_url)||(o!=null&&o.country_code?`https://flagsapi.com/${o.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return`<div style="width:160px;height:230px;background:linear-gradient(160deg,#4FC3F7,#0288D1);border-radius:14px;border:3px solid #0288D1;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px rgba(79,195,247,0.6)">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),d=[...new Set((s||[]).filter(y=>{var f,x;return((f=y.card)==null?void 0:f.card_type)==="stadium"&&((x=y.card)==null?void 0:x.stadium_id)}).map(y=>y.card.stadium_id))],c={};if(d.length){const{data:y}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(y||[]).forEach(f=>{c[f.id]=f}),(s||[]).forEach(f=>{var x,p;((x=f.card)==null?void 0:x.card_type)==="stadium"&&((p=f.card)!=null&&p.stadium_id)&&(f.card._stadiumDef=c[f.card.stadium_id]||null)})}let l=0;function m(){var g,M,k,S,q,te,ie;const y=o[l],f=(s||[]).filter(ee=>ee.deck_id===y.id),x=f.filter(ee=>{var j;return ee.is_starter&&((j=ee.card)==null?void 0:j.player)}).map(ee=>Si(ee.card,ee.position)),p=f.find(ee=>{var j;return((j=ee.card)==null?void 0:j.card_type)==="formation"}),u=y.formation||((g=p==null?void 0:p.card)==null?void 0:g.formation)||"4-4-2";let b=x.length>=11?li(x,u):null,w=((M=y.stadium_card)==null?void 0:M.stadium_def)||null;w&&b&&(b=ii(b,w));const h=x.length>=11;dt(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function ee(){const j=e.querySelector(".deck-preview-wrap"),z=e.querySelector("#deck-swipe-zone");if(!j||!z||!b)return;const K=z.clientWidth>=900,X=Math.max(200,z.clientHeight-(K?60:40)),fe=Math.max(200,z.clientWidth-16),C=K?Math.min(117,Math.max(52,Math.round(fe*.22))):Math.max(44,Math.round(fe*.168));if(X<220||fe<220){requestAnimationFrame(ee);return}const Y=K?null:Math.round(C*.55);j.innerHTML=Ot(b,u,null,[],fe,X,[],Y),j.style.cssText=`width:${fe}px;height:${X}px;overflow:hidden;margin:${K?0:60}px auto 0`;const ue=j.querySelector("svg");ue&&(ue.style.cssText="display:block;width:100%;height:100%",ue.setAttribute("preserveAspectRatio",K?"xMidYMid meet":"none"))})),(S=document.getElementById("prev-deck"))==null||S.addEventListener("click",()=>{l>0&&(l--,m())}),(q=document.getElementById("next-deck"))==null||q.addEventListener("click",()=>{l<o.length-1&&(l++,m())}),(te=document.getElementById("validate-deck"))==null||te.addEventListener("click",()=>{if(!h)return;const ee=t.state.params||{};t.navigate("match",{...ee,matchMode:ee.matchMode||i,deckId:y.id})}),(ie=document.getElementById("cancel-deck-select"))==null||ie.addEventListener("click",()=>{it(e),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let ee=0,j=0;E.addEventListener("touchstart",z=>{ee=z.touches[0].clientX,j=z.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",z=>{const K=z.changedTouches[0].clientX-ee,X=z.changedTouches[0].clientY-j;Math.abs(K)<40||Math.abs(K)<Math.abs(X)||(K<0&&l<o.length-1?(l++,m()):K>0&&l>0&&(l--,m()))},{passive:!0})}}m()}function vt(e,t=44,i=58,n=null){return Se(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Qe(e,t,i,n,r){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,d)=>{const c=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(c==="ATT"||c==="MIL")||n==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?l+=10:n||(l+=10)),a+=Se(s,{width:40,role:c,extraNote:l}),d<o.length-1){const m=o[d+1],y=Tn(s,m,r)?Ut(s,m):null;a+=`<div style="width:7px;height:3px;background:${!y||y==="#ff3333"||y==="#cc2222"?"rgba(255,255,255,0.12)":y};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function mi(e,t,i,n,r=310,o=310,a=[],s=null){const d=Rt[t]||{},c=qi(t)||Di[t]||[],l={},m=["ATT","MIL","DEF","GK"];for(const b of m)(e[b]||[]).forEach((h,E)=>{l[`${b}${E+1}`]=h});function y(b){const w=d[b];return w?{x:w.x*r,y:w.y*o}:null}let f="";for(const[b,w]of c){const h=y(b),E=y(w);if(!h||!E)continue;const g=l[b],M=l[w],k=Ut(g,M);k==="#00ff88"||k==="#FFD700"?(f+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
    ...
    ${mi(e,t,i,n,r,o,a,s)}
  </div>`}async function gi(e,t,i,n){var M;const{state:r,navigate:o,toast:a}=t;dt(e);const s=r.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return rr(e,t,i);const d=s.deckId;let c,l,m,y;try{const k=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",d).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]);c=k[0].data,m=k[0].error,l=k[1].data,y=k[1].error}catch(k){console.error("[Match] Exception chargement deck:",k),Tt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(m||y){console.error("[Match] Erreur Supabase:",m||y),Tt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const f=(l||[]).filter(k=>{var S;return k.is_starter&&((S=k.card)==null?void 0:S.player)}).map(k=>Si(k.card,k.position)),x=(l||[]).filter(k=>{var S;return!k.is_starter&&((S=k.card)==null?void 0:S.player)}).map(k=>Si(k.card,k.position));if(f.length<11){Tt(e,"⚠️",`Deck incomplet (${f.length}/11).`,"Compléter",()=>o("decks"));return}const p=(l||[]).find(k=>{var S;return((S=k.card)==null?void 0:S.card_type)==="formation"}),u=(c==null?void 0:c.formation)||((M=p==null?void 0:p.card)==null?void 0:M.formation)||"4-4-2",{data:b,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(b||[]).map(k=>({...k,_gcDef:(h==null?void 0:h.find(S=>S.name===k.gc_type||S.id===k.gc_definition_id))||null}));let g=null;if(c!=null&&c.stadium_card_id){const{data:k}=await v.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if(k!=null&&k.stadium_id){const{data:S}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",k.stadium_id).single();g=S||null}}n({deckId:d,formation:u,starters:f,subsRaw:x,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:g})}function zt(){return Math.min(window.innerWidth-40,860)}function Gt(){return Math.round(zt()*1.1)}function Pn(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:ti(e)}}function ar(e,t,i,n="Adversaire"){const r=zt(),o=Gt();return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ut(o,e[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Rn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const C=window.innerWidth>=700,Y=(B,N,pe)=>{var Ie,Ce;const de=(t.gcDefs||[]).find(qe=>qe.name===B.gc_type),we={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[de==null?void 0:de.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ae={purple:"#b06ce0",light_blue:"#00d4ef"}[de==null?void 0:de.color]||"#b06ce0",ve=(de==null?void 0:de.name)||B.gc_type,ze=(de==null?void 0:de.effect)||((Ie=Be[B.gc_type])==null?void 0:Ie.desc)||"",Me=de!=null&&de.image_url?`/icons/${de.image_url}`:null,Pe=((Ce=Be[B.gc_type])==null?void 0:Ce.icon)||"⚡",_e=Math.round(pe*.22),Ye=Math.round(pe*.22),Ne=pe-_e-Ye,ke=ve.length>12?7:9;return`<div class="gc-mini" data-gc-id="${B.id}" data-gc-type="${B.gc_type}"
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Ot(t.homeTeam,t.formation,t.phase,n,C?1300:zt(),C?600:Gt(),x)}
        </div>
      </div>`;return C?`
  ...
  <div id="match-history-panel">
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${P}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(Z=D.querySelector("#pvp-end-home"))==null||Z.addEventListener("click",()=>{D.remove(),it(e),l?f("mini-league",{openLeagueId:l}):f(a?"ranked":"home")})}const ee=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var I;const L=_.new;try{if(L.status==="finished"||L.forfeit){if(M)return;M=!0,k&&(clearInterval(k),k=null),L.game_state&&(g=L.game_state),ie(L);return}if(L.game_state){const A=g;g=L.game_state;const T=g._lastGC;if(T&&T.seq&&!te.has(T.seq)&&(te.add(T.seq),T.by!==p)){$(T.type,T.by,()=>Y());return}const P=A[p+"Score"]||0,D=A[u+"Score"]||0,F=g[p+"Score"]||0,O=g[u+"Score"]||0,Q=F>P,ne=O>D;if((Q||ne)&&!q.has(g.round)){q.add(g.round);const Z=[...g.log||[]].reverse().find(se=>se.isGoal),J=((Z==null?void 0:Z.homePlayers)||[]).map(se=>({name:se.name,note:se.note,portrait:se.portrait,job:se.job}));!!((I=Z==null?void 0:Z.text)!=null&&I.includes("DERNIER CORNER"))?Ae().then(()=>{Ze(J,F,O,Q,()=>Y())}):Ze(J,F,O,Q,()=>Y());return}Y()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function j(_){Object.assign(g,_),g.lastActionAt=new Date().toISOString();const{error:L}=await v.from("matches").update({game_state:g}).eq("id",i);L&&x("Erreur de synchronisation","error");try{Y()}catch(I){console.error("[PvP] renderPvpScreen crash:",I)}}async function z(){if(M)return;M=!0,k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,L=n?"p2":"p1",I=n?"p1":"p2",A={...g,[L+"Score"]:3,[I+"Score"]:0,phase:"finished"},T=A.p1Score||0,P=A.p2Score||0;try{await v.from("matches").update({game_state:A}).eq("id",i);const{data:D,error:F}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:T,p_away_score:P,p_forfeit:!0});if(F&&console.error("[PvP] finish_pvp_match (forfeit):",F),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(O){console.error("[PvP] check_and_finish_mini_league (forfeit):",O)}try{const{data:O}=await v.rpc("apply_match_rewards",{p_match_id:i});O!=null&&O.success&&!(O!=null&&O.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(O){console.error("[PvP] apply_match_rewards (forfeit):",O)}}catch{}try{v.removeChannel(ee)}catch{}setTimeout(()=>{it(e),l?f("mini-league",{openLeagueId:l}):f("home")},800)}const K={BOOST_STAT:({value:_=1,count:L=1,roles:I=[]},A,T)=>{const P=A[p+"Team"],D=Object.entries(P).filter(([F])=>!I.length||I.includes(F)).flatMap(([F,O])=>O.filter(Q=>!Q.used).map(Q=>({...Q,_line:F})));if(!D.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(A);return}X(D,L,`Choisir ${L} joueur(s) à booster (+${_})`,F=>{F.forEach(O=>{const Q=(P[O._line]||[]).find(ne=>ne.cardId===O.cardId);Q&&(Q.boost=(Q.boost||0)+_,A.log.push({text:`⚡ +${_} sur ${Q.name}`,type:"info"}))}),A[p+"Team"]=P,T(A)})},DEBUFF_STAT:({value:_=1,count:L=1,roles:I=[],target:A="ai"},T,P)=>{const D=A==="home"?p:u,F=T[D+"Team"],O=A==="home"?"allié":"adverse",Q=Object.entries(F).filter(([ne])=>!I.length||I.includes(ne)).flatMap(([ne,Z])=>Z.map(J=>({...J,_line:ne})));if(!Q.length){T.log.push({text:`🎯 Aucun joueur ${O}`,type:"info"}),P(T);return}X(Q,L,`Choisir ${L} joueur(s) ${O}(s) (-${_})`,ne=>{ne.forEach(Z=>{const J=(F[Z._line]||[]).find(ae=>ae.cardId===Z.cardId);J&&(J.boost=(J.boost||0)-_,T.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),T[D+"Team"]=F,P(T)})},GRAY_PLAYER:({count:_=1,roles:L=[],target:I="ai"},A,T)=>{const P=I==="home"?p:u,D=A[P+"Team"],F=I==="home"?"allié":"adverse",O=Object.entries(D).filter(([Q])=>!L.length||L.includes(Q)).flatMap(([Q,ne])=>ne.filter(Z=>!Z.used).map(Z=>({...Z,_line:Q})));if(!O.length){A.log.push({text:`❌ Aucun joueur ${F}`,type:"info"}),T(A);return}X(O,_,`Choisir ${_} joueur(s) ${F}(s) à exclure`,Q=>{const ne="usedCardIds_"+P,Z=new Set(A[ne]||[]);Q.forEach(J=>{const ae=(D[J._line]||[]).find(se=>se.cardId===J.cardId);ae&&(ae.used=!0,Z.add(J.cardId),A.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),A[ne]=[...Z],A[P+"Team"]=D,T(A)})},REVIVE_PLAYER:({count:_=1,roles:L=[]},I,A)=>{const T=I[p+"Team"],P=Object.entries(T).filter(([D])=>!L.length||L.includes(D)).flatMap(([D,F])=>F.filter(O=>O.used).map(O=>({...O,_line:D})));if(!P.length){I.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(I);return}X(P,_,`Choisir ${_} joueur(s) à ressusciter`,D=>{D.forEach(F=>{const O=(T[F._line]||[]).find(Q=>Q.cardId===F.cardId);O&&(O.used=!1,I.log.push({text:`💫 ${O.name} ressuscité !`,type:"info"}))}),I[p+"Team"]=T,A(I)})},REMOVE_GOAL:({},_,L)=>{const I=u+"Score";_[I]>0?(_[I]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(_)},ADD_GOAL_DRAW:({},_,L)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(_)},ADD_SUB:({value:_=1},L,I)=>{L.maxSubs=(L.maxSubs||3)+_,L.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),I(L)},CUSTOM:({},_,L)=>L(_)};function X(_,L,I,A){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let P=[];function D(){var O,Q;const F=_.map(ne=>{const Z=ne._line||ne.job||"MIL",J=P.find(se=>se.cardId===ne.cardId),ae=Se({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:Z,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(O=T.querySelector("#pp-close"))==null||O.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const Z=ne.dataset.cid,J=_.find(se=>se.cardId===Z),ae=P.findIndex(se=>se.cardId===Z);J&&(ae>-1?P.splice(ae,1):P.length<L&&P.push(J),D())})}),(Q=T.querySelector("#pp-confirm"))==null||Q.addEventListener("click",()=>{T.remove(),A(P)})}D(),document.body.appendChild(T)}async function ce(_,L){const A=(g["gcCardsFull_"+p]||[]).find(F=>F.id===_),T=(A==null?void 0:A._gcDef)||(g.gcDefs||[]).find(F=>{var O;return F.name===L||((O=F.name)==null?void 0:O.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),P=[...g["usedGc_"+p]||[],_],D={type:L,by:p,seq:(g._gcAnimSeq||0)+1};te.add(D.seq),$(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const O=K[T.effect_type];if(O){const Q={...g};O(T.effect_params||{},Q,async ne=>{ne["usedGc_"+p]=P,ne._lastGC=D,ne._gcAnimSeq=D.seq,await j(ne)});return}}const F={...g};switch(L){case"Remplacement+":F.maxSubs=(F.maxSubs||3)+1,F.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const O=u+"Score";F[O]>0&&(F[O]--,F.log.push({text:"🚫 But annulé",type:"info"}));break}}F["usedGc_"+p]=P,F._lastGC=D,F._gcAnimSeq=D.seq,await j(F)})}function fe(_,L){const I="usedCardIds_"+_,A=new Set(g[I]||[]);L.forEach(T=>A.add(T)),g[I]=[...A]}function C(){for(const _ of["p1","p2"]){const L=new Set(g["usedCardIds_"+_]||[]),I=g[_+"Team"];if(I)for(const A of["GK","DEF","MIL","ATT"])(I[A]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function Y(){var Xi,Ji,Qi,Zi,en,tn;if(g.phase==="reveal")return ue();if(g.phase==="midfield")return H();if(g.phase==="finished")return qe();const _=g[p+"Team"],L=g[u+"Team"];C();const I=g[p+"Score"],A=g[u+"Score"],T=g[p+"Name"],P=g[u+"Name"],D=g.phase===p+"-attack",F=g.phase===p+"-defense",O=Array.isArray(g["selected_"+p])?g["selected_"+p]:[],Q=O.map(W=>W.cardId),ne=window.innerWidth>=700,Z=g[p+"Subs"]||[],J=g["usedSubIds_"+p]||[],ae=Z.filter(W=>!J.includes(W.cardId)),se=g["gcCardsFull_"+p]||[],ge=g["usedGc_"+p]||[],le=se.filter(W=>!ge.includes(W.id)),xe=g.boostOwner===p&&!g.boostUsed,ye=[..._.MIL||[],..._.ATT||[]].filter(W=>!W.used),oe=[...L.MIL||[],...L.ATT||[]].filter(W=>!W.used),Ee=!_e(L),Oe=ye.length===0&&oe.length===0&&!Ee,Le=(_.DEF||[]).filter(W=>!W.used),We=(_.GK||[]).filter(W=>!W.used);let Ue=[];D&&ye.length===0&&(Ee?(Ue=Le.map(W=>W.cardId),Le.length===0&&(Ue=Ue.concat(We.map(W=>W.cardId)))):Oe&&(Ue=[...Le,...We].map(W=>W.cardId)));function nt(W,me,Te){var Bt,mt;const he=W._gcDef,Ct={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",at={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",Fe=(he==null?void 0:he.name)||W.gc_type,He=(he==null?void 0:he.effect)||((Bt=Be[W.gc_type])==null?void 0:Bt.desc)||"",je=he!=null&&he.image_url?`/icons/${he.image_url}`:null,kt=((mt=Be[W.gc_type])==null?void 0:mt.icon)||"⚡",Ge=Math.round(Te*.22),ft=Math.round(Te*.22),st=Te-Ge-ft,jt=Fe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${W.id}" data-gc-type="${W.gc_type}"
        style="box-sizing:border-box;width:${me}px;height:${Te}px;border-radius:10px;border:2px solid ${at};background:${Ct};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${Ge}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${jt}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${me-6}px">${Fe}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ot(_,g[p+"Formation"],ut,Q,ne?1300:zt(),ne?600:Gt(),Ue)}
      </div>
    </div>`,rt=g[p+"Team"],Jn=(()=>{var me,Te,he,Ct,at;if(F&&((me=g.pendingAttack)!=null&&me.players)){const Fe=g.pendingAttack;let He="";if(O.length>0){const je=O.map(Ge=>{const ft=(rt[Ge._role]||[]).find(yi=>yi.cardId===Ge.cardId)||Ge,st=rt[Ge._role]||[],jt=st.findIndex(yi=>yi.cardId===Ge.cardId),Bt=xt(st.length),mt=jt>=0?Bt[jt]:ft._col??1;return{...ft,_line:Ge._role,_col:mt}}),kt=ei(je,((Te=g.modifiers)==null?void 0:Te[p])||{},g[p+"Formation"]);He=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
        ...
        </div>`}if(D&&!((Ct=g.pendingAttack)!=null&&Ct.players)&&O.length>0){const Fe=O.map(je=>{const kt=(rt[je._role]||[]).find(mt=>mt.cardId===je.cardId)||je,Ge=["GK","DEF"].includes(je._role),ft=rt[je._role]||[],st=ft.findIndex(mt=>mt.cardId===je.cardId),jt=xt(ft.length),Bt=st>=0?jt[st]:kt._col??1;return{...kt,_line:je._role,_col:Bt,...Ge?{note_a:Math.max(1,Number(kt.note_a)||0)}:{}}}),He=Zt(Fe,((at=g.modifiers)==null?void 0:at[p])||{},g[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
        ...
        </div>`}const W=(g.log||[]).slice(-1)[0];return W?'<div style="padding:2px 4px">'+Gn(W)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),Wi=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
        ...
        <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px">
          ...
          <span style="font-size:26px;font-weight:900;color:#FFD700;letter-spacing:2px">${I} – ${A}</span>
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Ot(_,g[p+"Formation"],ut,Q,zt(),Gt(),Ue)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Mt(){const W=e.querySelector(".match-screen");if(!W)return;const me=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);W.style.height=me+"px",W.style.minHeight=me+"px",W.style.maxHeight=me+"px",W.style.overflow="hidden";const Te=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");Te&&he&&(he.style.paddingBottom=Te.offsetHeight+"px")}if(Mt(),setTimeout(Mt,120),setTimeout(Mt,400),S||(S=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Mt),window.visualViewport.addEventListener("scroll",Mt)),window.addEventListener("resize",Mt)),function(){const me=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!me)return;const Te=me.closest("#match-terrain-wrap");Te&&(Te.style.cssText="position:relative;width:100%;height:100%;padding:0"),me.removeAttribute("width"),me.removeAttribute("height"),me.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",me.setAttribute("preserveAspectRatio","xMidYMid meet")}(),g._pvpResizeBound||(g._pvpResizeBound=!0,window.addEventListener("resize",()=>{const W=e.querySelector(".terrain-wrapper svg");if(W){const me=W.closest("#match-terrain-wrap");me&&(me.style.cssText="position:relative;width:100%;height:100%;padding:0"),W.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(W=>{W.addEventListener("click",()=>{if(!D&&!F)return;const me=W.dataset.cardId,Te=W.dataset.role,he=(_[Te]||[]).find(He=>He.cardId===me);if(!he||he.used)return;const Ct=Ue.includes(me);if(D&&!["MIL","ATT"].includes(Te)&&!Ct)return;Array.isArray(g["selected_"+p])||(g["selected_"+p]=[]);const at=g["selected_"+p],Fe=at.findIndex(He=>He.cardId===me);Fe>-1?at.splice(Fe,1):at.length<3&&at.push({...he,_role:Te}),Y()})}),e.querySelectorAll(".match-used-hit").forEach(W=>{W.addEventListener("click",()=>U(W.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(W=>{W.addEventListener("click",()=>U())}),(Xi=e.querySelector("#pvp-sub-open"))==null||Xi.addEventListener("click",()=>U()),e.querySelectorAll(".pvp-gc-mini").forEach(W=>{D?W.addEventListener("click",()=>R(W.dataset.gcId,W.dataset.gcType)):(W.style.opacity="0.35",W.style.cursor="default",W.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Ji=e.querySelector("#pvp-boost-card"))==null||Ji.addEventListener("click",()=>V()),(Qi=e.querySelector("#pvp-action"))==null||Qi.addEventListener("click",W=>{D?W.currentTarget.dataset.pass==="1"||!Ne(p)?pe():ze():F&&Me()}),(Zi=e.querySelector("#pvp-quit"))==null||Zi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&z()}),(en=e.querySelector("#pvp-view-opp"))==null||en.addEventListener("click",()=>B()),(tn=e.querySelector("#pvp-toggle-history"))==null||tn.addEventListener("click",()=>N()),k&&(clearInterval(k),k=null),(D||F)&&!M){let W=30,me=!1;const Te=()=>document.getElementById("pvp-timer"),he=()=>{Te()&&(Te().textContent=W+"s",Te().style.color=me?"#ff4444":"#fff")};he(),k=setInterval(()=>{W--,W<0?me?(clearInterval(k),k=null,D&&!Ne(p)?pe():z()):(me=!0,W=15,he()):he()},1e3)}}function ue(){dt(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(Oe=Z.querySelector("#psub-close"))==null||Oe.addEventListener("click",()=>Z.remove()),(Le=Z.querySelector("#pout-up"))==null||Le.addEventListener("click",()=>{F>0&&(F--,J())}),(We=Z.querySelector("#pout-down"))==null||We.addEventListener("click",()=>{F<P.length-1&&(F++,J())}),(Ue=Z.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{Q>0&&(Q--,J())}),(nt=Z.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{Q<D.length-1&&(Q++,J())});const Ee=(De,Xe,Ke,pt)=>{const ot=Z.querySelector("#"+De);if(!ot)return;let At=0;ot.addEventListener("touchstart",ut=>{At=ut.touches[0].clientY},{passive:!0}),ot.addEventListener("touchend",ut=>{const _t=ut.changedTouches[0].clientY-At;if(Math.abs(_t)<30)return;const rt=Xe();_t<0&&rt<pt-1?(Ke(rt+1),J()):_t>0&&rt>0&&(Ke(rt-1),J())},{passive:!0})};Ee("pin-panel",()=>Q,De=>Q=De,D.length),Ee("pout-panel",()=>F,De=>F=De,P.length),(Kt=Z.querySelector("#psub-confirm"))==null||Kt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ne)return;ne=!0;const Xe=P[F],Ke=D[Q];if(!Xe||!Ke)return;const pt=Xe._line,ot=(I[pt]||[]).findIndex(_t=>_t.cardId===Xe.cardId);if(ot===-1){x("Erreur : joueur introuvable","error"),Z.remove();return}const At={...Ke,_line:pt,position:Xe.position,used:!1,boost:0};I[pt].splice(ot,1,At);const ut=[...A,Ke.cardId];Z.remove(),re(Xe,Ke,async()=>{await j({[p+"Team"]:I,[u+"Team"]:g[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(Z),J()}function re(_,L,I){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const P=(O,Q,ne)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${mi(g[u+"Team"],g[u+"Formation"],null,[],zt(),Gt())}</div>
      ...
      </div>`,document.body.appendChild(L),(I=L.querySelector("#pvp-hist-close"))==null||I.addEventListener("click",()=>L.remove())}async function pe(){if(g.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",L=(g.round||0)+1,I=[...g.log||[]];I.push({type:"info",text:`⏭️ ${g[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=ke(g),T=Ne(_),P=A||!T?"finished":_+"-attack";await j({["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:P,attacker:_,round:L,log:I}),P==="finished"&&await Ce(g)}function de(_){const L=(_.GK||[]).some(A=>!A.used),I=["DEF","MIL","ATT"].some(A=>(_[A]||[]).some(T=>!T.used));return L&&!I}function we(_){return(_.p1Score||0)!==(_.p2Score||0)?null:de(_.p1Team)&&!_e(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(L=>!L.used)}:de(_.p2Team)&&!_e(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(L=>!L.used)}:null}async function Ae(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const L=(I,A)=>new Promise(T=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${A};letter-spacing:2px;animation:lcFade 1.4s ease both">${I}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function ve(_,L){const{side:I,gk:A}=_;if(!A)return;const T=I+"Score",P=(L[T]||0)+1;A.used=!0;const D=[...L.log||[]];D.push({type:"duel",isGoal:!0,homeScored:I===p,homePlayers:I==="p1"?[qt(A)]:[],aiPlayers:I==="p2"?[qt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[I+"Name"]} marque !`});const F=(L.round||0)+1,O=I==="p1"?"p2":"p1",Q={...L,[T]:P},ne=ke(Q);q.add(F),await Ae();const Z=I===p?P:L[p+"Score"]||0,J=I===p?L[u+"Score"]||0:P;Ze([qt(A)],Z,J,I===p,async()=>{await j({[T]:P,log:D,round:F,pendingAttack:null,phase:ne?"finished":O+"-attack",attacker:O,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}}}),ne&&await Ce({...g,[T]:P})})}async function ze(){const _=g[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(P=>(g[u+"Team"][P]||[]).some(D=>!D.used)),I=(g["selected_"+p]||[]).map(P=>{const D=(_[P._role]||[]).find(se=>se.cardId===P.cardId)||P,F=["GK","DEF"].includes(P._role),O=_[P._role]||[],Q=O.findIndex(se=>se.cardId===P.cardId),ne=xt(O.length),Z=Q>=0?ne[Q]:D._col??1,J=g.stadiumDef||g.homeStadiumDef||null,ae=D.stadiumBonus||J&&(J.club_id&&String(D.club_id)===String(J.club_id)||J.country_code&&D.country_code===J.country_code)||!1;return{...D,_line:P._role,_col:Z,stadiumBonus:ae,...F?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!I.length)return;const A=Zt(I,g.modifiers[p]||{},g[p+"Formation"]);fe(p,I.map(P=>P.cardId)),I.forEach(P=>{const D=(_[P._role]||[]).find(F=>F.cardId===P.cardId);D&&(D.used=!0)}),g["selected_"+p]=[],Y();const T=[...g.log||[]];if(L){if(I.length===1&&(I[0]._line==="GK"||I[0].job==="GK")&&(g.p1Score||0)===(g.p2Score||0)){await ve({side:p,gk:I[0]},{...g,[p+"Team"]:_,log:T});return}const D=(g[p+"Score"]||0)+1,F=I.map(J=>qt(J));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:F,homeTotal:A.total,aiTotal:0});const O=(g.round||0)+1,Q=p==="p1"?"p2":"p1",ne={...g,[p+"Team"]:_,[p+"Score"]:D},Z=ke(ne);q.add(O),Ze(F,D,g[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:_,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":Q+"-attack",attacker:Q,round:O,log:T}),Z&&await Ce({...g,[p+"Score"]:D})});return}T.push({type:"pending",text:`⚔️ ${g[p+"Name"]} attaque (${A.total})`}),await j({[p+"Team"]:_,[u+"Team"]:g[u+"Team"],pendingAttack:{...A,players:I,side:p},["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Me(){const _=g[p+"Team"],L=(g["selected_"+p]||[]).map(le=>{const xe=(_[le._role]||[]).find(Le=>Le.cardId===le.cardId)||le,ye=_[le._role]||[],oe=ye.findIndex(Le=>Le.cardId===le.cardId),Ee=xt(ye.length),Oe=oe>=0?Ee[oe]:xe._col??1;return{...xe,_line:le._role,_col:Oe}}),I=ei(L,g.modifiers[p]||{},g[p+"Formation"]);fe(p,L.map(le=>le.cardId)),L.forEach(le=>{const xe=(_[le._role]||[]).find(ye=>ye.cardId===le.cardId);xe&&(xe.used=!0)}),g["selected_"+p]=[],Y();const A=Ri(g.pendingAttack.total,I.total,g.modifiers[p]||{}),T=g.pendingAttack.side,P=A==="attack"||(A==null?void 0:A.goal),D=T==="p1"?"p2":"p1",F=(g.round||0)+1,O=(g.pendingAttack.players||[]).map(le=>qt(le)),Q=[...g.log||[]];Q.push({type:"duel",isGoal:P,homeScored:P&&T===p,text:P?`⚽ BUT de ${g[T+"Name"]} ! (${g.pendingAttack.total} vs ${I.total})`:`✋ Attaque stoppée (${g.pendingAttack.total} vs ${I.total})`,homePlayers:O,aiPlayers:L.map(le=>qt(le)),homeTotal:g.pendingAttack.total,aiTotal:I.total});const ne=P?(g[T+"Score"]||0)+1:g[T+"Score"]||0,Z={...g,[p+"Team"]:_,[T+"Score"]:ne},J=ke(Z),ae=J?"finished":D+"-attack",se=!J&&!P?we(Z):null,ge=async()=>{if(se){await ve(se,Z);return}await j({[p+"Team"]:_,[u+"Team"]:g[u+"Team"],[T+"Score"]:ne,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:D,round:F,log:Q}),(ae==="finished"||J)&&await Ce({...g,[T+"Score"]:ne})};if(P){const le=T===p,xe=le?ne:g[p+"Score"]||0,ye=le?g[u+"Score"]||0:ne;q.add(F),Ze(O,xe,ye,le,ge)}else await ge()}function Pe(_){return["MIL","ATT"].some(L=>(_[L]||[]).some(I=>!I.used))}function _e(_){return["GK","DEF","MIL","ATT"].some(L=>(_[L]||[]).some(I=>!I.used))}function Ye(_){return _e(_)&&!Pe(_)}function Ne(_){const L=g[_+"Team"],I=g[(_==="p1"?"p2":"p1")+"Team"];return!!(Pe(L)||Ye(L)&&!_e(I)||Ye(L)&&!Pe(I)&&_e(I))}function ke(_){return!_e(_.p1Team)&&!_e(_.p2Team)}function Ie(_){const L=_.p1Score||0,I=_.p2Score||0;return L===I?null:L>I?h.home_id:h.away_id}async function Ce(_){try{const L=Ie(_),I=L?h.home_id===L?h.away_id:h.home_id:null,A=_.p1Score||0,T=_.p2Score||0,{data:P,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:A,p_away_score:T,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(F){console.error("[PvP] check_and_finish_mini_league:",F)}L&&I&&Eo(L,I).catch(()=>{});try{const{data:F}=await v.rpc("apply_match_rewards",{p_match_id:i});F!=null&&F.success&&!(F!=null&&F.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(F){console.error("[PvP] apply_match_rewards:",F)}if(typeof c=="function")try{await c({homeScore:A,awayScore:T,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(F){console.error("[PvP] onMatchEnd:",F)}}catch(L){console.error("[PvP] finishMatch:",L)}}function qe(){var T;const _=g[p+"Score"],L=g[u+"Score"],I=_>L,A=_===L;dt(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(ee)}catch{}it(e),l?f("mini-league",{openLeagueId:l}):f("home")})}Y()}async function Ci(e,t,i=!1){var s,d;const{state:n,navigate:r,toast:o}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await gi(e,t,i?"ranked":"random",async({deckId:c,formation:l,starters:m,subsRaw:y,gcCardsEnriched:f,gcDefs:x,stadiumDef:p})=>{dt(e);const u=async b=>{await Lr(e,t,c,l,m,y,b||[],x,p,i,a)};if(!(f!=null&&f.length)){await u([]);return}fi(e,f,u)})}async function Er(e,t,i){return $r(e,t,i)}async function Lr(e,t,i,n,r,o,a=[],s=[],d=null,c=!1,l=null){var ie,ee;const{state:m,navigate:y,toast:f}=t,x=(l==null?void 0:l.mmr)??((ie=m.profile)==null?void 0:ie.mmr)??1e3,p=c?Fi(x):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;e.innerHTML=`
    ...
    </div>`;const g=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(ee=document.getElementById("cancel-mm"))==null||ee.addEventListener("click",async()=>{await g(),it(e),y("home")});const M=async(j,z)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await St(e,t,j,z,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?Tr:null}))},k=m.user.id,{data:S,error:q}=c?await v.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:x}):await v.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(q||!(S!=null&&S.success)){console.error("[Matchmaking] try_matchmake error:",q||S),f("Erreur de matchmaking","error"),it(e),y("home");return}if(S.matched){await M(S.match_id,!1);return}const te=async()=>{if(w)return;const{data:j}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await M(j.match_id,!0)};h=v.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},j=>{const z=j.new;z.status==="matched"&&z.match_id&&M(z.match_id,!0)}).subscribe(),E=setInterval(te,3e3),setTimeout(()=>{w||g()},12e4)}async function Tr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:d,matchId:c}=e,l=i.user.id,m=o===l,y=r===l,{data:f}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",m?a:o).single();if(f&&x){const p=Qn(f.mmr,f.mmr_rd,f.mmr_v,x.mmr,x.mmr_rd,y?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?v.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:v.sql`mmr_losses + 1`}).eq("id",l),n(y?`+MMR ↑ ${Math.round(p.mmr-f.mmr)}`:`-MMR ↓ ${Math.round(f.mmr-p.mmr)}`,y?"success":"error",4e3)}}const zr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ci,resumePvpMatch:Er},Symbol.toStringTag,{value:"Module"}));async function Ir(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",d=!!o.isAccepting;await gi(e,t,"friend",async({deckId:c,formation:l,starters:m,subsRaw:y,gcCardsEnriched:f,gcDefs:x,stadiumDef:p})=>{dt(e);const u=async b=>{const w=b||[];d?await Ar(e,t,c,w,x,p):await Sr(e,t,c,w,x,p,a,s)};if(!(f!=null&&f.length)){await u([]);return}fi(e,f,u)})}async function Sr(e,t,i,n,r,o,a,s){var w;const{state:d,navigate:c,toast:l}=t,m=d.user.id,{data:y,error:f}=await v.from("friend_match_invites").insert({inviter_id:m,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(f||!y){console.error("[Friend] Erreur création invitation:",f),l("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Lt}">
      ${w.map(g=>`<button class="ml-tab" data-tab="${g.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===g.key?Hn:"transparent"};background:none;font-size:12px;font-weight:${i===g.key?"900":"600"};color:${i===g.key?"#4ade80":Mr};cursor:pointer">${g.label}${g.count?` (${g.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?jr(f,b,r):i==="active"?Br(x,r):qr(u,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>Dr(e,t)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>tt(e,t,i)),e.querySelectorAll(".ml-tab").forEach(g=>g.addEventListener("click",()=>tt(e,t,g.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(g=>g.addEventListener("click",()=>ct(e,t,g.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(g=>g.addEventListener("click",M=>{M.stopPropagation(),Kn(e,t,g.dataset.join,g.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(g=>g.addEventListener("click",M=>{M.stopPropagation(),ji(e,t,g.dataset.delete,g.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(g=>g.addEventListener("click",async M=>{M.stopPropagation(),g.disabled=!0,g.textContent="...";const{data:k,error:S}=await v.rpc("claim_mini_league_prize",{p_league_id:g.dataset.claimLeague,p_user_id:n.profile.id});if(S||!(k!=null&&k.success)){t.toast((k==null?void 0:k.error)||"Erreur lors de la récupération","error"),tt(e,t,i);return}if(!k.already_claimed){n.profile.credits=(n.profile.credits||0)+k.prize;const q=document.getElementById("nav-credits");q&&(q.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${k.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}tt(e,t,i)}))}function ui(e,t,i=!1,n=null){var d,c;const r=e.creator_id===t,o=e.pot||0,a=((c=(d=e.mini_league_members)==null?void 0:d[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Vt};border:1px solid ${s?"rgba(212,160,23,0.5)":Yt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Vt};border:1px solid ${Yt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((j,z)=>{const K=x>0&&a.status==="finished"?z===0?Math.floor(x*.7):z===1?Math.floor(x*.2):z===2?Math.floor(x*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${Vt};border:1px solid ${Yt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,z)=>z+1).reverse().map(j=>{const z=(d||[]).filter(K=>K.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${et};margin-bottom:6px">Journée ${j}</div>${z.map(K=>bn(K,m,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    </div>`;let l=!1;const m=async u=>{if(!l){if(l=!0,clearInterval(x),f)try{f.unsubscribe()}catch{}u&&await St(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(x),f)try{f.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),d()});const y=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&m(u.match_id)},f=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&m(u.new.match_id)}).subscribe(),x=setInterval(y,3e3);y()})}const Vr="/",Yr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let d="buy";const c=()=>{var p,u,b,w,h,E,g;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((g=document.getElementById("flt-note2"))==null?void 0:g.value)||0}};function l(p){const u=c();return p.filter(b=>{var q,te,ie;const w=(q=b.card)==null?void 0:q.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((te=w.clubs)==null?void 0:te.encoded_name)||"").toLowerCase(),g=(w.country_code||"").toLowerCase(),M=((ie=b.card)==null?void 0:ie.evolution_bonus)||0,k=Dt(w,w.job,M),S=w.job2?Dt(w,w.job2,M):0;return!(u.name&&!h.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!g.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&k<u.note1||u.note2&&S<u.note2)})}function m(p){var S,q,te,ie;const u=(S=p.card)==null?void 0:S.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,w=Dt(u,u.job,b),h=u.job2?Dt(u,u.job2,b):0,E=(i.profile.credits||0)>=p.price,g=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ai[u.job]||"#bbb",k=u.job2?ai[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function y(p){var S,q,te,ie;const u=(S=p.card)==null?void 0:S.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,w=Dt(u,u.job,b),h=u.job2?Dt(u,u.job2,b):0,E=p.status==="sold",g=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ai[u.job]||"#bbb",k=u.job2?ai[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${g?`<img src="${g}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(te=u.clubs)!=null&&te.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>n("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,m=s.placement_matches??0,y=m<10,f=Math.max(0,10-m),x=Fi(d),p=Zn(d),u=bi.findIndex(te=>te.id===x.id),b=bi[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,g=bi.map(te=>`
  ...
  </div>`}eo(io);const be={user:null,profile:null,page:"home",params:{}};function Ft(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function oa(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Bi(){document.getElementById("modal-overlay").classList.add("hidden")}async function Wt(){if(!be.user)return;const{data:e}=await v.from("users").select("*").eq("id",be.user.id).single();e&&(be.profile=e)}const Vn="mw_theme";function Yn(){return localStorage.getItem(Vn)||"dark"}function ra(e){var t;localStorage.setItem(Vn,e),aa(e),(t=be.profile)!=null&&t.id&&v.from("users").update({theme:e}).eq("id",be.profile.id).then(()=>{})}function aa(e){document.documentElement.setAttribute("data-theme",e)}function Pt(e,t={}){be.page=e,be.params=t,Wn()}async function Wn(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===be.page)});const t=document.getElementById("nav-credits");t&&be.profile&&(t.textContent=`💰 ${(be.profile.credits||0).toLocaleString("fr")}`);const i={state:be,navigate:Pt,toast:Ft,openModal:oa,closeModal:Bi,refreshProfile:Wt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',be.page){case"home":await an(e,i);break;case"settings":await Ei(e,i);break;case"collection":await jo(e,i);break;case"decks":await Ti(e,i);break;case"boosters":await Vo(e,i);break;case"ranked":await ia(e,i);break;case"match":{const s=be.params&&be.params.matchMode||"vs_ai_easy";s==="random"?await Ci(e,i,!1):s==="ranked"?await Ci(e,i,!0):s==="friend"?await Ir(e,i,(n=be.params)==null?void 0:n.friendId,(r=be.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await hn(e,i,(o=be.params)==null?void 0:o.mlMatchId,(a=be.params)==null?void 0:a.leagueId):await dr(e,i);break}case"market":await Jr(e,i);break;case"rankings":await ta(e,i);break;case"matches":await na(e,i);break;case"friends":await co(e,i);break;case"mini-league":await Cr(e,i);break;case"match-mini-league":{const s=be.params||{};await hn(e,i,s.mlMatchId,s.leagueId);break}default:await an(e,i)}}function sa(){var n,r;const e=document.getElementById("app"),t=be.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.21-1200" style="cursor:pointer">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function ca(){document.documentElement.setAttribute("data-theme",Yn()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Bi()}),document.getElementById("modal-close").addEventListener("click",Bi);const{data:{session:e}}=await v.auth.getSession();if(!e){vn(),la(document.getElementById("app"),{onPlay:()=>nn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft})});return}be.user=e.user,await Wt(),vn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),to(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!be.profile){oo(document.getElementById("app"),{state:be,navigate:async()=>{await Wt(),ki()},toast:Ft,refreshProfile:Wt});return}const t=Array.isArray(be.profile.pending_boosters)?be.profile.pending_boosters:[];if(!be.profile.onboarding_done&&t.length>0){tr(document.getElementById("app"),{state:be,navigate:()=>ki(),toast:Ft,refreshProfile:Wt});return}ki(),setTimeout(()=>Xr(be.profile,Pt,Ft),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(be.user=null,be.profile=null,document.getElementById("app").innerHTML="",nn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft}))})}function pa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function xi(){const e=document.getElementById("app");e&&(e.style.height=pa()+"px")}window.addEventListener("resize",xi);window.addEventListener("orientationchange",()=>setTimeout(xi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",xi);function ki(){const e=()=>{var i;(i=be.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",be.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",xi(),sa(),Wn()}function vn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Xn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
