...
import{s as k,F as hi,h as Rt,j as Yi,l as at,i as Ao,k as zo,b as So}from"./formation-links-Dnttc-Cp.js";const Lo="/";function Li(e,{navigate:t,toast:i}){let a="login";const l=()=>{var s,c,f,o,r,m;const d=a==="login";e.innerHTML=`
    <div style="
  ...
  </div>`}function Bi(e){const t=e.job||"ATT",i=zt(e,t),a=Ei[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`},({def:K,count:se})=>{var j,D;const he=window.innerWidth>=768?.76:.54,Se=(K==null?void 0:K.name)||"?",Me=((j=K==null?void 0:K.club)==null?void 0:j.encoded_name)||(K==null?void 0:K.country_code)||"—",be=K!=null&&K.image_url?`${ge}icons/${K.image_url}`:((D=K==null?void 0:K.club)==null?void 0:D.logo_url)||(K!=null&&K.country_code?`https://flagcdn.com/w80/${K.country_code.toLowerCase()}.png`:null),ze=be?`<img src="${be}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${he};line-height:0;pointer-events:none">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",c);let we=new Set;const ve=()=>{const W=we.size,Z=document.getElementById("sell-action-panel");if(!Z)return;Z.style.display=W>0?"block":"none",document.getElementById("sell-selected-count").textContent=W;const K=document.getElementById("evolve-btn");K&&(K.textContent=`⬆️ Évoluer ${W>1?"(+"+W+")":""}`)};document.querySelectorAll(".expl-check").forEach(W=>{W.addEventListener("change",()=>{const Z=W.dataset.id;W.checked?we.add(Z):we.delete(Z);const K=W.closest(".exemplaire-row");K&&(K.style.borderColor=W.checked?"#1A6B3C":"#eee"),ve()})}),document.querySelectorAll(".exemplaire-row").forEach(W=>{W.addEventListener("click",Z=>{if(Z.target.closest("button")||Z.target.tagName==="INPUT")return;const K=W.querySelector(".expl-check");K&&!K.disabled&&(K.checked=!K.checked,K.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(W=>{W.addEventListener("click",Z=>{Z.stopPropagation();const K=document.querySelector(`.expl-hist[data-hist="${W.dataset.idx}"]`);K&&(K.style.display=K.style.display==="none"?"flex":"none")})}),(J=document.getElementById("evolve-btn"))==null||J.addEventListener("click",async()=>{if(b<=1)return;const W=[...we];if(!W.length)return;if(we.has(e.id)){const be=document.createElement("div");be.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",be.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    <div style="padding:10px 12px;background:rgba(0,0,0,0.25);border-top:1px solid rgba(255,255,255,0.1)">
      ...
      <div style="display:flex;gap:8px;align-items:flex-end;overflow-x:auto;padding-bottom:4px" id="subs-list">
        ${f.map(u=>{const T={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
            ${Qo(T,44,58)}
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,C.style.transition="opacity .45s ease",C.style.opacity="1",C.style.pointerEvents="auto",(F=document.getElementById("start-match-btn"))==null||F.addEventListener("click",T))},600)},700)},2800)}function zn(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const P=window.innerWidth>=700,X=(_e,Ae,Ie)=>{var be,ze;const xe=(t.gcDefs||[]).find(j=>j.name===_e.gc_type),J={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[xe==null?void 0:xe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",oe={purple:"#b06ce0",light_blue:"#00d4ef"}[xe==null?void 0:xe.color]||"#b06ce0",ge=(xe==null?void 0:xe.name)||_e.gc_type,W=(xe==null?void 0:xe.effect)||((be=Re[_e.gc_type])==null?void 0:be.desc)||"",Z=xe!=null&&xe.image_url?`/icons/${xe.image_url}`:null,K=((ze=Re[_e.gc_type])==null?void 0:ze.icon)||"⚡",se=Math.round(Ie*.22),he=Math.round(Ie*.22),Se=Ie-se-he,Me=ge.length>12?7:9;return`<div class="gc-mini" data-gc-id="${_e.id}" data-gc-type="${_e.gc_type}"
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let c=!1;const f=()=>{c||(c=!0,d.remove(),setTimeout(()=>l(),50))};d.addEventListener("click",f),setTimeout(f,3500)}async function Ft(e,t,i){var r,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=i,l=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=l?"victoire":d?"nul":"defaite",c=Uo(t.mode,s);t.matchId&&await k.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:l?a.profile.id:null,home_credits_reward:c,played_at:new Date().toISOString()}).eq("id",t.matchId);const f={credits:(a.profile.credits||0)+c,matches_played:(a.profile.matches_played||0)+1};l?f.wins=(a.profile.wins||0)+1:d?f.draws=(a.profile.draws||0)+1:f.losses=(a.profile.losses||0)+1,await k.from("users").update(f).eq("id",a.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const T=async(R=!0)=>{b=!0,u&&(k.removeChannel(u),u=null),R&&await k.rpc("cancel_matchmaking",{p_user_id:o.profile.id}).catch(()=>{})};(q=document.getElementById("mm-cancel"))==null||q.addEventListener("click",async()=>{try{await T(!0)}catch{}We(e),r("home")});const n=async(R,C,F)=>{if(b)return;b=!0,u&&(k.removeChannel(u),u=null);const M=document.getElementById("mm-status");M&&(M.textContent="Adversaire trouvé !"),await new Promise(Y=>setTimeout(Y,600)),e.isConnected&&wo(e,t,R,F,s,c)},{data:p,error:A}=await k.rpc("try_matchmake",{p_user_id:o.profile.id,p_deck_id:i});if(A||!(p!=null&&p.success)){m("Erreur de matchmaking","error"),We(e),r("home");return}if(p.matched){n(p.match_id,p.opponent_id,!1);return}const I=document.getElementById("mm-status");I&&(I.textContent="En attente d'un autre joueur..."),u=k.channel("matchmaking-"+o.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${o.profile.id}`},R=>{const C=R.new;C.status==="matched"&&C.match_id&&n(C.match_id,C.matched_with,!0)}).subscribe()}async function Rn(e,t,i){const{state:a,navigate:l,toast:d}=t;try{(k.getChannels?k.getChannels():[]).forEach(o=>{const r=o.topic||"";(r.includes("matchmaking")||r.includes("pvp-match")||r.includes("friend-invite"))&&k.removeChannel(o)})}catch{}const{data:s}=await k.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!s){d("Match introuvable","error"),l("home");return}if(s.status==="finished"){d("Ce match est terminé","info"),l("home");return}const c=s.home_id===a.profile.id;wo(e,t,i,c,[],[])}async function wo(e,t,i,a,l=[],d=[]){const{state:s,navigate:c,toast:f}=t,o=a?"p1":"p2",r=a?"p2":"p1",m=(l||[]).map(j=>j.id),b=(l||[]).map(j=>({id:j.id,gc_type:j.gc_type,_gcDef:j._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:u}=await k.from("matches").select("*").eq("id",i).single();if(!u){f("Match introuvable","error"),c("home");return}async function T(){const[{data:j},{data:D},{data:w},{data:E}]=await Promise.all([k.rpc("get_deck_for_match",{p_deck_id:u.home_deck_id}),k.rpc("get_deck_for_match",{p_deck_id:u.away_deck_id}),k.from("users").select("id,pseudo,club_name").eq("id",u.home_id).single(),k.from("users").select("id,pseudo,club_name").eq("id",u.away_id).single()]),g=z=>{const L=Number(z.evolution_bonus)||0;return{cardId:z.card_id,position:z.position,id:z.id,firstname:z.firstname,name:z.surname_encoded,country_code:z.country_code,club_id:z.club_id,job:z.job,job2:z.job2,note_g:(Number(z.note_g)||0)+(z.job==="GK"||z.job2==="GK"&&Number(z.note_g)>0?L:0),note_d:(Number(z.note_d)||0)+(z.job==="DEF"||z.job2==="DEF"&&Number(z.note_d)>0?L:0),note_m:(Number(z.note_m)||0)+(z.job==="MIL"||z.job2==="MIL"&&Number(z.note_m)>0?L:0),note_a:(Number(z.note_a)||0)+(z.job==="ATT"||z.job2==="ATT"&&Number(z.note_a)>0?L:0),evolution_bonus:L,rarity:z.rarity,skin:z.skin,hair:z.hair,hair_length:z.hair_length,clubName:z.club_encoded_name||null,clubLogo:z.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},x=((j==null?void 0:j.starters)||[]).map(z=>g(z)),y=((D==null?void 0:D.starters)||[]).map(z=>g(z)),h=(j==null?void 0:j.formation)||"4-4-2",v=(D==null?void 0:D.formation)||"4-4-2";let _=yt(x,h),S=yt(y,v);const $=((j==null?void 0:j.subs)||[]).map(z=>g(z));return stadiumDef&&a&&(_=jt(_,stadiumDef),Nt($,stadiumDef)),{p1Team:_,p2Team:S,p1Subs:$,p2Subs:((D==null?void 0:D.subs)||[]).map(z=>g(z)),p1Formation:h,p2Formation:v,p1Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 1",p2Name:(E==null?void 0:E.club_name)||(E==null?void 0:E.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?m:[],gc_p2:a?[]:m,gcCardsFull_p1:a?b:[],gcCardsFull_p2:a?[]:b,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let n=u.game_state&&Object.keys(u.game_state).length?u.game_state:null;if(!n)if(a){n=await T();const{data:j}=await k.from("matches").select("game_state").eq("id",i).single();!(j!=null&&j.game_state)||!Object.keys(j.game_state).length?await k.from("matches").update({game_state:n,turn_user_id:u.home_id}).eq("id",i):n=j.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let j=0;j<30&&!n;j++){await new Promise(w=>setTimeout(w,400));const{data:D}=await k.from("matches").select("game_state").eq("id",i).single();D!=null&&D.game_state&&Object.keys(D.game_state).length&&(n=D.game_state)}if(!n){f("Erreur de synchronisation","error"),c("home");return}n.gc_p2=m,n.gcCardsFull_p2=b,await k.from("matches").update({game_state:n}).eq("id",i)}let p=!1,A=null,I=!1;const q=new Set,R=new Set;function C(j){var _,S;try{k.removeChannel(F)}catch{}const D=n[o+"Score"]||0,w=n[r+"Score"]||0;let E,g;j.winner_id?(E=j.winner_id===s.profile.id,g=!1):j.forfeit?(E=D>w,g=!1):(g=D===w,E=D>w),(_=document.getElementById("pvp-end-overlay"))==null||_.remove();const x=document.createElement("div");x.id="pvp-end-overlay",x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const y=g?"🤝":E?"🏆":"😞",h=g?"MATCH NUL":E?"VICTOIRE !":"DÉFAITE",v=g?"#fff":E?"#FFD700":"#ff6b6b";x.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(x),(S=x.querySelector("#pvp-end-home"))==null||S.addEventListener("click",()=>{x.remove(),We(e),c("home")})}const F=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},j=>{const D=j.new;try{if(D.status==="finished"||D.forfeit){if(p)return;p=!0,A&&(clearInterval(A),A=null),D.game_state&&(n=D.game_state),C(D);return}if(D.game_state){const w=n;n=D.game_state;const E=n._lastGC;if(E&&E.seq&&!R.has(E.seq)&&(R.add(E.seq),E.by!==o)){we(E.type,E.by,()=>N());return}const g=w[o+"Score"]||0,x=w[r+"Score"]||0,y=n[o+"Score"]||0,h=n[r+"Score"]||0,v=y>g,_=h>x;if((v||_)&&!q.has(n.round)){q.add(n.round);const S=[...n.log||[]].reverse().find(z=>z.isGoal),$=((S==null?void 0:S.homePlayers)||[]).map(z=>({name:z.name,note:z.note,portrait:z.portrait,job:z.job}));Le($,y,h,v,()=>N());return}N()}}catch(w){console.error("[PvP] crash:",w)}}).subscribe();async function M(j){Object.assign(n,j),n.lastActionAt=new Date().toISOString();const{error:D}=await k.from("matches").update({game_state:n}).eq("id",i);D&&f("Erreur de synchronisation","error");try{N()}catch(w){console.error("[PvP] renderPvpScreen crash:",w)}}async function Y(){if(p)return;p=!0,A&&(clearInterval(A),A=null);const j=a?u.away_id:u.home_id,D=a?"p2":"p1",w=a?"p1":"p2",E={...n,[D+"Score"]:3,[w+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:j,home_score:E.p1Score||0,away_score:E.p2Score||0,game_state:E}).eq("id",i)}catch{}try{k.removeChannel(F)}catch{}setTimeout(()=>{We(e),c("home")},800)}const de={BOOST_STAT:({value:j=1,count:D=1,roles:w=[]},E,g)=>{const x=E[o+"Team"],y=Object.entries(x).filter(([h])=>!w.length||w.includes(h)).flatMap(([h,v])=>v.filter(_=>!_.used).map(_=>({..._,_line:h})));if(!y.length){E.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),g(E);return}re(y,D,`Choisir ${D} joueur(s) à booster (+${j})`,h=>{h.forEach(v=>{const _=(x[v._line]||[]).find(S=>S.cardId===v.cardId);_&&(_.boost=(_.boost||0)+j,E.log.push({text:`⚡ +${j} sur ${_.name}`,type:"info"}))}),E[o+"Team"]=x,g(E)})},DEBUFF_STAT:({value:j=1,count:D=1,roles:w=[],target:E="ai"},g,x)=>{const y=E==="home"?o:r,h=g[y+"Team"],v=E==="home"?"allié":"adverse",_=Object.entries(h).filter(([S])=>!w.length||w.includes(S)).flatMap(([S,$])=>$.map(z=>({...z,_line:S})));if(!_.length){g.log.push({text:`🎯 Aucun joueur ${v}`,type:"info"}),x(g);return}re(_,D,`Choisir ${D} joueur(s) ${v}(s) (-${j})`,S=>{S.forEach($=>{const z=(h[$._line]||[]).find(L=>L.cardId===$.cardId);z&&(z.boost=(z.boost||0)-j,g.log.push({text:`🎯 -${j} sur ${z.name}`,type:"info"}))}),g[y+"Team"]=h,x(g)})},GRAY_PLAYER:({count:j=1,roles:D=[],target:w="ai"},E,g)=>{const x=w==="home"?o:r,y=E[x+"Team"],h=w==="home"?"allié":"adverse",v=Object.entries(y).filter(([_])=>!D.length||D.includes(_)).flatMap(([_,S])=>S.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){E.log.push({text:`❌ Aucun joueur ${h}`,type:"info"}),g(E);return}re(v,j,`Choisir ${j} joueur(s) ${h}(s) à exclure`,_=>{const S="usedCardIds_"+x,$=new Set(E[S]||[]);_.forEach(z=>{const L=(y[z._line]||[]).find(B=>B.cardId===z.cardId);L&&(L.used=!0,$.add(z.cardId),E.log.push({text:`❌ ${L.name} exclu !`,type:"info"}))}),E[S]=[...$],E[x+"Team"]=y,g(E)})},REVIVE_PLAYER:({count:j=1,roles:D=[]},w,E)=>{const g=w[o+"Team"],x=Object.entries(g).filter(([y])=>!D.length||D.includes(y)).flatMap(([y,h])=>h.filter(v=>v.used).map(v=>({...v,_line:y})));if(!x.length){w.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),E(w);return}re(x,j,`Choisir ${j} joueur(s) à ressusciter`,y=>{y.forEach(h=>{const v=(g[h._line]||[]).find(_=>_.cardId===h.cardId);v&&(v.used=!1,w.log.push({text:`💫 ${v.name} ressuscité !`,type:"info"}))}),w[o+"Team"]=g,E(w)})},REMOVE_GOAL:({},j,D)=>{const w=r+"Score";j[w]>0?(j[w]--,j.log.push({text:"🚫 Dernier but annulé !",type:"info"})):j.log.push({text:"🚫 Aucun but à annuler",type:"info"}),D(j)},ADD_GOAL_DRAW:({},j,D)=>{j[o+"Score"]===j[r+"Score"]?(j[o+"Score"]++,j.log.push({text:"🎯 But bonus !",type:"info"})):j.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),D(j)},ADD_SUB:({value:j=1},D,w)=>{D.maxSubs=(D.maxSubs||3)+j,D.log.push({text:`🔄 +${j} remplacement(s)`,type:"info"}),w(D)},CUSTOM:({},j,D)=>D(j)};function re(j,D,w,E){const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let x=[];function y(){var v,_;const h=j.map(S=>{const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[S._line]||"#555",z=je(S,S._line)+(S.boost||0),B=x.find(O=>O.cardId===S.cardId)?"#FFD700":"rgba(255,255,255,0.25)",G=S.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${S.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${B};background:${$};overflow:hidden;cursor:pointer;${G}">
        ...
        </div>`,(v=g.querySelector("#pp-close"))==null||v.addEventListener("click",()=>g.remove()),g.querySelectorAll(".pp-item").forEach(S=>{S.addEventListener("click",()=>{const $=S.dataset.cid,z=j.find(B=>B.cardId===$),L=x.findIndex(B=>B.cardId===$);z&&(L>-1?x.splice(L,1):x.length<D&&x.push(z),y())})}),(_=g.querySelector("#pp-confirm"))==null||_.addEventListener("click",()=>{g.remove(),E(x)})}y(),document.body.appendChild(g)}async function P(j,D){const E=(n["gcCardsFull_"+o]||[]).find(h=>h.id===j),g=(E==null?void 0:E._gcDef)||(n.gcDefs||[]).find(h=>{var v;return h.name===D||((v=h.name)==null?void 0:v.toLowerCase().trim())===(D==null?void 0:D.toLowerCase().trim())}),x=[...n["usedGc_"+o]||[],j],y={type:D,by:o,seq:(n._gcAnimSeq||0)+1};R.add(y.seq),we(D,o,async()=>{if(g!=null&&g.effect_type&&g.effect_type!=="CUSTOM"){const v=de[g.effect_type];if(v){const _={...n};v(g.effect_params||{},_,async S=>{S["usedGc_"+o]=x,S._lastGC=y,S._gcAnimSeq=y.seq,await M(S)});return}}const h={...n};switch(D){case"Remplacement+":h.maxSubs=(h.maxSubs||3)+1,h.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const v=r+"Score";h[v]>0&&(h[v]--,h.log.push({text:"🚫 But annulé",type:"info"}));break}}h["usedGc_"+o]=x,h._lastGC=y,h._gcAnimSeq=y.seq,await M(h)})}function X(j,D){const w="usedCardIds_"+j,E=new Set(n[w]||[]);D.forEach(g=>E.add(g)),n[w]=[...E]}function U(){for(const j of["p1","p2"]){const D=new Set(n["usedCardIds_"+j]||[]),w=n[j+"Team"];if(w)for(const E of["GK","DEF","MIL","ATT"])(w[E]||[]).forEach(g=>{g.used=D.has(g.cardId)})}}function N(){var Ke,Je,Ze,Qe,nt,gt;if(n.phase==="reveal")return ne();if(n.phase==="midfield")return ye();if(n.phase==="finished")return ze();const j=n[o+"Team"],D=n[r+"Team"];U();const w=n[o+"Score"],E=n[r+"Score"],g=n[o+"Name"],x=n[r+"Name"],y=n.phase===o+"-attack",h=n.phase===o+"-defense",v=Array.isArray(n["selected_"+o])?n["selected_"+o]:[],_=v.map(le=>le.cardId),S=window.innerWidth>=700,$=n[o+"Subs"]||[],z=n["usedSubIds_"+o]||[],L=$.filter(le=>!z.includes(le.cardId)),B=n["gcCardsFull_"+o]||[],G=n["usedGc_"+o]||[],O=B.filter(le=>!G.includes(le.id)),H=n.boostOwner===o&&!n.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(le=>(D[le]||[]).some(Ee=>!Ee.used)),V=[...j.MIL||[],...j.ATT||[]].filter(le=>!le.used),ie=y&&Q&&V.length===0?[...j.GK||[],...j.DEF||[]].filter(le=>!le.used).map(le=>le.cardId):[];function ae(le,Ee,te){var pt,ht;const ue=le._gcDef,ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ue==null?void 0:ue.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ce={purple:"#b06ce0",light_blue:"#00d4ef"}[ue==null?void 0:ue.color]||"#b06ce0",Be=(ue==null?void 0:ue.name)||le.gc_type,Te=(ue==null?void 0:ue.effect)||((pt=Re[le.gc_type])==null?void 0:pt.desc)||"",tt=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:null,it=((ht=Re[le.gc_type])==null?void 0:ht.icon)||"⚡",rt=Math.round(te*.22),st=Math.round(te*.22),ct=te-rt-st,kt=Be.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${le.id}" data-gc-type="${le.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(x);let v=!1;const _=()=>{v||(v=!0,x.remove(),setTimeout(()=>g(),50))};x.addEventListener("click",_),setTimeout(_,3500)}function we(j,D,w){var G,O;const E=(n.gcDefs||[]).find(H=>{var Q;return H.name===j||((Q=H.name)==null?void 0:Q.toLowerCase().trim())===(j==null?void 0:j.toLowerCase().trim())}),g={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[E==null?void 0:E.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",x={purple:"#b06ce0",light_blue:"#00d4ef"}[E==null?void 0:E.color]||"#b06ce0",y=(E==null?void 0:E.name)||j,h=(E==null?void 0:E.effect)||((G=Re[j])==null?void 0:G.desc)||"",v=E!=null&&E.image_url?`/icons/${E.image_url}`:null,_=((O=Re[j])==null?void 0:O.icon)||"⚡",$=D===o?"Vous":n[D+"Name"]||"Adversaire",z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",z.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(z);let L=!1;const B=()=>{L||(L=!0,z.remove(),setTimeout(()=>w&&w(),50))};z.addEventListener("click",B),setTimeout(B,3e3)}function ve(j,D){var z,L,B,G;const E=(n["gcCardsFull_"+o]||[]).find(O=>O.id===j),g=E==null?void 0:E._gcDef,x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[g==null?void 0:g.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",y={purple:"#b06ce0",light_blue:"#00d4ef"}[g==null?void 0:g.color]||"#b06ce0",h=(g==null?void 0:g.name)||D,v=(g==null?void 0:g.effect)||((z=Re[D])==null?void 0:z.desc)||"Carte spéciale.",_=g!=null&&g.image_url?`/icons/${g.image_url}`:null,S=((L=Re[D])==null?void 0:L.icon)||"⚡",$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",$.innerHTML=`
      ...
      </div>`,(ae=$.querySelector("#psub-close"))==null||ae.addEventListener("click",()=>$.remove()),(fe=$.querySelector("#pout-up"))==null||fe.addEventListener("click",()=>{h>0&&(h--,z())}),(me=$.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{h<x.length-1&&(h++,z())}),($e=$.querySelector("#pin-up"))==null||$e.addEventListener("click",()=>{_>0&&(_--,z())}),(ke=$.querySelector("#pin-down"))==null||ke.addEventListener("click",()=>{_<y.length-1&&(_++,z())});const ie=(Ce,Oe,Fe,He)=>{const De=$.querySelector("#"+Ce);if(!De)return;let Ve=0;De.addEventListener("touchstart",Ne=>{Ve=Ne.touches[0].clientY},{passive:!0}),De.addEventListener("touchend",Ne=>{const Ue=Ne.changedTouches[0].clientY-Ve;if(Math.abs(Ue)<30)return;const Ke=Oe();Ue<0&&Ke<He-1?(Fe(Ke+1),z()):Ue>0&&Ke>0&&(Fe(Ke-1),z())},{passive:!0})};ie("pin-panel",()=>_,Ce=>_=Ce,y.length),ie("pout-panel",()=>h,Ce=>h=Ce,x.length),(qe=$.querySelector("#psub-confirm"))==null||qe.addEventListener("click",async Ce=>{if(Ce.preventDefault(),Ce.stopPropagation(),S)return;S=!0;const Oe=x[h],Fe=y[_];if(!Oe||!Fe)return;const He=Oe._line,De=(w[He]||[]).findIndex(Ue=>Ue.cardId===Oe.cardId);if(De===-1){f("Erreur : joueur introuvable","error"),$.remove();return}const Ve={...Fe,_line:He,position:Oe.position,used:!1,boost:0};w[He].splice(De,1,Ve);const Ne=[...E,Fe.cardId];$.remove(),Ie(Oe,Fe,async()=>{await M({[o+"Team"]:w,[r+"Team"]:n[r+"Team"],["usedSubIds_"+o]:Ne})})})}document.body.appendChild($),z()}function Ie(j,D,w){const E={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const x=(v,_,S)=>`<div style="text-align:center">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(h),(z=h.querySelector("#pvp-end-home"))==null||z.addEventListener("click",()=>{h.remove(),We(e),c("home")})}const Y=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{const E=w.new;try{if(E.status==="finished"||E.forfeit){if(p)return;p=!0,q&&(clearInterval(q),q=null),E.game_state&&(n=E.game_state),M(E);return}if(E.game_state){const g=n;n=E.game_state;const x=n._lastGC;if(x&&x.seq&&!F.has(x.seq)&&(F.add(x.seq),x.by!==o)){_e(x.type,x.by,()=>pe());return}const y=g[o+"Score"]||0,h=g[r+"Score"]||0,v=n[o+"Score"]||0,_=n[r+"Score"]||0,S=v>y,$=_>h;if((S||$)&&!C.has(n.round)){C.add(n.round);const z=[...n.log||[]].reverse().find(B=>B.isGoal),L=((z==null?void 0:z.homePlayers)||[]).map(B=>({name:B.name,note:B.note,portrait:B.portrait,job:B.job}));ve(L,v,_,S,()=>pe());return}pe()}}catch(g){console.error("[PvP] crash:",g)}}).subscribe();async function de(w){Object.assign(n,w),n.lastActionAt=new Date().toISOString();const{error:E}=await k.from("matches").update({game_state:n}).eq("id",i);E&&f("Erreur de synchronisation","error");try{pe()}catch(g){console.error("[PvP] renderPvpScreen crash:",g)}}async function re(){if(p)return;p=!0,q&&(clearInterval(q),q=null);const w=a?u.away_id:u.home_id,E=a?"p2":"p1",g=a?"p1":"p2",x={...n,[E+"Score"]:3,[g+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:w,home_score:x.p1Score||0,away_score:x.p2Score||0,game_state:x}).eq("id",i)}catch{}try{k.removeChannel(Y)}catch{}setTimeout(()=>{We(e),c("home")},800)}const P={BOOST_STAT:({value:w=1,count:E=1,roles:g=[]},x,y)=>{const h=x[o+"Team"],v=Object.entries(h).filter(([_])=>!g.length||g.includes(_)).flatMap(([_,S])=>S.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){x.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(x);return}X(v,E,`Choisir ${E} joueur(s) à booster (+${w})`,_=>{_.forEach(S=>{const $=(h[S._line]||[]).find(z=>z.cardId===S.cardId);$&&($.boost=($.boost||0)+w,x.log.push({text:`⚡ +${w} sur ${$.name}`,type:"info"}))}),x[o+"Team"]=h,y(x)})},DEBUFF_STAT:({value:w=1,count:E=1,roles:g=[],target:x="ai"},y,h)=>{const v=x==="home"?o:r,_=y[v+"Team"],S=x==="home"?"allié":"adverse",$=Object.entries(_).filter(([z])=>!g.length||g.includes(z)).flatMap(([z,L])=>L.map(B=>({...B,_line:z})));if(!$.length){y.log.push({text:`🎯 Aucun joueur ${S}`,type:"info"}),h(y);return}X($,E,`Choisir ${E} joueur(s) ${S}(s) (-${w})`,z=>{z.forEach(L=>{const B=(_[L._line]||[]).find(G=>G.cardId===L.cardId);B&&(B.boost=(B.boost||0)-w,y.log.push({text:`🎯 -${w} sur ${B.name}`,type:"info"}))}),y[v+"Team"]=_,h(y)})},GRAY_PLAYER:({count:w=1,roles:E=[],target:g="ai"},x,y)=>{const h=g==="home"?o:r,v=x[h+"Team"],_=g==="home"?"allié":"adverse",S=Object.entries(v).filter(([$])=>!E.length||E.includes($)).flatMap(([$,z])=>z.filter(L=>!L.used).map(L=>({...L,_line:$})));if(!S.length){x.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),y(x);return}X(S,w,`Choisir ${w} joueur(s) ${_}(s) à exclure`,$=>{const z="usedCardIds_"+h,L=new Set(x[z]||[]);$.forEach(B=>{const G=(v[B._line]||[]).find(O=>O.cardId===B.cardId);G&&(G.used=!0,L.add(B.cardId),x.log.push({text:`❌ ${G.name} exclu !`,type:"info"}))}),x[z]=[...L],x[h+"Team"]=v,y(x)})},REVIVE_PLAYER:({count:w=1,roles:E=[]},g,x)=>{const y=g[o+"Team"],h=Object.entries(y).filter(([v])=>!E.length||E.includes(v)).flatMap(([v,_])=>_.filter(S=>S.used).map(S=>({...S,_line:v})));if(!h.length){g.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),x(g);return}X(h,w,`Choisir ${w} joueur(s) à ressusciter`,v=>{v.forEach(_=>{const S=(y[_._line]||[]).find($=>$.cardId===_.cardId);S&&(S.used=!1,g.log.push({text:`💫 ${S.name} ressuscité !`,type:"info"}))}),g[o+"Team"]=y,x(g)})},REMOVE_GOAL:({},w,E)=>{const g=r+"Score";w[g]>0?(w[g]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(w)},ADD_GOAL_DRAW:({},w,E)=>{w[o+"Score"]===w[r+"Score"]?(w[o+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(w)},ADD_SUB:({value:w=1},E,g)=>{E.maxSubs=(E.maxSubs||3)+w,E.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),g(E)},CUSTOM:({},w,E)=>E(w)};function X(w,E,g,x){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let h=[];function v(){var S,$;const _=w.map(z=>{const L={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",B=je(z,z._line)+(z.boost||0),O=h.find(Q=>Q.cardId===z.cardId)?"#FFD700":"rgba(255,255,255,0.25)",H=z.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${O};background:${L};overflow:hidden;cursor:pointer;${H}">
        ...
        </div>`,(S=y.querySelector("#pp-close"))==null||S.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(z=>{z.addEventListener("click",()=>{const L=z.dataset.cid,B=w.find(O=>O.cardId===L),G=h.findIndex(O=>O.cardId===L);B&&(G>-1?h.splice(G,1):h.length<E&&h.push(B),v())})}),($=y.querySelector("#pp-confirm"))==null||$.addEventListener("click",()=>{y.remove(),x(h)})}v(),document.body.appendChild(y)}async function U(w,E){const x=(n["gcCardsFull_"+o]||[]).find(_=>_.id===w),y=(x==null?void 0:x._gcDef)||(n.gcDefs||[]).find(_=>{var S;return _.name===E||((S=_.name)==null?void 0:S.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),h=[...n["usedGc_"+o]||[],w],v={type:E,by:o,seq:(n._gcAnimSeq||0)+1};F.add(v.seq),_e(E,o,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const S=P[y.effect_type];if(S){const $={...n};S(y.effect_params||{},$,async z=>{z["usedGc_"+o]=h,z._lastGC=v,z._gcAnimSeq=v.seq,await de(z)});return}}const _={...n};switch(E){case"Remplacement+":_.maxSubs=(_.maxSubs||3)+1,_.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const S=r+"Score";_[S]>0&&(_[S]--,_.log.push({text:"🚫 But annulé",type:"info"}));break}}_["usedGc_"+o]=h,_._lastGC=v,_._gcAnimSeq=v.seq,await de(_)})}function N(w,E){const g="usedCardIds_"+w,x=new Set(n[g]||[]);E.forEach(y=>x.add(y)),n[g]=[...x]}function ne(){for(const w of["p1","p2"]){const E=new Set(n["usedCardIds_"+w]||[]),g=n[w+"Team"];if(g)for(const x of["GK","DEF","MIL","ATT"])(g[x]||[]).forEach(y=>{y.used=E.has(y.cardId)})}}function pe(){var Ze,Qe,nt,gt,le,Ee;if(n.phase==="reveal")return ye();if(n.phase==="midfield")return we();if(n.phase==="finished")return D();const w=n[o+"Team"],E=n[r+"Team"];ne();const g=n[o+"Score"],x=n[r+"Score"],y=n[o+"Name"],h=n[r+"Name"],v=n.phase===o+"-attack",_=n.phase===o+"-defense",S=Array.isArray(n["selected_"+o])?n["selected_"+o]:[],$=S.map(te=>te.cardId),z=window.innerWidth>=700,L=n[o+"Subs"]||[],B=n["usedSubIds_"+o]||[],G=L.filter(te=>!B.includes(te.cardId)),O=n["gcCardsFull_"+o]||[],H=n["usedGc_"+o]||[],Q=O.filter(te=>!H.includes(te.id)),V=n.boostOwner===o&&!n.boostUsed,ie=!["GK","DEF","MIL","ATT"].some(te=>(E[te]||[]).some(ue=>!ue.used)),ae=[...w.MIL||[],...w.ATT||[]].filter(te=>!te.used),fe=v&&ie&&ae.length===0?[...w.GK||[],...w.DEF||[]].filter(te=>!te.used).map(te=>te.cardId):[];function me(te,ue,ee){var Et,Kt;const ce=te._gcDef,Be={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Te={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",tt=(ce==null?void 0:ce.name)||te.gc_type,it=(ce==null?void 0:ce.effect)||((Et=Re[te.gc_type])==null?void 0:Et.desc)||"",rt=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,st=((Kt=Re[te.gc_type])==null?void 0:Kt.icon)||"⚡",ct=Math.round(ee*.22),kt=Math.round(ee*.22),pt=ee-ct-kt,ht=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${te.id}" data-gc-type="${te.gc_type}"
      ...
      </div>`}const ke=(te,ue)=>ue?$e(130,175):me(te,130,175),qe=(te,ue)=>ue?$e(68,95):me(te,68,95),Ce=z?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Oe=v?Me(o)?`<button id="pvp-action" style="${Ce};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${S.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Ce};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:_?`<button id="pvp-action" style="${Ce};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${S.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${h}</div>`,Fe=v&&!Me(o)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':v||_?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${S.length}/3 sélectionné(s)</div>`:"",He=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${z?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${G.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':G.map(te=>`<div class="pvp-sub-btn" data-sub-id="${te.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(te,z?76:44,z?100:58)}</div>`).join("")}
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${w!=null&&w.length?`<div style="display:flex;gap:10px;animation:scoreIn .4s ease 1s both;position:relative;z-index:1">
        ${w.map(z=>`<div style="text-align:center">
          <div style="width:50px;height:50px;border-radius:50%;background:${_[z.job]||"#555"};border:2px solid #FFD700;position:relative;overflow:hidden;margin:0 auto">
      ...
      </div>`,document.body.appendChild(g),(x=g.querySelector("#bp-close"))==null||x.addEventListener("click",()=>g.remove()),g.querySelectorAll(".bp-item").forEach(y=>{y.addEventListener("click",async()=>{const h=y.dataset.cid,v=E.find(S=>S.cardId===h);if(!v)return;const _=(w[v._line]||[]).find(S=>S.cardId===h);_&&(_.boost=(_.boost||0)+n.boostValue),g.remove(),await de({[o+"Team"]:w,boostUsed:!0})})})}function xe(w=null){var G,O;if(!(n.phase===o+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const g=n[o+"Team"],x=n["usedSubIds_"+o]||[],y=n.maxSubs||3;if(x.length>=y){f(`Maximum ${y} remplacements atteint`,"warning");return}const h=Object.entries(g).flatMap(([H,Q])=>(Q||[]).filter(V=>V.used).map(V=>({...V,_line:H}))),v=(n[o+"Subs"]||[]).filter(H=>!x.includes(H.cardId));if(!h.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!v.length){f("Aucun remplaçant disponible","warning");return}let _=Math.max(0,h.findIndex(H=>H.cardId===w));const S=((G=h[_])==null?void 0:G._line)||((O=h[_])==null?void 0:O.job);let $=Math.max(0,v.findIndex(H=>H.job===S)),z=!1;const L=document.createElement("div");L.id="pvp-sub-overlay",L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function B(){var me,$e,ke,qe,Ce,Oe;const H=h[_],Q=v[$],V=Math.min(130,Math.round((window.innerWidth-90)/2)),ie=Math.round(V*1.35),ae=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;L.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${n[r+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(n[r+"Team"],n[r+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(w),(E=w.querySelector("#pvp-opp-close"))==null||E.addEventListener("click",()=>w.remove())}function ge(){var x;const w=n.log||[],E=document.createElement("div");E.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const g=y=>{var v,_,S;if(y.type==="duel"){const $=y.isGoal,z=y.homeScored&&o==="p1"||!y.homeScored&&$&&o==="p2",L=y.homeScored?"#FFD700":$?"#ff6b6b":"rgba(255,255,255,0.3)",B=$?z?"⚽ BUT !":"⚽ BUT adversaire !":(v=y.homePlayers)!=null&&v.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${$?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${L};margin-bottom:4px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(_),(B=_.querySelector("#pvp-end-home"))==null||B.addEventListener("click",()=>{_.remove(),We(e),o?c("mini-league",{openLeagueId:o}):c("mini-league")})}const de=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},g=>{const x=g.new;try{if(x.status==="finished"||x.forfeit){if(A||(A=!0,R&&(clearInterval(R),R=null),x.game_state&&(p=x.game_state),p.phase==="finished"&&!x.forfeit&&document.getElementById("pvp-home")))return;Y(x);return}if(x.game_state){const y=p;p=x.game_state;const h=p._lastGC;if(h&&h.seq&&!M.has(h.seq)&&(M.add(h.seq),h.by!==r)){Ae(h.type,h.by,()=>ye());return}const v=y[r+"Score"]||0,_=y[m+"Score"]||0,S=p[r+"Score"]||0,$=p[m+"Score"]||0,z=S>v,L=$>_;if((z||L)&&!F.has(p.round)){F.add(p.round);const B=[...p.log||[]].reverse().find(O=>O.isGoal),G=((B==null?void 0:B.homePlayers)||[]).map(O=>({name:O.name,note:O.note,portrait:O.portrait,job:O.job}));_e(G,S,$,z,()=>ye());return}ye()}}catch(y){console.error("[PvP] crash:",y)}}).subscribe();async function re(g){Object.assign(p,g),p.lastActionAt=new Date().toISOString();const{error:x}=await k.from("matches").update({game_state:p}).eq("id",i);x&&f("Erreur de synchronisation","error");try{ye()}catch(y){console.error("[PvP] renderPvpScreen crash:",y)}}async function P(){if(A)return;A=!0,R&&(clearInterval(R),R=null);const g=a?T.away_id:T.home_id,x=a?"p2":"p1",y=a?"p1":"p2",h={...p,[x+"Score"]:3,[y+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:g,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",i)}catch{}try{k.removeChannel(de)}catch{}setTimeout(()=>{We(e),c("mini-league")},800)}const X={BOOST_STAT:({value:g=1,count:x=1,roles:y=[]},h,v)=>{const _=h[r+"Team"],S=Object.entries(_).filter(([$])=>!y.length||y.includes($)).flatMap(([$,z])=>z.filter(L=>!L.used).map(L=>({...L,_line:$})));if(!S.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(h);return}U(S,x,`Choisir ${x} joueur(s) à booster (+${g})`,$=>{$.forEach(z=>{const L=(_[z._line]||[]).find(B=>B.cardId===z.cardId);L&&(L.boost=(L.boost||0)+g,h.log.push({text:`⚡ +${g} sur ${L.name}`,type:"info"}))}),h[r+"Team"]=_,v(h)})},DEBUFF_STAT:({value:g=1,count:x=1,roles:y=[],target:h="ai"},v,_)=>{const S=h==="home"?r:m,$=v[S+"Team"],z=h==="home"?"allié":"adverse",L=Object.entries($).filter(([B])=>!y.length||y.includes(B)).flatMap(([B,G])=>G.map(O=>({...O,_line:B})));if(!L.length){v.log.push({text:`🎯 Aucun joueur ${z}`,type:"info"}),_(v);return}U(L,x,`Choisir ${x} joueur(s) ${z}(s) (-${g})`,B=>{B.forEach(G=>{const O=($[G._line]||[]).find(H=>H.cardId===G.cardId);O&&(O.boost=(O.boost||0)-g,v.log.push({text:`🎯 -${g} sur ${O.name}`,type:"info"}))}),v[S+"Team"]=$,_(v)})},GRAY_PLAYER:({count:g=1,roles:x=[],target:y="ai"},h,v)=>{const _=y==="home"?r:m,S=h[_+"Team"],$=y==="home"?"allié":"adverse",z=Object.entries(S).filter(([L])=>!x.length||x.includes(L)).flatMap(([L,B])=>B.filter(G=>!G.used).map(G=>({...G,_line:L})));if(!z.length){h.log.push({text:`❌ Aucun joueur ${$}`,type:"info"}),v(h);return}U(z,g,`Choisir ${g} joueur(s) ${$}(s) à exclure`,L=>{const B="usedCardIds_"+_,G=new Set(h[B]||[]);L.forEach(O=>{const H=(S[O._line]||[]).find(Q=>Q.cardId===O.cardId);H&&(H.used=!0,G.add(O.cardId),h.log.push({text:`❌ ${H.name} exclu !`,type:"info"}))}),h[B]=[...G],h[_+"Team"]=S,v(h)})},REVIVE_PLAYER:({count:g=1,roles:x=[]},y,h)=>{const v=y[r+"Team"],_=Object.entries(v).filter(([S])=>!x.length||x.includes(S)).flatMap(([S,$])=>$.filter(z=>z.used).map(z=>({...z,_line:S})));if(!_.length){y.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(y);return}U(_,g,`Choisir ${g} joueur(s) à ressusciter`,S=>{S.forEach($=>{const z=(v[$._line]||[]).find(L=>L.cardId===$.cardId);z&&(z.used=!1,y.log.push({text:`💫 ${z.name} ressuscité !`,type:"info"}))}),y[r+"Team"]=v,h(y)})},REMOVE_GOAL:({},g,x)=>{const y=m+"Score";g[y]>0?(g[y]--,g.log.push({text:"🚫 Dernier but annulé !",type:"info"})):g.log.push({text:"🚫 Aucun but à annuler",type:"info"}),x(g)},ADD_GOAL_DRAW:({},g,x)=>{g[r+"Score"]===g[m+"Score"]?(g[r+"Score"]++,g.log.push({text:"🎯 But bonus !",type:"info"})):g.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),x(g)},ADD_SUB:({value:g=1},x,y)=>{x.maxSubs=(x.maxSubs||3)+g,x.log.push({text:`🔄 +${g} remplacement(s)`,type:"info"}),y(x)},CUSTOM:({},g,x)=>x(g)};function U(g,x,y,h){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let _=[];function S(){var z,L;const $=g.map(B=>{const G={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[B._line]||"#555",O=je(B,B._line)+(B.boost||0),Q=_.find(ie=>ie.cardId===B.cardId)?"#FFD700":"rgba(255,255,255,0.25)",V=B.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${B.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Q};background:${G};overflow:hidden;cursor:pointer;${V}">
        ...
        </div>`,(z=v.querySelector("#pp-close"))==null||z.addEventListener("click",()=>v.remove()),v.querySelectorAll(".pp-item").forEach(B=>{B.addEventListener("click",()=>{const G=B.dataset.cid,O=g.find(Q=>Q.cardId===G),H=_.findIndex(Q=>Q.cardId===G);O&&(H>-1?_.splice(H,1):_.length<x&&_.push(O),S())})}),(L=v.querySelector("#pp-confirm"))==null||L.addEventListener("click",()=>{v.remove(),h(_)})}S(),document.body.appendChild(v)}async function N(g,x){const h=(p["gcCardsFull_"+r]||[]).find($=>$.id===g),v=(h==null?void 0:h._gcDef)||(p.gcDefs||[]).find($=>{var z;return $.name===x||((z=$.name)==null?void 0:z.toLowerCase().trim())===(x==null?void 0:x.toLowerCase().trim())}),_=[...p["usedGc_"+r]||[],g],S={type:x,by:r,seq:(p._gcAnimSeq||0)+1};M.add(S.seq),Ae(x,r,async()=>{if(v!=null&&v.effect_type&&v.effect_type!=="CUSTOM"){const z=X[v.effect_type];if(z){const L={...p};z(v.effect_params||{},L,async B=>{B["usedGc_"+r]=_,B._lastGC=S,B._gcAnimSeq=S.seq,await re(B)});return}}const $={...p};switch(x){case"Remplacement+":$.maxSubs=($.maxSubs||3)+1,$.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const z=m+"Score";$[z]>0&&($[z]--,$.log.push({text:"🚫 But annulé",type:"info"}));break}}$["usedGc_"+r]=_,$._lastGC=S,$._gcAnimSeq=S.seq,await re($)})}function ne(g,x){const y="usedCardIds_"+g,h=new Set(p[y]||[]);x.forEach(v=>h.add(v)),p[y]=[...h]}function pe(){for(const g of["p1","p2"]){const x=new Set(p["usedCardIds_"+g]||[]),y=p[g+"Team"];if(y)for(const h of["GK","DEF","MIL","ATT"])(y[h]||[]).forEach(v=>{v.used=x.has(v.cardId)})}}function ye(){var nt,gt,le,Ee,te,ue;if(p.phase==="reveal")return Le();if(p.phase==="midfield")return ve();if(p.phase==="finished")return w();const g=p[r+"Team"],x=p[m+"Team"];pe();const y=p[r+"Score"],h=p[m+"Score"],v=p[r+"Name"],_=p[m+"Name"],S=p.phase===r+"-attack",$=p.phase===r+"-defense",z=Array.isArray(p["selected_"+r])?p["selected_"+r]:[],L=z.map(ee=>ee.cardId),B=window.innerWidth>=700,G=p[r+"Subs"]||[],O=p["usedSubIds_"+r]||[],H=G.filter(ee=>!O.includes(ee.cardId)),Q=p["gcCardsFull_"+r]||[],V=p["usedGc_"+r]||[],ie=Q.filter(ee=>!V.includes(ee.id)),ae=p.boostOwner===r&&!p.boostUsed,fe=!["GK","DEF","MIL","ATT"].some(ee=>(x[ee]||[]).some(ce=>!ce.used)),me=[...g.MIL||[],...g.ATT||[]].filter(ee=>!ee.used),$e=S&&fe&&me.length===0?[...g.GK||[],...g.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function ke(ee,ce,Be){var zi,Si;const Te=ee._gcDef,tt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[Te==null?void 0:Te.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",it={purple:"#b06ce0",light_blue:"#00d4ef"}[Te==null?void 0:Te.color]||"#b06ce0",rt=(Te==null?void 0:Te.name)||ee.gc_type,st=(Te==null?void 0:Te.effect)||((zi=Re[ee.gc_type])==null?void 0:zi.desc)||"",ct=Te!=null&&Te.image_url?`/icons/${Te.image_url}`:null,kt=((Si=Re[ee.gc_type])==null?void 0:Si.icon)||"⚡",pt=Math.round(Be*.22),ht=Math.round(Be*.22),Et=Be-pt-ht,Kt=rt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
      ...
      </div>`}const Ce=(ee,ce)=>ce?qe(130,175):ke(ee,130,175),Oe=(ee,ce)=>ce?qe(68,95):ke(ee,68,95),Fe=B?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",He=S?be(r)?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${z.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Fe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:$?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${z.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${_}</div>`,De=S&&!be(r)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':S||$?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${z.length}/3 sélectionné(s)</div>`:"",Ve=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${B?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}if(S&&((Be=p.pendingAttack)!=null&&Be.players)){const Te=p.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let z=!1;const L=()=>{z||(z=!0,_.remove(),setTimeout(()=>v(),50))};_.addEventListener("click",L),setTimeout(L,3500)}function Ae(g,x,y){var V,ie;const h=(p.gcDefs||[]).find(ae=>{var fe;return ae.name===g||((fe=ae.name)==null?void 0:fe.toLowerCase().trim())===(g==null?void 0:g.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",S=(h==null?void 0:h.name)||g,$=(h==null?void 0:h.effect)||((V=Re[g])==null?void 0:V.desc)||"",z=h!=null&&h.image_url?`/icons/${h.image_url}`:null,L=((ie=Re[g])==null?void 0:ie.icon)||"⚡",G=x===r?"Vous":p[x+"Name"]||"Adversaire",O=document.createElement("div");O.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",O.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      </div>`,document.body.appendChild(y),(h=y.querySelector("#bp-close"))==null||h.addEventListener("click",()=>y.remove()),y.querySelectorAll(".bp-item").forEach(v=>{v.addEventListener("click",async()=>{const _=v.dataset.cid,S=x.find(z=>z.cardId===_);if(!S)return;const $=(g[S._line]||[]).find(z=>z.cardId===_);$&&($.boost=($.boost||0)+p.boostValue),y.remove(),await re({[r+"Team"]:g,boostUsed:!0})})})}function J(g=null){var H,Q;if(!(p.phase===r+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const y=p[r+"Team"],h=p["usedSubIds_"+r]||[],v=p.maxSubs||3;if(h.length>=v){f(`Maximum ${v} remplacements atteint`,"warning");return}const _=Object.entries(y).flatMap(([V,ie])=>(ie||[]).filter(ae=>ae.used).map(ae=>({...ae,_line:V}))),S=(p[r+"Subs"]||[]).filter(V=>!h.includes(V.cardId));if(!_.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!S.length){f("Aucun remplaçant disponible","warning");return}let $=Math.max(0,_.findIndex(V=>V.cardId===g));const z=((H=_[$])==null?void 0:H._line)||((Q=_[$])==null?void 0:Q.job);let L=Math.max(0,S.findIndex(V=>V.job===z)),B=!1;const G=document.createElement("div");G.id="pvp-sub-overlay",G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function O(){var ke,qe,Ce,Oe,Fe,He;const V=_[$],ie=S[L],ae=Math.min(130,Math.round((window.innerWidth-90)/2)),fe=Math.round(ae*1.35),me=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;G.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <button id="pin-down" style="${me(L>=S.length-1)}" ${L>=S.length-1?"disabled":""}>▼</button>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(v);let S=!1;const $=()=>{S||(S=!0,v.remove(),setTimeout(()=>y(),50))};v.addEventListener("click",$),setTimeout($,2200)}function ge(){var x;const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",g.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${p[m+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(p[m+"Team"],p[m+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(g),(x=g.querySelector("#pvp-opp-close"))==null||x.addEventListener("click",()=>g.remove())}function W(){var h;const g=p.log||[],x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const y=v=>{var S,$,z;if(v.type==="duel"){const L=v.isGoal,B=v.homeScored&&r==="p1"||!v.homeScored&&L&&r==="p2",G=v.homeScored?"#FFD700":L?"#ff6b6b":"rgba(255,255,255,0.3)",O=L?B?"⚽ BUT !":"⚽ BUT adversaire !":(S=v.homePlayers)!=null&&S.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${L?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${G};margin-bottom:4px">
          ...
          ${(z=v.aiPlayers)!=null&&z.length?`<div style="opacity:0.7">${ot(v.aiPlayers,"#ff6b6b",v.aiTotal)}</div>`:""}
      ...
      </div>`,document.body.appendChild(x),(h=x.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>x.remove())}async function Z(){if(p.phase!==r+"-attack")return;const g=r==="p1"?"p2":"p1",x=(p.round||0)+1,y=[...p.log||[]];y.push({type:"info",text:`⏭️ ${p[r+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const h=ze(p),v=be(g),_=h||!v?"finished":g+"-attack";await re({["selected_"+r]:[],modifiers:{...p.modifiers,[r]:{}},pendingAttack:null,phase:_,attacker:g,round:x,log:y}),_==="finished"&&await D(p)}async function K(){const g=p[r+"Team"],x=!["GK","DEF","MIL","ATT"].some(_=>(p[m+"Team"][_]||[]).some(S=>!S.used)),y=(p["selected_"+r]||[]).map(_=>{const S=(g[_._role]||[]).find(O=>O.cardId===_.cardId)||_,$=x&&["GK","DEF"].includes(_._role),z=g[_._role]||[],L=z.findIndex(O=>O.cardId===_.cardId),B=lt(z.length),G=L>=0?B[L]:S._col??1;return{...S,_line:_._role,_col:G,...$?{note_a:Math.max(1,Number(S.note_a)||0)}:{}}});if(!y.length)return;const h=Ot(y,p.modifiers[r]||{});ne(r,y.map(_=>_.cardId)),y.forEach(_=>{const S=(g[_._role]||[]).find($=>$.cardId===_.cardId);S&&(S.used=!0)}),p["selected_"+r]=[],ye();const v=[...p.log||[]];if(x){const _=(p[r+"Score"]||0)+1,S=y.map(G=>({name:G.name,note:je(G,G._line||"ATT"),portrait:Pe(G),job:G.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:S,homeTotal:h.total,aiTotal:0});const $=(p.round||0)+1,z=r==="p1"?"p2":"p1",L={...p,[r+"Team"]:g,[r+"Score"]:_},B=ze(L);F.add($),_e(S,_,p[m+"Score"]||0,!0,async()=>{await re({[r+"Team"]:g,[r+"Score"]:_,["selected_"+r]:[],modifiers:{...p.modifiers,[r]:{}},pendingAttack:null,phase:B?"finished":z+"-attack",attacker:z,round:$,log:v}),B&&await D({...p,[r+"Score"]:_})});return}v.push({type:"pending",text:`⚔️ ${p[r+"Name"]} attaque (${h.total})`}),await re({[r+"Team"]:g,[m+"Team"]:p[m+"Team"],pendingAttack:{...h,players:y,side:r},["selected_"+r]:[],modifiers:{...p.modifiers,[r]:{}},phase:m+"-defense",log:v})}async function se(){const g=p[r+"Team"],x=(p["selected_"+r]||[]).map(V=>{const ie=(g[V._role]||[]).find(ke=>ke.cardId===V.cardId)||V,ae=g[V._role]||[],fe=ae.findIndex(ke=>ke.cardId===V.cardId),me=lt(ae.length),$e=fe>=0?me[fe]:ie._col??1;return{...ie,_line:V._role,_col:$e}}),y=Ht(x,p.modifiers[r]||{});ne(r,x.map(V=>V.cardId)),x.forEach(V=>{const ie=(g[V._role]||[]).find(ae=>ae.cardId===V.cardId);ie&&(ie.used=!0)}),p["selected_"+r]=[],ye();const h=Ut(p.pendingAttack.total,y.total,p.modifiers[r]||{}),v=p.pendingAttack.side,_=h==="attack"||(h==null?void 0:h.goal),S=v==="p1"?"p2":"p1",$=(p.round||0)+1,z=(p.pendingAttack.players||[]).map(V=>({name:V.name,note:je(V,V._line||"ATT"),portrait:Pe(V),job:V.job})),L=[...p.log||[]];L.push({type:"duel",isGoal:_,homeScored:_&&v===r,text:_?`⚽ BUT de ${p[v+"Name"]} ! (${p.pendingAttack.total} vs ${y.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${y.total})`,homePlayers:z,aiPlayers:x.map(V=>({name:V.name,note:je(V,V._line||"DEF"),portrait:Pe(V),job:V.job})),homeTotal:p.pendingAttack.total,aiTotal:y.total});const B=_?(p[v+"Score"]||0)+1:p[v+"Score"]||0,G={...p,[r+"Team"]:g,[v+"Score"]:B},O=ze(G),H=O?"finished":S+"-attack",Q=async()=>{await re({[r+"Team"]:g,[m+"Team"]:p[m+"Team"],[v+"Score"]:B,["selected_"+r]:[],modifiers:{...p.modifiers,[r]:{}},pendingAttack:null,phase:H,attacker:S,round:$,log:L}),(H==="finished"||O)&&await D({...p,[v+"Score"]:B})};if(_){const V=v===r,ie=V?B:p[r+"Score"]||0,ae=V?p[m+"Score"]||0:B;F.add($),_e(z,ie,ae,V,Q)}else await Q()}function he(g){return["MIL","ATT"].some(x=>(g[x]||[]).some(y=>!y.used))}function Se(g){return["GK","DEF","MIL","ATT"].some(x=>(g[x]||[]).some(y=>!y.used))}function Me(g){return Se(g)&&!he(g)}function be(g){const x=p[g+"Team"],y=p[(g==="p1"?"p2":"p1")+"Team"];return!!(he(x)||!Se(y)&&Me(x))}function ze(g){const x=["MIL","ATT"].some(L=>(g.p1Team[L]||[]).some(B=>!B.used)),y=["MIL","ATT"].some(L=>(g.p2Team[L]||[]).some(B=>!B.used)),h=Se(g.p1Team),v=Se(g.p2Team);return!x&&!(!v&&h)&&(!y&&!(!h&&v))}function j(g){const x=g.p1Score||0,y=g.p2Score||0;return x===y?null:x>y?T.home_id:T.away_id}async function D(g){try{const x=j(g),y=x?T.home_id===x?T.away_id:T.home_id:null,h=g.p1Score||0,v=g.p2Score||0;await k.from("matches").update({status:"finished",winner_id:x,home_score:h,away_score:v}).eq("id",i);const{data:_}=await k.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(_){await k.from("mini_league_matches").update({home_score:h,away_score:v,status:"finished"}).eq("id",_.id);const{data:S}=await k.from("mini_league_matches").select("id, status").eq("league_id",_.league_id).eq("matchday",_.matchday);if((S||[]).every(z=>z.status==="finished"||z.status==="bye")){const{data:z}=await k.from("mini_leagues").select("current_day,total_days").eq("id",_.league_id).single();if(z){const L=(z.current_day||0)+1,B=L>(z.total_days||0);await k.from("mini_leagues").update({current_day:B?z.total_days:L,status:B?"finished":"active"}).eq("id",_.league_id)}}}x&&y&&ki(x,y).catch(()=>{})}catch(x){console.error("[ML] finishMatch:",x)}}function w(){var v;if(A&&document.getElementById("pvp-end-overlay"))return;A=!0;const g=p[r+"Score"],x=p[m+"Score"],y=g>x,h=g===x;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
