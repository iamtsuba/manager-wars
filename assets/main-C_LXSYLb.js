...
import{s as w,l as Ot,m as Bi,F as qi,r as Ae,j as ti,h as Di,n as Kn,o as Vn,T as bi,k as Yn,p as Wn,b as Xn}from"./formation-links-Bb-Ce4un.js";const Jn="/";function Qi(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,l,c,d,x;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var m;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),x=((m=document.getElementById("setup-club"))==null?void 0:m.value)||"MW",y=x.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():x.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),d&&(d.textContent=g,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:x}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(x){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:x}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(x){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),x=document.getElementById("step3-error"),y=document.getElementById("step3-finish");x.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Zn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){x.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Zn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const eo="modulepreload",to=function(e){return"/"+e},Zi={},mn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(l=>{if(l=to(l),l in Zi)return;Zi[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const x=document.createElement("link");if(x.rel=c?"stylesheet":eo,c||(x.as="script"),x.crossOrigin="",x.href=l,s&&x.setAttribute("nonce",s),document.head.appendChild(x),c)return new Promise((y,g)=>{x.addEventListener("load",y),x.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Wt="#1A6B3C",Xt="#cc2222",io="#D4A017",en="#888";async function no(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${y.map(({friendshipId:g,friend:m})=>oo(m,g)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>ao(e,g.dataset.stats,g.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const m=g.dataset.friendId,p=g.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:b}=await w.from("friend_match_invites").select("id").eq("inviter_id",m).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),v=!!b;console.log("[Friends] clic match",{fid:m,fname:p,isAccepting:v}),n("match",{matchMode:"friend",friendId:m,friendName:p,isAccepting:v})})})}function oo(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||Wt,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,l=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    </style>`}const so="2026.07.20-0830";async function tn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    </div>`}).join(""),n.querySelectorAll("[data-resume]").forEach(l=>{l.addEventListener("click",async()=>{const c=document.getElementById("page-content")||document.getElementById("app");if(l.dataset.mini==="1"){const{data:d}=await w.from("mini_league_matches").select("id, league_id").eq("match_id",l.dataset.resume).single();d?i("match-mini-league",{mlMatchId:d.id,leagueId:d.league_id}):i("mini-league")}else{const{resumePvpMatch:d}=await mn(async()=>{const{resumePvpMatch:x}=await Promise.resolve().then(()=>wr);return{resumePvpMatch:x}},void 0);d(c,{state:e,navigate:i,toast:t,openModal:null,closeModal:null,refreshProfile:null},l.dataset.resume)}})}),n.querySelectorAll("[data-abandon]").forEach(l=>{l.addEventListener("click",()=>{po(async()=>{await co(l.dataset.abandon,l.dataset.opp,r),t("Match abandonné (défaite 3-0)","info"),bn(e,t,i)})})})}async function co(e,t,i){const{data:n}=await w.from("matches").select("home_id, away_id, game_state, mode").eq("id",e).single();if(!n)return;const r=n.home_id===i,o=r?0:3,a=r?3:0,s=n.game_state||{};s.p1Score=o,s.p2Score=a,s.phase="finished",s.forfeit=!0,await w.from("matches").update({status:"finished",forfeit:!0,winner_id:t,home_score:o,away_score:a,game_state:s}).eq("id",e),n.mode==="mini_league"&&await w.from("mini_league_matches").update({status:"finished",home_score:o,away_score:a}).eq("match_id",e)}function po(e){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`<div class="modal" style="max-width:340px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Ae(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(A=>A.card_type==="player"&&A.player),d=(s||[]).filter(A=>A.card_type==="game_changer"),x=(s||[]).filter(A=>A.card_type==="formation"),y=(s||[]).filter(A=>A.card_type==="stadium"),{data:g}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),m={};(g||[]).forEach(A=>{m[A.name]=A});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(A=>{u[A.id]=A}),y.forEach(A=>{A.stadium_def&&(u[A.stadium_id]=A.stadium_def)});const b=Object.keys(qi),v=Object.keys(Ce),h={};c.forEach(A=>{const D=A.player.id;h[D]=(h[D]||0)+1}),new Set(Object.keys(h).map(A=>String(A)));const $=new Set(x.map(A=>A.formation)),f=new Set(d.map(A=>A.gc_type));let M="player",k="Tous",P="",H=!1;function ae(){return[...c].sort((A,D)=>{const Y=ii.indexOf(A.player.job),te=ii.indexOf(D.player.job);return Y!==te?Y-te:(A.player.surname_real||"").localeCompare(D.player.surname_real||"")})}function re(){return[...l||[]].sort((A,D)=>{const Y=ii.indexOf(A.job),te=ii.indexOf(D.job);return Y!==te?Y-te:(A.surname_real||"").localeCompare(D.surname_real||"")})}function ee(){return ae().filter(A=>{const D=A.player,Y=k==="Tous"||D.job===k,te=!P||`${D.firstname} ${D.surname_real}`.toLowerCase().includes(P);return Y&&te})}function j(){return re().filter(A=>{const D=k==="Tous"||A.job===k,Y=!P||`${A.firstname} ${A.surname_real}`.toLowerCase().includes(P);return D&&Y})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="display:flex;border-bottom:2px solid var(--tile-border);background:var(--tile-bg)">
      ...
      <button class="col-tab-btn" data-tab="stadium" style="flex:1;padding:10px 4px;border:none;background:none;cursor:pointer;
        ...
        color:${M==="stadium"?"#E87722":"var(--tile-fg-dim)"}">
      ...
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        <div style="display:flex;gap:6px;overflow-x:auto;padding-bottom:2px;align-items:center">
          ...
          <button id="show-all-btn"
            style="flex-shrink:0;margin-left:auto;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
              ...
              color:${H?"#111":"var(--tile-fg-dim)"}; font-size:18px; padding:5px 10px">
            ${H?"👁️":"🚫👁️"}
          </button>
        ...
        <div style="display:flex;justify-content:flex-end">
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Ge?`<img src="${Ge}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${C.icon}</span>`}
          </div>
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(A=>{A.addEventListener("click",()=>{M=A.dataset.tab,k="Tous",P="",H=!1,e.querySelectorAll(".col-tab-btn").forEach(D=>{const Y=D.dataset.tab===M;D.style.borderBottomColor=Y?"var(--green)":"transparent",D.style.color=Y?"var(--green)":"var(--tile-fg-dim)"}),L(),V()})}),L(),V()}function zo(e,t,i){const n=Ce[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,x=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ni=1e3;function Io(e,t,i,n){var m,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function x(){const b=ti[c]||{},v=qi[c]||[],h=290,$=360,f=20;function M(P){const H=b[P];return H?{x:H.x*h,y:H.y*$}:null}let k=`<svg width="${h}" height="${$}" viewBox="0 0 ${h} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,H]of v){const ae=M(P),re=M(H);!ae||!re||(k+=`<line x1="${ae.x}" y1="${ae.y}" x2="${re.x}" y2="${re.y}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(m=document.getElementById("direct-sell-form-btn"))==null||m.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${c} pour ${ni.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const b=y.find(h=>!h.is_for_sale)||y[0];if(!b){o("Aucune carte à vendre","error");return}await w.from("market_listings").delete().eq("card_id",b.id),await w.from("transfer_history").delete().eq("card_id",b.id);const{error:v}=await w.from("cards").delete().eq("id",b.id);if(v){o(v.message,"error");return}await w.from("users").update({credits:(r.profile.credits||0)+ni}).eq("id",r.profile.id),await l(),o(`+${ni.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const b=parseInt(document.getElementById("sell-price-form").value);if(!b||b<1){o("Prix invalide","error");return}await w.from("cards").update({is_for_sale:!0,sale_price:b}).eq("id",e.id),await w.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:b}),o("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await w.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),s("collection")})}async function sn(e,t,i,n){var ue,ge,I,W,pe;const{state:r,toast:o,openModal:a,closeModal:s,navigate:l,refreshProfile:c}=n,d=e.player,x=t.filter(G=>G.player.id===d.id),y=x.length,g=e.evolution_bonus||0,m=Math.max((Number(d.note_g)||0)+(d.job==="GK"||d.job2==="GK"?g:0),(Number(d.note_d)||0)+(d.job==="DEF"||d.job2==="DEF"?g:0),(Number(d.note_m)||0)+(d.job==="MIL"||d.job2==="MIL"?g:0),(Number(d.note_a)||0)+(d.job==="ATT"||d.job2==="ATT"?g:0)),p=d.rarity||"normal",{data:u}=await w.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",m).gte("note_max",m).order("note_min",{ascending:!1}).limit(1);((ue=u==null?void 0:u[0])==null?void 0:ue.price)??_o[p];const b=d.rarity!=="legende";To(d);const v=((d.rarity==="pepite"||d.rarity==="papyte")&&e.current_note!=null?e.current_note:vi(d,d.job))+g,h=d.rarity==="pepite"||d.rarity==="papyte",$=d.job2?(h?bo(e,$o(d.job2)):vi(d,d.job2))+(vi(d,d.job2)>0?g:0):null;hi[d.job],d.job2&&hi[d.job2];const f=vo[d.rarity]||"#ccc";Eo[d.country_code]||d.country_code;const M=e.evolution_bonus||0,P=v+M,H=$||0,ae=H>0?H+M:0,re=x.map(G=>G.id);let ee={};if(re.length){const{data:G}=await w.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",re).order("transferred_at",{ascending:!0});(G||[]).forEach(K=>{ee[K.card_id]||(ee[K.card_id]=[]),ee[K.card_id].push(K)})}const j=G=>{const K=G.transferred_at?new Date(G.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",N=G.source==="booster"?"Booster":G.price?G.price.toLocaleString("fr"):"—";return`
    <div style="display:flex;justify-content:space-between;align-items:flex-start;background:#f9f9f9;border-radius:8px;padding:8px 12px;gap:8px">
      ...
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:13px;font-weight:700;color:${G.source==="booster"?"var(--tile-fg-dim)":"var(--yellow)"}">${N}</div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([G,K])=>{const N=hi[G],A=G==="GK"?"#fff":N,D=G===d.job||G===d.job2,Y=(Number(K)||0)+(D&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ge=document.getElementById("close-detail"))==null||ge.addEventListener("click",s);let V=new Set;const ie=()=>{const G=V.size,K=document.getElementById("sell-action-panel");if(!K)return;K.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G;const N=document.getElementById("evolve-btn");N&&(N.textContent=`⬆️ Évoluer ${G>1?"(+"+G+")":""}`)};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const K=G.dataset.id;G.checked?V.add(K):V.delete(K);const N=G.closest(".exemplaire-row");N&&(N.style.borderColor=G.checked?"#1A6B3C":"#eee"),ie()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",K=>{if(K.target.closest("button")||K.target.tagName==="INPUT")return;const N=G.querySelector(".expl-check");N&&!N.disabled&&(N.checked=!N.checked,N.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",K=>{K.stopPropagation();const N=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);N&&(N.style.display=N.style.display==="none"?"flex":"none")})}),(I=document.getElementById("evolve-btn"))==null||I.addEventListener("click",async()=>{if(y<=1)return;const G=[...V];if(!G.length)return;if(V.has(e.id)){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",R.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
  ...
  </div>`;const d=window.innerWidth>=900,x=e.querySelector(".deck-pc-layout"),y=e.querySelector(".deck-mobile-layout");x&&(x.style.display=d?"block":"none"),y&&(y.style.display=d?"none":"block"),Ao(e,t,r,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const g=()=>{const{openModal:u,closeModal:b}=i,v=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(y=document.getElementById("close-sub-selector"))==null||y.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{e.subs.push(g.dataset.cardId),r(),vt(t,e,i)})})}async function Bo(e,t){const{state:i,toast:n,navigate:r}=t,o=e.formationCards.find(l=>l.formation===e.formation),a=(o==null?void 0:o.id)||e.formationCardId;await w.from("decks").update({formation:e.formation,formation_card_id:a||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await w.from("deck_cards").delete().eq("deck_id",e.deckId);const s=[];if(Object.entries(e.slots).forEach(([l,c],d)=>{s.push({deck_id:e.deckId,card_id:c,position:l,is_starter:!0,slot_order:d})}),e.subs.forEach((l,c)=>{s.push({deck_id:e.deckId,card_id:l,position:`SUB${c+1}`,is_starter:!1,slot_order:100+c})}),s.length>0){const{error:l}=await w.from("deck_cards").insert(s);if(l){n(l.message,"error");return}}n("Deck enregistré ✅","success"),r("decks")}function cn(e){const t=ai[e]||ai["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}async function En(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await w.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const n=i.filter(a=>!(a.available_from&&t<a.available_from||a.available_until&&t>a.available_until));if(!n.length)return[];let r=n;if(e){const a=n.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await w.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",a.map(c=>c.id)),l={};(s||[]).forEach(c=>{l[c.booster_id]=(l[c.booster_id]||0)+1}),r=n.filter(c=>c.max_per_user==null?!0:(l[c.id]||0)<c.max_per_user)}}if(!r.length)return[];const{data:o}=await w.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(o||[]).filter(s=>s.booster_id===a.id)}))}async function qo(e,t){const{data:i}=await w.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await w.from("booster_claims").insert({user_id:e,booster_id:t})}function Do(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,r)=>n+Number(r.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const Tn=()=>Object.keys(ti),Fo=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Li={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Po(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return Ae({...t,_evolution_bonus:i},{width:140})}function Ln(e){var r;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((r=Object.entries(t).sort((o,a)=>a[1]-o[1])[0])==null?void 0:r[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function Go(e,{state:t,navigate:i,toast:n}){var x,y,g;const r=((x=t.profile)==null?void 0:x.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await En((y=t.user)==null?void 0:y.id)).map(Ln)}catch(m){console.warn("Erreur chargement boosters DB, fallback hardcodé",m)}o.length||(o=Fo.map(m=>({...m,rates:[],isPub:m.id==="players_pub"})));const a=await w.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(m=>m.data||[]),s=new Set(a.filter(m=>m.card_type==="stadium").map(m=>m.stadium_id)),l=new Set(a.filter(m=>m.card_type==="formation").map(m=>m.formation)),c=new Set(a.filter(m=>m.card_type==="game_changer").map(m=>m.gc_type)),d={};for(const m of o){if(m.allow_duplicates!==!1||!((g=m.rates)!=null&&g.length))continue;const p=[...new Set((m.rates||[]).map(b=>b.card_type))];let u=!1;for(const b of p)if(b==="stadium"){const{data:v}=await w.from("stadium_definitions").select("id");if((v||[]).some(h=>!s.has(h.id))){u=!0;break}}else if(b==="game_changer"){const{data:v}=await w.from("gc_definitions").select("name").eq("is_active",!0);if((v||[]).some(h=>!c.has(h.name))){u=!0;break}}else if(b==="formation"){const{FORMATION_LINKS:v}=await mn(async()=>{const{FORMATION_LINKS:h}=await import("./formation-links-Bb-Ce4un.js").then($=>$.q);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(v).some(h=>!l.has(h))){u=!0;break}}else{u=!0;break}u||(d[m.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=L=>L.touches&&L.touches[0]?L.touches[0].clientX:L.clientX;function d(L){o||(l=!0,s.style.opacity="1",x(L))}function x(L){if(!l||o)return;const V=a.getBoundingClientRect(),ie=c(L)-V.left,ue=Math.max(0,Math.min(1,ie/V.width));s.style.width=ue*V.width+"px",ue>=.82&&g()}function y(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var V;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(V=document.getElementById("cut-flash"))==null||V.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const L=document.getElementById("cut-hint");L&&(L.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",d),window.addEventListener("pointermove",x),window.addEventListener("pointerup",y),a.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",x,{passive:!0}),window.addEventListener("touchend",y);let m=0,p=!1;const u=new Set;function b(L){m=L,document.getElementById("reveal-phase").style.display="flex",v(),h(L,0),P()}function v(){const L=document.getElementById("card-dots");L&&(L.innerHTML=e.map((V,ie)=>`<div class="card-dot" data-i="${ie}" style="width:8px;height:8px;border-radius:50%;background:${ie===m?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),L.querySelectorAll(".card-dot").forEach(V=>V.addEventListener("click",()=>f(parseInt(V.dataset.i)))))}function h(L,V){var N,A;const ie=e[L],ue=document.getElementById("card-counter"),ge=document.getElementById("card-track");ue&&(ue.textContent=`Carte ${L+1} / ${e.length}`);const I=document.getElementById("reveal-btns");I&&(I.style.display=L===e.length-1?"flex":"none");const W=ie.card_type==="player"&&((N=ie.player)==null?void 0:N.rarity)==="legende",pe=!u.has(L);u.add(L);let G=0;if(ie.card_type==="player"&&ie.player){const D=ie.player,Y=D.job||"ATT";G=Number(Y==="GK"?D.note_g:Y==="DEF"?D.note_d:Y==="MIL"?D.note_m:D.note_a)||0}const K=D=>{ge.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${W?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Ho(ie)}</div>
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function Vo(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const n=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(n),t.remove(),e(!0))},1e3)})}async function Yo(e,{state:t,navigate:i,toast:n,refreshProfile:r}){var y,g;const{data:o}=await w.from("users").select("*").eq("id",t.user.id).single();o&&(t.profile=o);let a=Array.isArray((y=t.profile)==null?void 0:y.pending_boosters)?[...t.profile.pending_boosters]:[];if(!a.length){await w.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let s=null;try{const p=(await En()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(s=Ln(p))}catch(m){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',m)}const l=a.length;let c=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}function Cn(e){var o,a,s;if(!e)return"";const t=l=>l?Ae({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(l)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function er(e,t,i){const n=document.getElementById("sub-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ot(o,e[a+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Bn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
    ...
    </div>`}async function tr(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await gi(e,t,r,async({deckId:s,formation:l,starters:c,subsRaw:d,gcCardsEnriched:x,gcDefs:y,stadiumDef:g})=>{try{let m=di(c,l);g&&(m=ei(m,g),si(d,g));const p=await ir(l,o),u=p.lines||p,b=async v=>{try{const h=a==="vs_ai_club"?"club":a,{data:$,error:f}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:h,home_deck_id:s,status:"in_progress"}).select().single();if(f){console.error("[MatchIA] Erreur création match:",f),Tt(e,"⚠️","Impossible de créer le match ("+f.message+").","Retour",()=>t.navigate("home"));return}const M=p.stadiumDef||null;M&&u&&(ei(u,M),si(p.subs||[],M));const k={gcDefs:y||[],matchId:$==null?void 0:$.id,mode:a,difficulty:o,formation:l,homeTeam:m,aiTeam:u,homeSubs:d,subsUsed:0,maxSubs:Math.min(d.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:M,homeScore:0,aiScore:0,gcCards:v,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};or(e,k,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),Tt(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!x.length){b([]);return}ui(e,x,b)}catch(m){console.error("[MatchIA] Exception setup:",m),Tt(e,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>t.navigate("home"))}})}async function ir(e,t){var u;const{data:i}=await w.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:nr(e),subs:[],gcCards:[],stadiumDef:null};const n=Gt[e]||Gt["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(b,v,h){var $,f;return o.add(b.id),{cardId:"ai-"+b.id+"-"+h,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:(($=b.clubs)==null?void 0:$.encoded_name)||null,clubLogo:((f=b.clubs)==null?void 0:f.logo_url)||null,boost:0,used:!1,_line:v}}for(const b of["GK","DEF","MIL","ATT"]){const v=i.filter(k=>k.job===b&&!o.has(k.id)),h=i.filter(k=>k.job!==b&&!o.has(k.id)),$=[...v,...h],f=[];for(let k=0;k<n[b];k++){const P=$[k];P&&f.push(a(P,b,k))}const M=mt(f.length);f.forEach((k,P)=>{k._col=M[P]}),r[b]=f}const l=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,v)=>a(b,b.job,100+v)),x=Object.keys(Ce).sort(()=>Math.random()-.5).slice(0,3).map((b,v)=>{var h,$;return{id:"ai-gc-"+v,gc_type:b,name:((h=Ce[b])==null?void 0:h.name)||b,icon:(($=Ce[b])==null?void 0:$.icon)||"⚡"}}),y=Object.values(r).flat(),g={};y.forEach(b=>{b.club_id&&(g[b.club_id]=(g[b.club_id]||0)+1)});const m=(u=Object.entries(g).sort((b,v)=>v[1]-b[1])[0])==null?void 0:u[0];let p=null;if(m){const{data:b}=await w.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",m).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:r,subs:l,gcCards:x,stadiumDef:p}}function nr(e){const t=Gt[e]||Gt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<t[o];l++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=mt(a.length);a.forEach((l,c)=>{l._col=s[c]}),i[o]=a}return i}function or(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const W=t.pendingAttack;let pe="";if(t.selected.length>0){const G=t.selected.map(N=>({...(t.homeTeam[N._role]||[]).find(D=>D.cardId===N.cardId)||N,_line:N._role})),K=Qt(G,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Xe(G.map(N=>({...N,used:!1})),"#3a7bd5",K.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Xe((W.players||[]).map(G=>({...G,used:!1})),"#ff6b6b",W.total,"attack",t.formation)}</div>
            ${pe}
            ...
            <div style="display:flex;justify-content:center">${Xe(W.map(G=>({...G,used:!1})),"#FFD700",pe.total,"attack",t.formation)}</div>
          </div>`}const I=t.log[t.log.length-1];return I?'<div style="padding:2px 4px">'+Cn(I)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const I=window.innerWidth>=700,W=(R,C,O)=>{var tt,Oe;const ce=(t.gcDefs||[]).find(xi=>xi.name===R.gc_type),ke={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_e={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",he=(ce==null?void 0:ce.name)||R.gc_type,Ee=(ce==null?void 0:ce.effect)||((tt=Ce[R.gc_type])==null?void 0:tt.desc)||"",Te=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,ve=((Oe=Ce[R.gc_type])==null?void 0:Oe.icon)||"⚡",ze=Math.round(O*.22),De=Math.round(O*.22),je=O-ze-De,Ge=he.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          ...
          <div style="height:${ze}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ge}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${C-6}px">${he}</span>
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Rt(t.homeTeam,t.formation,t.phase,n,I?1300:Lt(),I?600:Pt(),m)}
        </div>
      </div>`;return I?`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(I=>{var W,pe,G;if(I.type==="duel"){const K=I.isGoal,N=I.homeScored?"#FFD700":K?"#ff6b6b":"rgba(255,255,255,0.3)",A=I.homeScored?"⚽ BUT !":K?"⚽ BUT IA !":(W=I.homePlayers)!=null&&W.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${K?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${N};margin-bottom:4px">
                ...
                ${(pe=I.homePlayers)!=null&&pe.length?`<div style="margin-bottom:3px">${Xe(I.homePlayers,"rgba(255,255,255,0.7)",I.homeTotal,void 0,t.formation)}</div>`:""}
                ${(G=I.aiPlayers)!=null&&G.length?`<div style="opacity:0.7">${Xe(I.aiPlayers,"#ff6b6b",I.aiTotal,void 0,t.formation)}</div>`:""}
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${I.outPlayer?ht({...I.outPlayer,used:!0,_line:I.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${I.inPlayer?ht({...I.inPlayer,_line:I.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${u?ht({...u,used:!1,boost:0},b,v):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?ht({...p,used:!1,boost:0},b,v):"<div>—</div>"}</div>
    ...
    </div>`,document.body.appendChild(g),(m=g.querySelector("#gc-back"))==null||m.addEventListener("click",()=>g.remove()),(p=g.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{g.remove(),gr(e,t,i,n,r)})}function oi(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function l(){var c,d;a.innerHTML=`
    ...
    </div>`,(c=a.querySelector("#gc-picker-close"))==null||c.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(x=>{x.addEventListener("click",()=>{const y=x.dataset.cid,g=e.find(p=>p.cardId===y);if(!g)return;const m=s.findIndex(p=>p.cardId===y);m>-1?s.splice(m,1):s.length<t&&s.push(g),l()})}),(d=a.querySelector("#gc-picker-confirm"))==null||d.addEventListener("click",()=>{a.remove(),o(s)})}l(),document.body.appendChild(a)}const fr={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},n,r,o)=>{const a=Object.entries(n.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,l])=>l.filter(c=>!c.used).map(c=>({...c,_line:s})));return a.length?(oi(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,r,n,s=>{s.forEach(l=>{const c=(n.homeTeam[l._line]||[]).find(d=>d.cardId===l.cardId);c&&(c.boost=(c.boost||0)+e,n.log.push({text:`⚡ +${e} sur ${c.name}`,type:"info"}))}),$e(r,n,o)}),!0):(n.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),$e(r,n,o),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:n="ai"},r,o,a)=>{const s=n==="home"?r.homeTeam:r.aiTeam,l=n==="ai"?"adverse":"allié",c=Object.entries(s).filter(([d])=>!i.length||i.includes(d)).flatMap(([d,x])=>x.filter(y=>!y.used).map(y=>({...y,_line:d})));return c.length?(oi(c,t,`Choisir ${t} joueur(s) ${l}(s) à débuffer (-${e})`,o,r,d=>{d.forEach(x=>{const g=((n==="home"?r.homeTeam:r.aiTeam)[x._line]||[]).find(m=>m.cardId===x.cardId);g&&(g.boost=(g.boost||0)-e,r.log.push({text:`🎯 -${e} sur ${g.name}${n==="ai"?" (IA)":""}`,type:"info"}))}),$e(o,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${l} disponible`,type:"info"}),$e(o,r,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},n,r,o)=>{const a=i==="home"?n.homeTeam:n.aiTeam,s=i==="ai"?"adverse":"allié",l=Object.entries(a).filter(([c])=>!t.length||t.includes(c)).flatMap(([c,d])=>d.filter(x=>!x.used).map(x=>({...x,_line:c})));return l.length?(oi(l,e,`Choisir ${e} joueur(s) ${s}(s) à exclure`,r,n,c=>{c.forEach(d=>{const y=((i==="home"?n.homeTeam:n.aiTeam)[d._line]||[]).find(g=>g.cardId===d.cardId);y&&(y.used=!0,n.log.push({text:`❌ ${y.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),$e(r,n,o)}),!0):(n.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),$e(r,n,o),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,n,r)=>{const o=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,s])=>s.filter(l=>l.used).map(l=>({...l,_line:a})));return o.length?(oi(o,e,`Choisir ${e} joueur(s) à ressusciter`,n,i,a=>{a.forEach(s=>{const l=(i.homeTeam[s._line]||[]).find(c=>c.cardId===s.cardId);l&&(l.used=!1,i.log.push({text:`💫 ${l.name} ressuscité !`,type:"info"}))}),$e(n,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),$e(n,i,r),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function gr(e,t,i,n,r){n.usedGc.push(e);const o=n.gcDefs||[],a=o.find(l=>l.name===t)||o.find(l=>{var c;return((c=l.name)==null?void 0:c.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const l=fr[a.effect_type];l?l(a.effect_params||{},n,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const l=Object.entries(n.homeTeam).flatMap(([c,d])=>(d||[]).filter(x=>x.used).map(x=>({...x,_line:c})));l.length?(l[0].used=!1,n.log.push({text:`💫 ${l[0].name} ressuscité !`,type:"info"})):n.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const l=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(c=>!c.used);if(l.length){const c=l.sort((d,x)=>Pe(x,"ATT")-Pe(d,"ATT"))[0];c.used=!0,n.log.push({text:`❄️ ${c.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}w.from("cards").delete().eq("id",e).then(()=>{}),s&&$e(i,n,r)}function mr(e,t,i){const n=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),$e(e,t,i)})})}async function bt(e,t,i){var d,x;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=xo(t.mode,a);t.matchId&&await w.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await w.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Rt(_,f[p+"Formation"],pt,Q,Lt(),Pt(),He)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function At(){const X=e.querySelector(".match-screen");if(!X)return;const fe=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=fe+"px",X.style.minHeight=fe+"px",X.style.maxHeight=fe+"px",X.style.overflow="hidden";const Se=e.querySelector("#mobile-action-bar"),we=e.querySelector("#mobile-play-area");Se&&we&&(we.style.paddingBottom=Se.offsetHeight+"px")}if(At(),setTimeout(At,120),setTimeout(At,400),P||(P=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",At),window.visualViewport.addEventListener("scroll",At)),window.addEventListener("resize",At)),function(){const fe=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!fe)return;const Se=fe.closest("#match-terrain-wrap");Se&&(Se.style.cssText="position:relative;width:100%;height:100%;padding:0"),fe.removeAttribute("width"),fe.removeAttribute("height"),fe.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",fe.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const fe=X.closest("#match-terrain-wrap");fe&&(fe.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!B&&!q)return;const fe=X.dataset.cardId,Se=X.dataset.role,we=(_[Se]||[]).find(Ne=>Ne.cardId===fe);if(!we||we.used)return;const Mt=He.includes(fe);if(B&&!["MIL","ATT"].includes(Se)&&!Mt)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const rt=f["selected_"+p],qe=rt.findIndex(Ne=>Ne.cardId===fe);qe>-1?rt.splice(qe,1):rt.length<3&&rt.push({...we,_role:Se}),W()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>Y(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>Y())}),(Ki=e.querySelector("#pvp-sub-open"))==null||Ki.addEventListener("click",()=>Y()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{B?X.addEventListener("click",()=>A(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>kt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Vi=e.querySelector("#pvp-boost-card"))==null||Vi.addEventListener("click",()=>D()),(Yi=e.querySelector("#pvp-action"))==null||Yi.addEventListener("click",X=>{B?X.currentTarget.dataset.pass==="1"||!je(p)?O():Ee():q&&Te()}),(Wi=e.querySelector("#pvp-quit"))==null||Wi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&L()}),(Xi=e.querySelector("#pvp-view-opp"))==null||Xi.addEventListener("click",()=>R()),(Ji=e.querySelector("#pvp-toggle-history"))==null||Ji.addEventListener("click",()=>C()),k&&(clearInterval(k),k=null),(B||q)&&!M){let X=30,fe=!1;const Se=()=>document.getElementById("pvp-timer"),we=()=>{Se()&&(Se().textContent=X+"s",Se().style.color=fe?"#ff4444":"#fff")};we(),k=setInterval(()=>{X--,X<0?fe?(clearInterval(k),k=null,B&&!je(p)?O():L()):(fe=!0,X=15,we()):we()},1e3)}}function pe(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${li(_,f[p+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${E.map(T=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",B=Pe(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${F};overflow:hidden;cursor:pointer">
      ...
      </div>`,(Re=Z.querySelector("#psub-close"))==null||Re.addEventListener("click",()=>Z.remove()),(Ie=Z.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{q>0&&(q--,J())}),(Ve=Z.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{q<F.length-1&&(q++,J())}),(He=Z.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{Q>0&&(Q--,J())}),(it=Z.querySelector("#pin-down"))==null||it.addEventListener("click",()=>{Q<B.length-1&&(Q++,J())});const Le=(Be,Ye,Ue,ct)=>{const nt=Z.querySelector("#"+Be);if(!nt)return;let St=0;nt.addEventListener("touchstart",pt=>{St=pt.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",pt=>{const wt=pt.changedTouches[0].clientY-St;if(Math.abs(wt)<30)return;const ot=Ye();wt<0&&ot<ct-1?(Ue(ot+1),J()):wt>0&&ot>0&&(Ue(ot-1),J())},{passive:!0})};Le("pin-panel",()=>Q,Be=>Q=Be,B.length),Le("pout-panel",()=>q,Be=>q=Be,F.length),(Ht=Z.querySelector("#psub-confirm"))==null||Ht.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),ne)return;ne=!0;const Ye=F[q],Ue=B[Q];if(!Ye||!Ue)return;const ct=Ye._line,nt=(z[ct]||[]).findIndex(wt=>wt.cardId===Ye.cardId);if(nt===-1){m("Erreur : joueur introuvable","error"),Z.remove();return}const St={...Ue,_line:ct,position:Ye.position,used:!1,boost:0};z[ct].splice(nt,1,St);const pt=[...S,Ue.cardId];Z.remove(),te(Ye,Ue,async()=>{await j({[p+"Team"]:z,[u+"Team"]:f[u+"Team"],["usedSubIds_"+p]:pt})})})}document.body.appendChild(Z),J()}function te(_,E,z){const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const F=(U,Q,ne)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(E),(z=E.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>E.remove())}async function O(){if(f.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",E=(f.round||0)+1,z=[...f.log||[]];z.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const S=Ge(f),T=je(_),F=S||!T?"finished":_+"-attack";await j({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:F,attacker:_,round:E,log:z}),F==="finished"&&await Oe(f)}function ce(_){const E=(_.GK||[]).some(S=>!S.used),z=["DEF","MIL","ATT"].some(S=>(_[S]||[]).some(T=>!T.used));return E&&!z}function ke(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ce(_.p1Team)&&!ze(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:ce(_.p2Team)&&!ze(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function _e(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(z,S)=>new Promise(T=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${S};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function he(_,E){const{side:z,gk:S}=_;if(!S)return;const T=z+"Score",F=(E[T]||0)+1;S.used=!0;const B=[...E.log||[]];B.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[Bt(S)]:[],aiPlayers:z==="p2"?[Bt(S)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[z+"Name"]} marque !`});const q=(E.round||0)+1,U=z==="p1"?"p2":"p1",Q={...E,[T]:F},ne=Ge(Q);H.add(q),await _e();const Z=z===p?F:E[p+"Score"]||0,J=z===p?E[u+"Score"]||0:F;Je([Bt(S)],Z,J,z===p,async()=>{await j({[T]:F,log:B,round:q,pendingAttack:null,phase:ne?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),ne&&await Oe({...f,[T]:F})})}async function Ee(){const _=f[p+"Team"],E=!["GK","DEF","MIL","ATT"].some(F=>(f[u+"Team"][F]||[]).some(B=>!B.used)),z=(f["selected_"+p]||[]).map(F=>{const B=(_[F._role]||[]).find(de=>de.cardId===F.cardId)||F,q=["GK","DEF"].includes(F._role),U=_[F._role]||[],Q=U.findIndex(de=>de.cardId===F.cardId),ne=mt(U.length),Z=Q>=0?ne[Q]:B._col??1,J=f.stadiumDef||f.homeStadiumDef||null,se=B.stadiumBonus||J&&(J.club_id&&String(B.club_id)===String(J.club_id)||J.country_code&&B.country_code===J.country_code)||!1;return{...B,_line:F._role,_col:Z,stadiumBonus:se,...q?{note_a:Math.max(1,Number(B.note_a)||0)}:{}}});if(!z.length)return;const S=Jt(z,f.modifiers[p]||{},f[p+"Formation"]);ge(p,z.map(F=>F.cardId)),z.forEach(F=>{const B=(_[F._role]||[]).find(q=>q.cardId===F.cardId);B&&(B.used=!0)}),f["selected_"+p]=[],W();const T=[...f.log||[]];if(E){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await he({side:p,gk:z[0]},{...f,[p+"Team"]:_,log:T});return}const B=(f[p+"Score"]||0)+1,q=z.map(J=>Bt(J));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:q,homeTotal:S.total,aiTotal:0});const U=(f.round||0)+1,Q=p==="p1"?"p2":"p1",ne={...f,[p+"Team"]:_,[p+"Score"]:B},Z=Ge(ne);H.add(U),Je(q,B,f[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:_,[p+"Score"]:B,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":Q+"-attack",attacker:Q,round:U,log:T}),Z&&await Oe({...f,[p+"Score"]:B})});return}T.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${S.total})`}),await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],pendingAttack:{...S,players:z,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Te(){const _=f[p+"Team"],E=(f["selected_"+p]||[]).map(le=>{const xe=(_[le._role]||[]).find(Ie=>Ie.cardId===le.cardId)||le,ye=_[le._role]||[],oe=ye.findIndex(Ie=>Ie.cardId===le.cardId),Le=mt(ye.length),Re=oe>=0?Le[oe]:xe._col??1;return{...xe,_line:le._role,_col:Re}}),z=Qt(E,f.modifiers[p]||{},f[p+"Formation"]);ge(p,E.map(le=>le.cardId)),E.forEach(le=>{const xe=(_[le._role]||[]).find(ye=>ye.cardId===le.cardId);xe&&(xe.used=!0)}),f["selected_"+p]=[],W();const S=Gi(f.pendingAttack.total,z.total,f.modifiers[p]||{}),T=f.pendingAttack.side,F=S==="attack"||(S==null?void 0:S.goal),B=T==="p1"?"p2":"p1",q=(f.round||0)+1,U=(f.pendingAttack.players||[]).map(le=>Bt(le)),Q=[...f.log||[]];Q.push({type:"duel",isGoal:F,homeScored:F&&T===p,text:F?`⚽ BUT de ${f[T+"Name"]} ! (${f.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${z.total})`,homePlayers:U,aiPlayers:E.map(le=>Bt(le)),homeTotal:f.pendingAttack.total,aiTotal:z.total});const ne=F?(f[T+"Score"]||0)+1:f[T+"Score"]||0,Z={...f,[p+"Team"]:_,[T+"Score"]:ne},J=Ge(Z),se=J?"finished":B+"-attack",de=!J&&!F?ke(Z):null,me=async()=>{if(de){await he(de,Z);return}await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],[T+"Score"]:ne,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:se,attacker:B,round:q,log:Q}),(se==="finished"||J)&&await Oe({...f,[T+"Score"]:ne})};if(F){const le=T===p,xe=le?ne:f[p+"Score"]||0,ye=le?f[u+"Score"]||0:ne;H.add(q),Je(U,xe,ye,le,me)}else await me()}function ve(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function ze(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function De(_){return ze(_)&&!ve(_)}function je(_){const E=f[_+"Team"],z=f[(_==="p1"?"p2":"p1")+"Team"];return!!(ve(E)||De(E)&&!ze(z)||De(E)&&!ve(z)&&ze(z))}function Ge(_){return!ze(_.p1Team)&&!ze(_.p2Team)}function tt(_){const E=_.p1Score||0,z=_.p2Score||0;return E===z?null:E>z?h.home_id:h.away_id}async function Oe(_){try{const E=tt(_),z=E?h.home_id===E?h.away_id:h.home_id:null,S=_.p1Score||0,T=_.p2Score||0,{data:F,error:B}=await w.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:S,p_away_score:T,p_forfeit:!1});if(B&&console.error("[PvP] finish_pvp_match:",B),d)try{await w.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(q){console.error("[PvP] check_and_finish_mini_league:",q)}E&&z&&ho(E,z).catch(()=>{});try{const{data:q}=await w.rpc("apply_match_rewards",{p_match_id:i});q!=null&&q.success&&!(q!=null&&q.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(q){console.error("[PvP] apply_match_rewards:",q)}if(typeof c=="function")try{await c({homeScore:S,awayScore:T,winnerId:E,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(q){console.error("[PvP] onMatchEnd:",q)}}catch(E){console.error("[PvP] finishMatch:",E)}}function xi(){var T;const _=f[p+"Score"],E=f[u+"Score"],z=_>E,S=_===E;st(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{w.removeChannel(ee)}catch{}et(e),d?g("mini-league",{openLeagueId:d}):g("home")})}W()}async function Mi(e,t,i=!1){var s,l;const{state:n,navigate:r,toast:o}=t,a=i&&((l=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:l.rankedData)||null;await gi(e,t,i?"ranked":"random",async({deckId:c,formation:d,starters:x,subsRaw:y,gcCardsEnriched:g,gcDefs:m,stadiumDef:p})=>{st(e);const u=async b=>{await hr(e,t,c,d,x,y,b||[],m,p,i,a)};if(!(g!=null&&g.length)){await u([]);return}ui(e,g,u)})}async function br(e,t,i){return yr(e,t,i)}async function hr(e,t,i,n,r,o,a=[],s=[],l=null,c=!1,d=null){var re,ee;const{state:x,navigate:y,toast:g}=t,m=(d==null?void 0:d.mmr)??((re=x.profile)==null?void 0:re.mmr)??1e3,p=c?Di(m):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let v=!1,h=null,$=null;e.innerHTML=`
    ...
    </div>`;const f=async()=>{v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null);try{await w.rpc("cancel_matchmaking",{p_user_id:x.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(ee=document.getElementById("cancel-mm"))==null||ee.addEventListener("click",async()=>{await f(),et(e),y("home")});const M=async(j,L)=>{v||(v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null),await It(e,t,j,L,{myGC:a,gcDefs:s,stadiumDef:l,isRanked:c,rankedData:d,onMatchEnd:c?vr:null}))},k=x.user.id,{data:P,error:H}=c?await w.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:m}):await w.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(H||!(P!=null&&P.success)){console.error("[Matchmaking] try_matchmake error:",H||P),g("Erreur de matchmaking","error"),et(e),y("home");return}if(P.matched){await M(P.match_id,!1);return}const ae=async()=>{if(v)return;const{data:j}=await w.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await M(j.match_id,!0)};h=w.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},j=>{const L=j.new;L.status==="matched"&&L.match_id&&M(L.match_id,!0)}).subscribe(),$=setInterval(ae,3e3),setTimeout(()=>{v||f()},12e4)}async function vr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:l,matchId:c}=e,d=i.user.id,x=o===d,y=r===d,{data:g}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",d).single(),{data:m}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",x?a:o).single();if(g&&m){const p=Kn(g.mmr,g.mmr_rd,g.mmr_v,m.mmr,m.mmr_rd,y?1:0);await w.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?w.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:w.sql`mmr_losses + 1`}).eq("id",d),n(y?`+MMR ↑ ${Math.round(p.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-p.mmr)}`,y?"success":"error",4e3)}}const wr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Mi,resumePvpMatch:br},Symbol.toStringTag,{value:"Module"}));async function _r(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",l=!!o.isAccepting;await gi(e,t,"friend",async({deckId:c,formation:d,starters:x,subsRaw:y,gcCardsEnriched:g,gcDefs:m,stadiumDef:p})=>{st(e);const u=async b=>{const v=b||[];l?await $r(e,t,c,v,m,p):await kr(e,t,c,v,m,p,a,s)};if(!(g!=null&&g.length)){await u([]);return}ui(e,g,u)})}async function kr(e,t,i,n,r,o,a,s){var v;const{state:l,navigate:c,toast:d}=t,x=l.user.id,{data:y,error:g}=await w.from("friend_match_invites").insert({inviter_id:x,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!y){console.error("[Friend] Erreur création invitation:",g),d("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Et}">
      ${v.map(f=>`<button class="ml-tab" data-tab="${f.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===f.key?Fn:"transparent"};background:none;font-size:12px;font-weight:${i===f.key?"900":"600"};color:${i===f.key?"#4ade80":Er};cursor:pointer">${f.label}${f.count?` (${f.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Lr(g,b,r):i==="active"?zr(m,r):Ir(u,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>Sr(e,t)),($=document.getElementById("ml-refresh-list"))==null||$.addEventListener("click",()=>Ze(e,t,i)),e.querySelectorAll(".ml-tab").forEach(f=>f.addEventListener("click",()=>Ze(e,t,f.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(f=>f.addEventListener("click",()=>lt(e,t,f.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(f=>f.addEventListener("click",M=>{M.stopPropagation(),Gn(e,t,f.dataset.join,f.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(f=>f.addEventListener("click",M=>{M.stopPropagation(),ji(e,t,f.dataset.delete,f.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(f=>f.addEventListener("click",async M=>{M.stopPropagation(),f.disabled=!0,f.textContent="...";const{data:k,error:P}=await w.rpc("claim_mini_league_prize",{p_league_id:f.dataset.claimLeague,p_user_id:n.profile.id});if(P||!(k!=null&&k.success)){t.toast((k==null?void 0:k.error)||"Erreur lors de la récupération","error"),Ze(e,t,i);return}if(!k.already_claimed){n.profile.credits=(n.profile.credits||0)+k.prize;const H=document.getElementById("nav-credits");H&&(H.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${k.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}Ze(e,t,i)}))}function pi(e,t,i=!1,n=null){var l,c;const r=e.creator_id===t,o=e.pot||0,a=((c=(l=e.mini_league_members)==null?void 0:l[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Ut};border:1px solid ${s?"rgba(212,160,23,0.5)":Kt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function Gn(e,t,i,n){var x;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await Ar(),s===null))return;const{data:l,error:c}=await w.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(c||!(l!=null&&l.success)){console.error("[MiniLeague] join_mini_league:",c||l),r((l==null?void 0:l.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:y}=await w.from("users").select("credits").eq("id",a).single();o.profile&&y&&(o.profile.credits=y.credits)}const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${(((x=o.profile)==null?void 0:x.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),lt(e,t,i)}async function Mr(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(y=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),y(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),y(!1)}}))return;const{data:l,error:c}=await w.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(l!=null&&l.success)){r((l==null?void 0:l.error)||"Erreur lors de la désinscription","error");return}const d=l.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+d);const x=document.getElementById("nav-credits");x&&(x.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${d.toLocaleString("fr")} cr. remboursés`,"success"),Ze(e,t,"waiting")}async function ji(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await w.from("mini_league_matches").delete().eq("league_id",i),await w.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await w.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),Ze(e,t,r)}async function jr(e,t,i){await w.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),Ze(e,t,"archived")}async function lt(e,t,i){var $,f,M,k,P,H,ae,re,ee;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:l}]=await Promise.all([w.from("mini_leagues").select("*").eq("id",i).single(),w.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),w.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await Ze(e,t);return}const c=(s||[]).some(j=>j.user_id===o),d=a.creator_id===o,x=(s||[]).map(j=>j.user).filter(Boolean),y=Fr(x,l||[]),g=(l||[]).filter(j=>j.matchday===a.current_day),m=a.pot||0,p=a.entry_fee||100,u=g.length>0&&g.every(j=>j.status==="finished"||j.status==="bye"),b=a.current_day>=a.total_days,v=(s||[]).find(j=>j.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Ut};border:1px solid ${Kt};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${We}">👥 Joueurs (${x.length}/${a.max_players})</div>
        <div style="font-size:12px;color:${$t};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*x.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*x.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*x.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*x.length*.1).toLocaleString("fr")})</div>
        ${x.map(j=>`
      ...
      <div style="background:${Ut};border:1px solid ${Kt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((j,L)=>{const V=m>0&&a.status==="finished"?L===0?Math.floor(m*.7):L===1?Math.floor(m*.2):L===2?Math.floor(m*.1):0:0;return`<tr style="border-bottom:1px solid ${Et};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${Ut};border:1px solid ${Kt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,L)=>L+1).reverse().map(j=>{const L=(l||[]).filter(V=>V.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Qe};margin-bottom:6px">Journée ${j}</div>${L.map(V=>un(V,x,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if(($=document.getElementById("ml-back"))==null||$.addEventListener("click",()=>Ze(e,t,h)),(f=document.getElementById("ml-refresh"))==null||f.addEventListener("click",async j=>{const L=j.currentTarget;L.style.opacity="0.5",await lt(e,t,i)}),(M=document.getElementById("ml-start-btn"))==null||M.addEventListener("click",()=>Cr(e,t,a,x)),(k=document.getElementById("ml-next-day"))==null||k.addEventListener("click",()=>Br(e,t,i)),(P=document.getElementById("ml-join-now"))==null||P.addEventListener("click",()=>Gn(e,t,i,a.type)),(H=document.getElementById("ml-leave-btn"))==null||H.addEventListener("click",()=>Mr(e,t,i,p)),(ae=document.getElementById("ml-delete-btn"))==null||ae.addEventListener("click",()=>ji(e,t,i,a.name,"waiting")),(re=document.getElementById("ml-delete-now"))==null||re.addEventListener("click",()=>ji(e,t,i,a.name,h)),(ee=document.getElementById("ml-archive-btn"))==null||ee.addEventListener("click",()=>jr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(j=>{j.addEventListener("click",()=>{const L=g.find(V=>V.id===j.dataset.playMatch);L&&t.navigate("match-mini-league",{mlMatchId:L.id,leagueId:i})})}),a.status==="finished"&&v){const j=y.findIndex(L=>L.userId===o);j>=0&&j<3&&v.prize_amount>0&&!v.prize_claimed&&setTimeout(()=>qr(e,t,a,v,j),400)}}function un(e,t,i,n,r=!1){const o=x=>t.find(y=>y.id===x);if(e.is_bye){const x=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${$t};text-align:center">🔵 ${(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),l=e.home_id===i||e.away_id===i,c=l&&e.status==="pending"&&n&&!r,d=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${l?"rgba(74,222,128,0.35)":Et}">
    ...
    <div style="font-size:13px;font-weight:900;min-width:50px;text-align:center;color:${e.status==="finished"?"#4ade80":Qe}">${d}</div>
    ...
    </div>`;let d=!1;const x=async u=>{if(!d){if(d=!0,clearInterval(m),g)try{g.unsubscribe()}catch{}u&&await It(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),l()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(m),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),l()});const y=async()=>{if(d)return;const{data:u}=await w.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&x(u.match_id)},g=w.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&x(u.new.match_id)}).subscribe(),m=setInterval(y,3e3);y()})}const Gr="/",Rr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Nr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var d,x,y;const s=t[n],l=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function y(p){var P,H,ae,re;const u=(P=p.card)==null?void 0:P.player;if(!u)return"";const b=((H=p.card)==null?void 0:H.evolution_bonus)||0,v=qt(u,u.job,b),h=u.job2?qt(u,u.job2,b):0,$=p.status==="sold",f=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ri[u.job]||"#bbb",k=u.job2?ri[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${f?`<img src="${f}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ae=u.clubs)!=null&&ae.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
    ...
    </div>`,document.body.appendChild(r);const o=s=>{r.remove(),s&&t()};r.querySelector("#buy-cancel").addEventListener("click",()=>o(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>o(!0)),r.addEventListener("click",s=>{s.target===r&&o(!1)})}async function Vr(e,t,i){const{toast:n}=i,{data:r}=await w.from("market_listings").select("card_id").eq("id",e).single();if(await w.from("market_listings").update({status:"cancelled"}).eq("id",e),r!=null&&r.card_id){const{count:o}=await w.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");o||await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}n("Annonce retirée","success"),Hi(t,i)}async function Yr(e,t){var d,x,y,g;const{state:i,navigate:n}=t,r=((x=(d=t==null?void 0:t.state)==null?void 0:d.params)==null?void 0:x.tab)||"global";e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:o},{data:a}]=await Promise.all([w.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100),w.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").gte("placement_matches",1).order("mmr",{ascending:!1}).limit(100)]);let s=r;function l(){var p,u;const m=document.getElementById("rankings-list");if(m){if(s==="global"){const b=o||[];m.innerHTML=b.length>0?b.map((v,h)=>`
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=a||[];m.innerHTML=b.length>0?b.map((v,h)=>{const $=Di(v.mmr??1e3),f=(v.ranked_wins||0)+(v.ranked_losses||0)+(v.ranked_draws||0),M=f>0?Math.round((v.ranked_wins||0)/f*100):0,k=v.id===i.profile.id,P=(v.placement_matches||0)<10;return`
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>n("home"));return}const l=s.mmr??1e3,c=s.mmr_deviation??350,d=s.mmr_volatility??.06,x=s.placement_matches??0,y=x<10,g=Math.max(0,10-x),m=Di(l),p=Vn(l),u=bi.findIndex(ae=>ae.id===m.id),b=bi[u+1]||null,v={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),$=h>0?Math.round((s.ranked_wins||0)/h*100):0,f=bi.map(ae=>`
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function na(){document.documentElement.setAttribute("data-theme",Nn()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ci()}),document.getElementById("modal-close").addEventListener("click",Ci);const{data:{session:e}}=await w.auth.getSession();if(!e){gn(),ia(document.getElementById("app"),{onPlay:()=>Qi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Dt})});return}be.user=e.user,await Vt(),gn();try{const{data:i}=await w.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),Wn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!be.profile){Qn(document.getElementById("app"),{state:be,navigate:async()=>{await Vt(),ki()},toast:Dt,refreshProfile:Vt});return}const t=Array.isArray(be.profile.pending_boosters)?be.profile.pending_boosters:[];if(!be.profile.onboarding_done&&t.length>0){Yo(document.getElementById("app"),{state:be,navigate:()=>ki(),toast:Dt,refreshProfile:Vt});return}ki(),setTimeout(()=>Or(be.profile,Ft,Dt),800),w.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(be.user=null,be.profile=null,document.getElementById("app").innerHTML="",Qi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Dt}))})}function oa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function mi(){const e=document.getElementById("app");e&&(e.style.height=oa()+"px")}window.addEventListener("resize",mi);window.addEventListener("orientationchange",()=>setTimeout(mi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",mi);function ki(){const e=()=>{var i;(i=be.user)!=null&&i.id&&w.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",be.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",mi(),ea(),On()}function gn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Hn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
