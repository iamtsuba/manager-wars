...
import{s as v,j as Ii,q as Fo,t as Dt,u as Ti,F as Si,o as nt,n as Ht,g as qt,r as ze,m as ut,v as ni,w as Po,T as Bi,p as _n,x as kn,d as $n}from"./special-cards-YynorolH.js";const En="/";function bo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,d,c,s,l,u,y;const n=o==="login";if(t.innerHTML=`
    <div style="
    ...
    </style>`,(a=document.getElementById("tab-login-btn"))==null||a.addEventListener("click",()=>{o="login",r()}),(d=document.getElementById("tab-reg-btn"))==null||d.addEventListener("click",()=>{o="register",r()}),n)(c=document.getElementById("login-password"))==null||c.addEventListener("keydown",b=>{var g;b.key==="Enter"&&((g=document.getElementById("login-btn"))==null||g.click())}),(s=document.getElementById("login-btn"))==null||s.addEventListener("click",async()=>{const b=document.getElementById("login-email").value.trim(),g=document.getElementById("login-password").value,p=document.getElementById("login-error");if(p.textContent="",!b||!g){p.textContent="Remplissez tous les champs.";return}const x=document.getElementById("login-btn");x.textContent="⏳ Connexion…",x.disabled=!0;const{error:f}=await v.auth.signInWithPassword({email:b,password:g});if(x.textContent="⚽ Se connecter",x.disabled=!1,f){p.textContent=f.message.includes("Invalid")?"Email ou mot de passe incorrect.":f.message;return}window.location.reload()});else{(l=document.getElementById("reg-confirm"))==null||l.addEventListener("keydown",p=>{var x;p.key==="Enter"&&((x=document.getElementById("reg-btn"))==null||x.click())});let b=null,g=!1;(u=document.getElementById("reg-access-code"))==null||u.addEventListener("input",p=>{const x=p.target.value,f=document.getElementById("access-code-status"),w=document.getElementById("reg-btn");if(clearTimeout(b),g=!1,w&&(w.disabled=!0,w.style.opacity="0.45",w.style.cursor="not-allowed"),!x){f&&(f.textContent="");return}f&&(f.textContent="⏳ Vérification…",f.style.color="rgba(255,255,255,0.4)"),b=setTimeout(async()=>{const{data:h,error:E}=await v.rpc("check_signup_password",{input_password:x});if(E){f&&(f.textContent="Erreur de vérification.",f.style.color="#f87171");return}g=!!h,f&&(f.textContent=g?"✅ Code valide":"❌ Code incorrect",f.style.color=g?"#4ade80":"#f87171"),w&&(w.disabled=!g,w.style.opacity=g?"1":"0.45",w.style.cursor=g?"pointer":"not-allowed")},400)}),(y=document.getElementById("reg-btn"))==null||y.addEventListener("click",async()=>{var $;const p=document.getElementById("reg-email").value.trim(),x=document.getElementById("reg-password").value,f=document.getElementById("reg-confirm").value,w=(($=document.getElementById("reg-access-code"))==null?void 0:$.value)||"",h=document.getElementById("reg-error");if(h.textContent="",!p||!x||!f){h.textContent="Remplissez tous les champs.";return}if(x.length<6){h.textContent="Mot de passe trop court (min. 6 caractères).";return}if(x!==f){h.textContent="Les mots de passe ne correspondent pas.";return}const{data:E}=await v.rpc("check_signup_password",{input_password:w});if(!E){h.textContent="Code d'accès incorrect.";return}const m=document.getElementById("reg-btn");m.textContent="⏳ Création…",m.disabled=!0;const{error:S}=await v.auth.signUp({email:p,password:x});if(m.textContent="🚀 Créer mon compte",m.disabled=!1,S){h.textContent=S.message;return}i("Compte créé ! Connecte-toi pour commencer.","success",4e3),o="login",r(),setTimeout(()=>{const T=document.getElementById("login-email");T&&(T.value=p)},50)})}};r()}function Ln(t,{state:e,navigate:i,toast:o,refreshProfile:r}){let n="#1A6B3C",a="#D4A017";t.innerHTML=`
  ...
  `;function d(){var g;const s=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),u=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",y=u.trim().split(" ").filter(Boolean),b=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():u.slice(0,2).toUpperCase();s&&(s.style.background=a,s.style.borderColor=n),l&&(l.textContent=b,l.style.color=n)}document.getElementById("color1").addEventListener("input",s=>{n=s.target.value,document.getElementById("swatch1").style.background=n,d()}),document.getElementById("color2").addEventListener("input",s=>{a=s.target.value,document.getElementById("swatch2").style.background=a,d()});function c(s){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${s}`).classList.add("active"),document.getElementById("step-num").textContent=s,document.getElementById("progress-fill").style.width=`${Math.round(s/3*100)}%`,s===3&&d()}document.getElementById("step1-next").addEventListener("click",async()=>{const s=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",s.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await v.from("users").select("id").eq("pseudo",s).maybeSingle();if(u){l.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const s=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",s.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await v.from("users").select("id").eq("club_name",s).maybeSingle();if(u){l.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const s=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),y=document.getElementById("step3-finish");u.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:s,club_name:l,club_color1:n,club_color2:a,credits:15e3});if(b)throw b;await In(e.user.id),await r(),o(`Bienvenue ${s} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){u.textContent=b.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function In(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Tn="modulepreload",Sn=function(t){return"/"+t},xo={},No=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=Sn(c),c in xo)return;xo[c]=!0;const s=c.endsWith(".css"),l=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${l}`))return;const u=document.createElement("link");if(u.rel=s?"stylesheet":Tn,s||(u.as="script"),u.crossOrigin="",u.href=c,d&&u.setAttribute("nonce",d),document.head.appendChild(u),s)return new Promise((y,b)=>{u.addEventListener("load",y),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return r.then(a=>{for(const d of a||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})},Ro="mw_sound_volume";function Qi(){const t=localStorage.getItem(Ro);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function An(t){localStorage.setItem(Ro,String(Math.max(0,Math.min(100,Math.round(t)))))}function Zi(){return Qi()===0}function vi(t){return Math.max(0,Math.min(1,t*(Qi()/100)))}function eo(t,e=1){if(Zi())return null;try{const i=new Audio(t);return i.volume=vi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Ri=null,yo=.3;function Go(t,e=.3){if(yo=e,ht&&Ri===t&&!ht.paused){ht.volume=vi(yo);return}if(Gt(),!Zi())try{const i=new Audio(t);i.loop=!0,i.volume=vi(e),i.play().catch(()=>{}),ht=i,Ri=t}catch{}}function Gt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Ri=null}let Qt=null;function Oo(t,e=.6){if(Ke(),!Zi())try{const i=new Audio(t);i.volume=vi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const zn=[{key:"home2",route:"home2",label:"ACCUEIL",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARTES",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"EQUIPES",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOUTIQUE",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function ci(t,e,i,o,r){if(!document.getElementById("home2-chrome-style")){const u=document.createElement("style");u.id="home2-chrome-style",u.textContent=`
    ...
    </div>`,document.body.appendChild(i),i.querySelector("#credits-ad-cancel").addEventListener("click",()=>i.remove()),i.querySelectorAll(".credits-ad-offer-btn").forEach(o=>{o.addEventListener("click",()=>{i.remove(),Cn(parseInt(o.dataset.ads),5,parseInt(o.dataset.credits),t,e)})})}function Cn(t,e,i,o,r){let n=1;const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;gap:14px;color:#fff;padding:16px",document.body.appendChild(a);function d(){a.innerHTML=`
  ...
  <div class="home-dark" id="home-dark">
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-right">
          <div class="news-widget">
            ...
            ${g.length?g.map(f).join(""):'<div style="font-size:11px;color:var(--tile-fg-dim);padding:8px 0">Aucune actualité pour le moment.</div>'}
          </div>
        </div>
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",s=>{s.target===i&&o()});const[{data:r},{data:n}]=await Promise.all([v.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),v.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),a=(n==null?void 0:n.unlocked_level)||1,d=r||[],c=document.getElementById("solo-levels-list");if(c){if(!d.length){c.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}c.innerHTML=d.map(s=>{const l=s.level_number>a,u=s.level_number===a,y=l?"#f0f0f0":u?"#eefaf2":"#f7f7f7",b=l?"#ddd":u?"#bfe8cf":"#e0e0e0",g=l?"#999":"#12401f";return`
      <div class="solo-level-card" data-level="${s.level_number}" data-locked="${l}"
        style="cursor:${l?"not-allowed":"pointer"};display:flex;align-items:center;gap:14px;padding:14px 16px;border-radius:14px;background:${y};border:1px solid ${b};opacity:${l?.6:1};transition:transform .12s ease">
    ...
    </div>`,s.querySelectorAll("[data-stats]").forEach(b=>{b.addEventListener("click",()=>Yn(t,b.dataset.stats,b.dataset.friendName))}),s.querySelectorAll("[data-match]").forEach(b=>{b.addEventListener("click",async()=>{const g=b.dataset.friendId,p=b.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const x=t.user.id,{data:f}=await v.from("friend_match_invites").select("id").eq("inviter_id",g).eq("invitee_id",x).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!f;console.log("[Friends] clic match",{fid:g,fname:p,isAccepting:w}),mt(),o("match",{matchMode:"friend",friendId:g,friendName:p,isAccepting:w})})})}function Kn(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",r=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||ri,a=t.club_color1||"#ffffff",d=t.last_seen_at?new Date(t.last_seen_at):null,c=d&&Date.now()-d.getTime()<3*60*1e3;return`
    ...
    ${io()}`,document.body.appendChild(s);const u=()=>s.remove();s.querySelector("#pending-close").addEventListener("click",u),s.addEventListener("click",y=>{y.target===s&&u()}),s.querySelectorAll("[data-accept]").forEach(y=>{y.addEventListener("click",async()=>{const{error:b}=await v.from("friendships").update({status:"accepted"}).eq("id",y.dataset.accept);if(b){e("Erreur : "+b.message,"error");return}y.closest("div[style]").remove(),e("✅ Ami accepté !","success"),Vo(t,e,o),i&&i()})}),s.querySelectorAll("[data-decline]").forEach(y=>{y.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",y.dataset.decline),y.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function Yn(t,e,i){const o=t.user.id,[r,n]=[o,e].sort(),a=o===r,{data:d}=await v.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",n).single(),c=t.profile.club_name||t.profile.pseudo||"Moi",s=d||{},l=a?s.wins_p1||0:s.wins_p2||0,u=a?s.wins_p2||0:s.wins_p1||0,y=s.draws||0,b=a?s.goals_p1||0:s.goals_p2||0,g=a?s.goals_p2||0:s.goals_p1||0,p=a?s.gc_used_p1||0:s.gc_used_p2||0,x=a?s.gc_used_p2||0:s.gc_used_p1||0,f=s.matches_total||0,w=(E,m,S,$=ri,T=ai)=>`
    ...
    </style>`}async function Wn(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;const n="/icons/";ci(i,r,"game",n,o),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const d=a.dataset.action;if(d==="match-ai"){Ko(i,e);return}if(d==="match-random"){mt(),i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Wo(t,e){var p,x;const{state:i,navigate:o}=e,r=oi(),n=Qi(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,d="2026.07.29-1132";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${ze(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),s=(d||[]).filter(C=>C.card_type==="player"&&C.player),l=(d||[]).filter(C=>C.card_type==="game_changer"),u=(d||[]).filter(C=>C.card_type==="formation"),y=(d||[]).filter(C=>C.card_type==="stadium"),{data:b}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(C=>{g[C.name]=C});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(C=>{x[C.id]=C}),y.forEach(C=>{C.stadium_def&&(x[C.stadium_id]=C.stadium_def)});const f=Object.keys(Si),w=Object.keys(Oe),h={};s.forEach(C=>{const K=C.player.id;h[K]=(h[K]||0)+1}),new Set(Object.keys(h).map(C=>String(C)));const E=new Set(u.map(C=>C.formation)),m=new Set(l.map(C=>C.gc_type));let S="player",$="Tous",T="",P=!1;function G(){return[...s].sort((C,K)=>{const Q=fi.indexOf(C.player.job),X=fi.indexOf(K.player.job);return Q!==X?Q-X:(C.player.surname_real||"").localeCompare(K.player.surname_real||"")})}function O(){return[...c||[]].sort((C,K)=>{const Q=fi.indexOf(C.job),X=fi.indexOf(K.job);return Q!==X?Q-X:(C.surname_real||"").localeCompare(K.surname_real||"")})}function V(){return G().filter(C=>{const K=C.player,Q=$==="Tous"||K.job===$,X=!T||`${K.firstname} ${K.surname_real}`.toLowerCase().includes(T);return Q&&X})}function I(){return O().filter(C=>{const K=$==="Tous"||C.job===$,Q=!T||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(T);return K&&Q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        <input id="col-search" placeholder="🔍 Rechercher un joueur..." style="font-size:13px;background:#fff;color:#1a1a1a" value="${T}">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${s} pour ${gi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const f=y.find(h=>!h.is_for_sale)||y[0];if(!f){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",f.id),await v.from("transfer_history").delete().eq("card_id",f.id);const{error:w}=await v.from("cards").delete().eq("id",f.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+gi}).eq("id",r.profile.id),await c(),n(`+${gi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const f=parseInt(document.getElementById("sell-price-form").value);if(!f||f<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:f}).eq("id",t.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:f}),n("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(x=document.getElementById("cancel-sell-form-btn"))==null||x.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),d("collection")})}async function $o(t,e,i,o){var pe,me,fe,C,K,Q,X,re,F;const{state:r,toast:n,openModal:a,closeModal:d,navigate:c,refreshProfile:s}=o,l=t.player,u=e.filter(z=>z.player.id===l.id),y=u.length,b=t.evolution_bonus||0,g=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?b:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?b:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?b:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?b:0)),p=l.rarity||"normal",{data:x}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((pe=x==null?void 0:x[0])==null?void 0:pe.price)??Zn[p];const f=((me=x==null?void 0:x[0])==null?void 0:me.price_min)??null,w=((fe=x==null?void 0:x[0])==null?void 0:fe.price_max)??null,h=l.rarity!=="legende";qt(l);const E=mi(l,l.job)+b,m=l.job2?mi(l,l.job2)+(mi(l,l.job2)>0?b:0):null;Jt[l.job],l.job2&&Jt[l.job2];const S=Jn[l.rarity]||"#ccc",$=tr[l.country_code]||l.country_code||"",T=t.evolution_bonus||0,G=E+T,O=m||0,V=O>0?O+T:0,I=u.map(z=>z.id);let _={};if(I.length){const{data:z}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",I).order("transferred_at",{ascending:!0});(z||[]).forEach(Y=>{_[Y.card_id]||(_[Y.card_id]=[]),_[Y.card_id].push(Y)})}const R=I.length?`
      ...
      ${y-1>0?`<div style="font-size:13px;font-weight:700;margin-bottom:10px">🗂️ Copies (${y-1})</div>`:`
        ...
        <div style="background:#f0fdf4;border:2px solid #1A6B3C;border-radius:12px;padding:14px">
          ...
          <div style="font-size:11px;color:#555;margin-bottom:8px;background:#fff;border-radius:6px;padding:6px 10px">
            💰 Fourchette autorisée : <b>${f.toLocaleString("fr")}</b> – <b>${w.toLocaleString("fr")}</b> cr.
          </div>`:""}
          <div style="display:flex;gap:8px">
        ...
        ${u.filter(z=>z.id!==t.id).map((z,Y)=>{const Z=_[z.id]||[],se=z.is_for_sale,ge=Z.length?Z[Z.length-1]:null,ye=z.evolution_bonus||0,$e=ge?ge.source==="booster"?"Booster":ge.price?ge.price.toLocaleString("fr")+" cr.":"—":"—",Ee=ge?new Date(ge.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",xe=80,be=Math.round(xe*657/507),je=ze({...l,_evolution_bonus:ye},{width:xe});return`
            <div class="exemplaire-row" data-card-id="${z.id}" data-card-idx="${Y}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${z.id}" data-evo="${ye}" data-note="${mi(l,l.job)}"
                ${se?"disabled":""}
                style="display:none">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${G}${l.job2&&O>0?` / ${V}`:""}`:`Note actuelle : ${G}${l.job2&&O>0?` / ${V}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([z,Y])=>{const Z=Jt[z],se=z==="GK"?"#fff":Z,ge=z===l.job||z===l.job2,ye=(Number(Y)||0)+(ge&&T>0?T:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(K=document.getElementById("close-detail"))==null||K.addEventListener("click",d);let W=new Set;const de=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(Y=>{if(Y.dataset.id===t.id)return;const se=Number(Y.dataset.evo)||0,ge=Number(Y.dataset.note)||0;z+=ge+se}),Math.round(z*de)}const j=()=>{const z=W.size,Y=document.getElementById("sell-action-panel");if(!Y)return;Y.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const Y=z.dataset.id;z.checked?W.add(Y):W.delete(Y);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",Y=>{if(Y.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(y<=1)return;const z=[...W];if(!z.length)return;if(W.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
    ...
    </div>`,document.body.appendChild(o);const r=n=>{o.remove(),i(n)};o.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),o.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),o.addEventListener("click",n=>{n.target===o&&r(!1)})})}const wi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Gi(t,e){const{state:i,navigate:o,toast:r}=e;ci(o,i.profile,"decks","/icons/",r),t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("id,name,formation,stadium_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1}),a=[...new Set((n||[]).map(c=>c.stadium_card_id).filter(Boolean))];let d={};if(a.length){const{data:c}=await v.from("cards").select("id, stadium_id, stadium_definitions(image_url, country_code, club:clubs(logo_url))").in("id",a);(c||[]).forEach(s=>{var y;const l=s.stadium_definitions,u=((y=l==null?void 0:l.club)==null?void 0:y.logo_url)||(l!=null&&l.image_url?`/icons/${l.image_url}`:null)||(l!=null&&l.country_code?`https://flagsapi.com/${l.country_code}/flat/64.png`:null);d[s.id]=u})}t.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),c=(a||[]).filter(f=>f.card_type==="player"&&f.player),s=(a||[]).filter(f=>f.card_type==="formation"),l=(d||[]).filter(f=>f.card_type==="stadium"),u=[...new Set(l.map(f=>f.stadium_id).filter(Boolean))];let y={};if(l.forEach(f=>{f.stadium_def&&f.stadium_id&&(y[f.stadium_id]=f.stadium_def)}),u.length&&Object.keys(y).length<u.length){const{data:f}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",u);(f||[]).forEach(w=>{y[w.id]=w})}const b=s.map(f=>f.formation).filter(Boolean),{data:g}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let p=n.formation||"4-4-2";b.length>0&&!b.includes(p)&&(p=b[0]);const x={deckId:t,name:n.name,formation:p,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:c,formationCards:s,stadiumCards:l,stadDefMap:y,availableFormations:b};(g||[]).forEach(f=>{f.is_starter?x.slots[f.position]=f.card_id:x.subs.includes(f.card_id)||x.subs.push(f.card_id)}),$t(e,x,i,!0)}function $t(t,e,i,o=!1){var p,x;const{navigate:r}=i;o||cr(e,i),wi[e.formation];const n=Io(e.formation),a=n.filter(f=>e.slots[f]).length,d=e.availableFormations.length>0?e.availableFormations:Object.keys(wi),c=(p=e.stadiumCards)==null?void 0:p.find(f=>f.id===e.stadiumCardId),s=c&&((x=e.stadDefMap)==null?void 0:x[c.stadium_id])||null,l=e.subs.map(f=>e.playerCards.find(w=>w.id===f)).filter(Boolean);l.length!==e.subs.length&&(e.subs=l.map(f=>f.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
      ...
      <div style="display:flex;gap:0;min-height:600px">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${l.map(f=>{const w={...f.player,_evolution_bonus:f.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
        ...
        <div style="width:130px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 8px;gap:12px;border-left:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="width:100%;text-align:center">
            ...
            <div id="add-stad-btn-pc" style="cursor:pointer;margin:0 auto;width:fit-content">
              ${c?(()=>{var h;const f=e.stadDefMap[c.stadium_id],w=((h=f==null?void 0:f.club)==null?void 0:h.logo_url)||(f==null?void 0:f.image_url)||(f!=null&&f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Ht((f==null?void 0:f.name)||"Stade",w,"+10 ⭐",{width:100})})():`<div style="width:100px;height:171px;border:2px dashed rgba(79,195,247,0.4);border-radius:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
        ...
        <div style="display:flex;gap:6px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${l.map(f=>{const w={...f.player,_evolution_bonus:f.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
          ...
          <div style="flex-shrink:0;text-align:center">
            ...
            <div id="add-stad-btn" style="cursor:pointer">
              ${c?(()=>{var h;const f=e.stadDefMap[c.stadium_id],w=((h=f==null?void 0:f.club)==null?void 0:h.logo_url)||(f==null?void 0:f.image_url)||(f!=null&&f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Ht((f==null?void 0:f.name)||"Stade",w,"+10⭐",{width:44})})():`<div style="width:44px;height:57px;border:2px dashed rgba(79,195,247,0.5);border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px">
  ...
  </div>`;const u=window.innerWidth>=900,y=t.querySelector(".deck-pc-layout"),b=t.querySelector(".deck-mobile-layout");y&&(y.style.display=u?"block":"none"),b&&(b.style.display=u?"none":"block"),t.querySelectorAll("#save-deck").forEach(f=>{f.closest(".page-body").style.display=u?"none":"block"}),ar(t,e,n,i),t.querySelectorAll("#builder-back").forEach(f=>f.addEventListener("click",()=>r("decks")));const g=()=>{const{openModal:f,closeModal:w}=i,E=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
    ...
    </div>`;f("⚽ Choisir une formation",E),document.querySelectorAll("#modal-body [data-forma]").forEach(m=>{m.addEventListener("click",()=>{e.formation=m.dataset.forma;const S=Io(e.formation),$={};S.forEach(T=>{e.slots[T]&&($[T]=e.slots[T])}),e.slots=$,w(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(f=>f.addEventListener("click",g)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(f=>f.addEventListener("click",()=>sr(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(f=>f.addEventListener("click",()=>pr(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(f=>{f.addEventListener("click",()=>{e.subs=e.subs.filter(w=>w!==f.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(f=>f.addEventListener("click",()=>dr(e,t,i)))}function ar(t,e,i,o){var h,E,m;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(h=e.stadiumCards)==null?void 0:h.find(S=>S.id===e.stadiumCardId),d=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,c=ut[e.formation]||{},s=Ti(e.formation)||[],l={};for(const S of i){const $=e.slots[S],T=$?e.playerCards.find(P=>P.id===$):null;T!=null&&T.player?l[S]={...T.player,_evolution_bonus:T.evolution_bonus||0,face:T.player.face||null}:l[S]=null}const u=window.innerWidth>=900,y=u?window.innerWidth-280:window.innerWidth-20,b=u?Math.min(y,860):y,g=Math.round(u?b*.82:b*.85),p=u?84:44;let x="";for(const[S,$]of s){const T=c[S],P=c[$];if(!T||!P)continue;const G=T.x*b,O=Math.round(.03*g+T.y*.85*g),V=P.x*b,I=Math.round(.03*g+P.y*.85*g),_=l[S],R=l[$],W=Dt(_,R);W==="#ff3333"||W==="#cc2222"?x+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let f="";const w=Math.round(p*657/507);for(const S of i){const $=c[S];if(!$)continue;const T=l[S],P=$.x*b;$.y*g;const G=Math.round(.03*g+$.y*(.85*g)),O=Math.round(P-p/2),V=Math.round(G-w/2);if(T){const I=S.replace(/\d+/,""),_=d&&(d.club_id&&String(T.club_id)===String(d.club_id)||d.country_code&&T.country_code===d.country_code),R=ze({...T,_evolution_bonus:T._evolution_bonus||0},{width:p,showStad:!0,stadDef:d,role:I});_&&((m=d.club)!=null&&m.logo_url||d.image_url),f+=`<div style="position:absolute;left:${O}px;top:${V}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${S}">
        <div style="position:relative">${R}</div>
      </div>`}else{const I=S.replace(/\d+/,"");f+=`<div style="position:absolute;left:${O}px;top:${V}px;width:${p}px;height:${w}px;
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${f}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(S=>{S.addEventListener("click",()=>lr(S.dataset.pos,e,t,o))})}function sr(t,e,i){var d;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(c=>{const s=c.stadium_id||c.id;return n.has(s)?!1:(n.add(s),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${a.map(c=>{var b;const s=t.stadDefMap[c.stadium_id],l=((b=s==null?void 0:s.club)==null?void 0:b.logo_url)||(s==null?void 0:s.image_url)||(s!=null&&s.country_code?`https://flagsapi.com/${s.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),u=t.stadiumCardId===c.id,y=Ht((s==null?void 0:s.name)||"Stade",l,"+10⭐",{width:90});return`<div class="stad-choice" data-stad-id="${c.id}" style="cursor:pointer;position:relative;border-radius:8px;${u?"box-shadow:0 0 0 3px #4fc3f7":""}">
          ${y}
        </div>`}).join("")}
    </div>`),(d=document.getElementById("stad-none"))==null||d.addEventListener("click",()=>{t.stadiumCardId=null,r(),$t(e,t,i)}),document.querySelectorAll(".stad-choice").forEach(c=>{c.addEventListener("click",()=>{t.stadiumCardId=c.dataset.stadId,r(),$t(e,t,i)})})}function lr(t,e,i,o){var g,p,x,f,w;const{openModal:r,closeModal:n}=o,a=t.replace(/\d+/,""),d=(g=e.stadiumCards)==null?void 0:g.find(h=>h.id===e.stadiumCardId),c=d&&((p=e.stadDefMap)==null?void 0:p[d.stadium_id])||null,s=e.slots[t],l=s?e.playerCards.find(h=>h.id===s):null;(x=l==null?void 0:l.player)==null||x.id;const u=new Set;Object.entries(e.slots).forEach(([h,E])=>{var S;if(h===t||!E)return;const m=e.playerCards.find($=>$.id===E);(S=m==null?void 0:m.player)!=null&&S.id&&u.add(m.player.id)}),e.subs.forEach(h=>{var m;const E=e.playerCards.find(S=>S.id===h);(m=E==null?void 0:E.player)!=null&&m.id&&u.add(E.player.id)});const y=new Set,b=e.playerCards.filter(h=>{const E=h.player;return!(E.job===a||E.job2===a)||u.has(E.id)||y.has(E.id)?!1:(y.add(E.id),!0)});b.sort((h,E)=>{const m=h.evolution_bonus||0,S=E.evolution_bonus||0,$=(a==="GK"?h.player.note_g:a==="DEF"?h.player.note_d:a==="MIL"?h.player.note_m:h.player.note_a)+(a===h.player.job||a===h.player.job2?m:0);return(a==="GK"?E.player.note_g:a==="DEF"?E.player.note_d:a==="MIL"?E.player.note_m:E.player.note_a)+(a===E.player.job||a===E.player.job2?S:0)-$}),r(`Choisir ${a} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),$t(i,e,o)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{e.slots[t]=h.dataset.cardId,n(),$t(i,e,o)})})}function dr(t,e,i){var l,u,y;const{openModal:o,closeModal:r}=i,n=(l=t.stadiumCards)==null?void 0:l.find(b=>b.id===t.stadiumCardId),a=n&&((u=t.stadDefMap)==null?void 0:u[n.stadium_id])||null,d=new Set;Object.keys(t.slots).forEach(b=>{var x;const g=t.slots[b];if(!g)return;const p=t.playerCards.find(f=>f.id===g);(x=p==null?void 0:p.player)!=null&&x.id&&d.add(p.player.id)}),t.subs.forEach(b=>{var p;const g=t.playerCards.find(x=>x.id===b);(p=g==null?void 0:g.player)!=null&&p.id&&d.add(g.player.id)});const c=new Set,s=t.playerCards.filter(b=>{var g,p,x;return d.has((g=b.player)==null?void 0:g.id)||c.has((p=b.player)==null?void 0:p.id)?!1:(c.add((x=b.player)==null?void 0:x.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${n.map(g=>{const p=g.cost===0||r>=g.cost,x=l[g.id]===!0;return`<div class="booster-card ${!p||x?"disabled":""}" data-booster="${g.id}" style="position:relative">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}const c=l=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(l)};function s(){var u,y,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const l=a.length>0;t.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
    ...
    </div>`,t.querySelectorAll(".gc-select-card").forEach(g=>{g.addEventListener("click",()=>{const p=g.dataset.id,x=n.find(w=>w.id===p);if(!x)return;const f=a.findIndex(w=>w.gc_type===x.gc_type);f>-1?a.splice(f,1):a.length<3&&a.push(x),s()})}),(u=t.querySelector("#gc-launch"))==null||u.addEventListener("click",()=>{l&&c(a)}),(y=t.querySelector("#gc-no-gc"))==null||y.addEventListener("click",()=>c([])),(b=t.querySelector("#gc-reset"))==null||b.addEventListener("click",()=>{a.length&&(a=[],s())})}s()}function Ir(t,e){var r;const i=((r=e==null?void 0:e.state)==null?void 0:r.params)||{},o=t||i.matchMode||"vs_ai_easy";return o==="friend"?`Match vs ${i.friendName||"Ami"}`:o==="random"?"Match vs Random":o==="ranked"?"Match Classé":o==="mini_league"||o==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${o.replace("vs_ai_","").toUpperCase()}`}async function Tr(t,e,i){const{state:o,navigate:r}=e;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),c=[...new Set((d||[]).filter(y=>{var b,g;return((b=y.card)==null?void 0:b.card_type)==="stadium"&&((g=y.card)==null?void 0:g.stadium_id)}).map(y=>y.card.stadium_id))],s={};if(c.length){const{data:y}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(y||[]).forEach(b=>{s[b.id]=b}),(d||[]).forEach(b=>{var g,p;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((p=b.card)!=null&&p.stadium_id)&&(b.card._stadiumDef=s[b.card.stadium_id]||null)})}let l=0;function u(){var m,S,$,T,P,G,O;const y=n[l],b=(d||[]).filter(V=>V.deck_id===y.id),g=b.filter(V=>{var I;return V.is_starter&&((I=V.card)==null?void 0:I.player)}).map(V=>Ki(V.card,V.position)),p=b.find(V=>{var I;return((I=V.card)==null?void 0:I.card_type)==="formation"}),x=y.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let f=g.length>=11?ki(g,x):null,w=((S=y.stadium_card)==null?void 0:S.stadium_def)||null;w&&f&&(f=di(f,w));const h=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow-y:auto;overflow-x:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center">
        ${f?'<div class="deck-preview-wrap" style="overflow:visible;width:100%;min-height:100%;display:flex;align-items:center;justify-content:center"></div>':`<div style="opacity:.4;text-align:center"><div style="font-size:32px">⚠️</div><div>Deck incomplet (${g.length}/11)</div></div>`}
      </div>

      <!-- Pagination -->
      ${n.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${n.map((V,I)=>`<div style="width:6px;height:6px;border-radius:50%;background:${I===l?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function V(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!f)return;const R=_.clientWidth>=900,W=Math.max(200,_.clientHeight-(R?60:40)),ce=Math.max(200,_.clientWidth-16),j=R?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(W<220||ce<220){requestAnimationFrame(V);return}const H=R?null:Math.round(j*.55);I.innerHTML=Ut(f,x,null,[],ce,W,[],H),I.style.cssText=`width:${ce}px;height:${W}px;overflow:hidden;margin:${R?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",R?"xMidYMid meet":"none"))})),(T=document.getElementById("prev-deck"))==null||T.addEventListener("click",()=>{l>0&&(l--,u())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{l<n.length-1&&(l++,u())}),(G=document.getElementById("validate-deck"))==null||G.addEventListener("click",()=>{if(!h)return;const V=e.state.params||{};e.navigate("match",{...V,matchMode:V.matchMode||i,deckId:y.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let V=0,I=0;E.addEventListener("touchstart",_=>{V=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const R=_.changedTouches[0].clientX-V,W=_.changedTouches[0].clientY-I;Math.abs(R)<40||Math.abs(R)<Math.abs(W)||(R<0&&l<n.length-1?(l++,u()):R>0&&l>0&&(l--,u()))},{passive:!0})}}u()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((d,c)=>{const s=d._line||d.job||"MIL";let l=d.boost||0;if(d.stadiumBonus&&(o==="attack"&&(s==="ATT"||s==="MIL")||o==="defense"&&(s==="GK"||s==="DEF"||s==="MIL")?l+=10:o||(l+=10)),a+=ze({...d,_evolution_bonus:0,evolution_bonus:0},{width:40,role:s,extraNote:l}),c<n.length-1){const u=n[c+1],y=Xo(d,u,r)?Dt(d,u):null;a+=`<div style="width:7px;height:3px;background:${!y||y==="#ff3333"||y==="#cc2222"?"rgba(255,255,255,0.12)":y};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function zi(t,e,i,o,r=310,n=310,a=[],d=null){const c=ut[e]||{},s=Ti(e)||Si[e]||[],l={},u=["ATT","MIL","DEF","GK"];for(const f of u)(t[f]||[]).forEach((h,E)=>{l[`${f}${E+1}`]=h});function y(f){const w=c[f];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[f,w]of s){const h=y(f),E=y(w);if(!h||!E)continue;const m=l[f],S=l[w],$=Dt(m,S);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
    ...
    ${zi(t,e,i,o,r,n,a,d)}
  </div>`}async function Mi(t,e,i,o){var S;const{state:r,navigate:n,toast:a}=e;ct(t);const d=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!d.deckId)return Tr(t,e,i);const c=d.deckId;let s,l,u,y;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);s=$[0].data,u=$[0].error,l=$[1].data,y=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Mt(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(u||y){console.error("[Match] Erreur Supabase:",u||y),Mt(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(l||[]).filter($=>{var T;return $.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Ki($.card,$.position)),g=(l||[]).filter($=>{var T;return!$.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Ki($.card,$.position));if(b.length<11){Mt(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(l||[]).find($=>{var T;return((T=$.card)==null?void 0:T.card_type)==="formation"}),x=(s==null?void 0:s.formation)||((S=p==null?void 0:p.card)==null?void 0:S.formation)||"4-4-2",{data:f,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(f||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(T=>T.name===$.gc_type||T.id===$.gc_definition_id))||null}));let m=null;if(s!=null&&s.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",s.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:T}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=T||null}}o({deckId:c,formation:x,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function Ct(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(Ct()*1.1)}function dn(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:qt(t)}}function Sr(t,e,i,o="Adversaire"){Go("/sounds/match-opening.mp3",.3);const r=Ct(),n=Ot();return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function pn(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+pn(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Dt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function $i(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const d=a<t.length-1?Dt(n,t[a+1]):null,c=!d||d==="#ff3333"||d==="#cc2222",s=d==="#00ff88"?"+10":d==="#FFD700"?"+5":"";return pn(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function zr(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",d=o.soloLevel||1,c=r.replace("vs_ai_",""),s=r;let l=null;if(n){const{data:g}=await v.from("solo_levels").select("*").eq("level_number",d).maybeSingle();l=g||{level_number:d,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const u=o.rankedData||null,y=o.presetSetup||null;async function b({deckId:g,formation:p,starters:x,subsRaw:f,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let m=ki(x,p);E&&(m=di(m,E),_i(f,E));let S=null;if(a){const G=Cr(m),{jaune:O,vert:V}=jr(m,p),I=.9+Math.random()*.2;S={target_note_avg:Math.max(1,Math.round(G*I/16)),nb_liens_jaune:O,nb_liens_vert:V,nb_joueurs_stade:E?3:0}}const $=n?await So(p,l):a?await So(p,S):await Mr(p,c),T=$.lines||$,P=async G=>{try{const O=s==="vs_ai_club"||s==="solo"||s==="ranked_ai"?"club":s,{data:V,error:I}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:O,home_deck_id:g,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),Mt(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&T&&(di(T,_),_i($.subs||[],_));const R={gcDefs:h||[],matchId:V==null?void 0:V.id,mode:s,difficulty:c,formation:p,isSolo:n,soloLevel:d,soloLevelConfig:l,isRankedAI:a,rankedAIData:u,homeTeam:m,aiTeam:T,homeSubs:f,subsUsed:0,maxSubs:Math.min(f.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:G,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};qr(t,R,e)}catch(O){console.error("[MatchIA] Exception launchMatch:",O),Mt(t,"⚠️","Erreur au lancement du match : "+O.message,"Retour",()=>e.navigate("home"))}};if(a&&y){P(y.gcCardsEnriched||[]);return}if(!w.length){P([]);return}Ai(t,w,P)}catch(m){console.error("[MatchIA] Exception setup:",m),Mt(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}y?await b(y):await Mi(t,e,r,b)}async function Mr(t,e){var x;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:un(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(f,w,h){var E,m;return n.add(f.id),{cardId:"ai-"+f.id+"-"+h,id:f.id,firstname:f.firstname,name:f.surname_real,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,face:f.face,clubName:((E=f.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=f.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const f of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===f&&!n.has($.id)),h=i.filter($=>$.job!==f&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[f];$++){const T=E[$];T&&m.push(a(T,f,$))}const S=dt(m.length);m.forEach(($,T)=>{$._col=S[T]}),r[f]=m}const c=i.filter(f=>!n.has(f.id)).slice(0,5).map((f,w)=>a(f,f.job,100+w)),{data:s}=await v.from("gc_definitions").select("*").eq("is_active",!0),u=[...s||[]].sort(()=>Math.random()-.5).slice(0,3).map((f,w)=>({id:"ai-gc-"+w,gc_type:f.name,name:f.name,icon:"⚡",effect_type:f.effect_type,effect_params:f.effect_params||{}})),y=Object.values(r).flat(),b={};y.forEach(f=>{f.club_id&&(b[f.club_id]=(b[f.club_id]||0)+1)});const g=(x=Object.entries(b).sort((f,w)=>w[1]-f[1])[0])==null?void 0:x[0];let p=null;if(g){const{data:f}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();f&&(p={club_id:f.id,country_code:null,name:f.encoded_name+" Stadium",club:{encoded_name:f.encoded_name,logo_url:f.logo_url}})}return{lines:r,subs:c,gcCards:u,stadiumDef:p}}function Cr(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function jr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((d,c)=>{i[`${a}${c+1}`]=d});const o=Ti(e)||Si[e]||[];let r=0,n=0;for(const[a,d]of o){const c=i[a],s=i[d];if(!c||!s)continue;const l=Dt(c,s);l==="#00ff88"?n++:l==="#FFD700"&&r++}return{jaune:r,vert:n}}function To(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function bi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(To(r)-e)-Math.abs(To(n)-e));return o.slice(0,Math.min(i,o.length))}async function So(t,e){var V,I;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:un(t),subs:[],gcCards:[],stadiumDef:null};const d={};a.forEach(_=>{_.club_id&&(d[_.club_id]=(d[_.club_id]||0)+1)});const c=((V=Object.entries(d).sort((_,R)=>R[1]-_[1])[0])==null?void 0:V[0])||null,s=c?a.filter(_=>_.club_id===c):[],l=((I=s[0])==null?void 0:I.country_code)||null,u=l?a.filter(_=>_.country_code===l&&_.club_id!==c):[],y=Math.min(s.length,Math.max(2,r+1),16),b=Math.min(u.length,Math.max(0,o),16-y),g=[],p=new Set;bi(s,i,y).forEach(_=>{g.push(_),p.add(_.id)}),bi(u,i,b).forEach(_=>{g.push(_),p.add(_.id)});const x=Math.max(0,16-g.length),f=a.filter(_=>!p.has(_.id));bi(f,i,x).forEach(_=>{g.push(_),p.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,R,W){var de,ce;return E.add(_.id),{cardId:"ai-"+_.id+"-"+W,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((de=_.clubs)==null?void 0:de.encoded_name)||null,clubLogo:((ce=_.clubs)==null?void 0:ce.logo_url)||null,boost:0,used:!1,_line:R}}for(const _ of["GK","DEF","MIL","ATT"]){const R=g.filter(H=>H.job===_&&!E.has(H.id)),W=g.filter(H=>H.job!==_&&!E.has(H.id)),de=[...R,...W],ce=[];for(let H=0;H<w[_];H++){const pe=de[H];pe&&ce.push(m(pe,_,H))}const j=dt(ce.length);ce.forEach((H,pe)=>{H._col=j[pe]}),h[_]=ce}let S=g.filter(_=>!E.has(_.id));if(S.length<5){const _=a.filter(R=>!E.has(R.id)&&!S.some(W=>W.id===R.id));S=S.concat(bi(_,i,5-S.length))}const $=S.slice(0,5).map((_,R)=>m(_,_.job,100+R)),{data:T}=await v.from("gc_definitions").select("*").eq("is_active",!0),G=[...T||[]].sort(()=>Math.random()-.5).slice(0,3).map((_,R)=>({id:"ai-gc-"+R,gc_type:_.name,name:_.name,icon:"⚡",effect_type:_.effect_type,effect_params:_.effect_params||{}}));let O=null;if(n>0&&c){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(O={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:G,stadiumDef:O}}function un(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<e[n];c++){const s=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?s:2,note_d:n==="DEF"?s:2,note_m:n==="MIL"?s:2,note_a:n==="ATT"?s:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const d=dt(a.length);a.forEach((c,s)=>{c._col=d[s]}),i[n]=a}return i}function qr(t,e,i){var r;Go("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const n=t.querySelector(".opponent-preview-wrap"),a=t.querySelector("#opponent-swipe-zone");if(!n||!a)return;const d=a.clientWidth>=900,c=Math.max(200,a.clientHeight-(d?8:40)),s=Math.max(200,a.clientWidth-(d?8:16)),l=d?null:Math.round(Math.max(44,Math.round(s*.168))*.55);n.innerHTML=Ut(e.aiTeam,e.formation,null,[],s,c,[],l),n.style.cssText=`width:${s}px;height:${c}px;overflow:hidden;flex-shrink:0`;const u=n.querySelector("svg");u&&(u.style.cssText="display:block;width:100%;height:100%",u.setAttribute("preserveAspectRatio",d?"xMidYMid meet":"none"))})),setTimeout(()=>Br(t,e,i),5e3)}const Ye=t=>dn(t);function Br(t,e,i){const o=e.homeTeam.MIL||[],r=e.aiTeam.MIL||[],n=e.stadiumDef||null,a=e.aiStadiumDef||null,d=vt(o,n)+wt(o),c=vt(r,a)+wt(r),s=d>=c;t.innerHTML=`
  ...
  </div>`;const l=()=>{const g=(p,x)=>t.querySelectorAll(p).forEach((f,w)=>{setTimeout(()=>{f.style.opacity="1",f.style.transform="translateY(0) scale(1)"},x+w*90)});g(".duel-card-home",150),g(".duel-card-ai",500),setTimeout(()=>t.querySelectorAll(".duel-link").forEach((p,x)=>{setTimeout(()=>{p.style.opacity="1"},x*70)}),900),setTimeout(()=>{const p=t.querySelector("#vs-label");p&&(p.style.opacity="1",p.style.animation="vsFlash .5s ease"),t.querySelectorAll(".duel-score-line").forEach(x=>x.style.opacity="1")},1250),setTimeout(()=>{u("score-home",d,800),u("score-ai",c,800)},1500)};function u(g,p,x){const f=document.getElementById(g);if(!f)return;const w=performance.now(),h=E=>{const m=Math.min(1,(E-w)/x);f.textContent=Math.round(p*(1-Math.pow(1-m,3))),m<1?requestAnimationFrame(h):f.textContent=p};requestAnimationFrame(h)}requestAnimationFrame(l),e.attacker=s?"home":"ai";const y=s?ln():null;s&&(e.boostCard={value:y}),e.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:o.map(g=>Ye(g)),aiPlayers:r.map(g=>Ye(g)),homeTotal:d,aiTotal:c,text:`Duel milieu : ${e.clubName} ${d} – ${c} IA → ${s?e.clubName+" attaque":"IA attaque"}`});const b=()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",Te(t,e,i),e.attacker==="ai"&&setTimeout(()=>ro(t,e,i),800)};setTimeout(()=>{const g=document.getElementById("score-home"),p=document.getElementById("score-ai"),x=document.getElementById(s?"duel-row-home":"duel-row-ai"),f=document.getElementById(s?"duel-row-ai":"duel-row-home"),w=s?g:p,h=s?p:g;w&&(w.style.fontSize="80px",w.style.color=s?"#FFD700":"#ff6b6b",w.style.animation="duelPulse .5s ease"+(s?", duelGlow 1.5s ease infinite .5s":"")),h&&(h.style.opacity="0.25"),setTimeout(()=>{x&&(x.style.transformOrigin="center",x.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",x.style.zIndex="5"),setTimeout(()=>{var m;const E=document.getElementById("duel-shock");if(E){const S=(m=f||x)==null?void 0:m.getBoundingClientRect(),$=t.querySelector(".match-screen").getBoundingClientRect();S&&(E.style.top=S.top-$.top+S.height/2+"px"),E.style.animation="shockwave .5s ease-out forwards"}f&&(f.style.transformOrigin="center",f.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var m;const E=document.getElementById("duel-finale");E&&(E.innerHTML=`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${x?kt({...x,used:!1,boost:0},f,w):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?kt({...p,used:!1,boost:0},f,w):"<div>—</div>"}</div>
    ...
    </div>`,(m=u.querySelector("#sub-close"))==null||m.addEventListener("click",()=>u.remove()),(S=u.querySelector("#out-up"))==null||S.addEventListener("click",()=>{d>0&&(d--,y())}),($=u.querySelector("#out-down"))==null||$.addEventListener("click",()=>{d<n.length-1&&(d++,y())}),(T=u.querySelector("#in-up"))==null||T.addEventListener("click",()=>{s>0&&(s--,y())}),(P=u.querySelector("#in-down"))==null||P.addEventListener("click",()=>{s<a.length-1&&(s++,y())});const E=(O,V,I,_)=>{const R=u.querySelector("#"+O);if(!R)return;let W=0;R.addEventListener("touchstart",de=>{W=de.touches[0].clientY},{passive:!0}),R.addEventListener("touchend",de=>{const ce=de.changedTouches[0].clientY-W;if(Math.abs(ce)<30)return;const j=V();ce<0&&j<_-1?(I(j+1),y()):ce>0&&j>0&&(I(j-1),y())},{passive:!0})};E("in-panel",()=>s,O=>s=O,a.length),E("out-panel",()=>d,O=>d=O,n.length),(G=u.querySelector("#sub-confirm"))==null||G.addEventListener("click",O=>{if(O.preventDefault(),O.stopPropagation(),l)return;l=!0;const V=n[d],I=a[s];if(!V||!I)return;let _=null,R=-1;for(const[de,ce]of Object.entries(e.homeTeam)){const j=(ce||[]).findIndex(H=>H.cardId===V.cardId);if(j!==-1){_=de,R=j;break}}if(R===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const W={...I,_line:_,_col:V._col||0,used:!1,boost:0};e.homeTeam[_].splice(R,1,W),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:V.name,firstname:V.firstname,note:Pe(V,_),portrait:qt(V),job:V.job,country_code:V.country_code,rarity:V.rarity,clubName:V.clubName,clubLogo:V.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Pe(I,_),portrait:qt(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${V.firstname} ${V.name}`}),u.remove(),Ar(V,I,()=>Te(t,e,i))})}document.body.appendChild(u),y()}function Hr(t,e,i,o,r){var y,b;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},d=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||a.desc,s=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=a.icon||"⚡",u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",u.innerHTML=`
    ${nt(d,s,l,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(u),(y=u.querySelector("#gc-back"))==null||y.addEventListener("click",()=>u.remove()),(b=u.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{u.remove(),Kr(t,e,i,o,r)})}function xi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let d=[];function c(){var s,l;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(u=>{const y=u._line||u.job||"MIL",b=d.find(p=>p.cardId===u.cardId),g=ze({...u,_evolution_bonus:0},{width:90,showStad:!0,role:y,extraNote:u.boost||0});return`<div class="gc-pick-item" data-cid="${u.cardId}"
    ...
    </div>`,(s=a.querySelector("#gc-picker-close"))==null||s.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(u=>{u.addEventListener("click",()=>{const y=u.dataset.cid,b=t.find(p=>p.cardId===y);if(!b)return;const g=d.findIndex(p=>p.cardId===y);g>-1?d.splice(g,1):d.length<e&&d.push(b),c()})}),(l=a.querySelector("#gc-picker-confirm"))==null||l.addEventListener("click",()=>{a.remove(),n(d)})}c(),document.body.appendChild(a)}const Ur={BOOST_STAT:({value:t=1,count:e=1,roles:i=[]},o,r,n)=>{const a=Object.entries(o.homeTeam).filter(([d])=>!i.length||i.includes(d)).flatMap(([d,c])=>c.filter(s=>!s.used).map(s=>({...s,_line:d})));return a.length?(xi(a,e,`Choisir ${e} joueur(s) à booster (+${t})`,r,o,d=>{d.forEach(c=>{const s=(o.homeTeam[c._line]||[]).find(l=>l.cardId===c.cardId);s&&(s.boost=(s.boost||0)+t,o.log.push({text:`⚡ +${t} sur ${s.name}`,type:"info"}))}),Te(r,o,n)}),!0):(o.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Te(r,o,n),!0)},DEBUFF_STAT:({value:t=1,count:e=1,roles:i=[],target:o="ai"},r,n,a)=>{const d=o==="home"?r.homeTeam:r.aiTeam,c=o==="ai"?"adverse":"allié",s=Object.entries(d).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,u])=>u.filter(y=>!y.used).map(y=>({...y,_line:l})));return s.length?(xi(s,e,`Choisir ${e} joueur(s) ${c}(s) à débuffer (-${t})`,n,r,l=>{l.forEach(u=>{const b=((o==="home"?r.homeTeam:r.aiTeam)[u._line]||[]).find(g=>g.cardId===u.cardId);b&&(b.boost=(b.boost||0)-t,r.log.push({text:`🎯 -${t} sur ${b.name}${o==="ai"?" (IA)":""}`,type:"info"}))}),Te(n,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${c} disponible`,type:"info"}),Te(n,r,a),!0)},GRAY_PLAYER:({count:t=1,roles:e=[],target:i="ai"},o,r,n)=>{const a=i==="home"?o.homeTeam:o.aiTeam,d=i==="ai"?"adverse":"allié",c=Object.entries(a).filter(([s])=>!e.length||e.includes(s)).flatMap(([s,l])=>l.filter(u=>!u.used).map(u=>({...u,_line:s})));return c.length?(xi(c,t,`Choisir ${t} joueur(s) ${d}(s) à exclure`,r,o,s=>{s.forEach(l=>{const y=((i==="home"?o.homeTeam:o.aiTeam)[l._line]||[]).find(b=>b.cardId===l.cardId);y&&(y.used=!0,o.log.push({text:`❌ ${y.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Te(r,o,n)}),!0):(o.log.push({text:`❌ Aucun joueur ${d} à exclure`,type:"info"}),Te(r,o,n),!0)},REVIVE_PLAYER:({count:t=1,roles:e=[]},i,o,r)=>{const n=Object.entries(i.homeTeam).filter(([a])=>!e.length||e.includes(a)).flatMap(([a,d])=>d.filter(c=>c.used).map(c=>({...c,_line:a})));return n.length?(xi(n,t,`Choisir ${t} joueur(s) à ressusciter`,o,i,a=>{a.forEach(d=>{const c=(i.homeTeam[d._line]||[]).find(s=>s.cardId===d.cardId);c&&(c.used=!1,i.log.push({text:`💫 ${c.name} ressuscité !`,type:"info"}))}),Te(o,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Te(o,i,r),!0)},REMOVE_GOAL:({},t)=>(t.aiScore>0?(t.aiScore--,t.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):t.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},t)=>(t.homeScore===t.aiScore?(t.homeScore++,t.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):t.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:t=1},e)=>(e.maxSubs=(e.maxSubs||3)+t,e.log.push({text:`🔄 +${t} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Kr(t,e,i,o,r){o.usedGc.push(t);const n=o.gcDefs||[],a=n.find(c=>c.name===e)||n.find(c=>{var s;return((s=c.name)==null?void 0:s.toLowerCase().trim())===(e==null?void 0:e.toLowerCase().trim())});let d=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const c=Ur[a.effect_type];c?c(a.effect_params||{},o,i,r)||(d=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),d=!0)}else{switch(e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const c=Object.entries(o.homeTeam).flatMap(([s,l])=>(l||[]).filter(u=>u.used).map(u=>({...u,_line:s})));c.length?(c[0].used=!1,o.log.push({text:`💫 ${c[0].name} ressuscité !`,type:"info"})):o.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const c=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(s=>!s.used);if(c.length){const s=c.sort((l,u)=>Pe(u,"ATT")-Pe(l,"ATT"))[0];s.used=!0,o.log.push({text:`❄️ ${s.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}d=!0}v.from("cards").delete().eq("id",t).then(()=>{}),d&&Te(i,o,r)}function Vr(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const d=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(d){d.boost=(d.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Te(t,e,i)})})}async function _t(t,e,i){var y,b,g,p;Gt(),Ke(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",d=e.isSolo&&((y=e.soloLevelConfig)!=null&&y.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):Xn(e.mode,a);if(e.isSolo&&r)try{const{data:x}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),f=(x==null?void 0:x.unlocked_level)||1;e.soloLevel>=f&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(x){console.warn("[Solo] Erreur mise à jour progression:",x.message)}const c="00000000-0000-0000-0000-000000000000";let s=null;if(e.isRankedAI)try{const{data:x}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(x){const f=x.mmr??1e3,w=x.mmr_deviation??350,h=x.mmr_volatility??.06,E=r?1:n?.5:0,m=(x.placement_matches??0)<10,S=Po(f,w,h,f,350,E,m),$=n?null:r?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:S.delta,p_away_delta:0,p_home_new_rd:S.newRd,p_away_new_rd:350,p_home_new_vol:S.newSigma,p_away_new_vol:.06}),s=S.delta}}catch(x){console.warn("[RankedAI] Erreur mise à jour MMR:",x.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",e.matchId);const l={credits:(o.profile.credits||0)+d,matches_played:(o.profile.matches_played||0)+1};r?l.wins=(o.profile.wins||0)+1:n?l.draws=(o.profile.draws||0)+1:l.losses=(o.profile.losses||0)+1,await v.from("users").update(l).eq("id",o.profile.id),await i.refreshProfile();const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",u.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}const J=(m.log||[]).slice(-1)[0];return J?'<div style="padding:2px 4px">'+cn(J)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),lo=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${$i(k,m[p+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
        <div id="pvp-score-me" style="font-size:48px;font-weight:900;color:#D4A017;transition:all .5s ease">0</div>
        <div id="pvp-vs" style="font-size:14px;color:rgba(255,255,255,.4);letter-spacing:3px;opacity:0">VS</div>
        <div id="pvp-score-opp" style="font-size:48px;font-weight:900;color:rgba(255,255,255,.7);transition:all .5s ease">0</div>
      </div>
      ${$i(L,m[x+"Name"]||"Adversaire","#e03030","opp",null)}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      ...
      <div style="width:min(90vw,420px)">${zi(m[x+"Team"],m[x+"Formation"],null,[],Ct(),Ot())}</div>
    ...
    </div>`,(A=document.getElementById("pvp-home"))==null||A.addEventListener("click",()=>{try{v.removeChannel(V)}catch{}Ve(t),l?b("mini-league",{openLeagueId:l}):b("home")})}H()}async function Wi(t,e,i=!1){var d,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:c.rankedData)||null;await Mi(t,e,i?"ranked":"random",async({deckId:s,formation:l,starters:u,subsRaw:y,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const x=async f=>{await ea(t,e,s,l,u,y,f||[],g,p,i,a)};if(!(b!=null&&b.length)){await x([]);return}Ai(t,b,x)})}async function Zr(t,e,i){return Qr(t,e,i)}async function ea(t,e,i,o,r,n,a=[],d=[],c=null,s=!1,l=null){var O,V;const{state:u,navigate:y,toast:b}=e,g=(l==null?void 0:l.mmr)??((O=u.profile)==null?void 0:O.mmr)??1e3,p=s?Ii(g):null,x=s?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",f=s?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:${x};color:#fff;padding:32px;text-align:center;gap:20px">
      ${s?`<div style="font-size:36px">${(p==null?void 0:p.emoji)||"⚽"}</div>`:""}
      <div style="font-size:18px;font-weight:900;color:#fff">${s?"Recherche Ranked…":"Recherche d'un adversaire…"}</div>
      ${s?`<div style="font-size:13px;color:${(p==null?void 0:p.color)||"#D4A017"}">${(p==null?void 0:p.name)||""} · ${Math.round(g)} MMR</div>`:""}
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(V=document.getElementById("cancel-mm"))==null||V.addEventListener("click",async()=>{await m(),Ve(t),y("home")});const S=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Bt(t,e,I,_,{myGC:a,gcDefs:d,stadiumDef:c,isRanked:s,rankedData:l,onMatchEnd:s?ta:null}))},$=u.user.id,{data:T,error:P}=s?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(T!=null&&T.success)){console.error("[Matchmaking] try_matchmake error:",P||T),b("Erreur de matchmaking","error"),Ve(t),y("home");return}if(T.matched){await S(T.match_id,!1);return}const G=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await S(I.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&S(_.match_id,!0)}).subscribe(),E=setInterval(G,3e3),s?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),y("match",{matchMode:"ranked_ai",rankedData:l,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:d,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function ta(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:d,awayScore:c,matchId:s}=t,l=i.user.id,u=n===l,y=r===l,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",u?a:n).single();if(b&&g){const p=Po(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,y?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?v.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(y?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,y?"success":"error",4e3)}}const ia=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Wi,resumePvpMatch:Zr},Symbol.toStringTag,{value:"Module"}));async function oa(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,d=n.friendName||"Ami",c=!!n.isAccepting;await Mi(t,e,"friend",async({deckId:s,formation:l,starters:u,subsRaw:y,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const x=async f=>{const w=f||[];c?await ra(t,e,s,w,g,p):await na(t,e,s,w,g,p,a,d)};if(!(b!=null&&b.length)){await x([]);return}Ai(t,b,x)})}async function na(t,e,i,o,r,n,a,d){var w;const{state:c,navigate:s,toast:l}=e,u=c.user.id,{data:y,error:b}=await v.from("friend_match_invites").insert({inviter_id:u,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!y){console.error("[Friend] Erreur création invitation:",b),l("Impossible de créer l'invitation","error"),s("home");return}t.innerHTML=`
    ...
    </div>`;let g=!1,p=null;const x=async()=>{p&&(p.unsubscribe(),p=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await x(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",y.id),Ve(t),s("home")}),p=v.channel(`friend_invite_${y.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${y.id}`},async({new:h})=>{g||h.status!=="accepted"||!h.match_id||(g=!0,await x(),await Bt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))}).subscribe();const f=setInterval(async()=>{if(g)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",y.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(g=!0,clearInterval(f),await x(),await Bt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))},3e3);setTimeout(async()=>{g||(clearInterval(f),await x(),l("Invitation expirée","info"),s("home"))},12e4)}async function ra(t,e,i,o,r,n){const{state:a,navigate:d,toast:c}=e,s=a.user.id,{data:l}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",s).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!l){c("Aucune invitation en attente","error"),d("home");return}const{data:u,error:y}=await v.rpc("accept_friend_invite",{p_invite_id:l.id,p_invitee_deck_id:i});if(y||!(u!=null&&u.success)){console.error("[Friend] Erreur accept_friend_invite:",y||u),c((u==null?void 0:u.error)||"Impossible de rejoindre le match","error"),d("home");return}await Bt(t,e,u.match_id,!1,{myGC:o,gcDefs:r,stadiumDef:n})}const gn="#1A6B3C",pt="#D4A017",Zt="var(--tile-bg)",ei="var(--tile-border)",At="var(--divider)",Ze="var(--tile-fg-on-page)",St="var(--tile-fg-dim)",it="var(--tile-fg-faint)",ii="var(--nav-fg,#fff)",bn="rgba(255,255,255,0.62)",aa="rgba(255,255,255,0.4)";async function sa(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ft(t,e,i);return}await ot(t,e)}async function ot(t,e,i="waiting"){var h,E;const{state:o}=e,r=o.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(n||[]).map(m=>m.league_id),d={};(n||[]).forEach(m=>{d[m.league_id]={amount:m.prize_amount,claimed:m.prize_claimed}});const{data:c,error:s}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),l=s?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:c||[],y=(a.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],b=y.filter(m=>m.status==="waiting"&&!m.is_archived),g=y.filter(m=>m.status==="active"&&!m.is_archived),p=y.filter(m=>m.is_archived||m.status==="finished");let x=p;if(p.length){const{data:m}=await v.from("mini_league_matches").select("league_id").in("league_id",p.map($=>$.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),S=new Set((m||[]).map($=>$.league_id));x=p.filter($=>S.has($.id))}const f=l.filter(m=>!a.includes(m.id)),w=[{key:"waiting",label:"🟡 En attente",count:b.length+f.length},{key:"active",label:"🟢 En cours",count:g.length},{key:"archived",label:"📁 Archivées",count:x.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?la(b,f,r):i==="active"?da(g,r):ca(x,r,d)}
    </div>
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var g,p,x,f;const{toast:o}=e,r=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,d=((g=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:g.value)||"public",c=((p=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:p.value)||"aller",s=((f=(x=document.getElementById("ml-pwd"))==null?void 0:x.value)==null?void 0:f.trim())||null;if(!r){o("Le nom est obligatoire","error");return}if(a<100){o("Mise minimum : 100 crédits","error");return}if(d==="private"&&!s){o("Mot de passe requis","error");return}const{data:l,error:u}=await v.from("mini_leagues").insert({name:r,creator_id:e.state.profile.id,type:d,password:s,mode:c,max_players:n,entry_fee:a}).select().single();if(u){o("Erreur : "+u.message,"error");return}const{data:y}=await v.from("users").select("credits").eq("id",e.state.profile.id).single();if(((y==null?void 0:y.credits)||0)<a){await v.from("mini_leagues").delete().eq("id",l.id),o(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:y.credits-a}).eq("id",e.state.profile.id),await v.from("mini_leagues").update({pot:a}).eq("id",l.id),await v.from("mini_league_members").insert({league_id:l.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=y.credits-a);const b=document.getElementById("nav-credits");b&&(b.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,l.id)})}function ua(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function xn(t,e,i,o){var u;const{toast:r,state:n}=e,a=n.profile.id;let d=null;if(o==="private"&&(d=await ua(),d===null))return;const{data:c,error:s}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:d});if(s||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",s||c),r((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:y}=await v.from("users").select("credits").eq("id",a).single();n.profile&&y&&(n.profile.credits=y.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((u=n.profile)==null?void 0:u.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function fa(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(y=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(b),b.querySelector("#lv-ok").onclick=()=>{b.remove(),y(!0)},b.querySelector("#lv-cancel").onclick=()=>{b.remove(),y(!1)}}))return;const{data:c,error:s}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(s||!(c!=null&&c.success)){r((c==null?void 0:c.error)||"Erreur lors de la désinscription","error");return}const l=c.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+l);const u=document.getElementById("nav-credits");u&&(u.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Xi(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,r)}async function ma(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,m,S,$,T,P,G,O,V;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:d},{data:c}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await ot(t,e);return}const s=(d||[]).some(I=>I.user_id===n),l=a.creator_id===n,u=(d||[]).map(I=>I.user).filter(Boolean),y=ha(u,c||[]),b=(c||[]).filter(I=>I.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,x=b.length>0&&b.every(I=>I.status==="finished"||I.status==="bye"),f=a.current_day>=a.total_days,w=(d||[]).find(I=>I.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        <div style="font-size:12px;color:${St};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*u.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*u.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*u.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*u.length*.1).toLocaleString("fr")})</div>
        ${u.map(I=>`
        ...
        ${s?"":`<button id="ml-join-now" class="btn btn-primary" style="width:100%;margin-top:14px">Rejoindre (mise : ${p} cr.)</button>`}
        ${s&&!l?`
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${l&&x&&!f?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
      </div>`:""}
    ...
    </div>`,document.body.appendChild(u),(y=u.querySelector("#prize-close"))==null||y.addEventListener("click",()=>u.remove()),(b=u.querySelector("#claim-prize-btn"))==null||b.addEventListener("click",async g=>{const p=g.currentTarget;p.disabled=!0,p.textContent="...";const{data:x,error:f}=await v.rpc("claim_mini_league_prize",{p_league_id:i.id,p_user_id:n.profile.id});if(f||!(x!=null&&x.success)){console.error("[MiniLeague] claim_mini_league_prize:",f||x),a((x==null?void 0:x.error)||"Erreur lors de la récupération","error"),p.disabled=!1,p.textContent=`💰 Récupérer ${s.toLocaleString("fr")} cr.`;return}if(x.already_claimed)a("Déjà récupéré précédemment","info");else{const w=(n.profile.credits||0)+x.prize;n.profile&&(n.profile.credits=w);const h=document.getElementById("nav-credits");h&&(h.textContent=`💰 ${w.toLocaleString("fr")}`),a(`💰 +${x.prize.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success")}u.remove(),ft(t,e,i.id)})}function ya(t,e){const o=t.length%2===0?[...t]:[...t,null],r=o.length;let n=o.slice(1);const a=[];for(let d=0;d<r-1;d++){const c=[],s=[o[0],...n];for(let l=0;l<r/2;l++){const u=s[l],y=s[r-1-l];u===null?c.push({bye:y}):y===null?c.push({bye:u}):c.push({home:u,away:y})}a.push(c),n=[n[n.length-1],...n.slice(0,-1)]}return e==="aller-retour"?[...a,...a.map(d=>d.map(c=>c.bye?c:{home:c.away,away:c.home}))]:a}function ha(t,e){const i={};return t.forEach(o=>{i[o.id]={userId:o.id,pseudo:o.pseudo,clubName:o.club_name||o.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),e.filter(o=>o.status==="finished"&&!o.is_bye&&o.home_score!=null).forEach(o=>{const r=i[o.home_id],n=i[o.away_id];!r||!n||(r.played++,n.played++,r.goalsFor+=o.home_score,r.goalsAgainst+=o.away_score,n.goalsFor+=o.away_score,n.goalsAgainst+=o.home_score,o.home_score>o.away_score?(r.won++,r.points+=3,n.lost++):o.home_score<o.away_score?(n.won++,n.points+=3,r.lost++):(r.drawn++,r.points++,n.drawn++,n.points++),r.goalDiff=r.goalsFor-r.goalsAgainst,n.goalDiff=n.goalsFor-n.goalsAgainst)}),Object.values(i).sort((o,r)=>r.points-o.points||r.goalDiff-o.goalDiff||r.goalsFor-o.goalsFor)}async function Co(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.leagueId||null,d=n.mlMatchId||null,c=i.user.id;if(!d||!a){r("Match introuvable","error"),o("mini-league");return}const{data:s,error:l}=await v.from("mini_league_matches").select("id, league_id, home_id, away_id, status, match_id").eq("id",d).single();if(l||!s){r("Match introuvable","error"),o("mini-league",{openLeagueId:a});return}if(s.home_id!==c&&s.away_id!==c){r("Vous ne faites pas partie de ce match","error"),o("mini-league",{openLeagueId:a});return}const u=s.home_id===c;if(s.match_id){await Bt(t,e,s.match_id,u,{mlLeagueId:a,mlMatchId:d});return}await Mi(t,e,"mini_league",async({deckId:y,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const x=async f=>{const{data:w,error:h}=await v.rpc("start_mini_league_match",{p_ml_match_id:d,p_user_id:c,p_deck_id:y});if(h||!(w!=null&&w.success)){console.error("[MiniLeague] start_mini_league_match error:",h||w),r((w==null?void 0:w.error)||"Impossible de lancer le match","error"),o("mini-league",{openLeagueId:a});return}if(w.matched){await Bt(t,e,w.match_id,u,{mlLeagueId:a,mlMatchId:d,myGC:f||[],gcDefs:g,stadiumDef:p});return}await va(t,e,{mlMatchId:d,leagueId:a,amIHome:u,chosenGC:f,gcDefs:g,stadiumDef:p})};if(!(b!=null&&b.length)){await x([]);return}Ai(t,b,x)})}function va(t,e,{mlMatchId:i,leagueId:o,amIHome:r,chosenGC:n,gcDefs:a,stadiumDef:d}){return new Promise(c=>{var p;const{navigate:s}=e;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#0a1a2e,#0d3d1e);color:#fff;padding:32px;text-align:center;gap:20px">
      <div style="font-size:36px">🏆</div>
    ...
    </div>`;let l=!1;const u=async x=>{if(!l){if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}x&&await Bt(t,e,x,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:d}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}s("mini-league",{openLeagueId:o}),c()});const y=async()=>{if(l)return;const{data:x}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();x!=null&&x.match_id&&u(x.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},x=>{var f;(f=x.new)!=null&&f.match_id&&u(x.new.match_id)}).subscribe(),g=setInterval(y,3e3);y()})}const wa="/",_a=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ka(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,u,y;const d=e[o],c=o===e.length-1,s=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let c="buy";const s=()=>{var p,x,f,w,h,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((x=document.getElementById("flt-club"))==null?void 0:x.value)||"").toLowerCase().trim(),country:(((f=document.getElementById("flt-country"))==null?void 0:f.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function l(p){const x=s();return p.filter(f=>{var P,G,O;const w=(P=f.card)==null?void 0:P.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((G=w.clubs)==null?void 0:G.encoded_name)||"").toLowerCase(),m=(w.country_code||"").toLowerCase(),S=((O=f.card)==null?void 0:O.evolution_bonus)||0,$=yi(w,w.job,S),T=w.job2?yi(w,w.job2,S):0;return!(x.name&&!h.includes(x.name)||x.club&&!E.includes(x.club)||x.country&&!m.includes(x.country)||x.job&&w.job!==x.job||x.rarity&&w.rarity!==x.rarity||x.note1&&$<x.note1||x.note2&&T<x.note2)})}function u(p){var E,m,S;const x=(E=p.card)==null?void 0:E.player;if(!x)return"";const f=((m=p.card)==null?void 0:m.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
      ${ze({...x,_evolution_bonus:f},{width:140})}
    ...
    </div>`}function y(p){var G,O,V,I;const x=(G=p.card)==null?void 0:G.player;if(!x)return"";const f=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=yi(x,x.job,f),h=x.job2?yi(x,x.job2,f):0,E=p.status==="sold",m=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,S=qo[x.job]||"#bbb",$=x.job2?qo[x.job2]||"#bbb":null,T=x.job==="GK"?"#fff":S,P=x.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
    ...
    </div>`}function b(){const p=document.getElementById("mkt-content"),x=document.getElementById("mkt-filters");if(p){if(x.style.display=c==="buy"?"flex":"none",c==="buy"){const f=l(a);p.innerHTML=f.length?`<div class="mkt-buy-grid">${f.map(u).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const f=d.filter(h=>h.status==="active").sort((h,E)=>new Date(E.listed_at)-new Date(h.listed_at)),w=d.filter(h=>h.status==="sold").sort((h,E)=>new Date(E.sold_at||E.listed_at)-new Date(h.sold_at||h.listed_at));p.innerHTML=(f.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${f.length})</div>`+f.map(y).join(""):"")+(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${w.length})</div>`+w.map(y).join(""):"")+(!f.length&&!w.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(f=>f.addEventListener("click",()=>Ea(f.dataset.buy,a,t,e))),p.querySelectorAll("[data-cancel]").forEach(f=>f.addEventListener("click",()=>Ia(f.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{c=p.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(x=>{const f=x===p;x.style.background=f?"var(--green)":"var(--tile-bg)",x.style.color=f?"#fff":"var(--tile-fg-dim)",x.style.borderColor=f?"var(--green)":"var(--tile-border)"}),b()})});let g;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var x;(x=document.getElementById(p))==null||x.addEventListener("input",()=>{clearTimeout(g),g=setTimeout(b,250)})}),b()}async function Ea(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,d=e.find(l=>l.id===t);if(!d)return;const c=d.price;if((r.profile.credits||0)<c){n("Crédits insuffisants","error");return}La(d,async()=>{const{error:l}=await v.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:r.profile.id});if(l){n("Erreur achat : "+l.message,"error");return}await a();const u=document.getElementById("nav-credits");u&&(u.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await so(i,o)})}function La(t,e){var a;const i=(a=t.card)==null?void 0:a.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${T.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${s(P)};color:${l(P)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${P<3?"16":"13"}px">${P<3?["🥇","🥈","🥉"][P]:P+1}</div>
          <div style="flex:1;min-width:0">
  ...
  </div>`,u(),(p=document.getElementById("tab-ranked"))==null||p.addEventListener("click",()=>{c="ranked",u()}),(x=document.getElementById("tab-mini-league"))==null||x.addEventListener("click",()=>{c="mini-league",u()}),(f=document.getElementById("tab-random"))==null||f.addEventListener("click",()=>{c="random",u()})}async function Sa(t,e){var S,$,T,P;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:d}]=await Promise.all([v.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),v.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!d){r("Erreur chargement profil","error"),o("home");return}if(!a){t.innerHTML=`
  ...
  <div style="min-height:100%;background:${w[g.id]};padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
    ...
    <div style="background:rgba(0,0,0,0.3);border-radius:12px;padding:12px 16px">
      ...
      <div style="text-align:center;font-size:11px;color:rgba(255,255,255,0.4);margin-top:4px">${p}% vers ${f?f.label:"Maître"}</div>
    </div>`:""}
  ...
  </div>`}_n($n);const ve={user:null,profile:null,page:"home",params:{}};function It(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function za(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ji(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const yn="mw_theme";function oi(){return localStorage.getItem(yn)||"club"}function Bo(t){var e;localStorage.setItem(yn,t),hi(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function hi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function zt(t,e={}){ve.page=t,ve.params=e,hn()}async function hn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:zt,toast:It,openModal:za,closeModal:Ji,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Di(t,i);break;case"home2":await Di(t,i);break;case"game":await Wn(t,i);break;case"settings":await Wo(t,i);break;case"collection":await ir(t,i);break;case"decks":await Gi(t,i);break;case"boosters":await br(t,i);break;case"ranked":await Sa(t,i);break;case"match":{const d=ve.params&&ve.params.matchMode||"vs_ai_easy";d==="random"?await Wi(t,i,!1):d==="ranked"?await Wi(t,i,!0):d==="friend"?await oa(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):d==="mini_league"||d==="mini-league"?await Co(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await zr(t,i);break}case"market":await $a(t,i);break;case"rankings":await Ta(t,i);break;case"matches":await Aa(t,i);break;case"friends":await Un(t,i);break;case"mini-league":await sa(t,i);break;case"match-mini-league":{const d=ve.params||{};await Co(t,i,d.mlMatchId,d.leagueId);break}default:await Di(t,i)}}function Ma(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.29-1132" style="cursor:pointer">
