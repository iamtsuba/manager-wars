...
import{s as w,l as Gt,F as Ii,r as Ae,j as Jt,m as on,h as Ai,n as Mn,o as jn,T as gi,k as Cn,p as Bn,b as qn}from"./formation-links-yJiMLlPw.js";const Dn="/";function Ri(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,l,c,d,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",x=u.trim().split(" ").filter(Boolean),m=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():u.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(u){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(u){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),x=document.getElementById("step3-finish");u.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:a,credits:1e4});if(m)throw m;await Pn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function Pn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Gn="modulepreload",Rn=function(e){return"/"+e},Ni={},rn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(l=>{if(l=Rn(l),l in Ni)return;Ni[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":Gn,c||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),c)return new Promise((x,m)=>{u.addEventListener("load",x),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Ut="#1A6B3C",Kt="#cc2222",Nn="#D4A017",Oi="#888";async function On(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`}function Un(e,t){const i=Si();i.innerHTML=`
    <div class="popup-box">
    ...
    ${Mi()}`,document.body.appendChild(b),b.querySelector("#stats-close").addEventListener("click",()=>b.remove()),b.addEventListener("click",$=>{$.target===b&&b.remove()})}function Si(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function Mi(){return`
    <style>
      .popup-box {
    ...
    </style>`}const Vn="2026.07.18-1435";async function Hi(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    ${Ae(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(S=>S.card_type==="player"&&S.player),d=(s||[]).filter(S=>S.card_type==="game_changer"),u=(s||[]).filter(S=>S.card_type==="formation"),x=(s||[]).filter(S=>S.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(S=>{f[S.name]=S});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),g={};(p||[]).forEach(S=>{g[S.id]=S}),x.forEach(S=>{S.stadium_def&&(g[S.stadium_id]=S.stadium_def)});const h=Object.keys(Ii),_=Object.keys(Me),b={};c.forEach(S=>{const C=S.player.id;b[C]=(b[C]||0)+1}),new Set(Object.keys(b).map(S=>String(S)));const $=new Set(u.map(S=>S.formation)),y=new Set(d.map(S=>S.gc_type));let j="player",E="Tous",F="",N=!1;function ne(){return[...c].sort((S,C)=>{const D=Zt.indexOf(S.player.job),W=Zt.indexOf(C.player.job);return D!==W?D-W:(S.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function ie(){return[...l||[]].sort((S,C)=>{const D=Zt.indexOf(S.job),W=Zt.indexOf(C.job);return D!==W?D-W:(S.surname_real||"").localeCompare(C.surname_real||"")})}function Q(){return ne().filter(S=>{const C=S.player,D=E==="Tous"||C.job===E,W=!F||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(F);return D&&W})}function U(){return ie().filter(S=>{const C=E==="Tous"||S.job===E,D=!F||`${S.firstname} ${S.surname_real}`.toLowerCase().includes(F);return C&&D})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function v(){const S=document.getElementById("col-filters");S&&(j==="player"?(S.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",C=>{F=C.target.value.toLowerCase(),I()}),e.querySelectorAll(".filter-btn").forEach(C=>{C.addEventListener("click",()=>{E=C.dataset.job,v(),I()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,v(),I()})):(S.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,v(),I()})))}function I(){const S=document.getElementById("col-grid");S&&(j==="player"?ke(S):j==="formation"?Y(S):j==="stadium"?R(S):J(S))}function G(S,C,D,W,K){const B=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!B||!O)return;var we=0;function _e(){const ye=window.innerWidth>=768,be=document.getElementById("col-big"),$e=document.getElementById("col-grid");ye&&be&&(be.style.minHeight="420px",be.style.flex="1 1 auto"),ye&&$e&&($e.style.height=Math.round(310*.76+16)+"px",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+C(S[we])+"</div>";var Le=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Le&&Le.addEventListener("click",function(){W(S[we])}),requestAnimationFrame(function(){var ge=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!ge||!O)){var Be=O.clientHeight-8,je=O.clientWidth-24,Oe=ge.offsetHeight,bt=ge.offsetWidth;if(Oe>0&&bt>0&&Be>40){var Xe=ye?2.2:1.6,Rt=Math.min(Be/Oe,je/bt,Xe);ge.style.transform="scale("+Rt.toFixed(3)+")",ge.style.transformOrigin="top center"}}}),B.innerHTML=S.map(function(ge,Be){var je=Be===we,Oe="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(je?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Be+'" style="'+Oe+'">'+D(ge,je)+"</div>"}).join(""),B.querySelectorAll(".col-mini-item").forEach(function(ge){ge.addEventListener("click",function(){we=Number(ge.dataset.idx),_e(),ge.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function re(S){var C=window.innerWidth>=768?.76:.54,D;if(!S||S._fake){var W=S?S.player:null;if(!W)return"";D=Yi(W)}else D=yi(S,"");return'<div style="display:inline-block;zoom:'+C+';pointer-events:none;line-height:0">'+D+"</div>"}function ae(S,C,D){C=C||100,D=D||140;var W=Jt[S]||{},K={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},B=Math.max(3,Math.round(C*.06)),O=Object.entries(W).map(function(_e){var ye=_e[0],be=_e[1],$e=ye.replace(/\d+$/,""),Le=K[$e]||"#888",ge=Math.round(be.x*C),Be=Math.round(be.y*D);return'<circle cx="'+ge+'" cy="'+Be+'" r="'+B+'" fill="'+Le+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),we=Math.max(1,Math.round(C/50));return'<svg viewBox="0 0 '+C+" "+D+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+C+'" height="'+D+'" fill="#1A6B3C"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(D*.02)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(D*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/><line x1="0" y1="'+Math.round(D*.5)+'" x2="'+C+'" y2="'+Math.round(D*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><ellipse cx="'+Math.round(C*.5)+'" cy="'+Math.round(D*.5)+'" rx="'+Math.round(C*.18)+'" ry="'+Math.round(D*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(D*.82)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(D*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/>'+O+"</svg>"}function se(S,C,D){var W=D>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+D+"</div>":"",K=C?'data-form-id="'+C.id+'"':"",B=S.length>7?14:S.length>5?16:19,O=!!C;return"<div "+K+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+W+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+B+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+S+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+ae(S,140,220)+"</div></div>"}function de(S,C){var D=window.innerWidth>=768?.76:.54,W=140,K=305,B=Math.round(K*.22),O=K-B,we=S.length>7?10:13,_e=ae(S,W,O),ye=C?"1.5px solid #2a7a40":"1px solid #ddd",be=C?"":"filter:grayscale(1);opacity:0.45;",$e=C?"#1A6B3C":"#bbb",Le="#fff";return'<div style="display:inline-block;zoom:'+D+';line-height:0;pointer-events:none"><div style="width:'+W+"px;height:"+K+"px;border-radius:6px;border:"+ye+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+be+'"><div style="height:'+B+"px;background:"+$e+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+we+"px;font-weight:900;color:"+Le+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(W-4)+'px">'+S+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function ke(S){if(N){const C=U();if(!C.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const D=C.map(W=>c.find(K=>K.player.id===W.id)||{_fake:!0,player:W,id:"fake-"+W.id});G(D,W=>W._fake?Yi(W.player):yi(W,""),W=>W._fake?re({player:W.player,id:"x",_fake:!0}):re(W),W=>{W._fake||Wi(W,c,b,t)})}else{const C=Q();if(!C.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const D={};C.forEach(K=>{const B=K.player.id;D[B]||(D[B]=[]),D[B].push(K)});const W=Object.values(D).map(K=>ro(K));G(W,K=>{const B=b[K.player.id]||1,O=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",_e=c.filter(ye=>ye.player.id===K.player.id&&ye.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return yi(K,O+_e)},K=>re(K),K=>Wi(K,c,b,t))}}function Y(S){const C=N?h:[...$];if(!C.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const D=C.map(W=>({formation:W,card:u.find(K=>K.formation===W)||null,owned:$.has(W)}));G(D,({formation:W,card:K,owned:B})=>se(W,B?K:null,B?u.filter(O=>O.formation===W).length:0),({formation:W,owned:K})=>de(W,K),({card:W,owned:K})=>{K&&W&&uo(W,u,t,o)})}function J(S){const C=Object.keys(f),D=N?C.length?C:_:[...y];if(!D.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const W=D.map(K=>({type:K,gc:Me[K]||{icon:"⚡",desc:""},def:f[K]||null,owned:y.has(K),card:d.find(B=>B.gc_type===K)||null}));G(W,({type:K,gc:B,def:O,owned:we,card:_e})=>{var Xe;const ye=we?d.filter(Rt=>Rt.gc_type===K).length:0,be=ye>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ye}</div>`:"",$e=(O==null?void 0:O.gc_type)==="ultra_game_changer",Le={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ge={purple:"#b06ce0",light_blue:"#00d4ef"},Be=Le[O==null?void 0:O.color]||Le.purple,je=ge[O==null?void 0:O.color]||ge.purple,Oe=(O==null?void 0:O.effect)||B.desc||"",bt=O!=null&&O.image_url?`/icons/${O.image_url}`:((Xe=O==null?void 0:O.club)==null?void 0:Xe.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return we&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${K}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${je};background:${Be};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${je}66;cursor:pointer">
          ${be}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${bt?`<img src="${bt}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${B.icon}</span>`}
          </div>
        ...
        </div>`},({type:K,gc:B,def:O,owned:we})=>{const _e=window.innerWidth>=768?.76:.54,ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},be={purple:"#9b59b6",light_blue:"#00bcd4"},$e=ye[O==null?void 0:O.color]||ye.purple,Le=be[O==null?void 0:O.color]||be.purple,ge=O!=null&&O.image_url?`/icons/${O.image_url}`:null;return we?`<div style="display:inline-block;zoom:${_e};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${$e};border:1px solid ${Le};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${K}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${ge?`<img src="${ge}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${B.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((O==null?void 0:O.effect)||B.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${_e};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${B.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${K}</span></div></div>`},({type:K,owned:B,def:O})=>{B&&po(K,O,o)})}function R(S){const C="#E87722",D="/";if(!x.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const W={};x.forEach(B=>{const O=B.stadium_id||"?";(W[O]=W[O]||[]).push(B)});const K=Object.entries(W).map(([B,O])=>({sid:B,def:g[B]||null,count:O.length,card:O[0]}));G(K,({def:B,count:O})=>{var Le,ge;const we=(B==null?void 0:B.name)||"?",_e=((Le=B==null?void 0:B.club)==null?void 0:Le.encoded_name)||(B==null?void 0:B.country_code)||"—",ye=B!=null&&B.image_url?`${D}icons/${B.image_url}`:((ge=B==null?void 0:B.club)==null?void 0:ge.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),be=ye?`<img src="${ye}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',$e=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${C},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${C}66">
          ${$e}
        ...
        </div>`},({def:B,count:O})=>{var Le,ge;const we=window.innerWidth>=768?.76:.54,_e=(B==null?void 0:B.name)||"?",ye=((Le=B==null?void 0:B.club)==null?void 0:Le.encoded_name)||(B==null?void 0:B.country_code)||"—",be=B!=null&&B.image_url?`${D}icons/${B.image_url}`:((ge=B==null?void 0:B.club)==null?void 0:ge.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),$e=be?`<img src="${be}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${we};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(S=>{S.addEventListener("click",()=>{j=S.dataset.tab,E="Tous",F="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(C=>{const D=C.dataset.tab===j;C.style.borderBottomColor=D?"var(--green)":"transparent",C.style.color=D?"var(--green)":"var(--gray-600)"}),v(),I()})}),v(),I()}function po(e,t,i){const n=Me[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((Y,J)=>{const R=Q[Y.id]||[],S=Y.is_for_sale,C=R.length?R[R.length-1]:null,W=(d.rarity==="pepite"||d.rarity==="papyte")&&Y.current_note!=null?` (☆${Y.current_note})`:"";return`
      ...
      <!-- Carte visuelle -->
      ${Ae({...d,_evolution_bonus:m},{width:160})}
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([Y,J])=>{const R=mi[Y],S=Y==="GK"?"#fff":R,C=Y===d.job||Y===d.job2,D=(Number(J)||0)+(C&&j>0?j:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${R};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${S};font-family:Arial Black,Arial;line-height:1">${D}</span>
                </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ae=document.getElementById("close-detail"))==null||ae.addEventListener("click",s);let I=new Set;const G=()=>{const Y=I.size,J=document.getElementById("sell-action-panel");if(!J)return;J.style.display=Y>0?"block":"none",document.getElementById("sell-selected-count").textContent=Y;const R=document.getElementById("evolve-btn");R&&(R.textContent=`⬆️ Évoluer ${Y>1?"(+"+Y+")":""}`)};document.querySelectorAll(".expl-check").forEach(Y=>{Y.addEventListener("change",()=>{const J=Y.dataset.id;Y.checked?I.add(J):I.delete(J);const R=Y.closest(".exemplaire-row");R&&(R.style.borderColor=Y.checked?"#1A6B3C":"#eee"),G()})}),document.querySelectorAll(".exemplaire-row").forEach(Y=>{Y.addEventListener("click",J=>{if(J.target.closest("button")||J.target.tagName==="INPUT")return;const R=Y.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(Y=>{Y.addEventListener("click",J=>{J.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${Y.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(se=document.getElementById("evolve-btn"))==null||se.addEventListener("click",async()=>{if(x<=1)return;const Y=[...I];if(!Y.length)return;if(I.has(e.id)){const K=document.createElement("div");K.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",K.innerHTML=`
        ...
        </div>`,document.body.appendChild(K),K.querySelector("#err-close").addEventListener("click",()=>K.remove()),K.addEventListener("click",B=>{B.target===K&&K.remove()});return}const J=Y.filter(K=>K!==e.id),R=d.rarity==="legende"?2:1;if((J.length||1)*R,!(!J.length&&Y.length===1&&Y[0]===e.id)){if(!J.length){o("Sélectionne des copies à sacrifier","warning");return}}if(!await new Promise(K=>{const B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",B.innerHTML=`
        ...
        </div>`,document.body.appendChild(B),B.querySelector("#sac-cancel").addEventListener("click",()=>{B.remove(),K(!1)}),B.querySelector("#sac-ok").addEventListener("click",()=>{B.remove(),K(!0)}),B.addEventListener("click",O=>{O.target===B&&(B.remove(),K(!1))})}))return;if(J.length){await w.from("market_listings").delete().in("card_id",J),await w.from("deck_cards").delete().in("card_id",J),await w.from("transfer_history").delete().in("card_id",J),await w.from("decks").update({stadium_card_id:null}).in("stadium_card_id",J);const{error:K}=await w.from("cards").delete().in("id",J);if(K){o("Erreur suppression : "+K.message,"error");return}}const C=(e.evolution_bonus||0)+J.length*R,{error:D}=await w.from("cards").update({evolution_bonus:C}).eq("id",e.id);if(D){o("Erreur évolution : "+D.message,"error");return}const W=_+C;o(`⬆️ ${d.firstname} ${d.surname_real} : note ${_+e.evolution_bonus||_} → ${W}${J.length?` · ${J.length} copie${J.length>1?"s":""} sacrifiée${J.length>1?"s":""}`:""} !`,"success",4e3),s(),l("collection")}),(de=document.getElementById("market-sell-btn"))==null||de.addEventListener("click",async()=>{var D;const Y=[...I];if(!Y.length){o("Sélectionne au moins un exemplaire","warning");return}const J=parseInt((D=document.getElementById("sell-market-price"))==null?void 0:D.value);if(!J||J<1){o("Prix invalide","error");return}const{error:R}=await w.from("cards").update({is_for_sale:!0,sale_price:J}).in("id",Y);if(R){o(R.message,"error");return}const S=Y.map(W=>({seller_id:r.profile.id,card_id:W,price:J,status:"active"})),{error:C}=await w.from("market_listings").insert(S);C&&console.warn("[Market] insert listings:",C.message),o(`${Y.length} carte${Y.length>1?"s":""} mise${Y.length>1?"s":""} en vente à ${J.toLocaleString("fr")} cr. chacune !`,"success"),s(),l("collection")}),(ke=document.getElementById("cancel-sell-btn"))==null||ke.addEventListener("click",async()=>{await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await w.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),l("collection")})}function Xi(e,t=""){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${c.map(g=>{const h={...g.player,_evolution_bonus:g.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                ${Ae({...h,_evolution_bonus:h._evolution_bonus||0},{width:60,showStad:!0,stadDef:l})}
        ...
        <div style="display:flex;gap:10px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:4px;align-items:center;flex-wrap:nowrap;overflow-x:auto" id="subs-list">
              ${c.map(g=>{const h={...g.player,_evolution_bonus:g.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                  ${Ae({...h,_evolution_bonus:h._evolution_bonus||0},{width:44,showStad:!0,stadDef:l})}
                  <button data-remove-sub="${g.id}"
  ...
  </div>`;const d=window.innerWidth>=900,u=e.querySelector(".deck-pc-layout"),x=e.querySelector(".deck-mobile-layout");u&&(u.style.display=d?"block":"none"),x&&(x.style.display=d?"none":"block"),go(e,t,r,i),e.querySelectorAll("#builder-back").forEach(g=>g.addEventListener("click",()=>n("decks")));const m=()=>{const{openModal:g,closeModal:h}=i,_=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;g("⚽ Choisir une formation",_),document.querySelectorAll("#modal-body [data-forma]").forEach(b=>{b.addEventListener("click",()=>{t.formation=b.dataset.forma;const $=Qi(t.formation),y={};$.forEach(j=>{t.slots[j]&&(y[j]=t.slots[j])}),t.slots=y,h(),xt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(g=>g.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(g=>g.addEventListener("click",()=>mo(t,e,i))),e.querySelectorAll("#save-deck").forEach(g=>g.addEventListener("click",()=>bo(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(g=>{g.addEventListener("click",()=>{t.subs=t.subs.filter(h=>h!==g.dataset.removeSub),xt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(g=>g.addEventListener("click",()=>yo(t,e,i)))}function go(e,t,i,n){var b,$;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(b=t.stadiumCards)==null?void 0:b.find(y=>y.id===t.stadiumCardId),s=a&&(($=t.stadDefMap)==null?void 0:$[a.stadium_id])||null,l=Jt[t.formation]||{},c=on(t.formation)||[],d={};for(const y of i){const j=t.slots[y],E=j?t.playerCards.find(F=>F.id===j):null;E!=null&&E.player?d[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:d[y]=null}const u=window.innerWidth>=900,x=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(x,860):x,f=Math.round(u?m*.82:m*.85),p=u?84:44;let g="";for(const[y,j]of c){const E=l[y],F=l[j];if(!E||!F)continue;const N=E.x*m,ne=Math.round(.03*f+E.y*.85*f),ie=F.x*m,Q=Math.round(.03*f+F.y*.85*f),U=d[y],v=d[j],I=Gt(U,v);I==="#ff3333"||I==="#cc2222"?g+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${I}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(g+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${I}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,g+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${I}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let h="";const _=Math.round(p*657/507);for(const y of i){const j=l[y];if(!j)continue;const E=d[y],F=j.x*m;j.y*f;const N=Math.round(.03*f+j.y*(.85*f)),ne=Math.round(F-p/2),ie=Math.round(N-_/2);if(E){const Q=y.replace(/\d+/,""),U=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),v=Ae({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:Q});h+=`<div style="position:absolute;left:${ne}px;top:${ie}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=v=>v.touches&&v.touches[0]?v.touches[0].clientX:v.clientX;function d(v){o||(l=!0,s.style.opacity="1",u(v))}function u(v){if(!l||o)return;const I=a.getBoundingClientRect(),G=c(v)-I.left,re=Math.max(0,Math.min(1,G/I.width));s.style.width=re*I.width+"px",re>=.82&&m()}function x(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var I;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(I=document.getElementById("cut-flash"))==null||I.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const v=document.getElementById("cut-hint");v&&(v.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",h(0)},620)}a.addEventListener("pointerdown",d),window.addEventListener("pointermove",u),window.addEventListener("pointerup",x),a.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",x);let f=0,p=!1;const g=new Set;function h(v){f=v,document.getElementById("reveal-phase").style.display="flex",_(),b(v,0),F()}function _(){const v=document.getElementById("card-dots");v&&(v.innerHTML=e.map((I,G)=>`<div class="card-dot" data-i="${G}" style="width:8px;height:8px;border-radius:50%;background:${G===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),v.querySelectorAll(".card-dot").forEach(I=>I.addEventListener("click",()=>y(parseInt(I.dataset.i)))))}function b(v,I){var R,S;const G=e[v],re=document.getElementById("card-counter"),ae=document.getElementById("card-track");re&&(re.textContent=`Carte ${v+1} / ${e.length}`);const se=document.getElementById("reveal-btns");se&&(se.style.display=v===e.length-1?"flex":"none");const de=G.card_type==="player"&&((R=G.player)==null?void 0:R.rarity)==="legende",ke=!g.has(v);g.add(v);let Y=0;if(G.card_type==="player"&&G.player){const C=G.player,D=C.job||"ATT";Y=Number(D==="GK"?C.note_g:D==="DEF"?C.note_d:D==="MIL"?C.note_m:C.note_a)||0}const J=C=>{ae.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${de?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${To(G)}</div>
        ...
        </div>`;const D=document.getElementById("current-card-wrap");I!==0?(D.style.transition="none",D.style.transform=`translateX(${I>0?100:-100}%)`,requestAnimationFrame(()=>{D.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",D.style.transform="translateX(0)"})):D.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),C||de?ne():ie(),_()};ke&&(((S=G.player)==null?void 0:S.rarity)==="legende"||Y>=8)&&G.card_type==="player"&&G.player?$(G,()=>J(!0)):J(!1)}function $(v,I){var ye;p=!0;const G=v.player,re=`https://flagsapi.com/${G.country_code}/flat/64.png`,ae=(ye=G.clubs)==null?void 0:ye.logo_url,se=G.face?"/"+G.face.replace(/^public\//,"").replace(/^\//,""):null,de=G.job||"ATT",ke=Number(de==="GK"?G.note_g:de==="DEF"?G.note_d:de==="MIL"?G.note_m:G.note_a)||0,Y=v.evolution_bonus||0,J=ke+Y,R=G.rarity==="legende",S=J>=18,C=document.getElementById("walkout-overlay"),D=document.getElementById("walkout-stage");if(!C||!D){p=!1,I();return}let W=null;R&&(W=new Audio("/sounds/Legendary.mp3"),W.volume=.8,W.play().catch(()=>{})),C.style.display="flex";const K=()=>{const be=D.firstElementChild;be&&(be.classList.remove("wo-in"),be.classList.add("wo-out"))},B=1800,O=400;D.innerHTML=`<img class="wo-in" src="${re}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(K,B),setTimeout(()=>{var be;D.innerHTML=ae?`<img class="wo-in" src="${ae}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((be=G.clubs)==null?void 0:be.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},B+O),setTimeout(K,B*2+O),setTimeout(()=>{D.innerHTML=se?`<img class="wo-in" src="${se}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(B+O)*2),setTimeout(K,(B+O)*2+B);const _e=S?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[de]||"#fff";setTimeout(()=>{D.innerHTML=`<div class="wo-in" style="
        ...
        ${J}
      </div>`,S&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(B+O)*3),setTimeout(K,(B+O)*3+B),setTimeout(()=>{C.style.display="none",D.innerHTML="",p=!1,W&&!R&&W.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),I()},(B+O)*4)}function y(v){if(p||v<0||v>=e.length||v===f)return;const I=v>f?1:-1;f=v,b(v,I)}function j(){y(f+1)}function E(){y(f-1)}function F(){const v=document.getElementById("card-viewport");if(!v||v._swipeBound)return;v._swipeBound=!0;let I=0,G=0,re=0,ae=!1;const se=R=>R.touches?R.touches[0].clientX:R.clientX,de=R=>R.touches?R.touches[0].clientY:R.clientY,ke=R=>{ae=!0,I=se(R),G=de(R),re=0},Y=R=>{if(!ae)return;re=se(R)-I;const S=de(R)-G;if(Math.abs(re)<Math.abs(S))return;const C=document.getElementById("current-card-wrap");C&&(C.style.transition="none",C.style.transform=`translateX(${re*.6}px) rotate(${re*.02}deg)`)},J=()=>{if(!ae)return;ae=!1;const R=document.getElementById("current-card-wrap"),S=55;re<=-S&&f<e.length-1?j():re>=S&&f>0?E():R&&(R.style.transition="transform .2s ease",R.style.transform="translateX(0)")};v.addEventListener("pointerdown",ke),v.addEventListener("pointermove",Y),v.addEventListener("pointerup",J),v.addEventListener("pointercancel",J),v.addEventListener("touchstart",ke,{passive:!0}),v.addEventListener("touchmove",Y,{passive:!0}),v.addEventListener("touchend",J),v.addEventListener("click",R=>{if(Math.abs(re)>8)return;const S=v.getBoundingClientRect();R.clientX-S.left>S.width/2?j():E()})}let N=null;function ne(){const v=document.getElementById("fireworks-canvas");if(!v)return;v.width=window.innerWidth,v.height=window.innerHeight;const I=v.getContext("2d"),G=[];function re(){const se=Math.random()*v.width,de=Math.random()*v.height*.6,ke=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],Y=ke[Math.floor(Math.random()*ke.length)];for(let J=0;J<60;J++){const R=Math.PI*2/60*J,S=2+Math.random()*5;G.push({x:se,y:de,vx:Math.cos(R)*S,vy:Math.sin(R)*S,alpha:1,color:Y,size:2+Math.random()*3})}}re(),N=setInterval(re,600);function ae(){if(document.getElementById("fireworks-canvas")){I.clearRect(0,0,v.width,v.height);for(let se=G.length-1;se>=0;se--){const de=G[se];if(de.x+=de.vx,de.y+=de.vy+.08,de.vy*=.98,de.alpha-=.018,de.alpha<=0){G.splice(se,1);continue}I.globalAlpha=de.alpha,I.fillStyle=de.color,I.beginPath(),I.arc(de.x,de.y,de.size,0,Math.PI*2),I.fill()}I.globalAlpha=1,(N!==null||G.length>0)&&requestAnimationFrame(ae)}}ae()}function ie(){N!==null&&(clearInterval(N),N=null);const v=document.getElementById("fireworks-canvas");v&&v.getContext("2d").clearRect(0,0,v.width,v.height)}if(n){const v=document.getElementById("reveal-btns");v&&(v.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(U=document.getElementById("reveal-next"))==null||U.addEventListener("click",()=>{ie(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ie(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ie(),r.remove(),i("boosters")})}function To(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return _o(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},l={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,d=l[o==null?void 0:o.color]||l.purple,u=(o==null?void 0:o.name)||e.gc_type||"Game Changer",x=(o==null?void 0:o.effect)||((t=wi[e.gc_type])==null?void 0:t.desc)||"",m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,f=((i=wi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${d};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${d}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),l=[...new Set((s||[]).filter(x=>{var m,f;return((m=x.card)==null?void 0:m.card_type)==="stadium"&&((f=x.card)==null?void 0:f.stadium_id)}).map(x=>x.card.stadium_id))],c={};if(l.length){const{data:x}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",l);(x||[]).forEach(m=>{c[m.id]=m}),(s||[]).forEach(m=>{var f,p;((f=m.card)==null?void 0:f.card_type)==="stadium"&&((p=m.card)!=null&&p.stadium_id)&&(m.card._stadiumDef=c[m.card.stadium_id]||null)})}let d=0;function u(){var y,j,E,F,N,ne,ie;const x=o[d],m=(s||[]).filter(Q=>Q.deck_id===x.id),f=m.filter(Q=>{var U;return Q.is_starter&&((U=Q.card)==null?void 0:U.player)}).map(Q=>ki(Q.card,Q.position)),p=m.find(Q=>{var U;return((U=Q.card)==null?void 0:U.card_type)==="formation"}),g=x.formation||((y=p==null?void 0:p.card)==null?void 0:y.formation)||"4-4-2";let h=f.length>=11?ri(f,g):null,_=((j=x.stadium_card)==null?void 0:j.stadium_def)||null;_&&h&&(h=Xt(h,_));const b=f.length>=11;nt(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <!-- Pagination -->
      ${o.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${o.map((Q,U)=>`<div style="width:6px;height:6px;border-radius:50%;background:${U===d?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
    ...
    ${ci(e,t,i,n,r,o,a,s)}
          ...
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]);c=E[0].data,u=E[0].error,d=E[1].data,x=E[1].error}catch(E){console.error("[Match] Exception chargement deck:",E),Et(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(u||x){console.error("[Match] Erreur Supabase:",u||x),Et(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const m=(d||[]).filter(E=>{var F;return E.is_starter&&((F=E.card)==null?void 0:F.player)}).map(E=>ki(E.card,E.position)),f=(d||[]).filter(E=>{var F;return!E.is_starter&&((F=E.card)==null?void 0:F.player)}).map(E=>ki(E.card,E.position));if(m.length<11){Et(e,"⚠️",`Deck incomplet (${m.length}/11).`,"Compléter",()=>o("decks"));return}const p=(d||[]).find(E=>{var F;return((F=E.card)==null?void 0:F.card_type)==="formation"}),g=(c==null?void 0:c.formation)||((j=p==null?void 0:p.card)==null?void 0:j.formation)||"4-4-2",{data:h,error:_}=await w.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:b}=await w.from("gc_definitions").select("*").eq("is_active",!0),$=(h||[]).map(E=>({...E,_gcDef:(b==null?void 0:b.find(F=>F.name===E.gc_type||F.id===E.gc_definition_id))||null}));let y=null;if(c!=null&&c.stadium_card_id){const{data:E}=await w.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if(E!=null&&E.stadium_id){const{data:F}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",E.stadium_id).single();y=F||null}}n({deckId:l,formation:g,starters:m,subsRaw:f,gcCardsEnriched:$,gcDefs:b||[],stadiumDef:y})}function Lt(){return Math.min(window.innerWidth-40,860)}function qt(){return Math.round(Lt()*1.1)}function wn(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:Wt(e)}}function qo(e,t,i,n="Adversaire"){const r=Lt(),o=qt();return`
    ...
    </div>`}function _n(e){var o,a,s;if(!e)return"";const t=l=>l?Ae({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Gt(o,e[a+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return kn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
    ...
    </div>`}async function Fo(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await pi(e,t,r,async({deckId:s,formation:l,starters:c,subsRaw:d,gcCardsEnriched:u,gcDefs:x,stadiumDef:m})=>{try{let f=ri(c,l);m&&(f=Xt(f,m),oi(d,m));const p=await Po(l,o),g=p.lines||p,h=async _=>{try{const b=a==="vs_ai_club"?"club":a,{data:$,error:y}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:b,home_deck_id:s,status:"in_progress"}).select().single();if(y){console.error("[MatchIA] Erreur création match:",y),Et(e,"⚠️","Impossible de créer le match ("+y.message+").","Retour",()=>t.navigate("home"));return}const j=p.stadiumDef||null;j&&g&&(Xt(g,j),oi(p.subs||[],j));const E={gcDefs:x||[],matchId:$==null?void 0:$.id,mode:a,difficulty:o,formation:l,homeTeam:f,aiTeam:g,homeSubs:d,subsUsed:0,maxSubs:Math.min(d.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:j,homeScore:0,aiScore:0,gcCards:_,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Ro(e,E,t)}catch(b){console.error("[MatchIA] Exception launchMatch:",b),Et(e,"⚠️","Erreur au lancement du match : "+b.message,"Retour",()=>t.navigate("home"))}};if(!u.length){h([]);return}li(e,u,h)}catch(f){console.error("[MatchIA] Exception setup:",f),Et(e,"⚠️","Erreur de préparation du match : "+f.message,"Retour",()=>t.navigate("home"))}})}async function Po(e,t){var g;const{data:i}=await w.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Go(e),subs:[],gcCards:[],stadiumDef:null};const n=Ft[e]||Ft["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(h,_,b){var $,y;return o.add(h.id),{cardId:"ai-"+h.id+"-"+b,id:h.id,firstname:h.firstname,name:h.surname_real,country_code:h.country_code,club_id:h.club_id,job:h.job,job2:h.job2,note_g:Number(h.note_g)||0,note_d:Number(h.note_d)||0,note_m:Number(h.note_m)||0,note_a:Number(h.note_a)||0,rarity:h.rarity,skin:h.skin,hair:h.hair,hair_length:h.hair_length,clubName:(($=h.clubs)==null?void 0:$.encoded_name)||null,clubLogo:((y=h.clubs)==null?void 0:y.logo_url)||null,boost:0,used:!1,_line:_}}for(const h of["GK","DEF","MIL","ATT"]){const _=i.filter(E=>E.job===h&&!o.has(E.id)),b=i.filter(E=>E.job!==h&&!o.has(E.id)),$=[..._,...b],y=[];for(let E=0;E<n[h];E++){const F=$[E];F&&y.push(a(F,h,E))}const j=pt(y.length);y.forEach((E,F)=>{E._col=j[F]}),r[h]=y}const l=i.filter(h=>!o.has(h.id)).slice(0,5).map((h,_)=>a(h,h.job,100+_)),u=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((h,_)=>{var b,$;return{id:"ai-gc-"+_,gc_type:h,name:((b=Me[h])==null?void 0:b.name)||h,icon:(($=Me[h])==null?void 0:$.icon)||"⚡"}}),x=Object.values(r).flat(),m={};x.forEach(h=>{h.club_id&&(m[h.club_id]=(m[h.club_id]||0)+1)});const f=(g=Object.entries(m).sort((h,_)=>_[1]-h[1])[0])==null?void 0:g[0];let p=null;if(f){const{data:h}=await w.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",f).single();h&&(p={club_id:h.id,country_code:null,name:h.encoded_name+" Stadium",club:{encoded_name:h.encoded_name,logo_url:h.logo_url}})}return{lines:r,subs:l,gcCards:u,stadiumDef:p}}function Go(e){const t=Ft[e]||Ft["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<t[o];l++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=pt(a.length);a.forEach((l,c)=>{l._col=s[c]}),i[o]=a}return i}function Ro(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const I=t.pendingAttack;let G="";if(t.selected.length>0){const re=t.selected.map(se=>({...(t.homeTeam[se._role]||[]).find(ke=>ke.cardId===se.cardId)||se,_line:se._role})),ae=Yt(re,t.modifiers.home);G=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Ye((I.players||[]).map(re=>({...re,used:!1})),"#ff6b6b",I.total,"attack")}</div>
            ${G}
            ...
            <div style="display:flex;justify-content:center">${Ye((I.players||[]).map(G=>({...G,used:!1})),"#00ff88",I.total,"attack")}</div>
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const I=t.selected.map(re=>{const ae=(t.homeTeam[re._role]||[]).find(de=>de.cardId===re.cardId)||re,se=["GK","DEF"].includes(re._role);return{...ae,_line:re._role,...se?{note_a:Math.max(1,Number(ae.note_a)||0)}:{}}}),G=Vt(I,t.modifiers.home);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Ye(I.map(re=>({...re,used:!1})),"#FFD700",G.total,"attack")}</div>
    ...
    ${(()=>{const v=window.innerWidth>=700,I=(R,S,C)=>{var ge,Be;const D=(t.gcDefs||[]).find(je=>je.name===R.gc_type),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[D==null?void 0:D.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",K={purple:"#b06ce0",light_blue:"#00d4ef"}[D==null?void 0:D.color]||"#b06ce0",B=(D==null?void 0:D.name)||R.gc_type,O=(D==null?void 0:D.effect)||((ge=Me[R.gc_type])==null?void 0:ge.desc)||"",we=D!=null&&D.image_url?`/icons/${D.image_url}`:null,_e=((Be=Me[R.gc_type])==null?void 0:Be.icon)||"⚡",ye=Math.round(C*.22),be=Math.round(C*.22),$e=C-ye-be,Le=B.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${S}px;height:${C}px;border-radius:10px;border:2px solid ${K};background:${W};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${ye}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Le}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${S-6}px">${B}</span>
        ...
        </div>`},G=(R,S)=>{var C;return`<div id="boost-card"
  ...
  <div id="match-history-panel">
    ...
    </div>`,document.body.appendChild(m),(f=m.querySelector("#gc-back"))==null||f.addEventListener("click",()=>m.remove()),(p=m.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{m.remove(),Jo(e,t,i,n,r)})}function ti(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function l(){var c,d;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(u=>{const x=u._line||u.job||"MIL",m=s.find(p=>p.cardId===u.cardId),f=Ae({...u,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:u.boost||0});return`<div class="gc-pick-item" data-cid="${u.cardId}"
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Ee(e,t,i)})})}async function Dt(e,t,i){var d,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=Qn(t.mode,a);t.matchId&&await w.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await w.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${ci(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=e=>wn(e);async function zt(e,t,i,n,r={}){return En(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function er(e,t,i){const{data:n}=await w.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;return En(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,null,null)}async function En(e,t,i,n,r=[],o=[],a=!1,s=null,l=null,c=null,d=null,u=null){const{state:x,navigate:m,toast:f}=t,p=n?"p1":"p2",g=n?"p2":"p1",h=(r||[]).map(k=>k.id),_=(r||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:b}=await w.from("matches").select("*").eq("id",i).single();if(!b){f("Match introuvable","error"),m("home");return}async function $(){var me,xe;console.log("[PvP] buildGameState match:",{id:b.id,home_deck_id:b.home_deck_id,away_deck_id:b.away_deck_id,mode:b.mode,is_ranked:b.is_ranked});const[{data:k,error:L},{data:z,error:A},{data:T},{data:M}]=await Promise.all([w.rpc("get_deck_for_match",{p_deck_id:b.home_deck_id}),w.rpc("get_deck_for_match",{p_deck_id:b.away_deck_id}),w.from("users").select("id,pseudo,club_name").eq("id",b.home_id).single(),w.from("users").select("id,pseudo,club_name").eq("id",b.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",A==null?void 0:A.message,"p1D:",(me=k==null?void 0:k.starters)==null?void 0:me.length,"p2D:",(xe=z==null?void 0:z.starters)==null?void 0:xe.length);const q=te=>{const Te=Number(te.evolution_bonus)||0;return{cardId:te.card_id,position:te.position,id:te.id,firstname:te.firstname,name:te.surname_real,country_code:te.country_code,club_id:te.club_id,job:te.job,job2:te.job2,note_g:(Number(te.note_g)||0)+(te.job==="GK"||te.job2==="GK"&&Number(te.note_g)>0?Te:0),note_d:(Number(te.note_d)||0)+(te.job==="DEF"||te.job2==="DEF"&&Number(te.note_d)>0?Te:0),note_m:(Number(te.note_m)||0)+(te.job==="MIL"||te.job2==="MIL"&&Number(te.note_m)>0?Te:0),note_a:(Number(te.note_a)||0)+(te.job==="ATT"||te.job2==="ATT"&&Number(te.note_a)>0?Te:0),evolution_bonus:Te,rarity:te.rarity,skin:te.skin,hair:te.hair,hair_length:te.hair_length,face:te.face||null,clubName:te.club_encoded_name||null,clubLogo:te.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},P=((k==null?void 0:k.starters)||[]).map(te=>q(te)),X=((z==null?void 0:z.starters)||[]).map(te=>q(te)),V=(k==null?void 0:k.formation)||"4-4-2",oe=(z==null?void 0:z.formation)||"4-4-2";let Z=ri(P,V),H=ri(X,oe);const le=((k==null?void 0:k.subs)||[]).map(te=>q(te)),pe=((z==null?void 0:z.subs)||[]).map(te=>q(te)),ue=(k==null?void 0:k.stadium_def)||(n?l:null),ce=(z==null?void 0:z.stadium_def)||(n?null:l);return ue&&(Z=Xt(Z,ue),oi(le,ue)),ce&&(H=Xt(H,ce),oi(pe,ce)),{p1Team:Z,p2Team:H,p1Subs:le,p2Subs:pe,p1Formation:V,p2Formation:oe,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(M==null?void 0:M.club_name)||(M==null?void 0:M.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?h:[],gc_p2:n?[]:h,gcCardsFull_p1:n?_:[],gcCardsFull_p2:n?[]:_,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let y=b.game_state&&Object.keys(b.game_state).length?b.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!y,"match.status:",b.status,"home_id:",b.home_id,"away_id:",b.away_id,"myId:",x.profile.id),!y)if(n){y=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((y==null?void 0:y.p1Team)||{}));const{data:k}=await w.from("matches").select("game_state").eq("id",i).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await w.from("matches").update({game_state:y,turn_user_id:b.home_id}).eq("id",i):y=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let k=0;k<30&&!y;k++){await new Promise(z=>setTimeout(z,400));const{data:L}=await w.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(y=L.game_state),k%5===0&&console.log("[PvP] away - poll",k,"game_state:",!!(L!=null&&L.game_state))}if(!y){f("Erreur de synchronisation","error"),m("home");return}y.gc_p2=h,y.gcCardsFull_p2=_,await w.from("matches").update({game_state:y}).eq("id",i)}let j=!1,E=null,F=!1;const N=new Set,ne=new Set;async function ie(k){var oe,Z;try{w.removeChannel(Q)}catch{}const L=y[p+"Score"]||0,z=y[g+"Score"]||0;let A,T;k.winner_id?(A=k.winner_id===x.profile.id,T=!1):k.forfeit?(A=L>z,T=!1):(T=L===z,A=L>z);let M="";if(a&&n)try{const{data:H}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",b.home_id).single(),{data:le}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",b.away_id).single();if(H&&le){const pe=A?1:T?.5:0,ue=1-pe,ce=H.placement_matches<10,me=le.placement_matches<10,xe=computeGlicko2(H.mmr,H.mmr_deviation,H.mmr_volatility,le.mmr,le.mmr_deviation,pe===1?1:pe===0?0:.5,ce),te=computeGlicko2(le.mmr,le.mmr_deviation,le.mmr_volatility,H.mmr,H.mmr_deviation,ue===1?1:ue===0?0:.5,me);await w.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:A?b.home_id:b.away_id,p_home_id:b.home_id,p_away_id:b.away_id,p_home_delta:xe.delta,p_away_delta:te.delta,p_home_new_rd:xe.newRd,p_away_new_rd:te.newRd,p_home_new_vol:xe.newSigma,p_away_new_vol:te.newSigma});const Te=xe.delta,Fe=xe.newMmr,Ie=getTier(Fe),He=Te>=0?"+":"",It=Te>=0?"#4caf50":"#ff6b6b",Je=getTier(H.mmr);M=`
            ...
            </div>`}}catch(H){console.error("[Ranked] MMR update error:",H)}(oe=document.getElementById("pvp-end-overlay"))==null||oe.remove();const q=document.createElement("div");q.id="pvp-end-overlay",q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const P=T?"🤝":A?"🏆":"😞",X=T?"MATCH NUL":A?"VICTOIRE !":"DÉFAITE",V=T?"#fff":A?"#FFD700":"#ff6b6b";q.innerHTML=`
      ...
      ${M}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(Z=q.querySelector("#pvp-end-home"))==null||Z.addEventListener("click",()=>{q.remove(),We(e),m(a?"ranked":"home")})}const Q=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(j)return;j=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),ie(L);return}if(L.game_state){const z=y;y=L.game_state;const A=y._lastGC;if(A&&A.seq&&!ne.has(A.seq)&&(ne.add(A.seq),A.by!==p)){R(A.type,A.by,()=>de());return}const T=z[p+"Score"]||0,M=z[g+"Score"]||0,q=y[p+"Score"]||0,P=y[g+"Score"]||0,X=q>T,V=P>M;if((X||V)&&!N.has(y.round)){N.add(y.round);const oe=[...y.log||[]].reverse().find(H=>H.isGoal),Z=((oe==null?void 0:oe.homePlayers)||[]).map(H=>({name:H.name,note:H.note,portrait:H.portrait,job:H.job}));ot(Z,q,P,X,()=>de());return}de()}}catch(z){console.error("[PvP] crash:",z)}}).subscribe();async function U(k){Object.assign(y,k),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{de()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function v(){if(j)return;j=!0,E&&(clearInterval(E),E=null);const k=n?b.away_id:b.home_id,L=n?"p2":"p1",z=n?"p1":"p2",A={...y,[L+"Score"]:3,[z+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:A.p1Score||0,away_score:A.p2Score||0,game_state:A}).eq("id",i)}catch{}try{w.removeChannel(Q)}catch{}setTimeout(()=>{We(e),m("home")},800)}const I={BOOST_STAT:({value:k=1,count:L=1,roles:z=[]},A,T)=>{const M=A[p+"Team"],q=Object.entries(M).filter(([P])=>!z.length||z.includes(P)).flatMap(([P,X])=>X.filter(V=>!V.used).map(V=>({...V,_line:P})));if(!q.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(A);return}G(q,L,`Choisir ${L} joueur(s) à booster (+${k})`,P=>{P.forEach(X=>{const V=(M[X._line]||[]).find(oe=>oe.cardId===X.cardId);V&&(V.boost=(V.boost||0)+k,A.log.push({text:`⚡ +${k} sur ${V.name}`,type:"info"}))}),A[p+"Team"]=M,T(A)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:z=[],target:A="ai"},T,M)=>{const q=A==="home"?p:g,P=T[q+"Team"],X=A==="home"?"allié":"adverse",V=Object.entries(P).filter(([oe])=>!z.length||z.includes(oe)).flatMap(([oe,Z])=>Z.map(H=>({...H,_line:oe})));if(!V.length){T.log.push({text:`🎯 Aucun joueur ${X}`,type:"info"}),M(T);return}G(V,L,`Choisir ${L} joueur(s) ${X}(s) (-${k})`,oe=>{oe.forEach(Z=>{const H=(P[Z._line]||[]).find(le=>le.cardId===Z.cardId);H&&(H.boost=(H.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${H.name}`,type:"info"}))}),T[q+"Team"]=P,M(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:z="ai"},A,T)=>{const M=z==="home"?p:g,q=A[M+"Team"],P=z==="home"?"allié":"adverse",X=Object.entries(q).filter(([V])=>!L.length||L.includes(V)).flatMap(([V,oe])=>oe.filter(Z=>!Z.used).map(Z=>({...Z,_line:V})));if(!X.length){A.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),T(A);return}G(X,k,`Choisir ${k} joueur(s) ${P}(s) à exclure`,V=>{const oe="usedCardIds_"+M,Z=new Set(A[oe]||[]);V.forEach(H=>{const le=(q[H._line]||[]).find(pe=>pe.cardId===H.cardId);le&&(le.used=!0,Z.add(H.cardId),A.log.push({text:`❌ ${le.name} exclu !`,type:"info"}))}),A[oe]=[...Z],A[M+"Team"]=q,T(A)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},z,A)=>{const T=z[p+"Team"],M=Object.entries(T).filter(([q])=>!L.length||L.includes(q)).flatMap(([q,P])=>P.filter(X=>X.used).map(X=>({...X,_line:q})));if(!M.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(z);return}G(M,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const X=(T[P._line]||[]).find(V=>V.cardId===P.cardId);X&&(X.used=!1,z.log.push({text:`💫 ${X.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=T,A(z)})},REMOVE_GOAL:({},k,L)=>{const z=g+"Score";k[z]>0?(k[z]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[g+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,z)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),z(L)},CUSTOM:({},k,L)=>L(k)};function G(k,L,z,A){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let M=[];function q(){var X,V;const P=k.map(oe=>{const Z=oe._line||oe.job||"MIL",H=M.find(pe=>pe.cardId===oe.cardId),le=Ae({...oe,_evolution_bonus:0},{width:90,showStad:!0,role:Z,extraNote:oe.boost||0});return`<div class="pp-item" data-cid="${oe.cardId}"
        ...
        </div>`,(X=T.querySelector("#pp-close"))==null||X.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(oe=>{oe.addEventListener("click",()=>{const Z=oe.dataset.cid,H=k.find(pe=>pe.cardId===Z),le=M.findIndex(pe=>pe.cardId===Z);H&&(le>-1?M.splice(le,1):M.length<L&&M.push(H),q())})}),(V=T.querySelector("#pp-confirm"))==null||V.addEventListener("click",()=>{T.remove(),A(M)})}q(),document.body.appendChild(T)}async function re(k,L){const A=(y["gcCardsFull_"+p]||[]).find(P=>P.id===k),T=(A==null?void 0:A._gcDef)||(y.gcDefs||[]).find(P=>{var X;return P.name===L||((X=P.name)==null?void 0:X.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),M=[...y["usedGc_"+p]||[],k],q={type:L,by:p,seq:(y._gcAnimSeq||0)+1};ne.add(q.seq),R(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const X=I[T.effect_type];if(X){const V={...y};X(T.effect_params||{},V,async oe=>{oe["usedGc_"+p]=M,oe._lastGC=q,oe._gcAnimSeq=q.seq,await U(oe)});return}}const P={...y};switch(L){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const X=g+"Score";P[X]>0&&(P[X]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=M,P._lastGC=q,P._gcAnimSeq=q.seq,await U(P)})}function ae(k,L){const z="usedCardIds_"+k,A=new Set(y[z]||[]);L.forEach(T=>A.add(T)),y[z]=[...A]}function se(){for(const k of["p1","p2"]){const L=new Set(y["usedCardIds_"+k]||[]),z=y[k+"Team"];if(z)for(const A of["GK","DEF","MIL","ATT"])(z[A]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function de(){var at,st,vt,Fi,Pi,Gi;if(y.phase==="reveal")return ke();if(y.phase==="midfield")return J();if(y.phase==="finished")return Rt();const k=y[p+"Team"];y[g+"Team"],se();const L=y[p+"Score"],z=y[g+"Score"],A=y[p+"Name"],T=y[g+"Name"],M=y.phase===p+"-attack",q=y.phase===p+"-defense",P=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],X=P.map(ee=>ee.cardId),V=window.innerWidth>=700,oe=y[p+"Subs"]||[],Z=y["usedSubIds_"+p]||[],H=oe.filter(ee=>!Z.includes(ee.cardId)),le=y["gcCardsFull_"+p]||[],pe=y["usedGc_"+p]||[],ue=le.filter(ee=>!pe.includes(ee.id)),ce=y.boostOwner===p&&!y.boostUsed,me=[...k.MIL||[],...k.ATT||[]].filter(ee=>!ee.used),xe=M&&me.length===0?[...k.GK||[],...k.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function te(ee,fe,ze){var Mt,lt;const he=ee._gcDef,At={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",et={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",De=(he==null?void 0:he.name)||ee.gc_type,Ne=(he==null?void 0:he.effect)||((Mt=Me[ee.gc_type])==null?void 0:Mt.desc)||"",Se=he!=null&&he.image_url?`/icons/${he.image_url}`:null,wt=((lt=Me[ee.gc_type])==null?void 0:lt.icon)||"⚡",Pe=Math.round(ze*.22),dt=Math.round(ze*.22),tt=ze-Pe-dt,St=De.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
        style="box-sizing:border-box;width:${fe}px;height:${ze}px;border-radius:10px;border:2px solid ${et};background:${At};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${Pe}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${St}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${fe-6}px">${De}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${tt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Se?`<img src="${Se}" style="max-width:${fe-10}px;max-height:${tt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(tt*.55)}px">${wt}</span>`}
        </div>
      ...
      </div>`}const Fe=(ee,fe)=>fe?Te(130,175):te(ee,130,175),Ie=(ee,fe)=>fe?Te(68,95):te(ee,68,95),He=V?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",It=M?je(p)?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${P.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${He};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:q?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${P.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${T}</div>`,Je=M&&!je(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':M||q?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${P.length}/3 sélectionné(s)</div>`:"",Qt=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${V?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
    ...
    </div>`,qe=M?"attack":q?"defense":"idle",Qe=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Pt(k,y[p+"Formation"],qe,X,V?1300:Lt(),V?600:qt(),xe)}
      </div>
    </div>`,Re=y[p+"Team"],ht=(()=>{var fe,ze,he,At,et;if(q&&((fe=y.pendingAttack)!=null&&fe.players)){const De=y.pendingAttack;let Ne="";if(P.length>0){const Se=P.map(Pe=>{const dt=(Re[Pe._role]||[]).find(fi=>fi.cardId===Pe.cardId)||Pe,tt=Re[Pe._role]||[],St=tt.findIndex(fi=>fi.cardId===Pe.cardId),Mt=pt(tt.length),lt=St>=0?Mt[St]:dt._col??1;return{...dt,_line:Pe._role,_col:lt}}),wt=Yt(Se,((ze=y.modifiers)==null?void 0:ze[p])||{});Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Ye(Se.map(Pe=>({...Pe,used:!1})),"#3a7bd5",wt.total,"defense")}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye((De.players||[]).map(Se=>({...Se,used:!1})),"#ff6b6b",De.total,"attack")}</div>
          ${Ne}
        </div>`}if(M&&((he=y.pendingAttack)!=null&&he.players)){const De=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Ye((De.players||[]).map(Ne=>({...Ne,used:!1})),"#00ff88",De.total,"attack")}</div>
        </div>`}if(M&&!((At=y.pendingAttack)!=null&&At.players)&&P.length>0){const De=P.map(Se=>{const wt=(Re[Se._role]||[]).find(lt=>lt.cardId===Se.cardId)||Se,Pe=["GK","DEF"].includes(Se._role),dt=Re[Se._role]||[],tt=dt.findIndex(lt=>lt.cardId===Se.cardId),St=pt(dt.length),Mt=tt>=0?St[tt]:wt._col??1;return{...wt,_line:Se._role,_col:Mt,...Pe?{note_a:Math.max(1,Number(wt.note_a)||0)}:{}}}),Ne=Vt(De,((et=y.modifiers)==null?void 0:et[p])||{});return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye(De.map(Se=>({...Se,used:!1})),"#FFD700",Ne.total,"attack")}</div>
      ...
      </div>`;function Ue(){const ee=e.querySelector(".match-screen");if(!ee)return;const fe=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ee.style.height=fe+"px",ee.style.minHeight=fe+"px",ee.style.maxHeight=fe+"px",ee.style.overflow="hidden";const ze=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");ze&&he&&(he.style.paddingBottom=ze.offsetHeight+"px")}if(Ue(),setTimeout(Ue,120),setTimeout(Ue,400),F||(F=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Ue),window.visualViewport.addEventListener("scroll",Ue)),window.addEventListener("resize",Ue)),function(){const fe=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!fe)return;const ze=fe.closest("#match-terrain-wrap");ze&&(ze.style.cssText="position:relative;width:100%;height:100%;padding:0"),fe.removeAttribute("width"),fe.removeAttribute("height"),fe.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",fe.setAttribute("preserveAspectRatio","xMidYMid meet")}(),y._pvpResizeBound||(y._pvpResizeBound=!0,window.addEventListener("resize",()=>{const ee=e.querySelector(".terrain-wrapper svg");if(ee){const fe=ee.closest("#match-terrain-wrap");fe&&(fe.style.cssText="position:relative;width:100%;height:100%;padding:0"),ee.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(ee=>{ee.addEventListener("click",()=>{if(!M&&!q)return;const fe=ee.dataset.cardId,ze=ee.dataset.role,he=(k[ze]||[]).find(Ne=>Ne.cardId===fe);if(!he||he.used)return;const At=xe.includes(fe);if(M&&!["MIL","ATT"].includes(ze)&&!At)return;Array.isArray(y["selected_"+p])||(y["selected_"+p]=[]);const et=y["selected_"+p],De=et.findIndex(Ne=>Ne.cardId===fe);De>-1?et.splice(De,1):et.length<3&&et.push({...he,_role:ze}),de()})}),e.querySelectorAll(".match-used-hit").forEach(ee=>{ee.addEventListener("click",()=>D(ee.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ee=>{ee.addEventListener("click",()=>D())}),(at=e.querySelector("#pvp-sub-open"))==null||at.addEventListener("click",()=>D()),e.querySelectorAll(".pvp-gc-mini").forEach(ee=>{M?ee.addEventListener("click",()=>S(ee.dataset.gcId,ee.dataset.gcType)):(ee.style.opacity="0.35",ee.style.cursor="default",ee.addEventListener("click",()=>_t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(st=e.querySelector("#pvp-boost-card"))==null||st.addEventListener("click",()=>C()),(vt=e.querySelector("#pvp-action"))==null||vt.addEventListener("click",ee=>{M?ee.currentTarget.dataset.pass==="1"||!je(p)?O():be():q&&$e()}),(Fi=e.querySelector("#pvp-quit"))==null||Fi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&v()}),(Pi=e.querySelector("#pvp-view-opp"))==null||Pi.addEventListener("click",()=>K()),(Gi=e.querySelector("#pvp-toggle-history"))==null||Gi.addEventListener("click",()=>B()),E&&(clearInterval(E),E=null),(M||q)&&!j){let ee=30,fe=!1;const ze=()=>document.getElementById("pvp-timer"),he=()=>{ze()&&(ze().textContent=ee+"s",ze().style.color=fe?"#ff4444":"#fff")};he(),E=setInterval(()=>{ee--,ee<0?fe?(clearInterval(E),E=null,M&&!je(p)?O():v()):(fe=!0,ee=15,he()):he()},1e3)}}function ke(){nt(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(H);let le=!1;const pe=()=>{le||(le=!0,H.remove(),setTimeout(()=>z&&z(),50))};H.addEventListener("click",pe),setTimeout(pe,3e3)}function S(k,L){var H,le,pe,ue;const A=(y["gcCardsFull_"+p]||[]).find(ce=>ce.id===k),T=A==null?void 0:A._gcDef,M={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",q={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",P=(T==null?void 0:T.name)||L,X=(T==null?void 0:T.effect)||((H=Me[L])==null?void 0:H.desc)||"Carte spéciale.",V=T!=null&&T.image_url?`/icons/${T.image_url}`:null,oe=((le=Me[L])==null?void 0:le.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${q};background:${M};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${q}66">
        <div style="padding:10px;background:rgba(255,255,255,0.14);text-align:center">
      ...
      </div>`,document.body.appendChild(Z),(pe=Z.querySelector("#pvp-gc-back"))==null||pe.addEventListener("click",()=>Z.remove()),(ue=Z.querySelector("#pvp-gc-use"))==null||ue.addEventListener("click",()=>{Z.remove(),re(k,L)})}function C(){var A;const k=y[p+"Team"],L=Object.entries(k).flatMap(([T,M])=>(M||[]).filter(q=>!q.used).map(q=>({...q,_line:T})));if(!L.length)return;const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",z.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(T=>{const M={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",q=Ge(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${M};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(z),(A=z.querySelector("#bp-close"))==null||A.addEventListener("click",()=>z.remove()),z.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const M=T.dataset.cid,q=L.find(X=>X.cardId===M);if(!q)return;const P=(k[q._line]||[]).find(X=>X.cardId===M);P&&(P.boost=(P.boost||0)+y.boostValue),z.remove(),await U({[p+"Team"]:k,boostUsed:!0})})})}function D(k=null){var le,pe;if(!(y.phase===p+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const z=y[p+"Team"],A=y["usedSubIds_"+p]||[],T=y.maxSubs||3;if(A.length>=T){f(`Maximum ${T} remplacements atteint`,"warning");return}const M=Object.entries(z).flatMap(([ue,ce])=>(ce||[]).filter(me=>me.used).map(me=>({...me,_line:ue}))),q=(y[p+"Subs"]||[]).filter(ue=>!A.includes(ue.cardId));if(!M.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!q.length){f("Aucun remplaçant disponible","warning");return}let P=Math.max(0,M.findIndex(ue=>ue.cardId===k));const X=((le=M[P])==null?void 0:le._line)||((pe=M[P])==null?void 0:pe.job);let V=Math.max(0,q.findIndex(ue=>ue.job===X)),oe=!1;const Z=document.createElement("div");Z.id="pvp-sub-overlay",Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function H(){var Fe,Ie,He,It,Je,Qt;const ue=M[P],ce=q[V],me=Math.min(130,Math.round((window.innerWidth-90)/2)),xe=Math.round(me*1.35),te=qe=>`background:rgba(255,255,255,0.12);border:none;color:${qe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${qe?"default":"pointer"};flex-shrink:0`;Z.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <button id="pin-down" style="${te(V>=q.length-1)}" ${V>=q.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${V+1}/${q.length}</div>
        </div>
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <button id="pout-down" style="${te(P>=M.length-1)}" ${P>=M.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${P+1}/${M.length}</div>
        </div>
      </div>
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(Fe=Z.querySelector("#psub-close"))==null||Fe.addEventListener("click",()=>Z.remove()),(Ie=Z.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{P>0&&(P--,H())}),(He=Z.querySelector("#pout-down"))==null||He.addEventListener("click",()=>{P<M.length-1&&(P++,H())}),(It=Z.querySelector("#pin-up"))==null||It.addEventListener("click",()=>{V>0&&(V--,H())}),(Je=Z.querySelector("#pin-down"))==null||Je.addEventListener("click",()=>{V<q.length-1&&(V++,H())});const Te=(qe,Qe,Re,ht)=>{const Ze=Z.querySelector("#"+qe);if(!Ze)return;let Ue=0;Ze.addEventListener("touchstart",at=>{Ue=at.touches[0].clientY},{passive:!0}),Ze.addEventListener("touchend",at=>{const st=at.changedTouches[0].clientY-Ue;if(Math.abs(st)<30)return;const vt=Qe();st<0&&vt<ht-1?(Re(vt+1),H()):st>0&&vt>0&&(Re(vt-1),H())},{passive:!0})};Te("pin-panel",()=>V,qe=>V=qe,q.length),Te("pout-panel",()=>P,qe=>P=qe,M.length),(Qt=Z.querySelector("#psub-confirm"))==null||Qt.addEventListener("click",async qe=>{if(qe.preventDefault(),qe.stopPropagation(),oe)return;oe=!0;const Qe=M[P],Re=q[V];if(!Qe||!Re)return;const ht=Qe._line,Ze=(z[ht]||[]).findIndex(st=>st.cardId===Qe.cardId);if(Ze===-1){f("Erreur : joueur introuvable","error"),Z.remove();return}const Ue={...Re,_line:ht,position:Qe.position,used:!1,boost:0};z[ht].splice(Ze,1,Ue);const at=[...A,Re.cardId];Z.remove(),W(Qe,Re,async()=>{await U({[p+"Team"]:z,[g+"Team"]:y[g+"Team"],["usedSubIds_"+p]:at})})})}document.body.appendChild(Z),H()}function W(k,L,z){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const M=(X,V,oe)=>`<div style="text-align:center">
      ...
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(k),(L=k.querySelector("#pvp-opp-close"))==null||L.addEventListener("click",()=>k.remove())}function B(){var z;const k=y.log||[],L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",L.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(z=L.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>L.remove())}async function O(){if(y.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(y.round||0)+1,z=[...y.log||[]];z.push({type:"info",text:`⏭️ ${y[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=Oe(y),T=je(k),M=A||!T?"finished":k+"-attack";await U({["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:M,attacker:k,round:L,log:z}),M==="finished"&&await Xe(y)}function we(k){const L=(k.GK||[]).some(A=>!A.used),z=["DEF","MIL","ATT"].some(A=>(k[A]||[]).some(T=>!T.used));return L&&!z}function _e(k){return(k.p1Score||0)!==(k.p2Score||0)?null:we(k.p1Team)&&!ge(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(L=>!L.used)}:we(k.p2Team)&&!ge(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(L=>!L.used)}:null}async function ye(k,L){const{side:z,gk:A}=k;if(!A)return;const T=z+"Score",M=(L[T]||0)+1;A.used=!0;const q=[...L.log||[]];q.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[jt(A)]:[],aiPlayers:z==="p2"?[jt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[z+"Name"]} marque !`});const P=(L.round||0)+1,X=z==="p1"?"p2":"p1",V={...L,[T]:M},oe=Oe(V);N.add(P);const Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(Z);const H=(ue,ce)=>new Promise(me=>{Z.innerHTML=`<div style="font-size:32px;font-weight:900;color:${ce};letter-spacing:2px;animation:lcFade 1.4s ease both">${ue}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(me,1400)});await H("⚽ DERNIER CORNER","#FFD700"),await H("🧤 LE GARDIEN MONTE !","#4fc3f7"),Z.remove();const le=z===p?M:L[p+"Score"]||0,pe=z===p?L[g+"Score"]||0:M;ot([jt(A)],le,pe,z===p,async()=>{await U({[T]:M,log:q,round:P,pendingAttack:null,phase:oe?"finished":X+"-attack",attacker:X,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}}}),oe&&await Xe({...y,[T]:M})})}async function be(){const k=y[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(M=>(y[g+"Team"][M]||[]).some(q=>!q.used)),z=(y["selected_"+p]||[]).map(M=>{const q=(k[M._role]||[]).find(pe=>pe.cardId===M.cardId)||M,P=["GK","DEF"].includes(M._role),X=k[M._role]||[],V=X.findIndex(pe=>pe.cardId===M.cardId),oe=pt(X.length),Z=V>=0?oe[V]:q._col??1,H=y.stadiumDef||y.homeStadiumDef||null,le=q.stadiumBonus||H&&(H.club_id&&String(q.club_id)===String(H.club_id)||H.country_code&&q.country_code===H.country_code)||!1;return{...q,_line:M._role,_col:Z,stadiumBonus:le,...P?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!z.length)return;const A=Vt(z,y.modifiers[p]||{});ae(p,z.map(M=>M.cardId)),z.forEach(M=>{const q=(k[M._role]||[]).find(P=>P.cardId===M.cardId);q&&(q.used=!0)}),y["selected_"+p]=[],de();const T=[...y.log||[]];if(L){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(y.p1Score||0)===(y.p2Score||0)){await ye({side:p,gk:z[0]},{...y,[p+"Team"]:k,log:T});return}const q=(y[p+"Score"]||0)+1,P=z.map(H=>jt(H));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:A.total,aiTotal:0});const X=(y.round||0)+1,V=p==="p1"?"p2":"p1",oe={...y,[p+"Team"]:k,[p+"Score"]:q},Z=Oe(oe);N.add(X),ot(P,q,y[g+"Score"]||0,!0,async()=>{await U({[p+"Team"]:k,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":V+"-attack",attacker:V,round:X,log:T}),Z&&await Xe({...y,[p+"Score"]:q})});return}T.push({type:"pending",text:`⚔️ ${y[p+"Name"]} attaque (${A.total})`}),await U({[p+"Team"]:k,[g+"Team"]:y[g+"Team"],pendingAttack:{...A,players:z,side:p},["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},phase:g+"-defense",log:T})}async function $e(){const k=y[p+"Team"],L=(y["selected_"+p]||[]).map(ce=>{const me=(k[ce._role]||[]).find(Ie=>Ie.cardId===ce.cardId)||ce,xe=k[ce._role]||[],te=xe.findIndex(Ie=>Ie.cardId===ce.cardId),Te=pt(xe.length),Fe=te>=0?Te[te]:me._col??1;return{...me,_line:ce._role,_col:Fe}}),z=Yt(L,y.modifiers[p]||{});ae(p,L.map(ce=>ce.cardId)),L.forEach(ce=>{const me=(k[ce._role]||[]).find(xe=>xe.cardId===ce.cardId);me&&(me.used=!0)}),y["selected_"+p]=[],de();const A=ji(y.pendingAttack.total,z.total,y.modifiers[p]||{}),T=y.pendingAttack.side,M=A==="attack"||(A==null?void 0:A.goal),q=T==="p1"?"p2":"p1",P=(y.round||0)+1,X=(y.pendingAttack.players||[]).map(ce=>jt(ce)),V=[...y.log||[]];V.push({type:"duel",isGoal:M,homeScored:M&&T===p,text:M?`⚽ BUT de ${y[T+"Name"]} ! (${y.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${y.pendingAttack.total} vs ${z.total})`,homePlayers:X,aiPlayers:L.map(ce=>jt(ce)),homeTotal:y.pendingAttack.total,aiTotal:z.total});const oe=M?(y[T+"Score"]||0)+1:y[T+"Score"]||0,Z={...y,[p+"Team"]:k,[T+"Score"]:oe},H=Oe(Z),le=H?"finished":q+"-attack",pe=!H&&!M?_e(Z):null,ue=async()=>{if(pe){await ye(pe,Z);return}await U({[p+"Team"]:k,[g+"Team"]:y[g+"Team"],[T+"Score"]:oe,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:le,attacker:q,round:P,log:V}),(le==="finished"||H)&&await Xe({...y,[T+"Score"]:oe})};if(M){const ce=T===p,me=ce?oe:y[p+"Score"]||0,xe=ce?y[g+"Score"]||0:oe;N.add(P),ot(X,me,xe,ce,ue)}else await ue()}function Le(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(z=>!z.used))}function ge(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(z=>!z.used))}function Be(k){return ge(k)&&!Le(k)}function je(k){const L=y[k+"Team"];return!!(Le(L)||Be(L))}function Oe(k){return!ge(k.p1Team)&&!ge(k.p2Team)}function bt(k){const L=k.p1Score||0,z=k.p2Score||0;return L===z?null:L>z?b.home_id:b.away_id}async function Xe(k){try{const L=bt(k),z=L?b.home_id===L?b.away_id:b.home_id:null,A=k.p1Score||0,T=k.p2Score||0;if(await w.from("matches").update({status:"finished",winner_id:L,home_score:A,away_score:T}).eq("id",i),L&&z&&to(L,z).catch(()=>{}),u&&await w.from("mini_league_matches").update({status:"finished",home_score:A,away_score:T,match_id:i}).eq("id",u),typeof c=="function")try{await c({homeScore:A,awayScore:T,winnerId:L})}catch(M){console.error("[PvP] onMatchEnd:",M)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Rt(){var T;const k=y[p+"Score"],L=y[g+"Score"],z=k>L,A=k===L;nt(e),e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${$t}">
      ${g.map(b=>`<button class="ml-tab" data-tab="${b.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===b.key?Ln:"transparent"};background:none;font-size:12px;font-weight:${i===b.key?"900":"600"};color:${i===b.key?"#4ade80":Ke};cursor:pointer">${b.label}${b.count?` (${b.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?lr(x,p,r):i==="active"?cr(m,r):pr(f,r)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>ur(e,t)),(_=document.getElementById("ml-refresh-list"))==null||_.addEventListener("click",()=>yt(e,t,i)),e.querySelectorAll(".ml-tab").forEach(b=>b.addEventListener("click",()=>yt(e,t,b.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(b=>b.addEventListener("click",()=>rt(e,t,b.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(b=>b.addEventListener("click",$=>{$.stopPropagation(),Tn(e,t,b.dataset.join,b.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(b=>b.addEventListener("click",$=>{$.stopPropagation(),Ti(e,t,b.dataset.delete,b.dataset.name,i)}))}function di(e,t,i=!1){var a,s;const n=e.creator_id===t,r=e.pot||0,o=((s=(a=e.mini_league_members)==null?void 0:a[0])==null?void 0:s.count)||0;return`<div data-league-id="${e.id}" style="background:${Nt};border:1px solid ${kt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Nt};border:1px solid ${kt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(v,I)=>I+1).reverse().map(v=>{const I=(l||[]).filter(G=>G.matchday===v);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ke};margin-bottom:6px">Journée ${v}</div>${I.map(G=>en(G,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const b=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if(($=document.getElementById("ml-back"))==null||$.addEventListener("click",()=>yt(e,t,b)),(y=document.getElementById("ml-refresh"))==null||y.addEventListener("click",async v=>{const I=v.currentTarget;I.style.opacity="0.5",await rt(e,t,i)}),(j=document.getElementById("ml-start-btn"))==null||j.addEventListener("click",()=>xr(e,t,a,u)),(E=document.getElementById("ml-next-day"))==null||E.addEventListener("click",()=>yr(e,t,i)),(F=document.getElementById("ml-finish-btn"))==null||F.addEventListener("click",()=>zn(e,t,i,f,x,u)),(N=document.getElementById("ml-join-now"))==null||N.addEventListener("click",()=>Tn(e,t,i,a.type)),(ne=document.getElementById("ml-leave-btn"))==null||ne.addEventListener("click",()=>gr(e,t,i,p)),(ie=document.getElementById("ml-delete-btn"))==null||ie.addEventListener("click",()=>Ti(e,t,i,a.name,"waiting")),(Q=document.getElementById("ml-delete-now"))==null||Q.addEventListener("click",()=>Ti(e,t,i,a.name,b)),(U=document.getElementById("ml-archive-btn"))==null||U.addEventListener("click",()=>mr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(v=>{v.addEventListener("click",()=>{const I=m.find(G=>G.id===v.dataset.playMatch);I&&t.navigate("match-mini-league",{mlMatchId:I.id,leagueId:i})})}),a.status==="finished"&&_){const v=x.findIndex(I=>I.userId===o);v>=0&&v<3&&_.prize_amount>0&&setTimeout(()=>br(e,t,a,_,v),400)}}function en(e,t,i,n,r=!1){const o=u=>t.find(x=>x.id===u);if(e.is_bye){const u=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${it};text-align:center">🔵 ${(u==null?void 0:u.club_name)||(u==null?void 0:u.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),l=e.home_id===i||e.away_id===i,c=l&&e.status==="pending"&&n&&!r,d=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${l?"rgba(74,222,128,0.35)":$t}">
  ...
  </div>`}async function xr(e,t,i,n){const{toast:r,state:o}=t,a=hr(n.map(c=>c.id),i.mode),s=[];a.forEach((c,d)=>c.forEach(u=>s.push({league_id:i.id,matchday:d+1,home_id:u.home||u.bye,away_id:u.away||null,is_bye:!!u.bye,status:u.bye?"bye":"pending"})));const{error:l}=await w.from("mini_league_matches").insert(s);if(l){r("Erreur calendrier : "+l.message,"error");return}await w.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),rt(e,t,i.id)}async function yr(e,t,i){const{data:n}=await w.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){await zn(e,t,i,n.pot||0,null,null);return}await w.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),rt(e,t,i)}async function zn(e,t,i,n,r,o){const{toast:a,state:s}=t;let l=r,c=o;if(!l){const{data:u}=await w.from("mini_league_matches").select("*").eq("league_id",i),{data:x}=await w.from("mini_league_members").select("*, user:users(id,pseudo,club_name)").eq("league_id",i);c=(x||[]).map(m=>m.user).filter(Boolean),l=In(c,u||[])}const d=[Math.floor(n*.7),Math.floor(n*.2),Math.floor(n*.1)];await Promise.all(l.slice(0,3).map((u,x)=>d[x]?w.from("mini_league_members").update({prize_amount:d[x],prize_claimed:!1}).eq("league_id",i).eq("user_id",u.userId):Promise.resolve())),await w.from("mini_leagues").update({status:"finished"}).eq("id",i),a("🏆 Mini League terminée ! Les gagnants peuvent récupérer leurs crédits.","success"),rt(e,t,i)}async function br(e,t,i,n,r){var x,m;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],l=["🥇","🥈","🥉"][r],c=n.prize_amount||s[r]||0,d=n.prize_claimed,u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",u.innerHTML=`
    ...
    </div>`;let d=!1;const u=async g=>{if(!d){if(d=!0,clearInterval(f),m)try{m.unsubscribe()}catch{}g&&await zt(e,t,g,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),l()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(f),m)try{m.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),l()});const x=async()=>{if(d)return;const{data:g}=await w.from("mini_league_matches").select("match_id").eq("id",i).single();g!=null&&g.match_id&&u(g.match_id)},m=w.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},g=>{var h;(h=g.new)!=null&&h.match_id&&u(g.new.match_id)}).subscribe(),f=setInterval(x,3e3);x()})}const wr="/",_r=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function kr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var d,u,x;const s=t[n],l=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function x(p){var F,N,ne,ie;const g=(F=p.card)==null?void 0:F.player;if(!g)return"";const h=((N=p.card)==null?void 0:N.evolution_bonus)||0,_=Ct(g,g.job,h),b=g.job2?Ct(g,g.job2,h):0,$=p.status==="sold",y=g.country_code?`https://flagsapi.com/${g.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,j=ii[g.job]||"#bbb",E=g.job2?ii[g.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ne=g.clubs)!=null&&ne.logo_url?`<img src="${g.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${j};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const h=a||[];f.innerHTML=h.length>0?h.map((_,b)=>{const $=Ai(_.mmr??1e3),y=(_.ranked_wins||0)+(_.ranked_losses||0)+(_.ranked_draws||0),j=y>0?Math.round((_.ranked_wins||0)/y*100):0,E=_.id===i.profile.id,F=(_.placement_matches||0)<10;return`
  ...
  </div>`}Cn(qn);const ve={user:null,profile:null,page:"home",params:{}};function Bt(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Mr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function zi(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ot(){if(!ve.user)return;const{data:e}=await w.from("users").select("*").eq("id",ve.user.id).single();e&&(ve.profile=e)}function Ht(e,t={}){ve.page=e,ve.params=t,An()}async function An(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const t=document.getElementById("nav-credits");t&&ve.profile&&(t.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Ht,toast:Bt,openModal:Mr,closeModal:zi,refreshProfile:Ot};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Hi(e,i);break;case"collection":await co(e,i);break;case"decks":await vi(e,i);break;case"boosters":await ko(e,i);break;case"ranked":await Ar(e,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Li(e,i,!1):s==="ranked"?await Li(e,i,!0):s==="friend"?await rr(e,i,(n=ve.params)==null?void 0:n.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await tn(e,i,(o=ve.params)==null?void 0:o.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await Fo(e,i);break}case"market":await Er(e,i);break;case"rankings":await Ir(e,i);break;case"matches":await Sr(e,i);break;case"friends":await On(e,i);break;case"mini-league":await dr(e,i);break;case"match-mini-league":{const s=ve.params||{};await tn(e,i,s.mlMatchId,s.leagueId);break}default:await Hi(e,i)}}function jr(){var n;const e=document.getElementById("app"),t=ve.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function qr(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&zi()}),document.getElementById("modal-close").addEventListener("click",zi);const{data:{session:e}}=await w.auth.getSession();if(!e){nn(),Br(document.getElementById("app"),{onPlay:()=>Ri(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Bt})});return}ve.user=e.user,await Ot(),nn();try{const{data:i}=await w.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),Bn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){Fn(document.getElementById("app"),{state:ve,navigate:async()=>{await Ot(),hi()},toast:Bt,refreshProfile:Ot});return}const t=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&t.length>0){So(document.getElementById("app"),{state:ve,navigate:()=>hi(),toast:Bt,refreshProfile:Ot});return}hi(),setTimeout(()=>$r(ve.profile,Ht,Bt),800),w.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",Ri(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Bt}))})}function Dr(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function ui(){const e=document.getElementById("app");e&&(e.style.height=Dr()+"px")}window.addEventListener("resize",ui);window.addEventListener("orientationchange",()=>setTimeout(ui,150));window.visualViewport&&window.visualViewport.addEventListener("resize",ui);function hi(){const e=()=>{var i;(i=ve.user)!=null&&i.id&&w.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",ui(),jr(),An()}function nn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Sn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
