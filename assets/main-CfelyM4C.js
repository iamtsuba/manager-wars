import{s as C,F as ht,b as Pe,c as ii,l as ke,d as $i}from"./formation-links-Bt44rMnM.js";function Nt(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",d=>{d.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{n(),e("match",{matchMode:d.dataset.mode})})})}const ye={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function re(e,t){if(!e)return 0;switch(t){case"GK":return Number(e.note_g)||0;case"DEF":return Number(e.note_d)||0;case"MIL":return Number(e.note_m)||0;case"ATT":return Number(e.note_a)||0;default:return 0}}const Ht=["ATT","MIL","DEF","GK"];function oi(e){let t=0;const i=e.length;for(let n=0;n<i;n++)for(let d=n+1;d<i;d++){const s=e[n],a=e[d];if(!s||!a)continue;const l=s._col!==void 0&&a._col!==void 0&&s._col===a._col,c=s._col!==void 0&&a._col!==void 0&&Math.abs(s._col-a._col)===1,o=Ht.indexOf(s._line),r=Ht.indexOf(a._line),p=Math.abs(o-r)===1;(s._line===a._line&&c||l&&p)&&(s.country_code&&a.country_code&&s.country_code===a.country_code&&t++,s.club_id&&a.club_id&&s.club_id===a.club_id&&t++)}return t}function bt(e,t={}){const i=e.reduce((s,a)=>{const l=a._line||a.job;return s+(Number(l==="MIL"?a.note_m:a.note_a)||0)+(a.boost||0)},0),n=oi(e);let d=i+n;return t.doubleAttack&&(d*=2),t.stolenNote&&(d-=t.stolenNote),{base:i,links:n,total:Math.max(0,d)}}function vt(e,t={}){const i=e.reduce((s,a)=>{const l=a._line||a.job;let c=0;return l==="GK"?c=Number(a.note_g)||0:l==="MIL"?c=Number(a.note_m)||0:c=Number(a.note_d)||0,s+c+(a.boost||0)},0),n=oi(e);let d=i+n;return t.stolenNote&&(d-=t.stolenNote),{base:i,links:n,total:Math.max(0,d)}}function wt(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function ni(e,t,i="easy"){const n=e.filter(a=>!a.used);if(!n.length)return[];const d=[...n].sort((a,l)=>{const c=t==="attack"?re(a,"ATT"):a._line==="GK"?re(a,"GK"):re(a,"DEF");return(t==="attack"?re(l,"ATT"):l._line==="GK"?re(l,"GK"):re(l,"DEF"))-c});let s=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return d.slice(0,Math.min(s,d.length,3))}function Ai(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const ri={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Ze={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},Ke=["GK","DEF","MIL","ATT"],Ii=["Tous","GK","DEF","MIL","ATT"],Li={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},$t={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function ai(e){return null}function Re(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function ct(e,t=""){var p,g;const i=e.player;if(!i)return"";const n=i.job||"ATT",d=Ze[n],s=ri[i.rarity]||"#ccc",a=Re(i,n),l=i.job2?Re(i,i.job2):null,c=i.job2?Ze[i.job2]:null,o=ai(),r=$t[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function Ut(e){const t=e.job||"ATT",i=Re(e,t),n=$t[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),o=(l||[]).filter(S=>S.card_type==="player"&&S.player),r=(l||[]).filter(S=>S.card_type==="game_changer"),p=(l||[]).filter(S=>S.card_type==="formation"),{data:g}=await C.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(g||[]).forEach(S=>{x[S.name]=S});const E=Object.keys(ht),u=Object.keys(ye),y={};o.forEach(S=>{const f=S.player.id;y[f]=(y[f]||0)+1}),new Set(Object.keys(y).map(S=>String(S)));const L=new Set(p.map(S=>S.formation)),_=new Set(r.map(S=>S.gc_type));let z="player",w="Tous",M="",T=!1;function D(){return[...o].sort((S,f)=>{const m=Ke.indexOf(S.player.job),h=Ke.indexOf(f.player.job);return m!==h?m-h:(S.player.surname_encoded||"").localeCompare(f.player.surname_encoded||"")})}function R(){return[...c||[]].sort((S,f)=>{const m=Ke.indexOf(S.job),h=Ke.indexOf(f.job);return m!==h?m-h:(S.surname_encoded||"").localeCompare(f.surname_encoded||"")})}function U(){return D().filter(S=>{const f=S.player,m=w==="Tous"||f.job===w,h=!M||`${f.firstname} ${f.surname_encoded}`.toLowerCase().includes(M);return m&&h})}function $(){return R().filter(S=>{const f=w==="Tous"||S.job===w,m=!M||`${S.firstname} ${S.surname_encoded}`.toLowerCase().includes(M);return f&&m})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{T=!T,q(),A()})))}function A(){const S=document.getElementById("col-grid");S&&(z==="player"?J(S):z==="formation"?de(S):X(S))}function N(S,f,m,h,b){b=b||"#7a28b8";const v=document.getElementById("col-grid"),k=document.getElementById("col-big");if(!v||!k)return;var I=0;function F(){k.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+f(S[I])+"</div>";var B=k.querySelector("[data-card-id],[data-form-id],[data-gc-id]");B&&B.addEventListener("click",function(){h(S[I])}),requestAnimationFrame(function(){var j=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!j||!k)){var O=k.clientHeight-8,P=k.clientWidth-24,V=j.offsetHeight,Q=j.offsetWidth;if(V>0&&Q>0&&O>40){var W=Math.min(O/V,P/Q,1);j.style.transform="scale("+W.toFixed(3)+")",j.style.transformOrigin="top center"}}}),v.innerHTML=S.map(function(j,O){return'<div class="col-mini-item" data-idx="'+O+'" style="flex-shrink:0;cursor:pointer;border-radius:8px;border:1.5px solid '+(O===I?b:"transparent")+';transition:border-color .15s;overflow:hidden">'+m(j,O===I)+"</div>"}).join(""),v.querySelectorAll(".col-mini-item").forEach(function(j){j.addEventListener("click",function(){I=Number(j.dataset.idx),F(),j.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}F()}function G(S){var f=.54,m=Math.round(140*f),h=Math.round(310*f),b;if(!S||S._fake){var v=S?S.player:null;if(!v)return"";b=Ut(v)}else b=ct(S,"");return'<div style="width:'+m+"px;height:"+h+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+f+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+b+"</div></div>"}function K(S,f,m){f=f||100,m=m||140;var h=Pe[S]||{},b={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},v=Math.max(3,Math.round(f*.06)),k=Object.entries(h).map(function(F){var B=F[0],j=F[1],O=B.replace(/\d+$/,""),P=b[O]||"#888",V=Math.round(j.x*f),Q=Math.round(j.y*m);return'<circle cx="'+V+'" cy="'+Q+'" r="'+v+'" fill="'+P+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),I=Math.max(1,Math.round(f/50));return'<svg viewBox="0 0 '+f+" "+m+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+f+'" height="'+m+'" fill="#1A6B3C"/><rect x="'+Math.round(f*.2)+'" y="'+Math.round(m*.02)+'" width="'+Math.round(f*.6)+'" height="'+Math.round(m*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+I+'"/><line x1="0" y1="'+Math.round(m*.5)+'" x2="'+f+'" y2="'+Math.round(m*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+I+'"/><ellipse cx="'+Math.round(f*.5)+'" cy="'+Math.round(m*.5)+'" rx="'+Math.round(f*.18)+'" ry="'+Math.round(m*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+I+'"/><rect x="'+Math.round(f*.2)+'" y="'+Math.round(m*.82)+'" width="'+Math.round(f*.6)+'" height="'+Math.round(m*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+I+'"/>'+k+"</svg>"}function Z(S,f,m){var h=m>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+m+"</div>":"",b=f?'data-form-id="'+f.id+'"':"",v=S.length>7?14:S.length>5?16:19,k=!!f;return"<div "+b+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(k?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(k?"":"filter:grayscale(1);opacity:0.5")+'">'+h+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(k?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+v+"px;font-weight:900;color:"+(k?"#1A6B3C":"#aaa")+';line-height:1">'+S+'</div></div><div style="flex:1;overflow:hidden;background:'+(k?"#1A6B3C":"#ccc")+'">'+K(S,140,220)+"</div></div>"}function te(S,f){var m=.54,h=Math.round(140*m),b=Math.round(305*m),v=Math.round(b*.22),k=b-v,I=S.length>7?5:7,F=K(S,h,k),B=f?"1.5px solid #2a7a40":"1px solid #ddd",j=f?"":"filter:grayscale(1);opacity:0.45;",O=f?"#1A6B3C":"#bbb",P="#fff";return'<div style="width:'+h+"px;height:"+b+"px;border-radius:6px;border:"+B+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+j+'"><div style="height:'+v+"px;background:"+O+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+I+"px;font-weight:900;color:"+P+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(h-4)+'px">'+S+'</span></div><div style="height:'+k+'px;overflow:hidden;flex-shrink:0">'+F+"</div></div>"}function J(S){if(T){const f=$();if(!f.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const m=f.map(h=>o.find(b=>b.player.id===h.id)||{_fake:!0,player:h,id:"fake-"+h.id});N(m,h=>h._fake?Ut(h.player):ct(h,""),h=>h._fake?G({player:h.player,id:"x",_fake:!0}):G(h),h=>{h._fake||Kt(h,o,y,t)},"#1A6B3C")}else{const f=U();if(!f.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const m={},h=[];f.forEach(b=>{m[b.player.id]||(m[b.player.id]=!0,h.push(b))}),N(h,b=>{const v=y[b.player.id]||1,k=v>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${v}</div>`:"",F=o.filter(B=>B.player.id===b.player.id&&B.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ct(b,k+F)},b=>G(b),b=>Kt(b,o,y,t),"#1A6B3C")}}function de(S){const f=T?E:[...L];if(!f.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const m=f.map(h=>({formation:h,card:p.find(b=>b.formation===h)||null,owned:L.has(h)}));N(m,({formation:h,card:b,owned:v})=>Z(h,v?b:null,v?p.filter(k=>k.formation===h).length:0),({formation:h,owned:b})=>te(h,b),({card:h,owned:b})=>{b&&h&&Si(h,p,t,s)},"#1A6B3C")}function X(S){const f=Object.keys(x),m=T?f.length?f:u:[..._];if(!m.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const h=m.map(b=>({type:b,gc:ye[b]||{icon:"⚡",desc:""},def:x[b]||null,owned:_.has(b),card:r.find(v=>v.gc_type===b)||null}));N(h,({type:b,gc:v,def:k,owned:I,card:F})=>{const B=I?r.filter(ie=>ie.gc_type===b).length:0,j=B>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${B}</div>`:"",O=(k==null?void 0:k.gc_type)==="ultra_game_changer",P={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},V={purple:"#b06ce0",light_blue:"#00d4ef"},Q=P[k==null?void 0:k.color]||P.purple,W=V[k==null?void 0:k.color]||V.purple,le=(k==null?void 0:k.effect)||v.desc||"",Y=k!=null&&k.image_url?`/manager-wars/icons/${k.image_url}`:null;return I&&F?`<div data-gc-id="${F.id}" data-gc-type="${b}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${W};background:${Q};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${W}66;cursor:pointer">
          ${j}
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Fe=1e3;function Si(e,t,i,n){var u,y,L;const{state:d,toast:s,closeModal:a,navigate:l,refreshProfile:c}=i,o=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function p(){const _=Pe[o]||{},z=ht[o]||[],w=290,M=360,T=20;function D(U){const $=_[U];return $?{x:$.x*w,y:$.y*M}:null}let R=`<svg width="${w}" height="${M}" viewBox="0 0 ${w} ${M}" xmlns="http://www.w3.org/2000/svg">`;for(const[U,$]of z){const q=D(U),A=D($);!q||!A||(R+=`<line x1="${q.x}" y1="${q.y}" x2="${A.x}" y2="${A.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const U of Object.keys(_)){const $=D(U);if(!$)continue;const q=U.replace(/\d+/,""),A=r[q]||"#555";R+=`<circle cx="${$.x}" cy="${$.y}" r="${T}" fill="${A}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,R+=`<text x="${$.x}" y="${$.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${q}</text>`}return R+="</svg>",R}const g=t.filter(_=>_.formation===o),x=g.length,E=!e.is_for_sale;n(`Formation ${o}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(u=document.getElementById("direct-sell-form-btn"))==null||u.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${o} pour ${Fe.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const _=g.find(w=>!w.is_for_sale)||g[0];if(!_){s("Aucune carte à vendre","error");return}const{error:z}=await C.from("cards").delete().eq("id",_.id);if(z){s(z.message,"error");return}await C.from("users").update({credits:(d.profile.credits||0)+Fe}).eq("id",d.profile.id),await c(),s(`+${Fe.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),l("collection")}),(y=document.getElementById("market-sell-form-btn"))==null||y.addEventListener("click",async()=>{const _=parseInt(document.getElementById("sell-price-form").value);if(!_||_<1){s("Prix invalide","error");return}await C.from("cards").update({is_for_sale:!0,sale_price:_}).eq("id",e.id),await C.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:_}),s("Carte mise en vente sur le marché !","success"),a(),l("collection")}),(L=document.getElementById("cancel-sell-form-btn"))==null||L.addEventListener("click",async()=>{await C.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await C.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),a(),l("collection")})}async function Kt(e,t,i,n){var R,U,$,q,A,N;const{state:d,toast:s,openModal:a,closeModal:l,navigate:c,refreshProfile:o}=n,r=e.player,p=t.filter(G=>G.player.id===r.id),g=p.length,x=Li[r.rarity]||1e3,E=r.rarity!=="legende",u=ai(),y=Re(r,r.job),L=r.job2?Re(r,r.job2):null,_=Ze[r.job]||"#1A6B3C",z=r.job2?Ze[r.job2]:null,w=ri[r.rarity]||"#ccc",M=$t[r.country_code]||r.country_code||"",{data:T}=await C.from("transfer_history").select("club_name, manager_name, source, price, transferred_at").eq("player_id",r.id).order("transferred_at",{ascending:!0}),D=T&&T.length?`
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="width:140px;border-radius:12px;padding:6px;background:${w};flex-shrink:0">
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${(R=r.clubs)!=null&&R.logo_url?`<img src="${r.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((U=r.clubs)==null?void 0:U.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),($=document.getElementById("close-detail"))==null||$.addEventListener("click",l),(q=document.getElementById("direct-sell-btn"))==null||q.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${r.surname_encoded} pour ${x.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const G=p.find(Z=>!Z.is_for_sale)||p[0];if(!G){s("Aucune carte à vendre","error");return}const{error:K}=await C.from("cards").delete().eq("id",G.id);if(K){s(K.message,"error");return}await C.from("users").update({credits:(d.profile.credits||0)+x}).eq("id",d.profile.id),await o(),s(`+${x.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),c("collection")}),(A=document.getElementById("market-sell-btn"))==null||A.addEventListener("click",async()=>{const G=parseInt(document.getElementById("sell-price").value);if(!G||G<1){s("Prix invalide","error");return}await C.from("cards").update({is_for_sale:!0,sale_price:G}).eq("id",e.id),await C.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:G}),s("Carte mise en vente sur le marché !","success"),l(),c("collection")}),(N=document.getElementById("cancel-sell-btn"))==null||N.addEventListener("click",async()=>{await C.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await C.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),l(),c("collection")})}const Ie={},et={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},$e={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function rt(e){const t=typeof import.meta<"u"?Ie==null?void 0:Ie.VITE_SUPABASE_URL:"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function si(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function li(e){var i;const t=(Ie==null?void 0:Ie.VITE_SUPABASE_URL)||"";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:t?`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null:null}function Ci(e,t=44,i=58){var x;const n=e?rt(e):null,d=e?li(e):null,s=si(e==null?void 0:e.country_code),a=(e==null?void 0:e.job)||"MIL",l=$e[a]||"#555",c={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",o=Number(a==="GK"?e==null?void 0:e.note_g:a==="DEF"?e==null?void 0:e.note_d:a==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(i*.19),p=Math.round(i*.25),g=i-r-p;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${c};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div class="page">
    ...
    <div class="page-body">
      ...
      ${l.length>0?l.map(o=>{var x;const r=o.player,p=rt(r),g=r.job==="GK"?r.note_g:r.job==="DEF"?r.note_d:r.job==="MIL"?r.note_m:r.note_a;return`<div class="player-option" data-card-id="${o.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  `,document.body.appendChild(n);let d=!1;const s=document.getElementById("pack-cut-zone"),a=document.getElementById("pack-blade");let l=!1;const c=A=>A.touches&&A.touches[0]?A.touches[0].clientX:A.clientX;function o(A){d||(l=!0,a.style.opacity="1",r(A))}function r(A){if(!l||d)return;const N=s.getBoundingClientRect(),G=c(A)-N.left,K=Math.max(0,Math.min(1,G/N.width));a.style.width=K*N.width+"px",K>=.82&&g()}function p(){d||(l=!1,a.style.transition="width .2s ease, opacity .2s ease",a.style.width="0",a.style.opacity="0",setTimeout(()=>{d||(a.style.transition="")},220))}function g(){var N;if(d)return;d=!0,l=!1,a.style.width="100%",a.style.opacity="1",(N=document.getElementById("cut-flash"))==null||N.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const A=document.getElementById("cut-hint");A&&(A.style.opacity="0"),s.classList.add("pack-cut"),setTimeout(()=>{a.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}s.addEventListener("pointerdown",o),window.addEventListener("pointermove",r),window.addEventListener("pointerup",p),s.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",r,{passive:!0}),window.addEventListener("touchend",p);let x=0,E=!1;const u=new Set;function y(A){x=A,document.getElementById("reveal-phase").style.display="flex",L(),_(A,0),D()}function L(){const A=document.getElementById("card-dots");A&&(A.innerHTML=e.map((N,G)=>`<div class="card-dot" data-i="${G}" style="width:8px;height:8px;border-radius:50%;background:${G===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),A.querySelectorAll(".card-dot").forEach(N=>N.addEventListener("click",()=>w(parseInt(N.dataset.i)))))}function _(A,N){var S;const G=e[A],K=document.getElementById("card-counter"),Z=document.getElementById("card-track");K&&(K.textContent=`Carte ${A+1} / ${e.length}`);const te=G.card_type==="player"&&((S=G.player)==null?void 0:S.rarity)==="legende",J=!u.has(A);u.add(A);let de=0;if(G.card_type==="player"&&G.player){const f=G.player,m=f.job||"ATT";de=Number(m==="GK"?f.note_g:m==="DEF"?f.note_d:m==="MIL"?f.note_m:f.note_a)||0}const X=f=>{Z.innerHTML=`
        ...
        </div>`;const m=document.getElementById("current-card-wrap");N!==0?(m.style.transition="none",m.style.transform=`translateX(${N>0?100:-100}%)`,requestAnimationFrame(()=>{m.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",m.style.transform="translateX(0)"})):m.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),f||te?U():$(),L()};J&&de>6&&G.card_type==="player"&&G.player?z(G,()=>X(!0)):X(!1)}function z(A,N){var X;E=!0;const G=A.player,K=`https://flagsapi.com/${G.country_code}/flat/64.png`,Z=(X=G.clubs)==null?void 0:X.logo_url,te=document.getElementById("walkout-overlay"),J=document.getElementById("walkout-stage");if(!te||!J){E=!1,N();return}te.style.display="flex";const de=()=>{const S=J.firstElementChild;S&&(S.classList.remove("wo-in"),S.classList.add("wo-out"))};J.innerHTML=`<img class="wo-in" src="${K}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(de,2e3),setTimeout(()=>{var S;J.innerHTML=Z?`<img class="wo-in" src="${Z}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((S=G.clubs)==null?void 0:S.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(de,4450),setTimeout(()=>{te.style.display="none",J.innerHTML="",E=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),N()},4900)}function w(A){if(E||A<0||A>=e.length||A===x)return;const N=A>x?1:-1;x=A,_(A,N)}function M(){w(x+1)}function T(){w(x-1)}function D(){const A=document.getElementById("card-viewport");if(!A||A._swipeBound)return;A._swipeBound=!0;let N=0,G=0,K=0,Z=!1;const te=f=>f.touches?f.touches[0].clientX:f.clientX,J=f=>f.touches?f.touches[0].clientY:f.clientY,de=f=>{Z=!0,N=te(f),G=J(f),K=0},X=f=>{if(!Z)return;K=te(f)-N;const m=J(f)-G;if(Math.abs(K)<Math.abs(m))return;const h=document.getElementById("current-card-wrap");h&&(h.style.transition="none",h.style.transform=`translateX(${K*.6}px) rotate(${K*.02}deg)`)},S=()=>{if(!Z)return;Z=!1;const f=document.getElementById("current-card-wrap"),m=55;K<=-m&&x<e.length-1?M():K>=m&&x>0?T():f&&(f.style.transition="transform .2s ease",f.style.transform="translateX(0)")};A.addEventListener("pointerdown",de),A.addEventListener("pointermove",X),A.addEventListener("pointerup",S),A.addEventListener("pointercancel",S),A.addEventListener("touchstart",de,{passive:!0}),A.addEventListener("touchmove",X,{passive:!0}),A.addEventListener("touchend",S),A.addEventListener("click",f=>{if(Math.abs(K)>8)return;const m=A.getBoundingClientRect();f.clientX-m.left>m.width/2?M():T()})}let R=null;function U(){const A=document.getElementById("fireworks-canvas");if(!A)return;A.width=window.innerWidth,A.height=window.innerHeight;const N=A.getContext("2d"),G=[];function K(){const te=Math.random()*A.width,J=Math.random()*A.height*.6,de=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],X=de[Math.floor(Math.random()*de.length)];for(let S=0;S<60;S++){const f=Math.PI*2/60*S,m=2+Math.random()*5;G.push({x:te,y:J,vx:Math.cos(f)*m,vy:Math.sin(f)*m,alpha:1,color:X,size:2+Math.random()*3})}}K(),R=setInterval(K,600);function Z(){if(document.getElementById("fireworks-canvas")){N.clearRect(0,0,A.width,A.height);for(let te=G.length-1;te>=0;te--){const J=G[te];if(J.x+=J.vx,J.y+=J.vy+.08,J.vy*=.98,J.alpha-=.018,J.alpha<=0){G.splice(te,1);continue}N.globalAlpha=J.alpha,N.fillStyle=J.color,N.beginPath(),N.arc(J.x,J.y,J.size,0,Math.PI*2),N.fill()}N.globalAlpha=1,(R!==null||G.length>0)&&requestAnimationFrame(Z)}}Z()}function $(){R!==null&&(clearInterval(R),R=null);const A=document.getElementById("fireworks-canvas");A&&A.getContext("2d").clearRect(0,0,A.width,A.height)}document.getElementById("reveal-collection").addEventListener("click",()=>{$(),n.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{$(),n.remove(),i("boosters")})}function eo(e){var t,i;if(e.card_type==="player"&&e.player)return Hi(e);if(e.card_type==="game_changer"){const n=e._gcDef,d=(n==null?void 0:n.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[n==null?void 0:n.color]||s.purple,c=a[n==null?void 0:n.color]||a.purple,o=(n==null?void 0:n.name)||e.gc_type||"Game Changer",r=(n==null?void 0:n.effect)||((t=ut[e.gc_type])==null?void 0:t.desc)||"",p=n!=null&&n.image_url?`/manager-wars/icons/${n.image_url}`:null,g=((i=ut[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${l};border-radius:14px;border:3px solid ${c};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${c}88;flex-shrink:0">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const oo="simulation",ci="VOTRE_ZONE_ID";function no(){switch(oo){case"propellerads":return ro();case"adsense":return ao();default:return _t()}}function _t(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const n=setInterval(()=>{i--;const d=document.getElementById("ad-cd"),s=document.getElementById("ad-skip");d&&(d.textContent=i),s&&(s.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(n),s&&(s.disabled=!1,s.style.cssText=s.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),s==null||s.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function ro(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(_t());window.propeller.push({zone_id:ci,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function ao(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(_t());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:ci,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const Le={},Se={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Ce={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function _e(e,t,i,n,d){var s;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(s=document.getElementById("msg-btn"))==null||s.addEventListener("click",d)}function me(e){const t=typeof import.meta<"u"?Le==null?void 0:Le.VITE_SUPABASE_URL:"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ft(e,t){var n,d;const i=e.player;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_encoded,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:Number(i.note_g)||0,note_d:Number(i.note_d)||0,note_m:Number(i.note_m)||0,note_a:Number(i.note_a)||0,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((d=i.clubs)==null?void 0:d.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function tt(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function pi(){const e=Math.random()*100;return e<10?3:e<30?2:1}function it(e,t){const i=Se[t]||Se["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const l=e.filter(o=>o.position&&o.position.replace(/\d+$/,"")===a).sort((o,r)=>parseInt(o.position.replace(/\D+/g,""),10)-parseInt(r.position.replace(/\D+/g,""),10)).map(o=>({...o,_line:a})),c=tt(l.length);l.forEach((o,r)=>{o._col=c[r]}),n[a]=l}return n}const s=[...e];for(const a of["GK","DEF","MIL","ATT"]){const l=[];for(let o=0;o<i[a];o++){let r=s.findIndex(p=>p.job===a);if(r===-1&&(r=s.findIndex(p=>p.job2===a)),r===-1&&(r=0),s[r]){const p={...s[r],_line:a};l.push(p),s.splice(r,1)}}const c=tt(l.length);l.forEach((o,r)=>{o._col=c[r]}),n[a]=l}return n}function we(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function be(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function ui(e,t,i){const d=new Set,s=t.filter(r=>{const p=r.gc_type||r.id;return d.has(p)?!1:(d.add(p),!0)});let a=[];function l(r,p){const g=r._gcDef,x={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},E={purple:"#9b59b6",light_blue:"#00bcd4"},u=x[g==null?void 0:g.color]||x.purple,y=E[g==null?void 0:g.color]||E.purple;return`<div class="gc-select-card" data-id="${r.id}"
    ...
    </div>`,function(){const R=e.querySelector(".deck-preview-wrap svg");R&&(R.removeAttribute("width"),R.removeAttribute("height"),R.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",R.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),(z=document.getElementById("prev-deck"))==null||z.addEventListener("click",()=>{c>0&&(c--,o())}),(w=document.getElementById("next-deck"))==null||w.addEventListener("click",()=>{c<s.length-1&&(c++,o())}),(M=document.getElementById("validate-deck"))==null||M.addEventListener("click",()=>{y&&t.navigate("match",{matchMode:i,deckId:r.id})}),(T=document.getElementById("cancel-deck-select"))==null||T.addEventListener("click",()=>{be(e),d("home")});const L=document.getElementById("deck-swipe-zone");if(L){let D=0,R=0;L.addEventListener("touchstart",U=>{D=U.touches[0].clientX,R=U.touches[0].clientY},{passive:!0}),L.addEventListener("touchend",U=>{const $=U.changedTouches[0].clientX-D,q=U.changedTouches[0].clientY-R;Math.abs($)<40||Math.abs($)<Math.abs(q)||($<0&&c<s.length-1?(c++,o()):$>0&&c>0&&(c--,o()))},{passive:!0})}}o()}function fi(e){const t=(Le==null?void 0:Le.VITE_SUPABASE_URL)||"";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:t?`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null:null}function he(e,t=44,i=58){if(!e)return`<div style="width:${t}px;height:${i}px;border:1.5px dashed rgba(255,255,255,0.2);border-radius:5px"></div>`;const n=typeof e.portrait=="string"&&e.portrait.startsWith("http")?e.portrait:me(e),d=fi(e),s=e._line||e.job||"MIL",a=Ce[s]||"#555",l={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",c=e.note!==void 0?Number(e.note)||0:(Number(re(e,s))||0)+(e.boost||0),o=gi(e==null?void 0:e.country_code),r=Math.round(i*.19),p=Math.round(i*.25),g=i-Math.round(i*.19)-Math.round(i*.25),x=e!=null&&e.used?.28:1;return`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${l};background:${a};position:relative;overflow:hidden;flex-shrink:0;opacity:${x}">
    <div style="position:absolute;top:0;left:0;right:0;height:${r}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:center;z-index:2">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ${gt(e==null?void 0:e.country_code)?`<img src="${gt(e.country_code)}" style="width:${p+2}px;height:${p-3}px;object-fit:cover;border-radius:1px">`:`<span style="font-size:${p-4}px">${o}</span>`}
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const q=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${Ge((q.players||[]).map(A=>({...A,used:!1})),"#ff6b6b",q.total)}
            ...
            ${Ge((q.players||[]).map(A=>({...A,used:!1})),"#00ff88",q.total)}
    ...
    ${(()=>{const $=window.innerWidth>=700,q=(X,S,f)=>{var V,Q;const m=(t.gcDefs||[]).find(W=>W.name===X.gc_type),h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[m==null?void 0:m.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[m==null?void 0:m.color]||"#b06ce0",v=(m==null?void 0:m.name)||X.gc_type,k=(m==null?void 0:m.effect)||((V=ye[X.gc_type])==null?void 0:V.desc)||"",I=m!=null&&m.image_url?`/manager-wars/icons/${m.image_url}`:null,F=((Q=ye[X.gc_type])==null?void 0:Q.icon)||"⚡",B=Math.round(f*.22),j=Math.round(f*.22),O=f-B-j,P=v.length>12?7:9;return`<div class="gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
          ...
          </div>`},N=(X,S)=>S?A(110,150):q(X,110,150),G=(X,S)=>S?A(68,95):q(X,68,95),K=$?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Z=x?`<button id="btn-results" style="${K};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:r?`<div style="${K};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:p?`<button id="btn-action" style="${K};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:g?`<button id="btn-action" style="${K};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${K};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,te=p||g?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",J=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${$?56:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map($=>{var q,A,N;if($.type==="duel"){const G=$.isGoal,K=$.homeScored?"#FFD700":G?"#ff6b6b":"rgba(255,255,255,0.3)",Z=$.homeScored?"⚽ BUT !":G?"⚽ BUT IA !":(q=$.homePlayers)!=null&&q.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${G?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${K};margin-bottom:4px">
                <div style="font-size:9px;color:${K};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${Z}</div>
                ${(A=$.homePlayers)!=null&&A.length?`<div style="margin-bottom:3px">${Ge($.homePlayers,"rgba(255,255,255,0.7)",$.homeTotal)}</div>`:""}
                ${(N=$.aiPlayers)!=null&&N.length?`<div style="opacity:0.7">${Ge($.aiPlayers,"#ff6b6b",$.aiTotal)}</div>`:""}
  ...
  </div>`;function y(){const $=e.querySelector(".match-screen");if(!$)return;const q=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);$.style.bottom="auto",$.style.height=q+"px",$.style.minHeight=q+"px",$.style.maxHeight=q+"px",$.style.overflow="hidden";const A=e.querySelector("#mobile-action-bar"),N=e.querySelector("#mobile-play-area");A&&N&&(N.style.paddingBottom=A.offsetHeight+"px")}if(y(),setTimeout(y,120),setTimeout(y,400),setTimeout(y,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",y),window.visualViewport.addEventListener("scroll",y)),window.addEventListener("resize",y)),function(){const q=e.querySelector(".terrain-wrapper svg");q&&(q.removeAttribute("width"),q.removeAttribute("height"),q.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",q.setAttribute("viewBox","-26 -26 352 352"),q.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const $=e.querySelector(".terrain-wrapper svg");$&&($.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0")})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let $=!1,q=30;const A=()=>document.getElementById("match-timer"),N=()=>{const G=A();if(!G)return;const K=String(Math.floor(q/60)).padStart(2,"0"),Z=String(q%60).padStart(2,"0");G.textContent=` ${K}:${Z}`,G.style.color=$?"#ff2222":"#ff9500",G.style.fontWeight="900"};N(),t._timerInt=setInterval(()=>{if(q--,q<0)if(!$)$=!0,q=15,N();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const G=document.createElement("div");G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",G.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(G),setTimeout(()=>{G.remove(),qe(e,t,i)},2500)}else N()},1e3)}(_=document.getElementById("match-quit"))==null||_.addEventListener("click",()=>{be(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,qe(e,t,i))}),(z=document.getElementById("view-ai"))==null||z.addEventListener("click",()=>ko(t,i)),(w=document.getElementById("toggle-history"))==null||w.addEventListener("click",()=>{var $;($=document.getElementById("match-history-panel"))==null||$.classList.add("open")}),(M=document.getElementById("close-history"))==null||M.addEventListener("click",()=>{var $;($=document.getElementById("match-history-panel"))==null||$.classList.remove("open")}),(T=document.getElementById("btn-action"))==null||T.addEventListener("click",()=>{t.selected.length!==0&&(p?xo(e,t,i):g&&yo(e,t,i))}),(D=document.getElementById("btn-results"))==null||D.addEventListener("click",()=>qe(e,t,i)),e.querySelectorAll(".match-slot-hit").forEach($=>{$.addEventListener("click",()=>mo($,t,e,i))}),e.querySelectorAll(".gc-mini").forEach($=>{$.addEventListener("click",()=>vo($.dataset.gcId,$.dataset.gcType,e,t,i))}),(R=document.getElementById("boost-card"))==null||R.addEventListener("click",()=>_o(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach($=>{$.addEventListener("click",()=>Qt(e,t,i,$.dataset.subId))}),(U=document.getElementById("sub-btn-main"))==null||U.addEventListener("click",()=>Qt(e,t,i))}function mo(e,t,i,n){const d=e.dataset.cardId,s=e.dataset.role,a=t.selected.findIndex(l=>l.cardId===d);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const l=(t.homeTeam[s]||[]).find(c=>c.cardId===d);l&&t.selected.push({...l,_role:s,_line:s})}se(i,t,n)}function kt(e,t,i){e.matchId&&C.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function xo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),kt(t,i,i.state.profile.id);const n=!["GK","DEF","MIL","ATT"].some(a=>(t.aiTeam[a]||[]).some(l=>!l.used)),d=t.selected.map(a=>{const l=(t.homeTeam[a._role]||[]).find(o=>o.cardId===a.cardId)||a,c=n&&["GK","DEF"].includes(a._role);return{...l,_line:a._role,...c?{note_a:Math.max(1,Number(l.note_a)||0)}:{}}}),s=bt(d,t.modifiers.home);t.pendingAttack={...s,players:[...d],side:"home"},t.selected.forEach(a=>{const l=(t.homeTeam[a._role]||[]).find(c=>c.cardId===a.cardId);l&&(l.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${s.total} (base ${s.base}${s.links?` +${s.links} liens`:""}) — ${t.selected.map(a=>a.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",se(e,t,i),setTimeout(()=>ho(e,t,i),1200)}function yo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),kt(t,i,i.state.profile.id);const n=t.selected.map(l=>({...(t.homeTeam[l._role]||[]).find(o=>o.cardId===l.cardId)||l,_line:l._role})),d=vt(n,t.modifiers.home);t.selected.forEach(l=>{const c=(t.homeTeam[l._role]||[]).find(o=>o.cardId===l.cardId);c&&(c.used=!0)});const s=wt(t.pendingAttack.total,d.total,t.modifiers.home),a={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>({name:l.name,note:l._line==="MIL"?l.note_m:l.note_a,portrait:me(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo})),homePlayers:t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(o=>o.cardId===l.cardId)||l;return{name:c.name,note:(c._line==="GK"?Number(c.note_g)||0:c._line==="MIL"?Number(c.note_m)||0:Number(c.note_d)||0)+(c.boost||0),portrait:me(c),job:c.job,country_code:c.country_code,rarity:c.rarity,clubName:c.clubName,clubLogo:c.clubLogo}}),homeTotal:d.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(s.shielded)a.text="🛡️ Bouclier ! But annulé.",t.log.push(a);else if(s.goal){t.aiScore++,a.isGoal=!0,a.homeScored=!1,a.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${d.total})`,t.log.push(a),t.selected=[],t.modifiers.home={},t.pendingAttack=null,se(e,t,i),ot(a.aiPlayers,t.homeScore,t.aiScore,!1,()=>{Me(e,t,i,"home-attack")});return}else a.text=`🧤 Défense réussie ! (${d.total} ≥ ${t.pendingAttack.total})`,t.log.push(a);t.selected=[],t.modifiers.home={},t.pendingAttack=null,Me(e,t,i,"home-attack")}function mt(e,t,i){kt(t,i,null);const n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],d=ni(n,"attack",t.difficulty);if(!d.length){We(e,t,i);return}const s=bt(d,t.modifiers.ai);t.pendingAttack={...s,players:d,side:"ai"},d.forEach(o=>{o.used=!0}),t.log.push({text:`🤖 IA attaque : ${s.total} (${d.map(o=>o.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const a=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(o=>!o.used),c=(t.homeSubs||[]).filter(o=>!(t.usedSubIds||[]).includes(o.cardId)).length>0&&t.subsUsed<t.maxSubs;if(a.length===0&&!c){t.aiScore++;const o={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:d.map(r=>({name:r.name,note:r._line==="MIL"?r.note_m:r.note_a,portrait:me(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiTotal:s.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(o),t.pendingAttack=null,se(e,t,i),ot(o.aiPlayers,t.homeScore,t.aiScore,!1,()=>{Me(e,t,i,"home-attack")});return}t.phase="defense",se(e,t,i)}function ho(e,t,i){var o,r;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],d=ni(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(p=>(t.aiTeam[p]||[]).filter(g=>!g.used)).length){t.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:(((o=t.pendingAttack)==null?void 0:o.players)||[]).map(x=>({name:x.name,note:re(x,x._line||x.job),portrait:me(x),job:x.job,country_code:x.country_code,rarity:x.rarity,clubName:x.clubName,clubLogo:x.clubLogo})),homeTotal:((r=t.pendingAttack)==null?void 0:r.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(g),t.modifiers.ai={},t.pendingAttack=null,se(e,t,i),ot(g.homePlayers,t.homeScore,t.aiScore,!0,()=>{Me(e,t,i,"ai-attack")});return}const a=d.length>0?vt(d,t.modifiers.ai).total:0;d.forEach(p=>{p.used=!0});const l=wt(t.pendingAttack.total,a,t.modifiers.ai),c={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(p=>({name:p.name,note:p._line==="MIL"?p.note_m:p.note_a,portrait:me(p),job:p.job,country_code:p.country_code,rarity:p.rarity,clubName:p.clubName,clubLogo:p.clubLogo})),aiPlayers:d.map(p=>({name:p.name,note:p._line==="GK"?p.note_g:p._line==="MIL"?p.note_m:p.note_d,portrait:me(p),job:p.job,country_code:p.country_code,rarity:p.rarity,clubName:p.clubName,clubLogo:p.clubLogo})),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(l.shielded)c.text="🛡️ Bouclier IA !",t.log.push(c);else if(l.goal){t.homeScore++,c.isGoal=!0,c.homeScored=!0,c.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(c),t.modifiers.ai={},t.pendingAttack=null,se(e,t,i),ot(c.homePlayers,t.homeScore,t.aiScore,!0,()=>{Me(e,t,i,"ai-attack")});return}else c.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(c);t.modifiers.ai={},t.pendingAttack=null,Me(e,t,i,"ai-attack")}function Me(e,t,i,n){if(t.round++,xi(t)){qe(e,t,i);return}if(n==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(s=>!s.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used).length){We(e,t,i);return}if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(l=>!l.used).length){We(e,t,i);return}setTimeout(()=>mt(e,t,i),100);return}t.phase="attack",se(e,t,i)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(s=>!s.used).length){We(e,t,i);return}t.phase="ai-attack",se(e,t,i),setTimeout(()=>mt(e,t,i),800)}}function xi(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(d=>!d.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(d=>!d.used));return!t&&!i}function We(e,t,i){xi(t)?qe(e,t,i):(t.phase="attack",se(e,t,i))}function bo(e,t,i){const n=document.createElement("div");n.style.cssText=`
  ...
  `,document.body.appendChild(n);let r=!1;const p=()=>{r||(r=!0,n.remove(),i())};n.addEventListener("click",p),setTimeout(p,2e3)}function De(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Qt(e,t,i,n=null){if(t.phase!=="attack"){De("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){De(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.values(t.homeTeam).flat().filter(p=>p.used),s=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!d.length){De("Aucun joueur utilisé à remplacer");return}if(!s.length){De("Aucun remplaçant disponible");return}let a=0,l=Math.max(0,s.findIndex(p=>p.cardId===n)),c=!1;const o=document.createElement("div");o.id="sub-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function r(){var L,_,z,w,M,T;const p=d[a],g=s[l],x=Math.min(130,Math.round((window.innerWidth-90)/2)),E=Math.round(x*1.35),u=D=>`background:rgba(255,255,255,0.12);border:none;color:${D?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${D?"default":"pointer"};flex-shrink:0`;o.innerHTML=`
    ...
    </div>`,document.body.appendChild(x),(E=x.querySelector("#gc-back"))==null||E.addEventListener("click",()=>x.remove()),(u=x.querySelector("#gc-use"))==null||u.addEventListener("click",()=>{x.remove(),$o(e,t,i,n,d)})}function Ye(e,t,i,n,d,s){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let l=[];function c(){var o,r;a.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(d=>{d.addEventListener("click",()=>{const s=d.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const l=(t.homeTeam[a]||[]).find(c=>c.cardId===s);if(l){l.boost=(l.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),se(e,t,i)})})}function ot(e,t,i,n,d){const s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const a=Array.from({length:10},(o,r)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const c=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",c),setTimeout(c,3500)}async function qe(e,t,i){var r,p;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,a=d?"victoire":s?"nul":"defaite",l=Ai(t.mode,a);t.matchId&&await C.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?n.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(n.profile.credits||0)+l,matches_played:(n.profile.matches_played||0)+1};d?c.wins=(n.profile.wins||0)+1:s?c.draws=(n.profile.draws||0)+1:c.losses=(n.profile.losses||0)+1,await C.from("users").update(c).eq("id",n.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}async function Eo(e,t){await mi(e,t,"random",({deckId:i,formation:n,starters:d,subsRaw:s,gcCardsEnriched:a,gcDefs:l})=>{const c=o=>To(e,t,i,n,d,s,o,l||[]);if(!a.length){c([]);return}ui(e,a,c)})}async function To(e,t,i,n,d,s,a=[],l=[]){var _;const{state:c,navigate:o,toast:r}=t;let p=!1,g=null;we(e),e.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const x=async(z=!0)=>{p=!0,g&&(C.removeChannel(g),g=null),z&&await C.rpc("cancel_matchmaking",{p_user_id:c.profile.id}).catch(()=>{})};(_=document.getElementById("mm-cancel"))==null||_.addEventListener("click",async()=>{try{await x(!0)}catch{}be(e),o("home")});const E=async(z,w,M)=>{if(p)return;p=!0,g&&(C.removeChannel(g),g=null);const T=document.getElementById("mm-status");T&&(T.textContent="Adversaire trouvé !"),await new Promise(D=>setTimeout(D,600)),e.isConnected&&Ao(e,t,z,M,a,l)},{data:u,error:y}=await C.rpc("try_matchmake",{p_user_id:c.profile.id,p_deck_id:i});if(y||!(u!=null&&u.success)){r("Erreur de matchmaking","error"),be(e),o("home");return}if(u.matched){E(u.match_id,u.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),g=C.channel("matchmaking-"+c.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${c.profile.id}`},z=>{const w=z.new;w.status==="matched"&&w.match_id&&E(w.match_id,w.matched_with,!0)}).subscribe()}async function Ao(e,t,i,n,d=[],s=[]){const{state:a,navigate:l,toast:c}=t,o=n?"p1":"p2",r=n?"p2":"p1",p=(d||[]).map(f=>f.id),g=(d||[]).map(f=>({id:f.id,gc_type:f.gc_type,_gcDef:f._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:x}=await C.from("matches").select("*").eq("id",i).single();if(!x){c("Match introuvable","error"),l("home");return}async function E(){const[{data:f},{data:m},{data:h},{data:b}]=await Promise.all([C.rpc("get_deck_for_match",{p_deck_id:x.home_deck_id}),C.rpc("get_deck_for_match",{p_deck_id:x.away_deck_id}),C.from("users").select("id,pseudo,club_name").eq("id",x.home_id).single(),C.from("users").select("id,pseudo,club_name").eq("id",x.away_id).single()]),v=j=>({cardId:j.card_id,position:j.position,id:j.id,firstname:j.firstname,name:j.surname_encoded,country_code:j.country_code,club_id:j.club_id,job:j.job,job2:j.job2,note_g:Number(j.note_g)||0,note_d:Number(j.note_d)||0,note_m:Number(j.note_m)||0,note_a:Number(j.note_a)||0,rarity:j.rarity,skin:j.skin,hair:j.hair,hair_length:j.hair_length,clubName:j.club_encoded_name||null,clubLogo:j.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),k=((f==null?void 0:f.starters)||[]).map(j=>v(j)),I=((m==null?void 0:m.starters)||[]).map(j=>v(j)),F=(f==null?void 0:f.formation)||"4-4-2",B=(m==null?void 0:m.formation)||"4-4-2";return{p1Team:it(k,F),p2Team:it(I,B),p1Subs:((f==null?void 0:f.subs)||[]).map(j=>v(j)),p2Subs:((m==null?void 0:m.subs)||[]).map(j=>v(j)),p1Formation:F,p2Formation:B,p1Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 1",p2Name:(b==null?void 0:b.club_name)||(b==null?void 0:b.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?p:[],gc_p2:n?[]:p,gcCardsFull_p1:n?g:[],gcCardsFull_p2:n?[]:g,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,lastActionAt:new Date().toISOString()}}let u=x.game_state&&Object.keys(x.game_state).length?x.game_state:null;if(!u)if(n){u=await E();const{data:f}=await C.from("matches").select("game_state").eq("id",i).single();!(f!=null&&f.game_state)||!Object.keys(f.game_state).length?await C.from("matches").update({game_state:u,turn_user_id:x.home_id}).eq("id",i):u=f.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let f=0;f<30&&!u;f++){await new Promise(h=>setTimeout(h,400));const{data:m}=await C.from("matches").select("game_state").eq("id",i).single();m!=null&&m.game_state&&Object.keys(m.game_state).length&&(u=m.game_state)}if(!u){c("Erreur de synchronisation","error"),l("home");return}u.gc_p2=p,u.gcCardsFull_p2=g,await C.from("matches").update({game_state:u}).eq("id",i)}let y=!1,L=null,_=!1;function z(f){var b,v;try{C.removeChannel(w)}catch{}const m=f.winner_id===a.profile.id;(b=h.remove)==null||b.call(h);const h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center",h.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(h),(v=h.querySelector("#pvp-end-home"))==null||v.addEventListener("click",()=>{h.remove(),be(e),l("home")})}const w=C.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},f=>{const m=f.new;try{if(m.status==="finished"||m.forfeit){if(y)return;y=!0,L&&(clearInterval(L),L=null),m.game_state&&(u=m.game_state),z(m);return}m.game_state&&(u=m.game_state,$())}catch(h){console.error("[PvP] crash:",h)}}).subscribe();async function M(f){Object.assign(u,f),u.lastActionAt=new Date().toISOString();const{error:m}=await C.from("matches").update({game_state:u}).eq("id",i);m&&c("Erreur de synchronisation","error");try{$()}catch(h){console.error("[PvP] renderPvpScreen crash:",h)}}async function T(){if(y)return;y=!0,L&&(clearInterval(L),L=null);const f=n?x.away_id:x.home_id;try{await C.from("matches").update({status:"finished",forfeit:!0,winner_id:f}).eq("id",i)}catch{}try{C.removeChannel(w)}catch{}be(e),l("home")}const D={BOOST_STAT:({value:f=1,count:m=1,roles:h=[]},b,v)=>{const k=b[o+"Team"],I=Object.entries(k).filter(([F])=>!h.length||h.includes(F)).flatMap(([F,B])=>B.filter(j=>!j.used).map(j=>({...j,_line:F})));if(!I.length){b.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(b);return}R(I,m,`Choisir ${m} joueur(s) à booster (+${f})`,F=>{F.forEach(B=>{const j=(k[B._line]||[]).find(O=>O.cardId===B.cardId);j&&(j.boost=(j.boost||0)+f,b.log.push({text:`⚡ +${f} sur ${j.name}`,type:"info"}))}),b[o+"Team"]=k,v(b)})},DEBUFF_STAT:({value:f=1,count:m=1,roles:h=[],target:b="ai"},v,k)=>{const I=b==="home"?o:r,F=v[I+"Team"],B=b==="home"?"allié":"adverse",j=Object.entries(F).filter(([O])=>!h.length||h.includes(O)).flatMap(([O,P])=>P.filter(V=>!V.used).map(V=>({...V,_line:O})));if(!j.length){v.log.push({text:`🎯 Aucun joueur ${B}`,type:"info"}),k(v);return}R(j,m,`Choisir ${m} joueur(s) ${B}(s) (-${f})`,O=>{O.forEach(P=>{const V=(F[P._line]||[]).find(Q=>Q.cardId===P.cardId);V&&(V.boost=(V.boost||0)-f,v.log.push({text:`🎯 -${f} sur ${V.name}`,type:"info"}))}),v[I+"Team"]=F,k(v)})},GRAY_PLAYER:({count:f=1,roles:m=[],target:h="ai"},b,v)=>{const k=h==="home"?o:r,I=b[k+"Team"],F=h==="home"?"allié":"adverse",B=Object.entries(I).filter(([j])=>!m.length||m.includes(j)).flatMap(([j,O])=>O.filter(P=>!P.used).map(P=>({...P,_line:j})));if(!B.length){b.log.push({text:`❌ Aucun joueur ${F}`,type:"info"}),v(b);return}R(B,f,`Choisir ${f} joueur(s) ${F}(s) à exclure`,j=>{j.forEach(O=>{const P=(I[O._line]||[]).find(V=>V.cardId===O.cardId);P&&(P.used=!0,b.log.push({text:`❌ ${P.name} exclu !`,type:"info"}))}),b[k+"Team"]=I,v(b)})},REVIVE_PLAYER:({count:f=1,roles:m=[]},h,b)=>{const v=h[o+"Team"],k=Object.entries(v).filter(([I])=>!m.length||m.includes(I)).flatMap(([I,F])=>F.filter(B=>B.used).map(B=>({...B,_line:I})));if(!k.length){h.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),b(h);return}R(k,f,`Choisir ${f} joueur(s) à ressusciter`,I=>{I.forEach(F=>{const B=(v[F._line]||[]).find(j=>j.cardId===F.cardId);B&&(B.used=!1,h.log.push({text:`💫 ${B.name} ressuscité !`,type:"info"}))}),h[o+"Team"]=v,b(h)})},REMOVE_GOAL:({},f,m)=>{const h=r+"Score";f[h]>0?(f[h]--,f.log.push({text:"🚫 Dernier but annulé !",type:"info"})):f.log.push({text:"🚫 Aucun but à annuler",type:"info"}),m(f)},ADD_GOAL_DRAW:({},f,m)=>{f[o+"Score"]===f[r+"Score"]?(f[o+"Score"]++,f.log.push({text:"🎯 But bonus !",type:"info"})):f.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),m(f)},ADD_SUB:({value:f=1},m,h)=>{m.maxSubs=(m.maxSubs||3)+f,m.log.push({text:`🔄 +${f} remplacement(s)`,type:"info"}),h(m)},CUSTOM:({},f,m)=>m(f)};function R(f,m,h,b){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let k=[];function I(){var B,j;const F=f.map(O=>{const P={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[O._line]||"#555",V=re(O,O._line)+(O.boost||0),W=k.find(Y=>Y.cardId===O.cardId)?"#FFD700":"rgba(255,255,255,0.25)",le=O.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${O.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${W};background:${P};overflow:hidden;cursor:pointer;${le}">
        ...
        </div>`,(B=v.querySelector("#pp-close"))==null||B.addEventListener("click",()=>v.remove()),v.querySelectorAll(".pp-item").forEach(O=>{O.addEventListener("click",()=>{const P=O.dataset.cid,V=f.find(W=>W.cardId===P),Q=k.findIndex(W=>W.cardId===P);V&&(Q>-1?k.splice(Q,1):k.length<m&&k.push(V),I())})}),(j=v.querySelector("#pp-confirm"))==null||j.addEventListener("click",()=>{v.remove(),b(k)})}I(),document.body.appendChild(v)}async function U(f,m){const b=(u["gcCardsFull_"+o]||[]).find(F=>F.id===f),v=(b==null?void 0:b._gcDef)||(u.gcDefs||[]).find(F=>{var B;return F.name===m||((B=F.name)==null?void 0:B.toLowerCase().trim())===(m==null?void 0:m.toLowerCase().trim())}),k=[...u["usedGc_"+o]||[],f];if(v!=null&&v.effect_type&&v.effect_type!=="CUSTOM"){const F=D[v.effect_type];if(F){const B={...u};F(v.effect_params||{},B,async j=>{j["usedGc_"+o]=k,await M(j)});return}}const I={...u};switch(m){case"Remplacement+":I.maxSubs=(I.maxSubs||3)+1,I.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const F=r+"Score";I[F]>0&&(I[F]--,I.log.push({text:"🚫 But annulé",type:"info"}));break}}I["usedGc_"+o]=k,await M(I)}function $(){var zt,St,Ct,jt,Bt,Ft;if(u.phase==="reveal")return q();if(u.phase==="midfield")return A();if(u.phase==="finished")return S();const f=u[o+"Team"],m=u[r+"Team"],h=u[o+"Score"],b=u[r+"Score"],v=u[o+"Name"],k=u[r+"Name"],I=u.phase===o+"-attack",F=u.phase===o+"-defense",B=!I&&!F,j=Array.isArray(u["selected_"+o])?u["selected_"+o]:[],O=j.map(H=>H.cardId),P=window.innerWidth>=700,V=u[o+"Subs"]||[],Q=u["usedSubIds_"+o]||[],W=V.filter(H=>!Q.includes(H.cardId)),le=u["gcCardsFull_"+o]||[],Y=u["usedGc_"+o]||[],ie=le.filter(H=>!Y.includes(H.id)),ae=u.boostOwner===o&&!u.boostUsed,pe=!["GK","DEF","MIL","ATT"].some(H=>(m[H]||[]).some(ee=>!ee.used)),ge=[...f.MIL||[],...f.ATT||[]].filter(H=>!H.used),ce=I&&pe&&ge.length===0?[...f.GK||[],...f.DEF||[]].filter(H=>!H.used).map(H=>H.cardId):[];function ue(H,ee,fe){var qt,Rt;const oe=H._gcDef,Be={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[oe==null?void 0:oe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",lt={purple:"#b06ce0",light_blue:"#00d4ef"}[oe==null?void 0:oe.color]||"#b06ce0",ve=(oe==null?void 0:oe.name)||H.gc_type,Ue=(oe==null?void 0:oe.effect)||((qt=ye[H.gc_type])==null?void 0:qt.desc)||"",Te=oe!=null&&oe.image_url?`/manager-wars/icons/${oe.image_url}`:null,wi=((Rt=ye[H.gc_type])==null?void 0:Rt.icon)||"⚡",Dt=Math.round(fe*.22),Gt=Math.round(fe*.22),dt=fe-Dt-Gt;return`<div class="pvp-gc-mini" data-gc-id="${H.id}" data-gc-type="${H.gc_type}" style="box-sizing:border-box;width:${ee}px;height:${fe}px;border-radius:10px;border:2px solid ${lt};background:${Be};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        ...
        <div style="height:${dt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Te?`<img src="${Te}" style="max-width:${ee-10}px;max-height:${dt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(dt*.55)}px">${wi}</span>`}
        </div>
        <div style="height:${Gt}px;background:rgba(0,0,0,0.38);display:flex;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:6px;color:rgba(255,255,255,0.9);text-align:center;line-height:1.25">${Ue.slice(0,38)}</span>
        </div>
      ...
      </div>`}const je=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${P?56:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
    ...
    </div>`,At=I?"attack":F?"defense":"idle",bi=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0" id="match-field">
      <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
        ${Oe(f,u[o+"Formation"],At,O,300,300,ce)}
      </div>
    </div>`,st=P?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",It=I?`<button id="pvp-action" style="${st};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${j.length===0&&ce.length===0&&ge.length===0||j.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:F?`<button id="pvp-action" style="${st};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${j.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="${st};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour de ${k}</div>`,Lt=I||F?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${j.length}/3 sélectionné(s)</div>`:"",He=(u.log||[]).slice(-1)[0],vi=F&&((zt=u.pendingAttack)!=null&&zt.players)?`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          <div style="font-size:8px;color:#ff6b6b;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ ${k} ATTAQUE</div>
          ${Ge(u.pendingAttack.players.map(H=>({...H,used:!1})),"#ff6b6b",u.pendingAttack.total)}
        </div>`:He?`<div style="padding:7px 10px;border-left:3px solid ${He.type==="goal"?"#FFD700":He.type==="stop"?"#00ff88":"rgba(255,255,255,0.4)"};font-size:12px;color:#fff">${He.text||""}</div>`:'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>',Mt=`
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div style="display:flex;flex:1;min-height:0;overflow:hidden">
          ...
          <div style="width:140px;flex-shrink:0;display:flex;flex-direction:column;padding:10px 8px;background:rgba(0,0,0,0.2)">
            ...
            <div style="width:100%;flex-shrink:0;padding-top:8px">${It}${Lt}</div>
          </div>
        </div>
      </div>`:e.innerHTML=`
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
            ...
            <button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
              ▶ Commencer le match
            </button>`,ue.style.transition="opacity .45s ease",ue.style.opacity="1",ue.style.pointerEvents="auto",(xe=document.getElementById("pvp-start-match"))==null||xe.addEventListener("click",async()=>{if(o!=="p1")return;const je=W;await M({phase:je+"-attack",attacker:je,round:1,boostValue:le,boostUsed:!1,boostOwner:je})}))},600)},700)},2800)}function N(f,m){var V,Q,W,le;const b=(u["gcCardsFull_"+o]||[]).find(Y=>Y.id===f),v=b==null?void 0:b._gcDef,k={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",I={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",F=(v==null?void 0:v.name)||m,B=(v==null?void 0:v.effect)||((V=ye[m])==null?void 0:V.desc)||"Carte spéciale.",j=v!=null&&v.image_url?`/manager-wars/icons/${v.image_url}`:null,O=((Q=ye[m])==null?void 0:Q.icon)||"⚡",P=document.createElement("div");P.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",P.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${I};background:${k};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${I}66">
        ...
        <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${j?`<img src="${j}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${O}</span>`}
        </div>
        <div style="padding:10px;background:rgba(0,0,0,0.38);text-align:center">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${k.map(B=>{const j={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[B._line]||"#555",O=re(B,B._line)+(B.boost||0);return`<div class="sp-item" data-cid="${B.cardId}" data-role="${B._line}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${j};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(I),(F=I.querySelector("#sp-close"))==null||F.addEventListener("click",()=>I.remove()),I.querySelectorAll(".sp-item").forEach(B=>{B.addEventListener("click",async()=>{const j=B.dataset.cid,O=B.dataset.role,P=(v[O]||[]).find(W=>W.cardId===j);if(!P)return;P.used=!0;const V={...b,_line:O,position:P.position};(v[O]=v[O]||[]).push(V);const Q=[...h,f];I.remove(),await M({[o+"Team"]:v,["usedSubIds_"+o]:Q})})})}function Z(){var m;const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",f.innerHTML=`
      ...
      </div>`,document.body.appendChild(m),(h=m.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>m.remove())}async function J(){const f=u[o+"Team"],m=!["GK","DEF","MIL","ATT"].some(k=>(u[r+"Team"][k]||[]).some(I=>!I.used)),h=(u["selected_"+o]||[]).map(k=>{const I=(f[k._role]||[]).find(B=>B.cardId===k.cardId)||k,F=m&&["GK","DEF"].includes(k._role);return{...I,_line:k._role,...F?{note_a:Math.max(1,Number(I.note_a)||0)}:{}}});if(!h.length)return;const b=bt(h,u.modifiers[o]||{});h.forEach(k=>{const I=(f[k._role]||[]).find(F=>F.cardId===k.cardId);I&&(I.used=!0)});const v=[...u.log||[]];if(v.push({type:"attack",text:`⚔️ ${u[o+"Name"]} attaque (${b.total})`,players:h,total:b.total,side:o}),m){u[o+"Score"]++,v.push({type:"goal",text:"⚽ BUT ! L'adversaire n'a plus de joueurs."});const k=(u.round||0)+1,I=o==="p1"?"p2":"p1",F=X({...u,[o+"Team"]:f});await M({[o+"Team"]:f,["selected_"+o]:[],modifiers:{...u.modifiers,[o]:{}},pendingAttack:null,phase:F?"finished":I+"-attack",attacker:I,round:k,log:v}),F&&await C.from("matches").update({status:"finished"}).eq("id",i);return}await M({[o+"Team"]:f,pendingAttack:{...b,players:h,side:o},["selected_"+o]:[],modifiers:{...u.modifiers,[o]:{}},phase:r+"-defense",log:v})}async function de(){const f=u[o+"Team"],m=(u["selected_"+o]||[]).map(W=>({...(f[W._role]||[]).find(Y=>Y.cardId===W.cardId)||W,_line:W._role})),h=vt(m,u.modifiers[o]||{});m.forEach(W=>{const le=(f[W._role]||[]).find(Y=>Y.cardId===W.cardId);le&&(le.used=!0)});const b=wt(u.pendingAttack.total,h.total,u.modifiers[o]||{}),v=u.pendingAttack.side,k=b==="attack"||(b==null?void 0:b.goal),I=v==="p1"?"p2":"p1",F=(u.round||0)+1,B={...u,[o+"Team"]:f};k&&(B[v+"Score"]=(u[v+"Score"]||0)+1);const j=[...u.log||[]];j.push({type:"defense",text:`🛡️ ${u[o+"Name"]} défend (${h.total})`}),j.push({type:k?"goal":"stop",text:k?`⚽ BUT de ${u[v+"Name"]} ! (${u.pendingAttack.total} vs ${h.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${h.total})`});const O=X(B),P=[...B[I+"Team"].MIL||[],...B[I+"Team"].ATT||[]].filter(W=>!W.used),V=[...B[I+"Team"].GK||[],...B[I+"Team"].DEF||[],...B[I+"Team"].MIL||[]].filter(W=>!W.used);let Q=I+"-attack";!P.length&&!V.length?Q="finished":!P.length&&V.length&&(Q=I+"-attack"),await M({...B,["selected_"+o]:[],modifiers:{...u.modifiers,[o]:{}},pendingAttack:null,phase:O?"finished":Q,attacker:I,round:F,log:j}),O&&await C.from("matches").update({status:"finished"}).eq("id",i)}function X(f){const m=["MIL","ATT","GK","DEF"].some(b=>(f.p1Team[b]||[]).some(v=>!v.used)),h=["MIL","ATT","GK","DEF"].some(b=>(f.p2Team[b]||[]).some(v=>!v.used));return!m&&!h}function S(){var v;const f=u[o+"Score"],m=u[r+"Score"],h=f>m,b=f===m;we(e),e.innerHTML=`
  ...
  `;function c(o){const r=document.getElementById("mkt-content"),p=o==="buy"?a:l;if(p.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${g.map(x=>{var z,w,M,T;const E=(z=x.card)==null?void 0:z.player;if(!E)return"";const u=E.job==="GK"?E.note_g:E.job==="DEF"?E.note_d:E.job==="MIL"?E.note_m:E.note_a,y=Io[E.rarity],L=(i.profile.credits||0)>=x.price,_=x.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${_?"opacity:0.65":""}">
  ...
  </div>`}const ne={user:null,profile:null,page:"home",params:{}};function Xe(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Bo(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function xt(){document.getElementById("modal-overlay").classList.add("hidden")}async function Je(){if(!ne.user)return;const{data:e}=await C.from("users").select("*").eq("id",ne.user.id).single();e&&(ne.profile=e)}const Tt="mw_theme";function nt(){return localStorage.getItem(Tt)||"light"}function Fo(e){var t;localStorage.setItem(Tt,e),yt(e),(t=ne.profile)!=null&&t.id&&C.from("users").update({theme:e}).eq("id",ne.profile.id).then(()=>{})}function yt(e){document.documentElement.setAttribute("data-theme",e)}function Qe(e,t={}){ne.page=e,ne.params=t,yi()}async function yi(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(n=>{n.classList.toggle("active",n.dataset.page===ne.page)});const t=document.getElementById("nav-credits");t&&ne.profile&&(t.textContent=`💰 ${(ne.profile.credits||0).toLocaleString("fr")}`);const i={state:ne,navigate:Qe,toast:Xe,openModal:Bo,closeModal:xt,refreshProfile:Je};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ne.page){case"home":await Pt(e,i);break;case"collection":await Mi(e,i);break;case"decks":await pt(e,i);break;case"boosters":await Ki(e,i);break;case"match":{(ne.params&&ne.params.matchMode||"vs_ai_easy")==="random"?await Eo(e,i):await lo(e,i);break}case"market":await Lo(e,i);break;case"rankings":await Co(e,i);break;case"matches":await jo(e,i);break;default:await Pt(e,i)}}function Do(){const e=document.getElementById("app"),t=ne.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",d=>{d.preventDefault(),Qe(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Qe("home")),document.getElementById("nav-credits").addEventListener("click",()=>Qe("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const d=nt()==="dark"?"light":"dark";Fo(d),Zt(d)}),Zt(nt())}function Zt(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function Go(){yt(nt()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&xt()}),document.getElementById("modal-close").addEventListener("click",xt);const{data:{session:e}}=await C.auth.getSession();if(!e){ti(),Nt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Xe});return}ne.user=e.user,await Je(),ti();try{const{data:t}=await C.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(n=>{i[n.formation]=n.links}),$i(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!ne.profile){_i(document.getElementById("app"),{state:ne,navigate:async()=>{await Je(),ei()},toast:Xe,refreshProfile:Je});return}ne.profile.theme&&ne.profile.theme!==nt()&&(localStorage.setItem(Tt,ne.profile.theme),yt(ne.profile.theme)),ei(),C.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(ne.user=null,ne.profile=null,document.getElementById("app").innerHTML="",Nt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Xe}))})}function qo(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function at(){const e=document.getElementById("app");e&&(e.style.height=qo()+"px")}window.addEventListener("resize",at);window.addEventListener("orientationchange",()=>setTimeout(at,150));window.visualViewport&&window.visualViewport.addEventListener("resize",at);function ei(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",at(),Do(),yi()}function ti(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function hi(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}Go().catch(e=>{console.error("Échec du démarrage:",e),hi()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&hi("Le serveur met trop de temps à répondre.")},12e3);
