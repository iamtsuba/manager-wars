import{s as k,F as et,b as Me,c as Bt,l as ge,d as ri}from"./formation-links-CDBKB_z4.js";function _t(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  </div>`}async function fi(e,t){const{state:i,navigate:a,toast:c,openModal:n,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await k.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const $e=1e3;function mi(e,t,i,a){var p,x,A;const{state:c,toast:n,closeModal:s,navigate:d,refreshProfile:l}=i,o=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const h=Me[o]||{},m=et[o]||[],_=290,j=360,M=20;function y(R){const b=h[R];return b?{x:b.x*_,y:b.y*j}:null}let z=`<svg width="${_}" height="${j}" viewBox="0 0 ${_} ${j}" xmlns="http://www.w3.org/2000/svg">`;for(const[R,b]of m){const F=y(R),O=y(b);!F||!O||(z+=`<line x1="${F.x}" y1="${F.y}" x2="${O.x}" y2="${O.y}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(p=document.getElementById("direct-sell-form-btn"))==null||p.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${o} pour ${$e.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const h=g.find(_=>!_.is_for_sale)||g[0];if(!h){n("Aucune carte à vendre","error");return}const{error:m}=await k.from("cards").delete().eq("id",h.id);if(m){n(m.message,"error");return}await k.from("users").update({credits:(c.profile.credits||0)+$e}).eq("id",c.profile.id),await l(),n(`+${$e.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),d("collection")}),(x=document.getElementById("market-sell-form-btn"))==null||x.addEventListener("click",async()=>{const h=parseInt(document.getElementById("sell-price-form").value);if(!h||h<1){n("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:h}).eq("id",e.id),await k.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:h}),n("Carte mise en vente sur le marché !","success"),s(),d("collection")}),(A=document.getElementById("cancel-sell-form-btn"))==null||A.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),n("Annonce retirée","success"),s(),d("collection")})}async function At(e,t,i,a){var z,R,b,F,O,H;const{state:c,toast:n,openModal:s,closeModal:d,navigate:l,refreshProfile:o}=a,r=e.player,u=t.filter(K=>K.player.id===r.id),g=u.length,f=ui[r.rarity]||1e3,C=r.rarity!=="legende",p=Gt(r),x=Ie(r,r.job),A=r.job2?Ie(r,r.job2):null,h=Ge[r.job]||"#1A6B3C",m=r.job2?Ge[r.job2]:null,_=qt[r.rarity]||"#ccc",j=nt[r.country_code]||r.country_code||"",{data:M}=await k.from("transfer_history").select("club_name, manager_name, source, price, transferred_at").eq("player_id",r.id).order("transferred_at",{ascending:!0}),y=M&&M.length?`
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
  ...
  `,document.body.appendChild(a);let c=!1;const n=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=b=>b.touches&&b.touches[0]?b.touches[0].clientX:b.clientX;function o(b){c||(d=!0,s.style.opacity="1",r(b))}function r(b){if(!d||c)return;const F=n.getBoundingClientRect(),O=l(b)-F.left,H=Math.max(0,Math.min(1,O/F.width));s.style.width=H*F.width+"px",H>=.82&&g()}function u(){c||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{c||(s.style.transition="")},220))}function g(){var F;if(c)return;c=!0,d=!1,s.style.width="100%",s.style.opacity="1",(F=document.getElementById("cut-flash"))==null||F.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const b=document.getElementById("cut-hint");b&&(b.style.opacity="0"),n.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",p(0)},620)}n.addEventListener("pointerdown",o),window.addEventListener("pointermove",r),window.addEventListener("pointerup",u),n.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",r,{passive:!0}),window.addEventListener("touchend",u);let f=0;const C=new Set;function p(b){f=b,document.getElementById("reveal-phase").style.display="flex",x(),A(b,0),j()}function x(){const b=document.getElementById("card-dots");b&&(b.innerHTML=e.map((F,O)=>`<div class="card-dot" data-i="${O}" style="width:8px;height:8px;border-radius:50%;background:${O===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),b.querySelectorAll(".card-dot").forEach(F=>F.addEventListener("click",()=>h(parseInt(F.dataset.i)))))}function A(b,F){var B;const O=e[b],H=document.getElementById("card-counter"),K=document.getElementById("card-track");H&&(H.textContent=`Carte ${b+1} / ${e.length}`);const W=O.card_type==="player"&&((B=O.player)==null?void 0:B.rarity)==="legende",I=!C.has(b);C.add(b),K.innerHTML=`
      <div id="current-card-wrap" style="display:flex;flex-direction:column;align-items:center;gap:8px;${W?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
        <div style="transform:scale(1.3);transform-origin:center">${Di(O)}</div>
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const Ri="simulation",Ht="VOTRE_ZONE_ID";function Ni(){switch(Ri){case"propellerads":return Pi();case"adsense":return Oi();default:return rt()}}function rt(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(C=>{C.addEventListener("click",()=>{const p=C.dataset.id,x=n.find(h=>h.id===p);if(!x)return;const A=s.findIndex(h=>h.gc_type===x.gc_type);A>-1?s.splice(A,1):s.length<3&&s.push(x),o()})}),(u=e.querySelector("#gc-launch"))==null||u.addEventListener("click",()=>{r&&l(s)}),(g=e.querySelector("#gc-no-gc"))==null||g.addEventListener("click",()=>l([])),(f=e.querySelector("#gc-reset"))==null||f.addEventListener("click",()=>{s.length&&(s=[],o())})}o()}async function Hi(e,t,i){const{state:a,navigate:c}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await k.from("decks").select("id,name,is_active,formation").eq("owner_id",a.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){fe(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>c("decks"));return}const s=n.map(r=>r.id),{data:d}=await k.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let l=0;function o(){var h,m,_,j,M;const r=n[l],u=(d||[]).filter(y=>y.deck_id===r.id),g=u.filter(y=>{var z;return y.is_starter&&((z=y.card)==null?void 0:z.player)}).map(y=>We(y.card,y.position)),f=u.find(y=>{var z;return((z=y.card)==null?void 0:z.card_type)==="formation"}),C=r.formation||((h=f==null?void 0:f.card)==null?void 0:h.formation)||"4-4-2",p=g.length>=11?Pe(g,C):null,x=g.length>=11;Ut(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center;padding:4px">
        ${p?`<div class="deck-preview-wrap" style="aspect-ratio:1/1;max-width:100%;max-height:100%;width:auto;height:100%;overflow:hidden">${Te(p,C,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
  ...
  </div>`,setTimeout(()=>Wi(e,t,i),5e3)}function Wi(e,t,i){const a=t.homeTeam.MIL||[],c=t.aiTeam.MIL||[];function n(p){return p.reduce((x,A)=>x+ie(A,"MIL"),0)}function s(p){let x=0;for(let A=0;A<p.length-1;A++){const h=ge(p[A],p[A+1]);h==="#00ff88"?x+=2:h==="#FFD700"&&(x+=1)}return x}const d=n(a)+s(a),l=n(c)+s(c),o=d>=l;function r(p,x,A,h){return`<div id="duel-row-${h}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,j.style.transition="opacity .45s ease",j.style.opacity="1",j.style.pointerEvents="auto",(M=document.getElementById("start-match-btn"))==null||M.addEventListener("click",C))},600)},700)},2800)}function Xi(e){if(e.type==="duel"){const t=e.homeTotal>=e.aiTotal;return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const z=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const y=t.log[t.log.length-1];return y?'<div style="padding:2px 4px">'+Xi(y)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const y=window.innerWidth>=700,z=(L,B,N)=>{var Y,J;const E=(t.gcDefs||[]).find(te=>te.name===L.gc_type),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[E==null?void 0:E.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[E==null?void 0:E.color]||"#b06ce0",D=(E==null?void 0:E.name)||L.gc_type,T=(E==null?void 0:E.effect)||((Y=de[L.gc_type])==null?void 0:Y.desc)||"",$=E!=null&&E.image_url?`/manager-wars/icons/${E.image_url}`:null,G=((J=de[L.gc_type])==null?void 0:J.icon)||"⚡",S=Math.round(N*.22),P=Math.round(N*.22),q=N-S-P,V=D.length>12?7:9;return`<div class="gc-mini" data-gc-id="${L.id}" data-gc-type="${L.gc_type}"
        ...
        <div style="display:flex;flex:0.8;min-height:0;overflow:hidden">
          ...
          <div style="width:140px;flex-shrink:0;display:flex;flex-direction:column;padding:10px 8px;background:rgba(0,0,0,0.2)">
            ...
            <div style="width:100%;flex-shrink:0;padding-top:8px">${H}${K}</div>
          </div>
        </div>`:`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(y=>{var z,R,b;if(y.type==="duel"){const F=y.isGoal,O=y.homeScored?"#FFD700":F?"#ff6b6b":"rgba(255,255,255,0.3)",H=y.homeScored?"⚽ BUT !":F?"⚽ BUT IA !":(z=y.homePlayers)!=null&&z.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${F?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${O};margin-bottom:4px">
                ...
                ${(b=y.aiPlayers)!=null&&b.length?`<div style="opacity:0.7">${Ee(y.aiPlayers,"#ff6b6b",y.aiTotal)}</div>`:""}
  ...
  `,document.body.appendChild(a);let r=!1;const u=()=>{r||(r=!0,a.remove(),i())};a.addEventListener("click",u),setTimeout(u,2e3)}function ke(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function zt(e,t,i,a=null){if(t.phase!=="attack"){ke("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){ke(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const c=Object.values(t.homeTeam).flat().filter(u=>u.used),n=t.homeSubs.filter(u=>!t.usedSubIds.includes(u.cardId));if(!c.length){ke("Aucun joueur utilisé à remplacer");return}if(!n.length){ke("Aucun remplaçant disponible");return}let s=0,d=Math.max(0,n.findIndex(u=>u.cardId===a)),l=!1;const o=document.createElement("div");o.id="sub-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function r(){var A,h,m,_,j,M;const u=c[s],g=n[d],f=Math.min(130,Math.round((window.innerWidth-90)/2)),C=Math.round(f*1.35),p=y=>`background:rgba(255,255,255,0.12);border:none;color:${y?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${y?"default":"pointer"};flex-shrink:0`;o.innerHTML=`
    ...
    </div>`,(A=o.querySelector("#sub-close"))==null||A.addEventListener("click",()=>o.remove()),(h=o.querySelector("#out-up"))==null||h.addEventListener("click",()=>{s>0&&(s--,r())}),(m=o.querySelector("#out-down"))==null||m.addEventListener("click",()=>{s<c.length-1&&(s++,r())}),(_=o.querySelector("#in-up"))==null||_.addEventListener("click",()=>{d>0&&(d--,r())}),(j=o.querySelector("#in-down"))==null||j.addEventListener("click",()=>{d<n.length-1&&(d++,r())});const x=(y,z,R,b)=>{const F=o.querySelector("#"+y);if(!F)return;let O=0;F.addEventListener("touchstart",H=>{O=H.touches[0].clientY},{passive:!0}),F.addEventListener("touchend",H=>{const K=H.changedTouches[0].clientY-O;if(Math.abs(K)<30)return;const W=z();K<0&&W<b-1?(R(W+1),r()):K>0&&W>0&&(R(W-1),r())},{passive:!0})};x("in-panel",()=>d,y=>d=y,n.length),x("out-panel",()=>s,y=>s=y,c.length),(M=o.querySelector("#sub-confirm"))==null||M.addEventListener("click",y=>{if(y.preventDefault(),y.stopPropagation(),l)return;l=!0;const z=c[s],R=n[d];if(!z||!R)return;let b=null,F=-1;for(const[H,K]of Object.entries(t.homeTeam)){const W=(K||[]).findIndex(I=>I.cardId===z.cardId);if(W!==-1){b=H,F=W;break}}if(F===-1||!b){ke("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),o.remove();return}const O={...R,_line:b,_col:z._col||0,used:!1,boost:0};t.homeTeam[b].splice(F,1,O),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(R.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:z.name,firstname:z.firstname,note:ie(z,b),portrait:ne(z),job:z.job,country_code:z.country_code,rarity:z.rarity,clubName:z.clubName,clubLogo:z.clubLogo},inPlayer:{name:R.name,firstname:R.firstname,note:ie(R,b),portrait:ne(R),job:R.job,country_code:R.country_code,rarity:R.rarity,clubName:R.clubName,clubLogo:R.clubLogo},text:`🔄 ${R.firstname} ${R.name} remplace ${z.firstname} ${z.name}`}),o.remove(),to(z,R,()=>oe(e,t,i))})}document.body.appendChild(o),r()}function io(e,t,i,a,c){var C,p;const n=(a.gcDefs||[]).find(x=>x.name===t),s=de[t]||{icon:"⚡",desc:"Carte spéciale."},d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[n==null?void 0:n.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[n==null?void 0:n.color]||"#b06ce0",o=(n==null?void 0:n.name)||t,r=(n==null?void 0:n.effect)||s.desc,u=n!=null&&n.image_url?`/manager-wars/icons/${n.image_url}`:null,g=s.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(n);let d=!1;const l=()=>{d||(d=!0,n.remove(),setTimeout(()=>c(),50))};n.addEventListener("click",l),setTimeout(l,3500)}async function ve(e,t,i){var r,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=i,c=t.homeScore>t.aiScore,n=t.homeScore===t.aiScore,s=c?"victoire":n?"nul":"defaite",d=ci(t.mode,s);t.matchId&&await k.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(a.profile.credits||0)+d,matches_played:(a.profile.matches_played||0)+1};c?l.wins=(a.profile.wins||0)+1:n?l.draws=(a.profile.draws||0)+1:l.losses=(a.profile.losses||0)+1,await k.from("users").update(l).eq("id",a.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const f=()=>document.getElementById("mm-status"),C=async(m=!0)=>{u=!0,g&&(k.removeChannel(g),g=null),m&&await k.rpc("cancel_matchmaking",{p_user_id:l.profile.id}).catch(()=>{})};(h=document.getElementById("mm-cancel"))==null||h.addEventListener("click",async()=>{try{await C(!0)}catch(m){console.warn("[Matchmaking] cleanup error:",m)}le(e),o("home")});const p=async(m,_,j)=>{u||(u=!0,g&&(k.removeChannel(g),g=null),f()&&(f().textContent="Adversaire trouvé !"),await new Promise(M=>setTimeout(M,600)),e.isConnected!==!1&&lo(e,t,m,j,s,d))},{data:x,error:A}=await k.rpc("try_matchmake",{p_user_id:l.profile.id,p_deck_id:i});if(A||!(x!=null&&x.success)){r("Erreur de matchmaking","error"),le(e),o("home");return}if(x.matched){p(x.match_id,x.opponent_id,!1);return}f()&&(f().textContent="En attente d'un autre joueur..."),g=k.channel("matchmaking-"+l.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${l.profile.id}`},m=>{const _=m.new;_.status==="matched"&&_.match_id&&p(_.match_id,_.matched_with,!0)}).subscribe()}async function lo(e,t,i,a,c=[],n=[]){const{state:s,navigate:d,toast:l}=t,o=a?"p1":"p2",r=a?"p2":"p1",u=(c||[]).map(I=>I.id),g=(c||[]).map(I=>({id:I.id,gc_type:I.gc_type,_gcDef:I._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation du match...</div>';const{data:f}=await k.from("matches").select("*").eq("id",i).single();if(!f){l("Match introuvable","error"),d("home");return}async function C(){const[{data:I,error:L},{data:B,error:N},{data:E},{data:v}]=await Promise.all([k.rpc("get_deck_for_match",{p_deck_id:f.home_deck_id}),k.rpc("get_deck_for_match",{p_deck_id:f.away_deck_id}),k.from("users").select("id,pseudo,club_name").eq("id",f.home_id).single(),k.from("users").select("id,pseudo,club_name").eq("id",f.away_id).single()]);L&&console.error("[PvP] get_deck_for_match p1 error:",L),N&&console.error("[PvP] get_deck_for_match p2 error:",N);function w(q,V){return{cardId:q.card_id,position:V||q.position,id:q.id,firstname:q.firstname,name:q.surname_encoded,country_code:q.country_code,club_id:q.club_id,job:q.job,job2:q.job2,note_g:Number(q.note_g)||0,note_d:Number(q.note_d)||0,note_m:Number(q.note_m)||0,note_a:Number(q.note_a)||0,rarity:q.rarity,skin:q.skin,hair:q.hair,hair_length:q.hair_length,clubName:q.club_encoded_name||null,clubLogo:q.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}}const D=((I==null?void 0:I.starters)||[]).map(q=>w(q,q.position)),T=((B==null?void 0:B.starters)||[]).map(q=>w(q,q.position)),$=((I==null?void 0:I.subs)||[]).map(q=>w(q,q.position)),G=((B==null?void 0:B.subs)||[]).map(q=>w(q,q.position)),S=(I==null?void 0:I.formation)||"4-4-2",P=(B==null?void 0:B.formation)||"4-4-2";return console.log("[PvP] p1Formation:",S,"p1 starters:",D.length,"positions:",D.map(q=>q.position)),console.log("[PvP] p2Formation:",P,"p2 starters:",T.length,"positions:",T.map(q=>q.position)),{p1Team:Pe(D,S),p2Team:Pe(T,P),p1Subs:$,p2Subs:G,p1Formation:S,p2Formation:P,p1Name:(E==null?void 0:E.club_name)||(E==null?void 0:E.pseudo)||"Joueur 1",p2Name:(v==null?void 0:v.club_name)||(v==null?void 0:v.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?u:[],gc_p2:a?[]:u,gcCardsFull_p1:a?g:[],gcCardsFull_p2:a?[]:g,gcReady_p1:!0,gcReady_p2:!0,usedGc_p1:[],usedGc_p2:[],lastActionAt:new Date().toISOString()}}let p=f.game_state&&Object.keys(f.game_state).length?f.game_state:null;if(!p)if(a){p=await C();const{data:I}=await k.from("matches").select("game_state").eq("id",i).single();!(I!=null&&I.game_state)||!Object.keys(I.game_state).length?await k.from("matches").update({game_state:p,turn_user_id:f.home_id}).eq("id",i):p=I.game_state}else{e.innerHTML=`<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation avec l'adversaire...</div>`;for(let I=0;I<30&&!p;I++){await new Promise(B=>setTimeout(B,400));const{data:L}=await k.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(p=L.game_state)}if(!p){l("Erreur de synchronisation","error"),d("home");return}p.gc_p2=u,p.gcCardsFull_p2=g,await k.from("matches").update({game_state:p}).eq("id",i)}let x=!1;function A(I){var D;try{k.removeChannel(h)}catch{}const L=s.profile.id,B=I.winner_id===L,N=!!I.forfeit,E=p[o+"Score"]??0,v=p[r+"Score"]??0,w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center",w.innerHTML=`
      ...
      ${q.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':q.map(U=>`<div class="pvp-sub-btn" data-sub-id="${U.cardId}" style="cursor:pointer;flex-shrink:0">${pe(U,G?60:44,G?78:58)}</div>`).join("")}
    </div>`,me=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0" id="match-field">
      <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
        ${Te(I,p[o+"Formation"],v?"attack":w?"defense":"idle",$,300,300)}
      </div>
    </div>`,ye=G?"padding:14px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:10px 8px;border-radius:12px;font-size:13px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ze=v?`<button id="pvp-action" style="${ye};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${T.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:w?`<button id="pvp-action" style="${ye};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${T.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="${ye};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour de ${E}</div>`,ct=v||w?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${T.length}/3 sélectionné(s)</div>`:"",ei=(()=>{const U=p.pendingAttack;if(w&&U&&Array.isArray(U.players))return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;const U=e.querySelector(".terrain-wrapper");U&&(U.innerHTML=Te(I,p[o+"Formation"],v?"attack":w?"defense":"idle",$,300,300))}if(e.querySelectorAll(".match-slot-hit").forEach(U=>{U.addEventListener("click",()=>{if(!v&&!w)return;const Z=U.dataset.cardId,ee=U.dataset.role,X=(I[ee]||[]).find(xe=>xe.cardId===Z);if(!X||X.used)return;Array.isArray(p["selected_"+o])||(p["selected_"+o]=[]);const ce=p["selected_"+o],Ce=ce.findIndex(xe=>xe.cardId===Z);Ce>-1?ce.splice(Ce,1):ce.length<3&&ce.push({...X,_role:ee}),j()})}),(ut=e.querySelector("#pvp-boost-card"))==null||ut.addEventListener("click",()=>{R()}),e.querySelectorAll(".pvp-gc-mini").forEach(U=>{U.addEventListener("click",()=>{O(U.dataset.gcId,U.dataset.gcType)})}),(ft=e.querySelector("#pvp-action"))==null||ft.addEventListener("click",()=>{v?K():w&&W()}),(gt=e.querySelector("#pvp-quit"))==null||gt.addEventListener("click",()=>{confirm("Quitter le match ? Vous perdrez par forfait.")&&_()}),(mt=e.querySelector("#pvp-view-opp"))==null||mt.addEventListener("click",()=>{F()}),(yt=e.querySelector("#pvp-toggle-history"))==null||yt.addEventListener("click",()=>{b()}),function(){const Z=e.querySelector(".terrain-wrapper svg");Z&&(Z.removeAttribute("width"),Z.removeAttribute("height"),Z.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Z.setAttribute("viewBox","-26 -26 352 352"),Z.setAttribute("preserveAspectRatio","xMidYMid meet"));const ee=e.querySelector(".match-screen");if(ee){const X=e.clientHeight;X>50&&(ee.style.height=X+"px",ee.style.maxHeight=X+"px",ee.style.overflow="hidden")}}(),p._timerInt&&(clearInterval(p._timerInt),p._timerInt=null),(v||w)&&!x){let U=30,Z=!1;const ee=()=>document.getElementById("pvp-timer"),X=()=>{ee()&&(ee().textContent=U+"s",ee().style.color=Z?"#ff4444":"#fff")};X(),p._timerInt=setInterval(()=>{U--,U<0?Z?(clearInterval(p._timerInt),p._timerInt=null,_()):(Z=!0,U=15,X()):X()},1e3)}}function M(){var w;const I=p["gcReady_"+o],L=p["gcReady_"+r];Array.isArray(p["gc_"+o])||(p["gc_"+o]=[]);let B=p["gc_"+o];const N=3;function E(D,T){const $=D._gcDef,G={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},S={purple:"#9b59b6",light_blue:"#00bcd4"},P=G[$==null?void 0:$.color]||G.purple,q=S[$==null?void 0:$.color]||S.purple;return`<div class="pvp-gc-card" data-id="${D.id}"
    ...
    </div>`,setTimeout(()=>{const T=document.getElementById("pvp-score-me"),$=document.getElementById("pvp-score-opp"),G=document.getElementById("pvp-midfield-result");T&&$&&(w?(T.style.fontSize="80px",T.style.color="#FFD700",$.style.opacity="0.25"):($.style.fontSize="80px",$.style.color="#ff6b6b",T.style.opacity="0.25"));const S=p.p1Team.MIL||[],P=p.p2Team.MIL||[],q=B(S)+N(S),V=B(P)+N(P),Y=q>=V?"p1":"p2";p[Y+"Name"];let J=p.boostValue;J==null&&(J=Kt(),p.boostValue=J,p.boostOwner=Y,p.boostUsed=!1),G&&(G.style.opacity="1",G.innerHTML=`<div style="font-size:20px;font-weight:900;margin-bottom:10px">
    ...
    </div>`,(E=document.getElementById("pvp-home"))==null||E.addEventListener("click",()=>{k.removeChannel(h),le(e),d("home")})}async function K(){const I=(p["selected_"+o]||[]).map(N=>({...(p[o+"Team"][N._role]||[]).find(v=>v.cardId===N.cardId)||N,_line:N._role}));if(!I.length)return;const L=tt(I,p.modifiers[o]||{});I.forEach(N=>{const E=(p[o+"Team"][N._role]||[]).find(v=>v.cardId===N.cardId);E&&(E.used=!0)});const B=Array.isArray(p.log)?p.log:[];B.push({type:"attack",text:`⚔️ ${p[o+"Name"]} attaque (${L.total})`,players:I,total:L.total,side:o}),await m({pendingAttack:{...L,players:I,side:o},["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},phase:r+"-defense",log:B})}async function W(){const I=(p["selected_"+o]||[]).map(G=>({...(p[o+"Team"][G._role]||[]).find(P=>P.cardId===G.cardId)||G,_line:G._role})),L=it(I,p.modifiers[o]||{});I.forEach(G=>{const S=(p[o+"Team"][G._role]||[]).find(P=>P.cardId===G.cardId);S&&(S.used=!0)});const B=ot(p.pendingAttack.total,L.total,p.modifiers[o]||{}),N=p.pendingAttack.side,E=B==="attack",v=p[N+"Score"]+(E?1:0),w=N==="p1"?"p2":"p1",D=(p.round||0)+1,T=D>10,$=Array.isArray(p.log)?p.log:[];$.push({type:"defense",text:`🛡️ ${p[o+"Name"]} défend (${L.total})`,players:I,total:L.total,side:o}),$.push({type:E?"goal":"stop",text:E?`⚽ BUT de ${p[N+"Name"]} ! (${p.pendingAttack.total} vs ${L.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${L.total})`}),await m({[N+"Score"]:v,["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},pendingAttack:null,phase:T?"finished":w+"-attack",attacker:w,round:D,log:$}),T&&await k.from("matches").update({status:"finished"}).eq("id",i)}j()}const co={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function po(e,t){const{state:i,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await dt(e,t)}async function dt(e,t){const{state:i,toast:a}=t,{data:c}=await k.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(o){const r=document.getElementById("mkt-content"),u=o==="buy"?s:d;if(u.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${g.map(f=>{var m,_,j,M;const C=(m=f.card)==null?void 0:m.player;if(!C)return"";const p=C.job==="GK"?C.note_g:C.job==="DEF"?C.note_d:C.job==="MIL"?C.note_m:C.note_a,x=co[C.rarity],A=(i.profile.credits||0)>=f.price,h=f.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${h?"opacity:0.65":""}">
          <div style="width:44px;height:44px;border-radius:8px;background:${go(C.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${x};flex-shrink:0">${p}</div>
          <div style="flex:1;min-width:0">
  ...
  `}async function yo(e,{state:t,navigate:i,toast:a}){const c=t.profile;if(!c)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await k.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(a=>{a.addEventListener("click",c=>{c.preventDefault(),qe(a.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>qe("home")),document.getElementById("nav-credits").addEventListener("click",()=>qe("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const c=Oe()==="dark"?"light":"dark";ho(c),Ct(c)}),Ct(Oe())}function Ct(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function bo(){Qe(Oe()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&Ze()}),document.getElementById("modal-close").addEventListener("click",Ze);const{data:{session:e}}=await k.auth.getSession();if(!e){jt(),_t(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Fe});return}Q.user=e.user,await De(),jt();try{const{data:t}=await k.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(a=>{i[a.formation]=a.links}),ri(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!Q.profile){ai(document.getElementById("app"),{state:Q,navigate:async()=>{await De(),St()},toast:Fe,refreshProfile:De});return}Q.profile.theme&&Q.profile.theme!==Oe()&&(localStorage.setItem(lt,Q.profile.theme),Qe(Q.profile.theme)),St(),k.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(Q.user=null,Q.profile=null,document.getElementById("app").innerHTML="",_t(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Fe}))})}function wo(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Ke(){const e=document.getElementById("app");e&&(e.style.height=wo()+"px")}window.addEventListener("resize",Ke);window.addEventListener("orientationchange",()=>setTimeout(Ke,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Ke);function St(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Ke(),vo(),Qt()}function jt(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}bo();
