...
import{s as w,F as li,r as Ie,j as At,l as Hi,m as Ct,h as ci,n as vn,o as wn,T as Yt,k as _n,p as kn,b as $n}from"./formation-links-TDtFd05S.js";const En="/";function Mi(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,l,c,d,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(u){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(u){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await Tn(t.user.id),await a(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function Tn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const zn="modulepreload",In=function(e){return"/"+e},Si={},Ui=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(l=>{if(l=In(l),l in Si)return;Si[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":zn,c||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),c)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},zt="#1A6B3C",It="#cc2222",Mn="#D4A017",Ai="#888";async function Sn(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`}function Cn(e,t){const i=pi();i.innerHTML=`
    <div class="popup-box">
    ...
    </style>`}const Bn="2026.07.16-1136";async function Ci(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(z=>{z.addEventListener("click",()=>{j=z.dataset.tab,E="Tous",G="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(C=>{const F=C.dataset.tab===j;C.style.borderBottomColor=F?"var(--green)":"transparent",C.style.color=F?"var(--green)":"var(--gray-600)"}),_(),M()})}),_(),M()}function Jn(e,t,i){const n=Se[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=r[t==null?void 0:t.color]||r.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((V,J)=>{const R=Z[V.id]||[],z=V.is_for_sale,C=R.length?R[R.length-1]:null,W=(d.rarity==="pepite"||d.rarity==="papyte")&&V.current_note!=null?` (☆${V.current_note})`:"";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(se=document.getElementById("close-detail"))==null||se.addEventListener("click",s);let M=new Set;const H=()=>{const V=M.size,J=document.getElementById("sell-action-panel");if(!J)return;J.style.display=V>0?"block":"none",document.getElementById("sell-selected-count").textContent=V;const R=document.getElementById("evolve-btn");R&&(R.textContent=`⬆️ Évoluer ${V>1?"(+"+V+")":""}`)};document.querySelectorAll(".expl-check").forEach(V=>{V.addEventListener("change",()=>{const J=V.dataset.id;V.checked?M.add(J):M.delete(J);const R=V.closest(".exemplaire-row");R&&(R.style.borderColor=V.checked?"#1A6B3C":"#eee"),H()})}),document.querySelectorAll(".exemplaire-row").forEach(V=>{V.addEventListener("click",J=>{if(J.target.closest("button")||J.target.tagName==="INPUT")return;const R=V.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(V=>{V.addEventListener("click",J=>{J.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${V.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(ce=document.getElementById("evolve-btn"))==null||ce.addEventListener("click",async()=>{if(g<=1)return;const V=[...M];if(!V.length)return;if(M.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    </div>`;x("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const $=Gi(t.formation),y={};$.forEach(j=>{t.slots[j]&&(y[j]=t.slots[j])}),t.slots=y,b(),et(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(x=>x.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(x=>x.addEventListener("click",()=>eo(t,e,i))),e.querySelectorAll("#save-deck").forEach(x=>x.addEventListener("click",()=>no(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(x=>{x.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==x.dataset.removeSub),et(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(x=>x.addEventListener("click",()=>io(t,e,i)))}function Zn(e,t,i,n){var h,$;const a=window.innerWidth>=900,o=e.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const r=(h=t.stadiumCards)==null?void 0:h.find(y=>y.id===t.stadiumCardId),s=r&&(($=t.stadDefMap)==null?void 0:$[r.stadium_id])||null,l=At[t.formation]||{},c=Hi(t.formation)||[],d={};for(const y of i){const j=t.slots[y],E=j?t.playerCards.find(G=>G.id===j):null;E!=null&&E.player?d[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:d[y]=null}const u=window.innerWidth>=900,g=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(g,860):g,f=Math.round(u?m*.82:m*.85),p=u?84:44;let x="";for(const[y,j]of c){const E=l[y],G=l[j];if(!E||!G)continue;const N=E.x*m,ne=Math.round(.03*f+E.y*.85*f),te=G.x*m,Z=Math.round(.03*f+G.y*.85*f),A=d[y],_=d[j],M=Ct(A,_);M==="#ff3333"||M==="#cc2222"?x+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${M}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${M}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${te.toFixed(1)}" y2="${Z.toFixed(1)}" stroke="${M}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const v=Math.round(p*657/507);for(const y of i){const j=l[y];if(!j)continue;const E=d[y],G=j.x*m;j.y*f;const N=Math.round(.03*f+j.y*(.85*f)),ne=Math.round(G-p/2),te=Math.round(N-v/2);if(E){const Z=y.replace(/\d+/,""),A=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),_=Ie({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:Z});b+=`<div style="position:absolute;left:${ne}px;top:${te}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </foreignObject>`,j&&(m+=`<rect x="${ne}" y="${te}" width="${f}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${v.cardId}" data-role="${$}" style="cursor:pointer"/>`)}const x=s!==null?s:Math.round(Math.max(f*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-x} ${-x} ${a+x*2} ${o+x*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${m}
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,a.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,r)=>{const s=r<e.length-1?Ct(o,e[r+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+2":s==="#FFD700"?"+1":"";return ln(o,a),o.stadiumBonus||a&&(a.club_id&&String(o.club_id)===String(a.club_id)||a.country_code&&(o.country_code,a.country_code)),`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const _=window.innerWidth>=700,M=(R,z,C)=>{var xe,Ce;const F=(t.gcDefs||[]).find(qe=>qe.name===R.gc_type),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[F==null?void 0:F.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",U={purple:"#b06ce0",light_blue:"#00d4ef"}[F==null?void 0:F.color]||"#b06ce0",B=(F==null?void 0:F.name)||R.gc_type,O=(F==null?void 0:F.effect)||((xe=Se[R.gc_type])==null?void 0:xe.desc)||"",ve=F!=null&&F.image_url?`/icons/${F.image_url}`:null,we=((Ce=Se[R.gc_type])==null?void 0:Ce.icon)||"⚡",be=Math.round(C*.22),ge=Math.round(C*.22),ke=C-be-ge,$e=B.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${z}px;height:${C}px;border-radius:10px;border:2px solid ${U};background:${W};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${ho[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Be(a,a._line||a.job)}</div>
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(oe=q.querySelector("#pvp-end-home"))==null||oe.addEventListener("click",()=>{q.remove(),Ne(e),m(r?"ranked":"home")})}const Z=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(j)return;j=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),te(L);return}if(L.game_state){const I=y;y=L.game_state;const S=y._lastGC;if(S&&S.seq&&!ne.has(S.seq)&&(ne.add(S.seq),S.by!==p)){R(S.type,S.by,()=>de());return}const T=I[p+"Score"]||0,D=I[x+"Score"]||0,q=y[p+"Score"]||0,P=y[x+"Score"]||0,X=q>T,Q=P>D;if((X||Q)&&!N.has(y.round)){N.add(y.round);const Y=[...y.log||[]].reverse().find(K=>K.isGoal),oe=((Y==null?void 0:Y.homePlayers)||[]).map(K=>({name:K.name,note:K.note,portrait:K.portrait,job:K.job}));Ze(oe,q,P,X,()=>de());return}de()}}catch(I){console.error("[PvP] crash:",I)}}).subscribe();async function A(k){Object.assign(y,k),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{de()}catch(I){console.error("[PvP] renderPvpScreen crash:",I)}}async function _(){if(j)return;j=!0,E&&(clearInterval(E),E=null);const k=n?h.away_id:h.home_id,L=n?"p2":"p1",I=n?"p1":"p2",S={...y,[L+"Score"]:3,[I+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:S.p1Score||0,away_score:S.p2Score||0,game_state:S}).eq("id",i)}catch{}try{w.removeChannel(Z)}catch{}setTimeout(()=>{Ne(e),m("home")},800)}const M={BOOST_STAT:({value:k=1,count:L=1,roles:I=[]},S,T)=>{const D=S[p+"Team"],q=Object.entries(D).filter(([P])=>!I.length||I.includes(P)).flatMap(([P,X])=>X.filter(Q=>!Q.used).map(Q=>({...Q,_line:P})));if(!q.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(S);return}H(q,L,`Choisir ${L} joueur(s) à booster (+${k})`,P=>{P.forEach(X=>{const Q=(D[X._line]||[]).find(Y=>Y.cardId===X.cardId);Q&&(Q.boost=(Q.boost||0)+k,S.log.push({text:`⚡ +${k} sur ${Q.name}`,type:"info"}))}),S[p+"Team"]=D,T(S)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:I=[],target:S="ai"},T,D)=>{const q=S==="home"?p:x,P=T[q+"Team"],X=S==="home"?"allié":"adverse",Q=Object.entries(P).filter(([Y])=>!I.length||I.includes(Y)).flatMap(([Y,oe])=>oe.map(K=>({...K,_line:Y})));if(!Q.length){T.log.push({text:`🎯 Aucun joueur ${X}`,type:"info"}),D(T);return}H(Q,L,`Choisir ${L} joueur(s) ${X}(s) (-${k})`,Y=>{Y.forEach(oe=>{const K=(P[oe._line]||[]).find(re=>re.cardId===oe.cardId);K&&(K.boost=(K.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${K.name}`,type:"info"}))}),T[q+"Team"]=P,D(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:I="ai"},S,T)=>{const D=I==="home"?p:x,q=S[D+"Team"],P=I==="home"?"allié":"adverse",X=Object.entries(q).filter(([Q])=>!L.length||L.includes(Q)).flatMap(([Q,Y])=>Y.filter(oe=>!oe.used).map(oe=>({...oe,_line:Q})));if(!X.length){S.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),T(S);return}H(X,k,`Choisir ${k} joueur(s) ${P}(s) à exclure`,Q=>{const Y="usedCardIds_"+D,oe=new Set(S[Y]||[]);Q.forEach(K=>{const re=(q[K._line]||[]).find(pe=>pe.cardId===K.cardId);re&&(re.used=!0,oe.add(K.cardId),S.log.push({text:`❌ ${re.name} exclu !`,type:"info"}))}),S[Y]=[...oe],S[D+"Team"]=q,T(S)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},I,S)=>{const T=I[p+"Team"],D=Object.entries(T).filter(([q])=>!L.length||L.includes(q)).flatMap(([q,P])=>P.filter(X=>X.used).map(X=>({...X,_line:q})));if(!D.length){I.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(I);return}H(D,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const X=(T[P._line]||[]).find(Q=>Q.cardId===P.cardId);X&&(X.used=!1,I.log.push({text:`💫 ${X.name} ressuscité !`,type:"info"}))}),I[p+"Team"]=T,S(I)})},REMOVE_GOAL:({},k,L)=>{const I=x+"Score";k[I]>0?(k[I]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[x+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,I)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),I(L)},CUSTOM:({},k,L)=>L(k)};function H(k,L,I,S){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let D=[];function q(){var X,Q;const P=k.map(Y=>{const oe={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[Y._line]||"#555",K=Be(Y,Y._line)+(Y.boost||0),pe=D.find(fe=>fe.cardId===Y.cardId)?"#FFD700":"rgba(255,255,255,0.25)",ae=Y.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${Y.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${pe};background:${oe};overflow:hidden;cursor:pointer;${ae}">
        ...
        <div style="height:${Li}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${hn}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ue-6}px">${kt}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    </div>`,Ke=(()=>{var ue,ze;if(P&&((ue=y.pendingAttack)!=null&&ue.players)){const me=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
        ...
        </div>`}const ee=(y.log||[]).slice(-1)[0];return ee?'<div style="padding:2px 4px">'+dn(ee)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})(),nt=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
  ...
  </div>`,(b=document.getElementById("ml-create-btn"))==null||b.addEventListener("click",()=>Zo(e,t)),e.querySelectorAll(".ml-tab").forEach(v=>v.addEventListener("click",()=>lt(e,t,v.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(v=>v.addEventListener("click",()=>tt(e,t,v.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(v=>v.addEventListener("click",h=>{h.stopPropagation(),un(e,t,v.dataset.join,v.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(v=>v.addEventListener("click",h=>{h.stopPropagation(),si(e,t,v.dataset.delete,v.dataset.name,i)}))}function Ht(e,t,i=!1){var r,s;const n=e.creator_id===t,a=e.pot||0,o=((s=(r=e.mini_league_members)==null?void 0:r[0])==null?void 0:s.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  </div>`}_n($n);const he={user:null,profile:null,page:"home",params:{}};function ft(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function wr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function di(){document.getElementById("modal-overlay").classList.add("hidden")}async function Lt(){if(!he.user)return;const{data:e}=await w.from("users").select("*").eq("id",he.user.id).single();e&&(he.profile=e)}function Tt(e,t={}){he.page=e,he.params=t,xn()}async function xn(){var n,a,o,r;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===he.page)});const t=document.getElementById("nav-credits");t&&he.profile&&(t.textContent=`💰 ${(he.profile.credits||0).toLocaleString("fr")}`);const i={state:he,navigate:Tt,toast:ft,openModal:wr,closeModal:di,refreshProfile:Lt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',he.page){case"home":await Ci(e,i);break;case"collection":await Xn(e,i);break;case"decks":await ei(e,i);break;case"boosters":await lo(e,i);break;case"ranked":await hr(e,i);break;case"match":{const s=he.params&&he.params.matchMode||"vs_ai_easy";s==="random"?await ai(e,i,!1):s==="ranked"?await ai(e,i,!0):s==="friend"?await Ko(e,i,(n=he.params)==null?void 0:n.friendId,(a=he.params)==null?void 0:a.friendName):s==="mini-league"?await Ni(e,i,(o=he.params)==null?void 0:o.mlMatchId,(r=he.params)==null?void 0:r.leagueId):await Eo(e,i);break}case"market":await gr(e,i);break;case"rankings":await br(e,i);break;case"matches":await vr(e,i);break;case"friends":await Sn(e,i);break;case"mini-league":await Wo(e,i);break;case"match-mini-league":{const s=he.params||{};await Ni(e,i,s.mlMatchId,s.leagueId);break}default:await Ci(e,i)}}function _r(){var n;const e=document.getElementById("app"),t=he.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(a=>{a.addEventListener("click",o=>{o.preventDefault(),Tt(a.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Tt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Tt("boosters")),(n=document.getElementById("journal-btn"))==null||n.addEventListener("click",()=>kr())}async function kr(){const{data:e}=await w.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(n=>{const a=new Date(n.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}async function $r(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&di()}),document.getElementById("modal-close").addEventListener("click",di);const{data:{session:e}}=await w.auth.getSession();if(!e){Oi(),Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:ft});return}he.user=e.user,await Lt(),Oi();try{const{data:i}=await w.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(a=>{n[a.formation]=a.links}),kn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!he.profile){Ln(document.getElementById("app"),{state:he,navigate:async()=>{await Lt(),Zt()},toast:ft,refreshProfile:Lt});return}const t=Array.isArray(he.profile.pending_boosters)?he.profile.pending_boosters:[];if(!he.profile.onboarding_done&&t.length>0){yo(document.getElementById("app"),{state:he,navigate:()=>Zt(),toast:ft,refreshProfile:Lt});return}Zt(),setTimeout(()=>fr(he.profile,Tt,ft),800),w.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(he.user=null,he.profile=null,document.getElementById("app").innerHTML="",Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:ft}))})}function Er(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Kt(){const e=document.getElementById("app");e&&(e.style.height=Er()+"px")}window.addEventListener("resize",Kt);window.addEventListener("orientationchange",()=>setTimeout(Kt,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Kt);function Zt(){const e=()=>{var i;(i=he.user)!=null&&i.id&&w.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",he.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Kt(),_r(),xn()}function Oi(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function yn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}$r().catch(e=>{console.error("Échec du démarrage:",e),yn()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&yn("Le serveur met trop de temps à répondre.")},12e3);
