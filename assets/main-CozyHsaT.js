import{s as j,F as ht,b as Ve,c as ii,l as Ae,d as Ei}from"./formation-links-CDBKB_z4.js";function Nt(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const ao="simulation",ci="VOTRE_ZONE_ID";function so(){switch(ao){case"propellerads":return lo();case"adsense":return co();default:return _t()}}function _t(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
  ...
  <div style="text-align:center;flex-shrink:0;width:38px">
    ...
    <div style="font-size:7px;color:rgba(255,255,255,0.5);margin-top:1px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${(e.name||"").slice(0,7)}</div>
          ...
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);o=I[0].data,u=I[0].error,r=I[1].data,f=I[1].error}catch(I){console.error("[Match] Exception chargement deck:",I),Te(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>s("home"));return}if(u||f){console.error("[Match] Erreur Supabase:",u||f),Te(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>s("home"));return}const m=(r||[]).filter(I=>{var G;return I.is_starter&&((G=I.card)==null?void 0:G.player)}).map(I=>ft(I.card,I.position)),A=(r||[]).filter(I=>{var G;return!I.is_starter&&((G=I.card)==null?void 0:G.player)}).map(I=>ft(I.card,I.position));if(m.length<11){Te(e,"⚠️",`Deck incomplet (${m.length}/11).`,"Compléter",()=>s("decks"));return}const p=(r||[]).find(I=>{var G;return((G=I.card)==null?void 0:G.card_type)==="formation"}),h=(o==null?void 0:o.formation)||((M=p==null?void 0:p.card)==null?void 0:M.formation)||"4-4-2",{data:E,error:_}=await j.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",d.profile.id).eq("card_type","game_changer"),{data:S}=await j.from("gc_definitions").select("*").eq("is_active",!0),$=(E||[]).map(I=>({...I,_gcDef:(S==null?void 0:S.find(G=>G.name===I.gc_type||G.id===I.gc_definition_id))||null}));n({deckId:c,formation:h,starters:m,subsRaw:A,gcCardsEnriched:$,gcDefs:S||[]})}async function uo(e,t){const{state:i}=t,d=(i.params||{}).matchMode||"vs_ai_easy",s=d.replace("vs_ai_",""),a=d;await mi(e,t,d,async({deckId:l,formation:c,starters:o,subsRaw:r,gcCardsEnriched:u,gcDefs:f})=>{try{const m=nt(o,c),A=await fo(c,s),p=async h=>{try{const{data:E,error:_}=await j.from("matches").insert({home_id:i.profile.id,away_id:null,mode:a,home_deck_id:l,status:"in_progress"}).select().single();if(_){console.error("[MatchIA] Erreur création match:",_),Te(e,"⚠️","Impossible de créer le match ("+_.message+").","Retour",()=>t.navigate("home"));return}const S={gcDefs:f||[],matchId:E==null?void 0:E.id,mode:a,difficulty:s,formation:c,homeTeam:m,aiTeam:A,homeSubs:r,subsUsed:0,maxSubs:Math.min(r.length,3),homeScore:0,aiScore:0,gcCards:h,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};mo(e,S,t)}catch(E){console.error("[MatchIA] Exception launchMatch:",E),Te(e,"⚠️","Erreur au lancement du match : "+E.message,"Retour",()=>t.navigate("home"))}};if(!u.length){p([]);return}ui(e,u,p)}catch(m){console.error("[MatchIA] Exception setup:",m),Te(e,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>t.navigate("home"))}})}async function fo(e,t){var a,l;const{data:i}=await j.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return go(e);const n=Fe[e]||Fe["4-4-2"],d={GK:[],DEF:[],MIL:[],ATT:[]},s=[...i];for(const c of["GK","DEF","MIL","ATT"]){const o=s.filter(A=>A.job===c),r=s.filter(A=>A.job!==c),u=[...o,...r],f=[];for(let A=0;A<n[c];A++){const p=u[A]||s[A];p&&f.push({cardId:"ai-"+p.id+"-"+A,id:p.id,firstname:p.firstname,name:p.surname_encoded,country_code:p.country_code,club_id:p.club_id,job:p.job,job2:p.job2,note_g:Number(p.note_g)||0,note_d:Number(p.note_d)||0,note_m:Number(p.note_m)||0,note_a:Number(p.note_a)||0,rarity:p.rarity,skin:p.skin,hair:p.hair,hair_length:p.hair_length,clubName:((a=p.clubs)==null?void 0:a.encoded_name)||null,clubLogo:((l=p.clubs)==null?void 0:l.logo_url)||null,boost:0,used:!1,_line:c})}const m=ot(f.length);f.forEach((A,p)=>{A._col=m[p]}),d[c]=f}return d}function go(e){const t=Fe[e]||Fe["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let d=0;for(const s of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<t[s];c++){const o=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+d,id:"fake-"+d,firstname:"IA",name:n[d%n.length],country_code:"XX",club_id:null,job:s,job2:null,note_g:s==="GK"?o:2,note_d:s==="DEF"?o:2,note_m:s==="MIL"?o:2,note_a:s==="ATT"?o:2,rarity:"normal",boost:0,used:!1,_line:s}),d++}const l=ot(a.length);a.forEach((c,o)=>{c._col=l[o]}),i[s]=a}return i}function mo(e,t,i){e.innerHTML=`
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,M.style.transition="opacity .45s ease",M.style.opacity="1",M.style.pointerEvents="auto",(I=document.getElementById("start-match-btn"))==null||I.addEventListener("click",A))},600)},700)},2800)}function yo(e){if(e.type==="duel"){const t=e.homeTotal>=e.aiTotal;return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const v=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const T=t.log[t.log.length-1];return T?'<div style="padding:2px 4px">'+yo(T)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const T=window.innerWidth>=700,v=(L,k,q)=>{var O,K;const N=(t.gcDefs||[]).find(ee=>ee.name===L.gc_type),g={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[N==null?void 0:N.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",y={purple:"#b06ce0",light_blue:"#00d4ef"}[N==null?void 0:N.color]||"#b06ce0",x=(N==null?void 0:N.name)||L.gc_type,z=(N==null?void 0:N.effect)||((O=ve[L.gc_type])==null?void 0:O.desc)||"",b=N!=null&&N.image_url?`/manager-wars/icons/${N.image_url}`:null,C=((K=ve[L.gc_type])==null?void 0:K.icon)||"⚡",w=Math.round(q*.22),D=Math.round(q*.22),B=q-w-D,F=x.length>12?7:9;return`<div class="gc-mini" data-gc-id="${L.id}" data-gc-type="${L.gc_type}"
      ...
      </div>`,ue=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;height:100%;display:flex;align-items:stretch;justify-content:center" id="match-field">
  ...
  `,document.body.appendChild(n);let r=!1;const u=()=>{r||(r=!0,n.remove(),i())};n.addEventListener("click",u),setTimeout(u,2e3)}function Oe(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Qt(e,t,i,n=null){if(t.phase!=="attack"){Oe("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){Oe(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.values(t.homeTeam).flat().filter(u=>u.used),s=t.homeSubs.filter(u=>!t.usedSubIds.includes(u.cardId));if(!d.length){Oe("Aucun joueur utilisé à remplacer");return}if(!s.length){Oe("Aucun remplaçant disponible");return}let a=0,l=Math.max(0,s.findIndex(u=>u.cardId===n)),c=!1;const o=document.createElement("div");o.id="sub-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function r(){var E,_,S,$,M,I;const u=d[a],f=s[l],m=Math.min(130,Math.round((window.innerWidth-90)/2)),A=Math.round(m*1.35),p=G=>`background:rgba(255,255,255,0.12);border:none;color:${G?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${G?"default":"pointer"};flex-shrink:0`;o.innerHTML=`
    ...
    </div>`,document.body.appendChild(m),(A=m.querySelector("#gc-back"))==null||A.addEventListener("click",()=>m.remove()),(p=m.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{m.remove(),Eo(e,t,i,n,d)})}function Xe(e,t,i,n,d,s){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let l=[];function c(){var o,r;a.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const c=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",c),setTimeout(c,3500)}async function Pe(e,t,i){var r,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,a=d?"victoire":s?"nul":"defaite",l=Mi(t.mode,a);t.matchId&&await j.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?n.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(n.profile.credits||0)+l,matches_played:(n.profile.matches_played||0)+1};d?c.wins=(n.profile.wins||0)+1:s?c.draws=(n.profile.draws||0)+1:c.losses=(n.profile.losses||0)+1,await j.from("users").update(c).eq("id",n.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}async function Io(e,t){await mi(e,t,"random",({deckId:i,formation:n,starters:d,subsRaw:s,gcCardsEnriched:a,gcDefs:l})=>{const c=o=>Lo(e,t,i,n,d,s,o,l||[]);if(!a.length){c([]);return}ui(e,a,c)})}async function Lo(e,t,i,n,d,s,a=[],l=[]){var _;const{state:c,navigate:o,toast:r}=t;let u=!1,f=null;ke(e),e.innerHTML=`
    ...
    </div>`,It=w?"attack":D?"defense":"idle",vi=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;height:100%;display:flex;align-items:stretch;justify-content:center" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;height:100%;display:flex;align-items:center;justify-content:center">
  ...
  `;function c(o){const r=document.getElementById("mkt-content"),u=o==="buy"?a:l;if(u.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${f.map(m=>{var S,$,M,I;const A=(S=m.card)==null?void 0:S.player;if(!A)return"";const p=A.job==="GK"?A.note_g:A.job==="DEF"?A.note_d:A.job==="MIL"?A.note_m:A.note_a,h=zo[A.rarity],E=(i.profile.credits||0)>=m.price,_=m.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${_?"opacity:0.65":""}">
          <div style="width:44px;height:44px;border-radius:8px;background:${Bo(A.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${h};flex-shrink:0">${p}</div>
          <div style="flex:1;min-width:0">
  ...
  </div>`}const se={user:null,profile:null,page:"home",params:{}};function Qe(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Go(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function xt(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ze(){if(!se.user)return;const{data:e}=await j.from("users").select("*").eq("id",se.user.id).single();e&&(se.profile=e)}const Tt="mw_theme";function at(){return localStorage.getItem(Tt)||"light"}function qo(e){var t;localStorage.setItem(Tt,e),yt(e),(t=se.profile)!=null&&t.id&&j.from("users").update({theme:e}).eq("id",se.profile.id).then(()=>{})}function yt(e){document.documentElement.setAttribute("data-theme",e)}function et(e,t={}){se.page=e,se.params=t,yi()}async function yi(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(n=>{n.classList.toggle("active",n.dataset.page===se.page)});const t=document.getElementById("nav-credits");t&&se.profile&&(t.textContent=`💰 ${(se.profile.credits||0).toLocaleString("fr")}`);const i={state:se,navigate:et,toast:Qe,openModal:Go,closeModal:xt,refreshProfile:Ze};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',se.page){case"home":await Pt(e,i);break;case"collection":await ji(e,i);break;case"decks":await pt(e,i);break;case"boosters":await Wi(e,i);break;case"match":{(se.params&&se.params.matchMode||"vs_ai_easy")==="random"?await Io(e,i):await uo(e,i);break}case"market":await So(e,i);break;case"rankings":await Fo(e,i);break;case"matches":await Do(e,i);break;default:await Pt(e,i)}}function Ro(){const e=document.getElementById("app"),t=se.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",d=>{d.preventDefault(),et(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>et("home")),document.getElementById("nav-credits").addEventListener("click",()=>et("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const d=at()==="dark"?"light":"dark";qo(d),Zt(d)}),Zt(at())}function Zt(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function No(){yt(at()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&xt()}),document.getElementById("modal-close").addEventListener("click",xt);const{data:{session:e}}=await j.auth.getSession();if(!e){ti(),Nt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Qe});return}se.user=e.user,await Ze(),ti();try{const{data:t}=await j.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(n=>{i[n.formation]=n.links}),Ei(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!se.profile){Ti(document.getElementById("app"),{state:se,navigate:async()=>{await Ze(),ei()},toast:Qe,refreshProfile:Ze});return}se.profile.theme&&se.profile.theme!==at()&&(localStorage.setItem(Tt,se.profile.theme),yt(se.profile.theme)),ei(),j.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(se.user=null,se.profile=null,document.getElementById("app").innerHTML="",Nt(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Qe}))})}function Oo(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function lt(){const e=document.getElementById("app");e&&(e.style.height=Oo()+"px")}window.addEventListener("resize",lt);window.addEventListener("orientationchange",()=>setTimeout(lt,150));window.visualViewport&&window.visualViewport.addEventListener("resize",lt);function ei(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",lt(),Ro(),yi()}function ti(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function hi(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}No().catch(e=>{console.error("Échec du démarrage:",e),hi()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&hi("Le serveur met trop de temps à répondre.")},12e3);
