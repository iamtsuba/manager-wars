import{s as k,F as Re,b as me,c as lt,l as ge,d as Ct}from"./formation-links-CDBKB_z4.js";function We(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(i);const r=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",r),i.addEventListener("click",c=>{c.target===i&&r()}),i.querySelectorAll("[data-mode]").forEach(c=>{c.addEventListener("click",()=>{r(),e("match",{matchMode:c.dataset.mode})})})}const de={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function U(e,t){if(!e)return 0;switch(t){case"GK":return Number(e.note_g)||0;case"DEF":return Number(e.note_d)||0;case"MIL":return Number(e.note_m)||0;case"ATT":return Number(e.note_a)||0;default:return 0}}const Qe=["ATT","MIL","DEF","GK"];function ct(e){let t=0;const i=e.length;for(let r=0;r<i;r++)for(let c=r+1;c<i;c++){const o=e[r],n=e[c];if(!o||!n)continue;const l=o._col!==void 0&&n._col!==void 0&&o._col===n._col,a=o._col!==void 0&&n._col!==void 0&&Math.abs(o._col-n._col)===1,d=Qe.indexOf(o._line),s=Qe.indexOf(n._line),p=Math.abs(d-s)===1;(o._line===n._line&&a||l&&p)&&(o.country_code&&n.country_code&&o.country_code===n.country_code&&t++,o.club_id&&n.club_id&&o.club_id===n.club_id&&t++)}return t}function pt(e,t={}){const i=e.reduce((o,n)=>{const l=n._line||n.job;return o+(Number(l==="MIL"?n.note_m:n.note_a)||0)+(n.boost||0)},0),r=ct(e);let c=i+r;return t.doubleAttack&&(c*=2),t.stolenNote&&(c-=t.stolenNote),{base:i,links:r,total:Math.max(0,c)}}function ut(e,t={}){const i=e.reduce((o,n)=>{const l=n._line||n.job;let a=0;return l==="GK"?a=Number(n.note_g)||0:l==="MIL"?a=Number(n.note_m)||0:a=Number(n.note_d)||0,o+a+(n.boost||0)},0),r=ct(e);let c=i+r;return t.stolenNote&&(c-=t.stolenNote),{base:i,links:r,total:Math.max(0,c)}}function ft(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function gt(e,t,i="easy"){const r=e.filter(n=>!n.used);if(!r.length)return[];const c=[...r].sort((n,l)=>{const a=t==="attack"?U(n,"ATT"):n._line==="GK"?U(n,"GK"):U(n,"DEF");return(t==="attack"?U(l,"ATT"):l._line==="GK"?U(l,"GK"):U(l,"DEF"))-a});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return c.slice(0,Math.min(o,c.length,3))}function Ft(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const xt={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Ee={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},be=["GK","DEF","MIL","ATT"],Dt=["Tous","GK","DEF","MIL","ATT"],Gt={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},qe={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function yt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function xe(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Me(e,t=""){var p,u;const i=e.player;if(!i)return"";const r=i.job||"ATT",c=Ee[r],o=xt[i.rarity]||"#ccc",n=xe(i,r),l=i.job2?xe(i,i.job2):null,a=i.job2?Ee[i.job2]:null,d=yt(i),s=qe[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function Ze(e){const t=e.job||"ATT",i=xe(e,t),r=qe[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  </div>`}async function Rt(e,t){const{state:i,navigate:r,toast:c,openModal:o,closeModal:n}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await k.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(x=document.getElementById("direct-sell-form-btn"))==null||x.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${d} pour ${ue.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const b=u.find(w=>!w.is_for_sale)||u[0];if(!b){o("Aucune carte à vendre","error");return}const{error:y}=await k.from("cards").delete().eq("id",b.id);if(y){o(y.message,"error");return}await k.from("users").update({credits:(c.profile.credits||0)+ue}).eq("id",c.profile.id),await a(),o(`+${ue.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),n(),l("collection")}),(m=document.getElementById("market-sell-form-btn"))==null||m.addEventListener("click",async()=>{const b=parseInt(document.getElementById("sell-price-form").value);if(!b||b<1){o("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:b}).eq("id",e.id),await k.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:b}),o("Carte mise en vente sur le marché !","success"),n(),l("collection")}),(_=document.getElementById("cancel-sell-form-btn"))==null||_.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),n(),l("collection")})}function et(e,t,i,r){var h,v,$,I,T,B;const{state:c,toast:o,openModal:n,closeModal:l,navigate:a,refreshProfile:d}=r,s=e.player,p=t.filter(S=>S.player.id===s.id),u=p.length,f=Gt[s.rarity]||1e3,g=s.rarity!=="legende",x=yt(s),m=xe(s,s.job),_=s.job2?xe(s,s.job2):null,b=Ee[s.job]||"#1A6B3C",y=s.job2?Ee[s.job2]:null,w=xt[s.rarity]||"#ccc",L=qe[s.country_code]||s.country_code||"";n(`${s.firstname} ${s.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),($=document.getElementById("close-detail"))==null||$.addEventListener("click",l),(I=document.getElementById("direct-sell-btn"))==null||I.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${s.surname_encoded} pour ${f.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const S=p.find(K=>!K.is_for_sale)||p[0];if(!S){o("Aucune carte à vendre","error");return}const{error:q}=await k.from("cards").delete().eq("id",S.id);if(q){o(q.message,"error");return}await k.from("users").update({credits:(c.profile.credits||0)+f}).eq("id",c.profile.id),await d(),o(`+${f.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),a("collection")}),(T=document.getElementById("market-sell-btn"))==null||T.addEventListener("click",async()=>{const S=parseInt(document.getElementById("sell-price").value);if(!S||S<1){o("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:S}).eq("id",e.id),await k.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:S}),o("Carte mise en vente sur le marché !","success"),l(),a("collection")}),(B=document.getElementById("cancel-sell-btn"))==null||B.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),l(),a("collection")})}const Ae={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},te={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Le(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function mt(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ht(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Ot(e,t=44,i=58){var f;const r=e?Le(e):null,c=e?ht(e):null,o=mt(e==null?void 0:e.country_code),n=(e==null?void 0:e.job)||"MIL",l=te[n]||"#555",a={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",d=Number(n==="GK"?e==null?void 0:e.note_g:n==="DEF"?e==null?void 0:e.note_d:n==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,s=Math.round(i*.19),p=Math.round(i*.25),u=i-s-p;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${a};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const n=prompt("Nom du deck :",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!n)return;const{data:l,error:a}=await k.from("decks").insert({owner_id:i.profile.id,name:n}).select().single();if(a){c(a.message,"error");return}c("Deck créé !","success"),tt(l.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(n=>{n.addEventListener("click",()=>tt(n.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(n=>{n.addEventListener("click",async()=>{const l=prompt("Nouveau nom :",n.dataset.name);if(!l||l===n.dataset.name)return;const{error:a}=await k.from("decks").update({name:l}).eq("id",n.dataset.rename);if(a){c(a.message,"error");return}c("Deck renommé !","success"),Ce(e,t)})}),e.querySelectorAll("[data-delete]").forEach(n=>{n.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${n.dataset.name}" ? Cette action est irréversible.`))return;await k.from("deck_cards").delete().eq("deck_id",n.dataset.delete);const{error:l}=await k.from("decks").delete().eq("id",n.dataset.delete);if(l){c(l.message,"error");return}c("Deck supprimé.","success"),Ce(e,t)})})}async function tt(e,t,i){const{state:r,toast:c}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await k.from("decks").select("*").eq("id",e).single(),{data:n}=await k.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",r.profile.id),l=(n||[]).filter(f=>f.card_type==="player"&&f.player),a=(n||[]).filter(f=>f.card_type==="formation"),d=a.map(f=>f.formation).filter(Boolean),{data:s}=await k.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";d.length>0&&!d.includes(p)&&(p=d[0]);const u={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,slots:{},subs:[],playerCards:l,formationCards:a,availableFormations:d};(s||[]).forEach(f=>{f.is_starter?u.slots[f.position]=f.card_id:u.subs.includes(f.card_id)||u.subs.push(f.card_id)}),le(t,u,i)}function le(e,t,i){var a;const{navigate:r}=i;Ae[t.formation];const c=it(t.formation),o=c.filter(d=>t.slots[d]).length,n=t.availableFormations.length>0?t.availableFormations:Object.keys(Ae),l=t.subs.map(d=>t.playerCards.find(s=>s.id===d)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div class="page">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",o),(g=document.getElementById("remove-player"))==null||g.addEventListener("click",()=>{delete t.slots[e],o(),le(i,t,r)}),document.querySelectorAll(".player-option").forEach(x=>{x.addEventListener("click",()=>{t.slots[e]=x.dataset.cardId,o(),le(i,t,r)})})}function Kt(e,t,i){var a;const{openModal:r,closeModal:c}=i,o=new Set;Object.values(e.slots).filter(Boolean).forEach(d=>{var p;const s=e.playerCards.find(u=>u.id===d);(p=s==null?void 0:s.player)!=null&&p.id&&o.add(s.player.id)}),e.subs.forEach(d=>{var p;const s=e.playerCards.find(u=>u.id===d);(p=s==null?void 0:s.player)!=null&&p.id&&o.add(s.player.id)});const n=new Set,l=e.playerCards.filter(d=>{var s,p,u;return o.has((s=d.player)==null?void 0:s.id)||n.has((p=d.player)==null?void 0:p.id)?!1:(n.add((u=d.player)==null?void 0:u.id),!0)});r("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  `,document.body.appendChild(r);let c=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(c)return;c=!0;const f=document.getElementById("pack-visual");f.classList.add("shaking"),setTimeout(()=>{f.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",n(0)},600)},500)});let o=0;function n(f){o=f;const g=document.getElementById("reveal-phase");g.style.display="flex",l(f)}function l(f){var h;const g=e[f],x=document.getElementById("card-counter"),m=document.getElementById("single-card-slot"),_=document.getElementById("card-tap-hint");x&&(x.textContent=`Carte ${f+1} / ${e.length}`),_&&(_.textContent=f<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const b=nt(g),y=g.card_type==="player"&&((h=g.player)==null?void 0:h.rarity)==="legende";m.innerHTML=`
      ...
      </div>`,document.body.appendChild(r),r.addEventListener("click",n=>{n.target===r&&r.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>r.remove());return}fi()}function fi(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const gi="simulation",wt="VOTRE_ZONE_ID";function xi(){switch(gi){case"propellerads":return yi();case"adsense":return mi();default:return Ne()}}function Ne(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const r=setInterval(()=>{i--;const c=document.getElementById("ad-cd"),o=document.getElementById("ad-skip");c&&(c.textContent=i),o&&(o.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(r),o&&(o.disabled=!1,o.style.cssText=o.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),o==null||o.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function yi(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(Ne());window.propeller.push({zone_id:wt,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function mi(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(Ne());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:wt,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const ce={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},pe={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function $t(e,t,i,r,c){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${r}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",c)}function J(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Be(e){var i,r;const t=e.player;return{cardId:e.id,id:t.id,firstname:t.firstname,name:t.surname_encoded,country_code:t.country_code,club_id:t.club_id,job:t.job,job2:t.job2,note_g:Number(t.note_g)||0,note_d:Number(t.note_d)||0,note_m:Number(t.note_m)||0,note_a:Number(t.note_a)||0,rarity:t.rarity,skin:t.skin,hair:t.hair,hair_length:t.hair_length,clubName:((i=t.clubs)==null?void 0:i.encoded_name)||null,clubLogo:((r=t.clubs)==null?void 0:r.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Oe(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function hi(){const e=Math.random()*100;return e<.1?4:e<5?3:e<20?2:1}function _t(e,t){const i=ce[t]||ce["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},c=[...e];for(const o of["GK","DEF","MIL","ATT"]){const n=[];for(let a=0;a<i[o];a++){let d=c.findIndex(s=>s.job===o);if(d===-1&&(d=c.findIndex(s=>s.job2===o)),d===-1&&(d=0),c[d]){const s={...c[d],_line:o};n.push(s),c.splice(d,1)}}const l=Oe(n.length);n.forEach((a,d)=>{a._col=l[d]}),r[o]=n}return r}async function bi(e,t){var n,l;const{data:i}=await k.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return vi(e);const r=ce[e]||ce["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},o=[...i];for(const a of["GK","DEF","MIL","ATT"]){const d=o.filter(g=>g.job===a),s=o.filter(g=>g.job!==a),p=[...d,...s],u=[];for(let g=0;g<r[a];g++){const x=p[g]||o[g];x&&u.push({cardId:"ai-"+x.id+"-"+g,id:x.id,firstname:x.firstname,name:x.surname_encoded,country_code:x.country_code,club_id:x.club_id,job:x.job,job2:x.job2,note_g:Number(x.note_g)||0,note_d:Number(x.note_d)||0,note_m:Number(x.note_m)||0,note_a:Number(x.note_a)||0,rarity:x.rarity,skin:x.skin,hair:x.hair,hair_length:x.hair_length,clubName:((n=x.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((l=x.clubs)==null?void 0:l.logo_url)||null,boost:0,used:!1,_line:a})}const f=Oe(u.length);u.forEach((g,x)=>{g._col=f[x]}),c[a]=u}return c}function vi(e){const t=ce[e]||ce["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},r=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const o of["GK","DEF","MIL","ATT"]){const n=[];for(let a=0;a<t[o];a++){const d=3+Math.floor(Math.random()*5);n.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:r[c%r.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?d:2,note_d:o==="DEF"?d:2,note_m:o==="MIL"?d:2,note_a:o==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:o}),c++}const l=Oe(n.length);n.forEach((a,d)=>{a._col=l[d]}),i[o]=n}return i}function wi(e){let t=e.nextElementSibling;for(;t;)t.dataset.matchHidden||(t.dataset.matchHidden=t.style.display||"flex",t.style.display="none"),t=t.nextElementSibling}function Ie(e){let t=e.nextElementSibling;for(;t;)t.dataset.matchHidden&&(t.style.display=t.dataset.matchHidden==="none"?"":t.dataset.matchHidden,delete t.dataset.matchHidden),t=t.nextElementSibling}async function $i(e,t){var h;const{state:i,navigate:r,toast:c}=t;wi(e);const o=i.params||{};e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const n=o.matchMode||"vs_ai_easy",l=n.replace("vs_ai_",""),a=n;if(!o.deckId)return ki(e,t,n);const d=o.deckId,[{data:s},{data:p}]=await Promise.all([k.from("decks").select("formation,name").eq("id",d).single(),k.from("deck_cards").select(`position, is_starter, slot_order,
        card:cards(id, card_type, formation,
          player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
            note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
            clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]),u=(p||[]).filter(v=>{var $;return v.is_starter&&(($=v.card)==null?void 0:$.player)}).map(v=>Be(v.card)),f=(p||[]).filter(v=>{var $;return!v.is_starter&&(($=v.card)==null?void 0:$.player)}).map(v=>Be(v.card));if(u.length<11){$t(e,"⚠️",`Deck incomplet (${u.length}/11).`,"Compléter",()=>r("decks"));return}const g=(p||[]).find(v=>{var $;return(($=v.card)==null?void 0:$.card_type)==="formation"}),x=(s==null?void 0:s.formation)||((h=g==null?void 0:g.card)==null?void 0:h.formation)||"4-4-2",{data:m}=await k.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",i.profile.id).eq("card_type","game_changer"),{data:_}=await k.from("gc_definitions").select("*").eq("is_active",!0),b=(m||[]).map(v=>({...v,_gcDef:(_==null?void 0:_.find($=>$.name===v.gc_type||$.id===v.gc_definition_id))||null})),y=_t(u,x),w=await bi(x),L=async v=>{const{data:$}=await k.from("matches").insert({home_id:i.profile.id,away_id:null,mode:a,home_deck_id:d,status:"in_progress"}).select().single(),I={gcDefs:_||[],matchId:$==null?void 0:$.id,mode:a,difficulty:l,formation:x,homeTeam:y,aiTeam:w,homeSubs:f,subsUsed:0,maxSubs:Math.min(f.length,3),homeScore:0,aiScore:0,gcCards:v,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Ei(e,I,t)};if(!b.length){L([]);return}_i(e,b,L)}function _i(e,t,i){const c=new Set,o=t.filter(s=>{const p=s.gc_type||s.id;return c.has(p)?!1:(c.add(p),!0)});let n=[];function l(s,p){const u=s._gcDef,f={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},g={purple:"#9b59b6",light_blue:"#00bcd4"},x=f[u==null?void 0:u.color]||f.purple,m=g[u==null?void 0:u.color]||g.purple;return`<div class="gc-select-card" data-id="${s.id}"
  ...
  </div>`,setTimeout(()=>Ai(e,t,i),5e3)}function Ai(e,t,i){const r=t.homeTeam.MIL||[],c=t.aiTeam.MIL||[];function o(p){return p.reduce((u,f)=>u+U(f,"MIL"),0)}function n(p){let u=0;for(let f=0;f<p.length-1;f++){const g=ge(p[f],p[f+1]);g==="#00ff88"?u+=2:g==="#FFD700"&&(u+=1)}return u}const l=o(r)+n(r),a=o(c)+n(c),d=l>=a;function s(p,u,f){return`<div style="text-align:center">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
      ...
      </div>`,(m=document.getElementById("start-match-btn"))==null||m.addEventListener("click",()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",V(e,t,i),t.attacker==="ai"&&setTimeout(()=>Fe(e,t,i),800)})},100)},5e3)}function kt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function ae(e,t=44,i=58){if(!e)return`<div style="width:${t}px;height:${i}px;border:1.5px dashed rgba(255,255,255,0.2);border-radius:5px"></div>`;const r=typeof e.portrait=="string"&&e.portrait.startsWith("http")?e.portrait:J(e),c=kt(e),o=e._line||e.job||"MIL",n=pe[o]||"#555",l={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",a=e.note!==void 0?Number(e.note)||0:(Number(U(e,o))||0)+(e.boost||0),d=Et(e==null?void 0:e.country_code),s=Math.round(i*.19),p=Math.round(i*.25),u=i-Math.round(i*.19)-Math.round(i*.25),f=e!=null&&e.used?.28:1;return`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${l};background:${n};position:relative;overflow:hidden;flex-shrink:0;opacity:${f}">
    <div style="position:absolute;top:0;left:0;right:0;height:${s}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:center;z-index:2">
    ...
    ${p}
  </svg>`}function At(e,t,i,r,c=300,o=300){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Pe(e,t,i,r,c,o)}
  ...
  `,document.body.appendChild(r);let s=!1;const p=()=>{s||(s=!0,r.remove(),i())};r.addEventListener("click",p),setTimeout(p,2e3)}function fe(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function rt(e,t,i,r=null){if(t.phase!=="attack"){fe("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){fe(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const c=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!c.length){fe("Aucun joueur utilisé à remplacer");return}if(!o.length){fe("Aucun remplaçant disponible");return}let n=0,l=Math.max(0,o.findIndex(p=>p.cardId===r)),a=!1;const d=document.createElement("div");d.id="sub-overlay",d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function s(){var _,b,y,w,L,h;const p=c[n],u=o[l],f=Math.min(130,Math.round((window.innerWidth-90)/2)),g=Math.round(f*1.35),x=v=>`background:rgba(255,255,255,0.12);border:none;color:${v?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${v?"default":"pointer"};flex-shrink:0`;d.innerHTML=`
    ...
    </div>`,document.body.appendChild(f),(g=f.querySelector("#gc-back"))==null||g.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),Bi(e,t,i,r,c)})}function ze(e,t,i,r,c,o){const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let l=[];function a(){var d,s;n.innerHTML=`
  ...
  `;function l(a){const d=document.getElementById("mkt-content"),s=a==="buy"?n:o;if(s.length===0){d.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${s.map(p=>{var m,_,b;const u=(m=p.card)==null?void 0:m.player;if(!u)return"";const f=u.job==="GK"?u.note_g:u.job==="DEF"?u.note_d:u.job==="MIL"?u.note_m:u.note_a,g=Di[u.rarity],x=(i.profile.credits||0)>=p.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
