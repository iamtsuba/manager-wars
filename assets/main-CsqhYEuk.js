import{s as w,l as J,F as we,b as ge,c as Oe,d as lt}from"./formation-links-CDBKB_z4.js";function ze(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function xt(e,t){const{state:i,navigate:n,toast:s,openModal:o,closeModal:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await w.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(d||[]).filter(I=>I.card_type==="player"&&I.player),c=(d||[]).filter(I=>I.card_type==="game_changer"),p=(d||[]).filter(I=>I.card_type==="formation"),u=Object.keys(we),f=Object.keys(ie),x={};l.forEach(I=>{const L=I.player.id;x[L]=(x[L]||0)+1});const $=new Set(Object.keys(x).map(I=>String(I))),v=new Set(p.map(I=>I.formation)),_=new Set(c.map(I=>I.gc_type));let m="player",g="Tous",h="",k=!1;function y(){return[...l].sort((I,L)=>{const M=re.indexOf(I.player.job),B=re.indexOf(L.player.job);return M!==B?M-B:(I.player.surname_encoded||"").localeCompare(L.player.surname_encoded||"")})}function b(){return[...r||[]].sort((I,L)=>{const M=re.indexOf(I.job),B=re.indexOf(L.job);return M!==B?M-B:(I.surname_encoded||"").localeCompare(L.surname_encoded||"")})}function E(){return y().filter(I=>{const L=I.player,M=g==="Tous"||L.job===g,B=!h||`${L.firstname} ${L.surname_encoded}`.toLowerCase().includes(h);return M&&B})}function T(){return b().filter(I=>{const L=g==="Tous"||I.job===g,M=!h||`${I.firstname} ${I.surname_encoded}`.toLowerCase().includes(h);return L&&M})}e.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:flex-start" id="col-grid"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",L=>{h=L.target.value.toLowerCase(),z()}),e.querySelectorAll(".filter-btn").forEach(L=>{L.addEventListener("click",()=>{g=L.dataset.job,A(),z()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{k=!k,A(),z()})):(I.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ee=1e3;function ht(e,t,i,n){var $,v,_;const{state:s,toast:o,closeModal:a,navigate:d,refreshProfile:r}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function p(){const m=ge[l]||{},g=we[l]||[],h=290,k=360,y=20;function b(T){const A=m[T];return A?{x:A.x*h,y:A.y*k}:null}let E=`<svg width="${h}" height="${k}" viewBox="0 0 ${h} ${k}" xmlns="http://www.w3.org/2000/svg">`;for(const[T,A]of g){const z=b(T),C=b(A);!z||!C||(E+=`<line x1="${z.x}" y1="${z.y}" x2="${C.x}" y2="${C.y}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),($=document.getElementById("direct-sell-form-btn"))==null||$.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${ee.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const m=u.find(h=>!h.is_for_sale)||u[0];if(!m){o("Aucune carte à vendre","error");return}const{error:g}=await w.from("cards").delete().eq("id",m.id);if(g){o(g.message,"error");return}await w.from("users").update({credits:(s.profile.credits||0)+ee}).eq("id",s.profile.id),await r(),o(`+${ee.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(v=document.getElementById("market-sell-form-btn"))==null||v.addEventListener("click",async()=>{const m=parseInt(document.getElementById("sell-price-form").value);if(!m||m<1){o("Prix invalide","error");return}await w.from("cards").update({is_for_sale:!0,sale_price:m}).eq("id",e.id),await w.from("market_listings").insert({seller_id:s.profile.id,card_id:e.id,price:m}),o("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(_=document.getElementById("cancel-sell-form-btn"))==null||_.addEventListener("click",async()=>{await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await w.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),d("collection")})}function bt(e,t,i,n){var y,b,E,T,A,z;const{state:s,toast:o,openModal:a,closeModal:d,navigate:r,refreshProfile:l}=n,c=e.player,p=t.filter(C=>C.player.id===c.id),u=p.length,f=mt[c.rarity]||1e3,x=c.rarity!=="legende",$=Je(c),v=oe(c,c.job),_=c.job2?oe(c,c.job2):null,m=pe[c.job]||"#1A6B3C",g=c.job2?pe[c.job2]:null,h=We[c.rarity]||"#ccc",k=$e[c.country_code]||c.country_code||"";a(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
  ...
  <div class="page">
  ...
  </div>`,wt(e,t,s,i),document.getElementById("builder-back").addEventListener("click",()=>n("decks")),document.getElementById("formation-select").addEventListener("change",l=>{t.formation=l.target.value;const c=Fe(t.formation),p={};c.forEach(u=>{t.slots[u]&&(p[u]=t.slots[u])}),t.slots=p,X(e,t,i)}),document.getElementById("save-deck").addEventListener("click",()=>kt(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(l=>{l.addEventListener("click",()=>{t.subs=t.subs.filter(c=>c!==l.dataset.removeSub),X(e,t,i)})}),(r=document.getElementById("add-sub-btn"))==null||r.addEventListener("click",()=>{_t(t,e,i)})}function wt(e,t,i,n){const s=e.querySelector("#deck-field");if(!s)return;const o=ge[t.formation]||{},a=Oe(t.formation)||[],d={};for(const _ of i){const m=t.slots[_],g=m?t.playerCards.find(h=>h.id===m):null;d[_]=g?g.player:null}const r=300,l=300,c=48,p=64,u=13,f=16,x=38;function $(_){const m=o[_];return m?{x:m.x*r,y:m.y*l}:null}let v="";for(const[_,m]of a){const g=$(_),h=$(m);if(!g||!h)continue;const k=d[_]?{...d[_],club_id:d[_].club_id,country_code:d[_].country_code,rarity:d[_].rarity}:null,y=d[m]?{...d[m],club_id:d[m].club_id,country_code:d[m].country_code,rarity:d[m].rarity}:null,b=J(k,y);b==="#ff3333"||b==="#cc2222"?v+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${h.x.toFixed(1)}" y2="${h.y.toFixed(1)}" stroke="${b}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(v+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${h.x.toFixed(1)}" y2="${h.y.toFixed(1)}" stroke="${b}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,v+=`<line x1="${g.x.toFixed(1)}" y1="${g.y.toFixed(1)}" x2="${h.x.toFixed(1)}" y2="${h.y.toFixed(1)}" stroke="${b}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const _ of i){const m=$(_);if(!m)continue;const g=d[_],h=_.replace(/\d+/,""),k=V[h]||"#555",y=(m.x-c/2).toFixed(1),b=(m.y-p/2).toFixed(1),E={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[g==null?void 0:g.rarity]||"#aaa";if(g){const T=_e(g),A=getClubLogo(g),z=flagImgUrl(g.country_code),C=Number(h==="GK"?g.note_g:h==="DEF"?g.note_d:h==="MIL"?g.note_m:g.note_a)||0,G=p-u-f;v+=`<defs><clipPath id="dcp-${_}"><rect x="${y}" y="${(m.y-p/2+u).toFixed(1)}" width="${c}" height="${G}"/></clipPath></defs>`,v+=`<rect x="${y}" y="${b}" width="${c}" height="${p}" rx="5" fill="${k}"/>`,T&&(v+=`<image href="${T}" x="${y}" y="${(m.y-p/2+u).toFixed(1)}" width="${c}" height="${G}" clip-path="url(#dcp-${_})" preserveAspectRatio="xMidYMin slice"/>`),v+=`<rect x="${y}" y="${b}" width="${c}" height="${u}" fill="rgba(255,255,255,0.93)"/>`,v+=`<text x="${m.x.toFixed(1)}" y="${(m.y-p/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(g.surname_encoded||"").slice(0,9)}</text>`;const q=(m.y+p/2-f).toFixed(1);v+=`<rect x="${y}" y="${q}" width="${c}" height="${f}" fill="rgba(255,255,255,0.93)"/>`,z&&(v+=`<image href="${z}" x="${(m.x-21).toFixed(1)}" y="${(m.y+p/2-f+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),v+=`<text x="${m.x.toFixed(1)}" y="${(m.y+p/2-f/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${C}</text>`,A&&(v+=`<image href="${A}" x="${(m.x+c/2-14).toFixed(1)}" y="${(m.y+p/2-f+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),v+=`<rect x="${y}" y="${b}" width="${c}" height="${p}" rx="5" fill="none" stroke="${E}" stroke-width="2"/>`}else v+=`<rect x="${y}" y="${b}" width="${c}" height="${p}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,v+=`<text x="${m.x.toFixed(1)}" y="${m.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,v+=`<text x="${m.x.toFixed(1)}" y="${(m.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${h}</text>`;v+=`<rect x="${y}" y="${b}" width="${c}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${_}" style="cursor:pointer"/>`}s.innerHTML=`<svg viewBox="${-x} ${-x} ${r+x*2} ${l+x*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${v}</svg>`,s.querySelectorAll(".deck-slot-hit").forEach(_=>{_.addEventListener("click",()=>$t(_.dataset.pos,t,e,n))})}function $t(e,t,i,n){var u,f,x;const{openModal:s,closeModal:o}=n,a=e.replace(/\d+/,""),d=t.slots[e],r=d?t.playerCards.find($=>$.id===d):null;(u=r==null?void 0:r.player)==null||u.id;const l=new Set;Object.entries(t.slots).forEach(([$,v])=>{var m;if($===e||!v)return;const _=t.playerCards.find(g=>g.id===v);(m=_==null?void 0:_.player)!=null&&m.id&&l.add(_.player.id)}),t.subs.forEach($=>{var _;const v=t.playerCards.find(m=>m.id===$);(_=v==null?void 0:v.player)!=null&&_.id&&l.add(v.player.id)});const c=new Set,p=t.playerCards.filter($=>{const v=$.player;return!(v.job===a||v.job2===a)||l.has(v.id)||c.has(v.id)?!1:(c.add(v.id),!0)});p.sort(($,v)=>{const _=a==="GK"?$.player.note_g:a==="DEF"?$.player.note_d:a==="MIL"?$.player.note_m:$.player.note_a;return(a==="GK"?v.player.note_g:a==="DEF"?v.player.note_d:a==="MIL"?v.player.note_m:v.player.note_a)-_}),s(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${p.length>0?p.map($=>{var h,k;const v=$.player,_=a==="GK"?v.note_g:a==="DEF"?v.note_d:a==="MIL"?v.note_m:v.note_a,m=_e(v),g={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[v.rarity];return`<div class="player-option" data-card-id="${$.id}"
          ...
          <div style="width:44px;height:44px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#dde;border:2px solid ${V[a]}">
            ${m?`<img src="${m}" style="width:100%;height:100%;object-fit:cover">`:`<div style="width:100%;height:100%;background:${V[a]};display:flex;align-items:center;justify-content:center;color:#fff;font-size:10px;font-weight:700">${a}</div>`}
          </div>
          <!-- Infos -->
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(h=v.clubs)!=null&&h.logo_url?`<img src="${v.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((k=v.clubs)==null?void 0:k.encoded_name)||"—"}</span>`}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(f=document.getElementById("close-selector"))==null||f.addEventListener("click",o),(x=document.getElementById("remove-player"))==null||x.addEventListener("click",()=>{delete t.slots[e],o(),X(i,t,n)}),document.querySelectorAll(".player-option").forEach($=>{$.addEventListener("click",()=>{t.slots[e]=$.dataset.cardId,o(),X(i,t,n)})})}function _t(e,t,i){var r;const{openModal:n,closeModal:s}=i,o=new Set;Object.values(e.slots).filter(Boolean).forEach(l=>{var p;const c=e.playerCards.find(u=>u.id===l);(p=c==null?void 0:c.player)!=null&&p.id&&o.add(c.player.id)}),e.subs.forEach(l=>{var p;const c=e.playerCards.find(u=>u.id===l);(p=c==null?void 0:c.player)!=null&&p.id&&o.add(c.player.id)});const a=new Set,d=e.playerCards.filter(l=>{var c,p,u;return o.has((c=l.player)==null?void 0:c.id)||a.has((p=l.player)==null?void 0:p.id)?!1:(a.add((u=l.player)==null?void 0:u.id),!0)});n("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${d.length>0?d.map(l=>{var f;const c=l.player,p=_e(c),u=c.job==="GK"?c.note_g:c.job==="DEF"?c.note_d:c.job==="MIL"?c.note_m:c.note_a;return`<div class="player-option" data-card-id="${l.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  `,document.body.appendChild(n);let s=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(s)return;s=!0;const f=document.getElementById("pack-visual");f.classList.add("shaking"),setTimeout(()=>{f.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",a(0)},600)},500)});let o=0;function a(f){o=f;const x=document.getElementById("reveal-phase");x.style.display="flex",d(f)}function d(f){var y;const x=e[f],$=document.getElementById("card-counter"),v=document.getElementById("single-card-slot"),_=document.getElementById("card-tap-hint");$&&($.textContent=`Carte ${f+1} / ${e.length}`),_&&(_.textContent=f<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const m=Ge(x),g=x.card_type==="player"&&((y=x.player)==null?void 0:y.rarity)==="legende";v.innerHTML=`
      ...
      </div>`,g&&c();const h=document.getElementById("current-card-wrap");let k=!1;h.addEventListener("click",()=>{if(k)return;k=!0;const b=f+1;b<e.length?(h.style.transition="all 0.25s ease",h.style.transform="translateX(-120%) rotate(-15deg)",h.style.opacity="0",setTimeout(()=>d(b),250)):r()})}function r(){p(),document.getElementById("reveal-phase").style.display="none";const f=document.getElementById("recap-phase");f.style.display="flex";const x=document.getElementById("recap-grid");x.innerHTML=e.map(($,v)=>`
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}Ht()}function Ht(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const Ut="simulation",et="VOTRE_ZONE_ID";function Vt(){switch(Ut){case"propellerads":return Yt();case"adsense":return Wt();default:return ke()}}function ke(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const n=setInterval(()=>{i--;const s=document.getElementById("ad-cd"),o=document.getElementById("ad-skip");s&&(s.textContent=i),o&&(o.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(n),o&&(o.disabled=!1,o.style.cssText=o.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),o==null||o.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function Yt(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(ke());window.propeller.push({zone_id:et,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function Wt(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(ke());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:et,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const Q={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Z={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function tt(e,t,i,n,s){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",s)}function N(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(e){var i,n;const t=e.player;return{cardId:e.id,id:t.id,firstname:t.firstname,name:t.surname_encoded,country_code:t.country_code,club_id:t.club_id,job:t.job,job2:t.job2,note_g:Number(t.note_g)||0,note_d:Number(t.note_d)||0,note_m:Number(t.note_m)||0,note_a:Number(t.note_a)||0,rarity:t.rarity,skin:t.skin,hair:t.hair,hair_length:t.hair_length,clubName:((i=t.clubs)==null?void 0:i.encoded_name)||null,clubLogo:((n=t.clubs)==null?void 0:n.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Ee(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Jt(){const e=Math.random()*100;return e<.1?4:e<5?3:e<20?2:1}function it(e,t){const i=Q[t]||Q["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]},s=[...e];for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let r=0;r<i[o];r++){let l=s.findIndex(c=>c.job===o);if(l===-1&&(l=s.findIndex(c=>c.job2===o)),l===-1&&(l=0),s[l]){const c={...s[l],_line:o};a.push(c),s.splice(l,1)}}const d=Ee(a.length);a.forEach((r,l)=>{r._col=d[l]}),n[o]=a}return n}async function Xt(e,t){const{data:i}=await w.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return Qt(e);const n=Q[e]||Q["4-4-2"],s={GK:[],DEF:[],MIL:[],ATT:[]},o=[...i];for(const a of["GK","DEF","MIL","ATT"]){const d=o.filter(u=>u.job===a),r=o.filter(u=>u.job!==a),l=[...d,...r],c=[];for(let u=0;u<n[a];u++){const f=l[u]||o[u];f&&c.push({cardId:"ai-"+f.id+"-"+u,id:f.id,firstname:f.firstname,name:f.surname_encoded,country_code:f.country_code,club_id:f.club_id,job:f.job,job2:f.job2,note_g:Number(f.note_g)||0,note_d:Number(f.note_d)||0,note_m:Number(f.note_m)||0,note_a:Number(f.note_a)||0,rarity:f.rarity,skin:f.skin,hair:f.hair,hair_length:f.hair_length,boost:0,used:!1,_line:a})}const p=Ee(c.length);c.forEach((u,f)=>{u._col=p[f]}),s[a]=c}return s}function Qt(e){const t=Q[e]||Q["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let s=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let r=0;r<t[o];r++){const l=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+s,id:"fake-"+s,firstname:"IA",name:n[s%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?l:2,note_d:o==="DEF"?l:2,note_m:o==="MIL"?l:2,note_a:o==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:o}),s++}const d=Ee(a.length);a.forEach((r,l)=>{r._col=d[l]}),i[o]=a}return i}async function Zt(e,t){var k;const{state:i,navigate:n,toast:s}=t,o=i.params||{};e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const a=o.matchMode||"vs_ai_easy",d=a.replace("vs_ai_",""),r=a;if(!o.deckId)return ei(e,t,a);const l=o.deckId,[{data:c},{data:p}]=await Promise.all([w.from("decks").select("formation,name").eq("id",l).single(),w.from("deck_cards").select(`position, is_starter, slot_order,
        card:cards(id, card_type, formation,
          player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
            note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
            clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]),u=(p||[]).filter(y=>{var b;return y.is_starter&&((b=y.card)==null?void 0:b.player)}).map(y=>ye(y.card)),f=(p||[]).filter(y=>{var b;return!y.is_starter&&((b=y.card)==null?void 0:b.player)}).map(y=>ye(y.card));if(u.length<11){tt(e,"⚠️",`Deck incomplet (${u.length}/11).`,"Compléter",()=>n("decks"));return}const x=(p||[]).find(y=>{var b;return((b=y.card)==null?void 0:b.card_type)==="formation"}),$=(c==null?void 0:c.formation)||((k=x==null?void 0:x.card)==null?void 0:k.formation)||"4-4-2",{data:v}=await w.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),_=it(u,$),m=await Xt($),{data:g}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:l,status:"in_progress"}).select().single(),h={matchId:g==null?void 0:g.id,mode:r,difficulty:d,formation:$,homeTeam:_,aiTeam:m,homeSubs:f,subsUsed:0,maxSubs:Math.min(f.length,3),homeScore:0,aiScore:0,gcCards:v||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};ti(e,h,t)}async function ei(e,t,i){const{state:n,navigate:s}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await w.from("decks").select("id,name,is_active,formation").eq("owner_id",n.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){tt(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>s("decks"));return}const a=o.map(c=>c.id),{data:d}=await w.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order");let r=0;function l(){var m,g,h,k,y;const c=o[r],p=(d||[]).filter(b=>b.deck_id===c.id),u=p.filter(b=>{var E;return b.is_starter&&((E=b.card)==null?void 0:E.player)}).map(b=>ye(b.card)),f=p.find(b=>{var E;return((E=b.card)==null?void 0:E.card_type)==="formation"}),x=c.formation||((m=f==null?void 0:f.card)==null?void 0:m.formation)||"4-4-2",$=u.length>=11?it(u,x):null,v=u.length>=11;e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center">
        ${$?`<div style="width:min(98vw, calc(100dvh - 400px));overflow:hidden;flex-shrink:0">${rt($,x,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;gap:12px;padding:12px 16px;background:#0a3d1e">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((x,$)=>{const v=N(x),_=$<p.length-1?J(x,p[$+1]):null,m=_&&_!=="#ff3333"&&_!=="#cc2222";return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
  ...
  </div>`,setTimeout(()=>{const p=document.getElementById("score-home"),u=document.getElementById("score-ai"),f=document.getElementById("midfield-result");if(p&&u&&(l?(p.style.fontSize="80px",p.style.color="#FFD700",u.style.opacity="0.25"):(u.style.fontSize="80px",u.style.color="#ff6b6b",p.style.opacity="0.25")),f){const x=Jt();f.style.opacity="1",l&&t.clubName,f.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${s?`<img src="${s}" style="width:${p-4}px;height:${p-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,p-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${E}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const u=48,f=64,x=13,$=16,v={normal:"#aaaaaa",pépite:"#D4A017",papyte:"#111111",légende:"#7a28b8"};for(const[m,g]of Object.entries(r)){const h=c(m);if(!h||!g)continue;const k=m.replace(/[0-9]/g,""),y=Z[k]||"#555",b=i==="attack"&&["MIL","ATT"].includes(k)&&!g.used||i==="defense"&&["GK","DEF","MIL"].includes(k)&&!g.used,E=n.includes(g.cardId);let T;i==="attack"?T=k==="MIL"?Number(g.note_m)||0:Number(g.note_a)||0:i==="defense"?T=k==="GK"?Number(g.note_g)||0:k==="MIL"?Number(g.note_m)||0:Number(g.note_d)||0:T=Number(k==="GK"?g.note_g:k==="DEF"?g.note_d:k==="MIL"?g.note_m:g.note_a)||0,T=T+(g.boost||0);const A=(h.x-u/2).toFixed(1),z=(h.y-f/2).toFixed(1),C=g.used?.25:1,G=v[g==null?void 0:g.rarity]||v.normal,q=E?"#ff3030":G,I=E?3:(g==null?void 0:g.rarity)==="légende"||(g==null?void 0:g.rarity)==="pépite"?2.5:2,L=f-x-$;p+=`<defs><clipPath id="cp-${m}"><rect x="${A}" y="${(h.y-f/2+x).toFixed(1)}" width="${u}" height="${L}"/></clipPath></defs>`,p+=`<rect x="${A}" y="${z}" width="${u}" height="${f}" rx="5" fill="${y}" opacity="${C}"/>`;const M=N(g);M&&!g.used&&(p+=`<image href="${M}" x="${A}" y="${(h.y-f/2+x).toFixed(1)}" width="${u}" height="${L}" clip-path="url(#cp-${m})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${A}" y="${z}" width="${u}" height="${x}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${h.x.toFixed(1)}" y="${(h.y-f/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(g.name||"").slice(0,9)}</text>`;const B=(h.y+f/2-$).toFixed(1);if(p+=`<rect x="${A}" y="${B}" width="${u}" height="${$}" fill="rgba(255,255,255,0.92)"/>`,g.used)p+=`<text x="${h.x.toFixed(1)}" y="${(h.y+f/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="13" font-weight="900" fill="rgba(0,0,0,0.4)" font-family="Arial Black">–</text>`;else{const S=xe(g.country_code);S?p+=`<image href="${S}" x="${(h.x-20).toFixed(1)}" y="${(h.y+f/2-$+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(h.x-13).toFixed(1)}" y="${(h.y+f/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${nt(g.country_code)}</text>`,p+=`<text x="${h.x.toFixed(1)}" y="${(h.y+f/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${T}</text>`;const F=ot(g);F?p+=`<image href="${F}" x="${(h.x+u/2-14).toFixed(1)}" y="${(h.y+f/2-$+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:g.clubName&&(p+=`<text x="${(h.x+14).toFixed(1)}" y="${(h.y+f/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(g.clubName||"").slice(0,3).toUpperCase()}</text>`),g.boost&&(p+=`<rect x="${(h.x+u/2-12).toFixed(1)}" y="${(h.y-f/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,p+=`<text x="${(h.x+u/2-5).toFixed(1)}" y="${(h.y-f/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${g.boost}</text>`)}p+=`<rect x="${A}" y="${z}" width="${u}" height="${f}" rx="5" fill="${E?"rgba(255,255,255,0.12)":"none"}" stroke="${q}" stroke-width="${I}" opacity="${C}"/>`,b&&(p+=`<rect x="${A}" y="${z}" width="${u}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${g.cardId}" data-role="${k}" style="cursor:pointer"/>`)}const _=38;return`<svg viewBox="${-_} ${-_} ${s+_*2} ${o+_*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  </svg>`}function rt(e,t,i,n,s=300,o=300){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Ie(e,t,i,n,s,o)}
  ...
  `,document.body.appendChild(n);let c=!1;const p=()=>{c||(c=!0,n.remove(),i())};n.addEventListener("click",p),setTimeout(p,2e3)}function te(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Ne(e,t,i,n=null){if(t.phase!=="attack"){te("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){te(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const s=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!s.length){te("Aucun joueur utilisé à remplacer");return}if(!o.length){te("Aucun remplaçant disponible");return}let a=0,d=Math.max(0,o.findIndex(p=>p.cardId===n)),r=!1;const l=document.createElement("div");l.id="sub-overlay",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function c(){var _,m,g,h,k,y;const p=s[a],u=o[d],f=Math.min(130,Math.round((window.innerWidth-90)/2)),x=Math.round(f*1.35),$=b=>`background:rgba(255,255,255,0.12);border:none;color:${b?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${b?"default":"pointer"};flex-shrink:0`;l.innerHTML=`
    ...
    </div>`,(_=l.querySelector("#sub-close"))==null||_.addEventListener("click",()=>l.remove()),(m=l.querySelector("#out-up"))==null||m.addEventListener("click",()=>{a>0&&(a--,c())}),(g=l.querySelector("#out-down"))==null||g.addEventListener("click",()=>{a<s.length-1&&(a++,c())}),(h=l.querySelector("#in-up"))==null||h.addEventListener("click",()=>{d>0&&(d--,c())}),(k=l.querySelector("#in-down"))==null||k.addEventListener("click",()=>{d<o.length-1&&(d++,c())});const v=(b,E,T,A)=>{const z=l.querySelector("#"+b);if(!z)return;let C=0;z.addEventListener("touchstart",G=>{C=G.touches[0].clientY},{passive:!0}),z.addEventListener("touchend",G=>{const q=G.changedTouches[0].clientY-C;if(Math.abs(q)<30)return;const I=E();q<0&&I<A-1?(T(I+1),c()):q>0&&I>0&&(T(I-1),c())},{passive:!0})};v("in-panel",()=>d,b=>d=b,o.length),v("out-panel",()=>a,b=>a=b,s.length),(y=l.querySelector("#sub-confirm"))==null||y.addEventListener("click",b=>{if(b.preventDefault(),b.stopPropagation(),r)return;r=!0;const E=s[a],T=o[d];if(!E||!T)return;let A=null,z=-1;for(const[G,q]of Object.entries(t.homeTeam)){const I=(q||[]).findIndex(L=>L.cardId===E.cardId);if(I!==-1){A=G,z=I;break}}if(z===-1||!A){te("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),l.remove();return}const C={...T,_line:A,_col:E._col||0,used:!1,boost:0};t.homeTeam[A].splice(z,1,C),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(T.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:E.name,firstname:E.firstname,note:D(E,A),portrait:N(E),job:E.job,country_code:E.country_code,rarity:E.rarity,clubName:E.clubName,clubLogo:E.clubLogo},inPlayer:{name:T.name,firstname:T.firstname,note:D(T,A),portrait:N(T),job:T.job,country_code:T.country_code,rarity:T.rarity,clubName:T.clubName,clubLogo:T.clubLogo},text:`🔄 ${T.firstname} ${T.name} remplace ${E.firstname} ${E.name}`}),l.remove(),di(E,T,()=>R(e,t,i))})}document.body.appendChild(l),c()}function li(e,t,i,n,s){var d,r;const o=ie[t]||{icon:"⚡",desc:"Carte spéciale."},a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;align-items:center;justify-content:center;padding:24px",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a),(d=a.querySelector("#gc-back"))==null||d.addEventListener("click",()=>a.remove()),(r=a.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{a.remove(),ci(e,t,i,n,s)})}function ci(e,t,i,n,s){if(!n.usedGc.includes(e)){switch(n.usedGc.push(e),t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{let o=!1;for(const a of["ATT","MIL","DEF","GK"]){const d=(n.homeTeam[a]||[]).find(r=>r.used);if(d){d.used=!1,o=!0;break}}n.log.push({text:o?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const o=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(a=>!a.used);if(o.length){const a=o.sort((d,r)=>D(r,"ATT")-D(d,"ATT"))[0];a.used=!0,n.log.push({text:`❄️ ${a.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}w.from("cards").delete().eq("id",e).then(()=>{}),R(i,n,s)}}function pi(e,t,i){const n=Object.values(t.homeTeam).flat().filter(s=>!s.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
  ...
  `;function d(r){const l=document.getElementById("mkt-content"),c=r==="buy"?a:o;if(c.length===0){l.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(p=>{var v,_,m;const u=(v=p.card)==null?void 0:v.player;if(!u)return"";const f=u.job==="GK"?u.note_g:u.job==="DEF"?u.note_d:u.job==="MIL"?u.note_m:u.note_a,x=ui[u.rarity],$=(i.profile.credits||0)>=p.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${xi(u.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${x};flex-shrink:0">${f}</div>
          <div style="flex:1;min-width:0">
