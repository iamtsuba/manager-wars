const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/special-cards-yI9ueqAE.js","assets/special-cards-DDWI3lot.css"])))=>i.map(i=>d[i]);
import{s as v,j as Ei,q as Bo,t as Dt,u as Li,F as Ii,o as nt,n as Ht,g as Bt,r as ze,m as ut,v as ni,w as qo,T as Bi,p as hn,x as vn,d as wn}from"./special-cards-yI9ueqAE.js";const _n="/";function mo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,s,c,d,l,f,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const d=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",x=f.trim().split(" ").filter(Boolean),b=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():f.slice(0,2).toUpperCase();d&&(d.style.background=a,d.style.borderColor=n),l&&(l.textContent=b,l.style.color=n)}document.getElementById("color1").addEventListener("input",d=>{n=d.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",d=>{a=d.target.value,document.getElementById("swatch2").style.background=a,s()});function c(d){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${d}`).classList.add("active"),document.getElementById("step-num").textContent=d,document.getElementById("progress-fill").style.width=`${Math.round(d/3*100)}%`,d===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",d.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",d).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const d=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",d.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",d).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),x=document.getElementById("step3-finish");f.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:d,club_name:l,club_color1:n,club_color2:a,credits:15e3});if(b)throw b;await $n(e.user.id),await r(),o(`Bienvenue ${d} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){f.textContent=b.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function $n(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const En="modulepreload",Ln=function(t){return"/"+t},go={},Do=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=Ln(c),c in go)return;go[c]=!0;const d=c.endsWith(".css"),l=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${l}`))return;const f=document.createElement("link");if(f.rel=d?"stylesheet":En,d||(f.as="script"),f.crossOrigin="",f.href=c,s&&f.setAttribute("nonce",s),document.head.appendChild(f),d)return new Promise((x,b)=>{f.addEventListener("load",x),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},Fo="mw_sound_volume";function Xi(){const t=localStorage.getItem(Fo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function In(t){localStorage.setItem(Fo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Ji(){return Xi()===0}function yi(t){return Math.max(0,Math.min(1,t*(Xi()/100)))}function Qi(t,e=1){if(Ji())return null;try{const i=new Audio(t);return i.volume=yi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Ni=null,bo=.3;function Po(t,e=.3){if(bo=e,ht&&Ni===t&&!ht.paused){ht.volume=yi(bo);return}if(Rt(),!Ji())try{const i=new Audio(t);i.loop=!0,i.volume=yi(e),i.play().catch(()=>{}),ht=i,Ni=t}catch{}}function Rt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Ni=null}let Qt=null;function No(t,e=.6){if(Ke(),!Ji())try{const i=new Audio(t);i.volume=yi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const Tn=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Go(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const l=document.createElement("style");l.id="home2-chrome-style",l.textContent=`
    ...
    `,document.head.appendChild(l)}const r=Tn.map(l=>`
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const s=a.dataset.action;if(s==="match-ai"){Ho(i,e);return}if(s==="match-random"){mt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Vo(t,e){var p,u;const{state:i,navigate:o}=e,r=oi(),n=Xi(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,s="2026.07.28-1743";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${ze(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),d=(s||[]).filter(C=>C.card_type==="player"&&C.player),l=(s||[]).filter(C=>C.card_type==="game_changer"),f=(s||[]).filter(C=>C.card_type==="formation"),x=(s||[]).filter(C=>C.card_type==="stadium"),{data:b}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(C=>{g[C.name]=C});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(C=>{u[C.id]=C}),x.forEach(C=>{C.stadium_def&&(u[C.stadium_id]=C.stadium_def)});const y=Object.keys(Ii),w=Object.keys(Me),h={};d.forEach(C=>{const V=C.player.id;h[V]=(h[V]||0)+1}),new Set(Object.keys(h).map(C=>String(C)));const E=new Set(f.map(C=>C.formation)),m=new Set(l.map(C=>C.gc_type));let S="player",$="Tous",A="",P=!1;function G(){return[...d].sort((C,V)=>{const Q=pi.indexOf(C.player.job),X=pi.indexOf(V.player.job);return Q!==X?Q-X:(C.player.surname_real||"").localeCompare(V.player.surname_real||"")})}function O(){return[...c||[]].sort((C,V)=>{const Q=pi.indexOf(C.job),X=pi.indexOf(V.job);return Q!==X?Q-X:(C.surname_real||"").localeCompare(V.surname_real||"")})}function Y(){return G().filter(C=>{const V=C.player,Q=$==="Tous"||V.job===$,X=!A||`${V.firstname} ${V.surname_real}`.toLowerCase().includes(A);return Q&&X})}function I(){return O().filter(C=>{const V=$==="Tous"||C.job===$,Q=!A||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(A);return V&&Q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",V=>{A=V.target.value.toLowerCase(),R()}),t.querySelectorAll(".filter-btn").forEach(V=>{V.addEventListener("click",()=>{$=V.dataset.job,_(),R()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{P=!P,_(),R()})):(C.innerHTML=`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${G}${l.job2&&O>0?` / ${Y}`:""}`:`Note actuelle : ${G}${l.job2&&O>0?` / ${Y}`:""}`}
            </div>
          </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(V=document.getElementById("close-detail"))==null||V.addEventListener("click",s);let K=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(W=>{if(W.dataset.id===t.id)return;const se=Number(W.dataset.evo)||0,ge=Number(W.dataset.note)||0;z+=ge+se}),Math.round(z*le)}const j=()=>{const z=K.size,W=document.getElementById("sell-action-panel");if(!W)return;W.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const W=z.dataset.id;z.checked?K.add(W):K.delete(W);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",W=>{if(W.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(x<=1)return;const z=[...K];if(!z.length)return;if(K.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(S=>{S.addEventListener("click",()=>or(S.dataset.pos,e,t,o))})}function ir(t,e,i){var s;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(c=>{const d=c.stadium_id||c.id;return n.has(d)?!1:(n.add(d),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let c=!1;const d=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function l(_){n||(c=!0,s.style.opacity="1",f(_))}function f(_){if(!c||n)return;const R=a.getBoundingClientRect(),K=d(_)-R.left,le=Math.max(0,Math.min(1,K/R.width));s.style.width=le*R.width+"px",le>=.82&&b()}function x(){n||(c=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{n||(s.style.transition="")},220))}function b(){var R;if(n)return;n=!0,c=!1,s.style.width="100%",s.style.opacity="1",(R=document.getElementById("cut-flash"))==null||R.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",f),window.addEventListener("pointerup",x),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",x);let g=0,p=!1;const u=new Set;function y(_){g=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),A()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((R,K)=>`<div class="card-dot" data-i="${K}" style="width:8px;height:8px;border-radius:50%;background:${K===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(R=>R.addEventListener("click",()=>m(parseInt(R.dataset.i)))))}function h(_,R){var C,V;const K=t[_],le=document.getElementById("card-counter"),ce=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${t.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=_===t.length-1?"flex":"none");const H=K.card_type==="player"&&((C=K.player)==null?void 0:C.rarity)==="legende",pe=!u.has(_);u.add(_);let me=0;if(K.card_type==="player"&&K.player){const Q=K.player,X=Q.job||"ATT";me=(Number(X==="GK"?Q.note_g:X==="DEF"?Q.note_d:X==="MIL"?Q.note_m:Q.note_a)||0)+(K.evolution_bonus||0)}const fe=Q=>{ce.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${H?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${mr(K)}</div>
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Y(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!y)return;const R=_.clientWidth>=900,K=Math.max(200,_.clientHeight-(R?60:40)),ce=Math.max(200,_.clientWidth-16),j=R?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(K<220||ce<220){requestAnimationFrame(Y);return}const H=R?null:Math.round(j*.55);I.innerHTML=Ut(y,u,null,[],ce,K,[],H),I.style.cssText=`width:${ce}px;height:${K}px;overflow:hidden;margin:${R?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",R?"xMidYMid meet":"none"))})),(A=document.getElementById("prev-deck"))==null||A.addEventListener("click",()=>{l>0&&(l--,f())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{l<n.length-1&&(l++,f())}),(G=document.getElementById("validate-deck"))==null||G.addEventListener("click",()=>{if(!h)return;const Y=e.state.params||{};e.navigate("match",{...Y,matchMode:Y.matchMode||i,deckId:x.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let Y=0,I=0;E.addEventListener("touchstart",_=>{Y=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const R=_.changedTouches[0].clientX-Y,K=_.changedTouches[0].clientY-I;Math.abs(R)<40||Math.abs(R)<Math.abs(K)||(R<0&&l<n.length-1?(l++,f()):R>0&&l>0&&(l--,f()))},{passive:!0})}}f()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,c)=>{const d=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(d==="ATT"||d==="MIL")||o==="defense"&&(d==="GK"||d==="DEF"||d==="MIL")?l+=10:o||(l+=10)),a+=ze({...s,_evolution_bonus:0,evolution_bonus:0},{width:40,role:d,extraNote:l}),c<n.length-1){const f=n[c+1],x=Yo(s,f,r)?Dt(s,f):null;a+=`<div style="width:7px;height:3px;background:${!x||x==="#ff3333"||x==="#cc2222"?"rgba(255,255,255,0.12)":x};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Ai(t,e,i,o,r=310,n=310,a=[],s=null){const c=ut[e]||{},d=Li(e)||Ii[e]||[],l={},f=["ATT","MIL","DEF","GK"];for(const y of f)(t[y]||[]).forEach((h,E)=>{l[`${y}${E+1}`]=h});function x(y){const w=c[y];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[y,w]of d){const h=x(y),E=x(w);if(!h||!E)continue;const m=l[y],S=l[w],$=Dt(m,S);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
    ...
    ${Ai(t,e,i,o,r,n,a,s)}
  </div>`}async function zi(t,e,i,o){var S;const{state:r,navigate:n,toast:a}=e;ct(t);const s=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return _r(t,e,i);const c=s.deckId;let d,l,f,x;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);d=$[0].data,f=$[0].error,l=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Mt(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),Mt(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(l||[]).filter($=>{var A;return $.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Hi($.card,$.position)),g=(l||[]).filter($=>{var A;return!$.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Hi($.card,$.position));if(b.length<11){Mt(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(l||[]).find($=>{var A;return((A=$.card)==null?void 0:A.card_type)==="formation"}),u=(d==null?void 0:d.formation)||((S=p==null?void 0:p.card)==null?void 0:S.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(A=>A.name===$.gc_type||A.id===$.gc_definition_id))||null}));let m=null;if(d!=null&&d.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",d.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:A}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=A||null}}o({deckId:c,formation:u,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function Ct(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(Ct()*1.1)}function an(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Bt(t)}}function kr(t,e,i,o="Adversaire"){Po("/sounds/match-opening.mp3",.3);const r=Ct(),n=Ot();return`
    ...
    </div>`}function sn(t){var n,a,s;if(!t)return"";const e=c=>c?ze({...c,_evolution_bonus:0},{width:52,role:c._line||c.job,showStad:!!c.stadiumBonus,extraNote:c.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function ln(t,e){const i=Ne(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+ln(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Dt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function _i(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const s=a<t.length-1?Dt(n,t[a+1]):null,c=!s||s==="#ff3333"||s==="#cc2222",d=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return ln(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function Er(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",s=o.soloLevel||1,c=r.replace("vs_ai_",""),d=r;let l=null;if(n){const{data:g}=await v.from("solo_levels").select("*").eq("level_number",s).maybeSingle();l=g||{level_number:s,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const f=o.rankedData||null,x=o.presetSetup||null;async function b({deckId:g,formation:p,starters:u,subsRaw:y,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let m=wi(u,p);E&&(m=di(m,E),vi(y,E));let S=null;if(a){const G=Ir(m),{jaune:O,vert:Y}=Tr(m,p),I=.9+Math.random()*.2;S={target_note_avg:Math.max(1,Math.round(G*I/16)),nb_liens_jaune:O,nb_liens_vert:Y,nb_joueurs_stade:E?3:0}}const $=n?await Lo(p,l):a?await Lo(p,S):await Lr(p,c),A=$.lines||$,P=async G=>{try{const O=d==="vs_ai_club"||d==="solo"||d==="ranked_ai"?"club":d,{data:Y,error:I}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:O,home_deck_id:g,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),Mt(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&A&&(di(A,_),vi($.subs||[],_));const R={gcDefs:h||[],matchId:Y==null?void 0:Y.id,mode:d,difficulty:c,formation:p,isSolo:n,soloLevel:s,soloLevelConfig:l,isRankedAI:a,rankedAIData:f,homeTeam:m,aiTeam:A,homeSubs:y,subsUsed:0,maxSubs:Math.min(y.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:G,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Sr(t,R,e)}catch(O){console.error("[MatchIA] Exception launchMatch:",O),Mt(t,"⚠️","Erreur au lancement du match : "+O.message,"Retour",()=>e.navigate("home"))}};if(a&&x){P(x.gcCardsEnriched||[]);return}if(!w.length){P([]);return}Si(t,w,P)}catch(m){console.error("[MatchIA] Exception setup:",m),Mt(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}x?await b(x):await zi(t,e,r,b)}async function Lr(t,e){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(y,w,h){var E,m;return n.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!n.has($.id)),h=i.filter($=>$.job!==y&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[y];$++){const A=E[$];A&&m.push(a(A,y,$))}const S=dt(m.length);m.forEach(($,A)=>{$._col=S[A]}),r[y]=m}const c=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),f=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var h,E;return{id:"ai-gc-"+w,gc_type:y,name:((h=Me[y])==null?void 0:h.name)||y,icon:((E=Me[y])==null?void 0:E.icon)||"⚡"}}),x=Object.values(r).flat(),b={};x.forEach(y=>{y.club_id&&(b[y.club_id]=(b[y.club_id]||0)+1)});const g=(u=Object.entries(b).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:r,subs:c,gcCards:f,stadiumDef:p}}function Ir(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Tr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((s,c)=>{i[`${a}${c+1}`]=s});const o=Li(e)||Ii[e]||[];let r=0,n=0;for(const[a,s]of o){const c=i[a],d=i[s];if(!c||!d)continue;const l=Dt(c,d);l==="#00ff88"?n++:l==="#FFD700"&&r++}return{jaune:r,vert:n}}function Eo(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function mi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(Eo(r)-e)-Math.abs(Eo(n)-e));return o.slice(0,Math.min(i,o.length))}async function Lo(t,e){var Y,I;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const s={};a.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const c=((Y=Object.entries(s).sort((_,R)=>R[1]-_[1])[0])==null?void 0:Y[0])||null,d=c?a.filter(_=>_.club_id===c):[],l=((I=d[0])==null?void 0:I.country_code)||null,f=l?a.filter(_=>_.country_code===l&&_.club_id!==c):[],x=Math.min(d.length,Math.max(2,r+1),16),b=Math.min(f.length,Math.max(0,o),16-x),g=[],p=new Set;mi(d,i,x).forEach(_=>{g.push(_),p.add(_.id)}),mi(f,i,b).forEach(_=>{g.push(_),p.add(_.id)});const u=Math.max(0,16-g.length),y=a.filter(_=>!p.has(_.id));mi(y,i,u).forEach(_=>{g.push(_),p.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,R,K){var le,ce;return E.add(_.id),{cardId:"ai-"+_.id+"-"+K,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((le=_.clubs)==null?void 0:le.encoded_name)||null,clubLogo:((ce=_.clubs)==null?void 0:ce.logo_url)||null,boost:0,used:!1,_line:R}}for(const _ of["GK","DEF","MIL","ATT"]){const R=g.filter(H=>H.job===_&&!E.has(H.id)),K=g.filter(H=>H.job!==_&&!E.has(H.id)),le=[...R,...K],ce=[];for(let H=0;H<w[_];H++){const pe=le[H];pe&&ce.push(m(pe,_,H))}const j=dt(ce.length);ce.forEach((H,pe)=>{H._col=j[pe]}),h[_]=ce}let S=g.filter(_=>!E.has(_.id));if(S.length<5){const _=a.filter(R=>!E.has(R.id)&&!S.some(K=>K.id===R.id));S=S.concat(mi(_,i,5-S.length))}const $=S.slice(0,5).map((_,R)=>m(_,_.job,100+R)),G=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((_,R)=>{var K,le;return{id:"ai-gc-"+R,gc_type:_,name:((K=Me[_])==null?void 0:K.name)||_,icon:((le=Me[_])==null?void 0:le.icon)||"⚡"}});let O=null;if(n>0&&c){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(O={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:G,stadiumDef:O}}function dn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<e[n];c++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const s=dt(a.length);a.forEach((c,d)=>{c._col=s[d]}),i[n]=a}return i}function Sr(t,e,i){var r;Po("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div id="match-history-panel">
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(S=f.querySelector("#out-up"))==null||S.addEventListener("click",()=>{s>0&&(s--,x())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<n.length-1&&(s++,x())}),(A=f.querySelector("#in-up"))==null||A.addEventListener("click",()=>{d>0&&(d--,x())}),(P=f.querySelector("#in-down"))==null||P.addEventListener("click",()=>{d<a.length-1&&(d++,x())});const E=(O,Y,I,_)=>{const R=f.querySelector("#"+O);if(!R)return;let K=0;R.addEventListener("touchstart",le=>{K=le.touches[0].clientY},{passive:!0}),R.addEventListener("touchend",le=>{const ce=le.changedTouches[0].clientY-K;if(Math.abs(ce)<30)return;const j=Y();ce<0&&j<_-1?(I(j+1),x()):ce>0&&j>0&&(I(j-1),x())},{passive:!0})};E("in-panel",()=>d,O=>d=O,a.length),E("out-panel",()=>s,O=>s=O,n.length),(G=f.querySelector("#sub-confirm"))==null||G.addEventListener("click",O=>{if(O.preventDefault(),O.stopPropagation(),l)return;l=!0;const Y=n[s],I=a[d];if(!Y||!I)return;let _=null,R=-1;for(const[le,ce]of Object.entries(e.homeTeam)){const j=(ce||[]).findIndex(H=>H.cardId===Y.cardId);if(j!==-1){_=le,R=j;break}}if(R===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const K={...I,_line:_,_col:Y._col||0,used:!1,boost:0};e.homeTeam[_].splice(R,1,K),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:Ne(Y,_),portrait:Bt(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Ne(I,_),portrait:Bt(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${Y.firstname} ${Y.name}`}),f.remove(),$r(Y,I,()=>Te(t,e,i))})}document.body.appendChild(f),x()}function Dr(t,e,i,o,r){var x,b;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Me[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||a.desc,d=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${nt(s,d,l,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#gc-back"))==null||x.addEventListener("click",()=>f.remove()),(b=f.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{f.remove(),Pr(t,e,i,o,r)})}function gi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function c(){var d,l;a.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${vr[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Ne(r,r._line||r.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Te(t,e,i)})})}async function _t(t,e,i){var x,b,g,p;Rt(),Ke(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",s=e.isSolo&&((x=e.soloLevelConfig)!=null&&x.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):Un(e.mode,a);if(e.isSolo&&r)try{const{data:u}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),y=(u==null?void 0:u.unlocked_level)||1;e.soloLevel>=y&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(u){console.warn("[Solo] Erreur mise à jour progression:",u.message)}const c="00000000-0000-0000-0000-000000000000";let d=null;if(e.isRankedAI)try{const{data:u}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(u){const y=u.mmr??1e3,w=u.mmr_deviation??350,h=u.mmr_volatility??.06,E=r?1:n?.5:0,m=(u.placement_matches??0)<10,S=qo(y,w,h,y,350,E,m),$=n?null:r?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:S.delta,p_away_delta:0,p_home_new_rd:S.newRd,p_away_new_rd:350,p_home_new_vol:S.newSigma,p_away_new_vol:.06}),d=S.delta}}catch(u){console.warn("[RankedAI] Erreur mise à jour MMR:",u.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const l={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};r?l.wins=(o.profile.wins||0)+1:n?l.draws=(o.profile.draws||0)+1:l.losses=(o.profile.losses||0)+1,await v.from("users").update(l).eq("id",o.profile.id),await i.refreshProfile();const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",f.innerHTML=`
    ...
    </div>`,st=m[p+"Team"],yn=(()=>{var he,Ce,Ie,Nt,lt;if(D&&((he=m.pendingAttack)!=null&&he.players)){const Pe=m.pendingAttack;let Oe="";if(U.length>0){const je=U.map(Qe=>{const Yt=(st[Qe._role]||[]).find(ji=>ji.cardId===Qe.cardId)||Qe,Wt=st[Qe._role]||[],ci=Wt.findIndex(ji=>ji.cardId===Qe.cardId),Ci=dt(Wt.length),Xt=ci>=0?Ci[ci]:Yt._col??1;return{...Yt,_line:Qe._role,_col:Xt}}),xt=li(je,((Ce=m.modifiers)==null?void 0:Ce[p])||{},m[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(Re=ie.querySelector("#psub-close"))==null||Re.addEventListener("click",()=>ie.remove()),(Ae=ie.querySelector("#pout-up"))==null||Ae.addEventListener("click",()=>{D>0&&(D--,te())}),(Xe=ie.querySelector("#pout-down"))==null||Xe.addEventListener("click",()=>{D<N.length-1&&(D++,te())}),(He=ie.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{ee>0&&(ee--,te())}),(rt=ie.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{ee<q.length-1&&(ee++,te())});const Se=(Fe,Je,Ue,gt)=>{const at=ie.querySelector("#"+Fe);if(!at)return;let Ft=0;at.addEventListener("touchstart",bt=>{Ft=bt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",bt=>{const Lt=bt.changedTouches[0].clientY-Ft;if(Math.abs(Lt)<30)return;const st=Je();Lt<0&&st<gt-1?(Ue(st+1),te()):Lt>0&&st>0&&(Ue(st-1),te())},{passive:!0})};Se("pin-panel",()=>ee,Fe=>ee=Fe,q.length),Se("pout-panel",()=>D,Fe=>D=Fe,N.length),(Vt=ie.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),oe)return;oe=!0;const Je=N[D],Ue=q[ee];if(!Je||!Ue)return;const gt=Je._line,at=(M[gt]||[]).findIndex(Lt=>Lt.cardId===Je.cardId);if(at===-1){g("Erreur : joueur introuvable","error"),ie.remove();return}const Ft={...Ue,_line:gt,position:Je.position,used:!1,boost:0};M[gt].splice(at,1,Ft);const bt=[...B,Ue.cardId];ie.remove(),re(Je,Ue,async()=>{await I({[p+"Team"]:M,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:bt})})})}document.body.appendChild(ie),te()}function re(k,L,M){const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(U,ee,oe)=>`<div style="text-align:center">
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(Y=document.getElementById("cancel-mm"))==null||Y.addEventListener("click",async()=>{await m(),Ve(t),x("home")});const S=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await qt(t,e,I,_,{myGC:a,gcDefs:s,stadiumDef:c,isRanked:d,rankedData:l,onMatchEnd:d?Yr:null}))},$=f.user.id,{data:A,error:P}=d?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(A!=null&&A.success)){console.error("[Matchmaking] try_matchmake error:",P||A),b("Erreur de matchmaking","error"),Ve(t),x("home");return}if(A.matched){await S(A.match_id,!1);return}const G=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await S(I.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&S(_.match_id,!0)}).subscribe(),E=setInterval(G,3e3),d?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),x("match",{matchMode:"ranked_ai",rankedData:l,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:s,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function Yr(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:s,awayScore:c,matchId:d}=t,l=i.user.id,f=n===l,x=r===l,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:n).single();if(b&&g){const p=qo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,x?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(x?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,x?"success":"error",4e3)}}const Wr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Vi,resumePvpMatch:Kr},Symbol.toStringTag,{value:"Module"}));async function Xr(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,s=n.friendName||"Ami",c=!!n.isAccepting;await zi(t,e,"friend",async({deckId:d,formation:l,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const w=y||[];c?await Qr(t,e,d,w,g,p):await Jr(t,e,d,w,g,p,a,s)};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}async function Jr(t,e,i,o,r,n,a,s){var w;const{state:c,navigate:d,toast:l}=e,f=c.user.id,{data:x,error:b}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!x){console.error("[Friend] Erreur création invitation:",b),l("Impossible de créer l'invitation","error"),d("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`}function ta(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(r=>$i(r,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(r=>$i(r,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${it}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function ia(t,e){return t.length?t.map(i=>$i(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league en cours.</div>`}function oa(t,e,i={}){return t.length?t.map(o=>$i(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league archivée.</div>`}function na(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function mn(t,e,i,o){var f;const{toast:r,state:n}=e,a=n.profile.id;let s=null;if(o==="private"&&(s=await ra(),s===null))return;const{data:c,error:d}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(d||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",d||c),r((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",a).single();n.profile&&x&&(n.profile.credits=x.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((f=n.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function aa(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(x=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`;let l=!1;const f=async u=>{if(!l){if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}u&&await qt(t,e,u,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:s}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}d("mini-league",{openLeagueId:o}),c()});const x=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&f(u.new.match_id)}).subscribe(),g=setInterval(x,3e3);x()})}const ma="/",ga=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ba(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,f,x;const s=e[o],c=o===e.length-1,d=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function x(p){var G,O,Y,I;const u=(G=p.card)==null?void 0:G.player;if(!u)return"";const y=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=bi(u,u.job,y),h=u.job2?bi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,S=Mo[u.job]||"#bbb",$=u.job2?Mo[u.job2]||"#bbb":null,A=u.job==="GK"?"#fff":S,P=u.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
          ...
          <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${I?"border:2px solid var(--yellow)":""}">
            ...
            <div style="flex:1;min-width:0">
              ...
              <div style="font-size:11px;color:var(--tile-fg-dim)">${A.club_name} · ${G.label}</div>
            </div>
            <div style="text-align:right;flex-shrink:0">
  ...
  </div>`}hn(wn);const ve={user:null,profile:null,page:"home",params:{}};function It(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function $a(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Wi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const gn="mw_theme";function oi(){return localStorage.getItem(gn)||"club"}function Co(t){var e;localStorage.setItem(gn,t),xi(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function xi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function zt(t,e={}){ve.page=t,ve.params=e,bn()}async function bn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:zt,toast:It,openModal:$a,closeModal:Wi,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await qi(t,i);break;case"home2":await qi(t,i);break;case"game":await Hn(t,i);break;case"settings":await Vo(t,i);break;case"collection":await Jn(t,i);break;case"decks":await Gi(t,i);break;case"boosters":await cr(t,i);break;case"ranked":await _a(t,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Vi(t,i,!1):s==="ranked"?await Vi(t,i,!0):s==="friend"?await Xr(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await Ao(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await Er(t,i);break}case"market":await xa(t,i);break;case"rankings":await wa(t,i);break;case"matches":await ka(t,i);break;case"friends":await Nn(t,i);break;case"mini-league":await ea(t,i);break;case"match-mini-league":{const s=ve.params||{};await Ao(t,i,s.mlMatchId,s.leagueId);break}default:await qi(t,i)}}function Ea(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.28-1743" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),zt(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>zt("home")),document.getElementById("nav-credits").addEventListener("click",()=>zt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>La()),(r=document.getElementById("settings-btn"))==null||r.addEventListener("click",()=>zt("settings"))}async function La(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const r=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${r}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
