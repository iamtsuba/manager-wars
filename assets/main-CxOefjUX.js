...
import{s as v,j as _i,q as So,t as Ut,u as Ui,F as Ki,o as tt,n as Rt,g as Mt,r as Se,m as wt,v as mi,w as fn,T as Si,p as mn,x as gn,d as xn}from"./special-cards-lEGt-tGs.js";const bn="/";function po(t,{navigate:e,toast:i}){let o="login";const a=()=>{var r,s,d,c,l,f,b;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=n),l&&(l.textContent=x,l.style.color=n)}document.getElementById("color1").addEventListener("input",c=>{n=c.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await v.from("users").insert({id:e.user.id,pseudo:c,club_name:l,club_color1:n,club_color2:r,credits:1e4});if(x)throw x;await hn(e.user.id),await a(),o(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function hn(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const vn="modulepreload",wn=function(t){return"/"+t},uo={},Ao=function(e,i,o){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(d=>{if(d=wn(d),d in uo)return;uo[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":vn,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},zo="mw_sound_volume";function Vi(){const t=localStorage.getItem(zo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function _n(t){localStorage.setItem(zo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Yi(){return Vi()===0}function gi(t){return Math.max(0,Math.min(1,t*(Vi()/100)))}function Wi(t,e=1){if(Yi())return null;try{const i=new Audio(t);return i.volume=gi(e),i.play().catch(()=>{}),i}catch{return null}}let xt=null,Bi=null,fo=.3;function Mo(t,e=.3){if(fo=e,xt&&Bi===t&&!xt.paused){xt.volume=gi(fo);return}if(Gt(),!Yi())try{const i=new Audio(t);i.loop=!0,i.volume=gi(e),i.play().catch(()=>{}),xt=i,Bi=t}catch{}}function Gt(){if(xt)try{xt.pause(),xt.currentTime=0}catch{}xt=null,Bi=null}let Jt=null;function Co(t,e=.6){if(Ue(),!Yi())try{const i=new Audio(t);i.volume=gi(e),i.play().catch(()=>{}),Jt=i}catch{}}function Ue(){if(Jt)try{Jt.pause(),Jt.currentTime=0}catch{}Jt=null}const kn=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"game",route:"game",label:"GAME",emoji:"🎮"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function jo(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const l=document.createElement("style");l.id="home2-chrome-style",l.textContent=`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Ai(t,{state:e,navigate:i,toast:o}){var L,m,M,E,I,D;const a=e.profile;if(!a)return;const n="/icons/";jo(i,a,"home2",n);const r=a.mmr??1e3,s=_i(r),d=En(r,s),c=So(r),l=isFinite(s.max)?s.max+1:null,[{list:f,iAmInTop:b,myPosition:x},g,p]=await Promise.all([Ln(a.id),Tn(5),In()]),u=(O,Y)=>`
  ...
  <div class="home-dark" id="home-dark">
    ...
    <div class="modal-body" style="padding:16px">
      ...
      </div>`}).join(""),d.querySelectorAll(".solo-level-card").forEach(c=>{c.dataset.locked!=="true"&&(c.addEventListener("mouseenter",()=>{c.style.transform="translateY(-1px)"}),c.addEventListener("mouseleave",()=>{c.style.transform=""}),c.addEventListener("click",()=>{o(),Kt(),t("match",{matchMode:"solo",soloLevel:Number(c.dataset.level)})}))})}}const ii="#1A6B3C",oi="#cc2222",jn="#D4A017",mo="#888";async function Bn(t,e){const{state:i,toast:o}=e;t.innerHTML=`
    ...
    </div>`,await Fo(i,o,e),document.getElementById("btn-add-friend").addEventListener("click",()=>Dn(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Po(i,o,null,e))}async function Fo(t,e,i={}){const{navigate:o}=i,a=t.user.id,{data:n,error:r}=await v.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${a},addressee_id.eq.${a}`),{count:s}=await v.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",a).eq("status","pending"),d=document.getElementById("pending-badge");d&&(s>0?(d.style.display="flex",d.textContent=s):d.style.display="none");const c=document.getElementById("friends-list");if(!c)return;if(r){console.error("[Friends] Erreur:",r),c.innerHTML=`<div style="color:${oi};text-align:center;padding:16px">Erreur chargement : ${r.message}</div>`;return}const l=(n||[]).map(x=>x.requester_id===a?x.addressee_id:x.requester_id);let f={};if(l.length){const{data:x}=await v.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",l);(x||[]).forEach(g=>{f[g.id]=g})}const b=(n||[]).map(x=>({friendshipId:x.id,friend:f[x.requester_id===a?x.addressee_id:x.requester_id]||{pseudo:"?"}}));if(!b.length){c.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${b.map(({friendshipId:x,friend:g})=>qn(g,x)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(x=>{x.addEventListener("click",()=>Fn(t,x.dataset.stats,x.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(x=>{x.addEventListener("click",async()=>{const g=x.dataset.friendId,p=x.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const u=t.user.id,{data:y}=await v.from("friend_match_invites").select("id").eq("inviter_id",g).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!y;console.log("[Friends] clic match",{fid:g,fname:p,isAccepting:w}),Kt(),o("match",{matchMode:"friend",friendId:g,friendName:p,isAccepting:w})})})}function qn(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",a=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||ii,r=t.club_color1||"#ffffff",s=t.last_seen_at?new Date(t.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(r=>{r.addEventListener("click",()=>{r.style.transform="scale(.96)",setTimeout(()=>r.style.transform="",180);const s=r.dataset.action;if(s==="match-ai"){Do(i,e);return}if(s==="match-random"){Kt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Go(t,e){var f;const{state:i,navigate:o}=e,a=dn(),n=Vi(),r=(f=i==null?void 0:i.profile)==null?void 0:f.is_admin,s="2026.07.26-1851";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Se(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),b=(s||[]).filter($=>$.card_type==="stadium"),{data:x}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach($=>{g[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),b.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const y=Object.keys(Ki),w=Object.keys(Ae),h={};c.forEach($=>{const C=$.player.id;h[C]=(h[C]||0)+1}),new Set(Object.keys(h).map($=>String($)));const L=new Set(f.map($=>$.formation)),m=new Set(l.map($=>$.gc_type));let M="player",E="Tous",I="",D=!1;function O(){return[...c].sort(($,C)=>{const R=li.indexOf($.player.job),P=li.indexOf(C.player.job);return R!==P?R-P:($.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function Y(){return[...d||[]].sort(($,C)=>{const R=li.indexOf($.job),P=li.indexOf(C.job);return R!==P?R-P:($.surname_real||"").localeCompare(C.surname_real||"")})}function J(){return O().filter($=>{const C=$.player,R=E==="Tous"||C.job===E,P=!I||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(I);return R&&P})}function A(){return Y().filter($=>{const C=E==="Tous"||$.job===E,R=!I||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(I);return C&&R})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ci=1e3;function Yn(t,e,i,o){var g,p,u;const{state:a,toast:n,closeModal:r,navigate:s,refreshProfile:d}=i,c=t.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=wt[c]||{},w=Ki[c]||[],h=290,L=360,m=20;function M(I){const D=y[I];return D?{x:D.x*h,y:D.y*L}:null}let E=`<svg width="${h}" height="${L}" viewBox="0 0 ${h} ${L}" xmlns="http://www.w3.org/2000/svg">`;for(const[I,D]of w){const O=M(I),Y=M(D);!O||!Y||(E+=`<line x1="${O.x}" y1="${O.y}" x2="${Y.x}" y2="${Y.y}"
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([$,C])=>{const R=zi[$],P=$==="GK"?"#fff":R,X=$===l.job||$===l.job2,q=(Number(C)||0)+(X&&m>0?m:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",s);let A=new Set;const _=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function H(){let $=0;return document.querySelectorAll(".expl-check:checked").forEach(C=>{if(C.dataset.id===t.id)return;const P=Number(C.dataset.evo)||0,X=Number(C.dataset.note)||0;$+=X+P}),Math.round($*_)}const W=()=>{const $=A.size,C=document.getElementById("sell-action-panel");if(!C)return;C.style.display=$>0?"block":"none",document.getElementById("sell-selected-count").textContent=$;const R=document.getElementById("evolve-btn");if(R){const P=H();R.textContent=P>0?`⬆️ Évoluer (+${P})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach($=>{$.addEventListener("change",()=>{const C=$.dataset.id;$.checked?A.add(C):A.delete(C);const R=$.closest(".exemplaire-row");if(R){const P=R.querySelector(".expl-sel-overlay"),X=R.querySelector(".expl-sel-check");P&&(P.style.display=$.checked?"block":"none"),X&&(X.style.display=$.checked?"flex":"none"),R.style.transform=$.checked?"scale(1.05)":"scale(1)"}W()})}),document.querySelectorAll(".exemplaire-row").forEach($=>{$.addEventListener("click",C=>{if(C.target.tagName==="INPUT")return;const R=$.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),(U=document.getElementById("evolve-btn"))==null||U.addEventListener("click",async()=>{if(b<=1)return;const $=[...A];if(!$.length)return;if(A.has(t.id)){const oe=document.createElement("div");oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",oe.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}function Qe(t,e,i,o,a){Wi("/sounds/goal.mp3",.7);const n=document.getElementById("goal-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="goal-anim-overlay",r.style.cssText=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,a.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.3s",setTimeout(()=>a.remove(),300)},i)}function en(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function bt(t,e){return t.reduce((i,o)=>i+en(o,e),0)}function yt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Ut(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function hi(t,e,i,o,a){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
  ...
  <div id="match-history-panel">
    ...
    </div>`,rt=m[p+"Team"],un=(()=>{var ge,Me,_e,qt,at;if(G&&((ge=m.pendingAttack)!=null&&ge.players)){const Fe=m.pendingAttack;let Re="";if(V.length>0){const Ce=V.map(We=>{const Yt=(rt[We._role]||[]).find(Ii=>Ii.cardId===We.cardId)||We,Wt=rt[We._role]||[],si=Wt.findIndex(Ii=>Ii.cardId===We.cardId),Ti=st(Wt.length),Xt=si>=0?Ti[si]:Yt._col??1;return{...Yt,_line:We._role,_col:Xt}}),mt=ri(Ce,((Me=m.modifiers)==null?void 0:Me[p])||{},m[p+"Formation"]);Re=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(Ne=te.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>te.remove()),(Ie=te.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{G>0&&(G--,ee())}),(Ve=te.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{G<N.length-1&&(G++,ee())}),(Oe=te.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{Z>0&&(Z--,ee())}),(ot=te.querySelector("#pin-down"))==null||ot.addEventListener("click",()=>{Z<F.length-1&&(Z++,ee())});const Le=(De,Ye,He,ut)=>{const nt=te.querySelector("#"+De);if(!nt)return;let jt=0;nt.addEventListener("touchstart",ft=>{jt=ft.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",ft=>{const Et=ft.changedTouches[0].clientY-jt;if(Math.abs(Et)<30)return;const rt=Ye();Et<0&&rt<ut-1?(He(rt+1),ee()):Et>0&&rt>0&&(He(rt-1),ee())},{passive:!0})};Le("pin-panel",()=>Z,De=>Z=De,F.length),Le("pout-panel",()=>G,De=>G=De,N.length),(Vt=te.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ie)return;ie=!0;const Ye=N[G],He=F[Z];if(!Ye||!He)return;const ut=Ye._line,nt=(z[ut]||[]).findIndex(Et=>Et.cardId===Ye.cardId);if(nt===-1){g("Erreur : joueur introuvable","error"),te.remove();return}const jt={...He,_line:ut,position:Ye.position,used:!1,boost:0};z[ut].splice(nt,1,jt);const ft=[...B,He.cardId];te.remove(),X(Ye,He,async()=>{await A({[p+"Team"]:z,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:ft})})})}document.body.appendChild(te),ee()}function X(k,T,z){const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(V,Z,ie)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${$i(m[u+"Team"],m[u+"Formation"],null,[],At(),Nt())}</div>
    ...
    </div>`,(S=document.getElementById("pvp-home"))==null||S.addEventListener("click",()=>{try{v.removeChannel(J)}catch{}it(t),l?x("mini-league",{openLeagueId:l}):x("home")})}U()}async function Ri(t,e,i=!1){var s,d;const{state:o,navigate:a,toast:n}=e,r=i&&((d=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await Ei(t,e,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{lt(t);const u=async y=>{await Nr(t,e,c,l,f,b,y||[],g,p,i,r)};if(!(x!=null&&x.length)){await u([]);return}ki(t,x,u)})}async function Gr(t,e,i){return Pr(t,e,i)}async function Nr(t,e,i,o,a,n,r=[],s=[],d=null,c=!1,l=null){var Y,J;const{state:f,navigate:b,toast:x}=e,g=(l==null?void 0:l.mmr)??((Y=f.profile)==null?void 0:Y.mmr)??1e3,p=c?_i(g):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,L=null;t.innerHTML=`
  ...
  </div>`}function Wr(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${Ze};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(a=>wi(a,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${Ze};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(a=>wi(a,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${Ze}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function Xr(t,e){return t.length?t.map(i=>wi(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${Ze}">Aucune mini league en cours.</div>`}function Jr(t,e,i={}){return t.length?t.map(o=>wi(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${Ze}">Aucune mini league archivée.</div>`}function Qr(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function b(p){var I,D,O,Y;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const y=((D=p.card)==null?void 0:D.evolution_bonus)||0,w=fi(u,u.job,y),h=u.job2?fi(u,u.job2,y):0,L=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=To[u.job]||"#bbb",E=u.job2?To[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${L?"opacity:0.7":""}">
