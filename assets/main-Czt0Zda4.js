...
import{s as v,j as ki,q as zo,t as Bt,u as $i,F as Ei,o as nt,n as Ht,g as Ct,r as ze,m as ut,v as oi,w as Mo,T as Ci,p as bn,x as xn,d as yn}from"./special-cards--9JnHrqo.js";const hn="/";function uo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,s,c,d,l,f,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const s=a.dataset.action;if(s==="match-ai"){No(i,e);return}if(s==="match-random"){mt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Oo(t,e){var p,u;const{state:i,navigate:o}=e,r=un(),n=Yi(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,s="2026.07.27-1957";t.innerHTML=`
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ui=1e3;function Xn(t,e,i,o){var g,p,u;const{state:r,toast:n,closeModal:a,navigate:s,refreshProfile:c}=i,d=t.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=ut[d]||{},w=Ei[d]||[],h=290,E=360,m=20;function S(A){const P=y[A];return P?{x:P.x*h,y:P.y*E}:null}let $=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[A,P]of w){const R=S(A),O=S(P);!R||!O||($+=`<line x1="${R.x}" y1="${R.y}" x2="${O.x}" y2="${O.y}"
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(V=document.getElementById("close-detail"))==null||V.addEventListener("click",s);let K=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(W=>{if(W.dataset.id===t.id)return;const se=Number(W.dataset.evo)||0,ge=Number(W.dataset.note)||0;z+=ge+se}),Math.round(z*le)}const j=()=>{const z=K.size,W=document.getElementById("sell-action-panel");if(!W)return;W.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const W=z.dataset.id;z.checked?K.add(W):K.delete(W);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",W=>{if(W.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(x<=1)return;const z=[...K];if(!z.length)return;if(K.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),c=[...new Set((s||[]).filter(x=>{var b,g;return((b=x.card)==null?void 0:b.card_type)==="stadium"&&((g=x.card)==null?void 0:g.stadium_id)}).map(x=>x.card.stadium_id))],d={};if(c.length){const{data:x}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(x||[]).forEach(b=>{d[b.id]=b}),(s||[]).forEach(b=>{var g,p;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((p=b.card)!=null&&p.stadium_id)&&(b.card._stadiumDef=d[b.card.stadium_id]||null)})}let l=0;function f(){var m,S,$,A,P,R,O;const x=n[l],b=(s||[]).filter(Y=>Y.deck_id===x.id),g=b.filter(Y=>{var I;return Y.is_starter&&((I=Y.card)==null?void 0:I.player)}).map(Y=>Ri(Y.card,Y.position)),p=b.find(Y=>{var I;return((I=Y.card)==null?void 0:I.card_type)==="formation"}),u=x.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let y=g.length>=11?hi(g,u):null,w=((S=x.stadium_card)==null?void 0:S.stadium_def)||null;w&&y&&(y=li(y,w));const h=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    ...
    ${Ti(t,e,i,o,r,n,a,s)}
  </div>`}async function Si(t,e,i,o){var S;const{state:r,navigate:n,toast:a}=e;ct(t);const s=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return hr(t,e,i);const c=s.deckId;let d,l,f,x;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);d=$[0].data,f=$[0].error,l=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),At(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),At(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(l||[]).filter($=>{var A;return $.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Ri($.card,$.position)),g=(l||[]).filter($=>{var A;return!$.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Ri($.card,$.position));if(b.length<11){At(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(l||[]).find($=>{var A;return((A=$.card)==null?void 0:A.card_type)==="formation"}),u=(d==null?void 0:d.formation)||((S=p==null?void 0:p.card)==null?void 0:S.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(A=>A.name===$.gc_type||A.id===$.gc_definition_id))||null}));let m=null;if(d!=null&&d.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",d.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:A}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=A||null}}o({deckId:c,formation:u,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function zt(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(zt()*1.1)}function tn(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Ct(t)}}function vr(t,e,i,o="Adversaire"){Bo("/sounds/match-opening.mp3",.3);const r=zt(),n=Ot();return`
  ...
  <div id="match-history-panel">
    ...
    </div>`,st=m[p+"Team"],gn=(()=>{var he,Ce,Ie,Ft,lt;if(D&&((he=m.pendingAttack)!=null&&he.players)){const Pe=m.pendingAttack;let Oe="";if(U.length>0){const je=U.map(Qe=>{const Yt=(st[Qe._role]||[]).find(Mi=>Mi.cardId===Qe.cardId)||Qe,Wt=st[Qe._role]||[],di=Wt.findIndex(Mi=>Mi.cardId===Qe.cardId),zi=dt(Wt.length),Xt=di>=0?zi[di]:Yt._col??1;return{...Yt,_line:Qe._role,_col:Xt}}),xt=si(je,((Ce=m.modifiers)==null?void 0:Ce[p])||{},m[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(Y)}catch{}Ve(t),l?b("mini-league",{openLeagueId:l}):b("home")})}H()}async function Ui(t,e,i=!1){var s,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:c.rankedData)||null;await Si(t,e,i?"ranked":"random",async({deckId:d,formation:l,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{await Hr(t,e,d,l,f,x,y||[],g,p,i,a)};if(!(b!=null&&b.length)){await u([]);return}Ii(t,b,u)})}async function Or(t,e,i){return Rr(t,e,i)}async function Hr(t,e,i,o,r,n,a=[],s=[],c=null,d=!1,l=null){var O,Y;const{state:f,navigate:x,toast:b}=e,g=(l==null?void 0:l.mmr)??((O=f.profile)==null?void 0:O.mmr)??1e3,p=d?ki(g):null,u=d?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=d?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`,document.body.appendChild(b),b.querySelector("#lv-ok").onclick=()=>{b.remove(),x(!0)},b.querySelector("#lv-cancel").onclick=()=>{b.remove(),x(!1)}}))return;const{data:c,error:d}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(d||!(c!=null&&c.success)){r((c==null?void 0:c.error)||"Erreur lors de la désinscription","error");return}const l=c.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+l);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Ki(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,r)}async function na(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,m,S,$,A,P,R,O,Y;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:s},{data:c}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await ot(t,e);return}const d=(s||[]).some(I=>I.user_id===n),l=a.creator_id===n,f=(s||[]).map(I=>I.user).filter(Boolean),x=da(f,c||[]),b=(c||[]).filter(I=>I.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,u=b.length>0&&b.every(I=>I.status==="finished"||I.status==="bye"),y=a.current_day>=a.total_days,w=(s||[]).find(I=>I.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(I,_)=>_+1).reverse().map(I=>{const _=(c||[]).filter(G=>G.matchday===I);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${I}</div>${_.map(G=>Io(G,f,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function fa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,f,x;const s=e[o],c=o===e.length-1,d=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function x(p){var R,O,Y,I;const u=(R=p.card)==null?void 0:R.player;if(!u)return"";const y=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=gi(u,u.job,y),h=u.job2?gi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,S=So[u.job]||"#bbb",$=u.job2?So[u.job2]||"#bbb":null,A=u.job==="GK"?"#fff":S,P=u.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.27-1957" style="cursor:pointer">
