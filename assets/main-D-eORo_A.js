import{s as T,F as xi,h as Nt,j as Yi,l as at,i as zn,k as Ln,b as Sn}from"./formation-links-DJC25wD7.js";const In="/manager-wars/";function Li(e,{navigate:t,toast:i}){let a="login";const d=()=>{var s,c,p,n,o,f;const l=a==="login";e.innerHTML=`
    <div style="
  ...
  `;function c(){var A;const n=document.getElementById("logo-preview"),o=document.getElementById("logo-initials"),f=((A=document.getElementById("setup-club"))==null?void 0:A.value)||"MW",v=f.trim().split(" ").filter(Boolean),w=v.length>=2?(v[0][0]+v[1][0]).toUpperCase():f.slice(0,2).toUpperCase();n&&(n.style.background=s,n.style.borderColor=l),o&&(o.textContent=w,o.style.color=l)}document.getElementById("color1").addEventListener("input",n=>{l=n.target.value,document.getElementById("swatch1").style.background=l,c()}),document.getElementById("color2").addEventListener("input",n=>{s=n.target.value,document.getElementById("swatch2").style.background=s,c()});function p(n){document.querySelectorAll(".setup-step").forEach(o=>o.classList.remove("active")),document.getElementById(`step-${n}`).classList.add("active"),document.getElementById("step-num").textContent=n,document.getElementById("progress-fill").style.width=`${Math.round(n/3*100)}%`,n===3&&c()}document.getElementById("step1-next").addEventListener("click",async()=>{const n=document.getElementById("setup-pseudo").value.trim(),o=document.getElementById("step1-error");if(o.textContent="",n.length<3){o.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await T.from("users").select("id").eq("pseudo",n).maybeSingle();if(f){o.textContent="Ce pseudo est déjà pris.";return}p(2)}),document.getElementById("step2-back").addEventListener("click",()=>p(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const n=document.getElementById("setup-club").value.trim(),o=document.getElementById("step2-error");if(o.textContent="",n.length<2){o.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await T.from("users").select("id").eq("club_name",n).maybeSingle();if(f){o.textContent="Ce nom de club est déjà pris.";return}p(3)}),document.getElementById("step3-back").addEventListener("click",()=>p(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const n=document.getElementById("setup-pseudo").value.trim(),o=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),v=document.getElementById("step3-finish");f.textContent="",v.disabled=!0,v.textContent="Création en cours…";try{const{error:w}=await T.from("users").insert({id:t.user.id,pseudo:n,club_name:o,club_color1:l,club_color2:s,credits:1e4});if(w)throw w;await Cn(t.user.id),await d(),a(`Bienvenue ${n} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(w){f.textContent=w.message,v.disabled=!1,v.textContent="🚀 Créer mon profil !"}})}async function Cn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await T.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const jn="modulepreload",qn=function(e){return"/manager-wars/"+e},Si={},yi=function(t,i,a){let d=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));d=Promise.allSettled(i.map(p=>{if(p=qn(p),p in Si)return;Si[p]=!0;const n=p.endsWith(".css"),o=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${o}`))return;const f=document.createElement("link");if(f.rel=n?"stylesheet":jn,n||(f.as="script"),f.crossOrigin="",f.href=p,c&&f.setAttribute("nonce",c),document.head.appendChild(f),n)return new Promise((v,w)=>{f.addEventListener("load",v),f.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${p}`)))})}))}function l(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return d.then(s=>{for(const c of s||[])c.status==="rejected"&&l(c.reason);return t().catch(l)})},Dt="#1A6B3C",Gt="#cc2222",Fn="#D4A017",Ii="#888";async function Bn(e,t){const{state:i,toast:a}=t;e.innerHTML=`
    ...
    </div>`,await Wi(i,a,t),document.getElementById("btn-add-friend").addEventListener("click",()=>Gn(i,a)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Ji(i,a,null,t))}async function Wi(e,t,i={}){const{navigate:a}=i,d=e.user.id,{data:l,error:s}=await T.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${d},addressee_id.eq.${d}`),{count:c}=await T.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",d).eq("status","pending"),p=document.getElementById("pending-badge");p&&(c>0?(p.style.display="flex",p.textContent=c):p.style.display="none");const n=document.getElementById("friends-list");if(!n)return;if(s){console.error("[Friends] Erreur:",s),n.innerHTML=`<div style="color:${Gt};text-align:center;padding:16px">Erreur chargement : ${s.message}</div>`;return}const o=(l||[]).map(w=>w.requester_id===d?w.addressee_id:w.requester_id);let f={};if(o.length){const{data:w}=await T.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",o);(w||[]).forEach(A=>{f[A.id]=A})}const v=(l||[]).map(w=>({friendshipId:w.id,friend:f[w.requester_id===d?w.addressee_id:w.requester_id]||{pseudo:"?"}}));if(!v.length){n.innerHTML=`
    ...
    ${hi()}`,document.body.appendChild(i);const a=i.querySelector("#friend-pseudo-input"),d=i.querySelector("#add-friend-error"),l=()=>i.remove();a.focus(),i.querySelector("#add-cancel").addEventListener("click",l),i.addEventListener("click",s=>{s.target===i&&l()}),i.querySelector("#add-ok").addEventListener("click",async()=>{const s=a.value.trim();if(!s){d.textContent="Entre un pseudo";return}d.textContent="";const{data:c}=await T.from("users").select("id, pseudo").ilike("pseudo",s).single();if(!c){d.textContent="Utilisateur introuvable";return}if(c.id===e.user.id){d.textContent="Tu ne peux pas t'ajouter toi-même";return}const{data:p}=await T.from("friendships").select("id, status").or(`and(requester_id.eq.${e.user.id},addressee_id.eq.${c.id}),and(requester_id.eq.${c.id},addressee_id.eq.${e.user.id})`).single();if(p){const o=p.status==="accepted"?"Vous êtes déjà amis !":p.status==="pending"?"Demande déjà envoyée":"Une demande existe déjà";d.textContent=o;return}const{error:n}=await T.from("friendships").insert({requester_id:e.user.id,addressee_id:c.id,status:"pending"});if(n){d.textContent="Erreur : "+n.message;return}l(),t(`✅ Demande envoyée à ${c.pseudo} !`,"success")})}async function Ji(e,t,i=null,a={}){const d=e.user.id,{data:l}=await T.from("friendships").select("id, requester_id").eq("addressee_id",d).eq("status","pending").order("created_at",{ascending:!1}),s=(l||[]).map(v=>v.requester_id);let c={};if(s.length){const{data:v}=await T.from("users").select("id, pseudo, club_name").in("id",s);(v||[]).forEach(w=>{c[w.id]=w})}const p=(l||[]).map(v=>({...v,requester:c[v.requester_id]||{pseudo:"?"}})),n=bi(),o=p||[];n.innerHTML=`
    <div class="popup-box">
    ...
    </style>`}async function Xi({player1Id:e,player2Id:t,score1:i,score2:a,gc1:d,gc2:l}){const[s,c]=[e,t].sort(),p=e!==s,n=p?a:i,o=p?i:a,f=p?l:d,v=p?d:l,w=n>o?1:0,A=o>n?1:0,r=n===o?1:0,{data:u}=await T.from("friend_match_stats").select("*").eq("player1_id",s).eq("player2_id",c).single();u?await T.from("friend_match_stats").update({wins_p1:u.wins_p1+w,wins_p2:u.wins_p2+A,draws:u.draws+r,goals_p1:u.goals_p1+n,goals_p2:u.goals_p2+o,gc_used_p1:u.gc_used_p1+f,gc_used_p2:u.gc_used_p2+v,matches_total:u.matches_total+1}).eq("player1_id",s).eq("player2_id",c):await T.from("friend_match_stats").insert({player1_id:s,player2_id:c,wins_p1:w,wins_p2:A,draws:r,goals_p1:n,goals_p2:o,gc_used_p1:f,gc_used_p2:v,matches_total:1})}const Nn="2026.07.02-0116";async function Mi(e,{state:t,navigate:i,toast:a}){var l,s;const d=t.profile;d&&(e.innerHTML=`
  <style>
  ...
  `,e.querySelectorAll("[data-nav]").forEach(c=>{c.addEventListener("click",p=>{p.preventDefault(),i(c.dataset.nav)})}),(l=document.getElementById("nav-rankings"))==null||l.addEventListener("click",()=>i("rankings")),(s=document.getElementById("nav-matches"))==null||s.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(c=>{c.addEventListener("click",()=>{c.classList.add("tapped"),setTimeout(()=>c.classList.remove("tapped"),200);const p=c.dataset.action;if(p==="match-ai"){Un(i);return}if(p==="match-random"){i("match",{matchMode:"random"});return}if(p==="match-friend"){i("friends");return}if(p==="mini-league"){i("mini-league");return}if(p==="ranked"){ctx.toast("Mode Ranked — Bientôt disponible !","info");return}a("Bientôt disponible","info")})}),window.innerWidth<768&&requestAnimationFrame(()=>{var H,B,j,U,oe,ce;const c=((H=window.visualViewport)==null?void 0:H.height)||window.innerHeight,p=((B=document.querySelector(".top-nav"))==null?void 0:B.offsetHeight)||56,n=((j=document.querySelector(".bottom-nav"))==null?void 0:j.offsetHeight)||60,o=((U=e.querySelector(".hero-compact"))==null?void 0:U.offsetHeight)||52,f=e.querySelector(".ranked-banner");e.querySelector(".play-grid");const v=((ce=(oe=e.querySelector("#logout-btn"))==null?void 0:oe.closest("div"))==null?void 0:ce.offsetHeight)||44,w=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((re,D)=>{var ie;return re+(((ie=document.getElementById(D))==null?void 0:ie.offsetHeight)||0)},0),A=14*5,r=c-p-n-o-v-w-A,u=Math.max(80,Math.round(r*.28)),I=Math.max(160,Math.round(r*.72)),z=Math.floor((I-10)/2);f&&(f.style.minHeight=f.style.maxHeight=u+"px"),e.querySelectorAll(".play-grid .play-card").forEach(re=>{re.style.minHeight=re.style.height=z+"px"});const C=Math.round(z*.55);e.querySelectorAll(".play-card .play-icon").forEach(re=>{re.style.height=C+"px"})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await T.auth.signOut(),window.location.reload()}),Qi(t,a),Hn(t,a,i),Zi(t,a,i))}async function Zi(e,t,i){const a=document.getElementById("ongoing-match-banner");if(!a)return;const d=e.profile.id,{data:l}=await T.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${d},away_id.eq.${d}`).order("created_at",{ascending:!1});if(!(l!=null&&l.length)){a.innerHTML="";return}const s=l.map(p=>p.home_id===d?p.away_id:p.home_id).filter(Boolean);let c={};if(s.length){const{data:p}=await T.from("users").select("id, pseudo, club_name").in("id",s);(p||[]).forEach(n=>{c[n.id]=n.club_name||n.pseudo})}a.innerHTML=l.map(p=>{const n=p.home_id===d?p.away_id:p.home_id,o=c[n]||"Adversaire",f=p.mode==="mini_league";return`
      ...
      </div>`}).join(""),a.querySelectorAll("[data-resume]").forEach(p=>{p.addEventListener("click",async()=>{const n=document.getElementById("page-content")||document.getElementById("app");if(p.dataset.mini==="1"){const{data:o}=await T.from("mini_league_matches").select("id, league_id").eq("match_id",p.dataset.resume).single();o?i("match-mini-league",{mlMatchId:o.id,leagueId:o.league_id}):i("mini-league")}else{const{resumePvpMatch:o}=await yi(async()=>{const{resumePvpMatch:f}=await Promise.resolve().then(()=>Ho);return{resumePvpMatch:f}},void 0);o(n,{state:e,navigate:i,toast:t,openModal:null,closeModal:null,refreshProfile:null},p.dataset.resume)}})}),a.querySelectorAll("[data-abandon]").forEach(p=>{p.addEventListener("click",()=>{On(async()=>{await Rn(p.dataset.abandon,p.dataset.opp,d),t("Match abandonné (défaite 3-0)","info"),Zi(e,t,i)})})})}async function Rn(e,t,i){const{data:a}=await T.from("matches").select("home_id, away_id, game_state").eq("id",e).single();if(!a)return;const d=a.home_id===i,l=d?0:3,s=d?3:0,c=a.game_state||{};c.p1Score=l,c.p2Score=s,c.phase="finished",c.forfeit=!0,await T.from("matches").update({status:"finished",forfeit:!0,winner_id:t,home_score:l,away_score:s,game_state:c}).eq("id",e)}function On(e){const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#ab-cancel").addEventListener("click",()=>t.remove()),t.querySelector("#ab-ok").addEventListener("click",()=>{t.remove(),e()}),t.addEventListener("click",i=>{i.target===t&&t.remove()})}async function Hn(e,t,i){var c,p,n,o;const a=document.getElementById("match-invite-banner");if(!a)return;const{data:d}=await T.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",e.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!d){a.innerHTML="";return}const l=((c=d.inviter)==null?void 0:c.club_name)||((p=d.inviter)==null?void 0:p.pseudo)||"?",s=d.inviter_id;a.innerHTML=`
    ...
    </div>`,(n=document.getElementById("match-inv-accept"))==null||n.addEventListener("click",()=>{a.innerHTML="",i("match",{matchMode:"friend",friendId:s,friendName:l})}),(o=document.getElementById("match-inv-decline"))==null||o.addEventListener("click",async()=>{await T.from("friend_match_invites").update({status:"declined"}).eq("id",d.id),a.innerHTML="",t("Invitation refusée","info")})}async function Qi(e,t){const i=document.getElementById("friend-requests-banner");if(!i)return;const{data:a,error:d}=await T.from("friendships").select("id, requester:users!requester_id(pseudo, club_name)").eq("addressee_id",e.user.id).eq("status","pending");if(d||!(a!=null&&a.length)){i.innerHTML="";return}const l=a.length,s=a.slice(0,2).map(p=>{var n;return((n=p.requester)==null?void 0:n.pseudo)||"?"}).join(", "),c=l>2?` +${l-2}`:"";i.innerHTML=`
  ...
  </div>`}async function Jn(e,t){const{state:i,navigate:a,toast:d,openModal:l,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:c}=await T.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",c);let G=new Set;const se=()=>{const N=G.size,R=document.getElementById("sell-action-panel");R&&(R.style.display=N>0?"block":"none",document.getElementById("sell-selected-count").textContent=N,document.getElementById("sell-direct-total").textContent=(N*u).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(N=>{N.addEventListener("change",()=>{const R=N.dataset.id;N.checked?G.add(R):G.delete(R);const Q=N.closest(".exemplaire-row");Q&&(Q.style.borderColor=N.checked?"#1A6B3C":"#eee"),se()})}),document.querySelectorAll(".exemplaire-row").forEach(N=>{N.addEventListener("click",R=>{if(R.target.closest("button")||R.target.tagName==="INPUT")return;const Q=N.querySelector(".expl-check");Q&&!Q.disabled&&(Q.checked=!Q.checked,Q.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(N=>{N.addEventListener("click",R=>{R.stopPropagation();const Q=document.querySelector(`.expl-hist[data-hist="${N.dataset.idx}"]`);Q&&(Q.style.display=Q.style.display==="none"?"flex":"none")})}),(he=document.getElementById("direct-sell-btn"))==null||he.addEventListener("click",async()=>{const N=[...G];if(!N.length)return;const R=N.length*u;if(!confirm(`Vendre ${N.length} carte${N.length>1?"s":""} ${o.surname_encoded} pour ${R.toLocaleString("fr")} crédits ? Action irréversible.`))return;await T.from("market_listings").delete().in("card_id",N),await T.from("transfer_history").delete().in("card_id",N);const{error:Q}=await T.from("cards").delete().in("id",N);if(Q){l(Q.message,"error");return}await T.from("users").update({credits:(d.profile.credits||0)+R}).eq("id",d.profile.id),await n();const ge=document.getElementById("nav-credits");ge&&(ge.textContent=`💰 ${(d.profile.credits||0).toLocaleString("fr")}`),l(`+${R.toLocaleString("fr")} crédits ! ${N.length} carte${N.length>1?"s":""} vendue${N.length>1?"s":""}.`,"success"),c(),p("collection")}),(Y=document.getElementById("market-sell-btn"))==null||Y.addEventListener("click",async()=>{var Me;const N=[...G];if(!N.length){l("Sélectionne au moins un exemplaire","warning");return}const R=parseInt((Me=document.getElementById("sell-market-price"))==null?void 0:Me.value);if(!R||R<1){l("Prix invalide","error");return}const{error:Q}=await T.from("cards").update({is_for_sale:!0,sale_price:R}).in("id",N);if(Q){l(Q.message,"error");return}const ge=N.map(Ce=>({seller_id:d.profile.id,card_id:Ce,price:R,status:"active"})),{error:pe}=await T.from("market_listings").insert(ge);pe&&console.warn("[Market] insert listings:",pe.message),l(`${N.length} carte${N.length>1?"s":""} mise${N.length>1?"s":""} en vente à ${R.toLocaleString("fr")} cr. chacune !`,"success"),c(),p("collection")}),(J=document.getElementById("cancel-sell-btn"))==null||J.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),c(),p("collection")})}const Xt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},vt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ti(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function dn(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ln(e){var i;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(i=e==null?void 0:e.clubs)!=null&&i.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Qn(e,t=44,i=58){var w;const a=e?ti(e):null,d=e?ln(e):null,l=dn(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",c=vt[s]||"#555",p={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",n=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,o=Math.round(i*.19),f=Math.round(i*.25),v=i-o-f;return e?`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${p};background:${c};position:relative;overflow:hidden;flex-shrink:0">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${f}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${d?`<img src="${d}" style="width:${f-4}px;height:${f-4}px;object-fit:contain">`:(w=e==null?void 0:e.clubs)!=null&&w.encoded_name?`<span style="font-size:${Math.max(4,f-8)}px;font-weight:700;color:#333">${(e.clubs.encoded_name||"").slice(0,3).toUpperCase()}</span>`:"<span></span>"}
    </div>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=prompt("Nom du deck :",`Deck ${((l==null?void 0:l.length)||0)+1}`);if(!s)return;const{data:c,error:p}=await T.from("decks").insert({owner_id:i.profile.id,name:s}).select().single();if(p){d(p.message,"error");return}d("Deck créé !","success"),Di(c.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(s=>{s.addEventListener("click",()=>Di(s.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(s=>{s.addEventListener("click",async()=>{const c=prompt("Nouveau nom :",s.dataset.name);if(!c||c===s.dataset.name)return;const{error:p}=await T.from("decks").update({name:c}).eq("id",s.dataset.rename);if(p){d(p.message,"error");return}d("Deck renommé !","success"),li(e,t)})}),e.querySelectorAll("[data-delete]").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${s.dataset.name}" ? Cette action est irréversible.`))return;await T.from("deck_cards").delete().eq("deck_id",s.dataset.delete);const{error:c}=await T.from("decks").delete().eq("id",s.dataset.delete);if(c){d(c.message,"error");return}d("Deck supprimé.","success"),li(e,t)})})}async function Di(e,t,i){const{state:a,toast:d}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await T.from("decks").select("*").eq("id",e).single(),{data:s}=await T.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",a.profile.id),c=(s||[]).filter(w=>w.card_type==="player"&&w.player),p=(s||[]).filter(w=>w.card_type==="formation"),n=p.map(w=>w.formation).filter(Boolean),{data:o}=await T.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let f=l.formation||"4-4-2";n.length>0&&!n.includes(f)&&(f=n[0]);const v={deckId:e,name:l.name,formation:f,formationCardId:l.formation_card_id,slots:{},subs:[],playerCards:c,formationCards:p,availableFormations:n};(o||[]).forEach(w=>{w.is_starter?v.slots[w.position]=w.card_id:v.subs.includes(w.card_id)||v.subs.push(w.card_id)}),zt(t,v,i)}function zt(e,t,i){var p;const{navigate:a}=i;Xt[t.formation];const d=Gi(t.formation),l=d.filter(n=>t.slots[n]).length,s=t.availableFormations.length>0?t.availableFormations:Object.keys(Xt),c=t.subs.map(n=>t.playerCards.find(o=>o.id===n)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(w=document.getElementById("close-selector"))==null||w.addEventListener("click",l),(A=document.getElementById("remove-player"))==null||A.addEventListener("click",()=>{delete t.slots[e],l(),zt(i,t,a)}),document.querySelectorAll(".player-option").forEach(r=>{r.addEventListener("click",()=>{t.slots[e]=r.dataset.cardId,l(),zt(i,t,a)})})}function io(e,t,i){var p;const{openModal:a,closeModal:d}=i,l=new Set;Object.values(e.slots).filter(Boolean).forEach(n=>{var f;const o=e.playerCards.find(v=>v.id===n);(f=o==null?void 0:o.player)!=null&&f.id&&l.add(o.player.id)}),e.subs.forEach(n=>{var f;const o=e.playerCards.find(v=>v.id===n);(f=o==null?void 0:o.player)!=null&&f.id&&l.add(o.player.id)});const s=new Set,c=e.playerCards.filter(n=>{var o,f,v;return l.has((o=n.player)==null?void 0:o.id)||s.has((f=n.player)==null?void 0:f.id)?!1:(s.add((v=n.player)==null?void 0:v.id),!0)});a("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(p=document.getElementById("close-sub-selector"))==null||p.addEventListener("click",d),document.querySelectorAll(".player-option").forEach(n=>{n.addEventListener("click",()=>{e.subs.push(n.dataset.cardId),d(),zt(t,e,i)})})}async function no(e,t){const{state:i,toast:a,navigate:d}=t,l=e.formationCards.find(p=>p.formation===e.formation),s=(l==null?void 0:l.id)||e.formationCardId;await T.from("decks").update({formation:e.formation,formation_card_id:s||null}).eq("id",e.deckId),await T.from("deck_cards").delete().eq("deck_id",e.deckId);const c=[];if(Object.entries(e.slots).forEach(([p,n],o)=>{c.push({deck_id:e.deckId,card_id:n,position:p,is_starter:!0,slot_order:o})}),e.subs.forEach((p,n)=>{c.push({deck_id:e.deckId,card_id:p,position:`SUB${n+1}`,is_starter:!1,slot_order:100+n})}),c.length>0){const{error:p}=await T.from("deck_cards").insert(c);if(p){a(p.message,"error");return}}a("Deck enregistré ✅","success"),d("decks")}function Gi(e){const t=Xt[e]||Xt["4-4-2"],i=["GK1"];for(let a=1;a<=t.DEF;a++)i.push(`DEF${a}`);for(let a=1;a<=t.MIL;a++)i.push(`MIL${a}`);for(let a=1;a<=t.ATT;a++)i.push(`ATT${a}`);return i}async function cn(){const{data:e}=await T.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(e!=null&&e.length))return[];const{data:t}=await T.from("booster_drop_rates").select("*").in("booster_id",e.map(i=>i.id)).order("sort_order");return e.map(i=>({...i,rates:(t||[]).filter(a=>a.booster_id===i.id)}))}function oo(e){if(!(e!=null&&e.length))return null;const t=e.reduce((a,d)=>a+Number(d.percentage),0);let i=Math.random()*t;for(const a of e)if(i-=Number(a.percentage),i<=0)return a;return e[e.length-1]}const pn=()=>Object.keys(Nt),ro=[{id:"players_std",img:"/manager-wars/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/manager-wars/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/manager-wars/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/manager-wars/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],ci={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function ao(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}const Pi={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},so={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},lo={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Ni(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function co(e){var o,f;const t=e.player;if(!t)return"";const i=t.job||"ATT",a=Pi[i],d=so[t.rarity]||"#ccc",l=Ni(t,i),s=t.job2?Ni(t,t.job2):null,c=t.job2?Pi[t.job2]:null,p=ao(t),n=lo[t.country_code]||t.country_code||"";return`
  ...
  </div>`}function un(e){var d;const t={};(e.rates||[]).forEach(l=>{t[l.card_type]=(t[l.card_type]||0)+Number(l.percentage||0)});const i=((d=Object.entries(t).sort((l,s)=>s[1]-l[1])[0])==null?void 0:d[0])||"player",a=e.image_url||"booster-players.png";return{id:e.id,img:"/manager-wars/icons/"+a,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],_raw:e}}async function po(e,{state:t,navigate:i,toast:a}){var s;const d=((s=t.profile)==null?void 0:s.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let l=[];try{l=(await cn()).map(un)}catch(c){console.warn("Erreur chargement boosters DB, fallback hardcodé",c)}l.length||(l=ro.map(c=>({...c,rates:[],isPub:c.id==="players_pub"}))),e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${l.map(c=>{const p=c.cost===0||d>=c.cost;return`<div class="booster-card ${p?"":"disabled"}" data-booster="${c.id}" style="position:relative">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const o=async()=>{await T.from("users").update({pending_boosters:s}).eq("id",t.user.id)};async function f(){var z;if(n>=p||!s.length){await T.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",t.user.id),d&&await d(),a("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const A=s[0],{data:r}=await T.from("users").select("*").eq("id",t.user.id).single();r&&(t.profile=r);let u=[];try{if(A.type==="formation")u=await mn(t.profile,0);else if(A.type==="game_changer")u=await gn(t.profile,A.count||3,0);else if(c&&((z=c.rates)!=null&&z.length)){const C={...c,cost:0,cardCount:A.count||c.cardCount||5};u=await pi(t.profile,C),A.guaranteeGK&&!t.profile.first_booster_opened&&(u.some(B=>B.player&&B.player.job==="GK")||await $o(t.profile,u),await T.from("users").update({first_booster_opened:!0}).eq("id",t.profile.id))}else u=await fn(t.profile,A.count||5,0)}catch(C){a(C.message||"Erreur ouverture booster","error");return}s.shift(),n++,await o();const I=A.type==="formation"?{name:"Booster Formation",img:"/manager-wars/icons/booster-formation.png"}:A.type==="game_changer"?{name:"Booster Game Changer",img:"/manager-wars/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${n}/${p})`,img:(c==null?void 0:c.img)||"/manager-wars/icons/booster-players.png"};xn(u,I,i,()=>{f()})}(w=document.getElementById("onboard-start"))==null||w.addEventListener("click",()=>f())}async function $o(e,t){try{const{data:i}=await T.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const a=i[Math.floor(Math.random()*i.length)],d=t.findIndex(s=>s.player);if(d===-1)return;const l=t[d];await T.from("cards").update({player_id:a.id}).eq("id",l.id),t[d]={...l,player_id:a.id,player:a}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Lt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},St={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function wt(e,t,i,a,d){var l;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${a}</button>
    </div>
  </div>`,(l=document.getElementById("msg-btn"))==null||l.addEventListener("click",d)}function qe(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ui(e,t){var a,d;const i=e.player;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_encoded,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:Number(i.note_g)||0,note_d:Number(i.note_d)||0,note_m:Number(i.note_m)||0,note_a:Number(i.note_a)||0,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,clubName:((a=i.clubs)==null?void 0:a.encoded_name)||null,clubLogo:((d=i.clubs)==null?void 0:d.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function lt(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function ii(){const e=Math.random()*100;return e<10?3:e<30?2:1}function yt(e,t){const i=Lt[t]||Lt["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(s=>s.position)){for(const s of["GK","DEF","MIL","ATT"]){const c=e.filter(n=>n.position&&n.position.replace(/\d+$/,"")===s).sort((n,o)=>parseInt(n.position.replace(/\D+/g,""),10)-parseInt(o.position.replace(/\D+/g,""),10)).map(n=>({...n,_line:s})),p=lt(c.length);c.forEach((n,o)=>{n._col=p[o]}),a[s]=c}return a}const l=[...e];for(const s of["GK","DEF","MIL","ATT"]){const c=[];for(let n=0;n<i[s];n++){let o=l.findIndex(f=>f.job===s);if(o===-1&&(o=l.findIndex(f=>f.job2===s)),o===-1&&(o=0),l[o]){const f={...l[o],_line:s};c.push(f),l.splice(o,1)}}const p=lt(c.length);c.forEach((n,o)=>{n._col=p[o]}),a[s]=c}return a}function et(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function Ye(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function ni(e,t,i){const d=new Set,l=t.filter(o=>{const f=o.gc_type||o.id;return d.has(f)?!1:(d.add(f),!0)});let s=[];function c(o,f){const v=o._gcDef,w={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},A={purple:"#9b59b6",light_blue:"#00bcd4"},r=w[v==null?void 0:v.color]||w.purple,u=A[v==null?void 0:v.color]||A.purple;return`<div class="gc-select-card" data-id="${o.id}"
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${l.map(A=>{const r=s.find(u=>u.gc_type===A.gc_type);return c(A,!!r)}).join("")}
      </div>
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${f}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${d?`<img src="${d}" style="width:${f-4}px;height:${f-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,f-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
    </div>
  </div>`}function nt(e,t,i){if(!(e!=null&&e.length))return"";const a=e.slice(0,5);let d='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return a.forEach((l,s)=>{if(d+=Ke(l,40,52),s<a.length-1){const c=at(l,a[s+1]);d+=`<div style="width:7px;height:3px;background:${c==="#ff3333"||c==="#cc2222"?"rgba(255,255,255,0.12)":c};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(d+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),d+="</div>",d}function Zt(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function hn(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function ut(e,t,i,a,d=310,l=310,s=[]){var C;const c=Nt[t]||{},p=Yi(t)||xi[t]||[],n={},o=["ATT","MIL","DEF","GK"];for(const H of o)(e[H]||[]).forEach((j,U)=>{n[`${H}${U+1}`]=j});function f(H){const B=c[H];return B?{x:B.x*d,y:B.y*l}:null}let v="";for(const[H,B]of p){const j=f(H),U=f(B);if(!j||!U)continue;const oe=n[H],ce=n[B],re=at(oe,ce);re==="#00ff88"||re==="#FFD700"?(v+=`<line x1="${j.x.toFixed(1)}" y1="${j.y.toFixed(1)}" x2="${U.x.toFixed(1)}" y2="${U.y.toFixed(1)}"
  ...
  </div>`}async function oi(e,t,i,a){var B;const{state:d,navigate:l,toast:s}=t;et(e);const c=d.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!c.deckId)return Eo(e,t,i);const p=c.deckId;let n,o,f,v;try{const j=await Promise.all([T.from("decks").select("formation,name").eq("id",p).single(),T.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",p).order("slot_order")]);n=j[0].data,f=j[0].error,o=j[1].data,v=j[1].error}catch(j){console.error("[Match] Exception chargement deck:",j),wt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>l("home"));return}if(f||v){console.error("[Match] Erreur Supabase:",f||v),wt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>l("home"));return}const w=(o||[]).filter(j=>{var U;return j.is_starter&&((U=j.card)==null?void 0:U.player)}).map(j=>ui(j.card,j.position)),A=(o||[]).filter(j=>{var U;return!j.is_starter&&((U=j.card)==null?void 0:U.player)}).map(j=>ui(j.card,j.position));if(w.length<11){wt(e,"⚠️",`Deck incomplet (${w.length}/11).`,"Compléter",()=>l("decks"));return}const r=(o||[]).find(j=>{var U;return((U=j.card)==null?void 0:U.card_type)==="formation"}),u=(n==null?void 0:n.formation)||((B=r==null?void 0:r.card)==null?void 0:B.formation)||"4-4-2",{data:I,error:z}=await T.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",d.profile.id).eq("card_type","game_changer"),{data:C}=await T.from("gc_definitions").select("*").eq("is_active",!0),H=(I||[]).map(j=>({...j,_gcDef:(C==null?void 0:C.find(U=>U.name===j.gc_type||U.id===j.gc_definition_id))||null}));a({deckId:p,formation:u,starters:w,subsRaw:A,gcCardsEnriched:H,gcDefs:C||[]})}async function To(e,t){const{state:i}=t,d=(i.params||{}).matchMode||"vs_ai_easy",l=d.replace("vs_ai_",""),s=d;await oi(e,t,d,async({deckId:c,formation:p,starters:n,subsRaw:o,gcCardsEnriched:f,gcDefs:v})=>{try{const w=yt(n,p),A=await Ao(p,l),r=async u=>{try{const{data:I,error:z}=await T.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:c,status:"in_progress"}).select().single();if(z){console.error("[MatchIA] Erreur création match:",z),wt(e,"⚠️","Impossible de créer le match ("+z.message+").","Retour",()=>t.navigate("home"));return}const C={gcDefs:v||[],matchId:I==null?void 0:I.id,mode:s,difficulty:l,formation:p,homeTeam:w,aiTeam:A,homeSubs:o,subsUsed:0,maxSubs:Math.min(o.length,3),homeScore:0,aiScore:0,gcCards:u,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Lo(e,C,t)}catch(I){console.error("[MatchIA] Exception launchMatch:",I),wt(e,"⚠️","Erreur au lancement du match : "+I.message,"Retour",()=>t.navigate("home"))}};if(!f.length){r([]);return}ni(e,f,r)}catch(w){console.error("[MatchIA] Exception setup:",w),wt(e,"⚠️","Erreur de préparation du match : "+w.message,"Retour",()=>t.navigate("home"))}})}async function Ao(e,t){var s,c;const{data:i}=await T.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return zo(e);const a=Lt[e]||Lt["4-4-2"],d={GK:[],DEF:[],MIL:[],ATT:[]},l=[...i];for(const p of["GK","DEF","MIL","ATT"]){const n=l.filter(A=>A.job===p),o=l.filter(A=>A.job!==p),f=[...n,...o],v=[];for(let A=0;A<a[p];A++){const r=f[A]||l[A];r&&v.push({cardId:"ai-"+r.id+"-"+A,id:r.id,firstname:r.firstname,name:r.surname_encoded,country_code:r.country_code,club_id:r.club_id,job:r.job,job2:r.job2,note_g:Number(r.note_g)||0,note_d:Number(r.note_d)||0,note_m:Number(r.note_m)||0,note_a:Number(r.note_a)||0,rarity:r.rarity,skin:r.skin,hair:r.hair,hair_length:r.hair_length,clubName:((s=r.clubs)==null?void 0:s.encoded_name)||null,clubLogo:((c=r.clubs)==null?void 0:c.logo_url)||null,boost:0,used:!1,_line:p})}const w=lt(v.length);v.forEach((A,r)=>{A._col=w[r]}),d[p]=v}return d}function zo(e){const t=Lt[e]||Lt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},a=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let d=0;for(const l of["GK","DEF","MIL","ATT"]){const s=[];for(let p=0;p<t[l];p++){const n=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+d,id:"fake-"+d,firstname:"IA",name:a[d%a.length],country_code:"XX",club_id:null,job:l,job2:null,note_g:l==="GK"?n:2,note_d:l==="DEF"?n:2,note_m:l==="MIL"?n:2,note_a:l==="ATT"?n:2,rarity:"normal",boost:0,used:!1,_line:l}),d++}const c=lt(s.length);s.forEach((p,n)=>{p._col=c[n]}),i[l]=s}return i}function Lo(e,t,i){e.innerHTML=`
  ...
  `,document.body.appendChild(a);let o=!1;const f=()=>{o||(o=!0,a.remove(),i())};a.addEventListener("click",f),setTimeout(f,2e3)}function It(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function si(e,t,i,a=null,d=null){var w,A;if(t.phase!=="attack"){It("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){It(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const l=Object.entries(t.homeTeam).flatMap(([r,u])=>(u||[]).filter(I=>I.used).map(I=>({...I,_line:I._line||r}))),s=t.homeSubs.filter(r=>!t.usedSubIds.includes(r.cardId));if(!l.length){It("Aucun joueur utilisé à remplacer");return}if(!s.length){It("Aucun remplaçant disponible");return}let c=Math.max(0,l.findIndex(r=>r.cardId===d));const p=((w=l[c])==null?void 0:w._line)||((A=l[c])==null?void 0:A.job);let n=a?Math.max(0,s.findIndex(r=>r.cardId===a)):Math.max(0,s.findIndex(r=>r.job===p)),o=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function v(){var B,j,U,oe,ce,re;const r=l[c],u=s[n],I=Math.min(130,Math.round((window.innerWidth-90)/2)),z=Math.round(I*1.35),C=D=>`background:rgba(255,255,255,0.12);border:none;color:${D?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${D?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,document.body.appendChild(w),(A=w.querySelector("#gc-back"))==null||A.addEventListener("click",()=>w.remove()),(r=w.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{w.remove(),Go(e,t,i,a,d)})}function Yt(e,t,i,a,d,l){const s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let c=[];function p(){var n,o;s.innerHTML=`
    ...
    </div>`,(n=s.querySelector("#gc-picker-close"))==null||n.addEventListener("click",()=>s.remove()),s.querySelectorAll(".gc-pick-item").forEach(f=>{f.addEventListener("click",()=>{const v=f.dataset.cid,w=e.find(r=>r.cardId===v);if(!w)return;const A=c.findIndex(r=>r.cardId===v);A>-1?c.splice(A,1):c.length<t&&c.push(w),p()})}),(o=s.querySelector("#gc-picker-confirm"))==null||o.addEventListener("click",()=>{s.remove(),l(c)})}p(),document.body.appendChild(s)}const Do={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},a,d,l)=>{const s=Object.entries(a.homeTeam).filter(([c])=>!i.length||i.includes(c)).flatMap(([c,p])=>p.filter(n=>!n.used).map(n=>({...n,_line:c})));return s.length?(Yt(s,t,`Choisir ${t} joueur(s) à booster (+${e})`,d,a,c=>{c.forEach(p=>{const n=(a.homeTeam[p._line]||[]).find(o=>o.cardId===p.cardId);n&&(n.boost=(n.boost||0)+e,a.log.push({text:`⚡ +${e} sur ${n.name}`,type:"info"}))}),Je(d,a,l)}),!0):(a.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Je(d,a,l),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:a="ai"},d,l,s)=>{const c=a==="home"?d.homeTeam:d.aiTeam,p=a==="ai"?"adverse":"allié",n=Object.entries(c).filter(([o])=>!i.length||i.includes(o)).flatMap(([o,f])=>f.filter(v=>!v.used).map(v=>({...v,_line:o})));return n.length?(Yt(n,t,`Choisir ${t} joueur(s) ${p}(s) à débuffer (-${e})`,l,d,o=>{o.forEach(f=>{const w=((a==="home"?d.homeTeam:d.aiTeam)[f._line]||[]).find(A=>A.cardId===f.cardId);w&&(w.boost=(w.boost||0)-e,d.log.push({text:`🎯 -${e} sur ${w.name}${a==="ai"?" (IA)":""}`,type:"info"}))}),Je(l,d,s)}),!0):(d.log.push({text:`🎯 Aucun joueur ${p} disponible`,type:"info"}),Je(l,d,s),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},a,d,l)=>{const s=i==="home"?a.homeTeam:a.aiTeam,c=i==="ai"?"adverse":"allié",p=Object.entries(s).filter(([n])=>!t.length||t.includes(n)).flatMap(([n,o])=>o.filter(f=>!f.used).map(f=>({...f,_line:n})));return p.length?(Yt(p,e,`Choisir ${e} joueur(s) ${c}(s) à exclure`,d,a,n=>{n.forEach(o=>{const v=((i==="home"?a.homeTeam:a.aiTeam)[o._line]||[]).find(w=>w.cardId===o.cardId);v&&(v.used=!0,a.log.push({text:`❌ ${v.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Je(d,a,l)}),!0):(a.log.push({text:`❌ Aucun joueur ${c} à exclure`,type:"info"}),Je(d,a,l),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,a,d)=>{const l=Object.entries(i.homeTeam).filter(([s])=>!t.length||t.includes(s)).flatMap(([s,c])=>c.filter(p=>p.used).map(p=>({...p,_line:s})));return l.length?(Yt(l,e,`Choisir ${e} joueur(s) à ressusciter`,a,i,s=>{s.forEach(c=>{const p=(i.homeTeam[c._line]||[]).find(n=>n.cardId===c.cardId);p&&(p.used=!1,i.log.push({text:`💫 ${p.name} ressuscité !`,type:"info"}))}),Je(a,i,d)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Je(a,i,d),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Go(e,t,i,a,d){a.usedGc.push(e);const l=a.gcDefs||[],s=l.find(p=>p.name===t)||l.find(p=>{var n;return((n=p.name)==null?void 0:n.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let c=!1;if(s!=null&&s.effect_type&&s.effect_type!=="CUSTOM"){const p=Do[s.effect_type];p?p(s.effect_params||{},a,i,d)||(c=!0):(d.toast(`Effet "${s.effect_type}" non implémenté`,"error"),c=!0)}else{switch(t){case"Double attaque":a.modifiers.home.doubleAttack=!0,a.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":a.modifiers.home.shield=!0,a.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const p=Object.entries(a.homeTeam).flatMap(([n,o])=>(o||[]).filter(f=>f.used).map(f=>({...f,_line:n})));p.length?(p[0].used=!1,a.log.push({text:`💫 ${p[0].name} ressuscité !`,type:"info"})):a.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":a.modifiers.ai.stolenNote=(a.modifiers.ai.stolenNote||0)+1,a.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const p=[...a.aiTeam.ATT||[],...a.aiTeam.MIL||[]].filter(n=>!n.used);if(p.length){const n=p.sort((o,f)=>$e(f,"ATT")-$e(o,"ATT"))[0];n.used=!0,a.log.push({text:`❄️ ${n.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":a.maxSubs++,a.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}c=!0}T.from("cards").delete().eq("id",e).then(()=>{}),c&&Je(i,a,d)}function Po(e,t,i){const a=Object.values(t.homeTeam).flat().filter(d=>!d.used);if(!a.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${a.map(d=>`
        <div class="player-boost-opt" data-card-id="${d.cardId}"
          ...
          <div style="width:32px;height:32px;background:${St[d.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${$e(d,d._line||d.job)}</div>
          <div style="flex:1"><b>${d.firstname} ${d.name}</b><div style="font-size:11px;color:#888">${d._line||d.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(d=>{d.addEventListener("click",()=>{const l=d.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const c=(t.homeTeam[s]||[]).find(p=>p.cardId===l);if(c){c.boost=(c.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${c.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Je(e,t,i)})})}function Qt(e,t,i,a,d){const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const s=Array.from({length:10},(n,o)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(l);let c=!1;const p=()=>{c||(c=!0,l.remove(),setTimeout(()=>d(),50))};l.addEventListener("click",p),setTimeout(p,3500)}async function Ft(e,t,i){var o,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=i,d=t.homeScore>t.aiScore,l=t.homeScore===t.aiScore,s=d?"victoire":l?"nul":"defaite",c=Vn(t.mode,s);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?a.profile.id:null,home_credits_reward:c,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(a.profile.credits||0)+c,matches_played:(a.profile.matches_played||0)+1};d?p.wins=(a.profile.wins||0)+1:l?p.draws=(a.profile.draws||0)+1:p.losses=(a.profile.losses||0)+1,await T.from("users").update(p).eq("id",a.profile.id),await i.refreshProfile();const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",n.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      <div style="font-size:72px;margin-bottom:12px">${d?"🏆":l?"🤝":"😔"}</div>
      <h2 style="font-size:28px;font-weight:900;margin-bottom:8px">${d?"Victoire !":l?"Match nul":"Défaite"}</h2>
    ...
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}async function wn(e,t){var i,a;try{const d=(a=(i=t==null?void 0:t.state)==null?void 0:i.profile)==null?void 0:a.id;try{(T.getChannels?T.getChannels():[]).forEach(s=>{const c=s.topic||"";(c.includes("matchmaking")||c.includes("pvp-match")||c.includes("friend-invite"))&&T.removeChannel(s)})}catch(l){console.warn("[Random] cleanup canaux:",l)}d&&await T.rpc("cancel_matchmaking",{p_user_id:d}).catch(()=>{})}catch{}await oi(e,t,"random",({deckId:d,formation:l,starters:s,subsRaw:c,gcCardsEnriched:p,gcDefs:n})=>{const o=f=>Ro(e,t,d,l,s,c,f,n||[]);if(!p.length){o([]);return}ni(e,p,o)})}async function Ro(e,t,i,a,d,l,s=[],c=[]){var z;const{state:p,navigate:n,toast:o}=t;let f=!1,v=null;et(e),e.innerHTML=`
    ...
    </div>`,(g=document.getElementById("pvp-home"))==null||g.addEventListener("click",()=>{try{T.removeChannel(j)}catch{}Ye(e),c("home")})}G()}const Ho=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:wn,resumePvpMatch:Oo},Symbol.toStringTag,{value:"Module"}));async function Uo(e,t,i,a){var d,l;try{const s=(l=(d=t==null?void 0:t.state)==null?void 0:d.profile)==null?void 0:l.id;try{(T.getChannels?T.getChannels():[]).forEach(p=>{const n=p.topic||"";(n.includes("matchmaking")||n.includes("pvp-match"))&&T.removeChannel(p)})}catch(c){console.warn("[FriendMatch] cleanup canaux:",c)}s&&(await T.rpc("cancel_matchmaking",{p_user_id:s}).catch(()=>{}),await T.from("matchmaking_queue").delete().eq("user_id",s).then(()=>{},()=>{}))}catch{}await oi(e,t,"random",({deckId:s,formation:c,starters:p,subsRaw:n,gcCardsEnriched:o,gcDefs:f})=>{const v=w=>Vo(e,t,s,c,p,n,w,f||[],i,a);if(!o.length){v([]);return}ni(e,o,v)})}async function Vo(e,t,i,a,d,l,s=[],c=[],p,n){var ce;const{state:o,navigate:f,toast:v}=t,w=o.profile.id;let A=!1,r=null;et(e);try{await T.rpc("cancel_matchmaking",{p_user_id:w})}catch{}try{await T.from("matchmaking_queue").delete().eq("user_id",w)}catch{}const u=(re,D,ie,W)=>{var G;e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Wo(v,r,d):i==="active"?Jo(w,d):Xo(A,d)}
    </div>
  </div>`,(I=document.getElementById("ml-create-btn"))==null||I.addEventListener("click",()=>Zo(e,t)),e.querySelectorAll(".ml-tab").forEach(z=>z.addEventListener("click",()=>_t(e,t,z.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(z=>z.addEventListener("click",()=>bt(e,t,z.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(z=>z.addEventListener("click",C=>{C.stopPropagation(),$n(e,t,z.dataset.join,z.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(z=>z.addEventListener("click",C=>{C.stopPropagation(),gi(e,t,z.dataset.delete,z.dataset.name,i)}))}function ei(e,t,i=!1){var s,c;const a=e.creator_id===t,d=e.pot||0,l=((c=(s=e.mini_league_members)==null?void 0:s[0])==null?void 0:c.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;font-size:11px;color:#666;margin-bottom:${i?"10px":"0"}">
      ...
      ${d>0?`<span style="color:${xt};font-weight:700">🏆 ${d.toLocaleString("fr")} cr.</span>`:""}
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),a=d=>{t.remove(),e(d)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>a(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>a(i.value.trim())),i.addEventListener("keydown",d=>{d.key==="Enter"&&a(i.value.trim())}),t.addEventListener("click",d=>{d.target===t&&a(null)})})}async function $n(e,t,i,a){const{toast:d,state:l}=t,s=l.profile.id,{data:c}=await T.from("mini_leagues").select("password,status,entry_fee,pot,max_players").eq("id",i).single();if(!c){d("Mini League introuvable","error");return}if(c.status!=="waiting"){d("Cette Mini League a déjà démarré","warning");return}const{count:p}=await T.from("mini_league_members").select("id",{count:"exact",head:!0}).eq("league_id",i);if(p>=c.max_players){d("La Mini League est complète","warning");return}if(a==="private"){const r=await Qo();if(r===null)return;if(c.password!==r){d("Mot de passe incorrect","error");return}}const n=c.entry_fee||100,{data:o}=await T.from("users").select("credits").eq("id",s).single();if(((o==null?void 0:o.credits)||0)<n){d(`Crédits insuffisants — il te faut ${n.toLocaleString("fr")} cr. (solde : ${((o==null?void 0:o.credits)||0).toLocaleString("fr")} cr.)`,"error");return}const{error:f}=await T.from("mini_league_members").insert({league_id:i,user_id:s});if(f){d("Erreur inscription : "+f.message,"error");return}const{error:v}=await T.from("users").update({credits:o.credits-n}).eq("id",s),{error:w}=await T.from("mini_leagues").update({pot:(c.pot||0)+n}).eq("id",i);(v||w)&&console.error("Erreur post-inscription:",v,w),l.profile&&(l.profile.credits=o.credits-n);const A=document.getElementById("nav-credits");A&&(A.textContent=`💰 ${(l.profile.credits||0).toLocaleString("fr")}`),d(`✅ Inscrit ! −${n.toLocaleString("fr")} cr. · Pot : ${((c.pot||0)+n).toLocaleString("fr")} cr.`,"success"),bt(e,t,i)}async function er(e,t,i,a){const{toast:d,state:l}=t,s=l.profile.id;if(!confirm(`Te désinscrire et récupérer ${a.toLocaleString("fr")} cr. ?`))return;const{data:c}=await T.from("mini_leagues").select("pot,status").eq("id",i).single();if(!c||c.status!=="waiting"){d("Impossible — la league a déjà démarré","error");return}const{data:p}=await T.from("users").select("credits").eq("id",s).single();await T.from("mini_leagues").update({pot:Math.max(0,(c.pot||0)-a)}).eq("id",i),await T.from("users").update({credits:((p==null?void 0:p.credits)||0)+a}).eq("id",s),await T.from("mini_league_members").delete().eq("league_id",i).eq("user_id",s),l.profile&&(l.profile.credits=((p==null?void 0:p.credits)||0)+a);const n=document.getElementById("nav-credits");n&&(n.textContent=`💰 ${(l.profile.credits||0).toLocaleString("fr")}`),d(`↩️ Désinscrit · +${a.toLocaleString("fr")} cr. remboursés`,"success"),_t(e,t,"waiting")}async function gi(e,t,i,a,d){const{toast:l}=t;if(!confirm(`Supprimer définitivement "${a}" et tous ses matchs/membres ? Action irréversible.`))return;await T.from("mini_league_matches").delete().eq("league_id",i),await T.from("mini_league_members").delete().eq("league_id",i);const{error:s}=await T.from("mini_leagues").delete().eq("id",i);if(s){l("Erreur suppression ("+s.message+")","error");return}l("Mini League supprimée avec succès","success"),_t(e,t,d)}async function tr(e,t,i){await T.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),_t(e,t,"archived")}async function bt(e,t,i){var H,B,j,U,oe,ce,re,D,ie;const{state:a,toast:d}=t,l=a.profile.id,[{data:s},{data:c},{data:p}]=await Promise.all([T.from("mini_leagues").select("*").eq("id",i).single(),T.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),T.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!s){d("Introuvable","error"),await _t(e,t);return}const n=(c||[]).some(W=>W.user_id===l),o=s.creator_id===l,f=(c||[]).map(W=>W.user).filter(Boolean),v=En(f,p||[]),w=(p||[]).filter(W=>W.matchday===s.current_day),A=s.pot||0,r=s.entry_fee||100,u=w.length>0&&w.every(W=>W.status==="finished"||W.status==="bye"),I=s.current_day>=s.total_days,z=(c||[]).find(W=>W.user_id===l);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`}async function ir(e,t,i,a){const{toast:d,state:l}=t,s=rr(a.map(n=>n.id),i.mode),c=[];s.forEach((n,o)=>n.forEach(f=>c.push({league_id:i.id,matchday:o+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:p}=await T.from("mini_league_matches").insert(c);if(p){d("Erreur calendrier : "+p.message,"error");return}await T.from("mini_leagues").update({status:"active",current_day:1,total_days:s.length}).eq("id",i.id),d(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),bt(e,t,i.id)}async function nr(e,t,i){const{data:a}=await T.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),d=(a.current_day||0)+1;if(d>(a.total_days||0)){await kn(e,t,i,a.pot||0,null,null);return}await T.from("mini_leagues").update({current_day:d}).eq("id",i),t.toast(`Journée ${d} commencée !`,"success"),bt(e,t,i)}async function kn(e,t,i,a,d,l){const{toast:s,state:c}=t;let p=d,n=l;if(!p){const{data:f}=await T.from("mini_league_matches").select("*").eq("league_id",i),{data:v}=await T.from("mini_league_members").select("*, user:users(id,pseudo,club_name)").eq("league_id",i);n=(v||[]).map(w=>w.user).filter(Boolean),p=En(n,f||[])}const o=[Math.floor(a*.7),Math.floor(a*.2),Math.floor(a*.1)];await Promise.all(p.slice(0,3).map((f,v)=>o[v]?T.from("mini_league_members").update({prize_amount:o[v],prize_claimed:!1}).eq("league_id",i).eq("user_id",f.userId):Promise.resolve())),await T.from("mini_leagues").update({status:"finished"}).eq("id",i),s("🏆 Mini League terminée ! Les gagnants peuvent récupérer leurs crédits.","success"),bt(e,t,i)}async function or(e,t,i,a,d){var v,w;const{state:l,toast:s}=t,c=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],p=["🥇","🥈","🥉"][d],n=a.prize_amount||c[d]||0,o=a.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function dr(e,t,i){let a=0;const d=document.createElement("div");d.id="tutorial-overlay",d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const l=()=>{var o,f,v;const c=Mt[a],p=a===Mt.length-1,n=Math.round((a+1)/Mt.length*100);d.innerHTML=`
    ...
    `,d.querySelectorAll("ul,ol").forEach(w=>{w.style.paddingLeft="20px",w.style.marginTop="6px",w.style.marginBottom="6px"}),d.querySelectorAll("li").forEach(w=>{w.style.marginBottom="4px"}),d.querySelectorAll("p").forEach(w=>{w.style.marginBottom="8px"}),(o=d.querySelector("#tuto-prev"))==null||o.addEventListener("click",()=>{a--,l()}),(f=d.querySelector("#tuto-next"))==null||f.addEventListener("click",()=>{p?s():(a++,l())}),(v=d.querySelector("#tuto-skip"))==null||v.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&s()})},s=async()=>{d.remove(),e!=null&&e.id&&await T.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(d),l()}async function lr(e,t){if(!e||e.tutorial_done)return;const{data:i}=await T.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order"),a=i&&i.length>0?i.map(d=>({emoji:d.emoji,title:d.title,color:d.color,content:d.content})):Mt;dr(e,a,()=>t("boosters"))}const cr={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Et(e,t){return t&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Hi(e){return`<div style="width:6px;height:100%;background:${{normal:"#e0e0e0",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[e]||"#e0e0e0"};border-radius:4px 0 0 4px;flex-shrink:0;align-self:stretch;min-height:52px"></div>`}function Wt(e,t){const a=t?cr[t]||"#bbb":"#d0d0d0",d=e>0?e:t||"—";return`<div style="width:32px;height:32px;border-radius:6px;background:${a};display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:13px;font-weight:900;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,0.4)">${d}</div>`}function Ui(e){const i=Zt(e);return i?`<div style="width:32px;height:32px;border-radius:6px;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#f0f0f0"><img src="${i}" style="width:100%;height:100%;object-fit:cover"></div>`:'<div style="width:32px;height:32px;border-radius:6px;background:#eee;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:16px">🌍</div>'}function Vi(e){return e?`<div style="width:32px;height:32px;border-radius:6px;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#f0f0f0"><img src="${e}" style="width:28px;height:28px;object-fit:contain" onerror="this.parentElement.innerHTML='🏟️'"></div>`:'<div style="width:32px;height:32px;border-radius:6px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:16px">🏟️</div>'}async function pr(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await Ti(e,t)}async function Ti(e,t){const{state:i,toast:a}=t,{data:d}=await T.from("market_listings").select(`id, price, status, listed_at, seller_id,
      ...
      card:cards(id, card_type, current_note,
        player:players(id, firstname, surname_encoded, country_code, job, job2,
          ...
          clubs(encoded_name, logo_url)))`).eq("seller_id",i.profile.id).in("status",["active","sold"]).order("listed_at",{ascending:!1}).limit(100),s=(d||[]).filter(r=>r.seller_id!==i.profile.id),c=l||[];e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <!-- Header -->
    ...
    </div>`,document.body.appendChild(d);const l=c=>{d.remove(),c&&t()};d.querySelector("#buy-cancel").addEventListener("click",()=>l(!1)),d.querySelector("#buy-ok").addEventListener("click",()=>l(!0)),d.addEventListener("click",c=>{c.target===d&&l(!1)})}async function gr(e,t,i){const{toast:a}=i,{data:d}=await T.from("market_listings").select("card_id").eq("id",e).single();if(await T.from("market_listings").update({status:"cancelled"}).eq("id",e),d!=null&&d.card_id){const{count:l}=await T.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",d.card_id).eq("status","active");l||await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",d.card_id)}a("Annonce retirée","success"),Ti(t,i)}async function mr(e,{state:t,navigate:i,toast:a}){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await T.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);e.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `}async function xr(e,{state:t,navigate:i,toast:a}){const d=t.profile;if(!d)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await T.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${d.id},away_id.eq.${d.id}`).order("created_at",{ascending:!1}).limit(50),s={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},c=(l||[]).filter(o=>o.status==="finished"),p=(l||[]).filter(o=>o.status==="in_progress");function n(o){const f=o.home_id===d.id;f?o.home_score:o.away_score,f?o.away_score:o.home_score;const v=o.winner_id===d.id,w=o.home_score===o.away_score&&o.status==="finished",A=o.status!=="finished"?"…":w?"N":v?"V":"D",r=o.status!=="finished"||w?"#888":v?"#1A6B3C":"#c0392b";let u=s[o.mode]||o.mode;o.away_id===null&&!u.startsWith("IA")&&(u="IA");const z=o.home_id===d.id?o.away:o.home;let C;o.away_id===null?C=u:z?C=`${z.club_name||z.pseudo} (${z.pseudo})`:C="Adversaire";let H="";o.status==="in_progress"&&Date.now()-new Date(o.created_at).getTime()>3600*1e3&&(H=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const B=new Date(o.created_at),j=B.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+B.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),U=o.status==="finished"?`${o.home_score} - ${o.away_score}`:`${o.home_score||0} - ${o.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
  ...
  </div>`}zn(Sn);const je={user:null,profile:null,page:"home",params:{}};function Ct(e,t="info",i=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},i))}function yr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function mi(){document.getElementById("modal-overlay").classList.add("hidden")}async function jt(){if(!je.user)return;const{data:e}=await T.from("users").select("*").eq("id",je.user.id).single();e&&(je.profile=e)}function Bt(e,t={}){je.page=e,je.params=t,Tn()}async function Tn(){var a,d,l,s;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(c=>{c.classList.toggle("active",c.dataset.page===je.page)});const t=document.getElementById("nav-credits");t&&je.profile&&(t.textContent=`💰 ${(je.profile.credits||0).toLocaleString("fr")}`);const i={state:je,navigate:Bt,toast:Ct,openModal:yr,closeModal:mi,refreshProfile:jt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',je.page){case"home":await Mi(e,i);break;case"collection":await Jn(e,i);break;case"decks":await li(e,i);break;case"boosters":await po(e,i);break;case"match":{const c=je.params&&je.params.matchMode||"vs_ai_easy";c==="random"?await wn(e,i):c==="friend"?await Uo(e,i,(a=je.params)==null?void 0:a.friendId,(d=je.params)==null?void 0:d.friendName):c==="mini-league"?await Oi(e,i,(l=je.params)==null?void 0:l.mlMatchId,(s=je.params)==null?void 0:s.leagueId):await To(e,i);break}case"market":await pr(e,i);break;case"rankings":await mr(e,i);break;case"matches":await xr(e,i);break;case"friends":await Bn(e,i);break;case"mini-league":await Yo(e,i);break;case"match-mini-league":{const c=je.params||{};await Oi(e,i,c.mlMatchId,c.leagueId);break}default:await Mi(e,i)}}function br(){var a;const e=document.getElementById("app"),t=je.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(d=>{d.addEventListener("click",l=>{l.preventDefault(),Bt(d.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Bt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Bt("boosters")),(a=document.getElementById("journal-btn"))==null||a.addEventListener("click",()=>hr())}async function hr(){const{data:e}=await T.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(a=>{const d=new Date(a.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
