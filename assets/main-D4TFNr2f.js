import{s as $,F as oi,h as St,j as Mi,l as Qe,i as ln,k as cn,b as pn}from"./formation-links-CEzN0rcz.js";function mi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  `;function l(){var z;const i=document.getElementById("logo-preview"),r=document.getElementById("logo-initials"),f=((z=document.getElementById("setup-club"))==null?void 0:z.value)||"MW",m=f.trim().split(" ").filter(Boolean),y=m.length>=2?(m[0][0]+m[1][0]).toUpperCase():f.slice(0,2).toUpperCase();i&&(i.style.background=s,i.style.borderColor=d),r&&(r.textContent=y,r.style.color=d)}document.getElementById("color1").addEventListener("input",i=>{d=i.target.value,document.getElementById("swatch1").style.background=d,l()}),document.getElementById("color2").addEventListener("input",i=>{s=i.target.value,document.getElementById("swatch2").style.background=s,l()});function p(i){document.querySelectorAll(".setup-step").forEach(r=>r.classList.remove("active")),document.getElementById(`step-${i}`).classList.add("active"),document.getElementById("step-num").textContent=i,document.getElementById("progress-fill").style.width=`${Math.round(i/3*100)}%`,i===3&&l()}document.getElementById("step1-next").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("step1-error");if(r.textContent="",i.length<3){r.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await $.from("users").select("id").eq("pseudo",i).maybeSingle();if(f){r.textContent="Ce pseudo est déjà pris.";return}p(2)}),document.getElementById("step2-back").addEventListener("click",()=>p(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const i=document.getElementById("setup-club").value.trim(),r=document.getElementById("step2-error");if(r.textContent="",i.length<2){r.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await $.from("users").select("id").eq("club_name",i).maybeSingle();if(f){r.textContent="Ce nom de club est déjà pris.";return}p(3)}),document.getElementById("step3-back").addEventListener("click",()=>p(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),m=document.getElementById("step3-finish");f.textContent="",m.disabled=!0,m.textContent="Création en cours…";try{const{error:y}=await $.from("users").insert({id:t.user.id,pseudo:i,club_name:r,club_color1:d,club_color2:s,credits:1e4});if(y)throw y;await fn(t.user.id),await c(),a(`Bienvenue ${i} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(y){f.textContent=y.message,m.disabled=!1,m.textContent="🚀 Créer mon profil !"}})}async function fn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await $.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(n){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",n)}}const gn="modulepreload",mn=function(e){return"/manager-wars/"+e},xi={},xn=function(t,n,a){let c=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));c=Promise.allSettled(n.map(p=>{if(p=mn(p),p in xi)return;xi[p]=!0;const i=p.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${r}`))return;const f=document.createElement("link");if(f.rel=i?"stylesheet":gn,i||(f.as="script"),f.crossOrigin="",f.href=p,l&&f.setAttribute("nonce",l),document.head.appendChild(f),i)return new Promise((m,y)=>{f.addEventListener("load",m),f.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${p}`)))})}))}function d(s){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s}return c.then(s=>{for(const l of s||[])l.status==="rejected"&&d(l.reason);return t().catch(d)})},It="#1A6B3C",Lt="#cc2222",yn="#D4A017",yi="#888";async function hn(e,t){const{state:n,toast:a}=t;e.innerHTML=`
    ...
    <div class="popup-box" style="max-width:380px">
      ...
      ${T===0?`
        ...
        ${L("GC utilisés ⚡",o,b,"#7a28b8","#7a28b8")}
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),i=(l||[]).filter(O=>O.card_type==="player"&&O.player),r=(l||[]).filter(O=>O.card_type==="game_changer"),f=(l||[]).filter(O=>O.card_type==="formation"),{data:m}=await $.from("gc_definitions").select("name,gc_type,color,effect,image_url"),y={};(m||[]).forEach(O=>{y[O.name]=O});const z=Object.keys(oi),o=Object.keys(Ne),b={};i.forEach(O=>{const U=O.player.id;b[U]=(b[U]||0)+1}),new Set(Object.keys(b).map(O=>String(O)));const T=new Set(f.map(O=>O.formation)),L=new Set(r.map(O=>O.gc_type));let S="player",P="Tous",B="",j=!1;function R(){return[...i].sort((O,U)=>{const C=Bt.indexOf(O.player.job),D=Bt.indexOf(U.player.job);return C!==D?C-D:(O.player.surname_encoded||"").localeCompare(U.player.surname_encoded||"")})}function ee(){return[...p||[]].sort((O,U)=>{const C=Bt.indexOf(O.job),D=Bt.indexOf(U.job);return C!==D?C-D:(O.surname_encoded||"").localeCompare(U.surname_encoded||"")})}function le(){return R().filter(O=>{const U=O.player,C=P==="Tous"||U.job===P,D=!B||`${U.firstname} ${U.surname_encoded}`.toLowerCase().includes(B);return C&&D})}function re(){return ee().filter(O=>{const U=P==="Tous"||O.job===P,C=!B||`${O.firstname} ${O.surname_encoded}`.toLowerCase().includes(B);return U&&C})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",U=>{B=U.target.value.toLowerCase(),Y()}),e.querySelectorAll(".filter-btn").forEach(U=>{U.addEventListener("click",()=>{P=U.dataset.job,M(),Y()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,M(),Y()})):(O.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,M(),Y()})))}function Y(){const O=document.getElementById("col-grid");O&&(S==="player"?he(O):S==="formation"?xe(O):ge(O))}function ie(O,U,C,D,K){const ne=document.getElementById("col-grid"),te=document.getElementById("col-big");if(!ne||!te)return;var we=0;function _e(){const ke=window.innerWidth>=768,Se=document.getElementById("col-big"),Ee=document.getElementById("col-grid");ke&&Se&&(Se.style.minHeight="420px",Se.style.flex="1 1 auto"),ke&&Ee&&(Ee.style.height=Math.round(310*.76+16)+"px",Ee.style.flexShrink="0",Ee.style.overflowX="auto",Ee.style.overflowY="hidden",Ee.style.alignItems="center",Ee.style.padding="8px 16px"),te.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+U(O[we])+"</div>";var Te=te.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Te&&Te.addEventListener("click",function(){D(O[we])}),requestAnimationFrame(function(){var $e=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!$e||!te)){var qe=te.clientHeight-8,Re=te.clientWidth-24,k=$e.offsetHeight,u=$e.offsetWidth;if(k>0&&u>0&&qe>40){var g=ke?2.2:1,h=Math.min(qe/k,Re/u,g);$e.style.transform="scale("+h.toFixed(3)+")",$e.style.transformOrigin="top center"}}}),ne.innerHTML=O.map(function($e,qe){var Re=qe===we,k="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Re?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+qe+'" style="'+k+'">'+C($e,Re)+"</div>"}).join(""),ne.querySelectorAll(".col-mini-item").forEach(function($e){$e.addEventListener("click",function(){we=Number($e.dataset.idx),_e(),$e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function q(O){var U=window.innerWidth>=768?.76:.54,C;if(!O||O._fake){var D=O?O.player:null;if(!D)return"";C=_i(D)}else C=Wt(O,"");return'<div style="display:inline-block;zoom:'+U+';pointer-events:none;line-height:0">'+C+"</div>"}function Z(O,U,C){U=U||100,C=C||140;var D=St[O]||{},K={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ne=Math.max(3,Math.round(U*.06)),te=Object.entries(D).map(function(_e){var ke=_e[0],Se=_e[1],Ee=ke.replace(/\d+$/,""),Te=K[Ee]||"#888",$e=Math.round(Se.x*U),qe=Math.round(Se.y*C);return'<circle cx="'+$e+'" cy="'+qe+'" r="'+ne+'" fill="'+Te+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),we=Math.max(1,Math.round(U/50));return'<svg viewBox="0 0 '+U+" "+C+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+U+'" height="'+C+'" fill="#1A6B3C"/><rect x="'+Math.round(U*.2)+'" y="'+Math.round(C*.02)+'" width="'+Math.round(U*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/><line x1="0" y1="'+Math.round(C*.5)+'" x2="'+U+'" y2="'+Math.round(C*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><ellipse cx="'+Math.round(U*.5)+'" cy="'+Math.round(C*.5)+'" rx="'+Math.round(U*.18)+'" ry="'+Math.round(C*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><rect x="'+Math.round(U*.2)+'" y="'+Math.round(C*.82)+'" width="'+Math.round(U*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/>'+te+"</svg>"}function ae(O,U,C){var D=C>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+C+"</div>":"",K=U?'data-form-id="'+U.id+'"':"",ne=O.length>7?14:O.length>5?16:19,te=!!U;return"<div "+K+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(te?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(te?"":"filter:grayscale(1);opacity:0.5")+'">'+D+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(te?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ne+"px;font-weight:900;color:"+(te?"#1A6B3C":"#aaa")+';line-height:1">'+O+'</div></div><div style="flex:1;overflow:hidden;background:'+(te?"#1A6B3C":"#ccc")+'">'+Z(O,140,220)+"</div></div>"}function pe(O,U){var C=window.innerWidth>=768?.76:.54,D=140,K=305,ne=Math.round(K*.22),te=K-ne,we=O.length>7?10:13,_e=Z(O,D,te),ke=U?"1.5px solid #2a7a40":"1px solid #ddd",Se=U?"":"filter:grayscale(1);opacity:0.45;",Ee=U?"#1A6B3C":"#bbb",Te="#fff";return'<div style="display:inline-block;zoom:'+C+';line-height:0;pointer-events:none"><div style="width:'+D+"px;height:"+K+"px;border-radius:6px;border:"+ke+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Se+'"><div style="height:'+ne+"px;background:"+Ee+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+we+"px;font-weight:900;color:"+Te+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(D-4)+'px">'+O+'</span></div><div style="height:'+te+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function he(O){if(j){const U=re();if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const C=U.map(D=>i.find(K=>K.player.id===D.id)||{_fake:!0,player:D,id:"fake-"+D.id});ie(C,D=>D._fake?_i(D.player):Wt(D,""),D=>D._fake?q({player:D.player,id:"x",_fake:!0}):q(D),D=>{D._fake||$i(D,i,b,t)})}else{const U=le();if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const C={};U.forEach(K=>{const ne=K.player.id;C[ne]||(C[ne]=[]),C[ne].push(K)});const D=Object.values(C).map(K=>Mn(K));ie(D,K=>{const ne=b[K.player.id]||1,te=ne>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ne}</div>`:"",_e=i.filter(ke=>ke.player.id===K.player.id&&ke.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Wt(K,te+_e)},K=>q(K),K=>$i(K,i,b,t))}}function xe(O){const U=j?z:[...T];if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const C=U.map(D=>({formation:D,card:f.find(K=>K.formation===D)||null,owned:T.has(D)}));ie(C,({formation:D,card:K,owned:ne})=>ae(D,ne?K:null,ne?f.filter(te=>te.formation===D).length:0),({formation:D,owned:K})=>pe(D,K),({card:D,owned:K})=>{K&&D&&Bn(D,f,t,d)})}function ge(O){const U=Object.keys(y),C=j?U.length?U:o:[...L];if(!C.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const D=C.map(K=>({type:K,gc:Ne[K]||{icon:"⚡",desc:""},def:y[K]||null,owned:L.has(K),card:r.find(ne=>ne.gc_type===K)||null}));ie(D,({type:K,gc:ne,def:te,owned:we,card:_e})=>{const ke=we?r.filter(g=>g.gc_type===K).length:0,Se=ke>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ke}</div>`:"",Ee=(te==null?void 0:te.gc_type)==="ultra_game_changer",Te={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},$e={purple:"#b06ce0",light_blue:"#00d4ef"},qe=Te[te==null?void 0:te.color]||Te.purple,Re=$e[te==null?void 0:te.color]||$e.purple,k=(te==null?void 0:te.effect)||ne.desc||"",u=te!=null&&te.image_url?`/manager-wars/icons/${te.image_url}`:null;return we&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${K}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Re};background:${qe};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Re}66;cursor:pointer">
          ${Se}
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${f.map((C,D)=>{const K=M[C.id]||[],ne=C.is_for_sale,te=K.length?K[K.length-1]:null,_e=(r.rarity==="pepite"||r.rarity==="papyte")&&C.current_note!=null?` (☆${C.current_note})`:"";return`
            <div data-card-id="${C.id}" data-card-idx="${D}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${D+1}${_e}${ne?" 🏷️ En vente":""}</div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let q=new Set;const Z=()=>{const C=q.size,D=document.getElementById("sell-action-panel");D&&(D.style.display=C>0?"block":"none",document.getElementById("sell-selected-count").textContent=C,document.getElementById("sell-direct-total").textContent=(C*b).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(C=>{C.addEventListener("change",()=>{const D=C.dataset.id;C.checked?q.add(D):q.delete(D);const K=C.closest(".exemplaire-row");K&&(K.style.borderColor=C.checked?"#1A6B3C":"#eee"),Z()})}),document.querySelectorAll(".exemplaire-row").forEach(C=>{C.addEventListener("click",D=>{if(D.target.closest("button")||D.target.tagName==="INPUT")return;const K=C.querySelector(".expl-check");K&&!K.disabled&&(K.checked=!K.checked,K.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(C=>{C.addEventListener("click",D=>{D.stopPropagation();const K=document.querySelector(`.expl-hist[data-hist="${C.dataset.idx}"]`);K&&(K.style.display=K.style.display==="none"?"flex":"none")})}),(ge=document.getElementById("direct-sell-btn"))==null||ge.addEventListener("click",async()=>{const C=[...q];if(!C.length)return;const D=C.length*b;if(!confirm(`Vendre ${C.length} carte${C.length>1?"s":""} ${r.surname_encoded} pour ${D.toLocaleString("fr")} crédits ? Action irréversible.`))return;await $.from("market_listings").delete().in("card_id",C),await $.from("transfer_history").delete().in("card_id",C);const{error:K}=await $.from("cards").delete().in("id",C);if(K){d(K.message,"error");return}await $.from("users").update({credits:(c.profile.credits||0)+D}).eq("id",c.profile.id),await i();const ne=document.getElementById("nav-credits");ne&&(ne.textContent=`💰 ${(c.profile.credits||0).toLocaleString("fr")}`),d(`+${D.toLocaleString("fr")} crédits ! ${C.length} carte${C.length>1?"s":""} vendue${C.length>1?"s":""}.`,"success"),l(),p("collection")}),(O=document.getElementById("market-sell-btn"))==null||O.addEventListener("click",async()=>{var we;const C=[...q];if(!C.length){d("Sélectionne au moins un exemplaire","warning");return}const D=parseInt((we=document.getElementById("sell-market-price"))==null?void 0:we.value);if(!D||D<1){d("Prix invalide","error");return}const{error:K}=await $.from("cards").update({is_for_sale:!0,sale_price:D}).in("id",C);if(K){d(K.message,"error");return}const ne=C.map(_e=>({seller_id:c.profile.id,card_id:_e,price:D,status:"active"})),{error:te}=await $.from("market_listings").insert(ne);te&&console.warn("[Market] insert listings:",te.message),d(`${C.length} carte${C.length>1?"s":""} mise${C.length>1?"s":""} en vente à ${D.toLocaleString("fr")} cr. chacune !`,"success"),l(),p("collection")}),(U=document.getElementById("cancel-sell-btn"))==null||U.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),l(),p("collection")})}const Pt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},rt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Vt(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const n=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${n}.png`}function Ui(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Ki(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(n=e==null?void 0:e.clubs)!=null&&n.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Fn(e,t=44,n=58){var y;const a=e?Vt(e):null,c=e?Ki(e):null,d=Ui(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",l=rt[s]||"#555",p={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(n*.19),f=Math.round(n*.25),m=n-r-f;return e?`<div style="width:${t}px;height:${n}px;border-radius:5px;border:2px solid ${p};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,Dn(e,t,c,n),document.getElementById("builder-back").addEventListener("click",()=>a("decks")),document.getElementById("formation-select").addEventListener("change",i=>{t.formation=i.target.value;const r=Ei(t.formation),f={};r.forEach(m=>{t.slots[m]&&(f[m]=t.slots[m])}),t.slots=f,ut(e,t,n)}),document.getElementById("save-deck").addEventListener("click",()=>Nn(t,n)),e.querySelectorAll("[data-remove-sub]").forEach(i=>{i.addEventListener("click",()=>{t.subs=t.subs.filter(r=>r!==i.dataset.removeSub),ut(e,t,n)})}),(p=document.getElementById("add-sub-btn"))==null||p.addEventListener("click",()=>{Gn(t,e,n)})}function Dn(e,t,n,a){const c=e.querySelector("#deck-field");if(!c)return;const d=St[t.formation]||{},s=Mi(t.formation)||[],l={};for(const T of n){const L=t.slots[T],S=L?t.playerCards.find(P=>P.id===L):null;l[T]=S?S.player:null}const p=300,i=300,r=48,f=64,m=13,y=16,z=38;function o(T){const L=d[T];return L?{x:L.x*p,y:L.y*i}:null}let b="";for(const[T,L]of s){const S=o(T),P=o(L);if(!S||!P)continue;const B=l[T]?{...l[T],club_id:l[T].club_id,country_code:l[T].country_code,rarity:l[T].rarity}:null,j=l[L]?{...l[L],club_id:l[L].club_id,country_code:l[L].country_code,rarity:l[L].rarity}:null,R=Qe(B,j);R==="#ff3333"||R==="#cc2222"?b+=`<line x1="${S.x.toFixed(1)}" y1="${S.y.toFixed(1)}" x2="${P.x.toFixed(1)}" y2="${P.y.toFixed(1)}" stroke="${R}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(b+=`<line x1="${S.x.toFixed(1)}" y1="${S.y.toFixed(1)}" x2="${P.x.toFixed(1)}" y2="${P.y.toFixed(1)}" stroke="${R}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,b+=`<line x1="${S.x.toFixed(1)}" y1="${S.y.toFixed(1)}" x2="${P.x.toFixed(1)}" y2="${P.y.toFixed(1)}" stroke="${R}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const T of n){const L=o(T);if(!L)continue;const S=l[T],P=T.replace(/\d+/,""),B=rt[P]||"#555",j=(L.x-r/2).toFixed(1),R=(L.y-f/2).toFixed(1),ee={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[S==null?void 0:S.rarity]||"#aaa";if(S){const le=Vt(S),re=Ki(S),M=Ui(S.country_code),Y=Number(P==="GK"?S.note_g:P==="DEF"?S.note_d:P==="MIL"?S.note_m:S.note_a)||0,ie=f-m-y;b+=`<defs><clipPath id="dcp-${T}"><rect x="${j}" y="${(L.y-f/2+m).toFixed(1)}" width="${r}" height="${ie}"/></clipPath></defs>`,b+=`<rect x="${j}" y="${R}" width="${r}" height="${f}" rx="5" fill="${B}"/>`,le&&(b+=`<image href="${le}" x="${j}" y="${(L.y-f/2+m).toFixed(1)}" width="${r}" height="${ie}" clip-path="url(#dcp-${T})" preserveAspectRatio="xMidYMin slice"/>`),b+=`<rect x="${j}" y="${R}" width="${r}" height="${m}" fill="rgba(255,255,255,0.93)"/>`,b+=`<text x="${L.x.toFixed(1)}" y="${(L.y-f/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(S.surname_encoded||"").slice(0,9)}</text>`;const q=(L.y+f/2-y).toFixed(1);b+=`<rect x="${j}" y="${q}" width="${r}" height="${y}" fill="rgba(255,255,255,0.93)"/>`,M&&(b+=`<image href="${M}" x="${(L.x-21).toFixed(1)}" y="${(L.y+f/2-y+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),b+=`<text x="${L.x.toFixed(1)}" y="${(L.y+f/2-y/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Y}</text>`,re&&(b+=`<image href="${re}" x="${(L.x+r/2-14).toFixed(1)}" y="${(L.y+f/2-y+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),b+=`<rect x="${j}" y="${R}" width="${r}" height="${f}" rx="5" fill="none" stroke="${ee}" stroke-width="2"/>`}else b+=`<rect x="${j}" y="${R}" width="${r}" height="${f}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,b+=`<text x="${L.x.toFixed(1)}" y="${L.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,b+=`<text x="${L.x.toFixed(1)}" y="${(L.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${P}</text>`;b+=`<rect x="${j}" y="${R}" width="${r}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${T}" style="cursor:pointer"/>`}c.innerHTML=`<svg viewBox="${-z} ${-z} ${p+z*2} ${i+z*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${b}</svg>`,c.querySelectorAll(".deck-slot-hit").forEach(T=>{T.addEventListener("click",()=>qn(T.dataset.pos,t,e,a))})}function qn(e,t,n,a){var m,y,z;const{openModal:c,closeModal:d}=a,s=e.replace(/\d+/,""),l=t.slots[e],p=l?t.playerCards.find(o=>o.id===l):null;(m=p==null?void 0:p.player)==null||m.id;const i=new Set;Object.entries(t.slots).forEach(([o,b])=>{var L;if(o===e||!b)return;const T=t.playerCards.find(S=>S.id===b);(L=T==null?void 0:T.player)!=null&&L.id&&i.add(T.player.id)}),t.subs.forEach(o=>{var T;const b=t.playerCards.find(L=>L.id===o);(T=b==null?void 0:b.player)!=null&&T.id&&i.add(b.player.id)});const r=new Set,f=t.playerCards.filter(o=>{const b=o.player;return!(b.job===s||b.job2===s)||i.has(b.id)||r.has(b.id)?!1:(r.add(b.id),!0)});f.sort((o,b)=>{const T=s==="GK"?o.player.note_g:s==="DEF"?o.player.note_d:s==="MIL"?o.player.note_m:o.player.note_a;return(s==="GK"?b.player.note_g:s==="DEF"?b.player.note_d:s==="MIL"?b.player.note_m:b.player.note_a)-T}),c(`Choisir ${s} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${f.length>0?f.map(o=>{var P,B;const b=o.player,T=s==="GK"?b.note_g:s==="DEF"?b.note_d:s==="MIL"?b.note_m:b.note_a,L=Vt(b),S={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[b.rarity];return`<div class="player-option" data-card-id="${o.id}"
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(P=b.clubs)!=null&&P.logo_url?`<img src="${b.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((B=b.clubs)==null?void 0:B.encoded_name)||"—"}</span>`}
      ...
      ${l.length>0?l.map(i=>{var y;const r=i.player,f=Vt(r),m=r.job==="GK"?r.note_g:r.job==="DEF"?r.note_d:r.job==="MIL"?r.note_m:r.note_a;return`<div class="player-option" data-card-id="${i.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(z=>{z.addEventListener("click",()=>{const o=z.dataset.id,b=d.find(L=>L.id===o);if(!b)return;const T=s.findIndex(L=>L.gc_type===b.gc_type);T>-1?s.splice(T,1):s.length<3&&s.push(b),i()})}),(f=e.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{r&&p(s)}),(m=e.querySelector("#gc-no-gc"))==null||m.addEventListener("click",()=>p([])),(y=e.querySelector("#gc-reset"))==null||y.addEventListener("click",()=>{s.length&&(s=[],i())})}i()}function ao(e){var a;const t=((a=e==null?void 0:e.state)==null?void 0:a.params)||{},n=t.matchMode||"vs_ai_easy";return n==="friend"?`Match vs ${t.friendName||"Ami"}`:n==="random"?"Match vs Random":`Match vs IA — ${n.replace("vs_ai_","").toUpperCase()}`}async function so(e,t,n){const{state:a,navigate:c}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await $.from("decks").select("id,name,is_active,formation").eq("owner_id",a.profile.id).order("created_at",{ascending:!1});if(!d||d.length===0){at(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>c("decks"));return}const s=d.map(r=>r.id),{data:l}=await $.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let p=0;function i(){var L,S,P,B,j;const r=d[p],f=(l||[]).filter(R=>R.deck_id===r.id),m=f.filter(R=>{var ee;return R.is_starter&&((ee=R.card)==null?void 0:ee.player)}).map(R=>ti(R.card,R.position)),y=f.find(R=>{var ee;return((ee=R.card)==null?void 0:ee.card_type)==="formation"}),z=r.formation||((L=y==null?void 0:y.card)==null?void 0:L.formation)||"4-4-2",o=m.length>=11?mt(m,z):null,b=m.length>=11;Xe(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${f}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${c?`<img src="${c}" style="width:${f-4}px;height:${f-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,f-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${re}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const y=48,z=64,o=13,b=16,T={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[P,B]of Object.entries(i)){const j=f(P);if(!j||!B)continue;const R=P.replace(/[0-9]/g,""),ee=gt[R]||"#555",le=s.includes(B.cardId),re=n==="attack"&&(["MIL","ATT"].includes(R)||le)&&!B.used||n==="defense"&&["GK","DEF","MIL"].includes(R)&&!B.used,M=a.includes(B.cardId);let Y;n==="attack"?Y=le?Math.max(1,Number(B.note_a)||0):R==="MIL"?Number(B.note_m)||0:Number(B.note_a)||0:n==="defense"?Y=R==="GK"?Number(B.note_g)||0:R==="MIL"?Number(B.note_m)||0:Number(B.note_d)||0:Y=Number(R==="GK"?B.note_g:R==="DEF"?B.note_d:R==="MIL"?B.note_m:B.note_a)||0,Y=Y+(B.boost||0);const ie=(j.x-y/2).toFixed(1),q=(j.y-z/2).toFixed(1),Z=T[B==null?void 0:B.rarity]||T.normal;if(B.used){const U=typeof import.meta<"u"&&"/manager-wars/"||"/",D=`${typeof window<"u"&&((S=window.location)==null?void 0:S.origin)||""}${U}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="#161616"/>`,m+=`<image href="${D}" xlink:href="${D}" x="${ie}" y="${q}" width="${y}" height="${z}" preserveAspectRatio="xMidYMid slice"/>`,m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="none" stroke="${Z}" stroke-width="2" opacity="0.7"/>`,m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${B.cardId}" data-role="${R}" style="cursor:pointer"/>`;continue}const ae=M?.45:1,pe=M?"#FFD700":Z,he=M?3:(B==null?void 0:B.rarity)==="legende"||(B==null?void 0:B.rarity)==="légende"||(B==null?void 0:B.rarity)==="pepite"||(B==null?void 0:B.rarity)==="pépite"?2.5:2,xe=z-o-b;m+=`<defs><clipPath id="cp-${P}"><rect x="${ie}" y="${(j.y-z/2+o).toFixed(1)}" width="${y}" height="${xe}"/></clipPath></defs>`,m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="${ee}" opacity="${ae}"/>`;const ge=ze(B);ge&&(m+=`<image href="${ge}" xlink:href="${ge}" x="${ie}" y="${(j.y-z/2+o).toFixed(1)}" width="${y}" height="${xe}" clip-path="url(#cp-${P})" preserveAspectRatio="xMidYMin slice"/>`),m+=`<rect x="${ie}" y="${q}" width="${y}" height="${o}" rx="4" fill="rgba(255,255,255,0.92)"/>`,m+=`<text x="${j.x.toFixed(1)}" y="${(j.y-z/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(B.name||"").slice(0,9)}</text>`;const O=(j.y+z/2-b).toFixed(1);m+=`<rect x="${ie}" y="${O}" width="${y}" height="${b}" fill="rgba(255,255,255,0.92)"/>`;{const U=Rt(B.country_code);U?m+=`<image href="${U}" xlink:href="${U}" x="${(j.x-20).toFixed(1)}" y="${(j.y+z/2-b+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:m+=`<text x="${(j.x-13).toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${nn(B.country_code)}</text>`,m+=`<text x="${j.x.toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Y}</text>`;const C=tn(B);C?m+=`<image href="${C}" xlink:href="${C}" x="${(j.x+y/2-14).toFixed(1)}" y="${(j.y+z/2-b+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:B.clubName&&(m+=`<text x="${(j.x+14).toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(B.clubName||"").slice(0,3).toUpperCase()}</text>`),B.boost&&(m+=`<rect x="${(j.x+y/2-12).toFixed(1)}" y="${(j.y-z/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,m+=`<text x="${(j.x+y/2-5).toFixed(1)}" y="${(j.y-z/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${B.boost}</text>`)}m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="${M?"rgba(255,255,255,0.12)":"none"}" stroke="${pe}" stroke-width="${he}" opacity="${ae}"/>`,re&&(m+=`<rect x="${ie}" y="${q}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${M?"selected":""}" data-card-id="${B.cardId}" data-role="${R}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${c+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${m}
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${o.map((S,P)=>{const B=P<o.length-1?Qe(S,o[P+1]):null,j=!B||B==="#ff3333"||B==="#cc2222",R=B==="#00ff88"?"+2":B==="#FFD700"?"+1":"";return`
          ...
          ${P<o.length-1?`<div class="duel-link duel-link-${L}" data-idx="${P}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${j?"rgba(255,255,255,0.12)":B};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${j?"none":`0 0 8px ${B}`}">
            ${R?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${B}">${R}</span>`:""}
          </div>`:""}
          `}).join("")}
      </div>
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
  ...
  </div>`;const f=()=>{const o=(b,T)=>e.querySelectorAll(b).forEach((L,S)=>{setTimeout(()=>{L.style.opacity="1",L.style.transform="translateY(0) scale(1)"},T+S*90)});o(".duel-card-home",150),o(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((b,T)=>{setTimeout(()=>{b.style.opacity="1"},T*70)}),900),setTimeout(()=>{const b=e.querySelector("#vs-label");b&&(b.style.opacity="1",b.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(T=>T.style.opacity="1")},1250),setTimeout(()=>{m("score-home",l,800),m("score-ai",p,800)},1500)};function m(o,b,T){const L=document.getElementById(o);if(!L)return;const S=performance.now(),P=B=>{const j=Math.min(1,(B-S)/T);L.textContent=Math.round(b*(1-Math.pow(1-j,3))),j<1?requestAnimationFrame(P):L.textContent=b};requestAnimationFrame(P)}requestAnimationFrame(f),t.attacker=i?"home":"ai";const y=i?li():null;i&&(t.boostCard={value:y}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:a.map(o=>({name:o.name,note:ve(o,"MIL"),portrait:ze(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),aiPlayers:c.map(o=>({name:o.name,note:ve(o,"MIL"),portrait:ze(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),homeTotal:l,aiTotal:p,text:`Duel milieu : ${t.clubName} ${l} – ${p} IA → ${i?t.clubName+" attaque":"IA attaque"}`});const z=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Me(e,t,n),t.attacker==="ai"&&setTimeout(()=>ii(e,t,n),800)};setTimeout(()=>{const o=document.getElementById("score-home"),b=document.getElementById("score-ai"),T=document.getElementById(i?"duel-row-home":"duel-row-ai"),L=document.getElementById(i?"duel-row-ai":"duel-row-home"),S=i?o:b,P=i?b:o;S&&(S.style.fontSize="80px",S.style.color=i?"#FFD700":"#ff6b6b",S.style.animation="duelPulse .5s ease"+(i?", duelGlow 1.5s ease infinite .5s":"")),P&&(P.style.opacity="0.25"),setTimeout(()=>{T&&(T.style.transformOrigin="center",T.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",T.style.zIndex="5"),setTimeout(()=>{var j;const B=document.getElementById("duel-shock");if(B){const R=(j=L||T)==null?void 0:j.getBoundingClientRect(),ee=e.querySelector(".match-screen").getBoundingClientRect();R&&(B.style.top=R.top-ee.top+R.height/2+"px"),B.style.animation="shockwave .5s ease-out forwards"}L&&(L.style.transformOrigin="center",L.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var j;const B=document.getElementById("duel-finale");B&&(B.innerHTML=`
    ...
    <div style="display:flex;align-items:center;gap:4px;${t?"flex-direction:row-reverse":""};background:rgba(255,255,255,0.04);border-radius:8px;padding:5px 8px;border:1px solid rgba(255,255,255,0.07)">
      ...
      ${nt(e.inPlayer||{})}
    </div>`}return`<div style="font-size:11px;color:${e.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${e.type==="goal"?700:400};padding:3px 2px">${e.text||""}</div>`}function Me(e,t,n){var S,P,B,j,R,ee,le,re;const a=t.selected.map(M=>M.cardId),c=t.usedSubIds||[],d=t.homeSubs.filter(M=>!c.includes(M.cardId)),l=Object.values(t.homeTeam).flat().filter(M=>M.used).length>0&&d.length>0&&t.subsUsed<t.maxSubs,p=!["GK","DEF","MIL","ATT"].some(M=>(t.aiTeam[M]||[]).some(Y=>!Y.used)),i=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(M=>!M.used),r=t.phase==="attack"&&p&&i.length===0?[...t.homeTeam.GK||[],...t.homeTeam.DEF||[]].filter(M=>!M.used).map(M=>M.cardId):[];t.log[t.log.length-1];const f=t.phase==="ai-attack"||t.phase==="ai-defense",m=t.phase==="attack",y=t.phase==="defense",z=t.phase==="finished",o=t.gcCards.filter(M=>!t.usedGc.includes(M.id)),b=t.boostCard&&!t.boostUsed;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column",e.innerHTML=`
  <style>
  ...
  `,document.body.appendChild(a);let r=!1;const f=()=>{r||(r=!0,a.remove(),n())};a.addEventListener("click",f),setTimeout(f,2e3)}function $t(e,t="rgba(0,0,0,0.8)"){const n=document.createElement("div");n.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function Xt(e,t,n,a=null,c=null){var y,z;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([o,b])=>(b||[]).filter(T=>T.used).map(T=>({...T,_line:T._line||o}))),s=t.homeSubs.filter(o=>!t.usedSubIds.includes(o.cardId));if(!d.length){$t("Aucun joueur utilisé à remplacer");return}if(!s.length){$t("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(o=>o.cardId===c));const p=((y=d[l])==null?void 0:y._line)||((z=d[l])==null?void 0:z.job);let i=a?Math.max(0,s.findIndex(o=>o.cardId===a)):Math.max(0,s.findIndex(o=>o.job===p)),r=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function m(){var B,j,R,ee,le,re;const o=d[l],b=s[i],T=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(T*1.35),S=M=>`background:rgba(255,255,255,0.12);border:none;color:${M?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${M?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${b?Ve({...b,used:!1,boost:0},T,L):"<div>—</div>"}</div>
    ...
    </div>`,(B=f.querySelector("#sub-close"))==null||B.addEventListener("click",()=>f.remove()),(j=f.querySelector("#out-up"))==null||j.addEventListener("click",()=>{l>0&&(l--,m())}),(R=f.querySelector("#out-down"))==null||R.addEventListener("click",()=>{l<d.length-1&&(l++,m())}),(ee=f.querySelector("#in-up"))==null||ee.addEventListener("click",()=>{i>0&&(i--,m())}),(le=f.querySelector("#in-down"))==null||le.addEventListener("click",()=>{i<s.length-1&&(i++,m())});const P=(M,Y,ie,q)=>{const Z=f.querySelector("#"+M);if(!Z)return;let ae=0;Z.addEventListener("touchstart",pe=>{ae=pe.touches[0].clientY},{passive:!0}),Z.addEventListener("touchend",pe=>{const he=pe.changedTouches[0].clientY-ae;if(Math.abs(he)<30)return;const xe=Y();he<0&&xe<q-1?(ie(xe+1),m()):he>0&&xe>0&&(ie(xe-1),m())},{passive:!0})};P("in-panel",()=>i,M=>i=M,s.length),P("out-panel",()=>l,M=>l=M,d.length),(re=f.querySelector("#sub-confirm"))==null||re.addEventListener("click",M=>{if(M.preventDefault(),M.stopPropagation(),r)return;r=!0;const Y=d[l],ie=s[i];if(!Y||!ie)return;let q=null,Z=-1;for(const[pe,he]of Object.entries(t.homeTeam)){const xe=(he||[]).findIndex(ge=>ge.cardId===Y.cardId);if(xe!==-1){q=pe,Z=xe;break}}if(Z===-1||!q){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const ae={...ie,_line:q,_col:Y._col||0,used:!1,boost:0};t.homeTeam[q].splice(Z,1,ae),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(ie.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:ve(Y,q),portrait:ze(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:ie.name,firstname:ie.firstname,note:ve(ie,q),portrait:ze(ie),job:ie.job,country_code:ie.country_code,rarity:ie.rarity,clubName:ie.clubName,clubLogo:ie.clubLogo},text:`🔄 ${ie.firstname} ${ie.name} remplace ${Y.firstname} ${Y.name}`}),f.remove(),bo(Y,ie,()=>Me(e,t,n))})}document.body.appendChild(f),m()}function vo(e,t,n,a,c){var z,o;const d=(a.gcDefs||[]).find(b=>b.name===t),s=Ne[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",p={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",i=(d==null?void 0:d.name)||t,r=(d==null?void 0:d.effect)||s.desc,f=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,m=s.icon||"⚡",y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",y.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
      ${e.map(f=>{const m=f._line||f.job||"MIL",y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[m]||"#555",z=ve(f,m)+(f.boost||0),o=l.find(b=>b.cardId===f.cardId);return`<div class="gc-pick-item" data-cid="${f.cardId}"
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const p=()=>{l||(l=!0,d.remove(),setTimeout(()=>c(),50))};d.addEventListener("click",p),setTimeout(p,3500)}async function Tt(e,t,n){var r,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=n,c=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=c?"victoire":d?"nul":"defaite",l=In(t.mode,s);t.matchId&&await $.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(a.profile.credits||0)+l,matches_played:(a.profile.matches_played||0)+1};c?p.wins=(a.profile.wins||0)+1:d?p.draws=(a.profile.draws||0)+1:p.losses=(a.profile.losses||0)+1,await $.from("users").update(p).eq("id",a.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const y=async(S=!0)=>{f=!0,m&&($.removeChannel(m),m=null),S&&await $.rpc("cancel_matchmaking",{p_user_id:p.profile.id}).catch(()=>{})};(L=document.getElementById("mm-cancel"))==null||L.addEventListener("click",async()=>{try{await y(!0)}catch{}He(e),i("home")});const z=async(S,P,B)=>{if(f)return;f=!0,m&&($.removeChannel(m),m=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(R=>setTimeout(R,600)),e.isConnected&&an(e,t,S,B,s,l)},{data:o,error:b}=await $.rpc("try_matchmake",{p_user_id:p.profile.id,p_deck_id:n});if(b||!(o!=null&&o.success)){r("Erreur de matchmaking","error"),He(e),i("home");return}if(o.matched){z(o.match_id,o.opponent_id,!1);return}const T=document.getElementById("mm-status");T&&(T.textContent="En attente d'un autre joueur..."),m=$.channel("matchmaking-"+p.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${p.profile.id}`},S=>{const P=S.new;P.status==="matched"&&P.match_id&&z(P.match_id,P.matched_with,!0)}).subscribe()}async function Ao(e,t,n){const{state:a,navigate:c,toast:d}=t;try{($.getChannels?$.getChannels():[]).forEach(i=>{const r=i.topic||"";(r.includes("matchmaking")||r.includes("pvp-match")||r.includes("friend-invite"))&&$.removeChannel(i)})}catch{}const{data:s}=await $.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!s){d("Match introuvable","error"),c("home");return}if(s.status==="finished"){d("Ce match est terminé","info"),c("home");return}const l=s.home_id===a.profile.id;an(e,t,n,l,[],[])}async function an(e,t,n,a,c=[],d=[]){const{state:s,navigate:l,toast:p}=t,i=a?"p1":"p2",r=a?"p2":"p1",f=(c||[]).map(k=>k.id),m=(c||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:y}=await $.from("matches").select("*").eq("id",n).single();if(!y){p("Match introuvable","error"),l("home");return}async function z(){const[{data:k},{data:u},{data:g},{data:h}]=await Promise.all([$.rpc("get_deck_for_match",{p_deck_id:y.home_deck_id}),$.rpc("get_deck_for_match",{p_deck_id:y.away_deck_id}),$.from("users").select("id,pseudo,club_name").eq("id",y.home_id).single(),$.from("users").select("id,pseudo,club_name").eq("id",y.away_id).single()]),x=E=>({cardId:E.card_id,position:E.position,id:E.id,firstname:E.firstname,name:E.surname_encoded,country_code:E.country_code,club_id:E.club_id,job:E.job,job2:E.job2,note_g:Number(E.note_g)||0,note_d:Number(E.note_d)||0,note_m:Number(E.note_m)||0,note_a:Number(E.note_a)||0,rarity:E.rarity,skin:E.skin,hair:E.hair,hair_length:E.hair_length,clubName:E.club_encoded_name||null,clubLogo:E.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),v=((k==null?void 0:k.starters)||[]).map(E=>x(E)),w=((u==null?void 0:u.starters)||[]).map(E=>x(E)),_=(k==null?void 0:k.formation)||"4-4-2",I=(u==null?void 0:u.formation)||"4-4-2";return{p1Team:mt(v,_),p2Team:mt(w,I),p1Subs:((k==null?void 0:k.subs)||[]).map(E=>x(E)),p2Subs:((u==null?void 0:u.subs)||[]).map(E=>x(E)),p1Formation:_,p2Formation:I,p1Name:(g==null?void 0:g.club_name)||(g==null?void 0:g.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?f:[],gc_p2:a?[]:f,gcCardsFull_p1:a?m:[],gcCardsFull_p2:a?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let o=y.game_state&&Object.keys(y.game_state).length?y.game_state:null;if(!o)if(a){o=await z();const{data:k}=await $.from("matches").select("game_state").eq("id",n).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await $.from("matches").update({game_state:o,turn_user_id:y.home_id}).eq("id",n):o=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let k=0;k<30&&!o;k++){await new Promise(g=>setTimeout(g,400));const{data:u}=await $.from("matches").select("game_state").eq("id",n).single();u!=null&&u.game_state&&Object.keys(u.game_state).length&&(o=u.game_state)}if(!o){p("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=m,await $.from("matches").update({game_state:o}).eq("id",n)}let b=!1,T=null,L=!1;const S=new Set,P=new Set;function B(k){var E,A;try{$.removeChannel(j)}catch{}const u=o[i+"Score"]||0,g=o[r+"Score"]||0;let h,x;k.winner_id?(h=k.winner_id===s.profile.id,x=!1):k.forfeit?(h=u>g,x=!1):(x=u===g,h=u>g),(E=document.getElementById("pvp-end-overlay"))==null||E.remove();const v=document.createElement("div");v.id="pvp-end-overlay",v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const w=x?"🤝":h?"🏆":"😞",_=x?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=x?"#fff":h?"#FFD700":"#ff6b6b";v.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(A=v.querySelector("#pvp-end-home"))==null||A.addEventListener("click",()=>{v.remove(),He(e),l("home")})}const j=$.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},k=>{const u=k.new;try{if(u.status==="finished"||u.forfeit){if(b)return;b=!0,T&&(clearInterval(T),T=null),u.game_state&&(o=u.game_state),B(u);return}if(u.game_state){const g=o;o=u.game_state;const h=o._lastGC;if(h&&h.seq&&!P.has(h.seq)&&(P.add(h.seq),h.by!==i)){xe(h.type,h.by,()=>q());return}const x=g[i+"Score"]||0,v=g[r+"Score"]||0,w=o[i+"Score"]||0,_=o[r+"Score"]||0,I=w>x,E=_>v;if((I||E)&&!S.has(o.round)){S.add(o.round);const A=[...o.log||[]].reverse().find(N=>N.isGoal),F=((A==null?void 0:A.homePlayers)||[]).map(N=>({name:N.name,note:N.note,portrait:N.portrait,job:N.job}));he(F,w,_,I,()=>q());return}q()}}catch(g){console.error("[PvP] crash:",g)}}).subscribe();async function R(k){Object.assign(o,k),o.lastActionAt=new Date().toISOString();const{error:u}=await $.from("matches").update({game_state:o}).eq("id",n);u&&p("Erreur de synchronisation","error");try{q()}catch(g){console.error("[PvP] renderPvpScreen crash:",g)}}async function ee(){if(b)return;b=!0,T&&(clearInterval(T),T=null);const k=a?y.away_id:y.home_id,u=a?"p2":"p1",g=a?"p1":"p2",h={...o,[u+"Score"]:3,[g+"Score"]:0,phase:"finished"};try{await $.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",n)}catch{}try{$.removeChannel(j)}catch{}setTimeout(()=>{He(e),l("home")},800)}const le={BOOST_STAT:({value:k=1,count:u=1,roles:g=[]},h,x)=>{const v=h[i+"Team"],w=Object.entries(v).filter(([_])=>!g.length||g.includes(_)).flatMap(([_,I])=>I.filter(E=>!E.used).map(E=>({...E,_line:_})));if(!w.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),x(h);return}re(w,u,`Choisir ${u} joueur(s) à booster (+${k})`,_=>{_.forEach(I=>{const E=(v[I._line]||[]).find(A=>A.cardId===I.cardId);E&&(E.boost=(E.boost||0)+k,h.log.push({text:`⚡ +${k} sur ${E.name}`,type:"info"}))}),h[i+"Team"]=v,x(h)})},DEBUFF_STAT:({value:k=1,count:u=1,roles:g=[],target:h="ai"},x,v)=>{const w=h==="home"?i:r,_=x[w+"Team"],I=h==="home"?"allié":"adverse",E=Object.entries(_).filter(([A])=>!g.length||g.includes(A)).flatMap(([A,F])=>F.filter(N=>!N.used).map(N=>({...N,_line:A})));if(!E.length){x.log.push({text:`🎯 Aucun joueur ${I}`,type:"info"}),v(x);return}re(E,u,`Choisir ${u} joueur(s) ${I}(s) (-${k})`,A=>{A.forEach(F=>{const N=(_[F._line]||[]).find(W=>W.cardId===F.cardId);N&&(N.boost=(N.boost||0)-k,x.log.push({text:`🎯 -${k} sur ${N.name}`,type:"info"}))}),x[w+"Team"]=_,v(x)})},GRAY_PLAYER:({count:k=1,roles:u=[],target:g="ai"},h,x)=>{const v=g==="home"?i:r,w=h[v+"Team"],_=g==="home"?"allié":"adverse",I=Object.entries(w).filter(([E])=>!u.length||u.includes(E)).flatMap(([E,A])=>A.filter(F=>!F.used).map(F=>({...F,_line:E})));if(!I.length){h.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),x(h);return}re(I,k,`Choisir ${k} joueur(s) ${_}(s) à exclure`,E=>{E.forEach(A=>{const F=(w[A._line]||[]).find(N=>N.cardId===A.cardId);F&&(F.used=!0,h.log.push({text:`❌ ${F.name} exclu !`,type:"info"}))}),h[v+"Team"]=w,x(h)})},REVIVE_PLAYER:({count:k=1,roles:u=[]},g,h)=>{const x=g[i+"Team"],v=Object.entries(x).filter(([w])=>!u.length||u.includes(w)).flatMap(([w,_])=>_.filter(I=>I.used).map(I=>({...I,_line:w})));if(!v.length){g.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(g);return}re(v,k,`Choisir ${k} joueur(s) à ressusciter`,w=>{w.forEach(_=>{const I=(x[_._line]||[]).find(E=>E.cardId===_.cardId);I&&(I.used=!1,g.log.push({text:`💫 ${I.name} ressuscité !`,type:"info"}))}),g[i+"Team"]=x,h(g)})},REMOVE_GOAL:({},k,u)=>{const g=r+"Score";k[g]>0?(k[g]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),u(k)},ADD_GOAL_DRAW:({},k,u)=>{k[i+"Score"]===k[r+"Score"]?(k[i+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),u(k)},ADD_SUB:({value:k=1},u,g)=>{u.maxSubs=(u.maxSubs||3)+k,u.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),g(u)},CUSTOM:({},k,u)=>u(k)};function re(k,u,g,h){const x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var I,E;const _=k.map(A=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",N=ve(A,A._line)+(A.boost||0),ce=v.find(H=>H.cardId===A.cardId)?"#FFD700":"rgba(255,255,255,0.25)",J=A.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${ce};background:${F};overflow:hidden;cursor:pointer;${J}">
        ...
        </div>`,(I=x.querySelector("#pp-close"))==null||I.addEventListener("click",()=>x.remove()),x.querySelectorAll(".pp-item").forEach(A=>{A.addEventListener("click",()=>{const F=A.dataset.cid,N=k.find(ce=>ce.cardId===F),W=v.findIndex(ce=>ce.cardId===F);N&&(W>-1?v.splice(W,1):v.length<u&&v.push(N),w())})}),(E=x.querySelector("#pp-confirm"))==null||E.addEventListener("click",()=>{x.remove(),h(v)})}w(),document.body.appendChild(x)}async function M(k,u){const h=(o["gcCardsFull_"+i]||[]).find(_=>_.id===k),x=(h==null?void 0:h._gcDef)||(o.gcDefs||[]).find(_=>{var I;return _.name===u||((I=_.name)==null?void 0:I.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),v=[...o["usedGc_"+i]||[],k],w={type:u,by:i,seq:(o._gcAnimSeq||0)+1};P.add(w.seq),xe(u,i,async()=>{if(x!=null&&x.effect_type&&x.effect_type!=="CUSTOM"){const I=le[x.effect_type];if(I){const E={...o};I(x.effect_params||{},E,async A=>{A["usedGc_"+i]=v,A._lastGC=w,A._gcAnimSeq=w.seq,await R(A)});return}}const _={...o};switch(u){case"Remplacement+":_.maxSubs=(_.maxSubs||3)+1,_.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const I=r+"Score";_[I]>0&&(_[I]--,_.log.push({text:"🚫 But annulé",type:"info"}));break}}_["usedGc_"+i]=v,_._lastGC=w,_._gcAnimSeq=w.seq,await R(_)})}function Y(k,u){const g="usedCardIds_"+k,h=new Set(o[g]||[]);u.forEach(x=>h.add(x)),o[g]=[...h]}function ie(){for(const k of["p1","p2"]){const u=new Set(o["usedCardIds_"+k]||[]),g=o[k+"Team"];if(g)for(const h of["GK","DEF","MIL","ATT"])(g[h]||[]).forEach(x=>{x.used=u.has(x.cardId)})}}function q(){var Fe,Ze,xt,yt,ht,bt;if(o.phase==="reveal")return Z();if(o.phase==="midfield")return pe();if(o.phase==="finished")return Re();const k=o[i+"Team"],u=o[r+"Team"];ie();const g=o[i+"Score"],h=o[r+"Score"],x=o[i+"Name"],v=o[r+"Name"],w=o.phase===i+"-attack",_=o.phase===i+"-defense",I=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],E=I.map(X=>X.cardId),A=window.innerWidth>=700,F=o[i+"Subs"]||[],N=o["usedSubIds_"+i]||[],W=F.filter(X=>!N.includes(X.cardId)),ce=o["gcCardsFull_"+i]||[],J=o["usedGc_"+i]||[],H=ce.filter(X=>!J.includes(X.id)),V=o.boostOwner===i&&!o.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(X=>(u[X]||[]).some(G=>!G.used)),de=[...k.MIL||[],...k.ATT||[]].filter(X=>!X.used),ue=w&&Q&&de.length===0?[...k.GK||[],...k.DEF||[]].filter(X=>!X.used).map(X=>X.cardId):[];function fe(X,G,oe){var jt,_t;const se=X._gcDef,ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[se==null?void 0:se.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ye={purple:"#b06ce0",light_blue:"#00d4ef"}[se==null?void 0:se.color]||"#b06ce0",We=(se==null?void 0:se.name)||X.gc_type,Je=(se==null?void 0:se.effect)||((jt=Ne[X.gc_type])==null?void 0:jt.desc)||"",et=se!=null&&se.image_url?`/manager-wars/icons/${se.image_url}`:null,Mt=((_t=Ne[X.gc_type])==null?void 0:_t.icon)||"⚡",Ct=Math.round(oe*.22),vt=Math.round(oe*.22),lt=oe-Ct-vt,wt=We.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
      ...
      </div>`}const be=(X,G)=>G?me(130,175):fe(X,130,175),Ce=(X,G)=>G?me(68,95):fe(X,68,95),Pe=A?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",De=w?Ee(i)?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${I.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Pe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:_?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${I.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${v}</div>`,Ie=w&&!Ee(i)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':w||_?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${I.length}/3 sélectionné(s)</div>`:"",Le=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${A?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div style="width:min(90vw,420px)">${st(o[r+"Team"],o[r+"Formation"],null,[],300,300)}</div>
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${H.map((de,ue)=>{const fe=ue<H.length-1?Qe(de,H[ue+1]):null,me=!fe||fe==="#ff3333"||fe==="#cc2222",be=fe==="#00ff88"?"+2":fe==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${Q}" data-idx="${ue}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ve({...de,note:ve(de,"MIL"),_line:"MIL"},58,78)}
            </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let I=!1;const E=()=>{I||(I=!0,v.remove(),setTimeout(()=>x(),50))};v.addEventListener("click",E),setTimeout(E,3500)}function xe(k,u,g){var J,H;const h=(o.gcDefs||[]).find(V=>{var Q;return V.name===k||((Q=V.name)==null?void 0:Q.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",w=(h==null?void 0:h.name)||k,_=(h==null?void 0:h.effect)||((J=Ne[k])==null?void 0:J.desc)||"",I=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,E=((H=Ne[k])==null?void 0:H.icon)||"⚡",F=u===i?"Vous":o[u+"Name"]||"Adversaire",N=document.createElement("div");N.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",N.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(N);let W=!1;const ce=()=>{W||(W=!0,N.remove(),setTimeout(()=>g&&g(),50))};N.addEventListener("click",ce),setTimeout(ce,3e3)}function ge(k,u){var N,W,ce,J;const h=(o["gcCardsFull_"+i]||[]).find(H=>H.id===k),x=h==null?void 0:h._gcDef,v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[x==null?void 0:x.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[x==null?void 0:x.color]||"#b06ce0",_=(x==null?void 0:x.name)||u,I=(x==null?void 0:x.effect)||((N=Ne[u])==null?void 0:N.desc)||"Carte spéciale.",E=x!=null&&x.image_url?`/manager-wars/icons/${x.image_url}`:null,A=((W=Ne[u])==null?void 0:W.icon)||"⚡",F=document.createElement("div");F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",F.innerHTML=`
      ...
      </div>`,document.body.appendChild(F),(ce=F.querySelector("#pvp-gc-back"))==null||ce.addEventListener("click",()=>F.remove()),(J=F.querySelector("#pvp-gc-use"))==null||J.addEventListener("click",()=>{F.remove(),M(k,u)})}function O(){var h;const k=o[i+"Team"],u=Object.entries(k).flatMap(([x,v])=>(v||[]).filter(w=>!w.used).map(w=>({...w,_line:x})));if(!u.length)return;const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",g.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${o.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${u.map(x=>{const v={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[x._line]||"#555",w=ve(x,x._line)+(x.boost||0);return`<div class="bp-item" data-cid="${x.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${v};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(g),(h=g.querySelector("#bp-close"))==null||h.addEventListener("click",()=>g.remove()),g.querySelectorAll(".bp-item").forEach(x=>{x.addEventListener("click",async()=>{const v=x.dataset.cid,w=u.find(I=>I.cardId===v);if(!w)return;const _=(k[w._line]||[]).find(I=>I.cardId===v);_&&(_.boost=(_.boost||0)+o.boostValue),g.remove(),await R({[i+"Team"]:k,boostUsed:!0})})})}function U(k=null){var W,ce;if(!(o.phase===i+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const g=o[i+"Team"],h=o["usedSubIds_"+i]||[],x=o.maxSubs||3;if(h.length>=x){p(`Maximum ${x} remplacements atteint`,"warning");return}const v=Object.entries(g).flatMap(([J,H])=>(H||[]).filter(V=>V.used).map(V=>({...V,_line:J}))),w=(o[i+"Subs"]||[]).filter(J=>!h.includes(J.cardId));if(!v.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!w.length){p("Aucun remplaçant disponible","warning");return}let _=Math.max(0,v.findIndex(J=>J.cardId===k));const I=((W=v[_])==null?void 0:W._line)||((ce=v[_])==null?void 0:ce.job);let E=Math.max(0,w.findIndex(J=>J.job===I)),A=!1;const F=document.createElement("div");F.id="pvp-sub-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function N(){var fe,me,be,Ce,Pe,De;const J=v[_],H=w[E],V=Math.min(130,Math.round((window.innerWidth-90)/2)),Q=Math.round(V*1.35),de=Ie=>`background:rgba(255,255,255,0.12);border:none;color:${Ie?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Ie?"default":"pointer"};flex-shrink:0`;F.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(fe=F.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>F.remove()),(me=F.querySelector("#pout-up"))==null||me.addEventListener("click",()=>{_>0&&(_--,N())}),(be=F.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{_<v.length-1&&(_++,N())}),(Ce=F.querySelector("#pin-up"))==null||Ce.addEventListener("click",()=>{E>0&&(E--,N())}),(Pe=F.querySelector("#pin-down"))==null||Pe.addEventListener("click",()=>{E<w.length-1&&(E++,N())});const ue=(Ie,Le,Be,Ge)=>{const Oe=F.querySelector("#"+Ie);if(!Oe)return;let Ue=0;Oe.addEventListener("touchstart",Ke=>{Ue=Ke.touches[0].clientY},{passive:!0}),Oe.addEventListener("touchend",Ke=>{const je=Ke.changedTouches[0].clientY-Ue;if(Math.abs(je)<30)return;const Fe=Le();je<0&&Fe<Ge-1?(Be(Fe+1),N()):je>0&&Fe>0&&(Be(Fe-1),N())},{passive:!0})};ue("pin-panel",()=>E,Ie=>E=Ie,w.length),ue("pout-panel",()=>_,Ie=>_=Ie,v.length),(De=F.querySelector("#psub-confirm"))==null||De.addEventListener("click",async Ie=>{if(Ie.preventDefault(),Ie.stopPropagation(),A)return;A=!0;const Le=v[_],Be=w[E];if(!Le||!Be)return;const Ge=Le._line,Oe=(g[Ge]||[]).findIndex(je=>je.cardId===Le.cardId);if(Oe===-1){p("Erreur : joueur introuvable","error"),F.remove();return}const Ue={...Be,_line:Ge,position:Le.position,used:!1,boost:0};g[Ge].splice(Oe,1,Ue);const Ke=[...h,Be.cardId];F.remove(),C(Le,Be,async()=>{await R({[i+"Team"]:g,[r+"Team"]:o[r+"Team"],["usedSubIds_"+i]:Ke})})})}document.body.appendChild(F),N()}function C(k,u,g){const h={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(I,E,A)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(u),(g=u.querySelector("#pvp-hist-close"))==null||g.addEventListener("click",()=>u.remove())}async function ne(){if(o.phase!==i+"-attack")return;const k=i==="p1"?"p2":"p1",u=(o.round||0)+1,g=[...o.log||[]];g.push({type:"info",text:`⏭️ ${o[i+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const h=Te(o),x=Ee(k),v=h||!x?"finished":k+"-attack";await R({["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:v,attacker:k,round:u,log:g}),v==="finished"&&await qe(o)}async function te(){const k=o[i+"Team"],u=!["GK","DEF","MIL","ATT"].some(v=>(o[r+"Team"][v]||[]).some(w=>!w.used)),g=(o["selected_"+i]||[]).map(v=>{const w=(k[v._role]||[]).find(N=>N.cardId===v.cardId)||v,_=u&&["GK","DEF"].includes(v._role),I=k[v._role]||[],E=I.findIndex(N=>N.cardId===v.cardId),A=ot(I.length),F=E>=0?A[E]:w._col??1;return{...w,_line:v._role,_col:F,..._?{note_a:Math.max(1,Number(w.note_a)||0)}:{}}});if(!g.length)return;const h=Ht(g,o.modifiers[i]||{});Y(i,g.map(v=>v.cardId)),g.forEach(v=>{const w=(k[v._role]||[]).find(_=>_.cardId===v.cardId);w&&(w.used=!0)}),o["selected_"+i]=[],q();const x=[...o.log||[]];if(u){const v=(o[i+"Score"]||0)+1,w=g.map(F=>({name:F.name,note:ve(F,F._line||"ATT"),portrait:ze(F),job:F.job}));x.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:w,homeTotal:h.total,aiTotal:0});const _=(o.round||0)+1,I=i==="p1"?"p2":"p1",E={...o,[i+"Team"]:k,[i+"Score"]:v},A=Te(E);S.add(_),he(w,v,o[r+"Score"]||0,!0,async()=>{await R({[i+"Team"]:k,[i+"Score"]:v,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:A?"finished":I+"-attack",attacker:I,round:_,log:x}),A&&await qe({...o,[i+"Score"]:v})});return}x.push({type:"pending",text:`⚔️ ${o[i+"Name"]} attaque (${h.total})`}),await R({[i+"Team"]:k,[r+"Team"]:o[r+"Team"],pendingAttack:{...h,players:g,side:i},["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},phase:r+"-defense",log:x})}async function we(){const k=o[i+"Team"],u=(o["selected_"+i]||[]).map(J=>{const H=(k[J._role]||[]).find(fe=>fe.cardId===J.cardId)||J,V=k[J._role]||[],Q=V.findIndex(fe=>fe.cardId===J.cardId),de=ot(V.length),ue=Q>=0?de[Q]:H._col??1;return{...H,_line:J._role,_col:ue}}),g=Ut(u,o.modifiers[i]||{});Y(i,u.map(J=>J.cardId)),u.forEach(J=>{const H=(k[J._role]||[]).find(V=>V.cardId===J.cardId);H&&(H.used=!0)}),o["selected_"+i]=[],q();const h=Kt(o.pendingAttack.total,g.total,o.modifiers[i]||{}),x=o.pendingAttack.side,v=h==="attack"||(h==null?void 0:h.goal),w=x==="p1"?"p2":"p1",_=(o.round||0)+1,I=(o.pendingAttack.players||[]).map(J=>({name:J.name,note:ve(J,J._line||"ATT"),portrait:ze(J),job:J.job})),E=[...o.log||[]];E.push({type:"duel",isGoal:v,homeScored:v&&x===i,text:v?`⚽ BUT de ${o[x+"Name"]} ! (${o.pendingAttack.total} vs ${g.total})`:`✋ Attaque stoppée (${o.pendingAttack.total} vs ${g.total})`,homePlayers:I,aiPlayers:u.map(J=>({name:J.name,note:ve(J,J._line||"DEF"),portrait:ze(J),job:J.job})),homeTotal:o.pendingAttack.total,aiTotal:g.total});const A=v?(o[x+"Score"]||0)+1:o[x+"Score"]||0,F={...o,[i+"Team"]:k,[x+"Score"]:A},N=Te(F),W=N?"finished":w+"-attack",ce=async()=>{await R({[i+"Team"]:k,[r+"Team"]:o[r+"Team"],[x+"Score"]:A,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:W,attacker:w,round:_,log:E}),(W==="finished"||N)&&await qe({...o,[x+"Score"]:A})};if(v){const J=x===i,H=J?A:o[i+"Score"]||0,V=J?o[r+"Score"]||0:A;S.add(_),he(I,H,V,J,ce)}else await ce()}function _e(k){return["MIL","ATT"].some(u=>(k[u]||[]).some(g=>!g.used))}function ke(k){return["GK","DEF","MIL","ATT"].some(u=>(k[u]||[]).some(g=>!g.used))}function Se(k){return ke(k)&&!_e(k)}function Ee(k){const u=o[k+"Team"],g=o[(k==="p1"?"p2":"p1")+"Team"];return!!(_e(u)||!ke(g)&&Se(u))}function Te(k){const u=["MIL","ATT"].some(E=>(k.p1Team[E]||[]).some(A=>!A.used)),g=["MIL","ATT"].some(E=>(k.p2Team[E]||[]).some(A=>!A.used)),h=ke(k.p1Team),x=ke(k.p2Team);return!u&&!(!x&&h)&&(!g&&!(!h&&x))}function $e(k){const u=k.p1Score||0,g=k.p2Score||0;return u===g?null:u>g?y.home_id:y.away_id}async function qe(k){try{const u=$e(k),g=u?y.home_id===u?y.away_id:y.home_id:null;await $.from("matches").update({status:"finished",winner_id:u,home_score:k.p1Score||0,away_score:k.p2Score||0}).eq("id",n),u&&g&&Pi(u,g).catch(()=>{})}catch(u){console.error("[PvP] finishMatch:",u)}}function Re(){var x;const k=o[i+"Score"],u=o[r+"Score"],g=k>u,h=k===u;Xe(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      </div>`,(q=document.getElementById("lobby-cancel"))==null||q.addEventListener("click",async()=>{z=!0,o&&($.removeChannel(o),o=null),Y&&await $.from("friend_match_invites").update({status:"declined"}).eq("id",Y),He(e),f("home")})},T=async(re,M)=>{z=!0,o&&($.removeChannel(o),o=null),await new Promise(Y=>setTimeout(Y,600)),e.isConnected&&zo(e,t,re,M,s,l)},{data:L}=await $.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${y},invitee_id.eq.${p}),and(inviter_id.eq.${p},invitee_id.eq.${y})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let S,P;if(L&&L.inviter_id===p)P=!1,S=L.id,await $.from("friend_match_invites").update({invitee_deck_id:n,invitee_ready:!0,status:"accepted"}).eq("id",S);else{P=!0;const{data:re,error:M}=await $.from("friend_match_invites").insert({inviter_id:y,invitee_id:p,friend_id:p,inviter_deck_id:n,inviter_ready:!0,status:"pending"}).select().single();if(M||!re){m("Erreur création invitation","error"),He(e),f("home");return}S=re.id}if(b(!0,!P,S),!P){const re={home_id:p,away_id:y,home_deck_id:L.inviter_deck_id,away_deck_id:n,status:"active",mode:"friend"},M=await $.from("matches").insert(re).select().single(),Y=M.data;if(!Y){m("Erreur création match: "+(((le=M.error)==null?void 0:le.message)||""),"error"),He(e),f("home");return}await $.from("friend_match_invites").update({match_id:Y.id,status:"matched"}).eq("id",S),T(Y.id,!1);return}let B=!1;const j=re=>{z||B||(re.status==="matched"&&re.match_id?(B=!0,clearInterval(R),clearInterval(ee),T(re.match_id,!0)):re.status==="declined"?(clearInterval(R),clearInterval(ee),m(`${i} a décliné l'invitation`,"warning"),He(e),f("home")):re.invitee_ready&&b(!0,!0,S))},R=setInterval(()=>{if(z){clearInterval(R);return}$.from("matchmaking_queue").delete().eq("user_id",y).then(()=>{},()=>{})},3e3),ee=setInterval(async()=>{if(z||B){clearInterval(ee);return}const{data:re}=await $.from("friend_match_invites").select("*").eq("id",S).maybeSingle();re&&j(re)},1200);o=$.channel("friend-invite-"+S).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${S}`},re=>j(re.new)).subscribe()}async function zo(e,t,n,a,c=[],d=[]){const{state:s,navigate:l,toast:p}=t,i=a?"p1":"p2",r=a?"p2":"p1",f=(c||[]).map(u=>u.id),m=(c||[]).map(u=>({id:u.id,gc_type:u.gc_type,_gcDef:u._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:y}=await $.from("matches").select("*").eq("id",n).single();if(!y){p("Match introuvable","error"),l("home");return}async function z(){const[{data:u},{data:g},{data:h},{data:x}]=await Promise.all([$.rpc("get_deck_for_match",{p_deck_id:y.home_deck_id}),$.rpc("get_deck_for_match",{p_deck_id:y.away_deck_id}),$.from("users").select("id,pseudo,club_name").eq("id",y.home_id).single(),$.from("users").select("id,pseudo,club_name").eq("id",y.away_id).single()]),v=A=>({cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:Number(A.note_g)||0,note_d:Number(A.note_d)||0,note_m:Number(A.note_m)||0,note_a:Number(A.note_a)||0,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),w=((u==null?void 0:u.starters)||[]).map(A=>v(A)),_=((g==null?void 0:g.starters)||[]).map(A=>v(A)),I=(u==null?void 0:u.formation)||"4-4-2",E=(g==null?void 0:g.formation)||"4-4-2";return{p1Team:mt(w,I),p2Team:mt(_,E),p1Subs:((u==null?void 0:u.subs)||[]).map(A=>v(A)),p2Subs:((g==null?void 0:g.subs)||[]).map(A=>v(A)),p1Formation:I,p2Formation:E,p1Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 1",p2Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?f:[],gc_p2:a?[]:f,gcCardsFull_p1:a?m:[],gcCardsFull_p2:a?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let o=y.game_state&&Object.keys(y.game_state).length?y.game_state:null;if(!o)if(a){o=await z();const{data:u}=await $.from("matches").select("game_state").eq("id",n).single();!(u!=null&&u.game_state)||!Object.keys(u.game_state).length?await $.from("matches").update({game_state:o,turn_user_id:y.home_id}).eq("id",n):o=u.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let u=0;u<60&&!o;u++){await new Promise(h=>setTimeout(h,400));const{data:g}=await $.from("matches").select("game_state").eq("id",n).single();g!=null&&g.game_state&&Object.keys(g.game_state).length&&(o=g.game_state)}if(!o){p("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=m,await $.from("matches").update({game_state:o}).eq("id",n)}let b=!1,T=!1,L=null,S=!1;const P=new Set,B=new Set;function j(u){var A,F;try{$.removeChannel(R)}catch{}const g=o[i+"Score"]||0,h=o[r+"Score"]||0;if(!T){const N=o.p1Score||0,W=o.p2Score||0,ce=(o.usedGc_p1||[]).length,J=(o.usedGc_p2||[]).length,H=u.winner_id||(N>W?y.home_id:W>N?y.away_id:null);(H?s.profile.id===H:s.profile.id<(a?y.away_id:y.home_id))&&(T=!0,_n({player1Id:y.home_id,player2Id:y.away_id,score1:N,score2:W,gc1:ce,gc2:J}).catch(Q=>console.warn("[FriendMatch] updateStats:",Q)))}let x,v;u.winner_id?(x=u.winner_id===s.profile.id,v=!1):u.forfeit?(x=g>h,v=!1):(v=g===h,x=g>h),(A=document.getElementById("pvp-end-overlay"))==null||A.remove();const w=document.createElement("div");w.id="pvp-end-overlay",w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const _=v?"🤝":x?"🏆":"😞",I=v?"MATCH NUL":x?"VICTOIRE !":"DÉFAITE",E=v?"#fff":x?"#FFD700":"#ff6b6b";w.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(w),(F=w.querySelector("#pvp-end-home"))==null||F.addEventListener("click",()=>{w.remove(),He(e),l("home")})}const R=$.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},u=>{const g=u.new;try{if(g.status==="finished"||g.forfeit){if(b)return;b=!0,L&&(clearInterval(L),L=null),g.game_state&&(o=g.game_state),j(g);return}if(g.game_state){const h=o;o=g.game_state;const x=o._lastGC;if(x&&x.seq&&!B.has(x.seq)&&(B.add(x.seq),x.by!==i)){ge(x.type,x.by,()=>Z());return}const v=h[i+"Score"]||0,w=h[r+"Score"]||0,_=o[i+"Score"]||0,I=o[r+"Score"]||0,E=_>v,A=I>w;if((E||A)&&!P.has(o.round)){P.add(o.round);const F=[...o.log||[]].reverse().find(W=>W.isGoal),N=((F==null?void 0:F.homePlayers)||[]).map(W=>({name:W.name,note:W.note,portrait:W.portrait,job:W.job}));xe(N,_,I,E,()=>Z());return}Z()}}catch(h){console.error("[PvP] crash:",h)}}).subscribe();async function ee(u){Object.assign(o,u),o.lastActionAt=new Date().toISOString();const{error:g}=await $.from("matches").update({game_state:o}).eq("id",n);g&&p("Erreur de synchronisation","error");try{Z()}catch(h){console.error("[PvP] renderPvpScreen crash:",h)}}async function le(){if(b)return;b=!0,L&&(clearInterval(L),L=null);const u=a?y.away_id:y.home_id,g=a?"p2":"p1",h=a?"p1":"p2",x={...o,[g+"Score"]:3,[h+"Score"]:0,phase:"finished"};try{await $.from("matches").update({status:"finished",forfeit:!0,winner_id:u,home_score:x.p1Score||0,away_score:x.p2Score||0,game_state:x}).eq("id",n)}catch{}try{$.removeChannel(R)}catch{}setTimeout(()=>{He(e),l("home")},800)}const re={BOOST_STAT:({value:u=1,count:g=1,roles:h=[]},x,v)=>{const w=x[i+"Team"],_=Object.entries(w).filter(([I])=>!h.length||h.includes(I)).flatMap(([I,E])=>E.filter(A=>!A.used).map(A=>({...A,_line:I})));if(!_.length){x.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(x);return}M(_,g,`Choisir ${g} joueur(s) à booster (+${u})`,I=>{I.forEach(E=>{const A=(w[E._line]||[]).find(F=>F.cardId===E.cardId);A&&(A.boost=(A.boost||0)+u,x.log.push({text:`⚡ +${u} sur ${A.name}`,type:"info"}))}),x[i+"Team"]=w,v(x)})},DEBUFF_STAT:({value:u=1,count:g=1,roles:h=[],target:x="ai"},v,w)=>{const _=x==="home"?i:r,I=v[_+"Team"],E=x==="home"?"allié":"adverse",A=Object.entries(I).filter(([F])=>!h.length||h.includes(F)).flatMap(([F,N])=>N.filter(W=>!W.used).map(W=>({...W,_line:F})));if(!A.length){v.log.push({text:`🎯 Aucun joueur ${E}`,type:"info"}),w(v);return}M(A,g,`Choisir ${g} joueur(s) ${E}(s) (-${u})`,F=>{F.forEach(N=>{const W=(I[N._line]||[]).find(ce=>ce.cardId===N.cardId);W&&(W.boost=(W.boost||0)-u,v.log.push({text:`🎯 -${u} sur ${W.name}`,type:"info"}))}),v[_+"Team"]=I,w(v)})},GRAY_PLAYER:({count:u=1,roles:g=[],target:h="ai"},x,v)=>{const w=h==="home"?i:r,_=x[w+"Team"],I=h==="home"?"allié":"adverse",E=Object.entries(_).filter(([A])=>!g.length||g.includes(A)).flatMap(([A,F])=>F.filter(N=>!N.used).map(N=>({...N,_line:A})));if(!E.length){x.log.push({text:`❌ Aucun joueur ${I}`,type:"info"}),v(x);return}M(E,u,`Choisir ${u} joueur(s) ${I}(s) à exclure`,A=>{A.forEach(F=>{const N=(_[F._line]||[]).find(W=>W.cardId===F.cardId);N&&(N.used=!0,x.log.push({text:`❌ ${N.name} exclu !`,type:"info"}))}),x[w+"Team"]=_,v(x)})},REVIVE_PLAYER:({count:u=1,roles:g=[]},h,x)=>{const v=h[i+"Team"],w=Object.entries(v).filter(([_])=>!g.length||g.includes(_)).flatMap(([_,I])=>I.filter(E=>E.used).map(E=>({...E,_line:_})));if(!w.length){h.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),x(h);return}M(w,u,`Choisir ${u} joueur(s) à ressusciter`,_=>{_.forEach(I=>{const E=(v[I._line]||[]).find(A=>A.cardId===I.cardId);E&&(E.used=!1,h.log.push({text:`💫 ${E.name} ressuscité !`,type:"info"}))}),h[i+"Team"]=v,x(h)})},REMOVE_GOAL:({},u,g)=>{const h=r+"Score";u[h]>0?(u[h]--,u.log.push({text:"🚫 Dernier but annulé !",type:"info"})):u.log.push({text:"🚫 Aucun but à annuler",type:"info"}),g(u)},ADD_GOAL_DRAW:({},u,g)=>{u[i+"Score"]===u[r+"Score"]?(u[i+"Score"]++,u.log.push({text:"🎯 But bonus !",type:"info"})):u.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),g(u)},ADD_SUB:({value:u=1},g,h)=>{g.maxSubs=(g.maxSubs||3)+u,g.log.push({text:`🔄 +${u} remplacement(s)`,type:"info"}),h(g)},CUSTOM:({},u,g)=>g(u)};function M(u,g,h,x){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let w=[];function _(){var E,A;const I=u.map(F=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[F._line]||"#555",W=ve(F,F._line)+(F.boost||0),J=w.find(V=>V.cardId===F.cardId)?"#FFD700":"rgba(255,255,255,0.25)",H=F.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${F.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${J};background:${N};overflow:hidden;cursor:pointer;${H}">
          <div style="background:rgba(255,255,255,0.9);text-align:center;padding:2px;font-size:7px;font-weight:900;color:#111;overflow:hidden;white-space:nowrap;text-overflow:ellipsis">${F.name||"?"}</div>
          <div style="height:50px;display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:900;color:#fff">${W}</div>
        ...
        </div>`,(E=v.querySelector("#pp-close"))==null||E.addEventListener("click",()=>v.remove()),v.querySelectorAll(".pp-item").forEach(F=>{F.addEventListener("click",()=>{const N=F.dataset.cid,W=u.find(J=>J.cardId===N),ce=w.findIndex(J=>J.cardId===N);W&&(ce>-1?w.splice(ce,1):w.length<g&&w.push(W),_())})}),(A=v.querySelector("#pp-confirm"))==null||A.addEventListener("click",()=>{v.remove(),x(w)})}_(),document.body.appendChild(v)}async function Y(u,g){const x=(o["gcCardsFull_"+i]||[]).find(I=>I.id===u),v=(x==null?void 0:x._gcDef)||(o.gcDefs||[]).find(I=>{var E;return I.name===g||((E=I.name)==null?void 0:E.toLowerCase().trim())===(g==null?void 0:g.toLowerCase().trim())}),w=[...o["usedGc_"+i]||[],u],_={type:g,by:i,seq:(o._gcAnimSeq||0)+1};B.add(_.seq),ge(g,i,async()=>{if(v!=null&&v.effect_type&&v.effect_type!=="CUSTOM"){const E=re[v.effect_type];if(E){const A={...o};E(v.effect_params||{},A,async F=>{F["usedGc_"+i]=w,F._lastGC=_,F._gcAnimSeq=_.seq,await ee(F)});return}}const I={...o};switch(g){case"Remplacement+":I.maxSubs=(I.maxSubs||3)+1,I.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const E=r+"Score";I[E]>0&&(I[E]--,I.log.push({text:"🚫 But annulé",type:"info"}));break}}I["usedGc_"+i]=w,I._lastGC=_,I._gcAnimSeq=_.seq,await ee(I)})}function ie(u,g){const h="usedCardIds_"+u,x=new Set(o[h]||[]);g.forEach(v=>x.add(v)),o[h]=[...x]}function q(){for(const u of["p1","p2"]){const g=new Set(o["usedCardIds_"+u]||[]),h=o[u+"Team"];if(h)for(const x of["GK","DEF","MIL","ATT"])(h[x]||[]).forEach(v=>{v.used=g.has(v.cardId)})}}function Z(){var Ze,xt,yt,ht,bt,X;if(o.phase==="reveal")return ae();if(o.phase==="midfield")return he();if(o.phase==="finished")return k();const u=o[i+"Team"],g=o[r+"Team"];q();const h=o[i+"Score"],x=o[r+"Score"],v=o[i+"Name"],w=o[r+"Name"],_=o.phase===i+"-attack",I=o.phase===i+"-defense",E=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],A=E.map(G=>G.cardId),F=window.innerWidth>=700,N=o[i+"Subs"]||[],W=o["usedSubIds_"+i]||[],ce=N.filter(G=>!W.includes(G.cardId)),J=o["gcCardsFull_"+i]||[],H=o["usedGc_"+i]||[],V=J.filter(G=>!H.includes(G.id)),Q=o.boostOwner===i&&!o.boostUsed,de=!["GK","DEF","MIL","ATT"].some(G=>(g[G]||[]).some(oe=>!oe.used)),ue=[...u.MIL||[],...u.ATT||[]].filter(G=>!G.used),fe=_&&de&&ue.length===0?[...u.GK||[],...u.DEF||[]].filter(G=>!G.used).map(G=>G.cardId):[];function me(G,oe,se){var _t,gi;const ye=G._gcDef,Ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ye==null?void 0:ye.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",We={purple:"#b06ce0",light_blue:"#00d4ef"}[ye==null?void 0:ye.color]||"#b06ce0",Je=(ye==null?void 0:ye.name)||G.gc_type,et=(ye==null?void 0:ye.effect)||((_t=Ne[G.gc_type])==null?void 0:_t.desc)||"",Mt=ye!=null&&ye.image_url?`/manager-wars/icons/${ye.image_url}`:null,Ct=((gi=Ne[G.gc_type])==null?void 0:gi.icon)||"⚡",vt=Math.round(se*.22),lt=Math.round(se*.22),wt=se-vt-lt,jt=Je.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${G.id}" data-gc-type="${G.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${u!=null&&u.length?`<div style="display:flex;gap:10px;animation:scoreIn .4s ease 1s both;position:relative;z-index:1">
        ${u.map(F=>`<div style="text-align:center">
          <div style="width:50px;height:50px;border-radius:50%;background:${I[F.job]||"#555"};border:2px solid #FFD700;position:relative;overflow:hidden;margin:0 auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(W);let ce=!1;const J=()=>{ce||(ce=!0,W.remove(),setTimeout(()=>h&&h(),50))};W.addEventListener("click",J),setTimeout(J,3e3)}function O(u,g){var W,ce,J,H;const x=(o["gcCardsFull_"+i]||[]).find(V=>V.id===u),v=x==null?void 0:x._gcDef,w={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",I=(v==null?void 0:v.name)||g,E=(v==null?void 0:v.effect)||((W=Ne[g])==null?void 0:W.desc)||"Carte spéciale.",A=v!=null&&v.image_url?`/manager-wars/icons/${v.image_url}`:null,F=((ce=Ne[g])==null?void 0:ce.icon)||"⚡",N=document.createElement("div");N.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",N.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${_};background:${w};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${_}66">
        ...
        <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${A?`<img src="${A}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${F}</span>`}
        </div>
        <div style="padding:10px;background:rgba(0,0,0,0.38);text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(v);let _=!1;const I=()=>{_||(_=!0,v.remove(),setTimeout(()=>h(),50))};v.addEventListener("click",I),setTimeout(I,2200)}function K(){var g;const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",u.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${o[r+"Name"]}</div>
      <div style="width:min(90vw,420px)">${st(o[r+"Team"],o[r+"Formation"],null,[],300,300)}</div>
      ...
      </div>`,document.body.appendChild(g),(h=g.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>g.remove())}async function te(){if(o.phase!==i+"-attack")return;const u=i==="p1"?"p2":"p1",g=(o.round||0)+1,h=[...o.log||[]];h.push({type:"info",text:`⏭️ ${o[i+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const x=$e(o),v=Te(u),w=x||!v?"finished":u+"-attack";await ee({["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:w,attacker:u,round:g,log:h}),w==="finished"&&await Re(o)}async function we(){const u=o[i+"Team"],g=!["GK","DEF","MIL","ATT"].some(w=>(o[r+"Team"][w]||[]).some(_=>!_.used)),h=(o["selected_"+i]||[]).map(w=>{const _=(u[w._role]||[]).find(W=>W.cardId===w.cardId)||w,I=g&&["GK","DEF"].includes(w._role),E=u[w._role]||[],A=E.findIndex(W=>W.cardId===w.cardId),F=ot(E.length),N=A>=0?F[A]:_._col??1;return{..._,_line:w._role,_col:N,...I?{note_a:Math.max(1,Number(_.note_a)||0)}:{}}});if(!h.length)return;const x=Ht(h,o.modifiers[i]||{});ie(i,h.map(w=>w.cardId)),h.forEach(w=>{const _=(u[w._role]||[]).find(I=>I.cardId===w.cardId);_&&(_.used=!0)}),o["selected_"+i]=[],Z();const v=[...o.log||[]];if(g){const w=(o[i+"Score"]||0)+1,_=h.map(N=>({name:N.name,note:ve(N,N._line||"ATT"),portrait:ze(N),job:N.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:_,homeTotal:x.total,aiTotal:0});const I=(o.round||0)+1,E=i==="p1"?"p2":"p1",A={...o,[i+"Team"]:u,[i+"Score"]:w},F=$e(A);P.add(I),xe(_,w,o[r+"Score"]||0,!0,async()=>{await ee({[i+"Team"]:u,[i+"Score"]:w,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:F?"finished":E+"-attack",attacker:E,round:I,log:v}),F&&await Re({...o,[i+"Score"]:w})});return}v.push({type:"pending",text:`⚔️ ${o[i+"Name"]} attaque (${x.total})`}),await ee({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],pendingAttack:{...x,players:h,side:i},["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},phase:r+"-defense",log:v})}async function _e(){const u=o[i+"Team"],g=(o["selected_"+i]||[]).map(H=>{const V=(u[H._role]||[]).find(me=>me.cardId===H.cardId)||H,Q=u[H._role]||[],de=Q.findIndex(me=>me.cardId===H.cardId),ue=ot(Q.length),fe=de>=0?ue[de]:V._col??1;return{...V,_line:H._role,_col:fe}}),h=Ut(g,o.modifiers[i]||{});ie(i,g.map(H=>H.cardId)),g.forEach(H=>{const V=(u[H._role]||[]).find(Q=>Q.cardId===H.cardId);V&&(V.used=!0)}),o["selected_"+i]=[],Z();const x=Kt(o.pendingAttack.total,h.total,o.modifiers[i]||{}),v=o.pendingAttack.side,w=x==="attack"||(x==null?void 0:x.goal),_=v==="p1"?"p2":"p1",I=(o.round||0)+1,E=(o.pendingAttack.players||[]).map(H=>({name:H.name,note:ve(H,H._line||"ATT"),portrait:ze(H),job:H.job})),A=[...o.log||[]];A.push({type:"duel",isGoal:w,homeScored:w&&v===i,text:w?`⚽ BUT de ${o[v+"Name"]} ! (${o.pendingAttack.total} vs ${h.total})`:`✋ Attaque stoppée (${o.pendingAttack.total} vs ${h.total})`,homePlayers:E,aiPlayers:g.map(H=>({name:H.name,note:ve(H,H._line||"DEF"),portrait:ze(H),job:H.job})),homeTotal:o.pendingAttack.total,aiTotal:h.total});const F=w?(o[v+"Score"]||0)+1:o[v+"Score"]||0,N={...o,[i+"Team"]:u,[v+"Score"]:F},W=$e(N),ce=W?"finished":_+"-attack",J=async()=>{await ee({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],[v+"Score"]:F,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:ce,attacker:_,round:I,log:A}),(ce==="finished"||W)&&await Re({...o,[v+"Score"]:F})};if(w){const H=v===i,V=H?F:o[i+"Score"]||0,Q=H?o[r+"Score"]||0:F;P.add(I),xe(E,V,Q,H,J)}else await J()}function ke(u){return["MIL","ATT"].some(g=>(u[g]||[]).some(h=>!h.used))}function Se(u){return["GK","DEF","MIL","ATT"].some(g=>(u[g]||[]).some(h=>!h.used))}function Ee(u){return Se(u)&&!ke(u)}function Te(u){const g=o[u+"Team"],h=o[(u==="p1"?"p2":"p1")+"Team"];return!!(ke(g)||!Se(h)&&Ee(g))}function $e(u){const g=["MIL","ATT"].some(A=>(u.p1Team[A]||[]).some(F=>!F.used)),h=["MIL","ATT"].some(A=>(u.p2Team[A]||[]).some(F=>!F.used)),x=Se(u.p1Team),v=Se(u.p2Team);return!g&&!(!v&&x)&&(!h&&!(!x&&v))}function qe(u){const g=u.p1Score||0,h=u.p2Score||0;return g===h?null:g>h?y.home_id:y.away_id}async function Re(u){try{const g=qe(u),h=g?y.home_id===g?y.away_id:y.home_id:null;await $.from("matches").update({status:"finished",winner_id:g,home_score:u.p1Score||0,away_score:u.p2Score||0}).eq("id",n),g&&h&&Pi(g,h).catch(()=>{})}catch(g){console.error("[PvP] finishMatch:",g)}}function k(){var v;const u=o[i+"Score"],g=o[r+"Score"],h=u>g,x=u===g;Xe(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let p="buy";const i=()=>{var o,b,T,L,S,P,B;return{name:(((o=document.getElementById("flt-name"))==null?void 0:o.value)||"").toLowerCase().trim(),club:(((b=document.getElementById("flt-club"))==null?void 0:b.value)||"").toLowerCase().trim(),country:(((T=document.getElementById("flt-country"))==null?void 0:T.value)||"").toLowerCase().trim(),job:((L=document.getElementById("flt-job"))==null?void 0:L.value)||"",rarity:((S=document.getElementById("flt-rarity"))==null?void 0:S.value)||"",note1:parseInt((P=document.getElementById("flt-note1"))==null?void 0:P.value)||0,note2:parseInt((B=document.getElementById("flt-note2"))==null?void 0:B.value)||0}};function r(o){const b=i();return o.filter(T=>{var ee,le;const L=(ee=T.card)==null?void 0:ee.player;if(!L)return!1;const S=`${L.firstname} ${L.surname_encoded}`.toLowerCase(),P=(((le=L.clubs)==null?void 0:le.encoded_name)||"").toLowerCase(),B=(L.country_code||"").toLowerCase(),j=ct(L,L.job),R=L.job2?ct(L,L.job2):0;return!(b.name&&!S.includes(b.name)||b.club&&!P.includes(b.club)||b.country&&!B.includes(b.country)||b.job&&L.job!==b.job||b.rarity&&L.rarity!==b.rarity||b.note1&&j<b.note1||b.note2&&R<b.note2)})}function f(o){var P,B,j;const b=(P=o.card)==null?void 0:P.player;if(!b)return"";const T=ct(b,b.job),L=b.job2?ct(b,b.job2):0,S=(n.profile.credits||0)>=o.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ii(b.rarity)}
      ${qt(T,b.job)}
      ${qt(L,b.job2||null)}
      ${Li(b.country_code)}
    ...
    </div>`}function m(o){var P,B,j;const b=(P=o.card)==null?void 0:P.player;if(!b)return"";const T=ct(b,b.job),L=b.job2?ct(b,b.job2):0,S=o.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${S?"opacity:0.7":""}">
      ${Ii(b.rarity)}
      ${qt(T,b.job)}
      ${qt(L,b.job2||null)}
      ${Li(b.country_code)}
    ...
    </div>`}function y(){const o=document.getElementById("mkt-content"),b=document.getElementById("mkt-filters");if(o){if(b.style.display=p==="buy"?"flex":"none",p==="buy"){const T=r(s);o.innerHTML=T.length?T.map(f).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const T=l.filter(S=>S.status==="active").sort((S,P)=>new Date(P.listed_at)-new Date(S.listed_at)),L=l.filter(S=>S.status==="sold").sort((S,P)=>new Date(P.sold_at||P.listed_at)-new Date(S.sold_at||S.listed_at));o.innerHTML=(T.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${T.length})</div>`+T.map(m).join(""):"")+(L.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${L.length})</div>`+L.map(m).join(""):"")+(!T.length&&!L.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}o.querySelectorAll("[data-buy]").forEach(T=>T.addEventListener("click",()=>Co(T.dataset.buy,s,e,t))),o.querySelectorAll("[data-cancel]").forEach(T=>T.addEventListener("click",()=>Bo(T.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(o=>{o.addEventListener("click",()=>{p=o.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(b=>{const T=b===o;b.style.background=T?"var(--green)":"#fff",b.style.color=T?"#fff":"var(--gray-600)",b.style.borderColor=T?"var(--green)":"var(--gray-200)"}),y()})});let z;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(o=>{var b;(b=document.getElementById(o))==null||b.addEventListener("input",()=>{clearTimeout(z),z=setTimeout(y,250)})}),y()}async function Co(e,t,n,a){const{state:c,toast:d,refreshProfile:s}=a,l=t.find(r=>r.id===e);if(!l)return;const p=l.price;if((c.profile.credits||0)<p){d("Crédits insuffisants","error");return}jo(l,async()=>{const{error:r}=await $.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:c.profile.id});if(r){d("Erreur achat : "+r.message,"error");return}await s();const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(c.profile.credits||0).toLocaleString("fr")}`),d("✅ Carte achetée !","success"),await fi(n,a)})}function jo(e,t){var s;const n=(s=e.card)==null?void 0:s.player,a=n?`${n.firstname} ${n.surname_encoded}`:"cette carte",c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",c.innerHTML=`
  ...
  </div>`}ln(pn);const Ae={user:null,profile:null,page:"home",params:{}};function kt(e,t="info",n=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},n))}function qo(e,t,n=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=n,document.getElementById("modal-overlay").classList.remove("hidden")}function ni(){document.getElementById("modal-overlay").classList.add("hidden")}async function Et(){if(!Ae.user)return;const{data:e}=await $.from("users").select("*").eq("id",Ae.user.id).single();e&&(Ae.profile=e)}function Nt(e,t={}){Ae.page=e,Ae.params=t,sn()}async function sn(){var a,c;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===Ae.page)});const t=document.getElementById("nav-credits");t&&Ae.profile&&(t.textContent=`💰 ${(Ae.profile.credits||0).toLocaleString("fr")}`);const n={state:Ae,navigate:Nt,toast:kt,openModal:qo,closeModal:ni,refreshProfile:Et};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',Ae.page){case"home":await hi(e,n);break;case"collection":await Cn(e,n);break;case"decks":await Zt(e,n);break;case"boosters":await Vn(e,n);break;case"match":{const d=Ae.params&&Ae.params.matchMode||"vs_ai_easy";d==="random"?await rn(e,n):d==="friend"?await Io(e,n,(a=Ae.params)==null?void 0:a.friendId,(c=Ae.params)==null?void 0:c.friendName):await lo(e,n);break}case"market":await Mo(e,n);break;case"rankings":await Fo(e,n);break;case"matches":await Do(e,n);break;case"friends":await hn(e,n);break;default:await hi(e,n)}}function Go(){var a;const e=document.getElementById("app"),t=Ae.profile;if(!t)return;const n="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
