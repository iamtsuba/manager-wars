...
import{s as w,l as Ot,m as Mi,F as ji,r as Se,j as ei,h as Ci,n as Pn,o as Gn,T as yi,k as Rn,p as Nn,b as On}from"./formation-links-CZYKSMms.js";const Hn="/";function Wi(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,l,c,d,x;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var m;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),x=((m=document.getElementById("setup-club"))==null?void 0:m.value)||"MW",y=x.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():x.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),d&&(d.textContent=g,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:x}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(x){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:x}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(x){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),x=document.getElementById("step3-error"),y=document.getElementById("step3-finish");x.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Kn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){x.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Kn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Vn="modulepreload",Yn=function(e){return"/"+e},Xi={},un=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(l=>{if(l=Yn(l),l in Xi)return;Xi[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const x=document.createElement("link");if(x.rel=c?"stylesheet":Vn,c||(x.as="script"),x.crossOrigin="",x.href=l,s&&x.setAttribute("nonce",s),document.head.appendChild(x),c)return new Promise((y,g)=>{x.addEventListener("load",y),x.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Yt="#1A6B3C",Wt="#cc2222",Wn="#D4A017",Ji="#888";async function Xn(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${y.map(({friendshipId:g,friend:m})=>Jn(m,g)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>Zn(e,g.dataset.stats,g.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const m=g.dataset.friendId,p=g.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:b}=await w.from("friend_match_invites").select("id").eq("inviter_id",m).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),v=!!b;console.log("[Friends] clic match",{fid:m,fname:p,isAccepting:v}),n("match",{matchMode:"friend",friendId:m,friendName:p,isAccepting:v})})})}function Jn(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||Yt,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,l=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    </div>`}function Qn(e,t){const i=Bi();i.innerHTML=`
    <div class="popup-box">
    ...
    ${qi()}`,document.body.appendChild(c);const x=()=>c.remove();c.querySelector("#pending-close").addEventListener("click",x),c.addEventListener("click",y=>{y.target===c&&x()}),c.querySelectorAll("[data-accept]").forEach(y=>{y.addEventListener("click",async()=>{const{error:g}=await w.from("friendships").update({status:"accepted"}).eq("id",y.dataset.accept);if(g){t("Erreur : "+g.message,"error");return}y.closest("div[style]").remove(),t("✅ Ami accepté !","success"),fn(e,t,n),i&&i()})}),c.querySelectorAll("[data-decline]").forEach(y=>{y.addEventListener("click",async()=>{await w.from("friendships").delete().eq("id",y.dataset.decline),y.closest("div[style]").remove(),t("Demande refusée","info"),i&&i()})})}async function Zn(e,t,i){const n=e.user.id,[r,o]=[n,t].sort(),a=n===r,{data:s}=await w.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",o).single(),l=e.profile.club_name||e.profile.pseudo||"Moi",c=s||{},d=a?c.wins_p1||0:c.wins_p2||0,x=a?c.wins_p2||0:c.wins_p1||0,y=c.draws||0,g=a?c.goals_p1||0:c.goals_p2||0,m=a?c.goals_p2||0:c.goals_p1||0,p=a?c.gc_used_p1||0:c.gc_used_p2||0,u=a?c.gc_used_p2||0:c.gc_used_p1||0,b=c.matches_total||0,v=($,f,M,k=Yt,P=Wt)=>`
    ...
    ${qi()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",$=>{$.target===h&&h.remove()})}function Bi(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function qi(){return`
    <style>
      .popup-box {
    ...
    </style>`}const eo="2026.07.19-1839";async function Qi(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  </div>`,document.body.appendChild(i),i.querySelectorAll(".diff-card").forEach(r=>{r.addEventListener("mouseenter",()=>{r.style.transform="translateY(-1px)",r.style.boxShadow="0 6px 16px -6px rgba(0,0,0,0.18)"}),r.addEventListener("mouseleave",()=>{r.style.transform="",r.style.boxShadow=""})});const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",r=>{r.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(r=>{r.addEventListener("click",()=>{n(),e("match",{matchMode:r.dataset.mode})})})}const Ce={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Ge(e,t){if(!e)return 0;let i=0;switch(t){case"GK":i=Number(e.note_g)||0;break;case"DEF":i=Number(e.note_d)||0;break;case"MIL":i=Number(e.note_m)||0;break;case"ATT":i=Number(e.note_a)||0;break;default:i=0}return i+(e.boost||0)}const Zi=["ATT","MIL","DEF","GK"];function yn(e,t,i){if(!e||!t)return!1;if(i&&e.position&&t.position)return Mi(i).some(([d,x])=>d===e.position&&x===t.position||d===t.position&&x===e.position);const n=e._col!=null&&t._col!=null&&e._col===t._col,r=e._col!=null&&t._col!=null&&Math.abs(e._col-t._col)===1,o=Zi.indexOf(e._line||e.job),a=Zi.indexOf(t._line||t.job),s=Math.abs(o-a)===1;return(e._line||e.job)===(t._line||t.job)&&r||n&&s}function bn(e,t){let i=0;const n=e.length;for(let r=0;r<n;r++)for(let o=r+1;o<n;o++){const a=e[r],s=e[o];if(!a||!s||!yn(a,s,t))continue;const l=Ot(a,s);l==="#00ff88"?i+=10:l==="#FFD700"&&(i+=5)}return i}function Xt(e,t={},i){let n=0,r=0;e.forEach(l=>{const c=l._line||l.job,d=Number(c==="MIL"?l.note_m:l.note_a)||0,x=l.stadiumBonus&&(c==="MIL"||c==="ATT")?10:0;n+=t.doubleAttack?d*2:d,r+=(l.boost||0)+x});const o=n+r,a=bn(e,i);let s=o+a;return t.stolenNote&&(s-=t.stolenNote),{base:o,links:a,total:Math.max(0,s)}}function Jt(e,t={},i){const n=e.reduce((a,s)=>{const l=s._line||s.job;let c=0;l==="GK"?c=Number(s.note_g)||0:l==="MIL"?c=Number(s.note_m)||0:c=Number(s.note_d)||0;const d=s.stadiumBonus&&(l==="GK"||l==="DEF"||l==="MIL")?10:0;return a+c+(s.boost||0)+d},0),r=bn(e,i);let o=n+r;return t.stolenNote&&(o-=t.stolenNote),{base:n,links:r,total:Math.max(0,o)}}function Di(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function hn(e,t,i="easy"){const n=e.filter(a=>!a.used);if(!n.length)return[];const r=[...n].sort((a,s)=>{const l=t==="attack"?Ge(a,"ATT"):a._line==="GK"?Ge(a,"GK"):Ge(a,"DEF");return(t==="attack"?Ge(s,"ATT"):s._line==="GK"?Ge(s,"GK"):Ge(s,"DEF"))-l});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return r.slice(0,Math.min(o,r.length,3))}function ao(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const so={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function lo(e,t){const i=e.player;if(!i)return 0;const n=i.rarity;if(n!=="pepite"&&n!=="papyte")return Number(i[t])||0;const r=vn(i),o=Number(i[t])||0;if(o<=0)return 0;const a=i.note_min??1,s=i.note_max??10,c=(e.current_note??r)-r;return Math.min(s,Math.max(a,o+c))}function vn(e){const t=e.job||"ATT";return Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}async function co(e,t){!e||!t||await Promise.all([en(e,"win"),en(t,"loss")])}async function en(e,t){const{data:i}=await w.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",e).eq("card_type","player");if(!(i!=null&&i.length))return;const n=i.filter(r=>{var o,a;return((o=r.player)==null?void 0:o.rarity)==="pepite"||((a=r.player)==null?void 0:a.rarity)==="papyte"});n.length&&await Promise.all(n.map(r=>{const o=so[r.player.rarity],a=t==="win"?o.win:o.loss,s=r.player.note_min??1,l=r.player.note_max??10,c=vn(r.player),d=r.current_note??c,x=Math.min(l,Math.max(s,d+a));return w.from("cards").update({current_note:x}).eq("id",r.id)}))}const po={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},bi={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},ti=["GK","DEF","MIL","ATT"],uo=["Tous","GK","DEF","MIL","ATT"],fo={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function tn(e){const t=e.player;if(!t)return null;const i=t.rarity;return(i==="pepite"||i==="papyte")&&e.current_note!=null?e.current_note:Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function go(e){return e.length?e.reduce((t,i)=>tn(i)>tn(t)?i:t,e[0]):e[0]}function mo(e){return e==="GK"?"note_g":e==="DEF"?"note_d":e==="MIL"?"note_m":"note_a"}const xo={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function yo(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function hi(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function vi(e,t=""){const i=e.player;if(!i)return"";const n=e.evolution_bonus||0,r={...i,_evolution_bonus:n},o=t?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${t}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${e.id}">
    ${o}
    ${Se(r,{width:140})}
  </div>`}function nn(e){return`<div style="display:inline-block;filter:grayscale(1);opacity:0.4">
    ${Se(e,{width:140})}
  </div>`}async function bo(e,t){const{state:i,navigate:n,toast:r,openModal:o,closeModal:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await w.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price, stadium_id, evolution_bonus,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(S=>S.card_type==="player"&&S.player),d=(s||[]).filter(S=>S.card_type==="game_changer"),x=(s||[]).filter(S=>S.card_type==="formation"),y=(s||[]).filter(S=>S.card_type==="stadium"),{data:g}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),m={};(g||[]).forEach(S=>{m[S.name]=S});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(S=>{u[S.id]=S}),y.forEach(S=>{S.stadium_def&&(u[S.stadium_id]=S.stadium_def)});const b=Object.keys(ji),v=Object.keys(Ce),h={};c.forEach(S=>{const D=S.player.id;h[D]=(h[D]||0)+1}),new Set(Object.keys(h).map(S=>String(S)));const $=new Set(x.map(S=>S.formation)),f=new Set(d.map(S=>S.gc_type));let M="player",k="Tous",P="",H=!1;function ae(){return[...c].sort((S,D)=>{const Y=ti.indexOf(S.player.job),Q=ti.indexOf(D.player.job);return Y!==Q?Y-Q:(S.player.surname_real||"").localeCompare(D.player.surname_real||"")})}function re(){return[...l||[]].sort((S,D)=>{const Y=ti.indexOf(S.job),Q=ti.indexOf(D.job);return Y!==Q?Y-Q:(S.surname_real||"").localeCompare(D.surname_real||"")})}function te(){return ae().filter(S=>{const D=S.player,Y=k==="Tous"||D.job===k,Q=!P||`${D.firstname} ${D.surname_real}`.toLowerCase().includes(P);return Y&&Q})}function j(){return re().filter(S=>{const D=k==="Tous"||S.job===k,Y=!P||`${S.firstname} ${S.surname_real}`.toLowerCase().includes(P);return D&&Y})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function L(){const S=document.getElementById("col-filters");S&&(M==="player"?(S.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",D=>{P=D.target.value.toLowerCase(),V()}),e.querySelectorAll(".filter-btn").forEach(D=>{D.addEventListener("click",()=>{k=D.dataset.job,L(),V()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{H=!H,L(),V()})):(S.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{H=!H,L(),V()})))}function V(){const S=document.getElementById("col-grid");S&&(M==="player"?pe(S):M==="formation"?G(S):M==="stadium"?N(S):K(S))}function ie(S,D,Y,Q,R){const C=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!C||!O)return;var ce=0;function ke(){const _e=window.innerWidth>=768,be=document.getElementById("col-big"),Ee=document.getElementById("col-grid");_e&&be&&(be.style.minHeight="420px",be.style.flex="1 1 auto"),_e&&Ee&&(Ee.style.height=Math.round(310*.76+16)+"px",Ee.style.flexShrink="0",Ee.style.overflowX="auto",Ee.style.overflowY="hidden",Ee.style.alignItems="center",Ee.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+D(S[ce])+"</div>";var Te=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Te&&Te.addEventListener("click",function(){Q(S[ce])}),requestAnimationFrame(function(){var he=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!he||!O)){var ze=O.clientHeight-8,Fe=O.clientWidth-24,je=he.offsetHeight,Re=he.offsetWidth;if(je>0&&Re>0&&ze>40){var tt=_e?2.2:1.6,He=Math.min(ze/je,Fe/Re,tt);he.style.transform="scale("+He.toFixed(3)+")",he.style.transformOrigin="top center"}}}),C.innerHTML=S.map(function(he,ze){var Fe=ze===ce,je="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Fe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+ze+'" style="'+je+'">'+Y(he,Fe)+"</div>"}).join(""),C.querySelectorAll(".col-mini-item").forEach(function(he){he.addEventListener("click",function(){ce=Number(he.dataset.idx),ke(),he.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}ke()}function ue(S){var D=window.innerWidth>=768?.76:.54,Y;if(!S||S._fake){var Q=S?S.player:null;if(!Q)return"";Y=nn(Q)}else Y=vi(S,"");return'<div style="display:inline-block;zoom:'+D+';pointer-events:none;line-height:0">'+Y+"</div>"}function ge(S,D,Y){D=D||100,Y=Y||140;var Q=ei[S]||{},R={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},C=Math.max(3,Math.round(D*.06)),O=Object.entries(Q).map(function(ke){var _e=ke[0],be=ke[1],Ee=_e.replace(/\d+$/,""),Te=R[Ee]||"#888",he=Math.round(be.x*D),ze=Math.round(be.y*Y);return'<circle cx="'+he+'" cy="'+ze+'" r="'+C+'" fill="'+Te+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),ce=Math.max(1,Math.round(D/50));return'<svg viewBox="0 0 '+D+" "+Y+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+D+'" height="'+Y+'" fill="#1A6B3C"/><rect x="'+Math.round(D*.2)+'" y="'+Math.round(Y*.02)+'" width="'+Math.round(D*.6)+'" height="'+Math.round(Y*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/><line x1="0" y1="'+Math.round(Y*.5)+'" x2="'+D+'" y2="'+Math.round(Y*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><ellipse cx="'+Math.round(D*.5)+'" cy="'+Math.round(Y*.5)+'" rx="'+Math.round(D*.18)+'" ry="'+Math.round(Y*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><rect x="'+Math.round(D*.2)+'" y="'+Math.round(Y*.82)+'" width="'+Math.round(D*.6)+'" height="'+Math.round(Y*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/>'+O+"</svg>"}function I(S,D,Y){var Q=Y>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+Y+"</div>":"",R=D?'data-form-id="'+D.id+'"':"",C=S.length>7?14:S.length>5?16:19,O=!!D;return"<div "+R+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+Q+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+C+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+S+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+ge(S,140,220)+"</div></div>"}function W(S,D){var Y=window.innerWidth>=768?.76:.54,Q=140,R=305,C=Math.round(R*.22),O=R-C,ce=S.length>7?10:13,ke=ge(S,Q,O),_e=D?"1.5px solid #2a7a40":"1px solid #ddd",be=D?"":"filter:grayscale(1);opacity:0.45;",Ee=D?"#1A6B3C":"#bbb",Te="#fff";return'<div style="display:inline-block;zoom:'+Y+';line-height:0;pointer-events:none"><div style="width:'+Q+"px;height:"+R+"px;border-radius:6px;border:"+_e+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+be+'"><div style="height:'+C+"px;background:"+Ee+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+ce+"px;font-weight:900;color:"+Te+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(Q-4)+'px">'+S+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+ke+"</div></div></div>"}function pe(S){if(H){const D=j();if(!D.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const Y=D.map(Q=>c.find(R=>R.player.id===Q.id)||{_fake:!0,player:Q,id:"fake-"+Q.id});ie(Y,Q=>Q._fake?nn(Q.player):vi(Q,""),Q=>Q._fake?ue({player:Q.player,id:"x",_fake:!0}):ue(Q),Q=>{Q._fake||on(Q,c,h,t)})}else{const D=te();if(!D.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const Y={};D.forEach(R=>{const C=R.player.id;Y[C]||(Y[C]=[]),Y[C].push(R)});const Q=Object.values(Y).map(R=>go(R));ie(Q,R=>{const C=h[R.player.id]||1,O=C>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${C}</div>`:"",ke=c.filter(_e=>_e.player.id===R.player.id&&_e.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return vi(R,O+ke)},R=>ue(R),R=>on(R,c,h,t))}}function G(S){const D=H?b:[...$];if(!D.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const Y=D.map(Q=>({formation:Q,card:x.find(R=>R.formation===Q)||null,owned:$.has(Q)}));ie(Y,({formation:Q,card:R,owned:C})=>I(Q,C?R:null,C?x.filter(O=>O.formation===Q).length:0),({formation:Q,owned:R})=>W(Q,R),({card:Q,owned:R})=>{R&&Q&&vo(Q,x,t,o)})}function K(S){const D=Object.keys(m),Y=H?D.length?D:v:[...f];if(!Y.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Q=Y.map(R=>({type:R,gc:Ce[R]||{icon:"⚡",desc:""},def:m[R]||null,owned:f.has(R),card:d.find(C=>C.gc_type===R)||null}));ie(Q,({type:R,gc:C,def:O,owned:ce,card:ke})=>{var tt;const _e=ce?d.filter(He=>He.gc_type===R).length:0,be=_e>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${_e}</div>`:"",Ee=(O==null?void 0:O.gc_type)==="ultra_game_changer",Te={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},he={purple:"#b06ce0",light_blue:"#00d4ef"},ze=Te[O==null?void 0:O.color]||Te.purple,Fe=he[O==null?void 0:O.color]||he.purple,je=(O==null?void 0:O.effect)||C.desc||"",Re=O!=null&&O.image_url?`/icons/${O.image_url}`:((tt=O==null?void 0:O.club)==null?void 0:tt.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return ce&&ke?`<div data-gc-id="${ke.id}" data-gc-type="${R}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Fe};background:${ze};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Fe}66;cursor:pointer">
          ${be}
        ...
        </div>`},({type:R,gc:C,def:O,owned:ce})=>{const ke=window.innerWidth>=768?.76:.54,_e={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},be={purple:"#9b59b6",light_blue:"#00bcd4"},Ee=_e[O==null?void 0:O.color]||_e.purple,Te=be[O==null?void 0:O.color]||be.purple,he=O!=null&&O.image_url?`/icons/${O.image_url}`:null;return ce?`<div style="display:inline-block;zoom:${ke};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${Ee};border:1px solid ${Te};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${R}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${he?`<img src="${he}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${C.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((O==null?void 0:O.effect)||C.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${ke};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${C.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${R}</span></div></div>`},({type:R,owned:C,def:O})=>{C&&ho(R,O,o)})}function N(S){const D="#E87722",Y="/";if(!y.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Q={};y.forEach(C=>{const O=C.stadium_id||"?";(Q[O]=Q[O]||[]).push(C)});const R=Object.entries(Q).map(([C,O])=>({sid:C,def:u[C]||null,count:O.length,card:O[0]}));ie(R,({def:C,count:O})=>{var Te,he;const ce=(C==null?void 0:C.name)||"?",ke=((Te=C==null?void 0:C.club)==null?void 0:Te.encoded_name)||(C==null?void 0:C.country_code)||"—",_e=C!=null&&C.image_url?`${Y}icons/${C.image_url}`:((he=C==null?void 0:C.club)==null?void 0:he.logo_url)||(C!=null&&C.country_code?`https://flagsapi.com/${C.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),be=_e?`<img src="${_e}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',Ee=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${D},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${D}66">
          ${Ee}
        ...
        </div>`},({def:C,count:O})=>{var Te,he;const ce=window.innerWidth>=768?.76:.54,ke=(C==null?void 0:C.name)||"?",_e=((Te=C==null?void 0:C.club)==null?void 0:Te.encoded_name)||(C==null?void 0:C.country_code)||"—",be=C!=null&&C.image_url?`${Y}icons/${C.image_url}`:((he=C==null?void 0:C.club)==null?void 0:he.logo_url)||(C!=null&&C.country_code?`https://flagsapi.com/${C.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Ee=be?`<img src="${be}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${ce};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(S=>{S.addEventListener("click",()=>{M=S.dataset.tab,k="Tous",P="",H=!1,e.querySelectorAll(".col-tab-btn").forEach(D=>{const Y=D.dataset.tab===M;D.style.borderBottomColor=Y?"var(--green)":"transparent",D.style.color=Y?"var(--green)":"var(--gray-600)"}),L(),V()})}),L(),V()}function ho(e,t,i){const n=Ce[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,x=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ii=1e3;function vo(e,t,i,n){var m,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function x(){const b=ei[c]||{},v=ji[c]||[],h=290,$=360,f=20;function M(P){const H=b[P];return H?{x:H.x*h,y:H.y*$}:null}let k=`<svg width="${h}" height="${$}" viewBox="0 0 ${h} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,H]of v){const ae=M(P),re=M(H);!ae||!re||(k+=`<line x1="${ae.x}" y1="${ae.y}" x2="${re.x}" y2="${re.y}"
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${x.map((G,K)=>{const N=te[G.id]||[],S=G.is_for_sale,D=N.length?N[N.length-1]:null,Q=(d.rarity==="pepite"||d.rarity==="papyte")&&G.current_note!=null?` (☆${G.current_note})`:"";return`
            <div data-card-id="${G.id}" data-card-idx="${K}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <input type="checkbox" class="expl-check" data-id="${G.id}" ${S?"disabled":""} style="width:18px;height:18px;cursor:pointer;accent-color:#1A6B3C;flex-shrink:0">
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${K+1}${Q}${S?" 🏷️ En vente":""}</div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([G,K])=>{const N=bi[G],S=G==="GK"?"#fff":N,D=G===d.job||G===d.job2,Y=(Number(K)||0)+(D&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${N};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${S};font-family:Arial Black,Arial;line-height:1">${Y}</span>
                </div>
                <span style="font-size:10px;font-weight:700;color:${S}">${G}</span>
              </div>`}).join("")}
          </div>
        </div>
        <div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ge=document.getElementById("close-detail"))==null||ge.addEventListener("click",s);let V=new Set;const ie=()=>{const G=V.size,K=document.getElementById("sell-action-panel");if(!K)return;K.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G;const N=document.getElementById("evolve-btn");N&&(N.textContent=`⬆️ Évoluer ${G>1?"(+"+G+")":""}`)};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const K=G.dataset.id;G.checked?V.add(K):V.delete(K);const N=G.closest(".exemplaire-row");N&&(N.style.borderColor=G.checked?"#1A6B3C":"#eee"),ie()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",K=>{if(K.target.closest("button")||K.target.tagName==="INPUT")return;const N=G.querySelector(".expl-check");N&&!N.disabled&&(N.checked=!N.checked,N.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",K=>{K.stopPropagation();const N=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);N&&(N.style.display=N.style.display==="none"?"flex":"none")})}),(I=document.getElementById("evolve-btn"))==null||I.addEventListener("click",async()=>{if(y<=1)return;const G=[...V];if(!G.length)return;if(V.has(e.id)){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",R.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const r=n.querySelector("#pm-input");r.focus(),r.select();const o=a=>{n.remove(),i(a)};n.querySelector("#pm-ok").addEventListener("click",()=>o(r.value.trim()||null)),n.querySelector("#pm-cancel").addEventListener("click",()=>o(null)),n.querySelector("#pm-cancel2").addEventListener("click",()=>o(null)),n.addEventListener("click",a=>{a.target===n&&o(null)}),r.addEventListener("keydown",a=>{a.key==="Enter"&&o(r.value.trim()||null),a.key==="Escape"&&o(null)})})}function wo(e,t=!1){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:380px">
    ...
    </div>`,document.body.appendChild(n);const r=o=>{n.remove(),i(o)};n.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),n.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),n.addEventListener("click",o=>{o.target===n&&r(!1)})})}const ri={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function ki(e,t){const{state:i,navigate:n,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await w.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const a=await rn("Nom du deck",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!a)return;const{data:s,error:l}=await w.from("decks").insert({owner_id:i.profile.id,name:a}).select().single();if(l){r(l.message,"error");return}r("Deck créé !","success"),an(s.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(a=>{a.addEventListener("click",()=>an(a.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(a=>{a.addEventListener("click",async()=>{const s=await rn("Nouveau nom",a.dataset.name);if(!s||s===a.dataset.name)return;const{error:l}=await w.from("decks").update({name:s}).eq("id",a.dataset.rename);if(l){r(l.message,"error");return}r("Deck renommé !","success"),ki(e,t)})}),e.querySelectorAll("[data-delete]").forEach(a=>{a.addEventListener("click",async()=>{if(!await wo(`Supprimer le deck "${a.dataset.name}" ? Cette action est irréversible.`,!0))return;await w.from("deck_cards").delete().eq("deck_id",a.dataset.delete);const{error:s}=await w.from("decks").delete().eq("id",a.dataset.delete);if(s){r(s.message,"error");return}r("Deck supprimé.","success"),ki(e,t)})})}async function an(e,t,i){const{state:n,toast:r}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await w.from("decks").select("*").eq("id",e).single(),{data:a}=await w.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body" style="padding-bottom:20px">
  ...
  </div>`;const d=window.innerWidth>=900,x=e.querySelector(".deck-pc-layout"),y=e.querySelector(".deck-mobile-layout");x&&(x.style.display=d?"block":"none"),y&&(y.style.display=d?"none":"block"),_o(e,t,r,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const g=()=>{const{openModal:u,closeModal:b}=i,v=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;u("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const $=sn(t.formation),f={};$.forEach(M=>{t.slots[M]&&(f[M]=t.slots[M])}),t.slots=f,b(),wt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",g)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>ko(t,e,i))),e.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>To(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==u.dataset.removeSub),wt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>Eo(t,e,i)))}function _o(e,t,i,n){var h,$;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=t.stadiumCards)==null?void 0:h.find(f=>f.id===t.stadiumCardId),s=a&&(($=t.stadDefMap)==null?void 0:$[a.stadium_id])||null,l=ei[t.formation]||{},c=Mi(t.formation)||[],d={};for(const f of i){const M=t.slots[f],k=M?t.playerCards.find(P=>P.id===M):null;k!=null&&k.player?d[f]={...k.player,_evolution_bonus:k.evolution_bonus||0,face:k.player.face||null}:d[f]=null}const x=window.innerWidth>=900,y=x?window.innerWidth-280:window.innerWidth-20,g=x?Math.min(y,860):y,m=Math.round(x?g*.82:g*.85),p=x?84:44;let u="";for(const[f,M]of c){const k=l[f],P=l[M];if(!k||!P)continue;const H=k.x*g,ae=Math.round(.03*m+k.y*.85*m),re=P.x*g,te=Math.round(.03*m+P.y*.85*m),j=d[f],L=d[M],V=Ot(j,L);V==="#ff3333"||V==="#cc2222"?u+=`<line x1="${H.toFixed(1)}" y1="${ae.toFixed(1)}" x2="${re.toFixed(1)}" y2="${te.toFixed(1)}" stroke="${V}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${H.toFixed(1)}" y1="${ae.toFixed(1)}" x2="${re.toFixed(1)}" y2="${te.toFixed(1)}" stroke="${V}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${H.toFixed(1)}" y1="${ae.toFixed(1)}" x2="${re.toFixed(1)}" y2="${te.toFixed(1)}" stroke="${V}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const v=Math.round(p*657/507);for(const f of i){const M=l[f];if(!M)continue;const k=d[f],P=M.x*g;M.y*m;const H=Math.round(.03*m+M.y*(.85*m)),ae=Math.round(P-p/2),re=Math.round(H-v/2);if(k){const te=f.replace(/\d+/,""),j=s&&(s.club_id&&String(k.club_id)===String(s.club_id)||s.country_code&&k.country_code===s.country_code),L=Se({...k,_evolution_bonus:k._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:te});b+=`<div style="position:absolute;left:${ae}px;top:${re}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${f}">
      ...
      </div>`}else{const te=f.replace(/\d+/,"");b+=`<div style="position:absolute;left:${ae}px;top:${re}px;width:${p}px;height:${v}px;
    ...
    <div style="position:relative;width:${g}px;height:${m}px;margin:0 auto">
      ...
      ${b}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(f=>{f.addEventListener("click",()=>$o(f.dataset.pos,t,e,n))})}function ko(e,t,i){var a;const{openModal:n,closeModal:r}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(y=document.getElementById("close-sub-selector"))==null||y.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{e.subs.push(g.dataset.cardId),r(),wt(t,e,i)})})}async function To(e,t){const{state:i,toast:n,navigate:r}=t,o=e.formationCards.find(l=>l.formation===e.formation),a=(o==null?void 0:o.id)||e.formationCardId;await w.from("decks").update({formation:e.formation,formation_card_id:a||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await w.from("deck_cards").delete().eq("deck_id",e.deckId);const s=[];if(Object.entries(e.slots).forEach(([l,c],d)=>{s.push({deck_id:e.deckId,card_id:c,position:l,is_starter:!0,slot_order:d})}),e.subs.forEach((l,c)=>{s.push({deck_id:e.deckId,card_id:l,position:`SUB${c+1}`,is_starter:!1,slot_order:100+c})}),s.length>0){const{error:l}=await w.from("deck_cards").insert(s);if(l){n(l.message,"error");return}}n("Deck enregistré ✅","success"),r("decks")}function sn(e){const t=ri[e]||ri["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}async function wn(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await w.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const n=i.filter(a=>!(a.available_from&&t<a.available_from||a.available_until&&t>a.available_until));if(!n.length)return[];let r=n;if(e){const a=n.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await w.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",a.map(c=>c.id)),l={};(s||[]).forEach(c=>{l[c.booster_id]=(l[c.booster_id]||0)+1}),r=n.filter(c=>c.max_per_user==null?!0:(l[c.id]||0)<c.max_per_user)}}if(!r.length)return[];const{data:o}=await w.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(o||[]).filter(s=>s.booster_id===a.id)}))}async function Lo(e,t){const{data:i}=await w.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await w.from("booster_claims").insert({user_id:e,booster_id:t})}function zo(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,r)=>n+Number(r.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const _n=()=>Object.keys(ei),Io=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],$i={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Ao(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return Se({...t,_evolution_bonus:i},{width:140})}function kn(e){var r;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((r=Object.entries(t).sort((o,a)=>a[1]-o[1])[0])==null?void 0:r[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function So(e,{state:t,navigate:i,toast:n}){var x,y,g;const r=((x=t.profile)==null?void 0:x.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await wn((y=t.user)==null?void 0:y.id)).map(kn)}catch(m){console.warn("Erreur chargement boosters DB, fallback hardcodé",m)}o.length||(o=Io.map(m=>({...m,rates:[],isPub:m.id==="players_pub"})));const a=await w.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(m=>m.data||[]),s=new Set(a.filter(m=>m.card_type==="stadium").map(m=>m.stadium_id)),l=new Set(a.filter(m=>m.card_type==="formation").map(m=>m.formation)),c=new Set(a.filter(m=>m.card_type==="game_changer").map(m=>m.gc_type)),d={};for(const m of o){if(m.allow_duplicates!==!1||!((g=m.rates)!=null&&g.length))continue;const p=[...new Set((m.rates||[]).map(b=>b.card_type))];let u=!1;for(const b of p)if(b==="stadium"){const{data:v}=await w.from("stadium_definitions").select("id");if((v||[]).some(h=>!s.has(h.id))){u=!0;break}}else if(b==="game_changer"){const{data:v}=await w.from("gc_definitions").select("name").eq("is_active",!0);if((v||[]).some(h=>!c.has(h.name))){u=!0;break}}else if(b==="formation"){const{FORMATION_LINKS:v}=await un(async()=>{const{FORMATION_LINKS:h}=await import("./formation-links-CZYKSMms.js").then($=>$.q);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(v).some(h=>!l.has(h))){u=!0;break}}else{u=!0;break}u||(d[m.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=L=>L.touches&&L.touches[0]?L.touches[0].clientX:L.clientX;function d(L){o||(l=!0,s.style.opacity="1",x(L))}function x(L){if(!l||o)return;const V=a.getBoundingClientRect(),ie=c(L)-V.left,ue=Math.max(0,Math.min(1,ie/V.width));s.style.width=ue*V.width+"px",ue>=.82&&g()}function y(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var V;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(V=document.getElementById("cut-flash"))==null||V.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const L=document.getElementById("cut-hint");L&&(L.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",d),window.addEventListener("pointermove",x),window.addEventListener("pointerup",y),a.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",x,{passive:!0}),window.addEventListener("touchend",y);let m=0,p=!1;const u=new Set;function b(L){m=L,document.getElementById("reveal-phase").style.display="flex",v(),h(L,0),P()}function v(){const L=document.getElementById("card-dots");L&&(L.innerHTML=e.map((V,ie)=>`<div class="card-dot" data-i="${ie}" style="width:8px;height:8px;border-radius:50%;background:${ie===m?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),L.querySelectorAll(".card-dot").forEach(V=>V.addEventListener("click",()=>f(parseInt(V.dataset.i)))))}function h(L,V){var N,S;const ie=e[L],ue=document.getElementById("card-counter"),ge=document.getElementById("card-track");ue&&(ue.textContent=`Carte ${L+1} / ${e.length}`);const I=document.getElementById("reveal-btns");I&&(I.style.display=L===e.length-1?"flex":"none");const W=ie.card_type==="player"&&((N=ie.player)==null?void 0:N.rarity)==="legende",pe=!u.has(L);u.add(L);let G=0;if(ie.card_type==="player"&&ie.player){const D=ie.player,Y=D.job||"ATT";G=Number(Y==="GK"?D.note_g:Y==="DEF"?D.note_d:Y==="MIL"?D.note_m:D.note_a)||0}const K=D=>{ge.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${W?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Bo(ie)}</div>
        ...
        </div>`;const Y=document.getElementById("current-card-wrap");V!==0?(Y.style.transition="none",Y.style.transform=`translateX(${V>0?100:-100}%)`,requestAnimationFrame(()=>{Y.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",Y.style.transform="translateX(0)"})):Y.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),D||W?ae():re(),v()};pe&&(((S=ie.player)==null?void 0:S.rarity)==="legende"||G>=8)&&ie.card_type==="player"&&ie.player?$(ie,()=>K(!0)):K(!1)}function $(L,V){var _e;p=!0;const ie=L.player,ue=`https://flagsapi.com/${ie.country_code}/flat/64.png`,ge=(_e=ie.clubs)==null?void 0:_e.logo_url,I=ie.face?"/"+ie.face.replace(/^public\//,"").replace(/^\//,""):null,W=ie.job||"ATT",pe=Number(W==="GK"?ie.note_g:W==="DEF"?ie.note_d:W==="MIL"?ie.note_m:ie.note_a)||0,G=L.evolution_bonus||0,K=pe+G,N=ie.rarity==="legende",S=K>=18,D=document.getElementById("walkout-overlay"),Y=document.getElementById("walkout-stage");if(!D||!Y){p=!1,V();return}let Q=null;N&&(Q=new Audio("/sounds/Legendary.mp3"),Q.volume=.8,Q.play().catch(()=>{})),D.style.display="flex";const R=()=>{const be=Y.firstElementChild;be&&(be.classList.remove("wo-in"),be.classList.add("wo-out"))},C=1800,O=400;Y.innerHTML=`<img class="wo-in" src="${ue}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(R,C),setTimeout(()=>{var be;Y.innerHTML=ge?`<img class="wo-in" src="${ge}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((be=ie.clubs)==null?void 0:be.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},C+O),setTimeout(R,C*2+O),setTimeout(()=>{Y.innerHTML=I?`<img class="wo-in" src="${I}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(C+O)*2),setTimeout(R,(C+O)*2+C);const ke=S?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[W]||"#fff";setTimeout(()=>{Y.innerHTML=`<div class="wo-in" style="
        ...
        ${K}
      </div>`,S&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(C+O)*3),setTimeout(R,(C+O)*3+C),setTimeout(()=>{D.style.display="none",Y.innerHTML="",p=!1,Q&&!N&&Q.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),V()},(C+O)*4)}function f(L){if(p||L<0||L>=e.length||L===m)return;const V=L>m?1:-1;m=L,h(L,V)}function M(){f(m+1)}function k(){f(m-1)}function P(){const L=document.getElementById("card-viewport");if(!L||L._swipeBound)return;L._swipeBound=!0;let V=0,ie=0,ue=0,ge=!1;const I=N=>N.touches?N.touches[0].clientX:N.clientX,W=N=>N.touches?N.touches[0].clientY:N.clientY,pe=N=>{ge=!0,V=I(N),ie=W(N),ue=0},G=N=>{if(!ge)return;ue=I(N)-V;const S=W(N)-ie;if(Math.abs(ue)<Math.abs(S))return;const D=document.getElementById("current-card-wrap");D&&(D.style.transition="none",D.style.transform=`translateX(${ue*.6}px) rotate(${ue*.02}deg)`)},K=()=>{if(!ge)return;ge=!1;const N=document.getElementById("current-card-wrap"),S=55;ue<=-S&&m<e.length-1?M():ue>=S&&m>0?k():N&&(N.style.transition="transform .2s ease",N.style.transform="translateX(0)")};L.addEventListener("pointerdown",pe),L.addEventListener("pointermove",G),L.addEventListener("pointerup",K),L.addEventListener("pointercancel",K),L.addEventListener("touchstart",pe,{passive:!0}),L.addEventListener("touchmove",G,{passive:!0}),L.addEventListener("touchend",K),L.addEventListener("click",N=>{if(Math.abs(ue)>8)return;const S=L.getBoundingClientRect();N.clientX-S.left>S.width/2?M():k()})}let H=null;function ae(){const L=document.getElementById("fireworks-canvas");if(!L)return;L.width=window.innerWidth,L.height=window.innerHeight;const V=L.getContext("2d"),ie=[];function ue(){const I=Math.random()*L.width,W=Math.random()*L.height*.6,pe=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],G=pe[Math.floor(Math.random()*pe.length)];for(let K=0;K<60;K++){const N=Math.PI*2/60*K,S=2+Math.random()*5;ie.push({x:I,y:W,vx:Math.cos(N)*S,vy:Math.sin(N)*S,alpha:1,color:G,size:2+Math.random()*3})}}ue(),H=setInterval(ue,600);function ge(){if(document.getElementById("fireworks-canvas")){V.clearRect(0,0,L.width,L.height);for(let I=ie.length-1;I>=0;I--){const W=ie[I];if(W.x+=W.vx,W.y+=W.vy+.08,W.vy*=.98,W.alpha-=.018,W.alpha<=0){ie.splice(I,1);continue}V.globalAlpha=W.alpha,V.fillStyle=W.color,V.beginPath(),V.arc(W.x,W.y,W.size,0,Math.PI*2),V.fill()}V.globalAlpha=1,(H!==null||ie.length>0)&&requestAnimationFrame(ge)}}ge()}function re(){H!==null&&(clearInterval(H),H=null);const L=document.getElementById("fireworks-canvas");L&&L.getContext("2d").clearRect(0,0,L.width,L.height)}if(n){const L=document.getElementById("reveal-btns");L&&(L.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(j=document.getElementById("reveal-next"))==null||j.addEventListener("click",()=>{re(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{re(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{re(),r.remove(),i("boosters")})}function Bo(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return Ao(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},l={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,d=l[o==null?void 0:o.color]||l.purple,x=(o==null?void 0:o.name)||e.gc_type||"Game Changer",y=(o==null?void 0:o.effect)||((t=$i[e.gc_type])==null?void 0:t.desc)||"",g=o!=null&&o.image_url?`/icons/${o.image_url}`:null,m=((i=$i[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${d};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${d}88;flex-shrink:0">
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}Do()}function Do(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function Fo(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const n=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(n),t.remove(),e(!0))},1e3)})}async function Po(e,{state:t,navigate:i,toast:n,refreshProfile:r}){var y,g;const{data:o}=await w.from("users").select("*").eq("id",t.user.id).single();o&&(t.profile=o);let a=Array.isArray((y=t.profile)==null?void 0:y.pending_boosters)?[...t.profile.pending_boosters]:[];if(!a.length){await w.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let s=null;try{const p=(await wn()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(s=kn(p))}catch(m){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',m)}const l=a.length;let c=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        <div style="padding:8px 16px;background:rgba(0,0,0,0.4);text-align:center">
          <div style="font-size:10px;opacity:.6;letter-spacing:2px;text-transform:uppercase">${No(i,t)}</div>
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function te(){const j=e.querySelector(".deck-preview-wrap"),L=e.querySelector("#deck-swipe-zone");if(!j||!L||!b)return;const V=L.clientWidth>=900,ie=Math.max(200,L.clientHeight-(V?60:40)),ge=Math.max(200,L.clientWidth-16),I=V?Math.min(117,Math.max(52,Math.round(ge*.22))):Math.max(44,Math.round(ge*.168));if(ie<220||ge<220){requestAnimationFrame(te);return}const W=V?null:Math.round(I*.55);j.innerHTML=Rt(b,u,null,[],ge,ie,[],W),j.style.cssText=`width:${ge}px;height:${ie}px;overflow:hidden;margin:${V?0:60}px auto 0`;const pe=j.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",V?"xMidYMid meet":"none"))})),(P=document.getElementById("prev-deck"))==null||P.addEventListener("click",()=>{d>0&&(d--,x())}),(H=document.getElementById("next-deck"))==null||H.addEventListener("click",()=>{d<o.length-1&&(d++,x())}),(ae=document.getElementById("validate-deck"))==null||ae.addEventListener("click",()=>{if(!h)return;const te=t.state.params||{};t.navigate("match",{...te,matchMode:te.matchMode||i,deckId:y.id})}),(re=document.getElementById("cancel-deck-select"))==null||re.addEventListener("click",()=>{et(e),r("home")});const $=document.getElementById("deck-swipe-zone");if($){let te=0,j=0;$.addEventListener("touchstart",L=>{te=L.touches[0].clientX,j=L.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",L=>{const V=L.changedTouches[0].clientX-te,ie=L.changedTouches[0].clientY-j;Math.abs(V)<40||Math.abs(V)<Math.abs(ie)||(V<0&&d<o.length-1?(d++,x()):V>0&&d>0&&(d--,x()))},{passive:!0})}}x()}function vt(e,t=44,i=58,n=null){return Se(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Je(e,t,i,n,r){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,l)=>{const c=s._line||s.job||"MIL";let d=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(c==="ATT"||c==="MIL")||n==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?d+=10:n||(d+=10)),a+=Se(s,{width:40,role:c,extraNote:d}),l<o.length-1){const x=o[l+1],y=yn(s,x,r)?Ot(s,x):null;a+=`<div style="width:7px;height:3px;background:${!y||y==="#ff3333"||y==="#cc2222"?"rgba(255,255,255,0.12)":y};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function ui(e,t,i,n,r=310,o=310,a=[],s=null){const l=ei[t]||{},c=Mi(t)||ji[t]||[],d={},x=["ATT","MIL","DEF","GK"];for(const b of x)(e[b]||[]).forEach((h,$)=>{d[`${b}${$+1}`]=h});function y(b){const v=l[b];return v?{x:v.x*r,y:v.y*o}:null}let g="";for(const[b,v]of c){const h=y(b),$=y(v);if(!h||!$)continue;const f=d[b],M=d[v],k=Ot(f,M);k==="#00ff88"||k==="#FFD700"?(g+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
    ...
    </div>`}function An(e){var o,a,s;if(!e)return"";const t=l=>l?Se({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(l)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function Uo(e,t,i){const n=document.getElementById("sub-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function Sn(e,t){const i=Ge(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function yt(e,t){return e.reduce((i,n)=>i+Sn(n,t),0)}function bt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Ot(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function di(e,t,i,n,r){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ot(o,e[a+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Sn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const W=t.pendingAttack;let pe="";if(t.selected.length>0){const G=t.selected.map(N=>({...(t.homeTeam[N._role]||[]).find(D=>D.cardId===N.cardId)||N,_line:N._role})),K=Jt(G,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          </div>`}const I=t.log[t.log.length-1];return I?'<div style="padding:2px 4px">'+An(I)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const I=window.innerWidth>=700,W=(R,C,O)=>{var tt,He;const ce=(t.gcDefs||[]).find(mi=>mi.name===R.gc_type),ke={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_e={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",be=(ce==null?void 0:ce.name)||R.gc_type,Ee=(ce==null?void 0:ce.effect)||((tt=Ce[R.gc_type])==null?void 0:tt.desc)||"",Te=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,he=((He=Ce[R.gc_type])==null?void 0:He.icon)||"⚡",ze=Math.round(O*.22),Fe=Math.round(O*.22),je=O-ze-Fe,Re=be.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          ...
          <div style="height:${ze}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Re}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${C-6}px">${be}</span>
          ...
          <div style="height:${je}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Te?`<img src="${Te}" style="max-width:${C-10}px;max-height:${je-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(je*.55)}px">${he}</span>`}
          </div>
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Rt(t.homeTeam,t.formation,t.phase,n,I?1300:zt(),I?600:Pt(),m)}
        </div>
      </div>`;return I?`
  ...
  <div id="match-history-panel">
  ...
  </div>`;function P(){const I=e.querySelector(".match-screen");if(!I)return;const W=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);I.style.bottom="auto",I.style.height=W+"px",I.style.minHeight=W+"px",I.style.maxHeight=W+"px",I.style.overflow="hidden";const pe=e.querySelector("#mobile-action-bar"),G=e.querySelector("#mobile-play-area");pe&&G&&(G.style.paddingBottom=pe.offsetHeight+"px")}if(P(),setTimeout(P,120),setTimeout(P,400),setTimeout(P,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",P),window.visualViewport.addEventListener("scroll",P)),window.addEventListener("resize",P)),function(){const W=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!W)return;const pe=W.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),W.removeAttribute("width"),W.removeAttribute("height"),W.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",W.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const I=e.querySelector(".terrain-wrapper svg");if(I){const W=I.closest("#match-terrain-wrap");W&&(W.style.cssText="position:relative;width:100%;height:100%;padding:0"),I.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let I=!1,W=30;const pe=()=>document.getElementById("match-timer"),G=()=>{const K=pe();if(!K)return;const N=String(Math.floor(W/60)).padStart(2,"0"),S=String(W%60).padStart(2,"0");K.textContent=` ${N}:${S}`,K.style.color=I?"#ff2222":"#ff9500",K.style.fontWeight="900"};G(),t._timerInt=setInterval(()=>{if(W--,W<0)if(!I)I=!0,W=15,G();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const K=document.createElement("div");K.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",K.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(K),setTimeout(()=>{K.remove(),ht(e,t,i)},2500)}else G()},1e3)}(ae=document.getElementById("match-quit"))==null||ae.addEventListener("click",()=>{et(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,ht(e,t,i))}),(re=document.getElementById("view-ai"))==null||re.addEventListener("click",()=>sr(t,i)),(te=document.getElementById("toggle-history"))==null||te.addEventListener("click",()=>{var I;(I=document.getElementById("match-history-panel"))==null||I.classList.add("open")}),(j=document.getElementById("close-history"))==null||j.addEventListener("click",()=>{var I;(I=document.getElementById("match-history-panel"))==null||I.classList.remove("open")}),(L=document.getElementById("btn-action"))==null||L.addEventListener("click",()=>{t.selected.length!==0&&(u?Qo(e,t,i):b&&Zo(e,t,i))}),(V=document.getElementById("btn-results"))==null||V.addEventListener("click",()=>ht(e,t,i)),(ie=document.getElementById("btn-pass"))==null||ie.addEventListener("click",()=>{if(t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Li(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(e,t,i);return}t.phase="ai-attack",$e(e,t,i),setTimeout(()=>Pi(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(I=>{I.addEventListener("click",()=>Jo(I,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(I=>{I.addEventListener("click",()=>wi(e,t,i,null,I.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(I=>{u?I.addEventListener("click",()=>nr(I.dataset.gcId,I.dataset.gcType,e,t,i)):(I.style.opacity="0.35",I.style.cursor="default",I.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(ue=document.getElementById("boost-card"))==null||ue.addEventListener("click",()=>ar(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(I=>{I.addEventListener("click",()=>wi(e,t,i,I.dataset.subId))}),(ge=document.getElementById("sub-btn-main"))==null||ge.addEventListener("click",()=>wi(e,t,i))}function Jo(e,t,i,n){const r=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(l=>l.cardId===r);s&&t.selected.push({...s,_role:o,_line:o})}$e(i,t,n)}function Fi(e,t,i){e.matchId&&w.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function Qo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Fi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const a=(t.homeTeam[o._role]||[]).find(l=>l.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...a,_line:o._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=Xt(n,t.modifiers.home,t.formation);t.pendingAttack={...r,players:[...n],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",$e(e,t,i),setTimeout(()=>ir(e,t,i),1200)}function Zo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Fi(t,i,i.state.profile.id);const n=t.stadiumDef||null,r=t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(x=>x.cardId===l.cardId)||l,d=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:l._role,stadiumBonus:d}}),o=Jt(r,t.modifiers.home,t.formation);t.selected.forEach(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId);c&&(c.used=!0)});const a=Di(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>Ye(l)),homePlayers:t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId)||l;return Ye(c)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,$e(e,t,i),Qe(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{It(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,It(e,t,i,"home-attack")}function er(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(l=>l.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(l=>!e.aiUsedSubIds.includes(l.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],r=i.find(l=>l.job===n.job)||i[0],o={...r,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(l=>l.cardId===n.cardId);s!==-1&&(a[s]=o),e.aiUsedSubIds.push(r.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function tr(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(r=>!e.aiUsedGc.includes(r.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),Ce[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function Pi(e,t,i){Fi(t,i,null),er(t),tr(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(d=>!d.used),r=!1;if(!n.length){const d=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(y=>!y.used),x=Nt(t.homeTeam);if(x||d.length===0){const y=(t.aiTeam.DEF||[]).filter(m=>!m.used),g=(t.aiTeam.GK||[]).filter(m=>!m.used);n=x?y.length?y:g:[...y,...g],r=!0}}const o=hn(n,"attack",t.difficulty);if(!o.length){zi(e,t,i);return}r&&o.forEach(d=>{d._line=d._line||d.job,d.note_a=Math.max(1,Number(d.note_a)||0)});const a=Xt(o,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:o,side:"ai"},o.forEach(d=>{d.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${o.map(d=>d.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(d=>!d.used),c=(t.homeSubs||[]).filter(d=>!(t.usedSubIds||[]).includes(d.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&Nt(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,li(e,t,i,"ai",o[0]);return}t.aiScore++;const x={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(y=>Ye(y)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(x),t.pendingAttack=null,$e(e,t,i),Qe(x.aiPlayers,t.homeScore,t.aiScore,!1,()=>{It(e,t,i,"home-attack")});return}t.phase="defense",$e(e,t,i)}function ir(e,t,i){var c,d;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=hn(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(x=>(t.aiTeam[x]||[]).filter(y=>!y.used)).length){const x=((c=t.pendingAttack)==null?void 0:c.players)||[];if(x.length===1&&(x[0]._line==="GK"||x[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,li(e,t,i,"home",x[0]);return}t.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:x.map(m=>Ye(m)),homeTotal:((d=t.pendingAttack)==null?void 0:d.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(g),t.modifiers.ai={},t.pendingAttack=null,$e(e,t,i),Qe(g.homePlayers,t.homeScore,t.aiScore,!0,()=>{It(e,t,i,"ai-attack")});return}const a=r.length>0?Jt(r,t.modifiers.ai,t.formation).total:0;r.forEach(x=>{x.used=!0});const s=Di(t.pendingAttack.total,a,t.modifiers.ai),l={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(x=>Ye(x)),aiPlayers:r.map(x=>Ye(x)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)l.text="🛡️ Bouclier IA !",t.log.push(l);else if(s.goal){t.homeScore++,l.isGoal=!0,l.homeScored=!0,l.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(l),t.modifiers.ai={},t.pendingAttack=null,$e(e,t,i),Qe(l.homePlayers,t.homeScore,t.aiScore,!0,()=>{It(e,t,i,"ai-attack")});return}else l.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(l);t.modifiers.ai={},t.pendingAttack=null,It(e,t,i,"ai-attack")}function It(e,t,i,n){if(t.round++,!Mn(e,t,i)){if(Gi(t)){ht(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used))){zi(e,t,i);return}t.phase="attack",$e(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used))){zi(e,t,i);return}t.phase="ai-attack",$e(e,t,i),setTimeout(()=>Pi(e,t,i),800)}}}function Nt(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function dn(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(r=>!r.used));return t&&!i}function Mn(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(dn(t.homeTeam)&&Nt(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.homeScore++,li(e,t,i,"home",n),!0):!1}if(dn(t.aiTeam)&&Nt(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.aiScore++,li(e,t,i,"ai",n),!0):!1}return!1}function li(e,t,i,n,r){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ye(r)]:[],aiPlayers:n==="ai"?[Ye(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const a=(s,l)=>new Promise(c=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${l};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,$e(e,t,i),Qe([Ye(r)],t.homeScore,t.aiScore,n==="home",()=>{if(Gi(t)){ht(e,t,i);return}It(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function Gi(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used));return!t&&!i}function Li(e,t){return!(["MIL","ATT"].some(r=>(e[r]||[]).some(o=>!o.used))||Nt(t)||!["MIL","ATT"].some(r=>(t[r]||[]).some(o=>!o.used)))}function zi(e,t,i){if(!Mn(e,t,i)){if(Gi(t)){ht(e,t,i);return}if(Li(t.homeTeam,t.aiTeam)&&Li(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(e,t,i);return}t.phase="attack",$e(e,t,i)}}function wi(e,t,i,n=null,r=null){var g,m;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,u])=>(u||[]).filter(b=>b.used).map(b=>({...b,_line:b._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){$t("Aucun joueur utilisé à remplacer");return}if(!a.length){$t("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===r));const l=((g=o[s])==null?void 0:g._line)||((m=o[s])==null?void 0:m.job);let c=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===l)),d=!1;const x=document.createElement("div");x.id="sub-overlay",x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function y(){var f,M,k,P,H,ae;const p=o[s],u=a[c],b=Math.min(130,Math.round((window.innerWidth-90)/2)),v=Math.round(b*1.35),h=re=>`background:rgba(255,255,255,0.12);border:none;color:${re?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${re?"default":"pointer"};flex-shrink:0`;x.innerHTML=`
    ...
    </div>`,(f=x.querySelector("#sub-close"))==null||f.addEventListener("click",()=>x.remove()),(M=x.querySelector("#out-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,y())}),(k=x.querySelector("#out-down"))==null||k.addEventListener("click",()=>{s<o.length-1&&(s++,y())}),(P=x.querySelector("#in-up"))==null||P.addEventListener("click",()=>{c>0&&(c--,y())}),(H=x.querySelector("#in-down"))==null||H.addEventListener("click",()=>{c<a.length-1&&(c++,y())});const $=(re,te,j,L)=>{const V=x.querySelector("#"+re);if(!V)return;let ie=0;V.addEventListener("touchstart",ue=>{ie=ue.touches[0].clientY},{passive:!0}),V.addEventListener("touchend",ue=>{const ge=ue.changedTouches[0].clientY-ie;if(Math.abs(ge)<30)return;const I=te();ge<0&&I<L-1?(j(I+1),y()):ge>0&&I>0&&(j(I-1),y())},{passive:!0})};$("in-panel",()=>c,re=>c=re,a.length),$("out-panel",()=>s,re=>s=re,o.length),(ae=x.querySelector("#sub-confirm"))==null||ae.addEventListener("click",re=>{if(re.preventDefault(),re.stopPropagation(),d)return;d=!0;const te=o[s],j=a[c];if(!te||!j)return;let L=null,V=-1;for(const[ue,ge]of Object.entries(t.homeTeam)){const I=(ge||[]).findIndex(W=>W.cardId===te.cardId);if(I!==-1){L=ue,V=I;break}}if(V===-1||!L){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),x.remove();return}const ie={...j,_line:L,_col:te._col||0,used:!1,boost:0};t.homeTeam[L].splice(V,1,ie),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(j.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:te.name,firstname:te.firstname,note:Ge(te,L),portrait:Qt(te),job:te.job,country_code:te.country_code,rarity:te.rarity,clubName:te.clubName,clubLogo:te.clubLogo},inPlayer:{name:j.name,firstname:j.firstname,note:Ge(j,L),portrait:Qt(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},text:`🔄 ${j.firstname} ${j.name} remplace ${te.firstname} ${te.name}`}),x.remove(),Uo(te,j,()=>$e(e,t,i))})}document.body.appendChild(x),y()}function nr(e,t,i,n,r){var m,p;const o=(n.gcDefs||[]).find(u=>u.name===t),a=Ce[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",c=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||a.desc,x=o!=null&&o.image_url?`/icons/${o.image_url}`:null,y=a.icon||"⚡",g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",g.innerHTML=`
    ...
    </div>`,document.body.appendChild(g),(m=g.querySelector("#gc-back"))==null||m.addEventListener("click",()=>g.remove()),(p=g.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{g.remove(),rr(e,t,i,n,r)})}function ni(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function l(){var c,d;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(x=>{const y=x._line||x.job||"MIL",g=s.find(p=>p.cardId===x.cardId),m=Se({...x,_evolution_bonus:0},{width:90,showStad:!0,role:y,extraNote:x.boost||0});return`<div class="gc-pick-item" data-cid="${x.cardId}"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Ro[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Ge(r,r._line||r.job)}</div>
          <div style="flex:1"><b>${r.firstname} ${r.name}</b><div style="font-size:11px;color:#888">${r._line||r.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),$e(e,t,i)})})}async function ht(e,t,i){var d,x;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=ao(t.mode,a);t.matchId&&await w.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await w.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${ui(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const qt=e=>In(e);async function At(e,t,i,n,r={}){return jn(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function dr(e,t,i){const{data:n}=await w.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;let o=null,a=null;if(n.mode==="mini_league"){const{data:s}=await w.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(o=s.league_id,a=s.id)}return jn(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,o,a)}async function jn(e,t,i,n,r=[],o=[],a=!1,s=null,l=null,c=null,d=null,x=null){const{state:y,navigate:g,toast:m}=t,p=n?"p1":"p2",u=n?"p2":"p1",b=(r||[]).map(_=>_.id),v=(r||[]).map(_=>({id:_.id,gc_type:_.gc_type,_gcDef:_._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await w.from("matches").select("*").eq("id",i).single();if(!h){m("Match introuvable","error"),g("home");return}async function $(){var xe,ye;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:_,error:E},{data:z,error:A},{data:T},{data:F}]=await Promise.all([w.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),w.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),w.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),w.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",E==null?void 0:E.message,"p2:",A==null?void 0:A.message,"p1D:",(xe=_==null?void 0:_.starters)==null?void 0:xe.length,"p2D:",(ye=z==null?void 0:z.starters)==null?void 0:ye.length);const B=oe=>{const Le=Number(oe.evolution_bonus)||0;return{cardId:oe.card_id,position:oe.position,id:oe.id,firstname:oe.firstname,name:oe.surname_real,country_code:oe.country_code,club_id:oe.club_id,job:oe.job,job2:oe.job2,note_g:(Number(oe.note_g)||0)+(oe.job==="GK"||oe.job2==="GK"&&Number(oe.note_g)>0?Le:0),note_d:(Number(oe.note_d)||0)+(oe.job==="DEF"||oe.job2==="DEF"&&Number(oe.note_d)>0?Le:0),note_m:(Number(oe.note_m)||0)+(oe.job==="MIL"||oe.job2==="MIL"&&Number(oe.note_m)>0?Le:0),note_a:(Number(oe.note_a)||0)+(oe.job==="ATT"||oe.job2==="ATT"&&Number(oe.note_a)>0?Le:0),evolution_bonus:Le,rarity:oe.rarity,skin:oe.skin,hair:oe.hair,hair_length:oe.hair_length,face:oe.face||null,clubName:oe.club_encoded_name||null,clubLogo:oe.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},q=((_==null?void 0:_.starters)||[]).map(oe=>B(oe)),U=((z==null?void 0:z.starters)||[]).map(oe=>B(oe)),Z=(_==null?void 0:_.formation)||"4-4-2",ne=(z==null?void 0:z.formation)||"4-4-2";let ee=si(q,Z),J=si(U,ne);const se=((_==null?void 0:_.subs)||[]).map(oe=>B(oe)),de=((z==null?void 0:z.subs)||[]).map(oe=>B(oe)),me=(_==null?void 0:_.stadium_def)||(n?l:null),le=(z==null?void 0:z.stadium_def)||(n?null:l);return me&&(ee=Zt(ee,me),ai(se,me)),le&&(J=Zt(J,le),ai(de,le)),{p1Team:ee,p2Team:J,p1Subs:se,p2Subs:de,p1Formation:Z,p2Formation:ne,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(F==null?void 0:F.club_name)||(F==null?void 0:F.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?v:[],gcCardsFull_p2:n?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let f=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!f,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",y.profile.id),!f)if(n){f=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((f==null?void 0:f.p1Team)||{}));const{data:_}=await w.from("matches").select("game_state").eq("id",i).single();!(_!=null&&_.game_state)||!Object.keys(_.game_state).length?await w.from("matches").update({game_state:f,turn_user_id:h.home_id}).eq("id",i):f=_.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let _=0;_<30&&!f;_++){await new Promise(z=>setTimeout(z,400));const{data:E}=await w.from("matches").select("game_state").eq("id",i).single();E!=null&&E.game_state&&Object.keys(E.game_state).length&&(f=E.game_state),_%5===0&&console.log("[PvP] away - poll",_,"game_state:",!!(E!=null&&E.game_state))}if(!f){m("Erreur de synchronisation","error"),g("home");return}f.gc_p2=b,f.gcCardsFull_p2=v,await w.from("matches").update({game_state:f}).eq("id",i)}let M=!1,k=null,P=!1;const H=new Set,ae=new Set;async function re(_){var ne,ee;try{w.removeChannel(te)}catch{}const E=f[p+"Score"]||0,z=f[u+"Score"]||0;let A,T;_.winner_id?(A=_.winner_id===y.profile.id,T=!1):_.forfeit?(A=E>z,T=!1):(T=E===z,A=E>z);let F="";if(a&&n)try{const{data:J}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:se}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(J&&se){const de=A?1:T?.5:0,me=1-de,le=J.placement_matches<10,xe=se.placement_matches<10,ye=computeGlicko2(J.mmr,J.mmr_deviation,J.mmr_volatility,se.mmr,se.mmr_deviation,de===1?1:de===0?0:.5,le),oe=computeGlicko2(se.mmr,se.mmr_deviation,se.mmr_volatility,J.mmr,J.mmr_deviation,me===1?1:me===0?0:.5,xe);await w.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:A?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:ye.delta,p_away_delta:oe.delta,p_home_new_rd:ye.newRd,p_away_new_rd:oe.newRd,p_home_new_vol:ye.newSigma,p_away_new_vol:oe.newSigma});const Le=ye.delta,Ne=ye.newMmr,Ie=getTier(Ne),We=Le>=0?"+":"",Ue=Le>=0?"#4caf50":"#ff6b6b",it=getTier(J.mmr);F=`
            ...
            </div>`}}catch(J){console.error("[Ranked] MMR update error:",J)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const B=document.createElement("div");B.id="pvp-end-overlay",B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const q=T?"🤝":A?"🏆":"😞",U=T?"MATCH NUL":A?"VICTOIRE !":"DÉFAITE",Z=T?"#fff":A?"#FFD700":"#ff6b6b";B.innerHTML=`
      ...
      ${F}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${d?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(B),(ee=B.querySelector("#pvp-end-home"))==null||ee.addEventListener("click",()=>{B.remove(),et(e),d?g("mini-league",{openLeagueId:d}):g(a?"ranked":"home")})}const te=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var z;const E=_.new;try{if(E.status==="finished"||E.forfeit){if(M)return;M=!0,k&&(clearInterval(k),k=null),E.game_state&&(f=E.game_state),re(E);return}if(E.game_state){const A=f;f=E.game_state;const T=f._lastGC;if(T&&T.seq&&!ae.has(T.seq)&&(ae.add(T.seq),T.by!==p)){N(T.type,T.by,()=>W());return}const F=A[p+"Score"]||0,B=A[u+"Score"]||0,q=f[p+"Score"]||0,U=f[u+"Score"]||0,Z=q>F,ne=U>B;if((Z||ne)&&!H.has(f.round)){H.add(f.round);const ee=[...f.log||[]].reverse().find(de=>de.isGoal),J=((ee==null?void 0:ee.homePlayers)||[]).map(de=>({name:de.name,note:de.note,portrait:de.portrait,job:de.job}));!!((z=ee==null?void 0:ee.text)!=null&&z.includes("DERNIER CORNER"))?_e().then(()=>{Qe(J,q,U,Z,()=>W())}):Qe(J,q,U,Z,()=>W());return}W()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function j(_){Object.assign(f,_),f.lastActionAt=new Date().toISOString();const{error:E}=await w.from("matches").update({game_state:f}).eq("id",i);E&&m("Erreur de synchronisation","error");try{W()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function L(){if(M)return;M=!0,k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,E=n?"p2":"p1",z=n?"p1":"p2",A={...f,[E+"Score"]:3,[z+"Score"]:0,phase:"finished"},T=A.p1Score||0,F=A.p2Score||0;try{await w.from("matches").update({game_state:A}).eq("id",i);const{data:B,error:q}=await w.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:T,p_away_score:F,p_forfeit:!0});if(q&&console.error("[PvP] finish_pvp_match (forfeit):",q),d)try{await w.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await w.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{w.removeChannel(te)}catch{}setTimeout(()=>{et(e),d?g("mini-league",{openLeagueId:d}):g("home")},800)}const V={BOOST_STAT:({value:_=1,count:E=1,roles:z=[]},A,T)=>{const F=A[p+"Team"],B=Object.entries(F).filter(([q])=>!z.length||z.includes(q)).flatMap(([q,U])=>U.filter(Z=>!Z.used).map(Z=>({...Z,_line:q})));if(!B.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(A);return}ie(B,E,`Choisir ${E} joueur(s) à booster (+${_})`,q=>{q.forEach(U=>{const Z=(F[U._line]||[]).find(ne=>ne.cardId===U.cardId);Z&&(Z.boost=(Z.boost||0)+_,A.log.push({text:`⚡ +${_} sur ${Z.name}`,type:"info"}))}),A[p+"Team"]=F,T(A)})},DEBUFF_STAT:({value:_=1,count:E=1,roles:z=[],target:A="ai"},T,F)=>{const B=A==="home"?p:u,q=T[B+"Team"],U=A==="home"?"allié":"adverse",Z=Object.entries(q).filter(([ne])=>!z.length||z.includes(ne)).flatMap(([ne,ee])=>ee.map(J=>({...J,_line:ne})));if(!Z.length){T.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),F(T);return}ie(Z,E,`Choisir ${E} joueur(s) ${U}(s) (-${_})`,ne=>{ne.forEach(ee=>{const J=(q[ee._line]||[]).find(se=>se.cardId===ee.cardId);J&&(J.boost=(J.boost||0)-_,T.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),T[B+"Team"]=q,F(T)})},GRAY_PLAYER:({count:_=1,roles:E=[],target:z="ai"},A,T)=>{const F=z==="home"?p:u,B=A[F+"Team"],q=z==="home"?"allié":"adverse",U=Object.entries(B).filter(([Z])=>!E.length||E.includes(Z)).flatMap(([Z,ne])=>ne.filter(ee=>!ee.used).map(ee=>({...ee,_line:Z})));if(!U.length){A.log.push({text:`❌ Aucun joueur ${q}`,type:"info"}),T(A);return}ie(U,_,`Choisir ${_} joueur(s) ${q}(s) à exclure`,Z=>{const ne="usedCardIds_"+F,ee=new Set(A[ne]||[]);Z.forEach(J=>{const se=(B[J._line]||[]).find(de=>de.cardId===J.cardId);se&&(se.used=!0,ee.add(J.cardId),A.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),A[ne]=[...ee],A[F+"Team"]=B,T(A)})},REVIVE_PLAYER:({count:_=1,roles:E=[]},z,A)=>{const T=z[p+"Team"],F=Object.entries(T).filter(([B])=>!E.length||E.includes(B)).flatMap(([B,q])=>q.filter(U=>U.used).map(U=>({...U,_line:B})));if(!F.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(z);return}ie(F,_,`Choisir ${_} joueur(s) à ressusciter`,B=>{B.forEach(q=>{const U=(T[q._line]||[]).find(Z=>Z.cardId===q.cardId);U&&(U.used=!1,z.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=T,A(z)})},REMOVE_GOAL:({},_,E)=>{const z=u+"Score";_[z]>0?(_[z]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(_)},ADD_GOAL_DRAW:({},_,E)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(_)},ADD_SUB:({value:_=1},E,z)=>{E.maxSubs=(E.maxSubs||3)+_,E.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),z(E)},CUSTOM:({},_,E)=>E(_)};function ie(_,E,z,A){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let F=[];function B(){var U,Z;const q=_.map(ne=>{const ee=ne._line||ne.job||"MIL",J=F.find(de=>de.cardId===ne.cardId),se=Se({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:ee,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(U=T.querySelector("#pp-close"))==null||U.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const ee=ne.dataset.cid,J=_.find(de=>de.cardId===ee),se=F.findIndex(de=>de.cardId===ee);J&&(se>-1?F.splice(se,1):F.length<E&&F.push(J),B())})}),(Z=T.querySelector("#pp-confirm"))==null||Z.addEventListener("click",()=>{T.remove(),A(F)})}B(),document.body.appendChild(T)}async function ue(_,E){const A=(f["gcCardsFull_"+p]||[]).find(q=>q.id===_),T=(A==null?void 0:A._gcDef)||(f.gcDefs||[]).find(q=>{var U;return q.name===E||((U=q.name)==null?void 0:U.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),F=[...f["usedGc_"+p]||[],_],B={type:E,by:p,seq:(f._gcAnimSeq||0)+1};ae.add(B.seq),N(E,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const U=V[T.effect_type];if(U){const Z={...f};U(T.effect_params||{},Z,async ne=>{ne["usedGc_"+p]=F,ne._lastGC=B,ne._gcAnimSeq=B.seq,await j(ne)});return}}const q={...f};switch(E){case"Remplacement+":q.maxSubs=(q.maxSubs||3)+1,q.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=u+"Score";q[U]>0&&(q[U]--,q.log.push({text:"🚫 But annulé",type:"info"}));break}}q["usedGc_"+p]=F,q._lastGC=B,q._gcAnimSeq=B.seq,await j(q)})}function ge(_,E){const z="usedCardIds_"+_,A=new Set(f[z]||[]);E.forEach(T=>A.add(T)),f[z]=[...A]}function I(){for(const _ of["p1","p2"]){const E=new Set(f["usedCardIds_"+_]||[]),z=f[_+"Team"];if(z)for(const A of["GK","DEF","MIL","ATT"])(z[A]||[]).forEach(T=>{T.used=E.has(T.cardId)})}}function W(){var Oi,Hi,Ui,Ki,Vi,Yi;if(f.phase==="reveal")return pe();if(f.phase==="midfield")return K();if(f.phase==="finished")return mi();const _=f[p+"Team"],E=f[u+"Team"];I();const z=f[p+"Score"],A=f[u+"Score"],T=f[p+"Name"],F=f[u+"Name"],B=f.phase===p+"-attack",q=f.phase===p+"-defense",U=Array.isArray(f["selected_"+p])?f["selected_"+p]:[],Z=U.map(X=>X.cardId),ne=window.innerWidth>=700,ee=f[p+"Subs"]||[],J=f["usedSubIds_"+p]||[],se=ee.filter(X=>!J.includes(X.cardId)),de=f["gcCardsFull_"+p]||[],me=f["usedGc_"+p]||[],le=de.filter(X=>!me.includes(X.id)),xe=f.boostOwner===p&&!f.boostUsed,ye=[..._.MIL||[],..._.ATT||[]].filter(X=>!X.used),oe=[...E.MIL||[],...E.ATT||[]].filter(X=>!X.used),Le=!ze(E),Ne=ye.length===0&&oe.length===0&&!Le,Ie=(_.DEF||[]).filter(X=>!X.used),We=(_.GK||[]).filter(X=>!X.used);let Ue=[];B&&ye.length===0&&(Le?(Ue=Ie.map(X=>X.cardId),Ie.length===0&&(Ue=Ue.concat(We.map(X=>X.cardId)))):Ne&&(Ue=[...Ie,...We].map(X=>X.cardId)));function it(X,fe,Ae){var Bt,gt;const ve=X._gcDef,jt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ve==null?void 0:ve.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",rt={purple:"#b06ce0",light_blue:"#00d4ef"}[ve==null?void 0:ve.color]||"#b06ce0",De=(ve==null?void 0:ve.name)||X.gc_type,Oe=(ve==null?void 0:ve.effect)||((Bt=Ce[X.gc_type])==null?void 0:Bt.desc)||"",Me=ve!=null&&ve.image_url?`/icons/${ve.image_url}`:null,kt=((gt=Ce[X.gc_type])==null?void 0:gt.icon)||"⚡",Pe=Math.round(Ae*.22),ft=Math.round(Ae*.22),at=Ae-Pe-ft,Ct=De.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
        style="box-sizing:border-box;width:${fe}px;height:${Ae}px;border-radius:10px;border:2px solid ${rt};background:${jt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Rt(_,f[p+"Formation"],ut,Z,ne?1300:zt(),ne?600:Pt(),Ue)}
      </div>
    </div>`,ot=f[p+"Team"],Fn=(()=>{var fe,Ae,ve,jt,rt;if(q&&((fe=f.pendingAttack)!=null&&fe.players)){const De=f.pendingAttack;let Oe="";if(U.length>0){const Me=U.map(Pe=>{const ft=(ot[Pe._role]||[]).find(xi=>xi.cardId===Pe.cardId)||Pe,at=ot[Pe._role]||[],Ct=at.findIndex(xi=>xi.cardId===Pe.cardId),Bt=xt(at.length),gt=Ct>=0?Bt[Ct]:ft._col??1;return{...ft,_line:Pe._role,_col:gt}}),kt=Jt(Me,((Ae=f.modifiers)==null?void 0:Ae[p])||{},f[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          ${Oe}
        </div>`}if(B&&((ve=f.pendingAttack)!=null&&ve.players)){const De=f.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
        ...
        </div>`}const X=(f.log||[]).slice(-1)[0];return X?'<div style="padding:2px 4px">'+An(X)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),Ni=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">${Fn}</div>
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Rt(_,f[p+"Formation"],ut,Z,zt(),Pt(),Ue)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Mt(){const X=e.querySelector(".match-screen");if(!X)return;const fe=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=fe+"px",X.style.minHeight=fe+"px",X.style.maxHeight=fe+"px",X.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),ve=e.querySelector("#mobile-play-area");Ae&&ve&&(ve.style.paddingBottom=Ae.offsetHeight+"px")}if(Mt(),setTimeout(Mt,120),setTimeout(Mt,400),P||(P=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Mt),window.visualViewport.addEventListener("scroll",Mt)),window.addEventListener("resize",Mt)),function(){const fe=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!fe)return;const Ae=fe.closest("#match-terrain-wrap");Ae&&(Ae.style.cssText="position:relative;width:100%;height:100%;padding:0"),fe.removeAttribute("width"),fe.removeAttribute("height"),fe.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",fe.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const fe=X.closest("#match-terrain-wrap");fe&&(fe.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!B&&!q)return;const fe=X.dataset.cardId,Ae=X.dataset.role,ve=(_[Ae]||[]).find(Oe=>Oe.cardId===fe);if(!ve||ve.used)return;const jt=Ue.includes(fe);if(B&&!["MIL","ATT"].includes(Ae)&&!jt)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const rt=f["selected_"+p],De=rt.findIndex(Oe=>Oe.cardId===fe);De>-1?rt.splice(De,1):rt.length<3&&rt.push({...ve,_role:Ae}),W()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>Y(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>Y())}),(Oi=e.querySelector("#pvp-sub-open"))==null||Oi.addEventListener("click",()=>Y()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{B?X.addEventListener("click",()=>S(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Hi=e.querySelector("#pvp-boost-card"))==null||Hi.addEventListener("click",()=>D()),(Ui=e.querySelector("#pvp-action"))==null||Ui.addEventListener("click",X=>{B?X.currentTarget.dataset.pass==="1"||!je(p)?O():Ee():q&&Te()}),(Ki=e.querySelector("#pvp-quit"))==null||Ki.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&L()}),(Vi=e.querySelector("#pvp-view-opp"))==null||Vi.addEventListener("click",()=>R()),(Yi=e.querySelector("#pvp-toggle-history"))==null||Yi.addEventListener("click",()=>C()),k&&(clearInterval(k),k=null),(B||q)&&!M){let X=30,fe=!1;const Ae=()=>document.getElementById("pvp-timer"),ve=()=>{Ae()&&(Ae().textContent=X+"s",Ae().style.color=fe?"#ff4444":"#fff")};ve(),k=setInterval(()=>{X--,X<0?fe?(clearInterval(k),k=null,B&&!je(p)?O():L()):(fe=!0,X=15,ve()):ve()},1e3)}}function pe(){dt(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:${F};letter-spacing:3px;text-transform:uppercase;font-weight:700;animation:gcLabel .4s ease both">${ee} joue une carte</div>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(J);let se=!1;const de=()=>{se||(se=!0,J.remove(),setTimeout(()=>z&&z(),50))};J.addEventListener("click",de),setTimeout(de,3e3)}function S(_,E){var J,se,de,me;const A=(f["gcCardsFull_"+p]||[]).find(le=>le.id===_),T=A==null?void 0:A._gcDef,F={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",B={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",q=(T==null?void 0:T.name)||E,U=(T==null?void 0:T.effect)||((J=Ce[E])==null?void 0:J.desc)||"Carte spéciale.",Z=T!=null&&T.image_url?`/icons/${T.image_url}`:null,ne=((se=Ce[E])==null?void 0:se.icon)||"⚡",ee=document.createElement("div");ee.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",ee.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${B};background:${F};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${B}66">
        ...
        <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Z?`<img src="${Z}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${ne}</span>`}
        </div>
        <div style="padding:10px;background:rgba(0,0,0,0.38);text-align:center">
      ...
      </div>`,document.body.appendChild(z),(A=z.querySelector("#bp-close"))==null||A.addEventListener("click",()=>z.remove()),z.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const F=T.dataset.cid,B=E.find(U=>U.cardId===F);if(!B)return;const q=(_[B._line]||[]).find(U=>U.cardId===F);q&&(q.boost=(q.boost||0)+f.boostValue),z.remove(),await j({[p+"Team"]:_,boostUsed:!0})})})}function Y(_=null){var se,de;if(!(f.phase===p+"-attack")){m("Remplacement uniquement avant votre attaque","warning");return}const z=f[p+"Team"],A=f["usedSubIds_"+p]||[],T=f.maxSubs||3;if(A.length>=T){m(`Maximum ${T} remplacements atteint`,"warning");return}const F=Object.entries(z).flatMap(([me,le])=>(le||[]).filter(xe=>xe.used).map(xe=>({...xe,_line:me}))),B=(f[p+"Subs"]||[]).filter(me=>!A.includes(me.cardId));if(!F.length){m("Aucun joueur utilisé à remplacer","warning");return}if(!B.length){m("Aucun remplaçant disponible","warning");return}let q=Math.max(0,F.findIndex(me=>me.cardId===_));const U=((se=F[q])==null?void 0:se._line)||((de=F[q])==null?void 0:de.job);let Z=Math.max(0,B.findIndex(me=>me.job===U)),ne=!1;const ee=document.createElement("div");ee.id="pvp-sub-overlay",ee.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function J(){var Ne,Ie,We,Ue,it,Ht;const me=F[q],le=B[Z],xe=Math.min(130,Math.round((window.innerWidth-90)/2)),ye=Math.round(xe*1.35),oe=qe=>`background:rgba(255,255,255,0.12);border:none;color:${qe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${qe?"default":"pointer"};flex-shrink:0`;ee.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <button id="pin-down" style="${oe(Z>=B.length-1)}" ${Z>=B.length-1?"disabled":""}>▼</button>
      ...
      </div>`,(Ne=ee.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>ee.remove()),(Ie=ee.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{q>0&&(q--,J())}),(We=ee.querySelector("#pout-down"))==null||We.addEventListener("click",()=>{q<F.length-1&&(q++,J())}),(Ue=ee.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{Z>0&&(Z--,J())}),(it=ee.querySelector("#pin-down"))==null||it.addEventListener("click",()=>{Z<B.length-1&&(Z++,J())});const Le=(qe,Xe,Ke,pt)=>{const nt=ee.querySelector("#"+qe);if(!nt)return;let St=0;nt.addEventListener("touchstart",ut=>{St=ut.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",ut=>{const _t=ut.changedTouches[0].clientY-St;if(Math.abs(_t)<30)return;const ot=Xe();_t<0&&ot<pt-1?(Ke(ot+1),J()):_t>0&&ot>0&&(Ke(ot-1),J())},{passive:!0})};Le("pin-panel",()=>Z,qe=>Z=qe,B.length),Le("pout-panel",()=>q,qe=>q=qe,F.length),(Ht=ee.querySelector("#psub-confirm"))==null||Ht.addEventListener("click",async qe=>{if(qe.preventDefault(),qe.stopPropagation(),ne)return;ne=!0;const Xe=F[q],Ke=B[Z];if(!Xe||!Ke)return;const pt=Xe._line,nt=(z[pt]||[]).findIndex(_t=>_t.cardId===Xe.cardId);if(nt===-1){m("Erreur : joueur introuvable","error"),ee.remove();return}const St={...Ke,_line:pt,position:Xe.position,used:!1,boost:0};z[pt].splice(nt,1,St);const ut=[...A,Ke.cardId];ee.remove(),Q(Xe,Ke,async()=>{await j({[p+"Team"]:z,[u+"Team"]:f[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(ee),J()}function Q(_,E,z){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const F=(U,Z,ne)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${Z};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${ne}</div>
      <div style="width:70px;height:70px;border-radius:50%;background:${A[U.job]||"#555"};border:3px solid ${Z};position:relative;overflow:hidden;margin:0 auto">
      ...
      <div style="width:min(90vw,420px)">${ui(f[u+"Team"],f[u+"Formation"],null,[],zt(),Pt())}</div>
      ...
      </div>`,document.body.appendChild(E),(z=E.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>E.remove())}async function O(){if(f.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",E=(f.round||0)+1,z=[...f.log||[]];z.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=Re(f),T=je(_),F=A||!T?"finished":_+"-attack";await j({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:F,attacker:_,round:E,log:z}),F==="finished"&&await He(f)}function ce(_){const E=(_.GK||[]).some(A=>!A.used),z=["DEF","MIL","ATT"].some(A=>(_[A]||[]).some(T=>!T.used));return E&&!z}function ke(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ce(_.p1Team)&&!ze(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:ce(_.p2Team)&&!ze(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function _e(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(z,A)=>new Promise(T=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${A};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function be(_,E){const{side:z,gk:A}=_;if(!A)return;const T=z+"Score",F=(E[T]||0)+1;A.used=!0;const B=[...E.log||[]];B.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[qt(A)]:[],aiPlayers:z==="p2"?[qt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[z+"Name"]} marque !`});const q=(E.round||0)+1,U=z==="p1"?"p2":"p1",Z={...E,[T]:F},ne=Re(Z);H.add(q),await _e();const ee=z===p?F:E[p+"Score"]||0,J=z===p?E[u+"Score"]||0:F;Qe([qt(A)],ee,J,z===p,async()=>{await j({[T]:F,log:B,round:q,pendingAttack:null,phase:ne?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),ne&&await He({...f,[T]:F})})}async function Ee(){const _=f[p+"Team"],E=!["GK","DEF","MIL","ATT"].some(F=>(f[u+"Team"][F]||[]).some(B=>!B.used)),z=(f["selected_"+p]||[]).map(F=>{const B=(_[F._role]||[]).find(de=>de.cardId===F.cardId)||F,q=["GK","DEF"].includes(F._role),U=_[F._role]||[],Z=U.findIndex(de=>de.cardId===F.cardId),ne=xt(U.length),ee=Z>=0?ne[Z]:B._col??1,J=f.stadiumDef||f.homeStadiumDef||null,se=B.stadiumBonus||J&&(J.club_id&&String(B.club_id)===String(J.club_id)||J.country_code&&B.country_code===J.country_code)||!1;return{...B,_line:F._role,_col:ee,stadiumBonus:se,...q?{note_a:Math.max(1,Number(B.note_a)||0)}:{}}});if(!z.length)return;const A=Xt(z,f.modifiers[p]||{},f[p+"Formation"]);ge(p,z.map(F=>F.cardId)),z.forEach(F=>{const B=(_[F._role]||[]).find(q=>q.cardId===F.cardId);B&&(B.used=!0)}),f["selected_"+p]=[],W();const T=[...f.log||[]];if(E){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await be({side:p,gk:z[0]},{...f,[p+"Team"]:_,log:T});return}const B=(f[p+"Score"]||0)+1,q=z.map(J=>qt(J));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:q,homeTotal:A.total,aiTotal:0});const U=(f.round||0)+1,Z=p==="p1"?"p2":"p1",ne={...f,[p+"Team"]:_,[p+"Score"]:B},ee=Re(ne);H.add(U),Qe(q,B,f[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:_,[p+"Score"]:B,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:ee?"finished":Z+"-attack",attacker:Z,round:U,log:T}),ee&&await He({...f,[p+"Score"]:B})});return}T.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${A.total})`}),await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],pendingAttack:{...A,players:z,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Te(){const _=f[p+"Team"],E=(f["selected_"+p]||[]).map(le=>{const xe=(_[le._role]||[]).find(Ie=>Ie.cardId===le.cardId)||le,ye=_[le._role]||[],oe=ye.findIndex(Ie=>Ie.cardId===le.cardId),Le=xt(ye.length),Ne=oe>=0?Le[oe]:xe._col??1;return{...xe,_line:le._role,_col:Ne}}),z=Jt(E,f.modifiers[p]||{},f[p+"Formation"]);ge(p,E.map(le=>le.cardId)),E.forEach(le=>{const xe=(_[le._role]||[]).find(ye=>ye.cardId===le.cardId);xe&&(xe.used=!0)}),f["selected_"+p]=[],W();const A=Di(f.pendingAttack.total,z.total,f.modifiers[p]||{}),T=f.pendingAttack.side,F=A==="attack"||(A==null?void 0:A.goal),B=T==="p1"?"p2":"p1",q=(f.round||0)+1,U=(f.pendingAttack.players||[]).map(le=>qt(le)),Z=[...f.log||[]];Z.push({type:"duel",isGoal:F,homeScored:F&&T===p,text:F?`⚽ BUT de ${f[T+"Name"]} ! (${f.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${z.total})`,homePlayers:U,aiPlayers:E.map(le=>qt(le)),homeTotal:f.pendingAttack.total,aiTotal:z.total});const ne=F?(f[T+"Score"]||0)+1:f[T+"Score"]||0,ee={...f,[p+"Team"]:_,[T+"Score"]:ne},J=Re(ee),se=J?"finished":B+"-attack",de=!J&&!F?ke(ee):null,me=async()=>{if(de){await be(de,ee);return}await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],[T+"Score"]:ne,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:se,attacker:B,round:q,log:Z}),(se==="finished"||J)&&await He({...f,[T+"Score"]:ne})};if(F){const le=T===p,xe=le?ne:f[p+"Score"]||0,ye=le?f[u+"Score"]||0:ne;H.add(q),Qe(U,xe,ye,le,me)}else await me()}function he(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function ze(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function Fe(_){return ze(_)&&!he(_)}function je(_){const E=f[_+"Team"],z=f[(_==="p1"?"p2":"p1")+"Team"];return!!(he(E)||Fe(E)&&!ze(z)||Fe(E)&&!he(z)&&ze(z))}function Re(_){return!ze(_.p1Team)&&!ze(_.p2Team)}function tt(_){const E=_.p1Score||0,z=_.p2Score||0;return E===z?null:E>z?h.home_id:h.away_id}async function He(_){try{const E=tt(_),z=E?h.home_id===E?h.away_id:h.home_id:null,A=_.p1Score||0,T=_.p2Score||0,{data:F,error:B}=await w.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:A,p_away_score:T,p_forfeit:!1});if(B&&console.error("[PvP] finish_pvp_match:",B),d)try{await w.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(q){console.error("[PvP] check_and_finish_mini_league:",q)}E&&z&&co(E,z).catch(()=>{});try{const{data:q}=await w.rpc("apply_match_rewards",{p_match_id:i});q!=null&&q.success&&!(q!=null&&q.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(q){console.error("[PvP] apply_match_rewards:",q)}if(typeof c=="function")try{await c({homeScore:A,awayScore:T,winnerId:E,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(q){console.error("[PvP] onMatchEnd:",q)}}catch(E){console.error("[PvP] finishMatch:",E)}}function mi(){var T;const _=f[p+"Score"],E=f[u+"Score"],z=_>E,A=_===E;dt(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{w.removeChannel(te)}catch{}et(e),d?g("mini-league",{openLeagueId:d}):g("home")})}W()}async function Ii(e,t,i=!1){var s,l;const{state:n,navigate:r,toast:o}=t,a=i&&((l=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:l.rankedData)||null;await fi(e,t,i?"ranked":"random",async({deckId:c,formation:d,starters:x,subsRaw:y,gcCardsEnriched:g,gcDefs:m,stadiumDef:p})=>{dt(e);const u=async b=>{await cr(e,t,c,d,x,y,b||[],m,p,i,a)};if(!(g!=null&&g.length)){await u([]);return}pi(e,g,u)})}async function lr(e,t,i){return dr(e,t,i)}async function cr(e,t,i,n,r,o,a=[],s=[],l=null,c=!1,d=null){var re,te;const{state:x,navigate:y,toast:g}=t,m=(d==null?void 0:d.mmr)??((re=x.profile)==null?void 0:re.mmr)??1e3,p=c?Ci(m):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let v=!1,h=null,$=null;e.innerHTML=`
    ...
    </div>`;const f=async()=>{v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null);try{await w.rpc("cancel_matchmaking",{p_user_id:x.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(te=document.getElementById("cancel-mm"))==null||te.addEventListener("click",async()=>{await f(),et(e),y("home")});const M=async(j,L)=>{v||(v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null),await At(e,t,j,L,{myGC:a,gcDefs:s,stadiumDef:l,isRanked:c,rankedData:d,onMatchEnd:c?pr:null}))},k=x.user.id,{data:P,error:H}=c?await w.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:m}):await w.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(H||!(P!=null&&P.success)){console.error("[Matchmaking] try_matchmake error:",H||P),g("Erreur de matchmaking","error"),et(e),y("home");return}if(P.matched){await M(P.match_id,!1);return}const ae=async()=>{if(v)return;const{data:j}=await w.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await M(j.match_id,!0)};h=w.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},j=>{const L=j.new;L.status==="matched"&&L.match_id&&M(L.match_id,!0)}).subscribe(),$=setInterval(ae,3e3),setTimeout(()=>{v||f()},12e4)}async function pr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:l,matchId:c}=e,d=i.user.id,x=o===d,y=r===d,{data:g}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",d).single(),{data:m}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",x?a:o).single();if(g&&m){const p=Pn(g.mmr,g.mmr_rd,g.mmr_v,m.mmr,m.mmr_rd,y?1:0);await w.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?w.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:w.sql`mmr_losses + 1`}).eq("id",d),n(y?`+MMR ↑ ${Math.round(p.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-p.mmr)}`,y?"success":"error",4e3)}}const ur=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ii,resumePvpMatch:lr},Symbol.toStringTag,{value:"Module"}));async function fr(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",l=!!o.isAccepting;await fi(e,t,"friend",async({deckId:c,formation:d,starters:x,subsRaw:y,gcCardsEnriched:g,gcDefs:m,stadiumDef:p})=>{dt(e);const u=async b=>{const v=b||[];l?await mr(e,t,c,v,m,p):await gr(e,t,c,v,m,p,a,s)};if(!(g!=null&&g.length)){await u([]);return}pi(e,g,u)})}async function gr(e,t,i,n,r,o,a,s){var v;const{state:l,navigate:c,toast:d}=t,x=l.user.id,{data:y,error:g}=await w.from("friend_match_invites").insert({inviter_id:x,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!y){console.error("[Friend] Erreur création invitation:",g),d("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Tt}">
      ${v.map(f=>`<button class="ml-tab" data-tab="${f.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===f.key?Cn:"transparent"};background:none;font-size:12px;font-weight:${i===f.key?"900":"600"};color:${i===f.key?"#4ade80":Ve};cursor:pointer">${f.label}${f.count?` (${f.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?yr(g,b,r):i==="active"?br(m,r):hr(u,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>vr(e,t)),($=document.getElementById("ml-refresh-list"))==null||$.addEventListener("click",()=>Ze(e,t,i)),e.querySelectorAll(".ml-tab").forEach(f=>f.addEventListener("click",()=>Ze(e,t,f.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(f=>f.addEventListener("click",()=>ct(e,t,f.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(f=>f.addEventListener("click",M=>{M.stopPropagation(),Bn(e,t,f.dataset.join,f.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(f=>f.addEventListener("click",M=>{M.stopPropagation(),Ai(e,t,f.dataset.delete,f.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(f=>f.addEventListener("click",async M=>{M.stopPropagation(),f.disabled=!0,f.textContent="...";const{data:k,error:P}=await w.rpc("claim_mini_league_prize",{p_league_id:f.dataset.claimLeague,p_user_id:n.profile.id});if(P||!(k!=null&&k.success)){t.toast((k==null?void 0:k.error)||"Erreur lors de la récupération","error"),Ze(e,t,i);return}if(!k.already_claimed){n.profile.credits=(n.profile.credits||0)+k.prize;const H=document.getElementById("nav-credits");H&&(H.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${k.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}Ze(e,t,i)}))}function ci(e,t,i=!1,n=null){var l,c;const r=e.creator_id===t,o=e.pot||0,a=((c=(l=e.mini_league_members)==null?void 0:l[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Ut};border:1px solid ${s?"rgba(212,160,23,0.5)":Et};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function Bn(e,t,i,n){var x;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await wr(),s===null))return;const{data:l,error:c}=await w.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(c||!(l!=null&&l.success)){console.error("[MiniLeague] join_mini_league:",c||l),r((l==null?void 0:l.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:y}=await w.from("users").select("credits").eq("id",a).single();o.profile&&y&&(o.profile.credits=y.credits)}const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${(((x=o.profile)==null?void 0:x.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ct(e,t,i)}async function _r(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(y=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),y(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),y(!1)}}))return;const{data:l,error:c}=await w.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(l!=null&&l.success)){r((l==null?void 0:l.error)||"Erreur lors de la désinscription","error");return}const d=l.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+d);const x=document.getElementById("nav-credits");x&&(x.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${d.toLocaleString("fr")} cr. remboursés`,"success"),Ze(e,t,"waiting")}async function Ai(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await w.from("mini_league_matches").delete().eq("league_id",i),await w.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await w.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),Ze(e,t,r)}async function kr(e,t,i){await w.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),Ze(e,t,"archived")}async function ct(e,t,i){var $,f,M,k,P,H,ae,re,te;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:l}]=await Promise.all([w.from("mini_leagues").select("*").eq("id",i).single(),w.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),w.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await Ze(e,t);return}const c=(s||[]).some(j=>j.user_id===o),d=a.creator_id===o,x=(s||[]).map(j=>j.user).filter(Boolean),y=zr(x,l||[]),g=(l||[]).filter(j=>j.matchday===a.current_day),m=a.pot||0,p=a.entry_fee||100,u=g.length>0&&g.every(j=>j.status==="finished"||j.status==="bye"),b=a.current_day>=a.total_days,v=(s||[]).find(j=>j.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      ${a.status==="waiting"?`
      <div style="background:${Ut};border:1px solid ${Et};border-radius:12px;padding:16px">
        ...
        ${x.map(j=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${Tt}">
            <div style="width:36px;height:36px;border-radius:50%;background:${j.club_color2||Cn};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${j.club_color1||"#fff"}">${(j.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:${Ut};border:1px solid ${Et};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,L)=>L+1).reverse().map(j=>{const L=(l||[]).filter(V=>V.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ve};margin-bottom:6px">Journée ${j}</div>${L.map(V=>ln(V,x,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if(($=document.getElementById("ml-back"))==null||$.addEventListener("click",()=>Ze(e,t,h)),(f=document.getElementById("ml-refresh"))==null||f.addEventListener("click",async j=>{const L=j.currentTarget;L.style.opacity="0.5",await ct(e,t,i)}),(M=document.getElementById("ml-start-btn"))==null||M.addEventListener("click",()=>$r(e,t,a,x)),(k=document.getElementById("ml-next-day"))==null||k.addEventListener("click",()=>Er(e,t,i)),(P=document.getElementById("ml-join-now"))==null||P.addEventListener("click",()=>Bn(e,t,i,a.type)),(H=document.getElementById("ml-leave-btn"))==null||H.addEventListener("click",()=>_r(e,t,i,p)),(ae=document.getElementById("ml-delete-btn"))==null||ae.addEventListener("click",()=>Ai(e,t,i,a.name,"waiting")),(re=document.getElementById("ml-delete-now"))==null||re.addEventListener("click",()=>Ai(e,t,i,a.name,h)),(te=document.getElementById("ml-archive-btn"))==null||te.addEventListener("click",()=>kr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(j=>{j.addEventListener("click",()=>{const L=g.find(V=>V.id===j.dataset.playMatch);L&&t.navigate("match-mini-league",{mlMatchId:L.id,leagueId:i})})}),a.status==="finished"&&v){const j=y.findIndex(L=>L.userId===o);j>=0&&j<3&&v.prize_amount>0&&!v.prize_claimed&&setTimeout(()=>Tr(e,t,a,v,j),400)}}function ln(e,t,i,n,r=!1){const o=x=>t.find(y=>y.id===x);if(e.is_bye){const x=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${st};text-align:center">🔵 ${(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),l=e.home_id===i||e.away_id===i,c=l&&e.status==="pending"&&n&&!r,d=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${l?"rgba(74,222,128,0.35)":Tt}">
  ...
  </div>`}async function $r(e,t,i,n){const{toast:r,state:o}=t,a=Lr(n.map(c=>c.id),i.mode),s=[];a.forEach((c,d)=>c.forEach(x=>s.push({league_id:i.id,matchday:d+1,home_id:x.home||x.bye,away_id:x.away||null,is_bye:!!x.bye,status:x.bye?"bye":"pending"})));const{error:l}=await w.from("mini_league_matches").insert(s);if(l){r("Erreur calendrier : "+l.message,"error");return}await w.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ct(e,t,i.id)}async function Er(e,t,i){const{data:n}=await w.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){ct(e,t,i);return}await w.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),ct(e,t,i)}async function Tr(e,t,i,n,r){var y,g;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],l=["🥇","🥈","🥉"][r],c=n.prize_amount||s[r]||0,d=n.prize_claimed,x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",x.innerHTML=`
    ...
    </div>`;let d=!1;const x=async u=>{if(!d){if(d=!0,clearInterval(m),g)try{g.unsubscribe()}catch{}u&&await At(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),l()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(m),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),l()});const y=async()=>{if(d)return;const{data:u}=await w.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&x(u.match_id)},g=w.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&x(u.new.match_id)}).subscribe(),m=setInterval(y,3e3);y()})}const Ar="/",Sr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Mr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var d,x,y;const s=t[n],l=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${s.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${Ar}icons/${s.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `,r.querySelectorAll("ul,ol").forEach(g=>{g.style.paddingLeft="20px",g.style.marginTop="6px",g.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(g=>{g.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(g=>{g.style.marginBottom="8px"}),(d=r.querySelector("#tuto-prev"))==null||d.addEventListener("click",()=>{n--,o()}),(x=r.querySelector("#tuto-next"))==null||x.addEventListener("click",()=>{l?a():(n++,o())}),(y=r.querySelector("#tuto-skip"))==null||y.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),e!=null&&e.id&&await w.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(r),o()}async function jr(e,t,i){if(!e||e.tutorial_done)return;let n=[];const{data:r,error:o}=await w.rpc("get_tutorial_steps");if(!o&&(r==null?void 0:r.length)>0)n=r,console.log(`[Tutorial] RPC OK → ${n.length} étapes`);else{const{data:s,error:l}=await w.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!l&&(s==null?void 0:s.length)>0?(n=s,console.log(`[Tutorial] Direct OK → ${n.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${o==null?void 0:o.message}, Direct: ${l==null?void 0:l.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=n.length>0?n.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):Sr;Mr(e,a,()=>t("boosters"))}const oi={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Dt(e,t,i=0){return t?(Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0)+(t===e.job||t===e.job2?i:0):0}async function Cr(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await Ri(e,t)}async function Ri(e,t){const{state:i,toast:n}=t,{data:r}=await w.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
    ...
    </div>`,document.body.appendChild(r);const o=s=>{r.remove(),s&&t()};r.querySelector("#buy-cancel").addEventListener("click",()=>o(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>o(!0)),r.addEventListener("click",s=>{s.target===r&&o(!1)})}async function Dr(e,t,i){const{toast:n}=i,{data:r}=await w.from("market_listings").select("card_id").eq("id",e).single();if(await w.from("market_listings").update({status:"cancelled"}).eq("id",e),r!=null&&r.card_id){const{count:o}=await w.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");o||await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}n("Annonce retirée","success"),Ri(t,i)}async function Fr(e,t){var d,x,y,g;const{state:i,navigate:n}=t,r=((x=(d=t==null?void 0:t.state)==null?void 0:d.params)==null?void 0:x.tab)||"global";e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:o},{data:a}]=await Promise.all([w.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100),w.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").gte("placement_matches",1).order("mmr",{ascending:!1}).limit(100)]);let s=r;function l(){var p,u;const m=document.getElementById("rankings-list");if(m){if(s==="global"){const b=o||[];m.innerHTML=b.length>0?b.map((v,h)=>`
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=a||[];m.innerHTML=b.length>0?b.map((v,h)=>{const $=Ci(v.mmr??1e3),f=(v.ranked_wins||0)+(v.ranked_losses||0)+(v.ranked_draws||0),M=f>0?Math.round((v.ranked_wins||0)/f*100):0,k=v.id===i.profile.id,P=(v.placement_matches||0)<10;return`
  ...
  </div>`}Rn(On);const we={user:null,profile:null,page:"home",params:{}};function Ft(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Rr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Si(){document.getElementById("modal-overlay").classList.add("hidden")}async function Kt(){if(!we.user)return;const{data:e}=await w.from("users").select("*").eq("id",we.user.id).single();e&&(we.profile=e)}function Vt(e,t={}){we.page=e,we.params=t,qn()}async function qn(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===we.page)});const t=document.getElementById("nav-credits");t&&we.profile&&(t.textContent=`💰 ${(we.profile.credits||0).toLocaleString("fr")}`);const i={state:we,navigate:Vt,toast:Ft,openModal:Rr,closeModal:Si,refreshProfile:Kt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',we.page){case"home":await Qi(e,i);break;case"collection":await bo(e,i);break;case"decks":await ki(e,i);break;case"boosters":await So(e,i);break;case"ranked":await Pr(e,i);break;case"match":{const s=we.params&&we.params.matchMode||"vs_ai_easy";s==="random"?await Ii(e,i,!1):s==="ranked"?await Ii(e,i,!0):s==="friend"?await fr(e,i,(n=we.params)==null?void 0:n.friendId,(r=we.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await cn(e,i,(o=we.params)==null?void 0:o.mlMatchId,(a=we.params)==null?void 0:a.leagueId):await Ko(e,i);break}case"market":await Cr(e,i);break;case"rankings":await Fr(e,i);break;case"matches":await Gr(e,i);break;case"friends":await Xn(e,i);break;case"mini-league":await xr(e,i);break;case"match-mini-league":{const s=we.params||{};await cn(e,i,s.mlMatchId,s.leagueId);break}default:await Qi(e,i)}}function Nr(){var n;const e=document.getElementById("app"),t=we.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.19-1839" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(r=>{r.addEventListener("click",o=>{o.preventDefault(),Vt(r.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Vt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Vt("boosters")),(n=document.getElementById("journal-btn"))==null||n.addEventListener("click",()=>Or())}async function Or(){const{data:e}=await w.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(n=>{const r=new Date(n.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}function Hr(e,{onPlay:t}){var n;const i="/icons/";e.style.cssText="",e.innerHTML=`
  <style>
    #public-landing{
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function Ur(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Si()}),document.getElementById("modal-close").addEventListener("click",Si);const{data:{session:e}}=await w.auth.getSession();if(!e){pn(),Hr(document.getElementById("app"),{onPlay:()=>Wi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft})});return}we.user=e.user,await Kt(),pn();try{const{data:i}=await w.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),Nn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!we.profile){Un(document.getElementById("app"),{state:we,navigate:async()=>{await Kt(),_i()},toast:Ft,refreshProfile:Kt});return}const t=Array.isArray(we.profile.pending_boosters)?we.profile.pending_boosters:[];if(!we.profile.onboarding_done&&t.length>0){Po(document.getElementById("app"),{state:we,navigate:()=>_i(),toast:Ft,refreshProfile:Kt});return}_i(),setTimeout(()=>jr(we.profile,Vt,Ft),800),w.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(we.user=null,we.profile=null,document.getElementById("app").innerHTML="",Wi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Ft}))})}function Kr(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function gi(){const e=document.getElementById("app");e&&(e.style.height=Kr()+"px")}window.addEventListener("resize",gi);window.addEventListener("orientationchange",()=>setTimeout(gi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",gi);function _i(){const e=()=>{var i;(i=we.user)!=null&&i.id&&w.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",we.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",gi(),Nr(),qn()}function pn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Dn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}Ur().catch(e=>{console.error("Échec du démarrage:",e),Dn()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&Dn("Le serveur met trop de temps à répondre.")},12e3);
