...
import{s as v,j as Ei,q as Bo,t as Dt,u as Li,F as Ii,o as nt,n as Ht,g as Bt,r as ze,m as ut,v as ni,w as qo,T as Bi,p as hn,x as vn,d as wn}from"./special-cards-YynorolH.js";const _n="/";function mo(t,{navigate:e,toast:i}){let o="login";const a=()=>{var r,s,c,l,d,f,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const l=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",x=f.trim().split(" ").filter(Boolean),b=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():f.slice(0,2).toUpperCase();l&&(l.style.background=r,l.style.borderColor=n),d&&(d.textContent=b,d.style.color=n)}document.getElementById("color1").addEventListener("input",l=>{n=l.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",l=>{r=l.target.value,document.getElementById("swatch2").style.background=r,s()});function c(l){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",l.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",l).maybeSingle();if(f){d.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",l.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",l).maybeSingle();if(f){d.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),x=document.getElementById("step3-finish");f.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:l,club_name:d,club_color1:n,club_color2:r,credits:15e3});if(b)throw b;await $n(e.user.id),await a(),o(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){f.textContent=b.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function $n(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const En="modulepreload",Ln=function(t){return"/"+t},go={},Do=function(e,i,o){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(c=>{if(c=Ln(c),c in go)return;go[c]=!0;const l=c.endsWith(".css"),d=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${d}`))return;const f=document.createElement("link");if(f.rel=l?"stylesheet":En,l||(f.as="script"),f.crossOrigin="",f.href=c,s&&f.setAttribute("nonce",s),document.head.appendChild(f),l)return new Promise((x,b)=>{f.addEventListener("load",x),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},Fo="mw_sound_volume";function Xi(){const t=localStorage.getItem(Fo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function In(t){localStorage.setItem(Fo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Ji(){return Xi()===0}function yi(t){return Math.max(0,Math.min(1,t*(Xi()/100)))}function Qi(t,e=1){if(Ji())return null;try{const i=new Audio(t);return i.volume=yi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Ni=null,bo=.3;function Po(t,e=.3){if(bo=e,ht&&Ni===t&&!ht.paused){ht.volume=yi(bo);return}if(Rt(),!Ji())try{const i=new Audio(t);i.loop=!0,i.volume=yi(e),i.play().catch(()=>{}),ht=i,Ni=t}catch{}}function Rt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Ni=null}let Qt=null;function No(t,e=.6){if(Ke(),!Ji())try{const i=new Audio(t);i.volume=yi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const Tn=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Go(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const d=document.createElement("style");d.id="home2-chrome-style",d.textContent=`
    ...
    `,document.head.appendChild(d)}const a=Tn.map(d=>`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function qi(t,{state:e,navigate:i,toast:o}){var E,m,A,$,T,P;const a=e.profile;if(!a)return;const n="/icons/";Go(i,a,"home2",n);const r=a.mmr??1e3,s=Ei(r),c=An(r,s),l=Bo(r),d=isFinite(s.max)?s.max+1:null,[{list:f,iAmInTop:x,myPosition:b},g,p]=await Promise.all([zn(a.id),Mn(5),Cn()]),u=(G,O)=>`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Sn(G.published_at)}</div>
      </div>
  ...
  <div class="home-dark" id="home-dark">
          ...
          <div class="rank-card">
            <div class="rank-top-row">
              ...
              <div class="rank-right">
                <div class="rank-rp-label">${r.toLocaleString("fr")}${d?" / "+d.toLocaleString("fr"):""} RP</div>
  ...
  </div>`,document.body.appendChild(e),e.querySelector("#ab-cancel").addEventListener("click",()=>e.remove()),e.querySelector("#ab-ok").addEventListener("click",()=>{e.remove(),t()}),e.addEventListener("click",i=>{i.target===e&&e.remove()})}async function Fn(t,e,i){var s,c,l,d;const o=document.getElementById("match-invite-banner");if(!o)return;const{data:a}=await v.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",t.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!a){o.innerHTML="";return}const n=((s=a.inviter)==null?void 0:s.club_name)||((c=a.inviter)==null?void 0:c.pseudo)||"?",r=a.inviter_id;o.innerHTML=`<div id="match-invite-btn" style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(26,10,46,0.8),rgba(74,26,138,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(122,40,184,0.4);cursor:pointer;box-shadow:0 3px 12px rgba(74,10,138,0.3)">
  ...
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>Ko(t,e,()=>Oo(t,e)))}async function Ho(t,e){const i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:420px;border-radius:18px;overflow:hidden">
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",l=>{l.target===i&&o()});const[{data:a},{data:n}]=await Promise.all([v.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),v.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),r=(n==null?void 0:n.unlocked_level)||1,s=a||[],c=document.getElementById("solo-levels-list");if(c){if(!s.length){c.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}c.innerHTML=s.map(l=>{const d=l.level_number>r,f=l.level_number===r,x=d?"#f0f0f0":f?"#eefaf2":"#f7f7f7",b=d?"#ddd":f?"#bfe8cf":"#e0e0e0",g=d?"#999":"#12401f";return`
      <div class="solo-level-card" data-level="${l.level_number}" data-locked="${d}"
        ...
        ${d?"":`<div style="font-weight:900;font-size:12.5px;color:${g};background:rgba(255,255,255,0.7);padding:6px 11px;border-radius:999px;flex-shrink:0;white-space:nowrap">+${l.reward_credits} cr.</div>`}
      </div>`}).join(""),c.querySelectorAll(".solo-level-card").forEach(l=>{l.dataset.locked!=="true"&&(l.addEventListener("mouseenter",()=>{l.style.transform="translateY(-1px)"}),l.addEventListener("mouseleave",()=>{l.style.transform=""}),l.addEventListener("click",()=>{o(),mt(),t("match",{matchMode:"solo",soloLevel:Number(l.dataset.level)})}))})}}const ri="#1A6B3C",ai="#cc2222",Pn="#D4A017",xo="#888";async function Nn(t,e){const{state:i,toast:o}=e;t.innerHTML=`
    ...
    </div>`,await Uo(i,o,e),document.getElementById("btn-add-friend").addEventListener("click",()=>Rn(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Ko(i,o,null,e))}async function Uo(t,e,i={}){const{navigate:o}=i,a=t.user.id,{data:n,error:r}=await v.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${a},addressee_id.eq.${a}`),{count:s}=await v.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",a).eq("status","pending"),c=document.getElementById("pending-badge");c&&(s>0?(c.style.display="flex",c.textContent=s):c.style.display="none");const l=document.getElementById("friends-list");if(!l)return;if(r){console.error("[Friends] Erreur:",r),l.innerHTML=`<div style="color:${ai};text-align:center;padding:16px">Erreur chargement : ${r.message}</div>`;return}const d=(n||[]).map(b=>b.requester_id===a?b.addressee_id:b.requester_id);let f={};if(d.length){const{data:b}=await v.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",d);(b||[]).forEach(g=>{f[g.id]=g})}const x=(n||[]).map(b=>({friendshipId:b.id,friend:f[b.requester_id===a?b.addressee_id:b.requester_id]||{pseudo:"?"}}));if(!x.length){l.innerHTML=`
    ...
    <div style="display:flex;align-items:center;gap:12px;background:var(--tile-bg);border-radius:12px;padding:12px 14px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
      ...
      <div style="display:flex;gap:8px;flex-shrink:0">
        ...
        <button data-stats="${t.id}" data-friend-name="${i}" title="Voir les stats"
          style="width:38px;height:38px;border-radius:50%;border:2px solid ${Pn};background:var(--tile-bg);font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center">📊</button>
      </div>
    </div>`}function Rn(t,e){const i=Zi();i.innerHTML=`
    <div class="popup-box">
    ...
    ${eo()}`,document.body.appendChild(i);const o=i.querySelector("#friend-pseudo-input"),a=i.querySelector("#add-friend-error"),n=()=>i.remove();o.focus(),i.querySelector("#add-cancel").addEventListener("click",n),i.addEventListener("click",r=>{r.target===i&&n()}),i.querySelector("#add-ok").addEventListener("click",async()=>{const r=o.value.trim();if(!r){a.textContent="Entre un pseudo";return}a.textContent="";const{data:s}=await v.from("users").select("id, pseudo").ilike("pseudo",r).single();if(!s){a.textContent="Utilisateur introuvable";return}if(s.id===t.user.id){a.textContent="Tu ne peux pas t'ajouter toi-même";return}const{data:c}=await v.from("friendships").select("id, status").or(`and(requester_id.eq.${t.user.id},addressee_id.eq.${s.id}),and(requester_id.eq.${s.id},addressee_id.eq.${t.user.id})`).single();if(c){const d=c.status==="accepted"?"Vous êtes déjà amis !":c.status==="pending"?"Demande déjà envoyée":"Une demande existe déjà";a.textContent=d;return}const{error:l}=await v.from("friendships").insert({requester_id:t.user.id,addressee_id:s.id,status:"pending"});if(l){a.textContent="Erreur : "+l.message;return}n(),e(`✅ Demande envoyée à ${s.pseudo} !`,"success")})}async function Ko(t,e,i=null,o={}){const a=t.user.id,{data:n}=await v.from("friendships").select("id, requester_id").eq("addressee_id",a).eq("status","pending").order("created_at",{ascending:!1}),r=(n||[]).map(x=>x.requester_id);let s={};if(r.length){const{data:x}=await v.from("users").select("id, pseudo, club_name").in("id",r);(x||[]).forEach(b=>{s[b.id]=b})}const c=(n||[]).map(x=>({...x,requester:s[x.requester_id]||{pseudo:"?"}})),l=Zi(),d=c||[];l.innerHTML=`
    <div class="popup-box">
    ...
    ${eo()}`,document.body.appendChild(l);const f=()=>l.remove();l.querySelector("#pending-close").addEventListener("click",f),l.addEventListener("click",x=>{x.target===l&&f()}),l.querySelectorAll("[data-accept]").forEach(x=>{x.addEventListener("click",async()=>{const{error:b}=await v.from("friendships").update({status:"accepted"}).eq("id",x.dataset.accept);if(b){e("Erreur : "+b.message,"error");return}x.closest("div[style]").remove(),e("✅ Ami accepté !","success"),Uo(t,e,o),i&&i()})}),l.querySelectorAll("[data-decline]").forEach(x=>{x.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",x.dataset.decline),x.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function On(t,e,i){const o=t.user.id,[a,n]=[o,e].sort(),r=o===a,{data:s}=await v.from("friend_match_stats").select("*").eq("player1_id",a).eq("player2_id",n).single(),c=t.profile.club_name||t.profile.pseudo||"Moi",l=s||{},d=r?l.wins_p1||0:l.wins_p2||0,f=r?l.wins_p2||0:l.wins_p1||0,x=l.draws||0,b=r?l.goals_p1||0:l.goals_p2||0,g=r?l.goals_p2||0:l.goals_p1||0,p=r?l.gc_used_p1||0:l.gc_used_p2||0,u=r?l.gc_used_p2||0:l.gc_used_p1||0,y=l.matches_total||0,w=(E,m,A,$=ri,T=ai)=>`
    <div style="display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid #f0f0f0">
      ...
      <div style="text-align:left;font-size:18px;font-weight:900;color:${T}">${A}</div>
    ...
    </style>`}async function Hn(t,{state:e,navigate:i,toast:o}){const a=e.profile;if(!a)return;const n="/icons/";Go(i,a,"game",n),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(r=>{r.addEventListener("click",()=>{r.style.transform="scale(.96)",setTimeout(()=>r.style.transform="",180);const s=r.dataset.action;if(s==="match-ai"){Ho(i,e);return}if(s==="match-random"){mt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Vo(t,e){var p,u;const{state:i,navigate:o}=e,a=oi(),n=Xi(),r=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,s="2026.07.29-0935";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:16px;display:flex;flex-direction:column;gap:14px;max-width:520px;margin:0 auto">
      ...
      <div style="background:var(--tile-bg);border:1px solid var(--tile-border);border-radius:14px;padding:18px">
        ...
        <div style="display:flex;gap:10px">
          <button data-theme-choice="club" style="flex:1;padding:14px;border-radius:12px;cursor:pointer;text-align:center;border:2px solid ${a==="club"?"#D4A017":"var(--tile-border)"};background:${a==="club"?"rgba(212,160,23,0.12)":"transparent"}">
  ...
  </div>`,t.querySelectorAll("[data-theme-choice]").forEach(y=>{y.addEventListener("click",()=>{Co(y.dataset.themeChoice),Vo(t,e)})});const c=t.querySelector("#team-color1"),l=t.querySelector("#team-color2"),d=t.querySelector("#team-preview"),f=()=>{d&&(d.style.background=`linear-gradient(135deg, ${c.value} 50%, ${l.value} 50%)`)};f(),c==null||c.addEventListener("input",f),l==null||l.addEventListener("input",f),(u=t.querySelector("#team-save"))==null||u.addEventListener("click",async()=>{const y=t.querySelector("#team-error"),w=t.querySelector("#team-save"),h=t.querySelector("#team-club-name").value.trim();if(h.length<2){y.textContent="Nom de club trop court.";return}w.disabled=!0,w.textContent="⏳ Enregistrement...",y.textContent="";const{error:E}=await v.from("users").update({club_name:h,club_color1:c.value,club_color2:l.value}).eq("id",i.profile.id);if(w.disabled=!1,w.textContent="💾 Enregistrer",E){y.textContent=E.message;return}i.profile.club_name=h,i.profile.club_color1=c.value,i.profile.club_color2=l.value,y.style.color="#2ecc71",y.textContent="✅ Modifications enregistrées.",oi()==="club"&&Co("club")});const x=t.querySelector("#volume-slider"),b=t.querySelector("#volume-label");let g=null;x.addEventListener("input",()=>{In(Number(x.value)),b.textContent=`${x.value}%`,g&&(g.volume=Math.max(0,Math.min(1,Number(x.value)/100)))}),t.querySelector("#volume-test").addEventListener("click",()=>{g=Qi("/sounds/match-opening.mp3",1)}),t.querySelector("#settings-logout").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()})}const Oe={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Pe(t,e){if(!t)return 0;let i=0;switch(e){case"GK":i=Number(t.note_g)||0;break;case"DEF":i=Number(t.note_d)||0;break;case"MIL":i=Number(t.note_m)||0;break;case"ATT":i=Number(t.note_a)||0;break;default:i=0}return i+(t.boost||0)}const yo=["ATT","MIL","DEF","GK"];function Yo(t,e,i){if(!t||!e)return!1;if(i&&t.position&&e.position)return Li(i).some(([d,f])=>d===t.position&&f===e.position||d===e.position&&f===t.position);const o=t._col!=null&&e._col!=null&&t._col===e._col,a=t._col!=null&&e._col!=null&&Math.abs(t._col-e._col)===1,n=yo.indexOf(t._line||t.job),r=yo.indexOf(e._line||e.job),s=Math.abs(n-r)===1;return(t._line||t.job)===(e._line||e.job)&&a||o&&s}function Wo(t,e){let i=0;const o=t.length;for(let a=0;a<o;a++)for(let n=a+1;n<o;n++){const r=t[a],s=t[n];if(!r||!s||!Yo(r,s,e))continue;const c=Dt(r,s);c==="#00ff88"?i+=10:c==="#FFD700"&&(i+=5)}return i}function si(t,e={},i){let o=0,a=0;t.forEach(c=>{const l=c._line||c.job,d=Number(l==="MIL"?c.note_m:c.note_a)||0,f=c.stadiumBonus&&(l==="MIL"||l==="ATT")?10:0;o+=e.doubleAttack?d*2:d,a+=(c.boost||0)+f});const n=o+a,r=Wo(t,i);let s=n+r;return e.stolenNote&&(s-=e.stolenNote),{base:n,links:r,total:Math.max(0,s)}}function li(t,e={},i){const o=t.reduce((r,s)=>{const c=s._line||s.job;let l=0;c==="GK"?l=Number(s.note_g)||0:c==="MIL"?l=Number(s.note_m)||0:l=Number(s.note_d)||0;const d=s.stadiumBonus&&(c==="GK"||c==="DEF"||c==="MIL")?10:0;return r+l+(s.boost||0)+d},0),a=Wo(t,i);let n=o+a;return e.stolenNote&&(n-=e.stolenNote),{base:o,links:a,total:Math.max(0,n)}}function to(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function Xo(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,s)=>{const c=e==="attack"?Pe(r,"ATT"):r._line==="GK"?Pe(r,"GK"):Pe(r,"DEF");return(e==="attack"?Pe(s,"ATT"):s._line==="GK"?Pe(s,"GK"):Pe(s,"DEF"))-c});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Un(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const Kn={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Jt={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},pi=["GK","DEF","MIL","ATT"],Vn=["Tous","GK","DEF","MIL","ATT"],Yn={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function ho(t){const e=t.player;return e?(e.rarity,Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)):null}function Wn(t){return t.length?t.reduce((e,i)=>ho(i)>ho(e)?i:e,t[0]):t[0]}const Xn={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function ui(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Di(t,e=""){const i=t.player;if(!i)return"";const o=t.evolution_bonus||0,a={...i,_evolution_bonus:o},n=e?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${e}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${t.id}">
    ${n}
    ${ze(a,{width:140})}
  </div>`}function vo(t){return`<div style="display:inline-block;filter:grayscale(1);opacity:0.4">
    ${ze(t,{width:140})}
  </div>`}async function Jn(t,e){const{state:i,navigate:o,toast:a,openModal:n,closeModal:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await v.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price, stadium_id, evolution_bonus,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter(C=>C.card_type==="player"&&C.player),d=(s||[]).filter(C=>C.card_type==="game_changer"),f=(s||[]).filter(C=>C.card_type==="formation"),x=(s||[]).filter(C=>C.card_type==="stadium"),{data:b}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(C=>{g[C.name]=C});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(C=>{u[C.id]=C}),x.forEach(C=>{C.stadium_def&&(u[C.stadium_id]=C.stadium_def)});const y=Object.keys(Ii),w=Object.keys(Oe),h={};l.forEach(C=>{const K=C.player.id;h[K]=(h[K]||0)+1}),new Set(Object.keys(h).map(C=>String(C)));const E=new Set(f.map(C=>C.formation)),m=new Set(d.map(C=>C.gc_type));let A="player",$="Tous",T="",P=!1;function G(){return[...l].sort((C,K)=>{const Q=pi.indexOf(C.player.job),X=pi.indexOf(K.player.job);return Q!==X?Q-X:(C.player.surname_real||"").localeCompare(K.player.surname_real||"")})}function O(){return[...c||[]].sort((C,K)=>{const Q=pi.indexOf(C.job),X=pi.indexOf(K.job);return Q!==X?Q-X:(C.surname_real||"").localeCompare(K.surname_real||"")})}function V(){return G().filter(C=>{const K=C.player,Q=$==="Tous"||K.job===$,X=!T||`${K.firstname} ${K.surname_real}`.toLowerCase().includes(T);return Q&&X})}function I(){return O().filter(C=>{const K=$==="Tous"||C.job===$,Q=!T||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(T);return K&&Q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{P=!P,_(),R()})))}function R(){const C=document.getElementById("col-grid");C&&(A==="player"?H(C):A==="formation"?pe(C):A==="stadium"?fe(C):me(C))}function W(C,K,Q,X,re,F=0){const z=document.getElementById("col-grid"),Y=document.getElementById("col-big");if(!z||!Y)return;var Z=0;function se(){var We;const ge=window.innerWidth>=768,ye=document.getElementById("col-big"),$e=document.getElementById("col-gap"),Ee=((We=document.getElementById("col-grid"))==null?void 0:We.parentElement)||null,xe=ye?ye.closest(".page"):null;if(ye&&Ee&&xe){let Le=0;Array.from(xe.children).forEach(function(B){B!==ye&&B!==Ee&&B!==$e&&(Le+=B.offsetHeight)});const Be=Math.max(0,xe.clientHeight-Le),qe=Math.round(Be*(F/100)),Ne=Math.max(0,Be-qe),k=ge?50/71:45/63,L=Math.round(Ne*k),M=Math.max(0,Ne-L);$e&&($e.style.height=qe+"px"),ye.style.flex="none",ye.style.height=L+"px",ye.style.minHeight="0",Ee.style.flex="none",Ee.style.height=M+"px",Ee.style.minHeight="0",Ee.style.display="flex",Ee.style.overflow="hidden"}const be=document.getElementById("col-grid");be&&(be.style.height="100%",be.style.flexShrink="0",be.style.overflowX="auto",be.style.overflowY="hidden",be.style.alignItems="center",be.style.width="100%"),Y.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+K(C[Z])+"</div>";var je=Y.querySelector("[data-card-id],[data-form-id],[data-gc-id]");je&&je.addEventListener("click",function(){X(C[Z])}),requestAnimationFrame(function(){var Le=document.getElementById("big-card-inner");if(!(!Le||!Y)){var Be=Y.clientHeight,qe=Y.clientWidth-16,Ne=Le.offsetHeight,k=Le.offsetWidth;if(Ne>0&&k>0&&Be>40){var L=Math.min(Be/Ne,qe/k);Le.style.transform="scale("+L.toFixed(3)+")",Le.style.transformOrigin="center center"}}}),z.innerHTML=C.map(function(Le,Be){var qe=Be===Z,Ne="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Be+'" style="'+Ne+'">'+Q(Le,qe)+"</div>"}).join(""),z.querySelectorAll(".col-mini-item").forEach(function(Le){Le.addEventListener("click",function(){Z=Number(Le.dataset.idx),se(),Le.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var Le=be?be.clientHeight:0,Be=z.querySelector(".col-mini-item > div");if(!(!Le||!Be)){var qe=Be.style.zoom;Be.style.zoom="1";var Ne=Be.offsetHeight;if(Be.style.zoom=qe,!(Ne<=0)){var k=Le/Ne;z.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=k.toFixed(4)})}}})}se()}function de(C,K){var Q=window.innerWidth>=768?.76:.54,X;if(!C||C._fake){var re=C?C.player:null;if(!re)return"";X=vo(re)}else X=Di(C,"");var F=C&&!C._fake?h[C.player&&C.player.id]||1:0,z=F>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+F+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+Q+';pointer-events:none;line-height:0">'+z+X+"</div>"}function ce(C,K,Q){var X=Q>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+Q+"</div>":"",re=!!K,F=ni(C,ut[C],{width:160});return re||(F='<div style="filter:grayscale(1);opacity:0.5">'+F+"</div>"),"<div "+(K?'data-form-id="'+K.id+'"':"")+' style="position:relative;cursor:pointer">'+X+F+"</div>"}function j(C,K){var Q=window.innerWidth>=768?.76:.54,X=ni(C,ut[C],{width:140});return K||(X='<div style="filter:grayscale(1);opacity:0.45">'+X+"</div>"),'<div style="display:inline-block;zoom:'+Q+';line-height:0;pointer-events:none">'+X+"</div>"}function H(C){if(P){const K=I();if(!K.length){C.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const Q=K.map(X=>l.find(re=>re.player.id===X.id)||{_fake:!0,player:X,id:"fake-"+X.id});W(Q,X=>X._fake?vo(X.player):Di(X,""),X=>X._fake?de({player:X.player,id:"x",_fake:!0}):de(X),X=>{X._fake||wo(X,l,h,e)})}else{const K=V();if(!K.length){C.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const Q={};K.forEach(re=>{const F=re.player.id;Q[F]||(Q[F]=[]),Q[F].push(re)});const X=Object.values(Q).map(re=>Wn(re));W(X,re=>{const F=h[re.player.id]||1,z=F>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${F}</div>`:"",Z=l.filter(se=>se.player.id===re.player.id&&se.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Di(re,z+Z)},re=>de(re),re=>wo(re,l,h,e))}}function pe(C){const K=P?y:[...E];if(!K.length){C.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const Q=K.map(X=>({formation:X,card:f.find(re=>re.formation===X)||null,owned:E.has(X)}));W(Q,({formation:X,card:re,owned:F})=>ce(X,F?re:null,F?f.filter(z=>z.formation===X).length:0),({formation:X,owned:re})=>j(X,re),({card:X,owned:re})=>{re&&X&&Zn(X,f,e,n)},"#1A6B3C",5)}function me(C){const K=Object.keys(g),Q=P?K.length?K:w:[...m];if(!Q.length){C.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const X=Q.map(re=>({type:re,gc:Oe[re]||{icon:"⚡",desc:""},def:g[re]||null,owned:m.has(re),card:d.find(F=>F.gc_type===re)||null}));W(X,({type:re,gc:F,def:z,owned:Y,card:Z})=>{var be;const se=(z==null?void 0:z.name)||re,ge=Y?d.filter(je=>je.gc_type===re).length:0,ye=ge>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ge}</div>`:"",$e=(z==null?void 0:z.effect)||F.desc||"",Ee=z!=null&&z.image_url?`/icons/${z.image_url}`:((be=z==null?void 0:z.club)==null?void 0:be.logo_url)||(z!=null&&z.country_code?`https://flagsapi.com/${z.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let xe=nt(se,Ee,F.icon,$e,{width:160,onClick:Y});return Y||(xe=`<div style="filter:grayscale(1);opacity:0.5">${xe}</div>`),`<div ${Y&&Z?`data-gc-id="${Z.id}" data-gc-type="${re}"`:""} style="position:relative">${ye}${xe}</div>`},({type:re,gc:F,def:z,owned:Y})=>{const Z=window.innerWidth>=768?.76:.54,se=(z==null?void 0:z.name)||re,ge=(z==null?void 0:z.effect)||F.desc||"",ye=z!=null&&z.image_url?`/icons/${z.image_url}`:null;let $e=nt(se,ye,F.icon,ge,{width:140});return Y||($e=`<div style="filter:grayscale(1);opacity:0.45">${$e}</div>`),`<div style="display:inline-block;zoom:${Z};line-height:0;pointer-events:none">${$e}</div>`},({type:re,owned:F,def:z})=>{F&&Qn(re,z,n)},"#7a28b8",5)}function fe(C){const K="#4FC3F7",Q="/";if(!x.length){C.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const X={};x.forEach(F=>{const z=F.stadium_id||"?";(X[z]=X[z]||[]).push(F)});const re=Object.entries(X).map(([F,z])=>({sid:F,def:u[F]||null,count:z.length,card:z[0]}));W(re,({def:F,count:z})=>{var $e,Ee;const Y=(F==null?void 0:F.name)||"?",Z=(($e=F==null?void 0:F.club)==null?void 0:$e.encoded_name)||(F==null?void 0:F.country_code)||"—",se=F!=null&&F.image_url?`${Q}icons/${F.image_url}`:((Ee=F==null?void 0:F.club)==null?void 0:Ee.logo_url)||(F!=null&&F.country_code?`https://flagsapi.com/${F.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ge=z>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${z}</div>`:"",ye=`${Z}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${ge}${Ht(Y,se,ye,{width:160})}</div>`},({def:F})=>{var ye,$e;const z=window.innerWidth>=768?.76:.54,Y=(F==null?void 0:F.name)||"?",Z=((ye=F==null?void 0:F.club)==null?void 0:ye.encoded_name)||(F==null?void 0:F.country_code)||"—",se=F!=null&&F.image_url?`${Q}icons/${F.image_url}`:(($e=F==null?void 0:F.club)==null?void 0:$e.logo_url)||(F!=null&&F.country_code?`https://flagsapi.com/${F.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ge=`${Z}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${z};line-height:0;pointer-events:none">${Ht(Y,se,ge,{width:140})}</div>`},null,K,5)}t.querySelectorAll(".col-tab-btn").forEach(C=>{C.addEventListener("click",()=>{A=C.dataset.tab,$="Tous",T="",P=!1,t.querySelectorAll(".col-tab-btn").forEach(K=>{const Q=K.dataset.tab===A;K.style.borderBottomColor=Q?"var(--green)":"transparent",K.style.color=Q?"var(--green)":"var(--tile-fg-dim)"}),_(),R()})}),_(),R()}function Qn(t,e,i){const o=Oe[t]||{icon:"⚡",desc:"Effet spécial."},a=(e==null?void 0:e.name)||t,n=(e==null?void 0:e.effect)||o.desc,r=e!=null&&e.image_url?`/icons/${e.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${nt(a,r,o.icon,n,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const fi=1e3;function Zn(t,e,i,o){var g,p,u;const{state:a,toast:n,closeModal:r,navigate:s,refreshProfile:c}=i,l=t.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=ut[l]||{},w=Ii[l]||[],h=290,E=360,m=20;function A(T){const P=y[T];return P?{x:P.x*h,y:P.y*E}:null}let $=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[T,P]of w){const G=A(T),O=A(P);!G||!O||($+=`<line x1="${G.x}" y1="${G.y}" x2="${O.x}" y2="${O.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const T of Object.keys(y)){const P=A(T);if(!P)continue;const G=T.replace(/\d+/,""),O=d[G]||"#555";$+=`<circle cx="${P.x}" cy="${P.y}" r="${m}" fill="${O}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,$+=`<text x="${P.x}" y="${P.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${G}</text>`}return $+="</svg>",$}const x=e.filter(y=>y.formation===l);x.length;const b=!t.is_for_sale;o(`Formation ${l}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${fi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=x.find(h=>!h.is_for_sale)||x[0];if(!y){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",y.id),await v.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await v.from("cards").delete().eq("id",y.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(a.profile.credits||0)+fi}).eq("id",a.profile.id),await c(),n(`+${fi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",t.id),await v.from("market_listings").insert({seller_id:a.profile.id,card_id:t.id,price:y}),n("Carte mise en vente sur le marché !","success"),r(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),r(),s("collection")})}async function wo(t,e,i,o){var pe,me,fe,C,K,Q,X,re,F;const{state:a,toast:n,openModal:r,closeModal:s,navigate:c,refreshProfile:l}=o,d=t.player,f=e.filter(z=>z.player.id===d.id),x=f.length,b=t.evolution_bonus||0,g=Math.max((Number(d.note_g)||0)+(d.job==="GK"||d.job2==="GK"?b:0),(Number(d.note_d)||0)+(d.job==="DEF"||d.job2==="DEF"?b:0),(Number(d.note_m)||0)+(d.job==="MIL"||d.job2==="MIL"?b:0),(Number(d.note_a)||0)+(d.job==="ATT"||d.job2==="ATT"?b:0)),p=d.rarity||"normal",{data:u}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((pe=u==null?void 0:u[0])==null?void 0:pe.price)??Yn[p];const y=((me=u==null?void 0:u[0])==null?void 0:me.price_min)??null,w=((fe=u==null?void 0:u[0])==null?void 0:fe.price_max)??null,h=d.rarity!=="legende";Bt(d);const E=ui(d,d.job)+b,m=d.job2?ui(d,d.job2)+(ui(d,d.job2)>0?b:0):null;Jt[d.job],d.job2&&Jt[d.job2];const A=Kn[d.rarity]||"#ccc",$=Xn[d.country_code]||d.country_code||"",T=t.evolution_bonus||0,G=E+T,O=m||0,V=O>0?O+T:0,I=f.map(z=>z.id);let _={};if(I.length){const{data:z}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",I).order("transferred_at",{ascending:!0});(z||[]).forEach(Y=>{_[Y.card_id]||(_[Y.card_id]=[]),_[Y.card_id].push(Y)})}const R=I.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
        ...
        ${f.filter(z=>z.id!==t.id).map((z,Y)=>{const Z=_[z.id]||[],se=z.is_for_sale,ge=Z.length?Z[Z.length-1]:null,ye=z.evolution_bonus||0,$e=ge?ge.source==="booster"?"Booster":ge.price?ge.price.toLocaleString("fr")+" cr.":"—":"—",Ee=ge?new Date(ge.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",xe=80,be=Math.round(xe*657/507),je=ze({...d,_evolution_bonus:ye},{width:xe});return`
            <div class="exemplaire-row" data-card-id="${z.id}" data-card-idx="${Y}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${z.id}" data-evo="${ye}" data-note="${ui(d,d.job)}"
                ${se?"disabled":""}
                style="display:none">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${G}${d.job2&&O>0?` / ${V}`:""}`:`Note actuelle : ${G}${d.job2&&O>0?` / ${V}`:""}`}
            </div>
          </div>
      ...
      <!-- Carte visuelle -->
      ${ze({...d,_evolution_bonus:b},{width:160})}
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px 16px;background:#f8f8f8;border-radius:10px;padding:10px 12px">
          ...
          <div>
            ...
            <div style="font-weight:700;font-size:13px;color:#333;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${((C=d.clubs)==null?void 0:C.encoded_name)||"—"}</div>
          </div>
          <div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([z,Y])=>{const Z=Jt[z],se=z==="GK"?"#fff":Z,ge=z===d.job||z===d.job2,ye=(Number(Y)||0)+(ge&&T>0?T:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(K=document.getElementById("close-detail"))==null||K.addEventListener("click",s);let W=new Set;const de=d.rarity==="pepite"?1.3:d.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(Y=>{if(Y.dataset.id===t.id)return;const se=Number(Y.dataset.evo)||0,ge=Number(Y.dataset.note)||0;z+=ge+se}),Math.round(z*de)}const j=()=>{const z=W.size,Y=document.getElementById("sell-action-panel");if(!Y)return;Y.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const Y=z.dataset.id;z.checked?W.add(Y):W.delete(Y);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",Y=>{if(Y.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(x<=1)return;const z=[...W];if(!z.length)return;if(W.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
    ...
    </div>`,document.body.appendChild(o);const a=o.querySelector("#pm-input");a.focus(),a.select();const n=r=>{o.remove(),i(r)};o.querySelector("#pm-ok").addEventListener("click",()=>n(a.value.trim()||null)),o.querySelector("#pm-cancel").addEventListener("click",()=>n(null)),o.querySelector("#pm-cancel2").addEventListener("click",()=>n(null)),o.addEventListener("click",r=>{r.target===o&&n(null)}),a.addEventListener("keydown",r=>{r.key==="Enter"&&n(a.value.trim()||null),r.key==="Escape"&&n(null)})})}function er(t,e=!1){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:380px">
    ...
    </div>`,document.body.appendChild(o);const a=n=>{o.remove(),i(n)};o.querySelector("#cm-ok").addEventListener("click",()=>a(!0)),o.querySelector("#cm-cancel").addEventListener("click",()=>a(!1)),o.addEventListener("click",n=>{n.target===o&&a(!1)})})}const hi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Gi(t,e){const{state:i,navigate:o,toast:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=await _o("Nom du deck",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!r)return;const{data:s,error:c}=await v.from("decks").insert({owner_id:i.profile.id,name:r}).select().single();if(c){a(c.message,"error");return}a("Deck créé !","success"),ko(s.id,t,e)}),t.querySelectorAll("[data-open-deck]").forEach(r=>{r.addEventListener("click",()=>ko(r.dataset.openDeck,t,e))}),t.querySelectorAll("[data-rename]").forEach(r=>{r.addEventListener("click",async()=>{const s=await _o("Nouveau nom",r.dataset.name);if(!s||s===r.dataset.name)return;const{error:c}=await v.from("decks").update({name:s}).eq("id",r.dataset.rename);if(c){a(c.message,"error");return}a("Deck renommé !","success"),Gi(t,e)})}),t.querySelectorAll("[data-delete]").forEach(r=>{r.addEventListener("click",async()=>{if(!await er(`Supprimer le deck "${r.dataset.name}" ? Cette action est irréversible.`,!0))return;await v.from("deck_cards").delete().eq("deck_id",r.dataset.delete);const{error:s}=await v.from("decks").delete().eq("id",r.dataset.delete);if(s){a(s.message,"error");return}a("Deck supprimé.","success"),Gi(t,e)})})}async function ko(t,e,i){const{state:o,toast:a}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("*").eq("id",t).single(),{data:r}=await v.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),c=(r||[]).filter(y=>y.card_type==="player"&&y.player),l=(r||[]).filter(y=>y.card_type==="formation"),d=(s||[]).filter(y=>y.card_type==="stadium"),f=[...new Set(d.map(y=>y.stadium_id).filter(Boolean))];let x={};if(d.forEach(y=>{y.stadium_def&&y.stadium_id&&(x[y.stadium_id]=y.stadium_def)}),f.length&&Object.keys(x).length<f.length){const{data:y}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(y||[]).forEach(w=>{x[w.id]=w})}const b=l.map(y=>y.formation).filter(Boolean),{data:g}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let p=n.formation||"4-4-2";b.length>0&&!b.includes(p)&&(p=b[0]);const u={deckId:t,name:n.name,formation:p,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:c,formationCards:l,stadiumCards:d,stadDefMap:x,availableFormations:b};(g||[]).forEach(y=>{y.is_starter?u.slots[y.position]=y.card_id:u.subs.includes(y.card_id)||u.subs.push(y.card_id)}),$t(e,u,i)}function $t(t,e,i){var g,p;const{navigate:o}=i;hi[e.formation];const a=$o(e.formation),n=a.filter(u=>e.slots[u]).length,r=e.availableFormations.length>0?e.availableFormations:Object.keys(hi),s=(g=e.stadiumCards)==null?void 0:g.find(u=>u.id===e.stadiumCardId),c=s&&((p=e.stadDefMap)==null?void 0:p[s.stadium_id])||null,l=e.subs.map(u=>e.playerCards.find(y=>y.id===u)).filter(Boolean);l.length!==e.subs.length&&(e.subs=l.map(u=>u.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;const d=window.innerWidth>=900,f=t.querySelector(".deck-pc-layout"),x=t.querySelector(".deck-mobile-layout");f&&(f.style.display=d?"block":"none"),x&&(x.style.display=d?"none":"block"),t.querySelectorAll("#save-deck").forEach(u=>{u.closest(".page-body").style.display=d?"none":"block"}),tr(t,e,a,i),t.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>o("decks")));const b=()=>{const{openModal:u,closeModal:y}=i,h=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
      ${[...new Set(r)].map(E=>{const m=E===e.formation;return`<div data-forma="${E}" style="cursor:pointer;border-radius:10px;${m?"box-shadow:0 0 0 3px #1A6B3C":""}">
          ${ni(E,ut[E],{width:90})}
        </div>`}).join("")}
    </div>`;u("⚽ Choisir une formation",h),document.querySelectorAll("#modal-body [data-forma]").forEach(E=>{E.addEventListener("click",()=>{e.formation=E.dataset.forma;const m=$o(e.formation),A={};m.forEach($=>{e.slots[$]&&(A[$]=e.slots[$])}),e.slots=A,y(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",b)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>ir(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>rr(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>nr(e,t,i)))}function tr(t,e,i,o){var h,E,m;const a=window.innerWidth>=900,n=t.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const r=(h=e.stadiumCards)==null?void 0:h.find(A=>A.id===e.stadiumCardId),s=r&&((E=e.stadDefMap)==null?void 0:E[r.stadium_id])||null,c=ut[e.formation]||{},l=Li(e.formation)||[],d={};for(const A of i){const $=e.slots[A],T=$?e.playerCards.find(P=>P.id===$):null;T!=null&&T.player?d[A]={...T.player,_evolution_bonus:T.evolution_bonus||0,face:T.player.face||null}:d[A]=null}const f=window.innerWidth>=900,x=f?window.innerWidth-280:window.innerWidth-20,b=f?Math.min(x,860):x,g=Math.round(f?b*.82:b*.85),p=f?84:44;let u="";for(const[A,$]of l){const T=c[A],P=c[$];if(!T||!P)continue;const G=T.x*b,O=Math.round(.03*g+T.y*.85*g),V=P.x*b,I=Math.round(.03*g+P.y*.85*g),_=d[A],R=d[$],W=Dt(_,R);W==="#ff3333"||W==="#cc2222"?u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const A of i){const $=c[A];if(!$)continue;const T=d[A],P=$.x*b;$.y*g;const G=Math.round(.03*g+$.y*(.85*g)),O=Math.round(P-p/2),V=Math.round(G-w/2);if(T){const I=A.replace(/\d+/,""),_=s&&(s.club_id&&String(T.club_id)===String(s.club_id)||s.country_code&&T.country_code===s.country_code),R=ze({...T,_evolution_bonus:T._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:I});_&&((m=s.club)!=null&&m.logo_url||s.image_url),y+=`<div style="position:absolute;left:${O}px;top:${V}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${A}">
        <div style="position:relative">${R}</div>
      </div>`}else{const I=A.replace(/\d+/,"");y+=`<div style="position:absolute;left:${O}px;top:${V}px;width:${p}px;height:${w}px;
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(A=>{A.addEventListener("click",()=>or(A.dataset.pos,e,t,o))})}function ir(t,e,i){var s;const{openModal:o,closeModal:a}=i,n=new Set,r=(t.stadiumCards||[]).filter(c=>{const l=c.stadium_id||c.id;return n.has(l)?!1:(n.add(l),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${r.map(c=>{var b;const l=t.stadDefMap[c.stadium_id],d=((b=l==null?void 0:l.club)==null?void 0:b.logo_url)||(l==null?void 0:l.image_url)||(l!=null&&l.country_code?`https://flagsapi.com/${l.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),f=t.stadiumCardId===c.id,x=Ht((l==null?void 0:l.name)||"Stade",d,"+10⭐",{width:90});return`<div class="stad-choice" data-stad-id="${c.id}" style="cursor:pointer;position:relative;border-radius:8px;${f?"box-shadow:0 0 0 3px #4fc3f7":""}">
          ${x}
        </div>`}).join("")}
    </div>`),(s=document.getElementById("stad-none"))==null||s.addEventListener("click",()=>{t.stadiumCardId=null,a(),$t(e,t,i)}),document.querySelectorAll(".stad-choice").forEach(c=>{c.addEventListener("click",()=>{t.stadiumCardId=c.dataset.stadId,a(),$t(e,t,i)})})}function or(t,e,i,o){var g,p,u,y,w;const{openModal:a,closeModal:n}=o,r=t.replace(/\d+/,""),s=(g=e.stadiumCards)==null?void 0:g.find(h=>h.id===e.stadiumCardId),c=s&&((p=e.stadDefMap)==null?void 0:p[s.stadium_id])||null,l=e.slots[t],d=l?e.playerCards.find(h=>h.id===l):null;(u=d==null?void 0:d.player)==null||u.id;const f=new Set;Object.entries(e.slots).forEach(([h,E])=>{var A;if(h===t||!E)return;const m=e.playerCards.find($=>$.id===E);(A=m==null?void 0:m.player)!=null&&A.id&&f.add(m.player.id)}),e.subs.forEach(h=>{var m;const E=e.playerCards.find(A=>A.id===h);(m=E==null?void 0:E.player)!=null&&m.id&&f.add(E.player.id)});const x=new Set,b=e.playerCards.filter(h=>{const E=h.player;return!(E.job===r||E.job2===r)||f.has(E.id)||x.has(E.id)?!1:(x.add(E.id),!0)});b.sort((h,E)=>{const m=h.evolution_bonus||0,A=E.evolution_bonus||0,$=(r==="GK"?h.player.note_g:r==="DEF"?h.player.note_d:r==="MIL"?h.player.note_m:h.player.note_a)+(r===h.player.job||r===h.player.job2?m:0);return(r==="GK"?E.player.note_g:r==="DEF"?E.player.note_d:r==="MIL"?E.player.note_m:E.player.note_a)+(r===E.player.job||r===E.player.job2?A:0)-$}),a(`Choisir ${r} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
      ...
      ${b.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+b.map(h=>{const E={...h.player,_evolution_bonus:h.evolution_bonus||0};return`<div class="player-option" data-card-id="${h.id}" style="cursor:pointer">
          ${ze(E,{width:100,showStad:!0,stadDef:c,role:r})}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(y=document.getElementById("close-selector"))==null||y.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),$t(i,e,o)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{e.slots[t]=h.dataset.cardId,n(),$t(i,e,o)})})}function nr(t,e,i){var d,f,x;const{openModal:o,closeModal:a}=i,n=(d=t.stadiumCards)==null?void 0:d.find(b=>b.id===t.stadiumCardId),r=n&&((f=t.stadDefMap)==null?void 0:f[n.stadium_id])||null,s=new Set;Object.keys(t.slots).forEach(b=>{var u;const g=t.slots[b];if(!g)return;const p=t.playerCards.find(y=>y.id===g);(u=p==null?void 0:p.player)!=null&&u.id&&s.add(p.player.id)}),t.subs.forEach(b=>{var p;const g=t.playerCards.find(u=>u.id===b);(p=g==null?void 0:g.player)!=null&&p.id&&s.add(g.player.id)});const c=new Set,l=t.playerCards.filter(b=>{var g,p,u;return s.has((g=b.player)==null?void 0:g.id)||c.has((p=b.player)==null?void 0:p.id)?!1:(c.add((u=b.player)==null?void 0:u.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${l.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+l.map(b=>{const g={...b.player,_evolution_bonus:b.evolution_bonus||0};return`<div class="player-option" data-card-id="${b.id}" style="cursor:pointer">
          ${ze(g,{width:100,showStad:!0,stadDef:r})}
        </div>`}).join("")+"</div>":'<div style="text-align:center;padding:20px;color:var(--tile-fg-dim)">Tous vos joueurs sont déjà utilisés.</div>'}
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(x=document.getElementById("close-sub-selector"))==null||x.addEventListener("click",a),document.querySelectorAll(".player-option").forEach(b=>{b.addEventListener("click",()=>{t.subs.push(b.dataset.cardId),a(),$t(e,t,i)})})}async function rr(t,e){const{state:i,toast:o,navigate:a}=e,n=t.formationCards.find(c=>c.formation===t.formation),r=(n==null?void 0:n.id)||t.formationCardId;await v.from("decks").update({formation:t.formation,formation_card_id:r||null,stadium_card_id:t.stadiumCardId||null}).eq("id",t.deckId),await v.from("deck_cards").delete().eq("deck_id",t.deckId);const s=[];if(Object.entries(t.slots).forEach(([c,l],d)=>{s.push({deck_id:t.deckId,card_id:l,position:c,is_starter:!0,slot_order:d})}),t.subs.forEach((c,l)=>{s.push({deck_id:t.deckId,card_id:c,position:`SUB${l+1}`,is_starter:!1,slot_order:100+l})}),s.length>0){const{error:c}=await v.from("deck_cards").insert(s);if(c){o(c.message,"error");return}}o("Deck enregistré ✅","success"),a("decks")}function $o(t){const e=hi[t]||hi["4-4-2"],i=["GK1"];for(let o=1;o<=e.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=e.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=e.ATT;o++)i.push(`ATT${o}`);return i}async function Jo(t=null){const e=new Date().toISOString().slice(0,10),{data:i}=await v.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const o=i.filter(r=>!(r.available_from&&e<r.available_from||r.available_until&&e>r.available_until));if(!o.length)return[];let a=o;if(t){const r=o.filter(s=>s.max_per_user!=null);if(r.length){const{data:s}=await v.from("booster_claims").select("booster_id").eq("user_id",t).in("booster_id",r.map(l=>l.id)),c={};(s||[]).forEach(l=>{c[l.booster_id]=(c[l.booster_id]||0)+1}),a=o.filter(l=>l.max_per_user==null?!0:(c[l.id]||0)<l.max_per_user)}}if(!a.length)return[];const{data:n}=await v.from("booster_drop_rates").select("*").in("booster_id",a.map(r=>r.id)).order("sort_order");return a.map(r=>({...r,rates:(n||[]).filter(s=>s.booster_id===r.id)}))}async function ar(t,e){const{data:i}=await v.from("booster_configs").select("max_per_user").eq("id",e).single();i!=null&&i.max_per_user&&await v.from("booster_claims").insert({user_id:t,booster_id:e})}function sr(t){if(!(t!=null&&t.length))return null;const e=t.reduce((o,a)=>o+Number(a.percentage),0);let i=Math.random()*e;for(const o of t)if(i-=Number(o.percentage),i<=0)return o;return t[t.length-1]}const Qo=()=>Object.keys(ut),lr=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Ri={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function dr(t){const e=t.player;if(!e)return"";const i=t.evolution_bonus||0;return ze({...e,_evolution_bonus:i},{width:140})}function Zo(t){var a;const e={};(t.rates||[]).forEach(n=>{e[n.card_type]=(e[n.card_type]||0)+Number(n.percentage||0)});const i=((a=Object.entries(e).sort((n,r)=>r[1]-n[1])[0])==null?void 0:a[0])||"player",o=t.image_url||"booster-players.png";return{id:t.id,img:"/icons/"+o,name:t.name,sub:`${t.card_count} carte(s)`,cost:t.price_type==="credits"&&t.price_credits||0,costLabel:t.price_type==="credits"?`${(t.price_credits||0).toLocaleString("fr")} crédits`:t.price_type==="pub"?"1 pub":"Gratuit",cardCount:t.card_count||5,type:i,isPub:t.price_type==="pub",rates:t.rates||[],allow_duplicates:t.allow_duplicates!==!1,_boosterId:t.id,_raw:t}}async function cr(t,{state:e,navigate:i,toast:o}){var f,x,b;const a=((f=e.profile)==null?void 0:f.credits)||0;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let n=[];try{n=(await Jo((x=e.user)==null?void 0:x.id)).map(Zo)}catch(g){console.warn("Erreur chargement boosters DB, fallback hardcodé",g)}n.length||(n=lr.map(g=>({...g,rates:[],isPub:g.id==="players_pub"})));const r=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.profile.id).then(g=>g.data||[]),s=new Set(r.filter(g=>g.card_type==="stadium").map(g=>g.stadium_id)),c=new Set(r.filter(g=>g.card_type==="formation").map(g=>g.formation)),l=new Set(r.filter(g=>g.card_type==="game_changer").map(g=>g.gc_type)),d={};for(const g of n){if(g.allow_duplicates!==!1||!((b=g.rates)!=null&&b.length))continue;const p=[...new Set((g.rates||[]).map(y=>y.card_type))];let u=!1;for(const y of p)if(y==="stadium"){const{data:w}=await v.from("stadium_definitions").select("id");if((w||[]).some(h=>!s.has(h.id))){u=!0;break}}else if(y==="game_changer"){const{data:w}=await v.from("gc_definitions").select("name").eq("is_active",!0);if((w||[]).some(h=>!l.has(h.name))){u=!0;break}}else if(y==="formation"){const{FORMATION_LINKS:w}=await Do(async()=>{const{FORMATION_LINKS:h}=await import("./special-cards-YynorolH.js").then(E=>E.y);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(w).some(h=>!c.has(h))){u=!0;break}}else{u=!0;break}u||(d[g.id]=!0)}t.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${n.map(g=>{const p=g.cost===0||a>=g.cost,u=d[g.id]===!0;return`<div class="booster-card ${!p||u?"disabled":""}" data-booster="${g.id}" style="position:relative">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(g=>{g.addEventListener("click",async()=>{const p=n.find(u=>u.id===g.dataset.booster);if(p){g.style.opacity="0.5",g.style.pointerEvents="none";try{await pr(p,{state:e,toast:o,navigate:i,container:t})}catch(u){o(u.message,"error"),g.style.opacity="",g.style.pointerEvents=""}}})}),t.querySelectorAll(".booster-info-btn").forEach(g=>{g.addEventListener("click",p=>{p.stopPropagation();const u=n.find(y=>y.id===g.dataset.boosterId);gr(u)})})}async function pr(t,{state:e,toast:i,navigate:o,container:a}){var f,x;if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}t.isPub&&await xr();const{data:n}=await v.from("cards").select("card_type, player_id, formation").eq("owner_id",e.profile.id),r=new Set((n||[]).filter(b=>b.card_type==="player").map(b=>b.player_id)),s=new Set((n||[]).filter(b=>b.card_type==="formation").map(b=>b.formation));let c=[],l=null;try{if((f=t.rates)!=null&&f.length)c=await Oi(e.profile,t);else{const b=t.type||"player";b==="player"?c=await en(e.profile,t.cardCount,t.cost):b==="game_changer"?c=await tn(e.profile,t.cardCount,t.cost):b==="formation"?c=await on(e.profile,t.cost):c=await Oi(e.profile,t)}}catch(b){l=b.message||String(b),console.error("[Booster] Erreur:",b)}if(c!=null&&c.length&&t._boosterId&&await ar(e.user.id,t._boosterId),!(c!=null&&c.length)){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",b.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${l||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(b),(x=b.querySelector("#anim-close-err"))==null||x.addEventListener("click",()=>b.remove());return}c.forEach(b=>{b.card_type==="player"&&b.player?b.isDuplicate=r.has(b.player.id):b.card_type==="formation"&&(b.isDuplicate=s.has(b.formation))});const{data:d}=await v.from("users").select("*").eq("id",e.profile.id).single();d&&(e.profile=d),nn(c,t,o)}function ur(){const t=Math.random()*100;return t<.5?"legende":t<2?"special":t<10?"normal_high":"normal_low"}function yt(t){return Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function fr(t,e){let i;switch(e){case"legende":i=t.filter(o=>o.rarity==="legende"),i.length||(i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=t.filter(o=>yt(o)>=6));break;case"special":i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=t.filter(o=>yt(o)>=6));break;case"normal_high":i=t.filter(o=>o.rarity==="normal"&&yt(o)>=6),i.length||(i=t.filter(o=>yt(o)>=6));break;default:i=t.filter(o=>o.rarity==="normal"&&yt(o)>=1&&yt(o)<=5),i.length||(i=t.filter(o=>o.rarity==="normal"));break}return i.length||(i=t),i[Math.floor(Math.random()*i.length)]}async function Oi(t,e){if(e.cost>0){const{error:x}=await v.from("users").update({credits:t.credits-e.cost}).eq("id",t.id);if(x)throw x;t.credits-=e.cost,Ti(t.credits)}const i=e.allow_duplicates!==!1;let o=[];const{data:a,error:n}=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.id);if(n){const{data:x}=await v.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",t.id);o=x||[]}else o=a||[];const r=new Set(o.filter(x=>x.card_type==="player").map(x=>x.player_id)),s=new Set(o.filter(x=>x.card_type==="formation").map(x=>x.formation)),c=new Set(o.filter(x=>x.card_type==="game_changer").map(x=>x.gc_type)),l=new Set(o.filter(x=>x.card_type==="stadium").map(x=>x.stadium_id).filter(Boolean)),d=new Set,f=[];for(let x=0;x<(e.cardCount||5);x++){const b=sr(e.rates);if(b){if(b.card_type==="player"){const g=$=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[$]||$,p=b.rarity?g(b.rarity):null;let u=v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);p&&(u=u.eq("rarity",p));const{data:y}=await u;let w=y||[];if((b.note_min||b.note_max)&&(w=w.filter($=>{const T=Math.max(Number($.note_g)||0,Number($.note_d)||0,Number($.note_m)||0,Number($.note_a)||0);return(!b.note_min||T>=b.note_min)&&(!b.note_max||T<=b.note_max)})),w.length||(b.note_min||b.note_max?(w=y||[],console.warn("[Booster] Aucun joueur avec note",b.note_min,"-",b.note_max,"— fallback rareté uniquement")):w=y||[]),!w.length)continue;let h=w.filter($=>!d.has($.id));if(i)h.length||(h=w);else if(h=h.filter($=>!r.has($.id)),!h.length)continue;const E=h[Math.floor(Math.random()*h.length)];d.add(E.id);const m=r.has(E.id),{data:A}=await v.from("cards").insert({owner_id:t.id,player_id:E.id,card_type:"player"}).select().single();A&&(f.push({...A,player:E,isDuplicate:m}),v.rpc("record_transfer",{p_card_id:A.id,p_player_id:E.id,p_club_name:t.club_name||t.pseudo,p_manager_name:t.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(b.card_type==="game_changer"){const{data:g}=await v.from("gc_definitions").select("id,name,color,effect,image_url,gc_type").eq("is_active",!0).eq("gc_type","game_changer"),p=g!=null&&g.length?g:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],u=i?p:p.filter(E=>!c.has(E.name));if(!i&&!u.length)continue;const y=u[Math.floor(Math.random()*u.length)],w=y.name,{data:h}=await v.from("cards").insert({owner_id:t.id,card_type:"game_changer",gc_type:w,gc_definition_id:y.id||null}).select().single();h&&f.push({...h,_gcDef:y})}else if(b.card_type==="formation"){const g=Qo(),p=i?g:g.filter(h=>!s.has(h));if(!i&&!p.length)continue;const u=p[Math.floor(Math.random()*p.length)],y=s.has(u),{data:w}=await v.from("cards").insert({owner_id:t.id,card_type:"formation",formation:u}).select();w!=null&&w[0]&&f.push({...w[0],isDuplicate:y})}else if(b.card_type==="stadium"){const{data:g,error:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(p){console.error("[Booster] stadium_definitions:",p.message);continue}if(!(g!=null&&g.length)){console.warn("[Booster] Aucun stade en DB");continue}const u=i?g:g.filter(E=>!l.has(E.id));if(!i&&!u.length)continue;const y=u[Math.floor(Math.random()*u.length)],{data:w,error:h}=await v.from("cards").insert({owner_id:t.id,card_type:"stadium",stadium_id:y.id}).select("id,card_type,stadium_id").single();if(h){console.error("[Booster] insert stadium card:",h.message);continue}w&&f.push({...w,rarity:"normal",_stadiumDef:y})}}}return f}async function en(t,e,i){if(i>0){const{error:l}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(l)throw l;t.credits-=i,Ti(t.credits)}const{data:o}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const a=o.filter(l=>l.job==="GK"),n=o.filter(l=>l.job!=="GK"),r=!t.first_booster_opened&&a.length>0,s=[];for(let l=0;l<e;l++){const d=l===0&&r?a:l===0?n:o,f=ur(),x=fr(d,f);x&&s.push(x)}r&&await v.from("users").update({first_booster_opened:!0}).eq("id",t.id);const{data:c}=await v.from("cards").insert(s.map(l=>({owner_id:t.id,player_id:l.id,card_type:"player"}))).select();return(c||[]).forEach((l,d)=>{v.rpc("record_transfer",{p_card_id:l.id,p_player_id:s[d].id,p_club_name:t.club_name||t.pseudo,p_manager_name:t.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),s.map((l,d)=>({...c[d],player:l}))}async function tn(t,e,i){const{error:o}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;t.credits-=i,Ti(t.credits);const{data:a}=await v.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),n=a!=null&&a.length?a:Object.keys(Ri).map(f=>({name:f,gc_type:"game_changer"})),r=Array.from({length:e},()=>n[Math.floor(Math.random()*n.length)]),s=r.map(f=>({owner_id:t.id,card_type:"game_changer",gc_type:f.name,gc_definition_id:f.id||null})),{data:c,error:l}=await v.from("cards").insert(s).select();return l&&console.error("[Booster GC] Erreur insert:",l.message,l),(c||[]).map((f,x)=>({...f,_gcDef:r[x]||null}))}async function on(t,e){const{error:i}=await v.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;t.credits-=e,Ti(t.credits);const{data:o}=await v.from("cards").select("formation").eq("owner_id",t.id).eq("card_type","formation"),a=new Set((o||[]).map(d=>d.formation)),n=Qo(),r=n[Math.floor(Math.random()*n.length)],s=a.has(r),{data:c,error:l}=await v.from("cards").insert({owner_id:t.id,card_type:"formation",formation:r}).select();return l&&console.error("[Booster Formation] Erreur insert:",l.message,l),(c||[]).map(d=>({...d,isDuplicate:s}))}function nn(t,e,i,o=null){var V,I;if(!t||t.length===0){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",_.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.5)">Erreur lors du tirage (permissions DB ou colonne manquante)</div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(_),(V=_.querySelector("#anim-close-err"))==null||V.addEventListener("click",()=>_.remove());return}t=[...t].sort((_,R)=>{const W=_.player?yt(_.player):-1;return(R.player?yt(R.player):-1)-W});const a=document.createElement("div");a.id="booster-anim-overlay",a.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(a);let n=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let c=!1;const l=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function d(_){n||(c=!0,s.style.opacity="1",f(_))}function f(_){if(!c||n)return;const R=r.getBoundingClientRect(),W=l(_)-R.left,de=Math.max(0,Math.min(1,W/R.width));s.style.width=de*R.width+"px",de>=.82&&b()}function x(){n||(c=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{n||(s.style.transition="")},220))}function b(){var R;if(n)return;n=!0,c=!1,s.style.width="100%",s.style.opacity="1",(R=document.getElementById("cut-flash"))==null||R.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}r.addEventListener("pointerdown",d),window.addEventListener("pointermove",f),window.addEventListener("pointerup",x),r.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",x);let g=0,p=!1;const u=new Set;function y(_){g=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),T()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((R,W)=>`<div class="card-dot" data-i="${W}" style="width:8px;height:8px;border-radius:50%;background:${W===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(R=>R.addEventListener("click",()=>m(parseInt(R.dataset.i)))))}function h(_,R){var C,K;const W=t[_],de=document.getElementById("card-counter"),ce=document.getElementById("card-track");de&&(de.textContent=`Carte ${_+1} / ${t.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=_===t.length-1?"flex":"none");const H=W.card_type==="player"&&((C=W.player)==null?void 0:C.rarity)==="legende",pe=!u.has(_);u.add(_);let me=0;if(W.card_type==="player"&&W.player){const Q=W.player,X=Q.job||"ATT";me=(Number(X==="GK"?Q.note_g:X==="DEF"?Q.note_d:X==="MIL"?Q.note_m:Q.note_a)||0)+(W.evolution_bonus||0)}const fe=Q=>{ce.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${H?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${mr(W)}</div>
      ...
      </div>`,document.body.appendChild(o),o.addEventListener("click",r=>{r.target===o&&o.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>o.remove());return}br()}function br(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function xr(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText=`
    ...
    `,document.body.appendChild(e);try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(a){console.warn("[AdSense]",a)}let i=5;const o=setInterval(()=>{i--;const a=document.getElementById("mw-ad-cd");a&&(a.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}async function yr(t,{state:e,navigate:i,toast:o,refreshProfile:a}){var x,b;const{data:n}=await v.from("users").select("*").eq("id",e.user.id).single();n&&(e.profile=n);let r=Array.isArray((x=e.profile)==null?void 0:x.pending_boosters)?[...e.profile.pending_boosters]:[];if(!r.length){await v.from("users").update({onboarding_done:!0}).eq("id",e.user.id),i("home");return}let s=null;try{const p=(await Jo()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(s=Zo(p))}catch(g){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',g)}const c=r.length;let l=0;t.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const d=async()=>{await v.from("users").update({pending_boosters:r}).eq("id",e.user.id)};async function f(){var w;if(l>=c||!r.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),a&&await a(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const g=r[0],{data:p}=await v.from("users").select("*").eq("id",e.user.id).single();p&&(e.profile=p);let u=[];try{if(g.type==="formation")u=await on(e.profile,0);else if(g.type==="game_changer")u=await tn(e.profile,g.count||3,0);else if(s&&((w=s.rates)!=null&&w.length)){const h={...s,cost:0,cardCount:g.count||s.cardCount||5};u=await Oi(e.profile,h),g.guaranteeGK&&!e.profile.first_booster_opened&&(u.some(m=>m.player&&m.player.job==="GK")||await hr(e.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else u=await en(e.profile,g.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}r.shift(),l++,await d();const y=g.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:g.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${l}/${c})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};nn(u,y,i,()=>{f()})}(b=document.getElementById("onboard-start"))==null||b.addEventListener("click",()=>f())}async function hr(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],a=e.findIndex(r=>r.player);if(a===-1)return;const n=e[a];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[a]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Et={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},vr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Mt(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Hi(t,e){var n,r;const i=t.player,o=t.evolution_bonus||0,a=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:t.id,position:e||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?o:0)+(i.job2==="GK"&&a>0?o:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?o:0)+(i.job2==="DEF"&&a>0?o:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?o:0)+(i.job2==="MIL"&&a>0?o:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?o:0)+(i.job2==="ATT"&&a>0?o:0),evolution_bonus:o,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((r=i.clubs)==null?void 0:r.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function di(t,e){if(!e||!t)return t;const{club_id:i,country_code:o}=e;return Object.values(t).forEach(a=>{Array.isArray(a)&&a.forEach(n=>{const r=i&&String(n.club_id)===String(i),s=o&&String(n.country_code)===String(o);(r||s)&&(n.stadiumBonus=!0)})}),t}function vi(t,e){if(!e||!(t!=null&&t.length))return t;const{club_id:i,country_code:o}=e;return t.forEach(a=>{if(!a)return;const n=i&&String(a.club_id)===String(i),r=o&&String(a.country_code)===String(o);(n||r)&&(a.stadiumBonus=!0)}),t}function dt(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function rn(){const t=Math.random()*100;return t<10?10:t<30?5:3}function wi(t,e){const i=Et[e]||Et["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]};if(t.length&&t.every(r=>r.position)){for(const r of["GK","DEF","MIL","ATT"]){const s=t.filter(l=>l.position&&l.position.replace(/\d+$/,"")===r).sort((l,d)=>parseInt(l.position.replace(/\D+/g,""),10)-parseInt(d.position.replace(/\D+/g,""),10)).map(l=>({...l,_line:r})),c=dt(s.length);s.forEach((l,d)=>{l._col=c[d]}),o[r]=s}return o}const n=[...t];for(const r of["GK","DEF","MIL","ATT"]){const s=[];for(let l=0;l<i[r];l++){let d=n.findIndex(f=>f.job===r);if(d===-1&&(d=n.findIndex(f=>f.job2===r)),d===-1&&(d=0),n[d]){const f={...n[d],_line:r};s.push(f),n.splice(d,1)}}const c=dt(s.length);s.forEach((l,d)=>{l._col=c[d]}),o[r]=s}return o}function ct(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.setProperty("display","none","important"),e.dataset.matchHidden="1"}),t&&t.style.setProperty("padding-bottom","0","important")}function Ve(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.removeProperty("display"),delete e.dataset.matchHidden}),t&&t.style.removeProperty("padding-bottom")}function Si(t,e,i){const a=new Set,n=e.filter(d=>{var x;const f=((x=d._gcDef)==null?void 0:x.name)||d.gc_type||d.id;return a.has(f)?!1:(a.add(f),!0)});let r=[];function s(d,f){const x=d._gcDef,b=(x==null?void 0:x.name)||d.gc_type,g=x!=null&&x.image_url?`/icons/${x.image_url}`:null,p=nt(b,g,"⚡",(x==null?void 0:x.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${d.id}"
    ...
    </div>`}const c=d=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(d)};function l(){var f,x,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const d=r.length>0;t.innerHTML=`
    ...
    </div>`,t.querySelectorAll(".gc-select-card").forEach(g=>{g.addEventListener("click",()=>{const p=g.dataset.id,u=n.find(w=>w.id===p);if(!u)return;const y=r.findIndex(w=>w.gc_type===u.gc_type);y>-1?r.splice(y,1):r.length<3&&r.push(u),l()})}),(f=t.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{d&&c(r)}),(x=t.querySelector("#gc-no-gc"))==null||x.addEventListener("click",()=>c([])),(b=t.querySelector("#gc-reset"))==null||b.addEventListener("click",()=>{r.length&&(r=[],l())})}l()}function wr(t,e){var a;const i=((a=e==null?void 0:e.state)==null?void 0:a.params)||{},o=t||i.matchMode||"vs_ai_easy";return o==="friend"?`Match vs ${i.friendName||"Ami"}`:o==="random"?"Match vs Random":o==="ranked"?"Match Classé":o==="mini_league"||o==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${o.replace("vs_ai_","").toUpperCase()}`}async function _r(t,e,i){const{state:o,navigate:a}=e;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Mt(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}const r=n.map(x=>x.id),{data:s}=await v.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),c=[...new Set((s||[]).filter(x=>{var b,g;return((b=x.card)==null?void 0:b.card_type)==="stadium"&&((g=x.card)==null?void 0:g.stadium_id)}).map(x=>x.card.stadium_id))],l={};if(c.length){const{data:x}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(x||[]).forEach(b=>{l[b.id]=b}),(s||[]).forEach(b=>{var g,p;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((p=b.card)!=null&&p.stadium_id)&&(b.card._stadiumDef=l[b.card.stadium_id]||null)})}let d=0;function f(){var m,A,$,T,P,G,O;const x=n[d],b=(s||[]).filter(V=>V.deck_id===x.id),g=b.filter(V=>{var I;return V.is_starter&&((I=V.card)==null?void 0:I.player)}).map(V=>Hi(V.card,V.position)),p=b.find(V=>{var I;return((I=V.card)==null?void 0:I.card_type)==="formation"}),u=x.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let y=g.length>=11?wi(g,u):null,w=((A=x.stadium_card)==null?void 0:A.stadium_def)||null;w&&y&&(y=di(y,w));const h=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        <div style="padding:8px 16px;background:rgba(0,0,0,0.4);text-align:center">
          <div style="font-size:10px;opacity:.6;letter-spacing:2px;text-transform:uppercase">${wr(i,e)}</div>
      ...
      <!-- Pagination -->
      ${n.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${n.map((V,I)=>`<div style="width:6px;height:6px;border-radius:50%;background:${I===d?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function V(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!y)return;const R=_.clientWidth>=900,W=Math.max(200,_.clientHeight-(R?60:40)),ce=Math.max(200,_.clientWidth-16),j=R?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(W<220||ce<220){requestAnimationFrame(V);return}const H=R?null:Math.round(j*.55);I.innerHTML=Ut(y,u,null,[],ce,W,[],H),I.style.cssText=`width:${ce}px;height:${W}px;overflow:hidden;margin:${R?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",R?"xMidYMid meet":"none"))})),(T=document.getElementById("prev-deck"))==null||T.addEventListener("click",()=>{d>0&&(d--,f())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{d<n.length-1&&(d++,f())}),(G=document.getElementById("validate-deck"))==null||G.addEventListener("click",()=>{if(!h)return;const V=e.state.params||{};e.navigate("match",{...V,matchMode:V.matchMode||i,deckId:x.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),a("home")});const E=document.getElementById("deck-swipe-zone");if(E){let V=0,I=0;E.addEventListener("touchstart",_=>{V=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const R=_.changedTouches[0].clientX-V,W=_.changedTouches[0].clientY-I;Math.abs(R)<40||Math.abs(R)<Math.abs(W)||(R<0&&d<n.length-1?(d++,f()):R>0&&d>0&&(d--,f()))},{passive:!0})}}f()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,a){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let r='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,c)=>{const l=s._line||s.job||"MIL";let d=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(l==="ATT"||l==="MIL")||o==="defense"&&(l==="GK"||l==="DEF"||l==="MIL")?d+=10:o||(d+=10)),r+=ze({...s,_evolution_bonus:0,evolution_bonus:0},{width:40,role:l,extraNote:d}),c<n.length-1){const f=n[c+1],x=Yo(s,f,a)?Dt(s,f):null;r+=`<div style="width:7px;height:3px;background:${!x||x==="#ff3333"||x==="#cc2222"?"rgba(255,255,255,0.12)":x};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(r+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),r+="</div>",r}function Ai(t,e,i,o,a=310,n=310,r=[],s=null){const c=ut[e]||{},l=Li(e)||Ii[e]||[],d={},f=["ATT","MIL","DEF","GK"];for(const y of f)(t[y]||[]).forEach((h,E)=>{d[`${y}${E+1}`]=h});function x(y){const w=c[y];return w?{x:w.x*a,y:w.y*n}:null}let b="";for(const[y,w]of l){const h=x(y),E=x(w);if(!h||!E)continue;const m=d[y],A=d[w],$=Dt(m,A);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(a*.225)),117):Math.max(44,Math.round(a*.168)),p=Math.round(g*657/507);for(const[y,w]of Object.entries(d)){const h=x(y);if(!h||!w)continue;const E=y.replace(/[0-9]/g,""),m=r.includes(w.cardId),A=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,$=o.includes(w.cardId);let T=w.boost||0,P=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(T+=10,P=!0):i||(T+=10,P=!0));const G=Math.round(h.x-g/2),O=Math.round(h.y-p/2);if(w.used){b+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${G}" y="${O}" width="${g}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const V=ze({...w,_evolution_bonus:0,stadiumBonus:!1},{width:g,showStad:!1,stadDef:null,role:E,extraNote:T,_cardOffset:30,_forceStadColor:P}),I=$?`position:absolute;top:30px;left:0;width:${g}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";b+=`<foreignObject x="${G-2}" y="${O-30}" width="${g+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${V}
        ${$?`<div style="${I}"></div>`:""}
      </div>
    </foreignObject>`,A&&(b+=`<rect x="${G}" y="${O}" width="${g}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const u=s!==null?s:Math.round(Math.max(g*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${a+u*2} ${n+u*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${b}
  </svg>`}function Ut(t,e,i,o,a=300,n=300,r=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Ai(t,e,i,o,a,n,r,s)}
  </div>`}async function zi(t,e,i,o){var A;const{state:a,navigate:n,toast:r}=e;ct(t);const s=a.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return _r(t,e,i);const c=s.deckId;let l,d,f,x;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);l=$[0].data,f=$[0].error,d=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Mt(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),Mt(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(d||[]).filter($=>{var T;return $.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Hi($.card,$.position)),g=(d||[]).filter($=>{var T;return!$.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Hi($.card,$.position));if(b.length<11){Mt(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(d||[]).find($=>{var T;return((T=$.card)==null?void 0:T.card_type)==="formation"}),u=(l==null?void 0:l.formation)||((A=p==null?void 0:p.card)==null?void 0:A.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",a.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(T=>T.name===$.gc_type||T.id===$.gc_definition_id))||null}));let m=null;if(l!=null&&l.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",l.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:T}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=T||null}}o({deckId:c,formation:u,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function Ct(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(Ct()*1.1)}function an(t){var a,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((a=t.clubs)==null?void 0:a.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Bt(t)}}function kr(t,e,i,o="Adversaire"){Po("/sounds/match-opening.mp3",.3);const a=Ct(),n=Ot();return`
    ...
    </div>`}function sn(t){var n,r,s;if(!t)return"";const e=c=>c?ze({...c,_evolution_bonus:0},{width:52,role:c._line||c.job,showStad:!!c.stadiumBonus,extraNote:c.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    </div>`}function tt(t,e,i,o,a){Qi("/sounds/goal.mp3",.7);const n=document.getElementById("goal-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="goal-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.85);pointer-events:none`;const s=(t||[]).slice(0,3).map(c=>ze({...c,_evolution_bonus:0},{width:Math.min(140,Math.round(window.innerWidth/4)),role:c._line||c.job,showStad:!!c.stadiumBonus})).join("");if(r.innerHTML=`
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(c)}setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.4s",setTimeout(()=>{r.remove(),a==null||a()},400)},1800)}function $r(t,e,i){const o=document.getElementById("sub-anim-overlay");o&&o.remove();const a=document.createElement("div");a.id="sub-anim-overlay",a.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.8);pointer-events:none`;const n=Math.min(120,Math.round(window.innerWidth/4)),r=t?ze({...t,_evolution_bonus:0},{width:n,role:t._line||t.job}):"",s=e?ze({...e,_evolution_bonus:0},{width:n,role:e._line||e.job}):"";a.innerHTML=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,a.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.3s",setTimeout(()=>a.remove(),300)},i)}function ln(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+ln(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Dt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function _i(t,e,i,o,a){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,r)=>{const s=r<t.length-1?Dt(n,t[r+1]):null,c=!s||s==="#ff3333"||s==="#cc2222",l=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return ln(n,a),n.stadiumBonus||a&&(a.club_id&&String(n.club_id)===String(a.club_id)||a.country_code&&(n.country_code,a.country_code)),`
          <div class="duel-card duel-card-${o}" data-idx="${r}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${ze({...n,_evolution_bonus:0},{width:window.innerWidth>=900?Math.min(130,Math.max(80,Math.round(window.innerWidth*.08))):58,showStad:!0,stadDef:a,role:"MIL",extraNote:n.boost||0})}
          </div>
          ${r<t.length-1?`<div class="duel-link duel-link-${o}" data-idx="${r}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${c?"rgba(255,255,255,0.12)":s};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${c?"none":`0 0 8px ${s}`}">
      ...
      <div class="duel-score-line duel-score-line-${o}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${vt(t,a)} + ${wt(t)} liens = <b style="color:#fff">${vt(t,a)+wt(t)}</b>
      </div>
    </div>`}async function Er(t,e){const{state:i}=e,o=i.params||{},a=o.matchMode||"vs_ai_easy",n=a==="solo",r=a==="ranked_ai",s=o.soloLevel||1,c=a.replace("vs_ai_",""),l=a;let d=null;if(n){const{data:g}=await v.from("solo_levels").select("*").eq("level_number",s).maybeSingle();d=g||{level_number:s,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const f=o.rankedData||null,x=o.presetSetup||null;async function b({deckId:g,formation:p,starters:u,subsRaw:y,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let m=wi(u,p);E&&(m=di(m,E),vi(y,E));let A=null;if(r){const G=Ir(m),{jaune:O,vert:V}=Tr(m,p),I=.9+Math.random()*.2;A={target_note_avg:Math.max(1,Math.round(G*I/16)),nb_liens_jaune:O,nb_liens_vert:V,nb_joueurs_stade:E?3:0}}const $=n?await Lo(p,d):r?await Lo(p,A):await Lr(p,c),T=$.lines||$,P=async G=>{try{const O=l==="vs_ai_club"||l==="solo"||l==="ranked_ai"?"club":l,{data:V,error:I}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:O,home_deck_id:g,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),Mt(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&T&&(di(T,_),vi($.subs||[],_));const R={gcDefs:h||[],matchId:V==null?void 0:V.id,mode:l,difficulty:c,formation:p,isSolo:n,soloLevel:s,soloLevelConfig:d,isRankedAI:r,rankedAIData:f,homeTeam:m,aiTeam:T,homeSubs:y,subsUsed:0,maxSubs:Math.min(y.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:G,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Sr(t,R,e)}catch(O){console.error("[MatchIA] Exception launchMatch:",O),Mt(t,"⚠️","Erreur au lancement du match : "+O.message,"Retour",()=>e.navigate("home"))}};if(r&&x){P(x.gcCardsEnriched||[]);return}if(!w.length){P([]);return}Si(t,w,P)}catch(m){console.error("[MatchIA] Exception setup:",m),Mt(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}x?await b(x):await zi(t,e,a,b)}async function Lr(t,e){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function r(y,w,h){var E,m;return n.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!n.has($.id)),h=i.filter($=>$.job!==y&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[y];$++){const T=E[$];T&&m.push(r(T,y,$))}const A=dt(m.length);m.forEach(($,T)=>{$._col=A[T]}),a[y]=m}const c=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>r(y,y.job,100+w)),{data:l}=await v.from("gc_definitions").select("*").eq("is_active",!0),f=[...l||[]].sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>({id:"ai-gc-"+w,gc_type:y.name,name:y.name,icon:"⚡",effect_type:y.effect_type,effect_params:y.effect_params||{}})),x=Object.values(a).flat(),b={};x.forEach(y=>{y.club_id&&(b[y.club_id]=(b[y.club_id]||0)+1)});const g=(u=Object.entries(b).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:a,subs:c,gcCards:f,stadiumDef:p}}function Ir(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const a=o._line||i,n=Number(a==="GK"?o.note_g:a==="DEF"?o.note_d:a==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Tr(t,e){const i={};for(const r of["GK","DEF","MIL","ATT"])(t[r]||[]).forEach((s,c)=>{i[`${r}${c+1}`]=s});const o=Li(e)||Ii[e]||[];let a=0,n=0;for(const[r,s]of o){const c=i[r],l=i[s];if(!c||!l)continue;const d=Dt(c,l);d==="#00ff88"?n++:d==="#FFD700"&&a++}return{jaune:a,vert:n}}function Eo(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function mi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((a,n)=>Math.abs(Eo(a)-e)-Math.abs(Eo(n)-e));return o.slice(0,Math.min(i,o.length))}async function Lo(t,e){var V,I;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,a=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:r}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!r||r.length<16)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const s={};r.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const c=((V=Object.entries(s).sort((_,R)=>R[1]-_[1])[0])==null?void 0:V[0])||null,l=c?r.filter(_=>_.club_id===c):[],d=((I=l[0])==null?void 0:I.country_code)||null,f=d?r.filter(_=>_.country_code===d&&_.club_id!==c):[],x=Math.min(l.length,Math.max(2,a+1),16),b=Math.min(f.length,Math.max(0,o),16-x),g=[],p=new Set;mi(l,i,x).forEach(_=>{g.push(_),p.add(_.id)}),mi(f,i,b).forEach(_=>{g.push(_),p.add(_.id)});const u=Math.max(0,16-g.length),y=r.filter(_=>!p.has(_.id));mi(y,i,u).forEach(_=>{g.push(_),p.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,R,W){var de,ce;return E.add(_.id),{cardId:"ai-"+_.id+"-"+W,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((de=_.clubs)==null?void 0:de.encoded_name)||null,clubLogo:((ce=_.clubs)==null?void 0:ce.logo_url)||null,boost:0,used:!1,_line:R}}for(const _ of["GK","DEF","MIL","ATT"]){const R=g.filter(H=>H.job===_&&!E.has(H.id)),W=g.filter(H=>H.job!==_&&!E.has(H.id)),de=[...R,...W],ce=[];for(let H=0;H<w[_];H++){const pe=de[H];pe&&ce.push(m(pe,_,H))}const j=dt(ce.length);ce.forEach((H,pe)=>{H._col=j[pe]}),h[_]=ce}let A=g.filter(_=>!E.has(_.id));if(A.length<5){const _=r.filter(R=>!E.has(R.id)&&!A.some(W=>W.id===R.id));A=A.concat(mi(_,i,5-A.length))}const $=A.slice(0,5).map((_,R)=>m(_,_.job,100+R)),{data:T}=await v.from("gc_definitions").select("*").eq("is_active",!0),G=[...T||[]].sort(()=>Math.random()-.5).slice(0,3).map((_,R)=>({id:"ai-gc-"+R,gc_type:_.name,name:_.name,icon:"⚡",effect_type:_.effect_type,effect_params:_.effect_params||{}}));let O=null;if(n>0&&c){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(O={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:G,stadiumDef:O}}function dn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let c=0;c<e[n];c++){const l=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?l:2,note_d:n==="DEF"?l:2,note_m:n==="MIL"?l:2,note_a:n==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const s=dt(r.length);r.forEach((c,l)=>{c._col=s[l]}),i[n]=r}return i}function Sr(t,e,i){var a;Po("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const n=t.querySelector(".opponent-preview-wrap"),r=t.querySelector("#opponent-swipe-zone");if(!n||!r)return;const s=r.clientWidth>=900,c=Math.max(200,r.clientHeight-(s?8:40)),l=Math.max(200,r.clientWidth-(s?8:16)),d=s?null:Math.round(Math.max(44,Math.round(l*.168))*.55);n.innerHTML=Ut(e.aiTeam,e.formation,null,[],l,c,[],d),n.style.cssText=`width:${l}px;height:${c}px;overflow:hidden;flex-shrink:0`;const f=n.querySelector("svg");f&&(f.style.cssText="display:block;width:100%;height:100%",f.setAttribute("preserveAspectRatio",s?"xMidYMid meet":"none"))})),setTimeout(()=>Ar(t,e,i),5e3)}const Ye=t=>an(t);function Ar(t,e,i){const o=e.homeTeam.MIL||[],a=e.aiTeam.MIL||[],n=e.stadiumDef||null,r=e.aiStadiumDef||null,s=vt(o,n)+wt(o),c=vt(a,r)+wt(a),l=s>=c;t.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(e.phase==="defense"&&e.pendingAttack){const H=e.pendingAttack;let pe="";if(e.selected.length>0){const me=e.selected.map(C=>({...(e.homeTeam[C._role]||[]).find(Q=>Q.cardId===C.cardId)||C,_line:C._role})),fe=li(me,e.modifiers.home,e.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          </div>`}const j=e.log[e.log.length-1];return j?'<div style="padding:2px 4px">'+sn(j)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
  ...
  <div id="match-history-panel">
  ...
  </div>`;function T(){const j=t.querySelector(".match-screen");if(!j)return;const H=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);j.style.bottom="auto",j.style.height=H+"px",j.style.minHeight=H+"px",j.style.maxHeight=H+"px",j.style.overflow="hidden";const pe=t.querySelector("#mobile-action-bar"),me=t.querySelector("#mobile-play-area");pe&&me&&(me.style.paddingBottom=pe.offsetHeight+"px")}if(T(),setTimeout(T,120),setTimeout(T,400),setTimeout(T,1e3),e._vvBound||(e._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",T),window.visualViewport.addEventListener("scroll",T)),window.addEventListener("resize",T)),function(){const H=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!H)return;const pe=H.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),H.removeAttribute("width"),H.removeAttribute("height"),H.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",H.setAttribute("preserveAspectRatio","xMidYMid meet")}(),e._resizeBound||(e._resizeBound=!0,window.addEventListener("resize",()=>{const j=t.querySelector(".terrain-wrapper svg");if(j){const H=j.closest("#match-terrain-wrap");H&&(H.style.cssText="position:relative;width:100%;height:100%;padding:0"),j.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),e.phase==="attack"||e.phase==="defense"){let j=!1,H=30;const pe=()=>document.getElementById("match-timer"),me=()=>{const fe=pe();if(!fe)return;const C=String(Math.floor(H/60)).padStart(2,"0"),K=String(H%60).padStart(2,"0");fe.textContent=` ${C}:${K}`,fe.style.color=j?"#ff2222":"#ff9500",fe.style.fontWeight="900"};me(),e._timerInt=setInterval(()=>{if(H--,H<0)if(!j)j=!0,H=15,me(),No("/sounds/timer-urgent.mp3",.6);else{clearInterval(e._timerInt),e._timerInt=null,Ke(),e.homeScore=0,e.aiScore=3;const fe=document.createElement("div");fe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",fe.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(fe),setTimeout(()=>{fe.remove(),_t(t,e,i)},2500)}else me()},1e3)}(G=document.getElementById("match-quit"))==null||G.addEventListener("click",()=>{Ve(t),confirm("Abandonner ? Résultat : défaite 3-0")&&(e.homeScore=0,e.aiScore=3,_t(t,e,i))}),(O=document.getElementById("view-ai"))==null||O.addEventListener("click",()=>Rr(e,i)),(V=document.getElementById("toggle-history"))==null||V.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.add("open")}),(I=document.getElementById("close-history"))==null||I.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.remove("open")}),(_=document.getElementById("btn-action"))==null||_.addEventListener("click",()=>{e.selected.length!==0&&(u?Mr(t,e,i):y&&Cr(t,e,i))}),(R=document.getElementById("btn-results"))==null||R.addEventListener("click",()=>_t(t,e,i)),(W=document.getElementById("btn-pass"))==null||W.addEventListener("click",()=>{if(e.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Ui(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="ai-attack",Te(t,e,i),setTimeout(()=>oo(t,e,i),800)}),t.querySelectorAll(".match-slot-hit").forEach(j=>{j.addEventListener("click",()=>zr(j,e,t,i))}),t.querySelectorAll(".match-used-hit").forEach(j=>{j.addEventListener("click",()=>Fi(t,e,i,null,j.dataset.cardId))}),t.querySelectorAll(".gc-mini").forEach(j=>{u?j.addEventListener("click",()=>Fr(j.dataset.gcId,j.dataset.gcType,t,e,i)):(j.style.opacity="0.35",j.style.cursor="default",j.addEventListener("click",()=>Tt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(de=document.getElementById("boost-card"))==null||de.addEventListener("click",()=>Gr(t,e,i)),t.querySelectorAll(".sub-btn-col").forEach(j=>{j.addEventListener("click",()=>Fi(t,e,i,j.dataset.subId))}),(ce=document.getElementById("sub-btn-main"))==null||ce.addEventListener("click",()=>Fi(t,e,i))}function zr(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(s=>s.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const s=(e.homeTeam[n]||[]).find(c=>c.cardId===a);s&&e.selected.push({...s,_role:n,_line:n})}Te(i,e,o)}function io(t,e,i){t.matchId&&v.from("matches").update({last_player_id:i}).eq("id",t.matchId).then(()=>{})}function Mr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),io(e,i,i.state.profile.id);const o=e.selected.map(n=>{const r=(e.homeTeam[n._role]||[]).find(c=>c.cardId===n.cardId)||n,s=["GK","DEF"].includes(n._role);return{...r,_line:n._role,...s?{note_a:Math.max(1,Number(r.note_a)||0)}:{}}}),a=si(o,e.modifiers.home,e.formation);e.pendingAttack={...a,players:[...o],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(s=>s.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`⚔️ Vous attaquez : ${a.total} (base ${a.base}${a.links?` +${a.links} liens`:""}) — ${e.selected.map(n=>n.name).join(", ")}`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",Te(t,e,i),setTimeout(()=>Dr(t,e,i),1200)}function Cr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),io(e,i,i.state.profile.id);const o=e.stadiumDef||null,a=e.selected.map(c=>{const l=(e.homeTeam[c._role]||[]).find(f=>f.cardId===c.cardId)||c,d=l.stadiumBonus||o&&(o.club_id&&String(l.club_id)===String(o.club_id)||o.country_code&&l.country_code===o.country_code)||!1;return{...l,_line:c._role,stadiumBonus:d}}),n=li(a,e.modifiers.home,e.formation);e.selected.forEach(c=>{const l=(e.homeTeam[c._role]||[]).find(d=>d.cardId===c.cardId);l&&(l.used=!0)});const r=to(e.pendingAttack.total,n.total,e.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(e.pendingAttack.players||[]).map(c=>Ye(c)),homePlayers:e.selected.map(c=>{const l=(e.homeTeam[c._role]||[]).find(d=>d.cardId===c.cardId)||c;return Ye(l)}),homeTotal:n.total,aiTotal:e.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(r.shielded)s.text="🛡️ Bouclier ! But annulé.",e.log.push(s);else if(r.goal){e.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${e.pendingAttack.total} > ${n.total})`,e.log.push(s),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Te(t,e,i),tt(s.aiPlayers,e.homeScore,e.aiScore,!1,()=>{jt(t,e,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${n.total} ≥ ${e.pendingAttack.total})`,e.log.push(s);e.selected=[],e.modifiers.home={},e.pendingAttack=null,jt(t,e,i,"home-attack")}function jr(t){if(t.aiSubsUsed>=t.aiMaxSubs)return;const e=Object.values(t.aiTeam).flat().filter(c=>c.used);if(!e.length)return;const i=(t.aiSubs||[]).filter(c=>!t.aiUsedSubIds.includes(c.cardId));if(!i.length)return;const o=e[Math.floor(Math.random()*e.length)],a=i.find(c=>c.job===o.job)||i[0],n={...a,used:!1,_line:o._line,_col:o._col},r=t.aiTeam[o._line],s=r.findIndex(c=>c.cardId===o.cardId);s!==-1&&(r[s]=n),t.aiUsedSubIds.push(a.cardId),t.aiSubsUsed++,t.log.push({text:`🔄 IA : ${a.firstname} ${a.name} remplace ${o.firstname} ${o.name}`,type:"info"})}function Br(t,e){const i=t.effect_params||{},o=i.value||1,a=i.count||1,n=i.roles||[],r=i.target||"home";switch(t.effect_type){case"BOOST_STAT":{const c=Object.values(e.aiTeam).flat().filter(l=>!l.used&&(!n.length||n.includes(l._line))).sort(()=>Math.random()-.5).slice(0,a);c.forEach(l=>{l.boost=(l.boost||0)+o}),c.length&&e.log.push({text:`⚡ IA : +${o} sur ${c.length} joueur(s)`,type:"gc"});break}case"DEBUFF_STAT":{const s=r==="ai"?e.aiTeam:e.homeTeam,l=Object.values(s).flat().filter(d=>!d.used&&(!n.length||n.includes(d._line))).sort(()=>Math.random()-.5).slice(0,a);l.forEach(d=>{d.boost=(d.boost||0)-o}),l.length&&e.log.push({text:`🎯 IA : -${o} sur ${l.length} joueur(s)${r!=="ai"?" (vous)":""}`,type:"gc"});break}case"GRAY_PLAYER":{const s=r==="ai"?e.aiTeam:e.homeTeam,l=Object.values(s).flat().filter(d=>!d.used&&(!n.length||n.includes(d._line))).sort(()=>Math.random()-.5).slice(0,a);l.forEach(d=>{d.used=!0}),l.length&&e.log.push({text:`❌ IA : ${l.length} joueur(s)${r!=="ai"?" (vous)":""} exclu(s)`,type:"gc"});break}case"REVIVE_PLAYER":{const c=Object.values(e.aiTeam).flat().filter(l=>l.used).sort(()=>Math.random()-.5).slice(0,a);c.forEach(l=>{l.used=!1}),c.length&&e.log.push({text:`💫 IA : ${c.length} joueur(s) ressuscité(s)`,type:"gc"});break}case"REMOVE_GOAL":e.homeScore>0&&(e.homeScore--,e.log.push({text:"🚫 IA : votre dernier but est annulé !",type:"gc"}));break;case"ADD_GOAL_DRAW":e.homeScore===e.aiScore&&(e.aiScore++,e.log.push({text:"🎯 IA : but bonus (match nul) !",type:"gc"}));break;case"ADD_SUB":e.aiMaxSubs=(e.aiMaxSubs||3)+o,e.log.push({text:`🔄 IA : +${o} remplacement(s)`,type:"gc"});break}}function qr(t){var o;if(!((o=t.aiGcCards)!=null&&o.length))return;const e=t.aiGcCards.filter(a=>!t.aiUsedGc.includes(a.id));if(!e.length||Math.random()>.5)return;const i=e[Math.floor(Math.random()*e.length)];t.aiUsedGc.push(i.id),i.effect_type?Br(i,t):t.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function oo(t,e,i){io(e,i,null),jr(e),qr(e);let o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(d=>!d.used),a=!1;if(!o.length){const d=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(x=>!x.used),f=Kt(e.homeTeam);if(f||d.length===0){const x=(e.aiTeam.DEF||[]).filter(g=>!g.used),b=(e.aiTeam.GK||[]).filter(g=>!g.used);o=f?x.length?x:b:[...x,...b],a=!0}}const n=Xo(o,"attack",e.difficulty);if(!n.length){Ki(t,e,i);return}a&&n.forEach(d=>{d._line=d._line||d.job,d.note_a=Math.max(1,Number(d.note_a)||0)});const r=si(n,e.modifiers.ai,e.formation);e.pendingAttack={...r,players:n,side:"ai"},n.forEach(d=>{d.used=!0}),e.log.push({text:`🤖 IA attaque : ${r.total} (${n.map(d=>d.name).join(", ")})`,type:"info"}),e.modifiers.ai={};const s=[...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(d=>!d.used),l=(e.homeSubs||[]).filter(d=>!(e.usedSubIds||[]).includes(d.cardId)).length>0&&e.subsUsed<e.maxSubs;if(s.length===0&&!l){if(n.length===1&&(n[0]._line==="GK"||n[0].job==="GK")&&Kt(e.homeTeam)&&e.homeScore===e.aiScore){e.aiScore++,ki(t,e,i,"ai",n[0]);return}e.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:n.map(x=>Ye(x)),aiTotal:r.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};e.log.push(f),e.pendingAttack=null,Te(t,e,i),tt(f.aiPlayers,e.homeScore,e.aiScore,!1,()=>{jt(t,e,i,"home-attack")});return}e.phase="defense",Te(t,e,i)}function Dr(t,e,i){var l,d;const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=Xo(o,"defense",e.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(e.aiTeam[f]||[]).filter(x=>!x.used)).length){const f=((l=e.pendingAttack)==null?void 0:l.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&e.homeScore===e.aiScore){e.homeScore++,ki(t,e,i,"home",f[0]);return}e.homeScore++;const b={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(g=>Ye(g)),homeTotal:((d=e.pendingAttack)==null?void 0:d.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};e.log.push(b),e.modifiers.ai={},e.pendingAttack=null,Te(t,e,i),tt(b.homePlayers,e.homeScore,e.aiScore,!0,()=>{jt(t,e,i,"ai-attack")});return}const r=a.length>0?li(a,e.modifiers.ai,e.formation).total:0;a.forEach(f=>{f.used=!0});const s=to(e.pendingAttack.total,r,e.modifiers.ai),c={type:"duel",title:"Attaque",homePlayers:(e.pendingAttack.players||[]).map(f=>Ye(f)),aiPlayers:a.map(f=>Ye(f)),homeTotal:e.pendingAttack.total,aiTotal:r,isGoal:!1,homeScored:!1,text:""};if(s.shielded)c.text="🛡️ Bouclier IA !",e.log.push(c);else if(s.goal){e.homeScore++,c.isGoal=!0,c.homeScored=!0,c.text=`⚽ BUT ! (${e.pendingAttack.total} > ${r})`,e.log.push(c),e.modifiers.ai={},e.pendingAttack=null,Te(t,e,i),tt(c.homePlayers,e.homeScore,e.aiScore,!0,()=>{jt(t,e,i,"ai-attack")});return}else c.text=`🧤 IA défend (${r} ≥ ${e.pendingAttack.total})`,e.log.push(c);e.modifiers.ai={},e.pendingAttack=null,jt(t,e,i,"ai-attack")}function jt(t,e,i,o){if(e.round++,!cn(t,e,i)){if(no(e)){_t(t,e,i);return}if(o==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used))){Ki(t,e,i);return}e.phase="attack",Te(t,e,i)}else{if(!["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used))){Ki(t,e,i);return}e.phase="ai-attack",Te(t,e,i),setTimeout(()=>oo(t,e,i),800)}}}function Kt(t){return!["GK","DEF","MIL","ATT"].some(e=>(t[e]||[]).some(i=>!i.used))}function Io(t){const e=(t.GK||[]).some(o=>!o.used),i=["DEF","MIL","ATT"].some(o=>(t[o]||[]).some(a=>!a.used));return e&&!i}function cn(t,e,i){if(e.homeScore!==e.aiScore)return!1;if(Io(e.homeTeam)&&Kt(e.aiTeam)){const o=(e.homeTeam.GK||[]).find(a=>!a.used);return o?(o.used=!0,e.homeScore++,ki(t,e,i,"home",o),!0):!1}if(Io(e.aiTeam)&&Kt(e.homeTeam)){const o=(e.aiTeam.GK||[]).find(a=>!a.used);return o?(o.used=!0,e.aiScore++,ki(t,e,i,"ai",o),!0):!1}return!1}function ki(t,e,i,o,a){e.log.push({type:"duel",isGoal:!0,homeScored:o==="home",homePlayers:o==="home"?[Ye(a)]:[],aiPlayers:o==="ai"?[Ye(a)]:[],text:`⚽ DERNIER CORNER — Le gardien ${o==="home"?"":"adverse "}marque !`});const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(n);const r=(s,c)=>new Promise(l=>{n.innerHTML=`<div style="font-size:32px;font-weight:900;color:${c};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(l,1400)});(async()=>(await r("⚽ DERNIER CORNER","#FFD700"),await r("🧤 LE GARDIEN MONTE !","#4fc3f7"),n.remove(),e.pendingAttack=null,Te(t,e,i),tt([Ye(a)],e.homeScore,e.aiScore,o==="home",()=>{if(no(e)){_t(t,e,i);return}jt(t,e,i,o==="home"?"ai-attack":"home-attack")})))()}function no(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Ui(t,e){return!(["MIL","ATT"].some(a=>(t[a]||[]).some(n=>!n.used))||Kt(e)||!["MIL","ATT"].some(a=>(e[a]||[]).some(n=>!n.used)))}function Ki(t,e,i){if(!cn(t,e,i)){if(no(e)){_t(t,e,i);return}if(Ui(e.homeTeam,e.aiTeam)&&Ui(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="attack",Te(t,e,i)}}function Fi(t,e,i,o=null,a=null){var b,g;if(e.phase!=="attack"){Tt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(e.usedSubIds||(e.usedSubIds=[]),e.subsUsed>=e.maxSubs){Tt(`Maximum ${e.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const n=Object.entries(e.homeTeam).flatMap(([p,u])=>(u||[]).filter(y=>y.used).map(y=>({...y,_line:y._line||p}))),r=e.homeSubs.filter(p=>!e.usedSubIds.includes(p.cardId));if(!n.length){Tt("Aucun joueur utilisé à remplacer");return}if(!r.length){Tt("Aucun remplaçant disponible");return}let s=Math.max(0,n.findIndex(p=>p.cardId===a));const c=((b=n[s])==null?void 0:b._line)||((g=n[s])==null?void 0:g.job);let l=o?Math.max(0,r.findIndex(p=>p.cardId===o)):Math.max(0,r.findIndex(p=>p.job===c)),d=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function x(){var m,A,$,T,P,G;const p=n[s],u=r[l],y=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(y*1.35),h=O=>`background:rgba(255,255,255,0.12);border:none;color:${O?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${O?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(A=f.querySelector("#out-up"))==null||A.addEventListener("click",()=>{s>0&&(s--,x())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<n.length-1&&(s++,x())}),(T=f.querySelector("#in-up"))==null||T.addEventListener("click",()=>{l>0&&(l--,x())}),(P=f.querySelector("#in-down"))==null||P.addEventListener("click",()=>{l<r.length-1&&(l++,x())});const E=(O,V,I,_)=>{const R=f.querySelector("#"+O);if(!R)return;let W=0;R.addEventListener("touchstart",de=>{W=de.touches[0].clientY},{passive:!0}),R.addEventListener("touchend",de=>{const ce=de.changedTouches[0].clientY-W;if(Math.abs(ce)<30)return;const j=V();ce<0&&j<_-1?(I(j+1),x()):ce>0&&j>0&&(I(j-1),x())},{passive:!0})};E("in-panel",()=>l,O=>l=O,r.length),E("out-panel",()=>s,O=>s=O,n.length),(G=f.querySelector("#sub-confirm"))==null||G.addEventListener("click",O=>{if(O.preventDefault(),O.stopPropagation(),d)return;d=!0;const V=n[s],I=r[l];if(!V||!I)return;let _=null,R=-1;for(const[de,ce]of Object.entries(e.homeTeam)){const j=(ce||[]).findIndex(H=>H.cardId===V.cardId);if(j!==-1){_=de,R=j;break}}if(R===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const W={...I,_line:_,_col:V._col||0,used:!1,boost:0};e.homeTeam[_].splice(R,1,W),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:V.name,firstname:V.firstname,note:Pe(V,_),portrait:Bt(V),job:V.job,country_code:V.country_code,rarity:V.rarity,clubName:V.clubName,clubLogo:V.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Pe(I,_),portrait:Bt(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${V.firstname} ${V.name}`}),f.remove(),$r(V,I,()=>Te(t,e,i))})}document.body.appendChild(f),x()}function Fr(t,e,i,o,a){var x,b;const n=(o.gcDefs||[]).find(g=>g.name===e),r=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||r.desc,l=n!=null&&n.image_url?`/icons/${n.image_url}`:null,d=r.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${nt(s,l,d,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#gc-back"))==null||x.addEventListener("click",()=>f.remove()),(b=f.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{f.remove(),Nr(t,e,i,o,a)})}function gi(t,e,i,o,a,n){const r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function c(){var l,d;r.innerHTML=`
    ...
    </div>`,(l=r.querySelector("#gc-picker-close"))==null||l.addEventListener("click",()=>r.remove()),r.querySelectorAll(".gc-pick-item").forEach(f=>{f.addEventListener("click",()=>{const x=f.dataset.cid,b=t.find(p=>p.cardId===x);if(!b)return;const g=s.findIndex(p=>p.cardId===x);g>-1?s.splice(g,1):s.length<e&&s.push(b),c()})}),(d=r.querySelector("#gc-picker-confirm"))==null||d.addEventListener("click",()=>{r.remove(),n(s)})}c(),document.body.appendChild(r)}const Pr={BOOST_STAT:({value:t=1,count:e=1,roles:i=[]},o,a,n)=>{const r=Object.entries(o.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,c])=>c.filter(l=>!l.used).map(l=>({...l,_line:s})));return r.length?(gi(r,e,`Choisir ${e} joueur(s) à booster (+${t})`,a,o,s=>{s.forEach(c=>{const l=(o.homeTeam[c._line]||[]).find(d=>d.cardId===c.cardId);l&&(l.boost=(l.boost||0)+t,o.log.push({text:`⚡ +${t} sur ${l.name}`,type:"info"}))}),Te(a,o,n)}),!0):(o.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Te(a,o,n),!0)},DEBUFF_STAT:({value:t=1,count:e=1,roles:i=[],target:o="ai"},a,n,r)=>{const s=o==="home"?a.homeTeam:a.aiTeam,c=o==="ai"?"adverse":"allié",l=Object.entries(s).filter(([d])=>!i.length||i.includes(d)).flatMap(([d,f])=>f.filter(x=>!x.used).map(x=>({...x,_line:d})));return l.length?(gi(l,e,`Choisir ${e} joueur(s) ${c}(s) à débuffer (-${t})`,n,a,d=>{d.forEach(f=>{const b=((o==="home"?a.homeTeam:a.aiTeam)[f._line]||[]).find(g=>g.cardId===f.cardId);b&&(b.boost=(b.boost||0)-t,a.log.push({text:`🎯 -${t} sur ${b.name}${o==="ai"?" (IA)":""}`,type:"info"}))}),Te(n,a,r)}),!0):(a.log.push({text:`🎯 Aucun joueur ${c} disponible`,type:"info"}),Te(n,a,r),!0)},GRAY_PLAYER:({count:t=1,roles:e=[],target:i="ai"},o,a,n)=>{const r=i==="home"?o.homeTeam:o.aiTeam,s=i==="ai"?"adverse":"allié",c=Object.entries(r).filter(([l])=>!e.length||e.includes(l)).flatMap(([l,d])=>d.filter(f=>!f.used).map(f=>({...f,_line:l})));return c.length?(gi(c,t,`Choisir ${t} joueur(s) ${s}(s) à exclure`,a,o,l=>{l.forEach(d=>{const x=((i==="home"?o.homeTeam:o.aiTeam)[d._line]||[]).find(b=>b.cardId===d.cardId);x&&(x.used=!0,o.log.push({text:`❌ ${x.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Te(a,o,n)}),!0):(o.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),Te(a,o,n),!0)},REVIVE_PLAYER:({count:t=1,roles:e=[]},i,o,a)=>{const n=Object.entries(i.homeTeam).filter(([r])=>!e.length||e.includes(r)).flatMap(([r,s])=>s.filter(c=>c.used).map(c=>({...c,_line:r})));return n.length?(gi(n,t,`Choisir ${t} joueur(s) à ressusciter`,o,i,r=>{r.forEach(s=>{const c=(i.homeTeam[s._line]||[]).find(l=>l.cardId===s.cardId);c&&(c.used=!1,i.log.push({text:`💫 ${c.name} ressuscité !`,type:"info"}))}),Te(o,i,a)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Te(o,i,a),!0)},REMOVE_GOAL:({},t)=>(t.aiScore>0?(t.aiScore--,t.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):t.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},t)=>(t.homeScore===t.aiScore?(t.homeScore++,t.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):t.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:t=1},e)=>(e.maxSubs=(e.maxSubs||3)+t,e.log.push({text:`🔄 +${t} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Nr(t,e,i,o,a){o.usedGc.push(t);const n=o.gcDefs||[],r=n.find(c=>c.name===e)||n.find(c=>{var l;return((l=c.name)==null?void 0:l.toLowerCase().trim())===(e==null?void 0:e.toLowerCase().trim())});let s=!1;if(r!=null&&r.effect_type&&r.effect_type!=="CUSTOM"){const c=Pr[r.effect_type];c?c(r.effect_params||{},o,i,a)||(s=!0):(a.toast(`Effet "${r.effect_type}" non implémenté`,"error"),s=!0)}else{switch(e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const c=Object.entries(o.homeTeam).flatMap(([l,d])=>(d||[]).filter(f=>f.used).map(f=>({...f,_line:l})));c.length?(c[0].used=!1,o.log.push({text:`💫 ${c[0].name} ressuscité !`,type:"info"})):o.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const c=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(l=>!l.used);if(c.length){const l=c.sort((d,f)=>Pe(f,"ATT")-Pe(d,"ATT"))[0];l.used=!0,o.log.push({text:`❄️ ${l.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",t).then(()=>{}),s&&Te(i,o,a)}function Gr(t,e,i){const o=Object.values(e.homeTeam).flat().filter(a=>!a.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${vr[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Pe(a,a._line||a.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[r]||[]).find(c=>c.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Te(t,e,i)})})}async function _t(t,e,i){var x,b,g,p;Rt(),Ke(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,a=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,r=a?"victoire":n?"nul":"defaite",s=e.isSolo&&((x=e.soloLevelConfig)!=null&&x.reward_credits)&&a?Number(e.soloLevelConfig.reward_credits):Un(e.mode,r);if(e.isSolo&&a)try{const{data:u}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),y=(u==null?void 0:u.unlocked_level)||1;e.soloLevel>=y&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(u){console.warn("[Solo] Erreur mise à jour progression:",u.message)}const c="00000000-0000-0000-0000-000000000000";let l=null;if(e.isRankedAI)try{const{data:u}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(u){const y=u.mmr??1e3,w=u.mmr_deviation??350,h=u.mmr_volatility??.06,E=a?1:n?.5:0,m=(u.placement_matches??0)<10,A=qo(y,w,h,y,350,E,m),$=n?null:a?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:A.delta,p_away_delta:0,p_home_new_rd:A.newRd,p_away_new_rd:350,p_home_new_vol:A.newSigma,p_away_new_vol:.06}),l=A.delta}}catch(u){console.warn("[RankedAI] Erreur mise à jour MMR:",u.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:a?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const d={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};a?d.wins=(o.profile.wins||0)+1:n?d.draws=(o.profile.draws||0)+1:d.losses=(o.profile.losses||0)+1,await v.from("users").update(d).eq("id",o.profile.id),await i.refreshProfile();const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",f.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
      ...
      ${e.isSolo&&a?`<div style="background:rgba(26,107,60,0.2);border:1px solid #1A6B3C;border-radius:14px;padding:12px;margin-bottom:12px;font-size:14px;font-weight:700">🔓 Niveau ${e.soloLevel+1} débloqué !</div>`:""}
      ...
      ${Ai(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Ae.id!==rt.id?`<div style="font-size:20px;font-weight:900;color:${Ae.color}">
                    ${Ge>te.mmr?"📈":"📉"} ${rt.emoji} ${rt.label} → ${Ae.emoji} ${Ae.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ge>te.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Se>=0?"📈":"📉"}</div>
            ...
            </div>`}}catch(te){console.error("[Ranked] MMR update error:",te)}(oe=document.getElementById("pvp-end-overlay"))==null||oe.remove();const q=document.createElement("div");q.id="pvp-end-overlay",q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const D=S?"🤝":B?"🏆":"😞",U=S?"MATCH NUL":B?"VICTOIRE !":"DÉFAITE",ee=S?"#fff":B?"#FFD700":"#ff6b6b";q.innerHTML=`
      ...
      ${N}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${d?"🏆 Retour à la Mini League":r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(ie=q.querySelector("#pvp-end-home"))==null||ie.addEventListener("click",()=>{q.remove(),Ve(t),d?b("mini-league",{openLeagueId:d}):b(r?"ranked":"home")})}const V=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{var M;const L=k.new;try{if(L.status==="finished"||L.forfeit){if(A)return;A=!0,$&&(clearInterval($),$=null),Ke(),L.game_state&&(m=L.game_state),O(L);return}if(L.game_state){const B=m;m=L.game_state;const S=m._lastGC;if(S&&S.seq&&!G.has(S.seq)&&(G.add(S.seq),S.by!==p)){C(S.type,S.by,()=>H());return}const N=B[p+"Score"]||0,q=B[u+"Score"]||0,D=m[p+"Score"]||0,U=m[u+"Score"]||0,ee=D>N,oe=U>q;if((ee||oe)&&!P.has(m.round)){P.add(m.round);const ie=[...m.log||[]].reverse().find(le=>le.isGoal),te=((ie==null?void 0:ie.homePlayers)||[]).map(le=>({name:le.name,note:le.note,portrait:le.portrait,job:le.job}));!!((M=ie==null?void 0:ie.text)!=null&&M.includes("DERNIER CORNER"))?ge().then(()=>{tt(te,D,U,ee,()=>H())}):tt(te,D,U,ee,()=>H());return}H()}}catch(B){console.error("[PvP] crash:",B)}}).subscribe();async function I(k){Object.assign(m,k),m.lastActionAt=new Date().toISOString();const{error:L}=await v.from("matches").update({game_state:m}).eq("id",i);L&&g("Erreur de synchronisation","error");try{H()}catch(M){console.error("[PvP] renderPvpScreen crash:",M)}}async function _(){if(A)return;A=!0,Rt(),Ke(),$&&(clearInterval($),$=null);const k=o?h.away_id:h.home_id,L=o?"p2":"p1",M=o?"p1":"p2",B={...m,[L+"Score"]:3,[M+"Score"]:0,phase:"finished"},S=B.p1Score||0,N=B.p2Score||0;try{await v.from("matches").update({game_state:B}).eq("id",i);const{data:q,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:S,p_away_score:N,p_forfeit:!0});if(D&&console.error("[PvP] finish_pvp_match (forfeit):",D),d)try{await v.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await v.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{v.removeChannel(V)}catch{}setTimeout(()=>{Ve(t),d?b("mini-league",{openLeagueId:d}):b("home")},800)}const R={BOOST_STAT:({value:k=1,count:L=1,roles:M=[]},B,S)=>{const N=B[p+"Team"],q=Object.entries(N).filter(([D])=>!M.length||M.includes(D)).flatMap(([D,U])=>U.filter(ee=>!ee.used).map(ee=>({...ee,_line:D})));if(!q.length){B.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),S(B);return}W(q,L,`Choisir ${L} joueur(s) à booster (+${k})`,D=>{D.forEach(U=>{const ee=(N[U._line]||[]).find(oe=>oe.cardId===U.cardId);ee&&(ee.boost=(ee.boost||0)+k,B.log.push({text:`⚡ +${k} sur ${ee.name}`,type:"info"}))}),B[p+"Team"]=N,S(B)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:M=[],target:B="ai"},S,N)=>{const q=B==="home"?p:u,D=S[q+"Team"],U=B==="home"?"allié":"adverse",ee=Object.entries(D).filter(([oe])=>!M.length||M.includes(oe)).flatMap(([oe,ie])=>ie.map(te=>({...te,_line:oe})));if(!ee.length){S.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),N(S);return}W(ee,L,`Choisir ${L} joueur(s) ${U}(s) (-${k})`,oe=>{oe.forEach(ie=>{const te=(D[ie._line]||[]).find(ae=>ae.cardId===ie.cardId);te&&(te.boost=(te.boost||0)-k,S.log.push({text:`🎯 -${k} sur ${te.name}`,type:"info"}))}),S[q+"Team"]=D,N(S)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:M="ai"},B,S)=>{const N=M==="home"?p:u,q=B[N+"Team"],D=M==="home"?"allié":"adverse",U=Object.entries(q).filter(([ee])=>!L.length||L.includes(ee)).flatMap(([ee,oe])=>oe.filter(ie=>!ie.used).map(ie=>({...ie,_line:ee})));if(!U.length){B.log.push({text:`❌ Aucun joueur ${D}`,type:"info"}),S(B);return}W(U,k,`Choisir ${k} joueur(s) ${D}(s) à exclure`,ee=>{const oe="usedCardIds_"+N,ie=new Set(B[oe]||[]);ee.forEach(te=>{const ae=(q[te._line]||[]).find(le=>le.cardId===te.cardId);ae&&(ae.used=!0,ie.add(te.cardId),B.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),B[oe]=[...ie],B[N+"Team"]=q,S(B)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},M,B)=>{const S=M[p+"Team"],N=Object.entries(S).filter(([q])=>!L.length||L.includes(q)).flatMap(([q,D])=>D.filter(U=>U.used).map(U=>({...U,_line:q})));if(!N.length){M.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),B(M);return}W(N,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(D=>{const U=(S[D._line]||[]).find(ee=>ee.cardId===D.cardId);U&&(U.used=!1,M.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),M[p+"Team"]=S,B(M)})},REMOVE_GOAL:({},k,L)=>{const M=u+"Score";k[M]>0?(k[M]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[u+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,M)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),M(L)},CUSTOM:({},k,L)=>L(k)};function W(k,L,M,B){const S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let N=[];function q(){var U,ee;const D=k.map(oe=>{const ie=oe._line||oe.job||"MIL",te=N.find(le=>le.cardId===oe.cardId),ae=ze({...oe,_evolution_bonus:0},{width:90,showStad:!0,role:ie,extraNote:oe.boost||0});return`<div class="pp-item" data-cid="${oe.cardId}"
        ...
        </div>`,(U=S.querySelector("#pp-close"))==null||U.addEventListener("click",()=>S.remove()),S.querySelectorAll(".pp-item").forEach(oe=>{oe.addEventListener("click",()=>{const ie=oe.dataset.cid,te=k.find(le=>le.cardId===ie),ae=N.findIndex(le=>le.cardId===ie);te&&(ae>-1?N.splice(ae,1):N.length<L&&N.push(te),q())})}),(ee=S.querySelector("#pp-confirm"))==null||ee.addEventListener("click",()=>{S.remove(),B(N)})}q(),document.body.appendChild(S)}async function de(k,L){const B=(m["gcCardsFull_"+p]||[]).find(D=>D.id===k),S=(B==null?void 0:B._gcDef)||(m.gcDefs||[]).find(D=>{var U;return D.name===L||((U=D.name)==null?void 0:U.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),N=[...m["usedGc_"+p]||[],k],q={type:L,by:p,seq:(m._gcAnimSeq||0)+1};G.add(q.seq),C(L,p,async()=>{if(S!=null&&S.effect_type&&S.effect_type!=="CUSTOM"){const U=R[S.effect_type];if(U){const ee={...m};U(S.effect_params||{},ee,async oe=>{oe["usedGc_"+p]=N,oe._lastGC=q,oe._gcAnimSeq=q.seq,await I(oe)});return}}const D={...m};switch(L){case"Remplacement+":D.maxSubs=(D.maxSubs||3)+1,D.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=u+"Score";D[U]>0&&(D[U]--,D.log.push({text:"🚫 But annulé",type:"info"}));break}}D["usedGc_"+p]=N,D._lastGC=q,D._gcAnimSeq=q.seq,await I(D)})}function ce(k,L){const M="usedCardIds_"+k,B=new Set(m[M]||[]);L.forEach(S=>B.add(S)),m[M]=[...B]}function j(){for(const k of["p1","p2"]){const L=new Set(m["usedCardIds_"+k]||[]),M=m[k+"Team"];if(M)for(const B of["GK","DEF","MIL","ATT"])(M[B]||[]).forEach(S=>{S.used=L.has(S.cardId)})}}function H(){var so,lo,co,po,uo,fo;if(m.phase==="reveal")return pe();if(m.phase==="midfield")return fe();if(m.phase==="finished")return Ne();const k=m[p+"Team"],L=m[u+"Team"];j();const M=m[p+"Score"],B=m[u+"Score"],S=m[p+"Name"],N=m[u+"Name"],q=m.phase===p+"-attack",D=m.phase===p+"-defense",U=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],ee=U.map(J=>J.cardId),oe=window.innerWidth>=700,ie=m[p+"Subs"]||[],te=m["usedSubIds_"+p]||[],ae=ie.filter(J=>!te.includes(J.cardId)),le=m["gcCardsFull_"+p]||[],we=m["usedGc_"+p]||[],ue=le.filter(J=>!we.includes(J.id)),_e=m.boostOwner===p&&!m.boostUsed,ke=[...k.MIL||[],...k.ATT||[]].filter(J=>!J.used),ne=[...L.MIL||[],...L.ATT||[]].filter(J=>!J.used),Se=!be(L),Ge=ke.length===0&&ne.length===0&&!Se,Ae=(k.DEF||[]).filter(J=>!J.used),Xe=(k.GK||[]).filter(J=>!J.used);let He=[];q&&ke.length===0&&(Se?(He=Ae.map(J=>J.cardId),Ae.length===0&&(He=He.concat(Xe.map(J=>J.cardId)))):Ge&&(He=[...Ae,...Xe].map(J=>J.cardId)));function rt(J,he,Me){var Ce,xt;const Ie=J._gcDef,Nt=(Ie==null?void 0:Ie.name)||J.gc_type,lt=(Ie==null?void 0:Ie.effect)||((Ce=Oe[J.gc_type])==null?void 0:Ce.desc)||"",Fe=Ie!=null&&Ie.image_url?`/icons/${Ie.image_url}`:null,Re=((xt=Oe[J.gc_type])==null?void 0:xt.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${J.id}" data-gc-type="${J.gc_type}" style="flex-shrink:0;cursor:pointer">
        ${nt(Nt,Fe,Re,lt,{width:he})}
      ...
      </div>`}const De=(J,he)=>he?Vt(95,162):rt(J,95),Je=(J,he)=>he?Vt(68,116):rt(J,68),Ue=oe?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",gt=q?We(p)?`<button id="pvp-action" style="${Ue};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${U.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Ue};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:D?`<button id="pvp-action" style="${Ue};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${U.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${N}</div>`,at=q&&!We(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':q||D?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${U.length}/3 sélectionné(s)</div>`:"",Ft=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${oe?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ut(k,m[p+"Formation"],bt,ee,oe?1300:Ct(),oe?600:Ot(),He)}
    ...
    </div>`,st=m[p+"Team"],yn=(()=>{var he,Me,Ie,Nt,lt;if(D&&((he=m.pendingAttack)!=null&&he.players)){const Fe=m.pendingAttack;let Re="";if(U.length>0){const Ce=U.map(Qe=>{const Yt=(st[Qe._role]||[]).find(ji=>ji.cardId===Qe.cardId)||Qe,Wt=st[Qe._role]||[],ci=Wt.findIndex(ji=>ji.cardId===Qe.cardId),Ci=dt(Wt.length),Xt=ci>=0?Ci[ci]:Yt._col??1;return{...Yt,_line:Qe._role,_col:Xt}}),xt=li(Ce,((Me=m.modifiers)==null?void 0:Me[p])||{},m[p+"Formation"]);Re=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          <div style="display:flex;justify-content:center">${et((Fe.players||[]).map(Ce=>({...Ce,used:!1})),"#ff6b6b",Fe.total,"attack",m[u+"Formation"])}</div>
          ${Re}
        </div>`}if(q&&((Ie=m.pendingAttack)!=null&&Ie.players)){const Fe=m.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${et((Fe.players||[]).map(Re=>({...Re,used:!1})),"#00ff88",Fe.total,"attack",m[p+"Formation"])}</div>
        </div>`}if(q&&!((Nt=m.pendingAttack)!=null&&Nt.players)&&U.length>0){const Fe=U.map(Ce=>{const xt=(st[Ce._role]||[]).find(Xt=>Xt.cardId===Ce.cardId)||Ce,Qe=["GK","DEF"].includes(Ce._role),Yt=st[Ce._role]||[],Wt=Yt.findIndex(Xt=>Xt.cardId===Ce.cardId),ci=dt(Yt.length),Ci=Wt>=0?ci[Wt]:xt._col??1;return{...xt,_line:Ce._role,_col:Ci,...Qe?{note_a:Math.max(1,Number(xt.note_a)||0)}:{}}}),Re=si(Fe,((lt=m.modifiers)==null?void 0:lt[p])||{},m[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${et(Fe.map(Ce=>({...Ce,used:!1})),"#FFD700",Re.total,"attack",m[p+"Formation"])}</div>
        </div>`}const J=(m.log||[]).slice(-1)[0];return J?'<div style="padding:2px 4px">'+sn(J)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),ao=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    </div>`;const N=(ae,le)=>t.querySelectorAll(ae).forEach((we,ue)=>{setTimeout(()=>{we.style.opacity="1",we.style.transform="translateY(0) scale(1)"},le+ue*90)});N(".duel-card-me",150),N(".duel-card-opp",500),setTimeout(()=>t.querySelectorAll(".duel-link").forEach((ae,le)=>setTimeout(()=>{ae.style.opacity="1"},le*70)),900),setTimeout(()=>{const ae=t.querySelector("#pvp-vs");ae&&(ae.style.opacity="1",ae.style.animation="vsFlash .5s ease"),t.querySelectorAll(".duel-score-line").forEach(le=>le.style.opacity="1")},1250);function q(ae,le,we){const ue=document.getElementById(ae);if(!ue)return;const _e=performance.now(),ke=ne=>{const Se=Math.min(1,(ne-_e)/we);ue.textContent=Math.round(le*(1-Math.pow(1-Se,3))),Se<1?requestAnimationFrame(ke):ue.textContent=le};requestAnimationFrame(ke)}setTimeout(()=>{q("pvp-score-me",M,800),q("pvp-score-opp",B,800)},1500);const D=m.p1Team.MIL||[],U=m.p2Team.MIL||[],ee=vt(D)+wt(D),oe=vt(U)+wt(U),ie=ee>=oe?"p1":"p2";let te=m.boostValue;te==null&&(te=rn(),m.boostValue=te,m.boostOwner=ie,m.boostUsed=!1),me=!0,setTimeout(()=>{const ae=t.querySelector("#duel-row-"+(S?"me":"opp")),le=t.querySelector("#duel-row-"+(S?"opp":"me")),we=document.getElementById("pvp-score-me"),ue=document.getElementById("pvp-score-opp"),_e=S?we:ue,ke=S?ue:we;_e&&(_e.style.fontSize="80px",_e.style.color=S?"#FFD700":"#ff6b6b",_e.style.animation="duelPulse .5s ease"+(S?",duelGlow 1.5s ease infinite .5s":"")),ke&&(ke.style.opacity="0.25"),setTimeout(()=>{ae&&(ae.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ae.style.zIndex="5"),setTimeout(()=>{const ne=document.getElementById("duel-shock");ne&&(ne.style.animation="shockwave .5s ease-out forwards"),le&&(le.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Ae;const ne=document.getElementById("pvp-duel-finale");if(!ne)return;const Se=m.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+te+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ge=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;ne.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(S?"⚽ "+m[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+m[u+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Se+Ge,ne.style.transition="opacity .45s ease",ne.style.opacity="1",ne.style.pointerEvents="auto",(Ae=document.getElementById("pvp-start-match"))==null||Ae.addEventListener("click",async()=>{const Xe=ie;await I({phase:Xe+"-attack",attacker:Xe,round:1,boostValue:te,boostUsed:!1,boostOwner:Xe})})},600)},700)},2800)}function C(k,L,M){var le,we;const B=(m.gcDefs||[]).find(ue=>{var _e;return ue.name===k||((_e=ue.name)==null?void 0:_e.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),S={purple:"#b06ce0",light_blue:"#00d4ef"}[B==null?void 0:B.color]||"#b06ce0",N=(B==null?void 0:B.name)||k,q=(B==null?void 0:B.effect)||((le=Oe[k])==null?void 0:le.desc)||"",D=B!=null&&B.image_url?`/icons/${B.image_url}`:null,U=((we=Oe[k])==null?void 0:we.icon)||"⚡",oe=L===p?"Vous":m[L+"Name"]||"Adversaire",ie=document.createElement("div");ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",ie.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:${S};letter-spacing:3px;text-transform:uppercase;font-weight:700;animation:gcLabel .4s ease both">${oe} joue une carte</div>
      <div style="animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        ${nt(N,D,U,q,{width:200})}
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(ie);let te=!1;const ae=()=>{te||(te=!0,ie.remove(),setTimeout(()=>M&&M(),50))};ie.addEventListener("click",ae),setTimeout(ae,3e3)}function K(k,L){var oe,ie,te,ae;const B=(m["gcCardsFull_"+p]||[]).find(le=>le.id===k),S=B==null?void 0:B._gcDef,N=(S==null?void 0:S.name)||L,q=(S==null?void 0:S.effect)||((oe=Oe[L])==null?void 0:oe.desc)||"Carte spéciale.",D=S!=null&&S.image_url?`/icons/${S.image_url}`:null,U=((ie=Oe[L])==null?void 0:ie.icon)||"⚡",ee=document.createElement("div");ee.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",ee.innerHTML=`
      ${nt(N,D,U,q,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(ee),(te=ee.querySelector("#pvp-gc-back"))==null||te.addEventListener("click",()=>ee.remove()),(ae=ee.querySelector("#pvp-gc-use"))==null||ae.addEventListener("click",()=>{ee.remove(),de(k,L)})}function Q(){var B;const k=m[p+"Team"],L=Object.entries(k).flatMap(([S,N])=>(N||[]).filter(q=>!q.used).map(q=>({...q,_line:S})));if(!L.length)return;const M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",M.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(S=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[S._line]||"#555",q=Pe(S,S._line)+(S.boost||0);return`<div class="bp-item" data-cid="${S.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${N};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(M),(B=M.querySelector("#bp-close"))==null||B.addEventListener("click",()=>M.remove()),M.querySelectorAll(".bp-item").forEach(S=>{S.addEventListener("click",async()=>{const N=S.dataset.cid,q=L.find(U=>U.cardId===N);if(!q)return;const D=(k[q._line]||[]).find(U=>U.cardId===N);D&&(D.boost=(D.boost||0)+m.boostValue),M.remove(),await I({[p+"Team"]:k,boostUsed:!0})})})}function X(k=null){var ae,le;if(!(m.phase===p+"-attack")){g("Remplacement uniquement avant votre attaque","warning");return}const M=m[p+"Team"],B=m["usedSubIds_"+p]||[],S=m.maxSubs||3;if(B.length>=S){g(`Maximum ${S} remplacements atteint`,"warning");return}const N=Object.entries(M).flatMap(([we,ue])=>(ue||[]).filter(_e=>_e.used).map(_e=>({..._e,_line:we}))),q=(m[p+"Subs"]||[]).filter(we=>!B.includes(we.cardId));if(!N.length){g("Aucun joueur utilisé à remplacer","warning");return}if(!q.length){g("Aucun remplaçant disponible","warning");return}let D=Math.max(0,N.findIndex(we=>we.cardId===k));const U=((ae=N[D])==null?void 0:ae._line)||((le=N[D])==null?void 0:le.job);let ee=Math.max(0,q.findIndex(we=>we.job===U)),oe=!1;const ie=document.createElement("div");ie.id="pvp-sub-overlay",ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function te(){var Ge,Ae,Xe,He,rt,Vt;const we=N[D],ue=q[ee],_e=Math.min(130,Math.round((window.innerWidth-90)/2)),ke=Math.round(_e*1.35),ne=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;ie.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(Ge=ie.querySelector("#psub-close"))==null||Ge.addEventListener("click",()=>ie.remove()),(Ae=ie.querySelector("#pout-up"))==null||Ae.addEventListener("click",()=>{D>0&&(D--,te())}),(Xe=ie.querySelector("#pout-down"))==null||Xe.addEventListener("click",()=>{D<N.length-1&&(D++,te())}),(He=ie.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{ee>0&&(ee--,te())}),(rt=ie.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{ee<q.length-1&&(ee++,te())});const Se=(De,Je,Ue,gt)=>{const at=ie.querySelector("#"+De);if(!at)return;let Ft=0;at.addEventListener("touchstart",bt=>{Ft=bt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",bt=>{const Lt=bt.changedTouches[0].clientY-Ft;if(Math.abs(Lt)<30)return;const st=Je();Lt<0&&st<gt-1?(Ue(st+1),te()):Lt>0&&st>0&&(Ue(st-1),te())},{passive:!0})};Se("pin-panel",()=>ee,De=>ee=De,q.length),Se("pout-panel",()=>D,De=>D=De,N.length),(Vt=ie.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),oe)return;oe=!0;const Je=N[D],Ue=q[ee];if(!Je||!Ue)return;const gt=Je._line,at=(M[gt]||[]).findIndex(Lt=>Lt.cardId===Je.cardId);if(at===-1){g("Erreur : joueur introuvable","error"),ie.remove();return}const Ft={...Ue,_line:gt,position:Je.position,used:!1,boost:0};M[gt].splice(at,1,Ft);const bt=[...B,Ue.cardId];ie.remove(),re(Je,Ue,async()=>{await I({[p+"Team"]:M,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:bt})})})}document.body.appendChild(ie),te()}function re(k,L,M){const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(U,ee,oe)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(S);let q=!1;const D=()=>{q||(q=!0,S.remove(),setTimeout(()=>M(),50))};S.addEventListener("click",D),setTimeout(D,2200)}function F(){var L;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${m[u+"Name"]}</div>
      <div style="width:min(90vw,420px)">${Ai(m[u+"Team"],m[u+"Formation"],null,[],Ct(),Ot())}</div>
      ...
      </div>`,document.body.appendChild(L),(M=L.querySelector("#pvp-hist-close"))==null||M.addEventListener("click",()=>L.remove())}async function Y(){if(m.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(m.round||0)+1,M=[...m.log||[]];M.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const B=Le(m),S=We(k),N=B||!S?"finished":k+"-attack";await I({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:N,attacker:k,round:L,log:M}),N==="finished"&&await qe(m)}function Z(k){const L=(k.GK||[]).some(B=>!B.used),M=["DEF","MIL","ATT"].some(B=>(k[B]||[]).some(S=>!S.used));return L&&!M}function se(k){return(k.p1Score||0)!==(k.p2Score||0)?null:Z(k.p1Team)&&!be(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(L=>!L.used)}:Z(k.p2Team)&&!be(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(L=>!L.used)}:null}async function ge(){const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(k);const L=(M,B)=>new Promise(S=>{k.innerHTML=`<div style="font-size:32px;font-weight:900;color:${B};letter-spacing:2px;animation:lcFade 1.4s ease both">${M}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(S,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),k.remove()}async function ye(k,L){const{side:M,gk:B}=k;if(!B)return;const S=M+"Score",N=(L[S]||0)+1;B.used=!0;const q=[...L.log||[]];q.push({type:"duel",isGoal:!0,homeScored:M===p,homePlayers:M==="p1"?[Gt(B)]:[],aiPlayers:M==="p2"?[Gt(B)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[M+"Name"]} marque !`});const D=(L.round||0)+1,U=M==="p1"?"p2":"p1",ee={...L,[S]:N},oe=Le(ee);P.add(D),await ge();const ie=M===p?N:L[p+"Score"]||0,te=M===p?L[u+"Score"]||0:N;tt([Gt(B)],ie,te,M===p,async()=>{await I({[S]:N,log:q,round:D,pendingAttack:null,phase:oe?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),oe&&await qe({...m,[S]:N})})}async function $e(){const k=m[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(N=>(m[u+"Team"][N]||[]).some(q=>!q.used)),M=(m["selected_"+p]||[]).map(N=>{const q=(k[N._role]||[]).find(le=>le.cardId===N.cardId)||N,D=["GK","DEF"].includes(N._role),U=k[N._role]||[],ee=U.findIndex(le=>le.cardId===N.cardId),oe=dt(U.length),ie=ee>=0?oe[ee]:q._col??1,te=m.stadiumDef||m.homeStadiumDef||null,ae=q.stadiumBonus||te&&(te.club_id&&String(q.club_id)===String(te.club_id)||te.country_code&&q.country_code===te.country_code)||!1;return{...q,_line:N._role,_col:ie,stadiumBonus:ae,...D?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!M.length)return;const B=si(M,m.modifiers[p]||{},m[p+"Formation"]);ce(p,M.map(N=>N.cardId)),M.forEach(N=>{const q=(k[N._role]||[]).find(D=>D.cardId===N.cardId);q&&(q.used=!0)}),m["selected_"+p]=[],H();const S=[...m.log||[]];if(L){if(M.length===1&&(M[0]._line==="GK"||M[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await ye({side:p,gk:M[0]},{...m,[p+"Team"]:k,log:S});return}const q=(m[p+"Score"]||0)+1,D=M.map(te=>Gt(te));S.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:D,homeTotal:B.total,aiTotal:0});const U=(m.round||0)+1,ee=p==="p1"?"p2":"p1",oe={...m,[p+"Team"]:k,[p+"Score"]:q},ie=Le(oe);P.add(U),tt(D,q,m[u+"Score"]||0,!0,async()=>{await I({[p+"Team"]:k,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ie?"finished":ee+"-attack",attacker:ee,round:U,log:S}),ie&&await qe({...m,[p+"Score"]:q})});return}S.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${B.total})`}),await I({[p+"Team"]:k,[u+"Team"]:m[u+"Team"],pendingAttack:{...B,players:M,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:S})}async function Ee(){const k=m[p+"Team"],L=(m["selected_"+p]||[]).map(ue=>{const _e=(k[ue._role]||[]).find(Ae=>Ae.cardId===ue.cardId)||ue,ke=k[ue._role]||[],ne=ke.findIndex(Ae=>Ae.cardId===ue.cardId),Se=dt(ke.length),Ge=ne>=0?Se[ne]:_e._col??1;return{..._e,_line:ue._role,_col:Ge}}),M=li(L,m.modifiers[p]||{},m[p+"Formation"]);ce(p,L.map(ue=>ue.cardId)),L.forEach(ue=>{const _e=(k[ue._role]||[]).find(ke=>ke.cardId===ue.cardId);_e&&(_e.used=!0)}),m["selected_"+p]=[],H();const B=to(m.pendingAttack.total,M.total,m.modifiers[p]||{}),S=m.pendingAttack.side,N=B==="attack"||(B==null?void 0:B.goal),q=S==="p1"?"p2":"p1",D=(m.round||0)+1,U=(m.pendingAttack.players||[]).map(ue=>Gt(ue)),ee=[...m.log||[]];ee.push({type:"duel",isGoal:N,homeScored:N&&S===p,text:N?`⚽ BUT de ${m[S+"Name"]} ! (${m.pendingAttack.total} vs ${M.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${M.total})`,homePlayers:U,aiPlayers:L.map(ue=>Gt(ue)),homeTotal:m.pendingAttack.total,aiTotal:M.total});const oe=N?(m[S+"Score"]||0)+1:m[S+"Score"]||0,ie={...m,[p+"Team"]:k,[S+"Score"]:oe},te=Le(ie),ae=te?"finished":q+"-attack",le=!te&&!N?se(ie):null,we=async()=>{if(le){await ye(le,ie);return}await I({[p+"Team"]:k,[u+"Team"]:m[u+"Team"],[S+"Score"]:oe,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:q,round:D,log:ee}),(ae==="finished"||te)&&await qe({...m,[S+"Score"]:oe})};if(N){const ue=S===p,_e=ue?oe:m[p+"Score"]||0,ke=ue?m[u+"Score"]||0:oe;P.add(D),tt(U,_e,ke,ue,we)}else await we()}function xe(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(M=>!M.used))}function be(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(M=>!M.used))}function je(k){return be(k)&&!xe(k)}function We(k){const L=m[k+"Team"],M=m[(k==="p1"?"p2":"p1")+"Team"];return!!(xe(L)||je(L)&&!be(M)||je(L)&&!xe(M)&&be(M))}function Le(k){return!be(k.p1Team)&&!be(k.p2Team)}function Be(k){const L=k.p1Score||0,M=k.p2Score||0;return L===M?null:L>M?h.home_id:h.away_id}async function qe(k){Rt(),Ke();try{const L=Be(k),M=L?h.home_id===L?h.away_id:h.home_id:null,B=k.p1Score||0,S=k.p2Score||0,{data:N,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:B,p_away_score:S,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),d)try{await v.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(D){console.error("[PvP] check_and_finish_mini_league:",D)}L&&M&&Ur(L,M).catch(()=>{});try{const{data:D}=await v.rpc("apply_match_rewards",{p_match_id:i});D!=null&&D.success&&!(D!=null&&D.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(D){console.error("[PvP] apply_match_rewards:",D)}if(typeof l=="function")try{await l({homeScore:B,awayScore:S,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(D){console.error("[PvP] onMatchEnd:",D)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Ne(){var S;const k=m[p+"Score"],L=m[u+"Score"],M=k>L,B=k===L;ct(t),t.innerHTML=`
    ...
    </div>`,(S=document.getElementById("pvp-home"))==null||S.addEventListener("click",()=>{try{v.removeChannel(V)}catch{}Ve(t),d?b("mini-league",{openLeagueId:d}):b("home")})}H()}async function Vi(t,e,i=!1){var s,c;const{state:o,navigate:a,toast:n}=e,r=i&&((c=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:c.rankedData)||null;await zi(t,e,i?"ranked":"random",async({deckId:l,formation:d,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{await Yr(t,e,l,d,f,x,y||[],g,p,i,r)};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}async function Vr(t,e,i){return Kr(t,e,i)}async function Yr(t,e,i,o,a,n,r=[],s=[],c=null,l=!1,d=null){var O,V;const{state:f,navigate:x,toast:b}=e,g=(d==null?void 0:d.mmr)??((O=f.profile)==null?void 0:O.mmr)??1e3,p=l?Ei(g):null,u=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(V=document.getElementById("cancel-mm"))==null||V.addEventListener("click",async()=>{await m(),Ve(t),x("home")});const A=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await qt(t,e,I,_,{myGC:r,gcDefs:s,stadiumDef:c,isRanked:l,rankedData:d,onMatchEnd:l?Wr:null}))},$=f.user.id,{data:T,error:P}=l?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(T!=null&&T.success)){console.error("[Matchmaking] try_matchmake error:",P||T),b("Erreur de matchmaking","error"),Ve(t),x("home");return}if(T.matched){await A(T.match_id,!1);return}const G=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await A(I.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&A(_.match_id,!0)}).subscribe(),E=setInterval(G,3e3),l?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),x("match",{matchMode:"ranked_ai",rankedData:d,presetSetup:{deckId:i,formation:o,starters:a,subsRaw:n,gcCardsEnriched:r,gcDefs:s,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function Wr(t,e){const{state:i,toast:o}=e,{winnerId:a,homeId:n,awayId:r,homeScore:s,awayScore:c,matchId:l}=t,d=i.user.id,f=n===d,x=a===d,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",d).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?r:n).single();if(b&&g){const p=qo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,x?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",d),o(x?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,x?"success":"error",4e3)}}const Xr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Vi,resumePvpMatch:Vr},Symbol.toStringTag,{value:"Module"}));async function Jr(t,e){const{state:i,navigate:o,toast:a}=e,n=i.params||{},r=n.friendId||null,s=n.friendName||"Ami",c=!!n.isAccepting;await zi(t,e,"friend",async({deckId:l,formation:d,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const w=y||[];c?await Zr(t,e,l,w,g,p):await Qr(t,e,l,w,g,p,r,s)};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}async function Qr(t,e,i,o,a,n,r,s){var w;const{state:c,navigate:l,toast:d}=e,f=c.user.id,{data:x,error:b}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:r,friend_id:r,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!x){console.error("[Friend] Erreur création invitation:",b),d("Impossible de créer l'invitation","error"),l("home");return}t.innerHTML=`
    ...
    </div>`;let g=!1,p=null;const u=async()=>{p&&(p.unsubscribe(),p=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await u(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",x.id),Ve(t),l("home")}),p=v.channel(`friend_invite_${x.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${x.id}`},async({new:h})=>{g||h.status!=="accepted"||!h.match_id||(g=!0,await u(),await qt(t,e,h.match_id,!0,{myGC:o,gcDefs:a,stadiumDef:n}))}).subscribe();const y=setInterval(async()=>{if(g)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",x.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(g=!0,clearInterval(y),await u(),await qt(t,e,h.match_id,!0,{myGC:o,gcDefs:a,stadiumDef:n}))},3e3);setTimeout(async()=>{g||(clearInterval(y),await u(),d("Invitation expirée","info"),l("home"))},12e4)}async function Zr(t,e,i,o,a,n){const{state:r,navigate:s,toast:c}=e,l=r.user.id,{data:d}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",l).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!d){c("Aucune invitation en attente","error"),s("home");return}const{data:f,error:x}=await v.rpc("accept_friend_invite",{p_invite_id:d.id,p_invitee_deck_id:i});if(x||!(f!=null&&f.success)){console.error("[Friend] Erreur accept_friend_invite:",x||f),c((f==null?void 0:f.error)||"Impossible de rejoindre le match","error"),s("home");return}await qt(t,e,f.match_id,!1,{myGC:o,gcDefs:a,stadiumDef:n})}const un="#1A6B3C",pt="#D4A017",Zt="var(--tile-bg)",ei="var(--tile-border)",At="var(--divider)",Ze="var(--tile-fg-on-page)",St="var(--tile-fg-dim)",it="var(--tile-fg-faint)",ii="var(--nav-fg,#fff)",fn="rgba(255,255,255,0.62)",ea="rgba(255,255,255,0.4)";async function ta(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ft(t,e,i);return}await ot(t,e)}async function ot(t,e,i="waiting"){var h,E;const{state:o}=e,a=o.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",a),r=(n||[]).map(m=>m.league_id),s={};(n||[]).forEach(m=>{s[m.league_id]={amount:m.prize_amount,claimed:m.prize_claimed}});const{data:c,error:l}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),d=l?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:c||[],x=(r.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",r).order("created_at",{ascending:!1}):{data:[]}).data||[],b=x.filter(m=>m.status==="waiting"&&!m.is_archived),g=x.filter(m=>m.status==="active"&&!m.is_archived),p=x.filter(m=>m.is_archived||m.status==="finished");let u=p;if(p.length){const{data:m}=await v.from("mini_league_matches").select("league_id").in("league_id",p.map($=>$.id)).or(`home_id.eq.${a},away_id.eq.${a}`).not("status","eq","bye"),A=new Set((m||[]).map($=>$.league_id));u=p.filter($=>A.has($.id))}const y=d.filter(m=>!r.includes(m.id)),w=[{key:"waiting",label:"🟡 En attente",count:b.length+y.length},{key:"active",label:"🟢 En cours",count:g.length},{key:"archived",label:"📁 Archivées",count:u.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${At};display:flex;align-items:center;justify-content:space-between">
      <div>
        ...
        <div style="font-size:12px;color:${fn}">Championnats 3 à 8 joueurs</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
  ...
  </div>`}function ia(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(a=>$i(a,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(a=>$i(a,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${it}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function oa(t,e){return t.length?t.map(i=>$i(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league en cours.</div>`}function na(t,e,i={}){return t.length?t.map(o=>$i(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league archivée.</div>`}function ra(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var g,p,u,y;const{toast:o}=e,a=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,r=parseInt(document.getElementById("ml-fee").value)||500,s=((g=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:g.value)||"public",c=((p=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:p.value)||"aller",l=((y=(u=document.getElementById("ml-pwd"))==null?void 0:u.value)==null?void 0:y.trim())||null;if(!a){o("Le nom est obligatoire","error");return}if(r<100){o("Mise minimum : 100 crédits","error");return}if(s==="private"&&!l){o("Mot de passe requis","error");return}const{data:d,error:f}=await v.from("mini_leagues").insert({name:a,creator_id:e.state.profile.id,type:s,password:l,mode:c,max_players:n,entry_fee:r}).select().single();if(f){o("Erreur : "+f.message,"error");return}const{data:x}=await v.from("users").select("credits").eq("id",e.state.profile.id).single();if(((x==null?void 0:x.credits)||0)<r){await v.from("mini_leagues").delete().eq("id",d.id),o(`Crédits insuffisants pour la mise (${r.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:x.credits-r}).eq("id",e.state.profile.id),await v.from("mini_leagues").update({pot:r}).eq("id",d.id),await v.from("mini_league_members").insert({league_id:d.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=x.credits-r);const b=document.getElementById("nav-credits");b&&(b.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${r.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,d.id)})}function aa(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=a=>{e.remove(),t(a)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",a=>{a.key==="Enter"&&o(i.value.trim())})})}async function mn(t,e,i,o){var f;const{toast:a,state:n}=e,r=n.profile.id;let s=null;if(o==="private"&&(s=await aa(),s===null))return;const{data:c,error:l}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:r,p_password:s});if(l||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",l||c),a((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",r).single();n.profile&&x&&(n.profile.credits=x.credits)}const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${(((f=n.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),a("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function sa(t,e,i,o){const{toast:a,state:n}=e,r=n.profile.id;if(!await new Promise(x=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(b),b.querySelector("#lv-ok").onclick=()=>{b.remove(),x(!0)},b.querySelector("#lv-cancel").onclick=()=>{b.remove(),x(!1)}}))return;const{data:c,error:l}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:r});if(l||!(c!=null&&c.success)){a((c==null?void 0:c.error)||"Erreur lors de la désinscription","error");return}const d=c.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+d);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),a(`↩️ Désinscrit · +${d.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Yi(t,e,i,o,a){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:r}=await v.from("mini_leagues").delete().eq("id",i);if(r){n("Erreur suppression ("+r.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,a)}async function la(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,m,A,$,T,P,G,O,V;const{state:o,toast:a}=e,n=o.profile.id,[{data:r},{data:s},{data:c}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!r){a("Introuvable","error"),await ot(t,e);return}const l=(s||[]).some(I=>I.user_id===n),d=r.creator_id===n,f=(s||[]).map(I=>I.user).filter(Boolean),x=fa(f,c||[]),b=(c||[]).filter(I=>I.matchday===r.current_day),g=r.pot||0,p=r.entry_fee||100,u=b.length>0&&b.every(I=>I.status==="finished"||I.status==="bye"),y=r.current_day>=r.total_days,w=(s||[]).find(I=>I.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${At};display:flex;align-items:center;gap:10px">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:11px;color:${fn}">${r.mode==="aller-retour"?"Aller-Retour":"Aller"} · max ${r.max_players} · 💰 ${p} cr./joueur</div>
      </div>
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${Ze}">👥 Joueurs (${f.length}/${r.max_players})</div>
        ...
        ${f.map(I=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${At}">
            <div style="width:36px;height:36px;border-radius:50%;background:${I.club_color2||un};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${I.club_color1||"#fff"}">${(I.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      ${r.status==="active"?`
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:10px;color:${Ze}">📅 Journée ${r.current_day} / ${r.total_days}</div>
        ${b.map(I=>So(I,f,n,l)).join("")}
        ${d&&u&&!y?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
      </div>`:""}

      ${(r.status==="active"||r.status==="finished")&&x.length?`
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="font-size:10px;color:${it};text-transform:uppercase;border-bottom:2px solid ${At}">
            ...
            ${g>0&&r.status==="finished"?`<th style="text-align:right;padding:5px 0;color:${pt}">💰</th>`:""}
          </tr></thead>
          <tbody>${x.map((I,_)=>{const R=g>0&&r.status==="finished"?_===0?Math.floor(g*.7):_===1?Math.floor(g*.2):_===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${At};${I.userId===n?"background:rgba(74,222,128,0.08);":""}">
              ...
              ${g>0&&r.status==="finished"?`<td style="text-align:right;font-weight:700;color:${pt}">${R?R.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(I,_)=>_+1).reverse().map(I=>{const _=(c||[]).filter(R=>R.matchday===I);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${I}</div>${_.map(R=>So(R,f,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=r.status==="waiting"?"waiting":r.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>ot(t,e,h)),(m=document.getElementById("ml-refresh"))==null||m.addEventListener("click",async I=>{const _=I.currentTarget;_.style.opacity="0.5",await ft(t,e,i)}),(A=document.getElementById("ml-start-btn"))==null||A.addEventListener("click",()=>da(t,e,r,f)),($=document.getElementById("ml-next-day"))==null||$.addEventListener("click",()=>ca(t,e,i)),(T=document.getElementById("ml-join-now"))==null||T.addEventListener("click",()=>mn(t,e,i,r.type)),(P=document.getElementById("ml-leave-btn"))==null||P.addEventListener("click",()=>sa(t,e,i,p)),(G=document.getElementById("ml-delete-btn"))==null||G.addEventListener("click",()=>Yi(t,e,i,r.name,"waiting")),(O=document.getElementById("ml-delete-now"))==null||O.addEventListener("click",()=>Yi(t,e,i,r.name,h)),(V=document.getElementById("ml-archive-btn"))==null||V.addEventListener("click",()=>la(t,e,i)),t.querySelectorAll("[data-play-match]").forEach(I=>{I.addEventListener("click",()=>{const _=b.find(R=>R.id===I.dataset.playMatch);_&&(mt(),e.navigate("match-mini-league",{mlMatchId:_.id,leagueId:i}))})}),r.status==="finished"&&w){const I=x.findIndex(_=>_.userId===n);I>=0&&I<3&&w.prize_amount>0&&!w.prize_claimed&&setTimeout(()=>pa(t,e,r,w,I),400)}}function So(t,e,i,o,a=!1){const n=f=>e.find(x=>x.id===f);if(t.is_bye){const f=n(t.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${St};text-align:center">🔵 ${(f==null?void 0:f.club_name)||(f==null?void 0:f.pseudo)||"?"} exempté(e)</div>`}const r=n(t.home_id),s=n(t.away_id),c=t.home_id===i||t.away_id===i,l=c&&t.status==="pending"&&o&&!a,d=t.status==="finished"?`${t.home_score} - ${t.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${c?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${c?"rgba(74,222,128,0.35)":At}">
    <div style="flex:1;text-align:right;font-size:12px;font-weight:700;color:${Ze};overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${(r==null?void 0:r.club_name)||(r==null?void 0:r.pseudo)||"?"}</div>
  ...
  </div>`}async function da(t,e,i,o){const{toast:a,state:n}=e,r=ua(o.map(l=>l.id),i.mode),s=[];r.forEach((l,d)=>l.forEach(f=>s.push({league_id:i.id,matchday:d+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:c}=await v.from("mini_league_matches").insert(s);if(c){a("Erreur calendrier : "+c.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:r.length}).eq("id",i.id),a(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ft(t,e,i.id)}async function ca(t,e,i){const{data:o}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),a=(o.current_day||0)+1;if(a>(o.total_days||0)){ft(t,e,i);return}await v.from("mini_leagues").update({current_day:a}).eq("id",i),e.toast(`Journée ${a} commencée !`,"success"),ft(t,e,i)}async function pa(t,e,i,o,a){var x,b;const{state:n,toast:r}=e,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],c=["🥇","🥈","🥉"][a],l=o.prize_amount||s[a]||0,d=o.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      ${d?'<div style="font-size:13px;color:#86efac;margin-bottom:16px">✅ Crédits déjà récupérés</div>':`<button id="claim-prize-btn" style="width:100%;padding:14px;border-radius:12px;border:none;background:${pt};color:#111;font-size:16px;font-weight:900;cursor:pointer;margin-bottom:12px">💰 Récupérer ${l.toLocaleString("fr")} cr.</button>`}
      <button id="prize-close" style="background:rgba(255,255,255,0.1);border:none;color:rgba(255,255,255,0.7);padding:10px 24px;border-radius:10px;font-size:14px;cursor:pointer">Fermer</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#prize-close"))==null||x.addEventListener("click",()=>f.remove()),(b=f.querySelector("#claim-prize-btn"))==null||b.addEventListener("click",async g=>{const p=g.currentTarget;p.disabled=!0,p.textContent="...";const{data:u,error:y}=await v.rpc("claim_mini_league_prize",{p_league_id:i.id,p_user_id:n.profile.id});if(y||!(u!=null&&u.success)){console.error("[MiniLeague] claim_mini_league_prize:",y||u),r((u==null?void 0:u.error)||"Erreur lors de la récupération","error"),p.disabled=!1,p.textContent=`💰 Récupérer ${l.toLocaleString("fr")} cr.`;return}if(u.already_claimed)r("Déjà récupéré précédemment","info");else{const w=(n.profile.credits||0)+u.prize;n.profile&&(n.profile.credits=w);const h=document.getElementById("nav-credits");h&&(h.textContent=`💰 ${w.toLocaleString("fr")}`),r(`💰 +${u.prize.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success")}f.remove(),ft(t,e,i.id)})}function ua(t,e){const o=t.length%2===0?[...t]:[...t,null],a=o.length;let n=o.slice(1);const r=[];for(let s=0;s<a-1;s++){const c=[],l=[o[0],...n];for(let d=0;d<a/2;d++){const f=l[d],x=l[a-1-d];f===null?c.push({bye:x}):x===null?c.push({bye:f}):c.push({home:f,away:x})}r.push(c),n=[n[n.length-1],...n.slice(0,-1)]}return e==="aller-retour"?[...r,...r.map(s=>s.map(c=>c.bye?c:{home:c.away,away:c.home}))]:r}function fa(t,e){const i={};return t.forEach(o=>{i[o.id]={userId:o.id,pseudo:o.pseudo,clubName:o.club_name||o.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),e.filter(o=>o.status==="finished"&&!o.is_bye&&o.home_score!=null).forEach(o=>{const a=i[o.home_id],n=i[o.away_id];!a||!n||(a.played++,n.played++,a.goalsFor+=o.home_score,a.goalsAgainst+=o.away_score,n.goalsFor+=o.away_score,n.goalsAgainst+=o.home_score,o.home_score>o.away_score?(a.won++,a.points+=3,n.lost++):o.home_score<o.away_score?(n.won++,n.points+=3,a.lost++):(a.drawn++,a.points++,n.drawn++,n.points++),a.goalDiff=a.goalsFor-a.goalsAgainst,n.goalDiff=n.goalsFor-n.goalsAgainst)}),Object.values(i).sort((o,a)=>a.points-o.points||a.goalDiff-o.goalDiff||a.goalsFor-o.goalsFor)}async function Ao(t,e){const{state:i,navigate:o,toast:a}=e,n=i.params||{},r=n.leagueId||null,s=n.mlMatchId||null,c=i.user.id;if(!s||!r){a("Match introuvable","error"),o("mini-league");return}const{data:l,error:d}=await v.from("mini_league_matches").select("id, league_id, home_id, away_id, status, match_id").eq("id",s).single();if(d||!l){a("Match introuvable","error"),o("mini-league",{openLeagueId:r});return}if(l.home_id!==c&&l.away_id!==c){a("Vous ne faites pas partie de ce match","error"),o("mini-league",{openLeagueId:r});return}const f=l.home_id===c;if(l.match_id){await qt(t,e,l.match_id,f,{mlLeagueId:r,mlMatchId:s});return}await zi(t,e,"mini_league",async({deckId:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const{data:w,error:h}=await v.rpc("start_mini_league_match",{p_ml_match_id:s,p_user_id:c,p_deck_id:x});if(h||!(w!=null&&w.success)){console.error("[MiniLeague] start_mini_league_match error:",h||w),a((w==null?void 0:w.error)||"Impossible de lancer le match","error"),o("mini-league",{openLeagueId:r});return}if(w.matched){await qt(t,e,w.match_id,f,{mlLeagueId:r,mlMatchId:s,myGC:y||[],gcDefs:g,stadiumDef:p});return}await ma(t,e,{mlMatchId:s,leagueId:r,amIHome:f,chosenGC:y,gcDefs:g,stadiumDef:p})};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}function ma(t,e,{mlMatchId:i,leagueId:o,amIHome:a,chosenGC:n,gcDefs:r,stadiumDef:s}){return new Promise(c=>{var p;const{navigate:l}=e;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#0a1a2e,#0d3d1e);color:#fff;padding:32px;text-align:center;gap:20px">
      <div style="font-size:36px">🏆</div>
    ...
    </div>`;let d=!1;const f=async u=>{if(!d){if(d=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}u&&await qt(t,e,u,a,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:r,stadiumDef:s}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}l("mini-league",{openLeagueId:o}),c()});const x=async()=>{if(d)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&f(u.new.match_id)}).subscribe(),g=setInterval(x,3e3);x()})}const ga="/",ba=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function xa(t,e,i){let o=0;const a=document.createElement("div");a.id="tutorial-overlay",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var d,f,x;const s=e[o],c=o===e.length-1,l=Math.round((o+1)/e.length*100);a.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${s.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${ga}icons/${s.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `,a.querySelectorAll("ul,ol").forEach(b=>{b.style.paddingLeft="20px",b.style.marginTop="6px",b.style.marginBottom="6px"}),a.querySelectorAll("li").forEach(b=>{b.style.marginBottom="4px"}),a.querySelectorAll("p").forEach(b=>{b.style.marginBottom="8px"}),(d=a.querySelector("#tuto-prev"))==null||d.addEventListener("click",()=>{o--,n()}),(f=a.querySelector("#tuto-next"))==null||f.addEventListener("click",()=>{c?r():(o++,n())}),(x=a.querySelector("#tuto-skip"))==null||x.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&r()})},r=async()=>{a.remove(),t!=null&&t.id&&await v.from("users").update({tutorial_done:!0}).eq("id",t.id),i==null||i()};document.body.appendChild(a),n()}async function zo(t,e,i){if(!t||t.tutorial_done)return;let o=[];const{data:a,error:n}=await v.rpc("get_tutorial_steps");if(!n&&(a==null?void 0:a.length)>0)o=a,console.log(`[Tutorial] RPC OK → ${o.length} étapes`);else{const{data:s,error:c}=await v.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!c&&(s==null?void 0:s.length)>0?(o=s,console.log(`[Tutorial] Direct OK → ${o.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${n==null?void 0:n.message}, Direct: ${c==null?void 0:c.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const r=o.length>0?o.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):ba;xa(t,r,()=>e("boosters"))}const Mo={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function bi(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function ya(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await ro(t,e)}async function ro(t,e){const{state:i,toast:o}=e,{data:a}=await v.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let c="buy";const l=()=>{var p,u,y,w,h,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((y=document.getElementById("flt-country"))==null?void 0:y.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function d(p){const u=l();return p.filter(y=>{var P,G,O;const w=(P=y.card)==null?void 0:P.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((G=w.clubs)==null?void 0:G.encoded_name)||"").toLowerCase(),m=(w.country_code||"").toLowerCase(),A=((O=y.card)==null?void 0:O.evolution_bonus)||0,$=bi(w,w.job,A),T=w.job2?bi(w,w.job2,A):0;return!(u.name&&!h.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!m.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&$<u.note1||u.note2&&T<u.note2)})}function f(p){var E,m,A;const u=(E=p.card)==null?void 0:E.player;if(!u)return"";const y=((m=p.card)==null?void 0:m.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function x(p){var G,O,V,I;const u=(G=p.card)==null?void 0:G.player;if(!u)return"";const y=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=bi(u,u.job,y),h=u.job2?bi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,A=Mo[u.job]||"#bbb",$=u.job2?Mo[u.job2]||"#bbb":null,T=u.job==="GK"?"#fff":A,P=u.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${m?`<img src="${m}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(V=u.clubs)!=null&&V.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
    ...
    </div>`}function b(){const p=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(p){if(u.style.display=c==="buy"?"flex":"none",c==="buy"){const y=d(r);p.innerHTML=y.length?`<div class="mkt-buy-grid">${y.map(f).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const y=s.filter(h=>h.status==="active").sort((h,E)=>new Date(E.listed_at)-new Date(h.listed_at)),w=s.filter(h=>h.status==="sold").sort((h,E)=>new Date(E.sold_at||E.listed_at)-new Date(h.sold_at||h.listed_at));p.innerHTML=(y.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${y.length})</div>`+y.map(x).join(""):"")+(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${w.length})</div>`+w.map(x).join(""):"")+(!y.length&&!w.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(y=>y.addEventListener("click",()=>ha(y.dataset.buy,r,t,e))),p.querySelectorAll("[data-cancel]").forEach(y=>y.addEventListener("click",()=>wa(y.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{c=p.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(u=>{const y=u===p;u.style.background=y?"var(--green)":"var(--tile-bg)",u.style.color=y?"#fff":"var(--tile-fg-dim)",u.style.borderColor=y?"var(--green)":"var(--tile-border)"}),b()})});let g;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var u;(u=document.getElementById(p))==null||u.addEventListener("input",()=>{clearTimeout(g),g=setTimeout(b,250)})}),b()}async function ha(t,e,i,o){const{state:a,toast:n,refreshProfile:r}=o,s=e.find(d=>d.id===t);if(!s)return;const c=s.price;if((a.profile.credits||0)<c){n("Crédits insuffisants","error");return}va(s,async()=>{const{error:d}=await v.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:a.profile.id});if(d){n("Erreur achat : "+d.message,"error");return}await r();const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(a.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await ro(i,o)})}function va(t,e){var r;const i=(r=t.card)==null?void 0:r.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",a.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
    ...
    </div>`,document.body.appendChild(a);const n=s=>{a.remove(),s&&e()};a.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),a.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),a.addEventListener("click",s=>{s.target===a&&n(!1)})}async function wa(t,e,i){const{toast:o}=i,{data:a}=await v.from("market_listings").select("card_id").eq("id",t).single();if(await v.from("market_listings").update({status:"cancelled"}).eq("id",t),a!=null&&a.card_id){const{count:n}=await v.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",a.card_id).eq("status","active");n||await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",a.card_id)}o("Annonce retirée","success"),ro(e,i)}async function _a(t,e){var b,g,p,u,y;const{state:i,navigate:o}=e,a=((g=(b=e==null?void 0:e.state)==null?void 0:b.params)==null?void 0:g.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:r},{data:s}]=await Promise.all([v.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").order("mmr",{ascending:!1}).limit(100),v.rpc("get_mini_league_leaderboard"),v.rpc("get_random_leaderboard")]);let c=a;const l=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",d=w=>w<3?"#000":"#fff";function f(){var E,m,A;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=c==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const h=document.getElementById("rankings-list");if(h){if(c==="ranked"){const $=n||[];h.innerHTML=$.length>0?$.map((T,P)=>{const G=Ei(T.mmr??1e3),O=(T.ranked_wins||0)+(T.ranked_losses||0)+(T.ranked_draws||0),V=O>0?Math.round((T.ranked_wins||0)/O*100):0,I=T.id===i.profile.id,_=(T.placement_matches||0)<10;return`
          ...
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(c==="mini-league"){const $=r||[];h.innerHTML=$.length>0?$.map((T,P)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${T.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${l(P)};color:${d(P)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${P<3?"16":"13"}px">${P<3?["🥇","🥈","🥉"][P]:P+1}</div>
          <div style="flex:1;min-width:0">
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const $=s||[];h.innerHTML=$.length>0?$.map((T,P)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${T.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${l(P)};color:${d(P)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${P<3?"16":"13"}px">${P<3?["🥇","🥈","🥉"][P]:P+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T.pseudo}</div>
  ...
  <div class="page">
    ...
    </div>`,(A=document.getElementById("ranked-back"))==null||A.addEventListener("click",()=>o("home"));return}const c=s.mmr??1e3,l=s.mmr_deviation??350,d=s.mmr_volatility??.06,f=s.placement_matches??0,x=f<10,b=Math.max(0,10-f),g=Ei(c),p=Bo(c),u=Bi.findIndex(G=>G.id===g.id),y=Bi[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=Bi.map(G=>`
  ...
  </div>`}hn(wn);const ve={user:null,profile:null,page:"home",params:{}};function It(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ea(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Wi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const gn="mw_theme";function oi(){return localStorage.getItem(gn)||"club"}function Co(t){var e;localStorage.setItem(gn,t),xi(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function xi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function zt(t,e={}){ve.page=t,ve.params=e,bn()}async function bn(){var o,a,n,r;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:zt,toast:It,openModal:Ea,closeModal:Wi,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await qi(t,i);break;case"home2":await qi(t,i);break;case"game":await Hn(t,i);break;case"settings":await Vo(t,i);break;case"collection":await Jn(t,i);break;case"decks":await Gi(t,i);break;case"boosters":await cr(t,i);break;case"ranked":await ka(t,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Vi(t,i,!1):s==="ranked"?await Vi(t,i,!0):s==="friend"?await Jr(t,i,(o=ve.params)==null?void 0:o.friendId,(a=ve.params)==null?void 0:a.friendName):s==="mini_league"||s==="mini-league"?await Ao(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(r=ve.params)==null?void 0:r.leagueId):await Er(t,i);break}case"market":await ya(t,i);break;case"rankings":await _a(t,i);break;case"matches":await $a(t,i);break;case"friends":await Nn(t,i);break;case"mini-league":await ta(t,i);break;case"match-mini-league":{const s=ve.params||{};await Ao(t,i,s.mlMatchId,s.leagueId);break}default:await qi(t,i)}}function La(){var o,a;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.29-0935" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",r=>{r.preventDefault(),zt(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>zt("home")),document.getElementById("nav-credits").addEventListener("click",()=>zt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>Ia()),(a=document.getElementById("settings-btn"))==null||a.addEventListener("click",()=>zt("settings"))}async function Ia(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const a=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${a}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}function Ta(t,{onPlay:e}){var o;const i="/icons/";t.style.cssText="",t.innerHTML=`
  <style>
    #public-landing{
  ...
  <div id="public-landing">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Sa(){xi(oi()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Wi()}),document.getElementById("modal-close").addEventListener("click",Wi);const{data:{session:t}}=await v.auth.getSession();if(!t){jo(),Ta(document.getElementById("app"),{onPlay:()=>mo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:It})});return}ve.user=t.user,await ti(),xi(oi()),jo();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(a=>{o[a.formation]=a.links}),vn(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){kn(document.getElementById("app"),{state:ve,navigate:async()=>{await ti(),xi(oi()),Pi()},toast:It,refreshProfile:ti});return}const e=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&e.length>0){yr(document.getElementById("app"),{state:ve,toast:It,refreshProfile:ti,navigate:()=>{Pi(),setTimeout(()=>zo(ve.profile,zt,It),800)}});return}Pi(),setTimeout(()=>zo(ve.profile,zt,It),800),v.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",mo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:It}))})}function Aa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Mi(){const t=document.getElementById("app");t&&(t.style.height=Aa()+"px")}window.addEventListener("resize",Mi);window.addEventListener("orientationchange",()=>setTimeout(Mi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Mi);function Pi(){const t=()=>{var i;(i=ve.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Mi(),La(),bn()}function jo(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function xn(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    ...
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(o=document.getElementById("boot-retry"))==null||o.addEventListener("click",()=>window.location.reload())}Sa().catch(t=>{console.error("Échec du démarrage:",t),xn()});setTimeout(()=>{const t=document.getElementById("app-loader");t&&t.style.display!=="none"&&!t.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&xn("Le serveur met trop de temps à répondre.")},12e3);
