...
import{s as w,F as si,r as Ae,j as At,l as Gi,m as bt,h as di,n as mn,o as xn,T as Yt,k as yn,p as bn,b as hn}from"./formation-links-TDtFd05S.js";const vn="/";function Li(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,d,l,c,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const l=document.getElementById("logo-preview"),c=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();l&&(l.style.background=r,l.style.borderColor=o),c&&(c.textContent=m,c.style.color=o)}document.getElementById("color1").addEventListener("input",l=>{o=l.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",l=>{r=l.target.value,document.getElementById("swatch2").style.background=r,s()});function d(l){document.querySelectorAll(".setup-step").forEach(c=>c.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("step1-error");if(c.textContent="",l.length<3){c.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",l).maybeSingle();if(u){c.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),c=document.getElementById("step2-error");if(c.textContent="",l.length<2){c.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",l).maybeSingle();if(u){c.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:l,club_name:c,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await _n(t.user.id),await a(),n(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function _n(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const kn="modulepreload",$n=function(e){return"/"+e},Ti={},Ri=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(d=>{if(d=$n(d),d in Ti)return;Ti[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":kn,l||(u.as="script"),u.crossOrigin="",u.href=d,s&&u.setAttribute("nonce",s),document.head.appendChild(u),l)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Lt="#1A6B3C",Tt="#cc2222",En="#D4A017",zi="#888";async function Ln(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const An="2026.07.15-2132";async function Mi(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    ${Ae(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter(T=>T.card_type==="player"&&T.player),c=(s||[]).filter(T=>T.card_type==="game_changer"),u=(s||[]).filter(T=>T.card_type==="formation"),g=(s||[]).filter(T=>T.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(T=>{f[T.name]=T});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(T=>{x[T.id]=T}),g.forEach(T=>{T.stadium_def&&(x[T.stadium_id]=T.stadium_def)});const b=Object.keys(si),h=Object.keys(Ie),v={};l.forEach(T=>{const I=T.player.id;v[I]=(v[I]||0)+1}),new Set(Object.keys(v).map(T=>String(T)));const $=new Set(u.map(T=>T.formation)),y=new Set(c.map(T=>T.gc_type));let C="player",E="Tous",P="",N=!1;function te(){return[...l].sort((T,I)=>{const R=Ct.indexOf(T.player.job),H=Ct.indexOf(I.player.job);return R!==H?R-H:(T.player.surname_real||"").localeCompare(I.player.surname_real||"")})}function ne(){return[...d||[]].sort((T,I)=>{const R=Ct.indexOf(T.job),H=Ct.indexOf(I.job);return R!==H?R-H:(T.surname_real||"").localeCompare(I.surname_real||"")})}function ee(){return te().filter(T=>{const I=T.player,R=E==="Tous"||I.job===E,H=!P||`${I.firstname} ${I.surname_real}`.toLowerCase().includes(P);return R&&H})}function q(){return ne().filter(T=>{const I=E==="Tous"||T.job===E,R=!P||`${T.firstname} ${T.surname_real}`.toLowerCase().includes(P);return I&&R})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function M(){const T=document.getElementById("col-filters");T&&(C==="player"?(T.innerHTML=`
          ...
          ${Pn.map(I=>`
            <button class="filter-btn" data-job="${I}"
              style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
                border:1.5px solid ${I===E?"var(--green)":"var(--gray-200)"};
                background:${I===E?"var(--green)":"#fff"};
                color:${I===E?"#fff":"var(--gray-600)"}">
              ${I}
            </button>`).join("")}
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",I=>{P=I.target.value.toLowerCase(),k()}),e.querySelectorAll(".filter-btn").forEach(I=>{I.addEventListener("click",()=>{E=I.dataset.job,M(),k()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,M(),k()})):(T.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,M(),k()})))}function k(){const T=document.getElementById("col-grid");T&&(C==="player"?ke(T):C==="formation"?K(T):C==="stadium"?V(T):Q(T))}function F(T,I,R,H,U){const j=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!j||!O)return;var Ee=0;function _e(){const we=window.innerWidth>=768,me=document.getElementById("col-big"),Le=document.getElementById("col-grid");we&&me&&(me.style.minHeight="420px",me.style.flex="1 1 auto"),we&&Le&&(Le.style.height=Math.round(310*.76+16)+"px",Le.style.flexShrink="0",Le.style.overflowX="auto",Le.style.overflowY="hidden",Le.style.alignItems="center",Le.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+I(T[Ee])+"</div>";var $e=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");$e&&$e.addEventListener("click",function(){H(T[Ee])}),requestAnimationFrame(function(){var he=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!he||!O)){var je=O.clientHeight-8,Be=O.clientWidth-24,Fe=he.offsetHeight,_=he.offsetWidth;if(Fe>0&&_>0&&je>40){var L=we?2.2:1.6,A=Math.min(je/Fe,Be/_,L);he.style.transform="scale("+A.toFixed(3)+")",he.style.transformOrigin="top center"}}}),j.innerHTML=T.map(function(he,je){var Be=je===Ee,Fe="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Be?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+je+'" style="'+Fe+'">'+R(he,Be)+"</div>"}).join(""),j.querySelectorAll(".col-mini-item").forEach(function(he){he.addEventListener("click",function(){Ee=Number(he.dataset.idx),_e(),he.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function de(T){var I=window.innerWidth>=768?.76:.54,R;if(!T||T._fake){var H=T?T.player:null;if(!H)return"";R=Si(H)}else R=Jt(T,"");return'<div style="display:inline-block;zoom:'+I+';pointer-events:none;line-height:0">'+R+"</div>"}function pe(T,I,R){I=I||100,R=R||140;var H=At[T]||{},U={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},j=Math.max(3,Math.round(I*.06)),O=Object.entries(H).map(function(_e){var we=_e[0],me=_e[1],Le=we.replace(/\d+$/,""),$e=U[Le]||"#888",he=Math.round(me.x*I),je=Math.round(me.y*R);return'<circle cx="'+he+'" cy="'+je+'" r="'+j+'" fill="'+$e+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),Ee=Math.max(1,Math.round(I/50));return'<svg viewBox="0 0 '+I+" "+R+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+I+'" height="'+R+'" fill="#1A6B3C"/><rect x="'+Math.round(I*.2)+'" y="'+Math.round(R*.02)+'" width="'+Math.round(I*.6)+'" height="'+Math.round(R*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Ee+'"/><line x1="0" y1="'+Math.round(R*.5)+'" x2="'+I+'" y2="'+Math.round(R*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+Ee+'"/><ellipse cx="'+Math.round(I*.5)+'" cy="'+Math.round(R*.5)+'" rx="'+Math.round(I*.18)+'" ry="'+Math.round(R*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+Ee+'"/><rect x="'+Math.round(I*.2)+'" y="'+Math.round(R*.82)+'" width="'+Math.round(I*.6)+'" height="'+Math.round(R*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Ee+'"/>'+O+"</svg>"}function le(T,I,R){var H=R>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+R+"</div>":"",U=I?'data-form-id="'+I.id+'"':"",j=T.length>7?14:T.length>5?16:19,O=!!I;return"<div "+U+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+H+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+j+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+T+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+pe(T,140,220)+"</div></div>"}function ae(T,I){var R=window.innerWidth>=768?.76:.54,H=140,U=305,j=Math.round(U*.22),O=U-j,Ee=T.length>7?10:13,_e=pe(T,H,O),we=I?"1.5px solid #2a7a40":"1px solid #ddd",me=I?"":"filter:grayscale(1);opacity:0.45;",Le=I?"#1A6B3C":"#bbb",$e="#fff";return'<div style="display:inline-block;zoom:'+R+';line-height:0;pointer-events:none"><div style="width:'+H+"px;height:"+U+"px;border-radius:6px;border:"+we+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+me+'"><div style="height:'+j+"px;background:"+Le+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+Ee+"px;font-weight:900;color:"+$e+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(H-4)+'px">'+T+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function ke(T){if(N){const I=q();if(!I.length){T.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const R=I.map(H=>l.find(U=>U.player.id===H.id)||{_fake:!0,player:H,id:"fake-"+H.id});F(R,H=>H._fake?Si(H.player):Jt(H,""),H=>H._fake?de({player:H.player,id:"x",_fake:!0}):de(H),H=>{H._fake||Ci(H,l,v,t)})}else{const I=ee();if(!I.length){T.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const R={};I.forEach(U=>{const j=U.player.id;R[j]||(R[j]=[]),R[j].push(U)});const H=Object.values(R).map(U=>Rn(U));F(H,U=>{const j=v[U.player.id]||1,O=j>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${j}</div>`:"",_e=l.filter(we=>we.player.id===U.player.id&&we.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Jt(U,O+_e)},U=>de(U),U=>Ci(U,l,v,t))}}function K(T){const I=N?b:[...$];if(!I.length){T.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const R=I.map(H=>({formation:H,card:u.find(U=>U.formation===H)||null,owned:$.has(H)}));F(R,({formation:H,card:U,owned:j})=>le(H,j?U:null,j?u.filter(O=>O.formation===H).length:0),({formation:H,owned:U})=>ae(H,U),({card:H,owned:U})=>{U&&H&&Vn(H,u,t,o)})}function Q(T){const I=Object.keys(f),R=N?I.length?I:h:[...y];if(!R.length){T.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const H=R.map(U=>({type:U,gc:Ie[U]||{icon:"⚡",desc:""},def:f[U]||null,owned:y.has(U),card:c.find(j=>j.gc_type===U)||null}));F(H,({type:U,gc:j,def:O,owned:Ee,card:_e})=>{var L;const we=Ee?c.filter(A=>A.gc_type===U).length:0,me=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Le=(O==null?void 0:O.gc_type)==="ultra_game_changer",$e={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},he={purple:"#b06ce0",light_blue:"#00d4ef"},je=$e[O==null?void 0:O.color]||$e.purple,Be=he[O==null?void 0:O.color]||he.purple,Fe=(O==null?void 0:O.effect)||j.desc||"",_=O!=null&&O.image_url?`/icons/${O.image_url}`:((L=O==null?void 0:O.club)==null?void 0:L.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Ee&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${U}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Be};background:${je};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Be}66;cursor:pointer">
          ${me}
          ...
          <div style="width:140px;height:310px;border-radius:8px;background:linear-gradient(160deg,${I},#c45a00);border:1px solid #c45a00;display:flex;flex-direction:column;overflow:hidden">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(T=>{T.addEventListener("click",()=>{C=T.dataset.tab,E="Tous",P="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(I=>{const R=I.dataset.tab===C;I.style.borderBottomColor=R?"var(--green)":"transparent",I.style.color=R?"var(--green)":"var(--gray-600)"}),M(),k()})}),M(),k()}function Kn(e,t,i){const n=Ie[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=r[t==null?void 0:t.color]||r.purple,l=(t==null?void 0:t.name)||e,c=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=1e3;function Vn(e,t,i,n){var f,p,x;const{state:a,toast:o,closeModal:r,navigate:s,refreshProfile:d}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const b=At[l]||{},h=si[l]||[],v=290,$=360,y=20;function C(P){const N=b[P];return N?{x:N.x*v,y:N.y*$}:null}let E=`<svg width="${v}" height="${$}" viewBox="0 0 ${v} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,N]of h){const te=C(P),ne=C(N);!te||!ne||(E+=`<line x1="${te.x}" y1="${te.y}" x2="${ne.x}" y2="${ne.y}"
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((K,Q)=>{const V=ee[K.id]||[],T=K.is_for_sale,I=V.length?V[V.length-1]:null,H=(c.rarity==="pepite"||c.rarity==="papyte")&&K.current_note!=null?` (☆${K.current_note})`:"";return`
            <div data-card-id="${K.id}" data-card-idx="${Q}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  ...
                  ${I?`<div style="font-size:11px;color:#888;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                    ${I.club_name} · ${I.source==="booster"?"Booster":I.price?I.price.toLocaleString("fr")+" cr.":"—"}
                  </div>`:""}
                </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([K,Q])=>{const V=Wt[K],T=K==="GK"?"#fff":V,I=K===c.job||K===c.job2,R=(Number(Q)||0)+(I&&C>0?C:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(pe=document.getElementById("close-detail"))==null||pe.addEventListener("click",s);let k=new Set;const F=()=>{const K=k.size,Q=document.getElementById("sell-action-panel");if(!Q)return;Q.style.display=K>0?"block":"none",document.getElementById("sell-selected-count").textContent=K;const V=document.getElementById("evolve-btn");V&&(V.textContent=`⬆️ Évoluer ${K>1?"(+"+K+")":""}`)};document.querySelectorAll(".expl-check").forEach(K=>{K.addEventListener("change",()=>{const Q=K.dataset.id;K.checked?k.add(Q):k.delete(Q);const V=K.closest(".exemplaire-row");V&&(V.style.borderColor=K.checked?"#1A6B3C":"#eee"),F()})}),document.querySelectorAll(".exemplaire-row").forEach(K=>{K.addEventListener("click",Q=>{if(Q.target.closest("button")||Q.target.tagName==="INPUT")return;const V=K.querySelector(".expl-check");V&&!V.disabled&&(V.checked=!V.checked,V.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(K=>{K.addEventListener("click",Q=>{Q.stopPropagation();const V=document.querySelector(`.expl-hist[data-hist="${K.dataset.idx}"]`);V&&(V.style.display=V.style.display==="none"?"flex":"none")})}),(le=document.getElementById("evolve-btn"))==null||le.addEventListener("click",async()=>{if(g<=1)return;const K=[...k];if(!K.length)return;if(k.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    </div>`;x("⚽ Choisir une formation",h),document.querySelectorAll("#modal-body [data-forma]").forEach(v=>{v.addEventListener("click",()=>{t.formation=v.dataset.forma;const $=Bi(t.formation),y={};$.forEach(C=>{t.slots[C]&&(y[C]=t.slots[C])}),t.slots=y,b(),Qe(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(x=>x.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(x=>x.addEventListener("click",()=>Wn(t,e,i))),e.querySelectorAll("#save-deck").forEach(x=>x.addEventListener("click",()=>Qn(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(x=>{x.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==x.dataset.removeSub),Qe(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(x=>x.addEventListener("click",()=>Jn(t,e,i)))}function Yn(e,t,i,n){var v,$;const a=window.innerWidth>=900,o=e.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const r=(v=t.stadiumCards)==null?void 0:v.find(y=>y.id===t.stadiumCardId),s=r&&(($=t.stadDefMap)==null?void 0:$[r.stadium_id])||null,d=At[t.formation]||{},l=Gi(t.formation)||[],c={};for(const y of i){const C=t.slots[y],E=C?t.playerCards.find(P=>P.id===C):null;E!=null&&E.player?c[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:c[y]=null}const u=window.innerWidth>=900,g=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(g,860):g,f=Math.round(u?m*.82:m*.85),p=u?84:44;let x="";for(const[y,C]of l){const E=d[y],P=d[C];if(!E||!P)continue;const N=E.x*m,te=Math.round(.03*f+E.y*.85*f),ne=P.x*m,ee=Math.round(.03*f+P.y*.85*f),q=c[y],M=c[C],k=bt(q,M);k==="#ff3333"||k==="#cc2222"?x+=`<line x1="${N.toFixed(1)}" y1="${te.toFixed(1)}" x2="${ne.toFixed(1)}" y2="${ee.toFixed(1)}" stroke="${k}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${N.toFixed(1)}" y1="${te.toFixed(1)}" x2="${ne.toFixed(1)}" y2="${ee.toFixed(1)}" stroke="${k}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${N.toFixed(1)}" y1="${te.toFixed(1)}" x2="${ne.toFixed(1)}" y2="${ee.toFixed(1)}" stroke="${k}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const h=Math.round(p*657/507);for(const y of i){const C=d[y];if(!C)continue;const E=c[y],P=C.x*m;C.y*f;const N=Math.round(.03*f+C.y*(.85*f)),te=Math.round(P-p/2),ne=Math.round(N-h/2);if(E){const ee=y.replace(/\d+/,""),q=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),M=Ae({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:ee});b+=`<div style="position:absolute;left:${te}px;top:${ne}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
        <div style="position:relative">${q?'<div style="position:absolute;top:-18px;left:0;right:0;text-align:center;font-size:14px;z-index:5;line-height:1">🏟️</div>':""}${M}</div>
  ...
  `,document.body.appendChild(a);let o=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=M=>M.touches&&M.touches[0]?M.touches[0].clientX:M.clientX;function c(M){o||(d=!0,s.style.opacity="1",u(M))}function u(M){if(!d||o)return;const k=r.getBoundingClientRect(),F=l(M)-k.left,de=Math.max(0,Math.min(1,F/k.width));s.style.width=de*k.width+"px",de>=.82&&m()}function g(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var k;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(k=document.getElementById("cut-flash"))==null||k.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const M=document.getElementById("cut-hint");M&&(M.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}r.addEventListener("pointerdown",c),window.addEventListener("pointermove",u),window.addEventListener("pointerup",g),r.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",g);let f=0,p=!1;const x=new Set;function b(M){f=M,document.getElementById("reveal-phase").style.display="flex",h(),v(M,0),P()}function h(){const M=document.getElementById("card-dots");M&&(M.innerHTML=e.map((k,F)=>`<div class="card-dot" data-i="${F}" style="width:8px;height:8px;border-radius:50%;background:${F===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),M.querySelectorAll(".card-dot").forEach(k=>k.addEventListener("click",()=>y(parseInt(k.dataset.i)))))}function v(M,k){var V,T;const F=e[M],de=document.getElementById("card-counter"),pe=document.getElementById("card-track");de&&(de.textContent=`Carte ${M+1} / ${e.length}`);const le=document.getElementById("reveal-btns");le&&(le.style.display=M===e.length-1?"flex":"none");const ae=F.card_type==="player"&&((V=F.player)==null?void 0:V.rarity)==="legende",ke=!x.has(M);x.add(M);let K=0;if(F.card_type==="player"&&F.player){const I=F.player,R=I.job||"ATT";K=Number(R==="GK"?I.note_g:R==="DEF"?I.note_d:R==="MIL"?I.note_m:I.note_a)||0}const Q=I=>{pe.innerHTML=`
        ...
        </div>`;const R=document.getElementById("current-card-wrap");k!==0?(R.style.transition="none",R.style.transform=`translateX(${k>0?100:-100}%)`,requestAnimationFrame(()=>{R.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",R.style.transform="translateX(0)"})):R.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),I||ae?te():ne(),h()};ke&&(((T=F.player)==null?void 0:T.rarity)==="legende"||K>=8)&&F.card_type==="player"&&F.player?$(F,()=>Q(!0)):Q(!1)}function $(M,k){var we;p=!0;const F=M.player,de=`https://flagsapi.com/${F.country_code}/flat/64.png`,pe=(we=F.clubs)==null?void 0:we.logo_url,le=F.face?"/"+F.face.replace(/^public\//,"").replace(/^\//,""):null,ae=F.job||"ATT",ke=Number(ae==="GK"?F.note_g:ae==="DEF"?F.note_d:ae==="MIL"?F.note_m:F.note_a)||0,K=M.evolution_bonus||0,Q=ke+K,V=F.rarity==="legende",T=Q>=18,I=document.getElementById("walkout-overlay"),R=document.getElementById("walkout-stage");if(!I||!R){p=!1,k();return}let H=null;V&&(H=new Audio("/sounds/Legendary.mp3"),H.volume=.8,H.play().catch(()=>{})),I.style.display="flex";const U=()=>{const me=R.firstElementChild;me&&(me.classList.remove("wo-in"),me.classList.add("wo-out"))},j=1800,O=400;R.innerHTML=`<img class="wo-in" src="${de}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(U,j),setTimeout(()=>{var me;R.innerHTML=pe?`<img class="wo-in" src="${pe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((me=F.clubs)==null?void 0:me.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},j+O),setTimeout(U,j*2+O),setTimeout(()=>{R.innerHTML=le?`<img class="wo-in" src="${le}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(j+O)*2),setTimeout(U,(j+O)*2+j);const _e=T?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[ae]||"#fff";setTimeout(()=>{R.innerHTML=`<div class="wo-in" style="
        ...
        ${Q}
      </div>`,T&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(j+O)*3),setTimeout(U,(j+O)*3+j),setTimeout(()=>{I.style.display="none",R.innerHTML="",p=!1,H&&!V&&H.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),k()},(j+O)*4)}function y(M){if(p||M<0||M>=e.length||M===f)return;const k=M>f?1:-1;f=M,v(M,k)}function C(){y(f+1)}function E(){y(f-1)}function P(){const M=document.getElementById("card-viewport");if(!M||M._swipeBound)return;M._swipeBound=!0;let k=0,F=0,de=0,pe=!1;const le=V=>V.touches?V.touches[0].clientX:V.clientX,ae=V=>V.touches?V.touches[0].clientY:V.clientY,ke=V=>{pe=!0,k=le(V),F=ae(V),de=0},K=V=>{if(!pe)return;de=le(V)-k;const T=ae(V)-F;if(Math.abs(de)<Math.abs(T))return;const I=document.getElementById("current-card-wrap");I&&(I.style.transition="none",I.style.transform=`translateX(${de*.6}px) rotate(${de*.02}deg)`)},Q=()=>{if(!pe)return;pe=!1;const V=document.getElementById("current-card-wrap"),T=55;de<=-T&&f<e.length-1?C():de>=T&&f>0?E():V&&(V.style.transition="transform .2s ease",V.style.transform="translateX(0)")};M.addEventListener("pointerdown",ke),M.addEventListener("pointermove",K),M.addEventListener("pointerup",Q),M.addEventListener("pointercancel",Q),M.addEventListener("touchstart",ke,{passive:!0}),M.addEventListener("touchmove",K,{passive:!0}),M.addEventListener("touchend",Q),M.addEventListener("click",V=>{if(Math.abs(de)>8)return;const T=M.getBoundingClientRect();V.clientX-T.left>T.width/2?C():E()})}let N=null;function te(){const M=document.getElementById("fireworks-canvas");if(!M)return;M.width=window.innerWidth,M.height=window.innerHeight;const k=M.getContext("2d"),F=[];function de(){const le=Math.random()*M.width,ae=Math.random()*M.height*.6,ke=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],K=ke[Math.floor(Math.random()*ke.length)];for(let Q=0;Q<60;Q++){const V=Math.PI*2/60*Q,T=2+Math.random()*5;F.push({x:le,y:ae,vx:Math.cos(V)*T,vy:Math.sin(V)*T,alpha:1,color:K,size:2+Math.random()*3})}}de(),N=setInterval(de,600);function pe(){if(document.getElementById("fireworks-canvas")){k.clearRect(0,0,M.width,M.height);for(let le=F.length-1;le>=0;le--){const ae=F[le];if(ae.x+=ae.vx,ae.y+=ae.vy+.08,ae.vy*=.98,ae.alpha-=.018,ae.alpha<=0){F.splice(le,1);continue}k.globalAlpha=ae.alpha,k.fillStyle=ae.color,k.beginPath(),k.arc(ae.x,ae.y,ae.size,0,Math.PI*2),k.fill()}k.globalAlpha=1,(N!==null||F.length>0)&&requestAnimationFrame(pe)}}pe()}function ne(){N!==null&&(clearInterval(N),N=null);const M=document.getElementById("fireworks-canvas");M&&M.getContext("2d").clearRect(0,0,M.width,M.height)}if(n){const M=document.getElementById("reveal-btns");M&&(M.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(q=document.getElementById("reveal-next"))==null||q.addEventListener("click",()=>{ne(),a.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ne(),a.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ne(),a.remove(),i("boosters")})}function so(e){var t,i,n,a;if(e.card_type==="player"&&e.player)return io(e);if(e.card_type==="game_changer"){const o=e._gcDef,r=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},d={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[o==null?void 0:o.color]||s.purple,c=d[o==null?void 0:o.color]||d.purple,u=(o==null?void 0:o.name)||e.gc_type||"Game Changer",g=(o==null?void 0:o.effect)||((t=ti[e.gc_type])==null?void 0:t.desc)||"",m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,f=((i=ti[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${l};border-radius:14px;border:3px solid ${c};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${c}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function ee(){const q=e.querySelector(".deck-preview-wrap"),M=e.querySelector("#deck-swipe-zone");if(!q||!M||!b)return;const k=M.clientWidth>=900,F=Math.max(200,M.clientHeight-(k?60:40)),pe=Math.max(200,M.clientWidth-16),le=k?Math.min(117,Math.max(52,Math.round(pe*.22))):Math.max(44,Math.round(pe*.168));if(F<220||pe<220){requestAnimationFrame(ee);return}const ae=k?null:Math.round(le*.55);q.innerHTML=yt(b,x,null,[],pe,F,[],ae),q.style.cssText=`width:${pe}px;height:${F}px;overflow:hidden;margin:${k?0:60}px auto 0`;const ke=q.querySelector("svg");ke&&(ke.style.cssText="display:block;width:100%;height:100%",ke.setAttribute("preserveAspectRatio",k?"xMidYMid meet":"none"))})),(P=document.getElementById("prev-deck"))==null||P.addEventListener("click",()=>{c>0&&(c--,u())}),(N=document.getElementById("next-deck"))==null||N.addEventListener("click",()=>{c<o.length-1&&(c++,u())}),(te=document.getElementById("validate-deck"))==null||te.addEventListener("click",()=>{if(!v)return;const ee=t.state.params||{};t.navigate("match",{...ee,matchMode:ee.matchMode||i,deckId:g.id})}),(ne=document.getElementById("cancel-deck-select"))==null||ne.addEventListener("click",()=>{Ue(e),a("home")});const $=document.getElementById("deck-swipe-zone");if($){let ee=0,q=0;$.addEventListener("touchstart",M=>{ee=M.touches[0].clientX,q=M.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",M=>{const k=M.changedTouches[0].clientX-ee,F=M.changedTouches[0].clientY-q;Math.abs(k)<40||Math.abs(k)<Math.abs(F)||(k<0&&c<o.length-1?(c++,u()):k>0&&c>0&&(c--,u()))},{passive:!0})}}u()}function Xe(e,t=44,i=58,n=null){return Ae(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function pt(e,t,i){if(!(e!=null&&e.length))return"";const n=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((o,r)=>{const s=o._line||o.job||"MIL";if(a+=Ae(o,{width:40,role:s,extraNote:o.boost||0}),r<n.length-1){const d=bt(o,n[r+1]);a+=`<div style="width:7px;height:3px;background:${d==="#ff3333"||d==="#cc2222"?"rgba(255,255,255,0.12)":d};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Rt(e,t,i,n,a=310,o=310,r=[],s=null){const d=At[t]||{},l=Gi(t)||si[t]||[],c={},u=["ATT","MIL","DEF","GK"];for(const b of u)(e[b]||[]).forEach((v,$)=>{c[`${b}${$+1}`]=v});function g(b){const h=d[b];return h?{x:h.x*a,y:h.y*o}:null}let m="";for(const[b,h]of l){const v=g(b),$=g(h);if(!v||!$)continue;const y=c[b],C=c[h],E=bt(y,C);E==="#00ff88"||E==="#FFD700"?(m+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,r)=>{const s=r<e.length-1?bt(o,e[r+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",l=s==="#00ff88"?"+2":s==="#FFD700"?"+1":"";return on(o,a),o.stadiumBonus||a&&(a.club_id&&String(o.club_id)===String(a.club_id)||a.country_code&&(o.country_code,a.country_code)),`
          <div class="duel-card duel-card-${n}" data-idx="${r}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${Ae({...o,_evolution_bonus:0},{width:window.innerWidth>=900?Math.min(130,Math.max(80,Math.round(window.innerWidth*.08))):58,showStad:!0,stadDef:a,role:"MIL",extraNote:o.boost||0})}
          </div>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const k=window.innerWidth>=700,F=(T,I,R)=>{var je,Be;const H=(t.gcDefs||[]).find(Fe=>Fe.name===T.gc_type),U={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[H==null?void 0:H.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",j={purple:"#b06ce0",light_blue:"#00d4ef"}[H==null?void 0:H.color]||"#b06ce0",O=(H==null?void 0:H.name)||T.gc_type,Ee=(H==null?void 0:H.effect)||((je=Ie[T.gc_type])==null?void 0:je.desc)||"",_e=H!=null&&H.image_url?`/icons/${H.image_url}`:null,we=((Be=Ie[T.gc_type])==null?void 0:Be.icon)||"⚡",me=Math.round(R*.22),Le=Math.round(R*.22),$e=R-me-Le,he=O.length>12?7:9;return`<div class="gc-mini" data-gc-id="${T.id}" data-gc-type="${T.gc_type}"
          style="box-sizing:border-box;width:${I}px;height:${R}px;border-radius:10px;border:2px solid ${j};background:${U};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${me}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${he}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${I-6}px">${O}</span>
          ...
          <div style="height:${$e}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${_e?`<img src="${_e}" style="max-width:${I-10}px;max-height:${$e-6}px;object-fit:contain">`:`<span style="font-size:${Math.round($e*.55)}px">${we}</span>`}
          </div>
      ...
      </div>`,V=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column;${k?"overflow-y:auto;min-height:500px":""}" id="match-field">
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;${k?"":"flex:1;min-height:0;"}display:flex;align-items:${k?"flex-start":"center"};justify-content:center">
  ...
  <div id="match-history-panel">
    ...
    </div>`,(y=u.querySelector("#sub-close"))==null||y.addEventListener("click",()=>u.remove()),(C=u.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,g())}),(E=u.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,g())}),(P=u.querySelector("#in-up"))==null||P.addEventListener("click",()=>{l>0&&(l--,g())}),(N=u.querySelector("#in-down"))==null||N.addEventListener("click",()=>{l<r.length-1&&(l++,g())});const $=(ne,ee,q,M)=>{const k=u.querySelector("#"+ne);if(!k)return;let F=0;k.addEventListener("touchstart",de=>{F=de.touches[0].clientY},{passive:!0}),k.addEventListener("touchend",de=>{const pe=de.changedTouches[0].clientY-F;if(Math.abs(pe)<30)return;const le=ee();pe<0&&le<M-1?(q(le+1),g()):pe>0&&le>0&&(q(le-1),g())},{passive:!0})};$("in-panel",()=>l,ne=>l=ne,r.length),$("out-panel",()=>s,ne=>s=ne,o.length),(te=u.querySelector("#sub-confirm"))==null||te.addEventListener("click",ne=>{if(ne.preventDefault(),ne.stopPropagation(),c)return;c=!0;const ee=o[s],q=r[l];if(!ee||!q)return;let M=null,k=-1;for(const[de,pe]of Object.entries(t.homeTeam)){const le=(pe||[]).findIndex(ae=>ae.cardId===ee.cardId);if(le!==-1){M=de,k=le;break}}if(k===-1||!M){_t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const F={...q,_line:M,_col:ee._col||0,used:!1,boost:0};t.homeTeam[M].splice(k,1,F),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(q.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:ee.name,firstname:ee.firstname,note:Ce(ee,M),portrait:zt(ee),job:ee.job,country_code:ee.country_code,rarity:ee.rarity,clubName:ee.clubName,clubLogo:ee.clubLogo},inPlayer:{name:q.name,firstname:q.firstname,note:Ce(q,M),portrait:zt(q),job:q.job,country_code:q.country_code,rarity:q.rarity,clubName:q.clubName,clubLogo:q.clubLogo},text:`🔄 ${q.firstname} ${q.name} remplace ${ee.firstname} ${ee.name}`}),u.remove(),ho(ee,q,()=>Te(e,t,i))})}document.body.appendChild(u),g()}function Io(e,t,i,n,a){var f,p;const o=(n.gcDefs||[]).find(x=>x.name===t),r=Ie[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",d={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",l=(o==null?void 0:o.name)||t,c=(o==null?void 0:o.effect)||r.desc,u=o!=null&&o.image_url?`/icons/${o.image_url}`:null,g=r.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${D}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(B),(re=B.querySelector("#pvp-end-home"))==null||re.addEventListener("click",()=>{B.remove(),Ue(e),m(r?"ranked":"home")})}const ee=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{const L=_.new;try{if(L.status==="finished"||L.forfeit){if(C)return;C=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),ne(L);return}if(L.game_state){const A=y;y=L.game_state;const S=y._lastGC;if(S&&S.seq&&!te.has(S.seq)&&(te.add(S.seq),S.by!==p)){V(S.type,S.by,()=>ae());return}const z=A[p+"Score"]||0,D=A[x+"Score"]||0,B=y[p+"Score"]||0,G=y[x+"Score"]||0,Y=B>z,W=G>D;if((Y||W)&&!N.has(y.round)){N.add(y.round);const X=[...y.log||[]].reverse().find(J=>J.isGoal),re=((X==null?void 0:X.homePlayers)||[]).map(J=>({name:J.name,note:J.note,portrait:J.portrait,job:J.job}));at(re,B,G,Y,()=>ae());return}ae()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function q(_){Object.assign(y,_),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{ae()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function M(){if(C)return;C=!0,E&&(clearInterval(E),E=null);const _=n?v.away_id:v.home_id,L=n?"p2":"p1",A=n?"p1":"p2",S={...y,[L+"Score"]:3,[A+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:_,home_score:S.p1Score||0,away_score:S.p2Score||0,game_state:S}).eq("id",i)}catch{}try{w.removeChannel(ee)}catch{}setTimeout(()=>{Ue(e),m("home")},800)}const k={BOOST_STAT:({value:_=1,count:L=1,roles:A=[]},S,z)=>{const D=S[p+"Team"],B=Object.entries(D).filter(([G])=>!A.length||A.includes(G)).flatMap(([G,Y])=>Y.filter(W=>!W.used).map(W=>({...W,_line:G})));if(!B.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(S);return}F(B,L,`Choisir ${L} joueur(s) à booster (+${_})`,G=>{G.forEach(Y=>{const W=(D[Y._line]||[]).find(X=>X.cardId===Y.cardId);W&&(W.boost=(W.boost||0)+_,S.log.push({text:`⚡ +${_} sur ${W.name}`,type:"info"}))}),S[p+"Team"]=D,z(S)})},DEBUFF_STAT:({value:_=1,count:L=1,roles:A=[],target:S="ai"},z,D)=>{const B=S==="home"?p:x,G=z[B+"Team"],Y=S==="home"?"allié":"adverse",W=Object.entries(G).filter(([X])=>!A.length||A.includes(X)).flatMap(([X,re])=>re.map(J=>({...J,_line:X})));if(!W.length){z.log.push({text:`🎯 Aucun joueur ${Y}`,type:"info"}),D(z);return}F(W,L,`Choisir ${L} joueur(s) ${Y}(s) (-${_})`,X=>{X.forEach(re=>{const J=(G[re._line]||[]).find(ce=>ce.cardId===re.cardId);J&&(J.boost=(J.boost||0)-_,z.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),z[B+"Team"]=G,D(z)})},GRAY_PLAYER:({count:_=1,roles:L=[],target:A="ai"},S,z)=>{const D=A==="home"?p:x,B=S[D+"Team"],G=A==="home"?"allié":"adverse",Y=Object.entries(B).filter(([W])=>!L.length||L.includes(W)).flatMap(([W,X])=>X.filter(re=>!re.used).map(re=>({...re,_line:W})));if(!Y.length){S.log.push({text:`❌ Aucun joueur ${G}`,type:"info"}),z(S);return}F(Y,_,`Choisir ${_} joueur(s) ${G}(s) à exclure`,W=>{const X="usedCardIds_"+D,re=new Set(S[X]||[]);W.forEach(J=>{const ce=(B[J._line]||[]).find(se=>se.cardId===J.cardId);ce&&(ce.used=!0,re.add(J.cardId),S.log.push({text:`❌ ${ce.name} exclu !`,type:"info"}))}),S[X]=[...re],S[D+"Team"]=B,z(S)})},REVIVE_PLAYER:({count:_=1,roles:L=[]},A,S)=>{const z=A[p+"Team"],D=Object.entries(z).filter(([B])=>!L.length||L.includes(B)).flatMap(([B,G])=>G.filter(Y=>Y.used).map(Y=>({...Y,_line:B})));if(!D.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(A);return}F(D,_,`Choisir ${_} joueur(s) à ressusciter`,B=>{B.forEach(G=>{const Y=(z[G._line]||[]).find(W=>W.cardId===G.cardId);Y&&(Y.used=!1,A.log.push({text:`💫 ${Y.name} ressuscité !`,type:"info"}))}),A[p+"Team"]=z,S(A)})},REMOVE_GOAL:({},_,L)=>{const A=x+"Score";_[A]>0?(_[A]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(_)},ADD_GOAL_DRAW:({},_,L)=>{_[p+"Score"]===_[x+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(_)},ADD_SUB:({value:_=1},L,A)=>{L.maxSubs=(L.maxSubs||3)+_,L.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),A(L)},CUSTOM:({},_,L)=>L(_)};function F(_,L,A,S){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let D=[];function B(){var Y,W;const G=_.map(X=>{const re={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[X._line]||"#555",J=Ce(X,X._line)+(X.boost||0),se=D.find(ue=>ue.cardId===X.cardId)?"#FFD700":"rgba(255,255,255,0.25)",oe=X.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${X.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${se};background:${re};overflow:hidden;cursor:pointer;${oe}">
        ...
        </div>`,(Y=z.querySelector("#pp-close"))==null||Y.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(X=>{X.addEventListener("click",()=>{const re=X.dataset.cid,J=_.find(se=>se.cardId===re),ce=D.findIndex(se=>se.cardId===re);J&&(ce>-1?D.splice(ce,1):D.length<L&&D.push(J),B())})}),(W=z.querySelector("#pp-confirm"))==null||W.addEventListener("click",()=>{z.remove(),S(D)})}B(),document.body.appendChild(z)}async function de(_,L){const S=(y["gcCardsFull_"+p]||[]).find(G=>G.id===_),z=(S==null?void 0:S._gcDef)||(y.gcDefs||[]).find(G=>{var Y;return G.name===L||((Y=G.name)==null?void 0:Y.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),D=[...y["usedGc_"+p]||[],_],B={type:L,by:p,seq:(y._gcAnimSeq||0)+1};te.add(B.seq),V(L,p,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const Y=k[z.effect_type];if(Y){const W={...y};Y(z.effect_params||{},W,async X=>{X["usedGc_"+p]=D,X._lastGC=B,X._gcAnimSeq=B.seq,await q(X)});return}}const G={...y};switch(L){case"Remplacement+":G.maxSubs=(G.maxSubs||3)+1,G.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const Y=x+"Score";G[Y]>0&&(G[Y]--,G.log.push({text:"🚫 But annulé",type:"info"}));break}}G["usedGc_"+p]=D,G._lastGC=B,G._gcAnimSeq=B.seq,await q(G)})}function pe(_,L){const A="usedCardIds_"+_,S=new Set(y[A]||[]);L.forEach(z=>S.add(z)),y[A]=[...S]}function le(){for(const _ of["p1","p2"]){const L=new Set(y["usedCardIds_"+_]||[]),A=y[_+"Team"];if(A)for(const S of["GK","DEF","MIL","ATT"])(A[S]||[]).forEach(z=>{z.used=L.has(z.cardId)})}}function ae(){var Ve,it,yi,bi,hi,vi;if(y.phase==="reveal")return ke();if(y.phase==="midfield")return Q();if(y.phase==="finished")return Fe();const _=y[p+"Team"],L=y[x+"Team"];le();const A=y[p+"Score"],S=y[x+"Score"],z=y[p+"Name"],D=y[x+"Name"],B=y.phase===p+"-attack",G=y.phase===p+"-defense",Y=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],W=Y.map(ie=>ie.cardId),X=window.innerWidth>=700,re=y[p+"Subs"]||[],J=y["usedSubIds_"+p]||[],ce=re.filter(ie=>!J.includes(ie.cardId)),se=y["gcCardsFull_"+p]||[],oe=y["usedGc_"+p]||[],ue=se.filter(ie=>!oe.includes(ie.id)),fe=y.boostOwner===p&&!y.boostUsed,xe=!["GK","DEF","MIL","ATT"].some(ie=>(L[ie]||[]).some(ge=>!ge.used)),Z=[..._.MIL||[],..._.ATT||[]].filter(ie=>!ie.used),be=B&&xe&&Z.length===0?[..._.GK||[],..._.DEF||[]].filter(ie=>!ie.used).map(ie=>ie.cardId):[];function ze(ie,ge,Me){var $i,Ei;const ye=ie._gcDef,nt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ye==null?void 0:ye.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",dt={purple:"#b06ce0",light_blue:"#00d4ef"}[ye==null?void 0:ye.color]||"#b06ce0",vt=(ye==null?void 0:ye.name)||ie.gc_type,wt=(ye==null?void 0:ye.effect)||(($i=Ie[ie.gc_type])==null?void 0:$i.desc)||"",wi=ye!=null&&ye.image_url?`/icons/${ye.image_url}`:null,fn=((Ei=Ie[ie.gc_type])==null?void 0:Ei.icon)||"⚡",_i=Math.round(Me*.22),ki=Math.round(Me*.22),Vt=Me-_i-ki,gn=vt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ie.id}" data-gc-type="${ie.gc_type}"
        style="box-sizing:border-box;width:${ge}px;height:${Me}px;border-radius:10px;border:2px solid ${dt};background:${nt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    </div>`,Ke=(()=>{var ge,Me;if(G&&((ge=y.pendingAttack)!=null&&ge.players)){const ye=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
        ...
        </div>`}if(B&&((Me=y.pendingAttack)!=null&&Me.players)){const ye=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function De(){const ie=e.querySelector(".match-screen");if(!ie)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ie.style.height=ge+"px",ie.style.minHeight=ge+"px",ie.style.maxHeight=ge+"px",ie.style.overflow="hidden";const Me=e.querySelector("#mobile-action-bar"),ye=e.querySelector("#mobile-play-area");Me&&ye&&(ye.style.paddingBottom=Me.offsetHeight+"px")}if(De(),setTimeout(De,120),setTimeout(De,400),P||(P=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",De),window.visualViewport.addEventListener("scroll",De)),window.addEventListener("resize",De)),function(){const ge=e.querySelector(".terrain-wrapper svg");ge&&(ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("viewBox","-26 -26 352 352"),ge.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(ie=>{ie.addEventListener("click",()=>{if(!B&&!G)return;const ge=ie.dataset.cardId,Me=ie.dataset.role,ye=(_[Me]||[]).find(wt=>wt.cardId===ge);if(!ye||ye.used)return;const nt=be.includes(ge);if(B&&!["MIL","ATT"].includes(Me)&&!nt)return;Array.isArray(y["selected_"+p])||(y["selected_"+p]=[]);const dt=y["selected_"+p],vt=dt.findIndex(wt=>wt.cardId===ge);vt>-1?dt.splice(vt,1):dt.length<3&&dt.push({...ye,_role:Me}),ae()})}),e.querySelectorAll(".match-used-hit").forEach(ie=>{ie.addEventListener("click",()=>R(ie.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ie=>{ie.addEventListener("click",()=>R())}),(Ve=e.querySelector("#pvp-sub-open"))==null||Ve.addEventListener("click",()=>R()),e.querySelectorAll(".pvp-gc-mini").forEach(ie=>{ie.addEventListener("click",()=>T(ie.dataset.gcId,ie.dataset.gcType))}),(it=e.querySelector("#pvp-boost-card"))==null||it.addEventListener("click",()=>I()),(yi=e.querySelector("#pvp-action"))==null||yi.addEventListener("click",ie=>{B?ie.currentTarget.dataset.pass==="1"||!$e(p)?O():Ee():G&&_e()}),(bi=e.querySelector("#pvp-quit"))==null||bi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&M()}),(hi=e.querySelector("#pvp-view-opp"))==null||hi.addEventListener("click",()=>U()),(vi=e.querySelector("#pvp-toggle-history"))==null||vi.addEventListener("click",()=>j()),E&&(clearInterval(E),E=null),(B||G)&&!C){let ie=30,ge=!1;const Me=()=>document.getElementById("pvp-timer"),ye=()=>{Me()&&(Me().textContent=ie+"s",Me().style.color=ge?"#ff4444":"#fff")};ye(),E=setInterval(()=>{ie--,ie<0?ge?(clearInterval(E),E=null,B&&!$e(p)?O():M()):(ge=!0,ie=15,ye()):ye()},1e3)}}function ke(){He(e),e.innerHTML=`
    ...
    </div>`,p==="p1"&&setTimeout(async()=>{await q({phase:"midfield"})},5e3)}let K=!1;function Q(){if(K)return;const _=y[p+"Team"].MIL||[],L=y[x+"Team"].MIL||[],A=milScore(_)+milLinks(_),S=milScore(L)+milLinks(L),z=A>=S;function D(se,oe,ue){return`<div id="duel-row-${ue}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(J);let ce=!1;const se=()=>{ce||(ce=!0,J.remove(),setTimeout(()=>A&&A(),50))};J.addEventListener("click",se),setTimeout(se,3e3)}function T(_,L){var J,ce,se,oe;const S=(y["gcCardsFull_"+p]||[]).find(ue=>ue.id===_),z=S==null?void 0:S._gcDef,D={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[z==null?void 0:z.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",B={purple:"#b06ce0",light_blue:"#00d4ef"}[z==null?void 0:z.color]||"#b06ce0",G=(z==null?void 0:z.name)||L,Y=(z==null?void 0:z.effect)||((J=Ie[L])==null?void 0:J.desc)||"Carte spéciale.",W=z!=null&&z.image_url?`/icons/${z.image_url}`:null,X=((ce=Ie[L])==null?void 0:ce.icon)||"⚡",re=document.createElement("div");re.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",re.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(A=L.querySelector("#pvp-hist-close"))==null||A.addEventListener("click",()=>L.remove())}async function O(){if(y.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",L=(y.round||0)+1,A=[...y.log||[]];A.push({type:"info",text:`⏭️ ${y[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const S=he(y),z=$e(_),D=S||!z?"finished":_+"-attack";await q({["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:D,attacker:_,round:L,log:A}),D==="finished"&&await Be(y)}async function Ee(){const _=y[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(D=>(y[x+"Team"][D]||[]).some(B=>!B.used)),A=(y["selected_"+p]||[]).map(D=>{const B=(_[D._role]||[]).find(se=>se.cardId===D.cardId)||D,G=L&&["GK","DEF"].includes(D._role),Y=_[D._role]||[],W=Y.findIndex(se=>se.cardId===D.cardId),X=xt(Y.length),re=W>=0?X[W]:B._col??1,J=y.stadiumDef||y.homeStadiumDef||null,ce=B.stadiumBonus||J&&(J.club_id&&String(B.club_id)===String(J.club_id)||J.country_code&&B.country_code===J.country_code)||!1;return{...B,_line:D._role,_col:re,stadiumBonus:ce,...G?{note_a:Math.max(1,Number(B.note_a)||0)}:{}}});if(!A.length)return;const S=pi(A,y.modifiers[p]||{});pe(p,A.map(D=>D.cardId)),A.forEach(D=>{const B=(_[D._role]||[]).find(G=>G.cardId===D.cardId);B&&(B.used=!0)}),y["selected_"+p]=[],ae();const z=[...y.log||[]];if(L){const D=(y[p+"Score"]||0)+1,B=A.map(re=>histPlayer(re));z.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:B,homeTotal:S.total,aiTotal:0});const G=(y.round||0)+1,Y=p==="p1"?"p2":"p1",W={...y,[p+"Team"]:_,[p+"Score"]:D},X=he(W);N.add(G),at(B,D,y[x+"Score"]||0,!0,async()=>{await q({[p+"Team"]:_,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:X?"finished":Y+"-attack",attacker:Y,round:G,log:z}),X&&await Be({...y,[p+"Score"]:D})});return}z.push({type:"pending",text:`⚔️ ${y[p+"Name"]} attaque (${S.total})`}),await q({[p+"Team"]:_,[x+"Team"]:y[x+"Team"],pendingAttack:{...S,players:A,side:p},["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},phase:x+"-defense",log:z})}async function _e(){const _=y[p+"Team"],L=(y["selected_"+p]||[]).map(oe=>{const ue=(_[oe._role]||[]).find(ze=>ze.cardId===oe.cardId)||oe,fe=_[oe._role]||[],xe=fe.findIndex(ze=>ze.cardId===oe.cardId),Z=xt(fe.length),be=xe>=0?Z[xe]:ue._col??1;return{...ue,_line:oe._role,_col:be}}),A=ui(L,y.modifiers[p]||{});pe(p,L.map(oe=>oe.cardId)),L.forEach(oe=>{const ue=(_[oe._role]||[]).find(fe=>fe.cardId===oe.cardId);ue&&(ue.used=!0)}),y["selected_"+p]=[],ae();const S=fi(y.pendingAttack.total,A.total,y.modifiers[p]||{}),z=y.pendingAttack.side,D=S==="attack"||(S==null?void 0:S.goal),B=z==="p1"?"p2":"p1",G=(y.round||0)+1,Y=(y.pendingAttack.players||[]).map(oe=>histPlayer(oe)),W=[...y.log||[]];W.push({type:"duel",isGoal:D,homeScored:D&&z===p,text:D?`⚽ BUT de ${y[z+"Name"]} ! (${y.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${y.pendingAttack.total} vs ${A.total})`,homePlayers:Y,aiPlayers:L.map(oe=>histPlayer(oe)),homeTotal:y.pendingAttack.total,aiTotal:A.total});const X=D?(y[z+"Score"]||0)+1:y[z+"Score"]||0,re={...y,[p+"Team"]:_,[z+"Score"]:X},J=he(re),ce=J?"finished":B+"-attack",se=async()=>{await q({[p+"Team"]:_,[x+"Team"]:y[x+"Team"],[z+"Score"]:X,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:ce,attacker:B,round:G,log:W}),(ce==="finished"||J)&&await Be({...y,[z+"Score"]:X})};if(D){const oe=z===p,ue=oe?X:y[p+"Score"]||0,fe=oe?y[x+"Score"]||0:X;N.add(G),at(Y,ue,fe,oe,se)}else await se()}function we(_){return["MIL","ATT"].some(L=>(_[L]||[]).some(A=>!A.used))}function me(_){return["GK","DEF","MIL","ATT"].some(L=>(_[L]||[]).some(A=>!A.used))}function Le(_){return me(_)&&!we(_)}function $e(_){const L=y[_+"Team"],A=y[(_==="p1"?"p2":"p1")+"Team"];return!!(we(L)||!me(A)&&Le(L))}function he(_){const L=["MIL","ATT"].some(W=>(_.p1Team[W]||[]).some(X=>!X.used)),A=["MIL","ATT"].some(W=>(_.p2Team[W]||[]).some(X=>!X.used)),S=me(_.p1Team),z=me(_.p2Team);return!L&&!(!z&&S)&&(!A&&!(!S&&z))}function je(_){const L=_.p1Score||0,A=_.p2Score||0;return L===A?null:L>A?v.home_id:v.away_id}async function Be(_){try{const L=je(_),A=L?v.home_id===L?v.away_id:v.home_id:null;await w.from("matches").update({status:"finished",winner_id:L,home_score:_.p1Score||0,away_score:_.p2Score||0}).eq("id",i),L&&A&&updateEvolutiveCards(L,A).catch(()=>{})}catch(L){console.error("[PvP] finishMatch:",L)}}function Fe(){var z;const _=y[p+"Score"],L=y[x+"Score"],A=_>L,S=_===L;He(e),e.innerHTML=`
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${g.map((q,M)=>{const k=f>0&&r.status==="finished"?M===0?Math.floor(f*.7):M===1?Math.floor(f*.2):M===2?Math.floor(f*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${q.userId===o?"background:#f0fdf4;":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${M===0?We:M<3?gt:"#555"}">${["🥇","🥈","🥉"][M]||M+1}</td>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(q,M)=>M+1).reverse().map(q=>{const M=(d||[]).filter(k=>k.matchday===q);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${q}</div>${M.map(k=>Di(k,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
