...
import{s as v,t as Oo,u as Ho,n as ut,g as Bt,p as nt,v as si,o as Ut,r as ze,k as At,w as Gi,x as Ft,y as Ii,F as Ai,z as Uo,T as Di,q as $n,C as En,d as Ln}from"./special-cards-DNsLLa5x.js";const Sn="/";function wo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,l,s,d,c,p,b;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function l(){var x;const d=document.getElementById("logo-preview"),c=document.getElementById("logo-initials"),p=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",b=p.trim().split(" ").filter(Boolean),g=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():p.slice(0,2).toUpperCase();d&&(d.style.background=a,d.style.borderColor=n),c&&(c.textContent=g,c.style.color=n)}document.getElementById("color1").addEventListener("input",d=>{n=d.target.value,document.getElementById("swatch1").style.background=n,l()}),document.getElementById("color2").addEventListener("input",d=>{a=d.target.value,document.getElementById("swatch2").style.background=a,l()});function s(d){document.querySelectorAll(".setup-step").forEach(c=>c.classList.remove("active")),document.getElementById(`step-${d}`).classList.add("active"),document.getElementById("step-num").textContent=d,document.getElementById("progress-fill").style.width=`${Math.round(d/3*100)}%`,d===3&&l()}document.getElementById("step1-next").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("step1-error");if(c.textContent="",d.length<3){c.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:p}=await v.from("users").select("id").eq("pseudo",d).maybeSingle();if(p){c.textContent="Ce pseudo est déjà pris.";return}s(2)}),document.getElementById("step2-back").addEventListener("click",()=>s(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const d=document.getElementById("setup-club").value.trim(),c=document.getElementById("step2-error");if(c.textContent="",d.length<2){c.textContent="Nom trop court (min. 2 caractères).";return}const{data:p}=await v.from("users").select("id").eq("club_name",d).maybeSingle();if(p){c.textContent="Ce nom de club est déjà pris.";return}s(3)}),document.getElementById("step3-back").addEventListener("click",()=>s(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("setup-club").value.trim(),p=document.getElementById("step3-error"),b=document.getElementById("step3-finish");p.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:e.user.id,pseudo:d,club_name:c,club_color1:n,club_color2:a,credits:15e3});if(g)throw g;await In(e.user.id),await r(),o(`Bienvenue ${d} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){p.textContent=g.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function In(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const An="modulepreload",zn=function(t){return"/"+t},_o={},Ko=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(s=>{if(s=zn(s),s in _o)return;_o[s]=!0;const d=s.endsWith(".css"),c=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${c}`))return;const p=document.createElement("link");if(p.rel=d?"stylesheet":An,d||(p.as="script"),p.crossOrigin="",p.href=s,l&&p.setAttribute("nonce",l),document.head.appendChild(p),d)return new Promise((b,g)=>{p.addEventListener("load",b),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${s}`)))})}))}function n(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return r.then(a=>{for(const l of a||[])l.status==="rejected"&&n(l.reason);return e().catch(n)})},Vo="mw_sound_volume";function Zi(){const t=localStorage.getItem(Vo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function Mn(t){localStorage.setItem(Vo,String(Math.max(0,Math.min(100,Math.round(t)))))}function eo(){return Zi()===0}function wi(t){return Math.max(0,Math.min(1,t*(Zi()/100)))}function to(t,e=1){if(eo())return null;try{const i=new Audio(t);return i.volume=wi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Oi=null,ko=.3;function Yo(t,e=.3){if(ko=e,ht&&Oi===t&&!ht.paused){ht.volume=wi(ko);return}if(Ot(),!eo())try{const i=new Audio(t);i.loop=!0,i.volume=wi(e),i.play().catch(()=>{}),ht=i,Oi=t}catch{}}function Ot(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Oi=null}let ti=null;function Wo(t,e=.6){if(Ve(),!eo())try{const i=new Audio(t);i.volume=wi(e),i.play().catch(()=>{}),ti=i}catch{}}function Ve(){if(ti)try{ti.pause(),ti.currentTime=0}catch{}ti=null}async function Xo(t=null){const e=new Date().toISOString().slice(0,10),{data:i}=await v.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const o=i.filter(a=>!(a.available_from&&e<a.available_from||a.available_until&&e>a.available_until));if(!o.length)return[];let r=o;if(t){const a=o.filter(l=>l.max_per_user!=null);if(a.length){const{data:l}=await v.from("booster_claims").select("booster_id").eq("user_id",t).in("booster_id",a.map(d=>d.id)),s={};(l||[]).forEach(d=>{s[d.booster_id]=(s[d.booster_id]||0)+1}),r=o.filter(d=>d.max_per_user==null?!0:(s[d.id]||0)<d.max_per_user)}}if(!r.length)return[];const{data:n}=await v.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(n||[]).filter(l=>l.booster_id===a.id)}))}async function Cn(t,e){const{data:i}=await v.from("booster_configs").select("max_per_user").eq("id",e).single();i!=null&&i.max_per_user&&await v.from("booster_claims").insert({user_id:t,booster_id:e})}function jn(t){if(!(t!=null&&t.length))return null;const e=t.reduce((o,r)=>o+Number(r.percentage),0);let i=Math.random()*e;for(const o of t)if(i-=Number(o.percentage),i<=0)return o;return t[t.length-1]}const Jo=()=>Object.keys(ut),qn=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Hi={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Bn(t){const e=t.player;if(!e)return"";const i=t.evolution_bonus||0;return ze({...e,_evolution_bonus:i},{width:140})}function io(t){var r;const e={};(t.rates||[]).forEach(n=>{e[n.card_type]=(e[n.card_type]||0)+Number(n.percentage||0)});const i=((r=Object.entries(e).sort((n,a)=>a[1]-n[1])[0])==null?void 0:r[0])||"player",o=t.image_url||"booster-players.png";return{id:t.id,img:"/icons/"+o,name:t.name,sub:`${t.card_count} carte(s)`,cost:t.price_type==="credits"&&t.price_credits||0,costLabel:t.price_type==="credits"?`${(t.price_credits||0).toLocaleString("fr")} crédits`:t.price_type==="pub"?"1 pub":"Gratuit",cardCount:t.card_count||5,type:i,isPub:t.price_type==="pub",rates:t.rates||[],allow_duplicates:t.allow_duplicates!==!1,_boosterId:t.id,_raw:t}}async function Dn(t,e,i,o){if(t.reward_type==="credits"){const r=(e.credits||0)+(t.credits_amount||0),{error:n}=await v.from("users").update({credits:r}).eq("id",e.id);if(n)throw n;return e.credits=r,{type:"credits",amount:t.credits_amount}}if(t.reward_type==="card"){const{data:r}=await v.from("players").select("firstname, surname_real, rarity").eq("id",t.player_id).single(),{error:n}=await v.from("cards").insert({owner_id:e.id,player_id:t.player_id,card_type:"player"});if(n)throw n;return{type:"card",player:r}}if(t.reward_type==="booster"){const{data:r}=await v.from("booster_configs").select("*").eq("id",t.booster_config_id).single(),{data:n}=await v.from("booster_drop_rates").select("*").eq("booster_id",t.booster_config_id);if(!r)throw new Error("Booster introuvable (peut-être supprimé depuis).");const a=io({...r,rates:n});let l=[];return a.type==="formation"?l=await ro(e,0):a.type==="game_changer"?l=await no(e,a.cardCount,0):a.type==="player"?l=await oo(e,a.cardCount,0):l=await _i(e,{...a,cost:0}),{type:"booster",name:r.name,cards:l,boosterUI:a}}throw new Error("Type de récompense inconnu.")}async function Fn(t,{state:e,navigate:i,toast:o}){var p,b,g;Yt(i,e.profile,"boosters","/icons/",o);const r=((p=e.profile)==null?void 0:p.credits)||0;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let n=[];try{n=(await Xo((b=e.user)==null?void 0:b.id)).map(io)}catch(x){console.warn("Erreur chargement boosters DB, fallback hardcodé",x)}n.length||(n=qn.map(x=>({...x,rates:[],isPub:x.id==="players_pub"})));const a=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.profile.id).then(x=>x.data||[]),l=new Set(a.filter(x=>x.card_type==="stadium").map(x=>x.stadium_id)),s=new Set(a.filter(x=>x.card_type==="formation").map(x=>x.formation)),d=new Set(a.filter(x=>x.card_type==="game_changer").map(x=>x.gc_type)),c={};for(const x of n){if(x.allow_duplicates!==!1||!((g=x.rates)!=null&&g.length))continue;const f=[...new Set((x.rates||[]).map(u=>u.card_type))];let y=!1;for(const u of f)if(u==="stadium"){const{data:w}=await v.from("stadium_definitions").select("id");if((w||[]).some(h=>!l.has(h.id))){y=!0;break}}else if(u==="game_changer"){const{data:w}=await v.from("gc_definitions").select("name").eq("is_active",!0);if((w||[]).some(h=>!d.has(h.name))){y=!0;break}}else if(u==="formation"){const{FORMATION_LINKS:w}=await Ko(async()=>{const{FORMATION_LINKS:h}=await import("./special-cards-DNsLLa5x.js").then(E=>E.G);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(w).some(h=>!s.has(h))){y=!0;break}}else{y=!0;break}y||(c[x.id]=!0)}t.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${n.map(x=>{const f=x.cost===0||r>=x.cost,y=c[x.id]===!0;return`<div class="booster-card ${!f||y?"disabled":""}" data-booster="${x.id}" style="position:relative">
  ...
  </div>`,t.querySelectorAll(".booster-card:not(.disabled)").forEach(x=>{x.addEventListener("click",async()=>{const f=n.find(y=>y.id===x.dataset.booster);if(f){x.style.opacity="0.5",x.style.pointerEvents="none";try{await Pn(f,{state:e,toast:o,navigate:i,container:t})}catch(y){o(y.message,"error"),x.style.opacity="",x.style.pointerEvents=""}}})}),t.querySelectorAll(".booster-info-btn").forEach(x=>{x.addEventListener("click",f=>{f.stopPropagation();const y=n.find(u=>u.id===x.dataset.boosterId);On(y)})})}async function Pn(t,{state:e,toast:i,navigate:o,container:r}){var p,b;if(t.cost>0&&e.profile.credits<t.cost){i("Crédits insuffisants","error");return}if(t.isPub){if(!await Oo("pub_mode")){Ho();return}await Un()}const{data:n}=await v.from("cards").select("card_type, player_id, formation").eq("owner_id",e.profile.id),a=new Set((n||[]).filter(g=>g.card_type==="player").map(g=>g.player_id)),l=new Set((n||[]).filter(g=>g.card_type==="formation").map(g=>g.formation));let s=[],d=null;try{if((p=t.rates)!=null&&p.length)s=await _i(e.profile,t);else{const g=t.type||"player";g==="player"?s=await oo(e.profile,t.cardCount,t.cost):g==="game_changer"?s=await no(e.profile,t.cardCount,t.cost):g==="formation"?s=await ro(e.profile,t.cost):s=await _i(e.profile,t)}}catch(g){d=g.message||String(g),console.error("[Booster] Erreur:",g)}if(s!=null&&s.length&&t._boosterId&&await Cn(e.user.id,t._boosterId),!(s!=null&&s.length)){const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",g.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${d||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(g),(b=g.querySelector("#anim-close-err"))==null||b.addEventListener("click",()=>g.remove());return}s.forEach(g=>{g.card_type==="player"&&g.player?g.isDuplicate=a.has(g.player.id):g.card_type==="formation"&&(g.isDuplicate=l.has(g.formation))});const{data:c}=await v.from("users").select("*").eq("id",e.profile.id).single();c&&(e.profile=c),Qo(s,t,o)}function Rn(){const t=Math.random()*100;return t<.5?"legende":t<2?"special":t<10?"normal_high":"normal_low"}function yt(t){return Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function Nn(t,e){let i;switch(e){case"legende":i=t.filter(o=>o.rarity==="legende"),i.length||(i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte")),i.length||(i=t.filter(o=>yt(o)>=6));break;case"special":i=t.filter(o=>o.rarity==="pepite"||o.rarity==="papyte"),i.length||(i=t.filter(o=>yt(o)>=6));break;case"normal_high":i=t.filter(o=>o.rarity==="normal"&&yt(o)>=6),i.length||(i=t.filter(o=>yt(o)>=6));break;default:i=t.filter(o=>o.rarity==="normal"&&yt(o)>=1&&yt(o)<=5),i.length||(i=t.filter(o=>o.rarity==="normal"));break}return i.length||(i=t),i[Math.floor(Math.random()*i.length)]}async function _i(t,e){if(e.cost>0){const{error:b}=await v.from("users").update({credits:t.credits-e.cost}).eq("id",t.id);if(b)throw b;t.credits-=e.cost,Wt(t.credits)}const i=e.allow_duplicates!==!1;let o=[];const{data:r,error:n}=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.id);if(n){const{data:b}=await v.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",t.id);o=b||[]}else o=r||[];const a=new Set(o.filter(b=>b.card_type==="player").map(b=>b.player_id)),l=new Set(o.filter(b=>b.card_type==="formation").map(b=>b.formation)),s=new Set(o.filter(b=>b.card_type==="game_changer").map(b=>b.gc_type)),d=new Set(o.filter(b=>b.card_type==="stadium").map(b=>b.stadium_id).filter(Boolean)),c=new Set,p=[];for(let b=0;b<(e.cardCount||5);b++){const g=jn(e.rates);if(g){if(g.card_type==="player"){const x=$=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[$]||$,f=g.rarity?x(g.rarity):null;let y=v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);f&&(y=y.eq("rarity",f));const{data:u}=await y;let w=u||[];if((g.note_min||g.note_max)&&(w=w.filter($=>{const I=Math.max(Number($.note_g)||0,Number($.note_d)||0,Number($.note_m)||0,Number($.note_a)||0);return(!g.note_min||I>=g.note_min)&&(!g.note_max||I<=g.note_max)})),w.length||(g.note_min||g.note_max?(w=u||[],console.warn("[Booster] Aucun joueur avec note",g.note_min,"-",g.note_max,"— fallback rareté uniquement")):w=u||[]),!w.length)continue;let h=w.filter($=>!c.has($.id));if(i)h.length||(h=w);else if(h=h.filter($=>!a.has($.id)),!h.length)continue;const E=h[Math.floor(Math.random()*h.length)];c.add(E.id);const m=a.has(E.id),{data:T}=await v.from("cards").insert({owner_id:t.id,player_id:E.id,card_type:"player"}).select().single();T&&(p.push({...T,player:E,isDuplicate:m}),v.rpc("record_transfer",{p_card_id:T.id,p_player_id:E.id,p_club_name:t.club_name||t.pseudo,p_manager_name:t.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(g.card_type==="game_changer"){const{data:x}=await v.from("gc_definitions").select("id,name,color,effect,image_url,gc_type").eq("is_active",!0).eq("gc_type","game_changer"),f=x!=null&&x.length?x:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],y=i?f:f.filter(E=>!s.has(E.name));if(!i&&!y.length)continue;const u=y[Math.floor(Math.random()*y.length)],w=u.name,{data:h}=await v.from("cards").insert({owner_id:t.id,card_type:"game_changer",gc_type:w,gc_definition_id:u.id||null}).select().single();h&&p.push({...h,_gcDef:u})}else if(g.card_type==="formation"){const x=Jo(),f=i?x:x.filter(h=>!l.has(h));if(!i&&!f.length)continue;const y=f[Math.floor(Math.random()*f.length)],u=l.has(y),{data:w}=await v.from("cards").insert({owner_id:t.id,card_type:"formation",formation:y}).select();w!=null&&w[0]&&p.push({...w[0],isDuplicate:u})}else if(g.card_type==="stadium"){const{data:x,error:f}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(f){console.error("[Booster] stadium_definitions:",f.message);continue}if(!(x!=null&&x.length)){console.warn("[Booster] Aucun stade en DB");continue}const y=i?x:x.filter(E=>!d.has(E.id));if(!i&&!y.length)continue;const u=y[Math.floor(Math.random()*y.length)],{data:w,error:h}=await v.from("cards").insert({owner_id:t.id,card_type:"stadium",stadium_id:u.id}).select("id,card_type,stadium_id").single();if(h){console.error("[Booster] insert stadium card:",h.message);continue}w&&p.push({...w,rarity:"normal",_stadiumDef:u})}}}return p}async function oo(t,e,i){if(i>0){const{error:d}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(d)throw d;t.credits-=i,Wt(t.credits)}const{data:o}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(o!=null&&o.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const r=o.filter(d=>d.job==="GK"),n=o.filter(d=>d.job!=="GK"),a=!t.first_booster_opened&&r.length>0,l=[];for(let d=0;d<e;d++){const c=d===0&&a?r:d===0?n:o,p=Rn(),b=Nn(c,p);b&&l.push(b)}a&&await v.from("users").update({first_booster_opened:!0}).eq("id",t.id);const{data:s}=await v.from("cards").insert(l.map(d=>({owner_id:t.id,player_id:d.id,card_type:"player"}))).select();return(s||[]).forEach((d,c)=>{v.rpc("record_transfer",{p_card_id:d.id,p_player_id:l[c].id,p_club_name:t.club_name||t.pseudo,p_manager_name:t.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),l.map((d,c)=>({...s[c],player:d}))}async function no(t,e,i){const{error:o}=await v.from("users").update({credits:t.credits-i}).eq("id",t.id);if(o)throw o;t.credits-=i,Wt(t.credits);const{data:r}=await v.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),n=r!=null&&r.length?r:Object.keys(Hi).map(p=>({name:p,gc_type:"game_changer"})),a=Array.from({length:e},()=>n[Math.floor(Math.random()*n.length)]),l=a.map(p=>({owner_id:t.id,card_type:"game_changer",gc_type:p.name,gc_definition_id:p.id||null})),{data:s,error:d}=await v.from("cards").insert(l).select();return d&&console.error("[Booster GC] Erreur insert:",d.message,d),(s||[]).map((p,b)=>({...p,_gcDef:a[b]||null}))}async function ro(t,e){const{error:i}=await v.from("users").update({credits:t.credits-e}).eq("id",t.id);if(i)throw i;t.credits-=e,Wt(t.credits);const{data:o}=await v.from("cards").select("formation").eq("owner_id",t.id).eq("card_type","formation"),r=new Set((o||[]).map(c=>c.formation)),n=Jo(),a=n[Math.floor(Math.random()*n.length)],l=r.has(a),{data:s,error:d}=await v.from("cards").insert({owner_id:t.id,card_type:"formation",formation:a}).select();return d&&console.error("[Booster Formation] Erreur insert:",d.message,d),(s||[]).map(c=>({...c,isDuplicate:l}))}function Qo(t,e,i,o=null){var j,L;if(!t||t.length===0){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",_.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let s=!1;const d=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function c(_){n||(s=!0,l.style.opacity="1",p(_))}function p(_){if(!s||n)return;const G=a.getBoundingClientRect(),O=d(_)-G.left,le=Math.max(0,Math.min(1,O/G.width));l.style.width=le*G.width+"px",le>=.82&&g()}function b(){n||(s=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{n||(l.style.transition="")},220))}function g(){var G;if(n)return;n=!0,s=!1,l.style.width="100%",l.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",u(0)},620)}a.addEventListener("pointerdown",c),window.addEventListener("pointermove",p),window.addEventListener("pointerup",b),a.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",p,{passive:!0}),window.addEventListener("touchend",b);let x=0,f=!1;const y=new Set;function u(_){x=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),I()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((G,O)=>`<div class="card-dot" data-i="${O}" style="width:8px;height:8px;border-radius:50%;background:${O===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>m(parseInt(G.dataset.i)))))}function h(_,G){var de,q;const O=t[_],le=document.getElementById("card-counter"),pe=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${t.length}`);const M=document.getElementById("reveal-btns");M&&(M.style.display=_===t.length-1?"flex":"none");const H=O.card_type==="player"&&((de=O.player)==null?void 0:de.rarity)==="legende",fe=!y.has(_);y.add(_);let xe=0;if(O.card_type==="player"&&O.player){const W=O.player,ee=W.job||"ATT";xe=(Number(ee==="GK"?W.note_g:ee==="DEF"?W.note_d:ee==="MIL"?W.note_m:W.note_a)||0)+(O.evolution_bonus||0)}const ge=W=>{pe.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${H?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Gn(O)}</div>
      ...
      </div>`,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>o.remove());return}Hn()}function Hn(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function Un(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText=`
    ...
    `,document.body.appendChild(e);try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(r){console.warn("[AdSense]",r)}let i=5;const o=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}async function Kn(t,{state:e,navigate:i,toast:o,refreshProfile:r}){var b,g;const{data:n}=await v.from("users").select("*").eq("id",e.user.id).single();n&&(e.profile=n);let a=Array.isArray((b=e.profile)==null?void 0:b.pending_boosters)?[...e.profile.pending_boosters]:[];if(!a.length){await v.from("users").update({onboarding_done:!0}).eq("id",e.user.id),i("home");return}let l=null;try{const f=(await Xo()).find(y=>(y.name||"").toLowerCase().includes("new player"));f&&(l=io(f))}catch(x){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',x)}const s=a.length;let d=0;t.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const c=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",e.user.id)};async function p(){var w;if(d>=s||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),r&&await r(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const x=a[0],{data:f}=await v.from("users").select("*").eq("id",e.user.id).single();f&&(e.profile=f);let y=[];try{if(x.type==="formation")y=await ro(e.profile,0);else if(x.type==="game_changer")y=await no(e.profile,x.count||3,0);else if(l&&((w=l.rates)!=null&&w.length)){const h={...l,cost:0,cardCount:x.count||l.cardCount||5};y=await _i(e.profile,h),x.guaranteeGK&&!e.profile.first_booster_opened&&(y.some(m=>m.player&&m.player.job==="GK")||await Vn(e.profile,y),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else y=await oo(e.profile,x.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}a.shift(),d++,await c();const u=x.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:x.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${d}/${s})`,img:(l==null?void 0:l.img)||"/icons/booster-players.png"};Qo(y,u,i,()=>{p()})}(g=document.getElementById("onboard-start"))==null||g.addEventListener("click",()=>p())}async function Vn(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],r=e.findIndex(a=>a.player);if(r===-1)return;const n=e[r];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[r]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Yn=[{key:"home2",route:"home2",label:"ACCUEIL",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARTES",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"EQUIPES",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOUTIQUE",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Yt(t,e,i,o,r){if(!document.getElementById("home2-chrome-style")){const p=document.createElement("style");p.id="home2-chrome-style",p.textContent=`
    ...
    `,document.head.appendChild(p)}const n=Yn.map(p=>`
    ...
    `,document.body.appendChild(l),l.querySelector("#home2-mobtop-settings-btn").addEventListener("click",()=>t("settings")),l.querySelector("#home2-mobtop-credits").addEventListener("click",()=>$o(e,r)));let s=document.getElementById("home2-mobile-bottom");s||(s=document.createElement("div"),s.id="home2-mobile-bottom",s.className="home2-mobile-bottom",s.innerHTML=n,document.body.appendChild(s)),document.querySelectorAll(".home2-chrome-tab").forEach(p=>{p._v2Bound||(p._v2Bound=!0,p.addEventListener("click",()=>{document.querySelectorAll(".home2-chrome-tab").forEach(b=>b.classList.remove("active")),document.querySelectorAll(`.home2-chrome-tab[data-key="${p.dataset.key}"]`).forEach(b=>b.classList.add("active")),t(p.dataset.route)}))}),document.querySelectorAll(".home2-chrome-tab").forEach(p=>p.classList.toggle("active",p.dataset.key===i));const d=`💰 ${(e.credits||0).toLocaleString("fr")}`;document.getElementById("home2-chrome-credits")&&(document.getElementById("home2-chrome-credits").textContent=d),document.getElementById("home2-mobtop-credits")&&(document.getElementById("home2-mobtop-credits").textContent=d),document.body.classList.remove("v2-match-flow"),a.style.display="",l.style.display="",s.style.display="";const c=document.getElementById("page-content");c&&(c.style.removeProperty("padding-top"),c.style.removeProperty("padding-bottom")),requestAnimationFrame(()=>{requestAnimationFrame(()=>{const p=window.innerWidth<1024;document.documentElement.style.setProperty("--v2-top-height",(p?l.offsetHeight:a.offsetHeight)+"px"),document.documentElement.style.setProperty("--v2-bottom-height",s.offsetHeight+"px")})})}const Wn=[{ads:1,seconds:5,credits:4500},{ads:2,seconds:10,credits:9500},{ads:3,seconds:15,credits:15e3}];async function $o(t,e){if(!await Oo("pub_mode")){Ho();return}const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:9999;padding:16px",i.innerHTML=`
    ...
    </div>`,document.body.appendChild(i),i.querySelector("#credits-ad-cancel").addEventListener("click",()=>i.remove()),i.querySelectorAll(".credits-ad-offer-btn").forEach(o=>{o.addEventListener("click",()=>{i.remove(),Xn(parseInt(o.dataset.ads),5,parseInt(o.dataset.credits),t,e)})})}function Xn(t,e,i,o,r){let n=1;const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;gap:14px;color:#fff;padding:16px",document.body.appendChild(a);function l(){a.innerHTML=`
    ...
    `;try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(p){console.warn("[AdSense]",p)}let d=e;const c=setInterval(()=>{d--;const p=a.querySelector("#credits-ad-cd");p&&(p.textContent=d),d<=0&&(clearInterval(c),s())},1e3)}function s(){var p,b;const d=a.querySelector("#credits-ad-status"),c=a.querySelector("#credits-ad-next-zone");n<t?(d&&(d.textContent="Publicité terminée ✅"),c&&(c.innerHTML=`
        <button id="credits-ad-next-btn" class="btn btn-primary" style="width:100%;padding:12px;font-size:14px">
          Suivant (${n}/${t}) →
        </button>`),(p=a.querySelector("#credits-ad-next-btn"))==null||p.addEventListener("click",()=>{n++,l()})):(d&&(d.textContent="Toutes les publicités ont été vues ✅"),c&&(c.innerHTML=`
        ...
        </button>`),(b=a.querySelector("#credits-ad-claim-btn"))==null||b.addEventListener("click",async()=>{const g=a.querySelector("#credits-ad-claim-btn");g.disabled=!0,g.textContent="⏳...";const x=(o.credits||0)+i,{error:f}=await v.from("users").update({credits:x}).eq("id",o.id);if(f){r(f.message,"error"),g.disabled=!1;return}o.credits=x,Wt(x),r(`+${i.toLocaleString("fr")} crédits ✅`,"success"),a.remove()}))}l()}async function Jn(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:9999;padding:16px",document.body.appendChild(i);async function o(){var l;const{data:r}=await v.from("pending_rewards").select(`*,
        player:players(id, firstname, surname_real, country_code, club_id, job, job2,
          note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length, face,
          clubs(encoded_name, logo_url)),
        booster:booster_configs(name, image_url)`).eq("user_id",t.profile.id).eq("claimed",!1).order("created_at",{ascending:!0});if(!(r!=null&&r.length)){i.remove();const s=document.getElementById("pending-rewards-banner");s&&s.remove();return}const n=s=>{var d;return s.reward_type==="credits"?'<div style="width:56px;height:56px;border-radius:12px;background:rgba(212,160,23,0.15);display:flex;align-items:center;justify-content:center;font-size:28px;flex-shrink:0">💰</div>':s.reward_type==="card"&&s.player?`<div style="flex-shrink:0">${ze(s.player,{width:56})}</div>`:s.reward_type==="booster"?`<img src="/icons/${((d=s.booster)==null?void 0:d.image_url)||"booster-players.png"}" style="width:56px;height:56px;object-fit:contain;border-radius:12px;background:rgba(255,255,255,0.05);flex-shrink:0">`:'<div style="width:56px;height:56px;border-radius:12px;background:rgba(255,255,255,0.05);display:flex;align-items:center;justify-content:center;font-size:28px;flex-shrink:0">❓</div>'},a=s=>{var d,c,p;return s.reward_type==="credits"?`${(s.credits_amount||0).toLocaleString("fr")} crédits`:s.reward_type==="card"?`${((d=s.player)==null?void 0:d.firstname)||""} ${((c=s.player)==null?void 0:c.surname_real)||""}`.trim()||"Carte joueur":s.reward_type==="booster"?((p=s.booster)==null?void 0:p.name)||"Booster":"Récompense"};i.innerHTML=`
          ...
          ${r.map(s=>`
            <div style="display:flex;align-items:center;gap:14px;padding:12px 14px;border-radius:12px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)">
              ...
              <div style="flex:1;min-width:0">
                <div style="font-weight:700;font-size:13px">${a(s)}</div>
      ...
      </div>`,(l=i.querySelector("#pending-rewards-close"))==null||l.addEventListener("click",()=>i.remove()),i.querySelectorAll(".claim-reward-btn").forEach(s=>{s.addEventListener("click",async()=>{var c,p,b;const d=r.find(g=>g.id===s.dataset.id);s.disabled=!0,s.textContent="⏳...";try{const g=await Dn(d,t.profile,e,null);await v.from("pending_rewards").update({claimed:!0,claimed_at:new Date().toISOString()}).eq("id",d.id),g.type==="credits"?(Wt(t.profile.credits),e(`+${g.amount.toLocaleString("fr")} crédits ✅`,"success")):g.type==="card"?e(`Carte reçue : ${((c=g.player)==null?void 0:c.firstname)||""} ${((p=g.player)==null?void 0:p.surname_real)||""} ✅`,"success"):g.type==="booster"&&e(`Booster "${g.name}" ouvert — ${((b=g.cards)==null?void 0:b.length)||0} carte(s) reçue(s) ✅`,"success")}catch(g){e(g.message||"Erreur lors de la réclamation","error"),s.disabled=!1,s.textContent="Récupérer";return}o()})})}o(),i.addEventListener("click",r=>{r.target===i&&i.remove()})}function Wt(t){const e=`💰 ${(t||0).toLocaleString("fr")}`,i=document.getElementById("home2-chrome-credits"),o=document.getElementById("home2-mobtop-credits");i&&(i.textContent=e),o&&(o.textContent=e)}function mt(){document.body.classList.add("v2-match-flow");const t=document.getElementById("home2-chrome-header");t&&(t.style.display="none");const e=document.getElementById("home2-mobile-top");e&&(e.style.display="none");const i=document.getElementById("home2-mobile-bottom");i&&(i.style.display="none");const o=document.getElementById("page-content");o&&(o.style.setProperty("padding-top","0","important"),o.style.setProperty("padding-bottom","0","important"))}function Qn(t){if(!t)return"";const e=Date.now()-new Date(t).getTime(),i=Math.floor(e/6e4);if(i<1)return"à l'instant";if(i<60)return`il y a ${i}min`;const o=Math.floor(i/60);if(o<24)return`il y a ${o}h`;const r=Math.floor(o/24);return r<7?`il y a ${r}j`:new Date(t).toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})}function Zn(t,e){if(!isFinite(e.max))return"";const i=e.max-e.min+1,o=Math.floor((t-e.min)/(i/3));return["III","II","I"][Math.min(2,Math.max(0,o))]}async function er(t){const{data:e}=await v.from("users").select("id,pseudo,club_name,mmr").order("mmr",{ascending:!1}).limit(5),i=e||[],o=i.some(n=>n.id===t);let r=null;if(!o){const{data:n}=await v.from("users").select("mmr").eq("id",t).single();if(n){const{count:a}=await v.from("users").select("id",{count:"exact",head:!0}).gt("mmr",n.mmr||0);r=(a||0)+1}}return{list:i,iAmInTop:o,myPosition:r}}async function tr(t=4){const{data:e}=await v.from("patch_notes").select("id,title,description,image_url,published_at").eq("is_published",!0).order("published_at",{ascending:!1}).limit(t);return e||[]}async function ir(){const{data:t}=await v.from("booster_configs").select("id,name,icon,price_type,price_credits,card_count").eq("is_active",!0).order("sort_order",{ascending:!0}).limit(5);return t||[]}async function or(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const r=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Fi(t,{state:e,navigate:i,toast:o}){var m,T,$,I,D,V,Y;const r=e.profile;if(!r)return;const n="/icons/";Yt(i,r,"home2",n,o);const a=r.mmr??1e3,l=At(a),s=Zn(a,l),d=Gi(a),c=isFinite(l.max)?l.max+1:null,[{list:p,iAmInTop:b,myPosition:g},x,f,{count:y}]=await Promise.all([er(r.id),tr(5),ir(),v.from("pending_rewards").select("*",{count:"exact",head:!0}).eq("user_id",r.id).eq("claimed",!1)]),u=(j,L)=>`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Qn(j.published_at)}</div>
      </div>
  ...
  <div class="home-dark" id="home-dark">
          ...
          <div class="rank-card">
            <div class="rank-top-row">
              <div class="rank-tier-block">
                ...
                <div class="rank-tier-value">${l.label.toUpperCase()}${s?" "+s:""}</div>
              </div>
    ...
    <div class="modal-body" style="padding:18px 20px">
  ...
  </div>`,document.body.appendChild(n),n.querySelector("#claim-later-btn").addEventListener("click",()=>n.remove()),n.querySelector("#claim-all-btn").addEventListener("click",async a=>{const l=a.currentTarget;l.disabled=!0,l.textContent="...";let s=0;for(const d of o){const{data:c}=await v.rpc("claim_mini_league_prize",{p_league_id:d.league_id,p_user_id:i});c!=null&&c.success&&!c.already_claimed&&(s+=c.prize||0)}if(s>0){t.profile.credits=(t.profile.credits||0)+s;const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${t.profile.credits.toLocaleString("fr")}`),e(`💰 +${s.toLocaleString("fr")} cr. récupérés !`,"success")}n.remove()})}async function Zo(t,e,i){const o=document.getElementById("ongoing-match-banner");if(!o)return;const r=t.profile.id,{data:n}=await v.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(n!=null&&n.length)){o.innerHTML="";return}const a=n.map(s=>s.home_id===r?s.away_id:s.home_id).filter(Boolean);let l={};if(a.length){const{data:s}=await v.from("users").select("id, pseudo, club_name").in("id",a);(s||[]).forEach(d=>{l[d.id]=d.club_name||d.pseudo})}o.innerHTML=n.map(s=>{const d=s.home_id===r?s.away_id:s.home_id,c=l[d]||"Adversaire",p=s.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
      ...
      <div style="flex:1;min-width:0">
        <div style="font-size:13px;font-weight:900">${p?"🏆 Mini League":s.mode==="friend"?"Match ami":"Match"} en cours</div>
        <div style="font-size:11px;opacity:0.8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">vs ${c}</div>
      </div>
      <button data-resume="${s.id}" data-mini="${p?"1":""}" style="width:38px;height:38px;border-radius:50%;border:none;background:#22c55e;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">⚽</button>
      <button data-abandon="${s.id}" data-opp="${d}" style="width:38px;height:38px;border-radius:50%;border:none;background:#cc2222;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">✕</button>
    </div>`}).join(""),o.querySelectorAll("[data-resume]").forEach(s=>{s.addEventListener("click",async()=>{mt();const d=document.getElementById("page-content")||document.getElementById("app");if(s.dataset.mini==="1"){const{data:c}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",s.dataset.resume).single();c?i("match-mini-league",{mlMatchId:c.id,leagueId:c.league_id}):i("mini-league")}else{const{resumePvpMatch:c}=await Ko(async()=>{const{resumePvpMatch:p}=await Promise.resolve().then(()=>aa);return{resumePvpMatch:p}},void 0);c(d,{state:t,navigate:i,toast:e,openModal:null,closeModal:null,refreshProfile:null},s.dataset.resume)}})}),o.querySelectorAll("[data-abandon]").forEach(s=>{s.addEventListener("click",()=>{ar(async()=>{await rr(s.dataset.abandon,s.dataset.opp,r),e("Match abandonné (défaite 3-0)","info"),Zo(t,e,i)})})})}async function rr(t,e,i){Ot();const{data:o}=await v.from("matches").select("home_id, away_id, game_state, mode").eq("id",t).single();if(!o)return;const r=o.home_id===i,n=r?0:3,a=r?3:0,l=o.game_state||{};l.p1Score=n,l.p2Score=a,l.phase="finished",l.forfeit=!0,await v.from("matches").update({status:"finished",forfeit:!0,winner_id:e,home_score:n,away_score:a,game_state:l}).eq("id",t),o.mode==="mini_league"&&await v.from("mini_league_matches").update({status:"finished",home_score:n,away_score:a}).eq("match_id",t)}function ar(t){const e=document.createElement("div");e.className="modal-overlay",e.innerHTML=`<div class="modal" style="max-width:340px">
  ...
  </div>`,document.body.appendChild(e),e.querySelector("#ab-cancel").addEventListener("click",()=>e.remove()),e.querySelector("#ab-ok").addEventListener("click",()=>{e.remove(),t()}),e.addEventListener("click",i=>{i.target===e&&e.remove()})}async function sr(t,e,i){var l,s,d,c;const o=document.getElementById("match-invite-banner");if(!o)return;const{data:r}=await v.from("friend_match_invites").select("id, inviter_id, inviter:users!inviter_id(pseudo, club_name)").eq("invitee_id",t.user.id).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!r){o.innerHTML="";return}const n=((l=r.inviter)==null?void 0:l.club_name)||((s=r.inviter)==null?void 0:s.pseudo)||"?",a=r.inviter_id;o.innerHTML=`<div id="match-invite-btn" style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(26,10,46,0.8),rgba(74,26,138,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(122,40,184,0.4);cursor:pointer;box-shadow:0 3px 12px rgba(74,10,138,0.3)">
  ...
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>nn(t,e,()=>en(t,e)))}async function tn(t,e){const i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:420px;border-radius:18px;overflow:hidden">
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",d=>{d.target===i&&o()});const[{data:r},{data:n}]=await Promise.all([v.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),v.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),a=(n==null?void 0:n.unlocked_level)||1,l=r||[],s=document.getElementById("solo-levels-list");if(s){if(!l.length){s.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}s.innerHTML=l.map(d=>{const c=d.level_number>a,p=d.level_number===a,b=c?"#f0f0f0":p?"#eefaf2":"#f7f7f7",g=c?"#ddd":p?"#bfe8cf":"#e0e0e0",x=c?"#999":"#12401f";return`
      <div class="solo-level-card" data-level="${d.level_number}" data-locked="${c}"
        style="cursor:${c?"not-allowed":"pointer"};display:flex;align-items:center;gap:14px;padding:14px 16px;border-radius:14px;background:${b};border:1px solid ${g};opacity:${c?.6:1};transition:transform .12s ease">
        ...
        <div style="flex:1;min-width:0">
          <div style="font-weight:800;font-size:15px;color:${x}">Niveau ${d.level_number}</div>
        ...
        ${c?"":`<div style="font-weight:900;font-size:12.5px;color:${x};background:rgba(255,255,255,0.7);padding:6px 11px;border-radius:999px;flex-shrink:0;white-space:nowrap">+${d.reward_credits} cr.</div>`}
      </div>`}).join(""),s.querySelectorAll(".solo-level-card").forEach(d=>{d.dataset.locked!=="true"&&(d.addEventListener("mouseenter",()=>{d.style.transform="translateY(-1px)"}),d.addEventListener("mouseleave",()=>{d.style.transform=""}),d.addEventListener("click",()=>{o(),mt(),t("match",{matchMode:"solo",soloLevel:Number(d.dataset.level)})}))})}}const di="#1A6B3C",li="#cc2222",dr="#D4A017",Eo="#888";async function lr(t,e){const{state:i,toast:o}=e;t.innerHTML=`
    ...
    </div>`,await on(i,o,e),document.getElementById("btn-add-friend").addEventListener("click",()=>pr(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>nn(i,o,null,e))}async function on(t,e,i={}){const{navigate:o}=i,r=t.user.id,{data:n,error:a}=await v.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${r},addressee_id.eq.${r}`),{count:l}=await v.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",r).eq("status","pending"),s=document.getElementById("pending-badge");s&&(l>0?(s.style.display="flex",s.textContent=l):s.style.display="none");const d=document.getElementById("friends-list");if(!d)return;if(a){console.error("[Friends] Erreur:",a),d.innerHTML=`<div style="color:${li};text-align:center;padding:16px">Erreur chargement : ${a.message}</div>`;return}const c=(n||[]).map(g=>g.requester_id===r?g.addressee_id:g.requester_id);let p={};if(c.length){const{data:g}=await v.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",c);(g||[]).forEach(x=>{p[x.id]=x})}const b=(n||[]).map(g=>({friendshipId:g.id,friend:p[g.requester_id===r?g.addressee_id:g.requester_id]||{pseudo:"?"}}));if(!b.length){d.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${b.map(({friendshipId:g,friend:x})=>cr(x,g)).join("")}
    </div>`,d.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>ur(t,g.dataset.stats,g.dataset.friendName))}),d.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const x=g.dataset.friendId,f=g.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const y=t.user.id,{data:u}=await v.from("friend_match_invites").select("id").eq("inviter_id",x).eq("invitee_id",y).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!u;console.log("[Friends] clic match",{fid:x,fname:f,isAccepting:w}),mt(),o("match",{matchMode:"friend",friendId:x,friendName:f,isAccepting:w})})})}function cr(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",r=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||di,a=t.club_color1||"#ffffff",l=t.last_seen_at?new Date(t.last_seen_at):null,s=l&&Date.now()-l.getTime()<3*60*1e3;return`
    <div style="display:flex;align-items:center;gap:12px;background:var(--tile-bg);border-radius:12px;padding:12px 14px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
      <div style="position:relative;width:46px;height:46px;flex-shrink:0">
        ...
        ${`<div style="width:10px;height:10px;border-radius:50%;background:${s?"#22c55e":"#ef4444"};border:2px solid #fff;position:absolute;bottom:1px;right:1px"></div>`}
      </div>
      <div style="flex:1;min-width:0">
        <div style="font-size:14px;font-weight:900;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${i}</div>
        <div style="font-size:11px;color:#888;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">@${o}</div>
        <div style="font-size:11px;color:${s?"#22c55e":"#bbb"};font-weight:600;margin-top:1px">${s?"🟢 En ligne":"🔴 Hors ligne"}</div>
      </div>
      <div style="display:flex;gap:8px;flex-shrink:0">
        ...
        <button data-stats="${t.id}" data-friend-name="${i}" title="Voir les stats"
          style="width:38px;height:38px;border-radius:50%;border:2px solid ${dr};background:var(--tile-bg);font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center">📊</button>
      </div>
    </div>`}function pr(t,e){const i=ao();i.innerHTML=`
    <div class="popup-box">
    ...
    ${so()}`,document.body.appendChild(i);const o=i.querySelector("#friend-pseudo-input"),r=i.querySelector("#add-friend-error"),n=()=>i.remove();o.focus(),i.querySelector("#add-cancel").addEventListener("click",n),i.addEventListener("click",a=>{a.target===i&&n()}),i.querySelector("#add-ok").addEventListener("click",async()=>{const a=o.value.trim();if(!a){r.textContent="Entre un pseudo";return}r.textContent="";const{data:l}=await v.from("users").select("id, pseudo").ilike("pseudo",a).single();if(!l){r.textContent="Utilisateur introuvable";return}if(l.id===t.user.id){r.textContent="Tu ne peux pas t'ajouter toi-même";return}const{data:s}=await v.from("friendships").select("id, status").or(`and(requester_id.eq.${t.user.id},addressee_id.eq.${l.id}),and(requester_id.eq.${l.id},addressee_id.eq.${t.user.id})`).single();if(s){const c=s.status==="accepted"?"Vous êtes déjà amis !":s.status==="pending"?"Demande déjà envoyée":"Une demande existe déjà";r.textContent=c;return}const{error:d}=await v.from("friendships").insert({requester_id:t.user.id,addressee_id:l.id,status:"pending"});if(d){r.textContent="Erreur : "+d.message;return}n(),e(`✅ Demande envoyée à ${l.pseudo} !`,"success")})}async function nn(t,e,i=null,o={}){const r=t.user.id,{data:n}=await v.from("friendships").select("id, requester_id").eq("addressee_id",r).eq("status","pending").order("created_at",{ascending:!1}),a=(n||[]).map(b=>b.requester_id);let l={};if(a.length){const{data:b}=await v.from("users").select("id, pseudo, club_name").in("id",a);(b||[]).forEach(g=>{l[g.id]=g})}const s=(n||[]).map(b=>({...b,requester:l[b.requester_id]||{pseudo:"?"}})),d=ao(),c=s||[];d.innerHTML=`
    <div class="popup-box">
    ...
    ${so()}`,document.body.appendChild(d);const p=()=>d.remove();d.querySelector("#pending-close").addEventListener("click",p),d.addEventListener("click",b=>{b.target===d&&p()}),d.querySelectorAll("[data-accept]").forEach(b=>{b.addEventListener("click",async()=>{const{error:g}=await v.from("friendships").update({status:"accepted"}).eq("id",b.dataset.accept);if(g){e("Erreur : "+g.message,"error");return}b.closest("div[style]").remove(),e("✅ Ami accepté !","success"),on(t,e,o),i&&i()})}),d.querySelectorAll("[data-decline]").forEach(b=>{b.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",b.dataset.decline),b.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function ur(t,e,i){const o=t.user.id,[r,n]=[o,e].sort(),a=o===r,{data:l}=await v.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",n).single(),s=t.profile.club_name||t.profile.pseudo||"Moi",d=l||{},c=a?d.wins_p1||0:d.wins_p2||0,p=a?d.wins_p2||0:d.wins_p1||0,b=d.draws||0,g=a?d.goals_p1||0:d.goals_p2||0,x=a?d.goals_p2||0:d.goals_p1||0,f=a?d.gc_used_p1||0:d.gc_used_p2||0,y=a?d.gc_used_p2||0:d.gc_used_p1||0,u=d.matches_total||0,w=(E,m,T,$=di,I=li)=>`
    ...
    </div>`,h=ao();h.innerHTML=`
    <div class="popup-box" style="max-width:380px">
      <div class="popup-title">📊 Stats vs ${i}</div>
      <!-- En-têtes -->
      <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:8px;margin-bottom:4px">
        <div style="text-align:right;font-size:12px;font-weight:700;color:#555;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${s}</div>
        <div></div>
    ...
    ${so()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",E=>{E.target===h&&h.remove()})}function ao(){const t=document.createElement("div");return t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",t}function so(){return`
    <style>
      .popup-box {
    ...
    </style>`}async function fr(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;const n="/icons/";Yt(i,r,"game",n,o),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const l=a.dataset.action;if(l==="match-ai"){tn(i,e);return}if(l==="match-random"){mt(),i("match",{matchMode:"random"});return}if(l==="match-friend"){i("friends");return}if(l==="mini-league"){i("mini-league");return}if(l==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function rn(t,e){var f,y;const{state:i,navigate:o}=e,r=ai(),n=Zi(),a=(f=i==null?void 0:i.profile)==null?void 0:f.is_admin,l="2026.07.30-2155";t.innerHTML=`
  ...
  </div>`,t.querySelectorAll("[data-theme-choice]").forEach(u=>{u.addEventListener("click",()=>{No(u.dataset.themeChoice),rn(t,e)})});const s=t.querySelector("#team-color1"),d=t.querySelector("#team-color2"),c=t.querySelector("#team-preview"),p=()=>{c&&(c.style.background=`linear-gradient(135deg, ${s.value} 50%, ${d.value} 50%)`)};p(),s==null||s.addEventListener("input",p),d==null||d.addEventListener("input",p),(y=t.querySelector("#team-save"))==null||y.addEventListener("click",async()=>{const u=t.querySelector("#team-error"),w=t.querySelector("#team-save"),h=t.querySelector("#team-club-name").value.trim();if(h.length<2){u.textContent="Nom de club trop court.";return}w.disabled=!0,w.textContent="⏳ Enregistrement...",u.textContent="";const{error:E}=await v.from("users").update({club_name:h,club_color1:s.value,club_color2:d.value}).eq("id",i.profile.id);if(w.disabled=!1,w.textContent="💾 Enregistrer",E){u.textContent=E.message;return}i.profile.club_name=h,i.profile.club_color1=s.value,i.profile.club_color2=d.value,u.style.color="#2ecc71",u.textContent="✅ Modifications enregistrées.",ai()==="club"&&No("club")});const b=t.querySelector("#volume-slider"),g=t.querySelector("#volume-label");let x=null;b.addEventListener("input",()=>{Mn(Number(b.value)),g.textContent=`${b.value}%`,x&&(x.volume=Math.max(0,Math.min(1,Number(b.value)/100)))}),t.querySelector("#volume-test").addEventListener("click",()=>{x=to("/sounds/match-opening.mp3",1)}),t.querySelector("#settings-logout").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()})}const Oe={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Re(t,e){if(!t)return 0;let i=0;switch(e){case"GK":i=Number(t.note_g)||0;break;case"DEF":i=Number(t.note_d)||0;break;case"MIL":i=Number(t.note_m)||0;break;case"ATT":i=Number(t.note_a)||0;break;default:i=0}return i+(t.boost||0)}const Lo=["ATT","MIL","DEF","GK"];function an(t,e,i){if(!t||!e)return!1;if(i&&t.position&&e.position)return Ii(i).some(([c,p])=>c===t.position&&p===e.position||c===e.position&&p===t.position);const o=t._col!=null&&e._col!=null&&t._col===e._col,r=t._col!=null&&e._col!=null&&Math.abs(t._col-e._col)===1,n=Lo.indexOf(t._line||t.job),a=Lo.indexOf(e._line||e.job),l=Math.abs(n-a)===1;return(t._line||t.job)===(e._line||e.job)&&r||o&&l}function sn(t,e){let i=0;const o=t.length;for(let r=0;r<o;r++)for(let n=r+1;n<o;n++){const a=t[r],l=t[n];if(!a||!l||!an(a,l,e))continue;const s=Ft(a,l);s==="#00ff88"?i+=10:s==="#FFD700"&&(i+=5)}return i}function ci(t,e={},i){let o=0,r=0;t.forEach(s=>{const d=s._line||s.job,c=Number(d==="MIL"?s.note_m:s.note_a)||0,p=s.stadiumBonus&&(d==="MIL"||d==="ATT")?10:0;o+=e.doubleAttack?c*2:c,r+=(s.boost||0)+p});const n=o+r,a=sn(t,i);let l=n+a;return e.stolenNote&&(l-=e.stolenNote),{base:n,links:a,total:Math.max(0,l)}}function pi(t,e={},i){const o=t.reduce((a,l)=>{const s=l._line||l.job;let d=0;s==="GK"?d=Number(l.note_g)||0:s==="MIL"?d=Number(l.note_m)||0:d=Number(l.note_d)||0;const c=l.stadiumBonus&&(s==="GK"||s==="DEF"||s==="MIL")?10:0;return a+d+(l.boost||0)+c},0),r=sn(t,i);let n=o+r;return e.stolenNote&&(n-=e.stolenNote),{base:o,links:r,total:Math.max(0,n)}}function lo(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function dn(t,e,i="easy"){const o=t.filter(a=>!a.used);if(!o.length)return[];const r=[...o].sort((a,l)=>{const s=e==="attack"?Re(a,"ATT"):a._line==="GK"?Re(a,"GK"):Re(a,"DEF");return(e==="attack"?Re(l,"ATT"):l._line==="GK"?Re(l,"GK"):Re(l,"DEF"))-s});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return r.slice(0,Math.min(n,r.length,3))}function mr(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const gr={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},ei={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},mi=["GK","DEF","MIL","ATT"],xr=["Tous","GK","DEF","MIL","ATT"],br={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function So(t){const e=t.player;return e?(e.rarity,Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)):null}function yr(t){return t.length?t.reduce((e,i)=>So(i)>So(e)?i:e,t[0]):t[0]}const hr={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function gi(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Pi(t,e=""){const i=t.player;if(!i)return"";const o=t.evolution_bonus||0,r={...i,_evolution_bonus:o},n=e?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${e}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${t.id}">
    ${n}
    ${ze(r,{width:140})}
  </div>`}function To(t){return`<div style="display:inline-block;filter:grayscale(1);opacity:0.4">
    ${ze(t,{width:140})}
  </div>`}async function vr(t,e){const{state:i,navigate:o,toast:r,openModal:n,closeModal:a}=e;Yt(o,i.profile,"cards","/icons/",r),t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await v.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price, face,
        clubs(encoded_name, logo_url)),
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),{data:s}=await v.from("players").select(`id, firstname, surname_real, country_code, club_id, job, job2,
      note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length,
      clubs(encoded_name, logo_url)`).eq("is_active",!0),d=(l||[]).filter(q=>q.card_type==="player"&&q.player),c=(l||[]).filter(q=>q.card_type==="game_changer"),p=(l||[]).filter(q=>q.card_type==="formation"),b=(l||[]).filter(q=>q.card_type==="stadium"),{data:g}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(g||[]).forEach(q=>{x[q.name]=q});const{data:f}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),y={};(f||[]).forEach(q=>{y[q.id]=q}),b.forEach(q=>{q.stadium_def&&(y[q.stadium_id]=q.stadium_def)});const u=Object.keys(Ai),w=Object.keys(Oe),h={};d.forEach(q=>{const W=q.player.id;h[W]=(h[W]||0)+1}),new Set(Object.keys(h).map(q=>String(q)));const E=new Set(p.map(q=>q.formation)),m=new Set(c.map(q=>q.gc_type));let T="player",$="Tous",I="",D=!1,V=!1;function Y(){return[...d].sort((q,W)=>{const ee=mi.indexOf(q.player.job),ie=mi.indexOf(W.player.job);return ee!==ie?ee-ie:(q.player.surname_real||"").localeCompare(W.player.surname_real||"")})}function j(){return[...s||[]].sort((q,W)=>{const ee=mi.indexOf(q.job),ie=mi.indexOf(W.job);return ee!==ie?ee-ie:(q.surname_real||"").localeCompare(W.surname_real||"")})}function L(){return Y().filter(q=>{const W=q.player,ee=$==="Tous"||W.job===$,ie=!I||`${W.firstname} ${W.surname_real}`.toLowerCase().includes(I);return ee&&ie})}function _(){return j().filter(q=>{const W=$==="Tous"||q.job===$,ee=!I||`${q.firstname} ${q.surname_real}`.toLowerCase().includes(I);return W&&ee})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(x=document.getElementById("direct-sell-form-btn"))==null||x.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${d} pour ${xi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const u=b.find(h=>!h.is_for_sale)||b[0];if(!u){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",u.id),await v.from("transfer_history").delete().eq("card_id",u.id);const{error:w}=await v.from("cards").delete().eq("id",u.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+xi}).eq("id",r.profile.id),await s(),n(`+${xi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),l("collection")}),(f=document.getElementById("market-sell-form-btn"))==null||f.addEventListener("click",async()=>{const u=parseInt(document.getElementById("sell-price-form").value);if(!u||u<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:u}).eq("id",t.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:u}),n("Carte mise en vente sur le marché !","success"),a(),l("collection")}),(y=document.getElementById("cancel-sell-form-btn"))==null||y.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),l("collection")})}async function Io(t,e,i,o){var fe,xe,ge,de,q,W,ee,ie,X,R,J;const{state:r,toast:n,openModal:a,closeModal:l,navigate:s,refreshProfile:d}=o,c=t.player,p=e.filter(P=>P.player.id===c.id),b=p.length,g=t.evolution_bonus||0,x=Math.max((Number(c.note_g)||0)+(c.job==="GK"||c.job2==="GK"?g:0),(Number(c.note_d)||0)+(c.job==="DEF"||c.job2==="DEF"?g:0),(Number(c.note_m)||0)+(c.job==="MIL"||c.job2==="MIL"?g:0),(Number(c.note_a)||0)+(c.job==="ATT"||c.job2==="ATT"?g:0)),f=c.rarity||"normal",{data:y}=await v.from("sell_price_configs").select("*").eq("rarity",f).lte("note_min",x).gte("note_max",x).order("note_min",{ascending:!1}).limit(1),u=((fe=y==null?void 0:y[0])==null?void 0:fe.price)??br[f]??1e3,w=((xe=y==null?void 0:y[0])==null?void 0:xe.price_min)??null,h=((ge=y==null?void 0:y[0])==null?void 0:ge.price_max)??null;Bt(c);const E=gi(c,c.job)+g,m=c.job2?gi(c,c.job2)+(gi(c,c.job2)>0?g:0):null;ei[c.job],c.job2&&ei[c.job2];const T=gr[c.rarity]||"#ccc",$=hr[c.country_code]||c.country_code||"",I=t.evolution_bonus||0,V=E+I,Y=m||0,j=Y>0?Y+I:0,L=p.map(P=>P.id);let _={};if(L.length){const{data:P}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",L).order("transferred_at",{ascending:!0});(P||[]).forEach(U=>{_[U.card_id]||(_[U.card_id]=[]),_[U.card_id].push(U)})}const G=L.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${p.filter(P=>P.id!==t.id).map((P,U)=>{const ae=_[P.id]||[],ce=P.is_for_sale,be=ae.length?ae[ae.length-1]:null,ke=P.evolution_bonus||0,Ee=be?be.source==="booster"?"Booster":be.price?be.price.toLocaleString("fr")+" cr.":"—":"—",Se=be?new Date(be.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",ye=80,Le=Math.round(ye*657/507),De=ze({...c,_evolution_bonus:ke},{width:ye});return`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${V}${c.job2&&Y>0?` / ${j}`:""}`:`Note actuelle : ${V}${c.job2&&Y>0?` / ${j}`:""}`}
            </div>
          </div>
      ...
      <!-- Carte visuelle -->
      ${ze({...c,_evolution_bonus:g},{width:160})}
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px 16px;background:#f8f8f8;border-radius:10px;padding:10px 12px">
          ...
          <div>
            ...
            <div style="font-weight:700;font-size:13px;color:${ei[c.job]||"#333"}">${c.job}</div>
          </div>
          <div>
            <div style="font-size:10px;color:#999;letter-spacing:.5px">POSTE SECONDAIRE</div>
            <div style="font-weight:700;font-size:13px;color:${c.job2?ei[c.job2]||"#333":"#bbb"}">${c.job2||"Aucun"}</div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([P,U])=>{const ae=ei[P],ce=P==="GK"?"#fff":ae,be=P===c.job||P===c.job2,ke=(Number(U)||0)+(be&&I>0?I:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(q=document.getElementById("close-detail"))==null||q.addEventListener("click",l);let O=new Set;const le=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function pe(){let P=0;return document.querySelectorAll(".expl-check:checked").forEach(U=>{if(U.dataset.id===t.id)return;const ce=Number(U.dataset.evo)||0,be=Number(U.dataset.note)||0;P+=be+ce}),Math.round(P*le)}const M=()=>{const P=O.size,U=document.getElementById("sell-action-panel");if(!U)return;U.style.display=P>0?"block":"none",document.getElementById("sell-selected-count").textContent=P;const ae=document.getElementById("evolve-btn");if(ae){const ce=pe();ae.textContent=ce>0?`⬆️ Évoluer (+${ce})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(P=>{P.addEventListener("change",()=>{const U=P.dataset.id;P.checked?O.add(U):O.delete(U);const ae=P.closest(".exemplaire-row");if(ae){const ce=ae.querySelector(".expl-sel-overlay"),be=ae.querySelector(".expl-sel-check");ce&&(ce.style.display=P.checked?"block":"none"),be&&(be.style.display=P.checked?"flex":"none"),ae.style.transform=P.checked?"scale(1.05)":"scale(1)"}M()})}),document.querySelectorAll(".exemplaire-row").forEach(P=>{P.addEventListener("click",U=>{if(U.target.tagName==="INPUT")return;const ae=P.querySelector(".expl-check");ae&&!ae.disabled&&(ae.checked=!ae.checked,ae.dispatchEvent(new Event("change")))})}),(W=document.getElementById("evolve-btn"))==null||W.addEventListener("click",async()=>{if(b<=1)return;const P=[...O];if(!P.length)return;if(O.has(t.id)){const ye=document.createElement("div");ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ye.innerHTML=`
    ...
    </div>`,document.body.appendChild(o);const r=o.querySelector("#pm-input");r.focus(),r.select();const n=a=>{o.remove(),i(a)};o.querySelector("#pm-ok").addEventListener("click",()=>n(r.value.trim()||null)),o.querySelector("#pm-cancel").addEventListener("click",()=>n(null)),o.querySelector("#pm-cancel2").addEventListener("click",()=>n(null)),o.addEventListener("click",a=>{a.target===o&&n(null)}),r.addEventListener("keydown",a=>{a.key==="Enter"&&n(r.value.trim()||null),a.key==="Escape"&&n(null)})})}function kr(t,e=!1){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:380px">
        ...
        ${(n==null?void 0:n.length)>0?n.map(s=>`
          <div class="card-panel" data-open-deck="${s.id}"
            ...
            <div style="display:flex;align-items:center;gap:10px;flex:1;min-width:0">
              ${l[s.stadium_card_id]?`<img src="${l[s.stadium_card_id]}" style="width:32px;height:32px;object-fit:contain;border-radius:6px;flex-shrink:0;background:rgba(255,255,255,0.06)">`:'<div style="width:32px;height:32px;border-radius:6px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:16px;opacity:.4">🏟️</div>'}
              <div style="min-width:0">
                <div style="font-weight:700;font-size:15px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${s.name}</div>
                <div style="font-size:11px;color:var(--tile-fg-dim)">${s.formation||"—"}</div>
              </div>
            </div>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=await Ao("Nom du deck",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!s)return;const{data:d,error:c}=await v.from("decks").insert({owner_id:i.profile.id,name:s}).select().single();if(c){r(c.message,"error");return}r("Deck créé !","success"),zo(d.id,t,e)}),t.querySelectorAll("[data-open-deck]").forEach(s=>{s.addEventListener("click",()=>zo(s.dataset.openDeck,t,e))}),t.querySelectorAll("[data-rename]").forEach(s=>{s.addEventListener("click",async()=>{const d=await Ao("Nouveau nom",s.dataset.name);if(!d||d===s.dataset.name)return;const{error:c}=await v.from("decks").update({name:d}).eq("id",s.dataset.rename);if(c){r(c.message,"error");return}r("Deck renommé !","success"),Ui(t,e)})}),t.querySelectorAll("[data-delete]").forEach(s=>{s.addEventListener("click",async()=>{if(!await kr(`Supprimer le deck "${s.dataset.name}" ? Cette action est irréversible.`,!0))return;await v.from("deck_cards").delete().eq("deck_id",s.dataset.delete);const{error:d}=await v.from("decks").delete().eq("id",s.dataset.delete);if(d){r(d.message,"error");return}r("Deck supprimé.","success"),Ui(t,e)})})}async function zo(t,e,i){const{state:o,toast:r}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("*").eq("id",t).single(),{data:a}=await v.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length, face,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),{data:l}=await v.from("cards").select(`id, card_type, stadium_id,
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),s=(a||[]).filter(u=>u.card_type==="player"&&u.player),d=(a||[]).filter(u=>u.card_type==="formation"),c=(l||[]).filter(u=>u.card_type==="stadium"),p=[...new Set(c.map(u=>u.stadium_id).filter(Boolean))];let b={};if(c.forEach(u=>{u.stadium_def&&u.stadium_id&&(b[u.stadium_id]=u.stadium_def)}),p.length&&Object.keys(b).length<p.length){const{data:u}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",p);(u||[]).forEach(w=>{b[w.id]=w})}const g=d.map(u=>u.formation).filter(Boolean),{data:x}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let f=n.formation||"4-4-2";g.length>0&&!g.includes(f)&&(f=g[0]);const y={deckId:t,name:n.name,formation:f,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:s,formationCards:d,stadiumCards:c,stadDefMap:b,availableFormations:g};(x||[]).forEach(u=>{u.is_starter?y.slots[u.position]=u.card_id:y.subs.includes(u.card_id)||y.subs.push(u.card_id)}),$t(e,y,i,!0)}function $t(t,e,i,o=!1){var f,y;const{navigate:r}=i;o||Tr(e,i),ki[e.formation];const n=Mo(e.formation),a=n.filter(u=>e.slots[u]).length,l=e.availableFormations.length>0?e.availableFormations:Object.keys(ki),s=(f=e.stadiumCards)==null?void 0:f.find(u=>u.id===e.stadiumCardId),d=s&&((y=e.stadDefMap)==null?void 0:y[s.stadium_id])||null,c=e.subs.map(u=>e.playerCards.find(w=>w.id===u)).filter(Boolean);c.length!==e.subs.length&&(e.subs=c.map(u=>u.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${c.map(u=>{const w={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
                ${ze({...w,_evolution_bonus:w._evolution_bonus||0},{width:90,showStad:!0,stadDef:d})}
        ...
        <div style="width:130px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 8px;gap:12px;border-left:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="width:100%;text-align:center">
            ...
            <div id="add-stad-btn-pc" style="cursor:pointer;margin:0 auto;width:fit-content">
              ${s?(()=>{var h;const u=e.stadDefMap[s.stadium_id],w=((h=u==null?void 0:u.club)==null?void 0:h.logo_url)||(u==null?void 0:u.image_url)||(u!=null&&u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Ut((u==null?void 0:u.name)||"Stade",w,"+10 ⭐",{width:100})})():`<div style="width:100px;height:171px;border:2px dashed rgba(79,195,247,0.4);border-radius:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
        ...
        <div style="display:flex;gap:6px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${c.map(u=>{const w={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
                  ${ze({...w,_evolution_bonus:w._evolution_bonus||0},{width:44,showStad:!0,stadDef:d})}
                  <button data-remove-sub="${u.id}"
          ...
          <div style="flex-shrink:0;text-align:center">
            ...
            <div id="add-stad-btn" style="cursor:pointer">
              ${s?(()=>{var h;const u=e.stadDefMap[s.stadium_id],w=((h=u==null?void 0:u.club)==null?void 0:h.logo_url)||(u==null?void 0:u.image_url)||(u!=null&&u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return Ut((u==null?void 0:u.name)||"Stade",w,"+10⭐",{width:44})})():`<div style="width:44px;height:57px;border:2px dashed rgba(79,195,247,0.5);border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px">
    ...
    </div>`;u("⚽ Choisir une formation",E),document.querySelectorAll("#modal-body [data-forma]").forEach(m=>{m.addEventListener("click",()=>{e.formation=m.dataset.forma;const T=Mo(e.formation),$={};T.forEach(I=>{e.slots[I]&&($[I]=e.slots[I])}),e.slots=$,w(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Er(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>Ir(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(w=>w!==u.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>Sr(e,t,i)))}function $r(t,e,i,o){var h,E,m;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(h=e.stadiumCards)==null?void 0:h.find(T=>T.id===e.stadiumCardId),l=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,s=ut[e.formation]||{},d=Ii(e.formation)||[],c={};for(const T of i){const $=e.slots[T],I=$?e.playerCards.find(D=>D.id===$):null;I!=null&&I.player?c[T]={...I.player,_evolution_bonus:I.evolution_bonus||0,face:I.player.face||null}:c[T]=null}const p=window.innerWidth>=900,b=p?window.innerWidth-280:window.innerWidth-20,g=p?Math.min(b,860):b,x=Math.round(p?g*.82:g*.85),f=p?84:44;let y="";for(const[T,$]of d){const I=s[T],D=s[$];if(!I||!D)continue;const V=I.x*g,Y=Math.round(.03*x+I.y*.85*x),j=D.x*g,L=Math.round(.03*x+D.y*.85*x),_=c[T],G=c[$],O=Ft(_,G);O==="#ff3333"||O==="#cc2222"?y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let u="";const w=Math.round(f*657/507);for(const T of i){const $=s[T];if(!$)continue;const I=c[T],D=$.x*g;$.y*x;const V=Math.round(.03*x+$.y*(.85*x)),Y=Math.round(D-f/2),j=Math.round(V-w/2);if(I){const L=T.replace(/\d+/,""),_=l&&(l.club_id&&String(I.club_id)===String(l.club_id)||l.country_code&&I.country_code===l.country_code),G=ze({...I,_evolution_bonus:I._evolution_bonus||0},{width:f,showStad:!0,stadDef:l,role:L});_&&((m=l.club)!=null&&m.logo_url||l.image_url),u+=`<div style="position:absolute;left:${Y}px;top:${j}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${T}">
    ...
    <div style="position:relative;width:${g}px;height:${x}px;margin:0 auto">
      ...
      ${u}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(T=>{T.addEventListener("click",()=>Lr(T.dataset.pos,e,t,o))})}function Er(t,e,i){var l;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(s=>{const d=s.stadium_id||s.id;return n.has(d)?!1:(n.add(d),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${g.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+g.map(h=>{const E={...h.player,_evolution_bonus:h.evolution_bonus||0};return`<div class="player-option" data-card-id="${h.id}" style="cursor:pointer">
          ${ze(E,{width:100,showStad:!0,stadDef:s,role:a})}
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(u=document.getElementById("close-selector"))==null||u.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),$t(i,e,o)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{e.slots[t]=h.dataset.cardId,n(),$t(i,e,o)})})}function Sr(t,e,i){var c,p,b;const{openModal:o,closeModal:r}=i,n=(c=t.stadiumCards)==null?void 0:c.find(g=>g.id===t.stadiumCardId),a=n&&((p=t.stadDefMap)==null?void 0:p[n.stadium_id])||null,l=new Set;Object.keys(t.slots).forEach(g=>{var y;const x=t.slots[g];if(!x)return;const f=t.playerCards.find(u=>u.id===x);(y=f==null?void 0:f.player)!=null&&y.id&&l.add(f.player.id)}),t.subs.forEach(g=>{var f;const x=t.playerCards.find(y=>y.id===g);(f=x==null?void 0:x.player)!=null&&f.id&&l.add(x.player.id)});const s=new Set,d=t.playerCards.filter(g=>{var x,f,y;return l.has((x=g.player)==null?void 0:x.id)||s.has((f=g.player)==null?void 0:f.id)?!1:(s.add((y=g.player)==null?void 0:y.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${d.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+d.map(g=>{const x={...g.player,_evolution_bonus:g.evolution_bonus||0};return`<div class="player-option" data-card-id="${g.id}" style="cursor:pointer">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(b=document.getElementById("close-sub-selector"))==null||b.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{t.subs.push(g.dataset.cardId),r(),$t(e,t,i)})})}async function ln(t){const e=t.formationCards.find(r=>r.formation===t.formation),i=(e==null?void 0:e.id)||t.formationCardId;await v.from("decks").update({formation:t.formation,formation_card_id:i||null,stadium_card_id:t.stadiumCardId||null}).eq("id",t.deckId),await v.from("deck_cards").delete().eq("deck_id",t.deckId);const o=[];return Object.entries(t.slots).forEach(([r,n],a)=>{o.push({deck_id:t.deckId,card_id:n,position:r,is_starter:!0,slot_order:a})}),t.subs.forEach((r,n)=>{o.push({deck_id:t.deckId,card_id:r,position:`SUB${n+1}`,is_starter:!1,slot_order:100+n})}),o.length>0?await v.from("deck_cards").insert(o):{error:null}}let Ki=null;function Tr(t,e){const{toast:i}=e;clearTimeout(Ki),document.querySelectorAll(".autosave-indicator").forEach(r=>{r.textContent="⏳ Enregistrement...",r.style.opacity="1",r.style.color=""}),Ki=setTimeout(async()=>{const{error:r}=await ln(t),n=document.querySelectorAll(".autosave-indicator");if(r){n.forEach(a=>{a.textContent="⚠️ Erreur d'enregistrement",a.style.color="#ff6b6b"}),i(r.message,"error");return}n.forEach(a=>{a.textContent="✅ Enregistré",a.style.color="",setTimeout(()=>{a.style.opacity="0"},1500)})},600)}async function Ir(t,e){const{toast:i,navigate:o}=e;clearTimeout(Ki);const{error:r}=await ln(t);if(r){i(r.message,"error");return}i("Deck enregistré ✅","success"),o("decks")}function Mo(t){const e=ki[t]||ki["4-4-2"],i=["GK1"];for(let o=1;o<=e.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=e.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=e.ATT;o++)i.push(`ATT${o}`);return i}const Et={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Ar={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ct(t,e,i,o,r){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function Vi(t,e){var n,a;const i=t.player,o=t.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:t.id,position:e||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?o:0)+(i.job2==="GK"&&r>0?o:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?o:0)+(i.job2==="DEF"&&r>0?o:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?o:0)+(i.job2==="MIL"&&r>0?o:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?o:0)+(i.job2==="ATT"&&r>0?o:0),evolution_bonus:o,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function ui(t,e){if(!e||!t)return t;const{club_id:i,country_code:o}=e;return Object.values(t).forEach(r=>{Array.isArray(r)&&r.forEach(n=>{const a=i&&String(n.club_id)===String(i),l=o&&String(n.country_code)===String(o);(a||l)&&(n.stadiumBonus=!0)})}),t}function $i(t,e){if(!e||!(t!=null&&t.length))return t;const{club_id:i,country_code:o}=e;return t.forEach(r=>{if(!r)return;const n=i&&String(r.club_id)===String(i),a=o&&String(r.country_code)===String(o);(n||a)&&(r.stadiumBonus=!0)}),t}function lt(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function cn(){const t=Math.random()*100;return t<10?10:t<30?5:3}function Ei(t,e){const i=Et[e]||Et["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]};if(t.length&&t.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const l=t.filter(d=>d.position&&d.position.replace(/\d+$/,"")===a).sort((d,c)=>parseInt(d.position.replace(/\D+/g,""),10)-parseInt(c.position.replace(/\D+/g,""),10)).map(d=>({...d,_line:a})),s=lt(l.length);l.forEach((d,c)=>{d._col=s[c]}),o[a]=l}return o}const n=[...t];for(const a of["GK","DEF","MIL","ATT"]){const l=[];for(let d=0;d<i[a];d++){let c=n.findIndex(p=>p.job===a);if(c===-1&&(c=n.findIndex(p=>p.job2===a)),c===-1&&(c=0),n[c]){const p={...n[c],_line:a};l.push(p),n.splice(c,1)}}const s=lt(l.length);l.forEach((d,c)=>{d._col=s[c]}),o[a]=l}return o}function ct(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.setProperty("display","none","important"),e.dataset.matchHidden="1"}),t&&t.style.setProperty("padding-bottom","0","important")}function Ye(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.removeProperty("display"),delete e.dataset.matchHidden}),t&&t.style.removeProperty("padding-bottom")}function zi(t,e,i){const r=new Set,n=e.filter(c=>{var b;const p=((b=c._gcDef)==null?void 0:b.name)||c.gc_type||c.id;return r.has(p)?!1:(r.add(p),!0)});let a=[];function l(c,p){const b=c._gcDef,g=(b==null?void 0:b.name)||c.gc_type,x=b!=null&&b.image_url?`/icons/${b.image_url}`:null,f=nt(g,x,"⚡",(b==null?void 0:b.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${c.id}"
    ...
    </div>`}const s=c=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(c)};function d(){var p,b,g;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const c=a.length>0;t.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${n.map(x=>{const f=a.find(y=>y.gc_type===x.gc_type);return l(x,!!f)}).join("")}
      </div>
    ...
    </div>`,t.querySelectorAll(".gc-select-card").forEach(x=>{x.addEventListener("click",()=>{const f=x.dataset.id,y=n.find(w=>w.id===f);if(!y)return;const u=a.findIndex(w=>w.gc_type===y.gc_type);u>-1?a.splice(u,1):a.length<3&&a.push(y),d()})}),(p=t.querySelector("#gc-launch"))==null||p.addEventListener("click",()=>{c&&s(a)}),(b=t.querySelector("#gc-no-gc"))==null||b.addEventListener("click",()=>s([])),(g=t.querySelector("#gc-reset"))==null||g.addEventListener("click",()=>{a.length&&(a=[],d())})}d()}function zr(t,e){var r;const i=((r=e==null?void 0:e.state)==null?void 0:r.params)||{},o=t||i.matchMode||"vs_ai_easy";return o==="friend"?`Match vs ${i.friendName||"Ami"}`:o==="random"?"Match vs Random":o==="ranked"?"Match Classé":o==="mini_league"||o==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${o.replace("vs_ai_","").toUpperCase()}`}async function Mr(t,e,i){const{state:o,navigate:r}=e;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Ct(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=n.map(b=>b.id),{data:l}=await v.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),s=[...new Set((l||[]).filter(b=>{var g,x;return((g=b.card)==null?void 0:g.card_type)==="stadium"&&((x=b.card)==null?void 0:x.stadium_id)}).map(b=>b.card.stadium_id))],d={};if(s.length){const{data:b}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",s);(b||[]).forEach(g=>{d[g.id]=g}),(l||[]).forEach(g=>{var x,f;((x=g.card)==null?void 0:x.card_type)==="stadium"&&((f=g.card)!=null&&f.stadium_id)&&(g.card._stadiumDef=d[g.card.stadium_id]||null)})}let c=0;function p(){var m,T,$,I,D,V,Y;const b=n[c],g=(l||[]).filter(j=>j.deck_id===b.id),x=g.filter(j=>{var L;return j.is_starter&&((L=j.card)==null?void 0:L.player)}).map(j=>Vi(j.card,j.position)),f=g.find(j=>{var L;return((L=j.card)==null?void 0:L.card_type)==="formation"}),y=b.formation||((m=f==null?void 0:f.card)==null?void 0:m.formation)||"4-4-2";let u=x.length>=11?Ei(x,y):null,w=((T=b.stadium_card)==null?void 0:T.stadium_def)||null;w&&u&&(u=ui(u,w));const h=x.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        <div style="padding:8px 16px;background:rgba(0,0,0,0.4);text-align:center">
          <div style="font-size:10px;opacity:.6;letter-spacing:2px;text-transform:uppercase">${zr(i,e)}</div>
      ...
      <!-- Pagination -->
      ${n.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${n.map((j,L)=>`<div style="width:6px;height:6px;border-radius:50%;background:${L===c?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function j(){const L=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!L||!_||!u)return;const G=_.clientWidth>=900,O=Math.max(200,_.clientHeight-(G?60:40)),pe=Math.max(200,_.clientWidth-16),M=G?Math.min(117,Math.max(52,Math.round(pe*.22))):Math.max(44,Math.round(pe*.168));if(O<220||pe<220){requestAnimationFrame(j);return}const H=G?null:Math.round(M*.55);L.innerHTML=Kt(u,y,null,[],pe,O,[],H),L.style.cssText=`width:${pe}px;height:${O}px;overflow:hidden;margin:${G?0:60}px auto 0`;const fe=L.querySelector("svg");fe&&(fe.style.cssText="display:block;width:100%;height:100%",fe.setAttribute("preserveAspectRatio",G?"xMidYMid meet":"none"))})),(I=document.getElementById("prev-deck"))==null||I.addEventListener("click",()=>{c>0&&(c--,p())}),(D=document.getElementById("next-deck"))==null||D.addEventListener("click",()=>{c<n.length-1&&(c++,p())}),(V=document.getElementById("validate-deck"))==null||V.addEventListener("click",()=>{if(!h)return;const j=e.state.params||{};e.navigate("match",{...j,matchMode:j.matchMode||i,deckId:b.id})}),(Y=document.getElementById("cancel-deck-select"))==null||Y.addEventListener("click",()=>{Ye(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let j=0,L=0;E.addEventListener("touchstart",_=>{j=_.touches[0].clientX,L=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const G=_.changedTouches[0].clientX-j,O=_.changedTouches[0].clientY-L;Math.abs(G)<40||Math.abs(G)<Math.abs(O)||(G<0&&c<n.length-1?(c++,p()):G>0&&c>0&&(c--,p()))},{passive:!0})}}p()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((l,s)=>{const d=l._line||l.job||"MIL";let c=l.boost||0;if(l.stadiumBonus&&(o==="attack"&&(d==="ATT"||d==="MIL")||o==="defense"&&(d==="GK"||d==="DEF"||d==="MIL")?c+=10:o||(c+=10)),a+=ze({...l,_evolution_bonus:0,evolution_bonus:0},{width:40,role:d,extraNote:c}),s<n.length-1){const p=n[s+1],b=an(l,p,r)?Ft(l,p):null;a+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Mi(t,e,i,o,r=310,n=310,a=[],l=null){const s=ut[e]||{},d=Ii(e)||Ai[e]||[],c={},p=["ATT","MIL","DEF","GK"];for(const u of p)(t[u]||[]).forEach((h,E)=>{c[`${u}${E+1}`]=h});function b(u){const w=s[u];return w?{x:w.x*r,y:w.y*n}:null}let g="";for(const[u,w]of d){const h=b(u),E=b(w);if(!h||!E)continue;const m=c[u],T=c[w],$=Ft(m,T);$==="#00ff88"||$==="#FFD700"?(g+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const x=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),f=Math.round(x*657/507);for(const[u,w]of Object.entries(c)){const h=b(u);if(!h||!w)continue;const E=u.replace(/[0-9]/g,""),m=a.includes(w.cardId),T=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,$=o.includes(w.cardId);let I=w.boost||0,D=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(I+=10,D=!0):i||(I+=10,D=!0));const V=Math.round(h.x-x/2),Y=Math.round(h.y-f/2);if(w.used){g+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${V}" y="${Y}" width="${x}" height="${f}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const j=ze({...w,_evolution_bonus:0,stadiumBonus:!1},{width:x,showStad:!1,stadDef:null,role:E,extraNote:I,_cardOffset:30,_forceStadColor:D}),L=$?`position:absolute;top:30px;left:0;width:${x}px;height:${f}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";g+=`<foreignObject x="${V-2}" y="${Y-30}" width="${x+8}" height="${f+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${j}
        ${$?`<div style="${L}"></div>`:""}
      </div>
    </foreignObject>`,T&&(g+=`<rect x="${V}" y="${Y}" width="${x}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const y=l!==null?l:Math.round(Math.max(x*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-y} ${-y} ${r+y*2} ${n+y*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${g}
  </svg>`}function Kt(t,e,i,o,r=300,n=300,a=[],l=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Mi(t,e,i,o,r,n,a,l)}
  </div>`}async function Ci(t,e,i,o){var T;const{state:r,navigate:n,toast:a}=e;ct(t);const l=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!l.deckId)return Mr(t,e,i);const s=l.deckId;let d,c,p,b;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",s).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",s).order("slot_order")]);d=$[0].data,p=$[0].error,c=$[1].data,b=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Ct(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(p||b){console.error("[Match] Erreur Supabase:",p||b),Ct(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const g=(c||[]).filter($=>{var I;return $.is_starter&&((I=$.card)==null?void 0:I.player)}).map($=>Vi($.card,$.position)),x=(c||[]).filter($=>{var I;return!$.is_starter&&((I=$.card)==null?void 0:I.player)}).map($=>Vi($.card,$.position));if(g.length<11){Ct(t,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>n("decks"));return}const f=(c||[]).find($=>{var I;return((I=$.card)==null?void 0:I.card_type)==="formation"}),y=(d==null?void 0:d.formation)||((T=f==null?void 0:f.card)==null?void 0:T.formation)||"4-4-2",{data:u,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(u||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(I=>I.name===$.gc_type||I.id===$.gc_definition_id))||null}));let m=null;if(d!=null&&d.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",d.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:I}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=I||null}}o({deckId:s,formation:y,starters:g,subsRaw:x,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function jt(){return Math.min(window.innerWidth-40,860)}function Ht(){return Math.round(jt()*1.1)}function pn(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Bt(t)}}function Cr(t,e,i,o="Adversaire"){Yo("/sounds/match-opening.mp3",.3);const r=jt(),n=Ht();return`
    ...
    </div>`}function un(t){var n,a,l;if(!t)return"";const e=s=>s?ze({...s,_evolution_bonus:0},{width:52,role:s._line||s.job,showStad:!!s.stadiumBonus,extraNote:s.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.85);pointer-events:none`;const l=(t||[]).slice(0,3).map(s=>ze({...s,_evolution_bonus:0},{width:Math.min(140,Math.round(window.innerWidth/4)),role:s._line||s.job,showStad:!!s.stadiumBonus})).join("");if(a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a),!document.getElementById("goal-anim-style")){const s=document.createElement("style");s.id="goal-anim-style",s.textContent=`
      @keyframes goalPop {
        from { transform: scale(0.5); opacity: 0; }
        to   { transform: scale(1);   opacity: 1; }
      }`,document.head.appendChild(s)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function jr(t,e,i){const o=document.getElementById("sub-anim-overlay");o&&o.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.8);pointer-events:none`;const n=Math.min(120,Math.round(window.innerWidth/4)),a=t?ze({...t,_evolution_bonus:0},{width:n,role:t._line||t.job}):"",l=e?ze({...e,_evolution_bonus:0},{width:n,role:e._line||e.job}):"";r.innerHTML=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function fn(t,e){const i=Re(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+fn(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Ft(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function Li(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const l=a<t.length-1?Ft(n,t[a+1]):null,s=!l||l==="#ff3333"||l==="#cc2222",d=l==="#00ff88"?"+10":l==="#FFD700"?"+5":"";return fn(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
          ...
          ${a<t.length-1?`<div class="duel-link duel-link-${o}" data-idx="${a}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${s?"rgba(255,255,255,0.12)":l};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${s?"none":`0 0 8px ${l}`}">
    ...
    </div>`}async function qr(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",l=o.soloLevel||1,s=r.replace("vs_ai_",""),d=r;let c=null;if(n){const{data:x}=await v.from("solo_levels").select("*").eq("level_number",l).maybeSingle();c=x||{level_number:l,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const p=o.rankedData||null,b=o.presetSetup||null;async function g({deckId:x,formation:f,starters:y,subsRaw:u,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let m=Ei(y,f);E&&(m=ui(m,E),$i(u,E));let T=null;if(a){const V=Dr(m),{jaune:Y,vert:j}=Fr(m,f),L=.9+Math.random()*.2;T={target_note_avg:Math.max(1,Math.round(V*L/16)),nb_liens_jaune:Y,nb_liens_vert:j,nb_joueurs_stade:E?3:0}}const $=n?await jo(f,c):a?await jo(f,T):await Br(f,s),I=$.lines||$,D=async V=>{try{const Y=d==="vs_ai_club"||d==="solo"||d==="ranked_ai"?"club":d,{data:j,error:L}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:Y,home_deck_id:x,status:"in_progress"}).select().single();if(L){console.error("[MatchIA] Erreur création match:",L),Ct(t,"⚠️","Impossible de créer le match ("+L.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&I&&(ui(I,_),$i($.subs||[],_));const G={gcDefs:h||[],matchId:j==null?void 0:j.id,mode:d,difficulty:s,formation:f,isSolo:n,soloLevel:l,soloLevelConfig:c,isRankedAI:a,rankedAIData:p,homeTeam:m,aiTeam:I,homeSubs:u,subsUsed:0,maxSubs:Math.min(u.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:V,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Pr(t,G,e)}catch(Y){console.error("[MatchIA] Exception launchMatch:",Y),Ct(t,"⚠️","Erreur au lancement du match : "+Y.message,"Retour",()=>e.navigate("home"))}};if(a&&b){D(b.gcCardsEnriched||[]);return}if(!w.length){D([]);return}zi(t,w,D)}catch(m){console.error("[MatchIA] Exception setup:",m),Ct(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}b?await g(b):await Ci(t,e,r,g)}async function Br(t,e){var y;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:mn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(u,w,h){var E,m;return n.add(u.id),{cardId:"ai-"+u.id+"-"+h,id:u.id,firstname:u.firstname,name:u.surname_real,country_code:u.country_code,club_id:u.club_id,job:u.job,job2:u.job2,note_g:Number(u.note_g)||0,note_d:Number(u.note_d)||0,note_m:Number(u.note_m)||0,note_a:Number(u.note_a)||0,rarity:u.rarity,skin:u.skin,hair:u.hair,hair_length:u.hair_length,face:u.face,clubName:((E=u.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=u.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const u of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===u&&!n.has($.id)),h=i.filter($=>$.job!==u&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[u];$++){const I=E[$];I&&m.push(a(I,u,$))}const T=lt(m.length);m.forEach(($,I)=>{$._col=T[I]}),r[u]=m}const s=i.filter(u=>!n.has(u.id)).slice(0,5).map((u,w)=>a(u,u.job,100+w)),{data:d}=await v.from("gc_definitions").select("*").eq("is_active",!0),p=[...d||[]].sort(()=>Math.random()-.5).slice(0,3).map((u,w)=>({id:"ai-gc-"+w,gc_type:u.name,name:u.name,icon:"⚡",effect_type:u.effect_type,effect_params:u.effect_params||{}})),b=Object.values(r).flat(),g={};b.forEach(u=>{u.club_id&&(g[u.club_id]=(g[u.club_id]||0)+1)});const x=(y=Object.entries(g).sort((u,w)=>w[1]-u[1])[0])==null?void 0:y[0];let f=null;if(x){const{data:u}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",x).single();u&&(f={club_id:u.id,country_code:null,name:u.encoded_name+" Stadium",club:{encoded_name:u.encoded_name,logo_url:u.logo_url}})}return{lines:r,subs:s,gcCards:p,stadiumDef:f}}function Dr(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Fr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((l,s)=>{i[`${a}${s+1}`]=l});const o=Ii(e)||Ai[e]||[];let r=0,n=0;for(const[a,l]of o){const s=i[a],d=i[l];if(!s||!d)continue;const c=Ft(s,d);c==="#00ff88"?n++:c==="#FFD700"&&r++}return{jaune:r,vert:n}}function Co(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function bi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(Co(r)-e)-Math.abs(Co(n)-e));return o.slice(0,Math.min(i,o.length))}async function jo(t,e){var j,L;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:mn(t),subs:[],gcCards:[],stadiumDef:null};const l={};a.forEach(_=>{_.club_id&&(l[_.club_id]=(l[_.club_id]||0)+1)});const s=((j=Object.entries(l).sort((_,G)=>G[1]-_[1])[0])==null?void 0:j[0])||null,d=s?a.filter(_=>_.club_id===s):[],c=((L=d[0])==null?void 0:L.country_code)||null,p=c?a.filter(_=>_.country_code===c&&_.club_id!==s):[],b=Math.min(d.length,Math.max(2,r+1),16),g=Math.min(p.length,Math.max(0,o),16-b),x=[],f=new Set;bi(d,i,b).forEach(_=>{x.push(_),f.add(_.id)}),bi(p,i,g).forEach(_=>{x.push(_),f.add(_.id)});const y=Math.max(0,16-x.length),u=a.filter(_=>!f.has(_.id));bi(u,i,y).forEach(_=>{x.push(_),f.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,G,O){var le,pe;return E.add(_.id),{cardId:"ai-"+_.id+"-"+O,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((le=_.clubs)==null?void 0:le.encoded_name)||null,clubLogo:((pe=_.clubs)==null?void 0:pe.logo_url)||null,boost:0,used:!1,_line:G}}for(const _ of["GK","DEF","MIL","ATT"]){const G=x.filter(H=>H.job===_&&!E.has(H.id)),O=x.filter(H=>H.job!==_&&!E.has(H.id)),le=[...G,...O],pe=[];for(let H=0;H<w[_];H++){const fe=le[H];fe&&pe.push(m(fe,_,H))}const M=lt(pe.length);pe.forEach((H,fe)=>{H._col=M[fe]}),h[_]=pe}let T=x.filter(_=>!E.has(_.id));if(T.length<5){const _=a.filter(G=>!E.has(G.id)&&!T.some(O=>O.id===G.id));T=T.concat(bi(_,i,5-T.length))}const $=T.slice(0,5).map((_,G)=>m(_,_.job,100+G)),{data:I}=await v.from("gc_definitions").select("*").eq("is_active",!0),V=[...I||[]].sort(()=>Math.random()-.5).slice(0,3).map((_,G)=>({id:"ai-gc-"+G,gc_type:_.name,name:_.name,icon:"⚡",effect_type:_.effect_type,effect_params:_.effect_params||{}}));let Y=null;if(n>0&&s){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",s).single();_&&(Y={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:V,stadiumDef:Y}}function mn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<e[n];s++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const l=lt(a.length);a.forEach((s,d)=>{s._col=l[d]}),i[n]=a}return i}function Pr(t,e,i){var r;Yo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const n=t.querySelector(".opponent-preview-wrap"),a=t.querySelector("#opponent-swipe-zone");if(!n||!a)return;const l=a.clientWidth>=900,s=Math.max(200,a.clientHeight-(l?8:40)),d=Math.max(200,a.clientWidth-(l?8:16)),c=l?null:Math.round(Math.max(44,Math.round(d*.168))*.55);n.innerHTML=Kt(e.aiTeam,e.formation,null,[],d,s,[],c),n.style.cssText=`width:${d}px;height:${s}px;overflow:hidden;flex-shrink:0`;const p=n.querySelector("svg");p&&(p.style.cssText="display:block;width:100%;height:100%",p.setAttribute("preserveAspectRatio",l?"xMidYMid meet":"none"))})),setTimeout(()=>Rr(t,e,i),5e3)}const We=t=>pn(t);function Rr(t,e,i){const o=e.homeTeam.MIL||[],r=e.aiTeam.MIL||[],n=e.stadiumDef||null,a=e.aiStadiumDef||null,l=vt(o,n)+wt(o),s=vt(r,a)+wt(r),d=l>=s;t.innerHTML=`
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:clamp(6px,1.5vh,20px);padding:clamp(8px,1.5vw,24px);background:#0a3d1e">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,E.style.transition="opacity .45s ease",E.style.opacity="1",E.style.pointerEvents="auto",(m=document.getElementById("start-match-btn"))==null||m.addEventListener("click",g))},600)},700)},2800)}function Ie(t,e,i){var V,Y,j,L,_,G,O,le,pe;const o=e.selected.map(M=>M.cardId),r=e.usedSubIds||[],n=e.homeSubs.filter(M=>!r.includes(M.cardId)),l=Object.values(e.homeTeam).flat().filter(M=>M.used).length>0&&n.length>0&&e.subsUsed<e.maxSubs,s=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(M=>!M.used),d=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(M=>!M.used),c=Vt(e.aiTeam),p=s.length===0&&d.length===0&&!c,b=(e.homeTeam.DEF||[]).filter(M=>!M.used),g=(e.homeTeam.GK||[]).filter(M=>!M.used);let x=[];e.phase==="attack"&&s.length===0&&(c?(x=b.map(M=>M.cardId),b.length===0&&(x=x.concat(g.map(M=>M.cardId)))):p&&(x=[...b,...g].map(M=>M.cardId))),e.log[e.log.length-1];const f=e.phase==="ai-attack"||e.phase==="ai-defense",y=e.phase==="attack",u=e.phase==="defense",w=e.phase==="finished",E=(e.homeSubs||[]).filter(M=>!(e.usedSubIds||[]).includes(M.cardId)).length>0&&e.subsUsed<e.maxSubs,m=y&&s.length===0&&x.length===0&&!E,T=e.gcCards.filter(M=>!e.usedGc.includes(M.id)),$=e.boostCard&&!e.boostUsed;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column",t.innerHTML=`
  <style>
  ...
  <div id="match-history-panel">
  ...
  </div>`;function I(){const M=t.querySelector(".match-screen");if(!M)return;const H=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);M.style.bottom="auto",M.style.height=H+"px",M.style.minHeight=H+"px",M.style.maxHeight=H+"px",M.style.overflow="hidden";const fe=t.querySelector("#mobile-action-bar"),xe=t.querySelector("#mobile-play-area");fe&&xe&&(xe.style.paddingBottom=fe.offsetHeight+"px")}if(I(),setTimeout(I,120),setTimeout(I,400),setTimeout(I,1e3),e._vvBound||(e._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",I),window.visualViewport.addEventListener("scroll",I)),window.addEventListener("resize",I)),function(){const H=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!H)return;const fe=H.closest("#match-terrain-wrap");fe&&(fe.style.cssText="position:relative;width:100%;height:100%;padding:0"),H.removeAttribute("width"),H.removeAttribute("height"),H.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",H.setAttribute("preserveAspectRatio","xMidYMid meet")}(),e._resizeBound||(e._resizeBound=!0,window.addEventListener("resize",()=>{const M=t.querySelector(".terrain-wrapper svg");if(M){const H=M.closest("#match-terrain-wrap");H&&(H.style.cssText="position:relative;width:100%;height:100%;padding:0"),M.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ve(),e.phase==="attack"||e.phase==="defense"){let M=!1,H=30;const fe=()=>document.getElementById("match-timer"),xe=()=>{const ge=fe();if(!ge)return;const de=String(Math.floor(H/60)).padStart(2,"0"),q=String(H%60).padStart(2,"0");ge.textContent=` ${de}:${q}`,ge.style.color=M?"#ff2222":"#ff9500",ge.style.fontWeight="900"};xe(),e._timerInt=setInterval(()=>{if(H--,H<0)if(!M)M=!0,H=15,xe(),Wo("/sounds/timer-urgent.mp3",.6);else{clearInterval(e._timerInt),e._timerInt=null,Ve(),e.homeScore=0,e.aiScore=3;const ge=document.createElement("div");ge.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",ge.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(ge),setTimeout(()=>{ge.remove(),_t(t,e,i)},2500)}else xe()},1e3)}(V=document.getElementById("match-quit"))==null||V.addEventListener("click",()=>{Ye(t),confirm("Abandonner ? Résultat : défaite 3-0")&&(e.homeScore=0,e.aiScore=3,_t(t,e,i))}),(Y=document.getElementById("view-ai"))==null||Y.addEventListener("click",()=>Qr(e,i)),(j=document.getElementById("toggle-history"))==null||j.addEventListener("click",()=>{var M;(M=document.getElementById("match-history-panel"))==null||M.classList.add("open")}),(L=document.getElementById("close-history"))==null||L.addEventListener("click",()=>{var M;(M=document.getElementById("match-history-panel"))==null||M.classList.remove("open")}),(_=document.getElementById("btn-action"))==null||_.addEventListener("click",()=>{e.selected.length!==0&&(y?Gr(t,e,i):u&&Or(t,e,i))}),(G=document.getElementById("btn-results"))==null||G.addEventListener("click",()=>_t(t,e,i)),(O=document.getElementById("btn-pass"))==null||O.addEventListener("click",()=>{if(e.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Yi(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="ai-attack",Ie(t,e,i),setTimeout(()=>po(t,e,i),800)}),t.querySelectorAll(".match-slot-hit").forEach(M=>{M.addEventListener("click",()=>Nr(M,e,t,i))}),t.querySelectorAll(".match-used-hit").forEach(M=>{M.addEventListener("click",()=>Ri(t,e,i,null,M.dataset.cardId))}),t.querySelectorAll(".gc-mini").forEach(M=>{y?M.addEventListener("click",()=>Yr(M.dataset.gcId,M.dataset.gcType,t,e,i)):(M.style.opacity="0.35",M.style.cursor="default",M.addEventListener("click",()=>Tt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(le=document.getElementById("boost-card"))==null||le.addEventListener("click",()=>Jr(t,e,i)),t.querySelectorAll(".sub-btn-col").forEach(M=>{M.addEventListener("click",()=>Ri(t,e,i,M.dataset.subId))}),(pe=document.getElementById("sub-btn-main"))==null||pe.addEventListener("click",()=>Ri(t,e,i))}function Nr(t,e,i,o){const r=t.dataset.cardId,n=t.dataset.role,a=e.selected.findIndex(l=>l.cardId===r);if(a!==-1)e.selected.splice(a,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const l=(e.homeTeam[n]||[]).find(s=>s.cardId===r);l&&e.selected.push({...l,_role:n,_line:n})}Ie(i,e,o)}function co(t,e,i){t.matchId&&v.from("matches").update({last_player_id:i}).eq("id",t.matchId).then(()=>{})}function Gr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ve(),co(e,i,i.state.profile.id);const o=e.selected.map(n=>{const a=(e.homeTeam[n._role]||[]).find(s=>s.cardId===n.cardId)||n,l=["GK","DEF"].includes(n._role);return{...a,_line:n._role,...l?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=ci(o,e.modifiers.home,e.formation);e.pendingAttack={...r,players:[...o],side:"home"},e.selected.forEach(n=>{const a=(e.homeTeam[n._role]||[]).find(l=>l.cardId===n.cardId);a&&(a.used=!0)}),e.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${e.selected.map(n=>n.name).join(", ")}`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",Ie(t,e,i),setTimeout(()=>Vr(t,e,i),1200)}function Or(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ve(),co(e,i,i.state.profile.id);const o=e.stadiumDef||null,r=e.selected.map(s=>{const d=(e.homeTeam[s._role]||[]).find(p=>p.cardId===s.cardId)||s,c=d.stadiumBonus||o&&(o.club_id&&String(d.club_id)===String(o.club_id)||o.country_code&&d.country_code===o.country_code)||!1;return{...d,_line:s._role,stadiumBonus:c}}),n=pi(r,e.modifiers.home,e.formation);e.selected.forEach(s=>{const d=(e.homeTeam[s._role]||[]).find(c=>c.cardId===s.cardId);d&&(d.used=!0)});const a=lo(e.pendingAttack.total,n.total,e.modifiers.home),l={type:"duel",title:"Défense",aiPlayers:(e.pendingAttack.players||[]).map(s=>We(s)),homePlayers:e.selected.map(s=>{const d=(e.homeTeam[s._role]||[]).find(c=>c.cardId===s.cardId)||s;return We(d)}),homeTotal:n.total,aiTotal:e.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)l.text="🛡️ Bouclier ! But annulé.",e.log.push(l);else if(a.goal){e.aiScore++,l.isGoal=!0,l.homeScored=!1,l.text=`⚽ BUT IA ! (${e.pendingAttack.total} > ${n.total})`,e.log.push(l),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Ie(t,e,i),tt(l.aiPlayers,e.homeScore,e.aiScore,!1,()=>{qt(t,e,i,"home-attack")});return}else l.text=`🧤 Défense réussie ! (${n.total} ≥ ${e.pendingAttack.total})`,e.log.push(l);e.selected=[],e.modifiers.home={},e.pendingAttack=null,qt(t,e,i,"home-attack")}function Hr(t){if(t.aiSubsUsed>=t.aiMaxSubs)return;const e=Object.values(t.aiTeam).flat().filter(s=>s.used);if(!e.length)return;const i=(t.aiSubs||[]).filter(s=>!t.aiUsedSubIds.includes(s.cardId));if(!i.length)return;const o=e[Math.floor(Math.random()*e.length)],r=i.find(s=>s.job===o.job)||i[0],n={...r,used:!1,_line:o._line,_col:o._col},a=t.aiTeam[o._line],l=a.findIndex(s=>s.cardId===o.cardId);l!==-1&&(a[l]=n),t.aiUsedSubIds.push(r.cardId),t.aiSubsUsed++,t.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${o.firstname} ${o.name}`,type:"info"})}function Ur(t,e){const i=t.effect_params||{},o=i.value||1,r=i.count||1,n=i.roles||[],a=i.target||"home";switch(t.effect_type){case"BOOST_STAT":{const s=Object.values(e.aiTeam).flat().filter(d=>!d.used&&(!n.length||n.includes(d._line))).sort(()=>Math.random()-.5).slice(0,r);s.forEach(d=>{d.boost=(d.boost||0)+o}),s.length&&e.log.push({text:`⚡ IA : +${o} sur ${s.length} joueur(s)`,type:"gc"});break}case"DEBUFF_STAT":{const l=a==="ai"?e.aiTeam:e.homeTeam,d=Object.values(l).flat().filter(c=>!c.used&&(!n.length||n.includes(c._line))).sort(()=>Math.random()-.5).slice(0,r);d.forEach(c=>{c.boost=(c.boost||0)-o}),d.length&&e.log.push({text:`🎯 IA : -${o} sur ${d.length} joueur(s)${a!=="ai"?" (vous)":""}`,type:"gc"});break}case"GRAY_PLAYER":{const l=a==="ai"?e.aiTeam:e.homeTeam,d=Object.values(l).flat().filter(c=>!c.used&&(!n.length||n.includes(c._line))).sort(()=>Math.random()-.5).slice(0,r);d.forEach(c=>{c.used=!0}),d.length&&e.log.push({text:`❌ IA : ${d.length} joueur(s)${a!=="ai"?" (vous)":""} exclu(s)`,type:"gc"});break}case"REVIVE_PLAYER":{const s=Object.values(e.aiTeam).flat().filter(d=>d.used).sort(()=>Math.random()-.5).slice(0,r);s.forEach(d=>{d.used=!1}),s.length&&e.log.push({text:`💫 IA : ${s.length} joueur(s) ressuscité(s)`,type:"gc"});break}case"REMOVE_GOAL":e.homeScore>0&&(e.homeScore--,e.log.push({text:"🚫 IA : votre dernier but est annulé !",type:"gc"}));break;case"ADD_GOAL_DRAW":e.homeScore===e.aiScore&&(e.aiScore++,e.log.push({text:"🎯 IA : but bonus (match nul) !",type:"gc"}));break;case"ADD_SUB":e.aiMaxSubs=(e.aiMaxSubs||3)+o,e.log.push({text:`🔄 IA : +${o} remplacement(s)`,type:"gc"});break}}function Kr(t){var o;if(!((o=t.aiGcCards)!=null&&o.length))return;const e=t.aiGcCards.filter(r=>!t.aiUsedGc.includes(r.id));if(!e.length||Math.random()>.5)return;const i=e[Math.floor(Math.random()*e.length)];t.aiUsedGc.push(i.id),i.effect_type?Ur(i,t):t.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function po(t,e,i){co(e,i,null),Hr(e),Kr(e);let o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(c=>!c.used),r=!1;if(!o.length){const c=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(b=>!b.used),p=Vt(e.homeTeam);if(p||c.length===0){const b=(e.aiTeam.DEF||[]).filter(x=>!x.used),g=(e.aiTeam.GK||[]).filter(x=>!x.used);o=p?b.length?b:g:[...b,...g],r=!0}}const n=dn(o,"attack",e.difficulty);if(!n.length){Wi(t,e,i);return}r&&n.forEach(c=>{c._line=c._line||c.job,c.note_a=Math.max(1,Number(c.note_a)||0)});const a=ci(n,e.modifiers.ai,e.formation);e.pendingAttack={...a,players:n,side:"ai"},n.forEach(c=>{c.used=!0}),e.log.push({text:`🤖 IA attaque : ${a.total} (${n.map(c=>c.name).join(", ")})`,type:"info"}),e.modifiers.ai={};const l=[...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(c=>!c.used),d=(e.homeSubs||[]).filter(c=>!(e.usedSubIds||[]).includes(c.cardId)).length>0&&e.subsUsed<e.maxSubs;if(l.length===0&&!d){if(n.length===1&&(n[0]._line==="GK"||n[0].job==="GK")&&Vt(e.homeTeam)&&e.homeScore===e.aiScore){e.aiScore++,Si(t,e,i,"ai",n[0]);return}e.aiScore++;const p={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:n.map(b=>We(b)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};e.log.push(p),e.pendingAttack=null,Ie(t,e,i),tt(p.aiPlayers,e.homeScore,e.aiScore,!1,()=>{qt(t,e,i,"home-attack")});return}e.phase="defense",Ie(t,e,i)}function Vr(t,e,i){var d,c;const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],r=dn(o,"defense",e.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(p=>(e.aiTeam[p]||[]).filter(b=>!b.used)).length){const p=((d=e.pendingAttack)==null?void 0:d.players)||[];if(p.length===1&&(p[0]._line==="GK"||p[0].job==="GK")&&e.homeScore===e.aiScore){e.homeScore++,Si(t,e,i,"home",p[0]);return}e.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:p.map(x=>We(x)),homeTotal:((c=e.pendingAttack)==null?void 0:c.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};e.log.push(g),e.modifiers.ai={},e.pendingAttack=null,Ie(t,e,i),tt(g.homePlayers,e.homeScore,e.aiScore,!0,()=>{qt(t,e,i,"ai-attack")});return}const a=r.length>0?pi(r,e.modifiers.ai,e.formation).total:0;r.forEach(p=>{p.used=!0});const l=lo(e.pendingAttack.total,a,e.modifiers.ai),s={type:"duel",title:"Attaque",homePlayers:(e.pendingAttack.players||[]).map(p=>We(p)),aiPlayers:r.map(p=>We(p)),homeTotal:e.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(l.shielded)s.text="🛡️ Bouclier IA !",e.log.push(s);else if(l.goal){e.homeScore++,s.isGoal=!0,s.homeScored=!0,s.text=`⚽ BUT ! (${e.pendingAttack.total} > ${a})`,e.log.push(s),e.modifiers.ai={},e.pendingAttack=null,Ie(t,e,i),tt(s.homePlayers,e.homeScore,e.aiScore,!0,()=>{qt(t,e,i,"ai-attack")});return}else s.text=`🧤 IA défend (${a} ≥ ${e.pendingAttack.total})`,e.log.push(s);e.modifiers.ai={},e.pendingAttack=null,qt(t,e,i,"ai-attack")}function qt(t,e,i,o){if(e.round++,!gn(t,e,i)){if(uo(e)){_t(t,e,i);return}if(o==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(a=>!a.used))){Wi(t,e,i);return}e.phase="attack",Ie(t,e,i)}else{if(!["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(a=>!a.used))){Wi(t,e,i);return}e.phase="ai-attack",Ie(t,e,i),setTimeout(()=>po(t,e,i),800)}}}function Vt(t){return!["GK","DEF","MIL","ATT"].some(e=>(t[e]||[]).some(i=>!i.used))}function qo(t){const e=(t.GK||[]).some(o=>!o.used),i=["DEF","MIL","ATT"].some(o=>(t[o]||[]).some(r=>!r.used));return e&&!i}function gn(t,e,i){if(e.homeScore!==e.aiScore)return!1;if(qo(e.homeTeam)&&Vt(e.aiTeam)){const o=(e.homeTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.homeScore++,Si(t,e,i,"home",o),!0):!1}if(qo(e.aiTeam)&&Vt(e.homeTeam)){const o=(e.aiTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.aiScore++,Si(t,e,i,"ai",o),!0):!1}return!1}function Si(t,e,i,o,r){e.log.push({type:"duel",isGoal:!0,homeScored:o==="home",homePlayers:o==="home"?[We(r)]:[],aiPlayers:o==="ai"?[We(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${o==="home"?"":"adverse "}marque !`});const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(n);const a=(l,s)=>new Promise(d=>{n.innerHTML=`<div style="font-size:32px;font-weight:900;color:${s};letter-spacing:2px;animation:lcFade 1.4s ease both">${l}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(d,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),n.remove(),e.pendingAttack=null,Ie(t,e,i),tt([We(r)],e.homeScore,e.aiScore,o==="home",()=>{if(uo(e)){_t(t,e,i);return}qt(t,e,i,o==="home"?"ai-attack":"home-attack")})))()}function uo(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used));return!e&&!i}function Yi(t,e){return!(["MIL","ATT"].some(r=>(t[r]||[]).some(n=>!n.used))||Vt(e)||!["MIL","ATT"].some(r=>(e[r]||[]).some(n=>!n.used)))}function Wi(t,e,i){if(!gn(t,e,i)){if(uo(e)){_t(t,e,i);return}if(Yi(e.homeTeam,e.aiTeam)&&Yi(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="attack",Ie(t,e,i)}}function Ri(t,e,i,o=null,r=null){var g,x;if(e.phase!=="attack"){Tt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(e.usedSubIds||(e.usedSubIds=[]),e.subsUsed>=e.maxSubs){Tt(`Maximum ${e.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const n=Object.entries(e.homeTeam).flatMap(([f,y])=>(y||[]).filter(u=>u.used).map(u=>({...u,_line:u._line||f}))),a=e.homeSubs.filter(f=>!e.usedSubIds.includes(f.cardId));if(!n.length){Tt("Aucun joueur utilisé à remplacer");return}if(!a.length){Tt("Aucun remplaçant disponible");return}let l=Math.max(0,n.findIndex(f=>f.cardId===r));const s=((g=n[l])==null?void 0:g._line)||((x=n[l])==null?void 0:x.job);let d=o?Math.max(0,a.findIndex(f=>f.cardId===o)):Math.max(0,a.findIndex(f=>f.job===s)),c=!1;const p=document.createElement("div");p.id="sub-overlay",p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function b(){var m,T,$,I,D,V;const f=n[l],y=a[d],u=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(u*1.35),h=Y=>`background:rgba(255,255,255,0.12);border:none;color:${Y?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Y?"default":"pointer"};flex-shrink:0`;p.innerHTML=`
    ...
    </div>`,(m=p.querySelector("#sub-close"))==null||m.addEventListener("click",()=>p.remove()),(T=p.querySelector("#out-up"))==null||T.addEventListener("click",()=>{l>0&&(l--,b())}),($=p.querySelector("#out-down"))==null||$.addEventListener("click",()=>{l<n.length-1&&(l++,b())}),(I=p.querySelector("#in-up"))==null||I.addEventListener("click",()=>{d>0&&(d--,b())}),(D=p.querySelector("#in-down"))==null||D.addEventListener("click",()=>{d<a.length-1&&(d++,b())});const E=(Y,j,L,_)=>{const G=p.querySelector("#"+Y);if(!G)return;let O=0;G.addEventListener("touchstart",le=>{O=le.touches[0].clientY},{passive:!0}),G.addEventListener("touchend",le=>{const pe=le.changedTouches[0].clientY-O;if(Math.abs(pe)<30)return;const M=j();pe<0&&M<_-1?(L(M+1),b()):pe>0&&M>0&&(L(M-1),b())},{passive:!0})};E("in-panel",()=>d,Y=>d=Y,a.length),E("out-panel",()=>l,Y=>l=Y,n.length),(V=p.querySelector("#sub-confirm"))==null||V.addEventListener("click",Y=>{if(Y.preventDefault(),Y.stopPropagation(),c)return;c=!0;const j=n[l],L=a[d];if(!j||!L)return;let _=null,G=-1;for(const[le,pe]of Object.entries(e.homeTeam)){const M=(pe||[]).findIndex(H=>H.cardId===j.cardId);if(M!==-1){_=le,G=M;break}}if(G===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),p.remove();return}const O={...L,_line:_,_col:j._col||0,used:!1,boost:0};e.homeTeam[_].splice(G,1,O),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(L.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:j.name,firstname:j.firstname,note:Re(j,_),portrait:Bt(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},inPlayer:{name:L.name,firstname:L.firstname,note:Re(L,_),portrait:Bt(L),job:L.job,country_code:L.country_code,rarity:L.rarity,clubName:L.clubName,clubLogo:L.clubLogo},text:`🔄 ${L.firstname} ${L.name} remplace ${j.firstname} ${j.name}`}),p.remove(),jr(j,L,()=>Ie(t,e,i))})}document.body.appendChild(p),b()}function Yr(t,e,i,o,r){var b,g;const n=(o.gcDefs||[]).find(x=>x.name===e),a=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},l=(n==null?void 0:n.name)||e,s=(n==null?void 0:n.effect)||a.desc,d=n!=null&&n.image_url?`/icons/${n.image_url}`:null,c=a.icon||"⚡",p=document.createElement("div");p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",p.innerHTML=`
    ${nt(l,d,c,s,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(p),(b=p.querySelector("#gc-back"))==null||b.addEventListener("click",()=>p.remove()),(g=p.querySelector("#gc-use"))==null||g.addEventListener("click",()=>{p.remove(),Xr(t,e,i,o,r)})}function yi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let l=[];function s(){var d,c;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(p=>{const b=p._line||p.job||"MIL",g=l.find(f=>f.cardId===p.cardId),x=ze({...p,_evolution_bonus:0},{width:90,showStad:!0,role:b,extraNote:p.boost||0});return`<div class="gc-pick-item" data-cid="${p.cardId}"
    ...
    </div>`,(d=a.querySelector("#gc-picker-close"))==null||d.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(p=>{p.addEventListener("click",()=>{const b=p.dataset.cid,g=t.find(f=>f.cardId===b);if(!g)return;const x=l.findIndex(f=>f.cardId===b);x>-1?l.splice(x,1):l.length<e&&l.push(g),s()})}),(c=a.querySelector("#gc-picker-confirm"))==null||c.addEventListener("click",()=>{a.remove(),n(l)})}s(),document.body.appendChild(a)}const Wr={BOOST_STAT:({value:t=1,count:e=1,roles:i=[]},o,r,n)=>{const a=Object.entries(o.homeTeam).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,s])=>s.filter(d=>!d.used).map(d=>({...d,_line:l})));return a.length?(yi(a,e,`Choisir ${e} joueur(s) à booster (+${t})`,r,o,l=>{l.forEach(s=>{const d=(o.homeTeam[s._line]||[]).find(c=>c.cardId===s.cardId);d&&(d.boost=(d.boost||0)+t,o.log.push({text:`⚡ +${t} sur ${d.name}`,type:"info"}))}),Ie(r,o,n)}),!0):(o.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Ie(r,o,n),!0)},DEBUFF_STAT:({value:t=1,count:e=1,roles:i=[],target:o="ai"},r,n,a)=>{const l=o==="home"?r.homeTeam:r.aiTeam,s=o==="ai"?"adverse":"allié",d=Object.entries(l).filter(([c])=>!i.length||i.includes(c)).flatMap(([c,p])=>p.filter(b=>!b.used).map(b=>({...b,_line:c})));return d.length?(yi(d,e,`Choisir ${e} joueur(s) ${s}(s) à débuffer (-${t})`,n,r,c=>{c.forEach(p=>{const g=((o==="home"?r.homeTeam:r.aiTeam)[p._line]||[]).find(x=>x.cardId===p.cardId);g&&(g.boost=(g.boost||0)-t,r.log.push({text:`🎯 -${t} sur ${g.name}${o==="ai"?" (IA)":""}`,type:"info"}))}),Ie(n,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${s} disponible`,type:"info"}),Ie(n,r,a),!0)},GRAY_PLAYER:({count:t=1,roles:e=[],target:i="ai"},o,r,n)=>{const a=i==="home"?o.homeTeam:o.aiTeam,l=i==="ai"?"adverse":"allié",s=Object.entries(a).filter(([d])=>!e.length||e.includes(d)).flatMap(([d,c])=>c.filter(p=>!p.used).map(p=>({...p,_line:d})));return s.length?(yi(s,t,`Choisir ${t} joueur(s) ${l}(s) à exclure`,r,o,d=>{d.forEach(c=>{const b=((i==="home"?o.homeTeam:o.aiTeam)[c._line]||[]).find(g=>g.cardId===c.cardId);b&&(b.used=!0,o.log.push({text:`❌ ${b.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Ie(r,o,n)}),!0):(o.log.push({text:`❌ Aucun joueur ${l} à exclure`,type:"info"}),Ie(r,o,n),!0)},REVIVE_PLAYER:({count:t=1,roles:e=[]},i,o,r)=>{const n=Object.entries(i.homeTeam).filter(([a])=>!e.length||e.includes(a)).flatMap(([a,l])=>l.filter(s=>s.used).map(s=>({...s,_line:a})));return n.length?(yi(n,t,`Choisir ${t} joueur(s) à ressusciter`,o,i,a=>{a.forEach(l=>{const s=(i.homeTeam[l._line]||[]).find(d=>d.cardId===l.cardId);s&&(s.used=!1,i.log.push({text:`💫 ${s.name} ressuscité !`,type:"info"}))}),Ie(o,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Ie(o,i,r),!0)},REMOVE_GOAL:({},t)=>(t.aiScore>0?(t.aiScore--,t.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):t.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},t)=>(t.homeScore===t.aiScore?(t.homeScore++,t.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):t.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:t=1},e)=>(e.maxSubs=(e.maxSubs||3)+t,e.log.push({text:`🔄 +${t} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Xr(t,e,i,o,r){o.usedGc.push(t);const n=o.gcDefs||[],a=n.find(s=>s.name===e)||n.find(s=>{var d;return((d=s.name)==null?void 0:d.toLowerCase().trim())===(e==null?void 0:e.toLowerCase().trim())});let l=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const s=Wr[a.effect_type];s?s(a.effect_params||{},o,i,r)||(l=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),l=!0)}else{switch(e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const s=Object.entries(o.homeTeam).flatMap(([d,c])=>(c||[]).filter(p=>p.used).map(p=>({...p,_line:d})));s.length?(s[0].used=!1,o.log.push({text:`💫 ${s[0].name} ressuscité !`,type:"info"})):o.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const s=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(d=>!d.used);if(s.length){const d=s.sort((c,p)=>Re(p,"ATT")-Re(c,"ATT"))[0];d.used=!0,o.log.push({text:`❄️ ${d.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}l=!0}v.from("cards").delete().eq("id",t).then(()=>{}),l&&Ie(i,o,r)}function Jr(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Ar[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Re(r,r._line||r.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const l=(e.homeTeam[a]||[]).find(s=>s.cardId===n);if(l){l.boost=(l.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Ie(t,e,i)})})}async function _t(t,e,i){var b,g,x,f;Ot(),Ve(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",l=e.isSolo&&((b=e.soloLevelConfig)!=null&&b.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):mr(e.mode,a);if(e.isSolo&&r)try{const{data:y}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),u=(y==null?void 0:y.unlocked_level)||1;e.soloLevel>=u&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(y){console.warn("[Solo] Erreur mise à jour progression:",y.message)}const s="00000000-0000-0000-0000-000000000000";let d=null;if(e.isRankedAI)try{const{data:y}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(y){const u=y.mmr??1e3,w=y.mmr_deviation??350,h=y.mmr_volatility??.06,E=r?1:n?.5:0,m=(y.placement_matches??0)<10,T=Uo(u,w,h,u,350,E,m),$=n?null:r?o.profile.id:s;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:s,p_home_delta:T.delta,p_away_delta:0,p_home_new_rd:T.newRd,p_away_new_rd:350,p_home_new_vol:T.newSigma,p_away_new_vol:.06}),d=T.delta}}catch(y){console.warn("[RankedAI] Erreur mise à jour MMR:",y.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",e.matchId);const c={credits:(o.profile.credits||0)+l,matches_played:(o.profile.matches_played||0)+1};r?c.wins=(o.profile.wins||0)+1:n?c.draws=(o.profile.draws||0)+1:c.losses=(o.profile.losses||0)+1,await v.from("users").update(c).eq("id",o.profile.id),await i.refreshProfile();const p=document.createElement("div");p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",p.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
      ...
      ${Mi(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            </div>`}}catch(te){console.error("[Ranked] MMR update error:",te)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const B=document.createElement("div");B.id="pvp-end-overlay",B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const F=A?"🤝":C?"🏆":"😞",K=A?"MATCH NUL":C?"VICTOIRE !":"DÉFAITE",Z=A?"#fff":C?"#FFD700":"#ff6b6b";B.innerHTML=`
      ...
      <div style="font-size:18px">${m[f+"Name"]} ${S} – ${z} ${m[y+"Name"]}</div>
      ${k.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${C?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${N}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${c?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(B),(oe=B.querySelector("#pvp-end-home"))==null||oe.addEventListener("click",()=>{B.remove(),Ye(t),c?g("mini-league",{openLeagueId:c}):g(a?"ranked":"home")})}const j=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{var z;const S=k.new;try{if(S.status==="finished"||S.forfeit){if(T)return;T=!0,$&&(clearInterval($),$=null),Ve(),S.game_state&&(m=S.game_state),Y(S);return}if(S.game_state){const C=m;m=S.game_state;const A=m._lastGC;if(A&&A.seq&&!V.has(A.seq)&&(V.add(A.seq),A.by!==f)){de(A.type,A.by,()=>H());return}const N=C[f+"Score"]||0,B=C[y+"Score"]||0,F=m[f+"Score"]||0,K=m[y+"Score"]||0,Z=F>N,ne=K>B;if((Z||ne)&&!D.has(m.round)){D.add(m.round);const oe=[...m.log||[]].reverse().find(ue=>ue.isGoal),te=((oe==null?void 0:oe.homePlayers)||[]).map(ue=>({name:ue.name,note:ue.note,portrait:ue.portrait,job:ue.job}));!!((z=oe==null?void 0:oe.text)!=null&&z.includes("DERNIER CORNER"))?ae().then(()=>{tt(te,F,K,Z,()=>H())}):tt(te,F,K,Z,()=>H());return}H()}}catch(C){console.error("[PvP] crash:",C)}}).subscribe();async function L(k){Object.assign(m,k),m.lastActionAt=new Date().toISOString();const{error:S}=await v.from("matches").update({game_state:m}).eq("id",i);S&&x("Erreur de synchronisation","error");try{H()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function _(){if(T)return;T=!0,Ot(),Ve(),$&&(clearInterval($),$=null);const k=o?h.away_id:h.home_id,S=o?"p2":"p1",z=o?"p1":"p2",C={...m,[S+"Score"]:3,[z+"Score"]:0,phase:"finished"},A=C.p1Score||0,N=C.p2Score||0;try{await v.from("matches").update({game_state:C}).eq("id",i);const{data:B,error:F}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:A,p_away_score:N,p_forfeit:!0});if(F&&console.error("[PvP] finish_pvp_match (forfeit):",F),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await v.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{v.removeChannel(j)}catch{}setTimeout(()=>{Ye(t),c?g("mini-league",{openLeagueId:c}):g("home")},800)}const G={BOOST_STAT:({value:k=1,count:S=1,roles:z=[]},C,A)=>{const N=C[f+"Team"],B=Object.entries(N).filter(([F])=>!z.length||z.includes(F)).flatMap(([F,K])=>K.filter(Z=>!Z.used).map(Z=>({...Z,_line:F})));if(!B.length){C.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),A(C);return}O(B,S,`Choisir ${S} joueur(s) à booster (+${k})`,F=>{F.forEach(K=>{const Z=(N[K._line]||[]).find(ne=>ne.cardId===K.cardId);Z&&(Z.boost=(Z.boost||0)+k,C.log.push({text:`⚡ +${k} sur ${Z.name}`,type:"info"}))}),C[f+"Team"]=N,A(C)})},DEBUFF_STAT:({value:k=1,count:S=1,roles:z=[],target:C="ai"},A,N)=>{const B=C==="home"?f:y,F=A[B+"Team"],K=C==="home"?"allié":"adverse",Z=Object.entries(F).filter(([ne])=>!z.length||z.includes(ne)).flatMap(([ne,oe])=>oe.map(te=>({...te,_line:ne})));if(!Z.length){A.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),N(A);return}O(Z,S,`Choisir ${S} joueur(s) ${K}(s) (-${k})`,ne=>{ne.forEach(oe=>{const te=(F[oe._line]||[]).find(se=>se.cardId===oe.cardId);te&&(te.boost=(te.boost||0)-k,A.log.push({text:`🎯 -${k} sur ${te.name}`,type:"info"}))}),A[B+"Team"]=F,N(A)})},GRAY_PLAYER:({count:k=1,roles:S=[],target:z="ai"},C,A)=>{const N=z==="home"?f:y,B=C[N+"Team"],F=z==="home"?"allié":"adverse",K=Object.entries(B).filter(([Z])=>!S.length||S.includes(Z)).flatMap(([Z,ne])=>ne.filter(oe=>!oe.used).map(oe=>({...oe,_line:Z})));if(!K.length){C.log.push({text:`❌ Aucun joueur ${F}`,type:"info"}),A(C);return}O(K,k,`Choisir ${k} joueur(s) ${F}(s) à exclure`,Z=>{const ne="usedCardIds_"+N,oe=new Set(C[ne]||[]);Z.forEach(te=>{const se=(B[te._line]||[]).find(ue=>ue.cardId===te.cardId);se&&(se.used=!0,oe.add(te.cardId),C.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),C[ne]=[...oe],C[N+"Team"]=B,A(C)})},REVIVE_PLAYER:({count:k=1,roles:S=[]},z,C)=>{const A=z[f+"Team"],N=Object.entries(A).filter(([B])=>!S.length||S.includes(B)).flatMap(([B,F])=>F.filter(K=>K.used).map(K=>({...K,_line:B})));if(!N.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),C(z);return}O(N,k,`Choisir ${k} joueur(s) à ressusciter`,B=>{B.forEach(F=>{const K=(A[F._line]||[]).find(Z=>Z.cardId===F.cardId);K&&(K.used=!1,z.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),z[f+"Team"]=A,C(z)})},REMOVE_GOAL:({},k,S)=>{const z=y+"Score";k[z]>0?(k[z]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),S(k)},ADD_GOAL_DRAW:({},k,S)=>{k[f+"Score"]===k[y+"Score"]?(k[f+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),S(k)},ADD_SUB:({value:k=1},S,z)=>{S.maxSubs=(S.maxSubs||3)+k,S.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),z(S)},CUSTOM:({},k,S)=>S(k)};function O(k,S,z,C){const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let N=[];function B(){var K,Z;const F=k.map(ne=>{const oe=ne._line||ne.job||"MIL",te=N.find(ue=>ue.cardId===ne.cardId),se=ze({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:oe,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(K=A.querySelector("#pp-close"))==null||K.addEventListener("click",()=>A.remove()),A.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const oe=ne.dataset.cid,te=k.find(ue=>ue.cardId===oe),se=N.findIndex(ue=>ue.cardId===oe);te&&(se>-1?N.splice(se,1):N.length<S&&N.push(te),B())})}),(Z=A.querySelector("#pp-confirm"))==null||Z.addEventListener("click",()=>{A.remove(),C(N)})}B(),document.body.appendChild(A)}async function le(k,S){const C=(m["gcCardsFull_"+f]||[]).find(F=>F.id===k),A=(C==null?void 0:C._gcDef)||(m.gcDefs||[]).find(F=>{var K;return F.name===S||((K=F.name)==null?void 0:K.toLowerCase().trim())===(S==null?void 0:S.toLowerCase().trim())}),N=[...m["usedGc_"+f]||[],k],B={type:S,by:f,seq:(m._gcAnimSeq||0)+1};V.add(B.seq),de(S,f,async()=>{if(A!=null&&A.effect_type&&A.effect_type!=="CUSTOM"){const K=G[A.effect_type];if(K){const Z={...m};K(A.effect_params||{},Z,async ne=>{ne["usedGc_"+f]=N,ne._lastGC=B,ne._gcAnimSeq=B.seq,await L(ne)});return}}const F={...m};switch(S){case"Remplacement+":F.maxSubs=(F.maxSubs||3)+1,F.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const K=y+"Score";F[K]>0&&(F[K]--,F.log.push({text:"🚫 But annulé",type:"info"}));break}}F["usedGc_"+f]=N,F._lastGC=B,F._gcAnimSeq=B.seq,await L(F)})}function pe(k,S){const z="usedCardIds_"+k,C=new Set(m[z]||[]);S.forEach(A=>C.add(A)),m[z]=[...C]}function M(){for(const k of["p1","p2"]){const S=new Set(m["usedCardIds_"+k]||[]),z=m[k+"Team"];if(z)for(const C of["GK","DEF","MIL","ATT"])(z[C]||[]).forEach(A=>{A.used=S.has(A.cardId)})}}function H(){var go,xo,bo,yo,ho,vo;if(m.phase==="reveal")return fe();if(m.phase==="midfield")return ge();if(m.phase==="finished")return He();const k=m[f+"Team"],S=m[y+"Team"];M();const z=m[f+"Score"],C=m[y+"Score"],A=m[f+"Name"],N=m[y+"Name"],B=m.phase===f+"-attack",F=m.phase===f+"-defense",K=Array.isArray(m["selected_"+f])?m["selected_"+f]:[],Z=K.map(Q=>Q.cardId),ne=window.innerWidth>=700,oe=m[f+"Subs"]||[],te=m["usedSubIds_"+f]||[],se=oe.filter(Q=>!te.includes(Q.cardId)),ue=m["gcCardsFull_"+f]||[],we=m["usedGc_"+f]||[],me=ue.filter(Q=>!we.includes(Q.id)),_e=m.boostOwner===f&&!m.boostUsed,$e=[...k.MIL||[],...k.ATT||[]].filter(Q=>!Q.used),re=[...S.MIL||[],...S.ATT||[]].filter(Q=>!Q.used),Ae=!Se(S),Ne=$e.length===0&&re.length===0&&!Ae,je=(k.DEF||[]).filter(Q=>!Q.used),Xe=(k.GK||[]).filter(Q=>!Q.used);let Ue=[];B&&$e.length===0&&(Ae?(Ue=je.map(Q=>Q.cardId),je.length===0&&(Ue=Ue.concat(Xe.map(Q=>Q.cardId)))):Ne&&(Ue=[...je,...Xe].map(Q=>Q.cardId)));function rt(Q,he,qe){var Be,bt;const Te=Q._gcDef,Nt=(Te==null?void 0:Te.name)||Q.gc_type,dt=(Te==null?void 0:Te.effect)||((Be=Oe[Q.gc_type])==null?void 0:Be.desc)||"",Pe=Te!=null&&Te.image_url?`/icons/${Te.image_url}`:null,Ge=((bt=Oe[Q.gc_type])==null?void 0:bt.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${Q.id}" data-gc-type="${Q.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
    ...
    </div>`,st=m[f+"Team"],kn=(()=>{var he,qe,Te,Nt,dt;if(F&&((he=m.pendingAttack)!=null&&he.players)){const Pe=m.pendingAttack;let Ge="";if(K.length>0){const Be=K.map(Qe=>{const Jt=(st[Qe._role]||[]).find(Bi=>Bi.cardId===Qe.cardId)||Qe,Qt=st[Qe._role]||[],fi=Qt.findIndex(Bi=>Bi.cardId===Qe.cardId),qi=lt(Qt.length),Zt=fi>=0?qi[fi]:Jt._col??1;return{...Jt,_line:Qe._role,_col:Zt}}),bt=pi(Be,((qe=m.modifiers)==null?void 0:qe[f])||{},m[f+"Formation"]);Ge=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
        ...
        </div>`}const Q=(m.log||[]).slice(-1)[0];return Q?'<div style="padding:2px 4px">'+un(Q)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),mo=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(oe);let te=!1;const se=()=>{te||(te=!0,oe.remove(),setTimeout(()=>z&&z(),50))};oe.addEventListener("click",se),setTimeout(se,3e3)}function q(k,S){var ne,oe,te,se;const C=(m["gcCardsFull_"+f]||[]).find(ue=>ue.id===k),A=C==null?void 0:C._gcDef,N=(A==null?void 0:A.name)||S,B=(A==null?void 0:A.effect)||((ne=Oe[S])==null?void 0:ne.desc)||"Carte spéciale.",F=A!=null&&A.image_url?`/icons/${A.image_url}`:null,K=((oe=Oe[S])==null?void 0:oe.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ${nt(N,F,K,B,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(Z),(te=Z.querySelector("#pvp-gc-back"))==null||te.addEventListener("click",()=>Z.remove()),(se=Z.querySelector("#pvp-gc-use"))==null||se.addEventListener("click",()=>{Z.remove(),le(k,S)})}function W(){var C;const k=m[f+"Team"],S=Object.entries(k).flatMap(([A,N])=>(N||[]).filter(B=>!B.used).map(B=>({...B,_line:A})));if(!S.length)return;const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",z.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${S.map(A=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",B=Re(A,A._line)+(A.boost||0);return`<div class="bp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${N};overflow:hidden;cursor:pointer">
      ...
      </div>`,(Ne=oe.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>oe.remove()),(je=oe.querySelector("#pout-up"))==null||je.addEventListener("click",()=>{F>0&&(F--,te())}),(Xe=oe.querySelector("#pout-down"))==null||Xe.addEventListener("click",()=>{F<N.length-1&&(F++,te())}),(Ue=oe.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{Z>0&&(Z--,te())}),(rt=oe.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{Z<B.length-1&&(Z++,te())});const Ae=(Fe,Je,Ke,gt)=>{const at=oe.querySelector("#"+Fe);if(!at)return;let Pt=0;at.addEventListener("touchstart",xt=>{Pt=xt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",xt=>{const Lt=xt.changedTouches[0].clientY-Pt;if(Math.abs(Lt)<30)return;const st=Je();Lt<0&&st<gt-1?(Ke(st+1),te()):Lt>0&&st>0&&(Ke(st-1),te())},{passive:!0})};Ae("pin-panel",()=>Z,Fe=>Z=Fe,B.length),Ae("pout-panel",()=>F,Fe=>F=Fe,N.length),(Xt=oe.querySelector("#psub-confirm"))==null||Xt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),ne)return;ne=!0;const Je=N[F],Ke=B[Z];if(!Je||!Ke)return;const gt=Je._line,at=(z[gt]||[]).findIndex(Lt=>Lt.cardId===Je.cardId);if(at===-1){x("Erreur : joueur introuvable","error"),oe.remove();return}const Pt={...Ke,_line:gt,position:Je.position,used:!1,boost:0};z[gt].splice(at,1,Pt);const xt=[...C,Ke.cardId];oe.remove(),ie(Je,Ke,async()=>{await L({[f+"Team"]:z,[y+"Team"]:m[y+"Team"],["usedSubIds_"+f]:xt})})})}document.body.appendChild(oe),te()}function ie(k,S,z){const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const N=(K,Z,ne)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(A);let B=!1;const F=()=>{B||(B=!0,A.remove(),setTimeout(()=>z(),50))};A.addEventListener("click",F),setTimeout(F,2200)}function X(){var S;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
      ...
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(k),(S=k.querySelector("#pvp-opp-close"))==null||S.addEventListener("click",()=>k.remove())}function R(){var z;const k=m.log||[],S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(S),(z=S.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>S.remove())}async function J(){if(m.phase!==f+"-attack")return;const k=f==="p1"?"p2":"p1",S=(m.round||0)+1,z=[...m.log||[]];z.push({type:"info",text:`⏭️ ${m[f+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const C=De(m),A=Le(k),N=C||!A?"finished":k+"-attack";await L({["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},pendingAttack:null,phase:N,attacker:k,round:S,log:z}),N==="finished"&&await Ce(m)}function P(k){const S=(k.GK||[]).some(C=>!C.used),z=["DEF","MIL","ATT"].some(C=>(k[C]||[]).some(A=>!A.used));return S&&!z}function U(k){return(k.p1Score||0)!==(k.p2Score||0)?null:P(k.p1Team)&&!Se(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(S=>!S.used)}:P(k.p2Team)&&!Se(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(S=>!S.used)}:null}async function ae(){const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(k);const S=(z,C)=>new Promise(A=>{k.innerHTML=`<div style="font-size:32px;font-weight:900;color:${C};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(A,1400)});await S("⚽ DERNIER CORNER","#FFD700"),await S("🧤 LE GARDIEN MONTE !","#4fc3f7"),k.remove()}async function ce(k,S){const{side:z,gk:C}=k;if(!C)return;const A=z+"Score",N=(S[A]||0)+1;C.used=!0;const B=[...S.log||[]];B.push({type:"duel",isGoal:!0,homeScored:z===f,homePlayers:z==="p1"?[Gt(C)]:[],aiPlayers:z==="p2"?[Gt(C)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${S[z+"Name"]} marque !`});const F=(S.round||0)+1,K=z==="p1"?"p2":"p1",Z={...S,[A]:N},ne=De(Z);D.add(F),await ae();const oe=z===f?N:S[f+"Score"]||0,te=z===f?S[y+"Score"]||0:N;tt([Gt(C)],oe,te,z===f,async()=>{await L({[A]:N,log:B,round:F,pendingAttack:null,phase:ne?"finished":K+"-attack",attacker:K,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}}}),ne&&await Ce({...m,[A]:N})})}async function be(){const k=m[f+"Team"],S=!["GK","DEF","MIL","ATT"].some(N=>(m[y+"Team"][N]||[]).some(B=>!B.used)),z=(m["selected_"+f]||[]).map(N=>{const B=(k[N._role]||[]).find(ue=>ue.cardId===N.cardId)||N,F=["GK","DEF"].includes(N._role),K=k[N._role]||[],Z=K.findIndex(ue=>ue.cardId===N.cardId),ne=lt(K.length),oe=Z>=0?ne[Z]:B._col??1,te=m.stadiumDef||m.homeStadiumDef||null,se=B.stadiumBonus||te&&(te.club_id&&String(B.club_id)===String(te.club_id)||te.country_code&&B.country_code===te.country_code)||!1;return{...B,_line:N._role,_col:oe,stadiumBonus:se,...F?{note_a:Math.max(1,Number(B.note_a)||0)}:{}}});if(!z.length)return;const C=ci(z,m.modifiers[f]||{},m[f+"Formation"]);pe(f,z.map(N=>N.cardId)),z.forEach(N=>{const B=(k[N._role]||[]).find(F=>F.cardId===N.cardId);B&&(B.used=!0)}),m["selected_"+f]=[],H();const A=[...m.log||[]];if(S){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await ce({side:f,gk:z[0]},{...m,[f+"Team"]:k,log:A});return}const B=(m[f+"Score"]||0)+1,F=z.map(te=>Gt(te));A.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:F,homeTotal:C.total,aiTotal:0});const K=(m.round||0)+1,Z=f==="p1"?"p2":"p1",ne={...m,[f+"Team"]:k,[f+"Score"]:B},oe=De(ne);D.add(K),tt(F,B,m[y+"Score"]||0,!0,async()=>{await L({[f+"Team"]:k,[f+"Score"]:B,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},pendingAttack:null,phase:oe?"finished":Z+"-attack",attacker:Z,round:K,log:A}),oe&&await Ce({...m,[f+"Score"]:B})});return}A.push({type:"pending",text:`⚔️ ${m[f+"Name"]} attaque (${C.total})`}),await L({[f+"Team"]:k,[y+"Team"]:m[y+"Team"],pendingAttack:{...C,players:z,side:f},["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},phase:y+"-defense",log:A})}async function ke(){const k=m[f+"Team"],S=(m["selected_"+f]||[]).map(me=>{const _e=(k[me._role]||[]).find(je=>je.cardId===me.cardId)||me,$e=k[me._role]||[],re=$e.findIndex(je=>je.cardId===me.cardId),Ae=lt($e.length),Ne=re>=0?Ae[re]:_e._col??1;return{..._e,_line:me._role,_col:Ne}}),z=pi(S,m.modifiers[f]||{},m[f+"Formation"]);pe(f,S.map(me=>me.cardId)),S.forEach(me=>{const _e=(k[me._role]||[]).find($e=>$e.cardId===me.cardId);_e&&(_e.used=!0)}),m["selected_"+f]=[],H();const C=lo(m.pendingAttack.total,z.total,m.modifiers[f]||{}),A=m.pendingAttack.side,N=C==="attack"||(C==null?void 0:C.goal),B=A==="p1"?"p2":"p1",F=(m.round||0)+1,K=(m.pendingAttack.players||[]).map(me=>Gt(me)),Z=[...m.log||[]];Z.push({type:"duel",isGoal:N,homeScored:N&&A===f,text:N?`⚽ BUT de ${m[A+"Name"]} ! (${m.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${z.total})`,homePlayers:K,aiPlayers:S.map(me=>Gt(me)),homeTotal:m.pendingAttack.total,aiTotal:z.total});const ne=N?(m[A+"Score"]||0)+1:m[A+"Score"]||0,oe={...m,[f+"Team"]:k,[A+"Score"]:ne},te=De(oe),se=te?"finished":B+"-attack",ue=!te&&!N?U(oe):null,we=async()=>{if(ue){await ce(ue,oe);return}await L({[f+"Team"]:k,[y+"Team"]:m[y+"Team"],[A+"Score"]:ne,["selected_"+f]:[],modifiers:{...m.modifiers,[f]:{}},pendingAttack:null,phase:se,attacker:B,round:F,log:Z}),(se==="finished"||te)&&await Ce({...m,[A+"Score"]:ne})};if(N){const me=A===f,_e=me?ne:m[f+"Score"]||0,$e=me?m[y+"Score"]||0:ne;D.add(F),tt(K,_e,$e,me,we)}else await we()}function Ee(k){return["MIL","ATT"].some(S=>(k[S]||[]).some(z=>!z.used))}function Se(k){return["GK","DEF","MIL","ATT"].some(S=>(k[S]||[]).some(z=>!z.used))}function ye(k){return Se(k)&&!Ee(k)}function Le(k){const S=m[k+"Team"],z=m[(k==="p1"?"p2":"p1")+"Team"];return!!(Ee(S)||ye(S)&&!Se(z)||ye(S)&&!Ee(z)&&Se(z))}function De(k){return!Se(k.p1Team)&&!Se(k.p2Team)}function Me(k){const S=k.p1Score||0,z=k.p2Score||0;return S===z?null:S>z?h.home_id:h.away_id}async function Ce(k){Ot(),Ve();try{const S=Me(k),z=S?h.home_id===S?h.away_id:h.home_id:null,C=k.p1Score||0,A=k.p2Score||0,{data:N,error:B}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:S,p_home_score:C,p_away_score:A,p_forfeit:!1});if(B&&console.error("[PvP] finish_pvp_match:",B),c)try{await v.rpc("check_and_finish_mini_league",{p_league_id:c})}catch(F){console.error("[PvP] check_and_finish_mini_league:",F)}S&&z&&ta(S,z).catch(()=>{});try{const{data:F}=await v.rpc("apply_match_rewards",{p_match_id:i});F!=null&&F.success&&!(F!=null&&F.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(F){console.error("[PvP] apply_match_rewards:",F)}if(typeof d=="function")try{await d({homeScore:C,awayScore:A,winnerId:S,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(F){console.error("[PvP] onMatchEnd:",F)}}catch(S){console.error("[PvP] finishMatch:",S)}}function He(){var A;const k=m[f+"Score"],S=m[y+"Score"],z=k>S,C=k===S;ct(t),t.innerHTML=`
    ...
    </div>`,(A=document.getElementById("pvp-home"))==null||A.addEventListener("click",()=>{try{v.removeChannel(j)}catch{}Ye(t),c?g("mini-league",{openLeagueId:c}):g("home")})}H()}async function Xi(t,e,i=!1){var l,s;const{state:o,navigate:r,toast:n}=e,a=i&&((s=(l=e==null?void 0:e.state)==null?void 0:l.params)==null?void 0:s.rankedData)||null;await Ci(t,e,i?"ranked":"random",async({deckId:d,formation:c,starters:p,subsRaw:b,gcCardsEnriched:g,gcDefs:x,stadiumDef:f})=>{ct(t);const y=async u=>{await na(t,e,d,c,p,b,u||[],x,f,i,a)};if(!(g!=null&&g.length)){await y([]);return}zi(t,g,y)})}async function oa(t,e,i){return ia(t,e,i)}async function na(t,e,i,o,r,n,a=[],l=[],s=null,d=!1,c=null){var Y,j;const{state:p,navigate:b,toast:g}=e,x=(c==null?void 0:c.mmr)??((Y=p.profile)==null?void 0:Y.mmr)??1e3,f=d?At(x):null,y=d?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",u=d?(f==null?void 0:f.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:${y};color:#fff;padding:32px;text-align:center;gap:20px">
      ${d?`<div style="font-size:36px">${(f==null?void 0:f.emoji)||"⚽"}</div>`:""}
      <div style="font-size:18px;font-weight:900;color:#fff">${d?"Recherche Ranked…":"Recherche d'un adversaire…"}</div>
      ${d?`<div style="font-size:13px;color:${(f==null?void 0:f.color)||"#D4A017"}">${(f==null?void 0:f.name)||""} · ${Math.round(x)} MMR</div>`:""}
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:p.profile.id})}catch(L){console.error("[Matchmaking] cancel error:",L)}};(j=document.getElementById("cancel-mm"))==null||j.addEventListener("click",async()=>{await m(),Ye(t),b("home")});const T=async(L,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Dt(t,e,L,_,{myGC:a,gcDefs:l,stadiumDef:s,isRanked:d,rankedData:c,onMatchEnd:d?ra:null}))},$=p.user.id,{data:I,error:D}=d?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:x,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(D||!(I!=null&&I.success)){console.error("[Matchmaking] try_matchmake error:",D||I),g("Erreur de matchmaking","error"),Ye(t),b("home");return}if(I.matched){await T(I.match_id,!1);return}const V=async()=>{if(w)return;const{data:L}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(L==null?void 0:L.status)==="matched"&&L.match_id&&await T(L.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},L=>{const _=L.new;_.status==="matched"&&_.match_id&&T(_.match_id,!0)}).subscribe(),E=setInterval(V,3e3),d?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:p.profile.id})}catch(L){console.error("[Matchmaking] cancel error:",L)}g("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),b("match",{matchMode:"ranked_ai",rankedData:c,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:l,stadiumDef:s}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function ra(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:l,awayScore:s,matchId:d}=t,c=i.user.id,p=n===c,b=r===c,{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",c).single(),{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",p?a:n).single();if(g&&x){const f=Uo(g.mmr,g.mmr_rd,g.mmr_v,x.mmr,x.mmr_rd,b?1:0);await v.from("users").update({mmr:f.mmr,mmr_rd:f.rd,mmr_v:f.v,mmr_wins:b?v.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:v.sql`mmr_losses + 1`}).eq("id",c),o(b?`+MMR ↑ ${Math.round(f.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-f.mmr)}`,b?"success":"error",4e3)}}const aa=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Xi,resumePvpMatch:oa},Symbol.toStringTag,{value:"Module"}));async function sa(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,l=n.friendName||"Ami",s=!!n.isAccepting;await Ci(t,e,"friend",async({deckId:d,formation:c,starters:p,subsRaw:b,gcCardsEnriched:g,gcDefs:x,stadiumDef:f})=>{ct(t);const y=async u=>{const w=u||[];s?await la(t,e,d,w,x,f):await da(t,e,d,w,x,f,a,l)};if(!(g!=null&&g.length)){await y([]);return}zi(t,g,y)})}async function da(t,e,i,o,r,n,a,l){var w;const{state:s,navigate:d,toast:c}=e,p=s.user.id,{data:b,error:g}=await v.from("friend_match_invites").insert({inviter_id:p,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!b){console.error("[Friend] Erreur création invitation:",g),c("Impossible de créer l'invitation","error"),d("home");return}t.innerHTML=`
    ...
    </div>`;let x=!1,f=null;const y=async()=>{f&&(f.unsubscribe(),f=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await y(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",b.id),Ye(t),d("home")}),f=v.channel(`friend_invite_${b.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${b.id}`},async({new:h})=>{x||h.status!=="accepted"||!h.match_id||(x=!0,await y(),await Dt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))}).subscribe();const u=setInterval(async()=>{if(x)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",b.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(x=!0,clearInterval(u),await y(),await Dt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))},3e3);setTimeout(async()=>{x||(clearInterval(u),await y(),c("Invitation expirée","info"),d("home"))},12e4)}async function la(t,e,i,o,r,n){const{state:a,navigate:l,toast:s}=e,d=a.user.id,{data:c}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",d).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!c){s("Aucune invitation en attente","error"),l("home");return}const{data:p,error:b}=await v.rpc("accept_friend_invite",{p_invite_id:c.id,p_invitee_deck_id:i});if(b||!(p!=null&&p.success)){console.error("[Friend] Erreur accept_friend_invite:",b||p),s((p==null?void 0:p.error)||"Impossible de rejoindre le match","error"),l("home");return}await Dt(t,e,p.match_id,!1,{myGC:o,gcDefs:r,stadiumDef:n})}const bn="#1A6B3C",pt="#D4A017",ii="var(--tile-bg)",oi="var(--tile-border)",zt="var(--divider)",Ze="var(--tile-fg-on-page)",It="var(--tile-fg-dim)",it="var(--tile-fg-faint)",ri="var(--nav-fg,#fff)",yn="rgba(255,255,255,0.62)",ca="rgba(255,255,255,0.4)";async function pa(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ft(t,e,i);return}await ot(t,e)}async function ot(t,e,i="waiting"){var h,E;const{state:o}=e,r=o.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(n||[]).map(m=>m.league_id),l={};(n||[]).forEach(m=>{l[m.league_id]={amount:m.prize_amount,claimed:m.prize_claimed}});const{data:s,error:d}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),c=d?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:s||[],b=(a.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],g=b.filter(m=>m.status==="waiting"&&!m.is_archived),x=b.filter(m=>m.status==="active"&&!m.is_archived),f=b.filter(m=>m.is_archived||m.status==="finished");let y=f;if(f.length){const{data:m}=await v.from("mini_league_matches").select("league_id").in("league_id",f.map($=>$.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),T=new Set((m||[]).map($=>$.league_id));y=f.filter($=>T.has($.id))}const u=c.filter(m=>!a.includes(m.id)),w=[{key:"waiting",label:"🟡 En attente",count:g.length+u.length},{key:"active",label:"🟢 En cours",count:x.length},{key:"archived",label:"📁 Archivées",count:y.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${zt}">
      ${w.map(m=>`<button class="ml-tab" data-tab="${m.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===m.key?bn:"transparent"};background:none;font-size:12px;font-weight:${i===m.key?"900":"600"};color:${i===m.key?"#4ade80":ca};cursor:pointer">${m.label}${m.count?` (${m.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?ua(g,u,r):i==="active"?fa(x,r):ma(y,r,l)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>ga(t,e)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>ot(t,e,i)),t.querySelectorAll(".ml-tab").forEach(m=>m.addEventListener("click",()=>ot(t,e,m.dataset.tab))),t.querySelectorAll("[data-league-id]").forEach(m=>m.addEventListener("click",()=>ft(t,e,m.dataset.leagueId))),t.querySelectorAll("[data-join]").forEach(m=>m.addEventListener("click",T=>{T.stopPropagation(),hn(t,e,m.dataset.join,m.dataset.type)})),t.querySelectorAll("[data-delete]").forEach(m=>m.addEventListener("click",T=>{T.stopPropagation(),Ji(t,e,m.dataset.delete,m.dataset.name,i)})),t.querySelectorAll("[data-claim-league]").forEach(m=>m.addEventListener("click",async T=>{T.stopPropagation(),m.disabled=!0,m.textContent="...";const{data:$,error:I}=await v.rpc("claim_mini_league_prize",{p_league_id:m.dataset.claimLeague,p_user_id:o.profile.id});if(I||!($!=null&&$.success)){e.toast(($==null?void 0:$.error)||"Erreur lors de la récupération","error"),ot(t,e,i);return}if(!$.already_claimed){o.profile.credits=(o.profile.credits||0)+$.prize;const D=document.getElementById("nav-credits");D&&(D.textContent=`💰 ${o.profile.credits.toLocaleString("fr")}`),e.toast(`💰 +${$.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}ot(t,e,i)}))}function Ti(t,e,i=!1,o=null){var s,d;const r=t.creator_id===e,n=t.pot||0,a=((d=(s=t.mini_league_members)==null?void 0:s[0])==null?void 0:d.count)||0,l=o&&o.amount>0&&!o.claimed;return`<div data-league-id="${t.id}" style="background:${ii};border:1px solid ${l?"rgba(212,160,23,0.5)":oi};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;font-size:11px;color:${It};margin-bottom:${i||l?"10px":"0"}">
  ...
  </div>`}function ua(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(r=>Ti(r,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(r=>Ti(r,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${it}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function fa(t,e){return t.length?t.map(i=>Ti(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league en cours.</div>`}function ma(t,e,i={}){return t.length?t.map(o=>Ti(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league archivée.</div>`}function ga(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var x,f,y,u;const{toast:o}=e,r=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,l=((x=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:x.value)||"public",s=((f=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:f.value)||"aller",d=((u=(y=document.getElementById("ml-pwd"))==null?void 0:y.value)==null?void 0:u.trim())||null;if(!r){o("Le nom est obligatoire","error");return}if(a<100){o("Mise minimum : 100 crédits","error");return}if(l==="private"&&!d){o("Mot de passe requis","error");return}const{data:c,error:p}=await v.from("mini_leagues").insert({name:r,creator_id:e.state.profile.id,type:l,password:d,mode:s,max_players:n,entry_fee:a}).select().single();if(p){o("Erreur : "+p.message,"error");return}const{data:b}=await v.from("users").select("credits").eq("id",e.state.profile.id).single();if(((b==null?void 0:b.credits)||0)<a){await v.from("mini_leagues").delete().eq("id",c.id),o(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:b.credits-a}).eq("id",e.state.profile.id),await v.from("mini_leagues").update({pot:a}).eq("id",c.id),await v.from("mini_league_members").insert({league_id:c.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=b.credits-a);const g=document.getElementById("nav-credits");g&&(g.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,c.id)})}function xa(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function hn(t,e,i,o){var p;const{toast:r,state:n}=e,a=n.profile.id;let l=null;if(o==="private"&&(l=await xa(),l===null))return;const{data:s,error:d}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:l});if(d||!(s!=null&&s.success)){console.error("[MiniLeague] join_mini_league:",d||s),r((s==null?void 0:s.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:b}=await v.from("users").select("credits").eq("id",a).single();n.profile&&b&&(n.profile.credits=b.credits)}const c=document.getElementById("nav-credits");c&&(c.textContent=`💰 ${(((p=n.profile)==null?void 0:p.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function ba(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(b=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),b(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),b(!1)}}))return;const{data:s,error:d}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(d||!(s!=null&&s.success)){r((s==null?void 0:s.error)||"Erreur lors de la désinscription","error");return}const c=s.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+c);const p=document.getElementById("nav-credits");p&&(p.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${c.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Ji(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,r)}async function ya(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,m,T,$,I,D,V,Y,j;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:l},{data:s}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await ot(t,e);return}const d=(l||[]).some(L=>L.user_id===n),c=a.creator_id===n,p=(l||[]).map(L=>L.user).filter(Boolean),b=ka(p,s||[]),g=(s||[]).filter(L=>L.matchday===a.current_day),x=a.pot||0,f=a.entry_fee||100,y=g.length>0&&g.every(L=>L.status==="finished"||L.status==="bye"),u=a.current_day>=a.total_days,w=(l||[]).find(L=>L.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        ${p.map(L=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${zt}">
            <div style="width:36px;height:36px;border-radius:50%;background:${L.club_color2||bn};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${L.club_color1||"#fff"}">${(L.pseudo||"?").slice(0,2).toUpperCase()}</div>
        ...
        ${c&&p.length>=2?`<button id="ml-start-btn" class="btn btn-primary" style="width:100%;margin-top:14px;padding:12px">🚀 Lancer (prélève ${f} cr. × ${p.length})</button>`:""}
        ${c?'<button id="ml-delete-btn" class="btn btn-ghost btn-sm" style="color:#ff6b6b;width:100%;margin-top:8px">🗑️ Supprimer</button>':""}
        ${d?"":`<button id="ml-join-now" class="btn btn-primary" style="width:100%;margin-top:14px">Rejoindre (mise : ${f} cr.)</button>`}
        ${d&&!c?`
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        ${g.map(L=>Do(L,p,n,d)).join("")}
        ${c&&y&&!u?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
      </div>`:""}
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((L,_)=>{const G=x>0&&a.status==="finished"?_===0?Math.floor(x*.7):_===1?Math.floor(x*.2):_===2?Math.floor(x*.1):0:0;return`<tr style="border-bottom:1px solid ${zt};${L.userId===n?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(L,_)=>_+1).reverse().map(L=>{const _=(s||[]).filter(G=>G.matchday===L);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${L}</div>${_.map(G=>Do(G,p,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    <div style="font-size:13px;font-weight:900;min-width:50px;text-align:center;color:${t.status==="finished"?"#4ade80":it}">${c}</div>
  ...
  </div>`}async function ha(t,e,i,o){const{toast:r,state:n}=e,a=_a(o.map(d=>d.id),i.mode),l=[];a.forEach((d,c)=>d.forEach(p=>l.push({league_id:i.id,matchday:c+1,home_id:p.home||p.bye,away_id:p.away||null,is_bye:!!p.bye,status:p.bye?"bye":"pending"})));const{error:s}=await v.from("mini_league_matches").insert(l);if(s){r("Erreur calendrier : "+s.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ft(t,e,i.id)}async function va(t,e,i){const{data:o}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(o.current_day||0)+1;if(r>(o.total_days||0)){ft(t,e,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),e.toast(`Journée ${r} commencée !`,"success"),ft(t,e,i)}async function wa(t,e,i,o,r){var b,g;const{state:n,toast:a}=e,l=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],s=["🥇","🥈","🥉"][r],d=o.prize_amount||l[r]||0,c=o.prize_claimed,p=document.createElement("div");p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",p.innerHTML=`
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      <div style="font-size:64px;margin-bottom:8px">${s}</div>
      ...
      ${c?'<div style="font-size:13px;color:#86efac;margin-bottom:16px">✅ Crédits déjà récupérés</div>':`<button id="claim-prize-btn" style="width:100%;padding:14px;border-radius:12px;border:none;background:${pt};color:#111;font-size:16px;font-weight:900;cursor:pointer;margin-bottom:12px">💰 Récupérer ${d.toLocaleString("fr")} cr.</button>`}
      <button id="prize-close" style="background:rgba(255,255,255,0.1);border:none;color:rgba(255,255,255,0.7);padding:10px 24px;border-radius:10px;font-size:14px;cursor:pointer">Fermer</button>
    </div>`,document.body.appendChild(p),(b=p.querySelector("#prize-close"))==null||b.addEventListener("click",()=>p.remove()),(g=p.querySelector("#claim-prize-btn"))==null||g.addEventListener("click",async x=>{const f=x.currentTarget;f.disabled=!0,f.textContent="...";const{data:y,error:u}=await v.rpc("claim_mini_league_prize",{p_league_id:i.id,p_user_id:n.profile.id});if(u||!(y!=null&&y.success)){console.error("[MiniLeague] claim_mini_league_prize:",u||y),a((y==null?void 0:y.error)||"Erreur lors de la récupération","error"),f.disabled=!1,f.textContent=`💰 Récupérer ${d.toLocaleString("fr")} cr.`;return}if(y.already_claimed)a("Déjà récupéré précédemment","info");else{const w=(n.profile.credits||0)+y.prize;n.profile&&(n.profile.credits=w);const h=document.getElementById("nav-credits");h&&(h.textContent=`💰 ${w.toLocaleString("fr")}`),a(`💰 +${y.prize.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success")}p.remove(),ft(t,e,i.id)})}function _a(t,e){const o=t.length%2===0?[...t]:[...t,null],r=o.length;let n=o.slice(1);const a=[];for(let l=0;l<r-1;l++){const s=[],d=[o[0],...n];for(let c=0;c<r/2;c++){const p=d[c],b=d[r-1-c];p===null?s.push({bye:b}):b===null?s.push({bye:p}):s.push({home:p,away:b})}a.push(s),n=[n[n.length-1],...n.slice(0,-1)]}return e==="aller-retour"?[...a,...a.map(l=>l.map(s=>s.bye?s:{home:s.away,away:s.home}))]:a}function ka(t,e){const i={};return t.forEach(o=>{i[o.id]={userId:o.id,pseudo:o.pseudo,clubName:o.club_name||o.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),e.filter(o=>o.status==="finished"&&!o.is_bye&&o.home_score!=null).forEach(o=>{const r=i[o.home_id],n=i[o.away_id];!r||!n||(r.played++,n.played++,r.goalsFor+=o.home_score,r.goalsAgainst+=o.away_score,n.goalsFor+=o.away_score,n.goalsAgainst+=o.home_score,o.home_score>o.away_score?(r.won++,r.points+=3,n.lost++):o.home_score<o.away_score?(n.won++,n.points+=3,r.lost++):(r.drawn++,r.points++,n.drawn++,n.points++),r.goalDiff=r.goalsFor-r.goalsAgainst,n.goalDiff=n.goalsFor-n.goalsAgainst)}),Object.values(i).sort((o,r)=>r.points-o.points||r.goalDiff-o.goalDiff||r.goalsFor-o.goalsFor)}async function Fo(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.leagueId||null,l=n.mlMatchId||null,s=i.user.id;if(!l||!a){r("Match introuvable","error"),o("mini-league");return}const{data:d,error:c}=await v.from("mini_league_matches").select("id, league_id, home_id, away_id, status, match_id").eq("id",l).single();if(c||!d){r("Match introuvable","error"),o("mini-league",{openLeagueId:a});return}if(d.home_id!==s&&d.away_id!==s){r("Vous ne faites pas partie de ce match","error"),o("mini-league",{openLeagueId:a});return}const p=d.home_id===s;if(d.match_id){await Dt(t,e,d.match_id,p,{mlLeagueId:a,mlMatchId:l});return}await Ci(t,e,"mini_league",async({deckId:b,gcCardsEnriched:g,gcDefs:x,stadiumDef:f})=>{ct(t);const y=async u=>{const{data:w,error:h}=await v.rpc("start_mini_league_match",{p_ml_match_id:l,p_user_id:s,p_deck_id:b});if(h||!(w!=null&&w.success)){console.error("[MiniLeague] start_mini_league_match error:",h||w),r((w==null?void 0:w.error)||"Impossible de lancer le match","error"),o("mini-league",{openLeagueId:a});return}if(w.matched){await Dt(t,e,w.match_id,p,{mlLeagueId:a,mlMatchId:l,myGC:u||[],gcDefs:x,stadiumDef:f});return}await $a(t,e,{mlMatchId:l,leagueId:a,amIHome:p,chosenGC:u,gcDefs:x,stadiumDef:f})};if(!(g!=null&&g.length)){await y([]);return}zi(t,g,y)})}function $a(t,e,{mlMatchId:i,leagueId:o,amIHome:r,chosenGC:n,gcDefs:a,stadiumDef:l}){return new Promise(s=>{var f;const{navigate:d}=e;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#0a1a2e,#0d3d1e);color:#fff;padding:32px;text-align:center;gap:20px">
      <div style="font-size:36px">🏆</div>
    ...
    </div>`;let c=!1;const p=async y=>{if(!c){if(c=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}y&&await Dt(t,e,y,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:l}),s()}};(f=document.getElementById("wait-back"))==null||f.addEventListener("click",()=>{if(c=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}d("mini-league",{openLeagueId:o}),s()});const b=async()=>{if(c)return;const{data:y}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();y!=null&&y.match_id&&p(y.match_id)},g=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},y=>{var u;(u=y.new)!=null&&u.match_id&&p(y.new.match_id)}).subscribe(),x=setInterval(b,3e3);b()})}const Ea="/",La=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Sa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var c,p,b;const l=e[o],s=o===e.length-1,d=Math.round((o+1)/e.length*100);r.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        <!-- Barre de progression -->
        <div style="height:4px;background:#eee">
          <div style="height:100%;width:${d}%;background:${l.color};transition:width .3s"></div>
        </div>
        <!-- En-tête -->
        ...
        <!-- Image optionnelle -->
        ${l.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${Ea}icons/${l.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `,r.querySelectorAll("ul,ol").forEach(g=>{g.style.paddingLeft="20px",g.style.marginTop="6px",g.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(g=>{g.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(g=>{g.style.marginBottom="8px"}),(c=r.querySelector("#tuto-prev"))==null||c.addEventListener("click",()=>{o--,n()}),(p=r.querySelector("#tuto-next"))==null||p.addEventListener("click",()=>{s?a():(o++,n())}),(b=r.querySelector("#tuto-skip"))==null||b.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),t!=null&&t.id&&await v.from("users").update({tutorial_done:!0}).eq("id",t.id),i==null||i()};document.body.appendChild(r),n()}async function Po(t,e,i){if(!t||t.tutorial_done)return;let o=[];const{data:r,error:n}=await v.rpc("get_tutorial_steps");if(!n&&(r==null?void 0:r.length)>0)o=r,console.log(`[Tutorial] RPC OK → ${o.length} étapes`);else{const{data:l,error:s}=await v.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!s&&(l==null?void 0:l.length)>0?(o=l,console.log(`[Tutorial] Direct OK → ${o.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${n==null?void 0:n.message}, Direct: ${s==null?void 0:s.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=o.length>0?o.map(l=>({emoji:l.emoji,title:l.title,color:l.color,content:l.content,image_url:l.image_url||null})):La;Sa(t,a,()=>e("boosters"))}const Ro={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function hi(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function Ta(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await fo(t,e)}async function fo(t,e){const{state:i,toast:o,navigate:r}=e;Yt(r,i.profile,"market","/icons/",o);const{data:n}=await v.from("market_listings").select(`id, price, status, listed_at, seller_id,
      ...
      card:cards(id, card_type, current_note, evolution_bonus,
        player:players(id, firstname, surname_real, country_code, job, job2,
          ...
          clubs(encoded_name, logo_url)))`).eq("seller_id",i.profile.id).in("status",["active","sold"]).order("listed_at",{ascending:!1}).limit(100),l=(n||[]).filter(y=>y.seller_id!==i.profile.id),s=a||[];t.innerHTML=`
  <style>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function g(y){var Y,j,L,_;const u=(Y=y.card)==null?void 0:Y.player;if(!u)return"";const w=((j=y.card)==null?void 0:j.evolution_bonus)||0,h=hi(u,u.job,w),E=u.job2?hi(u,u.job2,w):0,m=y.status==="sold",T=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,$=Ro[u.job]||"#bbb",I=u.job2?Ro[u.job2]||"#bbb":null,D=u.job==="GK"?"#fff":$,V=u.job2==="GK"?"#fff":I;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${m?"opacity:0.7":""}">
    ...
    </div>`}function x(){const y=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(y){if(u.style.display=d==="buy"?"flex":"none",d==="buy"){const w=p(l);y.innerHTML=w.length?`<div class="mkt-buy-grid">${w.map(b).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const w=s.filter(E=>E.status==="active").sort((E,m)=>new Date(m.listed_at)-new Date(E.listed_at)),h=s.filter(E=>E.status==="sold").sort((E,m)=>new Date(m.sold_at||m.listed_at)-new Date(E.sold_at||E.listed_at));y.innerHTML=(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${w.length})</div>`+w.map(g).join(""):"")+(h.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${h.length})</div>`+h.map(g).join(""):"")+(!w.length&&!h.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}y.querySelectorAll("[data-buy]").forEach(w=>w.addEventListener("click",()=>Ia(w.dataset.buy,l,t,e))),y.querySelectorAll("[data-cancel]").forEach(w=>w.addEventListener("click",()=>za(w.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(y=>{y.addEventListener("click",()=>{d=y.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(u=>{const w=u===y;u.style.background=w?"var(--green)":"var(--tile-bg)",u.style.color=w?"#fff":"var(--tile-fg-dim)",u.style.borderColor=w?"var(--green)":"var(--tile-border)"}),x()})});let f;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(y=>{var u;(u=document.getElementById(y))==null||u.addEventListener("input",()=>{clearTimeout(f),f=setTimeout(x,250)})}),x()}async function Ia(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,l=e.find(c=>c.id===t);if(!l)return;const s=l.price;if((r.profile.credits||0)<s){n("Crédits insuffisants","error");return}Aa(l,async()=>{const{error:c}=await v.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:r.profile.id});if(c){n("Erreur achat : "+c.message,"error");return}await a();const p=document.getElementById("nav-credits");p&&(p.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await fo(i,o)})}function Aa(t,e){var a;const i=(a=t.card)==null?void 0:a.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
    ...
    </div>`,document.body.appendChild(r);const n=l=>{r.remove(),l&&e()};r.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),r.addEventListener("click",l=>{l.target===r&&n(!1)})}async function za(t,e,i){const{toast:o}=i,{data:r}=await v.from("market_listings").select("card_id").eq("id",t).single();if(await v.from("market_listings").update({status:"cancelled"}).eq("id",t),r!=null&&r.card_id){const{count:n}=await v.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");n||await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}o("Annonce retirée","success"),fo(e,i)}async function Ma(t,e){var g,x,f,y,u;const{state:i,navigate:o}=e,r=((x=(g=e==null?void 0:e.state)==null?void 0:g.params)==null?void 0:x.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:a},{data:l}]=await Promise.all([v.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").order("mmr",{ascending:!1}).limit(100),v.rpc("get_mini_league_leaderboard"),v.rpc("get_random_leaderboard")]);let s=r;const d=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",c=w=>w<3?"#000":"#fff";function p(){var E,m,T;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=s==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const h=document.getElementById("rankings-list");if(h){if(s==="ranked"){const $=n||[];h.innerHTML=$.length>0?$.map((I,D)=>{const V=At(I.mmr??1e3),Y=(I.ranked_wins||0)+(I.ranked_losses||0)+(I.ranked_draws||0),j=Y>0?Math.round((I.ranked_wins||0)/Y*100):0,L=I.id===i.profile.id,_=(I.placement_matches||0)<10;return`
          ...
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(s==="mini-league"){const $=a||[];h.innerHTML=$.length>0?$.map((I,D)=>`
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const $=l||[];h.innerHTML=$.length>0?$.map((I,D)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${I.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${d(D)};color:${c(D)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${D<3?"16":"13"}px">${D<3?["🥇","🥈","🥉"][D]:D+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${I.pseudo}</div>
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div style="display:flex;gap:8px;margin-bottom:14px;background:rgba(255,255,255,0.04);border-radius:12px;padding:4px">
        <button id="tab-ranked" style="${b(s==="ranked")}">⚔️ Ranked</button>
        <button id="tab-mini-league" style="${b(s==="mini-league")}">🏆 Mini Leagues</button>
        <button id="tab-random" style="${b(s==="random")}">🎲 Random</button>
      </div>
      <div id="rankings-legend"></div>
      <div id="rankings-list" style="display:flex;flex-direction:column;gap:8px"></div>
    </div>
  </div>`,p(),(f=document.getElementById("tab-ranked"))==null||f.addEventListener("click",()=>{s="ranked",p()}),(y=document.getElementById("tab-mini-league"))==null||y.addEventListener("click",()=>{s="mini-league",p()}),(u=document.getElementById("tab-random"))==null||u.addEventListener("click",()=>{s="random",p()})}async function Ca(t,e){var T,$,I,D;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:l}]=await Promise.all([v.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),v.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!l){r("Erreur chargement profil","error"),o("home");return}if(!a){const V=l.mmr??1e3,Y=At(V);Gi(V);const j=Math.round(1e3+(V-1e3)*.5),L=At(j),{data:_}=await v.from("users").select("id, pseudo, club_name, mmr, rank_tier").order("mmr",{ascending:!1}).limit(100),G=(_||[]).findIndex(O=>O.id===l.id)+1;t.innerHTML=`
    <div style="min-height:100%;background:linear-gradient(160deg,#1a1a1a,#2a2a2a);padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:320px;overflow-y:auto">
          ${(_||[]).map((O,le)=>{const pe=At(O.mmr??1e3),M=O.id===l.id;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;
  ...
  </div>`,($=document.getElementById("ranked-back"))==null||$.addEventListener("click",()=>o("home")),(I=document.getElementById("ranked-leaderboard-btn"))==null||I.addEventListener("click",()=>o("rankings",{tab:"ranked"})),(D=document.getElementById("ranked-play-btn"))==null||D.addEventListener("click",()=>{mt(),o("match",{matchMode:"ranked",rankedData:{mmr:s,rd:d,sigma:c,isPlacement:b}})})}async function ja(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${r.id},away_id.eq.${r.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},l=(n||[]).filter(c=>c.status==="finished"),s=(n||[]).filter(c=>c.status==="in_progress");function d(c){const p=c.home_id===r.id;p?c.home_score:c.away_score,p?c.away_score:c.home_score;const b=c.winner_id===r.id,g=c.home_score===c.away_score&&c.status==="finished",x=c.status!=="finished"?"…":g?"N":b?"V":"D",f=c.status!=="finished"||g?"#888":b?"#1A6B3C":"#c0392b";let y=a[c.mode]||c.mode;c.away_id===null&&!y.startsWith("IA")&&(y="IA");const w=c.home_id===r.id?c.away:c.home;let h;c.away_id===null?h=y:w?h=`${w.club_name||w.pseudo} (${w.pseudo})`:h="Adversaire";let E="";c.status==="in_progress"&&Date.now()-new Date(c.created_at).getTime()>3600*1e3&&(E=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const m=new Date(c.created_at),T=m.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+m.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),$=c.status==="finished"?`${c.home_score} - ${c.away_score}`:`${c.home_score||0} - ${c.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
        <div style="font-size:13px;font-weight:600">${h}${E}</div>
        <div style="font-size:11px;color:var(--gray-600)">${y} · ${T}${c.status==="in_progress"?" · en cours":""}</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
  ...
  </div>`}$n(Ln);const ve={user:null,profile:null,page:"home",params:{}};function St(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function qa(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Qi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ni(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const vn="mw_theme";function ai(){return localStorage.getItem(vn)||"club"}function No(t){var e;localStorage.setItem(vn,t),vi(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function vi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function Mt(t,e={}){ve.page=t,ve.params=e,wn()}async function wn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(l=>{l.classList.toggle("active",l.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Mt,toast:St,openModal:qa,closeModal:Qi,refreshProfile:ni};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Fi(t,i);break;case"home2":await Fi(t,i);break;case"game":await fr(t,i);break;case"settings":await rn(t,i);break;case"collection":await vr(t,i);break;case"decks":await Ui(t,i);break;case"boosters":await Fn(t,i);break;case"ranked":await Ca(t,i);break;case"match":{const l=ve.params&&ve.params.matchMode||"vs_ai_easy";l==="random"?await Xi(t,i,!1):l==="ranked"?await Xi(t,i,!0):l==="friend"?await sa(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):l==="mini_league"||l==="mini-league"?await Fo(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await qr(t,i);break}case"market":await Ta(t,i);break;case"rankings":await Ma(t,i);break;case"matches":await ja(t,i);break;case"friends":await lr(t,i);break;case"mini-league":await pa(t,i);break;case"match-mini-league":{const l=ve.params||{};await Fo(t,i,l.mlMatchId,l.leagueId);break}default:await Fi(t,i)}}function Ba(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.30-2155" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),Mt(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Mt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Mt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>Da()),(r=document.getElementById("settings-btn"))==null||r.addEventListener("click",()=>Mt("settings"))}async function Da(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const r=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${r}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}function Fa(t,{onPlay:e}){var o;const i="/icons/";t.style.cssText="",t.innerHTML=`
  <style>
    #public-landing{
  ...
  <div id="public-landing">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Pa(){vi(ai()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Qi()}),document.getElementById("modal-close").addEventListener("click",Qi);const{data:{session:t}}=await v.auth.getSession();if(!t){Go(),Fa(document.getElementById("app"),{onPlay:()=>wo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:St})});return}ve.user=t.user,await ni(),vi(ai()),Go();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(r=>{o[r.formation]=r.links}),En(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){Tn(document.getElementById("app"),{state:ve,navigate:async()=>{await ni(),vi(ai()),Ni()},toast:St,refreshProfile:ni});return}const e=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&e.length>0){Kn(document.getElementById("app"),{state:ve,toast:St,refreshProfile:ni,navigate:()=>{Ni(),setTimeout(()=>Po(ve.profile,Mt,St),800)}});return}Ni(),setTimeout(()=>Po(ve.profile,Mt,St),800),v.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",wo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:St}))})}function Ra(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function ji(){const t=document.getElementById("app");t&&(t.style.height=Ra()+"px")}window.addEventListener("resize",ji);window.addEventListener("orientationchange",()=>setTimeout(ji,150));window.visualViewport&&window.visualViewport.addEventListener("resize",ji);function Ni(){const t=()=>{var i;(i=ve.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",ji(),Ba(),wn()}function Go(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function _n(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    ...
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(o=document.getElementById("boot-retry"))==null||o.addEventListener("click",()=>window.location.reload())}Pa().catch(t=>{console.error("Échec du démarrage:",t),_n()});setTimeout(()=>{const t=document.getElementById("app-loader");t&&t.style.display!=="none"&&!t.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&_n("Le serveur met trop de temps à répondre.")},12e3);
