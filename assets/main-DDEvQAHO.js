...
import{s as v,j as _i,q as So,t as Kt,u as Ui,F as Ki,o as it,n as Ot,g as Ct,r as Se,m as wt,v as mi,w as fn,T as Si,p as mn,x as gn,d as xn}from"./special-cards-lEGt-tGs.js";const bn="/";function po(t,{navigate:e,toast:i}){let o="login";const a=()=>{var r,s,d,c,l,f,b;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var m;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((m=document.getElementById("setup-club"))==null?void 0:m.value)||"MW",b=f.trim().split(" ").filter(Boolean),x=b.length>=2?(b[0][0]+b[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=n),l&&(l.textContent=x,l.style.color=n)}document.getElementById("color1").addEventListener("input",c=>{n=c.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),b=document.getElementById("step3-finish");f.textContent="",b.disabled=!0,b.textContent="Création en cours…";try{const{error:x}=await v.from("users").insert({id:e.user.id,pseudo:c,club_name:l,club_color1:n,club_color2:r,credits:1e4});if(x)throw x;await hn(e.user.id),await a(),o(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(x){f.textContent=x.message,b.disabled=!1,b.textContent="🚀 Créer mon profil !"}})}async function hn(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const vn="modulepreload",wn=function(t){return"/"+t},uo={},Ao=function(e,i,o){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(d=>{if(d=wn(d),d in uo)return;uo[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":vn,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((b,x)=>{f.addEventListener("load",b),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},zo="mw_sound_volume";function Vi(){const t=localStorage.getItem(zo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function _n(t){localStorage.setItem(zo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Yi(){return Vi()===0}function gi(t){return Math.max(0,Math.min(1,t*(Vi()/100)))}function Wi(t,e=1){if(Yi())return null;try{const i=new Audio(t);return i.volume=gi(e),i.play().catch(()=>{}),i}catch{return null}}let xt=null,Bi=null,fo=.3;function Mo(t,e=.3){if(fo=e,xt&&Bi===t&&!xt.paused){xt.volume=gi(fo);return}if(Gt(),!Yi())try{const i=new Audio(t);i.loop=!0,i.volume=gi(e),i.play().catch(()=>{}),xt=i,Bi=t}catch{}}function Gt(){if(xt)try{xt.pause(),xt.currentTime=0}catch{}xt=null,Bi=null}let Jt=null;function Co(t,e=.6){if(Ue(),!Yi())try{const i=new Audio(t);i.volume=gi(e),i.play().catch(()=>{}),Jt=i}catch{}}function Ue(){if(Jt)try{Jt.pause(),Jt.currentTime=0}catch{}Jt=null}const kn=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"game",route:"game",label:"GAME",emoji:"🎮"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function jo(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const l=document.createElement("style");l.id="home2-chrome-style",l.textContent=`
    ...
    `,document.head.appendChild(l)}const a=kn.map(l=>`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Ai(t,{state:e,navigate:i,toast:o}){var L,g,M,E,I,D;const a=e.profile;if(!a)return;const n="/icons/";jo(i,a,"home2",n);const r=a.mmr??1e3,s=_i(r),d=En(r,s),c=So(r),l=isFinite(s.max)?s.max+1:null,[{list:f,iAmInTop:b,myPosition:x},m,p]=await Promise.all([Ln(a.id),Tn(5),In()]),u=(O,Y)=>`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${$n(O.published_at)}</div>
      </div>
  ...
  <div class="home-dark" id="home-dark">
    ...
    </div>`}).join(""),o.querySelectorAll("[data-resume]").forEach(d=>{d.addEventListener("click",async()=>{$t();const c=document.getElementById("page-content")||document.getElementById("app");if(d.dataset.mini==="1"){const{data:l}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",d.dataset.resume).single();l?i("match-mini-league",{mlMatchId:l.id,leagueId:l.league_id}):i("mini-league")}else{const{resumePvpMatch:l}=await Ao(async()=>{const{resumePvpMatch:f}=await Promise.resolve().then(()=>Or);return{resumePvpMatch:f}},void 0);l(c,{state:t,navigate:i,toast:e,openModal:null,closeModal:null,refreshProfile:null},d.dataset.resume)}})}),o.querySelectorAll("[data-abandon]").forEach(d=>{d.addEventListener("click",()=>{Mn(async()=>{await zn(d.dataset.abandon,d.dataset.opp,a),e("Match abandonné (défaite 3-0)","info"),Bo(t,e,i)})})})}async function zn(t,e,i){Gt();const{data:o}=await v.from("matches").select("home_id, away_id, game_state, mode").eq("id",t).single();if(!o)return;const a=o.home_id===i,n=a?0:3,r=a?3:0,s=o.game_state||{};s.p1Score=n,s.p2Score=r,s.phase="finished",s.forfeit=!0,await v.from("matches").update({status:"finished",forfeit:!0,winner_id:e,home_score:n,away_score:r,game_state:s}).eq("id",t),o.mode==="mini_league"&&await v.from("mini_league_matches").update({status:"finished",home_score:n,away_score:r}).eq("match_id",t)}function Mn(t){const e=document.createElement("div");e.className="modal-overlay",e.innerHTML=`<div class="modal" style="max-width:340px">
  ...
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>Po(t,e,()=>qo(t,e)))}async function Do(t,e){const i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:420px;border-radius:18px;overflow:hidden">
    ...
    <div class="modal-body" style="padding:16px">
      ...
      <div class="solo-level-card" data-level="${c.level_number}" data-locked="${l}"
        ...
        <div style="flex:1;min-width:0">
          <div style="font-weight:800;font-size:15px;color:${m}">Niveau ${c.level_number}</div>
        ...
        ${l?"":`<div style="font-weight:900;font-size:12.5px;color:${m};background:rgba(255,255,255,0.7);padding:6px 11px;border-radius:999px;flex-shrink:0;white-space:nowrap">+${c.reward_credits} cr.</div>`}
      </div>`}).join(""),d.querySelectorAll(".solo-level-card").forEach(c=>{c.dataset.locked!=="true"&&(c.addEventListener("mouseenter",()=>{c.style.transform="translateY(-1px)"}),c.addEventListener("mouseleave",()=>{c.style.transform=""}),c.addEventListener("click",()=>{o(),$t(),t("match",{matchMode:"solo",soloLevel:Number(c.dataset.level)})}))})}}const ii="#1A6B3C",oi="#cc2222",jn="#D4A017",mo="#888";async function Bn(t,e){const{state:i,toast:o}=e;t.innerHTML=`
    ...
    </div>`,await Fo(i,o,e),document.getElementById("btn-add-friend").addEventListener("click",()=>Dn(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Po(i,o,null,e))}async function Fo(t,e,i={}){const{navigate:o}=i,a=t.user.id,{data:n,error:r}=await v.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${a},addressee_id.eq.${a}`),{count:s}=await v.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",a).eq("status","pending"),d=document.getElementById("pending-badge");d&&(s>0?(d.style.display="flex",d.textContent=s):d.style.display="none");const c=document.getElementById("friends-list");if(!c)return;if(r){console.error("[Friends] Erreur:",r),c.innerHTML=`<div style="color:${oi};text-align:center;padding:16px">Erreur chargement : ${r.message}</div>`;return}const l=(n||[]).map(x=>x.requester_id===a?x.addressee_id:x.requester_id);let f={};if(l.length){const{data:x}=await v.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",l);(x||[]).forEach(m=>{f[m.id]=m})}const b=(n||[]).map(x=>({friendshipId:x.id,friend:f[x.requester_id===a?x.addressee_id:x.requester_id]||{pseudo:"?"}}));if(!b.length){c.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${b.map(({friendshipId:x,friend:m})=>qn(m,x)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(x=>{x.addEventListener("click",()=>Fn(t,x.dataset.stats,x.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(x=>{x.addEventListener("click",async()=>{const m=x.dataset.friendId,p=x.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const u=t.user.id,{data:y}=await v.from("friend_match_invites").select("id").eq("inviter_id",m).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!y;console.log("[Friends] clic match",{fid:m,fname:p,isAccepting:w}),$t(),o("match",{matchMode:"friend",friendId:m,friendName:p,isAccepting:w})})})}function qn(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",a=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||ii,r=t.club_color1||"#ffffff",s=t.last_seen_at?new Date(t.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
    <div style="display:flex;align-items:center;gap:12px;background:var(--tile-bg);border-radius:12px;padding:12px 14px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
      ...
      <div style="display:flex;gap:8px;flex-shrink:0">
        ...
        <button data-stats="${t.id}" data-friend-name="${i}" title="Voir les stats"
          style="width:38px;height:38px;border-radius:50%;border:2px solid ${jn};background:var(--tile-bg);font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center">📊</button>
      </div>
    </div>`}function Dn(t,e){const i=Xi();i.innerHTML=`
    <div class="popup-box">
    ...
    ${Ji()}`,document.body.appendChild(c);const f=()=>c.remove();c.querySelector("#pending-close").addEventListener("click",f),c.addEventListener("click",b=>{b.target===c&&f()}),c.querySelectorAll("[data-accept]").forEach(b=>{b.addEventListener("click",async()=>{const{error:x}=await v.from("friendships").update({status:"accepted"}).eq("id",b.dataset.accept);if(x){e("Erreur : "+x.message,"error");return}b.closest("div[style]").remove(),e("✅ Ami accepté !","success"),Fo(t,e,o),i&&i()})}),c.querySelectorAll("[data-decline]").forEach(b=>{b.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",b.dataset.decline),b.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function Fn(t,e,i){const o=t.user.id,[a,n]=[o,e].sort(),r=o===a,{data:s}=await v.from("friend_match_stats").select("*").eq("player1_id",a).eq("player2_id",n).single(),d=t.profile.club_name||t.profile.pseudo||"Moi",c=s||{},l=r?c.wins_p1||0:c.wins_p2||0,f=r?c.wins_p2||0:c.wins_p1||0,b=c.draws||0,x=r?c.goals_p1||0:c.goals_p2||0,m=r?c.goals_p2||0:c.goals_p1||0,p=r?c.gc_used_p1||0:c.gc_used_p2||0,u=r?c.gc_used_p2||0:c.gc_used_p1||0,y=c.matches_total||0,w=(L,g,M,E=ii,I=oi)=>`
    ...
    </style>`}async function Pn(t,{state:e,navigate:i,toast:o}){const a=e.profile;if(!a)return;const n="/icons/";jo(i,a,"game",n),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(r=>{r.addEventListener("click",()=>{r.style.transform="scale(.96)",setTimeout(()=>r.style.transform="",180);const s=r.dataset.action;if(s==="match-ai"){Do(i,e);return}if(s==="match-random"){$t(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function No(t,e){var f;const{state:i,navigate:o}=e,a=dn(),n=Vi(),r=(f=i==null?void 0:i.profile)==null?void 0:f.is_admin,s="2026.07.26-2326";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`,t.querySelectorAll("[data-theme-choice]").forEach(b=>{b.addEventListener("click",()=>{va(b.dataset.themeChoice),No(t,e)})});const d=t.querySelector("#volume-slider"),c=t.querySelector("#volume-label");let l=null;d.addEventListener("input",()=>{_n(Number(d.value)),c.textContent=`${d.value}%`,l&&(l.volume=Math.max(0,Math.min(1,Number(d.value)/100)))}),t.querySelector("#volume-test").addEventListener("click",()=>{l=Wi("/sounds/match-opening.mp3",1)}),t.querySelector("#settings-logout").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()})}const Ae={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Pe(t,e){if(!t)return 0;let i=0;switch(e){case"GK":i=Number(t.note_g)||0;break;case"DEF":i=Number(t.note_d)||0;break;case"MIL":i=Number(t.note_m)||0;break;case"ATT":i=Number(t.note_a)||0;break;default:i=0}return i+(t.boost||0)}const go=["ATT","MIL","DEF","GK"];function Go(t,e,i){if(!t||!e)return!1;if(i&&t.position&&e.position)return Ui(i).some(([l,f])=>l===t.position&&f===e.position||l===e.position&&f===t.position);const o=t._col!=null&&e._col!=null&&t._col===e._col,a=t._col!=null&&e._col!=null&&Math.abs(t._col-e._col)===1,n=go.indexOf(t._line||t.job),r=go.indexOf(e._line||e.job),s=Math.abs(n-r)===1;return(t._line||t.job)===(e._line||e.job)&&a||o&&s}function Ro(t,e){let i=0;const o=t.length;for(let a=0;a<o;a++)for(let n=a+1;n<o;n++){const r=t[a],s=t[n];if(!r||!s||!Go(r,s,e))continue;const d=Kt(r,s);d==="#00ff88"?i+=10:d==="#FFD700"&&(i+=5)}return i}function ni(t,e={},i){let o=0,a=0;t.forEach(d=>{const c=d._line||d.job,l=Number(c==="MIL"?d.note_m:d.note_a)||0,f=d.stadiumBonus&&(c==="MIL"||c==="ATT")?10:0;o+=e.doubleAttack?l*2:l,a+=(d.boost||0)+f});const n=o+a,r=Ro(t,i);let s=n+r;return e.stolenNote&&(s-=e.stolenNote),{base:n,links:r,total:Math.max(0,s)}}function ri(t,e={},i){const o=t.reduce((r,s)=>{const d=s._line||s.job;let c=0;d==="GK"?c=Number(s.note_g)||0:d==="MIL"?c=Number(s.note_m)||0:c=Number(s.note_d)||0;const l=s.stadiumBonus&&(d==="GK"||d==="DEF"||d==="MIL")?10:0;return r+c+(s.boost||0)+l},0),a=Ro(t,i);let n=o+a;return e.stolenNote&&(n-=e.stolenNote),{base:o,links:a,total:Math.max(0,n)}}function Qi(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function Oo(t,e,i="easy"){const o=t.filter(r=>!r.used);if(!o.length)return[];const a=[...o].sort((r,s)=>{const d=e==="attack"?Pe(r,"ATT"):r._line==="GK"?Pe(r,"GK"):Pe(r,"DEF");return(e==="attack"?Pe(s,"ATT"):s._line==="GK"?Pe(s,"GK"):Pe(s,"DEF"))-d});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(n,a.length,3))}function Nn(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const Gn={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},zi={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},li=["GK","DEF","MIL","ATT"],Rn=["Tous","GK","DEF","MIL","ATT"],On={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function xo(t){const e=t.player;return e?(e.rarity,Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)):null}function Hn(t){return t.length?t.reduce((e,i)=>xo(i)>xo(e)?i:e,t[0]):t[0]}const Un={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function di(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Mi(t,e=""){const i=t.player;if(!i)return"";const o=t.evolution_bonus||0,a={...i,_evolution_bonus:o},n=e?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${e}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${t.id}">
    ${n}
    ${Se(a,{width:140})}
    ...
    ${Se(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),b=(s||[]).filter($=>$.card_type==="stadium"),{data:x}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),m={};(x||[]).forEach($=>{m[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),b.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const y=Object.keys(Ki),w=Object.keys(Ae),h={};c.forEach($=>{const C=$.player.id;h[C]=(h[C]||0)+1}),new Set(Object.keys(h).map($=>String($)));const L=new Set(f.map($=>$.formation)),g=new Set(l.map($=>$.gc_type));let M="player",E="Tous",I="",D=!1;function O(){return[...c].sort(($,C)=>{const R=li.indexOf($.player.job),P=li.indexOf(C.player.job);return R!==P?R-P:($.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function Y(){return[...d||[]].sort(($,C)=>{const R=li.indexOf($.job),P=li.indexOf(C.job);return R!==P?R-P:($.surname_real||"").localeCompare(C.surname_real||"")})}function J(){return O().filter($=>{const C=$.player,R=E==="Tous"||C.job===E,P=!I||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(I);return R&&P})}function A(){return Y().filter($=>{const C=E==="Tous"||$.job===E,R=!I||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(I);return C&&R})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{D=!D,_(),H()})))}function H(){const $=document.getElementById("col-grid");$&&(M==="player"?U($):M==="formation"?de($):M==="stadium"?ue($):fe($))}function W($,C,R,P,X,q=0){const K=document.getElementById("col-grid"),pe=document.getElementById("col-big");if(!K||!pe)return;var oe=0;function me(){var pt;const we=window.innerWidth>=768,he=document.getElementById("col-big"),Te=document.getElementById("col-gap"),ze=((pt=document.getElementById("col-grid"))==null?void 0:pt.parentElement)||null,Be=he?he.closest(".page"):null;if(he&&ze&&Be){let Ee=0;Array.from(Be.children).forEach(function(B){B!==he&&B!==ze&&B!==Te&&(Ee+=B.offsetHeight)});const je=Math.max(0,Be.clientHeight-Ee),qe=Math.round(je*(q/100)),Ne=Math.max(0,je-qe),k=we?50/71:45/63,T=Math.round(Ne*k),z=Math.max(0,Ne-T);Te&&(Te.style.height=qe+"px"),he.style.flex="none",he.style.height=T+"px",he.style.minHeight="0",ze.style.flex="none",ze.style.height=z+"px",ze.style.minHeight="0",ze.style.display="flex",ze.style.overflow="hidden"}const $e=document.getElementById("col-grid");$e&&($e.style.height="100%",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.width="100%"),pe.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+C($[oe])+"</div>";var Et=pe.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Et&&Et.addEventListener("click",function(){P($[oe])}),requestAnimationFrame(function(){var Ee=document.getElementById("big-card-inner");if(!(!Ee||!pe)){var je=pe.clientHeight,qe=pe.clientWidth-16,Ne=Ee.offsetHeight,k=Ee.offsetWidth;if(Ne>0&&k>0&&je>40){var T=Math.min(je/Ne,qe/k);Ee.style.transform="scale("+T.toFixed(3)+")",Ee.style.transformOrigin="center center"}}}),K.innerHTML=$.map(function(Ee,je){var qe=je===oe,Ne="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+je+'" style="'+Ne+'">'+R(Ee,qe)+"</div>"}).join(""),K.querySelectorAll(".col-mini-item").forEach(function(Ee){Ee.addEventListener("click",function(){oe=Number(Ee.dataset.idx),me(),Ee.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var Ee=$e?$e.clientHeight:0,je=K.querySelector(".col-mini-item > div");if(!(!Ee||!je)){var qe=je.style.zoom;je.style.zoom="1";var Ne=je.offsetHeight;if(je.style.zoom=qe,!(Ne<=0)){var k=Ee/Ne;K.querySelectorAll(".col-mini-item > div").forEach(function(T){T.style.zoom=k.toFixed(4)})}}})}me()}function ae($,C){var R=window.innerWidth>=768?.76:.54,P;if(!$||$._fake){var X=$?$.player:null;if(!X)return"";P=bo(X)}else P=Mi($,"");var q=$&&!$._fake?h[$.player&&$.player.id]||1:0,K=q>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+q+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+R+';pointer-events:none;line-height:0">'+K+P+"</div>"}function le($,C,R){var P=R>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+R+"</div>":"",X=!!C,q=mi($,wt[$],{width:160});return X||(q='<div style="filter:grayscale(1);opacity:0.5">'+q+"</div>"),"<div "+(C?'data-form-id="'+C.id+'"':"")+' style="position:relative;cursor:pointer">'+P+q+"</div>"}function j($,C){var R=window.innerWidth>=768?.76:.54,P=mi($,wt[$],{width:140});return C||(P='<div style="filter:grayscale(1);opacity:0.45">'+P+"</div>"),'<div style="display:inline-block;zoom:'+R+';line-height:0;pointer-events:none">'+P+"</div>"}function U($){if(D){const C=A();if(!C.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const R=C.map(P=>c.find(X=>X.player.id===P.id)||{_fake:!0,player:P,id:"fake-"+P.id});W(R,P=>P._fake?bo(P.player):Mi(P,""),P=>P._fake?ae({player:P.player,id:"x",_fake:!0}):ae(P),P=>{P._fake||yo(P,c,h,e)})}else{const C=J();if(!C.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const R={};C.forEach(X=>{const q=X.player.id;R[q]||(R[q]=[]),R[q].push(X)});const P=Object.values(R).map(X=>Hn(X));W(P,X=>{const q=h[X.player.id]||1,K=q>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${q}</div>`:"",oe=c.filter(me=>me.player.id===X.player.id&&me.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Mi(X,K+oe)},X=>ae(X),X=>yo(X,c,h,e))}}function de($){const C=D?y:[...L];if(!C.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const R=C.map(P=>({formation:P,card:f.find(X=>X.formation===P)||null,owned:L.has(P)}));W(R,({formation:P,card:X,owned:q})=>le(P,q?X:null,q?f.filter(K=>K.formation===P).length:0),({formation:P,owned:X})=>j(P,X),({card:P,owned:X})=>{X&&P&&Yn(P,f,e,n)},"#1A6B3C",5)}function fe($){const C=Object.keys(m),R=D?C.length?C:w:[...g];if(!R.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const P=R.map(X=>({type:X,gc:Ae[X]||{icon:"⚡",desc:""},def:m[X]||null,owned:g.has(X),card:l.find(q=>q.gc_type===X)||null}));W(P,({type:X,gc:q,def:K,owned:pe,card:oe})=>{var $e;const me=(K==null?void 0:K.name)||X,we=pe?l.filter(Et=>Et.gc_type===X).length:0,he=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Te=(K==null?void 0:K.effect)||q.desc||"",ze=K!=null&&K.image_url?`/icons/${K.image_url}`:(($e=K==null?void 0:K.club)==null?void 0:$e.logo_url)||(K!=null&&K.country_code?`https://flagsapi.com/${K.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=it(me,ze,q.icon,Te,{width:160,onClick:pe});return pe||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${pe&&oe?`data-gc-id="${oe.id}" data-gc-type="${X}"`:""} style="position:relative">${he}${Be}</div>`},({type:X,gc:q,def:K,owned:pe})=>{const oe=window.innerWidth>=768?.76:.54,me=(K==null?void 0:K.name)||X,we=(K==null?void 0:K.effect)||q.desc||"",he=K!=null&&K.image_url?`/icons/${K.image_url}`:null;let Te=it(me,he,q.icon,we,{width:140});return pe||(Te=`<div style="filter:grayscale(1);opacity:0.45">${Te}</div>`),`<div style="display:inline-block;zoom:${oe};line-height:0;pointer-events:none">${Te}</div>`},({type:X,owned:q,def:K})=>{q&&Vn(X,K,n)},"#7a28b8",5)}function ue($){const C="#4FC3F7",R="/";if(!b.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const P={};b.forEach(q=>{const K=q.stadium_id||"?";(P[K]=P[K]||[]).push(q)});const X=Object.entries(P).map(([q,K])=>({sid:q,def:u[q]||null,count:K.length,card:K[0]}));W(X,({def:q,count:K})=>{var Te,ze;const pe=(q==null?void 0:q.name)||"?",oe=((Te=q==null?void 0:q.club)==null?void 0:Te.encoded_name)||(q==null?void 0:q.country_code)||"—",me=q!=null&&q.image_url?`${R}icons/${q.image_url}`:((ze=q==null?void 0:q.club)==null?void 0:ze.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=K>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${K}</div>`:"",he=`${oe}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${we}${Ot(pe,me,he,{width:160})}</div>`},({def:q})=>{var he,Te;const K=window.innerWidth>=768?.76:.54,pe=(q==null?void 0:q.name)||"?",oe=((he=q==null?void 0:q.club)==null?void 0:he.encoded_name)||(q==null?void 0:q.country_code)||"—",me=q!=null&&q.image_url?`${R}icons/${q.image_url}`:((Te=q==null?void 0:q.club)==null?void 0:Te.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=`${oe}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${K};line-height:0;pointer-events:none">${Ot(pe,me,we,{width:140})}</div>`},null,C,5)}t.querySelectorAll(".col-tab-btn").forEach($=>{$.addEventListener("click",()=>{M=$.dataset.tab,E="Tous",I="",D=!1,t.querySelectorAll(".col-tab-btn").forEach(C=>{const R=C.dataset.tab===M;C.style.borderBottomColor=R?"var(--green)":"transparent",C.style.color=R?"var(--green)":"var(--tile-fg-dim)"}),_(),H()})}),_(),H()}function Vn(t,e,i){const o=Ae[t]||{icon:"⚡",desc:"Effet spécial."},a=(e==null?void 0:e.name)||t,n=(e==null?void 0:e.effect)||o.desc,r=e!=null&&e.image_url?`/icons/${e.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${it(a,r,o.icon,n,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ci=1e3;function Yn(t,e,i,o){var m,p,u;const{state:a,toast:n,closeModal:r,navigate:s,refreshProfile:d}=i,c=t.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const y=wt[c]||{},w=Ki[c]||[],h=290,L=360,g=20;function M(I){const D=y[I];return D?{x:D.x*h,y:D.y*L}:null}let E=`<svg width="${h}" height="${L}" viewBox="0 0 ${h} ${L}" xmlns="http://www.w3.org/2000/svg">`;for(const[I,D]of w){const O=M(I),Y=M(D);!O||!Y||(E+=`<line x1="${O.x}" y1="${O.y}" x2="${Y.x}" y2="${Y.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const I of Object.keys(y)){const D=M(I);if(!D)continue;const O=I.replace(/\d+/,""),Y=l[O]||"#555";E+=`<circle cx="${D.x}" cy="${D.y}" r="${g}" fill="${Y}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,E+=`<text x="${D.x}" y="${D.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${O}</text>`}return E+="</svg>",E}const b=e.filter(y=>y.formation===c);b.length;const x=!t.is_for_sale;o(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(m=document.getElementById("direct-sell-form-btn"))==null||m.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${c} pour ${ci.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=b.find(h=>!h.is_for_sale)||b[0];if(!y){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",y.id),await v.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await v.from("cards").delete().eq("id",y.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(a.profile.credits||0)+ci}).eq("id",a.profile.id),await d(),n(`+${ci.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",t.id),await v.from("market_listings").insert({seller_id:a.profile.id,card_id:t.id,price:y}),n("Carte mise en vente sur le marché !","success"),r(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),r(),s("collection")})}async function yo(t,e,i,o){var le,j,U,de,fe,ue;const{state:a,toast:n,openModal:r,closeModal:s,navigate:d,refreshProfile:c}=o,l=t.player,f=e.filter($=>$.player.id===l.id),b=f.length,x=t.evolution_bonus||0,m=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?x:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?x:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?x:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?x:0)),p=l.rarity||"normal",{data:u}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",m).gte("note_max",m).order("note_min",{ascending:!1}).limit(1);((le=u==null?void 0:u[0])==null?void 0:le.price)??On[p];const y=l.rarity!=="legende";Ct(l);const w=di(l,l.job)+x,h=l.job2?di(l,l.job2)+(di(l,l.job2)>0?x:0):null;zi[l.job],l.job2&&zi[l.job2];const L=Gn[l.rarity]||"#ccc";Un[l.country_code]||l.country_code;const g=t.evolution_bonus||0,E=w+g,I=h||0,D=I>0?I+g:0,O=f.map($=>$.id);let Y={};if(O.length){const{data:$}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",O).order("transferred_at",{ascending:!0});($||[]).forEach(C=>{Y[C.card_id]||(Y[C.card_id]=[]),Y[C.card_id].push(C)})}const J=O.length?`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(t.evolution_bonus||0)>0?`+${t.evolution_bonus} appliqué${t.evolution_bonus>1?"s":""} · Note : ${E}${l.job2&&I>0?` / ${D}`:""}`:`Note actuelle : ${E}${l.job2&&I>0?` / ${D}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([$,C])=>{const R=zi[$],P=$==="GK"?"#fff":R,X=$===l.job||$===l.job2,q=(Number(C)||0)+(X&&g>0?g:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",s);let A=new Set;const _=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function H(){let $=0;return document.querySelectorAll(".expl-check:checked").forEach(C=>{if(C.dataset.id===t.id)return;const P=Number(C.dataset.evo)||0,X=Number(C.dataset.note)||0;$+=X+P}),Math.round($*_)}const W=()=>{const $=A.size,C=document.getElementById("sell-action-panel");if(!C)return;C.style.display=$>0?"block":"none",document.getElementById("sell-selected-count").textContent=$;const R=document.getElementById("evolve-btn");if(R){const P=H();R.textContent=P>0?`⬆️ Évoluer (+${P})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach($=>{$.addEventListener("change",()=>{const C=$.dataset.id;$.checked?A.add(C):A.delete(C);const R=$.closest(".exemplaire-row");if(R){const P=R.querySelector(".expl-sel-overlay"),X=R.querySelector(".expl-sel-check");P&&(P.style.display=$.checked?"block":"none"),X&&(X.style.display=$.checked?"flex":"none"),R.style.transform=$.checked?"scale(1.05)":"scale(1)"}W()})}),document.querySelectorAll(".exemplaire-row").forEach($=>{$.addEventListener("click",C=>{if(C.target.tagName==="INPUT")return;const R=$.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),(U=document.getElementById("evolve-btn"))==null||U.addEventListener("click",async()=>{if(b<=1)return;const $=[...A];if(!$.length)return;if(A.has(t.id)){const oe=document.createElement("div");oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",oe.innerHTML=`
    ...
    </div>`,document.body.appendChild(o);const a=n=>{o.remove(),i(n)};o.querySelector("#cm-ok").addEventListener("click",()=>a(!0)),o.querySelector("#cm-cancel").addEventListener("click",()=>a(!1)),o.addEventListener("click",n=>{n.target===o&&a(!1)})})}const xi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function qi(t,e){const{state:i,navigate:o,toast:a}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),d=(r||[]).filter(y=>y.card_type==="player"&&y.player),c=(r||[]).filter(y=>y.card_type==="formation"),l=(s||[]).filter(y=>y.card_type==="stadium"),f=[...new Set(l.map(y=>y.stadium_id).filter(Boolean))];let b={};if(l.forEach(y=>{y.stadium_def&&y.stadium_id&&(b[y.stadium_id]=y.stadium_def)}),f.length&&Object.keys(b).length<f.length){const{data:y}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(y||[]).forEach(w=>{b[w.id]=w})}const x=c.map(y=>y.formation).filter(Boolean),{data:m}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let p=n.formation||"4-4-2";x.length>0&&!x.includes(p)&&(p=x[0]);const u={deckId:t,name:n.name,formation:p,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:d,formationCards:c,stadiumCards:l,stadDefMap:b,availableFormations:x};(m||[]).forEach(y=>{y.is_starter?u.slots[y.position]=y.card_id:u.subs.includes(y.card_id)||u.subs.push(y.card_id)}),_t(e,u,i)}function _t(t,e,i){var m,p;const{navigate:o}=i;xi[e.formation];const a=wo(e.formation),n=a.filter(u=>e.slots[u]).length,r=e.availableFormations.length>0?e.availableFormations:Object.keys(xi),s=(m=e.stadiumCards)==null?void 0:m.find(u=>u.id===e.stadiumCardId),d=s&&((p=e.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=e.subs.map(u=>e.playerCards.find(y=>y.id===u)).filter(Boolean);c.length!==e.subs.length&&(e.subs=c.map(u=>u.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{e.formation=h.dataset.forma;const L=wo(e.formation),g={};L.forEach(M=>{e.slots[M]&&(g[M]=e.slots[M])}),e.slots=g,y(),_t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Jn(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>er(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),_t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>Zn(e,t,i)))}function Xn(t,e,i,o){var h,L,g;const a=window.innerWidth>=900,n=t.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const r=(h=e.stadiumCards)==null?void 0:h.find(M=>M.id===e.stadiumCardId),s=r&&((L=e.stadDefMap)==null?void 0:L[r.stadium_id])||null,d=wt[e.formation]||{},c=Ui(e.formation)||[],l={};for(const M of i){const E=e.slots[M],I=E?e.playerCards.find(D=>D.id===E):null;I!=null&&I.player?l[M]={...I.player,_evolution_bonus:I.evolution_bonus||0,face:I.player.face||null}:l[M]=null}const f=window.innerWidth>=900,b=f?window.innerWidth-280:window.innerWidth-20,x=f?Math.min(b,860):b,m=Math.round(f?x*.82:x*.85),p=f?84:44;let u="";for(const[M,E]of c){const I=d[M],D=d[E];if(!I||!D)continue;const O=I.x*x,Y=Math.round(.03*m+I.y*.85*m),J=D.x*x,A=Math.round(.03*m+D.y*.85*m),_=l[M],H=l[E],W=Kt(_,H);W==="#ff3333"||W==="#cc2222"?u+=`<line x1="${O.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${J.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${W}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${O.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${J.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${O.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${J.toFixed(1)}" y2="${A.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const M of i){const E=d[M];if(!E)continue;const I=l[M],D=E.x*x;E.y*m;const O=Math.round(.03*m+E.y*(.85*m)),Y=Math.round(D-p/2),J=Math.round(O-w/2);if(I){const A=M.replace(/\d+/,""),_=s&&(s.club_id&&String(I.club_id)===String(s.club_id)||s.country_code&&I.country_code===s.country_code),H=Se({...I,_evolution_bonus:I._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:A});_&&((g=s.club)!=null&&g.logo_url||s.image_url),y+=`<div style="position:absolute;left:${Y}px;top:${J}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${M}">
    ...
    </div>`),(r=document.getElementById("stad-none"))==null||r.addEventListener("click",()=>{t.stadiumCardId=null,a(),_t(e,t,i)}),document.querySelectorAll(".stad-choice").forEach(s=>{s.addEventListener("click",()=>{t.stadiumCardId=s.dataset.stadId,a(),_t(e,t,i)})})}function Qn(t,e,i,o){var m,p,u,y,w;const{openModal:a,closeModal:n}=o,r=t.replace(/\d+/,""),s=(m=e.stadiumCards)==null?void 0:m.find(h=>h.id===e.stadiumCardId),d=s&&((p=e.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=e.slots[t],l=c?e.playerCards.find(h=>h.id===c):null;(u=l==null?void 0:l.player)==null||u.id;const f=new Set;Object.entries(e.slots).forEach(([h,L])=>{var M;if(h===t||!L)return;const g=e.playerCards.find(E=>E.id===L);(M=g==null?void 0:g.player)!=null&&M.id&&f.add(g.player.id)}),e.subs.forEach(h=>{var g;const L=e.playerCards.find(M=>M.id===h);(g=L==null?void 0:L.player)!=null&&g.id&&f.add(L.player.id)});const b=new Set,x=e.playerCards.filter(h=>{const L=h.player;return!(L.job===r||L.job2===r)||f.has(L.id)||b.has(L.id)?!1:(b.add(L.id),!0)});x.sort((h,L)=>{const g=h.evolution_bonus||0,M=L.evolution_bonus||0,E=(r==="GK"?h.player.note_g:r==="DEF"?h.player.note_d:r==="MIL"?h.player.note_m:h.player.note_a)+(r===h.player.job||r===h.player.job2?g:0);return(r==="GK"?L.player.note_g:r==="DEF"?L.player.note_d:r==="MIL"?L.player.note_m:L.player.note_a)+(r===L.player.job||r===L.player.job2?M:0)-E}),a(`Choisir ${r} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(y=document.getElementById("close-selector"))==null||y.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),_t(i,e,o)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{e.slots[t]=h.dataset.cardId,n(),_t(i,e,o)})})}function Zn(t,e,i){var l,f,b;const{openModal:o,closeModal:a}=i,n=(l=t.stadiumCards)==null?void 0:l.find(x=>x.id===t.stadiumCardId),r=n&&((f=t.stadDefMap)==null?void 0:f[n.stadium_id])||null,s=new Set;Object.keys(t.slots).forEach(x=>{var u;const m=t.slots[x];if(!m)return;const p=t.playerCards.find(y=>y.id===m);(u=p==null?void 0:p.player)!=null&&u.id&&s.add(p.player.id)}),t.subs.forEach(x=>{var p;const m=t.playerCards.find(u=>u.id===x);(p=m==null?void 0:m.player)!=null&&p.id&&s.add(m.player.id)});const d=new Set,c=t.playerCards.filter(x=>{var m,p,u;return s.has((m=x.player)==null?void 0:m.id)||d.has((p=x.player)==null?void 0:p.id)?!1:(d.add((u=x.player)==null?void 0:u.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${n.map(m=>{const p=m.cost===0||a>=m.cost,u=l[m.id]===!0;return`<div class="booster-card ${!p||u?"disabled":""}" data-booster="${m.id}" style="position:relative">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:r}).eq("id",e.user.id)};async function f(){var w;if(c>=d||!r.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),a&&await a(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const m=r[0],{data:p}=await v.from("users").select("*").eq("id",e.user.id).single();p&&(e.profile=p);let u=[];try{if(m.type==="formation")u=await Wo(e.profile,0);else if(m.type==="game_changer")u=await Yo(e.profile,m.count||3,0);else if(s&&((w=s.rates)!=null&&w.length)){const h={...s,cost:0,cardCount:m.count||s.cardCount||5};u=await Fi(e.profile,h),m.guaranteeGK&&!e.profile.first_booster_opened&&(u.some(g=>g.player&&g.player.job==="GK")||await mr(e.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else u=await Vo(e.profile,m.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}r.shift(),c++,await l();const y=m.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:m.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${c}/${d})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};Xo(u,y,i,()=>{f()})}(x=document.getElementById("onboard-start"))==null||x.addEventListener("click",()=>f())}async function mr(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],a=e.findIndex(r=>r.player);if(a===-1)return;const n=e[a];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[a]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const kt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},gr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function At(t,e,i,o,a){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",a)}function Pi(t,e){var n,r;const i=t.player,o=t.evolution_bonus||0,a=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:t.id,position:e||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?o:0)+(i.job2==="GK"&&a>0?o:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?o:0)+(i.job2==="DEF"&&a>0?o:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?o:0)+(i.job2==="MIL"&&a>0?o:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?o:0)+(i.job2==="ATT"&&a>0?o:0),evolution_bonus:o,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((r=i.clubs)==null?void 0:r.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function ai(t,e){if(!e||!t)return t;const{club_id:i,country_code:o}=e;return Object.values(t).forEach(a=>{Array.isArray(a)&&a.forEach(n=>{const r=i&&String(n.club_id)===String(i),s=o&&String(n.country_code)===String(o);(r||s)&&(n.stadiumBonus=!0)})}),t}function bi(t,e){if(!e||!(t!=null&&t.length))return t;const{club_id:i,country_code:o}=e;return t.forEach(a=>{if(!a)return;const n=i&&String(a.club_id)===String(i),r=o&&String(a.country_code)===String(o);(n||r)&&(a.stadiumBonus=!0)}),t}function st(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function Jo(){const t=Math.random()*100;return t<10?10:t<30?5:3}function yi(t,e){const i=kt[e]||kt["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]};if(t.length&&t.every(r=>r.position)){for(const r of["GK","DEF","MIL","ATT"]){const s=t.filter(c=>c.position&&c.position.replace(/\d+$/,"")===r).sort((c,l)=>parseInt(c.position.replace(/\D+/g,""),10)-parseInt(l.position.replace(/\D+/g,""),10)).map(c=>({...c,_line:r})),d=st(s.length);s.forEach((c,l)=>{c._col=d[l]}),o[r]=s}return o}const n=[...t];for(const r of["GK","DEF","MIL","ATT"]){const s=[];for(let c=0;c<i[r];c++){let l=n.findIndex(f=>f.job===r);if(l===-1&&(l=n.findIndex(f=>f.job2===r)),l===-1&&(l=0),n[l]){const f={...n[l],_line:r};s.push(f),n.splice(l,1)}}const d=st(s.length);s.forEach((c,l)=>{c._col=d[l]}),o[r]=s}return o}function lt(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.setProperty("display","none","important"),e.dataset.matchHidden="1"}),t&&t.style.setProperty("padding-bottom","0","important")}function Ke(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.removeProperty("display"),delete e.dataset.matchHidden}),t&&t.style.removeProperty("padding-bottom")}function ki(t,e,i){const a=new Set,n=e.filter(l=>{const f=l.gc_type||l.id;return a.has(f)?!1:(a.add(f),!0)});let r=[];function s(l,f){const b=l._gcDef,x=(b==null?void 0:b.name)||l.gc_type,m=b!=null&&b.image_url?`/icons/${b.image_url}`:null,p=it(x,m,"⚡",(b==null?void 0:b.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${l.id}"
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${n.map(m=>{const p=r.find(u=>u.gc_type===m.gc_type);return s(m,!!p)}).join("")}
      </div>
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),d=[...new Set((s||[]).filter(b=>{var x,m;return((x=b.card)==null?void 0:x.card_type)==="stadium"&&((m=b.card)==null?void 0:m.stadium_id)}).map(b=>b.card.stadium_id))],c={};if(d.length){const{data:b}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(b||[]).forEach(x=>{c[x.id]=x}),(s||[]).forEach(x=>{var m,p;((m=x.card)==null?void 0:m.card_type)==="stadium"&&((p=x.card)!=null&&p.stadium_id)&&(x.card._stadiumDef=c[x.card.stadium_id]||null)})}let l=0;function f(){var g,M,E,I,D,O,Y;const b=n[l],x=(s||[]).filter(J=>J.deck_id===b.id),m=x.filter(J=>{var A;return J.is_starter&&((A=J.card)==null?void 0:A.player)}).map(J=>Pi(J.card,J.position)),p=x.find(J=>{var A;return((A=J.card)==null?void 0:A.card_type)==="formation"}),u=b.formation||((g=p==null?void 0:p.card)==null?void 0:g.formation)||"4-4-2";let y=m.length>=11?yi(m,u):null,w=((M=b.stadium_card)==null?void 0:M.stadium_def)||null;w&&y&&(y=ai(y,w));const h=m.length>=11;lt(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <!-- Pagination -->
      ${n.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${n.map((J,A)=>`<div style="width:6px;height:6px;border-radius:50%;background:${A===l?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function J(){const A=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!A||!_||!y)return;const H=_.clientWidth>=900,W=Math.max(200,_.clientHeight-(H?60:40)),le=Math.max(200,_.clientWidth-16),j=H?Math.min(117,Math.max(52,Math.round(le*.22))):Math.max(44,Math.round(le*.168));if(W<220||le<220){requestAnimationFrame(J);return}const U=H?null:Math.round(j*.55);A.innerHTML=Ht(y,u,null,[],le,W,[],U),A.style.cssText=`width:${le}px;height:${W}px;overflow:hidden;margin:${H?0:60}px auto 0`;const de=A.querySelector("svg");de&&(de.style.cssText="display:block;width:100%;height:100%",de.setAttribute("preserveAspectRatio",H?"xMidYMid meet":"none"))})),(I=document.getElementById("prev-deck"))==null||I.addEventListener("click",()=>{l>0&&(l--,f())}),(D=document.getElementById("next-deck"))==null||D.addEventListener("click",()=>{l<n.length-1&&(l++,f())}),(O=document.getElementById("validate-deck"))==null||O.addEventListener("click",()=>{if(!h)return;const J=e.state.params||{};e.navigate("match",{...J,matchMode:J.matchMode||i,deckId:b.id})}),(Y=document.getElementById("cancel-deck-select"))==null||Y.addEventListener("click",()=>{Ke(t),a("home")});const L=document.getElementById("deck-swipe-zone");if(L){let J=0,A=0;L.addEventListener("touchstart",_=>{J=_.touches[0].clientX,A=_.touches[0].clientY},{passive:!0}),L.addEventListener("touchend",_=>{const H=_.changedTouches[0].clientX-J,W=_.changedTouches[0].clientY-A;Math.abs(H)<40||Math.abs(H)<Math.abs(W)||(H<0&&l<n.length-1?(l++,f()):H>0&&l>0&&(l--,f()))},{passive:!0})}}f()}function vt(t,e=44,i=58,o=null){return Se(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function Qe(t,e,i,o,a){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let r='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,d)=>{const c=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(c==="ATT"||c==="MIL")||o==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?l+=10:o||(l+=10)),r+=Se(s,{width:40,role:c,extraNote:l}),d<n.length-1){const f=n[d+1],b=Go(s,f,a)?Kt(s,f):null;r+=`<div style="width:7px;height:3px;background:${!b||b==="#ff3333"||b==="#cc2222"?"rgba(255,255,255,0.12)":b};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(r+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),r+="</div>",r}function $i(t,e,i,o,a=310,n=310,r=[],s=null){const d=wt[e]||{},c=Ui(e)||Ki[e]||[],l={},f=["ATT","MIL","DEF","GK"];for(const y of f)(t[y]||[]).forEach((h,L)=>{l[`${y}${L+1}`]=h});function b(y){const w=d[y];return w?{x:w.x*a,y:w.y*n}:null}let x="";for(const[y,w]of c){const h=b(y),L=b(w);if(!h||!L)continue;const g=l[y],M=l[w],E=Kt(g,M);E==="#00ff88"||E==="#FFD700"?(x+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${L.x.toFixed(1)}" y2="${L.y.toFixed(1)}"
        ...
        stroke="${E}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const m=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(a*.225)),117):Math.max(44,Math.round(a*.168)),p=Math.round(m*657/507);for(const[y,w]of Object.entries(l)){const h=b(y);if(!h||!w)continue;const L=y.replace(/[0-9]/g,""),g=r.includes(w.cardId),M=i==="attack"&&(["MIL","ATT"].includes(L)||g)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(L)&&!w.used,E=o.includes(w.cardId);let I=w.boost||0,D=!1;w.stadiumBonus&&(i==="attack"&&(L==="ATT"||L==="MIL")||i==="defense"&&(L==="GK"||L==="DEF"||L==="MIL")?(I+=10,D=!0):i||(I+=10,D=!0));const O=Math.round(h.x-m/2),Y=Math.round(h.y-p/2);if(w.used){x+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${O}" y="${Y}" width="${m}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${L}" style="cursor:pointer"/>`;continue}const J=Se({...w,_evolution_bonus:0,stadiumBonus:!1},{width:m,showStad:!1,stadDef:null,role:L,extraNote:I,_cardOffset:30,_forceStadColor:D}),A=E?`position:absolute;top:30px;left:0;width:${m}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";x+=`<foreignObject x="${O-2}" y="${Y-30}" width="${m+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${J}
        ${E?`<div style="${A}"></div>`:""}
      </div>
    </foreignObject>`,M&&(x+=`<rect x="${O}" y="${Y}" width="${m}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${w.cardId}" data-role="${L}" style="cursor:pointer"/>`)}const u=s!==null?s:Math.round(Math.max(m*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${a+u*2} ${n+u*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${x}
  </svg>`}function Ht(t,e,i,o,a=300,n=300,r=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${$i(t,e,i,o,a,n,r,s)}
  </div>`}async function Ei(t,e,i,o){var M;const{state:a,navigate:n,toast:r}=e;lt(t);const s=a.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return br(t,e,i);const d=s.deckId;let c,l,f,b;try{const E=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",d).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]);c=E[0].data,f=E[0].error,l=E[1].data,b=E[1].error}catch(E){console.error("[Match] Exception chargement deck:",E),At(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(f||b){console.error("[Match] Erreur Supabase:",f||b),At(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const x=(l||[]).filter(E=>{var I;return E.is_starter&&((I=E.card)==null?void 0:I.player)}).map(E=>Pi(E.card,E.position)),m=(l||[]).filter(E=>{var I;return!E.is_starter&&((I=E.card)==null?void 0:I.player)}).map(E=>Pi(E.card,E.position));if(x.length<11){At(t,"⚠️",`Deck incomplet (${x.length}/11).`,"Compléter",()=>n("decks"));return}const p=(l||[]).find(E=>{var I;return((I=E.card)==null?void 0:I.card_type)==="formation"}),u=(c==null?void 0:c.formation)||((M=p==null?void 0:p.card)==null?void 0:M.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",a.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),L=(y||[]).map(E=>({...E,_gcDef:(h==null?void 0:h.find(I=>I.name===E.gc_type||I.id===E.gc_definition_id))||null}));let g=null;if(c!=null&&c.stadium_card_id){const{data:E}=await v.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if(E!=null&&E.stadium_id){const{data:I}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",E.stadium_id).single();g=I||null}}o({deckId:d,formation:u,starters:x,subsRaw:m,gcCardsEnriched:L,gcDefs:h||[],stadiumDef:g})}function zt(){return Math.min(window.innerWidth-40,860)}function Rt(){return Math.round(zt()*1.1)}function Qo(t){var a,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((a=t.clubs)==null?void 0:a.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Ct(t)}}function yr(t,e,i,o="Adversaire"){Mo("/sounds/match-opening.mp3",.3);const a=zt(),n=Rt();return`
    ...
    </div>`}function Ze(t,e,i,o,a){Wi("/sounds/goal.mp3",.7);const n=document.getElementById("goal-anim-overlay");n&&n.remove();const r=document.createElement("div");r.id="goal-anim-overlay",r.style.cssText=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,a.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.3s",setTimeout(()=>a.remove(),300)},i)}function en(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function bt(t,e){return t.reduce((i,o)=>i+en(o,e),0)}function yt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Kt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function hi(t,e,i,o,a){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,r)=>{const s=r<t.length-1?Kt(n,t[r+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return en(n,a),n.stadiumBonus||a&&(a.club_id&&String(n.club_id)===String(a.club_id)||a.country_code&&(n.country_code,a.country_code)),`
    ...
    </div>`}async function vr(t,e){const{state:i}=e,o=i.params||{},a=o.matchMode||"vs_ai_easy",n=a==="solo",r=o.soloLevel||1,s=a.replace("vs_ai_",""),d=a;let c=null;if(n){const{data:l}=await v.from("solo_levels").select("*").eq("level_number",r).maybeSingle();c=l||{level_number:r,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}await Ei(t,e,a,async({deckId:l,formation:f,starters:b,subsRaw:x,gcCardsEnriched:m,gcDefs:p,stadiumDef:u})=>{try{let y=yi(b,f);u&&(y=ai(y,u),bi(x,u));const w=n?await _r(f,c):await wr(f,s),h=w.lines||w,L=async g=>{try{const M=d==="vs_ai_club"||d==="solo"?"club":d,{data:E,error:I}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:M,home_deck_id:l,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),At(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const D=w.stadiumDef||null;D&&h&&(ai(h,D),bi(w.subs||[],D));const O={gcDefs:p||[],matchId:E==null?void 0:E.id,mode:d,difficulty:s,formation:f,isSolo:n,soloLevel:r,soloLevelConfig:c,homeTeam:y,aiTeam:h,homeSubs:x,subsUsed:0,maxSubs:Math.min(x.length,3),aiSubs:w.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((w.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:w.gcCards||[],aiUsedGc:[],aiStadiumDef:D,homeScore:0,aiScore:0,gcCards:g,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};kr(t,O,e)}catch(M){console.error("[MatchIA] Exception launchMatch:",M),At(t,"⚠️","Erreur au lancement du match : "+M.message,"Retour",()=>e.navigate("home"))}};if(!m.length){L([]);return}ki(t,m,L)}catch(y){console.error("[MatchIA] Exception setup:",y),At(t,"⚠️","Erreur de préparation du match : "+y.message,"Retour",()=>e.navigate("home"))}})}async function wr(t,e){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:tn(t),subs:[],gcCards:[],stadiumDef:null};const o=kt[t]||kt["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function r(y,w,h){var L,g;return n.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((L=y.clubs)==null?void 0:L.encoded_name)||null,clubLogo:((g=y.clubs)==null?void 0:g.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter(E=>E.job===y&&!n.has(E.id)),h=i.filter(E=>E.job!==y&&!n.has(E.id)),L=[...w,...h],g=[];for(let E=0;E<o[y];E++){const I=L[E];I&&g.push(r(I,y,E))}const M=st(g.length);g.forEach((E,I)=>{E._col=M[I]}),a[y]=g}const d=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>r(y,y.job,100+w)),f=Object.keys(Ae).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var h,L;return{id:"ai-gc-"+w,gc_type:y,name:((h=Ae[y])==null?void 0:h.name)||y,icon:((L=Ae[y])==null?void 0:L.icon)||"⚡"}}),b=Object.values(a).flat(),x={};b.forEach(y=>{y.club_id&&(x[y.club_id]=(x[y.club_id]||0)+1)});const m=(u=Object.entries(x).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(m){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",m).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:a,subs:d,gcCards:f,stadiumDef:p}}function _o(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function pi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((a,n)=>Math.abs(_o(a)-e)-Math.abs(_o(n)-e));return o.slice(0,Math.min(i,o.length))}async function _r(t,e){var J,A;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,a=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:r}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!r||r.length<16)return{lines:tn(t),subs:[],gcCards:[],stadiumDef:null};const s={};r.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const d=((J=Object.entries(s).sort((_,H)=>H[1]-_[1])[0])==null?void 0:J[0])||null,c=d?r.filter(_=>_.club_id===d):[],l=((A=c[0])==null?void 0:A.country_code)||null,f=l?r.filter(_=>_.country_code===l&&_.club_id!==d):[],b=Math.min(c.length,Math.max(2,a+1),16),x=Math.min(f.length,Math.max(0,o),16-b),m=[],p=new Set;pi(c,i,b).forEach(_=>{m.push(_),p.add(_.id)}),pi(f,i,x).forEach(_=>{m.push(_),p.add(_.id)});const u=Math.max(0,16-m.length),y=r.filter(_=>!p.has(_.id));pi(y,i,u).forEach(_=>{m.push(_),p.add(_.id)});const w=kt[t]||kt["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},L=new Set;function g(_,H,W){var ae,le;return L.add(_.id),{cardId:"ai-"+_.id+"-"+W,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((ae=_.clubs)==null?void 0:ae.encoded_name)||null,clubLogo:((le=_.clubs)==null?void 0:le.logo_url)||null,boost:0,used:!1,_line:H}}for(const _ of["GK","DEF","MIL","ATT"]){const H=m.filter(U=>U.job===_&&!L.has(U.id)),W=m.filter(U=>U.job!==_&&!L.has(U.id)),ae=[...H,...W],le=[];for(let U=0;U<w[_];U++){const de=ae[U];de&&le.push(g(de,_,U))}const j=st(le.length);le.forEach((U,de)=>{U._col=j[de]}),h[_]=le}let M=m.filter(_=>!L.has(_.id));if(M.length<5){const _=r.filter(H=>!L.has(H.id)&&!M.some(W=>W.id===H.id));M=M.concat(pi(_,i,5-M.length))}const E=M.slice(0,5).map((_,H)=>g(_,_.job,100+H)),O=Object.keys(Ae).sort(()=>Math.random()-.5).slice(0,3).map((_,H)=>{var W,ae;return{id:"ai-gc-"+H,gc_type:_,name:((W=Ae[_])==null?void 0:W.name)||_,icon:((ae=Ae[_])==null?void 0:ae.icon)||"⚡"}});let Y=null;if(n>0&&d){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",d).single();_&&(Y={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:E,gcCards:O,stadiumDef:Y}}function tn(t){const e=kt[t]||kt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const n of["GK","DEF","MIL","ATT"]){const r=[];for(let d=0;d<e[n];d++){const c=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:o[a%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?c:2,note_d:n==="DEF"?c:2,note_m:n==="MIL"?c:2,note_a:n==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:n}),a++}const s=st(r.length);r.forEach((d,c)=>{d._col=s[c]}),i[n]=r}return i}function kr(t,e,i){var a;Mo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`;const l=()=>{const m=(p,u)=>t.querySelectorAll(p).forEach((y,w)=>{setTimeout(()=>{y.style.opacity="1",y.style.transform="translateY(0) scale(1)"},u+w*90)});m(".duel-card-home",150),m(".duel-card-ai",500),setTimeout(()=>t.querySelectorAll(".duel-link").forEach((p,u)=>{setTimeout(()=>{p.style.opacity="1"},u*70)}),900),setTimeout(()=>{const p=t.querySelector("#vs-label");p&&(p.style.opacity="1",p.style.animation="vsFlash .5s ease"),t.querySelectorAll(".duel-score-line").forEach(u=>u.style.opacity="1")},1250),setTimeout(()=>{f("score-home",s,800),f("score-ai",d,800)},1500)};function f(m,p,u){const y=document.getElementById(m);if(!y)return;const w=performance.now(),h=L=>{const g=Math.min(1,(L-w)/u);y.textContent=Math.round(p*(1-Math.pow(1-g,3))),g<1?requestAnimationFrame(h):y.textContent=p};requestAnimationFrame(h)}requestAnimationFrame(l),e.attacker=c?"home":"ai";const b=c?Jo():null;c&&(e.boostCard={value:b}),e.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:o.map(m=>Ve(m)),aiPlayers:a.map(m=>Ve(m)),homeTotal:s,aiTotal:d,text:`Duel milieu : ${e.clubName} ${s} – ${d} IA → ${c?e.clubName+" attaque":"IA attaque"}`});const x=()=>{e.phase=e.attacker==="home"?"attack":"ai-attack",ke(t,e,i),e.attacker==="ai"&&setTimeout(()=>eo(t,e,i),800)};setTimeout(()=>{const m=document.getElementById("score-home"),p=document.getElementById("score-ai"),u=document.getElementById(c?"duel-row-home":"duel-row-ai"),y=document.getElementById(c?"duel-row-ai":"duel-row-home"),w=c?m:p,h=c?p:m;w&&(w.style.fontSize="80px",w.style.color=c?"#FFD700":"#ff6b6b",w.style.animation="duelPulse .5s ease"+(c?", duelGlow 1.5s ease infinite .5s":"")),h&&(h.style.opacity="0.25"),setTimeout(()=>{u&&(u.style.transformOrigin="center",u.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",u.style.zIndex="5"),setTimeout(()=>{var g;const L=document.getElementById("duel-shock");if(L){const M=(g=y||u)==null?void 0:g.getBoundingClientRect(),E=t.querySelector(".match-screen").getBoundingClientRect();M&&(L.style.top=M.top-E.top+M.height/2+"px"),L.style.animation="shockwave .5s ease-out forwards"}y&&(y.style.transformOrigin="center",y.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var g;const L=document.getElementById("duel-finale");L&&(L.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const j=window.innerWidth>=700,U=(q,K,pe)=>{var ze,Be;const oe=(e.gcDefs||[]).find($e=>$e.name===q.gc_type),me=(oe==null?void 0:oe.name)||q.gc_type,we=(oe==null?void 0:oe.effect)||((ze=Ae[q.gc_type])==null?void 0:ze.desc)||"",he=oe!=null&&oe.image_url?`/icons/${oe.image_url}`:null,Te=((Be=Ae[q.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${q.id}" data-gc-type="${q.gc_type}" style="flex-shrink:0;cursor:pointer">
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Ht(e.homeTeam,e.formation,e.phase,o,j?1300:zt(),j?600:Rt(),m)}
        </div>
      </div>`;return j?`
  ...
  <div id="match-history-panel">
  ...
  </div>`;function I(){const j=t.querySelector(".match-screen");if(!j)return;const U=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);j.style.bottom="auto",j.style.height=U+"px",j.style.minHeight=U+"px",j.style.maxHeight=U+"px",j.style.overflow="hidden";const de=t.querySelector("#mobile-action-bar"),fe=t.querySelector("#mobile-play-area");de&&fe&&(fe.style.paddingBottom=de.offsetHeight+"px")}if(I(),setTimeout(I,120),setTimeout(I,400),setTimeout(I,1e3),e._vvBound||(e._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",I),window.visualViewport.addEventListener("scroll",I)),window.addEventListener("resize",I)),function(){const U=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!U)return;const de=U.closest("#match-terrain-wrap");de&&(de.style.cssText="position:relative;width:100%;height:100%;padding:0"),U.removeAttribute("width"),U.removeAttribute("height"),U.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",U.setAttribute("preserveAspectRatio","xMidYMid meet")}(),e._resizeBound||(e._resizeBound=!0,window.addEventListener("resize",()=>{const j=t.querySelector(".terrain-wrapper svg");if(j){const U=j.closest("#match-terrain-wrap");U&&(U.style.cssText="position:relative;width:100%;height:100%;padding:0"),j.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ue(),e.phase==="attack"||e.phase==="defense"){let j=!1,U=30;const de=()=>document.getElementById("match-timer"),fe=()=>{const ue=de();if(!ue)return;const $=String(Math.floor(U/60)).padStart(2,"0"),C=String(U%60).padStart(2,"0");ue.textContent=` ${$}:${C}`,ue.style.color=j?"#ff2222":"#ff9500",ue.style.fontWeight="900"};fe(),e._timerInt=setInterval(()=>{if(U--,U<0)if(!j)j=!0,U=15,fe(),Co("/sounds/timer-urgent.mp3",.6);else{clearInterval(e._timerInt),e._timerInt=null,Ue(),e.homeScore=0,e.aiScore=3;const ue=document.createElement("div");ue.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",ue.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(ue),setTimeout(()=>{ue.remove(),ht(t,e,i)},2500)}else fe()},1e3)}(O=document.getElementById("match-quit"))==null||O.addEventListener("click",()=>{Ke(t),confirm("Abandonner ? Résultat : défaite 3-0")&&(e.homeScore=0,e.aiScore=3,ht(t,e,i))}),(Y=document.getElementById("view-ai"))==null||Y.addEventListener("click",()=>Br(e,i)),(J=document.getElementById("toggle-history"))==null||J.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.add("open")}),(A=document.getElementById("close-history"))==null||A.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.remove("open")}),(_=document.getElementById("btn-action"))==null||_.addEventListener("click",()=>{e.selected.length!==0&&(u?Lr(t,e,i):y&&Tr(t,e,i))}),(H=document.getElementById("btn-results"))==null||H.addEventListener("click",()=>ht(t,e,i)),(W=document.getElementById("btn-pass"))==null||W.addEventListener("click",()=>{if(e.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Ni(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(t,e,i);return}e.phase="ai-attack",ke(t,e,i),setTimeout(()=>eo(t,e,i),800)}),t.querySelectorAll(".match-slot-hit").forEach(j=>{j.addEventListener("click",()=>Er(j,e,t,i))}),t.querySelectorAll(".match-used-hit").forEach(j=>{j.addEventListener("click",()=>Ci(t,e,i,null,j.dataset.cardId))}),t.querySelectorAll(".gc-mini").forEach(j=>{u?j.addEventListener("click",()=>zr(j.dataset.gcId,j.dataset.gcType,t,e,i)):(j.style.opacity="0.35",j.style.cursor="default",j.addEventListener("click",()=>Tt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(ae=document.getElementById("boost-card"))==null||ae.addEventListener("click",()=>jr(t,e,i)),t.querySelectorAll(".sub-btn-col").forEach(j=>{j.addEventListener("click",()=>Ci(t,e,i,j.dataset.subId))}),(le=document.getElementById("sub-btn-main"))==null||le.addEventListener("click",()=>Ci(t,e,i))}function Er(t,e,i,o){const a=t.dataset.cardId,n=t.dataset.role,r=e.selected.findIndex(s=>s.cardId===a);if(r!==-1)e.selected.splice(r,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const s=(e.homeTeam[n]||[]).find(d=>d.cardId===a);s&&e.selected.push({...s,_role:n,_line:n})}ke(i,e,o)}function Zi(t,e,i){t.matchId&&v.from("matches").update({last_player_id:i}).eq("id",t.matchId).then(()=>{})}function Lr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ue(),Zi(e,i,i.state.profile.id);const o=e.selected.map(n=>{const r=(e.homeTeam[n._role]||[]).find(d=>d.cardId===n.cardId)||n,s=["GK","DEF"].includes(n._role);return{...r,_line:n._role,...s?{note_a:Math.max(1,Number(r.note_a)||0)}:{}}}),a=ni(o,e.modifiers.home,e.formation);e.pendingAttack={...a,players:[...o],side:"home"},e.selected.forEach(n=>{const r=(e.homeTeam[n._role]||[]).find(s=>s.cardId===n.cardId);r&&(r.used=!0)}),e.log.push({text:`⚔️ Vous attaquez : ${a.total} (base ${a.base}${a.links?` +${a.links} liens`:""}) — ${e.selected.map(n=>n.name).join(", ")}`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",ke(t,e,i),setTimeout(()=>Ar(t,e,i),1200)}function Tr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ue(),Zi(e,i,i.state.profile.id);const o=e.stadiumDef||null,a=e.selected.map(d=>{const c=(e.homeTeam[d._role]||[]).find(f=>f.cardId===d.cardId)||d,l=c.stadiumBonus||o&&(o.club_id&&String(c.club_id)===String(o.club_id)||o.country_code&&c.country_code===o.country_code)||!1;return{...c,_line:d._role,stadiumBonus:l}}),n=ri(a,e.modifiers.home,e.formation);e.selected.forEach(d=>{const c=(e.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);c&&(c.used=!0)});const r=Qi(e.pendingAttack.total,n.total,e.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(e.pendingAttack.players||[]).map(d=>Ve(d)),homePlayers:e.selected.map(d=>{const c=(e.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return Ve(c)}),homeTotal:n.total,aiTotal:e.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(r.shielded)s.text="🛡️ Bouclier ! But annulé.",e.log.push(s);else if(r.goal){e.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${e.pendingAttack.total} > ${n.total})`,e.log.push(s),e.selected=[],e.modifiers.home={},e.pendingAttack=null,ke(t,e,i),Ze(s.aiPlayers,e.homeScore,e.aiScore,!1,()=>{Mt(t,e,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${n.total} ≥ ${e.pendingAttack.total})`,e.log.push(s);e.selected=[],e.modifiers.home={},e.pendingAttack=null,Mt(t,e,i,"home-attack")}function Ir(t){if(t.aiSubsUsed>=t.aiMaxSubs)return;const e=Object.values(t.aiTeam).flat().filter(d=>d.used);if(!e.length)return;const i=(t.aiSubs||[]).filter(d=>!t.aiUsedSubIds.includes(d.cardId));if(!i.length)return;const o=e[Math.floor(Math.random()*e.length)],a=i.find(d=>d.job===o.job)||i[0],n={...a,used:!1,_line:o._line,_col:o._col},r=t.aiTeam[o._line],s=r.findIndex(d=>d.cardId===o.cardId);s!==-1&&(r[s]=n),t.aiUsedSubIds.push(a.cardId),t.aiSubsUsed++,t.log.push({text:`🔄 IA : ${a.firstname} ${a.name} remplace ${o.firstname} ${o.name}`,type:"info"})}function Sr(t){var o;if(!((o=t.aiGcCards)!=null&&o.length))return;const e=t.aiGcCards.filter(a=>!t.aiUsedGc.includes(a.id));if(!e.length||Math.random()>.3)return;const i=e[Math.floor(Math.random()*e.length)];switch(t.aiUsedGc.push(i.id),Ae[i.gc_type],i.gc_type){case"Boost+2":{const a=Object.values(t.aiTeam).flat().filter(n=>!n.used);if(a.length){const n=a[Math.floor(Math.random()*a.length)];n.boost=(n.boost||0)+2}break}case"Boost+3":{const a=Object.values(t.aiTeam).flat().filter(n=>!n.used);if(a.length){const n=a[Math.floor(Math.random()*a.length)];n.boost=(n.boost||0)+3}break}case"Remplacement+":t.aiMaxSubs=(t.aiMaxSubs||3)+1;break;case"Bouclier":t.modifiers.ai.shield=!0;break;case"Nul+1":t.modifiers.ai.drawBonus=(t.modifiers.ai.drawBonus||0)+1;break}t.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function eo(t,e,i){Zi(e,i,null),Ir(e),Sr(e);let o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(l=>!l.used),a=!1;if(!o.length){const l=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(b=>!b.used),f=Ut(e.homeTeam);if(f||l.length===0){const b=(e.aiTeam.DEF||[]).filter(m=>!m.used),x=(e.aiTeam.GK||[]).filter(m=>!m.used);o=f?b.length?b:x:[...b,...x],a=!0}}const n=Oo(o,"attack",e.difficulty);if(!n.length){Gi(t,e,i);return}a&&n.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const r=ni(n,e.modifiers.ai,e.formation);e.pendingAttack={...r,players:n,side:"ai"},n.forEach(l=>{l.used=!0}),e.log.push({text:`🤖 IA attaque : ${r.total} (${n.map(l=>l.name).join(", ")})`,type:"info"}),e.modifiers.ai={};const s=[...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(l=>!l.used),c=(e.homeSubs||[]).filter(l=>!(e.usedSubIds||[]).includes(l.cardId)).length>0&&e.subsUsed<e.maxSubs;if(s.length===0&&!c){if(n.length===1&&(n[0]._line==="GK"||n[0].job==="GK")&&Ut(e.homeTeam)&&e.homeScore===e.aiScore){e.aiScore++,vi(t,e,i,"ai",n[0]);return}e.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:n.map(b=>Ve(b)),aiTotal:r.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};e.log.push(f),e.pendingAttack=null,ke(t,e,i),Ze(f.aiPlayers,e.homeScore,e.aiScore,!1,()=>{Mt(t,e,i,"home-attack")});return}e.phase="defense",ke(t,e,i)}function Ar(t,e,i){var c,l;const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],a=Oo(o,"defense",e.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(e.aiTeam[f]||[]).filter(b=>!b.used)).length){const f=((c=e.pendingAttack)==null?void 0:c.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&e.homeScore===e.aiScore){e.homeScore++,vi(t,e,i,"home",f[0]);return}e.homeScore++;const x={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(m=>Ve(m)),homeTotal:((l=e.pendingAttack)==null?void 0:l.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};e.log.push(x),e.modifiers.ai={},e.pendingAttack=null,ke(t,e,i),Ze(x.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}const r=a.length>0?ri(a,e.modifiers.ai,e.formation).total:0;a.forEach(f=>{f.used=!0});const s=Qi(e.pendingAttack.total,r,e.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(e.pendingAttack.players||[]).map(f=>Ve(f)),aiPlayers:a.map(f=>Ve(f)),homeTotal:e.pendingAttack.total,aiTotal:r,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",e.log.push(d);else if(s.goal){e.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${e.pendingAttack.total} > ${r})`,e.log.push(d),e.modifiers.ai={},e.pendingAttack=null,ke(t,e,i),Ze(d.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}else d.text=`🧤 IA défend (${r} ≥ ${e.pendingAttack.total})`,e.log.push(d);e.modifiers.ai={},e.pendingAttack=null,Mt(t,e,i,"ai-attack")}function Mt(t,e,i,o){if(e.round++,!on(t,e,i)){if(to(e)){ht(t,e,i);return}if(o==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used))){Gi(t,e,i);return}e.phase="attack",ke(t,e,i)}else{if(!["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used))){Gi(t,e,i);return}e.phase="ai-attack",ke(t,e,i),setTimeout(()=>eo(t,e,i),800)}}}function Ut(t){return!["GK","DEF","MIL","ATT"].some(e=>(t[e]||[]).some(i=>!i.used))}function ko(t){const e=(t.GK||[]).some(o=>!o.used),i=["DEF","MIL","ATT"].some(o=>(t[o]||[]).some(a=>!a.used));return e&&!i}function on(t,e,i){if(e.homeScore!==e.aiScore)return!1;if(ko(e.homeTeam)&&Ut(e.aiTeam)){const o=(e.homeTeam.GK||[]).find(a=>!a.used);return o?(o.used=!0,e.homeScore++,vi(t,e,i,"home",o),!0):!1}if(ko(e.aiTeam)&&Ut(e.homeTeam)){const o=(e.aiTeam.GK||[]).find(a=>!a.used);return o?(o.used=!0,e.aiScore++,vi(t,e,i,"ai",o),!0):!1}return!1}function vi(t,e,i,o,a){e.log.push({type:"duel",isGoal:!0,homeScored:o==="home",homePlayers:o==="home"?[Ve(a)]:[],aiPlayers:o==="ai"?[Ve(a)]:[],text:`⚽ DERNIER CORNER — Le gardien ${o==="home"?"":"adverse "}marque !`});const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(n);const r=(s,d)=>new Promise(c=>{n.innerHTML=`<div style="font-size:32px;font-weight:900;color:${d};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await r("⚽ DERNIER CORNER","#FFD700"),await r("🧤 LE GARDIEN MONTE !","#4fc3f7"),n.remove(),e.pendingAttack=null,ke(t,e,i),Ze([Ve(a)],e.homeScore,e.aiScore,o==="home",()=>{if(to(e)){ht(t,e,i);return}Mt(t,e,i,o==="home"?"ai-attack":"home-attack")})))()}function to(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used));return!e&&!i}function Ni(t,e){return!(["MIL","ATT"].some(a=>(t[a]||[]).some(n=>!n.used))||Ut(e)||!["MIL","ATT"].some(a=>(e[a]||[]).some(n=>!n.used)))}function Gi(t,e,i){if(!on(t,e,i)){if(to(e)){ht(t,e,i);return}if(Ni(e.homeTeam,e.aiTeam)&&Ni(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),ht(t,e,i);return}e.phase="attack",ke(t,e,i)}}function Ci(t,e,i,o=null,a=null){var x,m;if(e.phase!=="attack"){Tt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(e.usedSubIds||(e.usedSubIds=[]),e.subsUsed>=e.maxSubs){Tt(`Maximum ${e.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const n=Object.entries(e.homeTeam).flatMap(([p,u])=>(u||[]).filter(y=>y.used).map(y=>({...y,_line:y._line||p}))),r=e.homeSubs.filter(p=>!e.usedSubIds.includes(p.cardId));if(!n.length){Tt("Aucun joueur utilisé à remplacer");return}if(!r.length){Tt("Aucun remplaçant disponible");return}let s=Math.max(0,n.findIndex(p=>p.cardId===a));const d=((x=n[s])==null?void 0:x._line)||((m=n[s])==null?void 0:m.job);let c=o?Math.max(0,r.findIndex(p=>p.cardId===o)):Math.max(0,r.findIndex(p=>p.job===d)),l=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function b(){var g,M,E,I,D,O;const p=n[s],u=r[c],y=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(y*1.35),h=Y=>`background:rgba(255,255,255,0.12);border:none;color:${Y?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Y?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(g=f.querySelector("#sub-close"))==null||g.addEventListener("click",()=>f.remove()),(M=f.querySelector("#out-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,b())}),(E=f.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<n.length-1&&(s++,b())}),(I=f.querySelector("#in-up"))==null||I.addEventListener("click",()=>{c>0&&(c--,b())}),(D=f.querySelector("#in-down"))==null||D.addEventListener("click",()=>{c<r.length-1&&(c++,b())});const L=(Y,J,A,_)=>{const H=f.querySelector("#"+Y);if(!H)return;let W=0;H.addEventListener("touchstart",ae=>{W=ae.touches[0].clientY},{passive:!0}),H.addEventListener("touchend",ae=>{const le=ae.changedTouches[0].clientY-W;if(Math.abs(le)<30)return;const j=J();le<0&&j<_-1?(A(j+1),b()):le>0&&j>0&&(A(j-1),b())},{passive:!0})};L("in-panel",()=>c,Y=>c=Y,r.length),L("out-panel",()=>s,Y=>s=Y,n.length),(O=f.querySelector("#sub-confirm"))==null||O.addEventListener("click",Y=>{if(Y.preventDefault(),Y.stopPropagation(),l)return;l=!0;const J=n[s],A=r[c];if(!J||!A)return;let _=null,H=-1;for(const[ae,le]of Object.entries(e.homeTeam)){const j=(le||[]).findIndex(U=>U.cardId===J.cardId);if(j!==-1){_=ae,H=j;break}}if(H===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const W={...A,_line:_,_col:J._col||0,used:!1,boost:0};e.homeTeam[_].splice(H,1,W),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(A.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:J.name,firstname:J.firstname,note:Pe(J,_),portrait:Ct(J),job:J.job,country_code:J.country_code,rarity:J.rarity,clubName:J.clubName,clubLogo:J.clubLogo},inPlayer:{name:A.name,firstname:A.firstname,note:Pe(A,_),portrait:Ct(A),job:A.job,country_code:A.country_code,rarity:A.rarity,clubName:A.clubName,clubLogo:A.clubLogo},text:`🔄 ${A.firstname} ${A.name} remplace ${J.firstname} ${J.name}`}),f.remove(),hr(J,A,()=>ke(t,e,i))})}document.body.appendChild(f),b()}function zr(t,e,i,o,a){var b,x;const n=(o.gcDefs||[]).find(m=>m.name===e),r=Ae[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,d=(n==null?void 0:n.effect)||r.desc,c=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=r.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${it(s,c,l,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(b=f.querySelector("#gc-back"))==null||b.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),Cr(t,e,i,o,a)})}function ui(t,e,i,o,a,n){const r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var c,l;r.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(f=>{const b=f._line||f.job||"MIL",x=s.find(p=>p.cardId===f.cardId),m=Se({...f,_evolution_bonus:0},{width:90,showStad:!0,role:b,extraNote:f.boost||0});return`<div class="gc-pick-item" data-cid="${f.cardId}"
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[r]||[]).find(d=>d.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),ke(t,e,i)})})}async function ht(t,e,i){var l,f,b,x;Gt(),Ue(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,a=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,r=a?"victoire":n?"nul":"defaite",s=e.isSolo&&((l=e.soloLevelConfig)!=null&&l.reward_credits)&&a?Number(e.soloLevelConfig.reward_credits):Nn(e.mode,r);if(e.isSolo&&a)try{const{data:m}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),p=(m==null?void 0:m.unlocked_level)||1;e.soloLevel>=p&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(m){console.warn("[Solo] Erreur mise à jour progression:",m.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:a?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const d={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};a?d.wins=(o.profile.wins||0)+1:n?d.draws=(o.profile.draws||0)+1:d.losses=(o.profile.losses||0)+1,await v.from("users").update(d).eq("id",o.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${$i(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            </div>`}}catch(ee){console.error("[Ranked] MMR update error:",ee)}(ie=document.getElementById("pvp-end-overlay"))==null||ie.remove();const F=document.createElement("div");F.id="pvp-end-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const N=S?"🤝":B?"🏆":"😞",V=S?"MATCH NUL":B?"VICTOIRE !":"DÉFAITE",Z=S?"#fff":B?"#FFD700":"#ff6b6b";F.innerHTML=`
      ...
      <div style="font-size:18px">${g[p+"Name"]} ${T} – ${z} ${g[u+"Name"]}</div>
      ${k.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${B?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${G}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(F),(te=F.querySelector("#pvp-end-home"))==null||te.addEventListener("click",()=>{F.remove(),Ke(t),l?x("mini-league",{openLeagueId:l}):x(r?"ranked":"home")})}const J=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{var z;const T=k.new;try{if(T.status==="finished"||T.forfeit){if(M)return;M=!0,E&&(clearInterval(E),E=null),Ue(),T.game_state&&(g=T.game_state),Y(T);return}if(T.game_state){const B=g;g=T.game_state;const S=g._lastGC;if(S&&S.seq&&!O.has(S.seq)&&(O.add(S.seq),S.by!==p)){$(S.type,S.by,()=>U());return}const G=B[p+"Score"]||0,F=B[u+"Score"]||0,N=g[p+"Score"]||0,V=g[u+"Score"]||0,Z=N>G,ie=V>F;if((Z||ie)&&!D.has(g.round)){D.add(g.round);const te=[...g.log||[]].reverse().find(se=>se.isGoal),ee=((te==null?void 0:te.homePlayers)||[]).map(se=>({name:se.name,note:se.note,portrait:se.portrait,job:se.job}));!!((z=te==null?void 0:te.text)!=null&&z.includes("DERNIER CORNER"))?we().then(()=>{Ze(ee,N,V,Z,()=>U())}):Ze(ee,N,V,Z,()=>U());return}U()}}catch(B){console.error("[PvP] crash:",B)}}).subscribe();async function A(k){Object.assign(g,k),g.lastActionAt=new Date().toISOString();const{error:T}=await v.from("matches").update({game_state:g}).eq("id",i);T&&m("Erreur de synchronisation","error");try{U()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function _(){if(M)return;M=!0,Gt(),Ue(),E&&(clearInterval(E),E=null);const k=o?h.away_id:h.home_id,T=o?"p2":"p1",z=o?"p1":"p2",B={...g,[T+"Score"]:3,[z+"Score"]:0,phase:"finished"},S=B.p1Score||0,G=B.p2Score||0;try{await v.from("matches").update({game_state:B}).eq("id",i);const{data:F,error:N}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:S,p_away_score:G,p_forfeit:!0});if(N&&console.error("[PvP] finish_pvp_match (forfeit):",N),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(V){console.error("[PvP] check_and_finish_mini_league (forfeit):",V)}try{const{data:V}=await v.rpc("apply_match_rewards",{p_match_id:i});V!=null&&V.success&&!(V!=null&&V.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(V){console.error("[PvP] apply_match_rewards (forfeit):",V)}}catch{}try{v.removeChannel(J)}catch{}setTimeout(()=>{Ke(t),l?x("mini-league",{openLeagueId:l}):x("home")},800)}const H={BOOST_STAT:({value:k=1,count:T=1,roles:z=[]},B,S)=>{const G=B[p+"Team"],F=Object.entries(G).filter(([N])=>!z.length||z.includes(N)).flatMap(([N,V])=>V.filter(Z=>!Z.used).map(Z=>({...Z,_line:N})));if(!F.length){B.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),S(B);return}W(F,T,`Choisir ${T} joueur(s) à booster (+${k})`,N=>{N.forEach(V=>{const Z=(G[V._line]||[]).find(ie=>ie.cardId===V.cardId);Z&&(Z.boost=(Z.boost||0)+k,B.log.push({text:`⚡ +${k} sur ${Z.name}`,type:"info"}))}),B[p+"Team"]=G,S(B)})},DEBUFF_STAT:({value:k=1,count:T=1,roles:z=[],target:B="ai"},S,G)=>{const F=B==="home"?p:u,N=S[F+"Team"],V=B==="home"?"allié":"adverse",Z=Object.entries(N).filter(([ie])=>!z.length||z.includes(ie)).flatMap(([ie,te])=>te.map(ee=>({...ee,_line:ie})));if(!Z.length){S.log.push({text:`🎯 Aucun joueur ${V}`,type:"info"}),G(S);return}W(Z,T,`Choisir ${T} joueur(s) ${V}(s) (-${k})`,ie=>{ie.forEach(te=>{const ee=(N[te._line]||[]).find(re=>re.cardId===te.cardId);ee&&(ee.boost=(ee.boost||0)-k,S.log.push({text:`🎯 -${k} sur ${ee.name}`,type:"info"}))}),S[F+"Team"]=N,G(S)})},GRAY_PLAYER:({count:k=1,roles:T=[],target:z="ai"},B,S)=>{const G=z==="home"?p:u,F=B[G+"Team"],N=z==="home"?"allié":"adverse",V=Object.entries(F).filter(([Z])=>!T.length||T.includes(Z)).flatMap(([Z,ie])=>ie.filter(te=>!te.used).map(te=>({...te,_line:Z})));if(!V.length){B.log.push({text:`❌ Aucun joueur ${N}`,type:"info"}),S(B);return}W(V,k,`Choisir ${k} joueur(s) ${N}(s) à exclure`,Z=>{const ie="usedCardIds_"+G,te=new Set(B[ie]||[]);Z.forEach(ee=>{const re=(F[ee._line]||[]).find(se=>se.cardId===ee.cardId);re&&(re.used=!0,te.add(ee.cardId),B.log.push({text:`❌ ${re.name} exclu !`,type:"info"}))}),B[ie]=[...te],B[G+"Team"]=F,S(B)})},REVIVE_PLAYER:({count:k=1,roles:T=[]},z,B)=>{const S=z[p+"Team"],G=Object.entries(S).filter(([F])=>!T.length||T.includes(F)).flatMap(([F,N])=>N.filter(V=>V.used).map(V=>({...V,_line:F})));if(!G.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),B(z);return}W(G,k,`Choisir ${k} joueur(s) à ressusciter`,F=>{F.forEach(N=>{const V=(S[N._line]||[]).find(Z=>Z.cardId===N.cardId);V&&(V.used=!1,z.log.push({text:`💫 ${V.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=S,B(z)})},REMOVE_GOAL:({},k,T)=>{const z=u+"Score";k[z]>0?(k[z]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),T(k)},ADD_GOAL_DRAW:({},k,T)=>{k[p+"Score"]===k[u+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),T(k)},ADD_SUB:({value:k=1},T,z)=>{T.maxSubs=(T.maxSubs||3)+k,T.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),z(T)},CUSTOM:({},k,T)=>T(k)};function W(k,T,z,B){const S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let G=[];function F(){var V,Z;const N=k.map(ie=>{const te=ie._line||ie.job||"MIL",ee=G.find(se=>se.cardId===ie.cardId),re=Se({...ie,_evolution_bonus:0},{width:90,showStad:!0,role:te,extraNote:ie.boost||0});return`<div class="pp-item" data-cid="${ie.cardId}"
        ...
        </div>`,(V=S.querySelector("#pp-close"))==null||V.addEventListener("click",()=>S.remove()),S.querySelectorAll(".pp-item").forEach(ie=>{ie.addEventListener("click",()=>{const te=ie.dataset.cid,ee=k.find(se=>se.cardId===te),re=G.findIndex(se=>se.cardId===te);ee&&(re>-1?G.splice(re,1):G.length<T&&G.push(ee),F())})}),(Z=S.querySelector("#pp-confirm"))==null||Z.addEventListener("click",()=>{S.remove(),B(G)})}F(),document.body.appendChild(S)}async function ae(k,T){const B=(g["gcCardsFull_"+p]||[]).find(N=>N.id===k),S=(B==null?void 0:B._gcDef)||(g.gcDefs||[]).find(N=>{var V;return N.name===T||((V=N.name)==null?void 0:V.toLowerCase().trim())===(T==null?void 0:T.toLowerCase().trim())}),G=[...g["usedGc_"+p]||[],k],F={type:T,by:p,seq:(g._gcAnimSeq||0)+1};O.add(F.seq),$(T,p,async()=>{if(S!=null&&S.effect_type&&S.effect_type!=="CUSTOM"){const V=H[S.effect_type];if(V){const Z={...g};V(S.effect_params||{},Z,async ie=>{ie["usedGc_"+p]=G,ie._lastGC=F,ie._gcAnimSeq=F.seq,await A(ie)});return}}const N={...g};switch(T){case"Remplacement+":N.maxSubs=(N.maxSubs||3)+1,N.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const V=u+"Score";N[V]>0&&(N[V]--,N.log.push({text:"🚫 But annulé",type:"info"}));break}}N["usedGc_"+p]=G,N._lastGC=F,N._gcAnimSeq=F.seq,await A(N)})}function le(k,T){const z="usedCardIds_"+k,B=new Set(g[z]||[]);T.forEach(S=>B.add(S)),g[z]=[...B]}function j(){for(const k of["p1","p2"]){const T=new Set(g["usedCardIds_"+k]||[]),z=g[k+"Team"];if(z)for(const B of["GK","DEF","MIL","ATT"])(z[B]||[]).forEach(S=>{S.used=T.has(S.cardId)})}}function U(){var no,ro,ao,so,lo,co;if(g.phase==="reveal")return de();if(g.phase==="midfield")return ue();if(g.phase==="finished")return Ne();const k=g[p+"Team"],T=g[u+"Team"];j();const z=g[p+"Score"],B=g[u+"Score"],S=g[p+"Name"],G=g[u+"Name"],F=g.phase===p+"-attack",N=g.phase===p+"-defense",V=Array.isArray(g["selected_"+p])?g["selected_"+p]:[],Z=V.map(Q=>Q.cardId),ie=window.innerWidth>=700,te=g[p+"Subs"]||[],ee=g["usedSubIds_"+p]||[],re=te.filter(Q=>!ee.includes(Q.cardId)),se=g["gcCardsFull_"+p]||[],xe=g["usedGc_"+p]||[],ce=se.filter(Q=>!xe.includes(Q.id)),be=g.boostOwner===p&&!g.boostUsed,ve=[...k.MIL||[],...k.ATT||[]].filter(Q=>!Q.used),ne=[...T.MIL||[],...T.ATT||[]].filter(Q=>!Q.used),Le=!$e(T),Ge=ve.length===0&&ne.length===0&&!Le,Ie=(k.DEF||[]).filter(Q=>!Q.used),Ye=(k.GK||[]).filter(Q=>!Q.used);let Oe=[];F&&ve.length===0&&(Le?(Oe=Ie.map(Q=>Q.cardId),Ie.length===0&&(Oe=Oe.concat(Ye.map(Q=>Q.cardId)))):Ge&&(Oe=[...Ie,...Ye].map(Q=>Q.cardId)));function ot(Q,ge,Me){var Ce,mt;const _e=Q._gcDef,Dt=(_e==null?void 0:_e.name)||Q.gc_type,at=(_e==null?void 0:_e.effect)||((Ce=Ae[Q.gc_type])==null?void 0:Ce.desc)||"",Fe=_e!=null&&_e.image_url?`/icons/${_e.image_url}`:null,Re=((mt=Ae[Q.gc_type])==null?void 0:mt.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${Q.id}" data-gc-type="${Q.gc_type}" style="flex-shrink:0;cursor:pointer">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ht(k,g[p+"Formation"],ft,Z,ie?1300:zt(),ie?600:Rt(),Oe)}
      </div>
    </div>`,rt=g[p+"Team"],un=(()=>{var ge,Me,_e,Dt,at;if(N&&((ge=g.pendingAttack)!=null&&ge.players)){const Fe=g.pendingAttack;let Re="";if(V.length>0){const Ce=V.map(Xe=>{const Yt=(rt[Xe._role]||[]).find(Ii=>Ii.cardId===Xe.cardId)||Xe,Wt=rt[Xe._role]||[],si=Wt.findIndex(Ii=>Ii.cardId===Xe.cardId),Ti=st(Wt.length),Xt=si>=0?Ti[si]:Yt._col??1;return{...Yt,_line:Xe._role,_col:Xt}}),mt=ri(Ce,((Me=g.modifiers)==null?void 0:Me[p])||{},g[p+"Formation"]);Re=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Qe(Ce.map(Xe=>({...Xe,used:!1})),"#3a7bd5",mt.total,"defense",g[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Qe((Fe.players||[]).map(Ce=>({...Ce,used:!1})),"#ff6b6b",Fe.total,"attack",g[u+"Formation"])}</div>
          ${Re}
          ...
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Qe((Fe.players||[]).map(Re=>({...Re,used:!1})),"#00ff88",Fe.total,"attack",g[p+"Formation"])}</div>
          ...
          <div style="display:flex;justify-content:center">${Qe(Fe.map(Ce=>({...Ce,used:!1})),"#FFD700",Re.total,"attack",g[p+"Formation"])}</div>
        </div>`}const Q=(g.log||[]).slice(-1)[0];return Q?'<div style="padding:2px 4px">'+Zo(Q)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),oo=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Ht(k,g[p+"Formation"],ft,Z,zt(),Rt(),Oe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        ${it(G,N,V,F,{width:200})}
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(te);let ee=!1;const re=()=>{ee||(ee=!0,te.remove(),setTimeout(()=>z&&z(),50))};te.addEventListener("click",re),setTimeout(re,3e3)}function C(k,T){var ie,te,ee,re;const B=(g["gcCardsFull_"+p]||[]).find(se=>se.id===k),S=B==null?void 0:B._gcDef,G=(S==null?void 0:S.name)||T,F=(S==null?void 0:S.effect)||((ie=Ae[T])==null?void 0:ie.desc)||"Carte spéciale.",N=S!=null&&S.image_url?`/icons/${S.image_url}`:null,V=((te=Ae[T])==null?void 0:te.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ${it(G,N,V,F,{width:190})}
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(Z),(ee=Z.querySelector("#pvp-gc-back"))==null||ee.addEventListener("click",()=>Z.remove()),(re=Z.querySelector("#pvp-gc-use"))==null||re.addEventListener("click",()=>{Z.remove(),ae(k,T)})}function R(){var B;const k=g[p+"Team"],T=Object.entries(k).flatMap(([S,G])=>(G||[]).filter(F=>!F.used).map(F=>({...F,_line:S})));if(!T.length)return;const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",z.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      </div>`,document.body.appendChild(z),(B=z.querySelector("#bp-close"))==null||B.addEventListener("click",()=>z.remove()),z.querySelectorAll(".bp-item").forEach(S=>{S.addEventListener("click",async()=>{const G=S.dataset.cid,F=T.find(V=>V.cardId===G);if(!F)return;const N=(k[F._line]||[]).find(V=>V.cardId===G);N&&(N.boost=(N.boost||0)+g.boostValue),z.remove(),await A({[p+"Team"]:k,boostUsed:!0})})})}function P(k=null){var re,se;if(!(g.phase===p+"-attack")){m("Remplacement uniquement avant votre attaque","warning");return}const z=g[p+"Team"],B=g["usedSubIds_"+p]||[],S=g.maxSubs||3;if(B.length>=S){m(`Maximum ${S} remplacements atteint`,"warning");return}const G=Object.entries(z).flatMap(([xe,ce])=>(ce||[]).filter(be=>be.used).map(be=>({...be,_line:xe}))),F=(g[p+"Subs"]||[]).filter(xe=>!B.includes(xe.cardId));if(!G.length){m("Aucun joueur utilisé à remplacer","warning");return}if(!F.length){m("Aucun remplaçant disponible","warning");return}let N=Math.max(0,G.findIndex(xe=>xe.cardId===k));const V=((re=G[N])==null?void 0:re._line)||((se=G[N])==null?void 0:se.job);let Z=Math.max(0,F.findIndex(xe=>xe.job===V)),ie=!1;const te=document.createElement("div");te.id="pvp-sub-overlay",te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function ee(){var Ge,Ie,Ye,Oe,ot,Vt;const xe=G[N],ce=F[Z],be=Math.min(130,Math.round((window.innerWidth-90)/2)),ve=Math.round(be*1.35),ne=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;te.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(Ge=te.querySelector("#psub-close"))==null||Ge.addEventListener("click",()=>te.remove()),(Ie=te.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{N>0&&(N--,ee())}),(Ye=te.querySelector("#pout-down"))==null||Ye.addEventListener("click",()=>{N<G.length-1&&(N++,ee())}),(Oe=te.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{Z>0&&(Z--,ee())}),(ot=te.querySelector("#pin-down"))==null||ot.addEventListener("click",()=>{Z<F.length-1&&(Z++,ee())});const Le=(De,We,He,ut)=>{const nt=te.querySelector("#"+De);if(!nt)return;let Bt=0;nt.addEventListener("touchstart",ft=>{Bt=ft.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",ft=>{const Lt=ft.changedTouches[0].clientY-Bt;if(Math.abs(Lt)<30)return;const rt=We();Lt<0&&rt<ut-1?(He(rt+1),ee()):Lt>0&&rt>0&&(He(rt-1),ee())},{passive:!0})};Le("pin-panel",()=>Z,De=>Z=De,F.length),Le("pout-panel",()=>N,De=>N=De,G.length),(Vt=te.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ie)return;ie=!0;const We=G[N],He=F[Z];if(!We||!He)return;const ut=We._line,nt=(z[ut]||[]).findIndex(Lt=>Lt.cardId===We.cardId);if(nt===-1){m("Erreur : joueur introuvable","error"),te.remove();return}const Bt={...He,_line:ut,position:We.position,used:!1,boost:0};z[ut].splice(nt,1,Bt);const ft=[...B,He.cardId];te.remove(),X(We,He,async()=>{await A({[p+"Team"]:z,[u+"Team"]:g[u+"Team"],["usedSubIds_"+p]:ft})})})}document.body.appendChild(te),ee()}function X(k,T,z){const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const G=(V,Z,ie)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(S);let F=!1;const N=()=>{F||(F=!0,S.remove(),setTimeout(()=>z(),50))};S.addEventListener("click",N),setTimeout(N,2200)}function q(){var T;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${g[u+"Name"]}</div>
      <div style="width:min(90vw,420px)">${$i(g[u+"Team"],g[u+"Formation"],null,[],zt(),Rt())}</div>
      ...
      </div>`,document.body.appendChild(T),(z=T.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>T.remove())}async function pe(){if(g.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",T=(g.round||0)+1,z=[...g.log||[]];z.push({type:"info",text:`⏭️ ${g[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const B=Ee(g),S=pt(k),G=B||!S?"finished":k+"-attack";await A({["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:G,attacker:k,round:T,log:z}),G==="finished"&&await qe(g)}function oe(k){const T=(k.GK||[]).some(B=>!B.used),z=["DEF","MIL","ATT"].some(B=>(k[B]||[]).some(S=>!S.used));return T&&!z}function me(k){return(k.p1Score||0)!==(k.p2Score||0)?null:oe(k.p1Team)&&!$e(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(T=>!T.used)}:oe(k.p2Team)&&!$e(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(T=>!T.used)}:null}async function we(){const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(k);const T=(z,B)=>new Promise(S=>{k.innerHTML=`<div style="font-size:32px;font-weight:900;color:${B};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(S,1400)});await T("⚽ DERNIER CORNER","#FFD700"),await T("🧤 LE GARDIEN MONTE !","#4fc3f7"),k.remove()}async function he(k,T){const{side:z,gk:B}=k;if(!B)return;const S=z+"Score",G=(T[S]||0)+1;B.used=!0;const F=[...T.log||[]];F.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[Ft(B)]:[],aiPlayers:z==="p2"?[Ft(B)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${T[z+"Name"]} marque !`});const N=(T.round||0)+1,V=z==="p1"?"p2":"p1",Z={...T,[S]:G},ie=Ee(Z);D.add(N),await we();const te=z===p?G:T[p+"Score"]||0,ee=z===p?T[u+"Score"]||0:G;Ze([Ft(B)],te,ee,z===p,async()=>{await A({[S]:G,log:F,round:N,pendingAttack:null,phase:ie?"finished":V+"-attack",attacker:V,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}}}),ie&&await qe({...g,[S]:G})})}async function Te(){const k=g[p+"Team"],T=!["GK","DEF","MIL","ATT"].some(G=>(g[u+"Team"][G]||[]).some(F=>!F.used)),z=(g["selected_"+p]||[]).map(G=>{const F=(k[G._role]||[]).find(se=>se.cardId===G.cardId)||G,N=["GK","DEF"].includes(G._role),V=k[G._role]||[],Z=V.findIndex(se=>se.cardId===G.cardId),ie=st(V.length),te=Z>=0?ie[Z]:F._col??1,ee=g.stadiumDef||g.homeStadiumDef||null,re=F.stadiumBonus||ee&&(ee.club_id&&String(F.club_id)===String(ee.club_id)||ee.country_code&&F.country_code===ee.country_code)||!1;return{...F,_line:G._role,_col:te,stadiumBonus:re,...N?{note_a:Math.max(1,Number(F.note_a)||0)}:{}}});if(!z.length)return;const B=ni(z,g.modifiers[p]||{},g[p+"Formation"]);le(p,z.map(G=>G.cardId)),z.forEach(G=>{const F=(k[G._role]||[]).find(N=>N.cardId===G.cardId);F&&(F.used=!0)}),g["selected_"+p]=[],U();const S=[...g.log||[]];if(T){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(g.p1Score||0)===(g.p2Score||0)){await he({side:p,gk:z[0]},{...g,[p+"Team"]:k,log:S});return}const F=(g[p+"Score"]||0)+1,N=z.map(ee=>Ft(ee));S.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:N,homeTotal:B.total,aiTotal:0});const V=(g.round||0)+1,Z=p==="p1"?"p2":"p1",ie={...g,[p+"Team"]:k,[p+"Score"]:F},te=Ee(ie);D.add(V),Ze(N,F,g[u+"Score"]||0,!0,async()=>{await A({[p+"Team"]:k,[p+"Score"]:F,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:te?"finished":Z+"-attack",attacker:Z,round:V,log:S}),te&&await qe({...g,[p+"Score"]:F})});return}S.push({type:"pending",text:`⚔️ ${g[p+"Name"]} attaque (${B.total})`}),await A({[p+"Team"]:k,[u+"Team"]:g[u+"Team"],pendingAttack:{...B,players:z,side:p},["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},phase:u+"-defense",log:S})}async function ze(){const k=g[p+"Team"],T=(g["selected_"+p]||[]).map(ce=>{const be=(k[ce._role]||[]).find(Ie=>Ie.cardId===ce.cardId)||ce,ve=k[ce._role]||[],ne=ve.findIndex(Ie=>Ie.cardId===ce.cardId),Le=st(ve.length),Ge=ne>=0?Le[ne]:be._col??1;return{...be,_line:ce._role,_col:Ge}}),z=ri(T,g.modifiers[p]||{},g[p+"Formation"]);le(p,T.map(ce=>ce.cardId)),T.forEach(ce=>{const be=(k[ce._role]||[]).find(ve=>ve.cardId===ce.cardId);be&&(be.used=!0)}),g["selected_"+p]=[],U();const B=Qi(g.pendingAttack.total,z.total,g.modifiers[p]||{}),S=g.pendingAttack.side,G=B==="attack"||(B==null?void 0:B.goal),F=S==="p1"?"p2":"p1",N=(g.round||0)+1,V=(g.pendingAttack.players||[]).map(ce=>Ft(ce)),Z=[...g.log||[]];Z.push({type:"duel",isGoal:G,homeScored:G&&S===p,text:G?`⚽ BUT de ${g[S+"Name"]} ! (${g.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${g.pendingAttack.total} vs ${z.total})`,homePlayers:V,aiPlayers:T.map(ce=>Ft(ce)),homeTotal:g.pendingAttack.total,aiTotal:z.total});const ie=G?(g[S+"Score"]||0)+1:g[S+"Score"]||0,te={...g,[p+"Team"]:k,[S+"Score"]:ie},ee=Ee(te),re=ee?"finished":F+"-attack",se=!ee&&!G?me(te):null,xe=async()=>{if(se){await he(se,te);return}await A({[p+"Team"]:k,[u+"Team"]:g[u+"Team"],[S+"Score"]:ie,["selected_"+p]:[],modifiers:{...g.modifiers,[p]:{}},pendingAttack:null,phase:re,attacker:F,round:N,log:Z}),(re==="finished"||ee)&&await qe({...g,[S+"Score"]:ie})};if(G){const ce=S===p,be=ce?ie:g[p+"Score"]||0,ve=ce?g[u+"Score"]||0:ie;D.add(N),Ze(V,be,ve,ce,xe)}else await xe()}function Be(k){return["MIL","ATT"].some(T=>(k[T]||[]).some(z=>!z.used))}function $e(k){return["GK","DEF","MIL","ATT"].some(T=>(k[T]||[]).some(z=>!z.used))}function Et(k){return $e(k)&&!Be(k)}function pt(k){const T=g[k+"Team"],z=g[(k==="p1"?"p2":"p1")+"Team"];return!!(Be(T)||Et(T)&&!$e(z)||Et(T)&&!Be(z)&&$e(z))}function Ee(k){return!$e(k.p1Team)&&!$e(k.p2Team)}function je(k){const T=k.p1Score||0,z=k.p2Score||0;return T===z?null:T>z?h.home_id:h.away_id}async function qe(k){Gt(),Ue();try{const T=je(k),z=T?h.home_id===T?h.away_id:h.home_id:null,B=k.p1Score||0,S=k.p2Score||0,{data:G,error:F}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:T,p_home_score:B,p_away_score:S,p_forfeit:!1});if(F&&console.error("[PvP] finish_pvp_match:",F),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(N){console.error("[PvP] check_and_finish_mini_league:",N)}T&&z&&Fr(T,z).catch(()=>{});try{const{data:N}=await v.rpc("apply_match_rewards",{p_match_id:i});N!=null&&N.success&&!(N!=null&&N.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(N){console.error("[PvP] apply_match_rewards:",N)}if(typeof c=="function")try{await c({homeScore:B,awayScore:S,winnerId:T,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(N){console.error("[PvP] onMatchEnd:",N)}}catch(T){console.error("[PvP] finishMatch:",T)}}function Ne(){var S;const k=g[p+"Score"],T=g[u+"Score"],z=k>T,B=k===T;lt(t),t.innerHTML=`
    ...
    </div>`,(S=document.getElementById("pvp-home"))==null||S.addEventListener("click",()=>{try{v.removeChannel(J)}catch{}Ke(t),l?x("mini-league",{openLeagueId:l}):x("home")})}U()}async function Ri(t,e,i=!1){var s,d;const{state:o,navigate:a,toast:n}=e,r=i&&((d=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await Ei(t,e,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:m,stadiumDef:p})=>{lt(t);const u=async y=>{await Gr(t,e,c,l,f,b,y||[],m,p,i,r)};if(!(x!=null&&x.length)){await u([]);return}ki(t,x,u)})}async function Nr(t,e,i){return Pr(t,e,i)}async function Gr(t,e,i,o,a,n,r=[],s=[],d=null,c=!1,l=null){var Y,J;const{state:f,navigate:b,toast:x}=e,m=(l==null?void 0:l.mmr)??((Y=f.profile)==null?void 0:Y.mmr)??1e3,p=c?_i(m):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,L=null;t.innerHTML=`
    ...
    </div>`;const g=async()=>{w=!0,h&&(h.unsubscribe(),h=null),L&&(clearInterval(L),L=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(A){console.error("[Matchmaking] cancel error:",A)}};(J=document.getElementById("cancel-mm"))==null||J.addEventListener("click",async()=>{await g(),Ke(t),b("home")});const M=async(A,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),L&&(clearInterval(L),L=null),await jt(t,e,A,_,{myGC:r,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?Rr:null}))},E=f.user.id,{data:I,error:D}=c?await v.rpc("try_matchmake_ranked",{p_user_id:E,p_deck_id:i,p_mmr:m}):await v.rpc("try_matchmake",{p_user_id:E,p_deck_id:i});if(D||!(I!=null&&I.success)){console.error("[Matchmaking] try_matchmake error:",D||I),x("Erreur de matchmaking","error"),Ke(t),b("home");return}if(I.matched){await M(I.match_id,!1);return}const O=async()=>{if(w)return;const{data:A}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",E).maybeSingle();(A==null?void 0:A.status)==="matched"&&A.match_id&&await M(A.match_id,!0)};h=v.channel(`mm_${E}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${E}`},A=>{const _=A.new;_.status==="matched"&&_.match_id&&M(_.match_id,!0)}).subscribe(),L=setInterval(O,3e3),setTimeout(()=>{w||g()},12e4)}async function Rr(t,e){const{state:i,toast:o}=e,{winnerId:a,homeId:n,awayId:r,homeScore:s,awayScore:d,matchId:c}=t,l=i.user.id,f=n===l,b=a===l,{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:m}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?r:n).single();if(x&&m){const p=fn(x.mmr,x.mmr_rd,x.mmr_v,m.mmr,m.mmr_rd,b?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:b?v.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(b?`+MMR ↑ ${Math.round(p.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-p.mmr)}`,b?"success":"error",4e3)}}const Or=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ri,resumePvpMatch:Nr},Symbol.toStringTag,{value:"Module"}));async function Hr(t,e){const{state:i,navigate:o,toast:a}=e,n=i.params||{},r=n.friendId||null,s=n.friendName||"Ami",d=!!n.isAccepting;await Ei(t,e,"friend",async({deckId:c,formation:l,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:m,stadiumDef:p})=>{lt(t);const u=async y=>{const w=y||[];d?await Kr(t,e,c,w,m,p):await Ur(t,e,c,w,m,p,r,s)};if(!(x!=null&&x.length)){await u([]);return}ki(t,x,u)})}async function Ur(t,e,i,o,a,n,r,s){var w;const{state:d,navigate:c,toast:l}=e,f=d.user.id,{data:b,error:x}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:r,friend_id:r,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!b){console.error("[Friend] Erreur création invitation:",x),l("Impossible de créer l'invitation","error"),c("home");return}t.innerHTML=`
    ...
    </div>`;let m=!1,p=null;const u=async()=>{p&&(p.unsubscribe(),p=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await u(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",b.id),Ke(t),c("home")}),p=v.channel(`friend_invite_${b.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${b.id}`},async({new:h})=>{m||h.status!=="accepted"||!h.match_id||(m=!0,await u(),await jt(t,e,h.match_id,!0,{myGC:o,gcDefs:a,stadiumDef:n}))}).subscribe();const y=setInterval(async()=>{if(m)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",b.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(m=!0,clearInterval(y),await u(),await jt(t,e,h.match_id,!0,{myGC:o,gcDefs:a,stadiumDef:n}))},3e3);setTimeout(async()=>{m||(clearInterval(y),await u(),l("Invitation expirée","info"),c("home"))},12e4)}async function Kr(t,e,i,o,a,n){const{state:r,navigate:s,toast:d}=e,c=r.user.id,{data:l}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",c).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!l){d("Aucune invitation en attente","error"),s("home");return}const{data:f,error:b}=await v.rpc("accept_friend_invite",{p_invite_id:l.id,p_invitee_deck_id:i});if(b||!(f!=null&&f.success)){console.error("[Friend] Erreur accept_friend_invite:",b||f),d((f==null?void 0:f.error)||"Impossible de rejoindre le match","error"),s("home");return}await jt(t,e,f.match_id,!1,{myGC:o,gcDefs:a,stadiumDef:n})}const rn="#1A6B3C",dt="#D4A017",Qt="var(--tile-bg)",Zt="var(--tile-border)",St="var(--divider)",Je="var(--tile-fg-on-page)",It="var(--tile-fg-dim)",et="var(--tile-fg-faint)",ti="var(--nav-fg,#fff)",an="rgba(255,255,255,0.62)",Vr="rgba(255,255,255,0.4)";async function Yr(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ct(t,e,i);return}await tt(t,e)}async function tt(t,e,i="waiting"){var h,L;const{state:o}=e,a=o.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",a),r=(n||[]).map(g=>g.league_id),s={};(n||[]).forEach(g=>{s[g.league_id]={amount:g.prize_amount,claimed:g.prize_claimed}});const{data:d,error:c}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),l=c?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:d||[],b=(r.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",r).order("created_at",{ascending:!1}):{data:[]}).data||[],x=b.filter(g=>g.status==="waiting"&&!g.is_archived),m=b.filter(g=>g.status==="active"&&!g.is_archived),p=b.filter(g=>g.is_archived||g.status==="finished");let u=p;if(p.length){const{data:g}=await v.from("mini_league_matches").select("league_id").in("league_id",p.map(E=>E.id)).or(`home_id.eq.${a},away_id.eq.${a}`).not("status","eq","bye"),M=new Set((g||[]).map(E=>E.league_id));u=p.filter(E=>M.has(E.id))}const y=l.filter(g=>!r.includes(g.id)),w=[{key:"waiting",label:"🟡 En attente",count:x.length+y.length},{key:"active",label:"🟢 En cours",count:m.length},{key:"archived",label:"📁 Archivées",count:u.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${St}">
      ${w.map(g=>`<button class="ml-tab" data-tab="${g.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===g.key?rn:"transparent"};background:none;font-size:12px;font-weight:${i===g.key?"900":"600"};color:${i===g.key?"#4ade80":Vr};cursor:pointer">${g.label}${g.count?` (${g.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Wr(x,y,a):i==="active"?Xr(m,a):Jr(u,a,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>Qr(t,e)),(L=document.getElementById("ml-refresh-list"))==null||L.addEventListener("click",()=>tt(t,e,i)),t.querySelectorAll(".ml-tab").forEach(g=>g.addEventListener("click",()=>tt(t,e,g.dataset.tab))),t.querySelectorAll("[data-league-id]").forEach(g=>g.addEventListener("click",()=>ct(t,e,g.dataset.leagueId))),t.querySelectorAll("[data-join]").forEach(g=>g.addEventListener("click",M=>{M.stopPropagation(),sn(t,e,g.dataset.join,g.dataset.type)})),t.querySelectorAll("[data-delete]").forEach(g=>g.addEventListener("click",M=>{M.stopPropagation(),Oi(t,e,g.dataset.delete,g.dataset.name,i)})),t.querySelectorAll("[data-claim-league]").forEach(g=>g.addEventListener("click",async M=>{M.stopPropagation(),g.disabled=!0,g.textContent="...";const{data:E,error:I}=await v.rpc("claim_mini_league_prize",{p_league_id:g.dataset.claimLeague,p_user_id:o.profile.id});if(I||!(E!=null&&E.success)){e.toast((E==null?void 0:E.error)||"Erreur lors de la récupération","error"),tt(t,e,i);return}if(!E.already_claimed){o.profile.credits=(o.profile.credits||0)+E.prize;const D=document.getElementById("nav-credits");D&&(D.textContent=`💰 ${o.profile.credits.toLocaleString("fr")}`),e.toast(`💰 +${E.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}tt(t,e,i)}))}function wi(t,e,i=!1,o=null){var d,c;const a=t.creator_id===e,n=t.pot||0,r=((c=(d=t.mini_league_members)==null?void 0:d[0])==null?void 0:c.count)||0,s=o&&o.amount>0&&!o.claimed;return`<div data-league-id="${t.id}" style="background:${Qt};border:1px solid ${s?"rgba(212,160,23,0.5)":Zt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    </div>`,document.body.appendChild(x),x.querySelector("#lv-ok").onclick=()=>{x.remove(),b(!0)},x.querySelector("#lv-cancel").onclick=()=>{x.remove(),b(!1)}}))return;const{data:d,error:c}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:r});if(c||!(d!=null&&d.success)){a((d==null?void 0:d.error)||"Erreur lors de la désinscription","error");return}const l=d.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+l);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),a(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),tt(t,e,"waiting")}async function Oi(t,e,i,o,a){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:r}=await v.from("mini_leagues").delete().eq("id",i);if(r){n("Erreur suppression ("+r.message+")","error");return}n("Mini League supprimée avec succès","success"),tt(t,e,a)}async function ta(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),tt(t,e,"archived")}async function ct(t,e,i){var L,g,M,E,I,D,O,Y,J;const{state:o,toast:a}=e,n=o.profile.id,[{data:r},{data:s},{data:d}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!r){a("Introuvable","error"),await tt(t,e);return}const c=(s||[]).some(A=>A.user_id===n),l=r.creator_id===n,f=(s||[]).map(A=>A.user).filter(Boolean),b=aa(f,d||[]),x=(d||[]).filter(A=>A.matchday===r.current_day),m=r.pot||0,p=r.entry_fee||100,u=x.length>0&&x.every(A=>A.status==="finished"||A.status==="bye"),y=r.current_day>=r.total_days,w=(s||[]).find(A=>A.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${St};display:flex;align-items:center;gap:10px">
      ...
      <div style="flex:1">
        <div style="font-size:16px;font-weight:900;color:${ti}">${r.name}</div>
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Qt};border:1px solid ${Zt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="font-size:10px;color:${et};text-transform:uppercase;border-bottom:2px solid ${St}">
            ...
            ${m>0&&r.status==="finished"?`<th style="text-align:right;padding:5px 0;color:${dt}">💰</th>`:""}
          </tr></thead>
          <tbody>${b.map((A,_)=>{const H=m>0&&r.status==="finished"?_===0?Math.floor(m*.7):_===1?Math.floor(m*.2):_===2?Math.floor(m*.1):0:0;return`<tr style="border-bottom:1px solid ${St};${A.userId===n?"background:rgba(74,222,128,0.08);":""}">
              ...
              ${m>0&&r.status==="finished"?`<td style="text-align:right;font-weight:700;color:${dt}">${H?H.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:${Qt};border:1px solid ${Zt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(A,_)=>_+1).reverse().map(A=>{const _=(d||[]).filter(H=>H.matchday===A);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${et};margin-bottom:6px">Journée ${A}</div>${_.map(H=>Eo(H,f,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    </div>`;let l=!1;const f=async u=>{if(!l){if(l=!0,clearInterval(m),x)try{x.unsubscribe()}catch{}u&&await jt(t,e,u,a,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:r,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(m),x)try{x.unsubscribe()}catch{}c("mini-league",{openLeagueId:o}),d()});const b=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},x=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&f(u.new.match_id)}).subscribe(),m=setInterval(b,3e3);b()})}const la="/",da=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ca(t,e,i){let o=0;const a=document.createElement("div");a.id="tutorial-overlay",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,f,b;const s=e[o],d=o===e.length-1,c=Math.round((o+1)/e.length*100);a.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let d="buy";const c=()=>{var p,u,y,w,h,L,g;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((y=document.getElementById("flt-country"))==null?void 0:y.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((L=document.getElementById("flt-note1"))==null?void 0:L.value)||0,note2:parseInt((g=document.getElementById("flt-note2"))==null?void 0:g.value)||0}};function l(p){const u=c();return p.filter(y=>{var D,O,Y;const w=(D=y.card)==null?void 0:D.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),L=(((O=w.clubs)==null?void 0:O.encoded_name)||"").toLowerCase(),g=(w.country_code||"").toLowerCase(),M=((Y=y.card)==null?void 0:Y.evolution_bonus)||0,E=fi(w,w.job,M),I=w.job2?fi(w,w.job2,M):0;return!(u.name&&!h.includes(u.name)||u.club&&!L.includes(u.club)||u.country&&!g.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&E<u.note1||u.note2&&I<u.note2)})}function f(p){var L,g,M;const u=(L=p.card)==null?void 0:L.player;if(!u)return"";const y=((g=p.card)==null?void 0:g.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function b(p){var I,D,O,Y;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const y=((D=p.card)==null?void 0:D.evolution_bonus)||0,w=fi(u,u.job,y),h=u.job2?fi(u,u.job2,y):0,L=p.status==="sold",g=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=To[u.job]||"#bbb",E=u.job2?To[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${L?"opacity:0.7":""}">
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>o("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,f=s.placement_matches??0,b=f<10,x=Math.max(0,10-f),m=_i(d),p=So(d),u=Si.findIndex(O=>O.id===m.id),y=Si[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),L=h>0?Math.round((s.ranked_wins||0)/h*100):0,g=Si.map(O=>`
    <div style="display:flex;flex-direction:column;align-items:center;gap:2px;opacity:${m.id===O.id?1:.35};
      transform:${m.id===O.id?"scale(1.15)":"scale(1)"};transition:all 0.3s">
      <div style="font-size:${m.id===O.id?"28px":"20px"}">${O.emoji}</div>
      <div style="font-size:9px;color:${O.color};font-weight:${m.id===O.id?"900":"400"};letter-spacing:0.5px">${O.label.toUpperCase()}</div>
    </div>
  `).join("");t.innerHTML=`
  <div style="min-height:100%;background:${w[m.id]};padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
    ...
    <div style="display:flex;flex-direction:column;gap:10px;margin-top:auto;padding-top:8px">
      ...
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${a.id},away_id.eq.${a.id}`).order("created_at",{ascending:!1}).limit(50),r={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},s=(n||[]).filter(l=>l.status==="finished"),d=(n||[]).filter(l=>l.status==="in_progress");function c(l){const f=l.home_id===a.id;f?l.home_score:l.away_score,f?l.away_score:l.home_score;const b=l.winner_id===a.id,x=l.home_score===l.away_score&&l.status==="finished",m=l.status!=="finished"?"…":x?"N":b?"V":"D",p=l.status!=="finished"||x?"#888":b?"#1A6B3C":"#c0392b";let u=r[l.mode]||l.mode;l.away_id===null&&!u.startsWith("IA")&&(u="IA");const w=l.home_id===a.id?l.away:l.home;let h;l.away_id===null?h=u:w?h=`${w.club_name||w.pseudo} (${w.pseudo})`:h="Adversaire";let L="";l.status==="in_progress"&&Date.now()-new Date(l.created_at).getTime()>3600*1e3&&(L=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const g=new Date(l.created_at),M=g.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+g.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),E=l.status==="finished"?`${l.home_score} - ${l.away_score}`:`${l.home_score||0} - ${l.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
  ...
  </div>`}mn(xn);const ye={user:null,profile:null,page:"home",params:{}};function Pt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function ha(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Hi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ei(){if(!ye.user)return;const{data:t}=await v.from("users").select("*").eq("id",ye.user.id).single();t&&(ye.profile=t)}const ln="mw_theme";function dn(){return localStorage.getItem(ln)||"dark"}function va(t){var e;localStorage.setItem(ln,t),wa(t),(e=ye.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ye.profile.id).then(()=>{})}function wa(t){document.documentElement.setAttribute("data-theme",t)}function Nt(t,e={}){ye.page=t,ye.params=e,cn()}async function cn(){var o,a,n,r;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ye.page)});const e=document.getElementById("nav-credits");e&&ye.profile&&(e.textContent=`💰 ${(ye.profile.credits||0).toLocaleString("fr")}`);const i={state:ye,navigate:Nt,toast:Pt,openModal:ha,closeModal:Hi,refreshProfile:ei};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ye.page){case"home":await Ai(t,i);break;case"home2":await Ai(t,i);break;case"game":await Pn(t,i);break;case"settings":await No(t,i);break;case"collection":await Kn(t,i);break;case"decks":await qi(t,i);break;case"boosters":await rr(t,i);break;case"ranked":await ba(t,i);break;case"match":{const s=ye.params&&ye.params.matchMode||"vs_ai_easy";s==="random"?await Ri(t,i,!1):s==="ranked"?await Ri(t,i,!0):s==="friend"?await Hr(t,i,(o=ye.params)==null?void 0:o.friendId,(a=ye.params)==null?void 0:a.friendName):s==="mini_league"||s==="mini-league"?await Lo(t,i,(n=ye.params)==null?void 0:n.mlMatchId,(r=ye.params)==null?void 0:r.leagueId):await vr(t,i);break}case"market":await ua(t,i);break;case"rankings":await xa(t,i);break;case"matches":await ya(t,i);break;case"friends":await Bn(t,i);break;case"mini-league":await Yr(t,i);break;case"match-mini-league":{const s=ye.params||{};await Lo(t,i,s.mlMatchId,s.leagueId);break}default:await Ai(t,i)}}function _a(){var o,a;const t=document.getElementById("app"),e=ye.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.26-2326" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",r=>{r.preventDefault(),Nt(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Nt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Nt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>ka()),(a=document.getElementById("settings-btn"))==null||a.addEventListener("click",()=>Nt("settings"))}async function ka(){const{data:t}=await v.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const a=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${a}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
