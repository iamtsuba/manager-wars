import{s as E,F as bi,h as Pt,j as Wi,l as at,i as So,k as Lo,b as Io}from"./formation-links-CBa_FAsd.js";const Mo="/manager-wars/";function Ii(e,{navigate:t,toast:i}){let s="login";const c=()=>{var a,l,p,o,n,g;const d=s==="login";e.innerHTML=`
    <div style="
  ...
  `;function l(){var z;const o=document.getElementById("logo-preview"),n=document.getElementById("logo-initials"),g=((z=document.getElementById("setup-club"))==null?void 0:z.value)||"MW",v=g.trim().split(" ").filter(Boolean),y=v.length>=2?(v[0][0]+v[1][0]).toUpperCase():g.slice(0,2).toUpperCase();o&&(o.style.background=a,o.style.borderColor=d),n&&(n.textContent=y,n.style.color=d)}document.getElementById("color1").addEventListener("input",o=>{d=o.target.value,document.getElementById("swatch1").style.background=d,l()}),document.getElementById("color2").addEventListener("input",o=>{a=o.target.value,document.getElementById("swatch2").style.background=a,l()});function p(o){document.querySelectorAll(".setup-step").forEach(n=>n.classList.remove("active")),document.getElementById(`step-${o}`).classList.add("active"),document.getElementById("step-num").textContent=o,document.getElementById("progress-fill").style.width=`${Math.round(o/3*100)}%`,o===3&&l()}document.getElementById("step1-next").addEventListener("click",async()=>{const o=document.getElementById("setup-pseudo").value.trim(),n=document.getElementById("step1-error");if(n.textContent="",o.length<3){n.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:g}=await E.from("users").select("id").eq("pseudo",o).maybeSingle();if(g){n.textContent="Ce pseudo est déjà pris.";return}p(2)}),document.getElementById("step2-back").addEventListener("click",()=>p(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const o=document.getElementById("setup-club").value.trim(),n=document.getElementById("step2-error");if(n.textContent="",o.length<2){n.textContent="Nom trop court (min. 2 caractères).";return}const{data:g}=await E.from("users").select("id").eq("club_name",o).maybeSingle();if(g){n.textContent="Ce nom de club est déjà pris.";return}p(3)}),document.getElementById("step3-back").addEventListener("click",()=>p(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const o=document.getElementById("setup-pseudo").value.trim(),n=document.getElementById("setup-club").value.trim(),g=document.getElementById("step3-error"),v=document.getElementById("step3-finish");g.textContent="",v.disabled=!0,v.textContent="Création en cours…";try{const{error:y}=await E.from("users").insert({id:t.user.id,pseudo:o,club_name:n,club_color1:d,club_color2:a,credits:1e4});if(y)throw y;await Co(t.user.id),await c(),s(`Bienvenue ${o} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(y){g.textContent=y.message,v.disabled=!1,v.textContent="🚀 Créer mon profil !"}})}async function Co(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await E.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const qo="modulepreload",Bo=function(e){return"/manager-wars/"+e},Mi={},hi=function(t,i,s){let c=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));c=Promise.allSettled(i.map(p=>{if(p=Bo(p),p in Mi)return;Mi[p]=!0;const o=p.endsWith(".css"),n=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${n}`))return;const g=document.createElement("link");if(g.rel=o?"stylesheet":qo,o||(g.as="script"),g.crossOrigin="",g.href=p,l&&g.setAttribute("nonce",l),document.head.appendChild(g),o)return new Promise((v,y)=>{g.addEventListener("load",v),g.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${p}`)))})}))}function d(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return c.then(a=>{for(const l of a||[])l.status==="rejected"&&d(l.reason);return t().catch(d)})},Dt="#1A6B3C",Gt="#cc2222",Fo="#D4A017",ji="#888";async function Do(e,t){const{state:i,toast:s}=t;e.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid #f0f0f0">
      ...
      <div style="text-align:left;font-size:18px;font-weight:900;color:${U}">${P}</div>
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),o=(l||[]).filter(X=>X.card_type==="player"&&X.player),n=(l||[]).filter(X=>X.card_type==="game_changer"),g=(l||[]).filter(X=>X.card_type==="formation"),v=(l||[]).filter(X=>X.card_type==="stadium"),{data:y}=await E.from("gc_definitions").select("name,gc_type,color,effect,image_url"),z={};(y||[]).forEach(X=>{z[X.name]=X});const{data:r}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(r||[]).forEach(X=>{u[X.id]=X}),v.forEach(X=>{X.stadium_def&&(u[X.stadium_id]=X.stadium_def)});const M=Object.keys(bi),L=Object.keys(Ve),D={};o.forEach(X=>{const ne=X.player.id;D[ne]=(D[ne]||0)+1}),new Set(Object.keys(D).map(X=>String(X)));const W=new Set(g.map(X=>X.formation)),F=new Set(n.map(X=>X.gc_type));let P="player",j="Tous",U="",oe=!1;function de(){return[...o].sort((X,ne)=>{const ge=Kt.indexOf(X.player.job),J=Kt.indexOf(ne.player.job);return ge!==J?ge-J:(X.player.surname_encoded||"").localeCompare(ne.player.surname_encoded||"")})}function N(){return[...p||[]].sort((X,ne)=>{const ge=Kt.indexOf(X.job),J=Kt.indexOf(ne.job);return ge!==J?ge-J:(X.surname_encoded||"").localeCompare(ne.surname_encoded||"")})}function Y(){return de().filter(X=>{const ne=X.player,ge=j==="Tous"||ne.job===j,J=!U||`${ne.firstname} ${ne.surname_encoded}`.toLowerCase().includes(U);return ge&&J})}function H(){return N().filter(X=>{const ne=j==="Tous"||X.job===j,ge=!U||`${X.firstname} ${X.surname_encoded}`.toLowerCase().includes(U);return ne&&ge})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",ne=>{U=ne.target.value.toLowerCase(),re()}),e.querySelectorAll(".filter-btn").forEach(ne=>{ne.addEventListener("click",()=>{j=ne.dataset.job,G(),re()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{oe=!oe,G(),re()})):(X.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{oe=!oe,G(),re()})))}function re(){const X=document.getElementById("col-grid");X&&(P==="player"?ve(X):P==="formation"?ze(X):P==="stadium"?xe(X):Ie(X))}function pe(X,ne,ge,J,Z){const V=document.getElementById("col-grid"),ae=document.getElementById("col-big");if(!V||!ae)return;var be=0;function Le(){const Ee=window.innerWidth>=768,Te=document.getElementById("col-big"),De=document.getElementById("col-grid");Ee&&Te&&(Te.style.minHeight="420px",Te.style.flex="1 1 auto"),Ee&&De&&(De.style.height=Math.round(310*.76+16)+"px",De.style.flexShrink="0",De.style.overflowX="auto",De.style.overflowY="hidden",De.style.alignItems="center",De.style.padding="8px 16px"),ae.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ne(X[be])+"</div>";var I=ae.querySelector("[data-card-id],[data-form-id],[data-gc-id]");I&&I.addEventListener("click",function(){J(X[be])}),requestAnimationFrame(function(){var C=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!C||!ae)){var w=ae.clientHeight-8,k=ae.clientWidth-24,f=C.offsetHeight,m=C.offsetWidth;if(f>0&&m>0&&w>40){var x=Ee?2.2:1,b=Math.min(w/f,k/m,x);C.style.transform="scale("+b.toFixed(3)+")",C.style.transformOrigin="top center"}}}),V.innerHTML=X.map(function(C,w){var k=w===be,f="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(k?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+w+'" style="'+f+'">'+ge(C,k)+"</div>"}).join(""),V.querySelectorAll(".col-mini-item").forEach(function(C){C.addEventListener("click",function(){be=Number(C.dataset.idx),Le(),C.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Le()}function ye(X){var ne=window.innerWidth>=768?.76:.54,ge;if(!X||X._fake){var J=X?X.player:null;if(!J)return"";ge=Fi(J)}else ge=si(X,"");return'<div style="display:inline-block;zoom:'+ne+';pointer-events:none;line-height:0">'+ge+"</div>"}function Se(X,ne,ge){ne=ne||100,ge=ge||140;var J=Pt[X]||{},Z={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},V=Math.max(3,Math.round(ne*.06)),ae=Object.entries(J).map(function(Le){var Ee=Le[0],Te=Le[1],De=Ee.replace(/\d+$/,""),I=Z[De]||"#888",C=Math.round(Te.x*ne),w=Math.round(Te.y*ge);return'<circle cx="'+C+'" cy="'+w+'" r="'+V+'" fill="'+I+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),be=Math.max(1,Math.round(ne/50));return'<svg viewBox="0 0 '+ne+" "+ge+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ne+'" height="'+ge+'" fill="#1A6B3C"/><rect x="'+Math.round(ne*.2)+'" y="'+Math.round(ge*.02)+'" width="'+Math.round(ne*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+be+'"/><line x1="0" y1="'+Math.round(ge*.5)+'" x2="'+ne+'" y2="'+Math.round(ge*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+be+'"/><ellipse cx="'+Math.round(ne*.5)+'" cy="'+Math.round(ge*.5)+'" rx="'+Math.round(ne*.18)+'" ry="'+Math.round(ge*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+be+'"/><rect x="'+Math.round(ne*.2)+'" y="'+Math.round(ge*.82)+'" width="'+Math.round(ne*.6)+'" height="'+Math.round(ge*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+be+'"/>'+ae+"</svg>"}function he(X,ne,ge){var J=ge>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+ge+"</div>":"",Z=ne?'data-form-id="'+ne.id+'"':"",V=X.length>7?14:X.length>5?16:19,ae=!!ne;return"<div "+Z+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ae?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ae?"":"filter:grayscale(1);opacity:0.5")+'">'+J+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ae?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+V+"px;font-weight:900;color:"+(ae?"#1A6B3C":"#aaa")+';line-height:1">'+X+'</div></div><div style="flex:1;overflow:hidden;background:'+(ae?"#1A6B3C":"#ccc")+'">'+Se(X,140,220)+"</div></div>"}function we(X,ne){var ge=window.innerWidth>=768?.76:.54,J=140,Z=305,V=Math.round(Z*.22),ae=Z-V,be=X.length>7?10:13,Le=Se(X,J,ae),Ee=ne?"1.5px solid #2a7a40":"1px solid #ddd",Te=ne?"":"filter:grayscale(1);opacity:0.45;",De=ne?"#1A6B3C":"#bbb",I="#fff";return'<div style="display:inline-block;zoom:'+ge+';line-height:0;pointer-events:none"><div style="width:'+J+"px;height:"+Z+"px;border-radius:6px;border:"+Ee+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Te+'"><div style="height:'+V+"px;background:"+De+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+be+"px;font-weight:900;color:"+I+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(J-4)+'px">'+X+'</span></div><div style="height:'+ae+'px;overflow:hidden;flex-shrink:0">'+Le+"</div></div></div>"}function ve(X){if(oe){const ne=H();if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const ge=ne.map(J=>o.find(Z=>Z.player.id===J.id)||{_fake:!0,player:J,id:"fake-"+J.id});pe(ge,J=>J._fake?Fi(J.player):si(J,""),J=>J._fake?ye({player:J.player,id:"x",_fake:!0}):ye(J),J=>{J._fake||Di(J,o,D,t)})}else{const ne=Y();if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const ge={};ne.forEach(Z=>{const V=Z.player.id;ge[V]||(ge[V]=[]),ge[V].push(Z)});const J=Object.values(ge).map(Z=>Xo(Z));pe(J,Z=>{const V=D[Z.player.id]||1,ae=V>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${V}</div>`:"",Le=o.filter(Ee=>Ee.player.id===Z.player.id&&Ee.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return si(Z,ae+Le)},Z=>ye(Z),Z=>Di(Z,o,D,t))}}function ze(X){const ne=oe?M:[...W];if(!ne.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const ge=ne.map(J=>({formation:J,card:g.find(Z=>Z.formation===J)||null,owned:W.has(J)}));pe(ge,({formation:J,card:Z,owned:V})=>he(J,V?Z:null,V?g.filter(ae=>ae.formation===J).length:0),({formation:J,owned:Z})=>we(J,Z),({card:J,owned:Z})=>{Z&&J&&en(J,g,t,d)})}function Ie(X){const ne=Object.keys(z),ge=oe?ne.length?ne:L:[...F];if(!ge.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const J=ge.map(Z=>({type:Z,gc:Ve[Z]||{icon:"⚡",desc:""},def:z[Z]||null,owned:F.has(Z),card:n.find(V=>V.gc_type===Z)||null}));pe(J,({type:Z,gc:V,def:ae,owned:be,card:Le})=>{var x;const Ee=be?n.filter(b=>b.gc_type===Z).length:0,Te=Ee>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ee}</div>`:"",De=(ae==null?void 0:ae.gc_type)==="ultra_game_changer",I={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},C={purple:"#b06ce0",light_blue:"#00d4ef"},w=I[ae==null?void 0:ae.color]||I.purple,k=C[ae==null?void 0:ae.color]||C.purple,f=(ae==null?void 0:ae.effect)||V.desc||"",m=ae!=null&&ae.image_url?`/manager-wars/icons/${ae.image_url}`:((x=ae==null?void 0:ae.club)==null?void 0:x.logo_url)||(ae!=null&&ae.country_code?`https://flagcdn.com/w80/${ae.country_code.toLowerCase()}.png`:null);return be&&Le?`<div data-gc-id="${Le.id}" data-gc-type="${Z}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${k};background:${w};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${k}66;cursor:pointer">
          ${Te}
        ...
        </div>`},({type:Z,gc:V,def:ae,owned:be})=>{const Le=window.innerWidth>=768?.76:.54,Ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Te={purple:"#9b59b6",light_blue:"#00bcd4"},De=Ee[ae==null?void 0:ae.color]||Ee.purple,I=Te[ae==null?void 0:ae.color]||Te.purple,C=ae!=null&&ae.image_url?`/manager-wars/icons/${ae.image_url}`:null;return be?`<div style="display:inline-block;zoom:${Le};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${De};border:1px solid ${I};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${Z}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${C?`<img src="${C}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${V.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((ae==null?void 0:ae.effect)||V.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${Le};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${V.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${Z}</span></div></div>`},({type:Z,owned:V,def:ae})=>{V&&Qo(Z,ae,d)})}function xe(X){const ne="#E87722",ge="/manager-wars/";if(!v.length){X.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const J={};v.forEach(V=>{const ae=V.stadium_id||"?";(J[ae]=J[ae]||[]).push(V)});const Z=Object.entries(J).map(([V,ae])=>({sid:V,def:u[V]||null,count:ae.length,card:ae[0]}));pe(Z,({def:V,count:ae})=>{var I,C;const be=(V==null?void 0:V.name)||"?",Le=((I=V==null?void 0:V.club)==null?void 0:I.encoded_name)||(V==null?void 0:V.country_code)||"—",Ee=V!=null&&V.image_url?`${ge}icons/${V.image_url}`:((C=V==null?void 0:V.club)==null?void 0:C.logo_url)||(V!=null&&V.country_code?`https://flagcdn.com/w80/${V.country_code.toLowerCase()}.png`:null),Te=Ee?`<img src="${Ee}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',De=ae>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ae}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${ne},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${ne}66">
          ${De}
        ...
        </div>`},({def:V,count:ae})=>{var I,C;const be=window.innerWidth>=768?.76:.54,Le=(V==null?void 0:V.name)||"?",Ee=((I=V==null?void 0:V.club)==null?void 0:I.encoded_name)||(V==null?void 0:V.country_code)||"—",Te=V!=null&&V.image_url?`${ge}icons/${V.image_url}`:((C=V==null?void 0:V.club)==null?void 0:C.logo_url)||(V!=null&&V.country_code?`https://flagcdn.com/w80/${V.country_code.toLowerCase()}.png`:null),De=Te?`<img src="${Te}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${be};line-height:0;pointer-events:none">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Vt=1e3;function en(e,t,i,s){var z,r,u;const{state:c,toast:d,closeModal:a,navigate:l,refreshProfile:p}=i,o=e.formation,n={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function g(){const M=Pt[o]||{},L=bi[o]||[],D=290,W=360,F=20;function P(U){const oe=M[U];return oe?{x:oe.x*D,y:oe.y*W}:null}let j=`<svg width="${D}" height="${W}" viewBox="0 0 ${D} ${W}" xmlns="http://www.w3.org/2000/svg">`;for(const[U,oe]of L){const de=P(U),N=P(oe);!de||!N||(j+=`<line x1="${de.x}" y1="${de.y}" x2="${N.x}" y2="${N.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const U of Object.keys(M)){const oe=P(U);if(!oe)continue;const de=U.replace(/\d+/,""),N=n[de]||"#555";j+=`<circle cx="${oe.x}" cy="${oe.y}" r="${F}" fill="${N}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,j+=`<text x="${oe.x}" y="${oe.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${de}</text>`}return j+="</svg>",j}const v=t.filter(M=>M.formation===o);v.length;const y=!e.is_for_sale;s(`Formation ${o}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${g.map((J,Z)=>{const V=pe[J.id]||[],ae=J.is_for_sale,be=V.length?V[V.length-1]:null,Ee=(n.rarity==="pepite"||n.rarity==="papyte")&&J.current_note!=null?` (☆${J.current_note})`:"";return`
            <div data-card-id="${J.id}" data-card-idx="${Z}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <input type="checkbox" class="expl-check" data-id="${J.id}" ${ae?"disabled":""} style="width:18px;height:18px;cursor:pointer;accent-color:#1A6B3C;flex-shrink:0">
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${Z+1}${Ee}${ae?" 🏷️ En vente":""}</div>
      ...
      <div style="width:140px;border-radius:12px;padding:6px;background:${U};flex-shrink:0">
        <div style="background:#f2e8d2;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
          ...
          <div style="background:#f2e8d2;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;min-height:24px">
            ...
            ${(ze=n.clubs)!=null&&ze.logo_url?`<img src="${n.clubs.logo_url}" style="width:22px;height:16px;object-fit:contain">`:`<div style="background:#1a3a7a;color:#fff;border-radius:2px;padding:1px 3px;font-size:6px;font-weight:800">${(((Ie=n.clubs)==null?void 0:Ie.encoded_name)||"").slice(0,6)}</div>`}
          </div>
        </div>
      </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        <div>
          ...
          <div style="font-weight:700;color:${U}">${n.rarity.toUpperCase()}</div>
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",n.note_g],["DEF",n.note_d],["MIL",n.note_m],["ATT",n.note_a]].map(([J,Z])=>{const V=qt[J],ae=J===n.job||J===n.job2,be=(Number(Z)||0)+(ae&&de>0?de:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px">
                <svg width="38" height="37" viewBox="0 0 38 37" style="display:block">
                  ...
                  <text x="19" y="23" text-anchor="middle" font-size="13" font-weight="900" fill="white" font-family="Arial Black,Arial">${be}</text>
                </svg>
    ...
    ${Se}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let he=new Set;const we=()=>{const J=he.size,Z=document.getElementById("sell-action-panel");if(!Z)return;Z.style.display=J>0?"block":"none",document.getElementById("sell-selected-count").textContent=J;const V=document.getElementById("evolve-btn");V&&(V.textContent=`⬆️ Évoluer ${J>1?"(+"+J+")":""}`)};document.querySelectorAll(".expl-check").forEach(J=>{J.addEventListener("change",()=>{const Z=J.dataset.id;J.checked?he.add(Z):he.delete(Z);const V=J.closest(".exemplaire-row");V&&(V.style.borderColor=J.checked?"#1A6B3C":"#eee"),we()})}),document.querySelectorAll(".exemplaire-row").forEach(J=>{J.addEventListener("click",Z=>{if(Z.target.closest("button")||Z.target.tagName==="INPUT")return;const V=J.querySelector(".expl-check");V&&!V.disabled&&(V.checked=!V.checked,V.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(J=>{J.addEventListener("click",Z=>{Z.stopPropagation();const V=document.querySelector(`.expl-hist[data-hist="${J.dataset.idx}"]`);V&&(V.style.display=V.style.display==="none"?"flex":"none")})}),(X=document.getElementById("evolve-btn"))==null||X.addEventListener("click",async()=>{const J=[...he];if(!J.length)return;const Z=J.filter(Ee=>Ee!==e.id);if(Z.length,!(!Z.length&&J.length===1&&J[0]===e.id)){if(!Z.length){d("Sélectionne des copies à sacrifier","warning");return}}if(!await new Promise(Ee=>{const Te=document.createElement("div");Te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",Te.innerHTML=`
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            📈 Note : <strong>${D+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${D+(e.evolution_bonus||0)+Z.length}</strong>
            ${F&&F>0?`<br>📈 Note 2 : <strong>${F+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${F+(e.evolution_bonus||0)+Z.length}</strong>`:""}
          </div>
  ...
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,on(e,t,c,i),document.getElementById("builder-back").addEventListener("click",()=>s("decks")),document.getElementById("formation-select").addEventListener("change",n=>{t.formation=n.target.value;const g=Pi(t.formation),v={};g.forEach(y=>{t.slots[y]&&(v[y]=t.slots[y])}),t.slots=v,Lt(e,t,i)}),(p=document.getElementById("stadium-select"))==null||p.addEventListener("change",n=>{t.stadiumCardId=n.target.value||null}),document.getElementById("save-deck").addEventListener("click",()=>an(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(n=>{n.addEventListener("click",()=>{t.subs=t.subs.filter(g=>g!==n.dataset.removeSub),Lt(e,t,i)})}),(o=document.getElementById("add-sub-btn"))==null||o.addEventListener("click",()=>{rn(t,e,i)})}function on(e,t,i,s){var D,W,F;const c=e.querySelector("#deck-field");if(!c)return;const d=(D=t.stadiumCards)==null?void 0:D.find(P=>P.id===t.stadiumCardId),a=d&&((W=t.stadDefMap)==null?void 0:W[d.stadium_id])||null,l=Pt[t.formation]||{},p=Wi(t.formation)||[],o={};for(const P of i){const j=t.slots[P],U=j?t.playerCards.find(oe=>oe.id===j):null;o[P]=U?U.player:null}const n=300,g=300,v=48,y=64,z=13,r=16,u=38;function M(P){const j=l[P];return j?{x:j.x*n,y:j.y*g}:null}let L="";for(const[P,j]of p){const U=M(P),oe=M(j);if(!U||!oe)continue;const de=o[P]?{...o[P],club_id:o[P].club_id,country_code:o[P].country_code,rarity:o[P].rarity}:null,N=o[j]?{...o[j],club_id:o[j].club_id,country_code:o[j].country_code,rarity:o[j].rarity}:null,Y=at(de,N);Y==="#ff3333"||Y==="#cc2222"?L+=`<line x1="${U.x.toFixed(1)}" y1="${U.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${Y}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(L+=`<line x1="${U.x.toFixed(1)}" y1="${U.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${Y}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,L+=`<line x1="${U.x.toFixed(1)}" y1="${U.y.toFixed(1)}" x2="${oe.x.toFixed(1)}" y2="${oe.y.toFixed(1)}" stroke="${Y}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const P of i){const j=M(P);if(!j)continue;const U=o[P],oe=P.replace(/\d+/,""),de=vt[oe]||"#555",N=(j.x-v/2).toFixed(1),Y=(j.y-y/2).toFixed(1),H={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[U==null?void 0:U.rarity]||"#aaa";if(U){const G=ti(U),re=co(U),pe=lo(U.country_code),ye=((F=U.card)==null?void 0:F.evolution_bonus)||U.evolution_bonus||0,Se=(Number(oe==="GK"?U.note_g:oe==="DEF"?U.note_d:oe==="MIL"?U.note_m:U.note_a)||0)+(oe===U.job||oe===U.job2?ye:0),he=a&&(a.club_id&&String(U.club_id)===String(a.club_id)||a.country_code&&U.country_code===a.country_code),we=he?Se+10:Se,ve=y-z-r;L+=`<defs><clipPath id="dcp-${P}"><rect x="${N}" y="${(j.y-y/2+z).toFixed(1)}" width="${v}" height="${ve}"/></clipPath></defs>`,L+=`<rect x="${N}" y="${Y}" width="${v}" height="${y}" rx="5" fill="${de}"/>`,G&&(L+=`<image href="${G}" x="${N}" y="${(j.y-y/2+z).toFixed(1)}" width="${v}" height="${ve}" clip-path="url(#dcp-${P})" preserveAspectRatio="xMidYMin slice"/>`),L+=`<rect x="${N}" y="${Y}" width="${v}" height="${z}" fill="rgba(255,255,255,0.93)"/>`,L+=`<text x="${j.x.toFixed(1)}" y="${(j.y-y/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(U.surname_encoded||"").slice(0,9)}</text>`;const ze=(j.y+y/2-r).toFixed(1);L+=`<rect x="${N}" y="${ze}" width="${v}" height="${r}" fill="rgba(255,255,255,0.93)"/>`,pe&&(L+=`<image href="${pe}" x="${(j.x-21).toFixed(1)}" y="${(j.y+y/2-r+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),L+=`<text x="${j.x.toFixed(1)}" y="${(j.y+y/2-r/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${we}</text>`,re&&(L+=`<image href="${re}" x="${(j.x+v/2-14).toFixed(1)}" y="${(j.y+y/2-r+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),L+=`<rect x="${N}" y="${Y}" width="${v}" height="${y}" rx="5" fill="none" stroke="${he?"#E87722":H}" stroke-width="${he?"2.5":"2"}"/>`,he&&(L+=`<rect x="${(j.x+v/2-13).toFixed(1)}" y="${Y}" width="13" height="9" rx="3" fill="#E87722"/>`,L+=`<text x="${(j.x+v/2-6.5).toFixed(1)}" y="${(j.y-y/2+4.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="900" fill="#fff" font-family="Arial">+10</text>`)}else L+=`<rect x="${N}" y="${Y}" width="${v}" height="${y}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,L+=`<text x="${j.x.toFixed(1)}" y="${j.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,L+=`<text x="${j.x.toFixed(1)}" y="${(j.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${oe}</text>`;L+=`<rect x="${N}" y="${Y}" width="${v}" height="${y}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${P}" style="cursor:pointer"/>`}c.innerHTML=`<svg viewBox="${-u} ${-u} ${n+u*2} ${g+u*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${L}</svg>`,c.querySelectorAll(".deck-slot-hit").forEach(P=>{P.addEventListener("click",()=>nn(P.dataset.pos,t,e,s))})}function nn(e,t,i,s){var v,y,z;const{openModal:c,closeModal:d}=s,a=e.replace(/\d+/,""),l=t.slots[e],p=l?t.playerCards.find(r=>r.id===l):null;(v=p==null?void 0:p.player)==null||v.id;const o=new Set;Object.entries(t.slots).forEach(([r,u])=>{var L;if(r===e||!u)return;const M=t.playerCards.find(D=>D.id===u);(L=M==null?void 0:M.player)!=null&&L.id&&o.add(M.player.id)}),t.subs.forEach(r=>{var M;const u=t.playerCards.find(L=>L.id===r);(M=u==null?void 0:u.player)!=null&&M.id&&o.add(u.player.id)});const n=new Set,g=t.playerCards.filter(r=>{const u=r.player;return!(u.job===a||u.job2===a)||o.has(u.id)||n.has(u.id)?!1:(n.add(u.id),!0)});g.sort((r,u)=>{card!=null&&card.evolution_bonus;const M=r.evolution_bonus||0,L=u.evolution_bonus||0,D=(a==="GK"?r.player.note_g:a==="DEF"?r.player.note_d:a==="MIL"?r.player.note_m:r.player.note_a)+(a===r.player.job||a===r.player.job2?M:0);return(a==="GK"?u.player.note_g:a==="DEF"?u.player.note_d:a==="MIL"?u.player.note_m:u.player.note_a)+(a===u.player.job||a===u.player.job2?L:0)-D}),c(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${g.length>0?g.map(r=>{var F,P;const u=r.player,M=card.evolution_bonus||0,L=(a==="GK"?u.note_g:a==="DEF"?u.note_d:a==="MIL"?u.note_m:u.note_a)+(a===u.job||a===u.job2?M:0),D=ti(u),W={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[u.rarity];return`<div class="player-option" data-card-id="${r.id}"
      ...
      ${l.length>0?l.map(o=>{var y;const n=o.player,g=ti(n),v=(n.job==="GK"?n.note_g:n.job==="DEF"?n.note_d:n.job==="MIL"?n.note_m:n.note_a)+(card.evolution_bonus||0);return`<div class="player-option" data-card-id="${o.id}"
          style="display:flex;align-items:center;gap:10px;padding:8px;border:1.5px solid var(--gray-200);border-radius:10px;cursor:pointer">
  ...
  `,document.body.appendChild(c);let d=!1;const a=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let p=!1;const o=G=>G.touches&&G.touches[0]?G.touches[0].clientX:G.clientX;function n(G){d||(p=!0,l.style.opacity="1",g(G))}function g(G){if(!p||d)return;const re=a.getBoundingClientRect(),pe=o(G)-re.left,ye=Math.max(0,Math.min(1,pe/re.width));l.style.width=ye*re.width+"px",ye>=.82&&y()}function v(){d||(p=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{d||(l.style.transition="")},220))}function y(){var re;if(d)return;d=!0,p=!1,l.style.width="100%",l.style.opacity="1",(re=document.getElementById("cut-flash"))==null||re.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const G=document.getElementById("cut-hint");G&&(G.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",M(0)},620)}a.addEventListener("pointerdown",n),window.addEventListener("pointermove",g),window.addEventListener("pointerup",v),a.addEventListener("touchstart",n,{passive:!0}),window.addEventListener("touchmove",g,{passive:!0}),window.addEventListener("touchend",v);let z=0,r=!1;const u=new Set;function M(G){z=G,document.getElementById("reveal-phase").style.display="flex",L(),D(G,0),U()}function L(){const G=document.getElementById("card-dots");G&&(G.innerHTML=e.map((re,pe)=>`<div class="card-dot" data-i="${pe}" style="width:8px;height:8px;border-radius:50%;background:${pe===z?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),G.querySelectorAll(".card-dot").forEach(re=>re.addEventListener("click",()=>F(parseInt(re.dataset.i)))))}function D(G,re){var xe;const pe=e[G],ye=document.getElementById("card-counter"),Se=document.getElementById("card-track");ye&&(ye.textContent=`Carte ${G+1} / ${e.length}`);const he=document.getElementById("reveal-btns");he&&(he.style.display=G===e.length-1?"flex":"none");const we=pe.card_type==="player"&&((xe=pe.player)==null?void 0:xe.rarity)==="legende",ve=!u.has(G);u.add(G);let ze=0;if(pe.card_type==="player"&&pe.player){const X=pe.player,ne=X.job||"ATT";ze=Number(ne==="GK"?X.note_g:ne==="DEF"?X.note_d:ne==="MIL"?X.note_m:X.note_a)||0}const Ie=X=>{Se.innerHTML=`
        ...
        </div>`;const ne=document.getElementById("current-card-wrap");re!==0?(ne.style.transition="none",ne.style.transform=`translateX(${re>0?100:-100}%)`,requestAnimationFrame(()=>{ne.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ne.style.transform="translateX(0)"})):ne.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),X||we?de():N(),L()};ve&&ze>6&&pe.card_type==="player"&&pe.player?W(pe,()=>Ie(!0)):Ie(!1)}function W(G,re){var ze;r=!0;const pe=G.player,ye=`https://flagsapi.com/${pe.country_code}/flat/64.png`,Se=(ze=pe.clubs)==null?void 0:ze.logo_url,he=document.getElementById("walkout-overlay"),we=document.getElementById("walkout-stage");if(!he||!we){r=!1,re();return}he.style.display="flex";const ve=()=>{const Ie=we.firstElementChild;Ie&&(Ie.classList.remove("wo-in"),Ie.classList.add("wo-out"))};we.innerHTML=`<img class="wo-in" src="${ye}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(ve,2e3),setTimeout(()=>{var Ie;we.innerHTML=Se?`<img class="wo-in" src="${Se}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((Ie=pe.clubs)==null?void 0:Ie.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(ve,4450),setTimeout(()=>{he.style.display="none",we.innerHTML="",r=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),re()},4900)}function F(G){if(r||G<0||G>=e.length||G===z)return;const re=G>z?1:-1;z=G,D(G,re)}function P(){F(z+1)}function j(){F(z-1)}function U(){const G=document.getElementById("card-viewport");if(!G||G._swipeBound)return;G._swipeBound=!0;let re=0,pe=0,ye=0,Se=!1;const he=xe=>xe.touches?xe.touches[0].clientX:xe.clientX,we=xe=>xe.touches?xe.touches[0].clientY:xe.clientY,ve=xe=>{Se=!0,re=he(xe),pe=we(xe),ye=0},ze=xe=>{if(!Se)return;ye=he(xe)-re;const X=we(xe)-pe;if(Math.abs(ye)<Math.abs(X))return;const ne=document.getElementById("current-card-wrap");ne&&(ne.style.transition="none",ne.style.transform=`translateX(${ye*.6}px) rotate(${ye*.02}deg)`)},Ie=()=>{if(!Se)return;Se=!1;const xe=document.getElementById("current-card-wrap"),X=55;ye<=-X&&z<e.length-1?P():ye>=X&&z>0?j():xe&&(xe.style.transition="transform .2s ease",xe.style.transform="translateX(0)")};G.addEventListener("pointerdown",ve),G.addEventListener("pointermove",ze),G.addEventListener("pointerup",Ie),G.addEventListener("pointercancel",Ie),G.addEventListener("touchstart",ve,{passive:!0}),G.addEventListener("touchmove",ze,{passive:!0}),G.addEventListener("touchend",Ie),G.addEventListener("click",xe=>{if(Math.abs(ye)>8)return;const X=G.getBoundingClientRect();xe.clientX-X.left>X.width/2?P():j()})}let oe=null;function de(){const G=document.getElementById("fireworks-canvas");if(!G)return;G.width=window.innerWidth,G.height=window.innerHeight;const re=G.getContext("2d"),pe=[];function ye(){const he=Math.random()*G.width,we=Math.random()*G.height*.6,ve=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],ze=ve[Math.floor(Math.random()*ve.length)];for(let Ie=0;Ie<60;Ie++){const xe=Math.PI*2/60*Ie,X=2+Math.random()*5;pe.push({x:he,y:we,vx:Math.cos(xe)*X,vy:Math.sin(xe)*X,alpha:1,color:ze,size:2+Math.random()*3})}}ye(),oe=setInterval(ye,600);function Se(){if(document.getElementById("fireworks-canvas")){re.clearRect(0,0,G.width,G.height);for(let he=pe.length-1;he>=0;he--){const we=pe[he];if(we.x+=we.vx,we.y+=we.vy+.08,we.vy*=.98,we.alpha-=.018,we.alpha<=0){pe.splice(he,1);continue}re.globalAlpha=we.alpha,re.fillStyle=we.color,re.beginPath(),re.arc(we.x,we.y,we.size,0,Math.PI*2),re.fill()}re.globalAlpha=1,(oe!==null||pe.length>0)&&requestAnimationFrame(Se)}}Se()}function N(){oe!==null&&(clearInterval(oe),oe=null);const G=document.getElementById("fireworks-canvas");G&&G.getContext("2d").clearRect(0,0,G.width,G.height)}if(s){const G=document.getElementById("reveal-btns");G&&(G.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(H=document.getElementById("reveal-next"))==null||H.addEventListener("click",()=>{N(),c.remove(),s()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{N(),c.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{N(),c.remove(),i("boosters")})}function yn(e){var t,i,s,c;if(e.card_type==="player"&&e.player)return un(e);if(e.card_type==="game_changer"){const d=e._gcDef,a=(d==null?void 0:d.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},p={purple:"#b06ce0",light_blue:"#00d4ef"},o=l[d==null?void 0:d.color]||l.purple,n=p[d==null?void 0:d.color]||p.purple,g=(d==null?void 0:d.name)||e.gc_type||"Game Changer",v=(d==null?void 0:d.effect)||((t=ui[e.gc_type])==null?void 0:t.desc)||"",y=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,z=((i=ui[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${o};border-radius:14px;border:3px solid ${n};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${n}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),p=[...new Set((l||[]).filter(v=>{var y,z;return((y=v.card)==null?void 0:y.card_type)==="stadium"&&((z=v.card)==null?void 0:z.stadium_id)}).map(v=>v.card.stadium_id))],o={};if(p.length){const{data:v}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",p);(v||[]).forEach(y=>{o[y.id]=y}),(l||[]).forEach(y=>{var z,r;((z=y.card)==null?void 0:z.card_type)==="stadium"&&((r=y.card)!=null&&r.stadium_id)&&(y.card._stadiumDef=o[y.card.stadium_id]||null)})}let n=0;function g(){var F,P,j,U,oe,de,N;const v=d[n],y=(l||[]).filter(Y=>Y.deck_id===v.id),z=y.filter(Y=>{var H;return Y.is_starter&&((H=Y.card)==null?void 0:H.player)}).map(Y=>gi(Y.card,Y.position)),r=y.find(Y=>{var H;return((H=Y.card)==null?void 0:H.card_type)==="formation"}),u=v.formation||((F=r==null?void 0:r.card)==null?void 0:F.formation)||"4-4-2";let M=z.length>=11?yt(z,u):null,L=((P=v.stadium_card)==null?void 0:P.stadium_def)||null;L&&M&&(M=Ht(M,L));const D=z.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
  ...
  </div>`}function ot(e,t,i){if(!(e!=null&&e.length))return"";const s=e.slice(0,5);let c='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return s.forEach((d,a)=>{if(c+=Ye(d,40,52),a<s.length-1){const l=at(d,s[a+1]);c+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(c+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),c+="</div>",c}function Zt(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function vo(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function ut(e,t,i,s,c=310,d=310,a=[]){var D;const l=Pt[t]||{},p=Wi(t)||bi[t]||[],o={},n=["ATT","MIL","DEF","GK"];for(const W of n)(e[W]||[]).forEach((P,j)=>{o[`${W}${j+1}`]=P});function g(W){const F=l[W];return F?{x:F.x*c,y:F.y*d}:null}let v="";for(const[W,F]of p){const P=g(W),j=g(F);if(!P||!j)continue;const U=o[W],oe=o[F],de=at(U,oe);de==="#00ff88"||de==="#FFD700"?(v+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${de}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,v+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${de}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):v+=`<line x1="${P.x.toFixed(1)}" y1="${P.y.toFixed(1)}" x2="${j.x.toFixed(1)}" y2="${j.y.toFixed(1)}"
        stroke="${de}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const y=48,z=64,r=13,u=16,M={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[W,F]of Object.entries(o)){const P=g(W);if(!P||!F)continue;const j=W.replace(/[0-9]/g,""),U=Mt[j]||"#555",oe=a.includes(F.cardId),de=i==="attack"&&(["MIL","ATT"].includes(j)||oe)&&!F.used||i==="defense"&&["GK","DEF","MIL"].includes(j)&&!F.used,N=s.includes(F.cardId);let Y;i==="attack"?Y=oe?Math.max(1,Number(F.note_a)||0):j==="MIL"?Number(F.note_m)||0:Number(F.note_a)||0:i==="defense"?Y=j==="GK"?Number(F.note_g)||0:j==="MIL"?Number(F.note_m)||0:Number(F.note_d)||0:Y=Number(j==="GK"?F.note_g:j==="DEF"?F.note_d:j==="MIL"?F.note_m:F.note_a)||0,Y=Y+(F.boost||0),F.stadiumBonus&&(i==="attack"&&(j==="ATT"||j==="MIL")||i==="defense"&&(j==="GK"||j==="DEF"||j==="MIL")?Y+=10:i||(Y+=10));const H=(P.x-y/2).toFixed(1),G=(P.y-z/2).toFixed(1),re=M[F==null?void 0:F.rarity]||M.normal;if(F.used){const ze=typeof import.meta<"u"&&"/manager-wars/"||"/",xe=`${typeof window<"u"&&((D=window.location)==null?void 0:D.origin)||""}${ze}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="#161616"/>`,v+=`<image href="${xe}" xlink:href="${xe}" x="${H}" y="${G}" width="${y}" height="${z}" preserveAspectRatio="xMidYMid slice"/>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="none" stroke="${re}" stroke-width="2" opacity="0.7"/>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${F.cardId}" data-role="${j}" style="cursor:pointer"/>`;continue}const pe=N?.45:1,ye=N?"#FFD700":re,Se=N?3:(F==null?void 0:F.rarity)==="legende"||(F==null?void 0:F.rarity)==="légende"||(F==null?void 0:F.rarity)==="pepite"||(F==null?void 0:F.rarity)==="pépite"?2.5:2,he=z-r-u;v+=`<defs><clipPath id="cp-${W}"><rect x="${H}" y="${(P.y-z/2+r).toFixed(1)}" width="${y}" height="${he}"/></clipPath></defs>`,v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="${U}" opacity="${pe}"/>`;const we=Pe(F);we&&(v+=`<image href="${we}" xlink:href="${we}" x="${H}" y="${(P.y-z/2+r).toFixed(1)}" width="${y}" height="${he}" clip-path="url(#cp-${W})" preserveAspectRatio="xMidYMin slice"/>`),v+=`<rect x="${H}" y="${G}" width="${y}" height="${r}" rx="4" fill="rgba(255,255,255,0.92)"/>`,v+=`<text x="${P.x.toFixed(1)}" y="${(P.y-z/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(F.name||"").slice(0,9)}</text>`;const ve=(P.y+z/2-u).toFixed(1);v+=`<rect x="${H}" y="${ve}" width="${y}" height="${u}" fill="rgba(255,255,255,0.92)"/>`;{const ze=Zt(F.country_code);ze?v+=`<image href="${ze}" xlink:href="${ze}" x="${(P.x-20).toFixed(1)}" y="${(P.y+z/2-u+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:v+=`<text x="${(P.x-13).toFixed(1)}" y="${(P.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${vo(F.country_code)}</text>`;const Ie=F.stadiumBonus?"#E87722":"#111";v+=`<text x="${P.x.toFixed(1)}" y="${(P.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${Ie}" font-family="Arial Black">${Y}</text>`;const xe=ho(F);xe?v+=`<image href="${xe}" xlink:href="${xe}" x="${(P.x+y/2-14).toFixed(1)}" y="${(P.y+z/2-u+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:F.clubName&&(v+=`<text x="${(P.x+14).toFixed(1)}" y="${(P.y+z/2-u/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(F.clubName||"").slice(0,3).toUpperCase()}</text>`),F.stadiumBonus&&(v+=`<rect x="${(P.x-y/2).toFixed(1)}" y="${(P.y-z/2).toFixed(1)}" width="${y}" height="${z}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="${N?"rgba(255,255,255,0.12)":"none"}" stroke="${ye}" stroke-width="${Se}" opacity="${pe}"/>`,de&&(v+=`<rect x="${H}" y="${G}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${N?"selected":""}" data-card-id="${F.cardId}" data-role="${j}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${c+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${v}
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${r.map((D,W)=>{const F=W<r.length-1?at(D,r[W+1]):null,P=!F||F==="#ff3333"||F==="#cc2222",j=F==="#00ff88"?"+2":F==="#FFD700"?"+1":"";return`
          <div class="duel-card duel-card-${L}" data-idx="${W}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${Ye({...D,note:Me(D,"MIL"),_line:"MIL"},58,78)}
          </div>
          ${W<r.length-1?`<div class="duel-link duel-link-${L}" data-idx="${W}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${P?"rgba(255,255,255,0.12)":F};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${P?"none":`0 0 8px ${F}`}">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const N=window.innerWidth>=700,Y=(ve,ze,Ie)=>{var Te,De;const xe=(t.gcDefs||[]).find(I=>I.name===ve.gc_type),X={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[xe==null?void 0:xe.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ne={purple:"#b06ce0",light_blue:"#00d4ef"}[xe==null?void 0:xe.color]||"#b06ce0",ge=(xe==null?void 0:xe.name)||ve.gc_type,J=(xe==null?void 0:xe.effect)||((Te=Ve[ve.gc_type])==null?void 0:Te.desc)||"",Z=xe!=null&&xe.image_url?`/manager-wars/icons/${xe.image_url}`:null,V=((De=Ve[ve.gc_type])==null?void 0:De.icon)||"⚡",ae=Math.round(Ie*.22),be=Math.round(Ie*.22),Le=Ie-ae-be,Ee=ge.length>12?7:9;return`<div class="gc-mini" data-gc-id="${ve.id}" data-gc-type="${ve.gc_type}"
          style="box-sizing:border-box;width:${ze}px;height:${Ie}px;border-radius:10px;border:2px solid ${ne};background:${X};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${ae}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ee}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ze-6}px">${ge}</span>
          ...
          <div style="height:${Le}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Z?`<img src="${Z}" style="max-width:${ze-10}px;max-height:${Le-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Le*.55)}px">${V}</span>`}
          </div>
        ...
        </div>`},H=(ve,ze)=>{var Ie;return`<div id="boost-card"
          style="box-sizing:border-box;width:${ve}px;height:${ze}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(ze*.04)}px;text-align:center;flex-shrink:0">
            <div style="font-size:${Math.round(ze*.2)}px">⚡</div>
            <div style="font-size:${Math.round(ze*.09)}px;color:#000;font-weight:900">+${(Ie=t.boostCard)==null?void 0:Ie.value}</div>
          </div>`},G=(ve,ze)=>ze?H(130,175):Y(ve,130,175),re=(ve,ze)=>ze?H(68,95):Y(ve,68,95),pe=N?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ye=z?`<button id="btn-results" style="${pe};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:g?`<div style="${pe};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:v?`<button id="btn-action" style="${pe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:y?`<button id="btn-action" style="${pe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${pe};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,Se=v||y?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",he=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${N?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
        ${d.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':d.map(ve=>`<div class="sub-btn-col" data-sub-id="${ve.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(ve,76,100)}</div>`).join("")}
  ...
  `,document.body.appendChild(s);let n=!1;const g=()=>{n||(n=!0,s.remove(),i())};s.addEventListener("click",g),setTimeout(g,2e3)}function jt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function di(e,t,i,s=null,c=null){var y,z;if(t.phase!=="attack"){jt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){jt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([r,u])=>(u||[]).filter(M=>M.used).map(M=>({...M,_line:M._line||r}))),a=t.homeSubs.filter(r=>!t.usedSubIds.includes(r.cardId));if(!d.length){jt("Aucun joueur utilisé à remplacer");return}if(!a.length){jt("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(r=>r.cardId===c));const p=((y=d[l])==null?void 0:y._line)||((z=d[l])==null?void 0:z.job);let o=s?Math.max(0,a.findIndex(r=>r.cardId===s)):Math.max(0,a.findIndex(r=>r.job===p)),n=!1;const g=document.createElement("div");g.id="sub-overlay",g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function v(){var F,P,j,U,oe,de;const r=d[l],u=a[o],M=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(M*1.35),D=N=>`background:rgba(255,255,255,0.12);border:none;color:${N?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${N?"default":"pointer"};flex-shrink:0`;g.innerHTML=`
    ...
    </div>`,(F=g.querySelector("#sub-close"))==null||F.addEventListener("click",()=>g.remove()),(P=g.querySelector("#out-up"))==null||P.addEventListener("click",()=>{l>0&&(l--,v())}),(j=g.querySelector("#out-down"))==null||j.addEventListener("click",()=>{l<d.length-1&&(l++,v())}),(U=g.querySelector("#in-up"))==null||U.addEventListener("click",()=>{o>0&&(o--,v())}),(oe=g.querySelector("#in-down"))==null||oe.addEventListener("click",()=>{o<a.length-1&&(o++,v())});const W=(N,Y,H,G)=>{const re=g.querySelector("#"+N);if(!re)return;let pe=0;re.addEventListener("touchstart",ye=>{pe=ye.touches[0].clientY},{passive:!0}),re.addEventListener("touchend",ye=>{const Se=ye.changedTouches[0].clientY-pe;if(Math.abs(Se)<30)return;const he=Y();Se<0&&he<G-1?(H(he+1),v()):Se>0&&he>0&&(H(he-1),v())},{passive:!0})};W("in-panel",()=>o,N=>o=N,a.length),W("out-panel",()=>l,N=>l=N,d.length),(de=g.querySelector("#sub-confirm"))==null||de.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),n)return;n=!0;const Y=d[l],H=a[o];if(!Y||!H)return;let G=null,re=-1;for(const[ye,Se]of Object.entries(t.homeTeam)){const he=(Se||[]).findIndex(we=>we.cardId===Y.cardId);if(he!==-1){G=ye,re=he;break}}if(re===-1||!G){jt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),g.remove();return}const pe={...H,_line:G,_col:Y._col||0,used:!1,boost:0};t.homeTeam[G].splice(re,1,pe),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(H.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:Me(Y,G),portrait:Pe(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:H.name,firstname:H.firstname,note:Me(H,G),portrait:Pe(H),job:H.job,country_code:H.country_code,rarity:H.rarity,clubName:H.clubName,clubLogo:H.clubLogo},text:`🔄 ${H.firstname} ${H.name} remplace ${Y.firstname} ${Y.name}`}),g.remove(),Dn(Y,H,()=>Xe(e,t,i))})}document.body.appendChild(g),v()}function Gn(e,t,i,s,c){var z,r;const d=(s.gcDefs||[]).find(u=>u.name===t),a=Ve[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",p={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",o=(d==null?void 0:d.name)||t,n=(d==null?void 0:d.effect)||a.desc,g=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,v=a.icon||"⚡",y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",y.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
      ${e.map(g=>{const v=g._line||g.job||"MIL",y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[v]||"#555",z=Me(g,v)+(g.boost||0),r=l.find(u=>u.cardId===g.cardId);return`<div class="gc-pick-item" data-cid="${g.cardId}"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${s.map(c=>`
        <div class="player-boost-opt" data-card-id="${c.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Mt[c.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Me(c,c._line||c.job)}</div>
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const p=()=>{l||(l=!0,d.remove(),setTimeout(()=>c(),50))};d.addEventListener("click",p),setTimeout(p,3500)}async function Bt(e,t,i){var n,g;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,c=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,a=c?"victoire":d?"nul":"defaite",l=Vo(t.mode,a);t.matchId&&await E.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?s.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(s.profile.credits||0)+l,matches_played:(s.profile.matches_played||0)+1};c?p.wins=(s.profile.wins||0)+1:d?p.draws=(s.profile.draws||0)+1:p.losses=(s.profile.losses||0)+1,await E.from("users").update(p).eq("id",s.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const z=async(W=!0)=>{v=!0,y&&(E.removeChannel(y),y=null),W&&await E.rpc("cancel_matchmaking",{p_user_id:o.profile.id}).catch(()=>{})};(D=document.getElementById("mm-cancel"))==null||D.addEventListener("click",async()=>{try{await z(!0)}catch{}We(e),n("home")});const r=async(W,F,P)=>{if(v)return;v=!0,y&&(E.removeChannel(y),y=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(U=>setTimeout(U,600)),e.isConnected&&$o(e,t,W,P,a,l)},{data:u,error:M}=await E.rpc("try_matchmake",{p_user_id:o.profile.id,p_deck_id:i});if(M||!(u!=null&&u.success)){g("Erreur de matchmaking","error"),We(e),n("home");return}if(u.matched){r(u.match_id,u.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),y=E.channel("matchmaking-"+o.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${o.profile.id}`},W=>{const F=W.new;F.status==="matched"&&F.match_id&&r(F.match_id,F.matched_with,!0)}).subscribe()}async function Un(e,t,i){const{state:s,navigate:c,toast:d}=t;try{(E.getChannels?E.getChannels():[]).forEach(o=>{const n=o.topic||"";(n.includes("matchmaking")||n.includes("pvp-match")||n.includes("friend-invite"))&&E.removeChannel(o)})}catch{}const{data:a}=await E.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!a){d("Match introuvable","error"),c("home");return}if(a.status==="finished"){d("Ce match est terminé","info"),c("home");return}const l=a.home_id===s.profile.id;$o(e,t,i,l,[],[])}async function $o(e,t,i,s,c=[],d=[]){const{state:a,navigate:l,toast:p}=t,o=s?"p1":"p2",n=s?"p2":"p1",g=(c||[]).map(I=>I.id),v=(c||[]).map(I=>({id:I.id,gc_type:I.gc_type,_gcDef:I._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:y}=await E.from("matches").select("*").eq("id",i).single();if(!y){p("Match introuvable","error"),l("home");return}async function z(){const[{data:I},{data:C},{data:w},{data:k}]=await Promise.all([E.rpc("get_deck_for_match",{p_deck_id:y.home_deck_id}),E.rpc("get_deck_for_match",{p_deck_id:y.away_deck_id}),E.from("users").select("id,pseudo,club_name").eq("id",y.home_id).single(),E.from("users").select("id,pseudo,club_name").eq("id",y.away_id).single()]),f=A=>({cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:Number(A.note_g)||0,note_d:Number(A.note_d)||0,note_m:Number(A.note_m)||0,note_a:Number(A.note_a)||0,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),m=((I==null?void 0:I.starters)||[]).map(A=>f(A)),x=((C==null?void 0:C.starters)||[]).map(A=>f(A)),b=(I==null?void 0:I.formation)||"4-4-2",h=(C==null?void 0:C.formation)||"4-4-2";let _=yt(m,b),T=yt(x,h);const $=((I==null?void 0:I.subs)||[]).map(A=>f(A));return stadiumDef&&s&&(_=Ht(_,stadiumDef),ii($,stadiumDef)),{p1Team:_,p2Team:T,p1Subs:$,p2Subs:((C==null?void 0:C.subs)||[]).map(A=>f(A)),p1Formation:b,p2Formation:h,p1Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 1",p2Name:(k==null?void 0:k.club_name)||(k==null?void 0:k.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?g:[],gc_p2:s?[]:g,gcCardsFull_p1:s?v:[],gcCardsFull_p2:s?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=y.game_state&&Object.keys(y.game_state).length?y.game_state:null;if(!r)if(s){r=await z();const{data:I}=await E.from("matches").select("game_state").eq("id",i).single();!(I!=null&&I.game_state)||!Object.keys(I.game_state).length?await E.from("matches").update({game_state:r,turn_user_id:y.home_id}).eq("id",i):r=I.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let I=0;I<30&&!r;I++){await new Promise(w=>setTimeout(w,400));const{data:C}=await E.from("matches").select("game_state").eq("id",i).single();C!=null&&C.game_state&&Object.keys(C.game_state).length&&(r=C.game_state)}if(!r){p("Erreur de synchronisation","error"),l("home");return}r.gc_p2=g,r.gcCardsFull_p2=v,await E.from("matches").update({game_state:r}).eq("id",i)}let u=!1,M=null,L=!1;const D=new Set,W=new Set;function F(I){var _,T;try{E.removeChannel(P)}catch{}const C=r[o+"Score"]||0,w=r[n+"Score"]||0;let k,f;I.winner_id?(k=I.winner_id===a.profile.id,f=!1):I.forfeit?(k=C>w,f=!1):(f=C===w,k=C>w),(_=document.getElementById("pvp-end-overlay"))==null||_.remove();const m=document.createElement("div");m.id="pvp-end-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const x=f?"🤝":k?"🏆":"😞",b=f?"MATCH NUL":k?"VICTOIRE !":"DÉFAITE",h=f?"#fff":k?"#FFD700":"#ff6b6b";m.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(m),(T=m.querySelector("#pvp-end-home"))==null||T.addEventListener("click",()=>{m.remove(),We(e),l("home")})}const P=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},I=>{const C=I.new;try{if(C.status==="finished"||C.forfeit){if(u)return;u=!0,M&&(clearInterval(M),M=null),C.game_state&&(r=C.game_state),F(C);return}if(C.game_state){const w=r;r=C.game_state;const k=r._lastGC;if(k&&k.seq&&!W.has(k.seq)&&(W.add(k.seq),k.by!==o)){he(k.type,k.by,()=>G());return}const f=w[o+"Score"]||0,m=w[n+"Score"]||0,x=r[o+"Score"]||0,b=r[n+"Score"]||0,h=x>f,_=b>m;if((h||_)&&!D.has(r.round)){D.add(r.round);const T=[...r.log||[]].reverse().find(A=>A.isGoal),$=((T==null?void 0:T.homePlayers)||[]).map(A=>({name:A.name,note:A.note,portrait:A.portrait,job:A.job}));Se($,x,b,h,()=>G());return}G()}}catch(w){console.error("[PvP] crash:",w)}}).subscribe();async function j(I){Object.assign(r,I),r.lastActionAt=new Date().toISOString();const{error:C}=await E.from("matches").update({game_state:r}).eq("id",i);C&&p("Erreur de synchronisation","error");try{G()}catch(w){console.error("[PvP] renderPvpScreen crash:",w)}}async function U(){if(u)return;u=!0,M&&(clearInterval(M),M=null);const I=s?y.away_id:y.home_id,C=s?"p2":"p1",w=s?"p1":"p2",k={...r,[C+"Score"]:3,[w+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:I,home_score:k.p1Score||0,away_score:k.p2Score||0,game_state:k}).eq("id",i)}catch{}try{E.removeChannel(P)}catch{}setTimeout(()=>{We(e),l("home")},800)}const oe={BOOST_STAT:({value:I=1,count:C=1,roles:w=[]},k,f)=>{const m=k[o+"Team"],x=Object.entries(m).filter(([b])=>!w.length||w.includes(b)).flatMap(([b,h])=>h.filter(_=>!_.used).map(_=>({..._,_line:b})));if(!x.length){k.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),f(k);return}de(x,C,`Choisir ${C} joueur(s) à booster (+${I})`,b=>{b.forEach(h=>{const _=(m[h._line]||[]).find(T=>T.cardId===h.cardId);_&&(_.boost=(_.boost||0)+I,k.log.push({text:`⚡ +${I} sur ${_.name}`,type:"info"}))}),k[o+"Team"]=m,f(k)})},DEBUFF_STAT:({value:I=1,count:C=1,roles:w=[],target:k="ai"},f,m)=>{const x=k==="home"?o:n,b=f[x+"Team"],h=k==="home"?"allié":"adverse",_=Object.entries(b).filter(([T])=>!w.length||w.includes(T)).flatMap(([T,$])=>$.map(A=>({...A,_line:T})));if(!_.length){f.log.push({text:`🎯 Aucun joueur ${h}`,type:"info"}),m(f);return}de(_,C,`Choisir ${C} joueur(s) ${h}(s) (-${I})`,T=>{T.forEach($=>{const A=(b[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.boost=(A.boost||0)-I,f.log.push({text:`🎯 -${I} sur ${A.name}`,type:"info"}))}),f[x+"Team"]=b,m(f)})},GRAY_PLAYER:({count:I=1,roles:C=[],target:w="ai"},k,f)=>{const m=w==="home"?o:n,x=k[m+"Team"],b=w==="home"?"allié":"adverse",h=Object.entries(x).filter(([_])=>!C.length||C.includes(_)).flatMap(([_,T])=>T.filter($=>!$.used).map($=>({...$,_line:_})));if(!h.length){k.log.push({text:`❌ Aucun joueur ${b}`,type:"info"}),f(k);return}de(h,I,`Choisir ${I} joueur(s) ${b}(s) à exclure`,_=>{const T="usedCardIds_"+m,$=new Set(k[T]||[]);_.forEach(A=>{const S=(x[A._line]||[]).find(q=>q.cardId===A.cardId);S&&(S.used=!0,$.add(A.cardId),k.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),k[T]=[...$],k[m+"Team"]=x,f(k)})},REVIVE_PLAYER:({count:I=1,roles:C=[]},w,k)=>{const f=w[o+"Team"],m=Object.entries(f).filter(([x])=>!C.length||C.includes(x)).flatMap(([x,b])=>b.filter(h=>h.used).map(h=>({...h,_line:x})));if(!m.length){w.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),k(w);return}de(m,I,`Choisir ${I} joueur(s) à ressusciter`,x=>{x.forEach(b=>{const h=(f[b._line]||[]).find(_=>_.cardId===b.cardId);h&&(h.used=!1,w.log.push({text:`💫 ${h.name} ressuscité !`,type:"info"}))}),w[o+"Team"]=f,k(w)})},REMOVE_GOAL:({},I,C)=>{const w=n+"Score";I[w]>0?(I[w]--,I.log.push({text:"🚫 Dernier but annulé !",type:"info"})):I.log.push({text:"🚫 Aucun but à annuler",type:"info"}),C(I)},ADD_GOAL_DRAW:({},I,C)=>{I[o+"Score"]===I[n+"Score"]?(I[o+"Score"]++,I.log.push({text:"🎯 But bonus !",type:"info"})):I.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),C(I)},ADD_SUB:({value:I=1},C,w)=>{C.maxSubs=(C.maxSubs||3)+I,C.log.push({text:`🔄 +${I} remplacement(s)`,type:"info"}),w(C)},CUSTOM:({},I,C)=>C(I)};function de(I,C,w,k){const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let m=[];function x(){var h,_;const b=I.map(T=>{const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",A=Me(T,T._line)+(T.boost||0),q=m.find(R=>R.cardId===T.cardId)?"#FFD700":"rgba(255,255,255,0.25)",B=T.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${q};background:${$};overflow:hidden;cursor:pointer;${B}">
        ...
        </div>`,(h=f.querySelector("#pp-close"))==null||h.addEventListener("click",()=>f.remove()),f.querySelectorAll(".pp-item").forEach(T=>{T.addEventListener("click",()=>{const $=T.dataset.cid,A=I.find(q=>q.cardId===$),S=m.findIndex(q=>q.cardId===$);A&&(S>-1?m.splice(S,1):m.length<C&&m.push(A),x())})}),(_=f.querySelector("#pp-confirm"))==null||_.addEventListener("click",()=>{f.remove(),k(m)})}x(),document.body.appendChild(f)}async function N(I,C){const k=(r["gcCardsFull_"+o]||[]).find(b=>b.id===I),f=(k==null?void 0:k._gcDef)||(r.gcDefs||[]).find(b=>{var h;return b.name===C||((h=b.name)==null?void 0:h.toLowerCase().trim())===(C==null?void 0:C.toLowerCase().trim())}),m=[...r["usedGc_"+o]||[],I],x={type:C,by:o,seq:(r._gcAnimSeq||0)+1};W.add(x.seq),he(C,o,async()=>{if(f!=null&&f.effect_type&&f.effect_type!=="CUSTOM"){const h=oe[f.effect_type];if(h){const _={...r};h(f.effect_params||{},_,async T=>{T["usedGc_"+o]=m,T._lastGC=x,T._gcAnimSeq=x.seq,await j(T)});return}}const b={...r};switch(C){case"Remplacement+":b.maxSubs=(b.maxSubs||3)+1,b.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const h=n+"Score";b[h]>0&&(b[h]--,b.log.push({text:"🚫 But annulé",type:"info"}));break}}b["usedGc_"+o]=m,b._lastGC=x,b._gcAnimSeq=x.seq,await j(b)})}function Y(I,C){const w="usedCardIds_"+I,k=new Set(r[w]||[]);C.forEach(f=>k.add(f)),r[w]=[...k]}function H(){for(const I of["p1","p2"]){const C=new Set(r["usedCardIds_"+I]||[]),w=r[I+"Team"];if(w)for(const k of["GK","DEF","MIL","ATT"])(w[k]||[]).forEach(f=>{f.used=C.has(f.cardId)})}}function G(){var Ue,Je,Ze,Qe,nt,gt;if(r.phase==="reveal")return re();if(r.phase==="midfield")return ye();if(r.phase==="finished")return De();const I=r[o+"Team"],C=r[n+"Team"];H();const w=r[o+"Score"],k=r[n+"Score"],f=r[o+"Name"],m=r[n+"Name"],x=r.phase===o+"-attack",b=r.phase===o+"-defense",h=Array.isArray(r["selected_"+o])?r["selected_"+o]:[],_=h.map(le=>le.cardId),T=window.innerWidth>=700,$=r[o+"Subs"]||[],A=r["usedSubIds_"+o]||[],S=$.filter(le=>!A.includes(le.cardId)),q=r["gcCardsFull_"+o]||[],B=r["usedGc_"+o]||[],R=q.filter(le=>!B.includes(le.id)),O=r.boostOwner===o&&!r.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(le=>(C[le]||[]).some(ke=>!ke.used)),K=[...I.MIL||[],...I.ATT||[]].filter(le=>!le.used),ie=x&&Q&&K.length===0?[...I.GK||[],...I.DEF||[]].filter(le=>!le.used).map(le=>le.cardId):[];function se(le,ke,te){var pt,ht;const ue=le._gcDef,ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ue==null?void 0:ue.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ce={purple:"#b06ce0",light_blue:"#00d4ef"}[ue==null?void 0:ue.color]||"#b06ce0",qe=(ue==null?void 0:ue.name)||le.gc_type,Ae=(ue==null?void 0:ue.effect)||((pt=Ve[le.gc_type])==null?void 0:pt.desc)||"",tt=ue!=null&&ue.image_url?`/manager-wars/icons/${ue.image_url}`:null,it=((ht=Ve[le.gc_type])==null?void 0:ht.icon)||"⚡",rt=Math.round(te*.22),st=Math.round(te*.22),ct=te-rt-st,$t=qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${le.id}" data-gc-type="${le.gc_type}"
        style="box-sizing:border-box;width:${ke}px;height:${te}px;border-radius:10px;border:2px solid ${ce};background:${ee};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${rt}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${$t}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ke-6}px">${qe}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${ct}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${tt?`<img src="${tt}" style="max-width:${ke-10}px;max-height:${ct-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(ct*.55)}px">${it}</span>`}
        </div>
      ...
      </div>`}function fe(le,ke){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${le}px;height:${ke}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(ke*.04)}px;text-align:center;flex-shrink:0">
        <div style="font-size:${Math.round(ke*.2)}px">⚡</div>
        <div style="font-size:${Math.round(ke*.09)}px;color:#000;font-weight:900">+${r.boostValue}</div>
      </div>`}const me=(le,ke)=>ke?fe(130,175):se(le,130,175),_e=(le,ke)=>ke?fe(68,95):se(le,68,95),$e=T?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Ce=x?be(o)?`<button id="pvp-action" style="${$e};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${h.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${$e};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:b?`<button id="pvp-action" style="${$e};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${h.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${m}</div>`,je=x&&!be(o)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':x||b?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${h.length}/3 sélectionné(s)</div>`:"",Re=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${T?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(I,r[o+"Formation"],Be,_,300,300,ie)}
      </div>
    </div>`;function Fe(le){if(le.type==="duel"&&(le.homeTotal!=null||le.aiTotal!=null)){const ke=(le.homeTotal||0)>=(le.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            ...
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
              <div style="font-size:${ke?20:14}px;font-weight:900;color:${ke?"#FFD700":"rgba(255,255,255,0.4)"};line-height:1">${le.homeTotal}</div>
              <div style="font-size:8px;color:rgba(255,255,255,0.3);margin:1px 0">VS</div>
              <div style="font-size:${ke?14:20}px;font-weight:900;color:${ke?"rgba(255,255,255,0.4)":"#ff6b6b"};line-height:1">${le.aiTotal}</div>
            </div>
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-start;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
        ...
        </div>`}return`<div style="font-size:11px;color:${le.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${le.type==="goal"?700:400};padding:3px 2px">${le.text||""}</div>`}const Ke=(()=>{var ke,te;if(b&&((ke=r.pendingAttack)!=null&&ke.players)){const ue=r.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;function He(){const le=e.querySelector(".match-screen");if(!le)return;const ke=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);le.style.height=ke+"px",le.style.minHeight=ke+"px",le.style.maxHeight=ke+"px",le.style.overflow="hidden";const te=e.querySelector("#mobile-action-bar"),ue=e.querySelector("#mobile-play-area");te&&ue&&(ue.style.paddingBottom=te.offsetHeight+"px")}if(He(),setTimeout(He,120),setTimeout(He,400),L||(L=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",He),window.visualViewport.addEventListener("scroll",He)),window.addEventListener("resize",He)),function(){const ke=e.querySelector(".terrain-wrapper svg");ke&&(ke.removeAttribute("width"),ke.removeAttribute("height"),ke.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ke.setAttribute("viewBox","-26 -26 352 352"),ke.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(le=>{le.addEventListener("click",()=>{if(!x&&!b)return;const ke=le.dataset.cardId,te=le.dataset.role,ue=(I[te]||[]).find(Ae=>Ae.cardId===ke);if(!ue||ue.used)return;const ee=ie.includes(ke);if(x&&!["MIL","ATT"].includes(te)&&!ee)return;Array.isArray(r["selected_"+o])||(r["selected_"+o]=[]);const ce=r["selected_"+o],qe=ce.findIndex(Ae=>Ae.cardId===ke);qe>-1?ce.splice(qe,1):ce.length<3&&ce.push({...ue,_role:te}),G()})}),e.querySelectorAll(".match-used-hit").forEach(le=>{le.addEventListener("click",()=>ze(le.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(le=>{le.addEventListener("click",()=>ze())}),(Ue=e.querySelector("#pvp-sub-open"))==null||Ue.addEventListener("click",()=>ze()),e.querySelectorAll(".pvp-gc-mini").forEach(le=>{le.addEventListener("click",()=>we(le.dataset.gcId,le.dataset.gcType))}),(Je=e.querySelector("#pvp-boost-card"))==null||Je.addEventListener("click",()=>ve()),(Ze=e.querySelector("#pvp-action"))==null||Ze.addEventListener("click",le=>{x?le.currentTarget.dataset.pass==="1"||!be(o)?ne():ge():b&&J()}),(Qe=e.querySelector("#pvp-quit"))==null||Qe.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&U()}),(nt=e.querySelector("#pvp-view-opp"))==null||nt.addEventListener("click",()=>xe()),(gt=e.querySelector("#pvp-toggle-history"))==null||gt.addEventListener("click",()=>X()),M&&(clearInterval(M),M=null),(x||b)&&!u){let le=30,ke=!1;const te=()=>document.getElementById("pvp-timer"),ue=()=>{te()&&(te().textContent=le+"s",te().style.color=ke?"#ff4444":"#fff")};ue(),M=setInterval(()=>{le--,le<0?ke?(clearInterval(M),M=null,x&&!be(o)?ne():U()):(ke=!0,le=15,ue()):ue()},1e3)}}function re(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
    </div>`,o==="p1"&&setTimeout(async()=>{await j({phase:"midfield"})},5e3)}let pe=!1;function ye(){if(pe)return;const I=r[o+"Team"].MIL||[],C=r[n+"Team"].MIL||[];function w(R){return R.reduce((O,Q)=>O+Me(Q,"MIL"),0)}function k(R){let O=0;for(let Q=0;Q<R.length-1;Q++){const K=at(R[Q],R[Q+1]);K==="#00ff88"?O+=2:K==="#FFD700"&&(O+=1)}return O}const f=w(I)+k(I),m=w(C)+k(C),x=f>=m;function b(R,O,Q){return`<div id="duel-row-${Q}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${R.map((K,ie)=>{const se=ie<R.length-1?at(K,R[ie+1]):null,fe=!se||se==="#ff3333"||se==="#cc2222",me=se==="#00ff88"?"+2":se==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${Q}" data-idx="${ie}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...K,note:Me(K,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${ie<R.length-1?`<div class="duel-link duel-link-${Q}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${fe?"rgba(255,255,255,0.12)":se};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${fe?"none":`0 0 8px ${se}`}">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    </div>`;const h=(R,O)=>e.querySelectorAll(R).forEach((Q,K)=>{setTimeout(()=>{Q.style.opacity="1",Q.style.transform="translateY(0) scale(1)"},O+K*90)});h(".duel-card-me",150),h(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((R,O)=>setTimeout(()=>{R.style.opacity="1"},O*70)),900),setTimeout(()=>{const R=e.querySelector("#pvp-vs");R&&(R.style.opacity="1",R.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(O=>O.style.opacity="1")},1250);function _(R,O,Q){const K=document.getElementById(R);if(!K)return;const ie=performance.now(),se=fe=>{const me=Math.min(1,(fe-ie)/Q);K.textContent=Math.round(O*(1-Math.pow(1-me,3))),me<1?requestAnimationFrame(se):K.textContent=O};requestAnimationFrame(se)}setTimeout(()=>{_("pvp-score-me",f,800),_("pvp-score-opp",m,800)},1500);const T=r.p1Team.MIL||[],$=r.p2Team.MIL||[],A=w(T)+k(T),S=w($)+k($),q=A>=S?"p1":"p2";let B=r.boostValue;B==null&&(B=oi(),r.boostValue=B,r.boostOwner=q,r.boostUsed=!1),pe=!0,setTimeout(()=>{const R=e.querySelector("#duel-row-"+(x?"me":"opp")),O=e.querySelector("#duel-row-"+(x?"opp":"me")),Q=document.getElementById("pvp-score-me"),K=document.getElementById("pvp-score-opp"),ie=x?Q:K,se=x?K:Q;ie&&(ie.style.fontSize="80px",ie.style.color=x?"#FFD700":"#ff6b6b",ie.style.animation="duelPulse .5s ease"+(x?",duelGlow 1.5s ease infinite .5s":"")),se&&(se.style.opacity="0.25"),setTimeout(()=>{R&&(R.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",R.style.zIndex="5"),setTimeout(()=>{const fe=document.getElementById("duel-shock");fe&&(fe.style.animation="shockwave .5s ease-out forwards"),O&&(O.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var $e;const fe=document.getElementById("pvp-duel-finale");if(!fe)return;const me=r.boostOwner===o?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+B+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",_e=o==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;fe.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(x?"⚽ "+r[o+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+r[n+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+me+_e,fe.style.transition="opacity .45s ease",fe.style.opacity="1",fe.style.pointerEvents="auto",($e=document.getElementById("pvp-start-match"))==null||$e.addEventListener("click",async()=>{const Ce=q;await j({phase:Ce+"-attack",attacker:Ce,round:1,boostValue:B,boostUsed:!1,boostOwner:Ce})})},600)},700)},2800)}function Se(I,C,w,k,f){const m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const x=Array.from({length:10},(T,$)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${$%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][$%8]}</div>`).join(""),b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};m.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(m);let h=!1;const _=()=>{h||(h=!0,m.remove(),setTimeout(()=>f(),50))};m.addEventListener("click",_),setTimeout(_,3500)}function he(I,C,w){var B,R;const k=(r.gcDefs||[]).find(O=>{var Q;return O.name===I||((Q=O.name)==null?void 0:Q.toLowerCase().trim())===(I==null?void 0:I.toLowerCase().trim())}),f={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[k==null?void 0:k.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",m={purple:"#b06ce0",light_blue:"#00d4ef"}[k==null?void 0:k.color]||"#b06ce0",x=(k==null?void 0:k.name)||I,b=(k==null?void 0:k.effect)||((B=Ve[I])==null?void 0:B.desc)||"",h=k!=null&&k.image_url?`/manager-wars/icons/${k.image_url}`:null,_=((R=Ve[I])==null?void 0:R.icon)||"⚡",$=C===o?"Vous":r[C+"Name"]||"Adversaire",A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",A.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(A);let S=!1;const q=()=>{S||(S=!0,A.remove(),setTimeout(()=>w&&w(),50))};A.addEventListener("click",q),setTimeout(q,3e3)}function we(I,C){var A,S,q,B;const k=(r["gcCardsFull_"+o]||[]).find(R=>R.id===I),f=k==null?void 0:k._gcDef,m={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[f==null?void 0:f.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",x={purple:"#b06ce0",light_blue:"#00d4ef"}[f==null?void 0:f.color]||"#b06ce0",b=(f==null?void 0:f.name)||C,h=(f==null?void 0:f.effect)||((A=Ve[C])==null?void 0:A.desc)||"Carte spéciale.",_=f!=null&&f.image_url?`/manager-wars/icons/${f.image_url}`:null,T=((S=Ve[C])==null?void 0:S.icon)||"⚡",$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",$.innerHTML=`
      ...
      </div>`,document.body.appendChild(w),(k=w.querySelector("#bp-close"))==null||k.addEventListener("click",()=>w.remove()),w.querySelectorAll(".bp-item").forEach(f=>{f.addEventListener("click",async()=>{const m=f.dataset.cid,x=C.find(h=>h.cardId===m);if(!x)return;const b=(I[x._line]||[]).find(h=>h.cardId===m);b&&(b.boost=(b.boost||0)+r.boostValue),w.remove(),await j({[o+"Team"]:I,boostUsed:!0})})})}function ze(I=null){var S,q;if(!(r.phase===o+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const w=r[o+"Team"],k=r["usedSubIds_"+o]||[],f=r.maxSubs||3;if(k.length>=f){p(`Maximum ${f} remplacements atteint`,"warning");return}const m=Object.entries(w).flatMap(([B,R])=>(R||[]).filter(O=>O.used).map(O=>({...O,_line:B}))),x=(r[o+"Subs"]||[]).filter(B=>!k.includes(B.cardId));if(!m.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!x.length){p("Aucun remplaçant disponible","warning");return}let b=Math.max(0,m.findIndex(B=>B.cardId===I));const h=((S=m[b])==null?void 0:S._line)||((q=m[b])==null?void 0:q.job);let _=Math.max(0,x.findIndex(B=>B.job===h)),T=!1;const $=document.createElement("div");$.id="pvp-sub-overlay",$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function A(){var se,fe,me,_e,$e,Ce;const B=m[b],R=x[_],O=Math.min(130,Math.round((window.innerWidth-90)/2)),Q=Math.round(O*1.35),K=je=>`background:rgba(255,255,255,0.12);border:none;color:${je?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${je?"default":"pointer"};flex-shrink:0`;$.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          <div style="font-size:9px;color:#00ff88;letter-spacing:2px;text-transform:uppercase;font-weight:700">Joueur qui entre</div>
          <button id="pin-up" style="${K(_===0)}" ${_===0?"disabled":""}>▲</button>
          <div>${R?Ye({...R,used:!1,boost:0},O,Q):"<div>—</div>"}</div>
          <button id="pin-down" style="${K(_>=x.length-1)}" ${_>=x.length-1?"disabled":""}>▼</button>
      ...
      </div>`,(se=$.querySelector("#psub-close"))==null||se.addEventListener("click",()=>$.remove()),(fe=$.querySelector("#pout-up"))==null||fe.addEventListener("click",()=>{b>0&&(b--,A())}),(me=$.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{b<m.length-1&&(b++,A())}),(_e=$.querySelector("#pin-up"))==null||_e.addEventListener("click",()=>{_>0&&(_--,A())}),($e=$.querySelector("#pin-down"))==null||$e.addEventListener("click",()=>{_<x.length-1&&(_++,A())});const ie=(je,Re,Be,Oe)=>{const Fe=$.querySelector("#"+je);if(!Fe)return;let Ke=0;Fe.addEventListener("touchstart",Ne=>{Ke=Ne.touches[0].clientY},{passive:!0}),Fe.addEventListener("touchend",Ne=>{const He=Ne.changedTouches[0].clientY-Ke;if(Math.abs(He)<30)return;const Ue=Re();He<0&&Ue<Oe-1?(Be(Ue+1),A()):He>0&&Ue>0&&(Be(Ue-1),A())},{passive:!0})};ie("pin-panel",()=>_,je=>_=je,x.length),ie("pout-panel",()=>b,je=>b=je,m.length),(Ce=$.querySelector("#psub-confirm"))==null||Ce.addEventListener("click",async je=>{if(je.preventDefault(),je.stopPropagation(),T)return;T=!0;const Re=m[b],Be=x[_];if(!Re||!Be)return;const Oe=Re._line,Fe=(w[Oe]||[]).findIndex(He=>He.cardId===Re.cardId);if(Fe===-1){p("Erreur : joueur introuvable","error"),$.remove();return}const Ke={...Be,_line:Oe,position:Re.position,used:!1,boost:0};w[Oe].splice(Fe,1,Ke);const Ne=[...k,Be.cardId];$.remove(),Ie(Re,Be,async()=>{await j({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],["usedSubIds_"+o]:Ne})})})}document.body.appendChild($),A()}function Ie(I,C,w){const k={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const m=(h,_,T)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(I),(C=I.querySelector("#pvp-opp-close"))==null||C.addEventListener("click",()=>I.remove())}function X(){var w;const I=r.log||[],C=document.createElement("div");C.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",C.innerHTML=`
      ...
      </div>`,document.body.appendChild(C),(w=C.querySelector("#pvp-hist-close"))==null||w.addEventListener("click",()=>C.remove())}async function ne(){if(r.phase!==o+"-attack")return;const I=o==="p1"?"p2":"p1",C=(r.round||0)+1,w=[...r.log||[]];w.push({type:"info",text:`⏭️ ${r[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const k=Le(r),f=be(I),m=k||!f?"finished":I+"-attack";await j({["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:m,attacker:I,round:C,log:w}),m==="finished"&&await Te(r)}async function ge(){const I=r[o+"Team"],C=!["GK","DEF","MIL","ATT"].some(m=>(r[n+"Team"][m]||[]).some(x=>!x.used)),w=(r["selected_"+o]||[]).map(m=>{const x=(I[m._role]||[]).find(A=>A.cardId===m.cardId)||m,b=C&&["GK","DEF"].includes(m._role),h=I[m._role]||[],_=h.findIndex(A=>A.cardId===m.cardId),T=lt(h.length),$=_>=0?T[_]:x._col??1;return{...x,_line:m._role,_col:$,...b?{note_a:Math.max(1,Number(x.note_a)||0)}:{}}});if(!w.length)return;const k=Nt(w,r.modifiers[o]||{});Y(o,w.map(m=>m.cardId)),w.forEach(m=>{const x=(I[m._role]||[]).find(b=>b.cardId===m.cardId);x&&(x.used=!0)}),r["selected_"+o]=[],G();const f=[...r.log||[]];if(C){const m=(r[o+"Score"]||0)+1,x=w.map($=>({name:$.name,note:Me($,$._line||"ATT"),portrait:Pe($),job:$.job}));f.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:x,homeTotal:k.total,aiTotal:0});const b=(r.round||0)+1,h=o==="p1"?"p2":"p1",_={...r,[o+"Team"]:I,[o+"Score"]:m},T=Le(_);D.add(b),Se(x,m,r[n+"Score"]||0,!0,async()=>{await j({[o+"Team"]:I,[o+"Score"]:m,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:T?"finished":h+"-attack",attacker:h,round:b,log:f}),T&&await Te({...r,[o+"Score"]:m})});return}f.push({type:"pending",text:`⚔️ ${r[o+"Name"]} attaque (${k.total})`}),await j({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],pendingAttack:{...k,players:w,side:o},["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},phase:n+"-defense",log:f})}async function J(){const I=r[o+"Team"],C=(r["selected_"+o]||[]).map(B=>{const R=(I[B._role]||[]).find(se=>se.cardId===B.cardId)||B,O=I[B._role]||[],Q=O.findIndex(se=>se.cardId===B.cardId),K=lt(O.length),ie=Q>=0?K[Q]:R._col??1;return{...R,_line:B._role,_col:ie}}),w=Rt(C,r.modifiers[o]||{});Y(o,C.map(B=>B.cardId)),C.forEach(B=>{const R=(I[B._role]||[]).find(O=>O.cardId===B.cardId);R&&(R.used=!0)}),r["selected_"+o]=[],G();const k=Ot(r.pendingAttack.total,w.total,r.modifiers[o]||{}),f=r.pendingAttack.side,m=k==="attack"||(k==null?void 0:k.goal),x=f==="p1"?"p2":"p1",b=(r.round||0)+1,h=(r.pendingAttack.players||[]).map(B=>({name:B.name,note:Me(B,B._line||"ATT"),portrait:Pe(B),job:B.job})),_=[...r.log||[]];_.push({type:"duel",isGoal:m,homeScored:m&&f===o,text:m?`⚽ BUT de ${r[f+"Name"]} ! (${r.pendingAttack.total} vs ${w.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${w.total})`,homePlayers:h,aiPlayers:C.map(B=>({name:B.name,note:Me(B,B._line||"DEF"),portrait:Pe(B),job:B.job})),homeTotal:r.pendingAttack.total,aiTotal:w.total});const T=m?(r[f+"Score"]||0)+1:r[f+"Score"]||0,$={...r,[o+"Team"]:I,[f+"Score"]:T},A=Le($),S=A?"finished":x+"-attack",q=async()=>{await j({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],[f+"Score"]:T,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:S,attacker:x,round:b,log:_}),(S==="finished"||A)&&await Te({...r,[f+"Score"]:T})};if(m){const B=f===o,R=B?T:r[o+"Score"]||0,O=B?r[n+"Score"]||0:T;D.add(b),Se(h,R,O,B,q)}else await q()}function Z(I){return["MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function V(I){return["GK","DEF","MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function ae(I){return V(I)&&!Z(I)}function be(I){const C=r[I+"Team"],w=r[(I==="p1"?"p2":"p1")+"Team"];return!!(Z(C)||!V(w)&&ae(C))}function Le(I){const C=["MIL","ATT"].some(_=>(I.p1Team[_]||[]).some(T=>!T.used)),w=["MIL","ATT"].some(_=>(I.p2Team[_]||[]).some(T=>!T.used)),k=V(I.p1Team),f=V(I.p2Team);return!C&&!(!f&&k)&&(!w&&!(!k&&f))}function Ee(I){const C=I.p1Score||0,w=I.p2Score||0;return C===w?null:C>w?y.home_id:y.away_id}async function Te(I){try{const C=Ee(I),w=C?y.home_id===C?y.away_id:y.home_id:null;await E.from("matches").update({status:"finished",winner_id:C,home_score:I.p1Score||0,away_score:I.p2Score||0}).eq("id",i),C&&w&&updateEvolutiveCards(C,w).catch(()=>{})}catch(C){console.error("[PvP] finishMatch:",C)}}function De(){var f;const I=r[o+"Score"],C=r[n+"Score"],w=I>C,k=I===C;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(A=b.querySelector("#pvp-end-home"))==null||A.addEventListener("click",()=>{b.remove(),We(e),l("home")})}const U=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{const k=w.new;try{if(k.status==="finished"||k.forfeit){if(u)return;u=!0,D&&(clearInterval(D),D=null),k.game_state&&(r=k.game_state),j(k);return}if(k.game_state){const f=r;r=k.game_state;const m=r._lastGC;if(m&&m.seq&&!P.has(m.seq)&&(P.add(m.seq),m.by!==o)){ve(m.type,m.by,()=>pe());return}const x=f[o+"Score"]||0,b=f[n+"Score"]||0,h=r[o+"Score"]||0,_=r[n+"Score"]||0,T=h>x,$=_>b;if((T||$)&&!F.has(r.round)){F.add(r.round);const A=[...r.log||[]].reverse().find(q=>q.isGoal),S=((A==null?void 0:A.homePlayers)||[]).map(q=>({name:q.name,note:q.note,portrait:q.portrait,job:q.job}));we(S,h,_,T,()=>pe());return}pe()}}catch(f){console.error("[PvP] crash:",f)}}).subscribe();async function oe(w){Object.assign(r,w),r.lastActionAt=new Date().toISOString();const{error:k}=await E.from("matches").update({game_state:r}).eq("id",i);k&&p("Erreur de synchronisation","error");try{pe()}catch(f){console.error("[PvP] renderPvpScreen crash:",f)}}async function de(){if(u)return;u=!0,D&&(clearInterval(D),D=null);const w=s?y.away_id:y.home_id,k=s?"p2":"p1",f=s?"p1":"p2",m={...r,[k+"Score"]:3,[f+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:w,home_score:m.p1Score||0,away_score:m.p2Score||0,game_state:m}).eq("id",i)}catch{}try{E.removeChannel(U)}catch{}setTimeout(()=>{We(e),l("home")},800)}const N={BOOST_STAT:({value:w=1,count:k=1,roles:f=[]},m,x)=>{const b=m[o+"Team"],h=Object.entries(b).filter(([_])=>!f.length||f.includes(_)).flatMap(([_,T])=>T.filter($=>!$.used).map($=>({...$,_line:_})));if(!h.length){m.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),x(m);return}Y(h,k,`Choisir ${k} joueur(s) à booster (+${w})`,_=>{_.forEach(T=>{const $=(b[T._line]||[]).find(A=>A.cardId===T.cardId);$&&($.boost=($.boost||0)+w,m.log.push({text:`⚡ +${w} sur ${$.name}`,type:"info"}))}),m[o+"Team"]=b,x(m)})},DEBUFF_STAT:({value:w=1,count:k=1,roles:f=[],target:m="ai"},x,b)=>{const h=m==="home"?o:n,_=x[h+"Team"],T=m==="home"?"allié":"adverse",$=Object.entries(_).filter(([A])=>!f.length||f.includes(A)).flatMap(([A,S])=>S.map(q=>({...q,_line:A})));if(!$.length){x.log.push({text:`🎯 Aucun joueur ${T}`,type:"info"}),b(x);return}Y($,k,`Choisir ${k} joueur(s) ${T}(s) (-${w})`,A=>{A.forEach(S=>{const q=(_[S._line]||[]).find(B=>B.cardId===S.cardId);q&&(q.boost=(q.boost||0)-w,x.log.push({text:`🎯 -${w} sur ${q.name}`,type:"info"}))}),x[h+"Team"]=_,b(x)})},GRAY_PLAYER:({count:w=1,roles:k=[],target:f="ai"},m,x)=>{const b=f==="home"?o:n,h=m[b+"Team"],_=f==="home"?"allié":"adverse",T=Object.entries(h).filter(([$])=>!k.length||k.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!T.length){m.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),x(m);return}Y(T,w,`Choisir ${w} joueur(s) ${_}(s) à exclure`,$=>{const A="usedCardIds_"+b,S=new Set(m[A]||[]);$.forEach(q=>{const B=(h[q._line]||[]).find(R=>R.cardId===q.cardId);B&&(B.used=!0,S.add(q.cardId),m.log.push({text:`❌ ${B.name} exclu !`,type:"info"}))}),m[A]=[...S],m[b+"Team"]=h,x(m)})},REVIVE_PLAYER:({count:w=1,roles:k=[]},f,m)=>{const x=f[o+"Team"],b=Object.entries(x).filter(([h])=>!k.length||k.includes(h)).flatMap(([h,_])=>_.filter(T=>T.used).map(T=>({...T,_line:h})));if(!b.length){f.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),m(f);return}Y(b,w,`Choisir ${w} joueur(s) à ressusciter`,h=>{h.forEach(_=>{const T=(x[_._line]||[]).find($=>$.cardId===_.cardId);T&&(T.used=!1,f.log.push({text:`💫 ${T.name} ressuscité !`,type:"info"}))}),f[o+"Team"]=x,m(f)})},REMOVE_GOAL:({},w,k)=>{const f=n+"Score";w[f]>0?(w[f]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),k(w)},ADD_GOAL_DRAW:({},w,k)=>{w[o+"Score"]===w[n+"Score"]?(w[o+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),k(w)},ADD_SUB:({value:w=1},k,f)=>{k.maxSubs=(k.maxSubs||3)+w,k.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),f(k)},CUSTOM:({},w,k)=>k(w)};function Y(w,k,f,m){const x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function h(){var T,$;const _=w.map(A=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[A._line]||"#555",q=Me(A,A._line)+(A.boost||0),R=b.find(Q=>Q.cardId===A.cardId)?"#FFD700":"rgba(255,255,255,0.25)",O=A.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${A.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${R};background:${S};overflow:hidden;cursor:pointer;${O}">
        ...
        </div>`,(T=x.querySelector("#pp-close"))==null||T.addEventListener("click",()=>x.remove()),x.querySelectorAll(".pp-item").forEach(A=>{A.addEventListener("click",()=>{const S=A.dataset.cid,q=w.find(R=>R.cardId===S),B=b.findIndex(R=>R.cardId===S);q&&(B>-1?b.splice(B,1):b.length<k&&b.push(q),h())})}),($=x.querySelector("#pp-confirm"))==null||$.addEventListener("click",()=>{x.remove(),m(b)})}h(),document.body.appendChild(x)}async function H(w,k){const m=(r["gcCardsFull_"+o]||[]).find(_=>_.id===w),x=(m==null?void 0:m._gcDef)||(r.gcDefs||[]).find(_=>{var T;return _.name===k||((T=_.name)==null?void 0:T.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),b=[...r["usedGc_"+o]||[],w],h={type:k,by:o,seq:(r._gcAnimSeq||0)+1};P.add(h.seq),ve(k,o,async()=>{if(x!=null&&x.effect_type&&x.effect_type!=="CUSTOM"){const T=N[x.effect_type];if(T){const $={...r};T(x.effect_params||{},$,async A=>{A["usedGc_"+o]=b,A._lastGC=h,A._gcAnimSeq=h.seq,await oe(A)});return}}const _={...r};switch(k){case"Remplacement+":_.maxSubs=(_.maxSubs||3)+1,_.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const T=n+"Score";_[T]>0&&(_[T]--,_.log.push({text:"🚫 But annulé",type:"info"}));break}}_["usedGc_"+o]=b,_._lastGC=h,_._gcAnimSeq=h.seq,await oe(_)})}function G(w,k){const f="usedCardIds_"+w,m=new Set(r[f]||[]);k.forEach(x=>m.add(x)),r[f]=[...m]}function re(){for(const w of["p1","p2"]){const k=new Set(r["usedCardIds_"+w]||[]),f=r[w+"Team"];if(f)for(const m of["GK","DEF","MIL","ATT"])(f[m]||[]).forEach(x=>{x.used=k.has(x.cardId)})}}function pe(){var Ze,Qe,nt,gt,le,ke;if(r.phase==="reveal")return ye();if(r.phase==="midfield")return he();if(r.phase==="finished")return C();const w=r[o+"Team"],k=r[n+"Team"];re();const f=r[o+"Score"],m=r[n+"Score"],x=r[o+"Name"],b=r[n+"Name"],h=r.phase===o+"-attack",_=r.phase===o+"-defense",T=Array.isArray(r["selected_"+o])?r["selected_"+o]:[],$=T.map(te=>te.cardId),A=window.innerWidth>=700,S=r[o+"Subs"]||[],q=r["usedSubIds_"+o]||[],B=S.filter(te=>!q.includes(te.cardId)),R=r["gcCardsFull_"+o]||[],O=r["usedGc_"+o]||[],Q=R.filter(te=>!O.includes(te.id)),K=r.boostOwner===o&&!r.boostUsed,ie=!["GK","DEF","MIL","ATT"].some(te=>(k[te]||[]).some(ue=>!ue.used)),se=[...w.MIL||[],...w.ATT||[]].filter(te=>!te.used),fe=h&&ie&&se.length===0?[...w.GK||[],...w.DEF||[]].filter(te=>!te.used).map(te=>te.cardId):[];function me(te,ue,ee){var kt,Ut;const ce=te._gcDef,qe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ae={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",tt=(ce==null?void 0:ce.name)||te.gc_type,it=(ce==null?void 0:ce.effect)||((kt=Ve[te.gc_type])==null?void 0:kt.desc)||"",rt=ce!=null&&ce.image_url?`/manager-wars/icons/${ce.image_url}`:null,st=((Ut=Ve[te.gc_type])==null?void 0:Ut.icon)||"⚡",ct=Math.round(ee*.22),$t=Math.round(ee*.22),pt=ee-ct-$t,ht=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${te.id}" data-gc-type="${te.gc_type}"
        style="box-sizing:border-box;width:${ue}px;height:${ee}px;border-radius:10px;border:2px solid ${Ae};background:${qe};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      </div>`}const $e=(te,ue)=>ue?_e(130,175):me(te,130,175),Ce=(te,ue)=>ue?_e(68,95):me(te,68,95),je=A?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Re=h?Ee(o)?`<button id="pvp-action" style="${je};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${T.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${je};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:_?`<button id="pvp-action" style="${je};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${T.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${b}</div>`,Be=h&&!Ee(o)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':h||_?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${T.length}/3 sélectionné(s)</div>`:"",Oe=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${A?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${B.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':B.map(te=>`<div class="pvp-sub-btn" data-sub-id="${te.cardId}" style="cursor:pointer;flex-shrink:0">${Ye(te,A?76:44,A?100:58)}</div>`).join("")}
    </div>`,Fe=h?"attack":_?"defense":"idle",Ke=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}if(h&&((ee=r.pendingAttack)!=null&&ee.players)){const ce=r.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function Je(){const te=e.querySelector(".match-screen");if(!te)return;const ue=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);te.style.height=ue+"px",te.style.minHeight=ue+"px",te.style.maxHeight=ue+"px",te.style.overflow="hidden";const ee=e.querySelector("#mobile-action-bar"),ce=e.querySelector("#mobile-play-area");ee&&ce&&(ce.style.paddingBottom=ee.offsetHeight+"px")}if(Je(),setTimeout(Je,120),setTimeout(Je,400),W||(W=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Je),window.visualViewport.addEventListener("scroll",Je)),window.addEventListener("resize",Je)),function(){const ue=e.querySelector(".terrain-wrapper svg");ue&&(ue.removeAttribute("width"),ue.removeAttribute("height"),ue.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ue.setAttribute("viewBox","-26 -26 352 352"),ue.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(te=>{te.addEventListener("click",()=>{if(!h&&!_)return;const ue=te.dataset.cardId,ee=te.dataset.role,ce=(w[ee]||[]).find(it=>it.cardId===ue);if(!ce||ce.used)return;const qe=fe.includes(ue);if(h&&!["MIL","ATT"].includes(ee)&&!qe)return;Array.isArray(r["selected_"+o])||(r["selected_"+o]=[]);const Ae=r["selected_"+o],tt=Ae.findIndex(it=>it.cardId===ue);tt>-1?Ae.splice(tt,1):Ae.length<3&&Ae.push({...ce,_role:ee}),pe()})}),e.querySelectorAll(".match-used-hit").forEach(te=>{te.addEventListener("click",()=>xe(te.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(te=>{te.addEventListener("click",()=>xe())}),(Ze=e.querySelector("#pvp-sub-open"))==null||Ze.addEventListener("click",()=>xe()),e.querySelectorAll(".pvp-gc-mini").forEach(te=>{te.addEventListener("click",()=>ze(te.dataset.gcId,te.dataset.gcType))}),(Qe=e.querySelector("#pvp-boost-card"))==null||Qe.addEventListener("click",()=>Ie()),(nt=e.querySelector("#pvp-action"))==null||nt.addEventListener("click",te=>{h?te.currentTarget.dataset.pass==="1"||!Ee(o)?J():Z():_&&V()}),(gt=e.querySelector("#pvp-quit"))==null||gt.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&de()}),(le=e.querySelector("#pvp-view-opp"))==null||le.addEventListener("click",()=>ne()),(ke=e.querySelector("#pvp-toggle-history"))==null||ke.addEventListener("click",()=>ge()),D&&(clearInterval(D),D=null),(h||_)&&!u){let te=30,ue=!1;const ee=()=>document.getElementById("pvp-timer"),ce=()=>{ee()&&(ee().textContent=te+"s",ee().style.color=ue?"#ff4444":"#fff")};ce(),D=setInterval(()=>{te--,te<0?ue?(clearInterval(D),D=null,h&&!Ee(o)?J():de()):(ue=!0,te=15,ce()):ce()},1e3)}}function ye(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      <div style="font-size:20px;font-weight:900;color:#ff6b6b">${r[n+"Name"]||"Adversaire"}</div>
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
    </div>`,o==="p1"&&setTimeout(async()=>{await oe({phase:"midfield"})},5e3)}let Se=!1;function he(){if(Se)return;const w=r[o+"Team"].MIL||[],k=r[n+"Team"].MIL||[];function f(Q){return Q.reduce((K,ie)=>K+Me(ie,"MIL"),0)}function m(Q){let K=0;for(let ie=0;ie<Q.length-1;ie++){const se=at(Q[ie],Q[ie+1]);se==="#00ff88"?K+=2:se==="#FFD700"&&(K+=1)}return K}const x=f(w)+m(w),b=f(k)+m(k),h=x>=b;function _(Q,K,ie){return`<div id="duel-row-${ie}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${Q.map((se,fe)=>{const me=fe<Q.length-1?at(se,Q[fe+1]):null,_e=!me||me==="#ff3333"||me==="#cc2222",$e=me==="#00ff88"?"+2":me==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${ie}" data-idx="${fe}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...se,note:Me(se,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${fe<Q.length-1?`<div class="duel-link duel-link-${ie}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${_e?"rgba(255,255,255,0.12)":me};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${_e?"none":`0 0 8px ${me}`}">
              ${$e?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${me}">${$e}</span>`:""}
            </div>`:""}`}).join("")}
        </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const T=(Q,K)=>e.querySelectorAll(Q).forEach((ie,se)=>{setTimeout(()=>{ie.style.opacity="1",ie.style.transform="translateY(0) scale(1)"},K+se*90)});T(".duel-card-me",150),T(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((Q,K)=>setTimeout(()=>{Q.style.opacity="1"},K*70)),900),setTimeout(()=>{const Q=e.querySelector("#pvp-vs");Q&&(Q.style.opacity="1",Q.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(K=>K.style.opacity="1")},1250);function $(Q,K,ie){const se=document.getElementById(Q);if(!se)return;const fe=performance.now(),me=_e=>{const $e=Math.min(1,(_e-fe)/ie);se.textContent=Math.round(K*(1-Math.pow(1-$e,3))),$e<1?requestAnimationFrame(me):se.textContent=K};requestAnimationFrame(me)}setTimeout(()=>{$("pvp-score-me",x,800),$("pvp-score-opp",b,800)},1500);const A=r.p1Team.MIL||[],S=r.p2Team.MIL||[],q=f(A)+m(A),B=f(S)+m(S),R=q>=B?"p1":"p2";let O=r.boostValue;O==null&&(O=oi(),r.boostValue=O,r.boostOwner=R,r.boostUsed=!1),Se=!0,setTimeout(()=>{const Q=e.querySelector("#duel-row-"+(h?"me":"opp")),K=e.querySelector("#duel-row-"+(h?"opp":"me")),ie=document.getElementById("pvp-score-me"),se=document.getElementById("pvp-score-opp"),fe=h?ie:se,me=h?se:ie;fe&&(fe.style.fontSize="80px",fe.style.color=h?"#FFD700":"#ff6b6b",fe.style.animation="duelPulse .5s ease"+(h?",duelGlow 1.5s ease infinite .5s":"")),me&&(me.style.opacity="0.25"),setTimeout(()=>{Q&&(Q.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",Q.style.zIndex="5"),setTimeout(()=>{const _e=document.getElementById("duel-shock");_e&&(_e.style.animation="shockwave .5s ease-out forwards"),K&&(K.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var je;const _e=document.getElementById("pvp-duel-finale");if(!_e)return;const $e=r.boostOwner===o?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+O+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ce=o==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;_e.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(h?"⚽ "+r[o+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+r[n+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+$e+Ce,_e.style.transition="opacity .45s ease",_e.style.opacity="1",_e.style.pointerEvents="auto",(je=document.getElementById("pvp-start-match"))==null||je.addEventListener("click",async()=>{const Re=R;await oe({phase:Re+"-attack",attacker:Re,round:1,boostValue:O,boostUsed:!1,boostOwner:Re})})},600)},700)},2800)}function we(w,k,f,m,x){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const h=Array.from({length:10},(A,S)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${S%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][S%8]}</div>`).join(""),_={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};b.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(b);let T=!1;const $=()=>{T||(T=!0,b.remove(),setTimeout(()=>x(),50))};b.addEventListener("click",$),setTimeout($,3500)}function ve(w,k,f){var O,Q;const m=(r.gcDefs||[]).find(K=>{var ie;return K.name===w||((ie=K.name)==null?void 0:ie.toLowerCase().trim())===(w==null?void 0:w.toLowerCase().trim())}),x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[m==null?void 0:m.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[m==null?void 0:m.color]||"#b06ce0",h=(m==null?void 0:m.name)||w,_=(m==null?void 0:m.effect)||((O=Ve[w])==null?void 0:O.desc)||"",T=m!=null&&m.image_url?`/manager-wars/icons/${m.image_url}`:null,$=((Q=Ve[w])==null?void 0:Q.icon)||"⚡",S=k===o?"Vous":r[k+"Name"]||"Adversaire",q=document.createElement("div");q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",q.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(q);let B=!1;const R=()=>{B||(B=!0,q.remove(),setTimeout(()=>f&&f(),50))};q.addEventListener("click",R),setTimeout(R,3e3)}function ze(w,k){var q,B,R,O;const m=(r["gcCardsFull_"+o]||[]).find(Q=>Q.id===w),x=m==null?void 0:m._gcDef,b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[x==null?void 0:x.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",h={purple:"#b06ce0",light_blue:"#00d4ef"}[x==null?void 0:x.color]||"#b06ce0",_=(x==null?void 0:x.name)||k,T=(x==null?void 0:x.effect)||((q=Ve[k])==null?void 0:q.desc)||"Carte spéciale.",$=x!=null&&x.image_url?`/manager-wars/icons/${x.image_url}`:null,A=((B=Ve[k])==null?void 0:B.icon)||"⚡",S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",S.innerHTML=`
      ...
      <div style="display:flex;gap:12px;width:190px">
        <button id="pvp-gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
        <button id="pvp-gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
      </div>`,document.body.appendChild(S),(R=S.querySelector("#pvp-gc-back"))==null||R.addEventListener("click",()=>S.remove()),(O=S.querySelector("#pvp-gc-use"))==null||O.addEventListener("click",()=>{S.remove(),H(w,k)})}function Ie(){var m;const w=r[o+"Team"],k=Object.entries(w).flatMap(([x,b])=>(b||[]).filter(h=>!h.used).map(h=>({...h,_line:x})));if(!k.length)return;const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",f.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${r.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${k.map(x=>{const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[x._line]||"#555",h=Me(x,x._line)+(x.boost||0);return`<div class="bp-item" data-cid="${x.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${b};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(f),(m=f.querySelector("#bp-close"))==null||m.addEventListener("click",()=>f.remove()),f.querySelectorAll(".bp-item").forEach(x=>{x.addEventListener("click",async()=>{const b=x.dataset.cid,h=k.find(T=>T.cardId===b);if(!h)return;const _=(w[h._line]||[]).find(T=>T.cardId===b);_&&(_.boost=(_.boost||0)+r.boostValue),f.remove(),await oe({[o+"Team"]:w,boostUsed:!0})})})}function xe(w=null){var B,R;if(!(r.phase===o+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const f=r[o+"Team"],m=r["usedSubIds_"+o]||[],x=r.maxSubs||3;if(m.length>=x){p(`Maximum ${x} remplacements atteint`,"warning");return}const b=Object.entries(f).flatMap(([O,Q])=>(Q||[]).filter(K=>K.used).map(K=>({...K,_line:O}))),h=(r[o+"Subs"]||[]).filter(O=>!m.includes(O.cardId));if(!b.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!h.length){p("Aucun remplaçant disponible","warning");return}let _=Math.max(0,b.findIndex(O=>O.cardId===w));const T=((B=b[_])==null?void 0:B._line)||((R=b[_])==null?void 0:R.job);let $=Math.max(0,h.findIndex(O=>O.job===T)),A=!1;const S=document.createElement("div");S.id="pvp-sub-overlay",S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function q(){var me,_e,$e,Ce,je,Re;const O=b[_],Q=h[$],K=Math.min(130,Math.round((window.innerWidth-90)/2)),ie=Math.round(K*1.35),se=Be=>`background:rgba(255,255,255,0.12);border:none;color:${Be?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Be?"default":"pointer"};flex-shrink:0`;S.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${Q?Ye({...Q,used:!1,boost:0},K,ie):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${O?Ye({...O,used:!1,boost:0},K,ie):"<div>—</div>"}</div>
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(me=S.querySelector("#psub-close"))==null||me.addEventListener("click",()=>S.remove()),(_e=S.querySelector("#pout-up"))==null||_e.addEventListener("click",()=>{_>0&&(_--,q())}),($e=S.querySelector("#pout-down"))==null||$e.addEventListener("click",()=>{_<b.length-1&&(_++,q())}),(Ce=S.querySelector("#pin-up"))==null||Ce.addEventListener("click",()=>{$>0&&($--,q())}),(je=S.querySelector("#pin-down"))==null||je.addEventListener("click",()=>{$<h.length-1&&($++,q())});const fe=(Be,Oe,Fe,Ke)=>{const Ne=S.querySelector("#"+Be);if(!Ne)return;let He=0;Ne.addEventListener("touchstart",Ue=>{He=Ue.touches[0].clientY},{passive:!0}),Ne.addEventListener("touchend",Ue=>{const Je=Ue.changedTouches[0].clientY-He;if(Math.abs(Je)<30)return;const Ze=Oe();Je<0&&Ze<Ke-1?(Fe(Ze+1),q()):Je>0&&Ze>0&&(Fe(Ze-1),q())},{passive:!0})};fe("pin-panel",()=>$,Be=>$=Be,h.length),fe("pout-panel",()=>_,Be=>_=Be,b.length),(Re=S.querySelector("#psub-confirm"))==null||Re.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),A)return;A=!0;const Oe=b[_],Fe=h[$];if(!Oe||!Fe)return;const Ke=Oe._line,Ne=(f[Ke]||[]).findIndex(Je=>Je.cardId===Oe.cardId);if(Ne===-1){p("Erreur : joueur introuvable","error"),S.remove();return}const He={...Fe,_line:Ke,position:Oe.position,used:!1,boost:0};f[Ke].splice(Ne,1,He);const Ue=[...m,Fe.cardId];S.remove(),X(Oe,Fe,async()=>{await oe({[o+"Team"]:f,[n+"Team"]:r[n+"Team"],["usedSubIds_"+o]:Ue})})})}document.body.appendChild(S),q()}function X(w,k,f){const m={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const b=(T,$,A)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(x);let h=!1;const _=()=>{h||(h=!0,x.remove(),setTimeout(()=>f(),50))};x.addEventListener("click",_),setTimeout(_,2200)}function ne(){var k;const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",w.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${r[n+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ut(r[n+"Team"],r[n+"Formation"],null,[],300,300)}</div>
      ...
      </div>`,document.body.appendChild(k),(m=k.querySelector("#pvp-hist-close"))==null||m.addEventListener("click",()=>k.remove())}async function J(){if(r.phase!==o+"-attack")return;const w=o==="p1"?"p2":"p1",k=(r.round||0)+1,f=[...r.log||[]];f.push({type:"info",text:`⏭️ ${r[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const m=Te(r),x=Ee(w),b=m||!x?"finished":w+"-attack";await oe({["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:b,attacker:w,round:k,log:f}),b==="finished"&&await I(r)}async function Z(){const w=r[o+"Team"],k=!["GK","DEF","MIL","ATT"].some(b=>(r[n+"Team"][b]||[]).some(h=>!h.used)),f=(r["selected_"+o]||[]).map(b=>{const h=(w[b._role]||[]).find(q=>q.cardId===b.cardId)||b,_=k&&["GK","DEF"].includes(b._role),T=w[b._role]||[],$=T.findIndex(q=>q.cardId===b.cardId),A=lt(T.length),S=$>=0?A[$]:h._col??1;return{...h,_line:b._role,_col:S,..._?{note_a:Math.max(1,Number(h.note_a)||0)}:{}}});if(!f.length)return;const m=Nt(f,r.modifiers[o]||{});G(o,f.map(b=>b.cardId)),f.forEach(b=>{const h=(w[b._role]||[]).find(_=>_.cardId===b.cardId);h&&(h.used=!0)}),r["selected_"+o]=[],pe();const x=[...r.log||[]];if(k){const b=(r[o+"Score"]||0)+1,h=f.map(S=>({name:S.name,note:Me(S,S._line||"ATT"),portrait:Pe(S),job:S.job}));x.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:h,homeTotal:m.total,aiTotal:0});const _=(r.round||0)+1,T=o==="p1"?"p2":"p1",$={...r,[o+"Team"]:w,[o+"Score"]:b},A=Te($);F.add(_),we(h,b,r[n+"Score"]||0,!0,async()=>{await oe({[o+"Team"]:w,[o+"Score"]:b,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:A?"finished":T+"-attack",attacker:T,round:_,log:x}),A&&await I({...r,[o+"Score"]:b})});return}x.push({type:"pending",text:`⚔️ ${r[o+"Name"]} attaque (${m.total})`}),await oe({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],pendingAttack:{...m,players:f,side:o},["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},phase:n+"-defense",log:x})}async function V(){const w=r[o+"Team"],k=(r["selected_"+o]||[]).map(O=>{const Q=(w[O._role]||[]).find(me=>me.cardId===O.cardId)||O,K=w[O._role]||[],ie=K.findIndex(me=>me.cardId===O.cardId),se=lt(K.length),fe=ie>=0?se[ie]:Q._col??1;return{...Q,_line:O._role,_col:fe}}),f=Rt(k,r.modifiers[o]||{});G(o,k.map(O=>O.cardId)),k.forEach(O=>{const Q=(w[O._role]||[]).find(K=>K.cardId===O.cardId);Q&&(Q.used=!0)}),r["selected_"+o]=[],pe();const m=Ot(r.pendingAttack.total,f.total,r.modifiers[o]||{}),x=r.pendingAttack.side,b=m==="attack"||(m==null?void 0:m.goal),h=x==="p1"?"p2":"p1",_=(r.round||0)+1,T=(r.pendingAttack.players||[]).map(O=>({name:O.name,note:Me(O,O._line||"ATT"),portrait:Pe(O),job:O.job})),$=[...r.log||[]];$.push({type:"duel",isGoal:b,homeScored:b&&x===o,text:b?`⚽ BUT de ${r[x+"Name"]} ! (${r.pendingAttack.total} vs ${f.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${f.total})`,homePlayers:T,aiPlayers:k.map(O=>({name:O.name,note:Me(O,O._line||"DEF"),portrait:Pe(O),job:O.job})),homeTotal:r.pendingAttack.total,aiTotal:f.total});const A=b?(r[x+"Score"]||0)+1:r[x+"Score"]||0,S={...r,[o+"Team"]:w,[x+"Score"]:A},q=Te(S),B=q?"finished":h+"-attack",R=async()=>{await oe({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],[x+"Score"]:A,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:B,attacker:h,round:_,log:$}),(B==="finished"||q)&&await I({...r,[x+"Score"]:A})};if(b){const O=x===o,Q=O?A:r[o+"Score"]||0,K=O?r[n+"Score"]||0:A;F.add(_),we(T,Q,K,O,R)}else await R()}function ae(w){return["MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function be(w){return["GK","DEF","MIL","ATT"].some(k=>(w[k]||[]).some(f=>!f.used))}function Le(w){return be(w)&&!ae(w)}function Ee(w){const k=r[w+"Team"],f=r[(w==="p1"?"p2":"p1")+"Team"];return!!(ae(k)||!be(f)&&Le(k))}function Te(w){const k=["MIL","ATT"].some($=>(w.p1Team[$]||[]).some(A=>!A.used)),f=["MIL","ATT"].some($=>(w.p2Team[$]||[]).some(A=>!A.used)),m=be(w.p1Team),x=be(w.p2Team);return!k&&!(!x&&m)&&(!f&&!(!m&&x))}function De(w){const k=w.p1Score||0,f=w.p2Score||0;return k===f?null:k>f?y.home_id:y.away_id}async function I(w){try{const k=De(w),f=k?y.home_id===k?y.away_id:y.home_id:null;await E.from("matches").update({status:"finished",winner_id:k,home_score:w.p1Score||0,away_score:w.p2Score||0}).eq("id",i),k&&f&&ki(k,f).catch(()=>{})}catch(k){console.error("[PvP] finishMatch:",k)}}function C(){var x;const w=r[o+"Score"],k=r[n+"Score"],f=w>k,m=w===k;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  </div>`,(M=document.getElementById("ml-create-btn"))==null||M.addEventListener("click",()=>er(e,t)),e.querySelectorAll(".ml-tab").forEach(L=>L.addEventListener("click",()=>_t(e,t,L.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(L=>L.addEventListener("click",()=>bt(e,t,L.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(L=>L.addEventListener("click",D=>{D.stopPropagation(),ko(e,t,L.dataset.join,L.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(L=>L.addEventListener("click",D=>{D.stopPropagation(),xi(e,t,L.dataset.delete,L.dataset.name,i)}))}function ei(e,t,i=!1){var a,l;const s=e.creator_id===t,c=e.pot||0,d=((l=(a=e.mini_league_members)==null?void 0:a[0])==null?void 0:l.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${v.map((H,G)=>{const re=z>0&&a.status==="finished"?G===0?Math.floor(z*.7):G===1?Math.floor(z*.2):G===2?Math.floor(z*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${H.userId===d?"background:#f0fdf4;":""}">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(_),(q=_.querySelector("#pvp-end-home"))==null||q.addEventListener("click",()=>{_.remove(),We(e),o?l("mini-league",{openLeagueId:o}):l("mini-league")})}const oe=E.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},f=>{const m=f.new;try{if(m.status==="finished"||m.forfeit){if(M||(M=!0,W&&(clearInterval(W),W=null),m.game_state&&(u=m.game_state),u.phase==="finished"&&!m.forfeit&&document.getElementById("pvp-home")))return;U(m);return}if(m.game_state){const x=u;u=m.game_state;const b=u._lastGC;if(b&&b.seq&&!j.has(b.seq)&&(j.add(b.seq),b.by!==n)){ze(b.type,b.by,()=>ye());return}const h=x[n+"Score"]||0,_=x[g+"Score"]||0,T=u[n+"Score"]||0,$=u[g+"Score"]||0,A=T>h,S=$>_;if((A||S)&&!P.has(u.round)){P.add(u.round);const q=[...u.log||[]].reverse().find(R=>R.isGoal),B=((q==null?void 0:q.homePlayers)||[]).map(R=>({name:R.name,note:R.note,portrait:R.portrait,job:R.job}));ve(B,T,$,A,()=>ye());return}ye()}}catch(x){console.error("[PvP] crash:",x)}}).subscribe();async function de(f){Object.assign(u,f),u.lastActionAt=new Date().toISOString();const{error:m}=await E.from("matches").update({game_state:u}).eq("id",i);m&&p("Erreur de synchronisation","error");try{ye()}catch(x){console.error("[PvP] renderPvpScreen crash:",x)}}async function N(){if(M)return;M=!0,W&&(clearInterval(W),W=null);const f=s?z.away_id:z.home_id,m=s?"p2":"p1",x=s?"p1":"p2",b={...u,[m+"Score"]:3,[x+"Score"]:0,phase:"finished"};try{await E.from("matches").update({status:"finished",forfeit:!0,winner_id:f,home_score:b.p1Score||0,away_score:b.p2Score||0,game_state:b}).eq("id",i)}catch{}try{E.removeChannel(oe)}catch{}setTimeout(()=>{We(e),l("mini-league")},800)}const Y={BOOST_STAT:({value:f=1,count:m=1,roles:x=[]},b,h)=>{const _=b[n+"Team"],T=Object.entries(_).filter(([$])=>!x.length||x.includes($)).flatMap(([$,A])=>A.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!T.length){b.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),h(b);return}H(T,m,`Choisir ${m} joueur(s) à booster (+${f})`,$=>{$.forEach(A=>{const S=(_[A._line]||[]).find(q=>q.cardId===A.cardId);S&&(S.boost=(S.boost||0)+f,b.log.push({text:`⚡ +${f} sur ${S.name}`,type:"info"}))}),b[n+"Team"]=_,h(b)})},DEBUFF_STAT:({value:f=1,count:m=1,roles:x=[],target:b="ai"},h,_)=>{const T=b==="home"?n:g,$=h[T+"Team"],A=b==="home"?"allié":"adverse",S=Object.entries($).filter(([q])=>!x.length||x.includes(q)).flatMap(([q,B])=>B.map(R=>({...R,_line:q})));if(!S.length){h.log.push({text:`🎯 Aucun joueur ${A}`,type:"info"}),_(h);return}H(S,m,`Choisir ${m} joueur(s) ${A}(s) (-${f})`,q=>{q.forEach(B=>{const R=($[B._line]||[]).find(O=>O.cardId===B.cardId);R&&(R.boost=(R.boost||0)-f,h.log.push({text:`🎯 -${f} sur ${R.name}`,type:"info"}))}),h[T+"Team"]=$,_(h)})},GRAY_PLAYER:({count:f=1,roles:m=[],target:x="ai"},b,h)=>{const _=x==="home"?n:g,T=b[_+"Team"],$=x==="home"?"allié":"adverse",A=Object.entries(T).filter(([S])=>!m.length||m.includes(S)).flatMap(([S,q])=>q.filter(B=>!B.used).map(B=>({...B,_line:S})));if(!A.length){b.log.push({text:`❌ Aucun joueur ${$}`,type:"info"}),h(b);return}H(A,f,`Choisir ${f} joueur(s) ${$}(s) à exclure`,S=>{const q="usedCardIds_"+_,B=new Set(b[q]||[]);S.forEach(R=>{const O=(T[R._line]||[]).find(Q=>Q.cardId===R.cardId);O&&(O.used=!0,B.add(R.cardId),b.log.push({text:`❌ ${O.name} exclu !`,type:"info"}))}),b[q]=[...B],b[_+"Team"]=T,h(b)})},REVIVE_PLAYER:({count:f=1,roles:m=[]},x,b)=>{const h=x[n+"Team"],_=Object.entries(h).filter(([T])=>!m.length||m.includes(T)).flatMap(([T,$])=>$.filter(A=>A.used).map(A=>({...A,_line:T})));if(!_.length){x.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),b(x);return}H(_,f,`Choisir ${f} joueur(s) à ressusciter`,T=>{T.forEach($=>{const A=(h[$._line]||[]).find(S=>S.cardId===$.cardId);A&&(A.used=!1,x.log.push({text:`💫 ${A.name} ressuscité !`,type:"info"}))}),x[n+"Team"]=h,b(x)})},REMOVE_GOAL:({},f,m)=>{const x=g+"Score";f[x]>0?(f[x]--,f.log.push({text:"🚫 Dernier but annulé !",type:"info"})):f.log.push({text:"🚫 Aucun but à annuler",type:"info"}),m(f)},ADD_GOAL_DRAW:({},f,m)=>{f[n+"Score"]===f[g+"Score"]?(f[n+"Score"]++,f.log.push({text:"🎯 But bonus !",type:"info"})):f.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),m(f)},ADD_SUB:({value:f=1},m,x)=>{m.maxSubs=(m.maxSubs||3)+f,m.log.push({text:`🔄 +${f} remplacement(s)`,type:"info"}),x(m)},CUSTOM:({},f,m)=>m(f)};function H(f,m,x,b){const h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let _=[];function T(){var A,S;const $=f.map(q=>{const B={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[q._line]||"#555",R=Me(q,q._line)+(q.boost||0),Q=_.find(ie=>ie.cardId===q.cardId)?"#FFD700":"rgba(255,255,255,0.25)",K=q.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${q.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Q};background:${B};overflow:hidden;cursor:pointer;${K}">
        ...
        </div>`,(A=h.querySelector("#pp-close"))==null||A.addEventListener("click",()=>h.remove()),h.querySelectorAll(".pp-item").forEach(q=>{q.addEventListener("click",()=>{const B=q.dataset.cid,R=f.find(Q=>Q.cardId===B),O=_.findIndex(Q=>Q.cardId===B);R&&(O>-1?_.splice(O,1):_.length<m&&_.push(R),T())})}),(S=h.querySelector("#pp-confirm"))==null||S.addEventListener("click",()=>{h.remove(),b(_)})}T(),document.body.appendChild(h)}async function G(f,m){const b=(u["gcCardsFull_"+n]||[]).find($=>$.id===f),h=(b==null?void 0:b._gcDef)||(u.gcDefs||[]).find($=>{var A;return $.name===m||((A=$.name)==null?void 0:A.toLowerCase().trim())===(m==null?void 0:m.toLowerCase().trim())}),_=[...u["usedGc_"+n]||[],f],T={type:m,by:n,seq:(u._gcAnimSeq||0)+1};j.add(T.seq),ze(m,n,async()=>{if(h!=null&&h.effect_type&&h.effect_type!=="CUSTOM"){const A=Y[h.effect_type];if(A){const S={...u};A(h.effect_params||{},S,async q=>{q["usedGc_"+n]=_,q._lastGC=T,q._gcAnimSeq=T.seq,await de(q)});return}}const $={...u};switch(m){case"Remplacement+":$.maxSubs=($.maxSubs||3)+1,$.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const A=g+"Score";$[A]>0&&($[A]--,$.log.push({text:"🚫 But annulé",type:"info"}));break}}$["usedGc_"+n]=_,$._lastGC=T,$._gcAnimSeq=T.seq,await de($)})}function re(f,m){const x="usedCardIds_"+f,b=new Set(u[x]||[]);m.forEach(h=>b.add(h)),u[x]=[...b]}function pe(){for(const f of["p1","p2"]){const m=new Set(u["usedCardIds_"+f]||[]),x=u[f+"Team"];if(x)for(const b of["GK","DEF","MIL","ATT"])(x[b]||[]).forEach(h=>{h.used=m.has(h.cardId)})}}function ye(){var nt,gt,le,ke,te,ue;if(u.phase==="reveal")return Se();if(u.phase==="midfield")return we();if(u.phase==="finished")return w();const f=u[n+"Team"],m=u[g+"Team"];pe();const x=u[n+"Score"],b=u[g+"Score"],h=u[n+"Name"],_=u[g+"Name"],T=u.phase===n+"-attack",$=u.phase===n+"-defense",A=Array.isArray(u["selected_"+n])?u["selected_"+n]:[],S=A.map(ee=>ee.cardId),q=window.innerWidth>=700,B=u[n+"Subs"]||[],R=u["usedSubIds_"+n]||[],O=B.filter(ee=>!R.includes(ee.cardId)),Q=u["gcCardsFull_"+n]||[],K=u["usedGc_"+n]||[],ie=Q.filter(ee=>!K.includes(ee.id)),se=u.boostOwner===n&&!u.boostUsed,fe=!["GK","DEF","MIL","ATT"].some(ee=>(m[ee]||[]).some(ce=>!ce.used)),me=[...f.MIL||[],...f.ATT||[]].filter(ee=>!ee.used),_e=T&&fe&&me.length===0?[...f.GK||[],...f.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function $e(ee,ce,qe){var Si,Li;const Ae=ee._gcDef,tt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[Ae==null?void 0:Ae.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",it={purple:"#b06ce0",light_blue:"#00d4ef"}[Ae==null?void 0:Ae.color]||"#b06ce0",rt=(Ae==null?void 0:Ae.name)||ee.gc_type,st=(Ae==null?void 0:Ae.effect)||((Si=Ve[ee.gc_type])==null?void 0:Si.desc)||"",ct=Ae!=null&&Ae.image_url?`/manager-wars/icons/${Ae.image_url}`:null,$t=((Li=Ve[ee.gc_type])==null?void 0:Li.icon)||"⚡",pt=Math.round(qe*.22),ht=Math.round(qe*.22),kt=qe-pt-ht,Ut=rt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
      ...
      </div>`}function Ce(ee,ce){return`<div id="pvp-boost-card"
      ...
      </div>`}const je=(ee,ce)=>ce?Ce(130,175):$e(ee,130,175),Re=(ee,ce)=>ce?Ce(68,95):$e(ee,68,95),Be=q?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Oe=T?Te(n)?`<button id="pvp-action" style="${Be};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${A.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Be};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:$?`<button id="pvp-action" style="${Be};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${A.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${_}</div>`,Fe=T&&!Te(n)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':T||$?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${A.length}/3 sélectionné(s)</div>`:"",Ke=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${q?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(f,u[n+"Formation"],Ne,S,300,300,_e)}
      </div>
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-end;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
              ${(ee.homePlayers||[]).map(qe=>dt(qe)).join("")}
            </div>
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
          ...
          ${ot((Ae.players||[]).map(tt=>({...tt,used:!1})),"#ff6b6b",Ae.total)}
        </div>`}if(T&&((qe=u.pendingAttack)!=null&&qe.players)){const Ae=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          ${ot((Ae.players||[]).map(tt=>({...tt,used:!1})),"#00ff88",Ae.total)}
      ...
      </div>`;function Qe(){const ee=e.querySelector(".match-screen");if(!ee)return;const ce=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ee.style.height=ce+"px",ee.style.minHeight=ce+"px",ee.style.maxHeight=ce+"px",ee.style.overflow="hidden";const qe=e.querySelector("#mobile-action-bar"),Ae=e.querySelector("#mobile-play-area");qe&&Ae&&(Ae.style.paddingBottom=qe.offsetHeight+"px")}if(Qe(),setTimeout(Qe,120),setTimeout(Qe,400),F||(F=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Qe),window.visualViewport.addEventListener("scroll",Qe)),window.addEventListener("resize",Qe)),function(){const ce=e.querySelector(".terrain-wrapper svg");ce&&(ce.removeAttribute("width"),ce.removeAttribute("height"),ce.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ce.setAttribute("viewBox","-26 -26 352 352"),ce.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(ee=>{ee.addEventListener("click",()=>{if(!T&&!$)return;const ce=ee.dataset.cardId,qe=ee.dataset.role,Ae=(f[qe]||[]).find(st=>st.cardId===ce);if(!Ae||Ae.used)return;const tt=_e.includes(ce);if(T&&!["MIL","ATT"].includes(qe)&&!tt)return;Array.isArray(u["selected_"+n])||(u["selected_"+n]=[]);const it=u["selected_"+n],rt=it.findIndex(st=>st.cardId===ce);rt>-1?it.splice(rt,1):it.length<3&&it.push({...Ae,_role:qe}),ye()})}),e.querySelectorAll(".match-used-hit").forEach(ee=>{ee.addEventListener("click",()=>X(ee.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ee=>{ee.addEventListener("click",()=>X())}),(nt=e.querySelector("#pvp-sub-open"))==null||nt.addEventListener("click",()=>X()),e.querySelectorAll(".pvp-gc-mini").forEach(ee=>{ee.addEventListener("click",()=>Ie(ee.dataset.gcId,ee.dataset.gcType))}),(gt=e.querySelector("#pvp-boost-card"))==null||gt.addEventListener("click",()=>xe()),(le=e.querySelector("#pvp-action"))==null||le.addEventListener("click",ee=>{T?ee.currentTarget.dataset.pass==="1"||!Te(n)?Z():V():$&&ae()}),(ke=e.querySelector("#pvp-quit"))==null||ke.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&N()}),(te=e.querySelector("#pvp-view-opp"))==null||te.addEventListener("click",()=>ge()),(ue=e.querySelector("#pvp-toggle-history"))==null||ue.addEventListener("click",()=>J()),W&&(clearInterval(W),W=null),(T||$)&&!M){let ee=30,ce=!1;const qe=()=>document.getElementById("pvp-timer"),Ae=()=>{qe()&&(qe().textContent=ee+"s",qe().style.color=ce?"#ff4444":"#fff")};Ae(),W=setInterval(()=>{ee--,ee<0?ce?(clearInterval(W),W=null,T&&!Te(n)?Z():N()):(ce=!0,ee=15,Ae()):Ae()},1e3)}}function Se(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
      ...
      <div style="width:min(90vw,420px)">${ut(u[g+"Team"],u[g+"Formation"],null,[],300,300)}</div>
    </div>`,n==="p1"&&setTimeout(async()=>{await de({phase:"midfield"})},5e3)}let he=!1;function we(){if(he)return;const f=u[n+"Team"].MIL||[],m=u[g+"Team"].MIL||[];function x(ie){return ie.reduce((se,fe)=>se+Me(fe,"MIL"),0)}function b(ie){let se=0;for(let fe=0;fe<ie.length-1;fe++){const me=at(ie[fe],ie[fe+1]);me==="#00ff88"?se+=2:me==="#FFD700"&&(se+=1)}return se}const h=x(f)+b(f),_=x(m)+b(m),T=h>=_;function $(ie,se,fe){return`<div id="duel-row-${fe}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${ie.map((me,_e)=>{const $e=_e<ie.length-1?at(me,ie[_e+1]):null,Ce=!$e||$e==="#ff3333"||$e==="#cc2222",je=$e==="#00ff88"?"+2":$e==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${fe}" data-idx="${_e}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
              ${Ye({...me,note:Me(me,"MIL"),_line:"MIL"},58,78)}
            </div>
            ${_e<ie.length-1?`<div class="duel-link duel-link-${fe}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${Ce?"rgba(255,255,255,0.12)":$e};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${Ce?"none":`0 0 8px ${$e}`}">
              ${je?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${$e}">${je}</span>`:""}
            </div>`:""}`}).join("")}
        </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const A=(ie,se)=>e.querySelectorAll(ie).forEach((fe,me)=>{setTimeout(()=>{fe.style.opacity="1",fe.style.transform="translateY(0) scale(1)"},se+me*90)});A(".duel-card-me",150),A(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((ie,se)=>setTimeout(()=>{ie.style.opacity="1"},se*70)),900),setTimeout(()=>{const ie=e.querySelector("#pvp-vs");ie&&(ie.style.opacity="1",ie.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(se=>se.style.opacity="1")},1250);function S(ie,se,fe){const me=document.getElementById(ie);if(!me)return;const _e=performance.now(),$e=Ce=>{const je=Math.min(1,(Ce-_e)/fe);me.textContent=Math.round(se*(1-Math.pow(1-je,3))),je<1?requestAnimationFrame($e):me.textContent=se};requestAnimationFrame($e)}setTimeout(()=>{S("pvp-score-me",h,800),S("pvp-score-opp",_,800)},1500);const q=u.p1Team.MIL||[],B=u.p2Team.MIL||[],R=x(q)+b(q),O=x(B)+b(B),Q=R>=O?"p1":"p2";let K=u.boostValue;K==null&&(K=oi(),u.boostValue=K,u.boostOwner=Q,u.boostUsed=!1),he=!0,setTimeout(()=>{const ie=e.querySelector("#duel-row-"+(T?"me":"opp")),se=e.querySelector("#duel-row-"+(T?"opp":"me")),fe=document.getElementById("pvp-score-me"),me=document.getElementById("pvp-score-opp"),_e=T?fe:me,$e=T?me:fe;_e&&(_e.style.fontSize="80px",_e.style.color=T?"#FFD700":"#ff6b6b",_e.style.animation="duelPulse .5s ease"+(T?",duelGlow 1.5s ease infinite .5s":"")),$e&&($e.style.opacity="0.25"),setTimeout(()=>{ie&&(ie.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ie.style.zIndex="5"),setTimeout(()=>{const Ce=document.getElementById("duel-shock");Ce&&(Ce.style.animation="shockwave .5s ease-out forwards"),se&&(se.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Be;const Ce=document.getElementById("pvp-duel-finale");if(!Ce)return;const je=u.boostOwner===n?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+K+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Re=n==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;Ce.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(T?"⚽ "+u[n+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+u[g+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+je+Re,Ce.style.transition="opacity .45s ease",Ce.style.opacity="1",Ce.style.pointerEvents="auto",(Be=document.getElementById("pvp-start-match"))==null||Be.addEventListener("click",async()=>{const Oe=Q;await de({phase:Oe+"-attack",attacker:Oe,round:1,boostValue:K,boostUsed:!1,boostOwner:Oe})})},600)},700)},2800)}function ve(f,m,x,b,h){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const T=Array.from({length:10},(q,B)=>`<div style="position:absolute;font-size:${16+Math.floor(Math.random()*24)}px;top:${5+Math.floor(Math.random()*65)}%;left:${3+Math.floor(Math.random()*94)}%;animation:fw${B%2===0?"A":"B"} ${.7+Math.random()*.7}s ease ${Math.random()*.9}s both;opacity:0">${["✨","🌟","⭐","💥","🎇","🎆","🔥","🌈"][B%8]}</div>`).join(""),$={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};_.innerHTML=`
      <style>
        @keyframes butPop{0%{transform:scale(0) rotate(-8deg);opacity:0}55%{transform:scale(1.25) rotate(2deg)}85%{transform:scale(0.92) rotate(-1deg)}100%{transform:scale(1);opacity:1}}
        @keyframes ballIn{0%{transform:translate(-70px,18px);opacity:0}65%{opacity:1}100%{transform:translate(26px,-8px);opacity:1}}
        @keyframes scoreIn{from{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:translateY(0)}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let A=!1;const S=()=>{A||(A=!0,_.remove(),setTimeout(()=>h(),50))};_.addEventListener("click",S),setTimeout(S,3500)}function ze(f,m,x){var K,ie;const b=(u.gcDefs||[]).find(se=>{var fe;return se.name===f||((fe=se.name)==null?void 0:fe.toLowerCase().trim())===(f==null?void 0:f.toLowerCase().trim())}),h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",T=(b==null?void 0:b.name)||f,$=(b==null?void 0:b.effect)||((K=Ve[f])==null?void 0:K.desc)||"",A=b!=null&&b.image_url?`/manager-wars/icons/${b.image_url}`:null,S=((ie=Ve[f])==null?void 0:ie.icon)||"⚡",B=m===n?"Vous":u[m+"Name"]||"Adversaire",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",R.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(R);let O=!1;const Q=()=>{O||(O=!0,R.remove(),setTimeout(()=>x&&x(),50))};R.addEventListener("click",Q),setTimeout(Q,3e3)}function Ie(f,m){var R,O,Q,K;const b=(u["gcCardsFull_"+n]||[]).find(ie=>ie.id===f),h=b==null?void 0:b._gcDef,_={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",T={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",$=(h==null?void 0:h.name)||m,A=(h==null?void 0:h.effect)||((R=Ve[m])==null?void 0:R.desc)||"Carte spéciale.",S=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,q=((O=Ve[m])==null?void 0:O.icon)||"⚡",B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",B.innerHTML=`
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${ie?Ye({...ie,used:!1,boost:0},se,fe):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${K?Ye({...K,used:!1,boost:0},se,fe):"<div>—</div>"}</div>
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,($e=B.querySelector("#psub-close"))==null||$e.addEventListener("click",()=>B.remove()),(Ce=B.querySelector("#pout-up"))==null||Ce.addEventListener("click",()=>{$>0&&($--,R())}),(je=B.querySelector("#pout-down"))==null||je.addEventListener("click",()=>{$<_.length-1&&($++,R())}),(Re=B.querySelector("#pin-up"))==null||Re.addEventListener("click",()=>{S>0&&(S--,R())}),(Be=B.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{S<T.length-1&&(S++,R())});const _e=(Fe,Ke,Ne,He)=>{const Ue=B.querySelector("#"+Fe);if(!Ue)return;let Je=0;Ue.addEventListener("touchstart",Ze=>{Je=Ze.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ze=>{const Qe=Ze.changedTouches[0].clientY-Je;if(Math.abs(Qe)<30)return;const nt=Ke();Qe<0&&nt<He-1?(Ne(nt+1),R()):Qe>0&&nt>0&&(Ne(nt-1),R())},{passive:!0})};_e("pin-panel",()=>S,Fe=>S=Fe,T.length),_e("pout-panel",()=>$,Fe=>$=Fe,_.length),(Oe=B.querySelector("#psub-confirm"))==null||Oe.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),q)return;q=!0;const Ke=_[$],Ne=T[S];if(!Ke||!Ne)return;const He=Ke._line,Ue=(x[He]||[]).findIndex(Qe=>Qe.cardId===Ke.cardId);if(Ue===-1){p("Erreur : joueur introuvable","error"),B.remove();return}const Je={...Ne,_line:He,position:Ke.position,used:!1,boost:0};x[He].splice(Ue,1,Je);const Ze=[...b,Ne.cardId];B.remove(),ne(Ke,Ne,async()=>{await de({[n+"Team"]:x,[g+"Team"]:u[g+"Team"],["usedSubIds_"+n]:Ze})})})}document.body.appendChild(B),R()}function ne(f,m,x){const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const _=(A,S,q)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${ut(u[g+"Team"],u[g+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(f),(m=f.querySelector("#pvp-opp-close"))==null||m.addEventListener("click",()=>f.remove())}function J(){var b;const f=u.log||[],m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const x=h=>{var T,$,A;if(h.type==="duel"){const S=h.isGoal,q=h.homeScored&&n==="p1"||!h.homeScored&&S&&n==="p2",B=h.homeScored?"#FFD700":S?"#ff6b6b":"rgba(255,255,255,0.3)",R=S?q?"⚽ BUT !":"⚽ BUT adversaire !":(T=h.homePlayers)!=null&&T.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${S?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${B};margin-bottom:4px">
      ...
      </div>`,document.body.appendChild(m),(b=m.querySelector("#pvp-hist-close"))==null||b.addEventListener("click",()=>m.remove())}async function Z(){if(u.phase!==n+"-attack")return;const f=n==="p1"?"p2":"p1",m=(u.round||0)+1,x=[...u.log||[]];x.push({type:"info",text:`⏭️ ${u[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const b=De(u),h=Te(f),_=b||!h?"finished":f+"-attack";await de({["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:_,attacker:f,round:m,log:x}),_==="finished"&&await C(u)}async function V(){const f=u[n+"Team"],m=!["GK","DEF","MIL","ATT"].some(_=>(u[g+"Team"][_]||[]).some(T=>!T.used)),x=(u["selected_"+n]||[]).map(_=>{const T=(f[_._role]||[]).find(R=>R.cardId===_.cardId)||_,$=m&&["GK","DEF"].includes(_._role),A=f[_._role]||[],S=A.findIndex(R=>R.cardId===_.cardId),q=lt(A.length),B=S>=0?q[S]:T._col??1;return{...T,_line:_._role,_col:B,...$?{note_a:Math.max(1,Number(T.note_a)||0)}:{}}});if(!x.length)return;const b=Nt(x,u.modifiers[n]||{});re(n,x.map(_=>_.cardId)),x.forEach(_=>{const T=(f[_._role]||[]).find($=>$.cardId===_.cardId);T&&(T.used=!0)}),u["selected_"+n]=[],ye();const h=[...u.log||[]];if(m){const _=(u[n+"Score"]||0)+1,T=x.map(B=>({name:B.name,note:Me(B,B._line||"ATT"),portrait:Pe(B),job:B.job}));h.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:T,homeTotal:b.total,aiTotal:0});const $=(u.round||0)+1,A=n==="p1"?"p2":"p1",S={...u,[n+"Team"]:f,[n+"Score"]:_},q=De(S);P.add($),ve(T,_,u[g+"Score"]||0,!0,async()=>{await de({[n+"Team"]:f,[n+"Score"]:_,["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:q?"finished":A+"-attack",attacker:A,round:$,log:h}),q&&await C({...u,[n+"Score"]:_})});return}h.push({type:"pending",text:`⚔️ ${u[n+"Name"]} attaque (${b.total})`}),await de({[n+"Team"]:f,[g+"Team"]:u[g+"Team"],pendingAttack:{...b,players:x,side:n},["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},phase:g+"-defense",log:h})}async function ae(){const f=u[n+"Team"],m=(u["selected_"+n]||[]).map(K=>{const ie=(f[K._role]||[]).find($e=>$e.cardId===K.cardId)||K,se=f[K._role]||[],fe=se.findIndex($e=>$e.cardId===K.cardId),me=lt(se.length),_e=fe>=0?me[fe]:ie._col??1;return{...ie,_line:K._role,_col:_e}}),x=Rt(m,u.modifiers[n]||{});re(n,m.map(K=>K.cardId)),m.forEach(K=>{const ie=(f[K._role]||[]).find(se=>se.cardId===K.cardId);ie&&(ie.used=!0)}),u["selected_"+n]=[],ye();const b=Ot(u.pendingAttack.total,x.total,u.modifiers[n]||{}),h=u.pendingAttack.side,_=b==="attack"||(b==null?void 0:b.goal),T=h==="p1"?"p2":"p1",$=(u.round||0)+1,A=(u.pendingAttack.players||[]).map(K=>({name:K.name,note:Me(K,K._line||"ATT"),portrait:Pe(K),job:K.job})),S=[...u.log||[]];S.push({type:"duel",isGoal:_,homeScored:_&&h===n,text:_?`⚽ BUT de ${u[h+"Name"]} ! (${u.pendingAttack.total} vs ${x.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${x.total})`,homePlayers:A,aiPlayers:m.map(K=>({name:K.name,note:Me(K,K._line||"DEF"),portrait:Pe(K),job:K.job})),homeTotal:u.pendingAttack.total,aiTotal:x.total});const q=_?(u[h+"Score"]||0)+1:u[h+"Score"]||0,B={...u,[n+"Team"]:f,[h+"Score"]:q},R=De(B),O=R?"finished":T+"-attack",Q=async()=>{await de({[n+"Team"]:f,[g+"Team"]:u[g+"Team"],[h+"Score"]:q,["selected_"+n]:[],modifiers:{...u.modifiers,[n]:{}},pendingAttack:null,phase:O,attacker:T,round:$,log:S}),(O==="finished"||R)&&await C({...u,[h+"Score"]:q})};if(_){const K=h===n,ie=K?q:u[n+"Score"]||0,se=K?u[g+"Score"]||0:q;P.add($),ve(A,ie,se,K,Q)}else await Q()}function be(f){return["MIL","ATT"].some(m=>(f[m]||[]).some(x=>!x.used))}function Le(f){return["GK","DEF","MIL","ATT"].some(m=>(f[m]||[]).some(x=>!x.used))}function Ee(f){return Le(f)&&!be(f)}function Te(f){const m=u[f+"Team"],x=u[(f==="p1"?"p2":"p1")+"Team"];return!!(be(m)||!Le(x)&&Ee(m))}function De(f){const m=["MIL","ATT"].some(S=>(f.p1Team[S]||[]).some(q=>!q.used)),x=["MIL","ATT"].some(S=>(f.p2Team[S]||[]).some(q=>!q.used)),b=Le(f.p1Team),h=Le(f.p2Team);return!m&&!(!h&&b)&&(!x&&!(!b&&h))}function I(f){const m=f.p1Score||0,x=f.p2Score||0;return m===x?null:m>x?z.home_id:z.away_id}async function C(f){try{const m=I(f),x=m?z.home_id===m?z.away_id:z.home_id:null,b=f.p1Score||0,h=f.p2Score||0;await E.from("matches").update({status:"finished",winner_id:m,home_score:b,away_score:h}).eq("id",i);const{data:_}=await E.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(_){await E.from("mini_league_matches").update({home_score:b,away_score:h,status:"finished"}).eq("id",_.id);const{data:T}=await E.from("mini_league_matches").select("id, status").eq("league_id",_.league_id).eq("matchday",_.matchday);if((T||[]).every(A=>A.status==="finished"||A.status==="bye")){const{data:A}=await E.from("mini_leagues").select("current_day,total_days").eq("id",_.league_id).single();if(A){const S=(A.current_day||0)+1,q=S>(A.total_days||0);await E.from("mini_leagues").update({current_day:q?A.total_days:S,status:q?"finished":"active"}).eq("id",_.league_id)}}}m&&x&&ki(m,x).catch(()=>{})}catch(m){console.error("[ML] finishMatch:",m)}}function w(){var h;if(M&&document.getElementById("pvp-end-overlay"))return;M=!0;const f=u[n+"Score"],m=u[g+"Score"],x=f>m,b=f===m;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(h=document.getElementById("pvp-home"))==null||h.addEventListener("click",()=>{try{E.removeChannel(oe)}catch{}We(e),l("mini-league",o?{openLeagueId:o}:{})})}ye()}const cr="/manager-wars/",pr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let p="buy";const o=()=>{var r,u,M,L,D,W,F;return{name:(((r=document.getElementById("flt-name"))==null?void 0:r.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((M=document.getElementById("flt-country"))==null?void 0:M.value)||"").toLowerCase().trim(),job:((L=document.getElementById("flt-job"))==null?void 0:L.value)||"",rarity:((D=document.getElementById("flt-rarity"))==null?void 0:D.value)||"",note1:parseInt((W=document.getElementById("flt-note1"))==null?void 0:W.value)||0,note2:parseInt((F=document.getElementById("flt-note2"))==null?void 0:F.value)||0}};function n(r){const u=o();return r.filter(M=>{var U,oe;const L=(U=M.card)==null?void 0:U.player;if(!L)return!1;const D=`${L.firstname} ${L.surname_encoded}`.toLowerCase(),W=(((oe=L.clubs)==null?void 0:oe.encoded_name)||"").toLowerCase(),F=(L.country_code||"").toLowerCase(),P=Et(L,L.job),j=L.job2?Et(L,L.job2):0;return!(u.name&&!D.includes(u.name)||u.club&&!W.includes(u.club)||u.country&&!F.includes(u.country)||u.job&&L.job!==u.job||u.rarity&&L.rarity!==u.rarity||u.note1&&P<u.note1||u.note2&&j<u.note2)})}function g(r){var F,P,j,U;const u=(F=r.card)==null?void 0:F.player;if(!u)return"";const M=((P=r.card)==null?void 0:P.evolution_bonus)||0,L=Et(u,u.job,M),D=u.job2?Et(u,u.job2,M):0,W=(i.profile.credits||0)>=r.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ui(u.rarity)}
      ${Wt(L,u.job)}
      ${Wt(D,u.job2||null)}
      ${Ki(u.country_code)}
    ...
    </div>`}function v(r){var F,P,j,U;const u=(F=r.card)==null?void 0:F.player;if(!u)return"";const M=((P=r.card)==null?void 0:P.evolution_bonus)||0,L=Et(u,u.job,M),D=u.job2?Et(u,u.job2,M):0,W=r.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${W?"opacity:0.7":""}">
      ${Ui(u.rarity)}
      ${Wt(L,u.job)}
      ${Wt(D,u.job2||null)}
      ${Ki(u.country_code)}
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="font-size:10px;color:${W?"#22c55e":"#999"};margin-top:1px">
          ${W?`✅ Vendu à ${((U=r.buyer)==null?void 0:U.pseudo)||"—"} · ${r.sold_at?new Date(r.sold_at).toLocaleDateString("fr"):""}`:`🟢 En vente depuis le ${new Date(r.listed_at).toLocaleDateString("fr")}`}
        </div>
      </div>
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:14px;font-weight:900;color:#D4A017">${r.price.toLocaleString("fr")}</div>
  ...
  `}async function vr(e,{state:t,navigate:i,toast:s}){const c=t.profile;if(!c)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await E.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      ...
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${c.id},away_id.eq.${c.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},l=(d||[]).filter(n=>n.status==="finished"),p=(d||[]).filter(n=>n.status==="in_progress");function o(n){const g=n.home_id===c.id;g?n.home_score:n.away_score,g?n.away_score:n.home_score;const v=n.winner_id===c.id,y=n.home_score===n.away_score&&n.status==="finished",z=n.status!=="finished"?"…":y?"N":v?"V":"D",r=n.status!=="finished"||y?"#888":v?"#1A6B3C":"#c0392b";let u=a[n.mode]||n.mode;n.away_id===null&&!u.startsWith("IA")&&(u="IA");const L=n.home_id===c.id?n.away:n.home;let D;n.away_id===null?D=u:L?D=`${L.club_name||L.pseudo} (${L.pseudo})`:D="Adversaire";let W="";n.status==="in_progress"&&Date.now()-new Date(n.created_at).getTime()>3600*1e3&&(W=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const F=new Date(n.created_at),P=F.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+F.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),j=n.status==="finished"?`${n.home_score} - ${n.away_score}`:`${n.home_score||0} - ${n.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
