import{s as k,F as it,b as Ce,c as qt,l as ge,d as di}from"./formation-links-Bt44rMnM.js";function kt(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function xi(e,t){const{state:i,navigate:a,toast:c,openModal:n,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await k.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),o=(d||[]).filter($=>$.card_type==="player"&&$.player),r=(d||[]).filter($=>$.card_type==="game_changer"),u=(d||[]).filter($=>$.card_type==="formation"),{data:g}=await k.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(g||[]).forEach($=>{f[$.name]=$});const L=Object.keys(it),p=Object.keys(de),h={};o.forEach($=>{const b=$.player.id;h[b]=(h[b]||0)+1}),new Set(Object.keys(h).map($=>String($)));const A=new Set(u.map($=>$.formation)),v=new Set(r.map($=>$.gc_type));let y="player",x="Tous",w="",E=!1;function m(){return[...o].sort(($,b)=>{const j=Be.indexOf($.player.job),I=Be.indexOf(b.player.job);return j!==I?j-I:($.player.surname_encoded||"").localeCompare(b.player.surname_encoded||"")})}function T(){return[...l||[]].sort(($,b)=>{const j=Be.indexOf($.job),I=Be.indexOf(b.job);return j!==I?j-I:($.surname_encoded||"").localeCompare(b.surname_encoded||"")})}function G(){return m().filter($=>{const b=$.player,j=x==="Tous"||b.job===x,I=!w||`${b.firstname} ${b.surname_encoded}`.toLowerCase().includes(w);return j&&I})}function q(){return T().filter($=>{const b=x==="Tous"||$.job===x,j=!w||`${$.firstname} ${$.surname_encoded}`.toLowerCase().includes(w);return b&&j})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Ee=1e3;function hi(e,t,i,a){var p,h,A;const{state:c,toast:n,closeModal:s,navigate:d,refreshProfile:l}=i,o=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const v=Ce[o]||{},y=it[o]||[],x=290,w=360,E=20;function m(G){const q=v[G];return q?{x:q.x*x,y:q.y*w}:null}let T=`<svg width="${x}" height="${w}" viewBox="0 0 ${x} ${w}" xmlns="http://www.w3.org/2000/svg">`;for(const[G,q]of y){const N=m(G),O=m(q);!N||!O||(T+=`<line x1="${N.x}" y1="${N.y}" x2="${O.x}" y2="${O.y}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(p=document.getElementById("direct-sell-form-btn"))==null||p.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${o} pour ${Ee.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const v=g.find(x=>!x.is_for_sale)||g[0];if(!v){n("Aucune carte à vendre","error");return}const{error:y}=await k.from("cards").delete().eq("id",v.id);if(y){n(y.message,"error");return}await k.from("users").update({credits:(c.profile.credits||0)+Ee}).eq("id",c.profile.id),await l(),n(`+${Ee.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),d("collection")}),(h=document.getElementById("market-sell-form-btn"))==null||h.addEventListener("click",async()=>{const v=parseInt(document.getElementById("sell-price-form").value);if(!v||v<1){n("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:v}).eq("id",e.id),await k.from("market_listings").insert({seller_id:c.profile.id,card_id:e.id,price:v}),n("Carte mise en vente sur le marché !","success"),s(),d("collection")}),(A=document.getElementById("cancel-sell-form-btn"))==null||A.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),n("Annonce retirée","success"),s(),d("collection")})}async function Lt(e,t,i,a){var T,G,q,N,O,Y;const{state:c,toast:n,openModal:s,closeModal:d,navigate:l,refreshProfile:o}=a,r=e.player,u=t.filter(H=>H.player.id===r.id),g=u.length,f=mi[r.rarity]||1e3,L=r.rarity!=="legende",p=Pt(),h=Te(r,r.job),A=r.job2?Te(r,r.job2):null,v=Ne[r.job]||"#1A6B3C",y=r.job2?Ne[r.job2]:null,x=Nt[r.rarity]||"#ccc",w=at[r.country_code]||r.country_code||"",{data:E}=await k.from("transfer_history").select("club_name, manager_name, source, price, transferred_at").eq("player_id",r.id).order("transferred_at",{ascending:!0}),m=E&&E.length?`
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const Pi="simulation",Vt="VOTRE_ZONE_ID";function Oi(){switch(Pi){case"propellerads":return Hi();case"adsense":return Ui();default:return st()}}function st(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(L=>{L.addEventListener("click",()=>{const p=L.dataset.id,h=n.find(v=>v.id===p);if(!h)return;const A=s.findIndex(v=>v.gc_type===h.gc_type);A>-1?s.splice(A,1):s.length<3&&s.push(h),o()})}),(u=e.querySelector("#gc-launch"))==null||u.addEventListener("click",()=>{r&&l(s)}),(g=e.querySelector("#gc-no-gc"))==null||g.addEventListener("click",()=>l([])),(f=e.querySelector("#gc-reset"))==null||f.addEventListener("click",()=>{s.length&&(s=[],o())})}o()}async function Ki(e,t,i){const{state:a,navigate:c}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await k.from("decks").select("id,name,is_active,formation").eq("owner_id",a.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){fe(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>c("decks"));return}const s=n.map(r=>r.id),{data:d}=await k.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let l=0;function o(){var v,y,x,w,E;const r=n[l],u=(d||[]).filter(m=>m.deck_id===r.id),g=u.filter(m=>{var T;return m.is_starter&&((T=m.card)==null?void 0:T.player)}).map(m=>Je(m.card,m.position)),f=u.find(m=>{var T;return((T=m.card)==null?void 0:T.card_type)==="formation"}),L=r.formation||((v=f==null?void 0:f.card)==null?void 0:v.formation)||"4-4-2",p=g.length>=11?He(g,L):null,h=g.length>=11;Wt(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
  ...
  </div>`}async function Qt(e,t,i,a){var w;const{state:c,navigate:n,toast:s}=t;Wt(e);const d=c.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!d.deckId)return Ki(e,t,i);const l=d.deckId;let o,r,u,g;try{const E=await Promise.all([k.from("decks").select("formation,name").eq("id",l).single(),k.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]);o=E[0].data,u=E[0].error,r=E[1].data,g=E[1].error}catch(E){console.error("[Match] Exception chargement deck:",E),fe(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(u||g){console.error("[Match] Erreur Supabase:",u||g),fe(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const f=(r||[]).filter(E=>{var m;return E.is_starter&&((m=E.card)==null?void 0:m.player)}).map(E=>Je(E.card,E.position)),L=(r||[]).filter(E=>{var m;return!E.is_starter&&((m=E.card)==null?void 0:m.player)}).map(E=>Je(E.card,E.position));if(f.length<11){fe(e,"⚠️",`Deck incomplet (${f.length}/11).`,"Compléter",()=>n("decks"));return}const p=(r||[]).find(E=>{var m;return((m=E.card)==null?void 0:m.card_type)==="formation"}),h=(o==null?void 0:o.formation)||((w=p==null?void 0:p.card)==null?void 0:w.formation)||"4-4-2",{data:A,error:v}=await k.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",c.profile.id).eq("card_type","game_changer"),{data:y}=await k.from("gc_definitions").select("*").eq("is_active",!0),x=(A||[]).map(E=>({...E,_gcDef:(y==null?void 0:y.find(m=>m.name===E.gc_type||m.id===E.gc_definition_id))||null}));a({deckId:l,formation:h,starters:f,subsRaw:L,gcCardsEnriched:x,gcDefs:y||[]})}async function Vi(e,t){const{state:i}=t,c=(i.params||{}).matchMode||"vs_ai_easy",n=c.replace("vs_ai_",""),s=c;await Qt(e,t,c,async({deckId:d,formation:l,starters:o,subsRaw:r,gcCardsEnriched:u,gcDefs:g})=>{try{const f=He(o,l),L=await Yi(l,n),p=async h=>{try{const{data:A,error:v}=await k.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:d,status:"in_progress"}).select().single();if(v){console.error("[MatchIA] Erreur création match:",v),fe(e,"⚠️","Impossible de créer le match ("+v.message+").","Retour",()=>t.navigate("home"));return}const y={gcDefs:g||[],matchId:A==null?void 0:A.id,mode:s,difficulty:n,formation:l,homeTeam:f,aiTeam:L,homeSubs:r,subsUsed:0,maxSubs:Math.min(r.length,3),homeScore:0,aiScore:0,gcCards:h,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Xi(e,y,t)}catch(A){console.error("[MatchIA] Exception launchMatch:",A),fe(e,"⚠️","Erreur au lancement du match : "+A.message,"Retour",()=>t.navigate("home"))}};if(!u.length){p([]);return}Xt(e,u,p)}catch(f){console.error("[MatchIA] Exception setup:",f),fe(e,"⚠️","Erreur de préparation du match : "+f.message,"Retour",()=>t.navigate("home"))}})}async function Yi(e,t){var s,d;const{data:i}=await k.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(60);if(!i||i.length<11)return Wi(e);const a=$e[e]||$e["4-4-2"],c={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const l of["GK","DEF","MIL","ATT"]){const o=n.filter(L=>L.job===l),r=n.filter(L=>L.job!==l),u=[...o,...r],g=[];for(let L=0;L<a[l];L++){const p=u[L]||n[L];p&&g.push({cardId:"ai-"+p.id+"-"+L,id:p.id,firstname:p.firstname,name:p.surname_encoded,country_code:p.country_code,club_id:p.club_id,job:p.job,job2:p.job2,note_g:Number(p.note_g)||0,note_d:Number(p.note_d)||0,note_m:Number(p.note_m)||0,note_a:Number(p.note_a)||0,rarity:p.rarity,skin:p.skin,hair:p.hair,hair_length:p.hair_length,clubName:((s=p.clubs)==null?void 0:s.encoded_name)||null,clubLogo:((d=p.clubs)==null?void 0:d.logo_url)||null,boost:0,used:!1,_line:l})}const f=Oe(g.length);g.forEach((L,p)=>{L._col=f[p]}),c[l]=g}return c}function Wi(e){const t=$e[e]||$e["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},a=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let c=0;for(const n of["GK","DEF","MIL","ATT"]){const s=[];for(let l=0;l<t[n];l++){const o=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+c,id:"fake-"+c,firstname:"IA",name:a[c%a.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?o:2,note_d:n==="DEF"?o:2,note_m:n==="MIL"?o:2,note_a:n==="ATT"?o:2,rarity:"normal",boost:0,used:!1,_line:n}),c++}const d=Oe(s.length);s.forEach((l,o)=>{l._col=d[o]}),i[n]=s}return i}function Xi(e,t,i){e.innerHTML=`
  ...
  </div>`,setTimeout(()=>Ji(e,t,i),5e3)}function Ji(e,t,i){const a=t.homeTeam.MIL||[],c=t.aiTeam.MIL||[];function n(p){return p.reduce((h,A)=>h+ie(A,"MIL"),0)}function s(p){let h=0;for(let A=0;A<p.length-1;A++){const v=ge(p[A],p[A+1]);v==="#00ff88"?h+=2:v==="#FFD700"&&(h+=1)}return h}const d=n(a)+s(a),l=n(c)+s(c),o=d>=l;function r(p,h,A,v){return`<div id="duel-row-${v}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,w.style.transition="opacity .45s ease",w.style.opacity="1",w.style.pointerEvents="auto",(E=document.getElementById("start-match-btn"))==null||E.addEventListener("click",L))},600)},700)},2800)}function Zi(e){if(e.type==="duel"){const t=e.homeTotal>=e.aiTotal;return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const T=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${Ae((T.players||[]).map(G=>({...G,used:!1})),"#ff6b6b",T.total)}
            ...
            ${Ae((T.players||[]).map(G=>({...G,used:!1})),"#00ff88",T.total)}
    ...
    ${(()=>{const m=window.innerWidth>=700,T=(z,B,P)=>{var V,X;const S=(t.gcDefs||[]).find(te=>te.name===z.gc_type),$={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[S==null?void 0:S.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[S==null?void 0:S.color]||"#b06ce0",j=(S==null?void 0:S.name)||z.gc_type,I=(S==null?void 0:S.effect)||((V=de[z.gc_type])==null?void 0:V.desc)||"",_=S!=null&&S.image_url?`/manager-wars/icons/${S.image_url}`:null,D=((X=de[z.gc_type])==null?void 0:X.icon)||"⚡",M=Math.round(P*.22),R=Math.round(P*.22),F=P-M-R,K=j.length>12?7:9;return`<div class="gc-mini" data-gc-id="${z.id}" data-gc-type="${z.gc_type}"
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(m=>{var T,G,q;if(m.type==="duel"){const N=m.isGoal,O=m.homeScored?"#FFD700":N?"#ff6b6b":"rgba(255,255,255,0.3)",Y=m.homeScored?"⚽ BUT !":N?"⚽ BUT IA !":(T=m.homePlayers)!=null&&T.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${N?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${O};margin-bottom:4px">
                ...
                ${(G=m.homePlayers)!=null&&G.length?`<div style="margin-bottom:3px">${Ae(m.homePlayers,"rgba(255,255,255,0.7)",m.homeTotal)}</div>`:""}
                ${(q=m.aiPlayers)!=null&&q.length?`<div style="opacity:0.7">${Ae(m.aiPlayers,"#ff6b6b",m.aiTotal)}</div>`:""}
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(n);let d=!1;const l=()=>{d||(d=!0,n.remove(),setTimeout(()=>c(),50))};n.addEventListener("click",l),setTimeout(l,3500)}async function we(e,t,i){var r,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=i,c=t.homeScore>t.aiScore,n=t.homeScore===t.aiScore,s=c?"victoire":n?"nul":"defaite",d=fi(t.mode,s);t.matchId&&await k.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(a.profile.credits||0)+d,matches_played:(a.profile.matches_played||0)+1};c?l.wins=(a.profile.wins||0)+1:n?l.draws=(a.profile.draws||0)+1:l.losses=(a.profile.losses||0)+1,await k.from("users").update(l).eq("id",a.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const f=()=>document.getElementById("mm-status"),L=async(y=!0)=>{u=!0,g&&(k.removeChannel(g),g=null),y&&await k.rpc("cancel_matchmaking",{p_user_id:l.profile.id}).catch(()=>{})};(v=document.getElementById("mm-cancel"))==null||v.addEventListener("click",async()=>{try{await L(!0)}catch(y){console.warn("[Matchmaking] cleanup error:",y)}le(e),o("home")});const p=async(y,x,w)=>{u||(u=!0,g&&(k.removeChannel(g),g=null),f()&&(f().textContent="Adversaire trouvé !"),await new Promise(E=>setTimeout(E,600)),e.isConnected!==!1&&po(e,t,y,w,s,d))},{data:h,error:A}=await k.rpc("try_matchmake",{p_user_id:l.profile.id,p_deck_id:i});if(A||!(h!=null&&h.success)){r("Erreur de matchmaking","error"),le(e),o("home");return}if(h.matched){p(h.match_id,h.opponent_id,!1);return}f()&&(f().textContent="En attente d'un autre joueur..."),g=k.channel("matchmaking-"+l.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${l.profile.id}`},y=>{const x=y.new;x.status==="matched"&&x.match_id&&p(x.match_id,x.matched_with,!0)}).subscribe()}async function po(e,t,i,a,c=[],n=[]){const{state:s,navigate:d,toast:l}=t,o=a?"p1":"p2",r=a?"p2":"p1",u=(c||[]).map(C=>C.id),g=(c||[]).map(C=>({id:C.id,gc_type:C.gc_type,_gcDef:C._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation du match...</div>';const{data:f}=await k.from("matches").select("*").eq("id",i).single();if(!f){l("Match introuvable","error"),d("home");return}async function L(){const[{data:C,error:z},{data:B,error:P},{data:S},{data:$}]=await Promise.all([k.rpc("get_deck_for_match",{p_deck_id:f.home_deck_id}),k.rpc("get_deck_for_match",{p_deck_id:f.away_deck_id}),k.from("users").select("id,pseudo,club_name").eq("id",f.home_id).single(),k.from("users").select("id,pseudo,club_name").eq("id",f.away_id).single()]);z&&console.error("[PvP] get_deck_for_match p1 error:",z),P&&console.error("[PvP] get_deck_for_match p2 error:",P);function b(F,K){return{cardId:F.card_id,position:K||F.position,id:F.id,firstname:F.firstname,name:F.surname_encoded,country_code:F.country_code,club_id:F.club_id,job:F.job,job2:F.job2,note_g:Number(F.note_g)||0,note_d:Number(F.note_d)||0,note_m:Number(F.note_m)||0,note_a:Number(F.note_a)||0,rarity:F.rarity,skin:F.skin,hair:F.hair,hair_length:F.hair_length,clubName:F.club_encoded_name||null,clubLogo:F.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}}const j=((C==null?void 0:C.starters)||[]).map(F=>b(F,F.position)),I=((B==null?void 0:B.starters)||[]).map(F=>b(F,F.position)),_=((C==null?void 0:C.subs)||[]).map(F=>b(F,F.position)),D=((B==null?void 0:B.subs)||[]).map(F=>b(F,F.position)),M=(C==null?void 0:C.formation)||"4-4-2",R=(B==null?void 0:B.formation)||"4-4-2";return console.log("[PvP] p1Formation:",M,"p1 starters:",j.length,"positions:",j.map(F=>F.position)),console.log("[PvP] p2Formation:",R,"p2 starters:",I.length,"positions:",I.map(F=>F.position)),{p1Team:He(j,M),p2Team:He(I,R),p1Subs:_,p2Subs:D,p1Formation:M,p2Formation:R,p1Name:(S==null?void 0:S.club_name)||(S==null?void 0:S.pseudo)||"Joueur 1",p2Name:($==null?void 0:$.club_name)||($==null?void 0:$.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?u:[],gc_p2:a?[]:u,gcCardsFull_p1:a?g:[],gcCardsFull_p2:a?[]:g,gcReady_p1:!0,gcReady_p2:!0,usedGc_p1:[],usedGc_p2:[],lastActionAt:new Date().toISOString()}}let p=f.game_state&&Object.keys(f.game_state).length?f.game_state:null;if(!p)if(a){p=await L();const{data:C}=await k.from("matches").select("game_state").eq("id",i).single();!(C!=null&&C.game_state)||!Object.keys(C.game_state).length?await k.from("matches").update({game_state:p,turn_user_id:f.home_id}).eq("id",i):p=C.game_state}else{e.innerHTML=`<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation avec l'adversaire...</div>`;for(let C=0;C<30&&!p;C++){await new Promise(B=>setTimeout(B,400));const{data:z}=await k.from("matches").select("game_state").eq("id",i).single();z!=null&&z.game_state&&Object.keys(z.game_state).length&&(p=z.game_state)}if(!p){l("Erreur de synchronisation","error"),d("home");return}p.gc_p2=u,p.gcCardsFull_p2=g,await k.from("matches").update({game_state:p}).eq("id",i)}let h=!1;function A(C){var j;try{k.removeChannel(v)}catch{}const z=s.profile.id,B=C.winner_id===z,P=!!C.forfeit,S=p[o+"Score"]??0,$=p[r+"Score"]??0,b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center",b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(j=b.querySelector("#pvp-end-home"))==null||j.addEventListener("click",()=>{b.remove(),le(e),d("home")})}const v=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},C=>{const z=C.new;try{if(z.status==="finished"||z.forfeit){if(h)return;h=!0,p._timerInt&&(clearInterval(p._timerInt),p._timerInt=null),z.game_state&&(p=z.game_state),A(z);return}z.game_state&&(p=z.game_state,w())}catch(B){console.error("[PvP] Realtime render crash:",B,"gameState:",p)}}).subscribe();async function y(C){Object.assign(p,C),p.lastActionAt=new Date().toISOString();const{error:z}=await k.from("matches").update({game_state:p}).eq("id",i);z&&(console.error("[PvP] pushState DB error:",z.message,z),l("Erreur de synchronisation : "+z.message,"error"));try{w()}catch(B){console.error("[PvP] renderPvpScreen crash après pushState:",B),l("Erreur d'affichage : "+B.message,"error")}}async function x(){if(h)return;h=!0,p._timerInt&&(clearInterval(p._timerInt),p._timerInt=null);const C=a?f.away_id:f.home_id;try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:C}).eq("id",i)}catch(z){console.warn("[PvP] forfeit DB error:",z)}try{k.removeChannel(v)}catch{}le(e),d("home")}function w(){var gt,mt,xt,yt,ht;const C=p[o+"Team"];p[r+"Team"];const z=p[o+"Score"],B=p[r+"Score"],P=p[o+"Name"],S=p[r+"Name"];if(p.phase==="gc-select")return E();if(p.phase==="reveal")return m();if(p.phase==="midfield")return T();if(p.phase==="finished")return Y();const $=p.phase===o+"-attack",b=p.phase===o+"-defense",j=p.phase===r+"-attack"||p.phase===r+"-defense",I=Array.isArray(p["selected_"+o])?p["selected_"+o]:[],_=I.map(U=>U.cardId);e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const D=window.innerWidth>=700,M=p[o+"Subs"]||[],R=p["usedSubIds_"+o]||[],F=M.filter(U=>!R.includes(U.cardId)),K=p["gcCardsFull_"+o]||[],V=p["usedGc_"+o]||[],X=K.filter(U=>!V.includes(U.id)),te=p.boostOwner===o&&!p.boostUsed,re=(U,J,ee)=>{var _t,$t;const W=U._gcDef,ce={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[W==null?void 0:W.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",je={purple:"#b06ce0",light_blue:"#00d4ef"}[W==null?void 0:W.color]||"#b06ce0",ye=(W==null?void 0:W.name)||U.gc_type,ri=(W==null?void 0:W.effect)||((_t=de[U.gc_type])==null?void 0:_t.desc)||"",vt=W!=null&&W.image_url?`/manager-wars/icons/${W.image_url}`:null,ai=(($t=de[U.gc_type])==null?void 0:$t.icon)||"⚡",bt=Math.round(ee*.22),wt=Math.round(ee*.22),Ye=ee-bt-wt,si=ye.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${U.id}" data-gc-type="${U.gc_type}"
        ...
        <div style="height:${Ye}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${vt?`<img src="${vt}" style="max-width:${J-10}px;max-height:${Ye-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Ye*.55)}px">${ai}</span>`}
        </div>
      ...
      <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
        ${Me(C,p[o+"Formation"],$?"attack":b?"defense":"idle",_,300,300)}
          ...
          ${Ae(U.players.map(ce=>({...ce,used:!1})),"#ff6b6b",U.total)}
      ...
      </div>`;const U=e.querySelector(".terrain-wrapper");U&&(U.innerHTML=Me(C,p[o+"Formation"],$?"attack":b?"defense":"idle",_,300,300))}if(e.querySelectorAll(".match-slot-hit").forEach(U=>{U.addEventListener("click",()=>{if(!$&&!b)return;const J=U.dataset.cardId,ee=U.dataset.role,W=(C[ee]||[]).find(ye=>ye.cardId===J);if(!W||W.used)return;Array.isArray(p["selected_"+o])||(p["selected_"+o]=[]);const ce=p["selected_"+o],je=ce.findIndex(ye=>ye.cardId===J);je>-1?ce.splice(je,1):ce.length<3&&ce.push({...W,_role:ee}),w()})}),(gt=e.querySelector("#pvp-boost-card"))==null||gt.addEventListener("click",()=>{G()}),e.querySelectorAll(".pvp-gc-mini").forEach(U=>{U.addEventListener("click",()=>{O(U.dataset.gcId,U.dataset.gcType)})}),(mt=e.querySelector("#pvp-action"))==null||mt.addEventListener("click",()=>{$?H():b&&Q()}),(xt=e.querySelector("#pvp-quit"))==null||xt.addEventListener("click",()=>{confirm("Quitter le match ? Vous perdrez par forfait.")&&x()}),(yt=e.querySelector("#pvp-view-opp"))==null||yt.addEventListener("click",()=>{N()}),(ht=e.querySelector("#pvp-toggle-history"))==null||ht.addEventListener("click",()=>{q()}),function(){const J=e.querySelector(".terrain-wrapper svg");J&&(J.removeAttribute("width"),J.removeAttribute("height"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",J.setAttribute("viewBox","-26 -26 352 352"),J.setAttribute("preserveAspectRatio","xMidYMid meet"));const ee=e.querySelector(".match-screen");if(ee){const W=e.clientHeight;W>50&&(ee.style.height=W+"px",ee.style.maxHeight=W+"px",ee.style.overflow="hidden")}}(),p._timerInt&&(clearInterval(p._timerInt),p._timerInt=null),($||b)&&!h){let U=30,J=!1;const ee=()=>document.getElementById("pvp-timer"),W=()=>{ee()&&(ee().textContent=U+"s",ee().style.color=J?"#ff4444":"#fff")};W(),p._timerInt=setInterval(()=>{U--,U<0?J?(clearInterval(p._timerInt),p._timerInt=null,x()):(J=!0,U=15,W()):W()},1e3)}}function E(){var b;const C=p["gcReady_"+o],z=p["gcReady_"+r];Array.isArray(p["gc_"+o])||(p["gc_"+o]=[]);let B=p["gc_"+o];const P=3;function S(j,I){const _=j._gcDef,D={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},M={purple:"#9b59b6",light_blue:"#00bcd4"},R=D[_==null?void 0:_.color]||D.purple,F=M[_==null?void 0:_.color]||M.purple;return`<div class="pvp-gc-card" data-id="${j.id}"
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      ...
      <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${I.map((M,R)=>{const F=ne(M),K=R<I.length-1?ge(M,I[R+1]):null,V=K&&K!=="#ff3333"&&K!=="#cc2222";return`
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    </div>`,setTimeout(()=>{const I=document.getElementById("pvp-score-me"),_=document.getElementById("pvp-score-opp"),D=document.getElementById("pvp-midfield-result");I&&_&&(b?(I.style.fontSize="80px",I.style.color="#FFD700",_.style.opacity="0.25"):(_.style.fontSize="80px",_.style.color="#ff6b6b",I.style.opacity="0.25"));const M=p.p1Team.MIL||[],R=p.p2Team.MIL||[],F=B(M)+P(M),K=B(R)+P(R),V=F>=K?"p1":"p2";p[V+"Name"];let X=p.boostValue;X==null&&(X=Yt(),p.boostValue=X,p.boostOwner=V,p.boostUsed=!1),D&&(D.style.opacity="1",D.innerHTML=`<div style="font-size:20px;font-weight:900;margin-bottom:10px">
      ...
      </div>`,document.body.appendChild(R),(F=R.querySelector("#pvp-gc-back"))==null||F.addEventListener("click",()=>R.remove()),(K=R.querySelector("#pvp-gc-use"))==null||K.addEventListener("click",async()=>{R.remove();const V=p["usedGc_"+o]||[];V.push(C),await y({["usedGc_"+o]:V})})}function Y(){var S;const C=p[o+"Score"],z=p[r+"Score"],B=C>z,P=C===z;e.style.overflow="hidden",e.innerHTML=`
    ...
    </div>`,(S=document.getElementById("pvp-home"))==null||S.addEventListener("click",()=>{k.removeChannel(v),le(e),d("home")})}async function H(){const C=(p["selected_"+o]||[]).map(P=>({...(p[o+"Team"][P._role]||[]).find($=>$.cardId===P.cardId)||P,_line:P._role}));if(!C.length)return;const z=ot(C,p.modifiers[o]||{});C.forEach(P=>{const S=(p[o+"Team"][P._role]||[]).find($=>$.cardId===P.cardId);S&&(S.used=!0)});const B=Array.isArray(p.log)?p.log:[];B.push({type:"attack",text:`⚔️ ${p[o+"Name"]} attaque (${z.total})`,players:C,total:z.total,side:o}),await y({pendingAttack:{...z,players:C,side:o},["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},phase:r+"-defense",log:B})}async function Q(){const C=(p["selected_"+o]||[]).map(D=>({...(p[o+"Team"][D._role]||[]).find(R=>R.cardId===D.cardId)||D,_line:D._role})),z=nt(C,p.modifiers[o]||{});C.forEach(D=>{const M=(p[o+"Team"][D._role]||[]).find(R=>R.cardId===D.cardId);M&&(M.used=!0)});const B=rt(p.pendingAttack.total,z.total,p.modifiers[o]||{}),P=p.pendingAttack.side,S=B==="attack",$=p[P+"Score"]+(S?1:0),b=P==="p1"?"p2":"p1",j=(p.round||0)+1,I=j>10,_=Array.isArray(p.log)?p.log:[];_.push({type:"defense",text:`🛡️ ${p[o+"Name"]} défend (${z.total})`,players:C,total:z.total,side:o}),_.push({type:S?"goal":"stop",text:S?`⚽ BUT de ${p[P+"Name"]} ! (${p.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${z.total})`}),await y({[P+"Score"]:$,["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},pendingAttack:null,phase:I?"finished":b+"-attack",attacker:b,round:j,log:_}),I&&await k.from("matches").update({status:"finished"}).eq("id",i)}w()}const uo={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function fo(e,t){const{state:i,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await ct(e,t)}async function ct(e,t){const{state:i,toast:a}=t,{data:c}=await k.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function l(o){const r=document.getElementById("mkt-content"),u=o==="buy"?s:d;if(u.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${g.map(f=>{var y,x,w,E;const L=(y=f.card)==null?void 0:y.player;if(!L)return"";const p=L.job==="GK"?L.note_g:L.job==="DEF"?L.note_d:L.job==="MIL"?L.note_m:L.note_a,h=uo[L.rarity],A=(i.profile.credits||0)>=f.price,v=f.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${v?"opacity:0.65":""}">
          <div style="width:44px;height:44px;border-radius:8px;background:${xo(L.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${h};flex-shrink:0">${p}</div>
          <div style="flex:1;min-width:0">
  ...
  </div>`}const Z={user:null,profile:null,page:"home",params:{}};function qe(e,t="info",i=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},i))}function vo(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function et(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ge(){if(!Z.user)return;const{data:e}=await k.from("users").select("*").eq("id",Z.user.id).single();e&&(Z.profile=e)}const pt="mw_theme";function Ue(){return localStorage.getItem(pt)||"light"}function bo(e){var t;localStorage.setItem(pt,e),tt(e),(t=Z.profile)!=null&&t.id&&k.from("users").update({theme:e}).eq("id",Z.profile.id).then(()=>{})}function tt(e){document.documentElement.setAttribute("data-theme",e)}function Re(e,t={}){Z.page=e,Z.params=t,ii()}async function ii(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(a=>{a.classList.toggle("active",a.dataset.page===Z.page)});const t=document.getElementById("nav-credits");t&&Z.profile&&(t.textContent=`💰 ${(Z.profile.credits||0).toLocaleString("fr")}`);const i={state:Z,navigate:Re,toast:qe,openModal:vo,closeModal:et,refreshProfile:Ge};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',Z.page){case"home":await It(e,i);break;case"collection":await xi(e,i);break;case"decks":await We(e,i);break;case"boosters":await zi(e,i);break;case"match":{(Z.params&&Z.params.matchMode||"vs_ai_easy")==="random"?await lo(e,i):await Vi(e,i);break}case"market":await fo(e,i);break;case"rankings":await yo(e,i);break;case"matches":await ho(e,i);break;default:await It(e,i)}}function wo(){const e=document.getElementById("app"),t=Z.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
