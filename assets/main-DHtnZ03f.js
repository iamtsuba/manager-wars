...
import{s as h,j as Ei,q as Bo,t as Dt,u as Li,F as Ii,o as nt,n as Ht,g as Bt,r as ze,m as ut,v as ni,w as qo,T as Bi,p as hn,x as vn,d as wn}from"./special-cards-YynorolH.js";const _n="/";function mo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,d,c,l,s,f,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function d(){var g;const l=document.getElementById("logo-preview"),s=document.getElementById("logo-initials"),f=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",x=f.trim().split(" ").filter(Boolean),b=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():f.slice(0,2).toUpperCase();l&&(l.style.background=a,l.style.borderColor=n),s&&(s.textContent=b,s.style.color=n)}document.getElementById("color1").addEventListener("input",l=>{n=l.target.value,document.getElementById("swatch1").style.background=n,d()}),document.getElementById("color2").addEventListener("input",l=>{a=l.target.value,document.getElementById("swatch2").style.background=a,d()});function c(l){document.querySelectorAll(".setup-step").forEach(s=>s.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&d()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),s=document.getElementById("step1-error");if(s.textContent="",l.length<3){s.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await h.from("users").select("id").eq("pseudo",l).maybeSingle();if(f){s.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),s=document.getElementById("step2-error");if(s.textContent="",l.length<2){s.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await h.from("users").select("id").eq("club_name",l).maybeSingle();if(f){s.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),s=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),x=document.getElementById("step3-finish");f.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:b}=await h.from("users").insert({id:e.user.id,pseudo:l,club_name:s,club_color1:n,club_color2:a,credits:15e3});if(b)throw b;await $n(e.user.id),await r(),o(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){f.textContent=b.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function $n(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await h.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const En="modulepreload",Ln=function(t){return"/"+t},go={},Do=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=Ln(c),c in go)return;go[c]=!0;const l=c.endsWith(".css"),s=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${s}`))return;const f=document.createElement("link");if(f.rel=l?"stylesheet":En,l||(f.as="script"),f.crossOrigin="",f.href=c,d&&f.setAttribute("nonce",d),document.head.appendChild(f),l)return new Promise((x,b)=>{f.addEventListener("load",x),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return r.then(a=>{for(const d of a||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})},Fo="mw_sound_volume";function Xi(){const t=localStorage.getItem(Fo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function In(t){localStorage.setItem(Fo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Ji(){return Xi()===0}function yi(t){return Math.max(0,Math.min(1,t*(Xi()/100)))}function Qi(t,e=1){if(Ji())return null;try{const i=new Audio(t);return i.volume=yi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Ni=null,bo=.3;function Po(t,e=.3){if(bo=e,ht&&Ni===t&&!ht.paused){ht.volume=yi(bo);return}if(Rt(),!Ji())try{const i=new Audio(t);i.loop=!0,i.volume=yi(e),i.play().catch(()=>{}),ht=i,Ni=t}catch{}}function Rt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Ni=null}let Qt=null;function No(t,e=.6){if(Ke(),!Ji())try{const i=new Audio(t);i.volume=yi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const Tn=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Go(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const s=document.createElement("style");s.id="home2-chrome-style",s.textContent=`
    ...
    `,document.head.appendChild(s)}const r=Tn.map(s=>`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function qi(t,{state:e,navigate:i,toast:o}){var E,m,A,$,T,P;const r=e.profile;if(!r)return;const n="/icons/";Go(i,r,"home2",n);const a=r.mmr??1e3,d=Ei(a),c=An(a,d),l=Bo(a),s=isFinite(d.max)?d.max+1:null,[{list:f,iAmInTop:x,myPosition:b},g,p]=await Promise.all([zn(r.id),Mn(5),Cn()]),u=(G,O)=>`
  ...
  <div class="home-dark" id="home-dark">
  ...
  </div>`,document.body.appendChild(i);const o=()=>i.remove();document.getElementById("solo-cancel").addEventListener("click",o),i.addEventListener("click",l=>{l.target===i&&o()});const[{data:r},{data:n}]=await Promise.all([h.from("solo_levels").select("*").eq("is_active",!0).order("level_number"),h.from("user_solo_progress").select("unlocked_level").eq("user_id",e.profile.id).maybeSingle()]),a=(n==null?void 0:n.unlocked_level)||1,d=r||[],c=document.getElementById("solo-levels-list");if(c){if(!d.length){c.innerHTML='<div style="text-align:center;color:#999;padding:20px">Aucun niveau configuré.</div>';return}c.innerHTML=d.map(l=>{const s=l.level_number>a,f=l.level_number===a,x=s?"#f0f0f0":f?"#eefaf2":"#f7f7f7",b=s?"#ddd":f?"#bfe8cf":"#e0e0e0",g=s?"#999":"#12401f";return`
      <div class="solo-level-card" data-level="${l.level_number}" data-locked="${s}"
        style="cursor:${s?"not-allowed":"pointer"};display:flex;align-items:center;gap:14px;padding:14px 16px;border-radius:14px;background:${x};border:1px solid ${b};opacity:${s?.6:1};transition:transform .12s ease">
    ...
    </div>`,await Uo(i,o,e),document.getElementById("btn-add-friend").addEventListener("click",()=>Rn(i,o)),document.getElementById("btn-accept-friend").addEventListener("click",()=>Ko(i,o,null,e))}async function Uo(t,e,i={}){const{navigate:o}=i,r=t.user.id,{data:n,error:a}=await h.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${r},addressee_id.eq.${r}`),{count:d}=await h.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",r).eq("status","pending"),c=document.getElementById("pending-badge");c&&(d>0?(c.style.display="flex",c.textContent=d):c.style.display="none");const l=document.getElementById("friends-list");if(!l)return;if(a){console.error("[Friends] Erreur:",a),l.innerHTML=`<div style="color:${ai};text-align:center;padding:16px">Erreur chargement : ${a.message}</div>`;return}const s=(n||[]).map(b=>b.requester_id===r?b.addressee_id:b.requester_id);let f={};if(s.length){const{data:b}=await h.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",s);(b||[]).forEach(g=>{f[g.id]=g})}const x=(n||[]).map(b=>({friendshipId:b.id,friend:f[b.requester_id===r?b.addressee_id:b.requester_id]||{pseudo:"?"}}));if(!x.length){l.innerHTML=`
    ...
    </style>`}async function Hn(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;const n="/icons/";Go(i,r,"game",n),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const d=a.dataset.action;if(d==="match-ai"){Ho(i,e);return}if(d==="match-random"){mt(),i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Vo(t,e){var p,u;const{state:i,navigate:o}=e,r=oi(),n=Xi(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,d="2026.07.29-1004";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${ze(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(d||[]).filter(C=>C.card_type==="player"&&C.player),s=(d||[]).filter(C=>C.card_type==="game_changer"),f=(d||[]).filter(C=>C.card_type==="formation"),x=(d||[]).filter(C=>C.card_type==="stadium"),{data:b}=await h.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(C=>{g[C.name]=C});const{data:p}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(C=>{u[C.id]=C}),x.forEach(C=>{C.stadium_def&&(u[C.stadium_id]=C.stadium_def)});const y=Object.keys(Ii),w=Object.keys(Oe),v={};l.forEach(C=>{const K=C.player.id;v[K]=(v[K]||0)+1}),new Set(Object.keys(v).map(C=>String(C)));const E=new Set(f.map(C=>C.formation)),m=new Set(s.map(C=>C.gc_type));let A="player",$="Tous",T="",P=!1;function G(){return[...l].sort((C,K)=>{const Q=pi.indexOf(C.player.job),X=pi.indexOf(K.player.job);return Q!==X?Q-X:(C.player.surname_real||"").localeCompare(K.player.surname_real||"")})}function O(){return[...c||[]].sort((C,K)=>{const Q=pi.indexOf(C.job),X=pi.indexOf(K.job);return Q!==X?Q-X:(C.surname_real||"").localeCompare(K.surname_real||"")})}function V(){return G().filter(C=>{const K=C.player,Q=$==="Tous"||K.job===$,X=!T||`${K.firstname} ${K.surname_real}`.toLowerCase().includes(T);return Q&&X})}function I(){return O().filter(C=>{const K=$==="Tous"||C.job===$,Q=!T||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(T);return K&&Q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${fi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=x.find(v=>!v.is_for_sale)||x[0];if(!y){n("Aucune carte à vendre","error");return}await h.from("market_listings").delete().eq("card_id",y.id),await h.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await h.from("cards").delete().eq("id",y.id);if(w){n(w.message,"error");return}await h.from("users").update({credits:(r.profile.credits||0)+fi}).eq("id",r.profile.id),await c(),n(`+${fi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){n("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",t.id),await h.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:y}),n("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),d("collection")})}async function wo(t,e,i,o){var pe,me,fe,C,K,Q,X,re,F;const{state:r,toast:n,openModal:a,closeModal:d,navigate:c,refreshProfile:l}=o,s=t.player,f=e.filter(z=>z.player.id===s.id),x=f.length,b=t.evolution_bonus||0,g=Math.max((Number(s.note_g)||0)+(s.job==="GK"||s.job2==="GK"?b:0),(Number(s.note_d)||0)+(s.job==="DEF"||s.job2==="DEF"?b:0),(Number(s.note_m)||0)+(s.job==="MIL"||s.job2==="MIL"?b:0),(Number(s.note_a)||0)+(s.job==="ATT"||s.job2==="ATT"?b:0)),p=s.rarity||"normal",{data:u}=await h.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((pe=u==null?void 0:u[0])==null?void 0:pe.price)??Yn[p];const y=((me=u==null?void 0:u[0])==null?void 0:me.price_min)??null,w=((fe=u==null?void 0:u[0])==null?void 0:fe.price_max)??null,v=s.rarity!=="legende";Bt(s);const E=ui(s,s.job)+b,m=s.job2?ui(s,s.job2)+(ui(s,s.job2)>0?b:0):null;Jt[s.job],s.job2&&Jt[s.job2];const A=Kn[s.rarity]||"#ccc",$=Xn[s.country_code]||s.country_code||"",T=t.evolution_bonus||0,G=E+T,O=m||0,V=O>0?O+T:0,I=f.map(z=>z.id);let _={};if(I.length){const{data:z}=await h.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",I).order("transferred_at",{ascending:!0});(z||[]).forEach(Y=>{_[Y.card_id]||(_[Y.card_id]=[]),_[Y.card_id].push(Y)})}const R=I.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
        ...
        ${f.filter(z=>z.id!==t.id).map((z,Y)=>{const Z=_[z.id]||[],se=z.is_for_sale,ge=Z.length?Z[Z.length-1]:null,ye=z.evolution_bonus||0,$e=ge?ge.source==="booster"?"Booster":ge.price?ge.price.toLocaleString("fr")+" cr.":"—":"—",Ee=ge?new Date(ge.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",xe=80,be=Math.round(xe*657/507),je=ze({...s,_evolution_bonus:ye},{width:xe});return`
            <div class="exemplaire-row" data-card-id="${z.id}" data-card-idx="${Y}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${z.id}" data-evo="${ye}" data-note="${ui(s,s.job)}"
                ${se?"disabled":""}
                style="display:none">
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div>
          ...
          <div style="font-weight:900;font-size:15px;color:${s.rarity==="normal"?"#555":s.rarity==="papyte"?"#707070":A}">${s.rarity.toUpperCase()}</div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(K=document.getElementById("close-detail"))==null||K.addEventListener("click",d);let W=new Set;const de=s.rarity==="pepite"?1.3:s.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(Y=>{if(Y.dataset.id===t.id)return;const se=Number(Y.dataset.evo)||0,ge=Number(Y.dataset.note)||0;z+=ge+se}),Math.round(z*de)}const j=()=>{const z=W.size,Y=document.getElementById("sell-action-panel");if(!Y)return;Y.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const Y=z.dataset.id;z.checked?W.add(Y):W.delete(Y);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",Y=>{if(Y.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(x<=1)return;const z=[...W];if(!z.length)return;if(W.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
        ...
        </div>`,document.body.appendChild(be),be.querySelector("#sac-cancel").addEventListener("click",()=>{be.remove(),xe(!1)}),be.querySelector("#sac-ok").addEventListener("click",()=>{be.remove(),xe(!0)}),be.addEventListener("click",je=>{je.target===be&&(be.remove(),xe(!1))})}))return;if(Y.length){await h.from("market_listings").delete().in("card_id",Y),await h.from("deck_cards").delete().in("card_id",Y),await h.from("transfer_history").delete().in("card_id",Y),await h.from("decks").update({stadium_card_id:null}).in("stadium_card_id",Y);const{error:xe}=await h.from("cards").delete().in("id",Y);if(xe){n("Erreur suppression : "+xe.message,"error");return}}const $e=(t.evolution_bonus||0)+se,{error:Ee}=await h.from("cards").update({evolution_bonus:$e}).eq("id",t.id);if(Ee){n("Erreur évolution : "+Ee.message,"error");return}n(`⬆️ ${s.firstname} ${s.surname_real} : note ${E} → ${E+$e} (+${se}) !`,"success",4e3),d(),c("collection")});async function H(z){const{data:Y}=await h.from("sell_price_configs").select("price_min, price_max").eq("rarity",s.rarity).lte("note_min",E).gte("note_max",E).order("note_max",{ascending:!0}).limit(1).maybeSingle();return Y?z<Y.price_min||z>Y.price_max?{ok:!1,min:Y.price_min,max:Y.price_max}:{ok:!0}:{ok:!0}}(X=document.getElementById("market-sell-btn"))==null||X.addEventListener("click",async()=>{var $e;const z=[...W];if(!z.length){n("Sélectionne au moins un exemplaire","warning");return}const Y=parseInt(($e=document.getElementById("sell-market-price"))==null?void 0:$e.value);if(!Y||Y<1){n("Prix invalide","error");return}const Z=await H(Y);if(!Z.ok){n(`Prix hors grille : entre ${Z.min.toLocaleString("fr")} et ${Z.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:se}=await h.from("cards").update({is_for_sale:!0,sale_price:Y}).in("id",z);if(se){n(se.message,"error");return}const ge=z.map(Ee=>({seller_id:r.profile.id,card_id:Ee,price:Y,status:"active"})),{error:ye}=await h.from("market_listings").insert(ge);ye&&console.warn("[Market] insert listings:",ye.message),n(`${z.length} carte${z.length>1?"s":""} mise${z.length>1?"s":""} en vente à ${Y.toLocaleString("fr")} cr. chacune !`,"success"),d(),c("collection")}),(re=document.getElementById("single-sell-btn"))==null||re.addEventListener("click",async()=>{var ge;const z=parseInt((ge=document.getElementById("single-sell-price"))==null?void 0:ge.value);if(!z||z<1){n("Prix invalide","error");return}const Y=await H(z);if(!Y.ok){n(`Prix hors grille : entre ${Y.min.toLocaleString("fr")} et ${Y.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:Z}=await h.from("cards").update({is_for_sale:!0,sale_price:z}).eq("id",t.id);if(Z){n(Z.message,"error");return}const{error:se}=await h.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:z,status:"active"});se&&console.warn("[Market] insert listing:",se.message),n(`Carte mise en vente à ${z.toLocaleString("fr")} cr. !`,"success"),d(),c("collection")}),(F=document.getElementById("cancel-sell-btn"))==null||F.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),d(),c("collection")})}function _o(t,e=""){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(o);const r=o.querySelector("#pm-input");r.focus(),r.select();const n=a=>{o.remove(),i(a)};o.querySelector("#pm-ok").addEventListener("click",()=>n(r.value.trim()||null)),o.querySelector("#pm-cancel").addEventListener("click",()=>n(null)),o.querySelector("#pm-cancel2").addEventListener("click",()=>n(null)),o.addEventListener("click",a=>{a.target===o&&n(null)}),r.addEventListener("keydown",a=>{a.key==="Enter"&&n(r.value.trim()||null),a.key==="Escape"&&n(null)})})}function er(t,e=!1){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:380px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const c=await _o("Nom du deck",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!c)return;const{data:l,error:s}=await h.from("decks").insert({owner_id:i.profile.id,name:c}).select().single();if(s){r(s.message,"error");return}r("Deck créé !","success"),ko(l.id,t,e)}),t.querySelectorAll("[data-open-deck]").forEach(c=>{c.addEventListener("click",()=>ko(c.dataset.openDeck,t,e))}),t.querySelectorAll("[data-rename]").forEach(c=>{c.addEventListener("click",async()=>{const l=await _o("Nouveau nom",c.dataset.name);if(!l||l===c.dataset.name)return;const{error:s}=await h.from("decks").update({name:l}).eq("id",c.dataset.rename);if(s){r(s.message,"error");return}r("Deck renommé !","success"),Gi(t,e)})}),t.querySelectorAll("[data-delete]").forEach(c=>{c.addEventListener("click",async()=>{if(!await er(`Supprimer le deck "${c.dataset.name}" ? Cette action est irréversible.`,!0))return;await h.from("deck_cards").delete().eq("deck_id",c.dataset.delete);const{error:l}=await h.from("decks").delete().eq("id",c.dataset.delete);if(l){r(l.message,"error");return}r("Deck supprimé.","success"),Gi(t,e)})})}async function ko(t,e,i){const{state:o,toast:r}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await h.from("decks").select("*").eq("id",t).single(),{data:a}=await h.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),c=(a||[]).filter(y=>y.card_type==="player"&&y.player),l=(a||[]).filter(y=>y.card_type==="formation"),s=(d||[]).filter(y=>y.card_type==="stadium"),f=[...new Set(s.map(y=>y.stadium_id).filter(Boolean))];let x={};if(s.forEach(y=>{y.stadium_def&&y.stadium_id&&(x[y.stadium_id]=y.stadium_def)}),f.length&&Object.keys(x).length<f.length){const{data:y}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(y||[]).forEach(w=>{x[w.id]=w})}const b=l.map(y=>y.formation).filter(Boolean),{data:g}=await h.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let p=n.formation||"4-4-2";b.length>0&&!b.includes(p)&&(p=b[0]);const u={deckId:t,name:n.name,formation:p,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:c,formationCards:l,stadiumCards:s,stadDefMap:x,availableFormations:b};(g||[]).forEach(y=>{y.is_starter?u.slots[y.position]=y.card_id:u.subs.includes(y.card_id)||u.subs.push(y.card_id)}),$t(e,u,i)}function $t(t,e,i){var g,p;const{navigate:o}=i;hi[e.formation];const r=$o(e.formation),n=r.filter(u=>e.slots[u]).length,a=e.availableFormations.length>0?e.availableFormations:Object.keys(hi),d=(g=e.stadiumCards)==null?void 0:g.find(u=>u.id===e.stadiumCardId),c=d&&((p=e.stadDefMap)==null?void 0:p[d.stadium_id])||null,l=e.subs.map(u=>e.playerCards.find(y=>y.id===u)).filter(Boolean);l.length!==e.subs.length&&(e.subs=l.map(u=>u.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;const s=window.innerWidth>=900,f=t.querySelector(".deck-pc-layout"),x=t.querySelector(".deck-mobile-layout");f&&(f.style.display=s?"block":"none"),x&&(x.style.display=s?"none":"block"),t.querySelectorAll("#save-deck").forEach(u=>{u.closest(".page-body").style.display=s?"none":"block"}),tr(t,e,r,i),t.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>o("decks")));const b=()=>{const{openModal:u,closeModal:y}=i,v=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
    ...
    </div>`;u("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(E=>{E.addEventListener("click",()=>{e.formation=E.dataset.forma;const m=$o(e.formation),A={};m.forEach($=>{e.slots[$]&&(A[$]=e.slots[$])}),e.slots=A,y(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",b)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>ir(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>rr(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>nr(e,t,i)))}function tr(t,e,i,o){var v,E,m;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(v=e.stadiumCards)==null?void 0:v.find(A=>A.id===e.stadiumCardId),d=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,c=ut[e.formation]||{},l=Li(e.formation)||[],s={};for(const A of i){const $=e.slots[A],T=$?e.playerCards.find(P=>P.id===$):null;T!=null&&T.player?s[A]={...T.player,_evolution_bonus:T.evolution_bonus||0,face:T.player.face||null}:s[A]=null}const f=window.innerWidth>=900,x=f?window.innerWidth-280:window.innerWidth-20,b=f?Math.min(x,860):x,g=Math.round(f?b*.82:b*.85),p=f?84:44;let u="";for(const[A,$]of l){const T=c[A],P=c[$];if(!T||!P)continue;const G=T.x*b,O=Math.round(.03*g+T.y*.85*g),V=P.x*b,I=Math.round(.03*g+P.y*.85*g),_=s[A],R=s[$],W=Dt(_,R);W==="#ff3333"||W==="#cc2222"?u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${G.toFixed(1)}" y1="${O.toFixed(1)}" x2="${V.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${W}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const A of i){const $=c[A];if(!$)continue;const T=s[A],P=$.x*b;$.y*g;const G=Math.round(.03*g+$.y*(.85*g)),O=Math.round(P-p/2),V=Math.round(G-w/2);if(T){const I=A.replace(/\d+/,""),_=d&&(d.club_id&&String(T.club_id)===String(d.club_id)||d.country_code&&T.country_code===d.country_code),R=ze({...T,_evolution_bonus:T._evolution_bonus||0},{width:p,showStad:!0,stadDef:d,role:I});_&&((m=d.club)!=null&&m.logo_url||d.image_url),y+=`<div style="position:absolute;left:${O}px;top:${V}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${A}">
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(A=>{A.addEventListener("click",()=>or(A.dataset.pos,e,t,o))})}function ir(t,e,i){var d;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(c=>{const l=c.stadium_id||c.id;return n.has(l)?!1:(n.add(l),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${a.map(c=>{var b;const l=t.stadDefMap[c.stadium_id],s=((b=l==null?void 0:l.club)==null?void 0:b.logo_url)||(l==null?void 0:l.image_url)||(l!=null&&l.country_code?`https://flagsapi.com/${l.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),f=t.stadiumCardId===c.id,x=Ht((l==null?void 0:l.name)||"Stade",s,"+10⭐",{width:90});return`<div class="stad-choice" data-stad-id="${c.id}" style="cursor:pointer;position:relative;border-radius:8px;${f?"box-shadow:0 0 0 3px #4fc3f7":""}">
          ${x}
        </div>`}).join("")}
    </div>`),(d=document.getElementById("stad-none"))==null||d.addEventListener("click",()=>{t.stadiumCardId=null,r(),$t(e,t,i)}),document.querySelectorAll(".stad-choice").forEach(c=>{c.addEventListener("click",()=>{t.stadiumCardId=c.dataset.stadId,r(),$t(e,t,i)})})}function or(t,e,i,o){var g,p,u,y,w;const{openModal:r,closeModal:n}=o,a=t.replace(/\d+/,""),d=(g=e.stadiumCards)==null?void 0:g.find(v=>v.id===e.stadiumCardId),c=d&&((p=e.stadDefMap)==null?void 0:p[d.stadium_id])||null,l=e.slots[t],s=l?e.playerCards.find(v=>v.id===l):null;(u=s==null?void 0:s.player)==null||u.id;const f=new Set;Object.entries(e.slots).forEach(([v,E])=>{var A;if(v===t||!E)return;const m=e.playerCards.find($=>$.id===E);(A=m==null?void 0:m.player)!=null&&A.id&&f.add(m.player.id)}),e.subs.forEach(v=>{var m;const E=e.playerCards.find(A=>A.id===v);(m=E==null?void 0:E.player)!=null&&m.id&&f.add(E.player.id)});const x=new Set,b=e.playerCards.filter(v=>{const E=v.player;return!(E.job===a||E.job2===a)||f.has(E.id)||x.has(E.id)?!1:(x.add(E.id),!0)});b.sort((v,E)=>{const m=v.evolution_bonus||0,A=E.evolution_bonus||0,$=(a==="GK"?v.player.note_g:a==="DEF"?v.player.note_d:a==="MIL"?v.player.note_m:v.player.note_a)+(a===v.player.job||a===v.player.job2?m:0);return(a==="GK"?E.player.note_g:a==="DEF"?E.player.note_d:a==="MIL"?E.player.note_m:E.player.note_a)+(a===E.player.job||a===E.player.job2?A:0)-$}),r(`Choisir ${a} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${b.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+b.map(v=>{const E={...v.player,_evolution_bonus:v.evolution_bonus||0};return`<div class="player-option" data-card-id="${v.id}" style="cursor:pointer">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(y=document.getElementById("close-selector"))==null||y.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),$t(i,e,o)}),document.querySelectorAll(".player-option").forEach(v=>{v.addEventListener("click",()=>{e.slots[t]=v.dataset.cardId,n(),$t(i,e,o)})})}function nr(t,e,i){var s,f,x;const{openModal:o,closeModal:r}=i,n=(s=t.stadiumCards)==null?void 0:s.find(b=>b.id===t.stadiumCardId),a=n&&((f=t.stadDefMap)==null?void 0:f[n.stadium_id])||null,d=new Set;Object.keys(t.slots).forEach(b=>{var u;const g=t.slots[b];if(!g)return;const p=t.playerCards.find(y=>y.id===g);(u=p==null?void 0:p.player)!=null&&u.id&&d.add(p.player.id)}),t.subs.forEach(b=>{var p;const g=t.playerCards.find(u=>u.id===b);(p=g==null?void 0:g.player)!=null&&p.id&&d.add(g.player.id)});const c=new Set,l=t.playerCards.filter(b=>{var g,p,u;return d.has((g=b.player)==null?void 0:g.id)||c.has((p=b.player)==null?void 0:p.id)?!1:(c.add((u=b.player)==null?void 0:u.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${n.map(g=>{const p=g.cost===0||r>=g.cost,u=s[g.id]===!0;return`<div class="booster-card ${!p||u?"disabled":""}" data-booster="${g.id}" style="position:relative">
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),d=document.getElementById("pack-blade");let c=!1;const l=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function s(_){n||(c=!0,d.style.opacity="1",f(_))}function f(_){if(!c||n)return;const R=a.getBoundingClientRect(),W=l(_)-R.left,de=Math.max(0,Math.min(1,W/R.width));d.style.width=de*R.width+"px",de>=.82&&b()}function x(){n||(c=!1,d.style.transition="width .2s ease, opacity .2s ease",d.style.width="0",d.style.opacity="0",setTimeout(()=>{n||(d.style.transition="")},220))}function b(){var R;if(n)return;n=!0,c=!1,d.style.width="100%",d.style.opacity="1",(R=document.getElementById("cut-flash"))==null||R.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{d.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",s),window.addEventListener("pointermove",f),window.addEventListener("pointerup",x),a.addEventListener("touchstart",s,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",x);let g=0,p=!1;const u=new Set;function y(_){g=_,document.getElementById("reveal-phase").style.display="flex",w(),v(_,0),T()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((R,W)=>`<div class="card-dot" data-i="${W}" style="width:8px;height:8px;border-radius:50%;background:${W===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(R=>R.addEventListener("click",()=>m(parseInt(R.dataset.i)))))}function v(_,R){var C,K;const W=t[_],de=document.getElementById("card-counter"),ce=document.getElementById("card-track");de&&(de.textContent=`Carte ${_+1} / ${t.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=_===t.length-1?"flex":"none");const H=W.card_type==="player"&&((C=W.player)==null?void 0:C.rarity)==="legende",pe=!u.has(_);u.add(_);let me=0;if(W.card_type==="player"&&W.player){const Q=W.player,X=Q.job||"ATT";me=(Number(X==="GK"?Q.note_g:X==="DEF"?Q.note_d:X==="MIL"?Q.note_m:Q.note_a)||0)+(W.evolution_bonus||0)}const fe=Q=>{ce.innerHTML=`
      ...
      </div>`,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>o.remove());return}br()}function br(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function xr(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText=`
    ...
    `,document.body.appendChild(e);try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(r){console.warn("[AdSense]",r)}let i=5;const o=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(o),e.remove(),t(!0))},1e3)})}async function yr(t,{state:e,navigate:i,toast:o,refreshProfile:r}){var x,b;const{data:n}=await h.from("users").select("*").eq("id",e.user.id).single();n&&(e.profile=n);let a=Array.isArray((x=e.profile)==null?void 0:x.pending_boosters)?[...e.profile.pending_boosters]:[];if(!a.length){await h.from("users").update({onboarding_done:!0}).eq("id",e.user.id),i("home");return}let d=null;try{const p=(await Jo()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(d=Zo(p))}catch(g){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',g)}const c=a.length;let l=0;t.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const s=async()=>{await h.from("users").update({pending_boosters:a}).eq("id",e.user.id)};async function f(){var w;if(l>=c||!a.length){await h.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),r&&await r(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const g=a[0],{data:p}=await h.from("users").select("*").eq("id",e.user.id).single();p&&(e.profile=p);let u=[];try{if(g.type==="formation")u=await on(e.profile,0);else if(g.type==="game_changer")u=await tn(e.profile,g.count||3,0);else if(d&&((w=d.rates)!=null&&w.length)){const v={...d,cost:0,cardCount:g.count||d.cardCount||5};u=await Oi(e.profile,v),g.guaranteeGK&&!e.profile.first_booster_opened&&(u.some(m=>m.player&&m.player.job==="GK")||await hr(e.profile,u),await h.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else u=await en(e.profile,g.count||5,0)}catch(v){o(v.message||"Erreur ouverture booster","error");return}a.shift(),l++,await s();const y=g.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:g.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${l}/${c})`,img:(d==null?void 0:d.img)||"/icons/booster-players.png"};nn(u,y,i,()=>{f()})}(b=document.getElementById("onboard-start"))==null||b.addEventListener("click",()=>f())}async function hr(t,e){try{const{data:i}=await h.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],r=e.findIndex(a=>a.player);if(r===-1)return;const n=e[r];await h.from("cards").update({player_id:o.id}).eq("id",n.id),e[r]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Et={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},vr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Mt(t,e,i,o,r){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function Hi(t,e){var n,a;const i=t.player,o=t.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:t.id,position:e||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?o:0)+(i.job2==="GK"&&r>0?o:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?o:0)+(i.job2==="DEF"&&r>0?o:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?o:0)+(i.job2==="MIL"&&r>0?o:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?o:0)+(i.job2==="ATT"&&r>0?o:0),evolution_bonus:o,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function di(t,e){if(!e||!t)return t;const{club_id:i,country_code:o}=e;return Object.values(t).forEach(r=>{Array.isArray(r)&&r.forEach(n=>{const a=i&&String(n.club_id)===String(i),d=o&&String(n.country_code)===String(o);(a||d)&&(n.stadiumBonus=!0)})}),t}function vi(t,e){if(!e||!(t!=null&&t.length))return t;const{club_id:i,country_code:o}=e;return t.forEach(r=>{if(!r)return;const n=i&&String(r.club_id)===String(i),a=o&&String(r.country_code)===String(o);(n||a)&&(r.stadiumBonus=!0)}),t}function dt(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function rn(){const t=Math.random()*100;return t<10?10:t<30?5:3}function wi(t,e){const i=Et[e]||Et["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]};if(t.length&&t.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const d=t.filter(l=>l.position&&l.position.replace(/\d+$/,"")===a).sort((l,s)=>parseInt(l.position.replace(/\D+/g,""),10)-parseInt(s.position.replace(/\D+/g,""),10)).map(l=>({...l,_line:a})),c=dt(d.length);d.forEach((l,s)=>{l._col=c[s]}),o[a]=d}return o}const n=[...t];for(const a of["GK","DEF","MIL","ATT"]){const d=[];for(let l=0;l<i[a];l++){let s=n.findIndex(f=>f.job===a);if(s===-1&&(s=n.findIndex(f=>f.job2===a)),s===-1&&(s=0),n[s]){const f={...n[s],_line:a};d.push(f),n.splice(s,1)}}const c=dt(d.length);d.forEach((l,s)=>{l._col=c[s]}),o[a]=d}return o}function ct(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.setProperty("display","none","important"),e.dataset.matchHidden="1"}),t&&t.style.setProperty("padding-bottom","0","important")}function Ve(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.removeProperty("display"),delete e.dataset.matchHidden}),t&&t.style.removeProperty("padding-bottom")}function Si(t,e,i){const r=new Set,n=e.filter(s=>{var x;const f=((x=s._gcDef)==null?void 0:x.name)||s.gc_type||s.id;return r.has(f)?!1:(r.add(f),!0)});let a=[];function d(s,f){const x=s._gcDef,b=(x==null?void 0:x.name)||s.gc_type,g=x!=null&&x.image_url?`/icons/${x.image_url}`:null,p=nt(b,g,"⚡",(x==null?void 0:x.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${s.id}"
    ...
    </div>`}const c=s=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(s)};function l(){var f,x,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const s=a.length>0;t.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${n.map(g=>{const p=a.find(u=>u.gc_type===g.gc_type);return d(g,!!p)}).join("")}
      </div>
    ...
    </div>`,t.querySelectorAll(".gc-select-card").forEach(g=>{g.addEventListener("click",()=>{const p=g.dataset.id,u=n.find(w=>w.id===p);if(!u)return;const y=a.findIndex(w=>w.gc_type===u.gc_type);y>-1?a.splice(y,1):a.length<3&&a.push(u),l()})}),(f=t.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{s&&c(a)}),(x=t.querySelector("#gc-no-gc"))==null||x.addEventListener("click",()=>c([])),(b=t.querySelector("#gc-reset"))==null||b.addEventListener("click",()=>{a.length&&(a=[],l())})}l()}function wr(t,e){var r;const i=((r=e==null?void 0:e.state)==null?void 0:r.params)||{},o=t||i.matchMode||"vs_ai_easy";return o==="friend"?`Match vs ${i.friendName||"Ami"}`:o==="random"?"Match vs Random":o==="ranked"?"Match Classé":o==="mini_league"||o==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${o.replace("vs_ai_","").toUpperCase()}`}async function _r(t,e,i){const{state:o,navigate:r}=e;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await h.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Mt(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=n.map(x=>x.id),{data:d}=await h.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),c=[...new Set((d||[]).filter(x=>{var b,g;return((b=x.card)==null?void 0:b.card_type)==="stadium"&&((g=x.card)==null?void 0:g.stadium_id)}).map(x=>x.card.stadium_id))],l={};if(c.length){const{data:x}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(x||[]).forEach(b=>{l[b.id]=b}),(d||[]).forEach(b=>{var g,p;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((p=b.card)!=null&&p.stadium_id)&&(b.card._stadiumDef=l[b.card.stadium_id]||null)})}let s=0;function f(){var m,A,$,T,P,G,O;const x=n[s],b=(d||[]).filter(V=>V.deck_id===x.id),g=b.filter(V=>{var I;return V.is_starter&&((I=V.card)==null?void 0:I.player)}).map(V=>Hi(V.card,V.position)),p=b.find(V=>{var I;return((I=V.card)==null?void 0:I.card_type)==="formation"}),u=x.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let y=g.length>=11?wi(g,u):null,w=((A=x.stadium_card)==null?void 0:A.stadium_def)||null;w&&y&&(y=di(y,w));const v=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function V(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!y)return;const R=_.clientWidth>=900,W=Math.max(200,_.clientHeight-(R?60:40)),ce=Math.max(200,_.clientWidth-16),j=R?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(W<220||ce<220){requestAnimationFrame(V);return}const H=R?null:Math.round(j*.55);I.innerHTML=Ut(y,u,null,[],ce,W,[],H),I.style.cssText=`width:${ce}px;height:${W}px;overflow:hidden;margin:${R?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",R?"xMidYMid meet":"none"))})),(T=document.getElementById("prev-deck"))==null||T.addEventListener("click",()=>{s>0&&(s--,f())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{s<n.length-1&&(s++,f())}),(G=document.getElementById("validate-deck"))==null||G.addEventListener("click",()=>{if(!v)return;const V=e.state.params||{};e.navigate("match",{...V,matchMode:V.matchMode||i,deckId:x.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let V=0,I=0;E.addEventListener("touchstart",_=>{V=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const R=_.changedTouches[0].clientX-V,W=_.changedTouches[0].clientY-I;Math.abs(R)<40||Math.abs(R)<Math.abs(W)||(R<0&&s<n.length-1?(s++,f()):R>0&&s>0&&(s--,f()))},{passive:!0})}}f()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((d,c)=>{const l=d._line||d.job||"MIL";let s=d.boost||0;if(d.stadiumBonus&&(o==="attack"&&(l==="ATT"||l==="MIL")||o==="defense"&&(l==="GK"||l==="DEF"||l==="MIL")?s+=10:o||(s+=10)),a+=ze({...d,_evolution_bonus:0,evolution_bonus:0},{width:40,role:l,extraNote:s}),c<n.length-1){const f=n[c+1],x=Yo(d,f,r)?Dt(d,f):null;a+=`<div style="width:7px;height:3px;background:${!x||x==="#ff3333"||x==="#cc2222"?"rgba(255,255,255,0.12)":x};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Ai(t,e,i,o,r=310,n=310,a=[],d=null){const c=ut[e]||{},l=Li(e)||Ii[e]||[],s={},f=["ATT","MIL","DEF","GK"];for(const y of f)(t[y]||[]).forEach((v,E)=>{s[`${y}${E+1}`]=v});function x(y){const w=c[y];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[y,w]of l){const v=x(y),E=x(w);if(!v||!E)continue;const m=s[y],A=s[w],$=Dt(m,A);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${$}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,b+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):b+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),p=Math.round(g*657/507);for(const[y,w]of Object.entries(s)){const v=x(y);if(!v||!w)continue;const E=y.replace(/[0-9]/g,""),m=a.includes(w.cardId),A=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,$=o.includes(w.cardId);let T=w.boost||0,P=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(T+=10,P=!0):i||(T+=10,P=!0));const G=Math.round(v.x-g/2),O=Math.round(v.y-p/2);if(w.used){b+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${G}" y="${O}" width="${g}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const V=ze({...w,_evolution_bonus:0,stadiumBonus:!1},{width:g,showStad:!1,stadDef:null,role:E,extraNote:T,_cardOffset:30,_forceStadColor:P}),I=$?`position:absolute;top:30px;left:0;width:${g}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";b+=`<foreignObject x="${G-2}" y="${O-30}" width="${g+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${V}
        ${$?`<div style="${I}"></div>`:""}
      </div>
    </foreignObject>`,A&&(b+=`<rect x="${G}" y="${O}" width="${g}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const u=d!==null?d:Math.round(Math.max(g*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${r+u*2} ${n+u*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${b}
  </svg>`}function Ut(t,e,i,o,r=300,n=300,a=[],d=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Ai(t,e,i,o,r,n,a,d)}
  </div>`}async function zi(t,e,i,o){var A;const{state:r,navigate:n,toast:a}=e;ct(t);const d=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!d.deckId)return _r(t,e,i);const c=d.deckId;let l,s,f,x;try{const $=await Promise.all([h.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),h.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);l=$[0].data,f=$[0].error,s=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Mt(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),Mt(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(s||[]).filter($=>{var T;return $.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Hi($.card,$.position)),g=(s||[]).filter($=>{var T;return!$.is_starter&&((T=$.card)==null?void 0:T.player)}).map($=>Hi($.card,$.position));if(b.length<11){Mt(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(s||[]).find($=>{var T;return((T=$.card)==null?void 0:T.card_type)==="formation"}),u=(l==null?void 0:l.formation)||((A=p==null?void 0:p.card)==null?void 0:A.formation)||"4-4-2",{data:y,error:w}=await h.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:v}=await h.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(v==null?void 0:v.find(T=>T.name===$.gc_type||T.id===$.gc_definition_id))||null}));let m=null;if(l!=null&&l.stadium_card_id){const{data:$}=await h.from("cards").select("stadium_id").eq("id",l.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:T}=await h.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=T||null}}o({deckId:c,formation:u,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:v||[],stadiumDef:m})}function Ct(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(Ct()*1.1)}function an(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Bt(t)}}function kr(t,e,i,o="Adversaire"){Po("/sounds/match-opening.mp3",.3);const r=Ct(),n=Ot();return`
    ...
    </div>`}function sn(t){var n,a,d;if(!t)return"";const e=c=>c?ze({...c,_evolution_bonus:0},{width:52,role:c._line||c.job,showStad:!!c.stadiumBonus,extraNote:c.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(c)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function $r(t,e,i){const o=document.getElementById("sub-anim-overlay");o&&o.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function ln(t,e){const i=Pe(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+ln(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Dt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function _i(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const d=a<t.length-1?Dt(n,t[a+1]):null,c=!d||d==="#ff3333"||d==="#cc2222",l=d==="#00ff88"?"+10":d==="#FFD700"?"+5":"";return ln(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function Er(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",d=o.soloLevel||1,c=r.replace("vs_ai_",""),l=r;let s=null;if(n){const{data:g}=await h.from("solo_levels").select("*").eq("level_number",d).maybeSingle();s=g||{level_number:d,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const f=o.rankedData||null,x=o.presetSetup||null;async function b({deckId:g,formation:p,starters:u,subsRaw:y,gcCardsEnriched:w,gcDefs:v,stadiumDef:E}){try{let m=wi(u,p);E&&(m=di(m,E),vi(y,E));let A=null;if(a){const G=Ir(m),{jaune:O,vert:V}=Tr(m,p),I=.9+Math.random()*.2;A={target_note_avg:Math.max(1,Math.round(G*I/16)),nb_liens_jaune:O,nb_liens_vert:V,nb_joueurs_stade:E?3:0}}const $=n?await Lo(p,s):a?await Lo(p,A):await Lr(p,c),T=$.lines||$,P=async G=>{try{const O=l==="vs_ai_club"||l==="solo"||l==="ranked_ai"?"club":l,{data:V,error:I}=await h.from("matches").insert({home_id:i.profile.id,away_id:null,mode:O,home_deck_id:g,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),Mt(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&T&&(di(T,_),vi($.subs||[],_));const R={gcDefs:v||[],matchId:V==null?void 0:V.id,mode:l,difficulty:c,formation:p,isSolo:n,soloLevel:d,soloLevelConfig:s,isRankedAI:a,rankedAIData:f,homeTeam:m,aiTeam:T,homeSubs:y,subsUsed:0,maxSubs:Math.min(y.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:G,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Sr(t,R,e)}catch(O){console.error("[MatchIA] Exception launchMatch:",O),Mt(t,"⚠️","Erreur au lancement du match : "+O.message,"Retour",()=>e.navigate("home"))}};if(a&&x){P(x.gcCardsEnriched||[]);return}if(!w.length){P([]);return}Si(t,w,P)}catch(m){console.error("[MatchIA] Exception setup:",m),Mt(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}x?await b(x):await zi(t,e,r,b)}async function Lr(t,e){var u;const{data:i}=await h.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(y,w,v){var E,m;return n.add(y.id),{cardId:"ai-"+y.id+"-"+v,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=y.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!n.has($.id)),v=i.filter($=>$.job!==y&&!n.has($.id)),E=[...w,...v],m=[];for(let $=0;$<o[y];$++){const T=E[$];T&&m.push(a(T,y,$))}const A=dt(m.length);m.forEach(($,T)=>{$._col=A[T]}),r[y]=m}const c=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),{data:l}=await h.from("gc_definitions").select("*").eq("is_active",!0),f=[...l||[]].sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>({id:"ai-gc-"+w,gc_type:y.name,name:y.name,icon:"⚡",effect_type:y.effect_type,effect_params:y.effect_params||{}})),x=Object.values(r).flat(),b={};x.forEach(y=>{y.club_id&&(b[y.club_id]=(b[y.club_id]||0)+1)});const g=(u=Object.entries(b).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await h.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:r,subs:c,gcCards:f,stadiumDef:p}}function Ir(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Tr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((d,c)=>{i[`${a}${c+1}`]=d});const o=Li(e)||Ii[e]||[];let r=0,n=0;for(const[a,d]of o){const c=i[a],l=i[d];if(!c||!l)continue;const s=Dt(c,l);s==="#00ff88"?n++:s==="#FFD700"&&r++}return{jaune:r,vert:n}}function Eo(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function mi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(Eo(r)-e)-Math.abs(Eo(n)-e));return o.slice(0,Math.min(i,o.length))}async function Lo(t,e){var V,I;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await h.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:dn(t),subs:[],gcCards:[],stadiumDef:null};const d={};a.forEach(_=>{_.club_id&&(d[_.club_id]=(d[_.club_id]||0)+1)});const c=((V=Object.entries(d).sort((_,R)=>R[1]-_[1])[0])==null?void 0:V[0])||null,l=c?a.filter(_=>_.club_id===c):[],s=((I=l[0])==null?void 0:I.country_code)||null,f=s?a.filter(_=>_.country_code===s&&_.club_id!==c):[],x=Math.min(l.length,Math.max(2,r+1),16),b=Math.min(f.length,Math.max(0,o),16-x),g=[],p=new Set;mi(l,i,x).forEach(_=>{g.push(_),p.add(_.id)}),mi(f,i,b).forEach(_=>{g.push(_),p.add(_.id)});const u=Math.max(0,16-g.length),y=a.filter(_=>!p.has(_.id));mi(y,i,u).forEach(_=>{g.push(_),p.add(_.id)});const w=Et[t]||Et["4-4-2"],v={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,R,W){var de,ce;return E.add(_.id),{cardId:"ai-"+_.id+"-"+W,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((de=_.clubs)==null?void 0:de.encoded_name)||null,clubLogo:((ce=_.clubs)==null?void 0:ce.logo_url)||null,boost:0,used:!1,_line:R}}for(const _ of["GK","DEF","MIL","ATT"]){const R=g.filter(H=>H.job===_&&!E.has(H.id)),W=g.filter(H=>H.job!==_&&!E.has(H.id)),de=[...R,...W],ce=[];for(let H=0;H<w[_];H++){const pe=de[H];pe&&ce.push(m(pe,_,H))}const j=dt(ce.length);ce.forEach((H,pe)=>{H._col=j[pe]}),v[_]=ce}let A=g.filter(_=>!E.has(_.id));if(A.length<5){const _=a.filter(R=>!E.has(R.id)&&!A.some(W=>W.id===R.id));A=A.concat(mi(_,i,5-A.length))}const $=A.slice(0,5).map((_,R)=>m(_,_.job,100+R)),{data:T}=await h.from("gc_definitions").select("*").eq("is_active",!0),G=[...T||[]].sort(()=>Math.random()-.5).slice(0,3).map((_,R)=>({id:"ai-gc-"+R,gc_type:_.name,name:_.name,icon:"⚡",effect_type:_.effect_type,effect_params:_.effect_params||{}}));let O=null;if(n>0&&c){const{data:_}=await h.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(O={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:v,subs:$,gcCards:G,stadiumDef:O}}function dn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<e[n];c++){const l=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?l:2,note_d:n==="DEF"?l:2,note_m:n==="MIL"?l:2,note_a:n==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const d=dt(a.length);a.forEach((c,l)=>{c._col=d[l]}),i[n]=a}return i}function Sr(t,e,i){var r;Po("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const n=t.querySelector(".opponent-preview-wrap"),a=t.querySelector("#opponent-swipe-zone");if(!n||!a)return;const d=a.clientWidth>=900,c=Math.max(200,a.clientHeight-(d?8:40)),l=Math.max(200,a.clientWidth-(d?8:16)),s=d?null:Math.round(Math.max(44,Math.round(l*.168))*.55);n.innerHTML=Ut(e.aiTeam,e.formation,null,[],l,c,[],s),n.style.cssText=`width:${l}px;height:${c}px;overflow:hidden;flex-shrink:0`;const f=n.querySelector("svg");f&&(f.style.cssText="display:block;width:100%;height:100%",f.setAttribute("preserveAspectRatio",d?"xMidYMid meet":"none"))})),setTimeout(()=>Ar(t,e,i),5e3)}const Ye=t=>an(t);function Ar(t,e,i){const o=e.homeTeam.MIL||[],r=e.aiTeam.MIL||[],n=e.stadiumDef||null,a=e.aiStadiumDef||null,d=vt(o,n)+wt(o),c=vt(r,a)+wt(r),l=d>=c;t.innerHTML=`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <button id="in-down" style="${v(l>=a.length-1)}" ${l>=a.length-1?"disabled":""}>▼</button>
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(A=f.querySelector("#out-up"))==null||A.addEventListener("click",()=>{d>0&&(d--,x())}),($=f.querySelector("#out-down"))==null||$.addEventListener("click",()=>{d<n.length-1&&(d++,x())}),(T=f.querySelector("#in-up"))==null||T.addEventListener("click",()=>{l>0&&(l--,x())}),(P=f.querySelector("#in-down"))==null||P.addEventListener("click",()=>{l<a.length-1&&(l++,x())});const E=(O,V,I,_)=>{const R=f.querySelector("#"+O);if(!R)return;let W=0;R.addEventListener("touchstart",de=>{W=de.touches[0].clientY},{passive:!0}),R.addEventListener("touchend",de=>{const ce=de.changedTouches[0].clientY-W;if(Math.abs(ce)<30)return;const j=V();ce<0&&j<_-1?(I(j+1),x()):ce>0&&j>0&&(I(j-1),x())},{passive:!0})};E("in-panel",()=>l,O=>l=O,a.length),E("out-panel",()=>d,O=>d=O,n.length),(G=f.querySelector("#sub-confirm"))==null||G.addEventListener("click",O=>{if(O.preventDefault(),O.stopPropagation(),s)return;s=!0;const V=n[d],I=a[l];if(!V||!I)return;let _=null,R=-1;for(const[de,ce]of Object.entries(e.homeTeam)){const j=(ce||[]).findIndex(H=>H.cardId===V.cardId);if(j!==-1){_=de,R=j;break}}if(R===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const W={...I,_line:_,_col:V._col||0,used:!1,boost:0};e.homeTeam[_].splice(R,1,W),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:V.name,firstname:V.firstname,note:Pe(V,_),portrait:Bt(V),job:V.job,country_code:V.country_code,rarity:V.rarity,clubName:V.clubName,clubLogo:V.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Pe(I,_),portrait:Bt(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${V.firstname} ${V.name}`}),f.remove(),$r(V,I,()=>Te(t,e,i))})}document.body.appendChild(f),x()}function Fr(t,e,i,o,r){var x,b;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},d=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||a.desc,l=n!=null&&n.image_url?`/icons/${n.image_url}`:null,s=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${nt(d,l,s,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#gc-back"))==null||x.addEventListener("click",()=>f.remove()),(b=f.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{f.remove(),Nr(t,e,i,o,r)})}function gi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let d=[];function c(){var l,s;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(f=>{const x=f._line||f.job||"MIL",b=d.find(p=>p.cardId===f.cardId),g=ze({...f,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:f.boost||0});return`<div class="gc-pick-item" data-cid="${f.cardId}"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${vr[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Pe(r,r._line||r.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const d=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(d){d.boost=(d.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Te(t,e,i)})})}async function _t(t,e,i){var x,b,g,p;Rt(),Ke(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",d=e.isSolo&&((x=e.soloLevelConfig)!=null&&x.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):Un(e.mode,a);if(e.isSolo&&r)try{const{data:u}=await h.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),y=(u==null?void 0:u.unlocked_level)||1;e.soloLevel>=y&&await h.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(u){console.warn("[Solo] Erreur mise à jour progression:",u.message)}const c="00000000-0000-0000-0000-000000000000";let l=null;if(e.isRankedAI)try{const{data:u}=await h.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(u){const y=u.mmr??1e3,w=u.mmr_deviation??350,v=u.mmr_volatility??.06,E=r?1:n?.5:0,m=(u.placement_matches??0)<10,A=qo(y,w,v,y,350,E,m),$=n?null:r?o.profile.id:c;await h.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:A.delta,p_away_delta:0,p_home_new_rd:A.newRd,p_away_new_rd:350,p_home_new_vol:A.newSigma,p_away_new_vol:.06}),l=A.delta}}catch(u){console.warn("[RankedAI] Erreur mise à jour MMR:",u.message)}e.matchId&&await h.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",e.matchId);const s={credits:(o.profile.credits||0)+d,matches_played:(o.profile.matches_played||0)+1};r?s.wins=(o.profile.wins||0)+1:n?s.draws=(o.profile.draws||0)+1:s.losses=(o.profile.losses||0)+1,await h.from("users").update(s).eq("id",o.profile.id),await i.refreshProfile();const f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",f.innerHTML=`
    ...
    </div>`,(S=document.getElementById("pvp-home"))==null||S.addEventListener("click",()=>{try{h.removeChannel(V)}catch{}Ve(t),s?b("mini-league",{openLeagueId:s}):b("home")})}H()}async function Vi(t,e,i=!1){var d,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(d=e==null?void 0:e.state)==null?void 0:d.params)==null?void 0:c.rankedData)||null;await zi(t,e,i?"ranked":"random",async({deckId:l,formation:s,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{await Yr(t,e,l,s,f,x,y||[],g,p,i,a)};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}async function Vr(t,e,i){return Kr(t,e,i)}async function Yr(t,e,i,o,r,n,a=[],d=[],c=null,l=!1,s=null){var O,V;const{state:f,navigate:x,toast:b}=e,g=(s==null?void 0:s.mmr)??((O=f.profile)==null?void 0:O.mmr)??1e3,p=l?Ei(g):null,u=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,v=null,E=null;t.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,v&&(v.unsubscribe(),v=null),E&&(clearInterval(E),E=null);try{await h.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(V=document.getElementById("cancel-mm"))==null||V.addEventListener("click",async()=>{await m(),Ve(t),x("home")});const A=async(I,_)=>{w||(w=!0,v&&(v.unsubscribe(),v=null),E&&(clearInterval(E),E=null),await qt(t,e,I,_,{myGC:a,gcDefs:d,stadiumDef:c,isRanked:l,rankedData:s,onMatchEnd:l?Wr:null}))},$=f.user.id,{data:T,error:P}=l?await h.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await h.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(T!=null&&T.success)){console.error("[Matchmaking] try_matchmake error:",P||T),b("Erreur de matchmaking","error"),Ve(t),x("home");return}if(T.matched){await A(T.match_id,!1);return}const G=async()=>{if(w)return;const{data:I}=await h.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await A(I.match_id,!0)};v=h.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&A(_.match_id,!0)}).subscribe(),E=setInterval(G,3e3),l?setTimeout(async()=>{if(!w){w=!0,v&&(v.unsubscribe(),v=null),E&&(clearInterval(E),E=null);try{await h.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),x("match",{matchMode:"ranked_ai",rankedData:s,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:d,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function Wr(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:d,awayScore:c,matchId:l}=t,s=i.user.id,f=n===s,x=r===s,{data:b}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",s).single(),{data:g}=await h.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:n).single();if(b&&g){const p=qo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,x?1:0);await h.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?h.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:h.sql`mmr_losses + 1`}).eq("id",s),o(x?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,x?"success":"error",4e3)}}const Xr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Vi,resumePvpMatch:Vr},Symbol.toStringTag,{value:"Module"}));async function Jr(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,d=n.friendName||"Ami",c=!!n.isAccepting;await zi(t,e,"friend",async({deckId:l,formation:s,starters:f,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const w=y||[];c?await Zr(t,e,l,w,g,p):await Qr(t,e,l,w,g,p,a,d)};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}async function Qr(t,e,i,o,r,n,a,d){var w;const{state:c,navigate:l,toast:s}=e,f=c.user.id,{data:x,error:b}=await h.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!x){console.error("[Friend] Erreur création invitation:",b),s("Impossible de créer l'invitation","error"),l("home");return}t.innerHTML=`
    ...
    </div>`;let g=!1,p=null;const u=async()=>{p&&(p.unsubscribe(),p=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await u(),await h.from("friend_match_invites").update({status:"declined"}).eq("id",x.id),Ve(t),l("home")}),p=h.channel(`friend_invite_${x.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${x.id}`},async({new:v})=>{g||v.status!=="accepted"||!v.match_id||(g=!0,await u(),await qt(t,e,v.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))}).subscribe();const y=setInterval(async()=>{if(g)return;const{data:v}=await h.from("friend_match_invites").select("status, match_id").eq("id",x.id).single();(v==null?void 0:v.status)==="accepted"&&v.match_id&&(g=!0,clearInterval(y),await u(),await qt(t,e,v.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))},3e3);setTimeout(async()=>{g||(clearInterval(y),await u(),s("Invitation expirée","info"),l("home"))},12e4)}async function Zr(t,e,i,o,r,n){const{state:a,navigate:d,toast:c}=e,l=a.user.id,{data:s}=await h.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",l).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!s){c("Aucune invitation en attente","error"),d("home");return}const{data:f,error:x}=await h.rpc("accept_friend_invite",{p_invite_id:s.id,p_invitee_deck_id:i});if(x||!(f!=null&&f.success)){console.error("[Friend] Erreur accept_friend_invite:",x||f),c((f==null?void 0:f.error)||"Impossible de rejoindre le match","error"),d("home");return}await qt(t,e,f.match_id,!1,{myGC:o,gcDefs:r,stadiumDef:n})}const un="#1A6B3C",pt="#D4A017",Zt="var(--tile-bg)",ei="var(--tile-border)",At="var(--divider)",Ze="var(--tile-fg-on-page)",St="var(--tile-fg-dim)",it="var(--tile-fg-faint)",ii="var(--nav-fg,#fff)",fn="rgba(255,255,255,0.62)",ea="rgba(255,255,255,0.4)";async function ta(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ft(t,e,i);return}await ot(t,e)}async function ot(t,e,i="waiting"){var v,E;const{state:o}=e,r=o.profile.id,{data:n}=await h.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(n||[]).map(m=>m.league_id),d={};(n||[]).forEach(m=>{d[m.league_id]={amount:m.prize_amount,claimed:m.prize_claimed}});const{data:c,error:l}=await h.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),s=l?(await h.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:c||[],x=(a.length?await h.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],b=x.filter(m=>m.status==="waiting"&&!m.is_archived),g=x.filter(m=>m.status==="active"&&!m.is_archived),p=x.filter(m=>m.is_archived||m.status==="finished");let u=p;if(p.length){const{data:m}=await h.from("mini_league_matches").select("league_id").in("league_id",p.map($=>$.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),A=new Set((m||[]).map($=>$.league_id));u=p.filter($=>A.has($.id))}const y=s.filter(m=>!a.includes(m.id)),w=[{key:"waiting",label:"🟡 En attente",count:b.length+y.length},{key:"active",label:"🟢 En cours",count:g.length},{key:"archived",label:"📁 Archivées",count:u.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var g,p,u,y;const{toast:o}=e,r=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,d=((g=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:g.value)||"public",c=((p=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:p.value)||"aller",l=((y=(u=document.getElementById("ml-pwd"))==null?void 0:u.value)==null?void 0:y.trim())||null;if(!r){o("Le nom est obligatoire","error");return}if(a<100){o("Mise minimum : 100 crédits","error");return}if(d==="private"&&!l){o("Mot de passe requis","error");return}const{data:s,error:f}=await h.from("mini_leagues").insert({name:r,creator_id:e.state.profile.id,type:d,password:l,mode:c,max_players:n,entry_fee:a}).select().single();if(f){o("Erreur : "+f.message,"error");return}const{data:x}=await h.from("users").select("credits").eq("id",e.state.profile.id).single();if(((x==null?void 0:x.credits)||0)<a){await h.from("mini_leagues").delete().eq("id",s.id),o(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await h.from("users").update({credits:x.credits-a}).eq("id",e.state.profile.id),await h.from("mini_leagues").update({pot:a}).eq("id",s.id),await h.from("mini_league_members").insert({league_id:s.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=x.credits-a);const b=document.getElementById("nav-credits");b&&(b.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,s.id)})}function aa(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function mn(t,e,i,o){var f;const{toast:r,state:n}=e,a=n.profile.id;let d=null;if(o==="private"&&(d=await aa(),d===null))return;const{data:c,error:l}=await h.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:d});if(l||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",l||c),r((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:x}=await h.from("users").select("credits").eq("id",a).single();n.profile&&x&&(n.profile.credits=x.credits)}const s=document.getElementById("nav-credits");s&&(s.textContent=`💰 ${(((f=n.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function sa(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(x=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(b),b.querySelector("#lv-ok").onclick=()=>{b.remove(),x(!0)},b.querySelector("#lv-cancel").onclick=()=>{b.remove(),x(!1)}}))return;const{data:c,error:l}=await h.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(l||!(c!=null&&c.success)){r((c==null?void 0:c.error)||"Erreur lors de la désinscription","error");return}const s=c.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+s);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${s.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Yi(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await h.from("mini_league_matches").delete().eq("league_id",i),await h.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await h.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,r)}async function la(t,e,i){await h.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,m,A,$,T,P,G,O,V;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:d},{data:c}]=await Promise.all([h.from("mini_leagues").select("*").eq("id",i).single(),h.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),h.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await ot(t,e);return}const l=(d||[]).some(I=>I.user_id===n),s=a.creator_id===n,f=(d||[]).map(I=>I.user).filter(Boolean),x=fa(f,c||[]),b=(c||[]).filter(I=>I.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,u=b.length>0&&b.every(I=>I.status==="finished"||I.status==="bye"),y=a.current_day>=a.total_days,w=(d||[]).find(I=>I.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${At};display:flex;align-items:center;gap:10px">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:11px;color:${fn}">${a.mode==="aller-retour"?"Aller-Retour":"Aller"} · max ${a.max_players} · 💰 ${p} cr./joueur</div>
      </div>
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${s&&u&&!y?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
      </div>`:""}
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(I,_)=>_+1).reverse().map(I=>{const _=(c||[]).filter(R=>R.matchday===I);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${I}</div>${_.map(R=>So(R,f,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`}async function da(t,e,i,o){const{toast:r,state:n}=e,a=ua(o.map(l=>l.id),i.mode),d=[];a.forEach((l,s)=>l.forEach(f=>d.push({league_id:i.id,matchday:s+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:c}=await h.from("mini_league_matches").insert(d);if(c){r("Erreur calendrier : "+c.message,"error");return}await h.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ft(t,e,i.id)}async function ca(t,e,i){const{data:o}=await h.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(o.current_day||0)+1;if(r>(o.total_days||0)){ft(t,e,i);return}await h.from("mini_leagues").update({current_day:r}).eq("id",i),e.toast(`Journée ${r} commencée !`,"success"),ft(t,e,i)}async function pa(t,e,i,o,r){var x,b;const{state:n,toast:a}=e,d=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],c=["🥇","🥈","🥉"][r],l=o.prize_amount||d[r]||0,s=o.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    </div>`,document.body.appendChild(f),(x=f.querySelector("#prize-close"))==null||x.addEventListener("click",()=>f.remove()),(b=f.querySelector("#claim-prize-btn"))==null||b.addEventListener("click",async g=>{const p=g.currentTarget;p.disabled=!0,p.textContent="...";const{data:u,error:y}=await h.rpc("claim_mini_league_prize",{p_league_id:i.id,p_user_id:n.profile.id});if(y||!(u!=null&&u.success)){console.error("[MiniLeague] claim_mini_league_prize:",y||u),a((u==null?void 0:u.error)||"Erreur lors de la récupération","error"),p.disabled=!1,p.textContent=`💰 Récupérer ${l.toLocaleString("fr")} cr.`;return}if(u.already_claimed)a("Déjà récupéré précédemment","info");else{const w=(n.profile.credits||0)+u.prize;n.profile&&(n.profile.credits=w);const v=document.getElementById("nav-credits");v&&(v.textContent=`💰 ${w.toLocaleString("fr")}`),a(`💰 +${u.prize.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success")}f.remove(),ft(t,e,i.id)})}function ua(t,e){const o=t.length%2===0?[...t]:[...t,null],r=o.length;let n=o.slice(1);const a=[];for(let d=0;d<r-1;d++){const c=[],l=[o[0],...n];for(let s=0;s<r/2;s++){const f=l[s],x=l[r-1-s];f===null?c.push({bye:x}):x===null?c.push({bye:f}):c.push({home:f,away:x})}a.push(c),n=[n[n.length-1],...n.slice(0,-1)]}return e==="aller-retour"?[...a,...a.map(d=>d.map(c=>c.bye?c:{home:c.away,away:c.home}))]:a}function fa(t,e){const i={};return t.forEach(o=>{i[o.id]={userId:o.id,pseudo:o.pseudo,clubName:o.club_name||o.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),e.filter(o=>o.status==="finished"&&!o.is_bye&&o.home_score!=null).forEach(o=>{const r=i[o.home_id],n=i[o.away_id];!r||!n||(r.played++,n.played++,r.goalsFor+=o.home_score,r.goalsAgainst+=o.away_score,n.goalsFor+=o.away_score,n.goalsAgainst+=o.home_score,o.home_score>o.away_score?(r.won++,r.points+=3,n.lost++):o.home_score<o.away_score?(n.won++,n.points+=3,r.lost++):(r.drawn++,r.points++,n.drawn++,n.points++),r.goalDiff=r.goalsFor-r.goalsAgainst,n.goalDiff=n.goalsFor-n.goalsAgainst)}),Object.values(i).sort((o,r)=>r.points-o.points||r.goalDiff-o.goalDiff||r.goalsFor-o.goalsFor)}async function Ao(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.leagueId||null,d=n.mlMatchId||null,c=i.user.id;if(!d||!a){r("Match introuvable","error"),o("mini-league");return}const{data:l,error:s}=await h.from("mini_league_matches").select("id, league_id, home_id, away_id, status, match_id").eq("id",d).single();if(s||!l){r("Match introuvable","error"),o("mini-league",{openLeagueId:a});return}if(l.home_id!==c&&l.away_id!==c){r("Vous ne faites pas partie de ce match","error"),o("mini-league",{openLeagueId:a});return}const f=l.home_id===c;if(l.match_id){await qt(t,e,l.match_id,f,{mlLeagueId:a,mlMatchId:d});return}await zi(t,e,"mini_league",async({deckId:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const{data:w,error:v}=await h.rpc("start_mini_league_match",{p_ml_match_id:d,p_user_id:c,p_deck_id:x});if(v||!(w!=null&&w.success)){console.error("[MiniLeague] start_mini_league_match error:",v||w),r((w==null?void 0:w.error)||"Impossible de lancer le match","error"),o("mini-league",{openLeagueId:a});return}if(w.matched){await qt(t,e,w.match_id,f,{mlLeagueId:a,mlMatchId:d,myGC:y||[],gcDefs:g,stadiumDef:p});return}await ma(t,e,{mlMatchId:d,leagueId:a,amIHome:f,chosenGC:y,gcDefs:g,stadiumDef:p})};if(!(b!=null&&b.length)){await u([]);return}Si(t,b,u)})}function ma(t,e,{mlMatchId:i,leagueId:o,amIHome:r,chosenGC:n,gcDefs:a,stadiumDef:d}){return new Promise(c=>{var p;const{navigate:l}=e;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#0a1a2e,#0d3d1e);color:#fff;padding:32px;text-align:center;gap:20px">
      <div style="font-size:36px">🏆</div>
    ...
    </div>`;let s=!1;const f=async u=>{if(!s){if(s=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}u&&await qt(t,e,u,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:d}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(s=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}l("mini-league",{openLeagueId:o}),c()});const x=async()=>{if(s)return;const{data:u}=await h.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},b=h.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&f(u.new.match_id)}).subscribe(),g=setInterval(x,3e3);x()})}const ga="/",ba=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function xa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var s,f,x;const d=e[o],c=o===e.length-1,l=Math.round((o+1)/e.length*100);r.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${d.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${ga}icons/${d.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `,r.querySelectorAll("ul,ol").forEach(b=>{b.style.paddingLeft="20px",b.style.marginTop="6px",b.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(b=>{b.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(b=>{b.style.marginBottom="8px"}),(s=r.querySelector("#tuto-prev"))==null||s.addEventListener("click",()=>{o--,n()}),(f=r.querySelector("#tuto-next"))==null||f.addEventListener("click",()=>{c?a():(o++,n())}),(x=r.querySelector("#tuto-skip"))==null||x.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),t!=null&&t.id&&await h.from("users").update({tutorial_done:!0}).eq("id",t.id),i==null||i()};document.body.appendChild(r),n()}async function zo(t,e,i){if(!t||t.tutorial_done)return;let o=[];const{data:r,error:n}=await h.rpc("get_tutorial_steps");if(!n&&(r==null?void 0:r.length)>0)o=r,console.log(`[Tutorial] RPC OK → ${o.length} étapes`);else{const{data:d,error:c}=await h.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!c&&(d==null?void 0:d.length)>0?(o=d,console.log(`[Tutorial] Direct OK → ${o.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${n==null?void 0:n.message}, Direct: ${c==null?void 0:c.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=o.length>0?o.map(d=>({emoji:d.emoji,title:d.title,color:d.color,content:d.content,image_url:d.image_url||null})):ba;xa(t,a,()=>e("boosters"))}const Mo={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function bi(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function ya(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await ro(t,e)}async function ro(t,e){const{state:i,toast:o}=e,{data:r}=await h.from("market_listings").select(`id, price, status, listed_at, seller_id,
      ...
      card:cards(id, card_type, current_note, evolution_bonus,
        player:players(id, firstname, surname_real, country_code, job, job2,
          ...
          clubs(encoded_name, logo_url, logo_url)))`).eq("status","active").order("listed_at",{ascending:!1}).limit(100),{data:n}=await h.from("market_listings").select(`id, price, status, listed_at, sold_at, seller_id, buyer_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let c="buy";const l=()=>{var p,u,y,w,v,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((y=document.getElementById("flt-country"))==null?void 0:y.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((v=document.getElementById("flt-rarity"))==null?void 0:v.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function s(p){const u=l();return p.filter(y=>{var P,G,O;const w=(P=y.card)==null?void 0:P.player;if(!w)return!1;const v=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((G=w.clubs)==null?void 0:G.encoded_name)||"").toLowerCase(),m=(w.country_code||"").toLowerCase(),A=((O=y.card)==null?void 0:O.evolution_bonus)||0,$=bi(w,w.job,A),T=w.job2?bi(w,w.job2,A):0;return!(u.name&&!v.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!m.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&$<u.note1||u.note2&&T<u.note2)})}function f(p){var E,m,A;const u=(E=p.card)==null?void 0:E.player;if(!u)return"";const y=((m=p.card)==null?void 0:m.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function x(p){var G,O,V,I;const u=(G=p.card)==null?void 0:G.player;if(!u)return"";const y=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=bi(u,u.job,y),v=u.job2?bi(u,u.job2,y):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,A=Mo[u.job]||"#bbb",$=u.job2?Mo[u.job2]||"#bbb":null,T=u.job==="GK"?"#fff":A,P=u.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ...
      <div style="display:flex;gap:4px;flex-shrink:0">
        ...
        ${v?`<div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${$};display:flex;align-items:center;justify-content:center">
          <span style="font-size:14px;font-weight:900;color:${P};font-family:Arial Black,Arial">${v}</span>
        </div>`:""}
      </div>
      <div style="flex:1;min-width:0">
    ...
    </div>`}function b(){const p=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(p){if(u.style.display=c==="buy"?"flex":"none",c==="buy"){const y=s(a);p.innerHTML=y.length?`<div class="mkt-buy-grid">${y.map(f).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const y=d.filter(v=>v.status==="active").sort((v,E)=>new Date(E.listed_at)-new Date(v.listed_at)),w=d.filter(v=>v.status==="sold").sort((v,E)=>new Date(E.sold_at||E.listed_at)-new Date(v.sold_at||v.listed_at));p.innerHTML=(y.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${y.length})</div>`+y.map(x).join(""):"")+(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${w.length})</div>`+w.map(x).join(""):"")+(!y.length&&!w.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(y=>y.addEventListener("click",()=>ha(y.dataset.buy,a,t,e))),p.querySelectorAll("[data-cancel]").forEach(y=>y.addEventListener("click",()=>wa(y.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{c=p.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(u=>{const y=u===p;u.style.background=y?"var(--green)":"var(--tile-bg)",u.style.color=y?"#fff":"var(--tile-fg-dim)",u.style.borderColor=y?"var(--green)":"var(--tile-border)"}),b()})});let g;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var u;(u=document.getElementById(p))==null||u.addEventListener("input",()=>{clearTimeout(g),g=setTimeout(b,250)})}),b()}async function ha(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,d=e.find(s=>s.id===t);if(!d)return;const c=d.price;if((r.profile.credits||0)<c){n("Crédits insuffisants","error");return}va(d,async()=>{const{error:s}=await h.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:r.profile.id});if(s){n("Erreur achat : "+s.message,"error");return}await a();const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await ro(i,o)})}function va(t,e){var a;const i=(a=t.card)==null?void 0:a.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
    ...
    </div>`,document.body.appendChild(r);const n=d=>{r.remove(),d&&e()};r.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),r.addEventListener("click",d=>{d.target===r&&n(!1)})}async function wa(t,e,i){const{toast:o}=i,{data:r}=await h.from("market_listings").select("card_id").eq("id",t).single();if(await h.from("market_listings").update({status:"cancelled"}).eq("id",t),r!=null&&r.card_id){const{count:n}=await h.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");n||await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}o("Annonce retirée","success"),ro(e,i)}async function _a(t,e){var b,g,p,u,y;const{state:i,navigate:o}=e,r=((g=(b=e==null?void 0:e.state)==null?void 0:b.params)==null?void 0:g.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:a},{data:d}]=await Promise.all([h.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").order("mmr",{ascending:!1}).limit(100),h.rpc("get_mini_league_leaderboard"),h.rpc("get_random_leaderboard")]);let c=r;const l=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",s=w=>w<3?"#000":"#fff";function f(){var E,m,A;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=c==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const v=document.getElementById("rankings-list");if(v){if(c==="ranked"){const $=n||[];v.innerHTML=$.length>0?$.map((T,P)=>{const G=Ei(T.mmr??1e3),O=(T.ranked_wins||0)+(T.ranked_losses||0)+(T.ranked_draws||0),V=O>0?Math.round((T.ranked_wins||0)/O*100):0,I=T.id===i.profile.id,_=(T.placement_matches||0)<10;return`
          ...
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(c==="mini-league"){const $=a||[];v.innerHTML=$.length>0?$.map((T,P)=>`
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const $=d||[];v.innerHTML=$.length>0?$.map((T,P)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${T.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${l(P)};color:${s(P)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${P<3?"16":"13"}px">${P<3?["🥇","🥈","🥉"][P]:P+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${T.pseudo}</div>
  ...
  <div class="page">
  ...
  </div>`,f(),(p=document.getElementById("tab-ranked"))==null||p.addEventListener("click",()=>{c="ranked",f()}),(u=document.getElementById("tab-mini-league"))==null||u.addEventListener("click",()=>{c="mini-league",f()}),(y=document.getElementById("tab-random"))==null||y.addEventListener("click",()=>{c="random",f()})}async function ka(t,e){var A,$,T,P;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:d}]=await Promise.all([h.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),h.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!d){r("Erreur chargement profil","error"),o("home");return}if(!a){t.innerHTML=`
    ...
    </div>`,(A=document.getElementById("ranked-back"))==null||A.addEventListener("click",()=>o("home"));return}const c=d.mmr??1e3,l=d.mmr_deviation??350,s=d.mmr_volatility??.06,f=d.placement_matches??0,x=f<10,b=Math.max(0,10-f),g=Ei(c),p=Bo(c),u=Bi.findIndex(G=>G.id===g.id),y=Bi[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},v=(d.ranked_wins||0)+(d.ranked_losses||0)+(d.ranked_draws||0),E=v>0?Math.round((d.ranked_wins||0)/v*100):0,m=Bi.map(G=>`
  ...
  </div>`,($=document.getElementById("ranked-back"))==null||$.addEventListener("click",()=>o("home")),(T=document.getElementById("ranked-leaderboard-btn"))==null||T.addEventListener("click",()=>o("rankings",{tab:"ranked"})),(P=document.getElementById("ranked-play-btn"))==null||P.addEventListener("click",()=>{mt(),o("match",{matchMode:"ranked",rankedData:{mmr:c,rd:l,sigma:s,isPlacement:x}})})}async function $a(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await h.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${r.id},away_id.eq.${r.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},d=(n||[]).filter(s=>s.status==="finished"),c=(n||[]).filter(s=>s.status==="in_progress");function l(s){const f=s.home_id===r.id;f?s.home_score:s.away_score,f?s.away_score:s.home_score;const x=s.winner_id===r.id,b=s.home_score===s.away_score&&s.status==="finished",g=s.status!=="finished"?"…":b?"N":x?"V":"D",p=s.status!=="finished"||b?"#888":x?"#1A6B3C":"#c0392b";let u=a[s.mode]||s.mode;s.away_id===null&&!u.startsWith("IA")&&(u="IA");const w=s.home_id===r.id?s.away:s.home;let v;s.away_id===null?v=u:w?v=`${w.club_name||w.pseudo} (${w.pseudo})`:v="Adversaire";let E="";s.status==="in_progress"&&Date.now()-new Date(s.created_at).getTime()>3600*1e3&&(E=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const m=new Date(s.created_at),A=m.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+m.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),$=s.status==="finished"?`${s.home_score} - ${s.away_score}`:`${s.home_score||0} - ${s.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
        <div style="font-size:13px;font-weight:600">${v}${E}</div>
        <div style="font-size:11px;color:var(--gray-600)">${u} · ${A}${s.status==="in_progress"?" · en cours":""}</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
  ...
  </div>`}hn(wn);const ve={user:null,profile:null,page:"home",params:{}};function It(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ea(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Wi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!ve.user)return;const{data:t}=await h.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const gn="mw_theme";function oi(){return localStorage.getItem(gn)||"club"}function Co(t){var e;localStorage.setItem(gn,t),xi(t),(e=ve.profile)!=null&&e.id&&h.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function xi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function zt(t,e={}){ve.page=t,ve.params=e,bn()}async function bn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:zt,toast:It,openModal:Ea,closeModal:Wi,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await qi(t,i);break;case"home2":await qi(t,i);break;case"game":await Hn(t,i);break;case"settings":await Vo(t,i);break;case"collection":await Jn(t,i);break;case"decks":await Gi(t,i);break;case"boosters":await cr(t,i);break;case"ranked":await ka(t,i);break;case"match":{const d=ve.params&&ve.params.matchMode||"vs_ai_easy";d==="random"?await Vi(t,i,!1):d==="ranked"?await Vi(t,i,!0):d==="friend"?await Jr(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):d==="mini_league"||d==="mini-league"?await Ao(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await Er(t,i);break}case"market":await ya(t,i);break;case"rankings":await _a(t,i);break;case"matches":await $a(t,i);break;case"friends":await Nn(t,i);break;case"mini-league":await ta(t,i);break;case"match-mini-league":{const d=ve.params||{};await Ao(t,i,d.mlMatchId,d.leagueId);break}default:await qi(t,i)}}function La(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.29-1004" style="cursor:pointer">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Sa(){xi(oi()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Wi()}),document.getElementById("modal-close").addEventListener("click",Wi);const{data:{session:t}}=await h.auth.getSession();if(!t){jo(),Ta(document.getElementById("app"),{onPlay:()=>mo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:It})});return}ve.user=t.user,await ti(),xi(oi()),jo();try{const{data:i}=await h.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(r=>{o[r.formation]=r.links}),vn(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){kn(document.getElementById("app"),{state:ve,navigate:async()=>{await ti(),xi(oi()),Pi()},toast:It,refreshProfile:ti});return}const e=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&e.length>0){yr(document.getElementById("app"),{state:ve,toast:It,refreshProfile:ti,navigate:()=>{Pi(),setTimeout(()=>zo(ve.profile,zt,It),800)}});return}Pi(),setTimeout(()=>zo(ve.profile,zt,It),800),h.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",mo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:It}))})}function Aa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Mi(){const t=document.getElementById("app");t&&(t.style.height=Aa()+"px")}window.addEventListener("resize",Mi);window.addEventListener("orientationchange",()=>setTimeout(Mi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Mi);function Pi(){const t=()=>{var i;(i=ve.user)!=null&&i.id&&h.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Mi(),La(),bn()}function jo(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function xn(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
