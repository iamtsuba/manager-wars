...
import{s as v,n as Kt,o as Fi,F as Pi,l as zt,k as Qt,r as Se,j as At,p as Li,h as Gi,q as Wn,t as Xn,T as vi,m as Jn,u as Qn,b as Zn}from"./special-cards-DGU8wjVP.js";const eo="/";function tn(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,f;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var y;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((y=document.getElementById("setup-club"))==null?void 0:y.value)||"MW",x=f.trim().split(" ").filter(Boolean),g=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=g,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),x=document.getElementById("step3-finish");f.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await io(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){f.textContent=g.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function io(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const no="modulepreload",oo=function(e){return"/"+e},nn={},bn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=oo(d),d in nn)return;nn[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":no,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((x,g)=>{f.addEventListener("load",x),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Zt="#1A6B3C",ei="#cc2222",ro="#D4A017",on="#888";async function ao(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${x.map(({friendshipId:g,friend:y})=>so(y,g)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>co(e,g.dataset.stats,g.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const y=g.dataset.friendId,p=g.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:b}=await v.from("friend_match_invites").select("id").eq("inviter_id",y).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),_=!!b;console.log("[Friends] clic match",{fid:y,fname:p,isAccepting:_}),n("match",{matchMode:"friend",friendId:y,friendName:p,isAccepting:_})})})}function so(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||Zt,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    </div>`}function lo(e,t){const i=Ni();i.innerHTML=`
    <div class="popup-box">
    ...
    ${Ri()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",E=>{E.target===h&&h.remove()})}function Ni(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function Ri(){return`
    <style>
      .popup-box {
    ...
    </style>`}const po="2026.07.21-1219";async function rn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Se(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),x=(s||[]).filter($=>$.card_type==="stadium"),{data:g}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),y={};(g||[]).forEach($=>{y[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),x.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const b=Object.keys(Pi),_=Object.keys(je),h={};c.forEach($=>{const N=$.player.id;h[N]=(h[N]||0)+1}),new Set(Object.keys(h).map($=>String($)));const E=new Set(f.map($=>$.formation)),m=new Set(l.map($=>$.gc_type));let M="player",k="Tous",z="",q=!1;function te(){return[...c].sort(($,N)=>{const V=ri.indexOf($.player.job),U=ri.indexOf(N.player.job);return V!==U?V-U:($.player.surname_real||"").localeCompare(N.player.surname_real||"")})}function ie(){return[...d||[]].sort(($,N)=>{const V=ri.indexOf($.job),U=ri.indexOf(N.job);return V!==U?V-U:($.surname_real||"").localeCompare(N.surname_real||"")})}function ee(){return te().filter($=>{const N=$.player,V=k==="Tous"||N.job===k,U=!z||`${N.firstname} ${N.surname_real}`.toLowerCase().includes(z);return V&&U})}function j(){return ie().filter($=>{const N=k==="Tous"||$.job===k,V=!z||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(z);return N&&V})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(N){const V=document.getElementById(N);if(!V)return;V.addEventListener("wheel",ce=>{Math.abs(ce.deltaY)<=Math.abs(ce.deltaX)||(ce.preventDefault(),V.scrollLeft+=ce.deltaY)},{passive:!1});let U=!1,re=0,B=0,R=!1,ue=!1;V.addEventListener("mousedown",ce=>{U=!0,R=!1,re=ce.pageX,B=V.scrollLeft}),window.addEventListener("mouseup",()=>{U=!1,R&&(V.style.cursor="",ue=!0),R=!1}),window.addEventListener("mousemove",ce=>{if(!U)return;const _e=ce.pageX-re;!R&&Math.abs(_e)<6||(R=!0,V.style.cursor="grabbing",ce.preventDefault(),V.scrollLeft=B-_e)}),V.addEventListener("click",ce=>{ue&&(ce.stopPropagation(),ce.preventDefault(),ue=!1)},!0)}("col-grid");function I(){const $=document.getElementById("col-filters");$&&(M==="player"?($.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",N=>{z=N.target.value.toLowerCase(),K()}),e.querySelectorAll(".filter-btn").forEach(N=>{N.addEventListener("click",()=>{k=N.dataset.job,I(),K()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{q=!q,I(),K()})):($.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{q=!q,I(),K()})))}function K(){const $=document.getElementById("col-grid");$&&(M==="player"?Y($):M==="formation"?pe($):M==="stadium"?H($):G($))}function X($,N,V,U,re,B=0){const R=document.getElementById("col-grid"),ue=document.getElementById("col-big");if(!R||!ue)return;var ce=0;function _e(){var lt;const ze=window.innerWidth>=768,ve=document.getElementById("col-big"),Ie=document.getElementById("col-gap"),Ae=((lt=document.getElementById("col-grid"))==null?void 0:lt.parentElement)||null,Be=ve?ve.closest(".page"):null;if(ve&&Ae&&Be){let $e=0;Array.from(Be.children).forEach(function(A){A!==ve&&A!==Ae&&A!==Ie&&($e+=A.offsetHeight)});const Ce=Math.max(0,Be.clientHeight-$e),qe=Math.round(Ce*(B/100)),Ne=Math.max(0,Ce-qe),w=ze?50/71:45/63,L=Math.round(Ne*w),S=Math.max(0,Ne-L);Ie&&(Ie.style.height=qe+"px"),ve.style.flex="none",ve.style.height=L+"px",ve.style.minHeight="0",Ae.style.flex="none",Ae.style.height=S+"px",Ae.style.minHeight="0",Ae.style.display="flex",Ae.style.overflow="hidden"}const ke=document.getElementById("col-grid");ke&&(ke.style.height="100%",ke.style.flexShrink="0",ke.style.overflowX="auto",ke.style.overflowY="hidden",ke.style.alignItems="center",ke.style.width="100%"),ue.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+N($[ce])+"</div>";var _t=ue.querySelector("[data-card-id],[data-form-id],[data-gc-id]");_t&&_t.addEventListener("click",function(){U($[ce])}),requestAnimationFrame(function(){var $e=document.getElementById("big-card-inner");if(!(!$e||!ue)){var Ce=ue.clientHeight,qe=ue.clientWidth-16,Ne=$e.offsetHeight,w=$e.offsetWidth;if(Ne>0&&w>0&&Ce>40){var L=Math.min(Ce/Ne,qe/w);$e.style.transform="scale("+L.toFixed(3)+")",$e.style.transformOrigin="center center"}}}),R.innerHTML=$.map(function($e,Ce){var qe=Ce===ce,Ne="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Ne+'">'+V($e,qe)+"</div>"}).join(""),R.querySelectorAll(".col-mini-item").forEach(function($e){$e.addEventListener("click",function(){ce=Number($e.dataset.idx),_e(),$e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var $e=ke?ke.clientHeight:0,Ce=R.querySelector(".col-mini-item > div");if(!(!$e||!Ce)){var qe=Ce.style.zoom;Ce.style.zoom="1";var Ne=Ce.offsetHeight;if(Ce.style.zoom=qe,!(Ne<=0)){var w=$e/Ne;R.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=w.toFixed(4)})}}})}_e()}function le($){var N=window.innerWidth>=768?.76:.54,V;if(!$||$._fake){var U=$?$.player:null;if(!U)return"";V=ln(U)}else V=ki($,"");return'<div style="display:inline-block;zoom:'+N+';pointer-events:none;line-height:0">'+V+"</div>"}function fe($,N,V){var U=V>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+V+"</div>":"",re=!!N,B=Li($,At[$],{width:160});return re||(B='<div style="filter:grayscale(1);opacity:0.5">'+B+"</div>"),"<div "+(N?'data-form-id="'+N.id+'"':"")+' style="position:relative;cursor:pointer">'+U+B+"</div>"}function C($,N){var V=window.innerWidth>=768?.76:.54,U=Li($,At[$],{width:140});return N||(U='<div style="filter:grayscale(1);opacity:0.45">'+U+"</div>"),'<div style="display:inline-block;zoom:'+V+';line-height:0;pointer-events:none">'+U+"</div>"}function Y($){if(q){const N=j();if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const V=N.map(U=>c.find(re=>re.player.id===U.id)||{_fake:!0,player:U,id:"fake-"+U.id});X(V,U=>U._fake?ln(U.player):ki(U,""),U=>U._fake?le({player:U.player,id:"x",_fake:!0}):le(U),U=>{U._fake||cn(U,c,h,t)})}else{const N=ee();if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const V={};N.forEach(re=>{const B=re.player.id;V[B]||(V[B]=[]),V[B].push(re)});const U=Object.values(V).map(re=>Lo(re));X(U,re=>{const B=h[re.player.id]||1,R=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",ce=c.filter(_e=>_e.player.id===re.player.id&&_e.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return ki(re,R+ce)},re=>le(re),re=>cn(re,c,h,t))}}function pe($){const N=q?b:[...E];if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const V=N.map(U=>({formation:U,card:f.find(re=>re.formation===U)||null,owned:E.has(U)}));X(V,({formation:U,card:re,owned:B})=>fe(U,B?re:null,B?f.filter(R=>R.formation===U).length:0),({formation:U,owned:re})=>C(U,re),({card:U,owned:re})=>{re&&U&&Mo(U,f,t,o)},"#1A6B3C",5)}function G($){const N=Object.keys(y),V=q?N.length?N:_:[...m];if(!V.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const U=V.map(re=>({type:re,gc:je[re]||{icon:"⚡",desc:""},def:y[re]||null,owned:m.has(re),card:l.find(B=>B.gc_type===re)||null}));X(U,({type:re,gc:B,def:R,owned:ue,card:ce})=>{var ke;const _e=(R==null?void 0:R.name)||re,ze=ue?l.filter(_t=>_t.gc_type===re).length:0,ve=ze>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ze}</div>`:"",Ie=(R==null?void 0:R.effect)||B.desc||"",Ae=R!=null&&R.image_url?`/icons/${R.image_url}`:((ke=R==null?void 0:R.club)==null?void 0:ke.logo_url)||(R!=null&&R.country_code?`https://flagsapi.com/${R.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=zt(_e,Ae,B.icon,Ie,{width:160,onClick:ue});return ue||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${ue&&ce?`data-gc-id="${ce.id}" data-gc-type="${re}"`:""} style="position:relative">${ve}${Be}</div>`},({type:re,gc:B,def:R,owned:ue})=>{const ce=window.innerWidth>=768?.76:.54,_e=(R==null?void 0:R.name)||re,ze=(R==null?void 0:R.effect)||B.desc||"",ve=R!=null&&R.image_url?`/icons/${R.image_url}`:null;let Ie=zt(_e,ve,B.icon,ze,{width:140});return ue||(Ie=`<div style="filter:grayscale(1);opacity:0.45">${Ie}</div>`),`<div style="display:inline-block;zoom:${ce};line-height:0;pointer-events:none">${Ie}</div>`},({type:re,owned:B,def:R})=>{B&&Ao(re,R,o)},"#7a28b8",5)}function H($){const N="#4FC3F7",V="/";if(!x.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const U={};x.forEach(B=>{const R=B.stadium_id||"?";(U[R]=U[R]||[]).push(B)});const re=Object.entries(U).map(([B,R])=>({sid:B,def:u[B]||null,count:R.length,card:R[0]}));X(re,({def:B,count:R})=>{var Ie,Ae;const ue=(B==null?void 0:B.name)||"?",ce=((Ie=B==null?void 0:B.club)==null?void 0:Ie.encoded_name)||(B==null?void 0:B.country_code)||"—",_e=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((Ae=B==null?void 0:B.club)==null?void 0:Ae.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ze=R>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${R}</div>`:"",ve=`${ce}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${ze}${Qt(ue,_e,ve,{width:160})}</div>`},({def:B})=>{var ve,Ie;const R=window.innerWidth>=768?.76:.54,ue=(B==null?void 0:B.name)||"?",ce=((ve=B==null?void 0:B.club)==null?void 0:ve.encoded_name)||(B==null?void 0:B.country_code)||"—",_e=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((Ie=B==null?void 0:B.club)==null?void 0:Ie.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ze=`${ce}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${R};line-height:0;pointer-events:none">${Qt(ue,_e,ze,{width:140})}</div>`},null,N,5)}e.querySelectorAll(".col-tab-btn").forEach($=>{$.addEventListener("click",()=>{M=$.dataset.tab,k="Tous",z="",q=!1,e.querySelectorAll(".col-tab-btn").forEach(N=>{const V=N.dataset.tab===M;N.style.borderBottomColor=V?"var(--green)":"transparent",N.style.color=V?"var(--green)":"var(--tile-fg-dim)"}),I(),K()})}),I(),K()}function Ao(e,t,i){const n=je[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.name)||e,o=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${zt(r,a,n.icon,o,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ai=1e3;function Mo(e,t,i,n){var y,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:d}=i,c=e.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const b=At[c]||{},_=Pi[c]||[],h=290,E=360,m=20;function M(z){const q=b[z];return q?{x:q.x*h,y:q.y*E}:null}let k=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[z,q]of _){const te=M(z),ie=M(q);!te||!ie||(k+=`<line x1="${te.x}" y1="${te.y}" x2="${ie.x}" y2="${ie.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const z of Object.keys(b)){const q=M(z);if(!q)continue;const te=z.replace(/\d+/,""),ie=l[te]||"#555";k+=`<circle cx="${q.x}" cy="${q.y}" r="${m}" fill="${ie}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,k+=`<text x="${q.x}" y="${q.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${te}</text>`}return k+="</svg>",k}const x=t.filter(b=>b.formation===c);x.length;const g=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${f.map((G,H)=>{const $=ee[G.id]||[],N=G.is_for_sale,V=$.length?$[$.length-1]:null,re=(l.rarity==="pepite"||l.rarity==="papyte")&&G.current_note!=null?` (☆${G.current_note})`:"";return`
            <div data-card-id="${G.id}" data-card-idx="${H}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${H+1}${re}${N?" 🏷️ En vente":""}</div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([G,H])=>{const $=_i[G],N=G==="GK"?"#fff":$,V=G===l.job||G===l.job2,U=(Number(H)||0)+(V&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${$};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${N};font-family:Arial Black,Arial;line-height:1">${U}</span>
                </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(fe=document.getElementById("close-detail"))==null||fe.addEventListener("click",s);let K=new Set;const X=()=>{const G=K.size,H=document.getElementById("sell-action-panel");if(!H)return;H.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G;const $=document.getElementById("evolve-btn");$&&($.textContent=`⬆️ Évoluer ${G>1?"(+"+G+")":""}`)};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const H=G.dataset.id;G.checked?K.add(H):K.delete(H);const $=G.closest(".exemplaire-row");$&&($.style.borderColor=G.checked?"#1A6B3C":"#eee"),X()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",H=>{if(H.target.closest("button")||H.target.tagName==="INPUT")return;const $=G.querySelector(".expl-check");$&&!$.disabled&&($.checked=!$.checked,$.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",H=>{H.stopPropagation();const $=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);$&&($.style.display=$.style.display==="none"?"flex":"none")})}),(C=document.getElementById("evolve-btn"))==null||C.addEventListener("click",async()=>{if(x<=1)return;const G=[...K];if(!G.length)return;if(K.has(e.id)){const B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",B.innerHTML=`
        ...
        <div style="background:var(--tile-bg);border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            📈 Note : <strong>${_+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${_+(e.evolution_bonus||0)+H.length*$}</strong>
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${c.map(u=>{const b={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
                ${Se({...b,_evolution_bonus:b._evolution_bonus||0},{width:132,showStad:!0,stadDef:d})}
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:4px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${c.map(u=>{const b={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
                  ${Se({...b,_evolution_bonus:b._evolution_bonus||0},{width:66,showStad:!0,stadDef:d})}
                  <button data-remove-sub="${u.id}"
  ...
  </div>`;const l=window.innerWidth>=900,f=e.querySelector(".deck-pc-layout"),x=e.querySelector(".deck-mobile-layout");f&&(f.style.display=l?"block":"none"),x&&(x.style.display=l?"none":"block"),jo(e,t,r,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const g=()=>{const{openModal:u,closeModal:b}=i,_=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;u("⚽ Choisir une formation",_),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const E=fn(t.formation),m={};E.forEach(M=>{t.slots[M]&&(m[M]=t.slots[M])}),t.slots=m,b(),vt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",g)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Bo(t,e,i))),e.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>Fo(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==u.dataset.removeSub),vt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>Do(t,e,i)))}function jo(e,t,i,n){var h,E,m;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=t.stadiumCards)==null?void 0:h.find(M=>M.id===t.stadiumCardId),s=a&&((E=t.stadDefMap)==null?void 0:E[a.stadium_id])||null,d=At[t.formation]||{},c=Fi(t.formation)||[],l={};for(const M of i){const k=t.slots[M],z=k?t.playerCards.find(q=>q.id===k):null;z!=null&&z.player?l[M]={...z.player,_evolution_bonus:z.evolution_bonus||0,face:z.player.face||null}:l[M]=null}const f=window.innerWidth>=900,x=f?window.innerWidth-280:window.innerWidth-20,g=f?Math.min(x,860):x,y=Math.round(f?g*.82:g*.85),p=f?84:44;let u="";for(const[M,k]of c){const z=d[M],q=d[k];if(!z||!q)continue;const te=z.x*g,ie=Math.round(.03*y+z.y*.85*y),ee=q.x*g,j=Math.round(.03*y+q.y*.85*y),I=l[M],K=l[k],X=Kt(I,K);X==="#ff3333"||X==="#cc2222"?u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${te.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${j.toFixed(1)}" stroke="${X}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const _=Math.round(p*657/507);for(const M of i){const k=d[M];if(!k)continue;const z=l[M],q=k.x*g;k.y*y;const te=Math.round(.03*y+k.y*(.85*y)),ie=Math.round(q-p/2),ee=Math.round(te-_/2);if(z){const j=M.replace(/\d+/,""),I=s&&(s.club_id&&String(z.club_id)===String(s.club_id)||s.country_code&&z.country_code===s.country_code),K=Se({...z,_evolution_bonus:z._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:j}),X=I&&(((m=s.club)==null?void 0:m.logo_url)||s.image_url)||null,le=Math.round(p*.34),fe=I?`<div style="position:absolute;top:2px;right:2px;width:${le}px;height:${le}px;border-radius:50%;background:rgba(0,0,0,0.6);border:1.5px solid #4FC3F7;display:flex;align-items:center;justify-content:center;overflow:hidden;z-index:6">${X?`<img src="${X}" style="width:100%;height:100%;object-fit:cover">`:`<span style="font-size:${Math.round(le*.6)}px;line-height:1">🏟️</span>`}</div>`:"";b+=`<div style="position:absolute;left:${ie}px;top:${ee}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${M}">
        <div style="position:relative">${K}${fe}</div>
      </div>`}else{const j=M.replace(/\d+/,"");b+=`<div style="position:absolute;left:${ie}px;top:${ee}px;width:${p}px;height:${_}px;
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=I=>I.touches&&I.touches[0]?I.touches[0].clientX:I.clientX;function l(I){o||(d=!0,s.style.opacity="1",f(I))}function f(I){if(!d||o)return;const K=a.getBoundingClientRect(),X=c(I)-K.left,le=Math.max(0,Math.min(1,X/K.width));s.style.width=le*K.width+"px",le>=.82&&g()}function x(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var K;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(K=document.getElementById("cut-flash"))==null||K.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const I=document.getElementById("cut-hint");I&&(I.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",f),window.addEventListener("pointerup",x),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",x);let y=0,p=!1;const u=new Set;function b(I){y=I,document.getElementById("reveal-phase").style.display="flex",_(),h(I,0),z()}function _(){const I=document.getElementById("card-dots");I&&(I.innerHTML=e.map((K,X)=>`<div class="card-dot" data-i="${X}" style="width:8px;height:8px;border-radius:50%;background:${X===y?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),I.querySelectorAll(".card-dot").forEach(K=>K.addEventListener("click",()=>m(parseInt(K.dataset.i)))))}function h(I,K){var $,N;const X=e[I],le=document.getElementById("card-counter"),fe=document.getElementById("card-track");le&&(le.textContent=`Carte ${I+1} / ${e.length}`);const C=document.getElementById("reveal-btns");C&&(C.style.display=I===e.length-1?"flex":"none");const Y=X.card_type==="player"&&(($=X.player)==null?void 0:$.rarity)==="legende",pe=!u.has(I);u.add(I);let G=0;if(X.card_type==="player"&&X.player){const V=X.player,U=V.job||"ATT";G=Number(U==="GK"?V.note_g:U==="DEF"?V.note_d:U==="MIL"?V.note_m:V.note_a)||0}const H=V=>{fe.innerHTML=`
        ...
        </div>`;const U=document.getElementById("current-card-wrap");K!==0?(U.style.transition="none",U.style.transform=`translateX(${K>0?100:-100}%)`,requestAnimationFrame(()=>{U.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",U.style.transform="translateX(0)"})):U.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),V||Y?te():ie(),_()};pe&&(((N=X.player)==null?void 0:N.rarity)==="legende"||G>=8)&&X.card_type==="player"&&X.player?E(X,()=>H(!0)):H(!1)}function E(I,K){var ze;p=!0;const X=I.player,le=`https://flagsapi.com/${X.country_code}/flat/64.png`,fe=(ze=X.clubs)==null?void 0:ze.logo_url,C=X.face?"/"+X.face.replace(/^public\//,"").replace(/^\//,""):null,Y=X.job||"ATT",pe=Number(Y==="GK"?X.note_g:Y==="DEF"?X.note_d:Y==="MIL"?X.note_m:X.note_a)||0,G=I.evolution_bonus||0,H=pe+G,$=X.rarity==="legende",N=H>=18,V=document.getElementById("walkout-overlay"),U=document.getElementById("walkout-stage");if(!V||!U){p=!1,K();return}let re=null;$&&(re=bo("/sounds/Legendary.mp3",.8)),V.style.display="flex";const B=()=>{const ve=U.firstElementChild;ve&&(ve.classList.remove("wo-in"),ve.classList.add("wo-out"))},R=1800,ue=400;U.innerHTML=`<img class="wo-in" src="${le}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(B,R),setTimeout(()=>{var ve;U.innerHTML=fe?`<img class="wo-in" src="${fe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ve=X.clubs)==null?void 0:ve.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},R+ue),setTimeout(B,R*2+ue),setTimeout(()=>{U.innerHTML=C?`<img class="wo-in" src="${C}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(R+ue)*2),setTimeout(B,(R+ue)*2+R);const _e=N?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[Y]||"#fff";setTimeout(()=>{U.innerHTML=`<div class="wo-in" style="
        font-size:${N?"120px":"90px"};font-weight:900;color:${_e};
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function Xo(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const n=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(n),t.remove(),e(!0))},1e3)})}async function Jo(e,{state:t,navigate:i,toast:n,refreshProfile:r}){var x,g;const{data:o}=await v.from("users").select("*").eq("id",t.user.id).single();o&&(t.profile=o);let a=Array.isArray((x=t.profile)==null?void 0:x.pending_boosters)?[...t.profile.pending_boosters]:[];if(!a.length){await v.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let s=null;try{const p=(await In()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(s=zn(p))}catch(y){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',y)}const d=a.length;let c=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",t.user.id)};async function f(){var _;if(c>=d||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",t.user.id),r&&await r(),n("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const y=a[0],{data:p}=await v.from("users").select("*").eq("id",t.user.id).single();p&&(t.profile=p);let u=[];try{if(y.type==="formation")u=await Cn(t.profile,0);else if(y.type==="game_changer")u=await Mn(t.profile,y.count||3,0);else if(s&&((_=s.rates)!=null&&_.length)){const h={...s,cost:0,cardCount:y.count||s.cardCount||5};u=await Ai(t.profile,h),y.guaranteeGK&&!t.profile.first_booster_opened&&(u.some(m=>m.player&&m.player.job==="GK")||await Qo(t.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",t.profile.id))}else u=await An(t.profile,y.count||5,0)}catch(h){n(h.message||"Erreur ouverture booster","error");return}a.shift(),c++,await l();const b=y.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:y.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${c}/${d})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};jn(u,b,i,()=>{f()})}(g=document.getElementById("onboard-start"))==null||g.addEventListener("click",()=>f())}async function Qo(e,t){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const n=i[Math.floor(Math.random()*i.length)],r=t.findIndex(a=>a.player);if(r===-1)return;const o=t[r];await v.from("cards").update({player_id:n.id}).eq("id",o.id),t[r]={...o,player_id:n.id,player:n}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Ot={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Zo={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Tt(e,t,i,n,r){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",r)}function ni(e){if(e!=null&&e.face){const n=(typeof import.meta<"u"?"/":null)||"/",r=e.face.replace(/^public\//,"").replace(/^\//,"");return n+r}const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Mi(e,t){var o,a;const i=e.player,n=e.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?n:0)+(i.job2==="GK"&&r>0?n:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?n:0)+(i.job2==="DEF"&&r>0?n:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?n:0)+(i.job2==="MIL"&&r>0?n:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?n:0)+(i.job2==="ATT"&&r>0?n:0),evolution_bonus:n,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((o=i.clubs)==null?void 0:o.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function oi(e,t){if(!t||!e)return e;const{club_id:i,country_code:n}=t;return Object.values(e).forEach(r=>{Array.isArray(r)&&r.forEach(o=>{const a=i&&String(o.club_id)===String(i),s=n&&String(o.country_code)===String(n);(a||s)&&(o.stadiumBonus=!0)})}),e}function ci(e,t){if(!t||!(e!=null&&e.length))return e;const{club_id:i,country_code:n}=t;return e.forEach(r=>{if(!r)return;const o=i&&String(r.club_id)===String(i),a=n&&String(r.country_code)===String(n);(o||a)&&(r.stadiumBonus=!0)}),e}function gt(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Bn(){const e=Math.random()*100;return e<10?10:e<30?5:3}function pi(e,t){const i=Ot[t]||Ot["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const s=e.filter(c=>c.position&&c.position.replace(/\d+$/,"")===a).sort((c,l)=>parseInt(c.position.replace(/\D+/g,""),10)-parseInt(l.position.replace(/\D+/g,""),10)).map(c=>({...c,_line:a})),d=gt(s.length);s.forEach((c,l)=>{c._col=d[l]}),n[a]=s}return n}const o=[...e];for(const a of["GK","DEF","MIL","ATT"]){const s=[];for(let c=0;c<i[a];c++){let l=o.findIndex(f=>f.job===a);if(l===-1&&(l=o.findIndex(f=>f.job2===a)),l===-1&&(l=0),o[l]){const f={...o[l],_line:a};s.push(f),o.splice(l,1)}}const d=gt(s.length);s.forEach((c,l)=>{c._col=d[l]}),n[a]=s}return n}function at(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function et(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function gi(e,t,i){const r=new Set,o=t.filter(l=>{const f=l.gc_type||l.id;return r.has(f)?!1:(r.add(f),!0)});let a=[];function s(l,f){const x=l._gcDef,g=(x==null?void 0:x.name)||l.gc_type,y=x!=null&&x.image_url?`/icons/${x.image_url}`:null,p=zt(g,y,"⚡",(x==null?void 0:x.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${l.id}"
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
        ...
        stroke="${k}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const y=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),p=Math.round(y*657/507);for(const[b,_]of Object.entries(l)){const h=x(b);if(!h||!_)continue;const E=b.replace(/[0-9]/g,""),m=a.includes(_.cardId),M=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!_.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!_.used,k=n.includes(_.cardId);let z=_.boost||0,q=!1;_.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(z+=10,q=!0):i||(z+=10,q=!0));const te=Math.round(h.x-y/2),ie=Math.round(h.y-p/2);if(_.used){g+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${te}" y="${ie}" width="${y}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${_.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const ee=Se({..._,_evolution_bonus:0,stadiumBonus:!1},{width:y,showStad:!1,stadDef:null,role:E,extraNote:z,_cardOffset:30,_forceStadColor:q}),j=k?`position:absolute;top:30px;left:0;width:${y}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";g+=`<foreignObject x="${te-2}" y="${ie-30}" width="${y+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${ee}
        ${k?`<div style="${j}"></div>`:""}
      </div>
    </foreignObject>`,M&&(g+=`<rect x="${te}" y="${ie}" width="${y}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${k?"selected":""}" data-card-id="${_.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const u=s!==null?s:Math.round(Math.max(y*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${r+u*2} ${o+u*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${g}
  </svg>`}function Ht(e,t,i,n,r=300,o=300,a=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${yi(e,t,i,n,r,o,a,s)}
  </div>`}async function xi(e,t,i,n){var M;const{state:r,navigate:o,toast:a}=t;at(e);const s=r.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return tr(e,t,i);const d=s.deckId;let c,l,f,x;try{const k=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",d).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]);c=k[0].data,f=k[0].error,l=k[1].data,x=k[1].error}catch(k){console.error("[Match] Exception chargement deck:",k),Tt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),Tt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const g=(l||[]).filter(k=>{var z;return k.is_starter&&((z=k.card)==null?void 0:z.player)}).map(k=>Mi(k.card,k.position)),y=(l||[]).filter(k=>{var z;return!k.is_starter&&((z=k.card)==null?void 0:z.player)}).map(k=>Mi(k.card,k.position));if(g.length<11){Tt(e,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>o("decks"));return}const p=(l||[]).find(k=>{var z;return((z=k.card)==null?void 0:z.card_type)==="formation"}),u=(c==null?void 0:c.formation)||((M=p==null?void 0:p.card)==null?void 0:M.formation)||"4-4-2",{data:b,error:_}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(b||[]).map(k=>({...k,_gcDef:(h==null?void 0:h.find(z=>z.name===k.gc_type||z.id===k.gc_definition_id))||null}));let m=null;if(c!=null&&c.stadium_card_id){const{data:k}=await v.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if(k!=null&&k.stadium_id){const{data:z}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",k.stadium_id).single();m=z||null}}n({deckId:d,formation:u,starters:g,subsRaw:y,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function It(){return Math.min(window.innerWidth-40,860)}function Rt(){return Math.round(It()*1.1)}function qn(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:ni(e)}}function ir(e,t,i,n="Adversaire"){const r=It(),o=Rt();return`
    ...
    </div>`}function Dn(e){var o,a,s;if(!e)return"";const t=d=>d?Se({...d,_evolution_bonus:0},{width:52,role:d._line||d.job,showStad:!!d.stadiumBonus,extraNote:d.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function Fn(e,t){const i=Ge(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function yt(e,t){return e.reduce((i,n)=>i+Fn(n,t),0)}function xt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Kt(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function ui(e,t,i,n,r){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Kt(o,e[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Fn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
      ...
      <div class="duel-score-line duel-score-line-${n}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${yt(e,r)} + ${xt(e)} liens = <b style="color:#fff">${yt(e,r)+xt(e)}</b>
      </div>
    </div>`}async function or(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await xi(e,t,r,async({deckId:s,formation:d,starters:c,subsRaw:l,gcCardsEnriched:f,gcDefs:x,stadiumDef:g})=>{try{let y=pi(c,d);g&&(y=oi(y,g),ci(l,g));const p=await rr(d,o),u=p.lines||p,b=async _=>{try{const h=a==="vs_ai_club"?"club":a,{data:E,error:m}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:h,home_deck_id:s,status:"in_progress"}).select().single();if(m){console.error("[MatchIA] Erreur création match:",m),Tt(e,"⚠️","Impossible de créer le match ("+m.message+").","Retour",()=>t.navigate("home"));return}const M=p.stadiumDef||null;M&&u&&(oi(u,M),ci(p.subs||[],M));const k={gcDefs:x||[],matchId:E==null?void 0:E.id,mode:a,difficulty:o,formation:d,homeTeam:y,aiTeam:u,homeSubs:l,subsUsed:0,maxSubs:Math.min(l.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:M,homeScore:0,aiScore:0,gcCards:_,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};sr(e,k,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),Tt(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!f.length){b([]);return}gi(e,f,b)}catch(y){console.error("[MatchIA] Exception setup:",y),Tt(e,"⚠️","Erreur de préparation du match : "+y.message,"Retour",()=>t.navigate("home"))}})}async function rr(e,t){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:ar(e),subs:[],gcCards:[],stadiumDef:null};const n=Ot[e]||Ot["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(b,_,h){var E,m;return o.add(b.id),{cardId:"ai-"+b.id+"-"+h,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:((E=b.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=b.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:_}}for(const b of["GK","DEF","MIL","ATT"]){const _=i.filter(k=>k.job===b&&!o.has(k.id)),h=i.filter(k=>k.job!==b&&!o.has(k.id)),E=[..._,...h],m=[];for(let k=0;k<n[b];k++){const z=E[k];z&&m.push(a(z,b,k))}const M=gt(m.length);m.forEach((k,z)=>{k._col=M[z]}),r[b]=m}const d=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,_)=>a(b,b.job,100+_)),f=Object.keys(je).sort(()=>Math.random()-.5).slice(0,3).map((b,_)=>{var h,E;return{id:"ai-gc-"+_,gc_type:b,name:((h=je[b])==null?void 0:h.name)||b,icon:((E=je[b])==null?void 0:E.icon)||"⚡"}}),x=Object.values(r).flat(),g={};x.forEach(b=>{b.club_id&&(g[b.club_id]=(g[b.club_id]||0)+1)});const y=(u=Object.entries(g).sort((b,_)=>_[1]-b[1])[0])==null?void 0:u[0];let p=null;if(y){const{data:b}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",y).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:r,subs:d,gcCards:f,stadiumDef:p}}function ar(e){const t=Ot[e]||Ot["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let d=0;d<t[o];d++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=gt(a.length);a.forEach((d,c)=>{d._col=s[c]}),i[o]=a}return i}function sr(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const o=e.querySelector(".opponent-preview-wrap"),a=e.querySelector("#opponent-swipe-zone");if(!o||!a)return;const s=a.clientWidth>=900,d=Math.max(200,a.clientHeight-(s?8:40)),c=Math.max(200,a.clientWidth-(s?8:16)),l=s?null:Math.round(Math.max(44,Math.round(c*.168))*.55);o.innerHTML=Ht(t.aiTeam,t.formation,null,[],c,d,[],l),o.style.cssText=`width:${c}px;height:${d}px;overflow:hidden;flex-shrink:0`;const f=o.querySelector("svg");f&&(f.style.cssText="display:block;width:100%;height:100%",f.setAttribute("preserveAspectRatio",s?"xMidYMid meet":"none"))})),setTimeout(()=>dr(e,t,i),5e3)}const Ke=e=>qn(e);function dr(e,t,i){const n=t.homeTeam.MIL||[],r=t.aiTeam.MIL||[],o=t.stadiumDef||null,a=t.aiStadiumDef||null,s=yt(n,o)+xt(n),d=yt(r,a)+xt(r),c=s>=d;e.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const Y=t.pendingAttack;let pe="";if(t.selected.length>0){const G=t.selected.map($=>({...(t.homeTeam[$._role]||[]).find(V=>V.cardId===$.cardId)||$,_line:$._role})),H=ii(G,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Xe(G.map($=>({...$,used:!1})),"#3a7bd5",H.total,"defense",t.formation)}</div>
          ...
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const Y=t.selected.map(G=>{const H=(t.homeTeam[G._role]||[]).find(N=>N.cardId===G.cardId)||G,$=["GK","DEF"].includes(G._role);return{...H,_line:G._role,...$?{note_a:Math.max(1,Number(H.note_a)||0)}:{}}}),pe=ti(Y,t.modifiers.home,t.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
    ...
    ${(()=>{const C=window.innerWidth>=700,Y=(B,R,ue)=>{var Ae,Be;const ce=(t.gcDefs||[]).find(ke=>ke.name===B.gc_type),_e=(ce==null?void 0:ce.name)||B.gc_type,ze=(ce==null?void 0:ce.effect)||((Ae=je[B.gc_type])==null?void 0:Ae.desc)||"",ve=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,Ie=((Be=je[B.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${B.id}" data-gc-type="${B.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${zt(_e,ve,Ie,ze,{width:R})}
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Ht(t.homeTeam,t.formation,t.phase,n,C?1300:It(),C?600:Rt(),y)}
        </div>
      </div>`;return C?`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(C=>{var Y,pe,G;if(C.type==="duel"){const H=C.isGoal,$=C.homeScored?"#FFD700":H?"#ff6b6b":"rgba(255,255,255,0.3)",N=C.homeScored?"⚽ BUT !":H?"⚽ BUT IA !":(Y=C.homePlayers)!=null&&Y.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${H?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${$};margin-bottom:4px">
                <div style="font-size:9px;color:${$};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${N}</div>
                ${(pe=C.homePlayers)!=null&&pe.length?`<div style="margin-bottom:3px">${Xe(C.homePlayers,"rgba(255,255,255,0.7)",C.homeTotal,void 0,t.formation)}</div>`:""}
                ${(G=C.aiPlayers)!=null&&G.length?`<div style="opacity:0.7">${Xe(C.aiPlayers,"#ff6b6b",C.aiTotal,void 0,t.formation)}</div>`:""}
  ...
  </div>`;function z(){const C=e.querySelector(".match-screen");if(!C)return;const Y=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);C.style.bottom="auto",C.style.height=Y+"px",C.style.minHeight=Y+"px",C.style.maxHeight=Y+"px",C.style.overflow="hidden";const pe=e.querySelector("#mobile-action-bar"),G=e.querySelector("#mobile-play-area");pe&&G&&(G.style.paddingBottom=pe.offsetHeight+"px")}if(z(),setTimeout(z,120),setTimeout(z,400),setTimeout(z,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",z),window.visualViewport.addEventListener("scroll",z)),window.addEventListener("resize",z)),function(){const Y=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!Y)return;const pe=Y.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),Y.removeAttribute("width"),Y.removeAttribute("height"),Y.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Y.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const C=e.querySelector(".terrain-wrapper svg");if(C){const Y=C.closest("#match-terrain-wrap");Y&&(Y.style.cssText="position:relative;width:100%;height:100%;padding:0"),C.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let C=!1,Y=30;const pe=()=>document.getElementById("match-timer"),G=()=>{const H=pe();if(!H)return;const $=String(Math.floor(Y/60)).padStart(2,"0"),N=String(Y%60).padStart(2,"0");H.textContent=` ${$}:${N}`,H.style.color=C?"#ff2222":"#ff9500",H.style.fontWeight="900"};G(),t._timerInt=setInterval(()=>{if(Y--,Y<0)if(!C)C=!0,Y=15,G();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const H=document.createElement("div");H.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",H.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(H),setTimeout(()=>{H.remove(),bt(e,t,i)},2500)}else G()},1e3)}(te=document.getElementById("match-quit"))==null||te.addEventListener("click",()=>{et(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,bt(e,t,i))}),(ie=document.getElementById("view-ai"))==null||ie.addEventListener("click",()=>hr(t,i)),(ee=document.getElementById("toggle-history"))==null||ee.addEventListener("click",()=>{var C;(C=document.getElementById("match-history-panel"))==null||C.classList.add("open")}),(j=document.getElementById("close-history"))==null||j.addEventListener("click",()=>{var C;(C=document.getElementById("match-history-panel"))==null||C.classList.remove("open")}),(I=document.getElementById("btn-action"))==null||I.addEventListener("click",()=>{t.selected.length!==0&&(u?cr(e,t,i):b&&pr(e,t,i))}),(K=document.getElementById("btn-results"))==null||K.addEventListener("click",()=>bt(e,t,i)),(X=document.getElementById("btn-pass"))==null||X.addEventListener("click",()=>{if(t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Ci(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),bt(e,t,i);return}t.phase="ai-attack",we(e,t,i),setTimeout(()=>Ui(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(C=>{C.addEventListener("click",()=>lr(C,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(C=>{C.addEventListener("click",()=>$i(e,t,i,null,C.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(C=>{u?C.addEventListener("click",()=>gr(C.dataset.gcId,C.dataset.gcType,e,t,i)):(C.style.opacity="0.35",C.style.cursor="default",C.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(le=document.getElementById("boost-card"))==null||le.addEventListener("click",()=>br(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(C=>{C.addEventListener("click",()=>$i(e,t,i,C.dataset.subId))}),(fe=document.getElementById("sub-btn-main"))==null||fe.addEventListener("click",()=>$i(e,t,i))}function lr(e,t,i,n){const r=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(d=>d.cardId===r);s&&t.selected.push({...s,_role:o,_line:o})}we(i,t,n)}function Hi(e,t,i){e.matchId&&v.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function cr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Hi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const a=(t.homeTeam[o._role]||[]).find(d=>d.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...a,_line:o._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=ti(n,t.modifiers.home,t.formation);t.pendingAttack={...r,players:[...n],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",we(e,t,i),setTimeout(()=>mr(e,t,i),1200)}function pr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Hi(t,i,i.state.profile.id);const n=t.stadiumDef||null,r=t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(f=>f.cardId===d.cardId)||d,l=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:d._role,stadiumBonus:l}}),o=ii(r,t.modifiers.home,t.formation);t.selected.forEach(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);c&&(c.used=!0)});const a=Oi(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>Ke(d)),homePlayers:t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return Ke(c)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,we(e,t,i),Je(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,St(e,t,i,"home-attack")}function ur(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(d=>d.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(d=>!e.aiUsedSubIds.includes(d.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],r=i.find(d=>d.job===n.job)||i[0],o={...r,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(d=>d.cardId===n.cardId);s!==-1&&(a[s]=o),e.aiUsedSubIds.push(r.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function fr(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(r=>!e.aiUsedGc.includes(r.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),je[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function Ui(e,t,i){Hi(t,i,null),ur(t),fr(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(l=>!l.used),r=!1;if(!n.length){const l=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(x=>!x.used),f=Ut(t.homeTeam);if(f||l.length===0){const x=(t.aiTeam.DEF||[]).filter(y=>!y.used),g=(t.aiTeam.GK||[]).filter(y=>!y.used);n=f?x.length?x:g:[...x,...g],r=!0}}const o=Ln(n,"attack",t.difficulty);if(!o.length){ji(e,t,i);return}r&&o.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const a=ti(o,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:o,side:"ai"},o.forEach(l=>{l.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${o.map(l=>l.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used),c=(t.homeSubs||[]).filter(l=>!(t.usedSubIds||[]).includes(l.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&Ut(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,fi(e,t,i,"ai",o[0]);return}t.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(x=>Ke(x)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(f),t.pendingAttack=null,we(e,t,i),Je(f.aiPlayers,t.homeScore,t.aiScore,!1,()=>{St(e,t,i,"home-attack")});return}t.phase="defense",we(e,t,i)}function mr(e,t,i){var c,l;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=Ln(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(t.aiTeam[f]||[]).filter(x=>!x.used)).length){const f=((c=t.pendingAttack)==null?void 0:c.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,fi(e,t,i,"home",f[0]);return}t.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(y=>Ke(y)),homeTotal:((l=t.pendingAttack)==null?void 0:l.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(g),t.modifiers.ai={},t.pendingAttack=null,we(e,t,i),Je(g.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}const a=r.length>0?ii(r,t.modifiers.ai,t.formation).total:0;r.forEach(f=>{f.used=!0});const s=Oi(t.pendingAttack.total,a,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(f=>Ke(f)),aiPlayers:r.map(f=>Ke(f)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(s.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,we(e,t,i),Je(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{St(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,St(e,t,i,"ai-attack")}function St(e,t,i,n){if(t.round++,!Pn(e,t,i)){if(Ki(t)){bt(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used))){ji(e,t,i);return}t.phase="attack",we(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used))){ji(e,t,i);return}t.phase="ai-attack",we(e,t,i),setTimeout(()=>Ui(e,t,i),800)}}}function Ut(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function mn(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(r=>!r.used));return t&&!i}function Pn(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(mn(t.homeTeam)&&Ut(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.homeScore++,fi(e,t,i,"home",n),!0):!1}if(mn(t.aiTeam)&&Ut(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.aiScore++,fi(e,t,i,"ai",n),!0):!1}return!1}function fi(e,t,i,n,r){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ke(r)]:[],aiPlayers:n==="ai"?[Ke(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const a=(s,d)=>new Promise(c=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${d};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,we(e,t,i),Je([Ke(r)],t.homeScore,t.aiScore,n==="home",()=>{if(Ki(t)){bt(e,t,i);return}St(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function Ki(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used));return!t&&!i}function Ci(e,t){return!(["MIL","ATT"].some(r=>(e[r]||[]).some(o=>!o.used))||Ut(t)||!["MIL","ATT"].some(r=>(t[r]||[]).some(o=>!o.used)))}function ji(e,t,i){if(!Pn(e,t,i)){if(Ki(t)){bt(e,t,i);return}if(Ci(t.homeTeam,t.aiTeam)&&Ci(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),bt(e,t,i);return}t.phase="attack",we(e,t,i)}}function $i(e,t,i,n=null,r=null){var g,y;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,u])=>(u||[]).filter(b=>b.used).map(b=>({...b,_line:b._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){$t("Aucun joueur utilisé à remplacer");return}if(!a.length){$t("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===r));const d=((g=o[s])==null?void 0:g._line)||((y=o[s])==null?void 0:y.job);let c=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===d)),l=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function x(){var m,M,k,z,q,te;const p=o[s],u=a[c],b=Math.min(130,Math.round((window.innerWidth-90)/2)),_=Math.round(b*1.35),h=ie=>`background:rgba(255,255,255,0.12);border:none;color:${ie?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ie?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(M=f.querySelector("#out-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,x())}),(k=f.querySelector("#out-down"))==null||k.addEventListener("click",()=>{s<o.length-1&&(s++,x())}),(z=f.querySelector("#in-up"))==null||z.addEventListener("click",()=>{c>0&&(c--,x())}),(q=f.querySelector("#in-down"))==null||q.addEventListener("click",()=>{c<a.length-1&&(c++,x())});const E=(ie,ee,j,I)=>{const K=f.querySelector("#"+ie);if(!K)return;let X=0;K.addEventListener("touchstart",le=>{X=le.touches[0].clientY},{passive:!0}),K.addEventListener("touchend",le=>{const fe=le.changedTouches[0].clientY-X;if(Math.abs(fe)<30)return;const C=ee();fe<0&&C<I-1?(j(C+1),x()):fe>0&&C>0&&(j(C-1),x())},{passive:!0})};E("in-panel",()=>c,ie=>c=ie,a.length),E("out-panel",()=>s,ie=>s=ie,o.length),(te=f.querySelector("#sub-confirm"))==null||te.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),l)return;l=!0;const ee=o[s],j=a[c];if(!ee||!j)return;let I=null,K=-1;for(const[le,fe]of Object.entries(t.homeTeam)){const C=(fe||[]).findIndex(Y=>Y.cardId===ee.cardId);if(C!==-1){I=le,K=C;break}}if(K===-1||!I){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const X={...j,_line:I,_col:ee._col||0,used:!1,boost:0};t.homeTeam[I].splice(K,1,X),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(j.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:ee.name,firstname:ee.firstname,note:Ge(ee,I),portrait:ni(ee),job:ee.job,country_code:ee.country_code,rarity:ee.rarity,clubName:ee.clubName,clubLogo:ee.clubLogo},inPlayer:{name:j.name,firstname:j.firstname,note:Ge(j,I),portrait:ni(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},text:`🔄 ${j.firstname} ${j.name} remplace ${ee.firstname} ${ee.name}`}),f.remove(),nr(ee,j,()=>we(e,t,i))})}document.body.appendChild(f),x()}function gr(e,t,i,n,r){var x,g;const o=(n.gcDefs||[]).find(y=>y.name===t),a=je[t]||{icon:"⚡",desc:"Carte spéciale."},s=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||a.desc,c=o!=null&&o.image_url?`/icons/${o.image_url}`:null,l=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${zt(s,c,l,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#gc-back"))==null||x.addEventListener("click",()=>f.remove()),(g=f.querySelector("#gc-use"))==null||g.addEventListener("click",()=>{f.remove(),xr(e,t,i,n,r)})}function si(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var c,l;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(f=>{const x=f._line||f.job||"MIL",g=s.find(p=>p.cardId===f.cardId),y=Se({...f,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:f.boost||0});return`<div class="gc-pick-item" data-cid="${f.cardId}"
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(l=document.getElementById("res-home"))==null||l.addEventListener("click",()=>{c.remove(),et(e),i.navigate("home")}),(f=document.getElementById("res-replay"))==null||f.addEventListener("click",()=>{c.remove(),et(e),i.navigate("match",{matchMode:t.mode})})}function hr(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${yi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Ft=e=>qn(e);async function Mt(e,t,i,n,r={}){return Gn(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function vr(e,t,i){const{data:n}=await v.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;let o=null,a=null;if(n.mode==="mini_league"){const{data:s}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(o=s.league_id,a=s.id)}return Gn(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,o,a)}async function Gn(e,t,i,n,r=[],o=[],a=!1,s=null,d=null,c=null,l=null,f=null){const{state:x,navigate:g,toast:y}=t,p=n?"p1":"p2",u=n?"p2":"p1",b=(r||[]).map(w=>w.id),_=(r||[]).map(w=>({id:w.id,gc_type:w.gc_type,_gcDef:w._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await v.from("matches").select("*").eq("id",i).single();if(!h){y("Match introuvable","error"),g("home");return}async function E(){var ye,xe;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:w,error:L},{data:S,error:A},{data:T},{data:P}]=await Promise.all([v.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),v.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),v.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),v.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",A==null?void 0:A.message,"p1D:",(ye=w==null?void 0:w.starters)==null?void 0:ye.length,"p2D:",(xe=S==null?void 0:S.starters)==null?void 0:xe.length);const D=oe=>{const Ee=Number(oe.evolution_bonus)||0;return{cardId:oe.card_id,position:oe.position,id:oe.id,firstname:oe.firstname,name:oe.surname_real,country_code:oe.country_code,club_id:oe.club_id,job:oe.job,job2:oe.job2,note_g:(Number(oe.note_g)||0)+(oe.job==="GK"||oe.job2==="GK"&&Number(oe.note_g)>0?Ee:0),note_d:(Number(oe.note_d)||0)+(oe.job==="DEF"||oe.job2==="DEF"&&Number(oe.note_d)>0?Ee:0),note_m:(Number(oe.note_m)||0)+(oe.job==="MIL"||oe.job2==="MIL"&&Number(oe.note_m)>0?Ee:0),note_a:(Number(oe.note_a)||0)+(oe.job==="ATT"||oe.job2==="ATT"&&Number(oe.note_a)>0?Ee:0),evolution_bonus:Ee,rarity:oe.rarity,skin:oe.skin,hair:oe.hair,hair_length:oe.hair_length,face:oe.face||null,clubName:oe.club_encoded_name||null,clubLogo:oe.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},F=((w==null?void 0:w.starters)||[]).map(oe=>D(oe)),O=((S==null?void 0:S.starters)||[]).map(oe=>D(oe)),Q=(w==null?void 0:w.formation)||"4-4-2",ne=(S==null?void 0:S.formation)||"4-4-2";let Z=pi(F,Q),J=pi(O,ne);const ae=((w==null?void 0:w.subs)||[]).map(oe=>D(oe)),se=((S==null?void 0:S.subs)||[]).map(oe=>D(oe)),ge=(w==null?void 0:w.stadium_def)||(n?d:null),de=(S==null?void 0:S.stadium_def)||(n?null:d);return ge&&(Z=oi(Z,ge),ci(ae,ge)),de&&(J=oi(J,de),ci(se,de)),{p1Team:Z,p2Team:J,p1Subs:ae,p2Subs:se,p1Formation:Q,p2Formation:ne,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(P==null?void 0:P.club_name)||(P==null?void 0:P.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?_:[],gcCardsFull_p2:n?[]:_,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let m=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!m,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",x.profile.id),!m)if(n){m=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((m==null?void 0:m.p1Team)||{}));const{data:w}=await v.from("matches").select("game_state").eq("id",i).single();!(w!=null&&w.game_state)||!Object.keys(w.game_state).length?await v.from("matches").update({game_state:m,turn_user_id:h.home_id}).eq("id",i):m=w.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let w=0;w<30&&!m;w++){await new Promise(S=>setTimeout(S,400));const{data:L}=await v.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(m=L.game_state),w%5===0&&console.log("[PvP] away - poll",w,"game_state:",!!(L!=null&&L.game_state))}if(!m){y("Erreur de synchronisation","error"),g("home");return}m.gc_p2=b,m.gcCardsFull_p2=_,await v.from("matches").update({game_state:m}).eq("id",i)}let M=!1,k=null,z=!1;const q=new Set,te=new Set;async function ie(w){var ne,Z;try{v.removeChannel(ee)}catch{}const L=m[p+"Score"]||0,S=m[u+"Score"]||0;let A,T;w.winner_id?(A=w.winner_id===x.profile.id,T=!1):w.forfeit?(A=L>S,T=!1):(T=L===S,A=L>S);let P="";if(a&&n)try{const{data:J}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:ae}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(J&&ae){const se=A?1:T?.5:0,ge=1-se,de=J.placement_matches<10,ye=ae.placement_matches<10,xe=computeGlicko2(J.mmr,J.mmr_deviation,J.mmr_volatility,ae.mmr,ae.mmr_deviation,se===1?1:se===0?0:.5,de),oe=computeGlicko2(ae.mmr,ae.mmr_deviation,ae.mmr_volatility,J.mmr,J.mmr_deviation,ge===1?1:ge===0?0:.5,ye);await v.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:A?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:xe.delta,p_away_delta:oe.delta,p_home_new_rd:xe.newRd,p_away_new_rd:oe.newRd,p_home_new_vol:xe.newSigma,p_away_new_vol:oe.newSigma});const Ee=xe.delta,Re=xe.newMmr,Le=getTier(Re),Ve=Ee>=0?"+":"",He=Ee>=0?"#4caf50":"#ff6b6b",tt=getTier(J.mmr);P=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Le.id!==tt.id?`<div style="font-size:20px;font-weight:900;color:${Le.color}">
                    ${Re>J.mmr?"📈":"📉"} ${tt.emoji} ${tt.label} → ${Le.emoji} ${Le.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Re>J.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Ee>=0?"📈":"📉"}</div>
                   <div style="font-size:18px;font-weight:900;color:${Le.color}">${Le.emoji} ${Le.label}</div>`}
              ${de?`<div style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:6px">Match de placement (${J.placement_matches+1}/10)</div>`:""}
      ...
      ${P}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(Z=D.querySelector("#pvp-end-home"))==null||Z.addEventListener("click",()=>{D.remove(),et(e),l?g("mini-league",{openLeagueId:l}):g(a?"ranked":"home")})}const ee=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{var S;const L=w.new;try{if(L.status==="finished"||L.forfeit){if(M)return;M=!0,k&&(clearInterval(k),k=null),L.game_state&&(m=L.game_state),ie(L);return}if(L.game_state){const A=m;m=L.game_state;const T=m._lastGC;if(T&&T.seq&&!te.has(T.seq)&&(te.add(T.seq),T.by!==p)){$(T.type,T.by,()=>Y());return}const P=A[p+"Score"]||0,D=A[u+"Score"]||0,F=m[p+"Score"]||0,O=m[u+"Score"]||0,Q=F>P,ne=O>D;if((Q||ne)&&!q.has(m.round)){q.add(m.round);const Z=[...m.log||[]].reverse().find(se=>se.isGoal),J=((Z==null?void 0:Z.homePlayers)||[]).map(se=>({name:se.name,note:se.note,portrait:se.portrait,job:se.job}));!!((S=Z==null?void 0:Z.text)!=null&&S.includes("DERNIER CORNER"))?ze().then(()=>{Je(J,F,O,Q,()=>Y())}):Je(J,F,O,Q,()=>Y());return}Y()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function j(w){Object.assign(m,w),m.lastActionAt=new Date().toISOString();const{error:L}=await v.from("matches").update({game_state:m}).eq("id",i);L&&y("Erreur de synchronisation","error");try{Y()}catch(S){console.error("[PvP] renderPvpScreen crash:",S)}}async function I(){if(M)return;M=!0,k&&(clearInterval(k),k=null);const w=n?h.away_id:h.home_id,L=n?"p2":"p1",S=n?"p1":"p2",A={...m,[L+"Score"]:3,[S+"Score"]:0,phase:"finished"},T=A.p1Score||0,P=A.p2Score||0;try{await v.from("matches").update({game_state:A}).eq("id",i);const{data:D,error:F}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:w,p_home_score:T,p_away_score:P,p_forfeit:!0});if(F&&console.error("[PvP] finish_pvp_match (forfeit):",F),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(O){console.error("[PvP] check_and_finish_mini_league (forfeit):",O)}try{const{data:O}=await v.rpc("apply_match_rewards",{p_match_id:i});O!=null&&O.success&&!(O!=null&&O.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(O){console.error("[PvP] apply_match_rewards (forfeit):",O)}}catch{}try{v.removeChannel(ee)}catch{}setTimeout(()=>{et(e),l?g("mini-league",{openLeagueId:l}):g("home")},800)}const K={BOOST_STAT:({value:w=1,count:L=1,roles:S=[]},A,T)=>{const P=A[p+"Team"],D=Object.entries(P).filter(([F])=>!S.length||S.includes(F)).flatMap(([F,O])=>O.filter(Q=>!Q.used).map(Q=>({...Q,_line:F})));if(!D.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(A);return}X(D,L,`Choisir ${L} joueur(s) à booster (+${w})`,F=>{F.forEach(O=>{const Q=(P[O._line]||[]).find(ne=>ne.cardId===O.cardId);Q&&(Q.boost=(Q.boost||0)+w,A.log.push({text:`⚡ +${w} sur ${Q.name}`,type:"info"}))}),A[p+"Team"]=P,T(A)})},DEBUFF_STAT:({value:w=1,count:L=1,roles:S=[],target:A="ai"},T,P)=>{const D=A==="home"?p:u,F=T[D+"Team"],O=A==="home"?"allié":"adverse",Q=Object.entries(F).filter(([ne])=>!S.length||S.includes(ne)).flatMap(([ne,Z])=>Z.map(J=>({...J,_line:ne})));if(!Q.length){T.log.push({text:`🎯 Aucun joueur ${O}`,type:"info"}),P(T);return}X(Q,L,`Choisir ${L} joueur(s) ${O}(s) (-${w})`,ne=>{ne.forEach(Z=>{const J=(F[Z._line]||[]).find(ae=>ae.cardId===Z.cardId);J&&(J.boost=(J.boost||0)-w,T.log.push({text:`🎯 -${w} sur ${J.name}`,type:"info"}))}),T[D+"Team"]=F,P(T)})},GRAY_PLAYER:({count:w=1,roles:L=[],target:S="ai"},A,T)=>{const P=S==="home"?p:u,D=A[P+"Team"],F=S==="home"?"allié":"adverse",O=Object.entries(D).filter(([Q])=>!L.length||L.includes(Q)).flatMap(([Q,ne])=>ne.filter(Z=>!Z.used).map(Z=>({...Z,_line:Q})));if(!O.length){A.log.push({text:`❌ Aucun joueur ${F}`,type:"info"}),T(A);return}X(O,w,`Choisir ${w} joueur(s) ${F}(s) à exclure`,Q=>{const ne="usedCardIds_"+P,Z=new Set(A[ne]||[]);Q.forEach(J=>{const ae=(D[J._line]||[]).find(se=>se.cardId===J.cardId);ae&&(ae.used=!0,Z.add(J.cardId),A.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),A[ne]=[...Z],A[P+"Team"]=D,T(A)})},REVIVE_PLAYER:({count:w=1,roles:L=[]},S,A)=>{const T=S[p+"Team"],P=Object.entries(T).filter(([D])=>!L.length||L.includes(D)).flatMap(([D,F])=>F.filter(O=>O.used).map(O=>({...O,_line:D})));if(!P.length){S.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(S);return}X(P,w,`Choisir ${w} joueur(s) à ressusciter`,D=>{D.forEach(F=>{const O=(T[F._line]||[]).find(Q=>Q.cardId===F.cardId);O&&(O.used=!1,S.log.push({text:`💫 ${O.name} ressuscité !`,type:"info"}))}),S[p+"Team"]=T,A(S)})},REMOVE_GOAL:({},w,L)=>{const S=u+"Score";w[S]>0?(w[S]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(w)},ADD_GOAL_DRAW:({},w,L)=>{w[p+"Score"]===w[u+"Score"]?(w[p+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(w)},ADD_SUB:({value:w=1},L,S)=>{L.maxSubs=(L.maxSubs||3)+w,L.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),S(L)},CUSTOM:({},w,L)=>L(w)};function X(w,L,S,A){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let P=[];function D(){var O,Q;const F=w.map(ne=>{const Z=ne._line||ne.job||"MIL",J=P.find(se=>se.cardId===ne.cardId),ae=Se({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:Z,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
        ...
        </div>`,(O=T.querySelector("#pp-close"))==null||O.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const Z=ne.dataset.cid,J=w.find(se=>se.cardId===Z),ae=P.findIndex(se=>se.cardId===Z);J&&(ae>-1?P.splice(ae,1):P.length<L&&P.push(J),D())})}),(Q=T.querySelector("#pp-confirm"))==null||Q.addEventListener("click",()=>{T.remove(),A(P)})}D(),document.body.appendChild(T)}async function le(w,L){const A=(m["gcCardsFull_"+p]||[]).find(F=>F.id===w),T=(A==null?void 0:A._gcDef)||(m.gcDefs||[]).find(F=>{var O;return F.name===L||((O=F.name)==null?void 0:O.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),P=[...m["usedGc_"+p]||[],w],D={type:L,by:p,seq:(m._gcAnimSeq||0)+1};te.add(D.seq),$(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const O=K[T.effect_type];if(O){const Q={...m};O(T.effect_params||{},Q,async ne=>{ne["usedGc_"+p]=P,ne._lastGC=D,ne._gcAnimSeq=D.seq,await j(ne)});return}}const F={...m};switch(L){case"Remplacement+":F.maxSubs=(F.maxSubs||3)+1,F.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const O=u+"Score";F[O]>0&&(F[O]--,F.log.push({text:"🚫 But annulé",type:"info"}));break}}F["usedGc_"+p]=P,F._lastGC=D,F._gcAnimSeq=D.seq,await j(F)})}function fe(w,L){const S="usedCardIds_"+w,A=new Set(m[S]||[]);L.forEach(T=>A.add(T)),m[S]=[...A]}function C(){for(const w of["p1","p2"]){const L=new Set(m["usedCardIds_"+w]||[]),S=m[w+"Team"];if(S)for(const A of["GK","DEF","MIL","ATT"])(S[A]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function Y(){var Wi,Xi,Ji,Qi,Zi,en;if(m.phase==="reveal")return pe();if(m.phase==="midfield")return H();if(m.phase==="finished")return Ne();const w=m[p+"Team"],L=m[u+"Team"];C();const S=m[p+"Score"],A=m[u+"Score"],T=m[p+"Name"],P=m[u+"Name"],D=m.phase===p+"-attack",F=m.phase===p+"-defense",O=Array.isArray(m["selected_"+p])?m["selected_"+p]:[],Q=O.map(W=>W.cardId),ne=window.innerWidth>=700,Z=m[p+"Subs"]||[],J=m["usedSubIds_"+p]||[],ae=Z.filter(W=>!J.includes(W.cardId)),se=m["gcCardsFull_"+p]||[],ge=m["usedGc_"+p]||[],de=se.filter(W=>!ge.includes(W.id)),ye=m.boostOwner===p&&!m.boostUsed,xe=[...w.MIL||[],...w.ATT||[]].filter(W=>!W.used),oe=[...L.MIL||[],...L.ATT||[]].filter(W=>!W.used),Ee=!ke(L),Re=xe.length===0&&oe.length===0&&!Ee,Le=(w.DEF||[]).filter(W=>!W.used),Ve=(w.GK||[]).filter(W=>!W.used);let He=[];D&&xe.length===0&&(Ee?(He=Le.map(W=>W.cardId),Le.length===0&&(He=He.concat(Ve.map(W=>W.cardId)))):Re&&(He=[...Le,...Ve].map(W=>W.cardId)));function tt(W,me,Te){var Dt,ft;const he=W._gcDef,Bt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ot={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",Fe=(he==null?void 0:he.name)||W.gc_type,Oe=(he==null?void 0:he.effect)||((Dt=je[W.gc_type])==null?void 0:Dt.desc)||"",Me=he!=null&&he.image_url?`/icons/${he.image_url}`:null,kt=((ft=je[W.gc_type])==null?void 0:ft.icon)||"⚡",Pe=Math.round(Te*.22),ut=Math.round(Te*.22),rt=Te-Pe-ut,qt=Fe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${W.id}" data-gc-type="${W.gc_type}"
        style="box-sizing:border-box;width:${me}px;height:${Te}px;border-radius:10px;border:2px solid ${ot};background:${Bt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${Pe}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${qt}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${me-6}px">${Fe}</span>
        ...
        <div style="height:${rt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Me?`<img src="${Me}" style="max-width:${me-10}px;max-height:${rt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(rt*.55)}px">${kt}</span>`}
        </div>
      ...
      </div>`}function Vt(W,me){return`<div id="pvp-boost-card"
      ...
      </div>`}const De=(W,me)=>me?Vt(130,175):tt(W,130,175),Ye=(W,me)=>me?Vt(68,95):tt(W,68,95),Ue=ne?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ct=D?lt(p)?`<button id="pvp-action" style="${Ue};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${O.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Ue};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:F?`<button id="pvp-action" style="${Ue};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${O.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${P}</div>`,it=D&&!lt(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':D||F?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${O.length}/3 sélectionné(s)</div>`:"",Ct=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${ne?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${ae.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':ae.map(W=>`<div class="pvp-sub-btn" data-sub-id="${W.cardId}" style="cursor:pointer;flex-shrink:0">${ht(W,ne?76:44,ne?100:58)}</div>`).join("")}
    </div>`,pt=D?"attack":F?"defense":"idle",wt=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ht(w,m[p+"Formation"],pt,Q,ne?1300:It(),ne?600:Rt(),He)}
      </div>
    </div>`,nt=m[p+"Team"],Yn=(()=>{var me,Te,he,Bt,ot;if(F&&((me=m.pendingAttack)!=null&&me.players)){const Fe=m.pendingAttack;let Oe="";if(O.length>0){const Me=O.map(Pe=>{const ut=(nt[Pe._role]||[]).find(hi=>hi.cardId===Pe.cardId)||Pe,rt=nt[Pe._role]||[],qt=rt.findIndex(hi=>hi.cardId===Pe.cardId),Dt=gt(rt.length),ft=qt>=0?Dt[qt]:ut._col??1;return{...ut,_line:Pe._role,_col:ft}}),kt=ii(Me,((Te=m.modifiers)==null?void 0:Te[p])||{},m[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Xe(Me.map(Pe=>({...Pe,used:!1})),"#3a7bd5",kt.total,"defense",m[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Xe((Fe.players||[]).map(Oe=>({...Oe,used:!1})),"#00ff88",Fe.total,"attack",m[p+"Formation"])}</div>
        </div>`}if(D&&!((Bt=m.pendingAttack)!=null&&Bt.players)&&O.length>0){const Fe=O.map(Me=>{const kt=(nt[Me._role]||[]).find(ft=>ft.cardId===Me.cardId)||Me,Pe=["GK","DEF"].includes(Me._role),ut=nt[Me._role]||[],rt=ut.findIndex(ft=>ft.cardId===Me.cardId),qt=gt(ut.length),Dt=rt>=0?qt[rt]:kt._col??1;return{...kt,_line:Me._role,_col:Dt,...Pe?{note_a:Math.max(1,Number(kt.note_a)||0)}:{}}}),Oe=ti(Fe,((ot=m.modifiers)==null?void 0:ot[p])||{},m[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Xe(Fe.map(Me=>({...Me,used:!1})),"#FFD700",Oe.total,"attack",m[p+"Formation"])}</div>
      ...
      </button>`;at(e),e.style.overflow="hidden",ne?e.innerHTML=`
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ${Yi}
        <div style="display:flex;flex:1;min-height:0;overflow:hidden">
          ${Ct}
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Ht(w,m[p+"Formation"],pt,Q,It(),Rt(),He)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function jt(){const W=e.querySelector(".match-screen");if(!W)return;const me=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);W.style.height=me+"px",W.style.minHeight=me+"px",W.style.maxHeight=me+"px",W.style.overflow="hidden";const Te=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");Te&&he&&(he.style.paddingBottom=Te.offsetHeight+"px")}if(jt(),setTimeout(jt,120),setTimeout(jt,400),z||(z=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",jt),window.visualViewport.addEventListener("scroll",jt)),window.addEventListener("resize",jt)),function(){const me=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!me)return;const Te=me.closest("#match-terrain-wrap");Te&&(Te.style.cssText="position:relative;width:100%;height:100%;padding:0"),me.removeAttribute("width"),me.removeAttribute("height"),me.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",me.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const W=e.querySelector(".terrain-wrapper svg");if(W){const me=W.closest("#match-terrain-wrap");me&&(me.style.cssText="position:relative;width:100%;height:100%;padding:0"),W.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(W=>{W.addEventListener("click",()=>{if(!D&&!F)return;const me=W.dataset.cardId,Te=W.dataset.role,he=(w[Te]||[]).find(Oe=>Oe.cardId===me);if(!he||he.used)return;const Bt=He.includes(me);if(D&&!["MIL","ATT"].includes(Te)&&!Bt)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const ot=m["selected_"+p],Fe=ot.findIndex(Oe=>Oe.cardId===me);Fe>-1?ot.splice(Fe,1):ot.length<3&&ot.push({...he,_role:Te}),Y()})}),e.querySelectorAll(".match-used-hit").forEach(W=>{W.addEventListener("click",()=>U(W.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(W=>{W.addEventListener("click",()=>U())}),(Wi=e.querySelector("#pvp-sub-open"))==null||Wi.addEventListener("click",()=>U()),e.querySelectorAll(".pvp-gc-mini").forEach(W=>{D?W.addEventListener("click",()=>N(W.dataset.gcId,W.dataset.gcType)):(W.style.opacity="0.35",W.style.cursor="default",W.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Xi=e.querySelector("#pvp-boost-card"))==null||Xi.addEventListener("click",()=>V()),(Ji=e.querySelector("#pvp-action"))==null||Ji.addEventListener("click",W=>{D?W.currentTarget.dataset.pass==="1"||!lt(p)?ue():Ie():F&&Ae()}),(Qi=e.querySelector("#pvp-quit"))==null||Qi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&I()}),(Zi=e.querySelector("#pvp-view-opp"))==null||Zi.addEventListener("click",()=>B()),(en=e.querySelector("#pvp-toggle-history"))==null||en.addEventListener("click",()=>R()),k&&(clearInterval(k),k=null),(D||F)&&!M){let W=30,me=!1;const Te=()=>document.getElementById("pvp-timer"),he=()=>{Te()&&(Te().textContent=W+"s",Te().style.color=me?"#ff4444":"#fff")};he(),k=setInterval(()=>{W--,W<0?me?(clearInterval(k),k=null,D&&!lt(p)?ue():I()):(me=!0,W=15,he()):he()},1e3)}}function pe(){at(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${ui(w,m[p+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
    ...
    </div>`;const P=(ae,se)=>e.querySelectorAll(ae).forEach((ge,de)=>{setTimeout(()=>{ge.style.opacity="1",ge.style.transform="translateY(0) scale(1)"},se+de*90)});P(".duel-card-me",150),P(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((ae,se)=>setTimeout(()=>{ae.style.opacity="1"},se*70)),900),setTimeout(()=>{const ae=e.querySelector("#pvp-vs");ae&&(ae.style.opacity="1",ae.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(se=>se.style.opacity="1")},1250);function D(ae,se,ge){const de=document.getElementById(ae);if(!de)return;const ye=performance.now(),xe=oe=>{const Ee=Math.min(1,(oe-ye)/ge);de.textContent=Math.round(se*(1-Math.pow(1-Ee,3))),Ee<1?requestAnimationFrame(xe):de.textContent=se};requestAnimationFrame(xe)}setTimeout(()=>{D("pvp-score-me",S,800),D("pvp-score-opp",A,800)},1500);const F=m.p1Team.MIL||[],O=m.p2Team.MIL||[],Q=yt(F)+xt(F),ne=yt(O)+xt(O),Z=Q>=ne?"p1":"p2";let J=m.boostValue;J==null&&(J=Bn(),m.boostValue=J,m.boostOwner=Z,m.boostUsed=!1),G=!0,setTimeout(()=>{const ae=e.querySelector("#duel-row-"+(T?"me":"opp")),se=e.querySelector("#duel-row-"+(T?"opp":"me")),ge=document.getElementById("pvp-score-me"),de=document.getElementById("pvp-score-opp"),ye=T?ge:de,xe=T?de:ge;ye&&(ye.style.fontSize="80px",ye.style.color=T?"#FFD700":"#ff6b6b",ye.style.animation="duelPulse .5s ease"+(T?",duelGlow 1.5s ease infinite .5s":"")),xe&&(xe.style.opacity="0.25"),setTimeout(()=>{ae&&(ae.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ae.style.zIndex="5"),setTimeout(()=>{const oe=document.getElementById("duel-shock");oe&&(oe.style.animation="shockwave .5s ease-out forwards"),se&&(se.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Le;const oe=document.getElementById("pvp-duel-finale");if(!oe)return;const Ee=m.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+J+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Re=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;oe.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(T?"⚽ "+m[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+m[u+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Ee+Re,oe.style.transition="opacity .45s ease",oe.style.opacity="1",oe.style.pointerEvents="auto",(Le=document.getElementById("pvp-start-match"))==null||Le.addEventListener("click",async()=>{const Ve=Z;await j({phase:Ve+"-attack",attacker:Ve,round:1,boostValue:J,boostUsed:!1,boostOwner:Ve})})},600)},700)},2800)}function $(w,L,S){var ge,de;const A=(m.gcDefs||[]).find(ye=>{var xe;return ye.name===w||((xe=ye.name)==null?void 0:xe.toLowerCase().trim())===(w==null?void 0:w.toLowerCase().trim())}),T={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[A==null?void 0:A.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",P={purple:"#b06ce0",light_blue:"#00d4ef"}[A==null?void 0:A.color]||"#b06ce0",D=(A==null?void 0:A.name)||w,F=(A==null?void 0:A.effect)||((ge=je[w])==null?void 0:ge.desc)||"",O=A!=null&&A.image_url?`/icons/${A.image_url}`:null,Q=((de=je[w])==null?void 0:de.icon)||"⚡",Z=L===p?"Vous":m[L+"Name"]||"Adversaire",J=document.createElement("div");J.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",J.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(J);let ae=!1;const se=()=>{ae||(ae=!0,J.remove(),setTimeout(()=>S&&S(),50))};J.addEventListener("click",se),setTimeout(se,3e3)}function N(w,L){var J,ae,se,ge;const A=(m["gcCardsFull_"+p]||[]).find(de=>de.id===w),T=A==null?void 0:A._gcDef,P={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",D={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",F=(T==null?void 0:T.name)||L,O=(T==null?void 0:T.effect)||((J=je[L])==null?void 0:J.desc)||"Carte spéciale.",Q=T!=null&&T.image_url?`/icons/${T.image_url}`:null,ne=((ae=je[L])==null?void 0:ae.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(T=>{const P={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",D=Ge(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${P};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(S),(A=S.querySelector("#bp-close"))==null||A.addEventListener("click",()=>S.remove()),S.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const P=T.dataset.cid,D=L.find(O=>O.cardId===P);if(!D)return;const F=(w[D._line]||[]).find(O=>O.cardId===P);F&&(F.boost=(F.boost||0)+m.boostValue),S.remove(),await j({[p+"Team"]:w,boostUsed:!0})})})}function U(w=null){var ae,se;if(!(m.phase===p+"-attack")){y("Remplacement uniquement avant votre attaque","warning");return}const S=m[p+"Team"],A=m["usedSubIds_"+p]||[],T=m.maxSubs||3;if(A.length>=T){y(`Maximum ${T} remplacements atteint`,"warning");return}const P=Object.entries(S).flatMap(([ge,de])=>(de||[]).filter(ye=>ye.used).map(ye=>({...ye,_line:ge}))),D=(m[p+"Subs"]||[]).filter(ge=>!A.includes(ge.cardId));if(!P.length){y("Aucun joueur utilisé à remplacer","warning");return}if(!D.length){y("Aucun remplaçant disponible","warning");return}let F=Math.max(0,P.findIndex(ge=>ge.cardId===w));const O=((ae=P[F])==null?void 0:ae._line)||((se=P[F])==null?void 0:se.job);let Q=Math.max(0,D.findIndex(ge=>ge.job===O)),ne=!1;const Z=document.createElement("div");Z.id="pvp-sub-overlay",Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function J(){var Re,Le,Ve,He,tt,Vt;const ge=P[F],de=D[Q],ye=Math.min(130,Math.round((window.innerWidth-90)/2)),xe=Math.round(ye*1.35),oe=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;Z.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${de?ht({...de,used:!1,boost:0},ye,xe):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${ge?ht({...ge,used:!1,boost:0},ye,xe):"<div>—</div>"}</div>
      ...
      </div>`,(Re=Z.querySelector("#psub-close"))==null||Re.addEventListener("click",()=>Z.remove()),(Le=Z.querySelector("#pout-up"))==null||Le.addEventListener("click",()=>{F>0&&(F--,J())}),(Ve=Z.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{F<P.length-1&&(F++,J())}),(He=Z.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{Q>0&&(Q--,J())}),(tt=Z.querySelector("#pin-down"))==null||tt.addEventListener("click",()=>{Q<D.length-1&&(Q++,J())});const Ee=(De,Ye,Ue,ct)=>{const it=Z.querySelector("#"+De);if(!it)return;let Ct=0;it.addEventListener("touchstart",pt=>{Ct=pt.touches[0].clientY},{passive:!0}),it.addEventListener("touchend",pt=>{const wt=pt.changedTouches[0].clientY-Ct;if(Math.abs(wt)<30)return;const nt=Ye();wt<0&&nt<ct-1?(Ue(nt+1),J()):wt>0&&nt>0&&(Ue(nt-1),J())},{passive:!0})};Ee("pin-panel",()=>Q,De=>Q=De,D.length),Ee("pout-panel",()=>F,De=>F=De,P.length),(Vt=Z.querySelector("#psub-confirm"))==null||Vt.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),ne)return;ne=!0;const Ye=P[F],Ue=D[Q];if(!Ye||!Ue)return;const ct=Ye._line,it=(S[ct]||[]).findIndex(wt=>wt.cardId===Ye.cardId);if(it===-1){y("Erreur : joueur introuvable","error"),Z.remove();return}const Ct={...Ue,_line:ct,position:Ye.position,used:!1,boost:0};S[ct].splice(it,1,Ct);const pt=[...A,Ue.cardId];Z.remove(),re(Ye,Ue,async()=>{await j({[p+"Team"]:S,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:pt})})})}document.body.appendChild(Z),J()}function re(w,L,S){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const P=(O,Q,ne)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${A[O.job]||"#555"};border:3px solid ${Q};position:relative;overflow:hidden;margin:0 auto">
        ${ni(O)?`<img src="${ni(O)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      <div style="width:min(90vw,420px)">${yi(m[u+"Team"],m[u+"Formation"],null,[],It(),Rt())}</div>
      ...
      </div>`,document.body.appendChild(L),(S=L.querySelector("#pvp-hist-close"))==null||S.addEventListener("click",()=>L.remove())}async function ue(){if(m.phase!==p+"-attack")return;const w=p==="p1"?"p2":"p1",L=(m.round||0)+1,S=[...m.log||[]];S.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=$e(m),T=lt(w),P=A||!T?"finished":w+"-attack";await j({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:P,attacker:w,round:L,log:S}),P==="finished"&&await qe(m)}function ce(w){const L=(w.GK||[]).some(A=>!A.used),S=["DEF","MIL","ATT"].some(A=>(w[A]||[]).some(T=>!T.used));return L&&!S}function _e(w){return(w.p1Score||0)!==(w.p2Score||0)?null:ce(w.p1Team)&&!ke(w.p2Team)?{side:"p1",gk:(w.p1Team.GK||[]).find(L=>!L.used)}:ce(w.p2Team)&&!ke(w.p1Team)?{side:"p2",gk:(w.p2Team.GK||[]).find(L=>!L.used)}:null}async function ze(){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(w);const L=(S,A)=>new Promise(T=>{w.innerHTML=`<div style="font-size:32px;font-weight:900;color:${A};letter-spacing:2px;animation:lcFade 1.4s ease both">${S}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),w.remove()}async function ve(w,L){const{side:S,gk:A}=w;if(!A)return;const T=S+"Score",P=(L[T]||0)+1;A.used=!0;const D=[...L.log||[]];D.push({type:"duel",isGoal:!0,homeScored:S===p,homePlayers:S==="p1"?[Ft(A)]:[],aiPlayers:S==="p2"?[Ft(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[S+"Name"]} marque !`});const F=(L.round||0)+1,O=S==="p1"?"p2":"p1",Q={...L,[T]:P},ne=$e(Q);q.add(F),await ze();const Z=S===p?P:L[p+"Score"]||0,J=S===p?L[u+"Score"]||0:P;Je([Ft(A)],Z,J,S===p,async()=>{await j({[T]:P,log:D,round:F,pendingAttack:null,phase:ne?"finished":O+"-attack",attacker:O,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),ne&&await qe({...m,[T]:P})})}async function Ie(){const w=m[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(P=>(m[u+"Team"][P]||[]).some(D=>!D.used)),S=(m["selected_"+p]||[]).map(P=>{const D=(w[P._role]||[]).find(se=>se.cardId===P.cardId)||P,F=["GK","DEF"].includes(P._role),O=w[P._role]||[],Q=O.findIndex(se=>se.cardId===P.cardId),ne=gt(O.length),Z=Q>=0?ne[Q]:D._col??1,J=m.stadiumDef||m.homeStadiumDef||null,ae=D.stadiumBonus||J&&(J.club_id&&String(D.club_id)===String(J.club_id)||J.country_code&&D.country_code===J.country_code)||!1;return{...D,_line:P._role,_col:Z,stadiumBonus:ae,...F?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!S.length)return;const A=ti(S,m.modifiers[p]||{},m[p+"Formation"]);fe(p,S.map(P=>P.cardId)),S.forEach(P=>{const D=(w[P._role]||[]).find(F=>F.cardId===P.cardId);D&&(D.used=!0)}),m["selected_"+p]=[],Y();const T=[...m.log||[]];if(L){if(S.length===1&&(S[0]._line==="GK"||S[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await ve({side:p,gk:S[0]},{...m,[p+"Team"]:w,log:T});return}const D=(m[p+"Score"]||0)+1,F=S.map(J=>Ft(J));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:F,homeTotal:A.total,aiTotal:0});const O=(m.round||0)+1,Q=p==="p1"?"p2":"p1",ne={...m,[p+"Team"]:w,[p+"Score"]:D},Z=$e(ne);q.add(O),Je(F,D,m[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:w,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":Q+"-attack",attacker:Q,round:O,log:T}),Z&&await qe({...m,[p+"Score"]:D})});return}T.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${A.total})`}),await j({[p+"Team"]:w,[u+"Team"]:m[u+"Team"],pendingAttack:{...A,players:S,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Ae(){const w=m[p+"Team"],L=(m["selected_"+p]||[]).map(de=>{const ye=(w[de._role]||[]).find(Le=>Le.cardId===de.cardId)||de,xe=w[de._role]||[],oe=xe.findIndex(Le=>Le.cardId===de.cardId),Ee=gt(xe.length),Re=oe>=0?Ee[oe]:ye._col??1;return{...ye,_line:de._role,_col:Re}}),S=ii(L,m.modifiers[p]||{},m[p+"Formation"]);fe(p,L.map(de=>de.cardId)),L.forEach(de=>{const ye=(w[de._role]||[]).find(xe=>xe.cardId===de.cardId);ye&&(ye.used=!0)}),m["selected_"+p]=[],Y();const A=Oi(m.pendingAttack.total,S.total,m.modifiers[p]||{}),T=m.pendingAttack.side,P=A==="attack"||(A==null?void 0:A.goal),D=T==="p1"?"p2":"p1",F=(m.round||0)+1,O=(m.pendingAttack.players||[]).map(de=>Ft(de)),Q=[...m.log||[]];Q.push({type:"duel",isGoal:P,homeScored:P&&T===p,text:P?`⚽ BUT de ${m[T+"Name"]} ! (${m.pendingAttack.total} vs ${S.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${S.total})`,homePlayers:O,aiPlayers:L.map(de=>Ft(de)),homeTotal:m.pendingAttack.total,aiTotal:S.total});const ne=P?(m[T+"Score"]||0)+1:m[T+"Score"]||0,Z={...m,[p+"Team"]:w,[T+"Score"]:ne},J=$e(Z),ae=J?"finished":D+"-attack",se=!J&&!P?_e(Z):null,ge=async()=>{if(se){await ve(se,Z);return}await j({[p+"Team"]:w,[u+"Team"]:m[u+"Team"],[T+"Score"]:ne,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:D,round:F,log:Q}),(ae==="finished"||J)&&await qe({...m,[T+"Score"]:ne})};if(P){const de=T===p,ye=de?ne:m[p+"Score"]||0,xe=de?m[u+"Score"]||0:ne;q.add(F),Je(O,ye,xe,de,ge)}else await ge()}function Be(w){return["MIL","ATT"].some(L=>(w[L]||[]).some(S=>!S.used))}function ke(w){return["GK","DEF","MIL","ATT"].some(L=>(w[L]||[]).some(S=>!S.used))}function _t(w){return ke(w)&&!Be(w)}function lt(w){const L=m[w+"Team"],S=m[(w==="p1"?"p2":"p1")+"Team"];return!!(Be(L)||_t(L)&&!ke(S)||_t(L)&&!Be(S)&&ke(S))}function $e(w){return!ke(w.p1Team)&&!ke(w.p2Team)}function Ce(w){const L=w.p1Score||0,S=w.p2Score||0;return L===S?null:L>S?h.home_id:h.away_id}async function qe(w){try{const L=Ce(w),S=L?h.home_id===L?h.away_id:h.home_id:null,A=w.p1Score||0,T=w.p2Score||0,{data:P,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:A,p_away_score:T,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(F){console.error("[PvP] check_and_finish_mini_league:",F)}L&&S&&wo(L,S).catch(()=>{});try{const{data:F}=await v.rpc("apply_match_rewards",{p_match_id:i});F!=null&&F.success&&!(F!=null&&F.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(F){console.error("[PvP] apply_match_rewards:",F)}if(typeof c=="function")try{await c({homeScore:A,awayScore:T,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(F){console.error("[PvP] onMatchEnd:",F)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Ne(){var T;const w=m[p+"Score"],L=m[u+"Score"],S=w>L,A=w===L;at(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(ee)}catch{}et(e),l?g("mini-league",{openLeagueId:l}):g("home")})}Y()}async function Bi(e,t,i=!1){var s,d;const{state:n,navigate:r,toast:o}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await xi(e,t,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:x,gcCardsEnriched:g,gcDefs:y,stadiumDef:p})=>{at(e);const u=async b=>{await wr(e,t,c,l,f,x,b||[],y,p,i,a)};if(!(g!=null&&g.length)){await u([]);return}gi(e,g,u)})}async function _r(e,t,i){return vr(e,t,i)}async function wr(e,t,i,n,r,o,a=[],s=[],d=null,c=!1,l=null){var ie,ee;const{state:f,navigate:x,toast:g}=t,y=(l==null?void 0:l.mmr)??((ie=f.profile)==null?void 0:ie.mmr)??1e3,p=c?Gi(y):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let _=!1,h=null,E=null;e.innerHTML=`
    ...
    </div>`;const m=async()=>{_=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(ee=document.getElementById("cancel-mm"))==null||ee.addEventListener("click",async()=>{await m(),et(e),x("home")});const M=async(j,I)=>{_||(_=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Mt(e,t,j,I,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?kr:null}))},k=f.user.id,{data:z,error:q}=c?await v.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:y}):await v.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(q||!(z!=null&&z.success)){console.error("[Matchmaking] try_matchmake error:",q||z),g("Erreur de matchmaking","error"),et(e),x("home");return}if(z.matched){await M(z.match_id,!1);return}const te=async()=>{if(_)return;const{data:j}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await M(j.match_id,!0)};h=v.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},j=>{const I=j.new;I.status==="matched"&&I.match_id&&M(I.match_id,!0)}).subscribe(),E=setInterval(te,3e3),setTimeout(()=>{_||m()},12e4)}async function kr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:d,matchId:c}=e,l=i.user.id,f=o===l,x=r===l,{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:y}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:o).single();if(g&&y){const p=Wn(g.mmr,g.mmr_rd,g.mmr_v,y.mmr,y.mmr_rd,x?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",l),n(x?`+MMR ↑ ${Math.round(p.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-p.mmr)}`,x?"success":"error",4e3)}}const $r=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Bi,resumePvpMatch:_r},Symbol.toStringTag,{value:"Module"}));async function Er(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",d=!!o.isAccepting;await xi(e,t,"friend",async({deckId:c,formation:l,starters:f,subsRaw:x,gcCardsEnriched:g,gcDefs:y,stadiumDef:p})=>{at(e);const u=async b=>{const _=b||[];d?await Tr(e,t,c,_,y,p):await Lr(e,t,c,_,y,p,a,s)};if(!(g!=null&&g.length)){await u([]);return}gi(e,g,u)})}async function Lr(e,t,i,n,r,o,a,s){var _;const{state:d,navigate:c,toast:l}=t,f=d.user.id,{data:x,error:g}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!x){console.error("[Friend] Erreur création invitation:",g),l("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Lt};display:flex;align-items:center;justify-content:space-between">
      <div>
        ...
        <div style="font-size:12px;color:${Rn}">Championnats 3 à 8 joueurs</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function On(e,t,i,n){var f;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await jr(),s===null))return;const{data:d,error:c}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(c||!(d!=null&&d.success)){console.error("[MiniLeague] join_mini_league:",c||d),r((d==null?void 0:d.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",a).single();o.profile&&x&&(o.profile.credits=x.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((f=o.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),dt(e,t,i)}async function Br(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(x=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),x(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),x(!1)}}))return;const{data:d,error:c}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(d!=null&&d.success)){r((d==null?void 0:d.error)||"Erreur lors de la désinscription","error");return}const l=d.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+l);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),Ze(e,t,"waiting")}async function qi(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),Ze(e,t,r)}async function qr(e,t,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),Ze(e,t,"archived")}async function dt(e,t,i){var E,m,M,k,z,q,te,ie,ee;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:d}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await Ze(e,t);return}const c=(s||[]).some(j=>j.user_id===o),l=a.creator_id===o,f=(s||[]).map(j=>j.user).filter(Boolean),x=Nr(f,d||[]),g=(d||[]).filter(j=>j.matchday===a.current_day),y=a.pot||0,p=a.entry_fee||100,u=g.length>0&&g.every(j=>j.status==="finished"||j.status==="bye"),b=a.current_day>=a.total_days,_=(s||[]).find(j=>j.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Lt};display:flex;align-items:center;gap:10px">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:11px;color:${Rn}">${a.mode==="aller-retour"?"Aller-Retour":"Aller"} · max ${a.max_players} · 💰 ${p} cr./joueur</div>
      </div>
      <div style="text-align:right;flex-shrink:0">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        ...
        ${f.map(j=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${Lt}">
            <div style="width:36px;height:36px;border-radius:50%;background:${j.club_color2||Nn};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${j.club_color1||"#fff"}">${(j.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="font-size:10px;color:${Qe};text-transform:uppercase;border-bottom:2px solid ${Lt}">
          ...
          <tbody>${x.map((j,I)=>{const K=y>0&&a.status==="finished"?I===0?Math.floor(y*.7):I===1?Math.floor(y*.2):I===2?Math.floor(y*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${I===0?st:I<3?"#4ade80":Et}">${["🥇","🥈","🥉"][I]||I+1}</td>
      ...
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,I)=>I+1).reverse().map(j=>{const I=(d||[]).filter(K=>K.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Qe};margin-bottom:6px">Journée ${j}</div>${I.map(K=>gn(K,f,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`}async function Dr(e,t,i,n){const{toast:r,state:o}=t,a=Gr(n.map(c=>c.id),i.mode),s=[];a.forEach((c,l)=>c.forEach(f=>s.push({league_id:i.id,matchday:l+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:d}=await v.from("mini_league_matches").insert(s);if(d){r("Erreur calendrier : "+d.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),dt(e,t,i.id)}async function Fr(e,t,i){const{data:n}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){dt(e,t,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),dt(e,t,i)}async function Pr(e,t,i,n,r){var x,g;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],d=["🥇","🥈","🥉"][r],c=n.prize_amount||s[r]||0,l=n.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    ...
    </div>`;let l=!1;const f=async u=>{if(!l){if(l=!0,clearInterval(y),g)try{g.unsubscribe()}catch{}u&&await Mt(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(y),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),d()});const x=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},g=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&f(u.new.match_id)}).subscribe(),y=setInterval(x,3e3);x()})}const Or="/",Hr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Ur(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var l,f,x;const s=t[n],d=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
  </div>`;let d="buy";const c=()=>{var p,u,b,_,h,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((_=document.getElementById("flt-job"))==null?void 0:_.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function l(p){const u=c();return p.filter(b=>{var q,te,ie;const _=(q=b.card)==null?void 0:q.player;if(!_)return!1;const h=`${_.firstname} ${_.surname_real}`.toLowerCase(),E=(((te=_.clubs)==null?void 0:te.encoded_name)||"").toLowerCase(),m=(_.country_code||"").toLowerCase(),M=((ie=b.card)==null?void 0:ie.evolution_bonus)||0,k=Pt(_,_.job,M),z=_.job2?Pt(_,_.job2,M):0;return!(u.name&&!h.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!m.includes(u.country)||u.job&&_.job!==u.job||u.rarity&&_.rarity!==u.rarity||u.note1&&k<u.note1||u.note2&&z<u.note2)})}function f(p){var z,q,te,ie;const u=(z=p.card)==null?void 0:z.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,_=Pt(u,u.job,b),h=u.job2?Pt(u,u.job2,b):0,E=(i.profile.credits||0)>=p.price,m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=di[u.job]||"#bbb",k=u.job2?di[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
      ...
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
          <span style="font-size:14px;font-weight:900;color:${M};font-family:Arial Black,Arial">${_}</span>
        </div>
    ...
    </div>`}function x(p){var z,q,te,ie;const u=(z=p.card)==null?void 0:z.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,_=Pt(u,u.job,b),h=u.job2?Pt(u,u.job2,b):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=di[u.job]||"#bbb",k=u.job2?di[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${m?`<img src="${m}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(te=u.clubs)!=null&&te.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>n("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,f=s.placement_matches??0,x=f<10,g=Math.max(0,10-f),y=Gi(d),p=Xn(d),u=vi.findIndex(te=>te.id===y.id),b=vi[u+1]||null,_={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=vi.map(te=>`
    <div style="display:flex;flex-direction:column;align-items:center;gap:2px;opacity:${y.id===te.id?1:.35};
      transform:${y.id===te.id?"scale(1.15)":"scale(1)"};transition:all 0.3s">
      <div style="font-size:${y.id===te.id?"28px":"20px"}">${te.emoji}</div>
      <div style="font-size:9px;color:${te.color};font-weight:${y.id===te.id?"900":"400"};letter-spacing:0.5px">${te.label.toUpperCase()}</div>
    </div>
  `).join("");e.innerHTML=`
  ...
  </div>`}Jn(Zn);const be={user:null,profile:null,page:"home",params:{}};function Gt(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function ea(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Di(){document.getElementById("modal-overlay").classList.add("hidden")}async function Xt(){if(!be.user)return;const{data:e}=await v.from("users").select("*").eq("id",be.user.id).single();e&&(be.profile=e)}const Hn="mw_theme";function Un(){return localStorage.getItem(Hn)||"dark"}function ta(e){var t;localStorage.setItem(Hn,e),ia(e),(t=be.profile)!=null&&t.id&&v.from("users").update({theme:e}).eq("id",be.profile.id).then(()=>{})}function ia(e){document.documentElement.setAttribute("data-theme",e)}function Nt(e,t={}){be.page=e,be.params=t,Kn()}async function Kn(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===be.page)});const t=document.getElementById("nav-credits");t&&be.profile&&(t.textContent=`💰 ${(be.profile.credits||0).toLocaleString("fr")}`);const i={state:be,navigate:Nt,toast:Gt,openModal:ea,closeModal:Di,refreshProfile:Xt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',be.page){case"home":await rn(e,i);break;case"settings":await Ii(e,i);break;case"collection":await zo(e,i);break;case"decks":await Si(e,i);break;case"boosters":await Oo(e,i);break;case"ranked":await Qr(e,i);break;case"match":{const s=be.params&&be.params.matchMode||"vs_ai_easy";s==="random"?await Bi(e,i,!1):s==="ranked"?await Bi(e,i,!0):s==="friend"?await Er(e,i,(n=be.params)==null?void 0:n.friendId,(r=be.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await yn(e,i,(o=be.params)==null?void 0:o.mlMatchId,(a=be.params)==null?void 0:a.leagueId):await or(e,i);break}case"market":await Vr(e,i);break;case"rankings":await Jr(e,i);break;case"matches":await Zr(e,i);break;case"friends":await ao(e,i);break;case"mini-league":await Sr(e,i);break;case"match-mini-league":{const s=be.params||{};await yn(e,i,s.mlMatchId,s.leagueId);break}default:await rn(e,i)}}function na(){var n,r;const e=document.getElementById("app"),t=be.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.21-1219" style="cursor:pointer">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function aa(){document.documentElement.setAttribute("data-theme",Un()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Di()}),document.getElementById("modal-close").addEventListener("click",Di);const{data:{session:e}}=await v.auth.getSession();if(!e){xn(),ra(document.getElementById("app"),{onPlay:()=>tn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Gt})});return}be.user=e.user,await Xt(),xn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),Qn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!be.profile){to(document.getElementById("app"),{state:be,navigate:async()=>{await Xt(),Ei()},toast:Gt,refreshProfile:Xt});return}const t=Array.isArray(be.profile.pending_boosters)?be.profile.pending_boosters:[];if(!be.profile.onboarding_done&&t.length>0){Jo(document.getElementById("app"),{state:be,navigate:()=>Ei(),toast:Gt,refreshProfile:Xt});return}Ei(),setTimeout(()=>Kr(be.profile,Nt,Gt),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(be.user=null,be.profile=null,document.getElementById("app").innerHTML="",tn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Gt}))})}function sa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function bi(){const e=document.getElementById("app");e&&(e.style.height=sa()+"px")}window.addEventListener("resize",bi);window.addEventListener("orientationchange",()=>setTimeout(bi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",bi);function Ei(){const e=()=>{var i;(i=be.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",be.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",bi(),na(),Kn()}function xn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Vn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
