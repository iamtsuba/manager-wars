...
import{s as T,F as ki,i as Ht,k as eo,l as nt,m as ji,f as Nt,n as Lo,T as ci,j as Io,o as Mo,b as jo}from"./formation-links-BZe0pGr4.js";const Co="/";function Ci(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,m,a,o,y;const s=n==="login";e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",d=>{d.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{n(),e("match",{matchMode:d.dataset.mode})})})}const Ft="/",Di={GK:Ft+"cards/card-GK.png",DEF:Ft+"cards/card-DEF.png",MIL:Ft+"cards/card-MIL.png",ATT:Ft+"cards/card-ATT.png"},Wo={GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"};function Jo(e){if(!(e!=null&&e.face))return null;const t=e.face.replace(/^public\//,"").replace(/^\//,"");return Ft+t}function Xo(e){return!e||e.length<2?null:`https://flagsapi.com/${e.slice(0,2).toUpperCase()}/flat/64.png`}function Zo(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co",i=((n=e==null?void 0:e.clubs)==null?void 0:n.logo_url)||(e==null?void 0:e.clubLogo);return i?i.startsWith("http")?i:`${t}/storage/v1/object/public/assets/clubs/${i}`:null}function Gi(e,t,i=0){if(!t)return 0;const d="note_"+({GK:"g",DEF:"d",MIL:"m",ATT:"a"}[t]||t.toLowerCase());return(Number(e[d])||0)+(t===e.job||t===e.job2?i:0)}function Qo(e,t){return t?t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code:!1}function Ai(e,t={}){var de;const{width:i=160,showStad:n=!1,stadDef:d=null,used:s=!1,extraNote:r=0}=t;if(!e)return`<div style="width:${i}px;height:${Math.round(i*657/507)}px;border-radius:8px;background:#111;opacity:0.3"></div>`;const l=i/507,m=Math.round(i*657/507),a=H=>Math.round(H*l),o=H=>a(H)+"px",y=e._line||e.job||"MIL",p=Wo[y]||"#D4A017",x=Di[y]||Di.MIL,_=e._evolution_bonus??e.evolution_bonus??0,f=n&&(e.stadiumBonus||Qo(e,d))?10:0,c=Gi(e,y,_)+r+f,z=f>0?"#E87722":p,u=e.job2&&e.job2!==y?e.job2:null,M=u?Gi(e,u,_)+r+f:null,F=Jo(e),C=Xo(e.country_code),q=Zo(e),j=(e.firstname||"").toUpperCase(),N=(e.surname_encoded||e.name||"").toUpperCase(),X=s?"opacity:0.35;":"",K=N.length>11?34:N.length>8?42:50,re=a(155),ie=a(260),Z=a(235),R=a(390),G=a(180),oe=a(100),ge=a(309),_e=a(85),we=a(95),ve=a(435),Ee=a(38),se=a(374),pe=a(6);return`<div style="position:relative;width:${i}px;height:${m}px;flex-shrink:0;${X}user-select:none">
  ...
  <div style="position:absolute;left:${oe}px;top:${R}px;width:${ge}px;height:${G}px;
    z-index:4;display:flex;flex-direction:column;align-items:center;justify-content:center">
    <span style="font-size:${o(80)};font-weight:900;color:${z};font-family:Arial Black,Arial;line-height:1;text-shadow:0 2px 8px rgba(0,0,0,0.9)">${c}</span>
  </div>
  ...
  <div style="position:absolute;left:50%;transform:translateX(-50%);top:${o(530)};
    ...
    <span style="font-size:${o(32)};font-weight:900;color:#e03030;font-family:Arial Black,Arial;line-height:1">${M}</span>
  </div>`:""}
  ...
  <div style="position:absolute;left:${se}px;top:${ve}px;width:${we}px;height:${_e}px;z-index:3;
    ...
    ${Ai(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(H=>H.card_type==="player"&&H.player),o=(l||[]).filter(H=>H.card_type==="game_changer"),y=(l||[]).filter(H=>H.card_type==="formation"),p=(l||[]).filter(H=>H.card_type==="stadium"),{data:x}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(x||[]).forEach(H=>{_[H.name]=H});const{data:f}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(f||[]).forEach(H=>{c[H.id]=H}),p.forEach(H=>{H.stadium_def&&(c[H.stadium_id]=H.stadium_def)});const z=Object.keys(ki),u=Object.keys(He),M={};a.forEach(H=>{const ee=H.player.id;M[ee]=(M[ee]||0)+1}),new Set(Object.keys(M).map(H=>String(H)));const F=new Set(y.map(H=>H.formation)),C=new Set(o.map(H=>H.gc_type));let q="player",j="Tous",N="",X=!1;function K(){return[...a].sort((H,ee)=>{const xe=Yt.indexOf(H.player.job),le=Yt.indexOf(ee.player.job);return xe!==le?xe-le:(H.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function re(){return[...m||[]].sort((H,ee)=>{const xe=Yt.indexOf(H.job),le=Yt.indexOf(ee.job);return xe!==le?xe-le:(H.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function ie(){return K().filter(H=>{const ee=H.player,xe=j==="Tous"||ee.job===j,le=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&le})}function Z(){return re().filter(H=>{const ee=j==="Tous"||H.job===j,xe=!N||`${H.firstname} ${H.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",ee=>{N=ee.target.value.toLowerCase(),G()}),e.querySelectorAll(".filter-btn").forEach(ee=>{ee.addEventListener("click",()=>{j=ee.dataset.job,R(),G()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{X=!X,R(),G()})):(H.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{X=!X,R(),G()})))}function G(){const H=document.getElementById("col-grid");H&&(q==="player"?Ee(H):q==="formation"?se(H):q==="stadium"?de(H):pe(H))}function oe(H,ee,xe,le,me){const ne=document.getElementById("col-grid"),ue=document.getElementById("col-big");if(!ne||!ue)return;var Le=0;function Ie(){const Ce=window.innerWidth>=768,Ae=document.getElementById("col-big"),qe=document.getElementById("col-grid");Ce&&Ae&&(Ae.style.minHeight="420px",Ae.style.flex="1 1 auto"),Ce&&qe&&(qe.style.height=Math.round(310*.76+16)+"px",qe.style.flexShrink="0",qe.style.overflowX="auto",qe.style.overflowY="hidden",qe.style.alignItems="center",qe.style.padding="8px 16px"),ue.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ee(H[Le])+"</div>";var Ge=ue.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ge&&Ge.addEventListener("click",function(){le(H[Le])}),requestAnimationFrame(function(){var Se=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!Se||!ue)){var B=ue.clientHeight-8,$=ue.clientWidth-24,g=Se.offsetHeight,b=Se.offsetWidth;if(g>0&&b>0&&B>40){var h=Ce?2.2:1,v=Math.min(B/g,$/b,h);Se.style.transform="scale("+v.toFixed(3)+")",Se.style.transformOrigin="top center"}}}),ne.innerHTML=H.map(function(Se,B){var $=B===Le,g="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+($?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+B+'" style="'+g+'">'+xe(Se,$)+"</div>"}).join(""),ne.querySelectorAll(".col-mini-item").forEach(function(Se){Se.addEventListener("click",function(){Le=Number(Se.dataset.idx),Ie(),Se.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Ie()}function ge(H){var ee=window.innerWidth>=768?.76:.54,xe;if(!H||H._fake){var le=H?H.player:null;if(!le)return"";xe=Ri(le)}else xe=fi(H,"");return'<div style="display:inline-block;zoom:'+ee+';pointer-events:none;line-height:0">'+xe+"</div>"}function _e(H,ee,xe){ee=ee||100,xe=xe||140;var le=Ht[H]||{},me={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ne=Math.max(3,Math.round(ee*.06)),ue=Object.entries(le).map(function(Ie){var Ce=Ie[0],Ae=Ie[1],qe=Ce.replace(/\d+$/,""),Ge=me[qe]||"#888",Se=Math.round(Ae.x*ee),B=Math.round(Ae.y*xe);return'<circle cx="'+Se+'" cy="'+B+'" r="'+ne+'" fill="'+Ge+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),Le=Math.max(1,Math.round(ee/50));return'<svg viewBox="0 0 '+ee+" "+xe+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ee+'" height="'+xe+'" fill="#1A6B3C"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.02)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/><line x1="0" y1="'+Math.round(xe*.5)+'" x2="'+ee+'" y2="'+Math.round(xe*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><ellipse cx="'+Math.round(ee*.5)+'" cy="'+Math.round(xe*.5)+'" rx="'+Math.round(ee*.18)+'" ry="'+Math.round(xe*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.82)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/>'+ue+"</svg>"}function we(H,ee,xe){var le=xe>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+xe+"</div>":"",me=ee?'data-form-id="'+ee.id+'"':"",ne=H.length>7?14:H.length>5?16:19,ue=!!ee;return"<div "+me+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ue?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ue?"":"filter:grayscale(1);opacity:0.5")+'">'+le+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ue?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ne+"px;font-weight:900;color:"+(ue?"#1A6B3C":"#aaa")+';line-height:1">'+H+'</div></div><div style="flex:1;overflow:hidden;background:'+(ue?"#1A6B3C":"#ccc")+'">'+_e(H,140,220)+"</div></div>"}function ve(H,ee){var xe=window.innerWidth>=768?.76:.54,le=140,me=305,ne=Math.round(me*.22),ue=me-ne,Le=H.length>7?10:13,Ie=_e(H,le,ue),Ce=ee?"1.5px solid #2a7a40":"1px solid #ddd",Ae=ee?"":"filter:grayscale(1);opacity:0.45;",qe=ee?"#1A6B3C":"#bbb",Ge="#fff";return'<div style="display:inline-block;zoom:'+xe+';line-height:0;pointer-events:none"><div style="width:'+le+"px;height:"+me+"px;border-radius:6px;border:"+Ce+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Ae+'"><div style="height:'+ne+"px;background:"+qe+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+Le+"px;font-weight:900;color:"+Ge+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(le-4)+'px">'+H+'</span></div><div style="height:'+ue+'px;overflow:hidden;flex-shrink:0">'+Ie+"</div></div></div>"}function Ee(H){if(X){const ee=Z();if(!ee.length){H.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const xe=ee.map(le=>a.find(me=>me.player.id===le.id)||{_fake:!0,player:le,id:"fake-"+le.id});oe(xe,le=>le._fake?Ri(le.player):fi(le,""),le=>le._fake?ge({player:le.player,id:"x",_fake:!0}):ge(le),le=>{le._fake||Oi(le,a,M,t)})}else{const ee=ie();if(!ee.length){H.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const xe={};ee.forEach(me=>{const ne=me.player.id;xe[ne]||(xe[ne]=[]),xe[ne].push(me)});const le=Object.values(xe).map(me=>an(me));oe(le,me=>{const ne=M[me.player.id]||1,ue=ne>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ne}</div>`:"",Ie=a.filter(Ce=>Ce.player.id===me.player.id&&Ce.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return fi(me,ue+Ie)},me=>ge(me),me=>Oi(me,a,M,t))}}function se(H){const ee=X?z:[...F];if(!ee.length){H.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const xe=ee.map(le=>({formation:le,card:y.find(me=>me.formation===le)||null,owned:F.has(le)}));oe(xe,({formation:le,card:me,owned:ne})=>we(le,ne?me:null,ne?y.filter(ue=>ue.formation===le).length:0),({formation:le,owned:me})=>ve(le,me),({card:le,owned:me})=>{me&&le&&un(le,y,t,s)})}function pe(H){const ee=Object.keys(_),xe=X?ee.length?ee:u:[...C];if(!xe.length){H.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const le=xe.map(me=>({type:me,gc:He[me]||{icon:"⚡",desc:""},def:_[me]||null,owned:C.has(me),card:o.find(ne=>ne.gc_type===me)||null}));oe(le,({type:me,gc:ne,def:ue,owned:Le,card:Ie})=>{var h;const Ce=Le?o.filter(v=>v.gc_type===me).length:0,Ae=Ce>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ce}</div>`:"",qe=(ue==null?void 0:ue.gc_type)==="ultra_game_changer",Ge={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Se={purple:"#b06ce0",light_blue:"#00d4ef"},B=Ge[ue==null?void 0:ue.color]||Ge.purple,$=Se[ue==null?void 0:ue.color]||Se.purple,g=(ue==null?void 0:ue.effect)||ne.desc||"",b=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:((h=ue==null?void 0:ue.club)==null?void 0:h.logo_url)||(ue!=null&&ue.country_code?`https://flagsapi.com/${$def.country_code.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`:null);return Le&&Ie?`<div data-gc-id="${Ie.id}" data-gc-type="${me}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${$};background:${B};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${$}66;cursor:pointer">
          ${Ae}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${b?`<img src="${b}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${ne.icon}</span>`}
          </div>
        ...
        </div>`},({type:me,gc:ne,def:ue,owned:Le})=>{const Ie=window.innerWidth>=768?.76:.54,Ce={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Ae={purple:"#9b59b6",light_blue:"#00bcd4"},qe=Ce[ue==null?void 0:ue.color]||Ce.purple,Ge=Ae[ue==null?void 0:ue.color]||Ae.purple,Se=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:null;return Le?`<div style="display:inline-block;zoom:${Ie};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${qe};border:1px solid ${Ge};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${me}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${Se?`<img src="${Se}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${ne.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((ue==null?void 0:ue.effect)||ne.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${Ie};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${ne.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${me}</span></div></div>`},({type:me,owned:ne,def:ue})=>{ne&&pn(me,ue,s)})}function de(H){const ee="#E87722",xe="/";if(!p.length){H.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const le={};p.forEach(ne=>{const ue=ne.stadium_id||"?";(le[ue]=le[ue]||[]).push(ne)});const me=Object.entries(le).map(([ne,ue])=>({sid:ne,def:c[ne]||null,count:ue.length,card:ue[0]}));oe(me,({def:ne,count:ue})=>{var Ge,Se;const Le=(ne==null?void 0:ne.name)||"?",Ie=((Ge=ne==null?void 0:ne.club)==null?void 0:Ge.encoded_name)||(ne==null?void 0:ne.country_code)||"—",Ce=ne!=null&&ne.image_url?`${xe}icons/${ne.image_url}`:((Se=ne==null?void 0:ne.club)==null?void 0:Se.logo_url)||(ne!=null&&ne.country_code?`https://flagsapi.com/${$def.country_code.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`:null),Ae=Ce?`<img src="${Ce}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',qe=ue>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ue}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${ee},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${ee}66">
          ${qe}
        ...
        </div>`},({def:ne,count:ue})=>{var Ge,Se;const Le=window.innerWidth>=768?.76:.54,Ie=(ne==null?void 0:ne.name)||"?",Ce=((Ge=ne==null?void 0:ne.club)==null?void 0:Ge.encoded_name)||(ne==null?void 0:ne.country_code)||"—",Ae=ne!=null&&ne.image_url?`${xe}icons/${ne.image_url}`:((Se=ne==null?void 0:ne.club)==null?void 0:Se.logo_url)||(ne!=null&&ne.country_code?`https://flagsapi.com/${$def.country_code.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`:null),qe=Ae?`<img src="${Ae}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${Le};line-height:0;pointer-events:none">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Wt=1e3;function un(e,t,i,n){var _,f,c;const{state:d,toast:s,closeModal:r,navigate:l,refreshProfile:m}=i,a=e.formation,o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function y(){const z=Ht[a]||{},u=ki[a]||[],M=290,F=360,C=20;function q(N){const X=z[N];return X?{x:X.x*M,y:X.y*F}:null}let j=`<svg width="${M}" height="${F}" viewBox="0 0 ${M} ${F}" xmlns="http://www.w3.org/2000/svg">`;for(const[N,X]of u){const K=q(N),re=q(X);!K||!re||(j+=`<line x1="${K.x}" y1="${K.y}" x2="${re.x}" y2="${re.y}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(_=document.getElementById("direct-sell-form-btn"))==null||_.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${a} pour ${Wt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const z=p.find(M=>!M.is_for_sale)||p[0];if(!z){s("Aucune carte à vendre","error");return}await T.from("market_listings").delete().eq("card_id",z.id),await T.from("transfer_history").delete().eq("card_id",z.id);const{error:u}=await T.from("cards").delete().eq("id",z.id);if(u){s(u.message,"error");return}await T.from("users").update({credits:(d.profile.credits||0)+Wt}).eq("id",d.profile.id),await m(),s(`+${Wt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),l("collection")}),(f=document.getElementById("market-sell-form-btn"))==null||f.addEventListener("click",async()=>{const z=parseInt(document.getElementById("sell-price-form").value);if(!z||z<1){s("Prix invalide","error");return}await T.from("cards").update({is_for_sale:!0,sale_price:z}).eq("id",e.id),await T.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:z}),s("Carte mise en vente sur le marché !","success"),r(),l("collection")}),(c=document.getElementById("cancel-sell-form-btn"))==null||c.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),r(),l("collection")})}async function Oi(e,t,i,n){var ge,_e,we,ve,Ee;const{state:d,toast:s,openModal:r,closeModal:l,navigate:m,refreshProfile:a}=n,o=e.player,y=t.filter(se=>se.player.id===o.id),p=y.length,x=e.evolution_bonus||0,_=Math.max((Number(o.note_g)||0)+(o.job==="GK"||o.job2==="GK"?x:0),(Number(o.note_d)||0)+(o.job==="DEF"||o.job2==="DEF"?x:0),(Number(o.note_m)||0)+(o.job==="MIL"||o.job2==="MIL"?x:0),(Number(o.note_a)||0)+(o.job==="ATT"||o.job2==="ATT"?x:0)),f=o.rarity||"normal",{data:c}=await T.from("sell_price_configs").select("*").eq("rarity",f).lte("note_min",_).gte("note_max",_).order("note_min",{ascending:!1}).limit(1);((ge=c==null?void 0:c[0])==null?void 0:ge.price)??rn[f];const z=o.rarity!=="legende";ln(o);const u=((o.rarity==="pepite"||o.rarity==="papyte")&&e.current_note!=null?e.current_note:ui(o,o.job))+x,M=o.rarity==="pepite"||o.rarity==="papyte",F=o.job2?(M?co(e,sn(o.job2)):ui(o,o.job2))+(ui(o,o.job2)>0?x:0):null;pi[o.job],o.job2&&pi[o.job2];const C=on[o.rarity]||"#ccc";dn[o.country_code]||o.country_code;const q=e.evolution_bonus||0,N=u+q,X=F||0,K=X>0?X+q:0,re=y.map(se=>se.id);let ie={};if(re.length){const{data:se}=await T.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",re).order("transferred_at",{ascending:!0});(se||[]).forEach(pe=>{ie[pe.card_id]||(ie[pe.card_id]=[]),ie[pe.card_id].push(pe)})}const Z=se=>{const pe=se.transferred_at?new Date(se.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",de=se.source==="booster"?"Booster":se.price?se.price.toLocaleString("fr"):"—";return`
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${y.map((se,pe)=>{const de=ie[se.id]||[],H=se.is_for_sale,ee=de.length?de[de.length-1]:null,le=(o.rarity==="pepite"||o.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
            <div data-card-id="${se.id}" data-card-idx="${pe}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${pe+1}${le}${H?" 🏷️ En vente":""}</div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",l);let G=new Set;const oe=()=>{const se=G.size,pe=document.getElementById("sell-action-panel");if(!pe)return;pe.style.display=se>0?"block":"none",document.getElementById("sell-selected-count").textContent=se;const de=document.getElementById("evolve-btn");de&&(de.textContent=`⬆️ Évoluer ${se>1?"(+"+se+")":""}`)};document.querySelectorAll(".expl-check").forEach(se=>{se.addEventListener("change",()=>{const pe=se.dataset.id;se.checked?G.add(pe):G.delete(pe);const de=se.closest(".exemplaire-row");de&&(de.style.borderColor=se.checked?"#1A6B3C":"#eee"),oe()})}),document.querySelectorAll(".exemplaire-row").forEach(se=>{se.addEventListener("click",pe=>{if(pe.target.closest("button")||pe.target.tagName==="INPUT")return;const de=se.querySelector(".expl-check");de&&!de.disabled&&(de.checked=!de.checked,de.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(se=>{se.addEventListener("click",pe=>{pe.stopPropagation();const de=document.querySelector(`.expl-hist[data-hist="${se.dataset.idx}"]`);de&&(de.style.display=de.style.display==="none"?"flex":"none")})}),(we=document.getElementById("evolve-btn"))==null||we.addEventListener("click",async()=>{if(p<=1)return;const se=[...G];if(!se.length)return;if(G.has(e.id)){const me=document.createElement("div");me.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",me.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            ${F&&F>0?`<br>📈 Note 2 : <strong>${F+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${F+(e.evolution_bonus||0)+pe.length*de}</strong>`:""}
  ...
  `,document.body.appendChild(d);let s=!1;const r=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let m=!1;const a=R=>R.touches&&R.touches[0]?R.touches[0].clientX:R.clientX;function o(R){s||(m=!0,l.style.opacity="1",y(R))}function y(R){if(!m||s)return;const G=r.getBoundingClientRect(),oe=a(R)-G.left,ge=Math.max(0,Math.min(1,oe/G.width));l.style.width=ge*G.width+"px",ge>=.82&&x()}function p(){s||(m=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{s||(l.style.transition="")},220))}function x(){var G;if(s)return;s=!0,m=!1,l.style.width="100%",l.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const R=document.getElementById("cut-hint");R&&(R.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",z(0)},620)}r.addEventListener("pointerdown",o),window.addEventListener("pointermove",y),window.addEventListener("pointerup",p),r.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",y,{passive:!0}),window.addEventListener("touchend",p);let _=0,f=!1;const c=new Set;function z(R){_=R,document.getElementById("reveal-phase").style.display="flex",u(),M(R,0),N()}function u(){const R=document.getElementById("card-dots");R&&(R.innerHTML=e.map((G,oe)=>`<div class="card-dot" data-i="${oe}" style="width:8px;height:8px;border-radius:50%;background:${oe===_?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),R.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>C(parseInt(G.dataset.i)))))}function M(R,G){var de;const oe=e[R],ge=document.getElementById("card-counter"),_e=document.getElementById("card-track");ge&&(ge.textContent=`Carte ${R+1} / ${e.length}`);const we=document.getElementById("reveal-btns");we&&(we.style.display=R===e.length-1?"flex":"none");const ve=oe.card_type==="player"&&((de=oe.player)==null?void 0:de.rarity)==="legende",Ee=!c.has(R);c.add(R);let se=0;if(oe.card_type==="player"&&oe.player){const H=oe.player,ee=H.job||"ATT";se=Number(ee==="GK"?H.note_g:ee==="DEF"?H.note_d:ee==="MIL"?H.note_m:H.note_a)||0}const pe=H=>{_e.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${ve?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${zn(oe)}</div>
        ...
        </div>`;const ee=document.getElementById("current-card-wrap");G!==0?(ee.style.transition="none",ee.style.transform=`translateX(${G>0?100:-100}%)`,requestAnimationFrame(()=>{ee.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ee.style.transform="translateX(0)"})):ee.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),H||ve?K():re(),u()};Ee&&se>6&&oe.card_type==="player"&&oe.player?F(oe,()=>pe(!0)):pe(!1)}function F(R,G){var se;f=!0;const oe=R.player,ge=`https://flagsapi.com/${oe.country_code}/flat/64.png`,_e=(se=oe.clubs)==null?void 0:se.logo_url,we=document.getElementById("walkout-overlay"),ve=document.getElementById("walkout-stage");if(!we||!ve){f=!1,G();return}we.style.display="flex";const Ee=()=>{const pe=ve.firstElementChild;pe&&(pe.classList.remove("wo-in"),pe.classList.add("wo-out"))};ve.innerHTML=`<img class="wo-in" src="${ge}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(Ee,2e3),setTimeout(()=>{var pe;ve.innerHTML=_e?`<img class="wo-in" src="${_e}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((pe=oe.clubs)==null?void 0:pe.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(Ee,4450),setTimeout(()=>{we.style.display="none",ve.innerHTML="",f=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),G()},4900)}function C(R){if(f||R<0||R>=e.length||R===_)return;const G=R>_?1:-1;_=R,M(R,G)}function q(){C(_+1)}function j(){C(_-1)}function N(){const R=document.getElementById("card-viewport");if(!R||R._swipeBound)return;R._swipeBound=!0;let G=0,oe=0,ge=0,_e=!1;const we=de=>de.touches?de.touches[0].clientX:de.clientX,ve=de=>de.touches?de.touches[0].clientY:de.clientY,Ee=de=>{_e=!0,G=we(de),oe=ve(de),ge=0},se=de=>{if(!_e)return;ge=we(de)-G;const H=ve(de)-oe;if(Math.abs(ge)<Math.abs(H))return;const ee=document.getElementById("current-card-wrap");ee&&(ee.style.transition="none",ee.style.transform=`translateX(${ge*.6}px) rotate(${ge*.02}deg)`)},pe=()=>{if(!_e)return;_e=!1;const de=document.getElementById("current-card-wrap"),H=55;ge<=-H&&_<e.length-1?q():ge>=H&&_>0?j():de&&(de.style.transition="transform .2s ease",de.style.transform="translateX(0)")};R.addEventListener("pointerdown",Ee),R.addEventListener("pointermove",se),R.addEventListener("pointerup",pe),R.addEventListener("pointercancel",pe),R.addEventListener("touchstart",Ee,{passive:!0}),R.addEventListener("touchmove",se,{passive:!0}),R.addEventListener("touchend",pe),R.addEventListener("click",de=>{if(Math.abs(ge)>8)return;const H=R.getBoundingClientRect();de.clientX-H.left>H.width/2?q():j()})}let X=null;function K(){const R=document.getElementById("fireworks-canvas");if(!R)return;R.width=window.innerWidth,R.height=window.innerHeight;const G=R.getContext("2d"),oe=[];function ge(){const we=Math.random()*R.width,ve=Math.random()*R.height*.6,Ee=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],se=Ee[Math.floor(Math.random()*Ee.length)];for(let pe=0;pe<60;pe++){const de=Math.PI*2/60*pe,H=2+Math.random()*5;oe.push({x:we,y:ve,vx:Math.cos(de)*H,vy:Math.sin(de)*H,alpha:1,color:se,size:2+Math.random()*3})}}ge(),X=setInterval(ge,600);function _e(){if(document.getElementById("fireworks-canvas")){G.clearRect(0,0,R.width,R.height);for(let we=oe.length-1;we>=0;we--){const ve=oe[we];if(ve.x+=ve.vx,ve.y+=ve.vy+.08,ve.vy*=.98,ve.alpha-=.018,ve.alpha<=0){oe.splice(we,1);continue}G.globalAlpha=ve.alpha,G.fillStyle=ve.color,G.beginPath(),G.arc(ve.x,ve.y,ve.size,0,Math.PI*2),G.fill()}G.globalAlpha=1,(X!==null||oe.length>0)&&requestAnimationFrame(_e)}}_e()}function re(){X!==null&&(clearInterval(X),X=null);const R=document.getElementById("fireworks-canvas");R&&R.getContext("2d").clearRect(0,0,R.width,R.height)}if(n){const R=document.getElementById("reveal-btns");R&&(R.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(Z=document.getElementById("reveal-next"))==null||Z.addEventListener("click",()=>{re(),d.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{re(),d.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{re(),d.remove(),i("boosters")})}function zn(e){var t,i,n,d;if(e.card_type==="player"&&e.player)return kn(e);if(e.card_type==="game_changer"){const s=e._gcDef,r=(s==null?void 0:s.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},m={purple:"#b06ce0",light_blue:"#00d4ef"},a=l[s==null?void 0:s.color]||l.purple,o=m[s==null?void 0:s.color]||m.purple,y=(s==null?void 0:s.name)||e.gc_type||"Game Changer",p=(s==null?void 0:s.effect)||((t=bi[e.gc_type])==null?void 0:t.desc)||"",x=s!=null&&s.image_url?`/icons/${s.image_url}`:null,_=((i=bi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${a};border-radius:14px;border:3px solid ${o};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${o}88;flex-shrink:0">
    ...
    </div>`;if(e.card_type==="stadium"){const s=e._stadiumDef,r=(s==null?void 0:s.name)||"Stade",l=((n=s==null?void 0:s.club)==null?void 0:n.encoded_name)||(s==null?void 0:s.country_code)||"—",m=s!=null&&s.image_url?`/icons/${s.image_url}`:((d=s==null?void 0:s.club)==null?void 0:d.logo_url)||(s!=null&&s.country_code?`https://flagsapi.com/${$def.country_code.toLowerCase().slice(0,2).toUpperCase()}/flat/64.png`:null);return`<div style="width:160px;height:230px;background:linear-gradient(160deg,#E87722,#c45a00);border-radius:14px;border:3px solid #c45a00;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px rgba(232,119,34,0.6)">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),m=[...new Set((l||[]).filter(p=>{var x,_;return((x=p.card)==null?void 0:x.card_type)==="stadium"&&((_=p.card)==null?void 0:_.stadium_id)}).map(p=>p.card.stadium_id))],a={};if(m.length){const{data:p}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",m);(p||[]).forEach(x=>{a[x.id]=x}),(l||[]).forEach(x=>{var _,f;((_=x.card)==null?void 0:_.card_type)==="stadium"&&((f=x.card)!=null&&f.stadium_id)&&(x.card._stadiumDef=a[x.card.stadium_id]||null)})}let o=0;function y(){var C,q,j,N,X,K,re;const p=s[o],x=(l||[]).filter(ie=>ie.deck_id===p.id),_=x.filter(ie=>{var Z;return ie.is_starter&&((Z=ie.card)==null?void 0:Z.player)}).map(ie=>vi(ie.card,ie.position)),f=x.find(ie=>{var Z;return((Z=ie.card)==null?void 0:Z.card_type)==="formation"}),c=p.formation||((C=f==null?void 0:f.card)==null?void 0:C.formation)||"4-4-2";let z=_.length>=11?bt(_,c):null,u=((q=p.stadium_card)==null?void 0:q.stadium_def)||null;u&&z&&(z=Tt(z,u));const M=_.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${y}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${s?`<img src="${s}" style="width:${y-4}px;height:${y-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,y-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${K}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const x=48,_=64,f=13,c=16,z={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[F,C]of Object.entries(a)){const q=y(F);if(!q||!C)continue;const j=F.replace(/[0-9]/g,""),N=jt[j]||"#555",X=r.includes(C.cardId),K=i==="attack"&&(["MIL","ATT"].includes(j)||X)&&!C.used||i==="defense"&&["GK","DEF","MIL"].includes(j)&&!C.used,re=n.includes(C.cardId);let ie;i==="attack"?ie=X?Math.max(1,Number(C.note_a)||0):j==="MIL"?Number(C.note_m)||0:Number(C.note_a)||0:i==="defense"?ie=j==="GK"?Number(C.note_g)||0:j==="MIL"?Number(C.note_m)||0:Number(C.note_d)||0:ie=Number(j==="GK"?C.note_g:j==="DEF"?C.note_d:j==="MIL"?C.note_m:C.note_a)||0,ie=ie+(C.boost||0),C.stadiumBonus&&(i==="attack"&&(j==="ATT"||j==="MIL")||i==="defense"&&(j==="GK"||j==="DEF"||j==="MIL")?ie+=10:i||(ie+=10));const Z=(q.x-x/2).toFixed(1),R=(q.y-_/2).toFixed(1),G=z[C==null?void 0:C.rarity]||z.normal;if(C.used){const se=typeof import.meta<"u"&&"/"||"/",de=`${typeof window<"u"&&((M=window.location)==null?void 0:M.origin)||""}${se}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="#161616"/>`,p+=`<image href="${de}" xlink:href="${de}" x="${Z}" y="${R}" width="${x}" height="${_}" preserveAspectRatio="xMidYMid slice"/>`,p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="none" stroke="${G}" stroke-width="2" opacity="0.7"/>`,p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`;continue}const oe=re?.45:1,ge=re?"#FFD700":G,_e=re?3:(C==null?void 0:C.rarity)==="legende"||(C==null?void 0:C.rarity)==="légende"||(C==null?void 0:C.rarity)==="pepite"||(C==null?void 0:C.rarity)==="pépite"?2.5:2,we=_-f-c;p+=`<defs><clipPath id="cp-${F}"><rect x="${Z}" y="${(q.y-_/2+f).toFixed(1)}" width="${x}" height="${we}"/></clipPath></defs>`,p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="${N}" opacity="${oe}"/>`;const ve=Ne(C);ve&&(p+=`<image href="${ve}" xlink:href="${ve}" x="${Z}" y="${(q.y-_/2+f).toFixed(1)}" width="${x}" height="${we}" clip-path="url(#cp-${F})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${Z}" y="${R}" width="${x}" height="${f}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${q.x.toFixed(1)}" y="${(q.y-_/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(C.name||"").slice(0,9)}</text>`;const Ee=(q.y+_/2-c).toFixed(1);p+=`<rect x="${Z}" y="${Ee}" width="${x}" height="${c}" fill="rgba(255,255,255,0.92)"/>`;{const se=ei(C.country_code);se?p+=`<image href="${se}" xlink:href="${se}" x="${(q.x-20).toFixed(1)}" y="${(q.y+_/2-c+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(q.x-13).toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${_o(C.country_code)}</text>`;const pe=C.stadiumBonus?"#E87722":"#111";p+=`<text x="${q.x.toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${pe}" font-family="Arial Black">${ie}</text>`;const de=wo(C);de?p+=`<image href="${de}" xlink:href="${de}" x="${(q.x+x/2-14).toFixed(1)}" y="${(q.y+_/2-c+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:C.clubName&&(p+=`<text x="${(q.x+14).toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(C.clubName||"").slice(0,3).toUpperCase()}</text>`),C.stadiumBonus&&(p+=`<rect x="${(q.x-x/2).toFixed(1)}" y="${(q.y-_/2).toFixed(1)}" width="${x}" height="${_}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="${re?"rgba(255,255,255,0.12)":"none"}" stroke="${ge}" stroke-width="${_e}" opacity="${oe}"/>`,K&&(p+=`<rect x="${Z}" y="${R}" width="${x}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${re?"selected":""}" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`)}const u=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${d+u*2} ${s+u*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>Nn(e,t,i),5e3)}function Nn(e,t,i){const n=t.homeTeam.MIL||[],d=t.aiTeam.MIL||[],s=t.stadiumDef||null,r=t.aiStadiumDef||null;function l(u,M){const F=Te(u,"MIL"),C=u.evolution_bonus||u._evolution_bonus||0,q=u.job==="MIL"||u.job2==="MIL"?C:0,j=u.stadiumBonus||M&&(M.club_id&&String(u.club_id)===String(M.club_id)||M.country_code&&u.country_code===M.country_code)?10:0;return F+q+j}function m(u,M){return u.reduce((F,C)=>F+l(C,M),0)}function a(u){let M=0;for(let F=0;F<u.length-1;F++){const C=nt(u[F],u[F+1]);C==="#00ff88"?M+=2:C==="#FFD700"&&(M+=1)}return M}const o=m(n,s)+a(n),y=m(d,r)+a(d),p=o>=y;function x(u,M,F,C,q){return`<div id="duel-row-${C}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${u.map((j,N)=>{const X=N<u.length-1?nt(j,u[N+1]):null,K=!X||X==="#ff3333"||X==="#cc2222",re=X==="#00ff88"?"+2":X==="#FFD700"?"+1":"";l(j,q),j.stadiumBonus||q&&(q.club_id&&String(j.club_id)===String(q.club_id)||q.country_code&&(j.country_code,q.country_code));const ie=j.evolution_bonus||j._evolution_bonus||0;return`
          <div class="duel-card duel-card-${C}" data-idx="${N}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${Xe({...j,_evolution_bonus:ie},58,78,q)}
          </div>
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
  </div>`;const _=()=>{const u=(M,F)=>e.querySelectorAll(M).forEach((C,q)=>{setTimeout(()=>{C.style.opacity="1",C.style.transform="translateY(0) scale(1)"},F+q*90)});u(".duel-card-home",150),u(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((M,F)=>{setTimeout(()=>{M.style.opacity="1"},F*70)}),900),setTimeout(()=>{const M=e.querySelector("#vs-label");M&&(M.style.opacity="1",M.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(F=>F.style.opacity="1")},1250),setTimeout(()=>{f("score-home",o,800),f("score-ai",y,800)},1500)};function f(u,M,F){const C=document.getElementById(u);if(!C)return;const q=performance.now(),j=N=>{const X=Math.min(1,(N-q)/F);C.textContent=Math.round(M*(1-Math.pow(1-X,3))),X<1?requestAnimationFrame(j):C.textContent=M};requestAnimationFrame(j)}requestAnimationFrame(_),t.attacker=p?"home":"ai";const c=p?ai():null;p&&(t.boostCard={value:c}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:n.map(u=>({name:u.name,note:Te(u,"MIL"),portrait:Ne(u),job:u.job,country_code:u.country_code,rarity:u.rarity,clubName:u.clubName,clubLogo:u.clubLogo})),aiPlayers:d.map(u=>({name:u.name,note:Te(u,"MIL"),portrait:Ne(u),job:u.job,country_code:u.country_code,rarity:u.rarity,clubName:u.clubName,clubLogo:u.clubLogo})),homeTotal:o,aiTotal:y,text:`Duel milieu : ${t.clubName} ${o} – ${y} IA → ${p?t.clubName+" attaque":"IA attaque"}`});const z=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Je(e,t,i),t.attacker==="ai"&&setTimeout(()=>ti(e,t,i),800)};setTimeout(()=>{const u=document.getElementById("score-home"),M=document.getElementById("score-ai"),F=document.getElementById(p?"duel-row-home":"duel-row-ai"),C=document.getElementById(p?"duel-row-ai":"duel-row-home"),q=p?u:M,j=p?M:u;q&&(q.style.fontSize="80px",q.style.color=p?"#FFD700":"#ff6b6b",q.style.animation="duelPulse .5s ease"+(p?", duelGlow 1.5s ease infinite .5s":"")),j&&(j.style.opacity="0.25"),setTimeout(()=>{F&&(F.style.transformOrigin="center",F.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",F.style.zIndex="5"),setTimeout(()=>{var X;const N=document.getElementById("duel-shock");if(N){const K=(X=C||F)==null?void 0:X.getBoundingClientRect(),re=e.querySelector(".match-screen").getBoundingClientRect();K&&(N.style.top=K.top-re.top+K.height/2+"px"),N.style.animation="shockwave .5s ease-out forwards"}C&&(C.style.transformOrigin="center",C.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var X;const N=document.getElementById("duel-finale");N&&(N.innerHTML=`
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,N.style.transition="opacity .45s ease",N.style.opacity="1",N.style.pointerEvents="auto",(X=document.getElementById("start-match-btn"))==null||X.addEventListener("click",z))},600)},700)},2800)}function Rn(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const oe=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${it((oe.players||[]).map(ge=>({...ge,used:!1})),"#ff6b6b",oe.total)}
            ...
            ${it((oe.players||[]).map(ge=>({...ge,used:!1})),"#00ff88",oe.total)}
    ...
    ${(()=>{const G=window.innerWidth>=700,oe=(H,ee,xe)=>{var B,$;const le=(t.gcDefs||[]).find(g=>g.name===H.gc_type),me={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[le==null?void 0:le.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ne={purple:"#b06ce0",light_blue:"#00d4ef"}[le==null?void 0:le.color]||"#b06ce0",ue=(le==null?void 0:le.name)||H.gc_type,Le=(le==null?void 0:le.effect)||((B=He[H.gc_type])==null?void 0:B.desc)||"",Ie=le!=null&&le.image_url?`/icons/${le.image_url}`:null,Ce=(($=He[H.gc_type])==null?void 0:$.icon)||"⚡",Ae=Math.round(xe*.22),qe=Math.round(xe*.22),Ge=xe-Ae-qe,Se=ue.length>12?7:9;return`<div class="gc-mini" data-gc-id="${H.id}" data-gc-type="${H.gc_type}"
          style="box-sizing:border-box;width:${ee}px;height:${xe}px;border-radius:10px;border:2px solid ${ne};background:${me};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        ...
        </div>`},ge=(H,ee)=>{var xe;return`<div id="boost-card"
          style="box-sizing:border-box;width:${H}px;height:${ee}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(ee*.04)}px;text-align:center;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(G=>{var oe,ge,_e;if(G.type==="duel"){const we=G.isGoal,ve=G.homeScored?"#FFD700":we?"#ff6b6b":"rgba(255,255,255,0.3)",Ee=G.homeScored?"⚽ BUT !":we?"⚽ BUT IA !":(oe=G.homePlayers)!=null&&oe.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${we?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${ve};margin-bottom:4px">
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const m=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",m),setTimeout(m,3500)}async function Gt(e,t,i){var o,y;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,r=d?"victoire":s?"nul":"defaite",l=en(t.mode,r);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?n.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const m={credits:(n.profile.credits||0)+l,matches_played:(n.profile.matches_played||0)+1};d?m.wins=(n.profile.wins||0)+1:s?m.draws=(n.profile.draws||0)+1:m.losses=(n.profile.losses||0)+1,await T.from("users").update(m).eq("id",n.profile.id),await i.refreshProfile();const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",a.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(w);let E=!1;const L=()=>{E||(E=!0,w.remove(),setTimeout(()=>v(),50))};w.addEventListener("click",L),setTimeout(L,3500)}function se($,g,b){var U,P;const h=(u.gcDefs||[]).find(Y=>{var te;return Y.name===$||((te=Y.name)==null?void 0:te.toLowerCase().trim())===($==null?void 0:$.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",k=(h==null?void 0:h.name)||$,A=(h==null?void 0:h.effect)||((U=He[$])==null?void 0:U.desc)||"",E=h!=null&&h.image_url?`/icons/${h.image_url}`:null,L=((P=He[$])==null?void 0:P.icon)||"⚡",I=g===p?"Vous":u[g+"Name"]||"Adversaire",D=document.createElement("div");D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",D.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:${w};letter-spacing:3px;text-transform:uppercase;font-weight:700;animation:gcLabel .4s ease both">${I} joue une carte</div>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(D);let V=!1;const W=()=>{V||(V=!0,D.remove(),setTimeout(()=>b&&b(),50))};D.addEventListener("click",W),setTimeout(W,3e3)}function pe($,g){var D,V,W,U;const h=(u["gcCardsFull_"+p]||[]).find(P=>P.id===$),v=h==null?void 0:h._gcDef,w={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",k={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",A=(v==null?void 0:v.name)||g,E=(v==null?void 0:v.effect)||((D=He[g])==null?void 0:D.desc)||"Carte spéciale.",L=v!=null&&v.image_url?`/icons/${v.image_url}`:null,S=((V=He[g])==null?void 0:V.icon)||"⚡",I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",I.innerHTML=`
      ...
      </div>`,document.body.appendChild(b),(h=b.querySelector("#bp-close"))==null||h.addEventListener("click",()=>b.remove()),b.querySelectorAll(".bp-item").forEach(v=>{v.addEventListener("click",async()=>{const w=v.dataset.cid,k=g.find(E=>E.cardId===w);if(!k)return;const A=($[k._line]||[]).find(E=>E.cardId===w);A&&(A.boost=(A.boost||0)+u.boostValue),b.remove(),await K({[p+"Team"]:$,boostUsed:!0})})})}function H($=null){var V,W;if(!(u.phase===p+"-attack")){y("Remplacement uniquement avant votre attaque","warning");return}const b=u[p+"Team"],h=u["usedSubIds_"+p]||[],v=u.maxSubs||3;if(h.length>=v){y(`Maximum ${v} remplacements atteint`,"warning");return}const w=Object.entries(b).flatMap(([U,P])=>(P||[]).filter(Y=>Y.used).map(Y=>({...Y,_line:U}))),k=(u[p+"Subs"]||[]).filter(U=>!h.includes(U.cardId));if(!w.length){y("Aucun joueur utilisé à remplacer","warning");return}if(!k.length){y("Aucun remplaçant disponible","warning");return}let A=Math.max(0,w.findIndex(U=>U.cardId===$));const E=((V=w[A])==null?void 0:V._line)||((W=w[A])==null?void 0:W.job);let L=Math.max(0,k.findIndex(U=>U.job===E)),S=!1;const I=document.createElement("div");I.id="pvp-sub-overlay",I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function D(){var ye,be,ke,Be,Fe,Me;const U=w[A],P=k[L],Y=Math.min(130,Math.round((window.innerWidth-90)/2)),te=Math.round(Y*1.35),Q=je=>`background:rgba(255,255,255,0.12);border:none;color:${je?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${je?"default":"pointer"};flex-shrink:0`;I.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(ye=I.querySelector("#psub-close"))==null||ye.addEventListener("click",()=>I.remove()),(be=I.querySelector("#pout-up"))==null||be.addEventListener("click",()=>{A>0&&(A--,D())}),(ke=I.querySelector("#pout-down"))==null||ke.addEventListener("click",()=>{A<w.length-1&&(A++,D())}),(Be=I.querySelector("#pin-up"))==null||Be.addEventListener("click",()=>{L>0&&(L--,D())}),(Fe=I.querySelector("#pin-down"))==null||Fe.addEventListener("click",()=>{L<k.length-1&&(L++,D())});const fe=(je,ze,Re,Ue)=>{const Ye=I.querySelector("#"+je);if(!Ye)return;let Ke=0;Ye.addEventListener("touchstart",Oe=>{Ke=Oe.touches[0].clientY},{passive:!0}),Ye.addEventListener("touchend",Oe=>{const Pe=Oe.changedTouches[0].clientY-Ke;if(Math.abs(Pe)<30)return;const We=ze();Pe<0&&We<Ue-1?(Re(We+1),D()):Pe>0&&We>0&&(Re(We-1),D())},{passive:!0})};fe("pin-panel",()=>L,je=>L=je,k.length),fe("pout-panel",()=>A,je=>A=je,w.length),(Me=I.querySelector("#psub-confirm"))==null||Me.addEventListener("click",async je=>{if(je.preventDefault(),je.stopPropagation(),S)return;S=!0;const ze=w[A],Re=k[L];if(!ze||!Re)return;const Ue=ze._line,Ye=(b[Ue]||[]).findIndex(Pe=>Pe.cardId===ze.cardId);if(Ye===-1){y("Erreur : joueur introuvable","error"),I.remove();return}const Ke={...Re,_line:Ue,position:ze.position,used:!1,boost:0};b[Ue].splice(Ye,1,Ke);const Oe=[...h,Re.cardId];I.remove(),ee(ze,Re,async()=>{await K({[p+"Team"]:b,[x+"Team"]:u[x+"Team"],["usedSubIds_"+p]:Oe})})})}document.body.appendChild(I),D()}function ee($,g,b){const h={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const w=(E,L,S)=>`<div style="text-align:center">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(L=v.querySelector("#pvp-end-home"))==null||L.addEventListener("click",()=>{v.remove(),Ve(e),l("home")})}const N=T.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},B=>{const $=B.new;try{if($.status==="finished"||$.forfeit){if(c)return;c=!0,M&&(clearInterval(M),M=null),$.game_state&&(f=$.game_state),j($);return}if($.game_state){const g=f;f=$.game_state;const b=f._lastGC;if(b&&b.seq&&!q.has(b.seq)&&(q.add(b.seq),b.by!==a)){Ee(b.type,b.by,()=>oe());return}const h=g[a+"Score"]||0,v=g[o+"Score"]||0,w=f[a+"Score"]||0,k=f[o+"Score"]||0,A=w>h,E=k>v;if((A||E)&&!C.has(f.round)){C.add(f.round);const L=[...f.log||[]].reverse().find(I=>I.isGoal),S=((L==null?void 0:L.homePlayers)||[]).map(I=>({name:I.name,note:I.note,portrait:I.portrait,job:I.job}));ve(S,w,k,A,()=>oe());return}oe()}}catch(g){console.error("[PvP] crash:",g)}}).subscribe();async function X(B){Object.assign(f,B),f.lastActionAt=new Date().toISOString();const{error:$}=await T.from("matches").update({game_state:f}).eq("id",i);$&&m("Erreur de synchronisation","error");try{oe()}catch(g){console.error("[PvP] renderPvpScreen crash:",g)}}async function K(){if(c)return;c=!0,M&&(clearInterval(M),M=null);const B=n?x.away_id:x.home_id,$=n?"p2":"p1",g=n?"p1":"p2",b={...f,[$+"Score"]:3,[g+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:B,home_score:b.p1Score||0,away_score:b.p2Score||0,game_state:b}).eq("id",i)}catch{}try{T.removeChannel(N)}catch{}setTimeout(()=>{Ve(e),l("home")},800)}const re={BOOST_STAT:({value:B=1,count:$=1,roles:g=[]},b,h)=>{const v=b[a+"Team"],w=Object.entries(v).filter(([k])=>!g.length||g.includes(k)).flatMap(([k,A])=>A.filter(E=>!E.used).map(E=>({...E,_line:k})));if(!w.length){b.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),h(b);return}ie(w,$,`Choisir ${$} joueur(s) à booster (+${B})`,k=>{k.forEach(A=>{const E=(v[A._line]||[]).find(L=>L.cardId===A.cardId);E&&(E.boost=(E.boost||0)+B,b.log.push({text:`⚡ +${B} sur ${E.name}`,type:"info"}))}),b[a+"Team"]=v,h(b)})},DEBUFF_STAT:({value:B=1,count:$=1,roles:g=[],target:b="ai"},h,v)=>{const w=b==="home"?a:o,k=h[w+"Team"],A=b==="home"?"allié":"adverse",E=Object.entries(k).filter(([L])=>!g.length||g.includes(L)).flatMap(([L,S])=>S.map(I=>({...I,_line:L})));if(!E.length){h.log.push({text:`🎯 Aucun joueur ${A}`,type:"info"}),v(h);return}ie(E,$,`Choisir ${$} joueur(s) ${A}(s) (-${B})`,L=>{L.forEach(S=>{const I=(k[S._line]||[]).find(D=>D.cardId===S.cardId);I&&(I.boost=(I.boost||0)-B,h.log.push({text:`🎯 -${B} sur ${I.name}`,type:"info"}))}),h[w+"Team"]=k,v(h)})},GRAY_PLAYER:({count:B=1,roles:$=[],target:g="ai"},b,h)=>{const v=g==="home"?a:o,w=b[v+"Team"],k=g==="home"?"allié":"adverse",A=Object.entries(w).filter(([E])=>!$.length||$.includes(E)).flatMap(([E,L])=>L.filter(S=>!S.used).map(S=>({...S,_line:E})));if(!A.length){b.log.push({text:`❌ Aucun joueur ${k}`,type:"info"}),h(b);return}ie(A,B,`Choisir ${B} joueur(s) ${k}(s) à exclure`,E=>{const L="usedCardIds_"+v,S=new Set(b[L]||[]);E.forEach(I=>{const D=(w[I._line]||[]).find(V=>V.cardId===I.cardId);D&&(D.used=!0,S.add(I.cardId),b.log.push({text:`❌ ${D.name} exclu !`,type:"info"}))}),b[L]=[...S],b[v+"Team"]=w,h(b)})},REVIVE_PLAYER:({count:B=1,roles:$=[]},g,b)=>{const h=g[a+"Team"],v=Object.entries(h).filter(([w])=>!$.length||$.includes(w)).flatMap(([w,k])=>k.filter(A=>A.used).map(A=>({...A,_line:w})));if(!v.length){g.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),b(g);return}ie(v,B,`Choisir ${B} joueur(s) à ressusciter`,w=>{w.forEach(k=>{const A=(h[k._line]||[]).find(E=>E.cardId===k.cardId);A&&(A.used=!1,g.log.push({text:`💫 ${A.name} ressuscité !`,type:"info"}))}),g[a+"Team"]=h,b(g)})},REMOVE_GOAL:({},B,$)=>{const g=o+"Score";B[g]>0?(B[g]--,B.log.push({text:"🚫 Dernier but annulé !",type:"info"})):B.log.push({text:"🚫 Aucun but à annuler",type:"info"}),$(B)},ADD_GOAL_DRAW:({},B,$)=>{B[a+"Score"]===B[o+"Score"]?(B[a+"Score"]++,B.log.push({text:"🎯 But bonus !",type:"info"})):B.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),$(B)},ADD_SUB:({value:B=1},$,g)=>{$.maxSubs=($.maxSubs||3)+B,$.log.push({text:`🔄 +${B} remplacement(s)`,type:"info"}),g($)},CUSTOM:({},B,$)=>$(B)};function ie(B,$,g,b){const h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var A,E;const k=B.map(L=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",I=Te(L,L._line)+(L.boost||0),V=v.find(U=>U.cardId===L.cardId)?"#FFD700":"rgba(255,255,255,0.25)",W=L.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${V};background:${S};overflow:hidden;cursor:pointer;${W}">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="width:min(90vw,420px)">${lt(f[o+"Team"],f[o+"Formation"],null,[],300,300)}</div>
    </div>`,a==="p1"&&setTimeout(async()=>{await X({phase:"midfield"})},5e3)}let _e=!1;function we(){if(_e)return;const B=f[a+"Team"].MIL||[],$=f[o+"Team"].MIL||[];function g(U){return U.reduce((P,Y)=>P+Te(Y,"MIL"),0)}function b(U){let P=0;for(let Y=0;Y<U.length-1;Y++){const te=nt(U[Y],U[Y+1]);te==="#00ff88"?P+=2:te==="#FFD700"&&(P+=1)}return P}const h=g(B)+b(B),v=g($)+b($),w=h>=v;function k(U,P,Y){return`<div id="duel-row-${Y}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
        ...
        <div class="duel-score-line duel-score-line-${Y}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
          Score: ${g(U)} + ${b(U)} liens = <b style="color:#fff">${g(U)+b(U)}</b>
        </div>
      </div>`}et(e),e.innerHTML=`
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let A=!1;const E=()=>{A||(A=!0,v.remove(),setTimeout(()=>h(),50))};v.addEventListener("click",E),setTimeout(E,3500)}function Ee(B,$,g){var W,U;const b=(f.gcDefs||[]).find(P=>{var Y;return P.name===B||((Y=P.name)==null?void 0:Y.toLowerCase().trim())===(B==null?void 0:B.toLowerCase().trim())}),h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",w=(b==null?void 0:b.name)||B,k=(b==null?void 0:b.effect)||((W=He[B])==null?void 0:W.desc)||"",A=b!=null&&b.image_url?`/icons/${b.image_url}`:null,E=((U=He[B])==null?void 0:U.icon)||"⚡",S=$===a?"Vous":f[$+"Name"]||"Adversaire",I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",I.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(I);let D=!1;const V=()=>{D||(D=!0,I.remove(),setTimeout(()=>g&&g(),50))};I.addEventListener("click",V),setTimeout(V,3e3)}function se(B,$){var I,D,V,W;const b=(f["gcCardsFull_"+a]||[]).find(U=>U.id===B),h=b==null?void 0:b._gcDef,v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",w={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",k=(h==null?void 0:h.name)||$,A=(h==null?void 0:h.effect)||((I=He[$])==null?void 0:I.desc)||"Carte spéciale.",E=h!=null&&h.image_url?`/icons/${h.image_url}`:null,L=((D=He[$])==null?void 0:D.icon)||"⚡",S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(g),(b=g.querySelector("#bp-close"))==null||b.addEventListener("click",()=>g.remove()),g.querySelectorAll(".bp-item").forEach(h=>{h.addEventListener("click",async()=>{const v=h.dataset.cid,w=$.find(A=>A.cardId===v);if(!w)return;const k=(B[w._line]||[]).find(A=>A.cardId===v);k&&(k.boost=(k.boost||0)+f.boostValue),g.remove(),await X({[a+"Team"]:B,boostUsed:!0})})})}function de(B=null){var D,V;if(!(f.phase===a+"-attack")){m("Remplacement uniquement avant votre attaque","warning");return}const g=f[a+"Team"],b=f["usedSubIds_"+a]||[],h=f.maxSubs||3;if(b.length>=h){m(`Maximum ${h} remplacements atteint`,"warning");return}const v=Object.entries(g).flatMap(([W,U])=>(U||[]).filter(P=>P.used).map(P=>({...P,_line:W}))),w=(f[a+"Subs"]||[]).filter(W=>!b.includes(W.cardId));if(!v.length){m("Aucun joueur utilisé à remplacer","warning");return}if(!w.length){m("Aucun remplaçant disponible","warning");return}let k=Math.max(0,v.findIndex(W=>W.cardId===B));const A=((D=v[k])==null?void 0:D._line)||((V=v[k])==null?void 0:V.job);let E=Math.max(0,w.findIndex(W=>W.job===A)),L=!1;const S=document.createElement("div");S.id="pvp-sub-overlay",S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function I(){var fe,ye,be,ke,Be,Fe;const W=v[k],U=w[E],P=Math.min(130,Math.round((window.innerWidth-90)/2)),Y=Math.round(P*1.35),te=Me=>`background:rgba(255,255,255,0.12);border:none;color:${Me?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Me?"default":"pointer"};flex-shrink:0`;S.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(fe=S.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>S.remove()),(ye=S.querySelector("#pout-up"))==null||ye.addEventListener("click",()=>{k>0&&(k--,I())}),(be=S.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{k<v.length-1&&(k++,I())}),(ke=S.querySelector("#pin-up"))==null||ke.addEventListener("click",()=>{E>0&&(E--,I())}),(Be=S.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{E<w.length-1&&(E++,I())});const Q=(Me,je,ze,Re)=>{const Ue=S.querySelector("#"+Me);if(!Ue)return;let Ye=0;Ue.addEventListener("touchstart",Ke=>{Ye=Ke.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ke=>{const Oe=Ke.changedTouches[0].clientY-Ye;if(Math.abs(Oe)<30)return;const Pe=je();Oe<0&&Pe<Re-1?(ze(Pe+1),I()):Oe>0&&Pe>0&&(ze(Pe-1),I())},{passive:!0})};Q("pin-panel",()=>E,Me=>E=Me,w.length),Q("pout-panel",()=>k,Me=>k=Me,v.length),(Fe=S.querySelector("#psub-confirm"))==null||Fe.addEventListener("click",async Me=>{if(Me.preventDefault(),Me.stopPropagation(),L)return;L=!0;const je=v[k],ze=w[E];if(!je||!ze)return;const Re=je._line,Ue=(g[Re]||[]).findIndex(Oe=>Oe.cardId===je.cardId);if(Ue===-1){m("Erreur : joueur introuvable","error"),S.remove();return}const Ye={...ze,_line:Re,position:je.position,used:!1,boost:0};g[Re].splice(Ue,1,Ye);const Ke=[...b,ze.cardId];S.remove(),H(je,ze,async()=>{await X({[a+"Team"]:g,[o+"Team"]:f[o+"Team"],["usedSubIds_"+a]:Ke})})})}document.body.appendChild(S),I()}function H(B,$,g){const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(A,E,L)=>`<div style="text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(k),(I=k.querySelector("#pvp-end-home"))==null||I.addEventListener("click",()=>{k.remove(),Ve(e),a?l("mini-league",{openLeagueId:a}):l("mini-league")})}const X=T.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},g=>{const b=g.new;try{if(b.status==="finished"||b.forfeit){if(z||(z=!0,F&&(clearInterval(F),F=null),b.game_state&&(c=b.game_state),c.phase==="finished"&&!b.forfeit&&document.getElementById("pvp-home")))return;N(b);return}if(b.game_state){const h=c;c=b.game_state;const v=c._lastGC;if(v&&v.seq&&!j.has(v.seq)&&(j.add(v.seq),v.by!==o)){se(v.type,v.by,()=>ge());return}const w=h[o+"Score"]||0,k=h[y+"Score"]||0,A=c[o+"Score"]||0,E=c[y+"Score"]||0,L=A>w,S=E>k;if((L||S)&&!q.has(c.round)){q.add(c.round);const I=[...c.log||[]].reverse().find(V=>V.isGoal),D=((I==null?void 0:I.homePlayers)||[]).map(V=>({name:V.name,note:V.note,portrait:V.portrait,job:V.job}));Ee(D,A,E,L,()=>ge());return}ge()}}catch(h){console.error("[PvP] crash:",h)}}).subscribe();async function K(g){Object.assign(c,g),c.lastActionAt=new Date().toISOString();const{error:b}=await T.from("matches").update({game_state:c}).eq("id",i);b&&m("Erreur de synchronisation","error");try{ge()}catch(h){console.error("[PvP] renderPvpScreen crash:",h)}}async function re(){if(z)return;z=!0,F&&(clearInterval(F),F=null);const g=n?_.away_id:_.home_id,b=n?"p2":"p1",h=n?"p1":"p2",v={...c,[b+"Score"]:3,[h+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:g,home_score:v.p1Score||0,away_score:v.p2Score||0,game_state:v}).eq("id",i)}catch{}try{T.removeChannel(X)}catch{}setTimeout(()=>{Ve(e),l("mini-league")},800)}const ie={BOOST_STAT:({value:g=1,count:b=1,roles:h=[]},v,w)=>{const k=v[o+"Team"],A=Object.entries(k).filter(([E])=>!h.length||h.includes(E)).flatMap(([E,L])=>L.filter(S=>!S.used).map(S=>({...S,_line:E})));if(!A.length){v.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),w(v);return}Z(A,b,`Choisir ${b} joueur(s) à booster (+${g})`,E=>{E.forEach(L=>{const S=(k[L._line]||[]).find(I=>I.cardId===L.cardId);S&&(S.boost=(S.boost||0)+g,v.log.push({text:`⚡ +${g} sur ${S.name}`,type:"info"}))}),v[o+"Team"]=k,w(v)})},DEBUFF_STAT:({value:g=1,count:b=1,roles:h=[],target:v="ai"},w,k)=>{const A=v==="home"?o:y,E=w[A+"Team"],L=v==="home"?"allié":"adverse",S=Object.entries(E).filter(([I])=>!h.length||h.includes(I)).flatMap(([I,D])=>D.map(V=>({...V,_line:I})));if(!S.length){w.log.push({text:`🎯 Aucun joueur ${L}`,type:"info"}),k(w);return}Z(S,b,`Choisir ${b} joueur(s) ${L}(s) (-${g})`,I=>{I.forEach(D=>{const V=(E[D._line]||[]).find(W=>W.cardId===D.cardId);V&&(V.boost=(V.boost||0)-g,w.log.push({text:`🎯 -${g} sur ${V.name}`,type:"info"}))}),w[A+"Team"]=E,k(w)})},GRAY_PLAYER:({count:g=1,roles:b=[],target:h="ai"},v,w)=>{const k=h==="home"?o:y,A=v[k+"Team"],E=h==="home"?"allié":"adverse",L=Object.entries(A).filter(([S])=>!b.length||b.includes(S)).flatMap(([S,I])=>I.filter(D=>!D.used).map(D=>({...D,_line:S})));if(!L.length){v.log.push({text:`❌ Aucun joueur ${E}`,type:"info"}),w(v);return}Z(L,g,`Choisir ${g} joueur(s) ${E}(s) à exclure`,S=>{const I="usedCardIds_"+k,D=new Set(v[I]||[]);S.forEach(V=>{const W=(A[V._line]||[]).find(U=>U.cardId===V.cardId);W&&(W.used=!0,D.add(V.cardId),v.log.push({text:`❌ ${W.name} exclu !`,type:"info"}))}),v[I]=[...D],v[k+"Team"]=A,w(v)})},REVIVE_PLAYER:({count:g=1,roles:b=[]},h,v)=>{const w=h[o+"Team"],k=Object.entries(w).filter(([A])=>!b.length||b.includes(A)).flatMap(([A,E])=>E.filter(L=>L.used).map(L=>({...L,_line:A})));if(!k.length){h.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),v(h);return}Z(k,g,`Choisir ${g} joueur(s) à ressusciter`,A=>{A.forEach(E=>{const L=(w[E._line]||[]).find(S=>S.cardId===E.cardId);L&&(L.used=!1,h.log.push({text:`💫 ${L.name} ressuscité !`,type:"info"}))}),h[o+"Team"]=w,v(h)})},REMOVE_GOAL:({},g,b)=>{const h=y+"Score";g[h]>0?(g[h]--,g.log.push({text:"🚫 Dernier but annulé !",type:"info"})):g.log.push({text:"🚫 Aucun but à annuler",type:"info"}),b(g)},ADD_GOAL_DRAW:({},g,b)=>{g[o+"Score"]===g[y+"Score"]?(g[o+"Score"]++,g.log.push({text:"🎯 But bonus !",type:"info"})):g.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),b(g)},ADD_SUB:({value:g=1},b,h)=>{b.maxSubs=(b.maxSubs||3)+g,b.log.push({text:`🔄 +${g} remplacement(s)`,type:"info"}),h(b)},CUSTOM:({},g,b)=>b(g)};function Z(g,b,h,v){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let k=[];function A(){var L,S;const E=g.map(I=>{const D={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[I._line]||"#555",V=Te(I,I._line)+(I.boost||0),U=k.find(Y=>Y.cardId===I.cardId)?"#FFD700":"rgba(255,255,255,0.25)",P=I.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${I.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${U};background:${D};overflow:hidden;cursor:pointer;${P}">
        ...
        </div>`,(L=w.querySelector("#pp-close"))==null||L.addEventListener("click",()=>w.remove()),w.querySelectorAll(".pp-item").forEach(I=>{I.addEventListener("click",()=>{const D=I.dataset.cid,V=g.find(U=>U.cardId===D),W=k.findIndex(U=>U.cardId===D);V&&(W>-1?k.splice(W,1):k.length<b&&k.push(V),A())})}),(S=w.querySelector("#pp-confirm"))==null||S.addEventListener("click",()=>{w.remove(),v(k)})}A(),document.body.appendChild(w)}async function R(g,b){const v=(c["gcCardsFull_"+o]||[]).find(E=>E.id===g),w=(v==null?void 0:v._gcDef)||(c.gcDefs||[]).find(E=>{var L;return E.name===b||((L=E.name)==null?void 0:L.toLowerCase().trim())===(b==null?void 0:b.toLowerCase().trim())}),k=[...c["usedGc_"+o]||[],g],A={type:b,by:o,seq:(c._gcAnimSeq||0)+1};j.add(A.seq),se(b,o,async()=>{if(w!=null&&w.effect_type&&w.effect_type!=="CUSTOM"){const L=ie[w.effect_type];if(L){const S={...c};L(w.effect_params||{},S,async I=>{I["usedGc_"+o]=k,I._lastGC=A,I._gcAnimSeq=A.seq,await K(I)});return}}const E={...c};switch(b){case"Remplacement+":E.maxSubs=(E.maxSubs||3)+1,E.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const L=y+"Score";E[L]>0&&(E[L]--,E.log.push({text:"🚫 But annulé",type:"info"}));break}}E["usedGc_"+o]=k,E._lastGC=A,E._gcAnimSeq=A.seq,await K(E)})}function G(g,b){const h="usedCardIds_"+g,v=new Set(c[h]||[]);b.forEach(w=>v.add(w)),c[h]=[...v]}function oe(){for(const g of["p1","p2"]){const b=new Set(c["usedCardIds_"+g]||[]),h=c[g+"Team"];if(h)for(const v of["GK","DEF","MIL","ATT"])(h[v]||[]).forEach(w=>{w.used=b.has(w.cardId)})}}function ge(){var ot,pt,ut,ft,ce,J;if(c.phase==="reveal")return _e();if(c.phase==="midfield")return ve();if(c.phase==="finished")return B();const g=c[o+"Team"],b=c[y+"Team"];oe();const h=c[o+"Score"],v=c[y+"Score"],w=c[o+"Name"],k=c[y+"Name"],A=c.phase===o+"-attack",E=c.phase===o+"-defense",L=Array.isArray(c["selected_"+o])?c["selected_"+o]:[],S=L.map(O=>O.cardId),I=window.innerWidth>=700,D=c[o+"Subs"]||[],V=c["usedSubIds_"+o]||[],W=D.filter(O=>!V.includes(O.cardId)),U=c["gcCardsFull_"+o]||[],P=c["usedGc_"+o]||[],Y=U.filter(O=>!P.includes(O.id)),te=c.boostOwner===o&&!c.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(O=>(b[O]||[]).some(ae=>!ae.used)),fe=[...g.MIL||[],...g.ATT||[]].filter(O=>!O.used),ye=A&&Q&&fe.length===0?[...g.GK||[],...g.DEF||[]].filter(O=>!O.used).map(O=>O.cardId):[];function be(O,ae,he){var qt,Mi;const $e=O._gcDef,Ze={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[$e==null?void 0:$e.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Qe={purple:"#b06ce0",light_blue:"#00d4ef"}[$e==null?void 0:$e.color]||"#b06ce0",tt=($e==null?void 0:$e.name)||O.gc_type,rt=($e==null?void 0:$e.effect)||((qt=He[O.gc_type])==null?void 0:qt.desc)||"",vt=$e!=null&&$e.image_url?`/icons/${$e.image_url}`:null,wt=((Mi=He[O.gc_type])==null?void 0:Mi.icon)||"⚡",dt=Math.round(he*.22),gt=Math.round(he*.22),mt=he-dt-gt,_t=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${O.id}" data-gc-type="${O.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(V);let W=!1;const U=()=>{W||(W=!0,V.remove(),setTimeout(()=>h&&h(),50))};V.addEventListener("click",U),setTimeout(U,3e3)}function pe(g,b){var V,W,U,P;const v=(c["gcCardsFull_"+o]||[]).find(Y=>Y.id===g),w=v==null?void 0:v._gcDef,k={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[w==null?void 0:w.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",A={purple:"#b06ce0",light_blue:"#00d4ef"}[w==null?void 0:w.color]||"#b06ce0",E=(w==null?void 0:w.name)||b,L=(w==null?void 0:w.effect)||((V=He[b])==null?void 0:V.desc)||"Carte spéciale.",S=w!=null&&w.image_url?`/icons/${w.image_url}`:null,I=((W=He[b])==null?void 0:W.icon)||"⚡",D=document.createElement("div");D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",D.innerHTML=`
      ...
      </div>`,document.body.appendChild(h),(v=h.querySelector("#bp-close"))==null||v.addEventListener("click",()=>h.remove()),h.querySelectorAll(".bp-item").forEach(w=>{w.addEventListener("click",async()=>{const k=w.dataset.cid,A=b.find(L=>L.cardId===k);if(!A)return;const E=(g[A._line]||[]).find(L=>L.cardId===k);E&&(E.boost=(E.boost||0)+c.boostValue),h.remove(),await K({[o+"Team"]:g,boostUsed:!0})})})}function H(g=null){var W,U;if(!(c.phase===o+"-attack")){m("Remplacement uniquement avant votre attaque","warning");return}const h=c[o+"Team"],v=c["usedSubIds_"+o]||[],w=c.maxSubs||3;if(v.length>=w){m(`Maximum ${w} remplacements atteint`,"warning");return}const k=Object.entries(h).flatMap(([P,Y])=>(Y||[]).filter(te=>te.used).map(te=>({...te,_line:P}))),A=(c[o+"Subs"]||[]).filter(P=>!v.includes(P.cardId));if(!k.length){m("Aucun joueur utilisé à remplacer","warning");return}if(!A.length){m("Aucun remplaçant disponible","warning");return}let E=Math.max(0,k.findIndex(P=>P.cardId===g));const L=((W=k[E])==null?void 0:W._line)||((U=k[E])==null?void 0:U.job);let S=Math.max(0,A.findIndex(P=>P.job===L)),I=!1;const D=document.createElement("div");D.id="pvp-sub-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function V(){var be,ke,Be,Fe,Me,je;const P=k[E],Y=A[S],te=Math.min(130,Math.round((window.innerWidth-90)/2)),Q=Math.round(te*1.35),fe=ze=>`background:rgba(255,255,255,0.12);border:none;color:${ze?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ze?"default":"pointer"};flex-shrink:0`;D.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="width:min(90vw,420px)">${lt(c[y+"Team"],c[y+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(g),(b=g.querySelector("#pvp-opp-close"))==null||b.addEventListener("click",()=>g.remove())}function le(){var v;const g=c.log||[],b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column";const h=w=>{var A,E,L;if(w.type==="duel"){const S=w.isGoal,I=w.homeScored&&o==="p1"||!w.homeScored&&S&&o==="p2",D=w.homeScored?"#FFD700":S?"#ff6b6b":"rgba(255,255,255,0.3)",V=S?I?"⚽ BUT !":"⚽ BUT adversaire !":(A=w.homePlayers)!=null&&A.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${S?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${D};margin-bottom:4px">
    ...
    </div>`,(w=document.getElementById("pvp-home"))==null||w.addEventListener("click",()=>{try{T.removeChannel(X)}catch{}Ve(e),l("mini-league",a?{openLeagueId:a}:{})})}ge()}const wr="/",_r=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let m="buy";const a=()=>{var f,c,z,u,M,F,C;return{name:(((f=document.getElementById("flt-name"))==null?void 0:f.value)||"").toLowerCase().trim(),club:(((c=document.getElementById("flt-club"))==null?void 0:c.value)||"").toLowerCase().trim(),country:(((z=document.getElementById("flt-country"))==null?void 0:z.value)||"").toLowerCase().trim(),job:((u=document.getElementById("flt-job"))==null?void 0:u.value)||"",rarity:((M=document.getElementById("flt-rarity"))==null?void 0:M.value)||"",note1:parseInt((F=document.getElementById("flt-note1"))==null?void 0:F.value)||0,note2:parseInt((C=document.getElementById("flt-note2"))==null?void 0:C.value)||0}};function o(f){const c=a();return f.filter(z=>{var X,K,re;const u=(X=z.card)==null?void 0:X.player;if(!u)return!1;const M=`${u.firstname} ${u.surname_encoded}`.toLowerCase(),F=(((K=u.clubs)==null?void 0:K.encoded_name)||"").toLowerCase(),C=(u.country_code||"").toLowerCase(),q=((re=z.card)==null?void 0:re.evolution_bonus)||0,j=St(u,u.job,q),N=u.job2?St(u,u.job2,q):0;return!(c.name&&!M.includes(c.name)||c.club&&!F.includes(c.club)||c.country&&!C.includes(c.country)||c.job&&u.job!==c.job||c.rarity&&u.rarity!==c.rarity||c.note1&&j<c.note1||c.note2&&N<c.note2)})}function y(f){var C,q,j,N;const c=(C=f.card)==null?void 0:C.player;if(!c)return"";const z=((q=f.card)==null?void 0:q.evolution_bonus)||0,u=St(c,c.job,z),M=c.job2?St(c,c.job2,z):0,F=(i.profile.credits||0)>=f.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ji(c.rarity)}
      ${Xt(u,c.job)}
      ${Xt(M,c.job2||null)}
      ${Xi(c.country_code)}
    ...
    </div>`}function p(f){var C,q,j,N;const c=(C=f.card)==null?void 0:C.player;if(!c)return"";const z=((q=f.card)==null?void 0:q.evolution_bonus)||0,u=St(c,c.job,z),M=c.job2?St(c,c.job2,z):0,F=f.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${F?"opacity:0.7":""}">
      ${Ji(c.rarity)}
      ${Xt(u,c.job)}
      ${Xt(M,c.job2||null)}
      ${Xi(c.country_code)}
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const z=r||[];_.innerHTML=z.length>0?z.map((u,M)=>{const F=Nt(u.mmr??1e3),C=(u.ranked_wins||0)+(u.ranked_losses||0)+(u.ranked_draws||0),q=C>0?Math.round((u.ranked_wins||0)/C*100):0,j=u.id===i.profile.id,N=(u.placement_matches||0)<10;return`
