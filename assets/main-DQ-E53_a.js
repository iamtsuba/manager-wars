...
import{s as v,l as Ot,m as Bi,F as qi,r as Ae,j as ti,h as Di,n as Kn,o as Vn,T as bi,k as Yn,p as Wn,b as Xn}from"./formation-links-Bb-Ce4un.js";const Jn="/";function Qi(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,m;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var x;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),m=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",y=m.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():m.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=g,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(m){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(m){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),y=document.getElementById("step3-finish");m.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Zn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){m.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Zn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const eo="modulepreload",to=function(e){return"/"+e},Zi={},mn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=to(d),d in Zi)return;Zi[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":eo,c||(m.as="script"),m.crossOrigin="",m.href=d,s&&m.setAttribute("nonce",s),document.head.appendChild(m),c)return new Promise((y,g)=>{m.addEventListener("load",y),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Wt="#1A6B3C",Xt="#cc2222",io="#D4A017",en="#888";async function no(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const so="2026.07.20-1736";async function tn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`,function(F){const H=document.getElementById(F);if(!H)return;H.addEventListener("wheel",ue=>{Math.abs(ue.deltaY)<=Math.abs(ue.deltaX)||(ue.preventDefault(),H.scrollLeft+=ue.deltaY)},{passive:!1});let Q=!1,R=0,C=0,N=!1,ce=!1;H.addEventListener("mousedown",ue=>{Q=!0,N=!1,R=ue.pageX,C=H.scrollLeft}),window.addEventListener("mouseup",()=>{Q=!1,N&&(H.style.cursor="",ce=!0),N=!1}),window.addEventListener("mousemove",ue=>{if(!Q)return;const be=ue.pageX-R;!N&&Math.abs(be)<6||(N=!0,H.style.cursor="grabbing",ue.preventDefault(),H.scrollLeft=C-be)}),H.addEventListener("click",ue=>{ce&&(ue.stopPropagation(),ue.preventDefault(),ce=!1)},!0)}("col-grid");function T(){const M=document.getElementById("col-filters");M&&(B==="player"?(M.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",F=>{I=F.target.value.toLowerCase(),Y()}),e.querySelectorAll(".filter-btn").forEach(F=>{F.addEventListener("click",()=>{k=F.dataset.job,T(),Y()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{D=!D,T(),Y()})):(M.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{D=!D,T(),Y()})))}function Y(){const M=document.getElementById("col-grid");M&&(B==="player"?pe(M):B==="formation"?O(M):B==="stadium"?U(M):V(M))}function oe(M,F,H,Q,R){const C=document.getElementById("col-grid"),N=document.getElementById("col-big");if(!C||!N)return;var ce=0;function ue(){const be=window.innerWidth>=768,we=document.getElementById("col-big"),Ee=document.getElementById("col-grid");be&&we&&(we.style.minHeight="420px",we.style.flex="1 1 auto"),be&&Ee&&(Ee.style.height=Math.round(310*.76+16)+"px",Ee.style.flexShrink="0",Ee.style.overflowX="auto",Ee.style.overflowY="hidden",Ee.style.alignItems="center",Ee.style.padding="8px 16px"),N.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+F(M[ce])+"</div>";var Le=N.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Le&&Le.addEventListener("click",function(){Q(M[ce])}),requestAnimationFrame(function(){var _e=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!_e||!N)){var ze=N.clientHeight-8,De=N.clientWidth-24,je=_e.offsetHeight,Ge=_e.offsetWidth;if(je>0&&Ge>0&&ze>40){var tt=be?2.2:1.6,Oe=Math.min(ze/je,De/Ge,tt);_e.style.transform="scale("+Oe.toFixed(3)+")",_e.style.transformOrigin="top center"}}}),C.innerHTML=M.map(function(_e,ze){var De=ze===ce,je="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(De?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+ze+'" style="'+je+'">'+H(_e,De)+"</div>"}).join(""),C.querySelectorAll(".col-mini-item").forEach(function(_e){_e.addEventListener("click",function(){ce=Number(_e.dataset.idx),ue(),_e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}ue()}function fe(M){var F=window.innerWidth>=768?.76:.54,H;if(!M||M._fake){var Q=M?M.player:null;if(!Q)return"";H=an(Q)}else H=wi(M,"");return'<div style="display:inline-block;zoom:'+F+';pointer-events:none;line-height:0">'+H+"</div>"}function me(M,F,H){F=F||100,H=H||140;var Q=ti[M]||{},R={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},C=Math.max(3,Math.round(F*.06)),N=Object.entries(Q).map(function(ue){var be=ue[0],we=ue[1],Ee=be.replace(/\d+$/,""),Le=R[Ee]||"#888",_e=Math.round(we.x*F),ze=Math.round(we.y*H);return'<circle cx="'+_e+'" cy="'+ze+'" r="'+C+'" fill="'+Le+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),ce=Math.max(1,Math.round(F/50));return'<svg viewBox="0 0 '+F+" "+H+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+F+'" height="'+H+'" fill="#1A6B3C"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.02)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/><line x1="0" y1="'+Math.round(H*.5)+'" x2="'+F+'" y2="'+Math.round(H*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><ellipse cx="'+Math.round(F*.5)+'" cy="'+Math.round(H*.5)+'" rx="'+Math.round(F*.18)+'" ry="'+Math.round(H*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.82)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/>'+N+"</svg>"}function S(M,F,H){var Q=H>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+H+"</div>":"",R=F?'data-form-id="'+F.id+'"':"",C=M.length>7?14:M.length>5?16:19,N=!!F;return"<div "+R+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(N?"#2a7a40":"#bbb")+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(N?"":"filter:grayscale(1);opacity:0.5")+'">'+Q+'<div style="padding:8px 6px 6px;background:var(--tile-bg);text-align:center;border-bottom:3px solid '+(N?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+C+"px;font-weight:900;color:"+(N?"#1A6B3C":"#aaa")+';line-height:1">'+M+'</div></div><div style="flex:1;overflow:hidden;background:'+(N?"#1A6B3C":"#ccc")+'">'+me(M,140,220)+"</div></div>"}function W(M,F){var H=window.innerWidth>=768?.76:.54,Q=140,R=305,C=Math.round(R*.22),N=R-C,ce=M.length>7?10:13,ue=me(M,Q,N),be=F?"1.5px solid #2a7a40":"1px solid #ddd",we=F?"":"filter:grayscale(1);opacity:0.45;",Ee=F?"#1A6B3C":"#bbb",Le="#fff";return'<div style="display:inline-block;zoom:'+H+';line-height:0;pointer-events:none"><div style="width:'+Q+"px;height:"+R+"px;border-radius:6px;border:"+be+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;"+we+'"><div style="height:'+C+"px;background:"+Ee+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+ce+"px;font-weight:900;color:"+Le+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(Q-4)+'px">'+M+'</span></div><div style="height:'+N+'px;overflow:hidden;flex-shrink:0">'+ue+"</div></div></div>"}function pe(M){if(D){const F=j();if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const H=F.map(Q=>c.find(R=>R.player.id===Q.id)||{_fake:!0,player:Q,id:"fake-"+Q.id});oe(H,Q=>Q._fake?an(Q.player):wi(Q,""),Q=>Q._fake?fe({player:Q.player,id:"x",_fake:!0}):fe(Q),Q=>{Q._fake||sn(Q,c,h,t)})}else{const F=Z();if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const H={};F.forEach(R=>{const C=R.player.id;H[C]||(H[C]=[]),H[C].push(R)});const Q=Object.values(H).map(R=>ko(R));oe(Q,R=>{const C=h[R.player.id]||1,N=C>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${C}</div>`:"",ue=c.filter(be=>be.player.id===R.player.id&&be.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return wi(R,N+ue)},R=>fe(R),R=>sn(R,c,h,t))}}function O(M){const F=D?b:[...$];if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const H=F.map(Q=>({formation:Q,card:m.find(R=>R.formation===Q)||null,owned:$.has(Q)}));oe(H,({formation:Q,card:R,owned:C})=>S(Q,C?R:null,C?m.filter(N=>N.formation===Q).length:0),({formation:Q,owned:R})=>W(Q,R),({card:Q,owned:R})=>{R&&Q&&Io(Q,m,t,o)})}function V(M){const F=Object.keys(x),H=D?F.length?F:w:[...f];if(!H.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Q=H.map(R=>({type:R,gc:Ce[R]||{icon:"⚡",desc:""},def:x[R]||null,owned:f.has(R),card:l.find(C=>C.gc_type===R)||null}));oe(Q,({type:R,gc:C,def:N,owned:ce,card:ue})=>{var tt;const be=ce?l.filter(Oe=>Oe.gc_type===R).length:0,we=be>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${be}</div>`:"",Ee=(N==null?void 0:N.gc_type)==="ultra_game_changer",Le={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},_e={purple:"#b06ce0",light_blue:"#00d4ef"},ze=Le[N==null?void 0:N.color]||Le.purple,De=_e[N==null?void 0:N.color]||_e.purple,je=(N==null?void 0:N.effect)||C.desc||"",Ge=N!=null&&N.image_url?`/icons/${N.image_url}`:((tt=N==null?void 0:N.club)==null?void 0:tt.logo_url)||(N!=null&&N.country_code?`https://flagsapi.com/${N.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return ce&&ue?`<div data-gc-id="${ue.id}" data-gc-type="${R}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${De};background:${ze};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${De}66;cursor:pointer">
          ${we}
        ...
        </div>`},({type:R,gc:C,def:N,owned:ce})=>{const ue=window.innerWidth>=768?.76:.54,be={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},we={purple:"#9b59b6",light_blue:"#00bcd4"},Ee=be[N==null?void 0:N.color]||be.purple,Le=we[N==null?void 0:N.color]||we.purple,_e=N!=null&&N.image_url?`/icons/${N.image_url}`:null;return ce?`<div style="display:inline-block;zoom:${ue};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${Ee};border:1px solid ${Le};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${R}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${_e?`<img src="${_e}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${C.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((N==null?void 0:N.effect)||C.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${ue};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${C.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${R}</span></div></div>`},({type:R,owned:C,def:N})=>{C&&zo(R,N,o)})}function U(M){const F="#E87722",H="/";if(!y.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Q={};y.forEach(C=>{const N=C.stadium_id||"?";(Q[N]=Q[N]||[]).push(C)});const R=Object.entries(Q).map(([C,N])=>({sid:C,def:u[C]||null,count:N.length,card:N[0]}));oe(R,({def:C,count:N})=>{var Le,_e;const ce=(C==null?void 0:C.name)||"?",ue=((Le=C==null?void 0:C.club)==null?void 0:Le.encoded_name)||(C==null?void 0:C.country_code)||"—",be=C!=null&&C.image_url?`${H}icons/${C.image_url}`:((_e=C==null?void 0:C.club)==null?void 0:_e.logo_url)||(C!=null&&C.country_code?`https://flagsapi.com/${C.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),we=be?`<img src="${be}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',Ee=N>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${N}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${F},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${F}66">
          ${Ee}
        ...
        </div>`},({def:C,count:N})=>{var Le,_e;const ce=window.innerWidth>=768?.76:.54,ue=(C==null?void 0:C.name)||"?",be=((Le=C==null?void 0:C.club)==null?void 0:Le.encoded_name)||(C==null?void 0:C.country_code)||"—",we=C!=null&&C.image_url?`${H}icons/${C.image_url}`:((_e=C==null?void 0:C.club)==null?void 0:_e.logo_url)||(C!=null&&C.country_code?`https://flagsapi.com/${C.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Ee=we?`<img src="${we}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${ce};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(M=>{M.addEventListener("click",()=>{B=M.dataset.tab,k="Tous",I="",D=!1,e.querySelectorAll(".col-tab-btn").forEach(F=>{const H=F.dataset.tab===B;F.style.borderBottomColor=H?"var(--green)":"transparent",F.style.color=H?"var(--green)":"var(--tile-fg-dim)"}),T(),Y()})}),T(),Y()}function zo(e,t,i){const n=Ce[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,l=(t==null?void 0:t.effect)||n.desc,m=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ni=1e3;function Io(e,t,i,n){var x,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:d}=i,c=e.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function m(){const b=ti[c]||{},w=qi[c]||[],h=290,$=360,f=20;function B(I){const D=b[I];return D?{x:D.x*h,y:D.y*$}:null}let k=`<svg width="${h}" height="${$}" viewBox="0 0 ${h} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[I,D]of w){const ie=B(I),ne=B(D);!ie||!ne||(k+=`<line x1="${ie.x}" y1="${ie.y}" x2="${ne.x}" y2="${ne.y}"
    ...
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${m.map((O,V)=>{const U=Z[O.id]||[],M=O.is_for_sale,F=U.length?U[U.length-1]:null,Q=(l.rarity==="pepite"||l.rarity==="papyte")&&O.current_note!=null?` (☆${O.current_note})`:"";return`
            <div data-card-id="${O.id}" data-card-idx="${V}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                <input type="checkbox" class="expl-check" data-id="${O.id}" ${M?"disabled":""} style="width:18px;height:18px;cursor:pointer;accent-color:#1A6B3C;flex-shrink:0">
                <div style="flex:1;min-width:0">
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([O,V])=>{const U=hi[O],M=O==="GK"?"#fff":U,F=O===l.job||O===l.job2,H=(Number(V)||0)+(F&&B>0?B:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                ...
                <span style="font-size:10px;font-weight:700;color:${M}">${O}</span>
              </div>`}).join("")}
          </div>
        </div>
        <div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(me=document.getElementById("close-detail"))==null||me.addEventListener("click",s);let Y=new Set;const oe=()=>{const O=Y.size,V=document.getElementById("sell-action-panel");if(!V)return;V.style.display=O>0?"block":"none",document.getElementById("sell-selected-count").textContent=O;const U=document.getElementById("evolve-btn");U&&(U.textContent=`⬆️ Évoluer ${O>1?"(+"+O+")":""}`)};document.querySelectorAll(".expl-check").forEach(O=>{O.addEventListener("change",()=>{const V=O.dataset.id;O.checked?Y.add(V):Y.delete(V);const U=O.closest(".exemplaire-row");U&&(U.style.borderColor=O.checked?"#1A6B3C":"#eee"),oe()})}),document.querySelectorAll(".exemplaire-row").forEach(O=>{O.addEventListener("click",V=>{if(V.target.closest("button")||V.target.tagName==="INPUT")return;const U=O.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(O=>{O.addEventListener("click",V=>{V.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${O.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(S=document.getElementById("evolve-btn"))==null||S.addEventListener("click",async()=>{if(y<=1)return;const O=[...Y];if(!O.length)return;if(Y.has(e.id)){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",R.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const r=o=>{n.remove(),i(o)};n.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),n.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),n.addEventListener("click",o=>{o.target===n&&r(!1)})})}const ai={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Li(e,t){const{state:i,navigate:n,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div style="position:relative;width:${g}px;height:${x}px;margin:0 auto">
      ...
      ${g.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+g.map(h=>{const $={...h.player,_evolution_bonus:h.evolution_bonus||0};return`<div class="player-option" data-card-id="${h.id}" style="cursor:pointer">
          ${Ae($,{width:100,showStad:!0,stadDef:d,role:a})}
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=T=>T.touches&&T.touches[0]?T.touches[0].clientX:T.clientX;function l(T){o||(d=!0,s.style.opacity="1",m(T))}function m(T){if(!d||o)return;const Y=a.getBoundingClientRect(),oe=c(T)-Y.left,fe=Math.max(0,Math.min(1,oe/Y.width));s.style.width=fe*Y.width+"px",fe>=.82&&g()}function y(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var Y;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(Y=document.getElementById("cut-flash"))==null||Y.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const T=document.getElementById("cut-hint");T&&(T.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",m),window.addEventListener("pointerup",y),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",y);let x=0,p=!1;const u=new Set;function b(T){x=T,document.getElementById("reveal-phase").style.display="flex",w(),h(T,0),I()}function w(){const T=document.getElementById("card-dots");T&&(T.innerHTML=e.map((Y,oe)=>`<div class="card-dot" data-i="${oe}" style="width:8px;height:8px;border-radius:50%;background:${oe===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),T.querySelectorAll(".card-dot").forEach(Y=>Y.addEventListener("click",()=>f(parseInt(Y.dataset.i)))))}function h(T,Y){var U,M;const oe=e[T],fe=document.getElementById("card-counter"),me=document.getElementById("card-track");fe&&(fe.textContent=`Carte ${T+1} / ${e.length}`);const S=document.getElementById("reveal-btns");S&&(S.style.display=T===e.length-1?"flex":"none");const W=oe.card_type==="player"&&((U=oe.player)==null?void 0:U.rarity)==="legende",pe=!u.has(T);u.add(T);let O=0;if(oe.card_type==="player"&&oe.player){const F=oe.player,H=F.job||"ATT";O=Number(H==="GK"?F.note_g:H==="DEF"?F.note_d:H==="MIL"?F.note_m:F.note_a)||0}const V=F=>{me.innerHTML=`
        ...
        </div>`;const H=document.getElementById("current-card-wrap");Y!==0?(H.style.transition="none",H.style.transform=`translateX(${Y>0?100:-100}%)`,requestAnimationFrame(()=>{H.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",H.style.transform="translateX(0)"})):H.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),F||W?ie():ne(),w()};pe&&(((M=oe.player)==null?void 0:M.rarity)==="legende"||O>=8)&&oe.card_type==="player"&&oe.player?$(oe,()=>V(!0)):V(!1)}function $(T,Y){var be;p=!0;const oe=T.player,fe=`https://flagsapi.com/${oe.country_code}/flat/64.png`,me=(be=oe.clubs)==null?void 0:be.logo_url,S=oe.face?"/"+oe.face.replace(/^public\//,"").replace(/^\//,""):null,W=oe.job||"ATT",pe=Number(W==="GK"?oe.note_g:W==="DEF"?oe.note_d:W==="MIL"?oe.note_m:oe.note_a)||0,O=T.evolution_bonus||0,V=pe+O,U=oe.rarity==="legende",M=V>=18,F=document.getElementById("walkout-overlay"),H=document.getElementById("walkout-stage");if(!F||!H){p=!1,Y();return}let Q=null;U&&(Q=mo("/sounds/Legendary.mp3",.8)),F.style.display="flex";const R=()=>{const we=H.firstElementChild;we&&(we.classList.remove("wo-in"),we.classList.add("wo-out"))},C=1800,N=400;H.innerHTML=`<img class="wo-in" src="${fe}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(R,C),setTimeout(()=>{var we;H.innerHTML=me?`<img class="wo-in" src="${me}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((we=oe.clubs)==null?void 0:we.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},C+N),setTimeout(R,C*2+N),setTimeout(()=>{H.innerHTML=S?`<img class="wo-in" src="${S}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(C+N)*2),setTimeout(R,(C+N)*2+C);const ue=M?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[W]||"#fff";setTimeout(()=>{H.innerHTML=`<div class="wo-in" style="
        font-size:${M?"120px":"90px"};font-weight:900;color:${ue};
        ...
        ${V}
      </div>`,M&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(C+N)*3),setTimeout(R,(C+N)*3+C),setTimeout(()=>{F.style.display="none",H.innerHTML="",p=!1,Q&&!U&&Q.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),Y()},(C+N)*4)}function f(T){if(p||T<0||T>=e.length||T===x)return;const Y=T>x?1:-1;x=T,h(T,Y)}function B(){f(x+1)}function k(){f(x-1)}function I(){const T=document.getElementById("card-viewport");if(!T||T._swipeBound)return;T._swipeBound=!0;let Y=0,oe=0,fe=0,me=!1;const S=U=>U.touches?U.touches[0].clientX:U.clientX,W=U=>U.touches?U.touches[0].clientY:U.clientY,pe=U=>{me=!0,Y=S(U),oe=W(U),fe=0},O=U=>{if(!me)return;fe=S(U)-Y;const M=W(U)-oe;if(Math.abs(fe)<Math.abs(M))return;const F=document.getElementById("current-card-wrap");F&&(F.style.transition="none",F.style.transform=`translateX(${fe*.6}px) rotate(${fe*.02}deg)`)},V=()=>{if(!me)return;me=!1;const U=document.getElementById("current-card-wrap"),M=55;fe<=-M&&x<e.length-1?B():fe>=M&&x>0?k():U&&(U.style.transition="transform .2s ease",U.style.transform="translateX(0)")};T.addEventListener("pointerdown",pe),T.addEventListener("pointermove",O),T.addEventListener("pointerup",V),T.addEventListener("pointercancel",V),T.addEventListener("touchstart",pe,{passive:!0}),T.addEventListener("touchmove",O,{passive:!0}),T.addEventListener("touchend",V),T.addEventListener("click",U=>{if(Math.abs(fe)>8)return;const M=T.getBoundingClientRect();U.clientX-M.left>M.width/2?B():k()})}let D=null;function ie(){const T=document.getElementById("fireworks-canvas");if(!T)return;T.width=window.innerWidth,T.height=window.innerHeight;const Y=T.getContext("2d"),oe=[];function fe(){const S=Math.random()*T.width,W=Math.random()*T.height*.6,pe=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],O=pe[Math.floor(Math.random()*pe.length)];for(let V=0;V<60;V++){const U=Math.PI*2/60*V,M=2+Math.random()*5;oe.push({x:S,y:W,vx:Math.cos(U)*M,vy:Math.sin(U)*M,alpha:1,color:O,size:2+Math.random()*3})}}fe(),D=setInterval(fe,600);function me(){if(document.getElementById("fireworks-canvas")){Y.clearRect(0,0,T.width,T.height);for(let S=oe.length-1;S>=0;S--){const W=oe[S];if(W.x+=W.vx,W.y+=W.vy+.08,W.vy*=.98,W.alpha-=.018,W.alpha<=0){oe.splice(S,1);continue}Y.globalAlpha=W.alpha,Y.fillStyle=W.color,Y.beginPath(),Y.arc(W.x,W.y,W.size,0,Math.PI*2),Y.fill()}Y.globalAlpha=1,(D!==null||oe.length>0)&&requestAnimationFrame(me)}}me()}function ne(){D!==null&&(clearInterval(D),D=null);const T=document.getElementById("fireworks-canvas");T&&T.getContext("2d").clearRect(0,0,T.width,T.height)}if(n){const T=document.getElementById("reveal-btns");T&&(T.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(j=document.getElementById("reveal-next"))==null||j.addEventListener("click",()=>{ne(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ne(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ne(),r.remove(),i("boosters")})}function Ho(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return Po(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},d={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,l=d[o==null?void 0:o.color]||d.purple,m=(o==null?void 0:o.name)||e.gc_type||"Game Changer",y=(o==null?void 0:o.effect)||((t=Ti[e.gc_type])==null?void 0:t.desc)||"",g=o!=null&&o.image_url?`/icons/${o.image_url}`:null,x=((i=Ti[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${l};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${l}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),d=[...new Set((s||[]).filter(y=>{var g,x;return((g=y.card)==null?void 0:g.card_type)==="stadium"&&((x=y.card)==null?void 0:x.stadium_id)}).map(y=>y.card.stadium_id))],c={};if(d.length){const{data:y}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(y||[]).forEach(g=>{c[g.id]=g}),(s||[]).forEach(g=>{var x,p;((x=g.card)==null?void 0:x.card_type)==="stadium"&&((p=g.card)!=null&&p.stadium_id)&&(g.card._stadiumDef=c[g.card.stadium_id]||null)})}let l=0;function m(){var f,B,k,I,D,ie,ne;const y=o[l],g=(s||[]).filter(Z=>Z.deck_id===y.id),x=g.filter(Z=>{var j;return Z.is_starter&&((j=Z.card)==null?void 0:j.player)}).map(Z=>Ii(Z.card,Z.position)),p=g.find(Z=>{var j;return((j=Z.card)==null?void 0:j.card_type)==="formation"}),u=y.formation||((f=p==null?void 0:p.card)==null?void 0:f.formation)||"4-4-2";let b=x.length>=11?di(x,u):null,w=((B=y.stadium_card)==null?void 0:B.stadium_def)||null;w&&b&&(b=ei(b,w));const h=x.length>=11;st(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    </div>`}function Cn(e){var o,a,s;if(!e)return"";const t=d=>d?Ae({...d,_evolution_bonus:0},{width:52,role:d._line||d.job,showStad:!!d.stadiumBonus,extraNote:d.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.85);pointer-events:none`;const s=(e||[]).slice(0,3).map(d=>Ae({...d,_evolution_bonus:0},{width:Math.min(140,Math.round(window.innerWidth/4)),role:d._line||d.job,showStad:!!d.stadiumBonus})).join("");if(a.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const W=t.pendingAttack;let pe="";if(t.selected.length>0){const O=t.selected.map(U=>({...(t.homeTeam[U._role]||[]).find(F=>F.cardId===U.cardId)||U,_line:U._role})),V=Qt(O,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Xe(O.map(U=>({...U,used:!1})),"#3a7bd5",V.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Xe((W.players||[]).map(O=>({...O,used:!1})),"#ff6b6b",W.total,"attack",t.formation)}</div>
            ${pe}
          ...
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const W=t.selected.map(O=>{const V=(t.homeTeam[O._role]||[]).find(M=>M.cardId===O.cardId)||O,U=["GK","DEF"].includes(O._role);return{...V,_line:O._role,...U?{note_a:Math.max(1,Number(V.note_a)||0)}:{}}}),pe=Jt(W,t.modifiers.home,t.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Xe(W.map(O=>({...O,used:!1})),"#FFD700",pe.total,"attack",t.formation)}</div>
    ...
    ${(()=>{const S=window.innerWidth>=700,W=(R,C,N)=>{var tt,Oe;const ce=(t.gcDefs||[]).find(xi=>xi.name===R.gc_type),ue={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",be={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",we=(ce==null?void 0:ce.name)||R.gc_type,Ee=(ce==null?void 0:ce.effect)||((tt=Ce[R.gc_type])==null?void 0:tt.desc)||"",Le=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,_e=((Oe=Ce[R.gc_type])==null?void 0:Oe.icon)||"⚡",ze=Math.round(N*.22),De=Math.round(N*.22),je=N-ze-De,Ge=we.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${C}px;height:${N}px;border-radius:10px;border:2px solid ${be};background:${ue};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${ze}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ge}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${C-6}px">${we}</span>
          ...
          <div style="height:${je}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Le?`<img src="${Le}" style="max-width:${C-10}px;max-height:${je-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(je*.55)}px">${_e}</span>`}
          </div>
        ...
        </div>`},pe=(R,C)=>{var N;return`<div id="boost-card"
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(S=>{var W,pe,O;if(S.type==="duel"){const V=S.isGoal,U=S.homeScored?"#FFD700":V?"#ff6b6b":"rgba(255,255,255,0.3)",M=S.homeScored?"⚽ BUT !":V?"⚽ BUT IA !":(W=S.homePlayers)!=null&&W.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${V?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${U};margin-bottom:4px">
                ...
                ${(pe=S.homePlayers)!=null&&pe.length?`<div style="margin-bottom:3px">${Xe(S.homePlayers,"rgba(255,255,255,0.7)",S.homeTotal,void 0,t.formation)}</div>`:""}
                ${(O=S.aiPlayers)!=null&&O.length?`<div style="opacity:0.7">${Xe(S.aiPlayers,"#ff6b6b",S.aiTotal,void 0,t.formation)}</div>`:""}
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${fi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Ie.id!==it.id?`<div style="font-size:20px;font-weight:900;color:${Ie.color}">
                  ...
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Re>J.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Te>=0?"📈":"📉"}</div>
      ...
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(te=q.querySelector("#pvp-end-home"))==null||te.addEventListener("click",()=>{q.remove(),et(e),l?g("mini-league",{openLeagueId:l}):g(a?"ranked":"home")})}const Z=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var z;const E=_.new;try{if(E.status==="finished"||E.forfeit){if(B)return;B=!0,k&&(clearInterval(k),k=null),E.game_state&&(f=E.game_state),ne(E);return}if(E.game_state){const A=f;f=E.game_state;const L=f._lastGC;if(L&&L.seq&&!ie.has(L.seq)&&(ie.add(L.seq),L.by!==p)){U(L.type,L.by,()=>W());return}const G=A[p+"Score"]||0,q=A[u+"Score"]||0,P=f[p+"Score"]||0,K=f[u+"Score"]||0,ee=P>G,re=K>q;if((ee||re)&&!D.has(f.round)){D.add(f.round);const te=[...f.log||[]].reverse().find(de=>de.isGoal),J=((te==null?void 0:te.homePlayers)||[]).map(de=>({name:de.name,note:de.note,portrait:de.portrait,job:de.job}));!!((z=te==null?void 0:te.text)!=null&&z.includes("DERNIER CORNER"))?be().then(()=>{Je(J,P,K,ee,()=>W())}):Je(J,P,K,ee,()=>W());return}W()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function j(_){Object.assign(f,_),f.lastActionAt=new Date().toISOString();const{error:E}=await v.from("matches").update({game_state:f}).eq("id",i);E&&x("Erreur de synchronisation","error");try{W()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function T(){if(B)return;B=!0,k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,E=n?"p2":"p1",z=n?"p1":"p2",A={...f,[E+"Score"]:3,[z+"Score"]:0,phase:"finished"},L=A.p1Score||0,G=A.p2Score||0;try{await v.from("matches").update({game_state:A}).eq("id",i);const{data:q,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:L,p_away_score:G,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await v.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{v.removeChannel(Z)}catch{}setTimeout(()=>{et(e),l?g("mini-league",{openLeagueId:l}):g("home")},800)}const Y={BOOST_STAT:({value:_=1,count:E=1,roles:z=[]},A,L)=>{const G=A[p+"Team"],q=Object.entries(G).filter(([P])=>!z.length||z.includes(P)).flatMap(([P,K])=>K.filter(ee=>!ee.used).map(ee=>({...ee,_line:P})));if(!q.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),L(A);return}oe(q,E,`Choisir ${E} joueur(s) à booster (+${_})`,P=>{P.forEach(K=>{const ee=(G[K._line]||[]).find(re=>re.cardId===K.cardId);ee&&(ee.boost=(ee.boost||0)+_,A.log.push({text:`⚡ +${_} sur ${ee.name}`,type:"info"}))}),A[p+"Team"]=G,L(A)})},DEBUFF_STAT:({value:_=1,count:E=1,roles:z=[],target:A="ai"},L,G)=>{const q=A==="home"?p:u,P=L[q+"Team"],K=A==="home"?"allié":"adverse",ee=Object.entries(P).filter(([re])=>!z.length||z.includes(re)).flatMap(([re,te])=>te.map(J=>({...J,_line:re})));if(!ee.length){L.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),G(L);return}oe(ee,E,`Choisir ${E} joueur(s) ${K}(s) (-${_})`,re=>{re.forEach(te=>{const J=(P[te._line]||[]).find(se=>se.cardId===te.cardId);J&&(J.boost=(J.boost||0)-_,L.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),L[q+"Team"]=P,G(L)})},GRAY_PLAYER:({count:_=1,roles:E=[],target:z="ai"},A,L)=>{const G=z==="home"?p:u,q=A[G+"Team"],P=z==="home"?"allié":"adverse",K=Object.entries(q).filter(([ee])=>!E.length||E.includes(ee)).flatMap(([ee,re])=>re.filter(te=>!te.used).map(te=>({...te,_line:ee})));if(!K.length){A.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),L(A);return}oe(K,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,ee=>{const re="usedCardIds_"+G,te=new Set(A[re]||[]);ee.forEach(J=>{const se=(q[J._line]||[]).find(de=>de.cardId===J.cardId);se&&(se.used=!0,te.add(J.cardId),A.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),A[re]=[...te],A[G+"Team"]=q,L(A)})},REVIVE_PLAYER:({count:_=1,roles:E=[]},z,A)=>{const L=z[p+"Team"],G=Object.entries(L).filter(([q])=>!E.length||E.includes(q)).flatMap(([q,P])=>P.filter(K=>K.used).map(K=>({...K,_line:q})));if(!G.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(z);return}oe(G,_,`Choisir ${_} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const K=(L[P._line]||[]).find(ee=>ee.cardId===P.cardId);K&&(K.used=!1,z.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=L,A(z)})},REMOVE_GOAL:({},_,E)=>{const z=u+"Score";_[z]>0?(_[z]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(_)},ADD_GOAL_DRAW:({},_,E)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(_)},ADD_SUB:({value:_=1},E,z)=>{E.maxSubs=(E.maxSubs||3)+_,E.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),z(E)},CUSTOM:({},_,E)=>E(_)};function oe(_,E,z,A){const L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let G=[];function q(){var K,ee;const P=_.map(re=>{const te=re._line||re.job||"MIL",J=G.find(de=>de.cardId===re.cardId),se=Ae({...re,_evolution_bonus:0},{width:90,showStad:!0,role:te,extraNote:re.boost||0});return`<div class="pp-item" data-cid="${re.cardId}"
        ...
        </div>`,(K=L.querySelector("#pp-close"))==null||K.addEventListener("click",()=>L.remove()),L.querySelectorAll(".pp-item").forEach(re=>{re.addEventListener("click",()=>{const te=re.dataset.cid,J=_.find(de=>de.cardId===te),se=G.findIndex(de=>de.cardId===te);J&&(se>-1?G.splice(se,1):G.length<E&&G.push(J),q())})}),(ee=L.querySelector("#pp-confirm"))==null||ee.addEventListener("click",()=>{L.remove(),A(G)})}q(),document.body.appendChild(L)}async function fe(_,E){const A=(f["gcCardsFull_"+p]||[]).find(P=>P.id===_),L=(A==null?void 0:A._gcDef)||(f.gcDefs||[]).find(P=>{var K;return P.name===E||((K=P.name)==null?void 0:K.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),G=[...f["usedGc_"+p]||[],_],q={type:E,by:p,seq:(f._gcAnimSeq||0)+1};ie.add(q.seq),U(E,p,async()=>{if(L!=null&&L.effect_type&&L.effect_type!=="CUSTOM"){const K=Y[L.effect_type];if(K){const ee={...f};K(L.effect_params||{},ee,async re=>{re["usedGc_"+p]=G,re._lastGC=q,re._gcAnimSeq=q.seq,await j(re)});return}}const P={...f};switch(E){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const K=u+"Score";P[K]>0&&(P[K]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=G,P._lastGC=q,P._gcAnimSeq=q.seq,await j(P)})}function me(_,E){const z="usedCardIds_"+_,A=new Set(f[z]||[]);E.forEach(L=>A.add(L)),f[z]=[...A]}function S(){for(const _ of["p1","p2"]){const E=new Set(f["usedCardIds_"+_]||[]),z=f[_+"Team"];if(z)for(const A of["GK","DEF","MIL","ATT"])(z[A]||[]).forEach(L=>{L.used=E.has(L.cardId)})}}function W(){var Ki,Vi,Yi,Wi,Xi,Ji;if(f.phase==="reveal")return pe();if(f.phase==="midfield")return V();if(f.phase==="finished")return xi();const _=f[p+"Team"],E=f[u+"Team"];S();const z=f[p+"Score"],A=f[u+"Score"],L=f[p+"Name"],G=f[u+"Name"],q=f.phase===p+"-attack",P=f.phase===p+"-defense",K=Array.isArray(f["selected_"+p])?f["selected_"+p]:[],ee=K.map(X=>X.cardId),re=window.innerWidth>=700,te=f[p+"Subs"]||[],J=f["usedSubIds_"+p]||[],se=te.filter(X=>!J.includes(X.cardId)),de=f["gcCardsFull_"+p]||[],xe=f["usedGc_"+p]||[],le=de.filter(X=>!xe.includes(X.id)),ye=f.boostOwner===p&&!f.boostUsed,he=[..._.MIL||[],..._.ATT||[]].filter(X=>!X.used),ae=[...E.MIL||[],...E.ATT||[]].filter(X=>!X.used),Te=!ze(E),Re=he.length===0&&ae.length===0&&!Te,Ie=(_.DEF||[]).filter(X=>!X.used),Ve=(_.GK||[]).filter(X=>!X.used);let He=[];q&&he.length===0&&(Te?(He=Ie.map(X=>X.cardId),Ie.length===0&&(He=He.concat(Ve.map(X=>X.cardId)))):Re&&(He=[...Ie,...Ve].map(X=>X.cardId)));function it(X,ge,Se){var Ct,ft;const ke=X._gcDef,Mt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ke==null?void 0:ke.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",rt={purple:"#b06ce0",light_blue:"#00d4ef"}[ke==null?void 0:ke.color]||"#b06ce0",qe=(ke==null?void 0:ke.name)||X.gc_type,Ne=(ke==null?void 0:ke.effect)||((Ct=Ce[X.gc_type])==null?void 0:Ct.desc)||"",Me=ke!=null&&ke.image_url?`/icons/${ke.image_url}`:null,_t=((ft=Ce[X.gc_type])==null?void 0:ft.icon)||"⚡",Fe=Math.round(Se*.22),ut=Math.round(Se*.22),at=Se-Fe-ut,jt=qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
        ...
        <div style="height:${Fe}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${jt}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ge-6}px">${qe}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${at}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Me?`<img src="${Me}" style="max-width:${ge-10}px;max-height:${at-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(at*.55)}px">${_t}</span>`}
        </div>
      ...
      </div>`}function Ht(X,ge){return`<div id="pvp-boost-card"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Rt(_,f[p+"Formation"],pt,ee,re?1300:Tt(),re?600:Pt(),He)}
      </div>
    </div>`,ot=f[p+"Team"],Un=(()=>{var ge,Se,ke,Mt,rt;if(P&&((ge=f.pendingAttack)!=null&&ge.players)){const qe=f.pendingAttack;let Ne="";if(K.length>0){const Me=K.map(Fe=>{const ut=(ot[Fe._role]||[]).find(yi=>yi.cardId===Fe.cardId)||Fe,at=ot[Fe._role]||[],jt=at.findIndex(yi=>yi.cardId===Fe.cardId),Ct=mt(at.length),ft=jt>=0?Ct[jt]:ut._col??1;return{...ut,_line:Fe._role,_col:ft}}),_t=Qt(Me,((Se=f.modifiers)==null?void 0:Se[p])||{},f[p+"Formation"]);Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Rt(_,f[p+"Formation"],pt,ee,Tt(),Pt(),He)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function At(){const X=e.querySelector(".match-screen");if(!X)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=ge+"px",X.style.minHeight=ge+"px",X.style.maxHeight=ge+"px",X.style.overflow="hidden";const Se=e.querySelector("#mobile-action-bar"),ke=e.querySelector("#mobile-play-area");Se&&ke&&(ke.style.paddingBottom=Se.offsetHeight+"px")}if(At(),setTimeout(At,120),setTimeout(At,400),I||(I=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",At),window.visualViewport.addEventListener("scroll",At)),window.addEventListener("resize",At)),function(){const ge=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ge)return;const Se=ge.closest("#match-terrain-wrap");Se&&(Se.style.cssText="position:relative;width:100%;height:100%;padding:0"),ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const ge=X.closest("#match-terrain-wrap");ge&&(ge.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!q&&!P)return;const ge=X.dataset.cardId,Se=X.dataset.role,ke=(_[Se]||[]).find(Ne=>Ne.cardId===ge);if(!ke||ke.used)return;const Mt=He.includes(ge);if(q&&!["MIL","ATT"].includes(Se)&&!Mt)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const rt=f["selected_"+p],qe=rt.findIndex(Ne=>Ne.cardId===ge);qe>-1?rt.splice(qe,1):rt.length<3&&rt.push({...ke,_role:Se}),W()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>H(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>H())}),(Ki=e.querySelector("#pvp-sub-open"))==null||Ki.addEventListener("click",()=>H()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{q?X.addEventListener("click",()=>M(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>kt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Vi=e.querySelector("#pvp-boost-card"))==null||Vi.addEventListener("click",()=>F()),(Yi=e.querySelector("#pvp-action"))==null||Yi.addEventListener("click",X=>{q?X.currentTarget.dataset.pass==="1"||!je(p)?N():Ee():P&&Le()}),(Wi=e.querySelector("#pvp-quit"))==null||Wi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&T()}),(Xi=e.querySelector("#pvp-view-opp"))==null||Xi.addEventListener("click",()=>R()),(Ji=e.querySelector("#pvp-toggle-history"))==null||Ji.addEventListener("click",()=>C()),k&&(clearInterval(k),k=null),(q||P)&&!B){let X=30,ge=!1;const Se=()=>document.getElementById("pvp-timer"),ke=()=>{Se()&&(Se().textContent=X+"s",Se().style.color=ge?"#ff4444":"#fff")};ke(),k=setInterval(()=>{X--,X<0?ge?(clearInterval(k),k=null,q&&!je(p)?N():T()):(ge=!0,X=15,ke()):ke()},1e3)}}function pe(){st(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(J);let se=!1;const de=()=>{se||(se=!0,J.remove(),setTimeout(()=>z&&z(),50))};J.addEventListener("click",de),setTimeout(de,3e3)}function M(_,E){var J,se,de,xe;const A=(f["gcCardsFull_"+p]||[]).find(le=>le.id===_),L=A==null?void 0:A._gcDef,G={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[L==null?void 0:L.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",q={purple:"#b06ce0",light_blue:"#00d4ef"}[L==null?void 0:L.color]||"#b06ce0",P=(L==null?void 0:L.name)||E,K=(L==null?void 0:L.effect)||((J=Ce[E])==null?void 0:J.desc)||"Carte spéciale.",ee=L!=null&&L.image_url?`/icons/${L.image_url}`:null,re=((se=Ce[E])==null?void 0:se.icon)||"⚡",te=document.createElement("div");te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",te.innerHTML=`
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${E.map(L=>{const G={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",q=Pe(L,L._line)+(L.boost||0);return`<div class="bp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${G};overflow:hidden;cursor:pointer">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${le?ht({...le,used:!1,boost:0},ye,he):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${xe?ht({...xe,used:!1,boost:0},ye,he):"<div>—</div>"}</div>
      ...
      </div>`,(Re=te.querySelector("#psub-close"))==null||Re.addEventListener("click",()=>te.remove()),(Ie=te.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{P>0&&(P--,J())}),(Ve=te.querySelector("#pout-down"))==null||Ve.addEventListener("click",()=>{P<G.length-1&&(P++,J())}),(He=te.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{ee>0&&(ee--,J())}),(it=te.querySelector("#pin-down"))==null||it.addEventListener("click",()=>{ee<q.length-1&&(ee++,J())});const Te=(Be,Ye,Ue,ct)=>{const nt=te.querySelector("#"+Be);if(!nt)return;let St=0;nt.addEventListener("touchstart",pt=>{St=pt.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",pt=>{const wt=pt.changedTouches[0].clientY-St;if(Math.abs(wt)<30)return;const ot=Ye();wt<0&&ot<ct-1?(Ue(ot+1),J()):wt>0&&ot>0&&(Ue(ot-1),J())},{passive:!0})};Te("pin-panel",()=>ee,Be=>ee=Be,q.length),Te("pout-panel",()=>P,Be=>P=Be,G.length),(Ht=te.querySelector("#psub-confirm"))==null||Ht.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),re)return;re=!0;const Ye=G[P],Ue=q[ee];if(!Ye||!Ue)return;const ct=Ye._line,nt=(z[ct]||[]).findIndex(wt=>wt.cardId===Ye.cardId);if(nt===-1){x("Erreur : joueur introuvable","error"),te.remove();return}const St={...Ue,_line:ct,position:Ye.position,used:!1,boost:0};z[ct].splice(nt,1,St);const pt=[...A,Ue.cardId];te.remove(),Q(Ye,Ue,async()=>{await j({[p+"Team"]:z,[u+"Team"]:f[u+"Team"],["usedSubIds_"+p]:pt})})})}document.body.appendChild(te),J()}function Q(_,E,z){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const G=(K,ee,re)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${A[K.job]||"#555"};border:3px solid ${ee};position:relative;overflow:hidden;margin:0 auto">
        ${Zt(K)?`<img src="${Zt(K)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      <div style="width:min(90vw,420px)">${fi(f[u+"Team"],f[u+"Formation"],null,[],Tt(),Pt())}</div>
      ...
      </div>`,document.body.appendChild(E),(z=E.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>E.remove())}async function N(){if(f.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",E=(f.round||0)+1,z=[...f.log||[]];z.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=Ge(f),L=je(_),G=A||!L?"finished":_+"-attack";await j({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:G,attacker:_,round:E,log:z}),G==="finished"&&await Oe(f)}function ce(_){const E=(_.GK||[]).some(A=>!A.used),z=["DEF","MIL","ATT"].some(A=>(_[A]||[]).some(L=>!L.used));return E&&!z}function ue(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ce(_.p1Team)&&!ze(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:ce(_.p2Team)&&!ze(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function be(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(z,A)=>new Promise(L=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${A};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(L,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function we(_,E){const{side:z,gk:A}=_;if(!A)return;const L=z+"Score",G=(E[L]||0)+1;A.used=!0;const q=[...E.log||[]];q.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[Bt(A)]:[],aiPlayers:z==="p2"?[Bt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[z+"Name"]} marque !`});const P=(E.round||0)+1,K=z==="p1"?"p2":"p1",ee={...E,[L]:G},re=Ge(ee);D.add(P),await be();const te=z===p?G:E[p+"Score"]||0,J=z===p?E[u+"Score"]||0:G;Je([Bt(A)],te,J,z===p,async()=>{await j({[L]:G,log:q,round:P,pendingAttack:null,phase:re?"finished":K+"-attack",attacker:K,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),re&&await Oe({...f,[L]:G})})}async function Ee(){const _=f[p+"Team"],E=!["GK","DEF","MIL","ATT"].some(G=>(f[u+"Team"][G]||[]).some(q=>!q.used)),z=(f["selected_"+p]||[]).map(G=>{const q=(_[G._role]||[]).find(de=>de.cardId===G.cardId)||G,P=["GK","DEF"].includes(G._role),K=_[G._role]||[],ee=K.findIndex(de=>de.cardId===G.cardId),re=mt(K.length),te=ee>=0?re[ee]:q._col??1,J=f.stadiumDef||f.homeStadiumDef||null,se=q.stadiumBonus||J&&(J.club_id&&String(q.club_id)===String(J.club_id)||J.country_code&&q.country_code===J.country_code)||!1;return{...q,_line:G._role,_col:te,stadiumBonus:se,...P?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!z.length)return;const A=Jt(z,f.modifiers[p]||{},f[p+"Formation"]);me(p,z.map(G=>G.cardId)),z.forEach(G=>{const q=(_[G._role]||[]).find(P=>P.cardId===G.cardId);q&&(q.used=!0)}),f["selected_"+p]=[],W();const L=[...f.log||[]];if(E){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await we({side:p,gk:z[0]},{...f,[p+"Team"]:_,log:L});return}const q=(f[p+"Score"]||0)+1,P=z.map(J=>Bt(J));L.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:A.total,aiTotal:0});const K=(f.round||0)+1,ee=p==="p1"?"p2":"p1",re={...f,[p+"Team"]:_,[p+"Score"]:q},te=Ge(re);D.add(K),Je(P,q,f[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:_,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:te?"finished":ee+"-attack",attacker:ee,round:K,log:L}),te&&await Oe({...f,[p+"Score"]:q})});return}L.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${A.total})`}),await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],pendingAttack:{...A,players:z,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:L})}async function Le(){const _=f[p+"Team"],E=(f["selected_"+p]||[]).map(le=>{const ye=(_[le._role]||[]).find(Ie=>Ie.cardId===le.cardId)||le,he=_[le._role]||[],ae=he.findIndex(Ie=>Ie.cardId===le.cardId),Te=mt(he.length),Re=ae>=0?Te[ae]:ye._col??1;return{...ye,_line:le._role,_col:Re}}),z=Qt(E,f.modifiers[p]||{},f[p+"Formation"]);me(p,E.map(le=>le.cardId)),E.forEach(le=>{const ye=(_[le._role]||[]).find(he=>he.cardId===le.cardId);ye&&(ye.used=!0)}),f["selected_"+p]=[],W();const A=Gi(f.pendingAttack.total,z.total,f.modifiers[p]||{}),L=f.pendingAttack.side,G=A==="attack"||(A==null?void 0:A.goal),q=L==="p1"?"p2":"p1",P=(f.round||0)+1,K=(f.pendingAttack.players||[]).map(le=>Bt(le)),ee=[...f.log||[]];ee.push({type:"duel",isGoal:G,homeScored:G&&L===p,text:G?`⚽ BUT de ${f[L+"Name"]} ! (${f.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${z.total})`,homePlayers:K,aiPlayers:E.map(le=>Bt(le)),homeTotal:f.pendingAttack.total,aiTotal:z.total});const re=G?(f[L+"Score"]||0)+1:f[L+"Score"]||0,te={...f,[p+"Team"]:_,[L+"Score"]:re},J=Ge(te),se=J?"finished":q+"-attack",de=!J&&!G?ue(te):null,xe=async()=>{if(de){await we(de,te);return}await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],[L+"Score"]:re,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:se,attacker:q,round:P,log:ee}),(se==="finished"||J)&&await Oe({...f,[L+"Score"]:re})};if(G){const le=L===p,ye=le?re:f[p+"Score"]||0,he=le?f[u+"Score"]||0:re;D.add(P),Je(K,ye,he,le,xe)}else await xe()}function _e(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function ze(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function De(_){return ze(_)&&!_e(_)}function je(_){const E=f[_+"Team"],z=f[(_==="p1"?"p2":"p1")+"Team"];return!!(_e(E)||De(E)&&!ze(z)||De(E)&&!_e(z)&&ze(z))}function Ge(_){return!ze(_.p1Team)&&!ze(_.p2Team)}function tt(_){const E=_.p1Score||0,z=_.p2Score||0;return E===z?null:E>z?h.home_id:h.away_id}async function Oe(_){try{const E=tt(_),z=E?h.home_id===E?h.away_id:h.home_id:null,A=_.p1Score||0,L=_.p2Score||0,{data:G,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:A,p_away_score:L,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}E&&z&&ho(E,z).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof c=="function")try{await c({homeScore:A,awayScore:L,winnerId:E,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(E){console.error("[PvP] finishMatch:",E)}}function xi(){var L;const _=f[p+"Score"],E=f[u+"Score"],z=_>E,A=_===E;st(e),e.innerHTML=`
    ...
    </div>`,(L=document.getElementById("pvp-home"))==null||L.addEventListener("click",()=>{try{v.removeChannel(Z)}catch{}et(e),l?g("mini-league",{openLeagueId:l}):g("home")})}W()}async function Mi(e,t,i=!1){var s,d;const{state:n,navigate:r,toast:o}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await gi(e,t,i?"ranked":"random",async({deckId:c,formation:l,starters:m,subsRaw:y,gcCardsEnriched:g,gcDefs:x,stadiumDef:p})=>{st(e);const u=async b=>{await hr(e,t,c,l,m,y,b||[],x,p,i,a)};if(!(g!=null&&g.length)){await u([]);return}ui(e,g,u)})}async function br(e,t,i){return yr(e,t,i)}async function hr(e,t,i,n,r,o,a=[],s=[],d=null,c=!1,l=null){var ne,Z;const{state:m,navigate:y,toast:g}=t,x=(l==null?void 0:l.mmr)??((ne=m.profile)==null?void 0:ne.mmr)??1e3,p=c?Di(x):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,$=null;e.innerHTML=`
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Ut};border:1px solid ${Kt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((j,T)=>{const Y=x>0&&a.status==="finished"?T===0?Math.floor(x*.7):T===1?Math.floor(x*.2):T===2?Math.floor(x*.1):0:0;return`<tr style="border-bottom:1px solid ${Et};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${Ut};border:1px solid ${Kt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,T)=>T+1).reverse().map(j=>{const T=(d||[]).filter(Y=>Y.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Qe};margin-bottom:6px">Journée ${j}</div>${T.map(Y=>un(Y,m,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function y(p){var I,D,ie,ne;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const b=((D=p.card)==null?void 0:D.evolution_bonus)||0,w=qt(u,u.job,b),h=u.job2?qt(u,u.job2,b):0,$=p.status==="sold",f=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,B=ri[u.job]||"#bbb",k=u.job2?ri[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${f?`<img src="${f}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ie=u.clubs)!=null&&ie.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${B};display:flex;align-items:center;justify-content:center">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function na(){document.documentElement.setAttribute("data-theme",Nn()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Ci()}),document.getElementById("modal-close").addEventListener("click",Ci);const{data:{session:e}}=await v.auth.getSession();if(!e){gn(),ia(document.getElementById("app"),{onPlay:()=>Qi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Dt})});return}ve.user=e.user,await Vt(),gn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),Wn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!ve.profile){Qn(document.getElementById("app"),{state:ve,navigate:async()=>{await Vt(),ki()},toast:Dt,refreshProfile:Vt});return}const t=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&t.length>0){Yo(document.getElementById("app"),{state:ve,navigate:()=>ki(),toast:Dt,refreshProfile:Vt});return}ki(),setTimeout(()=>Or(ve.profile,Ft,Dt),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",Qi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Dt}))})}function oa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function mi(){const e=document.getElementById("app");e&&(e.style.height=oa()+"px")}window.addEventListener("resize",mi);window.addEventListener("orientationchange",()=>setTimeout(mi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",mi);function ki(){const e=()=>{var i;(i=ve.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",mi(),ea(),On()}function gn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Hn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
