...
import{s as v,t as Oo,u as Ho,n as ut,g as Bt,p as nt,v as si,o as Ut,r as je,k as At,w as Gi,x as Ft,y as Ii,F as Ai,z as Uo,T as Di,q as $n,C as En,d as Ln}from"./special-cards-DNsLLa5x.js";const Sn="/";function wo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,s,c,d,l,u,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const d=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),u=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",x=u.trim().split(" ").filter(Boolean),b=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():u.slice(0,2).toUpperCase();d&&(d.style.background=a,d.style.borderColor=n),l&&(l.textContent=b,l.style.color=n)}document.getElementById("color1").addEventListener("input",d=>{n=d.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",d=>{a=d.target.value,document.getElementById("swatch2").style.background=a,s()});function c(d){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${d}`).classList.add("active"),document.getElementById("step-num").textContent=d,document.getElementById("progress-fill").style.width=`${Math.round(d/3*100)}%`,d===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",d.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await v.from("users").select("id").eq("pseudo",d).maybeSingle();if(u){l.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const d=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",d.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await v.from("users").select("id").eq("club_name",d).maybeSingle();if(u){l.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),x=document.getElementById("step3-finish");u.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:d,club_name:l,club_color1:n,club_color2:a,credits:15e3});if(b)throw b;await In(e.user.id),await r(),o(`Bienvenue ${d} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){u.textContent=b.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function In(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const An="modulepreload",zn=function(t){return"/"+t},_o={},Ko=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=zn(c),c in _o)return;_o[c]=!0;const d=c.endsWith(".css"),l=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${l}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":An,d||(u.as="script"),u.crossOrigin="",u.href=c,s&&u.setAttribute("nonce",s),document.head.appendChild(u),d)return new Promise((x,b)=>{u.addEventListener("load",x),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},Vo="mw_sound_volume";function Zi(){const t=localStorage.getItem(Vo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function Mn(t){localStorage.setItem(Vo,String(Math.max(0,Math.min(100,Math.round(t)))))}function eo(){return Zi()===0}function wi(t){return Math.max(0,Math.min(1,t*(Zi()/100)))}function to(t,e=1){if(eo())return null;try{const i=new Audio(t);return i.volume=wi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Oi=null,ko=.3;function Yo(t,e=.3){if(ko=e,ht&&Oi===t&&!ht.paused){ht.volume=wi(ko);return}if(Ot(),!eo())try{const i=new Audio(t);i.loop=!0,i.volume=wi(e),i.play().catch(()=>{}),ht=i,Oi=t}catch{}}function Ot(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Oi=null}let ti=null;function Wo(t,e=.6){if(Ve(),!eo())try{const i=new Audio(t);i.volume=wi(e),i.play().catch(()=>{}),ti=i}catch{}}function Ve(){if(ti)try{ti.pause(),ti.currentTime=0}catch{}ti=null}async function Xo(t=null){const e=new Date().toISOString().slice(0,10),{data:i}=await v.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const o=i.filter(a=>!(a.available_from&&e<a.available_from||a.available_until&&e>a.available_until));if(!o.length)return[];let r=o;if(t){const a=o.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await v.from("booster_claims").select("booster_id").eq("user_id",t).in("booster_id",a.map(d=>d.id)),c={};(s||[]).forEach(d=>{c[d.booster_id]=(c[d.booster_id]||0)+1}),r=o.filter(d=>d.max_per_user==null?!0:(c[d.id]||0)<d.max_per_user)}}if(!r.length)return[];const{data:n}=await v.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(n||[]).filter(s=>s.booster_id===a.id)}))}async function Cn(t,e){const{data:i}=await v.from("booster_configs").select("max_per_user").eq("id",e).single();i!=null&&i.max_per_user&&await v.from("booster_claims").insert({user_id:t,booster_id:e})}function jn(t){if(!(t!=null&&t.length))return null;const e=t.reduce((o,r)=>o+Number(r.percentage),0);let i=Math.random()*e;for(const o of t)if(i-=Number(o.percentage),i<=0)return o;return t[t.length-1]}const Jo=()=>Object.keys(ut),qn=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Hi={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Bn(t){const e=t.player;if(!e)return"";const i=t.evolution_bonus||0;return je({...e,_evolution_bonus:i},{width:140})}function io(t){var r;const e={};(t.rates||[]).forEach(n=>{e[n.card_type]=(e[n.card_type]||0)+Number(n.percentage||0)});const i=((r=Object.entries(e).sort((n,a)=>a[1]-n[1])[0])==null?void 0:r[0])||"player",o=t.image_url||"booster-players.png";return{id:t.id,img:"/icons/"+o,name:t.name,sub:`${t.card_count} carte(s)`,cost:t.price_type==="credits"&&t.price_credits||0,costLabel:t.price_type==="credits"?`${(t.price_credits||0).toLocaleString("fr")} crédits`:t.price_type==="pub"?"1 pub":"Gratuit",cardCount:t.card_count||5,type:i,isPub:t.price_type==="pub",rates:t.rates||[],allow_duplicates:t.allow_duplicates!==!1,_boosterId:t.id,_raw:t}}async function Dn(t,e,i,o){if(t.reward_type==="credits"){const r=(e.credits||0)+(t.credits_amount||0),{error:n}=await v.from("users").update({credits:r}).eq("id",e.id);if(n)throw n;return e.credits=r,{type:"credits",amount:t.credits_amount}}if(t.reward_type==="card"){const{data:r}=await v.from("players").select("firstname, surname_real, rarity").eq("id",t.player_id).single(),{error:n}=await v.from("cards").insert({owner_id:e.id,player_id:t.player_id,card_type:"player"});if(n)throw n;return{type:"card",player:r}}if(t.reward_type==="booster"){const{data:r}=await v.from("booster_configs").select("*").eq("id",t.booster_config_id).single(),{data:n}=await v.from("booster_drop_rates").select("*").eq("booster_id",t.booster_config_id);if(!r)throw new Error("Booster introuvable (peut-être supprimé depuis).");const a=io({...r,rates:n});let s=[];return a.type==="formation"?s=await ro(e,0):a.type==="game_changer"?s=await no(e,a.cardCount,0):a.type==="player"?s=await oo(e,a.cardCount,0):s=await _i(e,{...a,cost:0}),{type:"booster",name:r.name,cards:s}}throw new Error("Type de récompense inconnu.")}async function Fn(t,{state:e,navigate:i,toast:o}){var u,x,b;Yt(i,e.profile,"boosters","/icons/",o);const r=((u=e.profile)==null?void 0:u.credits)||0;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let n=[];try{n=(await Xo((x=e.user)==null?void 0:x.id)).map(io)}catch(g){console.warn("Erreur chargement boosters DB, fallback hardcodé",g)}n.length||(n=qn.map(g=>({...g,rates:[],isPub:g.id==="players_pub"})));const a=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.profile.id).then(g=>g.data||[]),s=new Set(a.filter(g=>g.card_type==="stadium").map(g=>g.stadium_id)),c=new Set(a.filter(g=>g.card_type==="formation").map(g=>g.formation)),d=new Set(a.filter(g=>g.card_type==="game_changer").map(g=>g.gc_type)),l={};for(const g of n){if(g.allow_duplicates!==!1||!((b=g.rates)!=null&&b.length))continue;const f=[...new Set((g.rates||[]).map(p=>p.card_type))];let y=!1;for(const p of f)if(p==="stadium"){const{data:w}=await v.from("stadium_definitions").select("id");if((w||[]).some(h=>!s.has(h.id))){y=!0;break}}else if(p==="game_changer"){const{data:w}=await v.from("gc_definitions").select("name").eq("is_active",!0);if((w||[]).some(h=>!d.has(h.name))){y=!0;break}}else if(p==="formation"){const{FORMATION_LINKS:w}=await Ko(async()=>{const{FORMATION_LINKS:h}=await import("./special-cards-DNsLLa5x.js").then(E=>E.G);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(w).some(h=>!c.has(h))){y=!0;break}}else{y=!0;break}y||(l[g.id]=!0)}t.innerHTML=`
  <div class="page">
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let c=!1;const d=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function l(_){n||(c=!0,s.style.opacity="1",u(_))}function u(_){if(!c||n)return;const G=a.getBoundingClientRect(),O=d(_)-G.left,le=Math.max(0,Math.min(1,O/G.width));s.style.width=le*G.width+"px",le>=.82&&b()}function x(){n||(c=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{n||(s.style.transition="")},220))}function b(){var G;if(n)return;n=!0,c=!1,s.style.width="100%",s.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",p(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",u),window.addEventListener("pointerup",x),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",x);let g=0,f=!1;const y=new Set;function p(_){g=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),I()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((G,O)=>`<div class="card-dot" data-i="${O}" style="width:8px;height:8px;border-radius:50%;background:${O===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>m(parseInt(G.dataset.i)))))}function h(_,G){var de,q;const O=t[_],le=document.getElementById("card-counter"),pe=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${t.length}`);const M=document.getElementById("reveal-btns");M&&(M.style.display=_===t.length-1?"flex":"none");const H=O.card_type==="player"&&((de=O.player)==null?void 0:de.rarity)==="legende",fe=!y.has(_);y.add(_);let xe=0;if(O.card_type==="player"&&O.player){const W=O.player,ee=W.job||"ATT";xe=(Number(ee==="GK"?W.note_g:ee==="DEF"?W.note_d:ee==="MIL"?W.note_m:W.note_a)||0)+(O.evolution_bonus||0)}const ge=W=>{pe.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",e.user.id)};async function u(){var w;if(d>=c||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),r&&await r(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const g=a[0],{data:f}=await v.from("users").select("*").eq("id",e.user.id).single();f&&(e.profile=f);let y=[];try{if(g.type==="formation")y=await ro(e.profile,0);else if(g.type==="game_changer")y=await no(e.profile,g.count||3,0);else if(s&&((w=s.rates)!=null&&w.length)){const h={...s,cost:0,cardCount:g.count||s.cardCount||5};y=await _i(e.profile,h),g.guaranteeGK&&!e.profile.first_booster_opened&&(y.some(m=>m.player&&m.player.job==="GK")||await Vn(e.profile,y),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else y=await oo(e.profile,g.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}a.shift(),d++,await l();const p=g.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:g.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${d}/${c})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};Qo(y,p,i,()=>{u()})}(b=document.getElementById("onboard-start"))==null||b.addEventListener("click",()=>u())}async function Vn(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],r=e.findIndex(a=>a.player);if(r===-1)return;const n=e[r];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[r]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Yn=[{key:"home2",route:"home2",label:"ACCUEIL",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARTES",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"EQUIPES",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOUTIQUE",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Yt(t,e,i,o,r){if(!document.getElementById("home2-chrome-style")){const u=document.createElement("style");u.id="home2-chrome-style",u.textContent=`
    ...
    `,document.head.appendChild(u)}const n=Yn.map(u=>`
    ...
    `,document.body.appendChild(s),s.querySelector("#home2-mobtop-settings-btn").addEventListener("click",()=>t("settings")),s.querySelector("#home2-mobtop-credits").addEventListener("click",()=>$o(e,r)));let c=document.getElementById("home2-mobile-bottom");c||(c=document.createElement("div"),c.id="home2-mobile-bottom",c.className="home2-mobile-bottom",c.innerHTML=n,document.body.appendChild(c)),document.querySelectorAll(".home2-chrome-tab").forEach(u=>{u._v2Bound||(u._v2Bound=!0,u.addEventListener("click",()=>{document.querySelectorAll(".home2-chrome-tab").forEach(x=>x.classList.remove("active")),document.querySelectorAll(`.home2-chrome-tab[data-key="${u.dataset.key}"]`).forEach(x=>x.classList.add("active")),t(u.dataset.route)}))}),document.querySelectorAll(".home2-chrome-tab").forEach(u=>u.classList.toggle("active",u.dataset.key===i));const d=`💰 ${(e.credits||0).toLocaleString("fr")}`;document.getElementById("home2-chrome-credits")&&(document.getElementById("home2-chrome-credits").textContent=d),document.getElementById("home2-mobtop-credits")&&(document.getElementById("home2-mobtop-credits").textContent=d),document.body.classList.remove("v2-match-flow"),a.style.display="",s.style.display="",c.style.display="";const l=document.getElementById("page-content");l&&(l.style.removeProperty("padding-top"),l.style.removeProperty("padding-bottom")),requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=window.innerWidth<1024;document.documentElement.style.setProperty("--v2-top-height",(u?s.offsetHeight:a.offsetHeight)+"px"),document.documentElement.style.setProperty("--v2-bottom-height",c.offsetHeight+"px")})})}const Wn=[{ads:1,seconds:5,credits:4500},{ads:2,seconds:10,credits:9500},{ads:3,seconds:15,credits:15e3}];async function $o(t,e){if(!await Oo("pub_mode")){Ho();return}const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:9999;padding:16px",i.innerHTML=`
    ...
    </div>`,document.body.appendChild(i),i.querySelector("#credits-ad-cancel").addEventListener("click",()=>i.remove()),i.querySelectorAll(".credits-ad-offer-btn").forEach(o=>{o.addEventListener("click",()=>{i.remove(),Xn(parseInt(o.dataset.ads),5,parseInt(o.dataset.credits),t,e)})})}function Xn(t,e,i,o,r){let n=1;const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;gap:14px;color:#fff;padding:16px",document.body.appendChild(a);function s(){a.innerHTML=`
    ...
    `;try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(u){console.warn("[AdSense]",u)}let d=e;const l=setInterval(()=>{d--;const u=a.querySelector("#credits-ad-cd");u&&(u.textContent=d),d<=0&&(clearInterval(l),c())},1e3)}function c(){var u,x;const d=a.querySelector("#credits-ad-status"),l=a.querySelector("#credits-ad-next-zone");n<t?(d&&(d.textContent="Publicité terminée ✅"),l&&(l.innerHTML=`
        <button id="credits-ad-next-btn" class="btn btn-primary" style="width:100%;padding:12px;font-size:14px">
          Suivant (${n}/${t}) →
        </button>`),(u=a.querySelector("#credits-ad-next-btn"))==null||u.addEventListener("click",()=>{n++,s()})):(d&&(d.textContent="Toutes les publicités ont été vues ✅"),l&&(l.innerHTML=`
        ...
        </button>`),(x=a.querySelector("#credits-ad-claim-btn"))==null||x.addEventListener("click",async()=>{const b=a.querySelector("#credits-ad-claim-btn");b.disabled=!0,b.textContent="⏳...";const g=(o.credits||0)+i,{error:f}=await v.from("users").update({credits:g}).eq("id",o.id);if(f){r(f.message,"error"),b.disabled=!1;return}o.credits=g,Wt(g),r(`+${i.toLocaleString("fr")} crédits ✅`,"success"),a.remove()}))}s()}async function Jn(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;align-items:center;justify-content:center;z-index:9999;padding:16px",document.body.appendChild(i);async function o(){var a;const{data:r}=await v.from("pending_rewards").select("*, player:players(firstname, surname_real), booster:booster_configs(name)").eq("user_id",t.profile.id).eq("claimed",!1).order("created_at",{ascending:!0});if(!(r!=null&&r.length)){i.remove();const s=document.getElementById("pending-rewards-banner");s&&s.remove();return}const n=s=>{var c,d,l;return s.reward_type==="credits"?{icon:"💰",text:`${(s.credits_amount||0).toLocaleString("fr")} crédits`}:s.reward_type==="card"?{icon:"🃏",text:`${((c=s.player)==null?void 0:c.firstname)||""} ${((d=s.player)==null?void 0:d.surname_real)||""}`.trim()||"Carte joueur"}:s.reward_type==="booster"?{icon:"🎁",text:((l=s.booster)==null?void 0:l.name)||"Booster"}:{icon:"❓",text:"Récompense"}};i.innerHTML=`
      <div style="background:#111a12;border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:24px;max-width:420px;width:100%;max-height:80vh;overflow-y:auto;color:#fff">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ${r.map(s=>{const{icon:c,text:d}=n(s);return`<div style="display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:12px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)">
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Fi(t,{state:e,navigate:i,toast:o}){var m,T,$,I,D,V,Y;const r=e.profile;if(!r)return;const n="/icons/";Yt(i,r,"home2",n,o);const a=r.mmr??1e3,s=At(a),c=Zn(a,s),d=Gi(a),l=isFinite(s.max)?s.max+1:null,[{list:u,iAmInTop:x,myPosition:b},g,f,{count:y}]=await Promise.all([er(r.id),tr(5),ir(),v.from("pending_rewards").select("*",{count:"exact",head:!0}).eq("user_id",r.id).eq("claimed",!1)]),p=(j,L)=>`
  ...
  <div class="home-dark" id="home-dark">
      ...
      <div class="home2-dash">
        ...
        <div class="home2-col-right">
          <div class="news-widget">
            ...
            ${g.length?g.map(w).join(""):'<div style="font-size:11px;color:var(--tile-fg-dim);padding:8px 0">Aucune actualité pour le moment.</div>'}
          </div>
        </div>
  ...
  </div>`,document.body.appendChild(n),n.querySelector("#claim-later-btn").addEventListener("click",()=>n.remove()),n.querySelector("#claim-all-btn").addEventListener("click",async a=>{const s=a.currentTarget;s.disabled=!0,s.textContent="...";let c=0;for(const d of o){const{data:l}=await v.rpc("claim_mini_league_prize",{p_league_id:d.league_id,p_user_id:i});l!=null&&l.success&&!l.already_claimed&&(c+=l.prize||0)}if(c>0){t.profile.credits=(t.profile.credits||0)+c;const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${t.profile.credits.toLocaleString("fr")}`),e(`💰 +${c.toLocaleString("fr")} cr. récupérés !`,"success")}n.remove()})}async function Zo(t,e,i){const o=document.getElementById("ongoing-match-banner");if(!o)return;const r=t.profile.id,{data:n}=await v.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(n!=null&&n.length)){o.innerHTML="";return}const a=n.map(c=>c.home_id===r?c.away_id:c.home_id).filter(Boolean);let s={};if(a.length){const{data:c}=await v.from("users").select("id, pseudo, club_name").in("id",a);(c||[]).forEach(d=>{s[d.id]=d.club_name||d.pseudo})}o.innerHTML=n.map(c=>{const d=c.home_id===r?c.away_id:c.home_id,l=s[d]||"Adversaire",u=c.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
    ...
    </div>`}).join(""),o.querySelectorAll("[data-resume]").forEach(c=>{c.addEventListener("click",async()=>{mt();const d=document.getElementById("page-content")||document.getElementById("app");if(c.dataset.mini==="1"){const{data:l}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",c.dataset.resume).single();l?i("match-mini-league",{mlMatchId:l.id,leagueId:l.league_id}):i("mini-league")}else{const{resumePvpMatch:l}=await Ko(async()=>{const{resumePvpMatch:u}=await Promise.resolve().then(()=>aa);return{resumePvpMatch:u}},void 0);l(d,{state:t,navigate:i,toast:e,openModal:null,closeModal:null,refreshProfile:null},c.dataset.resume)}})}),o.querySelectorAll("[data-abandon]").forEach(c=>{c.addEventListener("click",()=>{ar(async()=>{await rr(c.dataset.abandon,c.dataset.opp,r),e("Match abandonné (défaite 3-0)","info"),Zo(t,e,i)})})})}async function rr(t,e,i){Ot();const{data:o}=await v.from("matches").select("home_id, away_id, game_state, mode").eq("id",t).single();if(!o)return;const r=o.home_id===i,n=r?0:3,a=r?3:0,s=o.game_state||{};s.p1Score=n,s.p2Score=a,s.phase="finished",s.forfeit=!0,await v.from("matches").update({status:"finished",forfeit:!0,winner_id:e,home_score:n,away_score:a,game_state:s}).eq("id",t),o.mode==="mini_league"&&await v.from("mini_league_matches").update({status:"finished",home_score:n,away_score:a}).eq("match_id",t)}function ar(t){const e=document.createElement("div");e.className="modal-overlay",e.innerHTML=`<div class="modal" style="max-width:340px">
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${x.map(({friendshipId:b,friend:g})=>cr(g,b)).join("")}
    </div>`,d.querySelectorAll("[data-stats]").forEach(b=>{b.addEventListener("click",()=>ur(t,b.dataset.stats,b.dataset.friendName))}),d.querySelectorAll("[data-match]").forEach(b=>{b.addEventListener("click",async()=>{const g=b.dataset.friendId,f=b.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const y=t.user.id,{data:p}=await v.from("friend_match_invites").select("id").eq("inviter_id",g).eq("invitee_id",y).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),w=!!p;console.log("[Friends] clic match",{fid:g,fname:f,isAccepting:w}),mt(),o("match",{matchMode:"friend",friendId:g,friendName:f,isAccepting:w})})})}function cr(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",r=(o||i).slice(0,2).toUpperCase(),n=t.club_color2||di,a=t.club_color1||"#ffffff",s=t.last_seen_at?new Date(t.last_seen_at):null,c=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    ${so()}`,document.body.appendChild(d);const u=()=>d.remove();d.querySelector("#pending-close").addEventListener("click",u),d.addEventListener("click",x=>{x.target===d&&u()}),d.querySelectorAll("[data-accept]").forEach(x=>{x.addEventListener("click",async()=>{const{error:b}=await v.from("friendships").update({status:"accepted"}).eq("id",x.dataset.accept);if(b){e("Erreur : "+b.message,"error");return}x.closest("div[style]").remove(),e("✅ Ami accepté !","success"),on(t,e,o),i&&i()})}),d.querySelectorAll("[data-decline]").forEach(x=>{x.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",x.dataset.decline),x.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function ur(t,e,i){const o=t.user.id,[r,n]=[o,e].sort(),a=o===r,{data:s}=await v.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",n).single(),c=t.profile.club_name||t.profile.pseudo||"Moi",d=s||{},l=a?d.wins_p1||0:d.wins_p2||0,u=a?d.wins_p2||0:d.wins_p1||0,x=d.draws||0,b=a?d.goals_p1||0:d.goals_p2||0,g=a?d.goals_p2||0:d.goals_p1||0,f=a?d.gc_used_p1||0:d.gc_used_p2||0,y=a?d.gc_used_p2||0:d.gc_used_p1||0,p=d.matches_total||0,w=(E,m,T,$=di,I=li)=>`
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const s=a.dataset.action;if(s==="match-ai"){tn(i,e);return}if(s==="match-random"){mt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function rn(t,e){var f,y;const{state:i,navigate:o}=e,r=ai(),n=Zi(),a=(f=i==null?void 0:i.profile)==null?void 0:f.is_admin,s="2026.07.30-2148";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${je(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),d=(s||[]).filter(q=>q.card_type==="player"&&q.player),l=(s||[]).filter(q=>q.card_type==="game_changer"),u=(s||[]).filter(q=>q.card_type==="formation"),x=(s||[]).filter(q=>q.card_type==="stadium"),{data:b}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(q=>{g[q.name]=q});const{data:f}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),y={};(f||[]).forEach(q=>{y[q.id]=q}),x.forEach(q=>{q.stadium_def&&(y[q.stadium_id]=q.stadium_def)});const p=Object.keys(Ai),w=Object.keys(Oe),h={};d.forEach(q=>{const W=q.player.id;h[W]=(h[W]||0)+1}),new Set(Object.keys(h).map(q=>String(q)));const E=new Set(u.map(q=>q.formation)),m=new Set(l.map(q=>q.gc_type));let T="player",$="Tous",I="",D=!1,V=!1;function Y(){return[...d].sort((q,W)=>{const ee=mi.indexOf(q.player.job),ie=mi.indexOf(W.player.job);return ee!==ie?ee-ie:(q.player.surname_real||"").localeCompare(W.player.surname_real||"")})}function j(){return[...c||[]].sort((q,W)=>{const ee=mi.indexOf(q.job),ie=mi.indexOf(W.job);return ee!==ie?ee-ie:(q.surname_real||"").localeCompare(W.surname_real||"")})}function L(){return Y().filter(q=>{const W=q.player,ee=$==="Tous"||W.job===$,ie=!I||`${W.firstname} ${W.surname_real}`.toLowerCase().includes(I);return ee&&ie})}function _(){return j().filter(q=>{const W=$==="Tous"||q.job===$,ee=!I||`${q.firstname} ${q.surname_real}`.toLowerCase().includes(I);return W&&ee})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${d} pour ${xi.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const p=x.find(h=>!h.is_for_sale)||x[0];if(!p){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",p.id),await v.from("transfer_history").delete().eq("card_id",p.id);const{error:w}=await v.from("cards").delete().eq("id",p.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+xi}).eq("id",r.profile.id),await c(),n(`+${xi.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(f=document.getElementById("market-sell-form-btn"))==null||f.addEventListener("click",async()=>{const p=parseInt(document.getElementById("sell-price-form").value);if(!p||p<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:p}).eq("id",t.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:p}),n("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(y=document.getElementById("cancel-sell-form-btn"))==null||y.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),s("collection")})}async function Io(t,e,i,o){var fe,xe,ge,de,q,W,ee,ie,X,R,J;const{state:r,toast:n,openModal:a,closeModal:s,navigate:c,refreshProfile:d}=o,l=t.player,u=e.filter(P=>P.player.id===l.id),x=u.length,b=t.evolution_bonus||0,g=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?b:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?b:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?b:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?b:0)),f=l.rarity||"normal",{data:y}=await v.from("sell_price_configs").select("*").eq("rarity",f).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1),p=((fe=y==null?void 0:y[0])==null?void 0:fe.price)??br[f]??1e3,w=((xe=y==null?void 0:y[0])==null?void 0:xe.price_min)??null,h=((ge=y==null?void 0:y[0])==null?void 0:ge.price_max)??null;Bt(l);const E=gi(l,l.job)+b,m=l.job2?gi(l,l.job2)+(gi(l,l.job2)>0?b:0):null;ei[l.job],l.job2&&ei[l.job2];const T=gr[l.rarity]||"#ccc",$=hr[l.country_code]||l.country_code||"",I=t.evolution_bonus||0,V=E+I,Y=m||0,j=Y>0?Y+I:0,L=u.map(P=>P.id);let _={};if(L.length){const{data:P}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",L).order("transferred_at",{ascending:!0});(P||[]).forEach(U=>{_[U.card_id]||(_[U.card_id]=[]),_[U.card_id].push(U)})}const G=L.length?`
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <!-- Carte visuelle -->
      ${je({...l,_evolution_bonus:b},{width:160})}
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(q=document.getElementById("close-detail"))==null||q.addEventListener("click",s);let O=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function pe(){let P=0;return document.querySelectorAll(".expl-check:checked").forEach(U=>{if(U.dataset.id===t.id)return;const ce=Number(U.dataset.evo)||0,be=Number(U.dataset.note)||0;P+=be+ce}),Math.round(P*le)}const M=()=>{const P=O.size,U=document.getElementById("sell-action-panel");if(!U)return;U.style.display=P>0?"block":"none",document.getElementById("sell-selected-count").textContent=P;const ae=document.getElementById("evolve-btn");if(ae){const ce=pe();ae.textContent=ce>0?`⬆️ Évoluer (+${ce})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(P=>{P.addEventListener("change",()=>{const U=P.dataset.id;P.checked?O.add(U):O.delete(U);const ae=P.closest(".exemplaire-row");if(ae){const ce=ae.querySelector(".expl-sel-overlay"),be=ae.querySelector(".expl-sel-check");ce&&(ce.style.display=P.checked?"block":"none"),be&&(be.style.display=P.checked?"flex":"none"),ae.style.transform=P.checked?"scale(1.05)":"scale(1)"}M()})}),document.querySelectorAll(".exemplaire-row").forEach(P=>{P.addEventListener("click",U=>{if(U.target.tagName==="INPUT")return;const ae=P.querySelector(".expl-check");ae&&!ae.disabled&&(ae.checked=!ae.checked,ae.dispatchEvent(new Event("change")))})}),(W=document.getElementById("evolve-btn"))==null||W.addEventListener("click",async()=>{if(x<=1)return;const P=[...O];if(!P.length)return;if(O.has(t.id)){const ye=document.createElement("div");ye.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ye.innerHTML=`
        ...
        </div>`,document.body.appendChild(Le),Le.querySelector("#sac-cancel").addEventListener("click",()=>{Le.remove(),ye(!1)}),Le.querySelector("#sac-ok").addEventListener("click",()=>{Le.remove(),ye(!0)}),Le.addEventListener("click",De=>{De.target===Le&&(Le.remove(),ye(!1))})}))return;if(U.length){await v.from("market_listings").delete().in("card_id",U),await v.from("deck_cards").delete().in("card_id",U),await v.from("transfer_history").delete().in("card_id",U),await v.from("decks").update({stadium_card_id:null}).in("stadium_card_id",U);const{error:ye}=await v.from("cards").delete().in("id",U);if(ye){n("Erreur suppression : "+ye.message,"error");return}}const Ee=(t.evolution_bonus||0)+ce,{error:Se}=await v.from("cards").update({evolution_bonus:Ee}).eq("id",t.id);if(Se){n("Erreur évolution : "+Se.message,"error");return}n(`⬆️ ${l.firstname} ${l.surname_real} : note ${E} → ${E+Ee} (+${ce}) !`,"success",4e3),s(),c("collection")});async function H(P){const{data:U}=await v.from("sell_price_configs").select("price_min, price_max").eq("rarity",l.rarity).lte("note_min",E).gte("note_max",E).order("note_max",{ascending:!0}).limit(1).maybeSingle();return U?P<U.price_min||P>U.price_max?{ok:!1,min:U.price_min,max:U.price_max}:{ok:!0}:{ok:!0}}(ee=document.getElementById("market-sell-btn"))==null||ee.addEventListener("click",async()=>{var Ee;const P=[...O];if(!P.length){n("Sélectionne au moins un exemplaire","warning");return}const U=parseInt((Ee=document.getElementById("sell-market-price"))==null?void 0:Ee.value);if(!U||U<1){n("Prix invalide","error");return}const ae=await H(U);if(!ae.ok){n(`Prix hors grille : entre ${ae.min.toLocaleString("fr")} et ${ae.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:ce}=await v.from("cards").update({is_for_sale:!0,sale_price:U}).in("id",P);if(ce){n(ce.message,"error");return}const be=P.map(Se=>({seller_id:r.profile.id,card_id:Se,price:U,status:"active"})),{error:ke}=await v.from("market_listings").insert(be);ke&&console.warn("[Market] insert listings:",ke.message),n(`${P.length} carte${P.length>1?"s":""} mise${P.length>1?"s":""} en vente à ${U.toLocaleString("fr")} cr. chacune !`,"success"),s(),c("collection")}),(ie=document.getElementById("single-sell-btn"))==null||ie.addEventListener("click",async()=>{var be;const P=parseInt((be=document.getElementById("single-sell-price"))==null?void 0:be.value);if(!P||P<1){n("Prix invalide","error");return}const U=await H(P);if(!U.ok){n(`Prix hors grille : entre ${U.min.toLocaleString("fr")} et ${U.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:ae}=await v.from("cards").update({is_for_sale:!0,sale_price:P}).eq("id",t.id);if(ae){n(ae.message,"error");return}const{error:ce}=await v.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:P,status:"active"});ce&&console.warn("[Market] insert listing:",ce.message),n(`Carte mise en vente à ${P.toLocaleString("fr")} cr. !`,"success"),s(),c("collection")}),(X=document.getElementById("single-direct-sell-btn"))==null||X.addEventListener("click",async()=>{const P=w??p;if(!confirm(`Vendre cette carte immédiatement pour ${P.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;await v.from("market_listings").delete().eq("card_id",t.id),await v.from("transfer_history").delete().eq("card_id",t.id);const{error:U}=await v.from("cards").delete().eq("id",t.id);if(U){n(U.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+P}).eq("id",r.profile.id),await d(),n(`+${P.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),c("collection")}),(R=document.getElementById("market-direct-sell-btn"))==null||R.addEventListener("click",async()=>{const P=[...O];if(!P.length){n("Sélectionne au moins un exemplaire","warning");return}const ae=(w??p)*P.length;if(!confirm(`Vendre ${P.length} carte${P.length>1?"s":""} immédiatement pour ${ae.toLocaleString("fr")} crédits au total ? Cette action est irréversible.`))return;await v.from("market_listings").delete().in("card_id",P),await v.from("transfer_history").delete().in("card_id",P);const{error:ce}=await v.from("cards").delete().in("id",P);if(ce){n(ce.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+ae}).eq("id",r.profile.id),await d(),n(`+${ae.toLocaleString("fr")} crédits ! ${P.length} carte${P.length>1?"s":""} vendue${P.length>1?"s":""}.`,"success"),s(),c("collection")}),(J=document.getElementById("cancel-sell-btn"))==null||J.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),s(),c("collection")})}function Ao(t,e=""){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
        ...
        ${(n==null?void 0:n.length)>0?n.map(c=>`
          <div class="card-panel" data-open-deck="${c.id}"
            ...
            <div style="display:flex;align-items:center;gap:10px;flex:1;min-width:0">
              ${s[c.stadium_card_id]?`<img src="${s[c.stadium_card_id]}" style="width:32px;height:32px;object-fit:contain;border-radius:6px;flex-shrink:0;background:rgba(255,255,255,0.06)">`:'<div style="width:32px;height:32px;border-radius:6px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:16px;opacity:.4">🏟️</div>'}
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const c=await Ao("Nom du deck",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!c)return;const{data:d,error:l}=await v.from("decks").insert({owner_id:i.profile.id,name:c}).select().single();if(l){r(l.message,"error");return}r("Deck créé !","success"),zo(d.id,t,e)}),t.querySelectorAll("[data-open-deck]").forEach(c=>{c.addEventListener("click",()=>zo(c.dataset.openDeck,t,e))}),t.querySelectorAll("[data-rename]").forEach(c=>{c.addEventListener("click",async()=>{const d=await Ao("Nouveau nom",c.dataset.name);if(!d||d===c.dataset.name)return;const{error:l}=await v.from("decks").update({name:d}).eq("id",c.dataset.rename);if(l){r(l.message,"error");return}r("Deck renommé !","success"),Ui(t,e)})}),t.querySelectorAll("[data-delete]").forEach(c=>{c.addEventListener("click",async()=>{if(!await kr(`Supprimer le deck "${c.dataset.name}" ? Cette action est irréversible.`,!0))return;await v.from("deck_cards").delete().eq("deck_id",c.dataset.delete);const{error:d}=await v.from("decks").delete().eq("id",c.dataset.delete);if(d){r(d.message,"error");return}r("Deck supprimé.","success"),Ui(t,e)})})}async function zo(t,e,i){const{state:o,toast:r}=i;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("*").eq("id",t).single(),{data:a}=await v.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id).eq("card_type","stadium"),c=(a||[]).filter(p=>p.card_type==="player"&&p.player),d=(a||[]).filter(p=>p.card_type==="formation"),l=(s||[]).filter(p=>p.card_type==="stadium"),u=[...new Set(l.map(p=>p.stadium_id).filter(Boolean))];let x={};if(l.forEach(p=>{p.stadium_def&&p.stadium_id&&(x[p.stadium_id]=p.stadium_def)}),u.length&&Object.keys(x).length<u.length){const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",u);(p||[]).forEach(w=>{x[w.id]=w})}const b=d.map(p=>p.formation).filter(Boolean),{data:g}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",t);let f=n.formation||"4-4-2";b.length>0&&!b.includes(f)&&(f=b[0]);const y={deckId:t,name:n.name,formation:f,formationCardId:n.formation_card_id,stadiumCardId:n.stadium_card_id||null,slots:{},subs:[],playerCards:c,formationCards:d,stadiumCards:l,stadDefMap:x,availableFormations:b};(g||[]).forEach(p=>{p.is_starter?y.slots[p.position]=p.card_id:y.subs.includes(p.card_id)||y.subs.push(p.card_id)}),$t(e,y,i,!0)}function $t(t,e,i,o=!1){var f,y;const{navigate:r}=i;o||Tr(e,i),ki[e.formation];const n=Mo(e.formation),a=n.filter(p=>e.slots[p]).length,s=e.availableFormations.length>0?e.availableFormations:Object.keys(ki),c=(f=e.stadiumCards)==null?void 0:f.find(p=>p.id===e.stadiumCardId),d=c&&((y=e.stadDefMap)==null?void 0:y[c.stadium_id])||null,l=e.subs.map(p=>e.playerCards.find(w=>w.id===p)).filter(Boolean);l.length!==e.subs.length&&(e.subs=l.map(p=>p.id)),[...Object.values(e.slots),...e.subs],t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${l.map(p=>{const w={...p.player,_evolution_bonus:p.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
                ${je({...w,_evolution_bonus:w._evolution_bonus||0},{width:90,showStad:!0,stadDef:d})}
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${l.map(p=>{const w={...p.player,_evolution_bonus:p.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
                  ${je({...w,_evolution_bonus:w._evolution_bonus||0},{width:44,showStad:!0,stadDef:d})}
                  <button data-remove-sub="${p.id}"
  ...
  </div>`;const u=window.innerWidth>=900,x=t.querySelector(".deck-pc-layout"),b=t.querySelector(".deck-mobile-layout");x&&(x.style.display=u?"block":"none"),b&&(b.style.display=u?"none":"block"),t.querySelectorAll("#save-deck").forEach(p=>{p.closest(".page-body").style.display=u?"none":"block"}),$r(t,e,n,i),t.querySelectorAll("#builder-back").forEach(p=>p.addEventListener("click",()=>r("decks")));const g=()=>{const{openModal:p,closeModal:w}=i,E=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
      ${[...new Set(s)].map(m=>{const T=m===e.formation;return`<div data-forma="${m}" style="cursor:pointer;border-radius:10px;${T?"box-shadow:0 0 0 3px #1A6B3C":""}">
          ${si(m,ut[m],{width:90})}
        </div>`}).join("")}
    </div>`;p("⚽ Choisir une formation",E),document.querySelectorAll("#modal-body [data-forma]").forEach(m=>{m.addEventListener("click",()=>{e.formation=m.dataset.forma;const T=Mo(e.formation),$={};T.forEach(I=>{e.slots[I]&&($[I]=e.slots[I])}),e.slots=$,w(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(p=>p.addEventListener("click",g)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(p=>p.addEventListener("click",()=>Er(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(p=>p.addEventListener("click",()=>Ir(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(p=>{p.addEventListener("click",()=>{e.subs=e.subs.filter(w=>w!==p.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(p=>p.addEventListener("click",()=>Sr(e,t,i)))}function $r(t,e,i,o){var h,E,m;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(h=e.stadiumCards)==null?void 0:h.find(T=>T.id===e.stadiumCardId),s=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,c=ut[e.formation]||{},d=Ii(e.formation)||[],l={};for(const T of i){const $=e.slots[T],I=$?e.playerCards.find(D=>D.id===$):null;I!=null&&I.player?l[T]={...I.player,_evolution_bonus:I.evolution_bonus||0,face:I.player.face||null}:l[T]=null}const u=window.innerWidth>=900,x=u?window.innerWidth-280:window.innerWidth-20,b=u?Math.min(x,860):x,g=Math.round(u?b*.82:b*.85),f=u?84:44;let y="";for(const[T,$]of d){const I=c[T],D=c[$];if(!I||!D)continue;const V=I.x*b,Y=Math.round(.03*g+I.y*.85*g),j=D.x*b,L=Math.round(.03*g+D.y*.85*g),_=l[T],G=l[$],O=Ft(_,G);O==="#ff3333"||O==="#cc2222"?y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,y+=`<line x1="${V.toFixed(1)}" y1="${Y.toFixed(1)}" x2="${j.toFixed(1)}" y2="${L.toFixed(1)}" stroke="${O}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let p="";const w=Math.round(f*657/507);for(const T of i){const $=c[T];if(!$)continue;const I=l[T],D=$.x*b;$.y*g;const V=Math.round(.03*g+$.y*(.85*g)),Y=Math.round(D-f/2),j=Math.round(V-w/2);if(I){const L=T.replace(/\d+/,""),_=s&&(s.club_id&&String(I.club_id)===String(s.club_id)||s.country_code&&I.country_code===s.country_code),G=je({...I,_evolution_bonus:I._evolution_bonus||0},{width:f,showStad:!0,stadDef:s,role:L});_&&((m=s.club)!=null&&m.logo_url||s.image_url),p+=`<div style="position:absolute;left:${Y}px;top:${j}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${T}">
        <div style="position:relative">${G}</div>
      </div>`}else{const L=T.replace(/\d+/,"");p+=`<div style="position:absolute;left:${Y}px;top:${j}px;width:${f}px;height:${w}px;
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${p}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(T=>{T.addEventListener("click",()=>Lr(T.dataset.pos,e,t,o))})}function Er(t,e,i){var s;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(c=>{const d=c.stadium_id||c.id;return n.has(d)?!1:(n.add(d),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(p=document.getElementById("close-selector"))==null||p.addEventListener("click",n),(w=document.getElementById("remove-player"))==null||w.addEventListener("click",()=>{delete e.slots[t],n(),$t(i,e,o)}),document.querySelectorAll(".player-option").forEach(h=>{h.addEventListener("click",()=>{e.slots[t]=h.dataset.cardId,n(),$t(i,e,o)})})}function Sr(t,e,i){var l,u,x;const{openModal:o,closeModal:r}=i,n=(l=t.stadiumCards)==null?void 0:l.find(b=>b.id===t.stadiumCardId),a=n&&((u=t.stadDefMap)==null?void 0:u[n.stadium_id])||null,s=new Set;Object.keys(t.slots).forEach(b=>{var y;const g=t.slots[b];if(!g)return;const f=t.playerCards.find(p=>p.id===g);(y=f==null?void 0:f.player)!=null&&y.id&&s.add(f.player.id)}),t.subs.forEach(b=>{var f;const g=t.playerCards.find(y=>y.id===b);(f=g==null?void 0:g.player)!=null&&f.id&&s.add(g.player.id)});const c=new Set,d=t.playerCards.filter(b=>{var g,f,y;return s.has((g=b.player)==null?void 0:g.id)||c.has((f=b.player)==null?void 0:f.id)?!1:(c.add((y=b.player)==null?void 0:y.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`}const c=l=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(l)};function d(){var u,x,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const l=a.length>0;t.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${n.map(g=>{const f=a.find(y=>y.gc_type===g.gc_type);return s(g,!!f)}).join("")}
      </div>
    ...
    </div>`,t.querySelectorAll(".gc-select-card").forEach(g=>{g.addEventListener("click",()=>{const f=g.dataset.id,y=n.find(w=>w.id===f);if(!y)return;const p=a.findIndex(w=>w.gc_type===y.gc_type);p>-1?a.splice(p,1):a.length<3&&a.push(y),d()})}),(u=t.querySelector("#gc-launch"))==null||u.addEventListener("click",()=>{l&&c(a)}),(x=t.querySelector("#gc-no-gc"))==null||x.addEventListener("click",()=>c([])),(b=t.querySelector("#gc-reset"))==null||b.addEventListener("click",()=>{a.length&&(a=[],d())})}d()}function zr(t,e){var r;const i=((r=e==null?void 0:e.state)==null?void 0:r.params)||{},o=t||i.matchMode||"vs_ai_easy";return o==="friend"?`Match vs ${i.friendName||"Ami"}`:o==="random"?"Match vs Random":o==="ranked"?"Match Classé":o==="mini_league"||o==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${o.replace("vs_ai_","").toUpperCase()}`}async function Mr(t,e,i){const{state:o,navigate:r}=e;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Ct(t,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=n.map(x=>x.id),{data:s}=await v.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),c=[...new Set((s||[]).filter(x=>{var b,g;return((b=x.card)==null?void 0:b.card_type)==="stadium"&&((g=x.card)==null?void 0:g.stadium_id)}).map(x=>x.card.stadium_id))],d={};if(c.length){const{data:x}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(x||[]).forEach(b=>{d[b.id]=b}),(s||[]).forEach(b=>{var g,f;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((f=b.card)!=null&&f.stadium_id)&&(b.card._stadiumDef=d[b.card.stadium_id]||null)})}let l=0;function u(){var m,T,$,I,D,V,Y;const x=n[l],b=(s||[]).filter(j=>j.deck_id===x.id),g=b.filter(j=>{var L;return j.is_starter&&((L=j.card)==null?void 0:L.player)}).map(j=>Vi(j.card,j.position)),f=b.find(j=>{var L;return((L=j.card)==null?void 0:L.card_type)==="formation"}),y=x.formation||((m=f==null?void 0:f.card)==null?void 0:m.formation)||"4-4-2";let p=g.length>=11?Ei(g,y):null,w=((T=x.stadium_card)==null?void 0:T.stadium_def)||null;w&&p&&(p=ui(p,w));const h=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function j(){const L=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!L||!_||!p)return;const G=_.clientWidth>=900,O=Math.max(200,_.clientHeight-(G?60:40)),pe=Math.max(200,_.clientWidth-16),M=G?Math.min(117,Math.max(52,Math.round(pe*.22))):Math.max(44,Math.round(pe*.168));if(O<220||pe<220){requestAnimationFrame(j);return}const H=G?null:Math.round(M*.55);L.innerHTML=Kt(p,y,null,[],pe,O,[],H),L.style.cssText=`width:${pe}px;height:${O}px;overflow:hidden;margin:${G?0:60}px auto 0`;const fe=L.querySelector("svg");fe&&(fe.style.cssText="display:block;width:100%;height:100%",fe.setAttribute("preserveAspectRatio",G?"xMidYMid meet":"none"))})),(I=document.getElementById("prev-deck"))==null||I.addEventListener("click",()=>{l>0&&(l--,u())}),(D=document.getElementById("next-deck"))==null||D.addEventListener("click",()=>{l<n.length-1&&(l++,u())}),(V=document.getElementById("validate-deck"))==null||V.addEventListener("click",()=>{if(!h)return;const j=e.state.params||{};e.navigate("match",{...j,matchMode:j.matchMode||i,deckId:x.id})}),(Y=document.getElementById("cancel-deck-select"))==null||Y.addEventListener("click",()=>{Ye(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let j=0,L=0;E.addEventListener("touchstart",_=>{j=_.touches[0].clientX,L=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const G=_.changedTouches[0].clientX-j,O=_.changedTouches[0].clientY-L;Math.abs(G)<40||Math.abs(G)<Math.abs(O)||(G<0&&l<n.length-1?(l++,u()):G>0&&l>0&&(l--,u()))},{passive:!0})}}u()}function kt(t,e=44,i=58,o=null){return je(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,c)=>{const d=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(d==="ATT"||d==="MIL")||o==="defense"&&(d==="GK"||d==="DEF"||d==="MIL")?l+=10:o||(l+=10)),a+=je({...s,_evolution_bonus:0,evolution_bonus:0},{width:40,role:d,extraNote:l}),c<n.length-1){const u=n[c+1],x=an(s,u,r)?Ft(s,u):null;a+=`<div style="width:7px;height:3px;background:${!x||x==="#ff3333"||x==="#cc2222"?"rgba(255,255,255,0.12)":x};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Mi(t,e,i,o,r=310,n=310,a=[],s=null){const c=ut[e]||{},d=Ii(e)||Ai[e]||[],l={},u=["ATT","MIL","DEF","GK"];for(const p of u)(t[p]||[]).forEach((h,E)=>{l[`${p}${E+1}`]=h});function x(p){const w=c[p];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[p,w]of d){const h=x(p),E=x(w);if(!h||!E)continue;const m=l[p],T=l[w],$=Ft(m,T);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),f=Math.round(g*657/507);for(const[p,w]of Object.entries(l)){const h=x(p);if(!h||!w)continue;const E=p.replace(/[0-9]/g,""),m=a.includes(w.cardId),T=i==="attack"&&(["MIL","ATT"].includes(E)||m)&&!w.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!w.used,$=o.includes(w.cardId);let I=w.boost||0,D=!1;w.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(I+=10,D=!0):i||(I+=10,D=!0));const V=Math.round(h.x-g/2),Y=Math.round(h.y-f/2);if(w.used){b+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${V}" y="${Y}" width="${g}" height="${f}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const j=je({...w,_evolution_bonus:0,stadiumBonus:!1},{width:g,showStad:!1,stadDef:null,role:E,extraNote:I,_cardOffset:30,_forceStadColor:D}),L=$?`position:absolute;top:30px;left:0;width:${g}px;height:${f}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";b+=`<foreignObject x="${V-2}" y="${Y-30}" width="${g+8}" height="${f+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${j}
        ${$?`<div style="${L}"></div>`:""}
      </div>
    </foreignObject>`,T&&(b+=`<rect x="${V}" y="${Y}" width="${g}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${w.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const y=s!==null?s:Math.round(Math.max(g*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-y} ${-y} ${r+y*2} ${n+y*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${b}
  </svg>`}function Kt(t,e,i,o,r=300,n=300,a=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Mi(t,e,i,o,r,n,a,s)}
  </div>`}async function Ci(t,e,i,o){var T;const{state:r,navigate:n,toast:a}=e;ct(t);const s=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return Mr(t,e,i);const c=s.deckId;let d,l,u,x;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);d=$[0].data,u=$[0].error,l=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Ct(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(u||x){console.error("[Match] Erreur Supabase:",u||x),Ct(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(l||[]).filter($=>{var I;return $.is_starter&&((I=$.card)==null?void 0:I.player)}).map($=>Vi($.card,$.position)),g=(l||[]).filter($=>{var I;return!$.is_starter&&((I=$.card)==null?void 0:I.player)}).map($=>Vi($.card,$.position));if(b.length<11){Ct(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const f=(l||[]).find($=>{var I;return((I=$.card)==null?void 0:I.card_type)==="formation"}),y=(d==null?void 0:d.formation)||((T=f==null?void 0:f.card)==null?void 0:T.formation)||"4-4-2",{data:p,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(p||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(I=>I.name===$.gc_type||I.id===$.gc_definition_id))||null}));let m=null;if(d!=null&&d.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",d.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:I}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();m=I||null}}o({deckId:c,formation:y,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function jt(){return Math.min(window.innerWidth-40,860)}function Ht(){return Math.round(jt()*1.1)}function pn(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Bt(t)}}function Cr(t,e,i,o="Adversaire"){Yo("/sounds/match-opening.mp3",.3);const r=jt(),n=Ht();return`
    ...
    </div>`}function un(t){var n,a,s;if(!t)return"";const e=c=>c?je({...c,_evolution_bonus:0},{width:52,role:c._line||c.job,showStad:!!c.stadiumBonus,extraNote:c.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.85);pointer-events:none`;const s=(t||[]).slice(0,3).map(c=>je({...c,_evolution_bonus:0},{width:Math.min(140,Math.round(window.innerWidth/4)),role:c._line||c.job,showStad:!!c.stadiumBonus})).join("");if(a.innerHTML=`
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(c)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function jr(t,e,i){const o=document.getElementById("sub-anim-overlay");o&&o.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.8);pointer-events:none`;const n=Math.min(120,Math.round(window.innerWidth/4)),a=t?je({...t,_evolution_bonus:0},{width:n,role:t._line||t.job}):"",s=e?je({...e,_evolution_bonus:0},{width:n,role:e._line||e.job}):"";r.innerHTML=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const s=a<t.length-1?Ft(n,t[a+1]):null,c=!s||s==="#ff3333"||s==="#cc2222",d=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return fn(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function qr(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",s=o.soloLevel||1,c=r.replace("vs_ai_",""),d=r;let l=null;if(n){const{data:g}=await v.from("solo_levels").select("*").eq("level_number",s).maybeSingle();l=g||{level_number:s,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const u=o.rankedData||null,x=o.presetSetup||null;async function b({deckId:g,formation:f,starters:y,subsRaw:p,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let m=Ei(y,f);E&&(m=ui(m,E),$i(p,E));let T=null;if(a){const V=Dr(m),{jaune:Y,vert:j}=Fr(m,f),L=.9+Math.random()*.2;T={target_note_avg:Math.max(1,Math.round(V*L/16)),nb_liens_jaune:Y,nb_liens_vert:j,nb_joueurs_stade:E?3:0}}const $=n?await jo(f,l):a?await jo(f,T):await Br(f,c),I=$.lines||$,D=async V=>{try{const Y=d==="vs_ai_club"||d==="solo"||d==="ranked_ai"?"club":d,{data:j,error:L}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:Y,home_deck_id:g,status:"in_progress"}).select().single();if(L){console.error("[MatchIA] Erreur création match:",L),Ct(t,"⚠️","Impossible de créer le match ("+L.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&I&&(ui(I,_),$i($.subs||[],_));const G={gcDefs:h||[],matchId:j==null?void 0:j.id,mode:d,difficulty:c,formation:f,isSolo:n,soloLevel:s,soloLevelConfig:l,isRankedAI:a,rankedAIData:u,homeTeam:m,aiTeam:I,homeSubs:p,subsUsed:0,maxSubs:Math.min(p.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:V,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Pr(t,G,e)}catch(Y){console.error("[MatchIA] Exception launchMatch:",Y),Ct(t,"⚠️","Erreur au lancement du match : "+Y.message,"Retour",()=>e.navigate("home"))}};if(a&&x){D(x.gcCardsEnriched||[]);return}if(!w.length){D([]);return}zi(t,w,D)}catch(m){console.error("[MatchIA] Exception setup:",m),Ct(t,"⚠️","Erreur de préparation du match : "+m.message,"Retour",()=>e.navigate("home"))}}x?await b(x):await Ci(t,e,r,b)}async function Br(t,e){var y;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:mn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(p,w,h){var E,m;return n.add(p.id),{cardId:"ai-"+p.id+"-"+h,id:p.id,firstname:p.firstname,name:p.surname_real,country_code:p.country_code,club_id:p.club_id,job:p.job,job2:p.job2,note_g:Number(p.note_g)||0,note_d:Number(p.note_d)||0,note_m:Number(p.note_m)||0,note_a:Number(p.note_a)||0,rarity:p.rarity,skin:p.skin,hair:p.hair,hair_length:p.hair_length,face:p.face,clubName:((E=p.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=p.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:w}}for(const p of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===p&&!n.has($.id)),h=i.filter($=>$.job!==p&&!n.has($.id)),E=[...w,...h],m=[];for(let $=0;$<o[p];$++){const I=E[$];I&&m.push(a(I,p,$))}const T=lt(m.length);m.forEach(($,I)=>{$._col=T[I]}),r[p]=m}const c=i.filter(p=>!n.has(p.id)).slice(0,5).map((p,w)=>a(p,p.job,100+w)),{data:d}=await v.from("gc_definitions").select("*").eq("is_active",!0),u=[...d||[]].sort(()=>Math.random()-.5).slice(0,3).map((p,w)=>({id:"ai-gc-"+w,gc_type:p.name,name:p.name,icon:"⚡",effect_type:p.effect_type,effect_params:p.effect_params||{}})),x=Object.values(r).flat(),b={};x.forEach(p=>{p.club_id&&(b[p.club_id]=(b[p.club_id]||0)+1)});const g=(y=Object.entries(b).sort((p,w)=>w[1]-p[1])[0])==null?void 0:y[0];let f=null;if(g){const{data:p}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();p&&(f={club_id:p.id,country_code:null,name:p.encoded_name+" Stadium",club:{encoded_name:p.encoded_name,logo_url:p.logo_url}})}return{lines:r,subs:c,gcCards:u,stadiumDef:f}}function Dr(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Fr(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((s,c)=>{i[`${a}${c+1}`]=s});const o=Ii(e)||Ai[e]||[];let r=0,n=0;for(const[a,s]of o){const c=i[a],d=i[s];if(!c||!d)continue;const l=Ft(c,d);l==="#00ff88"?n++:l==="#FFD700"&&r++}return{jaune:r,vert:n}}function Co(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function bi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(Co(r)-e)-Math.abs(Co(n)-e));return o.slice(0,Math.min(i,o.length))}async function jo(t,e){var j,L;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:mn(t),subs:[],gcCards:[],stadiumDef:null};const s={};a.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const c=((j=Object.entries(s).sort((_,G)=>G[1]-_[1])[0])==null?void 0:j[0])||null,d=c?a.filter(_=>_.club_id===c):[],l=((L=d[0])==null?void 0:L.country_code)||null,u=l?a.filter(_=>_.country_code===l&&_.club_id!==c):[],x=Math.min(d.length,Math.max(2,r+1),16),b=Math.min(u.length,Math.max(0,o),16-x),g=[],f=new Set;bi(d,i,x).forEach(_=>{g.push(_),f.add(_.id)}),bi(u,i,b).forEach(_=>{g.push(_),f.add(_.id)});const y=Math.max(0,16-g.length),p=a.filter(_=>!f.has(_.id));bi(p,i,y).forEach(_=>{g.push(_),f.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function m(_,G,O){var le,pe;return E.add(_.id),{cardId:"ai-"+_.id+"-"+O,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((le=_.clubs)==null?void 0:le.encoded_name)||null,clubLogo:((pe=_.clubs)==null?void 0:pe.logo_url)||null,boost:0,used:!1,_line:G}}for(const _ of["GK","DEF","MIL","ATT"]){const G=g.filter(H=>H.job===_&&!E.has(H.id)),O=g.filter(H=>H.job!==_&&!E.has(H.id)),le=[...G,...O],pe=[];for(let H=0;H<w[_];H++){const fe=le[H];fe&&pe.push(m(fe,_,H))}const M=lt(pe.length);pe.forEach((H,fe)=>{H._col=M[fe]}),h[_]=pe}let T=g.filter(_=>!E.has(_.id));if(T.length<5){const _=a.filter(G=>!E.has(G.id)&&!T.some(O=>O.id===G.id));T=T.concat(bi(_,i,5-T.length))}const $=T.slice(0,5).map((_,G)=>m(_,_.job,100+G)),{data:I}=await v.from("gc_definitions").select("*").eq("is_active",!0),V=[...I||[]].sort(()=>Math.random()-.5).slice(0,3).map((_,G)=>({id:"ai-gc-"+G,gc_type:_.name,name:_.name,icon:"⚡",effect_type:_.effect_type,effect_params:_.effect_params||{}}));let Y=null;if(n>0&&c){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(Y={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:V,stadiumDef:Y}}function mn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<e[n];c++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const s=lt(a.length);a.forEach((c,d)=>{c._col=s[d]}),i[n]=a}return i}function Pr(t,e,i){var r;Yo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`,requestAnimationFrame(()=>requestAnimationFrame(()=>{const n=t.querySelector(".opponent-preview-wrap"),a=t.querySelector("#opponent-swipe-zone");if(!n||!a)return;const s=a.clientWidth>=900,c=Math.max(200,a.clientHeight-(s?8:40)),d=Math.max(200,a.clientWidth-(s?8:16)),l=s?null:Math.round(Math.max(44,Math.round(d*.168))*.55);n.innerHTML=Kt(e.aiTeam,e.formation,null,[],d,c,[],l),n.style.cssText=`width:${d}px;height:${c}px;overflow:hidden;flex-shrink:0`;const u=n.querySelector("svg");u&&(u.style.cssText="display:block;width:100%;height:100%",u.setAttribute("preserveAspectRatio",s?"xMidYMid meet":"none"))})),setTimeout(()=>Rr(t,e,i),5e3)}const We=t=>pn(t);function Rr(t,e,i){const o=e.homeTeam.MIL||[],r=e.aiTeam.MIL||[],n=e.stadiumDef||null,a=e.aiStadiumDef||null,s=vt(o,n)+wt(o),c=vt(r,a)+wt(r),d=s>=c;t.innerHTML=`
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:clamp(6px,1.5vh,20px);padding:clamp(8px,1.5vw,24px);background:#0a3d1e">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,E.style.transition="opacity .45s ease",E.style.opacity="1",E.style.pointerEvents="auto",(m=document.getElementById("start-match-btn"))==null||m.addEventListener("click",b))},600)},700)},2800)}function Ie(t,e,i){var V,Y,j,L,_,G,O,le,pe;const o=e.selected.map(M=>M.cardId),r=e.usedSubIds||[],n=e.homeSubs.filter(M=>!r.includes(M.cardId)),s=Object.values(e.homeTeam).flat().filter(M=>M.used).length>0&&n.length>0&&e.subsUsed<e.maxSubs,c=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(M=>!M.used),d=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(M=>!M.used),l=Vt(e.aiTeam),u=c.length===0&&d.length===0&&!l,x=(e.homeTeam.DEF||[]).filter(M=>!M.used),b=(e.homeTeam.GK||[]).filter(M=>!M.used);let g=[];e.phase==="attack"&&c.length===0&&(l?(g=x.map(M=>M.cardId),x.length===0&&(g=g.concat(b.map(M=>M.cardId)))):u&&(g=[...x,...b].map(M=>M.cardId))),e.log[e.log.length-1];const f=e.phase==="ai-attack"||e.phase==="ai-defense",y=e.phase==="attack",p=e.phase==="defense",w=e.phase==="finished",E=(e.homeSubs||[]).filter(M=>!(e.usedSubIds||[]).includes(M.cardId)).length>0&&e.subsUsed<e.maxSubs,m=y&&c.length===0&&g.length===0&&!E,T=e.gcCards.filter(M=>!e.usedGc.includes(M.id)),$=e.boostCard&&!e.boostUsed;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column",t.innerHTML=`
  <style>
  ...
  <div id="match-history-panel">
    ...
    </div>`,(m=u.querySelector("#sub-close"))==null||m.addEventListener("click",()=>u.remove()),(T=u.querySelector("#out-up"))==null||T.addEventListener("click",()=>{s>0&&(s--,x())}),($=u.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<n.length-1&&(s++,x())}),(I=u.querySelector("#in-up"))==null||I.addEventListener("click",()=>{d>0&&(d--,x())}),(D=u.querySelector("#in-down"))==null||D.addEventListener("click",()=>{d<a.length-1&&(d++,x())});const E=(Y,j,L,_)=>{const G=u.querySelector("#"+Y);if(!G)return;let O=0;G.addEventListener("touchstart",le=>{O=le.touches[0].clientY},{passive:!0}),G.addEventListener("touchend",le=>{const pe=le.changedTouches[0].clientY-O;if(Math.abs(pe)<30)return;const M=j();pe<0&&M<_-1?(L(M+1),x()):pe>0&&M>0&&(L(M-1),x())},{passive:!0})};E("in-panel",()=>d,Y=>d=Y,a.length),E("out-panel",()=>s,Y=>s=Y,n.length),(V=u.querySelector("#sub-confirm"))==null||V.addEventListener("click",Y=>{if(Y.preventDefault(),Y.stopPropagation(),l)return;l=!0;const j=n[s],L=a[d];if(!j||!L)return;let _=null,G=-1;for(const[le,pe]of Object.entries(e.homeTeam)){const M=(pe||[]).findIndex(H=>H.cardId===j.cardId);if(M!==-1){_=le,G=M;break}}if(G===-1||!_){Tt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const O={...L,_line:_,_col:j._col||0,used:!1,boost:0};e.homeTeam[_].splice(G,1,O),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(L.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:j.name,firstname:j.firstname,note:Re(j,_),portrait:Bt(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},inPlayer:{name:L.name,firstname:L.firstname,note:Re(L,_),portrait:Bt(L),job:L.job,country_code:L.country_code,rarity:L.rarity,clubName:L.clubName,clubLogo:L.clubLogo},text:`🔄 ${L.firstname} ${L.name} remplace ${j.firstname} ${j.name}`}),u.remove(),jr(j,L,()=>Ie(t,e,i))})}document.body.appendChild(u),x()}function Yr(t,e,i,o,r){var x,b;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Oe[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||a.desc,d=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=a.icon||"⚡",u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",u.innerHTML=`
    ${nt(s,d,l,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(u),(x=u.querySelector("#gc-back"))==null||x.addEventListener("click",()=>u.remove()),(b=u.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{u.remove(),Xr(t,e,i,o,r)})}function yi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function c(){var d,l;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(u=>{const x=u._line||u.job||"MIL",b=s.find(f=>f.cardId===u.cardId),g=je({...u,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:u.boost||0});return`<div class="gc-pick-item" data-cid="${u.cardId}"
    ...
    </div>`,(d=a.querySelector("#gc-picker-close"))==null||d.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(u=>{u.addEventListener("click",()=>{const x=u.dataset.cid,b=t.find(f=>f.cardId===x);if(!b)return;const g=s.findIndex(f=>f.cardId===x);g>-1?s.splice(g,1):s.length<e&&s.push(b),c()})}),(l=a.querySelector("#gc-picker-confirm"))==null||l.addEventListener("click",()=>{a.remove(),n(s)})}c(),document.body.appendChild(a)}const Wr={BOOST_STAT:({value:t=1,count:e=1,roles:i=[]},o,r,n)=>{const a=Object.entries(o.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,c])=>c.filter(d=>!d.used).map(d=>({...d,_line:s})));return a.length?(yi(a,e,`Choisir ${e} joueur(s) à booster (+${t})`,r,o,s=>{s.forEach(c=>{const d=(o.homeTeam[c._line]||[]).find(l=>l.cardId===c.cardId);d&&(d.boost=(d.boost||0)+t,o.log.push({text:`⚡ +${t} sur ${d.name}`,type:"info"}))}),Ie(r,o,n)}),!0):(o.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Ie(r,o,n),!0)},DEBUFF_STAT:({value:t=1,count:e=1,roles:i=[],target:o="ai"},r,n,a)=>{const s=o==="home"?r.homeTeam:r.aiTeam,c=o==="ai"?"adverse":"allié",d=Object.entries(s).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,u])=>u.filter(x=>!x.used).map(x=>({...x,_line:l})));return d.length?(yi(d,e,`Choisir ${e} joueur(s) ${c}(s) à débuffer (-${t})`,n,r,l=>{l.forEach(u=>{const b=((o==="home"?r.homeTeam:r.aiTeam)[u._line]||[]).find(g=>g.cardId===u.cardId);b&&(b.boost=(b.boost||0)-t,r.log.push({text:`🎯 -${t} sur ${b.name}${o==="ai"?" (IA)":""}`,type:"info"}))}),Ie(n,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${c} disponible`,type:"info"}),Ie(n,r,a),!0)},GRAY_PLAYER:({count:t=1,roles:e=[],target:i="ai"},o,r,n)=>{const a=i==="home"?o.homeTeam:o.aiTeam,s=i==="ai"?"adverse":"allié",c=Object.entries(a).filter(([d])=>!e.length||e.includes(d)).flatMap(([d,l])=>l.filter(u=>!u.used).map(u=>({...u,_line:d})));return c.length?(yi(c,t,`Choisir ${t} joueur(s) ${s}(s) à exclure`,r,o,d=>{d.forEach(l=>{const x=((i==="home"?o.homeTeam:o.aiTeam)[l._line]||[]).find(b=>b.cardId===l.cardId);x&&(x.used=!0,o.log.push({text:`❌ ${x.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Ie(r,o,n)}),!0):(o.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),Ie(r,o,n),!0)},REVIVE_PLAYER:({count:t=1,roles:e=[]},i,o,r)=>{const n=Object.entries(i.homeTeam).filter(([a])=>!e.length||e.includes(a)).flatMap(([a,s])=>s.filter(c=>c.used).map(c=>({...c,_line:a})));return n.length?(yi(n,t,`Choisir ${t} joueur(s) à ressusciter`,o,i,a=>{a.forEach(s=>{const c=(i.homeTeam[s._line]||[]).find(d=>d.cardId===s.cardId);c&&(c.used=!1,i.log.push({text:`💫 ${c.name} ressuscité !`,type:"info"}))}),Ie(o,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Ie(o,i,r),!0)},REMOVE_GOAL:({},t)=>(t.aiScore>0?(t.aiScore--,t.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):t.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},t)=>(t.homeScore===t.aiScore?(t.homeScore++,t.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):t.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:t=1},e)=>(e.maxSubs=(e.maxSubs||3)+t,e.log.push({text:`🔄 +${t} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Xr(t,e,i,o,r){o.usedGc.push(t);const n=o.gcDefs||[],a=n.find(c=>c.name===e)||n.find(c=>{var d;return((d=c.name)==null?void 0:d.toLowerCase().trim())===(e==null?void 0:e.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const c=Wr[a.effect_type];c?c(a.effect_params||{},o,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const c=Object.entries(o.homeTeam).flatMap(([d,l])=>(l||[]).filter(u=>u.used).map(u=>({...u,_line:d})));c.length?(c[0].used=!1,o.log.push({text:`💫 ${c[0].name} ressuscité !`,type:"info"})):o.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const c=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(d=>!d.used);if(c.length){const d=c.sort((l,u)=>Re(u,"ATT")-Re(l,"ATT"))[0];d.used=!0,o.log.push({text:`❄️ ${d.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",t).then(()=>{}),s&&Ie(i,o,r)}function Jr(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Ie(t,e,i)})})}async function _t(t,e,i){var x,b,g,f;Ot(),Ve(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",s=e.isSolo&&((x=e.soloLevelConfig)!=null&&x.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):mr(e.mode,a);if(e.isSolo&&r)try{const{data:y}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),p=(y==null?void 0:y.unlocked_level)||1;e.soloLevel>=p&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(y){console.warn("[Solo] Erreur mise à jour progression:",y.message)}const c="00000000-0000-0000-0000-000000000000";let d=null;if(e.isRankedAI)try{const{data:y}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(y){const p=y.mmr??1e3,w=y.mmr_deviation??350,h=y.mmr_volatility??.06,E=r?1:n?.5:0,m=(y.placement_matches??0)<10,T=Uo(p,w,h,p,350,E,m),$=n?null:r?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:T.delta,p_away_delta:0,p_home_new_rd:T.newRd,p_away_new_rd:350,p_home_new_vol:T.newSigma,p_away_new_vol:.06}),d=T.delta}}catch(y){console.warn("[RankedAI] Erreur mise à jour MMR:",y.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const l={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};r?l.wins=(o.profile.wins||0)+1:n?l.draws=(o.profile.draws||0)+1:l.losses=(o.profile.losses||0)+1,await v.from("users").update(l).eq("id",o.profile.id),await i.refreshProfile();const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",u.innerHTML=`
    ...
    </div>`,(A=document.getElementById("pvp-home"))==null||A.addEventListener("click",()=>{try{v.removeChannel(j)}catch{}Ye(t),l?b("mini-league",{openLeagueId:l}):b("home")})}H()}async function Xi(t,e,i=!1){var s,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:c.rankedData)||null;await Ci(t,e,i?"ranked":"random",async({deckId:d,formation:l,starters:u,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:f})=>{ct(t);const y=async p=>{await na(t,e,d,l,u,x,p||[],g,f,i,a)};if(!(b!=null&&b.length)){await y([]);return}zi(t,b,y)})}async function oa(t,e,i){return ia(t,e,i)}async function na(t,e,i,o,r,n,a=[],s=[],c=null,d=!1,l=null){var Y,j;const{state:u,navigate:x,toast:b}=e,g=(l==null?void 0:l.mmr)??((Y=u.profile)==null?void 0:Y.mmr)??1e3,f=d?At(g):null,y=d?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",p=d?(f==null?void 0:f.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:${y};color:#fff;padding:32px;text-align:center;gap:20px">
      ...
      ${d?`<div style="font-size:13px;color:${(f==null?void 0:f.color)||"#D4A017"}">${(f==null?void 0:f.name)||""} · ${Math.round(g)} MMR</div>`:""}
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(L){console.error("[Matchmaking] cancel error:",L)}};(j=document.getElementById("cancel-mm"))==null||j.addEventListener("click",async()=>{await m(),Ye(t),x("home")});const T=async(L,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Dt(t,e,L,_,{myGC:a,gcDefs:s,stadiumDef:c,isRanked:d,rankedData:l,onMatchEnd:d?ra:null}))},$=u.user.id,{data:I,error:D}=d?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(D||!(I!=null&&I.success)){console.error("[Matchmaking] try_matchmake error:",D||I),b("Erreur de matchmaking","error"),Ye(t),x("home");return}if(I.matched){await T(I.match_id,!1);return}const V=async()=>{if(w)return;const{data:L}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(L==null?void 0:L.status)==="matched"&&L.match_id&&await T(L.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},L=>{const _=L.new;_.status==="matched"&&_.match_id&&T(_.match_id,!0)}).subscribe(),E=setInterval(V,3e3),d?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:u.profile.id})}catch(L){console.error("[Matchmaking] cancel error:",L)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),x("match",{matchMode:"ranked_ai",rankedData:l,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:s,stadiumDef:c}})}},2e4):setTimeout(()=>{w||m()},12e4)}async function ra(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:s,awayScore:c,matchId:d}=t,l=i.user.id,u=n===l,x=r===l,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",u?a:n).single();if(b&&g){const f=Uo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,x?1:0);await v.from("users").update({mmr:f.mmr,mmr_rd:f.rd,mmr_v:f.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(x?`+MMR ↑ ${Math.round(f.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-f.mmr)}`,x?"success":"error",4e3)}}const aa=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Xi,resumePvpMatch:oa},Symbol.toStringTag,{value:"Module"}));async function sa(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,s=n.friendName||"Ami",c=!!n.isAccepting;await Ci(t,e,"friend",async({deckId:d,formation:l,starters:u,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:f})=>{ct(t);const y=async p=>{const w=p||[];c?await la(t,e,d,w,g,f):await da(t,e,d,w,g,f,a,s)};if(!(b!=null&&b.length)){await y([]);return}zi(t,b,y)})}async function da(t,e,i,o,r,n,a,s){var w;const{state:c,navigate:d,toast:l}=e,u=c.user.id,{data:x,error:b}=await v.from("friend_match_invites").insert({inviter_id:u,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!x){console.error("[Friend] Erreur création invitation:",b),l("Impossible de créer l'invitation","error"),d("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var g,f,y,p;const{toast:o}=e,r=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,s=((g=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:g.value)||"public",c=((f=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:f.value)||"aller",d=((p=(y=document.getElementById("ml-pwd"))==null?void 0:y.value)==null?void 0:p.trim())||null;if(!r){o("Le nom est obligatoire","error");return}if(a<100){o("Mise minimum : 100 crédits","error");return}if(s==="private"&&!d){o("Mot de passe requis","error");return}const{data:l,error:u}=await v.from("mini_leagues").insert({name:r,creator_id:e.state.profile.id,type:s,password:d,mode:c,max_players:n,entry_fee:a}).select().single();if(u){o("Erreur : "+u.message,"error");return}const{data:x}=await v.from("users").select("credits").eq("id",e.state.profile.id).single();if(((x==null?void 0:x.credits)||0)<a){await v.from("mini_leagues").delete().eq("id",l.id),o(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:x.credits-a}).eq("id",e.state.profile.id),await v.from("mini_leagues").update({pot:a}).eq("id",l.id),await v.from("mini_league_members").insert({league_id:l.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=x.credits-a);const b=document.getElementById("nav-credits");b&&(b.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,l.id)})}function xa(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function hn(t,e,i,o){var u;const{toast:r,state:n}=e,a=n.profile.id;let s=null;if(o==="private"&&(s=await xa(),s===null))return;const{data:c,error:d}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(d||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",d||c),r((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",a).single();n.profile&&x&&(n.profile.credits=x.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((u=n.profile)==null?void 0:u.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function ba(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(x=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${x.map((L,_)=>{const G=g>0&&a.status==="finished"?_===0?Math.floor(g*.7):_===1?Math.floor(g*.2):_===2?Math.floor(g*.1):0:0;return`<tr style="border-bottom:1px solid ${zt};${L.userId===n?"background:rgba(74,222,128,0.08);":""}">
      ...
      <div style="background:${ii};border:1px solid ${oi};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(L,_)=>_+1).reverse().map(L=>{const _=(c||[]).filter(G=>G.matchday===L);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${L}</div>${_.map(G=>Do(G,u,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    </div>`;let l=!1;const u=async y=>{if(!l){if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}y&&await Dt(t,e,y,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:s}),c()}};(f=document.getElementById("wait-back"))==null||f.addEventListener("click",()=>{if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}d("mini-league",{openLeagueId:o}),c()});const x=async()=>{if(l)return;const{data:y}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();y!=null&&y.match_id&&u(y.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},y=>{var p;(p=y.new)!=null&&p.match_id&&u(y.new.match_id)}).subscribe(),g=setInterval(x,3e3);x()})}const Ea="/",La=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Sa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,u,x;const s=e[o],c=o===e.length-1,d=Math.round((o+1)/e.length*100);r.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${s.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${Ea}icons/${s.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
    ...
    `,r.querySelectorAll("ul,ol").forEach(b=>{b.style.paddingLeft="20px",b.style.marginTop="6px",b.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(b=>{b.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(b=>{b.style.marginBottom="8px"}),(l=r.querySelector("#tuto-prev"))==null||l.addEventListener("click",()=>{o--,n()}),(u=r.querySelector("#tuto-next"))==null||u.addEventListener("click",()=>{c?a():(o++,n())}),(x=r.querySelector("#tuto-skip"))==null||x.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),t!=null&&t.id&&await v.from("users").update({tutorial_done:!0}).eq("id",t.id),i==null||i()};document.body.appendChild(r),n()}async function Po(t,e,i){if(!t||t.tutorial_done)return;let o=[];const{data:r,error:n}=await v.rpc("get_tutorial_steps");if(!n&&(r==null?void 0:r.length)>0)o=r,console.log(`[Tutorial] RPC OK → ${o.length} étapes`);else{const{data:s,error:c}=await v.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!c&&(s==null?void 0:s.length)>0?(o=s,console.log(`[Tutorial] Direct OK → ${o.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${n==null?void 0:n.message}, Direct: ${c==null?void 0:c.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=o.length>0?o.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):La;Sa(t,a,()=>e("boosters"))}const Ro={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function hi(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function Ta(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await fo(t,e)}async function fo(t,e){const{state:i,toast:o,navigate:r}=e;Yt(r,i.profile,"market","/icons/",o);const{data:n}=await v.from("market_listings").select(`id, price, status, listed_at, seller_id,
      ...
      card:cards(id, card_type, current_note, evolution_bonus,
        player:players(id, firstname, surname_real, country_code, job, job2,
          ...
          clubs(encoded_name, logo_url)))`).eq("seller_id",i.profile.id).in("status",["active","sold"]).order("listed_at",{ascending:!1}).limit(100),s=(n||[]).filter(y=>y.seller_id!==i.profile.id),c=a||[];t.innerHTML=`
  <style>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;background:var(--tile-bg);border-bottom:1px solid var(--tile-border)">
      ...
      <div style="font-size:12px;color:var(--tile-fg-dim);margin-top:2px">${s.length} carte(s) en vente · ${(i.profile.credits||0).toLocaleString("fr")} cr.</div>
    </div>
  ...
  </div>`;let d="buy";const l=()=>{var y,p,w,h,E,m,T;return{name:(((y=document.getElementById("flt-name"))==null?void 0:y.value)||"").toLowerCase().trim(),club:(((p=document.getElementById("flt-club"))==null?void 0:p.value)||"").toLowerCase().trim(),country:(((w=document.getElementById("flt-country"))==null?void 0:w.value)||"").toLowerCase().trim(),job:((h=document.getElementById("flt-job"))==null?void 0:h.value)||"",rarity:((E=document.getElementById("flt-rarity"))==null?void 0:E.value)||"",note1:parseInt((m=document.getElementById("flt-note1"))==null?void 0:m.value)||0,note2:parseInt((T=document.getElementById("flt-note2"))==null?void 0:T.value)||0}};function u(y){const p=l();return y.filter(w=>{var V,Y,j;const h=(V=w.card)==null?void 0:V.player;if(!h)return!1;const E=`${h.firstname} ${h.surname_real}`.toLowerCase(),m=(((Y=h.clubs)==null?void 0:Y.encoded_name)||"").toLowerCase(),T=(h.country_code||"").toLowerCase(),$=((j=w.card)==null?void 0:j.evolution_bonus)||0,I=hi(h,h.job,$),D=h.job2?hi(h,h.job2,$):0;return!(p.name&&!E.includes(p.name)||p.club&&!m.includes(p.club)||p.country&&!T.includes(p.country)||p.job&&h.job!==p.job||p.rarity&&h.rarity!==p.rarity||p.note1&&I<p.note1||p.note2&&D<p.note2)})}function x(y){var m,T,$;const p=(m=y.card)==null?void 0:m.player;if(!p)return"";const w=((T=y.card)==null?void 0:T.evolution_bonus)||0,h=(i.profile.credits||0)>=y.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function b(y){var Y,j,L,_;const p=(Y=y.card)==null?void 0:Y.player;if(!p)return"";const w=((j=y.card)==null?void 0:j.evolution_bonus)||0,h=hi(p,p.job,w),E=p.job2?hi(p,p.job2,w):0,m=y.status==="sold",T=p.country_code?`https://flagsapi.com/${p.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,$=Ro[p.job]||"#bbb",I=p.job2?Ro[p.job2]||"#bbb":null,D=p.job==="GK"?"#fff":$,V=p.job2==="GK"?"#fff":I;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${m?"opacity:0.7":""}">
      ${T?`<img src="${T}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(L=p.clubs)!=null&&L.logo_url?`<img src="${p.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
    ...
    </div>`,document.body.appendChild(r);const n=s=>{r.remove(),s&&e()};r.querySelector("#buy-cancel").addEventListener("click",()=>n(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>n(!0)),r.addEventListener("click",s=>{s.target===r&&n(!1)})}async function za(t,e,i){const{toast:o}=i,{data:r}=await v.from("market_listings").select("card_id").eq("id",t).single();if(await v.from("market_listings").update({status:"cancelled"}).eq("id",t),r!=null&&r.card_id){const{count:n}=await v.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");n||await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}o("Annonce retirée","success"),fo(e,i)}async function Ma(t,e){var b,g,f,y,p;const{state:i,navigate:o}=e,r=((g=(b=e==null?void 0:e.state)==null?void 0:b.params)==null?void 0:g.tab)||"ranked";t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:var(--tile-fg-dim)">⚽ Chargement...</div>';const[{data:n},{data:a},{data:s}]=await Promise.all([v.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").order("mmr",{ascending:!1}).limit(100),v.rpc("get_mini_league_leaderboard"),v.rpc("get_random_leaderboard")]);let c=r;const d=w=>w<3?["#D4A017","#a0a0a0","#cd7f32"][w]:"var(--green)",l=w=>w<3?"#000":"#fff";function u(){var E,m,T;const w=document.getElementById("rankings-legend");w&&(w.innerHTML=c==="random"?'<div style="font-size:11px;color:var(--tile-fg-dim);text-align:center;margin-bottom:10px">📊 = score de classement fiable (tient compte du nombre de matchs joués, pas seulement du %)</div>':"");const h=document.getElementById("rankings-list");if(h){if(c==="ranked"){const $=n||[];h.innerHTML=$.length>0?$.map((I,D)=>{const V=At(I.mmr??1e3),Y=(I.ranked_wins||0)+(I.ranked_losses||0)+(I.ranked_draws||0),j=Y>0?Math.round((I.ranked_wins||0)/Y*100):0,L=I.id===i.profile.id,_=(I.placement_matches||0)<10;return`
        ...
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${I.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${d(D)};color:${l(D)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${D<3?"16":"13"}px">${D<3?["🥇","🥈","🥉"][D]:D+1}</div>
          <div style="flex:1;min-width:0">
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const $=s||[];h.innerHTML=$.length>0?$.map((I,D)=>`
        <div style="display:flex;align-items:center;gap:12px;padding:12px;background:var(--tile-bg,rgba(255,255,255,0.05));border-radius:12px;border:1px solid var(--tile-border,rgba(255,255,255,0.1));${I.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${d(D)};color:${l(D)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${D<3?"16":"13"}px">${D<3?["🥇","🥈","🥉"][D]:D+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${I.pseudo}</div>
  ...
  <div class="page">
  ...
  </div>`,u(),(f=document.getElementById("tab-ranked"))==null||f.addEventListener("click",()=>{c="ranked",u()}),(y=document.getElementById("tab-mini-league"))==null||y.addEventListener("click",()=>{c="mini-league",u()}),(p=document.getElementById("tab-random"))==null||p.addEventListener("click",()=>{c="random",u()})}async function Ca(t,e){var T,$,I,D;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:s}]=await Promise.all([v.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),v.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!s){r("Erreur chargement profil","error"),o("home");return}if(!a){const V=s.mmr??1e3,Y=At(V);Gi(V);const j=Math.round(1e3+(V-1e3)*.5),L=At(j),{data:_}=await v.from("users").select("id, pseudo, club_name, mmr, rank_tier").order("mmr",{ascending:!1}).limit(100),G=(_||[]).findIndex(O=>O.id===s.id)+1;t.innerHTML=`
    <div style="min-height:100%;background:linear-gradient(160deg,#1a1a1a,#2a2a2a);padding:16px;overflow-y:auto;display:flex;flex-direction:column;gap:16px">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:320px;overflow-y:auto">
          ${(_||[]).map((O,le)=>{const pe=At(O.mmr??1e3),M=O.id===s.id;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;
    ...
    </div>`,(T=document.getElementById("ranked-back"))==null||T.addEventListener("click",()=>o("home"));return}const c=s.mmr??1e3,d=s.mmr_deviation??350,l=s.mmr_volatility??.06,u=s.placement_matches??0,x=u<10,b=Math.max(0,10-u),g=At(c),f=Gi(c),y=Di.findIndex(V=>V.id===g.id),p=Di[y+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=Di.map(V=>`
    <div style="display:flex;flex-direction:column;align-items:center;gap:2px;opacity:${g.id===V.id?1:.35};
      transform:${g.id===V.id?"scale(1.15)":"scale(1)"};transition:all 0.3s">
      <div style="font-size:${g.id===V.id?"28px":"20px"}">${V.emoji}</div>
      <div style="font-size:9px;color:${V.color};font-weight:${g.id===V.id?"900":"400"};letter-spacing:0.5px">${V.label.toUpperCase()}</div>
    </div>
  `).join("");t.innerHTML=`
  ...
  </div>`}$n(Ln);const ve={user:null,profile:null,page:"home",params:{}};function St(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function qa(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Qi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ni(){if(!ve.user)return;const{data:t}=await v.from("users").select("*").eq("id",ve.user.id).single();t&&(ve.profile=t)}const vn="mw_theme";function ai(){return localStorage.getItem(vn)||"club"}function No(t){var e;localStorage.setItem(vn,t),vi(t),(e=ve.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",ve.profile.id).then(()=>{})}function vi(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=ve.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=ve.profile)==null?void 0:i.club_color2)||"#080d08"))}function Mt(t,e={}){ve.page=t,ve.params=e,wn()}async function wn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const e=document.getElementById("nav-credits");e&&ve.profile&&(e.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Mt,toast:St,openModal:qa,closeModal:Qi,refreshProfile:ni};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Fi(t,i);break;case"home2":await Fi(t,i);break;case"game":await fr(t,i);break;case"settings":await rn(t,i);break;case"collection":await vr(t,i);break;case"decks":await Ui(t,i);break;case"boosters":await Fn(t,i);break;case"ranked":await Ca(t,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Xi(t,i,!1):s==="ranked"?await Xi(t,i,!0):s==="friend"?await sa(t,i,(o=ve.params)==null?void 0:o.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await Fo(t,i,(n=ve.params)==null?void 0:n.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await qr(t,i);break}case"market":await Ta(t,i);break;case"rankings":await Ma(t,i);break;case"matches":await ja(t,i);break;case"friends":await lr(t,i);break;case"mini-league":await pa(t,i);break;case"match-mini-league":{const s=ve.params||{};await Fo(t,i,s.mlMatchId,s.leagueId);break}default:await Fi(t,i)}}function Ba(){var o,r;const t=document.getElementById("app"),e=ve.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.30-2148" style="cursor:pointer">
