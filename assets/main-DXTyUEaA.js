...
import{s as v,j as vi,q as zn,t as Ut,u as Oi,F as Hi,o as tt,n as Rt,g as Mt,r as Se,m as Ct,v as Mi,w as go,T as Ti,p as xo,x as bo,d as yo}from"./special-cards-lEGt-tGs.js";const ho="/";function pn(t,{navigate:e,toast:i}){let n="login";const r=()=>{var a,s,d,l,c,f,b;const o=n==="login";if(t.innerHTML=`
    <div style="
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${Se(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter($=>$.card_type==="player"&&$.player),c=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),b=(s||[]).filter($=>$.card_type==="stadium"),{data:x}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(x||[]).forEach($=>{g[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),b.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const y=Object.keys(Hi),w=Object.keys(ze),h={};l.forEach($=>{const C=$.player.id;h[C]=(h[C]||0)+1}),new Set(Object.keys(h).map($=>String($)));const L=new Set(f.map($=>$.formation)),m=new Set(c.map($=>$.gc_type));let A="player",E="Tous",S="",q=!1;function W(){return[...l].sort(($,C)=>{const O=si.indexOf($.player.job),P=si.indexOf(C.player.job);return O!==P?O-P:($.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function ee(){return[...d||[]].sort(($,C)=>{const O=si.indexOf($.job),P=si.indexOf(C.job);return O!==P?O-P:($.surname_real||"").localeCompare(C.surname_real||"")})}function G(){return W().filter($=>{const C=$.player,O=E==="Tous"||C.job===E,P=!S||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(S);return O&&P})}function I(){return ee().filter($=>{const C=E==="Tous"||$.job===E,O=!S||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(S);return C&&O})}t.innerHTML=`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(j=document.getElementById("close-detail"))==null||j.addEventListener("click",s);let I=new Set;const _=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function H(){let $=0;return document.querySelectorAll(".expl-check:checked").forEach(C=>{if(C.dataset.id===t.id)return;const P=Number(C.dataset.evo)||0,X=Number(C.dataset.note)||0;$+=X+P}),Math.round($*_)}const Y=()=>{const $=I.size,C=document.getElementById("sell-action-panel");if(!C)return;C.style.display=$>0?"block":"none",document.getElementById("sell-selected-count").textContent=$;const O=document.getElementById("evolve-btn");if(O){const P=H();O.textContent=P>0?`⬆️ Évoluer (+${P})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach($=>{$.addEventListener("change",()=>{const C=$.dataset.id;$.checked?I.add(C):I.delete(C);const O=$.closest(".exemplaire-row");if(O){const P=O.querySelector(".expl-sel-overlay"),X=O.querySelector(".expl-sel-check");P&&(P.style.display=$.checked?"block":"none"),X&&(X.style.display=$.checked?"flex":"none"),O.style.transform=$.checked?"scale(1.05)":"scale(1)"}Y()})}),document.querySelectorAll(".exemplaire-row").forEach($=>{$.addEventListener("click",C=>{if(C.target.tagName==="INPUT")return;const O=$.querySelector(".expl-check");O&&!O.disabled&&(O.checked=!O.checked,O.dispatchEvent(new Event("change")))})}),(U=document.getElementById("evolve-btn"))==null||U.addEventListener("click",async()=>{if(b<=1)return;const $=[...I];if(!$.length)return;if(I.has(t.id)){const ne=document.createElement("div");ne.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ne.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`;u("⚽ Choisir une formation",w),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{e.formation=h.dataset.forma;const L=_n(e.formation),m={};L.forEach(A=>{e.slots[A]&&(m[A]=e.slots[A])}),e.slots=m,y(),wt(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",x)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>sr(e,t,i))),t.querySelectorAll("#save-deck").forEach(u=>u.addEventListener("click",()=>cr(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),wt(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>lr(e,t,i)))}function ar(t,e,i,n){var h,L,m;const r=window.innerWidth>=900,o=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=e.stadiumCards)==null?void 0:h.find(A=>A.id===e.stadiumCardId),s=a&&((L=e.stadDefMap)==null?void 0:L[a.stadium_id])||null,d=Ct[e.formation]||{},l=Oi(e.formation)||[],c={};for(const A of i){const E=e.slots[A],S=E?e.playerCards.find(q=>q.id===E):null;S!=null&&S.player?c[A]={...S.player,_evolution_bonus:S.evolution_bonus||0,face:S.player.face||null}:c[A]=null}const f=window.innerWidth>=900,b=f?window.innerWidth-280:window.innerWidth-20,x=f?Math.min(b,860):b,g=Math.round(f?x*.82:x*.85),p=f?84:44;let u="";for(const[A,E]of l){const S=d[A],q=d[E];if(!S||!q)continue;const W=S.x*x,ee=Math.round(.03*g+S.y*.85*g),G=q.x*x,I=Math.round(.03*g+q.y*.85*g),_=c[A],H=c[E],Y=Ut(_,H);Y==="#ff3333"||Y==="#cc2222"?u+=`<line x1="${W.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${G.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${Y}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${W.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${G.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${Y}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${W.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${G.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${Y}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const A of i){const E=d[A];if(!E)continue;const S=c[A],q=E.x*x;E.y*g;const W=Math.round(.03*g+E.y*(.85*g)),ee=Math.round(q-p/2),G=Math.round(W-w/2);if(S){const I=A.replace(/\d+/,""),_=s&&(s.club_id&&String(S.club_id)===String(s.club_id)||s.country_code&&S.country_code===s.country_code),H=Se({...S,_evolution_bonus:S._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:I});_&&((m=s.club)!=null&&m.logo_url||s.image_url),y+=`<div style="position:absolute;left:${ee}px;top:${G}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${A}">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((o,a)=>{const s=a<t.length-1?Ut(o,t[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",l=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return to(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
  ...
  <div id="match-history-panel">
    ...
    </div>`,(m=f.querySelector("#sub-close"))==null||m.addEventListener("click",()=>f.remove()),(A=f.querySelector("#out-up"))==null||A.addEventListener("click",()=>{s>0&&(s--,b())}),(E=f.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,b())}),(S=f.querySelector("#in-up"))==null||S.addEventListener("click",()=>{l>0&&(l--,b())}),(q=f.querySelector("#in-down"))==null||q.addEventListener("click",()=>{l<a.length-1&&(l++,b())});const L=(ee,G,I,_)=>{const H=f.querySelector("#"+ee);if(!H)return;let Y=0;H.addEventListener("touchstart",ae=>{Y=ae.touches[0].clientY},{passive:!0}),H.addEventListener("touchend",ae=>{const de=ae.changedTouches[0].clientY-Y;if(Math.abs(de)<30)return;const j=G();de<0&&j<_-1?(I(j+1),b()):de>0&&j>0&&(I(j-1),b())},{passive:!0})};L("in-panel",()=>l,ee=>l=ee,a.length),L("out-panel",()=>s,ee=>s=ee,o.length),(W=f.querySelector("#sub-confirm"))==null||W.addEventListener("click",ee=>{if(ee.preventDefault(),ee.stopPropagation(),c)return;c=!0;const G=o[s],I=a[l];if(!G||!I)return;let _=null,H=-1;for(const[ae,de]of Object.entries(e.homeTeam)){const j=(de||[]).findIndex(U=>U.cardId===G.cardId);if(j!==-1){_=ae,H=j;break}}if(H===-1||!_){Et("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const Y={...I,_line:_,_col:G._col||0,used:!1,boost:0};e.homeTeam[_].splice(H,1,Y),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:G.name,firstname:G.firstname,note:Pe(G,_),portrait:Mt(G),job:G.job,country_code:G.country_code,rarity:G.rarity,clubName:G.clubName,clubLogo:G.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Pe(I,_),portrait:Mt(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${G.firstname} ${G.name}`}),f.remove(),Sr(G,I,()=>ke(t,e,i))})}document.body.appendChild(f),b()}function Gr(t,e,i,n,r){var b,x;const o=(n.gcDefs||[]).find(g=>g.name===e),a=ze[e]||{icon:"⚡",desc:"Carte spéciale."},s=(o==null?void 0:o.name)||e,d=(o==null?void 0:o.effect)||a.desc,l=o!=null&&o.image_url?`/icons/${o.image_url}`:null,c=a.icon||"⚡",f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",f.innerHTML=`
    ${tt(s,l,c,d,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(f),(b=f.querySelector("#gc-back"))==null||b.addEventListener("click",()=>f.remove()),(x=f.querySelector("#gc-use"))==null||x.addEventListener("click",()=>{f.remove(),Or(t,e,i,n,r)})}function pi(t,e,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function d(){var l,c;a.innerHTML=`
    ...
    </div>`,(z=document.getElementById("pvp-home"))==null||z.addEventListener("click",()=>{try{v.removeChannel(G)}catch{}it(t),c?x("mini-league",{openLeagueId:c}):x("home")})}U()}async function Ni(t,e,i=!1){var s,d;const{state:n,navigate:r,toast:o}=e,a=i&&((d=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await ki(t,e,i?"ranked":"random",async({deckId:l,formation:c,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{dt(t);const u=async y=>{await Jr(t,e,l,c,f,b,y||[],g,p,i,a)};if(!(x!=null&&x.length)){await u([]);return}wi(t,x,u)})}async function Xr(t,e,i){return Wr(t,e,i)}async function Jr(t,e,i,n,r,o,a=[],s=[],d=null,l=!1,c=null){var ee,G;const{state:f,navigate:b,toast:x}=e,g=(c==null?void 0:c.mmr)??((ee=f.profile)==null?void 0:ee.mmr)??1e3,p=l?vi(g):null,u=l?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=l?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,L=null;t.innerHTML=`
    ...
    </div>`;const m=async()=>{w=!0,h&&(h.unsubscribe(),h=null),L&&(clearInterval(L),L=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(G=document.getElementById("cancel-mm"))==null||G.addEventListener("click",async()=>{await m(),it(t),b("home")});const A=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),L&&(clearInterval(L),L=null),await jt(t,e,I,_,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:l,rankedData:c,onMatchEnd:l?Qr:null}))},E=f.user.id,{data:S,error:q}=l?await v.rpc("try_matchmake_ranked",{p_user_id:E,p_deck_id:i,p_mmr:g}):await v.rpc("try_matchmake",{p_user_id:E,p_deck_id:i});if(q||!(S!=null&&S.success)){console.error("[Matchmaking] try_matchmake error:",q||S),x("Erreur de matchmaking","error"),it(t),b("home");return}if(S.matched){await A(S.match_id,!1);return}const W=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",E).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await A(I.match_id,!0)};h=v.channel(`mm_${E}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${E}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&A(_.match_id,!0)}).subscribe(),L=setInterval(W,3e3),setTimeout(()=>{w||m()},12e4)}async function Qr(t,e){const{state:i,toast:n}=e,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:d,matchId:l}=t,c=i.user.id,f=o===c,b=r===c,{data:x}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",c).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:o).single();if(x&&g){const p=go(x.mmr,x.mmr_rd,x.mmr_v,g.mmr,g.mmr_rd,b?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:b?v.sql`mmr_wins + 1`:void 0,mmr_losses:b?void 0:v.sql`mmr_losses + 1`}).eq("id",c),n(b?`+MMR ↑ ${Math.round(p.mmr-x.mmr)}`:`-MMR ↓ ${Math.round(x.mmr-p.mmr)}`,b?"success":"error",4e3)}}const ro=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ni,resumePvpMatch:Xr},Symbol.toStringTag,{value:"Module"}));async function Zr(t,e){const{state:i,navigate:n,toast:r}=e,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",d=!!o.isAccepting;await ki(t,e,"friend",async({deckId:l,formation:c,starters:f,subsRaw:b,gcCardsEnriched:x,gcDefs:g,stadiumDef:p})=>{dt(t);const u=async y=>{const w=y||[];d?await ta(t,e,l,w,g,p):await ea(t,e,l,w,g,p,a,s)};if(!(x!=null&&x.length)){await u([]);return}wi(t,x,u)})}async function ea(t,e,i,n,r,o,a,s){var w;const{state:d,navigate:l,toast:c}=e,f=d.user.id,{data:b,error:x}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(x||!b){console.error("[Friend] Erreur création invitation:",x),c("Impossible de créer l'invitation","error"),l("home");return}t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?oa(x,y,r):i==="active"?ra(g,r):aa(u,r,s)}
    </div>
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),n=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function lo(t,e,i,n){var f;const{toast:r,state:o}=e,a=o.profile.id;let s=null;if(n==="private"&&(s=await da(),s===null))return;const{data:d,error:l}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(l||!(d!=null&&d.success)){console.error("[MiniLeague] join_mini_league:",l||d),r((d==null?void 0:d.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:b}=await v.from("users").select("credits").eq("id",a).single();o.profile&&b&&(o.profile.credits=b.credits)}const c=document.getElementById("nav-credits");c&&(c.textContent=`💰 ${(((f=o.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ct(t,e,i)}async function la(t,e,i,n){const{toast:r,state:o}=e,a=o.profile.id;if(!await new Promise(b=>{const x=document.createElement("div");x.className="modal-overlay",x.style.zIndex="2100",x.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Jt};border:1px solid ${Qt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(I,_)=>_+1).reverse().map(I=>{const _=(d||[]).filter(H=>H.matchday===I);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ze};margin-bottom:6px">Journée ${I}</div>${_.map(H=>Ln(H,f,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function ha(t,e,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var c,f,b;const s=e[n],d=n===e.length-1,l=Math.round((n+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function b(p){var S,q,W,ee;const u=(S=p.card)==null?void 0:S.player;if(!u)return"";const y=((q=p.card)==null?void 0:q.evolution_bonus)||0,w=ui(u,u.job,y),h=u.job2?ui(u,u.job2,y):0,L=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,A=In[u.job]||"#bbb",E=u.job2?In[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${L?"opacity:0.7":""}">
