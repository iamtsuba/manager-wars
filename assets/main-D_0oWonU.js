...
import{s as w,F as ci,r as Ie,j as St,l as Hi,m as At,h as pi,n as vn,o as wn,T as Yt,k as _n,p as kn,b as $n}from"./formation-links-EITwj297.js";const En="/";function Mi(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,l,c,d,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(u){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(u){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await Tn(t.user.id),await a(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function Tn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const zn="modulepreload",In=function(e){return"/"+e},Si={},Ui=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(l=>{if(l=In(l),l in Si)return;Si[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":zn,c||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),c)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Tt="#1A6B3C",zt="#cc2222",Mn="#D4A017",Ai="#888";async function Sn(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;align-items:center;gap:12px;background:#fff;border-radius:12px;padding:12px 14px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
      ...
      <div style="display:flex;gap:8px;flex-shrink:0">
        ...
        <button data-stats="${e.id}" data-friend-name="${i}" title="Voir les stats"
          style="width:38px;height:38px;border-radius:50%;border:2px solid ${Mn};background:#fff;font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center">📊</button>
      </div>
    </div>`}function jn(e,t){const i=ui();i.innerHTML=`
    <div class="popup-box">
    ...
    <div style="display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid #f0f0f0">
      ...
      <div style="text-align:left;font-size:18px;font-weight:900;color:${F}">${B}</div>
    </div>`,h=ui();h.innerHTML=`
    ...
    ${fi()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",$=>{$.target===h&&h.remove()})}function ui(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function fi(){return`
    <style>
      .popup-box {
    ...
    </style>`}const Bn="2026.07.17-1107";async function ji(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>Vi(e,t,()=>Wi(e,t)))}function Gn(e){const t=[{mode:"vs_ai_easy",label:"Facile",sub:"Gain 500 cr.",icon:"🟢"},{mode:"vs_ai_medium",label:"Moyen",sub:"Gain 1 000 cr.",icon:"🟡"},{mode:"vs_ai_hard",label:"Difficile",sub:"Gain 1 500 cr.",icon:"🟠"},{mode:"vs_ai_club",label:"Club",sub:"Gain 2 500 cr.",icon:"🔴"}],i=document.createElement("div");i.className="modal-overlay",i.style.zIndex="2000",i.innerHTML=`<div class="modal" style="max-width:380px">
  ...
  </div>`,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",a=>{a.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{n(),e("match",{matchMode:a.dataset.mode})})})}const Se={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function De(e,t){if(!e)return 0;let i=0;switch(t){case"GK":i=Number(e.note_g)||0;break;case"DEF":i=Number(e.note_d)||0;break;case"MIL":i=Number(e.note_m)||0;break;case"ATT":i=Number(e.note_a)||0;break;default:i=0}return i+(e.boost||0)}const Ci=["ATT","MIL","DEF","GK"];function Xi(e){let t=0;const i=e.length;for(let n=0;n<i;n++)for(let a=n+1;a<i;a++){const o=e[n],r=e[a];if(!o||!r)continue;const s=o._col!=null&&r._col!=null&&o._col===r._col,l=o._col!=null&&r._col!=null&&Math.abs(o._col-r._col)===1,c=Ci.indexOf(o._line||o.job),d=Ci.indexOf(r._line||r.job),u=Math.abs(c-d)===1;if(!((o._line||o.job)===(r._line||r.job)&&l||s&&u))continue;const f=o.country_code&&r.country_code&&o.country_code===r.country_code,p=o.club_id&&r.club_id&&o.club_id===r.club_id;f&&p?t+=2:(f||p)&&(t+=1)}return t}function gi(e,t={}){let i=0,n=0;e.forEach(s=>{const l=s._line||s.job,c=Number(l==="MIL"?s.note_m:s.note_a)||0,d=s.stadiumBonus&&(l==="MIL"||l==="ATT")?10:0;i+=t.doubleAttack?c*2:c,n+=(s.boost||0)+d});const a=i+n,o=Xi(e);let r=a+o;return t.stolenNote&&(r-=t.stolenNote),{base:a,links:o,total:Math.max(0,r)}}function mi(e,t={}){const i=e.reduce((o,r)=>{const s=r._line||r.job;let l=0;s==="GK"?l=Number(r.note_g)||0:s==="MIL"?l=Number(r.note_m)||0:l=Number(r.note_d)||0;const c=r.stadiumBonus&&(s==="GK"||s==="DEF"||s==="MIL")?10:0;return o+l+(r.boost||0)+c},0),n=Xi(e);let a=i+n;return t.stolenNote&&(a-=t.stolenNote),{base:i,links:n,total:Math.max(0,a)}}function xi(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function Ji(e,t,i="easy"){const n=e.filter(r=>!r.used);if(!n.length)return[];const a=[...n].sort((r,s)=>{const l=t==="attack"?De(r,"ATT"):r._line==="GK"?De(r,"GK"):De(r,"DEF");return(t==="attack"?De(s,"ATT"):s._line==="GK"?De(s,"GK"):De(s,"DEF"))-l});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(o,a.length,3))}function Pn(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}function Rn(e,t){const i=e.player;if(!i)return 0;const n=i.rarity;if(n!=="pepite"&&n!=="papyte")return Number(i[t])||0;const a=Nn(i),o=Number(i[t])||0;if(o<=0)return 0;const r=i.note_min??1,s=i.note_max??10,c=(e.current_note??a)-a;return Math.min(s,Math.max(r,o+c))}function Nn(e){const t=e.job||"ATT";return Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}const On={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Wt={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},Bt=["GK","DEF","MIL","ATT"],Hn=["Tous","GK","DEF","MIL","ATT"],Un={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function Bi(e){const t=e.player;if(!t)return null;const i=t.rarity;return(i==="pepite"||i==="papyte")&&e.current_note!=null?e.current_note:Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function Kn(e){return e.length?e.reduce((t,i)=>Bi(i)>Bi(t)?i:t,e[0]):e[0]}function Vn(e){return e==="GK"?"note_g":e==="DEF"?"note_d":e==="MIL"?"note_m":"note_a"}const Yn={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Wn(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Xt(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Jt(e,t=""){const i=e.player;if(!i)return"";const n=e.evolution_bonus||0,a={...i,_evolution_bonus:n},o=t?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${t}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${e.id}">
    ${o}
    ${Ie(a,{width:140})}
  </div>`}function qi(e){return`<div style="display:inline-block;filter:grayscale(1);opacity:0.4">
    ${Ie(e,{width:140})}
  </div>`}async function Xn(e,t){const{state:i,navigate:n,toast:a,openModal:o,closeModal:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:s}=await w.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price, stadium_id, evolution_bonus,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(z=>z.card_type==="player"&&z.player),d=(s||[]).filter(z=>z.card_type==="game_changer"),u=(s||[]).filter(z=>z.card_type==="formation"),g=(s||[]).filter(z=>z.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(z=>{f[z.name]=z});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(z=>{x[z.id]=z}),g.forEach(z=>{z.stadium_def&&(x[z.stadium_id]=z.stadium_def)});const b=Object.keys(ci),v=Object.keys(Se),h={};c.forEach(z=>{const C=z.player.id;h[C]=(h[C]||0)+1}),new Set(Object.keys(h).map(z=>String(z)));const $=new Set(u.map(z=>z.formation)),y=new Set(d.map(z=>z.gc_type));let B="player",E="Tous",F="",R=!1;function ie(){return[...c].sort((z,C)=>{const D=Bt.indexOf(z.player.job),Y=Bt.indexOf(C.player.job);return D!==Y?D-Y:(z.player.surname_real||"").localeCompare(C.player.surname_real||"")})}function ee(){return[...l||[]].sort((z,C)=>{const D=Bt.indexOf(z.job),Y=Bt.indexOf(C.job);return D!==Y?D-Y:(z.surname_real||"").localeCompare(C.surname_real||"")})}function J(){return ie().filter(z=>{const C=z.player,D=E==="Tous"||C.job===E,Y=!F||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(F);return D&&Y})}function S(){return ee().filter(z=>{const C=E==="Tous"||z.job===E,D=!F||`${z.firstname} ${z.surname_real}`.toLowerCase().includes(F);return C&&D})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",C=>{F=C.target.value.toLowerCase(),M()}),e.querySelectorAll(".filter-btn").forEach(C=>{C.addEventListener("click",()=>{E=C.dataset.job,_(),M()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{R=!R,_(),M()})):(z.innerHTML=`
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{R=!R,_(),M()})))}function M(){const z=document.getElementById("col-grid");z&&(B==="player"?Le(z):B==="formation"?V(z):B==="stadium"?P(z):X(z))}function H(z,C,D,Y,K){const q=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!q||!O)return;var we=0;function _e(){const be=window.innerWidth>=768,me=document.getElementById("col-big"),ke=document.getElementById("col-grid");be&&me&&(me.style.minHeight="420px",me.style.flex="1 1 auto"),be&&ke&&(ke.style.height=Math.round(310*.76+16)+"px",ke.style.flexShrink="0",ke.style.overflowX="auto",ke.style.overflowY="hidden",ke.style.alignItems="center",ke.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+C(z[we])+"</div>";var $e=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");$e&&$e.addEventListener("click",function(){Y(z[we])}),requestAnimationFrame(function(){var xe=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!xe||!O)){var je=O.clientHeight-8,Be=O.clientWidth-24,Ue=xe.offsetHeight,k=xe.offsetWidth;if(Ue>0&&k>0&&je>40){var L=be?2.2:1.6,I=Math.min(je/Ue,Be/k,L);xe.style.transform="scale("+I.toFixed(3)+")",xe.style.transformOrigin="top center"}}}),q.innerHTML=z.map(function(xe,je){var Be=je===we,Ue="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Be?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+je+'" style="'+Ue+'">'+D(xe,Be)+"</div>"}).join(""),q.querySelectorAll(".col-mini-item").forEach(function(xe){xe.addEventListener("click",function(){we=Number(xe.dataset.idx),_e(),xe.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function le(z){var C=window.innerWidth>=768?.76:.54,D;if(!z||z._fake){var Y=z?z.player:null;if(!Y)return"";D=qi(Y)}else D=Jt(z,"");return'<div style="display:inline-block;zoom:'+C+';pointer-events:none;line-height:0">'+D+"</div>"}function se(z,C,D){C=C||100,D=D||140;var Y=St[z]||{},K={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},q=Math.max(3,Math.round(C*.06)),O=Object.entries(Y).map(function(_e){var be=_e[0],me=_e[1],ke=be.replace(/\d+$/,""),$e=K[ke]||"#888",xe=Math.round(me.x*C),je=Math.round(me.y*D);return'<circle cx="'+xe+'" cy="'+je+'" r="'+q+'" fill="'+$e+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),we=Math.max(1,Math.round(C/50));return'<svg viewBox="0 0 '+C+" "+D+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+C+'" height="'+D+'" fill="#1A6B3C"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(D*.02)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(D*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/><line x1="0" y1="'+Math.round(D*.5)+'" x2="'+C+'" y2="'+Math.round(D*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><ellipse cx="'+Math.round(C*.5)+'" cy="'+Math.round(D*.5)+'" rx="'+Math.round(C*.18)+'" ry="'+Math.round(D*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><rect x="'+Math.round(C*.2)+'" y="'+Math.round(D*.82)+'" width="'+Math.round(C*.6)+'" height="'+Math.round(D*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/>'+O+"</svg>"}function ce(z,C,D){var Y=D>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+D+"</div>":"",K=C?'data-form-id="'+C.id+'"':"",q=z.length>7?14:z.length>5?16:19,O=!!C;return"<div "+K+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+Y+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+q+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+z+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+se(z,140,220)+"</div></div>"}function de(z,C){var D=window.innerWidth>=768?.76:.54,Y=140,K=305,q=Math.round(K*.22),O=K-q,we=z.length>7?10:13,_e=se(z,Y,O),be=C?"1.5px solid #2a7a40":"1px solid #ddd",me=C?"":"filter:grayscale(1);opacity:0.45;",ke=C?"#1A6B3C":"#bbb",$e="#fff";return'<div style="display:inline-block;zoom:'+D+';line-height:0;pointer-events:none"><div style="width:'+Y+"px;height:"+K+"px;border-radius:6px;border:"+be+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+me+'"><div style="height:'+q+"px;background:"+ke+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+we+"px;font-weight:900;color:"+$e+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(Y-4)+'px">'+z+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function Le(z){if(R){const C=S();if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const D=C.map(Y=>c.find(K=>K.player.id===Y.id)||{_fake:!0,player:Y,id:"fake-"+Y.id});H(D,Y=>Y._fake?qi(Y.player):Jt(Y,""),Y=>Y._fake?le({player:Y.player,id:"x",_fake:!0}):le(Y),Y=>{Y._fake||Di(Y,c,h,t)})}else{const C=J();if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const D={};C.forEach(K=>{const q=K.player.id;D[q]||(D[q]=[]),D[q].push(K)});const Y=Object.values(D).map(K=>Kn(K));H(Y,K=>{const q=h[K.player.id]||1,O=q>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${q}</div>`:"",_e=c.filter(be=>be.player.id===K.player.id&&be.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Jt(K,O+_e)},K=>le(K),K=>Di(K,c,h,t))}}function V(z){const C=R?b:[...$];if(!C.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const D=C.map(Y=>({formation:Y,card:u.find(K=>K.formation===Y)||null,owned:$.has(Y)}));H(D,({formation:Y,card:K,owned:q})=>ce(Y,q?K:null,q?u.filter(O=>O.formation===Y).length:0),({formation:Y,owned:K})=>de(Y,K),({card:Y,owned:K})=>{K&&Y&&Qn(Y,u,t,o)})}function X(z){const C=Object.keys(f),D=R?C.length?C:v:[...y];if(!D.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Y=D.map(K=>({type:K,gc:Se[K]||{icon:"⚡",desc:""},def:f[K]||null,owned:y.has(K),card:d.find(q=>q.gc_type===K)||null}));H(Y,({type:K,gc:q,def:O,owned:we,card:_e})=>{var L;const be=we?d.filter(I=>I.gc_type===K).length:0,me=be>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${be}</div>`:"",ke=(O==null?void 0:O.gc_type)==="ultra_game_changer",$e={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},xe={purple:"#b06ce0",light_blue:"#00d4ef"},je=$e[O==null?void 0:O.color]||$e.purple,Be=xe[O==null?void 0:O.color]||xe.purple,Ue=(O==null?void 0:O.effect)||q.desc||"",k=O!=null&&O.image_url?`/icons/${O.image_url}`:((L=O==null?void 0:O.club)==null?void 0:L.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return we&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${K}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Be};background:${je};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Be}66;cursor:pointer">
          ${me}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${k?`<img src="${k}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${q.icon}</span>`}
          </div>
        ...
        </div>`},({type:K,gc:q,def:O,owned:we})=>{const _e=window.innerWidth>=768?.76:.54,be={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},me={purple:"#9b59b6",light_blue:"#00bcd4"},ke=be[O==null?void 0:O.color]||be.purple,$e=me[O==null?void 0:O.color]||me.purple,xe=O!=null&&O.image_url?`/icons/${O.image_url}`:null;return we?`<div style="display:inline-block;zoom:${_e};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${ke};border:1px solid ${$e};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${K}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${xe?`<img src="${xe}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${q.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((O==null?void 0:O.effect)||q.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${_e};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${q.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${K}</span></div></div>`},({type:K,owned:q,def:O})=>{q&&Jn(K,O,o)})}function P(z){const C="#E87722",D="/";if(!g.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Y={};g.forEach(q=>{const O=q.stadium_id||"?";(Y[O]=Y[O]||[]).push(q)});const K=Object.entries(Y).map(([q,O])=>({sid:q,def:x[q]||null,count:O.length,card:O[0]}));H(K,({def:q,count:O})=>{var $e,xe;const we=(q==null?void 0:q.name)||"?",_e=(($e=q==null?void 0:q.club)==null?void 0:$e.encoded_name)||(q==null?void 0:q.country_code)||"—",be=q!=null&&q.image_url?`${D}icons/${q.image_url}`:((xe=q==null?void 0:q.club)==null?void 0:xe.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),me=be?`<img src="${be}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',ke=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${C},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${C}66">
          ${ke}
        ...
        </div>`},({def:q,count:O})=>{var $e,xe;const we=window.innerWidth>=768?.76:.54,_e=(q==null?void 0:q.name)||"?",be=(($e=q==null?void 0:q.club)==null?void 0:$e.encoded_name)||(q==null?void 0:q.country_code)||"—",me=q!=null&&q.image_url?`${D}icons/${q.image_url}`:((xe=q==null?void 0:q.club)==null?void 0:xe.logo_url)||(q!=null&&q.country_code?`https://flagsapi.com/${q.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ke=me?`<img src="${me}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${we};line-height:0;pointer-events:none">
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(z=>{z.addEventListener("click",()=>{B=z.dataset.tab,E="Tous",F="",R=!1,e.querySelectorAll(".col-tab-btn").forEach(C=>{const D=C.dataset.tab===B;C.style.borderBottomColor=D?"var(--green)":"transparent",C.style.color=D?"var(--green)":"var(--gray-600)"}),_(),M()})}),_(),M()}function Jn(e,t,i){const n=Se[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=r[t==null?void 0:t.color]||r.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const qt=1e3;function Qn(e,t,i,n){var f,p,x;const{state:a,toast:o,closeModal:r,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const b=St[c]||{},v=ci[c]||[],h=290,$=360,y=20;function B(F){const R=b[F];return R?{x:R.x*h,y:R.y*$}:null}let E=`<svg width="${h}" height="${$}" viewBox="0 0 ${h} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[F,R]of v){const ie=B(F),ee=B(R);!ie||!ee||(E+=`<line x1="${ie.x}" y1="${ie.y}" x2="${ee.x}" y2="${ee.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const F of Object.keys(b)){const R=B(F);if(!R)continue;const ie=F.replace(/\d+/,""),ee=d[ie]||"#555";E+=`<circle cx="${R.x}" cy="${R.y}" r="${y}" fill="${ee}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,E+=`<text x="${R.x}" y="${R.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${ie}</text>`}return E+="</svg>",E}const g=t.filter(b=>b.formation===c);g.length;const m=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;background:#f9f9f9;border-radius:8px;padding:8px 12px;gap:8px">
      ...
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:13px;font-weight:700;color:${V.source==="booster"?"var(--gray-600)":"var(--yellow)"}">${P}</div>
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((V,X)=>{const P=J[V.id]||[],z=V.is_for_sale,C=P.length?P[P.length-1]:null,Y=(d.rarity==="pepite"||d.rarity==="papyte")&&V.current_note!=null?` (☆${V.current_note})`:"";return`
            <div data-card-id="${V.id}" data-card-idx="${X}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${X+1}${Y}${z?" 🏷️ En vente":""}</div>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${F}${d.job2&&R>0?` / ${ie}`:""}`:`Note actuelle : ${F}${d.job2&&R>0?` / ${ie}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([V,X])=>{const P=Wt[V],z=V==="GK"?"#fff":P,C=V===d.job||V===d.job2,D=(Number(X)||0)+(C&&B>0?B:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${P};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${z};font-family:Arial Black,Arial;line-height:1">${D}</span>
                </div>
    ...
    ${_}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(se=document.getElementById("close-detail"))==null||se.addEventListener("click",s);let M=new Set;const H=()=>{const V=M.size,X=document.getElementById("sell-action-panel");if(!X)return;X.style.display=V>0?"block":"none",document.getElementById("sell-selected-count").textContent=V;const P=document.getElementById("evolve-btn");P&&(P.textContent=`⬆️ Évoluer ${V>1?"(+"+V+")":""}`)};document.querySelectorAll(".expl-check").forEach(V=>{V.addEventListener("change",()=>{const X=V.dataset.id;V.checked?M.add(X):M.delete(X);const P=V.closest(".exemplaire-row");P&&(P.style.borderColor=V.checked?"#1A6B3C":"#eee"),H()})}),document.querySelectorAll(".exemplaire-row").forEach(V=>{V.addEventListener("click",X=>{if(X.target.closest("button")||X.target.tagName==="INPUT")return;const P=V.querySelector(".expl-check");P&&!P.disabled&&(P.checked=!P.checked,P.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(V=>{V.addEventListener("click",X=>{X.stopPropagation();const P=document.querySelector(`.expl-hist[data-hist="${V.dataset.idx}"]`);P&&(P.style.display=P.style.display==="none"?"flex":"none")})}),(ce=document.getElementById("evolve-btn"))==null||ce.addEventListener("click",async()=>{if(g<=1)return;const V=[...M];if(!V.length)return;if(M.has(e.id)){const K=document.createElement("div");K.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",K.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            📈 Note : <strong>${v+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${v+(e.evolution_bonus||0)+X.length*P}</strong>
            ${$&&$>0?`<br>📈 Note 2 : <strong>${$+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${$+(e.evolution_bonus||0)+X.length*P}</strong>`:""}
        ...
        </div>`,document.body.appendChild(q),q.querySelector("#sac-cancel").addEventListener("click",()=>{q.remove(),K(!1)}),q.querySelector("#sac-ok").addEventListener("click",()=>{q.remove(),K(!0)}),q.addEventListener("click",O=>{O.target===q&&(q.remove(),K(!1))})}))return;if(X.length){await w.from("market_listings").delete().in("card_id",X),await w.from("deck_cards").delete().in("card_id",X),await w.from("transfer_history").delete().in("card_id",X),await w.from("decks").update({stadium_card_id:null}).in("stadium_card_id",X);const{error:K}=await w.from("cards").delete().in("id",X);if(K){o("Erreur suppression : "+K.message,"error");return}}const C=(e.evolution_bonus||0)+X.length*P,{error:D}=await w.from("cards").update({evolution_bonus:C}).eq("id",e.id);if(D){o("Erreur évolution : "+D.message,"error");return}const Y=v+C;o(`⬆️ ${d.firstname} ${d.surname_real} : note ${v+e.evolution_bonus||v} → ${Y}${X.length?` · ${X.length} copie${X.length>1?"s":""} sacrifiée${X.length>1?"s":""}`:""} !`,"success",4e3),s(),l("collection")}),(de=document.getElementById("market-sell-btn"))==null||de.addEventListener("click",async()=>{var D;const V=[...M];if(!V.length){o("Sélectionne au moins un exemplaire","warning");return}const X=parseInt((D=document.getElementById("sell-market-price"))==null?void 0:D.value);if(!X||X<1){o("Prix invalide","error");return}const{error:P}=await w.from("cards").update({is_for_sale:!0,sale_price:X}).in("id",V);if(P){o(P.message,"error");return}const z=V.map(Y=>({seller_id:a.profile.id,card_id:Y,price:X,status:"active"})),{error:C}=await w.from("market_listings").insert(z);C&&console.warn("[Market] insert listings:",C.message),o(`${V.length} carte${V.length>1?"s":""} mise${V.length>1?"s":""} en vente à ${X.toLocaleString("fr")} cr. chacune !`,"success"),s(),l("collection")}),(Le=document.getElementById("cancel-sell-btn"))==null||Le.addEventListener("click",async()=>{await w.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await w.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),l("collection")})}const Gt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function ti(e,t){const{state:i,navigate:n,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await w.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const r=prompt("Nom du deck :",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!r)return;const{data:s,error:l}=await w.from("decks").insert({owner_id:i.profile.id,name:r}).select().single();if(l){a(l.message,"error");return}a("Deck créé !","success"),Fi(s.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(r=>{r.addEventListener("click",()=>Fi(r.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(r=>{r.addEventListener("click",async()=>{const s=prompt("Nouveau nom :",r.dataset.name);if(!s||s===r.dataset.name)return;const{error:l}=await w.from("decks").update({name:s}).eq("id",r.dataset.rename);if(l){a(l.message,"error");return}a("Deck renommé !","success"),ti(e,t)})}),e.querySelectorAll("[data-delete]").forEach(r=>{r.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${r.dataset.name}" ? Cette action est irréversible.`))return;await w.from("deck_cards").delete().eq("deck_id",r.dataset.delete);const{error:s}=await w.from("decks").delete().eq("id",r.dataset.delete);if(s){a(s.message,"error");return}a("Deck supprimé.","success"),ti(e,t)})})}async function Fi(e,t,i){const{state:n,toast:a}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await w.from("decks").select("*").eq("id",e).single(),{data:r}=await w.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
  ...
  </div>`;const d=window.innerWidth>=900,u=e.querySelector(".deck-pc-layout"),g=e.querySelector(".deck-mobile-layout");u&&(u.style.display=d?"block":"none"),g&&(g.style.display=d?"none":"block"),Zn(e,t,a,i),e.querySelectorAll("#builder-back").forEach(x=>x.addEventListener("click",()=>n("decks")));const m=()=>{const{openModal:x,closeModal:b}=i,v=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;x("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const $=Gi(t.formation),y={};$.forEach(B=>{t.slots[B]&&(y[B]=t.slots[B])}),t.slots=y,b(),tt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(x=>x.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(x=>x.addEventListener("click",()=>eo(t,e,i))),e.querySelectorAll("#save-deck").forEach(x=>x.addEventListener("click",()=>no(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(x=>{x.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==x.dataset.removeSub),tt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(x=>x.addEventListener("click",()=>io(t,e,i)))}function Zn(e,t,i,n){var h,$;const a=window.innerWidth>=900,o=e.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const r=(h=t.stadiumCards)==null?void 0:h.find(y=>y.id===t.stadiumCardId),s=r&&(($=t.stadDefMap)==null?void 0:$[r.stadium_id])||null,l=St[t.formation]||{},c=Hi(t.formation)||[],d={};for(const y of i){const B=t.slots[y],E=B?t.playerCards.find(F=>F.id===B):null;E!=null&&E.player?d[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:d[y]=null}const u=window.innerWidth>=900,g=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(g,860):g,f=Math.round(u?m*.82:m*.85),p=u?84:44;let x="";for(const[y,B]of c){const E=l[y],F=l[B];if(!E||!F)continue;const R=E.x*m,ie=Math.round(.03*f+E.y*.85*f),ee=F.x*m,J=Math.round(.03*f+F.y*.85*f),S=d[y],_=d[B],M=At(S,_);M==="#ff3333"||M==="#cc2222"?x+=`<line x1="${R.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${J.toFixed(1)}" stroke="${M}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${R.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${J.toFixed(1)}" stroke="${M}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${R.toFixed(1)}" y1="${ie.toFixed(1)}" x2="${ee.toFixed(1)}" y2="${J.toFixed(1)}" stroke="${M}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const v=Math.round(p*657/507);for(const y of i){const B=l[y];if(!B)continue;const E=d[y],F=B.x*m;B.y*f;const R=Math.round(.03*f+B.y*(.85*f)),ie=Math.round(F-p/2),ee=Math.round(R-v/2);if(E){const J=y.replace(/\d+/,""),S=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),_=Ie({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:J});b+=`<div style="position:absolute;left:${ie}px;top:${ee}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
        <div style="position:relative">${S?'<div style="position:absolute;top:-18px;left:0;right:0;text-align:center;font-size:14px;z-index:5;line-height:1">🏟️</div>':""}${_}</div>
      </div>`}else{const J=y.replace(/\d+/,"");b+=`<div style="position:absolute;left:${ie}px;top:${ee}px;width:${p}px;height:${v}px;
    ...
    <div style="position:relative;width:${m}px;height:${f}px;margin:0 auto">
      ...
      ${b}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(y=>{y.addEventListener("click",()=>to(y.dataset.pos,t,e,n))})}function eo(e,t,i){var r;const{openModal:n,closeModal:a}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
  ...
  `,document.body.appendChild(a);let o=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function d(_){o||(l=!0,s.style.opacity="1",u(_))}function u(_){if(!l||o)return;const M=r.getBoundingClientRect(),H=c(_)-M.left,le=Math.max(0,Math.min(1,H/M.width));s.style.width=le*M.width+"px",le>=.82&&m()}function g(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var M;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(M=document.getElementById("cut-flash"))==null||M.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}r.addEventListener("pointerdown",d),window.addEventListener("pointermove",u),window.addEventListener("pointerup",g),r.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",g);let f=0,p=!1;const x=new Set;function b(_){f=_,document.getElementById("reveal-phase").style.display="flex",v(),h(_,0),F()}function v(){const _=document.getElementById("card-dots");_&&(_.innerHTML=e.map((M,H)=>`<div class="card-dot" data-i="${H}" style="width:8px;height:8px;border-radius:50%;background:${H===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(M=>M.addEventListener("click",()=>y(parseInt(M.dataset.i)))))}function h(_,M){var P,z;const H=e[_],le=document.getElementById("card-counter"),se=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${e.length}`);const ce=document.getElementById("reveal-btns");ce&&(ce.style.display=_===e.length-1?"flex":"none");const de=H.card_type==="player"&&((P=H.player)==null?void 0:P.rarity)==="legende",Le=!x.has(_);x.add(_);let V=0;if(H.card_type==="player"&&H.player){const C=H.player,D=C.job||"ATT";V=Number(D==="GK"?C.note_g:D==="DEF"?C.note_d:D==="MIL"?C.note_m:C.note_a)||0}const X=C=>{se.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${de?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${fo(H)}</div>
        ...
        </div>`;const D=document.getElementById("current-card-wrap");M!==0?(D.style.transition="none",D.style.transform=`translateX(${M>0?100:-100}%)`,requestAnimationFrame(()=>{D.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",D.style.transform="translateX(0)"})):D.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),C||de?ie():ee(),v()};Le&&(((z=H.player)==null?void 0:z.rarity)==="legende"||V>=8)&&H.card_type==="player"&&H.player?$(H,()=>X(!0)):X(!1)}function $(_,M){var be;p=!0;const H=_.player,le=`https://flagsapi.com/${H.country_code}/flat/64.png`,se=(be=H.clubs)==null?void 0:be.logo_url,ce=H.face?"/"+H.face.replace(/^public\//,"").replace(/^\//,""):null,de=H.job||"ATT",Le=Number(de==="GK"?H.note_g:de==="DEF"?H.note_d:de==="MIL"?H.note_m:H.note_a)||0,V=_.evolution_bonus||0,X=Le+V,P=H.rarity==="legende",z=X>=18,C=document.getElementById("walkout-overlay"),D=document.getElementById("walkout-stage");if(!C||!D){p=!1,M();return}let Y=null;P&&(Y=new Audio("/sounds/Legendary.mp3"),Y.volume=.8,Y.play().catch(()=>{})),C.style.display="flex";const K=()=>{const me=D.firstElementChild;me&&(me.classList.remove("wo-in"),me.classList.add("wo-out"))},q=1800,O=400;D.innerHTML=`<img class="wo-in" src="${le}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(K,q),setTimeout(()=>{var me;D.innerHTML=se?`<img class="wo-in" src="${se}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((me=H.clubs)==null?void 0:me.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},q+O),setTimeout(K,q*2+O),setTimeout(()=>{D.innerHTML=ce?`<img class="wo-in" src="${ce}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(q+O)*2),setTimeout(K,(q+O)*2+q);const _e=z?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[de]||"#fff";setTimeout(()=>{D.innerHTML=`<div class="wo-in" style="
        font-size:${z?"120px":"90px"};font-weight:900;color:${_e};
        ...
        ${X}
      </div>`,z&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(q+O)*3),setTimeout(K,(q+O)*3+q),setTimeout(()=>{C.style.display="none",D.innerHTML="",p=!1,Y&&!P&&Y.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),M()},(q+O)*4)}function y(_){if(p||_<0||_>=e.length||_===f)return;const M=_>f?1:-1;f=_,h(_,M)}function B(){y(f+1)}function E(){y(f-1)}function F(){const _=document.getElementById("card-viewport");if(!_||_._swipeBound)return;_._swipeBound=!0;let M=0,H=0,le=0,se=!1;const ce=P=>P.touches?P.touches[0].clientX:P.clientX,de=P=>P.touches?P.touches[0].clientY:P.clientY,Le=P=>{se=!0,M=ce(P),H=de(P),le=0},V=P=>{if(!se)return;le=ce(P)-M;const z=de(P)-H;if(Math.abs(le)<Math.abs(z))return;const C=document.getElementById("current-card-wrap");C&&(C.style.transition="none",C.style.transform=`translateX(${le*.6}px) rotate(${le*.02}deg)`)},X=()=>{if(!se)return;se=!1;const P=document.getElementById("current-card-wrap"),z=55;le<=-z&&f<e.length-1?B():le>=z&&f>0?E():P&&(P.style.transition="transform .2s ease",P.style.transform="translateX(0)")};_.addEventListener("pointerdown",Le),_.addEventListener("pointermove",V),_.addEventListener("pointerup",X),_.addEventListener("pointercancel",X),_.addEventListener("touchstart",Le,{passive:!0}),_.addEventListener("touchmove",V,{passive:!0}),_.addEventListener("touchend",X),_.addEventListener("click",P=>{if(Math.abs(le)>8)return;const z=_.getBoundingClientRect();P.clientX-z.left>z.width/2?B():E()})}let R=null;function ie(){const _=document.getElementById("fireworks-canvas");if(!_)return;_.width=window.innerWidth,_.height=window.innerHeight;const M=_.getContext("2d"),H=[];function le(){const ce=Math.random()*_.width,de=Math.random()*_.height*.6,Le=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],V=Le[Math.floor(Math.random()*Le.length)];for(let X=0;X<60;X++){const P=Math.PI*2/60*X,z=2+Math.random()*5;H.push({x:ce,y:de,vx:Math.cos(P)*z,vy:Math.sin(P)*z,alpha:1,color:V,size:2+Math.random()*3})}}le(),R=setInterval(le,600);function se(){if(document.getElementById("fireworks-canvas")){M.clearRect(0,0,_.width,_.height);for(let ce=H.length-1;ce>=0;ce--){const de=H[ce];if(de.x+=de.vx,de.y+=de.vy+.08,de.vy*=.98,de.alpha-=.018,de.alpha<=0){H.splice(ce,1);continue}M.globalAlpha=de.alpha,M.fillStyle=de.color,M.beginPath(),M.arc(de.x,de.y,de.size,0,Math.PI*2),M.fill()}M.globalAlpha=1,(R!==null||H.length>0)&&requestAnimationFrame(se)}}se()}function ee(){R!==null&&(clearInterval(R),R=null);const _=document.getElementById("fireworks-canvas");_&&_.getContext("2d").clearRect(0,0,_.width,_.height)}if(n){const _=document.getElementById("reveal-btns");_&&(_.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(S=document.getElementById("reveal-next"))==null||S.addEventListener("click",()=>{ee(),a.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ee(),a.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ee(),a.remove(),i("boosters")})}function fo(e){var t,i,n,a;if(e.card_type==="player"&&e.player)return so(e);if(e.card_type==="game_changer"){const o=e._gcDef,r=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},l={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,d=l[o==null?void 0:o.color]||l.purple,u=(o==null?void 0:o.name)||e.gc_type||"Game Changer",g=(o==null?void 0:o.effect)||((t=ii[e.gc_type])==null?void 0:t.desc)||"",m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,f=((i=ii[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${d};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${d}88;flex-shrink:0">
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",r=>{r.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}mo()}function mo(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const d=async()=>{await w.from("users").update({pending_boosters:r}).eq("id",t.user.id)};async function u(){var v;if(c>=l||!r.length){await w.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",t.user.id),a&&await a(),n("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const f=r[0],{data:p}=await w.from("users").select("*").eq("id",t.user.id).single();p&&(t.profile=p);let x=[];try{if(f.type==="formation")x=await on(t.profile,0);else if(f.type==="game_changer")x=await nn(t.profile,f.count||3,0);else if(s&&((v=s.rates)!=null&&v.length)){const h={...s,cost:0,cardCount:f.count||s.cardCount||5};x=await ni(t.profile,h),f.guaranteeGK&&!t.profile.first_booster_opened&&(x.some(y=>y.player&&y.player.job==="GK")||await bo(t.profile,x),await w.from("users").update({first_booster_opened:!0}).eq("id",t.profile.id))}else x=await tn(t.profile,f.count||5,0)}catch(h){n(h.message||"Erreur ouverture booster","error");return}r.shift(),c++,await d();const b=f.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:f.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${c}/${l})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};rn(x,b,i,()=>{u()})}(m=document.getElementById("onboard-start"))==null||m.addEventListener("click",()=>u())}async function bo(e,t){try{const{data:i}=await w.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const n=i[Math.floor(Math.random()*i.length)],a=t.findIndex(r=>r.player);if(a===-1)return;const o=t[a];await w.from("cards").update({player_id:n.id}).eq("id",o.id),t[a]={...o,player_id:n.id,player:n}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const bt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},ho={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function at(e,t,i,n,a){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",a)}function It(e){if(e!=null&&e.face){const n=(typeof import.meta<"u"?"/":null)||"/",a=e.face.replace(/^public\//,"").replace(/^\//,"");return n+a}const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function oi(e,t){var o,r;const i=e.player,n=e.evolution_bonus||0,a=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?n:0)+(i.job2==="GK"&&a>0?n:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?n:0)+(i.job2==="DEF"&&a>0?n:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?n:0)+(i.job2==="MIL"&&a>0?n:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?n:0)+(i.job2==="ATT"&&a>0?n:0),evolution_bonus:n,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((o=i.clubs)==null?void 0:o.encoded_name)||null,clubLogo:((r=i.clubs)==null?void 0:r.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Mt(e,t){if(!t||!e)return e;const{club_id:i,country_code:n}=t;return Object.values(e).forEach(a=>{Array.isArray(a)&&a.forEach(o=>{const r=i&&String(o.club_id)===String(i),s=n&&String(o.country_code)===String(n);(r||s)&&(o.stadiumBonus=!0)})}),e}function Pt(e,t){if(!t||!(e!=null&&e.length))return e;const{club_id:i,country_code:n}=t;return e.forEach(a=>{if(!a)return;const o=i&&String(a.club_id)===String(i),r=n&&String(a.country_code)===String(n);(o||r)&&(a.stadiumBonus=!0)}),e}function ht(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function an(){const e=Math.random()*100;return e<10?3:e<30?2:1}function Rt(e,t){const i=bt[t]||bt["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(r=>r.position)){for(const r of["GK","DEF","MIL","ATT"]){const s=e.filter(c=>c.position&&c.position.replace(/\d+$/,"")===r).sort((c,d)=>parseInt(c.position.replace(/\D+/g,""),10)-parseInt(d.position.replace(/\D+/g,""),10)).map(c=>({...c,_line:r})),l=ht(s.length);s.forEach((c,d)=>{c._col=l[d]}),n[r]=s}return n}const o=[...e];for(const r of["GK","DEF","MIL","ATT"]){const s=[];for(let c=0;c<i[r];c++){let d=o.findIndex(u=>u.job===r);if(d===-1&&(d=o.findIndex(u=>u.job2===r)),d===-1&&(d=0),o[d]){const u={...o[d],_line:r};s.push(u),o.splice(d,1)}}const l=ht(s.length);s.forEach((c,d)=>{c._col=l[d]}),n[r]=s}return n}function He(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function Pe(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function yi(e,t,i){const a=new Set,o=t.filter(d=>{const u=d.gc_type||d.id;return a.has(u)?!1:(a.add(u),!0)});let r=[];function s(d,u){const g=d._gcDef,m={purple:"linear-gradient(135deg,#3d0a7a,#7a28b8)",light_blue:"linear-gradient(135deg,#006080,#00bcd4)"},f={purple:"#9b59b6",light_blue:"#00bcd4"},p=m[g==null?void 0:g.color]||m.purple,x=f[g==null?void 0:g.color]||f.purple;return`<div class="gc-select-card" data-id="${d.id}"
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),l=[...new Set((s||[]).filter(g=>{var m,f;return((m=g.card)==null?void 0:m.card_type)==="stadium"&&((f=g.card)==null?void 0:f.stadium_id)}).map(g=>g.card.stadium_id))],c={};if(l.length){const{data:g}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",l);(g||[]).forEach(m=>{c[m.id]=m}),(s||[]).forEach(m=>{var f,p;((f=m.card)==null?void 0:f.card_type)==="stadium"&&((p=m.card)!=null&&p.stadium_id)&&(m.card._stadiumDef=c[m.card.stadium_id]||null)})}let d=0;function u(){var y,B,E,F,R,ie,ee;const g=o[d],m=(s||[]).filter(J=>J.deck_id===g.id),f=m.filter(J=>{var S;return J.is_starter&&((S=J.card)==null?void 0:S.player)}).map(J=>oi(J.card,J.position)),p=m.find(J=>{var S;return((S=J.card)==null?void 0:S.card_type)==="formation"}),x=g.formation||((y=p==null?void 0:p.card)==null?void 0:y.formation)||"4-4-2";let b=f.length>=11?Rt(f,x):null,v=((B=g.stadium_card)==null?void 0:B.stadium_def)||null;v&&b&&(b=Mt(b,v));const h=f.length>=11;He(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <!-- Pagination -->
      ${o.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${o.map((J,S)=>`<div style="width:6px;height:6px;border-radius:50%;background:${S===d?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function J(){const S=e.querySelector(".deck-preview-wrap"),_=e.querySelector("#deck-swipe-zone");if(!S||!_||!b)return;const M=_.clientWidth>=900,H=Math.max(200,_.clientHeight-(M?60:40)),se=Math.max(200,_.clientWidth-16),ce=M?Math.min(117,Math.max(52,Math.round(se*.22))):Math.max(44,Math.round(se*.168));if(H<220||se<220){requestAnimationFrame(J);return}const de=M?null:Math.round(ce*.55);S.innerHTML=vt(b,x,null,[],se,H,[],de),S.style.cssText=`width:${se}px;height:${H}px;overflow:hidden;margin:${M?0:60}px auto 0`;const Le=S.querySelector("svg");Le&&(Le.style.cssText="display:block;width:100%;height:100%",Le.setAttribute("preserveAspectRatio",M?"xMidYMid meet":"none"))})),(F=document.getElementById("prev-deck"))==null||F.addEventListener("click",()=>{d>0&&(d--,u())}),(R=document.getElementById("next-deck"))==null||R.addEventListener("click",()=>{d<o.length-1&&(d++,u())}),(ie=document.getElementById("validate-deck"))==null||ie.addEventListener("click",()=>{if(!h)return;const J=t.state.params||{};t.navigate("match",{...J,matchMode:J.matchMode||i,deckId:g.id})}),(ee=document.getElementById("cancel-deck-select"))==null||ee.addEventListener("click",()=>{Pe(e),a("home")});const $=document.getElementById("deck-swipe-zone");if($){let J=0,S=0;$.addEventListener("touchstart",_=>{J=_.touches[0].clientX,S=_.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",_=>{const M=_.changedTouches[0].clientX-J,H=_.changedTouches[0].clientY-S;Math.abs(M)<40||Math.abs(M)<Math.abs(H)||(M<0&&d<o.length-1?(d++,u()):M>0&&d>0&&(d--,u()))},{passive:!0})}}u()}function Ze(e,t=44,i=58,n=null){return Ie(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function gt(e,t,i){if(!(e!=null&&e.length))return"";const n=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((o,r)=>{const s=o._line||o.job||"MIL";if(a+=Ie(o,{width:40,role:s,extraNote:o.boost||0}),r<n.length-1){const l=At(o,n[r+1]);a+=`<div style="width:7px;height:3px;background:${l==="#ff3333"||l==="#cc2222"?"rgba(255,255,255,0.12)":l};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Ut(e,t,i,n,a=310,o=310,r=[],s=null){const l=St[t]||{},c=Hi(t)||ci[t]||[],d={},u=["ATT","MIL","DEF","GK"];for(const b of u)(e[b]||[]).forEach((h,$)=>{d[`${b}${$+1}`]=h});function g(b){const v=l[b];return v?{x:v.x*a,y:v.y*o}:null}let m="";for(const[b,v]of c){const h=g(b),$=g(v);if(!h||!$)continue;const y=d[b],B=d[v],E=At(y,B);E==="#00ff88"||E==="#FFD700"?(m+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
    ...
    </div>`}function dn(e){var o,r,s;if(!e)return"";const t=l=>l?Ie({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,a.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.3s",setTimeout(()=>a.remove(),300)},i)}function ln(e,t){const i=De(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function Xe(e,t){return e.reduce((i,n)=>i+ln(n,t),0)}function Je(e){let t=0;for(let i=0;i<e.length-1;i++){const n=At(e[i],e[i+1]);n==="#00ff88"?t+=2:n==="#FFD700"&&(t+=1)}return t}function Nt(e,t,i,n,a){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,r)=>{const s=r<e.length-1?At(o,e[r+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+2":s==="#FFD700"?"+1":"";return ln(o,a),o.stadiumBonus||a&&(a.club_id&&String(o.club_id)===String(a.club_id)||a.country_code&&(o.country_code,a.country_code)),`
      ...
      <div class="duel-score-line duel-score-line-${n}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${Xe(e,a)} + ${Je(e)} liens = <b style="color:#fff">${Xe(e,a)+Je(e)}</b>
      </div>
    </div>`}async function $o(e,t){const{state:i}=t,a=(i.params||{}).matchMode||"vs_ai_easy",o=a.replace("vs_ai_",""),r=a;await jt(e,t,a,async({deckId:s,formation:l,starters:c,subsRaw:d,gcCardsEnriched:u,gcDefs:g,stadiumDef:m})=>{try{let f=Rt(c,l);m&&(f=Mt(f,m),Pt(d,m));const p=await Eo(l,o),x=p.lines||p,b=async v=>{try{const{data:h,error:$}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:s,status:"in_progress"}).select().single();if($){console.error("[MatchIA] Erreur création match:",$),at(e,"⚠️","Impossible de créer le match ("+$.message+").","Retour",()=>t.navigate("home"));return}const y=p.stadiumDef||null;y&&x&&(Mt(x,y),Pt(p.subs||[],y));const B={gcDefs:g||[],matchId:h==null?void 0:h.id,mode:r,difficulty:o,formation:l,homeTeam:f,aiTeam:x,homeSubs:d,subsUsed:0,maxSubs:Math.min(d.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:y,homeScore:0,aiScore:0,gcCards:v,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};To(e,B,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),at(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!u.length){b([]);return}yi(e,u,b)}catch(f){console.error("[MatchIA] Exception setup:",f),at(e,"⚠️","Erreur de préparation du match : "+f.message,"Retour",()=>t.navigate("home"))}})}async function Eo(e,t){var x;const{data:i}=await w.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Lo(e),subs:[],gcCards:[],stadiumDef:null};const n=bt[e]||bt["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function r(b,v,h){var $,y;return o.add(b.id),{cardId:"ai-"+b.id+"-"+h,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:(($=b.clubs)==null?void 0:$.encoded_name)||null,clubLogo:((y=b.clubs)==null?void 0:y.logo_url)||null,boost:0,used:!1,_line:v}}for(const b of["GK","DEF","MIL","ATT"]){const v=i.filter(E=>E.job===b&&!o.has(E.id)),h=i.filter(E=>E.job!==b&&!o.has(E.id)),$=[...v,...h],y=[];for(let E=0;E<n[b];E++){const F=$[E];F&&y.push(r(F,b,E))}const B=ht(y.length);y.forEach((E,F)=>{E._col=B[F]}),a[b]=y}const l=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,v)=>r(b,b.job,100+v)),u=Object.keys(Se).sort(()=>Math.random()-.5).slice(0,3).map((b,v)=>{var h,$;return{id:"ai-gc-"+v,gc_type:b,name:((h=Se[b])==null?void 0:h.name)||b,icon:(($=Se[b])==null?void 0:$.icon)||"⚡"}}),g=Object.values(a).flat(),m={};g.forEach(b=>{b.club_id&&(m[b.club_id]=(m[b.club_id]||0)+1)});const f=(x=Object.entries(m).sort((b,v)=>v[1]-b[1])[0])==null?void 0:x[0];let p=null;if(f){const{data:b}=await w.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",f).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:a,subs:l,gcCards:u,stadiumDef:p}}function Lo(e){const t=bt[e]||bt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const o of["GK","DEF","MIL","ATT"]){const r=[];for(let l=0;l<t[o];l++){const c=3+Math.floor(Math.random()*5);r.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:n[a%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),a++}const s=ht(r.length);r.forEach((l,c)=>{l._col=s[c]}),i[o]=r}return i}function To(e,t,i){var a;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const M=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          </div>`}const _=t.log[t.log.length-1];return _?'<div style="padding:2px 4px">'+dn(_)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const _=window.innerWidth>=700,M=(P,z,C)=>{var xe,je;const D=(t.gcDefs||[]).find(Be=>Be.name===P.gc_type),Y={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[D==null?void 0:D.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",K={purple:"#b06ce0",light_blue:"#00d4ef"}[D==null?void 0:D.color]||"#b06ce0",q=(D==null?void 0:D.name)||P.gc_type,O=(D==null?void 0:D.effect)||((xe=Se[P.gc_type])==null?void 0:xe.desc)||"",we=D!=null&&D.image_url?`/icons/${D.image_url}`:null,_e=((je=Se[P.gc_type])==null?void 0:je.icon)||"⚡",be=Math.round(C*.22),me=Math.round(C*.22),ke=C-be-me,$e=q.length>12?7:9;return`<div class="gc-mini" data-gc-id="${P.id}" data-gc-type="${P.gc_type}"
          style="box-sizing:border-box;width:${z}px;height:${C}px;border-radius:10px;border:2px solid ${K};background:${Y};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${be}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${$e}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${z-6}px">${q}</span>
          ...
          <div style="height:${ke}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${we?`<img src="${we}" style="max-width:${z-10}px;max-height:${ke-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(ke*.55)}px">${_e}</span>`}
          </div>
        ...
        </div>`},H=(P,z)=>{var C;return`<div id="boost-card"
          style="box-sizing:border-box;width:${P}px;height:${z}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(z*.04)}px;text-align:center;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(_=>{var M,H,le;if(_.type==="duel"){const se=_.isGoal,ce=_.homeScored?"#FFD700":se?"#ff6b6b":"rgba(255,255,255,0.3)",de=_.homeScored?"⚽ BUT !":se?"⚽ BUT IA !":(M=_.homePlayers)!=null&&M.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${se?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${ce};margin-bottom:4px">
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${_.outPlayer?Ze({..._.outPlayer,used:!0,_line:_.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${_.inPlayer?Ze({..._.inPlayer,_line:_.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
  ...
  </div>`;function h(){const _=e.querySelector(".match-screen");if(!_)return;const M=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);_.style.bottom="auto",_.style.height=M+"px",_.style.minHeight=M+"px",_.style.maxHeight=M+"px",_.style.overflow="hidden";const H=e.querySelector("#mobile-action-bar"),le=e.querySelector("#mobile-play-area");H&&le&&(le.style.paddingBottom=H.offsetHeight+"px")}if(h(),setTimeout(h,120),setTimeout(h,400),setTimeout(h,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",h),window.visualViewport.addEventListener("scroll",h)),window.addEventListener("resize",h)),function(){const M=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!M)return;const H=M.closest("#match-terrain-wrap");H&&(H.style.cssText="position:relative;width:100%;height:100%;padding:0"),M.removeAttribute("width"),M.removeAttribute("height"),M.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",M.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const _=e.querySelector(".terrain-wrapper svg");if(_){const M=_.closest("#match-terrain-wrap");M&&(M.style.cssText="position:relative;width:100%;height:100%;padding:0"),_.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let _=!1,M=30;const H=()=>document.getElementById("match-timer"),le=()=>{const se=H();if(!se)return;const ce=String(Math.floor(M/60)).padStart(2,"0"),de=String(M%60).padStart(2,"0");se.textContent=` ${ce}:${de}`,se.style.color=_?"#ff2222":"#ff9500",se.style.fontWeight="900"};le(),t._timerInt=setInterval(()=>{if(M--,M<0)if(!_)_=!0,M=15,le();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const se=document.createElement("div");se.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",se.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(se),setTimeout(()=>{se.remove(),xt(e,t,i)},2500)}else le()},1e3)}(y=document.getElementById("match-quit"))==null||y.addEventListener("click",()=>{Pe(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,xt(e,t,i))}),(B=document.getElementById("view-ai"))==null||B.addEventListener("click",()=>Go(t,i)),(E=document.getElementById("toggle-history"))==null||E.addEventListener("click",()=>{var _;(_=document.getElementById("match-history-panel"))==null||_.classList.add("open")}),(F=document.getElementById("close-history"))==null||F.addEventListener("click",()=>{var _;(_=document.getElementById("match-history-panel"))==null||_.classList.remove("open")}),(R=document.getElementById("btn-action"))==null||R.addEventListener("click",()=>{t.selected.length!==0&&(u?Mo(e,t,i):g&&So(e,t,i))}),(ie=document.getElementById("btn-results"))==null||ie.addEventListener("click",()=>xt(e,t,i)),(ee=document.getElementById("btn-pass"))==null||ee.addEventListener("click",()=>{t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),t.phase="ai-attack",Ee(e,t,i),setTimeout(()=>hi(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(_=>{_.addEventListener("click",()=>Io(_,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(_=>{_.addEventListener("click",()=>Qt(e,t,i,null,_.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(_=>{_.addEventListener("click",()=>Bo(_.dataset.gcId,_.dataset.gcType,e,t,i))}),(J=document.getElementById("boost-card"))==null||J.addEventListener("click",()=>Fo(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(_=>{_.addEventListener("click",()=>Qt(e,t,i,_.dataset.subId))}),(S=document.getElementById("sub-btn-main"))==null||S.addEventListener("click",()=>Qt(e,t,i))}function Io(e,t,i,n){const a=e.dataset.cardId,o=e.dataset.role,r=t.selected.findIndex(s=>s.cardId===a);if(r!==-1)t.selected.splice(r,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(l=>l.cardId===a);s&&t.selected.push({...s,_role:o,_line:o})}Ee(i,t,n)}function bi(e,t,i){e.matchId&&w.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function Mo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),bi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const r=(t.homeTeam[o._role]||[]).find(l=>l.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...r,_line:o._role,...s?{note_a:Math.max(1,Number(r.note_a)||0)}:{}}}),a=gi(n,t.modifiers.home);t.pendingAttack={...a,players:[...n],side:"home"},t.selected.forEach(o=>{const r=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);r&&(r.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${a.total} (base ${a.base}${a.links?` +${a.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",Ee(e,t,i),setTimeout(()=>Co(e,t,i),1200)}function So(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),bi(t,i,i.state.profile.id);const n=t.stadiumDef||null,a=t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(u=>u.cardId===l.cardId)||l,d=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:l._role,stadiumBonus:d}}),o=mi(a,t.modifiers.home);t.selected.forEach(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId);c&&(c.used=!0)});const r=xi(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>Ge(l)),homePlayers:t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId)||l;return Ge(c)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(r.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(r.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,Ee(e,t,i),et(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{dt(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,dt(e,t,i,"home-attack")}function Ao(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(l=>l.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(l=>!e.aiUsedSubIds.includes(l.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],a=i.find(l=>l.job===n.job)||i[0],o={...a,used:!1,_line:n._line,_col:n._col},r=e.aiTeam[n._line],s=r.findIndex(l=>l.cardId===n.cardId);s!==-1&&(r[s]=o),e.aiUsedSubIds.push(a.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${a.firstname} ${a.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function jo(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(a=>!e.aiUsedGc.includes(a.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),Se[i.gc_type],i.gc_type){case"Boost+2":{const a=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(a.length){const o=a[Math.floor(Math.random()*a.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const a=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(a.length){const o=a[Math.floor(Math.random()*a.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function hi(e,t,i){bi(t,i,null),Ao(t),jo(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(d=>!d.used),a=!1;n.length||(n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[]].filter(d=>!d.used),a=!0);const o=Ji(n,"attack",t.difficulty);if(!o.length){ai(e,t,i);return}a&&o.forEach(d=>{d._line=d._line||d.job,d.note_a=Math.max(1,Number(d.note_a)||0)});const r=gi(o,t.modifiers.ai);t.pendingAttack={...r,players:o,side:"ai"},o.forEach(d=>{d.used=!0}),t.log.push({text:`🤖 IA attaque : ${r.total} (${o.map(d=>d.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(d=>!d.used),c=(t.homeSubs||[]).filter(d=>!(t.usedSubIds||[]).includes(d.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&ri(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,Ot(e,t,i,"ai",o[0]);return}t.aiScore++;const u={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(g=>Ge(g)),aiTotal:r.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(u),t.pendingAttack=null,Ee(e,t,i),et(u.aiPlayers,t.homeScore,t.aiScore,!1,()=>{dt(e,t,i,"home-attack")});return}t.phase="defense",Ee(e,t,i)}function Co(e,t,i){var c,d;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],a=Ji(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(u=>(t.aiTeam[u]||[]).filter(g=>!g.used)).length){const u=((c=t.pendingAttack)==null?void 0:c.players)||[];if(u.length===1&&(u[0]._line==="GK"||u[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,Ot(e,t,i,"home",u[0]);return}t.homeScore++;const m={type:"duel",isGoal:!0,homeScored:!0,homePlayers:u.map(f=>Ge(f)),homeTotal:((d=t.pendingAttack)==null?void 0:d.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(m),t.modifiers.ai={},t.pendingAttack=null,Ee(e,t,i),et(m.homePlayers,t.homeScore,t.aiScore,!0,()=>{dt(e,t,i,"ai-attack")});return}const r=a.length>0?mi(a,t.modifiers.ai).total:0;a.forEach(u=>{u.used=!0});const s=xi(t.pendingAttack.total,r,t.modifiers.ai),l={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(u=>Ge(u)),aiPlayers:a.map(u=>Ge(u)),homeTotal:t.pendingAttack.total,aiTotal:r,isGoal:!1,homeScored:!1,text:""};if(s.shielded)l.text="🛡️ Bouclier IA !",t.log.push(l);else if(s.goal){t.homeScore++,l.isGoal=!0,l.homeScored=!0,l.text=`⚽ BUT ! (${t.pendingAttack.total} > ${r})`,t.log.push(l),t.modifiers.ai={},t.pendingAttack=null,Ee(e,t,i),et(l.homePlayers,t.homeScore,t.aiScore,!0,()=>{dt(e,t,i,"ai-attack")});return}else l.text=`🧤 IA défend (${r} ≥ ${t.pendingAttack.total})`,t.log.push(l);t.modifiers.ai={},t.pendingAttack=null,dt(e,t,i,"ai-attack")}function dt(e,t,i,n){if(t.round++,!cn(e,t,i)){if(vi(t)){xt(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used))){ai(e,t,i);return}t.phase="attack",Ee(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used))){ai(e,t,i);return}t.phase="ai-attack",Ee(e,t,i),setTimeout(()=>hi(e,t,i),800)}}}function ri(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function Pi(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(a=>!a.used));return t&&!i}function cn(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(Pi(t.homeTeam)&&ri(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(a=>!a.used);return n?(n.used=!0,t.homeScore++,Ot(e,t,i,"home",n),!0):!1}if(Pi(t.aiTeam)&&ri(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(a=>!a.used);return n?(n.used=!0,t.aiScore++,Ot(e,t,i,"ai",n),!0):!1}return!1}function Ot(e,t,i,n,a){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ge(a)]:[],aiPlayers:n==="ai"?[Ge(a)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const r=(s,l)=>new Promise(c=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${l};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await r("⚽ DERNIER CORNER","#FFD700"),await r("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,Ee(e,t,i),et([Ge(a)],t.homeScore,t.aiScore,n==="home",()=>{if(vi(t)){xt(e,t,i);return}dt(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function vi(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(a=>!a.used));return!t&&!i}function ai(e,t,i){cn(e,t,i)||(vi(t)?xt(e,t,i):(t.phase="attack",Ee(e,t,i)))}function Qt(e,t,i,n=null,a=null){var m,f;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,x])=>(x||[]).filter(b=>b.used).map(b=>({...b,_line:b._line||p}))),r=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){$t("Aucun joueur utilisé à remplacer");return}if(!r.length){$t("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===a));const l=((m=o[s])==null?void 0:m._line)||((f=o[s])==null?void 0:f.job);let c=n?Math.max(0,r.findIndex(p=>p.cardId===n)):Math.max(0,r.findIndex(p=>p.job===l)),d=!1;const u=document.createElement("div");u.id="sub-overlay",u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function g(){var y,B,E,F,R,ie;const p=o[s],x=r[c],b=Math.min(130,Math.round((window.innerWidth-90)/2)),v=Math.round(b*1.35),h=ee=>`background:rgba(255,255,255,0.12);border:none;color:${ee?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ee?"default":"pointer"};flex-shrink:0`;u.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${x?Ze({...x,used:!1,boost:0},b,v):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?Ze({...p,used:!1,boost:0},b,v):"<div>—</div>"}</div>
    ...
    </div>`,(y=u.querySelector("#sub-close"))==null||y.addEventListener("click",()=>u.remove()),(B=u.querySelector("#out-up"))==null||B.addEventListener("click",()=>{s>0&&(s--,g())}),(E=u.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,g())}),(F=u.querySelector("#in-up"))==null||F.addEventListener("click",()=>{c>0&&(c--,g())}),(R=u.querySelector("#in-down"))==null||R.addEventListener("click",()=>{c<r.length-1&&(c++,g())});const $=(ee,J,S,_)=>{const M=u.querySelector("#"+ee);if(!M)return;let H=0;M.addEventListener("touchstart",le=>{H=le.touches[0].clientY},{passive:!0}),M.addEventListener("touchend",le=>{const se=le.changedTouches[0].clientY-H;if(Math.abs(se)<30)return;const ce=J();se<0&&ce<_-1?(S(ce+1),g()):se>0&&ce>0&&(S(ce-1),g())},{passive:!0})};$("in-panel",()=>c,ee=>c=ee,r.length),$("out-panel",()=>s,ee=>s=ee,o.length),(ie=u.querySelector("#sub-confirm"))==null||ie.addEventListener("click",ee=>{if(ee.preventDefault(),ee.stopPropagation(),d)return;d=!0;const J=o[s],S=r[c];if(!J||!S)return;let _=null,M=-1;for(const[le,se]of Object.entries(t.homeTeam)){const ce=(se||[]).findIndex(de=>de.cardId===J.cardId);if(ce!==-1){_=le,M=ce;break}}if(M===-1||!_){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const H={...S,_line:_,_col:J._col||0,used:!1,boost:0};t.homeTeam[_].splice(M,1,H),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(S.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:J.name,firstname:J.firstname,note:De(J,_),portrait:It(J),job:J.job,country_code:J.country_code,rarity:J.rarity,clubName:J.clubName,clubLogo:J.clubLogo},inPlayer:{name:S.name,firstname:S.firstname,note:De(S,_),portrait:It(S),job:S.job,country_code:S.country_code,rarity:S.rarity,clubName:S.clubName,clubLogo:S.clubLogo},text:`🔄 ${S.firstname} ${S.name} remplace ${J.firstname} ${J.name}`}),u.remove(),ko(J,S,()=>Ee(e,t,i))})}document.body.appendChild(u),g()}function Bo(e,t,i,n,a){var f,p;const o=(n.gcDefs||[]).find(x=>x.name===t),r=Se[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",c=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||r.desc,u=o!=null&&o.image_url?`/icons/${o.image_url}`:null,g=r.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ...
    </div>`,document.body.appendChild(m),(f=m.querySelector("#gc-back"))==null||f.addEventListener("click",()=>m.remove()),(p=m.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{m.remove(),Do(e,t,i,n,a)})}function Dt(e,t,i,n,a,o){const r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function l(){var c,d;r.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(a=>`
        <div class="player-boost-opt" data-card-id="${a.cardId}"
          ...
          <div style="width:32px;height:32px;background:${ho[a.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${De(a,a._line||a.job)}</div>
          <div style="flex:1"><b>${a.firstname} ${a.name}</b><div style="font-size:11px;color:#888">${a._line||a.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.cardId;for(const r of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[r]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Ee(e,t,i)})})}async function xt(e,t,i){var d,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,a=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,r=a?"victoire":o?"nul":"defaite",s=Pn(t.mode,r);t.matchId&&await w.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:a?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};a?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await w.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(d=document.getElementById("res-home"))==null||d.addEventListener("click",()=>{c.remove(),Pe(e),i.navigate("home")}),(u=document.getElementById("res-replay"))==null||u.addEventListener("click",()=>{c.remove(),Pe(e),i.navigate("match",{matchMode:t.mode})})}function Go(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${Ut(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Zt=e=>sn(e);async function wt(e,t,i,n,a={}){return pn(e,t,i,n,a.myGC||[],a.gcDefs||[],a.isRanked||!1,a.rankedData||null,a.stadiumDef||null,a.onMatchEnd||null,a.mlLeagueId||null,a.mlMatchId||null)}async function Po(e,t,i){const{data:n}=await w.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const a=n.home_id===t.state.user.id;return pn(e,t,i,a,[],[],n.is_ranked||!1,null,null,null,null,null)}async function pn(e,t,i,n,a=[],o=[],r=!1,s=null,l=null,c=null,d=null,u=null){const{state:g,navigate:m,toast:f}=t,p=n?"p1":"p2",x=n?"p2":"p1",b=(a||[]).map(k=>k.id),v=(a||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await w.from("matches").select("*").eq("id",i).single();if(!h){f("Match introuvable","error"),m("home");return}async function $(){var ye,ve;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:k,error:L},{data:I,error:j},{data:T},{data:A}]=await Promise.all([w.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),w.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),w.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),w.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",j==null?void 0:j.message,"p1D:",(ye=k==null?void 0:k.starters)==null?void 0:ye.length,"p2D:",(ve=I==null?void 0:I.starters)==null?void 0:ve.length);const G=Z=>{const Te=Number(Z.evolution_bonus)||0;return{cardId:Z.card_id,position:Z.position,id:Z.id,firstname:Z.firstname,name:Z.surname_real,country_code:Z.country_code,club_id:Z.club_id,job:Z.job,job2:Z.job2,note_g:(Number(Z.note_g)||0)+(Z.job==="GK"||Z.job2==="GK"&&Number(Z.note_g)>0?Te:0),note_d:(Number(Z.note_d)||0)+(Z.job==="DEF"||Z.job2==="DEF"&&Number(Z.note_d)>0?Te:0),note_m:(Number(Z.note_m)||0)+(Z.job==="MIL"||Z.job2==="MIL"&&Number(Z.note_m)>0?Te:0),note_a:(Number(Z.note_a)||0)+(Z.job==="ATT"||Z.job2==="ATT"&&Number(Z.note_a)>0?Te:0),evolution_bonus:Te,rarity:Z.rarity,skin:Z.skin,hair:Z.hair,hair_length:Z.hair_length,face:Z.face||null,clubName:Z.club_encoded_name||null,clubLogo:Z.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},N=((k==null?void 0:k.starters)||[]).map(Z=>G(Z)),Q=((I==null?void 0:I.starters)||[]).map(Z=>G(Z)),W=(k==null?void 0:k.formation)||"4-4-2",ne=(I==null?void 0:I.formation)||"4-4-2";let oe=Rt(N,W),U=Rt(Q,ne);const ae=((k==null?void 0:k.subs)||[]).map(Z=>G(Z)),pe=((I==null?void 0:I.subs)||[]).map(Z=>G(Z)),re=(k==null?void 0:k.stadium_def)||(n?l:null),fe=(I==null?void 0:I.stadium_def)||(n?null:l);return re&&(oe=Mt(oe,re),Pt(ae,re)),fe&&(U=Mt(U,fe),Pt(pe,fe)),{p1Team:oe,p2Team:U,p1Subs:ae,p2Subs:pe,p1Formation:W,p2Formation:ne,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(A==null?void 0:A.club_name)||(A==null?void 0:A.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?v:[],gcCardsFull_p2:n?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let y=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!y,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",g.profile.id),!y)if(n){y=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((y==null?void 0:y.p1Team)||{}));const{data:k}=await w.from("matches").select("game_state").eq("id",i).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await w.from("matches").update({game_state:y,turn_user_id:h.home_id}).eq("id",i):y=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let k=0;k<30&&!y;k++){await new Promise(I=>setTimeout(I,400));const{data:L}=await w.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(y=L.game_state),k%5===0&&console.log("[PvP] away - poll",k,"game_state:",!!(L!=null&&L.game_state))}if(!y){f("Erreur de synchronisation","error"),m("home");return}y.gc_p2=b,y.gcCardsFull_p2=v,await w.from("matches").update({game_state:y}).eq("id",i)}let B=!1,E=null,F=!1;const R=new Set,ie=new Set;async function ee(k){var ne,oe;try{w.removeChannel(J)}catch{}const L=y[p+"Score"]||0,I=y[x+"Score"]||0;let j,T;k.winner_id?(j=k.winner_id===g.profile.id,T=!1):k.forfeit?(j=L>I,T=!1):(T=L===I,j=L>I);let A="";if(r&&n)try{const{data:U}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:ae}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(U&&ae){const pe=j?1:T?.5:0,re=1-pe,fe=U.placement_matches<10,ye=ae.placement_matches<10,ve=computeGlicko2(U.mmr,U.mmr_deviation,U.mmr_volatility,ae.mmr,ae.mmr_deviation,pe===1?1:pe===0?0:.5,fe),Z=computeGlicko2(ae.mmr,ae.mmr_deviation,ae.mmr_volatility,U.mmr,U.mmr_deviation,re===1?1:re===0?0:.5,ye);await w.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:j?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:ve.delta,p_away_delta:Z.delta,p_home_new_rd:ve.newRd,p_away_new_rd:Z.newRd,p_home_new_vol:ve.newSigma,p_away_new_vol:Z.newSigma});const Te=ve.delta,Ae=ve.newMmr,Me=getTier(Ae),Fe=Te>=0?"+":"",ct=Te>=0?"#4caf50":"#ff6b6b",Re=getTier(U.mmr);A=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Me.id!==Re.id?`<div style="font-size:20px;font-weight:900;color:${Me.color}">
                    ${Ae>U.mmr?"📈":"📉"} ${Re.emoji} ${Re.label} → ${Me.emoji} ${Me.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ae>U.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Te>=0?"📈":"📉"}</div>
                   <div style="font-size:18px;font-weight:900;color:${Me.color}">${Me.emoji} ${Me.label}</div>`}
              ${fe?`<div style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:6px">Match de placement (${U.placement_matches+1}/10)</div>`:""}
            </div>`}}catch(U){console.error("[Ranked] MMR update error:",U)}(ne=document.getElementById("pvp-end-overlay"))==null||ne.remove();const G=document.createElement("div");G.id="pvp-end-overlay",G.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const N=T?"🤝":j?"🏆":"😞",Q=T?"MATCH NUL":j?"VICTOIRE !":"DÉFAITE",W=T?"#fff":j?"#FFD700":"#ff6b6b";G.innerHTML=`
      <div style="font-size:64px">${N}</div>
      <div style="font-size:26px;font-weight:900;color:${W}">${Q}</div>
      ...
      ${A}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(G),(oe=G.querySelector("#pvp-end-home"))==null||oe.addEventListener("click",()=>{G.remove(),Pe(e),m(r?"ranked":"home")})}const J=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(B)return;B=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),ee(L);return}if(L.game_state){const I=y;y=L.game_state;const j=y._lastGC;if(j&&j.seq&&!ie.has(j.seq)&&(ie.add(j.seq),j.by!==p)){P(j.type,j.by,()=>de());return}const T=I[p+"Score"]||0,A=I[x+"Score"]||0,G=y[p+"Score"]||0,N=y[x+"Score"]||0,Q=G>T,W=N>A;if((Q||W)&&!R.has(y.round)){R.add(y.round);const ne=[...y.log||[]].reverse().find(U=>U.isGoal),oe=((ne==null?void 0:ne.homePlayers)||[]).map(U=>({name:U.name,note:U.note,portrait:U.portrait,job:U.job}));et(oe,G,N,Q,()=>de());return}de()}}catch(I){console.error("[PvP] crash:",I)}}).subscribe();async function S(k){Object.assign(y,k),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{de()}catch(I){console.error("[PvP] renderPvpScreen crash:",I)}}async function _(){if(B)return;B=!0,E&&(clearInterval(E),E=null);const k=n?h.away_id:h.home_id,L=n?"p2":"p1",I=n?"p1":"p2",j={...y,[L+"Score"]:3,[I+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:j.p1Score||0,away_score:j.p2Score||0,game_state:j}).eq("id",i)}catch{}try{w.removeChannel(J)}catch{}setTimeout(()=>{Pe(e),m("home")},800)}const M={BOOST_STAT:({value:k=1,count:L=1,roles:I=[]},j,T)=>{const A=j[p+"Team"],G=Object.entries(A).filter(([N])=>!I.length||I.includes(N)).flatMap(([N,Q])=>Q.filter(W=>!W.used).map(W=>({...W,_line:N})));if(!G.length){j.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(j);return}H(G,L,`Choisir ${L} joueur(s) à booster (+${k})`,N=>{N.forEach(Q=>{const W=(A[Q._line]||[]).find(ne=>ne.cardId===Q.cardId);W&&(W.boost=(W.boost||0)+k,j.log.push({text:`⚡ +${k} sur ${W.name}`,type:"info"}))}),j[p+"Team"]=A,T(j)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:I=[],target:j="ai"},T,A)=>{const G=j==="home"?p:x,N=T[G+"Team"],Q=j==="home"?"allié":"adverse",W=Object.entries(N).filter(([ne])=>!I.length||I.includes(ne)).flatMap(([ne,oe])=>oe.map(U=>({...U,_line:ne})));if(!W.length){T.log.push({text:`🎯 Aucun joueur ${Q}`,type:"info"}),A(T);return}H(W,L,`Choisir ${L} joueur(s) ${Q}(s) (-${k})`,ne=>{ne.forEach(oe=>{const U=(N[oe._line]||[]).find(ae=>ae.cardId===oe.cardId);U&&(U.boost=(U.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${U.name}`,type:"info"}))}),T[G+"Team"]=N,A(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:I="ai"},j,T)=>{const A=I==="home"?p:x,G=j[A+"Team"],N=I==="home"?"allié":"adverse",Q=Object.entries(G).filter(([W])=>!L.length||L.includes(W)).flatMap(([W,ne])=>ne.filter(oe=>!oe.used).map(oe=>({...oe,_line:W})));if(!Q.length){j.log.push({text:`❌ Aucun joueur ${N}`,type:"info"}),T(j);return}H(Q,k,`Choisir ${k} joueur(s) ${N}(s) à exclure`,W=>{const ne="usedCardIds_"+A,oe=new Set(j[ne]||[]);W.forEach(U=>{const ae=(G[U._line]||[]).find(pe=>pe.cardId===U.cardId);ae&&(ae.used=!0,oe.add(U.cardId),j.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),j[ne]=[...oe],j[A+"Team"]=G,T(j)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},I,j)=>{const T=I[p+"Team"],A=Object.entries(T).filter(([G])=>!L.length||L.includes(G)).flatMap(([G,N])=>N.filter(Q=>Q.used).map(Q=>({...Q,_line:G})));if(!A.length){I.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),j(I);return}H(A,k,`Choisir ${k} joueur(s) à ressusciter`,G=>{G.forEach(N=>{const Q=(T[N._line]||[]).find(W=>W.cardId===N.cardId);Q&&(Q.used=!1,I.log.push({text:`💫 ${Q.name} ressuscité !`,type:"info"}))}),I[p+"Team"]=T,j(I)})},REMOVE_GOAL:({},k,L)=>{const I=x+"Score";k[I]>0?(k[I]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[x+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,I)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),I(L)},CUSTOM:({},k,L)=>L(k)};function H(k,L,I,j){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let A=[];function G(){var Q,W;const N=k.map(ne=>{const oe=ne._line||ne.job||"MIL",U=A.find(pe=>pe.cardId===ne.cardId),ae=Ie({...ne,_evolution_bonus:0},{width:90,showStad:!0,role:oe,extraNote:ne.boost||0});return`<div class="pp-item" data-cid="${ne.cardId}"
          style="position:relative;border-radius:8px;${U?"outline:3px solid #FFD700;outline-offset:2px;":""}cursor:pointer;flex-shrink:0;${ne.used?"opacity:0.3;pointer-events:none":""}">
          ${ae}
        ...
        </div>`,(Q=T.querySelector("#pp-close"))==null||Q.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(ne=>{ne.addEventListener("click",()=>{const oe=ne.dataset.cid,U=k.find(pe=>pe.cardId===oe),ae=A.findIndex(pe=>pe.cardId===oe);U&&(ae>-1?A.splice(ae,1):A.length<L&&A.push(U),G())})}),(W=T.querySelector("#pp-confirm"))==null||W.addEventListener("click",()=>{T.remove(),j(A)})}G(),document.body.appendChild(T)}async function le(k,L){const j=(y["gcCardsFull_"+p]||[]).find(N=>N.id===k),T=(j==null?void 0:j._gcDef)||(y.gcDefs||[]).find(N=>{var Q;return N.name===L||((Q=N.name)==null?void 0:Q.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),A=[...y["usedGc_"+p]||[],k],G={type:L,by:p,seq:(y._gcAnimSeq||0)+1};ie.add(G.seq),P(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const Q=M[T.effect_type];if(Q){const W={...y};Q(T.effect_params||{},W,async ne=>{ne["usedGc_"+p]=A,ne._lastGC=G,ne._gcAnimSeq=G.seq,await S(ne)});return}}const N={...y};switch(L){case"Remplacement+":N.maxSubs=(N.maxSubs||3)+1,N.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const Q=x+"Score";N[Q]>0&&(N[Q]--,N.log.push({text:"🚫 But annulé",type:"info"}));break}}N["usedGc_"+p]=A,N._lastGC=G,N._gcAnimSeq=G.seq,await S(N)})}function se(k,L){const I="usedCardIds_"+k,j=new Set(y[I]||[]);L.forEach(T=>j.add(T)),y[I]=[...j]}function ce(){for(const k of["p1","p2"]){const L=new Set(y["usedCardIds_"+k]||[]),I=y[k+"Team"];if(I)for(const j of["GK","DEF","MIL","ATT"])(I[j]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function de(){var nt,Ve,Ye,ot,ki,$i;if(y.phase==="reveal")return Le();if(y.phase==="midfield")return X();if(y.phase==="finished")return Ue();const k=y[p+"Team"];y[x+"Team"],ce();const L=y[p+"Score"],I=y[x+"Score"],j=y[p+"Name"],T=y[x+"Name"],A=y.phase===p+"-attack",G=y.phase===p+"-defense",N=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],Q=N.map(te=>te.cardId),W=window.innerWidth>=700,ne=y[p+"Subs"]||[],oe=y["usedSubIds_"+p]||[],U=ne.filter(te=>!oe.includes(te.cardId)),ae=y["gcCardsFull_"+p]||[],pe=y["usedGc_"+p]||[],re=ae.filter(te=>!pe.includes(te.id)),fe=y.boostOwner===p&&!y.boostUsed,ye=[...k.MIL||[],...k.ATT||[]].filter(te=>!te.used),ve=A&&ye.length===0?[...k.GK||[],...k.DEF||[]].filter(te=>!te.used).map(te=>te.cardId):[];function Z(te,ue,ze){var zi,Ii;const ge=te._gcDef,rt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ge==null?void 0:ge.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",pt={purple:"#b06ce0",light_blue:"#00d4ef"}[ge==null?void 0:ge.color]||"#b06ce0",_t=(ge==null?void 0:ge.name)||te.gc_type,kt=(ge==null?void 0:ge.effect)||((zi=Se[te.gc_type])==null?void 0:zi.desc)||"",Ei=ge!=null&&ge.image_url?`/icons/${ge.image_url}`:null,bn=((Ii=Se[te.gc_type])==null?void 0:Ii.icon)||"⚡",Li=Math.round(ze*.22),Ti=Math.round(ze*.22),Vt=ze-Li-Ti,hn=_t.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${te.id}" data-gc-type="${te.gc_type}"
        style="box-sizing:border-box;width:${ue}px;height:${ze}px;border-radius:10px;border:2px solid ${pt};background:${rt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        <div style="height:${Li}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${hn}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ue-6}px">${_t}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
        <div style="height:${Vt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Ei?`<img src="${Ei}" style="max-width:${ue-10}px;max-height:${Vt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(Vt*.55)}px">${bn}</span>`}
        </div>
      ...
      </div>`}function Te(te,ue){return`<div id="pvp-boost-card"
        ...
        <div style="font-size:${Math.round(ue*.09)}px;color:#000;font-weight:900">+${y.boostValue}</div>
      </div>`}const Ae=(te,ue)=>ue?Te(130,175):Z(te,130,175),Me=(te,ue)=>ue?Te(68,95):Z(te,68,95),Fe=W?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ct=A?$e(p)?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${N.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Fe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:G?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${N.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${T}</div>`,Re=A&&!$e(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':A||G?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${N.length}/3 sélectionné(s)</div>`:"",Ct=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${W?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${U.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':U.map(te=>`<div class="pvp-sub-btn" data-sub-id="${te.cardId}" style="cursor:pointer;flex-shrink:0">${Ze(te,W?76:44,W?100:58)}</div>`).join("")}
    </div>`,Ce=A?"attack":G?"defense":"idle",Ne=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${vt(k,y[p+"Formation"],Ce,Q,W?1300:st(),W?600:mt(),ve)}
      </div>
    </div>`,Oe=(()=>{var ue,ze;if(G&&((ue=y.pendingAttack)!=null&&ue.players)){const ge=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${gt((ge.players||[]).map(rt=>({...rt,used:!1})),"#ff6b6b",ge.total)}</div>
        </div>`}if(A&&((ze=y.pendingAttack)!=null&&ze.players)){const ge=y.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${gt((ge.players||[]).map(rt=>({...rt,used:!1})),"#00ff88",ge.total)}</div>
        </div>`}const te=(y.log||[]).slice(-1)[0];return te?'<div style="padding:2px 4px">'+dn(te)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),Ke=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
        <button id="pvp-quit" style="width:34px;height:34px;border-radius:50%;background:rgba(220,50,50,0.7);border:none;color:#fff;font-size:16px;cursor:pointer;flex-shrink:0">✕</button>
        <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px">
          <span style="font-size:13px;font-weight:700;color:rgba(255,255,255,0.9);max-width:90px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${j}</span>
      ...
      </button>`;He(e),e.style.overflow="hidden",W?e.innerHTML=`
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ${Ke}
        <div style="display:flex;flex:1;min-height:0;overflow:hidden">
          ${Ct}
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${vt(k,y[p+"Formation"],Ce,Q,st(),mt(),ve)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
          <div style="display:flex;gap:6px;overflow-x:auto;align-items:flex-end;min-height:96px;padding-bottom:2px">
            ${re.map(te=>Me(te,!1)).join("")}
            ${fe?Me(null,!0):""}
            <div id="pvp-sub-open" style="cursor:${A&&U.length>0?"pointer":"default"};flex-shrink:0;box-sizing:border-box;width:68px;height:95px;border-radius:10px;border:2px solid ${A&&U.length>0?"rgba(255,255,255,0.5)":"rgba(255,255,255,0.15)"};background:${A&&U.length>0?"rgba(60,60,60,0.9)":"rgba(40,40,40,0.5)"};display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;opacity:${A&&U.length>0?1:.4}">
              <div style="display:flex;gap:6px;align-items:center">
                <div style="text-align:center">
                  <div style="font-size:7px;color:#00ff88;font-weight:700;letter-spacing:1px">IN</div>
      ...
      </div>`;function qe(){const te=e.querySelector(".match-screen");if(!te)return;const ue=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);te.style.height=ue+"px",te.style.minHeight=ue+"px",te.style.maxHeight=ue+"px",te.style.overflow="hidden";const ze=e.querySelector("#mobile-action-bar"),ge=e.querySelector("#mobile-play-area");ze&&ge&&(ge.style.paddingBottom=ze.offsetHeight+"px")}if(qe(),setTimeout(qe,120),setTimeout(qe,400),F||(F=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",qe),window.visualViewport.addEventListener("scroll",qe)),window.addEventListener("resize",qe)),function(){const ue=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ue)return;const ze=ue.closest("#match-terrain-wrap");ze&&(ze.style.cssText="position:relative;width:100%;height:100%;padding:0"),ue.removeAttribute("width"),ue.removeAttribute("height"),ue.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ue.setAttribute("preserveAspectRatio","xMidYMid meet")}(),y._pvpResizeBound||(y._pvpResizeBound=!0,window.addEventListener("resize",()=>{const te=e.querySelector(".terrain-wrapper svg");if(te){const ue=te.closest("#match-terrain-wrap");ue&&(ue.style.cssText="position:relative;width:100%;height:100%;padding:0"),te.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(te=>{te.addEventListener("click",()=>{if(!A&&!G)return;const ue=te.dataset.cardId,ze=te.dataset.role,ge=(k[ze]||[]).find(kt=>kt.cardId===ue);if(!ge||ge.used)return;const rt=ve.includes(ue);if(A&&!["MIL","ATT"].includes(ze)&&!rt)return;Array.isArray(y["selected_"+p])||(y["selected_"+p]=[]);const pt=y["selected_"+p],_t=pt.findIndex(kt=>kt.cardId===ue);_t>-1?pt.splice(_t,1):pt.length<3&&pt.push({...ge,_role:ze}),de()})}),e.querySelectorAll(".match-used-hit").forEach(te=>{te.addEventListener("click",()=>D(te.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(te=>{te.addEventListener("click",()=>D())}),(nt=e.querySelector("#pvp-sub-open"))==null||nt.addEventListener("click",()=>D()),e.querySelectorAll(".pvp-gc-mini").forEach(te=>{te.addEventListener("click",()=>z(te.dataset.gcId,te.dataset.gcType))}),(Ve=e.querySelector("#pvp-boost-card"))==null||Ve.addEventListener("click",()=>C()),(Ye=e.querySelector("#pvp-action"))==null||Ye.addEventListener("click",te=>{A?te.currentTarget.dataset.pass==="1"||!$e(p)?O():we():G&&_e()}),(ot=e.querySelector("#pvp-quit"))==null||ot.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&_()}),(ki=e.querySelector("#pvp-view-opp"))==null||ki.addEventListener("click",()=>K()),($i=e.querySelector("#pvp-toggle-history"))==null||$i.addEventListener("click",()=>q()),E&&(clearInterval(E),E=null),(A||G)&&!B){let te=30,ue=!1;const ze=()=>document.getElementById("pvp-timer"),ge=()=>{ze()&&(ze().textContent=te+"s",ze().style.color=ue?"#ff4444":"#fff")};ge(),E=setInterval(()=>{te--,te<0?ue?(clearInterval(E),E=null,A&&!$e(p)?O():_()):(ue=!0,te=15,ge()):ge()},1e3)}}function Le(){He(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    </div>`;const A=(ae,pe)=>e.querySelectorAll(ae).forEach((re,fe)=>{setTimeout(()=>{re.style.opacity="1",re.style.transform="translateY(0) scale(1)"},pe+fe*90)});A(".duel-card-me",150),A(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((ae,pe)=>setTimeout(()=>{ae.style.opacity="1"},pe*70)),900),setTimeout(()=>{const ae=e.querySelector("#pvp-vs");ae&&(ae.style.opacity="1",ae.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(pe=>pe.style.opacity="1")},1250);function G(ae,pe,re){const fe=document.getElementById(ae);if(!fe)return;const ye=performance.now(),ve=Z=>{const Te=Math.min(1,(Z-ye)/re);fe.textContent=Math.round(pe*(1-Math.pow(1-Te,3))),Te<1?requestAnimationFrame(ve):fe.textContent=pe};requestAnimationFrame(ve)}setTimeout(()=>{G("pvp-score-me",I,800),G("pvp-score-opp",j,800)},1500);const N=y.p1Team.MIL||[],Q=y.p2Team.MIL||[],W=Xe(N)+Je(N),ne=Xe(Q)+Je(Q),oe=W>=ne?"p1":"p2";let U=y.boostValue;U==null&&(U=an(),y.boostValue=U,y.boostOwner=oe,y.boostUsed=!1),V=!0,setTimeout(()=>{const ae=e.querySelector("#duel-row-"+(T?"me":"opp")),pe=e.querySelector("#duel-row-"+(T?"opp":"me")),re=document.getElementById("pvp-score-me"),fe=document.getElementById("pvp-score-opp"),ye=T?re:fe,ve=T?fe:re;ye&&(ye.style.fontSize="80px",ye.style.color=T?"#FFD700":"#ff6b6b",ye.style.animation="duelPulse .5s ease"+(T?",duelGlow 1.5s ease infinite .5s":"")),ve&&(ve.style.opacity="0.25"),setTimeout(()=>{ae&&(ae.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ae.style.zIndex="5"),setTimeout(()=>{const Z=document.getElementById("duel-shock");Z&&(Z.style.animation="shockwave .5s ease-out forwards"),pe&&(pe.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Me;const Z=document.getElementById("pvp-duel-finale");if(!Z)return;const Te=y.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+U+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Ae=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;Z.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(T?"⚽ "+y[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+y[x+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Te+Ae,Z.style.transition="opacity .45s ease",Z.style.opacity="1",Z.style.pointerEvents="auto",(Me=document.getElementById("pvp-start-match"))==null||Me.addEventListener("click",async()=>{const Fe=oe;await S({phase:Fe+"-attack",attacker:Fe,round:1,boostValue:U,boostUsed:!1,boostOwner:Fe})})},600)},700)},2800)}function P(k,L,I){var re,fe;const j=(y.gcDefs||[]).find(ye=>{var ve;return ye.name===k||((ve=ye.name)==null?void 0:ve.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),T={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[j==null?void 0:j.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",A={purple:"#b06ce0",light_blue:"#00d4ef"}[j==null?void 0:j.color]||"#b06ce0",G=(j==null?void 0:j.name)||k,N=(j==null?void 0:j.effect)||((re=Se[k])==null?void 0:re.desc)||"",Q=j!=null&&j.image_url?`/icons/${j.image_url}`:null,W=((fe=Se[k])==null?void 0:fe.icon)||"⚡",oe=L===p?"Vous":y[L+"Name"]||"Adversaire",U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",U.innerHTML=`
      <style>
      ...
      <div style="width:200px;border-radius:18px;border:3px solid ${A};background:${T};display:flex;flex-direction:column;overflow:hidden;animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
        <div style="padding:12px;background:rgba(255,255,255,0.14);text-align:center">
          <div style="font-size:${G.length>14?12:15}px;font-weight:900;color:#fff;letter-spacing:.5px;text-transform:uppercase">${G}</div>
          <div style="font-size:8px;color:rgba(255,255,255,0.5);margin-top:2px">⚡ GAME CHANGER</div>
        </div>
        <div style="height:170px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Q?`<img src="${Q}" style="max-width:160px;max-height:160px;object-fit:contain">`:`<span style="font-size:76px">${W}</span>`}
        </div>
        <div style="padding:12px;background:rgba(0,0,0,0.38);text-align:center">
          <div style="font-size:12px;color:rgba(255,255,255,0.92);line-height:1.5">${N}</div>
        </div>
      </div>
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(U);let ae=!1;const pe=()=>{ae||(ae=!0,U.remove(),setTimeout(()=>I&&I(),50))};U.addEventListener("click",pe),setTimeout(pe,3e3)}function z(k,L){var U,ae,pe,re;const j=(y["gcCardsFull_"+p]||[]).find(fe=>fe.id===k),T=j==null?void 0:j._gcDef,A={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",G={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",N=(T==null?void 0:T.name)||L,Q=(T==null?void 0:T.effect)||((U=Se[L])==null?void 0:U.desc)||"Carte spéciale.",W=T!=null&&T.image_url?`/icons/${T.image_url}`:null,ne=((ae=Se[L])==null?void 0:ae.icon)||"⚡",oe=document.createElement("div");oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",oe.innerHTML=`
      <div style="width:190px;border-radius:16px;border:3px solid ${G};background:${A};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 40px ${G}66">
        <div style="padding:10px;background:rgba(255,255,255,0.14);text-align:center">
          <div style="font-size:${N.length>14?11:14}px;font-weight:900;color:#fff;letter-spacing:.5px;text-transform:uppercase">${N}</div>
          <div style="font-size:8px;color:rgba(255,255,255,0.5);margin-top:2px">⚡ GAME CHANGER</div>
        </div>
        <div style="height:160px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${W?`<img src="${W}" style="max-width:150px;max-height:150px;object-fit:contain">`:`<span style="font-size:72px">${ne}</span>`}
        </div>
        <div style="padding:10px;background:rgba(0,0,0,0.38);text-align:center">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(T=>{const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",G=De(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${A};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(I),(j=I.querySelector("#bp-close"))==null||j.addEventListener("click",()=>I.remove()),I.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const A=T.dataset.cid,G=L.find(Q=>Q.cardId===A);if(!G)return;const N=(k[G._line]||[]).find(Q=>Q.cardId===A);N&&(N.boost=(N.boost||0)+y.boostValue),I.remove(),await S({[p+"Team"]:k,boostUsed:!0})})})}function D(k=null){var ae,pe;if(!(y.phase===p+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const I=y[p+"Team"],j=y["usedSubIds_"+p]||[],T=y.maxSubs||3;if(j.length>=T){f(`Maximum ${T} remplacements atteint`,"warning");return}const A=Object.entries(I).flatMap(([re,fe])=>(fe||[]).filter(ye=>ye.used).map(ye=>({...ye,_line:re}))),G=(y[p+"Subs"]||[]).filter(re=>!j.includes(re.cardId));if(!A.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!G.length){f("Aucun remplaçant disponible","warning");return}let N=Math.max(0,A.findIndex(re=>re.cardId===k));const Q=((ae=A[N])==null?void 0:ae._line)||((pe=A[N])==null?void 0:pe.job);let W=Math.max(0,G.findIndex(re=>re.job===Q)),ne=!1;const oe=document.createElement("div");oe.id="pvp-sub-overlay",oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function U(){var Ae,Me,Fe,ct,Re,Ct;const re=A[N],fe=G[W],ye=Math.min(130,Math.round((window.innerWidth-90)/2)),ve=Math.round(ye*1.35),Z=Ce=>`background:rgba(255,255,255,0.12);border:none;color:${Ce?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Ce?"default":"pointer"};flex-shrink:0`;oe.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${fe?Ze({...fe,used:!1,boost:0},ye,ve):"<div>—</div>"}</div>
          <button id="pin-down" style="${Z(W>=G.length-1)}" ${W>=G.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${W+1}/${G.length}</div>
        </div>
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          <div style="font-size:9px;color:#ff6b6b;letter-spacing:2px;text-transform:uppercase;font-weight:700">Joueur qui sort</div>
          <button id="pout-up" style="${Z(N===0)}" ${N===0?"disabled":""}>▲</button>
          <div>${re?Ze({...re,used:!1,boost:0},ye,ve):"<div>—</div>"}</div>
          <button id="pout-down" style="${Z(N>=A.length-1)}" ${N>=A.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${N+1}/${A.length}</div>
        </div>
      </div>
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(Ae=oe.querySelector("#psub-close"))==null||Ae.addEventListener("click",()=>oe.remove()),(Me=oe.querySelector("#pout-up"))==null||Me.addEventListener("click",()=>{N>0&&(N--,U())}),(Fe=oe.querySelector("#pout-down"))==null||Fe.addEventListener("click",()=>{N<A.length-1&&(N++,U())}),(ct=oe.querySelector("#pin-up"))==null||ct.addEventListener("click",()=>{W>0&&(W--,U())}),(Re=oe.querySelector("#pin-down"))==null||Re.addEventListener("click",()=>{W<G.length-1&&(W++,U())});const Te=(Ce,Ne,Oe,Ke)=>{const qe=oe.querySelector("#"+Ce);if(!qe)return;let nt=0;qe.addEventListener("touchstart",Ve=>{nt=Ve.touches[0].clientY},{passive:!0}),qe.addEventListener("touchend",Ve=>{const Ye=Ve.changedTouches[0].clientY-nt;if(Math.abs(Ye)<30)return;const ot=Ne();Ye<0&&ot<Ke-1?(Oe(ot+1),U()):Ye>0&&ot>0&&(Oe(ot-1),U())},{passive:!0})};Te("pin-panel",()=>W,Ce=>W=Ce,G.length),Te("pout-panel",()=>N,Ce=>N=Ce,A.length),(Ct=oe.querySelector("#psub-confirm"))==null||Ct.addEventListener("click",async Ce=>{if(Ce.preventDefault(),Ce.stopPropagation(),ne)return;ne=!0;const Ne=A[N],Oe=G[W];if(!Ne||!Oe)return;const Ke=Ne._line,qe=(I[Ke]||[]).findIndex(Ye=>Ye.cardId===Ne.cardId);if(qe===-1){f("Erreur : joueur introuvable","error"),oe.remove();return}const nt={...Oe,_line:Ke,position:Ne.position,used:!1,boost:0};I[Ke].splice(qe,1,nt);const Ve=[...j,Oe.cardId];oe.remove(),Y(Ne,Oe,async()=>{await S({[p+"Team"]:I,[x+"Team"]:y[x+"Team"],["usedSubIds_"+p]:Ve})})})}document.body.appendChild(oe),U()}function Y(k,L,I){const j={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const A=(Q,W,ne)=>`<div style="text-align:center">
      <div style="font-size:9px;color:${W};letter-spacing:2px;text-transform:uppercase;font-weight:700;margin-bottom:6px">${ne}</div>
      <div style="width:70px;height:70px;border-radius:50%;background:${j[Q.job]||"#555"};border:3px solid ${W};position:relative;overflow:hidden;margin:0 auto">
        ${It(Q)?`<img src="${It(Q)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(T);let G=!1;const N=()=>{G||(G=!0,T.remove(),setTimeout(()=>I(),50))};T.addEventListener("click",N),setTimeout(N,2200)}function K(){var L;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(I=L.querySelector("#pvp-hist-close"))==null||I.addEventListener("click",()=>L.remove())}async function O(){if(y.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(y.round||0)+1,I=[...y.log||[]];I.push({type:"info",text:`⏭️ ${y[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const j=xe(y),T=$e(k),A=j||!T?"finished":k+"-attack";await S({["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:A,attacker:k,round:L,log:I}),A==="finished"&&await Be(y)}async function we(){const k=y[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(A=>(y[x+"Team"][A]||[]).some(G=>!G.used)),I=(y["selected_"+p]||[]).map(A=>{const G=(k[A._role]||[]).find(pe=>pe.cardId===A.cardId)||A,N=["GK","DEF"].includes(A._role),Q=k[A._role]||[],W=Q.findIndex(pe=>pe.cardId===A.cardId),ne=ht(Q.length),oe=W>=0?ne[W]:G._col??1,U=y.stadiumDef||y.homeStadiumDef||null,ae=G.stadiumBonus||U&&(U.club_id&&String(G.club_id)===String(U.club_id)||U.country_code&&G.country_code===U.country_code)||!1;return{...G,_line:A._role,_col:oe,stadiumBonus:ae,...N?{note_a:Math.max(1,Number(G.note_a)||0)}:{}}});if(!I.length)return;const j=gi(I,y.modifiers[p]||{});se(p,I.map(A=>A.cardId)),I.forEach(A=>{const G=(k[A._role]||[]).find(N=>N.cardId===A.cardId);G&&(G.used=!0)}),y["selected_"+p]=[],de();const T=[...y.log||[]];if(L){const A=(y[p+"Score"]||0)+1,G=I.map(oe=>Zt(oe));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:G,homeTotal:j.total,aiTotal:0});const N=(y.round||0)+1,Q=p==="p1"?"p2":"p1",W={...y,[p+"Team"]:k,[p+"Score"]:A},ne=xe(W);R.add(N),et(G,A,y[x+"Score"]||0,!0,async()=>{await S({[p+"Team"]:k,[p+"Score"]:A,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:ne?"finished":Q+"-attack",attacker:Q,round:N,log:T}),ne&&await Be({...y,[p+"Score"]:A})});return}T.push({type:"pending",text:`⚔️ ${y[p+"Name"]} attaque (${j.total})`}),await S({[p+"Team"]:k,[x+"Team"]:y[x+"Team"],pendingAttack:{...j,players:I,side:p},["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},phase:x+"-defense",log:T})}async function _e(){const k=y[p+"Team"],L=(y["selected_"+p]||[]).map(re=>{const fe=(k[re._role]||[]).find(Ae=>Ae.cardId===re.cardId)||re,ye=k[re._role]||[],ve=ye.findIndex(Ae=>Ae.cardId===re.cardId),Z=ht(ye.length),Te=ve>=0?Z[ve]:fe._col??1;return{...fe,_line:re._role,_col:Te}}),I=mi(L,y.modifiers[p]||{});se(p,L.map(re=>re.cardId)),L.forEach(re=>{const fe=(k[re._role]||[]).find(ye=>ye.cardId===re.cardId);fe&&(fe.used=!0)}),y["selected_"+p]=[],de();const j=xi(y.pendingAttack.total,I.total,y.modifiers[p]||{}),T=y.pendingAttack.side,A=j==="attack"||(j==null?void 0:j.goal),G=T==="p1"?"p2":"p1",N=(y.round||0)+1,Q=(y.pendingAttack.players||[]).map(re=>Zt(re)),W=[...y.log||[]];W.push({type:"duel",isGoal:A,homeScored:A&&T===p,text:A?`⚽ BUT de ${y[T+"Name"]} ! (${y.pendingAttack.total} vs ${I.total})`:`✋ Attaque stoppée (${y.pendingAttack.total} vs ${I.total})`,homePlayers:Q,aiPlayers:L.map(re=>Zt(re)),homeTotal:y.pendingAttack.total,aiTotal:I.total});const ne=A?(y[T+"Score"]||0)+1:y[T+"Score"]||0,oe={...y,[p+"Team"]:k,[T+"Score"]:ne},U=xe(oe),ae=U?"finished":G+"-attack",pe=async()=>{await S({[p+"Team"]:k,[x+"Team"]:y[x+"Team"],[T+"Score"]:ne,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:G,round:N,log:W}),(ae==="finished"||U)&&await Be({...y,[T+"Score"]:ne})};if(A){const re=T===p,fe=re?ne:y[p+"Score"]||0,ye=re?y[x+"Score"]||0:ne;R.add(N),et(Q,fe,ye,re,pe)}else await pe()}function be(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(I=>!I.used))}function me(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(I=>!I.used))}function ke(k){return me(k)&&!be(k)}function $e(k){const L=y[k+"Team"];return!!(be(L)||ke(L))}function xe(k){return!me(k.p1Team)&&!me(k.p2Team)}function je(k){const L=k.p1Score||0,I=k.p2Score||0;return L===I?null:L>I?h.home_id:h.away_id}async function Be(k){try{const L=je(k),I=L?h.home_id===L?h.away_id:h.home_id:null;await w.from("matches").update({status:"finished",winner_id:L,home_score:k.p1Score||0,away_score:k.p2Score||0}).eq("id",i),L&&I&&updateEvolutiveCards(L,I).catch(()=>{})}catch(L){console.error("[PvP] finishMatch:",L)}}function Ue(){var T;const k=y[p+"Score"],L=y[x+"Score"],I=k>L,j=k===L;He(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{w.removeChannel(J)}catch{}Pe(e),m("home")})}de()}async function si(e,t,i=!1){var s,l;const{state:n,navigate:a,toast:o}=t,r=i&&((l=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:l.rankedData)||null;await jt(e,t,i?"ranked":"random",async({deckId:c,formation:d,starters:u,subsRaw:g,gcCardsEnriched:m,gcDefs:f,stadiumDef:p})=>{He(e);const x=async b=>{await No(e,t,c,d,u,g,b||[],f,p,i,r)};if(!(m!=null&&m.length)){await x([]);return}yi(e,m,x)})}async function Ro(e,t,i){return Po(e,t,i)}async function No(e,t,i,n,a,o,r=[],s=[],l=null,c=!1,d=null){var ee,J;const{state:u,navigate:g,toast:m}=t,f=(d==null?void 0:d.mmr)??((ee=u.profile)==null?void 0:ee.mmr)??1e3,p=c?pi(f):null,x=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let v=!1,h=null,$=null;e.innerHTML=`
    ...
    </div>`;const y=async()=>{v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null),await w.rpc("cancel_matchmaking",{p_user_id:u.profile.id}).catch(()=>{})};(J=document.getElementById("cancel-mm"))==null||J.addEventListener("click",async()=>{await y(),Pe(e),g("home")});const B=async(S,_)=>{v||(v=!0,h&&(h.unsubscribe(),h=null),$&&(clearInterval($),$=null),await wt(e,t,S,_,{myGC:r,gcDefs:s,stadiumDef:l,isRanked:c,rankedData:d,onMatchEnd:c?Oo:null}))},E=u.user.id,{data:F,error:R}=c?await w.rpc("try_matchmake_ranked",{p_user_id:E,p_deck_id:i,p_mmr:f}):await w.rpc("try_matchmake",{p_user_id:E,p_deck_id:i});if(R||!(F!=null&&F.success)){console.error("[Matchmaking] try_matchmake error:",R||F),m("Erreur de matchmaking","error"),Pe(e),g("home");return}if(F.matched){await B(F.match_id,!1);return}const ie=async()=>{if(v)return;const{data:S}=await w.from("matchmaking_queue").select("status, match_id").eq("user_id",E).maybeSingle();(S==null?void 0:S.status)==="matched"&&S.match_id&&await B(S.match_id,!0)};h=w.channel(`mm_${E}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${E}`},S=>{const _=S.new;_.status==="matched"&&_.match_id&&B(_.match_id,!0)}).subscribe(),$=setInterval(ie,3e3),setTimeout(()=>{v||y()},12e4)}async function Oo(e,t){const{state:i,toast:n}=t,{winnerId:a,homeId:o,awayId:r,homeScore:s,awayScore:l,matchId:c}=e,d=i.user.id,u=o===d,g=a===d,{data:m}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",d).single(),{data:f}=await w.from("users").select("mmr, mmr_rd, mmr_v").eq("id",u?r:o).single();if(m&&f){const p=vn(m.mmr,m.mmr_rd,m.mmr_v,f.mmr,f.mmr_rd,g?1:0);await w.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:g?w.sql`mmr_wins + 1`:void 0,mmr_losses:g?void 0:w.sql`mmr_losses + 1`}).eq("id",d),n(g?`+MMR ↑ ${Math.round(p.mmr-m.mmr)}`:`-MMR ↓ ${Math.round(m.mmr-p.mmr)}`,g?"success":"error",4e3)}}const Ho=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:si,resumePvpMatch:Ro},Symbol.toStringTag,{value:"Module"}));async function Uo(e,t){const{state:i,navigate:n,toast:a}=t,o=i.params||{},r=o.friendId||null,s=o.friendName||"Ami";await jt(e,t,"friend",async({deckId:l,formation:c,starters:d,subsRaw:u,gcCardsEnriched:g,gcDefs:m,stadiumDef:f})=>{He(e);const p=async x=>{const b=x||[];r?await Ko(e,t,l,b,m,f,r,s):await Vo(e,t,l,b,m,f)};if(!(g!=null&&g.length)){await p([]);return}yi(e,g,p)})}async function Ko(e,t,i,n,a,o,r,s){var v;const{state:l,navigate:c,toast:d}=t,u=l.user.id,{data:g,error:m}=await w.from("friend_match_invites").insert({inviter_id:u,invitee_id:r,friend_id:r,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(m||!g){console.error("[Friend] Erreur création invitation:",m),d("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`,(b=document.getElementById("ml-create-btn"))==null||b.addEventListener("click",()=>Qo(e,t)),e.querySelectorAll(".ml-tab").forEach(v=>v.addEventListener("click",()=>lt(e,t,v.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(v=>v.addEventListener("click",()=>it(e,t,v.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(v=>v.addEventListener("click",h=>{h.stopPropagation(),un(e,t,v.dataset.join,v.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(v=>v.addEventListener("click",h=>{h.stopPropagation(),di(e,t,v.dataset.delete,v.dataset.name,i)}))}function Ht(e,t,i=!1){var r,s;const n=e.creator_id===t,a=e.pot||0,o=((s=(r=e.mini_league_members)==null?void 0:r[0])==null?void 0:s.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;font-size:11px;color:#666;margin-bottom:${i?"10px":"0"}">
      ...
      ${a>0?`<span style="color:${Qe};font-weight:700">🏆 ${a.toLocaleString("fr")} cr.</span>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:12px 16px;background:#fff;border-bottom:1px solid #eee;display:flex;align-items:center;gap:10px">
      ...
      <div style="text-align:right;flex-shrink:0">
        ...
        ${f>0?`<div style="font-size:12px;font-weight:900;color:${Qe};margin-top:4px">🏆 ${f.toLocaleString("fr")} cr.</div>`:""}
      </div>
    </div>
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${u.map(S=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #f5f5f5">
            <div style="width:36px;height:36px;border-radius:50%;background:${S.club_color2||yt};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${S.club_color1||"#fff"}">${(S.pseudo||"?").slice(0,2).toUpperCase()}</div>
            <div style="flex:1"><div style="font-size:13px;font-weight:700">${S.club_name||S.pseudo}</div><div style="font-size:11px;color:#999">@${S.pseudo}</div></div>
            ${S.id===r.creator_id?'<span style="font-size:10px;color:#D4A017;font-weight:700">👑</span>':""}
          </div>`).join("")}
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="font-size:10px;color:#888;text-transform:uppercase;border-bottom:2px solid #f0f0f0">
            ...
            ${f>0&&r.status==="finished"?`<th style="text-align:right;padding:5px 0;color:${Qe}">💰</th>`:""}
          </tr></thead>
          <tbody>${g.map((S,_)=>{const M=f>0&&r.status==="finished"?_===0?Math.floor(f*.7):_===1?Math.floor(f*.2):_===2?Math.floor(f*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${S.userId===o?"background:#f0fdf4;":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${_===0?Qe:_<3?yt:"#555"}">${["🥇","🥈","🥉"][_]||_+1}</td>
              ...
              <td style="text-align:center;color:${S.goalDiff>=0?yt:"#cc2222"}">${S.goalDiff>=0?"+":""}${S.goalDiff}</td>
              <td style="text-align:center;font-weight:900;font-size:14px">${S.points}</td>
              ${f>0&&r.status==="finished"?`<td style="text-align:right;font-weight:700;color:${Qe}">${M?M.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(S,_)=>_+1).reverse().map(S=>{const _=(l||[]).filter(M=>M.matchday===S);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${S}</div>${_.map(M=>Ri(M,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=r.status==="waiting"?"waiting":r.status==="active"?"active":"archived";if(($=document.getElementById("ml-back"))==null||$.addEventListener("click",()=>lt(e,t,h)),(y=document.getElementById("ml-start-btn"))==null||y.addEventListener("click",()=>ir(e,t,r,u)),(B=document.getElementById("ml-next-day"))==null||B.addEventListener("click",()=>nr(e,t,i)),(E=document.getElementById("ml-finish-btn"))==null||E.addEventListener("click",()=>fn(e,t,i,f,g,u)),(F=document.getElementById("ml-join-now"))==null||F.addEventListener("click",()=>un(e,t,i,r.type)),(R=document.getElementById("ml-leave-btn"))==null||R.addEventListener("click",()=>er(e,t,i,p)),(ie=document.getElementById("ml-delete-btn"))==null||ie.addEventListener("click",()=>di(e,t,i,r.name,"waiting")),(ee=document.getElementById("ml-delete-now"))==null||ee.addEventListener("click",()=>di(e,t,i,r.name,h)),(J=document.getElementById("ml-archive-btn"))==null||J.addEventListener("click",()=>tr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(S=>{S.addEventListener("click",()=>{const _=m.find(M=>M.id===S.dataset.playMatch);_&&t.navigate("match-mini-league",{mlMatchId:_.id,leagueId:i})})}),r.status==="finished"&&v){const S=g.findIndex(_=>_.userId===o);S>=0&&S<3&&v.prize_amount>0&&setTimeout(()=>or(e,t,r,v,S),400)}}function Ri(e,t,i,n,a=!1){const o=u=>t.find(g=>g.id===u);if(e.is_bye){const u=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:#f9f9f9;margin-bottom:6px;font-size:12px;color:#888;text-align:center">🔵 ${(u==null?void 0:u.club_name)||(u==null?void 0:u.pseudo)||"?"} exempté(e)</div>`}const r=o(e.home_id),s=o(e.away_id),l=e.home_id===i||e.away_id===i,c=l&&e.status==="pending"&&n&&!a,d=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"#f0fdf4":"#f9f9f9"};margin-bottom:6px;border:1px solid ${l?"#86efac":"#f0f0f0"}">
  ...
  </div>`}async function ir(e,t,i,n){const{toast:a,state:o}=t,r=rr(n.map(c=>c.id),i.mode),s=[];r.forEach((c,d)=>c.forEach(u=>s.push({league_id:i.id,matchday:d+1,home_id:u.home||u.bye,away_id:u.away||null,is_bye:!!u.bye,status:u.bye?"bye":"pending"})));const{error:l}=await w.from("mini_league_matches").insert(s);if(l){a("Erreur calendrier : "+l.message,"error");return}await w.from("mini_leagues").update({status:"active",current_day:1,total_days:r.length}).eq("id",i.id),a(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),it(e,t,i.id)}async function nr(e,t,i){const{data:n}=await w.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),a=(n.current_day||0)+1;if(a>(n.total_days||0)){await fn(e,t,i,n.pot||0,null,null);return}await w.from("mini_leagues").update({current_day:a}).eq("id",i),t.toast(`Journée ${a} commencée !`,"success"),it(e,t,i)}async function fn(e,t,i,n,a,o){const{toast:r,state:s}=t;let l=a,c=o;if(!l){const{data:u}=await w.from("mini_league_matches").select("*").eq("league_id",i),{data:g}=await w.from("mini_league_members").select("*, user:users(id,pseudo,club_name)").eq("league_id",i);c=(g||[]).map(m=>m.user).filter(Boolean),l=gn(c,u||[])}const d=[Math.floor(n*.7),Math.floor(n*.2),Math.floor(n*.1)];await Promise.all(l.slice(0,3).map((u,g)=>d[g]?w.from("mini_league_members").update({prize_amount:d[g],prize_claimed:!1}).eq("league_id",i).eq("user_id",u.userId):Promise.resolve())),await w.from("mini_leagues").update({status:"finished"}).eq("id",i),r("🏆 Mini League terminée ! Les gagnants peuvent récupérer leurs crédits.","success"),it(e,t,i)}async function or(e,t,i,n,a){var g,m;const{state:o,toast:r}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],l=["🥇","🥈","🥉"][a],c=n.prize_amount||s[a]||0,d=n.prize_claimed,u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",u.innerHTML=`
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <div style="background:rgba(212,160,23,0.2);border:2px solid ${Qe};border-radius:14px;padding:16px;margin-bottom:24px">
        <div style="font-size:12px;color:rgba(255,255,255,0.6);margin-bottom:4px">${d?"Déjà récupéré":"Tes gains"}</div>
        <div style="font-size:32px;font-weight:900;color:${Qe}">${c.toLocaleString("fr")} cr.</div>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let l="buy";const c=()=>{var p,x,b,v,h,$,y;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((x=document.getElementById("flt-club"))==null?void 0:x.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((v=document.getElementById("flt-job"))==null?void 0:v.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt(($=document.getElementById("flt-note1"))==null?void 0:$.value)||0,note2:parseInt((y=document.getElementById("flt-note2"))==null?void 0:y.value)||0}};function d(p){const x=c();return p.filter(b=>{var R,ie,ee;const v=(R=b.card)==null?void 0:R.player;if(!v)return!1;const h=`${v.firstname} ${v.surname_real}`.toLowerCase(),$=(((ie=v.clubs)==null?void 0:ie.encoded_name)||"").toLowerCase(),y=(v.country_code||"").toLowerCase(),B=((ee=b.card)==null?void 0:ee.evolution_bonus)||0,E=ut(v,v.job,B),F=v.job2?ut(v,v.job2,B):0;return!(x.name&&!h.includes(x.name)||x.club&&!$.includes(x.club)||x.country&&!y.includes(x.country)||x.job&&v.job!==x.job||x.rarity&&v.rarity!==x.rarity||x.note1&&E<x.note1||x.note2&&F<x.note2)})}function u(p){var F,R,ie,ee;const x=(F=p.card)==null?void 0:F.player;if(!x)return"";const b=((R=p.card)==null?void 0:R.evolution_bonus)||0,v=ut(x,x.job,b),h=x.job2?ut(x,x.job2,b):0,$=(i.profile.credits||0)>=p.price,y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,B=Ft[x.job]||"#bbb",E=x.job2?Ft[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function g(p){var F,R,ie,ee;const x=(F=p.card)==null?void 0:F.player;if(!x)return"";const b=((R=p.card)==null?void 0:R.evolution_bonus)||0,v=ut(x,x.job,b),h=x.job2?ut(x,x.job2,b):0,$=p.status==="sold",y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,B=Ft[x.job]||"#bbb",E=x.job2?Ft[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ie=x.clubs)!=null&&ie.logo_url?`<img src="${x.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${B};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=r||[];f.innerHTML=b.length>0?b.map((v,h)=>{const $=pi(v.mmr??1e3),y=(v.ranked_wins||0)+(v.ranked_losses||0)+(v.ranked_draws||0),B=y>0?Math.round((v.ranked_wins||0)/y*100):0,E=v.id===i.profile.id,F=(v.placement_matches||0)<10;return`
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${E?"border:2px solid var(--yellow)":""}">
            ...
            <div style="text-align:right;flex-shrink:0">
              ...
              ${F?"":`<div style="font-size:10px;color:var(--gray-600)">${B}% WR</div>`}
            </div>
  ...
  </div>`}_n($n);const he={user:null,profile:null,page:"home",params:{}};function ft(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function vr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function li(){document.getElementById("modal-overlay").classList.add("hidden")}async function Et(){if(!he.user)return;const{data:e}=await w.from("users").select("*").eq("id",he.user.id).single();e&&(he.profile=e)}function Lt(e,t={}){he.page=e,he.params=t,xn()}async function xn(){var n,a,o,r;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===he.page)});const t=document.getElementById("nav-credits");t&&he.profile&&(t.textContent=`💰 ${(he.profile.credits||0).toLocaleString("fr")}`);const i={state:he,navigate:Lt,toast:ft,openModal:vr,closeModal:li,refreshProfile:Et};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',he.page){case"home":await ji(e,i);break;case"collection":await Xn(e,i);break;case"decks":await ti(e,i);break;case"boosters":await lo(e,i);break;case"ranked":await br(e,i);break;case"match":{const s=he.params&&he.params.matchMode||"vs_ai_easy";s==="random"?await si(e,i,!1):s==="ranked"?await si(e,i,!0):s==="friend"?await Uo(e,i,(n=he.params)==null?void 0:n.friendId,(a=he.params)==null?void 0:a.friendName):s==="mini-league"?await Ni(e,i,(o=he.params)==null?void 0:o.mlMatchId,(r=he.params)==null?void 0:r.leagueId):await $o(e,i);break}case"market":await fr(e,i);break;case"rankings":await yr(e,i);break;case"matches":await hr(e,i);break;case"friends":await Sn(e,i);break;case"mini-league":await Yo(e,i);break;case"match-mini-league":{const s=he.params||{};await Ni(e,i,s.mlMatchId,s.leagueId);break}default:await ji(e,i)}}function wr(){var n;const e=document.getElementById("app"),t=he.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(a=>{a.addEventListener("click",o=>{o.preventDefault(),Lt(a.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Lt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Lt("boosters")),(n=document.getElementById("journal-btn"))==null||n.addEventListener("click",()=>_r())}async function _r(){const{data:e}=await w.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(e||[]).map(n=>{const a=new Date(n.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
    ...
    </div>`,document.body.appendChild(t),t.querySelector("#journal-close").addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()})}async function kr(){document.documentElement.setAttribute("data-theme","light"),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&li()}),document.getElementById("modal-close").addEventListener("click",li);const{data:{session:e}}=await w.auth.getSession();if(!e){Oi(),Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:ft});return}he.user=e.user,await Et(),Oi();try{const{data:i}=await w.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(a=>{n[a.formation]=a.links}),kn(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!he.profile){Ln(document.getElementById("app"),{state:he,navigate:async()=>{await Et(),ei()},toast:ft,refreshProfile:Et});return}const t=Array.isArray(he.profile.pending_boosters)?he.profile.pending_boosters:[];if(!he.profile.onboarding_done&&t.length>0){yo(document.getElementById("app"),{state:he,navigate:()=>ei(),toast:ft,refreshProfile:Et});return}ei(),setTimeout(()=>ur(he.profile,Lt,ft),800),w.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(he.user=null,he.profile=null,document.getElementById("app").innerHTML="",Mi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:ft}))})}function $r(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Kt(){const e=document.getElementById("app");e&&(e.style.height=$r()+"px")}window.addEventListener("resize",Kt);window.addEventListener("orientationchange",()=>setTimeout(Kt,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Kt);function ei(){const e=()=>{var i;(i=he.user)!=null&&i.id&&w.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",he.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Kt(),wr(),xn()}function Oi(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function yn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    <div style="font-size:42px">📡</div>
    <div style="font-size:18px;font-weight:900">Connexion impossible</div>
    <div style="font-size:13px;color:rgba(255,255,255,0.6);max-width:280px">${e||"Le chargement a échoué. Vérifie ta connexion et réessaie."}</div>
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(n=document.getElementById("boot-retry"))==null||n.addEventListener("click",()=>window.location.reload())}kr().catch(e=>{console.error("Échec du démarrage:",e),yn()});setTimeout(()=>{const e=document.getElementById("app-loader");e&&e.style.display!=="none"&&!e.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&yn("Le serveur met trop de temps à répondre.")},12e3);
