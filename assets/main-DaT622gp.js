import{s as T,l as Ze,j as Ii,F as oi,h as Mt,i as Zi,k as en,b as tn}from"./formation-links-CEzN0rcz.js";function xi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  <div style="text-align:center;flex-shrink:0;width:38px">
    ...
    <div style="font-size:7px;color:rgba(255,255,255,0.5);margin-top:1px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${(e.name||"").slice(0,7)}</div>
          ...
          card:cards(id, card_type, formation,
            player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);i=C[0].data,f=C[0].error,a=C[1].data,m=C[1].error}catch(C){console.error("[Match] Exception chargement deck:",C),rt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>d("home"));return}if(f||m){console.error("[Match] Erreur Supabase:",f||m),rt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>d("home"));return}const g=(a||[]).filter(C=>{var G;return C.is_starter&&((G=C.card)==null?void 0:G.player)}).map(C=>Xt(C.card,C.position)),$=(a||[]).filter(C=>{var G;return!C.is_starter&&((G=C.card)==null?void 0:G.player)}).map(C=>Xt(C.card,C.position));if(g.length<11){rt(e,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>d("decks"));return}const o=(a||[]).find(C=>{var G;return((G=C.card)==null?void 0:G.card_type)==="formation"}),_=(i==null?void 0:i.formation)||((j=o==null?void 0:o.card)==null?void 0:j.formation)||"4-4-2",{data:M,error:L}=await T.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",p.profile.id).eq("card_type","game_changer"),{data:F}=await T.from("gc_definitions").select("*").eq("is_active",!0),P=(M||[]).map(C=>({...C,_gcDef:(F==null?void 0:F.find(G=>G.name===C.gc_type||G.id===C.gc_definition_id))||null}));r({deckId:c,formation:_,starters:g,subsRaw:$,gcCardsEnriched:P,gcDefs:F||[]})}async function gn(e,t){var n,r;try{const p=(r=(n=t==null?void 0:t.state)==null?void 0:n.profile)==null?void 0:r.id;try{(T.getChannels?T.getChannels():[]).forEach(s=>{const l=s.topic||"";(l.includes("matchmaking")||l.includes("pvp-match")||l.includes("friend-invite"))&&T.removeChannel(s)})}catch(d){console.warn("[Random] cleanup canaux:",d)}p&&await T.rpc("cancel_matchmaking",{p_user_id:p}).catch(()=>{})}catch{}await li(e,t,"random",({deckId:p,formation:d,starters:s,subsRaw:l,gcCardsEnriched:c,gcDefs:i})=>{const a=f=>mn(e,t,p,d,s,l,f,i||[]);if(!c.length){a([]);return}di(e,c,a)})}async function mn(e,t,n,r,p,d,s=[],l=[]){var L;const{state:c,navigate:i,toast:a}=t;let f=!1,m=null;Xe(e),e.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const g=async(F=!0)=>{f=!0,m&&(T.removeChannel(m),m=null),F&&await T.rpc("cancel_matchmaking",{p_user_id:c.profile.id}).catch(()=>{})};(L=document.getElementById("mm-cancel"))==null||L.addEventListener("click",async()=>{try{await g(!0)}catch{}Oe(e),i("home")});const $=async(F,P,j)=>{if(f)return;f=!0,m&&(T.removeChannel(m),m=null);const C=document.getElementById("mm-status");C&&(C.textContent="Adversaire trouvé !"),await new Promise(G=>setTimeout(G,600)),e.isConnected&&Fi(e,t,F,j,s,l)},{data:o,error:_}=await T.rpc("try_matchmake",{p_user_id:c.profile.id,p_deck_id:n});if(_||!(o!=null&&o.success)){a("Erreur de matchmaking","error"),Oe(e),i("home");return}if(o.matched){$(o.match_id,o.opponent_id,!1);return}const M=document.getElementById("mm-status");M&&(M.textContent="En attente d'un autre joueur..."),m=T.channel("matchmaking-"+c.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${c.profile.id}`},F=>{const P=F.new;P.status==="matched"&&P.match_id&&$(P.match_id,P.matched_with,!0)}).subscribe()}async function xn(e,t,n){const{state:r,navigate:p,toast:d}=t;try{(T.getChannels?T.getChannels():[]).forEach(i=>{const a=i.topic||"";(a.includes("matchmaking")||a.includes("pvp-match")||a.includes("friend-invite"))&&T.removeChannel(i)})}catch{}const{data:s}=await T.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!s){d("Match introuvable","error"),p("home");return}if(s.status==="finished"){d("Ce match est terminé","info"),p("home");return}const l=s.home_id===r.profile.id;Fi(e,t,n,l,[],[])}async function Fi(e,t,n,r,p=[],d=[]){const{state:s,navigate:l,toast:c}=t,i=r?"p1":"p2",a=r?"p2":"p1",f=(p||[]).map(A=>A.id),m=(p||[]).map(A=>({id:A.id,gc_type:A.gc_type,_gcDef:A._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await T.from("matches").select("*").eq("id",n).single();if(!g){c("Match introuvable","error"),l("home");return}async function $(){const[{data:A},{data:u},{data:x},{data:h}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),y=k=>({cardId:k.card_id,position:k.position,id:k.id,firstname:k.firstname,name:k.surname_encoded,country_code:k.country_code,club_id:k.club_id,job:k.job,job2:k.job2,note_g:Number(k.note_g)||0,note_d:Number(k.note_d)||0,note_m:Number(k.note_m)||0,note_a:Number(k.note_a)||0,rarity:k.rarity,skin:k.skin,hair:k.hair,hair_length:k.hair_length,clubName:k.club_encoded_name||null,clubLogo:k.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),b=((A==null?void 0:A.starters)||[]).map(k=>y(k)),v=((u==null?void 0:u.starters)||[]).map(k=>y(k)),w=(A==null?void 0:A.formation)||"4-4-2",I=(u==null?void 0:u.formation)||"4-4-2";return{p1Team:ft(b,w),p2Team:ft(v,I),p1Subs:((A==null?void 0:A.subs)||[]).map(k=>y(k)),p2Subs:((u==null?void 0:u.subs)||[]).map(k=>y(k)),p1Formation:w,p2Formation:I,p1Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:r?f:[],gc_p2:r?[]:f,gcCardsFull_p1:r?m:[],gcCardsFull_p2:r?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let o=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!o)if(r){o=await $();const{data:A}=await T.from("matches").select("game_state").eq("id",n).single();!(A!=null&&A.game_state)||!Object.keys(A.game_state).length?await T.from("matches").update({game_state:o,turn_user_id:g.home_id}).eq("id",n):o=A.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let A=0;A<30&&!o;A++){await new Promise(x=>setTimeout(x,400));const{data:u}=await T.from("matches").select("game_state").eq("id",n).single();u!=null&&u.game_state&&Object.keys(u.game_state).length&&(o=u.game_state)}if(!o){c("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=m,await T.from("matches").update({game_state:o}).eq("id",n)}let _=!1,M=null,L=!1;const F=new Set,P=new Set;function j(A){var k,E;try{T.removeChannel(C)}catch{}const u=o[i+"Score"]||0,x=o[a+"Score"]||0;let h,y;A.winner_id?(h=A.winner_id===s.profile.id,y=!1):A.forfeit?(h=u>x,y=!1):(y=u===x,h=u>x),(k=document.getElementById("pvp-end-overlay"))==null||k.remove();const b=document.createElement("div");b.id="pvp-end-overlay",b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":h?"🏆":"😞",w=y?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=y?"#fff":h?"#FFD700":"#ff6b6b";b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(E=b.querySelector("#pvp-end-home"))==null||E.addEventListener("click",()=>{b.remove(),Oe(e),l("home")})}const C=T.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},A=>{const u=A.new;try{if(u.status==="finished"||u.forfeit){if(_)return;_=!0,M&&(clearInterval(M),M=null),u.game_state&&(o=u.game_state),j(u);return}if(u.game_state){const x=o;o=u.game_state;const h=o._lastGC;if(h&&h.seq&&!P.has(h.seq)&&(P.add(h.seq),h.by!==i)){xe(h.type,h.by,()=>B());return}const y=x[i+"Score"]||0,b=x[a+"Score"]||0,v=o[i+"Score"]||0,w=o[a+"Score"]||0,I=v>y,k=w>b;if((I||k)&&!F.has(o.round)){F.add(o.round);const E=[...o.log||[]].reverse().find(D=>D.isGoal),S=((E==null?void 0:E.homePlayers)||[]).map(D=>({name:D.name,note:D.note,portrait:D.portrait,job:D.job}));he(S,v,w,I,()=>B());return}B()}}catch(x){console.error("[PvP] crash:",x)}}).subscribe();async function G(A){Object.assign(o,A),o.lastActionAt=new Date().toISOString();const{error:u}=await T.from("matches").update({game_state:o}).eq("id",n);u&&c("Erreur de synchronisation","error");try{B()}catch(x){console.error("[PvP] renderPvpScreen crash:",x)}}async function ne(){if(_)return;_=!0,M&&(clearInterval(M),M=null);const A=r?g.away_id:g.home_id,u=r?"p2":"p1",x=r?"p1":"p2",h={...o,[u+"Score"]:3,[x+"Score"]:0,phase:"finished"};try{await T.from("matches").update({status:"finished",forfeit:!0,winner_id:A,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",n)}catch{}try{T.removeChannel(C)}catch{}setTimeout(()=>{Oe(e),l("home")},800)}const ue={BOOST_STAT:({value:A=1,count:u=1,roles:x=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!x.length||x.includes(w)).flatMap(([w,I])=>I.filter(k=>!k.used).map(k=>({...k,_line:w})));if(!v.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(h);return}te(v,u,`Choisir ${u} joueur(s) à booster (+${A})`,w=>{w.forEach(I=>{const k=(b[I._line]||[]).find(E=>E.cardId===I.cardId);k&&(k.boost=(k.boost||0)+A,h.log.push({text:`⚡ +${A} sur ${k.name}`,type:"info"}))}),h[i+"Team"]=b,y(h)})},DEBUFF_STAT:({value:A=1,count:u=1,roles:x=[],target:h="ai"},y,b)=>{const v=h==="home"?i:a,w=y[v+"Team"],I=h==="home"?"allié":"adverse",k=Object.entries(w).filter(([E])=>!x.length||x.includes(E)).flatMap(([E,S])=>S.filter(D=>!D.used).map(D=>({...D,_line:E})));if(!k.length){y.log.push({text:`🎯 Aucun joueur ${I}`,type:"info"}),b(y);return}te(k,u,`Choisir ${u} joueur(s) ${I}(s) (-${A})`,E=>{E.forEach(S=>{const D=(w[S._line]||[]).find(W=>W.cardId===S.cardId);D&&(D.boost=(D.boost||0)-A,y.log.push({text:`🎯 -${A} sur ${D.name}`,type:"info"}))}),y[v+"Team"]=w,b(y)})},GRAY_PLAYER:({count:A=1,roles:u=[],target:x="ai"},h,y)=>{const b=x==="home"?i:a,v=h[b+"Team"],w=x==="home"?"allié":"adverse",I=Object.entries(v).filter(([k])=>!u.length||u.includes(k)).flatMap(([k,E])=>E.filter(S=>!S.used).map(S=>({...S,_line:k})));if(!I.length){h.log.push({text:`❌ Aucun joueur ${w}`,type:"info"}),y(h);return}te(I,A,`Choisir ${A} joueur(s) ${w}(s) à exclure`,k=>{k.forEach(E=>{const S=(v[E._line]||[]).find(D=>D.cardId===E.cardId);S&&(S.used=!0,h.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),h[b+"Team"]=v,y(h)})},REVIVE_PLAYER:({count:A=1,roles:u=[]},x,h)=>{const y=x[i+"Team"],b=Object.entries(y).filter(([v])=>!u.length||u.includes(v)).flatMap(([v,w])=>w.filter(I=>I.used).map(I=>({...I,_line:v})));if(!b.length){x.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(x);return}te(b,A,`Choisir ${A} joueur(s) à ressusciter`,v=>{v.forEach(w=>{const I=(y[w._line]||[]).find(k=>k.cardId===w.cardId);I&&(I.used=!1,x.log.push({text:`💫 ${I.name} ressuscité !`,type:"info"}))}),x[i+"Team"]=y,h(x)})},REMOVE_GOAL:({},A,u)=>{const x=a+"Score";A[x]>0?(A[x]--,A.log.push({text:"🚫 Dernier but annulé !",type:"info"})):A.log.push({text:"🚫 Aucun but à annuler",type:"info"}),u(A)},ADD_GOAL_DRAW:({},A,u)=>{A[i+"Score"]===A[a+"Score"]?(A[i+"Score"]++,A.log.push({text:"🎯 But bonus !",type:"info"})):A.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),u(A)},ADD_SUB:({value:A=1},u,x)=>{u.maxSubs=(u.maxSubs||3)+A,u.log.push({text:`🔄 +${A} remplacement(s)`,type:"info"}),x(u)},CUSTOM:({},A,u)=>u(A)};function te(A,u,x,h){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function v(){var I,k;const w=A.map(E=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E._line]||"#555",D=we(E,E._line)+(E.boost||0),le=b.find(N=>N.cardId===E.cardId)?"#FFD700":"rgba(255,255,255,0.25)",Z=E.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${E.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${le};background:${S};overflow:hidden;cursor:pointer;${Z}">
        ...
        </div>`,(I=y.querySelector("#pp-close"))==null||I.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(E=>{E.addEventListener("click",()=>{const S=E.dataset.cid,D=A.find(le=>le.cardId===S),W=b.findIndex(le=>le.cardId===S);D&&(W>-1?b.splice(W,1):b.length<u&&b.push(D),v())})}),(k=y.querySelector("#pp-confirm"))==null||k.addEventListener("click",()=>{y.remove(),h(b)})}v(),document.body.appendChild(y)}async function z(A,u){const h=(o["gcCardsFull_"+i]||[]).find(w=>w.id===A),y=(h==null?void 0:h._gcDef)||(o.gcDefs||[]).find(w=>{var I;return w.name===u||((I=w.name)==null?void 0:I.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b=[...o["usedGc_"+i]||[],A],v={type:u,by:i,seq:(o._gcAnimSeq||0)+1};P.add(v.seq),xe(u,i,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const I=ue[y.effect_type];if(I){const k={...o};I(y.effect_params||{},k,async E=>{E["usedGc_"+i]=b,E._lastGC=v,E._gcAnimSeq=v.seq,await G(E)});return}}const w={...o};switch(u){case"Remplacement+":w.maxSubs=(w.maxSubs||3)+1,w.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const I=a+"Score";w[I]>0&&(w[I]--,w.log.push({text:"🚫 But annulé",type:"info"}));break}}w["usedGc_"+i]=b,w._lastGC=v,w._gcAnimSeq=v.seq,await G(w)})}function K(A,u){const x="usedCardIds_"+A,h=new Set(o[x]||[]);u.forEach(y=>h.add(y)),o[x]=[...h]}function ie(){for(const A of["p1","p2"]){const u=new Set(o["usedCardIds_"+A]||[]),x=o[A+"Team"];if(x)for(const h of["GK","DEF","MIL","ATT"])(x[h]||[]).forEach(y=>{y.used=u.has(y.cardId)})}}function B(){var Fe,Qe,mt,xt,yt,ht;if(o.phase==="reveal")return J();if(o.phase==="midfield")return de();if(o.phase==="finished")return He();const A=o[i+"Team"],u=o[a+"Team"];ie();const x=o[i+"Score"],h=o[a+"Score"],y=o[i+"Name"],b=o[a+"Name"],v=o.phase===i+"-attack",w=o.phase===i+"-defense",I=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],k=I.map(X=>X.cardId),E=window.innerWidth>=700,S=o[i+"Subs"]||[],D=o["usedSubIds_"+i]||[],W=S.filter(X=>!D.includes(X.cardId)),le=o["gcCardsFull_"+i]||[],Z=o["usedGc_"+i]||[],N=le.filter(X=>!Z.includes(X.id)),U=o.boostOwner===i&&!o.boostUsed,ee=!["GK","DEF","MIL","ATT"].some(X=>(u[X]||[]).some(q=>!q.used)),se=[...A.MIL||[],...A.ATT||[]].filter(X=>!X.used),ce=v&&ee&&se.length===0?[...A.GK||[],...A.DEF||[]].filter(X=>!X.used).map(X=>X.cardId):[];function pe(X,q,oe){var jt,wt;const ae=X._gcDef,me={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ae==null?void 0:ae.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ye={purple:"#b06ce0",light_blue:"#00d4ef"}[ae==null?void 0:ae.color]||"#b06ce0",We=(ae==null?void 0:ae.name)||X.gc_type,Je=(ae==null?void 0:ae.effect)||((jt=Ge[X.gc_type])==null?void 0:jt.desc)||"",et=ae!=null&&ae.image_url?`/manager-wars/icons/${ae.image_url}`:null,St=((wt=Ge[X.gc_type])==null?void 0:wt.icon)||"⚡",Ct=Math.round(oe*.22),bt=Math.round(oe*.22),lt=oe-Ct-bt,vt=We.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
      ...
      </div>`}function fe(X,q){return`<div id="pvp-boost-card"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${dt(A,o[i+"Formation"],je,k,300,300,ce)}
      </div>
        ...
        </div>`}return`<div style="font-size:11px;color:${X.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${X.type==="goal"?700:400};padding:3px 2px">${X.text||""}</div>`}const Ue=(()=>{var q,oe;if(w&&((q=o.pendingAttack)!=null&&q.players)){const ae=o.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;function Ce(){const X=e.querySelector(".match-screen");if(!X)return;const q=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=q+"px",X.style.minHeight=q+"px",X.style.maxHeight=q+"px",X.style.overflow="hidden";const oe=e.querySelector("#mobile-action-bar"),ae=e.querySelector("#mobile-play-area");oe&&ae&&(ae.style.paddingBottom=oe.offsetHeight+"px")}if(Ce(),setTimeout(Ce,120),setTimeout(Ce,400),L||(L=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Ce),window.visualViewport.addEventListener("scroll",Ce)),window.addEventListener("resize",Ce)),function(){const q=e.querySelector(".terrain-wrapper svg");q&&(q.removeAttribute("width"),q.removeAttribute("height"),q.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",q.setAttribute("viewBox","-26 -26 352 352"),q.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!v&&!w)return;const q=X.dataset.cardId,oe=X.dataset.role,ae=(A[oe]||[]).find(Je=>Je.cardId===q);if(!ae||ae.used)return;const me=ce.includes(q);if(v&&!["MIL","ATT"].includes(oe)&&!me)return;Array.isArray(o["selected_"+i])||(o["selected_"+i]=[]);const Ye=o["selected_"+i],We=Ye.findIndex(Je=>Je.cardId===q);We>-1?Ye.splice(We,1):Ye.length<3&&Ye.push({...ae,_role:oe}),B()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>O(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>O())}),(Fe=e.querySelector("#pvp-sub-open"))==null||Fe.addEventListener("click",()=>O()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{X.addEventListener("click",()=>ye(X.dataset.gcId,X.dataset.gcType))}),(Qe=e.querySelector("#pvp-boost-card"))==null||Qe.addEventListener("click",()=>R()),(mt=e.querySelector("#pvp-action"))==null||mt.addEventListener("click",X=>{v?X.currentTarget.dataset.pass==="1"||!Ee(i)?ge():re():w&&Te()}),(xt=e.querySelector("#pvp-quit"))==null||xt.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&ne()}),(yt=e.querySelector("#pvp-view-opp"))==null||yt.addEventListener("click",()=>H()),(ht=e.querySelector("#pvp-toggle-history"))==null||ht.addEventListener("click",()=>Q()),M&&(clearInterval(M),M=null),(v||w)&&!_){let X=30,q=!1;const oe=()=>document.getElementById("pvp-timer"),ae=()=>{oe()&&(oe().textContent=X+"s",oe().style.color=q?"#ff4444":"#fff")};ae(),M=setInterval(()=>{X--,X<0?q?(clearInterval(M),M=null,v&&!Ee(i)?ge():ne()):(q=!0,X=15,ae()):ae()},1e3)}}function J(){Xe(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(b);let I=!1;const k=()=>{I||(I=!0,b.remove(),setTimeout(()=>y(),50))};b.addEventListener("click",k),setTimeout(k,3500)}function xe(A,u,x){var Z,N;const h=(o.gcDefs||[]).find(U=>{var ee;return U.name===A||((ee=U.name)==null?void 0:ee.toLowerCase().trim())===(A==null?void 0:A.toLowerCase().trim())}),y={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",b={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",v=(h==null?void 0:h.name)||A,w=(h==null?void 0:h.effect)||((Z=Ge[A])==null?void 0:Z.desc)||"",I=h!=null&&h.image_url?`/manager-wars/icons/${h.image_url}`:null,k=((N=Ge[A])==null?void 0:N.icon)||"⚡",S=u===i?"Vous":o[u+"Name"]||"Adversaire",D=document.createElement("div");D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",D.innerHTML=`
      <style>
      ...
      <div style="width:min(90vw,420px)">${st(o[a+"Team"],o[a+"Formation"],null,[],300,300)}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(A),(u=A.querySelector("#pvp-opp-close"))==null||u.addEventListener("click",()=>A.remove())}function Q(){var x;const A=o.log||[],u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",u.innerHTML=`
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),i=(l||[]).filter(R=>R.card_type==="player"&&R.player),a=(l||[]).filter(R=>R.card_type==="game_changer"),f=(l||[]).filter(R=>R.card_type==="formation"),{data:m}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(m||[]).forEach(R=>{g[R.name]=R});const $=Object.keys(oi),o=Object.keys(Ge),_={};i.forEach(R=>{const O=R.player.id;_[O]=(_[O]||0)+1}),new Set(Object.keys(_).map(R=>String(R)));const M=new Set(f.map(R=>R.formation)),L=new Set(a.map(R=>R.gc_type));let F="player",P="Tous",j="",C=!1;function G(){return[...i].sort((R,O)=>{const V=Ft.indexOf(R.player.job),H=Ft.indexOf(O.player.job);return V!==H?V-H:(R.player.surname_encoded||"").localeCompare(O.player.surname_encoded||"")})}function ne(){return[...c||[]].sort((R,O)=>{const V=Ft.indexOf(R.job),H=Ft.indexOf(O.job);return V!==H?V-H:(R.surname_encoded||"").localeCompare(O.surname_encoded||"")})}function ue(){return G().filter(R=>{const O=R.player,V=P==="Tous"||O.job===P,H=!j||`${O.firstname} ${O.surname_encoded}`.toLowerCase().includes(j);return V&&H})}function te(){return ne().filter(R=>{const O=P==="Tous"||R.job===P,V=!j||`${R.firstname} ${R.surname_encoded}`.toLowerCase().includes(j);return O&&V})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{C=!C,z(),K()})))}function K(){const R=document.getElementById("col-grid");R&&(F==="player"?he(R):F==="formation"?xe(R):ye(R))}function ie(R,O,V,H,Q){Q=Q||"#7a28b8";const ge=document.getElementById("col-grid"),re=document.getElementById("col-big");if(!ge||!re)return;var Te=0;function ke(){re.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+O(R[Te])+"</div>";var $e=re.querySelector("[data-card-id],[data-form-id],[data-gc-id]");$e&&$e.addEventListener("click",function(){H(R[Te])}),requestAnimationFrame(function(){var _e=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!_e||!re)){var Ee=re.clientHeight-8,Ae=re.clientWidth-24,qe=_e.offsetHeight,Ne=_e.offsetWidth;if(qe>0&&Ne>0&&Ee>40){var He=Math.min(Ee/qe,Ae/Ne,1);_e.style.transform="scale("+He.toFixed(3)+")",_e.style.transformOrigin="top center"}}}),ge.innerHTML=R.map(function(_e,Ee){return'<div class="col-mini-item" data-idx="'+Ee+'" style="flex-shrink:0;cursor:pointer;border-radius:8px;border:1.5px solid '+(Ee===Te?Q:"transparent")+';transition:border-color .15s;overflow:hidden">'+V(_e,Ee===Te)+"</div>"}).join(""),ge.querySelectorAll(".col-mini-item").forEach(function(_e){_e.addEventListener("click",function(){Te=Number(_e.dataset.idx),ke(),_e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}ke()}function B(R){var O=.54,V=Math.round(140*O),H=Math.round(310*O),Q;if(!R||R._fake){var ge=R?R.player:null;if(!ge)return"";Q=vi(ge)}else Q=Vt(R,"");return'<div style="width:'+V+"px;height:"+H+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+O+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+Q+"</div></div>"}function J(R,O,V){O=O||100,V=V||140;var H=Mt[R]||{},Q={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ge=Math.max(3,Math.round(O*.06)),re=Object.entries(H).map(function(ke){var $e=ke[0],_e=ke[1],Ee=$e.replace(/\d+$/,""),Ae=Q[Ee]||"#888",qe=Math.round(_e.x*O),Ne=Math.round(_e.y*V);return'<circle cx="'+qe+'" cy="'+Ne+'" r="'+ge+'" fill="'+Ae+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),Te=Math.max(1,Math.round(O/50));return'<svg viewBox="0 0 '+O+" "+V+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+O+'" height="'+V+'" fill="#1A6B3C"/><rect x="'+Math.round(O*.2)+'" y="'+Math.round(V*.02)+'" width="'+Math.round(O*.6)+'" height="'+Math.round(V*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Te+'"/><line x1="0" y1="'+Math.round(V*.5)+'" x2="'+O+'" y2="'+Math.round(V*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+Te+'"/><ellipse cx="'+Math.round(O*.5)+'" cy="'+Math.round(V*.5)+'" rx="'+Math.round(O*.18)+'" ry="'+Math.round(V*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+Te+'"/><rect x="'+Math.round(O*.2)+'" y="'+Math.round(V*.82)+'" width="'+Math.round(O*.6)+'" height="'+Math.round(V*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Te+'"/>'+re+"</svg>"}function Y(R,O,V){var H=V>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+V+"</div>":"",Q=O?'data-form-id="'+O.id+'"':"",ge=R.length>7?14:R.length>5?16:19,re=!!O;return"<div "+Q+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(re?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(re?"":"filter:grayscale(1);opacity:0.5")+'">'+H+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(re?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ge+"px;font-weight:900;color:"+(re?"#1A6B3C":"#aaa")+';line-height:1">'+R+'</div></div><div style="flex:1;overflow:hidden;background:'+(re?"#1A6B3C":"#ccc")+'">'+J(R,140,220)+"</div></div>"}function de(R,O){var V=.54,H=Math.round(140*V),Q=Math.round(305*V),ge=Math.round(Q*.22),re=Q-ge,Te=R.length>7?5:7,ke=J(R,H,re),$e=O?"1.5px solid #2a7a40":"1px solid #ddd",_e=O?"":"filter:grayscale(1);opacity:0.45;",Ee=O?"#1A6B3C":"#bbb",Ae="#fff";return'<div style="width:'+H+"px;height:"+Q+"px;border-radius:6px;border:"+$e+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+_e+'"><div style="height:'+ge+"px;background:"+Ee+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+Te+"px;font-weight:900;color:"+Ae+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(H-4)+'px">'+R+'</span></div><div style="height:'+re+'px;overflow:hidden;flex-shrink:0">'+ke+"</div></div>"}function he(R){if(C){const O=te();if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const V=O.map(H=>i.find(Q=>Q.player.id===H.id)||{_fake:!0,player:H,id:"fake-"+H.id});ie(V,H=>H._fake?vi(H.player):Vt(H,""),H=>H._fake?B({player:H.player,id:"x",_fake:!0}):B(H),H=>{H._fake||wi(H,i,_,t)},"#1A6B3C")}else{const O=ue();if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const V={},H=[];O.forEach(Q=>{V[Q.player.id]||(V[Q.player.id]=!0,H.push(Q))}),ie(H,Q=>{const ge=_[Q.player.id]||1,re=ge>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ge}</div>`:"",ke=i.filter($e=>$e.player.id===Q.player.id&&$e.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Vt(Q,re+ke)},Q=>B(Q),Q=>wi(Q,i,_,t),"#1A6B3C")}}function xe(R){const O=C?$:[...M];if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const V=O.map(H=>({formation:H,card:f.find(Q=>Q.formation===H)||null,owned:M.has(H)}));ie(V,({formation:H,card:Q,owned:ge})=>Y(H,ge?Q:null,ge?f.filter(re=>re.formation===H).length:0),({formation:H,owned:Q})=>de(H,Q),({card:H,owned:Q})=>{Q&&H&&An(H,f,t,d)},"#1A6B3C")}function ye(R){const O=Object.keys(g),V=C?O.length?O:o:[...L];if(!V.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const H=V.map(Q=>({type:Q,gc:Ge[Q]||{icon:"⚡",desc:""},def:g[Q]||null,owned:L.has(Q),card:a.find(ge=>ge.gc_type===Q)||null}));ie(H,({type:Q,gc:ge,def:re,owned:Te,card:ke})=>{const $e=Te?a.filter(x=>x.gc_type===Q).length:0,_e=$e>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${$e}</div>`:"",Ee=(re==null?void 0:re.gc_type)==="ultra_game_changer",Ae={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},qe={purple:"#b06ce0",light_blue:"#00d4ef"},Ne=Ae[re==null?void 0:re.color]||Ae.purple,He=qe[re==null?void 0:re.color]||qe.purple,A=(re==null?void 0:re.effect)||ge.desc||"",u=re!=null&&re.image_url?`/manager-wars/icons/${re.image_url}`:null;return Te&&ke?`<div data-gc-id="${ke.id}" data-gc-type="${Q}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${He};background:${Ne};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${He}66;cursor:pointer">
          ${_e}
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const _t=1e3;function An(e,t,n,r){var o,_,M;const{state:p,toast:d,closeModal:s,navigate:l,refreshProfile:c}=n,i=e.formation,a={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const L=Mt[i]||{},F=oi[i]||[],P=290,j=360,C=20;function G(ue){const te=L[ue];return te?{x:te.x*P,y:te.y*j}:null}let ne=`<svg width="${P}" height="${j}" viewBox="0 0 ${P} ${j}" xmlns="http://www.w3.org/2000/svg">`;for(const[ue,te]of F){const z=G(ue),K=G(te);!z||!K||(ne+=`<line x1="${z.x}" y1="${z.y}" x2="${K.x}" y2="${K.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const ue of Object.keys(L)){const te=G(ue);if(!te)continue;const z=ue.replace(/\d+/,""),K=a[z]||"#555";ne+=`<circle cx="${te.x}" cy="${te.y}" r="${C}" fill="${K}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,ne+=`<text x="${te.x}" y="${te.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${z}</text>`}return ne+="</svg>",ne}const m=t.filter(L=>L.formation===i),g=m.length,$=!e.is_for_sale;r(`Formation ${i}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(o=document.getElementById("direct-sell-form-btn"))==null||o.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${i} pour ${_t.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const L=m.find(P=>!P.is_for_sale)||m[0];if(!L){d("Aucune carte à vendre","error");return}const{error:F}=await T.from("cards").delete().eq("id",L.id);if(F){d(F.message,"error");return}await T.from("users").update({credits:(p.profile.credits||0)+_t}).eq("id",p.profile.id),await c(),d(`+${_t.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),l("collection")}),(_=document.getElementById("market-sell-form-btn"))==null||_.addEventListener("click",async()=>{const L=parseInt(document.getElementById("sell-price-form").value);if(!L||L<1){d("Prix invalide","error");return}await T.from("cards").update({is_for_sale:!0,sale_price:L}).eq("id",e.id),await T.from("market_listings").insert({seller_id:p.profile.id,card_id:e.id,price:L}),d("Carte mise en vente sur le marché !","success"),s(),l("collection")}),(M=document.getElementById("cancel-sell-form-btn"))==null||M.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),s(),l("collection")})}async function wi(e,t,n,r){var te,z,K,ie,B,J;const{state:p,toast:d,openModal:s,closeModal:l,navigate:c,refreshProfile:i}=r,a=e.player,f=t.filter(Y=>Y.player.id===a.id),m=f.length,g=$n[a.rarity]||1e3,$=a.rarity!=="legende",o=Gi(a),_=zt(a,a.job),M=a.job2?zt(a,a.job2):null,L=At[a.job]||"#1A6B3C",F=a.job2?At[a.job2]:null,P=Di[a.rarity]||"#ccc",j=ci[a.country_code]||a.country_code||"",C=f.map(Y=>Y.id);let G={};if(C.length){const{data:Y}=await T.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",C).order("transferred_at",{ascending:!0});(Y||[]).forEach(de=>{G[de.card_id]||(G[de.card_id]=[]),G[de.card_id].push(de)})}const ne=Y=>`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",a.note_g],["DEF",a.note_d],["MIL",a.note_m],["ATT",a.note_a]].map(([Y,de])=>{const he=At[Y],xe=Number(de)||0;return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px">
  ...
  `,document.body.appendChild(p);let d=!1;const s=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let c=!1;const i=B=>B.touches&&B.touches[0]?B.touches[0].clientX:B.clientX;function a(B){d||(c=!0,l.style.opacity="1",f(B))}function f(B){if(!c||d)return;const J=s.getBoundingClientRect(),Y=i(B)-J.left,de=Math.max(0,Math.min(1,Y/J.width));l.style.width=de*J.width+"px",de>=.82&&g()}function m(){d||(c=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{d||(l.style.transition="")},220))}function g(){var J;if(d)return;d=!0,c=!1,l.style.width="100%",l.style.opacity="1",(J=document.getElementById("cut-flash"))==null||J.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const B=document.getElementById("cut-hint");B&&(B.style.opacity="0"),s.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",M(0)},620)}s.addEventListener("pointerdown",a),window.addEventListener("pointermove",f),window.addEventListener("pointerup",m),s.addEventListener("touchstart",a,{passive:!0}),window.addEventListener("touchmove",f,{passive:!0}),window.addEventListener("touchend",m);let $=0,o=!1;const _=new Set;function M(B){$=B,document.getElementById("reveal-phase").style.display="flex",L(),F(B,0),ne()}function L(){const B=document.getElementById("card-dots");B&&(B.innerHTML=e.map((J,Y)=>`<div class="card-dot" data-i="${Y}" style="width:8px;height:8px;border-radius:50%;background:${Y===$?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),B.querySelectorAll(".card-dot").forEach(J=>J.addEventListener("click",()=>j(parseInt(J.dataset.i)))))}function F(B,J){var V;const Y=e[B],de=document.getElementById("card-counter"),he=document.getElementById("card-track");de&&(de.textContent=`Carte ${B+1} / ${e.length}`);const xe=Y.card_type==="player"&&((V=Y.player)==null?void 0:V.rarity)==="legende",ye=!_.has(B);_.add(B);let R=0;if(Y.card_type==="player"&&Y.player){const H=Y.player,Q=H.job||"ATT";R=Number(Q==="GK"?H.note_g:Q==="DEF"?H.note_d:Q==="MIL"?H.note_m:H.note_a)||0}const O=H=>{he.innerHTML=`
        ...
        </div>`;const Q=document.getElementById("current-card-wrap");J!==0?(Q.style.transition="none",Q.style.transform=`translateX(${J>0?100:-100}%)`,requestAnimationFrame(()=>{Q.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",Q.style.transform="translateX(0)"})):Q.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),H||xe?te():z(),L()};ye&&R>6&&Y.card_type==="player"&&Y.player?P(Y,()=>O(!0)):O(!1)}function P(B,J){var O;o=!0;const Y=B.player,de=`https://flagsapi.com/${Y.country_code}/flat/64.png`,he=(O=Y.clubs)==null?void 0:O.logo_url,xe=document.getElementById("walkout-overlay"),ye=document.getElementById("walkout-stage");if(!xe||!ye){o=!1,J();return}xe.style.display="flex";const R=()=>{const V=ye.firstElementChild;V&&(V.classList.remove("wo-in"),V.classList.add("wo-out"))};ye.innerHTML=`<img class="wo-in" src="${de}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(R,2e3),setTimeout(()=>{var V;ye.innerHTML=he?`<img class="wo-in" src="${he}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((V=Y.clubs)==null?void 0:V.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(R,4450),setTimeout(()=>{xe.style.display="none",ye.innerHTML="",o=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),J()},4900)}function j(B){if(o||B<0||B>=e.length||B===$)return;const J=B>$?1:-1;$=B,F(B,J)}function C(){j($+1)}function G(){j($-1)}function ne(){const B=document.getElementById("card-viewport");if(!B||B._swipeBound)return;B._swipeBound=!0;let J=0,Y=0,de=0,he=!1;const xe=H=>H.touches?H.touches[0].clientX:H.clientX,ye=H=>H.touches?H.touches[0].clientY:H.clientY,R=H=>{he=!0,J=xe(H),Y=ye(H),de=0},O=H=>{if(!he)return;de=xe(H)-J;const Q=ye(H)-Y;if(Math.abs(de)<Math.abs(Q))return;const ge=document.getElementById("current-card-wrap");ge&&(ge.style.transition="none",ge.style.transform=`translateX(${de*.6}px) rotate(${de*.02}deg)`)},V=()=>{if(!he)return;he=!1;const H=document.getElementById("current-card-wrap"),Q=55;de<=-Q&&$<e.length-1?C():de>=Q&&$>0?G():H&&(H.style.transition="transform .2s ease",H.style.transform="translateX(0)")};B.addEventListener("pointerdown",R),B.addEventListener("pointermove",O),B.addEventListener("pointerup",V),B.addEventListener("pointercancel",V),B.addEventListener("touchstart",R,{passive:!0}),B.addEventListener("touchmove",O,{passive:!0}),B.addEventListener("touchend",V),B.addEventListener("click",H=>{if(Math.abs(de)>8)return;const Q=B.getBoundingClientRect();H.clientX-Q.left>Q.width/2?C():G()})}let ue=null;function te(){const B=document.getElementById("fireworks-canvas");if(!B)return;B.width=window.innerWidth,B.height=window.innerHeight;const J=B.getContext("2d"),Y=[];function de(){const xe=Math.random()*B.width,ye=Math.random()*B.height*.6,R=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],O=R[Math.floor(Math.random()*R.length)];for(let V=0;V<60;V++){const H=Math.PI*2/60*V,Q=2+Math.random()*5;Y.push({x:xe,y:ye,vx:Math.cos(H)*Q,vy:Math.sin(H)*Q,alpha:1,color:O,size:2+Math.random()*3})}}de(),ue=setInterval(de,600);function he(){if(document.getElementById("fireworks-canvas")){J.clearRect(0,0,B.width,B.height);for(let xe=Y.length-1;xe>=0;xe--){const ye=Y[xe];if(ye.x+=ye.vx,ye.y+=ye.vy+.08,ye.vy*=.98,ye.alpha-=.018,ye.alpha<=0){Y.splice(xe,1);continue}J.globalAlpha=ye.alpha,J.fillStyle=ye.color,J.beginPath(),J.arc(ye.x,ye.y,ye.size,0,Math.PI*2),J.fill()}J.globalAlpha=1,(ue!==null||Y.length>0)&&requestAnimationFrame(he)}}he()}function z(){ue!==null&&(clearInterval(ue),ue=null);const B=document.getElementById("fireworks-canvas");B&&B.getContext("2d").clearRect(0,0,B.width,B.height)}if(r){const B=document.getElementById("reveal-phase"),J=B==null?void 0:B.querySelector('div[style*="display:flex"][style*="gap:10px"]');J&&(J.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(ie=document.getElementById("reveal-next"))==null||ie.addEventListener("click",()=>{z(),p.remove(),r()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{z(),p.remove(),n("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{z(),p.remove(),n("boosters")})}function Pn(e){var t,n;if(e.card_type==="player"&&e.player)return qn(e);if(e.card_type==="game_changer"){const r=e._gcDef,p=(r==null?void 0:r.gc_type)==="ultra_game_changer",d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},s={purple:"#b06ce0",light_blue:"#00d4ef"},l=d[r==null?void 0:r.color]||d.purple,c=s[r==null?void 0:r.color]||s.purple,i=(r==null?void 0:r.name)||e.gc_type||"Game Changer",a=(r==null?void 0:r.effect)||((t=Zt[e.gc_type])==null?void 0:t.desc)||"",f=r!=null&&r.image_url?`/manager-wars/icons/${r.image_url}`:null,m=((n=Zt[e.gc_type])==null?void 0:n.icon)||"⚡";return`<div style="width:170px;height:240px;background:${l};border-radius:14px;border:3px solid ${c};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${c}88;flex-shrink:0">
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${o.map((F,P)=>{const j=P<o.length-1?Ze(F,o[P+1]):null,C=!j||j==="#ff3333"||j==="#cc2222",G=j==="#00ff88"?"+2":j==="#FFD700"?"+1":"";return`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const z=window.innerWidth>=700,K=(R,O,V)=>{var Ne,He;const H=(t.gcDefs||[]).find(A=>A.name===R.gc_type),Q={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[H==null?void 0:H.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ge={purple:"#b06ce0",light_blue:"#00d4ef"}[H==null?void 0:H.color]||"#b06ce0",re=(H==null?void 0:H.name)||R.gc_type,Te=(H==null?void 0:H.effect)||((Ne=Ge[R.gc_type])==null?void 0:Ne.desc)||"",ke=H!=null&&H.image_url?`/manager-wars/icons/${H.image_url}`:null,$e=((He=Ge[R.gc_type])==null?void 0:He.icon)||"⚡",_e=Math.round(V*.22),Ee=Math.round(V*.22),Ae=V-_e-Ee,qe=re.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${O}px;height:${V}px;border-radius:10px;border:2px solid ${ge};background:${Q};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(z=>{var K,ie,B;if(z.type==="duel"){const J=z.isGoal,Y=z.homeScored?"#FFD700":J?"#ff6b6b":"rgba(255,255,255,0.3)",de=z.homeScored?"⚽ BUT !":J?"⚽ BUT IA !":(K=z.homePlayers)!=null&&K.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${J?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${Y};margin-bottom:4px">
  ...
  `,document.body.appendChild(r);let a=!1;const f=()=>{a||(a=!0,r.remove(),n())};r.addEventListener("click",f),setTimeout(f,2e3)}function $t(e,t="rgba(0,0,0,0.8)"){const n=document.createElement("div");n.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function Yt(e,t,n,r=null,p=null){var g,$;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([o,_])=>(_||[]).filter(M=>M.used).map(M=>({...M,_line:M._line||o}))),s=t.homeSubs.filter(o=>!t.usedSubIds.includes(o.cardId));if(!d.length){$t("Aucun joueur utilisé à remplacer");return}if(!s.length){$t("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(o=>o.cardId===p));const c=((g=d[l])==null?void 0:g._line)||(($=d[l])==null?void 0:$.job);let i=r?Math.max(0,s.findIndex(o=>o.cardId===r)):Math.max(0,s.findIndex(o=>o.job===c)),a=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function m(){var j,C,G,ne,ue,te;const o=d[l],_=s[i],M=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(M*1.35),F=z=>`background:rgba(255,255,255,0.12);border:none;color:${z?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${z?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(j=f.querySelector("#sub-close"))==null||j.addEventListener("click",()=>f.remove()),(C=f.querySelector("#out-up"))==null||C.addEventListener("click",()=>{l>0&&(l--,m())}),(G=f.querySelector("#out-down"))==null||G.addEventListener("click",()=>{l<d.length-1&&(l++,m())}),(ne=f.querySelector("#in-up"))==null||ne.addEventListener("click",()=>{i>0&&(i--,m())}),(ue=f.querySelector("#in-down"))==null||ue.addEventListener("click",()=>{i<s.length-1&&(i++,m())});const P=(z,K,ie,B)=>{const J=f.querySelector("#"+z);if(!J)return;let Y=0;J.addEventListener("touchstart",de=>{Y=de.touches[0].clientY},{passive:!0}),J.addEventListener("touchend",de=>{const he=de.changedTouches[0].clientY-Y;if(Math.abs(he)<30)return;const xe=K();he<0&&xe<B-1?(ie(xe+1),m()):he>0&&xe>0&&(ie(xe-1),m())},{passive:!0})};P("in-panel",()=>i,z=>i=z,s.length),P("out-panel",()=>l,z=>l=z,d.length),(te=f.querySelector("#sub-confirm"))==null||te.addEventListener("click",z=>{if(z.preventDefault(),z.stopPropagation(),a)return;a=!0;const K=d[l],ie=s[i];if(!K||!ie)return;let B=null,J=-1;for(const[de,he]of Object.entries(t.homeTeam)){const xe=(he||[]).findIndex(ye=>ye.cardId===K.cardId);if(xe!==-1){B=de,J=xe;break}}if(J===-1||!B){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const Y={...ie,_line:B,_col:K._col||0,used:!1,boost:0};t.homeTeam[B].splice(J,1,Y),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(ie.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:K.name,firstname:K.firstname,note:we(K,B),portrait:ze(K),job:K.job,country_code:K.country_code,rarity:K.rarity,clubName:K.clubName,clubLogo:K.clubLogo},inPlayer:{name:ie.name,firstname:ie.firstname,note:we(ie,B),portrait:ze(ie),job:ie.job,country_code:ie.country_code,rarity:ie.rarity,clubName:ie.clubName,clubLogo:ie.clubLogo},text:`🔄 ${ie.firstname} ${ie.name} remplace ${K.firstname} ${K.name}`}),f.remove(),so(K,ie,()=>Me(e,t,n))})}document.body.appendChild(f),m()}function lo(e,t,n,r,p){var $,o;const d=(r.gcDefs||[]).find(_=>_.name===t),s=Ge[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",c={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",i=(d==null?void 0:d.name)||t,a=(d==null?void 0:d.effect)||s.desc,f=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,m=s.icon||"⚡",g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",g.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const c=()=>{l||(l=!0,d.remove(),setTimeout(()=>p(),50))};d.addEventListener("click",c),setTimeout(c,3500)}async function Tt(e,t,n){var a,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:r}=n,p=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=p?"victoire":d?"nul":"defaite",l=pn(t.mode,s);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:p?r.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(r.profile.credits||0)+l,matches_played:(r.profile.matches_played||0)+1};p?c.wins=(r.profile.wins||0)+1:d?c.draws=(r.profile.draws||0)+1:c.losses=(r.profile.losses||0)+1,await T.from("users").update(c).eq("id",r.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let k=!1;const E=()=>{k||(k=!0,v.remove(),setTimeout(()=>b(),50))};v.addEventListener("click",E),setTimeout(E,3500)}function ye(u,x,h){var N,U;const y=(o.gcDefs||[]).find(ee=>{var se;return ee.name===u||((se=ee.name)==null?void 0:se.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",w=(y==null?void 0:y.name)||u,I=(y==null?void 0:y.effect)||((N=Ge[u])==null?void 0:N.desc)||"",k=y!=null&&y.image_url?`/manager-wars/icons/${y.image_url}`:null,E=((U=Ge[u])==null?void 0:U.icon)||"⚡",D=x===i?"Vous":o[x+"Name"]||"Adversaire",W=document.createElement("div");W.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",W.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(fe=D.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>D.remove()),(be=D.querySelector("#pout-up"))==null||be.addEventListener("click",()=>{I>0&&(I--,W())}),(Se=D.querySelector("#pout-down"))==null||Se.addEventListener("click",()=>{I<v.length-1&&(I++,W())}),(Re=D.querySelector("#pin-up"))==null||Re.addEventListener("click",()=>{E>0&&(E--,W())}),(Be=D.querySelector("#pin-down"))==null||Be.addEventListener("click",()=>{E<w.length-1&&(E++,W())});const pe=(Le,je,De,Pe)=>{const Ue=D.querySelector("#"+Le);if(!Ue)return;let Ke=0;Ue.addEventListener("touchstart",Ce=>{Ke=Ce.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ce=>{const Fe=Ce.changedTouches[0].clientY-Ke;if(Math.abs(Fe)<30)return;const Qe=je();Fe<0&&Qe<Pe-1?(De(Qe+1),W()):Fe>0&&Qe>0&&(De(Qe-1),W())},{passive:!0})};pe("pin-panel",()=>E,Le=>E=Le,w.length),pe("pout-panel",()=>I,Le=>I=Le,v.length),(Ie=D.querySelector("#psub-confirm"))==null||Ie.addEventListener("click",async Le=>{if(Le.preventDefault(),Le.stopPropagation(),S)return;S=!0;const je=v[I],De=w[E];if(!je||!De)return;const Pe=je._line,Ue=(h[Pe]||[]).findIndex(Fe=>Fe.cardId===je.cardId);if(Ue===-1){c("Erreur : joueur introuvable","error"),D.remove();return}const Ke={...De,_line:Pe,position:je.position,used:!1,boost:0};h[Pe].splice(Ue,1,Ke);const Ce=[...y,De.cardId];D.remove(),H(je,De,async()=>{await ne({[i+"Team"]:h,[a+"Team"]:o[a+"Team"],["usedSubIds_"+i]:Ce})})})}document.body.appendChild(D),W()}function H(u,x,h){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(k,E,S)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(b);let w=!1;const I=()=>{w||(w=!0,b.remove(),setTimeout(()=>h(),50))};b.addEventListener("click",I),setTimeout(I,2200)}function Q(){var x;const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",u.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${o[a+"Name"]}</div>
      <div style="width:min(90vw,420px)">${st(o[a+"Team"],o[a+"Formation"],null,[],300,300)}</div>
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-home" style="padding:16px 40px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏠 Retour</button>
    </div>`,(b=document.getElementById("pvp-home"))==null||b.addEventListener("click",()=>{try{T.removeChannel(G)}catch{}Oe(e),l("home")})}J()}const yo={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function ho(e,t){const{state:n,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await fi(e,t)}async function fi(e,t){const{state:n,toast:r}=t,{data:p}=await T.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function c(i){const a=document.getElementById("mkt-content"),f=i==="buy"?s:l;if(f.length===0){a.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${m.map(g=>{var F,P,j,C;const $=(F=g.card)==null?void 0:F.player;if(!$)return"";const o=$.job==="GK"?$.note_g:$.job==="DEF"?$.note_d:$.job==="MIL"?$.note_m:$.note_a,_=yo[$.rarity],M=(n.profile.credits||0)>=g.price,L=g.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${L?"opacity:0.65":""}">
