import{s as E,F as xi,h as Pt,j as Yi,l as at,i as zn,k as Sn,b as Ln}from"./formation-links-DJC25wD7.js";const In="/manager-wars/";function Li(e,{navigate:t,toast:i}){let s="login";const c=()=>{var a,l,p,n,o,g;const d=s==="login";e.innerHTML=`
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),n=(l||[]).filter(R=>R.card_type==="player"&&R.player),o=(l||[]).filter(R=>R.card_type==="game_changer"),g=(l||[]).filter(R=>R.card_type==="formation"),v=(l||[]).filter(R=>R.card_type==="stadium"),{data:y}=await E.from("gc_definitions").select("name,gc_type,color,effect,image_url"),T={};(y||[]).forEach(R=>{T[R.name]=R});const{data:r}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(r||[]).forEach(R=>{u[R.id]=R}),v.forEach(R=>{R.stadium_def&&(u[R.stadium_id]=R.stadium_def)});const M=Object.keys(xi),L=Object.keys(Ke),N={};n.forEach(R=>{const Z=R.player.id;N[Z]=(N[Z]||0)+1}),new Set(Object.keys(N).map(R=>String(R)));const K=new Set(g.map(R=>R.formation)),C=new Set(o.map(R=>R.gc_type));let q="player",D="Tous",X="",se=!1;function oe(){return[...n].sort((R,Z)=>{const ge=Ut.indexOf(R.player.job),me=Ut.indexOf(Z.player.job);return ge!==me?ge-me:(R.player.surname_encoded||"").localeCompare(Z.player.surname_encoded||"")})}function P(){return[...p||[]].sort((R,Z)=>{const ge=Ut.indexOf(R.job),me=Ut.indexOf(Z.job);return ge!==me?ge-me:(R.surname_encoded||"").localeCompare(Z.surname_encoded||"")})}function J(){return oe().filter(R=>{const Z=R.player,ge=D==="Tous"||Z.job===D,me=!X||`${Z.firstname} ${Z.surname_encoded}`.toLowerCase().includes(X);return ge&&me})}function U(){return P().filter(R=>{const Z=D==="Tous"||R.job===D,ge=!X||`${R.firstname} ${R.surname_encoded}`.toLowerCase().includes(X);return Z&&ge})}e.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),p=[...new Set((l||[]).filter(v=>{var y,T;return((y=v.card)==null?void 0:y.card_type)==="stadium"&&((T=v.card)==null?void 0:T.stadium_id)}).map(v=>v.card.stadium_id))],n={};if(p.length){const{data:v}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",p);(v||[]).forEach(y=>{n[y.id]=y}),(l||[]).forEach(y=>{var T,r;((T=y.card)==null?void 0:T.card_type)==="stadium"&&((r=y.card)!=null&&r.stadium_id)&&(y.card._stadiumDef=n[y.card.stadium_id]||null)})}let o=0;function g(){var C,q,D,X,se,oe,P;const v=d[o],y=(l||[]).filter(J=>J.deck_id===v.id),T=y.filter(J=>{var U;return J.is_starter&&((U=J.card)==null?void 0:U.player)}).map(J=>ui(J.card,J.position)),r=y.find(J=>{var U;return((U=J.card)==null?void 0:U.card_type)==="formation"}),u=v.formation||((C=r==null?void 0:r.card)==null?void 0:C.formation)||"4-4-2";let M=T.length>=11?yt(T,u):null,L=((q=v.stadium_card)==null?void 0:q.stadium_def)||null;L&&M&&(M=Ei(M,L));const N=T.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">
        ${d.map((J,U)=>`<div style="width:7px;height:7px;border-radius:50%;background:${U===o?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}
      </div>`:""}
