import{s as h,l as U,F as ie,b as $e,c as me,d as dt}from"./formation-links-CDBKB_z4.js";function Ce(e,{navigate:t,toast:i}){e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",a=>{a.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(a=>{a.addEventListener("click",()=>{n(),e("match",{matchMode:a.dataset.mode})})})}const oe={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function F(e,t){if(!e)return 0;switch(t){case"GK":return Number(e.note_g)||0;case"DEF":return Number(e.note_d)||0;case"MIL":return Number(e.note_m)||0;case"ATT":return Number(e.note_a)||0;default:return 0}}function Ke(e){let t=0;for(let i=0;i<e.length-1;i++){const n=e[i],a=e[i+1];if(!n||!a)continue;const o=U(n,a);o==="#00ff88"?t+=2:o==="#FFD700"&&(t+=1)}return t}function He(e,t={}){const i=e.reduce((o,s)=>{const d=s._line||s.job;return o+(Number(d==="MIL"?s.note_m:s.note_a)||0)+(Number(s.boost)||0)},0),n=Ke(e);let a=i+n;return t.doubleAttack&&(a*=2),t.stolenNote&&(a-=t.stolenNote),{base:i,links:n,total:Math.max(0,a)}}function Ue(e,t={}){const i=e.reduce((o,s)=>{const d=s._line||s.job;let r=0;return d==="GK"?r=Number(s.note_g)||0:d==="MIL"?r=Number(s.note_m)||0:r=Number(s.note_d)||0,o+r+(Number(s.boost)||0)},0),n=Ke(e);let a=i+n;return t.stolenNote&&(a-=t.stolenNote),{base:i,links:n,total:Math.max(0,a)}}function Ve(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function Ye(e,t,i="easy"){const n=e.filter(s=>!s.used);if(!n.length)return[];const a=[...n].sort((s,d)=>{const r=t==="attack"?F(s,"ATT"):s._line==="GK"?F(s,"GK"):F(s,"DEF");return(t==="attack"?F(d,"ATT"):d._line==="GK"?F(d,"GK"):F(d,"DEF"))-r});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return a.slice(0,Math.min(o,a.length,3))}function ft(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const We={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},fe={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},ae=["GK","DEF","MIL","ATT"],ut=["Tous","GK","DEF","MIL","ATT"],gt={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4},_e={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Je(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ne(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Se(e,t=""){var p,f;const i=e.player;if(!i)return"";const n=i.job||"ATT",a=fe[n],o=We[i.rarity]||"#ccc",s=ne(i,n),d=i.job2?ne(i,i.job2):null,r=i.job2?fe[i.job2]:null,l=Je(i),c=_e[i.country_code]||i.country_code||"";return`
  <div style="
  ...
  </div>`}function mt(e){const t=e.job||"ATT",i=ne(e,t),n=_e[e.country_code]||e.country_code||"";return`
  <div style="
    width:140px;border-radius:12px;padding:6px;
  ...
  </div>`}async function yt(e,t){const{state:i,navigate:n,toast:a,openModal:o,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await h.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length, sell_price,
        clubs(encoded_name, logo_url))`).eq("owner_id",i.profile.id),{data:r}=await h.from("players").select(`id, firstname, surname_encoded, country_code, club_id, job, job2,
      note_g, note_d, note_m, note_a, rarity, note_min, note_max, skin, hair, hair_length,
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(d||[]).filter(I=>I.card_type==="player"&&I.player),c=(d||[]).filter(I=>I.card_type==="game_changer"),p=(d||[]).filter(I=>I.card_type==="formation"),f=Object.keys(ie),u=Object.keys(oe),x={};l.forEach(I=>{const L=I.player.id;x[L]=(x[L]||0)+1});const $=new Set(Object.keys(x).map(I=>String(I))),w=new Set(p.map(I=>I.formation)),k=new Set(c.map(I=>I.gc_type));let b="player",g="Tous",m="",v=!1;function y(){return[...l].sort((I,L)=>{const M=ae.indexOf(I.player.job),B=ae.indexOf(L.player.job);return M!==B?M-B:(I.player.surname_encoded||"").localeCompare(L.player.surname_encoded||"")})}function _(){return[...r||[]].sort((I,L)=>{const M=ae.indexOf(I.job),B=ae.indexOf(L.job);return M!==B?M-B:(I.surname_encoded||"").localeCompare(L.surname_encoded||"")})}function E(){return y().filter(I=>{const L=I.player,M=g==="Tous"||L.job===g,B=!m||`${L.firstname} ${L.surname_encoded}`.toLowerCase().includes(m);return M&&B})}function A(){return _().filter(I=>{const L=g==="Tous"||I.job===g,M=!m||`${I.firstname} ${I.surname_encoded}`.toLowerCase().includes(m);return L&&M})}e.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:flex-start" id="col-grid"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",L=>{m=L.target.value.toLowerCase(),z()}),e.querySelectorAll(".filter-btn").forEach(L=>{L.addEventListener("click",()=>{g=L.dataset.job,T(),z()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{v=!v,T(),z()})):(I.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{v=!v,T(),z()})))}function z(){const I=document.getElementById("col-grid");I&&(b==="player"?C(I):b==="formation"?R(I):q(I))}function C(I){if(v){const L=A();if(!L.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}I.innerHTML=L.map(M=>{if($.has(String(M.id))){const S=l.find(H=>H.player.id===M.id),D=x[M.id]||1,P=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",K=l.filter(H=>H.player.id===M.id&&H.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Se(S,P+K)}return mt(M)}).join("")}else{const L=E();if(!L.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const M={},B=[];L.forEach(S=>{const D=S.player.id;M[D]||(M[D]=!0,B.push(S))}),I.innerHTML=B.map(S=>{const D=x[S.player.id]||1,P=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",K=l.filter(H=>H.player.id===S.player.id&&H.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Se(S,P+K)}).join("")}I.querySelectorAll("[data-card-id]").forEach(L=>{L.addEventListener("click",()=>{const M=l.find(B=>B.id===L.dataset.cardId);M&&bt(M,l,x,t)})})}function R(I){const L=v?f:[...w];if(!L.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}I.innerHTML=L.map(M=>{if(w.has(M)){const S=p.find(O=>O.formation===M),D=p.filter(O=>O.formation===M).length,P=D>1?`<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"";return`
        ...
        <div style="
          ...
          <div style="font-weight:900;font-size:18px">${M}</div>
        </div>`}).join(""),I.querySelectorAll("[data-form-id]").forEach(M=>{M.addEventListener("click",()=>{const B=p.find(S=>S.id===M.dataset.formId);B&&vt(B,p,t,o)})})}function q(I){const L=v?u:[...k];if(!L.length){I.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}I.innerHTML=L.map(M=>{const B=k.has(M),S=oe[M]||{icon:"⚡"};if(B){const D=c.find(K=>K.gc_type===M),P=c.filter(K=>K.gc_type===M).length,O=P>1?`<div style="position:absolute;top:4px;right:4px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${P}</div>`:"";return`
        ...
        <div style="
          ...
          <div style="font-weight:700;font-size:13px">${M}</div>
        </div>`}).join(""),I.querySelectorAll("[data-gc-id]").forEach(M=>{M.addEventListener("click",()=>xt(M.dataset.gcType,o))})}e.querySelectorAll(".col-tab-btn").forEach(I=>{I.addEventListener("click",()=>{b=I.dataset.tab,g="Tous",m="",v=!1,e.querySelectorAll(".col-tab-btn").forEach(L=>{const M=L.dataset.tab===b;L.style.borderBottomColor=M?"var(--green)":"transparent",L.style.color=M?"var(--green)":"var(--gray-600)"}),T(),z()})}),T(),z()}function xt(e,t){const i=oe[e]||{icon:"⚡",desc:"Effet spécial."};t("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ee=1e3;function vt(e,t,i,n){var $,w,k;const{state:a,toast:o,closeModal:s,navigate:d,refreshProfile:r}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function p(){const b=$e[l]||{},g=ie[l]||[],m=290,v=360,y=20;function _(A){const T=b[A];return T?{x:T.x*m,y:T.y*v}:null}let E=`<svg width="${m}" height="${v}" viewBox="0 0 ${m} ${v}" xmlns="http://www.w3.org/2000/svg">`;for(const[A,T]of g){const z=_(A),C=_(T);!z||!C||(E+=`<line x1="${z.x}" y1="${z.y}" x2="${C.x}" y2="${C.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const A of Object.keys(b)){const T=_(A);if(!T)continue;const z=A.replace(/\d+/,""),C=c[z]||"#555";E+=`<circle cx="${T.x}" cy="${T.y}" r="${y}" fill="${C}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,E+=`<text x="${T.x}" y="${T.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${z}</text>`}return E+="</svg>",E}const f=t.filter(b=>b.formation===l),u=f.length,x=!e.is_for_sale;n(`Formation ${l}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),($=document.getElementById("direct-sell-form-btn"))==null||$.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${ee.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const b=f.find(m=>!m.is_for_sale)||f[0];if(!b){o("Aucune carte à vendre","error");return}const{error:g}=await h.from("cards").delete().eq("id",b.id);if(g){o(g.message,"error");return}await h.from("users").update({credits:(a.profile.credits||0)+ee}).eq("id",a.profile.id),await r(),o(`+${ee.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),d("collection")}),(w=document.getElementById("market-sell-form-btn"))==null||w.addEventListener("click",async()=>{const b=parseInt(document.getElementById("sell-price-form").value);if(!b||b<1){o("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:b}).eq("id",e.id),await h.from("market_listings").insert({seller_id:a.profile.id,card_id:e.id,price:b}),o("Carte mise en vente sur le marché !","success"),s(),d("collection")}),(k=document.getElementById("cancel-sell-form-btn"))==null||k.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),d("collection")})}function bt(e,t,i,n){var y,_,E,A,T,z;const{state:a,toast:o,openModal:s,closeModal:d,navigate:r,refreshProfile:l}=n,c=e.player,p=t.filter(C=>C.player.id===c.id),f=p.length,u=gt[c.rarity]||1e3,x=c.rarity!=="legende",$=Je(c),w=ne(c,c.job),k=c.job2?ne(c,c.job2):null,b=fe[c.job]||"#1A6B3C",g=c.job2?fe[c.job2]:null,m=We[c.rarity]||"#ccc",v=_e[c.country_code]||c.country_code||"";s(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(E=document.getElementById("close-detail"))==null||E.addEventListener("click",d),(A=document.getElementById("direct-sell-btn"))==null||A.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${u.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const C=p.find(q=>!q.is_for_sale)||p[0];if(!C){o("Aucune carte à vendre","error");return}const{error:R}=await h.from("cards").delete().eq("id",C.id);if(R){o(R.message,"error");return}await h.from("users").update({credits:(a.profile.credits||0)+u}).eq("id",a.profile.id),await l(),o(`+${u.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),d(),r("collection")}),(T=document.getElementById("market-sell-btn"))==null||T.addEventListener("click",async()=>{const C=parseInt(document.getElementById("sell-price").value);if(!C||C<1){o("Prix invalide","error");return}await h.from("cards").update({is_for_sale:!0,sale_price:C}).eq("id",e.id),await h.from("market_listings").insert({seller_id:a.profile.id,card_id:e.id,price:C}),o("Carte mise en vente sur le marché !","success"),d(),r("collection")}),(z=document.getElementById("cancel-sell-btn"))==null||z.addEventListener("click",async()=>{await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await h.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),d(),r("collection")})}const ue={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ke(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}async function ye(e,t){const{state:i,navigate:n,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await h.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=prompt("Nom du deck :",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!s)return;const{data:d,error:r}=await h.from("decks").insert({owner_id:i.profile.id,name:s}).select().single();if(r){a(r.message,"error");return}a("Deck créé !","success"),De(d.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(s=>{s.addEventListener("click",()=>De(s.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(s=>{s.addEventListener("click",async()=>{const d=prompt("Nouveau nom :",s.dataset.name);if(!d||d===s.dataset.name)return;const{error:r}=await h.from("decks").update({name:d}).eq("id",s.dataset.rename);if(r){a(r.message,"error");return}a("Deck renommé !","success"),ye(e,t)})}),e.querySelectorAll("[data-delete]").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${s.dataset.name}" ? Cette action est irréversible.`))return;await h.from("deck_cards").delete().eq("deck_id",s.dataset.delete);const{error:d}=await h.from("decks").delete().eq("id",s.dataset.delete);if(d){a(d.message,"error");return}a("Deck supprimé.","success"),ye(e,t)})})}async function De(e,t,i){const{state:n,toast:a}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await h.from("decks").select("*").eq("id",e).single(),{data:s}=await h.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",n.profile.id),d=(s||[]).filter(u=>u.card_type==="player"&&u.player),r=(s||[]).filter(u=>u.card_type==="formation"),l=r.map(u=>u.formation).filter(Boolean),{data:c}=await h.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";l.length>0&&!l.includes(p)&&(p=l[0]);const f={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,slots:{},subs:[],playerCards:d,formationCards:r,availableFormations:l};(c||[]).forEach(u=>{u.is_starter?f.slots[u.position]=u.card_id:f.subs.includes(u.card_id)||f.subs.push(u.card_id)}),X(t,f,i)}function X(e,t,i){var r;const{navigate:n}=i;ue[t.formation];const a=Fe(t.formation),o=a.filter(l=>t.slots[l]).length,s=t.availableFormations.length>0?t.availableFormations:Object.keys(ue),d=t.subs.map(l=>t.playerCards.find(c=>c.id===l)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div class="page">
  ...
  </div>`,ht(e,t,a,i),document.getElementById("builder-back").addEventListener("click",()=>n("decks")),document.getElementById("formation-select").addEventListener("change",l=>{t.formation=l.target.value;const c=Fe(t.formation),p={};c.forEach(f=>{t.slots[f]&&(p[f]=t.slots[f])}),t.slots=p,X(e,t,i)}),document.getElementById("save-deck").addEventListener("click",()=>_t(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(l=>{l.addEventListener("click",()=>{t.subs=t.subs.filter(c=>c!==l.dataset.removeSub),X(e,t,i)})}),(r=document.getElementById("add-sub-btn"))==null||r.addEventListener("click",()=>{$t(t,e,i)})}function ht(e,t,i,n){const a=document.getElementById("deck-field");if(!a)return;const o=t.formation,s=$e[o]||{},d=me?me(o)||ie[o]||[]:ie[o]||[],r={};i.forEach(g=>{const m=t.slots[g],v=m?t.playerCards.find(y=>y.id===m):null;r[g]=(v==null?void 0:v.player)||null});const l=i.filter(g=>g.startsWith("MIL"));let c=0,p=0;l.forEach(g=>{const m=r[g];m&&(c+=Number(m.note_m)||0)}),d.forEach(([g,m])=>{if(!g.startsWith("MIL")||!m.startsWith("MIL"))return;U(r[g],r[m])!=="#ff3333"&&p++});const f=320,u=320,x=28,$=4;function w(g){const m=s[g];return m?{x:m.x*f,y:m.y*u}:null}let k="";for(const[g,m]of d){const v=w(g),y=w(m);if(!v||!y)continue;const _=r[g],E=r[m],A=U(_,E);if(A==="#00ff88"||A==="#FFD700")k+=`<line x1="${v.x}" y1="${v.y}" x2="${y.x}" y2="${y.y}"
        stroke="${A}" stroke-width="${$*3}" stroke-linecap="round" opacity="0.25"/>`,k+=`<line x1="${v.x}" y1="${v.y}" x2="${y.x}" y2="${y.y}"
        stroke="${A}" stroke-width="${$}" stroke-linecap="round" opacity="0.95"/>`;else{const z=A==="#ff3333"||A==="#cc2222"?.75:.9;k+=`<line x1="${v.x}" y1="${v.y}" x2="${y.x}" y2="${y.y}"
        stroke="${A}" stroke-width="${$}" stroke-linecap="round" opacity="${z}"/>`}}for(const g of i){const m=w(g);if(!m)continue;const v=r[g],y=g.replace(/\d+/,""),E={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[y]||"#555",A=v?Number(y==="GK"?v.note_g:y==="DEF"?v.note_d:y==="MIL"?v.note_m:v.note_a)||0:null,T=v?(v.surname_encoded||"").slice(0,8).toUpperCase():"";if(v){const z=ke(v);z&&(k+=`
          <defs>
            <clipPath id="clip-${g}">
    ...
    <svg viewBox="0 0 ${f} ${u}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${b}
      ${k}
    </svg>`,a.querySelectorAll(".deck-slot-hit").forEach(g=>{g.addEventListener("click",()=>wt(g.dataset.pos,t,e,n))})}function wt(e,t,i,n){var f,u,x;const{openModal:a,closeModal:o}=n,s=e.replace(/\d+/,""),d=t.slots[e],r=d?t.playerCards.find($=>$.id===d):null;(f=r==null?void 0:r.player)==null||f.id;const l=new Set;Object.entries(t.slots).forEach(([$,w])=>{var b;if($===e||!w)return;const k=t.playerCards.find(g=>g.id===w);(b=k==null?void 0:k.player)!=null&&b.id&&l.add(k.player.id)}),t.subs.forEach($=>{var k;const w=t.playerCards.find(b=>b.id===$);(k=w==null?void 0:w.player)!=null&&k.id&&l.add(w.player.id)});const c=new Set,p=t.playerCards.filter($=>{const w=$.player;return!(w.job===s||w.job2===s)||l.has(w.id)||c.has(w.id)?!1:(c.add(w.id),!0)});p.sort(($,w)=>{const k=s==="GK"?$.player.note_g:s==="DEF"?$.player.note_d:s==="MIL"?$.player.note_m:$.player.note_a;return(s==="GK"?w.player.note_g:s==="DEF"?w.player.note_d:s==="MIL"?w.player.note_m:w.player.note_a)-k}),a(`Choisir ${s} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${p.length>0?p.map($=>{var m,v;const w=$.player,k=s==="GK"?w.note_g:s==="DEF"?w.note_d:s==="MIL"?w.note_m:w.note_a,b=ke(w),g={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[w.rarity];return`<div class="player-option" data-card-id="${$.id}"
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(u=document.getElementById("close-selector"))==null||u.addEventListener("click",o),(x=document.getElementById("remove-player"))==null||x.addEventListener("click",()=>{delete t.slots[e],o(),X(i,t,n)}),document.querySelectorAll(".player-option").forEach($=>{$.addEventListener("click",()=>{t.slots[e]=$.dataset.cardId,o(),X(i,t,n)})})}function $t(e,t,i){var r;const{openModal:n,closeModal:a}=i,o=new Set;Object.values(e.slots).filter(Boolean).forEach(l=>{var p;const c=e.playerCards.find(f=>f.id===l);(p=c==null?void 0:c.player)!=null&&p.id&&o.add(c.player.id)}),e.subs.forEach(l=>{var p;const c=e.playerCards.find(f=>f.id===l);(p=c==null?void 0:c.player)!=null&&p.id&&o.add(c.player.id)});const s=new Set,d=e.playerCards.filter(l=>{var c,p,f;return o.has((c=l.player)==null?void 0:c.id)||s.has((p=l.player)==null?void 0:p.id)?!1:(s.add((f=l.player)==null?void 0:f.id),!0)});n("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(r=document.getElementById("close-sub-selector"))==null||r.addEventListener("click",a),document.querySelectorAll(".player-option").forEach(l=>{l.addEventListener("click",()=>{e.subs.push(l.dataset.cardId),a(),X(t,e,i)})})}async function _t(e,t){const{state:i,toast:n,navigate:a}=t,o=e.formationCards.find(r=>r.formation===e.formation),s=(o==null?void 0:o.id)||e.formationCardId;await h.from("decks").update({formation:e.formation,formation_card_id:s||null}).eq("id",e.deckId),await h.from("deck_cards").delete().eq("deck_id",e.deckId);const d=[];if(Object.entries(e.slots).forEach(([r,l],c)=>{d.push({deck_id:e.deckId,card_id:l,position:r,is_starter:!0,slot_order:c})}),e.subs.forEach((r,l)=>{d.push({deck_id:e.deckId,card_id:r,position:`SUB${l+1}`,is_starter:!1,slot_order:100+l})}),d.length>0){const{error:r}=await h.from("deck_cards").insert(d);if(r){n(r.message,"error");return}}n("Deck enregistré ✅","success"),a("decks")}function Fe(e){const t=ue[e]||ue["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}const kt="modulepreload",Et=function(e){return"/manager-wars/"+e},Ge={},It=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),d=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=Promise.allSettled(i.map(r=>{if(r=Et(r),r in Ge)return;Ge[r]=!0;const l=r.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${c}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":kt,l||(p.as="script"),p.crossOrigin="",p.href=r,d&&p.setAttribute("nonce",d),document.head.appendChild(p),l)return new Promise((f,u)=>{p.addEventListener("load",f),p.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${r}`)))})}))}function o(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return a.then(s=>{for(const d of s||[])d.status==="rejected"&&o(d.reason);return t().catch(o)})};async function Xe(){const{data:e}=await h.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(e!=null&&e.length))return[];const{data:t}=await h.from("booster_drop_rates").select("*").in("booster_id",e.map(i=>i.id)).order("sort_order");return e.map(i=>({...i,rates:(t||[]).filter(n=>n.booster_id===i.id)}))}function At(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,a)=>n+Number(a.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const Tt=Object.freeze(Object.defineProperty({__proto__:null,loadActiveBoosters:Xe,rollDropRate:At},Symbol.toStringTag,{value:"Module"})),Lt=[{id:"players_std",img:"/manager-wars/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/manager-wars/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/manager-wars/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/manager-wars/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Qe={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Mt(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}const zt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},Ct={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};function jt(e){var a;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((a=Object.entries(t).sort((o,s)=>s[1]-o[1])[0])==null?void 0:a[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/manager-wars/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],_raw:e}}async function Bt(e,{state:t,navigate:i,toast:n}){var s;const a=((s=t.profile)==null?void 0:s.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await Xe()).map(jt)}catch(d){console.warn("Erreur chargement boosters DB, fallback hardcodé",d)}o.length||(o=Lt.map(d=>({...d,rates:[],isPub:d.id==="players_pub"}))),e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(d=>{d.addEventListener("click",async()=>{const r=o.find(l=>l.id===d.dataset.booster);if(r){d.style.opacity="0.5",d.style.pointerEvents="none";try{await St(r,{state:t,toast:n,navigate:i,container:e})}catch(l){n(l.message,"error"),d.style.opacity="",d.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(d=>{d.addEventListener("click",r=>{r.stopPropagation();const l=o.find(c=>c.id===d.dataset.boosterId);Ot(l)})})}async function St(e,{state:t,toast:i,navigate:n,container:a}){if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}if(e.isPub)try{await Ut()}catch(p){i(p.message||"Regardez la pub entièrement pour ouvrir le booster","error");return}const{data:o}=await h.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),s=new Set((o||[]).filter(p=>p.card_type==="player").map(p=>p.player_id)),d=new Set((o||[]).filter(p=>p.card_type==="formation").map(p=>p.formation));let r=[];const l=e.type||"player";l==="player"?r=await Nt(t.profile,e.cardCount,e.cost):l==="game_changer"?r=await Rt(t.profile,e.cardCount,e.cost):l==="formation"?r=await qt(t.profile,e.cost):r=await Gt(t.profile,e),r.forEach(p=>{p.card_type==="player"&&p.player?p.isDuplicate=s.has(p.player.id):p.card_type==="formation"&&(p.isDuplicate=d.has(p.formation))});const{data:c}=await h.from("users").select("*").eq("id",t.profile.id).single();c&&(t.profile=c),Pt(r,e,n)}function Dt(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function V(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function Ft(e,t){let i;switch(t){case"legende":i=e.filter(n=>n.rarity==="legende"),i.length||(i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte")),i.length||(i=e.filter(n=>V(n)>=6));break;case"special":i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte"),i.length||(i=e.filter(n=>V(n)>=6));break;case"normal_high":i=e.filter(n=>n.rarity==="normal"&&V(n)>=6),i.length||(i=e.filter(n=>V(n)>=6));break;default:i=e.filter(n=>n.rarity==="normal"&&V(n)>=1&&V(n)<=5),i.length||(i=e.filter(n=>n.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function Gt(e,t){if(t.cost>0){const{error:a}=await h.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(a)throw a}const{rollDropRate:i}=await It(async()=>{const{rollDropRate:a}=await Promise.resolve().then(()=>Tt);return{rollDropRate:a}},void 0),n=[];for(let a=0;a<(t.cardCount||5);a++){const o=i(t.rates);if(o){if(o.card_type==="player"){let s=h.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);o.rarity&&(s=s.eq("rarity",o.rarity));const{data:d}=await s;let r=d||[];if((o.note_min||o.note_max)&&(r=r.filter(p=>{const f=Math.max(Number(p.note_g)||0,Number(p.note_d)||0,Number(p.note_m)||0,Number(p.note_a)||0);return(!o.note_min||f>=o.note_min)&&(!o.note_max||f<=o.note_max)})),r.length||(r=d||[]),!r.length)continue;const l=r[Math.floor(Math.random()*r.length)],{data:c}=await h.from("cards").insert({owner_id:e.id,player_id:l.id,card_type:"player"}).select().single();c&&n.push({...c,player:l})}else if(o.card_type==="game_changer"){const s=["Ressusciter","Double attaque","Bouclier","Vol de note","Gel","Remplacement+"],d=s[Math.floor(Math.random()*s.length)],{data:r}=await h.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:d}).select().single();r&&n.push(r)}else if(o.card_type==="formation"){const s=["4-4-2","4-3-3","3-5-2","4-2-3-1","3-4-3"],d=s[Math.floor(Math.random()*s.length)],{data:r}=await h.from("cards").insert({owner_id:e.id,card_type:"formation",formation:d}).select();r!=null&&r[0]&&n.push(r[0])}}}return n}async function Nt(e,t,i){if(i>0){const{error:l}=await h.from("users").update({credits:e.credits-i}).eq("id",e.id);if(l)throw l}const{data:n}=await h.from("players").select("id,job,firstname,surname_encoded,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(n!=null&&n.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const a=n.filter(l=>l.job==="GK"),o=n.filter(l=>l.job!=="GK"),s=!e.first_booster_opened&&a.length>0,d=[];for(let l=0;l<t;l++){const c=l===0&&s?a:l===0?o:n,p=Dt(),f=Ft(c,p);f&&d.push(f)}s&&await h.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:r}=await h.from("cards").insert(d.map(l=>({owner_id:e.id,player_id:l.id,card_type:"player"}))).select();return d.map((l,c)=>({...r[c],player:l}))}async function Rt(e,t,i){const{error:n}=await h.from("users").update({credits:e.credits-i}).eq("id",e.id);if(n)throw n;const a=Object.keys(Qe),o=Array.from({length:t},()=>a[Math.floor(Math.random()*a.length)]),{data:s}=await h.from("cards").insert(o.map(d=>({owner_id:e.id,card_type:"game_changer",gc_type:d}))).select();return s}async function qt(e,t){const{error:i}=await h.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const n=["4-4-2","4-3-3","3-4-3","3-5-2","5-3-2"],a=n[Math.floor(Math.random()*n.length)],{data:o}=await h.from("cards").insert({owner_id:e.id,card_type:"formation",formation:a}).select();return o}function Pt(e,t,i){const n=document.createElement("div");n.id="booster-anim-overlay",n.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(n);let a=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(a)return;a=!0;const f=document.getElementById("pack-visual");f.classList.add("shaking"),setTimeout(()=>{f.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",s(0)},600)},500)});let o=0;function s(f){o=f;const u=document.getElementById("reveal-phase");u.style.display="flex",d(f)}function d(f){var v;const u=e[f],x=document.getElementById("card-counter"),$=document.getElementById("single-card-slot"),w=document.getElementById("card-tap-hint");x&&(x.textContent=`Carte ${f+1} / ${e.length}`),w&&(w.textContent=f<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const k=Ne(u),b=u.card_type==="player"&&((v=u.player)==null?void 0:v.rarity)==="legende";$.innerHTML=`
      ...
      </div>`).join("")}let l=null;function c(){const f=document.getElementById("fireworks-canvas");if(!f)return;f.width=window.innerWidth,f.height=window.innerHeight;const u=f.getContext("2d"),x=[];function $(){const k=Math.random()*f.width,b=Math.random()*f.height*.6,g=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],m=g[Math.floor(Math.random()*g.length)];for(let v=0;v<60;v++){const y=Math.PI*2/60*v,_=2+Math.random()*5;x.push({x:k,y:b,vx:Math.cos(y)*_,vy:Math.sin(y)*_,alpha:1,color:m,size:2+Math.random()*3})}}$(),l=setInterval($,600);function w(){if(document.getElementById("fireworks-canvas")){u.clearRect(0,0,f.width,f.height);for(let k=x.length-1;k>=0;k--){const b=x[k];if(b.x+=b.vx,b.y+=b.vy+.08,b.vy*=.98,b.alpha-=.018,b.alpha<=0){x.splice(k,1);continue}u.globalAlpha=b.alpha,u.fillStyle=b.color,u.beginPath(),u.arc(b.x,b.y,b.size,0,Math.PI*2),u.fill()}u.globalAlpha=1,(l!==null||x.length>0)&&requestAnimationFrame(w)}}w()}function p(){l!==null&&(clearInterval(l),l=null);const f=document.getElementById("fireworks-canvas");f&&f.getContext("2d").clearRect(0,0,f.width,f.height)}document.getElementById("reveal-collection").addEventListener("click",()=>{p(),n.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{p(),n.remove(),i("boosters")})}function Ne(e){var t,i;if(e.card_type==="player"&&e.player){const n=e.player,a=n.job||"ATT",o=zt[a]||"#1A6B3C",s=Ct[n.rarity]||"#ccc",d=a==="GK"?n.note_g:a==="DEF"?n.note_d:a==="MIL"?n.note_m:n.note_a,r=Mt(n),l={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL"}[n.country_code]||n.country_code;return`<div style="width:140px;height:200px;background:#f2e8d2;border-radius:12px;border:3px solid ${s};overflow:hidden;display:flex;flex-direction:column">
      <!-- Nom -->
    ...
    </div>`}if(e.card_type==="game_changer"){const n=Qe[e.gc_type]||{icon:"⚡",desc:""};return`<div style="width:140px;height:200px;background:linear-gradient(135deg,#3d0a7a,#7a28b8);border-radius:12px;border:3px solid #9b59b6;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:16px">
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",s=>{s.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}Kt()}function Kt(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}const Ht="simulation",Ze="VOTRE_ZONE_ID";function Ut(){switch(Ht){case"propellerads":return Vt();case"adsense":return Yt();default:return Ee()}}function Ee(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#111;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:14px";let i=5;t.innerHTML=`
      ...
      <button id="ad-skip" disabled style="margin-top:8px;padding:10px 24px;border-radius:20px;border:none;background:rgba(255,255,255,0.15);color:rgba(255,255,255,0.4);font-size:13px;cursor:default">
        Passer (5)
      </button>`,document.body.appendChild(t);const n=setInterval(()=>{i--;const a=document.getElementById("ad-cd"),o=document.getElementById("ad-skip");a&&(a.textContent=i),o&&(o.textContent=i>0?`Passer (${i})`:"✓ Continuer"),i<=0&&(clearInterval(n),o&&(o.disabled=!1,o.style.cssText=o.style.cssText.replace("rgba(255,255,255,0.15)","#1A6B3C").replace("rgba(255,255,255,0.4)","#fff").replace("default","pointer")),o==null||o.addEventListener("click",()=>{t.remove(),e(!0)},{once:!0}))},1e3)})}function Vt(){return new Promise((e,t)=>{if(typeof window.propeller>"u")return console.warn("[Ad] PropellerAds non chargé → simulation"),e(Ee());window.propeller.push({zone_id:Ze,onComplete:()=>e(!0),onSkip:()=>t(new Error("Publicité ignorée")),onError:()=>t(new Error("Erreur publicité"))})})}function Yt(){return new Promise((e,t)=>{if(typeof window.adsbygoogle>"u")return console.warn("[Ad] AdSense non chargé → simulation"),e(Ee());try{(window.adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:"ca-pub-VOTRE_PUBLISHER_ID",google_ad_slot:Ze,google_ad_format:"rewarded",on_reward:()=>e(!0),on_dismiss:()=>t(new Error("Publicité fermée"))})}catch(i){t(i)}})}const Q={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Z={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function et(e,t,i,n,a){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",a)}function G(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function xe(e){var i,n;const t=e.player;return{cardId:e.id,id:t.id,firstname:t.firstname,name:t.surname_encoded,country_code:t.country_code,club_id:t.club_id,job:t.job,job2:t.job2,note_g:Number(t.note_g)||0,note_d:Number(t.note_d)||0,note_m:Number(t.note_m)||0,note_a:Number(t.note_a)||0,rarity:t.rarity,skin:t.skin,hair:t.hair,hair_length:t.hair_length,clubName:((i=t.clubs)==null?void 0:i.encoded_name)||null,clubLogo:((n=t.clubs)==null?void 0:n.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function Ie(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Wt(){const e=Math.random()*100;return e<.1?4:e<5?3:e<20?2:1}function tt(e,t){const i=Q[t]||Q["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]},a=[...e];for(const o of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<i[o];r++){let l=a.findIndex(c=>c.job===o);if(l===-1&&(l=a.findIndex(c=>c.job2===o)),l===-1&&(l=0),a[l]){const c={...a[l],_line:o};s.push(c),a.splice(l,1)}}const d=Ie(s.length);s.forEach((r,l)=>{r._col=d[l]}),n[o]=s}return n}async function Jt(e,t){const{data:i}=await h.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return Xt(e);const n=Q[e]||Q["4-4-2"],a={GK:[],DEF:[],MIL:[],ATT:[]},o=[...i];for(const s of["GK","DEF","MIL","ATT"]){const d=o.filter(f=>f.job===s),r=o.filter(f=>f.job!==s),l=[...d,...r],c=[];for(let f=0;f<n[s];f++){const u=l[f]||o[f];u&&c.push({cardId:"ai-"+u.id+"-"+f,id:u.id,firstname:u.firstname,name:u.surname_encoded,country_code:u.country_code,club_id:u.club_id,job:u.job,job2:u.job2,note_g:Number(u.note_g)||0,note_d:Number(u.note_d)||0,note_m:Number(u.note_m)||0,note_a:Number(u.note_a)||0,rarity:u.rarity,skin:u.skin,hair:u.hair,hair_length:u.hair_length,boost:0,used:!1,_line:s})}const p=Ie(c.length);c.forEach((f,u)=>{f._col=p[u]}),a[s]=c}return a}function Xt(e){const t=Q[e]||Q["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let a=0;for(const o of["GK","DEF","MIL","ATT"]){const s=[];for(let r=0;r<t[o];r++){const l=3+Math.floor(Math.random()*5);s.push({cardId:"fake-"+a,id:"fake-"+a,firstname:"IA",name:n[a%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?l:2,note_d:o==="DEF"?l:2,note_m:o==="MIL"?l:2,note_a:o==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:o}),a++}const d=Ie(s.length);s.forEach((r,l)=>{r._col=d[l]}),i[o]=s}return i}async function Qt(e,t){var v;const{state:i,navigate:n,toast:a}=t,o=i.params||{};e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const s=o.matchMode||"vs_ai_easy",d=s.replace("vs_ai_",""),r=s;if(!o.deckId)return Zt(e,t,s);const l=o.deckId,[{data:c},{data:p}]=await Promise.all([h.from("decks").select("formation,name").eq("id",l).single(),h.from("deck_cards").select(`position, is_starter, slot_order,
        card:cards(id, card_type, formation,
          player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
            note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
            clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]),f=(p||[]).filter(y=>{var _;return y.is_starter&&((_=y.card)==null?void 0:_.player)}).map(y=>xe(y.card)),u=(p||[]).filter(y=>{var _;return!y.is_starter&&((_=y.card)==null?void 0:_.player)}).map(y=>xe(y.card));if(f.length<11){et(e,"⚠️",`Deck incomplet (${f.length}/11).`,"Compléter",()=>n("decks"));return}const x=(p||[]).find(y=>{var _;return((_=y.card)==null?void 0:_.card_type)==="formation"}),$=(c==null?void 0:c.formation)||((v=x==null?void 0:x.card)==null?void 0:v.formation)||"4-4-2",{data:w}=await h.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),k=tt(f,$),b=await Jt($),{data:g}=await h.from("matches").insert({home_id:i.profile.id,away_id:null,mode:r,home_deck_id:l,status:"in_progress"}).select().single(),m={matchId:g==null?void 0:g.id,mode:r,difficulty:d,formation:$,homeTeam:k,aiTeam:b,homeSubs:u,subsUsed:0,maxSubs:Math.min(u.length,3),homeScore:0,aiScore:0,gcCards:w||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};ei(e,m,t)}async function Zt(e,t,i){const{state:n,navigate:a}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await h.from("decks").select("id,name,is_active,formation").eq("owner_id",n.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){et(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>a("decks"));return}const s=o.map(c=>c.id),{data:d}=await h.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let r=0;function l(){var b,g,m,v,y;const c=o[r],p=(d||[]).filter(_=>_.deck_id===c.id),f=p.filter(_=>{var E;return _.is_starter&&((E=_.card)==null?void 0:E.player)}).map(_=>xe(_.card)),u=p.find(_=>{var E;return((E=_.card)==null?void 0:E.card_type)==="formation"}),x=c.formation||((b=u==null?void 0:u.card)==null?void 0:b.formation)||"4-4-2",$=f.length>=11?tt(f,x):null,w=f.length>=11;e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center">
        ${$?`<div style="width:min(98vw, calc(100dvh - 400px));overflow:hidden;flex-shrink:0">${nt($,x,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
      ...
      <div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">
        ${o.map((_,E)=>`<div style="width:7px;height:7px;border-radius:50%;background:${E===r?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}
      </div>`:""}
    ...
    </div>`,(g=document.getElementById("prev-deck"))==null||g.addEventListener("click",()=>{r>0&&(r--,l())}),(m=document.getElementById("next-deck"))==null||m.addEventListener("click",()=>{r<o.length-1&&(r++,l())}),(v=document.getElementById("validate-deck"))==null||v.addEventListener("click",()=>{w&&t.navigate("match",{matchMode:i,deckId:c.id})}),(y=document.getElementById("cancel-deck-select"))==null||y.addEventListener("click",()=>a("home"));const k=document.getElementById("deck-swipe-zone");if(k){let _=0,E=0;k.addEventListener("touchstart",A=>{_=A.touches[0].clientX,E=A.touches[0].clientY},{passive:!0}),k.addEventListener("touchend",A=>{const T=A.changedTouches[0].clientX-_,z=A.changedTouches[0].clientY-E;Math.abs(T)<40||Math.abs(T)<Math.abs(z)||(T<0&&r<o.length-1?(r++,l()):T>0&&r>0&&(r--,l()))},{passive:!0})}}l()}function ei(e,t,i){e.innerHTML=`
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;gap:12px;padding:12px 16px;background:#0a3d1e">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
  </div>`,setTimeout(()=>ti(e,t,i),5e3)}function ti(e,t,i){const n=t.homeTeam.MIL||[],a=t.aiTeam.MIL||[];function o(p){return p.reduce((f,u)=>f+F(u,"MIL"),0)}function s(p){let f=0;for(let u=0;u<p.length-1;u++){const x=U(p[u],p[u+1]);x==="#00ff88"?f+=2:x==="#FFD700"&&(f+=1)}return f}const d=o(n)+s(n),r=o(a)+s(a),l=d>=r;function c(p,f,u){return`<div style="text-align:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${p.map((x,$)=>{const w=G(x),k=$<p.length-1?U(x,p[$+1]):null,b=k&&k!=="#ff3333"&&k!=="#cc2222";return`
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
  </div>`,setTimeout(()=>{const p=document.getElementById("score-home"),f=document.getElementById("score-ai"),u=document.getElementById("midfield-result");if(p&&f&&(l?(p.style.fontSize="80px",p.style.color="#FFD700",f.style.opacity="0.25"):(f.style.fontSize="80px",f.style.color="#ff6b6b",p.style.opacity="0.25")),u){const x=Wt();u.style.opacity="1",l&&t.clubName,u.innerHTML=`
      ...
      `,l&&(t.boostCard={value:x})}if(t.attacker=l?"home":"ai",t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:n.map(x=>({name:x.name,note:F(x,"MIL"),portrait:G(x),job:x.job,country_code:x.country_code,rarity:x.rarity,clubName:x.clubName,clubLogo:x.clubLogo})),aiPlayers:a.map(x=>({name:x.name,note:F(x,"MIL"),portrait:G(x),job:x.job,country_code:x.country_code,rarity:x.rarity,clubName:x.clubName,clubLogo:x.clubLogo})),homeTotal:d,aiTotal:r,text:`Duel milieu : ${t.clubName} ${d} – ${r} IA → ${l?t.clubName+" attaque":"IA attaque"}`}),u){const x=document.createElement("button");x.textContent="▶ Commencer le match",x.style.cssText="margin-top:20px;padding:14px 28px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer",x.addEventListener("click",()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",N(e,t,i),t.attacker==="ai"&&setTimeout(()=>be(e,t,i),800)}),u.appendChild(x)}},5e3)}function it(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function W(e,t=44,i=58){if(!e)return`<div style="width:${t}px;height:${i}px;border:1.5px dashed rgba(255,255,255,0.2);border-radius:5px"></div>`;const n=typeof e.portrait=="string"&&e.portrait.startsWith("http")?e.portrait:G(e),a=it(e),o=e._line||e.job||"MIL",s=Z[o]||"#555",d={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",r=e.note!==void 0?Number(e.note)||0:(Number(F(e,o))||0)+(e.boost||0),l=ot(e==null?void 0:e.country_code),c=Math.round(i*.19),p=Math.round(i*.25),f=i-Math.round(i*.19)-Math.round(i*.25),u=e!=null&&e.used?.28:1;return`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${d};background:${s};position:relative;overflow:hidden;flex-shrink:0;opacity:${u}">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${a?`<img src="${a}" style="width:${p-4}px;height:${p-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,p-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
  ...
  </div>`}function se(e,t,i){if(!(e!=null&&e.length))return"";const n=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((o,s)=>{if(a+=W(o,40,52),s<n.length-1){const d=U(o,n[s+1]);a+=`<div style="width:7px;height:3px;background:${d==="#ff3333"||d==="#cc2222"?"rgba(255,255,255,0.12)":d};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function ve(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function ot(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function Ae(e,t,i,n,a=310,o=310){const s=$e[t]||{},d=me(t)||ie[t]||[],r={},l=["ATT","MIL","DEF","GK"];for(const b of l)(e[b]||[]).forEach((m,v)=>{r[`${b}${v+1}`]=m});function c(b){const g=s[b];return g?{x:g.x*a,y:g.y*o}:null}let p="";for(const[b,g]of d){const m=c(b),v=c(g);if(!m||!v)continue;const y=r[b],_=r[g],E=U(y,_);E==="#00ff88"||E==="#FFD700"?(p+=`<line x1="${m.x.toFixed(1)}" y1="${m.y.toFixed(1)}" x2="${v.x.toFixed(1)}" y2="${v.y.toFixed(1)}"
        ...
        stroke="${E}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const f=48,u=64,x=13,$=16,w={normal:"#aaaaaa",pépite:"#D4A017",papyte:"#111111",légende:"#7a28b8"};for(const[b,g]of Object.entries(r)){const m=c(b);if(!m||!g)continue;const v=b.replace(/[0-9]/g,""),y=Z[v]||"#555",_=i==="attack"&&["MIL","ATT"].includes(v)&&!g.used||i==="defense"&&["GK","DEF","MIL"].includes(v)&&!g.used,E=n.includes(g.cardId);let A;i==="attack"?A=v==="MIL"?Number(g.note_m)||0:Number(g.note_a)||0:i==="defense"?A=v==="GK"?Number(g.note_g)||0:v==="MIL"?Number(g.note_m)||0:Number(g.note_d)||0:A=Number(v==="GK"?g.note_g:v==="DEF"?g.note_d:v==="MIL"?g.note_m:g.note_a)||0,A=A+(g.boost||0);const T=(m.x-f/2).toFixed(1),z=(m.y-u/2).toFixed(1),C=g.used?.25:1,R=w[g==null?void 0:g.rarity]||w.normal,q=E?"#ff3030":R,I=E?3:(g==null?void 0:g.rarity)==="légende"||(g==null?void 0:g.rarity)==="pépite"?2.5:2,L=u-x-$;p+=`<defs><clipPath id="cp-${b}"><rect x="${T}" y="${(m.y-u/2+x).toFixed(1)}" width="${f}" height="${L}"/></clipPath></defs>`,p+=`<rect x="${T}" y="${z}" width="${f}" height="${u}" rx="5" fill="${y}" opacity="${C}"/>`;const M=G(g);M&&!g.used&&(p+=`<image href="${M}" x="${T}" y="${(m.y-u/2+x).toFixed(1)}" width="${f}" height="${L}" clip-path="url(#cp-${b})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${T}" y="${z}" width="${f}" height="${x}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${m.x.toFixed(1)}" y="${(m.y-u/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(g.name||"").slice(0,9)}</text>`;const B=(m.y+u/2-$).toFixed(1);if(p+=`<rect x="${T}" y="${B}" width="${f}" height="${$}" fill="rgba(255,255,255,0.92)"/>`,g.used)p+=`<text x="${m.x.toFixed(1)}" y="${(m.y+u/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="13" font-weight="900" fill="rgba(0,0,0,0.4)" font-family="Arial Black">–</text>`;else{const S=ve(g.country_code);S?p+=`<image href="${S}" x="${(m.x-20).toFixed(1)}" y="${(m.y+u/2-$+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(m.x-13).toFixed(1)}" y="${(m.y+u/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${ot(g.country_code)}</text>`,p+=`<text x="${m.x.toFixed(1)}" y="${(m.y+u/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${A}</text>`;const D=it(g);D?p+=`<image href="${D}" x="${(m.x+f/2-14).toFixed(1)}" y="${(m.y+u/2-$+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:g.clubName&&(p+=`<text x="${(m.x+14).toFixed(1)}" y="${(m.y+u/2-$/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(g.clubName||"").slice(0,3).toUpperCase()}</text>`),g.boost&&(p+=`<rect x="${(m.x+f/2-12).toFixed(1)}" y="${(m.y-u/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,p+=`<text x="${(m.x+f/2-5).toFixed(1)}" y="${(m.y-u/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${g.boost}</text>`)}p+=`<rect x="${T}" y="${z}" width="${f}" height="${u}" rx="5" fill="${E?"rgba(255,255,255,0.12)":"none"}" stroke="${q}" stroke-width="${I}" opacity="${C}"/>`,_&&(p+=`<rect x="${T}" y="${z}" width="${f}" height="${u}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${g.cardId}" data-role="${v}" style="cursor:pointer"/>`)}const k=38;return`<svg viewBox="${-k} ${-k} ${a+k*2} ${o+k*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  </svg>`}function nt(e,t,i,n,a=300,o=300){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${Ae(e,t,i,n,a,o)}
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);max-height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;position:relative">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:100px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const _=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const y=t.log[t.log.length-1];return y?'<div style="padding:2px 4px">'+ii(y)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    <div style="display:flex;flex-shrink:0;overflow:hidden">
      ...
      <div style="overflow:hidden;min-width:0;display:flex;align-items:flex-start;justify-content:center" id="match-field">
        <div style="width:min(calc(100vw - 56px), calc(100dvh - 370px));aspect-ratio:1;overflow:hidden;flex-shrink:0">
          ${nt(t.homeTeam,t.formation,t.phase,n,300,300)}
        </div>
      </div>
    </div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(y=>{var _,E,A;if(y.type==="duel"){const T=y.isGoal,z=y.homeScored?"#FFD700":T?"#ff6b6b":"rgba(255,255,255,0.3)",C=y.homeScored?"⚽ BUT !":T?"⚽ BUT IA !":(_=y.homePlayers)!=null&&_.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${T?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${z};margin-bottom:4px">
                ...
                ${(A=y.aiPlayers)!=null&&A.length?`<div style="opacity:0.7">${se(y.aiPlayers,"#ff6b6b",y.aiTotal)}</div>`:""}
  ...
  </div>`,t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let y=!1,_=30;const E=()=>document.getElementById("match-timer"),A=()=>{const T=E();if(!T)return;const z=String(Math.floor(_/60)).padStart(2,"0"),C=String(_%60).padStart(2,"0");T.textContent=` ${z}:${C}`,T.style.color=y?"#ff2222":"#ff9500",T.style.fontWeight="900"};A(),t._timerInt=setInterval(()=>{if(_--,_<0)if(!y)y=!0,_=15,A();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",T.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(T),setTimeout(()=>{T.remove(),J(e,t,i)},2500)}else A()},1e3)}(x=document.getElementById("match-quit"))==null||x.addEventListener("click",()=>{confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,J(e,t,i))}),($=document.getElementById("view-ai"))==null||$.addEventListener("click",()=>pi(t,i)),(w=document.getElementById("toggle-history"))==null||w.addEventListener("click",()=>{var y;(y=document.getElementById("match-history-panel"))==null||y.classList.add("open")}),(k=document.getElementById("close-history"))==null||k.addEventListener("click",()=>{var y;(y=document.getElementById("match-history-panel"))==null||y.classList.remove("open")}),(b=document.getElementById("btn-action"))==null||b.addEventListener("click",()=>{t.selected.length!==0&&(r?ni(e,t,i):l&&ri(e,t,i))}),(g=document.getElementById("btn-results"))==null||g.addEventListener("click",()=>J(e,t,i)),e.querySelectorAll(".match-slot-hit").forEach(y=>{y.addEventListener("click",()=>oi(y,t,e,i))}),e.querySelectorAll(".gc-mini").forEach(y=>{y.addEventListener("click",()=>di(y.dataset.gcId,y.dataset.gcType,e,t,i))}),(m=document.getElementById("boost-card"))==null||m.addEventListener("click",()=>ci(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(y=>{y.addEventListener("click",()=>Re(e,t,i,y.dataset.subId))}),(v=document.getElementById("sub-btn-main"))==null||v.addEventListener("click",()=>Re(e,t,i))}function oi(e,t,i,n){const a=e.dataset.cardId,o=e.dataset.role,s=t.selected.findIndex(d=>d.cardId===a);if(s!==-1)t.selected.splice(s,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const d=(t.homeTeam[o]||[]).find(r=>r.cardId===a);d&&t.selected.push({...d,_role:o,_line:o})}N(i,t,n)}function Te(e,t,i){e.matchId&&h.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function ni(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Te(t,i,i.state.profile.id);const n=t.selected.map(o=>({...o,_line:o._role})),a=He(n,t.modifiers.home);t.pendingAttack={...a,players:[...t.selected],side:"home"},t.selected.forEach(o=>{const s=(t.homeTeam[o._role]||[]).find(d=>d.cardId===o.cardId);s&&(s.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${a.total} (base ${a.base}${a.links?` +${a.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",N(e,t,i),setTimeout(()=>ai(e,t,i),1200)}function ri(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Te(t,i,i.state.profile.id);const n=t.selected.map(d=>({...d,_line:d._role})),a=Ue(n,t.modifiers.home);t.selected.forEach(d=>{const r=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);r&&(r.used=!0)});const o=Ve(t.pendingAttack.total,a.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>({name:d.name,note:d._line==="MIL"?d.note_m:d.note_a,portrait:G(d),job:d.job,country_code:d.country_code,rarity:d.rarity,clubName:d.clubName,clubLogo:d.clubLogo})),homePlayers:t.selected.map(d=>{const r=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return{name:r.name,note:r._line==="GK"?r.note_g:r._line==="MIL"?r.note_m:r.note_d,portrait:G(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo}}),homeTotal:a.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(o.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(o.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${a.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,N(e,t,i),Le(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{re(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${a.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,re(e,t,i,"home-attack")}function be(e,t,i){Te(t,i,null);const n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],a=Ye(n,"attack",t.difficulty);if(!a.length){at(e,t,i);return}const o=He(a,t.modifiers.ai);t.pendingAttack={...o,players:a,side:"ai"},a.forEach(l=>{l.used=!0}),t.log.push({text:`🤖 IA attaque : ${o.total} (${a.map(l=>l.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used),r=(t.homeSubs||[]).filter(l=>!(t.usedSubIds||[]).includes(l.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!r){t.aiScore++;const l={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:a.map(c=>({name:c.name,note:c._line==="MIL"?c.note_m:c.note_a,portrait:G(c),job:c.job,country_code:c.country_code,rarity:c.rarity,clubName:c.clubName,clubLogo:c.clubLogo})),aiTotal:o.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(l),t.pendingAttack=null,N(e,t,i),Le(l.aiPlayers,t.homeScore,t.aiScore,!1,()=>{re(e,t,i,"home-attack")});return}t.phase="defense",N(e,t,i)}function ai(e,t,i){const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],a=Ye(n,"defense",t.difficulty),o=a.length>0?Ue(a,t.modifiers.ai).total:0;a.forEach(r=>{r.used=!0});const s=Ve(t.pendingAttack.total,o,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(r=>({name:r.name,note:r._line==="MIL"?r.note_m:r.note_a,portrait:G(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiPlayers:a.map(r=>({name:r.name,note:r._line==="GK"?r.note_g:r._line==="MIL"?r.note_m:r.note_d,portrait:G(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),homeTotal:t.pendingAttack.total,aiTotal:o,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(s.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${o})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,N(e,t,i),Le(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{re(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${o} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,re(e,t,i,"ai-attack")}function re(e,t,i,n){if(t.round++,rt(t)){J(e,t,i);return}if(n==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(o=>!o.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(s=>!s.used).length){J(e,t,i);return}t.phase="ai-attack",N(e,t,i),setTimeout(()=>be(e,t,i),800);return}t.phase="attack",N(e,t,i)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(o=>!o.used).length){at(e,t,i);return}t.phase="ai-attack",N(e,t,i),setTimeout(()=>be(e,t,i),800)}}function rt(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(a=>!a.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(a=>!a.used));return!t&&!i}function at(e,t,i){rt(t)?J(e,t,i):(t.phase="attack",N(e,t,i))}function si(e,t,i){const n=document.createElement("div");n.style.cssText=`
    position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:800;
    display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;
    animation:subFadeIn 0.2s ease;
  `;const a=G(e),o=G(t),s=Z[e.job]||"#555",d=Z[t.job]||"#555",r=e.job==="GK"?e.note_g:e.job==="DEF"?e.note_d:e.job==="MIL"?e.note_m:e.note_a,l=t.job==="GK"?t.note_g:t.job==="DEF"?t.note_d:t.job==="MIL"?t.note_m:t.note_a;n.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(n);let c=!1;const p=()=>{c||(c=!0,n.remove(),i())};n.addEventListener("click",p),setTimeout(p,2e3)}function te(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Re(e,t,i,n=null){if(t.phase!=="attack"){te("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){te(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const a=Object.values(t.homeTeam).flat().filter(p=>p.used),o=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!a.length){te("Aucun joueur utilisé à remplacer");return}if(!o.length){te("Aucun remplaçant disponible");return}let s=0,d=Math.max(0,o.findIndex(p=>p.cardId===n)),r=!1;const l=document.createElement("div");l.id="sub-overlay",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function c(){var k,b,g,m,v,y;const p=a[s],f=o[d],u=Math.min(130,Math.round((window.innerWidth-90)/2)),x=Math.round(u*1.35),$=_=>`background:rgba(255,255,255,0.12);border:none;color:${_?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${_?"default":"pointer"};flex-shrink:0`;l.innerHTML=`
    ...
    </div>`,(k=l.querySelector("#sub-close"))==null||k.addEventListener("click",()=>l.remove()),(b=l.querySelector("#out-up"))==null||b.addEventListener("click",()=>{s>0&&(s--,c())}),(g=l.querySelector("#out-down"))==null||g.addEventListener("click",()=>{s<a.length-1&&(s++,c())}),(m=l.querySelector("#in-up"))==null||m.addEventListener("click",()=>{d>0&&(d--,c())}),(v=l.querySelector("#in-down"))==null||v.addEventListener("click",()=>{d<o.length-1&&(d++,c())});const w=(_,E,A,T)=>{const z=l.querySelector("#"+_);if(!z)return;let C=0;z.addEventListener("touchstart",R=>{C=R.touches[0].clientY},{passive:!0}),z.addEventListener("touchend",R=>{const q=R.changedTouches[0].clientY-C;if(Math.abs(q)<30)return;const I=E();q<0&&I<T-1?(A(I+1),c()):q>0&&I>0&&(A(I-1),c())},{passive:!0})};w("in-panel",()=>d,_=>d=_,o.length),w("out-panel",()=>s,_=>s=_,a.length),(y=l.querySelector("#sub-confirm"))==null||y.addEventListener("click",_=>{if(_.preventDefault(),_.stopPropagation(),r)return;r=!0;const E=a[s],A=o[d];if(!E||!A)return;let T=null,z=-1;for(const[R,q]of Object.entries(t.homeTeam)){const I=(q||[]).findIndex(L=>L.cardId===E.cardId);if(I!==-1){T=R,z=I;break}}if(z===-1||!T){te("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),l.remove();return}const C={...A,_line:T,_col:E._col||0,used:!1,boost:0};t.homeTeam[T].splice(z,1,C),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(A.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:E.name,firstname:E.firstname,note:F(E,T),portrait:G(E),job:E.job,country_code:E.country_code,rarity:E.rarity,clubName:E.clubName,clubLogo:E.clubLogo},inPlayer:{name:A.name,firstname:A.firstname,note:F(A,T),portrait:G(A),job:A.job,country_code:A.country_code,rarity:A.rarity,clubName:A.clubName,clubLogo:A.clubLogo},text:`🔄 ${A.firstname} ${A.name} remplace ${E.firstname} ${E.name}`}),l.remove(),si(E,A,()=>N(e,t,i))})}document.body.appendChild(l),c()}function di(e,t,i,n,a){var d,r;const o=oe[t]||{icon:"⚡",desc:"Carte spéciale."},s=document.createElement("div");s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;align-items:center;justify-content:center;padding:24px",s.innerHTML=`
    ...
    </div>`,document.body.appendChild(s),(d=s.querySelector("#gc-back"))==null||d.addEventListener("click",()=>s.remove()),(r=s.querySelector("#gc-use"))==null||r.addEventListener("click",()=>{s.remove(),li(e,t,i,n,a)})}function li(e,t,i,n,a){if(!n.usedGc.includes(e)){switch(n.usedGc.push(e),t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{let o=!1;for(const s of["ATT","MIL","DEF","GK"]){const d=(n.homeTeam[s]||[]).find(r=>r.used);if(d){d.used=!1,o=!0;break}}n.log.push({text:o?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const o=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(s=>!s.used);if(o.length){const s=o.sort((d,r)=>F(r,"ATT")-F(d,"ATT"))[0];s.used=!0,n.log.push({text:`❄️ ${s.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}h.from("cards").delete().eq("id",e).then(()=>{}),N(i,n,a)}}function ci(e,t,i){const n=Object.values(t.homeTeam).flat().filter(a=>!a.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const d=(t.homeTeam[s]||[]).find(r=>r.cardId===o);if(d){d.boost=(d.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),N(e,t,i)})})}function Le(e,t,i,n,a){const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const s=Array.from({length:10},(l,c)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(o);let d=!1;const r=()=>{d||(d=!0,o.remove(),setTimeout(()=>a(),50))};o.addEventListener("click",r),setTimeout(r,3500)}async function J(e,t,i){var c,p;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,a=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,s=a?"victoire":o?"nul":"defaite",d=ft(t.mode,s);t.matchId&&await h.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:a?n.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const r={credits:(n.profile.credits||0)+d,matches_played:(n.profile.matches_played||0)+1};a?r.wins=(n.profile.wins||0)+1:o?r.draws=(n.profile.draws||0)+1:r.losses=(n.profile.losses||0)+1,await h.from("users").update(r).eq("id",n.profile.id),await i.refreshProfile();const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",l.innerHTML=`
  ...
  `;function d(r){const l=document.getElementById("mkt-content"),c=r==="buy"?s:o;if(c.length===0){l.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(p=>{var w,k,b;const f=(w=p.card)==null?void 0:w.player;if(!f)return"";const u=f.job==="GK"?f.note_g:f.job==="DEF"?f.note_d:f.job==="MIL"?f.note_m:f.note_a,x=fi[f.rarity],$=(i.profile.credits||0)>=p.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${yi(f.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${x};flex-shrink:0">${u}</div>
          <div style="flex:1;min-width:0">
    ...
    </div>`,l.querySelectorAll("[data-buy]").forEach(p=>{p.addEventListener("click",()=>gi(p.dataset.buy,c,e,t))}),l.querySelectorAll("[data-cancel]").forEach(p=>{p.addEventListener("click",()=>mi(p.dataset.cancel,e,t))})}d("buy"),e.querySelectorAll(".mkt-tab").forEach(r=>{r.addEventListener("click",()=>{e.querySelectorAll(".mkt-tab").forEach(l=>{const c=l===r;l.style.background=c?"var(--green)":"#fff",l.style.color=c?"#fff":"var(--gray-600)",l.style.borderColor=c?"var(--green)":"var(--gray-200)"}),d(r.dataset.tab)})})}async function gi(e,t,i,n){const{state:a,toast:o,refreshProfile:s}=n,d=t.find(r=>r.id===e);if(d){if((a.profile.credits||0)<d.price){o("Crédits insuffisants","error");return}if(confirm(`Acheter ${d.card.player.firstname} ${d.card.player.surname_encoded} pour ${d.price.toLocaleString("fr")} crédits ?`))try{const{error:r}=await h.from("cards").update({owner_id:a.profile.id,is_for_sale:!1,sale_price:null}).eq("id",d.card.id);if(r)throw r;await h.from("market_listings").update({status:"sold",buyer_id:a.profile.id,sold_at:new Date().toISOString()}).eq("id",e),await h.from("users").update({credits:(a.profile.credits||0)-d.price}).eq("id",a.profile.id);const{data:l}=await h.from("users").select("credits").eq("id",d.seller_id).single();l&&await h.from("users").update({credits:(l.credits||0)+d.price}).eq("id",d.seller_id),await h.from("notifications").insert({user_id:d.seller_id,type:"card_sold",message:`Ta carte ${d.card.player.surname_encoded} a été vendue pour ${d.price} crédits !`,data:{card_id:d.card.id,price:d.price}}),await s(),o("Carte achetée ! ✅","success"),Me(i,n)}catch(r){o("Erreur : "+r.message,"error")}}}async function mi(e,t,i){const{toast:n}=i,{data:a}=await h.from("market_listings").select("card_id").eq("id",e).single();await h.from("market_listings").update({status:"cancelled"}).eq("id",e),a&&await h.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",a.card_id),n("Annonce retirée","success"),Me(t,i)}function yi(e){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[e]||"#888"}async function xi(e,{state:t,navigate:i,toast:n}){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:a}=await h.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);e.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  </div>`}const j={user:null,profile:null,page:"home",params:{}};function le(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function bi(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function he(){document.getElementById("modal-overlay").classList.add("hidden")}async function ce(){if(!j.user)return;const{data:e}=await h.from("users").select("*").eq("id",j.user.id).single();e&&(j.profile=e)}const ze="mw_theme";function ge(){return localStorage.getItem(ze)||"light"}function hi(e){var t;localStorage.setItem(ze,e),we(e),(t=j.profile)!=null&&t.id&&h.from("users").update({theme:e}).eq("id",j.profile.id).then(()=>{})}function we(e){document.documentElement.setAttribute("data-theme",e)}function pe(e,t={}){j.page=e,j.params=t,st()}async function st(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(n=>{n.classList.toggle("active",n.dataset.page===j.page)});const t=document.getElementById("nav-credits");t&&j.profile&&(t.textContent=`💰 ${(j.profile.credits||0).toLocaleString("fr")}`);const i={state:j,navigate:pe,toast:le,openModal:bi,closeModal:he,refreshProfile:ce};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',j.page){case"home":await Be(e,i);break;case"collection":await yt(e,i);break;case"decks":await ye(e,i);break;case"boosters":await Bt(e,i);break;case"match":await Qt(e,i);break;case"market":await ui(e,i);break;case"rankings":await xi(e,i);break;case"matches":await vi(e,i);break;default:await Be(e,i)}}function wi(){const e=document.getElementById("app"),t=j.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(n=>{n.addEventListener("click",a=>{a.preventDefault(),pe(n.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>pe("home")),document.getElementById("nav-credits").addEventListener("click",()=>pe("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const a=ge()==="dark"?"light":"dark";hi(a),qe(a)}),qe(ge())}function qe(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function $i(){we(ge()),document.getElementById("modal-overlay").addEventListener("click",t=>{t.target===t.currentTarget&&he()}),document.getElementById("modal-close").addEventListener("click",he);const{data:{session:e}}=await h.auth.getSession();if(!e){Oe(),Ce(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:le});return}j.user=e.user,await ce(),Oe();try{const{data:t}=await h.from("formation_links_overrides").select("formation, links"),i={};(t||[]).forEach(n=>{i[n.formation]=n.links}),dt(i)}catch(t){console.warn("Impossible de charger les overrides de formation:",t)}if(!j.profile){lt(document.getElementById("app"),{state:j,navigate:async()=>{await ce(),Pe()},toast:le,refreshProfile:ce});return}j.profile.theme&&j.profile.theme!==ge()&&(localStorage.setItem(ze,j.profile.theme),we(j.profile.theme)),Pe(),h.auth.onAuthStateChange(async(t,i)=>{t==="SIGNED_OUT"&&(j.user=null,j.profile=null,document.getElementById("app").innerHTML="",Ce(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:le}))})}function Pe(){const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",wi(),st()}function Oe(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}$i();
