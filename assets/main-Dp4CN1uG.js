...
import{s as v,l as Ht,m as Bi,F as qi,r as je,j as ii,h as Di,n as Kn,o as Vn,T as bi,k as Yn,p as Wn,b as Xn}from"./formation-links-Bb-Ce4un.js";const Jn="/";function Qi(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,m;const o=n==="login";e.innerHTML=`
  ...
  `;function s(){var x;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),m=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",y=m.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():m.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=g,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(m){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(m){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),y=document.getElementById("step3-finish");m.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Zn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){m.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Zn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const eo="modulepreload",to=function(e){return"/"+e},Zi={},mn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=to(d),d in Zi)return;Zi[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":eo,c||(m.as="script"),m.crossOrigin="",m.href=d,s&&m.setAttribute("nonce",s),document.head.appendChild(m),c)return new Promise((y,g)=>{m.addEventListener("load",y),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Xt="#1A6B3C",Jt="#cc2222",io="#D4A017",en="#888";async function no(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const so="2026.07.20-2240";async function tn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(F){const H=document.getElementById(F);if(!H)return;H.addEventListener("wheel",ue=>{Math.abs(ue.deltaY)<=Math.abs(ue.deltaX)||(ue.preventDefault(),H.scrollLeft+=ue.deltaY)},{passive:!1});let Q=!1,R=0,M=0,N=!1,ce=!1;H.addEventListener("mousedown",ue=>{Q=!0,N=!1,R=ue.pageX,M=H.scrollLeft}),window.addEventListener("mouseup",()=>{Q=!1,N&&(H.style.cursor="",ce=!0),N=!1}),window.addEventListener("mousemove",ue=>{if(!Q)return;const we=ue.pageX-R;!N&&Math.abs(we)<6||(N=!0,H.style.cursor="grabbing",ue.preventDefault(),H.scrollLeft=M-we)}),H.addEventListener("click",ue=>{ce&&(ue.stopPropagation(),ue.preventDefault(),ce=!1)},!0)}("col-grid");function T(){const j=document.getElementById("col-filters");j&&(B==="player"?(j.innerHTML=`
        ...
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{D=!D,T(),Y()})))}function Y(){const j=document.getElementById("col-grid");j&&(B==="player"?pe(j):B==="formation"?O(j):B==="stadium"?U(j):V(j))}function oe(j,F,H,Q,R){const M=document.getElementById("col-grid"),N=document.getElementById("col-big");if(!M||!N)return;var ce=0;function ue(){var He;const we=window.innerWidth>=768,ye=document.getElementById("col-big"),Te=((He=document.getElementById("col-grid"))==null?void 0:He.parentElement)||null,ze=ye?ye.closest(".page"):null;if(ye&&Te&&ze){let $e=0;Array.from(ze.children).forEach(function(_){_!==ye&&_!==Te&&($e+=_.offsetHeight)});const Ee=Math.max(0,ze.clientHeight-$e),qe=we?50/71:45/63,Me=Math.round(Ee*qe),Ye=Math.max(0,Ee-Me);ye.style.flex="none",ye.style.height=Me+"px",ye.style.minHeight="0",Te.style.flex="none",Te.style.height=Ye+"px",Te.style.minHeight="0",Te.style.display="flex",Te.style.overflow="hidden"}const ke=document.getElementById("col-grid");ke&&(ke.style.height="100%",ke.style.flexShrink="0",ke.style.overflowX="auto",ke.style.overflowY="hidden",ke.style.alignItems="center",ke.style.width="100%"),N.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+F(j[ce])+"</div>";var Ce=N.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ce&&Ce.addEventListener("click",function(){Q(j[ce])}),requestAnimationFrame(function(){var $e=document.getElementById("big-card-inner");if(!(!$e||!N)){var Ee=N.clientHeight,qe=N.clientWidth-16,Me=$e.offsetHeight,Ye=$e.offsetWidth;if(Me>0&&Ye>0&&Ee>40){var _=Math.min(Ee/Me,qe/Ye);$e.style.transform="scale("+_.toFixed(3)+")",$e.style.transformOrigin="center center"}}}),M.innerHTML=j.map(function($e,Ee){var qe=Ee===ce,Me="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ee+'" style="'+Me+'">'+H($e,qe)+"</div>"}).join(""),M.querySelectorAll(".col-mini-item").forEach(function($e){$e.addEventListener("click",function(){ce=Number($e.dataset.idx),ue(),$e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var $e=ke?ke.clientHeight:0,Ee=M.querySelector(".col-mini-item > div");if(!(!$e||!Ee)){var qe=Ee.style.zoom;Ee.style.zoom="1";var Me=Ee.offsetHeight;if(Ee.style.zoom=qe,!(Me<=0)){var Ye=$e/Me;M.querySelectorAll(".col-mini-item > div").forEach(function(_){_.style.zoom=Ye.toFixed(4)})}}})}ue()}function fe(j){var F=window.innerWidth>=768?.76:.54,H;if(!j||j._fake){var Q=j?j.player:null;if(!Q)return"";H=an(Q)}else H=wi(j,"");return'<div style="display:inline-block;zoom:'+F+';pointer-events:none;line-height:0">'+H+"</div>"}function me(j,F,H){F=F||100,H=H||140;var Q=ii[j]||{},R={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},M=Math.max(3,Math.round(F*.06)),N=Object.entries(Q).map(function(ue){var we=ue[0],ye=ue[1],Te=we.replace(/\d+$/,""),ze=R[Te]||"#888",ke=Math.round(ye.x*F),Ce=Math.round(ye.y*H);return'<circle cx="'+ke+'" cy="'+Ce+'" r="'+M+'" fill="'+ze+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),ce=Math.max(1,Math.round(F/50));return'<svg viewBox="0 0 '+F+" "+H+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+F+'" height="'+H+'" fill="#1A6B3C"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.02)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/><line x1="0" y1="'+Math.round(H*.5)+'" x2="'+F+'" y2="'+Math.round(H*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><ellipse cx="'+Math.round(F*.5)+'" cy="'+Math.round(H*.5)+'" rx="'+Math.round(F*.18)+'" ry="'+Math.round(H*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+ce+'"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.82)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ce+'"/>'+N+"</svg>"}function S(j,F,H){var Q=H>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+H+"</div>":"",R=F?'data-form-id="'+F.id+'"':"",M=j.length>7?14:j.length>5?16:19,N=!!F;return"<div "+R+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(N?"#2a7a40":"#bbb")+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(N?"":"filter:grayscale(1);opacity:0.5")+'">'+Q+'<div style="padding:8px 6px 6px;background:var(--tile-bg);text-align:center;border-bottom:3px solid '+(N?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+M+"px;font-weight:900;color:"+(N?"#1A6B3C":"#aaa")+';line-height:1">'+j+'</div></div><div style="flex:1;overflow:hidden;background:'+(N?"#1A6B3C":"#ccc")+'">'+me(j,140,220)+"</div></div>"}function W(j,F){var H=window.innerWidth>=768?.76:.54,Q=140,R=305,M=Math.round(R*.22),N=R-M,ce=j.length>7?10:13,ue=me(j,Q,N),we=F?"1.5px solid #2a7a40":"1px solid #ddd",ye=F?"":"filter:grayscale(1);opacity:0.45;",Te=F?"#1A6B3C":"#bbb",ze="#fff";return'<div style="display:inline-block;zoom:'+H+';line-height:0;pointer-events:none"><div style="width:'+Q+"px;height:"+R+"px;border-radius:6px;border:"+we+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;"+ye+'"><div style="height:'+M+"px;background:"+Te+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+ce+"px;font-weight:900;color:"+ze+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(Q-4)+'px">'+j+'</span></div><div style="height:'+N+'px;overflow:hidden;flex-shrink:0">'+ue+"</div></div></div>"}function pe(j){if(D){const F=C();if(!F.length){j.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const H=F.map(Q=>c.find(R=>R.player.id===Q.id)||{_fake:!0,player:Q,id:"fake-"+Q.id});oe(H,Q=>Q._fake?an(Q.player):wi(Q,""),Q=>Q._fake?fe({player:Q.player,id:"x",_fake:!0}):fe(Q),Q=>{Q._fake||sn(Q,c,h,t)})}else{const F=Z();if(!F.length){j.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const H={};F.forEach(R=>{const M=R.player.id;H[M]||(H[M]=[]),H[M].push(R)});const Q=Object.values(H).map(R=>ko(R));oe(Q,R=>{const M=h[R.player.id]||1,N=M>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${M}</div>`:"",ue=c.filter(we=>we.player.id===R.player.id&&we.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return wi(R,N+ue)},R=>fe(R),R=>sn(R,c,h,t))}}function O(j){const F=D?b:[...$];if(!F.length){j.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const H=F.map(Q=>({formation:Q,card:m.find(R=>R.formation===Q)||null,owned:$.has(Q)}));oe(H,({formation:Q,card:R,owned:M})=>S(Q,M?R:null,M?m.filter(N=>N.formation===Q).length:0),({formation:Q,owned:R})=>W(Q,R),({card:Q,owned:R})=>{R&&Q&&Io(Q,m,t,o)})}function V(j){const F=Object.keys(x),H=D?F.length?F:w:[...f];if(!H.length){j.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Q=H.map(R=>({type:R,gc:De[R]||{icon:"⚡",desc:""},def:x[R]||null,owned:f.has(R),card:l.find(M=>M.gc_type===R)||null}));oe(Q,({type:R,gc:M,def:N,owned:ce,card:ue})=>{var qe;const we=ce?l.filter(Me=>Me.gc_type===R).length:0,ye=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Te=(N==null?void 0:N.gc_type)==="ultra_game_changer",ze={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ke={purple:"#b06ce0",light_blue:"#00d4ef"},Ce=ze[N==null?void 0:N.color]||ze.purple,He=ke[N==null?void 0:N.color]||ke.purple,$e=(N==null?void 0:N.effect)||M.desc||"",Ee=N!=null&&N.image_url?`/icons/${N.image_url}`:((qe=N==null?void 0:N.club)==null?void 0:qe.logo_url)||(N!=null&&N.country_code?`https://flagsapi.com/${N.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return ce&&ue?`<div data-gc-id="${ue.id}" data-gc-type="${R}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${He};background:${Ce};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${He}66;cursor:pointer">
          ${ye}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Ee?`<img src="${Ee}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${M.icon}</span>`}
          </div>
        ...
        </div>`},({type:R,gc:M,def:N,owned:ce})=>{const ue=window.innerWidth>=768?.76:.54,we={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ye={purple:"#9b59b6",light_blue:"#00bcd4"},Te=we[N==null?void 0:N.color]||we.purple,ze=ye[N==null?void 0:N.color]||ye.purple,ke=N!=null&&N.image_url?`/icons/${N.image_url}`:null;return ce?`<div style="display:inline-block;zoom:${ue};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:${Te};border:1px solid ${ze};display:flex;flex-direction:column;overflow:hidden"><div style="height:56px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:13px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${R}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center">${ke?`<img src="${ke}" style="max-width:130px;max-height:190px;object-fit:contain">`:`<span style="font-size:48px">${M.icon}</span>`}</div><div style="height:54px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:10px;color:rgba(255,255,255,0.7);text-align:center">${((N==null?void 0:N.effect)||M.desc||"").slice(0,30)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${ue};line-height:0;pointer-events:none"><div style="width:140px;height:310px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:36px">${M.icon}</span><span style="font-size:12px;color:#aaa;margin-top:6px;text-align:center;padding:0 6px">${R}</span></div></div>`},({type:R,owned:M,def:N})=>{M&&zo(R,N,o)})}function U(j){const F="#E87722",H="/";if(!y.length){j.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Q={};y.forEach(M=>{const N=M.stadium_id||"?";(Q[N]=Q[N]||[]).push(M)});const R=Object.entries(Q).map(([M,N])=>({sid:M,def:u[M]||null,count:N.length,card:N[0]}));oe(R,({def:M,count:N})=>{var ze,ke;const ce=(M==null?void 0:M.name)||"?",ue=((ze=M==null?void 0:M.club)==null?void 0:ze.encoded_name)||(M==null?void 0:M.country_code)||"—",we=M!=null&&M.image_url?`${H}icons/${M.image_url}`:((ke=M==null?void 0:M.club)==null?void 0:ke.logo_url)||(M!=null&&M.country_code?`https://flagsapi.com/${M.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ye=we?`<img src="${we}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',Te=N>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${N}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${F},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${F}66">
          ${Te}
          ...
          <div style="height:140px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.08)">${ye}</div>
        ...
        </div>`},({def:M,count:N})=>{var ze,ke;const ce=window.innerWidth>=768?.76:.54,ue=(M==null?void 0:M.name)||"?",we=((ze=M==null?void 0:M.club)==null?void 0:ze.encoded_name)||(M==null?void 0:M.country_code)||"—",ye=M!=null&&M.image_url?`${H}icons/${M.image_url}`:((ke=M==null?void 0:M.club)==null?void 0:ke.logo_url)||(M!=null&&M.country_code?`https://flagsapi.com/${M.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Te=ye?`<img src="${ye}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${ce};line-height:0;pointer-events:none">
          <div style="width:140px;height:310px;border-radius:8px;background:linear-gradient(160deg,${F},#c45a00);border:1px solid #c45a00;display:flex;flex-direction:column;overflow:hidden">
            ...
            <div style="flex:1;display:flex;align-items:center;justify-content:center">${Te}</div>
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(j=>{j.addEventListener("click",()=>{B=j.dataset.tab,k="Tous",I="",D=!1,e.querySelectorAll(".col-tab-btn").forEach(F=>{const H=F.dataset.tab===B;F.style.borderBottomColor=H?"var(--green)":"transparent",F.style.color=H?"var(--green)":"var(--tile-fg-dim)"}),T(),Y()})}),T(),Y()}function zo(e,t,i){const n=De[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,l=(t==null?void 0:t.effect)||n.desc,m=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(me=document.getElementById("close-detail"))==null||me.addEventListener("click",s);let Y=new Set;const oe=()=>{const O=Y.size,V=document.getElementById("sell-action-panel");if(!V)return;V.style.display=O>0?"block":"none",document.getElementById("sell-selected-count").textContent=O;const U=document.getElementById("evolve-btn");U&&(U.textContent=`⬆️ Évoluer ${O>1?"(+"+O+")":""}`)};document.querySelectorAll(".expl-check").forEach(O=>{O.addEventListener("change",()=>{const V=O.dataset.id;O.checked?Y.add(V):Y.delete(V);const U=O.closest(".exemplaire-row");U&&(U.style.borderColor=O.checked?"#1A6B3C":"#eee"),oe()})}),document.querySelectorAll(".exemplaire-row").forEach(O=>{O.addEventListener("click",V=>{if(V.target.closest("button")||V.target.tagName==="INPUT")return;const U=O.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(O=>{O.addEventListener("click",V=>{V.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${O.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(S=document.getElementById("evolve-btn"))==null||S.addEventListener("click",async()=>{if(y<=1)return;const O=[...Y];if(!O.length)return;if(Y.has(e.id)){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",R.innerHTML=`
        ...
        </div>`,document.body.appendChild(R),R.querySelector("#err-close").addEventListener("click",()=>R.remove()),R.addEventListener("click",M=>{M.target===R&&R.remove()});return}const V=O.filter(R=>R!==e.id),U=l.rarity==="legende"?2:1;if((V.length||1)*U,!(!V.length&&O.length===1&&O[0]===e.id)){if(!V.length){o("Sélectionne des copies à sacrifier","warning");return}}if(!await new Promise(R=>{const M=document.createElement("div");M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",M.innerHTML=`
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=T=>T.touches&&T.touches[0]?T.touches[0].clientX:T.clientX;function l(T){o||(d=!0,s.style.opacity="1",m(T))}function m(T){if(!d||o)return;const Y=a.getBoundingClientRect(),oe=c(T)-Y.left,fe=Math.max(0,Math.min(1,oe/Y.width));s.style.width=fe*Y.width+"px",fe>=.82&&g()}function y(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var Y;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(Y=document.getElementById("cut-flash"))==null||Y.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const T=document.getElementById("cut-hint");T&&(T.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",m),window.addEventListener("pointerup",y),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",y);let x=0,p=!1;const u=new Set;function b(T){x=T,document.getElementById("reveal-phase").style.display="flex",w(),h(T,0),I()}function w(){const T=document.getElementById("card-dots");T&&(T.innerHTML=e.map((Y,oe)=>`<div class="card-dot" data-i="${oe}" style="width:8px;height:8px;border-radius:50%;background:${oe===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),T.querySelectorAll(".card-dot").forEach(Y=>Y.addEventListener("click",()=>f(parseInt(Y.dataset.i)))))}function h(T,Y){var U,j;const oe=e[T],fe=document.getElementById("card-counter"),me=document.getElementById("card-track");fe&&(fe.textContent=`Carte ${T+1} / ${e.length}`);const S=document.getElementById("reveal-btns");S&&(S.style.display=T===e.length-1?"flex":"none");const W=oe.card_type==="player"&&((U=oe.player)==null?void 0:U.rarity)==="legende",pe=!u.has(T);u.add(T);let O=0;if(oe.card_type==="player"&&oe.player){const F=oe.player,H=F.job||"ATT";O=Number(H==="GK"?F.note_g:H==="DEF"?F.note_d:H==="MIL"?F.note_m:F.note_a)||0}const V=F=>{me.innerHTML=`
        ...
        </div>`;const H=document.getElementById("current-card-wrap");Y!==0?(H.style.transition="none",H.style.transform=`translateX(${Y>0?100:-100}%)`,requestAnimationFrame(()=>{H.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",H.style.transform="translateX(0)"})):H.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),F||W?ie():ne(),w()};pe&&(((j=oe.player)==null?void 0:j.rarity)==="legende"||O>=8)&&oe.card_type==="player"&&oe.player?$(oe,()=>V(!0)):V(!1)}function $(T,Y){var we;p=!0;const oe=T.player,fe=`https://flagsapi.com/${oe.country_code}/flat/64.png`,me=(we=oe.clubs)==null?void 0:we.logo_url,S=oe.face?"/"+oe.face.replace(/^public\//,"").replace(/^\//,""):null,W=oe.job||"ATT",pe=Number(W==="GK"?oe.note_g:W==="DEF"?oe.note_d:W==="MIL"?oe.note_m:oe.note_a)||0,O=T.evolution_bonus||0,V=pe+O,U=oe.rarity==="legende",j=V>=18,F=document.getElementById("walkout-overlay"),H=document.getElementById("walkout-stage");if(!F||!H){p=!1,Y();return}let Q=null;U&&(Q=mo("/sounds/Legendary.mp3",.8)),F.style.display="flex";const R=()=>{const ye=H.firstElementChild;ye&&(ye.classList.remove("wo-in"),ye.classList.add("wo-out"))},M=1800,N=400;H.innerHTML=`<img class="wo-in" src="${fe}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(R,M),setTimeout(()=>{var ye;H.innerHTML=me?`<img class="wo-in" src="${me}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ye=oe.clubs)==null?void 0:ye.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},M+N),setTimeout(R,M*2+N),setTimeout(()=>{H.innerHTML=S?`<img class="wo-in" src="${S}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(M+N)*2),setTimeout(R,(M+N)*2+M);const ue=j?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[W]||"#fff";setTimeout(()=>{H.innerHTML=`<div class="wo-in" style="
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const W=t.pendingAttack;let pe="";if(t.selected.length>0){const O=t.selected.map(U=>({...(t.homeTeam[U._role]||[]).find(F=>F.cardId===U.cardId)||U,_line:U._role})),V=Zt(O,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Qe(O.map(U=>({...U,used:!1})),"#3a7bd5",V.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Qe((W.players||[]).map(O=>({...O,used:!1})),"#ff6b6b",W.total,"attack",t.formation)}</div>
            ${pe}
            ...
            <div style="display:flex;justify-content:center">${Qe((W.players||[]).map(pe=>({...pe,used:!1})),"#00ff88",W.total,"attack",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Qe(W.map(O=>({...O,used:!1})),"#FFD700",pe.total,"attack",t.formation)}</div>
    ...
    ${(()=>{const S=window.innerWidth>=700,W=(R,M,N)=>{var qe,Me;const ce=(t.gcDefs||[]).find(Ye=>Ye.name===R.gc_type),ue={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",we={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",ye=(ce==null?void 0:ce.name)||R.gc_type,Te=(ce==null?void 0:ce.effect)||((qe=De[R.gc_type])==null?void 0:qe.desc)||"",ze=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,ke=((Me=De[R.gc_type])==null?void 0:Me.icon)||"⚡",Ce=Math.round(N*.22),He=Math.round(N*.22),$e=N-Ce-He,Ee=ye.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${M}px;height:${N}px;border-radius:10px;border:2px solid ${we};background:${ue};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${Ce}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ee}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${M-6}px">${ye}</span>
          ...
          <div style="height:${$e}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${ze?`<img src="${ze}" style="max-width:${M-10}px;max-height:${$e-6}px;object-fit:contain">`:`<span style="font-size:${Math.round($e*.55)}px">${ke}</span>`}
          </div>
        ...
        </div>`},pe=(R,M)=>{var N;return`<div id="boost-card"
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(S=>{var W,pe,O;if(S.type==="duel"){const V=S.isGoal,U=S.homeScored?"#FFD700":V?"#ff6b6b":"rgba(255,255,255,0.3)",j=S.homeScored?"⚽ BUT !":V?"⚽ BUT IA !":(W=S.homePlayers)!=null&&W.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${V?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${U};margin-bottom:4px">
                ...
                ${(pe=S.homePlayers)!=null&&pe.length?`<div style="margin-bottom:3px">${Qe(S.homePlayers,"rgba(255,255,255,0.7)",S.homeTotal,void 0,t.formation)}</div>`:""}
                ${(O=S.aiPlayers)!=null&&O.length?`<div style="opacity:0.7">${Qe(S.aiPlayers,"#ff6b6b",S.aiTotal,void 0,t.formation)}</div>`:""}
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Xo[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Re(r,r._line||r.job)}</div>
          <div style="flex:1"><b>${r.firstname} ${r.name}</b><div style="font-size:11px;color:#888">${r._line||r.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(d=>d.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Le(e,t,i)})})}async function ht(e,t,i){var l,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=xo(t.mode,a);t.matchId&&await v.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const d={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?d.wins=(n.profile.wins||0)+1:o?d.draws=(n.profile.draws||0)+1:d.losses=(n.profile.losses||0)+1,await v.from("users").update(d).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${gi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Se.id!==nt.id?`<div style="font-size:20px;font-weight:900;color:${Se.color}">
                    ${Ne>J.mmr?"📈":"📉"} ${nt.emoji} ${nt.label} → ${Se.emoji} ${Se.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Ne>J.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Ie>=0?"📈":"📉"}</div>
      ...
      ${G}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(te=q.querySelector("#pvp-end-home"))==null||te.addEventListener("click",()=>{q.remove(),it(e),l?g("mini-league",{openLeagueId:l}):g(a?"ranked":"home")})}const Z=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var z;const E=_.new;try{if(E.status==="finished"||E.forfeit){if(B)return;B=!0,k&&(clearInterval(k),k=null),E.game_state&&(f=E.game_state),ne(E);return}if(E.game_state){const A=f;f=E.game_state;const L=f._lastGC;if(L&&L.seq&&!ie.has(L.seq)&&(ie.add(L.seq),L.by!==p)){U(L.type,L.by,()=>W());return}const G=A[p+"Score"]||0,q=A[u+"Score"]||0,P=f[p+"Score"]||0,K=f[u+"Score"]||0,ee=P>G,re=K>q;if((ee||re)&&!D.has(f.round)){D.add(f.round);const te=[...f.log||[]].reverse().find(de=>de.isGoal),J=((te==null?void 0:te.homePlayers)||[]).map(de=>({name:de.name,note:de.note,portrait:de.portrait,job:de.job}));!!((z=te==null?void 0:te.text)!=null&&z.includes("DERNIER CORNER"))?we().then(()=>{Ze(J,P,K,ee,()=>W())}):Ze(J,P,K,ee,()=>W());return}W()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function C(_){Object.assign(f,_),f.lastActionAt=new Date().toISOString();const{error:E}=await v.from("matches").update({game_state:f}).eq("id",i);E&&x("Erreur de synchronisation","error");try{W()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function T(){if(B)return;B=!0,k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,E=n?"p2":"p1",z=n?"p1":"p2",A={...f,[E+"Score"]:3,[z+"Score"]:0,phase:"finished"},L=A.p1Score||0,G=A.p2Score||0;try{await v.from("matches").update({game_state:A}).eq("id",i);const{data:q,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:L,p_away_score:G,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await v.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{v.removeChannel(Z)}catch{}setTimeout(()=>{it(e),l?g("mini-league",{openLeagueId:l}):g("home")},800)}const Y={BOOST_STAT:({value:_=1,count:E=1,roles:z=[]},A,L)=>{const G=A[p+"Team"],q=Object.entries(G).filter(([P])=>!z.length||z.includes(P)).flatMap(([P,K])=>K.filter(ee=>!ee.used).map(ee=>({...ee,_line:P})));if(!q.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),L(A);return}oe(q,E,`Choisir ${E} joueur(s) à booster (+${_})`,P=>{P.forEach(K=>{const ee=(G[K._line]||[]).find(re=>re.cardId===K.cardId);ee&&(ee.boost=(ee.boost||0)+_,A.log.push({text:`⚡ +${_} sur ${ee.name}`,type:"info"}))}),A[p+"Team"]=G,L(A)})},DEBUFF_STAT:({value:_=1,count:E=1,roles:z=[],target:A="ai"},L,G)=>{const q=A==="home"?p:u,P=L[q+"Team"],K=A==="home"?"allié":"adverse",ee=Object.entries(P).filter(([re])=>!z.length||z.includes(re)).flatMap(([re,te])=>te.map(J=>({...J,_line:re})));if(!ee.length){L.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),G(L);return}oe(ee,E,`Choisir ${E} joueur(s) ${K}(s) (-${_})`,re=>{re.forEach(te=>{const J=(P[te._line]||[]).find(se=>se.cardId===te.cardId);J&&(J.boost=(J.boost||0)-_,L.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),L[q+"Team"]=P,G(L)})},GRAY_PLAYER:({count:_=1,roles:E=[],target:z="ai"},A,L)=>{const G=z==="home"?p:u,q=A[G+"Team"],P=z==="home"?"allié":"adverse",K=Object.entries(q).filter(([ee])=>!E.length||E.includes(ee)).flatMap(([ee,re])=>re.filter(te=>!te.used).map(te=>({...te,_line:ee})));if(!K.length){A.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),L(A);return}oe(K,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,ee=>{const re="usedCardIds_"+G,te=new Set(A[re]||[]);ee.forEach(J=>{const se=(q[J._line]||[]).find(de=>de.cardId===J.cardId);se&&(se.used=!0,te.add(J.cardId),A.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),A[re]=[...te],A[G+"Team"]=q,L(A)})},REVIVE_PLAYER:({count:_=1,roles:E=[]},z,A)=>{const L=z[p+"Team"],G=Object.entries(L).filter(([q])=>!E.length||E.includes(q)).flatMap(([q,P])=>P.filter(K=>K.used).map(K=>({...K,_line:q})));if(!G.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(z);return}oe(G,_,`Choisir ${_} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const K=(L[P._line]||[]).find(ee=>ee.cardId===P.cardId);K&&(K.used=!1,z.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=L,A(z)})},REMOVE_GOAL:({},_,E)=>{const z=u+"Score";_[z]>0?(_[z]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(_)},ADD_GOAL_DRAW:({},_,E)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(_)},ADD_SUB:({value:_=1},E,z)=>{E.maxSubs=(E.maxSubs||3)+_,E.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),z(E)},CUSTOM:({},_,E)=>E(_)};function oe(_,E,z,A){const L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let G=[];function q(){var K,ee;const P=_.map(re=>{const te=re._line||re.job||"MIL",J=G.find(de=>de.cardId===re.cardId),se=je({...re,_evolution_bonus:0},{width:90,showStad:!0,role:te,extraNote:re.boost||0});return`<div class="pp-item" data-cid="${re.cardId}"
        ...
        </div>`,(K=L.querySelector("#pp-close"))==null||K.addEventListener("click",()=>L.remove()),L.querySelectorAll(".pp-item").forEach(re=>{re.addEventListener("click",()=>{const te=re.dataset.cid,J=_.find(de=>de.cardId===te),se=G.findIndex(de=>de.cardId===te);J&&(se>-1?G.splice(se,1):G.length<E&&G.push(J),q())})}),(ee=L.querySelector("#pp-confirm"))==null||ee.addEventListener("click",()=>{L.remove(),A(G)})}q(),document.body.appendChild(L)}async function fe(_,E){const A=(f["gcCardsFull_"+p]||[]).find(P=>P.id===_),L=(A==null?void 0:A._gcDef)||(f.gcDefs||[]).find(P=>{var K;return P.name===E||((K=P.name)==null?void 0:K.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),G=[...f["usedGc_"+p]||[],_],q={type:E,by:p,seq:(f._gcAnimSeq||0)+1};ie.add(q.seq),U(E,p,async()=>{if(L!=null&&L.effect_type&&L.effect_type!=="CUSTOM"){const K=Y[L.effect_type];if(K){const ee={...f};K(L.effect_params||{},ee,async re=>{re["usedGc_"+p]=G,re._lastGC=q,re._gcAnimSeq=q.seq,await C(re)});return}}const P={...f};switch(E){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const K=u+"Score";P[K]>0&&(P[K]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=G,P._lastGC=q,P._gcAnimSeq=q.seq,await C(P)})}function me(_,E){const z="usedCardIds_"+_,A=new Set(f[z]||[]);E.forEach(L=>A.add(L)),f[z]=[...A]}function S(){for(const _ of["p1","p2"]){const E=new Set(f["usedCardIds_"+_]||[]),z=f[_+"Team"];if(z)for(const A of["GK","DEF","MIL","ATT"])(z[A]||[]).forEach(L=>{L.used=E.has(L.cardId)})}}function W(){var Ki,Vi,Yi,Wi,Xi,Ji;if(f.phase==="reveal")return pe();if(f.phase==="midfield")return V();if(f.phase==="finished")return Ye();const _=f[p+"Team"],E=f[u+"Team"];S();const z=f[p+"Score"],A=f[u+"Score"],L=f[p+"Name"],G=f[u+"Name"],q=f.phase===p+"-attack",P=f.phase===p+"-defense",K=Array.isArray(f["selected_"+p])?f["selected_"+p]:[],ee=K.map(X=>X.cardId),re=window.innerWidth>=700,te=f[p+"Subs"]||[],J=f["usedSubIds_"+p]||[],se=te.filter(X=>!J.includes(X.cardId)),de=f["gcCardsFull_"+p]||[],xe=f["usedGc_"+p]||[],le=de.filter(X=>!xe.includes(X.id)),be=f.boostOwner===p&&!f.boostUsed,he=[..._.MIL||[],..._.ATT||[]].filter(X=>!X.used),ae=[...E.MIL||[],...E.ATT||[]].filter(X=>!X.used),Ie=!Ce(E),Ne=he.length===0&&ae.length===0&&!Ie,Se=(_.DEF||[]).filter(X=>!X.used),We=(_.GK||[]).filter(X=>!X.used);let Ue=[];q&&he.length===0&&(Ie?(Ue=Se.map(X=>X.cardId),Se.length===0&&(Ue=Ue.concat(We.map(X=>X.cardId)))):Ne&&(Ue=[...Se,...We].map(X=>X.cardId)));function nt(X,ge,Ae){var Bt,gt;const _e=X._gcDef,jt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[_e==null?void 0:_e.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",at={purple:"#b06ce0",light_blue:"#00d4ef"}[_e==null?void 0:_e.color]||"#b06ce0",Pe=(_e==null?void 0:_e.name)||X.gc_type,Oe=(_e==null?void 0:_e.effect)||((Bt=De[X.gc_type])==null?void 0:Bt.desc)||"",Be=_e!=null&&_e.image_url?`/icons/${_e.image_url}`:null,kt=((gt=De[X.gc_type])==null?void 0:gt.icon)||"⚡",Ge=Math.round(Ae*.22),ft=Math.round(Ae*.22),st=Ae-Ge-ft,Ct=Pe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
        style="box-sizing:border-box;width:${ge}px;height:${Ae}px;border-radius:10px;border:2px solid ${at};background:${jt};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
      ...
      </div>`}const Fe=(X,ge)=>ge?Ut(130,175):nt(X,130,175),Xe=(X,ge)=>ge?Ut(68,95):nt(X,68,95),Ke=re?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",pt=q?$e(p)?`<button id="pvp-action" style="${Ke};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${K.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Ke};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:P?`<button id="pvp-action" style="${Ke};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${K.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${G}</div>`,ot=q&&!$e(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':q||P?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${K.length}/3 sélectionné(s)</div>`:"",At=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${re?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Nt(_,f[p+"Formation"],ut,ee,re?1300:zt(),re?600:Gt(),Ue)}
      </div>
    </div>`,rt=f[p+"Team"],Un=(()=>{var ge,Ae,_e,jt,at;if(P&&((ge=f.pendingAttack)!=null&&ge.players)){const Pe=f.pendingAttack;let Oe="";if(K.length>0){const Be=K.map(Ge=>{const ft=(rt[Ge._role]||[]).find(yi=>yi.cardId===Ge.cardId)||Ge,st=rt[Ge._role]||[],Ct=st.findIndex(yi=>yi.cardId===Ge.cardId),Bt=xt(st.length),gt=Ct>=0?Bt[Ct]:ft._col??1;return{...ft,_line:Ge._role,_col:gt}}),kt=Zt(Be,((Ae=f.modifiers)==null?void 0:Ae[p])||{},f[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Qe(Be.map(Ge=>({...Ge,used:!1})),"#3a7bd5",kt.total,"defense",f[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          ${Oe}
        </div>`}if(q&&((_e=f.pendingAttack)!=null&&_e.players)){const Pe=f.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Qe((Pe.players||[]).map(Oe=>({...Oe,used:!1})),"#00ff88",Pe.total,"attack",f[p+"Formation"])}</div>
        </div>`}if(q&&!((jt=f.pendingAttack)!=null&&jt.players)&&K.length>0){const Pe=K.map(Be=>{const kt=(rt[Be._role]||[]).find(gt=>gt.cardId===Be.cardId)||Be,Ge=["GK","DEF"].includes(Be._role),ft=rt[Be._role]||[],st=ft.findIndex(gt=>gt.cardId===Be.cardId),Ct=xt(ft.length),Bt=st>=0?Ct[st]:kt._col??1;return{...kt,_line:Be._role,_col:Bt,...Ge?{note_a:Math.max(1,Number(kt.note_a)||0)}:{}}}),Oe=Qt(Pe,((at=f.modifiers)==null?void 0:at[p])||{},f[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Qe(Pe.map(Be=>({...Be,used:!1})),"#FFD700",Oe.total,"attack",f[p+"Formation"])}</div>
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Nt(_,f[p+"Formation"],ut,ee,zt(),Gt(),Ue)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Mt(){const X=e.querySelector(".match-screen");if(!X)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=ge+"px",X.style.minHeight=ge+"px",X.style.maxHeight=ge+"px",X.style.overflow="hidden";const Ae=e.querySelector("#mobile-action-bar"),_e=e.querySelector("#mobile-play-area");Ae&&_e&&(_e.style.paddingBottom=Ae.offsetHeight+"px")}if(Mt(),setTimeout(Mt,120),setTimeout(Mt,400),I||(I=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Mt),window.visualViewport.addEventListener("scroll",Mt)),window.addEventListener("resize",Mt)),function(){const ge=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ge)return;const Ae=ge.closest("#match-terrain-wrap");Ae&&(Ae.style.cssText="position:relative;width:100%;height:100%;padding:0"),ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const ge=X.closest("#match-terrain-wrap");ge&&(ge.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!q&&!P)return;const ge=X.dataset.cardId,Ae=X.dataset.role,_e=(_[Ae]||[]).find(Oe=>Oe.cardId===ge);if(!_e||_e.used)return;const jt=Ue.includes(ge);if(q&&!["MIL","ATT"].includes(Ae)&&!jt)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const at=f["selected_"+p],Pe=at.findIndex(Oe=>Oe.cardId===ge);Pe>-1?at.splice(Pe,1):at.length<3&&at.push({..._e,_role:Ae}),W()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>H(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>H())}),(Ki=e.querySelector("#pvp-sub-open"))==null||Ki.addEventListener("click",()=>H()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{q?X.addEventListener("click",()=>j(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Vi=e.querySelector("#pvp-boost-card"))==null||Vi.addEventListener("click",()=>F()),(Yi=e.querySelector("#pvp-action"))==null||Yi.addEventListener("click",X=>{q?X.currentTarget.dataset.pass==="1"||!$e(p)?N():Te():P&&ze()}),(Wi=e.querySelector("#pvp-quit"))==null||Wi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&T()}),(Xi=e.querySelector("#pvp-view-opp"))==null||Xi.addEventListener("click",()=>R()),(Ji=e.querySelector("#pvp-toggle-history"))==null||Ji.addEventListener("click",()=>M()),k&&(clearInterval(k),k=null),(q||P)&&!B){let X=30,ge=!1;const Ae=()=>document.getElementById("pvp-timer"),_e=()=>{Ae()&&(Ae().textContent=X+"s",Ae().style.color=ge?"#ff4444":"#fff")};_e(),k=setInterval(()=>{X--,X<0?ge?(clearInterval(k),k=null,q&&!$e(p)?N():T()):(ge=!0,X=15,_e()):_e()},1e3)}}function pe(){dt(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(J);let se=!1;const de=()=>{se||(se=!0,J.remove(),setTimeout(()=>z&&z(),50))};J.addEventListener("click",de),setTimeout(de,3e3)}function j(_,E){var J,se,de,xe;const A=(f["gcCardsFull_"+p]||[]).find(le=>le.id===_),L=A==null?void 0:A._gcDef,G={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[L==null?void 0:L.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",q={purple:"#b06ce0",light_blue:"#00d4ef"}[L==null?void 0:L.color]||"#b06ce0",P=(L==null?void 0:L.name)||E,K=(L==null?void 0:L.effect)||((J=De[E])==null?void 0:J.desc)||"Carte spéciale.",ee=L!=null&&L.image_url?`/icons/${L.image_url}`:null,re=((se=De[E])==null?void 0:se.icon)||"⚡",te=document.createElement("div");te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",te.innerHTML=`
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${E.map(L=>{const G={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[L._line]||"#555",q=Re(L,L._line)+(L.boost||0);return`<div class="bp-item" data-cid="${L.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${G};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(z),(A=z.querySelector("#bp-close"))==null||A.addEventListener("click",()=>z.remove()),z.querySelectorAll(".bp-item").forEach(L=>{L.addEventListener("click",async()=>{const G=L.dataset.cid,q=E.find(K=>K.cardId===G);if(!q)return;const P=(_[q._line]||[]).find(K=>K.cardId===G);P&&(P.boost=(P.boost||0)+f.boostValue),z.remove(),await C({[p+"Team"]:_,boostUsed:!0})})})}function H(_=null){var se,de;if(!(f.phase===p+"-attack")){x("Remplacement uniquement avant votre attaque","warning");return}const z=f[p+"Team"],A=f["usedSubIds_"+p]||[],L=f.maxSubs||3;if(A.length>=L){x(`Maximum ${L} remplacements atteint`,"warning");return}const G=Object.entries(z).flatMap(([xe,le])=>(le||[]).filter(be=>be.used).map(be=>({...be,_line:xe}))),q=(f[p+"Subs"]||[]).filter(xe=>!A.includes(xe.cardId));if(!G.length){x("Aucun joueur utilisé à remplacer","warning");return}if(!q.length){x("Aucun remplaçant disponible","warning");return}let P=Math.max(0,G.findIndex(xe=>xe.cardId===_));const K=((se=G[P])==null?void 0:se._line)||((de=G[P])==null?void 0:de.job);let ee=Math.max(0,q.findIndex(xe=>xe.job===K)),re=!1;const te=document.createElement("div");te.id="pvp-sub-overlay",te.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function J(){var Ne,Se,We,Ue,nt,Ut;const xe=G[P],le=q[ee],be=Math.min(130,Math.round((window.innerWidth-90)/2)),he=Math.round(be*1.35),ae=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;te.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${le?vt({...le,used:!1,boost:0},be,he):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${xe?vt({...xe,used:!1,boost:0},be,he):"<div>—</div>"}</div>
      ...
      </div>`,(Ne=te.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>te.remove()),(Se=te.querySelector("#pout-up"))==null||Se.addEventListener("click",()=>{P>0&&(P--,J())}),(We=te.querySelector("#pout-down"))==null||We.addEventListener("click",()=>{P<G.length-1&&(P++,J())}),(Ue=te.querySelector("#pin-up"))==null||Ue.addEventListener("click",()=>{ee>0&&(ee--,J())}),(nt=te.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{ee<q.length-1&&(ee++,J())});const Ie=(Fe,Xe,Ke,pt)=>{const ot=te.querySelector("#"+Fe);if(!ot)return;let At=0;ot.addEventListener("touchstart",ut=>{At=ut.touches[0].clientY},{passive:!0}),ot.addEventListener("touchend",ut=>{const _t=ut.changedTouches[0].clientY-At;if(Math.abs(_t)<30)return;const rt=Xe();_t<0&&rt<pt-1?(Ke(rt+1),J()):_t>0&&rt>0&&(Ke(rt-1),J())},{passive:!0})};Ie("pin-panel",()=>ee,Fe=>ee=Fe,q.length),Ie("pout-panel",()=>P,Fe=>P=Fe,G.length),(Ut=te.querySelector("#psub-confirm"))==null||Ut.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),re)return;re=!0;const Xe=G[P],Ke=q[ee];if(!Xe||!Ke)return;const pt=Xe._line,ot=(z[pt]||[]).findIndex(_t=>_t.cardId===Xe.cardId);if(ot===-1){x("Erreur : joueur introuvable","error"),te.remove();return}const At={...Ke,_line:pt,position:Xe.position,used:!1,boost:0};z[pt].splice(ot,1,At);const ut=[...A,Ke.cardId];te.remove(),Q(Xe,Ke,async()=>{await C({[p+"Team"]:z,[u+"Team"]:f[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(te),J()}function Q(_,E,z){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const G=(K,ee,re)=>`<div style="text-align:center">
      ...
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(_),(E=_.querySelector("#pvp-opp-close"))==null||E.addEventListener("click",()=>_.remove())}function M(){var z;const _=f.log||[],E=document.createElement("div");E.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",E.innerHTML=`
      ...
      </div>`,document.body.appendChild(E),(z=E.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>E.remove())}async function N(){if(f.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",E=(f.round||0)+1,z=[...f.log||[]];z.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=Ee(f),L=$e(_),G=A||!L?"finished":_+"-attack";await C({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:G,attacker:_,round:E,log:z}),G==="finished"&&await Me(f)}function ce(_){const E=(_.GK||[]).some(A=>!A.used),z=["DEF","MIL","ATT"].some(A=>(_[A]||[]).some(L=>!L.used));return E&&!z}function ue(_){return(_.p1Score||0)!==(_.p2Score||0)?null:ce(_.p1Team)&&!Ce(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:ce(_.p2Team)&&!Ce(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function we(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(z,A)=>new Promise(L=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${A};letter-spacing:2px;animation:lcFade 1.4s ease both">${z}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(L,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function ye(_,E){const{side:z,gk:A}=_;if(!A)return;const L=z+"Score",G=(E[L]||0)+1;A.used=!0;const q=[...E.log||[]];q.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[qt(A)]:[],aiPlayers:z==="p2"?[qt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[z+"Name"]} marque !`});const P=(E.round||0)+1,K=z==="p1"?"p2":"p1",ee={...E,[L]:G},re=Ee(ee);D.add(P),await we();const te=z===p?G:E[p+"Score"]||0,J=z===p?E[u+"Score"]||0:G;Ze([qt(A)],te,J,z===p,async()=>{await C({[L]:G,log:q,round:P,pendingAttack:null,phase:re?"finished":K+"-attack",attacker:K,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),re&&await Me({...f,[L]:G})})}async function Te(){const _=f[p+"Team"],E=!["GK","DEF","MIL","ATT"].some(G=>(f[u+"Team"][G]||[]).some(q=>!q.used)),z=(f["selected_"+p]||[]).map(G=>{const q=(_[G._role]||[]).find(de=>de.cardId===G.cardId)||G,P=["GK","DEF"].includes(G._role),K=_[G._role]||[],ee=K.findIndex(de=>de.cardId===G.cardId),re=xt(K.length),te=ee>=0?re[ee]:q._col??1,J=f.stadiumDef||f.homeStadiumDef||null,se=q.stadiumBonus||J&&(J.club_id&&String(q.club_id)===String(J.club_id)||J.country_code&&q.country_code===J.country_code)||!1;return{...q,_line:G._role,_col:te,stadiumBonus:se,...P?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!z.length)return;const A=Qt(z,f.modifiers[p]||{},f[p+"Formation"]);me(p,z.map(G=>G.cardId)),z.forEach(G=>{const q=(_[G._role]||[]).find(P=>P.cardId===G.cardId);q&&(q.used=!0)}),f["selected_"+p]=[],W();const L=[...f.log||[]];if(E){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await ye({side:p,gk:z[0]},{...f,[p+"Team"]:_,log:L});return}const q=(f[p+"Score"]||0)+1,P=z.map(J=>qt(J));L.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:A.total,aiTotal:0});const K=(f.round||0)+1,ee=p==="p1"?"p2":"p1",re={...f,[p+"Team"]:_,[p+"Score"]:q},te=Ee(re);D.add(K),Ze(P,q,f[u+"Score"]||0,!0,async()=>{await C({[p+"Team"]:_,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:te?"finished":ee+"-attack",attacker:ee,round:K,log:L}),te&&await Me({...f,[p+"Score"]:q})});return}L.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${A.total})`}),await C({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],pendingAttack:{...A,players:z,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:L})}async function ze(){const _=f[p+"Team"],E=(f["selected_"+p]||[]).map(le=>{const be=(_[le._role]||[]).find(Se=>Se.cardId===le.cardId)||le,he=_[le._role]||[],ae=he.findIndex(Se=>Se.cardId===le.cardId),Ie=xt(he.length),Ne=ae>=0?Ie[ae]:be._col??1;return{...be,_line:le._role,_col:Ne}}),z=Zt(E,f.modifiers[p]||{},f[p+"Formation"]);me(p,E.map(le=>le.cardId)),E.forEach(le=>{const be=(_[le._role]||[]).find(he=>he.cardId===le.cardId);be&&(be.used=!0)}),f["selected_"+p]=[],W();const A=Gi(f.pendingAttack.total,z.total,f.modifiers[p]||{}),L=f.pendingAttack.side,G=A==="attack"||(A==null?void 0:A.goal),q=L==="p1"?"p2":"p1",P=(f.round||0)+1,K=(f.pendingAttack.players||[]).map(le=>qt(le)),ee=[...f.log||[]];ee.push({type:"duel",isGoal:G,homeScored:G&&L===p,text:G?`⚽ BUT de ${f[L+"Name"]} ! (${f.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${z.total})`,homePlayers:K,aiPlayers:E.map(le=>qt(le)),homeTotal:f.pendingAttack.total,aiTotal:z.total});const re=G?(f[L+"Score"]||0)+1:f[L+"Score"]||0,te={...f,[p+"Team"]:_,[L+"Score"]:re},J=Ee(te),se=J?"finished":q+"-attack",de=!J&&!G?ue(te):null,xe=async()=>{if(de){await ye(de,te);return}await C({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],[L+"Score"]:re,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:se,attacker:q,round:P,log:ee}),(se==="finished"||J)&&await Me({...f,[L+"Score"]:re})};if(G){const le=L===p,be=le?re:f[p+"Score"]||0,he=le?f[u+"Score"]||0:re;D.add(P),Ze(K,be,he,le,xe)}else await xe()}function ke(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function Ce(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(z=>!z.used))}function He(_){return Ce(_)&&!ke(_)}function $e(_){const E=f[_+"Team"],z=f[(_==="p1"?"p2":"p1")+"Team"];return!!(ke(E)||He(E)&&!Ce(z)||He(E)&&!ke(z)&&Ce(z))}function Ee(_){return!Ce(_.p1Team)&&!Ce(_.p2Team)}function qe(_){const E=_.p1Score||0,z=_.p2Score||0;return E===z?null:E>z?h.home_id:h.away_id}async function Me(_){try{const E=qe(_),z=E?h.home_id===E?h.away_id:h.home_id:null,A=_.p1Score||0,L=_.p2Score||0,{data:G,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:A,p_away_score:L,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}E&&z&&ho(E,z).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof c=="function")try{await c({homeScore:A,awayScore:L,winnerId:E,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(E){console.error("[PvP] finishMatch:",E)}}function Ye(){var L;const _=f[p+"Score"],E=f[u+"Score"],z=_>E,A=_===E;dt(e),e.innerHTML=`
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Kt};border:1px solid ${Vt};border-radius:12px;padding:16px">
        ...
        ${m.map(C=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${Lt}">
            ...
            <div style="flex:1"><div style="font-size:13px;font-weight:700;color:${Je}">${C.club_name||C.pseudo}</div><div style="font-size:11px;color:${et}">@${C.pseudo}</div></div>
      ...
      <div style="background:${Kt};border:1px solid ${Vt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((C,T)=>{const Y=x>0&&a.status==="finished"?T===0?Math.floor(x*.7):T===1?Math.floor(x*.2):T===2?Math.floor(x*.1):0:0;return`<tr style="border-bottom:1px solid ${Lt};${C.userId===o?"background:rgba(74,222,128,0.08);":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${T===0?lt:T<3?"#4ade80":Et}">${["🥇","🥈","🥉"][T]||T+1}</td>
              <td style="padding:7px 3px"><div style="font-weight:700;color:${Je}">${C.clubName}</div><div style="font-size:10px;color:${et}">@${C.pseudo}</div></td>
              <td style="text-align:center;color:${Et}">${C.played}</td><td style="text-align:center;color:${Et}">${C.won}-${C.drawn}-${C.lost}</td>
              <td style="text-align:center;color:${C.goalDiff>=0?"#4ade80":"#ff6b6b"}">${C.goalDiff>=0?"+":""}${C.goalDiff}</td>
              <td style="text-align:center;font-weight:900;font-size:14px;color:${Je}">${C.points}</td>
      ...
      <div style="background:${Kt};border:1px solid ${Vt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(C,T)=>T+1).reverse().map(C=>{const T=(d||[]).filter(Y=>Y.matchday===C);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${et};margin-bottom:6px">Journée ${C}</div>${T.map(Y=>un(Y,m,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let d="buy";const c=()=>{var p,u,b,w,h,$,f;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt(($=document.getElementById("flt-note1"))==null?void 0:$.value)||0,note2:parseInt((f=document.getElementById("flt-note2"))==null?void 0:f.value)||0}};function l(p){const u=c();return p.filter(b=>{var D,ie,ne;const w=(D=b.card)==null?void 0:D.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),$=(((ie=w.clubs)==null?void 0:ie.encoded_name)||"").toLowerCase(),f=(w.country_code||"").toLowerCase(),B=((ne=b.card)==null?void 0:ne.evolution_bonus)||0,k=Dt(w,w.job,B),I=w.job2?Dt(w,w.job2,B):0;return!(u.name&&!h.includes(u.name)||u.club&&!$.includes(u.club)||u.country&&!f.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&k<u.note1||u.note2&&I<u.note2)})}function m(p){var I,D,ie,ne;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const b=((D=p.card)==null?void 0:D.evolution_bonus)||0,w=Dt(u,u.job,b),h=u.job2?Dt(u,u.job2,b):0,$=(i.profile.credits||0)>=p.price,f=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,B=ai[u.job]||"#bbb",k=u.job2?ai[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function y(p){var I,D,ie,ne;const u=(I=p.card)==null?void 0:I.player;if(!u)return"";const b=((D=p.card)==null?void 0:D.evolution_bonus)||0,w=Dt(u,u.job,b),h=u.job2?Dt(u,u.job2,b):0,$=p.status==="sold",f=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,B=ai[u.job]||"#bbb",k=u.job2?ai[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${f?`<img src="${f}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ie=u.clubs)!=null&&ie.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${B};display:flex;align-items:center;justify-content:center">
  ...
  <div class="page">
    ...
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.20-2240" style="cursor:pointer">
