import{s as $,l as U,F as te,b as $e,c as me,d as ot}from"./formation-links-BXiJqmnj.js";function Ae(e,{navigate:t,toast:i}){e.innerHTML=`
    ...
    <div class="page-body">
      ...
      <div>
        ...
        <div class="card-panel" style="padding:0">
          ${n.map(d=>{const s=d.winner_id===r.id,l=d.home_score===d.away_score,c=l?"N":s?"V":"D",u=l?"#888":s?"#1A6B3C":"#c0392b",p={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat"}[d.mode]||d.mode,y=new Date(d.created_at).toLocaleDateString("fr",{month:"short",day:"numeric"});return`<div style="display:flex;justify-content:space-between;align-items:center;padding:10px 14px;border-bottom:1px solid var(--gray-200)">
              <div>
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function pt(e,t){const{state:i,navigate:o,toast:r,openModal:n,closeModal:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await $.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(d||[]).filter(E=>E.card_type==="player"&&E.player),c=(d||[]).filter(E=>E.card_type==="game_changer"),u=(d||[]).filter(E=>E.card_type==="formation"),p=Object.keys(te),g=Object.keys(ce),y={};l.forEach(E=>{const A=E.player.id;y[A]=(y[A]||0)+1});const w=new Set(Object.keys(y).map(E=>String(E))),b=new Set(u.map(E=>E.formation)),k=new Set(c.map(E=>E.gc_type));let v="player",m="Tous",x="",f=!1;function h(){return[...l].sort((E,A)=>{const T=ne.indexOf(E.player.job),j=ne.indexOf(A.player.job);return T!==j?T-j:(E.player.surname_encoded||"").localeCompare(A.player.surname_encoded||"")})}function _(){return[...s||[]].sort((E,A)=>{const T=ne.indexOf(E.job),j=ne.indexOf(A.job);return T!==j?T-j:(E.surname_encoded||"").localeCompare(A.surname_encoded||"")})}function I(){return h().filter(E=>{const A=E.player,T=m==="Tous"||A.job===m,j=!x||`${A.firstname} ${A.surname_encoded}`.toLowerCase().includes(x);return T&&j})}function L(){return _().filter(E=>{const A=m==="Tous"||E.job===m,T=!x||`${E.firstname} ${E.surname_encoded}`.toLowerCase().includes(x);return A&&T})}e.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:flex-start" id="col-grid"></div>
          ...
          ${dt.map(A=>`
            <button class="filter-btn" data-job="${A}"
              style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
                border:1.5px solid ${A===m?"var(--green)":"var(--gray-200)"};
                background:${A===m?"var(--green)":"#fff"};
                color:${A===m?"#fff":"var(--gray-600)"}">
              ${A}
            </button>`).join("")}
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",A=>{x=A.target.value.toLowerCase(),z()}),e.querySelectorAll(".filter-btn").forEach(A=>{A.addEventListener("click",()=>{m=A.dataset.job,M(),z()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{f=!f,M(),z()})):(E.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{f=!f,M(),z()})))}function z(){const E=document.getElementById("col-grid");E&&(v==="player"?C(E):v==="formation"?N(E):O(E))}function C(E){if(f){const A=L();if(!A.length){E.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}E.innerHTML=A.map(T=>{if(w.has(String(T.id))){const S=l.find(H=>H.player.id===T.id),D=y[T.id]||1,q=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",K=l.filter(H=>H.player.id===T.id&&H.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Me(S,q+K)}return ct(T)}).join("")}else{const A=I();if(!A.length){E.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const T={},j=[];A.forEach(S=>{const D=S.player.id;T[D]||(T[D]=!0,j.push(S))}),E.innerHTML=j.map(S=>{const D=y[S.player.id]||1,q=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",K=l.filter(H=>H.player.id===S.player.id&&H.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Me(S,q+K)}).join("")}E.querySelectorAll("[data-card-id]").forEach(A=>{A.addEventListener("click",()=>{const T=l.find(j=>j.id===A.dataset.cardId);T&&gt(T,l,y,t)})})}function N(E){const A=f?p:[...b];if(!A.length){E.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}E.innerHTML=A.map(T=>{if(b.has(T)){const S=u.find(P=>P.formation===T),D=u.filter(P=>P.formation===T).length,q=D>1?`<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"";return`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Z=1e3;function ut(e,t,i,o){var w,b,k;const{state:r,toast:n,closeModal:a,navigate:d,refreshProfile:s}=i,l=e.formation,c={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const v=$e[l]||{},m=te[l]||[],x=290,f=360,h=20;function _(L){const M=v[L];return M?{x:M.x*x,y:M.y*f}:null}let I=`<svg width="${x}" height="${f}" viewBox="0 0 ${x} ${f}" xmlns="http://www.w3.org/2000/svg">`;for(const[L,M]of m){const z=_(L),C=_(M);!z||!C||(I+=`<line x1="${z.x}" y1="${z.y}" x2="${C.x}" y2="${C.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const L of Object.keys(v)){const M=_(L);if(!M)continue;const z=L.replace(/\d+/,""),C=c[z]||"#555";I+=`<circle cx="${M.x}" cy="${M.y}" r="${h}" fill="${C}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,I+=`<text x="${M.x}" y="${M.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${z}</text>`}return I+="</svg>",I}const p=t.filter(v=>v.formation===l),g=p.length,y=!e.is_for_sale;o(`Formation ${l}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(w=document.getElementById("direct-sell-form-btn"))==null||w.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${l} pour ${Z.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const v=p.find(x=>!x.is_for_sale)||p[0];if(!v){n("Aucune carte à vendre","error");return}const{error:m}=await $.from("cards").delete().eq("id",v.id);if(m){n(m.message,"error");return}await $.from("users").update({credits:(r.profile.credits||0)+Z}).eq("id",r.profile.id),await s(),n(`+${Z.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),d("collection")}),(b=document.getElementById("market-sell-form-btn"))==null||b.addEventListener("click",async()=>{const v=parseInt(document.getElementById("sell-price-form").value);if(!v||v<1){n("Prix invalide","error");return}await $.from("cards").update({is_for_sale:!0,sale_price:v}).eq("id",e.id),await $.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:v}),n("Carte mise en vente sur le marché !","success"),a(),d("collection")}),(k=document.getElementById("cancel-sell-form-btn"))==null||k.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),n("Annonce retirée","success"),a(),d("collection")})}function gt(e,t,i,o){var h,_,I,L,M,z;const{state:r,toast:n,openModal:a,closeModal:d,navigate:s,refreshProfile:l}=o,c=e.player,u=t.filter(C=>C.player.id===c.id),p=u.length,g=lt[c.rarity]||1e3,y=c.rarity!=="legende",w=He(c),b=ie(c,c.job),k=c.job2?ie(c,c.job2):null,v=pe[c.job]||"#1A6B3C",m=c.job2?pe[c.job2]:null,x=Ke[c.rarity]||"#ccc",f=we[c.country_code]||c.country_code||"";a(`${c.firstname} ${c.surname_encoded}`,`<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
    ...
    </div>`:""}`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(I=document.getElementById("close-detail"))==null||I.addEventListener("click",d),(L=document.getElementById("direct-sell-btn"))==null||L.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte ${c.surname_encoded} pour ${g.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const C=u.find(O=>!O.is_for_sale)||u[0];if(!C){n("Aucune carte à vendre","error");return}const{error:N}=await $.from("cards").delete().eq("id",C.id);if(N){n(N.message,"error");return}await $.from("users").update({credits:(r.profile.credits||0)+g}).eq("id",r.profile.id),await l(),n(`+${g.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),d(),s("collection")}),(M=document.getElementById("market-sell-btn"))==null||M.addEventListener("click",async()=>{const C=parseInt(document.getElementById("sell-price").value);if(!C||C<1){n("Prix invalide","error");return}await $.from("cards").update({is_for_sale:!0,sale_price:C}).eq("id",e.id),await $.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:C}),n("Carte mise en vente sur le marché !","success"),d(),s("collection")}),(z=document.getElementById("cancel-sell-btn"))==null||z.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),n("Annonce retirée","success"),d(),s("collection")})}const fe={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},Y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function ke(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}async function xe(e,t){const{state:i,navigate:o,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await $.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>Mes decks</h2>
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const a=prompt("Nom du deck :",`Deck ${((n==null?void 0:n.length)||0)+1}`);if(!a)return;const{data:d,error:s}=await $.from("decks").insert({owner_id:i.profile.id,name:a}).select().single();if(s){r(s.message,"error");return}r("Deck créé !","success"),ze(d.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(a=>{a.addEventListener("click",()=>ze(a.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(a=>{a.addEventListener("click",async()=>{const d=prompt("Nouveau nom :",a.dataset.name);if(!d||d===a.dataset.name)return;const{error:s}=await $.from("decks").update({name:d}).eq("id",a.dataset.rename);if(s){r(s.message,"error");return}r("Deck renommé !","success"),xe(e,t)})}),e.querySelectorAll("[data-delete]").forEach(a=>{a.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${a.dataset.name}" ? Cette action est irréversible.`))return;await $.from("deck_cards").delete().eq("deck_id",a.dataset.delete);const{error:d}=await $.from("decks").delete().eq("id",a.dataset.delete);if(d){r(d.message,"error");return}r("Deck supprimé.","success"),xe(e,t)})})}async function ze(e,t,i){const{state:o,toast:r}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await $.from("decks").select("*").eq("id",e).single(),{data:a}=await $.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",o.profile.id),d=(a||[]).filter(g=>g.card_type==="player"&&g.player),s=(a||[]).filter(g=>g.card_type==="formation"),l=s.map(g=>g.formation).filter(Boolean),{data:c}=await $.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let u=n.formation||"4-4-2";l.length>0&&!l.includes(u)&&(u=l[0]);const p={deckId:e,name:n.name,formation:u,formationCardId:n.formation_card_id,slots:{},subs:[],playerCards:d,formationCards:s,availableFormations:l};(c||[]).forEach(g=>{g.is_starter?p.slots[g.position]=g.card_id:p.subs.includes(g.card_id)||p.subs.push(g.card_id)}),W(t,p,i)}function W(e,t,i){var s;const{navigate:o}=i;fe[t.formation];const r=Ce(t.formation),n=r.filter(l=>t.slots[l]).length,a=t.availableFormations.length>0?t.availableFormations:Object.keys(fe),d=t.subs.map(l=>t.playerCards.find(c=>c.id===l)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div class="page">
    ...
    <div class="page-body">
      <button class="btn btn-primary" id="save-deck" style="width:100%" ${n<11?"disabled":""}>
  ...
  </div>`,mt(e,t,r,i),document.getElementById("builder-back").addEventListener("click",()=>o("decks")),document.getElementById("formation-select").addEventListener("change",l=>{t.formation=l.target.value;const c=Ce(t.formation),u={};c.forEach(p=>{t.slots[p]&&(u[p]=t.slots[p])}),t.slots=u,W(e,t,i)}),document.getElementById("save-deck").addEventListener("click",()=>vt(t,i)),e.querySelectorAll("[data-remove-sub]").forEach(l=>{l.addEventListener("click",()=>{t.subs=t.subs.filter(c=>c!==l.dataset.removeSub),W(e,t,i)})}),(s=document.getElementById("add-sub-btn"))==null||s.addEventListener("click",()=>{yt(t,e,i)})}function mt(e,t,i,o){const r=document.getElementById("deck-field");if(!r)return;const n=t.formation,a=$e[n]||{},d=me?me(n)||te[n]||[]:te[n]||[],s={};i.forEach(m=>{const x=t.slots[m],f=x?t.playerCards.find(h=>h.id===x):null;s[m]=(f==null?void 0:f.player)||null});const l=i.filter(m=>m.startsWith("MIL"));let c=0,u=0;l.forEach(m=>{const x=s[m];x&&(c+=Number(x.note_m)||0)}),d.forEach(([m,x])=>{if(!m.startsWith("MIL")||!x.startsWith("MIL"))return;U(s[m],s[x])!=="#ff3333"&&u++});const p=320,g=320,y=28,w=4;function b(m){const x=a[m];return x?{x:x.x*p,y:x.y*g}:null}let k="";for(const[m,x]of d){const f=b(m),h=b(x);if(!f||!h)continue;const _=s[m],I=s[x],L=U(_,I);if(L==="#00ff88"||L==="#FFD700")k+=`<line x1="${f.x}" y1="${f.y}" x2="${h.x}" y2="${h.y}"
        stroke="${L}" stroke-width="${w*3}" stroke-linecap="round" opacity="0.25"/>`,k+=`<line x1="${f.x}" y1="${f.y}" x2="${h.x}" y2="${h.y}"
        stroke="${L}" stroke-width="${w}" stroke-linecap="round" opacity="0.95"/>`;else{const z=L==="#ff3333"||L==="#cc2222"?.75:.9;k+=`<line x1="${f.x}" y1="${f.y}" x2="${h.x}" y2="${h.y}"
        stroke="${L}" stroke-width="${w}" stroke-linecap="round" opacity="${z}"/>`}}for(const m of i){const x=b(m);if(!x)continue;const f=s[m],h=m.replace(/\d+/,""),I={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[h]||"#555",L=f?Number(h==="GK"?f.note_g:h==="DEF"?f.note_d:h==="MIL"?f.note_m:f.note_a)||0:null,M=f?(f.surname_encoded||"").slice(0,8).toUpperCase():"";if(f){const z=ke(f);z&&(k+=`
          <defs>
            <clipPath id="clip-${m}">
        ...
        <circle cx="${x.x}" cy="${x.y}" r="${y}" fill="${z?"transparent":I}"
          stroke="${I}" stroke-width="2" />
        <circle cx="${x.x}" cy="${x.y}" r="${y}" fill="${I}" opacity="${z?"0.5":"1"}"
    ...
    <svg viewBox="0 0 ${p} ${g}" width="100%" style="display:block;max-width:380px;margin:0 auto">
      ${v}
      ${k}
    </svg>`,r.querySelectorAll(".deck-slot-hit").forEach(m=>{m.addEventListener("click",()=>xt(m.dataset.pos,t,e,o))})}function xt(e,t,i,o){var p,g,y;const{openModal:r,closeModal:n}=o,a=e.replace(/\d+/,""),d=t.slots[e],s=d?t.playerCards.find(w=>w.id===d):null;(p=s==null?void 0:s.player)==null||p.id;const l=new Set;Object.entries(t.slots).forEach(([w,b])=>{var v;if(w===e||!b)return;const k=t.playerCards.find(m=>m.id===b);(v=k==null?void 0:k.player)!=null&&v.id&&l.add(k.player.id)}),t.subs.forEach(w=>{var k;const b=t.playerCards.find(v=>v.id===w);(k=b==null?void 0:b.player)!=null&&k.id&&l.add(b.player.id)});const c=new Set,u=t.playerCards.filter(w=>{const b=w.player;return!(b.job===a||b.job2===a)||l.has(b.id)||c.has(b.id)?!1:(c.add(b.id),!0)});u.sort((w,b)=>{const k=a==="GK"?w.player.note_g:a==="DEF"?w.player.note_d:a==="MIL"?w.player.note_m:w.player.note_a;return(a==="GK"?b.player.note_g:a==="DEF"?b.player.note_d:a==="MIL"?b.player.note_m:b.player.note_a)-k}),r(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${u.length>0?u.map(w=>{var x,f;const b=w.player,k=a==="GK"?b.note_g:a==="DEF"?b.note_d:a==="MIL"?b.note_m:b.note_a,v=ke(b),m={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[b.rarity];return`<div class="player-option" data-card-id="${w.id}"
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(x=b.clubs)!=null&&x.logo_url?`<img src="${b.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((f=b.clubs)==null?void 0:f.encoded_name)||"—"}</span>`}
              <span style="font-size:10px;color:var(--gray-600)">${b.country_code}</span>
            </div>
          </div>
          <!-- Note -->
          <div style="width:36px;height:36px;border-radius:8px;background:${Y[a]};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:16px;border:2px solid ${m};flex-shrink:0">
            ${k}
          </div>
        </div>`}).join(""):'<div style="text-align:center;color:var(--gray-600);padding:20px">Aucun joueur pour ce poste.<br><small>Ouvre des boosters !</small></div>'}
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(g=document.getElementById("close-selector"))==null||g.addEventListener("click",n),(y=document.getElementById("remove-player"))==null||y.addEventListener("click",()=>{delete t.slots[e],n(),W(i,t,o)}),document.querySelectorAll(".player-option").forEach(w=>{w.addEventListener("click",()=>{t.slots[e]=w.dataset.cardId,n(),W(i,t,o)})})}function yt(e,t,i){var s;const{openModal:o,closeModal:r}=i,n=new Set;Object.values(e.slots).filter(Boolean).forEach(l=>{var u;const c=e.playerCards.find(p=>p.id===l);(u=c==null?void 0:c.player)!=null&&u.id&&n.add(c.player.id)}),e.subs.forEach(l=>{var u;const c=e.playerCards.find(p=>p.id===l);(u=c==null?void 0:c.player)!=null&&u.id&&n.add(c.player.id)});const a=new Set,d=e.playerCards.filter(l=>{var c,u,p;return n.has((c=l.player)==null?void 0:c.id)||a.has((u=l.player)==null?void 0:u.id)?!1:(a.add((p=l.player)==null?void 0:p.id),!0)});o("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(s=document.getElementById("close-sub-selector"))==null||s.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(l=>{l.addEventListener("click",()=>{e.subs.push(l.dataset.cardId),r(),W(t,e,i)})})}async function vt(e,t){const{state:i,toast:o,navigate:r}=t,n=e.formationCards.find(s=>s.formation===e.formation),a=(n==null?void 0:n.id)||e.formationCardId;await $.from("decks").update({formation:e.formation,formation_card_id:a||null}).eq("id",e.deckId),await $.from("deck_cards").delete().eq("deck_id",e.deckId);const d=[];if(Object.entries(e.slots).forEach(([s,l],c)=>{d.push({deck_id:e.deckId,card_id:l,position:s,is_starter:!0,slot_order:c})}),e.subs.forEach((s,l)=>{d.push({deck_id:e.deckId,card_id:s,position:`SUB${l+1}`,is_starter:!1,slot_order:100+l})}),d.length>0){const{error:s}=await $.from("deck_cards").insert(d);if(s){o(s.message,"error");return}}o("Deck enregistré ✅","success"),r("decks")}function Ce(e){const t=fe[e]||fe["4-4-2"],i=["GK1"];for(let o=1;o<=t.DEF;o++)i.push(`DEF${o}`);for(let o=1;o<=t.MIL;o++)i.push(`MIL${o}`);for(let o=1;o<=t.ATT;o++)i.push(`ATT${o}`);return i}const Be=[{id:"players_std",img:"/manager-wars/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/manager-wars/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/manager-wars/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/manager-wars/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Ue={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function ht(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}const bt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},$t={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function wt(e,{state:t,navigate:i,toast:o}){var n;const r=((n=t.profile)==null?void 0:n.credits)||0;e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${Be.map(a=>{const d=r>=a.cost||a.cost===0,s=a.id==="players_std"||a.id==="players_pub";return`<div class="booster-card ${d?"":"disabled"}" data-booster="${a.id}" style="position:relative">
  ...
  `,document.body.appendChild(o);let r=!1;document.getElementById("pack-visual").addEventListener("click",()=>{if(r)return;r=!0;const p=document.getElementById("pack-visual");p.classList.add("shaking"),setTimeout(()=>{p.classList.add("pack-open"),setTimeout(()=>{document.getElementById("pack-phase").style.display="none",a(0)},600)},500)});let n=0;function a(p){n=p;const g=document.getElementById("reveal-phase");g.style.display="flex",d(p)}function d(p){var f;const g=e[p],y=document.getElementById("card-counter"),w=document.getElementById("single-card-slot"),b=document.getElementById("card-tap-hint");y&&(y.textContent=`Carte ${p+1} / ${e.length}`),b&&(b.textContent=p<e.length-1?"Appuie pour continuer →":"Appuie pour voir toutes tes cartes");const k=je(g),v=g.card_type==="player"&&((f=g.player)==null?void 0:f.rarity)==="legende";w.innerHTML=`
      ...
      </div>`,v&&c();const m=document.getElementById("current-card-wrap");let x=!1;m.addEventListener("click",()=>{if(x)return;x=!0;const h=p+1;h<e.length?(m.style.transition="all 0.25s ease",m.style.transform="translateX(-120%) rotate(-15deg)",m.style.opacity="0",setTimeout(()=>d(h),250)):s()})}function s(){u(),document.getElementById("reveal-phase").style.display="none";const p=document.getElementById("recap-phase");p.style.display="flex";const g=document.getElementById("recap-grid");g.innerHTML=e.map((y,w)=>`
      ...
      </div>`).join("")}let l=null;function c(){const p=document.getElementById("fireworks-canvas");if(!p)return;p.width=window.innerWidth,p.height=window.innerHeight;const g=p.getContext("2d"),y=[];function w(){const k=Math.random()*p.width,v=Math.random()*p.height*.6,m=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],x=m[Math.floor(Math.random()*m.length)];for(let f=0;f<60;f++){const h=Math.PI*2/60*f,_=2+Math.random()*5;y.push({x:k,y:v,vx:Math.cos(h)*_,vy:Math.sin(h)*_,alpha:1,color:x,size:2+Math.random()*3})}}w(),l=setInterval(w,600);function b(){if(document.getElementById("fireworks-canvas")){g.clearRect(0,0,p.width,p.height);for(let k=y.length-1;k>=0;k--){const v=y[k];if(v.x+=v.vx,v.y+=v.vy+.08,v.vy*=.98,v.alpha-=.018,v.alpha<=0){y.splice(k,1);continue}g.globalAlpha=v.alpha,g.fillStyle=v.color,g.beginPath(),g.arc(v.x,v.y,v.size,0,Math.PI*2),g.fill()}g.globalAlpha=1,(l!==null||y.length>0)&&requestAnimationFrame(b)}}b()}function u(){l!==null&&(clearInterval(l),l=null);const p=document.getElementById("fireworks-canvas");p&&p.getContext("2d").clearRect(0,0,p.width,p.height)}document.getElementById("reveal-collection").addEventListener("click",()=>{u(),o.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{u(),o.remove(),i("boosters")})}function je(e){var t,i;if(e.card_type==="player"&&e.player){const o=e.player,r=o.job||"ATT",n=bt[r]||"#1A6B3C",a=$t[o.rarity]||"#ccc",d=r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a,s=ht(o),l={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL"}[o.country_code]||o.country_code;return`<div style="width:140px;height:200px;background:#f2e8d2;border-radius:12px;border:3px solid ${a};overflow:hidden;display:flex;flex-direction:column">
      <!-- Nom -->
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function zt(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:4000;color:#fff;gap:16px";let i=5;t.innerHTML=`<div style="font-size:48px">📺</div>
  ...
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function G(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function ye(e){var i,o;const t=e.player;return{cardId:e.id,id:t.id,firstname:t.firstname,name:t.surname_encoded,country_code:t.country_code,club_id:t.club_id,job:t.job,job2:t.job2,note_g:Number(t.note_g)||0,note_d:Number(t.note_d)||0,note_m:Number(t.note_m)||0,note_a:Number(t.note_a)||0,rarity:t.rarity,skin:t.skin,hair:t.hair,hair_length:t.hair_length,clubName:((i=t.clubs)==null?void 0:i.encoded_name)||null,clubLogo:((o=t.clubs)==null?void 0:o.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function _e(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Ct(){const e=Math.random()*100;return e<.1?4:e<5?3:e<20?2:1}function Ye(e,t){const i=X[t]||X["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]},r=[...e];for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<i[n];s++){let l=r.findIndex(c=>c.job===n);if(l===-1&&(l=r.findIndex(c=>c.job2===n)),l===-1&&(l=0),r[l]){const c={...r[l],_line:n};a.push(c),r.splice(l,1)}}const d=_e(a.length);a.forEach((s,l)=>{s._col=d[l]}),o[n]=a}return o}async function Bt(e,t){const{data:i}=await $.from("players").select("id,firstname,surname_encoded,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length").eq("is_active",!0).limit(60);if(!i||i.length<11)return jt(e);const o=X[e]||X["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=[...i];for(const a of["GK","DEF","MIL","ATT"]){const d=n.filter(p=>p.job===a),s=n.filter(p=>p.job!==a),l=[...d,...s],c=[];for(let p=0;p<o[a];p++){const g=l[p]||n[p];g&&c.push({cardId:"ai-"+g.id+"-"+p,id:g.id,firstname:g.firstname,name:g.surname_encoded,country_code:g.country_code,club_id:g.club_id,job:g.job,job2:g.job2,note_g:Number(g.note_g)||0,note_d:Number(g.note_d)||0,note_m:Number(g.note_m)||0,note_a:Number(g.note_a)||0,rarity:g.rarity,skin:g.skin,hair:g.hair,hair_length:g.hair_length,boost:0,used:!1,_line:a})}const u=_e(c.length);c.forEach((p,g)=>{p._col=u[g]}),r[a]=c}return r}function jt(e){const t=X[e]||X["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let s=0;s<t[n];s++){const l=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?l:2,note_d:n==="DEF"?l:2,note_m:n==="MIL"?l:2,note_a:n==="ATT"?l:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const d=_e(a.length);a.forEach((s,l)=>{s._col=d[l]}),i[n]=a}return i}async function St(e,t){var f;const{state:i,navigate:o,toast:r}=t,n=i.params||{};e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const a=n.matchMode||"vs_ai_easy",d=a.replace("vs_ai_",""),s=a;if(!n.deckId)return Ft(e,t,a);const l=n.deckId,[{data:c},{data:u}]=await Promise.all([$.from("decks").select("formation,name").eq("id",l).single(),$.from("deck_cards").select(`position, is_starter, slot_order,
        card:cards(id, card_type, formation,
          player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
            note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
            clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]),p=(u||[]).filter(h=>{var _;return h.is_starter&&((_=h.card)==null?void 0:_.player)}).map(h=>ye(h.card)),g=(u||[]).filter(h=>{var _;return!h.is_starter&&((_=h.card)==null?void 0:_.player)}).map(h=>ye(h.card));if(p.length<11){Ve(e,"⚠️",`Deck incomplet (${p.length}/11).`,"Compléter",()=>o("decks"));return}const y=(u||[]).find(h=>{var _;return((_=h.card)==null?void 0:_.card_type)==="formation"}),w=(c==null?void 0:c.formation)||((f=y==null?void 0:y.card)==null?void 0:f.formation)||"4-4-2",{data:b}=await $.from("cards").select("id,gc_type").eq("owner_id",i.profile.id).eq("card_type","game_changer"),k=Ye(p,w),v=await Bt(w),{data:m}=await $.from("matches").insert({home_id:i.profile.id,away_id:null,mode:s,home_deck_id:l,status:"in_progress"}).select().single(),x={matchId:m==null?void 0:m.id,mode:s,difficulty:d,formation:w,homeTeam:k,aiTeam:v,homeSubs:g,subsUsed:0,maxSubs:Math.min(g.length,3),homeScore:0,aiScore:0,gcCards:b||[],usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Dt(e,x,t)}async function Ft(e,t,i){const{state:o,navigate:r}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await $.from("decks").select("id,name,is_active,formation").eq("owner_id",o.profile.id).order("created_at",{ascending:!1});if(!n||n.length===0){Ve(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=n.map(c=>c.id),{data:d}=await $.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order");let s=0;function l(){var v,m,x,f,h;const c=n[s],u=(d||[]).filter(_=>_.deck_id===c.id),p=u.filter(_=>{var I;return _.is_starter&&((I=_.card)==null?void 0:I.player)}).map(_=>ye(_.card)),g=u.find(_=>{var I;return((I=_.card)==null?void 0:I.card_type)==="formation"}),y=c.formation||((v=g==null?void 0:g.card)==null?void 0:v.formation)||"4-4-2",w=p.length>=11?Ye(p,y):null,b=p.length>=11;e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:calc(100dvh - 130px);overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-swipe-zone" style="flex:1;min-height:0;overflow:hidden;position:relative;touch-action:pan-y;display:flex;align-items:center;justify-content:center">
        ${w?`<div style="width:min(98vw, calc(100dvh - 400px));overflow:hidden;flex-shrink:0">${Qe(w,y,null,[],285,285)}</div>`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;opacity:.4;flex-direction:column;gap:8px">
    ...
    </div>`,(m=document.getElementById("prev-deck"))==null||m.addEventListener("click",()=>{s>0&&(s--,l())}),(x=document.getElementById("next-deck"))==null||x.addEventListener("click",()=>{s<n.length-1&&(s++,l())}),(f=document.getElementById("validate-deck"))==null||f.addEventListener("click",()=>{b&&t.navigate("match",{matchMode:i,deckId:c.id})}),(h=document.getElementById("cancel-deck-select"))==null||h.addEventListener("click",()=>r("home"));const k=document.getElementById("deck-swipe-zone");if(k){let _=0,I=0;k.addEventListener("touchstart",L=>{_=L.touches[0].clientX,I=L.touches[0].clientY},{passive:!0}),k.addEventListener("touchend",L=>{const M=L.changedTouches[0].clientX-_,z=L.changedTouches[0].clientY-I;Math.abs(M)<40||Math.abs(M)<Math.abs(z)||(M<0&&s<n.length-1?(s++,l()):M>0&&s>0&&(s--,l()))},{passive:!0})}}l()}function Dt(e,t,i){const o=t.homeTeam.MIL||[],r=t.aiTeam.MIL||[];function n(u){return u.reduce((p,g)=>p+F(g,"MIL"),0)}function a(u){let p=0;for(let g=0;g<u.length-1;g++){const y=U(u[g],u[g+1]);y!=="#ff3333"&&y!=="#cc2222"&&p++}return p}const d=n(o)+a(o),s=n(r)+a(r),l=d>=s;function c(u,p,g){return`<div style="text-align:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${u.map((y,w)=>{const b=G(y),k=w<u.length-1?U(y,u[w+1]):null,v=k&&k!=="#ff3333"&&k!=="#cc2222";return`
          <div style="width:52px;height:52px;border-radius:8px;background:${g};position:relative;flex-shrink:0;overflow:hidden;border:2px solid rgba(255,255,255,0.3)">
            ...
            <div style="position:relative;z-index:1;font-size:15px;font-weight:900;color:#fff;text-shadow:0 1px 3px #000;text-align:center;padding-top:4px">${F(y,"MIL")}</div>
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;gap:24px;padding:24px;background:#0a3d1e">
    ...
    <div id="midfield-result" style="opacity:0;text-align:center;transition:opacity 0.5s;color:#fff;max-width:320px"></div>
  </div>`,setTimeout(()=>{const u=document.getElementById("score-home"),p=document.getElementById("score-ai"),g=document.getElementById("midfield-result");if(u&&p&&(l?(u.style.fontSize="80px",u.style.color="#FFD700",p.style.opacity="0.25"):(p.style.fontSize="80px",p.style.color="#ff6b6b",u.style.opacity="0.25")),g){const y=Ct();g.style.opacity="1",l&&t.clubName,g.innerHTML=`
      ...
      `,l&&(t.boostCard={value:y})}t.attacker=l?"home":"ai",t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:o.map(y=>({name:y.name,note:F(y,"MIL"),portrait:G(y),job:y.job})),aiPlayers:r.map(y=>({name:y.name,note:F(y,"MIL"),portrait:G(y),job:y.job})),homeTotal:d,aiTotal:s,text:`Duel milieu : ${t.clubName} ${d} – ${s} IA → ${l?t.clubName+" attaque":"IA attaque"}`}),setTimeout(()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",R(e,t,i),t.attacker==="ai"&&setTimeout(()=>ve(e,t,i),1e3)},2800)},1200)}function Je(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";return e!=null&&e.clubLogo?e.clubLogo.startsWith("http")?e.clubLogo:`${t}/storage/v1/object/public/assets/clubs/${e.clubLogo}`:null}function J(e,t=44,i=58){if(!e)return`<div style="width:${t}px;height:${i}px;border:1.5px dashed rgba(255,255,255,0.2);border-radius:5px"></div>`;const o=G(e),r=Je(e),n=e._line||e.job||"MIL",a=Q[n]||"#555",d={normal:"#aaa",pépite:"#D4A017",papyte:"#222",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",s=(Number(F(e,n))||0)+(e.boost||0),l=We(e==null?void 0:e.country_code),c=Math.round(i*.19),u=Math.round(i*.25),p=i-Math.round(i*.19)-Math.round(i*.25),g=e!=null&&e.used?.28:1;return`<div style="width:${t}px;height:${i}px;border-radius:5px;border:2px solid ${d};background:${a};position:relative;overflow:hidden;flex-shrink:0;opacity:${g}">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${u}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      <span style="font-size:${u-2}px;font-weight:900;color:#111;font-family:Arial Black,Arial">${e!=null&&e.used?"–":s}</span>
  ...
  </div>`}function re(e,t,i){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let r='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((n,a)=>{if(r+=J(n,40,52),a<o.length-1){const d=U(n,o[a+1]);r+=`<div style="width:7px;height:3px;background:${d==="#ff3333"||d==="#cc2222"?"rgba(255,255,255,0.12)":d};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(r+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),r+="</div>",r}function We(e){if(!e||e.length<2)return"🌍";try{return String.fromCodePoint(127462+e.charCodeAt(0)-65)+String.fromCodePoint(127462+e.charCodeAt(1)-65)}catch{return"🌍"}}function Xe(e,t,i,o,r=310,n=310){const a=$e[t]||{},d=me(t)||te[t]||[],s={},l=["ATT","MIL","DEF","GK"];for(const v of l)(e[v]||[]).forEach((x,f)=>{s[`${v}${f+1}`]=x});function c(v){const m=a[v];return m?{x:m.x*r,y:m.y*n}:null}let u="";for(const[v,m]of d){const x=c(v),f=c(m);if(!x||!f)continue;const h=s[v],_=s[m],I=U(h,_);I==="#00ff88"||I==="#FFD700"?(u+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${f.x.toFixed(1)}" y2="${f.y.toFixed(1)}"
        stroke="${I}" stroke-width="10" stroke-linecap="round" opacity="0.22"/>`,u+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${f.x.toFixed(1)}" y2="${f.y.toFixed(1)}"
        stroke="${I}" stroke-width="3.5" stroke-linecap="round" opacity="0.95"/>`):u+=`<line x1="${x.x.toFixed(1)}" y1="${x.y.toFixed(1)}" x2="${f.x.toFixed(1)}" y2="${f.y.toFixed(1)}"
        stroke="${I}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const p=48,g=64,y=13,w=16,b={normal:"#aaaaaa",pépite:"#D4A017",papyte:"#111111",légende:"#7a28b8"};for(const[v,m]of Object.entries(s)){const x=c(v);if(!x||!m)continue;const f=v.replace(/[0-9]/g,""),h=Q[f]||"#555",_=i==="attack"&&["MIL","ATT"].includes(f)&&!m.used||i==="defense"&&["GK","DEF","MIL"].includes(f)&&!m.used,I=o.includes(m.cardId);let L;i==="attack"?L=f==="MIL"?Number(m.note_m)||0:Number(m.note_a)||0:i==="defense"?L=f==="GK"?Number(m.note_g)||0:f==="MIL"?Number(m.note_m)||0:Number(m.note_d)||0:L=Number(f==="GK"?m.note_g:f==="DEF"?m.note_d:f==="MIL"?m.note_m:m.note_a)||0,L=L+(m.boost||0);const M=(x.x-p/2).toFixed(1),z=(x.y-g/2).toFixed(1),C=m.used?.25:1,N=b[m==null?void 0:m.rarity]||b.normal,O=I?"#ffffff":N,E=I?3:(m==null?void 0:m.rarity)==="légende"||(m==null?void 0:m.rarity)==="pépite"?2.5:2,A=g-y-w;u+=`<defs><clipPath id="cp-${v}"><rect x="${M}" y="${(x.y-g/2+y).toFixed(1)}" width="${p}" height="${A}"/></clipPath></defs>`,u+=`<rect x="${M}" y="${z}" width="${p}" height="${g}" rx="5" fill="${h}" opacity="${C}"/>`;const T=G(m);T&&!m.used&&(u+=`<image href="${T}" x="${M}" y="${(x.y-g/2+y).toFixed(1)}" width="${p}" height="${A}" clip-path="url(#cp-${v})" preserveAspectRatio="xMidYMin slice"/>`),u+=`<rect x="${M}" y="${z}" width="${p}" height="${y}" rx="4" fill="rgba(255,255,255,0.92)"/>`,u+=`<text x="${x.x.toFixed(1)}" y="${(x.y-g/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(m.name||"").slice(0,9)}</text>`;const j=(x.y+g/2-w).toFixed(1);if(u+=`<rect x="${M}" y="${j}" width="${p}" height="${w}" fill="rgba(255,255,255,0.92)"/>`,m.used)u+=`<text x="${x.x.toFixed(1)}" y="${(x.y+g/2-w/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="13" font-weight="900" fill="rgba(0,0,0,0.4)" font-family="Arial Black">–</text>`;else{u+=`<text x="${(x.x-13).toFixed(1)}" y="${(x.y+g/2-w/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${We(m.country_code)}</text>`,u+=`<text x="${x.x.toFixed(1)}" y="${(x.y+g/2-w/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${L}</text>`;const S=Je(m);S?u+=`<image href="${S}" x="${(x.x+p/2-14).toFixed(1)}" y="${(x.y+g/2-w+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:m.clubName&&(u+=`<text x="${(x.x+14).toFixed(1)}" y="${(x.y+g/2-w/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(m.clubName||"").slice(0,3).toUpperCase()}</text>`),m.boost&&(u+=`<rect x="${(x.x+p/2-12).toFixed(1)}" y="${(x.y-g/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,u+=`<text x="${(x.x+p/2-5).toFixed(1)}" y="${(x.y-g/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${m.boost}</text>`)}u+=`<rect x="${M}" y="${z}" width="${p}" height="${g}" rx="5" fill="${I?"rgba(255,255,255,0.12)":"none"}" stroke="${O}" stroke-width="${E}" opacity="${C}"/>`,_&&(u+=`<rect x="${M}" y="${z}" width="${p}" height="${g}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${I?"selected":""}" data-card-id="${m.cardId}" data-role="${f}" style="cursor:pointer"/>`)}const k=38;return`<svg viewBox="${-k} ${-k} ${r+k*2} ${n+k*2}" width="100%" style="display:block;width:100%;max-width:380px;margin:0 auto">
    ${u}
      ...
      <div style="flex:1;display:grid;grid-template-columns:repeat(4,1fr);gap:3px;align-content:start">
        ${u.map(f=>{var h;return`
          <div class="gc-mini" data-gc-id="${f.id}" data-gc-type="${f.gc_type}"
            ...
            <div style="font-size:16px">${((h=ce[f.gc_type])==null?void 0:h.icon)||"⚡"}</div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(f=>{var h,_,I;if(f.type==="duel"){const L=f.isGoal,M=f.homeScored?"#FFD700":L?"#ff6b6b":"rgba(255,255,255,0.3)",z=f.homeScored?"⚽ BUT !":L?"⚽ BUT IA !":(h=f.homePlayers)!=null&&h.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${L?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${M};margin-bottom:4px">
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${f.outPlayer?J({...f.outPlayer,used:!0,_line:f.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${f.inPlayer?J({...f.inPlayer,_line:f.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
  ...
  </div>`,requestAnimationFrame(()=>{var L;const f=e.querySelector(".match-screen");if(!f)return;const h=f.getBoundingClientRect().top,_=((L=document.querySelector('.bottom-nav, nav, [class*="nav"]'))==null?void 0:L.offsetHeight)||60,I=Math.round(window.innerHeight-h-_);I>150&&(f.style.height=I+"px")}),(g=document.getElementById("match-quit"))==null||g.addEventListener("click",()=>{confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,oe(e,t,i))}),(y=document.getElementById("view-ai"))==null||y.addEventListener("click",()=>Ut(t,i)),(w=document.getElementById("toggle-history"))==null||w.addEventListener("click",()=>{var f;(f=document.getElementById("match-history-panel"))==null||f.classList.add("open")}),(b=document.getElementById("close-history"))==null||b.addEventListener("click",()=>{var f;(f=document.getElementById("match-history-panel"))==null||f.classList.remove("open")}),(k=document.getElementById("btn-action"))==null||k.addEventListener("click",()=>{t.selected.length!==0&&(s?Nt(e,t,i):l&&qt(e,t,i))}),(v=document.getElementById("btn-results"))==null||v.addEventListener("click",()=>oe(e,t,i)),e.querySelectorAll(".match-slot-hit").forEach(f=>{f.addEventListener("click",()=>Rt(f,t,e,i))}),e.querySelectorAll(".gc-mini").forEach(f=>{f.addEventListener("click",()=>Kt(f.dataset.gcId,f.dataset.gcType,e,t,i))}),(m=document.getElementById("boost-card"))==null||m.addEventListener("click",()=>Ht(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(f=>{f.addEventListener("click",()=>Se(e,t,i,f.dataset.subId))}),(x=document.getElementById("sub-btn-main"))==null||x.addEventListener("click",()=>Se(e,t,i))}function Rt(e,t,i,o){const r=e.dataset.cardId,n=e.dataset.role,a=t.selected.findIndex(d=>d.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const d=(t.homeTeam[n]||[]).find(s=>s.cardId===r);d&&t.selected.push({...d,_role:n,_line:n})}R(i,t,o)}function Nt(e,t,i){const o=t.selected.map(n=>({...n,_line:n._role})),r=Ne(o,t.modifiers.home);t.pendingAttack={...r,players:[...t.selected],side:"home"},t.selected.forEach(n=>{const a=(t.homeTeam[n._role]||[]).find(d=>d.cardId===n.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(n=>n.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",R(e,t,i),setTimeout(()=>Ot(e,t,i),1200)}function qt(e,t,i){const o=t.selected.map(d=>({...d,_line:d._role})),r=qe(o,t.modifiers.home);t.selected.forEach(d=>{const s=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);s&&(s.used=!0)});const n=Oe(t.pendingAttack.total,r.total,t.modifiers.home),a={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>({name:d.name,note:d._line==="MIL"?d.note_m:d.note_a,portrait:G(d),job:d.job})),homePlayers:t.selected.map(d=>{const s=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return{name:s.name,note:s._line==="GK"?s.note_g:s._line==="MIL"?s.note_m:s.note_d,portrait:G(s),job:s.job}}),homeTotal:r.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(n.shielded)a.text="🛡️ Bouclier ! But annulé.",t.log.push(a);else if(n.goal){t.aiScore++,a.isGoal=!0,a.homeScored=!1,a.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${r.total})`,t.log.push(a),t.selected=[],t.modifiers.home={},t.pendingAttack=null,R(e,t,i),tt(a.aiPlayers,t.homeScore,t.aiScore,!1,()=>{ue(e,t,i,"home-attack")});return}else a.text=`🧤 Défense réussie ! (${r.total} ≥ ${t.pendingAttack.total})`,t.log.push(a);t.selected=[],t.modifiers.home={},t.pendingAttack=null,ue(e,t,i,"home-attack")}function ve(e,t,i){const o=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],r=Pe(o,"attack",t.difficulty);if(!r.length){et(e,t,i);return}const n=Ne(r,t.modifiers.ai);t.pendingAttack={...n,players:r,side:"ai"},r.forEach(a=>{a.used=!0}),t.log.push({text:`🤖 IA attaque : ${n.total} (${r.map(a=>a.name).join(", ")})`,type:"info"}),t.modifiers.ai={},t.phase="defense",R(e,t,i)}function Ot(e,t,i){const o=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=Pe(o,"defense",t.difficulty),n=r.length>0?qe(r,t.modifiers.ai).total:0;r.forEach(s=>{s.used=!0});const a=Oe(t.pendingAttack.total,n,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(s=>({name:s.name,note:s._line==="MIL"?s.note_m:s.note_a,portrait:G(s),job:s.job})),aiPlayers:r.map(s=>({name:s.name,note:s._line==="GK"?s.note_g:s._line==="MIL"?s.note_m:s.note_d,portrait:G(s),job:s.job})),homeTotal:t.pendingAttack.total,aiTotal:n,isGoal:!1,homeScored:!1,text:""};if(a.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(a.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${n})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,R(e,t,i),tt(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{ue(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${n} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,ue(e,t,i,"ai-attack")}function ue(e,t,i,o){if(t.round++,Ze(t)){oe(e,t,i);return}if(o==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(n=>!n.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(a=>!a.used).length){oe(e,t,i);return}t.phase="ai-attack",R(e,t,i),setTimeout(()=>ve(e,t,i),800);return}t.phase="attack",R(e,t,i)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(n=>!n.used).length){et(e,t,i);return}t.phase="ai-attack",R(e,t,i),setTimeout(()=>ve(e,t,i),800)}}function Ze(e){const t=["MIL","ATT","GK","DEF"].some(o=>(e.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(e.aiTeam[o]||[]).some(r=>!r.used));return!t&&!i}function et(e,t,i){Ze(t)?oe(e,t,i):(t.phase="attack",R(e,t,i))}function Pt(e,t,i){const o=document.createElement("div");o.style.cssText=`
  ...
  `,document.body.appendChild(o);let c=!1;const u=()=>{c||(c=!0,o.remove(),setTimeout(()=>i(),50))};o.addEventListener("click",u),setTimeout(u,2e3)}function ee(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function Se(e,t,i,o=null){if(t.phase!=="attack"){ee("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){ee(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const r=Object.values(t.homeTeam).flat().filter(c=>c.used),n=t.homeSubs.filter(c=>!t.usedSubIds.includes(c.cardId));if(!r.length){ee("Aucun joueur utilisé à remplacer");return}if(!n.length){ee("Aucun remplaçant disponible");return}let a=0,d=Math.max(0,n.findIndex(c=>c.cardId===o));const s=document.createElement("div");s.id="sub-overlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function l(){var b,k,v,m,x,f;const c=r[a],u=n[d],p=Math.min(130,Math.round((window.innerWidth-80)/2)),g=Math.round(p*1.35);s.innerHTML=`
    ...
    </div>`,(b=document.getElementById("sub-close"))==null||b.addEventListener("click",()=>s.remove()),(k=document.getElementById("out-up"))==null||k.addEventListener("click",()=>{a>0&&(a--,l())}),(v=document.getElementById("out-down"))==null||v.addEventListener("click",()=>{a<r.length-1&&(a++,l())}),(m=document.getElementById("in-up"))==null||m.addEventListener("click",()=>{d>0&&(d--,l())}),(x=document.getElementById("in-down"))==null||x.addEventListener("click",()=>{d<n.length-1&&(d++,l())});let y=0;const w=document.getElementById("in-panel");w==null||w.addEventListener("touchstart",h=>{y=h.touches[0].clientY},{passive:!0}),w==null||w.addEventListener("touchend",h=>{const _=h.changedTouches[0].clientY-y;Math.abs(_)<30||(_<0&&d<n.length-1?(d++,l()):_>0&&d>0&&(d--,l()))},{passive:!0}),(f=document.getElementById("sub-confirm"))==null||f.addEventListener("click",()=>{const h=r[a],_=n[d];if(!h||!_)return;let I=null,L=-1;for(const[z,C]of Object.entries(t.homeTeam)){const N=(C||[]).findIndex(O=>O.cardId===h.cardId);if(N!==-1){I=z,L=N;break}}if(L===-1||!I){ee("Erreur remplacement","rgba(180,0,0,0.9)"),s.remove();return}const M={..._,_line:I,_col:h._col,used:!1,boost:0};t.homeTeam[I].splice(L,1,M),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(_.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:h.name,firstname:h.firstname,note:F(h,I),portrait:G(h),job:h.job},inPlayer:{name:_.name,firstname:_.firstname,note:F(_,I),portrait:G(_),job:_.job},text:`🔄 ${_.firstname} ${_.name} remplace ${h.firstname} ${h.name}`}),s.remove(),Pt(h,_,()=>R(e,t,i))})}l(),document.body.appendChild(s)}function Kt(e,t,i,o,r){if(!o.usedGc.includes(e)){switch(o.usedGc.push(e),t){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{let n=!1;for(const a of["ATT","MIL","DEF","GK"]){const d=(o.homeTeam[a]||[]).find(s=>s.used);if(d){d.used=!1,n=!0;break}}o.log.push({text:n?"💫 Joueur ressuscité !":"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const n=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(a=>!a.used);if(n.length){const a=n.sort((d,s)=>F(s,"ATT")-F(d,"ATT"))[0];a.used=!0,o.log.push({text:`❄️ ${a.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}$.from("cards").delete().eq("id",e).then(()=>{}),R(i,o,r)}}function Ht(e,t,i){const o=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const d=(t.homeTeam[a]||[]).find(s=>s.cardId===n);if(d){d.boost=(d.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),R(e,t,i)})})}function tt(e,t,i,o,r){const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const a=Array.from({length:10},(l,c)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(n);let d=!1;const s=()=>{d||(d=!0,n.remove(),setTimeout(()=>r(),50))};n.addEventListener("click",s),setTimeout(s,3500)}async function oe(e,t,i){var c,u;t.phase="finished";const{state:o}=i,r=t.homeScore>t.aiScore,n=t.homeScore===t.aiScore,a=r?"victoire":n?"nul":"defaite",d=st(t.mode,a);t.matchId&&await $.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const s={credits:(o.profile.credits||0)+d,matches_played:(o.profile.matches_played||0)+1};r?s.wins=(o.profile.wins||0)+1:n?s.draws=(o.profile.draws||0)+1:s.losses=(o.profile.losses||0)+1,await $.from("users").update(s).eq("id",o.profile.id),await i.refreshProfile();const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",l.innerHTML=`
  ...
  `;function d(s){const l=document.getElementById("mkt-content"),c=s==="buy"?a:n;if(c.length===0){l.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${c.map(u=>{var b,k,v;const p=(b=u.card)==null?void 0:b.player;if(!p)return"";const g=p.job==="GK"?p.note_g:p.job==="DEF"?p.note_d:p.job==="MIL"?p.note_m:p.note_a,y=Vt[p.rarity],w=(i.profile.credits||0)>=u.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px">
          <div style="width:44px;height:44px;border-radius:8px;background:${Xt(p.job)};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:18px;border:2px solid ${y};flex-shrink:0">${g}</div>
          <div style="flex:1;min-width:0">
  ...
  `}const B={user:null,profile:null,page:"home",params:{}};function se(e,t="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=e,o.className=`show ${t}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Zt(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function he(){document.getElementById("modal-overlay").classList.add("hidden")}async function de(){if(!B.user)return;const{data:e}=await $.from("users").select("*").eq("id",B.user.id).single();e&&(B.profile=e)}const Ie="mw_theme";function ge(){return localStorage.getItem(Ie)||"light"}function ei(e){var t;localStorage.setItem(Ie,e),be(e),(t=B.profile)!=null&&t.id&&$.from("users").update({theme:e}).eq("id",B.profile.id).then(()=>{})}function be(e){document.documentElement.setAttribute("data-theme",e)}function le(e,t={}){B.page=e,B.params=t,it()}async function it(){const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(o=>{o.classList.toggle("active",o.dataset.page===B.page)});const t=document.getElementById("nav-credits");t&&B.profile&&(t.textContent=`💰 ${(B.profile.credits||0).toLocaleString("fr")}`);const i={state:B,navigate:le,toast:se,openModal:Zt,closeModal:he,refreshProfile:de};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',B.page){case"home":await Le(e,i);break;case"collection":await pt(e,i);break;case"decks":await xe(e,i);break;case"boosters":await wt(e,i);break;case"match":await St(e,i);break;case"market":await Yt(e,i);break;case"rankings":await Qt(e,i);break;default:await Le(e,i)}}function ti(){const e=document.getElementById("app"),t=B.profile;if(!t)return;const i="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
