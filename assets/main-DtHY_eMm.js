...
import{s as v,j as ki,q as zo,t as Bt,u as $i,F as Ei,o as nt,n as Ht,g as Ct,r as ze,m as ut,v as oi,w as Mo,T as Ci,p as bn,x as xn,d as yn}from"./special-cards--9JnHrqo.js";const hn="/";function uo(t,{navigate:e,toast:i}){let o="login";const r=()=>{var a,s,c,d,l,m,x;const n=o==="login";if(t.innerHTML=`
    <div style="
  ...
  `;function s(){var g;const d=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),m=((g=document.getElementById("setup-club"))==null?void 0:g.value)||"MW",x=m.trim().split(" ").filter(Boolean),b=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():m.slice(0,2).toUpperCase();d&&(d.style.background=a,d.style.borderColor=n),l&&(l.textContent=b,l.style.color=n)}document.getElementById("color1").addEventListener("input",d=>{n=d.target.value,document.getElementById("swatch1").style.background=n,s()}),document.getElementById("color2").addEventListener("input",d=>{a=d.target.value,document.getElementById("swatch2").style.background=a,s()});function c(d){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${d}`).classList.add("active"),document.getElementById("step-num").textContent=d,document.getElementById("progress-fill").style.width=`${Math.round(d/3*100)}%`,d===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",d.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await v.from("users").select("id").eq("pseudo",d).maybeSingle();if(m){l.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const d=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",d.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await v.from("users").select("id").eq("club_name",d).maybeSingle();if(m){l.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const d=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),x=document.getElementById("step3-finish");m.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:b}=await v.from("users").insert({id:e.user.id,pseudo:d,club_name:l,club_color1:n,club_color2:a,credits:1e4});if(b)throw b;await wn(e.user.id),await r(),o(`Bienvenue ${d} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(b){m.textContent=b.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function wn(t){const e=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:e,onboarding_done:!1,first_booster_opened:!1}).eq("id",t)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const _n="modulepreload",kn=function(t){return"/"+t},fo={},Co=function(e,i,o){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(c=>{if(c=kn(c),c in fo)return;fo[c]=!0;const d=c.endsWith(".css"),l=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${l}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":_n,d||(m.as="script"),m.crossOrigin="",m.href=c,s&&m.setAttribute("nonce",s),document.head.appendChild(m),d)return new Promise((x,b)=>{m.addEventListener("load",x),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})},jo="mw_sound_volume";function Yi(){const t=localStorage.getItem(jo);if(t===null)return 100;const e=parseInt(t,10);return Number.isFinite(e)?Math.max(0,Math.min(100,e)):100}function $n(t){localStorage.setItem(jo,String(Math.max(0,Math.min(100,Math.round(t)))))}function Wi(){return Yi()===0}function bi(t){return Math.max(0,Math.min(1,t*(Yi()/100)))}function Xi(t,e=1){if(Wi())return null;try{const i=new Audio(t);return i.volume=bi(e),i.play().catch(()=>{}),i}catch{return null}}let ht=null,Fi=null,mo=.3;function Bo(t,e=.3){if(mo=e,ht&&Fi===t&&!ht.paused){ht.volume=bi(mo);return}if(Rt(),!Wi())try{const i=new Audio(t);i.loop=!0,i.volume=bi(e),i.play().catch(()=>{}),ht=i,Fi=t}catch{}}function Rt(){if(ht)try{ht.pause(),ht.currentTime=0}catch{}ht=null,Fi=null}let Qt=null;function qo(t,e=.6){if(Ke(),!Wi())try{const i=new Audio(t);i.volume=bi(e),i.play().catch(()=>{}),Qt=i}catch{}}function Ke(){if(Qt)try{Qt.pause(),Qt.currentTime=0}catch{}Qt=null}const En=[{key:"home2",route:"home2",label:"HOME",icon:"nav-home.png"},{key:"cards",route:"collection",label:"CARDS",icon:"nav-collection.png"},{key:"decks",route:"decks",label:"DECKS",icon:"nav-decks.png"},{key:"boosters",route:"boosters",label:"BOOSTERS",icon:"nav-boosters.png"},{key:"market",route:"market",label:"MERCATO",icon:"nav-market.png"}];function Do(t,e,i,o){if(!document.getElementById("home2-chrome-style")){const l=document.createElement("style");l.id="home2-chrome-style",l.textContent=`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function ji(t,{state:e,navigate:i,toast:o}){var E,f,S,$,A,P;const r=e.profile;if(!r)return;const n="/icons/";Do(i,r,"home2",n);const a=r.mmr??1e3,s=ki(a),c=In(a,s),d=zo(a),l=isFinite(s.max)?s.max+1:null,[{list:m,iAmInTop:x,myPosition:b},g,p]=await Promise.all([Tn(r.id),Sn(5),An()]),u=(R,O)=>`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${Ln(R.published_at)}</div>
      </div>
  ...
  <div class="home-dark" id="home-dark">
    ...
    <div class="modal-body" style="padding:18px 20px">
  ...
  </div>`,document.body.appendChild(n),n.querySelector("#claim-later-btn").addEventListener("click",()=>n.remove()),n.querySelector("#claim-all-btn").addEventListener("click",async a=>{const s=a.currentTarget;s.disabled=!0,s.textContent="...";let c=0;for(const d of o){const{data:l}=await v.rpc("claim_mini_league_prize",{p_league_id:d.league_id,p_user_id:i});l!=null&&l.success&&!l.already_claimed&&(c+=l.prize||0)}if(c>0){t.profile.credits=(t.profile.credits||0)+c;const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${t.profile.credits.toLocaleString("fr")}`),e(`💰 +${c.toLocaleString("fr")} cr. récupérés !`,"success")}n.remove()})}async function Fo(t,e,i){const o=document.getElementById("ongoing-match-banner");if(!o)return;const r=t.profile.id,{data:n}=await v.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(n!=null&&n.length)){o.innerHTML="";return}const a=n.map(c=>c.home_id===r?c.away_id:c.home_id).filter(Boolean);let s={};if(a.length){const{data:c}=await v.from("users").select("id, pseudo, club_name").in("id",a);(c||[]).forEach(d=>{s[d.id]=d.club_name||d.pseudo})}o.innerHTML=n.map(c=>{const d=c.home_id===r?c.away_id:c.home_id,l=s[d]||"Adversaire",m=c.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
      ...
      <div style="flex:1;min-width:0">
        <div style="font-size:13px;font-weight:900">${m?"🏆 Mini League":c.mode==="friend"?"Match ami":"Match"} en cours</div>
        <div style="font-size:11px;opacity:0.8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">vs ${l}</div>
      </div>
      <button data-resume="${c.id}" data-mini="${m?"1":""}" style="width:38px;height:38px;border-radius:50%;border:none;background:#22c55e;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0">⚽</button>
    ...
    ${Qi()}`,document.body.appendChild(d);const m=()=>d.remove();d.querySelector("#pending-close").addEventListener("click",m),d.addEventListener("click",x=>{x.target===d&&m()}),d.querySelectorAll("[data-accept]").forEach(x=>{x.addEventListener("click",async()=>{const{error:b}=await v.from("friendships").update({status:"accepted"}).eq("id",x.dataset.accept);if(b){e("Erreur : "+b.message,"error");return}x.closest("div[style]").remove(),e("✅ Ami accepté !","success"),Go(t,e,o),i&&i()})}),d.querySelectorAll("[data-decline]").forEach(x=>{x.addEventListener("click",async()=>{await v.from("friendships").delete().eq("id",x.dataset.decline),x.closest("div[style]").remove(),e("Demande refusée","info"),i&&i()})})}async function Nn(t,e,i){const o=t.user.id,[r,n]=[o,e].sort(),a=o===r,{data:s}=await v.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",n).single(),c=t.profile.club_name||t.profile.pseudo||"Moi",d=s||{},l=a?d.wins_p1||0:d.wins_p2||0,m=a?d.wins_p2||0:d.wins_p1||0,x=d.draws||0,b=a?d.goals_p1||0:d.goals_p2||0,g=a?d.goals_p2||0:d.goals_p1||0,p=a?d.gc_used_p1||0:d.gc_used_p2||0,u=a?d.gc_used_p2||0:d.gc_used_p1||0,y=d.matches_total||0,w=(E,f,S,$=ni,A=ri)=>`
    <div style="display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid #f0f0f0">
      <div style="text-align:right;font-size:18px;font-weight:900;color:${$}">${f}</div>
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const s=a.dataset.action;if(s==="match-ai"){No(i,e);return}if(s==="match-random"){mt(),i("match",{matchMode:"random"});return}if(s==="match-friend"){i("friends");return}if(s==="mini-league"){i("mini-league");return}if(s==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}async function Oo(t,e){var p,u;const{state:i,navigate:o}=e,r=un(),n=Yi(),a=(p=i==null?void 0:i.profile)==null?void 0:p.is_admin,s="2026.07.27-1953";t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
      ...
      <div style="background:var(--tile-bg);border:1px solid var(--tile-border);border-radius:14px;padding:18px">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          <div>
            ...
            <input id="team-pseudo" value="${(i.profile.pseudo||"").replace(/"/g,"&quot;")}"
  ...
  </div>`,t.querySelectorAll("[data-theme-choice]").forEach(y=>{y.addEventListener("click",()=>{ka(y.dataset.themeChoice),Oo(t,e)})});const c=t.querySelector("#team-color1"),d=t.querySelector("#team-color2"),l=t.querySelector("#team-preview"),m=()=>{l&&(l.style.background=`linear-gradient(135deg, ${c.value} 50%, ${d.value} 50%)`)};m(),c==null||c.addEventListener("input",m),d==null||d.addEventListener("input",m),(u=t.querySelector("#team-save"))==null||u.addEventListener("click",async()=>{const y=t.querySelector("#team-error"),w=t.querySelector("#team-save"),h=t.querySelector("#team-pseudo").value.trim(),E=t.querySelector("#team-club-name").value.trim();if(h.length<3){y.textContent="Pseudo trop court (min. 3 caractères).";return}if(E.length<2){y.textContent="Nom de club trop court.";return}w.disabled=!0,w.textContent="⏳ Enregistrement...",y.textContent="";const{error:f}=await v.from("users").update({pseudo:h,club_name:E,club_color1:c.value,club_color2:d.value}).eq("id",i.profile.id);if(w.disabled=!1,w.textContent="💾 Enregistrer",f){y.textContent=f.message;return}i.profile.pseudo=h,i.profile.club_name=E,i.profile.club_color1=c.value,i.profile.club_color2=d.value,y.style.color="#2ecc71",y.textContent="✅ Modifications enregistrées."});const x=t.querySelector("#volume-slider"),b=t.querySelector("#volume-label");let g=null;x.addEventListener("input",()=>{$n(Number(x.value)),b.textContent=`${x.value}%`,g&&(g.volume=Math.max(0,Math.min(1,Number(x.value)/100)))}),t.querySelector("#volume-test").addEventListener("click",()=>{g=Xi("/sounds/match-opening.mp3",1)}),t.querySelector("#settings-logout").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()})}const Me={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Ne(t,e){if(!t)return 0;let i=0;switch(e){case"GK":i=Number(t.note_g)||0;break;case"DEF":i=Number(t.note_d)||0;break;case"MIL":i=Number(t.note_m)||0;break;case"ATT":i=Number(t.note_a)||0;break;default:i=0}return i+(t.boost||0)}const bo=["ATT","MIL","DEF","GK"];function Ho(t,e,i){if(!t||!e)return!1;if(i&&t.position&&e.position)return $i(i).some(([l,m])=>l===t.position&&m===e.position||l===e.position&&m===t.position);const o=t._col!=null&&e._col!=null&&t._col===e._col,r=t._col!=null&&e._col!=null&&Math.abs(t._col-e._col)===1,n=bo.indexOf(t._line||t.job),a=bo.indexOf(e._line||e.job),s=Math.abs(n-a)===1;return(t._line||t.job)===(e._line||e.job)&&r||o&&s}function Uo(t,e){let i=0;const o=t.length;for(let r=0;r<o;r++)for(let n=r+1;n<o;n++){const a=t[r],s=t[n];if(!a||!s||!Ho(a,s,e))continue;const c=Bt(a,s);c==="#00ff88"?i+=10:c==="#FFD700"&&(i+=5)}return i}function ai(t,e={},i){let o=0,r=0;t.forEach(c=>{const d=c._line||c.job,l=Number(d==="MIL"?c.note_m:c.note_a)||0,m=c.stadiumBonus&&(d==="MIL"||d==="ATT")?10:0;o+=e.doubleAttack?l*2:l,r+=(c.boost||0)+m});const n=o+r,a=Uo(t,i);let s=n+a;return e.stolenNote&&(s-=e.stolenNote),{base:n,links:a,total:Math.max(0,s)}}function si(t,e={},i){const o=t.reduce((a,s)=>{const c=s._line||s.job;let d=0;c==="GK"?d=Number(s.note_g)||0:c==="MIL"?d=Number(s.note_m)||0:d=Number(s.note_d)||0;const l=s.stadiumBonus&&(c==="GK"||c==="DEF"||c==="MIL")?10:0;return a+d+(s.boost||0)+l},0),r=Uo(t,i);let n=o+r;return e.stolenNote&&(n-=e.stolenNote),{base:o,links:r,total:Math.max(0,n)}}function Zi(t,e,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:t>e,shielded:!1}}function Ko(t,e,i="easy"){const o=t.filter(a=>!a.used);if(!o.length)return[];const r=[...o].sort((a,s)=>{const c=e==="attack"?Ne(a,"ATT"):a._line==="GK"?Ne(a,"GK"):Ne(a,"DEF");return(e==="attack"?Ne(s,"ATT"):s._line==="GK"?Ne(s,"GK"):Ne(s,"DEF"))-c});let n=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return r.slice(0,Math.min(n,r.length,3))}function Rn(t,e){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[t]||i.vs_ai_easy)[e]||0}const On={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},Jt={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},ci=["GK","DEF","MIL","ATT"],Hn=["Tous","GK","DEF","MIL","ATT"],Un={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function xo(t){const e=t.player;return e?(e.rarity,Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)):null}function Kn(t){return t.length?t.reduce((e,i)=>xo(i)>xo(e)?i:e,t[0]):t[0]}const Vn={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function pi(t,e){return t&&Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function Bi(t,e=""){const i=t.player;if(!i)return"";const o=t.evolution_bonus||0,r={...i,_evolution_bonus:o},n=e?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${e}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${t.id}">
    ${n}
    ${ze(r,{width:140})}
    ...
    ${ze(t,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),d=(s||[]).filter(C=>C.card_type==="player"&&C.player),l=(s||[]).filter(C=>C.card_type==="game_changer"),m=(s||[]).filter(C=>C.card_type==="formation"),x=(s||[]).filter(C=>C.card_type==="stadium"),{data:b}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),g={};(b||[]).forEach(C=>{g[C.name]=C});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(C=>{u[C.id]=C}),x.forEach(C=>{C.stadium_def&&(u[C.stadium_id]=C.stadium_def)});const y=Object.keys(Ei),w=Object.keys(Me),h={};d.forEach(C=>{const V=C.player.id;h[V]=(h[V]||0)+1}),new Set(Object.keys(h).map(C=>String(C)));const E=new Set(m.map(C=>C.formation)),f=new Set(l.map(C=>C.gc_type));let S="player",$="Tous",A="",P=!1;function R(){return[...d].sort((C,V)=>{const Q=ci.indexOf(C.player.job),X=ci.indexOf(V.player.job);return Q!==X?Q-X:(C.player.surname_real||"").localeCompare(V.player.surname_real||"")})}function O(){return[...c||[]].sort((C,V)=>{const Q=ci.indexOf(C.job),X=ci.indexOf(V.job);return Q!==X?Q-X:(C.surname_real||"").localeCompare(V.surname_real||"")})}function Y(){return R().filter(C=>{const V=C.player,Q=$==="Tous"||V.job===$,X=!A||`${V.firstname} ${V.surname_real}`.toLowerCase().includes(A);return Q&&X})}function I(){return O().filter(C=>{const V=$==="Tous"||C.job===$,Q=!A||`${C.firstname} ${C.surname_real}`.toLowerCase().includes(A);return V&&Q})}t.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="margin-top:12px;border-top:1px solid var(--tile-border);padding-top:12px">
      ...
      <div style="display:flex;gap:8px">
        <input type="number" id="sell-price-form" min="1" placeholder="Prix en crédits" value="${ui}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(g=document.getElementById("direct-sell-form-btn"))==null||g.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${d} pour ${ui.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const y=x.find(h=>!h.is_for_sale)||x[0];if(!y){n("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",y.id),await v.from("transfer_history").delete().eq("card_id",y.id);const{error:w}=await v.from("cards").delete().eq("id",y.id);if(w){n(w.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+ui}).eq("id",r.profile.id),await c(),n(`+${ui.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const y=parseInt(document.getElementById("sell-price-form").value);if(!y||y<1){n("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:y}).eq("id",t.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:y}),n("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),n("Annonce retirée","success"),a(),s("collection")})}async function ho(t,e,i,o){var pe,me,fe,C,V,Q,X,re,F;const{state:r,toast:n,openModal:a,closeModal:s,navigate:c,refreshProfile:d}=o,l=t.player,m=e.filter(z=>z.player.id===l.id),x=m.length,b=t.evolution_bonus||0,g=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?b:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?b:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?b:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?b:0)),p=l.rarity||"normal",{data:u}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1);((pe=u==null?void 0:u[0])==null?void 0:pe.price)??Un[p];const y=((me=u==null?void 0:u[0])==null?void 0:me.price_min)??null,w=((fe=u==null?void 0:u[0])==null?void 0:fe.price_max)??null,h=l.rarity!=="legende";Ct(l);const E=pi(l,l.job)+b,f=l.job2?pi(l,l.job2)+(pi(l,l.job2)>0?b:0):null;Jt[l.job],l.job2&&Jt[l.job2];const S=On[l.rarity]||"#ccc",$=Vn[l.country_code]||l.country_code||"",A=t.evolution_bonus||0,R=E+A,O=f||0,Y=O>0?O+A:0,I=m.map(z=>z.id);let _={};if(I.length){const{data:z}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",I).order("transferred_at",{ascending:!0});(z||[]).forEach(W=>{_[W.card_id]||(_[W.card_id]=[]),_[W.card_id].push(W)})}const G=I.length?`
        ...
        ${m.filter(z=>z.id!==t.id).map((z,W)=>{const Z=_[z.id]||[],se=z.is_for_sale,ge=Z.length?Z[Z.length-1]:null,ye=z.evolution_bonus||0,$e=ge?ge.source==="booster"?"Booster":ge.price?ge.price.toLocaleString("fr")+" cr.":"—":"—",Ee=ge?new Date(ge.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",xe=80,be=Math.round(xe*657/507),Be=ze({...l,_evolution_bonus:ye},{width:xe});return`
            <div class="exemplaire-row" data-card-id="${z.id}" data-card-idx="${W}"
              ...
              <input type="checkbox" class="expl-check"
                data-id="${z.id}" data-evo="${ye}" data-note="${pi(l,l.job)}"
                ${se?"disabled":""}
                style="display:none">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(V=document.getElementById("close-detail"))==null||V.addEventListener("click",s);let K=new Set;const le=l.rarity==="pepite"?1.3:l.rarity==="papyte"?.7:1;function ce(){let z=0;return document.querySelectorAll(".expl-check:checked").forEach(W=>{if(W.dataset.id===t.id)return;const se=Number(W.dataset.evo)||0,ge=Number(W.dataset.note)||0;z+=ge+se}),Math.round(z*le)}const j=()=>{const z=K.size,W=document.getElementById("sell-action-panel");if(!W)return;W.style.display=z>0?"block":"none",document.getElementById("sell-selected-count").textContent=z;const Z=document.getElementById("evolve-btn");if(Z){const se=ce();Z.textContent=se>0?`⬆️ Évoluer (+${se})`:"⬆️ Évoluer"}};document.querySelectorAll(".expl-check").forEach(z=>{z.addEventListener("change",()=>{const W=z.dataset.id;z.checked?K.add(W):K.delete(W);const Z=z.closest(".exemplaire-row");if(Z){const se=Z.querySelector(".expl-sel-overlay"),ge=Z.querySelector(".expl-sel-check");se&&(se.style.display=z.checked?"block":"none"),ge&&(ge.style.display=z.checked?"flex":"none"),Z.style.transform=z.checked?"scale(1.05)":"scale(1)"}j()})}),document.querySelectorAll(".exemplaire-row").forEach(z=>{z.addEventListener("click",W=>{if(W.target.tagName==="INPUT")return;const Z=z.querySelector(".expl-check");Z&&!Z.disabled&&(Z.checked=!Z.checked,Z.dispatchEvent(new Event("change")))})}),(Q=document.getElementById("evolve-btn"))==null||Q.addEventListener("click",async()=>{if(x<=1)return;const z=[...K];if(!z.length)return;if(K.has(t.id)){const xe=document.createElement("div");xe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",xe.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            ${f&&f>0?`<br>📊 Note 2 finale : <strong>${f}</strong> → <strong style="color:#1A6B3C">${f+se}</strong>`:""}
          </div>
    ...
    </div>`,document.body.appendChild(o);const r=n=>{o.remove(),i(n)};o.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),o.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),o.addEventListener("click",n=>{n.target===o&&r(!1)})})}const xi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Pi(t,e){const{state:i,navigate:o,toast:r}=e;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});t.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
        ...
        <div style="width:130px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 8px;gap:12px;border-left:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="width:100%;text-align:center">
            ...
            <div id="formation-pc-btn" style="cursor:pointer;margin:0 auto;width:fit-content">
              ${oi(e.formation,ut[e.formation],{width:100})}
            </div>
          </div>
          <!-- Stade -->
          <div style="width:100%;text-align:center">
  ...
  </div>`;const l=window.innerWidth>=900,m=t.querySelector(".deck-pc-layout"),x=t.querySelector(".deck-mobile-layout");m&&(m.style.display=l?"block":"none"),x&&(x.style.display=l?"none":"block"),t.querySelectorAll("#save-deck").forEach(u=>{u.closest(".page-body").style.display=l?"none":"block"}),Qn(t,e,r,i),t.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>o("decks")));const b=()=>{const{openModal:u,closeModal:y}=i,h=`<div style="display:flex;flex-wrap:wrap;gap:12px;padding:8px;justify-content:center">
      ${[...new Set(a)].map(E=>{const f=E===e.formation;return`<div data-forma="${E}" style="cursor:pointer;border-radius:10px;${f?"box-shadow:0 0 0 3px #1A6B3C":""}">
          ${oi(E,ut[E],{width:90})}
        </div>`}).join("")}
    </div>`;u("⚽ Choisir une formation",h),document.querySelectorAll("#modal-body [data-forma]").forEach(E=>{E.addEventListener("click",()=>{e.formation=E.dataset.forma;const f=_o(e.formation),S={};f.forEach($=>{e.slots[$]&&(S[$]=e.slots[$])}),e.slots=S,y(),$t(t,e,i)})})};t.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(u=>u.addEventListener("click",b)),t.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(u=>u.addEventListener("click",()=>Zn(e,t,i))),t.querySelectorAll("#save-deck, #save-deck-pc").forEach(u=>u.addEventListener("click",()=>ir(e,i))),t.querySelectorAll("[data-remove-sub]").forEach(u=>{u.addEventListener("click",()=>{e.subs=e.subs.filter(y=>y!==u.dataset.removeSub),$t(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(u=>u.addEventListener("click",()=>tr(e,t,i)))}function Qn(t,e,i,o){var h,E,f;const r=window.innerWidth>=900,n=t.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!n)return;const a=(h=e.stadiumCards)==null?void 0:h.find(S=>S.id===e.stadiumCardId),s=a&&((E=e.stadDefMap)==null?void 0:E[a.stadium_id])||null,c=ut[e.formation]||{},d=$i(e.formation)||[],l={};for(const S of i){const $=e.slots[S],A=$?e.playerCards.find(P=>P.id===$):null;A!=null&&A.player?l[S]={...A.player,_evolution_bonus:A.evolution_bonus||0,face:A.player.face||null}:l[S]=null}const m=window.innerWidth>=900,x=m?window.innerWidth-280:window.innerWidth-20,b=m?Math.min(x,860):x,g=Math.round(m?b*.82:b*.85),p=m?84:44;let u="";for(const[S,$]of d){const A=c[S],P=c[$];if(!A||!P)continue;const R=A.x*b,O=Math.round(.03*g+A.y*.85*g),Y=P.x*b,I=Math.round(.03*g+P.y*.85*g),_=l[S],G=l[$],K=Bt(_,G);K==="#ff3333"||K==="#cc2222"?u+=`<line x1="${R.toFixed(1)}" y1="${O.toFixed(1)}" x2="${Y.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${K}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(u+=`<line x1="${R.toFixed(1)}" y1="${O.toFixed(1)}" x2="${Y.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${K}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,u+=`<line x1="${R.toFixed(1)}" y1="${O.toFixed(1)}" x2="${Y.toFixed(1)}" y2="${I.toFixed(1)}" stroke="${K}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let y="";const w=Math.round(p*657/507);for(const S of i){const $=c[S];if(!$)continue;const A=l[S],P=$.x*b;$.y*g;const R=Math.round(.03*g+$.y*(.85*g)),O=Math.round(P-p/2),Y=Math.round(R-w/2);if(A){const I=S.replace(/\d+/,""),_=s&&(s.club_id&&String(A.club_id)===String(s.club_id)||s.country_code&&A.country_code===s.country_code),G=ze({...A,_evolution_bonus:A._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:I});_&&((f=s.club)!=null&&f.logo_url||s.image_url),y+=`<div style="position:absolute;left:${O}px;top:${Y}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${S}">
    ...
    <div style="position:relative;width:${b}px;height:${g}px;margin:0 auto">
      ...
      ${y}
    </div>`,n.querySelectorAll(".deck-slot-hit").forEach(S=>{S.addEventListener("click",()=>er(S.dataset.pos,e,t,o))})}function Zn(t,e,i){var s;const{openModal:o,closeModal:r}=i,n=new Set,a=(t.stadiumCards||[]).filter(c=>{const d=c.stadium_id||c.id;return n.has(d)?!1:(n.add(d),!0)});o("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
      ...
      ${a.map(c=>{var b;const d=t.stadDefMap[c.stadium_id],l=((b=d==null?void 0:d.club)==null?void 0:b.logo_url)||(d==null?void 0:d.image_url)||(d!=null&&d.country_code?`https://flagsapi.com/${d.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),m=t.stadiumCardId===c.id,x=Ht((d==null?void 0:d.name)||"Stade",l,"+10⭐",{width:90});return`<div class="stad-choice" data-stad-id="${c.id}" style="cursor:pointer;position:relative;border-radius:8px;${m?"box-shadow:0 0 0 3px #4fc3f7":""}">
          ${x}
        </div>`}).join("")}
    </div>`),(s=document.getElementById("stad-none"))==null||s.addEventListener("click",()=>{t.stadiumCardId=null,r(),$t(e,t,i)}),document.querySelectorAll(".stad-choice").forEach(c=>{c.addEventListener("click",()=>{t.stadiumCardId=c.dataset.stadId,r(),$t(e,t,i)})})}function er(t,e,i,o){var g,p,u,y,w;const{openModal:r,closeModal:n}=o,a=t.replace(/\d+/,""),s=(g=e.stadiumCards)==null?void 0:g.find(h=>h.id===e.stadiumCardId),c=s&&((p=e.stadDefMap)==null?void 0:p[s.stadium_id])||null,d=e.slots[t],l=d?e.playerCards.find(h=>h.id===d):null;(u=l==null?void 0:l.player)==null||u.id;const m=new Set;Object.entries(e.slots).forEach(([h,E])=>{var S;if(h===t||!E)return;const f=e.playerCards.find($=>$.id===E);(S=f==null?void 0:f.player)!=null&&S.id&&m.add(f.player.id)}),e.subs.forEach(h=>{var f;const E=e.playerCards.find(S=>S.id===h);(f=E==null?void 0:E.player)!=null&&f.id&&m.add(E.player.id)});const x=new Set,b=e.playerCards.filter(h=>{const E=h.player;return!(E.job===a||E.job2===a)||m.has(E.id)||x.has(E.id)?!1:(x.add(E.id),!0)});b.sort((h,E)=>{const f=h.evolution_bonus||0,S=E.evolution_bonus||0,$=(a==="GK"?h.player.note_g:a==="DEF"?h.player.note_d:a==="MIL"?h.player.note_m:h.player.note_a)+(a===h.player.job||a===h.player.job2?f:0);return(a==="GK"?E.player.note_g:a==="DEF"?E.player.note_d:a==="MIL"?E.player.note_m:E.player.note_a)+(a===E.player.job||a===E.player.job2?S:0)-$}),r(`Choisir ${a} — ${t}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${e.slots[t]?`
  ...
  `,document.body.appendChild(r);let n=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let c=!1;const d=_=>_.touches&&_.touches[0]?_.touches[0].clientX:_.clientX;function l(_){n||(c=!0,s.style.opacity="1",m(_))}function m(_){if(!c||n)return;const G=a.getBoundingClientRect(),K=d(_)-G.left,le=Math.max(0,Math.min(1,K/G.width));s.style.width=le*G.width+"px",le>=.82&&b()}function x(){n||(c=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{n||(s.style.transition="")},220))}function b(){var G;if(n)return;n=!0,c=!1,s.style.width="100%",s.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const _=document.getElementById("cut-hint");_&&(_.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",y(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",m),window.addEventListener("pointerup",x),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",x);let g=0,p=!1;const u=new Set;function y(_){g=_,document.getElementById("reveal-phase").style.display="flex",w(),h(_,0),A()}function w(){const _=document.getElementById("card-dots");_&&(_.innerHTML=t.map((G,K)=>`<div class="card-dot" data-i="${K}" style="width:8px;height:8px;border-radius:50%;background:${K===g?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),_.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>f(parseInt(G.dataset.i)))))}function h(_,G){var C,V;const K=t[_],le=document.getElementById("card-counter"),ce=document.getElementById("card-track");le&&(le.textContent=`Carte ${_+1} / ${t.length}`);const j=document.getElementById("reveal-btns");j&&(j.style.display=_===t.length-1?"flex":"none");const H=K.card_type==="player"&&((C=K.player)==null?void 0:C.rarity)==="legende",pe=!u.has(_);u.add(_);let me=0;if(K.card_type==="player"&&K.player){const Q=K.player,X=Q.job||"ATT";me=(Number(X==="GK"?Q.note_g:X==="DEF"?Q.note_d:X==="MIL"?Q.note_m:Q.note_a)||0)+(K.evolution_bonus||0)}const fe=Q=>{ce.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${H?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${pr(K)}</div>
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",e.user.id)};async function m(){var w;if(d>=c||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",e.user.id),r&&await r(),o("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const g=a[0],{data:p}=await v.from("users").select("*").eq("id",e.user.id).single();p&&(e.profile=p);let u=[];try{if(g.type==="formation")u=await Qo(e.profile,0);else if(g.type==="game_changer")u=await Jo(e.profile,g.count||3,0);else if(s&&((w=s.rates)!=null&&w.length)){const h={...s,cost:0,cardCount:g.count||s.cardCount||5};u=await Gi(e.profile,h),g.guaranteeGK&&!e.profile.first_booster_opened&&(u.some(f=>f.player&&f.player.job==="GK")||await br(e.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",e.profile.id))}else u=await Xo(e.profile,g.count||5,0)}catch(h){o(h.message||"Erreur ouverture booster","error");return}a.shift(),d++,await l();const y=g.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:g.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${d}/${c})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};Zo(u,y,i,()=>{m()})}(b=document.getElementById("onboard-start"))==null||b.addEventListener("click",()=>m())}async function br(t,e){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const o=i[Math.floor(Math.random()*i.length)],r=e.findIndex(a=>a.player);if(r===-1)return;const n=e[r];await v.from("cards").update({player_id:o.id}).eq("id",n.id),e[r]={...n,player_id:o.id,player:o}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Et={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},xr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function At(t,e,i,o,r){var n;t.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${e}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${o}</button>
    </div>
  </div>`,(n=document.getElementById("msg-btn"))==null||n.addEventListener("click",r)}function Ri(t,e){var n,a;const i=t.player,o=t.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:t.id,position:e||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?o:0)+(i.job2==="GK"&&r>0?o:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?o:0)+(i.job2==="DEF"&&r>0?o:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?o:0)+(i.job2==="MIL"&&r>0?o:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?o:0)+(i.job2==="ATT"&&r>0?o:0),evolution_bonus:o,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((n=i.clubs)==null?void 0:n.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function li(t,e){if(!e||!t)return t;const{club_id:i,country_code:o}=e;return Object.values(t).forEach(r=>{Array.isArray(r)&&r.forEach(n=>{const a=i&&String(n.club_id)===String(i),s=o&&String(n.country_code)===String(o);(a||s)&&(n.stadiumBonus=!0)})}),t}function yi(t,e){if(!e||!(t!=null&&t.length))return t;const{club_id:i,country_code:o}=e;return t.forEach(r=>{if(!r)return;const n=i&&String(r.club_id)===String(i),a=o&&String(r.country_code)===String(o);(n||a)&&(r.stadiumBonus=!0)}),t}function dt(t){return t===1?[1]:t===2?[0,2]:t===3?[0,1,2]:t===4?[0,1,1,2]:t===5?[0,1,1,1,2]:[1]}function en(){const t=Math.random()*100;return t<10?10:t<30?5:3}function hi(t,e){const i=Et[e]||Et["4-4-2"],o={GK:[],DEF:[],MIL:[],ATT:[]};if(t.length&&t.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const s=t.filter(d=>d.position&&d.position.replace(/\d+$/,"")===a).sort((d,l)=>parseInt(d.position.replace(/\D+/g,""),10)-parseInt(l.position.replace(/\D+/g,""),10)).map(d=>({...d,_line:a})),c=dt(s.length);s.forEach((d,l)=>{d._col=c[l]}),o[a]=s}return o}const n=[...t];for(const a of["GK","DEF","MIL","ATT"]){const s=[];for(let d=0;d<i[a];d++){let l=n.findIndex(m=>m.job===a);if(l===-1&&(l=n.findIndex(m=>m.job2===a)),l===-1&&(l=0),n[l]){const m={...n[l],_line:a};s.push(m),n.splice(l,1)}}const c=dt(s.length);s.forEach((d,l)=>{d._col=c[l]}),o[a]=s}return o}function ct(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.setProperty("display","none","important"),e.dataset.matchHidden="1"}),t&&t.style.setProperty("padding-bottom","0","important")}function Ve(t){document.querySelectorAll(".top-nav, .bottom-nav").forEach(e=>{e.style.removeProperty("display"),delete e.dataset.matchHidden}),t&&t.style.removeProperty("padding-bottom")}function Ii(t,e,i){const r=new Set,n=e.filter(l=>{var x;const m=((x=l._gcDef)==null?void 0:x.name)||l.gc_type||l.id;return r.has(m)?!1:(r.add(m),!0)});let a=[];function s(l,m){const x=l._gcDef,b=(x==null?void 0:x.name)||l.gc_type,g=x!=null&&x.image_url?`/icons/${x.image_url}`:null,p=nt(b,g,"⚡",(x==null?void 0:x.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${l.id}"
    ...
    </div>`}const c=l=>{t.style.overflow="",t.style.height="",t.style.display="",t.style.flexDirection="",i(l)};function d(){var m,x,b;t.style.overflow="hidden",t.style.height="100%",t.style.display="flex",t.style.flexDirection="column";const l=a.length>0;t.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),c=[...new Set((s||[]).filter(x=>{var b,g;return((b=x.card)==null?void 0:b.card_type)==="stadium"&&((g=x.card)==null?void 0:g.stadium_id)}).map(x=>x.card.stadium_id))],d={};if(c.length){const{data:x}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",c);(x||[]).forEach(b=>{d[b.id]=b}),(s||[]).forEach(b=>{var g,p;((g=b.card)==null?void 0:g.card_type)==="stadium"&&((p=b.card)!=null&&p.stadium_id)&&(b.card._stadiumDef=d[b.card.stadium_id]||null)})}let l=0;function m(){var f,S,$,A,P,R,O;const x=n[l],b=(s||[]).filter(Y=>Y.deck_id===x.id),g=b.filter(Y=>{var I;return Y.is_starter&&((I=Y.card)==null?void 0:I.player)}).map(Y=>Ri(Y.card,Y.position)),p=b.find(Y=>{var I;return((I=Y.card)==null?void 0:I.card_type)==="formation"}),u=x.formation||((f=p==null?void 0:p.card)==null?void 0:f.formation)||"4-4-2";let y=g.length>=11?hi(g,u):null,w=((S=x.stadium_card)==null?void 0:S.stadium_def)||null;w&&y&&(y=li(y,w));const h=g.length>=11;ct(t),t.style.height="100%",t.style.overflow="hidden",t.innerHTML=`
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Y(){const I=t.querySelector(".deck-preview-wrap"),_=t.querySelector("#deck-swipe-zone");if(!I||!_||!y)return;const G=_.clientWidth>=900,K=Math.max(200,_.clientHeight-(G?60:40)),ce=Math.max(200,_.clientWidth-16),j=G?Math.min(117,Math.max(52,Math.round(ce*.22))):Math.max(44,Math.round(ce*.168));if(K<220||ce<220){requestAnimationFrame(Y);return}const H=G?null:Math.round(j*.55);I.innerHTML=Ut(y,u,null,[],ce,K,[],H),I.style.cssText=`width:${ce}px;height:${K}px;overflow:hidden;margin:${G?0:60}px auto 0`;const pe=I.querySelector("svg");pe&&(pe.style.cssText="display:block;width:100%;height:100%",pe.setAttribute("preserveAspectRatio",G?"xMidYMid meet":"none"))})),(A=document.getElementById("prev-deck"))==null||A.addEventListener("click",()=>{l>0&&(l--,m())}),(P=document.getElementById("next-deck"))==null||P.addEventListener("click",()=>{l<n.length-1&&(l++,m())}),(R=document.getElementById("validate-deck"))==null||R.addEventListener("click",()=>{if(!h)return;const Y=e.state.params||{};e.navigate("match",{...Y,matchMode:Y.matchMode||i,deckId:x.id})}),(O=document.getElementById("cancel-deck-select"))==null||O.addEventListener("click",()=>{Ve(t),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let Y=0,I=0;E.addEventListener("touchstart",_=>{Y=_.touches[0].clientX,I=_.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",_=>{const G=_.changedTouches[0].clientX-Y,K=_.changedTouches[0].clientY-I;Math.abs(G)<40||Math.abs(G)<Math.abs(K)||(G<0&&l<n.length-1?(l++,m()):G>0&&l>0&&(l--,m()))},{passive:!0})}}m()}function kt(t,e=44,i=58,o=null){return ze(t,{width:e,showStad:!!o,stadDef:o,used:t==null?void 0:t.used})}function et(t,e,i,o,r){if(!(t!=null&&t.length))return"";const n=t.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((s,c)=>{const d=s._line||s.job||"MIL";let l=s.boost||0;if(s.stadiumBonus&&(o==="attack"&&(d==="ATT"||d==="MIL")||o==="defense"&&(d==="GK"||d==="DEF"||d==="MIL")?l+=10:o||(l+=10)),a+=ze({...s,_evolution_bonus:0,evolution_bonus:0},{width:40,role:d,extraNote:l}),c<n.length-1){const m=n[c+1],x=Ho(s,m,r)?Bt(s,m):null;a+=`<div style="width:7px;height:3px;background:${!x||x==="#ff3333"||x==="#cc2222"?"rgba(255,255,255,0.12)":x};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${e};color:${e==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function Ti(t,e,i,o,r=310,n=310,a=[],s=null){const c=ut[e]||{},d=$i(e)||Ei[e]||[],l={},m=["ATT","MIL","DEF","GK"];for(const y of m)(t[y]||[]).forEach((h,E)=>{l[`${y}${E+1}`]=h});function x(y){const w=c[y];return w?{x:w.x*r,y:w.y*n}:null}let b="";for(const[y,w]of d){const h=x(y),E=x(w);if(!h||!E)continue;const f=l[y],S=l[w],$=Bt(f,S);$==="#00ff88"||$==="#FFD700"?(b+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
    ...
    ${Ti(t,e,i,o,r,n,a,s)}
  </div>`}async function Si(t,e,i,o){var S;const{state:r,navigate:n,toast:a}=e;ct(t);const s=r.params||{};if(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return hr(t,e,i);const c=s.deckId;let d,l,m,x;try{const $=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",c).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",c).order("slot_order")]);d=$[0].data,m=$[0].error,l=$[1].data,x=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),At(t,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>n("home"));return}if(m||x){console.error("[Match] Erreur Supabase:",m||x),At(t,"⚠️","Erreur lors du chargement du deck.","Retour",()=>n("home"));return}const b=(l||[]).filter($=>{var A;return $.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Ri($.card,$.position)),g=(l||[]).filter($=>{var A;return!$.is_starter&&((A=$.card)==null?void 0:A.player)}).map($=>Ri($.card,$.position));if(b.length<11){At(t,"⚠️",`Deck incomplet (${b.length}/11).`,"Compléter",()=>n("decks"));return}const p=(l||[]).find($=>{var A;return((A=$.card)==null?void 0:A.card_type)==="formation"}),u=(d==null?void 0:d.formation)||((S=p==null?void 0:p.card)==null?void 0:S.formation)||"4-4-2",{data:y,error:w}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(y||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(A=>A.name===$.gc_type||A.id===$.gc_definition_id))||null}));let f=null;if(d!=null&&d.stadium_card_id){const{data:$}=await v.from("cards").select("stadium_id").eq("id",d.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:A}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();f=A||null}}o({deckId:c,formation:u,starters:b,subsRaw:g,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:f})}function zt(){return Math.min(window.innerWidth-40,860)}function Ot(){return Math.round(zt()*1.1)}function tn(t){var r,n;if(!t)return null;const e=t._line||t.job||"MIL",i=e==="GK"?t.note_g||0:e==="DEF"?t.note_d||0:e==="MIL"?t.note_m||0:t.note_a||0,o=t.stadiumBonus?10:0;return{name:t.name,firstname:t.firstname||"",note:i+(t.boost||0)+o,note_g:t.note_g||0,note_d:t.note_d||0,note_m:t.note_m||0,note_a:t.note_a||0,_evolution_bonus:0,stadiumBonus:t.stadiumBonus||!1,boost:t.boost||0,job:t.job,job2:t.job2||null,_line:t._line||t.job,_col:t._col,country_code:t.country_code,club_id:t.club_id,rarity:t.rarity,clubName:t.clubName||((r=t.clubs)==null?void 0:r.encoded_name)||null,clubLogo:t.clubLogo||((n=t.clubs)==null?void 0:n.logo_url)||null,face:t.face||null,portrait:Ct(t)}}function vr(t,e,i,o="Adversaire"){Bo("/sounds/match-opening.mp3",.3);const r=zt(),n=Ot();return`
    ...
    </div>`}function on(t){var n,a,s;if(!t)return"";const e=c=>c?ze({...c,_evolution_bonus:0},{width:52,role:c._line||c.job,showStad:!!c.stadiumBonus,extraNote:c.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    </div>`}function tt(t,e,i,o,r){Xi("/sounds/goal.mp3",.7);const n=document.getElementById("goal-anim-overlay");n&&n.remove();const a=document.createElement("div");a.id="goal-anim-overlay",a.style.cssText=`
    ...
    <div style="animation:goalPop 0.4s ease-out;text-align:center">
      ...
      }`,document.head.appendChild(c)}setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.4s",setTimeout(()=>{a.remove(),r==null||r()},400)},1800)}function wr(t,e,i){const o=document.getElementById("sub-anim-overlay");o&&o.remove();const r=document.createElement("div");r.id="sub-anim-overlay",r.style.cssText=`
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=t,!document.getElementById("game-toast-style")){const n=document.createElement("style");n.id="game-toast-style",n.textContent=`
      ...
      }`,document.head.appendChild(n)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function nn(t,e){const i=Ne(t,"MIL"),o=t.stadiumBonus||e&&(e.club_id&&String(t.club_id)===String(e.club_id)||e.country_code&&t.country_code===e.country_code)?10:0;return i+o}function vt(t,e){return t.reduce((i,o)=>i+nn(o,e),0)}function wt(t){let e=0;for(let i=0;i<t.length-1;i++){const o=Bt(t[i],t[i+1]);o==="#00ff88"?e+=10:o==="#FFD700"&&(e+=5)}return e}function vi(t,e,i,o,r){return`<div id="duel-row-${o}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((n,a)=>{const s=a<t.length-1?Bt(n,t[a+1]):null,c=!s||s==="#ff3333"||s==="#cc2222",d=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return nn(n,r),n.stadiumBonus||r&&(r.club_id&&String(n.club_id)===String(r.club_id)||r.country_code&&(n.country_code,r.country_code)),`
    ...
    </div>`}async function _r(t,e){const{state:i}=e,o=i.params||{},r=o.matchMode||"vs_ai_easy",n=r==="solo",a=r==="ranked_ai",s=o.soloLevel||1,c=r.replace("vs_ai_",""),d=r;let l=null;if(n){const{data:g}=await v.from("solo_levels").select("*").eq("level_number",s).maybeSingle();l=g||{level_number:s,target_note_avg:10,nb_liens_jaune:2,nb_liens_vert:1,nb_joueurs_stade:2,reward_credits:500}}const m=o.rankedData||null,x=o.presetSetup||null;async function b({deckId:g,formation:p,starters:u,subsRaw:y,gcCardsEnriched:w,gcDefs:h,stadiumDef:E}){try{let f=hi(u,p);E&&(f=li(f,E),yi(y,E));let S=null;if(a){const R=$r(f),{jaune:O,vert:Y}=Er(f,p),I=.9+Math.random()*.2;S={target_note_avg:Math.max(1,Math.round(R*I/16)),nb_liens_jaune:O,nb_liens_vert:Y,nb_joueurs_stade:E?3:0}}const $=n?await $o(p,l):a?await $o(p,S):await kr(p,c),A=$.lines||$,P=async R=>{try{const O=d==="vs_ai_club"||d==="solo"||d==="ranked_ai"?"club":d,{data:Y,error:I}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:O,home_deck_id:g,status:"in_progress"}).select().single();if(I){console.error("[MatchIA] Erreur création match:",I),At(t,"⚠️","Impossible de créer le match ("+I.message+").","Retour",()=>e.navigate("home"));return}const _=$.stadiumDef||null;_&&A&&(li(A,_),yi($.subs||[],_));const G={gcDefs:h||[],matchId:Y==null?void 0:Y.id,mode:d,difficulty:c,formation:p,isSolo:n,soloLevel:s,soloLevelConfig:l,isRankedAI:a,rankedAIData:m,homeTeam:f,aiTeam:A,homeSubs:y,subsUsed:0,maxSubs:Math.min(y.length,3),aiSubs:$.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min(($.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:$.gcCards||[],aiUsedGc:[],aiStadiumDef:_,homeScore:0,aiScore:0,gcCards:R,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Lr(t,G,e)}catch(O){console.error("[MatchIA] Exception launchMatch:",O),At(t,"⚠️","Erreur au lancement du match : "+O.message,"Retour",()=>e.navigate("home"))}};if(a&&x){P(x.gcCardsEnriched||[]);return}if(!w.length){P([]);return}Ii(t,w,P)}catch(f){console.error("[MatchIA] Exception setup:",f),At(t,"⚠️","Erreur de préparation du match : "+f.message,"Retour",()=>e.navigate("home"))}}x?await b(x):await Si(t,e,r,b)}async function kr(t,e){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:rn(t),subs:[],gcCards:[],stadiumDef:null};const o=Et[t]||Et["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},n=new Set;function a(y,w,h){var E,f;return n.add(y.id),{cardId:"ai-"+y.id+"-"+h,id:y.id,firstname:y.firstname,name:y.surname_real,country_code:y.country_code,club_id:y.club_id,job:y.job,job2:y.job2,note_g:Number(y.note_g)||0,note_d:Number(y.note_d)||0,note_m:Number(y.note_m)||0,note_a:Number(y.note_a)||0,rarity:y.rarity,skin:y.skin,hair:y.hair,hair_length:y.hair_length,face:y.face,clubName:((E=y.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((f=y.clubs)==null?void 0:f.logo_url)||null,boost:0,used:!1,_line:w}}for(const y of["GK","DEF","MIL","ATT"]){const w=i.filter($=>$.job===y&&!n.has($.id)),h=i.filter($=>$.job!==y&&!n.has($.id)),E=[...w,...h],f=[];for(let $=0;$<o[y];$++){const A=E[$];A&&f.push(a(A,y,$))}const S=dt(f.length);f.forEach(($,A)=>{$._col=S[A]}),r[y]=f}const c=i.filter(y=>!n.has(y.id)).slice(0,5).map((y,w)=>a(y,y.job,100+w)),m=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((y,w)=>{var h,E;return{id:"ai-gc-"+w,gc_type:y,name:((h=Me[y])==null?void 0:h.name)||y,icon:((E=Me[y])==null?void 0:E.icon)||"⚡"}}),x=Object.values(r).flat(),b={};x.forEach(y=>{y.club_id&&(b[y.club_id]=(b[y.club_id]||0)+1)});const g=(u=Object.entries(b).sort((y,w)=>w[1]-y[1])[0])==null?void 0:u[0];let p=null;if(g){const{data:y}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",g).single();y&&(p={club_id:y.id,country_code:null,name:y.encoded_name+" Stadium",club:{encoded_name:y.encoded_name,logo_url:y.logo_url}})}return{lines:r,subs:c,gcCards:m,stadiumDef:p}}function $r(t){let e=0;for(const i of["GK","DEF","MIL","ATT"])(t[i]||[]).forEach(o=>{const r=o._line||i,n=Number(r==="GK"?o.note_g:r==="DEF"?o.note_d:r==="MIL"?o.note_m:o.note_a)||0;e+=n+(o.boost||0)});return e}function Er(t,e){const i={};for(const a of["GK","DEF","MIL","ATT"])(t[a]||[]).forEach((s,c)=>{i[`${a}${c+1}`]=s});const o=$i(e)||Ei[e]||[];let r=0,n=0;for(const[a,s]of o){const c=i[a],d=i[s];if(!c||!d)continue;const l=Bt(c,d);l==="#00ff88"?n++:l==="#FFD700"&&r++}return{jaune:r,vert:n}}function ko(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}function fi(t,e,i){if(i<=0||!t.length)return[];const o=[...t].sort((r,n)=>Math.abs(ko(r)-e)-Math.abs(ko(n)-e));return o.slice(0,Math.min(i,o.length))}async function $o(t,e){var Y,I;const i=Number(e==null?void 0:e.target_note_avg)||10,o=Number(e==null?void 0:e.nb_liens_jaune)||0,r=Number(e==null?void 0:e.nb_liens_vert)||0,n=Number(e==null?void 0:e.nb_joueurs_stade)||0,{data:a}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url,country_code)").eq("is_active",!0).limit(300);if(!a||a.length<16)return{lines:rn(t),subs:[],gcCards:[],stadiumDef:null};const s={};a.forEach(_=>{_.club_id&&(s[_.club_id]=(s[_.club_id]||0)+1)});const c=((Y=Object.entries(s).sort((_,G)=>G[1]-_[1])[0])==null?void 0:Y[0])||null,d=c?a.filter(_=>_.club_id===c):[],l=((I=d[0])==null?void 0:I.country_code)||null,m=l?a.filter(_=>_.country_code===l&&_.club_id!==c):[],x=Math.min(d.length,Math.max(2,r+1),16),b=Math.min(m.length,Math.max(0,o),16-x),g=[],p=new Set;fi(d,i,x).forEach(_=>{g.push(_),p.add(_.id)}),fi(m,i,b).forEach(_=>{g.push(_),p.add(_.id)});const u=Math.max(0,16-g.length),y=a.filter(_=>!p.has(_.id));fi(y,i,u).forEach(_=>{g.push(_),p.add(_.id)});const w=Et[t]||Et["4-4-2"],h={GK:[],DEF:[],MIL:[],ATT:[]},E=new Set;function f(_,G,K){var le,ce;return E.add(_.id),{cardId:"ai-"+_.id+"-"+K,id:_.id,firstname:_.firstname,name:_.surname_real,country_code:_.country_code,club_id:_.club_id,job:_.job,job2:_.job2,note_g:Number(_.note_g)||0,note_d:Number(_.note_d)||0,note_m:Number(_.note_m)||0,note_a:Number(_.note_a)||0,rarity:_.rarity,skin:_.skin,hair:_.hair,hair_length:_.hair_length,face:_.face,clubName:((le=_.clubs)==null?void 0:le.encoded_name)||null,clubLogo:((ce=_.clubs)==null?void 0:ce.logo_url)||null,boost:0,used:!1,_line:G}}for(const _ of["GK","DEF","MIL","ATT"]){const G=g.filter(H=>H.job===_&&!E.has(H.id)),K=g.filter(H=>H.job!==_&&!E.has(H.id)),le=[...G,...K],ce=[];for(let H=0;H<w[_];H++){const pe=le[H];pe&&ce.push(f(pe,_,H))}const j=dt(ce.length);ce.forEach((H,pe)=>{H._col=j[pe]}),h[_]=ce}let S=g.filter(_=>!E.has(_.id));if(S.length<5){const _=a.filter(G=>!E.has(G.id)&&!S.some(K=>K.id===G.id));S=S.concat(fi(_,i,5-S.length))}const $=S.slice(0,5).map((_,G)=>f(_,_.job,100+G)),R=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((_,G)=>{var K,le;return{id:"ai-gc-"+G,gc_type:_,name:((K=Me[_])==null?void 0:K.name)||_,icon:((le=Me[_])==null?void 0:le.icon)||"⚡"}});let O=null;if(n>0&&c){const{data:_}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",c).single();_&&(O={club_id:_.id,country_code:null,name:_.encoded_name+" Stadium",club:{encoded_name:_.encoded_name,logo_url:_.logo_url}})}return{lines:h,subs:$,gcCards:R,stadiumDef:O}}function rn(t){const e=Et[t]||Et["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},o=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const n of["GK","DEF","MIL","ATT"]){const a=[];for(let c=0;c<e[n];c++){const d=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:o[r%o.length],country_code:"XX",club_id:null,job:n,job2:null,note_g:n==="GK"?d:2,note_d:n==="DEF"?d:2,note_m:n==="MIL"?d:2,note_a:n==="ATT"?d:2,rarity:"normal",boost:0,used:!1,_line:n}),r++}const s=dt(a.length);a.forEach((c,d)=>{c._col=s[d]}),i[n]=a}return i}function Lr(t,e,i){var r;Bo("/sounds/match-opening.mp3",.3);const o=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(e.phase==="defense"&&e.pendingAttack){const H=e.pendingAttack;let pe="";if(e.selected.length>0){const me=e.selected.map(C=>({...(e.homeTeam[C._role]||[]).find(Q=>Q.cardId===C.cardId)||C,_line:C._role})),fe=si(me,e.modifiers.home,e.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          </div>`}const j=e.log[e.log.length-1];return j?'<div style="padding:2px 4px">'+on(j)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
  ...
  <div id="match-history-panel">
  ...
  </div>`;function A(){const j=t.querySelector(".match-screen");if(!j)return;const H=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);j.style.bottom="auto",j.style.height=H+"px",j.style.minHeight=H+"px",j.style.maxHeight=H+"px",j.style.overflow="hidden";const pe=t.querySelector("#mobile-action-bar"),me=t.querySelector("#mobile-play-area");pe&&me&&(me.style.paddingBottom=pe.offsetHeight+"px")}if(A(),setTimeout(A,120),setTimeout(A,400),setTimeout(A,1e3),e._vvBound||(e._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",A),window.visualViewport.addEventListener("scroll",A)),window.addEventListener("resize",A)),function(){const H=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!H)return;const pe=H.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),H.removeAttribute("width"),H.removeAttribute("height"),H.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",H.setAttribute("preserveAspectRatio","xMidYMid meet")}(),e._resizeBound||(e._resizeBound=!0,window.addEventListener("resize",()=>{const j=t.querySelector(".terrain-wrapper svg");if(j){const H=j.closest("#match-terrain-wrap");H&&(H.style.cssText="position:relative;width:100%;height:100%;padding:0"),j.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),e.phase==="attack"||e.phase==="defense"){let j=!1,H=30;const pe=()=>document.getElementById("match-timer"),me=()=>{const fe=pe();if(!fe)return;const C=String(Math.floor(H/60)).padStart(2,"0"),V=String(H%60).padStart(2,"0");fe.textContent=` ${C}:${V}`,fe.style.color=j?"#ff2222":"#ff9500",fe.style.fontWeight="900"};me(),e._timerInt=setInterval(()=>{if(H--,H<0)if(!j)j=!0,H=15,me(),qo("/sounds/timer-urgent.mp3",.6);else{clearInterval(e._timerInt),e._timerInt=null,Ke(),e.homeScore=0,e.aiScore=3;const fe=document.createElement("div");fe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",fe.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(fe),setTimeout(()=>{fe.remove(),_t(t,e,i)},2500)}else me()},1e3)}(R=document.getElementById("match-quit"))==null||R.addEventListener("click",()=>{Ve(t),confirm("Abandonner ? Résultat : défaite 3-0")&&(e.homeScore=0,e.aiScore=3,_t(t,e,i))}),(O=document.getElementById("view-ai"))==null||O.addEventListener("click",()=>Fr(e,i)),(Y=document.getElementById("toggle-history"))==null||Y.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.add("open")}),(I=document.getElementById("close-history"))==null||I.addEventListener("click",()=>{var j;(j=document.getElementById("match-history-panel"))==null||j.classList.remove("open")}),(_=document.getElementById("btn-action"))==null||_.addEventListener("click",()=>{e.selected.length!==0&&(u?Sr(t,e,i):y&&Ar(t,e,i))}),(G=document.getElementById("btn-results"))==null||G.addEventListener("click",()=>_t(t,e,i)),(K=document.getElementById("btn-pass"))==null||K.addEventListener("click",()=>{if(e.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),Oi(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="ai-attack",Te(t,e,i),setTimeout(()=>to(t,e,i),800)}),t.querySelectorAll(".match-slot-hit").forEach(j=>{j.addEventListener("click",()=>Tr(j,e,t,i))}),t.querySelectorAll(".match-used-hit").forEach(j=>{j.addEventListener("click",()=>qi(t,e,i,null,j.dataset.cardId))}),t.querySelectorAll(".gc-mini").forEach(j=>{u?j.addEventListener("click",()=>jr(j.dataset.gcId,j.dataset.gcType,t,e,i)):(j.style.opacity="0.35",j.style.cursor="default",j.addEventListener("click",()=>It("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(le=document.getElementById("boost-card"))==null||le.addEventListener("click",()=>Dr(t,e,i)),t.querySelectorAll(".sub-btn-col").forEach(j=>{j.addEventListener("click",()=>qi(t,e,i,j.dataset.subId))}),(ce=document.getElementById("sub-btn-main"))==null||ce.addEventListener("click",()=>qi(t,e,i))}function Tr(t,e,i,o){const r=t.dataset.cardId,n=t.dataset.role,a=e.selected.findIndex(s=>s.cardId===r);if(a!==-1)e.selected.splice(a,1);else{if(e.selected.length>=3){o.toast("Maximum 3 joueurs","error");return}const s=(e.homeTeam[n]||[]).find(c=>c.cardId===r);s&&e.selected.push({...s,_role:n,_line:n})}Te(i,e,o)}function eo(t,e,i){t.matchId&&v.from("matches").update({last_player_id:i}).eq("id",t.matchId).then(()=>{})}function Sr(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),eo(e,i,i.state.profile.id);const o=e.selected.map(n=>{const a=(e.homeTeam[n._role]||[]).find(c=>c.cardId===n.cardId)||n,s=["GK","DEF"].includes(n._role);return{...a,_line:n._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=ai(o,e.modifiers.home,e.formation);e.pendingAttack={...r,players:[...o],side:"home"},e.selected.forEach(n=>{const a=(e.homeTeam[n._role]||[]).find(s=>s.cardId===n.cardId);a&&(a.used=!0)}),e.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${e.selected.map(n=>n.name).join(", ")}`,type:"info"}),e.selected=[],e.modifiers.home={},e.phase="ai-defense",Te(t,e,i),setTimeout(()=>Cr(t,e,i),1200)}function Ar(t,e,i){e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),Ke(),eo(e,i,i.state.profile.id);const o=e.stadiumDef||null,r=e.selected.map(c=>{const d=(e.homeTeam[c._role]||[]).find(m=>m.cardId===c.cardId)||c,l=d.stadiumBonus||o&&(o.club_id&&String(d.club_id)===String(o.club_id)||o.country_code&&d.country_code===o.country_code)||!1;return{...d,_line:c._role,stadiumBonus:l}}),n=si(r,e.modifiers.home,e.formation);e.selected.forEach(c=>{const d=(e.homeTeam[c._role]||[]).find(l=>l.cardId===c.cardId);d&&(d.used=!0)});const a=Zi(e.pendingAttack.total,n.total,e.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(e.pendingAttack.players||[]).map(c=>Ye(c)),homePlayers:e.selected.map(c=>{const d=(e.homeTeam[c._role]||[]).find(l=>l.cardId===c.cardId)||c;return Ye(d)}),homeTotal:n.total,aiTotal:e.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",e.log.push(s);else if(a.goal){e.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${e.pendingAttack.total} > ${n.total})`,e.log.push(s),e.selected=[],e.modifiers.home={},e.pendingAttack=null,Te(t,e,i),tt(s.aiPlayers,e.homeScore,e.aiScore,!1,()=>{Mt(t,e,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${n.total} ≥ ${e.pendingAttack.total})`,e.log.push(s);e.selected=[],e.modifiers.home={},e.pendingAttack=null,Mt(t,e,i,"home-attack")}function zr(t){if(t.aiSubsUsed>=t.aiMaxSubs)return;const e=Object.values(t.aiTeam).flat().filter(c=>c.used);if(!e.length)return;const i=(t.aiSubs||[]).filter(c=>!t.aiUsedSubIds.includes(c.cardId));if(!i.length)return;const o=e[Math.floor(Math.random()*e.length)],r=i.find(c=>c.job===o.job)||i[0],n={...r,used:!1,_line:o._line,_col:o._col},a=t.aiTeam[o._line],s=a.findIndex(c=>c.cardId===o.cardId);s!==-1&&(a[s]=n),t.aiUsedSubIds.push(r.cardId),t.aiSubsUsed++,t.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${o.firstname} ${o.name}`,type:"info"})}function Mr(t){var o;if(!((o=t.aiGcCards)!=null&&o.length))return;const e=t.aiGcCards.filter(r=>!t.aiUsedGc.includes(r.id));if(!e.length||Math.random()>.3)return;const i=e[Math.floor(Math.random()*e.length)];switch(t.aiUsedGc.push(i.id),Me[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(t.aiTeam).flat().filter(n=>!n.used);if(r.length){const n=r[Math.floor(Math.random()*r.length)];n.boost=(n.boost||0)+2}break}case"Boost+3":{const r=Object.values(t.aiTeam).flat().filter(n=>!n.used);if(r.length){const n=r[Math.floor(Math.random()*r.length)];n.boost=(n.boost||0)+3}break}case"Remplacement+":t.aiMaxSubs=(t.aiMaxSubs||3)+1;break;case"Bouclier":t.modifiers.ai.shield=!0;break;case"Nul+1":t.modifiers.ai.drawBonus=(t.modifiers.ai.drawBonus||0)+1;break}t.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function to(t,e,i){eo(e,i,null),zr(e),Mr(e);let o=[...e.aiTeam.MIL||[],...e.aiTeam.ATT||[]].filter(l=>!l.used),r=!1;if(!o.length){const l=[...e.homeTeam.MIL||[],...e.homeTeam.ATT||[]].filter(x=>!x.used),m=Kt(e.homeTeam);if(m||l.length===0){const x=(e.aiTeam.DEF||[]).filter(g=>!g.used),b=(e.aiTeam.GK||[]).filter(g=>!g.used);o=m?x.length?x:b:[...x,...b],r=!0}}const n=Ko(o,"attack",e.difficulty);if(!n.length){Hi(t,e,i);return}r&&n.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const a=ai(n,e.modifiers.ai,e.formation);e.pendingAttack={...a,players:n,side:"ai"},n.forEach(l=>{l.used=!0}),e.log.push({text:`🤖 IA attaque : ${a.total} (${n.map(l=>l.name).join(", ")})`,type:"info"}),e.modifiers.ai={};const s=[...e.homeTeam.GK||[],...e.homeTeam.DEF||[],...e.homeTeam.MIL||[]].filter(l=>!l.used),d=(e.homeSubs||[]).filter(l=>!(e.usedSubIds||[]).includes(l.cardId)).length>0&&e.subsUsed<e.maxSubs;if(s.length===0&&!d){if(n.length===1&&(n[0]._line==="GK"||n[0].job==="GK")&&Kt(e.homeTeam)&&e.homeScore===e.aiScore){e.aiScore++,wi(t,e,i,"ai",n[0]);return}e.aiScore++;const m={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:n.map(x=>Ye(x)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};e.log.push(m),e.pendingAttack=null,Te(t,e,i),tt(m.aiPlayers,e.homeScore,e.aiScore,!1,()=>{Mt(t,e,i,"home-attack")});return}e.phase="defense",Te(t,e,i)}function Cr(t,e,i){var d,l;const o=[...e.aiTeam.GK||[],...e.aiTeam.DEF||[],...e.aiTeam.MIL||[]],r=Ko(o,"defense",e.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(m=>(e.aiTeam[m]||[]).filter(x=>!x.used)).length){const m=((d=e.pendingAttack)==null?void 0:d.players)||[];if(m.length===1&&(m[0]._line==="GK"||m[0].job==="GK")&&e.homeScore===e.aiScore){e.homeScore++,wi(t,e,i,"home",m[0]);return}e.homeScore++;const b={type:"duel",isGoal:!0,homeScored:!0,homePlayers:m.map(g=>Ye(g)),homeTotal:((l=e.pendingAttack)==null?void 0:l.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};e.log.push(b),e.modifiers.ai={},e.pendingAttack=null,Te(t,e,i),tt(b.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}const a=r.length>0?si(r,e.modifiers.ai,e.formation).total:0;r.forEach(m=>{m.used=!0});const s=Zi(e.pendingAttack.total,a,e.modifiers.ai),c={type:"duel",title:"Attaque",homePlayers:(e.pendingAttack.players||[]).map(m=>Ye(m)),aiPlayers:r.map(m=>Ye(m)),homeTotal:e.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)c.text="🛡️ Bouclier IA !",e.log.push(c);else if(s.goal){e.homeScore++,c.isGoal=!0,c.homeScored=!0,c.text=`⚽ BUT ! (${e.pendingAttack.total} > ${a})`,e.log.push(c),e.modifiers.ai={},e.pendingAttack=null,Te(t,e,i),tt(c.homePlayers,e.homeScore,e.aiScore,!0,()=>{Mt(t,e,i,"ai-attack")});return}else c.text=`🧤 IA défend (${a} ≥ ${e.pendingAttack.total})`,e.log.push(c);e.modifiers.ai={},e.pendingAttack=null,Mt(t,e,i,"ai-attack")}function Mt(t,e,i,o){if(e.round++,!an(t,e,i)){if(io(e)){_t(t,e,i);return}if(o==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(a=>!a.used))){Hi(t,e,i);return}e.phase="attack",Te(t,e,i)}else{if(!["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(a=>!a.used))){Hi(t,e,i);return}e.phase="ai-attack",Te(t,e,i),setTimeout(()=>to(t,e,i),800)}}}function Kt(t){return!["GK","DEF","MIL","ATT"].some(e=>(t[e]||[]).some(i=>!i.used))}function Eo(t){const e=(t.GK||[]).some(o=>!o.used),i=["DEF","MIL","ATT"].some(o=>(t[o]||[]).some(r=>!r.used));return e&&!i}function an(t,e,i){if(e.homeScore!==e.aiScore)return!1;if(Eo(e.homeTeam)&&Kt(e.aiTeam)){const o=(e.homeTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.homeScore++,wi(t,e,i,"home",o),!0):!1}if(Eo(e.aiTeam)&&Kt(e.homeTeam)){const o=(e.aiTeam.GK||[]).find(r=>!r.used);return o?(o.used=!0,e.aiScore++,wi(t,e,i,"ai",o),!0):!1}return!1}function wi(t,e,i,o,r){e.log.push({type:"duel",isGoal:!0,homeScored:o==="home",homePlayers:o==="home"?[Ye(r)]:[],aiPlayers:o==="ai"?[Ye(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${o==="home"?"":"adverse "}marque !`});const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(n);const a=(s,c)=>new Promise(d=>{n.innerHTML=`<div style="font-size:32px;font-weight:900;color:${c};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(d,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),n.remove(),e.pendingAttack=null,Te(t,e,i),tt([Ye(r)],e.homeScore,e.aiScore,o==="home",()=>{if(io(e)){_t(t,e,i);return}Mt(t,e,i,o==="home"?"ai-attack":"home-attack")})))()}function io(t){const e=["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(r=>!r.used));return!e&&!i}function Oi(t,e){return!(["MIL","ATT"].some(r=>(t[r]||[]).some(n=>!n.used))||Kt(e)||!["MIL","ATT"].some(r=>(e[r]||[]).some(n=>!n.used)))}function Hi(t,e,i){if(!an(t,e,i)){if(io(e)){_t(t,e,i);return}if(Oi(e.homeTeam,e.aiTeam)&&Oi(e.aiTeam,e.homeTeam)){e.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),_t(t,e,i);return}e.phase="attack",Te(t,e,i)}}function qi(t,e,i,o=null,r=null){var b,g;if(e.phase!=="attack"){It("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(e.usedSubIds||(e.usedSubIds=[]),e.subsUsed>=e.maxSubs){It(`Maximum ${e.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const n=Object.entries(e.homeTeam).flatMap(([p,u])=>(u||[]).filter(y=>y.used).map(y=>({...y,_line:y._line||p}))),a=e.homeSubs.filter(p=>!e.usedSubIds.includes(p.cardId));if(!n.length){It("Aucun joueur utilisé à remplacer");return}if(!a.length){It("Aucun remplaçant disponible");return}let s=Math.max(0,n.findIndex(p=>p.cardId===r));const c=((b=n[s])==null?void 0:b._line)||((g=n[s])==null?void 0:g.job);let d=o?Math.max(0,a.findIndex(p=>p.cardId===o)):Math.max(0,a.findIndex(p=>p.job===c)),l=!1;const m=document.createElement("div");m.id="sub-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function x(){var f,S,$,A,P,R;const p=n[s],u=a[d],y=Math.min(130,Math.round((window.innerWidth-90)/2)),w=Math.round(y*1.35),h=O=>`background:rgba(255,255,255,0.12);border:none;color:${O?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${O?"default":"pointer"};flex-shrink:0`;m.innerHTML=`
    ...
    </div>`,(f=m.querySelector("#sub-close"))==null||f.addEventListener("click",()=>m.remove()),(S=m.querySelector("#out-up"))==null||S.addEventListener("click",()=>{s>0&&(s--,x())}),($=m.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<n.length-1&&(s++,x())}),(A=m.querySelector("#in-up"))==null||A.addEventListener("click",()=>{d>0&&(d--,x())}),(P=m.querySelector("#in-down"))==null||P.addEventListener("click",()=>{d<a.length-1&&(d++,x())});const E=(O,Y,I,_)=>{const G=m.querySelector("#"+O);if(!G)return;let K=0;G.addEventListener("touchstart",le=>{K=le.touches[0].clientY},{passive:!0}),G.addEventListener("touchend",le=>{const ce=le.changedTouches[0].clientY-K;if(Math.abs(ce)<30)return;const j=Y();ce<0&&j<_-1?(I(j+1),x()):ce>0&&j>0&&(I(j-1),x())},{passive:!0})};E("in-panel",()=>d,O=>d=O,a.length),E("out-panel",()=>s,O=>s=O,n.length),(R=m.querySelector("#sub-confirm"))==null||R.addEventListener("click",O=>{if(O.preventDefault(),O.stopPropagation(),l)return;l=!0;const Y=n[s],I=a[d];if(!Y||!I)return;let _=null,G=-1;for(const[le,ce]of Object.entries(e.homeTeam)){const j=(ce||[]).findIndex(H=>H.cardId===Y.cardId);if(j!==-1){_=le,G=j;break}}if(G===-1||!_){It("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),m.remove();return}const K={...I,_line:_,_col:Y._col||0,used:!1,boost:0};e.homeTeam[_].splice(G,1,K),e.usedSubIds||(e.usedSubIds=[]),e.usedSubIds.push(I.cardId),e.subsUsed++,e.selected=[],e.log.push({type:"sub",subSide:"home",clubName:e.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:Ne(Y,_),portrait:Ct(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:I.name,firstname:I.firstname,note:Ne(I,_),portrait:Ct(I),job:I.job,country_code:I.country_code,rarity:I.rarity,clubName:I.clubName,clubLogo:I.clubLogo},text:`🔄 ${I.firstname} ${I.name} remplace ${Y.firstname} ${Y.name}`}),m.remove(),wr(Y,I,()=>Te(t,e,i))})}document.body.appendChild(m),x()}function jr(t,e,i,o,r){var x,b;const n=(o.gcDefs||[]).find(g=>g.name===e),a=Me[e]||{icon:"⚡",desc:"Carte spéciale."},s=(n==null?void 0:n.name)||e,c=(n==null?void 0:n.effect)||a.desc,d=n!=null&&n.image_url?`/icons/${n.image_url}`:null,l=a.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ${nt(s,d,l,c,{width:190})}
    <!-- Boutons -->
    <div style="display:flex;gap:12px;width:190px">
      <button id="gc-back" style="flex:1;padding:13px;border-radius:12px;border:1px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Retour</button>
      <button id="gc-use" style="flex:1;padding:13px;border-radius:12px;border:none;background:#FFD700;color:#000;font-size:14px;font-weight:900;cursor:pointer">Utiliser ⚡</button>
    </div>`,document.body.appendChild(m),(x=m.querySelector("#gc-back"))==null||x.addEventListener("click",()=>m.remove()),(b=m.querySelector("#gc-use"))==null||b.addEventListener("click",()=>{m.remove(),qr(t,e,i,o,r)})}function mi(t,e,i,o,r,n){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function c(){var d,l;a.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(m=>{const x=m._line||m.job||"MIL",b=s.find(p=>p.cardId===m.cardId),g=ze({...m,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:m.boost||0});return`<div class="gc-pick-item" data-cid="${m.cardId}"
          style="position:relative;border-radius:8px;${b?"outline:3px solid #FFD700;outline-offset:2px;":""}cursor:pointer;flex-shrink:0;${m.used?"opacity:0.3;pointer-events:none":""}">
          ${g}
        </div>`}).join("")}
    </div>
    ...
    </div>`,(d=a.querySelector("#gc-picker-close"))==null||d.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(m=>{m.addEventListener("click",()=>{const x=m.dataset.cid,b=t.find(p=>p.cardId===x);if(!b)return;const g=s.findIndex(p=>p.cardId===x);g>-1?s.splice(g,1):s.length<e&&s.push(b),c()})}),(l=a.querySelector("#gc-picker-confirm"))==null||l.addEventListener("click",()=>{a.remove(),n(s)})}c(),document.body.appendChild(a)}const Br={BOOST_STAT:({value:t=1,count:e=1,roles:i=[]},o,r,n)=>{const a=Object.entries(o.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,c])=>c.filter(d=>!d.used).map(d=>({...d,_line:s})));return a.length?(mi(a,e,`Choisir ${e} joueur(s) à booster (+${t})`,r,o,s=>{s.forEach(c=>{const d=(o.homeTeam[c._line]||[]).find(l=>l.cardId===c.cardId);d&&(d.boost=(d.boost||0)+t,o.log.push({text:`⚡ +${t} sur ${d.name}`,type:"info"}))}),Te(r,o,n)}),!0):(o.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Te(r,o,n),!0)},DEBUFF_STAT:({value:t=1,count:e=1,roles:i=[],target:o="ai"},r,n,a)=>{const s=o==="home"?r.homeTeam:r.aiTeam,c=o==="ai"?"adverse":"allié",d=Object.entries(s).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,m])=>m.filter(x=>!x.used).map(x=>({...x,_line:l})));return d.length?(mi(d,e,`Choisir ${e} joueur(s) ${c}(s) à débuffer (-${t})`,n,r,l=>{l.forEach(m=>{const b=((o==="home"?r.homeTeam:r.aiTeam)[m._line]||[]).find(g=>g.cardId===m.cardId);b&&(b.boost=(b.boost||0)-t,r.log.push({text:`🎯 -${t} sur ${b.name}${o==="ai"?" (IA)":""}`,type:"info"}))}),Te(n,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${c} disponible`,type:"info"}),Te(n,r,a),!0)},GRAY_PLAYER:({count:t=1,roles:e=[],target:i="ai"},o,r,n)=>{const a=i==="home"?o.homeTeam:o.aiTeam,s=i==="ai"?"adverse":"allié",c=Object.entries(a).filter(([d])=>!e.length||e.includes(d)).flatMap(([d,l])=>l.filter(m=>!m.used).map(m=>({...m,_line:d})));return c.length?(mi(c,t,`Choisir ${t} joueur(s) ${s}(s) à exclure`,r,o,d=>{d.forEach(l=>{const x=((i==="home"?o.homeTeam:o.aiTeam)[l._line]||[]).find(b=>b.cardId===l.cardId);x&&(x.used=!0,o.log.push({text:`❌ ${x.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Te(r,o,n)}),!0):(o.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),Te(r,o,n),!0)},REVIVE_PLAYER:({count:t=1,roles:e=[]},i,o,r)=>{const n=Object.entries(i.homeTeam).filter(([a])=>!e.length||e.includes(a)).flatMap(([a,s])=>s.filter(c=>c.used).map(c=>({...c,_line:a})));return n.length?(mi(n,t,`Choisir ${t} joueur(s) à ressusciter`,o,i,a=>{a.forEach(s=>{const c=(i.homeTeam[s._line]||[]).find(d=>d.cardId===s.cardId);c&&(c.used=!1,i.log.push({text:`💫 ${c.name} ressuscité !`,type:"info"}))}),Te(o,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Te(o,i,r),!0)},REMOVE_GOAL:({},t)=>(t.aiScore>0?(t.aiScore--,t.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):t.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},t)=>(t.homeScore===t.aiScore?(t.homeScore++,t.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):t.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:t=1},e)=>(e.maxSubs=(e.maxSubs||3)+t,e.log.push({text:`🔄 +${t} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function qr(t,e,i,o,r){o.usedGc.push(t);const n=o.gcDefs||[],a=n.find(c=>c.name===e)||n.find(c=>{var d;return((d=c.name)==null?void 0:d.toLowerCase().trim())===(e==null?void 0:e.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const c=Br[a.effect_type];c?c(a.effect_params||{},o,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(e){case"Double attaque":o.modifiers.home.doubleAttack=!0,o.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":o.modifiers.home.shield=!0,o.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const c=Object.entries(o.homeTeam).flatMap(([d,l])=>(l||[]).filter(m=>m.used).map(m=>({...m,_line:d})));c.length?(c[0].used=!1,o.log.push({text:`💫 ${c[0].name} ressuscité !`,type:"info"})):o.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":o.modifiers.ai.stolenNote=(o.modifiers.ai.stolenNote||0)+1,o.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const c=[...o.aiTeam.ATT||[],...o.aiTeam.MIL||[]].filter(d=>!d.used);if(c.length){const d=c.sort((l,m)=>Ne(m,"ATT")-Ne(l,"ATT"))[0];d.used=!0,o.log.push({text:`❄️ ${d.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":o.maxSubs++,o.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",t).then(()=>{}),s&&Te(i,o,r)}function Dr(t,e,i){const o=Object.values(e.homeTeam).flat().filter(r=>!r.used);if(!o.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${xr[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Ne(r,r._line||r.job)}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const n=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(e.homeTeam[a]||[]).find(c=>c.cardId===n);if(s){s.boost=(s.boost||0)+e.boostCard.value,e.log.push({text:`⚡ Boost +${e.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}e.boostUsed=!0,i.closeModal(),Te(t,e,i)})})}async function _t(t,e,i){var x,b,g,p;Rt(),Ke(),e._timerInt&&(clearInterval(e._timerInt),e._timerInt=null),e.phase="finished";const{state:o}=i,r=e.homeScore>e.aiScore,n=e.homeScore===e.aiScore,a=r?"victoire":n?"nul":"defaite",s=e.isSolo&&((x=e.soloLevelConfig)!=null&&x.reward_credits)&&r?Number(e.soloLevelConfig.reward_credits):Rn(e.mode,a);if(e.isSolo&&r)try{const{data:u}=await v.from("user_solo_progress").select("unlocked_level").eq("user_id",o.profile.id).maybeSingle(),y=(u==null?void 0:u.unlocked_level)||1;e.soloLevel>=y&&await v.from("user_solo_progress").upsert({user_id:o.profile.id,unlocked_level:e.soloLevel+1,updated_at:new Date().toISOString()})}catch(u){console.warn("[Solo] Erreur mise à jour progression:",u.message)}const c="00000000-0000-0000-0000-000000000000";let d=null;if(e.isRankedAI)try{const{data:u}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",o.profile.id).single();if(u){const y=u.mmr??1e3,w=u.mmr_deviation??350,h=u.mmr_volatility??.06,E=r?1:n?.5:0,f=(u.placement_matches??0)<10,S=Mo(y,w,h,y,350,E,f),$=n?null:r?o.profile.id:c;await v.rpc("update_mmr_after_ranked",{p_match_id:e.matchId,p_winner_id:$,p_home_id:o.profile.id,p_away_id:c,p_home_delta:S.delta,p_away_delta:0,p_home_new_rd:S.newRd,p_away_new_rd:350,p_home_new_vol:S.newSigma,p_away_new_vol:.06}),d=S.delta}}catch(u){console.warn("[RankedAI] Erreur mise à jour MMR:",u.message)}e.matchId&&await v.from("matches").update({status:"finished",home_score:e.homeScore,away_score:e.aiScore,winner_id:r?o.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",e.matchId);const l={credits:(o.profile.credits||0)+s,matches_played:(o.profile.matches_played||0)+1};r?l.wins=(o.profile.wins||0)+1:n?l.draws=(o.profile.draws||0)+1:l.losses=(o.profile.losses||0)+1,await v.from("users").update(l).eq("id",o.profile.id),await i.refreshProfile();const m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",m.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:380px;width:100%">
    ...
    </div>`,document.body.appendChild(m),(b=document.getElementById("res-home"))==null||b.addEventListener("click",()=>{m.remove(),Ve(t),i.navigate("home")}),(g=document.getElementById("res-replay"))==null||g.addEventListener("click",async()=>{if(m.remove(),Ve(t),e.isRankedAI){const{data:u}=await v.from("users").select("mmr, mmr_deviation, mmr_volatility, placement_matches").eq("id",i.state.profile.id).single();mt(),i.navigate("match",{matchMode:"ranked",rankedData:{mmr:(u==null?void 0:u.mmr)??1e3,rd:(u==null?void 0:u.mmr_deviation)??350,sigma:(u==null?void 0:u.mmr_volatility)??.06,isPlacement:((u==null?void 0:u.placement_matches)??0)<10}});return}i.navigate("match",e.isSolo?{matchMode:e.mode,soloLevel:e.soloLevel}:{matchMode:e.mode})}),(p=document.getElementById("res-next-level"))==null||p.addEventListener("click",()=>{m.remove(),Ve(t),i.navigate("match",{matchMode:"solo",soloLevel:e.soloLevel+1})})}function Fr(t,e){e.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${Ti(t.aiTeam,t.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Pr={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function Nr(t){const e=t.job||"ATT";return Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0}async function Gr(t,e){!t||!e||await Promise.all([Lo(t,"win"),Lo(e,"loss")])}async function Lo(t,e){const{data:i}=await v.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",t).eq("card_type","player");if(!(i!=null&&i.length))return;const o=i.filter(r=>{var n,a;return((n=r.player)==null?void 0:n.rarity)==="pepite"||((a=r.player)==null?void 0:a.rarity)==="papyte"});o.length&&await Promise.all(o.map(r=>{const n=Pr[r.player.rarity],a=e==="win"?n.win:n.loss,s=r.player.note_min??1,c=r.player.note_max??10,d=Nr(r.player),l=r.current_note??d,m=Math.min(c,Math.max(s,l+a));return v.from("cards").update({current_note:m}).eq("id",r.id)}))}const Pt=t=>tn(t);async function jt(t,e,i,o,r={}){return sn(t,e,i,o,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function Rr(t,e,i){const{data:o}=await v.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!o){e.toast("Match introuvable","error"),e.navigate("home");return}const r=o.home_id===e.state.user.id;let n=null,a=null;if(o.mode==="mini_league"){const{data:s}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(n=s.league_id,a=s.id)}return sn(t,e,i,r,[],[],o.is_ranked||!1,null,null,null,n,a)}async function sn(t,e,i,o,r=[],n=[],a=!1,s=null,c=null,d=null,l=null,m=null){const{state:x,navigate:b,toast:g}=e,p=o?"p1":"p2",u=o?"p2":"p1",y=(r||[]).map(k=>k.id),w=(r||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await v.from("matches").select("*").eq("id",i).single();if(!h){g("Match introuvable","error"),b("home");return}async function E(){var we,ke;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:k,error:L},{data:M,error:B},{data:T},{data:N}]=await Promise.all([v.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),v.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),v.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),v.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",B==null?void 0:B.message,"p1D:",(we=k==null?void 0:k.starters)==null?void 0:we.length,"p2D:",(ke=M==null?void 0:M.starters)==null?void 0:ke.length);const q=ne=>{const Se=Number(ne.evolution_bonus)||0;return{cardId:ne.card_id,position:ne.position,id:ne.id,firstname:ne.firstname,name:ne.surname_real,country_code:ne.country_code,club_id:ne.club_id,job:ne.job,job2:ne.job2,note_g:(Number(ne.note_g)||0)+(ne.job==="GK"||ne.job2==="GK"&&Number(ne.note_g)>0?Se:0),note_d:(Number(ne.note_d)||0)+(ne.job==="DEF"||ne.job2==="DEF"&&Number(ne.note_d)>0?Se:0),note_m:(Number(ne.note_m)||0)+(ne.job==="MIL"||ne.job2==="MIL"&&Number(ne.note_m)>0?Se:0),note_a:(Number(ne.note_a)||0)+(ne.job==="ATT"||ne.job2==="ATT"&&Number(ne.note_a)>0?Se:0),evolution_bonus:Se,rarity:ne.rarity,skin:ne.skin,hair:ne.hair,hair_length:ne.hair_length,face:ne.face||null,clubName:ne.club_encoded_name||null,clubLogo:ne.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},D=((k==null?void 0:k.starters)||[]).map(ne=>q(ne)),U=((M==null?void 0:M.starters)||[]).map(ne=>q(ne)),ee=(k==null?void 0:k.formation)||"4-4-2",oe=(M==null?void 0:M.formation)||"4-4-2";let ie=hi(D,ee),te=hi(U,oe);const ae=((k==null?void 0:k.subs)||[]).map(ne=>q(ne)),de=((M==null?void 0:M.subs)||[]).map(ne=>q(ne)),ve=(k==null?void 0:k.stadium_def)||(o?c:null),ue=(M==null?void 0:M.stadium_def)||(o?null:c);return ve&&(ie=li(ie,ve),yi(ae,ve)),ue&&(te=li(te,ue),yi(de,ue)),{p1Team:ie,p2Team:te,p1Subs:ae,p2Subs:de,p1Formation:ee,p2Formation:oe,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(N==null?void 0:N.club_name)||(N==null?void 0:N.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:o?y:[],gc_p2:o?[]:y,gcCardsFull_p1:o?w:[],gcCardsFull_p2:o?[]:w,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:n||[],lastActionAt:new Date().toISOString()}}let f=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",o,"gameState exists:",!!f,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",x.profile.id),!f)if(o){f=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((f==null?void 0:f.p1Team)||{}));const{data:k}=await v.from("matches").select("game_state").eq("id",i).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await v.from("matches").update({game_state:f,turn_user_id:h.home_id}).eq("id",i):f=k.game_state}else{t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let k=0;k<30&&!f;k++){await new Promise(M=>setTimeout(M,400));const{data:L}=await v.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(f=L.game_state),k%5===0&&console.log("[PvP] away - poll",k,"game_state:",!!(L!=null&&L.game_state))}if(!f){g("Erreur de synchronisation","error"),b("home");return}f.gc_p2=y,f.gcCardsFull_p2=w,await v.from("matches").update({game_state:f}).eq("id",i)}let S=!1,$=null,A=!1;const P=new Set,R=new Set;async function O(k){var oe,ie;Rt();try{v.removeChannel(Y)}catch{}const L=f[p+"Score"]||0,M=f[u+"Score"]||0;let B,T;k.winner_id?(B=k.winner_id===x.profile.id,T=!1):k.forfeit?(B=L>M,T=!1):(T=L===M,B=L>M);let N="";if(a&&o)try{const{data:te}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:ae}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(te&&ae){const de=B?1:T?.5:0,ve=1-de,ue=te.placement_matches<10,we=ae.placement_matches<10,ke=computeGlicko2(te.mmr,te.mmr_deviation,te.mmr_volatility,ae.mmr,ae.mmr_deviation,de===1?1:de===0?0:.5,ue),ne=computeGlicko2(ae.mmr,ae.mmr_deviation,ae.mmr_volatility,te.mmr,te.mmr_deviation,ve===1?1:ve===0?0:.5,we);await v.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:B?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:ke.delta,p_away_delta:ne.delta,p_home_new_rd:ke.newRd,p_away_new_rd:ne.newRd,p_home_new_vol:ke.newSigma,p_away_new_vol:ne.newSigma});const Se=ke.delta,Re=ke.newMmr,Ae=getTier(Re),Xe=Se>=0?"+":"",He=Se>=0?"#4caf50":"#ff6b6b",rt=getTier(te.mmr);N=`
      ...
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(ie=q.querySelector("#pvp-end-home"))==null||ie.addEventListener("click",()=>{q.remove(),Ve(t),l?b("mini-league",{openLeagueId:l}):b(a?"ranked":"home")})}const Y=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{var M;const L=k.new;try{if(L.status==="finished"||L.forfeit){if(S)return;S=!0,$&&(clearInterval($),$=null),Ke(),L.game_state&&(f=L.game_state),O(L);return}if(L.game_state){const B=f;f=L.game_state;const T=f._lastGC;if(T&&T.seq&&!R.has(T.seq)&&(R.add(T.seq),T.by!==p)){C(T.type,T.by,()=>H());return}const N=B[p+"Score"]||0,q=B[u+"Score"]||0,D=f[p+"Score"]||0,U=f[u+"Score"]||0,ee=D>N,oe=U>q;if((ee||oe)&&!P.has(f.round)){P.add(f.round);const ie=[...f.log||[]].reverse().find(de=>de.isGoal),te=((ie==null?void 0:ie.homePlayers)||[]).map(de=>({name:de.name,note:de.note,portrait:de.portrait,job:de.job}));!!((M=ie==null?void 0:ie.text)!=null&&M.includes("DERNIER CORNER"))?ge().then(()=>{tt(te,D,U,ee,()=>H())}):tt(te,D,U,ee,()=>H());return}H()}}catch(B){console.error("[PvP] crash:",B)}}).subscribe();async function I(k){Object.assign(f,k),f.lastActionAt=new Date().toISOString();const{error:L}=await v.from("matches").update({game_state:f}).eq("id",i);L&&g("Erreur de synchronisation","error");try{H()}catch(M){console.error("[PvP] renderPvpScreen crash:",M)}}async function _(){if(S)return;S=!0,Rt(),Ke(),$&&(clearInterval($),$=null);const k=o?h.away_id:h.home_id,L=o?"p2":"p1",M=o?"p1":"p2",B={...f,[L+"Score"]:3,[M+"Score"]:0,phase:"finished"},T=B.p1Score||0,N=B.p2Score||0;try{await v.from("matches").update({game_state:B}).eq("id",i);const{data:q,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:T,p_away_score:N,p_forfeit:!0});if(D&&console.error("[PvP] finish_pvp_match (forfeit):",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(U){console.error("[PvP] check_and_finish_mini_league (forfeit):",U)}try{const{data:U}=await v.rpc("apply_match_rewards",{p_match_id:i});U!=null&&U.success&&!(U!=null&&U.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(U){console.error("[PvP] apply_match_rewards (forfeit):",U)}}catch{}try{v.removeChannel(Y)}catch{}setTimeout(()=>{Ve(t),l?b("mini-league",{openLeagueId:l}):b("home")},800)}const G={BOOST_STAT:({value:k=1,count:L=1,roles:M=[]},B,T)=>{const N=B[p+"Team"],q=Object.entries(N).filter(([D])=>!M.length||M.includes(D)).flatMap(([D,U])=>U.filter(ee=>!ee.used).map(ee=>({...ee,_line:D})));if(!q.length){B.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(B);return}K(q,L,`Choisir ${L} joueur(s) à booster (+${k})`,D=>{D.forEach(U=>{const ee=(N[U._line]||[]).find(oe=>oe.cardId===U.cardId);ee&&(ee.boost=(ee.boost||0)+k,B.log.push({text:`⚡ +${k} sur ${ee.name}`,type:"info"}))}),B[p+"Team"]=N,T(B)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:M=[],target:B="ai"},T,N)=>{const q=B==="home"?p:u,D=T[q+"Team"],U=B==="home"?"allié":"adverse",ee=Object.entries(D).filter(([oe])=>!M.length||M.includes(oe)).flatMap(([oe,ie])=>ie.map(te=>({...te,_line:oe})));if(!ee.length){T.log.push({text:`🎯 Aucun joueur ${U}`,type:"info"}),N(T);return}K(ee,L,`Choisir ${L} joueur(s) ${U}(s) (-${k})`,oe=>{oe.forEach(ie=>{const te=(D[ie._line]||[]).find(ae=>ae.cardId===ie.cardId);te&&(te.boost=(te.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${te.name}`,type:"info"}))}),T[q+"Team"]=D,N(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:M="ai"},B,T)=>{const N=M==="home"?p:u,q=B[N+"Team"],D=M==="home"?"allié":"adverse",U=Object.entries(q).filter(([ee])=>!L.length||L.includes(ee)).flatMap(([ee,oe])=>oe.filter(ie=>!ie.used).map(ie=>({...ie,_line:ee})));if(!U.length){B.log.push({text:`❌ Aucun joueur ${D}`,type:"info"}),T(B);return}K(U,k,`Choisir ${k} joueur(s) ${D}(s) à exclure`,ee=>{const oe="usedCardIds_"+N,ie=new Set(B[oe]||[]);ee.forEach(te=>{const ae=(q[te._line]||[]).find(de=>de.cardId===te.cardId);ae&&(ae.used=!0,ie.add(te.cardId),B.log.push({text:`❌ ${ae.name} exclu !`,type:"info"}))}),B[oe]=[...ie],B[N+"Team"]=q,T(B)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},M,B)=>{const T=M[p+"Team"],N=Object.entries(T).filter(([q])=>!L.length||L.includes(q)).flatMap(([q,D])=>D.filter(U=>U.used).map(U=>({...U,_line:q})));if(!N.length){M.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),B(M);return}K(N,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(D=>{const U=(T[D._line]||[]).find(ee=>ee.cardId===D.cardId);U&&(U.used=!1,M.log.push({text:`💫 ${U.name} ressuscité !`,type:"info"}))}),M[p+"Team"]=T,B(M)})},REMOVE_GOAL:({},k,L)=>{const M=u+"Score";k[M]>0?(k[M]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[u+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,M)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),M(L)},CUSTOM:({},k,L)=>L(k)};function K(k,L,M,B){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let N=[];function q(){var U,ee;const D=k.map(oe=>{const ie=oe._line||oe.job||"MIL",te=N.find(de=>de.cardId===oe.cardId),ae=ze({...oe,_evolution_bonus:0},{width:90,showStad:!0,role:ie,extraNote:oe.boost||0});return`<div class="pp-item" data-cid="${oe.cardId}"
        ...
        </div>`,(U=T.querySelector("#pp-close"))==null||U.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(oe=>{oe.addEventListener("click",()=>{const ie=oe.dataset.cid,te=k.find(de=>de.cardId===ie),ae=N.findIndex(de=>de.cardId===ie);te&&(ae>-1?N.splice(ae,1):N.length<L&&N.push(te),q())})}),(ee=T.querySelector("#pp-confirm"))==null||ee.addEventListener("click",()=>{T.remove(),B(N)})}q(),document.body.appendChild(T)}async function le(k,L){const B=(f["gcCardsFull_"+p]||[]).find(D=>D.id===k),T=(B==null?void 0:B._gcDef)||(f.gcDefs||[]).find(D=>{var U;return D.name===L||((U=D.name)==null?void 0:U.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),N=[...f["usedGc_"+p]||[],k],q={type:L,by:p,seq:(f._gcAnimSeq||0)+1};R.add(q.seq),C(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const U=G[T.effect_type];if(U){const ee={...f};U(T.effect_params||{},ee,async oe=>{oe["usedGc_"+p]=N,oe._lastGC=q,oe._gcAnimSeq=q.seq,await I(oe)});return}}const D={...f};switch(L){case"Remplacement+":D.maxSubs=(D.maxSubs||3)+1,D.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const U=u+"Score";D[U]>0&&(D[U]--,D.log.push({text:"🚫 But annulé",type:"info"}));break}}D["usedGc_"+p]=N,D._lastGC=q,D._gcAnimSeq=q.seq,await I(D)})}function ce(k,L){const M="usedCardIds_"+k,B=new Set(f[M]||[]);L.forEach(T=>B.add(T)),f[M]=[...B]}function j(){for(const k of["p1","p2"]){const L=new Set(f["usedCardIds_"+k]||[]),M=f[k+"Team"];if(M)for(const B of["GK","DEF","MIL","ATT"])(M[B]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function H(){var ro,ao,so,lo,co,po;if(f.phase==="reveal")return pe();if(f.phase==="midfield")return fe();if(f.phase==="finished")return Ge();const k=f[p+"Team"],L=f[u+"Team"];j();const M=f[p+"Score"],B=f[u+"Score"],T=f[p+"Name"],N=f[u+"Name"],q=f.phase===p+"-attack",D=f.phase===p+"-defense",U=Array.isArray(f["selected_"+p])?f["selected_"+p]:[],ee=U.map(J=>J.cardId),oe=window.innerWidth>=700,ie=f[p+"Subs"]||[],te=f["usedSubIds_"+p]||[],ae=ie.filter(J=>!te.includes(J.cardId)),de=f["gcCardsFull_"+p]||[],ve=f["usedGc_"+p]||[],ue=de.filter(J=>!ve.includes(J.id)),we=f.boostOwner===p&&!f.boostUsed,ke=[...k.MIL||[],...k.ATT||[]].filter(J=>!J.used),ne=[...L.MIL||[],...L.ATT||[]].filter(J=>!J.used),Se=!be(L),Re=ke.length===0&&ne.length===0&&!Se,Ae=(k.DEF||[]).filter(J=>!J.used),Xe=(k.GK||[]).filter(J=>!J.used);let He=[];q&&ke.length===0&&(Se?(He=Ae.map(J=>J.cardId),Ae.length===0&&(He=He.concat(Xe.map(J=>J.cardId)))):Re&&(He=[...Ae,...Xe].map(J=>J.cardId)));function rt(J,he,Ce){var je,xt;const Ie=J._gcDef,Ft=(Ie==null?void 0:Ie.name)||J.gc_type,lt=(Ie==null?void 0:Ie.effect)||((je=Me[J.gc_type])==null?void 0:je.desc)||"",Pe=Ie!=null&&Ie.image_url?`/icons/${Ie.image_url}`:null,Oe=((xt=Me[J.gc_type])==null?void 0:xt.icon)||"⚡";return`<div class="pvp-gc-mini" data-gc-id="${J.id}" data-gc-type="${J.gc_type}" style="flex-shrink:0;cursor:pointer">
        ...
        <div style="font-size:${Math.round(he*.09)}px;color:#000;font-weight:900">+${f.boostValue}</div>
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ut(k,f[p+"Formation"],bt,ee,oe?1300:zt(),oe?600:Ot(),He)}
      </div>
    </div>`,st=f[p+"Team"],gn=(()=>{var he,Ce,Ie,Ft,lt;if(D&&((he=f.pendingAttack)!=null&&he.players)){const Pe=f.pendingAttack;let Oe="";if(U.length>0){const je=U.map(Qe=>{const Yt=(st[Qe._role]||[]).find(Mi=>Mi.cardId===Qe.cardId)||Qe,Wt=st[Qe._role]||[],di=Wt.findIndex(Mi=>Mi.cardId===Qe.cardId),zi=dt(Wt.length),Xt=di>=0?zi[di]:Yt._col??1;return{...Yt,_line:Qe._role,_col:Xt}}),xt=si(je,((Ce=f.modifiers)==null?void 0:Ce[p])||{},f[p+"Formation"]);Oe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${et(je.map(Qe=>({...Qe,used:!1})),"#3a7bd5",xt.total,"defense",f[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${et((Pe.players||[]).map(je=>({...je,used:!1})),"#ff6b6b",Pe.total,"attack",f[u+"Formation"])}</div>
          ${Oe}
        </div>`}if(q&&((Ie=f.pendingAttack)!=null&&Ie.players)){const Pe=f.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${et((Pe.players||[]).map(Oe=>({...Oe,used:!1})),"#00ff88",Pe.total,"attack",f[p+"Formation"])}</div>
        </div>`}if(q&&!((Ft=f.pendingAttack)!=null&&Ft.players)&&U.length>0){const Pe=U.map(je=>{const xt=(st[je._role]||[]).find(Xt=>Xt.cardId===je.cardId)||je,Qe=["GK","DEF"].includes(je._role),Yt=st[je._role]||[],Wt=Yt.findIndex(Xt=>Xt.cardId===je.cardId),di=dt(Yt.length),zi=Wt>=0?di[Wt]:xt._col??1;return{...xt,_line:je._role,_col:zi,...Qe?{note_a:Math.max(1,Number(xt.note_a)||0)}:{}}}),Oe=ai(Pe,((lt=f.modifiers)==null?void 0:lt[p])||{},f[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${et(Pe.map(je=>({...je,used:!1})),"#FFD700",Oe.total,"attack",f[p+"Formation"])}</div>
        </div>`}const J=(f.log||[]).slice(-1)[0];return J?'<div style="padding:2px 4px">'+on(J)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),no=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Ut(k,f[p+"Formation"],bt,ee,zt(),Ot(),He)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Dt(){const J=t.querySelector(".match-screen");if(!J)return;const he=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);J.style.height=he+"px",J.style.minHeight=he+"px",J.style.maxHeight=he+"px",J.style.overflow="hidden";const Ce=t.querySelector("#mobile-action-bar"),Ie=t.querySelector("#mobile-play-area");Ce&&Ie&&(Ie.style.paddingBottom=Ce.offsetHeight+"px")}if(Dt(),setTimeout(Dt,120),setTimeout(Dt,400),A||(A=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Dt),window.visualViewport.addEventListener("scroll",Dt)),window.addEventListener("resize",Dt)),function(){const he=t.querySelector("#match-field .terrain-wrapper svg")||t.querySelector(".terrain-wrapper svg");if(!he)return;const Ce=he.closest("#match-terrain-wrap");Ce&&(Ce.style.cssText="position:relative;width:100%;height:100%;padding:0"),he.removeAttribute("width"),he.removeAttribute("height"),he.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",he.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const J=t.querySelector(".terrain-wrapper svg");if(J){const he=J.closest("#match-terrain-wrap");he&&(he.style.cssText="position:relative;width:100%;height:100%;padding:0"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t.querySelectorAll(".match-slot-hit").forEach(J=>{J.addEventListener("click",()=>{if(!q&&!D)return;const he=J.dataset.cardId,Ce=J.dataset.role,Ie=(k[Ce]||[]).find(Oe=>Oe.cardId===he);if(!Ie||Ie.used)return;const Ft=He.includes(he);if(q&&!["MIL","ATT"].includes(Ce)&&!Ft)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const lt=f["selected_"+p],Pe=lt.findIndex(Oe=>Oe.cardId===he);Pe>-1?lt.splice(Pe,1):lt.length<3&&lt.push({...Ie,_role:Ce}),H()})}),t.querySelectorAll(".match-used-hit").forEach(J=>{J.addEventListener("click",()=>X(J.dataset.cardId))}),t.querySelectorAll(".pvp-sub-btn").forEach(J=>{J.addEventListener("click",()=>X())}),(ro=t.querySelector("#pvp-sub-open"))==null||ro.addEventListener("click",()=>X()),t.querySelectorAll(".pvp-gc-mini").forEach(J=>{q?J.addEventListener("click",()=>V(J.dataset.gcId,J.dataset.gcType)):(J.style.opacity="0.35",J.style.cursor="default",J.addEventListener("click",()=>It("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(ao=t.querySelector("#pvp-boost-card"))==null||ao.addEventListener("click",()=>Q()),(so=t.querySelector("#pvp-action"))==null||so.addEventListener("click",J=>{q?J.currentTarget.dataset.pass==="1"||!We(p)?W():$e():D&&Ee()}),(lo=t.querySelector("#pvp-quit"))==null||lo.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&_()}),(co=t.querySelector("#pvp-view-opp"))==null||co.addEventListener("click",()=>F()),(po=t.querySelector("#pvp-toggle-history"))==null||po.addEventListener("click",()=>z()),$&&(clearInterval($),$=null),Ke(),(q||D)&&!S){let J=30,he=!1;const Ce=()=>document.getElementById("pvp-timer"),Ie=()=>{Ce()&&(Ce().textContent=J+"s",Ce().style.color=he?"#ff4444":"#fff")};Ie(),$=setInterval(()=>{J--,J<0?he?(clearInterval($),$=null,Ke(),q&&!We(p)?W():_()):(he=!0,J=15,Ie(),qo("/sounds/timer-urgent.mp3",.6)):Ie()},1e3)}}function pe(){ct(t),t.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${vi(k,f[p+"Name"]||"Vous","#FFD700","me",null)}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
        <div id="pvp-score-me" style="font-size:48px;font-weight:900;color:#D4A017;transition:all .5s ease">0</div>
        <div id="pvp-vs" style="font-size:14px;color:rgba(255,255,255,.4);letter-spacing:3px;opacity:0">VS</div>
        <div id="pvp-score-opp" style="font-size:48px;font-weight:900;color:rgba(255,255,255,.7);transition:all .5s ease">0</div>
      </div>
      ${vi(L,f[u+"Name"]||"Adversaire","#e03030","opp",null)}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const N=(ae,de)=>t.querySelectorAll(ae).forEach((ve,ue)=>{setTimeout(()=>{ve.style.opacity="1",ve.style.transform="translateY(0) scale(1)"},de+ue*90)});N(".duel-card-me",150),N(".duel-card-opp",500),setTimeout(()=>t.querySelectorAll(".duel-link").forEach((ae,de)=>setTimeout(()=>{ae.style.opacity="1"},de*70)),900),setTimeout(()=>{const ae=t.querySelector("#pvp-vs");ae&&(ae.style.opacity="1",ae.style.animation="vsFlash .5s ease"),t.querySelectorAll(".duel-score-line").forEach(de=>de.style.opacity="1")},1250);function q(ae,de,ve){const ue=document.getElementById(ae);if(!ue)return;const we=performance.now(),ke=ne=>{const Se=Math.min(1,(ne-we)/ve);ue.textContent=Math.round(de*(1-Math.pow(1-Se,3))),Se<1?requestAnimationFrame(ke):ue.textContent=de};requestAnimationFrame(ke)}setTimeout(()=>{q("pvp-score-me",M,800),q("pvp-score-opp",B,800)},1500);const D=f.p1Team.MIL||[],U=f.p2Team.MIL||[],ee=vt(D)+wt(D),oe=vt(U)+wt(U),ie=ee>=oe?"p1":"p2";let te=f.boostValue;te==null&&(te=en(),f.boostValue=te,f.boostOwner=ie,f.boostUsed=!1),me=!0,setTimeout(()=>{const ae=t.querySelector("#duel-row-"+(T?"me":"opp")),de=t.querySelector("#duel-row-"+(T?"opp":"me")),ve=document.getElementById("pvp-score-me"),ue=document.getElementById("pvp-score-opp"),we=T?ve:ue,ke=T?ue:ve;we&&(we.style.fontSize="80px",we.style.color=T?"#FFD700":"#ff6b6b",we.style.animation="duelPulse .5s ease"+(T?",duelGlow 1.5s ease infinite .5s":"")),ke&&(ke.style.opacity="0.25"),setTimeout(()=>{ae&&(ae.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",ae.style.zIndex="5"),setTimeout(()=>{const ne=document.getElementById("duel-shock");ne&&(ne.style.animation="shockwave .5s ease-out forwards"),de&&(de.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Ae;const ne=document.getElementById("pvp-duel-finale");if(!ne)return;const Se=f.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+te+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Re=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;ne.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(T?"⚽ "+f[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+f[u+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+Se+Re,ne.style.transition="opacity .45s ease",ne.style.opacity="1",ne.style.pointerEvents="auto",(Ae=document.getElementById("pvp-start-match"))==null||Ae.addEventListener("click",async()=>{const Xe=ie;await I({phase:Xe+"-attack",attacker:Xe,round:1,boostValue:te,boostUsed:!1,boostOwner:Xe})})},600)},700)},2800)}function C(k,L,M){var de,ve;const B=(f.gcDefs||[]).find(ue=>{var we;return ue.name===k||((we=ue.name)==null?void 0:we.toLowerCase().trim())===(k==null?void 0:k.toLowerCase().trim())}),T={purple:"#b06ce0",light_blue:"#00d4ef"}[B==null?void 0:B.color]||"#b06ce0",N=(B==null?void 0:B.name)||k,q=(B==null?void 0:B.effect)||((de=Me[k])==null?void 0:de.desc)||"",D=B!=null&&B.image_url?`/icons/${B.image_url}`:null,U=((ve=Me[k])==null?void 0:ve.icon)||"⚡",oe=L===p?"Vous":f[L+"Name"]||"Adversaire",ie=document.createElement("div");ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",ie.innerHTML=`
      <style>
      ...
      </div>`,document.body.appendChild(M),(B=M.querySelector("#bp-close"))==null||B.addEventListener("click",()=>M.remove()),M.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const N=T.dataset.cid,q=L.find(U=>U.cardId===N);if(!q)return;const D=(k[q._line]||[]).find(U=>U.cardId===N);D&&(D.boost=(D.boost||0)+f.boostValue),M.remove(),await I({[p+"Team"]:k,boostUsed:!0})})})}function X(k=null){var ae,de;if(!(f.phase===p+"-attack")){g("Remplacement uniquement avant votre attaque","warning");return}const M=f[p+"Team"],B=f["usedSubIds_"+p]||[],T=f.maxSubs||3;if(B.length>=T){g(`Maximum ${T} remplacements atteint`,"warning");return}const N=Object.entries(M).flatMap(([ve,ue])=>(ue||[]).filter(we=>we.used).map(we=>({...we,_line:ve}))),q=(f[p+"Subs"]||[]).filter(ve=>!B.includes(ve.cardId));if(!N.length){g("Aucun joueur utilisé à remplacer","warning");return}if(!q.length){g("Aucun remplaçant disponible","warning");return}let D=Math.max(0,N.findIndex(ve=>ve.cardId===k));const U=((ae=N[D])==null?void 0:ae._line)||((de=N[D])==null?void 0:de.job);let ee=Math.max(0,q.findIndex(ve=>ve.job===U)),oe=!1;const ie=document.createElement("div");ie.id="pvp-sub-overlay",ie.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function te(){var Re,Ae,Xe,He,rt,Vt;const ve=N[D],ue=q[ee],we=Math.min(130,Math.round((window.innerWidth-90)/2)),ke=Math.round(we*1.35),ne=Fe=>`background:rgba(255,255,255,0.12);border:none;color:${Fe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Fe?"default":"pointer"};flex-shrink:0`;ie.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${ue?kt({...ue,used:!1,boost:0},we,ke):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${ve?kt({...ve,used:!1,boost:0},we,ke):"<div>—</div>"}</div>
      ...
      <div style="width:min(90vw,420px)">${Ti(f[u+"Team"],f[u+"Formation"],null,[],zt(),Ot())}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(k),(L=k.querySelector("#pvp-opp-close"))==null||L.addEventListener("click",()=>k.remove())}function z(){var M;const k=f.log||[],L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",L.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(M=L.querySelector("#pvp-hist-close"))==null||M.addEventListener("click",()=>L.remove())}async function W(){if(f.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(f.round||0)+1,M=[...f.log||[]];M.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const B=Le(f),T=We(k),N=B||!T?"finished":k+"-attack";await I({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:N,attacker:k,round:L,log:M}),N==="finished"&&await De(f)}function Z(k){const L=(k.GK||[]).some(B=>!B.used),M=["DEF","MIL","ATT"].some(B=>(k[B]||[]).some(T=>!T.used));return L&&!M}function se(k){return(k.p1Score||0)!==(k.p2Score||0)?null:Z(k.p1Team)&&!be(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(L=>!L.used)}:Z(k.p2Team)&&!be(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(L=>!L.used)}:null}async function ge(){const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(k);const L=(M,B)=>new Promise(T=>{k.innerHTML=`<div style="font-size:32px;font-weight:900;color:${B};letter-spacing:2px;animation:lcFade 1.4s ease both">${M}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),k.remove()}async function ye(k,L){const{side:M,gk:B}=k;if(!B)return;const T=M+"Score",N=(L[T]||0)+1;B.used=!0;const q=[...L.log||[]];q.push({type:"duel",isGoal:!0,homeScored:M===p,homePlayers:M==="p1"?[Pt(B)]:[],aiPlayers:M==="p2"?[Pt(B)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[M+"Name"]} marque !`});const D=(L.round||0)+1,U=M==="p1"?"p2":"p1",ee={...L,[T]:N},oe=Le(ee);P.add(D),await ge();const ie=M===p?N:L[p+"Score"]||0,te=M===p?L[u+"Score"]||0:N;tt([Pt(B)],ie,te,M===p,async()=>{await I({[T]:N,log:q,round:D,pendingAttack:null,phase:oe?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),oe&&await De({...f,[T]:N})})}async function $e(){const k=f[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(N=>(f[u+"Team"][N]||[]).some(q=>!q.used)),M=(f["selected_"+p]||[]).map(N=>{const q=(k[N._role]||[]).find(de=>de.cardId===N.cardId)||N,D=["GK","DEF"].includes(N._role),U=k[N._role]||[],ee=U.findIndex(de=>de.cardId===N.cardId),oe=dt(U.length),ie=ee>=0?oe[ee]:q._col??1,te=f.stadiumDef||f.homeStadiumDef||null,ae=q.stadiumBonus||te&&(te.club_id&&String(q.club_id)===String(te.club_id)||te.country_code&&q.country_code===te.country_code)||!1;return{...q,_line:N._role,_col:ie,stadiumBonus:ae,...D?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!M.length)return;const B=ai(M,f.modifiers[p]||{},f[p+"Formation"]);ce(p,M.map(N=>N.cardId)),M.forEach(N=>{const q=(k[N._role]||[]).find(D=>D.cardId===N.cardId);q&&(q.used=!0)}),f["selected_"+p]=[],H();const T=[...f.log||[]];if(L){if(M.length===1&&(M[0]._line==="GK"||M[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await ye({side:p,gk:M[0]},{...f,[p+"Team"]:k,log:T});return}const q=(f[p+"Score"]||0)+1,D=M.map(te=>Pt(te));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:D,homeTotal:B.total,aiTotal:0});const U=(f.round||0)+1,ee=p==="p1"?"p2":"p1",oe={...f,[p+"Team"]:k,[p+"Score"]:q},ie=Le(oe);P.add(U),tt(D,q,f[u+"Score"]||0,!0,async()=>{await I({[p+"Team"]:k,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:ie?"finished":ee+"-attack",attacker:ee,round:U,log:T}),ie&&await De({...f,[p+"Score"]:q})});return}T.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${B.total})`}),await I({[p+"Team"]:k,[u+"Team"]:f[u+"Team"],pendingAttack:{...B,players:M,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Ee(){const k=f[p+"Team"],L=(f["selected_"+p]||[]).map(ue=>{const we=(k[ue._role]||[]).find(Ae=>Ae.cardId===ue.cardId)||ue,ke=k[ue._role]||[],ne=ke.findIndex(Ae=>Ae.cardId===ue.cardId),Se=dt(ke.length),Re=ne>=0?Se[ne]:we._col??1;return{...we,_line:ue._role,_col:Re}}),M=si(L,f.modifiers[p]||{},f[p+"Formation"]);ce(p,L.map(ue=>ue.cardId)),L.forEach(ue=>{const we=(k[ue._role]||[]).find(ke=>ke.cardId===ue.cardId);we&&(we.used=!0)}),f["selected_"+p]=[],H();const B=Zi(f.pendingAttack.total,M.total,f.modifiers[p]||{}),T=f.pendingAttack.side,N=B==="attack"||(B==null?void 0:B.goal),q=T==="p1"?"p2":"p1",D=(f.round||0)+1,U=(f.pendingAttack.players||[]).map(ue=>Pt(ue)),ee=[...f.log||[]];ee.push({type:"duel",isGoal:N,homeScored:N&&T===p,text:N?`⚽ BUT de ${f[T+"Name"]} ! (${f.pendingAttack.total} vs ${M.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${M.total})`,homePlayers:U,aiPlayers:L.map(ue=>Pt(ue)),homeTotal:f.pendingAttack.total,aiTotal:M.total});const oe=N?(f[T+"Score"]||0)+1:f[T+"Score"]||0,ie={...f,[p+"Team"]:k,[T+"Score"]:oe},te=Le(ie),ae=te?"finished":q+"-attack",de=!te&&!N?se(ie):null,ve=async()=>{if(de){await ye(de,ie);return}await I({[p+"Team"]:k,[u+"Team"]:f[u+"Team"],[T+"Score"]:oe,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:q,round:D,log:ee}),(ae==="finished"||te)&&await De({...f,[T+"Score"]:oe})};if(N){const ue=T===p,we=ue?oe:f[p+"Score"]||0,ke=ue?f[u+"Score"]||0:oe;P.add(D),tt(U,we,ke,ue,ve)}else await ve()}function xe(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(M=>!M.used))}function be(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(M=>!M.used))}function Be(k){return be(k)&&!xe(k)}function We(k){const L=f[k+"Team"],M=f[(k==="p1"?"p2":"p1")+"Team"];return!!(xe(L)||Be(L)&&!be(M)||Be(L)&&!xe(M)&&be(M))}function Le(k){return!be(k.p1Team)&&!be(k.p2Team)}function qe(k){const L=k.p1Score||0,M=k.p2Score||0;return L===M?null:L>M?h.home_id:h.away_id}async function De(k){Rt(),Ke();try{const L=qe(k),M=L?h.home_id===L?h.away_id:h.home_id:null,B=k.p1Score||0,T=k.p2Score||0,{data:N,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:B,p_away_score:T,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(D){console.error("[PvP] check_and_finish_mini_league:",D)}L&&M&&Gr(L,M).catch(()=>{});try{const{data:D}=await v.rpc("apply_match_rewards",{p_match_id:i});D!=null&&D.success&&!(D!=null&&D.skipped)&&typeof e.refreshProfile=="function"&&await e.refreshProfile()}catch(D){console.error("[PvP] apply_match_rewards:",D)}if(typeof d=="function")try{await d({homeScore:B,awayScore:T,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(D){console.error("[PvP] onMatchEnd:",D)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Ge(){var T;const k=f[p+"Score"],L=f[u+"Score"],M=k>L,B=k===L;ct(t),t.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(Y)}catch{}Ve(t),l?b("mini-league",{openLeagueId:l}):b("home")})}H()}async function Ui(t,e,i=!1){var s,c;const{state:o,navigate:r,toast:n}=e,a=i&&((c=(s=e==null?void 0:e.state)==null?void 0:s.params)==null?void 0:c.rankedData)||null;await Si(t,e,i?"ranked":"random",async({deckId:d,formation:l,starters:m,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{await Hr(t,e,d,l,m,x,y||[],g,p,i,a)};if(!(b!=null&&b.length)){await u([]);return}Ii(t,b,u)})}async function Or(t,e,i){return Rr(t,e,i)}async function Hr(t,e,i,o,r,n,a=[],s=[],c=null,d=!1,l=null){var O,Y;const{state:m,navigate:x,toast:b}=e,g=(l==null?void 0:l.mmr)??((O=m.profile)==null?void 0:O.mmr)??1e3,p=d?ki(g):null,u=d?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",y=d?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let w=!1,h=null,E=null;t.innerHTML=`
    ...
    </div>`;const f=async()=>{w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}};(Y=document.getElementById("cancel-mm"))==null||Y.addEventListener("click",async()=>{await f(),Ve(t),x("home")});const S=async(I,_)=>{w||(w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await jt(t,e,I,_,{myGC:a,gcDefs:s,stadiumDef:c,isRanked:d,rankedData:l,onMatchEnd:d?Ur:null}))},$=m.user.id,{data:A,error:P}=d?await v.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:g,p_range:200}):await v.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(P||!(A!=null&&A.success)){console.error("[Matchmaking] try_matchmake error:",P||A),b("Erreur de matchmaking","error"),Ve(t),x("home");return}if(A.matched){await S(A.match_id,!1);return}const R=async()=>{if(w)return;const{data:I}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(I==null?void 0:I.status)==="matched"&&I.match_id&&await S(I.match_id,!0)};h=v.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},I=>{const _=I.new;_.status==="matched"&&_.match_id&&S(_.match_id,!0)}).subscribe(),E=setInterval(R,3e3),d?setTimeout(async()=>{if(!w){w=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(I){console.error("[Matchmaking] cancel error:",I)}b("Aucun adversaire trouvé — match contre une IA calibrée sur votre niveau","info",4e3),x("match",{matchMode:"ranked_ai",rankedData:l,presetSetup:{deckId:i,formation:o,starters:r,subsRaw:n,gcCardsEnriched:a,gcDefs:s,stadiumDef:c}})}},2e4):setTimeout(()=>{w||f()},12e4)}async function Ur(t,e){const{state:i,toast:o}=e,{winnerId:r,homeId:n,awayId:a,homeScore:s,awayScore:c,matchId:d}=t,l=i.user.id,m=n===l,x=r===l,{data:b}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",m?a:n).single();if(b&&g){const p=Mo(b.mmr,b.mmr_rd,b.mmr_v,g.mmr,g.mmr_rd,x?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",l),o(x?`+MMR ↑ ${Math.round(p.mmr-b.mmr)}`:`-MMR ↓ ${Math.round(b.mmr-p.mmr)}`,x?"success":"error",4e3)}}const Kr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ui,resumePvpMatch:Or},Symbol.toStringTag,{value:"Module"}));async function Vr(t,e){const{state:i,navigate:o,toast:r}=e,n=i.params||{},a=n.friendId||null,s=n.friendName||"Ami",c=!!n.isAccepting;await Si(t,e,"friend",async({deckId:d,formation:l,starters:m,subsRaw:x,gcCardsEnriched:b,gcDefs:g,stadiumDef:p})=>{ct(t);const u=async y=>{const w=y||[];c?await Wr(t,e,d,w,g,p):await Yr(t,e,d,w,g,p,a,s)};if(!(b!=null&&b.length)){await u([]);return}Ii(t,b,u)})}async function Yr(t,e,i,o,r,n,a,s){var w;const{state:c,navigate:d,toast:l}=e,m=c.user.id,{data:x,error:b}=await v.from("friend_match_invites").insert({inviter_id:m,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(b||!x){console.error("[Friend] Erreur création invitation:",b),l("Impossible de créer l'invitation","error"),d("home");return}t.innerHTML=`
    ...
    </div>`;let g=!1,p=null;const u=async()=>{p&&(p.unsubscribe(),p=null)};(w=document.getElementById("cancel-friend"))==null||w.addEventListener("click",async()=>{await u(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",x.id),Ve(t),d("home")}),p=v.channel(`friend_invite_${x.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${x.id}`},async({new:h})=>{g||h.status!=="accepted"||!h.match_id||(g=!0,await u(),await jt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))}).subscribe();const y=setInterval(async()=>{if(g)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",x.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(g=!0,clearInterval(y),await u(),await jt(t,e,h.match_id,!0,{myGC:o,gcDefs:r,stadiumDef:n}))},3e3);setTimeout(async()=>{g||(clearInterval(y),await u(),l("Invitation expirée","info"),d("home"))},12e4)}async function Wr(t,e,i,o,r,n){const{state:a,navigate:s,toast:c}=e,d=a.user.id,{data:l}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",d).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!l){c("Aucune invitation en attente","error"),s("home");return}const{data:m,error:x}=await v.rpc("accept_friend_invite",{p_invite_id:l.id,p_invitee_deck_id:i});if(x||!(m!=null&&m.success)){console.error("[Friend] Erreur accept_friend_invite:",x||m),c((m==null?void 0:m.error)||"Impossible de rejoindre le match","error"),s("home");return}await jt(t,e,m.match_id,!1,{myGC:o,gcDefs:r,stadiumDef:n})}const ln="#1A6B3C",pt="#D4A017",Zt="var(--tile-bg)",ei="var(--tile-border)",St="var(--divider)",Ze="var(--tile-fg-on-page)",Tt="var(--tile-fg-dim)",it="var(--tile-fg-faint)",ii="var(--nav-fg,#fff)",dn="rgba(255,255,255,0.62)",Xr="rgba(255,255,255,0.4)";async function Jr(t,e){var o;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(o=e.state.params)==null?void 0:o.openLeagueId;if(i){e.state.params.openLeagueId=null,await ft(t,e,i);return}await ot(t,e)}async function ot(t,e,i="waiting"){var h,E;const{state:o}=e,r=o.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(n||[]).map(f=>f.league_id),s={};(n||[]).forEach(f=>{s[f.league_id]={amount:f.prize_amount,claimed:f.prize_claimed}});const{data:c,error:d}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),l=d?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:c||[],x=(a.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],b=x.filter(f=>f.status==="waiting"&&!f.is_archived),g=x.filter(f=>f.status==="active"&&!f.is_archived),p=x.filter(f=>f.is_archived||f.status==="finished");let u=p;if(p.length){const{data:f}=await v.from("mini_league_matches").select("league_id").in("league_id",p.map($=>$.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),S=new Set((f||[]).map($=>$.league_id));u=p.filter($=>S.has($.id))}const y=l.filter(f=>!a.includes(f.id)),w=[{key:"waiting",label:"🟡 En attente",count:b.length+y.length},{key:"active",label:"🟢 En cours",count:g.length},{key:"archived",label:"📁 Archivées",count:u.length}];t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${St}">
      ${w.map(f=>`<button class="ml-tab" data-tab="${f.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===f.key?ln:"transparent"};background:none;font-size:12px;font-weight:${i===f.key?"900":"600"};color:${i===f.key?"#4ade80":Xr};cursor:pointer">${f.label}${f.count?` (${f.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?Qr(b,y,r):i==="active"?Zr(g,r):ea(u,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>ta(t,e)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>ot(t,e,i)),t.querySelectorAll(".ml-tab").forEach(f=>f.addEventListener("click",()=>ot(t,e,f.dataset.tab))),t.querySelectorAll("[data-league-id]").forEach(f=>f.addEventListener("click",()=>ft(t,e,f.dataset.leagueId))),t.querySelectorAll("[data-join]").forEach(f=>f.addEventListener("click",S=>{S.stopPropagation(),cn(t,e,f.dataset.join,f.dataset.type)})),t.querySelectorAll("[data-delete]").forEach(f=>f.addEventListener("click",S=>{S.stopPropagation(),Ki(t,e,f.dataset.delete,f.dataset.name,i)})),t.querySelectorAll("[data-claim-league]").forEach(f=>f.addEventListener("click",async S=>{S.stopPropagation(),f.disabled=!0,f.textContent="...";const{data:$,error:A}=await v.rpc("claim_mini_league_prize",{p_league_id:f.dataset.claimLeague,p_user_id:o.profile.id});if(A||!($!=null&&$.success)){e.toast(($==null?void 0:$.error)||"Erreur lors de la récupération","error"),ot(t,e,i);return}if(!$.already_claimed){o.profile.credits=(o.profile.credits||0)+$.prize;const P=document.getElementById("nav-credits");P&&(P.textContent=`💰 ${o.profile.credits.toLocaleString("fr")}`),e.toast(`💰 +${$.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}ot(t,e,i)}))}function _i(t,e,i=!1,o=null){var c,d;const r=t.creator_id===e,n=t.pot||0,a=((d=(c=t.mini_league_members)==null?void 0:c[0])==null?void 0:d.count)||0,s=o&&o.amount>0&&!o.claimed;return`<div data-league-id="${t.id}" style="background:${Zt};border:1px solid ${s?"rgba(212,160,23,0.5)":ei};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
  ...
  </div>`}function Qr(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(r=>_i(r,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${it};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(r=>_i(r,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${it}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function Zr(t,e){return t.length?t.map(i=>_i(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league en cours.</div>`}function ea(t,e,i={}){return t.length?t.map(o=>_i(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${it}">Aucune mini league archivée.</div>`}function ta(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(o=>o.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=o.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var g,p,u,y;const{toast:o}=e,r=document.getElementById("ml-name").value.trim(),n=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,s=((g=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:g.value)||"public",c=((p=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:p.value)||"aller",d=((y=(u=document.getElementById("ml-pwd"))==null?void 0:u.value)==null?void 0:y.trim())||null;if(!r){o("Le nom est obligatoire","error");return}if(a<100){o("Mise minimum : 100 crédits","error");return}if(s==="private"&&!d){o("Mot de passe requis","error");return}const{data:l,error:m}=await v.from("mini_leagues").insert({name:r,creator_id:e.state.profile.id,type:s,password:d,mode:c,max_players:n,entry_fee:a}).select().single();if(m){o("Erreur : "+m.message,"error");return}const{data:x}=await v.from("users").select("credits").eq("id",e.state.profile.id).single();if(((x==null?void 0:x.credits)||0)<a){await v.from("mini_leagues").delete().eq("id",l.id),o(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:x.credits-a}).eq("id",e.state.profile.id),await v.from("mini_leagues").update({pot:a}).eq("id",l.id),await v.from("mini_league_members").insert({league_id:l.id,user_id:e.state.profile.id}),e.state.profile&&(e.state.profile.credits=x.credits-a);const b=document.getElementById("nav-credits");b&&(b.textContent=`💰 ${(e.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),o(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),ft(t,e,l.id)})}function ia(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",e.innerHTML=`
      ...
      </div>`,document.body.appendChild(e);const i=e.querySelector("#ml-pwd-input"),o=r=>{e.remove(),t(r)};setTimeout(()=>i==null?void 0:i.focus(),80),e.querySelector("#pwd-cancel").addEventListener("click",()=>o(null)),e.querySelector("#pwd-ok").addEventListener("click",()=>o(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&o(i.value.trim())})})}async function cn(t,e,i,o){var m;const{toast:r,state:n}=e,a=n.profile.id;let s=null;if(o==="private"&&(s=await ia(),s===null))return;const{data:c,error:d}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(d||!(c!=null&&c.success)){console.error("[MiniLeague] join_mini_league:",d||c),r((c==null?void 0:c.error)||"Erreur lors de l'inscription","error");return}if(typeof e.refreshProfile=="function")await e.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",a).single();n.profile&&x&&(n.profile.credits=x.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((m=n.profile)==null?void 0:m.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),ft(t,e,i)}async function oa(t,e,i,o){const{toast:r,state:n}=e,a=n.profile.id;if(!await new Promise(x=>{const b=document.createElement("div");b.className="modal-overlay",b.style.zIndex="2100",b.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(b),b.querySelector("#lv-ok").onclick=()=>{b.remove(),x(!0)},b.querySelector("#lv-cancel").onclick=()=>{b.remove(),x(!1)}}))return;const{data:c,error:d}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(d||!(c!=null&&c.success)){r((c==null?void 0:c.error)||"Erreur lors de la désinscription","error");return}const l=c.refund||o;n.profile&&(n.profile.credits=(n.profile.credits||0)+l);const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(n.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),ot(t,e,"waiting")}async function Ki(t,e,i,o,r){const{toast:n}=e;if(!confirm(`Supprimer définitivement "${o}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){n("Erreur suppression ("+a.message+")","error");return}n("Mini League supprimée avec succès","success"),ot(t,e,r)}async function na(t,e,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),e.toast("Mini League archivée","success"),ot(t,e,"archived")}async function ft(t,e,i){var E,f,S,$,A,P,R,O,Y;const{state:o,toast:r}=e,n=o.profile.id,[{data:a},{data:s},{data:c}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await ot(t,e);return}const d=(s||[]).some(I=>I.user_id===n),l=a.creator_id===n,m=(s||[]).map(I=>I.user).filter(Boolean),x=da(m,c||[]),b=(c||[]).filter(I=>I.matchday===a.current_day),g=a.pot||0,p=a.entry_fee||100,u=b.length>0&&b.every(I=>I.status==="finished"||I.status==="bye"),y=a.current_day>=a.total_days,w=(s||[]).find(I=>I.user_id===n);t.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${Ze}">👥 Joueurs (${m.length}/${a.max_players})</div>
        <div style="font-size:12px;color:${Tt};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*m.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*m.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*m.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*m.length*.1).toLocaleString("fr")})</div>
        ${m.map(I=>`
      ...
      <div style="background:${Zt};border:1px solid ${ei};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(I,_)=>_+1).reverse().map(I=>{const _=(c||[]).filter(G=>G.matchday===I);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${it};margin-bottom:6px">Journée ${I}</div>${_.map(G=>Io(G,m,n,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>ot(t,e,h)),(f=document.getElementById("ml-refresh"))==null||f.addEventListener("click",async I=>{const _=I.currentTarget;_.style.opacity="0.5",await ft(t,e,i)}),(S=document.getElementById("ml-start-btn"))==null||S.addEventListener("click",()=>ra(t,e,a,m)),($=document.getElementById("ml-next-day"))==null||$.addEventListener("click",()=>aa(t,e,i)),(A=document.getElementById("ml-join-now"))==null||A.addEventListener("click",()=>cn(t,e,i,a.type)),(P=document.getElementById("ml-leave-btn"))==null||P.addEventListener("click",()=>oa(t,e,i,p)),(R=document.getElementById("ml-delete-btn"))==null||R.addEventListener("click",()=>Ki(t,e,i,a.name,"waiting")),(O=document.getElementById("ml-delete-now"))==null||O.addEventListener("click",()=>Ki(t,e,i,a.name,h)),(Y=document.getElementById("ml-archive-btn"))==null||Y.addEventListener("click",()=>na(t,e,i)),t.querySelectorAll("[data-play-match]").forEach(I=>{I.addEventListener("click",()=>{const _=b.find(G=>G.id===I.dataset.playMatch);_&&(mt(),e.navigate("match-mini-league",{mlMatchId:_.id,leagueId:i}))})}),a.status==="finished"&&w){const I=x.findIndex(_=>_.userId===n);I>=0&&I<3&&w.prize_amount>0&&!w.prize_claimed&&setTimeout(()=>sa(t,e,a,w,I),400)}}function Io(t,e,i,o,r=!1){const n=m=>e.find(x=>x.id===m);if(t.is_bye){const m=n(t.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${Tt};text-align:center">🔵 ${(m==null?void 0:m.club_name)||(m==null?void 0:m.pseudo)||"?"} exempté(e)</div>`}const a=n(t.home_id),s=n(t.away_id),c=t.home_id===i||t.away_id===i,d=c&&t.status==="pending"&&o&&!r,l=t.status==="finished"?`${t.home_score} - ${t.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${c?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${c?"rgba(74,222,128,0.35)":St}">
  ...
  </div>`}async function ra(t,e,i,o){const{toast:r,state:n}=e,a=la(o.map(d=>d.id),i.mode),s=[];a.forEach((d,l)=>d.forEach(m=>s.push({league_id:i.id,matchday:l+1,home_id:m.home||m.bye,away_id:m.away||null,is_bye:!!m.bye,status:m.bye?"bye":"pending"})));const{error:c}=await v.from("mini_league_matches").insert(s);if(c){r("Erreur calendrier : "+c.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),ft(t,e,i.id)}async function aa(t,e,i){const{data:o}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(o.current_day||0)+1;if(r>(o.total_days||0)){ft(t,e,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),e.toast(`Journée ${r} commencée !`,"success"),ft(t,e,i)}async function sa(t,e,i,o,r){var x,b;const{state:n,toast:a}=e,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],c=["🥇","🥈","🥉"][r],d=o.prize_amount||s[r]||0,l=o.prize_claimed,m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",m.innerHTML=`
    ...
    </div>`;let l=!1;const m=async u=>{if(!l){if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}u&&await jt(t,e,u,r,{mlLeagueId:o,mlMatchId:i,myGC:n||[],gcDefs:a,stadiumDef:s}),c()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(g),b)try{b.unsubscribe()}catch{}d("mini-league",{openLeagueId:o}),c()});const x=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&m(u.match_id)},b=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var y;(y=u.new)!=null&&y.match_id&&m(u.new.match_id)}).subscribe(),g=setInterval(x,3e3);x()})}const pa="/",ua=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function fa(t,e,i){let o=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const n=()=>{var l,m,x;const s=e[o],c=o===e.length-1,d=Math.round((o+1)/e.length*100);r.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let c="buy";const d=()=>{var p,u,y,w,h,E,f;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((y=document.getElementById("flt-country"))==null?void 0:y.value)||"").toLowerCase().trim(),job:((w=document.getElementById("flt-job"))==null?void 0:w.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((f=document.getElementById("flt-note2"))==null?void 0:f.value)||0}};function l(p){const u=d();return p.filter(y=>{var P,R,O;const w=(P=y.card)==null?void 0:P.player;if(!w)return!1;const h=`${w.firstname} ${w.surname_real}`.toLowerCase(),E=(((R=w.clubs)==null?void 0:R.encoded_name)||"").toLowerCase(),f=(w.country_code||"").toLowerCase(),S=((O=y.card)==null?void 0:O.evolution_bonus)||0,$=gi(w,w.job,S),A=w.job2?gi(w,w.job2,S):0;return!(u.name&&!h.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!f.includes(u.country)||u.job&&w.job!==u.job||u.rarity&&w.rarity!==u.rarity||u.note1&&$<u.note1||u.note2&&A<u.note2)})}function m(p){var E,f,S;const u=(E=p.card)==null?void 0:E.player;if(!u)return"";const y=((f=p.card)==null?void 0:f.evolution_bonus)||0,w=(i.profile.credits||0)>=p.price;return`<div class="mkt-buy-tile">
    ...
    </div>`}function x(p){var R,O,Y,I;const u=(R=p.card)==null?void 0:R.player;if(!u)return"";const y=((O=p.card)==null?void 0:O.evolution_bonus)||0,w=gi(u,u.job,y),h=u.job2?gi(u,u.job2,y):0,E=p.status==="sold",f=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,S=So[u.job]||"#bbb",$=u.job2?So[u.job2]||"#bbb":null,A=u.job==="GK"?"#fff":S,P=u.job2==="GK"?"#fff":$;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
    ...
    </div>`}function b(){const p=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(p){if(u.style.display=c==="buy"?"flex":"none",c==="buy"){const y=l(a);p.innerHTML=y.length?`<div class="mkt-buy-grid">${y.map(m).join("")}</div>`:'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const y=s.filter(h=>h.status==="active").sort((h,E)=>new Date(E.listed_at)-new Date(h.listed_at)),w=s.filter(h=>h.status==="sold").sort((h,E)=>new Date(E.sold_at||E.listed_at)-new Date(h.sold_at||h.listed_at));p.innerHTML=(y.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${y.length})</div>`+y.map(x).join(""):"")+(w.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${w.length})</div>`+w.map(x).join(""):"")+(!y.length&&!w.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(y=>y.addEventListener("click",()=>ba(y.dataset.buy,a,t,e))),p.querySelectorAll("[data-cancel]").forEach(y=>y.addEventListener("click",()=>ya(y.dataset.cancel,t,e)))}}t.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{c=p.dataset.tab,t.querySelectorAll(".mkt-tab").forEach(u=>{const y=u===p;u.style.background=y?"var(--green)":"var(--tile-bg)",u.style.color=y?"#fff":"var(--tile-fg-dim)",u.style.borderColor=y?"var(--green)":"var(--tile-border)"}),b()})});let g;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var u;(u=document.getElementById(p))==null||u.addEventListener("input",()=>{clearTimeout(g),g=setTimeout(b,250)})}),b()}async function ba(t,e,i,o){const{state:r,toast:n,refreshProfile:a}=o,s=e.find(l=>l.id===t);if(!s)return;const c=s.price;if((r.profile.credits||0)<c){n("Crédits insuffisants","error");return}xa(s,async()=>{const{error:l}=await v.rpc("buy_market_card",{p_listing_id:t,p_buyer_id:r.profile.id});if(l){n("Erreur achat : "+l.message,"error");return}await a();const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),n("✅ Carte achetée !","success"),await oo(i,o)})}function xa(t,e){var a;const i=(a=t.card)==null?void 0:a.player,o=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
  ...
  <div class="page">
  ...
  </div>`,m(),(p=document.getElementById("tab-ranked"))==null||p.addEventListener("click",()=>{c="ranked",m()}),(u=document.getElementById("tab-mini-league"))==null||u.addEventListener("click",()=>{c="mini-league",m()}),(y=document.getElementById("tab-random"))==null||y.addEventListener("click",()=>{c="random",m()})}async function va(t,e){var S,$,A,P;const{state:i,navigate:o,toast:r}=e,n=i.profile;t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:a},{data:s}]=await Promise.all([v.from("ranked_seasons").select("*").eq("is_active",!0).maybeSingle(),v.from("users").select("id,pseudo,club_name,mmr,mmr_deviation,mmr_volatility,rank_tier,placement_matches,ranked_wins,ranked_losses,ranked_draws").eq("id",n.id).single()]);if(!s){r("Erreur chargement profil","error"),o("home");return}if(!a){t.innerHTML=`
    ...
    </div>`,(S=document.getElementById("ranked-back"))==null||S.addEventListener("click",()=>o("home"));return}const c=s.mmr??1e3,d=s.mmr_deviation??350,l=s.mmr_volatility??.06,m=s.placement_matches??0,x=m<10,b=Math.max(0,10-m),g=ki(c),p=zo(c),u=Ci.findIndex(R=>R.id===g.id),y=Ci[u+1]||null,w={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,f=Ci.map(R=>`
  ...
  </div>`,($=document.getElementById("ranked-back"))==null||$.addEventListener("click",()=>o("home")),(A=document.getElementById("ranked-leaderboard-btn"))==null||A.addEventListener("click",()=>o("rankings",{tab:"ranked"})),(P=document.getElementById("ranked-play-btn"))==null||P.addEventListener("click",()=>{mt(),o("match",{matchMode:"ranked",rankedData:{mmr:c,rd:d,sigma:l,isPlacement:x}})})}async function wa(t,{state:e,navigate:i,toast:o}){const r=e.profile;if(!r)return;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:n}=await v.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
      home:users!home_id(pseudo,club_name),
      away:users!away_id(pseudo,club_name)`).or(`home_id.eq.${r.id},away_id.eq.${r.id}`).order("created_at",{ascending:!1}).limit(50),a={vs_ai_easy:"IA Facile",vs_ai_medium:"IA Moyen",vs_ai_hard:"IA Difficile",vs_ai_club:"IA Club",friend_challenge:"Défi ami",championship:"Championnat",vs_random:"Match Random"},s=(n||[]).filter(l=>l.status==="finished"),c=(n||[]).filter(l=>l.status==="in_progress");function d(l){const m=l.home_id===r.id;m?l.home_score:l.away_score,m?l.away_score:l.home_score;const x=l.winner_id===r.id,b=l.home_score===l.away_score&&l.status==="finished",g=l.status!=="finished"?"…":b?"N":x?"V":"D",p=l.status!=="finished"||b?"#888":x?"#1A6B3C":"#c0392b";let u=a[l.mode]||l.mode;l.away_id===null&&!u.startsWith("IA")&&(u="IA");const w=l.home_id===r.id?l.away:l.home;let h;l.away_id===null?h=u:w?h=`${w.club_name||w.pseudo} (${w.pseudo})`:h="Adversaire";let E="";l.status==="in_progress"&&Date.now()-new Date(l.created_at).getTime()>3600*1e3&&(E=' <span style="color:#e67e22;font-weight:700">(VAR en cours)</span>');const f=new Date(l.created_at),S=f.toLocaleDateString("fr",{day:"numeric",month:"short"})+" "+f.toLocaleTimeString("fr",{hour:"2-digit",minute:"2-digit"}),$=l.status==="finished"?`${l.home_score} - ${l.away_score}`:`${l.home_score||0} - ${l.away_score||0}`;return`<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 14px;border-bottom:1px solid var(--gray-200)">
      <div style="flex:1">
  ...
  </div>`}bn(yn);const _e={user:null,profile:null,page:"home",params:{}};function Nt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function _a(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Vi(){document.getElementById("modal-overlay").classList.add("hidden")}async function ti(){if(!_e.user)return;const{data:t}=await v.from("users").select("*").eq("id",_e.user.id).single();t&&(_e.profile=t)}const pn="mw_theme";function un(){return localStorage.getItem(pn)||"dark"}function ka(t){var e;localStorage.setItem(pn,t),$a(t),(e=_e.profile)!=null&&e.id&&v.from("users").update({theme:t}).eq("id",_e.profile.id).then(()=>{})}function $a(t){document.documentElement.setAttribute("data-theme",t)}function Gt(t,e={}){_e.page=t,_e.params=e,fn()}async function fn(){var o,r,n,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===_e.page)});const e=document.getElementById("nav-credits");e&&_e.profile&&(e.textContent=`💰 ${(_e.profile.credits||0).toLocaleString("fr")}`);const i={state:_e,navigate:Gt,toast:Nt,openModal:_a,closeModal:Vi,refreshProfile:ti};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',_e.page){case"home":await ji(t,i);break;case"home2":await ji(t,i);break;case"game":await Gn(t,i);break;case"settings":await Oo(t,i);break;case"collection":await Yn(t,i);break;case"decks":await Pi(t,i);break;case"boosters":await sr(t,i);break;case"ranked":await va(t,i);break;case"match":{const s=_e.params&&_e.params.matchMode||"vs_ai_easy";s==="random"?await Ui(t,i,!1):s==="ranked"?await Ui(t,i,!0):s==="friend"?await Vr(t,i,(o=_e.params)==null?void 0:o.friendId,(r=_e.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await To(t,i,(n=_e.params)==null?void 0:n.mlMatchId,(a=_e.params)==null?void 0:a.leagueId):await _r(t,i);break}case"market":await ga(t,i);break;case"rankings":await ha(t,i);break;case"matches":await wa(t,i);break;case"friends":await Dn(t,i);break;case"mini-league":await Jr(t,i);break;case"match-mini-league":{const s=_e.params||{};await To(t,i,s.mlMatchId,s.leagueId);break}default:await ji(t,i)}}function Ea(){var o,r;const t=document.getElementById("app"),e=_e.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.27-1953" style="cursor:pointer">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Ta(){document.documentElement.setAttribute("data-theme",un()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Vi()}),document.getElementById("modal-close").addEventListener("click",Vi);const{data:{session:t}}=await v.auth.getSession();if(!t){Ao(),Ia(document.getElementById("app"),{onPlay:()=>uo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Nt})});return}_e.user=t.user,await ti(),Ao();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),o={};(i||[]).forEach(r=>{o[r.formation]=r.links}),xn(o)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!_e.profile){vn(document.getElementById("app"),{state:_e,navigate:async()=>{await ti(),Di()},toast:Nt,refreshProfile:ti});return}const e=Array.isArray(_e.profile.pending_boosters)?_e.profile.pending_boosters:[];if(!_e.profile.onboarding_done&&e.length>0){gr(document.getElementById("app"),{state:_e,navigate:()=>Di(),toast:Nt,refreshProfile:ti});return}Di(),setTimeout(()=>ma(_e.profile,Gt,Nt),800),v.auth.onAuthStateChange(async(i,o)=>{i==="SIGNED_OUT"&&(_e.user=null,_e.profile=null,document.getElementById("app").innerHTML="",uo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:Nt}))})}function Sa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Ai(){const t=document.getElementById("app");t&&(t.style.height=Sa()+"px")}window.addEventListener("resize",Ai);window.addEventListener("orientationchange",()=>setTimeout(Ai,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Ai);function Di(){const t=()=>{var i;(i=_e.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",_e.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",Ai(),Ea(),fn()}function Ao(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function mn(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
