const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/match-shared-Gpu5ritM.js","assets/match-shared-D_M6t_P4.css"])))=>i.map(i=>d[i]);
import{w as to,s as y,_ as Yo,x as Wo,F as ct,g as Ct,n as it,k as di,m as Kt,r as qe,j as xt,y as ki,z as Hi,G as Oe,t as gi,C as Mi,I as jt,p as io,J as qt,L as Ci,O as Ui,o as $i,P as Ei,Q as Pi,U as ji,V as Vt,W as ci,X as Lt,Y as Jo,Z as pi,$ as Qe,a0 as ui,a1 as $t,a2 as ot,a3 as jn,a4 as Xo,a5 as oo,a6 as qn,a7 as Qo,a8 as It,T as So,a9 as Bn,v as Dn,aa as Pn,d as Fn}from"./match-shared-Gpu5ritM.js";const Rn="/";async function zo(t,{navigate:e,toast:i}){let o="login";const n=await to("signup_access_code_required"),r=()=>{var d,l,s,p,c,x,h,m;const a=o==="login";if(t.innerHTML=`
    <div style="
    ...
    ">
      ...
      <div style="margin-bottom:10px;text-align:center;animation:authFadeIn .5s ease">
        <img src="${Rn}icons/logo-withname.png" alt="Manager Wars" style="height:44px;width:auto;filter:drop-shadow(0 4px 16px rgba(212,160,23,0.4))">
  ...
  `,document.body.appendChild(r);let a=!1;const d=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let s=!1;const p=S=>S.touches&&S.touches[0]?S.touches[0].clientX:S.clientX;function c(S){a||(s=!0,l.style.opacity="1",x(S))}function x(S){if(!s||a)return;const Z=d.getBoundingClientRect(),U=p(S)-Z.left,te=Math.max(0,Math.min(1,U/Z.width));l.style.width=te*Z.width+"px",te>=.82&&m()}function h(){a||(s=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{a||(l.style.transition="")},220))}function m(){var Z;if(a)return;a=!0,s=!1,l.style.width="100%",l.style.opacity="1",(Z=document.getElementById("cut-flash"))==null||Z.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const S=document.getElementById("cut-hint");S&&(S.style.opacity="0"),d.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",$(0)},620)}d.addEventListener("pointerdown",c),window.addEventListener("pointermove",x),window.addEventListener("pointerup",h),d.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",x,{passive:!0}),window.addEventListener("touchend",h);let f=0,v=!1;const _=new Set;function $(S){f=S,document.getElementById("reveal-phase").style.display="flex",b(),M(S,0),J()}function b(){const S=document.getElementById("card-dots");S&&(S.innerHTML=t.map((Z,U)=>`<div class="card-dot" data-i="${U}" style="width:8px;height:8px;border-radius:50%;background:${U===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),S.querySelectorAll(".card-dot").forEach(Z=>Z.addEventListener("click",()=>R(parseInt(Z.dataset.i)))))}function M(S,Z){var ve,be;const U=t[S],te=document.getElementById("card-counter"),ce=document.getElementById("card-track");te&&(te.textContent=`Carte ${S+1} / ${t.length}`);const xe=document.getElementById("reveal-btns");xe&&(xe.style.display=S===t.length-1?"flex":"none");const ue=U.card_type==="player"&&((ve=U.player)==null?void 0:ve.rarity)==="legende",Me=!_.has(S);if(_.add(S),U.card_type==="player"&&U.player){const ke=U.player,B=ke.job||"ATT";(Number(B==="GK"?ke.note_g:B==="DEF"?ke.note_d:B==="MIL"?ke.note_m:ke.note_a)||0)+(U.evolution_bonus||0)}const Be=ke=>{ce.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${ue?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${Zn(U)}</div>
      ...
      </div>`,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>o.remove());return}tr()}function tr(){const t=document.createElement("div");t.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(t),t.addEventListener("click",e=>{e.target===t&&t.remove()}),document.getElementById("odds-close").addEventListener("click",()=>t.remove())}function ir(){return new Promise(t=>{const e=document.createElement("div");e.style.cssText=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    `,document.head.appendChild(c)}const r=rr.map(c=>`
    ...
    </div>`,document.body.appendChild(i),i.querySelector("#credits-ad-cancel").addEventListener("click",()=>i.remove()),i.querySelectorAll(".credits-ad-offer-btn").forEach(o=>{o.addEventListener("click",()=>{i.remove(),sr(parseInt(o.dataset.ads),5,parseInt(o.dataset.credits),t,e)})})}function sr(t,e,i,o,n){let r=1;const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.94);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;gap:14px;color:#fff;padding:16px",document.body.appendChild(a);function d(){a.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),e.querySelector("#journal-close-v2").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}async function Fi(t,{state:e,navigate:i,toast:o,openModal:n,closeModal:r}){var j,N,J,X,A,w;const a=e.profile;if(!a)return;const d="/icons/";Wt(i,a,"home2",d,o);const l=a.mmr??450,s=xt(l),p=ki(l,s),c=Hi(l),x=isFinite(s.max)?s.max+1:null,[{list:h,iAmInTop:m,myPosition:f},v,_,{count:$}]=await Promise.all([dr(a.id),cr(5),pr(),y.from("pending_rewards").select("*",{count:"exact",head:!0}).eq("user_id",a.id).eq("claimed",!1)]),b=(g,E)=>{const H=xt(g.mmr??0),z=ki(g.mmr??0,H);return`
    ...
    <div class="news-item">
      ...
      <div class="news-body">
        ...
        <div class="news-time">${lr(g.published_at)}</div>
      </div>
  ...
  <div class="home-dark" id="home-dark">
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${x.map(({friendshipId:h,friend:m})=>vr(m,h)).join("")}
    </div>`,s.querySelectorAll("[data-stats]").forEach(h=>{h.addEventListener("click",()=>_r(t,h.dataset.stats,h.dataset.friendName))}),s.querySelectorAll("[data-match]").forEach(h=>{h.addEventListener("click",async()=>{const m=h.dataset.friendId,f=h.dataset.friendName;if(typeof o!="function"){e("Erreur navigation","error");return}const v=t.user.id,{data:_}=await y.from("friend_match_invites").select("id").eq("inviter_id",m).eq("invitee_id",v).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),$=!!_;console.log("[Friends] clic match",{fid:m,fname:f,isAccepting:$}),ut(),o("match",{matchMode:"friend",friendId:m,friendName:f,isAccepting:$})})})}function vr(t,e){const i=t.club_name||t.pseudo||"?",o=t.pseudo||"",n=(o||i).slice(0,2).toUpperCase(),r=t.club_color2||fi,a=t.club_color1||"#ffffff",d=t.last_seen_at?new Date(t.last_seen_at):null,l=d&&Date.now()-d.getTime()<3*60*1e3;return`
    ...
    </div>`}function wr(t,e){const i=fo();i.innerHTML=`
    <div class="popup-box">
    ...
    </style>`}async function kr(t,{state:e,navigate:i,toast:o}){const n=e.profile;if(!n)return;const r="/icons/";Wt(i,n,"game",r,o),t.innerHTML=`
  <style>
    .game-page {
      min-height: 100%;
      background: var(--page-bg);
  ...
  <div class="game-page">
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(a=>{a.addEventListener("click",()=>{a.style.transform="scale(.96)",setTimeout(()=>a.style.transform="",180);const d=a.dataset.action;if(d==="match-ai"){pn(i,e);return}if(d==="match-random"){ut(),i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}o("Bientôt disponible","info")})})}const $r="/",mn=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function gn(t,e,i){let o=0;const n=document.createElement("div");n.id="tutorial-overlay",n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const r=()=>{var p,c,x;const d=e[o],l=o===e.length-1,s=Math.round((o+1)/e.length*100);n.innerHTML=`
      <div style="background:#fff;border-radius:20px;width:100%;max-width:420px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 16px 64px rgba(0,0,0,0.4)">
        ...
        <!-- Image optionnelle -->
        ${d.image_url?`<div style="padding:0 24px 8px;text-align:center"><img src="${$r}icons/${d.image_url}" style="max-height:160px;max-width:100%;border-radius:12px;object-fit:contain"></div>`:""}
        <!-- Contenu -->
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
  ...
  </div>`,function(T){const K=document.getElementById(T);if(!K)return;K.addEventListener("wheel",ge=>{Math.abs(ge.deltaY)<=Math.abs(ge.deltaX)||(ge.preventDefault(),K.scrollLeft+=ge.deltaY)},{passive:!1});let Y=!1,W=0,D=0,ee=!1,fe=!1;K.addEventListener("mousedown",ge=>{Y=!0,ee=!1,W=ge.pageX,D=K.scrollLeft}),window.addEventListener("mouseup",()=>{Y=!1,ee&&(K.style.cursor="",fe=!0),ee=!1}),window.addEventListener("mousemove",ge=>{if(!Y)return;const pe=ge.pageX-W;!ee&&Math.abs(pe)<6||(ee=!0,K.style.cursor="grabbing",ge.preventDefault(),K.scrollLeft=D-pe)}),K.addEventListener("click",ge=>{fe&&(ge.stopPropagation(),ge.preventDefault(),fe=!1)},!0)}("col-grid");function Z(){const B=document.getElementById("col-filters");B&&(R==="player"?(B.innerHTML=`
      ...
      <div style="max-height:340px;overflow-y:auto;display:flex;flex-direction:column;gap:2px">
        ${ee.length?ee.map(he=>`
          <label style="display:flex;align-items:center;gap:8px;padding:6px 4px;font-size:14px;color:#1a1a1a;cursor:pointer">
            <input type="checkbox" class="mf-check" value="${he.value}" ${W.has(he.value)?"checked":""}>
            <span>${he.label}</span>
          </label>`).join(""):'<div style="color:#999;font-size:13px;text-align:center;padding:16px">Aucune option disponible.</div>'}
      </div>`;K.openModal(T,fe,'<button class="btn btn-primary" id="mf-apply" style="width:100%">Appliquer</button>'),(pe=document.getElementById("mf-all"))==null||pe.addEventListener("click",()=>{document.querySelectorAll(".mf-check").forEach(he=>he.checked=!0)}),($e=document.getElementById("mf-none"))==null||$e.addEventListener("click",()=>{document.querySelectorAll(".mf-check").forEach(he=>he.checked=!1)}),(Le=document.getElementById("mf-apply"))==null||Le.addEventListener("click",()=>{W.clear(),document.querySelectorAll(".mf-check:checked").forEach(he=>W.add(he.value)),K.closeModal(),Z(),te()})}function te(){const B=document.getElementById("col-grid");B&&(R==="player"?Be(B):R==="formation"?ve(B):R==="stadium"?ke(B):be(B))}function ce(B,T,K,Y,W,D=0){const ee=document.getElementById("col-grid"),fe=document.getElementById("col-big");if(!ee||!fe)return;var ge=0;function pe(){var C;const $e=window.innerWidth>=768,Le=document.getElementById("col-big"),he=document.getElementById("col-gap"),we=((C=document.getElementById("col-grid"))==null?void 0:C.parentElement)||null,k=Le?Le.closest(".page"):null;if(Le&&we&&k){let F=0;Array.from(k.children).forEach(function(oe){oe!==Le&&oe!==we&&oe!==he&&(F+=oe.offsetHeight)});const P=Math.max(0,k.clientHeight-F),V=Math.round(P*(D/100)),Q=Math.max(0,P-V),ie=$e?50/71:45/63,ne=Math.round(Q*ie),ae=Math.max(0,Q-ne);he&&(he.style.height=V+"px"),Le.style.flex="none",Le.style.height=ne+"px",Le.style.minHeight="0",we.style.flex="none",we.style.height=ae+"px",we.style.minHeight="0",we.style.display="flex",we.style.overflow="hidden"}const L=document.getElementById("col-grid");L&&(L.style.height="100%",L.style.flexShrink="0",L.style.overflowX="auto",L.style.overflowY="hidden",L.style.alignItems="center",L.style.width="100%"),fe.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+T(B[ge])+"</div>";var q=fe.querySelector("[data-card-id],[data-form-id],[data-gc-id]");q&&q.addEventListener("click",function(){Y(B[ge])});var G=fe.querySelector(".big-evolve-btn");G&&G.addEventListener("click",function(F){F.stopPropagation(),Y(B[ge],{autoEvolve:!0})}),requestAnimationFrame(function(){var F=document.getElementById("big-card-inner");if(!(!F||!fe)){var P=fe.clientHeight,V=fe.clientWidth-16,Q=F.offsetHeight,ie=F.offsetWidth;if(Q>0&&ie>0&&P>40){var ne=Math.min(P/Q,V/ie);F.style.transform="scale("+ne.toFixed(3)+")",F.style.transformOrigin="center center"}}}),ee.innerHTML=B.map(function(F,P){var V=P===ge,Q="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(V?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+P+'" style="'+Q+'">'+K(F,V)+"</div>"}).join(""),ee.querySelectorAll(".col-mini-item").forEach(function(F){F.addEventListener("click",function(){ge=Number(F.dataset.idx),pe(),F.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var F=L?L.clientHeight:0,P=ee.querySelector(".col-mini-item > div");if(!(!F||!P)){var V=P.style.zoom;P.style.zoom="1";var Q=P.offsetHeight;if(P.style.zoom=V,!(Q<=0)){var ie=F/Q;ee.querySelectorAll(".col-mini-item > div").forEach(function(ne){ne.style.zoom=ie.toFixed(4)})}}})}pe()}function xe(B,T){var K=window.innerWidth>=768?.76:.54,Y;if(!B||B._fake){var W=B?B.player:null;if(!W)return"";Y=jo(W)}else Y=Ri(B,"");var D=B&&!B._fake?b[B.player&&B.player.id]||1:0,ee=D>0?'<div style="position:absolute;top:6px;right:6px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:11px;font-weight:900;padding:2px 7px;z-index:3;box-shadow:0 1px 4px rgba(0,0,0,0.4)">×'+D+"</div>":"";return'<div style="display:inline-block;position:relative;zoom:'+K+';pointer-events:none;line-height:0">'+ee+Y+"</div>"}function ue(B,T,K){var Y=K>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+K+"</div>":"",W=!!T,D=di(B,ct[B],{width:160});return W||(D='<div style="filter:grayscale(1);opacity:0.5">'+D+"</div>"),"<div "+(T?'data-form-id="'+T.id+'"':"")+' style="position:relative;cursor:pointer">'+Y+D+"</div>"}function Me(B,T){var K=window.innerWidth>=768?.76:.54,Y=di(B,ct[B],{width:140});return T||(Y='<div style="filter:grayscale(1);opacity:0.45">'+Y+"</div>"),'<div style="display:inline-block;zoom:'+K+';line-height:0;pointer-events:none">'+Y+"</div>"}function Be(B){if(J){const T=S();if(!T.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const K=T.map(Y=>s.find(W=>W.player.id===Y.id)||{_fake:!0,player:Y,id:"fake-"+Y.id});ce(K,Y=>Y._fake?jo(Y.player):Ri(Y,""),Y=>Y._fake?xe({player:Y.player,id:"x",_fake:!0}):xe(Y),Y=>{Y._fake||qo(Y,s,b,e)})}else{const T=I();if(!T.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const K={};T.forEach(W=>{const D=W.player.id;K[D]||(K[D]=[]),K[D].push(W)});const Y=Object.values(K).map(W=>Lr(W)).filter(W=>!X||(b[W.player.id]||1)>1);if(X&&!Y.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte en plusieurs exemplaires.</div>';return}ce(Y,W=>{const D=b[W.player.id]||1,ee=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",ge=s.filter(pe=>pe.player.id===W.player.id&&pe.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Ri(W,ee+ge,D)},W=>xe(W),(W,D)=>qo(W,s,b,e,D))}}function ve(B){const T=J?_:[...M];if(!T.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const K=T.map(Y=>({formation:Y,card:c.find(W=>W.formation===Y)||null,owned:M.has(Y)}));ce(K,({formation:Y,card:W,owned:D})=>ue(Y,D?W:null,D?c.filter(ee=>ee.formation===Y).length:0),({formation:Y,owned:W})=>Me(Y,W),({card:Y,owned:W})=>{W&&Y&&Mr(Y,c,e,r)},"#1A6B3C",5)}function be(B){const T=Object.keys(m),K=J?T.length?T:$:[...u];if(!K.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Y=K.map(W=>({type:W,gc:Oe[W]||{icon:"⚡",desc:""},def:m[W]||null,owned:u.has(W),card:p.find(D=>D.gc_type===W)||null}));ce(Y,({type:W,gc:D,def:ee,owned:fe,card:ge})=>{var L;const pe=(ee==null?void 0:ee.name)||W,$e=fe?p.filter(q=>q.gc_type===W).length:0,Le=$e>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${$e}</div>`:"",he=(ee==null?void 0:ee.effect)||D.desc||"",we=ee!=null&&ee.image_url?`/icons/${ee.image_url}`:((L=ee==null?void 0:ee.club)==null?void 0:L.logo_url)||(ee!=null&&ee.country_code?`https://flagsapi.com/${ee.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let k=it(pe,we,D.icon,he,{width:160,onClick:fe});return fe||(k=`<div style="filter:grayscale(1);opacity:0.5">${k}</div>`),`<div ${fe&&ge?`data-gc-id="${ge.id}" data-gc-type="${W}"`:""} style="position:relative">${Le}${k}</div>`},({type:W,gc:D,def:ee,owned:fe})=>{const ge=window.innerWidth>=768?.76:.54,pe=(ee==null?void 0:ee.name)||W,$e=(ee==null?void 0:ee.effect)||D.desc||"",Le=ee!=null&&ee.image_url?`/icons/${ee.image_url}`:null;let he=it(pe,Le,D.icon,$e,{width:140});return fe||(he=`<div style="filter:grayscale(1);opacity:0.45">${he}</div>`),`<div style="display:inline-block;zoom:${ge};line-height:0;pointer-events:none">${he}</div>`},({type:W,owned:D,def:ee})=>{D&&Tr(W,ee,r)},"#7a28b8",5)}function ke(B){const T="#4FC3F7",K="/";if(!x.length){B.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Y={};x.forEach(D=>{const ee=D.stadium_id||"?";(Y[ee]=Y[ee]||[]).push(D)});const W=Object.entries(Y).map(([D,ee])=>({sid:D,def:v[D]||null,count:ee.length,card:ee[0]}));ce(W,({def:D,count:ee})=>{var he,we;const fe=(D==null?void 0:D.name)||"?",ge=((he=D==null?void 0:D.club)==null?void 0:he.encoded_name)||(D==null?void 0:D.country_code)||"—",pe=D!=null&&D.image_url?`${K}icons/${D.image_url}`:((we=D==null?void 0:D.club)==null?void 0:we.logo_url)||(D!=null&&D.country_code?`https://flagsapi.com/${D.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),$e=ee>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ee}</div>`:"",Le=`${ge}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${$e}${Kt(fe,pe,Le,{width:160})}</div>`},({def:D})=>{var Le,he;const ee=window.innerWidth>=768?.76:.54,fe=(D==null?void 0:D.name)||"?",ge=((Le=D==null?void 0:D.club)==null?void 0:Le.encoded_name)||(D==null?void 0:D.country_code)||"—",pe=D!=null&&D.image_url?`${K}icons/${D.image_url}`:((he=D==null?void 0:D.club)==null?void 0:he.logo_url)||(D!=null&&D.country_code?`https://flagsapi.com/${D.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),$e=`${ge}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${ee};line-height:0;pointer-events:none">${Kt(fe,pe,$e,{width:140})}</div>`},null,T,5)}t.querySelectorAll(".col-tab-btn").forEach(B=>{B.addEventListener("click",()=>{R=B.dataset.tab,j="Tous",N="",J=!1,t.querySelectorAll(".col-tab-btn").forEach(T=>{const K=T.dataset.tab===R;T.style.borderBottomColor=K?"var(--green)":"transparent",T.style.color=K?"var(--green)":"var(--tile-fg-dim)"}),Z(),te()})}),Z(),te()}function Tr(t,e,i){const o=Oe[t]||{icon:"⚡",desc:"Effet spécial."},n=(e==null?void 0:e.name)||t,r=(e==null?void 0:e.effect)||o.desc,a=e!=null&&e.image_url?`/icons/${e.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${it(n,a,o.icon,r,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const hi=1e3;function Mr(t,e,i,o){var m,f,v;const{state:n,toast:r,closeModal:a,navigate:d,refreshProfile:l}=i,s=t.formation,p={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function c(){const _=ct[s]||{},$=gi[s]||[],b=290,M=360,u=20;function R(N){const J=_[N];return J?{x:J.x*b,y:J.y*M}:null}let j=`<svg width="${b}" height="${M}" viewBox="0 0 ${b} ${M}" xmlns="http://www.w3.org/2000/svg">`;for(const[N,J]of $){const X=R(N),A=R(J);!X||!A||(j+=`<line x1="${X.x}" y1="${X.y}" x2="${A.x}" y2="${A.y}"
    ...
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px">
        ${x.filter(T=>T.id!==t.id).map((T,K)=>{const Y=H[T.id]||[],W=T.is_for_sale,D=Y.length?Y[Y.length-1]:null,ee=T.evolution_bonus||0,fe=D?D.source==="booster"?"Booster":D.price?D.price.toLocaleString("fr")+" cr.":"—":"—",ge=D?new Date(D.transferred_at).toLocaleDateString("fr",{day:"2-digit",month:"2-digit",year:"numeric"}):"",pe=80,$e=Math.round(pe*657/507),Le=qe({...c,_evolution_bonus:ee},{width:pe});return`
            <div class="exemplaire-row" data-card-id="${T.id}" data-card-idx="${K}"
              style="position:relative;cursor:${W?"not-allowed":"pointer"};opacity:${W?.55:1};transition:transform .1s">
              <!-- Checkbox cachée -->
              ...
              <div class="expl-mini-card" style="position:relative;width:${pe}px;height:${$e}px;border-radius:8px;overflow:hidden">
                ...
                ${W?'<div style="position:absolute;top:0;right:0;background:#e67e22;color:#fff;font-size:6px;font-weight:900;padding:2px 4px;border-radius:0 6px 0 4px;z-index:12">VENTE</div>':""}
              </div>
              <!-- Source + date -->
      ...
      <div style="flex:1;min-width:220px;display:flex;flex-direction:column;gap:12px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([T,K])=>{const Y=ti[T],W=T==="GK"?"#fff":Y,D=T===c.job||T===c.job2,ee=(Number(K)||0)+(D&&J>0?J:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${Y};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${W};font-family:Arial Black,Arial;line-height:1">${ee}</span>
                </div>
                <span style="font-size:10px;font-weight:700;color:${W}">${T}</span>
              </div>`}).join("")}
          </div>
        </div>
        <div>
    ...
    ${z}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ue=document.getElementById("close-detail"))==null||ue.addEventListener("click",l);let O=new Set;const le=c.rarity==="pepite"?1.3:c.rarity==="papyte"?.7:1;function I(){let T=0;return document.querySelectorAll(".expl-check:checked").forEach(K=>{if(K.dataset.id===t.id)return;const W=Number(K.dataset.evo)||0,D=Number(K.dataset.note)||0;T+=D+W}),Math.round(T*le)}const S=()=>{const T=O.size,K=document.getElementById("sell-action-panel");if(!K)return;K.style.display=T>0?"block":"none",document.getElementById("sell-selected-count").textContent=T;const Y=document.getElementById("evolve-btn");if(Y){const W=I();Y.textContent=W>0?`⬆️ Évoluer (+${W})`:"⬆️ Évoluer"}};if(document.querySelectorAll(".expl-check").forEach(T=>{T.addEventListener("change",()=>{const K=T.dataset.id;T.checked?O.add(K):O.delete(K);const Y=T.closest(".exemplaire-row");if(Y){const W=Y.querySelector(".expl-sel-overlay"),D=Y.querySelector(".expl-sel-check");W&&(W.style.display=T.checked?"block":"none"),D&&(D.style.display=T.checked?"flex":"none"),Y.style.transform=T.checked?"scale(1.05)":"scale(1)"}S()})}),n.autoEvolve){document.querySelectorAll(".expl-check").forEach(K=>{if(K.dataset.id===t.id)return;K.checked=!0,O.add(K.dataset.id);const Y=K.closest(".exemplaire-row");if(Y){const W=Y.querySelector(".expl-sel-overlay"),D=Y.querySelector(".expl-sel-check");W&&(W.style.display="block"),D&&(D.style.display="flex"),Y.style.transform="scale(1.05)"}}),S();const T=document.getElementById("modal-overlay");T&&(T.style.visibility="hidden"),requestAnimationFrame(()=>{const K=document.getElementById("evolve-btn");if(!K||K.disabled){T&&(T.style.visibility="");return}K.click();const Y=()=>{T&&(T.style.visibility="",T.classList.contains("hidden")||l())},W=new MutationObserver(()=>{[...document.body.children].some(fe=>{var ge;return((ge=fe.style)==null?void 0:ge.zIndex)==="9999"})||(W.disconnect(),clearTimeout(D),Y())});W.observe(document.body,{childList:!0});const D=setTimeout(()=>{W.disconnect(),Y()},6e4)})}document.querySelectorAll(".exemplaire-row").forEach(T=>{T.addEventListener("click",K=>{if(K.target.tagName==="INPUT")return;const Y=T.querySelector(".expl-check");Y&&!Y.disabled&&(Y.checked=!Y.checked,Y.dispatchEvent(new Event("change")))})}),(Me=document.getElementById("evolve-btn"))==null||Me.addEventListener("click",async()=>{if(h<=1)return;const T=[...O];if(!T.length)return;if(O.has(t.id)){const pe=document.createElement("div");pe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",pe.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            ➕ Brut : <strong>+${Y}</strong>${D?`<span style="font-size:11px;color:#888"> ${D}</span>`:""}<br>
            ⬆️ Bonus final : <strong style="color:#1A6B3C">+${W}</strong><br>
            📈 Évolution : <strong>${t.evolution_bonus||0}</strong> → <strong style="color:#1A6B3C">${(t.evolution_bonus||0)+W}</strong><br>
            📊 Note finale : <strong>${u}</strong> → <strong style="color:#1A6B3C">${u+W}</strong>
            ${R&&R>0?`<br>📊 Note 2 finale : <strong>${R}</strong> → <strong style="color:#1A6B3C">${R+W}</strong>`:""}
          </div>
        ...
        </div>`,document.body.appendChild($e),$e.querySelector("#sac-cancel").addEventListener("click",()=>{$e.remove(),pe(!1)}),$e.querySelector("#sac-ok").addEventListener("click",()=>{$e.remove(),pe(!0)}),$e.addEventListener("click",Le=>{Le.target===$e&&($e.remove(),pe(!1))})}))return;if(K.length){await y.from("market_listings").delete().in("card_id",K),await y.from("deck_cards").delete().in("card_id",K),await y.from("transfer_history").delete().in("card_id",K),await y.from("decks").update({stadium_card_id:null}).in("stadium_card_id",K);const{error:pe}=await y.from("cards").delete().in("id",K);if(pe){a("Erreur suppression : "+pe.message,"error");return}}const fe=(t.evolution_bonus||0)+W,{error:ge}=await y.from("cards").update({evolution_bonus:fe}).eq("id",t.id);if(ge){a("Erreur évolution : "+ge.message,"error");return}a(`⬆️ ${c.firstname} ${c.surname_real} : note ${u} → ${u+fe} (+${W}) !`,"success",4e3),l(),s("collection")});async function Z(T){const{data:K}=await y.from("sell_price_configs").select("price_min, price_max").eq("rarity",c.rarity).lte("note_min",u).gte("note_max",u).order("note_max",{ascending:!0}).limit(1).maybeSingle();return K?T<K.price_min||T>K.price_max?{ok:!1,min:K.price_min,max:K.price_max}:{ok:!0}:{ok:!0}}(Be=document.getElementById("market-sell-btn"))==null||Be.addEventListener("click",async()=>{var fe;const T=[...O];if(!T.length){a("Sélectionne au moins un exemplaire","warning");return}const K=parseInt((fe=document.getElementById("sell-market-price"))==null?void 0:fe.value);if(!K||K<1){a("Prix invalide","error");return}const Y=await Z(K);if(!Y.ok){a(`Prix hors grille : entre ${Y.min.toLocaleString("fr")} et ${Y.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:W}=await y.from("cards").update({is_for_sale:!0,sale_price:K}).in("id",T);if(W){a(W.message,"error");return}const D=T.map(ge=>({seller_id:r.profile.id,card_id:ge,price:K,status:"active"})),{error:ee}=await y.from("market_listings").insert(D);ee&&console.warn("[Market] insert listings:",ee.message),a(`${T.length} carte${T.length>1?"s":""} mise${T.length>1?"s":""} en vente à ${K.toLocaleString("fr")} cr. chacune !`,"success"),l(),s("collection")}),(ve=document.getElementById("single-sell-btn"))==null||ve.addEventListener("click",async()=>{var D;const T=parseInt((D=document.getElementById("single-sell-price"))==null?void 0:D.value);if(!T||T<1){a("Prix invalide","error");return}const K=await Z(T);if(!K.ok){a(`Prix hors grille : entre ${K.min.toLocaleString("fr")} et ${K.max.toLocaleString("fr")} cr. pour cette rareté/note`,"error");return}const{error:Y}=await y.from("cards").update({is_for_sale:!0,sale_price:T}).eq("id",t.id);if(Y){a(Y.message,"error");return}const{error:W}=await y.from("market_listings").insert({seller_id:r.profile.id,card_id:t.id,price:T,status:"active"});W&&console.warn("[Market] insert listing:",W.message),a(`Carte mise en vente à ${T.toLocaleString("fr")} cr. !`,"success"),l(),s("collection")}),(be=document.getElementById("single-direct-sell-btn"))==null||be.addEventListener("click",async()=>{const T=b??$;if(!confirm(`Vendre cette carte immédiatement pour ${T.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;await y.from("market_listings").delete().eq("card_id",t.id),await y.from("transfer_history").delete().eq("card_id",t.id);const{error:K}=await y.from("cards").delete().eq("id",t.id);if(K){a(K.message,"error");return}await y.from("users").update({credits:(r.profile.credits||0)+T}).eq("id",r.profile.id),await p(),a(`+${T.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),l(),s("collection")}),(ke=document.getElementById("market-direct-sell-btn"))==null||ke.addEventListener("click",async()=>{const T=[...O];if(!T.length){a("Sélectionne au moins un exemplaire","warning");return}const Y=(b??$)*T.length;if(!confirm(`Vendre ${T.length} carte${T.length>1?"s":""} immédiatement pour ${Y.toLocaleString("fr")} crédits au total ? Cette action est irréversible.`))return;await y.from("market_listings").delete().in("card_id",T),await y.from("transfer_history").delete().in("card_id",T);const{error:W}=await y.from("cards").delete().in("id",T);if(W){a(W.message,"error");return}await y.from("users").update({credits:(r.profile.credits||0)+Y}).eq("id",r.profile.id),await p(),a(`+${Y.toLocaleString("fr")} crédits ! ${T.length} carte${T.length>1?"s":""} vendue${T.length>1?"s":""}.`,"success"),l(),s("collection")}),(B=document.getElementById("cancel-sell-btn"))==null||B.addEventListener("click",async()=>{await y.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",t.id),await y.from("market_listings").update({status:"cancelled"}).eq("card_id",t.id).eq("status","active"),a("Annonce retirée","success"),l(),s("collection")})}const Cr={GK:"note_g",DEF:"note_d",MIL:"note_m",ATT:"note_a"};function Ot(t,e){const i=t==null?void 0:t.player;if(!i)return 0;const o=t.evolution_bonus||0;return(Number(i[Cr[e]])||0)+(e===i.job||e===i.job2?o:0)}function wi(t){return t.replace(/[0-9]/g,"")}function xn(t,e){if(!(t!=null&&t.player)||!e)return 0;const i=t.player,o=e.club_id&&String(i.club_id)===String(e.club_id),n=e.country_code&&String(i.country_code)===String(e.country_code);return o||n?10:0}function Ni(t,e,i){let o=0;for(const[r,a]of Object.entries(t))a&&(o+=Ot(a,wi(r)),o+=xn(a,i));const n=Mi(e)||gi[e]||[];for(const[r,a]of n){const d=t[r],l=t[a];if(!d||!l)continue;const s=jt(d.player,l.player);s==="#00ff88"?o+=10:s==="#FFD700"&&(o+=5)}return o}function jr(t,e,i){const o={},n=new Set,r=[...t].sort((a,d)=>{const l={GK:0,DEF:1,ATT:2,MIL:3};return l[wi(a)]-l[wi(d)]});for(const a of r){const d=wi(a);let l=null,s=-1;for(const p of e){if(n.has(p.id))continue;const c=Ot(p,d)+xn(p,i);c>s&&(s=c,l=p)}l&&(o[a]=l,n.add(l.id))}return{assign:o,used:n}}function qr(t,e,i,o,n,r,a=6){let d=Ni(t,n,r);const l=o.filter(s=>!e.has(s.id));for(let s=0;s<a;s++){let p=!1;for(let c=0;c<i.length;c++)for(let x=c+1;x<i.length;x++){const h=i[c],m=i[x],f=t[h],v=t[m];if(!f||!v)continue;t[h]=v,t[m]=f;const _=Ni(t,n,r);_>d?(d=_,p=!0):(t[h]=f,t[m]=v)}for(const c of i){const x=t[c];for(let h=0;h<l.length;h++){const m=l[h];t[c]=m;const f=Ni(t,n,r);if(f>d){d=f,p=!0,l[h]=x,e.delete(x==null?void 0:x.id),e.add(m.id);break}else t[c]=x}}if(!p)break}return d}function Br({playerCards:t,availableFormations:e,stadiumCards:i,stadDefMap:o}){const n=(t||[]).filter(d=>d.player);if(n.length<11)return null;const r=[{id:null,def:null}];(i||[]).forEach(d=>{const l=o==null?void 0:o[d.stadium_id];l&&r.push({id:d.id,def:l})});let a=null;for(const d of e||[]){const l=ct[d];if(!l)continue;const s=Object.keys(l);if(s.length===11)for(const p of r){const{assign:c,used:x}=jr(s,n,p.def);if(Object.keys(c).length!==11)continue;const h=qr(c,x,s,n,d,p.def);if(!a||h>a.score){const f=n.filter(_=>!Object.values(c).some($=>$.id===_.id)).map(_=>({c:_,v:Math.max(Ot(_,"GK"),Ot(_,"DEF"),Ot(_,"MIL"),Ot(_,"ATT"))})).sort((_,$)=>$.v-_.v).slice(0,5).map(_=>_.c.id),v={};Object.entries(c).forEach(([_,$])=>{v[_]=$.id}),a={formation:d,stadiumCardId:p.id,slots:v,subs:f,score:h}}}}return a}function Bo(t,e=""){return new Promise(i=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2100",o.innerHTML=`<div class="modal" style="max-width:360px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${c.map(b=>{const M={...b.player,_evolution_bonus:b.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:24px">
                ${qe({...M,_evolution_bonus:M._evolution_bonus||0},{width:90,showStad:!0,stadDef:p})}
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:2px;align-items:center;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none" id="subs-list" class="no-scrollbar">
              ${c.map(b=>{const M={...b.player,_evolution_bonus:b.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible;padding-bottom:20px">
                  ${qe({...M,_evolution_bonus:M._evolution_bonus||0},{width:44,showStad:!0,stadDef:p})}
                  <button data-remove-sub="${b.id}"
    ...
    <div class="page-body" style="padding:12px 16px calc(80px + env(safe-area-inset-bottom, 0px))">
      ...
      <div style="font-size:16px;font-weight:800">✨ Deck en cours de préparation…</div>`,document.body.appendChild(b),()=>b.remove()}t.querySelectorAll("#auto-deck-pc, #auto-deck-mobile").forEach(b=>{b.addEventListener("click",async()=>{if(e.playerCards.length<11){i.toast(`Il faut au moins 11 joueurs (tu en as ${e.playerCards.length})`,"error");return}b.disabled=!0;const M=v();await new Promise(R=>setTimeout(R,30));const u=Br({playerCards:e.playerCards,availableFormations:e.availableFormations,stadiumCards:e.stadiumCards,stadDefMap:e.stadDefMap});if(b.disabled=!1,M(),!u){i.toast("Impossible de composer une équipe complète","error");return}e.formation=u.formation,e.slots=u.slots,e.wanted={},e.subs=u.subs,e.stadiumCardId=u.stadiumCardId,nt(t,e,i),i.toast(`✨ Deck optimisé : ${u.formation} · score ${u.score}`,"success")})}),t.querySelectorAll("[data-remove-sub]").forEach(b=>{b.addEventListener("click",()=>{e.subs=e.subs.filter(M=>M!==b.dataset.removeSub),nt(t,e,i)})}),t.querySelectorAll("#add-sub-btn").forEach(b=>b.addEventListener("click",()=>Nr(e,t,i)))}function Pr(t,e,i,o){var M,u,R,j,N,J;const n=window.innerWidth>=900,r=t.querySelector(n?"#deck-field-pc":"#deck-field-mobile");if(!r)return;const a=(M=e.stadiumCards)==null?void 0:M.find(X=>X.id===e.stadiumCardId),d=a&&((u=e.stadDefMap)==null?void 0:u[a.stadium_id])||null,l=ct[e.formation]||{},s=Mi(e.formation)||[],p={},c=new Set;for(const X of i){const A=e.slots[X],w=A?e.playerCards.find(g=>g.id===A):null;w!=null&&w.player?p[X]={...w.player,_evolution_bonus:w.evolution_bonus||0,face:w.player.face||null}:(R=e.wanted)!=null&&R[X]&&((j=e._playersCache)!=null&&j[e.wanted[X]])?(p[X]={...e._playersCache[e.wanted[X]],_evolution_bonus:0},c.add(X)):p[X]=null}const x=window.innerWidth>=900,h=x?window.innerWidth-280:window.innerWidth-20,m=x?Math.min(h,860):h,f=Math.round(x?m*.82:m*.85),v=x?84:44;let _="";for(const[X,A]of s){const w=l[X],g=l[A];if(!w||!g)continue;const E=w.x*m,H=Math.round(.03*f+w.y*.85*f),z=g.x*m,O=Math.round(.03*f+g.y*.85*f),le=p[X],I=p[A],S=jt(le,I);S==="#ff3333"||S==="#cc2222"?_+=`<line x1="${E.toFixed(1)}" y1="${H.toFixed(1)}" x2="${z.toFixed(1)}" y2="${O.toFixed(1)}" stroke="${S}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(_+=`<line x1="${E.toFixed(1)}" y1="${H.toFixed(1)}" x2="${z.toFixed(1)}" y2="${O.toFixed(1)}" stroke="${S}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,_+=`<line x1="${E.toFixed(1)}" y1="${H.toFixed(1)}" x2="${z.toFixed(1)}" y2="${O.toFixed(1)}" stroke="${S}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let $="";const b=Math.round(v*657/507);for(const X of i){const A=l[X];if(!A)continue;const w=p[X],g=A.x*m;A.y*f;const E=Math.round(.03*f+A.y*(.85*f)),H=Math.round(g-v/2),z=Math.round(E-b/2);if(w){const O=X.replace(/\d+/,""),le=c.has(X),I=!le&&d&&(d.club_id&&String(w.club_id)===String(d.club_id)||d.country_code&&w.country_code===d.country_code),S=qe({...w,_evolution_bonus:w._evolution_bonus||0},{width:v,showStad:!0,stadDef:d,role:O});I&&((N=d.club)!=null&&N.logo_url||d.image_url);const Z="",U=le?`<button class="wanted-market-btn" data-wanted-pos="${X}"
    ...
    <div style="position:relative;width:${m}px;height:${f}px;margin:0 auto">
      ...
      <div class="${A.owned?"player-option":"wanted-option"}"
        ...
        ${qe(w,{width:100,showStad:!0,stadDef:s,role:d})}
    ...
    </div>`}function wn(t){var r,a,d;if(!t)return"";const e=l=>l?qe({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",o={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[t.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,n.textContent=t,!document.getElementById("game-toast-style")){const r=document.createElement("style");r.id="game-toast-style",r.textContent=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${t.map((r,a)=>{const d=a<t.length-1?jt(r,t[a+1]):null,l=!d||d==="#ff3333"||d==="#cc2222",s=d==="#00ff88"?"+10":d==="#FFD700"?"+5":"";return kn(r,n),r.stadiumBonus||n&&(n.club_id&&String(r.club_id)===String(n.club_id)||n.country_code&&(r.country_code,n.country_code)),`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${t.map(c=>{const x=c._line||c.job||"MIL",h=d.find(f=>f.cardId===c.cardId),m=qe({...c,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:c.boost||0});return`<div class="gc-pick-item" data-cid="${c.cardId}"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${o.map(n=>`
        <div class="player-boost-opt" data-card-id="${n.cardId}"
          ...
          <div style="width:32px;height:32px;background:${qn[n.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${qt(n,n._line||n.job)}</div>
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;overflow-y:auto;background:#0a3d1e">
      ${Hr(u[v+"Team"],u[v+"Formation"],null,u[v+"Name"]||"Adversaire")}
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(Ne=ae.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>ae.remove()),(je=ae.querySelector("#pout-up"))==null||je.addEventListener("click",()=>{V>0&&(V--,oe())}),(Ye=ae.querySelector("#pout-down"))==null||Ye.addEventListener("click",()=>{V<F.length-1&&(V++,oe())}),(He=ae.querySelector("#pin-up"))==null||He.addEventListener("click",()=>{ie>0&&(ie--,oe())}),(rt=ae.querySelector("#pin-down"))==null||rt.addEventListener("click",()=>{ie<P.length-1&&(ie++,oe())});const Ce=(Fe,We,Ue,ft)=>{const at=ae.querySelector("#"+Fe);if(!at)return;let Dt=0;at.addEventListener("touchstart",mt=>{Dt=mt.touches[0].clientY},{passive:!0}),at.addEventListener("touchend",mt=>{const Et=mt.changedTouches[0].clientY-Dt;if(Math.abs(Et)<30)return;const st=We();Et<0&&st<ft-1?(Ue(st+1),oe()):Et>0&&st>0&&(Ue(st-1),oe())},{passive:!0})};Ce("pin-panel",()=>ie,Fe=>ie=Fe,P.length),Ce("pout-panel",()=>V,Fe=>V=Fe,F.length),(Xt=ae.querySelector("#psub-confirm"))==null||Xt.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),ne)return;ne=!0;const We=F[V],Ue=P[ie];if(!We||!Ue)return;const ft=We._line,at=(q[ft]||[]).findIndex(Et=>Et.cardId===We.cardId);if(at===-1){m("Erreur : joueur introuvable","error"),ae.remove();return}const Dt={...Ue,_line:ft,position:We.position,used:!1,boost:0};q[ft].splice(at,1,Dt);const mt=[...G,Ue.cardId];ae.remove(),Be(We,Ue,async()=>{await g({[f+"Team"]:q,[v+"Team"]:u[v+"Team"],["usedSubIds_"+f]:mt})})})}document.body.appendChild(ae),oe()}function Be(k,L,q){const G={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},C=document.createElement("div");C.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const F=(Q,ie,ne)=>`<div style="text-align:center">
  ...
  </div>`}function Ea(t,e,i){const o=[];return t.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${et};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),o.push(...t.map(n=>Ti(n,i,!1)))),e.length&&(o.push(`<div style="font-size:11px;font-weight:700;color:${et};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),o.push(...e.map(n=>Ti(n,i,!0)))),o.length?o.join(""):`<div style="text-align:center;padding:40px;color:${et}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function Sa(t,e){return t.length?t.map(i=>Ti(i,e)).join(""):`<div style="text-align:center;padding:40px;color:${et}">Aucune mini league en cours.</div>`}function za(t,e,i={}){return t.length?t.map(o=>Ti(o,e,!1,i[o.id])).join(""):`<div style="text-align:center;padding:40px;color:${et}">Aucune mini league archivée.</div>`}function La(t,e){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`}async function Ma(t,e,i,o){const{toast:n,state:r}=e,a=qa(o.map(s=>s.id),i.mode),d=[];a.forEach((s,p)=>s.forEach(c=>d.push({league_id:i.id,matchday:p+1,home_id:c.home||c.bye,away_id:c.away||null,is_bye:!!c.bye,status:c.bye?"bye":"pending"})));const{error:l}=await y.from("mini_league_matches").insert(d);if(l){n("Erreur calendrier : "+l.message,"error");return}await y.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),n(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),pt(t,e,i.id)}async function Ca(t,e,i){const{data:o}=await y.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),n=(o.current_day||0)+1;if(n>(o.total_days||0)){pt(t,e,i);return}await y.from("mini_leagues").update({current_day:n}).eq("id",i),e.toast(`Journée ${n} commencée !`,"success"),pt(t,e,i)}async function ja(t,e,i,o,n){var x,h;const{state:r,toast:a}=e,d=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],l=["🥇","🥈","🥉"][n],s=o.prize_amount||d[n]||0,p=o.prize_claimed,c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",c.innerHTML=`
    ...
    </div>`;let p=!1;const c=async v=>{if(!p){if(p=!0,clearInterval(m),h)try{h.unsubscribe()}catch{}v&&await Bt(t,e,v,n,{mlLeagueId:o,mlMatchId:i,myGC:r||[],gcDefs:a,stadiumDef:d}),l()}};(f=document.getElementById("wait-back"))==null||f.addEventListener("click",()=>{if(p=!0,clearInterval(m),h)try{h.unsubscribe()}catch{}s("mini-league",{openLeagueId:o}),l()});const x=async()=>{if(p)return;const{data:v}=await y.from("mini_league_matches").select("match_id").eq("id",i).single();v!=null&&v.match_id&&c(v.match_id)},h=y.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},v=>{var _;(_=v.new)!=null&&_.match_id&&c(v.new.match_id)}).subscribe(),m=setInterval(x,3e3);x()})}const Uo={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Gt(t,e,i=0){return e?(Number(e==="GK"?t.note_g:e==="DEF"?t.note_d:e==="MIL"?t.note_m:t.note_a)||0)+(e===t.job||e===t.job2?i:0):0}async function Pa(t,e){t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await xo(t,e)}async function xo(t,e){var R,j,N,J,X,A;const{state:i,toast:o,navigate:n}=e;Wt(n,i.profile,"market","/icons/",o);const{data:r}=await y.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  </div>`}Dn(Fn);const _e={user:null,profile:null,page:"home",params:{}};function bt(t,e="info",i=3e3){const o=document.getElementById("toast");o&&(o.textContent=t,o.className=`show ${e}`,clearTimeout(o._t),o._t=setTimeout(()=>{o.className=""},i))}function Ka(t,e,i=""){document.getElementById("modal-title").textContent=t,document.getElementById("modal-body").innerHTML=e,document.getElementById("modal-footer").innerHTML=i;const o=document.getElementById("modal-overlay");o.style.visibility="",o.classList.remove("hidden")}function eo(){const t=document.getElementById("modal-overlay");t.style.visibility="",t.classList.add("hidden")}async function ai(){if(!_e.user)return;const{data:t}=await y.from("users").select("*").eq("id",_e.user.id).single();t&&(_e.profile=t)}const An="mw_theme";function li(){return localStorage.getItem(An)||"dark"}function Ko(t){var e;localStorage.setItem(An,t),_i(t),(e=_e.profile)!=null&&e.id&&y.from("users").update({theme:t}).eq("id",_e.profile.id).then(()=>{})}function _i(t){var e,i;document.documentElement.setAttribute("data-theme",t),t==="club"&&(document.documentElement.style.setProperty("--club-color1",((e=_e.profile)==null?void 0:e.club_color1)||"#0a0f0a"),document.documentElement.style.setProperty("--club-color2",((i=_e.profile)==null?void 0:i.club_color2)||"#080d08"))}function kt(t,e={}){_e.page=t,_e.params=e,Tn()}async function Tn(){var o,n,r,a;const t=document.getElementById("page-content");if(!t)return;document.querySelectorAll(".bottom-nav a").forEach(d=>{d.classList.toggle("active",d.dataset.page===_e.page)});const e=document.getElementById("nav-credits");e&&_e.profile&&(e.textContent=`💰 ${(_e.profile.credits||0).toLocaleString("fr")}`);const i={state:_e,navigate:kt,toast:bt,openModal:Ka,closeModal:eo,refreshProfile:ai};switch(t.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',_e.page){case"home":await Fi(t,i);break;case"home2":await Fi(t,i);break;case"game":await kr(t,i);break;case"settings":await yn(t,i);break;case"collection":await Ar(t,i);break;case"decks":await Yi(t,i);break;case"boosters":await Wn(t,i);break;case"ranked":await Ha(t,i);break;case"match":{const d=_e.params&&_e.params.matchMode||"vs_ai_easy";d==="random"?await Qi(t,i,!1):d==="ranked"?await Qi(t,i,!0):d==="friend"?await va(t,i,(o=_e.params)==null?void 0:o.friendId,(n=_e.params)==null?void 0:n.friendName):d==="mini_league"||d==="mini-league"?await Ho(t,i,(r=_e.params)==null?void 0:r.mlMatchId,(a=_e.params)==null?void 0:a.leagueId):await Ur(t,i);break}case"market":await Pa(t,i);break;case"rankings":await Oa(t,i);break;case"matches":await Ua(t,i);break;case"friends":await hr(t,i);break;case"mini-league":await $a(t,i);break;case"match-mini-league":{const d=_e.params||{};await Ho(t,i,d.mlMatchId,d.leagueId);break}default:await Fi(t,i)}}function Va(){var o,n;const t=document.getElementById("app"),e=_e.profile;if(!e)return;const i="/icons/";t.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.08.09-1547" style="cursor:pointer">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(r=>{r.addEventListener("click",a=>{a.preventDefault(),kt(r.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>kt("home")),document.getElementById("nav-credits").addEventListener("click",()=>kt("boosters")),(o=document.getElementById("journal-btn"))==null||o.addEventListener("click",()=>Ya()),(n=document.getElementById("settings-btn"))==null||n.addEventListener("click",()=>kt("settings"))}async function Ya(){const{data:t}=await y.from("patch_notes").select("*").eq("is_published",!0).order("published_at",{ascending:!1}).limit(20),e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px";const i=(t||[]).map(o=>{const n=new Date(o.published_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"long",year:"numeric"});return`<div style="padding:14px 0;border-bottom:1px solid #f0f0f0">
      ${o.image_url?`<img src="${o.image_url}" style="width:100%;max-height:160px;object-fit:cover;border-radius:8px;margin-bottom:10px">`:""}
      <div style="font-size:12px;color:#999;margin-bottom:4px">${n}</div>
      <div style="font-size:15px;font-weight:900;margin-bottom:6px">${o.title}</div>
      <div style="font-size:13px;color:#444;line-height:1.6;white-space:pre-line">${o.description}</div>
  ...
  <div id="public-landing">
  ...
  </div>`,(o=t.querySelector("#pl-play-btn"))==null||o.addEventListener("click",e)}async function Ja(){_i(li()),document.getElementById("modal-overlay").addEventListener("click",o=>{o.target===o.currentTarget&&eo()}),document.getElementById("modal-close").addEventListener("click",eo);const{data:{session:t}}=await y.auth.getSession();if(!t){Vo(),Wa(document.getElementById("app"),{onPlay:()=>zo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:bt})});return}_e.user=t.user,await ai(),_i(li()),Vo();try{const{data:o}=await y.from("formation_links_overrides").select("formation, links"),n={};(o||[]).forEach(r=>{n[r.formation]=r.links}),Pn(n)}catch(o){console.warn("Impossible de charger les overrides de formation:",o)}if(!_e.profile){Nn(document.getElementById("app"),{state:_e,navigate:async()=>{await ai(),_i(li()),Oi()},toast:bt,refreshProfile:ai});return}y.rpc("heartbeat").then(()=>{}).catch(()=>{}),setInterval(()=>{y.rpc("heartbeat").then(()=>{}).catch(()=>{})},45e3);const e=Array.isArray(_e.profile.pending_boosters)?_e.profile.pending_boosters:[];if(!_e.profile.onboarding_done&&e.length>0){or(document.getElementById("app"),{state:_e,toast:bt,refreshProfile:ai,navigate:()=>{Oi(),setTimeout(()=>To(_e.profile,kt,bt),800)}});return}Oi(),new URLSearchParams(location.search).get("tutorial")==="1"?(history.replaceState({},"",location.pathname),setTimeout(()=>bn(_e.profile,kt,bt),800)):setTimeout(()=>To(_e.profile,kt,bt),800),y.auth.onAuthStateChange(async(o,n)=>{o==="SIGNED_OUT"&&(_e.user=null,_e.profile=null,document.getElementById("app").innerHTML="",zo(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:bt}))})}function Xa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function qi(){const t=document.getElementById("app");t&&(t.style.height=Xa()+"px")}window.addEventListener("resize",qi);window.addEventListener("orientationchange",()=>setTimeout(qi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",qi);function Oi(){const t=()=>{var i;(i=_e.user)!=null&&i.id&&y.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",_e.user.id).then(()=>{})};t(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(t,6e4);const e=document.getElementById("app");e.style.display="flex",e.style.flexDirection="column",qi(),Va(),Tn()}function Vo(){const t=document.getElementById("app-loader"),e=document.getElementById("app");e&&(e.style.display=""),t&&(t.classList.add("zoom-out"),setTimeout(()=>t.style.display="none",500))}function Mn(t){var o;const e=document.getElementById("app-loader");if(e&&(e.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
    ...
    <button id="boot-retry" style="margin-top:8px;padding:12px 30px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer">Réessayer</button>`,document.body.appendChild(i),(o=document.getElementById("boot-retry"))==null||o.addEventListener("click",()=>window.location.reload())}Ja().catch(t=>{console.error("Échec du démarrage:",t),Mn()});setTimeout(()=>{const t=document.getElementById("app-loader");t&&t.style.display!=="none"&&!t.classList.contains("zoom-out")&&!document.getElementById("boot-error")&&Mn("Le serveur met trop de temps à répondre.")},12e3);
