...
import{s as w,F as ci,r as Ie,j as At,l as Ki,m as jt,h as pi,n as _n,o as kn,T as Yt,k as $n,p as En,b as Ln}from"./formation-links-TDtFd05S.js";const Tn="/";function Ai(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,l,c,d,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();c&&(c.style.background=r,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{r=c.target.value,document.getElementById("swatch2").style.background=r,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(u){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(u){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await In(t.user.id),await a(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function In(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Mn="modulepreload",Sn=function(e){return"/"+e},ji={},Vi=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(l=>{if(l=Sn(l),l in ji)return;ji[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":Mn,c||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),c)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},zt="#1A6B3C",It="#cc2222",An="#D4A017",Ci="#888";async function jn(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const Dn="2026.07.16-1218";async function Bi(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",j=>{G=j.target.value.toLowerCase(),M()}),e.querySelectorAll(".filter-btn").forEach(j=>{j.addEventListener("click",()=>{E=j.dataset.job,_(),M()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,_(),M()})):(z.innerHTML=`
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(z=>{z.addEventListener("click",()=>{C=z.dataset.tab,E="Tous",G="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(j=>{const F=j.dataset.tab===C;j.style.borderBottomColor=F?"var(--green)":"transparent",j.style.color=F?"var(--green)":"var(--gray-600)"}),_(),M()})}),_(),M()}function Zn(e,t,i){const n=Se[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=r[t==null?void 0:t.color]||r.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(se=document.getElementById("close-detail"))==null||se.addEventListener("click",s);let M=new Set;const H=()=>{const V=M.size,J=document.getElementById("sell-action-panel");if(!J)return;J.style.display=V>0?"block":"none",document.getElementById("sell-selected-count").textContent=V;const R=document.getElementById("evolve-btn");R&&(R.textContent=`⬆️ Évoluer ${V>1?"(+"+V+")":""}`)};document.querySelectorAll(".expl-check").forEach(V=>{V.addEventListener("change",()=>{const J=V.dataset.id;V.checked?M.add(J):M.delete(J);const R=V.closest(".exemplaire-row");R&&(R.style.borderColor=V.checked?"#1A6B3C":"#eee"),H()})}),document.querySelectorAll(".exemplaire-row").forEach(V=>{V.addEventListener("click",J=>{if(J.target.closest("button")||J.target.tagName==="INPUT")return;const R=V.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(V=>{V.addEventListener("click",J=>{J.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${V.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(ce=document.getElementById("evolve-btn"))==null||ce.addEventListener("click",async()=>{if(g<=1)return;const V=[...M];if(!V.length)return;if(M.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const _=window.innerWidth>=700,M=(R,z,j)=>{var xe,je;const F=(t.gcDefs||[]).find(qe=>qe.name===R.gc_type),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[F==null?void 0:F.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",U={purple:"#b06ce0",light_blue:"#00d4ef"}[F==null?void 0:F.color]||"#b06ce0",B=(F==null?void 0:F.name)||R.gc_type,O=(F==null?void 0:F.effect)||((xe=Se[R.gc_type])==null?void 0:xe.desc)||"",ve=F!=null&&F.image_url?`/icons/${F.image_url}`:null,we=((je=Se[R.gc_type])==null?void 0:je.icon)||"⚡",be=Math.round(j*.22),ge=Math.round(j*.22),ke=j-be-ge,$e=B.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
  ...
  <div id="match-history-panel">
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${Ut(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            </div>`}}catch(K){console.error("[Ranked] MMR update error:",K)}(Y=document.getElementById("pvp-end-overlay"))==null||Y.remove();const q=document.createElement("div");q.id="pvp-end-overlay",q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const P=T?"🤝":S?"🏆":"😞",X=T?"MATCH NUL":S?"VICTOIRE !":"DÉFAITE",Q=T?"#fff":S?"#FFD700":"#ff6b6b";q.innerHTML=`
      ...
      ${D}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(oe=q.querySelector("#pvp-end-home"))==null||oe.addEventListener("click",()=>{q.remove(),Ne(e),m(r?"ranked":"home")})}const Z=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(C)return;C=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),te(L);return}if(L.game_state){const I=y;y=L.game_state;const S=y._lastGC;if(S&&S.seq&&!ne.has(S.seq)&&(ne.add(S.seq),S.by!==p)){R(S.type,S.by,()=>de());return}const T=I[p+"Score"]||0,D=I[x+"Score"]||0,q=y[p+"Score"]||0,P=y[x+"Score"]||0,X=q>T,Q=P>D;if((X||Q)&&!N.has(y.round)){N.add(y.round);const Y=[...y.log||[]].reverse().find(K=>K.isGoal),oe=((Y==null?void 0:Y.homePlayers)||[]).map(K=>({name:K.name,note:K.note,portrait:K.portrait,job:K.job}));Ze(oe,q,P,X,()=>de());return}de()}}catch(I){console.error("[PvP] crash:",I)}}).subscribe();async function A(k){Object.assign(y,k),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&f("Erreur de synchronisation","error");try{de()}catch(I){console.error("[PvP] renderPvpScreen crash:",I)}}async function _(){if(C)return;C=!0,E&&(clearInterval(E),E=null);const k=n?h.away_id:h.home_id,L=n?"p2":"p1",I=n?"p1":"p2",S={...y,[L+"Score"]:3,[I+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:S.p1Score||0,away_score:S.p2Score||0,game_state:S}).eq("id",i)}catch{}try{w.removeChannel(Z)}catch{}setTimeout(()=>{Ne(e),m("home")},800)}const M={BOOST_STAT:({value:k=1,count:L=1,roles:I=[]},S,T)=>{const D=S[p+"Team"],q=Object.entries(D).filter(([P])=>!I.length||I.includes(P)).flatMap(([P,X])=>X.filter(Q=>!Q.used).map(Q=>({...Q,_line:P})));if(!q.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(S);return}H(q,L,`Choisir ${L} joueur(s) à booster (+${k})`,P=>{P.forEach(X=>{const Q=(D[X._line]||[]).find(Y=>Y.cardId===X.cardId);Q&&(Q.boost=(Q.boost||0)+k,S.log.push({text:`⚡ +${k} sur ${Q.name}`,type:"info"}))}),S[p+"Team"]=D,T(S)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:I=[],target:S="ai"},T,D)=>{const q=S==="home"?p:x,P=T[q+"Team"],X=S==="home"?"allié":"adverse",Q=Object.entries(P).filter(([Y])=>!I.length||I.includes(Y)).flatMap(([Y,oe])=>oe.map(K=>({...K,_line:Y})));if(!Q.length){T.log.push({text:`🎯 Aucun joueur ${X}`,type:"info"}),D(T);return}H(Q,L,`Choisir ${L} joueur(s) ${X}(s) (-${k})`,Y=>{Y.forEach(oe=>{const K=(P[oe._line]||[]).find(re=>re.cardId===oe.cardId);K&&(K.boost=(K.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${K.name}`,type:"info"}))}),T[q+"Team"]=P,D(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:I="ai"},S,T)=>{const D=I==="home"?p:x,q=S[D+"Team"],P=I==="home"?"allié":"adverse",X=Object.entries(q).filter(([Q])=>!L.length||L.includes(Q)).flatMap(([Q,Y])=>Y.filter(oe=>!oe.used).map(oe=>({...oe,_line:Q})));if(!X.length){S.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),T(S);return}H(X,k,`Choisir ${k} joueur(s) ${P}(s) à exclure`,Q=>{const Y="usedCardIds_"+D,oe=new Set(S[Y]||[]);Q.forEach(K=>{const re=(q[K._line]||[]).find(pe=>pe.cardId===K.cardId);re&&(re.used=!0,oe.add(K.cardId),S.log.push({text:`❌ ${re.name} exclu !`,type:"info"}))}),S[Y]=[...oe],S[D+"Team"]=q,T(S)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},I,S)=>{const T=I[p+"Team"],D=Object.entries(T).filter(([q])=>!L.length||L.includes(q)).flatMap(([q,P])=>P.filter(X=>X.used).map(X=>({...X,_line:q})));if(!D.length){I.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(I);return}H(D,k,`Choisir ${k} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const X=(T[P._line]||[]).find(Q=>Q.cardId===P.cardId);X&&(X.used=!1,I.log.push({text:`💫 ${X.name} ressuscité !`,type:"info"}))}),I[p+"Team"]=T,S(I)})},REMOVE_GOAL:({},k,L)=>{const I=x+"Score";k[I]>0?(k[I]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[x+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,I)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),I(L)},CUSTOM:({},k,L)=>L(k)};function H(k,L,I,S){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let D=[];function q(){var X,Q;const P=k.map(Y=>{const oe={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[Y._line]||"#555",K=Be(Y,Y._line)+(Y.boost||0),pe=D.find(fe=>fe.cardId===Y.cardId)?"#FFD700":"rgba(255,255,255,0.25)",ae=Y.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${Y.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${pe};background:${oe};overflow:hidden;cursor:pointer;${ae}">
        ...
        </div>`,(X=T.querySelector("#pp-close"))==null||X.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(Y=>{Y.addEventListener("click",()=>{const oe=Y.dataset.cid,K=k.find(pe=>pe.cardId===oe),re=D.findIndex(pe=>pe.cardId===oe);K&&(re>-1?D.splice(re,1):D.length<L&&D.push(K),q())})}),(Q=T.querySelector("#pp-confirm"))==null||Q.addEventListener("click",()=>{T.remove(),S(D)})}q(),document.body.appendChild(T)}async function le(k,L){const S=(y["gcCardsFull_"+p]||[]).find(P=>P.id===k),T=(S==null?void 0:S._gcDef)||(y.gcDefs||[]).find(P=>{var X;return P.name===L||((X=P.name)==null?void 0:X.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),D=[...y["usedGc_"+p]||[],k],q={type:L,by:p,seq:(y._gcAnimSeq||0)+1};ne.add(q.seq),R(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const X=M[T.effect_type];if(X){const Q={...y};X(T.effect_params||{},Q,async Y=>{Y["usedGc_"+p]=D,Y._lastGC=q,Y._gcAnimSeq=q.seq,await A(Y)});return}}const P={...y};switch(L){case"Remplacement+":P.maxSubs=(P.maxSubs||3)+1,P.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const X=x+"Score";P[X]>0&&(P[X]--,P.log.push({text:"🚫 But annulé",type:"info"}));break}}P["usedGc_"+p]=D,P._lastGC=q,P._gcAnimSeq=q.seq,await A(P)})}function se(k,L){const I="usedCardIds_"+k,S=new Set(y[I]||[]);L.forEach(T=>S.add(T)),y[I]=[...S]}function ce(){for(const k of["p1","p2"]){const L=new Set(y["usedCardIds_"+k]||[]),I=y[k+"Team"];if(I)for(const S of["GK","DEF","MIL","ATT"])(I[S]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function de(){var Ve,ot,ki,$i,Ei,Li;if(y.phase==="reveal")return Le();if(y.phase==="midfield")return J();if(y.phase==="finished")return Ue();const k=y[p+"Team"],L=y[x+"Team"];ce();const I=y[p+"Score"],S=y[x+"Score"],T=y[p+"Name"],D=y[x+"Name"],q=y.phase===p+"-attack",P=y.phase===p+"-defense",X=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],Q=X.map(ee=>ee.cardId),Y=window.innerWidth>=700,oe=y[p+"Subs"]||[],K=y["usedSubIds_"+p]||[],re=oe.filter(ee=>!K.includes(ee.cardId)),pe=y["gcCardsFull_"+p]||[],ae=y["usedGc_"+p]||[],fe=pe.filter(ee=>!ae.includes(ee.id)),ye=y.boostOwner===p&&!y.boostUsed,_e=!["GK","DEF","MIL","ATT"].some(ee=>(L[ee]||[]).some(ue=>!ue.used)),ie=[...k.MIL||[],...k.ATT||[]].filter(ee=>!ee.used),Te=q&&_e&&ie.length===0?[...k.GK||[],...k.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function Ae(ee,ue,ze){var Mi,Si;const me=ee._gcDef,rt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[me==null?void 0:me.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",pt={purple:"#b06ce0",light_blue:"#00d4ef"}[me==null?void 0:me.color]||"#b06ce0",kt=(me==null?void 0:me.name)||ee.gc_type,$t=(me==null?void 0:me.effect)||((Mi=Se[ee.gc_type])==null?void 0:Mi.desc)||"",Ti=me!=null&&me.image_url?`/icons/${me.image_url}`:null,vn=((Si=Se[ee.gc_type])==null?void 0:Si.icon)||"⚡",zi=Math.round(ze*.22),Ii=Math.round(ze*.22),Vt=ze-zi-Ii,wn=kt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
      ...
      </div>`}function Me(ee,ue){return`<div id="pvp-boost-card"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(K);let re=!1;const pe=()=>{re||(re=!0,K.remove(),setTimeout(()=>I&&I(),50))};K.addEventListener("click",pe),setTimeout(pe,3e3)}function z(k,L){var K,re,pe,ae;const S=(y["gcCardsFull_"+p]||[]).find(fe=>fe.id===k),T=S==null?void 0:S._gcDef,D={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",q={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",P=(T==null?void 0:T.name)||L,X=(T==null?void 0:T.effect)||((K=Se[L])==null?void 0:K.desc)||"Carte spéciale.",Q=T!=null&&T.image_url?`/icons/${T.image_url}`:null,Y=((re=Se[L])==null?void 0:re.icon)||"⚡",oe=document.createElement("div");oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",oe.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(A,_)=>_+1).reverse().map(A=>{const _=(l||[]).filter(M=>M.matchday===A);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${A}</div>${_.map(M=>Oi(M,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
