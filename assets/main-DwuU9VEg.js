import{s as _,F as oi,h as Mt,j as zi,l as Ze,i as dn,k as ln,b as cn}from"./formation-links-CEzN0rcz.js";function xi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",O=>{q=O.target.value.toLowerCase(),Y()}),e.querySelectorAll(".filter-btn").forEach(O=>{O.addEventListener("click",()=>{K=O.dataset.job,z(),Y()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,z(),Y()})):(R.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,z(),Y()})))}function Y(){const R=document.getElementById("col-grid");R&&(F==="player"?he(R):F==="formation"?xe(R):ge(R))}function ne(R,O,S,B,U){const ie=document.getElementById("col-grid"),ee=document.getElementById("col-big");if(!ie||!ee)return;var ke=0;function _e(){const $e=window.innerWidth>=768,Me=document.getElementById("col-big"),Ee=document.getElementById("col-grid");$e&&Me&&(Me.style.minHeight="420px",Me.style.flex="1 1 auto"),$e&&Ee&&(Ee.style.height="250px",Ee.style.flexShrink="0",Ee.style.overflowX="auto",Ee.style.overflowY="hidden",Ee.style.alignItems="center",Ee.style.padding="8px 16px"),ee.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+O(R[ke])+"</div>";var Ae=ee.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ae&&Ae.addEventListener("click",function(){B(R[ke])}),requestAnimationFrame(function(){var u=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!u||!ee)){var m=ee.clientHeight-8,h=ee.clientWidth-24,y=u.offsetHeight,b=u.offsetWidth;if(y>0&&b>0&&m>40){var v=$e?2.2:1,w=Math.min(m/y,h/b,v);u.style.transform="scale("+w.toFixed(3)+")",u.style.transformOrigin="top center"}}});var Ge=window.innerWidth>=768,Ne=Ge?.76:.54,He=Math.round(140*Ne),E=Math.round(310*Ne);ie.innerHTML=R.map(function(u,m){var h=m===ke,y="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;width:"+He+"px;height:"+E+"px;"+(h?"background:rgba(212,160,23,0.35);outline:2.5px solid #D4A017;outline-offset:1px;":"");return'<div class="col-mini-item" data-idx="'+m+'" style="'+y+'">'+S(u,h)+"</div>"}).join(""),ie.querySelectorAll(".col-mini-item").forEach(function(u){u.addEventListener("click",function(){ke=Number(u.dataset.idx),_e(),u.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function D(R){var O=window.innerWidth>=768?.76:.54,S=Math.round(140*O),B=Math.round(310*O),U;if(!R||R._fake){var ie=R?R.player:null;if(!ie)return"";U=$i(ie)}else U=Vt(R,"");return'<div style="width:'+S+"px;height:"+B+'px;overflow:hidden;position:relative;flex-shrink:0"><div style="transform:scale('+O+');transform-origin:top left;position:absolute;top:0;left:0;pointer-events:none">'+U+"</div></div>"}function Q(R,O,S){O=O||100,S=S||140;var B=Mt[R]||{},U={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ie=Math.max(3,Math.round(O*.06)),ee=Object.entries(B).map(function(_e){var $e=_e[0],Me=_e[1],Ee=$e.replace(/\d+$/,""),Ae=U[Ee]||"#888",Ge=Math.round(Me.x*O),Ne=Math.round(Me.y*S);return'<circle cx="'+Ge+'" cy="'+Ne+'" r="'+ie+'" fill="'+Ae+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),ke=Math.max(1,Math.round(O/50));return'<svg viewBox="0 0 '+O+" "+S+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+O+'" height="'+S+'" fill="#1A6B3C"/><rect x="'+Math.round(O*.2)+'" y="'+Math.round(S*.02)+'" width="'+Math.round(O*.6)+'" height="'+Math.round(S*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ke+'"/><line x1="0" y1="'+Math.round(S*.5)+'" x2="'+O+'" y2="'+Math.round(S*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+ke+'"/><ellipse cx="'+Math.round(O*.5)+'" cy="'+Math.round(S*.5)+'" rx="'+Math.round(O*.18)+'" ry="'+Math.round(S*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+ke+'"/><rect x="'+Math.round(O*.2)+'" y="'+Math.round(S*.82)+'" width="'+Math.round(O*.6)+'" height="'+Math.round(S*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+ke+'"/>'+ee+"</svg>"}function ae(R,O,S){var B=S>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+S+"</div>":"",U=O?'data-form-id="'+O.id+'"':"",ie=R.length>7?14:R.length>5?16:19,ee=!!O;return"<div "+U+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ee?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ee?"":"filter:grayscale(1);opacity:0.5")+'">'+B+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ee?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ie+"px;font-weight:900;color:"+(ee?"#1A6B3C":"#aaa")+';line-height:1">'+R+'</div></div><div style="flex:1;overflow:hidden;background:'+(ee?"#1A6B3C":"#ccc")+'">'+Q(R,140,220)+"</div></div>"}function pe(R,O){var S=.54,B=Math.round(140*S),U=Math.round(305*S),ie=Math.round(U*.22),ee=U-ie,ke=R.length>7?5:7,_e=Q(R,B,ee),$e=O?"1.5px solid #2a7a40":"1px solid #ddd",Me=O?"":"filter:grayscale(1);opacity:0.45;",Ee=O?"#1A6B3C":"#bbb",Ae="#fff";return'<div style="width:'+B+"px;height:"+U+"px;border-radius:6px;border:"+$e+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Me+'"><div style="height:'+ie+"px;background:"+Ee+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+ke+"px;font-weight:900;color:"+Ae+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(B-4)+'px">'+R+'</span></div><div style="height:'+ee+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div>"}function he(R){if(j){const O=re();if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const S=O.map(B=>i.find(U=>U.player.id===B.id)||{_fake:!0,player:B,id:"fake-"+B.id});ne(S,B=>B._fake?$i(B.player):Vt(B,""),B=>B._fake?D({player:B.player,id:"x",_fake:!0}):D(B),B=>{B._fake||ki(B,i,$,t)})}else{const O=ce();if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const S={};O.forEach(U=>{const ie=U.player.id;S[ie]||(S[ie]=[]),S[ie].push(U)});const B=Object.values(S).map(U=>zn(U));ne(B,U=>{const ie=$[U.player.id]||1,ee=ie>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ie}</div>`:"",_e=i.filter($e=>$e.player.id===U.player.id&&$e.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Vt(U,ee+_e)},U=>D(U),U=>ki(U,i,$,t))}}function xe(R){const O=j?k:[...L];if(!O.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const S=O.map(B=>({formation:B,card:f.find(U=>U.formation===B)||null,owned:L.has(B)}));ne(S,({formation:B,card:U,owned:ie})=>ae(B,ie?U:null,ie?f.filter(ee=>ee.formation===B).length:0),({formation:B,owned:U})=>pe(B,U),({card:B,owned:U})=>{U&&B&&jn(B,f,t,d)})}function ge(R){const O=Object.keys(g),S=j?O.length?O:o:[...M];if(!S.length){R.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const B=S.map(U=>({type:U,gc:De[U]||{icon:"⚡",desc:""},def:g[U]||null,owned:M.has(U),card:r.find(ie=>ie.gc_type===U)||null}));ne(B,({type:U,gc:ie,def:ee,owned:ke,card:_e})=>{const $e=ke?r.filter(m=>m.gc_type===U).length:0,Me=$e>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${$e}</div>`:"",Ee=(ee==null?void 0:ee.gc_type)==="ultra_game_changer",Ae={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Ge={purple:"#b06ce0",light_blue:"#00d4ef"},Ne=Ae[ee==null?void 0:ee.color]||Ae.purple,He=Ge[ee==null?void 0:ee.color]||Ge.purple,E=(ee==null?void 0:ee.effect)||ie.desc||"",u=ee!=null&&ee.image_url?`/manager-wars/icons/${ee.image_url}`:null;return ke&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${U}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${He};background:${Ne};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${He}66;cursor:pointer">
          ${Me}
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Bt=1e3;function jn(e,t,n,a){var k,o,$;const{state:p,toast:d,closeModal:s,navigate:l,refreshProfile:c}=n,i=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const L=Mt[i]||{},M=oi[i]||[],F=290,K=360,q=20;function j(te){const ce=L[te];return ce?{x:ce.x*F,y:ce.y*K}:null}let P=`<svg width="${F}" height="${K}" viewBox="0 0 ${F} ${K}" xmlns="http://www.w3.org/2000/svg">`;for(const[te,ce]of M){const re=j(te),z=j(ce);!re||!z||(P+=`<line x1="${re.x}" y1="${re.y}" x2="${z.x}" y2="${z.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const te of Object.keys(L)){const ce=j(te);if(!ce)continue;const re=te.replace(/\d+/,""),z=r[re]||"#555";P+=`<circle cx="${ce.x}" cy="${ce.y}" r="${q}" fill="${z}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,P+=`<text x="${ce.x}" y="${ce.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${re}</text>`}return P+="</svg>",P}const x=t.filter(L=>L.formation===i);x.length;const g=!e.is_for_sale;a(`Formation ${i}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${f.map((S,B)=>{const U=z[S.id]||[],ie=S.is_for_sale,ee=U.length?U[U.length-1]:null,_e=(r.rarity==="pepite"||r.rarity==="papyte")&&S.current_note!=null?` (☆${S.current_note})`:"";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let D=new Set;const Q=()=>{const S=D.size,B=document.getElementById("sell-action-panel");B&&(B.style.display=S>0?"block":"none",document.getElementById("sell-selected-count").textContent=S,document.getElementById("sell-direct-total").textContent=(S*$).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(S=>{S.addEventListener("change",()=>{const B=S.dataset.id;S.checked?D.add(B):D.delete(B);const U=S.closest(".exemplaire-row");U&&(U.style.borderColor=S.checked?"#1A6B3C":"#eee"),Q()})}),document.querySelectorAll(".exemplaire-row").forEach(S=>{S.addEventListener("click",B=>{if(B.target.closest("button")||B.target.tagName==="INPUT")return;const U=S.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(S=>{S.addEventListener("click",B=>{B.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${S.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(ge=document.getElementById("direct-sell-btn"))==null||ge.addEventListener("click",async()=>{const S=[...D];if(!S.length)return;const B=S.length*$;if(!confirm(`Vendre ${S.length} carte${S.length>1?"s":""} ${r.surname_encoded} pour ${B.toLocaleString("fr")} crédits ? Action irréversible.`))return;await _.from("market_listings").delete().in("card_id",S),await _.from("transfer_history").delete().in("card_id",S);const{error:U}=await _.from("cards").delete().in("id",S);if(U){d(U.message,"error");return}await _.from("users").update({credits:(p.profile.credits||0)+B}).eq("id",p.profile.id),await i();const ie=document.getElementById("nav-credits");ie&&(ie.textContent=`💰 ${(p.profile.credits||0).toLocaleString("fr")}`),d(`+${B.toLocaleString("fr")} crédits ! ${S.length} carte${S.length>1?"s":""} vendue${S.length>1?"s":""}.`,"success"),l(),c("collection")}),(R=document.getElementById("market-sell-btn"))==null||R.addEventListener("click",async()=>{var ke;const S=[...D];if(!S.length){d("Sélectionne au moins un exemplaire","warning");return}const B=parseInt((ke=document.getElementById("sell-market-price"))==null?void 0:ke.value);if(!B||B<1){d("Prix invalide","error");return}const{error:U}=await _.from("cards").update({is_for_sale:!0,sale_price:B}).in("id",S);if(U){d(U.message,"error");return}const ie=S.map(_e=>({seller_id:p.profile.id,card_id:_e,price:B,status:"active"})),{error:ee}=await _.from("market_listings").insert(ie);ee&&console.warn("[Market] insert listings:",ee.message),d(`${S.length} carte${S.length>1?"s":""} mise${S.length>1?"s":""} en vente à ${B.toLocaleString("fr")} cr. chacune !`,"success"),l(),c("collection")}),(O=document.getElementById("cancel-sell-btn"))==null||O.addEventListener("click",async()=>{await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await _.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),l(),c("collection")})}const Gt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},rt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ut(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const n=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${n}.png`}function Hi(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Ui(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(n=e==null?void 0:e.clubs)!=null&&n.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Bn(e,t=44,n=58){var g;const a=e?Ut(e):null,p=e?Ui(e):null,d=Hi(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",l=rt[s]||"#555",c={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(n*.19),f=Math.round(n*.25),x=n-r-f;return e?`<div style="width:${t}px;height:${n}px;border-radius:5px;border:2px solid ${c};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`,Fn(e,t,p,n),document.getElementById("builder-back").addEventListener("click",()=>a("decks")),document.getElementById("formation-select").addEventListener("change",i=>{t.formation=i.target.value;const r=Ai(t.formation),f={};r.forEach(x=>{t.slots[x]&&(f[x]=t.slots[x])}),t.slots=f,pt(e,t,n)}),document.getElementById("save-deck").addEventListener("click",()=>Gn(t,n)),e.querySelectorAll("[data-remove-sub]").forEach(i=>{i.addEventListener("click",()=>{t.subs=t.subs.filter(r=>r!==i.dataset.removeSub),pt(e,t,n)})}),(c=document.getElementById("add-sub-btn"))==null||c.addEventListener("click",()=>{Dn(t,e,n)})}function Fn(e,t,n,a){const p=e.querySelector("#deck-field");if(!p)return;const d=Mt[t.formation]||{},s=zi(t.formation)||[],l={};for(const L of n){const M=t.slots[L],F=M?t.playerCards.find(K=>K.id===M):null;l[L]=F?F.player:null}const c=300,i=300,r=48,f=64,x=13,g=16,k=38;function o(L){const M=d[L];return M?{x:M.x*c,y:M.y*i}:null}let $="";for(const[L,M]of s){const F=o(L),K=o(M);if(!F||!K)continue;const q=l[L]?{...l[L],club_id:l[L].club_id,country_code:l[L].country_code,rarity:l[L].rarity}:null,j=l[M]?{...l[M],club_id:l[M].club_id,country_code:l[M].country_code,rarity:l[M].rarity}:null,P=Ze(q,j);P==="#ff3333"||P==="#cc2222"?$+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${K.x.toFixed(1)}" y2="${K.y.toFixed(1)}" stroke="${P}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:($+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${K.x.toFixed(1)}" y2="${K.y.toFixed(1)}" stroke="${P}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,$+=`<line x1="${F.x.toFixed(1)}" y1="${F.y.toFixed(1)}" x2="${K.x.toFixed(1)}" y2="${K.y.toFixed(1)}" stroke="${P}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const L of n){const M=o(L);if(!M)continue;const F=l[L],K=L.replace(/\d+/,""),q=rt[K]||"#555",j=(M.x-r/2).toFixed(1),P=(M.y-f/2).toFixed(1),te={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[F==null?void 0:F.rarity]||"#aaa";if(F){const ce=Ut(F),re=Ui(F),z=Hi(F.country_code),Y=Number(K==="GK"?F.note_g:K==="DEF"?F.note_d:K==="MIL"?F.note_m:F.note_a)||0,ne=f-x-g;$+=`<defs><clipPath id="dcp-${L}"><rect x="${j}" y="${(M.y-f/2+x).toFixed(1)}" width="${r}" height="${ne}"/></clipPath></defs>`,$+=`<rect x="${j}" y="${P}" width="${r}" height="${f}" rx="5" fill="${q}"/>`,ce&&($+=`<image href="${ce}" x="${j}" y="${(M.y-f/2+x).toFixed(1)}" width="${r}" height="${ne}" clip-path="url(#dcp-${L})" preserveAspectRatio="xMidYMin slice"/>`),$+=`<rect x="${j}" y="${P}" width="${r}" height="${x}" fill="rgba(255,255,255,0.93)"/>`,$+=`<text x="${M.x.toFixed(1)}" y="${(M.y-f/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(F.surname_encoded||"").slice(0,9)}</text>`;const D=(M.y+f/2-g).toFixed(1);$+=`<rect x="${j}" y="${D}" width="${r}" height="${g}" fill="rgba(255,255,255,0.93)"/>`,z&&($+=`<image href="${z}" x="${(M.x-21).toFixed(1)}" y="${(M.y+f/2-g+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),$+=`<text x="${M.x.toFixed(1)}" y="${(M.y+f/2-g/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Y}</text>`,re&&($+=`<image href="${re}" x="${(M.x+r/2-14).toFixed(1)}" y="${(M.y+f/2-g+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),$+=`<rect x="${j}" y="${P}" width="${r}" height="${f}" rx="5" fill="none" stroke="${te}" stroke-width="2"/>`}else $+=`<rect x="${j}" y="${P}" width="${r}" height="${f}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,$+=`<text x="${M.x.toFixed(1)}" y="${M.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,$+=`<text x="${M.x.toFixed(1)}" y="${(M.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${K}</text>`;$+=`<rect x="${j}" y="${P}" width="${r}" height="${f}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${L}" style="cursor:pointer"/>`}p.innerHTML=`<svg viewBox="${-k} ${-k} ${c+k*2} ${i+k*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${$}</svg>`,p.querySelectorAll(".deck-slot-hit").forEach(L=>{L.addEventListener("click",()=>qn(L.dataset.pos,t,e,a))})}function qn(e,t,n,a){var x,g,k;const{openModal:p,closeModal:d}=a,s=e.replace(/\d+/,""),l=t.slots[e],c=l?t.playerCards.find(o=>o.id===l):null;(x=c==null?void 0:c.player)==null||x.id;const i=new Set;Object.entries(t.slots).forEach(([o,$])=>{var M;if(o===e||!$)return;const L=t.playerCards.find(F=>F.id===$);(M=L==null?void 0:L.player)!=null&&M.id&&i.add(L.player.id)}),t.subs.forEach(o=>{var L;const $=t.playerCards.find(M=>M.id===o);(L=$==null?void 0:$.player)!=null&&L.id&&i.add($.player.id)});const r=new Set,f=t.playerCards.filter(o=>{const $=o.player;return!($.job===s||$.job2===s)||i.has($.id)||r.has($.id)?!1:(r.add($.id),!0)});f.sort((o,$)=>{const L=s==="GK"?o.player.note_g:s==="DEF"?o.player.note_d:s==="MIL"?o.player.note_m:o.player.note_a;return(s==="GK"?$.player.note_g:s==="DEF"?$.player.note_d:s==="MIL"?$.player.note_m:$.player.note_a)-L}),p(`Choisir ${s} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${f.length>0?f.map(o=>{var K,q;const $=o.player,L=s==="GK"?$.note_g:s==="DEF"?$.note_d:s==="MIL"?$.note_m:$.note_a,M=Ut($),F={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[$.rarity];return`<div class="player-option" data-card-id="${o.id}"
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(k=>{k.addEventListener("click",()=>{const o=k.dataset.id,$=d.find(M=>M.id===o);if(!$)return;const L=s.findIndex(M=>M.gc_type===$.gc_type);L>-1?s.splice(L,1):s.length<3&&s.push($),i()})}),(f=e.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{r&&c(s)}),(x=e.querySelector("#gc-no-gc"))==null||x.addEventListener("click",()=>c([])),(g=e.querySelector("#gc-reset"))==null||g.addEventListener("click",()=>{s.length&&(s=[],i())})}i()}function ro(e){var a;const t=((a=e==null?void 0:e.state)==null?void 0:a.params)||{},n=t.matchMode||"vs_ai_easy";return n==="friend"?`Match vs ${t.friendName||"Ami"}`:n==="random"?"Match vs Random":`Match vs IA — ${n.replace("vs_ai_","").toUpperCase()}`}async function ao(e,t,n){const{state:a,navigate:p}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await _.from("decks").select("id,name,is_active,formation").eq("owner_id",a.profile.id).order("created_at",{ascending:!1});if(!d||d.length===0){at(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>p("decks"));return}const s=d.map(r=>r.id),{data:l}=await _.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let c=0;function i(){var M,F,K,q,j;const r=d[c],f=(l||[]).filter(P=>P.deck_id===r.id),x=f.filter(P=>{var te;return P.is_starter&&((te=P.card)==null?void 0:te.player)}).map(P=>Zt(P.card,P.position)),g=f.find(P=>{var te;return((te=P.card)==null?void 0:te.card_type)==="formation"}),k=r.formation||((M=g==null?void 0:g.card)==null?void 0:M.formation)||"4-4-2",o=x.length>=11?gt(x,k):null,$=x.length>=11;Xe(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${o.map((F,K)=>{const q=K<o.length-1?Ze(F,o[K+1]):null,j=!q||q==="#ff3333"||q==="#cc2222",P=q==="#00ff88"?"+2":q==="#FFD700"?"+1":"";return`
          <div class="duel-card duel-card-${M}" data-idx="${K}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${Ve({...F,note:we(F,"MIL"),_line:"MIL"},58,78)}
          </div>
          ${K<o.length-1?`<div class="duel-link duel-link-${M}" data-idx="${K}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${j?"rgba(255,255,255,0.12)":q};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${j?"none":`0 0 8px ${q}`}">
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
  ...
  </div>`;const f=()=>{const o=($,L)=>e.querySelectorAll($).forEach((M,F)=>{setTimeout(()=>{M.style.opacity="1",M.style.transform="translateY(0) scale(1)"},L+F*90)});o(".duel-card-home",150),o(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach(($,L)=>{setTimeout(()=>{$.style.opacity="1"},L*70)}),900),setTimeout(()=>{const $=e.querySelector("#vs-label");$&&($.style.opacity="1",$.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(L=>L.style.opacity="1")},1250),setTimeout(()=>{x("score-home",l,800),x("score-ai",c,800)},1500)};function x(o,$,L){const M=document.getElementById(o);if(!M)return;const F=performance.now(),K=q=>{const j=Math.min(1,(q-F)/L);M.textContent=Math.round($*(1-Math.pow(1-j,3))),j<1?requestAnimationFrame(K):M.textContent=$};requestAnimationFrame(K)}requestAnimationFrame(f),t.attacker=i?"home":"ai";const g=i?li():null;i&&(t.boostCard={value:g}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:a.map(o=>({name:o.name,note:we(o,"MIL"),portrait:Le(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),aiPlayers:p.map(o=>({name:o.name,note:we(o,"MIL"),portrait:Le(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),homeTotal:l,aiTotal:c,text:`Duel milieu : ${t.clubName} ${l} – ${c} IA → ${i?t.clubName+" attaque":"IA attaque"}`});const k=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",ze(e,t,n),t.attacker==="ai"&&setTimeout(()=>ti(e,t,n),800)};setTimeout(()=>{const o=document.getElementById("score-home"),$=document.getElementById("score-ai"),L=document.getElementById(i?"duel-row-home":"duel-row-ai"),M=document.getElementById(i?"duel-row-ai":"duel-row-home"),F=i?o:$,K=i?$:o;F&&(F.style.fontSize="80px",F.style.color=i?"#FFD700":"#ff6b6b",F.style.animation="duelPulse .5s ease"+(i?", duelGlow 1.5s ease infinite .5s":"")),K&&(K.style.opacity="0.25"),setTimeout(()=>{L&&(L.style.transformOrigin="center",L.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",L.style.zIndex="5"),setTimeout(()=>{var j;const q=document.getElementById("duel-shock");if(q){const P=(j=M||L)==null?void 0:j.getBoundingClientRect(),te=e.querySelector(".match-screen").getBoundingClientRect();P&&(q.style.top=P.top-te.top+P.height/2+"px"),q.style.animation="shockwave .5s ease-out forwards"}M&&(M.style.transformOrigin="center",M.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var j;const q=document.getElementById("duel-finale");q&&(q.innerHTML=`
    ...
    <div style="display:flex;align-items:center;gap:4px;${t?"flex-direction:row-reverse":""};background:rgba(255,255,255,0.04);border-radius:8px;padding:5px 8px;border:1px solid rgba(255,255,255,0.07)">
      ...
      ${nt(e.inPlayer||{})}
    </div>`}return`<div style="font-size:11px;color:${e.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${e.type==="goal"?700:400};padding:3px 2px">${e.text||""}</div>`}function ze(e,t,n){var F,K,q,j,P,te,ce,re;const a=t.selected.map(z=>z.cardId),p=t.usedSubIds||[],d=t.homeSubs.filter(z=>!p.includes(z.cardId)),l=Object.values(t.homeTeam).flat().filter(z=>z.used).length>0&&d.length>0&&t.subsUsed<t.maxSubs,c=!["GK","DEF","MIL","ATT"].some(z=>(t.aiTeam[z]||[]).some(Y=>!Y.used)),i=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(z=>!z.used),r=t.phase==="attack"&&c&&i.length===0?[...t.homeTeam.GK||[],...t.homeTeam.DEF||[]].filter(z=>!z.used).map(z=>z.cardId):[];t.log[t.log.length-1];const f=t.phase==="ai-attack"||t.phase==="ai-defense",x=t.phase==="attack",g=t.phase==="defense",k=t.phase==="finished",o=t.gcCards.filter(z=>!t.usedGc.includes(z.id)),$=t.boostCard&&!t.boostUsed;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column",e.innerHTML=`
  <style>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const Y=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const z=t.log[t.log.length-1];return z?'<div style="padding:2px 4px">'+fo(z)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const z=window.innerWidth>=700,Y=(R,O,S)=>{var Ne,He;const B=(t.gcDefs||[]).find(E=>E.name===R.gc_type),U={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[B==null?void 0:B.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ie={purple:"#b06ce0",light_blue:"#00d4ef"}[B==null?void 0:B.color]||"#b06ce0",ee=(B==null?void 0:B.name)||R.gc_type,ke=(B==null?void 0:B.effect)||((Ne=De[R.gc_type])==null?void 0:Ne.desc)||"",_e=B!=null&&B.image_url?`/manager-wars/icons/${B.image_url}`:null,$e=((He=De[R.gc_type])==null?void 0:He.icon)||"⚡",Me=Math.round(S*.22),Ee=Math.round(S*.22),Ae=S-Me-Ee,Ge=ee.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          ...
          <div style="height:${Me}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Ge}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${O-6}px">${ee}</span>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(z=>{var Y,ne,D;if(z.type==="duel"){const Q=z.isGoal,ae=z.homeScored?"#FFD700":Q?"#ff6b6b":"rgba(255,255,255,0.3)",pe=z.homeScored?"⚽ BUT !":Q?"⚽ BUT IA !":(Y=z.homePlayers)!=null&&Y.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${Q?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${ae};margin-bottom:4px">
                <div style="font-size:9px;color:${ae};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${pe}</div>
                ${(ne=z.homePlayers)!=null&&ne.length?`<div style="margin-bottom:3px">${it(z.homePlayers,"rgba(255,255,255,0.7)",z.homeTotal)}</div>`:""}
                ${(D=z.aiPlayers)!=null&&D.length?`<div style="opacity:0.7">${it(z.aiPlayers,"#ff6b6b",z.aiTotal)}</div>`:""}
  ...
  </div>`;function L(){const z=e.querySelector(".match-screen");if(!z)return;const Y=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);z.style.bottom="auto",z.style.height=Y+"px",z.style.minHeight=Y+"px",z.style.maxHeight=Y+"px",z.style.overflow="hidden";const ne=e.querySelector("#mobile-action-bar"),D=e.querySelector("#mobile-play-area");ne&&D&&(D.style.paddingBottom=ne.offsetHeight+"px")}if(L(),setTimeout(L,120),setTimeout(L,400),setTimeout(L,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",L),window.visualViewport.addEventListener("scroll",L)),window.addEventListener("resize",L)),function(){const Y=e.querySelector(".terrain-wrapper svg");Y&&(Y.removeAttribute("width"),Y.removeAttribute("height"),Y.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Y.setAttribute("viewBox","-26 -26 352 352"),Y.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const z=e.querySelector(".terrain-wrapper svg");z&&(z.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0")})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let z=!1,Y=30;const ne=()=>document.getElementById("match-timer"),D=()=>{const Q=ne();if(!Q)return;const ae=String(Math.floor(Y/60)).padStart(2,"0"),pe=String(Y%60).padStart(2,"0");Q.textContent=` ${ae}:${pe}`,Q.style.color=z?"#ff2222":"#ff9500",Q.style.fontWeight="900"};D(),t._timerInt=setInterval(()=>{if(Y--,Y<0)if(!z)z=!0,Y=15,D();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const Q=document.createElement("div");Q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",Q.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(Q),setTimeout(()=>{Q.remove(),At(e,t,n)},2500)}else D()},1e3)}(F=document.getElementById("match-quit"))==null||F.addEventListener("click",()=>{Oe(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,At(e,t,n))}),(K=document.getElementById("view-ai"))==null||K.addEventListener("click",()=>$o(t,n)),(q=document.getElementById("toggle-history"))==null||q.addEventListener("click",()=>{var z;(z=document.getElementById("match-history-panel"))==null||z.classList.add("open")}),(j=document.getElementById("close-history"))==null||j.addEventListener("click",()=>{var z;(z=document.getElementById("match-history-panel"))==null||z.classList.remove("open")}),(P=document.getElementById("btn-action"))==null||P.addEventListener("click",()=>{t.selected.length!==0&&(x?mo(e,t,n):g&&xo(e,t,n))}),(te=document.getElementById("btn-results"))==null||te.addEventListener("click",()=>At(e,t,n)),e.querySelectorAll(".match-slot-hit").forEach(z=>{z.addEventListener("click",()=>go(z,t,e,n))}),e.querySelectorAll(".match-used-hit").forEach(z=>{z.addEventListener("click",()=>Yt(e,t,n,null,z.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(z=>{z.addEventListener("click",()=>bo(z.dataset.gcId,z.dataset.gcType,e,t,n))}),(ce=document.getElementById("boost-card"))==null||ce.addEventListener("click",()=>_o(e,t,n)),e.querySelectorAll(".sub-btn-col").forEach(z=>{z.addEventListener("click",()=>Yt(e,t,n,z.dataset.subId))}),(re=document.getElementById("sub-btn-main"))==null||re.addEventListener("click",()=>Yt(e,t,n))}function go(e,t,n,a){const p=e.dataset.cardId,d=e.dataset.role,s=t.selected.findIndex(l=>l.cardId===p);if(s!==-1)t.selected.splice(s,1);else{if(t.selected.length>=3){a.toast("Maximum 3 joueurs","error");return}const l=(t.homeTeam[d]||[]).find(c=>c.cardId===p);l&&t.selected.push({...l,_role:d,_line:d})}ze(n,t,a)}function ui(e,t,n){e.matchId&&_.from("matches").update({last_player_id:n}).eq("id",e.matchId).then(()=>{})}function mo(e,t,n){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),ui(t,n,n.state.profile.id);const a=!["GK","DEF","MIL","ATT"].some(s=>(t.aiTeam[s]||[]).some(l=>!l.used)),p=t.selected.map(s=>{const l=(t.homeTeam[s._role]||[]).find(i=>i.cardId===s.cardId)||s,c=a&&["GK","DEF"].includes(s._role);return{...l,_line:s._role,...c?{note_a:Math.max(1,Number(l.note_a)||0)}:{}}}),d=Rt(p,t.modifiers.home);t.pendingAttack={...d,players:[...p],side:"home"},t.selected.forEach(s=>{const l=(t.homeTeam[s._role]||[]).find(c=>c.cardId===s.cardId);l&&(l.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${d.total} (base ${d.base}${d.links?` +${d.links} liens`:""}) — ${t.selected.map(s=>s.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",ze(e,t,n),setTimeout(()=>yo(e,t,n),1200)}function xo(e,t,n){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),ui(t,n,n.state.profile.id);const a=t.selected.map(l=>({...(t.homeTeam[l._role]||[]).find(i=>i.cardId===l.cardId)||l,_line:l._role})),p=Ot(a,t.modifiers.home);t.selected.forEach(l=>{const c=(t.homeTeam[l._role]||[]).find(i=>i.cardId===l.cardId);c&&(c.used=!0)});const d=Ht(t.pendingAttack.total,p.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>({name:l.name,note:l._line==="MIL"?l.note_m:l.note_a,portrait:Le(l),job:l.job,country_code:l.country_code,rarity:l.rarity,clubName:l.clubName,clubLogo:l.clubLogo})),homePlayers:t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(i=>i.cardId===l.cardId)||l;return{name:c.name,note:(c._line==="GK"?Number(c.note_g)||0:c._line==="MIL"?Number(c.note_m)||0:Number(c.note_d)||0)+(c.boost||0),portrait:Le(c),job:c.job,country_code:c.country_code,rarity:c.rarity,clubName:c.clubName,clubLogo:c.clubLogo}}),homeTotal:p.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(d.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(d.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${p.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,ze(e,t,n),Nt(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{ct(e,t,n,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${p.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,ct(e,t,n,"home-attack")}function ti(e,t,n){ui(t,n,null);const a=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]],p=qi(a,"attack",t.difficulty);if(!p.length){qt(e,t,n);return}const d=Rt(p,t.modifiers.ai);t.pendingAttack={...d,players:p,side:"ai"},p.forEach(i=>{i.used=!0}),t.log.push({text:`🤖 IA attaque : ${d.total} (${p.map(i=>i.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(i=>!i.used),c=(t.homeSubs||[]).filter(i=>!(t.usedSubIds||[]).includes(i.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){t.aiScore++;const i={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:p.map(r=>({name:r.name,note:r._line==="MIL"?r.note_m:r.note_a,portrait:Le(r),job:r.job,country_code:r.country_code,rarity:r.rarity,clubName:r.clubName,clubLogo:r.clubLogo})),aiTotal:d.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(i),t.pendingAttack=null,ze(e,t,n),Nt(i.aiPlayers,t.homeScore,t.aiScore,!1,()=>{ct(e,t,n,"home-attack")});return}t.phase="defense",ze(e,t,n)}function yo(e,t,n){var i,r;const a=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],p=qi(a,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(t.aiTeam[f]||[]).filter(x=>!x.used)).length){t.homeScore++;const x={type:"duel",isGoal:!0,homeScored:!0,homePlayers:(((i=t.pendingAttack)==null?void 0:i.players)||[]).map(g=>({name:g.name,note:we(g,g._line||g.job),portrait:Le(g),job:g.job,country_code:g.country_code,rarity:g.rarity,clubName:g.clubName,clubLogo:g.clubLogo})),homeTotal:((r=t.pendingAttack)==null?void 0:r.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(x),t.modifiers.ai={},t.pendingAttack=null,ze(e,t,n),Nt(x.homePlayers,t.homeScore,t.aiScore,!0,()=>{ct(e,t,n,"ai-attack")});return}const s=p.length>0?Ot(p,t.modifiers.ai).total:0;p.forEach(f=>{f.used=!0});const l=Ht(t.pendingAttack.total,s,t.modifiers.ai),c={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(f=>({name:f.name,note:f._line==="MIL"?f.note_m:f.note_a,portrait:Le(f),job:f.job,country_code:f.country_code,rarity:f.rarity,clubName:f.clubName,clubLogo:f.clubLogo})),aiPlayers:p.map(f=>({name:f.name,note:f._line==="GK"?f.note_g:f._line==="MIL"?f.note_m:f.note_d,portrait:Le(f),job:f.job,country_code:f.country_code,rarity:f.rarity,clubName:f.clubName,clubLogo:f.clubLogo})),homeTotal:t.pendingAttack.total,aiTotal:s,isGoal:!1,homeScored:!1,text:""};if(l.shielded)c.text="🛡️ Bouclier IA !",t.log.push(c);else if(l.goal){t.homeScore++,c.isGoal=!0,c.homeScored=!0,c.text=`⚽ BUT ! (${t.pendingAttack.total} > ${s})`,t.log.push(c),t.modifiers.ai={},t.pendingAttack=null,ze(e,t,n),Nt(c.homePlayers,t.homeScore,t.aiScore,!0,()=>{ct(e,t,n,"ai-attack")});return}else c.text=`🧤 IA défend (${s} ≥ ${t.pendingAttack.total})`,t.log.push(c);t.modifiers.ai={},t.pendingAttack=null,ct(e,t,n,"ai-attack")}function ct(e,t,n,a){if(t.round++,nn(t)){At(e,t,n);return}if(a==="home-attack"){if(![...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(d=>!d.used).length){if(![...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used).length){qt(e,t,n);return}if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(l=>!l.used).length){qt(e,t,n);return}setTimeout(()=>ti(e,t,n),100);return}t.phase="attack",ze(e,t,n)}else{if(![...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(d=>!d.used).length){qt(e,t,n);return}t.phase="ai-attack",ze(e,t,n),setTimeout(()=>ti(e,t,n),800)}}function nn(e){const t=["MIL","ATT","GK","DEF"].some(a=>(e.homeTeam[a]||[]).some(p=>!p.used)),n=["MIL","ATT","GK","DEF"].some(a=>(e.aiTeam[a]||[]).some(p=>!p.used));return!t&&!n}function qt(e,t,n){nn(t)?At(e,t,n):(t.phase="attack",ze(e,t,n))}function ho(e,t,n){const a=document.createElement("div");a.style.cssText=`
    position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:800;
    display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;
    animation:subFadeIn 0.2s ease;
  `;const p=Le(e),d=Le(t),s=ft[e.job]||"#555",l=ft[t.job]||"#555",c=e.job==="GK"?e.note_g:e.job==="DEF"?e.note_d:e.job==="MIL"?e.note_m:e.note_a,i=t.job==="GK"?t.note_g:t.job==="DEF"?t.note_d:t.job==="MIL"?t.note_m:t.note_a;a.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(a);let r=!1;const f=()=>{r||(r=!0,a.remove(),n())};a.addEventListener("click",f),setTimeout(f,2e3)}function _t(e,t="rgba(0,0,0,0.8)"){const n=document.createElement("div");n.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function Yt(e,t,n,a=null,p=null){var g,k;if(t.phase!=="attack"){_t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){_t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([o,$])=>($||[]).filter(L=>L.used).map(L=>({...L,_line:L._line||o}))),s=t.homeSubs.filter(o=>!t.usedSubIds.includes(o.cardId));if(!d.length){_t("Aucun joueur utilisé à remplacer");return}if(!s.length){_t("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(o=>o.cardId===p));const c=((g=d[l])==null?void 0:g._line)||((k=d[l])==null?void 0:k.job);let i=a?Math.max(0,s.findIndex(o=>o.cardId===a)):Math.max(0,s.findIndex(o=>o.job===c)),r=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function x(){var q,j,P,te,ce,re;const o=d[l],$=s[i],L=Math.min(130,Math.round((window.innerWidth-90)/2)),M=Math.round(L*1.35),F=z=>`background:rgba(255,255,255,0.12);border:none;color:${z?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${z?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${$?Ve({...$,used:!1,boost:0},L,M):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${o?Ve({...o,used:!1,boost:0},L,M):"<div>—</div>"}</div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(p=>{p.addEventListener("click",()=>{const d=p.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const l=(t.homeTeam[s]||[]).find(c=>c.cardId===d);if(l){l.boost=(l.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${l.name}`,type:"info"});break}}t.boostUsed=!0,n.closeModal(),ze(e,t,n)})})}function Nt(e,t,n,a,p){const d=document.createElement("div");d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const s=Array.from({length:10},(i,r)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const c=()=>{l||(l=!0,d.remove(),setTimeout(()=>p(),50))};d.addEventListener("click",c),setTimeout(c,3500)}async function At(e,t,n){var r,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=n,p=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=p?"victoire":d?"nul":"defaite",l=Tn(t.mode,s);t.matchId&&await _.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:p?a.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(a.profile.credits||0)+l,matches_played:(a.profile.matches_played||0)+1};p?c.wins=(a.profile.wins||0)+1:d?c.draws=(a.profile.draws||0)+1:c.losses=(a.profile.losses||0)+1,await _.from("users").update(c).eq("id",a.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const g=async(F=!0)=>{f=!0,x&&(_.removeChannel(x),x=null),F&&await _.rpc("cancel_matchmaking",{p_user_id:c.profile.id}).catch(()=>{})};(M=document.getElementById("mm-cancel"))==null||M.addEventListener("click",async()=>{try{await g(!0)}catch{}Oe(e),i("home")});const k=async(F,K,q)=>{if(f)return;f=!0,x&&(_.removeChannel(x),x=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(P=>setTimeout(P,600)),e.isConnected&&rn(e,t,F,q,s,l)},{data:o,error:$}=await _.rpc("try_matchmake",{p_user_id:c.profile.id,p_deck_id:n});if($||!(o!=null&&o.success)){r("Erreur de matchmaking","error"),Oe(e),i("home");return}if(o.matched){k(o.match_id,o.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),x=_.channel("matchmaking-"+c.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${c.profile.id}`},F=>{const K=F.new;K.status==="matched"&&K.match_id&&k(K.match_id,K.matched_with,!0)}).subscribe()}async function Eo(e,t,n){const{state:a,navigate:p,toast:d}=t;try{(_.getChannels?_.getChannels():[]).forEach(i=>{const r=i.topic||"";(r.includes("matchmaking")||r.includes("pvp-match")||r.includes("friend-invite"))&&_.removeChannel(i)})}catch{}const{data:s}=await _.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!s){d("Match introuvable","error"),p("home");return}if(s.status==="finished"){d("Ce match est terminé","info"),p("home");return}const l=s.home_id===a.profile.id;rn(e,t,n,l,[],[])}async function rn(e,t,n,a,p=[],d=[]){const{state:s,navigate:l,toast:c}=t,i=a?"p1":"p2",r=a?"p2":"p1",f=(p||[]).map(E=>E.id),x=(p||[]).map(E=>({id:E.id,gc_type:E.gc_type,_gcDef:E._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await _.from("matches").select("*").eq("id",n).single();if(!g){c("Match introuvable","error"),l("home");return}async function k(){const[{data:E},{data:u},{data:m},{data:h}]=await Promise.all([_.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),_.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),_.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),_.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),y=A=>({cardId:A.card_id,position:A.position,id:A.id,firstname:A.firstname,name:A.surname_encoded,country_code:A.country_code,club_id:A.club_id,job:A.job,job2:A.job2,note_g:Number(A.note_g)||0,note_d:Number(A.note_d)||0,note_m:Number(A.note_m)||0,note_a:Number(A.note_a)||0,rarity:A.rarity,skin:A.skin,hair:A.hair,hair_length:A.hair_length,clubName:A.club_encoded_name||null,clubLogo:A.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),b=((E==null?void 0:E.starters)||[]).map(A=>y(A)),v=((u==null?void 0:u.starters)||[]).map(A=>y(A)),w=(E==null?void 0:E.formation)||"4-4-2",I=(u==null?void 0:u.formation)||"4-4-2";return{p1Team:gt(b,w),p2Team:gt(v,I),p1Subs:((E==null?void 0:E.subs)||[]).map(A=>y(A)),p2Subs:((u==null?void 0:u.subs)||[]).map(A=>y(A)),p1Formation:w,p2Formation:I,p1Name:(m==null?void 0:m.club_name)||(m==null?void 0:m.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?f:[],gc_p2:a?[]:f,gcCardsFull_p1:a?x:[],gcCardsFull_p2:a?[]:x,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let o=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!o)if(a){o=await k();const{data:E}=await _.from("matches").select("game_state").eq("id",n).single();!(E!=null&&E.game_state)||!Object.keys(E.game_state).length?await _.from("matches").update({game_state:o,turn_user_id:g.home_id}).eq("id",n):o=E.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let E=0;E<30&&!o;E++){await new Promise(m=>setTimeout(m,400));const{data:u}=await _.from("matches").select("game_state").eq("id",n).single();u!=null&&u.game_state&&Object.keys(u.game_state).length&&(o=u.game_state)}if(!o){c("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=x,await _.from("matches").update({game_state:o}).eq("id",n)}let $=!1,L=null,M=!1;const F=new Set,K=new Set;function q(E){var A,T;try{_.removeChannel(j)}catch{}const u=o[i+"Score"]||0,m=o[r+"Score"]||0;let h,y;E.winner_id?(h=E.winner_id===s.profile.id,y=!1):E.forfeit?(h=u>m,y=!1):(y=u===m,h=u>m),(A=document.getElementById("pvp-end-overlay"))==null||A.remove();const b=document.createElement("div");b.id="pvp-end-overlay",b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":h?"🏆":"😞",w=y?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=y?"#fff":h?"#FFD700":"#ff6b6b";b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(T=b.querySelector("#pvp-end-home"))==null||T.addEventListener("click",()=>{b.remove(),Oe(e),l("home")})}const j=_.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},E=>{const u=E.new;try{if(u.status==="finished"||u.forfeit){if($)return;$=!0,L&&(clearInterval(L),L=null),u.game_state&&(o=u.game_state),q(u);return}if(u.game_state){const m=o;o=u.game_state;const h=o._lastGC;if(h&&h.seq&&!K.has(h.seq)&&(K.add(h.seq),h.by!==i)){xe(h.type,h.by,()=>D());return}const y=m[i+"Score"]||0,b=m[r+"Score"]||0,v=o[i+"Score"]||0,w=o[r+"Score"]||0,I=v>y,A=w>b;if((I||A)&&!F.has(o.round)){F.add(o.round);const T=[...o.log||[]].reverse().find(N=>N.isGoal),C=((T==null?void 0:T.homePlayers)||[]).map(N=>({name:N.name,note:N.note,portrait:N.portrait,job:N.job}));he(C,v,w,I,()=>D());return}D()}}catch(m){console.error("[PvP] crash:",m)}}).subscribe();async function P(E){Object.assign(o,E),o.lastActionAt=new Date().toISOString();const{error:u}=await _.from("matches").update({game_state:o}).eq("id",n);u&&c("Erreur de synchronisation","error");try{D()}catch(m){console.error("[PvP] renderPvpScreen crash:",m)}}async function te(){if($)return;$=!0,L&&(clearInterval(L),L=null);const E=a?g.away_id:g.home_id,u=a?"p2":"p1",m=a?"p1":"p2",h={...o,[u+"Score"]:3,[m+"Score"]:0,phase:"finished"};try{await _.from("matches").update({status:"finished",forfeit:!0,winner_id:E,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",n)}catch{}try{_.removeChannel(j)}catch{}setTimeout(()=>{Oe(e),l("home")},800)}const ce={BOOST_STAT:({value:E=1,count:u=1,roles:m=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!m.length||m.includes(w)).flatMap(([w,I])=>I.filter(A=>!A.used).map(A=>({...A,_line:w})));if(!v.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(h);return}re(v,u,`Choisir ${u} joueur(s) à booster (+${E})`,w=>{w.forEach(I=>{const A=(b[I._line]||[]).find(T=>T.cardId===I.cardId);A&&(A.boost=(A.boost||0)+E,h.log.push({text:`⚡ +${E} sur ${A.name}`,type:"info"}))}),h[i+"Team"]=b,y(h)})},DEBUFF_STAT:({value:E=1,count:u=1,roles:m=[],target:h="ai"},y,b)=>{const v=h==="home"?i:r,w=y[v+"Team"],I=h==="home"?"allié":"adverse",A=Object.entries(w).filter(([T])=>!m.length||m.includes(T)).flatMap(([T,C])=>C.filter(N=>!N.used).map(N=>({...N,_line:T})));if(!A.length){y.log.push({text:`🎯 Aucun joueur ${I}`,type:"info"}),b(y);return}re(A,u,`Choisir ${u} joueur(s) ${I}(s) (-${E})`,T=>{T.forEach(C=>{const N=(w[C._line]||[]).find(W=>W.cardId===C.cardId);N&&(N.boost=(N.boost||0)-E,y.log.push({text:`🎯 -${E} sur ${N.name}`,type:"info"}))}),y[v+"Team"]=w,b(y)})},GRAY_PLAYER:({count:E=1,roles:u=[],target:m="ai"},h,y)=>{const b=m==="home"?i:r,v=h[b+"Team"],w=m==="home"?"allié":"adverse",I=Object.entries(v).filter(([A])=>!u.length||u.includes(A)).flatMap(([A,T])=>T.filter(C=>!C.used).map(C=>({...C,_line:A})));if(!I.length){h.log.push({text:`❌ Aucun joueur ${w}`,type:"info"}),y(h);return}re(I,E,`Choisir ${E} joueur(s) ${w}(s) à exclure`,A=>{A.forEach(T=>{const C=(v[T._line]||[]).find(N=>N.cardId===T.cardId);C&&(C.used=!0,h.log.push({text:`❌ ${C.name} exclu !`,type:"info"}))}),h[b+"Team"]=v,y(h)})},REVIVE_PLAYER:({count:E=1,roles:u=[]},m,h)=>{const y=m[i+"Team"],b=Object.entries(y).filter(([v])=>!u.length||u.includes(v)).flatMap(([v,w])=>w.filter(I=>I.used).map(I=>({...I,_line:v})));if(!b.length){m.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(m);return}re(b,E,`Choisir ${E} joueur(s) à ressusciter`,v=>{v.forEach(w=>{const I=(y[w._line]||[]).find(A=>A.cardId===w.cardId);I&&(I.used=!1,m.log.push({text:`💫 ${I.name} ressuscité !`,type:"info"}))}),m[i+"Team"]=y,h(m)})},REMOVE_GOAL:({},E,u)=>{const m=r+"Score";E[m]>0?(E[m]--,E.log.push({text:"🚫 Dernier but annulé !",type:"info"})):E.log.push({text:"🚫 Aucun but à annuler",type:"info"}),u(E)},ADD_GOAL_DRAW:({},E,u)=>{E[i+"Score"]===E[r+"Score"]?(E[i+"Score"]++,E.log.push({text:"🎯 But bonus !",type:"info"})):E.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),u(E)},ADD_SUB:({value:E=1},u,m)=>{u.maxSubs=(u.maxSubs||3)+E,u.log.push({text:`🔄 +${E} remplacement(s)`,type:"info"}),m(u)},CUSTOM:({},E,u)=>u(E)};function re(E,u,m,h){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function v(){var I,A;const w=E.map(T=>{const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",N=we(T,T._line)+(T.boost||0),le=b.find(H=>H.cardId===T.cardId)?"#FFD700":"rgba(255,255,255,0.25)",J=T.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${le};background:${C};overflow:hidden;cursor:pointer;${J}">
        ...
        </div>`,(I=y.querySelector("#pp-close"))==null||I.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(T=>{T.addEventListener("click",()=>{const C=T.dataset.cid,N=E.find(le=>le.cardId===C),W=b.findIndex(le=>le.cardId===C);N&&(W>-1?b.splice(W,1):b.length<u&&b.push(N),v())})}),(A=y.querySelector("#pp-confirm"))==null||A.addEventListener("click",()=>{y.remove(),h(b)})}v(),document.body.appendChild(y)}async function z(E,u){const h=(o["gcCardsFull_"+i]||[]).find(w=>w.id===E),y=(h==null?void 0:h._gcDef)||(o.gcDefs||[]).find(w=>{var I;return w.name===u||((I=w.name)==null?void 0:I.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b=[...o["usedGc_"+i]||[],E],v={type:u,by:i,seq:(o._gcAnimSeq||0)+1};K.add(v.seq),xe(u,i,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const I=ce[y.effect_type];if(I){const A={...o};I(y.effect_params||{},A,async T=>{T["usedGc_"+i]=b,T._lastGC=v,T._gcAnimSeq=v.seq,await P(T)});return}}const w={...o};switch(u){case"Remplacement+":w.maxSubs=(w.maxSubs||3)+1,w.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const I=r+"Score";w[I]>0&&(w[I]--,w.log.push({text:"🚫 But annulé",type:"info"}));break}}w["usedGc_"+i]=b,w._lastGC=v,w._gcAnimSeq=v.seq,await P(w)})}function Y(E,u){const m="usedCardIds_"+E,h=new Set(o[m]||[]);u.forEach(y=>h.add(y)),o[m]=[...h]}function ne(){for(const E of["p1","p2"]){const u=new Set(o["usedCardIds_"+E]||[]),m=o[E+"Team"];if(m)for(const h of["GK","DEF","MIL","ATT"])(m[h]||[]).forEach(y=>{y.used=u.has(y.cardId)})}}function D(){var Be,Qe,mt,xt,yt,ht;if(o.phase==="reveal")return Q();if(o.phase==="midfield")return pe();if(o.phase==="finished")return He();const E=o[i+"Team"],u=o[r+"Team"];ne();const m=o[i+"Score"],h=o[r+"Score"],y=o[i+"Name"],b=o[r+"Name"],v=o.phase===i+"-attack",w=o.phase===i+"-defense",I=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],A=I.map(X=>X.cardId),T=window.innerWidth>=700,C=o[i+"Subs"]||[],N=o["usedSubIds_"+i]||[],W=C.filter(X=>!N.includes(X.cardId)),le=o["gcCardsFull_"+i]||[],J=o["usedGc_"+i]||[],H=le.filter(X=>!J.includes(X.id)),V=o.boostOwner===i&&!o.boostUsed,Z=!["GK","DEF","MIL","ATT"].some(X=>(u[X]||[]).some(G=>!G.used)),de=[...E.MIL||[],...E.ATT||[]].filter(X=>!X.used),ue=v&&Z&&de.length===0?[...E.GK||[],...E.DEF||[]].filter(X=>!X.used).map(X=>X.cardId):[];function fe(X,G,oe){var Ct,wt;const se=X._gcDef,ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[se==null?void 0:se.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ye={purple:"#b06ce0",light_blue:"#00d4ef"}[se==null?void 0:se.color]||"#b06ce0",We=(se==null?void 0:se.name)||X.gc_type,Je=(se==null?void 0:se.effect)||((Ct=De[X.gc_type])==null?void 0:Ct.desc)||"",et=se!=null&&se.image_url?`/manager-wars/icons/${se.image_url}`:null,zt=((wt=De[X.gc_type])==null?void 0:wt.icon)||"⚡",St=Math.round(oe*.22),bt=Math.round(oe*.22),lt=oe-St-bt,vt=We.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
        ...
        <div style="height:${lt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${et?`<img src="${et}" style="max-width:${G-10}px;max-height:${lt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(lt*.55)}px">${zt}</span>`}
        </div>
      ...
      </div>`}const be=(X,G)=>G?me(130,175):fe(X,130,175),Se=(X,G)=>G?me(68,95):fe(X,68,95),Pe=T?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Fe=v?Ee(i)?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${I.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Pe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:w?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${I.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${b}</div>`,Te=v&&!Ee(i)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':v||w?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${I.length}/3 sélectionné(s)</div>`:"",Ie=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${T?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${dt(E,o[i+"Formation"],je,A,300,300,ue)}
      </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,(fe=C.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>C.remove()),(me=C.querySelector("#pout-up"))==null||me.addEventListener("click",()=>{w>0&&(w--,N())}),(be=C.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{w<b.length-1&&(w++,N())}),(Se=C.querySelector("#pin-up"))==null||Se.addEventListener("click",()=>{A>0&&(A--,N())}),(Pe=C.querySelector("#pin-down"))==null||Pe.addEventListener("click",()=>{A<v.length-1&&(A++,N())});const ue=(Te,Ie,je,qe)=>{const Re=C.querySelector("#"+Te);if(!Re)return;let Ue=0;Re.addEventListener("touchstart",Ke=>{Ue=Ke.touches[0].clientY},{passive:!0}),Re.addEventListener("touchend",Ke=>{const Ce=Ke.changedTouches[0].clientY-Ue;if(Math.abs(Ce)<30)return;const Be=Ie();Ce<0&&Be<qe-1?(je(Be+1),N()):Ce>0&&Be>0&&(je(Be-1),N())},{passive:!0})};ue("pin-panel",()=>A,Te=>A=Te,v.length),ue("pout-panel",()=>w,Te=>w=Te,b.length),(Fe=C.querySelector("#psub-confirm"))==null||Fe.addEventListener("click",async Te=>{if(Te.preventDefault(),Te.stopPropagation(),T)return;T=!0;const Ie=b[w],je=v[A];if(!Ie||!je)return;const qe=Ie._line,Re=(m[qe]||[]).findIndex(Ce=>Ce.cardId===Ie.cardId);if(Re===-1){c("Erreur : joueur introuvable","error"),C.remove();return}const Ue={...je,_line:qe,position:Ie.position,used:!1,boost:0};m[qe].splice(Re,1,Ue);const Ke=[...h,je.cardId];C.remove(),S(Ie,je,async()=>{await P({[i+"Team"]:m,[r+"Team"]:o[r+"Team"],["usedSubIds_"+i]:Ke})})})}document.body.appendChild(C),N()}function S(E,u,m){const h={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const b=(I,A,T)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${h[I.job]||"#555"};border:3px solid ${A};position:relative;overflow:hidden;margin:0 auto">
        ${Le(I)?`<img src="${Le(I)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:20px;background:linear-gradient(180deg,#0a1628,#1a0a2e);padding:24px;text-align:center;color:#fff">
        ...
        ${!z&&re?'<div style="font-size:13px;color:rgba(255,255,255,0.5);animation:lobbyPulse 1.5s ease-in-out infinite">En attente de ton ami...</div>':""}
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(C=v.querySelector("#pvp-end-home"))==null||C.addEventListener("click",()=>{v.remove(),Oe(e),l("home")})}const P=_.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},u=>{const m=u.new;try{if(m.status==="finished"||m.forfeit){if($)return;$=!0,M&&(clearInterval(M),M=null),m.game_state&&(o=m.game_state),j(m);return}if(m.game_state){const h=o;o=m.game_state;const y=o._lastGC;if(y&&y.seq&&!q.has(y.seq)&&(q.add(y.seq),y.by!==i)){ge(y.type,y.by,()=>Q());return}const b=h[i+"Score"]||0,v=h[r+"Score"]||0,w=o[i+"Score"]||0,I=o[r+"Score"]||0,A=w>b,T=I>v;if((A||T)&&!K.has(o.round)){K.add(o.round);const C=[...o.log||[]].reverse().find(W=>W.isGoal),N=((C==null?void 0:C.homePlayers)||[]).map(W=>({name:W.name,note:W.note,portrait:W.portrait,job:W.job}));xe(N,w,I,A,()=>Q());return}Q()}}catch(h){console.error("[PvP] crash:",h)}}).subscribe();async function te(u){Object.assign(o,u),o.lastActionAt=new Date().toISOString();const{error:m}=await _.from("matches").update({game_state:o}).eq("id",n);m&&c("Erreur de synchronisation","error");try{Q()}catch(h){console.error("[PvP] renderPvpScreen crash:",h)}}async function ce(){if($)return;$=!0,M&&(clearInterval(M),M=null);const u=a?g.away_id:g.home_id,m=a?"p2":"p1",h=a?"p1":"p2",y={...o,[m+"Score"]:3,[h+"Score"]:0,phase:"finished"};try{await _.from("matches").update({status:"finished",forfeit:!0,winner_id:u,home_score:y.p1Score||0,away_score:y.p2Score||0,game_state:y}).eq("id",n)}catch{}try{_.removeChannel(P)}catch{}setTimeout(()=>{Oe(e),l("home")},800)}const re={BOOST_STAT:({value:u=1,count:m=1,roles:h=[]},y,b)=>{const v=y[i+"Team"],w=Object.entries(v).filter(([I])=>!h.length||h.includes(I)).flatMap(([I,A])=>A.filter(T=>!T.used).map(T=>({...T,_line:I})));if(!w.length){y.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),b(y);return}z(w,m,`Choisir ${m} joueur(s) à booster (+${u})`,I=>{I.forEach(A=>{const T=(v[A._line]||[]).find(C=>C.cardId===A.cardId);T&&(T.boost=(T.boost||0)+u,y.log.push({text:`⚡ +${u} sur ${T.name}`,type:"info"}))}),y[i+"Team"]=v,b(y)})},DEBUFF_STAT:({value:u=1,count:m=1,roles:h=[],target:y="ai"},b,v)=>{const w=y==="home"?i:r,I=b[w+"Team"],A=y==="home"?"allié":"adverse",T=Object.entries(I).filter(([C])=>!h.length||h.includes(C)).flatMap(([C,N])=>N.filter(W=>!W.used).map(W=>({...W,_line:C})));if(!T.length){b.log.push({text:`🎯 Aucun joueur ${A}`,type:"info"}),v(b);return}z(T,m,`Choisir ${m} joueur(s) ${A}(s) (-${u})`,C=>{C.forEach(N=>{const W=(I[N._line]||[]).find(le=>le.cardId===N.cardId);W&&(W.boost=(W.boost||0)-u,b.log.push({text:`🎯 -${u} sur ${W.name}`,type:"info"}))}),b[w+"Team"]=I,v(b)})},GRAY_PLAYER:({count:u=1,roles:m=[],target:h="ai"},y,b)=>{const v=h==="home"?i:r,w=y[v+"Team"],I=h==="home"?"allié":"adverse",A=Object.entries(w).filter(([T])=>!m.length||m.includes(T)).flatMap(([T,C])=>C.filter(N=>!N.used).map(N=>({...N,_line:T})));if(!A.length){y.log.push({text:`❌ Aucun joueur ${I}`,type:"info"}),b(y);return}z(A,u,`Choisir ${u} joueur(s) ${I}(s) à exclure`,T=>{T.forEach(C=>{const N=(w[C._line]||[]).find(W=>W.cardId===C.cardId);N&&(N.used=!0,y.log.push({text:`❌ ${N.name} exclu !`,type:"info"}))}),y[v+"Team"]=w,b(y)})},REVIVE_PLAYER:({count:u=1,roles:m=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!m.length||m.includes(w)).flatMap(([w,I])=>I.filter(A=>A.used).map(A=>({...A,_line:w})));if(!v.length){h.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),y(h);return}z(v,u,`Choisir ${u} joueur(s) à ressusciter`,w=>{w.forEach(I=>{const A=(b[I._line]||[]).find(T=>T.cardId===I.cardId);A&&(A.used=!1,h.log.push({text:`💫 ${A.name} ressuscité !`,type:"info"}))}),h[i+"Team"]=b,y(h)})},REMOVE_GOAL:({},u,m)=>{const h=r+"Score";u[h]>0?(u[h]--,u.log.push({text:"🚫 Dernier but annulé !",type:"info"})):u.log.push({text:"🚫 Aucun but à annuler",type:"info"}),m(u)},ADD_GOAL_DRAW:({},u,m)=>{u[i+"Score"]===u[r+"Score"]?(u[i+"Score"]++,u.log.push({text:"🎯 But bonus !",type:"info"})):u.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),m(u)},ADD_SUB:({value:u=1},m,h)=>{m.maxSubs=(m.maxSubs||3)+u,m.log.push({text:`🔄 +${u} remplacement(s)`,type:"info"}),h(m)},CUSTOM:({},u,m)=>m(u)};function z(u,m,h,y){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var A,T;const I=u.map(C=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[C._line]||"#555",W=we(C,C._line)+(C.boost||0),J=v.find(V=>V.cardId===C.cardId)?"#FFD700":"rgba(255,255,255,0.25)",H=C.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${C.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${J};background:${N};overflow:hidden;cursor:pointer;${H}">
        ...
        <div style="height:${vt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${zt?`<img src="${zt}" style="max-width:${oe-10}px;max-height:${vt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(vt*.55)}px">${St}</span>`}
        </div>
      ...
      </div>`}const Se=(G,oe)=>oe?be(130,175):me(G,130,175),Pe=(G,oe)=>oe?be(68,95):me(G,68,95),Fe=C?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Te=w?Ae(i)?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${A.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Fe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:I?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${A.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${v}</div>`,Ie=w&&!Ae(i)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':w||I?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${A.length}/3 sélectionné(s)</div>`:"",je=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${C?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
    ...
    </div>`,qe=w?"attack":I?"defense":"idle",Re=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${dt(u,o[i+"Formation"],qe,T,300,300,fe)}
      </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(v);let A=!1;const T=()=>{A||(A=!0,v.remove(),setTimeout(()=>b(),50))};v.addEventListener("click",T),setTimeout(T,3500)}function ge(u,m,h){var H,V;const y=(o.gcDefs||[]).find(Z=>{var de;return Z.name===u||((de=Z.name)==null?void 0:de.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),b={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",w=(y==null?void 0:y.name)||u,I=(y==null?void 0:y.effect)||((H=De[u])==null?void 0:H.desc)||"",A=y!=null&&y.image_url?`/manager-wars/icons/${y.image_url}`:null,T=((V=De[u])==null?void 0:V.icon)||"⚡",N=m===i?"Vous":o[m+"Name"]||"Adversaire",W=document.createElement("div");W.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",W.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(me=N.querySelector("#psub-close"))==null||me.addEventListener("click",()=>N.remove()),(be=N.querySelector("#pout-up"))==null||be.addEventListener("click",()=>{I>0&&(I--,W())}),(Se=N.querySelector("#pout-down"))==null||Se.addEventListener("click",()=>{I<v.length-1&&(I++,W())}),(Pe=N.querySelector("#pin-up"))==null||Pe.addEventListener("click",()=>{T>0&&(T--,W())}),(Fe=N.querySelector("#pin-down"))==null||Fe.addEventListener("click",()=>{T<w.length-1&&(T++,W())});const fe=(Ie,je,qe,Re)=>{const Ue=N.querySelector("#"+Ie);if(!Ue)return;let Ke=0;Ue.addEventListener("touchstart",Ce=>{Ke=Ce.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ce=>{const Be=Ce.changedTouches[0].clientY-Ke;if(Math.abs(Be)<30)return;const Qe=je();Be<0&&Qe<Re-1?(qe(Qe+1),W()):Be>0&&Qe>0&&(qe(Qe-1),W())},{passive:!0})};fe("pin-panel",()=>T,Ie=>T=Ie,w.length),fe("pout-panel",()=>I,Ie=>I=Ie,v.length),(Te=N.querySelector("#psub-confirm"))==null||Te.addEventListener("click",async Ie=>{if(Ie.preventDefault(),Ie.stopPropagation(),C)return;C=!0;const je=v[I],qe=w[T];if(!je||!qe)return;const Re=je._line,Ue=(h[Re]||[]).findIndex(Be=>Be.cardId===je.cardId);if(Ue===-1){c("Erreur : joueur introuvable","error"),N.remove();return}const Ke={...qe,_line:Re,position:je.position,used:!1,boost:0};h[Re].splice(Ue,1,Ke);const Ce=[...y,qe.cardId];N.remove(),B(je,qe,async()=>{await te({[i+"Team"]:h,[r+"Team"]:o[r+"Team"],["usedSubIds_"+i]:Ce})})})}document.body.appendChild(N),W()}function B(u,m,h){const y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(A,T,C)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${y[A.job]||"#555"};border:3px solid ${T};position:relative;overflow:hidden;margin:0 auto">
        ${Le(A)?`<img src="${Le(A)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-home" style="padding:16px 40px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏠 Retour</button>
    </div>`,(b=document.getElementById("pvp-home"))==null||b.addEventListener("click",()=>{try{_.removeChannel(P)}catch{}Oe(e),l("home")})}Q()}const Mo={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function zo(e,t){const{state:n,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await fi(e,t)}async function fi(e,t){const{state:n,toast:a}=t,{data:p}=await _.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  `;function c(i){const r=document.getElementById("mkt-content"),f=i==="buy"?s:l;if(f.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${x.map(g=>{var F,K,q,j;const k=(F=g.card)==null?void 0:F.player;if(!k)return"";const o=k.job==="GK"?k.note_g:k.job==="DEF"?k.note_d:k.job==="MIL"?k.note_m:k.note_a,$=Mo[k.rarity],L=(n.profile.credits||0)>=g.price,M=g.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${M?"opacity:0.65":""}">
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            ${i==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${g.id}" ${L?"":"disabled"} style="margin-top:4px">${L?"Acheter":"Trop cher"}</button>`:M?'<span style="display:inline-block;margin-top:4px;font-size:10px;font-weight:700;color:#fff;background:var(--green);padding:3px 10px;border-radius:10px">VENDU</span>':`<button class="btn btn-danger btn-sm" data-cancel="${g.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
