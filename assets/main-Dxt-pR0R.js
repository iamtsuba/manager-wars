import{s as $,F as ai,h as St,j as Fi,l as Qe,i as fn,k as gn,b as mn}from"./formation-links-CEzN0rcz.js";function hi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-nav]").forEach(l=>{l.addEventListener("click",p=>{p.preventDefault(),n(l.dataset.nav)})}),(d=document.getElementById("nav-rankings"))==null||d.addEventListener("click",()=>n("rankings")),(s=document.getElementById("nav-matches"))==null||s.addEventListener("click",()=>n("matches")),e.querySelectorAll("[data-action]").forEach(l=>{l.addEventListener("click",()=>{l.classList.add("tapped"),setTimeout(()=>l.classList.remove("tapped"),200);const p=l.dataset.action;if(p==="match-ai"){Sn(n);return}if(p==="match-random"){n("match",{matchMode:"random"});return}if(p==="match-friend"){n("friends");return}a("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await $.auth.signOut(),window.location.reload()}),Ni(t,a),zn(t,a,n),Gi(t,a,n))}async function Gi(e,t,n){const a=document.getElementById("ongoing-match-banner");if(!a)return;const c=e.profile.id,{data:d}=await $.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${c},away_id.eq.${c}`).order("created_at",{ascending:!1});if(!(d!=null&&d.length)){a.innerHTML="";return}const s=d.map(p=>p.home_id===c?p.away_id:p.home_id).filter(Boolean);let l={};if(s.length){const{data:p}=await $.from("users").select("id, pseudo, club_name").in("id",s);(p||[]).forEach(i=>{l[i.id]=i.club_name||i.pseudo})}a.innerHTML=d.map(p=>{const i=p.home_id===c?p.away_id:p.home_id,r=l[i]||"Adversaire";return`
    ...
    </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>{Di(e,t,()=>Ni(e,t))})}function Sn(e){const t=[{mode:"vs_ai_easy",label:"Facile",sub:"Gain 500 cr.",icon:"🟢"},{mode:"vs_ai_medium",label:"Moyen",sub:"Gain 1 000 cr.",icon:"🟡"},{mode:"vs_ai_hard",label:"Difficile",sub:"Gain 1 500 cr.",icon:"🟠"},{mode:"vs_ai_club",label:"Club",sub:"Gain 2 500 cr.",icon:"🔴"}],n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2000",n.innerHTML=`
  ...
  ">
    <div style="background:#e8e8e8;border-radius:8px;overflow:hidden;display:flex;flex-direction:column">
  ...
  </div>`}async function qn(e,t){const{state:n,navigate:a,toast:c,openModal:d,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await $.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),i=(l||[]).filter(O=>O.card_type==="player"&&O.player),r=(l||[]).filter(O=>O.card_type==="game_changer"),f=(l||[]).filter(O=>O.card_type==="formation"),{data:m}=await $.from("gc_definitions").select("name,gc_type,color,effect,image_url"),y={};(m||[]).forEach(O=>{y[O.name]=O});const z=Object.keys(ai),o=Object.keys(Ne),b={};i.forEach(O=>{const U=O.player.id;b[U]=(b[U]||0)+1}),new Set(Object.keys(b).map(O=>String(O)));const T=new Set(f.map(O=>O.formation)),L=new Set(r.map(O=>O.gc_type));let S="player",P="Tous",B="",j=!1;function R(){return[...i].sort((O,U)=>{const C=Bt.indexOf(O.player.job),q=Bt.indexOf(U.player.job);return C!==q?C-q:(O.player.surname_encoded||"").localeCompare(U.player.surname_encoded||"")})}function ee(){return[...p||[]].sort((O,U)=>{const C=Bt.indexOf(O.job),q=Bt.indexOf(U.job);return C!==q?C-q:(O.surname_encoded||"").localeCompare(U.surname_encoded||"")})}function le(){return R().filter(O=>{const U=O.player,C=P==="Tous"||U.job===P,q=!B||`${U.firstname} ${U.surname_encoded}`.toLowerCase().includes(B);return C&&q})}function re(){return ee().filter(O=>{const U=P==="Tous"||O.job===P,C=!B||`${O.firstname} ${O.surname_encoded}`.toLowerCase().includes(B);return U&&C})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,M(),Y()})))}function Y(){const O=document.getElementById("col-grid");O&&(S==="player"?he(O):S==="formation"?xe(O):ge(O))}function ie(O,U,C,q,K){const ne=document.getElementById("col-grid"),te=document.getElementById("col-big");if(!ne||!te)return;var _e=0;function $e(){const Ee=window.innerWidth>=768,Se=document.getElementById("col-big"),Ae=document.getElementById("col-grid");Ee&&Se&&(Se.style.minHeight="420px",Se.style.flex="1 1 auto"),Ee&&Ae&&(Ae.style.height=Math.round(310*.76+16)+"px",Ae.style.flexShrink="0",Ae.style.overflowX="auto",Ae.style.overflowY="hidden",Ae.style.alignItems="center",Ae.style.padding="8px 16px"),te.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+U(O[_e])+"</div>";var Te=te.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Te&&Te.addEventListener("click",function(){q(O[_e])}),requestAnimationFrame(function(){var ke=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!ke||!te)){var De=te.clientHeight-8,Re=te.clientWidth-24,k=ke.offsetHeight,u=ke.offsetWidth;if(k>0&&u>0&&De>40){var g=Ee?2.2:1,h=Math.min(De/k,Re/u,g);ke.style.transform="scale("+h.toFixed(3)+")",ke.style.transformOrigin="top center"}}}),ne.innerHTML=O.map(function(ke,De){var Re=De===_e,k="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Re?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+De+'" style="'+k+'">'+C(ke,Re)+"</div>"}).join(""),ne.querySelectorAll(".col-mini-item").forEach(function(ke){ke.addEventListener("click",function(){_e=Number(ke.dataset.idx),$e(),ke.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}$e()}function D(O){var U=window.innerWidth>=768?.76:.54,C;if(!O||O._fake){var q=O?O.player:null;if(!q)return"";C=Ei(q)}else C=Xt(O,"");return'<div style="display:inline-block;zoom:'+U+';pointer-events:none;line-height:0">'+C+"</div>"}function Z(O,U,C){U=U||100,C=C||140;var q=St[O]||{},K={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ne=Math.max(3,Math.round(U*.06)),te=Object.entries(q).map(function($e){var Ee=$e[0],Se=$e[1],Ae=Ee.replace(/\d+$/,""),Te=K[Ae]||"#888",ke=Math.round(Se.x*U),De=Math.round(Se.y*C);return'<circle cx="'+ke+'" cy="'+De+'" r="'+ne+'" fill="'+Te+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),_e=Math.max(1,Math.round(U/50));return'<svg viewBox="0 0 '+U+" "+C+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+U+'" height="'+C+'" fill="#1A6B3C"/><rect x="'+Math.round(U*.2)+'" y="'+Math.round(C*.02)+'" width="'+Math.round(U*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+_e+'"/><line x1="0" y1="'+Math.round(C*.5)+'" x2="'+U+'" y2="'+Math.round(C*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+_e+'"/><ellipse cx="'+Math.round(U*.5)+'" cy="'+Math.round(C*.5)+'" rx="'+Math.round(U*.18)+'" ry="'+Math.round(C*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+_e+'"/><rect x="'+Math.round(U*.2)+'" y="'+Math.round(C*.82)+'" width="'+Math.round(U*.6)+'" height="'+Math.round(C*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+_e+'"/>'+te+"</svg>"}function ae(O,U,C){var q=C>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+C+"</div>":"",K=U?'data-form-id="'+U.id+'"':"",ne=O.length>7?14:O.length>5?16:19,te=!!U;return"<div "+K+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(te?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(te?"":"filter:grayscale(1);opacity:0.5")+'">'+q+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(te?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ne+"px;font-weight:900;color:"+(te?"#1A6B3C":"#aaa")+';line-height:1">'+O+'</div></div><div style="flex:1;overflow:hidden;background:'+(te?"#1A6B3C":"#ccc")+'">'+Z(O,140,220)+"</div></div>"}function pe(O,U){var C=window.innerWidth>=768?.76:.54,q=140,K=305,ne=Math.round(K*.22),te=K-ne,_e=O.length>7?10:13,$e=Z(O,q,te),Ee=U?"1.5px solid #2a7a40":"1px solid #ddd",Se=U?"":"filter:grayscale(1);opacity:0.45;",Ae=U?"#1A6B3C":"#bbb",Te="#fff";return'<div style="display:inline-block;zoom:'+C+';line-height:0;pointer-events:none"><div style="width:'+q+"px;height:"+K+"px;border-radius:6px;border:"+Ee+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Se+'"><div style="height:'+ne+"px;background:"+Ae+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+_e+"px;font-weight:900;color:"+Te+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(q-4)+'px">'+O+'</span></div><div style="height:'+te+'px;overflow:hidden;flex-shrink:0">'+$e+"</div></div></div>"}function he(O){if(j){const U=re();if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const C=U.map(q=>i.find(K=>K.player.id===q.id)||{_fake:!0,player:q,id:"fake-"+q.id});ie(C,q=>q._fake?Ei(q.player):Xt(q,""),q=>q._fake?D({player:q.player,id:"x",_fake:!0}):D(q),q=>{q._fake||Ai(q,i,b,t)})}else{const U=le();if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const C={};U.forEach(K=>{const ne=K.player.id;C[ne]||(C[ne]=[]),C[ne].push(K)});const q=Object.values(C).map(K=>Fn(K));ie(q,K=>{const ne=b[K.player.id]||1,te=ne>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ne}</div>`:"",$e=i.filter(Ee=>Ee.player.id===K.player.id&&Ee.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Xt(K,te+$e)},K=>D(K),K=>Ai(K,i,b,t))}}function xe(O){const U=j?z:[...T];if(!U.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const C=U.map(q=>({formation:q,card:f.find(K=>K.formation===q)||null,owned:T.has(q)}));ie(C,({formation:q,card:K,owned:ne})=>ae(q,ne?K:null,ne?f.filter(te=>te.formation===q).length:0),({formation:q,owned:K})=>pe(q,K),({card:q,owned:K})=>{K&&q&&Gn(q,f,t,d)})}function ge(O){const U=Object.keys(y),C=j?U.length?U:o:[...L];if(!C.length){O.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const q=C.map(K=>({type:K,gc:Ne[K]||{icon:"⚡",desc:""},def:y[K]||null,owned:L.has(K),card:r.find(ne=>ne.gc_type===K)||null}));ie(q,({type:K,gc:ne,def:te,owned:_e,card:$e})=>{const Ee=_e?r.filter(g=>g.gc_type===K).length:0,Se=Ee>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ee}</div>`:"",Ae=(te==null?void 0:te.gc_type)==="ultra_game_changer",Te={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ke={purple:"#b06ce0",light_blue:"#00d4ef"},De=Te[te==null?void 0:te.color]||Te.purple,Re=ke[te==null?void 0:te.color]||ke.purple,k=(te==null?void 0:te.effect)||ne.desc||"",u=te!=null&&te.image_url?`/manager-wars/icons/${te.image_url}`:null;return _e&&$e?`<div data-gc-id="${$e.id}" data-gc-type="${K}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Re};background:${De};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Re}66;cursor:pointer">
          ${Se}
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${f.map((C,q)=>{const K=M[C.id]||[],ne=C.is_for_sale,te=K.length?K[K.length-1]:null,$e=(r.rarity==="pepite"||r.rarity==="papyte")&&C.current_note!=null?` (☆${C.current_note})`:"";return`
            <div data-card-id="${C.id}" data-card-idx="${q}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${q+1}${$e}${ne?" 🏷️ En vente":""}</div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",r.note_g],["DEF",r.note_d],["MIL",r.note_m],["ATT",r.note_a]].map(([C,q])=>{const K=At[C],ne=Number(q)||0;return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let D=new Set;const Z=()=>{const C=D.size,q=document.getElementById("sell-action-panel");q&&(q.style.display=C>0?"block":"none",document.getElementById("sell-selected-count").textContent=C,document.getElementById("sell-direct-total").textContent=(C*b).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(C=>{C.addEventListener("change",()=>{const q=C.dataset.id;C.checked?D.add(q):D.delete(q);const K=C.closest(".exemplaire-row");K&&(K.style.borderColor=C.checked?"#1A6B3C":"#eee"),Z()})}),document.querySelectorAll(".exemplaire-row").forEach(C=>{C.addEventListener("click",q=>{if(q.target.closest("button")||q.target.tagName==="INPUT")return;const K=C.querySelector(".expl-check");K&&!K.disabled&&(K.checked=!K.checked,K.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(C=>{C.addEventListener("click",q=>{q.stopPropagation();const K=document.querySelector(`.expl-hist[data-hist="${C.dataset.idx}"]`);K&&(K.style.display=K.style.display==="none"?"flex":"none")})}),(ge=document.getElementById("direct-sell-btn"))==null||ge.addEventListener("click",async()=>{const C=[...D];if(!C.length)return;const q=C.length*b;if(!confirm(`Vendre ${C.length} carte${C.length>1?"s":""} ${r.surname_encoded} pour ${q.toLocaleString("fr")} crédits ? Action irréversible.`))return;await $.from("market_listings").delete().in("card_id",C),await $.from("transfer_history").delete().in("card_id",C);const{error:K}=await $.from("cards").delete().in("id",C);if(K){d(K.message,"error");return}await $.from("users").update({credits:(c.profile.credits||0)+q}).eq("id",c.profile.id),await i();const ne=document.getElementById("nav-credits");ne&&(ne.textContent=`💰 ${(c.profile.credits||0).toLocaleString("fr")}`),d(`+${q.toLocaleString("fr")} crédits ! ${C.length} carte${C.length>1?"s":""} vendue${C.length>1?"s":""}.`,"success"),l(),p("collection")}),(O=document.getElementById("market-sell-btn"))==null||O.addEventListener("click",async()=>{var _e;const C=[...D];if(!C.length){d("Sélectionne au moins un exemplaire","warning");return}const q=parseInt((_e=document.getElementById("sell-market-price"))==null?void 0:_e.value);if(!q||q<1){d("Prix invalide","error");return}const{error:K}=await $.from("cards").update({is_for_sale:!0,sale_price:q}).in("id",C);if(K){d(K.message,"error");return}const ne=C.map($e=>({seller_id:c.profile.id,card_id:$e,price:q,status:"active"})),{error:te}=await $.from("market_listings").insert(ne);te&&console.warn("[Market] insert listings:",te.message),d(`${C.length} carte${C.length>1?"s":""} mise${C.length>1?"s":""} en vente à ${q.toLocaleString("fr")} cr. chacune !`,"success"),l(),p("collection")}),(U=document.getElementById("cancel-sell-btn"))==null||U.addEventListener("click",async()=>{await $.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await $.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),l(),p("collection")})}const Pt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},rt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Yt(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const n=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${n}.png`}function Wi(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Xi(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(n=e==null?void 0:e.clubs)!=null&&n.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Nn(e,t=44,n=58){var y;const a=e?Yt(e):null,c=e?Xi(e):null,d=Wi(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",l=rt[s]||"#555",p={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(n*.19),f=Math.round(n*.25),m=n-r-f;return e?`<div style="width:${t}px;height:${n}px;border-radius:5px;border:2px solid ${p};background:${l};position:relative;overflow:hidden;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",s).order("slot_order");let p=0;function i(){var L,S,P,B,j;const r=d[p],f=(l||[]).filter(R=>R.deck_id===r.id),m=f.filter(R=>{var ee;return R.is_starter&&((ee=R.card)==null?void 0:ee.player)}).map(R=>ii(R.card,R.position)),y=f.find(R=>{var ee;return((ee=R.card)==null?void 0:ee.card_type)==="formation"}),z=r.formation||((L=y==null?void 0:y.card)==null?void 0:L.formation)||"4-4-2",o=m.length>=11?mt(m,z):null,b=m.length>=11;Xe(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${f}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${c?`<img src="${c}" style="width:${f-4}px;height:${f-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,f-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${re}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const y=48,z=64,o=13,b=16,T={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[P,B]of Object.entries(i)){const j=f(P);if(!j||!B)continue;const R=P.replace(/[0-9]/g,""),ee=gt[R]||"#555",le=s.includes(B.cardId),re=n==="attack"&&(["MIL","ATT"].includes(R)||le)&&!B.used||n==="defense"&&["GK","DEF","MIL"].includes(R)&&!B.used,M=a.includes(B.cardId);let Y;n==="attack"?Y=le?Math.max(1,Number(B.note_a)||0):R==="MIL"?Number(B.note_m)||0:Number(B.note_a)||0:n==="defense"?Y=R==="GK"?Number(B.note_g)||0:R==="MIL"?Number(B.note_m)||0:Number(B.note_d)||0:Y=Number(R==="GK"?B.note_g:R==="DEF"?B.note_d:R==="MIL"?B.note_m:B.note_a)||0,Y=Y+(B.boost||0);const ie=(j.x-y/2).toFixed(1),D=(j.y-z/2).toFixed(1),Z=T[B==null?void 0:B.rarity]||T.normal;if(B.used){const U=typeof import.meta<"u"&&"/manager-wars/"||"/",q=`${typeof window<"u"&&((S=window.location)==null?void 0:S.origin)||""}${U}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="#161616"/>`,m+=`<image href="${q}" xlink:href="${q}" x="${ie}" y="${D}" width="${y}" height="${z}" preserveAspectRatio="xMidYMid slice"/>`,m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="none" stroke="${Z}" stroke-width="2" opacity="0.7"/>`,m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${B.cardId}" data-role="${R}" style="cursor:pointer"/>`;continue}const ae=M?.45:1,pe=M?"#FFD700":Z,he=M?3:(B==null?void 0:B.rarity)==="legende"||(B==null?void 0:B.rarity)==="légende"||(B==null?void 0:B.rarity)==="pepite"||(B==null?void 0:B.rarity)==="pépite"?2.5:2,xe=z-o-b;m+=`<defs><clipPath id="cp-${P}"><rect x="${ie}" y="${(j.y-z/2+o).toFixed(1)}" width="${y}" height="${xe}"/></clipPath></defs>`,m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="${ee}" opacity="${ae}"/>`;const ge=ze(B);ge&&(m+=`<image href="${ge}" xlink:href="${ge}" x="${ie}" y="${(j.y-z/2+o).toFixed(1)}" width="${y}" height="${xe}" clip-path="url(#cp-${P})" preserveAspectRatio="xMidYMin slice"/>`),m+=`<rect x="${ie}" y="${D}" width="${y}" height="${o}" rx="4" fill="rgba(255,255,255,0.92)"/>`,m+=`<text x="${j.x.toFixed(1)}" y="${(j.y-z/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(B.name||"").slice(0,9)}</text>`;const O=(j.y+z/2-b).toFixed(1);m+=`<rect x="${ie}" y="${O}" width="${y}" height="${b}" fill="rgba(255,255,255,0.92)"/>`;{const U=Rt(B.country_code);U?m+=`<image href="${U}" xlink:href="${U}" x="${(j.x-20).toFixed(1)}" y="${(j.y+z/2-b+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:m+=`<text x="${(j.x-13).toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${sn(B.country_code)}</text>`,m+=`<text x="${j.x.toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Y}</text>`;const C=an(B);C?m+=`<image href="${C}" xlink:href="${C}" x="${(j.x+y/2-14).toFixed(1)}" y="${(j.y+z/2-b+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:B.clubName&&(m+=`<text x="${(j.x+14).toFixed(1)}" y="${(j.y+z/2-b/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(B.clubName||"").slice(0,3).toUpperCase()}</text>`),B.boost&&(m+=`<rect x="${(j.x+y/2-12).toFixed(1)}" y="${(j.y-z/2).toFixed(1)}" width="14" height="10" rx="3" fill="#87CEEB"/>`,m+=`<text x="${(j.x+y/2-5).toFixed(1)}" y="${(j.y-z/2+6).toFixed(1)}" text-anchor="middle" font-size="7" fill="#000" font-weight="900">+${B.boost}</text>`)}m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="${M?"rgba(255,255,255,0.12)":"none"}" stroke="${pe}" stroke-width="${he}" opacity="${ae}"/>`,re&&(m+=`<rect x="${ie}" y="${D}" width="${y}" height="${z}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${M?"selected":""}" data-card-id="${B.cardId}" data-role="${R}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${c+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${m}
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,B.style.transition="opacity .45s ease",B.style.opacity="1",B.style.pointerEvents="auto",(j=document.getElementById("start-match-btn"))==null||j.addEventListener("click",z))},600)},700)},2800)}function ho(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  `,document.body.appendChild(a);let r=!1;const f=()=>{r||(r=!0,a.remove(),n())};a.addEventListener("click",f),setTimeout(f,2e3)}function $t(e,t="rgba(0,0,0,0.8)"){const n=document.createElement("div");n.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function Jt(e,t,n,a=null,c=null){var y,z;if(t.phase!=="attack"){$t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){$t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const d=Object.entries(t.homeTeam).flatMap(([o,b])=>(b||[]).filter(T=>T.used).map(T=>({...T,_line:T._line||o}))),s=t.homeSubs.filter(o=>!t.usedSubIds.includes(o.cardId));if(!d.length){$t("Aucun joueur utilisé à remplacer");return}if(!s.length){$t("Aucun remplaçant disponible");return}let l=Math.max(0,d.findIndex(o=>o.cardId===c));const p=((y=d[l])==null?void 0:y._line)||((z=d[l])==null?void 0:z.job);let i=a?Math.max(0,s.findIndex(o=>o.cardId===a)):Math.max(0,s.findIndex(o=>o.job===p)),r=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function m(){var B,j,R,ee,le,re;const o=d[l],b=s[i],T=Math.min(130,Math.round((window.innerWidth-90)/2)),L=Math.round(T*1.35),S=M=>`background:rgba(255,255,255,0.12);border:none;color:${M?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${M?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    </div>`,(B=f.querySelector("#sub-close"))==null||B.addEventListener("click",()=>f.remove()),(j=f.querySelector("#out-up"))==null||j.addEventListener("click",()=>{l>0&&(l--,m())}),(R=f.querySelector("#out-down"))==null||R.addEventListener("click",()=>{l<d.length-1&&(l++,m())}),(ee=f.querySelector("#in-up"))==null||ee.addEventListener("click",()=>{i>0&&(i--,m())}),(le=f.querySelector("#in-down"))==null||le.addEventListener("click",()=>{i<s.length-1&&(i++,m())});const P=(M,Y,ie,D)=>{const Z=f.querySelector("#"+M);if(!Z)return;let ae=0;Z.addEventListener("touchstart",pe=>{ae=pe.touches[0].clientY},{passive:!0}),Z.addEventListener("touchend",pe=>{const he=pe.changedTouches[0].clientY-ae;if(Math.abs(he)<30)return;const xe=Y();he<0&&xe<D-1?(ie(xe+1),m()):he>0&&xe>0&&(ie(xe-1),m())},{passive:!0})};P("in-panel",()=>i,M=>i=M,s.length),P("out-panel",()=>l,M=>l=M,d.length),(re=f.querySelector("#sub-confirm"))==null||re.addEventListener("click",M=>{if(M.preventDefault(),M.stopPropagation(),r)return;r=!0;const Y=d[l],ie=s[i];if(!Y||!ie)return;let D=null,Z=-1;for(const[pe,he]of Object.entries(t.homeTeam)){const xe=(he||[]).findIndex(ge=>ge.cardId===Y.cardId);if(xe!==-1){D=pe,Z=xe;break}}if(Z===-1||!D){$t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),f.remove();return}const ae={...ie,_line:D,_col:Y._col||0,used:!1,boost:0};t.homeTeam[D].splice(Z,1,ae),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(ie.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:we(Y,D),portrait:ze(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:ie.name,firstname:ie.firstname,note:we(ie,D),portrait:ze(ie),job:ie.job,country_code:ie.country_code,rarity:ie.rarity,clubName:ie.clubName,clubLogo:ie.clubLogo},text:`🔄 ${ie.firstname} ${ie.name} remplace ${Y.firstname} ${Y.name}`}),f.remove(),$o(Y,ie,()=>Me(e,t,n))})}document.body.appendChild(f),m()}function ko(e,t,n,a,c){var z,o;const d=(a.gcDefs||[]).find(b=>b.name===t),s=Ne[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[d==null?void 0:d.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",p={purple:"#b06ce0",light_blue:"#00d4ef"}[d==null?void 0:d.color]||"#b06ce0",i=(d==null?void 0:d.name)||t,r=(d==null?void 0:d.effect)||s.desc,f=d!=null&&d.image_url?`/manager-wars/icons/${d.image_url}`:null,m=s.icon||"⚡",y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",y.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
      ${e.map(f=>{const m=f._line||f.job||"MIL",y={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[m]||"#555",z=we(f,m)+(f.boost||0),o=l.find(b=>b.cardId===f.cardId);return`<div class="gc-pick-item" data-cid="${f.cardId}"
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const p=()=>{l||(l=!0,d.remove(),setTimeout(()=>c(),50))};d.addEventListener("click",p),setTimeout(p,3500)}async function Tt(e,t,n){var r,f;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=n,c=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,s=c?"victoire":d?"nul":"defaite",l=Mn(t.mode,s);t.matchId&&await $.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?a.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(a.profile.credits||0)+l,matches_played:(a.profile.matches_played||0)+1};c?p.wins=(a.profile.wins||0)+1:d?p.draws=(a.profile.draws||0)+1:p.losses=(a.profile.losses||0)+1,await $.from("users").update(p).eq("id",a.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const y=async(S=!0)=>{f=!0,m&&($.removeChannel(m),m=null),S&&await $.rpc("cancel_matchmaking",{p_user_id:p.profile.id}).catch(()=>{})};(L=document.getElementById("mm-cancel"))==null||L.addEventListener("click",async()=>{try{await y(!0)}catch{}He(e),i("home")});const z=async(S,P,B)=>{if(f)return;f=!0,m&&($.removeChannel(m),m=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(R=>setTimeout(R,600)),e.isConnected&&cn(e,t,S,B,s,l)},{data:o,error:b}=await $.rpc("try_matchmake",{p_user_id:p.profile.id,p_deck_id:n});if(b||!(o!=null&&o.success)){r("Erreur de matchmaking","error"),He(e),i("home");return}if(o.matched){z(o.match_id,o.opponent_id,!1);return}const T=document.getElementById("mm-status");T&&(T.textContent="En attente d'un autre joueur..."),m=$.channel("matchmaking-"+p.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${p.profile.id}`},S=>{const P=S.new;P.status==="matched"&&P.match_id&&z(P.match_id,P.matched_with,!0)}).subscribe()}async function zo(e,t,n){const{state:a,navigate:c,toast:d}=t;try{($.getChannels?$.getChannels():[]).forEach(i=>{const r=i.topic||"";(r.includes("matchmaking")||r.includes("pvp-match")||r.includes("friend-invite"))&&$.removeChannel(i)})}catch{}const{data:s}=await $.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!s){d("Match introuvable","error"),c("home");return}if(s.status==="finished"){d("Ce match est terminé","info"),c("home");return}const l=s.home_id===a.profile.id;cn(e,t,n,l,[],[])}async function cn(e,t,n,a,c=[],d=[]){const{state:s,navigate:l,toast:p}=t,i=a?"p1":"p2",r=a?"p2":"p1",f=(c||[]).map(k=>k.id),m=(c||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:y}=await $.from("matches").select("*").eq("id",n).single();if(!y){p("Match introuvable","error"),l("home");return}async function z(){const[{data:k},{data:u},{data:g},{data:h}]=await Promise.all([$.rpc("get_deck_for_match",{p_deck_id:y.home_deck_id}),$.rpc("get_deck_for_match",{p_deck_id:y.away_deck_id}),$.from("users").select("id,pseudo,club_name").eq("id",y.home_id).single(),$.from("users").select("id,pseudo,club_name").eq("id",y.away_id).single()]),x=E=>({cardId:E.card_id,position:E.position,id:E.id,firstname:E.firstname,name:E.surname_encoded,country_code:E.country_code,club_id:E.club_id,job:E.job,job2:E.job2,note_g:Number(E.note_g)||0,note_d:Number(E.note_d)||0,note_m:Number(E.note_m)||0,note_a:Number(E.note_a)||0,rarity:E.rarity,skin:E.skin,hair:E.hair,hair_length:E.hair_length,clubName:E.club_encoded_name||null,clubLogo:E.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),v=((k==null?void 0:k.starters)||[]).map(E=>x(E)),w=((u==null?void 0:u.starters)||[]).map(E=>x(E)),_=(k==null?void 0:k.formation)||"4-4-2",I=(u==null?void 0:u.formation)||"4-4-2";return{p1Team:mt(v,_),p2Team:mt(w,I),p1Subs:((k==null?void 0:k.subs)||[]).map(E=>x(E)),p2Subs:((u==null?void 0:u.subs)||[]).map(E=>x(E)),p1Formation:_,p2Formation:I,p1Name:(g==null?void 0:g.club_name)||(g==null?void 0:g.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?f:[],gc_p2:a?[]:f,gcCardsFull_p1:a?m:[],gcCardsFull_p2:a?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let o=y.game_state&&Object.keys(y.game_state).length?y.game_state:null;if(!o)if(a){o=await z();const{data:k}=await $.from("matches").select("game_state").eq("id",n).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await $.from("matches").update({game_state:o,turn_user_id:y.home_id}).eq("id",n):o=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let k=0;k<30&&!o;k++){await new Promise(g=>setTimeout(g,400));const{data:u}=await $.from("matches").select("game_state").eq("id",n).single();u!=null&&u.game_state&&Object.keys(u.game_state).length&&(o=u.game_state)}if(!o){p("Erreur de synchronisation","error"),l("home");return}o.gc_p2=f,o.gcCardsFull_p2=m,await $.from("matches").update({game_state:o}).eq("id",n)}let b=!1,T=null,L=!1;const S=new Set,P=new Set;function B(k){var E,A;try{$.removeChannel(j)}catch{}const u=o[i+"Score"]||0,g=o[r+"Score"]||0;let h,x;k.winner_id?(h=k.winner_id===s.profile.id,x=!1):k.forfeit?(h=u>g,x=!1):(x=u===g,h=u>g),(E=document.getElementById("pvp-end-overlay"))==null||E.remove();const v=document.createElement("div");v.id="pvp-end-overlay",v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const w=x?"🤝":h?"🏆":"😞",_=x?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=x?"#fff":h?"#FFD700":"#ff6b6b";v.innerHTML=`
      ...
      </div>`}const be=(X,G)=>G?me(130,175):fe(X,130,175),Ce=(X,G)=>G?me(68,95):fe(X,68,95),Pe=A?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",qe=w?Ae(i)?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${I.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Pe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:_?`<button id="pvp-action" style="${Pe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${I.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${v}</div>`,Ie=w&&!Ae(i)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':w||_?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${I.length}/3 sélectionné(s)</div>`:"",Le=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${A?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${u.map(x=>{const v={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[x._line]||"#555",w=we(x,x._line)+(x.boost||0);return`<div class="bp-item" data-cid="${x.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${v};overflow:hidden;cursor:pointer">
      ...
      </div>`,(fe=F.querySelector("#psub-close"))==null||fe.addEventListener("click",()=>F.remove()),(me=F.querySelector("#pout-up"))==null||me.addEventListener("click",()=>{_>0&&(_--,N())}),(be=F.querySelector("#pout-down"))==null||be.addEventListener("click",()=>{_<v.length-1&&(_++,N())}),(Ce=F.querySelector("#pin-up"))==null||Ce.addEventListener("click",()=>{E>0&&(E--,N())}),(Pe=F.querySelector("#pin-down"))==null||Pe.addEventListener("click",()=>{E<w.length-1&&(E++,N())});const ue=(Ie,Le,Be,Ge)=>{const Oe=F.querySelector("#"+Ie);if(!Oe)return;let Ue=0;Oe.addEventListener("touchstart",Ke=>{Ue=Ke.touches[0].clientY},{passive:!0}),Oe.addEventListener("touchend",Ke=>{const je=Ke.changedTouches[0].clientY-Ue;if(Math.abs(je)<30)return;const Fe=Le();je<0&&Fe<Ge-1?(Be(Fe+1),N()):je>0&&Fe>0&&(Be(Fe-1),N())},{passive:!0})};ue("pin-panel",()=>E,Ie=>E=Ie,w.length),ue("pout-panel",()=>_,Ie=>_=Ie,v.length),(qe=F.querySelector("#psub-confirm"))==null||qe.addEventListener("click",async Ie=>{if(Ie.preventDefault(),Ie.stopPropagation(),A)return;A=!0;const Le=v[_],Be=w[E];if(!Le||!Be)return;const Ge=Le._line,Oe=(g[Ge]||[]).findIndex(je=>je.cardId===Le.cardId);if(Oe===-1){p("Erreur : joueur introuvable","error"),F.remove();return}const Ue={...Be,_line:Ge,position:Le.position,used:!1,boost:0};g[Ge].splice(Oe,1,Ue);const Ke=[...h,Be.cardId];F.remove(),C(Le,Be,async()=>{await R({[i+"Team"]:g,[r+"Team"]:o[r+"Team"],["usedSubIds_"+i]:Ke})})})}document.body.appendChild(F),N()}function C(k,u,g){const h={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const v=(I,E,A)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(x);let w=!1;const _=()=>{w||(w=!0,x.remove(),setTimeout(()=>g(),50))};x.addEventListener("click",_),setTimeout(_,2200)}function q(){var u;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${g.map(v=>{const w={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[v._line]||"#555",_=we(v,v._line)+(v.boost||0);return`<div class="bp-item" data-cid="${v.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${w};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(g),(h=g.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>g.remove())}async function te(){if(o.phase!==i+"-attack")return;const u=i==="p1"?"p2":"p1",g=(o.round||0)+1,h=[...o.log||[]];h.push({type:"info",text:`⏭️ ${o[i+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const x=ke(o),v=Te(u),w=x||!v?"finished":u+"-attack";await ee({["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:w,attacker:u,round:g,log:h}),w==="finished"&&await Re(o)}async function _e(){const u=o[i+"Team"],g=!["GK","DEF","MIL","ATT"].some(w=>(o[r+"Team"][w]||[]).some(_=>!_.used)),h=(o["selected_"+i]||[]).map(w=>{const _=(u[w._role]||[]).find(W=>W.cardId===w.cardId)||w,I=g&&["GK","DEF"].includes(w._role),E=u[w._role]||[],A=E.findIndex(W=>W.cardId===w.cardId),F=ot(E.length),N=A>=0?F[A]:_._col??1;return{..._,_line:w._role,_col:N,...I?{note_a:Math.max(1,Number(_.note_a)||0)}:{}}});if(!h.length)return;const x=Ut(h,o.modifiers[i]||{});ie(i,h.map(w=>w.cardId)),h.forEach(w=>{const _=(u[w._role]||[]).find(I=>I.cardId===w.cardId);_&&(_.used=!0)}),o["selected_"+i]=[],Z();const v=[...o.log||[]];if(g){const w=(o[i+"Score"]||0)+1,_=h.map(N=>({name:N.name,note:we(N,N._line||"ATT"),portrait:ze(N),job:N.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:_,homeTotal:x.total,aiTotal:0});const I=(o.round||0)+1,E=i==="p1"?"p2":"p1",A={...o,[i+"Team"]:u,[i+"Score"]:w},F=ke(A);P.add(I),xe(_,w,o[r+"Score"]||0,!0,async()=>{await ee({[i+"Team"]:u,[i+"Score"]:w,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:F?"finished":E+"-attack",attacker:E,round:I,log:v}),F&&await Re({...o,[i+"Score"]:w})});return}v.push({type:"pending",text:`⚔️ ${o[i+"Name"]} attaque (${x.total})`}),await ee({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],pendingAttack:{...x,players:h,side:i},["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},phase:r+"-defense",log:v})}async function $e(){const u=o[i+"Team"],g=(o["selected_"+i]||[]).map(H=>{const V=(u[H._role]||[]).find(me=>me.cardId===H.cardId)||H,Q=u[H._role]||[],de=Q.findIndex(me=>me.cardId===H.cardId),ue=ot(Q.length),fe=de>=0?ue[de]:V._col??1;return{...V,_line:H._role,_col:fe}}),h=Kt(g,o.modifiers[i]||{});ie(i,g.map(H=>H.cardId)),g.forEach(H=>{const V=(u[H._role]||[]).find(Q=>Q.cardId===H.cardId);V&&(V.used=!0)}),o["selected_"+i]=[],Z();const x=Vt(o.pendingAttack.total,h.total,o.modifiers[i]||{}),v=o.pendingAttack.side,w=x==="attack"||(x==null?void 0:x.goal),_=v==="p1"?"p2":"p1",I=(o.round||0)+1,E=(o.pendingAttack.players||[]).map(H=>({name:H.name,note:we(H,H._line||"ATT"),portrait:ze(H),job:H.job})),A=[...o.log||[]];A.push({type:"duel",isGoal:w,homeScored:w&&v===i,text:w?`⚽ BUT de ${o[v+"Name"]} ! (${o.pendingAttack.total} vs ${h.total})`:`✋ Attaque stoppée (${o.pendingAttack.total} vs ${h.total})`,homePlayers:E,aiPlayers:g.map(H=>({name:H.name,note:we(H,H._line||"DEF"),portrait:ze(H),job:H.job})),homeTotal:o.pendingAttack.total,aiTotal:h.total});const F=w?(o[v+"Score"]||0)+1:o[v+"Score"]||0,N={...o,[i+"Team"]:u,[v+"Score"]:F},W=ke(N),ce=W?"finished":_+"-attack",J=async()=>{await ee({[i+"Team"]:u,[r+"Team"]:o[r+"Team"],[v+"Score"]:F,["selected_"+i]:[],modifiers:{...o.modifiers,[i]:{}},pendingAttack:null,phase:ce,attacker:_,round:I,log:A}),(ce==="finished"||W)&&await Re({...o,[v+"Score"]:F})};if(w){const H=v===i,V=H?F:o[i+"Score"]||0,Q=H?o[r+"Score"]||0:F;P.add(I),xe(E,V,Q,H,J)}else await J()}function Ee(u){return["MIL","ATT"].some(g=>(u[g]||[]).some(h=>!h.used))}function Se(u){return["GK","DEF","MIL","ATT"].some(g=>(u[g]||[]).some(h=>!h.used))}function Ae(u){return Se(u)&&!Ee(u)}function Te(u){const g=o[u+"Team"],h=o[(u==="p1"?"p2":"p1")+"Team"];return!!(Ee(g)||!Se(h)&&Ae(g))}function ke(u){const g=["MIL","ATT"].some(A=>(u.p1Team[A]||[]).some(F=>!F.used)),h=["MIL","ATT"].some(A=>(u.p2Team[A]||[]).some(F=>!F.used)),x=Se(u.p1Team),v=Se(u.p2Team);return!g&&!(!v&&x)&&(!h&&!(!x&&v))}function De(u){const g=u.p1Score||0,h=u.p2Score||0;return g===h?null:g>h?y.home_id:y.away_id}async function Re(u){try{const g=De(u),h=g?y.home_id===g?y.away_id:y.home_id:null;await $.from("matches").update({status:"finished",winner_id:g,home_score:u.p1Score||0,away_score:u.p2Score||0}).eq("id",n),g&&h&&Ui(g,h).catch(()=>{})}catch(g){console.error("[PvP] finishMatch:",g)}}function k(){var v;const u=o[i+"Score"],g=o[r+"Score"],h=u>g,x=u===g;Xe(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div id="mkt-content" style="padding:10px 16px;display:flex;flex-direction:column;gap:8px"></div>
      ...
      ${Dt(L,b.job2||null)}
      ${Mi(b.country_code)}
      ${Ci((B=b.clubs)==null?void 0:B.logo_url)}
      <div style="flex:1;min-width:0">
