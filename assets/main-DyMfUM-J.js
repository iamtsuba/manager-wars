import{s as A,F as oi,h as zt,j as Li,l as Ze,i as tn,k as nn,b as on}from"./formation-links-CEzN0rcz.js";function xi(e,{navigate:t,toast:n}){e.innerHTML=`
  ...
  `;function d(){var $;const i=document.getElementById("logo-preview"),r=document.getElementById("logo-initials"),u=(($=document.getElementById("setup-club"))==null?void 0:$.value)||"MW",m=u.trim().split(" ").filter(Boolean),g=m.length>=2?(m[0][0]+m[1][0]).toUpperCase():u.slice(0,2).toUpperCase();i&&(i.style.background=s,i.style.borderColor=l),r&&(r.textContent=g,r.style.color=l)}document.getElementById("color1").addEventListener("input",i=>{l=i.target.value,document.getElementById("swatch1").style.background=l,d()}),document.getElementById("color2").addEventListener("input",i=>{s=i.target.value,document.getElementById("swatch2").style.background=s,d()});function c(i){document.querySelectorAll(".setup-step").forEach(r=>r.classList.remove("active")),document.getElementById(`step-${i}`).classList.add("active"),document.getElementById("step-num").textContent=i,document.getElementById("progress-fill").style.width=`${Math.round(i/3*100)}%`,i===3&&d()}document.getElementById("step1-next").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("step1-error");if(r.textContent="",i.length<3){r.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await A.from("users").select("id").eq("pseudo",i).maybeSingle();if(u){r.textContent="Ce pseudo est déjà pris.";return}c(2)}),document.getElementById("step2-back").addEventListener("click",()=>c(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const i=document.getElementById("setup-club").value.trim(),r=document.getElementById("step2-error");if(r.textContent="",i.length<2){r.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await A.from("users").select("id").eq("club_name",i).maybeSingle();if(u){r.textContent="Ce nom de club est déjà pris.";return}c(3)}),document.getElementById("step3-back").addEventListener("click",()=>c(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const i=document.getElementById("setup-pseudo").value.trim(),r=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),m=document.getElementById("step3-finish");u.textContent="",m.disabled=!0,m.textContent="Création en cours…";try{const{error:g}=await A.from("users").insert({id:t.user.id,pseudo:i,club_name:r,club_color1:l,club_color2:s,credits:1e4});if(g)throw g;await an(t.user.id),await p(),a(`Bienvenue ${i} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){u.textContent=g.message,m.disabled=!1,m.textContent="🚀 Créer mon profil !"}})}async function an(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await A.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(n){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",n)}}const sn="modulepreload",dn=function(e){return"/manager-wars/"+e},yi={},ln=function(t,n,a){let p=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),d=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));p=Promise.allSettled(n.map(c=>{if(c=dn(c),c in yi)return;yi[c]=!0;const i=c.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${r}`))return;const u=document.createElement("link");if(u.rel=i?"stylesheet":sn,i||(u.as="script"),u.crossOrigin="",u.href=c,d&&u.setAttribute("nonce",d),document.head.appendChild(u),i)return new Promise((m,g)=>{u.addEventListener("load",m),u.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return p.then(s=>{for(const d of s||[])d.status==="rejected"&&l(d.reason);return t().catch(l)})},Tt="#1A6B3C",It="#cc2222",cn="#D4A017",hi="#888";async function pn(e,t){const{state:n,toast:a}=t;e.innerHTML=`
    ...
    </style>`}async function mn({player1Id:e,player2Id:t,score1:n,score2:a,gc1:p,gc2:l}){const[s,d]=[e,t].sort(),c=e!==s,i=c?a:n,r=c?n:a,u=c?l:p,m=c?p:l,g=i>r?1:0,$=r>i?1:0,o=i===r?1:0,{data:_}=await A.from("friend_match_stats").select("*").eq("player1_id",s).eq("player2_id",d).single();_?await A.from("friend_match_stats").update({wins_p1:_.wins_p1+g,wins_p2:_.wins_p2+$,draws:_.draws+o,goals_p1:_.goals_p1+i,goals_p2:_.goals_p2+r,gc_used_p1:_.gc_used_p1+u,gc_used_p2:_.gc_used_p2+m,matches_total:_.matches_total+1}).eq("player1_id",s).eq("player2_id",d):await A.from("friend_match_stats").insert({player1_id:s,player2_id:d,wins_p1:g,wins_p2:$,draws:o,goals_p1:i,goals_p2:r,gc_used_p1:u,gc_used_p2:m,matches_total:1})}const xn="2026.06.28-2309";async function bi(e,{state:t,navigate:n,toast:a}){var l,s;const p=t.profile;p&&(e.innerHTML=`
  <div class="page">
    <div class="page-body">
  ...
  `,e.querySelectorAll("[data-nav]").forEach(d=>{d.addEventListener("click",c=>{c.preventDefault(),n(d.dataset.nav)})}),(l=document.getElementById("nav-rankings"))==null||l.addEventListener("click",()=>n("rankings")),(s=document.getElementById("nav-matches"))==null||s.addEventListener("click",()=>n("matches")),e.querySelectorAll("[data-action]").forEach(d=>{d.addEventListener("click",()=>{d.classList.add("tapped"),setTimeout(()=>d.classList.remove("tapped"),200);const c=d.dataset.action;if(c==="match-ai"){vn(n);return}if(c==="match-random"){n("match",{matchMode:"random"});return}if(c==="match-friend"){n("friends");return}a("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await A.auth.signOut(),window.location.reload()}),Ci(t,a),bn(t,a,n),Mi(t,a,n))}async function Mi(e,t,n){const a=document.getElementById("ongoing-match-banner");if(!a)return;const p=e.profile.id,{data:l}=await A.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${p},away_id.eq.${p}`).order("created_at",{ascending:!1});if(!(l!=null&&l.length)){a.innerHTML="";return}const s=l.map(c=>c.home_id===p?c.away_id:c.home_id).filter(Boolean);let d={};if(s.length){const{data:c}=await A.from("users").select("id, pseudo, club_name").in("id",s);(c||[]).forEach(i=>{d[i.id]=i.club_name||i.pseudo})}a.innerHTML=l.map(c=>{const i=c.home_id===p?c.away_id:c.home_id,r=d[i]||"Adversaire";return`
    ...
    </div>`,(i=document.getElementById("match-inv-accept"))==null||i.addEventListener("click",()=>{a.innerHTML="",n("match",{matchMode:"friend",friendId:s,friendName:l})}),(r=document.getElementById("match-inv-decline"))==null||r.addEventListener("click",async()=>{await A.from("friend_match_invites").update({status:"declined"}).eq("id",p.id),a.innerHTML="",t("Invitation refusée","info")})}async function Ci(e,t){const n=document.getElementById("friend-requests-banner");if(!n)return;const{data:a,error:p}=await A.from("friendships").select("id, requester:users!requester_id(pseudo, club_name)").eq("addressee_id",e.user.id).eq("status","pending");if(p||!(a!=null&&a.length)){n.innerHTML="";return}const l=a.length,s=a.slice(0,2).map(c=>{var i;return((i=c.requester)==null?void 0:i.pseudo)||"?"}).join(", "),d=l>2?` +${l-2}`:"";n.innerHTML=`
    ...
    </div>`,document.getElementById("friend-req-btn").addEventListener("click",()=>{Si(e,t,()=>Ci(e,t))})}function vn(e){const t=[{mode:"vs_ai_easy",label:"Facile",sub:"Gain 500 cr.",icon:"🟢"},{mode:"vs_ai_medium",label:"Moyen",sub:"Gain 1 000 cr.",icon:"🟡"},{mode:"vs_ai_hard",label:"Difficile",sub:"Gain 1 500 cr.",icon:"🟠"},{mode:"vs_ai_club",label:"Club",sub:"Gain 2 500 cr.",icon:"🔴"}],n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2000",n.innerHTML=`
  ...
  </div>`}async function kn(e,t){const{state:n,navigate:a,toast:p,openModal:l,closeModal:s}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:d}=await A.from("cards").select(`id, card_type, current_note, gc_type, formation, is_for_sale, sale_price,
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function M(){const O=document.getElementById("col-filters");O&&(B==="player"?(O.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",L=>{F=L.target.value.toLowerCase(),Y()}),e.querySelectorAll(".filter-btn").forEach(L=>{L.addEventListener("click",()=>{U=L.dataset.job,M(),Y()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{j=!j,M(),Y()})):(O.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Bt=1e3;function An(e,t,n,a){var $,o,_;const{state:p,toast:l,closeModal:s,navigate:d,refreshProfile:c}=n,i=e.formation,r={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function u(){const S=zt[i]||{},z=oi[i]||[],B=290,U=360,F=20;function j(te){const ce=S[te];return ce?{x:ce.x*B,y:ce.y*U}:null}let R=`<svg width="${B}" height="${U}" viewBox="0 0 ${B} ${U}" xmlns="http://www.w3.org/2000/svg">`;for(const[te,ce]of z){const ne=j(te),M=j(ce);!ne||!M||(R+=`<line x1="${ne.x}" y1="${ne.y}" x2="${M.x}" y2="${M.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const te of Object.keys(S)){const ce=j(te);if(!ce)continue;const ne=te.replace(/\d+/,""),M=r[ne]||"#555";R+=`<circle cx="${ce.x}" cy="${ce.y}" r="${F}" fill="${M}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,R+=`<text x="${ce.x}" y="${ce.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${ne}</text>`}return R+="</svg>",R}const m=t.filter(S=>S.formation===i);m.length;const g=!e.is_for_sale;a(`Formation ${i}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),($=document.getElementById("direct-sell-form-btn"))==null||$.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${i} pour ${Bt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const S=m.find(B=>!B.is_for_sale)||m[0];if(!S){l("Aucune carte à vendre","error");return}const{error:z}=await A.from("cards").delete().eq("id",S.id);if(z){l(z.message,"error");return}await A.from("users").update({credits:(p.profile.credits||0)+Bt}).eq("id",p.profile.id),await c(),l(`+${Bt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),s(),d("collection")}),(o=document.getElementById("market-sell-form-btn"))==null||o.addEventListener("click",async()=>{const S=parseInt(document.getElementById("sell-price-form").value);if(!S||S<1){l("Prix invalide","error");return}await A.from("cards").update({is_for_sale:!0,sale_price:S}).eq("id",e.id),await A.from("market_listings").insert({seller_id:p.profile.id,card_id:e.id,price:S}),l("Carte mise en vente sur le marché !","success"),s(),d("collection")}),(_=document.getElementById("cancel-sell-form-btn"))==null||_.addEventListener("click",async()=>{await A.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await A.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),s(),d("collection")})}async function _i(e,t,n,a){var Q,ae,pe,he,xe,ge,O;const{state:p,toast:l,openModal:s,closeModal:d,navigate:c,refreshProfile:i}=a,r=e.player,u=t.filter(L=>L.player.id===r.id),m=u.length,g=Math.max(Number(r.note_g)||0,Number(r.note_d)||0,Number(r.note_m)||0,Number(r.note_a)||0),$=r.rarity||"normal",{data:o}=await A.from("sell_price_configs").select("*").eq("rarity",$).lte("note_min",g).gte("note_max",g).order("note_min",{ascending:!1}).limit(1),_=((Q=o==null?void 0:o[0])==null?void 0:Q.price)??$n[$]??1e3,S=r.rarity!=="legende",z=qi(r),B=Lt(r,r.job),U=r.job2?Lt(r,r.job2):null,F=Et[r.job]||"#1A6B3C",j=r.job2?Et[r.job2]:null,R=Fi[r.rarity]||"#ccc",te=si[r.country_code]||r.country_code||"",ce=u.map(L=>L.id);let ne={};if(ce.length){const{data:L}=await A.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",ce).order("transferred_at",{ascending:!0});(L||[]).forEach(P=>{ne[P.card_id]||(ne[P.card_id]=[]),ne[P.card_id].push(P)})}const M=L=>`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(he=document.getElementById("close-detail"))==null||he.addEventListener("click",d);let ee=new Set;const D=()=>{const L=ee.size,P=document.getElementById("sell-action-panel");P&&(P.style.display=L>0?"block":"none",document.getElementById("sell-selected-count").textContent=L,document.getElementById("sell-direct-total").textContent=(L*_).toLocaleString("fr")+" cr.")};document.querySelectorAll(".expl-check").forEach(L=>{L.addEventListener("change",()=>{const P=L.dataset.id;L.checked?ee.add(P):ee.delete(P);const q=L.closest(".exemplaire-row");q&&(q.style.borderColor=L.checked?"#1A6B3C":"#eee"),D()})}),document.querySelectorAll(".exemplaire-row").forEach(L=>{L.addEventListener("click",P=>{if(P.target.closest("button")||P.target.tagName==="INPUT")return;const q=L.querySelector(".expl-check");q&&!q.disabled&&(q.checked=!q.checked,q.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(L=>{L.addEventListener("click",P=>{P.stopPropagation();const q=document.querySelector(`.expl-hist[data-hist="${L.dataset.idx}"]`);q&&(q.style.display=q.style.display==="none"?"flex":"none")})}),(xe=document.getElementById("direct-sell-btn"))==null||xe.addEventListener("click",async()=>{const L=[...ee];if(!L.length)return;const P=L.length*_;if(!confirm(`Vendre ${L.length} carte${L.length>1?"s":""} ${r.surname_encoded} pour ${P.toLocaleString("fr")} crédits ? Action irréversible.`))return;const{error:q}=await A.from("cards").delete().in("id",L);if(q){l(q.message,"error");return}await A.from("users").update({credits:(p.profile.credits||0)+P}).eq("id",p.profile.id),await i();const V=document.getElementById("nav-credits");V&&(V.textContent=`💰 ${(p.profile.credits||0).toLocaleString("fr")}`),l(`+${P.toLocaleString("fr")} crédits ! ${L.length} carte${L.length>1?"s":""} vendue${L.length>1?"s":""}.`,"success"),d(),c("collection")}),(ge=document.getElementById("market-sell-btn"))==null||ge.addEventListener("click",async()=>{var ie;const L=[...ee];if(!L.length){l("Sélectionne au moins un exemplaire","warning");return}const P=parseInt((ie=document.getElementById("sell-market-price"))==null?void 0:ie.value);if(!P||P<1){l("Prix invalide","error");return}const{error:q}=await A.from("cards").update({is_for_sale:!0,sale_price:P}).in("id",L);if(q){l(q.message,"error");return}const V=L.map(ke=>({seller_id:p.profile.id,card_id:ke,price:P,status:"active"})),{error:re}=await A.from("market_listings").insert(V);re&&console.warn("[Market] insert listings:",re.message),l(`${L.length} carte${L.length>1?"s":""} mise${L.length>1?"s":""} en vente à ${P.toLocaleString("fr")} cr. chacune !`,"success"),d(),c("collection")}),(O=document.getElementById("cancel-sell-btn"))==null||O.addEventListener("click",async()=>{await A.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await A.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),l("Annonce retirée","success"),d(),c("collection")})}const Gt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},rt={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ut(e){const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const n=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${n}.png`}function Di(e){return!e||e.length<2?null:`https://flagcdn.com/24x18/${e.slice(0,2).toLowerCase()}.png`}function Gi(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co";return(n=e==null?void 0:e.clubs)!=null&&n.logo_url?e.clubs.logo_url.startsWith("http")?e.clubs.logo_url:`${t}/storage/v1/object/public/assets/clubs/${e.clubs.logo_url}`:null}function Tn(e,t=44,n=58){var g;const a=e?Ut(e):null,p=e?Gi(e):null,l=Di(e==null?void 0:e.country_code),s=(e==null?void 0:e.job)||"MIL",d=rt[s]||"#555",c={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[e==null?void 0:e.rarity]||"#aaa",i=Number(s==="GK"?e==null?void 0:e.note_g:s==="DEF"?e==null?void 0:e.note_d:s==="MIL"?e==null?void 0:e.note_m:e==null?void 0:e.note_a)||0,r=Math.round(n*.19),u=Math.round(n*.25),m=n-r-u;return e?`<div style="width:${t}px;height:${n}px;border-radius:5px;border:2px solid ${c};background:${d};position:relative;overflow:hidden;flex-shrink:0">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const s=prompt("Nom du deck :",`Deck ${((l==null?void 0:l.length)||0)+1}`);if(!s)return;const{data:d,error:c}=await A.from("decks").insert({owner_id:n.profile.id,name:s}).select().single();if(c){p(c.message,"error");return}p("Deck créé !","success"),$i(d.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(s=>{s.addEventListener("click",()=>$i(s.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(s=>{s.addEventListener("click",async()=>{const d=prompt("Nouveau nom :",s.dataset.name);if(!d||d===s.dataset.name)return;const{error:c}=await A.from("decks").update({name:d}).eq("id",s.dataset.rename);if(c){p(c.message,"error");return}p("Deck renommé !","success"),Xt(e,t)})}),e.querySelectorAll("[data-delete]").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm(`Supprimer le deck "${s.dataset.name}" ? Cette action est irréversible.`))return;await A.from("deck_cards").delete().eq("deck_id",s.dataset.delete);const{error:d}=await A.from("decks").delete().eq("id",s.dataset.delete);if(d){p(d.message,"error");return}p("Deck supprimé.","success"),Xt(e,t)})})}async function $i(e,t,n){const{state:a,toast:p}=n;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await A.from("decks").select("*").eq("id",e).single(),{data:s}=await A.from("cards").select(`id, card_type, formation,
      player:players(id, firstname, surname_encoded, country_code, club_id, job, job2,
        note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length,
        clubs(encoded_name, logo_url))`).eq("owner_id",a.profile.id),d=(s||[]).filter(g=>g.card_type==="player"&&g.player),c=(s||[]).filter(g=>g.card_type==="formation"),i=c.map(g=>g.formation).filter(Boolean),{data:r}=await A.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let u=l.formation||"4-4-2";i.length>0&&!i.includes(u)&&(u=i[0]);const m={deckId:e,name:l.name,formation:u,formationCardId:l.formation_card_id,slots:{},subs:[],playerCards:d,formationCards:c,availableFormations:i};(r||[]).forEach(g=>{g.is_starter?m.slots[g.position]=g.card_id:m.subs.includes(g.card_id)||m.subs.push(g.card_id)}),pt(t,m,n)}function pt(e,t,n){var c;const{navigate:a}=n;Gt[t.formation];const p=ki(t.formation),l=p.filter(i=>t.slots[i]).length,s=t.availableFormations.length>0?t.availableFormations:Object.keys(Gt),d=t.subs.map(i=>t.playerCards.find(r=>r.id===i)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div style="height:100%;overflow-y:auto;padding-bottom:80px;background:var(--page-bg)">
  ...
  </div>`,In(e,t,p,n),document.getElementById("builder-back").addEventListener("click",()=>a("decks")),document.getElementById("formation-select").addEventListener("change",i=>{t.formation=i.target.value;const r=ki(t.formation),u={};r.forEach(m=>{t.slots[m]&&(u[m]=t.slots[m])}),t.slots=u,pt(e,t,n)}),document.getElementById("save-deck").addEventListener("click",()=>Sn(t,n)),e.querySelectorAll("[data-remove-sub]").forEach(i=>{i.addEventListener("click",()=>{t.subs=t.subs.filter(r=>r!==i.dataset.removeSub),pt(e,t,n)})}),(c=document.getElementById("add-sub-btn"))==null||c.addEventListener("click",()=>{zn(t,e,n)})}function In(e,t,n,a){const p=e.querySelector("#deck-field");if(!p)return;const l=zt[t.formation]||{},s=Li(t.formation)||[],d={};for(const S of n){const z=t.slots[S],B=z?t.playerCards.find(U=>U.id===z):null;d[S]=B?B.player:null}const c=300,i=300,r=48,u=64,m=13,g=16,$=38;function o(S){const z=l[S];return z?{x:z.x*c,y:z.y*i}:null}let _="";for(const[S,z]of s){const B=o(S),U=o(z);if(!B||!U)continue;const F=d[S]?{...d[S],club_id:d[S].club_id,country_code:d[S].country_code,rarity:d[S].rarity}:null,j=d[z]?{...d[z],club_id:d[z].club_id,country_code:d[z].country_code,rarity:d[z].rarity}:null,R=Ze(F,j);R==="#ff3333"||R==="#cc2222"?_+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${U.x.toFixed(1)}" y2="${U.y.toFixed(1)}" stroke="${R}" stroke-width="2.5" stroke-linecap="round" opacity="0.4"/>`:(_+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${U.x.toFixed(1)}" y2="${U.y.toFixed(1)}" stroke="${R}" stroke-width="8" stroke-linecap="round" opacity="0.2"/>`,_+=`<line x1="${B.x.toFixed(1)}" y1="${B.y.toFixed(1)}" x2="${U.x.toFixed(1)}" y2="${U.y.toFixed(1)}" stroke="${R}" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>`)}for(const S of n){const z=o(S);if(!z)continue;const B=d[S],U=S.replace(/\d+/,""),F=rt[U]||"#555",j=(z.x-r/2).toFixed(1),R=(z.y-u/2).toFixed(1),te={normal:"#aaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#222",legende:"#7a28b8",légende:"#7a28b8"}[B==null?void 0:B.rarity]||"#aaa";if(B){const ce=Ut(B),ne=Gi(B),M=Di(B.country_code),Y=Number(U==="GK"?B.note_g:U==="DEF"?B.note_d:U==="MIL"?B.note_m:B.note_a)||0,ee=u-m-g;_+=`<defs><clipPath id="dcp-${S}"><rect x="${j}" y="${(z.y-u/2+m).toFixed(1)}" width="${r}" height="${ee}"/></clipPath></defs>`,_+=`<rect x="${j}" y="${R}" width="${r}" height="${u}" rx="5" fill="${F}"/>`,ce&&(_+=`<image href="${ce}" x="${j}" y="${(z.y-u/2+m).toFixed(1)}" width="${r}" height="${ee}" clip-path="url(#dcp-${S})" preserveAspectRatio="xMidYMin slice"/>`),_+=`<rect x="${j}" y="${R}" width="${r}" height="${m}" fill="rgba(255,255,255,0.93)"/>`,_+=`<text x="${z.x.toFixed(1)}" y="${(z.y-u/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(B.surname_encoded||"").slice(0,9)}</text>`;const D=(z.y+u/2-g).toFixed(1);_+=`<rect x="${j}" y="${D}" width="${r}" height="${g}" fill="rgba(255,255,255,0.93)"/>`,M&&(_+=`<image href="${M}" x="${(z.x-21).toFixed(1)}" y="${(z.y+u/2-g+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`),_+=`<text x="${z.x.toFixed(1)}" y="${(z.y+u/2-g/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="#111" font-family="Arial Black">${Y}</text>`,ne&&(_+=`<image href="${ne}" x="${(z.x+r/2-14).toFixed(1)}" y="${(z.y+u/2-g+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`),_+=`<rect x="${j}" y="${R}" width="${r}" height="${u}" rx="5" fill="none" stroke="${te}" stroke-width="2"/>`}else _+=`<rect x="${j}" y="${R}" width="${r}" height="${u}" rx="5" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.35)" stroke-width="2" stroke-dasharray="5,3"/>`,_+=`<text x="${z.x.toFixed(1)}" y="${z.y.toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="22" fill="rgba(255,255,255,0.35)">+</text>`,_+=`<text x="${z.x.toFixed(1)}" y="${(z.y+16).toFixed(1)}" text-anchor="middle" font-size="7" fill="rgba(255,255,255,0.3)">${U}</text>`;_+=`<rect x="${j}" y="${R}" width="${r}" height="${u}" rx="5" fill="rgba(0,0,0,0.01)" class="deck-slot-hit" data-pos="${S}" style="cursor:pointer"/>`}p.innerHTML=`<svg viewBox="${-$} ${-$} ${c+$*2} ${i+$*2}" width="100%" style="display:block;max-width:440px;margin:0 auto">${_}</svg>`,p.querySelectorAll(".deck-slot-hit").forEach(S=>{S.addEventListener("click",()=>Ln(S.dataset.pos,t,e,a))})}function Ln(e,t,n,a){var m,g,$;const{openModal:p,closeModal:l}=a,s=e.replace(/\d+/,""),d=t.slots[e],c=d?t.playerCards.find(o=>o.id===d):null;(m=c==null?void 0:c.player)==null||m.id;const i=new Set;Object.entries(t.slots).forEach(([o,_])=>{var z;if(o===e||!_)return;const S=t.playerCards.find(B=>B.id===_);(z=S==null?void 0:S.player)!=null&&z.id&&i.add(S.player.id)}),t.subs.forEach(o=>{var S;const _=t.playerCards.find(z=>z.id===o);(S=_==null?void 0:_.player)!=null&&S.id&&i.add(_.player.id)});const r=new Set,u=t.playerCards.filter(o=>{const _=o.player;return!(_.job===s||_.job2===s)||i.has(_.id)||r.has(_.id)?!1:(r.add(_.id),!0)});u.sort((o,_)=>{const S=s==="GK"?o.player.note_g:s==="DEF"?o.player.note_d:s==="MIL"?o.player.note_m:o.player.note_a;return(s==="GK"?_.player.note_g:s==="DEF"?_.player.note_d:s==="MIL"?_.player.note_m:_.player.note_a)-S}),p(`Choisir ${s} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
        <button class="btn btn-danger btn-sm" id="remove-player" style="width:100%;margin-bottom:4px">
          ✕ Retirer le joueur actuel
        </button>`:""}
      ${u.length>0?u.map(o=>{var U,F;const _=o.player,S=s==="GK"?_.note_g:s==="DEF"?_.note_d:s==="MIL"?_.note_m:_.note_a,z=Ut(_),B={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[_.rarity];return`<div class="player-option" data-card-id="${o.id}"
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
  ...
  </div>`;const u=()=>{const o=(_,S)=>e.querySelectorAll(_).forEach((z,B)=>{setTimeout(()=>{z.style.opacity="1",z.style.transform="translateY(0) scale(1)"},S+B*90)});o(".duel-card-home",150),o(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((_,S)=>{setTimeout(()=>{_.style.opacity="1"},S*70)}),900),setTimeout(()=>{const _=e.querySelector("#vs-label");_&&(_.style.opacity="1",_.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(S=>S.style.opacity="1")},1250),setTimeout(()=>{m("score-home",d,800),m("score-ai",c,800)},1500)};function m(o,_,S){const z=document.getElementById(o);if(!z)return;const B=performance.now(),U=F=>{const j=Math.min(1,(F-B)/S);z.textContent=Math.round(_*(1-Math.pow(1-j,3))),j<1?requestAnimationFrame(U):z.textContent=_};requestAnimationFrame(U)}requestAnimationFrame(u),t.attacker=i?"home":"ai";const g=i?li():null;i&&(t.boostCard={value:g}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:a.map(o=>({name:o.name,note:we(o,"MIL"),portrait:ze(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),aiPlayers:p.map(o=>({name:o.name,note:we(o,"MIL"),portrait:ze(o),job:o.job,country_code:o.country_code,rarity:o.rarity,clubName:o.clubName,clubLogo:o.clubLogo})),homeTotal:d,aiTotal:c,text:`Duel milieu : ${t.clubName} ${d} – ${c} IA → ${i?t.clubName+" attaque":"IA attaque"}`});const $=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Se(e,t,n),t.attacker==="ai"&&setTimeout(()=>ti(e,t,n),800)};setTimeout(()=>{const o=document.getElementById("score-home"),_=document.getElementById("score-ai"),S=document.getElementById(i?"duel-row-home":"duel-row-ai"),z=document.getElementById(i?"duel-row-ai":"duel-row-home"),B=i?o:_,U=i?_:o;B&&(B.style.fontSize="80px",B.style.color=i?"#FFD700":"#ff6b6b",B.style.animation="duelPulse .5s ease"+(i?", duelGlow 1.5s ease infinite .5s":"")),U&&(U.style.opacity="0.25"),setTimeout(()=>{S&&(S.style.transformOrigin="center",S.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",S.style.zIndex="5"),setTimeout(()=>{var j;const F=document.getElementById("duel-shock");if(F){const R=(j=z||S)==null?void 0:j.getBoundingClientRect(),te=e.querySelector(".match-screen").getBoundingClientRect();R&&(F.style.top=R.top-te.top+R.height/2+"px"),F.style.animation="shockwave .5s ease-out forwards"}z&&(z.style.transformOrigin="center",z.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var j;const F=document.getElementById("duel-finale");F&&(F.innerHTML=`
    ...
    <div style="display:flex;align-items:center;gap:4px;${t?"flex-direction:row-reverse":""};background:rgba(255,255,255,0.04);border-radius:8px;padding:5px 8px;border:1px solid rgba(255,255,255,0.07)">
      ...
      ${nt(e.inPlayer||{})}
    </div>`}return`<div style="font-size:11px;color:${e.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${e.type==="goal"?700:400};padding:3px 2px">${e.text||""}</div>`}function Se(e,t,n){var B,U,F,j,R,te,ce,ne;const a=t.selected.map(M=>M.cardId),p=t.usedSubIds||[],l=t.homeSubs.filter(M=>!p.includes(M.cardId)),d=Object.values(t.homeTeam).flat().filter(M=>M.used).length>0&&l.length>0&&t.subsUsed<t.maxSubs,c=!["GK","DEF","MIL","ATT"].some(M=>(t.aiTeam[M]||[]).some(Y=>!Y.used)),i=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(M=>!M.used),r=t.phase==="attack"&&c&&i.length===0?[...t.homeTeam.GK||[],...t.homeTeam.DEF||[]].filter(M=>!M.used).map(M=>M.cardId):[];t.log[t.log.length-1];const u=t.phase==="ai-attack"||t.phase==="ai-defense",m=t.phase==="attack",g=t.phase==="defense",$=t.phase==="finished",o=t.gcCards.filter(M=>!t.usedGc.includes(M.id)),_=t.boostCard&&!t.boostUsed;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column",e.innerHTML=`
  <style>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const Y=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
          ...
          </div>`}const M=t.log[t.log.length-1];return M?'<div style="padding:2px 4px">'+oo(M)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
  ...
  `,document.body.appendChild(a);let r=!1;const u=()=>{r||(r=!0,a.remove(),n())};a.addEventListener("click",u),setTimeout(u,2e3)}function _t(e,t="rgba(0,0,0,0.8)"){const n=document.createElement("div");n.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function Yt(e,t,n,a=null,p=null){var g,$;if(t.phase!=="attack"){_t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){_t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const l=Object.entries(t.homeTeam).flatMap(([o,_])=>(_||[]).filter(S=>S.used).map(S=>({...S,_line:S._line||o}))),s=t.homeSubs.filter(o=>!t.usedSubIds.includes(o.cardId));if(!l.length){_t("Aucun joueur utilisé à remplacer");return}if(!s.length){_t("Aucun remplaçant disponible");return}let d=Math.max(0,l.findIndex(o=>o.cardId===p));const c=((g=l[d])==null?void 0:g._line)||(($=l[d])==null?void 0:$.job);let i=a?Math.max(0,s.findIndex(o=>o.cardId===a)):Math.max(0,s.findIndex(o=>o.job===c)),r=!1;const u=document.createElement("div");u.id="sub-overlay",u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function m(){var F,j,R,te,ce,ne;const o=l[d],_=s[i],S=Math.min(130,Math.round((window.innerWidth-90)/2)),z=Math.round(S*1.35),B=M=>`background:rgba(255,255,255,0.12);border:none;color:${M?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${M?"default":"pointer"};flex-shrink:0`;u.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${_?Ve({..._,used:!1,boost:0},S,z):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${o?Ve({...o,used:!1,boost:0},S,z):"<div>—</div>"}</div>
    ...
    </div>`,(F=u.querySelector("#sub-close"))==null||F.addEventListener("click",()=>u.remove()),(j=u.querySelector("#out-up"))==null||j.addEventListener("click",()=>{d>0&&(d--,m())}),(R=u.querySelector("#out-down"))==null||R.addEventListener("click",()=>{d<l.length-1&&(d++,m())}),(te=u.querySelector("#in-up"))==null||te.addEventListener("click",()=>{i>0&&(i--,m())}),(ce=u.querySelector("#in-down"))==null||ce.addEventListener("click",()=>{i<s.length-1&&(i++,m())});const U=(M,Y,ee,D)=>{const Q=u.querySelector("#"+M);if(!Q)return;let ae=0;Q.addEventListener("touchstart",pe=>{ae=pe.touches[0].clientY},{passive:!0}),Q.addEventListener("touchend",pe=>{const he=pe.changedTouches[0].clientY-ae;if(Math.abs(he)<30)return;const xe=Y();he<0&&xe<D-1?(ee(xe+1),m()):he>0&&xe>0&&(ee(xe-1),m())},{passive:!0})};U("in-panel",()=>i,M=>i=M,s.length),U("out-panel",()=>d,M=>d=M,l.length),(ne=u.querySelector("#sub-confirm"))==null||ne.addEventListener("click",M=>{if(M.preventDefault(),M.stopPropagation(),r)return;r=!0;const Y=l[d],ee=s[i];if(!Y||!ee)return;let D=null,Q=-1;for(const[pe,he]of Object.entries(t.homeTeam)){const xe=(he||[]).findIndex(ge=>ge.cardId===Y.cardId);if(xe!==-1){D=pe,Q=xe;break}}if(Q===-1||!D){_t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const ae={...ee,_line:D,_col:Y._col||0,used:!1,boost:0};t.homeTeam[D].splice(Q,1,ae),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(ee.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Y.name,firstname:Y.firstname,note:we(Y,D),portrait:ze(Y),job:Y.job,country_code:Y.country_code,rarity:Y.rarity,clubName:Y.clubName,clubLogo:Y.clubLogo},inPlayer:{name:ee.name,firstname:ee.firstname,note:we(ee,D),portrait:ze(ee),job:ee.job,country_code:ee.country_code,rarity:ee.rarity,clubName:ee.clubName,clubLogo:ee.clubLogo},text:`🔄 ${ee.firstname} ${ee.name} remplace ${Y.firstname} ${Y.name}`}),u.remove(),co(Y,ee,()=>Se(e,t,n))})}document.body.appendChild(u),m()}function po(e,t,n,a,p){var $,o;const l=(a.gcDefs||[]).find(_=>_.name===t),s=Ge[t]||{icon:"⚡",desc:"Carte spéciale."},d={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[l==null?void 0:l.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",c={purple:"#b06ce0",light_blue:"#00d4ef"}[l==null?void 0:l.color]||"#b06ce0",i=(l==null?void 0:l.name)||t,r=(l==null?void 0:l.effect)||s.desc,u=l!=null&&l.image_url?`/manager-wars/icons/${l.image_url}`:null,m=s.icon||"⚡",g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",g.innerHTML=`
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(p=>{p.addEventListener("click",()=>{const l=p.dataset.cardId;for(const s of["GK","DEF","MIL","ATT"]){const d=(t.homeTeam[s]||[]).find(c=>c.cardId===l);if(d){d.boost=(d.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${d.name}`,type:"info"});break}}t.boostUsed=!0,n.closeModal(),Se(e,t,n)})})}function Nt(e,t,n,a,p){const l=document.createElement("div");l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:900;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;overflow:hidden;cursor:pointer";const s=Array.from({length:10},(i,r)=>`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(l);let d=!1;const c=()=>{d||(d=!0,l.remove(),setTimeout(()=>p(),50))};l.addEventListener("click",c),setTimeout(c,3500)}async function At(e,t,n){var r,u;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:a}=n,p=t.homeScore>t.aiScore,l=t.homeScore===t.aiScore,s=p?"victoire":l?"nul":"defaite",d=wn(t.mode,s);t.matchId&&await A.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:p?a.profile.id:null,home_credits_reward:d,played_at:new Date().toISOString()}).eq("id",t.matchId);const c={credits:(a.profile.credits||0)+d,matches_played:(a.profile.matches_played||0)+1};p?c.wins=(a.profile.wins||0)+1:l?c.draws=(a.profile.draws||0)+1:c.losses=(a.profile.losses||0)+1,await A.from("users").update(c).eq("id",a.profile.id),await n.refreshProfile();const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",i.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const g=async(B=!0)=>{u=!0,m&&(A.removeChannel(m),m=null),B&&await A.rpc("cancel_matchmaking",{p_user_id:c.profile.id}).catch(()=>{})};(z=document.getElementById("mm-cancel"))==null||z.addEventListener("click",async()=>{try{await g(!0)}catch{}Oe(e),i("home")});const $=async(B,U,F)=>{if(u)return;u=!0,m&&(A.removeChannel(m),m=null);const j=document.getElementById("mm-status");j&&(j.textContent="Adversaire trouvé !"),await new Promise(R=>setTimeout(R,600)),e.isConnected&&Qi(e,t,B,F,s,d)},{data:o,error:_}=await A.rpc("try_matchmake",{p_user_id:c.profile.id,p_deck_id:n});if(_||!(o!=null&&o.success)){r("Erreur de matchmaking","error"),Oe(e),i("home");return}if(o.matched){$(o.match_id,o.opponent_id,!1);return}const S=document.getElementById("mm-status");S&&(S.textContent="En attente d'un autre joueur..."),m=A.channel("matchmaking-"+c.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${c.profile.id}`},B=>{const U=B.new;U.status==="matched"&&U.match_id&&$(U.match_id,U.matched_with,!0)}).subscribe()}async function yo(e,t,n){const{state:a,navigate:p,toast:l}=t;try{(A.getChannels?A.getChannels():[]).forEach(i=>{const r=i.topic||"";(r.includes("matchmaking")||r.includes("pvp-match")||r.includes("friend-invite"))&&A.removeChannel(i)})}catch{}const{data:s}=await A.from("matches").select("home_id, away_id, status").eq("id",n).single();if(!s){l("Match introuvable","error"),p("home");return}if(s.status==="finished"){l("Ce match est terminé","info"),p("home");return}const d=s.home_id===a.profile.id;Qi(e,t,n,d,[],[])}async function Qi(e,t,n,a,p=[],l=[]){const{state:s,navigate:d,toast:c}=t,i=a?"p1":"p2",r=a?"p2":"p1",u=(p||[]).map(T=>T.id),m=(p||[]).map(T=>({id:T.id,gc_type:T.gc_type,_gcDef:T._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await A.from("matches").select("*").eq("id",n).single();if(!g){c("Match introuvable","error"),d("home");return}async function $(){const[{data:T},{data:f},{data:x},{data:h}]=await Promise.all([A.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),A.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),A.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),A.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),y=k=>({cardId:k.card_id,position:k.position,id:k.id,firstname:k.firstname,name:k.surname_encoded,country_code:k.country_code,club_id:k.club_id,job:k.job,job2:k.job2,note_g:Number(k.note_g)||0,note_d:Number(k.note_d)||0,note_m:Number(k.note_m)||0,note_a:Number(k.note_a)||0,rarity:k.rarity,skin:k.skin,hair:k.hair,hair_length:k.hair_length,clubName:k.club_encoded_name||null,clubLogo:k.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),b=((T==null?void 0:T.starters)||[]).map(k=>y(k)),v=((f==null?void 0:f.starters)||[]).map(k=>y(k)),w=(T==null?void 0:T.formation)||"4-4-2",I=(f==null?void 0:f.formation)||"4-4-2";return{p1Team:gt(b,w),p2Team:gt(v,I),p1Subs:((T==null?void 0:T.subs)||[]).map(k=>y(k)),p2Subs:((f==null?void 0:f.subs)||[]).map(k=>y(k)),p1Formation:w,p2Formation:I,p1Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 1",p2Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?u:[],gc_p2:a?[]:u,gcCardsFull_p1:a?m:[],gcCardsFull_p2:a?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:l||[],lastActionAt:new Date().toISOString()}}let o=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!o)if(a){o=await $();const{data:T}=await A.from("matches").select("game_state").eq("id",n).single();!(T!=null&&T.game_state)||!Object.keys(T.game_state).length?await A.from("matches").update({game_state:o,turn_user_id:g.home_id}).eq("id",n):o=T.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let T=0;T<30&&!o;T++){await new Promise(x=>setTimeout(x,400));const{data:f}=await A.from("matches").select("game_state").eq("id",n).single();f!=null&&f.game_state&&Object.keys(f.game_state).length&&(o=f.game_state)}if(!o){c("Erreur de synchronisation","error"),d("home");return}o.gc_p2=u,o.gcCardsFull_p2=m,await A.from("matches").update({game_state:o}).eq("id",n)}let _=!1,S=null,z=!1;const B=new Set,U=new Set;function F(T){var k,E;try{A.removeChannel(j)}catch{}const f=o[i+"Score"]||0,x=o[r+"Score"]||0;let h,y;T.winner_id?(h=T.winner_id===s.profile.id,y=!1):T.forfeit?(h=f>x,y=!1):(y=f===x,h=f>x),(k=document.getElementById("pvp-end-overlay"))==null||k.remove();const b=document.createElement("div");b.id="pvp-end-overlay",b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":h?"🏆":"😞",w=y?"MATCH NUL":h?"VICTOIRE !":"DÉFAITE",I=y?"#fff":h?"#FFD700":"#ff6b6b";b.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(b),(E=b.querySelector("#pvp-end-home"))==null||E.addEventListener("click",()=>{b.remove(),Oe(e),d("home")})}const j=A.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},T=>{const f=T.new;try{if(f.status==="finished"||f.forfeit){if(_)return;_=!0,S&&(clearInterval(S),S=null),f.game_state&&(o=f.game_state),F(f);return}if(f.game_state){const x=o;o=f.game_state;const h=o._lastGC;if(h&&h.seq&&!U.has(h.seq)&&(U.add(h.seq),h.by!==i)){xe(h.type,h.by,()=>D());return}const y=x[i+"Score"]||0,b=x[r+"Score"]||0,v=o[i+"Score"]||0,w=o[r+"Score"]||0,I=v>y,k=w>b;if((I||k)&&!B.has(o.round)){B.add(o.round);const E=[...o.log||[]].reverse().find(N=>N.isGoal),C=((E==null?void 0:E.homePlayers)||[]).map(N=>({name:N.name,note:N.note,portrait:N.portrait,job:N.job}));he(C,v,w,I,()=>D());return}D()}}catch(x){console.error("[PvP] crash:",x)}}).subscribe();async function R(T){Object.assign(o,T),o.lastActionAt=new Date().toISOString();const{error:f}=await A.from("matches").update({game_state:o}).eq("id",n);f&&c("Erreur de synchronisation","error");try{D()}catch(x){console.error("[PvP] renderPvpScreen crash:",x)}}async function te(){if(_)return;_=!0,S&&(clearInterval(S),S=null);const T=a?g.away_id:g.home_id,f=a?"p2":"p1",x=a?"p1":"p2",h={...o,[f+"Score"]:3,[x+"Score"]:0,phase:"finished"};try{await A.from("matches").update({status:"finished",forfeit:!0,winner_id:T,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",n)}catch{}try{A.removeChannel(j)}catch{}setTimeout(()=>{Oe(e),d("home")},800)}const ce={BOOST_STAT:({value:T=1,count:f=1,roles:x=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!x.length||x.includes(w)).flatMap(([w,I])=>I.filter(k=>!k.used).map(k=>({...k,_line:w})));if(!v.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(h);return}ne(v,f,`Choisir ${f} joueur(s) à booster (+${T})`,w=>{w.forEach(I=>{const k=(b[I._line]||[]).find(E=>E.cardId===I.cardId);k&&(k.boost=(k.boost||0)+T,h.log.push({text:`⚡ +${T} sur ${k.name}`,type:"info"}))}),h[i+"Team"]=b,y(h)})},DEBUFF_STAT:({value:T=1,count:f=1,roles:x=[],target:h="ai"},y,b)=>{const v=h==="home"?i:r,w=y[v+"Team"],I=h==="home"?"allié":"adverse",k=Object.entries(w).filter(([E])=>!x.length||x.includes(E)).flatMap(([E,C])=>C.filter(N=>!N.used).map(N=>({...N,_line:E})));if(!k.length){y.log.push({text:`🎯 Aucun joueur ${I}`,type:"info"}),b(y);return}ne(k,f,`Choisir ${f} joueur(s) ${I}(s) (-${T})`,E=>{E.forEach(C=>{const N=(w[C._line]||[]).find(W=>W.cardId===C.cardId);N&&(N.boost=(N.boost||0)-T,y.log.push({text:`🎯 -${T} sur ${N.name}`,type:"info"}))}),y[v+"Team"]=w,b(y)})},GRAY_PLAYER:({count:T=1,roles:f=[],target:x="ai"},h,y)=>{const b=x==="home"?i:r,v=h[b+"Team"],w=x==="home"?"allié":"adverse",I=Object.entries(v).filter(([k])=>!f.length||f.includes(k)).flatMap(([k,E])=>E.filter(C=>!C.used).map(C=>({...C,_line:k})));if(!I.length){h.log.push({text:`❌ Aucun joueur ${w}`,type:"info"}),y(h);return}ne(I,T,`Choisir ${T} joueur(s) ${w}(s) à exclure`,k=>{k.forEach(E=>{const C=(v[E._line]||[]).find(N=>N.cardId===E.cardId);C&&(C.used=!0,h.log.push({text:`❌ ${C.name} exclu !`,type:"info"}))}),h[b+"Team"]=v,y(h)})},REVIVE_PLAYER:({count:T=1,roles:f=[]},x,h)=>{const y=x[i+"Team"],b=Object.entries(y).filter(([v])=>!f.length||f.includes(v)).flatMap(([v,w])=>w.filter(I=>I.used).map(I=>({...I,_line:v})));if(!b.length){x.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(x);return}ne(b,T,`Choisir ${T} joueur(s) à ressusciter`,v=>{v.forEach(w=>{const I=(y[w._line]||[]).find(k=>k.cardId===w.cardId);I&&(I.used=!1,x.log.push({text:`💫 ${I.name} ressuscité !`,type:"info"}))}),x[i+"Team"]=y,h(x)})},REMOVE_GOAL:({},T,f)=>{const x=r+"Score";T[x]>0?(T[x]--,T.log.push({text:"🚫 Dernier but annulé !",type:"info"})):T.log.push({text:"🚫 Aucun but à annuler",type:"info"}),f(T)},ADD_GOAL_DRAW:({},T,f)=>{T[i+"Score"]===T[r+"Score"]?(T[i+"Score"]++,T.log.push({text:"🎯 But bonus !",type:"info"})):T.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),f(T)},ADD_SUB:({value:T=1},f,x)=>{f.maxSubs=(f.maxSubs||3)+T,f.log.push({text:`🔄 +${T} remplacement(s)`,type:"info"}),x(f)},CUSTOM:({},T,f)=>f(T)};function ne(T,f,x,h){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let b=[];function v(){var I,k;const w=T.map(E=>{const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[E._line]||"#555",N=we(E,E._line)+(E.boost||0),le=b.find(H=>H.cardId===E.cardId)?"#FFD700":"rgba(255,255,255,0.25)",J=E.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${E.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${le};background:${C};overflow:hidden;cursor:pointer;${J}">
        ...
        </div>`,(I=y.querySelector("#pp-close"))==null||I.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(E=>{E.addEventListener("click",()=>{const C=E.dataset.cid,N=T.find(le=>le.cardId===C),W=b.findIndex(le=>le.cardId===C);N&&(W>-1?b.splice(W,1):b.length<f&&b.push(N),v())})}),(k=y.querySelector("#pp-confirm"))==null||k.addEventListener("click",()=>{y.remove(),h(b)})}v(),document.body.appendChild(y)}async function M(T,f){const h=(o["gcCardsFull_"+i]||[]).find(w=>w.id===T),y=(h==null?void 0:h._gcDef)||(o.gcDefs||[]).find(w=>{var I;return w.name===f||((I=w.name)==null?void 0:I.toLowerCase().trim())===(f==null?void 0:f.toLowerCase().trim())}),b=[...o["usedGc_"+i]||[],T],v={type:f,by:i,seq:(o._gcAnimSeq||0)+1};U.add(v.seq),xe(f,i,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const I=ce[y.effect_type];if(I){const k={...o};I(y.effect_params||{},k,async E=>{E["usedGc_"+i]=b,E._lastGC=v,E._gcAnimSeq=v.seq,await R(E)});return}}const w={...o};switch(f){case"Remplacement+":w.maxSubs=(w.maxSubs||3)+1,w.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const I=r+"Score";w[I]>0&&(w[I]--,w.log.push({text:"🚫 But annulé",type:"info"}));break}}w["usedGc_"+i]=b,w._lastGC=v,w._gcAnimSeq=v.seq,await R(w)})}function Y(T,f){const x="usedCardIds_"+T,h=new Set(o[x]||[]);f.forEach(y=>h.add(y)),o[x]=[...h]}function ee(){for(const T of["p1","p2"]){const f=new Set(o["usedCardIds_"+T]||[]),x=o[T+"Team"];if(x)for(const h of["GK","DEF","MIL","ATT"])(x[h]||[]).forEach(y=>{y.used=f.has(y.cardId)})}}function D(){var Be,Qe,mt,xt,yt,ht;if(o.phase==="reveal")return Q();if(o.phase==="midfield")return pe();if(o.phase==="finished")return He();const T=o[i+"Team"],f=o[r+"Team"];ee();const x=o[i+"Score"],h=o[r+"Score"],y=o[i+"Name"],b=o[r+"Name"],v=o.phase===i+"-attack",w=o.phase===i+"-defense",I=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],k=I.map(X=>X.cardId),E=window.innerWidth>=700,C=o[i+"Subs"]||[],N=o["usedSubIds_"+i]||[],W=C.filter(X=>!N.includes(X.cardId)),le=o["gcCardsFull_"+i]||[],J=o["usedGc_"+i]||[],H=le.filter(X=>!J.includes(X.id)),K=o.boostOwner===i&&!o.boostUsed,Z=!["GK","DEF","MIL","ATT"].some(X=>(f[X]||[]).some(G=>!G.used)),de=[...T.MIL||[],...T.ATT||[]].filter(X=>!X.used),ue=v&&Z&&de.length===0?[...T.GK||[],...T.DEF||[]].filter(X=>!X.used).map(X=>X.cardId):[];function fe(X,G,oe){var Ct,wt;const se=X._gcDef,ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[se==null?void 0:se.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Ye={purple:"#b06ce0",light_blue:"#00d4ef"}[se==null?void 0:se.color]||"#b06ce0",We=(se==null?void 0:se.name)||X.gc_type,Je=(se==null?void 0:se.effect)||((Ct=Ge[X.gc_type])==null?void 0:Ct.desc)||"",et=se!=null&&se.image_url?`/manager-wars/icons/${se.image_url}`:null,St=((wt=Ge[X.gc_type])==null?void 0:wt.icon)||"⚡",Mt=Math.round(oe*.22),bt=Math.round(oe*.22),lt=oe-Mt-bt,vt=We.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${X.id}" data-gc-type="${X.gc_type}"
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(y=document.getElementById("pvp-home"))==null||y.addEventListener("click",()=>{try{A.removeChannel(j)}catch{}Oe(e),d("home")})}D()}const ho=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Ji,resumePvpMatch:yo},Symbol.toStringTag,{value:"Module"}));async function bo(e,t,n,a){var p,l;try{const s=(l=(p=t==null?void 0:t.state)==null?void 0:p.profile)==null?void 0:l.id;try{(A.getChannels?A.getChannels():[]).forEach(c=>{const i=c.topic||"";(i.includes("matchmaking")||i.includes("pvp-match"))&&A.removeChannel(c)})}catch(d){console.warn("[FriendMatch] cleanup canaux:",d)}s&&(await A.rpc("cancel_matchmaking",{p_user_id:s}).catch(()=>{}),await A.from("matchmaking_queue").delete().eq("user_id",s).then(()=>{},()=>{}))}catch{}await pi(e,t,"random",({deckId:s,formation:d,starters:c,subsRaw:i,gcCardsEnriched:r,gcDefs:u})=>{const m=g=>vo(e,t,s,d,c,i,g,u||[],n,a);if(!r.length){m([]);return}ci(e,r,m)})}async function vo(e,t,n,a,p,l,s=[],d=[],c,i){var ce;const{state:r,navigate:u,toast:m}=t,g=r.profile.id;let $=!1,o=null;Xe(e);try{await A.rpc("cancel_matchmaking",{p_user_id:g})}catch{}try{await A.from("matchmaking_queue").delete().eq("user_id",g)}catch{}const _=(ne,M,Y,ee)=>{var D;e.innerHTML=`
      ...
      </div>`,(D=document.getElementById("lobby-cancel"))==null||D.addEventListener("click",async()=>{$=!0,o&&(A.removeChannel(o),o=null),Y&&await A.from("friend_match_invites").update({status:"declined"}).eq("id",Y),Oe(e),u("home")})},S=async(ne,M)=>{$=!0,o&&(A.removeChannel(o),o=null),await new Promise(Y=>setTimeout(Y,600)),e.isConnected&&wo(e,t,ne,M,s,d)},{data:z}=await A.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${g},invitee_id.eq.${c}),and(inviter_id.eq.${c},invitee_id.eq.${g})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let B,U;if(z&&z.inviter_id===c)U=!1,B=z.id,await A.from("friend_match_invites").update({invitee_deck_id:n,invitee_ready:!0,status:"accepted"}).eq("id",B);else{U=!0;const{data:ne,error:M}=await A.from("friend_match_invites").insert({inviter_id:g,invitee_id:c,friend_id:c,inviter_deck_id:n,inviter_ready:!0,status:"pending"}).select().single();if(M||!ne){m("Erreur création invitation","error"),Oe(e),u("home");return}B=ne.id}if(_(!0,!U,B),!U){const ne={home_id:c,away_id:g,home_deck_id:z.inviter_deck_id,away_deck_id:n,status:"active",mode:"friend"},M=await A.from("matches").insert(ne).select().single(),Y=M.data;if(!Y){m("Erreur création match: "+(((ce=M.error)==null?void 0:ce.message)||""),"error"),Oe(e),u("home");return}await A.from("friend_match_invites").update({match_id:Y.id,status:"matched"}).eq("id",B),S(Y.id,!1);return}let F=!1;const j=ne=>{$||F||(ne.status==="matched"&&ne.match_id?(F=!0,clearInterval(R),clearInterval(te),S(ne.match_id,!0)):ne.status==="declined"?(clearInterval(R),clearInterval(te),m(`${i} a décliné l'invitation`,"warning"),Oe(e),u("home")):ne.invitee_ready&&_(!0,!0,B))},R=setInterval(()=>{if($){clearInterval(R);return}A.from("matchmaking_queue").delete().eq("user_id",g).then(()=>{},()=>{})},3e3),te=setInterval(async()=>{if($||F){clearInterval(te);return}const{data:ne}=await A.from("friend_match_invites").select("*").eq("id",B).maybeSingle();ne&&j(ne)},1200);o=A.channel("friend-invite-"+B).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${B}`},ne=>j(ne.new)).subscribe()}async function wo(e,t,n,a,p=[],l=[]){const{state:s,navigate:d,toast:c}=t,i=a?"p1":"p2",r=a?"p2":"p1",u=(p||[]).map(f=>f.id),m=(p||[]).map(f=>({id:f.id,gc_type:f.gc_type,_gcDef:f._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await A.from("matches").select("*").eq("id",n).single();if(!g){c("Match introuvable","error"),d("home");return}async function $(){const[{data:f},{data:x},{data:h},{data:y}]=await Promise.all([A.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),A.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),A.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),A.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),b=E=>({cardId:E.card_id,position:E.position,id:E.id,firstname:E.firstname,name:E.surname_encoded,country_code:E.country_code,club_id:E.club_id,job:E.job,job2:E.job2,note_g:Number(E.note_g)||0,note_d:Number(E.note_d)||0,note_m:Number(E.note_m)||0,note_a:Number(E.note_a)||0,rarity:E.rarity,skin:E.skin,hair:E.hair,hair_length:E.hair_length,clubName:E.club_encoded_name||null,clubLogo:E.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}),v=((f==null?void 0:f.starters)||[]).map(E=>b(E)),w=((x==null?void 0:x.starters)||[]).map(E=>b(E)),I=(f==null?void 0:f.formation)||"4-4-2",k=(x==null?void 0:x.formation)||"4-4-2";return{p1Team:gt(v,I),p2Team:gt(w,k),p1Subs:((f==null?void 0:f.subs)||[]).map(E=>b(E)),p2Subs:((x==null?void 0:x.subs)||[]).map(E=>b(E)),p1Formation:I,p2Formation:k,p1Name:(h==null?void 0:h.club_name)||(h==null?void 0:h.pseudo)||"Joueur 1",p2Name:(y==null?void 0:y.club_name)||(y==null?void 0:y.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:a?u:[],gc_p2:a?[]:u,gcCardsFull_p1:a?m:[],gcCardsFull_p2:a?[]:m,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:l||[],lastActionAt:new Date().toISOString()}}let o=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!o)if(a){o=await $();const{data:f}=await A.from("matches").select("game_state").eq("id",n).single();!(f!=null&&f.game_state)||!Object.keys(f.game_state).length?await A.from("matches").update({game_state:o,turn_user_id:g.home_id}).eq("id",n):o=f.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let f=0;f<60&&!o;f++){await new Promise(h=>setTimeout(h,400));const{data:x}=await A.from("matches").select("game_state").eq("id",n).single();x!=null&&x.game_state&&Object.keys(x.game_state).length&&(o=x.game_state)}if(!o){c("Erreur de synchronisation","error"),d("home");return}o.gc_p2=u,o.gcCardsFull_p2=m,await A.from("matches").update({game_state:o}).eq("id",n)}let _=!1,S=!1,z=null,B=!1;const U=new Set,F=new Set;function j(f){var E,C;try{A.removeChannel(R)}catch{}const x=o[i+"Score"]||0,h=o[r+"Score"]||0;if(!S){const N=o.p1Score||0,W=o.p2Score||0,le=(o.usedGc_p1||[]).length,J=(o.usedGc_p2||[]).length,H=f.winner_id||(N>W?g.home_id:W>N?g.away_id:null);(H?s.profile.id===H:s.profile.id<(a?g.away_id:g.home_id))&&(S=!0,mn({player1Id:g.home_id,player2Id:g.away_id,score1:N,score2:W,gc1:le,gc2:J}).catch(Z=>console.warn("[FriendMatch] updateStats:",Z)))}let y,b;f.winner_id?(y=f.winner_id===s.profile.id,b=!1):f.forfeit?(y=x>h,b=!1):(b=x===h,y=x>h),(E=document.getElementById("pvp-end-overlay"))==null||E.remove();const v=document.createElement("div");v.id="pvp-end-overlay",v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const w=b?"🤝":y?"🏆":"😞",I=b?"MATCH NUL":y?"VICTOIRE !":"DÉFAITE",k=b?"#fff":y?"#FFD700":"#ff6b6b";v.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(v),(C=v.querySelector("#pvp-end-home"))==null||C.addEventListener("click",()=>{v.remove(),Oe(e),d("home")})}const R=A.channel("pvp-match-"+n).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${n}`},f=>{const x=f.new;try{if(x.status==="finished"||x.forfeit){if(_)return;_=!0,z&&(clearInterval(z),z=null),x.game_state&&(o=x.game_state),j(x);return}if(x.game_state){const h=o;o=x.game_state;const y=o._lastGC;if(y&&y.seq&&!F.has(y.seq)&&(F.add(y.seq),y.by!==i)){ge(y.type,y.by,()=>Q());return}const b=h[i+"Score"]||0,v=h[r+"Score"]||0,w=o[i+"Score"]||0,I=o[r+"Score"]||0,k=w>b,E=I>v;if((k||E)&&!U.has(o.round)){U.add(o.round);const C=[...o.log||[]].reverse().find(W=>W.isGoal),N=((C==null?void 0:C.homePlayers)||[]).map(W=>({name:W.name,note:W.note,portrait:W.portrait,job:W.job}));xe(N,w,I,k,()=>Q());return}Q()}}catch(h){console.error("[PvP] crash:",h)}}).subscribe();async function te(f){Object.assign(o,f),o.lastActionAt=new Date().toISOString();const{error:x}=await A.from("matches").update({game_state:o}).eq("id",n);x&&c("Erreur de synchronisation","error");try{Q()}catch(h){console.error("[PvP] renderPvpScreen crash:",h)}}async function ce(){if(_)return;_=!0,z&&(clearInterval(z),z=null);const f=a?g.away_id:g.home_id,x=a?"p2":"p1",h=a?"p1":"p2",y={...o,[x+"Score"]:3,[h+"Score"]:0,phase:"finished"};try{await A.from("matches").update({status:"finished",forfeit:!0,winner_id:f,home_score:y.p1Score||0,away_score:y.p2Score||0,game_state:y}).eq("id",n)}catch{}try{A.removeChannel(R)}catch{}setTimeout(()=>{Oe(e),d("home")},800)}const ne={BOOST_STAT:({value:f=1,count:x=1,roles:h=[]},y,b)=>{const v=y[i+"Team"],w=Object.entries(v).filter(([I])=>!h.length||h.includes(I)).flatMap(([I,k])=>k.filter(E=>!E.used).map(E=>({...E,_line:I})));if(!w.length){y.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),b(y);return}M(w,x,`Choisir ${x} joueur(s) à booster (+${f})`,I=>{I.forEach(k=>{const E=(v[k._line]||[]).find(C=>C.cardId===k.cardId);E&&(E.boost=(E.boost||0)+f,y.log.push({text:`⚡ +${f} sur ${E.name}`,type:"info"}))}),y[i+"Team"]=v,b(y)})},DEBUFF_STAT:({value:f=1,count:x=1,roles:h=[],target:y="ai"},b,v)=>{const w=y==="home"?i:r,I=b[w+"Team"],k=y==="home"?"allié":"adverse",E=Object.entries(I).filter(([C])=>!h.length||h.includes(C)).flatMap(([C,N])=>N.filter(W=>!W.used).map(W=>({...W,_line:C})));if(!E.length){b.log.push({text:`🎯 Aucun joueur ${k}`,type:"info"}),v(b);return}M(E,x,`Choisir ${x} joueur(s) ${k}(s) (-${f})`,C=>{C.forEach(N=>{const W=(I[N._line]||[]).find(le=>le.cardId===N.cardId);W&&(W.boost=(W.boost||0)-f,b.log.push({text:`🎯 -${f} sur ${W.name}`,type:"info"}))}),b[w+"Team"]=I,v(b)})},GRAY_PLAYER:({count:f=1,roles:x=[],target:h="ai"},y,b)=>{const v=h==="home"?i:r,w=y[v+"Team"],I=h==="home"?"allié":"adverse",k=Object.entries(w).filter(([E])=>!x.length||x.includes(E)).flatMap(([E,C])=>C.filter(N=>!N.used).map(N=>({...N,_line:E})));if(!k.length){y.log.push({text:`❌ Aucun joueur ${I}`,type:"info"}),b(y);return}M(k,f,`Choisir ${f} joueur(s) ${I}(s) à exclure`,E=>{E.forEach(C=>{const N=(w[C._line]||[]).find(W=>W.cardId===C.cardId);N&&(N.used=!0,y.log.push({text:`❌ ${N.name} exclu !`,type:"info"}))}),y[v+"Team"]=w,b(y)})},REVIVE_PLAYER:({count:f=1,roles:x=[]},h,y)=>{const b=h[i+"Team"],v=Object.entries(b).filter(([w])=>!x.length||x.includes(w)).flatMap(([w,I])=>I.filter(k=>k.used).map(k=>({...k,_line:w})));if(!v.length){h.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),y(h);return}M(v,f,`Choisir ${f} joueur(s) à ressusciter`,w=>{w.forEach(I=>{const k=(b[I._line]||[]).find(E=>E.cardId===I.cardId);k&&(k.used=!1,h.log.push({text:`💫 ${k.name} ressuscité !`,type:"info"}))}),h[i+"Team"]=b,y(h)})},REMOVE_GOAL:({},f,x)=>{const h=r+"Score";f[h]>0?(f[h]--,f.log.push({text:"🚫 Dernier but annulé !",type:"info"})):f.log.push({text:"🚫 Aucun but à annuler",type:"info"}),x(f)},ADD_GOAL_DRAW:({},f,x)=>{f[i+"Score"]===f[r+"Score"]?(f[i+"Score"]++,f.log.push({text:"🎯 But bonus !",type:"info"})):f.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),x(f)},ADD_SUB:({value:f=1},x,h)=>{x.maxSubs=(x.maxSubs||3)+f,x.log.push({text:`🔄 +${f} remplacement(s)`,type:"info"}),h(x)},CUSTOM:({},f,x)=>x(f)};function M(f,x,h,y){const b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let v=[];function w(){var k,E;const I=f.map(C=>{const N={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[C._line]||"#555",W=we(C,C._line)+(C.boost||0),J=v.find(K=>K.cardId===C.cardId)?"#FFD700":"rgba(255,255,255,0.25)",H=C.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${C.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${J};background:${N};overflow:hidden;cursor:pointer;${H}">
        ...
        </div>`,(k=b.querySelector("#pp-close"))==null||k.addEventListener("click",()=>b.remove()),b.querySelectorAll(".pp-item").forEach(C=>{C.addEventListener("click",()=>{const N=C.dataset.cid,W=f.find(J=>J.cardId===N),le=v.findIndex(J=>J.cardId===N);W&&(le>-1?v.splice(le,1):v.length<x&&v.push(W),w())})}),(E=b.querySelector("#pp-confirm"))==null||E.addEventListener("click",()=>{b.remove(),y(v)})}w(),document.body.appendChild(b)}async function Y(f,x){const y=(o["gcCardsFull_"+i]||[]).find(I=>I.id===f),b=(y==null?void 0:y._gcDef)||(o.gcDefs||[]).find(I=>{var k;return I.name===x||((k=I.name)==null?void 0:k.toLowerCase().trim())===(x==null?void 0:x.toLowerCase().trim())}),v=[...o["usedGc_"+i]||[],f],w={type:x,by:i,seq:(o._gcAnimSeq||0)+1};F.add(w.seq),ge(x,i,async()=>{if(b!=null&&b.effect_type&&b.effect_type!=="CUSTOM"){const k=ne[b.effect_type];if(k){const E={...o};k(b.effect_params||{},E,async C=>{C["usedGc_"+i]=v,C._lastGC=w,C._gcAnimSeq=w.seq,await te(C)});return}}const I={...o};switch(x){case"Remplacement+":I.maxSubs=(I.maxSubs||3)+1,I.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const k=r+"Score";I[k]>0&&(I[k]--,I.log.push({text:"🚫 But annulé",type:"info"}));break}}I["usedGc_"+i]=v,I._lastGC=w,I._gcAnimSeq=w.seq,await te(I)})}function ee(f,x){const h="usedCardIds_"+f,y=new Set(o[h]||[]);x.forEach(b=>y.add(b)),o[h]=[...y]}function D(){for(const f of["p1","p2"]){const x=new Set(o["usedCardIds_"+f]||[]),h=o[f+"Team"];if(h)for(const y of["GK","DEF","MIL","ATT"])(h[y]||[]).forEach(b=>{b.used=x.has(b.cardId)})}}function Q(){var Qe,mt,xt,yt,ht,X;if(o.phase==="reveal")return ae();if(o.phase==="midfield")return he();if(o.phase==="finished")return T();const f=o[i+"Team"],x=o[r+"Team"];D();const h=o[i+"Score"],y=o[r+"Score"],b=o[i+"Name"],v=o[r+"Name"],w=o.phase===i+"-attack",I=o.phase===i+"-defense",k=Array.isArray(o["selected_"+i])?o["selected_"+i]:[],E=k.map(G=>G.cardId),C=window.innerWidth>=700,N=o[i+"Subs"]||[],W=o["usedSubIds_"+i]||[],le=N.filter(G=>!W.includes(G.cardId)),J=o["gcCardsFull_"+i]||[],H=o["usedGc_"+i]||[],K=J.filter(G=>!H.includes(G.id)),Z=o.boostOwner===i&&!o.boostUsed,de=!["GK","DEF","MIL","ATT"].some(G=>(x[G]||[]).some(oe=>!oe.used)),ue=[...f.MIL||[],...f.ATT||[]].filter(G=>!G.used),fe=w&&de&&ue.length===0?[...f.GK||[],...f.DEF||[]].filter(G=>!G.used).map(G=>G.cardId):[];function me(G,oe,se){var wt,mi;const ye=G._gcDef,Ye={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ye==null?void 0:ye.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",We={purple:"#b06ce0",light_blue:"#00d4ef"}[ye==null?void 0:ye.color]||"#b06ce0",Je=(ye==null?void 0:ye.name)||G.gc_type,et=(ye==null?void 0:ye.effect)||((wt=Ge[G.gc_type])==null?void 0:wt.desc)||"",St=ye!=null&&ye.image_url?`/manager-wars/icons/${ye.image_url}`:null,Mt=((mi=Ge[G.gc_type])==null?void 0:mi.icon)||"⚡",bt=Math.round(se*.22),lt=Math.round(se*.22),vt=se-bt-lt,Ct=Je.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${G.id}" data-gc-type="${G.gc_type}"
        ...
        <div style="height:${vt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${St?`<img src="${St}" style="max-width:${oe-10}px;max-height:${vt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(vt*.55)}px">${Mt}</span>`}
        </div>
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${dt(f,o[i+"Formation"],De,E,300,300,fe)}
      </div>
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="width:min(90vw,420px)">${st(o[r+"Team"],o[r+"Formation"],null,[],300,300)}</div>
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:0">
          ${K.map((ue,fe)=>{const me=fe<K.length-1?Ze(ue,K[fe+1]):null,be=!me||me==="#ff3333"||me==="#cc2222",Me=me==="#00ff88"?"+2":me==="#FFD700"?"+1":"";return`<div class="duel-card duel-card-${de}" data-idx="${fe}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease,transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ...
            ${fe<K.length-1?`<div class="duel-link duel-link-${de}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${be?"rgba(255,255,255,0.12)":me};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${be?"none":`0 0 8px ${me}`}">
              ${Me?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${me}">${Me}</span>`:""}
            </div>`:""}`}).join("")}
        </div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      </div>`,document.body.appendChild(h),(y=h.querySelector("#bp-close"))==null||y.addEventListener("click",()=>h.remove()),h.querySelectorAll(".bp-item").forEach(b=>{b.addEventListener("click",async()=>{const v=b.dataset.cid,w=x.find(k=>k.cardId===v);if(!w)return;const I=(f[w._line]||[]).find(k=>k.cardId===v);I&&(I.boost=(I.boost||0)+o.boostValue),h.remove(),await te({[i+"Team"]:f,boostUsed:!0})})})}function P(f=null){var le,J;if(!(o.phase===i+"-attack")){c("Remplacement uniquement avant votre attaque","warning");return}const h=o[i+"Team"],y=o["usedSubIds_"+i]||[],b=o.maxSubs||3;if(y.length>=b){c(`Maximum ${b} remplacements atteint`,"warning");return}const v=Object.entries(h).flatMap(([H,K])=>(K||[]).filter(Z=>Z.used).map(Z=>({...Z,_line:H}))),w=(o[i+"Subs"]||[]).filter(H=>!y.includes(H.cardId));if(!v.length){c("Aucun joueur utilisé à remplacer","warning");return}if(!w.length){c("Aucun remplaçant disponible","warning");return}let I=Math.max(0,v.findIndex(H=>H.cardId===f));const k=((le=v[I])==null?void 0:le._line)||((J=v[I])==null?void 0:J.job);let E=Math.max(0,w.findIndex(H=>H.job===k)),C=!1;const N=document.createElement("div");N.id="pvp-sub-overlay",N.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function W(){var me,be,Me,Pe,Fe,Ie;const H=v[I],K=w[E],Z=Math.min(130,Math.round((window.innerWidth-90)/2)),de=Math.round(Z*1.35),ue=Le=>`background:rgba(255,255,255,0.12);border:none;color:${Le?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Le?"default":"pointer"};flex-shrink:0`;N.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <button id="pvp-home" style="padding:16px 40px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏠 Retour</button>
    </div>`,(b=document.getElementById("pvp-home"))==null||b.addEventListener("click",()=>{try{A.removeChannel(R)}catch{}Oe(e),d("home")})}Q()}const _o={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"};async function $o(e,t){const{state:n,toast:a}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement du marché...</div>',await fi(e,t)}async function fi(e,t){const{state:n,toast:a}=t,{data:p}=await A.from("market_listings").select(`id, price, status, listed_at, seller_id,
      seller:users!seller_id(pseudo),
      card:cards(id, card_type,
        player:players(id, firstname, surname_encoded, country_code, job, job2,
          note_g, note_d, note_m, note_a, rarity, skin, hair, hair_length, clubs(encoded_name, logo_url)))`).eq("status","active").order("listed_at",{ascending:!1}).limit(60),{data:l}=await A.from("market_listings").select(`id, price, status, listed_at, sold_at, seller_id, buyer_id,
  ...
  `;function c(i){const r=document.getElementById("mkt-content"),u=i==="buy"?s:d;if(u.length===0){r.innerHTML=`<div style="text-align:center;color:var(--gray-600);padding:40px">
      ...
      ${m.map(g=>{var B,U,F,j;const $=(B=g.card)==null?void 0:B.player;if(!$)return"";const o=$.job==="GK"?$.note_g:$.job==="DEF"?$.note_d:$.job==="MIL"?$.note_m:$.note_a,_=_o[$.rarity],S=(n.profile.credits||0)>=g.price,z=g.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${z?"opacity:0.65":""}">
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            ${i==="buy"?`<button class="btn btn-primary btn-sm" data-buy="${g.id}" ${S?"":"disabled"} style="margin-top:4px">${S?"Acheter":"Trop cher"}</button>`:z?'<span style="display:inline-block;margin-top:4px;font-size:10px;font-weight:700;color:#fff;background:var(--green);padding:3px 10px;border-radius:10px">VENDU</span>':`<button class="btn btn-danger btn-sm" data-cancel="${g.id}" style="margin-top:4px">Retirer</button>`}
          </div>
        </div>`}).join("")}
      ...
      </div>`,document.body.appendChild(a);const p=l=>{a.remove(),n(l)};a.querySelector("#buy-ok").addEventListener("click",()=>p(!0)),a.querySelector("#buy-cancel").addEventListener("click",()=>p(!1)),a.addEventListener("click",l=>{l.target===a&&p(!1)})})}async function Ao(e,t,n){const{toast:a}=n,{data:p}=await A.from("market_listings").select("card_id").eq("id",e).single();await A.from("market_listings").update({status:"cancelled"}).eq("id",e),p&&await A.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",p.card_id),a("Annonce retirée","success"),fi(t,n)}function To(e){return{GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[e]||"#888"}async function Io(e,{state:t,navigate:n,toast:a}){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:p}=await A.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100);e.innerHTML=`
  <div class="page">
    <div class="page-header">
  ...
  `}async function Lo(e,{state:t,navigate:n,toast:a}){const p=t.profile;if(!p)return;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:l}=await A.from("matches").select(`id,home_id,away_id,home_score,away_score,status,mode,winner_id,created_at,played_at,
  ...
  </div>`}tn(on);const ve={user:null,profile:null,page:"home",params:{}};function $t(e,t="info",n=3e3){const a=document.getElementById("toast");a&&(a.textContent=e,a.className=`show ${t}`,clearTimeout(a._t),a._t=setTimeout(()=>{a.className=""},n))}function zo(e,t,n=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=n,document.getElementById("modal-overlay").classList.remove("hidden")}function ii(){document.getElementById("modal-overlay").classList.add("hidden")}async function kt(){if(!ve.user)return;const{data:e}=await A.from("users").select("*").eq("id",ve.user.id).single();e&&(ve.profile=e)}const gi="mw_theme";function Pt(){return localStorage.getItem(gi)||"light"}function So(e){var t;localStorage.setItem(gi,e),ni(e),(t=ve.profile)!=null&&t.id&&A.from("users").update({theme:e}).eq("id",ve.profile.id).then(()=>{})}function ni(e){document.documentElement.setAttribute("data-theme",e)}function Dt(e,t={}){ve.page=e,ve.params=t,Zi()}async function Zi(){var a,p;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(l=>{l.classList.toggle("active",l.dataset.page===ve.page)});const t=document.getElementById("nav-credits");t&&ve.profile&&(t.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const n={state:ve,navigate:Dt,toast:$t,openModal:zo,closeModal:ii,refreshProfile:kt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await bi(e,n);break;case"collection":await kn(e,n);break;case"decks":await Xt(e,n);break;case"boosters":await Dn(e,n);break;case"match":{const l=ve.params&&ve.params.matchMode||"vs_ai_easy";l==="random"?await Ji(e,n):l==="friend"?await bo(e,n,(a=ve.params)==null?void 0:a.friendId,(p=ve.params)==null?void 0:p.friendName):await Zn(e,n);break}case"market":await $o(e,n);break;case"rankings":await Io(e,n);break;case"matches":await Lo(e,n);break;case"friends":await pn(e,n);break;default:await bi(e,n)}}function Mo(){const e=document.getElementById("app"),t=ve.profile;if(!t)return;const n="/manager-wars/icons/";e.innerHTML=`
    <nav class="top-nav">
  ...
  `,document.querySelectorAll(".bottom-nav a").forEach(a=>{a.addEventListener("click",p=>{p.preventDefault(),Dt(a.dataset.page)})}),document.getElementById("nav-logo").addEventListener("click",()=>Dt("home")),document.getElementById("nav-credits").addEventListener("click",()=>Dt("boosters")),document.getElementById("theme-toggle").addEventListener("click",()=>{const p=Pt()==="dark"?"light":"dark";So(p),Ti(p)}),Ti(Pt())}function Ti(e){const t=document.getElementById("theme-icon");t&&(t.textContent=e==="dark"?"☀️":"🌙")}async function Co(){ni(Pt()),document.getElementById("modal-overlay").addEventListener("click",n=>{n.target===n.currentTarget&&ii()}),document.getElementById("modal-close").addEventListener("click",ii);const{data:{session:e}}=await A.auth.getSession();if(!e){Ii(),xi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:$t});return}ve.user=e.user,await kt(),Ii();try{const{data:n}=await A.from("formation_links_overrides").select("formation, links"),a={};(n||[]).forEach(p=>{a[p.formation]=p.links}),nn(a)}catch(n){console.warn("Impossible de charger les overrides de formation:",n)}if(!ve.profile){rn(document.getElementById("app"),{state:ve,navigate:async()=>{await kt(),Wt()},toast:$t,refreshProfile:kt});return}const t=Array.isArray(ve.profile.pending_boosters)?ve.profile.pending_boosters:[];if(!ve.profile.onboarding_done&&t.length>0){Wn(document.getElementById("app"),{state:ve,navigate:()=>Wt(),toast:$t,refreshProfile:kt});return}ve.profile.theme&&ve.profile.theme!==Pt()&&(localStorage.setItem(gi,ve.profile.theme),ni(ve.profile.theme)),Wt(),A.auth.onAuthStateChange(async(n,a)=>{n==="SIGNED_OUT"&&(ve.user=null,ve.profile=null,document.getElementById("app").innerHTML="",xi(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:$t}))})}function jo(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function Kt(){const e=document.getElementById("app");e&&(e.style.height=jo()+"px")}window.addEventListener("resize",Kt);window.addEventListener("orientationchange",()=>setTimeout(Kt,150));window.visualViewport&&window.visualViewport.addEventListener("resize",Kt);function Wt(){const e=()=>{var n;(n=ve.user)!=null&&n.id&&A.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",ve.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",Kt(),Mo(),Zi()}function Ii(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function en(e){var a;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const n=document.createElement("div");n.id="boot-error",n.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",n.innerHTML=`
