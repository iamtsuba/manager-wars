...
import{s as v,l as Ht,m as Bi,F as qi,r as je,j as ii,h as Di,n as Kn,o as Vn,T as bi,k as Yn,p as Wn,b as Xn}from"./formation-links-Bb-Ce4un.js";const Jn="/";function Qi(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,m;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var x;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),m=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",y=m.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():m.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=g,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(m){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(m){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),y=document.getElementById("step3-finish");m.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Zn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){m.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Zn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const eo="modulepreload",to=function(e){return"/"+e},Zi={},mn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=to(d),d in Zi)return;Zi[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":eo,c||(m.as="script"),m.crossOrigin="",m.href=d,s&&m.setAttribute("nonce",s),document.head.appendChild(m),c)return new Promise((y,g)=>{m.addEventListener("load",y),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Xt="#1A6B3C",Jt="#cc2222",io="#D4A017",en="#888";async function no(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const so="2026.07.20-2313";async function tn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    ${je(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(M=>M.card_type==="player"&&M.player),l=(s||[]).filter(M=>M.card_type==="game_changer"),m=(s||[]).filter(M=>M.card_type==="formation"),y=(s||[]).filter(M=>M.card_type==="stadium"),{data:g}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(g||[]).forEach(M=>{x[M.name]=M});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach(M=>{u[M.id]=M}),y.forEach(M=>{M.stadium_def&&(u[M.stadium_id]=M.stadium_def)});const b=Object.keys(qi),w=Object.keys(qe),h={};c.forEach(M=>{const F=M.player.id;h[F]=(h[F]||0)+1}),new Set(Object.keys(h).map(M=>String(M)));const $=new Set(m.map(M=>M.formation)),f=new Set(l.map(M=>M.gc_type));let C="player",k="Tous",I="",D=!1;function ie(){return[...c].sort((M,F)=>{const H=ni.indexOf(M.player.job),Q=ni.indexOf(F.player.job);return H!==Q?H-Q:(M.player.surname_real||"").localeCompare(F.player.surname_real||"")})}function ne(){return[...d||[]].sort((M,F)=>{const H=ni.indexOf(M.job),Q=ni.indexOf(F.job);return H!==Q?H-Q:(M.surname_real||"").localeCompare(F.surname_real||"")})}function Z(){return ie().filter(M=>{const F=M.player,H=k==="Tous"||F.job===k,Q=!I||`${F.firstname} ${F.surname_real}`.toLowerCase().includes(I);return H&&Q})}function j(){return ne().filter(M=>{const F=k==="Tous"||M.job===k,H=!I||`${M.firstname} ${M.surname_real}`.toLowerCase().includes(I);return F&&H})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="display:flex;border-bottom:2px solid var(--tile-border);background:var(--tile-bg)">
      ...
      <button class="col-tab-btn" data-tab="stadium" style="flex:1;padding:10px 4px;border:none;background:none;cursor:pointer;
        ...
        color:${C==="stadium"?"#E87722":"var(--tile-fg-dim)"}">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(F){const H=document.getElementById(F);if(!H)return;H.addEventListener("wheel",pe=>{Math.abs(pe.deltaY)<=Math.abs(pe.deltaX)||(pe.preventDefault(),H.scrollLeft+=pe.deltaY)},{passive:!1});let Q=!1,R=0,B=0,O=!1,le=!1;H.addEventListener("mousedown",pe=>{Q=!0,O=!1,R=pe.pageX,B=H.scrollLeft}),window.addEventListener("mouseup",()=>{Q=!1,O&&(H.style.cursor="",le=!0),O=!1}),window.addEventListener("mousemove",pe=>{if(!Q)return;const ve=pe.pageX-R;!O&&Math.abs(ve)<6||(O=!0,H.style.cursor="grabbing",pe.preventDefault(),H.scrollLeft=B-ve)}),H.addEventListener("click",pe=>{le&&(pe.stopPropagation(),pe.preventDefault(),le=!1)},!0)}("col-grid");function z(){const M=document.getElementById("col-filters");M&&(C==="player"?(M.innerHTML=`
        ...
        <div style="display:flex;justify-content:flex-end">
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{D=!D,z(),Y()})))}function Y(){const M=document.getElementById("col-grid");M&&(C==="player"?ue(M):C==="formation"?N(M):C==="stadium"?U(M):V(M))}function oe(M,F,H,Q,R,B=0){const O=document.getElementById("col-grid"),le=document.getElementById("col-big");if(!O||!le)return;var pe=0;function ve(){var Oe;const _e=window.innerWidth>=768,ze=document.getElementById("col-big"),Ie=document.getElementById("col-gap"),ke=((Oe=document.getElementById("col-grid"))==null?void 0:Oe.parentElement)||null,$e=ze?ze.closest(".page"):null;if(ze&&ke&&$e){let Ee=0;Array.from($e.children).forEach(function(L){L!==ze&&L!==ke&&L!==Ie&&(Ee+=L.offsetHeight)});const Le=Math.max(0,$e.clientHeight-Ee),Ge=Math.round(Le*(B/100)),_=Math.max(0,Le-Ge),E=_e?50/71:45/63,T=Math.round(_*E),S=Math.max(0,_-T);Ie&&(Ie.style.height=Ge+"px"),ze.style.flex="none",ze.style.height=T+"px",ze.style.minHeight="0",ke.style.flex="none",ke.style.height=S+"px",ke.style.minHeight="0",ke.style.display="flex",ke.style.overflow="hidden"}const Ce=document.getElementById("col-grid");Ce&&(Ce.style.height="100%",Ce.style.flexShrink="0",Ce.style.overflowX="auto",Ce.style.overflowY="hidden",Ce.style.alignItems="center",Ce.style.width="100%"),le.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+F(M[pe])+"</div>";var De=le.querySelector("[data-card-id],[data-form-id],[data-gc-id]");De&&De.addEventListener("click",function(){Q(M[pe])}),requestAnimationFrame(function(){var Ee=document.getElementById("big-card-inner");if(!(!Ee||!le)){var Le=le.clientHeight,Ge=le.clientWidth-16,_=Ee.offsetHeight,E=Ee.offsetWidth;if(_>0&&E>0&&Le>40){var T=Math.min(Le/_,Ge/E);Ee.style.transform="scale("+T.toFixed(3)+")",Ee.style.transformOrigin="center center"}}}),O.innerHTML=M.map(function(Ee,Le){var Ge=Le===pe,_="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(Ge?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Le+'" style="'+_+'">'+H(Ee,Ge)+"</div>"}).join(""),O.querySelectorAll(".col-mini-item").forEach(function(Ee){Ee.addEventListener("click",function(){pe=Number(Ee.dataset.idx),ve(),Ee.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var Ee=Ce?Ce.clientHeight:0,Le=O.querySelector(".col-mini-item > div");if(!(!Ee||!Le)){var Ge=Le.style.zoom;Le.style.zoom="1";var _=Le.offsetHeight;if(Le.style.zoom=Ge,!(_<=0)){var E=Ee/_;O.querySelectorAll(".col-mini-item > div").forEach(function(T){T.style.zoom=E.toFixed(4)})}}})}ve()}function fe(M){var F=window.innerWidth>=768?.76:.54,H;if(!M||M._fake){var Q=M?M.player:null;if(!Q)return"";H=an(Q)}else H=wi(M,"");return'<div style="display:inline-block;zoom:'+F+';pointer-events:none;line-height:0">'+H+"</div>"}function me(M,F,H){F=F||100,H=H||140;var Q=ii[M]||{},R={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},B=Math.max(3,Math.round(F*.06)),O=Object.entries(Q).map(function(pe){var ve=pe[0],_e=pe[1],ze=ve.replace(/\d+$/,""),Ie=R[ze]||"#888",ke=Math.round(_e.x*F),$e=Math.round(_e.y*H);return'<circle cx="'+ke+'" cy="'+$e+'" r="'+B+'" fill="'+Ie+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),le=Math.max(1,Math.round(F/50));return'<svg viewBox="0 0 '+F+" "+H+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+F+'" height="'+H+'" fill="#1A6B3C"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.02)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+le+'"/><line x1="0" y1="'+Math.round(H*.5)+'" x2="'+F+'" y2="'+Math.round(H*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+le+'"/><ellipse cx="'+Math.round(F*.5)+'" cy="'+Math.round(H*.5)+'" rx="'+Math.round(F*.18)+'" ry="'+Math.round(H*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+le+'"/><rect x="'+Math.round(F*.2)+'" y="'+Math.round(H*.82)+'" width="'+Math.round(F*.6)+'" height="'+Math.round(H*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+le+'"/>'+O+"</svg>"}function A(M,F,H){var Q=H>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+H+"</div>":"",R=F?'data-form-id="'+F.id+'"':"",B=M.length>7?14:M.length>5?16:19,O=!!F;return"<div "+R+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+Q+'<div style="padding:8px 6px 6px;background:var(--tile-bg);text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+B+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+M+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+me(M,140,220)+"</div></div>"}function W(M,F){var H=window.innerWidth>=768?.76:.54,Q=140,R=Math.round(140*657/507),B=Math.round(R*.28),O=R-B,le=M.length>7?9:11,pe=me(M,Q,O),ve=F?"1.5px solid #2a7a40":"1px solid #ddd",_e=F?"":"filter:grayscale(1);opacity:0.45;",ze=F?"#1A6B3C":"#bbb",Ie="#fff";return'<div style="display:inline-block;zoom:'+H+';line-height:0;pointer-events:none"><div style="width:'+Q+"px;height:"+R+"px;border-radius:6px;border:"+ve+";background:var(--tile-bg);display:flex;flex-direction:column;overflow:hidden;"+_e+'"><div style="height:'+B+"px;background:"+ze+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+le+"px;font-weight:900;color:"+Ie+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(Q-4)+'px">'+M+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+pe+"</div></div></div>"}function ue(M){if(D){const F=j();if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const H=F.map(Q=>c.find(R=>R.player.id===Q.id)||{_fake:!0,player:Q,id:"fake-"+Q.id});oe(H,Q=>Q._fake?an(Q.player):wi(Q,""),Q=>Q._fake?fe({player:Q.player,id:"x",_fake:!0}):fe(Q),Q=>{Q._fake||sn(Q,c,h,t)})}else{const F=Z();if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const H={};F.forEach(R=>{const B=R.player.id;H[B]||(H[B]=[]),H[B].push(R)});const Q=Object.values(H).map(R=>ko(R));oe(Q,R=>{const B=h[R.player.id]||1,O=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",pe=c.filter(ve=>ve.player.id===R.player.id&&ve.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return wi(R,O+pe)},R=>fe(R),R=>sn(R,c,h,t))}}function N(M){const F=D?b:[...$];if(!F.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const H=F.map(Q=>({formation:Q,card:m.find(R=>R.formation===Q)||null,owned:$.has(Q)}));oe(H,({formation:Q,card:R,owned:B})=>A(Q,B?R:null,B?m.filter(O=>O.formation===Q).length:0),({formation:Q,owned:R})=>W(Q,R),({card:Q,owned:R})=>{R&&Q&&Io(Q,m,t,o)},"#1A6B3C",5)}function V(M){const F=Object.keys(x),H=D?F.length?F:w:[...f];if(!H.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const Q=H.map(R=>({type:R,gc:qe[R]||{icon:"⚡",desc:""},def:x[R]||null,owned:f.has(R),card:l.find(B=>B.gc_type===R)||null}));oe(Q,({type:R,gc:B,def:O,owned:le,card:pe})=>{var Ee;const ve=le?l.filter(Le=>Le.gc_type===R).length:0,_e=ve>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ve}</div>`:"",ze=(O==null?void 0:O.gc_type)==="ultra_game_changer",Ie={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ke={purple:"#b06ce0",light_blue:"#00d4ef"},$e=Ie[O==null?void 0:O.color]||Ie.purple,Ce=ke[O==null?void 0:O.color]||ke.purple,De=(O==null?void 0:O.effect)||B.desc||"",Oe=O!=null&&O.image_url?`/icons/${O.image_url}`:((Ee=O==null?void 0:O.club)==null?void 0:Ee.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return le&&pe?`<div data-gc-id="${pe.id}" data-gc-type="${R}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${Ce};background:${$e};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${Ce}66;cursor:pointer">
          ${_e}
          ...
          <div style="height:150px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Oe?`<img src="${Oe}" style="max-width:120px;max-height:120px;object-fit:contain;border-radius:6px">`:`<span style="font-size:64px">${B.icon}</span>`}
          </div>
          <div style="padding:10px 12px;background:rgba(0,0,0,0.35);text-align:center">
            <div style="font-size:11px;color:rgba(255,255,255,0.9);line-height:1.4">${De.slice(0,60)}</div>
          </div>
        ...
        </div>`},({type:R,gc:B,def:O,owned:le})=>{const pe=window.innerWidth>=768?.76:.54,ve={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},_e={purple:"#9b59b6",light_blue:"#00bcd4"},ze=ve[O==null?void 0:O.color]||ve.purple,Ie=_e[O==null?void 0:O.color]||_e.purple,ke=O!=null&&O.image_url?`/icons/${O.image_url}`:null,$e=Math.round(140*657/507);return le?`<div style="display:inline-block;zoom:${pe};line-height:0;pointer-events:none"><div style="width:140px;height:${$e}px;border-radius:8px;background:${ze};border:1px solid ${Ie};display:flex;flex-direction:column;overflow:hidden"><div style="height:34px;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center"><span style="font-size:10px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px">${R}</span></div><div style="flex:1;display:flex;align-items:center;justify-content:center;min-height:0">${ke?`<img src="${ke}" style="max-width:110px;max-height:100px;object-fit:contain">`:`<span style="font-size:28px">${B.icon}</span>`}</div><div style="height:30px;display:flex;align-items:center;justify-content:center;padding:0 4px"><span style="font-size:8px;color:rgba(255,255,255,0.7);text-align:center;line-height:1.2">${((O==null?void 0:O.effect)||B.desc||"").slice(0,26)}</span></div></div></div>`:`<div style="display:inline-block;zoom:${pe};line-height:0;pointer-events:none"><div style="width:140px;height:${$e}px;border-radius:8px;background:#eee;border:1px solid #ddd;display:flex;flex-direction:column;align-items:center;justify-content:center;filter:grayscale(1);opacity:0.45"><span style="font-size:24px">${B.icon}</span><span style="font-size:9px;color:#aaa;margin-top:4px;text-align:center;padding:0 6px">${R}</span></div></div>`},({type:R,owned:B,def:O})=>{B&&zo(R,O,o)},"#7a28b8",5)}function U(M){const F="#E87722",H="/";if(!y.length){M.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const Q={};y.forEach(B=>{const O=B.stadium_id||"?";(Q[O]=Q[O]||[]).push(B)});const R=Object.entries(Q).map(([B,O])=>({sid:B,def:u[B]||null,count:O.length,card:O[0]}));oe(R,({def:B,count:O})=>{var Ie,ke;const le=(B==null?void 0:B.name)||"?",pe=((Ie=B==null?void 0:B.club)==null?void 0:Ie.encoded_name)||(B==null?void 0:B.country_code)||"—",ve=B!=null&&B.image_url?`${H}icons/${B.image_url}`:((ke=B==null?void 0:B.club)==null?void 0:ke.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),_e=ve?`<img src="${ve}" style="width:90px;height:90px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<div style="font-size:56px">🏟️</div>',ze=O>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${O}</div>`:"";return`<div style="position:relative;width:140px;border-radius:12px;border:3px solid #c45a00;background:linear-gradient(160deg,${F},#c45a00);display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${F}66">
          ${ze}
          ...
          <div style="height:140px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.08)">${_e}</div>
        ...
        </div>`},({def:B,count:O})=>{var ke,$e;const le=window.innerWidth>=768?.76:.54,pe=(B==null?void 0:B.name)||"?",ve=((ke=B==null?void 0:B.club)==null?void 0:ke.encoded_name)||(B==null?void 0:B.country_code)||"—",_e=B!=null&&B.image_url?`${H}icons/${B.image_url}`:(($e=B==null?void 0:B.club)==null?void 0:$e.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),ze=_e?`<img src="${_e}" style="width:44px;height:44px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:22px">🏟️</span>',Ie=Math.round(140*657/507);return`<div style="display:inline-block;zoom:${le};line-height:0;pointer-events:none">
          <div style="width:140px;height:${Ie}px;border-radius:8px;background:linear-gradient(160deg,${F},#c45a00);border:1px solid #c45a00;display:flex;flex-direction:column;overflow:hidden">
            <div style="height:36px;background:rgba(0,0,0,0.25);display:flex;align-items:center;justify-content:center;flex-direction:column;padding:2px 6px">
              ...
              <div style="font-size:9px;font-weight:900;color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:130px;margin-top:1px">${pe}</div>
            </div>
            <div style="flex:1;display:flex;align-items:center;justify-content:center;min-height:0">${ze}</div>
            <div style="height:42px;display:flex;flex-direction:column;align-items:center;justify-content:center;background:rgba(0,0,0,0.3);padding:3px;gap:2px">
              <div style="font-size:8px;font-weight:700;color:rgba(255,255,255,0.9);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:126px;text-align:center">${ve}</div>
              <div style="font-size:10px;font-weight:900;color:#FFD700">+10 ⭐</div>
            </div>
          </div>
        </div>`},null,F,5)}e.querySelectorAll(".col-tab-btn").forEach(M=>{M.addEventListener("click",()=>{C=M.dataset.tab,k="Tous",I="",D=!1,e.querySelectorAll(".col-tab-btn").forEach(F=>{const H=F.dataset.tab===C;F.style.borderBottomColor=H?"var(--green)":"transparent",F.style.color=H?"var(--green)":"var(--tile-fg-dim)"}),z(),Y()})}),z(),Y()}function zo(e,t,i){const n=qe[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,l=(t==null?void 0:t.effect)||n.desc,m=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--tile-border);padding-top:14px">
      ...
      <!-- Carte visuelle -->
      ${je({...l,_evolution_bonus:g},{width:160})}
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([N,V])=>{const U=hi[N],M=N==="GK"?"#fff":U,F=N===l.job||N===l.job2,H=(Number(V)||0)+(F&&C>0?C:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${U};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${M};font-family:Arial Black,Arial;line-height:1">${H}</span>
                </div>
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(me=document.getElementById("close-detail"))==null||me.addEventListener("click",s);let Y=new Set;const oe=()=>{const N=Y.size,V=document.getElementById("sell-action-panel");if(!V)return;V.style.display=N>0?"block":"none",document.getElementById("sell-selected-count").textContent=N;const U=document.getElementById("evolve-btn");U&&(U.textContent=`⬆️ Évoluer ${N>1?"(+"+N+")":""}`)};document.querySelectorAll(".expl-check").forEach(N=>{N.addEventListener("change",()=>{const V=N.dataset.id;N.checked?Y.add(V):Y.delete(V);const U=N.closest(".exemplaire-row");U&&(U.style.borderColor=N.checked?"#1A6B3C":"#eee"),oe()})}),document.querySelectorAll(".exemplaire-row").forEach(N=>{N.addEventListener("click",V=>{if(V.target.closest("button")||V.target.tagName==="INPUT")return;const U=N.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(N=>{N.addEventListener("click",V=>{V.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${N.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(A=document.getElementById("evolve-btn"))==null||A.addEventListener("click",async()=>{if(y<=1)return;const N=[...Y];if(!N.length)return;if(Y.has(e.id)){const R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",R.innerHTML=`
        ...
        </div>`,document.body.appendChild(R),R.querySelector("#err-close").addEventListener("click",()=>R.remove()),R.addEventListener("click",B=>{B.target===R&&R.remove()});return}const V=N.filter(R=>R!==e.id),U=l.rarity==="legende"?2:1;if((V.length||1)*U,!(!V.length&&N.length===1&&N[0]===e.id)){if(!V.length){o("Sélectionne des copies à sacrifier","warning");return}}if(!await new Promise(R=>{const B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",B.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
        ...
        <div style="width:105px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 6px;gap:8px;border-right:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;align-items:center" id="subs-list">
            ${c.map(u=>{const b={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                ${je({...b,_evolution_bonus:b._evolution_bonus||0},{width:60,showStad:!0,stadDef:d})}
        ...
        <div style="display:flex;gap:10px;align-items:flex-start">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;gap:4px;align-items:center;flex-wrap:nowrap;overflow-x:auto" id="subs-list">
              ${c.map(u=>{const b={...u.player,_evolution_bonus:u.evolution_bonus||0};return`<div style="position:relative;flex-shrink:0;overflow:visible">
                  ${je({...b,_evolution_bonus:b._evolution_bonus||0},{width:44,showStad:!0,stadDef:d})}
                  <button data-remove-sub="${u.id}"
    ...
    <div style="position:relative;width:${g}px;height:${x}px;margin:0 auto">
      ...
      ${g.length>0?'<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center">'+g.map(h=>{const $={...h.player,_evolution_bonus:h.evolution_bonus||0};return`<div class="player-option" data-card-id="${h.id}" style="cursor:pointer">
          ${je($,{width:100,showStad:!0,stadDef:d,role:a})}
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const c=z=>z.touches&&z.touches[0]?z.touches[0].clientX:z.clientX;function l(z){o||(d=!0,s.style.opacity="1",m(z))}function m(z){if(!d||o)return;const Y=a.getBoundingClientRect(),oe=c(z)-Y.left,fe=Math.max(0,Math.min(1,oe/Y.width));s.style.width=fe*Y.width+"px",fe>=.82&&g()}function y(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var Y;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(Y=document.getElementById("cut-flash"))==null||Y.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const z=document.getElementById("cut-hint");z&&(z.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",l),window.addEventListener("pointermove",m),window.addEventListener("pointerup",y),a.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",y);let x=0,p=!1;const u=new Set;function b(z){x=z,document.getElementById("reveal-phase").style.display="flex",w(),h(z,0),I()}function w(){const z=document.getElementById("card-dots");z&&(z.innerHTML=e.map((Y,oe)=>`<div class="card-dot" data-i="${oe}" style="width:8px;height:8px;border-radius:50%;background:${oe===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),z.querySelectorAll(".card-dot").forEach(Y=>Y.addEventListener("click",()=>f(parseInt(Y.dataset.i)))))}function h(z,Y){var U,M;const oe=e[z],fe=document.getElementById("card-counter"),me=document.getElementById("card-track");fe&&(fe.textContent=`Carte ${z+1} / ${e.length}`);const A=document.getElementById("reveal-btns");A&&(A.style.display=z===e.length-1?"flex":"none");const W=oe.card_type==="player"&&((U=oe.player)==null?void 0:U.rarity)==="legende",ue=!u.has(z);u.add(z);let N=0;if(oe.card_type==="player"&&oe.player){const F=oe.player,H=F.job||"ATT";N=Number(H==="GK"?F.note_g:H==="DEF"?F.note_d:H==="MIL"?F.note_m:F.note_a)||0}const V=F=>{me.innerHTML=`
        ...
        </div>`;const H=document.getElementById("current-card-wrap");Y!==0?(H.style.transition="none",H.style.transform=`translateX(${Y>0?100:-100}%)`,requestAnimationFrame(()=>{H.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",H.style.transform="translateX(0)"})):H.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),F||W?ie():ne(),w()};ue&&(((M=oe.player)==null?void 0:M.rarity)==="legende"||N>=8)&&oe.card_type==="player"&&oe.player?$(oe,()=>V(!0)):V(!1)}function $(z,Y){var ve;p=!0;const oe=z.player,fe=`https://flagsapi.com/${oe.country_code}/flat/64.png`,me=(ve=oe.clubs)==null?void 0:ve.logo_url,A=oe.face?"/"+oe.face.replace(/^public\//,"").replace(/^\//,""):null,W=oe.job||"ATT",ue=Number(W==="GK"?oe.note_g:W==="DEF"?oe.note_d:W==="MIL"?oe.note_m:oe.note_a)||0,N=z.evolution_bonus||0,V=ue+N,U=oe.rarity==="legende",M=V>=18,F=document.getElementById("walkout-overlay"),H=document.getElementById("walkout-stage");if(!F||!H){p=!1,Y();return}let Q=null;U&&(Q=mo("/sounds/Legendary.mp3",.8)),F.style.display="flex";const R=()=>{const _e=H.firstElementChild;_e&&(_e.classList.remove("wo-in"),_e.classList.add("wo-out"))},B=1800,O=400;H.innerHTML=`<img class="wo-in" src="${fe}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(R,B),setTimeout(()=>{var _e;H.innerHTML=me?`<img class="wo-in" src="${me}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((_e=oe.clubs)==null?void 0:_e.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},B+O),setTimeout(R,B*2+O),setTimeout(()=>{H.innerHTML=A?`<img class="wo-in" src="${A}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(B+O)*2),setTimeout(R,(B+O)*2+B);const pe=M?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[W]||"#fff";setTimeout(()=>{H.innerHTML=`<div class="wo-in" style="
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}function Cn(e){var o,a,s;if(!e)return"";const t=d=>d?je({...d,_evolution_bonus:0},{width:52,role:d._line||d.job,showStad:!!d.stadiumBonus,extraNote:d.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.85);pointer-events:none`;const s=(e||[]).slice(0,3).map(d=>je({...d,_evolution_bonus:0},{width:Math.min(140,Math.round(window.innerWidth/4)),role:d._line||d.job,showStad:!!d.stadiumBonus})).join("");if(a.innerHTML=`
    ...
    position:fixed;inset:0;z-index:3000;
    display:flex;flex-direction:column;align-items:center;justify-content:center;
    background:rgba(0,0,0,0.8);pointer-events:none`;const o=Math.min(120,Math.round(window.innerWidth/4)),a=e?je({...e,_evolution_bonus:0},{width:o,role:e._line||e.job}):"",s=t?je({...t,_evolution_bonus:0},{width:o,role:t._line||t.job}):"";r.innerHTML=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ht(o,e[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Bn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
          <div class="duel-card duel-card-${n}" data-idx="${a}" style="opacity:0;transform:translateY(18px) scale(0.7);transition:opacity .35s ease, transform .35s cubic-bezier(.34,1.56,.64,1);flex-shrink:0">
            ${je({...o,_evolution_bonus:0},{width:window.innerWidth>=900?Math.min(130,Math.max(80,Math.round(window.innerWidth*.08))):58,showStad:!0,stadDef:r,role:"MIL",extraNote:o.boost||0})}
          </div>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const A=window.innerWidth>=700,W=(R,B,O)=>{var Ee,Le;const le=(t.gcDefs||[]).find(Ge=>Ge.name===R.gc_type),pe={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[le==null?void 0:le.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ve={purple:"#b06ce0",light_blue:"#00d4ef"}[le==null?void 0:le.color]||"#b06ce0",_e=(le==null?void 0:le.name)||R.gc_type,ze=(le==null?void 0:le.effect)||((Ee=qe[R.gc_type])==null?void 0:Ee.desc)||"",Ie=le!=null&&le.image_url?`/icons/${le.image_url}`:null,ke=((Le=qe[R.gc_type])==null?void 0:Le.icon)||"⚡",$e=Math.round(O*.22),Ce=Math.round(O*.22),De=O-$e-Ce,Oe=_e.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          style="box-sizing:border-box;width:${B}px;height:${O}px;border-radius:10px;border:2px solid ${ve};background:${pe};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
          <div style="height:${$e}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
            <span style="font-size:${Oe}px;font-weight:900;color:#fff;text-align:center;line-height:1.1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${B-6}px">${_e}</span>
          ...
          <div style="height:${De}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
            ${Ie?`<img src="${Ie}" style="max-width:${B-10}px;max-height:${De-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(De*.55)}px">${ke}</span>`}
          </div>
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(m=>{const y=m._line||m.job||"MIL",g=s.find(p=>p.cardId===m.cardId),x=je({...m,_evolution_bonus:0},{width:90,showStad:!0,role:y,extraNote:m.boost||0});return`<div class="gc-pick-item" data-cid="${m.cardId}"
    ...
    </div>`,(c=a.querySelector("#gc-picker-close"))==null||c.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(m=>{m.addEventListener("click",()=>{const y=m.dataset.cid,g=e.find(p=>p.cardId===y);if(!g)return;const x=s.findIndex(p=>p.cardId===y);x>-1?s.splice(x,1):s.length<t&&s.push(g),d()})}),(l=a.querySelector("#gc-picker-confirm"))==null||l.addEventListener("click",()=>{a.remove(),o(s)})}d(),document.body.appendChild(a)}const fr={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},n,r,o)=>{const a=Object.entries(n.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,d])=>d.filter(c=>!c.used).map(c=>({...c,_line:s})));return a.length?(ri(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,r,n,s=>{s.forEach(d=>{const c=(n.homeTeam[d._line]||[]).find(l=>l.cardId===d.cardId);c&&(c.boost=(c.boost||0)+e,n.log.push({text:`⚡ +${e} sur ${c.name}`,type:"info"}))}),Te(r,n,o)}),!0):(n.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Te(r,n,o),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:n="ai"},r,o,a)=>{const s=n==="home"?r.homeTeam:r.aiTeam,d=n==="ai"?"adverse":"allié",c=Object.entries(s).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,m])=>m.filter(y=>!y.used).map(y=>({...y,_line:l})));return c.length?(ri(c,t,`Choisir ${t} joueur(s) ${d}(s) à débuffer (-${e})`,o,r,l=>{l.forEach(m=>{const g=((n==="home"?r.homeTeam:r.aiTeam)[m._line]||[]).find(x=>x.cardId===m.cardId);g&&(g.boost=(g.boost||0)-e,r.log.push({text:`🎯 -${e} sur ${g.name}${n==="ai"?" (IA)":""}`,type:"info"}))}),Te(o,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${d} disponible`,type:"info"}),Te(o,r,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},n,r,o)=>{const a=i==="home"?n.homeTeam:n.aiTeam,s=i==="ai"?"adverse":"allié",d=Object.entries(a).filter(([c])=>!t.length||t.includes(c)).flatMap(([c,l])=>l.filter(m=>!m.used).map(m=>({...m,_line:c})));return d.length?(ri(d,e,`Choisir ${e} joueur(s) ${s}(s) à exclure`,r,n,c=>{c.forEach(l=>{const y=((i==="home"?n.homeTeam:n.aiTeam)[l._line]||[]).find(g=>g.cardId===l.cardId);y&&(y.used=!0,n.log.push({text:`❌ ${y.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Te(r,n,o)}),!0):(n.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),Te(r,n,o),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,n,r)=>{const o=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,s])=>s.filter(d=>d.used).map(d=>({...d,_line:a})));return o.length?(ri(o,e,`Choisir ${e} joueur(s) à ressusciter`,n,i,a=>{a.forEach(s=>{const d=(i.homeTeam[s._line]||[]).find(c=>c.cardId===s.cardId);d&&(d.used=!1,i.log.push({text:`💫 ${d.name} ressuscité !`,type:"info"}))}),Te(n,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Te(n,i,r),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function gr(e,t,i,n,r){n.usedGc.push(e);const o=n.gcDefs||[],a=o.find(d=>d.name===t)||o.find(d=>{var c;return((c=d.name)==null?void 0:c.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const d=fr[a.effect_type];d?d(a.effect_params||{},n,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const d=Object.entries(n.homeTeam).flatMap(([c,l])=>(l||[]).filter(m=>m.used).map(m=>({...m,_line:c})));d.length?(d[0].used=!1,n.log.push({text:`💫 ${d[0].name} ressuscité !`,type:"info"})):n.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const d=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(c=>!c.used);if(d.length){const c=d.sort((l,m)=>Ne(m,"ATT")-Ne(l,"ATT"))[0];c.used=!0,n.log.push({text:`❄️ ${c.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",e).then(()=>{}),s&&Te(i,n,r)}function mr(e,t,i){const n=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(d=>d.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Te(e,t,i)})})}async function ht(e,t,i){var l,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=xo(t.mode,a);t.matchId&&await v.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const d={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?d.wins=(n.profile.wins||0)+1:o?d.draws=(n.profile.draws||0)+1:d.losses=(n.profile.losses||0)+1,await v.from("users").update(d).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${gi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
            ...
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Se.id!==nt.id?`<div style="font-size:20px;font-weight:900;color:${Se.color}">
                    ${He>J.mmr?"📈":"📉"} ${nt.emoji} ${nt.label} → ${Se.emoji} ${Se.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${He>J.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${Ae>=0?"📈":"📉"}</div>
      ...
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${l?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(q),(te=q.querySelector("#pvp-end-home"))==null||te.addEventListener("click",()=>{q.remove(),it(e),l?g("mini-league",{openLeagueId:l}):g(a?"ranked":"home")})}const Z=v.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{var T;const E=_.new;try{if(E.status==="finished"||E.forfeit){if(C)return;C=!0,k&&(clearInterval(k),k=null),E.game_state&&(f=E.game_state),ne(E);return}if(E.game_state){const S=f;f=E.game_state;const L=f._lastGC;if(L&&L.seq&&!ie.has(L.seq)&&(ie.add(L.seq),L.by!==p)){U(L.type,L.by,()=>W());return}const G=S[p+"Score"]||0,q=S[u+"Score"]||0,P=f[p+"Score"]||0,K=f[u+"Score"]||0,ee=P>G,re=K>q;if((ee||re)&&!D.has(f.round)){D.add(f.round);const te=[...f.log||[]].reverse().find(de=>de.isGoal),J=((te==null?void 0:te.homePlayers)||[]).map(de=>({name:de.name,note:de.note,portrait:de.portrait,job:de.job}));!!((T=te==null?void 0:te.text)!=null&&T.includes("DERNIER CORNER"))?ve().then(()=>{Ze(J,P,K,ee,()=>W())}):Ze(J,P,K,ee,()=>W());return}W()}}catch(S){console.error("[PvP] crash:",S)}}).subscribe();async function j(_){Object.assign(f,_),f.lastActionAt=new Date().toISOString();const{error:E}=await v.from("matches").update({game_state:f}).eq("id",i);E&&x("Erreur de synchronisation","error");try{W()}catch(T){console.error("[PvP] renderPvpScreen crash:",T)}}async function z(){if(C)return;C=!0,k&&(clearInterval(k),k=null);const _=n?h.away_id:h.home_id,E=n?"p2":"p1",T=n?"p1":"p2",S={...f,[E+"Score"]:3,[T+"Score"]:0,phase:"finished"},L=S.p1Score||0,G=S.p2Score||0;try{await v.from("matches").update({game_state:S}).eq("id",i);const{data:q,error:P}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:_,p_home_score:L,p_away_score:G,p_forfeit:!0});if(P&&console.error("[PvP] finish_pvp_match (forfeit):",P),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await v.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{v.removeChannel(Z)}catch{}setTimeout(()=>{it(e),l?g("mini-league",{openLeagueId:l}):g("home")},800)}const Y={BOOST_STAT:({value:_=1,count:E=1,roles:T=[]},S,L)=>{const G=S[p+"Team"],q=Object.entries(G).filter(([P])=>!T.length||T.includes(P)).flatMap(([P,K])=>K.filter(ee=>!ee.used).map(ee=>({...ee,_line:P})));if(!q.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),L(S);return}oe(q,E,`Choisir ${E} joueur(s) à booster (+${_})`,P=>{P.forEach(K=>{const ee=(G[K._line]||[]).find(re=>re.cardId===K.cardId);ee&&(ee.boost=(ee.boost||0)+_,S.log.push({text:`⚡ +${_} sur ${ee.name}`,type:"info"}))}),S[p+"Team"]=G,L(S)})},DEBUFF_STAT:({value:_=1,count:E=1,roles:T=[],target:S="ai"},L,G)=>{const q=S==="home"?p:u,P=L[q+"Team"],K=S==="home"?"allié":"adverse",ee=Object.entries(P).filter(([re])=>!T.length||T.includes(re)).flatMap(([re,te])=>te.map(J=>({...J,_line:re})));if(!ee.length){L.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),G(L);return}oe(ee,E,`Choisir ${E} joueur(s) ${K}(s) (-${_})`,re=>{re.forEach(te=>{const J=(P[te._line]||[]).find(se=>se.cardId===te.cardId);J&&(J.boost=(J.boost||0)-_,L.log.push({text:`🎯 -${_} sur ${J.name}`,type:"info"}))}),L[q+"Team"]=P,G(L)})},GRAY_PLAYER:({count:_=1,roles:E=[],target:T="ai"},S,L)=>{const G=T==="home"?p:u,q=S[G+"Team"],P=T==="home"?"allié":"adverse",K=Object.entries(q).filter(([ee])=>!E.length||E.includes(ee)).flatMap(([ee,re])=>re.filter(te=>!te.used).map(te=>({...te,_line:ee})));if(!K.length){S.log.push({text:`❌ Aucun joueur ${P}`,type:"info"}),L(S);return}oe(K,_,`Choisir ${_} joueur(s) ${P}(s) à exclure`,ee=>{const re="usedCardIds_"+G,te=new Set(S[re]||[]);ee.forEach(J=>{const se=(q[J._line]||[]).find(de=>de.cardId===J.cardId);se&&(se.used=!0,te.add(J.cardId),S.log.push({text:`❌ ${se.name} exclu !`,type:"info"}))}),S[re]=[...te],S[G+"Team"]=q,L(S)})},REVIVE_PLAYER:({count:_=1,roles:E=[]},T,S)=>{const L=T[p+"Team"],G=Object.entries(L).filter(([q])=>!E.length||E.includes(q)).flatMap(([q,P])=>P.filter(K=>K.used).map(K=>({...K,_line:q})));if(!G.length){T.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(T);return}oe(G,_,`Choisir ${_} joueur(s) à ressusciter`,q=>{q.forEach(P=>{const K=(L[P._line]||[]).find(ee=>ee.cardId===P.cardId);K&&(K.used=!1,T.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),T[p+"Team"]=L,S(T)})},REMOVE_GOAL:({},_,E)=>{const T=u+"Score";_[T]>0?(_[T]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(_)},ADD_GOAL_DRAW:({},_,E)=>{_[p+"Score"]===_[u+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(_)},ADD_SUB:({value:_=1},E,T)=>{E.maxSubs=(E.maxSubs||3)+_,E.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),T(E)},CUSTOM:({},_,E)=>E(_)};function oe(_,E,T,S){const L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let G=[];function q(){var K,ee;const P=_.map(re=>{const te=re._line||re.job||"MIL",J=G.find(de=>de.cardId===re.cardId),se=je({...re,_evolution_bonus:0},{width:90,showStad:!0,role:te,extraNote:re.boost||0});return`<div class="pp-item" data-cid="${re.cardId}"
        ...
        <div style="height:${Re}px;background:rgba(255,255,255,0.14);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0 3px">
          <span style="font-size:${Ct}px;font-weight:900;color:#fff;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:${ge-6}px">${Pe}</span>
          <span style="font-size:6px;color:rgba(255,255,255,0.45)">⚡ GC</span>
        </div>
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Nt(_,f[p+"Formation"],ut,ee,re?1300:zt(),re?600:Gt(),Ke)}
    ...
    </div>`,rt=f[p+"Team"],Un=(()=>{var ge,Me,we,jt,at;if(P&&((ge=f.pendingAttack)!=null&&ge.players)){const Pe=f.pendingAttack;let Ue="";if(K.length>0){const Be=K.map(Re=>{const ft=(rt[Re._role]||[]).find(yi=>yi.cardId===Re.cardId)||Re,st=rt[Re._role]||[],Ct=st.findIndex(yi=>yi.cardId===Re.cardId),Bt=xt(st.length),gt=Ct>=0?Bt[Ct]:ft._col??1;return{...ft,_line:Re._role,_col:gt}}),kt=Zt(Be,((Me=f.modifiers)==null?void 0:Me[p])||{},f[p+"Formation"]);Ue=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
          ...
          <div style="display:flex;justify-content:center">${Qe((Pe.players||[]).map(Be=>({...Be,used:!1})),"#ff6b6b",Pe.total,"attack",f[u+"Formation"])}</div>
          ${Ue}
        </div>`}if(q&&((we=f.pendingAttack)!=null&&we.players)){const Pe=f.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Qe((Pe.players||[]).map(Ue=>({...Ue,used:!1})),"#00ff88",Pe.total,"attack",f[p+"Formation"])}</div>
        </div>`}if(q&&!((jt=f.pendingAttack)!=null&&jt.players)&&K.length>0){const Pe=K.map(Be=>{const kt=(rt[Be._role]||[]).find(gt=>gt.cardId===Be.cardId)||Be,Re=["GK","DEF"].includes(Be._role),ft=rt[Be._role]||[],st=ft.findIndex(gt=>gt.cardId===Be.cardId),Ct=xt(ft.length),Bt=st>=0?Ct[st]:kt._col??1;return{...kt,_line:Be._role,_col:Bt,...Re?{note_a:Math.max(1,Number(kt.note_a)||0)}:{}}}),Ue=Qt(Pe,((at=f.modifiers)==null?void 0:at[p])||{},f[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Qe(Pe.map(Be=>({...Be,used:!1})),"#FFD700",Ue.total,"attack",f[p+"Formation"])}</div>
      ...
      </div>`;function Mt(){const X=e.querySelector(".match-screen");if(!X)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=ge+"px",X.style.minHeight=ge+"px",X.style.maxHeight=ge+"px",X.style.overflow="hidden";const Me=e.querySelector("#mobile-action-bar"),we=e.querySelector("#mobile-play-area");Me&&we&&(we.style.paddingBottom=Me.offsetHeight+"px")}if(Mt(),setTimeout(Mt,120),setTimeout(Mt,400),I||(I=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Mt),window.visualViewport.addEventListener("scroll",Mt)),window.addEventListener("resize",Mt)),function(){const ge=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!ge)return;const Me=ge.closest("#match-terrain-wrap");Me&&(Me.style.cssText="position:relative;width:100%;height:100%;padding:0"),ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("preserveAspectRatio","xMidYMid meet")}(),f._pvpResizeBound||(f._pvpResizeBound=!0,window.addEventListener("resize",()=>{const X=e.querySelector(".terrain-wrapper svg");if(X){const ge=X.closest("#match-terrain-wrap");ge&&(ge.style.cssText="position:relative;width:100%;height:100%;padding:0"),X.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!q&&!P)return;const ge=X.dataset.cardId,Me=X.dataset.role,we=(_[Me]||[]).find(Ue=>Ue.cardId===ge);if(!we||we.used)return;const jt=Ke.includes(ge);if(q&&!["MIL","ATT"].includes(Me)&&!jt)return;Array.isArray(f["selected_"+p])||(f["selected_"+p]=[]);const at=f["selected_"+p],Pe=at.findIndex(Ue=>Ue.cardId===ge);Pe>-1?at.splice(Pe,1):at.length<3&&at.push({...we,_role:Me}),W()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>H(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>H())}),(Ki=e.querySelector("#pvp-sub-open"))==null||Ki.addEventListener("click",()=>H()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{q?X.addEventListener("click",()=>M(X.dataset.gcId,X.dataset.gcType)):(X.style.opacity="0.35",X.style.cursor="default",X.addEventListener("click",()=>$t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Vi=e.querySelector("#pvp-boost-card"))==null||Vi.addEventListener("click",()=>F()),(Yi=e.querySelector("#pvp-action"))==null||Yi.addEventListener("click",X=>{q?X.currentTarget.dataset.pass==="1"||!De(p)?O():ze():P&&Ie()}),(Wi=e.querySelector("#pvp-quit"))==null||Wi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&z()}),(Xi=e.querySelector("#pvp-view-opp"))==null||Xi.addEventListener("click",()=>R()),(Ji=e.querySelector("#pvp-toggle-history"))==null||Ji.addEventListener("click",()=>B()),k&&(clearInterval(k),k=null),(q||P)&&!C){let X=30,ge=!1;const Me=()=>document.getElementById("pvp-timer"),we=()=>{Me()&&(Me().textContent=X+"s",Me().style.color=ge?"#ff4444":"#fff")};we(),k=setInterval(()=>{X--,X<0?ge?(clearInterval(k),k=null,q&&!De(p)?O():z()):(ge=!0,X=15,we()):we()},1e3)}}function ue(){dt(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${xe?vt({...xe,used:!1,boost:0},ye,be):"<div>—</div>"}</div>
      ...
      </div>`,(He=te.querySelector("#psub-close"))==null||He.addEventListener("click",()=>te.remove()),(Se=te.querySelector("#pout-up"))==null||Se.addEventListener("click",()=>{P>0&&(P--,J())}),(We=te.querySelector("#pout-down"))==null||We.addEventListener("click",()=>{P<G.length-1&&(P++,J())}),(Ke=te.querySelector("#pin-up"))==null||Ke.addEventListener("click",()=>{ee>0&&(ee--,J())}),(nt=te.querySelector("#pin-down"))==null||nt.addEventListener("click",()=>{ee<q.length-1&&(ee++,J())});const Ae=(Fe,Xe,Ve,pt)=>{const ot=te.querySelector("#"+Fe);if(!ot)return;let St=0;ot.addEventListener("touchstart",ut=>{St=ut.touches[0].clientY},{passive:!0}),ot.addEventListener("touchend",ut=>{const _t=ut.changedTouches[0].clientY-St;if(Math.abs(_t)<30)return;const rt=Xe();_t<0&&rt<pt-1?(Ve(rt+1),J()):_t>0&&rt>0&&(Ve(rt-1),J())},{passive:!0})};Ae("pin-panel",()=>ee,Fe=>ee=Fe,q.length),Ae("pout-panel",()=>P,Fe=>P=Fe,G.length),(Ut=te.querySelector("#psub-confirm"))==null||Ut.addEventListener("click",async Fe=>{if(Fe.preventDefault(),Fe.stopPropagation(),re)return;re=!0;const Xe=G[P],Ve=q[ee];if(!Xe||!Ve)return;const pt=Xe._line,ot=(T[pt]||[]).findIndex(_t=>_t.cardId===Xe.cardId);if(ot===-1){x("Erreur : joueur introuvable","error"),te.remove();return}const St={...Ve,_line:pt,position:Xe.position,used:!1,boost:0};T[pt].splice(ot,1,St);const ut=[...S,Ve.cardId];te.remove(),Q(Xe,Ve,async()=>{await j({[p+"Team"]:T,[u+"Team"]:f[u+"Team"],["usedSubIds_"+p]:ut})})})}document.body.appendChild(te),J()}function Q(_,E,T){const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const G=(K,ee,re)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(E),(T=E.querySelector("#pvp-hist-close"))==null||T.addEventListener("click",()=>E.remove())}async function O(){if(f.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",E=(f.round||0)+1,T=[...f.log||[]];T.push({type:"info",text:`⏭️ ${f[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const S=Oe(f),L=De(_),G=S||!L?"finished":_+"-attack";await j({["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:G,attacker:_,round:E,log:T}),G==="finished"&&await Le(f)}function le(_){const E=(_.GK||[]).some(S=>!S.used),T=["DEF","MIL","ATT"].some(S=>(_[S]||[]).some(L=>!L.used));return E&&!T}function pe(_){return(_.p1Score||0)!==(_.p2Score||0)?null:le(_.p1Team)&&!$e(_.p2Team)?{side:"p1",gk:(_.p1Team.GK||[]).find(E=>!E.used)}:le(_.p2Team)&&!$e(_.p1Team)?{side:"p2",gk:(_.p2Team.GK||[]).find(E=>!E.used)}:null}async function ve(){const _=document.createElement("div");_.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(_);const E=(T,S)=>new Promise(L=>{_.innerHTML=`<div style="font-size:32px;font-weight:900;color:${S};letter-spacing:2px;animation:lcFade 1.4s ease both">${T}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(L,1400)});await E("⚽ DERNIER CORNER","#FFD700"),await E("🧤 LE GARDIEN MONTE !","#4fc3f7"),_.remove()}async function _e(_,E){const{side:T,gk:S}=_;if(!S)return;const L=T+"Score",G=(E[L]||0)+1;S.used=!0;const q=[...E.log||[]];q.push({type:"duel",isGoal:!0,homeScored:T===p,homePlayers:T==="p1"?[qt(S)]:[],aiPlayers:T==="p2"?[qt(S)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${E[T+"Name"]} marque !`});const P=(E.round||0)+1,K=T==="p1"?"p2":"p1",ee={...E,[L]:G},re=Oe(ee);D.add(P),await ve();const te=T===p?G:E[p+"Score"]||0,J=T===p?E[u+"Score"]||0:G;Ze([qt(S)],te,J,T===p,async()=>{await j({[L]:G,log:q,round:P,pendingAttack:null,phase:re?"finished":K+"-attack",attacker:K,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}}}),re&&await Le({...f,[L]:G})})}async function ze(){const _=f[p+"Team"],E=!["GK","DEF","MIL","ATT"].some(G=>(f[u+"Team"][G]||[]).some(q=>!q.used)),T=(f["selected_"+p]||[]).map(G=>{const q=(_[G._role]||[]).find(de=>de.cardId===G.cardId)||G,P=["GK","DEF"].includes(G._role),K=_[G._role]||[],ee=K.findIndex(de=>de.cardId===G.cardId),re=xt(K.length),te=ee>=0?re[ee]:q._col??1,J=f.stadiumDef||f.homeStadiumDef||null,se=q.stadiumBonus||J&&(J.club_id&&String(q.club_id)===String(J.club_id)||J.country_code&&q.country_code===J.country_code)||!1;return{...q,_line:G._role,_col:te,stadiumBonus:se,...P?{note_a:Math.max(1,Number(q.note_a)||0)}:{}}});if(!T.length)return;const S=Qt(T,f.modifiers[p]||{},f[p+"Formation"]);me(p,T.map(G=>G.cardId)),T.forEach(G=>{const q=(_[G._role]||[]).find(P=>P.cardId===G.cardId);q&&(q.used=!0)}),f["selected_"+p]=[],W();const L=[...f.log||[]];if(E){if(T.length===1&&(T[0]._line==="GK"||T[0].job==="GK")&&(f.p1Score||0)===(f.p2Score||0)){await _e({side:p,gk:T[0]},{...f,[p+"Team"]:_,log:L});return}const q=(f[p+"Score"]||0)+1,P=T.map(J=>qt(J));L.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:P,homeTotal:S.total,aiTotal:0});const K=(f.round||0)+1,ee=p==="p1"?"p2":"p1",re={...f,[p+"Team"]:_,[p+"Score"]:q},te=Oe(re);D.add(K),Ze(P,q,f[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:_,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:te?"finished":ee+"-attack",attacker:ee,round:K,log:L}),te&&await Le({...f,[p+"Score"]:q})});return}L.push({type:"pending",text:`⚔️ ${f[p+"Name"]} attaque (${S.total})`}),await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],pendingAttack:{...S,players:T,side:p},["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},phase:u+"-defense",log:L})}async function Ie(){const _=f[p+"Team"],E=(f["selected_"+p]||[]).map(ce=>{const ye=(_[ce._role]||[]).find(Se=>Se.cardId===ce.cardId)||ce,be=_[ce._role]||[],ae=be.findIndex(Se=>Se.cardId===ce.cardId),Ae=xt(be.length),He=ae>=0?Ae[ae]:ye._col??1;return{...ye,_line:ce._role,_col:He}}),T=Zt(E,f.modifiers[p]||{},f[p+"Formation"]);me(p,E.map(ce=>ce.cardId)),E.forEach(ce=>{const ye=(_[ce._role]||[]).find(be=>be.cardId===ce.cardId);ye&&(ye.used=!0)}),f["selected_"+p]=[],W();const S=Gi(f.pendingAttack.total,T.total,f.modifiers[p]||{}),L=f.pendingAttack.side,G=S==="attack"||(S==null?void 0:S.goal),q=L==="p1"?"p2":"p1",P=(f.round||0)+1,K=(f.pendingAttack.players||[]).map(ce=>qt(ce)),ee=[...f.log||[]];ee.push({type:"duel",isGoal:G,homeScored:G&&L===p,text:G?`⚽ BUT de ${f[L+"Name"]} ! (${f.pendingAttack.total} vs ${T.total})`:`✋ Attaque stoppée (${f.pendingAttack.total} vs ${T.total})`,homePlayers:K,aiPlayers:E.map(ce=>qt(ce)),homeTotal:f.pendingAttack.total,aiTotal:T.total});const re=G?(f[L+"Score"]||0)+1:f[L+"Score"]||0,te={...f,[p+"Team"]:_,[L+"Score"]:re},J=Oe(te),se=J?"finished":q+"-attack",de=!J&&!G?pe(te):null,xe=async()=>{if(de){await _e(de,te);return}await j({[p+"Team"]:_,[u+"Team"]:f[u+"Team"],[L+"Score"]:re,["selected_"+p]:[],modifiers:{...f.modifiers,[p]:{}},pendingAttack:null,phase:se,attacker:q,round:P,log:ee}),(se==="finished"||J)&&await Le({...f,[L+"Score"]:re})};if(G){const ce=L===p,ye=ce?re:f[p+"Score"]||0,be=ce?f[u+"Score"]||0:re;D.add(P),Ze(K,ye,be,ce,xe)}else await xe()}function ke(_){return["MIL","ATT"].some(E=>(_[E]||[]).some(T=>!T.used))}function $e(_){return["GK","DEF","MIL","ATT"].some(E=>(_[E]||[]).some(T=>!T.used))}function Ce(_){return $e(_)&&!ke(_)}function De(_){const E=f[_+"Team"],T=f[(_==="p1"?"p2":"p1")+"Team"];return!!(ke(E)||Ce(E)&&!$e(T)||Ce(E)&&!ke(T)&&$e(T))}function Oe(_){return!$e(_.p1Team)&&!$e(_.p2Team)}function Ee(_){const E=_.p1Score||0,T=_.p2Score||0;return E===T?null:E>T?h.home_id:h.away_id}async function Le(_){try{const E=Ee(_),T=E?h.home_id===E?h.away_id:h.home_id:null,S=_.p1Score||0,L=_.p2Score||0,{data:G,error:q}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:E,p_home_score:S,p_away_score:L,p_forfeit:!1});if(q&&console.error("[PvP] finish_pvp_match:",q),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(P){console.error("[PvP] check_and_finish_mini_league:",P)}E&&T&&ho(E,T).catch(()=>{});try{const{data:P}=await v.rpc("apply_match_rewards",{p_match_id:i});P!=null&&P.success&&!(P!=null&&P.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(P){console.error("[PvP] apply_match_rewards:",P)}if(typeof c=="function")try{await c({homeScore:S,awayScore:L,winnerId:E,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(P){console.error("[PvP] onMatchEnd:",P)}}catch(E){console.error("[PvP] finishMatch:",E)}}function Ge(){var L;const _=f[p+"Score"],E=f[u+"Score"],T=_>E,S=_===E;dt(e),e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`;let l=!1;const m=async u=>{if(!l){if(l=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}u&&await At(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),d()});const y=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&m(u.match_id)},g=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&m(u.new.match_id)}).subscribe(),x=setInterval(y,3e3);y()})}const Gr="/",Rr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
