...
import{s as v,n as Ot,o as Ni,F as Ri,l as et,k as Qt,r as Ie,j as St,p as Si,h as Oi,q as Qn,t as Zn,T as ki,m as eo,u as to,b as io}from"./special-cards-CiJC3HtT.js";const no="/";function rn(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,d,c,l,f;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var y;const c=document.getElementById("logo-preview"),l=document.getElementById("logo-initials"),f=((y=document.getElementById("setup-club"))==null?void 0:y.value)||"MW",x=f.trim().split(" ").filter(Boolean),g=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():f.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),l&&(l.textContent=g,l.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function d(c){document.querySelectorAll(".setup-step").forEach(l=>l.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("step1-error");if(l.textContent="",c.length<3){l.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:f}=await v.from("users").select("id").eq("pseudo",c).maybeSingle();if(f){l.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),l=document.getElementById("step2-error");if(l.textContent="",c.length<2){l.textContent="Nom trop court (min. 2 caractères).";return}const{data:f}=await v.from("users").select("id").eq("club_name",c).maybeSingle();if(f){l.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),l=document.getElementById("setup-club").value.trim(),f=document.getElementById("step3-error"),x=document.getElementById("step3-finish");f.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:g}=await v.from("users").insert({id:t.user.id,pseudo:c,club_name:l,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await ro(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){f.textContent=g.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function ro(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await v.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const ao="modulepreload",so=function(e){return"/"+e},an={},_n=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=so(d),d in an)return;an[d]=!0;const c=d.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${l}`))return;const f=document.createElement("link");if(f.rel=c?"stylesheet":ao,c||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),c)return new Promise((x,g)=>{f.addEventListener("load",x),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Zt="#1A6B3C",ei="#cc2222",lo="#D4A017",sn="#888";async function co(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${x.map(({friendshipId:g,friend:y})=>po(y,g)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>fo(e,g.dataset.stats,g.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const y=g.dataset.friendId,p=g.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const u=e.user.id,{data:b}=await v.from("friend_match_invites").select("id").eq("inviter_id",y).eq("invitee_id",u).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),_=!!b;console.log("[Friends] clic match",{fid:y,fname:p,isAccepting:_}),n("match",{matchMode:"friend",friendId:y,friendName:p,isAccepting:_})})})}function po(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||Zt,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,d=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    ${Ui()}`,document.body.appendChild(h),h.querySelector("#stats-close").addEventListener("click",()=>h.remove()),h.addEventListener("click",E=>{E.target===h&&h.remove()})}function Hi(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function Ui(){return`
    <style>
      .popup-box {
    ...
    </style>`}const $n="mw_sound_muted";function ci(){return localStorage.getItem($n)==="1"}function mo(e){localStorage.setItem($n,e?"1":"0")}function go(e,t=1){if(ci())return null;try{const i=new Audio(e);return i.volume=t,i.play().catch(()=>{}),i}catch{return null}}let $t=null,Ai=null;function yo(e,t=.3){if(!($t&&Ai===e&&!$t.paused)&&(Ft(),!ci()))try{const i=new Audio(e);i.loop=!0,i.volume=t,i.play().catch(()=>{}),$t=i,Ai=e}catch{}}function Ft(){if($t)try{$t.pause(),$t.currentTime=0}catch{}$t=null,Ai=null}const xo="2026.07.21-1718";async function dn(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    <div class="home-inner">
      ...
      <div class="home-footer">
        ...
        <div style="font-size:10px;color:rgba(255,255,255,0.25);font-family:monospace">build ${xo}</div>`:""}
      </div>

    </div>
  </div>`,requestAnimationFrame(()=>{var f,x,g,y,p;const s=((f=window.visualViewport)==null?void 0:f.height)||window.innerHeight,d=((x=document.querySelector(".top-nav"))==null?void 0:x.offsetHeight)||56,c=((g=document.querySelector(".bottom-nav"))==null?void 0:g.offsetHeight)||60;if(e.querySelector(".home-inner")){const u=s-d-c;e.querySelector(".home-dark").style.minHeight=u+"px"}if(window.innerWidth<768){const u=((y=e.querySelector(".home-hero"))==null?void 0:y.offsetHeight)||60,b=e.querySelector(".ranked-tile");e.querySelector(".play-grid");const _=((p=e.querySelector(".home-footer"))==null?void 0:p.offsetHeight)||44,h=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((q,ie)=>{var ne;return q+(((ne=document.getElementById(ie))==null?void 0:ne.offsetHeight)||0)},0),E=12*5,m=s-d-c-u-_-h-E-32,z=Math.max(80,Math.round(m*.28)),k=Math.max(160,Math.round(m*.72)),A=Math.floor((k-10)/2);b&&(b.style.minHeight=b.style.maxHeight=z+"px"),e.querySelectorAll(".play-tile").forEach(q=>{q.style.minHeight=q.style.height=A+"px"}),e.querySelectorAll(".play-tile .play-icon").forEach(q=>{q.style.height=Math.round(A*.55)+"px"})}}),(o=document.getElementById("nav-rankings"))==null||o.addEventListener("click",()=>i("rankings")),(a=document.getElementById("nav-matches"))==null||a.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(s=>{s.addEventListener("click",()=>{s.style.transform="scale(.96)",setTimeout(()=>s.style.transform="",180);const d=s.dataset.action;if(d==="match-ai"){wo(i);return}if(d==="match-random"){i("match",{matchMode:"random"});return}if(d==="match-friend"){i("friends");return}if(d==="mini-league"){i("mini-league");return}if(d==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()}),Ln(t,n),_o(t,n,i),En(t,n,i),bo(t,n))}async function bo(e,t){const i=e.profile.id,{data:n}=await v.from("mini_league_members").select("league_id, prize_amount, mini_leagues(name)").eq("user_id",i).eq("prize_claimed",!1).gt("prize_amount",0);if(!(n!=null&&n.length))return;const r=n.reduce((a,s)=>a+(s.prize_amount||0),0),o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="2200",o.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    </div>`}).join(""),n.querySelectorAll("[data-resume]").forEach(d=>{d.addEventListener("click",async()=>{const c=document.getElementById("page-content")||document.getElementById("app");if(d.dataset.mini==="1"){const{data:l}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",d.dataset.resume).single();l?i("match-mini-league",{mlMatchId:l.id,leagueId:l.league_id}):i("mini-league")}else{const{resumePvpMatch:l}=await _n(async()=>{const{resumePvpMatch:f}=await Promise.resolve().then(()=>Ir);return{resumePvpMatch:f}},void 0);l(c,{state:e,navigate:i,toast:t,openModal:null,closeModal:null,refreshProfile:null},d.dataset.resume)}})}),n.querySelectorAll("[data-abandon]").forEach(d=>{d.addEventListener("click",()=>{vo(async()=>{await ho(d.dataset.abandon,d.dataset.opp,r),t("Match abandonné (défaite 3-0)","info"),En(e,t,i)})})})}async function ho(e,t,i){Ft();const{data:n}=await v.from("matches").select("home_id, away_id, game_state, mode").eq("id",e).single();if(!n)return;const r=n.home_id===i,o=r?0:3,a=r?3:0,s=n.game_state||{};s.p1Score=o,s.p2Score=a,s.phase="finished",s.forfeit=!0,await v.from("matches").update({status:"finished",forfeit:!0,winner_id:t,home_score:o,away_score:a,game_state:s}).eq("id",e),n.mode==="mini_league"&&await v.from("mini_league_matches").update({status:"finished",home_score:o,away_score:a}).eq("match_id",e)}function vo(e){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`<div class="modal" style="max-width:340px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`,e.querySelector("#settings-back").addEventListener("click",()=>i("home")),e.querySelectorAll("[data-theme-choice]").forEach(o=>{o.addEventListener("click",()=>{ra(o.dataset.themeChoice),zi(e,t)})}),e.querySelector("#sound-toggle").addEventListener("click",()=>{mo(!ci()),zi(e,t)}),e.querySelector("#settings-logout").addEventListener("click",async()=>{await v.auth.signOut(),window.location.reload()})}const je={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé pour ce match."},"Double attaque":{icon:"⚡",desc:"La note d'attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la note d'un joueur adverse."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Pe(e,t){if(!e)return 0;let i=0;switch(t){case"GK":i=Number(e.note_g)||0;break;case"DEF":i=Number(e.note_d)||0;break;case"MIL":i=Number(e.note_m)||0;break;case"ATT":i=Number(e.note_a)||0;break;default:i=0}return i+(e.boost||0)}const ln=["ATT","MIL","DEF","GK"];function Tn(e,t,i){if(!e||!t)return!1;if(i&&e.position&&t.position)return Ni(i).some(([l,f])=>l===e.position&&f===t.position||l===t.position&&f===e.position);const n=e._col!=null&&t._col!=null&&e._col===t._col,r=e._col!=null&&t._col!=null&&Math.abs(e._col-t._col)===1,o=ln.indexOf(e._line||e.job),a=ln.indexOf(t._line||t.job),s=Math.abs(o-a)===1;return(e._line||e.job)===(t._line||t.job)&&r||n&&s}function In(e,t){let i=0;const n=e.length;for(let r=0;r<n;r++)for(let o=r+1;o<n;o++){const a=e[r],s=e[o];if(!a||!s||!Tn(a,s,t))continue;const d=Ot(a,s);d==="#00ff88"?i+=10:d==="#FFD700"&&(i+=5)}return i}function ti(e,t={},i){let n=0,r=0;e.forEach(d=>{const c=d._line||d.job,l=Number(c==="MIL"?d.note_m:d.note_a)||0,f=d.stadiumBonus&&(c==="MIL"||c==="ATT")?10:0;n+=t.doubleAttack?l*2:l,r+=(d.boost||0)+f});const o=n+r,a=In(e,i);let s=o+a;return t.stolenNote&&(s-=t.stolenNote),{base:o,links:a,total:Math.max(0,s)}}function ii(e,t={},i){const n=e.reduce((a,s)=>{const d=s._line||s.job;let c=0;d==="GK"?c=Number(s.note_g)||0:d==="MIL"?c=Number(s.note_m)||0:c=Number(s.note_d)||0;const l=s.stadiumBonus&&(d==="GK"||d==="DEF"||d==="MIL")?10:0;return a+c+(s.boost||0)+l},0),r=In(e,i);let o=n+r;return t.stolenNote&&(o-=t.stolenNote),{base:n,links:r,total:Math.max(0,o)}}function Ki(e,t,i={}){return i.shield?{goal:!1,shielded:!0}:{goal:e>t,shielded:!1}}function Sn(e,t,i="easy"){const n=e.filter(a=>!a.used);if(!n.length)return[];const r=[...n].sort((a,s)=>{const d=t==="attack"?Pe(a,"ATT"):a._line==="GK"?Pe(a,"GK"):Pe(a,"DEF");return(t==="attack"?Pe(s,"ATT"):s._line==="GK"?Pe(s,"GK"):Pe(s,"DEF"))-d});let o=i==="easy"?1+Math.floor(Math.random()*2):i==="medium"?2+Math.floor(Math.random()*2):3;return r.slice(0,Math.min(o,r.length,3))}function ko(e,t){const i={vs_ai_easy:{victoire:500,nul:250,defaite:50},vs_ai_medium:{victoire:1e3,nul:500,defaite:50},vs_ai_hard:{victoire:1500,nul:750,defaite:100},vs_ai_club:{victoire:2500,nul:1250,defaite:100}};return(i[e]||i.vs_ai_easy)[t]||0}const $o={pepite:{win:2,loss:-1,boosterStart:"min"},papyte:{win:1,loss:-2,boosterStart:"max"}};function Eo(e,t){const i=e.player;if(!i)return 0;const n=i.rarity;if(n!=="pepite"&&n!=="papyte")return Number(i[t])||0;const r=An(i),o=Number(i[t])||0;if(o<=0)return 0;const a=i.note_min??1,s=i.note_max??10,c=(e.current_note??r)-r;return Math.min(s,Math.max(a,o+c))}function An(e){const t=e.job||"ATT";return Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}async function Lo(e,t){!e||!t||await Promise.all([cn(e,"win"),cn(t,"loss")])}async function cn(e,t){const{data:i}=await v.from("cards").select("id, current_note, player:players(rarity, job, note_g, note_d, note_m, note_a, note_min, note_max)").eq("owner_id",e).eq("card_type","player");if(!(i!=null&&i.length))return;const n=i.filter(r=>{var o,a;return((o=r.player)==null?void 0:o.rarity)==="pepite"||((a=r.player)==null?void 0:a.rarity)==="papyte"});n.length&&await Promise.all(n.map(r=>{const o=$o[r.player.rarity],a=t==="win"?o.win:o.loss,s=r.player.note_min??1,d=r.player.note_max??10,c=An(r.player),l=r.current_note??c,f=Math.min(d,Math.max(s,l+a));return v.from("cards").update({current_note:f}).eq("id",r.id)}))}const To={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"},$i={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},ai=["GK","DEF","MIL","ATT"],Io=["Tous","GK","DEF","MIL","ATT"],So={normal:1e3,pepite:5e3,papyte:5e3,legende:1e4};function pn(e){const t=e.player;if(!t)return null;const i=t.rarity;return(i==="pepite"||i==="papyte")&&e.current_note!=null?e.current_note:Math.max(Number(t.note_g)||0,Number(t.note_d)||0,Number(t.note_m)||0,Number(t.note_a)||0)}function Ao(e){return e.length?e.reduce((t,i)=>pn(i)>pn(t)?i:t,e[0]):e[0]}function zo(e){return e==="GK"?"note_g":e==="DEF"?"note_d":e==="MIL"?"note_m":"note_a"}const Mo={MA:"MAROC",FR:"FRANCE",AR:"ARGENTINE",PT:"PORTUGAL",BR:"BRESIL",ES:"ESPAGNE",DE:"ALLEMAGNE",GB:"ANGLETERRE",IT:"ITALIE",CM:"CAMEROUN",SN:"SENEGAL",NG:"NIGERIA",DK:"DANEMARK",NL:"PAYS-BAS",BE:"BELGIQUE",CI:"CÔTE D'IVOIRE",AL:"ALBANIE",HR:"CROATIE",RS:"SERBIE",TR:"TURQUIE"};function Co(e){const t="https://fcnwclxlkytdfjotqkta.supabase.co";if(!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Ei(e,t){return e&&Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0}function Li(e,t=""){const i=e.player;if(!i)return"";const n=e.evolution_bonus||0,r={...i,_evolution_bonus:n},o=t?`<div style="position:absolute;top:6px;right:6px;z-index:10;background:#0a3d1e;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 7px">${t}</div>`:"";return`<div style="position:relative;display:inline-block;cursor:pointer" data-card-id="${e.id}">
    ${o}
    ${Ie(r,{width:140})}
    ...
    ${Ie(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter($=>$.card_type==="player"&&$.player),l=(s||[]).filter($=>$.card_type==="game_changer"),f=(s||[]).filter($=>$.card_type==="formation"),x=(s||[]).filter($=>$.card_type==="stadium"),{data:g}=await v.from("gc_definitions").select("name,gc_type,color,effect,image_url"),y={};(g||[]).forEach($=>{y[$.name]=$});const{data:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),u={};(p||[]).forEach($=>{u[$.id]=$}),x.forEach($=>{$.stadium_def&&(u[$.stadium_id]=$.stadium_def)});const b=Object.keys(Ri),_=Object.keys(je),h={};c.forEach($=>{const N=$.player.id;h[N]=(h[N]||0)+1}),new Set(Object.keys(h).map($=>String($)));const E=new Set(f.map($=>$.formation)),m=new Set(l.map($=>$.gc_type));let z="player",k="Tous",A="",q=!1;function ie(){return[...c].sort(($,N)=>{const V=ai.indexOf($.player.job),H=ai.indexOf(N.player.job);return V!==H?V-H:($.player.surname_real||"").localeCompare(N.player.surname_real||"")})}function ne(){return[...d||[]].sort(($,N)=>{const V=ai.indexOf($.job),H=ai.indexOf(N.job);return V!==H?V-H:($.surname_real||"").localeCompare(N.surname_real||"")})}function Z(){return ie().filter($=>{const N=$.player,V=k==="Tous"||N.job===k,H=!A||`${N.firstname} ${N.surname_real}`.toLowerCase().includes(A);return V&&H})}function j(){return ne().filter($=>{const N=k==="Tous"||$.job===k,V=!A||`${$.firstname} ${$.surname_real}`.toLowerCase().includes(A);return N&&V})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:0 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none;align-items:center"></div>
  ...
  </div>`,function(N){const V=document.getElementById(N);if(!V)return;V.addEventListener("wheel",ce=>{Math.abs(ce.deltaY)<=Math.abs(ce.deltaX)||(ce.preventDefault(),V.scrollLeft+=ce.deltaY)},{passive:!1});let H=!1,re=0,B=0,R=!1,ue=!1;V.addEventListener("mousedown",ce=>{H=!0,R=!1,re=ce.pageX,B=V.scrollLeft}),window.addEventListener("mouseup",()=>{H=!1,R&&(V.style.cursor="",ue=!0),R=!1}),window.addEventListener("mousemove",ce=>{if(!H)return;const ve=ce.pageX-re;!R&&Math.abs(ve)<6||(R=!0,V.style.cursor="grabbing",ce.preventDefault(),V.scrollLeft=B-ve)}),V.addEventListener("click",ce=>{ue&&(ce.stopPropagation(),ce.preventDefault(),ue=!1)},!0)}("col-grid");function I(){const $=document.getElementById("col-filters");$&&(z==="player"?($.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{q=!q,I(),K()})))}function K(){const $=document.getElementById("col-grid");$&&(z==="player"?Y($):z==="formation"?pe($):z==="stadium"?O($):G($))}function X($,N,V,H,re,B=0){const R=document.getElementById("col-grid"),ue=document.getElementById("col-big");if(!R||!ue)return;var ce=0;function ve(){var lt;const Se=window.innerWidth>=768,he=document.getElementById("col-big"),Te=document.getElementById("col-gap"),Ae=((lt=document.getElementById("col-grid"))==null?void 0:lt.parentElement)||null,Be=he?he.closest(".page"):null;if(he&&Ae&&Be){let $e=0;Array.from(Be.children).forEach(function(C){C!==he&&C!==Ae&&C!==Te&&($e+=C.offsetHeight)});const Ce=Math.max(0,Be.clientHeight-$e),qe=Math.round(Ce*(B/100)),Ge=Math.max(0,Ce-qe),w=Se?50/71:45/63,L=Math.round(Ge*w),S=Math.max(0,Ge-L);Te&&(Te.style.height=qe+"px"),he.style.flex="none",he.style.height=L+"px",he.style.minHeight="0",Ae.style.flex="none",Ae.style.height=S+"px",Ae.style.minHeight="0",Ae.style.display="flex",Ae.style.overflow="hidden"}const ke=document.getElementById("col-grid");ke&&(ke.style.height="100%",ke.style.flexShrink="0",ke.style.overflowX="auto",ke.style.overflowY="hidden",ke.style.alignItems="center",ke.style.width="100%"),ue.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:center center">'+N($[ce])+"</div>";var vt=ue.querySelector("[data-card-id],[data-form-id],[data-gc-id]");vt&&vt.addEventListener("click",function(){H($[ce])}),requestAnimationFrame(function(){var $e=document.getElementById("big-card-inner");if(!(!$e||!ue)){var Ce=ue.clientHeight,qe=ue.clientWidth-16,Ge=$e.offsetHeight,w=$e.offsetWidth;if(Ge>0&&w>0&&Ce>40){var L=Math.min(Ce/Ge,qe/w);$e.style.transform="scale("+L.toFixed(3)+")",$e.style.transformOrigin="center center"}}}),R.innerHTML=$.map(function($e,Ce){var qe=Ce===ce,Ge="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(qe?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Ge+'">'+V($e,qe)+"</div>"}).join(""),R.querySelectorAll(".col-mini-item").forEach(function($e){$e.addEventListener("click",function(){ce=Number($e.dataset.idx),ve(),$e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})}),requestAnimationFrame(function(){var $e=ke?ke.clientHeight:0,Ce=R.querySelector(".col-mini-item > div");if(!(!$e||!Ce)){var qe=Ce.style.zoom;Ce.style.zoom="1";var Ge=Ce.offsetHeight;if(Ce.style.zoom=qe,!(Ge<=0)){var w=$e/Ge;R.querySelectorAll(".col-mini-item > div").forEach(function(L){L.style.zoom=w.toFixed(4)})}}})}ve()}function le($){var N=window.innerWidth>=768?.76:.54,V;if(!$||$._fake){var H=$?$.player:null;if(!H)return"";V=un(H)}else V=Li($,"");return'<div style="display:inline-block;zoom:'+N+';pointer-events:none;line-height:0">'+V+"</div>"}function fe($,N,V){var H=V>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+V+"</div>":"",re=!!N,B=Si($,St[$],{width:160});return re||(B='<div style="filter:grayscale(1);opacity:0.5">'+B+"</div>"),"<div "+(N?'data-form-id="'+N.id+'"':"")+' style="position:relative;cursor:pointer">'+H+B+"</div>"}function M($,N){var V=window.innerWidth>=768?.76:.54,H=Si($,St[$],{width:140});return N||(H='<div style="filter:grayscale(1);opacity:0.45">'+H+"</div>"),'<div style="display:inline-block;zoom:'+V+';line-height:0;pointer-events:none">'+H+"</div>"}function Y($){if(q){const N=j();if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucun joueur.</div>';return}const V=N.map(H=>c.find(re=>re.player.id===H.id)||{_fake:!0,player:H,id:"fake-"+H.id});X(V,H=>H._fake?un(H.player):Li(H,""),H=>H._fake?le({player:H.player,id:"x",_fake:!0}):le(H),H=>{H._fake||fn(H,c,h,t)})}else{const N=Z();if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const V={};N.forEach(re=>{const B=re.player.id;V[B]||(V[B]=[]),V[B].push(re)});const H=Object.values(V).map(re=>Ao(re));X(H,re=>{const B=h[re.player.id]||1,R=B>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${B}</div>`:"",ce=c.filter(ve=>ve.player.id===re.player.id&&ve.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Li(re,R+ce)},re=>le(re),re=>fn(re,c,h,t))}}function pe($){const N=q?b:[...E];if(!N.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const V=N.map(H=>({formation:H,card:f.find(re=>re.formation===H)||null,owned:E.has(H)}));X(V,({formation:H,card:re,owned:B})=>fe(H,B?re:null,B?f.filter(R=>R.formation===H).length:0),({formation:H,owned:re})=>M(H,re),({card:H,owned:re})=>{re&&H&&qo(H,f,t,o)},"#1A6B3C",5)}function G($){const N=Object.keys(y),V=q?N.length?N:_:[...m];if(!V.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const H=V.map(re=>({type:re,gc:je[re]||{icon:"⚡",desc:""},def:y[re]||null,owned:m.has(re),card:l.find(B=>B.gc_type===re)||null}));X(H,({type:re,gc:B,def:R,owned:ue,card:ce})=>{var ke;const ve=(R==null?void 0:R.name)||re,Se=ue?l.filter(vt=>vt.gc_type===re).length:0,he=Se>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Se}</div>`:"",Te=(R==null?void 0:R.effect)||B.desc||"",Ae=R!=null&&R.image_url?`/icons/${R.image_url}`:((ke=R==null?void 0:R.club)==null?void 0:ke.logo_url)||(R!=null&&R.country_code?`https://flagsapi.com/${R.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);let Be=et(ve,Ae,B.icon,Te,{width:160,onClick:ue});return ue||(Be=`<div style="filter:grayscale(1);opacity:0.5">${Be}</div>`),`<div ${ue&&ce?`data-gc-id="${ce.id}" data-gc-type="${re}"`:""} style="position:relative">${he}${Be}</div>`},({type:re,gc:B,def:R,owned:ue})=>{const ce=window.innerWidth>=768?.76:.54,ve=(R==null?void 0:R.name)||re,Se=(R==null?void 0:R.effect)||B.desc||"",he=R!=null&&R.image_url?`/icons/${R.image_url}`:null;let Te=et(ve,he,B.icon,Se,{width:140});return ue||(Te=`<div style="filter:grayscale(1);opacity:0.45">${Te}</div>`),`<div style="display:inline-block;zoom:${ce};line-height:0;pointer-events:none">${Te}</div>`},({type:re,owned:B,def:R})=>{B&&Bo(re,R,o)},"#7a28b8",5)}function O($){const N="#4FC3F7",V="/";if(!x.length){$.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--tile-fg-dim)">Aucune carte Stade.<br><small>Ouvre un booster Stade !</small></div>';return}const H={};x.forEach(B=>{const R=B.stadium_id||"?";(H[R]=H[R]||[]).push(B)});const re=Object.entries(H).map(([B,R])=>({sid:B,def:u[B]||null,count:R.length,card:R[0]}));X(re,({def:B,count:R})=>{var Te,Ae;const ue=(B==null?void 0:B.name)||"?",ce=((Te=B==null?void 0:B.club)==null?void 0:Te.encoded_name)||(B==null?void 0:B.country_code)||"—",ve=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((Ae=B==null?void 0:B.club)==null?void 0:Ae.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Se=R>1?`<div style="position:absolute;top:8px;right:8px;background:#333;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${R}</div>`:"",he=`${ce}<br>+10 ⭐ joueurs alliés`;return`<div style="position:relative">${Se}${Qt(ue,ve,he,{width:160})}</div>`},({def:B})=>{var he,Te;const R=window.innerWidth>=768?.76:.54,ue=(B==null?void 0:B.name)||"?",ce=((he=B==null?void 0:B.club)==null?void 0:he.encoded_name)||(B==null?void 0:B.country_code)||"—",ve=B!=null&&B.image_url?`${V}icons/${B.image_url}`:((Te=B==null?void 0:B.club)==null?void 0:Te.logo_url)||(B!=null&&B.country_code?`https://flagsapi.com/${B.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null),Se=`${ce}<br>+10 ⭐`;return`<div style="display:inline-block;zoom:${R};line-height:0;pointer-events:none">${Qt(ue,ve,Se,{width:140})}</div>`},null,N,5)}e.querySelectorAll(".col-tab-btn").forEach($=>{$.addEventListener("click",()=>{z=$.dataset.tab,k="Tous",A="",q=!1,e.querySelectorAll(".col-tab-btn").forEach(N=>{const V=N.dataset.tab===z;N.style.borderBottomColor=V?"var(--green)":"transparent",N.style.color=V?"var(--green)":"var(--tile-fg-dim)"}),I(),K()})}),I(),K()}function Bo(e,t,i){const n=je[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.name)||e,o=(t==null?void 0:t.effect)||n.desc,a=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
      ${et(r,a,n.icon,o,{width:200})}
      <div style="background:#fff3cd;border-radius:10px;padding:10px 14px;width:100%">
        <div style="font-size:12px;color:#856404">⚠️ Cette carte est à <b>usage unique</b>. Une fois jouée en match, elle est définitivement supprimée de ta collection.</div>
      </div>
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const si=1e3;function qo(e,t,i,n){var y,p,u;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:d}=i,c=e.formation,l={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function f(){const b=St[c]||{},_=Ri[c]||[],h=290,E=360,m=20;function z(A){const q=b[A];return q?{x:q.x*h,y:q.y*E}:null}let k=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[A,q]of _){const ie=z(A),ne=z(q);!ie||!ne||(k+=`<line x1="${ie.x}" y1="${ie.y}" x2="${ne.x}" y2="${ne.y}"
    ...
    <div style="margin-top:12px;border-top:1px solid var(--tile-border);padding-top:12px">
      ...
      <div style="display:flex;gap:8px">
        <input type="number" id="sell-price-form" min="1" placeholder="Prix en crédits" value="${si}"
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(y=document.getElementById("direct-sell-form-btn"))==null||y.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${c} pour ${si.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const b=x.find(h=>!h.is_for_sale)||x[0];if(!b){o("Aucune carte à vendre","error");return}await v.from("market_listings").delete().eq("card_id",b.id),await v.from("transfer_history").delete().eq("card_id",b.id);const{error:_}=await v.from("cards").delete().eq("id",b.id);if(_){o(_.message,"error");return}await v.from("users").update({credits:(r.profile.credits||0)+si}).eq("id",r.profile.id),await d(),o(`+${si.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const b=parseInt(document.getElementById("sell-price-form").value);if(!b||b<1){o("Prix invalide","error");return}await v.from("cards").update({is_for_sale:!0,sale_price:b}).eq("id",e.id),await v.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:b}),o("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(u=document.getElementById("cancel-sell-form-btn"))==null||u.addEventListener("click",async()=>{await v.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await v.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),s("collection")})}async function fn(e,t,i,n){var le,fe,M,Y,pe;const{state:r,toast:o,openModal:a,closeModal:s,navigate:d,refreshProfile:c}=n,l=e.player,f=t.filter(G=>G.player.id===l.id),x=f.length,g=e.evolution_bonus||0,y=Math.max((Number(l.note_g)||0)+(l.job==="GK"||l.job2==="GK"?g:0),(Number(l.note_d)||0)+(l.job==="DEF"||l.job2==="DEF"?g:0),(Number(l.note_m)||0)+(l.job==="MIL"||l.job2==="MIL"?g:0),(Number(l.note_a)||0)+(l.job==="ATT"||l.job2==="ATT"?g:0)),p=l.rarity||"normal",{data:u}=await v.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",y).gte("note_max",y).order("note_min",{ascending:!1}).limit(1);((le=u==null?void 0:u[0])==null?void 0:le.price)??So[p];const b=l.rarity!=="legende";Co(l);const _=((l.rarity==="pepite"||l.rarity==="papyte")&&e.current_note!=null?e.current_note:Ei(l,l.job))+g,h=l.rarity==="pepite"||l.rarity==="papyte",E=l.job2?(h?Eo(e,zo(l.job2)):Ei(l,l.job2))+(Ei(l,l.job2)>0?g:0):null;$i[l.job],l.job2&&$i[l.job2];const m=To[l.rarity]||"#ccc";Mo[l.country_code]||l.country_code;const z=e.evolution_bonus||0,A=_+z,q=E||0,ie=q>0?q+z:0,ne=f.map(G=>G.id);let Z={};if(ne.length){const{data:G}=await v.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",ne).order("transferred_at",{ascending:!0});(G||[]).forEach(O=>{Z[O.card_id]||(Z[O.card_id]=[]),Z[O.card_id].push(O)})}const j=G=>{const O=G.transferred_at?new Date(G.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",$=G.source==="booster"?"Booster":G.price?G.price.toLocaleString("fr"):"—";return`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",l.note_g],["DEF",l.note_d],["MIL",l.note_m],["ATT",l.note_a]].map(([G,O])=>{const $=$i[G],N=G==="GK"?"#fff":$,V=G===l.job||G===l.job2,H=(Number(O)||0)+(V&&z>0?z:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(fe=document.getElementById("close-detail"))==null||fe.addEventListener("click",s);let K=new Set;const X=()=>{const G=K.size,O=document.getElementById("sell-action-panel");if(!O)return;O.style.display=G>0?"block":"none",document.getElementById("sell-selected-count").textContent=G;const $=document.getElementById("evolve-btn");$&&($.textContent=`⬆️ Évoluer ${G>1?"(+"+G+")":""}`)};document.querySelectorAll(".expl-check").forEach(G=>{G.addEventListener("change",()=>{const O=G.dataset.id;G.checked?K.add(O):K.delete(O);const $=G.closest(".exemplaire-row");$&&($.style.borderColor=G.checked?"#1A6B3C":"#eee"),X()})}),document.querySelectorAll(".exemplaire-row").forEach(G=>{G.addEventListener("click",O=>{if(O.target.closest("button")||O.target.tagName==="INPUT")return;const $=G.querySelector(".expl-check");$&&!$.disabled&&($.checked=!$.checked,$.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(G=>{G.addEventListener("click",O=>{O.stopPropagation();const $=document.querySelector(`.expl-hist[data-hist="${G.dataset.idx}"]`);$&&($.style.display=$.style.display==="none"?"flex":"none")})}),(M=document.getElementById("evolve-btn"))==null||M.addEventListener("click",async()=>{if(x<=1)return;const G=[...K];if(!G.length)return;if(K.has(e.id)){const B=document.createElement("div");B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",B.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const r=o=>{n.remove(),i(o)};n.querySelector("#cm-ok").addEventListener("click",()=>r(!0)),n.querySelector("#cm-cancel").addEventListener("click",()=>r(!1)),n.addEventListener("click",o=>{o.target===n&&r(!1)})})}const pi={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}};async function Mi(e,t){const{state:i,navigate:n,toast:r}=t;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await v.from("decks").select("id,name,formation_card_id").eq("owner_id",i.profile.id).order("created_at",{ascending:!1});e.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",n.profile.id).eq("card_type","stadium"),d=(a||[]).filter(b=>b.card_type==="player"&&b.player),c=(a||[]).filter(b=>b.card_type==="formation"),l=(s||[]).filter(b=>b.card_type==="stadium"),f=[...new Set(l.map(b=>b.stadium_id).filter(Boolean))];let x={};if(l.forEach(b=>{b.stadium_def&&b.stadium_id&&(x[b.stadium_id]=b.stadium_def)}),f.length&&Object.keys(x).length<f.length){const{data:b}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(b||[]).forEach(_=>{x[_.id]=_})}const g=c.map(b=>b.formation).filter(Boolean),{data:y}=await v.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";g.length>0&&!g.includes(p)&&(p=g[0]);const u={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,stadiumCardId:o.stadium_card_id||null,slots:{},subs:[],playerCards:d,formationCards:c,stadiumCards:l,stadDefMap:x,availableFormations:g};(y||[]).forEach(b=>{b.is_starter?u.slots[b.position]=b.card_id:u.subs.includes(b.card_id)||u.subs.push(b.card_id)}),ht(t,u,i)}function ht(e,t,i){var y,p;const{navigate:n}=i;pi[t.formation];const r=yn(t.formation),o=r.filter(u=>t.slots[u]).length,a=t.availableFormations.length>0?t.availableFormations:Object.keys(pi),s=(y=t.stadiumCards)==null?void 0:y.find(u=>u.id===t.stadiumCardId),d=s&&((p=t.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=t.subs.map(u=>t.playerCards.find(b=>b.id===u)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
        ...
        <div style="width:130px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 8px;gap:12px;border-left:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="width:100%;text-align:center">
            ...
            <div id="add-stad-btn-pc" style="cursor:pointer;margin:0 auto;width:fit-content">
              ${s?(()=>{var _;const u=t.stadDefMap[s.stadium_id],b=((_=u==null?void 0:u.club)==null?void 0:_.logo_url)||(u==null?void 0:u.image_url)||null;return Qt((u==null?void 0:u.name)||"Stade",b,"+10 ⭐",{width:100})})():`<div style="width:100px;height:171px;border:2px dashed rgba(79,195,247,0.4);border-radius:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
        ...
        <div style="display:flex;gap:10px;align-items:flex-start">
          ...
          <div style="flex-shrink:0;text-align:center">
            ...
            <div id="add-stad-btn" style="cursor:pointer">
              ${s?(()=>{var _;const u=t.stadDefMap[s.stadium_id],b=((_=u==null?void 0:u.club)==null?void 0:_.logo_url)||(u==null?void 0:u.image_url)||null;return Qt((u==null?void 0:u.name)||"Stade",b,"+10⭐",{width:50})})():`<div style="width:50px;height:85px;border:2px dashed rgba(79,195,247,0.5);border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px">
  ...
  </div>`;const l=window.innerWidth>=900,f=e.querySelector(".deck-pc-layout"),x=e.querySelector(".deck-mobile-layout");f&&(f.style.display=l?"block":"none"),x&&(x.style.display=l?"none":"block"),Fo(e,t,r,i),e.querySelectorAll("#builder-back").forEach(u=>u.addEventListener("click",()=>n("decks")));const g=()=>{const{openModal:u,closeModal:b}=i,_=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    <div style="position:relative;width:${g}px;height:${y}px;margin:0 auto">
      ...
      ${b}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(z=>{z.addEventListener("click",()=>Go(z.dataset.pos,t,e,n))})}function Po(e,t,i){var a;const{openModal:n,closeModal:r}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`),(a=document.getElementById("stad-none"))==null||a.addEventListener("click",()=>{e.stadiumCardId=null,r(),ht(t,e,i)}),document.querySelectorAll(".stad-choice").forEach(s=>{s.addEventListener("click",()=>{e.stadiumCardId=s.dataset.stadId,r(),ht(t,e,i)})})}function Go(e,t,i,n){var y,p,u,b,_;const{openModal:r,closeModal:o}=n,a=e.replace(/\d+/,""),s=(y=t.stadiumCards)==null?void 0:y.find(h=>h.id===t.stadiumCardId),d=s&&((p=t.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=t.slots[e],l=c?t.playerCards.find(h=>h.id===c):null;(u=l==null?void 0:l.player)==null||u.id;const f=new Set;Object.entries(t.slots).forEach(([h,E])=>{var z;if(h===e||!E)return;const m=t.playerCards.find(k=>k.id===E);(z=m==null?void 0:m.player)!=null&&z.id&&f.add(m.player.id)}),t.subs.forEach(h=>{var m;const E=t.playerCards.find(z=>z.id===h);(m=E==null?void 0:E.player)!=null&&m.id&&f.add(E.player.id)});const x=new Set,g=t.playerCards.filter(h=>{const E=h.player;return!(E.job===a||E.job2===a)||f.has(E.id)||x.has(E.id)?!1:(x.add(E.id),!0)});g.sort((h,E)=>{const m=h.evolution_bonus||0,z=E.evolution_bonus||0,k=(a==="GK"?h.player.note_g:a==="DEF"?h.player.note_d:a==="MIL"?h.player.note_m:h.player.note_a)+(a===h.player.job||a===h.player.job2?m:0);return(a==="GK"?E.player.note_g:a==="DEF"?E.player.note_d:a==="MIL"?E.player.note_m:E.player.note_a)+(a===E.player.job||a===E.player.job2?z:0)-k}),r(`Choisir ${a} — ${e}`,`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
      ${t.slots[e]?`
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(x=document.getElementById("close-sub-selector"))==null||x.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{e.subs.push(g.dataset.cardId),r(),ht(t,e,i)})})}async function Ro(e,t){const{state:i,toast:n,navigate:r}=t,o=e.formationCards.find(d=>d.formation===e.formation),a=(o==null?void 0:o.id)||e.formationCardId;await v.from("decks").update({formation:e.formation,formation_card_id:a||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await v.from("deck_cards").delete().eq("deck_id",e.deckId);const s=[];if(Object.entries(e.slots).forEach(([d,c],l)=>{s.push({deck_id:e.deckId,card_id:c,position:d,is_starter:!0,slot_order:l})}),e.subs.forEach((d,c)=>{s.push({deck_id:e.deckId,card_id:d,position:`SUB${c+1}`,is_starter:!1,slot_order:100+c})}),s.length>0){const{error:d}=await v.from("deck_cards").insert(s);if(d){n(d.message,"error");return}}n("Deck enregistré ✅","success"),r("decks")}function yn(e){const t=pi[e]||pi["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}async function zn(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await v.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const n=i.filter(a=>!(a.available_from&&t<a.available_from||a.available_until&&t>a.available_until));if(!n.length)return[];let r=n;if(e){const a=n.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await v.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",a.map(c=>c.id)),d={};(s||[]).forEach(c=>{d[c.booster_id]=(d[c.booster_id]||0)+1}),r=n.filter(c=>c.max_per_user==null?!0:(d[c.id]||0)<c.max_per_user)}}if(!r.length)return[];const{data:o}=await v.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(o||[]).filter(s=>s.booster_id===a.id)}))}async function Oo(e,t){const{data:i}=await v.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await v.from("booster_claims").insert({user_id:e,booster_id:t})}function Ho(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,r)=>n+Number(r.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const Mn=()=>Object.keys(St),Uo=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],Ci={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function Ko(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return Ie({...t,_evolution_bonus:i},{width:140})}function Cn(e){var r;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((r=Object.entries(t).sort((o,a)=>a[1]-o[1])[0])==null?void 0:r[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function Vo(e,{state:t,navigate:i,toast:n}){var f,x,g;const r=((f=t.profile)==null?void 0:f.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await zn((x=t.user)==null?void 0:x.id)).map(Cn)}catch(y){console.warn("Erreur chargement boosters DB, fallback hardcodé",y)}o.length||(o=Uo.map(y=>({...y,rates:[],isPub:y.id==="players_pub"})));const a=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(y=>y.data||[]),s=new Set(a.filter(y=>y.card_type==="stadium").map(y=>y.stadium_id)),d=new Set(a.filter(y=>y.card_type==="formation").map(y=>y.formation)),c=new Set(a.filter(y=>y.card_type==="game_changer").map(y=>y.gc_type)),l={};for(const y of o){if(y.allow_duplicates!==!1||!((g=y.rates)!=null&&g.length))continue;const p=[...new Set((y.rates||[]).map(b=>b.card_type))];let u=!1;for(const b of p)if(b==="stadium"){const{data:_}=await v.from("stadium_definitions").select("id");if((_||[]).some(h=>!s.has(h.id))){u=!0;break}}else if(b==="game_changer"){const{data:_}=await v.from("gc_definitions").select("name").eq("is_active",!0);if((_||[]).some(h=>!c.has(h.name))){u=!0;break}}else if(b==="formation"){const{FORMATION_LINKS:_}=await _n(async()=>{const{FORMATION_LINKS:h}=await import("./special-cards-CiJC3HtT.js").then(E=>E.v);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(_).some(h=>!d.has(h))){u=!0;break}}else{u=!0;break}u||(l[y.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(y=>{y.addEventListener("click",async()=>{const p=o.find(u=>u.id===y.dataset.booster);if(p){y.style.opacity="0.5",y.style.pointerEvents="none";try{await Yo(p,{state:t,toast:n,navigate:i,container:e})}catch(u){n(u.message,"error"),y.style.opacity="",y.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(y=>{y.addEventListener("click",p=>{p.stopPropagation();const u=o.find(b=>b.id===y.dataset.boosterId);Qo(u)})})}async function Yo(e,{state:t,toast:i,navigate:n,container:r}){var f,x;if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}e.isPub&&await er();const{data:o}=await v.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),a=new Set((o||[]).filter(g=>g.card_type==="player").map(g=>g.player_id)),s=new Set((o||[]).filter(g=>g.card_type==="formation").map(g=>g.formation));let d=[],c=null;try{if((f=e.rates)!=null&&f.length)d=await ji(t.profile,e);else{const g=e.type||"player";g==="player"?d=await jn(t.profile,e.cardCount,e.cost):g==="game_changer"?d=await Bn(t.profile,e.cardCount,e.cost):g==="formation"?d=await qn(t.profile,e.cost):d=await ji(t.profile,e)}}catch(g){c=g.message||String(g),console.error("[Booster] Erreur:",g)}if(d!=null&&d.length&&e._boosterId&&await Oo(t.user.id,e._boosterId),!(d!=null&&d.length)){const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",g.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${c||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(g),(x=g.querySelector("#anim-close-err"))==null||x.addEventListener("click",()=>g.remove());return}d.forEach(g=>{g.card_type==="player"&&g.player?g.isDuplicate=a.has(g.player.id):g.card_type==="formation"&&(g.isDuplicate=s.has(g.formation))});const{data:l}=await v.from("users").select("*").eq("id",t.profile.id).single();l&&(t.profile=l),Dn(d,e,n)}function Wo(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function ft(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function Xo(e,t){let i;switch(t){case"legende":i=e.filter(n=>n.rarity==="legende"),i.length||(i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte")),i.length||(i=e.filter(n=>ft(n)>=6));break;case"special":i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte"),i.length||(i=e.filter(n=>ft(n)>=6));break;case"normal_high":i=e.filter(n=>n.rarity==="normal"&&ft(n)>=6),i.length||(i=e.filter(n=>ft(n)>=6));break;default:i=e.filter(n=>n.rarity==="normal"&&ft(n)>=1&&ft(n)<=5),i.length||(i=e.filter(n=>n.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function ji(e,t){if(t.cost>0){const{error:x}=await v.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(x)throw x}const i=t.allow_duplicates!==!1;let n=[];const{data:r,error:o}=await v.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.id);if(o){const{data:x}=await v.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",e.id);n=x||[]}else n=r||[];const a=new Set(n.filter(x=>x.card_type==="player").map(x=>x.player_id)),s=new Set(n.filter(x=>x.card_type==="formation").map(x=>x.formation)),d=new Set(n.filter(x=>x.card_type==="game_changer").map(x=>x.gc_type)),c=new Set(n.filter(x=>x.card_type==="stadium").map(x=>x.stadium_id).filter(Boolean)),l=new Set,f=[];for(let x=0;x<(t.cardCount||5);x++){const g=Ho(t.rates);if(g){if(g.card_type==="player"){const y=k=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[k]||k,p=g.rarity?y(g.rarity):null;let u=v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);p&&(u=u.eq("rarity",p));const{data:b}=await u;let _=b||[];if((g.note_min||g.note_max)&&(_=_.filter(k=>{const A=Math.max(Number(k.note_g)||0,Number(k.note_d)||0,Number(k.note_m)||0,Number(k.note_a)||0);return(!g.note_min||A>=g.note_min)&&(!g.note_max||A<=g.note_max)})),_.length||(g.note_min||g.note_max?(_=b||[],console.warn("[Booster] Aucun joueur avec note",g.note_min,"-",g.note_max,"— fallback rareté uniquement")):_=b||[]),!_.length)continue;let h=_.filter(k=>!l.has(k.id));if(i)h.length||(h=_);else if(h=h.filter(k=>!a.has(k.id)),!h.length)continue;const E=h[Math.floor(Math.random()*h.length)];l.add(E.id);const m=a.has(E.id),{data:z}=await v.from("cards").insert({owner_id:e.id,player_id:E.id,card_type:"player"}).select().single();z&&(f.push({...z,player:E,isDuplicate:m}),v.rpc("record_transfer",{p_card_id:z.id,p_player_id:E.id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(g.card_type==="game_changer"){const{data:y}=await v.from("gc_definitions").select("id,name,color,effect,image_url,gc_type").eq("is_active",!0).eq("gc_type","game_changer"),p=y!=null&&y.length?y:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],u=i?p:p.filter(E=>!d.has(E.name));if(!i&&!u.length)continue;const b=u[Math.floor(Math.random()*u.length)],_=b.name,{data:h}=await v.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:_,gc_definition_id:b.id||null}).select().single();h&&f.push({...h,_gcDef:b})}else if(g.card_type==="formation"){const y=Mn(),p=i?y:y.filter(h=>!s.has(h));if(!i&&!p.length)continue;const u=p[Math.floor(Math.random()*p.length)],b=s.has(u),{data:_}=await v.from("cards").insert({owner_id:e.id,card_type:"formation",formation:u}).select();_!=null&&_[0]&&f.push({..._[0],isDuplicate:b})}else if(g.card_type==="stadium"){const{data:y,error:p}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(p){console.error("[Booster] stadium_definitions:",p.message);continue}if(!(y!=null&&y.length)){console.warn("[Booster] Aucun stade en DB");continue}const u=i?y:y.filter(E=>!c.has(E.id));if(!i&&!u.length)continue;const b=u[Math.floor(Math.random()*u.length)],{data:_,error:h}=await v.from("cards").insert({owner_id:e.id,card_type:"stadium",stadium_id:b.id}).select("id,card_type,stadium_id").single();if(h){console.error("[Booster] insert stadium card:",h.message);continue}_&&f.push({..._,rarity:"normal",_stadiumDef:b})}}}return f}async function jn(e,t,i){if(i>0){const{error:c}=await v.from("users").update({credits:e.credits-i}).eq("id",e.id);if(c)throw c}const{data:n}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(n!=null&&n.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const r=n.filter(c=>c.job==="GK"),o=n.filter(c=>c.job!=="GK"),a=!e.first_booster_opened&&r.length>0,s=[];for(let c=0;c<t;c++){const l=c===0&&a?r:c===0?o:n,f=Wo(),x=Xo(l,f);x&&s.push(x)}a&&await v.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:d}=await v.from("cards").insert(s.map(c=>({owner_id:e.id,player_id:c.id,card_type:"player"}))).select();return(d||[]).forEach((c,l)=>{v.rpc("record_transfer",{p_card_id:c.id,p_player_id:s[l].id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),s.map((c,l)=>({...d[l],player:c}))}async function Bn(e,t,i){const{error:n}=await v.from("users").update({credits:e.credits-i}).eq("id",e.id);if(n)throw n;const{data:r}=await v.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),o=r!=null&&r.length?r:Object.keys(Ci).map(f=>({name:f,gc_type:"game_changer"})),a=Array.from({length:t},()=>o[Math.floor(Math.random()*o.length)]),s=a.map(f=>({owner_id:e.id,card_type:"game_changer",gc_type:f.name,gc_definition_id:f.id||null})),{data:d,error:c}=await v.from("cards").insert(s).select();return c&&console.error("[Booster GC] Erreur insert:",c.message,c),(d||[]).map((f,x)=>({...f,_gcDef:a[x]||null}))}async function qn(e,t){const{error:i}=await v.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const{data:n}=await v.from("cards").select("formation").eq("owner_id",e.id).eq("card_type","formation"),r=new Set((n||[]).map(l=>l.formation)),o=Mn(),a=o[Math.floor(Math.random()*o.length)],s=r.has(a),{data:d,error:c}=await v.from("cards").insert({owner_id:e.id,card_type:"formation",formation:a}).select();return c&&console.error("[Booster Formation] Erreur insert:",c.message,c),(d||[]).map(l=>({...l,isDuplicate:s}))}function Dn(e,t,i,n=null){var Z,j;if(!e||e.length===0){const I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",I.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.5)">Erreur lors du tirage (permissions DB ou colonne manquante)</div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(I),(Z=I.querySelector("#anim-close-err"))==null||Z.addEventListener("click",()=>I.remove());return}e=[...e].sort((I,K)=>{const X=I.player?ft(I.player):-1;return(K.player?ft(K.player):-1)-X});const r=document.createElement("div");r.id="booster-anim-overlay",r.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function er(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const n=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(n),t.remove(),e(!0))},1e3)})}async function tr(e,{state:t,navigate:i,toast:n,refreshProfile:r}){var x,g;const{data:o}=await v.from("users").select("*").eq("id",t.user.id).single();o&&(t.profile=o);let a=Array.isArray((x=t.profile)==null?void 0:x.pending_boosters)?[...t.profile.pending_boosters]:[];if(!a.length){await v.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let s=null;try{const p=(await zn()).find(u=>(u.name||"").toLowerCase().includes("new player"));p&&(s=Cn(p))}catch(y){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',y)}const d=a.length;let c=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
  ...
  </div>`;const l=async()=>{await v.from("users").update({pending_boosters:a}).eq("id",t.user.id)};async function f(){var _;if(c>=d||!a.length){await v.from("users").update({pending_boosters:[],onboarding_done:!0}).eq("id",t.user.id),r&&await r(),n("Tous tes boosters sont ouverts ! Bon jeu 🎮","success",4e3),i("home");return}const y=a[0],{data:p}=await v.from("users").select("*").eq("id",t.user.id).single();p&&(t.profile=p);let u=[];try{if(y.type==="formation")u=await qn(t.profile,0);else if(y.type==="game_changer")u=await Bn(t.profile,y.count||3,0);else if(s&&((_=s.rates)!=null&&_.length)){const h={...s,cost:0,cardCount:y.count||s.cardCount||5};u=await ji(t.profile,h),y.guaranteeGK&&!t.profile.first_booster_opened&&(u.some(m=>m.player&&m.player.job==="GK")||await ir(t.profile,u),await v.from("users").update({first_booster_opened:!0}).eq("id",t.profile.id))}else u=await jn(t.profile,y.count||5,0)}catch(h){n(h.message||"Erreur ouverture booster","error");return}a.shift(),c++,await l();const b=y.type==="formation"?{name:"Booster Formation",img:"/icons/booster-formation.png"}:y.type==="game_changer"?{name:"Booster Game Changer",img:"/icons/booster-gamechanger.png"}:{name:`Booster Joueurs (${c}/${d})`,img:(s==null?void 0:s.img)||"/icons/booster-players.png"};Dn(u,b,i,()=>{f()})}(g=document.getElementById("onboard-start"))==null||g.addEventListener("click",()=>f())}async function ir(e,t){try{const{data:i}=await v.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0).eq("job","GK");if(!(i!=null&&i.length))return;const n=i[Math.floor(Math.random()*i.length)],r=t.findIndex(a=>a.player);if(r===-1)return;const o=t[r];await v.from("cards").update({player_id:n.id}).eq("id",o.id),t[r]={...o,player_id:n.id,player:n}}catch(i){console.warn("[Onboarding] ensureGK échec",i)}}const Gt={"4-3-3 (3)":{GK:1,DEF:4,MIL:3,ATT:3},"5-3-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-3-3 (4)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-2-1":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (2)":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3":{GK:1,DEF:4,MIL:3,ATT:3},"4-3-3 (5)":{GK:1,DEF:4,MIL:3,ATT:3},"5-2-2-1":{GK:1,DEF:5,MIL:2,ATT:3},"4-3-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"5-2-1-2":{GK:1,DEF:5,MIL:3,ATT:2},"4-5-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"4-5-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-4-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2},"4-4-1-1":{GK:1,DEF:4,MIL:4,ATT:2},"4-1-2-1-2":{GK:1,DEF:4,MIL:4,ATT:2},"3-4-1-2":{GK:1,DEF:3,MIL:5,ATT:2},"3-4-2-1":{GK:1,DEF:3,MIL:4,ATT:3},"3-5-2":{GK:1,DEF:3,MIL:5,ATT:2},"4-1-4-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-2-2":{GK:1,DEF:4,MIL:4,ATT:2},"4-2-3-1":{GK:1,DEF:4,MIL:5,ATT:1},"4-2-3-1 (2)":{GK:1,DEF:4,MIL:5,ATT:1},"3-4-3":{GK:1,DEF:3,MIL:4,ATT:3},"4-1-2-1-2 (2)":{GK:1,DEF:4,MIL:4,ATT:2}},nr={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Lt(e,t,i,n,r){var o;e.innerHTML=`<div class="match-screen" style="display:flex;align-items:center;justify-content:center;min-height:100vh">
    <div style="text-align:center;padding:40px;color:#fff">
      <div style="font-size:48px;margin-bottom:16px">${t}</div>
      <p style="margin-bottom:16px">${i}</p>
      <button class="btn btn-primary" id="msg-btn">${n}</button>
    </div>
  </div>`,(o=document.getElementById("msg-btn"))==null||o.addEventListener("click",r)}function ni(e){if(e!=null&&e.face){const n=(typeof import.meta<"u"?"/":null)||"/",r=e.face.replace(/^public\//,"").replace(/^\//,"");return n+r}const t=typeof import.meta<"u"?"https://fcnwclxlkytdfjotqkta.supabase.co":"";if(!t||!(e!=null&&e.skin)||!(e!=null&&e.hair))return null;const i=e.hair==="chauve"?`${e.skin}-chauve-rase`:`${e.skin}-${e.hair}-${e.hair_length}`;return`${t}/storage/v1/object/public/assets/tetes/${i}.png`}function Bi(e,t){var o,a;const i=e.player,n=e.evolution_bonus||0,r=i.job2&&Number(i[`note_${i.job2.toLowerCase()}`])||0;return{cardId:e.id,position:t||null,id:i.id,firstname:i.firstname,name:i.surname_real,country_code:i.country_code,club_id:i.club_id,job:i.job,job2:i.job2,note_g:(Number(i.note_g)||0)+(i.job==="GK"?n:0)+(i.job2==="GK"&&r>0?n:0),note_d:(Number(i.note_d)||0)+(i.job==="DEF"?n:0)+(i.job2==="DEF"&&r>0?n:0),note_m:(Number(i.note_m)||0)+(i.job==="MIL"?n:0)+(i.job2==="MIL"&&r>0?n:0),note_a:(Number(i.note_a)||0)+(i.job==="ATT"?n:0)+(i.job2==="ATT"&&r>0?n:0),evolution_bonus:n,rarity:i.rarity,skin:i.skin,hair:i.hair,hair_length:i.hair_length,face:i.face||null,clubName:((o=i.clubs)==null?void 0:o.encoded_name)||null,clubLogo:((a=i.clubs)==null?void 0:a.logo_url)||null,boost:0,used:!1,_line:null,_col:null}}function oi(e,t){if(!t||!e)return e;const{club_id:i,country_code:n}=t;return Object.values(e).forEach(r=>{Array.isArray(r)&&r.forEach(o=>{const a=i&&String(o.club_id)===String(i),s=n&&String(o.country_code)===String(n);(a||s)&&(o.stadiumBonus=!0)})}),e}function ui(e,t){if(!t||!(e!=null&&e.length))return e;const{club_id:i,country_code:n}=t;return e.forEach(r=>{if(!r)return;const o=i&&String(r.club_id)===String(i),a=n&&String(r.country_code)===String(n);(o||a)&&(r.stadiumBonus=!0)}),e}function mt(e){return e===1?[1]:e===2?[0,2]:e===3?[0,1,2]:e===4?[0,1,1,2]:e===5?[0,1,1,1,2]:[1]}function Fn(){const e=Math.random()*100;return e<10?10:e<30?5:3}function fi(e,t){const i=Gt[t]||Gt["4-4-2"],n={GK:[],DEF:[],MIL:[],ATT:[]};if(e.length&&e.every(a=>a.position)){for(const a of["GK","DEF","MIL","ATT"]){const s=e.filter(c=>c.position&&c.position.replace(/\d+$/,"")===a).sort((c,l)=>parseInt(c.position.replace(/\D+/g,""),10)-parseInt(l.position.replace(/\D+/g,""),10)).map(c=>({...c,_line:a})),d=mt(s.length);s.forEach((c,l)=>{c._col=d[l]}),n[a]=s}return n}const o=[...e];for(const a of["GK","DEF","MIL","ATT"]){const s=[];for(let c=0;c<i[a];c++){let l=o.findIndex(f=>f.job===a);if(l===-1&&(l=o.findIndex(f=>f.job2===a)),l===-1&&(l=0),o[l]){const f={...o[l],_line:a};s.push(f),o.splice(l,1)}}const d=mt(s.length);s.forEach((c,l)=>{c._col=d[l]}),n[a]=s}return n}function at(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.setProperty("display","none","important"),t.dataset.matchHidden="1"}),e&&e.style.setProperty("padding-bottom","0","important")}function tt(e){document.querySelectorAll(".top-nav, .bottom-nav").forEach(t=>{t.style.removeProperty("display"),delete t.dataset.matchHidden}),e&&e.style.removeProperty("padding-bottom")}function xi(e,t,i){const r=new Set,o=t.filter(l=>{const f=l.gc_type||l.id;return r.has(f)?!1:(r.add(f),!0)});let a=[];function s(l,f){const x=l._gcDef,g=(x==null?void 0:x.name)||l.gc_type,y=x!=null&&x.image_url?`/icons/${x.image_url}`:null,p=et(g,y,"⚡",(x==null?void 0:x.effect)||"",{width:100});return`<div class="gc-select-card" data-id="${l.id}"
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(y=>{y.addEventListener("click",()=>{const p=y.dataset.id,u=o.find(_=>_.id===p);if(!u)return;const b=a.findIndex(_=>_.gc_type===u.gc_type);b>-1?a.splice(b,1):a.length<3&&a.push(u),c()})}),(f=e.querySelector("#gc-launch"))==null||f.addEventListener("click",()=>{l&&d(a)}),(x=e.querySelector("#gc-no-gc"))==null||x.addEventListener("click",()=>d([])),(g=e.querySelector("#gc-reset"))==null||g.addEventListener("click",()=>{a.length&&(a=[],c())})}c()}function or(e,t){var r;const i=((r=t==null?void 0:t.state)==null?void 0:r.params)||{},n=e||i.matchMode||"vs_ai_easy";return n==="friend"?`Match vs ${i.friendName||"Ami"}`:n==="random"?"Match vs Random":n==="ranked"?"Match Classé":n==="mini_league"||n==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${n.replace("vs_ai_","").toUpperCase()}`}async function rr(e,t,i){const{state:n,navigate:r}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await v.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",n.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){Lt(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=o.map(x=>x.id),{data:s}=await v.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),d=[...new Set((s||[]).filter(x=>{var g,y;return((g=x.card)==null?void 0:g.card_type)==="stadium"&&((y=x.card)==null?void 0:y.stadium_id)}).map(x=>x.card.stadium_id))],c={};if(d.length){const{data:x}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",d);(x||[]).forEach(g=>{c[g.id]=g}),(s||[]).forEach(g=>{var y,p;((y=g.card)==null?void 0:y.card_type)==="stadium"&&((p=g.card)!=null&&p.stadium_id)&&(g.card._stadiumDef=c[g.card.stadium_id]||null)})}let l=0;function f(){var m,z,k,A,q,ie,ne;const x=o[l],g=(s||[]).filter(Z=>Z.deck_id===x.id),y=g.filter(Z=>{var j;return Z.is_starter&&((j=Z.card)==null?void 0:j.player)}).map(Z=>Bi(Z.card,Z.position)),p=g.find(Z=>{var j;return((j=Z.card)==null?void 0:j.card_type)==="formation"}),u=x.formation||((m=p==null?void 0:p.card)==null?void 0:m.formation)||"4-4-2";let b=y.length>=11?fi(y,u):null,_=((z=x.stadium_card)==null?void 0:z.stadium_def)||null;_&&b&&(b=oi(b,_));const h=y.length>=11;at(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    ${bi(e,t,i,n,r,o,a,s)}
  </div>`}async function hi(e,t,i,n){var z;const{state:r,navigate:o,toast:a}=t;at(e);const s=r.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return rr(e,t,i);const d=s.deckId;let c,l,f,x;try{const k=await Promise.all([v.from("decks").select("formation,name,stadium_card_id").eq("id",d).single(),v.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",d).order("slot_order")]);c=k[0].data,f=k[0].error,l=k[1].data,x=k[1].error}catch(k){console.error("[Match] Exception chargement deck:",k),Lt(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(f||x){console.error("[Match] Erreur Supabase:",f||x),Lt(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const g=(l||[]).filter(k=>{var A;return k.is_starter&&((A=k.card)==null?void 0:A.player)}).map(k=>Bi(k.card,k.position)),y=(l||[]).filter(k=>{var A;return!k.is_starter&&((A=k.card)==null?void 0:A.player)}).map(k=>Bi(k.card,k.position));if(g.length<11){Lt(e,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>o("decks"));return}const p=(l||[]).find(k=>{var A;return((A=k.card)==null?void 0:A.card_type)==="formation"}),u=(c==null?void 0:c.formation)||((z=p==null?void 0:p.card)==null?void 0:z.formation)||"4-4-2",{data:b,error:_}=await v.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await v.from("gc_definitions").select("*").eq("is_active",!0),E=(b||[]).map(k=>({...k,_gcDef:(h==null?void 0:h.find(A=>A.name===k.gc_type||A.id===k.gc_definition_id))||null}));let m=null;if(c!=null&&c.stadium_card_id){const{data:k}=await v.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if(k!=null&&k.stadium_id){const{data:A}=await v.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",k.stadium_id).single();m=A||null}}n({deckId:d,formation:u,starters:g,subsRaw:y,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:m})}function Tt(){return Math.min(window.innerWidth-40,860)}function Pt(){return Math.round(Tt()*1.1)}function Pn(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:ni(e)}}function ar(e,t,i,n="Adversaire"){yo("/sounds/match-opening.mp3",.3);const r=Tt(),o=Pt();return`
    ...
    </div>`}function Gn(e){var o,a,s;if(!e)return"";const t=d=>d?Ie({...d,_evolution_bonus:0},{width:52,role:d._line||d.job,showStad:!!d.stadiumBonus,extraNote:d.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    </div>`,document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.4s",setTimeout(()=>{r.remove(),i==null||i()},400)},1600)}function wt(e,t="rgba(0,0,0,0.85)",i=2200){const n=document.getElementById("game-toast");n&&n.remove();const r=document.createElement("div");if(r.id="game-toast",r.style.cssText=`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function Nn(e,t){const i=Pe(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function gt(e,t){return e.reduce((i,n)=>i+Nn(n,t),0)}function yt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Ot(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function mi(e,t,i,n,r){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Ot(o,e[a+1]):null,d=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return Nn(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
      ...
      <div class="duel-score-line duel-score-line-${n}" style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);opacity:0;transition:opacity .4s ease">
        Score: ${gt(e,r)} + ${yt(e)} liens = <b style="color:#fff">${gt(e,r)+yt(e)}</b>
      </div>
    </div>`}async function dr(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await hi(e,t,r,async({deckId:s,formation:d,starters:c,subsRaw:l,gcCardsEnriched:f,gcDefs:x,stadiumDef:g})=>{try{let y=fi(c,d);g&&(y=oi(y,g),ui(l,g));const p=await lr(d,o),u=p.lines||p,b=async _=>{try{const h=a==="vs_ai_club"?"club":a,{data:E,error:m}=await v.from("matches").insert({home_id:i.profile.id,away_id:null,mode:h,home_deck_id:s,status:"in_progress"}).select().single();if(m){console.error("[MatchIA] Erreur création match:",m),Lt(e,"⚠️","Impossible de créer le match ("+m.message+").","Retour",()=>t.navigate("home"));return}const z=p.stadiumDef||null;z&&u&&(oi(u,z),ui(p.subs||[],z));const k={gcDefs:x||[],matchId:E==null?void 0:E.id,mode:a,difficulty:o,formation:d,homeTeam:y,aiTeam:u,homeSubs:l,subsUsed:0,maxSubs:Math.min(l.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:z,homeScore:0,aiScore:0,gcCards:_,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};pr(e,k,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),Lt(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!f.length){b([]);return}xi(e,f,b)}catch(y){console.error("[MatchIA] Exception setup:",y),Lt(e,"⚠️","Erreur de préparation du match : "+y.message,"Retour",()=>t.navigate("home"))}})}async function lr(e,t){var u;const{data:i}=await v.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:cr(e),subs:[],gcCards:[],stadiumDef:null};const n=Gt[e]||Gt["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(b,_,h){var E,m;return o.add(b.id),{cardId:"ai-"+b.id+"-"+h,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:((E=b.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((m=b.clubs)==null?void 0:m.logo_url)||null,boost:0,used:!1,_line:_}}for(const b of["GK","DEF","MIL","ATT"]){const _=i.filter(k=>k.job===b&&!o.has(k.id)),h=i.filter(k=>k.job!==b&&!o.has(k.id)),E=[..._,...h],m=[];for(let k=0;k<n[b];k++){const A=E[k];A&&m.push(a(A,b,k))}const z=mt(m.length);m.forEach((k,A)=>{k._col=z[A]}),r[b]=m}const d=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,_)=>a(b,b.job,100+_)),f=Object.keys(je).sort(()=>Math.random()-.5).slice(0,3).map((b,_)=>{var h,E;return{id:"ai-gc-"+_,gc_type:b,name:((h=je[b])==null?void 0:h.name)||b,icon:((E=je[b])==null?void 0:E.icon)||"⚡"}}),x=Object.values(r).flat(),g={};x.forEach(b=>{b.club_id&&(g[b.club_id]=(g[b.club_id]||0)+1)});const y=(u=Object.entries(g).sort((b,_)=>_[1]-b[1])[0])==null?void 0:u[0];let p=null;if(y){const{data:b}=await v.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",y).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:r,subs:d,gcCards:f,stadiumDef:p}}function cr(e){const t=Gt[e]||Gt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let d=0;d<t[o];d++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=mt(a.length);a.forEach((d,c)=>{d._col=s[c]}),i[o]=a}return i}function pr(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const Y=t.pendingAttack;let pe="";if(t.selected.length>0){const G=t.selected.map($=>({...(t.homeTeam[$._role]||[]).find(V=>V.cardId===$.cardId)||$,_line:$._role})),O=ii(G,t.modifiers.home,t.formation);pe=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
              ...
              <div style="display:flex;justify-content:center">${Xe(G.map($=>({...$,used:!1})),"#3a7bd5",O.total,"defense",t.formation)}</div>
            ...
            <div style="display:flex;justify-content:center">${Xe((Y.players||[]).map(G=>({...G,used:!1})),"#ff6b6b",Y.total,"attack",t.formation)}</div>
            ${pe}
            ...
            <div style="display:flex;justify-content:center">${Xe(Y.map(G=>({...G,used:!1})),"#FFD700",pe.total,"attack",t.formation)}</div>
          </div>`}const M=t.log[t.log.length-1];return M?'<div style="padding:2px 4px">'+Gn(M)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3)">⏳ Match en cours...</div>'})()}
    </div>
    ...
    ${(()=>{const M=window.innerWidth>=700,Y=(B,R,ue)=>{var Ae,Be;const ce=(t.gcDefs||[]).find(ke=>ke.name===B.gc_type),ve=(ce==null?void 0:ce.name)||B.gc_type,Se=(ce==null?void 0:ce.effect)||((Ae=je[B.gc_type])==null?void 0:Ae.desc)||"",he=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,Te=((Be=je[B.gc_type])==null?void 0:Be.icon)||"⚡";return`<div class="gc-mini" data-gc-id="${B.id}" data-gc-type="${B.gc_type}" style="flex-shrink:0;cursor:pointer">
          ${et(ve,he,Te,Se,{width:R})}
        ...
        <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
          ${Nt(t.homeTeam,t.formation,t.phase,n,M?1300:Tt(),M?600:Pt(),y)}
        </div>
      </div>`;return M?`
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(M=>{var Y,pe,G;if(M.type==="duel"){const O=M.isGoal,$=M.homeScored?"#FFD700":O?"#ff6b6b":"rgba(255,255,255,0.3)",N=M.homeScored?"⚽ BUT !":O?"⚽ BUT IA !":(Y=M.homePlayers)!=null&&Y.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${O?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${$};margin-bottom:4px">
                ...
                ${(pe=M.homePlayers)!=null&&pe.length?`<div style="margin-bottom:3px">${Xe(M.homePlayers,"rgba(255,255,255,0.7)",M.homeTotal,void 0,t.formation)}</div>`:""}
                ${(G=M.aiPlayers)!=null&&G.length?`<div style="opacity:0.7">${Xe(M.aiPlayers,"#ff6b6b",M.aiTotal,void 0,t.formation)}</div>`:""}
                ...
                <div style="display:flex;align-items:center;gap:8px">
                  ${M.outPlayer?bt({...M.outPlayer,used:!0,_line:M.outPlayer.job,rarity:"normal"},38,50):""}
                  <span style="color:rgba(255,255,255,0.4);font-size:18px">→</span>
                  ${M.inPlayer?bt({...M.inPlayer,_line:M.inPlayer.job,rarity:"normal"},38,50):""}
                </div>
  ...
  </div>`;function A(){const M=e.querySelector(".match-screen");if(!M)return;const Y=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);M.style.bottom="auto",M.style.height=Y+"px",M.style.minHeight=Y+"px",M.style.maxHeight=Y+"px",M.style.overflow="hidden";const pe=e.querySelector("#mobile-action-bar"),G=e.querySelector("#mobile-play-area");pe&&G&&(G.style.paddingBottom=pe.offsetHeight+"px")}if(A(),setTimeout(A,120),setTimeout(A,400),setTimeout(A,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",A),window.visualViewport.addEventListener("scroll",A)),window.addEventListener("resize",A)),function(){const Y=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!Y)return;const pe=Y.closest("#match-terrain-wrap");pe&&(pe.style.cssText="position:relative;width:100%;height:100%;padding:0"),Y.removeAttribute("width"),Y.removeAttribute("height"),Y.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",Y.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const M=e.querySelector(".terrain-wrapper svg");if(M){const Y=M.closest("#match-terrain-wrap");Y&&(Y.style.cssText="position:relative;width:100%;height:100%;padding:0"),M.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let M=!1,Y=30;const pe=()=>document.getElementById("match-timer"),G=()=>{const O=pe();if(!O)return;const $=String(Math.floor(Y/60)).padStart(2,"0"),N=String(Y%60).padStart(2,"0");O.textContent=` ${$}:${N}`,O.style.color=M?"#ff2222":"#ff9500",O.style.fontWeight="900"};G(),t._timerInt=setInterval(()=>{if(Y--,Y<0)if(!M)M=!0,Y=15,G();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const O=document.createElement("div");O.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",O.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(O),setTimeout(()=>{O.remove(),xt(e,t,i)},2500)}else G()},1e3)}(ie=document.getElementById("match-quit"))==null||ie.addEventListener("click",()=>{tt(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,xt(e,t,i))}),(ne=document.getElementById("view-ai"))==null||ne.addEventListener("click",()=>kr(t,i)),(Z=document.getElementById("toggle-history"))==null||Z.addEventListener("click",()=>{var M;(M=document.getElementById("match-history-panel"))==null||M.classList.add("open")}),(j=document.getElementById("close-history"))==null||j.addEventListener("click",()=>{var M;(M=document.getElementById("match-history-panel"))==null||M.classList.remove("open")}),(I=document.getElementById("btn-action"))==null||I.addEventListener("click",()=>{t.selected.length!==0&&(u?mr(e,t,i):b&&gr(e,t,i))}),(K=document.getElementById("btn-results"))==null||K.addEventListener("click",()=>xt(e,t,i)),(X=document.getElementById("btn-pass"))==null||X.addEventListener("click",()=>{if(t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),qi(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),xt(e,t,i);return}t.phase="ai-attack",we(e,t,i),setTimeout(()=>Yi(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(M=>{M.addEventListener("click",()=>fr(M,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(M=>{M.addEventListener("click",()=>Ti(e,t,i,null,M.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(M=>{u?M.addEventListener("click",()=>hr(M.dataset.gcId,M.dataset.gcType,e,t,i)):(M.style.opacity="0.35",M.style.cursor="default",M.addEventListener("click",()=>wt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(le=document.getElementById("boost-card"))==null||le.addEventListener("click",()=>wr(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(M=>{M.addEventListener("click",()=>Ti(e,t,i,M.dataset.subId))}),(fe=document.getElementById("sub-btn-main"))==null||fe.addEventListener("click",()=>Ti(e,t,i))}function fr(e,t,i,n){const r=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(d=>d.cardId===r);s&&t.selected.push({...s,_role:o,_line:o})}we(i,t,n)}function Vi(e,t,i){e.matchId&&v.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function mr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Vi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const a=(t.homeTeam[o._role]||[]).find(d=>d.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...a,_line:o._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=ti(n,t.modifiers.home,t.formation);t.pendingAttack={...r,players:[...n],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",we(e,t,i),setTimeout(()=>br(e,t,i),1200)}function gr(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Vi(t,i,i.state.profile.id);const n=t.stadiumDef||null,r=t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(f=>f.cardId===d.cardId)||d,l=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:d._role,stadiumBonus:l}}),o=ii(r,t.modifiers.home,t.formation);t.selected.forEach(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId);c&&(c.used=!0)});const a=Ki(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(d=>Ue(d)),homePlayers:t.selected.map(d=>{const c=(t.homeTeam[d._role]||[]).find(l=>l.cardId===d.cardId)||d;return Ue(c)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,we(e,t,i),Je(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{It(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,It(e,t,i,"home-attack")}function yr(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(d=>d.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(d=>!e.aiUsedSubIds.includes(d.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],r=i.find(d=>d.job===n.job)||i[0],o={...r,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(d=>d.cardId===n.cardId);s!==-1&&(a[s]=o),e.aiUsedSubIds.push(r.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function xr(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(r=>!e.aiUsedGc.includes(r.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),je[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function Yi(e,t,i){Vi(t,i,null),yr(t),xr(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(l=>!l.used),r=!1;if(!n.length){const l=[...t.homeTeam.MIL||[],...t.homeTeam.ATT||[]].filter(x=>!x.used),f=Rt(t.homeTeam);if(f||l.length===0){const x=(t.aiTeam.DEF||[]).filter(y=>!y.used),g=(t.aiTeam.GK||[]).filter(y=>!y.used);n=f?x.length?x:g:[...x,...g],r=!0}}const o=Sn(n,"attack",t.difficulty);if(!o.length){Di(e,t,i);return}r&&o.forEach(l=>{l._line=l._line||l.job,l.note_a=Math.max(1,Number(l.note_a)||0)});const a=ti(o,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:o,side:"ai"},o.forEach(l=>{l.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${o.map(l=>l.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(l=>!l.used),c=(t.homeSubs||[]).filter(l=>!(t.usedSubIds||[]).includes(l.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&Rt(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,gi(e,t,i,"ai",o[0]);return}t.aiScore++;const f={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(x=>Ue(x)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(f),t.pendingAttack=null,we(e,t,i),Je(f.aiPlayers,t.homeScore,t.aiScore,!1,()=>{It(e,t,i,"home-attack")});return}t.phase="defense",we(e,t,i)}function br(e,t,i){var c,l;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=Sn(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(f=>(t.aiTeam[f]||[]).filter(x=>!x.used)).length){const f=((c=t.pendingAttack)==null?void 0:c.players)||[];if(f.length===1&&(f[0]._line==="GK"||f[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,gi(e,t,i,"home",f[0]);return}t.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:f.map(y=>Ue(y)),homeTotal:((l=t.pendingAttack)==null?void 0:l.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(g),t.modifiers.ai={},t.pendingAttack=null,we(e,t,i),Je(g.homePlayers,t.homeScore,t.aiScore,!0,()=>{It(e,t,i,"ai-attack")});return}const a=r.length>0?ii(r,t.modifiers.ai,t.formation).total:0;r.forEach(f=>{f.used=!0});const s=Ki(t.pendingAttack.total,a,t.modifiers.ai),d={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(f=>Ue(f)),aiPlayers:r.map(f=>Ue(f)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)d.text="🛡️ Bouclier IA !",t.log.push(d);else if(s.goal){t.homeScore++,d.isGoal=!0,d.homeScored=!0,d.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(d),t.modifiers.ai={},t.pendingAttack=null,we(e,t,i),Je(d.homePlayers,t.homeScore,t.aiScore,!0,()=>{It(e,t,i,"ai-attack")});return}else d.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(d);t.modifiers.ai={},t.pendingAttack=null,It(e,t,i,"ai-attack")}function It(e,t,i,n){if(t.round++,!Rn(e,t,i)){if(Wi(t)){xt(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used))){Di(e,t,i);return}t.phase="attack",we(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used))){Di(e,t,i);return}t.phase="ai-attack",we(e,t,i),setTimeout(()=>Yi(e,t,i),800)}}}function Rt(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function xn(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(r=>!r.used));return t&&!i}function Rn(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(xn(t.homeTeam)&&Rt(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.homeScore++,gi(e,t,i,"home",n),!0):!1}if(xn(t.aiTeam)&&Rt(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.aiScore++,gi(e,t,i,"ai",n),!0):!1}return!1}function gi(e,t,i,n,r){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ue(r)]:[],aiPlayers:n==="ai"?[Ue(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const a=(s,d)=>new Promise(c=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${d};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,we(e,t,i),Je([Ue(r)],t.homeScore,t.aiScore,n==="home",()=>{if(Wi(t)){xt(e,t,i);return}It(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function Wi(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used));return!t&&!i}function qi(e,t){return!(["MIL","ATT"].some(r=>(e[r]||[]).some(o=>!o.used))||Rt(t)||!["MIL","ATT"].some(r=>(t[r]||[]).some(o=>!o.used)))}function Di(e,t,i){if(!Rn(e,t,i)){if(Wi(t)){xt(e,t,i);return}if(qi(t.homeTeam,t.aiTeam)&&qi(t.aiTeam,t.homeTeam)){t.log.push({text:"🏁 Plus personne ne peut attaquer — match terminé.",type:"info"}),xt(e,t,i);return}t.phase="attack",we(e,t,i)}}function Ti(e,t,i,n=null,r=null){var g,y;if(t.phase!=="attack"){wt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){wt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,u])=>(u||[]).filter(b=>b.used).map(b=>({...b,_line:b._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){wt("Aucun joueur utilisé à remplacer");return}if(!a.length){wt("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===r));const d=((g=o[s])==null?void 0:g._line)||((y=o[s])==null?void 0:y.job);let c=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===d)),l=!1;const f=document.createElement("div");f.id="sub-overlay",f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function x(){var m,z,k,A,q,ie;const p=o[s],u=a[c],b=Math.min(130,Math.round((window.innerWidth-90)/2)),_=Math.round(b*1.35),h=ne=>`background:rgba(255,255,255,0.12);border:none;color:${ne?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ne?"default":"pointer"};flex-shrink:0`;f.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${u?bt({...u,used:!1,boost:0},b,_):"<div>—</div>"}</div>
      ...
      <div id="out-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
        ...
        <div>${p?bt({...p,used:!1,boost:0},b,_):"<div>—</div>"}</div>
    ...
    </div>`,(c=a.querySelector("#gc-picker-close"))==null||c.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(f=>{f.addEventListener("click",()=>{const x=f.dataset.cid,g=e.find(p=>p.cardId===x);if(!g)return;const y=s.findIndex(p=>p.cardId===x);y>-1?s.splice(y,1):s.length<t&&s.push(g),d()})}),(l=a.querySelector("#gc-picker-confirm"))==null||l.addEventListener("click",()=>{a.remove(),o(s)})}d(),document.body.appendChild(a)}const vr={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},n,r,o)=>{const a=Object.entries(n.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,d])=>d.filter(c=>!c.used).map(c=>({...c,_line:s})));return a.length?(di(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,r,n,s=>{s.forEach(d=>{const c=(n.homeTeam[d._line]||[]).find(l=>l.cardId===d.cardId);c&&(c.boost=(c.boost||0)+e,n.log.push({text:`⚡ +${e} sur ${c.name}`,type:"info"}))}),we(r,n,o)}),!0):(n.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),we(r,n,o),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:n="ai"},r,o,a)=>{const s=n==="home"?r.homeTeam:r.aiTeam,d=n==="ai"?"adverse":"allié",c=Object.entries(s).filter(([l])=>!i.length||i.includes(l)).flatMap(([l,f])=>f.filter(x=>!x.used).map(x=>({...x,_line:l})));return c.length?(di(c,t,`Choisir ${t} joueur(s) ${d}(s) à débuffer (-${e})`,o,r,l=>{l.forEach(f=>{const g=((n==="home"?r.homeTeam:r.aiTeam)[f._line]||[]).find(y=>y.cardId===f.cardId);g&&(g.boost=(g.boost||0)-e,r.log.push({text:`🎯 -${e} sur ${g.name}${n==="ai"?" (IA)":""}`,type:"info"}))}),we(o,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${d} disponible`,type:"info"}),we(o,r,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},n,r,o)=>{const a=i==="home"?n.homeTeam:n.aiTeam,s=i==="ai"?"adverse":"allié",d=Object.entries(a).filter(([c])=>!t.length||t.includes(c)).flatMap(([c,l])=>l.filter(f=>!f.used).map(f=>({...f,_line:c})));return d.length?(di(d,e,`Choisir ${e} joueur(s) ${s}(s) à exclure`,r,n,c=>{c.forEach(l=>{const x=((i==="home"?n.homeTeam:n.aiTeam)[l._line]||[]).find(g=>g.cardId===l.cardId);x&&(x.used=!0,n.log.push({text:`❌ ${x.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),we(r,n,o)}),!0):(n.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),we(r,n,o),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,n,r)=>{const o=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,s])=>s.filter(d=>d.used).map(d=>({...d,_line:a})));return o.length?(di(o,e,`Choisir ${e} joueur(s) à ressusciter`,n,i,a=>{a.forEach(s=>{const d=(i.homeTeam[s._line]||[]).find(c=>c.cardId===s.cardId);d&&(d.used=!1,i.log.push({text:`💫 ${d.name} ressuscité !`,type:"info"}))}),we(n,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),we(n,i,r),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function _r(e,t,i,n,r){n.usedGc.push(e);const o=n.gcDefs||[],a=o.find(d=>d.name===t)||o.find(d=>{var c;return((c=d.name)==null?void 0:c.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const d=vr[a.effect_type];d?d(a.effect_params||{},n,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const d=Object.entries(n.homeTeam).flatMap(([c,l])=>(l||[]).filter(f=>f.used).map(f=>({...f,_line:c})));d.length?(d[0].used=!1,n.log.push({text:`💫 ${d[0].name} ressuscité !`,type:"info"})):n.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const d=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(c=>!c.used);if(d.length){const c=d.sort((l,f)=>Pe(f,"ATT")-Pe(l,"ATT"))[0];c.used=!0,n.log.push({text:`❄️ ${c.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}v.from("cards").delete().eq("id",e).then(()=>{}),s&&we(i,n,r)}function wr(e,t,i){const n=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(l=document.getElementById("res-home"))==null||l.addEventListener("click",()=>{c.remove(),tt(e),i.navigate("home")}),(f=document.getElementById("res-replay"))==null||f.addEventListener("click",()=>{c.remove(),tt(e),i.navigate("match",{matchMode:t.mode})})}function kr(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${bi(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=e=>Pn(e);async function At(e,t,i,n,r={}){return On(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function $r(e,t,i){const{data:n}=await v.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;let o=null,a=null;if(n.mode==="mini_league"){const{data:s}=await v.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(o=s.league_id,a=s.id)}return On(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,o,a)}async function On(e,t,i,n,r=[],o=[],a=!1,s=null,d=null,c=null,l=null,f=null){const{state:x,navigate:g,toast:y}=t,p=n?"p1":"p2",u=n?"p2":"p1",b=(r||[]).map(w=>w.id),_=(r||[]).map(w=>({id:w.id,gc_type:w.gc_type,_gcDef:w._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await v.from("matches").select("*").eq("id",i).single();if(!h){y("Match introuvable","error"),g("home");return}async function E(){var ye,be;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:w,error:L},{data:S,error:C},{data:T},{data:P}]=await Promise.all([v.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),v.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),v.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),v.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",C==null?void 0:C.message,"p1D:",(ye=w==null?void 0:w.starters)==null?void 0:ye.length,"p2D:",(be=S==null?void 0:S.starters)==null?void 0:be.length);const D=oe=>{const Ee=Number(oe.evolution_bonus)||0;return{cardId:oe.card_id,position:oe.position,id:oe.id,firstname:oe.firstname,name:oe.surname_real,country_code:oe.country_code,club_id:oe.club_id,job:oe.job,job2:oe.job2,note_g:(Number(oe.note_g)||0)+(oe.job==="GK"||oe.job2==="GK"&&Number(oe.note_g)>0?Ee:0),note_d:(Number(oe.note_d)||0)+(oe.job==="DEF"||oe.job2==="DEF"&&Number(oe.note_d)>0?Ee:0),note_m:(Number(oe.note_m)||0)+(oe.job==="MIL"||oe.job2==="MIL"&&Number(oe.note_m)>0?Ee:0),note_a:(Number(oe.note_a)||0)+(oe.job==="ATT"||oe.job2==="ATT"&&Number(oe.note_a)>0?Ee:0),evolution_bonus:Ee,rarity:oe.rarity,skin:oe.skin,hair:oe.hair,hair_length:oe.hair_length,face:oe.face||null,clubName:oe.club_encoded_name||null,clubLogo:oe.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},F=((w==null?void 0:w.starters)||[]).map(oe=>D(oe)),U=((S==null?void 0:S.starters)||[]).map(oe=>D(oe)),J=(w==null?void 0:w.formation)||"4-4-2",te=(S==null?void 0:S.formation)||"4-4-2";let ee=fi(F,J),Q=fi(U,te);const ae=((w==null?void 0:w.subs)||[]).map(oe=>D(oe)),se=((S==null?void 0:S.subs)||[]).map(oe=>D(oe)),ge=(w==null?void 0:w.stadium_def)||(n?d:null),de=(S==null?void 0:S.stadium_def)||(n?null:d);return ge&&(ee=oi(ee,ge),ui(ae,ge)),de&&(Q=oi(Q,de),ui(se,de)),{p1Team:ee,p2Team:Q,p1Subs:ae,p2Subs:se,p1Formation:J,p2Formation:te,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(P==null?void 0:P.club_name)||(P==null?void 0:P.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?_:[],gcCardsFull_p2:n?[]:_,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let m=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!m,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",x.profile.id),!m)if(n){m=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((m==null?void 0:m.p1Team)||{}));const{data:w}=await v.from("matches").select("game_state").eq("id",i).single();!(w!=null&&w.game_state)||!Object.keys(w.game_state).length?await v.from("matches").update({game_state:m,turn_user_id:h.home_id}).eq("id",i):m=w.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let w=0;w<30&&!m;w++){await new Promise(S=>setTimeout(S,400));const{data:L}=await v.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(m=L.game_state),w%5===0&&console.log("[PvP] away - poll",w,"game_state:",!!(L!=null&&L.game_state))}if(!m){y("Erreur de synchronisation","error"),g("home");return}m.gc_p2=b,m.gcCardsFull_p2=_,await v.from("matches").update({game_state:m}).eq("id",i)}let z=!1,k=null,A=!1;const q=new Set,ie=new Set;async function ne(w){var te,ee;Ft();try{v.removeChannel(Z)}catch{}const L=m[p+"Score"]||0,S=m[u+"Score"]||0;let C,T;w.winner_id?(C=w.winner_id===x.profile.id,T=!1):w.forfeit?(C=L>S,T=!1):(T=L===S,C=L>S);let P="";if(a&&n)try{const{data:Q}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:ae}=await v.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(Q&&ae){const se=C?1:T?.5:0,ge=1-se,de=Q.placement_matches<10,ye=ae.placement_matches<10,be=computeGlicko2(Q.mmr,Q.mmr_deviation,Q.mmr_volatility,ae.mmr,ae.mmr_deviation,se===1?1:se===0?0:.5,de),oe=computeGlicko2(ae.mmr,ae.mmr_deviation,ae.mmr_volatility,Q.mmr,Q.mmr_deviation,ge===1?1:ge===0?0:.5,ye);await v.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:C?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:be.delta,p_away_delta:oe.delta,p_home_new_rd:be.newRd,p_away_new_rd:oe.newRd,p_home_new_vol:be.newSigma,p_away_new_vol:oe.newSigma});const Ee=be.delta,Ne=be.newMmr,Le=getTier(Ne),Ke=Ee>=0?"+":"",Oe=Ee>=0?"#4caf50":"#ff6b6b",it=getTier(Q.mmr);P=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Le.id!==it.id?`<div style="font-size:20px;font-weight:900;color:${Le.color}">
                    ${Ne>Q.mmr?"📈":"📉"} ${it.emoji} ${it.label} → ${Le.emoji} ${Le.label}
                  </div>
      ...
      </div>`}const De=(W,me)=>me?Ht(130,222):it(W,130),Ve=(W,me)=>me?Ht(68,116):it(W,68),He=te?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",ct=D?lt(p)?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${U.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${He};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:F?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${U.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${P}</div>`,nt=D&&!lt(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':D||F?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${U.length}/3 sélectionné(s)</div>`:"",zt=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${te?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ${ae.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':ae.map(W=>`<div class="pvp-sub-btn" data-sub-id="${W.cardId}" style="cursor:pointer;flex-shrink:0">${bt(W,te?76:44,te?100:58)}</div>`).join("")}
    </div>`,pt=D?"attack":F?"defense":"idle",_t=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Nt(w,m[p+"Formation"],pt,J,te?1300:Tt(),te?600:Pt(),Oe)}
      </div>
    </div>`,ot=m[p+"Team"],Jn=(()=>{var me,ze,_e,Ct,rt;if(F&&((me=m.pendingAttack)!=null&&me.players)){const Fe=m.pendingAttack;let Re="";if(U.length>0){const Me=U.map(Ye=>{const Ut=(ot[Ye._role]||[]).find(wi=>wi.cardId===Ye.cardId)||Ye,Kt=ot[Ye._role]||[],ri=Kt.findIndex(wi=>wi.cardId===Ye.cardId),_i=mt(Kt.length),Vt=ri>=0?_i[ri]:Ut._col??1;return{...Ut,_line:Ye._role,_col:Vt}}),ut=ii(Me,((ze=m.modifiers)==null?void 0:ze[p])||{},m[p+"Formation"]);Re=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Xe(Me.map(Ye=>({...Ye,used:!1})),"#3a7bd5",ut.total,"defense",m[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Xe((Fe.players||[]).map(Me=>({...Me,used:!1})),"#ff6b6b",Fe.total,"attack",m[u+"Formation"])}</div>
          ${Re}
          ...
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Xe((Fe.players||[]).map(Re=>({...Re,used:!1})),"#00ff88",Fe.total,"attack",m[p+"Formation"])}</div>
        </div>`}if(D&&!((Ct=m.pendingAttack)!=null&&Ct.players)&&U.length>0){const Fe=U.map(Me=>{const ut=(ot[Me._role]||[]).find(Vt=>Vt.cardId===Me.cardId)||Me,Ye=["GK","DEF"].includes(Me._role),Ut=ot[Me._role]||[],Kt=Ut.findIndex(Vt=>Vt.cardId===Me.cardId),ri=mt(Ut.length),_i=Kt>=0?ri[Kt]:ut._col??1;return{...ut,_line:Me._role,_col:_i,...Ye?{note_a:Math.max(1,Number(ut.note_a)||0)}:{}}}),Re=ti(Fe,((rt=m.modifiers)==null?void 0:rt[p])||{},m[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Xe(Fe.map(Me=>({...Me,used:!1})),"#FFD700",Re.total,"attack",m[p+"Formation"])}</div>
        </div>`}const W=(m.log||[]).slice(-1)[0];return W?'<div style="padding:2px 4px">'+Gn(W)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),Ji=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      </button>`;at(e),e.style.overflow="hidden",te?e.innerHTML=`
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ${Ji}
        <div style="display:flex;flex:1;min-height:0;overflow:hidden">
          ${zt}
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Nt(w,m[p+"Formation"],pt,J,Tt(),Pt(),Oe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
          <div style="display:flex;gap:6px;overflow-x:auto;align-items:flex-end;min-height:96px;padding-bottom:2px">
            ${de.map(W=>Ve(W,!1)).join("")}
            ${ye?Ve(null,!0):""}
      ...
      </div>`;function Mt(){const W=e.querySelector(".match-screen");if(!W)return;const me=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);W.style.height=me+"px",W.style.minHeight=me+"px",W.style.maxHeight=me+"px",W.style.overflow="hidden";const ze=e.querySelector("#mobile-action-bar"),_e=e.querySelector("#mobile-play-area");ze&&_e&&(_e.style.paddingBottom=ze.offsetHeight+"px")}if(Mt(),setTimeout(Mt,120),setTimeout(Mt,400),A||(A=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Mt),window.visualViewport.addEventListener("scroll",Mt)),window.addEventListener("resize",Mt)),function(){const me=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!me)return;const ze=me.closest("#match-terrain-wrap");ze&&(ze.style.cssText="position:relative;width:100%;height:100%;padding:0"),me.removeAttribute("width"),me.removeAttribute("height"),me.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",me.setAttribute("preserveAspectRatio","xMidYMid meet")}(),m._pvpResizeBound||(m._pvpResizeBound=!0,window.addEventListener("resize",()=>{const W=e.querySelector(".terrain-wrapper svg");if(W){const me=W.closest("#match-terrain-wrap");me&&(me.style.cssText="position:relative;width:100%;height:100%;padding:0"),W.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(W=>{W.addEventListener("click",()=>{if(!D&&!F)return;const me=W.dataset.cardId,ze=W.dataset.role,_e=(w[ze]||[]).find(Re=>Re.cardId===me);if(!_e||_e.used)return;const Ct=Oe.includes(me);if(D&&!["MIL","ATT"].includes(ze)&&!Ct)return;Array.isArray(m["selected_"+p])||(m["selected_"+p]=[]);const rt=m["selected_"+p],Fe=rt.findIndex(Re=>Re.cardId===me);Fe>-1?rt.splice(Fe,1):rt.length<3&&rt.push({..._e,_role:ze}),Y()})}),e.querySelectorAll(".match-used-hit").forEach(W=>{W.addEventListener("click",()=>H(W.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(W=>{W.addEventListener("click",()=>H())}),(Qi=e.querySelector("#pvp-sub-open"))==null||Qi.addEventListener("click",()=>H()),e.querySelectorAll(".pvp-gc-mini").forEach(W=>{D?W.addEventListener("click",()=>N(W.dataset.gcId,W.dataset.gcType)):(W.style.opacity="0.35",W.style.cursor="default",W.addEventListener("click",()=>wt("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Zi=e.querySelector("#pvp-boost-card"))==null||Zi.addEventListener("click",()=>V()),(en=e.querySelector("#pvp-action"))==null||en.addEventListener("click",W=>{D?W.currentTarget.dataset.pass==="1"||!lt(p)?ue():Te():F&&Ae()}),(tn=e.querySelector("#pvp-quit"))==null||tn.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&I()}),(nn=e.querySelector("#pvp-view-opp"))==null||nn.addEventListener("click",()=>B()),(on=e.querySelector("#pvp-toggle-history"))==null||on.addEventListener("click",()=>R()),k&&(clearInterval(k),k=null),(D||F)&&!z){let W=30,me=!1;const ze=()=>document.getElementById("pvp-timer"),_e=()=>{ze()&&(ze().textContent=W+"s",ze().style.color=me?"#ff4444":"#fff")};_e(),k=setInterval(()=>{W--,W<0?me?(clearInterval(k),k=null,D&&!lt(p)?ue():I()):(me=!0,W=15,_e()):_e()},1e3)}}function pe(){at(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${de?bt({...de,used:!1,boost:0},ye,be):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${ge?bt({...ge,used:!1,boost:0},ye,be):"<div>—</div>"}</div>
      ...
      </div>`,(Ne=ee.querySelector("#psub-close"))==null||Ne.addEventListener("click",()=>ee.remove()),(Le=ee.querySelector("#pout-up"))==null||Le.addEventListener("click",()=>{F>0&&(F--,Q())}),(Ke=ee.querySelector("#pout-down"))==null||Ke.addEventListener("click",()=>{F<P.length-1&&(F++,Q())}),(Oe=ee.querySelector("#pin-up"))==null||Oe.addEventListener("click",()=>{J>0&&(J--,Q())}),(it=ee.querySelector("#pin-down"))==null||it.addEventListener("click",()=>{J<D.length-1&&(J++,Q())});const Ee=(De,Ve,He,ct)=>{const nt=ee.querySelector("#"+De);if(!nt)return;let zt=0;nt.addEventListener("touchstart",pt=>{zt=pt.touches[0].clientY},{passive:!0}),nt.addEventListener("touchend",pt=>{const _t=pt.changedTouches[0].clientY-zt;if(Math.abs(_t)<30)return;const ot=Ve();_t<0&&ot<ct-1?(He(ot+1),Q()):_t>0&&ot>0&&(He(ot-1),Q())},{passive:!0})};Ee("pin-panel",()=>J,De=>J=De,D.length),Ee("pout-panel",()=>F,De=>F=De,P.length),(Ht=ee.querySelector("#psub-confirm"))==null||Ht.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),te)return;te=!0;const Ve=P[F],He=D[J];if(!Ve||!He)return;const ct=Ve._line,nt=(S[ct]||[]).findIndex(_t=>_t.cardId===Ve.cardId);if(nt===-1){y("Erreur : joueur introuvable","error"),ee.remove();return}const zt={...He,_line:ct,position:Ve.position,used:!1,boost:0};S[ct].splice(nt,1,zt);const pt=[...C,He.cardId];ee.remove(),re(Ve,He,async()=>{await j({[p+"Team"]:S,[u+"Team"]:m[u+"Team"],["usedSubIds_"+p]:pt})})})}document.body.appendChild(ee),Q()}function re(w,L,S){const C={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const P=(U,J,te)=>`<div style="text-align:center">
      ...
      <div style="width:70px;height:70px;border-radius:50%;background:${C[U.job]||"#555"};border:3px solid ${J};position:relative;overflow:hidden;margin:0 auto">
        ${ni(U)?`<img src="${ni(U)}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">`:""}
      </div>
      ...
      <div style="width:min(90vw,420px)">${bi(m[u+"Team"],m[u+"Formation"],null,[],Tt(),Pt())}</div>
      ...
      </div>`,document.body.appendChild(L),(S=L.querySelector("#pvp-hist-close"))==null||S.addEventListener("click",()=>L.remove())}async function ue(){if(m.phase!==p+"-attack")return;const w=p==="p1"?"p2":"p1",L=(m.round||0)+1,S=[...m.log||[]];S.push({type:"info",text:`⏭️ ${m[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const C=$e(m),T=lt(w),P=C||!T?"finished":w+"-attack";await j({["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:P,attacker:w,round:L,log:S}),P==="finished"&&await qe(m)}function ce(w){const L=(w.GK||[]).some(C=>!C.used),S=["DEF","MIL","ATT"].some(C=>(w[C]||[]).some(T=>!T.used));return L&&!S}function ve(w){return(w.p1Score||0)!==(w.p2Score||0)?null:ce(w.p1Team)&&!ke(w.p2Team)?{side:"p1",gk:(w.p1Team.GK||[]).find(L=>!L.used)}:ce(w.p2Team)&&!ke(w.p1Team)?{side:"p2",gk:(w.p2Team.GK||[]).find(L=>!L.used)}:null}async function Se(){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(w);const L=(S,C)=>new Promise(T=>{w.innerHTML=`<div style="font-size:32px;font-weight:900;color:${C};letter-spacing:2px;animation:lcFade 1.4s ease both">${S}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(T,1400)});await L("⚽ DERNIER CORNER","#FFD700"),await L("🧤 LE GARDIEN MONTE !","#4fc3f7"),w.remove()}async function he(w,L){const{side:S,gk:C}=w;if(!C)return;const T=S+"Score",P=(L[T]||0)+1;C.used=!0;const D=[...L.log||[]];D.push({type:"duel",isGoal:!0,homeScored:S===p,homePlayers:S==="p1"?[jt(C)]:[],aiPlayers:S==="p2"?[jt(C)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[S+"Name"]} marque !`});const F=(L.round||0)+1,U=S==="p1"?"p2":"p1",J={...L,[T]:P},te=$e(J);q.add(F),await Se();const ee=S===p?P:L[p+"Score"]||0,Q=S===p?L[u+"Score"]||0:P;Je([jt(C)],ee,Q,S===p,async()=>{await j({[T]:P,log:D,round:F,pendingAttack:null,phase:te?"finished":U+"-attack",attacker:U,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}}}),te&&await qe({...m,[T]:P})})}async function Te(){const w=m[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(P=>(m[u+"Team"][P]||[]).some(D=>!D.used)),S=(m["selected_"+p]||[]).map(P=>{const D=(w[P._role]||[]).find(se=>se.cardId===P.cardId)||P,F=["GK","DEF"].includes(P._role),U=w[P._role]||[],J=U.findIndex(se=>se.cardId===P.cardId),te=mt(U.length),ee=J>=0?te[J]:D._col??1,Q=m.stadiumDef||m.homeStadiumDef||null,ae=D.stadiumBonus||Q&&(Q.club_id&&String(D.club_id)===String(Q.club_id)||Q.country_code&&D.country_code===Q.country_code)||!1;return{...D,_line:P._role,_col:ee,stadiumBonus:ae,...F?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!S.length)return;const C=ti(S,m.modifiers[p]||{},m[p+"Formation"]);fe(p,S.map(P=>P.cardId)),S.forEach(P=>{const D=(w[P._role]||[]).find(F=>F.cardId===P.cardId);D&&(D.used=!0)}),m["selected_"+p]=[],Y();const T=[...m.log||[]];if(L){if(S.length===1&&(S[0]._line==="GK"||S[0].job==="GK")&&(m.p1Score||0)===(m.p2Score||0)){await he({side:p,gk:S[0]},{...m,[p+"Team"]:w,log:T});return}const D=(m[p+"Score"]||0)+1,F=S.map(Q=>jt(Q));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:F,homeTotal:C.total,aiTotal:0});const U=(m.round||0)+1,J=p==="p1"?"p2":"p1",te={...m,[p+"Team"]:w,[p+"Score"]:D},ee=$e(te);q.add(U),Je(F,D,m[u+"Score"]||0,!0,async()=>{await j({[p+"Team"]:w,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ee?"finished":J+"-attack",attacker:J,round:U,log:T}),ee&&await qe({...m,[p+"Score"]:D})});return}T.push({type:"pending",text:`⚔️ ${m[p+"Name"]} attaque (${C.total})`}),await j({[p+"Team"]:w,[u+"Team"]:m[u+"Team"],pendingAttack:{...C,players:S,side:p},["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},phase:u+"-defense",log:T})}async function Ae(){const w=m[p+"Team"],L=(m["selected_"+p]||[]).map(de=>{const ye=(w[de._role]||[]).find(Le=>Le.cardId===de.cardId)||de,be=w[de._role]||[],oe=be.findIndex(Le=>Le.cardId===de.cardId),Ee=mt(be.length),Ne=oe>=0?Ee[oe]:ye._col??1;return{...ye,_line:de._role,_col:Ne}}),S=ii(L,m.modifiers[p]||{},m[p+"Formation"]);fe(p,L.map(de=>de.cardId)),L.forEach(de=>{const ye=(w[de._role]||[]).find(be=>be.cardId===de.cardId);ye&&(ye.used=!0)}),m["selected_"+p]=[],Y();const C=Ki(m.pendingAttack.total,S.total,m.modifiers[p]||{}),T=m.pendingAttack.side,P=C==="attack"||(C==null?void 0:C.goal),D=T==="p1"?"p2":"p1",F=(m.round||0)+1,U=(m.pendingAttack.players||[]).map(de=>jt(de)),J=[...m.log||[]];J.push({type:"duel",isGoal:P,homeScored:P&&T===p,text:P?`⚽ BUT de ${m[T+"Name"]} ! (${m.pendingAttack.total} vs ${S.total})`:`✋ Attaque stoppée (${m.pendingAttack.total} vs ${S.total})`,homePlayers:U,aiPlayers:L.map(de=>jt(de)),homeTotal:m.pendingAttack.total,aiTotal:S.total});const te=P?(m[T+"Score"]||0)+1:m[T+"Score"]||0,ee={...m,[p+"Team"]:w,[T+"Score"]:te},Q=$e(ee),ae=Q?"finished":D+"-attack",se=!Q&&!P?ve(ee):null,ge=async()=>{if(se){await he(se,ee);return}await j({[p+"Team"]:w,[u+"Team"]:m[u+"Team"],[T+"Score"]:te,["selected_"+p]:[],modifiers:{...m.modifiers,[p]:{}},pendingAttack:null,phase:ae,attacker:D,round:F,log:J}),(ae==="finished"||Q)&&await qe({...m,[T+"Score"]:te})};if(P){const de=T===p,ye=de?te:m[p+"Score"]||0,be=de?m[u+"Score"]||0:te;q.add(F),Je(U,ye,be,de,ge)}else await ge()}function Be(w){return["MIL","ATT"].some(L=>(w[L]||[]).some(S=>!S.used))}function ke(w){return["GK","DEF","MIL","ATT"].some(L=>(w[L]||[]).some(S=>!S.used))}function vt(w){return ke(w)&&!Be(w)}function lt(w){const L=m[w+"Team"],S=m[(w==="p1"?"p2":"p1")+"Team"];return!!(Be(L)||vt(L)&&!ke(S)||vt(L)&&!Be(S)&&ke(S))}function $e(w){return!ke(w.p1Team)&&!ke(w.p2Team)}function Ce(w){const L=w.p1Score||0,S=w.p2Score||0;return L===S?null:L>S?h.home_id:h.away_id}async function qe(w){Ft();try{const L=Ce(w),S=L?h.home_id===L?h.away_id:h.home_id:null,C=w.p1Score||0,T=w.p2Score||0,{data:P,error:D}=await v.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:C,p_away_score:T,p_forfeit:!1});if(D&&console.error("[PvP] finish_pvp_match:",D),l)try{await v.rpc("check_and_finish_mini_league",{p_league_id:l})}catch(F){console.error("[PvP] check_and_finish_mini_league:",F)}L&&S&&Lo(L,S).catch(()=>{});try{const{data:F}=await v.rpc("apply_match_rewards",{p_match_id:i});F!=null&&F.success&&!(F!=null&&F.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(F){console.error("[PvP] apply_match_rewards:",F)}if(typeof c=="function")try{await c({homeScore:C,awayScore:T,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(F){console.error("[PvP] onMatchEnd:",F)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Ge(){var T;const w=m[p+"Score"],L=m[u+"Score"],S=w>L,C=w===L;at(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{v.removeChannel(Z)}catch{}tt(e),l?g("mini-league",{openLeagueId:l}):g("home")})}Y()}async function Fi(e,t,i=!1){var s,d;const{state:n,navigate:r,toast:o}=t,a=i&&((d=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:d.rankedData)||null;await hi(e,t,i?"ranked":"random",async({deckId:c,formation:l,starters:f,subsRaw:x,gcCardsEnriched:g,gcDefs:y,stadiumDef:p})=>{at(e);const u=async b=>{await Lr(e,t,c,l,f,x,b||[],y,p,i,a)};if(!(g!=null&&g.length)){await u([]);return}xi(e,g,u)})}async function Er(e,t,i){return $r(e,t,i)}async function Lr(e,t,i,n,r,o,a=[],s=[],d=null,c=!1,l=null){var ne,Z;const{state:f,navigate:x,toast:g}=t,y=(l==null?void 0:l.mmr)??((ne=f.profile)==null?void 0:ne.mmr)??1e3,p=c?Oi(y):null,u=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let _=!1,h=null,E=null;e.innerHTML=`
    ...
    </div>`;const m=async()=>{_=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await v.rpc("cancel_matchmaking",{p_user_id:f.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(Z=document.getElementById("cancel-mm"))==null||Z.addEventListener("click",async()=>{await m(),tt(e),x("home")});const z=async(j,I)=>{_||(_=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await At(e,t,j,I,{myGC:a,gcDefs:s,stadiumDef:d,isRanked:c,rankedData:l,onMatchEnd:c?Tr:null}))},k=f.user.id,{data:A,error:q}=c?await v.rpc("try_matchmake_ranked",{p_user_id:k,p_deck_id:i,p_mmr:y}):await v.rpc("try_matchmake",{p_user_id:k,p_deck_id:i});if(q||!(A!=null&&A.success)){console.error("[Matchmaking] try_matchmake error:",q||A),g("Erreur de matchmaking","error"),tt(e),x("home");return}if(A.matched){await z(A.match_id,!1);return}const ie=async()=>{if(_)return;const{data:j}=await v.from("matchmaking_queue").select("status, match_id").eq("user_id",k).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await z(j.match_id,!0)};h=v.channel(`mm_${k}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${k}`},j=>{const I=j.new;I.status==="matched"&&I.match_id&&z(I.match_id,!0)}).subscribe(),E=setInterval(ie,3e3),setTimeout(()=>{_||m()},12e4)}async function Tr(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:d,matchId:c}=e,l=i.user.id,f=o===l,x=r===l,{data:g}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",l).single(),{data:y}=await v.from("users").select("mmr, mmr_rd, mmr_v").eq("id",f?a:o).single();if(g&&y){const p=Qn(g.mmr,g.mmr_rd,g.mmr_v,y.mmr,y.mmr_rd,x?1:0);await v.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:x?v.sql`mmr_wins + 1`:void 0,mmr_losses:x?void 0:v.sql`mmr_losses + 1`}).eq("id",l),n(x?`+MMR ↑ ${Math.round(p.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-p.mmr)}`,x?"success":"error",4e3)}}const Ir=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Fi,resumePvpMatch:Er},Symbol.toStringTag,{value:"Module"}));async function Sr(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",d=!!o.isAccepting;await hi(e,t,"friend",async({deckId:c,formation:l,starters:f,subsRaw:x,gcCardsEnriched:g,gcDefs:y,stadiumDef:p})=>{at(e);const u=async b=>{const _=b||[];d?await zr(e,t,c,_,y,p):await Ar(e,t,c,_,y,p,a,s)};if(!(g!=null&&g.length)){await u([]);return}xi(e,g,u)})}async function Ar(e,t,i,n,r,o,a,s){var _;const{state:d,navigate:c,toast:l}=t,f=d.user.id,{data:x,error:g}=await v.from("friend_match_invites").insert({inviter_id:f,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!x){console.error("[Friend] Erreur création invitation:",g),l("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
    ...
    </div>`;let y=!1,p=null;const u=async()=>{p&&(p.unsubscribe(),p=null)};(_=document.getElementById("cancel-friend"))==null||_.addEventListener("click",async()=>{await u(),await v.from("friend_match_invites").update({status:"declined"}).eq("id",x.id),tt(e),c("home")}),p=v.channel(`friend_invite_${x.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${x.id}`},async({new:h})=>{y||h.status!=="accepted"||!h.match_id||(y=!0,await u(),await At(e,t,h.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))}).subscribe();const b=setInterval(async()=>{if(y)return;const{data:h}=await v.from("friend_match_invites").select("status, match_id").eq("id",x.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(y=!0,clearInterval(b),await u(),await At(e,t,h.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))},3e3);setTimeout(async()=>{y||(clearInterval(b),await u(),l("Invitation expirée","info"),c("home"))},12e4)}async function zr(e,t,i,n,r,o){const{state:a,navigate:s,toast:d}=t,c=a.user.id,{data:l}=await v.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",c).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!l){d("Aucune invitation en attente","error"),s("home");return}const{data:f,error:x}=await v.rpc("accept_friend_invite",{p_invite_id:l.id,p_invitee_deck_id:i});if(x||!(f!=null&&f.success)){console.error("[Friend] Erreur accept_friend_invite:",x||f),d((f==null?void 0:f.error)||"Impossible de rejoindre le match","error"),s("home");return}await At(e,t,f.match_id,!1,{myGC:n,gcDefs:r,stadiumDef:o})}const Hn="#1A6B3C",st="#D4A017",Yt="var(--tile-bg)",Wt="var(--tile-border)",Et="var(--divider)",We="var(--tile-fg-on-page)",kt="var(--tile-fg-dim)",Qe="var(--tile-fg-faint)",Jt="var(--nav-fg,#fff)",Un="rgba(255,255,255,0.62)",Mr="rgba(255,255,255,0.4)";async function Cr(e,t){var n;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(n=t.state.params)==null?void 0:n.openLeagueId;if(i){t.state.params.openLeagueId=null,await dt(e,t,i);return}await Ze(e,t)}async function Ze(e,t,i="waiting"){var h,E;const{state:n}=t,r=n.profile.id,{data:o}=await v.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(o||[]).map(m=>m.league_id),s={};(o||[]).forEach(m=>{s[m.league_id]={amount:m.prize_amount,claimed:m.prize_claimed}});const{data:d,error:c}=await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),l=c?(await v.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:d||[],x=(a.length?await v.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],g=x.filter(m=>m.status==="waiting"&&!m.is_archived),y=x.filter(m=>m.status==="active"&&!m.is_archived),p=x.filter(m=>m.is_archived||m.status==="finished");let u=p;if(p.length){const{data:m}=await v.from("mini_league_matches").select("league_id").in("league_id",p.map(k=>k.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),z=new Set((m||[]).map(k=>k.league_id));u=p.filter(k=>z.has(k.id))}const b=l.filter(m=>!a.includes(m.id)),_=[{key:"waiting",label:"🟡 En attente",count:g.length+b.length},{key:"active",label:"🟢 En cours",count:y.length},{key:"archived",label:"📁 Archivées",count:u.length}];e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Et};display:flex;align-items:center;justify-content:space-between">
      <div>
        <div style="font-size:18px;font-weight:900;color:${Jt}">🏆 Mini League</div>
        <div style="font-size:12px;color:${Un}">Championnats 3 à 8 joueurs</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px">
        <button id="ml-refresh-list" title="Actualiser" style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.15);border-radius:8px;width:36px;height:36px;font-size:16px;cursor:pointer;color:${Jt}">🔄</button>
        <button id="ml-create-btn" class="btn btn-primary">+ Créer</button>
      </div>
    </div>
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Et}">
      ${_.map(m=>`<button class="ml-tab" data-tab="${m.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===m.key?Hn:"transparent"};background:none;font-size:12px;font-weight:${i===m.key?"900":"600"};color:${i===m.key?"#4ade80":Mr};cursor:pointer">${m.label}${m.count?` (${m.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?jr(g,b,r):i==="active"?Br(y,r):qr(u,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>Dr(e,t)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>Ze(e,t,i)),e.querySelectorAll(".ml-tab").forEach(m=>m.addEventListener("click",()=>Ze(e,t,m.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(m=>m.addEventListener("click",()=>dt(e,t,m.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(m=>m.addEventListener("click",z=>{z.stopPropagation(),Kn(e,t,m.dataset.join,m.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(m=>m.addEventListener("click",z=>{z.stopPropagation(),Pi(e,t,m.dataset.delete,m.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(m=>m.addEventListener("click",async z=>{z.stopPropagation(),m.disabled=!0,m.textContent="...";const{data:k,error:A}=await v.rpc("claim_mini_league_prize",{p_league_id:m.dataset.claimLeague,p_user_id:n.profile.id});if(A||!(k!=null&&k.success)){t.toast((k==null?void 0:k.error)||"Erreur lors de la récupération","error"),Ze(e,t,i);return}if(!k.already_claimed){n.profile.credits=(n.profile.credits||0)+k.prize;const q=document.getElementById("nav-credits");q&&(q.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${k.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}Ze(e,t,i)}))}function yi(e,t,i=!1,n=null){var d,c;const r=e.creator_id===t,o=e.pot||0,a=((c=(d=e.mini_league_members)==null?void 0:d[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Yt};border:1px solid ${s?"rgba(212,160,23,0.5)":Wt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;font-size:11px;color:${kt};margin-bottom:${i||s?"10px":"0"}">
  ...
  </div>`}function jr(e,t,i){const n=[];return e.length&&(n.push(`<div style="font-size:11px;font-weight:700;color:${Qe};text-transform:uppercase;letter-spacing:1px">Mes leagues en attente</div>`),n.push(...e.map(r=>yi(r,i,!1)))),t.length&&(n.push(`<div style="font-size:11px;font-weight:700;color:${Qe};text-transform:uppercase;letter-spacing:1px;margin-top:4px">Rejoindre</div>`),n.push(...t.map(r=>yi(r,i,!0)))),n.length?n.join(""):`<div style="text-align:center;padding:40px;color:${Qe}">🏆<br>Aucune mini league.<br>Crée la première !</div>`}function Br(e,t){return e.length?e.map(i=>yi(i,t)).join(""):`<div style="text-align:center;padding:40px;color:${Qe}">Aucune mini league en cours.</div>`}function qr(e,t,i={}){return e.length?e.map(n=>yi(n,t,!1,i[n.id])).join(""):`<div style="text-align:center;padding:40px;color:${Qe}">Aucune mini league archivée.</div>`}function Dr(e,t){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px",i.innerHTML=`<div style="background:#fff;border-radius:16px;width:100%;max-width:400px;max-height:90vh;overflow-y:auto">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
    ...
    </div></div>`,document.body.appendChild(i),i.querySelector("#ml-form-close").addEventListener("click",()=>i.remove()),i.querySelectorAll('input[name="ml-type"]').forEach(n=>n.addEventListener("change",()=>{document.getElementById("ml-pwd-block").style.display=n.value==="private"?"block":"none"})),i.querySelector("#ml-create-confirm").addEventListener("click",async()=>{var y,p,u,b;const{toast:n}=t,r=document.getElementById("ml-name").value.trim(),o=parseInt(document.getElementById("ml-max").value)||6,a=parseInt(document.getElementById("ml-fee").value)||500,s=((y=i.querySelector('input[name="ml-type"]:checked'))==null?void 0:y.value)||"public",d=((p=i.querySelector('input[name="ml-mode"]:checked'))==null?void 0:p.value)||"aller",c=((b=(u=document.getElementById("ml-pwd"))==null?void 0:u.value)==null?void 0:b.trim())||null;if(!r){n("Le nom est obligatoire","error");return}if(a<100){n("Mise minimum : 100 crédits","error");return}if(s==="private"&&!c){n("Mot de passe requis","error");return}const{data:l,error:f}=await v.from("mini_leagues").insert({name:r,creator_id:t.state.profile.id,type:s,password:c,mode:d,max_players:o,entry_fee:a}).select().single();if(f){n("Erreur : "+f.message,"error");return}const{data:x}=await v.from("users").select("credits").eq("id",t.state.profile.id).single();if(((x==null?void 0:x.credits)||0)<a){await v.from("mini_leagues").delete().eq("id",l.id),n(`Crédits insuffisants pour la mise (${a.toLocaleString("fr")} cr.)`,"error");return}await v.from("users").update({credits:x.credits-a}).eq("id",t.state.profile.id),await v.from("mini_leagues").update({pot:a}).eq("id",l.id),await v.from("mini_league_members").insert({league_id:l.id,user_id:t.state.profile.id}),t.state.profile&&(t.state.profile.credits=x.credits-a);const g=document.getElementById("nav-credits");g&&(g.textContent=`💰 ${(t.state.profile.credits||0).toLocaleString("fr")}`),i.remove(),n(`Mini League créée ! ${a.toLocaleString("fr")} cr. déduits.`,"success"),dt(e,t,l.id)})}function Fr(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9500;display:flex;align-items:center;justify-content:center;padding:20px",t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function Kn(e,t,i,n){var f;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await Fr(),s===null))return;const{data:d,error:c}=await v.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(c||!(d!=null&&d.success)){console.error("[MiniLeague] join_mini_league:",c||d),r((d==null?void 0:d.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:x}=await v.from("users").select("credits").eq("id",a).single();o.profile&&x&&(o.profile.credits=x.credits)}const l=document.getElementById("nav-credits");l&&(l.textContent=`💰 ${(((f=o.profile)==null?void 0:f.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),dt(e,t,i)}async function Pr(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(x=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),x(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),x(!1)}}))return;const{data:d,error:c}=await v.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(d!=null&&d.success)){r((d==null?void 0:d.error)||"Erreur lors de la désinscription","error");return}const l=d.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+l);const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${l.toLocaleString("fr")} cr. remboursés`,"success"),Ze(e,t,"waiting")}async function Pi(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await v.from("mini_league_matches").delete().eq("league_id",i),await v.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await v.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),Ze(e,t,r)}async function Gr(e,t,i){await v.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),Ze(e,t,"archived")}async function dt(e,t,i){var E,m,z,k,A,q,ie,ne,Z;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:d}]=await Promise.all([v.from("mini_leagues").select("*").eq("id",i).single(),v.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),v.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await Ze(e,t);return}const c=(s||[]).some(j=>j.user_id===o),l=a.creator_id===o,f=(s||[]).map(j=>j.user).filter(Boolean),x=Ur(f,d||[]),g=(d||[]).filter(j=>j.matchday===a.current_day),y=a.pot||0,p=a.entry_fee||100,u=g.length>0&&g.every(j=>j.status==="finished"||j.status==="bye"),b=a.current_day>=a.total_days,_=(s||[]).find(j=>j.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    <div style="padding:14px 16px;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${Et};display:flex;align-items:center;gap:10px">
      <button id="ml-back" style="background:none;border:none;font-size:20px;cursor:pointer;color:${Jt}">‹</button>
      <button id="ml-refresh" title="Actualiser" style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.15);border-radius:8px;width:32px;height:32px;font-size:15px;cursor:pointer;color:${Jt};flex-shrink:0">🔄</button>
      <div style="flex:1">
        <div style="font-size:16px;font-weight:900;color:${Jt}">${a.name}</div>
      ...
      <div style="text-align:right;flex-shrink:0">
        ...
        ${y>0?`<div style="font-size:12px;font-weight:900;color:${st};margin-top:4px">🏆 ${y.toLocaleString("fr")} cr.</div>`:""}
      </div>
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">

      ${a.status==="waiting"?`
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${We}">👥 Joueurs (${f.length}/${a.max_players})</div>
        <div style="font-size:12px;color:${kt};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*f.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*f.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*f.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*f.length*.1).toLocaleString("fr")})</div>
        ${f.map(j=>`
      ...
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="font-size:10px;color:${Qe};text-transform:uppercase;border-bottom:2px solid ${Et}">
            ...
            ${y>0&&a.status==="finished"?`<th style="text-align:right;padding:5px 0;color:${st}">💰</th>`:""}
          </tr></thead>
          <tbody>${x.map((j,I)=>{const K=y>0&&a.status==="finished"?I===0?Math.floor(y*.7):I===1?Math.floor(y*.2):I===2?Math.floor(y*.1):0:0;return`<tr style="border-bottom:1px solid ${Et};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${I===0?st:I<3?"#4ade80":kt}">${["🥇","🥈","🥉"][I]||I+1}</td>
              ...
              <td style="text-align:center;color:${kt}">${j.played}</td><td style="text-align:center;color:${kt}">${j.won}-${j.drawn}-${j.lost}</td>
              ...
              ${y>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${st}">${K?K.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:${Yt};border:1px solid ${Wt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,I)=>I+1).reverse().map(j=>{const I=(d||[]).filter(K=>K.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Qe};margin-bottom:6px">Journée ${j}</div>${I.map(K=>bn(K,f,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}

      ${l&&!a.is_archived&&a.status!=="waiting"?`
      <div style="display:flex;gap:8px">
        <button id="ml-archive-btn" class="btn btn-ghost btn-sm" style="flex:1;color:${kt}">📁 Archiver</button>
        <button id="ml-delete-now" class="btn btn-ghost btn-sm" style="flex:1;color:#ff6b6b">🗑️ Supprimer</button>
      </div>`:""}

    </div>
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>Ze(e,t,h)),(m=document.getElementById("ml-refresh"))==null||m.addEventListener("click",async j=>{const I=j.currentTarget;I.style.opacity="0.5",await dt(e,t,i)}),(z=document.getElementById("ml-start-btn"))==null||z.addEventListener("click",()=>Nr(e,t,a,f)),(k=document.getElementById("ml-next-day"))==null||k.addEventListener("click",()=>Rr(e,t,i)),(A=document.getElementById("ml-join-now"))==null||A.addEventListener("click",()=>Kn(e,t,i,a.type)),(q=document.getElementById("ml-leave-btn"))==null||q.addEventListener("click",()=>Pr(e,t,i,p)),(ie=document.getElementById("ml-delete-btn"))==null||ie.addEventListener("click",()=>Pi(e,t,i,a.name,"waiting")),(ne=document.getElementById("ml-delete-now"))==null||ne.addEventListener("click",()=>Pi(e,t,i,a.name,h)),(Z=document.getElementById("ml-archive-btn"))==null||Z.addEventListener("click",()=>Gr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(j=>{j.addEventListener("click",()=>{const I=g.find(K=>K.id===j.dataset.playMatch);I&&t.navigate("match-mini-league",{mlMatchId:I.id,leagueId:i})})}),a.status==="finished"&&_){const j=x.findIndex(I=>I.userId===o);j>=0&&j<3&&_.prize_amount>0&&!_.prize_claimed&&setTimeout(()=>Or(e,t,a,_,j),400)}}function bn(e,t,i,n,r=!1){const o=f=>t.find(x=>x.id===f);if(e.is_bye){const f=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${kt};text-align:center">🔵 ${(f==null?void 0:f.club_name)||(f==null?void 0:f.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),d=e.home_id===i||e.away_id===i,c=d&&e.status==="pending"&&n&&!r,l=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${d?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${d?"rgba(74,222,128,0.35)":Et}">
  ...
  </div>`}async function Nr(e,t,i,n){const{toast:r,state:o}=t,a=Hr(n.map(c=>c.id),i.mode),s=[];a.forEach((c,l)=>c.forEach(f=>s.push({league_id:i.id,matchday:l+1,home_id:f.home||f.bye,away_id:f.away||null,is_bye:!!f.bye,status:f.bye?"bye":"pending"})));const{error:d}=await v.from("mini_league_matches").insert(s);if(d){r("Erreur calendrier : "+d.message,"error");return}await v.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),dt(e,t,i.id)}async function Rr(e,t,i){const{data:n}=await v.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){dt(e,t,i);return}await v.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),dt(e,t,i)}async function Or(e,t,i,n,r){var x,g;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],d=["🥇","🥈","🥉"][r],c=n.prize_amount||s[r]||0,l=n.prize_claimed,f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",f.innerHTML=`
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      ${l?'<div style="font-size:13px;color:#86efac;margin-bottom:16px">✅ Crédits déjà récupérés</div>':`<button id="claim-prize-btn" style="width:100%;padding:14px;border-radius:12px;border:none;background:${st};color:#111;font-size:16px;font-weight:900;cursor:pointer;margin-bottom:12px">💰 Récupérer ${c.toLocaleString("fr")} cr.</button>`}
      <button id="prize-close" style="background:rgba(255,255,255,0.1);border:none;color:rgba(255,255,255,0.7);padding:10px 24px;border-radius:10px;font-size:14px;cursor:pointer">Fermer</button>
    </div>`,document.body.appendChild(f),(x=f.querySelector("#prize-close"))==null||x.addEventListener("click",()=>f.remove()),(g=f.querySelector("#claim-prize-btn"))==null||g.addEventListener("click",async y=>{const p=y.currentTarget;p.disabled=!0,p.textContent="...";const{data:u,error:b}=await v.rpc("claim_mini_league_prize",{p_league_id:i.id,p_user_id:o.profile.id});if(b||!(u!=null&&u.success)){console.error("[MiniLeague] claim_mini_league_prize:",b||u),a((u==null?void 0:u.error)||"Erreur lors de la récupération","error"),p.disabled=!1,p.textContent=`💰 Récupérer ${c.toLocaleString("fr")} cr.`;return}if(u.already_claimed)a("Déjà récupéré précédemment","info");else{const _=(o.profile.credits||0)+u.prize;o.profile&&(o.profile.credits=_);const h=document.getElementById("nav-credits");h&&(h.textContent=`💰 ${_.toLocaleString("fr")}`),a(`💰 +${u.prize.toLocaleString("fr")} cr. ajoutés à ton solde !`,"success")}f.remove(),dt(e,t,i.id)})}function Hr(e,t){const n=e.length%2===0?[...e]:[...e,null],r=n.length;let o=n.slice(1);const a=[];for(let s=0;s<r-1;s++){const d=[],c=[n[0],...o];for(let l=0;l<r/2;l++){const f=c[l],x=c[r-1-l];f===null?d.push({bye:x}):x===null?d.push({bye:f}):d.push({home:f,away:x})}a.push(d),o=[o[o.length-1],...o.slice(0,-1)]}return t==="aller-retour"?[...a,...a.map(s=>s.map(d=>d.bye?d:{home:d.away,away:d.home}))]:a}function Ur(e,t){const i={};return e.forEach(n=>{i[n.id]={userId:n.id,pseudo:n.pseudo,clubName:n.club_name||n.pseudo,played:0,won:0,drawn:0,lost:0,goalsFor:0,goalsAgainst:0,goalDiff:0,points:0}}),t.filter(n=>n.status==="finished"&&!n.is_bye&&n.home_score!=null).forEach(n=>{const r=i[n.home_id],o=i[n.away_id];!r||!o||(r.played++,o.played++,r.goalsFor+=n.home_score,r.goalsAgainst+=n.away_score,o.goalsFor+=n.away_score,o.goalsAgainst+=n.home_score,n.home_score>n.away_score?(r.won++,r.points+=3,o.lost++):n.home_score<n.away_score?(o.won++,o.points+=3,r.lost++):(r.drawn++,r.points++,o.drawn++,o.points++),r.goalDiff=r.goalsFor-r.goalsAgainst,o.goalDiff=o.goalsFor-o.goalsAgainst)}),Object.values(i).sort((n,r)=>r.points-n.points||r.goalDiff-n.goalDiff||r.goalsFor-n.goalsFor)}async function hn(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.leagueId||null,s=o.mlMatchId||null,d=i.user.id;if(!s||!a){r("Match introuvable","error"),n("mini-league");return}const{data:c,error:l}=await v.from("mini_league_matches").select("id, league_id, home_id, away_id, status, match_id").eq("id",s).single();if(l||!c){r("Match introuvable","error"),n("mini-league",{openLeagueId:a});return}if(c.home_id!==d&&c.away_id!==d){r("Vous ne faites pas partie de ce match","error"),n("mini-league",{openLeagueId:a});return}const f=c.home_id===d;if(c.match_id){await At(e,t,c.match_id,f,{mlLeagueId:a,mlMatchId:s});return}await hi(e,t,"mini_league",async({deckId:x,gcCardsEnriched:g,gcDefs:y,stadiumDef:p})=>{at(e);const u=async b=>{const{data:_,error:h}=await v.rpc("start_mini_league_match",{p_ml_match_id:s,p_user_id:d,p_deck_id:x});if(h||!(_!=null&&_.success)){console.error("[MiniLeague] start_mini_league_match error:",h||_),r((_==null?void 0:_.error)||"Impossible de lancer le match","error"),n("mini-league",{openLeagueId:a});return}if(_.matched){await At(e,t,_.match_id,f,{mlLeagueId:a,mlMatchId:s,myGC:b||[],gcDefs:y,stadiumDef:p});return}await Kr(e,t,{mlMatchId:s,leagueId:a,amIHome:f,chosenGC:b,gcDefs:y,stadiumDef:p})};if(!(g!=null&&g.length)){await u([]);return}xi(e,g,u)})}function Kr(e,t,{mlMatchId:i,leagueId:n,amIHome:r,chosenGC:o,gcDefs:a,stadiumDef:s}){return new Promise(d=>{var p;const{navigate:c}=t;e.innerHTML=`
    <div style="min-height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#0a1a2e,#0d3d1e);color:#fff;padding:32px;text-align:center;gap:20px">
      <div style="font-size:36px">🏆</div>
    ...
    </div>`;let l=!1;const f=async u=>{if(!l){if(l=!0,clearInterval(y),g)try{g.unsubscribe()}catch{}u&&await At(e,t,u,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),d()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(l=!0,clearInterval(y),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),d()});const x=async()=>{if(l)return;const{data:u}=await v.from("mini_league_matches").select("match_id").eq("id",i).single();u!=null&&u.match_id&&f(u.match_id)},g=v.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},u=>{var b;(b=u.new)!=null&&b.match_id&&f(u.new.match_id)}).subscribe(),y=setInterval(x,3e3);x()})}const Vr="/",Yr=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function Wr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var l,f,x;const s=t[n],d=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
    ...
    `,r.querySelectorAll("ul,ol").forEach(g=>{g.style.paddingLeft="20px",g.style.marginTop="6px",g.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(g=>{g.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(g=>{g.style.marginBottom="8px"}),(l=r.querySelector("#tuto-prev"))==null||l.addEventListener("click",()=>{n--,o()}),(f=r.querySelector("#tuto-next"))==null||f.addEventListener("click",()=>{d?a():(n++,o())}),(x=r.querySelector("#tuto-skip"))==null||x.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),e!=null&&e.id&&await v.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(r),o()}async function Xr(e,t,i){if(!e||e.tutorial_done)return;let n=[];const{data:r,error:o}=await v.rpc("get_tutorial_steps");if(!o&&(r==null?void 0:r.length)>0)n=r,console.log(`[Tutorial] RPC OK → ${n.length} étapes`);else{const{data:s,error:d}=await v.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!d&&(s==null?void 0:s.length)>0?(n=s,console.log(`[Tutorial] Direct OK → ${n.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${o==null?void 0:o.message}, Direct: ${d==null?void 0:d.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=n.length>0?n.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):Yr;Wr(e,a,()=>t("boosters"))}const li={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Bt(e,t,i=0){return t?(Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0)+(t===e.job||t===e.job2?i:0):0}async function Jr(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await Xi(e,t)}async function Xi(e,t){const{state:i,toast:n}=t,{data:r}=await v.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let d="buy";const c=()=>{var p,u,b,_,h,E,m;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((u=document.getElementById("flt-club"))==null?void 0:u.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((_=document.getElementById("flt-job"))==null?void 0:_.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((m=document.getElementById("flt-note2"))==null?void 0:m.value)||0}};function l(p){const u=c();return p.filter(b=>{var q,ie,ne;const _=(q=b.card)==null?void 0:q.player;if(!_)return!1;const h=`${_.firstname} ${_.surname_real}`.toLowerCase(),E=(((ie=_.clubs)==null?void 0:ie.encoded_name)||"").toLowerCase(),m=(_.country_code||"").toLowerCase(),z=((ne=b.card)==null?void 0:ne.evolution_bonus)||0,k=Bt(_,_.job,z),A=_.job2?Bt(_,_.job2,z):0;return!(u.name&&!h.includes(u.name)||u.club&&!E.includes(u.club)||u.country&&!m.includes(u.country)||u.job&&_.job!==u.job||u.rarity&&_.rarity!==u.rarity||u.note1&&k<u.note1||u.note2&&A<u.note2)})}function f(p){var A,q,ie,ne;const u=(A=p.card)==null?void 0:A.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,_=Bt(u,u.job,b),h=u.job2?Bt(u,u.job2,b):0,E=(i.profile.credits||0)>=p.price,m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,z=li[u.job]||"#bbb",k=u.job2?li[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function x(p){var A,q,ie,ne;const u=(A=p.card)==null?void 0:A.player;if(!u)return"";const b=((q=p.card)==null?void 0:q.evolution_bonus)||0,_=Bt(u,u.job,b),h=u.job2?Bt(u,u.job2,b):0,E=p.status==="sold",m=u.country_code?`https://flagsapi.com/${u.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,z=li[u.job]||"#bbb",k=u.job2?li[u.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${m?`<img src="${m}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ie=u.clubs)!=null&&ie.logo_url?`<img src="${u.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${z};display:flex;align-items:center;justify-content:center">
    ...
    </div>`}function g(){const p=document.getElementById("mkt-content"),u=document.getElementById("mkt-filters");if(p){if(u.style.display=d==="buy"?"flex":"none",d==="buy"){const b=l(a);p.innerHTML=b.length?b.map(f).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const b=s.filter(h=>h.status==="active").sort((h,E)=>new Date(E.listed_at)-new Date(h.listed_at)),_=s.filter(h=>h.status==="sold").sort((h,E)=>new Date(E.sold_at||E.listed_at)-new Date(h.sold_at||h.listed_at));p.innerHTML=(b.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${b.length})</div>`+b.map(x).join(""):"")+(_.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${_.length})</div>`+_.map(x).join(""):"")+(!b.length&&!_.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(b=>b.addEventListener("click",()=>Qr(b.dataset.buy,a,e,t))),p.querySelectorAll("[data-cancel]").forEach(b=>b.addEventListener("click",()=>ea(b.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{d=p.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(u=>{const b=u===p;u.style.background=b?"var(--green)":"var(--tile-bg)",u.style.color=b?"#fff":"var(--tile-fg-dim)",u.style.borderColor=b?"var(--green)":"var(--tile-border)"}),g()})});let y;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var u;(u=document.getElementById(p))==null||u.addEventListener("input",()=>{clearTimeout(y),y=setTimeout(g,250)})}),g()}async function Qr(e,t,i,n){const{state:r,toast:o,refreshProfile:a}=n,s=t.find(l=>l.id===e);if(!s)return;const d=s.price;if((r.profile.credits||0)<d){o("Crédits insuffisants","error");return}Zr(s,async()=>{const{error:l}=await v.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:r.profile.id});if(l){o("Erreur achat : "+l.message,"error");return}await a();const f=document.getElementById("nav-credits");f&&(f.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),o("✅ Carte achetée !","success"),await Xi(i,n)})}function Zr(e,t){var a;const i=(a=e.card)==null?void 0:a.player,n=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="display:flex;gap:10px">
        ...
        <button id="buy-ok" style="flex:1;padding:12px;border-radius:10px;border:none;background:var(--green);color:#fff;font-size:14px;font-weight:900;cursor:pointer">Confirmer</button>
          ...
          </div>`}).join(""):'<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun joueur classé.</div>'}else if(d==="mini-league"){const k=a||[];h.innerHTML=k.length>0?k.map((A,q)=>`
      ...
      `).join(""):`<div style="text-align:center;color:var(--tile-fg-dim);padding:40px">Aucun résultat de Mini League pour l'instant.</div>`}else{const k=s||[];h.innerHTML=k.length>0?k.map((A,q)=>`
        <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${A.user_id===i.profile.id?"border:2px solid var(--yellow)":""}">
          <div style="width:32px;height:32px;border-radius:50%;background:${c(q)};color:${l(q)};display:flex;align-items:center;justify-content:center;font-weight:900;flex-shrink:0;font-size:${q<3?"16":"13"}px">${q<3?["🥇","🥈","🥉"][q]:q+1}</div>
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;color:var(--tile-fg-on-page);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${A.pseudo}</div>
  ...
  <div class="page">
    ...
    </div>`,(z=document.getElementById("ranked-back"))==null||z.addEventListener("click",()=>n("home"));return}const d=s.mmr??1e3,c=s.mmr_deviation??350,l=s.mmr_volatility??.06,f=s.placement_matches??0,x=f<10,g=Math.max(0,10-f),y=Oi(d),p=Zn(d),u=ki.findIndex(ie=>ie.id===y.id),b=ki[u+1]||null,_={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,m=ki.map(ie=>`
  ...
  </div>`}eo(io);const xe={user:null,profile:null,page:"home",params:{}};function qt(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function oa(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Gi(){document.getElementById("modal-overlay").classList.add("hidden")}async function Xt(){if(!xe.user)return;const{data:e}=await v.from("users").select("*").eq("id",xe.user.id).single();e&&(xe.profile=e)}const Vn="mw_theme";function Yn(){return localStorage.getItem(Vn)||"dark"}function ra(e){var t;localStorage.setItem(Vn,e),aa(e),(t=xe.profile)!=null&&t.id&&v.from("users").update({theme:e}).eq("id",xe.profile.id).then(()=>{})}function aa(e){document.documentElement.setAttribute("data-theme",e)}function Dt(e,t={}){xe.page=e,xe.params=t,Wn()}async function Wn(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===xe.page)});const t=document.getElementById("nav-credits");t&&xe.profile&&(t.textContent=`💰 ${(xe.profile.credits||0).toLocaleString("fr")}`);const i={state:xe,navigate:Dt,toast:qt,openModal:oa,closeModal:Gi,refreshProfile:Xt};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',xe.page){case"home":await dn(e,i);break;case"settings":await zi(e,i);break;case"collection":await jo(e,i);break;case"decks":await Mi(e,i);break;case"boosters":await Vo(e,i);break;case"ranked":await ia(e,i);break;case"match":{const s=xe.params&&xe.params.matchMode||"vs_ai_easy";s==="random"?await Fi(e,i,!1):s==="ranked"?await Fi(e,i,!0):s==="friend"?await Sr(e,i,(n=xe.params)==null?void 0:n.friendId,(r=xe.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await hn(e,i,(o=xe.params)==null?void 0:o.mlMatchId,(a=xe.params)==null?void 0:a.leagueId):await dr(e,i);break}case"market":await Jr(e,i);break;case"rankings":await ta(e,i);break;case"matches":await na(e,i);break;case"friends":await co(e,i);break;case"mini-league":await Cr(e,i);break;case"match-mini-league":{const s=xe.params||{};await hn(e,i,s.mlMatchId,s.leagueId);break}default:await dn(e,i)}}function sa(){var n,r;const e=document.getElementById("app"),t=xe.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
      <div class="logo" id="nav-logo" title="Manager Wars v2026.07.21-1718" style="cursor:pointer">
  ...
  </div>`,(n=e.querySelector("#pl-play-btn"))==null||n.addEventListener("click",t)}async function ca(){document.documentElement.setAttribute("data-theme",Yn()),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&Gi()}),document.getElementById("modal-close").addEventListener("click",Gi);const{data:{session:e}}=await v.auth.getSession();if(!e){vn(),la(document.getElementById("app"),{onPlay:()=>rn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:qt})});return}xe.user=e.user,await Xt(),vn();try{const{data:i}=await v.from("formation_links_overrides").select("formation, links"),n={};(i||[]).forEach(r=>{n[r.formation]=r.links}),to(n)}catch(i){console.warn("Impossible de charger les overrides de formation:",i)}if(!xe.profile){oo(document.getElementById("app"),{state:xe,navigate:async()=>{await Xt(),Ii()},toast:qt,refreshProfile:Xt});return}const t=Array.isArray(xe.profile.pending_boosters)?xe.profile.pending_boosters:[];if(!xe.profile.onboarding_done&&t.length>0){tr(document.getElementById("app"),{state:xe,navigate:()=>Ii(),toast:qt,refreshProfile:Xt});return}Ii(),setTimeout(()=>Xr(xe.profile,Dt,qt),800),v.auth.onAuthStateChange(async(i,n)=>{i==="SIGNED_OUT"&&(xe.user=null,xe.profile=null,document.getElementById("app").innerHTML="",rn(document.getElementById("app"),{navigate:()=>window.location.reload(),toast:qt}))})}function pa(){return Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight)}function vi(){const e=document.getElementById("app");e&&(e.style.height=pa()+"px")}window.addEventListener("resize",vi);window.addEventListener("orientationchange",()=>setTimeout(vi,150));window.visualViewport&&window.visualViewport.addEventListener("resize",vi);function Ii(){const e=()=>{var i;(i=xe.user)!=null&&i.id&&v.from("users").update({last_seen_at:new Date().toISOString()}).eq("id",xe.user.id).then(()=>{})};e(),window._presencePingInterval&&clearInterval(window._presencePingInterval),window._presencePingInterval=setInterval(e,6e4);const t=document.getElementById("app");t.style.display="flex",t.style.flexDirection="column",vi(),sa(),Wn()}function vn(){const e=document.getElementById("app-loader"),t=document.getElementById("app");t&&(t.style.display=""),e&&(e.classList.add("zoom-out"),setTimeout(()=>e.style.display="none",500))}function Xn(e){var n;const t=document.getElementById("app-loader");if(t&&(t.style.display="none"),document.getElementById("boot-error"))return;const i=document.createElement("div");i.id="boot-error",i.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:99999;gap:16px;color:#fff;padding:24px;text-align:center",i.innerHTML=`
