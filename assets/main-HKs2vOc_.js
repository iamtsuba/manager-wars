  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`},({def:U,count:se})=>{var I,C;const he=window.innerWidth>=768?.76:.54,Se=(U==null?void 0:U.name)||"?",Me=((I=U==null?void 0:U.club)==null?void 0:I.encoded_name)||(U==null?void 0:U.country_code)||"—",be=U!=null&&U.image_url?`${ge}icons/${U.image_url}`:((C=U==null?void 0:U.club)==null?void 0:C.logo_url)||(U!=null&&U.country_code?`https://flagcdn.com/w80/${U.country_code.toLowerCase()}.png`:null),ze=be?`<img src="${be}" style="width:64px;height:64px;object-fit:contain;border-radius:4px" onerror="this.style.display='none'">`:'<span style="font-size:32px">🏟️</span>';return`<div style="display:inline-block;zoom:${he};line-height:0;pointer-events:none">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Vt=1e3;function en(e,t,i,s){var z,r,u;const{state:c,toast:d,closeModal:a,navigate:l,refreshProfile:p}=i,o=e.formation,n={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function g(){const M=Pt[o]||{},L=bi[o]||[],D=290,W=360,F=20;function P(K){const oe=M[K];return oe?{x:oe.x*D,y:oe.y*W}:null}let j=`<svg width="${D}" height="${W}" viewBox="0 0 ${D} ${W}" xmlns="http://www.w3.org/2000/svg">`;for(const[K,oe]of L){const de=P(K),N=P(oe);!de||!N||(j+=`<line x1="${de.x}" y1="${de.y}" x2="${N.x}" y2="${N.y}"
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",l);let ve=new Set;const _e=()=>{const J=ve.size,Z=document.getElementById("sell-action-panel");if(!Z)return;Z.style.display=J>0?"block":"none",document.getElementById("sell-selected-count").textContent=J;const U=document.getElementById("evolve-btn");U&&(U.textContent=`⬆️ Évoluer ${J>1?"(+"+J+")":""}`)};document.querySelectorAll(".expl-check").forEach(J=>{J.addEventListener("change",()=>{const Z=J.dataset.id;J.checked?ve.add(Z):ve.delete(Z);const U=J.closest(".exemplaire-row");U&&(U.style.borderColor=J.checked?"#1A6B3C":"#eee"),_e()})}),document.querySelectorAll(".exemplaire-row").forEach(J=>{J.addEventListener("click",Z=>{if(Z.target.closest("button")||Z.target.tagName==="INPUT")return;const U=J.querySelector(".expl-check");U&&!U.disabled&&(U.checked=!U.checked,U.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(J=>{J.addEventListener("click",Z=>{Z.stopPropagation();const U=document.querySelector(`.expl-hist[data-hist="${J.dataset.idx}"]`);U&&(U.style.display=U.style.display==="none"?"flex":"none")})}),(X=document.getElementById("evolve-btn"))==null||X.addEventListener("click",async()=>{if(h<=1)return;const J=[...ve];if(!J.length)return;if(ve.has(e.id)){const be=document.createElement("div");be.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",be.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),p=[...new Set((l||[]).filter(h=>{var y,z;return((y=h.card)==null?void 0:y.card_type)==="stadium"&&((z=h.card)==null?void 0:z.stadium_id)}).map(h=>h.card.stadium_id))],o={};if(p.length){const{data:h}=await E.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",p);(h||[]).forEach(y=>{o[y.id]=y}),(l||[]).forEach(y=>{var z,r;((z=y.card)==null?void 0:z.card_type)==="stadium"&&((r=y.card)!=null&&r.stadium_id)&&(y.card._stadiumDef=o[y.card.stadium_id]||null)})}let n=0;function g(){var F,P,j,K,oe,de,N;const h=d[n],y=(l||[]).filter(Y=>Y.deck_id===h.id),z=y.filter(Y=>{var H;return Y.is_starter&&((H=Y.card)==null?void 0:H.player)}).map(Y=>gi(Y.card,Y.position)),r=y.find(Y=>{var H;return((H=Y.card)==null?void 0:H.card_type)==="formation"}),u=h.formation||((F=r==null?void 0:r.card)==null?void 0:F.formation)||"4-4-2";let M=z.length>=11?yt(z,u):null,L=((P=h.stadium_card)==null?void 0:P.stadium_def)||null;L&&M&&(M=Ht(M,L));const D=z.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let l=!1;const p=()=>{l||(l=!0,d.remove(),setTimeout(()=>c(),50))};d.addEventListener("click",p),setTimeout(p,3500)}async function Bt(e,t,i){var n,g;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,c=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,a=c?"victoire":d?"nul":"defaite",l=Vo(t.mode,a);t.matchId&&await E.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:c?s.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const p={credits:(s.profile.credits||0)+l,matches_played:(s.profile.matches_played||0)+1};c?p.wins=(s.profile.wins||0)+1:d?p.draws=(s.profile.draws||0)+1:p.losses=(s.profile.losses||0)+1,await E.from("users").update(p).eq("id",s.profile.id),await i.refreshProfile();const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",o.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${C.map(f=>{const m={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[f._line]||"#555",x=je(f,f._line)+(f.boost||0);return`<div class="bp-item" data-cid="${f.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${m};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(w),(k=w.querySelector("#bp-close"))==null||k.addEventListener("click",()=>w.remove()),w.querySelectorAll(".bp-item").forEach(f=>{f.addEventListener("click",async()=>{const m=f.dataset.cid,x=C.find(v=>v.cardId===m);if(!x)return;const b=(I[x._line]||[]).find(v=>v.cardId===m);b&&(b.boost=(b.boost||0)+r.boostValue),w.remove(),await j({[o+"Team"]:I,boostUsed:!0})})})}function Ae(I=null){var S,q;if(!(r.phase===o+"-attack")){p("Remplacement uniquement avant votre attaque","warning");return}const w=r[o+"Team"],k=r["usedSubIds_"+o]||[],f=r.maxSubs||3;if(k.length>=f){p(`Maximum ${f} remplacements atteint`,"warning");return}const m=Object.entries(w).flatMap(([B,R])=>(R||[]).filter(O=>O.used).map(O=>({...O,_line:B}))),x=(r[o+"Subs"]||[]).filter(B=>!k.includes(B.cardId));if(!m.length){p("Aucun joueur utilisé à remplacer","warning");return}if(!x.length){p("Aucun remplaçant disponible","warning");return}let b=Math.max(0,m.findIndex(B=>B.cardId===I));const v=((S=m[b])==null?void 0:S._line)||((q=m[b])==null?void 0:q.job);let _=Math.max(0,x.findIndex(B=>B.job===v)),T=!1;const $=document.createElement("div");$.id="pvp-sub-overlay",$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function A(){var ae,fe,me,$e,ke,qe;const B=m[b],R=x[_],O=Math.min(130,Math.round((window.innerWidth-90)/2)),Q=Math.round(O*1.35),V=Ce=>`background:rgba(255,255,255,0.12);border:none;color:${Ce?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Ce?"default":"pointer"};flex-shrink:0`;$.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(ae=$.querySelector("#psub-close"))==null||ae.addEventListener("click",()=>$.remove()),(fe=$.querySelector("#pout-up"))==null||fe.addEventListener("click",()=>{b>0&&(b--,A())}),(me=$.querySelector("#pout-down"))==null||me.addEventListener("click",()=>{b<m.length-1&&(b++,A())}),($e=$.querySelector("#pin-up"))==null||$e.addEventListener("click",()=>{_>0&&(_--,A())}),(ke=$.querySelector("#pin-down"))==null||ke.addEventListener("click",()=>{_<x.length-1&&(_++,A())});const ie=(Ce,Re,Fe,Oe)=>{const De=$.querySelector("#"+Ce);if(!De)return;let Ke=0;De.addEventListener("touchstart",Ne=>{Ke=Ne.touches[0].clientY},{passive:!0}),De.addEventListener("touchend",Ne=>{const He=Ne.changedTouches[0].clientY-Ke;if(Math.abs(He)<30)return;const Ue=Re();He<0&&Ue<Oe-1?(Fe(Ue+1),A()):He>0&&Ue>0&&(Fe(Ue-1),A())},{passive:!0})};ie("pin-panel",()=>_,Ce=>_=Ce,x.length),ie("pout-panel",()=>b,Ce=>b=Ce,m.length),(qe=$.querySelector("#psub-confirm"))==null||qe.addEventListener("click",async Ce=>{if(Ce.preventDefault(),Ce.stopPropagation(),T)return;T=!0;const Re=m[b],Fe=x[_];if(!Re||!Fe)return;const Oe=Re._line,De=(w[Oe]||[]).findIndex(He=>He.cardId===Re.cardId);if(De===-1){p("Erreur : joueur introuvable","error"),$.remove();return}const Ke={...Fe,_line:Oe,position:Re.position,used:!1,boost:0};w[Oe].splice(De,1,Ke);const Ne=[...k,Fe.cardId];$.remove(),Ie(Re,Fe,async()=>{await j({[o+"Team"]:w,[n+"Team"]:r[n+"Team"],["usedSubIds_"+o]:Ne})})})}document.body.appendChild($),A()}function Ie(I,C,w){const k={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const m=(v,_,T)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(C),(w=C.querySelector("#pvp-hist-close"))==null||w.addEventListener("click",()=>C.remove())}async function ne(){if(r.phase!==o+"-attack")return;const I=o==="p1"?"p2":"p1",C=(r.round||0)+1,w=[...r.log||[]];w.push({type:"info",text:`⏭️ ${r[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const k=Se(r),f=he(I),m=k||!f?"finished":I+"-attack";await j({["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:m,attacker:I,round:C,log:w}),m==="finished"&&await be(r)}async function ge(){const I=r[o+"Team"],C=!["GK","DEF","MIL","ATT"].some(m=>(r[n+"Team"][m]||[]).some(x=>!x.used)),w=(r["selected_"+o]||[]).map(m=>{const x=(I[m._role]||[]).find(A=>A.cardId===m.cardId)||m,b=C&&["GK","DEF"].includes(m._role),v=I[m._role]||[],_=v.findIndex(A=>A.cardId===m.cardId),T=lt(v.length),$=_>=0?T[_]:x._col??1;return{...x,_line:m._role,_col:$,...b?{note_a:Math.max(1,Number(x.note_a)||0)}:{}}});if(!w.length)return;const k=Nt(w,r.modifiers[o]||{});Y(o,w.map(m=>m.cardId)),w.forEach(m=>{const x=(I[m._role]||[]).find(b=>b.cardId===m.cardId);x&&(x.used=!0)}),r["selected_"+o]=[],G();const f=[...r.log||[]];if(C){const m=(r[o+"Score"]||0)+1,x=w.map($=>({name:$.name,note:je($,$._line||"ATT"),portrait:Pe($),job:$.job}));f.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:x,homeTotal:k.total,aiTotal:0});const b=(r.round||0)+1,v=o==="p1"?"p2":"p1",_={...r,[o+"Team"]:I,[o+"Score"]:m},T=Se(_);D.add(b),Le(x,m,r[n+"Score"]||0,!0,async()=>{await j({[o+"Team"]:I,[o+"Score"]:m,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:T?"finished":v+"-attack",attacker:v,round:b,log:f}),T&&await be({...r,[o+"Score"]:m})});return}f.push({type:"pending",text:`⚔️ ${r[o+"Name"]} attaque (${k.total})`}),await j({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],pendingAttack:{...k,players:w,side:o},["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},phase:n+"-defense",log:f})}async function J(){const I=r[o+"Team"],C=(r["selected_"+o]||[]).map(B=>{const R=(I[B._role]||[]).find(ae=>ae.cardId===B.cardId)||B,O=I[B._role]||[],Q=O.findIndex(ae=>ae.cardId===B.cardId),V=lt(O.length),ie=Q>=0?V[Q]:R._col??1;return{...R,_line:B._role,_col:ie}}),w=Rt(C,r.modifiers[o]||{});Y(o,C.map(B=>B.cardId)),C.forEach(B=>{const R=(I[B._role]||[]).find(O=>O.cardId===B.cardId);R&&(R.used=!0)}),r["selected_"+o]=[],G();const k=Ot(r.pendingAttack.total,w.total,r.modifiers[o]||{}),f=r.pendingAttack.side,m=k==="attack"||(k==null?void 0:k.goal),x=f==="p1"?"p2":"p1",b=(r.round||0)+1,v=(r.pendingAttack.players||[]).map(B=>({name:B.name,note:je(B,B._line||"ATT"),portrait:Pe(B),job:B.job})),_=[...r.log||[]];_.push({type:"duel",isGoal:m,homeScored:m&&f===o,text:m?`⚽ BUT de ${r[f+"Name"]} ! (${r.pendingAttack.total} vs ${w.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${w.total})`,homePlayers:v,aiPlayers:C.map(B=>({name:B.name,note:je(B,B._line||"DEF"),portrait:Pe(B),job:B.job})),homeTotal:r.pendingAttack.total,aiTotal:w.total});const T=m?(r[f+"Score"]||0)+1:r[f+"Score"]||0,$={...r,[o+"Team"]:I,[f+"Score"]:T},A=Se($),S=A?"finished":x+"-attack",q=async()=>{await j({[o+"Team"]:I,[n+"Team"]:r[n+"Team"],[f+"Score"]:T,["selected_"+o]:[],modifiers:{...r.modifiers,[o]:{}},pendingAttack:null,phase:S,attacker:x,round:b,log:_}),(S==="finished"||A)&&await be({...r,[f+"Score"]:T})};if(m){const B=f===o,R=B?T:r[o+"Score"]||0,O=B?r[n+"Score"]||0:T;D.add(b),Le(v,R,O,B,q)}else await q()}function Z(I){return["MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function U(I){return["GK","DEF","MIL","ATT"].some(C=>(I[C]||[]).some(w=>!w.used))}function se(I){return U(I)&&!Z(I)}function he(I){const C=r[I+"Team"],w=r[(I==="p1"?"p2":"p1")+"Team"];return!!(Z(C)||!U(w)&&se(C))}function Se(I){const C=["MIL","ATT"].some(_=>(I.p1Team[_]||[]).some(T=>!T.used)),w=["MIL","ATT"].some(_=>(I.p2Team[_]||[]).some(T=>!T.used)),k=U(I.p1Team),f=U(I.p2Team);return!C&&!(!f&&k)&&(!w&&!(!k&&f))}function Me(I){const C=I.p1Score||0,w=I.p2Score||0;return C===w?null:C>w?y.home_id:y.away_id}async function be(I){try{const C=Me(I),w=C?y.home_id===C?y.away_id:y.home_id:null;await E.from("matches").update({status:"finished",winner_id:C,home_score:I.p1Score||0,away_score:I.p2Score||0}).eq("id",i),C&&w&&updateEvolutiveCards(C,w).catch(()=>{})}catch(C){console.error("[PvP] finishMatch:",C)}}function ze(){var f;const I=r[o+"Score"],C=r[n+"Score"],w=I>C,k=I===C;et(e),e.innerHTML=`
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      </div>`}const Ce=(ee,ce)=>ce?qe(130,175):ke(ee,130,175),Re=(ee,ce)=>ce?qe(68,95):ke(ee,68,95),Fe=q?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Oe=T?be(n)?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${A.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${Fe};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:$?`<button id="pvp-action" style="${Fe};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${A.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${_}</div>`,De=T&&!be(n)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':T||$?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${A.length}/3 sélectionné(s)</div>`:"",Ke=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${q?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ft(f,u[n+"Formation"],Ne,S,300,300,$e)}
      </div>
        ...
        </div>`}if(T&&((Be=u.pendingAttack)!=null&&Be.players)){const Te=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let A=!1;const S=()=>{A||(A=!0,_.remove(),setTimeout(()=>v(),50))};_.addEventListener("click",S),setTimeout(S,3500)}function Ae(f,m,x){var V,ie;const b=(u.gcDefs||[]).find(ae=>{var fe;return ae.name===f||((fe=ae.name)==null?void 0:fe.toLowerCase().trim())===(f==null?void 0:f.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[b==null?void 0:b.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[b==null?void 0:b.color]||"#b06ce0",T=(b==null?void 0:b.name)||f,$=(b==null?void 0:b.effect)||((V=Ve[f])==null?void 0:V.desc)||"",A=b!=null&&b.image_url?`/manager-wars/icons/${b.image_url}`:null,S=((ie=Ve[f])==null?void 0:ie.icon)||"⚡",B=m===n?"Vous":u[m+"Name"]||"Adversaire",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",R.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${m.map(v=>{const _={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[v._line]||"#555",T=je(v,v._line)+(v.boost||0);return`<div class="bp-item" data-cid="${v.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${_};overflow:hidden;cursor:pointer">
      ...
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(ke=B.querySelector("#psub-close"))==null||ke.addEventListener("click",()=>B.remove()),(qe=B.querySelector("#pout-up"))==null||qe.addEventListener("click",()=>{$>0&&($--,R())}),(Ce=B.querySelector("#pout-down"))==null||Ce.addEventListener("click",()=>{$<_.length-1&&($++,R())}),(Re=B.querySelector("#pin-up"))==null||Re.addEventListener("click",()=>{S>0&&(S--,R())}),(Fe=B.querySelector("#pin-down"))==null||Fe.addEventListener("click",()=>{S<T.length-1&&(S++,R())});const $e=(De,Ke,Ne,He)=>{const Ue=B.querySelector("#"+De);if(!Ue)return;let Je=0;Ue.addEventListener("touchstart",Ze=>{Je=Ze.touches[0].clientY},{passive:!0}),Ue.addEventListener("touchend",Ze=>{const Qe=Ze.changedTouches[0].clientY-Je;if(Math.abs(Qe)<30)return;const nt=Ke();Qe<0&&nt<He-1?(Ne(nt+1),R()):Qe>0&&nt>0&&(Ne(nt-1),R())},{passive:!0})};$e("pin-panel",()=>S,De=>S=De,T.length),$e("pout-panel",()=>$,De=>$=De,_.length),(Oe=B.querySelector("#psub-confirm"))==null||Oe.addEventListener("click",async De=>{if(De.preventDefault(),De.stopPropagation(),q)return;q=!0;const Ke=_[$],Ne=T[S];if(!Ke||!Ne)return;const He=Ke._line,Ue=(x[He]||[]).findIndex(Qe=>Qe.cardId===Ke.cardId);if(Ue===-1){p("Erreur : joueur introuvable","error"),B.remove();return}const Je={...Ne,_line:He,position:Ke.position,used:!1,boost:0};x[He].splice(Ue,1,Je);const Ze=[...b,Ne.cardId];B.remove(),ne(Ke,Ne,async()=>{await de({[n+"Team"]:x,[g+"Team"]:u[g+"Team"],["usedSubIds_"+n]:Ze})})})}document.body.appendChild(B),R()}function ne(f,m,x){const b={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const _=(A,S,q)=>`<div style="text-align:center">
