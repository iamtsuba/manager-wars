...
import{s as T,F as ki,i as Ht,k as eo,l as nt,m as ji,f as Nt,n as Lo,T as ci,j as Io,o as Mo,b as jo}from"./formation-links-BZe0pGr4.js";const Co="/";function Ci(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,m,a,o,y;const s=n==="login";e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",d=>{d.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{n(),e("match",{matchMode:d.dataset.mode})})})}const Ft="/",Di={GK:Ft+"cards/card-GK.png",DEF:Ft+"cards/card-DEF.png",MIL:Ft+"cards/card-MIL.png",ATT:Ft+"cards/card-ATT.png"},Wo={GK:"#aaaaaa",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Jo(e){if(!(e!=null&&e.face))return null;const t=e.face.replace(/^public\//,"").replace(/^\//,"");return Ft+t}function Xo(e){return!e||e.length<2?null:`https://flagcdn.com/48x36/${e.slice(0,2).toLowerCase()}.png`}function Zo(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co",i=((n=e==null?void 0:e.clubs)==null?void 0:n.logo_url)||(e==null?void 0:e.clubLogo);return i?i.startsWith("http")?i:`${t}/storage/v1/object/public/assets/clubs/${i}`:null}function Gi(e,t,i=0){if(!t)return 0;const n=`note_${t.toLowerCase()}`;return(Number(e[n])||0)+(t===e.job||t===e.job2?i:0)}function Qo(e,t){return t?t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code:!1}function Ai(e,t={}){var oe;const{width:i=160,showStad:n=!1,stadDef:d=null,used:s=!1,extraNote:r=0}=t;if(!e)return`<div style="width:${i}px;height:${Math.round(i*1.295)}px;border-radius:8px;background:#111;opacity:0.3"></div>`;const l=i/507,m=Math.round(i*657/507),a=J=>Math.round(J*l)+"px",o=(J,R)=>(J/R*100).toFixed(2)+"%",y=e._line||e.job||"MIL",p=Wo[y]||"#D4A017",x=Di[y]||Di.MIL,_=e._evolution_bonus??e.evolution_bonus??0,f=n&&(e.stadiumBonus||Qo(e,d))?10:0,c=Gi(e,y,_)+r+f,z=f>0?"#E87722":"#fff",u=e.job2&&e.job2!==y?e.job2:null,I=u?Gi(e,u,_)+r+f:null,F=Jo(e),C=Xo(e.country_code),q=Zo(e),j=(e.firstname||"").toUpperCase(),N=(e.surname_encoded||e.name||"").toUpperCase(),Z=s?"opacity:0.35;":"",K=N.length>10?36:N.length>7?42:48,ne=a(K);return`<div style="position:relative;width:${i}px;height:${m}px;flex-shrink:0;${Z}user-select:none">
  ...
  <div style="position:absolute;top:${o(38,657)};left:0;right:0;text-align:center;z-index:2;padding:0 ${a(50)}">
    <span style="font-size:${a(18)};font-weight:700;color:${p};letter-spacing:${a(2)};line-height:1;text-shadow:0 1px 3px #000">${j}</span>
  </div>

  <!-- Nom : sous le prénom -->
  <div style="position:absolute;top:${o(60,657)};left:0;right:0;text-align:center;z-index:2;padding:0 ${a(16)}">
    <span style="font-size:${ne};font-weight:900;color:#fff;line-height:1;text-shadow:0 2px 8px #000;font-family:Arial Black,Arial;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block">${N}</span>
  </div>

  <!-- Portrait : zone centrale, réduit pour rester dans la partie haute de l'octogone -->
  ${F?`<img src="${F}"
    style="position:absolute;top:${o(152,657)};left:50%;transform:translateX(-50%);
    width:${a(240)};height:${o(270,657)};object-fit:cover;object-position:top center;z-index:2"
    onerror="this.style.display='none'">`:""}

  <!-- Note principale : superposée dans l'octogone du template (centre x=254, y=539 sur 507x657) -->
  <div style="position:absolute;
    left:${o(145,507)};right:${o(145,507)};
    top:${o(450,657)};bottom:${o(43,657)};
    z-index:3;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:0">
    <span style="font-size:${a(I!==null?56:68)};font-weight:900;color:${z};font-family:Arial Black,Arial;line-height:1;text-shadow:0 2px 6px rgba(0,0,0,0.8)">${c}</span>
    ${I!==null?`<span style="font-size:${a(26)};font-weight:900;color:#bb2020;font-family:Arial Black,Arial;line-height:1">${I}</span>`:""}
  </div>
  ...
  <div style="position:absolute;
    left:${o(22,507)};
    top:${o(468,657)};
    width:${o(100,507)};height:${o(95,657)};
    z-index:3;
    clip-path:polygon(30% 0%,70% 0%,100% 30%,100% 70%,70% 100%,30% 100%,0% 70%,0% 30%);
    background:${p};display:flex;align-items:center;justify-content:center;overflow:hidden">
    ${C?`<img src="${C}" style="width:85%;height:75%;object-fit:cover">`:`<span style="font-size:${a(22)}">🌍</span>`}
  </div>
  ...
  <div style="position:absolute;
    ...
    clip-path:polygon(30% 0%,70% 0%,100% 30%,100% 70%,70% 100%,30% 100%,0% 70%,0% 30%);
    background:${p};display:flex;align-items:center;justify-content:center;overflow:hidden">
    ${q?`<img src="${q}" style="width:80%;height:80%;object-fit:contain">`:`<span style="font-size:${a(13)};font-weight:900;color:#fff">${(((oe=e.clubs)==null?void 0:oe.encoded_name)||e.clubName||"").slice(0,3).toUpperCase()}</span>`}
  </div>
    ...
    ${Ai(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(U=>U.card_type==="player"&&U.player),o=(l||[]).filter(U=>U.card_type==="game_changer"),y=(l||[]).filter(U=>U.card_type==="formation"),p=(l||[]).filter(U=>U.card_type==="stadium"),{data:x}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(x||[]).forEach(U=>{_[U.name]=U});const{data:f}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(f||[]).forEach(U=>{c[U.id]=U}),p.forEach(U=>{U.stadium_def&&(c[U.stadium_id]=U.stadium_def)});const z=Object.keys(ki),u=Object.keys(He),I={};a.forEach(U=>{const ee=U.player.id;I[ee]=(I[ee]||0)+1}),new Set(Object.keys(I).map(U=>String(U)));const F=new Set(y.map(U=>U.formation)),C=new Set(o.map(U=>U.gc_type));let q="player",j="Tous",N="",Z=!1;function K(){return[...a].sort((U,ee)=>{const xe=Yt.indexOf(U.player.job),de=Yt.indexOf(ee.player.job);return xe!==de?xe-de:(U.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function ne(){return[...m||[]].sort((U,ee)=>{const xe=Yt.indexOf(U.job),de=Yt.indexOf(ee.job);return xe!==de?xe-de:(U.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function oe(){return K().filter(U=>{const ee=U.player,xe=j==="Tous"||ee.job===j,de=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&de})}function J(){return ne().filter(U=>{const ee=j==="Tous"||U.job===j,xe=!N||`${U.firstname} ${U.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",ee=>{N=ee.target.value.toLowerCase(),G()}),e.querySelectorAll(".filter-btn").forEach(ee=>{ee.addEventListener("click",()=>{j=ee.dataset.job,R(),G()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{Z=!Z,R(),G()})):(U.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{Z=!Z,R(),G()})))}function G(){const U=document.getElementById("col-grid");U&&(q==="player"?Te(U):q==="formation"?se(U):q==="stadium"?ue(U):pe(U))}function ae(U,ee,xe,de,ge){const ie=document.getElementById("col-grid"),ce=document.getElementById("col-big");if(!ie||!ce)return;var Le=0;function Ie(){const Ce=window.innerWidth>=768,Ae=document.getElementById("col-big"),qe=document.getElementById("col-grid");Ce&&Ae&&(Ae.style.minHeight="420px",Ae.style.flex="1 1 auto"),Ce&&qe&&(qe.style.height=Math.round(310*.76+16)+"px",qe.style.flexShrink="0",qe.style.overflowX="auto",qe.style.overflowY="hidden",qe.style.alignItems="center",qe.style.padding="8px 16px"),ce.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+ee(U[Le])+"</div>";var Ge=ce.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Ge&&Ge.addEventListener("click",function(){de(U[Le])}),requestAnimationFrame(function(){var Se=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!Se||!ce)){var B=ce.clientHeight-8,$=ce.clientWidth-24,g=Se.offsetHeight,b=Se.offsetWidth;if(g>0&&b>0&&B>40){var h=Ce?2.2:1,v=Math.min(B/g,$/b,h);Se.style.transform="scale("+v.toFixed(3)+")",Se.style.transformOrigin="top center"}}}),ie.innerHTML=U.map(function(Se,B){var $=B===Le,g="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+($?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+B+'" style="'+g+'">'+xe(Se,$)+"</div>"}).join(""),ie.querySelectorAll(".col-mini-item").forEach(function(Se){Se.addEventListener("click",function(){Le=Number(Se.dataset.idx),Ie(),Se.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}Ie()}function me(U){var ee=window.innerWidth>=768?.76:.54,xe;if(!U||U._fake){var de=U?U.player:null;if(!de)return"";xe=Ri(de)}else xe=fi(U,"");return'<div style="display:inline-block;zoom:'+ee+';pointer-events:none;line-height:0">'+xe+"</div>"}function _e(U,ee,xe){ee=ee||100,xe=xe||140;var de=Ht[U]||{},ge={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},ie=Math.max(3,Math.round(ee*.06)),ce=Object.entries(de).map(function(Ie){var Ce=Ie[0],Ae=Ie[1],qe=Ce.replace(/\d+$/,""),Ge=ge[qe]||"#888",Se=Math.round(Ae.x*ee),B=Math.round(Ae.y*xe);return'<circle cx="'+Se+'" cy="'+B+'" r="'+ie+'" fill="'+Ge+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),Le=Math.max(1,Math.round(ee/50));return'<svg viewBox="0 0 '+ee+" "+xe+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+ee+'" height="'+xe+'" fill="#1A6B3C"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.02)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/><line x1="0" y1="'+Math.round(xe*.5)+'" x2="'+ee+'" y2="'+Math.round(xe*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><ellipse cx="'+Math.round(ee*.5)+'" cy="'+Math.round(xe*.5)+'" rx="'+Math.round(ee*.18)+'" ry="'+Math.round(xe*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+Le+'"/><rect x="'+Math.round(ee*.2)+'" y="'+Math.round(xe*.82)+'" width="'+Math.round(ee*.6)+'" height="'+Math.round(xe*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+Le+'"/>'+ce+"</svg>"}function we(U,ee,xe){var de=xe>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+xe+"</div>":"",ge=ee?'data-form-id="'+ee.id+'"':"",ie=U.length>7?14:U.length>5?16:19,ce=!!ee;return"<div "+ge+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(ce?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(ce?"":"filter:grayscale(1);opacity:0.5")+'">'+de+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(ce?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+ie+"px;font-weight:900;color:"+(ce?"#1A6B3C":"#aaa")+';line-height:1">'+U+'</div></div><div style="flex:1;overflow:hidden;background:'+(ce?"#1A6B3C":"#ccc")+'">'+_e(U,140,220)+"</div></div>"}function ve(U,ee){var xe=window.innerWidth>=768?.76:.54,de=140,ge=305,ie=Math.round(ge*.22),ce=ge-ie,Le=U.length>7?10:13,Ie=_e(U,de,ce),Ce=ee?"1.5px solid #2a7a40":"1px solid #ddd",Ae=ee?"":"filter:grayscale(1);opacity:0.45;",qe=ee?"#1A6B3C":"#bbb",Ge="#fff";return'<div style="display:inline-block;zoom:'+xe+';line-height:0;pointer-events:none"><div style="width:'+de+"px;height:"+ge+"px;border-radius:6px;border:"+Ce+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+Ae+'"><div style="height:'+ie+"px;background:"+qe+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+Le+"px;font-weight:900;color:"+Ge+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(de-4)+'px">'+U+'</span></div><div style="height:'+ce+'px;overflow:hidden;flex-shrink:0">'+Ie+"</div></div></div>"}function Te(U){if(Z){const ee=J();if(!ee.length){U.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const xe=ee.map(de=>a.find(ge=>ge.player.id===de.id)||{_fake:!0,player:de,id:"fake-"+de.id});ae(xe,de=>de._fake?Ri(de.player):fi(de,""),de=>de._fake?me({player:de.player,id:"x",_fake:!0}):me(de),de=>{de._fake||Oi(de,a,I,t)})}else{const ee=oe();if(!ee.length){U.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const xe={};ee.forEach(ge=>{const ie=ge.player.id;xe[ie]||(xe[ie]=[]),xe[ie].push(ge)});const de=Object.values(xe).map(ge=>an(ge));ae(de,ge=>{const ie=I[ge.player.id]||1,ce=ie>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${ie}</div>`:"",Ie=a.filter(Ce=>Ce.player.id===ge.player.id&&Ce.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return fi(ge,ce+Ie)},ge=>me(ge),ge=>Oi(ge,a,I,t))}}function se(U){const ee=Z?z:[...F];if(!ee.length){U.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const xe=ee.map(de=>({formation:de,card:y.find(ge=>ge.formation===de)||null,owned:F.has(de)}));ae(xe,({formation:de,card:ge,owned:ie})=>we(de,ie?ge:null,ie?y.filter(ce=>ce.formation===de).length:0),({formation:de,owned:ge})=>ve(de,ge),({card:de,owned:ge})=>{ge&&de&&un(de,y,t,s)})}function pe(U){const ee=Object.keys(_),xe=Z?ee.length?ee:u:[...C];if(!xe.length){U.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const de=xe.map(ge=>({type:ge,gc:He[ge]||{icon:"⚡",desc:""},def:_[ge]||null,owned:C.has(ge),card:o.find(ie=>ie.gc_type===ge)||null}));ae(de,({type:ge,gc:ie,def:ce,owned:Le,card:Ie})=>{var h;const Ce=Le?o.filter(v=>v.gc_type===ge).length:0,Ae=Ce>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${Ce}</div>`:"",qe=(ce==null?void 0:ce.gc_type)==="ultra_game_changer",Ge={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},Se={purple:"#b06ce0",light_blue:"#00d4ef"},B=Ge[ce==null?void 0:ce.color]||Ge.purple,$=Se[ce==null?void 0:ce.color]||Se.purple,g=(ce==null?void 0:ce.effect)||ie.desc||"",b=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:((h=ce==null?void 0:ce.club)==null?void 0:h.logo_url)||(ce!=null&&ce.country_code?`https://flagcdn.com/w80/${ce.country_code.toLowerCase()}.png`:null);return Le&&Ie?`<div data-gc-id="${Ie.id}" data-gc-type="${ge}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${$};background:${B};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${$}66;cursor:pointer">
          ${Ae}
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Wt=1e3;function un(e,t,i,n){var _,f,c;const{state:d,toast:s,closeModal:r,navigate:l,refreshProfile:m}=i,a=e.formation,o={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function y(){const z=Ht[a]||{},u=ki[a]||[],I=290,F=360,C=20;function q(N){const Z=z[N];return Z?{x:Z.x*I,y:Z.y*F}:null}let j=`<svg width="${I}" height="${F}" viewBox="0 0 ${I} ${F}" xmlns="http://www.w3.org/2000/svg">`;for(const[N,Z]of u){const K=q(N),ne=q(Z);!K||!ne||(j+=`<line x1="${K.x}" y1="${K.y}" x2="${ne.x}" y2="${ne.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const N of Object.keys(z)){const Z=q(N);if(!Z)continue;const K=N.replace(/\d+/,""),ne=o[K]||"#555";j+=`<circle cx="${Z.x}" cy="${Z.y}" r="${C}" fill="${ne}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,j+=`<text x="${Z.x}" y="${Z.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${K}</text>`}return j+="</svg>",j}const p=t.filter(z=>z.formation===a);p.length;const x=!e.is_for_sale;n(`Formation ${a}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(_=document.getElementById("direct-sell-form-btn"))==null||_.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${a} pour ${Wt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const z=p.find(I=>!I.is_for_sale)||p[0];if(!z){s("Aucune carte à vendre","error");return}await T.from("market_listings").delete().eq("card_id",z.id),await T.from("transfer_history").delete().eq("card_id",z.id);const{error:u}=await T.from("cards").delete().eq("id",z.id);if(u){s(u.message,"error");return}await T.from("users").update({credits:(d.profile.credits||0)+Wt}).eq("id",d.profile.id),await m(),s(`+${Wt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),r(),l("collection")}),(f=document.getElementById("market-sell-form-btn"))==null||f.addEventListener("click",async()=>{const z=parseInt(document.getElementById("sell-price-form").value);if(!z||z<1){s("Prix invalide","error");return}await T.from("cards").update({is_for_sale:!0,sale_price:z}).eq("id",e.id),await T.from("market_listings").insert({seller_id:d.profile.id,card_id:e.id,price:z}),s("Carte mise en vente sur le marché !","success"),r(),l("collection")}),(c=document.getElementById("cancel-sell-form-btn"))==null||c.addEventListener("click",async()=>{await T.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await T.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),s("Annonce retirée","success"),r(),l("collection")})}async function Oi(e,t,i,n){var me,_e,we,ve,Te;const{state:d,toast:s,openModal:r,closeModal:l,navigate:m,refreshProfile:a}=n,o=e.player,y=t.filter(se=>se.player.id===o.id),p=y.length,x=e.evolution_bonus||0,_=Math.max((Number(o.note_g)||0)+(o.job==="GK"||o.job2==="GK"?x:0),(Number(o.note_d)||0)+(o.job==="DEF"||o.job2==="DEF"?x:0),(Number(o.note_m)||0)+(o.job==="MIL"||o.job2==="MIL"?x:0),(Number(o.note_a)||0)+(o.job==="ATT"||o.job2==="ATT"?x:0)),f=o.rarity||"normal",{data:c}=await T.from("sell_price_configs").select("*").eq("rarity",f).lte("note_min",_).gte("note_max",_).order("note_min",{ascending:!1}).limit(1);((me=c==null?void 0:c[0])==null?void 0:me.price)??rn[f];const z=o.rarity!=="legende";ln(o);const u=((o.rarity==="pepite"||o.rarity==="papyte")&&e.current_note!=null?e.current_note:ui(o,o.job))+x,I=o.rarity==="pepite"||o.rarity==="papyte",F=o.job2?(I?co(e,sn(o.job2)):ui(o,o.job2))+(ui(o,o.job2)>0?x:0):null;pi[o.job],o.job2&&pi[o.job2];const C=on[o.rarity]||"#ccc";dn[o.country_code]||o.country_code;const q=e.evolution_bonus||0,N=u+q,Z=F||0,K=Z>0?Z+q:0,ne=y.map(se=>se.id);let oe={};if(ne.length){const{data:se}=await T.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",ne).order("transferred_at",{ascending:!0});(se||[]).forEach(pe=>{oe[pe.card_id]||(oe[pe.card_id]=[]),oe[pe.card_id].push(pe)})}const J=se=>{const pe=se.transferred_at?new Date(se.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",ue=se.source==="booster"?"Booster":se.price?se.price.toLocaleString("fr"):"—";return`
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${y.map((se,pe)=>{const ue=oe[se.id]||[],U=se.is_for_sale,ee=ue.length?ue[ue.length-1]:null,de=(o.rarity==="pepite"||o.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",l);let G=new Set;const ae=()=>{const se=G.size,pe=document.getElementById("sell-action-panel");if(!pe)return;pe.style.display=se>0?"block":"none",document.getElementById("sell-selected-count").textContent=se;const ue=document.getElementById("evolve-btn");ue&&(ue.textContent=`⬆️ Évoluer ${se>1?"(+"+se+")":""}`)};document.querySelectorAll(".expl-check").forEach(se=>{se.addEventListener("change",()=>{const pe=se.dataset.id;se.checked?G.add(pe):G.delete(pe);const ue=se.closest(".exemplaire-row");ue&&(ue.style.borderColor=se.checked?"#1A6B3C":"#eee"),ae()})}),document.querySelectorAll(".exemplaire-row").forEach(se=>{se.addEventListener("click",pe=>{if(pe.target.closest("button")||pe.target.tagName==="INPUT")return;const ue=se.querySelector(".expl-check");ue&&!ue.disabled&&(ue.checked=!ue.checked,ue.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(se=>{se.addEventListener("click",pe=>{pe.stopPropagation();const ue=document.querySelector(`.expl-hist[data-hist="${se.dataset.idx}"]`);ue&&(ue.style.display=ue.style.display==="none"?"flex":"none")})}),(we=document.getElementById("evolve-btn"))==null||we.addEventListener("click",async()=>{if(p<=1)return;const se=[...G];if(!se.length)return;if(G.has(e.id)){const ge=document.createElement("div");ge.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",ge.innerHTML=`
  ...
  `,document.body.appendChild(d);let s=!1;const r=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let m=!1;const a=R=>R.touches&&R.touches[0]?R.touches[0].clientX:R.clientX;function o(R){s||(m=!0,l.style.opacity="1",y(R))}function y(R){if(!m||s)return;const G=r.getBoundingClientRect(),ae=a(R)-G.left,me=Math.max(0,Math.min(1,ae/G.width));l.style.width=me*G.width+"px",me>=.82&&x()}function p(){s||(m=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{s||(l.style.transition="")},220))}function x(){var G;if(s)return;s=!0,m=!1,l.style.width="100%",l.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const R=document.getElementById("cut-hint");R&&(R.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",z(0)},620)}r.addEventListener("pointerdown",o),window.addEventListener("pointermove",y),window.addEventListener("pointerup",p),r.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",y,{passive:!0}),window.addEventListener("touchend",p);let _=0,f=!1;const c=new Set;function z(R){_=R,document.getElementById("reveal-phase").style.display="flex",u(),I(R,0),N()}function u(){const R=document.getElementById("card-dots");R&&(R.innerHTML=e.map((G,ae)=>`<div class="card-dot" data-i="${ae}" style="width:8px;height:8px;border-radius:50%;background:${ae===_?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),R.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>C(parseInt(G.dataset.i)))))}function I(R,G){var ue;const ae=e[R],me=document.getElementById("card-counter"),_e=document.getElementById("card-track");me&&(me.textContent=`Carte ${R+1} / ${e.length}`);const we=document.getElementById("reveal-btns");we&&(we.style.display=R===e.length-1?"flex":"none");const ve=ae.card_type==="player"&&((ue=ae.player)==null?void 0:ue.rarity)==="legende",Te=!c.has(R);c.add(R);let se=0;if(ae.card_type==="player"&&ae.player){const U=ae.player,ee=U.job||"ATT";se=Number(ee==="GK"?U.note_g:ee==="DEF"?U.note_d:ee==="MIL"?U.note_m:U.note_a)||0}const pe=U=>{_e.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${ve?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${zn(ae)}</div>
        ...
        </div>`;const ee=document.getElementById("current-card-wrap");G!==0?(ee.style.transition="none",ee.style.transform=`translateX(${G>0?100:-100}%)`,requestAnimationFrame(()=>{ee.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ee.style.transform="translateX(0)"})):ee.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),U||ve?K():ne(),u()};Te&&se>6&&ae.card_type==="player"&&ae.player?F(ae,()=>pe(!0)):pe(!1)}function F(R,G){var se;f=!0;const ae=R.player,me=`https://flagsapi.com/${ae.country_code}/flat/64.png`,_e=(se=ae.clubs)==null?void 0:se.logo_url,we=document.getElementById("walkout-overlay"),ve=document.getElementById("walkout-stage");if(!we||!ve){f=!1,G();return}we.style.display="flex";const Te=()=>{const pe=ve.firstElementChild;pe&&(pe.classList.remove("wo-in"),pe.classList.add("wo-out"))};ve.innerHTML=`<img class="wo-in" src="${me}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(Te,2e3),setTimeout(()=>{var pe;ve.innerHTML=_e?`<img class="wo-in" src="${_e}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((pe=ae.clubs)==null?void 0:pe.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(Te,4450),setTimeout(()=>{we.style.display="none",ve.innerHTML="",f=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),G()},4900)}function C(R){if(f||R<0||R>=e.length||R===_)return;const G=R>_?1:-1;_=R,I(R,G)}function q(){C(_+1)}function j(){C(_-1)}function N(){const R=document.getElementById("card-viewport");if(!R||R._swipeBound)return;R._swipeBound=!0;let G=0,ae=0,me=0,_e=!1;const we=ue=>ue.touches?ue.touches[0].clientX:ue.clientX,ve=ue=>ue.touches?ue.touches[0].clientY:ue.clientY,Te=ue=>{_e=!0,G=we(ue),ae=ve(ue),me=0},se=ue=>{if(!_e)return;me=we(ue)-G;const U=ve(ue)-ae;if(Math.abs(me)<Math.abs(U))return;const ee=document.getElementById("current-card-wrap");ee&&(ee.style.transition="none",ee.style.transform=`translateX(${me*.6}px) rotate(${me*.02}deg)`)},pe=()=>{if(!_e)return;_e=!1;const ue=document.getElementById("current-card-wrap"),U=55;me<=-U&&_<e.length-1?q():me>=U&&_>0?j():ue&&(ue.style.transition="transform .2s ease",ue.style.transform="translateX(0)")};R.addEventListener("pointerdown",Te),R.addEventListener("pointermove",se),R.addEventListener("pointerup",pe),R.addEventListener("pointercancel",pe),R.addEventListener("touchstart",Te,{passive:!0}),R.addEventListener("touchmove",se,{passive:!0}),R.addEventListener("touchend",pe),R.addEventListener("click",ue=>{if(Math.abs(me)>8)return;const U=R.getBoundingClientRect();ue.clientX-U.left>U.width/2?q():j()})}let Z=null;function K(){const R=document.getElementById("fireworks-canvas");if(!R)return;R.width=window.innerWidth,R.height=window.innerHeight;const G=R.getContext("2d"),ae=[];function me(){const we=Math.random()*R.width,ve=Math.random()*R.height*.6,Te=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],se=Te[Math.floor(Math.random()*Te.length)];for(let pe=0;pe<60;pe++){const ue=Math.PI*2/60*pe,U=2+Math.random()*5;ae.push({x:we,y:ve,vx:Math.cos(ue)*U,vy:Math.sin(ue)*U,alpha:1,color:se,size:2+Math.random()*3})}}me(),Z=setInterval(me,600);function _e(){if(document.getElementById("fireworks-canvas")){G.clearRect(0,0,R.width,R.height);for(let we=ae.length-1;we>=0;we--){const ve=ae[we];if(ve.x+=ve.vx,ve.y+=ve.vy+.08,ve.vy*=.98,ve.alpha-=.018,ve.alpha<=0){ae.splice(we,1);continue}G.globalAlpha=ve.alpha,G.fillStyle=ve.color,G.beginPath(),G.arc(ve.x,ve.y,ve.size,0,Math.PI*2),G.fill()}G.globalAlpha=1,(Z!==null||ae.length>0)&&requestAnimationFrame(_e)}}_e()}function ne(){Z!==null&&(clearInterval(Z),Z=null);const R=document.getElementById("fireworks-canvas");R&&R.getContext("2d").clearRect(0,0,R.width,R.height)}if(n){const R=document.getElementById("reveal-btns");R&&(R.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(J=document.getElementById("reveal-next"))==null||J.addEventListener("click",()=>{ne(),d.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ne(),d.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ne(),d.remove(),i("boosters")})}function zn(e){var t,i,n,d;if(e.card_type==="player"&&e.player)return kn(e);if(e.card_type==="game_changer"){const s=e._gcDef,r=(s==null?void 0:s.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},m={purple:"#b06ce0",light_blue:"#00d4ef"},a=l[s==null?void 0:s.color]||l.purple,o=m[s==null?void 0:s.color]||m.purple,y=(s==null?void 0:s.name)||e.gc_type||"Game Changer",p=(s==null?void 0:s.effect)||((t=bi[e.gc_type])==null?void 0:t.desc)||"",x=s!=null&&s.image_url?`/icons/${s.image_url}`:null,_=((i=bi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${a};border-radius:14px;border:3px solid ${o};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${o}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",r).order("slot_order"),m=[...new Set((l||[]).filter(p=>{var x,_;return((x=p.card)==null?void 0:x.card_type)==="stadium"&&((_=p.card)==null?void 0:_.stadium_id)}).map(p=>p.card.stadium_id))],a={};if(m.length){const{data:p}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",m);(p||[]).forEach(x=>{a[x.id]=x}),(l||[]).forEach(x=>{var _,f;((_=x.card)==null?void 0:_.card_type)==="stadium"&&((f=x.card)!=null&&f.stadium_id)&&(x.card._stadiumDef=a[x.card.stadium_id]||null)})}let o=0;function y(){var C,q,j,N,Z,K,ne;const p=s[o],x=(l||[]).filter(oe=>oe.deck_id===p.id),_=x.filter(oe=>{var J;return oe.is_starter&&((J=oe.card)==null?void 0:J.player)}).map(oe=>vi(oe.card,oe.position)),f=x.find(oe=>{var J;return((J=oe.card)==null?void 0:J.card_type)==="formation"}),c=p.formation||((C=f==null?void 0:f.card)==null?void 0:C.formation)||"4-4-2";let z=_.length>=11?bt(_,c):null,u=((q=p.stadium_card)==null?void 0:q.stadium_def)||null;u&&z&&(z=Tt(z,u));const I=_.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${y}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${s?`<img src="${s}" style="width:${y-4}px;height:${y-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,y-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${K}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const x=48,_=64,f=13,c=16,z={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[F,C]of Object.entries(a)){const q=y(F);if(!q||!C)continue;const j=F.replace(/[0-9]/g,""),N=jt[j]||"#555",Z=r.includes(C.cardId),K=i==="attack"&&(["MIL","ATT"].includes(j)||Z)&&!C.used||i==="defense"&&["GK","DEF","MIL"].includes(j)&&!C.used,ne=n.includes(C.cardId);let oe;i==="attack"?oe=Z?Math.max(1,Number(C.note_a)||0):j==="MIL"?Number(C.note_m)||0:Number(C.note_a)||0:i==="defense"?oe=j==="GK"?Number(C.note_g)||0:j==="MIL"?Number(C.note_m)||0:Number(C.note_d)||0:oe=Number(j==="GK"?C.note_g:j==="DEF"?C.note_d:j==="MIL"?C.note_m:C.note_a)||0,oe=oe+(C.boost||0),C.stadiumBonus&&(i==="attack"&&(j==="ATT"||j==="MIL")||i==="defense"&&(j==="GK"||j==="DEF"||j==="MIL")?oe+=10:i||(oe+=10));const J=(q.x-x/2).toFixed(1),R=(q.y-_/2).toFixed(1),G=z[C==null?void 0:C.rarity]||z.normal;if(C.used){const se=typeof import.meta<"u"&&"/"||"/",ue=`${typeof window<"u"&&((I=window.location)==null?void 0:I.origin)||""}${se}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="#161616"/>`,p+=`<image href="${ue}" xlink:href="${ue}" x="${J}" y="${R}" width="${x}" height="${_}" preserveAspectRatio="xMidYMid slice"/>`,p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="none" stroke="${G}" stroke-width="2" opacity="0.7"/>`,p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`;continue}const ae=ne?.45:1,me=ne?"#FFD700":G,_e=ne?3:(C==null?void 0:C.rarity)==="legende"||(C==null?void 0:C.rarity)==="légende"||(C==null?void 0:C.rarity)==="pepite"||(C==null?void 0:C.rarity)==="pépite"?2.5:2,we=_-f-c;p+=`<defs><clipPath id="cp-${F}"><rect x="${J}" y="${(q.y-_/2+f).toFixed(1)}" width="${x}" height="${we}"/></clipPath></defs>`,p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="${N}" opacity="${ae}"/>`;const ve=Ne(C);ve&&(p+=`<image href="${ve}" xlink:href="${ve}" x="${J}" y="${(q.y-_/2+f).toFixed(1)}" width="${x}" height="${we}" clip-path="url(#cp-${F})" preserveAspectRatio="xMidYMin slice"/>`),p+=`<rect x="${J}" y="${R}" width="${x}" height="${f}" rx="4" fill="rgba(255,255,255,0.92)"/>`,p+=`<text x="${q.x.toFixed(1)}" y="${(q.y-_/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(C.name||"").slice(0,9)}</text>`;const Te=(q.y+_/2-c).toFixed(1);p+=`<rect x="${J}" y="${Te}" width="${x}" height="${c}" fill="rgba(255,255,255,0.92)"/>`;{const se=ei(C.country_code);se?p+=`<image href="${se}" xlink:href="${se}" x="${(q.x-20).toFixed(1)}" y="${(q.y+_/2-c+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:p+=`<text x="${(q.x-13).toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${_o(C.country_code)}</text>`;const pe=C.stadiumBonus?"#E87722":"#111";p+=`<text x="${q.x.toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${pe}" font-family="Arial Black">${oe}</text>`;const ue=wo(C);ue?p+=`<image href="${ue}" xlink:href="${ue}" x="${(q.x+x/2-14).toFixed(1)}" y="${(q.y+_/2-c+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:C.clubName&&(p+=`<text x="${(q.x+14).toFixed(1)}" y="${(q.y+_/2-c/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(C.clubName||"").slice(0,3).toUpperCase()}</text>`),C.stadiumBonus&&(p+=`<rect x="${(q.x-x/2).toFixed(1)}" y="${(q.y-_/2).toFixed(1)}" width="${x}" height="${_}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="${ne?"rgba(255,255,255,0.12)":"none"}" stroke="${me}" stroke-width="${_e}" opacity="${ae}"/>`,K&&(p+=`<rect x="${J}" y="${R}" width="${x}" height="${_}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${ne?"selected":""}" data-card-id="${C.cardId}" data-role="${j}" style="cursor:pointer"/>`)}const u=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-u} ${-u} ${d+u*2} ${s+u*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${p}
  ...
  <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
    ...
    <style>@keyframes ld{0%,20%{opacity:0.3}50%{opacity:1}80%,100%{opacity:0.3}}.loading-dots::after{content:'...';animation:ld 1.4s infinite}</style>
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${u.map((j,N)=>{const Z=N<u.length-1?nt(j,u[N+1]):null,K=!Z||Z==="#ff3333"||Z==="#cc2222",ne=Z==="#00ff88"?"+2":Z==="#FFD700"?"+1":"";l(j,q),j.stadiumBonus||q&&(q.club_id&&String(j.club_id)===String(q.club_id)||q.country_code&&(j.country_code,q.country_code));const oe=j.evolution_bonus||j._evolution_bonus||0;return`
          ...
          ${N<u.length-1?`<div class="duel-link duel-link-${C}" data-idx="${N}" style="position:relative;width:18px;height:5px;border-radius:3px;background:${K?"rgba(255,255,255,0.12)":Z};flex-shrink:0;opacity:0;transition:opacity .3s ease;box-shadow:${K?"none":`0 0 8px ${Z}`}">
            ${ne?`<span style="position:absolute;top:-13px;left:50%;transform:translateX(-50%);font-size:8px;font-weight:900;color:${Z}">${ne}</span>`:""}
          </div>`:""}
          `}).join("")}
      </div>
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const G=window.innerWidth>=700,ae=(U,ee,xe)=>{var B,$;const de=(t.gcDefs||[]).find(g=>g.name===U.gc_type),ge={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[de==null?void 0:de.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ie={purple:"#b06ce0",light_blue:"#00d4ef"}[de==null?void 0:de.color]||"#b06ce0",ce=(de==null?void 0:de.name)||U.gc_type,Le=(de==null?void 0:de.effect)||((B=He[U.gc_type])==null?void 0:B.desc)||"",Ie=de!=null&&de.image_url?`/icons/${de.image_url}`:null,Ce=(($=He[U.gc_type])==null?void 0:$.icon)||"⚡",Ae=Math.round(xe*.22),qe=Math.round(xe*.22),Ge=xe-Ae-qe,Se=ce.length>12?7:9;return`<div class="gc-mini" data-gc-id="${U.id}" data-gc-type="${U.gc_type}"
        ...
        </div>`},me=(U,ee)=>{var xe;return`<div id="boost-card"
          ...
          </div>`},_e=(U,ee)=>ee?me(130,175):ae(U,130,175),we=(U,ee)=>ee?me(68,95):ae(U,68,95),ve=G?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Te=_?`<button id="btn-results" style="${ve};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:y?`<div style="${ve};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:z?`<button id="btn-pass" style="${ve};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:p?`<button id="btn-action" style="${ve};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:x?`<button id="btn-action" style="${ve};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${ve};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,se=p||x?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",pe=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${G?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(G=>{var ae,me,_e;if(G.type==="duel"){const we=G.isGoal,ve=G.homeScored?"#FFD700":we?"#ff6b6b":"rgba(255,255,255,0.3)",Te=G.homeScored?"⚽ BUT !":we?"⚽ BUT IA !":(ae=G.homePlayers)!=null&&ae.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${we?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${ve};margin-bottom:4px">
                <div style="font-size:9px;color:${ve};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${Te}</div>
  ...
  `,document.body.appendChild(n);let o=!1;const y=()=>{o||(o=!0,n.remove(),i())};n.addEventListener("click",y),setTimeout(y,2e3)}function Bt(e,t="rgba(0,0,0,0.8)"){const i=document.createElement("div");i.style.cssText=`position:fixed;bottom:110px;left:50%;transform:translateX(-50%);background:${t};color:#fff;padding:8px 18px;border-radius:20px;font-size:13px;z-index:1200;pointer-events:none;text-align:center;max-width:80vw;white-space:nowrap`,i.textContent=e,document.body.appendChild(i),setTimeout(()=>i.remove(),2200)}function gi(e,t,i,n=null,d=null){var x,_;if(t.phase!=="attack"){Bt("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){Bt(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const s=Object.entries(t.homeTeam).flatMap(([f,c])=>(c||[]).filter(z=>z.used).map(z=>({...z,_line:z._line||f}))),r=t.homeSubs.filter(f=>!t.usedSubIds.includes(f.cardId));if(!s.length){Bt("Aucun joueur utilisé à remplacer");return}if(!r.length){Bt("Aucun remplaçant disponible");return}let l=Math.max(0,s.findIndex(f=>f.cardId===d));const m=((x=s[l])==null?void 0:x._line)||((_=s[l])==null?void 0:_.job);let a=n?Math.max(0,r.findIndex(f=>f.cardId===n)):Math.max(0,r.findIndex(f=>f.job===m)),o=!1;const y=document.createElement("div");y.id="sub-overlay",y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function p(){var C,q,j,N,Z,K;const f=s[l],c=r[a],z=Math.min(130,Math.round((window.innerWidth-90)/2)),u=Math.round(z*1.35),I=ne=>`background:rgba(255,255,255,0.12);border:none;color:${ne?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ne?"default":"pointer"};flex-shrink:0`;y.innerHTML=`
    ...
    </div>`,(C=y.querySelector("#sub-close"))==null||C.addEventListener("click",()=>y.remove()),(q=y.querySelector("#out-up"))==null||q.addEventListener("click",()=>{l>0&&(l--,p())}),(j=y.querySelector("#out-down"))==null||j.addEventListener("click",()=>{l<s.length-1&&(l++,p())}),(N=y.querySelector("#in-up"))==null||N.addEventListener("click",()=>{a>0&&(a--,p())}),(Z=y.querySelector("#in-down"))==null||Z.addEventListener("click",()=>{a<r.length-1&&(a++,p())});const F=(ne,oe,J,R)=>{const G=y.querySelector("#"+ne);if(!G)return;let ae=0;G.addEventListener("touchstart",me=>{ae=me.touches[0].clientY},{passive:!0}),G.addEventListener("touchend",me=>{const _e=me.changedTouches[0].clientY-ae;if(Math.abs(_e)<30)return;const we=oe();_e<0&&we<R-1?(J(we+1),p()):_e>0&&we>0&&(J(we-1),p())},{passive:!0})};F("in-panel",()=>a,ne=>a=ne,r.length),F("out-panel",()=>l,ne=>l=ne,s.length),(K=y.querySelector("#sub-confirm"))==null||K.addEventListener("click",ne=>{if(ne.preventDefault(),ne.stopPropagation(),o)return;o=!0;const oe=s[l],J=r[a];if(!oe||!J)return;let R=null,G=-1;for(const[me,_e]of Object.entries(t.homeTeam)){const we=(_e||[]).findIndex(ve=>ve.cardId===oe.cardId);if(we!==-1){R=me,G=we;break}}if(G===-1||!R){Bt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),y.remove();return}const ae={...J,_line:R,_col:oe._col||0,used:!1,boost:0};t.homeTeam[R].splice(G,1,ae),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(J.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:oe.name,firstname:oe.firstname,note:Ee(oe,R),portrait:Ne(oe),job:oe.job,country_code:oe.country_code,rarity:oe.rarity,clubName:oe.clubName,clubLogo:oe.clubLogo},inPlayer:{name:J.name,firstname:J.firstname,note:Ee(J,R),portrait:Ne(J),job:J.job,country_code:J.country_code,rarity:J.rarity,clubName:J.clubName,clubLogo:J.clubLogo},text:`🔄 ${J.firstname} ${J.name} remplace ${oe.firstname} ${oe.name}`}),y.remove(),Wn(oe,J,()=>Je(e,t,i))})}document.body.appendChild(y),p()}function Jn(e,t,i,n,d){var _,f;const s=(n.gcDefs||[]).find(c=>c.name===t),r=He[t]||{icon:"⚡",desc:"Carte spéciale."},l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[s==null?void 0:s.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",m={purple:"#b06ce0",light_blue:"#00d4ef"}[s==null?void 0:s.color]||"#b06ce0",a=(s==null?void 0:s.name)||t,o=(s==null?void 0:s.effect)||r.desc,y=s!=null&&s.image_url?`/icons/${s.image_url}`:null,p=r.icon||"⚡",x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",x.innerHTML=`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const m=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",m),setTimeout(m,3500)}async function Gt(e,t,i){var o,y;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,r=d?"victoire":s?"nul":"defaite",l=en(t.mode,r);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?n.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const m={credits:(n.profile.credits||0)+l,matches_played:(n.profile.matches_played||0)+1};d?m.wins=(n.profile.wins||0)+1:s?m.draws=(n.profile.draws||0)+1:m.losses=(n.profile.losses||0)+1,await T.from("users").update(m).eq("id",n.profile.id),await i.refreshProfile();const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",a.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const F=async(N=!0)=>{_=!0,f&&(T.removeChannel(f),f=null),N&&await T.rpc("cancel_matchmaking",{p_user_id:y.profile.id}).catch(()=>{})};(j=document.getElementById("mm-cancel"))==null||j.addEventListener("click",async()=>{try{await F(!0)}catch{}Ve(e),p("home")});const C=async(N,Z,K)=>{if(_)return;_=!0,f&&(T.removeChannel(f),f=null);const ne=document.getElementById("mm-status");ne&&(ne.textContent="Adversaire trouvé !"),await new Promise(oe=>setTimeout(oe,600)),e.isConnected&&ko(e,t,N,K,r,l,a,o,m)};if(a){const N=[{range:50,delay:0},{range:100,delay:15e3},{range:200,delay:3e4},{range:400,delay:45e3},{range:800,delay:6e4}];let Z=0,K=!1;const ne=async()=>{if(_||K)return;const{range:oe}=N[Z],J=document.getElementById("mm-range");J&&(J.textContent=`Plage MMR : ±${oe}`);const{data:R,error:G}=await T.rpc("try_matchmake_ranked",{p_user_id:y.profile.id,p_deck_id:i,p_mmr:c,p_range:oe});if(console.log("[Ranked] try_matchmake_ranked result:",R,"error:",JSON.stringify(G)),_)return;if(G||!(R!=null&&R.success)){x("Erreur matchmaking ranked","error"),Ve(e),p("home");return}if(R.matched){K=!0,C(R.match_id,R.opponent_id,!1);return}const ae=document.getElementById("mm-status");if(ae&&(ae.textContent="En attente d'un adversaire..."),f||(f=T.channel("matchmaking-"+y.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${y.profile.id}`},me=>{const _e=me.new;_e.status==="matched"&&_e.match_id&&!K&&(K=!0,C(_e.match_id,_e.matched_with,!0))}).subscribe()),Z<N.length-1){const me=N[Z+1].delay-N[Z].delay;Z++,setTimeout(()=>{!_&&!K&&ne()},me)}};await ne()}else{const{data:N,error:Z}=await T.rpc("try_matchmake",{p_user_id:y.profile.id,p_deck_id:i});if(Z||!(N!=null&&N.success)){x("Erreur de matchmaking","error"),Ve(e),p("home");return}if(N.matched){C(N.match_id,N.opponent_id,!1);return}const K=document.getElementById("mm-status");K&&(K.textContent="En attente d'un autre joueur..."),f=T.channel("matchmaking-"+y.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${y.profile.id}`},ne=>{const oe=ne.new;oe.status==="matched"&&oe.match_id&&C(oe.match_id,oe.matched_with,!0)}).subscribe()}}async function ir(e,t,i){const{state:n,navigate:d,toast:s}=t;try{(T.getChannels?T.getChannels():[]).forEach(a=>{const o=a.topic||"";(o.includes("matchmaking")||o.includes("pvp-match")||o.includes("friend-invite"))&&T.removeChannel(a)})}catch{}const{data:r}=await T.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!r){s("Match introuvable","error"),d("home");return}if(r.status==="finished"){s("Ce match est terminé","info"),d("home");return}const l=r.home_id===n.profile.id;ko(e,t,i,l,[],[])}async function ko(e,t,i,n,d=[],s=[],r=!1,l=null,m=null){const{state:a,navigate:o,toast:y}=t,p=n?"p1":"p2",x=n?"p2":"p1",_=(d||[]).map($=>$.id),f=(d||[]).map($=>({id:$.id,gc_type:$.gc_type,_gcDef:$._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:c}=await T.from("matches").select("*").eq("id",i).single();if(!c){y("Match introuvable","error"),o("home");return}async function z(){var Y,te;console.log("[PvP] buildGameState match:",{id:c.id,home_deck_id:c.home_deck_id,away_deck_id:c.away_deck_id,mode:c.mode,is_ranked:c.is_ranked});const[{data:$,error:g},{data:b,error:h},{data:v},{data:w}]=await Promise.all([T.rpc("get_deck_for_match",{p_deck_id:c.home_deck_id}),T.rpc("get_deck_for_match",{p_deck_id:c.away_deck_id}),T.from("users").select("id,pseudo,club_name").eq("id",c.home_id).single(),T.from("users").select("id,pseudo,club_name").eq("id",c.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",g==null?void 0:g.message,"p2:",h==null?void 0:h.message,"p1D:",(Y=$==null?void 0:$.starters)==null?void 0:Y.length,"p2D:",(te=b==null?void 0:b.starters)==null?void 0:te.length);const k=Q=>{const fe=Number(Q.evolution_bonus)||0;return{cardId:Q.card_id,position:Q.position,id:Q.id,firstname:Q.firstname,name:Q.surname_encoded,country_code:Q.country_code,club_id:Q.club_id,job:Q.job,job2:Q.job2,note_g:(Number(Q.note_g)||0)+(Q.job==="GK"||Q.job2==="GK"&&Number(Q.note_g)>0?fe:0),note_d:(Number(Q.note_d)||0)+(Q.job==="DEF"||Q.job2==="DEF"&&Number(Q.note_d)>0?fe:0),note_m:(Number(Q.note_m)||0)+(Q.job==="MIL"||Q.job2==="MIL"&&Number(Q.note_m)>0?fe:0),note_a:(Number(Q.note_a)||0)+(Q.job==="ATT"||Q.job2==="ATT"&&Number(Q.note_a)>0?fe:0),evolution_bonus:fe,rarity:Q.rarity,skin:Q.skin,hair:Q.hair,hair_length:Q.hair_length,clubName:Q.club_encoded_name||null,clubLogo:Q.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},A=(($==null?void 0:$.starters)||[]).map(Q=>k(Q)),E=((b==null?void 0:b.starters)||[]).map(Q=>k(Q)),L=($==null?void 0:$.formation)||"4-4-2",S=(b==null?void 0:b.formation)||"4-4-2";let M=bt(A,L),D=bt(E,S);const V=(($==null?void 0:$.subs)||[]).map(Q=>k(Q)),W=((b==null?void 0:b.subs)||[]).map(Q=>k(Q)),H=($==null?void 0:$.stadium_def)||(n?m:null),P=(b==null?void 0:b.stadium_def)||(n?null:m);return H&&(M=Tt(M,H),Ct(V,H)),P&&(D=Tt(D,P),Ct(W,P)),{p1Team:M,p2Team:D,p1Subs:V,p2Subs:W,p1Formation:L,p2Formation:S,p1Name:(v==null?void 0:v.club_name)||(v==null?void 0:v.pseudo)||"Joueur 1",p2Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?_:[],gc_p2:n?[]:_,gcCardsFull_p1:n?f:[],gcCardsFull_p2:n?[]:f,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:s||[],lastActionAt:new Date().toISOString()}}let u=c.game_state&&Object.keys(c.game_state).length?c.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!u,"match.status:",c.status,"home_id:",c.home_id,"away_id:",c.away_id,"myId:",a.profile.id),!u)if(n){u=await z(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((u==null?void 0:u.p1Team)||{}));const{data:$}=await T.from("matches").select("game_state").eq("id",i).single();!($!=null&&$.game_state)||!Object.keys($.game_state).length?await T.from("matches").update({game_state:u,turn_user_id:c.home_id}).eq("id",i):u=$.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let $=0;$<30&&!u;$++){await new Promise(b=>setTimeout(b,400));const{data:g}=await T.from("matches").select("game_state").eq("id",i).single();g!=null&&g.game_state&&Object.keys(g.game_state).length&&(u=g.game_state),$%5===0&&console.log("[PvP] away - poll",$,"game_state:",!!(g!=null&&g.game_state))}if(!u){y("Erreur de synchronisation","error"),o("home");return}u.gc_p2=_,u.gcCardsFull_p2=f,await T.from("matches").update({game_state:u}).eq("id",i)}let I=!1,F=null,C=!1;const q=new Set,j=new Set;async function N($){var S,M;try{T.removeChannel(Z)}catch{}const g=u[p+"Score"]||0,b=u[x+"Score"]||0;let h,v;$.winner_id?(h=$.winner_id===a.profile.id,v=!1):$.forfeit?(h=g>b,v=!1):(v=g===b,h=g>b);let w="";if(r&&n)try{const{data:D}=await T.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.home_id).single(),{data:V}=await T.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",c.away_id).single();if(D&&V){const W=h?1:v?.5:0,H=1-W,P=D.placement_matches<10,Y=V.placement_matches<10,te=ji(D.mmr,D.mmr_deviation,D.mmr_volatility,V.mmr,V.mmr_deviation,W===1?1:W===0?0:.5,P),Q=ji(V.mmr,V.mmr_deviation,V.mmr_volatility,D.mmr,D.mmr_deviation,H===1?1:H===0?0:.5,Y);await T.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:v?null:h?c.home_id:c.away_id,p_home_id:c.home_id,p_away_id:c.away_id,p_home_delta:te.delta,p_away_delta:Q.delta,p_home_new_rd:te.newRd,p_away_new_rd:Q.newRd,p_home_new_vol:te.newSigma,p_away_new_vol:Q.newSigma});const fe=te.delta,ye=te.newMmr,be=Nt(ye),ke=fe>=0?"+":"",Be=fe>=0?"#4caf50":"#ff6b6b",Fe=Nt(D.mmr);w=`
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}if(k&&((re=u.pendingAttack)!=null&&re.players)){const he=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
      ...
      </div>`;function Pe(){const X=e.querySelector(".match-screen");if(!X)return;const O=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);X.style.height=O+"px",X.style.minHeight=O+"px",X.style.maxHeight=O+"px",X.style.overflow="hidden";const re=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");re&&he&&(he.style.paddingBottom=re.offsetHeight+"px")}if(Pe(),setTimeout(Pe,120),setTimeout(Pe,400),C||(C=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Pe),window.visualViewport.addEventListener("scroll",Pe)),window.addEventListener("resize",Pe)),function(){const O=e.querySelector(".terrain-wrapper svg");O&&(O.removeAttribute("width"),O.removeAttribute("height"),O.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",O.setAttribute("viewBox","-26 -26 352 352"),O.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(X=>{X.addEventListener("click",()=>{if(!k&&!A)return;const O=X.dataset.cardId,re=X.dataset.role,he=($[re]||[]).find(tt=>tt.cardId===O);if(!he||he.used)return;const $e=fe.includes(O);if(k&&!["MIL","ATT"].includes(re)&&!$e)return;Array.isArray(u["selected_"+p])||(u["selected_"+p]=[]);const Ze=u["selected_"+p],Qe=Ze.findIndex(tt=>tt.cardId===O);Qe>-1?Ze.splice(Qe,1):Ze.length<3&&Ze.push({...he,_role:re}),me()})}),e.querySelectorAll(".match-used-hit").forEach(X=>{X.addEventListener("click",()=>U(X.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(X=>{X.addEventListener("click",()=>U())}),(We=e.querySelector("#pvp-sub-open"))==null||We.addEventListener("click",()=>U()),e.querySelectorAll(".pvp-gc-mini").forEach(X=>{X.addEventListener("click",()=>pe(X.dataset.gcId,X.dataset.gcType))}),(ot=e.querySelector("#pvp-boost-card"))==null||ot.addEventListener("click",()=>ue()),(pt=e.querySelector("#pvp-action"))==null||pt.addEventListener("click",X=>{k?X.currentTarget.dataset.pass==="1"||!Ae(p)?ge():ie():A&&ce()}),(ut=e.querySelector("#pvp-quit"))==null||ut.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&ne()}),(ft=e.querySelector("#pvp-view-opp"))==null||ft.addEventListener("click",()=>xe()),(le=e.querySelector("#pvp-toggle-history"))==null||le.addEventListener("click",()=>de()),F&&(clearInterval(F),F=null),(k||A)&&!I){let X=30,O=!1;const re=()=>document.getElementById("pvp-timer"),he=()=>{re()&&(re().textContent=X+"s",re().style.color=O?"#ff4444":"#fff")};he(),F=setInterval(()=>{X--,X<0?O?(clearInterval(F),F=null,k&&!Ae(p)?ge():ne()):(O=!0,X=15,he()):he()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    </div>`,p==="p1"&&setTimeout(async()=>{await K({phase:"midfield"})},5e3)}let we=!1;function ve(){if(we)return;const $=u[p+"Team"].MIL||[],g=u[x+"Team"].MIL||[];function b(P){return P.reduce((Y,te)=>Y+Ee(te,"MIL"),0)}function h(P){let Y=0;for(let te=0;te<P.length-1;te++){const Q=nt(P[te],P[te+1]);Q==="#00ff88"?Y+=2:Q==="#FFD700"&&(Y+=1)}return Y}const v=b($)+h($),w=b(g)+h(g),k=v>=w;function A(P,Y,te){return`<div id="duel-row-${te}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}return`<div style="font-size:11px;color:${le.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${le.type==="goal"?700:400};padding:3px 2px">${le.text||""}</div>`}const Ye=(()=>{var X,O;if(k&&((X=f.pendingAttack)!=null&&X.players)){const re=f.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
  ...
  </div>`,(z=document.getElementById("ml-create-btn"))==null||z.addEventListener("click",()=>pr(e,t)),e.querySelectorAll(".ml-tab").forEach(u=>u.addEventListener("click",()=>At(e,t,u.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(u=>u.addEventListener("click",()=>ht(e,t,u.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(u=>u.addEventListener("click",I=>{I.stopPropagation(),Eo(e,t,u.dataset.join,u.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(u=>u.addEventListener("click",I=>{I.stopPropagation(),_i(e,t,u.dataset.delete,u.dataset.name,i)}))}function oi(e,t,i=!1){var r,l;const n=e.creator_id===t,d=e.pot||0,s=((l=(r=e.mini_league_members)==null?void 0:r[0])==null?void 0:l.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      </div>`}function ke(O,re){return`<div id="pvp-boost-card"
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ...
        </div>`}return`<div style="font-size:11px;color:${O.type==="goal"?"#FFD700":"rgba(255,255,255,0.65)"};font-weight:${O.type==="goal"?700:400};padding:3px 2px">${O.text||""}</div>`}const Oe=(()=>{var re,he;if(E&&((re=c.pendingAttack)!=null&&re.players)){const $e=c.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
      ...
      </div>`;function We(){const O=e.querySelector(".match-screen");if(!O)return;const re=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);O.style.height=re+"px",O.style.minHeight=re+"px",O.style.maxHeight=re+"px",O.style.overflow="hidden";const he=e.querySelector("#mobile-action-bar"),$e=e.querySelector("#mobile-play-area");he&&$e&&($e.style.paddingBottom=he.offsetHeight+"px")}if(We(),setTimeout(We,120),setTimeout(We,400),C||(C=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",We),window.visualViewport.addEventListener("scroll",We)),window.addEventListener("resize",We)),function(){const re=e.querySelector(".terrain-wrapper svg");re&&(re.removeAttribute("width"),re.removeAttribute("height"),re.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",re.setAttribute("viewBox","-26 -26 352 352"),re.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(O=>{O.addEventListener("click",()=>{if(!A&&!E)return;const re=O.dataset.cardId,he=O.dataset.role,$e=(g[he]||[]).find(rt=>rt.cardId===re);if(!$e||$e.used)return;const Ze=ye.includes(re);if(A&&!["MIL","ATT"].includes(he)&&!Ze)return;Array.isArray(c["selected_"+o])||(c["selected_"+o]=[]);const Qe=c["selected_"+o],tt=Qe.findIndex(rt=>rt.cardId===re);tt>-1?Qe.splice(tt,1):Qe.length<3&&Qe.push({...$e,_role:he}),me()})}),e.querySelectorAll(".match-used-hit").forEach(O=>{O.addEventListener("click",()=>U(O.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(O=>{O.addEventListener("click",()=>U())}),(ot=e.querySelector("#pvp-sub-open"))==null||ot.addEventListener("click",()=>U()),e.querySelectorAll(".pvp-gc-mini").forEach(O=>{O.addEventListener("click",()=>pe(O.dataset.gcId,O.dataset.gcType))}),(pt=e.querySelector("#pvp-boost-card"))==null||pt.addEventListener("click",()=>ue()),(ut=e.querySelector("#pvp-action"))==null||ut.addEventListener("click",O=>{A?O.currentTarget.dataset.pass==="1"||!Ae(o)?ge():ie():E&&ce()}),(ft=e.querySelector("#pvp-quit"))==null||ft.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&ne()}),(le=e.querySelector("#pvp-view-opp"))==null||le.addEventListener("click",()=>xe()),(X=e.querySelector("#pvp-toggle-history"))==null||X.addEventListener("click",()=>de()),F&&(clearInterval(F),F=null),(A||E)&&!z){let O=30,re=!1;const he=()=>document.getElementById("pvp-timer"),$e=()=>{he()&&(he().textContent=O+"s",he().style.color=re?"#ff4444":"#fff")};$e(),F=setInterval(()=>{O--,O<0?re?(clearInterval(F),F=null,A&&!Ae(o)?ge():ne()):(re=!0,O=15,$e()):$e()},1e3)}}function _e(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    </div>`,o==="p1"&&setTimeout(async()=>{await K({phase:"midfield"})},5e3)}let we=!1;function ve(){if(we)return;const g=c[o+"Team"].MIL||[],b=c[y+"Team"].MIL||[];function h(Y){return Y.reduce((te,Q)=>te+Ee(Q,"MIL"),0)}function v(Y){let te=0;for(let Q=0;Q<Y.length-1;Q++){const fe=nt(Y[Q],Y[Q+1]);fe==="#00ff88"?te+=2:fe==="#FFD700"&&(te+=1)}return te}const w=h(g)+v(g),k=h(b)+v(b),A=w>=k;function E(Y,te,Q){return`<div id="duel-row-${Q}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    </div>`,(w=document.getElementById("pvp-home"))==null||w.addEventListener("click",()=>{try{T.removeChannel(Z)}catch{}Ve(e),l("mini-league",a?{openLeagueId:a}:{})})}me()}const wr="/",_r=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let m="buy";const a=()=>{var f,c,z,u,I,F,C;return{name:(((f=document.getElementById("flt-name"))==null?void 0:f.value)||"").toLowerCase().trim(),club:(((c=document.getElementById("flt-club"))==null?void 0:c.value)||"").toLowerCase().trim(),country:(((z=document.getElementById("flt-country"))==null?void 0:z.value)||"").toLowerCase().trim(),job:((u=document.getElementById("flt-job"))==null?void 0:u.value)||"",rarity:((I=document.getElementById("flt-rarity"))==null?void 0:I.value)||"",note1:parseInt((F=document.getElementById("flt-note1"))==null?void 0:F.value)||0,note2:parseInt((C=document.getElementById("flt-note2"))==null?void 0:C.value)||0}};function o(f){const c=a();return f.filter(z=>{var Z,K,ne;const u=(Z=z.card)==null?void 0:Z.player;if(!u)return!1;const I=`${u.firstname} ${u.surname_encoded}`.toLowerCase(),F=(((K=u.clubs)==null?void 0:K.encoded_name)||"").toLowerCase(),C=(u.country_code||"").toLowerCase(),q=((ne=z.card)==null?void 0:ne.evolution_bonus)||0,j=St(u,u.job,q),N=u.job2?St(u,u.job2,q):0;return!(c.name&&!I.includes(c.name)||c.club&&!F.includes(c.club)||c.country&&!C.includes(c.country)||c.job&&u.job!==c.job||c.rarity&&u.rarity!==c.rarity||c.note1&&j<c.note1||c.note2&&N<c.note2)})}function y(f){var C,q,j,N;const c=(C=f.card)==null?void 0:C.player;if(!c)return"";const z=((q=f.card)==null?void 0:q.evolution_bonus)||0,u=St(c,c.job,z),I=c.job2?St(c,c.job2,z):0,F=(i.profile.credits||0)>=f.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Ji(c.rarity)}
      ${Xt(u,c.job)}
      ${Xt(I,c.job2||null)}
      ${Xi(c.country_code)}
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const z=r||[];_.innerHTML=z.length>0?z.map((u,I)=>{const F=Nt(u.mmr??1e3),C=(u.ranked_wins||0)+(u.ranked_losses||0)+(u.ranked_draws||0),q=C>0?Math.round((u.ranked_wins||0)/C*100):0,j=u.id===i.profile.id,N=(u.placement_matches||0)<10;return`
