...
import{s as _,l as Gt,m as Ii,F as Si,r as Se,j as Jt,h as Ai,n as An,o as Mn,T as gi,k as jn,p as Cn,b as Bn}from"./formation-links-yJiMLlPw.js";const qn="/";function Ni(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,l,c,d,m;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var x;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),m=((x=document.getElementById("setup-club"))==null?void 0:x.value)||"MW",y=m.trim().split(" ").filter(Boolean),g=y.length>=2?(y[0][0]+y[1][0]).toUpperCase():m.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),d&&(d.textContent=g,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:m}=await _.from("users").select("id").eq("pseudo",c).maybeSingle();if(m){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:m}=await _.from("users").select("id").eq("club_name",c).maybeSingle();if(m){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),m=document.getElementById("step3-error"),y=document.getElementById("step3-finish");m.textContent="",y.disabled=!0,y.textContent="Création en cours…";try{const{error:g}=await _.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:a,credits:1e4});if(g)throw g;await Fn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(g){m.textContent=g.message,y.disabled=!1,y.textContent="🚀 Créer mon profil !"}})}async function Fn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await _.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Pn="modulepreload",Gn=function(e){return"/"+e},Oi={},rn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(l=>{if(l=Gn(l),l in Oi)return;Oi[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":Pn,c||(m.as="script"),m.crossOrigin="",m.href=l,s&&m.setAttribute("nonce",s),document.head.appendChild(m),c)return new Promise((y,g)=>{m.addEventListener("load",y),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Ut="#1A6B3C",Kt="#cc2222",Rn="#D4A017",Hi="#888";async function Nn(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`,await an(i,n,t),document.getElementById("btn-add-friend").addEventListener("click",()=>Hn(i,n)),document.getElementById("btn-accept-friend").addEventListener("click",()=>sn(i,n,null,t))}async function an(e,t,i={}){const{navigate:n}=i,r=e.user.id,{data:o,error:a}=await _.from("friendships").select("id, requester_id, addressee_id").eq("status","accepted").or(`requester_id.eq.${r},addressee_id.eq.${r}`),{count:s}=await _.from("friendships").select("id",{count:"exact",head:!0}).eq("addressee_id",r).eq("status","pending"),l=document.getElementById("pending-badge");l&&(s>0?(l.style.display="flex",l.textContent=s):l.style.display="none");const c=document.getElementById("friends-list");if(!c)return;if(a){console.error("[Friends] Erreur:",a),c.innerHTML=`<div style="color:${Kt};text-align:center;padding:16px">Erreur chargement : ${a.message}</div>`;return}const d=(o||[]).map(g=>g.requester_id===r?g.addressee_id:g.requester_id);let m={};if(d.length){const{data:g}=await _.from("users").select("id, pseudo, club_name, last_seen_at, club_color1, club_color2").in("id",d);(g||[]).forEach(x=>{m[x.id]=x})}const y=(o||[]).map(g=>({friendshipId:g.id,friend:m[g.requester_id===r?g.addressee_id:g.requester_id]||{pseudo:"?"}}));if(!y.length){c.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ${y.map(({friendshipId:g,friend:x})=>On(x,g)).join("")}
    </div>`,c.querySelectorAll("[data-stats]").forEach(g=>{g.addEventListener("click",()=>Un(e,g.dataset.stats,g.dataset.friendName))}),c.querySelectorAll("[data-match]").forEach(g=>{g.addEventListener("click",async()=>{const x=g.dataset.friendId,p=g.dataset.friendName;if(typeof n!="function"){t("Erreur navigation","error");return}const f=e.user.id,{data:b}=await _.from("friend_match_invites").select("id").eq("inviter_id",x).eq("invitee_id",f).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle(),v=!!b;console.log("[Friends] clic match",{fid:x,fname:p,isAccepting:v}),n("match",{matchMode:"friend",friendId:x,friendName:p,isAccepting:v})})})}function On(e,t){const i=e.club_name||e.pseudo||"?",n=e.pseudo||"",r=(n||i).slice(0,2).toUpperCase(),o=e.club_color2||Ut,a=e.club_color1||"#ffffff",s=e.last_seen_at?new Date(e.last_seen_at):null,l=s&&Date.now()-s.getTime()<3*60*1e3;return`
    ...
    ${ji()}`,document.body.appendChild(c);const m=()=>c.remove();c.querySelector("#pending-close").addEventListener("click",m),c.addEventListener("click",y=>{y.target===c&&m()}),c.querySelectorAll("[data-accept]").forEach(y=>{y.addEventListener("click",async()=>{const{error:g}=await _.from("friendships").update({status:"accepted"}).eq("id",y.dataset.accept);if(g){t("Erreur : "+g.message,"error");return}y.closest("div[style]").remove(),t("✅ Ami accepté !","success"),an(e,t,n),i&&i()})}),c.querySelectorAll("[data-decline]").forEach(y=>{y.addEventListener("click",async()=>{await _.from("friendships").delete().eq("id",y.dataset.decline),y.closest("div[style]").remove(),t("Demande refusée","info"),i&&i()})})}async function Un(e,t,i){const n=e.user.id,[r,o]=[n,t].sort(),a=n===r,{data:s}=await _.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",o).single(),l=e.profile.club_name||e.profile.pseudo||"Moi",c=s||{},d=a?c.wins_p1||0:c.wins_p2||0,m=a?c.wins_p2||0:c.wins_p1||0,y=c.draws||0,g=a?c.goals_p1||0:c.goals_p2||0,x=a?c.goals_p2||0:c.goals_p1||0,p=a?c.gc_used_p1||0:c.gc_used_p2||0,f=a?c.gc_used_p2||0:c.gc_used_p1||0,b=c.matches_total||0,v=(E,u,M,$=Ut,P=Kt)=>`
  ...
  <div class="home-dark" id="home-dark">
  ...
  </div>`,requestAnimationFrame(()=>{var m,y,g,x,p;const s=((m=window.visualViewport)==null?void 0:m.height)||window.innerHeight,l=((y=document.querySelector(".top-nav"))==null?void 0:y.offsetHeight)||56,c=((g=document.querySelector(".bottom-nav"))==null?void 0:g.offsetHeight)||60;if(e.querySelector(".home-inner")){const f=s-l-c;e.querySelector(".home-dark").style.minHeight=f+"px"}if(window.innerWidth<768){const f=((x=e.querySelector(".home-hero"))==null?void 0:x.offsetHeight)||60,b=e.querySelector(".ranked-tile");e.querySelector(".play-grid");const v=((p=e.querySelector(".home-footer"))==null?void 0:p.offsetHeight)||44,h=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((R,ne)=>{var ie;return R+(((ie=document.getElementById(ne))==null?void 0:ie.offsetHeight)||0)},0),E=12*5,u=s-l-c-f-v-h-E-32,M=Math.max(80,Math.round(u*.28)),$=Math.max(160,Math.round(u*.72)),P=Math.floor(($-10)/2);b&&(b.style.minHeight=b.style.maxHeight=M+"px"),e.querySelectorAll(".play-tile").forEach(R=>{R.style.minHeight=R.style.height=P+"px"}),e.querySelectorAll(".play-tile .play-icon").forEach(R=>{R.style.height=Math.round(P*.55)+"px"})}}),(o=document.getElementById("nav-rankings"))==null||o.addEventListener("click",()=>i("rankings")),(a=document.getElementById("nav-matches"))==null||a.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(s=>{s.addEventListener("click",()=>{s.style.transform="scale(.96)",setTimeout(()=>s.style.transform="",180);const l=s.dataset.action;if(l==="match-ai"){Xn(i);return}if(l==="match-random"){i("match",{matchMode:"random"});return}if(l==="match-friend"){i("friends");return}if(l==="mini-league"){i("mini-league");return}if(l==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await _.auth.signOut(),window.location.reload()}),ln(t,n),Wn(t,n,i),dn(t,n,i))}async function dn(e,t,i){const n=document.getElementById("ongoing-match-banner");if(!n)return;const r=e.profile.id,{data:o}=await _.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(o!=null&&o.length)){n.innerHTML="";return}const a=o.map(l=>l.home_id===r?l.away_id:l.home_id).filter(Boolean);let s={};if(a.length){const{data:l}=await _.from("users").select("id, pseudo, club_name").in("id",a);(l||[]).forEach(c=>{s[c.id]=c.club_name||c.pseudo})}n.innerHTML=o.map(l=>{const c=l.home_id===r?l.away_id:l.home_id,d=s[c]||"Adversaire",m=l.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
    ...
    ${Se(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(S=>S.card_type==="player"&&S.player),d=(s||[]).filter(S=>S.card_type==="game_changer"),m=(s||[]).filter(S=>S.card_type==="formation"),y=(s||[]).filter(S=>S.card_type==="stadium"),{data:g}=await _.from("gc_definitions").select("name,gc_type,color,effect,image_url"),x={};(g||[]).forEach(S=>{x[S.name]=S});const{data:p}=await _.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),f={};(p||[]).forEach(S=>{f[S.id]=S}),y.forEach(S=>{S.stadium_def&&(f[S.stadium_id]=S.stadium_def)});const b=Object.keys(Si),v=Object.keys(Me),h={};c.forEach(S=>{const q=S.player.id;h[q]=(h[q]||0)+1}),new Set(Object.keys(h).map(S=>String(S)));const E=new Set(m.map(S=>S.formation)),u=new Set(d.map(S=>S.gc_type));let M="player",$="Tous",P="",R=!1;function ne(){return[...c].sort((S,q)=>{const G=Zt.indexOf(S.player.job),X=Zt.indexOf(q.player.job);return G!==X?G-X:(S.player.surname_real||"").localeCompare(q.player.surname_real||"")})}function ie(){return[...l||[]].sort((S,q)=>{const G=Zt.indexOf(S.job),X=Zt.indexOf(q.job);return G!==X?G-X:(S.surname_real||"").localeCompare(q.surname_real||"")})}function Q(){return ne().filter(S=>{const q=S.player,G=$==="Tous"||q.job===$,X=!P||`${q.firstname} ${q.surname_real}`.toLowerCase().includes(P);return G&&X})}function j(){return ie().filter(S=>{const q=$==="Tous"||S.job===$,G=!P||`${S.firstname} ${S.surname_real}`.toLowerCase().includes(P);return q&&G})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function w(){const S=document.getElementById("col-filters");S&&(M==="player"?(S.innerHTML=`
          ...
          ${io.map(q=>`
            <button class="filter-btn" data-job="${q}"
              style="flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer;
                border:1.5px solid ${q===$?"var(--green)":"var(--gray-200)"};
                background:${q===$?"var(--green)":"#fff"};
                color:${q===$?"#fff":"var(--gray-600)"}">
              ${q}
            </button>`).join("")}
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",q=>{P=q.target.value.toLowerCase(),C()}),e.querySelectorAll(".filter-btn").forEach(q=>{q.addEventListener("click",()=>{$=q.dataset.job,w(),C()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{R=!R,w(),C()})):(S.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{R=!R,w(),C()})))}function C(){const S=document.getElementById("col-grid");S&&(M==="player"?ke(S):M==="formation"?W(S):M==="stadium"?N(S):J(S))}function U(S,q,G,X,V){const D=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!D||!O)return;var we=0;function _e(){const ye=window.innerWidth>=768,be=document.getElementById("col-big"),$e=document.getElementById("col-grid");ye&&be&&(be.style.minHeight="420px",be.style.flex="1 1 auto"),ye&&$e&&($e.style.height=Math.round(310*.76+16)+"px",$e.style.flexShrink="0",$e.style.overflowX="auto",$e.style.overflowY="hidden",$e.style.alignItems="center",$e.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+q(S[we])+"</div>";var Le=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");Le&&Le.addEventListener("click",function(){X(S[we])}),requestAnimationFrame(function(){var ge=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!ge||!O)){var Be=O.clientHeight-8,je=O.clientWidth-24,Oe=ge.offsetHeight,bt=ge.offsetWidth;if(Oe>0&&bt>0&&Be>40){var Je=ye?2.2:1.6,Rt=Math.min(Be/Oe,je/bt,Je);ge.style.transform="scale("+Rt.toFixed(3)+")",ge.style.transformOrigin="top center"}}}),D.innerHTML=S.map(function(ge,Be){var je=Be===we,Oe="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(je?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Be+'" style="'+Oe+'">'+G(ge,je)+"</div>"}).join(""),D.querySelectorAll(".col-mini-item").forEach(function(ge){ge.addEventListener("click",function(){we=Number(ge.dataset.idx),_e(),ge.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function re(S){var q=window.innerWidth>=768?.76:.54,G;if(!S||S._fake){var X=S?S.player:null;if(!X)return"";G=Wi(X)}else G=yi(S,"");return'<div style="display:inline-block;zoom:'+q+';pointer-events:none;line-height:0">'+G+"</div>"}function ae(S,q,G){q=q||100,G=G||140;var X=Jt[S]||{},V={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},D=Math.max(3,Math.round(q*.06)),O=Object.entries(X).map(function(_e){var ye=_e[0],be=_e[1],$e=ye.replace(/\d+$/,""),Le=V[$e]||"#888",ge=Math.round(be.x*q),Be=Math.round(be.y*G);return'<circle cx="'+ge+'" cy="'+Be+'" r="'+D+'" fill="'+Le+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),we=Math.max(1,Math.round(q/50));return'<svg viewBox="0 0 '+q+" "+G+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+q+'" height="'+G+'" fill="#1A6B3C"/><rect x="'+Math.round(q*.2)+'" y="'+Math.round(G*.02)+'" width="'+Math.round(q*.6)+'" height="'+Math.round(G*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/><line x1="0" y1="'+Math.round(G*.5)+'" x2="'+q+'" y2="'+Math.round(G*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><ellipse cx="'+Math.round(q*.5)+'" cy="'+Math.round(G*.5)+'" rx="'+Math.round(q*.18)+'" ry="'+Math.round(G*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+we+'"/><rect x="'+Math.round(q*.2)+'" y="'+Math.round(G*.82)+'" width="'+Math.round(q*.6)+'" height="'+Math.round(G*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+we+'"/>'+O+"</svg>"}function se(S,q,G){var X=G>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+G+"</div>":"",V=q?'data-form-id="'+q.id+'"':"",D=S.length>7?14:S.length>5?16:19,O=!!q;return"<div "+V+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+X+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+D+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+S+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+ae(S,140,220)+"</div></div>"}function de(S,q){var G=window.innerWidth>=768?.76:.54,X=140,V=305,D=Math.round(V*.22),O=V-D,we=S.length>7?10:13,_e=ae(S,X,O),ye=q?"1.5px solid #2a7a40":"1px solid #ddd",be=q?"":"filter:grayscale(1);opacity:0.45;",$e=q?"#1A6B3C":"#bbb",Le="#fff";return'<div style="display:inline-block;zoom:'+G+';line-height:0;pointer-events:none"><div style="width:'+X+"px;height:"+V+"px;border-radius:6px;border:"+ye+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+be+'"><div style="height:'+D+"px;background:"+$e+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+we+"px;font-weight:900;color:"+Le+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(X-4)+'px">'+S+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function ke(S){if(R){const q=j();if(!q.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const G=q.map(X=>c.find(V=>V.player.id===X.id)||{_fake:!0,player:X,id:"fake-"+X.id});U(G,X=>X._fake?Wi(X.player):yi(X,""),X=>X._fake?re({player:X.player,id:"x",_fake:!0}):re(X),X=>{X._fake||Xi(X,c,h,t)})}else{const q=Q();if(!q.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const G={};q.forEach(V=>{const D=V.player.id;G[D]||(G[D]=[]),G[D].push(V)});const X=Object.values(G).map(V=>oo(V));U(X,V=>{const D=h[V.player.id]||1,O=D>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${D}</div>`:"",_e=c.filter(ye=>ye.player.id===V.player.id&&ye.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return yi(V,O+_e)},V=>re(V),V=>Xi(V,c,h,t))}}function W(S){const q=R?b:[...E];if(!q.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const G=q.map(X=>({formation:X,card:m.find(V=>V.formation===X)||null,owned:E.has(X)}));U(G,({formation:X,card:V,owned:D})=>se(X,D?V:null,D?m.filter(O=>O.formation===X).length:0),({formation:X,owned:V})=>de(X,V),({card:X,owned:V})=>{V&&X&&po(X,m,t,o)})}function J(S){const q=Object.keys(x),G=R?q.length?q:v:[...u];if(!G.length){S.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const X=G.map(V=>({type:V,gc:Me[V]||{icon:"⚡",desc:""},def:x[V]||null,owned:u.has(V),card:d.find(D=>D.gc_type===V)||null}));U(X,({type:V,gc:D,def:O,owned:we,card:_e})=>{var Je;const ye=we?d.filter(Rt=>Rt.gc_type===V).length:0,be=ye>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${ye}</div>`:"",$e=(O==null?void 0:O.gc_type)==="ultra_game_changer",Le={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},ge={purple:"#b06ce0",light_blue:"#00d4ef"},Be=Le[O==null?void 0:O.color]||Le.purple,je=ge[O==null?void 0:O.color]||ge.purple,Oe=(O==null?void 0:O.effect)||D.desc||"",bt=O!=null&&O.image_url?`/icons/${O.image_url}`:((Je=O==null?void 0:O.club)==null?void 0:Je.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return we&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${V}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${je};background:${Be};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${je}66;cursor:pointer">
          ${be}
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(S=>{S.addEventListener("click",()=>{M=S.dataset.tab,$="Tous",P="",R=!1,e.querySelectorAll(".col-tab-btn").forEach(q=>{const G=q.dataset.tab===M;q.style.borderBottomColor=G?"var(--green)":"transparent",q.style.color=G?"var(--green)":"var(--gray-600)"}),w(),C()})}),w(),C()}function co(e,t,i){const n=Me[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,m=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ei=1e3;function po(e,t,i,n){var x,p,f;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function m(){const b=Jt[c]||{},v=Si[c]||[],h=290,E=360,u=20;function M(P){const R=b[P];return R?{x:R.x*h,y:R.y*E}:null}let $=`<svg width="${h}" height="${E}" viewBox="0 0 ${h} ${E}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,R]of v){const ne=M(P),ie=M(R);!ne||!ie||($+=`<line x1="${ne.x}" y1="${ne.y}" x2="${ie.x}" y2="${ie.y}"
        stroke="#FFD700" stroke-width="2.5" stroke-dasharray="4,3" opacity="0.85"/>`)}for(const P of Object.keys(b)){const R=M(P);if(!R)continue;const ne=P.replace(/\d+/,""),ie=d[ne]||"#555";$+=`<circle cx="${R.x}" cy="${R.y}" r="${u}" fill="${ie}" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>`,$+=`<text x="${R.x}" y="${R.y+4}" text-anchor="middle" font-size="9" font-weight="900" fill="white" font-family="Arial Black,Arial">${ne}</text>`}return $+="</svg>",$}const y=t.filter(b=>b.formation===c);y.length;const g=!e.is_for_sale;n(`Formation ${c}`,`<div style="background:linear-gradient(180deg,#1a6b3c,#0a3d1e);border-radius:12px;padding:16px;margin-bottom:14px;overflow-x:auto;text-align:center">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(x=document.getElementById("direct-sell-form-btn"))==null||x.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${c} pour ${ei.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const b=y.find(h=>!h.is_for_sale)||y[0];if(!b){o("Aucune carte à vendre","error");return}await _.from("market_listings").delete().eq("card_id",b.id),await _.from("transfer_history").delete().eq("card_id",b.id);const{error:v}=await _.from("cards").delete().eq("id",b.id);if(v){o(v.message,"error");return}await _.from("users").update({credits:(r.profile.credits||0)+ei}).eq("id",r.profile.id),await l(),o(`+${ei.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),s("collection")}),(p=document.getElementById("market-sell-form-btn"))==null||p.addEventListener("click",async()=>{const b=parseInt(document.getElementById("sell-price-form").value);if(!b||b<1){o("Prix invalide","error");return}await _.from("cards").update({is_for_sale:!0,sale_price:b}).eq("id",e.id),await _.from("market_listings").insert({seller_id:r.profile.id,card_id:e.id,price:b}),o("Carte mise en vente sur le marché !","success"),a(),s("collection")}),(f=document.getElementById("cancel-sell-form-btn"))==null||f.addEventListener("click",async()=>{await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await _.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),a(),s("collection")})}async function Xi(e,t,i,n){var re,ae,se,de,ke;const{state:r,toast:o,openModal:a,closeModal:s,navigate:l,refreshProfile:c}=n,d=e.player,m=t.filter(W=>W.player.id===d.id),y=m.length,g=e.evolution_bonus||0,x=Math.max((Number(d.note_g)||0)+(d.job==="GK"||d.job2==="GK"?g:0),(Number(d.note_d)||0)+(d.job==="DEF"||d.job2==="DEF"?g:0),(Number(d.note_m)||0)+(d.job==="MIL"||d.job2==="MIL"?g:0),(Number(d.note_a)||0)+(d.job==="ATT"||d.job2==="ATT"?g:0)),p=d.rarity||"normal",{data:f}=await _.from("sell_price_configs").select("*").eq("rarity",p).lte("note_min",x).gte("note_max",x).order("note_min",{ascending:!1}).limit(1);((re=f==null?void 0:f[0])==null?void 0:re.price)??no[p];const b=d.rarity!=="legende";so(d);const v=((d.rarity==="pepite"||d.rarity==="papyte")&&e.current_note!=null?e.current_note:xi(d,d.job))+g,h=d.rarity==="pepite"||d.rarity==="papyte",E=d.job2?(h?Zn(e,ro(d.job2)):xi(d,d.job2))+(xi(d,d.job2)>0?g:0):null;mi[d.job],d.job2&&mi[d.job2];const u=to[d.rarity]||"#ccc";ao[d.country_code]||d.country_code;const M=e.evolution_bonus||0,P=v+M,R=E||0,ne=R>0?R+M:0,ie=m.map(W=>W.id);let Q={};if(ie.length){const{data:W}=await _.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",ie).order("transferred_at",{ascending:!0});(W||[]).forEach(J=>{Q[J.card_id]||(Q[J.card_id]=[]),Q[J.card_id].push(J)})}const j=W=>{const J=W.transferred_at?new Date(W.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",N=W.source==="booster"?"Booster":W.price?W.price.toLocaleString("fr"):"—";return`
    <div style="display:flex;justify-content:space-between;align-items:flex-start;background:#f9f9f9;border-radius:8px;padding:8px 12px;gap:8px">
      ...
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:13px;font-weight:700;color:${W.source==="booster"?"var(--gray-600)":"var(--yellow)"}">${N}</div>
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${m.map((W,J)=>{const N=Q[W.id]||[],S=W.is_for_sale,q=N.length?N[N.length-1]:null,X=(d.rarity==="pepite"||d.rarity==="papyte")&&W.current_note!=null?` (☆${W.current_note})`:"";return`
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${P}${d.job2&&R>0?` / ${ne}`:""}`:`Note actuelle : ${P}${d.job2&&R>0?` / ${ne}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([W,J])=>{const N=mi[W],S=W==="GK"?"#fff":N,q=W===d.job||W===d.job2,G=(Number(J)||0)+(q&&M>0?M:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                <div style="width:48px;height:48px;border-radius:8px;background:#111;border:2.5px solid ${N};
                  display:flex;align-items:center;justify-content:center">
                  <span style="font-size:20px;font-weight:900;color:${S};font-family:Arial Black,Arial;line-height:1">${G}</span>
                </div>
    ...
    ${w}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ae=document.getElementById("close-detail"))==null||ae.addEventListener("click",s);let C=new Set;const U=()=>{const W=C.size,J=document.getElementById("sell-action-panel");if(!J)return;J.style.display=W>0?"block":"none",document.getElementById("sell-selected-count").textContent=W;const N=document.getElementById("evolve-btn");N&&(N.textContent=`⬆️ Évoluer ${W>1?"(+"+W+")":""}`)};document.querySelectorAll(".expl-check").forEach(W=>{W.addEventListener("change",()=>{const J=W.dataset.id;W.checked?C.add(J):C.delete(J);const N=W.closest(".exemplaire-row");N&&(N.style.borderColor=W.checked?"#1A6B3C":"#eee"),U()})}),document.querySelectorAll(".exemplaire-row").forEach(W=>{W.addEventListener("click",J=>{if(J.target.closest("button")||J.target.tagName==="INPUT")return;const N=W.querySelector(".expl-check");N&&!N.disabled&&(N.checked=!N.checked,N.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(W=>{W.addEventListener("click",J=>{J.stopPropagation();const N=document.querySelector(`.expl-hist[data-hist="${W.dataset.idx}"]`);N&&(N.style.display=N.style.display==="none"?"flex":"none")})}),(se=document.getElementById("evolve-btn"))==null||se.addEventListener("click",async()=>{if(y<=1)return;const W=[...C];if(!W.length)return;if(C.has(e.id)){const V=document.createElement("div");V.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",V.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            📈 Note : <strong>${v+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${v+(e.evolution_bonus||0)+J.length*N}</strong>
            ${E&&E>0?`<br>📈 Note 2 : <strong>${E+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${E+(e.evolution_bonus||0)+J.length*N}</strong>`:""}
        ...
        </div>`,document.body.appendChild(D),D.querySelector("#sac-cancel").addEventListener("click",()=>{D.remove(),V(!1)}),D.querySelector("#sac-ok").addEventListener("click",()=>{D.remove(),V(!0)}),D.addEventListener("click",O=>{O.target===D&&(D.remove(),V(!1))})}))return;if(J.length){await _.from("market_listings").delete().in("card_id",J),await _.from("deck_cards").delete().in("card_id",J),await _.from("transfer_history").delete().in("card_id",J),await _.from("decks").update({stadium_card_id:null}).in("stadium_card_id",J);const{error:V}=await _.from("cards").delete().in("id",J);if(V){o("Erreur suppression : "+V.message,"error");return}}const q=(e.evolution_bonus||0)+J.length*N,{error:G}=await _.from("cards").update({evolution_bonus:q}).eq("id",e.id);if(G){o("Erreur évolution : "+G.message,"error");return}const X=v+q;o(`⬆️ ${d.firstname} ${d.surname_real} : note ${v+e.evolution_bonus||v} → ${X}${J.length?` · ${J.length} copie${J.length>1?"s":""} sacrifiée${J.length>1?"s":""}`:""} !`,"success",4e3),s(),l("collection")}),(de=document.getElementById("market-sell-btn"))==null||de.addEventListener("click",async()=>{var G;const W=[...C];if(!W.length){o("Sélectionne au moins un exemplaire","warning");return}const J=parseInt((G=document.getElementById("sell-market-price"))==null?void 0:G.value);if(!J||J<1){o("Prix invalide","error");return}const{error:N}=await _.from("cards").update({is_for_sale:!0,sale_price:J}).in("id",W);if(N){o(N.message,"error");return}const S=W.map(X=>({seller_id:r.profile.id,card_id:X,price:J,status:"active"})),{error:q}=await _.from("market_listings").insert(S);q&&console.warn("[Market] insert listings:",q.message),o(`${W.length} carte${W.length>1?"s":""} mise${W.length>1?"s":""} en vente à ${J.toLocaleString("fr")} cr. chacune !`,"success"),s(),l("collection")}),(ke=document.getElementById("cancel-sell-btn"))==null||ke.addEventListener("click",async()=>{await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await _.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),o("Annonce retirée","success"),s(),l("collection")})}function Ji(e,t=""){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(n);const r=n.querySelector("#pm-input");r.focus(),r.select();const o=a=>{n.remove(),i(a)};n.querySelector("#pm-ok").addEventListener("click",()=>o(r.value.trim()||null)),n.querySelector("#pm-cancel").addEventListener("click",()=>o(null)),n.querySelector("#pm-cancel2").addEventListener("click",()=>o(null)),n.addEventListener("click",a=>{a.target===n&&o(null)}),r.addEventListener("keydown",a=>{a.key==="Enter"&&o(r.value.trim()||null),a.key==="Escape"&&o(null)})})}function uo(e,t=!1){return new Promise(i=>{const n=document.createElement("div");n.className="modal-overlay",n.style.zIndex="2100",n.innerHTML=`<div class="modal" style="max-width:380px">
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
  ...
  </div>`,document.getElementById("new-deck-btn").addEventListener("click",async()=>{const a=await Ji("Nom du deck",`Deck ${((o==null?void 0:o.length)||0)+1}`);if(!a)return;const{data:s,error:l}=await _.from("decks").insert({owner_id:i.profile.id,name:a}).select().single();if(l){r(l.message,"error");return}r("Deck créé !","success"),Qi(s.id,e,t)}),e.querySelectorAll("[data-open-deck]").forEach(a=>{a.addEventListener("click",()=>Qi(a.dataset.openDeck,e,t))}),e.querySelectorAll("[data-rename]").forEach(a=>{a.addEventListener("click",async()=>{const s=await Ji("Nouveau nom",a.dataset.name);if(!s||s===a.dataset.name)return;const{error:l}=await _.from("decks").update({name:s}).eq("id",a.dataset.rename);if(l){r(l.message,"error");return}r("Deck renommé !","success"),vi(e,t)})}),e.querySelectorAll("[data-delete]").forEach(a=>{a.addEventListener("click",async()=>{if(!await uo(`Supprimer le deck "${a.dataset.name}" ? Cette action est irréversible.`,!0))return;await _.from("deck_cards").delete().eq("deck_id",a.dataset.delete);const{error:s}=await _.from("decks").delete().eq("id",a.dataset.delete);if(s){r(s.message,"error");return}r("Deck supprimé.","success"),vi(e,t)})})}async function Qi(e,t,i){const{state:n,toast:r}=i;t.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await _.from("decks").select("*").eq("id",e).single(),{data:a}=await _.from("cards").select(`id, card_type, formation, stadium_id, evolution_bonus,
      player:players(id, firstname, surname_real, country_code, club_id, job, job2,
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",n.profile.id).eq("card_type","stadium"),l=(a||[]).filter(b=>b.card_type==="player"&&b.player),c=(a||[]).filter(b=>b.card_type==="formation"),d=(s||[]).filter(b=>b.card_type==="stadium"),m=[...new Set(d.map(b=>b.stadium_id).filter(Boolean))];let y={};if(d.forEach(b=>{b.stadium_def&&b.stadium_id&&(y[b.stadium_id]=b.stadium_def)}),m.length&&Object.keys(y).length<m.length){const{data:b}=await _.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",m);(b||[]).forEach(v=>{y[v.id]=v})}const g=c.map(b=>b.formation).filter(Boolean),{data:x}=await _.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";g.length>0&&!g.includes(p)&&(p=g[0]);const f={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,stadiumCardId:o.stadium_card_id||null,slots:{},subs:[],playerCards:l,formationCards:c,stadiumCards:d,stadDefMap:y,availableFormations:g};(x||[]).forEach(b=>{b.is_starter?f.slots[b.position]=b.card_id:f.subs.includes(b.card_id)||f.subs.push(b.card_id)}),yt(t,f,i)}function yt(e,t,i){var x,p;const{navigate:n}=i;ni[t.formation];const r=Zi(t.formation),o=r.filter(f=>t.slots[f]).length,a=t.availableFormations.length>0?t.availableFormations:Object.keys(ni),s=(x=t.stadiumCards)==null?void 0:x.find(f=>f.id===t.stadiumCardId),l=s&&((p=t.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=t.subs.map(f=>t.playerCards.find(b=>b.id===f)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
  ...
  </div>`;const d=window.innerWidth>=900,m=e.querySelector(".deck-pc-layout"),y=e.querySelector(".deck-mobile-layout");m&&(m.style.display=d?"block":"none"),y&&(y.style.display=d?"none":"block"),fo(e,t,r,i),e.querySelectorAll("#builder-back").forEach(f=>f.addEventListener("click",()=>n("decks")));const g=()=>{const{openModal:f,closeModal:b}=i,v=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;f("⚽ Choisir une formation",v),document.querySelectorAll("#modal-body [data-forma]").forEach(h=>{h.addEventListener("click",()=>{t.formation=h.dataset.forma;const E=Zi(t.formation),u={};E.forEach(M=>{t.slots[M]&&(u[M]=t.slots[M])}),t.slots=u,b(),yt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(f=>f.addEventListener("click",g)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(f=>f.addEventListener("click",()=>go(t,e,i))),e.querySelectorAll("#save-deck").forEach(f=>f.addEventListener("click",()=>yo(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(f=>{f.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==f.dataset.removeSub),yt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(f=>f.addEventListener("click",()=>xo(t,e,i)))}function fo(e,t,i,n){var h,E;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(h=t.stadiumCards)==null?void 0:h.find(u=>u.id===t.stadiumCardId),s=a&&((E=t.stadDefMap)==null?void 0:E[a.stadium_id])||null,l=Jt[t.formation]||{},c=Ii(t.formation)||[],d={};for(const u of i){const M=t.slots[u],$=M?t.playerCards.find(P=>P.id===M):null;$!=null&&$.player?d[u]={...$.player,_evolution_bonus:$.evolution_bonus||0,face:$.player.face||null}:d[u]=null}const m=window.innerWidth>=900,y=m?window.innerWidth-280:window.innerWidth-20,g=m?Math.min(y,860):y,x=Math.round(m?g*.82:g*.85),p=m?84:44;let f="";for(const[u,M]of c){const $=l[u],P=l[M];if(!$||!P)continue;const R=$.x*g,ne=Math.round(.03*x+$.y*.85*x),ie=P.x*g,Q=Math.round(.03*x+P.y*.85*x),j=d[u],w=d[M],C=Gt(j,w);C==="#ff3333"||C==="#cc2222"?f+=`<line x1="${R.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${C}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(f+=`<line x1="${R.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${C}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,f+=`<line x1="${R.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${C}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const v=Math.round(p*657/507);for(const u of i){const M=l[u];if(!M)continue;const $=d[u],P=M.x*g;M.y*x;const R=Math.round(.03*x+M.y*(.85*x)),ne=Math.round(P-p/2),ie=Math.round(R-v/2);if($){const Q=u.replace(/\d+/,""),j=s&&(s.club_id&&String($.club_id)===String(s.club_id)||s.country_code&&$.country_code===s.country_code),w=Se({...$,_evolution_bonus:$._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:Q});b+=`<div style="position:absolute;left:${ne}px;top:${ie}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${u}">
        <div style="position:relative">${j?'<div style="position:absolute;top:-18px;left:0;right:0;text-align:center;font-size:14px;z-index:5;line-height:1">🏟️</div>':""}${w}</div>
      </div>`}else{const Q=u.replace(/\d+/,"");b+=`<div style="position:absolute;left:${ne}px;top:${ie}px;width:${p}px;height:${v}px;
    ...
    <div style="position:relative;width:${g}px;height:${x}px;margin:0 auto">
      ...
      ${b}
    </div>`,o.querySelectorAll(".deck-slot-hit").forEach(u=>{u.addEventListener("click",()=>mo(u.dataset.pos,t,e,n))})}function go(e,t,i){var a;const{openModal:n,closeModal:r}=i,o=e.stadiumCards||[];n("🏟️ Choisir un stade",`<div style="display:flex;flex-wrap:wrap;gap:10px;padding:8px">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-sub-selector">Fermer</button>'),(y=document.getElementById("close-sub-selector"))==null||y.addEventListener("click",r),document.querySelectorAll(".player-option").forEach(g=>{g.addEventListener("click",()=>{e.subs.push(g.dataset.cardId),r(),yt(t,e,i)})})}async function yo(e,t){const{state:i,toast:n,navigate:r}=t,o=e.formationCards.find(l=>l.formation===e.formation),a=(o==null?void 0:o.id)||e.formationCardId;await _.from("decks").update({formation:e.formation,formation_card_id:a||null,stadium_card_id:e.stadiumCardId||null}).eq("id",e.deckId),await _.from("deck_cards").delete().eq("deck_id",e.deckId);const s=[];if(Object.entries(e.slots).forEach(([l,c],d)=>{s.push({deck_id:e.deckId,card_id:c,position:l,is_starter:!0,slot_order:d})}),e.subs.forEach((l,c)=>{s.push({deck_id:e.deckId,card_id:l,position:`SUB${c+1}`,is_starter:!1,slot_order:100+c})}),s.length>0){const{error:l}=await _.from("deck_cards").insert(s);if(l){n(l.message,"error");return}}n("Deck enregistré ✅","success"),r("decks")}function Zi(e){const t=ni[e]||ni["4-4-2"],i=["GK1"];for(let n=1;n<=t.DEF;n++)i.push(`DEF${n}`);for(let n=1;n<=t.MIL;n++)i.push(`MIL${n}`);for(let n=1;n<=t.ATT;n++)i.push(`ATT${n}`);return i}async function gn(e=null){const t=new Date().toISOString().slice(0,10),{data:i}=await _.from("booster_configs").select("*").eq("is_active",!0).order("sort_order");if(!(i!=null&&i.length))return[];const n=i.filter(a=>!(a.available_from&&t<a.available_from||a.available_until&&t>a.available_until));if(!n.length)return[];let r=n;if(e){const a=n.filter(s=>s.max_per_user!=null);if(a.length){const{data:s}=await _.from("booster_claims").select("booster_id").eq("user_id",e).in("booster_id",a.map(c=>c.id)),l={};(s||[]).forEach(c=>{l[c.booster_id]=(l[c.booster_id]||0)+1}),r=n.filter(c=>c.max_per_user==null?!0:(l[c.id]||0)<c.max_per_user)}}if(!r.length)return[];const{data:o}=await _.from("booster_drop_rates").select("*").in("booster_id",r.map(a=>a.id)).order("sort_order");return r.map(a=>({...a,rates:(o||[]).filter(s=>s.booster_id===a.id)}))}async function bo(e,t){const{data:i}=await _.from("booster_configs").select("max_per_user").eq("id",t).single();i!=null&&i.max_per_user&&await _.from("booster_claims").insert({user_id:e,booster_id:t})}function ho(e){if(!(e!=null&&e.length))return null;const t=e.reduce((n,r)=>n+Number(r.percentage),0);let i=Math.random()*t;for(const n of e)if(i-=Number(n.percentage),i<=0)return n;return e[e.length-1]}const mn=()=>Object.keys(Jt),vo=[{id:"players_std",img:"/icons/booster-players.png",name:"Players",sub:"5 cartes joueurs",cost:5e3,costLabel:"5 000 crédits",cardCount:5,type:"player"},{id:"players_pub",img:"/icons/booster-silver.png",name:"Players (pub)",sub:"3 cartes joueurs",cost:0,costLabel:"1 pub",cardCount:3,type:"player"},{id:"game_changer",img:"/icons/booster-gamechanger.png",name:"Game Changer",sub:"3 cartes spéciales",cost:1e4,costLabel:"10 000 crédits",cardCount:3,type:"game_changer"},{id:"formation",img:"/icons/booster-formation.png",name:"Formation",sub:"1 carte formation",cost:1e4,costLabel:"10 000 crédits",cardCount:1,type:"formation"}],wi={Ressusciter:{icon:"💫",desc:"Réactive un joueur grisé."},"Double attaque":{icon:"⚡",desc:"La prochaine attaque compte double."},Bouclier:{icon:"🛡️",desc:"Annule le prochain but adverse."},"Vol de note":{icon:"🎯",desc:"-1 à la prochaine action IA."},Gel:{icon:"❄️",desc:"Bloque le meilleur attaquant IA."},"Remplacement+":{icon:"🔄",desc:"+1 remplacement pour ce match."}};function wo(e){const t=e.player;if(!t)return"";const i=e.evolution_bonus||0;return Se({...t,_evolution_bonus:i},{width:140})}function xn(e){var r;const t={};(e.rates||[]).forEach(o=>{t[o.card_type]=(t[o.card_type]||0)+Number(o.percentage||0)});const i=((r=Object.entries(t).sort((o,a)=>a[1]-o[1])[0])==null?void 0:r[0])||"player",n=e.image_url||"booster-players.png";return{id:e.id,img:"/icons/"+n,name:e.name,sub:`${e.card_count} carte(s)`,cost:e.price_type==="credits"&&e.price_credits||0,costLabel:e.price_type==="credits"?`${(e.price_credits||0).toLocaleString("fr")} crédits`:e.price_type==="pub"?"1 pub":"Gratuit",cardCount:e.card_count||5,type:i,isPub:e.price_type==="pub",rates:e.rates||[],allow_duplicates:e.allow_duplicates!==!1,_boosterId:e.id,_raw:e}}async function _o(e,{state:t,navigate:i,toast:n}){var m,y,g;const r=((m=t.profile)==null?void 0:m.credits)||0;e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⏳ Chargement...</div>';let o=[];try{o=(await gn((y=t.user)==null?void 0:y.id)).map(xn)}catch(x){console.warn("Erreur chargement boosters DB, fallback hardcodé",x)}o.length||(o=vo.map(x=>({...x,rates:[],isPub:x.id==="players_pub"})));const a=await _.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",t.profile.id).then(x=>x.data||[]),s=new Set(a.filter(x=>x.card_type==="stadium").map(x=>x.stadium_id)),l=new Set(a.filter(x=>x.card_type==="formation").map(x=>x.formation)),c=new Set(a.filter(x=>x.card_type==="game_changer").map(x=>x.gc_type)),d={};for(const x of o){if(x.allow_duplicates!==!1||!((g=x.rates)!=null&&g.length))continue;const p=[...new Set((x.rates||[]).map(b=>b.card_type))];let f=!1;for(const b of p)if(b==="stadium"){const{data:v}=await _.from("stadium_definitions").select("id");if((v||[]).some(h=>!s.has(h.id))){f=!0;break}}else if(b==="game_changer"){const{data:v}=await _.from("gc_definitions").select("name").eq("is_active",!0);if((v||[]).some(h=>!c.has(h.name))){f=!0;break}}else if(b==="formation"){const{FORMATION_LINKS:v}=await rn(async()=>{const{FORMATION_LINKS:h}=await import("./formation-links-yJiMLlPw.js").then(E=>E.q);return{FORMATION_LINKS:h}},__vite__mapDeps([0,1]));if(Object.keys(v).some(h=>!l.has(h))){f=!0;break}}else{f=!0;break}f||(d[x.id]=!0)}e.innerHTML=`
  <div class="page">
    <div class="page-header">
      <h2>📦 Boosters</h2>
  ...
  </div>`,e.querySelectorAll(".booster-card:not(.disabled)").forEach(x=>{x.addEventListener("click",async()=>{const p=o.find(f=>f.id===x.dataset.booster);if(p){x.style.opacity="0.5",x.style.pointerEvents="none";try{await ko(p,{state:t,toast:n,navigate:i,container:e})}catch(f){n(f.message,"error"),x.style.opacity="",x.style.pointerEvents=""}}})}),e.querySelectorAll(".booster-info-btn").forEach(x=>{x.addEventListener("click",p=>{p.stopPropagation();const f=o.find(b=>b.id===x.dataset.boosterId);zo(f)})})}async function ko(e,{state:t,toast:i,navigate:n,container:r}){var m,y;if(e.cost>0&&t.profile.credits<e.cost){i("Crédits insuffisants","error");return}e.isPub&&await Io();const{data:o}=await _.from("cards").select("card_type, player_id, formation").eq("owner_id",t.profile.id),a=new Set((o||[]).filter(g=>g.card_type==="player").map(g=>g.player_id)),s=new Set((o||[]).filter(g=>g.card_type==="formation").map(g=>g.formation));let l=[],c=null;try{if((m=e.rates)!=null&&m.length)l=await _i(t.profile,e);else{const g=e.type||"player";g==="player"?l=await yn(t.profile,e.cardCount,e.cost):g==="game_changer"?l=await bn(t.profile,e.cardCount,e.cost):g==="formation"?l=await hn(t.profile,e.cost):l=await _i(t.profile,e)}}catch(g){c=g.message||String(g),console.error("[Booster] Erreur:",g)}if(l!=null&&l.length&&e._boosterId&&await bo(t.user.id,e._boosterId),!(l!=null&&l.length)){const g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",g.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:12px;color:rgba(255,255,255,0.6);max-width:320px;word-break:break-all;background:rgba(255,255,255,0.05);padding:10px;border-radius:8px;margin-top:6px">
        ${c||"Vérifie la console (F12) pour plus de détails"}
      </div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(g),(y=g.querySelector("#anim-close-err"))==null||y.addEventListener("click",()=>g.remove());return}l.forEach(g=>{g.card_type==="player"&&g.player?g.isDuplicate=a.has(g.player.id):g.card_type==="formation"&&(g.isDuplicate=s.has(g.formation))});const{data:d}=await _.from("users").select("*").eq("id",t.profile.id).single();d&&(t.profile=d),vn(l,e,n)}function $o(){const e=Math.random()*100;return e<.5?"legende":e<2?"special":e<10?"normal_high":"normal_low"}function ut(e){return Math.max(Number(e.note_g)||0,Number(e.note_d)||0,Number(e.note_m)||0,Number(e.note_a)||0)}function Eo(e,t){let i;switch(t){case"legende":i=e.filter(n=>n.rarity==="legende"),i.length||(i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte")),i.length||(i=e.filter(n=>ut(n)>=6));break;case"special":i=e.filter(n=>n.rarity==="pepite"||n.rarity==="papyte"),i.length||(i=e.filter(n=>ut(n)>=6));break;case"normal_high":i=e.filter(n=>n.rarity==="normal"&&ut(n)>=6),i.length||(i=e.filter(n=>ut(n)>=6));break;default:i=e.filter(n=>n.rarity==="normal"&&ut(n)>=1&&ut(n)<=5),i.length||(i=e.filter(n=>n.rarity==="normal"));break}return i.length||(i=e),i[Math.floor(Math.random()*i.length)]}async function _i(e,t){if(t.cost>0){const{error:y}=await _.from("users").update({credits:e.credits-t.cost}).eq("id",e.id);if(y)throw y}const i=t.allow_duplicates!==!1;let n=[];const{data:r,error:o}=await _.from("cards").select("player_id, card_type, formation, stadium_id, gc_type").eq("owner_id",e.id);if(o){const{data:y}=await _.from("cards").select("player_id, card_type, formation, gc_type").eq("owner_id",e.id);n=y||[]}else n=r||[];const a=new Set(n.filter(y=>y.card_type==="player").map(y=>y.player_id)),s=new Set(n.filter(y=>y.card_type==="formation").map(y=>y.formation)),l=new Set(n.filter(y=>y.card_type==="game_changer").map(y=>y.gc_type)),c=new Set(n.filter(y=>y.card_type==="stadium").map(y=>y.stadium_id).filter(Boolean)),d=new Set,m=[];for(let y=0;y<(t.cardCount||5);y++){const g=ho(t.rates);if(g){if(g.card_type==="player"){const x=$=>({légende:"legende",pépite:"pepite",pépites:"pepite"})[$]||$,p=g.rarity?x(g.rarity):null;let f=_.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);p&&(f=f.eq("rarity",p));const{data:b}=await f;let v=b||[];if((g.note_min||g.note_max)&&(v=v.filter($=>{const P=Math.max(Number($.note_g)||0,Number($.note_d)||0,Number($.note_m)||0,Number($.note_a)||0);return(!g.note_min||P>=g.note_min)&&(!g.note_max||P<=g.note_max)})),v.length||(g.note_min||g.note_max?(v=b||[],console.warn("[Booster] Aucun joueur avec note",g.note_min,"-",g.note_max,"— fallback rareté uniquement")):v=b||[]),!v.length)continue;let h=v.filter($=>!d.has($.id));if(i)h.length||(h=v);else if(h=h.filter($=>!a.has($.id)),!h.length)continue;const E=h[Math.floor(Math.random()*h.length)];d.add(E.id);const u=a.has(E.id),{data:M}=await _.from("cards").insert({owner_id:e.id,player_id:E.id,card_type:"player"}).select().single();M&&(m.push({...M,player:E,isDuplicate:u}),_.rpc("record_transfer",{p_card_id:M.id,p_player_id:E.id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{}))}else if(g.card_type==="game_changer"){const{data:x}=await _.from("gc_definitions").select("id,name").eq("is_active",!0).eq("gc_type","game_changer"),p=x!=null&&x.length?x:[{name:"Ressusciter"},{name:"Double attaque"},{name:"Bouclier"},{name:"Vol de note"},{name:"Gel"}],f=i?p:p.filter(E=>!l.has(E.name));if(!i&&!f.length)continue;const v=f[Math.floor(Math.random()*f.length)].name,{data:h}=await _.from("cards").insert({owner_id:e.id,card_type:"game_changer",gc_type:v}).select().single();h&&m.push(h)}else if(g.card_type==="formation"){const x=mn(),p=i?x:x.filter(h=>!s.has(h));if(!i&&!p.length)continue;const f=p[Math.floor(Math.random()*p.length)],b=s.has(f),{data:v}=await _.from("cards").insert({owner_id:e.id,card_type:"formation",formation:f}).select();v!=null&&v[0]&&m.push({...v[0],isDuplicate:b})}else if(g.card_type==="stadium"){const{data:x,error:p}=await _.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)");if(p){console.error("[Booster] stadium_definitions:",p.message);continue}if(!(x!=null&&x.length)){console.warn("[Booster] Aucun stade en DB");continue}const f=i?x:x.filter(E=>!c.has(E.id));if(!i&&!f.length)continue;const b=f[Math.floor(Math.random()*f.length)],{data:v,error:h}=await _.from("cards").insert({owner_id:e.id,card_type:"stadium",stadium_id:b.id}).select("id,card_type,stadium_id").single();if(h){console.error("[Booster] insert stadium card:",h.message);continue}v&&m.push({...v,rarity:"normal",_stadiumDef:b})}}}return m}async function yn(e,t,i){if(i>0){const{error:c}=await _.from("users").update({credits:e.credits-i}).eq("id",e.id);if(c)throw c}const{data:n}=await _.from("players").select("id,job,firstname,surname_real,country_code,club_id,rarity,note_g,note_d,note_m,note_a,note_min,note_max,skin,hair,hair_length,face,sell_price,clubs(encoded_name,logo_url)").eq("is_active",!0);if(!(n!=null&&n.length))throw new Error("Pas de joueurs en BDD — ajoutes-en via le panel admin !");const r=n.filter(c=>c.job==="GK"),o=n.filter(c=>c.job!=="GK"),a=!e.first_booster_opened&&r.length>0,s=[];for(let c=0;c<t;c++){const d=c===0&&a?r:c===0?o:n,m=$o(),y=Eo(d,m);y&&s.push(y)}a&&await _.from("users").update({first_booster_opened:!0}).eq("id",e.id);const{data:l}=await _.from("cards").insert(s.map(c=>({owner_id:e.id,player_id:c.id,card_type:"player"}))).select();return(l||[]).forEach((c,d)=>{_.rpc("record_transfer",{p_card_id:c.id,p_player_id:s[d].id,p_club_name:e.club_name||e.pseudo,p_manager_name:e.pseudo,p_source:"booster",p_price:null}).then(()=>{}).catch(()=>{})}),s.map((c,d)=>({...l[d],player:c}))}async function bn(e,t,i){const{error:n}=await _.from("users").update({credits:e.credits-i}).eq("id",e.id);if(n)throw n;const{data:r}=await _.from("gc_definitions").select("id,name,gc_type,color,effect,image_url").eq("is_active",!0),o=r!=null&&r.length?r:Object.keys(wi).map(d=>({name:d,gc_type:"game_changer"})),a=Array.from({length:t},()=>{const d=o[Math.floor(Math.random()*o.length)];return{owner_id:e.id,card_type:"game_changer",gc_type:d.name,gc_definition_id:d.id||null}}),{data:s,error:l}=await _.from("cards").insert(a).select();return l&&console.error("[Booster GC] Erreur insert:",l.message,l),(s||[]).map(d=>{const m=r==null?void 0:r.find(y=>y.name===d.gc_type||y.id===d.gc_definition_id);return{...d,_gcDef:m||null}})}async function hn(e,t){const{error:i}=await _.from("users").update({credits:e.credits-t}).eq("id",e.id);if(i)throw i;const{data:n}=await _.from("cards").select("formation").eq("owner_id",e.id).eq("card_type","formation"),r=new Set((n||[]).map(d=>d.formation)),o=mn(),a=o[Math.floor(Math.random()*o.length)],s=r.has(a),{data:l,error:c}=await _.from("cards").insert({owner_id:e.id,card_type:"formation",formation:a}).select();return c&&console.error("[Booster Formation] Erreur insert:",c.message,c),(l||[]).map(d=>({...d,isDuplicate:s}))}function vn(e,t,i,n=null){var Q,j;if(!e||e.length===0){const w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:#0a1628;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:3000;gap:16px;color:#fff;padding:24px;text-align:center",w.innerHTML=`
      <div style="font-size:48px">😕</div>
      <div style="font-size:20px;font-weight:900">Aucune carte obtenue</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.5)">Erreur lors du tirage (permissions DB ou colonne manquante)</div>
      <button style="margin-top:10px;padding:12px 28px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:700;cursor:pointer" id="anim-close-err">Fermer</button>`,document.body.appendChild(w),(Q=w.querySelector("#anim-close-err"))==null||Q.addEventListener("click",()=>w.remove());return}e=[...e].sort((w,C)=>{const U=w.player?ut(w.player):-1;return(C.player?ut(C.player):-1)-U});const r=document.createElement("div");r.id="booster-anim-overlay",r.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(r);let o=!1;const a=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let l=!1;const c=w=>w.touches&&w.touches[0]?w.touches[0].clientX:w.clientX;function d(w){o||(l=!0,s.style.opacity="1",m(w))}function m(w){if(!l||o)return;const C=a.getBoundingClientRect(),U=c(w)-C.left,re=Math.max(0,Math.min(1,U/C.width));s.style.width=re*C.width+"px",re>=.82&&g()}function y(){o||(l=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function g(){var C;if(o)return;o=!0,l=!1,s.style.width="100%",s.style.opacity="1",(C=document.getElementById("cut-flash"))==null||C.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const w=document.getElementById("cut-hint");w&&(w.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}a.addEventListener("pointerdown",d),window.addEventListener("pointermove",m),window.addEventListener("pointerup",y),a.addEventListener("touchstart",d,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",y);let x=0,p=!1;const f=new Set;function b(w){x=w,document.getElementById("reveal-phase").style.display="flex",v(),h(w,0),P()}function v(){const w=document.getElementById("card-dots");w&&(w.innerHTML=e.map((C,U)=>`<div class="card-dot" data-i="${U}" style="width:8px;height:8px;border-radius:50%;background:${U===x?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),w.querySelectorAll(".card-dot").forEach(C=>C.addEventListener("click",()=>u(parseInt(C.dataset.i)))))}function h(w,C){var N,S;const U=e[w],re=document.getElementById("card-counter"),ae=document.getElementById("card-track");re&&(re.textContent=`Carte ${w+1} / ${e.length}`);const se=document.getElementById("reveal-btns");se&&(se.style.display=w===e.length-1?"flex":"none");const de=U.card_type==="player"&&((N=U.player)==null?void 0:N.rarity)==="legende",ke=!f.has(w);f.add(w);let W=0;if(U.card_type==="player"&&U.player){const q=U.player,G=q.job||"ATT";W=Number(G==="GK"?q.note_g:G==="DEF"?q.note_d:G==="MIL"?q.note_m:q.note_a)||0}const J=q=>{ae.innerHTML=`
        ...
        </div>`;const G=document.getElementById("current-card-wrap");C!==0?(G.style.transition="none",G.style.transform=`translateX(${C>0?100:-100}%)`,requestAnimationFrame(()=>{G.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",G.style.transform="translateX(0)"})):G.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),q||de?ne():ie(),v()};ke&&(((S=U.player)==null?void 0:S.rarity)==="legende"||W>=8)&&U.card_type==="player"&&U.player?E(U,()=>J(!0)):J(!1)}function E(w,C){var ye;p=!0;const U=w.player,re=`https://flagsapi.com/${U.country_code}/flat/64.png`,ae=(ye=U.clubs)==null?void 0:ye.logo_url,se=U.face?"/"+U.face.replace(/^public\//,"").replace(/^\//,""):null,de=U.job||"ATT",ke=Number(de==="GK"?U.note_g:de==="DEF"?U.note_d:de==="MIL"?U.note_m:U.note_a)||0,W=w.evolution_bonus||0,J=ke+W,N=U.rarity==="legende",S=J>=18,q=document.getElementById("walkout-overlay"),G=document.getElementById("walkout-stage");if(!q||!G){p=!1,C();return}let X=null;N&&(X=new Audio("/sounds/Legendary.mp3"),X.volume=.8,X.play().catch(()=>{})),q.style.display="flex";const V=()=>{const be=G.firstElementChild;be&&(be.classList.remove("wo-in"),be.classList.add("wo-out"))},D=1800,O=400;G.innerHTML=`<img class="wo-in" src="${re}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(V,D),setTimeout(()=>{var be;G.innerHTML=ae?`<img class="wo-in" src="${ae}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((be=U.clubs)==null?void 0:be.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},D+O),setTimeout(V,D*2+O),setTimeout(()=>{G.innerHTML=se?`<img class="wo-in" src="${se}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(D+O)*2),setTimeout(V,(D+O)*2+D);const _e=S?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[de]||"#fff";setTimeout(()=>{G.innerHTML=`<div class="wo-in" style="
        ...
        ${J}
      </div>`,S&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(D+O)*3),setTimeout(V,(D+O)*3+D),setTimeout(()=>{q.style.display="none",G.innerHTML="",p=!1,X&&!N&&X.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),C()},(D+O)*4)}function u(w){if(p||w<0||w>=e.length||w===x)return;const C=w>x?1:-1;x=w,h(w,C)}function M(){u(x+1)}function $(){u(x-1)}function P(){const w=document.getElementById("card-viewport");if(!w||w._swipeBound)return;w._swipeBound=!0;let C=0,U=0,re=0,ae=!1;const se=N=>N.touches?N.touches[0].clientX:N.clientX,de=N=>N.touches?N.touches[0].clientY:N.clientY,ke=N=>{ae=!0,C=se(N),U=de(N),re=0},W=N=>{if(!ae)return;re=se(N)-C;const S=de(N)-U;if(Math.abs(re)<Math.abs(S))return;const q=document.getElementById("current-card-wrap");q&&(q.style.transition="none",q.style.transform=`translateX(${re*.6}px) rotate(${re*.02}deg)`)},J=()=>{if(!ae)return;ae=!1;const N=document.getElementById("current-card-wrap"),S=55;re<=-S&&x<e.length-1?M():re>=S&&x>0?$():N&&(N.style.transition="transform .2s ease",N.style.transform="translateX(0)")};w.addEventListener("pointerdown",ke),w.addEventListener("pointermove",W),w.addEventListener("pointerup",J),w.addEventListener("pointercancel",J),w.addEventListener("touchstart",ke,{passive:!0}),w.addEventListener("touchmove",W,{passive:!0}),w.addEventListener("touchend",J),w.addEventListener("click",N=>{if(Math.abs(re)>8)return;const S=w.getBoundingClientRect();N.clientX-S.left>S.width/2?M():$()})}let R=null;function ne(){const w=document.getElementById("fireworks-canvas");if(!w)return;w.width=window.innerWidth,w.height=window.innerHeight;const C=w.getContext("2d"),U=[];function re(){const se=Math.random()*w.width,de=Math.random()*w.height*.6,ke=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],W=ke[Math.floor(Math.random()*ke.length)];for(let J=0;J<60;J++){const N=Math.PI*2/60*J,S=2+Math.random()*5;U.push({x:se,y:de,vx:Math.cos(N)*S,vy:Math.sin(N)*S,alpha:1,color:W,size:2+Math.random()*3})}}re(),R=setInterval(re,600);function ae(){if(document.getElementById("fireworks-canvas")){C.clearRect(0,0,w.width,w.height);for(let se=U.length-1;se>=0;se--){const de=U[se];if(de.x+=de.vx,de.y+=de.vy+.08,de.vy*=.98,de.alpha-=.018,de.alpha<=0){U.splice(se,1);continue}C.globalAlpha=de.alpha,C.fillStyle=de.color,C.beginPath(),C.arc(de.x,de.y,de.size,0,Math.PI*2),C.fill()}C.globalAlpha=1,(R!==null||U.length>0)&&requestAnimationFrame(ae)}}ae()}function ie(){R!==null&&(clearInterval(R),R=null);const w=document.getElementById("fireworks-canvas");w&&w.getContext("2d").clearRect(0,0,w.width,w.height)}if(n){const w=document.getElementById("reveal-btns");w&&(w.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(j=document.getElementById("reveal-next"))==null||j.addEventListener("click",()=>{ie(),r.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ie(),r.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ie(),r.remove(),i("boosters")})}function Lo(e){var t,i,n,r;if(e.card_type==="player"&&e.player)return wo(e);if(e.card_type==="game_changer"){const o=e._gcDef,a=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},l={purple:"#b06ce0",light_blue:"#00d4ef"},c=s[o==null?void 0:o.color]||s.purple,d=l[o==null?void 0:o.color]||l.purple,m=(o==null?void 0:o.name)||e.gc_type||"Game Changer",y=(o==null?void 0:o.effect)||((t=wi[e.gc_type])==null?void 0:t.desc)||"",g=o!=null&&o.image_url?`/icons/${o.image_url}`:null,x=((i=wi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${c};border-radius:14px;border:3px solid ${d};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${d}88;flex-shrink:0">
      ...
      </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.remove()}),(i=document.getElementById("odds-close"))==null||i.addEventListener("click",()=>n.remove());return}To()}function To(){const e=document.createElement("div");e.style.cssText=`position:fixed;inset:0;background:rgba(0,0,0,0.6);display:flex;
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()}),document.getElementById("odds-close").addEventListener("click",()=>e.remove())}function Io(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
    ...
    `,document.body.appendChild(t);let i=5;const n=setInterval(()=>{i--;const r=document.getElementById("mw-ad-cd");r&&(r.textContent=i),i<=0&&(clearInterval(n),t.remove(),e(!0))},1e3)})}async function So(e,{state:t,navigate:i,toast:n,refreshProfile:r}){var y,g;const{data:o}=await _.from("users").select("*").eq("id",t.user.id).single();o&&(t.profile=o);let a=Array.isArray((y=t.profile)==null?void 0:y.pending_boosters)?[...t.profile.pending_boosters]:[];if(!a.length){await _.from("users").update({onboarding_done:!0}).eq("id",t.user.id),i("home");return}let s=null;try{const p=(await gn()).find(f=>(f.name||"").toLowerCase().includes("new player"));p&&(s=xn(p))}catch(x){console.warn('[Onboarding] Config "Booster (new player)" introuvable, fallback taux par défaut',x)}const l=a.length;let c=0;e.innerHTML=`
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`,e.querySelectorAll(".gc-select-card").forEach(x=>{x.addEventListener("click",()=>{const p=x.dataset.id,f=o.find(v=>v.id===p);if(!f)return;const b=a.findIndex(v=>v.gc_type===f.gc_type);b>-1?a.splice(b,1):a.length<3&&a.push(f),c()})}),(m=e.querySelector("#gc-launch"))==null||m.addEventListener("click",()=>{d&&l(a)}),(y=e.querySelector("#gc-no-gc"))==null||y.addEventListener("click",()=>l([])),(g=e.querySelector("#gc-reset"))==null||g.addEventListener("click",()=>{a.length&&(a=[],c())})}c()}function jo(e,t){var r;const i=((r=t==null?void 0:t.state)==null?void 0:r.params)||{},n=e||i.matchMode||"vs_ai_easy";return n==="friend"?`Match vs ${i.friendName||"Ami"}`:n==="random"?"Match vs Random":n==="ranked"?"Match Classé":n==="mini_league"||n==="mini-league"?"🏆 Match de Mini League":`Match vs IA — ${n.replace("vs_ai_","").toUpperCase()}`}async function Co(e,t,i){const{state:n,navigate:r}=t;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const{data:o}=await _.from("decks").select(`id,name,is_active,formation,stadium_card_id,
      stadium_card:cards!stadium_card_id(id,stadium_id,
        stadium_def:stadium_definitions(id,name,club_id,country_code,image_url,
          club:clubs(encoded_name,logo_url)))`).eq("owner_id",n.profile.id).order("created_at",{ascending:!1});if(!o||o.length===0){Et(e,"📋","Aucun deck. Crée un deck avant de jouer !","Créer un deck",()=>r("decks"));return}const a=o.map(y=>y.id),{data:s}=await _.from("deck_cards").select(`deck_id, position, is_starter, slot_order,
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),l=[...new Set((s||[]).filter(y=>{var g,x;return((g=y.card)==null?void 0:g.card_type)==="stadium"&&((x=y.card)==null?void 0:x.stadium_id)}).map(y=>y.card.stadium_id))],c={};if(l.length){const{data:y}=await _.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",l);(y||[]).forEach(g=>{c[g.id]=g}),(s||[]).forEach(g=>{var x,p;((x=g.card)==null?void 0:x.card_type)==="stadium"&&((p=g.card)!=null&&p.stadium_id)&&(g.card._stadiumDef=c[g.card.stadium_id]||null)})}let d=0;function m(){var u,M,$,P,R,ne,ie;const y=o[d],g=(s||[]).filter(Q=>Q.deck_id===y.id),x=g.filter(Q=>{var j;return Q.is_starter&&((j=Q.card)==null?void 0:j.player)}).map(Q=>ki(Q.card,Q.position)),p=g.find(Q=>{var j;return((j=Q.card)==null?void 0:j.card_type)==="formation"}),f=y.formation||((u=p==null?void 0:p.card)==null?void 0:u.formation)||"4-4-2";let b=x.length>=11?ri(x,f):null,v=((M=y.stadium_card)==null?void 0:M.stadium_def)||null;v&&b&&(b=Xt(b,v));const h=x.length>=11;ot(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff;position:relative">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        ...
        <div style="display:flex;align-items:center;gap:8px;padding:5px 14px;background:linear-gradient(90deg,rgba(30,100,220,0.35),rgba(10,60,180,0.15));border-top:1px solid rgba(30,120,255,0.45)">
          ...
          <span style="font-size:11px;color:#5DAAFF;margin-left:auto">+10 aux joueurs ${(($=v.club)==null?void 0:$.encoded_name)||v.country_code||""}</span>
        </div>`:""}
      </div>
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function Q(){const j=e.querySelector(".deck-preview-wrap"),w=e.querySelector("#deck-swipe-zone");if(!j||!w||!b)return;const C=w.clientWidth>=900,U=Math.max(200,w.clientHeight-(C?60:40)),ae=Math.max(200,w.clientWidth-16),se=C?Math.min(117,Math.max(52,Math.round(ae*.22))):Math.max(44,Math.round(ae*.168));if(U<220||ae<220){requestAnimationFrame(Q);return}const de=C?null:Math.round(se*.55);j.innerHTML=Pt(b,f,null,[],ae,U,[],de),j.style.cssText=`width:${ae}px;height:${U}px;overflow:hidden;margin:${C?0:60}px auto 0`;const ke=j.querySelector("svg");ke&&(ke.style.cssText="display:block;width:100%;height:100%",ke.setAttribute("preserveAspectRatio",C?"xMidYMid meet":"none"))})),(P=document.getElementById("prev-deck"))==null||P.addEventListener("click",()=>{d>0&&(d--,m())}),(R=document.getElementById("next-deck"))==null||R.addEventListener("click",()=>{d<o.length-1&&(d++,m())}),(ne=document.getElementById("validate-deck"))==null||ne.addEventListener("click",()=>{if(!h)return;const Q=t.state.params||{};t.navigate("match",{...Q,matchMode:Q.matchMode||i,deckId:y.id})}),(ie=document.getElementById("cancel-deck-select"))==null||ie.addEventListener("click",()=>{Xe(e),r("home")});const E=document.getElementById("deck-swipe-zone");if(E){let Q=0,j=0;E.addEventListener("touchstart",w=>{Q=w.touches[0].clientX,j=w.touches[0].clientY},{passive:!0}),E.addEventListener("touchend",w=>{const C=w.changedTouches[0].clientX-Q,U=w.changedTouches[0].clientY-j;Math.abs(C)<40||Math.abs(C)<Math.abs(U)||(C<0&&d<o.length-1?(d++,m()):C>0&&d>0&&(d--,m()))},{passive:!0})}}m()}function xt(e,t=44,i=58,n=null){return Se(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function Ye(e,t,i,n,r){if(!(e!=null&&e.length))return"";const o=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return o.forEach((s,l)=>{const c=s._line||s.job||"MIL";let d=s.boost||0;if(s.stadiumBonus&&(n==="attack"&&(c==="ATT"||c==="MIL")||n==="defense"&&(c==="GK"||c==="DEF"||c==="MIL")?d+=10:n||(d+=10)),a+=Se(s,{width:40,role:c,extraNote:d}),l<o.length-1){const m=o[l+1],y=cn(s,m,r)?Gt(s,m):null;a+=`<div style="width:7px;height:3px;background:${!y||y==="#ff3333"||y==="#cc2222"?"rgba(255,255,255,0.12)":y};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function ci(e,t,i,n,r=310,o=310,a=[],s=null){const l=Jt[t]||{},c=Ii(t)||Si[t]||[],d={},m=["ATT","MIL","DEF","GK"];for(const b of m)(e[b]||[]).forEach((h,E)=>{d[`${b}${E+1}`]=h});function y(b){const v=l[b];return v?{x:v.x*r,y:v.y*o}:null}let g="";for(const[b,v]of c){const h=y(b),E=y(v);if(!h||!E)continue;const u=d[b],M=d[v],$=Gt(u,M);$==="#00ff88"||$==="#FFD700"?(g+=`<line x1="${h.x.toFixed(1)}" y1="${h.y.toFixed(1)}" x2="${E.x.toFixed(1)}" y2="${E.y.toFixed(1)}"
        ...
        stroke="${$}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const x=typeof window<"u"&&window.innerWidth>=900?Math.min(Math.max(81,Math.round(r*.225)),117):Math.max(44,Math.round(r*.168)),p=Math.round(x*657/507);for(const[b,v]of Object.entries(d)){const h=y(b);if(!h||!v)continue;const E=b.replace(/[0-9]/g,""),u=a.includes(v.cardId),M=i==="attack"&&(["MIL","ATT"].includes(E)||u)&&!v.used||i==="defense"&&["GK","DEF","MIL"].includes(E)&&!v.used,$=n.includes(v.cardId);let P=v.boost||0,R=!1;v.stadiumBonus&&(i==="attack"&&(E==="ATT"||E==="MIL")||i==="defense"&&(E==="GK"||E==="DEF"||E==="MIL")?(P+=10,R=!0):i||(P+=10,R=!0));const ne=Math.round(h.x-x/2),ie=Math.round(h.y-p/2);if(v.used){g+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${ne}" y="${ie}" width="${x}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${v.cardId}" data-role="${E}" style="cursor:pointer"/>`;continue}const Q=Se({...v,_evolution_bonus:0,stadiumBonus:!1},{width:x,showStad:!1,stadDef:null,role:E,extraNote:P,_cardOffset:30,_forceStadColor:R}),j=$?`position:absolute;top:30px;left:0;width:${x}px;height:${p}px;outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;pointer-events:none;`:"";g+=`<foreignObject x="${ne-2}" y="${ie-30}" width="${x+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="position:relative">
        ${Q}
        ${$?`<div style="${j}"></div>`:""}
      </div>
    </foreignObject>`,M&&(g+=`<rect x="${ne}" y="${ie}" width="${x}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${$?"selected":""}" data-card-id="${v.cardId}" data-role="${E}" style="cursor:pointer"/>`)}const f=s!==null?s:Math.round(Math.max(x*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-f} ${-f} ${r+f*2} ${o+f*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${g}
  </svg>`}function Pt(e,t,i,n,r=300,o=300,a=[],s=null){return`<div id="match-terrain-wrap" style="position:relative;padding:0 4px">
    ${ci(e,t,i,n,r,o,a,s)}
  </div>`}async function pi(e,t,i,n){var M;const{state:r,navigate:o,toast:a}=t;ot(e);const s=r.params||{};if(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',!s.deckId)return Co(e,t,i);const l=s.deckId;let c,d,m,y;try{const $=await Promise.all([_.from("decks").select("formation,name,stadium_card_id").eq("id",l).single(),_.from("deck_cards").select(`position, is_starter, slot_order,
          card:cards(id, card_type, formation, evolution_bonus,
            player:players(id,firstname,surname_real,country_code,club_id,job,job2,
              note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
              clubs(encoded_name,logo_url)))`).eq("deck_id",l).order("slot_order")]);c=$[0].data,m=$[0].error,d=$[1].data,y=$[1].error}catch($){console.error("[Match] Exception chargement deck:",$),Et(e,"⚠️","Erreur réseau lors du chargement du deck. Réessaie.","Retour",()=>o("home"));return}if(m||y){console.error("[Match] Erreur Supabase:",m||y),Et(e,"⚠️","Erreur lors du chargement du deck.","Retour",()=>o("home"));return}const g=(d||[]).filter($=>{var P;return $.is_starter&&((P=$.card)==null?void 0:P.player)}).map($=>ki($.card,$.position)),x=(d||[]).filter($=>{var P;return!$.is_starter&&((P=$.card)==null?void 0:P.player)}).map($=>ki($.card,$.position));if(g.length<11){Et(e,"⚠️",`Deck incomplet (${g.length}/11).`,"Compléter",()=>o("decks"));return}const p=(d||[]).find($=>{var P;return((P=$.card)==null?void 0:P.card_type)==="formation"}),f=(c==null?void 0:c.formation)||((M=p==null?void 0:p.card)==null?void 0:M.formation)||"4-4-2",{data:b,error:v}=await _.from("cards").select("id, gc_type, gc_definition_id").eq("owner_id",r.profile.id).eq("card_type","game_changer"),{data:h}=await _.from("gc_definitions").select("*").eq("is_active",!0),E=(b||[]).map($=>({...$,_gcDef:(h==null?void 0:h.find(P=>P.name===$.gc_type||P.id===$.gc_definition_id))||null}));let u=null;if(c!=null&&c.stadium_card_id){const{data:$}=await _.from("cards").select("stadium_id").eq("id",c.stadium_card_id).single();if($!=null&&$.stadium_id){const{data:P}=await _.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").eq("id",$.stadium_id).single();u=P||null}}n({deckId:l,formation:f,starters:g,subsRaw:x,gcCardsEnriched:E,gcDefs:h||[],stadiumDef:u})}function Lt(){return Math.min(window.innerWidth-40,860)}function qt(){return Math.round(Lt()*1.1)}function _n(e){var r,o;if(!e)return null;const t=e._line||e.job||"MIL",i=t==="GK"?e.note_g||0:t==="DEF"?e.note_d||0:t==="MIL"?e.note_m||0:e.note_a||0,n=e.stadiumBonus?10:0;return{name:e.name,firstname:e.firstname||"",note:i+(e.boost||0)+n,note_g:e.note_g||0,note_d:e.note_d||0,note_m:e.note_m||0,note_a:e.note_a||0,_evolution_bonus:0,stadiumBonus:e.stadiumBonus||!1,boost:e.boost||0,job:e.job,job2:e.job2||null,_line:e._line||e.job,_col:e._col,country_code:e.country_code,club_id:e.club_id,rarity:e.rarity,clubName:e.clubName||((r=e.clubs)==null?void 0:r.encoded_name)||null,clubLogo:e.clubLogo||((o=e.clubs)==null?void 0:o.logo_url)||null,face:e.face||null,portrait:Wt(e)}}function Bo(e,t,i,n="Adversaire"){const r=Lt(),o=qt();return`
    ...
    </div>`}function kn(e){var o,a,s;if(!e)return"";const t=l=>l?Se({...l,_evolution_bonus:0},{width:52,role:l._line||l.job,showStad:!!l.stadiumBonus,extraNote:l.boost||0}):"",n={goal:"⚽","goal-home":"⚽","goal-ai":"⚽",duel:"⚔️",midfield:"🎯",sub:"🔄",gc:"⚡",boost:"💥","defense-won":"🛡️","attack-won":"⚔️","defense-lost":"😓","attack-lost":"😓"}[e.type]||"📋";return`
    ...
    pointer-events:none;white-space:nowrap;max-width:90vw;text-align:center`,r.textContent=e,!document.getElementById("game-toast-style")){const o=document.createElement("style");o.id="game-toast-style",o.textContent=`
      ...
      }`,document.head.appendChild(o)}document.body.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},i)}function $n(e,t){const i=Ge(e,"MIL"),n=e.stadiumBonus||t&&(t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code)?10:0;return i+n}function gt(e,t){return e.reduce((i,n)=>i+$n(n,t),0)}function mt(e){let t=0;for(let i=0;i<e.length-1;i++){const n=Gt(e[i],e[i+1]);n==="#00ff88"?t+=10:n==="#FFD700"&&(t+=5)}return t}function ai(e,t,i,n,r){return`<div id="duel-row-${n}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0), opacity .5s ease;transform-origin:center">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0">
        ${e.map((o,a)=>{const s=a<e.length-1?Gt(o,e[a+1]):null,l=!s||s==="#ff3333"||s==="#cc2222",c=s==="#00ff88"?"+10":s==="#FFD700"?"+5":"";return $n(o,r),o.stadiumBonus||r&&(r.club_id&&String(o.club_id)===String(r.club_id)||r.country_code&&(o.country_code,r.country_code)),`
    ...
    </div>`}async function Do(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await pi(e,t,r,async({deckId:s,formation:l,starters:c,subsRaw:d,gcCardsEnriched:m,gcDefs:y,stadiumDef:g})=>{try{let x=ri(c,l);g&&(x=Xt(x,g),oi(d,g));const p=await Fo(l,o),f=p.lines||p,b=async v=>{try{const h=a==="vs_ai_club"?"club":a,{data:E,error:u}=await _.from("matches").insert({home_id:i.profile.id,away_id:null,mode:h,home_deck_id:s,status:"in_progress"}).select().single();if(u){console.error("[MatchIA] Erreur création match:",u),Et(e,"⚠️","Impossible de créer le match ("+u.message+").","Retour",()=>t.navigate("home"));return}const M=p.stadiumDef||null;M&&f&&(Xt(f,M),oi(p.subs||[],M));const $={gcDefs:y||[],matchId:E==null?void 0:E.id,mode:a,difficulty:o,formation:l,homeTeam:x,aiTeam:f,homeSubs:d,subsUsed:0,maxSubs:Math.min(d.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:M,homeScore:0,aiScore:0,gcCards:v,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Go(e,$,t)}catch(h){console.error("[MatchIA] Exception launchMatch:",h),Et(e,"⚠️","Erreur au lancement du match : "+h.message,"Retour",()=>t.navigate("home"))}};if(!m.length){b([]);return}li(e,m,b)}catch(x){console.error("[MatchIA] Exception setup:",x),Et(e,"⚠️","Erreur de préparation du match : "+x.message,"Retour",()=>t.navigate("home"))}})}async function Fo(e,t){var f;const{data:i}=await _.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Po(e),subs:[],gcCards:[],stadiumDef:null};const n=Ft[e]||Ft["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(b,v,h){var E,u;return o.add(b.id),{cardId:"ai-"+b.id+"-"+h,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:((E=b.clubs)==null?void 0:E.encoded_name)||null,clubLogo:((u=b.clubs)==null?void 0:u.logo_url)||null,boost:0,used:!1,_line:v}}for(const b of["GK","DEF","MIL","ATT"]){const v=i.filter($=>$.job===b&&!o.has($.id)),h=i.filter($=>$.job!==b&&!o.has($.id)),E=[...v,...h],u=[];for(let $=0;$<n[b];$++){const P=E[$];P&&u.push(a(P,b,$))}const M=ft(u.length);u.forEach(($,P)=>{$._col=M[P]}),r[b]=u}const l=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,v)=>a(b,b.job,100+v)),m=Object.keys(Me).sort(()=>Math.random()-.5).slice(0,3).map((b,v)=>{var h,E;return{id:"ai-gc-"+v,gc_type:b,name:((h=Me[b])==null?void 0:h.name)||b,icon:((E=Me[b])==null?void 0:E.icon)||"⚡"}}),y=Object.values(r).flat(),g={};y.forEach(b=>{b.club_id&&(g[b.club_id]=(g[b.club_id]||0)+1)});const x=(f=Object.entries(g).sort((b,v)=>v[1]-b[1])[0])==null?void 0:f[0];let p=null;if(x){const{data:b}=await _.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",x).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:r,subs:l,gcCards:m,stadiumDef:p}}function Po(e){const t=Ft[e]||Ft["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<t[o];l++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=ft(a.length);a.forEach((l,c)=>{l._col=s[c]}),i[o]=a}return i}function Go(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const C=t.pendingAttack;let U="";if(t.selected.length>0){const re=t.selected.map(se=>({...(t.homeTeam[se._role]||[]).find(ke=>ke.cardId===se.cardId)||se,_line:se._role})),ae=Yt(re,t.modifiers.home,t.formation);U=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Ye((C.players||[]).map(re=>({...re,used:!1})),"#ff6b6b",C.total,"attack",t.formation)}</div>
            ${U}
          </div>`}if(t.phase==="ai-defense"&&t.pendingAttack){const C=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
            <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
            <div style="display:flex;justify-content:center">${Ye((C.players||[]).map(U=>({...U,used:!1})),"#00ff88",C.total,"attack",t.formation)}</div>
          </div>`}if(t.phase==="attack"&&t.selected.length>0){const C=t.selected.map(re=>{const ae=(t.homeTeam[re._role]||[]).find(de=>de.cardId===re.cardId)||re,se=["GK","DEF"].includes(re._role);return{...ae,_line:re._role,...se?{note_a:Math.max(1,Number(ae.note_a)||0)}:{}}}),U=Vt(C,t.modifiers.home,t.formation);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
            ...
            <div style="display:flex;justify-content:center">${Ye(C.map(re=>({...re,used:!1})),"#FFD700",U.total,"attack",t.formation)}</div>
    ...
    ${(()=>{const w=window.innerWidth>=700,C=(N,S,q)=>{var ge,Be;const G=(t.gcDefs||[]).find(je=>je.name===N.gc_type),X={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[G==null?void 0:G.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",V={purple:"#b06ce0",light_blue:"#00d4ef"}[G==null?void 0:G.color]||"#b06ce0",D=(G==null?void 0:G.name)||N.gc_type,O=(G==null?void 0:G.effect)||((ge=Me[N.gc_type])==null?void 0:ge.desc)||"",we=G!=null&&G.image_url?`/icons/${G.image_url}`:null,_e=((Be=Me[N.gc_type])==null?void 0:Be.icon)||"⚡",ye=Math.round(q*.22),be=Math.round(q*.22),$e=q-ye-be,Le=D.length>12?7:9;return`<div class="gc-mini" data-gc-id="${N.id}" data-gc-type="${N.gc_type}"
        ...
        </div>`},U=(N,S)=>{var q;return`<div id="boost-card"
          style="box-sizing:border-box;width:${N}px;height:${S}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(S*.04)}px;text-align:center;flex-shrink:0">
          ...
          </div>`},re=(N,S)=>S?U(130,175):C(N,130,175),ae=(N,S)=>S?U(68,95):C(N,68,95),se=w?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",de=g?`<button id="btn-results" style="${se};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:d?`<div style="${se};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:f?`<button id="btn-pass" style="${se};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:m?`<button id="btn-action" style="${se};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:y?`<button id="btn-action" style="${se};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${se};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,ke=m||y?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",W=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${w?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
        ${o.length===0?'<div style="font-size:7px;color:rgba(255,255,255,0.25);text-align:center;margin-top:6px;line-height:1.4">Pas de<br>rempl.</div>':o.map(N=>`<div class="sub-btn-col" data-sub-id="${N.cardId}" style="cursor:pointer;flex-shrink:0">${xt(N,76,100)}</div>`).join("")}
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(w=>{var C,U,re;if(w.type==="duel"){const ae=w.isGoal,se=w.homeScored?"#FFD700":ae?"#ff6b6b":"rgba(255,255,255,0.3)",de=w.homeScored?"⚽ BUT !":ae?"⚽ BUT IA !":(C=w.homePlayers)!=null&&C.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${ae?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${se};margin-bottom:4px">
  ...
  </div>`;function h(){const w=e.querySelector(".match-screen");if(!w)return;const C=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);w.style.bottom="auto",w.style.height=C+"px",w.style.minHeight=C+"px",w.style.maxHeight=C+"px",w.style.overflow="hidden";const U=e.querySelector("#mobile-action-bar"),re=e.querySelector("#mobile-play-area");U&&re&&(re.style.paddingBottom=U.offsetHeight+"px")}if(h(),setTimeout(h,120),setTimeout(h,400),setTimeout(h,1e3),t._vvBound||(t._vvBound=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",h),window.visualViewport.addEventListener("scroll",h)),window.addEventListener("resize",h)),function(){const C=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!C)return;const U=C.closest("#match-terrain-wrap");U&&(U.style.cssText="position:relative;width:100%;height:100%;padding:0"),C.removeAttribute("width"),C.removeAttribute("height"),C.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",C.setAttribute("preserveAspectRatio","xMidYMid meet")}(),t._resizeBound||(t._resizeBound=!0,window.addEventListener("resize",()=>{const w=e.querySelector(".terrain-wrapper svg");if(w){const C=w.closest("#match-terrain-wrap");C&&(C.style.cssText="position:relative;width:100%;height:100%;padding:0"),w.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase==="attack"||t.phase==="defense"){let w=!1,C=30;const U=()=>document.getElementById("match-timer"),re=()=>{const ae=U();if(!ae)return;const se=String(Math.floor(C/60)).padStart(2,"0"),de=String(C%60).padStart(2,"0");ae.textContent=` ${se}:${de}`,ae.style.color=w?"#ff2222":"#ff9500",ae.style.fontWeight="900"};re(),t._timerInt=setInterval(()=>{if(C--,C<0)if(!w)w=!0,C=15,re();else{clearInterval(t._timerInt),t._timerInt=null,t.homeScore=0,t.aiScore=3;const ae=document.createElement("div");ae.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;padding:24px;text-align:center",ae.innerHTML='<div style="font-size:56px">⏱️</div><div style="font-size:24px;font-weight:900;color:#ff4444">MATCH PERDU PAR FORFAIT</div><div style="font-size:14px;color:rgba(255,255,255,0.6)">Temps écoulé</div>',document.body.appendChild(ae),setTimeout(()=>{ae.remove(),Dt(e,t,i)},2500)}else re()},1e3)}(u=document.getElementById("match-quit"))==null||u.addEventListener("click",()=>{Xe(e),confirm("Abandonner ? Résultat : défaite 3-0")&&(t.homeScore=0,t.aiScore=3,Dt(e,t,i))}),(M=document.getElementById("view-ai"))==null||M.addEventListener("click",()=>Qo(t,i)),($=document.getElementById("toggle-history"))==null||$.addEventListener("click",()=>{var w;(w=document.getElementById("match-history-panel"))==null||w.classList.add("open")}),(P=document.getElementById("close-history"))==null||P.addEventListener("click",()=>{var w;(w=document.getElementById("match-history-panel"))==null||w.classList.remove("open")}),(R=document.getElementById("btn-action"))==null||R.addEventListener("click",()=>{t.selected.length!==0&&(m?Oo(e,t,i):y&&Ho(e,t,i))}),(ne=document.getElementById("btn-results"))==null||ne.addEventListener("click",()=>Dt(e,t,i)),(ie=document.getElementById("btn-pass"))==null||ie.addEventListener("click",()=>{t.log.push({text:"⏭️ Vous passez votre tour (plus d'attaquants)",type:"info"}),t.phase="ai-attack",Ee(e,t,i),setTimeout(()=>qi(e,t,i),800)}),e.querySelectorAll(".match-slot-hit").forEach(w=>{w.addEventListener("click",()=>No(w,t,e,i))}),e.querySelectorAll(".match-used-hit").forEach(w=>{w.addEventListener("click",()=>bi(e,t,i,null,w.dataset.cardId))}),e.querySelectorAll(".gc-mini").forEach(w=>{m?w.addEventListener("click",()=>Yo(w.dataset.gcId,w.dataset.gcType,e,t,i)):(w.style.opacity="0.35",w.style.cursor="default",w.addEventListener("click",()=>_t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(Q=document.getElementById("boost-card"))==null||Q.addEventListener("click",()=>Jo(e,t,i)),e.querySelectorAll(".sub-btn-col").forEach(w=>{w.addEventListener("click",()=>bi(e,t,i,w.dataset.subId))}),(j=document.getElementById("sub-btn-main"))==null||j.addEventListener("click",()=>bi(e,t,i))}function No(e,t,i,n){const r=e.dataset.cardId,o=e.dataset.role,a=t.selected.findIndex(s=>s.cardId===r);if(a!==-1)t.selected.splice(a,1);else{if(t.selected.length>=3){n.toast("Maximum 3 joueurs","error");return}const s=(t.homeTeam[o]||[]).find(l=>l.cardId===r);s&&t.selected.push({...s,_role:o,_line:o})}Ee(i,t,n)}function Bi(e,t,i){e.matchId&&_.from("matches").update({last_player_id:i}).eq("id",e.matchId).then(()=>{})}function Oo(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Bi(t,i,i.state.profile.id);const n=t.selected.map(o=>{const a=(t.homeTeam[o._role]||[]).find(l=>l.cardId===o.cardId)||o,s=["GK","DEF"].includes(o._role);return{...a,_line:o._role,...s?{note_a:Math.max(1,Number(a.note_a)||0)}:{}}}),r=Vt(n,t.modifiers.home,t.formation);t.pendingAttack={...r,players:[...n],side:"home"},t.selected.forEach(o=>{const a=(t.homeTeam[o._role]||[]).find(s=>s.cardId===o.cardId);a&&(a.used=!0)}),t.log.push({text:`⚔️ Vous attaquez : ${r.total} (base ${r.base}${r.links?` +${r.links} liens`:""}) — ${t.selected.map(o=>o.name).join(", ")}`,type:"info"}),t.selected=[],t.modifiers.home={},t.phase="ai-defense",Ee(e,t,i),setTimeout(()=>Vo(e,t,i),1200)}function Ho(e,t,i){t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),Bi(t,i,i.state.profile.id);const n=t.stadiumDef||null,r=t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(m=>m.cardId===l.cardId)||l,d=c.stadiumBonus||n&&(n.club_id&&String(c.club_id)===String(n.club_id)||n.country_code&&c.country_code===n.country_code)||!1;return{...c,_line:l._role,stadiumBonus:d}}),o=Yt(r,t.modifiers.home,t.formation);t.selected.forEach(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId);c&&(c.used=!0)});const a=Ci(t.pendingAttack.total,o.total,t.modifiers.home),s={type:"duel",title:"Défense",aiPlayers:(t.pendingAttack.players||[]).map(l=>Ve(l)),homePlayers:t.selected.map(l=>{const c=(t.homeTeam[l._role]||[]).find(d=>d.cardId===l.cardId)||l;return Ve(c)}),homeTotal:o.total,aiTotal:t.pendingAttack.total,isGoal:!1,homeScored:!1,text:""};if(a.shielded)s.text="🛡️ Bouclier ! But annulé.",t.log.push(s);else if(a.goal){t.aiScore++,s.isGoal=!0,s.homeScored=!1,s.text=`⚽ BUT IA ! (${t.pendingAttack.total} > ${o.total})`,t.log.push(s),t.selected=[],t.modifiers.home={},t.pendingAttack=null,Ee(e,t,i),rt(s.aiPlayers,t.homeScore,t.aiScore,!1,()=>{zt(e,t,i,"home-attack")});return}else s.text=`🧤 Défense réussie ! (${o.total} ≥ ${t.pendingAttack.total})`,t.log.push(s);t.selected=[],t.modifiers.home={},t.pendingAttack=null,zt(e,t,i,"home-attack")}function Uo(e){if(e.aiSubsUsed>=e.aiMaxSubs)return;const t=Object.values(e.aiTeam).flat().filter(l=>l.used);if(!t.length)return;const i=(e.aiSubs||[]).filter(l=>!e.aiUsedSubIds.includes(l.cardId));if(!i.length)return;const n=t[Math.floor(Math.random()*t.length)],r=i.find(l=>l.job===n.job)||i[0],o={...r,used:!1,_line:n._line,_col:n._col},a=e.aiTeam[n._line],s=a.findIndex(l=>l.cardId===n.cardId);s!==-1&&(a[s]=o),e.aiUsedSubIds.push(r.cardId),e.aiSubsUsed++,e.log.push({text:`🔄 IA : ${r.firstname} ${r.name} remplace ${n.firstname} ${n.name}`,type:"info"})}function Ko(e){var n;if(!((n=e.aiGcCards)!=null&&n.length))return;const t=e.aiGcCards.filter(r=>!e.aiUsedGc.includes(r.id));if(!t.length||Math.random()>.3)return;const i=t[Math.floor(Math.random()*t.length)];switch(e.aiUsedGc.push(i.id),Me[i.gc_type],i.gc_type){case"Boost+2":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+2}break}case"Boost+3":{const r=Object.values(e.aiTeam).flat().filter(o=>!o.used);if(r.length){const o=r[Math.floor(Math.random()*r.length)];o.boost=(o.boost||0)+3}break}case"Remplacement+":e.aiMaxSubs=(e.aiMaxSubs||3)+1;break;case"Bouclier":e.modifiers.ai.shield=!0;break;case"Nul+1":e.modifiers.ai.drawBonus=(e.modifiers.ai.drawBonus||0)+1;break}e.log.push({text:`⚡ IA joue ${i.icon||"⚡"} ${i.name}`,type:"gc"})}function qi(e,t,i){Bi(t,i,null),Uo(t),Ko(t);let n=[...t.aiTeam.MIL||[],...t.aiTeam.ATT||[]].filter(d=>!d.used),r=!1;n.length||(n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[]].filter(d=>!d.used),r=!0);const o=un(n,"attack",t.difficulty);if(!o.length){Ei(e,t,i);return}r&&o.forEach(d=>{d._line=d._line||d.job,d.note_a=Math.max(1,Number(d.note_a)||0)});const a=Vt(o,t.modifiers.ai,t.formation);t.pendingAttack={...a,players:o,side:"ai"},o.forEach(d=>{d.used=!0}),t.log.push({text:`🤖 IA attaque : ${a.total} (${o.map(d=>d.name).join(", ")})`,type:"info"}),t.modifiers.ai={};const s=[...t.homeTeam.GK||[],...t.homeTeam.DEF||[],...t.homeTeam.MIL||[]].filter(d=>!d.used),c=(t.homeSubs||[]).filter(d=>!(t.usedSubIds||[]).includes(d.cardId)).length>0&&t.subsUsed<t.maxSubs;if(s.length===0&&!c){if(o.length===1&&(o[0]._line==="GK"||o[0].job==="GK")&&$i(t.homeTeam)&&t.homeScore===t.aiScore){t.aiScore++,si(e,t,i,"ai",o[0]);return}t.aiScore++;const m={type:"duel",isGoal:!0,homeScored:!1,aiPlayers:o.map(y=>Ve(y)),aiTotal:a.total,text:"⚽ BUT IA ! (aucun défenseur disponible)"};t.log.push(m),t.pendingAttack=null,Ee(e,t,i),rt(m.aiPlayers,t.homeScore,t.aiScore,!1,()=>{zt(e,t,i,"home-attack")});return}t.phase="defense",Ee(e,t,i)}function Vo(e,t,i){var c,d;const n=[...t.aiTeam.GK||[],...t.aiTeam.DEF||[],...t.aiTeam.MIL||[]],r=un(n,"defense",t.difficulty);if(!["GK","DEF","MIL","ATT"].flatMap(m=>(t.aiTeam[m]||[]).filter(y=>!y.used)).length){const m=((c=t.pendingAttack)==null?void 0:c.players)||[];if(m.length===1&&(m[0]._line==="GK"||m[0].job==="GK")&&t.homeScore===t.aiScore){t.homeScore++,si(e,t,i,"home",m[0]);return}t.homeScore++;const g={type:"duel",isGoal:!0,homeScored:!0,homePlayers:m.map(x=>Ve(x)),homeTotal:((d=t.pendingAttack)==null?void 0:d.total)||0,aiTotal:0,text:"⚽ BUT ! L'IA n'a plus de joueurs — but automatique !"};t.log.push(g),t.modifiers.ai={},t.pendingAttack=null,Ee(e,t,i),rt(g.homePlayers,t.homeScore,t.aiScore,!0,()=>{zt(e,t,i,"ai-attack")});return}const a=r.length>0?Yt(r,t.modifiers.ai,t.formation).total:0;r.forEach(m=>{m.used=!0});const s=Ci(t.pendingAttack.total,a,t.modifiers.ai),l={type:"duel",title:"Attaque",homePlayers:(t.pendingAttack.players||[]).map(m=>Ve(m)),aiPlayers:r.map(m=>Ve(m)),homeTotal:t.pendingAttack.total,aiTotal:a,isGoal:!1,homeScored:!1,text:""};if(s.shielded)l.text="🛡️ Bouclier IA !",t.log.push(l);else if(s.goal){t.homeScore++,l.isGoal=!0,l.homeScored=!0,l.text=`⚽ BUT ! (${t.pendingAttack.total} > ${a})`,t.log.push(l),t.modifiers.ai={},t.pendingAttack=null,Ee(e,t,i),rt(l.homePlayers,t.homeScore,t.aiScore,!0,()=>{zt(e,t,i,"ai-attack")});return}else l.text=`🧤 IA défend (${a} ≥ ${t.pendingAttack.total})`,t.log.push(l);t.modifiers.ai={},t.pendingAttack=null,zt(e,t,i,"ai-attack")}function zt(e,t,i,n){if(t.round++,!En(e,t,i)){if(Di(t)){Dt(e,t,i);return}if(n==="home-attack"){if(!["MIL","ATT","GK","DEF"].some(o=>(t.homeTeam[o]||[]).some(a=>!a.used))){Ei(e,t,i);return}t.phase="attack",Ee(e,t,i)}else{if(!["MIL","ATT","GK","DEF"].some(o=>(t.aiTeam[o]||[]).some(a=>!a.used))){Ei(e,t,i);return}t.phase="ai-attack",Ee(e,t,i),setTimeout(()=>qi(e,t,i),800)}}}function $i(e){return!["GK","DEF","MIL","ATT"].some(t=>(e[t]||[]).some(i=>!i.used))}function en(e){const t=(e.GK||[]).some(n=>!n.used),i=["DEF","MIL","ATT"].some(n=>(e[n]||[]).some(r=>!r.used));return t&&!i}function En(e,t,i){if(t.homeScore!==t.aiScore)return!1;if(en(t.homeTeam)&&$i(t.aiTeam)){const n=(t.homeTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.homeScore++,si(e,t,i,"home",n),!0):!1}if(en(t.aiTeam)&&$i(t.homeTeam)){const n=(t.aiTeam.GK||[]).find(r=>!r.used);return n?(n.used=!0,t.aiScore++,si(e,t,i,"ai",n),!0):!1}return!1}function si(e,t,i,n,r){t.log.push({type:"duel",isGoal:!0,homeScored:n==="home",homePlayers:n==="home"?[Ve(r)]:[],aiPlayers:n==="ai"?[Ve(r)]:[],text:`⚽ DERNIER CORNER — Le gardien ${n==="home"?"":"adverse "}marque !`});const o=document.createElement("div");o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(o);const a=(s,l)=>new Promise(c=>{o.innerHTML=`<div style="font-size:32px;font-weight:900;color:${l};letter-spacing:2px;animation:lcFade 1.4s ease both">${s}</div>
    <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(c,1400)});(async()=>(await a("⚽ DERNIER CORNER","#FFD700"),await a("🧤 LE GARDIEN MONTE !","#4fc3f7"),o.remove(),t.pendingAttack=null,Ee(e,t,i),rt([Ve(r)],t.homeScore,t.aiScore,n==="home",()=>{if(Di(t)){Dt(e,t,i);return}zt(e,t,i,n==="home"?"ai-attack":"home-attack")})))()}function Di(e){const t=["MIL","ATT","GK","DEF"].some(n=>(e.homeTeam[n]||[]).some(r=>!r.used)),i=["MIL","ATT","GK","DEF"].some(n=>(e.aiTeam[n]||[]).some(r=>!r.used));return!t&&!i}function Ei(e,t,i){En(e,t,i)||(Di(t)?Dt(e,t,i):(t.phase="attack",Ee(e,t,i)))}function bi(e,t,i,n=null,r=null){var g,x;if(t.phase!=="attack"){_t("⏰ Remplacement uniquement avant une attaque","rgba(180,100,0,0.9)");return}if(t.usedSubIds||(t.usedSubIds=[]),t.subsUsed>=t.maxSubs){_t(`Maximum ${t.maxSubs} remplacements atteint`,"rgba(180,30,30,0.9)");return}const o=Object.entries(t.homeTeam).flatMap(([p,f])=>(f||[]).filter(b=>b.used).map(b=>({...b,_line:b._line||p}))),a=t.homeSubs.filter(p=>!t.usedSubIds.includes(p.cardId));if(!o.length){_t("Aucun joueur utilisé à remplacer");return}if(!a.length){_t("Aucun remplaçant disponible");return}let s=Math.max(0,o.findIndex(p=>p.cardId===r));const l=((g=o[s])==null?void 0:g._line)||((x=o[s])==null?void 0:x.job);let c=n?Math.max(0,a.findIndex(p=>p.cardId===n)):Math.max(0,a.findIndex(p=>p.job===l)),d=!1;const m=document.createElement("div");m.id="sub-overlay",m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function y(){var u,M,$,P,R,ne;const p=o[s],f=a[c],b=Math.min(130,Math.round((window.innerWidth-90)/2)),v=Math.round(b*1.35),h=ie=>`background:rgba(255,255,255,0.12);border:none;color:${ie?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${ie?"default":"pointer"};flex-shrink:0`;m.innerHTML=`
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${f?xt({...f,used:!1,boost:0},b,v):"<div>—</div>"}</div>
    ...
    </div>`,(u=m.querySelector("#sub-close"))==null||u.addEventListener("click",()=>m.remove()),(M=m.querySelector("#out-up"))==null||M.addEventListener("click",()=>{s>0&&(s--,y())}),($=m.querySelector("#out-down"))==null||$.addEventListener("click",()=>{s<o.length-1&&(s++,y())}),(P=m.querySelector("#in-up"))==null||P.addEventListener("click",()=>{c>0&&(c--,y())}),(R=m.querySelector("#in-down"))==null||R.addEventListener("click",()=>{c<a.length-1&&(c++,y())});const E=(ie,Q,j,w)=>{const C=m.querySelector("#"+ie);if(!C)return;let U=0;C.addEventListener("touchstart",re=>{U=re.touches[0].clientY},{passive:!0}),C.addEventListener("touchend",re=>{const ae=re.changedTouches[0].clientY-U;if(Math.abs(ae)<30)return;const se=Q();ae<0&&se<w-1?(j(se+1),y()):ae>0&&se>0&&(j(se-1),y())},{passive:!0})};E("in-panel",()=>c,ie=>c=ie,a.length),E("out-panel",()=>s,ie=>s=ie,o.length),(ne=m.querySelector("#sub-confirm"))==null||ne.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),d)return;d=!0;const Q=o[s],j=a[c];if(!Q||!j)return;let w=null,C=-1;for(const[re,ae]of Object.entries(t.homeTeam)){const se=(ae||[]).findIndex(de=>de.cardId===Q.cardId);if(se!==-1){w=re,C=se;break}}if(C===-1||!w){_t("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),m.remove();return}const U={...j,_line:w,_col:Q._col||0,used:!1,boost:0};t.homeTeam[w].splice(C,1,U),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(j.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Q.name,firstname:Q.firstname,note:Ge(Q,w),portrait:Wt(Q),job:Q.job,country_code:Q.country_code,rarity:Q.rarity,clubName:Q.clubName,clubLogo:Q.clubLogo},inPlayer:{name:j.name,firstname:j.firstname,note:Ge(j,w),portrait:Wt(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},text:`🔄 ${j.firstname} ${j.name} remplace ${Q.firstname} ${Q.name}`}),m.remove(),qo(Q,j,()=>Ee(e,t,i))})}document.body.appendChild(m),y()}function Yo(e,t,i,n,r){var x,p;const o=(n.gcDefs||[]).find(f=>f.name===t),a=Me[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",c=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||a.desc,m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,y=a.icon||"⚡",g=document.createElement("div");g.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",g.innerHTML=`
    ...
    </div>`,document.body.appendChild(g),(x=g.querySelector("#gc-back"))==null||x.addEventListener("click",()=>g.remove()),(p=g.querySelector("#gc-use"))==null||p.addEventListener("click",()=>{g.remove(),Xo(e,t,i,n,r)})}function ti(e,t,i,n,r,o){const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let s=[];function l(){var c,d;a.innerHTML=`
    ...
    </div>`,(c=a.querySelector("#gc-picker-close"))==null||c.addEventListener("click",()=>a.remove()),a.querySelectorAll(".gc-pick-item").forEach(m=>{m.addEventListener("click",()=>{const y=m.dataset.cid,g=e.find(p=>p.cardId===y);if(!g)return;const x=s.findIndex(p=>p.cardId===y);x>-1?s.splice(x,1):s.length<t&&s.push(g),l()})}),(d=a.querySelector("#gc-picker-confirm"))==null||d.addEventListener("click",()=>{a.remove(),o(s)})}l(),document.body.appendChild(a)}const Wo={BOOST_STAT:({value:e=1,count:t=1,roles:i=[]},n,r,o)=>{const a=Object.entries(n.homeTeam).filter(([s])=>!i.length||i.includes(s)).flatMap(([s,l])=>l.filter(c=>!c.used).map(c=>({...c,_line:s})));return a.length?(ti(a,t,`Choisir ${t} joueur(s) à booster (+${e})`,r,n,s=>{s.forEach(l=>{const c=(n.homeTeam[l._line]||[]).find(d=>d.cardId===l.cardId);c&&(c.boost=(c.boost||0)+e,n.log.push({text:`⚡ +${e} sur ${c.name}`,type:"info"}))}),Ee(r,n,o)}),!0):(n.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),Ee(r,n,o),!0)},DEBUFF_STAT:({value:e=1,count:t=1,roles:i=[],target:n="ai"},r,o,a)=>{const s=n==="home"?r.homeTeam:r.aiTeam,l=n==="ai"?"adverse":"allié",c=Object.entries(s).filter(([d])=>!i.length||i.includes(d)).flatMap(([d,m])=>m.filter(y=>!y.used).map(y=>({...y,_line:d})));return c.length?(ti(c,t,`Choisir ${t} joueur(s) ${l}(s) à débuffer (-${e})`,o,r,d=>{d.forEach(m=>{const g=((n==="home"?r.homeTeam:r.aiTeam)[m._line]||[]).find(x=>x.cardId===m.cardId);g&&(g.boost=(g.boost||0)-e,r.log.push({text:`🎯 -${e} sur ${g.name}${n==="ai"?" (IA)":""}`,type:"info"}))}),Ee(o,r,a)}),!0):(r.log.push({text:`🎯 Aucun joueur ${l} disponible`,type:"info"}),Ee(o,r,a),!0)},GRAY_PLAYER:({count:e=1,roles:t=[],target:i="ai"},n,r,o)=>{const a=i==="home"?n.homeTeam:n.aiTeam,s=i==="ai"?"adverse":"allié",l=Object.entries(a).filter(([c])=>!t.length||t.includes(c)).flatMap(([c,d])=>d.filter(m=>!m.used).map(m=>({...m,_line:c})));return l.length?(ti(l,e,`Choisir ${e} joueur(s) ${s}(s) à exclure`,r,n,c=>{c.forEach(d=>{const y=((i==="home"?n.homeTeam:n.aiTeam)[d._line]||[]).find(g=>g.cardId===d.cardId);y&&(y.used=!0,n.log.push({text:`❌ ${y.name}${i==="ai"?" (IA)":""} exclu !`,type:"info"}))}),Ee(r,n,o)}),!0):(n.log.push({text:`❌ Aucun joueur ${s} à exclure`,type:"info"}),Ee(r,n,o),!0)},REVIVE_PLAYER:({count:e=1,roles:t=[]},i,n,r)=>{const o=Object.entries(i.homeTeam).filter(([a])=>!t.length||t.includes(a)).flatMap(([a,s])=>s.filter(l=>l.used).map(l=>({...l,_line:a})));return o.length?(ti(o,e,`Choisir ${e} joueur(s) à ressusciter`,n,i,a=>{a.forEach(s=>{const l=(i.homeTeam[s._line]||[]).find(c=>c.cardId===s.cardId);l&&(l.used=!1,i.log.push({text:`💫 ${l.name} ressuscité !`,type:"info"}))}),Ee(n,i,r)}),!0):(i.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),Ee(n,i,r),!0)},REMOVE_GOAL:({},e)=>(e.aiScore>0?(e.aiScore--,e.log.push({text:"🚫 Dernier but IA annulé !",type:"info"})):e.log.push({text:"🚫 Aucun but à annuler",type:"info"}),!1),ADD_GOAL_DRAW:({},e)=>(e.homeScore===e.aiScore?(e.homeScore++,e.log.push({text:"🎯 But bonus (match nul) !",type:"info"})):e.log.push({text:"🎯 But bonus : non applicable (pas de match nul)",type:"info"}),!1),ADD_SUB:({value:e=1},t)=>(t.maxSubs=(t.maxSubs||3)+e,t.log.push({text:`🔄 +${e} remplacement(s) débloqué(s)`,type:"info"}),!1),CUSTOM:()=>!1};function Xo(e,t,i,n,r){n.usedGc.push(e);const o=n.gcDefs||[],a=o.find(l=>l.name===t)||o.find(l=>{var c;return((c=l.name)==null?void 0:c.toLowerCase().trim())===(t==null?void 0:t.toLowerCase().trim())});let s=!1;if(a!=null&&a.effect_type&&a.effect_type!=="CUSTOM"){const l=Wo[a.effect_type];l?l(a.effect_params||{},n,i,r)||(s=!0):(r.toast(`Effet "${a.effect_type}" non implémenté`,"error"),s=!0)}else{switch(t){case"Double attaque":n.modifiers.home.doubleAttack=!0,n.log.push({text:"⚡ Double attaque activée !",type:"info"});break;case"Bouclier":n.modifiers.home.shield=!0,n.log.push({text:"🛡️ Bouclier activé !",type:"info"});break;case"Ressusciter":{const l=Object.entries(n.homeTeam).flatMap(([c,d])=>(d||[]).filter(m=>m.used).map(m=>({...m,_line:c})));l.length?(l[0].used=!1,n.log.push({text:`💫 ${l[0].name} ressuscité !`,type:"info"})):n.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"});break}case"Vol de note":n.modifiers.ai.stolenNote=(n.modifiers.ai.stolenNote||0)+1,n.log.push({text:"🎯 -1 à la prochaine attaque IA",type:"info"});break;case"Gel":{const l=[...n.aiTeam.ATT||[],...n.aiTeam.MIL||[]].filter(c=>!c.used);if(l.length){const c=l.sort((d,m)=>Ge(m,"ATT")-Ge(d,"ATT"))[0];c.used=!0,n.log.push({text:`❄️ ${c.name} (IA) gelé !`,type:"info"})}break}case"Remplacement+":n.maxSubs++,n.log.push({text:"🔄 +1 remplacement débloqué",type:"info"});break}s=!0}_.from("cards").delete().eq("id",e).then(()=>{}),s&&Ee(i,n,r)}function Jo(e,t,i){const n=Object.values(t.homeTeam).flat().filter(r=>!r.used);if(!n.length){i.toast("Aucun joueur actif à booster","error");return}i.openModal("⚡ Utiliser le Boost",`<div style="margin-bottom:12px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border-radius:10px;padding:12px;text-align:center;color:#000">
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${n.map(r=>`
        <div class="player-boost-opt" data-card-id="${r.cardId}"
          ...
          <div style="width:32px;height:32px;background:${Mo[r.job]||"#888"};border-radius:6px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:13px">${Ge(r,r._line||r.job)}</div>
          <div style="flex:1"><b>${r.firstname} ${r.name}</b><div style="font-size:11px;color:#888">${r._line||r.job}</div></div>
          <div style="color:#87CEEB;font-weight:700">+${t.boostCard.value}</div>
        </div>`).join("")}
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Ee(e,t,i)})})}async function Dt(e,t,i){var d,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=Jn(t.mode,a);t.matchId&&await _.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await _.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(d=document.getElementById("res-home"))==null||d.addEventListener("click",()=>{c.remove(),Xe(e),i.navigate("home")}),(m=document.getElementById("res-replay"))==null||m.addEventListener("click",()=>{c.remove(),Xe(e),i.navigate("match",{matchMode:t.mode})})}function Qo(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${ci(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const jt=e=>_n(e);async function Tt(e,t,i,n,r={}){return Ln(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function Zo(e,t,i){const{data:n}=await _.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;let o=null,a=null;if(n.mode==="mini_league"){const{data:s}=await _.from("mini_league_matches").select("id, league_id").eq("match_id",i).maybeSingle();s&&(o=s.league_id,a=s.id)}return Ln(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,o,a)}async function Ln(e,t,i,n,r=[],o=[],a=!1,s=null,l=null,c=null,d=null,m=null){const{state:y,navigate:g,toast:x}=t,p=n?"p1":"p2",f=n?"p2":"p1",b=(r||[]).map(k=>k.id),v=(r||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:h}=await _.from("matches").select("*").eq("id",i).single();if(!h){x("Match introuvable","error"),g("home");return}async function E(){var me,xe;console.log("[PvP] buildGameState match:",{id:h.id,home_deck_id:h.home_deck_id,away_deck_id:h.away_deck_id,mode:h.mode,is_ranked:h.is_ranked});const[{data:k,error:L},{data:T,error:I},{data:z},{data:A}]=await Promise.all([_.rpc("get_deck_for_match",{p_deck_id:h.home_deck_id}),_.rpc("get_deck_for_match",{p_deck_id:h.away_deck_id}),_.from("users").select("id,pseudo,club_name").eq("id",h.home_id).single(),_.from("users").select("id,pseudo,club_name").eq("id",h.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",I==null?void 0:I.message,"p1D:",(me=k==null?void 0:k.starters)==null?void 0:me.length,"p2D:",(xe=T==null?void 0:T.starters)==null?void 0:xe.length);const F=te=>{const ze=Number(te.evolution_bonus)||0;return{cardId:te.card_id,position:te.position,id:te.id,firstname:te.firstname,name:te.surname_real,country_code:te.country_code,club_id:te.club_id,job:te.job,job2:te.job2,note_g:(Number(te.note_g)||0)+(te.job==="GK"||te.job2==="GK"&&Number(te.note_g)>0?ze:0),note_d:(Number(te.note_d)||0)+(te.job==="DEF"||te.job2==="DEF"&&Number(te.note_d)>0?ze:0),note_m:(Number(te.note_m)||0)+(te.job==="MIL"||te.job2==="MIL"&&Number(te.note_m)>0?ze:0),note_a:(Number(te.note_a)||0)+(te.job==="ATT"||te.job2==="ATT"&&Number(te.note_a)>0?ze:0),evolution_bonus:ze,rarity:te.rarity,skin:te.skin,hair:te.hair,hair_length:te.hair_length,face:te.face||null,clubName:te.club_encoded_name||null,clubLogo:te.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},B=((k==null?void 0:k.starters)||[]).map(te=>F(te)),K=((T==null?void 0:T.starters)||[]).map(te=>F(te)),Y=(k==null?void 0:k.formation)||"4-4-2",oe=(T==null?void 0:T.formation)||"4-4-2";let Z=ri(B,Y),H=ri(K,oe);const le=((k==null?void 0:k.subs)||[]).map(te=>F(te)),pe=((T==null?void 0:T.subs)||[]).map(te=>F(te)),ue=(k==null?void 0:k.stadium_def)||(n?l:null),ce=(T==null?void 0:T.stadium_def)||(n?null:l);return ue&&(Z=Xt(Z,ue),oi(le,ue)),ce&&(H=Xt(H,ce),oi(pe,ce)),{p1Team:Z,p2Team:H,p1Subs:le,p2Subs:pe,p1Formation:Y,p2Formation:oe,p1Name:(z==null?void 0:z.club_name)||(z==null?void 0:z.pseudo)||"Joueur 1",p2Name:(A==null?void 0:A.club_name)||(A==null?void 0:A.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?v:[],gcCardsFull_p2:n?[]:v,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let u=h.game_state&&Object.keys(h.game_state).length?h.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!u,"match.status:",h.status,"home_id:",h.home_id,"away_id:",h.away_id,"myId:",y.profile.id),!u)if(n){u=await E(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((u==null?void 0:u.p1Team)||{}));const{data:k}=await _.from("matches").select("game_state").eq("id",i).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await _.from("matches").update({game_state:u,turn_user_id:h.home_id}).eq("id",i):u=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let k=0;k<30&&!u;k++){await new Promise(T=>setTimeout(T,400));const{data:L}=await _.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(u=L.game_state),k%5===0&&console.log("[PvP] away - poll",k,"game_state:",!!(L!=null&&L.game_state))}if(!u){x("Erreur de synchronisation","error"),g("home");return}u.gc_p2=b,u.gcCardsFull_p2=v,await _.from("matches").update({game_state:u}).eq("id",i)}let M=!1,$=null,P=!1;const R=new Set,ne=new Set;async function ie(k){var oe,Z;try{_.removeChannel(Q)}catch{}const L=u[p+"Score"]||0,T=u[f+"Score"]||0;let I,z;k.winner_id?(I=k.winner_id===y.profile.id,z=!1):k.forfeit?(I=L>T,z=!1):(z=L===T,I=L>T);let A="";if(a&&n)try{const{data:H}=await _.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.home_id).single(),{data:le}=await _.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",h.away_id).single();if(H&&le){const pe=I?1:z?.5:0,ue=1-pe,ce=H.placement_matches<10,me=le.placement_matches<10,xe=computeGlicko2(H.mmr,H.mmr_deviation,H.mmr_volatility,le.mmr,le.mmr_deviation,pe===1?1:pe===0?0:.5,ce),te=computeGlicko2(le.mmr,le.mmr_deviation,le.mmr_volatility,H.mmr,H.mmr_deviation,ue===1?1:ue===0?0:.5,me);await _.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:z?null:I?h.home_id:h.away_id,p_home_id:h.home_id,p_away_id:h.away_id,p_home_delta:xe.delta,p_away_delta:te.delta,p_home_new_rd:xe.newRd,p_away_new_rd:te.newRd,p_home_new_vol:xe.newSigma,p_away_new_vol:te.newSigma});const ze=xe.delta,Fe=xe.newMmr,Ie=getTier(Fe),He=ze>=0?"+":"",It=ze>=0?"#4caf50":"#ff6b6b",Qe=getTier(H.mmr);A=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Ie.id!==Qe.id?`<div style="font-size:20px;font-weight:900;color:${Ie.color}">
                    ${Fe>H.mmr?"📈":"📉"} ${Qe.emoji} ${Qe.label} → ${Ie.emoji} ${Ie.label}
                  </div>
                  <div style="font-size:13px;color:rgba(255,255,255,0.5);margin-top:4px">${Fe>H.mmr?"Promotion !":"Rétrogradation"}</div>`:`<div style="font-size:36px">${ze>=0?"📈":"📉"}</div>
            ...
            </div>`}}catch(H){console.error("[Ranked] MMR update error:",H)}(oe=document.getElementById("pvp-end-overlay"))==null||oe.remove();const F=document.createElement("div");F.id="pvp-end-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const B=z?"🤝":I?"🏆":"😞",K=z?"MATCH NUL":I?"VICTOIRE !":"DÉFAITE",Y=z?"#fff":I?"#FFD700":"#ff6b6b";F.innerHTML=`
      ...
      <div style="font-size:18px">${u[p+"Name"]} ${L} – ${T} ${u[f+"Name"]}</div>
      ${k.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${I?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${A}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${d?"🏆 Retour à la Mini League":a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(F),(Z=F.querySelector("#pvp-end-home"))==null||Z.addEventListener("click",()=>{F.remove(),Xe(e),d?g("mini-league",{openLeagueId:d}):g(a?"ranked":"home")})}const Q=_.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(M)return;M=!0,$&&(clearInterval($),$=null),L.game_state&&(u=L.game_state),ie(L);return}if(L.game_state){const T=u;u=L.game_state;const I=u._lastGC;if(I&&I.seq&&!ne.has(I.seq)&&(ne.add(I.seq),I.by!==p)){N(I.type,I.by,()=>de());return}const z=T[p+"Score"]||0,A=T[f+"Score"]||0,F=u[p+"Score"]||0,B=u[f+"Score"]||0,K=F>z,Y=B>A;if((K||Y)&&!R.has(u.round)){R.add(u.round);const oe=[...u.log||[]].reverse().find(H=>H.isGoal),Z=((oe==null?void 0:oe.homePlayers)||[]).map(H=>({name:H.name,note:H.note,portrait:H.portrait,job:H.job}));rt(Z,F,B,K,()=>de());return}de()}}catch(T){console.error("[PvP] crash:",T)}}).subscribe();async function j(k){Object.assign(u,k),u.lastActionAt=new Date().toISOString();const{error:L}=await _.from("matches").update({game_state:u}).eq("id",i);L&&x("Erreur de synchronisation","error");try{de()}catch(T){console.error("[PvP] renderPvpScreen crash:",T)}}async function w(){if(M)return;M=!0,$&&(clearInterval($),$=null);const k=n?h.away_id:h.home_id,L=n?"p2":"p1",T=n?"p1":"p2",I={...u,[L+"Score"]:3,[T+"Score"]:0,phase:"finished"},z=I.p1Score||0,A=I.p2Score||0;try{await _.from("matches").update({game_state:I}).eq("id",i);const{data:F,error:B}=await _.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:k,p_home_score:z,p_away_score:A,p_forfeit:!0});if(B&&console.error("[PvP] finish_pvp_match (forfeit):",B),d)try{await _.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(K){console.error("[PvP] check_and_finish_mini_league (forfeit):",K)}try{const{data:K}=await _.rpc("apply_match_rewards",{p_match_id:i});K!=null&&K.success&&!(K!=null&&K.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(K){console.error("[PvP] apply_match_rewards (forfeit):",K)}}catch{}try{_.removeChannel(Q)}catch{}setTimeout(()=>{Xe(e),d?g("mini-league",{openLeagueId:d}):g("home")},800)}const C={BOOST_STAT:({value:k=1,count:L=1,roles:T=[]},I,z)=>{const A=I[p+"Team"],F=Object.entries(A).filter(([B])=>!T.length||T.includes(B)).flatMap(([B,K])=>K.filter(Y=>!Y.used).map(Y=>({...Y,_line:B})));if(!F.length){I.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),z(I);return}U(F,L,`Choisir ${L} joueur(s) à booster (+${k})`,B=>{B.forEach(K=>{const Y=(A[K._line]||[]).find(oe=>oe.cardId===K.cardId);Y&&(Y.boost=(Y.boost||0)+k,I.log.push({text:`⚡ +${k} sur ${Y.name}`,type:"info"}))}),I[p+"Team"]=A,z(I)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:T=[],target:I="ai"},z,A)=>{const F=I==="home"?p:f,B=z[F+"Team"],K=I==="home"?"allié":"adverse",Y=Object.entries(B).filter(([oe])=>!T.length||T.includes(oe)).flatMap(([oe,Z])=>Z.map(H=>({...H,_line:oe})));if(!Y.length){z.log.push({text:`🎯 Aucun joueur ${K}`,type:"info"}),A(z);return}U(Y,L,`Choisir ${L} joueur(s) ${K}(s) (-${k})`,oe=>{oe.forEach(Z=>{const H=(B[Z._line]||[]).find(le=>le.cardId===Z.cardId);H&&(H.boost=(H.boost||0)-k,z.log.push({text:`🎯 -${k} sur ${H.name}`,type:"info"}))}),z[F+"Team"]=B,A(z)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:T="ai"},I,z)=>{const A=T==="home"?p:f,F=I[A+"Team"],B=T==="home"?"allié":"adverse",K=Object.entries(F).filter(([Y])=>!L.length||L.includes(Y)).flatMap(([Y,oe])=>oe.filter(Z=>!Z.used).map(Z=>({...Z,_line:Y})));if(!K.length){I.log.push({text:`❌ Aucun joueur ${B}`,type:"info"}),z(I);return}U(K,k,`Choisir ${k} joueur(s) ${B}(s) à exclure`,Y=>{const oe="usedCardIds_"+A,Z=new Set(I[oe]||[]);Y.forEach(H=>{const le=(F[H._line]||[]).find(pe=>pe.cardId===H.cardId);le&&(le.used=!0,Z.add(H.cardId),I.log.push({text:`❌ ${le.name} exclu !`,type:"info"}))}),I[oe]=[...Z],I[A+"Team"]=F,z(I)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},T,I)=>{const z=T[p+"Team"],A=Object.entries(z).filter(([F])=>!L.length||L.includes(F)).flatMap(([F,B])=>B.filter(K=>K.used).map(K=>({...K,_line:F})));if(!A.length){T.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),I(T);return}U(A,k,`Choisir ${k} joueur(s) à ressusciter`,F=>{F.forEach(B=>{const K=(z[B._line]||[]).find(Y=>Y.cardId===B.cardId);K&&(K.used=!1,T.log.push({text:`💫 ${K.name} ressuscité !`,type:"info"}))}),T[p+"Team"]=z,I(T)})},REMOVE_GOAL:({},k,L)=>{const T=f+"Score";k[T]>0?(k[T]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[f+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,T)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),T(L)},CUSTOM:({},k,L)=>L(k)};function U(k,L,T,I){const z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let A=[];function F(){var K,Y;const B=k.map(oe=>{const Z=oe._line||oe.job||"MIL",H=A.find(pe=>pe.cardId===oe.cardId),le=Se({...oe,_evolution_bonus:0},{width:90,showStad:!0,role:Z,extraNote:oe.boost||0});return`<div class="pp-item" data-cid="${oe.cardId}"
        ...
        </div>`,(K=z.querySelector("#pp-close"))==null||K.addEventListener("click",()=>z.remove()),z.querySelectorAll(".pp-item").forEach(oe=>{oe.addEventListener("click",()=>{const Z=oe.dataset.cid,H=k.find(pe=>pe.cardId===Z),le=A.findIndex(pe=>pe.cardId===Z);H&&(le>-1?A.splice(le,1):A.length<L&&A.push(H),F())})}),(Y=z.querySelector("#pp-confirm"))==null||Y.addEventListener("click",()=>{z.remove(),I(A)})}F(),document.body.appendChild(z)}async function re(k,L){const I=(u["gcCardsFull_"+p]||[]).find(B=>B.id===k),z=(I==null?void 0:I._gcDef)||(u.gcDefs||[]).find(B=>{var K;return B.name===L||((K=B.name)==null?void 0:K.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),A=[...u["usedGc_"+p]||[],k],F={type:L,by:p,seq:(u._gcAnimSeq||0)+1};ne.add(F.seq),N(L,p,async()=>{if(z!=null&&z.effect_type&&z.effect_type!=="CUSTOM"){const K=C[z.effect_type];if(K){const Y={...u};K(z.effect_params||{},Y,async oe=>{oe["usedGc_"+p]=A,oe._lastGC=F,oe._gcAnimSeq=F.seq,await j(oe)});return}}const B={...u};switch(L){case"Remplacement+":B.maxSubs=(B.maxSubs||3)+1,B.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const K=f+"Score";B[K]>0&&(B[K]--,B.log.push({text:"🚫 But annulé",type:"info"}));break}}B["usedGc_"+p]=A,B._lastGC=F,B._gcAnimSeq=F.seq,await j(B)})}function ae(k,L){const T="usedCardIds_"+k,I=new Set(u[T]||[]);L.forEach(z=>I.add(z)),u[T]=[...I]}function se(){for(const k of["p1","p2"]){const L=new Set(u["usedCardIds_"+k]||[]),T=u[k+"Team"];if(T)for(const I of["GK","DEF","MIL","ATT"])(T[I]||[]).forEach(z=>{z.used=L.has(z.cardId)})}}function de(){var dt,lt,vt,Pi,Gi,Ri;if(u.phase==="reveal")return ke();if(u.phase==="midfield")return J();if(u.phase==="finished")return Rt();const k=u[p+"Team"];u[f+"Team"],se();const L=u[p+"Score"],T=u[f+"Score"],I=u[p+"Name"],z=u[f+"Name"],A=u.phase===p+"-attack",F=u.phase===p+"-defense",B=Array.isArray(u["selected_"+p])?u["selected_"+p]:[],K=B.map(ee=>ee.cardId),Y=window.innerWidth>=700,oe=u[p+"Subs"]||[],Z=u["usedSubIds_"+p]||[],H=oe.filter(ee=>!Z.includes(ee.cardId)),le=u["gcCardsFull_"+p]||[],pe=u["usedGc_"+p]||[],ue=le.filter(ee=>!pe.includes(ee.id)),ce=u.boostOwner===p&&!u.boostUsed,me=[...k.MIL||[],...k.ATT||[]].filter(ee=>!ee.used),xe=A&&me.length===0?[...k.GK||[],...k.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function te(ee,fe,Te){var Mt,pt;const he=ee._gcDef,St={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",tt={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",De=(he==null?void 0:he.name)||ee.gc_type,Ne=(he==null?void 0:he.effect)||((Mt=Me[ee.gc_type])==null?void 0:Mt.desc)||"",Ae=he!=null&&he.image_url?`/icons/${he.image_url}`:null,wt=((pt=Me[ee.gc_type])==null?void 0:pt.icon)||"⚡",Pe=Math.round(Te*.22),ct=Math.round(Te*.22),it=Te-Pe-ct,At=De.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
        style="box-sizing:border-box;width:${fe}px;height:${Te}px;border-radius:10px;border:2px solid ${tt};background:${St};display:flex;flex-direction:column;overflow:hidden;cursor:pointer;flex-shrink:0">
        ...
        <div style="height:${it}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Ae?`<img src="${Ae}" style="max-width:${fe-10}px;max-height:${it-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(it*.55)}px">${wt}</span>`}
        </div>
    ...
    </div>`,qe=A?"attack":F?"defense":"idle",Ze=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Pt(k,u[p+"Formation"],qe,K,Y?1300:Lt(),Y?600:qt(),xe)}
      </div>
    </div>`,Re=u[p+"Team"],ht=(()=>{var fe,Te,he,St,tt;if(F&&((fe=u.pendingAttack)!=null&&fe.players)){const De=u.pendingAttack;let Ne="";if(B.length>0){const Ae=B.map(Pe=>{const ct=(Re[Pe._role]||[]).find(fi=>fi.cardId===Pe.cardId)||Pe,it=Re[Pe._role]||[],At=it.findIndex(fi=>fi.cardId===Pe.cardId),Mt=ft(it.length),pt=At>=0?Mt[At]:ct._col??1;return{...ct,_line:Pe._role,_col:pt}}),wt=Yt(Ae,((Te=u.modifiers)==null?void 0:Te[p])||{},u[p+"Formation"]);Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Ye(Ae.map(Pe=>({...Pe,used:!1})),"#3a7bd5",wt.total,"defense",u[p+"Formation"])}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye((De.players||[]).map(Ae=>({...Ae,used:!1})),"#ff6b6b",De.total,"attack",u[f+"Formation"])}</div>
          ${Ne}
        </div>`}if(A&&((he=u.pendingAttack)!=null&&he.players)){const De=u.pendingAttack;return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #00ff88;text-align:center">
          <div style="font-size:8px;color:#00ff88;letter-spacing:2px;margin-bottom:4px;text-transform:uppercase">⚔️ VOUS ATTAQUEZ</div>
          <div style="display:flex;justify-content:center">${Ye((De.players||[]).map(Ne=>({...Ne,used:!1})),"#00ff88",De.total,"attack",u[p+"Formation"])}</div>
        </div>`}if(A&&!((St=u.pendingAttack)!=null&&St.players)&&B.length>0){const De=B.map(Ae=>{const wt=(Re[Ae._role]||[]).find(pt=>pt.cardId===Ae.cardId)||Ae,Pe=["GK","DEF"].includes(Ae._role),ct=Re[Ae._role]||[],it=ct.findIndex(pt=>pt.cardId===Ae.cardId),At=ft(ct.length),Mt=it>=0?At[it]:wt._col??1;return{...wt,_line:Ae._role,_col:Mt,...Pe?{note_a:Math.max(1,Number(wt.note_a)||0)}:{}}}),Ne=Vt(De,((tt=u.modifiers)==null?void 0:tt[p])||{},u[p+"Formation"]);return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye(De.map(Ae=>({...Ae,used:!1})),"#FFD700",Ne.total,"attack",u[p+"Formation"])}</div>
        </div>`}const ee=(u.log||[]).slice(-1)[0];return ee?'<div style="padding:2px 4px">'+kn(ee)+"</div>":'<div style="padding:6px 8px;font-size:11px;color:rgba(255,255,255,0.3);text-align:center">⏳ Match en cours...</div>'})(),et=`
      <div style="display:flex;align-items:center;padding:8px 10px;background:rgba(0,0,0,0.5);gap:6px;flex-shrink:0">
      ...
      <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
        ...
        <div id="mobile-play-area" style="flex:1;min-height:0;display:flex;overflow:hidden">
          <div id="match-field" style="flex:1;min-width:0;min-height:0;overflow:hidden">
            <div class="terrain-wrapper" style="width:100%;height:100%;overflow:hidden">
              ${Pt(k,u[p+"Formation"],qe,K,Lt(),qt(),xe)}
            </div>
          </div>
        </div>
        <div id="mobile-action-bar" style="position:absolute;left:0;right:0;bottom:0;z-index:20;background:rgba(0,0,0,0.55);padding:6px 8px 8px;display:flex;flex-direction:column;gap:6px;box-shadow:0 -4px 16px rgba(0,0,0,0.5)">
      ...
      </div>`;function Ue(){const ee=e.querySelector(".match-screen");if(!ee)return;const fe=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);ee.style.height=fe+"px",ee.style.minHeight=fe+"px",ee.style.maxHeight=fe+"px",ee.style.overflow="hidden";const Te=e.querySelector("#mobile-action-bar"),he=e.querySelector("#mobile-play-area");Te&&he&&(he.style.paddingBottom=Te.offsetHeight+"px")}if(Ue(),setTimeout(Ue,120),setTimeout(Ue,400),P||(P=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Ue),window.visualViewport.addEventListener("scroll",Ue)),window.addEventListener("resize",Ue)),function(){const fe=e.querySelector("#match-field .terrain-wrapper svg")||e.querySelector(".terrain-wrapper svg");if(!fe)return;const Te=fe.closest("#match-terrain-wrap");Te&&(Te.style.cssText="position:relative;width:100%;height:100%;padding:0"),fe.removeAttribute("width"),fe.removeAttribute("height"),fe.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",fe.setAttribute("preserveAspectRatio","xMidYMid meet")}(),u._pvpResizeBound||(u._pvpResizeBound=!0,window.addEventListener("resize",()=>{const ee=e.querySelector(".terrain-wrapper svg");if(ee){const fe=ee.closest("#match-terrain-wrap");fe&&(fe.style.cssText="position:relative;width:100%;height:100%;padding:0"),ee.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0"}})),e.querySelectorAll(".match-slot-hit").forEach(ee=>{ee.addEventListener("click",()=>{if(!A&&!F)return;const fe=ee.dataset.cardId,Te=ee.dataset.role,he=(k[Te]||[]).find(Ne=>Ne.cardId===fe);if(!he||he.used)return;const St=xe.includes(fe);if(A&&!["MIL","ATT"].includes(Te)&&!St)return;Array.isArray(u["selected_"+p])||(u["selected_"+p]=[]);const tt=u["selected_"+p],De=tt.findIndex(Ne=>Ne.cardId===fe);De>-1?tt.splice(De,1):tt.length<3&&tt.push({...he,_role:Te}),de()})}),e.querySelectorAll(".match-used-hit").forEach(ee=>{ee.addEventListener("click",()=>G(ee.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(ee=>{ee.addEventListener("click",()=>G())}),(dt=e.querySelector("#pvp-sub-open"))==null||dt.addEventListener("click",()=>G()),e.querySelectorAll(".pvp-gc-mini").forEach(ee=>{A?ee.addEventListener("click",()=>S(ee.dataset.gcId,ee.dataset.gcType)):(ee.style.opacity="0.35",ee.style.cursor="default",ee.addEventListener("click",()=>_t("⚡ Les Game Changers ne sont utilisables qu'en attaque","rgba(180,100,0,0.9)")))}),(lt=e.querySelector("#pvp-boost-card"))==null||lt.addEventListener("click",()=>q()),(vt=e.querySelector("#pvp-action"))==null||vt.addEventListener("click",ee=>{A?ee.currentTarget.dataset.pass==="1"||!je(p)?O():be():F&&$e()}),(Pi=e.querySelector("#pvp-quit"))==null||Pi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&w()}),(Gi=e.querySelector("#pvp-view-opp"))==null||Gi.addEventListener("click",()=>V()),(Ri=e.querySelector("#pvp-toggle-history"))==null||Ri.addEventListener("click",()=>D()),$&&(clearInterval($),$=null),(A||F)&&!M){let ee=30,fe=!1;const Te=()=>document.getElementById("pvp-timer"),he=()=>{Te()&&(Te().textContent=ee+"s",Te().style.color=fe?"#ff4444":"#fff")};he(),$=setInterval(()=>{ee--,ee<0?fe?(clearInterval($),$=null,A&&!je(p)?O():w()):(fe=!0,ee=15,he()):he()},1e3)}}function ke(){ot(e),e.innerHTML=`
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(H);let le=!1;const pe=()=>{le||(le=!0,H.remove(),setTimeout(()=>T&&T(),50))};H.addEventListener("click",pe),setTimeout(pe,3e3)}function S(k,L){var H,le,pe,ue;const I=(u["gcCardsFull_"+p]||[]).find(ce=>ce.id===k),z=I==null?void 0:I._gcDef,A={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[z==null?void 0:z.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",F={purple:"#b06ce0",light_blue:"#00d4ef"}[z==null?void 0:z.color]||"#b06ce0",B=(z==null?void 0:z.name)||L,K=(z==null?void 0:z.effect)||((H=Me[L])==null?void 0:H.desc)||"Carte spéciale.",Y=z!=null&&z.image_url?`/icons/${z.image_url}`:null,oe=((le=Me[L])==null?void 0:le.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ...
      </div>`,document.body.appendChild(Z),(pe=Z.querySelector("#pvp-gc-back"))==null||pe.addEventListener("click",()=>Z.remove()),(ue=Z.querySelector("#pvp-gc-use"))==null||ue.addEventListener("click",()=>{Z.remove(),re(k,L)})}function q(){var I;const k=u[p+"Team"],L=Object.entries(k).flatMap(([z,A])=>(A||[]).filter(F=>!F.used).map(F=>({...F,_line:z})));if(!L.length)return;const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",T.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(z=>{const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",F=Ge(z,z._line)+(z.boost||0);return`<div class="bp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${A};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(T),(I=T.querySelector("#bp-close"))==null||I.addEventListener("click",()=>T.remove()),T.querySelectorAll(".bp-item").forEach(z=>{z.addEventListener("click",async()=>{const A=z.dataset.cid,F=L.find(K=>K.cardId===A);if(!F)return;const B=(k[F._line]||[]).find(K=>K.cardId===A);B&&(B.boost=(B.boost||0)+u.boostValue),T.remove(),await j({[p+"Team"]:k,boostUsed:!0})})})}function G(k=null){var le,pe;if(!(u.phase===p+"-attack")){x("Remplacement uniquement avant votre attaque","warning");return}const T=u[p+"Team"],I=u["usedSubIds_"+p]||[],z=u.maxSubs||3;if(I.length>=z){x(`Maximum ${z} remplacements atteint`,"warning");return}const A=Object.entries(T).flatMap(([ue,ce])=>(ce||[]).filter(me=>me.used).map(me=>({...me,_line:ue}))),F=(u[p+"Subs"]||[]).filter(ue=>!I.includes(ue.cardId));if(!A.length){x("Aucun joueur utilisé à remplacer","warning");return}if(!F.length){x("Aucun remplaçant disponible","warning");return}let B=Math.max(0,A.findIndex(ue=>ue.cardId===k));const K=((le=A[B])==null?void 0:le._line)||((pe=A[B])==null?void 0:pe.job);let Y=Math.max(0,F.findIndex(ue=>ue.job===K)),oe=!1;const Z=document.createElement("div");Z.id="pvp-sub-overlay",Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function H(){var Fe,Ie,He,It,Qe,Qt;const ue=A[B],ce=F[Y],me=Math.min(130,Math.round((window.innerWidth-90)/2)),xe=Math.round(me*1.35),te=qe=>`background:rgba(255,255,255,0.12);border:none;color:${qe?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${qe?"default":"pointer"};flex-shrink:0`;Z.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
        <div style="flex:1;font-size:15px;font-weight:900;color:#fff">🔄 Remplacement (${I.length}/${z})</div>
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <div>${ce?xt({...ce,used:!1,boost:0},me,xe):"<div>—</div>"}</div>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <div>${ue?xt({...ue,used:!1,boost:0},me,xe):"<div>—</div>"}</div>
      ...
      </div>`,(Fe=Z.querySelector("#psub-close"))==null||Fe.addEventListener("click",()=>Z.remove()),(Ie=Z.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{B>0&&(B--,H())}),(He=Z.querySelector("#pout-down"))==null||He.addEventListener("click",()=>{B<A.length-1&&(B++,H())}),(It=Z.querySelector("#pin-up"))==null||It.addEventListener("click",()=>{Y>0&&(Y--,H())}),(Qe=Z.querySelector("#pin-down"))==null||Qe.addEventListener("click",()=>{Y<F.length-1&&(Y++,H())});const ze=(qe,Ze,Re,ht)=>{const et=Z.querySelector("#"+qe);if(!et)return;let Ue=0;et.addEventListener("touchstart",dt=>{Ue=dt.touches[0].clientY},{passive:!0}),et.addEventListener("touchend",dt=>{const lt=dt.changedTouches[0].clientY-Ue;if(Math.abs(lt)<30)return;const vt=Ze();lt<0&&vt<ht-1?(Re(vt+1),H()):lt>0&&vt>0&&(Re(vt-1),H())},{passive:!0})};ze("pin-panel",()=>Y,qe=>Y=qe,F.length),ze("pout-panel",()=>B,qe=>B=qe,A.length),(Qt=Z.querySelector("#psub-confirm"))==null||Qt.addEventListener("click",async qe=>{if(qe.preventDefault(),qe.stopPropagation(),oe)return;oe=!0;const Ze=A[B],Re=F[Y];if(!Ze||!Re)return;const ht=Ze._line,et=(T[ht]||[]).findIndex(lt=>lt.cardId===Ze.cardId);if(et===-1){x("Erreur : joueur introuvable","error"),Z.remove();return}const Ue={...Re,_line:ht,position:Ze.position,used:!1,boost:0};T[ht].splice(et,1,Ue);const dt=[...I,Re.cardId];Z.remove(),X(Ze,Re,async()=>{await j({[p+"Team"]:T,[f+"Team"]:u[f+"Team"],["usedSubIds_"+p]:dt})})})}document.body.appendChild(Z),H()}function X(k,L,T){const I={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},z=document.createElement("div");z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const A=(K,Y,oe)=>`<div style="text-align:center">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:6px">Appuyer pour continuer</div>`,document.body.appendChild(z);let F=!1;const B=()=>{F||(F=!0,z.remove(),setTimeout(()=>T(),50))};z.addEventListener("click",B),setTimeout(B,2200)}function V(){var L;const k=document.createElement("div");k.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:20px;overflow-y:auto",k.innerHTML=`
      <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:2px;text-transform:uppercase">Équipe adverse</div>
      <div style="font-size:18px;font-weight:900;color:#ff6b6b">${u[f+"Name"]}</div>
      <div style="width:min(90vw,420px)">${ci(u[f+"Team"],u[f+"Formation"],null,[],Lt(),qt())}</div>
      <button id="pvp-opp-close" style="margin-top:8px;padding:12px 28px;border-radius:12px;border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#fff;font-size:14px;cursor:pointer">Fermer</button>`,document.body.appendChild(k),(L=k.querySelector("#pvp-opp-close"))==null||L.addEventListener("click",()=>k.remove())}function D(){var T;const k=u.log||[],L=document.createElement("div");L.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:800;display:flex;flex-direction:column",L.innerHTML=`
      ...
      </div>`,document.body.appendChild(L),(T=L.querySelector("#pvp-hist-close"))==null||T.addEventListener("click",()=>L.remove())}async function O(){if(u.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(u.round||0)+1,T=[...u.log||[]];T.push({type:"info",text:`⏭️ ${u[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const I=Oe(u),z=je(k),A=I||!z?"finished":k+"-attack";await j({["selected_"+p]:[],modifiers:{...u.modifiers,[p]:{}},pendingAttack:null,phase:A,attacker:k,round:L,log:T}),A==="finished"&&await Je(u)}function we(k){const L=(k.GK||[]).some(I=>!I.used),T=["DEF","MIL","ATT"].some(I=>(k[I]||[]).some(z=>!z.used));return L&&!T}function _e(k){return(k.p1Score||0)!==(k.p2Score||0)?null:we(k.p1Team)&&!ge(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(L=>!L.used)}:we(k.p2Team)&&!ge(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(L=>!L.used)}:null}async function ye(k,L){const{side:T,gk:I}=k;if(!I)return;const z=T+"Score",A=(L[z]||0)+1;I.used=!0;const F=[...L.log||[]];F.push({type:"duel",isGoal:!0,homeScored:T===p,homePlayers:T==="p1"?[jt(I)]:[],aiPlayers:T==="p2"?[jt(I)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[T+"Name"]} marque !`});const B=(L.round||0)+1,K=T==="p1"?"p2":"p1",Y={...L,[z]:A},oe=Oe(Y);R.add(B);const Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(Z);const H=(ue,ce)=>new Promise(me=>{Z.innerHTML=`<div style="font-size:32px;font-weight:900;color:${ce};letter-spacing:2px;animation:lcFade 1.4s ease both">${ue}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(me,1400)});await H("⚽ DERNIER CORNER","#FFD700"),await H("🧤 LE GARDIEN MONTE !","#4fc3f7"),Z.remove();const le=T===p?A:L[p+"Score"]||0,pe=T===p?L[f+"Score"]||0:A;rt([jt(I)],le,pe,T===p,async()=>{await j({[z]:A,log:F,round:B,pendingAttack:null,phase:oe?"finished":K+"-attack",attacker:K,["selected_"+p]:[],modifiers:{...u.modifiers,[p]:{}}}),oe&&await Je({...u,[z]:A})})}async function be(){const k=u[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(A=>(u[f+"Team"][A]||[]).some(F=>!F.used)),T=(u["selected_"+p]||[]).map(A=>{const F=(k[A._role]||[]).find(pe=>pe.cardId===A.cardId)||A,B=["GK","DEF"].includes(A._role),K=k[A._role]||[],Y=K.findIndex(pe=>pe.cardId===A.cardId),oe=ft(K.length),Z=Y>=0?oe[Y]:F._col??1,H=u.stadiumDef||u.homeStadiumDef||null,le=F.stadiumBonus||H&&(H.club_id&&String(F.club_id)===String(H.club_id)||H.country_code&&F.country_code===H.country_code)||!1;return{...F,_line:A._role,_col:Z,stadiumBonus:le,...B?{note_a:Math.max(1,Number(F.note_a)||0)}:{}}});if(!T.length)return;const I=Vt(T,u.modifiers[p]||{},u[p+"Formation"]);ae(p,T.map(A=>A.cardId)),T.forEach(A=>{const F=(k[A._role]||[]).find(B=>B.cardId===A.cardId);F&&(F.used=!0)}),u["selected_"+p]=[],de();const z=[...u.log||[]];if(L){if(T.length===1&&(T[0]._line==="GK"||T[0].job==="GK")&&(u.p1Score||0)===(u.p2Score||0)){await ye({side:p,gk:T[0]},{...u,[p+"Team"]:k,log:z});return}const F=(u[p+"Score"]||0)+1,B=T.map(H=>jt(H));z.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:B,homeTotal:I.total,aiTotal:0});const K=(u.round||0)+1,Y=p==="p1"?"p2":"p1",oe={...u,[p+"Team"]:k,[p+"Score"]:F},Z=Oe(oe);R.add(K),rt(B,F,u[f+"Score"]||0,!0,async()=>{await j({[p+"Team"]:k,[p+"Score"]:F,["selected_"+p]:[],modifiers:{...u.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":Y+"-attack",attacker:Y,round:K,log:z}),Z&&await Je({...u,[p+"Score"]:F})});return}z.push({type:"pending",text:`⚔️ ${u[p+"Name"]} attaque (${I.total})`}),await j({[p+"Team"]:k,[f+"Team"]:u[f+"Team"],pendingAttack:{...I,players:T,side:p},["selected_"+p]:[],modifiers:{...u.modifiers,[p]:{}},phase:f+"-defense",log:z})}async function $e(){const k=u[p+"Team"],L=(u["selected_"+p]||[]).map(ce=>{const me=(k[ce._role]||[]).find(Ie=>Ie.cardId===ce.cardId)||ce,xe=k[ce._role]||[],te=xe.findIndex(Ie=>Ie.cardId===ce.cardId),ze=ft(xe.length),Fe=te>=0?ze[te]:me._col??1;return{...me,_line:ce._role,_col:Fe}}),T=Yt(L,u.modifiers[p]||{},u[p+"Formation"]);ae(p,L.map(ce=>ce.cardId)),L.forEach(ce=>{const me=(k[ce._role]||[]).find(xe=>xe.cardId===ce.cardId);me&&(me.used=!0)}),u["selected_"+p]=[],de();const I=Ci(u.pendingAttack.total,T.total,u.modifiers[p]||{}),z=u.pendingAttack.side,A=I==="attack"||(I==null?void 0:I.goal),F=z==="p1"?"p2":"p1",B=(u.round||0)+1,K=(u.pendingAttack.players||[]).map(ce=>jt(ce)),Y=[...u.log||[]];Y.push({type:"duel",isGoal:A,homeScored:A&&z===p,text:A?`⚽ BUT de ${u[z+"Name"]} ! (${u.pendingAttack.total} vs ${T.total})`:`✋ Attaque stoppée (${u.pendingAttack.total} vs ${T.total})`,homePlayers:K,aiPlayers:L.map(ce=>jt(ce)),homeTotal:u.pendingAttack.total,aiTotal:T.total});const oe=A?(u[z+"Score"]||0)+1:u[z+"Score"]||0,Z={...u,[p+"Team"]:k,[z+"Score"]:oe},H=Oe(Z),le=H?"finished":F+"-attack",pe=!H&&!A?_e(Z):null,ue=async()=>{if(pe){await ye(pe,Z);return}await j({[p+"Team"]:k,[f+"Team"]:u[f+"Team"],[z+"Score"]:oe,["selected_"+p]:[],modifiers:{...u.modifiers,[p]:{}},pendingAttack:null,phase:le,attacker:F,round:B,log:Y}),(le==="finished"||H)&&await Je({...u,[z+"Score"]:oe})};if(A){const ce=z===p,me=ce?oe:u[p+"Score"]||0,xe=ce?u[f+"Score"]||0:oe;R.add(B),rt(K,me,xe,ce,ue)}else await ue()}function Le(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(T=>!T.used))}function ge(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(T=>!T.used))}function Be(k){return ge(k)&&!Le(k)}function je(k){const L=u[k+"Team"];return!!(Le(L)||Be(L))}function Oe(k){return!ge(k.p1Team)&&!ge(k.p2Team)}function bt(k){const L=k.p1Score||0,T=k.p2Score||0;return L===T?null:L>T?h.home_id:h.away_id}async function Je(k){try{const L=bt(k),T=L?h.home_id===L?h.away_id:h.home_id:null,I=k.p1Score||0,z=k.p2Score||0,{data:A,error:F}=await _.rpc("finish_pvp_match",{p_match_id:i,p_winner_id:L,p_home_score:I,p_away_score:z,p_forfeit:!1});if(F&&console.error("[PvP] finish_pvp_match:",F),d)try{await _.rpc("check_and_finish_mini_league",{p_league_id:d})}catch(B){console.error("[PvP] check_and_finish_mini_league:",B)}L&&T&&eo(L,T).catch(()=>{});try{const{data:B}=await _.rpc("apply_match_rewards",{p_match_id:i});B!=null&&B.success&&!(B!=null&&B.skipped)&&typeof t.refreshProfile=="function"&&await t.refreshProfile()}catch(B){console.error("[PvP] apply_match_rewards:",B)}if(typeof c=="function")try{await c({homeScore:I,awayScore:z,winnerId:L,homeId:h.home_id,awayId:h.away_id,matchId:i})}catch(B){console.error("[PvP] onMatchEnd:",B)}}catch(L){console.error("[PvP] finishMatch:",L)}}function Rt(){var z;const k=u[p+"Score"],L=u[f+"Score"],T=k>L,I=k===L;ot(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      <div style="font-size:64px">${T?"🏆":I?"🤝":"😤"}</div>
      <div style="font-size:24px;font-weight:900;color:#fff">${T?"Victoire !":I?"Match nul":"Défaite"}</div>
    ...
    </div>`,(z=document.getElementById("pvp-home"))==null||z.addEventListener("click",()=>{try{_.removeChannel(Q)}catch{}Xe(e),d?g("mini-league",{openLeagueId:d}):g("home")})}de()}async function Li(e,t,i=!1){var s,l;const{state:n,navigate:r,toast:o}=t,a=i&&((l=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:l.rankedData)||null;await pi(e,t,i?"ranked":"random",async({deckId:c,formation:d,starters:m,subsRaw:y,gcCardsEnriched:g,gcDefs:x,stadiumDef:p})=>{ot(e);const f=async b=>{await tr(e,t,c,d,m,y,b||[],x,p,i,a)};if(!(g!=null&&g.length)){await f([]);return}li(e,g,f)})}async function er(e,t,i){return Zo(e,t,i)}async function tr(e,t,i,n,r,o,a=[],s=[],l=null,c=!1,d=null){var ie,Q;const{state:m,navigate:y,toast:g}=t,x=(d==null?void 0:d.mmr)??((ie=m.profile)==null?void 0:ie.mmr)??1e3,p=c?Ai(x):null,f=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let v=!1,h=null,E=null;e.innerHTML=`
    ...
    </div>`;const u=async()=>{v=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null);try{await _.rpc("cancel_matchmaking",{p_user_id:m.profile.id})}catch(j){console.error("[Matchmaking] cancel error:",j)}};(Q=document.getElementById("cancel-mm"))==null||Q.addEventListener("click",async()=>{await u(),Xe(e),y("home")});const M=async(j,w)=>{v||(v=!0,h&&(h.unsubscribe(),h=null),E&&(clearInterval(E),E=null),await Tt(e,t,j,w,{myGC:a,gcDefs:s,stadiumDef:l,isRanked:c,rankedData:d,onMatchEnd:c?ir:null}))},$=m.user.id,{data:P,error:R}=c?await _.rpc("try_matchmake_ranked",{p_user_id:$,p_deck_id:i,p_mmr:x}):await _.rpc("try_matchmake",{p_user_id:$,p_deck_id:i});if(R||!(P!=null&&P.success)){console.error("[Matchmaking] try_matchmake error:",R||P),g("Erreur de matchmaking","error"),Xe(e),y("home");return}if(P.matched){await M(P.match_id,!1);return}const ne=async()=>{if(v)return;const{data:j}=await _.from("matchmaking_queue").select("status, match_id").eq("user_id",$).maybeSingle();(j==null?void 0:j.status)==="matched"&&j.match_id&&await M(j.match_id,!0)};h=_.channel(`mm_${$}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${$}`},j=>{const w=j.new;w.status==="matched"&&w.match_id&&M(w.match_id,!0)}).subscribe(),E=setInterval(ne,3e3),setTimeout(()=>{v||u()},12e4)}async function ir(e,t){const{state:i,toast:n}=t,{winnerId:r,homeId:o,awayId:a,homeScore:s,awayScore:l,matchId:c}=e,d=i.user.id,m=o===d,y=r===d,{data:g}=await _.from("users").select("mmr, mmr_rd, mmr_v").eq("id",d).single(),{data:x}=await _.from("users").select("mmr, mmr_rd, mmr_v").eq("id",m?a:o).single();if(g&&x){const p=An(g.mmr,g.mmr_rd,g.mmr_v,x.mmr,x.mmr_rd,y?1:0);await _.from("users").update({mmr:p.mmr,mmr_rd:p.rd,mmr_v:p.v,mmr_wins:y?_.sql`mmr_wins + 1`:void 0,mmr_losses:y?void 0:_.sql`mmr_losses + 1`}).eq("id",d),n(y?`+MMR ↑ ${Math.round(p.mmr-g.mmr)}`:`-MMR ↓ ${Math.round(g.mmr-p.mmr)}`,y?"success":"error",4e3)}}const nr=Object.freeze(Object.defineProperty({__proto__:null,renderMatchRandom:Li,resumePvpMatch:er},Symbol.toStringTag,{value:"Module"}));async function or(e,t){const{state:i,navigate:n,toast:r}=t,o=i.params||{},a=o.friendId||null,s=o.friendName||"Ami",l=!!o.isAccepting;await pi(e,t,"friend",async({deckId:c,formation:d,starters:m,subsRaw:y,gcCardsEnriched:g,gcDefs:x,stadiumDef:p})=>{ot(e);const f=async b=>{const v=b||[];l?await ar(e,t,c,v,x,p):await rr(e,t,c,v,x,p,a,s)};if(!(g!=null&&g.length)){await f([]);return}li(e,g,f)})}async function rr(e,t,i,n,r,o,a,s){var v;const{state:l,navigate:c,toast:d}=t,m=l.user.id,{data:y,error:g}=await _.from("friend_match_invites").insert({inviter_id:m,invitee_id:a,friend_id:a,status:"pending",inviter_deck_id:i,expires_at:new Date(Date.now()+2*60*1e3).toISOString()}).select("id").single();if(g||!y){console.error("[Friend] Erreur création invitation:",g),d("Impossible de créer l'invitation","error"),c("home");return}e.innerHTML=`
    ...
    </div>`;let x=!1,p=null;const f=async()=>{p&&(p.unsubscribe(),p=null)};(v=document.getElementById("cancel-friend"))==null||v.addEventListener("click",async()=>{await f(),await _.from("friend_match_invites").update({status:"declined"}).eq("id",y.id),Xe(e),c("home")}),p=_.channel(`friend_invite_${y.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${y.id}`},async({new:h})=>{x||h.status!=="accepted"||!h.match_id||(x=!0,await f(),await Tt(e,t,h.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))}).subscribe();const b=setInterval(async()=>{if(x)return;const{data:h}=await _.from("friend_match_invites").select("status, match_id").eq("id",y.id).single();(h==null?void 0:h.status)==="accepted"&&h.match_id&&(x=!0,clearInterval(b),await f(),await Tt(e,t,h.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))},3e3);setTimeout(async()=>{x||(clearInterval(b),await f(),d("Invitation expirée","info"),c("home"))},12e4)}async function ar(e,t,i,n,r,o){const{state:a,navigate:s,toast:l}=t,c=a.user.id,{data:d}=await _.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",c).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!d){l("Aucune invitation en attente","error"),s("home");return}const{data:m,error:y}=await _.rpc("accept_friend_invite",{p_invite_id:d.id,p_invitee_deck_id:i});if(y||!(m!=null&&m.success)){console.error("[Friend] Erreur accept_friend_invite:",y||m),l((m==null?void 0:m.error)||"Impossible de rejoindre le match","error"),s("home");return}await Tt(e,t,m.match_id,!1,{myGC:n,gcDefs:r,stadiumDef:o})}const zn="#1A6B3C",at="#D4A017",Nt="rgba(255,255,255,0.045)",kt="rgba(255,255,255,0.09)",$t="rgba(255,255,255,0.08)",Ce="#f3f5f2",nt="rgba(243,245,242,0.62)",Ke="rgba(243,245,242,0.4)";async function sr(e,t){var n;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(n=t.state.params)==null?void 0:n.openLeagueId;if(i){t.state.params.openLeagueId=null,await st(e,t,i);return}await We(e,t)}async function We(e,t,i="waiting"){var h,E;const{state:n}=t,r=n.profile.id,{data:o}=await _.from("mini_league_members").select("league_id, prize_amount, prize_claimed").eq("user_id",r),a=(o||[]).map(u=>u.league_id),s={};(o||[]).forEach(u=>{s[u.league_id]={amount:u.prize_amount,claimed:u.prize_claimed}});const{data:l,error:c}=await _.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),d=c?(await _.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:l||[],y=(a.length?await _.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],g=y.filter(u=>u.status==="waiting"&&!u.is_archived),x=y.filter(u=>u.status==="active"&&!u.is_archived),p=y.filter(u=>u.is_archived||u.status==="finished");let f=p;if(p.length){const{data:u}=await _.from("mini_league_matches").select("league_id").in("league_id",p.map($=>$.id)).or(`home_id.eq.${r},away_id.eq.${r}`).not("status","eq","bye"),M=new Set((u||[]).map($=>$.league_id));f=p.filter($=>M.has($.id))}const b=d.filter(u=>!a.includes(u.id)),v=[{key:"waiting",label:"🟡 En attente",count:g.length+b.length},{key:"active",label:"🟢 En cours",count:x.length},{key:"archived",label:"📁 Archivées",count:f.length}];e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${$t}">
      ${v.map(u=>`<button class="ml-tab" data-tab="${u.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===u.key?zn:"transparent"};background:none;font-size:12px;font-weight:${i===u.key?"900":"600"};color:${i===u.key?"#4ade80":Ke};cursor:pointer">${u.label}${u.count?` (${u.count})`:""}</button>`).join("")}
    </div>
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:10px">
      ${i==="waiting"?dr(g,b,r):i==="active"?lr(x,r):cr(f,r,s)}
    </div>
  </div>`,(h=document.getElementById("ml-create-btn"))==null||h.addEventListener("click",()=>pr(e,t)),(E=document.getElementById("ml-refresh-list"))==null||E.addEventListener("click",()=>We(e,t,i)),e.querySelectorAll(".ml-tab").forEach(u=>u.addEventListener("click",()=>We(e,t,u.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(u=>u.addEventListener("click",()=>st(e,t,u.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(u=>u.addEventListener("click",M=>{M.stopPropagation(),Tn(e,t,u.dataset.join,u.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(u=>u.addEventListener("click",M=>{M.stopPropagation(),zi(e,t,u.dataset.delete,u.dataset.name,i)})),e.querySelectorAll("[data-claim-league]").forEach(u=>u.addEventListener("click",async M=>{M.stopPropagation(),u.disabled=!0,u.textContent="...";const{data:$,error:P}=await _.rpc("claim_mini_league_prize",{p_league_id:u.dataset.claimLeague,p_user_id:n.profile.id});if(P||!($!=null&&$.success)){t.toast(($==null?void 0:$.error)||"Erreur lors de la récupération","error"),We(e,t,i);return}if(!$.already_claimed){n.profile.credits=(n.profile.credits||0)+$.prize;const R=document.getElementById("nav-credits");R&&(R.textContent=`💰 ${n.profile.credits.toLocaleString("fr")}`),t.toast(`💰 +${$.prize.toLocaleString("fr")} cr. ajoutés !`,"success")}We(e,t,i)}))}function di(e,t,i=!1,n=null){var l,c;const r=e.creator_id===t,o=e.pot||0,a=((c=(l=e.mini_league_members)==null?void 0:l[0])==null?void 0:c.count)||0,s=n&&n.amount>0&&!n.claimed;return`<div data-league-id="${e.id}" style="background:${Nt};border:1px solid ${s?"rgba(212,160,23,0.5)":kt};border-radius:12px;padding:14px 16px;cursor:pointer;margin-bottom:8px">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;font-size:11px;color:${nt};margin-bottom:${i||s?"10px":"0"}">
    ...
    <div style="padding:20px;display:flex;flex-direction:column;gap:14px">
      ...
      </div>`,document.body.appendChild(t);const i=t.querySelector("#ml-pwd-input"),n=r=>{t.remove(),e(r)};setTimeout(()=>i==null?void 0:i.focus(),80),t.querySelector("#pwd-cancel").addEventListener("click",()=>n(null)),t.querySelector("#pwd-ok").addEventListener("click",()=>n(i.value.trim())),i.addEventListener("keydown",r=>{r.key==="Enter"&&n(i.value.trim())})})}async function Tn(e,t,i,n){var m;const{toast:r,state:o}=t,a=o.profile.id;let s=null;if(n==="private"&&(s=await ur(),s===null))return;const{data:l,error:c}=await _.rpc("join_mini_league",{p_league_id:i,p_user_id:a,p_password:s});if(c||!(l!=null&&l.success)){console.error("[MiniLeague] join_mini_league:",c||l),r((l==null?void 0:l.error)||"Erreur lors de l'inscription","error");return}if(typeof t.refreshProfile=="function")await t.refreshProfile();else{const{data:y}=await _.from("users").select("credits").eq("id",a).single();o.profile&&y&&(o.profile.credits=y.credits)}const d=document.getElementById("nav-credits");d&&(d.textContent=`💰 ${(((m=o.profile)==null?void 0:m.credits)||0).toLocaleString("fr")}`),r("✅ Inscrit ! Pot mis à jour.","success"),st(e,t,i)}async function fr(e,t,i,n){const{toast:r,state:o}=t,a=o.profile.id;if(!await new Promise(y=>{const g=document.createElement("div");g.className="modal-overlay",g.style.zIndex="2100",g.innerHTML=`<div class="modal" style="max-width:360px">
    ...
    </div>`,document.body.appendChild(g),g.querySelector("#lv-ok").onclick=()=>{g.remove(),y(!0)},g.querySelector("#lv-cancel").onclick=()=>{g.remove(),y(!1)}}))return;const{data:l,error:c}=await _.rpc("leave_mini_league",{p_league_id:i,p_user_id:a});if(c||!(l!=null&&l.success)){r((l==null?void 0:l.error)||"Erreur lors de la désinscription","error");return}const d=l.refund||n;o.profile&&(o.profile.credits=(o.profile.credits||0)+d);const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(o.profile.credits||0).toLocaleString("fr")}`),r(`↩️ Désinscrit · +${d.toLocaleString("fr")} cr. remboursés`,"success"),We(e,t,"waiting")}async function zi(e,t,i,n,r){const{toast:o}=t;if(!confirm(`Supprimer définitivement "${n}" et tous ses matchs/membres ? Action irréversible.`))return;await _.from("mini_league_matches").delete().eq("league_id",i),await _.from("mini_league_members").delete().eq("league_id",i);const{error:a}=await _.from("mini_leagues").delete().eq("id",i);if(a){o("Erreur suppression ("+a.message+")","error");return}o("Mini League supprimée avec succès","success"),We(e,t,r)}async function gr(e,t,i){await _.from("mini_leagues").update({is_archived:!0}).eq("id",i),t.toast("Mini League archivée","success"),We(e,t,"archived")}async function st(e,t,i){var E,u,M,$,P,R,ne,ie,Q;const{state:n,toast:r}=t,o=n.profile.id,[{data:a},{data:s},{data:l}]=await Promise.all([_.from("mini_leagues").select("*").eq("id",i).single(),_.from("mini_league_members").select("*, user:users(id,pseudo,club_name,club_color1,club_color2)").eq("league_id",i),_.from("mini_league_matches").select("*").eq("league_id",i).order("matchday").order("created_at")]);if(!a){r("Introuvable","error"),await We(e,t);return}const c=(s||[]).some(j=>j.user_id===o),d=a.creator_id===o,m=(s||[]).map(j=>j.user).filter(Boolean),y=hr(m,l||[]),g=(l||[]).filter(j=>j.matchday===a.current_day),x=a.pot||0,p=a.entry_fee||100,f=g.length>0&&g.every(j=>j.status==="finished"||j.status==="bye"),b=a.current_day>=a.total_days,v=(s||[]).find(j=>j.user_id===o);e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Nt};border:1px solid ${kt};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${Ce}">👥 Joueurs (${m.length}/${a.max_players})</div>
        <div style="font-size:12px;color:${nt};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*m.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*m.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*m.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*m.length*.1).toLocaleString("fr")})</div>
        ${m.map(j=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid ${$t}">
            <div style="width:36px;height:36px;border-radius:50%;background:${j.club_color2||zn};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${j.club_color1||"#fff"}">${(j.pseudo||"?").slice(0,2).toUpperCase()}</div>
            <div style="flex:1"><div style="font-size:13px;font-weight:700;color:${Ce}">${j.club_name||j.pseudo}</div><div style="font-size:11px;color:${Ke}">@${j.pseudo}</div></div>
      ...
      <div style="background:${Nt};border:1px solid ${kt};border-radius:12px;padding:16px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${y.map((j,w)=>{const C=x>0&&a.status==="finished"?w===0?Math.floor(x*.7):w===1?Math.floor(x*.2):w===2?Math.floor(x*.1):0:0;return`<tr style="border-bottom:1px solid ${$t};${j.userId===o?"background:rgba(74,222,128,0.08);":""}">
              <td style="padding:7px 3px 7px 0;font-weight:700;color:${w===0?at:w<3?"#4ade80":nt}">${["🥇","🥈","🥉"][w]||w+1}</td>
              <td style="padding:7px 3px"><div style="font-weight:700;color:${Ce}">${j.clubName}</div><div style="font-size:10px;color:${Ke}">@${j.pseudo}</div></td>
              <td style="text-align:center;color:${nt}">${j.played}</td><td style="text-align:center;color:${nt}">${j.won}-${j.drawn}-${j.lost}</td>
              <td style="text-align:center;color:${j.goalDiff>=0?"#4ade80":"#ff6b6b"}">${j.goalDiff>=0?"+":""}${j.goalDiff}</td>
              <td style="text-align:center;font-weight:900;font-size:14px;color:${Ce}">${j.points}</td>
              ${x>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${at}">${C?C.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:${Nt};border:1px solid ${kt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,w)=>w+1).reverse().map(j=>{const w=(l||[]).filter(C=>C.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ke};margin-bottom:6px">Journée ${j}</div>${w.map(C=>tn(C,m,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  </div>`;const h=a.status==="waiting"?"waiting":a.status==="active"?"active":"archived";if((E=document.getElementById("ml-back"))==null||E.addEventListener("click",()=>We(e,t,h)),(u=document.getElementById("ml-refresh"))==null||u.addEventListener("click",async j=>{const w=j.currentTarget;w.style.opacity="0.5",await st(e,t,i)}),(M=document.getElementById("ml-start-btn"))==null||M.addEventListener("click",()=>mr(e,t,a,m)),($=document.getElementById("ml-next-day"))==null||$.addEventListener("click",()=>xr(e,t,i)),(P=document.getElementById("ml-join-now"))==null||P.addEventListener("click",()=>Tn(e,t,i,a.type)),(R=document.getElementById("ml-leave-btn"))==null||R.addEventListener("click",()=>fr(e,t,i,p)),(ne=document.getElementById("ml-delete-btn"))==null||ne.addEventListener("click",()=>zi(e,t,i,a.name,"waiting")),(ie=document.getElementById("ml-delete-now"))==null||ie.addEventListener("click",()=>zi(e,t,i,a.name,h)),(Q=document.getElementById("ml-archive-btn"))==null||Q.addEventListener("click",()=>gr(e,t,i)),e.querySelectorAll("[data-play-match]").forEach(j=>{j.addEventListener("click",()=>{const w=g.find(C=>C.id===j.dataset.playMatch);w&&t.navigate("match-mini-league",{mlMatchId:w.id,leagueId:i})})}),a.status==="finished"&&v){const j=y.findIndex(w=>w.userId===o);j>=0&&j<3&&v.prize_amount>0&&!v.prize_claimed&&setTimeout(()=>yr(e,t,a,v,j),400)}}function tn(e,t,i,n,r=!1){const o=m=>t.find(y=>y.id===m);if(e.is_bye){const m=o(e.home_id);return`<div style="padding:8px;border-radius:8px;background:rgba(255,255,255,0.03);margin-bottom:6px;font-size:12px;color:${nt};text-align:center">🔵 ${(m==null?void 0:m.club_name)||(m==null?void 0:m.pseudo)||"?"} exempté(e)</div>`}const a=o(e.home_id),s=o(e.away_id),l=e.home_id===i||e.away_id===i,c=l&&e.status==="pending"&&n&&!r,d=e.status==="finished"?`${e.home_score} - ${e.away_score}`:"vs";return`<div style="display:flex;align-items:center;gap:8px;padding:10px;border-radius:8px;background:${l?"rgba(26,107,60,0.16)":"rgba(255,255,255,0.03)"};margin-bottom:6px;border:1px solid ${l?"rgba(74,222,128,0.35)":$t}">
  ...
  </div>`}async function mr(e,t,i,n){const{toast:r,state:o}=t,a=br(n.map(c=>c.id),i.mode),s=[];a.forEach((c,d)=>c.forEach(m=>s.push({league_id:i.id,matchday:d+1,home_id:m.home||m.bye,away_id:m.away||null,is_bye:!!m.bye,status:m.bye?"bye":"pending"})));const{error:l}=await _.from("mini_league_matches").insert(s);if(l){r("Erreur calendrier : "+l.message,"error");return}await _.from("mini_leagues").update({status:"active",current_day:1,total_days:a.length}).eq("id",i.id),r(`🚀 Lancée ! Pot : ${(i.pot||0).toLocaleString("fr")} cr.`,"success"),st(e,t,i.id)}async function xr(e,t,i){const{data:n}=await _.from("mini_leagues").select("current_day,total_days,pot").eq("id",i).single(),r=(n.current_day||0)+1;if(r>(n.total_days||0)){st(e,t,i);return}await _.from("mini_leagues").update({current_day:r}).eq("id",i),t.toast(`Journée ${r} commencée !`,"success"),st(e,t,i)}async function yr(e,t,i,n,r){var y,g;const{state:o,toast:a}=t,s=[Math.floor((i.pot||0)*.7),Math.floor((i.pot||0)*.2),Math.floor((i.pot||0)*.1)],l=["🥇","🥈","🥉"][r],c=n.prize_amount||s[r]||0,d=n.prize_claimed,m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",m.innerHTML=`
    ...
    </div>`;let d=!1;const m=async f=>{if(!d){if(d=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}f&&await Tt(e,t,f,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),l()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(x),g)try{g.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),l()});const y=async()=>{if(d)return;const{data:f}=await _.from("mini_league_matches").select("match_id").eq("id",i).single();f!=null&&f.match_id&&m(f.match_id)},g=_.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},f=>{var b;(b=f.new)!=null&&b.match_id&&m(f.new.match_id)}).subscribe(),x=setInterval(y,3e3);y()})}const wr="/",_r=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function kr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var d,m,y;const s=t[n],l=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
    ...
    `,r.querySelectorAll("ul,ol").forEach(g=>{g.style.paddingLeft="20px",g.style.marginTop="6px",g.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(g=>{g.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(g=>{g.style.marginBottom="8px"}),(d=r.querySelector("#tuto-prev"))==null||d.addEventListener("click",()=>{n--,o()}),(m=r.querySelector("#tuto-next"))==null||m.addEventListener("click",()=>{l?a():(n++,o())}),(y=r.querySelector("#tuto-skip"))==null||y.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),e!=null&&e.id&&await _.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(r),o()}async function $r(e,t,i){if(!e||e.tutorial_done)return;let n=[];const{data:r,error:o}=await _.rpc("get_tutorial_steps");if(!o&&(r==null?void 0:r.length)>0)n=r,console.log(`[Tutorial] RPC OK → ${n.length} étapes`);else{const{data:s,error:l}=await _.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!l&&(s==null?void 0:s.length)>0?(n=s,console.log(`[Tutorial] Direct OK → ${n.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${o==null?void 0:o.message}, Direct: ${l==null?void 0:l.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=n.length>0?n.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):_r;kr(e,a,()=>t("boosters"))}const ii={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function Ct(e,t,i=0){return t?(Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0)+(t===e.job||t===e.job2?i:0):0}async function Er(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await Fi(e,t)}async function Fi(e,t){const{state:i,toast:n}=t,{data:r}=await _.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let l="buy";const c=()=>{var p,f,b,v,h,E,u;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((f=document.getElementById("flt-club"))==null?void 0:f.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((v=document.getElementById("flt-job"))==null?void 0:v.value)||"",rarity:((h=document.getElementById("flt-rarity"))==null?void 0:h.value)||"",note1:parseInt((E=document.getElementById("flt-note1"))==null?void 0:E.value)||0,note2:parseInt((u=document.getElementById("flt-note2"))==null?void 0:u.value)||0}};function d(p){const f=c();return p.filter(b=>{var R,ne,ie;const v=(R=b.card)==null?void 0:R.player;if(!v)return!1;const h=`${v.firstname} ${v.surname_real}`.toLowerCase(),E=(((ne=v.clubs)==null?void 0:ne.encoded_name)||"").toLowerCase(),u=(v.country_code||"").toLowerCase(),M=((ie=b.card)==null?void 0:ie.evolution_bonus)||0,$=Ct(v,v.job,M),P=v.job2?Ct(v,v.job2,M):0;return!(f.name&&!h.includes(f.name)||f.club&&!E.includes(f.club)||f.country&&!u.includes(f.country)||f.job&&v.job!==f.job||f.rarity&&v.rarity!==f.rarity||f.note1&&$<f.note1||f.note2&&P<f.note2)})}function m(p){var P,R,ne,ie;const f=(P=p.card)==null?void 0:P.player;if(!f)return"";const b=((R=p.card)==null?void 0:R.evolution_bonus)||0,v=Ct(f,f.job,b),h=f.job2?Ct(f,f.job2,b):0,E=(i.profile.credits||0)>=p.price,u=f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ii[f.job]||"#bbb",$=f.job2?ii[f.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function y(p){var P,R,ne,ie;const f=(P=p.card)==null?void 0:P.player;if(!f)return"";const b=((R=p.card)==null?void 0:R.evolution_bonus)||0,v=Ct(f,f.job,b),h=f.job2?Ct(f,f.job2,b):0,E=p.status==="sold",u=f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,M=ii[f.job]||"#bbb",$=f.job2?ii[f.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${E?"opacity:0.7":""}">
      ${u?`<img src="${u}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ne=f.clubs)!=null&&ne.logo_url?`<img src="${f.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${M};display:flex;align-items:center;justify-content:center">
    ...
    </div>`}function g(){const p=document.getElementById("mkt-content"),f=document.getElementById("mkt-filters");if(p){if(f.style.display=l==="buy"?"flex":"none",l==="buy"){const b=d(a);p.innerHTML=b.length?b.map(m).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const b=s.filter(h=>h.status==="active").sort((h,E)=>new Date(E.listed_at)-new Date(h.listed_at)),v=s.filter(h=>h.status==="sold").sort((h,E)=>new Date(E.sold_at||E.listed_at)-new Date(h.sold_at||h.listed_at));p.innerHTML=(b.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${b.length})</div>`+b.map(y).join(""):"")+(v.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${v.length})</div>`+v.map(y).join(""):"")+(!b.length&&!v.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(b=>b.addEventListener("click",()=>Lr(b.dataset.buy,a,e,t))),p.querySelectorAll("[data-cancel]").forEach(b=>b.addEventListener("click",()=>Tr(b.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{l=p.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(f=>{const b=f===p;f.style.background=b?"var(--green)":"#fff",f.style.color=b?"#fff":"var(--gray-600)",f.style.borderColor=b?"var(--green)":"var(--gray-200)"}),g()})});let x;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var f;(f=document.getElementById(p))==null||f.addEventListener("input",()=>{clearTimeout(x),x=setTimeout(g,250)})}),g()}async function Lr(e,t,i,n){const{state:r,toast:o,refreshProfile:a}=n,s=t.find(d=>d.id===e);if(!s)return;const l=s.price;if((r.profile.credits||0)<l){o("Crédits insuffisants","error");return}zr(s,async()=>{const{error:d}=await _.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:r.profile.id});if(d){o("Erreur achat : "+d.message,"error");return}await a();const m=document.getElementById("nav-credits");m&&(m.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),o("✅ Carte achetée !","success"),await Fi(i,n)})}function zr(e,t){var a;const i=(a=e.card)==null?void 0:a.player,n=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
    ...
    </div>`,document.body.appendChild(r);const o=s=>{r.remove(),s&&t()};r.querySelector("#buy-cancel").addEventListener("click",()=>o(!1)),r.querySelector("#buy-ok").addEventListener("click",()=>o(!0)),r.addEventListener("click",s=>{s.target===r&&o(!1)})}async function Tr(e,t,i){const{toast:n}=i,{data:r}=await _.from("market_listings").select("card_id").eq("id",e).single();if(await _.from("market_listings").update({status:"cancelled"}).eq("id",e),r!=null&&r.card_id){const{count:o}=await _.from("market_listings").select("id",{count:"exact",head:!0}).eq("card_id",r.card_id).eq("status","active");o||await _.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",r.card_id)}n("Annonce retirée","success"),Fi(t,i)}async function Ir(e,t){var d,m,y,g;const{state:i,navigate:n}=t,r=((m=(d=t==null?void 0:t.state)==null?void 0:d.params)==null?void 0:m.tab)||"global";e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const[{data:o},{data:a}]=await Promise.all([_.from("users").select("id,pseudo,club_name,trophies_top1,trophies_top2,trophies_top3,wins,level").order("trophies_top1",{ascending:!1}).limit(100),_.from("users").select("id,pseudo,club_name,mmr,rank_tier,ranked_wins,ranked_losses,ranked_draws,placement_matches").gte("placement_matches",1).order("mmr",{ascending:!1}).limit(100)]);let s=r;function l(){var p,f;const x=document.getElementById("rankings-list");if(x){if(s==="global"){const b=o||[];x.innerHTML=b.length>0?b.map((v,h)=>`
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=a||[];x.innerHTML=b.length>0?b.map((v,h)=>{const E=Ai(v.mmr??1e3),u=(v.ranked_wins||0)+(v.ranked_losses||0)+(v.ranked_draws||0),M=u>0?Math.round((v.ranked_wins||0)/u*100):0,$=v.id===i.profile.id,P=(v.placement_matches||0)<10;return`
          <div class="card-panel" style="display:flex;align-items:center;gap:12px;padding:12px;${$?"border:2px solid var(--yellow)":""}">
            ...
            <div style="flex:1;min-width:0">
              ...
              <div style="font-size:11px;color:var(--gray-600)">${v.club_name} · ${E.label}</div>
            </div>
            <div style="text-align:right;flex-shrink:0">
              <div style="font-size:20px">${P?"❓":E.emoji}</div>
              <div style="font-size:11px;font-weight:700;color:${E.color}">${P?"Placement":E.label}</div>
  ...
  <div class="page">
    ...
    </div>`,(M=document.getElementById("ranked-back"))==null||M.addEventListener("click",()=>n("home"));return}const l=s.mmr??1e3,c=s.mmr_deviation??350,d=s.mmr_volatility??.06,m=s.placement_matches??0,y=m<10,g=Math.max(0,10-m),x=Ai(l),p=Mn(l),f=gi.findIndex(ne=>ne.id===x.id),b=gi[f+1]||null,v={bronze:"linear-gradient(160deg,#3d1c00,#7a3e00)",silver:"linear-gradient(160deg,#1a1a2e,#3a3a5e)",gold:"linear-gradient(160deg,#1a1200,#4a3500)",platinum:"linear-gradient(160deg,#001a20,#003040)",diamond:"linear-gradient(160deg,#001030,#1a2860)",master:"linear-gradient(160deg,#1a0030,#3d0070)"},h=(s.ranked_wins||0)+(s.ranked_losses||0)+(s.ranked_draws||0),E=h>0?Math.round((s.ranked_wins||0)/h*100):0,u=gi.map(ne=>`
    <div style="display:flex;flex-direction:column;align-items:center;gap:2px;opacity:${x.id===ne.id?1:.35};
      transform:${x.id===ne.id?"scale(1.15)":"scale(1)"};transition:all 0.3s">
      <div style="font-size:${x.id===ne.id?"28px":"20px"}">${ne.emoji}</div>
      <div style="font-size:9px;color:${ne.color};font-weight:${x.id===ne.id?"900":"400"};letter-spacing:0.5px">${ne.label.toUpperCase()}</div>
    </div>
  `).join("");e.innerHTML=`
  ...
  </div>`}jn(Bn);const ve={user:null,profile:null,page:"home",params:{}};function Bt(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Mr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function Ti(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ot(){if(!ve.user)return;const{data:e}=await _.from("users").select("*").eq("id",ve.user.id).single();e&&(ve.profile=e)}function Ht(e,t={}){ve.page=e,ve.params=t,In()}async function In(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const t=document.getElementById("nav-credits");t&&ve.profile&&(t.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Ht,toast:Bt,openModal:Mr,closeModal:Ti,refreshProfile:Ot};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Ui(e,i);break;case"collection":await lo(e,i);break;case"decks":await vi(e,i);break;case"boosters":await _o(e,i);break;case"ranked":await Sr(e,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Li(e,i,!1):s==="ranked"?await Li(e,i,!0):s==="friend"?await or(e,i,(n=ve.params)==null?void 0:n.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini_league"||s==="mini-league"?await nn(e,i,(o=ve.params)==null?void 0:o.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await Do(e,i);break}case"market":await Er(e,i);break;case"rankings":await Ir(e,i);break;case"matches":await Ar(e,i);break;case"friends":await Nn(e,i);break;case"mini-league":await sr(e,i);break;case"match-mini-league":{const s=ve.params||{};await nn(e,i,s.mlMatchId,s.leagueId);break}default:await Ui(e,i)}}function jr(){var n;const e=document.getElementById("app"),t=ve.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
