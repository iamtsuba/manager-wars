...
import{s as w,l as Pt,F as Ii,r as Ae,j as Jt,m as on,h as Ai,n as Sn,o as jn,T as gi,k as Cn,p as Bn,b as qn}from"./formation-links-yJiMLlPw.js";const Dn="/";function Ri(e,{navigate:t,toast:i}){let n="login";const r=()=>{var a,s,l,c,d,g;const o=n==="login";e.innerHTML=`
    <div style="
    ...
    </style>`,(a=document.getElementById("tab-login-btn"))==null||a.addEventListener("click",()=>{n="login",r()}),(s=document.getElementById("tab-reg-btn"))==null||s.addEventListener("click",()=>{n="register",r()}),o?((l=document.getElementById("login-password"))==null||l.addEventListener("keydown",x=>{var m;x.key==="Enter"&&((m=document.getElementById("login-btn"))==null||m.click())}),(c=document.getElementById("login-btn"))==null||c.addEventListener("click",async()=>{const x=document.getElementById("login-email").value.trim(),m=document.getElementById("login-password").value,u=document.getElementById("login-error");if(u.textContent="",!x||!m){u.textContent="Remplissez tous les champs.";return}const p=document.getElementById("login-btn");p.textContent="⏳ Connexion…",p.disabled=!0;const{error:f}=await w.auth.signInWithPassword({email:x,password:m});if(p.textContent="⚽ Se connecter",p.disabled=!1,f){u.textContent=f.message.includes("Invalid")?"Email ou mot de passe incorrect.":f.message;return}window.location.reload()})):((d=document.getElementById("reg-confirm"))==null||d.addEventListener("keydown",x=>{var m;x.key==="Enter"&&((m=document.getElementById("reg-btn"))==null||m.click())}),(g=document.getElementById("reg-btn"))==null||g.addEventListener("click",async()=>{const x=document.getElementById("reg-email").value.trim(),m=document.getElementById("reg-password").value,u=document.getElementById("reg-confirm").value,p=document.getElementById("reg-error");if(p.textContent="",!x||!m||!u){p.textContent="Remplissez tous les champs.";return}if(m.length<6){p.textContent="Mot de passe trop court (min. 6 caractères).";return}if(m!==u){p.textContent="Les mots de passe ne correspondent pas.";return}const f=document.getElementById("reg-btn");f.textContent="⏳ Création…",f.disabled=!0;const{error:b}=await w.auth.signUp({email:x,password:m});if(f.textContent="🚀 Créer mon compte",f.disabled=!1,b){p.textContent=b.message;return}i("Compte créé ! Connecte-toi pour commencer.","success",4e3),n="login",r(),setTimeout(()=>{const h=document.getElementById("login-email");h&&(h.value=x)},50)}))};r()}function Fn(e,{state:t,navigate:i,toast:n,refreshProfile:r}){let o="#1A6B3C",a="#D4A017";e.innerHTML=`
  ...
  `;function s(){var u;const c=document.getElementById("logo-preview"),d=document.getElementById("logo-initials"),g=((u=document.getElementById("setup-club"))==null?void 0:u.value)||"MW",x=g.trim().split(" ").filter(Boolean),m=x.length>=2?(x[0][0]+x[1][0]).toUpperCase():g.slice(0,2).toUpperCase();c&&(c.style.background=a,c.style.borderColor=o),d&&(d.textContent=m,d.style.color=o)}document.getElementById("color1").addEventListener("input",c=>{o=c.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",c=>{a=c.target.value,document.getElementById("swatch2").style.background=a,s()});function l(c){document.querySelectorAll(".setup-step").forEach(d=>d.classList.remove("active")),document.getElementById(`step-${c}`).classList.add("active"),document.getElementById("step-num").textContent=c,document.getElementById("progress-fill").style.width=`${Math.round(c/3*100)}%`,c===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("step1-error");if(d.textContent="",c.length<3){d.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:g}=await w.from("users").select("id").eq("pseudo",c).maybeSingle();if(g){d.textContent="Ce pseudo est déjà pris.";return}l(2)}),document.getElementById("step2-back").addEventListener("click",()=>l(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const c=document.getElementById("setup-club").value.trim(),d=document.getElementById("step2-error");if(d.textContent="",c.length<2){d.textContent="Nom trop court (min. 2 caractères).";return}const{data:g}=await w.from("users").select("id").eq("club_name",c).maybeSingle();if(g){d.textContent="Ce nom de club est déjà pris.";return}l(3)}),document.getElementById("step3-back").addEventListener("click",()=>l(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const c=document.getElementById("setup-pseudo").value.trim(),d=document.getElementById("setup-club").value.trim(),g=document.getElementById("step3-error"),x=document.getElementById("step3-finish");g.textContent="",x.disabled=!0,x.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:c,club_name:d,club_color1:o,club_color2:a,credits:1e4});if(m)throw m;await Pn(t.user.id),await r(),n(`Bienvenue ${c} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){g.textContent=m.message,x.disabled=!1,x.textContent="🚀 Créer mon profil !"}})}async function Pn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const Gn="modulepreload",Rn=function(e){return"/"+e},Ni={},rn=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(i.map(l=>{if(l=Rn(l),l in Ni)return;Ni[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":Gn,c||(g.as="script"),g.crossOrigin="",g.href=l,s&&g.setAttribute("nonce",s),document.head.appendChild(g),c)return new Promise((x,m)=>{g.addEventListener("load",x),g.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return r.then(a=>{for(const s of a||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Ut="#1A6B3C",Kt="#cc2222",Nn="#D4A017",Oi="#888";async function On(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </div>`}function Un(e,t){const i=Mi();i.innerHTML=`
    <div class="popup-box">
    ...
    ${Si()}`,document.body.appendChild(c);const g=()=>c.remove();c.querySelector("#pending-close").addEventListener("click",g),c.addEventListener("click",x=>{x.target===c&&g()}),c.querySelectorAll("[data-accept]").forEach(x=>{x.addEventListener("click",async()=>{const{error:m}=await w.from("friendships").update({status:"accepted"}).eq("id",x.dataset.accept);if(m){t("Erreur : "+m.message,"error");return}x.closest("div[style]").remove(),t("✅ Ami accepté !","success"),an(e,t,n),i&&i()})}),c.querySelectorAll("[data-decline]").forEach(x=>{x.addEventListener("click",async()=>{await w.from("friendships").delete().eq("id",x.dataset.decline),x.closest("div[style]").remove(),t("Demande refusée","info"),i&&i()})})}async function Kn(e,t,i){const n=e.user.id,[r,o]=[n,t].sort(),a=n===r,{data:s}=await w.from("friend_match_stats").select("*").eq("player1_id",r).eq("player2_id",o).single(),l=e.profile.club_name||e.profile.pseudo||"Moi",c=s||{},d=a?c.wins_p1||0:c.wins_p2||0,g=a?c.wins_p2||0:c.wins_p1||0,x=c.draws||0,m=a?c.goals_p1||0:c.goals_p2||0,u=a?c.goals_p2||0:c.goals_p1||0,p=a?c.gc_used_p1||0:c.gc_used_p2||0,f=a?c.gc_used_p2||0:c.gc_used_p1||0,b=c.matches_total||0,h=($,y,C,E=Ut,P=Kt)=>`
    ...
    <div class="popup-box" style="max-width:380px">
      ...
      ${b===0?`
        ...
        ${h("GC utilisés ⚡",p,f,"#7a28b8","#7a28b8")}
        <div style="text-align:center;font-size:12px;color:#aaa;padding-top:8px">${b} match${b>1?"s":""} joué${b>1?"s":""}</div>`}
      <button id="stats-close" class="popup-btn-cancel" style="width:100%;margin-top:14px">Fermer</button>
    </div>
    ${Si()}`,document.body.appendChild(v),v.querySelector("#stats-close").addEventListener("click",()=>v.remove()),v.addEventListener("click",$=>{$.target===v&&v.remove()})}function Mi(){const e=document.createElement("div");return e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:8000;display:flex;align-items:center;justify-content:center;padding:20px",e}function Si(){return`
    <style>
      .popup-box {
    ...
    </style>`}const Vn="2026.07.18-1157";async function Hi(e,{state:t,navigate:i,toast:n}){var o,a;const r=t.profile;r&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
  ...
  </div>`,requestAnimationFrame(()=>{var g,x,m,u,p;const s=((g=window.visualViewport)==null?void 0:g.height)||window.innerHeight,l=((x=document.querySelector(".top-nav"))==null?void 0:x.offsetHeight)||56,c=((m=document.querySelector(".bottom-nav"))==null?void 0:m.offsetHeight)||60;if(e.querySelector(".home-inner")){const f=s-l-c;e.querySelector(".home-dark").style.minHeight=f+"px"}if(window.innerWidth<768){const f=((u=e.querySelector(".home-hero"))==null?void 0:u.offsetHeight)||60,b=e.querySelector(".ranked-tile");e.querySelector(".play-grid");const h=((p=e.querySelector(".home-footer"))==null?void 0:p.offsetHeight)||44,v=["friend-requests-banner","match-invite-banner","ongoing-match-banner"].reduce((N,ne)=>{var ie;return N+(((ie=document.getElementById(ne))==null?void 0:ie.offsetHeight)||0)},0),$=12*5,y=s-l-c-f-h-v-$-32,C=Math.max(80,Math.round(y*.28)),E=Math.max(160,Math.round(y*.72)),P=Math.floor((E-10)/2);b&&(b.style.minHeight=b.style.maxHeight=C+"px"),e.querySelectorAll(".play-tile").forEach(N=>{N.style.minHeight=N.style.height=P+"px"}),e.querySelectorAll(".play-tile .play-icon").forEach(N=>{N.style.height=Math.round(P*.55)+"px"})}}),(o=document.getElementById("nav-rankings"))==null||o.addEventListener("click",()=>i("rankings")),(a=document.getElementById("nav-matches"))==null||a.addEventListener("click",()=>i("matches")),e.querySelectorAll("[data-action]").forEach(s=>{s.addEventListener("click",()=>{s.style.transform="scale(.96)",setTimeout(()=>s.style.transform="",180);const l=s.dataset.action;if(l==="match-ai"){Jn(i);return}if(l==="match-random"){i("match",{matchMode:"random"});return}if(l==="match-friend"){i("friends");return}if(l==="mini-league"){i("mini-league");return}if(l==="ranked"){i("ranked");return}n("Bientôt disponible","info")})}),document.getElementById("logout-btn").addEventListener("click",async()=>{await w.auth.signOut(),window.location.reload()}),ln(t,n),Xn(t,n,i),dn(t,n,i))}async function dn(e,t,i){const n=document.getElementById("ongoing-match-banner");if(!n)return;const r=e.profile.id,{data:o}=await w.from("matches").select("id, home_id, away_id, status, mode").eq("status","active").or(`home_id.eq.${r},away_id.eq.${r}`).order("created_at",{ascending:!1});if(!(o!=null&&o.length)){n.innerHTML="";return}const a=o.map(l=>l.home_id===r?l.away_id:l.home_id).filter(Boolean);let s={};if(a.length){const{data:l}=await w.from("users").select("id, pseudo, club_name").in("id",a);(l||[]).forEach(c=>{s[c.id]=c.club_name||c.pseudo})}n.innerHTML=o.map(l=>{const c=l.home_id===r?l.away_id:l.home_id,d=s[c]||"Adversaire",g=l.mode==="mini_league";return`<div style="display:flex;align-items:center;gap:10px;background:linear-gradient(135deg,rgba(10,61,30,0.8),rgba(26,107,60,0.6));color:#fff;border-radius:12px;padding:12px 16px;border:1px solid rgba(26,107,60,0.4);box-shadow:0 3px 12px rgba(26,107,60,0.3)">
    ...
    ${Ae(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),c=(s||[]).filter(I=>I.card_type==="player"&&I.player),d=(s||[]).filter(I=>I.card_type==="game_changer"),g=(s||[]).filter(I=>I.card_type==="formation"),x=(s||[]).filter(I=>I.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),u={};(m||[]).forEach(I=>{u[I.name]=I});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),f={};(p||[]).forEach(I=>{f[I.id]=I}),x.forEach(I=>{I.stadium_def&&(f[I.stadium_id]=I.stadium_def)});const b=Object.keys(Ii),h=Object.keys(Se),v={};c.forEach(I=>{const B=I.player.id;v[B]=(v[B]||0)+1}),new Set(Object.keys(v).map(I=>String(I)));const $=new Set(g.map(I=>I.formation)),y=new Set(d.map(I=>I.gc_type));let C="player",E="Tous",P="",N=!1;function ne(){return[...c].sort((I,B)=>{const F=Zt.indexOf(I.player.job),W=Zt.indexOf(B.player.job);return F!==W?F-W:(I.player.surname_real||"").localeCompare(B.player.surname_real||"")})}function ie(){return[...l||[]].sort((I,B)=>{const F=Zt.indexOf(I.job),W=Zt.indexOf(B.job);return F!==W?F-W:(I.surname_real||"").localeCompare(B.surname_real||"")})}function Q(){return ne().filter(I=>{const B=I.player,F=E==="Tous"||B.job===E,W=!P||`${B.firstname} ${B.surname_real}`.toLowerCase().includes(P);return F&&W})}function j(){return ie().filter(I=>{const B=E==="Tous"||I.job===E,F=!P||`${I.firstname} ${I.surname_real}`.toLowerCase().includes(P);return B&&F})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",B=>{P=B.target.value.toLowerCase(),M()}),e.querySelectorAll(".filter-btn").forEach(B=>{B.addEventListener("click",()=>{E=B.dataset.job,_(),M()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,_(),M()})):(I.innerHTML=`
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(I=>{I.addEventListener("click",()=>{C=I.dataset.tab,E="Tous",P="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(B=>{const F=B.dataset.tab===C;B.style.borderBottomColor=F?"var(--green)":"transparent",B.style.color=F?"var(--green)":"var(--gray-600)"}),_(),M()})}),_(),M()}function po(e,t,i){const n=Se[e]||{icon:"⚡",desc:"Effet spécial."},r=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},a={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,l=a[t==null?void 0:t.color]||a.purple,c=(t==null?void 0:t.name)||e,d=(t==null?void 0:t.effect)||n.desc,g=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const ei=1e3;function uo(e,t,i,n){var u,p,f;const{state:r,toast:o,closeModal:a,navigate:s,refreshProfile:l}=i,c=e.formation,d={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function g(){const b=Jt[c]||{},h=Ii[c]||[],v=290,$=360,y=20;function C(P){const N=b[P];return N?{x:N.x*v,y:N.y*$}:null}let E=`<svg width="${v}" height="${$}" viewBox="0 0 ${v} ${$}" xmlns="http://www.w3.org/2000/svg">`;for(const[P,N]of h){const ne=C(P),ie=C(N);!ne||!ie||(E+=`<line x1="${ne.x}" y1="${ne.y}" x2="${ie.x}" y2="${ie.y}"
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${g.map((Y,J)=>{const R=Q[Y.id]||[],I=Y.is_for_sale,B=R.length?R[R.length-1]:null,W=(d.rarity==="pepite"||d.rarity==="papyte")&&Y.current_note!=null?` (☆${Y.current_note})`:"";return`
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",d.note_g],["DEF",d.note_d],["MIL",d.note_m],["ATT",d.note_a]].map(([Y,J])=>{const R=mi[Y],I=Y==="GK"?"#fff":R,B=Y===d.job||Y===d.job2,F=(Number(J)||0)+(B&&C>0?C:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(ae=document.getElementById("close-detail"))==null||ae.addEventListener("click",s);let M=new Set;const U=()=>{const Y=M.size,J=document.getElementById("sell-action-panel");if(!J)return;J.style.display=Y>0?"block":"none",document.getElementById("sell-selected-count").textContent=Y;const R=document.getElementById("evolve-btn");R&&(R.textContent=`⬆️ Évoluer ${Y>1?"(+"+Y+")":""}`)};document.querySelectorAll(".expl-check").forEach(Y=>{Y.addEventListener("change",()=>{const J=Y.dataset.id;Y.checked?M.add(J):M.delete(J);const R=Y.closest(".exemplaire-row");R&&(R.style.borderColor=Y.checked?"#1A6B3C":"#eee"),U()})}),document.querySelectorAll(".exemplaire-row").forEach(Y=>{Y.addEventListener("click",J=>{if(J.target.closest("button")||J.target.tagName==="INPUT")return;const R=Y.querySelector(".expl-check");R&&!R.disabled&&(R.checked=!R.checked,R.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(Y=>{Y.addEventListener("click",J=>{J.stopPropagation();const R=document.querySelector(`.expl-hist[data-hist="${Y.dataset.idx}"]`);R&&(R.style.display=R.style.display==="none"?"flex":"none")})}),(se=document.getElementById("evolve-btn"))==null||se.addEventListener("click",async()=>{if(x<=1)return;const Y=[...M];if(!Y.length)return;if(M.has(e.id)){const K=document.createElement("div");K.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",K.innerHTML=`
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    <div class="page-body">
      ...
      stadium_def:stadium_definitions(id, name, club_id, country_code, image_url,
        club:clubs(encoded_name, logo_url))`).eq("owner_id",n.profile.id).eq("card_type","stadium"),l=(a||[]).filter(b=>b.card_type==="player"&&b.player),c=(a||[]).filter(b=>b.card_type==="formation"),d=(s||[]).filter(b=>b.card_type==="stadium"),g=[...new Set(d.map(b=>b.stadium_id).filter(Boolean))];let x={};if(d.forEach(b=>{b.stadium_def&&b.stadium_id&&(x[b.stadium_id]=b.stadium_def)}),g.length&&Object.keys(x).length<g.length){const{data:b}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",g);(b||[]).forEach(h=>{x[h.id]=h})}const m=c.map(b=>b.formation).filter(Boolean),{data:u}=await w.from("deck_cards").select("card_id, position, is_starter, slot_order").eq("deck_id",e);let p=o.formation||"4-4-2";m.length>0&&!m.includes(p)&&(p=m[0]);const f={deckId:e,name:o.name,formation:p,formationCardId:o.formation_card_id,stadiumCardId:o.stadium_card_id||null,slots:{},subs:[],playerCards:l,formationCards:c,stadiumCards:d,stadDefMap:x,availableFormations:m};(u||[]).forEach(b=>{b.is_starter?f.slots[b.position]=b.card_id:f.subs.includes(b.card_id)||f.subs.push(b.card_id)}),mt(t,f,i)}function mt(e,t,i){var u,p;const{navigate:n}=i;ni[t.formation];const r=Qi(t.formation),o=r.filter(f=>t.slots[f]).length,a=t.availableFormations.length>0?t.availableFormations:Object.keys(ni),s=(u=t.stadiumCards)==null?void 0:u.find(f=>f.id===t.stadiumCardId),l=s&&((p=t.stadDefMap)==null?void 0:p[s.stadium_id])||null,c=t.subs.map(f=>t.playerCards.find(b=>b.id===f)).filter(Boolean);[...Object.values(t.slots),...t.subs],e.innerHTML=`
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
        ...
        <div style="width:130px;flex-shrink:0;background:rgba(0,0,0,0.3);display:flex;flex-direction:column;align-items:center;padding:12px 8px;gap:12px;border-left:1px solid rgba(255,255,255,0.1)">
          ...
          <div style="width:100%;text-align:center">
            ...
            <div id="add-stad-btn-pc" style="cursor:pointer;margin:0 auto;width:fit-content">
              ${s?(()=>{var h;const f=t.stadDefMap[s.stadium_id],b=((h=f==null?void 0:f.club)==null?void 0:h.logo_url)||null;return`<div style="width:100px;height:130px;border-radius:8px;background:linear-gradient(135deg,#1a3a6b,#0a1a3a);border:2px solid #4fc3f7;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
  ...
  </div>`;const d=window.innerWidth>=900,g=e.querySelector(".deck-pc-layout"),x=e.querySelector(".deck-mobile-layout");g&&(g.style.display=d?"block":"none"),x&&(x.style.display=d?"none":"block"),go(e,t,r,i),e.querySelectorAll("#builder-back").forEach(f=>f.addEventListener("click",()=>n("decks")));const m=()=>{const{openModal:f,closeModal:b}=i,h=`<div style="display:flex;flex-wrap:wrap;gap:8px;padding:8px">
    ...
    </div>`;f("⚽ Choisir une formation",h),document.querySelectorAll("#modal-body [data-forma]").forEach(v=>{v.addEventListener("click",()=>{t.formation=v.dataset.forma;const $=Qi(t.formation),y={};$.forEach(C=>{t.slots[C]&&(y[C]=t.slots[C])}),t.slots=y,b(),mt(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(f=>f.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(f=>f.addEventListener("click",()=>mo(t,e,i))),e.querySelectorAll("#save-deck").forEach(f=>f.addEventListener("click",()=>bo(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(f=>{f.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==f.dataset.removeSub),mt(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(f=>f.addEventListener("click",()=>yo(t,e,i)))}function go(e,t,i,n){var v,$;const r=window.innerWidth>=900,o=e.querySelector(r?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const a=(v=t.stadiumCards)==null?void 0:v.find(y=>y.id===t.stadiumCardId),s=a&&(($=t.stadDefMap)==null?void 0:$[a.stadium_id])||null,l=Jt[t.formation]||{},c=on(t.formation)||[],d={};for(const y of i){const C=t.slots[y],E=C?t.playerCards.find(P=>P.id===C):null;E!=null&&E.player?d[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:d[y]=null}const g=window.innerWidth>=900,x=g?window.innerWidth-280:window.innerWidth-20,m=g?Math.min(x,860):x,u=Math.round(g?m*.82:m*.85),p=g?84:44;let f="";for(const[y,C]of c){const E=l[y],P=l[C];if(!E||!P)continue;const N=E.x*m,ne=Math.round(.03*u+E.y*.85*u),ie=P.x*m,Q=Math.round(.03*u+P.y*.85*u),j=d[y],_=d[C],M=Pt(j,_);M==="#ff3333"||M==="#cc2222"?f+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${M}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(f+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${M}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,f+=`<line x1="${N.toFixed(1)}" y1="${ne.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${Q.toFixed(1)}" stroke="${M}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const h=Math.round(p*657/507);for(const y of i){const C=l[y];if(!C)continue;const E=d[y],P=C.x*m;C.y*u;const N=Math.round(.03*u+C.y*(.85*u)),ne=Math.round(P-p/2),ie=Math.round(N-h/2);if(E){const Q=y.replace(/\d+/,""),j=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),_=Ae({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:Q});b+=`<div style="position:absolute;left:${ne}px;top:${ie}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
    ...
    <div style="position:relative;width:${m}px;height:${u}px;margin:0 auto">
      <svg style="position:absolute;inset:0;width:100%;height:100%;pointer-events:none" viewBox="0 0 ${m} ${u}">${f}</svg>
      ${b}
      ...
      ${o.map(s=>{var b,h;const l=e.stadDefMap[s.stadium_id],c=((b=l==null?void 0:l.club)==null?void 0:b.logo_url)||null,d=l!=null&&l.image_url?"/icons/"+l.image_url:null,g=e.stadiumCardId===s.id,x=l!=null&&l.country_code&&!c?`https://flagsapi.com/${l.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,m=(l==null?void 0:l.name)||"Stade",u=m.match(/^(Stade\s+(?:de\s+)?(?:\w+)?)(.*)?$/i),p=u?u[1].trim():m.slice(0,8),f=((h=u==null?void 0:u[2])==null?void 0:h.trim())||"";return`<div class="stad-choice" data-stad-id="${s.id}" style="cursor:pointer;width:80px;text-align:center">
    ...
    </div>`,'<button class="btn btn-ghost" id="close-selector">Fermer</button>'),(b=document.getElementById("close-selector"))==null||b.addEventListener("click",o),(h=document.getElementById("remove-player"))==null||h.addEventListener("click",()=>{delete t.slots[e],o(),mt(i,t,n)}),document.querySelectorAll(".player-option").forEach(v=>{v.addEventListener("click",()=>{t.slots[e]=v.dataset.cardId,o(),mt(i,t,n)})})}function yo(e,t,i){var d,g,x;const{openModal:n,closeModal:r}=i,o=(d=e.stadiumCards)==null?void 0:d.find(m=>m.id===e.stadiumCardId),a=o&&((g=e.stadDefMap)==null?void 0:g[o.stadium_id])||null,s=new Set;Object.keys(e.slots).forEach(m=>{var f;const u=e.slots[m];if(!u)return;const p=e.playerCards.find(b=>b.id===u);(f=p==null?void 0:p.player)!=null&&f.id&&s.add(p.player.id)}),e.subs.forEach(m=>{var p;const u=e.playerCards.find(f=>f.id===m);(p=u==null?void 0:u.player)!=null&&p.id&&s.add(u.player.id)});const l=new Set,c=e.playerCards.filter(m=>{var u,p,f;return s.has((u=m.player)==null?void 0:u.id)||l.has((p=m.player)==null?void 0:p.id)?!1:(l.add((f=m.player)==null?void 0:f.id),!0)});n("Ajouter un remplaçant",`<div style="max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px">
  ...
  <div class="page">
    ...
    <div class="page-body">
      <div class="booster-grid">
        ${o.map(u=>{const p=u.cost===0||r>=u.cost,f=d[u.id]===!0;return`<div class="booster-card ${!p||f?"disabled":""}" data-booster="${u.id}" style="position:relative">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    </div>`}const l=d=>{e.style.overflow="",e.style.height="",e.style.display="",e.style.flexDirection="",i(d)};function c(){var g,x,m;e.style.overflow="hidden",e.style.height="100%",e.style.display="flex",e.style.flexDirection="column";const d=a.length>0;e.innerHTML=`
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      <div style="flex:1;overflow-y:auto;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;align-content:flex-start;padding:8px 16px 16px">
        ${o.map(u=>{const p=a.find(f=>f.gc_type===u.gc_type);return s(u,!!p)}).join("")}
      </div>
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_real,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),l=[...new Set((s||[]).filter(x=>{var m,u;return((m=x.card)==null?void 0:m.card_type)==="stadium"&&((u=x.card)==null?void 0:u.stadium_id)}).map(x=>x.card.stadium_id))],c={};if(l.length){const{data:x}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",l);(x||[]).forEach(m=>{c[m.id]=m}),(s||[]).forEach(m=>{var u,p;((u=m.card)==null?void 0:u.card_type)==="stadium"&&((p=m.card)!=null&&p.stadium_id)&&(m.card._stadiumDef=c[m.card.stadium_id]||null)})}let d=0;function g(){var y,C,E,P,N,ne,ie;const x=o[d],m=(s||[]).filter(Q=>Q.deck_id===x.id),u=m.filter(Q=>{var j;return Q.is_starter&&((j=Q.card)==null?void 0:j.player)}).map(Q=>ki(Q.card,Q.position)),p=m.find(Q=>{var j;return((j=Q.card)==null?void 0:j.card_type)==="formation"}),f=x.formation||((y=p==null?void 0:p.card)==null?void 0:y.formation)||"4-4-2";let b=u.length>=11?ri(u,f):null,h=((C=x.stadium_card)==null?void 0:C.stadium_def)||null;h&&b&&(b=Xt(b,h));const v=u.length>=11;nt(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        ...
        <div style="display:flex;align-items:center;gap:8px;padding:6px 8px">
          ...
          <div style="flex:1;text-align:center">
            ...
            <div style="font-size:11px;opacity:.6">${f} · ${u.length}/11${x.is_active?" · ⭐":""}</div>
          </div>
    ...
    </div>`}async function Fo(e,t){const{state:i}=t,r=(i.params||{}).matchMode||"vs_ai_easy",o=r.replace("vs_ai_",""),a=r;await pi(e,t,r,async({deckId:s,formation:l,starters:c,subsRaw:d,gcCardsEnriched:g,gcDefs:x,stadiumDef:m})=>{try{let u=ri(c,l);m&&(u=Xt(u,m),oi(d,m));const p=await Po(l,o),f=p.lines||p,b=async h=>{try{const v=a==="vs_ai_club"?"club":a,{data:$,error:y}=await w.from("matches").insert({home_id:i.profile.id,away_id:null,mode:v,home_deck_id:s,status:"in_progress"}).select().single();if(y){console.error("[MatchIA] Erreur création match:",y),_t(e,"⚠️","Impossible de créer le match ("+y.message+").","Retour",()=>t.navigate("home"));return}const C=p.stadiumDef||null;C&&f&&(Xt(f,C),oi(p.subs||[],C));const E={gcDefs:x||[],matchId:$==null?void 0:$.id,mode:a,difficulty:o,formation:l,homeTeam:u,aiTeam:f,homeSubs:d,subsUsed:0,maxSubs:Math.min(d.length,3),aiSubs:p.subs||[],aiSubsUsed:0,aiMaxSubs:Math.min((p.subs||[]).length,3),aiUsedSubIds:[],aiGcCards:p.gcCards||[],aiUsedGc:[],aiStadiumDef:C,homeScore:0,aiScore:0,gcCards:h,usedGc:[],boostCard:null,boostUsed:!1,phase:"midfield",attacker:null,round:0,selected:[],pendingAttack:null,log:[],modifiers:{home:{},ai:{}},clubName:i.profile.club_name||"Vous"};Ro(e,E,t)}catch(v){console.error("[MatchIA] Exception launchMatch:",v),_t(e,"⚠️","Erreur au lancement du match : "+v.message,"Retour",()=>t.navigate("home"))}};if(!g.length){b([]);return}li(e,g,b)}catch(u){console.error("[MatchIA] Exception setup:",u),_t(e,"⚠️","Erreur de préparation du match : "+u.message,"Retour",()=>t.navigate("home"))}})}async function Po(e,t){var f;const{data:i}=await w.from("players").select("id,firstname,surname_real,country_code,club_id,job,job2,note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,face,clubs(encoded_name,logo_url)").eq("is_active",!0).limit(80);if(!i||i.length<11)return{lines:Go(e),subs:[],gcCards:[],stadiumDef:null};const n=Dt[e]||Dt["4-4-2"],r={GK:[],DEF:[],MIL:[],ATT:[]},o=new Set;function a(b,h,v){var $,y;return o.add(b.id),{cardId:"ai-"+b.id+"-"+v,id:b.id,firstname:b.firstname,name:b.surname_real,country_code:b.country_code,club_id:b.club_id,job:b.job,job2:b.job2,note_g:Number(b.note_g)||0,note_d:Number(b.note_d)||0,note_m:Number(b.note_m)||0,note_a:Number(b.note_a)||0,rarity:b.rarity,skin:b.skin,hair:b.hair,hair_length:b.hair_length,clubName:(($=b.clubs)==null?void 0:$.encoded_name)||null,clubLogo:((y=b.clubs)==null?void 0:y.logo_url)||null,boost:0,used:!1,_line:h}}for(const b of["GK","DEF","MIL","ATT"]){const h=i.filter(E=>E.job===b&&!o.has(E.id)),v=i.filter(E=>E.job!==b&&!o.has(E.id)),$=[...h,...v],y=[];for(let E=0;E<n[b];E++){const P=$[E];P&&y.push(a(P,b,E))}const C=ct(y.length);y.forEach((E,P)=>{E._col=C[P]}),r[b]=y}const l=i.filter(b=>!o.has(b.id)).slice(0,5).map((b,h)=>a(b,b.job,100+h)),g=Object.keys(Se).sort(()=>Math.random()-.5).slice(0,3).map((b,h)=>{var v,$;return{id:"ai-gc-"+h,gc_type:b,name:((v=Se[b])==null?void 0:v.name)||b,icon:(($=Se[b])==null?void 0:$.icon)||"⚡"}}),x=Object.values(r).flat(),m={};x.forEach(b=>{b.club_id&&(m[b.club_id]=(m[b.club_id]||0)+1)});const u=(f=Object.entries(m).sort((b,h)=>h[1]-b[1])[0])==null?void 0:f[0];let p=null;if(u){const{data:b}=await w.from("clubs").select("id,encoded_name,logo_url,country_code").eq("id",u).single();b&&(p={club_id:b.id,country_code:null,name:b.encoded_name+" Stadium",club:{encoded_name:b.encoded_name,logo_url:b.logo_url}})}return{lines:r,subs:l,gcCards:g,stadiumDef:p}}function Go(e){const t=Dt[e]||Dt["4-4-2"],i={GK:[],DEF:[],MIL:[],ATT:[]},n=["ROBOT","CYBER","NEXUS","ALGO","PIXEL","BYTE","LOGIC","TURBO","CORE","VOLT","FLUX"];let r=0;for(const o of["GK","DEF","MIL","ATT"]){const a=[];for(let l=0;l<t[o];l++){const c=3+Math.floor(Math.random()*5);a.push({cardId:"fake-"+r,id:"fake-"+r,firstname:"IA",name:n[r%n.length],country_code:"XX",club_id:null,job:o,job2:null,note_g:o==="GK"?c:2,note_d:o==="DEF"?c:2,note_m:o==="MIL"?c:2,note_a:o==="ATT"?c:2,rarity:"normal",boost:0,used:!1,_line:o}),r++}const s=ct(a.length);a.forEach((l,c)=>{l._col=s[c]}),i[o]=a}return i}function Ro(e,t,i){var r;const n=`<div style="position:relative;width:22px;height:22px;flex-shrink:0;display:flex;align-items:center;justify-content:center">
  ...
  </div>`;const d=()=>{const u=(p,f)=>e.querySelectorAll(p).forEach((b,h)=>{setTimeout(()=>{b.style.opacity="1",b.style.transform="translateY(0) scale(1)"},f+h*90)});u(".duel-card-home",150),u(".duel-card-ai",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((p,f)=>{setTimeout(()=>{p.style.opacity="1"},f*70)}),900),setTimeout(()=>{const p=e.querySelector("#vs-label");p&&(p.style.opacity="1",p.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(f=>f.style.opacity="1")},1250),setTimeout(()=>{g("score-home",s,800),g("score-ai",l,800)},1500)};function g(u,p,f){const b=document.getElementById(u);if(!b)return;const h=performance.now(),v=$=>{const y=Math.min(1,($-h)/f);b.textContent=Math.round(p*(1-Math.pow(1-y,3))),y<1?requestAnimationFrame(v):b.textContent=p};requestAnimationFrame(v)}requestAnimationFrame(d),t.attacker=c?"home":"ai";const x=c?vn():null;c&&(t.boostCard={value:x}),t.log.push({type:"duel",title:"Milieu de Terrain",homePlayers:n.map(u=>Ve(u)),aiPlayers:r.map(u=>Ve(u)),homeTotal:s,aiTotal:l,text:`Duel milieu : ${t.clubName} ${s} – ${l} IA → ${c?t.clubName+" attaque":"IA attaque"}`});const m=()=>{t.phase=t.attacker==="home"?"attack":"ai-attack",Ee(e,t,i),t.attacker==="ai"&&setTimeout(()=>Bi(e,t,i),800)};setTimeout(()=>{const u=document.getElementById("score-home"),p=document.getElementById("score-ai"),f=document.getElementById(c?"duel-row-home":"duel-row-ai"),b=document.getElementById(c?"duel-row-ai":"duel-row-home"),h=c?u:p,v=c?p:u;h&&(h.style.fontSize="80px",h.style.color=c?"#FFD700":"#ff6b6b",h.style.animation="duelPulse .5s ease"+(c?", duelGlow 1.5s ease infinite .5s":"")),v&&(v.style.opacity="0.25"),setTimeout(()=>{f&&(f.style.transformOrigin="center",f.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",f.style.zIndex="5"),setTimeout(()=>{var y;const $=document.getElementById("duel-shock");if($){const C=(y=b||f)==null?void 0:y.getBoundingClientRect(),E=e.querySelector(".match-screen").getBoundingClientRect();C&&($.style.top=C.top-E.top+C.height/2+"px"),$.style.animation="shockwave .5s ease-out forwards"}b&&(b.style.transformOrigin="center",b.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var y;const $=document.getElementById("duel-finale");$&&($.innerHTML=`
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const _=window.innerWidth>=700,M=(R,I,B)=>{var ge,Ce;const F=(t.gcDefs||[]).find(je=>je.name===R.gc_type),W={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[F==null?void 0:F.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",K={purple:"#b06ce0",light_blue:"#00d4ef"}[F==null?void 0:F.color]||"#b06ce0",q=(F==null?void 0:F.name)||R.gc_type,O=(F==null?void 0:F.effect)||((ge=Se[R.gc_type])==null?void 0:ge.desc)||"",we=F!=null&&F.image_url?`/icons/${F.image_url}`:null,_e=((Ce=Se[R.gc_type])==null?void 0:Ce.icon)||"⚡",ye=Math.round(B*.22),be=Math.round(B*.22),$e=B-ye-be,Le=q.length>12?7:9;return`<div class="gc-mini" data-gc-id="${R.id}" data-gc-type="${R.gc_type}"
          ...
          </div>`},re=(R,I)=>I?U(130,175):M(R,130,175),ae=(R,I)=>I?U(68,95):M(R,68,95),se=_?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",de=m?`<button id="btn-results" style="${se};background:linear-gradient(135deg,#D4A017,#FFD700);border:none;color:#000">🏁 Résultats</button>`:d?`<div style="${se};background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.4)">⏳ Tour IA</div>`:f?`<button id="btn-pass" style="${se};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER (plus d'attaquants)</button>`:g?`<button id="btn-action" style="${se};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${t.selected.length===0?"disabled":""}> ⚔️ ATTAQUEZ <span id="match-timer" style="font-weight:900"></span></button>`:x?`<button id="btn-action" style="${se};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${t.selected.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="match-timer" style="font-weight:900"></span></button>`:`<div style="${se};background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1)"></div>`,ke=g||x?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${t.selected.length}/3 sélectionné(s)</div>`:"",Y=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${_?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;display:flex;gap:0;overflow:hidden">
      ...
      <div id="in-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
        ...
        <div>${f?gt({...f,used:!1,boost:0},b,h):"<div>—</div>"}</div>
    ...
    </div>`,(y=g.querySelector("#sub-close"))==null||y.addEventListener("click",()=>g.remove()),(C=g.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,x())}),(E=g.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,x())}),(P=g.querySelector("#in-up"))==null||P.addEventListener("click",()=>{c>0&&(c--,x())}),(N=g.querySelector("#in-down"))==null||N.addEventListener("click",()=>{c<a.length-1&&(c++,x())});const $=(ie,Q,j,_)=>{const M=g.querySelector("#"+ie);if(!M)return;let U=0;M.addEventListener("touchstart",re=>{U=re.touches[0].clientY},{passive:!0}),M.addEventListener("touchend",re=>{const ae=re.changedTouches[0].clientY-U;if(Math.abs(ae)<30)return;const se=Q();ae<0&&se<_-1?(j(se+1),x()):ae>0&&se>0&&(j(se-1),x())},{passive:!0})};$("in-panel",()=>c,ie=>c=ie,a.length),$("out-panel",()=>s,ie=>s=ie,o.length),(ne=g.querySelector("#sub-confirm"))==null||ne.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),d)return;d=!0;const Q=o[s],j=a[c];if(!Q||!j)return;let _=null,M=-1;for(const[re,ae]of Object.entries(t.homeTeam)){const se=(ae||[]).findIndex(de=>de.cardId===Q.cardId);if(se!==-1){_=re,M=se;break}}if(M===-1||!_){jt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),g.remove();return}const U={...j,_line:_,_col:Q._col||0,used:!1,boost:0};t.homeTeam[_].splice(M,1,U),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(j.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:Q.name,firstname:Q.firstname,note:Ge(Q,_),portrait:Wt(Q),job:Q.job,country_code:Q.country_code,rarity:Q.rarity,clubName:Q.clubName,clubLogo:Q.clubLogo},inPlayer:{name:j.name,firstname:j.firstname,note:Ge(j,_),portrait:Wt(j),job:j.job,country_code:j.country_code,rarity:j.rarity,clubName:j.clubName,clubLogo:j.clubLogo},text:`🔄 ${j.firstname} ${j.name} remplace ${Q.firstname} ${Q.name}`}),g.remove(),Do(Q,j,()=>Ee(e,t,i))})}document.body.appendChild(g),x()}function Wo(e,t,i,n,r){var u,p;const o=(n.gcDefs||[]).find(f=>f.name===t),a=Se[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",l={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",c=(o==null?void 0:o.name)||t,d=(o==null?void 0:o.effect)||a.desc,g=o!=null&&o.image_url?`/icons/${o.image_url}`:null,x=a.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start;justify-content:center">
      ${e.map(g=>{const x=g._line||g.job||"MIL",m=s.find(p=>p.cardId===g.cardId),u=Ae({...g,_evolution_bonus:0},{width:90,showStad:!0,role:x,extraNote:g.boost||0});return`<div class="gc-pick-item" data-cid="${g.cardId}"
          style="position:relative;border-radius:8px;${m?"outline:3px solid #FFD700;outline-offset:2px;":""}cursor:pointer;flex-shrink:0;${g.used?"opacity:0.3;pointer-events:none":""}">
          ${u}
        </div>`}).join("")}
    </div>
    ...
    </div>`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Annuler</button>`),document.querySelectorAll(".player-boost-opt").forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.cardId;for(const a of["GK","DEF","MIL","ATT"]){const s=(t.homeTeam[a]||[]).find(l=>l.cardId===o);if(s){s.boost=(s.boost||0)+t.boostCard.value,t.log.push({text:`⚡ Boost +${t.boostCard.value} appliqué à ${s.name}`,type:"info"});break}}t.boostUsed=!0,i.closeModal(),Ee(e,t,i)})})}async function qt(e,t,i){var d,g;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,r=t.homeScore>t.aiScore,o=t.homeScore===t.aiScore,a=r?"victoire":o?"nul":"defaite",s=Qn(t.mode,a);t.matchId&&await w.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:r?n.profile.id:null,home_credits_reward:s,played_at:new Date().toISOString()}).eq("id",t.matchId);const l={credits:(n.profile.credits||0)+s,matches_played:(n.profile.matches_played||0)+1};r?l.wins=(n.profile.wins||0)+1:o?l.draws=(n.profile.draws||0)+1:l.losses=(n.profile.losses||0)+1,await w.from("users").update(l).eq("id",n.profile.id),await i.refreshProfile();const c=document.createElement("div");c.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",c.innerHTML=`
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
    ...
    </div>`,document.body.appendChild(c),(d=document.getElementById("res-home"))==null||d.addEventListener("click",()=>{c.remove(),We(e),i.navigate("home")}),(g=document.getElementById("res-replay"))==null||g.addEventListener("click",()=>{c.remove(),We(e),i.navigate("match",{matchMode:t.mode})})}function Zo(e,t){t.openModal("Équipe adverse (IA)",`<div style="background:#0a3d1e;padding:12px;border-radius:8px">
      ${ci(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}const Mt=e=>wn(e);async function Et(e,t,i,n,r={}){return En(e,t,i,n,r.myGC||[],r.gcDefs||[],r.isRanked||!1,r.rankedData||null,r.stadiumDef||null,r.onMatchEnd||null,r.mlLeagueId||null,r.mlMatchId||null)}async function er(e,t,i){const{data:n}=await w.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const r=n.home_id===t.state.user.id;return En(e,t,i,r,[],[],n.is_ranked||!1,null,null,null,null,null)}async function En(e,t,i,n,r=[],o=[],a=!1,s=null,l=null,c=null,d=null,g=null){const{state:x,navigate:m,toast:u}=t,p=n?"p1":"p2",f=n?"p2":"p1",b=(r||[]).map(k=>k.id),h=(r||[]).map(k=>({id:k.id,gc_type:k.gc_type,_gcDef:k._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:v}=await w.from("matches").select("*").eq("id",i).single();if(!v){u("Match introuvable","error"),m("home");return}async function $(){var me,xe;console.log("[PvP] buildGameState match:",{id:v.id,home_deck_id:v.home_deck_id,away_deck_id:v.away_deck_id,mode:v.mode,is_ranked:v.is_ranked});const[{data:k,error:L},{data:z,error:A},{data:T},{data:S}]=await Promise.all([w.rpc("get_deck_for_match",{p_deck_id:v.home_deck_id}),w.rpc("get_deck_for_match",{p_deck_id:v.away_deck_id}),w.from("users").select("id,pseudo,club_name").eq("id",v.home_id).single(),w.from("users").select("id,pseudo,club_name").eq("id",v.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",L==null?void 0:L.message,"p2:",A==null?void 0:A.message,"p1D:",(me=k==null?void 0:k.starters)==null?void 0:me.length,"p2D:",(xe=z==null?void 0:z.starters)==null?void 0:xe.length);const D=te=>{const Te=Number(te.evolution_bonus)||0;return{cardId:te.card_id,position:te.position,id:te.id,firstname:te.firstname,name:te.surname_real,country_code:te.country_code,club_id:te.club_id,job:te.job,job2:te.job2,note_g:(Number(te.note_g)||0)+(te.job==="GK"||te.job2==="GK"&&Number(te.note_g)>0?Te:0),note_d:(Number(te.note_d)||0)+(te.job==="DEF"||te.job2==="DEF"&&Number(te.note_d)>0?Te:0),note_m:(Number(te.note_m)||0)+(te.job==="MIL"||te.job2==="MIL"&&Number(te.note_m)>0?Te:0),note_a:(Number(te.note_a)||0)+(te.job==="ATT"||te.job2==="ATT"&&Number(te.note_a)>0?Te:0),evolution_bonus:Te,rarity:te.rarity,skin:te.skin,hair:te.hair,hair_length:te.hair_length,face:te.face||null,clubName:te.club_encoded_name||null,clubLogo:te.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},G=((k==null?void 0:k.starters)||[]).map(te=>D(te)),X=((z==null?void 0:z.starters)||[]).map(te=>D(te)),V=(k==null?void 0:k.formation)||"4-4-2",oe=(z==null?void 0:z.formation)||"4-4-2";let Z=ri(G,V),H=ri(X,oe);const le=((k==null?void 0:k.subs)||[]).map(te=>D(te)),pe=((z==null?void 0:z.subs)||[]).map(te=>D(te)),ue=(k==null?void 0:k.stadium_def)||(n?l:null),ce=(z==null?void 0:z.stadium_def)||(n?null:l);return ue&&(Z=Xt(Z,ue),oi(le,ue)),ce&&(H=Xt(H,ce),oi(pe,ce)),{p1Team:Z,p2Team:H,p1Subs:le,p2Subs:pe,p1Formation:V,p2Formation:oe,p1Name:(T==null?void 0:T.club_name)||(T==null?void 0:T.pseudo)||"Joueur 1",p2Name:(S==null?void 0:S.club_name)||(S==null?void 0:S.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?h:[],gcCardsFull_p2:n?[]:h,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let y=v.game_state&&Object.keys(v.game_state).length?v.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!y,"match.status:",v.status,"home_id:",v.home_id,"away_id:",v.away_id,"myId:",x.profile.id),!y)if(n){y=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((y==null?void 0:y.p1Team)||{}));const{data:k}=await w.from("matches").select("game_state").eq("id",i).single();!(k!=null&&k.game_state)||!Object.keys(k.game_state).length?await w.from("matches").update({game_state:y,turn_user_id:v.home_id}).eq("id",i):y=k.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let k=0;k<30&&!y;k++){await new Promise(z=>setTimeout(z,400));const{data:L}=await w.from("matches").select("game_state").eq("id",i).single();L!=null&&L.game_state&&Object.keys(L.game_state).length&&(y=L.game_state),k%5===0&&console.log("[PvP] away - poll",k,"game_state:",!!(L!=null&&L.game_state))}if(!y){u("Erreur de synchronisation","error"),m("home");return}y.gc_p2=b,y.gcCardsFull_p2=h,await w.from("matches").update({game_state:y}).eq("id",i)}let C=!1,E=null,P=!1;const N=new Set,ne=new Set;async function ie(k){var oe,Z;try{w.removeChannel(Q)}catch{}const L=y[p+"Score"]||0,z=y[f+"Score"]||0;let A,T;k.winner_id?(A=k.winner_id===x.profile.id,T=!1):k.forfeit?(A=L>z,T=!1):(T=L===z,A=L>z);let S="";if(a&&n)try{const{data:H}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.home_id).single(),{data:le}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.away_id).single();if(H&&le){const pe=A?1:T?.5:0,ue=1-pe,ce=H.placement_matches<10,me=le.placement_matches<10,xe=computeGlicko2(H.mmr,H.mmr_deviation,H.mmr_volatility,le.mmr,le.mmr_deviation,pe===1?1:pe===0?0:.5,ce),te=computeGlicko2(le.mmr,le.mmr_deviation,le.mmr_volatility,H.mmr,H.mmr_deviation,ue===1?1:ue===0?0:.5,me);await w.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:T?null:A?v.home_id:v.away_id,p_home_id:v.home_id,p_away_id:v.away_id,p_home_delta:xe.delta,p_away_delta:te.delta,p_home_new_rd:xe.newRd,p_away_new_rd:te.newRd,p_home_new_vol:xe.newSigma,p_away_new_vol:te.newSigma});const Te=xe.delta,De=xe.newMmr,Ie=getTier(De),He=Te>=0?"+":"",Tt=Te>=0?"#4caf50":"#ff6b6b",Je=getTier(H.mmr);S=`
            ...
            </div>`}}catch(H){console.error("[Ranked] MMR update error:",H)}(oe=document.getElementById("pvp-end-overlay"))==null||oe.remove();const D=document.createElement("div");D.id="pvp-end-overlay",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const G=T?"🤝":A?"🏆":"😞",X=T?"MATCH NUL":A?"VICTOIRE !":"DÉFAITE",V=T?"#fff":A?"#FFD700":"#ff6b6b";D.innerHTML=`
      ...
      ${S}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${a?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(D),(Z=D.querySelector("#pvp-end-home"))==null||Z.addEventListener("click",()=>{D.remove(),We(e),m(a?"ranked":"home")})}const Q=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},k=>{const L=k.new;try{if(L.status==="finished"||L.forfeit){if(C)return;C=!0,E&&(clearInterval(E),E=null),L.game_state&&(y=L.game_state),ie(L);return}if(L.game_state){const z=y;y=L.game_state;const A=y._lastGC;if(A&&A.seq&&!ne.has(A.seq)&&(ne.add(A.seq),A.by!==p)){R(A.type,A.by,()=>de());return}const T=z[p+"Score"]||0,S=z[f+"Score"]||0,D=y[p+"Score"]||0,G=y[f+"Score"]||0,X=D>T,V=G>S;if((X||V)&&!N.has(y.round)){N.add(y.round);const oe=[...y.log||[]].reverse().find(H=>H.isGoal),Z=((oe==null?void 0:oe.homePlayers)||[]).map(H=>({name:H.name,note:H.note,portrait:H.portrait,job:H.job}));ot(Z,D,G,X,()=>de());return}de()}}catch(z){console.error("[PvP] crash:",z)}}).subscribe();async function j(k){Object.assign(y,k),y.lastActionAt=new Date().toISOString();const{error:L}=await w.from("matches").update({game_state:y}).eq("id",i);L&&u("Erreur de synchronisation","error");try{de()}catch(z){console.error("[PvP] renderPvpScreen crash:",z)}}async function _(){if(C)return;C=!0,E&&(clearInterval(E),E=null);const k=n?v.away_id:v.home_id,L=n?"p2":"p1",z=n?"p1":"p2",A={...y,[L+"Score"]:3,[z+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:k,home_score:A.p1Score||0,away_score:A.p2Score||0,game_state:A}).eq("id",i)}catch{}try{w.removeChannel(Q)}catch{}setTimeout(()=>{We(e),m("home")},800)}const M={BOOST_STAT:({value:k=1,count:L=1,roles:z=[]},A,T)=>{const S=A[p+"Team"],D=Object.entries(S).filter(([G])=>!z.length||z.includes(G)).flatMap(([G,X])=>X.filter(V=>!V.used).map(V=>({...V,_line:G})));if(!D.length){A.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),T(A);return}U(D,L,`Choisir ${L} joueur(s) à booster (+${k})`,G=>{G.forEach(X=>{const V=(S[X._line]||[]).find(oe=>oe.cardId===X.cardId);V&&(V.boost=(V.boost||0)+k,A.log.push({text:`⚡ +${k} sur ${V.name}`,type:"info"}))}),A[p+"Team"]=S,T(A)})},DEBUFF_STAT:({value:k=1,count:L=1,roles:z=[],target:A="ai"},T,S)=>{const D=A==="home"?p:f,G=T[D+"Team"],X=A==="home"?"allié":"adverse",V=Object.entries(G).filter(([oe])=>!z.length||z.includes(oe)).flatMap(([oe,Z])=>Z.map(H=>({...H,_line:oe})));if(!V.length){T.log.push({text:`🎯 Aucun joueur ${X}`,type:"info"}),S(T);return}U(V,L,`Choisir ${L} joueur(s) ${X}(s) (-${k})`,oe=>{oe.forEach(Z=>{const H=(G[Z._line]||[]).find(le=>le.cardId===Z.cardId);H&&(H.boost=(H.boost||0)-k,T.log.push({text:`🎯 -${k} sur ${H.name}`,type:"info"}))}),T[D+"Team"]=G,S(T)})},GRAY_PLAYER:({count:k=1,roles:L=[],target:z="ai"},A,T)=>{const S=z==="home"?p:f,D=A[S+"Team"],G=z==="home"?"allié":"adverse",X=Object.entries(D).filter(([V])=>!L.length||L.includes(V)).flatMap(([V,oe])=>oe.filter(Z=>!Z.used).map(Z=>({...Z,_line:V})));if(!X.length){A.log.push({text:`❌ Aucun joueur ${G}`,type:"info"}),T(A);return}U(X,k,`Choisir ${k} joueur(s) ${G}(s) à exclure`,V=>{const oe="usedCardIds_"+S,Z=new Set(A[oe]||[]);V.forEach(H=>{const le=(D[H._line]||[]).find(pe=>pe.cardId===H.cardId);le&&(le.used=!0,Z.add(H.cardId),A.log.push({text:`❌ ${le.name} exclu !`,type:"info"}))}),A[oe]=[...Z],A[S+"Team"]=D,T(A)})},REVIVE_PLAYER:({count:k=1,roles:L=[]},z,A)=>{const T=z[p+"Team"],S=Object.entries(T).filter(([D])=>!L.length||L.includes(D)).flatMap(([D,G])=>G.filter(X=>X.used).map(X=>({...X,_line:D})));if(!S.length){z.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),A(z);return}U(S,k,`Choisir ${k} joueur(s) à ressusciter`,D=>{D.forEach(G=>{const X=(T[G._line]||[]).find(V=>V.cardId===G.cardId);X&&(X.used=!1,z.log.push({text:`💫 ${X.name} ressuscité !`,type:"info"}))}),z[p+"Team"]=T,A(z)})},REMOVE_GOAL:({},k,L)=>{const z=f+"Score";k[z]>0?(k[z]--,k.log.push({text:"🚫 Dernier but annulé !",type:"info"})):k.log.push({text:"🚫 Aucun but à annuler",type:"info"}),L(k)},ADD_GOAL_DRAW:({},k,L)=>{k[p+"Score"]===k[f+"Score"]?(k[p+"Score"]++,k.log.push({text:"🎯 But bonus !",type:"info"})):k.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),L(k)},ADD_SUB:({value:k=1},L,z)=>{L.maxSubs=(L.maxSubs||3)+k,L.log.push({text:`🔄 +${k} remplacement(s)`,type:"info"}),z(L)},CUSTOM:({},k,L)=>L(k)};function U(k,L,z,A){const T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let S=[];function D(){var X,V;const G=k.map(oe=>{const Z=oe._line||oe.job||"MIL",H=S.find(pe=>pe.cardId===oe.cardId),le=Ae({...oe,_evolution_bonus:0},{width:90,showStad:!0,role:Z,extraNote:oe.boost||0});return`<div class="pp-item" data-cid="${oe.cardId}"
        ...
        </div>`,(X=T.querySelector("#pp-close"))==null||X.addEventListener("click",()=>T.remove()),T.querySelectorAll(".pp-item").forEach(oe=>{oe.addEventListener("click",()=>{const Z=oe.dataset.cid,H=k.find(pe=>pe.cardId===Z),le=S.findIndex(pe=>pe.cardId===Z);H&&(le>-1?S.splice(le,1):S.length<L&&S.push(H),D())})}),(V=T.querySelector("#pp-confirm"))==null||V.addEventListener("click",()=>{T.remove(),A(S)})}D(),document.body.appendChild(T)}async function re(k,L){const A=(y["gcCardsFull_"+p]||[]).find(G=>G.id===k),T=(A==null?void 0:A._gcDef)||(y.gcDefs||[]).find(G=>{var X;return G.name===L||((X=G.name)==null?void 0:X.toLowerCase().trim())===(L==null?void 0:L.toLowerCase().trim())}),S=[...y["usedGc_"+p]||[],k],D={type:L,by:p,seq:(y._gcAnimSeq||0)+1};ne.add(D.seq),R(L,p,async()=>{if(T!=null&&T.effect_type&&T.effect_type!=="CUSTOM"){const X=M[T.effect_type];if(X){const V={...y};X(T.effect_params||{},V,async oe=>{oe["usedGc_"+p]=S,oe._lastGC=D,oe._gcAnimSeq=D.seq,await j(oe)});return}}const G={...y};switch(L){case"Remplacement+":G.maxSubs=(G.maxSubs||3)+1,G.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const X=f+"Score";G[X]>0&&(G[X]--,G.log.push({text:"🚫 But annulé",type:"info"}));break}}G["usedGc_"+p]=S,G._lastGC=D,G._gcAnimSeq=D.seq,await j(G)})}function ae(k,L){const z="usedCardIds_"+k,A=new Set(y[z]||[]);L.forEach(T=>A.add(T)),y[z]=[...A]}function se(){for(const k of["p1","p2"]){const L=new Set(y["usedCardIds_"+k]||[]),z=y[k+"Team"];if(z)for(const A of["GK","DEF","MIL","ATT"])(z[A]||[]).forEach(T=>{T.used=L.has(T.cardId)})}}function de(){var rt,at,ht,Fi,Pi,Gi;if(y.phase==="reveal")return ke();if(y.phase==="midfield")return J();if(y.phase==="finished")return Gt();const k=y[p+"Team"];y[f+"Team"],se();const L=y[p+"Score"],z=y[f+"Score"],A=y[p+"Name"],T=y[f+"Name"],S=y.phase===p+"-attack",D=y.phase===p+"-defense",G=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],X=G.map(ee=>ee.cardId),V=window.innerWidth>=700,oe=y[p+"Subs"]||[],Z=y["usedSubIds_"+p]||[],H=oe.filter(ee=>!Z.includes(ee.cardId)),le=y["gcCardsFull_"+p]||[],pe=y["usedGc_"+p]||[],ue=le.filter(ee=>!pe.includes(ee.id)),ce=y.boostOwner===p&&!y.boostUsed,me=[...k.MIL||[],...k.ATT||[]].filter(ee=>!ee.used),xe=S&&me.length===0?[...k.GK||[],...k.DEF||[]].filter(ee=>!ee.used).map(ee=>ee.cardId):[];function te(ee,fe,ze){var At,dt;const he=ee._gcDef,zt={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[he==null?void 0:he.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",et={purple:"#b06ce0",light_blue:"#00d4ef"}[he==null?void 0:he.color]||"#b06ce0",qe=(he==null?void 0:he.name)||ee.gc_type,Ne=(he==null?void 0:he.effect)||((At=Se[ee.gc_type])==null?void 0:At.desc)||"",Me=he!=null&&he.image_url?`/icons/${he.image_url}`:null,vt=((dt=Se[ee.gc_type])==null?void 0:dt.icon)||"⚡",Fe=Math.round(ze*.22),st=Math.round(ze*.22),tt=ze-Fe-st,It=qe.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${ee.id}" data-gc-type="${ee.gc_type}"
        ...
        <div style="height:${tt}px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06)">
          ${Me?`<img src="${Me}" style="max-width:${fe-10}px;max-height:${tt-6}px;object-fit:contain">`:`<span style="font-size:${Math.round(tt*.55)}px">${vt}</span>`}
        </div>
      ...
      </div>`}const De=(ee,fe)=>fe?Te(130,175):te(ee,130,175),Ie=(ee,fe)=>fe?Te(68,95):te(ee,68,95),He=V?"padding:28px 20px;border-radius:14px;font-size:16px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;width:100%":"padding:22px 8px;border-radius:12px;font-size:14px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;width:100%",Tt=S?je(p)?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#c47a00,#FFD700);border:none;color:#fff;box-shadow:0 0 18px rgba(255,215,0,0.4)" ${G.length===0?"disabled":""}>⚔️ ATTAQUEZ <span id="pvp-timer"></span></button>`:`<button id="pvp-action" data-pass="1" style="${He};background:linear-gradient(135deg,#555,#888);border:none;color:#fff">⏭️ PASSER <span id="pvp-timer"></span></button>`:D?`<button id="pvp-action" style="${He};background:linear-gradient(135deg,#1a4a8a,#3a7bd5);border:none;color:#fff;box-shadow:0 0 18px rgba(135,206,235,0.4)" ${G.length===0?"disabled":""}>🛡️ DÉFENDEZ <span id="pvp-timer"></span></button>`:`<div style="font-size:11px;color:rgba(255,255,255,0.3);text-align:center;padding:4px">⏳ Tour de ${T}</div>`,Je=S&&!je(p)?'<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">Aucun attaquant — passez la main</div>':S||D?`<div style="font-size:9px;color:rgba(255,255,255,0.4);text-align:center;margin-top:2px">${G.length}/3 sélectionné(s)</div>`:"",Qt=`<div style="display:flex;flex-direction:column;gap:4px;padding:4px 2px;width:${V?90:50}px;align-items:center;overflow-y:auto;flex-shrink:0;background:rgba(0,0,0,0.15)">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${Ft(k,y[p+"Formation"],Be,X,V?1300:kt(),V?600:Bt(),xe)}
    ...
    </div>`,Re=y[p+"Team"],bt=(()=>{var fe,ze,he,zt,et;if(D&&((fe=y.pendingAttack)!=null&&fe.players)){const qe=y.pendingAttack;let Ne="";if(G.length>0){const Me=G.map(Fe=>{const st=(Re[Fe._role]||[]).find(fi=>fi.cardId===Fe.cardId)||Fe,tt=Re[Fe._role]||[],It=tt.findIndex(fi=>fi.cardId===Fe.cardId),At=ct(tt.length),dt=It>=0?At[It]:st._col??1;return{...st,_line:Fe._role,_col:dt}}),vt=Yt(Me,((ze=y.modifiers)==null?void 0:ze[p])||{});Ne=`<div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.15)">
            ...
            <div style="display:flex;justify-content:center">${Ye(Me.map(Fe=>({...Fe,used:!1})),"#3a7bd5",vt.total,"defense")}</div>
          </div>`}return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye((qe.players||[]).map(Me=>({...Me,used:!1})),"#ff6b6b",qe.total,"attack")}</div>
          ${Ne}
        ...
        </div>`}if(S&&!((zt=y.pendingAttack)!=null&&zt.players)&&G.length>0){const qe=G.map(Me=>{const vt=(Re[Me._role]||[]).find(dt=>dt.cardId===Me.cardId)||Me,Fe=["GK","DEF"].includes(Me._role),st=Re[Me._role]||[],tt=st.findIndex(dt=>dt.cardId===Me.cardId),It=ct(st.length),At=tt>=0?It[tt]:vt._col??1;return{...vt,_line:Me._role,_col:At,...Fe?{note_a:Math.max(1,Number(vt.note_a)||0)}:{}}}),Ne=Vt(qe,((et=y.modifiers)==null?void 0:et[p])||{});return`<div style="padding:5px 8px;background:rgba(26,107,60,0.2);border-left:3px solid #FFD700;text-align:center">
          ...
          <div style="display:flex;justify-content:center">${Ye(qe.map(Me=>({...Me,used:!1})),"#FFD700",Ne.total,"attack")}</div>
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="width:200px;border-radius:18px;border:3px solid ${S};background:${T};display:flex;flex-direction:column;overflow:hidden;animation:gcFlipIn .7s cubic-bezier(.34,1.56,.64,1) both,gcGlow 1.8s ease infinite .7s">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(H);let le=!1;const pe=()=>{le||(le=!0,H.remove(),setTimeout(()=>z&&z(),50))};H.addEventListener("click",pe),setTimeout(pe,3e3)}function I(k,L){var H,le,pe,ue;const A=(y["gcCardsFull_"+p]||[]).find(ce=>ce.id===k),T=A==null?void 0:A._gcDef,S={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[T==null?void 0:T.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",D={purple:"#b06ce0",light_blue:"#00d4ef"}[T==null?void 0:T.color]||"#b06ce0",G=(T==null?void 0:T.name)||L,X=(T==null?void 0:T.effect)||((H=Se[L])==null?void 0:H.desc)||"Carte spéciale.",V=T!=null&&T.image_url?`/icons/${T.image_url}`:null,oe=((le=Se[L])==null?void 0:le.icon)||"⚡",Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",Z.innerHTML=`
      ...
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${L.map(T=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",D=Ge(T,T._line)+(T.boost||0);return`<div class="bp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${S};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(z),(A=z.querySelector("#bp-close"))==null||A.addEventListener("click",()=>z.remove()),z.querySelectorAll(".bp-item").forEach(T=>{T.addEventListener("click",async()=>{const S=T.dataset.cid,D=L.find(X=>X.cardId===S);if(!D)return;const G=(k[D._line]||[]).find(X=>X.cardId===S);G&&(G.boost=(G.boost||0)+y.boostValue),z.remove(),await j({[p+"Team"]:k,boostUsed:!0})})})}function F(k=null){var le,pe;if(!(y.phase===p+"-attack")){u("Remplacement uniquement avant votre attaque","warning");return}const z=y[p+"Team"],A=y["usedSubIds_"+p]||[],T=y.maxSubs||3;if(A.length>=T){u(`Maximum ${T} remplacements atteint`,"warning");return}const S=Object.entries(z).flatMap(([ue,ce])=>(ce||[]).filter(me=>me.used).map(me=>({...me,_line:ue}))),D=(y[p+"Subs"]||[]).filter(ue=>!A.includes(ue.cardId));if(!S.length){u("Aucun joueur utilisé à remplacer","warning");return}if(!D.length){u("Aucun remplaçant disponible","warning");return}let G=Math.max(0,S.findIndex(ue=>ue.cardId===k));const X=((le=S[G])==null?void 0:le._line)||((pe=S[G])==null?void 0:pe.job);let V=Math.max(0,D.findIndex(ue=>ue.job===X)),oe=!1;const Z=document.createElement("div");Z.id="pvp-sub-overlay",Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function H(){var De,Ie,He,Tt,Je,Qt;const ue=S[G],ce=D[V],me=Math.min(130,Math.round((window.innerWidth-90)/2)),xe=Math.round(me*1.35),te=Be=>`background:rgba(255,255,255,0.12);border:none;color:${Be?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Be?"default":"pointer"};flex-shrink:0`;Z.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,(De=Z.querySelector("#psub-close"))==null||De.addEventListener("click",()=>Z.remove()),(Ie=Z.querySelector("#pout-up"))==null||Ie.addEventListener("click",()=>{G>0&&(G--,H())}),(He=Z.querySelector("#pout-down"))==null||He.addEventListener("click",()=>{G<S.length-1&&(G++,H())}),(Tt=Z.querySelector("#pin-up"))==null||Tt.addEventListener("click",()=>{V>0&&(V--,H())}),(Je=Z.querySelector("#pin-down"))==null||Je.addEventListener("click",()=>{V<D.length-1&&(V++,H())});const Te=(Be,Qe,Re,bt)=>{const Ze=Z.querySelector("#"+Be);if(!Ze)return;let Ue=0;Ze.addEventListener("touchstart",rt=>{Ue=rt.touches[0].clientY},{passive:!0}),Ze.addEventListener("touchend",rt=>{const at=rt.changedTouches[0].clientY-Ue;if(Math.abs(at)<30)return;const ht=Qe();at<0&&ht<bt-1?(Re(ht+1),H()):at>0&&ht>0&&(Re(ht-1),H())},{passive:!0})};Te("pin-panel",()=>V,Be=>V=Be,D.length),Te("pout-panel",()=>G,Be=>G=Be,S.length),(Qt=Z.querySelector("#psub-confirm"))==null||Qt.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),oe)return;oe=!0;const Qe=S[G],Re=D[V];if(!Qe||!Re)return;const bt=Qe._line,Ze=(z[bt]||[]).findIndex(at=>at.cardId===Qe.cardId);if(Ze===-1){u("Erreur : joueur introuvable","error"),Z.remove();return}const Ue={...Re,_line:bt,position:Qe.position,used:!1,boost:0};z[bt].splice(Ze,1,Ue);const rt=[...A,Re.cardId];Z.remove(),W(Qe,Re,async()=>{await j({[p+"Team"]:z,[f+"Team"]:y[f+"Team"],["usedSubIds_"+p]:rt})})})}document.body.appendChild(Z),H()}function W(k,L,z){const A={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const S=(X,V,oe)=>`<div style="text-align:center">
      ...
      <div style="width:min(90vw,420px)">${ci(y[f+"Team"],y[f+"Formation"],null,[],kt(),Bt())}</div>
      ...
      </div>`,document.body.appendChild(L),(z=L.querySelector("#pvp-hist-close"))==null||z.addEventListener("click",()=>L.remove())}async function O(){if(y.phase!==p+"-attack")return;const k=p==="p1"?"p2":"p1",L=(y.round||0)+1,z=[...y.log||[]];z.push({type:"info",text:`⏭️ ${y[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const A=Oe(y),T=je(k),S=A||!T?"finished":k+"-attack";await j({["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:S,attacker:k,round:L,log:z}),S==="finished"&&await Xe(y)}function we(k){const L=(k.GK||[]).some(A=>!A.used),z=["DEF","MIL","ATT"].some(A=>(k[A]||[]).some(T=>!T.used));return L&&!z}function _e(k){return(k.p1Score||0)!==(k.p2Score||0)?null:we(k.p1Team)&&!ge(k.p2Team)?{side:"p1",gk:(k.p1Team.GK||[]).find(L=>!L.used)}:we(k.p2Team)&&!ge(k.p1Team)?{side:"p2",gk:(k.p2Team.GK||[]).find(L=>!L.used)}:null}async function ye(k,L){const{side:z,gk:A}=k;if(!A)return;const T=z+"Score",S=(L[T]||0)+1;A.used=!0;const D=[...L.log||[]];D.push({type:"duel",isGoal:!0,homeScored:z===p,homePlayers:z==="p1"?[Mt(A)]:[],aiPlayers:z==="p2"?[Mt(A)]:[],text:`⚽ DERNIER CORNER — Le gardien de ${L[z+"Name"]} marque !`});const G=(L.round||0)+1,X=z==="p1"?"p2":"p1",V={...L,[T]:S},oe=Oe(V);N.add(G);const Z=document.createElement("div");Z.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:950;display:flex;align-items:center;justify-content:center;overflow:hidden;text-align:center;padding:24px",document.body.appendChild(Z);const H=(ue,ce)=>new Promise(me=>{Z.innerHTML=`<div style="font-size:32px;font-weight:900;color:${ce};letter-spacing:2px;animation:lcFade 1.4s ease both">${ue}</div>
      <style>@keyframes lcFade{0%{opacity:0;transform:scale(0.8)}18%{opacity:1;transform:scale(1)}82%{opacity:1}100%{opacity:0;transform:scale(1.05)}}</style>`,setTimeout(me,1400)});await H("⚽ DERNIER CORNER","#FFD700"),await H("🧤 LE GARDIEN MONTE !","#4fc3f7"),Z.remove();const le=z===p?S:L[p+"Score"]||0,pe=z===p?L[f+"Score"]||0:S;ot([Mt(A)],le,pe,z===p,async()=>{await j({[T]:S,log:D,round:G,pendingAttack:null,phase:oe?"finished":X+"-attack",attacker:X,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}}}),oe&&await Xe({...y,[T]:S})})}async function be(){const k=y[p+"Team"],L=!["GK","DEF","MIL","ATT"].some(S=>(y[f+"Team"][S]||[]).some(D=>!D.used)),z=(y["selected_"+p]||[]).map(S=>{const D=(k[S._role]||[]).find(pe=>pe.cardId===S.cardId)||S,G=["GK","DEF"].includes(S._role),X=k[S._role]||[],V=X.findIndex(pe=>pe.cardId===S.cardId),oe=ct(X.length),Z=V>=0?oe[V]:D._col??1,H=y.stadiumDef||y.homeStadiumDef||null,le=D.stadiumBonus||H&&(H.club_id&&String(D.club_id)===String(H.club_id)||H.country_code&&D.country_code===H.country_code)||!1;return{...D,_line:S._role,_col:Z,stadiumBonus:le,...G?{note_a:Math.max(1,Number(D.note_a)||0)}:{}}});if(!z.length)return;const A=Vt(z,y.modifiers[p]||{});ae(p,z.map(S=>S.cardId)),z.forEach(S=>{const D=(k[S._role]||[]).find(G=>G.cardId===S.cardId);D&&(D.used=!0)}),y["selected_"+p]=[],de();const T=[...y.log||[]];if(L){if(z.length===1&&(z[0]._line==="GK"||z[0].job==="GK")&&(y.p1Score||0)===(y.p2Score||0)){await ye({side:p,gk:z[0]},{...y,[p+"Team"]:k,log:T});return}const D=(y[p+"Score"]||0)+1,G=z.map(H=>Mt(H));T.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:G,homeTotal:A.total,aiTotal:0});const X=(y.round||0)+1,V=p==="p1"?"p2":"p1",oe={...y,[p+"Team"]:k,[p+"Score"]:D},Z=Oe(oe);N.add(X),ot(G,D,y[f+"Score"]||0,!0,async()=>{await j({[p+"Team"]:k,[p+"Score"]:D,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:Z?"finished":V+"-attack",attacker:V,round:X,log:T}),Z&&await Xe({...y,[p+"Score"]:D})});return}T.push({type:"pending",text:`⚔️ ${y[p+"Name"]} attaque (${A.total})`}),await j({[p+"Team"]:k,[f+"Team"]:y[f+"Team"],pendingAttack:{...A,players:z,side:p},["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},phase:f+"-defense",log:T})}async function $e(){const k=y[p+"Team"],L=(y["selected_"+p]||[]).map(ce=>{const me=(k[ce._role]||[]).find(Ie=>Ie.cardId===ce.cardId)||ce,xe=k[ce._role]||[],te=xe.findIndex(Ie=>Ie.cardId===ce.cardId),Te=ct(xe.length),De=te>=0?Te[te]:me._col??1;return{...me,_line:ce._role,_col:De}}),z=Yt(L,y.modifiers[p]||{});ae(p,L.map(ce=>ce.cardId)),L.forEach(ce=>{const me=(k[ce._role]||[]).find(xe=>xe.cardId===ce.cardId);me&&(me.used=!0)}),y["selected_"+p]=[],de();const A=ji(y.pendingAttack.total,z.total,y.modifiers[p]||{}),T=y.pendingAttack.side,S=A==="attack"||(A==null?void 0:A.goal),D=T==="p1"?"p2":"p1",G=(y.round||0)+1,X=(y.pendingAttack.players||[]).map(ce=>Mt(ce)),V=[...y.log||[]];V.push({type:"duel",isGoal:S,homeScored:S&&T===p,text:S?`⚽ BUT de ${y[T+"Name"]} ! (${y.pendingAttack.total} vs ${z.total})`:`✋ Attaque stoppée (${y.pendingAttack.total} vs ${z.total})`,homePlayers:X,aiPlayers:L.map(ce=>Mt(ce)),homeTotal:y.pendingAttack.total,aiTotal:z.total});const oe=S?(y[T+"Score"]||0)+1:y[T+"Score"]||0,Z={...y,[p+"Team"]:k,[T+"Score"]:oe},H=Oe(Z),le=H?"finished":D+"-attack",pe=!H&&!S?_e(Z):null,ue=async()=>{if(pe){await ye(pe,Z);return}await j({[p+"Team"]:k,[f+"Team"]:y[f+"Team"],[T+"Score"]:oe,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:le,attacker:D,round:G,log:V}),(le==="finished"||H)&&await Xe({...y,[T+"Score"]:oe})};if(S){const ce=T===p,me=ce?oe:y[p+"Score"]||0,xe=ce?y[f+"Score"]||0:oe;N.add(G),ot(X,me,xe,ce,ue)}else await ue()}function Le(k){return["MIL","ATT"].some(L=>(k[L]||[]).some(z=>!z.used))}function ge(k){return["GK","DEF","MIL","ATT"].some(L=>(k[L]||[]).some(z=>!z.used))}function Ce(k){return ge(k)&&!Le(k)}function je(k){const L=y[k+"Team"];return!!(Le(L)||Ce(L))}function Oe(k){return!ge(k.p1Team)&&!ge(k.p2Team)}function yt(k){const L=k.p1Score||0,z=k.p2Score||0;return L===z?null:L>z?v.home_id:v.away_id}async function Xe(k){try{const L=yt(k),z=L?v.home_id===L?v.away_id:v.home_id:null;await w.from("matches").update({status:"finished",winner_id:L,home_score:k.p1Score||0,away_score:k.p2Score||0}).eq("id",i),L&&z&&to(L,z).catch(()=>{})}catch(L){console.error("[PvP] finishMatch:",L)}}function Gt(){var T;const k=y[p+"Score"],L=y[f+"Score"],z=k>L,A=k===L;nt(e),e.innerHTML=`
    ...
    </div>`,(T=document.getElementById("pvp-home"))==null||T.addEventListener("click",()=>{try{w.removeChannel(Q)}catch{}We(e),m("home")})}de()}async function Li(e,t,i=!1){var s,l;const{state:n,navigate:r,toast:o}=t,a=i&&((l=(s=t==null?void 0:t.state)==null?void 0:s.params)==null?void 0:l.rankedData)||null;await pi(e,t,i?"ranked":"random",async({deckId:c,formation:d,starters:g,subsRaw:x,gcCardsEnriched:m,gcDefs:u,stadiumDef:p})=>{nt(e);const f=async b=>{await ir(e,t,c,d,g,x,b||[],u,p,i,a)};if(!(m!=null&&m.length)){await f([]);return}li(e,m,f)})}async function tr(e,t,i){return er(e,t,i)}async function ir(e,t,i,n,r,o,a=[],s=[],l=null,c=!1,d=null){var ie,Q;const{state:g,navigate:x,toast:m}=t,u=(d==null?void 0:d.mmr)??((ie=g.profile)==null?void 0:ie.mmr)??1e3,p=c?Ai(u):null,f=c?"linear-gradient(135deg, #1a0a2e 0%, #2d1060 50%, #1a0a2e 100%)":"linear-gradient(135deg, #0a1a2e 0%, #0d3d1e 100%)",b=c?(p==null?void 0:p.color)||"#D4A017":"#FFD700";let h=!1,v=null,$=null;e.innerHTML=`
    ...
    </div>`;let u=!1,p=null;const f=async()=>{p&&(p.unsubscribe(),p=null)};(h=document.getElementById("cancel-friend"))==null||h.addEventListener("click",async()=>{await f(),await w.from("friend_match_invites").update({status:"declined"}).eq("id",x.id),We(e),c("home")}),p=w.channel(`friend_invite_${x.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${x.id}`},async({new:v})=>{u||v.status!=="accepted"||!v.match_id||(u=!0,await f(),await Et(e,t,v.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))}).subscribe();const b=setInterval(async()=>{if(u)return;const{data:v}=await w.from("friend_match_invites").select("status, match_id").eq("id",x.id).single();(v==null?void 0:v.status)==="accepted"&&v.match_id&&(u=!0,clearInterval(b),await f(),await Et(e,t,v.match_id,!0,{myGC:n,gcDefs:r,stadiumDef:o}))},3e3);setTimeout(async()=>{u||(clearInterval(b),await f(),d("Invitation expirée","info"),c("home"))},12e4)}async function sr(e,t,i,n,r,o){const{state:a,navigate:s,toast:l}=t,c=a.user.id,{data:d}=await w.from("friend_match_invites").select("id, inviter_id").eq("invitee_id",c).eq("status","pending").order("created_at",{ascending:!1}).limit(1).maybeSingle();if(!d){l("Aucune invitation en attente","error"),s("home");return}const{data:g,error:x}=await w.rpc("accept_friend_invite",{p_invite_id:d.id,p_invitee_deck_id:i});if(x||!(g!=null&&g.success)){console.error("[Friend] Erreur accept_friend_invite:",x||g),l((g==null?void 0:g.error)||"Impossible de rejoindre le match","error"),s("home");return}await Et(e,t,g.match_id,!1,{myGC:n,gcDefs:r,stadiumDef:o})}const Ln="#1A6B3C",ft="#D4A017",Rt="rgba(255,255,255,0.045)",Nt="rgba(255,255,255,0.09)",wt="rgba(255,255,255,0.08)",Pe="#f3f5f2",it="rgba(243,245,242,0.62)",Ke="rgba(243,245,242,0.4)";async function dr(e,t){var n;e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>';const i=(n=t.state.params)==null?void 0:n.openLeagueId;if(i){t.state.params.openLeagueId=null,await xt(e,t,i);return}await Lt(e,t)}async function Lt(e,t,i="waiting"){var b;const{state:n}=t,r=n.profile.id,{data:o}=await w.from("mini_league_members").select("league_id").eq("user_id",r),a=(o||[]).map(h=>h.league_id),{data:s,error:l}=await w.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").eq("is_archived",!1).order("created_at",{ascending:!1}).limit(30),c=l?(await w.from("mini_leagues").select("*, mini_league_members(count)").eq("status","waiting").order("created_at",{ascending:!1}).limit(30)).data||[]:s||[],g=(a.length?await w.from("mini_leagues").select("*, mini_league_members(count)").in("id",a).order("created_at",{ascending:!1}):{data:[]}).data||[],x=g.filter(h=>h.status==="waiting"&&!h.is_archived),m=g.filter(h=>h.status==="active"&&!h.is_archived),u=g.filter(h=>h.is_archived||h.status==="finished"),p=c.filter(h=>!a.includes(h.id)),f=[{key:"waiting",label:"🟡 En attente",count:x.length+p.length},{key:"active",label:"🟢 En cours",count:m.length},{key:"archived",label:"📁 Archivées",count:u.length}];e.innerHTML=`
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="display:flex;background:var(--nav-bg,#0d1a0f);border-bottom:1px solid ${wt}">
      ${f.map(h=>`<button class="ml-tab" data-tab="${h.key}" style="flex:1;padding:11px 4px;border:none;border-bottom:2px solid ${i===h.key?Ln:"transparent"};background:none;font-size:12px;font-weight:${i===h.key?"900":"600"};color:${i===h.key?"#4ade80":Ke};cursor:pointer">${h.label}${h.count?` (${h.count})`:""}</button>`).join("")}
    </div>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:14px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:${Rt};border:1px solid ${Nt};border-radius:12px;padding:16px">
        <div style="font-size:14px;font-weight:900;margin-bottom:4px;color:${Pe}">👥 Joueurs (${g.length}/${a.max_players})</div>
        <div style="font-size:12px;color:${it};margin-bottom:10px">💰 ${p} cr./joueur → Pot estimé : ${(p*g.length).toLocaleString("fr")} cr. (🥇${Math.floor(p*g.length*.7).toLocaleString("fr")} · 🥈${Math.floor(p*g.length*.2).toLocaleString("fr")} · 🥉${Math.floor(p*g.length*.1).toLocaleString("fr")})</div>
        ${g.map(j=>`
      ...
      <div style="background:${Rt};border:1px solid ${Nt};border-radius:12px;padding:16px">
        ...
        ${m.map(j=>en(j,g,o,c)).join("")}
        ${d&&f&&!b?'<button id="ml-next-day" class="btn btn-primary" style="width:100%;margin-top:12px">➡️ Journée suivante</button>':""}
        ${d&&f&&b?'<button id="ml-finish-btn" class="btn btn-primary" style="width:100%;margin-top:12px;background:#7a28b8">🏆 Terminer et distribuer le pot</button>':""}
      </div>`:""}
      ...
      <div style="background:${Rt};border:1px solid ${Nt};border-radius:12px;padding:16px">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(j,_)=>_+1).reverse().map(j=>{const _=(l||[]).filter(M=>M.matchday===j);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:${Ke};margin-bottom:6px">Journée ${j}</div>${_.map(M=>en(M,g,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    </div>`;let d=!1;const g=async f=>{if(!d){if(d=!0,clearInterval(u),m)try{m.unsubscribe()}catch{}f&&await Et(e,t,f,r,{mlLeagueId:n,mlMatchId:i,myGC:o||[],gcDefs:a,stadiumDef:s}),l()}};(p=document.getElementById("wait-back"))==null||p.addEventListener("click",()=>{if(d=!0,clearInterval(u),m)try{m.unsubscribe()}catch{}c("mini-league",{openLeagueId:n}),l()});const x=async()=>{if(d)return;const{data:f}=await w.from("mini_league_matches").select("match_id").eq("id",i).single();f!=null&&f.match_id&&g(f.match_id)},m=w.channel(`ml_match_${i}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"mini_league_matches",filter:`id=eq.${i}`},f=>{var b;(b=f.new)!=null&&b.match_id&&g(f.new.match_id)}).subscribe(),u=setInterval(x,3e3);x()})}const wr="/",_r=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
    ...
    <p style="margin-top:12px;font-size:13px;color:#888">Tu peux revoir ce tutoriel depuis les paramètres à tout moment.</p>`}];function kr(e,t,i){let n=0;const r=document.createElement("div");r.id="tutorial-overlay",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.65);z-index:9900;display:flex;align-items:center;justify-content:center;padding:16px";const o=()=>{var d,g,x;const s=t[n],l=n===t.length-1,c=Math.round((n+1)/t.length*100);r.innerHTML=`
    ...
    `,r.querySelectorAll("ul,ol").forEach(m=>{m.style.paddingLeft="20px",m.style.marginTop="6px",m.style.marginBottom="6px"}),r.querySelectorAll("li").forEach(m=>{m.style.marginBottom="4px"}),r.querySelectorAll("p").forEach(m=>{m.style.marginBottom="8px"}),(d=r.querySelector("#tuto-prev"))==null||d.addEventListener("click",()=>{n--,o()}),(g=r.querySelector("#tuto-next"))==null||g.addEventListener("click",()=>{l?a():(n++,o())}),(x=r.querySelector("#tuto-skip"))==null||x.addEventListener("click",()=>{confirm("Passer le tutoriel ? Tu pourras le revoir plus tard depuis les paramètres.")&&a()})},a=async()=>{r.remove(),e!=null&&e.id&&await w.from("users").update({tutorial_done:!0}).eq("id",e.id),i==null||i()};document.body.appendChild(r),o()}async function $r(e,t,i){if(!e||e.tutorial_done)return;let n=[];const{data:r,error:o}=await w.rpc("get_tutorial_steps");if(!o&&(r==null?void 0:r.length)>0)n=r,console.log(`[Tutorial] RPC OK → ${n.length} étapes`);else{const{data:s,error:l}=await w.from("tutorial_steps").select("*").eq("is_active",!0).order("step_order");!l&&(s==null?void 0:s.length)>0?(n=s,console.log(`[Tutorial] Direct OK → ${n.length} étapes`)):(console.warn(`[Tutorial] Aucune étape DB (RPC: ${o==null?void 0:o.message}, Direct: ${l==null?void 0:l.message})`),i&&i("[Tutorial] DB vide ou inaccessible — tuto local utilisé","warning",5e3))}const a=n.length>0?n.map(s=>({emoji:s.emoji,title:s.title,color:s.color,content:s.content,image_url:s.image_url||null})):_r;kr(e,a,()=>t("boosters"))}const ii={GK:"#111111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"};function St(e,t,i=0){return t?(Number(t==="GK"?e.note_g:t==="DEF"?e.note_d:t==="MIL"?e.note_m:e.note_a)||0)+(t===e.job||t===e.job2?i:0):0}async function Er(e,t){e.innerHTML='<div class="page" style="padding:40px;text-align:center;color:#aaa">⚽ Chargement...</div>',await Di(e,t)}async function Di(e,t){const{state:i,toast:n}=t,{data:r}=await w.from("market_listings").select(`id, price, status, listed_at, seller_id,
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let l="buy";const c=()=>{var p,f,b,h,v,$,y;return{name:(((p=document.getElementById("flt-name"))==null?void 0:p.value)||"").toLowerCase().trim(),club:(((f=document.getElementById("flt-club"))==null?void 0:f.value)||"").toLowerCase().trim(),country:(((b=document.getElementById("flt-country"))==null?void 0:b.value)||"").toLowerCase().trim(),job:((h=document.getElementById("flt-job"))==null?void 0:h.value)||"",rarity:((v=document.getElementById("flt-rarity"))==null?void 0:v.value)||"",note1:parseInt(($=document.getElementById("flt-note1"))==null?void 0:$.value)||0,note2:parseInt((y=document.getElementById("flt-note2"))==null?void 0:y.value)||0}};function d(p){const f=c();return p.filter(b=>{var N,ne,ie;const h=(N=b.card)==null?void 0:N.player;if(!h)return!1;const v=`${h.firstname} ${h.surname_real}`.toLowerCase(),$=(((ne=h.clubs)==null?void 0:ne.encoded_name)||"").toLowerCase(),y=(h.country_code||"").toLowerCase(),C=((ie=b.card)==null?void 0:ie.evolution_bonus)||0,E=St(h,h.job,C),P=h.job2?St(h,h.job2,C):0;return!(f.name&&!v.includes(f.name)||f.club&&!$.includes(f.club)||f.country&&!y.includes(f.country)||f.job&&h.job!==f.job||f.rarity&&h.rarity!==f.rarity||f.note1&&E<f.note1||f.note2&&P<f.note2)})}function g(p){var P,N,ne,ie;const f=(P=p.card)==null?void 0:P.player;if(!f)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,h=St(f,f.job,b),v=f.job2?St(f,f.job2,b):0,$=(i.profile.credits||0)>=p.price,y=f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,C=ii[f.job]||"#bbb",E=f.job2?ii[f.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden">
      <!-- Drapeau -->
    ...
    </div>`}function x(p){var P,N,ne,ie;const f=(P=p.card)==null?void 0:P.player;if(!f)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,h=St(f,f.job,b),v=f.job2?St(f,f.job2,b):0,$=p.status==="sold",y=f.country_code?`https://flagsapi.com/${f.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,C=ii[f.job]||"#bbb",E=f.job2?ii[f.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ne=f.clubs)!=null&&ne.logo_url?`<img src="${f.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${C};display:flex;align-items:center;justify-content:center">
    ...
    </div>`}function m(){const p=document.getElementById("mkt-content"),f=document.getElementById("mkt-filters");if(p){if(f.style.display=l==="buy"?"flex":"none",l==="buy"){const b=d(a);p.innerHTML=b.length?b.map(g).join(""):'<div style="text-align:center;color:#aaa;padding:40px">Aucune carte trouvée.</div>'}else{const b=s.filter(v=>v.status==="active").sort((v,$)=>new Date($.listed_at)-new Date(v.listed_at)),h=s.filter(v=>v.status==="sold").sort((v,$)=>new Date($.sold_at||$.listed_at)-new Date(v.sold_at||v.listed_at));p.innerHTML=(b.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:4px 0 6px;text-transform:uppercase;letter-spacing:1px">🟢 En vente (${b.length})</div>`+b.map(x).join(""):"")+(h.length?`<div style="font-size:11px;font-weight:700;color:#555;padding:12px 0 6px;text-transform:uppercase;letter-spacing:1px">✅ Ventes réussies (${h.length})</div>`+h.map(x).join(""):"")+(!b.length&&!h.length?'<div style="text-align:center;color:#aaa;padding:40px">Aucune vente pour le moment.</div>':"")}p.querySelectorAll("[data-buy]").forEach(b=>b.addEventListener("click",()=>Lr(b.dataset.buy,a,e,t))),p.querySelectorAll("[data-cancel]").forEach(b=>b.addEventListener("click",()=>zr(b.dataset.cancel,e,t)))}}e.querySelectorAll(".mkt-tab").forEach(p=>{p.addEventListener("click",()=>{l=p.dataset.tab,e.querySelectorAll(".mkt-tab").forEach(f=>{const b=f===p;f.style.background=b?"var(--green)":"#fff",f.style.color=b?"#fff":"var(--gray-600)",f.style.borderColor=b?"var(--green)":"var(--gray-200)"}),m()})});let u;["flt-name","flt-club","flt-country","flt-job","flt-rarity","flt-note1","flt-note2"].forEach(p=>{var f;(f=document.getElementById(p))==null||f.addEventListener("input",()=>{clearTimeout(u),u=setTimeout(m,250)})}),m()}async function Lr(e,t,i,n){const{state:r,toast:o,refreshProfile:a}=n,s=t.find(d=>d.id===e);if(!s)return;const l=s.price;if((r.profile.credits||0)<l){o("Crédits insuffisants","error");return}Tr(s,async()=>{const{error:d}=await w.rpc("buy_market_card",{p_listing_id:e,p_buyer_id:r.profile.id});if(d){o("Erreur achat : "+d.message,"error");return}await a();const g=document.getElementById("nav-credits");g&&(g.textContent=`💰 ${(r.profile.credits||0).toLocaleString("fr")}`),o("✅ Carte achetée !","success"),await Di(i,n)})}function Tr(e,t){var a;const i=(a=e.card)==null?void 0:a.player,n=i?`${i.firstname} ${i.surname_real}`:"cette carte",r=document.createElement("div");r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px",r.innerHTML=`
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=a||[];u.innerHTML=b.length>0?b.map((h,v)=>{const $=Ai(h.mmr??1e3),y=(h.ranked_wins||0)+(h.ranked_losses||0)+(h.ranked_draws||0),C=y>0?Math.round((h.ranked_wins||0)/y*100):0,E=h.id===i.profile.id,P=(h.placement_matches||0)<10;return`
  ...
  </div>`}Cn(qn);const ve={user:null,profile:null,page:"home",params:{}};function Ct(e,t="info",i=3e3){const n=document.getElementById("toast");n&&(n.textContent=e,n.className=`show ${t}`,clearTimeout(n._t),n._t=setTimeout(()=>{n.className=""},i))}function Sr(e,t,i=""){document.getElementById("modal-title").textContent=e,document.getElementById("modal-body").innerHTML=t,document.getElementById("modal-footer").innerHTML=i,document.getElementById("modal-overlay").classList.remove("hidden")}function zi(){document.getElementById("modal-overlay").classList.add("hidden")}async function Ot(){if(!ve.user)return;const{data:e}=await w.from("users").select("*").eq("id",ve.user.id).single();e&&(ve.profile=e)}function Ht(e,t={}){ve.page=e,ve.params=t,An()}async function An(){var n,r,o,a;const e=document.getElementById("page-content");if(!e)return;document.querySelectorAll(".bottom-nav a").forEach(s=>{s.classList.toggle("active",s.dataset.page===ve.page)});const t=document.getElementById("nav-credits");t&&ve.profile&&(t.textContent=`💰 ${(ve.profile.credits||0).toLocaleString("fr")}`);const i={state:ve,navigate:Ht,toast:Ct,openModal:Sr,closeModal:zi,refreshProfile:Ot};switch(e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽</div>',ve.page){case"home":await Hi(e,i);break;case"collection":await co(e,i);break;case"decks":await vi(e,i);break;case"boosters":await ko(e,i);break;case"ranked":await Ar(e,i);break;case"match":{const s=ve.params&&ve.params.matchMode||"vs_ai_easy";s==="random"?await Li(e,i,!1):s==="ranked"?await Li(e,i,!0):s==="friend"?await rr(e,i,(n=ve.params)==null?void 0:n.friendId,(r=ve.params)==null?void 0:r.friendName):s==="mini-league"?await tn(e,i,(o=ve.params)==null?void 0:o.mlMatchId,(a=ve.params)==null?void 0:a.leagueId):await Fo(e,i);break}case"market":await Er(e,i);break;case"rankings":await Ir(e,i);break;case"matches":await Mr(e,i);break;case"friends":await On(e,i);break;case"mini-league":await dr(e,i);break;case"match-mini-league":{const s=ve.params||{};await tn(e,i,s.mlMatchId,s.leagueId);break}default:await Hi(e,i)}}function jr(){var n;const e=document.getElementById("app"),t=ve.profile;if(!t)return;const i="/icons/";e.innerHTML=`
    <nav class="top-nav">
