...
import{s as T,F as ki,i as Ht,k as eo,l as nt,m as ji,f as Nt,n as Lo,T as ci,j as Io,o as Mo,b as jo}from"./formation-links-BZe0pGr4.js";const Co="/";function Ci(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,m,a,o,y;const s=n==="login";e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",d=>{d.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{n(),e("match",{matchMode:d.dataset.mode})})})}const Ft="/",Di={GK:Ft+"cards/card-GK.png",DEF:Ft+"cards/card-DEF.png",MIL:Ft+"cards/card-MIL.png",ATT:Ft+"cards/card-ATT.png"},Wo={GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"};function Jo(e){if(!(e!=null&&e.face))return null;const t=e.face.replace(/^public\//,"").replace(/^\//,"");return Ft+t}function Xo(e){return!e||e.length<2?null:`https://flagcdn.com/64x48/${e.slice(0,2).toLowerCase()}.png`}function Zo(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co",i=((n=e==null?void 0:e.clubs)==null?void 0:n.logo_url)||(e==null?void 0:e.clubLogo);return i?i.startsWith("http")?i:`${t}/storage/v1/object/public/assets/clubs/${i}`:null}function Gi(e,t,i=0){if(!t)return 0;const d="note_"+({GK:"g",DEF:"d",MIL:"m",ATT:"a"}[t]||t.toLowerCase());return(Number(e[d])||0)+(t===e.job||t===e.job2?i:0)}function Qo(e,t){return t?t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code:!1}function Ai(e,t={}){var ce;const{width:i=160,showStad:n=!1,stadDef:d=null,used:s=!1,extraNote:r=0}=t;if(!e)return`<div style="width:${i}px;height:${Math.round(i*657/507)}px;border-radius:8px;background:#111;opacity:0.3"></div>`;const l=i/507,m=Math.round(i*657/507),a=H=>Math.round(H*l),o=H=>a(H)+"px",y=e._line||e.job||"MIL",p=Wo[y]||"#D4A017",x=Di[y]||Di.MIL,_=e._evolution_bonus??e.evolution_bonus??0,f=n&&(e.stadiumBonus||Qo(e,d))?10:0,c=Gi(e,y,_)+r+f,z=f>0?"#E87722":p,u=e.job2&&e.job2!==y?e.job2:null,M=u?Gi(e,u,_)+r+f:null,F=Jo(e),C=Xo(e.country_code),q=Zo(e),j=(e.firstname||"").toUpperCase(),N=(e.surname_encoded||e.name||"").toUpperCase(),X=s?"opacity:0.35;":"",K=N.length>11?34:N.length>8?42:50,re=a(155),oe=a(260),Z=a(235),R=a(390),G=a(180),ne=a(100),ge=a(309),_e=a(85),we=a(95),ve=a(455),Ee=a(5),se=a(407),pe=a(6);return`<div style="position:relative;width:${i}px;height:${m}px;flex-shrink:0;${X}user-select:none">
