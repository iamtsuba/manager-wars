...
import{s as w,F as si,r as Ae,j as Mt,l as Pi,m as yt,h as di,n as gn,o as mn,T as Yt,k as xn,p as yn,b as bn}from"./formation-links-CUL_inpB.js";const hn="/";function Li(e,{navigate:t,toast:i}){let n="login";const a=()=>{var r,s,d,l,c,u;const o=n==="login";e.innerHTML=`
    <div style="
  ...
  `;function s(){var f;const l=document.getElementById("logo-preview"),c=document.getElementById("logo-initials"),u=((f=document.getElementById("setup-club"))==null?void 0:f.value)||"MW",g=u.trim().split(" ").filter(Boolean),m=g.length>=2?(g[0][0]+g[1][0]).toUpperCase():u.slice(0,2).toUpperCase();l&&(l.style.background=r,l.style.borderColor=o),c&&(c.textContent=m,c.style.color=o)}document.getElementById("color1").addEventListener("input",l=>{o=l.target.value,document.getElementById("swatch1").style.background=o,s()}),document.getElementById("color2").addEventListener("input",l=>{r=l.target.value,document.getElementById("swatch2").style.background=r,s()});function d(l){document.querySelectorAll(".setup-step").forEach(c=>c.classList.remove("active")),document.getElementById(`step-${l}`).classList.add("active"),document.getElementById("step-num").textContent=l,document.getElementById("progress-fill").style.width=`${Math.round(l/3*100)}%`,l===3&&s()}document.getElementById("step1-next").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("step1-error");if(c.textContent="",l.length<3){c.textContent="Pseudo trop court (min. 3 caractères).";return}const{data:u}=await w.from("users").select("id").eq("pseudo",l).maybeSingle();if(u){c.textContent="Ce pseudo est déjà pris.";return}d(2)}),document.getElementById("step2-back").addEventListener("click",()=>d(1)),document.getElementById("step2-next").addEventListener("click",async()=>{const l=document.getElementById("setup-club").value.trim(),c=document.getElementById("step2-error");if(c.textContent="",l.length<2){c.textContent="Nom trop court (min. 2 caractères).";return}const{data:u}=await w.from("users").select("id").eq("club_name",l).maybeSingle();if(u){c.textContent="Ce nom de club est déjà pris.";return}d(3)}),document.getElementById("step3-back").addEventListener("click",()=>d(2)),document.getElementById("step3-finish").addEventListener("click",async()=>{const l=document.getElementById("setup-pseudo").value.trim(),c=document.getElementById("setup-club").value.trim(),u=document.getElementById("step3-error"),g=document.getElementById("step3-finish");u.textContent="",g.disabled=!0,g.textContent="Création en cours…";try{const{error:m}=await w.from("users").insert({id:t.user.id,pseudo:l,club_name:c,club_color1:o,club_color2:r,credits:1e4});if(m)throw m;await wn(t.user.id),await a(),n(`Bienvenue ${l} ! Tes récompenses de démarrage sont prêtes.`,"success",5e3),window.location.reload()}catch(m){u.textContent=m.message,g.disabled=!1,g.textContent="🚀 Créer mon profil !"}})}async function wn(e){const t=[{type:"player",count:5,guaranteeGK:!0},{type:"player",count:5},{type:"player",count:5},{type:"player",count:5},{type:"game_changer",count:3},{type:"formation",count:1}];try{await w.from("users").update({pending_boosters:t,onboarding_done:!1,first_booster_opened:!1}).eq("id",e)}catch(i){console.warn("[Setup] Colonnes pending_boosters/onboarding_done absentes — migration requise",i)}}const _n="modulepreload",kn=function(e){return"/"+e},Ti={},Ri=function(t,i,n){let a=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(i.map(d=>{if(d=kn(d),d in Ti)return;Ti[d]=!0;const l=d.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":_n,l||(u.as="script"),u.crossOrigin="",u.href=d,s&&u.setAttribute("nonce",s),document.head.appendChild(u),l)return new Promise((g,m)=>{u.addEventListener("load",g),u.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},Et="#1A6B3C",Lt="#cc2222",$n="#D4A017",zi="#888";async function En(e,t){const{state:i,toast:n}=t;e.innerHTML=`
    ...
    </style>`}const In="2026.07.14-1430";async function Ii(e,{state:t,navigate:i,toast:n}){var o,r;const a=t.profile;a&&(e.innerHTML=`
  <style>
    .home-dark {
      min-height: 100%;
  ...
  <div class="home-dark" id="home-dark">
    ...
    ${Ae(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),l=(s||[]).filter(z=>z.card_type==="player"&&z.player),c=(s||[]).filter(z=>z.card_type==="game_changer"),u=(s||[]).filter(z=>z.card_type==="formation"),g=(s||[]).filter(z=>z.card_type==="stadium"),{data:m}=await w.from("gc_definitions").select("name,gc_type,color,effect,image_url"),f={};(m||[]).forEach(z=>{f[z.name]=z});const{data:p}=await w.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),x={};(p||[]).forEach(z=>{x[z.id]=z}),g.forEach(z=>{z.stadium_def&&(x[z.stadium_id]=z.stadium_def)});const b=Object.keys(si),h=Object.keys(Me),v={};l.forEach(z=>{const M=z.player.id;v[M]=(v[M]||0)+1}),new Set(Object.keys(v).map(z=>String(z)));const $=new Set(u.map(z=>z.formation)),y=new Set(c.map(z=>z.gc_type));let C="player",E="Tous",F="",N=!1;function ee(){return[...l].sort((z,M)=>{const R=jt.indexOf(z.player.job),H=jt.indexOf(M.player.job);return R!==H?R-H:(z.player.surname_real||"").localeCompare(M.player.surname_real||"")})}function ie(){return[...d||[]].sort((z,M)=>{const R=jt.indexOf(z.job),H=jt.indexOf(M.job);return R!==H?R-H:(z.surname_real||"").localeCompare(M.surname_real||"")})}function le(){return ee().filter(z=>{const M=z.player,R=E==="Tous"||M.job===E,H=!F||`${M.firstname} ${M.surname_real}`.toLowerCase().includes(F);return R&&H})}function P(){return ie().filter(z=>{const M=E==="Tous"||z.job===E,R=!F||`${z.firstname} ${z.surname_real}`.toLowerCase().includes(F);return M&&R})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="flex-shrink:0;padding:0">
      <div id="col-grid" style="display:flex;overflow-x:auto;gap:8px;padding:8px 16px;-webkit-overflow-scrolling:touch;scrollbar-width:none"></div>
  ...
  </div>`;function L(){const z=document.getElementById("col-filters");z&&(C==="player"?(z.innerHTML=`
        ...
        </div>`,document.getElementById("col-search").addEventListener("input",M=>{F=M.target.value.toLowerCase(),k()}),e.querySelectorAll(".filter-btn").forEach(M=>{M.addEventListener("click",()=>{E=M.dataset.job,L(),k()})}),document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,L(),k()})):(z.innerHTML=`
        ...
        </div>`,document.getElementById("show-all-btn").addEventListener("click",()=>{N=!N,L(),k()})))}function k(){const z=document.getElementById("col-grid");z&&(C==="player"?Ee(z):C==="formation"?K(z):C==="stadium"?Y(z):V(z))}function D(z,M,R,H,U){const j=document.getElementById("col-grid"),O=document.getElementById("col-big");if(!j||!O)return;var $e=0;function _e(){const we=window.innerWidth>=768,me=document.getElementById("col-big"),Le=document.getElementById("col-grid");we&&me&&(me.style.minHeight="420px",me.style.flex="1 1 auto"),we&&Le&&(Le.style.height=Math.round(310*.76+16)+"px",Le.style.flexShrink="0",Le.style.overflowX="auto",Le.style.overflowY="hidden",Le.style.alignItems="center",Le.style.padding="8px 16px"),O.innerHTML='<div id="big-card-inner" style="display:inline-block;transform-origin:top center">'+M(z[$e])+"</div>";var ke=O.querySelector("[data-card-id],[data-form-id],[data-gc-id]");ke&&ke.addEventListener("click",function(){H(z[$e])}),requestAnimationFrame(function(){var he=document.getElementById("big-card-inner");if(document.getElementById("col-grid"),!(!he||!O)){var Ce=O.clientHeight-8,je=O.clientWidth-24,Fe=he.offsetHeight,_=he.offsetWidth;if(Fe>0&&_>0&&Ce>40){var T=we?2.2:1.6,A=Math.min(Ce/Fe,je/_,T);he.style.transform="scale("+A.toFixed(3)+")",he.style.transformOrigin="top center"}}}),j.innerHTML=z.map(function(he,Ce){var je=Ce===$e,Fe="flex-shrink:0;cursor:pointer;border-radius:6px;overflow:hidden;display:inline-block;line-height:0;"+(je?"outline:2.5px solid #D4A017;outline-offset:1px;background:rgba(212,160,23,0.25);":"");return'<div class="col-mini-item" data-idx="'+Ce+'" style="'+Fe+'">'+R(he,je)+"</div>"}).join(""),j.querySelectorAll(".col-mini-item").forEach(function(he){he.addEventListener("click",function(){$e=Number(he.dataset.idx),_e(),he.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})})})}_e()}function oe(z){var M=window.innerWidth>=768?.76:.54,R;if(!z||z._fake){var H=z?z.player:null;if(!H)return"";R=Si(H)}else R=Jt(z,"");return'<div style="display:inline-block;zoom:'+M+';pointer-events:none;line-height:0">'+R+"</div>"}function pe(z,M,R){M=M||100,R=R||140;var H=Mt[z]||{},U={GK:"#111111",DEF:"#cc2222",MIL:"#D4A017",ATT:"#22aa55"},j=Math.max(3,Math.round(M*.06)),O=Object.entries(H).map(function(_e){var we=_e[0],me=_e[1],Le=we.replace(/\d+$/,""),ke=U[Le]||"#888",he=Math.round(me.x*M),Ce=Math.round(me.y*R);return'<circle cx="'+he+'" cy="'+Ce+'" r="'+j+'" fill="'+ke+'" stroke="rgba(255,255,255,0.8)" stroke-width="1"/>'}).join(""),$e=Math.max(1,Math.round(M/50));return'<svg viewBox="0 0 '+M+" "+R+'" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><rect width="'+M+'" height="'+R+'" fill="#1A6B3C"/><rect x="'+Math.round(M*.2)+'" y="'+Math.round(R*.02)+'" width="'+Math.round(M*.6)+'" height="'+Math.round(R*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+$e+'"/><line x1="0" y1="'+Math.round(R*.5)+'" x2="'+M+'" y2="'+Math.round(R*.5)+'" stroke="rgba(255,255,255,0.3)" stroke-width="'+$e+'"/><ellipse cx="'+Math.round(M*.5)+'" cy="'+Math.round(R*.5)+'" rx="'+Math.round(M*.18)+'" ry="'+Math.round(R*.11)+'" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="'+$e+'"/><rect x="'+Math.round(M*.2)+'" y="'+Math.round(R*.82)+'" width="'+Math.round(M*.6)+'" height="'+Math.round(R*.16)+'" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="'+$e+'"/>'+O+"</svg>"}function de(z,M,R){var H=R>1?'<div style="position:absolute;top:4px;right:4px;background:#0a3d1e;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×'+R+"</div>":"",U=M?'data-form-id="'+M.id+'"':"",j=z.length>7?14:z.length>5?16:19,O=!!M;return"<div "+U+' style="position:relative;width:140px;border-radius:12px;border:3px solid '+(O?"#2a7a40":"#bbb")+";background:#fff;display:flex;flex-direction:column;overflow:hidden;cursor:pointer;box-shadow:0 2px 10px rgba(0,0,0,.12);"+(O?"":"filter:grayscale(1);opacity:0.5")+'">'+H+'<div style="padding:8px 6px 6px;background:#fff;text-align:center;border-bottom:3px solid '+(O?"#1A6B3C":"#aaa")+';flex-shrink:0"><div style="font-size:8px;color:#888;letter-spacing:1.5px;font-weight:700;margin-bottom:2px">FORMATION</div><div style="font-size:'+j+"px;font-weight:900;color:"+(O?"#1A6B3C":"#aaa")+';line-height:1">'+z+'</div></div><div style="flex:1;overflow:hidden;background:'+(O?"#1A6B3C":"#ccc")+'">'+pe(z,140,220)+"</div></div>"}function ae(z,M){var R=window.innerWidth>=768?.76:.54,H=140,U=305,j=Math.round(U*.22),O=U-j,$e=z.length>7?10:13,_e=pe(z,H,O),we=M?"1.5px solid #2a7a40":"1px solid #ddd",me=M?"":"filter:grayscale(1);opacity:0.45;",Le=M?"#1A6B3C":"#bbb",ke="#fff";return'<div style="display:inline-block;zoom:'+R+';line-height:0;pointer-events:none"><div style="width:'+H+"px;height:"+U+"px;border-radius:6px;border:"+we+";background:#fff;display:flex;flex-direction:column;overflow:hidden;"+me+'"><div style="height:'+j+"px;background:"+Le+';display:flex;align-items:center;justify-content:center;padding:0 2px;flex-shrink:0"><span style="font-size:'+$e+"px;font-weight:900;color:"+ke+";text-align:center;overflow:hidden;white-space:nowrap;max-width:"+(H-4)+'px">'+z+'</span></div><div style="height:'+O+'px;overflow:hidden;flex-shrink:0">'+_e+"</div></div></div>"}function Ee(z){if(N){const M=P();if(!M.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucun joueur.</div>';return}const R=M.map(H=>l.find(U=>U.player.id===H.id)||{_fake:!0,player:H,id:"fake-"+H.id});D(R,H=>H._fake?Si(H.player):Jt(H,""),H=>H._fake?oe({player:H.player,id:"x",_fake:!0}):oe(H),H=>{H._fake||Ci(H,l,v,t)})}else{const M=le();if(!M.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte.<br><small>Ouvre des boosters !</small></div>';return}const R={};M.forEach(U=>{const j=U.player.id;R[j]||(R[j]=[]),R[j].push(U)});const H=Object.values(R).map(U=>Pn(U));D(H,U=>{const j=v[U.player.id]||1,O=j>1?`<div style="position:absolute;top:4px;right:4px;background:#1A6B3C;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 6px;z-index:3">×${j}</div>`:"",_e=l.filter(we=>we.player.id===U.player.id&&we.is_for_sale).length>0?'<div style="position:absolute;top:4px;left:4px;background:#D4A017;color:#fff;border-radius:10px;font-size:9px;font-weight:700;padding:1px 5px;z-index:3">🏷️</div>':"";return Jt(U,O+_e)},U=>oe(U),U=>Ci(U,l,v,t))}}function K(z){const M=N?b:[...$];if(!M.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Formation.<br><small>Ouvre un booster Formation !</small></div>';return}const R=M.map(H=>({formation:H,card:u.find(U=>U.formation===H)||null,owned:$.has(H)}));D(R,({formation:H,card:U,owned:j})=>de(H,j?U:null,j?u.filter(O=>O.formation===H).length:0),({formation:H,owned:U})=>ae(H,U),({card:H,owned:U})=>{U&&H&&Kn(H,u,t,o)})}function V(z){const M=Object.keys(f),R=N?M.length?M:h:[...y];if(!R.length){z.innerHTML='<div style="width:100%;text-align:center;padding:40px;color:var(--gray-600)">Aucune carte Game Changer.<br><small>Ouvre un booster Game Changer !</small></div>';return}const H=R.map(U=>({type:U,gc:Me[U]||{icon:"⚡",desc:""},def:f[U]||null,owned:y.has(U),card:c.find(j=>j.gc_type===U)||null}));D(H,({type:U,gc:j,def:O,owned:$e,card:_e})=>{var T;const we=$e?c.filter(A=>A.gc_type===U).length:0,me=we>1?`<div style="position:absolute;top:8px;right:8px;background:#3d0a7a;color:#fff;border-radius:10px;font-size:10px;font-weight:700;padding:2px 8px;z-index:3">×${we}</div>`:"",Le=(O==null?void 0:O.gc_type)==="ultra_game_changer",ke={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},he={purple:"#b06ce0",light_blue:"#00d4ef"},Ce=ke[O==null?void 0:O.color]||ke.purple,je=he[O==null?void 0:O.color]||he.purple,Fe=(O==null?void 0:O.effect)||j.desc||"",_=O!=null&&O.image_url?`/icons/${O.image_url}`:((T=O==null?void 0:O.club)==null?void 0:T.logo_url)||(O!=null&&O.country_code?`https://flagsapi.com/${O.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null);return $e&&_e?`<div data-gc-id="${_e.id}" data-gc-type="${U}" style="position:relative;width:140px;border-radius:12px;border:3px solid ${je};background:${Ce};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${je}66;cursor:pointer">
          ${me}
        ...
        </div>`},null)}e.querySelectorAll(".col-tab-btn").forEach(z=>{z.addEventListener("click",()=>{C=z.dataset.tab,E="Tous",F="",N=!1,e.querySelectorAll(".col-tab-btn").forEach(M=>{const R=M.dataset.tab===C;M.style.borderBottomColor=R?"var(--green)":"transparent",M.style.color=R?"var(--green)":"var(--gray-600)"}),L(),k()})}),L(),k()}function Un(e,t,i){const n=Me[e]||{icon:"⚡",desc:"Effet spécial."},a=(t==null?void 0:t.gc_type)==="ultra_game_changer",o={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},r={purple:"#b06ce0",light_blue:"#00d4ef"},s=o[t==null?void 0:t.color]||o.purple,d=r[t==null?void 0:t.color]||r.purple,l=(t==null?void 0:t.name)||e,c=(t==null?void 0:t.effect)||n.desc,u=t!=null&&t.image_url?`/icons/${t.image_url}`:null;i("Game Changer",`<div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:8px">
    ...
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${u.map((K,V)=>{const Y=le[K.id]||[],z=K.is_for_sale,M=Y.length?Y[Y.length-1]:null,H=(c.rarity==="pepite"||c.rarity==="papyte")&&K.current_note!=null?` (☆${K.current_note})`:"";return`
            <div data-card-id="${K.id}" data-card-idx="${V}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${V+1}${H}${z?" 🏷️ En vente":""}</div>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;background:#f0fdf4;border-radius:10px;padding:10px 14px">
          <div>
            ...
            <div style="font-size:11px;color:#555;margin-top:2px">
              ${(e.evolution_bonus||0)>0?`+${e.evolution_bonus} appliqué${e.evolution_bonus>1?"s":""} · Note : ${F}${c.job2&&N>0?` / ${ee}`:""}`:`Note actuelle : ${F}${c.job2&&N>0?` / ${ee}`:""}`}
            </div>
          </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",c.note_g],["DEF",c.note_d],["MIL",c.note_m],["ATT",c.note_a]].map(([K,V])=>{const Y=Wt[K],z=K==="GK"?"#fff":Y,M=K===c.job||K===c.job2,R=(Number(V)||0)+(M&&C>0?C:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:4px">
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(pe=document.getElementById("close-detail"))==null||pe.addEventListener("click",s);let k=new Set;const D=()=>{const K=k.size,V=document.getElementById("sell-action-panel");if(!V)return;V.style.display=K>0?"block":"none",document.getElementById("sell-selected-count").textContent=K;const Y=document.getElementById("evolve-btn");Y&&(Y.textContent=`⬆️ Évoluer ${K>1?"(+"+K+")":""}`)};document.querySelectorAll(".expl-check").forEach(K=>{K.addEventListener("change",()=>{const V=K.dataset.id;K.checked?k.add(V):k.delete(V);const Y=K.closest(".exemplaire-row");Y&&(Y.style.borderColor=K.checked?"#1A6B3C":"#eee"),D()})}),document.querySelectorAll(".exemplaire-row").forEach(K=>{K.addEventListener("click",V=>{if(V.target.closest("button")||V.target.tagName==="INPUT")return;const Y=K.querySelector(".expl-check");Y&&!Y.disabled&&(Y.checked=!Y.checked,Y.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(K=>{K.addEventListener("click",V=>{V.stopPropagation();const Y=document.querySelector(`.expl-hist[data-hist="${K.dataset.idx}"]`);Y&&(Y.style.display=Y.style.display==="none"?"flex":"none")})}),(de=document.getElementById("evolve-btn"))==null||de.addEventListener("click",async()=>{if(g<=1)return;const K=[...k];if(!K.length)return;if(k.has(e.id)){const U=document.createElement("div");U.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",U.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            ...
            📈 Note : <strong>${h+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${h+(e.evolution_bonus||0)+V.length*Y}</strong>
  ...
  <div style="height:100%;overflow:hidden;background:var(--page-bg)">
    ...
    </div>`;x("⚽ Choisir une formation",h),document.querySelectorAll("#modal-body [data-forma]").forEach(v=>{v.addEventListener("click",()=>{t.formation=v.dataset.forma;const $=Bi(t.formation),y={};$.forEach(C=>{t.slots[C]&&(y[C]=t.slots[C])}),t.slots=y,b(),Ze(e,t,i)})})};e.querySelectorAll("#formation-mobile-btn, #formation-pc-btn").forEach(x=>x.addEventListener("click",m)),e.querySelectorAll("#add-stad-btn-pc, #add-stad-btn").forEach(x=>x.addEventListener("click",()=>Yn(t,e,i))),e.querySelectorAll("#save-deck").forEach(x=>x.addEventListener("click",()=>Jn(t,i))),e.querySelectorAll("[data-remove-sub]").forEach(x=>{x.addEventListener("click",()=>{t.subs=t.subs.filter(b=>b!==x.dataset.removeSub),Ze(e,t,i)})}),e.querySelectorAll("#add-sub-btn").forEach(x=>x.addEventListener("click",()=>Xn(t,e,i)))}function Vn(e,t,i,n){var v,$;const a=window.innerWidth>=900,o=e.querySelector(a?"#deck-field-pc":"#deck-field-mobile");if(!o)return;const r=(v=t.stadiumCards)==null?void 0:v.find(y=>y.id===t.stadiumCardId),s=r&&(($=t.stadDefMap)==null?void 0:$[r.stadium_id])||null,d=Mt[t.formation]||{},l=Pi(t.formation)||[],c={};for(const y of i){const C=t.slots[y],E=C?t.playerCards.find(F=>F.id===C):null;E!=null&&E.player?c[y]={...E.player,_evolution_bonus:E.evolution_bonus||0,face:E.player.face||null}:c[y]=null}const u=window.innerWidth>=900,g=u?window.innerWidth-280:window.innerWidth-20,m=u?Math.min(g,860):g,f=Math.round(u?m*.82:m*.85),p=u?84:44;let x="";for(const[y,C]of l){const E=d[y],F=d[C];if(!E||!F)continue;const N=E.x*m,ee=Math.round(.03*f+E.y*.85*f),ie=F.x*m,le=Math.round(.03*f+F.y*.85*f),P=c[y],L=c[C],k=yt(P,L);k==="#ff3333"||k==="#cc2222"?x+=`<line x1="${N.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${le.toFixed(1)}" stroke="${k}" stroke-width="2" stroke-linecap="round" opacity="0.35"/>`:(x+=`<line x1="${N.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${le.toFixed(1)}" stroke="${k}" stroke-width="8" stroke-linecap="round" opacity="0.15"/>`,x+=`<line x1="${N.toFixed(1)}" y1="${ee.toFixed(1)}" x2="${ie.toFixed(1)}" y2="${le.toFixed(1)}" stroke="${k}" stroke-width="2.5" stroke-linecap="round" opacity="0.85"/>`)}let b="";const h=Math.round(p*657/507);for(const y of i){const C=d[y];if(!C)continue;const E=c[y],F=C.x*m;C.y*f;const N=Math.round(.03*f+C.y*(.85*f)),ee=Math.round(F-p/2),ie=Math.round(N-h/2);if(E){const le=y.replace(/\d+/,""),P=s&&(s.club_id&&String(E.club_id)===String(s.club_id)||s.country_code&&E.country_code===s.country_code),L=Ae({...E,_evolution_bonus:E._evolution_bonus||0},{width:p,showStad:!0,stadDef:s,role:le});b+=`<div style="position:absolute;left:${ee}px;top:${ie}px;cursor:pointer;z-index:2;position:absolute" class="deck-slot-hit" data-pos="${y}">
        <div style="position:relative">${P?'<div style="position:absolute;top:-18px;left:0;right:0;text-align:center;font-size:14px;z-index:5;line-height:1">🏟️</div>':""}${L}</div>
  ...
  `,document.body.appendChild(a);let o=!1;const r=document.getElementById("pack-cut-zone"),s=document.getElementById("pack-blade");let d=!1;const l=L=>L.touches&&L.touches[0]?L.touches[0].clientX:L.clientX;function c(L){o||(d=!0,s.style.opacity="1",u(L))}function u(L){if(!d||o)return;const k=r.getBoundingClientRect(),D=l(L)-k.left,oe=Math.max(0,Math.min(1,D/k.width));s.style.width=oe*k.width+"px",oe>=.82&&m()}function g(){o||(d=!1,s.style.transition="width .2s ease, opacity .2s ease",s.style.width="0",s.style.opacity="0",setTimeout(()=>{o||(s.style.transition="")},220))}function m(){var k;if(o)return;o=!0,d=!1,s.style.width="100%",s.style.opacity="1",(k=document.getElementById("cut-flash"))==null||k.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const L=document.getElementById("cut-hint");L&&(L.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{s.style.opacity="0",document.getElementById("pack-phase").style.display="none",b(0)},620)}r.addEventListener("pointerdown",c),window.addEventListener("pointermove",u),window.addEventListener("pointerup",g),r.addEventListener("touchstart",c,{passive:!0}),window.addEventListener("touchmove",u,{passive:!0}),window.addEventListener("touchend",g);let f=0,p=!1;const x=new Set;function b(L){f=L,document.getElementById("reveal-phase").style.display="flex",h(),v(L,0),F()}function h(){const L=document.getElementById("card-dots");L&&(L.innerHTML=e.map((k,D)=>`<div class="card-dot" data-i="${D}" style="width:8px;height:8px;border-radius:50%;background:${D===f?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),L.querySelectorAll(".card-dot").forEach(k=>k.addEventListener("click",()=>y(parseInt(k.dataset.i)))))}function v(L,k){var Y,z;const D=e[L],oe=document.getElementById("card-counter"),pe=document.getElementById("card-track");oe&&(oe.textContent=`Carte ${L+1} / ${e.length}`);const de=document.getElementById("reveal-btns");de&&(de.style.display=L===e.length-1?"flex":"none");const ae=D.card_type==="player"&&((Y=D.player)==null?void 0:Y.rarity)==="legende",Ee=!x.has(L);x.add(L);let K=0;if(D.card_type==="player"&&D.player){const M=D.player,R=M.job||"ATT";K=Number(R==="GK"?M.note_g:R==="DEF"?M.note_d:R==="MIL"?M.note_m:M.note_a)||0}const V=M=>{pe.innerHTML=`
        <div id="current-card-wrap" style="position:relative;display:flex;flex-direction:column;align-items:center;gap:8px;${ae?"filter:drop-shadow(0 0 20px #7a28b8)":""}">
          <div style="transform:scale(1.25);transform-origin:center">${ao(D)}</div>
        ...
        </div>`;const R=document.getElementById("current-card-wrap");k!==0?(R.style.transition="none",R.style.transform=`translateX(${k>0?100:-100}%)`,requestAnimationFrame(()=>{R.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",R.style.transform="translateX(0)"})):R.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),M||ae?ee():ie(),h()};Ee&&(((z=D.player)==null?void 0:z.rarity)==="legende"||K>=8)&&D.card_type==="player"&&D.player?$(D,()=>V(!0)):V(!1)}function $(L,k){var we;p=!0;const D=L.player,oe=`https://flagsapi.com/${D.country_code}/flat/64.png`,pe=(we=D.clubs)==null?void 0:we.logo_url,de=D.face?"/"+D.face.replace(/^public\//,"").replace(/^\//,""):null,ae=D.job||"ATT",Ee=Number(ae==="GK"?D.note_g:ae==="DEF"?D.note_d:ae==="MIL"?D.note_m:D.note_a)||0,K=L.evolution_bonus||0,V=Ee+K,Y=D.rarity==="legende",z=V>=18,M=document.getElementById("walkout-overlay"),R=document.getElementById("walkout-stage");if(!M||!R){p=!1,k();return}let H=null;Y&&(H=new Audio("/sounds/Legendary.mp3"),H.volume=.8,H.play().catch(()=>{})),M.style.display="flex";const U=()=>{const me=R.firstElementChild;me&&(me.classList.remove("wo-in"),me.classList.add("wo-out"))},j=1800,O=400;R.innerHTML=`<img class="wo-in" src="${oe}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(U,j),setTimeout(()=>{var me;R.innerHTML=pe?`<img class="wo-in" src="${pe}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((me=D.clubs)==null?void 0:me.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},j+O),setTimeout(U,j*2+O),setTimeout(()=>{R.innerHTML=de?`<img class="wo-in" src="${de}" style="height:200px;border-radius:50%;box-shadow:0 0 40px rgba(255,255,255,0.3);object-fit:cover;object-position:top">`:'<div class="wo-in" style="font-size:80px">👤</div>',navigator.vibrate&&navigator.vibrate(30)},(j+O)*2),setTimeout(U,(j+O)*2+j);const _e=z?"#FFD700":{GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"}[ae]||"#fff";setTimeout(()=>{R.innerHTML=`<div class="wo-in" style="
        ...
        ${V}
      </div>`,z&&navigator.vibrate&&navigator.vibrate([50,30,100,30,200])},(j+O)*3),setTimeout(U,(j+O)*3+j),setTimeout(()=>{M.style.display="none",R.innerHTML="",p=!1,H&&!Y&&H.pause(),navigator.vibrate&&navigator.vibrate([40,30,80]),k()},(j+O)*4)}function y(L){if(p||L<0||L>=e.length||L===f)return;const k=L>f?1:-1;f=L,v(L,k)}function C(){y(f+1)}function E(){y(f-1)}function F(){const L=document.getElementById("card-viewport");if(!L||L._swipeBound)return;L._swipeBound=!0;let k=0,D=0,oe=0,pe=!1;const de=Y=>Y.touches?Y.touches[0].clientX:Y.clientX,ae=Y=>Y.touches?Y.touches[0].clientY:Y.clientY,Ee=Y=>{pe=!0,k=de(Y),D=ae(Y),oe=0},K=Y=>{if(!pe)return;oe=de(Y)-k;const z=ae(Y)-D;if(Math.abs(oe)<Math.abs(z))return;const M=document.getElementById("current-card-wrap");M&&(M.style.transition="none",M.style.transform=`translateX(${oe*.6}px) rotate(${oe*.02}deg)`)},V=()=>{if(!pe)return;pe=!1;const Y=document.getElementById("current-card-wrap"),z=55;oe<=-z&&f<e.length-1?C():oe>=z&&f>0?E():Y&&(Y.style.transition="transform .2s ease",Y.style.transform="translateX(0)")};L.addEventListener("pointerdown",Ee),L.addEventListener("pointermove",K),L.addEventListener("pointerup",V),L.addEventListener("pointercancel",V),L.addEventListener("touchstart",Ee,{passive:!0}),L.addEventListener("touchmove",K,{passive:!0}),L.addEventListener("touchend",V),L.addEventListener("click",Y=>{if(Math.abs(oe)>8)return;const z=L.getBoundingClientRect();Y.clientX-z.left>z.width/2?C():E()})}let N=null;function ee(){const L=document.getElementById("fireworks-canvas");if(!L)return;L.width=window.innerWidth,L.height=window.innerHeight;const k=L.getContext("2d"),D=[];function oe(){const de=Math.random()*L.width,ae=Math.random()*L.height*.6,Ee=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],K=Ee[Math.floor(Math.random()*Ee.length)];for(let V=0;V<60;V++){const Y=Math.PI*2/60*V,z=2+Math.random()*5;D.push({x:de,y:ae,vx:Math.cos(Y)*z,vy:Math.sin(Y)*z,alpha:1,color:K,size:2+Math.random()*3})}}oe(),N=setInterval(oe,600);function pe(){if(document.getElementById("fireworks-canvas")){k.clearRect(0,0,L.width,L.height);for(let de=D.length-1;de>=0;de--){const ae=D[de];if(ae.x+=ae.vx,ae.y+=ae.vy+.08,ae.vy*=.98,ae.alpha-=.018,ae.alpha<=0){D.splice(de,1);continue}k.globalAlpha=ae.alpha,k.fillStyle=ae.color,k.beginPath(),k.arc(ae.x,ae.y,ae.size,0,Math.PI*2),k.fill()}k.globalAlpha=1,(N!==null||D.length>0)&&requestAnimationFrame(pe)}}pe()}function ie(){N!==null&&(clearInterval(N),N=null);const L=document.getElementById("fireworks-canvas");L&&L.getContext("2d").clearRect(0,0,L.width,L.height)}if(n){const L=document.getElementById("reveal-btns");L&&(L.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(P=document.getElementById("reveal-next"))==null||P.addEventListener("click",()=>{ie(),a.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{ie(),a.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{ie(),a.remove(),i("boosters")})}function ao(e){var t,i,n,a;if(e.card_type==="player"&&e.player)return to(e);if(e.card_type==="game_changer"){const o=e._gcDef,r=(o==null?void 0:o.gc_type)==="ultra_game_changer",s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},d={purple:"#b06ce0",light_blue:"#00d4ef"},l=s[o==null?void 0:o.color]||s.purple,c=d[o==null?void 0:o.color]||d.purple,u=(o==null?void 0:o.name)||e.gc_type||"Game Changer",g=(o==null?void 0:o.effect)||((t=ti[e.gc_type])==null?void 0:t.desc)||"",m=o!=null&&o.image_url?`/icons/${o.image_url}`:null,f=((i=ti[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${l};border-radius:14px;border:3px solid ${c};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${c}88;flex-shrink:0">
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="deck-select-screen" style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#0a3d1e;color:#fff">
      ...
      <div id="deck-top-bar" style="flex-shrink:0">
        ...
        <div style="display:flex;align-items:center;gap:8px;padding:5px 14px;background:linear-gradient(90deg,rgba(232,119,34,0.3),transparent);border-top:1px solid rgba(232,119,34,0.3)">
          ...
          <span style="font-size:11px;color:#FFD700;margin-left:auto">+10 aux joueurs ${((N=h.club)==null?void 0:N.encoded_name)||h.country_code||""}</span>
        </div>`:""}
      </div>
      ...
      <!-- Pagination -->
      ${o.length>1?`<div style="display:flex;justify-content:center;gap:6px;padding:4px;flex-shrink:0">${o.map((L,k)=>`<div style="width:6px;height:6px;border-radius:50%;background:${k===c?"#FFD700":"rgba(255,255,255,0.25)"}"></div>`).join("")}</div>`:""}
      ...
      <div id="deck-bottom-bar" style="flex-shrink:0;padding:10px 14px 14px;display:flex;flex-direction:column;gap:8px;background:rgba(0,0,0,0.2)">
    ...
    </div>`,requestAnimationFrame(()=>requestAnimationFrame(function L(){const k=e.querySelector(".deck-preview-wrap"),D=e.querySelector("#deck-swipe-zone");if(!k||!D||!b)return;const oe=Math.max(200,D.clientHeight-40),pe=Math.max(200,D.clientWidth-16),de=D.clientWidth>=900,ae=de?Math.min(pe,Math.round(oe*.95)):pe,Ee=Math.max(52,Math.round(ae*.18));if(oe<220||ae<220){requestAnimationFrame(L);return}const K=de?null:Math.round(Ee*.55);k.innerHTML=At(b,x,null,[],ae,oe,[],K),k.style.cssText=`width:${ae}px;height:${oe}px;overflow:visible;margin:${de?0:60}px auto 0`;const V=k.querySelector("svg");V&&(V.style.cssText="display:block;width:100%;height:100%",V.setAttribute("preserveAspectRatio",de?"xMidYMid meet":"none"))})),(ee=document.getElementById("prev-deck"))==null||ee.addEventListener("click",()=>{c>0&&(c--,u())}),(ie=document.getElementById("next-deck"))==null||ie.addEventListener("click",()=>{c<o.length-1&&(c++,u())}),(le=document.getElementById("validate-deck"))==null||le.addEventListener("click",()=>{if(!v)return;const L=t.state.params||{};t.navigate("match",{...L,matchMode:L.matchMode||i,deckId:g.id})}),(P=document.getElementById("cancel-deck-select"))==null||P.addEventListener("click",()=>{Ue(e),a("home")});const $=document.getElementById("deck-swipe-zone");if($){let L=0,k=0;$.addEventListener("touchstart",D=>{L=D.touches[0].clientX,k=D.touches[0].clientY},{passive:!0}),$.addEventListener("touchend",D=>{const oe=D.changedTouches[0].clientX-L,pe=D.changedTouches[0].clientY-k;Math.abs(oe)<40||Math.abs(oe)<Math.abs(pe)||(oe<0&&c<o.length-1?(c++,u()):oe>0&&c>0&&(c--,u()))},{passive:!0})}}u()}function Je(e,t=44,i=58,n=null){return Ae(e,{width:t,showStad:!!n,stadDef:n,used:e==null?void 0:e.used})}function ut(e,t,i){if(!(e!=null&&e.length))return"";const n=e.slice(0,5);let a='<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;overflow:hidden">';return n.forEach((o,r)=>{const s=o._line||o.job||"MIL";if(a+=Ae(o,{width:40,role:s,extraNote:o.boost||0}),r<n.length-1){const d=yt(o,n[r+1]);a+=`<div style="width:7px;height:3px;background:${d==="#ff3333"||d==="#cc2222"?"rgba(255,255,255,0.12)":d};border-radius:2px;flex-shrink:0;margin:0 1px"></div>`}}),i!==void 0&&(a+=`<div style="margin-left:6px;background:${t};color:${t==="#00ff88"?"#000":"#fff"};border-radius:6px;padding:3px 8px;font-size:15px;font-weight:900;flex-shrink:0">${i}</div>`),a+="</div>",a}function It(e,t,i,n,a=310,o=310,r=[],s=null){const d=Mt[t]||{},l=Pi(t)||si[t]||[],c={},u=["ATT","MIL","DEF","GK"];for(const b of u)(e[b]||[]).forEach((v,$)=>{c[`${b}${$+1}`]=v});function g(b){const h=d[b];return h?{x:h.x*a,y:h.y*o}:null}let m="";for(const[b,h]of l){const v=g(b),$=g(h);if(!v||!$)continue;const y=c[b],C=c[h],E=yt(y,C);E==="#00ff88"||E==="#FFD700"?(m+=`<line x1="${v.x.toFixed(1)}" y1="${v.y.toFixed(1)}" x2="${$.x.toFixed(1)}" y2="${$.y.toFixed(1)}"
        ...
        stroke="${E}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const f=Math.max(52,Math.round(a*.18)),p=Math.round(f*657/507);for(const[b,h]of Object.entries(c)){const v=g(b);if(!v||!h)continue;const $=b.replace(/[0-9]/g,""),y=r.includes(h.cardId),C=i==="attack"&&(["MIL","ATT"].includes($)||y)&&!h.used||i==="defense"&&["GK","DEF","MIL"].includes($)&&!h.used,E=n.includes(h.cardId);let F=h.boost||0;h.stadiumBonus&&(i==="attack"&&($==="ATT"||$==="MIL")||i==="defense"&&($==="GK"||$==="DEF"||$==="MIL")?F+=10:i||(F+=10));const N=Math.round(v.x-f/2),ee=Math.round(v.y-p/2);if(h.used){m+=`<image href="${`${typeof import.meta<"u"&&"/"||"/"}icons/carte-dos.png`}" x="${N}" y="${ee}" width="${f}" height="${p}" preserveAspectRatio="xMidYMid slice" class="match-used-hit" data-card-id="${h.cardId}" data-role="${$}" style="cursor:pointer"/>`;continue}const ie=Ae({...h,_evolution_bonus:0},{width:f,showStad:!0,stadDef:null,role:$,extraNote:F,_cardOffset:30}),le=E?"outline:3px solid #FFD700;outline-offset:2px;border-radius:8px;opacity:0.75;":"";m+=`<foreignObject x="${N-2}" y="${ee-30}" width="${f+8}" height="${p+60}" style="overflow:visible">
      <div xmlns="http://www.w3.org/1999/xhtml" style="${le}position:relative">
        ${ie}
      </div>
    </foreignObject>`,C&&(m+=`<rect x="${N}" y="${ee}" width="${f}" height="${p}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${E?"selected":""}" data-card-id="${h.cardId}" data-role="${$}" style="cursor:pointer"/>`)}const x=s!==null?s:Math.round(Math.max(f*.7,80));return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-x} ${-x} ${a+x*2} ${o+x*2}" width="100%" style="display:block;width:100%;margin:0 auto">
    ${m}
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    <div id="last-action-zone" style="background:rgba(0,0,0,0.3);flex-shrink:0;overflow:hidden;max-height:140px">
      ${(()=>{if(t.phase==="defense"&&t.pendingAttack){const D=t.pendingAttack;return`<div style="padding:5px 8px;background:rgba(180,30,30,0.2);border-left:3px solid #ff6b6b">
            ...
            ${ut((D.players||[]).map(oe=>({...oe,used:!1})),"#ff6b6b",D.total)}
            ...
            ${ut((D.players||[]).map(oe=>({...oe,used:!1})),"#00ff88",D.total)}
    ...
    ${(()=>{const k=window.innerWidth>=700,D=(z,M,R)=>{var Ce,je;const H=(t.gcDefs||[]).find(Fe=>Fe.name===z.gc_type),U={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[H==null?void 0:H.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",j={purple:"#b06ce0",light_blue:"#00d4ef"}[H==null?void 0:H.color]||"#b06ce0",O=(H==null?void 0:H.name)||z.gc_type,$e=(H==null?void 0:H.effect)||((Ce=Me[z.gc_type])==null?void 0:Ce.desc)||"",_e=H!=null&&H.image_url?`/icons/${H.image_url}`:null,we=((je=Me[z.gc_type])==null?void 0:je.icon)||"⚡",me=Math.round(R*.22),Le=Math.round(R*.22),ke=R-me-Le,he=O.length>12?7:9;return`<div class="gc-mini" data-gc-id="${z.id}" data-gc-type="${z.gc_type}"
        ...
        </div>`},oe=(z,M)=>{var R;return`<div id="boost-card"
          style="box-sizing:border-box;width:${z}px;height:${M}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(M*.04)}px;text-align:center;flex-shrink:0">
  ...
  <div id="match-history-panel">
    ...
    <div style="flex:1;overflow-y:auto;padding:12px 16px;display:flex;flex-direction:column;gap:6px">
      ${t.log.length===0?`<div style="text-align:center;padding:40px;color:rgba(255,255,255,0.3)">Aucune action pour l'instant</div>`:[...t.log].reverse().map(k=>{var D,oe,pe;if(k.type==="duel"){const de=k.isGoal,ae=k.homeScored?"#FFD700":de?"#ff6b6b":"rgba(255,255,255,0.3)",Ee=k.homeScored?"⚽ BUT !":de?"⚽ BUT IA !":(D=k.homePlayers)!=null&&D.length?"⚔️ Attaque":"🛡️ Défense";return`<div style="padding:8px;border-radius:8px;background:${de?"rgba(212,160,23,0.12)":"rgba(255,255,255,0.04)"};border-left:3px solid ${ae};margin-bottom:4px">
                <div style="font-size:9px;color:${ae};letter-spacing:1px;margin-bottom:5px;font-weight:700;text-transform:uppercase">${Ee}</div>
                ${(oe=k.homePlayers)!=null&&oe.length?`<div style="margin-bottom:3px">${ut(k.homePlayers,"rgba(255,255,255,0.7)",k.homeTotal)}</div>`:""}
    ...
    </div>`,(y=u.querySelector("#sub-close"))==null||y.addEventListener("click",()=>u.remove()),(C=u.querySelector("#out-up"))==null||C.addEventListener("click",()=>{s>0&&(s--,g())}),(E=u.querySelector("#out-down"))==null||E.addEventListener("click",()=>{s<o.length-1&&(s++,g())}),(F=u.querySelector("#in-up"))==null||F.addEventListener("click",()=>{l>0&&(l--,g())}),(N=u.querySelector("#in-down"))==null||N.addEventListener("click",()=>{l<r.length-1&&(l++,g())});const $=(ie,le,P,L)=>{const k=u.querySelector("#"+ie);if(!k)return;let D=0;k.addEventListener("touchstart",oe=>{D=oe.touches[0].clientY},{passive:!0}),k.addEventListener("touchend",oe=>{const pe=oe.changedTouches[0].clientY-D;if(Math.abs(pe)<30)return;const de=le();pe<0&&de<L-1?(P(de+1),g()):pe>0&&de>0&&(P(de-1),g())},{passive:!0})};$("in-panel",()=>l,ie=>l=ie,r.length),$("out-panel",()=>s,ie=>s=ie,o.length),(ee=u.querySelector("#sub-confirm"))==null||ee.addEventListener("click",ie=>{if(ie.preventDefault(),ie.stopPropagation(),c)return;c=!0;const le=o[s],P=r[l];if(!le||!P)return;let L=null,k=-1;for(const[oe,pe]of Object.entries(t.homeTeam)){const de=(pe||[]).findIndex(ae=>ae.cardId===le.cardId);if(de!==-1){L=oe,k=de;break}}if(k===-1||!L){wt("Erreur : joueur introuvable","rgba(180,0,0,0.9)"),u.remove();return}const D={...P,_line:L,_col:le._col||0,used:!1,boost:0};t.homeTeam[L].splice(k,1,D),t.usedSubIds||(t.usedSubIds=[]),t.usedSubIds.push(P.cardId),t.subsUsed++,t.selected=[],t.log.push({type:"sub",subSide:"home",clubName:t.clubName,outPlayer:{name:le.name,firstname:le.firstname,note:qe(le,L),portrait:Tt(le),job:le.job,country_code:le.country_code,rarity:le.rarity,clubName:le.clubName,clubLogo:le.clubLogo},inPlayer:{name:P.name,firstname:P.firstname,note:qe(P,L),portrait:Tt(P),job:P.job,country_code:P.country_code,rarity:P.rarity,clubName:P.clubName,clubLogo:P.clubLogo},text:`🔄 ${P.firstname} ${P.name} remplace ${le.firstname} ${le.name}`}),u.remove(),bo(le,P,()=>Te(e,t,i))})}document.body.appendChild(u),g()}function Ao(e,t,i,n,a){var f,p;const o=(n.gcDefs||[]).find(x=>x.name===t),r=Me[t]||{icon:"⚡",desc:"Carte spéciale."},s={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[o==null?void 0:o.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",d={purple:"#b06ce0",light_blue:"#00d4ef"}[o==null?void 0:o.color]||"#b06ce0",l=(o==null?void 0:o.name)||t,c=(o==null?void 0:o.effect)||r.desc,u=o!=null&&o.image_url?`/icons/${o.image_url}`:null,g=r.icon||"⚡",m=document.createElement("div");m.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",m.innerHTML=`
    ...
    <div style="text-align:center;padding:40px;color:#fff;max-width:360px">
      ...
      ${It(e.aiTeam,e.formation,null,[],Math.min(window.innerWidth-40,860),Math.round(Math.min(window.innerWidth-40,860)*1.1))}
    </div>`,`<button class="btn btn-primary" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`)}async function Ct(e,t,i,n,a={}){return rn(e,t,i,n,a.myGC||[],a.gcDefs||[],a.isRanked||!1,a.rankedData||null,a.stadiumDef||null,a.onMatchEnd||null,a.mlLeagueId||null,a.mlMatchId||null)}async function Bo(e,t,i){const{data:n}=await w.from("matches").select("home_id,away_id,mode,is_ranked").eq("id",i).single();if(!n){t.toast("Match introuvable","error"),t.navigate("home");return}const a=n.home_id===t.state.user.id;return rn(e,t,i,a,[],[],n.is_ranked||!1,null,null,null,null,null)}async function rn(e,t,i,n,a=[],o=[],r=!1,s=null,d=null,l=null,c=null,u=null){const{state:g,navigate:m,toast:f}=t,p=n?"p1":"p2",x=n?"p2":"p1",b=(a||[]).map(_=>_.id),h=(a||[]).map(_=>({id:_.id,gc_type:_.gc_type,_gcDef:_._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:v}=await w.from("matches").select("*").eq("id",i).single();if(!v){f("Match introuvable","error"),m("home");return}async function $(){var fe,xe;console.log("[PvP] buildGameState match:",{id:v.id,home_deck_id:v.home_deck_id,away_deck_id:v.away_deck_id,mode:v.mode,is_ranked:v.is_ranked});const[{data:_,error:T},{data:A,error:S},{data:I},{data:q}]=await Promise.all([w.rpc("get_deck_for_match",{p_deck_id:v.home_deck_id}),w.rpc("get_deck_for_match",{p_deck_id:v.away_deck_id}),w.from("users").select("id,pseudo,club_name").eq("id",v.home_id).single(),w.from("users").select("id,pseudo,club_name").eq("id",v.away_id).single()]);console.log("[PvP] get_deck_for_match p1:",T==null?void 0:T.message,"p2:",S==null?void 0:S.message,"p1D:",(fe=_==null?void 0:_.starters)==null?void 0:fe.length,"p2D:",(xe=A==null?void 0:A.starters)==null?void 0:xe.length);const B=Z=>{const be=Number(Z.evolution_bonus)||0;return{cardId:Z.card_id,position:Z.position,id:Z.id,firstname:Z.firstname,name:Z.surname_real,country_code:Z.country_code,club_id:Z.club_id,job:Z.job,job2:Z.job2,note_g:(Number(Z.note_g)||0)+(Z.job==="GK"||Z.job2==="GK"&&Number(Z.note_g)>0?be:0),note_d:(Number(Z.note_d)||0)+(Z.job==="DEF"||Z.job2==="DEF"&&Number(Z.note_d)>0?be:0),note_m:(Number(Z.note_m)||0)+(Z.job==="MIL"||Z.job2==="MIL"&&Number(Z.note_m)>0?be:0),note_a:(Number(Z.note_a)||0)+(Z.job==="ATT"||Z.job2==="ATT"&&Number(Z.note_a)>0?be:0),evolution_bonus:be,rarity:Z.rarity,skin:Z.skin,hair:Z.hair,hair_length:Z.hair_length,face:Z.face||null,clubName:Z.club_encoded_name||null,clubLogo:Z.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},G=((_==null?void 0:_.starters)||[]).map(Z=>B(Z)),W=((A==null?void 0:A.starters)||[]).map(Z=>B(Z)),X=(_==null?void 0:_.formation)||"4-4-2",J=(A==null?void 0:A.formation)||"4-4-2";let re=Rt(G,X),Q=Rt(W,J);const ce=((_==null?void 0:_.subs)||[]).map(Z=>B(Z)),se=((A==null?void 0:A.subs)||[]).map(Z=>B(Z)),ne=(_==null?void 0:_.stadium_def)||(n?d:null),ue=(A==null?void 0:A.stadium_def)||(n?null:d);return ne&&(re=zt(re,ne),Pt(ce,ne)),ue&&(Q=zt(Q,ue),Pt(se,ue)),{p1Team:re,p2Team:Q,p1Subs:ce,p2Subs:se,p1Formation:X,p2Formation:J,p1Name:(I==null?void 0:I.club_name)||(I==null?void 0:I.pseudo)||"Joueur 1",p2Name:(q==null?void 0:q.club_name)||(q==null?void 0:q.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:n?b:[],gc_p2:n?[]:b,gcCardsFull_p1:n?h:[],gcCardsFull_p2:n?[]:h,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:o||[],lastActionAt:new Date().toISOString()}}let y=v.game_state&&Object.keys(v.game_state).length?v.game_state:null;if(console.log("[PvP] init - amIHome:",n,"gameState exists:",!!y,"match.status:",v.status,"home_id:",v.home_id,"away_id:",v.away_id,"myId:",g.profile.id),!y)if(n){y=await $(),console.log("[PvP] home - gameState built, p1Team keys:",Object.keys((y==null?void 0:y.p1Team)||{}));const{data:_}=await w.from("matches").select("game_state").eq("id",i).single();!(_!=null&&_.game_state)||!Object.keys(_.game_state).length?await w.from("matches").update({game_state:y,turn_user_id:v.home_id}).eq("id",i):y=_.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>',console.log("[PvP] away - waiting for home to write game_state...");for(let _=0;_<30&&!y;_++){await new Promise(A=>setTimeout(A,400));const{data:T}=await w.from("matches").select("game_state").eq("id",i).single();T!=null&&T.game_state&&Object.keys(T.game_state).length&&(y=T.game_state),_%5===0&&console.log("[PvP] away - poll",_,"game_state:",!!(T!=null&&T.game_state))}if(!y){f("Erreur de synchronisation","error"),m("home");return}y.gc_p2=b,y.gcCardsFull_p2=h,await w.from("matches").update({game_state:y}).eq("id",i)}let C=!1,E=null,F=!1;const N=new Set,ee=new Set;async function ie(_){var J,re;try{w.removeChannel(le)}catch{}const T=y[p+"Score"]||0,A=y[x+"Score"]||0;let S,I;_.winner_id?(S=_.winner_id===g.profile.id,I=!1):_.forfeit?(S=T>A,I=!1):(I=T===A,S=T>A);let q="";if(r&&n)try{const{data:Q}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.home_id).single(),{data:ce}=await w.from("users").select("id,mmr,mmr_deviation,mmr_volatility,placement_matches").eq("id",v.away_id).single();if(Q&&ce){const se=S?1:I?.5:0,ne=1-se,ue=Q.placement_matches<10,fe=ce.placement_matches<10,xe=computeGlicko2(Q.mmr,Q.mmr_deviation,Q.mmr_volatility,ce.mmr,ce.mmr_deviation,se===1?1:se===0?0:.5,ue),Z=computeGlicko2(ce.mmr,ce.mmr_deviation,ce.mmr_volatility,Q.mmr,Q.mmr_deviation,ne===1?1:ne===0?0:.5,fe);await w.rpc("update_mmr_after_ranked",{p_match_id:i,p_winner_id:I?null:S?v.home_id:v.away_id,p_home_id:v.home_id,p_away_id:v.away_id,p_home_delta:xe.delta,p_away_delta:Z.delta,p_home_new_rd:xe.newRd,p_away_new_rd:Z.newRd,p_home_new_vol:xe.newSigma,p_away_new_vol:Z.newSigma});const be=xe.delta,ze=xe.newMmr,Se=getTier(ze),Ne=be>=0?"+":"",Ge=be>=0?"#4caf50":"#ff6b6b",Pe=getTier(Q.mmr);q=`
            <div style="background:rgba(255,255,255,0.08);border-radius:14px;padding:14px 20px;text-align:center;min-width:220px">
              ...
              ${Se.id!==Pe.id?`<div style="font-size:20px;font-weight:900;color:${Se.color}">
                    ${ze>Q.mmr?"📈":"📉"} ${Pe.emoji} ${Pe.label} → ${Se.emoji} ${Se.label}
                  </div>
            ...
            </div>`}}catch(Q){console.error("[Ranked] MMR update error:",Q)}(J=document.getElementById("pvp-end-overlay"))==null||J.remove();const B=document.createElement("div");B.id="pvp-end-overlay",B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;padding:24px;text-align:center;overflow-y:auto";const G=I?"🤝":S?"🏆":"😞",W=I?"MATCH NUL":S?"VICTOIRE !":"DÉFAITE",X=I?"#fff":S?"#FFD700":"#ff6b6b";B.innerHTML=`
      ...
      <div style="font-size:18px">${y[p+"Name"]} ${T} – ${A} ${y[x+"Name"]}</div>
      ${_.forfeit?`<div style="font-size:13px;color:rgba(255,255,255,0.5)">${S?"L'adversaire a quitté":"Perdu par forfait"}</div>`:""}
      ${q}
      <button id="pvp-end-home" style="margin-top:8px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">${r?"⚔️ Retour au Ranked":"Retour à l'accueil"}</button>`,document.body.appendChild(B),(re=B.querySelector("#pvp-end-home"))==null||re.addEventListener("click",()=>{B.remove(),Ue(e),m(r?"ranked":"home")})}const le=w.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},_=>{const T=_.new;try{if(T.status==="finished"||T.forfeit){if(C)return;C=!0,E&&(clearInterval(E),E=null),T.game_state&&(y=T.game_state),ie(T);return}if(T.game_state){const A=y;y=T.game_state;const S=y._lastGC;if(S&&S.seq&&!ee.has(S.seq)&&(ee.add(S.seq),S.by!==p)){Y(S.type,S.by,()=>ae());return}const I=A[p+"Score"]||0,q=A[x+"Score"]||0,B=y[p+"Score"]||0,G=y[x+"Score"]||0,W=B>I,X=G>q;if((W||X)&&!N.has(y.round)){N.add(y.round);const J=[...y.log||[]].reverse().find(Q=>Q.isGoal),re=((J==null?void 0:J.homePlayers)||[]).map(Q=>({name:Q.name,note:Q.note,portrait:Q.portrait,job:Q.job}));st(re,B,G,W,()=>ae());return}ae()}}catch(A){console.error("[PvP] crash:",A)}}).subscribe();async function P(_){Object.assign(y,_),y.lastActionAt=new Date().toISOString();const{error:T}=await w.from("matches").update({game_state:y}).eq("id",i);T&&f("Erreur de synchronisation","error");try{ae()}catch(A){console.error("[PvP] renderPvpScreen crash:",A)}}async function L(){if(C)return;C=!0,E&&(clearInterval(E),E=null);const _=n?v.away_id:v.home_id,T=n?"p2":"p1",A=n?"p1":"p2",S={...y,[T+"Score"]:3,[A+"Score"]:0,phase:"finished"};try{await w.from("matches").update({status:"finished",forfeit:!0,winner_id:_,home_score:S.p1Score||0,away_score:S.p2Score||0,game_state:S}).eq("id",i)}catch{}try{w.removeChannel(le)}catch{}setTimeout(()=>{Ue(e),m("home")},800)}const k={BOOST_STAT:({value:_=1,count:T=1,roles:A=[]},S,I)=>{const q=S[p+"Team"],B=Object.entries(q).filter(([G])=>!A.length||A.includes(G)).flatMap(([G,W])=>W.filter(X=>!X.used).map(X=>({...X,_line:G})));if(!B.length){S.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),I(S);return}D(B,T,`Choisir ${T} joueur(s) à booster (+${_})`,G=>{G.forEach(W=>{const X=(q[W._line]||[]).find(J=>J.cardId===W.cardId);X&&(X.boost=(X.boost||0)+_,S.log.push({text:`⚡ +${_} sur ${X.name}`,type:"info"}))}),S[p+"Team"]=q,I(S)})},DEBUFF_STAT:({value:_=1,count:T=1,roles:A=[],target:S="ai"},I,q)=>{const B=S==="home"?p:x,G=I[B+"Team"],W=S==="home"?"allié":"adverse",X=Object.entries(G).filter(([J])=>!A.length||A.includes(J)).flatMap(([J,re])=>re.map(Q=>({...Q,_line:J})));if(!X.length){I.log.push({text:`🎯 Aucun joueur ${W}`,type:"info"}),q(I);return}D(X,T,`Choisir ${T} joueur(s) ${W}(s) (-${_})`,J=>{J.forEach(re=>{const Q=(G[re._line]||[]).find(ce=>ce.cardId===re.cardId);Q&&(Q.boost=(Q.boost||0)-_,I.log.push({text:`🎯 -${_} sur ${Q.name}`,type:"info"}))}),I[B+"Team"]=G,q(I)})},GRAY_PLAYER:({count:_=1,roles:T=[],target:A="ai"},S,I)=>{const q=A==="home"?p:x,B=S[q+"Team"],G=A==="home"?"allié":"adverse",W=Object.entries(B).filter(([X])=>!T.length||T.includes(X)).flatMap(([X,J])=>J.filter(re=>!re.used).map(re=>({...re,_line:X})));if(!W.length){S.log.push({text:`❌ Aucun joueur ${G}`,type:"info"}),I(S);return}D(W,_,`Choisir ${_} joueur(s) ${G}(s) à exclure`,X=>{const J="usedCardIds_"+q,re=new Set(S[J]||[]);X.forEach(Q=>{const ce=(B[Q._line]||[]).find(se=>se.cardId===Q.cardId);ce&&(ce.used=!0,re.add(Q.cardId),S.log.push({text:`❌ ${ce.name} exclu !`,type:"info"}))}),S[J]=[...re],S[q+"Team"]=B,I(S)})},REVIVE_PLAYER:({count:_=1,roles:T=[]},A,S)=>{const I=A[p+"Team"],q=Object.entries(I).filter(([B])=>!T.length||T.includes(B)).flatMap(([B,G])=>G.filter(W=>W.used).map(W=>({...W,_line:B})));if(!q.length){A.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),S(A);return}D(q,_,`Choisir ${_} joueur(s) à ressusciter`,B=>{B.forEach(G=>{const W=(I[G._line]||[]).find(X=>X.cardId===G.cardId);W&&(W.used=!1,A.log.push({text:`💫 ${W.name} ressuscité !`,type:"info"}))}),A[p+"Team"]=I,S(A)})},REMOVE_GOAL:({},_,T)=>{const A=x+"Score";_[A]>0?(_[A]--,_.log.push({text:"🚫 Dernier but annulé !",type:"info"})):_.log.push({text:"🚫 Aucun but à annuler",type:"info"}),T(_)},ADD_GOAL_DRAW:({},_,T)=>{_[p+"Score"]===_[x+"Score"]?(_[p+"Score"]++,_.log.push({text:"🎯 But bonus !",type:"info"})):_.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),T(_)},ADD_SUB:({value:_=1},T,A)=>{T.maxSubs=(T.maxSubs||3)+_,T.log.push({text:`🔄 +${_} remplacement(s)`,type:"info"}),A(T)},CUSTOM:({},_,T)=>T(_)};function D(_,T,A,S){const I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let q=[];function B(){var W,X;const G=_.map(J=>{const re={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[J._line]||"#555",Q=qe(J,J._line)+(J.boost||0),se=q.find(ue=>ue.cardId===J.cardId)?"#FFD700":"rgba(255,255,255,0.25)",ne=J.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${J.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${se};background:${re};overflow:hidden;cursor:pointer;${ne}">
        ...
        <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
          ...
          <span style="font-size:12px;color:rgba(255,255,255,0.5)">${q.length}/${T}</span>
        ...
        <div style="padding:12px;background:rgba(0,0,0,0.4);flex-shrink:0">
          <button id="pp-confirm" ${q.length===0?'disabled style="opacity:0.4"':""} style="width:100%;padding:13px;border-radius:10px;border:none;background:#7a28b8;color:#fff;font-size:15px;font-weight:900;cursor:pointer">
            ✅ Confirmer (${q.length}/${T})
          </button>
        </div>`,(W=I.querySelector("#pp-close"))==null||W.addEventListener("click",()=>I.remove()),I.querySelectorAll(".pp-item").forEach(J=>{J.addEventListener("click",()=>{const re=J.dataset.cid,Q=_.find(se=>se.cardId===re),ce=q.findIndex(se=>se.cardId===re);Q&&(ce>-1?q.splice(ce,1):q.length<T&&q.push(Q),B())})}),(X=I.querySelector("#pp-confirm"))==null||X.addEventListener("click",()=>{I.remove(),S(q)})}B(),document.body.appendChild(I)}async function oe(_,T){const S=(y["gcCardsFull_"+p]||[]).find(G=>G.id===_),I=(S==null?void 0:S._gcDef)||(y.gcDefs||[]).find(G=>{var W;return G.name===T||((W=G.name)==null?void 0:W.toLowerCase().trim())===(T==null?void 0:T.toLowerCase().trim())}),q=[...y["usedGc_"+p]||[],_],B={type:T,by:p,seq:(y._gcAnimSeq||0)+1};ee.add(B.seq),Y(T,p,async()=>{if(I!=null&&I.effect_type&&I.effect_type!=="CUSTOM"){const W=k[I.effect_type];if(W){const X={...y};W(I.effect_params||{},X,async J=>{J["usedGc_"+p]=q,J._lastGC=B,J._gcAnimSeq=B.seq,await P(J)});return}}const G={...y};switch(T){case"Remplacement+":G.maxSubs=(G.maxSubs||3)+1,G.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const W=x+"Score";G[W]>0&&(G[W]--,G.log.push({text:"🚫 But annulé",type:"info"}));break}}G["usedGc_"+p]=q,G._lastGC=B,G._gcAnimSeq=B.seq,await P(G)})}function pe(_,T){const A="usedCardIds_"+_,S=new Set(y[A]||[]);T.forEach(I=>S.add(I)),y[A]=[...S]}function de(){for(const _ of["p1","p2"]){const T=new Set(y["usedCardIds_"+_]||[]),A=y[_+"Team"];if(A)for(const S of["GK","DEF","MIL","ATT"])(A[S]||[]).forEach(I=>{I.used=T.has(I.cardId)})}}function ae(){var Ve,nt,yi,bi,hi,vi;if(y.phase==="reveal")return Ee();if(y.phase==="midfield")return V();if(y.phase==="finished")return Fe();const _=y[p+"Team"],T=y[x+"Team"];de();const A=y[p+"Score"],S=y[x+"Score"],I=y[p+"Name"],q=y[x+"Name"],B=y.phase===p+"-attack",G=y.phase===p+"-defense",W=Array.isArray(y["selected_"+p])?y["selected_"+p]:[],X=W.map(te=>te.cardId),J=window.innerWidth>=700,re=y[p+"Subs"]||[],Q=y["usedSubIds_"+p]||[],ce=re.filter(te=>!Q.includes(te.cardId)),se=y["gcCardsFull_"+p]||[],ne=y["usedGc_"+p]||[],ue=se.filter(te=>!ne.includes(te.id)),fe=y.boostOwner===p&&!y.boostUsed,xe=!["GK","DEF","MIL","ATT"].some(te=>(T[te]||[]).some(ge=>!ge.used)),Z=[..._.MIL||[],..._.ATT||[]].filter(te=>!te.used),be=B&&xe&&Z.length===0?[..._.GK||[],..._.DEF||[]].filter(te=>!te.used).map(te=>te.cardId):[];function ze(te,ge,Ie){var $i,Ei;const ye=te._gcDef,ot={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ye==null?void 0:ye.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",lt={purple:"#b06ce0",light_blue:"#00d4ef"}[ye==null?void 0:ye.color]||"#b06ce0",ht=(ye==null?void 0:ye.name)||te.gc_type,vt=(ye==null?void 0:ye.effect)||(($i=Me[te.gc_type])==null?void 0:$i.desc)||"",wi=ye!=null&&ye.image_url?`/icons/${ye.image_url}`:null,un=((Ei=Me[te.gc_type])==null?void 0:Ei.icon)||"⚡",_i=Math.round(Ie*.22),ki=Math.round(Ie*.22),Vt=Ie-_i-ki,fn=ht.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${te.id}" data-gc-type="${te.gc_type}"
      ...
      </div>`}function Se(te,ge){return`<div id="pvp-boost-card"
    ...
    </div>`,Re=B?"attack":G?"defense":"idle",tt=`<div style="overflow:hidden;min-width:0;flex:1;min-height:0;display:flex;flex-direction:column" id="match-field">
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
      ...
      </div>`;function De(){const te=e.querySelector(".match-screen");if(!te)return;const ge=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);te.style.height=ge+"px",te.style.minHeight=ge+"px",te.style.maxHeight=ge+"px",te.style.overflow="hidden";const Ie=e.querySelector("#mobile-action-bar"),ye=e.querySelector("#mobile-play-area");Ie&&ye&&(ye.style.paddingBottom=Ie.offsetHeight+"px")}if(De(),setTimeout(De,120),setTimeout(De,400),F||(F=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",De),window.visualViewport.addEventListener("scroll",De)),window.addEventListener("resize",De)),function(){const ge=e.querySelector(".terrain-wrapper svg");ge&&(ge.removeAttribute("width"),ge.removeAttribute("height"),ge.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",ge.setAttribute("viewBox","-26 -26 352 352"),ge.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(te=>{te.addEventListener("click",()=>{if(!B&&!G)return;const ge=te.dataset.cardId,Ie=te.dataset.role,ye=(_[Ie]||[]).find(vt=>vt.cardId===ge);if(!ye||ye.used)return;const ot=be.includes(ge);if(B&&!["MIL","ATT"].includes(Ie)&&!ot)return;Array.isArray(y["selected_"+p])||(y["selected_"+p]=[]);const lt=y["selected_"+p],ht=lt.findIndex(vt=>vt.cardId===ge);ht>-1?lt.splice(ht,1):lt.length<3&&lt.push({...ye,_role:Ie}),ae()})}),e.querySelectorAll(".match-used-hit").forEach(te=>{te.addEventListener("click",()=>R(te.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(te=>{te.addEventListener("click",()=>R())}),(Ve=e.querySelector("#pvp-sub-open"))==null||Ve.addEventListener("click",()=>R()),e.querySelectorAll(".pvp-gc-mini").forEach(te=>{te.addEventListener("click",()=>z(te.dataset.gcId,te.dataset.gcType))}),(nt=e.querySelector("#pvp-boost-card"))==null||nt.addEventListener("click",()=>M()),(yi=e.querySelector("#pvp-action"))==null||yi.addEventListener("click",te=>{B?te.currentTarget.dataset.pass==="1"||!ke(p)?O():$e():G&&_e()}),(bi=e.querySelector("#pvp-quit"))==null||bi.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&L()}),(hi=e.querySelector("#pvp-view-opp"))==null||hi.addEventListener("click",()=>U()),(vi=e.querySelector("#pvp-toggle-history"))==null||vi.addEventListener("click",()=>j()),E&&(clearInterval(E),E=null),(B||G)&&!C){let te=30,ge=!1;const Ie=()=>document.getElementById("pvp-timer"),ye=()=>{Ie()&&(Ie().textContent=te+"s",Ie().style.color=ge?"#ff4444":"#fff")};ye(),E=setInterval(()=>{te--,te<0?ge?(clearInterval(E),E=null,B&&!ke(p)?O():L()):(ge=!0,te=15,ye()):ye()},1e3)}}function Ee(){He(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
    ...
    </div>`,p==="p1"&&setTimeout(async()=>{await P({phase:"midfield"})},5e3)}let K=!1;function V(){if(K)return;const _=y[p+"Team"].MIL||[],T=y[x+"Team"].MIL||[],A=milScore(_)+milLinks(_),S=milScore(T)+milLinks(T),I=A>=S;function q(se,ne,ue){return`<div id="duel-row-${ue}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      ${q(_,y[p+"Name"]||"Vous","me")}
      <div style="display:flex;flex-direction:column;align-items:center;gap:2px;margin:4px 0">
        <div id="pvp-score-me" style="font-size:48px;font-weight:900;color:#D4A017;transition:all .5s ease">0</div>
        <div id="pvp-vs" style="font-size:14px;color:rgba(255,255,255,.4);letter-spacing:3px;opacity:0">VS</div>
        <div id="pvp-score-opp" style="font-size:48px;font-weight:900;color:rgba(255,255,255,.7);transition:all .5s ease">0</div>
      </div>
      ${q(T,y[x+"Name"]||"Adversaire","opp")}
      <div id="duel-shock" style="position:absolute;left:50%;top:50%;width:120px;height:120px;border-radius:50%;border:6px solid #FFD700;opacity:0;pointer-events:none"></div>
      <div id="pvp-duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center,rgba(10,61,30,.4),rgba(10,61,30,.92))"></div>
    </div>`;const B=(se,ne)=>e.querySelectorAll(se).forEach((ue,fe)=>{setTimeout(()=>{ue.style.opacity="1",ue.style.transform="translateY(0) scale(1)"},ne+fe*90)});B(".duel-card-me",150),B(".duel-card-opp",500),setTimeout(()=>e.querySelectorAll(".duel-link").forEach((se,ne)=>setTimeout(()=>{se.style.opacity="1"},ne*70)),900),setTimeout(()=>{const se=e.querySelector("#pvp-vs");se&&(se.style.opacity="1",se.style.animation="vsFlash .5s ease"),e.querySelectorAll(".duel-score-line").forEach(ne=>ne.style.opacity="1")},1250);function G(se,ne,ue){const fe=document.getElementById(se);if(!fe)return;const xe=performance.now(),Z=be=>{const ze=Math.min(1,(be-xe)/ue);fe.textContent=Math.round(ne*(1-Math.pow(1-ze,3))),ze<1?requestAnimationFrame(Z):fe.textContent=ne};requestAnimationFrame(Z)}setTimeout(()=>{G("pvp-score-me",A,800),G("pvp-score-opp",S,800)},1500);const W=y.p1Team.MIL||[],X=y.p2Team.MIL||[],J=milScore(W)+milLinks(W),re=milScore(X)+milLinks(X),Q=J>=re?"p1":"p2";let ce=y.boostValue;ce==null&&(ce=tn(),y.boostValue=ce,y.boostOwner=Q,y.boostUsed=!1),K=!0,setTimeout(()=>{const se=e.querySelector("#duel-row-"+(I?"me":"opp")),ne=e.querySelector("#duel-row-"+(I?"opp":"me")),ue=document.getElementById("pvp-score-me"),fe=document.getElementById("pvp-score-opp"),xe=I?ue:fe,Z=I?fe:ue;xe&&(xe.style.fontSize="80px",xe.style.color=I?"#FFD700":"#ff6b6b",xe.style.animation="duelPulse .5s ease"+(I?",duelGlow 1.5s ease infinite .5s":"")),Z&&(Z.style.opacity="0.25"),setTimeout(()=>{se&&(se.style.animation="winnerSlam .5s cubic-bezier(.4,0,.7,1) forwards",se.style.zIndex="5"),setTimeout(()=>{const be=document.getElementById("duel-shock");be&&(be.style.animation="shockwave .5s ease-out forwards"),ne&&(ne.style.animation="crushSquash .45s ease-in forwards"),navigator.vibrate&&navigator.vibrate([40,30,60])},320),setTimeout(()=>{var Ne;const be=document.getElementById("pvp-duel-finale");if(!be)return;const ze=y.boostOwner===p?'<div style="background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:3px solid #cdeffd;border-radius:18px;padding:20px 34px;text-align:center;animation:boostFlipIn .7s cubic-bezier(.34,1.56,.64,1) both;box-shadow:0 10px 36px rgba(135,206,235,.5)"><div style="font-size:10px;color:rgba(0,0,0,.6);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;font-weight:700">Carte Boost obtenue</div><div style="font-size:46px;line-height:1">⚡</div><div style="font-size:50px;font-weight:900;color:#063;line-height:1.1">+'+ce+`</div><div style="font-size:10px;color:rgba(0,0,0,.55);margin-top:4px">Applicable sur n'importe quel joueur</div></div>`:"",Se=p==="p1"?'<button id="pvp-start-match" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">▶ Commencer le match</button>':`<div style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin-top:8px;animation:fadeUp .4s ease both">⏳ En attente de l'adversaire...</div>`;be.innerHTML='<div style="font-size:22px;font-weight:900;color:#fff;text-align:center;animation:fadeUp .4s ease both;text-shadow:0 2px 12px rgba(0,0,0,.5)">'+(I?"⚽ "+y[p+"Name"]+"<br>gagne le milieu et attaque !":"😔 "+y[x+"Name"]+"<br>gagne l'engagement et attaque !")+"</div>"+ze+Se,be.style.transition="opacity .45s ease",be.style.opacity="1",be.style.pointerEvents="auto",(Ne=document.getElementById("pvp-start-match"))==null||Ne.addEventListener("click",async()=>{const Ge=Q;await P({phase:Ge+"-attack",attacker:Ge,round:1,boostValue:ce,boostUsed:!1,boostOwner:Ge})})},600)},700)},2800)}function Y(_,T,A){var ne,ue;const S=(y.gcDefs||[]).find(fe=>{var xe;return fe.name===_||((xe=fe.name)==null?void 0:xe.toLowerCase().trim())===(_==null?void 0:_.toLowerCase().trim())}),I={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[S==null?void 0:S.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",q={purple:"#b06ce0",light_blue:"#00d4ef"}[S==null?void 0:S.color]||"#b06ce0",B=(S==null?void 0:S.name)||_,G=(S==null?void 0:S.effect)||((ne=Me[_])==null?void 0:ne.desc)||"",W=S!=null&&S.image_url?`/icons/${S.image_url}`:null,X=((ue=Me[_])==null?void 0:ue.icon)||"⚡",re=T===p?"Vous":y[T+"Name"]||"Adversaire",Q=document.createElement("div");Q.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",Q.innerHTML=`
      <style>
      ...
      </div>`,document.body.appendChild(re),(se=re.querySelector("#pvp-gc-back"))==null||se.addEventListener("click",()=>re.remove()),(ne=re.querySelector("#pvp-gc-use"))==null||ne.addEventListener("click",()=>{re.remove(),oe(_,T)})}function M(){var S;const _=y[p+"Team"],T=Object.entries(_).flatMap(([I,q])=>(q||[]).filter(B=>!B.used).map(B=>({...B,_line:I})));if(!T.length)return;const A=document.createElement("div");A.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden",A.innerHTML=`
      <div style="padding:12px 16px;background:rgba(255,255,255,0.08);display:flex;align-items:center;gap:10px;flex-shrink:0">
        <div style="flex:1;font-size:14px;font-weight:700;color:#fff">⚡ Choisir un joueur pour +${y.boostValue}</div>
        <button id="bp-close" style="background:none;border:none;color:rgba(255,255,255,0.5);font-size:22px;cursor:pointer">✕</button>
      </div>
      <div style="flex:1;overflow-y:auto;padding:12px;display:flex;flex-wrap:wrap;gap:8px;align-content:flex-start">
        ${T.map(I=>{const q={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[I._line]||"#555",B=qe(I,I._line)+(I.boost||0);return`<div class="bp-item" data-cid="${I.cardId}" style="width:80px;border-radius:8px;border:2px solid rgba(255,255,255,0.25);background:${q};overflow:hidden;cursor:pointer">
      ...
      </div>`,document.body.appendChild(A),(S=A.querySelector("#bp-close"))==null||S.addEventListener("click",()=>A.remove()),A.querySelectorAll(".bp-item").forEach(I=>{I.addEventListener("click",async()=>{const q=I.dataset.cid,B=T.find(W=>W.cardId===q);if(!B)return;const G=(_[B._line]||[]).find(W=>W.cardId===q);G&&(G.boost=(G.boost||0)+y.boostValue),A.remove(),await P({[p+"Team"]:_,boostUsed:!0})})})}function R(_=null){var ce,se;if(!(y.phase===p+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const A=y[p+"Team"],S=y["usedSubIds_"+p]||[],I=y.maxSubs||3;if(S.length>=I){f(`Maximum ${I} remplacements atteint`,"warning");return}const q=Object.entries(A).flatMap(([ne,ue])=>(ue||[]).filter(fe=>fe.used).map(fe=>({...fe,_line:ne}))),B=(y[p+"Subs"]||[]).filter(ne=>!S.includes(ne.cardId));if(!q.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!B.length){f("Aucun remplaçant disponible","warning");return}let G=Math.max(0,q.findIndex(ne=>ne.cardId===_));const W=((ce=q[G])==null?void 0:ce._line)||((se=q[G])==null?void 0:se.job);let X=Math.max(0,B.findIndex(ne=>ne.job===W)),J=!1;const re=document.createElement("div");re.id="pvp-sub-overlay",re.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function Q(){var ze,Se,Ne,Ge,Pe,bt;const ne=q[G],ue=B[X],fe=Math.min(130,Math.round((window.innerWidth-90)/2)),xe=Math.round(fe*1.35),Z=Be=>`background:rgba(255,255,255,0.12);border:none;color:${Be?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${Be?"default":"pointer"};flex-shrink:0`;re.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      <div style="flex:1;display:flex;gap:0;overflow:hidden">
        <div id="pin-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px;border-right:1px solid rgba(255,255,255,0.08)">
          ...
          <button id="pin-down" style="${Z(X>=B.length-1)}" ${X>=B.length-1?"disabled":""}>▼</button>
        ...
        <div id="pout-panel" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px 6px">
          ...
          <button id="pout-down" style="${Z(G>=q.length-1)}" ${G>=q.length-1?"disabled":""}>▼</button>
          <div style="font-size:10px;color:rgba(255,255,255,0.35)">${G+1}/${q.length}</div>
        </div>
      </div>
      <div style="padding:12px 16px;background:rgba(0,0,0,0.4);flex-shrink:0">
        <button id="psub-confirm" style="width:100%;padding:14px;border-radius:10px;border:none;background:#1A6B3C;color:#fff;font-size:15px;font-weight:900;cursor:pointer">✅ Confirmer</button>
      </div>`,(ze=re.querySelector("#psub-close"))==null||ze.addEventListener("click",()=>re.remove()),(Se=re.querySelector("#pout-up"))==null||Se.addEventListener("click",()=>{G>0&&(G--,Q())}),(Ne=re.querySelector("#pout-down"))==null||Ne.addEventListener("click",()=>{G<q.length-1&&(G++,Q())}),(Ge=re.querySelector("#pin-up"))==null||Ge.addEventListener("click",()=>{X>0&&(X--,Q())}),(Pe=re.querySelector("#pin-down"))==null||Pe.addEventListener("click",()=>{X<B.length-1&&(X++,Q())});const be=(Be,Oe,Re,tt)=>{const Ke=re.querySelector("#"+Be);if(!Ke)return;let it=0;Ke.addEventListener("touchstart",De=>{it=De.touches[0].clientY},{passive:!0}),Ke.addEventListener("touchend",De=>{const Ve=De.changedTouches[0].clientY-it;if(Math.abs(Ve)<30)return;const nt=Oe();Ve<0&&nt<tt-1?(Re(nt+1),Q()):Ve>0&&nt>0&&(Re(nt-1),Q())},{passive:!0})};be("pin-panel",()=>X,Be=>X=Be,B.length),be("pout-panel",()=>G,Be=>G=Be,q.length),(bt=re.querySelector("#psub-confirm"))==null||bt.addEventListener("click",async Be=>{if(Be.preventDefault(),Be.stopPropagation(),J)return;J=!0;const Oe=q[G],Re=B[X];if(!Oe||!Re)return;const tt=Oe._line,Ke=(A[tt]||[]).findIndex(Ve=>Ve.cardId===Oe.cardId);if(Ke===-1){f("Erreur : joueur introuvable","error"),re.remove();return}const it={...Re,_line:tt,position:Oe.position,used:!1,boost:0};A[tt].splice(Ke,1,it);const De=[...S,Re.cardId];re.remove(),H(Oe,Re,async()=>{await P({[p+"Team"]:A,[x+"Team"]:y[x+"Team"],["usedSubIds_"+p]:De})})})}document.body.appendChild(re),Q()}function H(_,T,A){const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"},I=document.createElement("div");I.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:850;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;overflow:hidden;cursor:pointer";const q=(W,X,J)=>`<div style="text-align:center">
      ...
      </div>`,document.body.appendChild(T),(A=T.querySelector("#pvp-hist-close"))==null||A.addEventListener("click",()=>T.remove())}async function O(){if(y.phase!==p+"-attack")return;const _=p==="p1"?"p2":"p1",T=(y.round||0)+1,A=[...y.log||[]];A.push({type:"info",text:`⏭️ ${y[p+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const S=he(y),I=ke(_),q=S||!I?"finished":_+"-attack";await P({["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:q,attacker:_,round:T,log:A}),q==="finished"&&await je(y)}async function $e(){const _=y[p+"Team"],T=!["GK","DEF","MIL","ATT"].some(q=>(y[x+"Team"][q]||[]).some(B=>!B.used)),A=(y["selected_"+p]||[]).map(q=>{const B=(_[q._role]||[]).find(se=>se.cardId===q.cardId)||q,G=T&&["GK","DEF"].includes(q._role),W=_[q._role]||[],X=W.findIndex(se=>se.cardId===q.cardId),J=xt(W.length),re=X>=0?J[X]:B._col??1,Q=y.stadiumDef||y.homeStadiumDef||null,ce=B.stadiumBonus||Q&&(Q.club_id&&String(B.club_id)===String(Q.club_id)||Q.country_code&&B.country_code===Q.country_code)||!1;return{...B,_line:q._role,_col:re,stadiumBonus:ce,...G?{note_a:Math.max(1,Number(B.note_a)||0)}:{}}});if(!A.length)return;const S=pi(A,y.modifiers[p]||{});pe(p,A.map(q=>q.cardId)),A.forEach(q=>{const B=(_[q._role]||[]).find(G=>G.cardId===q.cardId);B&&(B.used=!0)}),y["selected_"+p]=[],ae();const I=[...y.log||[]];if(T){const q=(y[p+"Score"]||0)+1,B=A.map(re=>histPlayer(re));I.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:B,homeTotal:S.total,aiTotal:0});const G=(y.round||0)+1,W=p==="p1"?"p2":"p1",X={...y,[p+"Team"]:_,[p+"Score"]:q},J=he(X);N.add(G),st(B,q,y[x+"Score"]||0,!0,async()=>{await P({[p+"Team"]:_,[p+"Score"]:q,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:J?"finished":W+"-attack",attacker:W,round:G,log:I}),J&&await je({...y,[p+"Score"]:q})});return}I.push({type:"pending",text:`⚔️ ${y[p+"Name"]} attaque (${S.total})`}),await P({[p+"Team"]:_,[x+"Team"]:y[x+"Team"],pendingAttack:{...S,players:A,side:p},["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},phase:x+"-defense",log:I})}async function _e(){const _=y[p+"Team"],T=(y["selected_"+p]||[]).map(ne=>{const ue=(_[ne._role]||[]).find(ze=>ze.cardId===ne.cardId)||ne,fe=_[ne._role]||[],xe=fe.findIndex(ze=>ze.cardId===ne.cardId),Z=xt(fe.length),be=xe>=0?Z[xe]:ue._col??1;return{...ue,_line:ne._role,_col:be}}),A=ui(T,y.modifiers[p]||{});pe(p,T.map(ne=>ne.cardId)),T.forEach(ne=>{const ue=(_[ne._role]||[]).find(fe=>fe.cardId===ne.cardId);ue&&(ue.used=!0)}),y["selected_"+p]=[],ae();const S=fi(y.pendingAttack.total,A.total,y.modifiers[p]||{}),I=y.pendingAttack.side,q=S==="attack"||(S==null?void 0:S.goal),B=I==="p1"?"p2":"p1",G=(y.round||0)+1,W=(y.pendingAttack.players||[]).map(ne=>histPlayer(ne)),X=[...y.log||[]];X.push({type:"duel",isGoal:q,homeScored:q&&I===p,text:q?`⚽ BUT de ${y[I+"Name"]} ! (${y.pendingAttack.total} vs ${A.total})`:`✋ Attaque stoppée (${y.pendingAttack.total} vs ${A.total})`,homePlayers:W,aiPlayers:T.map(ne=>histPlayer(ne)),homeTotal:y.pendingAttack.total,aiTotal:A.total});const J=q?(y[I+"Score"]||0)+1:y[I+"Score"]||0,re={...y,[p+"Team"]:_,[I+"Score"]:J},Q=he(re),ce=Q?"finished":B+"-attack",se=async()=>{await P({[p+"Team"]:_,[x+"Team"]:y[x+"Team"],[I+"Score"]:J,["selected_"+p]:[],modifiers:{...y.modifiers,[p]:{}},pendingAttack:null,phase:ce,attacker:B,round:G,log:X}),(ce==="finished"||Q)&&await je({...y,[I+"Score"]:J})};if(q){const ne=I===p,ue=ne?J:y[p+"Score"]||0,fe=ne?y[x+"Score"]||0:J;N.add(G),st(W,ue,fe,ne,se)}else await se()}function we(_){return["MIL","ATT"].some(T=>(_[T]||[]).some(A=>!A.used))}function me(_){return["GK","DEF","MIL","ATT"].some(T=>(_[T]||[]).some(A=>!A.used))}function Le(_){return me(_)&&!we(_)}function ke(_){const T=y[_+"Team"],A=y[(_==="p1"?"p2":"p1")+"Team"];return!!(we(T)||!me(A)&&Le(T))}function he(_){const T=["MIL","ATT"].some(X=>(_.p1Team[X]||[]).some(J=>!J.used)),A=["MIL","ATT"].some(X=>(_.p2Team[X]||[]).some(J=>!J.used)),S=me(_.p1Team),I=me(_.p2Team);return!T&&!(!I&&S)&&(!A&&!(!S&&I))}function Ce(_){const T=_.p1Score||0,A=_.p2Score||0;return T===A?null:T>A?v.home_id:v.away_id}async function je(_){try{const T=Ce(_),A=T?v.home_id===T?v.away_id:v.home_id:null;await w.from("matches").update({status:"finished",winner_id:T,home_score:_.p1Score||0,away_score:_.p2Score||0}).eq("id",i),T&&A&&updateEvolutiveCards(T,A).catch(()=>{})}catch(T){console.error("[PvP] finishMatch:",T)}}function Fe(){var I;const _=y[p+"Score"],T=y[x+"Score"],A=_>T,S=_===T;He(e),e.innerHTML=`
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${u.map(P=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #f5f5f5">
            <div style="width:36px;height:36px;border-radius:50%;background:${P.club_color2||gt};display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:900;color:${P.club_color1||"#fff"}">${(P.pseudo||"?").slice(0,2).toUpperCase()}</div>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${g.map((P,L)=>{const k=f>0&&r.status==="finished"?L===0?Math.floor(f*.7):L===1?Math.floor(f*.2):L===2?Math.floor(f*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${P.userId===o?"background:#f0fdf4;":""}">
              ...
              <td style="text-align:center;color:${P.goalDiff>=0?gt:"#cc2222"}">${P.goalDiff>=0?"+":""}${P.goalDiff}</td>
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,r.status==="active"?r.current_day-1:r.current_day)},(P,L)=>L+1).reverse().map(P=>{const L=(d||[]).filter(k=>k.matchday===P);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${P}</div>${L.map(k=>Di(k,u,o,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    </div>`}function g(p){var F,N,ee,ie;const x=(F=p.card)==null?void 0:F.player;if(!x)return"";const b=((N=p.card)==null?void 0:N.evolution_bonus)||0,h=ct(x,x.job,b),v=x.job2?ct(x,x.job2,b):0,$=p.status==="sold",y=x.country_code?`https://flagsapi.com/${x.country_code.slice(0,2).toUpperCase()}/flat/64.png`:null,C=Dt[x.job]||"#bbb",E=x.job2?Dt[x.job2]||"#bbb":null;return`<div class="card-panel" style="display:flex;align-items:center;gap:10px;padding:10px 12px;overflow:hidden;${$?"opacity:0.7":""}">
      ${y?`<img src="${y}" style="width:32px;height:24px;object-fit:cover;border-radius:3px;flex-shrink:0">`:'<span style="font-size:20px">🌍</span>'}
      ${(ee=x.clubs)!=null&&ee.logo_url?`<img src="${x.clubs.logo_url}" style="width:28px;height:28px;object-fit:contain;flex-shrink:0">`:""}
      <div style="display:flex;gap:4px;flex-shrink:0">
        <div style="width:36px;height:36px;border-radius:6px;background:#111;border:2px solid ${C};display:flex;align-items:center;justify-content:center">
    ...
    <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      `).join(""):'<div style="text-align:center;color:var(--gray-600);padding:40px">Aucun manager.</div>'}else{const b=r||[];f.innerHTML=b.length>0?b.map((h,v)=>{const $=di(h.mmr??1e3),y=(h.ranked_wins||0)+(h.ranked_losses||0)+(h.ranked_draws||0),C=y>0?Math.round((h.ranked_wins||0)/y*100):0,E=h.id===i.profile.id,F=(h.placement_matches||0)<10;return`
