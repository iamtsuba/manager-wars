const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/formation-links-DbBZzHQV.js","assets/formation-links-B6ttdMxQ.css"])))=>i.map(i=>d[i]);
import{s as T,F as wi,r as st,j as Ot,l as Oi,m as ot,n as Ai,h as Pt,o as mn,T as si,k as xn,p as yn,b as bn}from"./formation-links-DbBZzHQV.js";const hn="/";function Li(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,p,s,o,h;const a=n==="login";e.innerHTML=`
    <div style="
