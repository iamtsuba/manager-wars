...
import{s as k,F as hi,h as Pt,j as Yi,l as at,i as Ao,k as zo,b as So}from"./formation-links-Dnttc-Cp.js";const Lo="/";function Li(e,{navigate:t,toast:i}){let s="login";const l=()=>{var a,c,f,n,o,m;const d=s==="login";e.innerHTML=`
  ...
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    </div>`:""}`,`<button class="btn btn-ghost" onclick="document.getElementById('modal-overlay').classList.add('hidden')">Fermer</button>`),(A=document.getElementById("direct-sell-form-btn"))==null||A.addEventListener("click",async()=>{if(!confirm(`Vendre 1 carte Formation ${n} pour ${Vt.toLocaleString("fr")} crédits ? Cette action est irréversible.`))return;const I=b.find(q=>!q.is_for_sale)||b[0];if(!I){d("Aucune carte à vendre","error");return}await k.from("market_listings").delete().eq("card_id",I.id),await k.from("transfer_history").delete().eq("card_id",I.id);const{error:L}=await k.from("cards").delete().eq("id",I.id);if(L){d(L.message,"error");return}await k.from("users").update({credits:(l.profile.credits||0)+Vt}).eq("id",l.profile.id),await f(),d(`+${Vt.toLocaleString("fr")} crédits ! Carte vendue.`,"success"),a(),c("collection")}),(r=document.getElementById("market-sell-form-btn"))==null||r.addEventListener("click",async()=>{const I=parseInt(document.getElementById("sell-price-form").value);if(!I||I<1){d("Prix invalide","error");return}await k.from("cards").update({is_for_sale:!0,sale_price:I}).eq("id",e.id),await k.from("market_listings").insert({seller_id:l.profile.id,card_id:e.id,price:I}),d("Carte mise en vente sur le marché !","success"),a(),c("collection")}),(p=document.getElementById("cancel-sell-form-btn"))==null||p.addEventListener("click",async()=>{await k.from("cards").update({is_for_sale:!1,sale_price:null}).eq("id",e.id),await k.from("market_listings").update({status:"cancelled"}).eq("card_id",e.id).eq("status","active"),d("Annonce retirée","success"),a(),c("collection")})}async function Fi(e,t,i,s){var we,Ae,Ie,xe,X,ne,ge;const{state:l,toast:d,openModal:a,closeModal:c,navigate:f,refreshProfile:n}=s,o=e.player,m=t.filter(J=>J.player.id===o.id),b=m.length,g=e.evolution_bonus||0,A=Math.max((Number(o.note_g)||0)+(o.job==="GK"||o.job2==="GK"?g:0),(Number(o.note_d)||0)+(o.job==="DEF"||o.job2==="DEF"?g:0),(Number(o.note_m)||0)+(o.job==="MIL"||o.job2==="MIL"?g:0),(Number(o.note_a)||0)+(o.job==="ATT"||o.job2==="ATT"?g:0)),r=o.rarity||"normal",{data:p}=await k.from("sell_price_configs").select("*").eq("rarity",r).lte("note_min",A).gte("note_max",A).order("note_min",{ascending:!1}).limit(1);((we=p==null?void 0:p[0])==null?void 0:we.price)??Yo[r];const I=o.rarity!=="legende",L=ao(o),q=((o.rarity==="pepite"||o.rarity==="papyte")&&e.current_note!=null?e.current_note:At(o,o.job))+g,H=o.rarity==="pepite"||o.rarity==="papyte",D=o.job2?(H?_i(e,ro(o.job2)):At(o,o.job2))+(At(o,o.job2)>0?g:0):null,G=qt[o.job]||"#1A6B3C",M=o.job2?qt[o.job2]:null,U=no[o.rarity]||"#ccc",oe=Ei[o.country_code]||o.country_code||"",de=e.evolution_bonus||0,W=q+de,K=D||0,P=K>0?K+de:0,re=m.map(J=>J.id);let pe={};if(re.length){const{data:J}=await k.from("transfer_history").select("card_id, club_name, manager_name, source, price, transferred_at").in("card_id",re).order("transferred_at",{ascending:!0});(J||[]).forEach(Z=>{pe[Z.card_id]||(pe[Z.card_id]=[]),pe[Z.card_id].push(Z)})}const ye=J=>{const Z=J.transferred_at?new Date(J.transferred_at).toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}):"",V=J.source==="booster"?"Booster":J.price?J.price.toLocaleString("fr"):"—";return`
...
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(xe=document.getElementById("close-detail"))==null||xe.addEventListener("click",c);let ve=new Set;const _e=()=>{const J=ve.size,Z=document.getElementById("sell-action-panel");if(!Z)return;Z.style.display=J>0?"block":"none",document.getElementById("sell-selected-count").textContent=J;const V=document.getElementById("evolve-btn");V&&(V.textContent=`⬆️ Évoluer ${J>1?"(+"+J+")":""}`)};document.querySelectorAll(".expl-check").forEach(J=>{J.addEventListener("change",()=>{const Z=J.dataset.id;J.checked?ve.add(Z):ve.delete(Z);const V=J.closest(".exemplaire-row");V&&(V.style.borderColor=J.checked?"#1A6B3C":"#eee"),_e()})}),document.querySelectorAll(".exemplaire-row").forEach(J=>{J.addEventListener("click",Z=>{if(Z.target.closest("button")||Z.target.tagName==="INPUT")return;const V=J.querySelector(".expl-check");V&&!V.disabled&&(V.checked=!V.checked,V.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(J=>{J.addEventListener("click",Z=>{Z.stopPropagation();const V=document.querySelector(`.expl-hist[data-hist="${J.dataset.idx}"]`);V&&(V.style.display=V.style.display==="none"?"flex":"none")})}),(X=document.getElementById("evolve-btn"))==null||X.addEventListener("click",async()=>{if(b<=1)return;const J=[...ve];if(!J.length)return;if(ve.has(e.id)){const be=document.createElement("div");be.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",be.innerHTML=`
      ...
      ${m.length>0?m.map(r=>{var D,G;const p=r.player,I=card.evolution_bonus||0,L=(a==="GK"?p.note_g:a==="DEF"?p.note_d:a==="MIL"?p.note_m:p.note_a)+(a===p.job||a===p.job2?I:0),q=ii(p),H={normal:"#ccc",pepite:"#D4A017",papyte:"#909090",legende:"#7a28b8"}[p.rarity];return`<div class="player-option" data-card-id="${r.id}"
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
              ...
              ${(D=p.clubs)!=null&&D.logo_url?`<img src="${p.clubs.logo_url}" style="width:18px;height:18px;object-fit:contain">`:`<span style="font-size:10px;color:var(--gray-600)">${((G=p.clubs)==null?void 0:G.encoded_name)||"—"}</span>`}
  ...
  `,document.body.appendChild(l);let d=!1;const a=document.getElementById("pack-cut-zone"),c=document.getElementById("pack-blade");let f=!1;const n=P=>P.touches&&P.touches[0]?P.touches[0].clientX:P.clientX;function o(P){d||(f=!0,c.style.opacity="1",m(P))}function m(P){if(!f||d)return;const re=a.getBoundingClientRect(),pe=n(P)-re.left,ye=Math.max(0,Math.min(1,pe/re.width));c.style.width=ye*re.width+"px",ye>=.82&&g()}function b(){d||(f=!1,c.style.transition="width .2s ease, opacity .2s ease",c.style.width="0",c.style.opacity="0",setTimeout(()=>{d||(c.style.transition="")},220))}function g(){var re;if(d)return;d=!0,f=!1,c.style.width="100%",c.style.opacity="1",(re=document.getElementById("cut-flash"))==null||re.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const P=document.getElementById("cut-hint");P&&(P.style.opacity="0"),a.classList.add("pack-cut"),setTimeout(()=>{c.style.opacity="0",document.getElementById("pack-phase").style.display="none",I(0)},620)}a.addEventListener("pointerdown",o),window.addEventListener("pointermove",m),window.addEventListener("pointerup",b),a.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",m,{passive:!0}),window.addEventListener("touchend",b);let A=0,r=!1;const p=new Set;function I(P){A=P,document.getElementById("reveal-phase").style.display="flex",L(),q(P,0),U()}function L(){const P=document.getElementById("card-dots");P&&(P.innerHTML=e.map((re,pe)=>`<div class="card-dot" data-i="${pe}" style="width:8px;height:8px;border-radius:50%;background:${pe===A?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),P.querySelectorAll(".card-dot").forEach(re=>re.addEventListener("click",()=>D(parseInt(re.dataset.i)))))}function q(P,re){var xe;const pe=e[P],ye=document.getElementById("card-counter"),Le=document.getElementById("card-track");ye&&(ye.textContent=`Carte ${P+1} / ${e.length}`);const ve=document.getElementById("reveal-btns");ve&&(ve.style.display=P===e.length-1?"flex":"none");const _e=pe.card_type==="player"&&((xe=pe.player)==null?void 0:xe.rarity)==="legende",we=!p.has(P);p.add(P);let Ae=0;if(pe.card_type==="player"&&pe.player){const X=pe.player,ne=X.job||"ATT";Ae=Number(ne==="GK"?X.note_g:ne==="DEF"?X.note_d:ne==="MIL"?X.note_m:X.note_a)||0}const Ie=X=>{Le.innerHTML=`
  ...
  <div class="page" style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0a3d1e,#063015);padding:24px">
    ...
    <div id="gc-screen-wrap" style="position:relative;display:flex;flex-direction:column;height:100%;overflow:hidden;background:linear-gradient(180deg,#0a1628,#1a0a2e)">
      ...
      card:cards(id,card_type,formation,stadium_id,evolution_bonus,
        player:players(id,firstname,surname_encoded,country_code,club_id,job,job2,
          note_g,note_d,note_m,note_a,rarity,skin,hair,hair_length,
          clubs(encoded_name,logo_url)))`).in("deck_id",a).order("slot_order"),f=[...new Set((c||[]).filter(b=>{var g,A;return((g=b.card)==null?void 0:g.card_type)==="stadium"&&((A=b.card)==null?void 0:A.stadium_id)}).map(b=>b.card.stadium_id))],n={};if(f.length){const{data:b}=await k.from("stadium_definitions").select("id,name,club_id,country_code,image_url,club:clubs(encoded_name,logo_url)").in("id",f);(b||[]).forEach(g=>{n[g.id]=g}),(c||[]).forEach(g=>{var A,r;((A=g.card)==null?void 0:A.card_type)==="stadium"&&((r=g.card)!=null&&r.stadium_id)&&(g.card._stadiumDef=n[g.card.stadium_id]||null)})}let o=0;function m(){var D,G,M,U,oe,de,N;const b=d[o],g=(c||[]).filter(W=>W.deck_id===b.id),A=g.filter(W=>{var K;return W.is_starter&&((K=W.card)==null?void 0:K.player)}).map(W=>mi(W.card,W.position)),r=g.find(W=>{var K;return((K=W.card)==null?void 0:K.card_type)==="formation"}),p=b.formation||((D=r==null?void 0:r.card)==null?void 0:D.formation)||"4-4-2";let I=A.length>=11?yt(A,p):null,L=((G=b.stadium_card)==null?void 0:G.stadium_def)||null;L&&I&&(I=Ht(I,L));const q=A.length>=11;et(e),e.style.height="100%",e.style.overflow="hidden",e.innerHTML=`
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;height:${m}px;background:rgba(255,255,255,0.93);display:flex;align-items:center;justify-content:space-between;padding:0 3px;z-index:2">
      ...
      ${l?`<img src="${l}" style="width:${m-4}px;height:${m-4}px;object-fit:contain">`:e!=null&&e.clubName?`<span style="font-size:${Math.max(4,m-8)}px;font-weight:700;color:#333">${(e.clubName||"").slice(0,3).toUpperCase()}</span>`:""}
        ...
        stroke="${de}" stroke-width="3.5" stroke-linecap="round" opacity="0.7"/>`}const g=48,A=64,r=13,p=16,I={normal:"#aaaaaa",pepite:"#D4A017",pépite:"#D4A017",papyte:"#111111",legende:"#7a28b8",légende:"#7a28b8"};for(const[H,D]of Object.entries(n)){const G=m(H);if(!G||!D)continue;const M=H.replace(/[0-9]/g,""),U=Mt[M]||"#555",oe=a.includes(D.cardId),de=i==="attack"&&(["MIL","ATT"].includes(M)||oe)&&!D.used||i==="defense"&&["GK","DEF","MIL"].includes(M)&&!D.used,N=s.includes(D.cardId);let W;i==="attack"?W=oe?Math.max(1,Number(D.note_a)||0):M==="MIL"?Number(D.note_m)||0:Number(D.note_a)||0:i==="defense"?W=M==="GK"?Number(D.note_g)||0:M==="MIL"?Number(D.note_m)||0:Number(D.note_d)||0:W=Number(M==="GK"?D.note_g:M==="DEF"?D.note_d:M==="MIL"?D.note_m:D.note_a)||0,W=W+(D.boost||0),D.stadiumBonus&&(i==="attack"&&(M==="ATT"||M==="MIL")||i==="defense"&&(M==="GK"||M==="DEF"||M==="MIL")?W+=10:i||(W+=10));const K=(G.x-g/2).toFixed(1),P=(G.y-A/2).toFixed(1),re=I[D==null?void 0:D.rarity]||I.normal;if(D.used){const Ae=typeof import.meta<"u"&&"/"||"/",xe=`${typeof window<"u"&&((q=window.location)==null?void 0:q.origin)||""}${Ae}icons/carte-dos.png`.replace(/([^:])\/\//g,"$1/");b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="#161616"/>`,b+=`<image href="${xe}" xlink:href="${xe}" x="${K}" y="${P}" width="${g}" height="${A}" preserveAspectRatio="xMidYMid slice"/>`,b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="none" stroke="${re}" stroke-width="2" opacity="0.7"/>`,b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="rgba(0,0,0,0.01)" class="match-used-hit" data-card-id="${D.cardId}" data-role="${M}" style="cursor:pointer"/>`;continue}const pe=N?.45:1,ye=N?"#FFD700":re,Le=N?3:(D==null?void 0:D.rarity)==="legende"||(D==null?void 0:D.rarity)==="légende"||(D==null?void 0:D.rarity)==="pepite"||(D==null?void 0:D.rarity)==="pépite"?2.5:2,ve=A-r-p;b+=`<defs><clipPath id="cp-${H}"><rect x="${K}" y="${(G.y-A/2+r).toFixed(1)}" width="${g}" height="${ve}"/></clipPath></defs>`,b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="${U}" opacity="${pe}"/>`;const _e=Pe(D);_e&&(b+=`<image href="${_e}" xlink:href="${_e}" x="${K}" y="${(G.y-A/2+r).toFixed(1)}" width="${g}" height="${ve}" clip-path="url(#cp-${H})" preserveAspectRatio="xMidYMin slice"/>`),b+=`<rect x="${K}" y="${P}" width="${g}" height="${r}" rx="4" fill="rgba(255,255,255,0.92)"/>`,b+=`<text x="${G.x.toFixed(1)}" y="${(G.y-A/2+8.5).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="6.5" font-weight="900" fill="#111" font-family="Arial Black,Arial">${(D.name||"").slice(0,9)}</text>`;const we=(G.y+A/2-p).toFixed(1);b+=`<rect x="${K}" y="${we}" width="${g}" height="${p}" fill="rgba(255,255,255,0.92)"/>`;{const Ae=Zt(D.country_code);Ae?b+=`<image href="${Ae}" xlink:href="${Ae}" x="${(G.x-20).toFixed(1)}" y="${(G.y+A/2-p+3).toFixed(1)}" width="13" height="10" preserveAspectRatio="xMidYMid slice"/>`:b+=`<text x="${(G.x-13).toFixed(1)}" y="${(G.y+A/2-p/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="10">${bo(D.country_code)}</text>`;const Ie=D.stadiumBonus?"#E87722":"#111";b+=`<text x="${G.x.toFixed(1)}" y="${(G.y+A/2-p/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="12" font-weight="900" fill="${Ie}" font-family="Arial Black">${W}</text>`;const xe=yo(D);xe?b+=`<image href="${xe}" xlink:href="${xe}" x="${(G.x+g/2-14).toFixed(1)}" y="${(G.y+A/2-p+2).toFixed(1)}" width="12" height="12" preserveAspectRatio="xMidYMid meet"/>`:D.clubName&&(b+=`<text x="${(G.x+14).toFixed(1)}" y="${(G.y+A/2-p/2).toFixed(1)}" text-anchor="middle" dominant-baseline="central" font-size="5.5" font-weight="700" fill="#333">${(D.clubName||"").slice(0,3).toUpperCase()}</text>`),D.stadiumBonus&&(b+=`<rect x="${(G.x-g/2).toFixed(1)}" y="${(G.y-A/2).toFixed(1)}" width="${g}" height="${A}" rx="5" fill="none" stroke="#E87722" stroke-width="2" opacity="0.8"/>`)}b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="${N?"rgba(255,255,255,0.12)":"none"}" stroke="${ye}" stroke-width="${Le}" opacity="${pe}"/>`,de&&(b+=`<rect x="${K}" y="${P}" width="${g}" height="${A}" rx="5" fill="rgba(0,0,0,0.01)" class="match-slot-hit ${N?"selected":""}" data-card-id="${D.cardId}" data-role="${M}" style="cursor:pointer"/>`)}const L=38;return`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${-L} ${-L} ${l+L*2} ${d+L*2}" width="100%" style="display:block;width:100%;max-width:440px;margin:0 auto">
    ${b}
  ...
  <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
    ...
    <div id="duel-finale" style="position:fixed;inset:0;z-index:200;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px;opacity:0;pointer-events:none;background:radial-gradient(circle at center, rgba(10,61,30,0.4), rgba(10,61,30,0.92))"></div>
          ...
          <button id="start-match-btn" style="margin-top:6px;padding:18px 46px;border-radius:14px;border:none;background:#1A6B3C;color:#fff;font-size:18px;font-weight:900;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,0.4);animation:fadeUp .4s ease both;animation-delay:.45s;opacity:0">
            ▶ Commencer le match
          </button>`,D.style.transition="opacity .45s ease",D.style.opacity="1",D.style.pointerEvents="auto",(G=document.getElementById("start-match-btn"))==null||G.addEventListener("click",A))},600)},700)},2800)}function zn(e){if(e.type==="duel"&&(e.homeTotal!=null||e.aiTotal!=null)){const t=(e.homeTotal||0)>=(e.aiTotal||0);return`
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(d);let c=!1;const f=()=>{c||(c=!0,d.remove(),setTimeout(()=>l(),50))};d.addEventListener("click",f),setTimeout(f,3500)}async function Bt(e,t,i){var o,m;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:s}=i,l=t.homeScore>t.aiScore,d=t.homeScore===t.aiScore,a=l?"victoire":d?"nul":"defaite",c=Uo(t.mode,a);t.matchId&&await k.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:l?s.profile.id:null,home_credits_reward:c,played_at:new Date().toISOString()}).eq("id",t.matchId);const f={credits:(s.profile.credits||0)+c,matches_played:(s.profile.matches_played||0)+1};l?f.wins=(s.profile.wins||0)+1:d?f.draws=(s.profile.draws||0)+1:f.losses=(s.profile.losses||0)+1,await k.from("users").update(f).eq("id",s.profile.id),await i.refreshProfile();const n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",n.innerHTML=`
    ...
    <style>@keyframes mmspin{to{transform:rotate(360deg)}}</style>`;const A=async(H=!0)=>{b=!0,g&&(k.removeChannel(g),g=null),H&&await k.rpc("cancel_matchmaking",{p_user_id:n.profile.id}).catch(()=>{})};(q=document.getElementById("mm-cancel"))==null||q.addEventListener("click",async()=>{try{await A(!0)}catch{}We(e),o("home")});const r=async(H,D,G)=>{if(b)return;b=!0,g&&(k.removeChannel(g),g=null);const M=document.getElementById("mm-status");M&&(M.textContent="Adversaire trouvé !"),await new Promise(U=>setTimeout(U,600)),e.isConnected&&wo(e,t,H,G,a,c)},{data:p,error:I}=await k.rpc("try_matchmake",{p_user_id:n.profile.id,p_deck_id:i});if(I||!(p!=null&&p.success)){m("Erreur de matchmaking","error"),We(e),o("home");return}if(p.matched){r(p.match_id,p.opponent_id,!1);return}const L=document.getElementById("mm-status");L&&(L.textContent="En attente d'un autre joueur..."),g=k.channel("matchmaking-"+n.profile.id).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matchmaking_queue",filter:`user_id=eq.${n.profile.id}`},H=>{const D=H.new;D.status==="matched"&&D.match_id&&r(D.match_id,D.matched_with,!0)}).subscribe()}async function Pn(e,t,i){const{state:s,navigate:l,toast:d}=t;try{(k.getChannels?k.getChannels():[]).forEach(n=>{const o=n.topic||"";(o.includes("matchmaking")||o.includes("pvp-match")||o.includes("friend-invite"))&&k.removeChannel(n)})}catch{}const{data:a}=await k.from("matches").select("home_id, away_id, status").eq("id",i).single();if(!a){d("Match introuvable","error"),l("home");return}if(a.status==="finished"){d("Ce match est terminé","info"),l("home");return}const c=a.home_id===s.profile.id;wo(e,t,i,c,[],[])}async function wo(e,t,i,s,l=[],d=[]){const{state:a,navigate:c,toast:f}=t,n=s?"p1":"p2",o=s?"p2":"p1",m=(l||[]).map(j=>j.id),b=(l||[]).map(j=>({id:j.id,gc_type:j.gc_type,_gcDef:j._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await k.from("matches").select("*").eq("id",i).single();if(!g){f("Match introuvable","error"),c("home");return}async function A(){const[{data:j},{data:B},{data:w},{data:E}]=await Promise.all([k.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),k.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),k.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),k.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),u=T=>{const S=Number(T.evolution_bonus)||0;return{cardId:T.card_id,position:T.position,id:T.id,firstname:T.firstname,name:T.surname_encoded,country_code:T.country_code,club_id:T.club_id,job:T.job,job2:T.job2,note_g:(Number(T.note_g)||0)+(T.job==="GK"||T.job2==="GK"&&Number(T.note_g)>0?S:0),note_d:(Number(T.note_d)||0)+(T.job==="DEF"||T.job2==="DEF"&&Number(T.note_d)>0?S:0),note_m:(Number(T.note_m)||0)+(T.job==="MIL"||T.job2==="MIL"&&Number(T.note_m)>0?S:0),note_a:(Number(T.note_a)||0)+(T.job==="ATT"||T.job2==="ATT"&&Number(T.note_a)>0?S:0),evolution_bonus:S,rarity:T.rarity,skin:T.skin,hair:T.hair,hair_length:T.hair_length,clubName:T.club_encoded_name||null,clubLogo:T.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},x=((j==null?void 0:j.starters)||[]).map(T=>u(T)),y=((B==null?void 0:B.starters)||[]).map(T=>u(T)),h=(j==null?void 0:j.formation)||"4-4-2",v=(B==null?void 0:B.formation)||"4-4-2";let _=yt(x,h),z=yt(y,v);const $=((j==null?void 0:j.subs)||[]).map(T=>u(T));return stadiumDef&&s&&(_=Ht(_,stadiumDef),oi($,stadiumDef)),{p1Team:_,p2Team:z,p1Subs:$,p2Subs:((B==null?void 0:B.subs)||[]).map(T=>u(T)),p1Formation:h,p2Formation:v,p1Name:(w==null?void 0:w.club_name)||(w==null?void 0:w.pseudo)||"Joueur 1",p2Name:(E==null?void 0:E.club_name)||(E==null?void 0:E.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?m:[],gc_p2:s?[]:m,gcCardsFull_p1:s?b:[],gcCardsFull_p2:s?[]:b,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!r)if(s){r=await A();const{data:j}=await k.from("matches").select("game_state").eq("id",i).single();!(j!=null&&j.game_state)||!Object.keys(j.game_state).length?await k.from("matches").update({game_state:r,turn_user_id:g.home_id}).eq("id",i):r=j.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let j=0;j<30&&!r;j++){await new Promise(w=>setTimeout(w,400));const{data:B}=await k.from("matches").select("game_state").eq("id",i).single();B!=null&&B.game_state&&Object.keys(B.game_state).length&&(r=B.game_state)}if(!r){f("Erreur de synchronisation","error"),c("home");return}r.gc_p2=m,r.gcCardsFull_p2=b,await k.from("matches").update({game_state:r}).eq("id",i)}let p=!1,I=null,L=!1;const q=new Set,H=new Set;function D(j){var _,z;try{k.removeChannel(G)}catch{}const B=r[n+"Score"]||0,w=r[o+"Score"]||0;let E,u;j.winner_id?(E=j.winner_id===a.profile.id,u=!1):j.forfeit?(E=B>w,u=!1):(u=B===w,E=B>w),(_=document.getElementById("pvp-end-overlay"))==null||_.remove();const x=document.createElement("div");x.id="pvp-end-overlay",x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const y=u?"🤝":E?"🏆":"😞",h=u?"MATCH NUL":E?"VICTOIRE !":"DÉFAITE",v=u?"#fff":E?"#FFD700":"#ff6b6b";x.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(x),(z=x.querySelector("#pvp-end-home"))==null||z.addEventListener("click",()=>{x.remove(),We(e),c("home")})}const G=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},j=>{const B=j.new;try{if(B.status==="finished"||B.forfeit){if(p)return;p=!0,I&&(clearInterval(I),I=null),B.game_state&&(r=B.game_state),D(B);return}if(B.game_state){const w=r;r=B.game_state;const E=r._lastGC;if(E&&E.seq&&!H.has(E.seq)&&(H.add(E.seq),E.by!==n)){ve(E.type,E.by,()=>P());return}const u=w[n+"Score"]||0,x=w[o+"Score"]||0,y=r[n+"Score"]||0,h=r[o+"Score"]||0,v=y>u,_=h>x;if((v||_)&&!q.has(r.round)){q.add(r.round);const z=[...r.log||[]].reverse().find(T=>T.isGoal),$=((z==null?void 0:z.homePlayers)||[]).map(T=>({name:T.name,note:T.note,portrait:T.portrait,job:T.job}));Le($,y,h,v,()=>P());return}P()}}catch(w){console.error("[PvP] crash:",w)}}).subscribe();async function M(j){Object.assign(r,j),r.lastActionAt=new Date().toISOString();const{error:B}=await k.from("matches").update({game_state:r}).eq("id",i);B&&f("Erreur de synchronisation","error");try{P()}catch(w){console.error("[PvP] renderPvpScreen crash:",w)}}async function U(){if(p)return;p=!0,I&&(clearInterval(I),I=null);const j=s?g.away_id:g.home_id,B=s?"p2":"p1",w=s?"p1":"p2",E={...r,[B+"Score"]:3,[w+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:j,home_score:E.p1Score||0,away_score:E.p2Score||0,game_state:E}).eq("id",i)}catch{}try{k.removeChannel(G)}catch{}setTimeout(()=>{We(e),c("home")},800)}const oe={BOOST_STAT:({value:j=1,count:B=1,roles:w=[]},E,u)=>{const x=E[n+"Team"],y=Object.entries(x).filter(([h])=>!w.length||w.includes(h)).flatMap(([h,v])=>v.filter(_=>!_.used).map(_=>({..._,_line:h})));if(!y.length){E.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),u(E);return}de(y,B,`Choisir ${B} joueur(s) à booster (+${j})`,h=>{h.forEach(v=>{const _=(x[v._line]||[]).find(z=>z.cardId===v.cardId);_&&(_.boost=(_.boost||0)+j,E.log.push({text:`⚡ +${j} sur ${_.name}`,type:"info"}))}),E[n+"Team"]=x,u(E)})},DEBUFF_STAT:({value:j=1,count:B=1,roles:w=[],target:E="ai"},u,x)=>{const y=E==="home"?n:o,h=u[y+"Team"],v=E==="home"?"allié":"adverse",_=Object.entries(h).filter(([z])=>!w.length||w.includes(z)).flatMap(([z,$])=>$.map(T=>({...T,_line:z})));if(!_.length){u.log.push({text:`🎯 Aucun joueur ${v}`,type:"info"}),x(u);return}de(_,B,`Choisir ${B} joueur(s) ${v}(s) (-${j})`,z=>{z.forEach($=>{const T=(h[$._line]||[]).find(S=>S.cardId===$.cardId);T&&(T.boost=(T.boost||0)-j,u.log.push({text:`🎯 -${j} sur ${T.name}`,type:"info"}))}),u[y+"Team"]=h,x(u)})},GRAY_PLAYER:({count:j=1,roles:B=[],target:w="ai"},E,u)=>{const x=w==="home"?n:o,y=E[x+"Team"],h=w==="home"?"allié":"adverse",v=Object.entries(y).filter(([_])=>!B.length||B.includes(_)).flatMap(([_,z])=>z.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){E.log.push({text:`❌ Aucun joueur ${h}`,type:"info"}),u(E);return}de(v,j,`Choisir ${j} joueur(s) ${h}(s) à exclure`,_=>{const z="usedCardIds_"+x,$=new Set(E[z]||[]);_.forEach(T=>{const S=(y[T._line]||[]).find(C=>C.cardId===T.cardId);S&&(S.used=!0,$.add(T.cardId),E.log.push({text:`❌ ${S.name} exclu !`,type:"info"}))}),E[z]=[...$],E[x+"Team"]=y,u(E)})},REVIVE_PLAYER:({count:j=1,roles:B=[]},w,E)=>{const u=w[n+"Team"],x=Object.entries(u).filter(([y])=>!B.length||B.includes(y)).flatMap(([y,h])=>h.filter(v=>v.used).map(v=>({...v,_line:y})));if(!x.length){w.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),E(w);return}de(x,j,`Choisir ${j} joueur(s) à ressusciter`,y=>{y.forEach(h=>{const v=(u[h._line]||[]).find(_=>_.cardId===h.cardId);v&&(v.used=!1,w.log.push({text:`💫 ${v.name} ressuscité !`,type:"info"}))}),w[n+"Team"]=u,E(w)})},REMOVE_GOAL:({},j,B)=>{const w=o+"Score";j[w]>0?(j[w]--,j.log.push({text:"🚫 Dernier but annulé !",type:"info"})):j.log.push({text:"🚫 Aucun but à annuler",type:"info"}),B(j)},ADD_GOAL_DRAW:({},j,B)=>{j[n+"Score"]===j[o+"Score"]?(j[n+"Score"]++,j.log.push({text:"🎯 But bonus !",type:"info"})):j.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),B(j)},ADD_SUB:({value:j=1},B,w)=>{B.maxSubs=(B.maxSubs||3)+j,B.log.push({text:`🔄 +${j} remplacement(s)`,type:"info"}),w(B)},CUSTOM:({},j,B)=>B(j)};function de(j,B,w,E){const u=document.createElement("div");u.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let x=[];function y(){var v,_;const h=j.map(z=>{const $={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[z._line]||"#555",T=je(z,z._line)+(z.boost||0),C=x.find(R=>R.cardId===z.cardId)?"#FFD700":"rgba(255,255,255,0.25)",F=z.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${z.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${C};background:${$};overflow:hidden;cursor:pointer;${F}">
        ...
        </div>`,(v=u.querySelector("#pp-close"))==null||v.addEventListener("click",()=>u.remove()),u.querySelectorAll(".pp-item").forEach(z=>{z.addEventListener("click",()=>{const $=z.dataset.cid,T=j.find(C=>C.cardId===$),S=x.findIndex(C=>C.cardId===$);T&&(S>-1?x.splice(S,1):x.length<B&&x.push(T),y())})}),(_=u.querySelector("#pp-confirm"))==null||_.addEventListener("click",()=>{u.remove(),E(x)})}y(),document.body.appendChild(u)}async function N(j,B){const E=(r["gcCardsFull_"+n]||[]).find(h=>h.id===j),u=(E==null?void 0:E._gcDef)||(r.gcDefs||[]).find(h=>{var v;return h.name===B||((v=h.name)==null?void 0:v.toLowerCase().trim())===(B==null?void 0:B.toLowerCase().trim())}),x=[...r["usedGc_"+n]||[],j],y={type:B,by:n,seq:(r._gcAnimSeq||0)+1};H.add(y.seq),ve(B,n,async()=>{if(u!=null&&u.effect_type&&u.effect_type!=="CUSTOM"){const v=oe[u.effect_type];if(v){const _={...r};v(u.effect_params||{},_,async z=>{z["usedGc_"+n]=x,z._lastGC=y,z._gcAnimSeq=y.seq,await M(z)});return}}const h={...r};switch(B){case"Remplacement+":h.maxSubs=(h.maxSubs||3)+1,h.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const v=o+"Score";h[v]>0&&(h[v]--,h.log.push({text:"🚫 But annulé",type:"info"}));break}}h["usedGc_"+n]=x,h._lastGC=y,h._gcAnimSeq=y.seq,await M(h)})}function W(j,B){const w="usedCardIds_"+j,E=new Set(r[w]||[]);B.forEach(u=>E.add(u)),r[w]=[...E]}function K(){for(const j of["p1","p2"]){const B=new Set(r["usedCardIds_"+j]||[]),w=r[j+"Team"];if(w)for(const E of["GK","DEF","MIL","ATT"])(w[E]||[]).forEach(u=>{u.used=B.has(u.cardId)})}}function P(){var Ue,Je,Ze,Qe,nt,gt;if(r.phase==="reveal")return re();if(r.phase==="midfield")return ye();if(r.phase==="finished")return ze();const j=r[n+"Team"],B=r[o+"Team"];K();const w=r[n+"Score"],E=r[o+"Score"],u=r[n+"Name"],x=r[o+"Name"],y=r.phase===n+"-attack",h=r.phase===n+"-defense",v=Array.isArray(r["selected_"+n])?r["selected_"+n]:[],_=v.map(le=>le.cardId),z=window.innerWidth>=700,$=r[n+"Subs"]||[],T=r["usedSubIds_"+n]||[],S=$.filter(le=>!T.includes(le.cardId)),C=r["gcCardsFull_"+n]||[],F=r["usedGc_"+n]||[],R=C.filter(le=>!F.includes(le.id)),O=r.boostOwner===n&&!r.boostUsed,Q=!["GK","DEF","MIL","ATT"].some(le=>(B[le]||[]).some(Ee=>!Ee.used)),Y=[...j.MIL||[],...j.ATT||[]].filter(le=>!le.used),ie=y&&Q&&Y.length===0?[...j.GK||[],...j.DEF||[]].filter(le=>!le.used).map(le=>le.cardId):[];function ae(le,Ee,te){var pt,ht;const ue=le._gcDef,ee={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ue==null?void 0:ue.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ce={purple:"#b06ce0",light_blue:"#00d4ef"}[ue==null?void 0:ue.color]||"#b06ce0",Be=(ue==null?void 0:ue.name)||le.gc_type,Te=(ue==null?void 0:ue.effect)||((pt=Ve[le.gc_type])==null?void 0:pt.desc)||"",tt=ue!=null&&ue.image_url?`/icons/${ue.image_url}`:null,it=((ht=Ve[le.gc_type])==null?void 0:ht.icon)||"⚡",rt=Math.round(te*.22),st=Math.round(te*.22),ct=te-rt-st,$t=Be.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${le.id}" data-gc-type="${le.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(x);let v=!1;const _=()=>{v||(v=!0,x.remove(),setTimeout(()=>u(),50))};x.addEventListener("click",_),setTimeout(_,3500)}function ve(j,B,w){var F,R;const E=(r.gcDefs||[]).find(O=>{var Q;return O.name===j||((Q=O.name)==null?void 0:Q.toLowerCase().trim())===(j==null?void 0:j.toLowerCase().trim())}),u={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[E==null?void 0:E.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",x={purple:"#b06ce0",light_blue:"#00d4ef"}[E==null?void 0:E.color]||"#b06ce0",y=(E==null?void 0:E.name)||j,h=(E==null?void 0:E.effect)||((F=Ve[j])==null?void 0:F.desc)||"",v=E!=null&&E.image_url?`/icons/${E.image_url}`:null,_=((R=Ve[j])==null?void 0:R.icon)||"⚡",$=B===n?"Vous":r[B+"Name"]||"Adversaire",T=document.createElement("div");T.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",T.innerHTML=`
      <style>
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(T);let S=!1;const C=()=>{S||(S=!0,T.remove(),setTimeout(()=>w&&w(),50))};T.addEventListener("click",C),setTimeout(C,3e3)}function _e(j,B){var T,S,C,F;const E=(r["gcCardsFull_"+n]||[]).find(R=>R.id===j),u=E==null?void 0:E._gcDef,x={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[u==null?void 0:u.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",y={purple:"#b06ce0",light_blue:"#00d4ef"}[u==null?void 0:u.color]||"#b06ce0",h=(u==null?void 0:u.name)||B,v=(u==null?void 0:u.effect)||((T=Ve[B])==null?void 0:T.desc)||"Carte spéciale.",_=u!=null&&u.image_url?`/icons/${u.image_url}`:null,z=((S=Ve[B])==null?void 0:S.icon)||"⚡",$=document.createElement("div");$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",$.innerHTML=`
      ...
      </div>`,document.body.appendChild(B),(w=B.querySelector("#pvp-hist-close"))==null||w.addEventListener("click",()=>B.remove())}async function ne(){if(r.phase!==n+"-attack")return;const j=n==="p1"?"p2":"p1",B=(r.round||0)+1,w=[...r.log||[]];w.push({type:"info",text:`⏭️ ${r[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const E=Se(r),u=he(j),x=E||!u?"finished":j+"-attack";await M({["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:x,attacker:j,round:B,log:w}),x==="finished"&&await be(r)}async function ge(){const j=r[n+"Team"],B=!["GK","DEF","MIL","ATT"].some(x=>(r[o+"Team"][x]||[]).some(y=>!y.used)),w=(r["selected_"+n]||[]).map(x=>{const y=(j[x._role]||[]).find(T=>T.cardId===x.cardId)||x,h=B&&["GK","DEF"].includes(x._role),v=j[x._role]||[],_=v.findIndex(T=>T.cardId===x.cardId),z=lt(v.length),$=_>=0?z[_]:y._col??1;return{...y,_line:x._role,_col:$,...h?{note_a:Math.max(1,Number(y.note_a)||0)}:{}}});if(!w.length)return;const E=Nt(w,r.modifiers[n]||{});W(n,w.map(x=>x.cardId)),w.forEach(x=>{const y=(j[x._role]||[]).find(h=>h.cardId===x.cardId);y&&(y.used=!0)}),r["selected_"+n]=[],P();const u=[...r.log||[]];if(B){const x=(r[n+"Score"]||0)+1,y=w.map($=>({name:$.name,note:je($,$._line||"ATT"),portrait:Pe($),job:$.job}));u.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:y,homeTotal:E.total,aiTotal:0});const h=(r.round||0)+1,v=n==="p1"?"p2":"p1",_={...r,[n+"Team"]:j,[n+"Score"]:x},z=Se(_);q.add(h),Le(y,x,r[o+"Score"]||0,!0,async()=>{await M({[n+"Team"]:j,[n+"Score"]:x,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:z?"finished":v+"-attack",attacker:v,round:h,log:u}),z&&await be({...r,[n+"Score"]:x})});return}u.push({type:"pending",text:`⚔️ ${r[n+"Name"]} attaque (${E.total})`}),await M({[n+"Team"]:j,[o+"Team"]:r[o+"Team"],pendingAttack:{...E,players:w,side:n},["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},phase:o+"-defense",log:u})}async function J(){const j=r[n+"Team"],B=(r["selected_"+n]||[]).map(F=>{const R=(j[F._role]||[]).find(ae=>ae.cardId===F.cardId)||F,O=j[F._role]||[],Q=O.findIndex(ae=>ae.cardId===F.cardId),Y=lt(O.length),ie=Q>=0?Y[Q]:R._col??1;return{...R,_line:F._role,_col:ie}}),w=Rt(B,r.modifiers[n]||{});W(n,B.map(F=>F.cardId)),B.forEach(F=>{const R=(j[F._role]||[]).find(O=>O.cardId===F.cardId);R&&(R.used=!0)}),r["selected_"+n]=[],P();const E=Ot(r.pendingAttack.total,w.total,r.modifiers[n]||{}),u=r.pendingAttack.side,x=E==="attack"||(E==null?void 0:E.goal),y=u==="p1"?"p2":"p1",h=(r.round||0)+1,v=(r.pendingAttack.players||[]).map(F=>({name:F.name,note:je(F,F._line||"ATT"),portrait:Pe(F),job:F.job})),_=[...r.log||[]];_.push({type:"duel",isGoal:x,homeScored:x&&u===n,text:x?`⚽ BUT de ${r[u+"Name"]} ! (${r.pendingAttack.total} vs ${w.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${w.total})`,homePlayers:v,aiPlayers:B.map(F=>({name:F.name,note:je(F,F._line||"DEF"),portrait:Pe(F),job:F.job})),homeTotal:r.pendingAttack.total,aiTotal:w.total});const z=x?(r[u+"Score"]||0)+1:r[u+"Score"]||0,$={...r,[n+"Team"]:j,[u+"Score"]:z},T=Se($),S=T?"finished":y+"-attack",C=async()=>{await M({[n+"Team"]:j,[o+"Team"]:r[o+"Team"],[u+"Score"]:z,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:S,attacker:y,round:h,log:_}),(S==="finished"||T)&&await be({...r,[u+"Score"]:z})};if(x){const F=u===n,R=F?z:r[n+"Score"]||0,O=F?r[o+"Score"]||0:z;q.add(h),Le(v,R,O,F,C)}else await C()}function Z(j){return["MIL","ATT"].some(B=>(j[B]||[]).some(w=>!w.used))}function V(j){return["GK","DEF","MIL","ATT"].some(B=>(j[B]||[]).some(w=>!w.used))}function se(j){return V(j)&&!Z(j)}function he(j){const B=r[j+"Team"],w=r[(j==="p1"?"p2":"p1")+"Team"];return!!(Z(B)||!V(w)&&se(B))}function Se(j){const B=["MIL","ATT"].some(_=>(j.p1Team[_]||[]).some(z=>!z.used)),w=["MIL","ATT"].some(_=>(j.p2Team[_]||[]).some(z=>!z.used)),E=V(j.p1Team),u=V(j.p2Team);return!B&&!(!u&&E)&&(!w&&!(!E&&u))}function Me(j){const B=j.p1Score||0,w=j.p2Score||0;return B===w?null:B>w?g.home_id:g.away_id}async function be(j){try{const B=Me(j),w=B?g.home_id===B?g.away_id:g.home_id:null;await k.from("matches").update({status:"finished",winner_id:B,home_score:j.p1Score||0,away_score:j.p2Score||0}).eq("id",i),B&&w&&updateEvolutiveCards(B,w).catch(()=>{})}catch(B){console.error("[PvP] finishMatch:",B)}}function ze(){var u;const j=r[n+"Score"],B=r[o+"Score"],w=j>B,E=j===B;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      </div>`,(P=document.getElementById("lobby-cancel"))==null||P.addEventListener("click",async()=>{A=!0,r&&(k.removeChannel(r),r=null),W&&await k.from("friend_match_invites").update({status:"declined"}).eq("id",W),We(e),m("home")})},I=async(de,N)=>{A=!0,r&&(k.removeChannel(r),r=null),await new Promise(W=>setTimeout(W,600)),e.isConnected&&Hn(e,t,de,N,a,c)},{data:L}=await k.from("friend_match_invites").select("*").eq("status","pending").or(`and(inviter_id.eq.${g},invitee_id.eq.${f}),and(inviter_id.eq.${f},invitee_id.eq.${g})`).order("created_at",{ascending:!1}).limit(1).maybeSingle();let q,H;if(L&&L.inviter_id===f)H=!1,q=L.id,await k.from("friend_match_invites").update({invitee_deck_id:i,invitee_ready:!0,status:"accepted"}).eq("id",q);else{H=!0;const{data:de,error:N}=await k.from("friend_match_invites").insert({inviter_id:g,invitee_id:f,friend_id:f,inviter_deck_id:i,inviter_ready:!0,status:"pending"}).select().single();if(N||!de){b("Erreur création invitation","error"),We(e),m("home");return}q=de.id}if(p(!0,!H,q),!H){const de={home_id:f,away_id:g,home_deck_id:L.inviter_deck_id,away_deck_id:i,status:"active",mode:"friend"},N=await k.from("matches").insert(de).select().single(),W=N.data;if(!W){b("Erreur création match: "+(((oe=N.error)==null?void 0:oe.message)||""),"error"),We(e),m("home");return}await k.from("friend_match_invites").update({match_id:W.id,status:"matched"}).eq("id",q),I(W.id,!1);return}let D=!1;const G=de=>{A||D||(de.status==="matched"&&de.match_id?(D=!0,clearInterval(M),clearInterval(U),I(de.match_id,!0)):de.status==="declined"?(clearInterval(M),clearInterval(U),b(`${n} a décliné l'invitation`,"warning"),We(e),m("home")):de.invitee_ready&&p(!0,!0,q))},M=setInterval(()=>{if(A){clearInterval(M);return}k.from("matchmaking_queue").delete().eq("user_id",g).then(()=>{},()=>{})},3e3),U=setInterval(async()=>{if(A||D){clearInterval(U);return}const{data:de}=await k.from("friend_match_invites").select("*").eq("id",q).maybeSingle();de&&G(de)},1200);r=k.channel("friend-invite-"+q).on("postgres_changes",{event:"UPDATE",schema:"public",table:"friend_match_invites",filter:`id=eq.${q}`},de=>G(de.new)).subscribe()}async function Hn(e,t,i,s,l=[],d=[]){const{state:a,navigate:c,toast:f}=t,n=s?"p1":"p2",o=s?"p2":"p1",m=(l||[]).map(w=>w.id),b=(l||[]).map(w=>({id:w.id,gc_type:w.gc_type,_gcDef:w._gcDef||null}));e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Préparation...</div>';const{data:g}=await k.from("matches").select("*").eq("id",i).single();if(!g){f("Match introuvable","error"),c("home");return}async function A(){const[{data:w},{data:E},{data:u},{data:x}]=await Promise.all([k.rpc("get_deck_for_match",{p_deck_id:g.home_deck_id}),k.rpc("get_deck_for_match",{p_deck_id:g.away_deck_id}),k.from("users").select("id,pseudo,club_name").eq("id",g.home_id).single(),k.from("users").select("id,pseudo,club_name").eq("id",g.away_id).single()]),y=$=>{const T=Number($.evolution_bonus)||0;return{cardId:$.card_id,position:$.position,id:$.id,firstname:$.firstname,name:$.surname_encoded,country_code:$.country_code,club_id:$.club_id,job:$.job,job2:$.job2,note_g:(Number($.note_g)||0)+($.job==="GK"||$.job2==="GK"&&Number($.note_g)>0?T:0),note_d:(Number($.note_d)||0)+($.job==="DEF"||$.job2==="DEF"&&Number($.note_d)>0?T:0),note_m:(Number($.note_m)||0)+($.job==="MIL"||$.job2==="MIL"&&Number($.note_m)>0?T:0),note_a:(Number($.note_a)||0)+($.job==="ATT"||$.job2==="ATT"&&Number($.note_a)>0?T:0),evolution_bonus:T,rarity:$.rarity,skin:$.skin,hair:$.hair,hair_length:$.hair_length,clubName:$.club_encoded_name||null,clubLogo:$.club_logo_url||null,boost:0,used:!1,_line:null,_col:null}},h=((w==null?void 0:w.starters)||[]).map($=>y($)),v=((E==null?void 0:E.starters)||[]).map($=>y($)),_=(w==null?void 0:w.formation)||"4-4-2",z=(E==null?void 0:E.formation)||"4-4-2";return{p1Team:(()=>{const $=yt(h,_);return stadiumDef?Ht($,stadiumDef):$})(),p2Team:yt(v,z),p1Subs:(()=>{const $=((w==null?void 0:w.subs)||[]).map(T=>y(T));return stadiumDef&&oi($,stadiumDef),$})(),p2Subs:((E==null?void 0:E.subs)||[]).map($=>y($)),p1Formation:_,p2Formation:z,p1Name:(u==null?void 0:u.club_name)||(u==null?void 0:u.pseudo)||"Joueur 1",p2Name:(x==null?void 0:x.club_name)||(x==null?void 0:x.pseudo)||"Joueur 2",p1Score:0,p2Score:0,p1Subs_used:0,p2Subs_used:0,maxSubs:3,phase:"reveal",attacker:null,round:0,selected_p1:[],selected_p2:[],pendingAttack:null,log:[],modifiers:{p1:{},p2:{}},gc_p1:s?m:[],gc_p2:s?[]:m,gcCardsFull_p1:s?b:[],gcCardsFull_p2:s?[]:b,usedGc_p1:[],usedGc_p2:[],boostValue:null,boostOwner:null,boostUsed:!1,gcDefs:d||[],lastActionAt:new Date().toISOString()}}let r=g.game_state&&Object.keys(g.game_state).length?g.game_state:null;if(!r)if(s){r=await A();const{data:w}=await k.from("matches").select("game_state").eq("id",i).single();!(w!=null&&w.game_state)||!Object.keys(w.game_state).length?await k.from("matches").update({game_state:r,turn_user_id:g.home_id}).eq("id",i):r=w.game_state}else{e.innerHTML='<div style="padding:40px;text-align:center;color:#aaa">⚽ Synchronisation...</div>';for(let w=0;w<60&&!r;w++){await new Promise(u=>setTimeout(u,400));const{data:E}=await k.from("matches").select("game_state").eq("id",i).single();E!=null&&E.game_state&&Object.keys(E.game_state).length&&(r=E.game_state)}if(!r){f("Erreur de synchronisation","error"),c("home");return}r.gc_p2=m,r.gcCardsFull_p2=b,await k.from("matches").update({game_state:r}).eq("id",i)}let p=!1,I=!1,L=!1,q=null,H=!1;const D=new Set,G=new Set;function M(w){var $,T;try{k.removeChannel(U)}catch{}const E=r[n+"Score"]||0,u=r[o+"Score"]||0;if(!L){L=!0;const S=w.winner_id||(E>u?a.profile.id:u>E?"opp":null),C=S===a.profile.id?"win":S?"loss":null;C&&ti(()=>Promise.resolve().then(()=>oo),void 0).then(F=>F.applyOwnEvolution(a.profile.id,C)).catch(()=>{})}if(!I){const S=r.p1Score||0,C=r.p2Score||0,F=(r.usedGc_p1||[]).length,R=(r.usedGc_p2||[]).length,O=w.winner_id||(S>C?g.home_id:C>S?g.away_id:null);(O?a.profile.id===O:a.profile.id<(s?g.away_id:g.home_id))&&(I=!0,Xi({player1Id:g.home_id,player2Id:g.away_id,score1:S,score2:C,gc1:F,gc2:R}).catch(Y=>console.warn("[FriendMatch] updateStats:",Y)))}let x,y;w.winner_id?(x=w.winner_id===a.profile.id,y=!1):w.forfeit?(x=E>u,y=!1):(y=E===u,x=E>u),($=document.getElementById("pvp-end-overlay"))==null||$.remove();const h=document.createElement("div");h.id="pvp-end-overlay",h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:1500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;color:#fff;padding:24px;text-align:center";const v=y?"🤝":x?"🏆":"😞",_=y?"MATCH NUL":x?"VICTOIRE !":"DÉFAITE",z=y?"#fff":x?"#FFD700":"#ff6b6b";h.innerHTML=`
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">Retour à l'accueil</button>`,document.body.appendChild(h),(T=h.querySelector("#pvp-end-home"))==null||T.addEventListener("click",()=>{h.remove(),We(e),c("home")})}const U=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},w=>{const E=w.new;try{if(E.status==="finished"||E.forfeit){if(p)return;p=!0,q&&(clearInterval(q),q=null),E.game_state&&(r=E.game_state),M(E);return}if(E.game_state){const u=r;r=E.game_state;const x=r._lastGC;if(x&&x.seq&&!G.has(x.seq)&&(G.add(x.seq),x.by!==n)){we(x.type,x.by,()=>pe());return}const y=u[n+"Score"]||0,h=u[o+"Score"]||0,v=r[n+"Score"]||0,_=r[o+"Score"]||0,z=v>y,$=_>h;if((z||$)&&!D.has(r.round)){D.add(r.round);const T=[...r.log||[]].reverse().find(C=>C.isGoal),S=((T==null?void 0:T.homePlayers)||[]).map(C=>({name:C.name,note:C.note,portrait:C.portrait,job:C.job}));_e(S,v,_,z,()=>pe());return}pe()}}catch(u){console.error("[PvP] crash:",u)}}).subscribe();async function oe(w){Object.assign(r,w),r.lastActionAt=new Date().toISOString();const{error:E}=await k.from("matches").update({game_state:r}).eq("id",i);E&&f("Erreur de synchronisation","error");try{pe()}catch(u){console.error("[PvP] renderPvpScreen crash:",u)}}async function de(){if(p)return;p=!0,q&&(clearInterval(q),q=null);const w=s?g.away_id:g.home_id,E=s?"p2":"p1",u=s?"p1":"p2",x={...r,[E+"Score"]:3,[u+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:w,home_score:x.p1Score||0,away_score:x.p2Score||0,game_state:x}).eq("id",i)}catch{}try{k.removeChannel(U)}catch{}setTimeout(()=>{We(e),c("home")},800)}const N={BOOST_STAT:({value:w=1,count:E=1,roles:u=[]},x,y)=>{const h=x[n+"Team"],v=Object.entries(h).filter(([_])=>!u.length||u.includes(_)).flatMap(([_,z])=>z.filter($=>!$.used).map($=>({...$,_line:_})));if(!v.length){x.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),y(x);return}W(v,E,`Choisir ${E} joueur(s) à booster (+${w})`,_=>{_.forEach(z=>{const $=(h[z._line]||[]).find(T=>T.cardId===z.cardId);$&&($.boost=($.boost||0)+w,x.log.push({text:`⚡ +${w} sur ${$.name}`,type:"info"}))}),x[n+"Team"]=h,y(x)})},DEBUFF_STAT:({value:w=1,count:E=1,roles:u=[],target:x="ai"},y,h)=>{const v=x==="home"?n:o,_=y[v+"Team"],z=x==="home"?"allié":"adverse",$=Object.entries(_).filter(([T])=>!u.length||u.includes(T)).flatMap(([T,S])=>S.map(C=>({...C,_line:T})));if(!$.length){y.log.push({text:`🎯 Aucun joueur ${z}`,type:"info"}),h(y);return}W($,E,`Choisir ${E} joueur(s) ${z}(s) (-${w})`,T=>{T.forEach(S=>{const C=(_[S._line]||[]).find(F=>F.cardId===S.cardId);C&&(C.boost=(C.boost||0)-w,y.log.push({text:`🎯 -${w} sur ${C.name}`,type:"info"}))}),y[v+"Team"]=_,h(y)})},GRAY_PLAYER:({count:w=1,roles:E=[],target:u="ai"},x,y)=>{const h=u==="home"?n:o,v=x[h+"Team"],_=u==="home"?"allié":"adverse",z=Object.entries(v).filter(([$])=>!E.length||E.includes($)).flatMap(([$,T])=>T.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!z.length){x.log.push({text:`❌ Aucun joueur ${_}`,type:"info"}),y(x);return}W(z,w,`Choisir ${w} joueur(s) ${_}(s) à exclure`,$=>{const T="usedCardIds_"+h,S=new Set(x[T]||[]);$.forEach(C=>{const F=(v[C._line]||[]).find(R=>R.cardId===C.cardId);F&&(F.used=!0,S.add(C.cardId),x.log.push({text:`❌ ${F.name} exclu !`,type:"info"}))}),x[T]=[...S],x[h+"Team"]=v,y(x)})},REVIVE_PLAYER:({count:w=1,roles:E=[]},u,x)=>{const y=u[n+"Team"],h=Object.entries(y).filter(([v])=>!E.length||E.includes(v)).flatMap(([v,_])=>_.filter(z=>z.used).map(z=>({...z,_line:v})));if(!h.length){u.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),x(u);return}W(h,w,`Choisir ${w} joueur(s) à ressusciter`,v=>{v.forEach(_=>{const z=(y[_._line]||[]).find($=>$.cardId===_.cardId);z&&(z.used=!1,u.log.push({text:`💫 ${z.name} ressuscité !`,type:"info"}))}),u[n+"Team"]=y,x(u)})},REMOVE_GOAL:({},w,E)=>{const u=o+"Score";w[u]>0?(w[u]--,w.log.push({text:"🚫 Dernier but annulé !",type:"info"})):w.log.push({text:"🚫 Aucun but à annuler",type:"info"}),E(w)},ADD_GOAL_DRAW:({},w,E)=>{w[n+"Score"]===w[o+"Score"]?(w[n+"Score"]++,w.log.push({text:"🎯 But bonus !",type:"info"})):w.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),E(w)},ADD_SUB:({value:w=1},E,u)=>{E.maxSubs=(E.maxSubs||3)+w,E.log.push({text:`🔄 +${w} remplacement(s)`,type:"info"}),u(E)},CUSTOM:({},w,E)=>E(w)};function W(w,E,u,x){const y=document.createElement("div");y.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let h=[];function v(){var z,$;const _=w.map(T=>{const S={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[T._line]||"#555",C=je(T,T._line)+(T.boost||0),R=h.find(Q=>Q.cardId===T.cardId)?"#FFD700":"rgba(255,255,255,0.25)",O=T.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${T.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${R};background:${S};overflow:hidden;cursor:pointer;${O}">
        ...
        </div>`,(z=y.querySelector("#pp-close"))==null||z.addEventListener("click",()=>y.remove()),y.querySelectorAll(".pp-item").forEach(T=>{T.addEventListener("click",()=>{const S=T.dataset.cid,C=w.find(R=>R.cardId===S),F=h.findIndex(R=>R.cardId===S);C&&(F>-1?h.splice(F,1):h.length<E&&h.push(C),v())})}),($=y.querySelector("#pp-confirm"))==null||$.addEventListener("click",()=>{y.remove(),x(h)})}v(),document.body.appendChild(y)}async function K(w,E){const x=(r["gcCardsFull_"+n]||[]).find(_=>_.id===w),y=(x==null?void 0:x._gcDef)||(r.gcDefs||[]).find(_=>{var z;return _.name===E||((z=_.name)==null?void 0:z.toLowerCase().trim())===(E==null?void 0:E.toLowerCase().trim())}),h=[...r["usedGc_"+n]||[],w],v={type:E,by:n,seq:(r._gcAnimSeq||0)+1};G.add(v.seq),we(E,n,async()=>{if(y!=null&&y.effect_type&&y.effect_type!=="CUSTOM"){const z=N[y.effect_type];if(z){const $={...r};z(y.effect_params||{},$,async T=>{T["usedGc_"+n]=h,T._lastGC=v,T._gcAnimSeq=v.seq,await oe(T)});return}}const _={...r};switch(E){case"Remplacement+":_.maxSubs=(_.maxSubs||3)+1,_.log.push({text:"🔄 +1 remplacement",type:"info"});break;case"VAR":{const z=o+"Score";_[z]>0&&(_[z]--,_.log.push({text:"🚫 But annulé",type:"info"}));break}}_["usedGc_"+n]=h,_._lastGC=v,_._gcAnimSeq=v.seq,await oe(_)})}function P(w,E){const u="usedCardIds_"+w,x=new Set(r[u]||[]);E.forEach(y=>x.add(y)),r[u]=[...x]}function re(){for(const w of["p1","p2"]){const E=new Set(r["usedCardIds_"+w]||[]),u=r[w+"Team"];if(u)for(const x of["GK","DEF","MIL","ATT"])(u[x]||[]).forEach(y=>{y.used=E.has(y.cardId)})}}function pe(){var Ze,Qe,nt,gt,le,Ee;if(r.phase==="reveal")return ye();if(r.phase==="midfield")return ve();if(r.phase==="finished")return B();const w=r[n+"Team"],E=r[o+"Team"];re();const u=r[n+"Score"],x=r[o+"Score"],y=r[n+"Name"],h=r[o+"Name"],v=r.phase===n+"-attack",_=r.phase===n+"-defense",z=Array.isArray(r["selected_"+n])?r["selected_"+n]:[],$=z.map(te=>te.cardId),T=window.innerWidth>=700,S=r[n+"Subs"]||[],C=r["usedSubIds_"+n]||[],F=S.filter(te=>!C.includes(te.cardId)),R=r["gcCardsFull_"+n]||[],O=r["usedGc_"+n]||[],Q=R.filter(te=>!O.includes(te.id)),Y=r.boostOwner===n&&!r.boostUsed,ie=!["GK","DEF","MIL","ATT"].some(te=>(E[te]||[]).some(ue=>!ue.used)),ae=[...w.MIL||[],...w.ATT||[]].filter(te=>!te.used),fe=v&&ie&&ae.length===0?[...w.GK||[],...w.DEF||[]].filter(te=>!te.used).map(te=>te.cardId):[];function me(te,ue,ee){var kt,Ut;const ce=te._gcDef,Be={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[ce==null?void 0:ce.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",Te={purple:"#b06ce0",light_blue:"#00d4ef"}[ce==null?void 0:ce.color]||"#b06ce0",tt=(ce==null?void 0:ce.name)||te.gc_type,it=(ce==null?void 0:ce.effect)||((kt=Ve[te.gc_type])==null?void 0:kt.desc)||"",rt=ce!=null&&ce.image_url?`/icons/${ce.image_url}`:null,st=((Ut=Ve[te.gc_type])==null?void 0:Ut.icon)||"⚡",ct=Math.round(ee*.22),$t=Math.round(ee*.22),pt=ee-ct-$t,ht=tt.length>12?7:9;return`<div class="pvp-gc-mini" data-gc-id="${te.id}" data-gc-type="${te.gc_type}"
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(h);let z=!1;const $=()=>{z||(z=!0,h.remove(),setTimeout(()=>y(),50))};h.addEventListener("click",$),setTimeout($,3500)}function we(w,E,u){var O,Q;const x=(r.gcDefs||[]).find(Y=>{var ie;return Y.name===w||((ie=Y.name)==null?void 0:ie.toLowerCase().trim())===(w==null?void 0:w.toLowerCase().trim())}),y={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[x==null?void 0:x.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",h={purple:"#b06ce0",light_blue:"#00d4ef"}[x==null?void 0:x.color]||"#b06ce0",v=(x==null?void 0:x.name)||w,_=(x==null?void 0:x.effect)||((O=Ve[w])==null?void 0:O.desc)||"",z=x!=null&&x.image_url?`/icons/${x.image_url}`:null,$=((Q=Ve[w])==null?void 0:Q.icon)||"⚡",S=E===n?"Vous":r[E+"Name"]||"Adversaire",C=document.createElement("div");C.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",C.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(C);let F=!1;const R=()=>{F||(F=!0,C.remove(),setTimeout(()=>u&&u(),50))};C.addEventListener("click",R),setTimeout(R,3e3)}function Ae(w,E){var C,F,R,O;const x=(r["gcCardsFull_"+n]||[]).find(Q=>Q.id===w),y=x==null?void 0:x._gcDef,h={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[y==null?void 0:y.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",v={purple:"#b06ce0",light_blue:"#00d4ef"}[y==null?void 0:y.color]||"#b06ce0",_=(y==null?void 0:y.name)||E,z=(y==null?void 0:y.effect)||((C=Ve[E])==null?void 0:C.desc)||"Carte spéciale.",$=y!=null&&y.image_url?`/icons/${y.image_url}`:null,T=((F=Ve[E])==null?void 0:F.icon)||"⚡",S=document.createElement("div");S.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",S.innerHTML=`
      ...
      </div>`,document.body.appendChild(E),(x=E.querySelector("#pvp-hist-close"))==null||x.addEventListener("click",()=>E.remove())}async function J(){if(r.phase!==n+"-attack")return;const w=n==="p1"?"p2":"p1",E=(r.round||0)+1,u=[...r.log||[]];u.push({type:"info",text:`⏭️ ${r[n+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const x=be(r),y=Me(w),h=x||!y?"finished":w+"-attack";await oe({["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:h,attacker:w,round:E,log:u}),h==="finished"&&await j(r)}async function Z(){const w=r[n+"Team"],E=!["GK","DEF","MIL","ATT"].some(h=>(r[o+"Team"][h]||[]).some(v=>!v.used)),u=(r["selected_"+n]||[]).map(h=>{const v=(w[h._role]||[]).find(C=>C.cardId===h.cardId)||h,_=E&&["GK","DEF"].includes(h._role),z=w[h._role]||[],$=z.findIndex(C=>C.cardId===h.cardId),T=lt(z.length),S=$>=0?T[$]:v._col??1;return{...v,_line:h._role,_col:S,..._?{note_a:Math.max(1,Number(v.note_a)||0)}:{}}});if(!u.length)return;const x=Nt(u,r.modifiers[n]||{});P(n,u.map(h=>h.cardId)),u.forEach(h=>{const v=(w[h._role]||[]).find(_=>_.cardId===h.cardId);v&&(v.used=!0)}),r["selected_"+n]=[],pe();const y=[...r.log||[]];if(E){const h=(r[n+"Score"]||0)+1,v=u.map(S=>({name:S.name,note:je(S,S._line||"ATT"),portrait:Pe(S),job:S.job}));y.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:v,homeTotal:x.total,aiTotal:0});const _=(r.round||0)+1,z=n==="p1"?"p2":"p1",$={...r,[n+"Team"]:w,[n+"Score"]:h},T=be($);D.add(_),_e(v,h,r[o+"Score"]||0,!0,async()=>{await oe({[n+"Team"]:w,[n+"Score"]:h,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:T?"finished":z+"-attack",attacker:z,round:_,log:y}),T&&await j({...r,[n+"Score"]:h})});return}y.push({type:"pending",text:`⚔️ ${r[n+"Name"]} attaque (${x.total})`}),await oe({[n+"Team"]:w,[o+"Team"]:r[o+"Team"],pendingAttack:{...x,players:u,side:n},["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},phase:o+"-defense",log:y})}async function V(){const w=r[n+"Team"],E=(r["selected_"+n]||[]).map(O=>{const Q=(w[O._role]||[]).find(me=>me.cardId===O.cardId)||O,Y=w[O._role]||[],ie=Y.findIndex(me=>me.cardId===O.cardId),ae=lt(Y.length),fe=ie>=0?ae[ie]:Q._col??1;return{...Q,_line:O._role,_col:fe}}),u=Rt(E,r.modifiers[n]||{});P(n,E.map(O=>O.cardId)),E.forEach(O=>{const Q=(w[O._role]||[]).find(Y=>Y.cardId===O.cardId);Q&&(Q.used=!0)}),r["selected_"+n]=[],pe();const x=Ot(r.pendingAttack.total,u.total,r.modifiers[n]||{}),y=r.pendingAttack.side,h=x==="attack"||(x==null?void 0:x.goal),v=y==="p1"?"p2":"p1",_=(r.round||0)+1,z=(r.pendingAttack.players||[]).map(O=>({name:O.name,note:je(O,O._line||"ATT"),portrait:Pe(O),job:O.job})),$=[...r.log||[]];$.push({type:"duel",isGoal:h,homeScored:h&&y===n,text:h?`⚽ BUT de ${r[y+"Name"]} ! (${r.pendingAttack.total} vs ${u.total})`:`✋ Attaque stoppée (${r.pendingAttack.total} vs ${u.total})`,homePlayers:z,aiPlayers:E.map(O=>({name:O.name,note:je(O,O._line||"DEF"),portrait:Pe(O),job:O.job})),homeTotal:r.pendingAttack.total,aiTotal:u.total});const T=h?(r[y+"Score"]||0)+1:r[y+"Score"]||0,S={...r,[n+"Team"]:w,[y+"Score"]:T},C=be(S),F=C?"finished":v+"-attack",R=async()=>{await oe({[n+"Team"]:w,[o+"Team"]:r[o+"Team"],[y+"Score"]:T,["selected_"+n]:[],modifiers:{...r.modifiers,[n]:{}},pendingAttack:null,phase:F,attacker:v,round:_,log:$}),(F==="finished"||C)&&await j({...r,[y+"Score"]:T})};if(h){const O=y===n,Q=O?T:r[n+"Score"]||0,Y=O?r[o+"Score"]||0:T;D.add(_),_e(z,Q,Y,O,R)}else await R()}function se(w){return["MIL","ATT"].some(E=>(w[E]||[]).some(u=>!u.used))}function he(w){return["GK","DEF","MIL","ATT"].some(E=>(w[E]||[]).some(u=>!u.used))}function Se(w){return he(w)&&!se(w)}function Me(w){const E=r[w+"Team"],u=r[(w==="p1"?"p2":"p1")+"Team"];return!!(se(E)||!he(u)&&Se(E))}function be(w){const E=["MIL","ATT"].some($=>(w.p1Team[$]||[]).some(T=>!T.used)),u=["MIL","ATT"].some($=>(w.p2Team[$]||[]).some(T=>!T.used)),x=he(w.p1Team),y=he(w.p2Team);return!E&&!(!y&&x)&&(!u&&!(!x&&y))}function ze(w){const E=w.p1Score||0,u=w.p2Score||0;return E===u?null:E>u?g.home_id:g.away_id}async function j(w){try{const E=ze(w),u=E?g.home_id===E?g.away_id:g.home_id:null;await k.from("matches").update({status:"finished",winner_id:E,home_score:w.p1Score||0,away_score:w.p2Score||0}).eq("id",i),E&&u&&ki(E,u).catch(()=>{})}catch(E){console.error("[PvP] finishMatch:",E)}}function B(){var y;const w=r[n+"Score"],E=r[o+"Score"],u=w>E,x=w===E;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
  ...
  </div>`,(I=document.getElementById("ml-create-btn"))==null||I.addEventListener("click",()=>Wn(e,t)),e.querySelectorAll(".ml-tab").forEach(L=>L.addEventListener("click",()=>_t(e,t,L.dataset.tab))),e.querySelectorAll("[data-league-id]").forEach(L=>L.addEventListener("click",()=>bt(e,t,L.dataset.leagueId))),e.querySelectorAll("[data-join]").forEach(L=>L.addEventListener("click",q=>{q.stopPropagation(),_o(e,t,L.dataset.join,L.dataset.type)})),e.querySelectorAll("[data-delete]").forEach(L=>L.addEventListener("click",q=>{q.stopPropagation(),yi(e,t,L.dataset.delete,L.dataset.name,i)}))}function ei(e,t,i=!1){var a,c;const s=e.creator_id===t,l=e.pot||0,d=((c=(a=e.mini_league_members)==null?void 0:a[0])==null?void 0:c.count)||0;return`<div data-league-id="${e.id}" style="background:#fff;border-radius:12px;padding:14px 16px;box-shadow:0 1px 6px rgba(0,0,0,0.08);cursor:pointer;margin-bottom:8px">
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
    ...
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:14px">
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          ...
          <tbody>${b.map((K,P)=>{const re=A>0&&a.status==="finished"?P===0?Math.floor(A*.7):P===1?Math.floor(A*.2):P===2?Math.floor(A*.1):0:0;return`<tr style="border-bottom:1px solid #f5f5f5;${K.userId===d?"background:#f0fdf4;":""}">
              ...
              ${A>0&&a.status==="finished"?`<td style="text-align:right;font-weight:700;color:${xt}">${re?re.toLocaleString("fr")+" cr.":"—"}</td>`:""}
            </tr>`}).join("")}</tbody>
        </table>
      </div>`:""}
      ...
      <div style="background:#fff;border-radius:12px;padding:16px;box-shadow:0 1px 6px rgba(0,0,0,0.08)">
        ...
        ${Array.from({length:Math.max(0,a.status==="active"?a.current_day-1:a.current_day)},(K,P)=>P+1).reverse().map(K=>{const P=(f||[]).filter(re=>re.matchday===K);return`<div style="margin-bottom:10px"><div style="font-size:11px;font-weight:700;color:#888;margin-bottom:6px">Journée ${K}</div>${P.map(re=>Ri(re,m,d,!1,!0)).join("")}</div>`}).join("")}
      </div>`:""}
    ...
    <div style="background:linear-gradient(160deg,#1a0a2e,#3b1a6e);border-radius:20px;padding:32px 24px;max-width:320px;width:100%;text-align:center;color:#fff;box-shadow:0 8px 40px rgba(0,0,0,0.6)">
      ...
      <button id="pvp-end-home" style="margin-top:10px;padding:14px 32px;border-radius:12px;border:none;background:#1A6B3C;color:#fff;font-size:16px;font-weight:900;cursor:pointer">🏆 Retour à la Mini League</button>`,document.body.appendChild(_),(C=_.querySelector("#pvp-end-home"))==null||C.addEventListener("click",()=>{_.remove(),We(e),n?c("mini-league",{openLeagueId:n}):c("mini-league")})}const oe=k.channel("pvp-match-"+i).on("postgres_changes",{event:"UPDATE",schema:"public",table:"matches",filter:`id=eq.${i}`},u=>{const x=u.new;try{if(x.status==="finished"||x.forfeit){if(I||(I=!0,H&&(clearInterval(H),H=null),x.game_state&&(p=x.game_state),p.phase==="finished"&&!x.forfeit&&document.getElementById("pvp-home")))return;U(x);return}if(x.game_state){const y=p;p=x.game_state;const h=p._lastGC;if(h&&h.seq&&!M.has(h.seq)&&(M.add(h.seq),h.by!==o)){Ae(h.type,h.by,()=>ye());return}const v=y[o+"Score"]||0,_=y[m+"Score"]||0,z=p[o+"Score"]||0,$=p[m+"Score"]||0,T=z>v,S=$>_;if((T||S)&&!G.has(p.round)){G.add(p.round);const C=[...p.log||[]].reverse().find(R=>R.isGoal),F=((C==null?void 0:C.homePlayers)||[]).map(R=>({name:R.name,note:R.note,portrait:R.portrait,job:R.job}));we(F,z,$,T,()=>ye());return}ye()}}catch(y){console.error("[PvP] crash:",y)}}).subscribe();async function de(u){Object.assign(p,u),p.lastActionAt=new Date().toISOString();const{error:x}=await k.from("matches").update({game_state:p}).eq("id",i);x&&f("Erreur de synchronisation","error");try{ye()}catch(y){console.error("[PvP] renderPvpScreen crash:",y)}}async function N(){if(I)return;I=!0,H&&(clearInterval(H),H=null);const u=s?A.away_id:A.home_id,x=s?"p2":"p1",y=s?"p1":"p2",h={...p,[x+"Score"]:3,[y+"Score"]:0,phase:"finished"};try{await k.from("matches").update({status:"finished",forfeit:!0,winner_id:u,home_score:h.p1Score||0,away_score:h.p2Score||0,game_state:h}).eq("id",i)}catch{}try{k.removeChannel(oe)}catch{}setTimeout(()=>{We(e),c("mini-league")},800)}const W={BOOST_STAT:({value:u=1,count:x=1,roles:y=[]},h,v)=>{const _=h[o+"Team"],z=Object.entries(_).filter(([$])=>!y.length||y.includes($)).flatMap(([$,T])=>T.filter(S=>!S.used).map(S=>({...S,_line:$})));if(!z.length){h.log.push({text:"⚡ Aucun joueur disponible",type:"info"}),v(h);return}K(z,x,`Choisir ${x} joueur(s) à booster (+${u})`,$=>{$.forEach(T=>{const S=(_[T._line]||[]).find(C=>C.cardId===T.cardId);S&&(S.boost=(S.boost||0)+u,h.log.push({text:`⚡ +${u} sur ${S.name}`,type:"info"}))}),h[o+"Team"]=_,v(h)})},DEBUFF_STAT:({value:u=1,count:x=1,roles:y=[],target:h="ai"},v,_)=>{const z=h==="home"?o:m,$=v[z+"Team"],T=h==="home"?"allié":"adverse",S=Object.entries($).filter(([C])=>!y.length||y.includes(C)).flatMap(([C,F])=>F.map(R=>({...R,_line:C})));if(!S.length){v.log.push({text:`🎯 Aucun joueur ${T}`,type:"info"}),_(v);return}K(S,x,`Choisir ${x} joueur(s) ${T}(s) (-${u})`,C=>{C.forEach(F=>{const R=($[F._line]||[]).find(O=>O.cardId===F.cardId);R&&(R.boost=(R.boost||0)-u,v.log.push({text:`🎯 -${u} sur ${R.name}`,type:"info"}))}),v[z+"Team"]=$,_(v)})},GRAY_PLAYER:({count:u=1,roles:x=[],target:y="ai"},h,v)=>{const _=y==="home"?o:m,z=h[_+"Team"],$=y==="home"?"allié":"adverse",T=Object.entries(z).filter(([S])=>!x.length||x.includes(S)).flatMap(([S,C])=>C.filter(F=>!F.used).map(F=>({...F,_line:S})));if(!T.length){h.log.push({text:`❌ Aucun joueur ${$}`,type:"info"}),v(h);return}K(T,u,`Choisir ${u} joueur(s) ${$}(s) à exclure`,S=>{const C="usedCardIds_"+_,F=new Set(h[C]||[]);S.forEach(R=>{const O=(z[R._line]||[]).find(Q=>Q.cardId===R.cardId);O&&(O.used=!0,F.add(R.cardId),h.log.push({text:`❌ ${O.name} exclu !`,type:"info"}))}),h[C]=[...F],h[_+"Team"]=z,v(h)})},REVIVE_PLAYER:({count:u=1,roles:x=[]},y,h)=>{const v=y[o+"Team"],_=Object.entries(v).filter(([z])=>!x.length||x.includes(z)).flatMap(([z,$])=>$.filter(T=>T.used).map(T=>({...T,_line:z})));if(!_.length){y.log.push({text:"💫 Aucun joueur à ressusciter",type:"info"}),h(y);return}K(_,u,`Choisir ${u} joueur(s) à ressusciter`,z=>{z.forEach($=>{const T=(v[$._line]||[]).find(S=>S.cardId===$.cardId);T&&(T.used=!1,y.log.push({text:`💫 ${T.name} ressuscité !`,type:"info"}))}),y[o+"Team"]=v,h(y)})},REMOVE_GOAL:({},u,x)=>{const y=m+"Score";u[y]>0?(u[y]--,u.log.push({text:"🚫 Dernier but annulé !",type:"info"})):u.log.push({text:"🚫 Aucun but à annuler",type:"info"}),x(u)},ADD_GOAL_DRAW:({},u,x)=>{u[o+"Score"]===u[m+"Score"]?(u[o+"Score"]++,u.log.push({text:"🎯 But bonus !",type:"info"})):u.log.push({text:"🎯 Non applicable (pas de nul)",type:"info"}),x(u)},ADD_SUB:({value:u=1},x,y)=>{x.maxSubs=(x.maxSubs||3)+u,x.log.push({text:`🔄 +${u} remplacement(s)`,type:"info"}),y(x)},CUSTOM:({},u,x)=>x(u)};function K(u,x,y,h){const v=document.createElement("div");v.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.9);z-index:900;display:flex;flex-direction:column;overflow:hidden";let _=[];function z(){var T,S;const $=u.map(C=>{const F={GK:"#111",DEF:"#bb2020",MIL:"#D4A017",ATT:"#1A6B3C"}[C._line]||"#555",R=je(C,C._line)+(C.boost||0),Q=_.find(ie=>ie.cardId===C.cardId)?"#FFD700":"rgba(255,255,255,0.25)",Y=C.used?"opacity:0.3;pointer-events:none":"";return`<div class="pp-item" data-cid="${C.cardId}" style="width:80px;border-radius:8px;border:2.5px solid ${Q};background:${F};overflow:hidden;cursor:pointer;${Y}">
    ...
    </div>`,o==="p1"&&setTimeout(async()=>{await de({phase:"midfield"})},5e3)}let ve=!1;function _e(){if(ve)return;const u=p[o+"Team"].MIL||[],x=p[m+"Team"].MIL||[];function y(ie){return ie.reduce((ae,fe)=>ae+je(fe,"MIL"),0)}function h(ie){let ae=0;for(let fe=0;fe<ie.length-1;fe++){const me=at(ie[fe],ie[fe+1]);me==="#00ff88"?ae+=2:me==="#FFD700"&&(ae+=1)}return ae}const v=y(u)+h(u),_=y(x)+h(x),z=v>=_;function $(ie,ae,fe){return`<div id="duel-row-${fe}" style="text-align:center;width:100%;transition:transform .5s cubic-bezier(.5,0,.75,0),opacity .5s ease;transform-origin:center">
    ...
    <div class="match-screen" style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;overflow:hidden;gap:14px;padding:16px;background:#0a3d1e;overflow-y:auto">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn .3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(_);let T=!1;const S=()=>{T||(T=!0,_.remove(),setTimeout(()=>v(),50))};_.addEventListener("click",S),setTimeout(S,3500)}function Ae(u,x,y){var Y,ie;const h=(p.gcDefs||[]).find(ae=>{var fe;return ae.name===u||((fe=ae.name)==null?void 0:fe.toLowerCase().trim())===(u==null?void 0:u.toLowerCase().trim())}),v={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[h==null?void 0:h.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",_={purple:"#b06ce0",light_blue:"#00d4ef"}[h==null?void 0:h.color]||"#b06ce0",z=(h==null?void 0:h.name)||u,$=(h==null?void 0:h.effect)||((Y=Ve[u])==null?void 0:Y.desc)||"",T=h!=null&&h.image_url?`/icons/${h.image_url}`:null,S=((ie=Ve[u])==null?void 0:ie.icon)||"⚡",F=x===o?"Vous":p[x+"Name"]||"Adversaire",R=document.createElement("div");R.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.93);z-index:1100;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden;cursor:pointer;padding:24px",R.innerHTML=`
      <style>
        @keyframes gcFlipIn{0%{transform:perspective(800px) rotateY(90deg) scale(.7);opacity:0}55%{transform:perspective(800px) rotateY(-12deg) scale(1.08);opacity:1}100%{transform:perspective(800px) rotateY(0) scale(1);opacity:1}}
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:4px;animation:gcLabel .3s ease 1.2s both">Appuyer pour continuer</div>`,document.body.appendChild(R);let O=!1;const Q=()=>{O||(O=!0,R.remove(),setTimeout(()=>y&&y(),50))};R.addEventListener("click",Q),setTimeout(Q,3e3)}function Ie(u,x){var R,O,Q,Y;const h=(p["gcCardsFull_"+o]||[]).find(ie=>ie.id===u),v=h==null?void 0:h._gcDef,_={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[v==null?void 0:v.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",z={purple:"#b06ce0",light_blue:"#00d4ef"}[v==null?void 0:v.color]||"#b06ce0",$=(v==null?void 0:v.name)||x,T=(v==null?void 0:v.effect)||((R=Ve[x])==null?void 0:R.desc)||"Carte spéciale.",S=v!=null&&v.image_url?`/icons/${v.image_url}`:null,C=((O=Ve[x])==null?void 0:O.icon)||"⚡",F=document.createElement("div");F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);z-index:750;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:24px",F.innerHTML=`
      ...
      </div>`,document.body.appendChild(y),(h=y.querySelector("#bp-close"))==null||h.addEventListener("click",()=>y.remove()),y.querySelectorAll(".bp-item").forEach(v=>{v.addEventListener("click",async()=>{const _=v.dataset.cid,z=x.find(T=>T.cardId===_);if(!z)return;const $=(u[z._line]||[]).find(T=>T.cardId===_);$&&($.boost=($.boost||0)+p.boostValue),y.remove(),await de({[o+"Team"]:u,boostUsed:!0})})})}function X(u=null){var O,Q;if(!(p.phase===o+"-attack")){f("Remplacement uniquement avant votre attaque","warning");return}const y=p[o+"Team"],h=p["usedSubIds_"+o]||[],v=p.maxSubs||3;if(h.length>=v){f(`Maximum ${v} remplacements atteint`,"warning");return}const _=Object.entries(y).flatMap(([Y,ie])=>(ie||[]).filter(ae=>ae.used).map(ae=>({...ae,_line:Y}))),z=(p[o+"Subs"]||[]).filter(Y=>!h.includes(Y.cardId));if(!_.length){f("Aucun joueur utilisé à remplacer","warning");return}if(!z.length){f("Aucun remplaçant disponible","warning");return}let $=Math.max(0,_.findIndex(Y=>Y.cardId===u));const T=((O=_[$])==null?void 0:O._line)||((Q=_[$])==null?void 0:Q.job);let S=Math.max(0,z.findIndex(Y=>Y.job===T)),C=!1;const F=document.createElement("div");F.id="pvp-sub-overlay",F.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:700;display:flex;flex-direction:column;overflow:hidden";function R(){var ke,qe,Ce,Re,Fe,Oe;const Y=_[$],ie=z[S],ae=Math.min(130,Math.round((window.innerWidth-90)/2)),fe=Math.round(ae*1.35),me=De=>`background:rgba(255,255,255,0.12);border:none;color:${De?"rgba(255,255,255,0.2)":"#fff"};width:40px;height:40px;border-radius:50%;font-size:20px;cursor:${De?"default":"pointer"};flex-shrink:0`;F.innerHTML=`
      <div style="display:flex;align-items:center;padding:12px 16px;background:rgba(0,0,0,0.5);flex-shrink:0">
      ...
      </div>`,document.body.appendChild(x),(h=x.querySelector("#pvp-hist-close"))==null||h.addEventListener("click",()=>x.remove())}async function Z(){if(p.phase!==o+"-attack")return;const u=o==="p1"?"p2":"p1",x=(p.round||0)+1,y=[...p.log||[]];y.push({type:"info",text:`⏭️ ${p[o+"Name"]||"Vous"} passe (aucun attaquant disponible)`});const h=ze(p),v=be(u),_=h||!v?"finished":u+"-attack";await de({["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},pendingAttack:null,phase:_,attacker:u,round:x,log:y}),_==="finished"&&await B(p)}async function V(){const u=p[o+"Team"],x=!["GK","DEF","MIL","ATT"].some(_=>(p[m+"Team"][_]||[]).some(z=>!z.used)),y=(p["selected_"+o]||[]).map(_=>{const z=(u[_._role]||[]).find(R=>R.cardId===_.cardId)||_,$=x&&["GK","DEF"].includes(_._role),T=u[_._role]||[],S=T.findIndex(R=>R.cardId===_.cardId),C=lt(T.length),F=S>=0?C[S]:z._col??1;return{...z,_line:_._role,_col:F,...$?{note_a:Math.max(1,Number(z.note_a)||0)}:{}}});if(!y.length)return;const h=Nt(y,p.modifiers[o]||{});re(o,y.map(_=>_.cardId)),y.forEach(_=>{const z=(u[_._role]||[]).find($=>$.cardId===_.cardId);z&&(z.used=!0)}),p["selected_"+o]=[],ye();const v=[...p.log||[]];if(x){const _=(p[o+"Score"]||0)+1,z=y.map(F=>({name:F.name,note:je(F,F._line||"ATT"),portrait:Pe(F),job:F.job}));v.push({type:"duel",isGoal:!0,homeScored:!0,text:"⚽ BUT ! L'adversaire n'a plus de joueurs.",homePlayers:z,homeTotal:h.total,aiTotal:0});const $=(p.round||0)+1,T=o==="p1"?"p2":"p1",S={...p,[o+"Team"]:u,[o+"Score"]:_},C=ze(S);G.add($),we(z,_,p[m+"Score"]||0,!0,async()=>{await de({[o+"Team"]:u,[o+"Score"]:_,["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},pendingAttack:null,phase:C?"finished":T+"-attack",attacker:T,round:$,log:v}),C&&await B({...p,[o+"Score"]:_})});return}v.push({type:"pending",text:`⚔️ ${p[o+"Name"]} attaque (${h.total})`}),await de({[o+"Team"]:u,[m+"Team"]:p[m+"Team"],pendingAttack:{...h,players:y,side:o},["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},phase:m+"-defense",log:v})}async function se(){const u=p[o+"Team"],x=(p["selected_"+o]||[]).map(Y=>{const ie=(u[Y._role]||[]).find(ke=>ke.cardId===Y.cardId)||Y,ae=u[Y._role]||[],fe=ae.findIndex(ke=>ke.cardId===Y.cardId),me=lt(ae.length),$e=fe>=0?me[fe]:ie._col??1;return{...ie,_line:Y._role,_col:$e}}),y=Rt(x,p.modifiers[o]||{});re(o,x.map(Y=>Y.cardId)),x.forEach(Y=>{const ie=(u[Y._role]||[]).find(ae=>ae.cardId===Y.cardId);ie&&(ie.used=!0)}),p["selected_"+o]=[],ye();const h=Ot(p.pendingAttack.total,y.total,p.modifiers[o]||{}),v=p.pendingAttack.side,_=h==="attack"||(h==null?void 0:h.goal),z=v==="p1"?"p2":"p1",$=(p.round||0)+1,T=(p.pendingAttack.players||[]).map(Y=>({name:Y.name,note:je(Y,Y._line||"ATT"),portrait:Pe(Y),job:Y.job})),S=[...p.log||[]];S.push({type:"duel",isGoal:_,homeScored:_&&v===o,text:_?`⚽ BUT de ${p[v+"Name"]} ! (${p.pendingAttack.total} vs ${y.total})`:`✋ Attaque stoppée (${p.pendingAttack.total} vs ${y.total})`,homePlayers:T,aiPlayers:x.map(Y=>({name:Y.name,note:je(Y,Y._line||"DEF"),portrait:Pe(Y),job:Y.job})),homeTotal:p.pendingAttack.total,aiTotal:y.total});const C=_?(p[v+"Score"]||0)+1:p[v+"Score"]||0,F={...p,[o+"Team"]:u,[v+"Score"]:C},R=ze(F),O=R?"finished":z+"-attack",Q=async()=>{await de({[o+"Team"]:u,[m+"Team"]:p[m+"Team"],[v+"Score"]:C,["selected_"+o]:[],modifiers:{...p.modifiers,[o]:{}},pendingAttack:null,phase:O,attacker:z,round:$,log:S}),(O==="finished"||R)&&await B({...p,[v+"Score"]:C})};if(_){const Y=v===o,ie=Y?C:p[o+"Score"]||0,ae=Y?p[m+"Score"]||0:C;G.add($),we(T,ie,ae,Y,Q)}else await Q()}function he(u){return["MIL","ATT"].some(x=>(u[x]||[]).some(y=>!y.used))}function Se(u){return["GK","DEF","MIL","ATT"].some(x=>(u[x]||[]).some(y=>!y.used))}function Me(u){return Se(u)&&!he(u)}function be(u){const x=p[u+"Team"],y=p[(u==="p1"?"p2":"p1")+"Team"];return!!(he(x)||!Se(y)&&Me(x))}function ze(u){const x=["MIL","ATT"].some(S=>(u.p1Team[S]||[]).some(C=>!C.used)),y=["MIL","ATT"].some(S=>(u.p2Team[S]||[]).some(C=>!C.used)),h=Se(u.p1Team),v=Se(u.p2Team);return!x&&!(!v&&h)&&(!y&&!(!h&&v))}function j(u){const x=u.p1Score||0,y=u.p2Score||0;return x===y?null:x>y?A.home_id:A.away_id}async function B(u){try{const x=j(u),y=x?A.home_id===x?A.away_id:A.home_id:null,h=u.p1Score||0,v=u.p2Score||0;await k.from("matches").update({status:"finished",winner_id:x,home_score:h,away_score:v}).eq("id",i);const{data:_}=await k.from("mini_league_matches").select("id, league_id, matchday").eq("match_id",i).single();if(_){await k.from("mini_league_matches").update({home_score:h,away_score:v,status:"finished"}).eq("id",_.id);const{data:z}=await k.from("mini_league_matches").select("id, status").eq("league_id",_.league_id).eq("matchday",_.matchday);if((z||[]).every(T=>T.status==="finished"||T.status==="bye")){const{data:T}=await k.from("mini_leagues").select("current_day,total_days").eq("id",_.league_id).single();if(T){const S=(T.current_day||0)+1,C=S>(T.total_days||0);await k.from("mini_leagues").update({current_day:C?T.total_days:S,status:C?"finished":"active"}).eq("id",_.league_id)}}}x&&y&&ki(x,y).catch(()=>{})}catch(x){console.error("[ML] finishMatch:",x)}}function w(){var v;if(I&&document.getElementById("pvp-end-overlay"))return;I=!0;const u=p[o+"Score"],x=p[m+"Score"],y=u>x,h=u===x;et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
    ...
    </div>`,(v=document.getElementById("pvp-home"))==null||v.addEventListener("click",()=>{try{k.removeChannel(oe)}catch{}We(e),c("mini-league",n?{openLeagueId:n}:{})})}ye()}const rr="/",ar=[{emoji:"⚽",title:"Bienvenue dans Manager Wars !",color:"#1A6B3C",content:`<p>Tu es désormais un <strong>manager de football</strong> virtuel.</p>
  ...
  <div style="height:100%;overflow-y:auto;background:var(--page-bg)">
  ...
  </div>`;let f="buy";const n=()=>{var r,p,I,L,q,H,D;return{name:(((r=document.getElementById("flt-name"))==null?void 0:r.value)||"").toLowerCase().trim(),club:(((p=document.getElementById("flt-club"))==null?void 0:p.value)||"").toLowerCase().trim(),country:(((I=document.getElementById("flt-country"))==null?void 0:I.value)||"").toLowerCase().trim(),job:((L=document.getElementById("flt-job"))==null?void 0:L.value)||"",rarity:((q=document.getElementById("flt-rarity"))==null?void 0:q.value)||"",note1:parseInt((H=document.getElementById("flt-note1"))==null?void 0:H.value)||0,note2:parseInt((D=document.getElementById("flt-note2"))==null?void 0:D.value)||0}};function o(r){const p=n();return r.filter(I=>{var U,oe;const L=(U=I.card)==null?void 0:U.player;if(!L)return!1;const q=`${L.firstname} ${L.surname_encoded}`.toLowerCase(),H=(((oe=L.clubs)==null?void 0:oe.encoded_name)||"").toLowerCase(),D=(L.country_code||"").toLowerCase(),G=Et(L,L.job),M=L.job2?Et(L,L.job2):0;return!(p.name&&!q.includes(p.name)||p.club&&!H.includes(p.club)||p.country&&!D.includes(p.country)||p.job&&L.job!==p.job||p.rarity&&L.rarity!==p.rarity||p.note1&&G<p.note1||p.note2&&M<p.note2)})}function m(r){var D,G,M,U;const p=(D=r.card)==null?void 0:D.player;if(!p)return"";const I=((G=r.card)==null?void 0:G.evolution_bonus)||0,L=Et(p,p.job,I),q=p.job2?Et(p,p.job2,I):0,H=(i.profile.credits||0)>=r.price;return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px">
      ${Hi(p.rarity)}
      ${Wt(L,p.job)}
      ${Wt(q,p.job2||null)}
      ${Ui(p.country_code)}
    ...
    </div>`}function b(r){var D,G,M,U;const p=(D=r.card)==null?void 0:D.player;if(!p)return"";const I=((G=r.card)==null?void 0:G.evolution_bonus)||0,L=Et(p,p.job,I),q=p.job2?Et(p,p.job2,I):0,H=r.status==="sold";return`<div class="card-panel" style="display:flex;align-items:center;gap:8px;padding:10px 12px;overflow:hidden;padding-left:6px;${H?"opacity:0.7":""}">
      ${Hi(p.rarity)}
      ${Wt(L,p.job)}
      ${Wt(q,p.job2||null)}
      ${Ui(p.country_code)}
