...
import{s as T,F as ki,i as Ht,k as eo,l as nt,m as ji,f as Nt,n as Lo,T as ci,j as Io,o as Mo,b as jo}from"./formation-links-BZe0pGr4.js";const Co="/";function Ci(e,{navigate:t,toast:i}){let n="login";const d=()=>{var r,l,m,a,o,y;const s=n==="login";e.innerHTML=`
  ...
  `,document.body.appendChild(i);const n=()=>i.remove();document.getElementById("diff-cancel").addEventListener("click",n),i.addEventListener("click",d=>{d.target===i&&n()}),i.querySelectorAll("[data-mode]").forEach(d=>{d.addEventListener("click",()=>{n(),e("match",{matchMode:d.dataset.mode})})})}const Ft="/",Di={GK:Ft+"cards/card-GK.png",DEF:Ft+"cards/card-DEF.png",MIL:Ft+"cards/card-MIL.png",ATT:Ft+"cards/card-ATT.png"},Wo={GK:"#c0c0c0",DEF:"#e03030",MIL:"#D4A017",ATT:"#3fbf5f"};function Jo(e){if(!(e!=null&&e.face))return null;const t=e.face.replace(/^public\//,"").replace(/^\//,"");return Ft+t}function Xo(e){return!e||e.length<2?null:`https://flagcdn.com/64x48/${e.slice(0,2).toLowerCase()}.png`}function Zo(e){var n;const t="https://fcnwclxlkytdfjotqkta.supabase.co",i=((n=e==null?void 0:e.clubs)==null?void 0:n.logo_url)||(e==null?void 0:e.clubLogo);return i?i.startsWith("http")?i:`${t}/storage/v1/object/public/assets/clubs/${i}`:null}function Gi(e,t,i=0){return t?(Number(e[`note_${t.toLowerCase()}`])||0)+(t===e.job||t===e.job2?i:0):0}function Qo(e,t){return t?t.club_id&&String(e.club_id)===String(t.club_id)||t.country_code&&e.country_code===t.country_code:!1}function Ai(e,t={}){var pe;const{width:i=160,showStad:n=!1,stadDef:d=null,used:s=!1,extraNote:r=0}=t;if(!e)return`<div style="width:${i}px;height:${Math.round(i*657/507)}px;border-radius:8px;background:#111;opacity:0.3"></div>`;const l=i/507,m=Math.round(i*657/507),a=H=>Math.round(H*l),o=H=>a(H)+"px",y=e._line||e.job||"MIL",p=Wo[y]||"#D4A017",x=Di[y]||Di.MIL,_=e._evolution_bonus??e.evolution_bonus??0,f=n&&(e.stadiumBonus||Qo(e,d))?10:0,c=Gi(e,y,_)+r+f,z=f>0?"#E87722":p,u=e.job2&&e.job2!==y?e.job2:null,M=u?Gi(e,u,_)+r+f:null,F=Jo(e),C=Xo(e.country_code),q=Zo(e),j=(e.firstname||"").toUpperCase(),N=(e.surname_encoded||e.name||"").toUpperCase(),X=s?"opacity:0.35;":"",K=N.length>11?34:N.length>8?42:50,re=a(165),oe=a(220),Z=a(215),R=a(450),G=a(179),ne=a(150),ge=a(209),_e=a(468),we=a(110),ve=a(90),Ee=a(55),se=a(342),ce=a(8);return`<div style="position:relative;width:${i}px;height:${m}px;flex-shrink:0;${X}user-select:none">
  ...
  ${F?`<img src="${F}"
    ...
    width:${oe}px;height:${Z}px;object-fit:cover;object-position:top center;z-index:2"
    onerror="this.style.display='none'">`:""}

  <!-- Note principale : centrée dans l'octogone du template -->
  <div style="position:absolute;left:${ne}px;top:${R}px;width:${ge}px;height:${G}px;
    z-index:4;display:flex;flex-direction:column;align-items:center;justify-content:center">
    <span style="font-size:${o(72)};font-weight:900;color:${z};font-family:Arial Black,Arial;line-height:1;text-shadow:0 2px 6px rgba(0,0,0,0.9)">${c}</span>
  </div>

  <!-- Note secondaire : sous l'octogone note -->
  ${M!==null?`
  <div style="position:absolute;left:50%;transform:translateX(-50%);top:${o(580)};
    width:${o(80)};height:${o(58)};z-index:5;
    clip-path:polygon(30% 0%,70% 0%,100% 30%,100% 70%,70% 100%,30% 100%,0% 70%,0% 30%);
    background:#0a0a0a;border:${o(2)} solid #e03030;
    display:flex;align-items:center;justify-content:center">
    <span style="font-size:${o(30)};font-weight:900;color:#e03030;font-family:Arial Black,Arial;line-height:1">${M}</span>
  </div>`:""}

  <!-- Drapeau : rectangle gauche -->
  <div style="position:absolute;left:${Ee}px;top:${_e}px;width:${we}px;height:${ve}px;z-index:3;
    border-radius:${ce}px;background:${p};
    display:flex;align-items:center;justify-content:center;overflow:hidden">
    ${C?`<img src="${C}" style="width:100%;height:100%;object-fit:cover">`:`<span style="font-size:${o(22)}">🌍</span>`}
  </div>

  <!-- Logo club : rectangle droit -->
  <div style="position:absolute;left:${se}px;top:${_e}px;width:${we}px;height:${ve}px;z-index:3;
    border-radius:${ce}px;background:${p};
    display:flex;align-items:center;justify-content:center;overflow:hidden">
    ${q?`<img src="${q}" style="width:88%;height:88%;object-fit:contain">`:`<span style="font-size:${o(14)};font-weight:900;color:#fff">${(((pe=e.clubs)==null?void 0:pe.encoded_name)||e.clubName||"").slice(0,3).toUpperCase()}</span>`}
  </div>
    ...
    ${Ai(e,{width:140})}
      ...
      clubs(encoded_name, logo_url)`).eq("is_active",!0),a=(l||[]).filter(H=>H.card_type==="player"&&H.player),o=(l||[]).filter(H=>H.card_type==="game_changer"),y=(l||[]).filter(H=>H.card_type==="formation"),p=(l||[]).filter(H=>H.card_type==="stadium"),{data:x}=await T.from("gc_definitions").select("name,gc_type,color,effect,image_url"),_={};(x||[]).forEach(H=>{_[H.name]=H});const{data:f}=await T.from("stadium_definitions").select("id,name,club_id,country_code,image_url, club:clubs(encoded_name,logo_url)"),c={};(f||[]).forEach(H=>{c[H.id]=H}),p.forEach(H=>{H.stadium_def&&(c[H.stadium_id]=H.stadium_def)});const z=Object.keys(ki),u=Object.keys(He),M={};a.forEach(H=>{const ee=H.player.id;M[ee]=(M[ee]||0)+1}),new Set(Object.keys(M).map(H=>String(H)));const F=new Set(y.map(H=>H.formation)),C=new Set(o.map(H=>H.gc_type));let q="player",j="Tous",N="",X=!1;function K(){return[...a].sort((H,ee)=>{const xe=Yt.indexOf(H.player.job),de=Yt.indexOf(ee.player.job);return xe!==de?xe-de:(H.player.surname_encoded||"").localeCompare(ee.player.surname_encoded||"")})}function re(){return[...m||[]].sort((H,ee)=>{const xe=Yt.indexOf(H.job),de=Yt.indexOf(ee.job);return xe!==de?xe-de:(H.surname_encoded||"").localeCompare(ee.surname_encoded||"")})}function oe(){return K().filter(H=>{const ee=H.player,xe=j==="Tous"||ee.job===j,de=!N||`${ee.firstname} ${ee.surname_encoded}`.toLowerCase().includes(N);return xe&&de})}function Z(){return re().filter(H=>{const ee=j==="Tous"||H.job===j,xe=!N||`${H.firstname} ${H.surname_encoded}`.toLowerCase().includes(N);return ee&&xe})}e.innerHTML=`
  <div class="page" style="display:flex;flex-direction:column;height:100%;overflow:hidden">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;background:#f9f9f9;border-radius:8px;padding:8px 12px;gap:8px">
      ...
      <div style="text-align:right;flex-shrink:0">
        ...
        <div style="font-size:11px;color:var(--gray-600)">${ce}</div>
      </div>
    </div>`},R=re.length?`
    <div style="margin-top:16px;border-top:1px solid var(--gray-200);padding-top:14px">
      <div style="font-size:13px;font-weight:700;margin-bottom:10px">🏟️ Mes exemplaires ${p>1?`(${p})`:""}</div>
      <div style="display:flex;flex-direction:column;gap:10px">
        ${y.map((se,ce)=>{const pe=oe[se.id]||[],H=se.is_for_sale,ee=pe.length?pe[pe.length-1]:null,de=(o.rarity==="pepite"||o.rarity==="papyte")&&se.current_note!=null?` (☆${se.current_note})`:"";return`
            <div data-card-id="${se.id}" data-card-idx="${ce}" class="exemplaire-row"
              ...
              <div style="display:flex;align-items:center;gap:10px">
                ...
                <div style="flex:1;min-width:0">
                  <div style="font-size:12px;font-weight:700">Exemplaire ${ce+1}${de}${H?" 🏷️ En vente":""}</div>
                ...
                <button class="expl-hist-toggle" data-idx="${ce}" style="font-size:11px;color:#999;border:none;background:none;cursor:pointer;padding:2px 6px;flex-shrink:0">
                  ${pe.length?`${pe.length} club${pe.length>1?"s":""}`:""} ▾
                </button>
              </div>
              <div class="expl-hist" data-hist="${ce}" style="display:none;margin-top:8px;display:flex;flex-direction:column;gap:4px">
                ${pe.map(Z).join("")}
              </div>
            </div>`}).join("")}
      </div>
      ...
      <div style="flex:1;min-width:160px;display:flex;flex-direction:column;gap:10px">
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:6px">
            ${[["GK",o.note_g],["DEF",o.note_d],["MIL",o.note_m],["ATT",o.note_a]].map(([se,ce])=>{const pe=pi[se],H=se===o.job||se===o.job2,ee=(Number(ce)||0)+(H&&q>0?q:0);return`<div style="display:flex;flex-direction:column;align-items:center;gap:2px">
                <svg width="38" height="37" viewBox="0 0 38 37" style="display:block">
                  <polygon points="19,2 24,13 36,13 26,21 30,33 19,26 8,33 12,21 2,13 14,13" fill="${pe}" stroke="white" stroke-width="1.5"/>
    ...
    ${R}
`,'<button class="btn btn-ghost" id="close-detail">Fermer</button>'),(_e=document.getElementById("close-detail"))==null||_e.addEventListener("click",l);let G=new Set;const ne=()=>{const se=G.size,ce=document.getElementById("sell-action-panel");if(!ce)return;ce.style.display=se>0?"block":"none",document.getElementById("sell-selected-count").textContent=se;const pe=document.getElementById("evolve-btn");pe&&(pe.textContent=`⬆️ Évoluer ${se>1?"(+"+se+")":""}`)};document.querySelectorAll(".expl-check").forEach(se=>{se.addEventListener("change",()=>{const ce=se.dataset.id;se.checked?G.add(ce):G.delete(ce);const pe=se.closest(".exemplaire-row");pe&&(pe.style.borderColor=se.checked?"#1A6B3C":"#eee"),ne()})}),document.querySelectorAll(".exemplaire-row").forEach(se=>{se.addEventListener("click",ce=>{if(ce.target.closest("button")||ce.target.tagName==="INPUT")return;const pe=se.querySelector(".expl-check");pe&&!pe.disabled&&(pe.checked=!pe.checked,pe.dispatchEvent(new Event("change")))})}),document.querySelectorAll(".expl-hist-toggle").forEach(se=>{se.addEventListener("click",ce=>{ce.stopPropagation();const pe=document.querySelector(`.expl-hist[data-hist="${se.dataset.idx}"]`);pe&&(pe.style.display=pe.style.display==="none"?"flex":"none")})}),(we=document.getElementById("evolve-btn"))==null||we.addEventListener("click",async()=>{if(p<=1)return;const se=[...G];if(!se.length)return;if(G.has(e.id)){const me=document.createElement("div");me.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px",me.innerHTML=`
        ...
        <div style="background:#fff;border-radius:16px;padding:24px;max-width:320px;width:100%;text-align:center;box-shadow:0 16px 48px rgba(0,0,0,0.3)">
          ...
          <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:16px;font-size:13px;color:#333">
            🗑️ <strong>${ce.length}</strong> copie${ce.length>1?"s":""} sacrifiée${ce.length>1?"s":""}<br>
            📈 Note : <strong>${u+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${u+(e.evolution_bonus||0)+ce.length*pe}</strong>
            ${F&&F>0?`<br>📈 Note 2 : <strong>${F+(e.evolution_bonus||0)}</strong> → <strong style="color:#1A6B3C">${F+(e.evolution_bonus||0)+ce.length*pe}</strong>`:""}
  ...
  `,document.body.appendChild(d);let s=!1;const r=document.getElementById("pack-cut-zone"),l=document.getElementById("pack-blade");let m=!1;const a=R=>R.touches&&R.touches[0]?R.touches[0].clientX:R.clientX;function o(R){s||(m=!0,l.style.opacity="1",y(R))}function y(R){if(!m||s)return;const G=r.getBoundingClientRect(),ne=a(R)-G.left,ge=Math.max(0,Math.min(1,ne/G.width));l.style.width=ge*G.width+"px",ge>=.82&&x()}function p(){s||(m=!1,l.style.transition="width .2s ease, opacity .2s ease",l.style.width="0",l.style.opacity="0",setTimeout(()=>{s||(l.style.transition="")},220))}function x(){var G;if(s)return;s=!0,m=!1,l.style.width="100%",l.style.opacity="1",(G=document.getElementById("cut-flash"))==null||G.classList.add("cut-flash-go"),navigator.vibrate&&navigator.vibrate([30,20,50]);const R=document.getElementById("cut-hint");R&&(R.style.opacity="0"),r.classList.add("pack-cut"),setTimeout(()=>{l.style.opacity="0",document.getElementById("pack-phase").style.display="none",z(0)},620)}r.addEventListener("pointerdown",o),window.addEventListener("pointermove",y),window.addEventListener("pointerup",p),r.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchmove",y,{passive:!0}),window.addEventListener("touchend",p);let _=0,f=!1;const c=new Set;function z(R){_=R,document.getElementById("reveal-phase").style.display="flex",u(),M(R,0),N()}function u(){const R=document.getElementById("card-dots");R&&(R.innerHTML=e.map((G,ne)=>`<div class="card-dot" data-i="${ne}" style="width:8px;height:8px;border-radius:50%;background:${ne===_?"#FFD700":"rgba(255,255,255,0.3)"};transition:background .2s;cursor:pointer"></div>`).join(""),R.querySelectorAll(".card-dot").forEach(G=>G.addEventListener("click",()=>C(parseInt(G.dataset.i)))))}function M(R,G){var pe;const ne=e[R],ge=document.getElementById("card-counter"),_e=document.getElementById("card-track");ge&&(ge.textContent=`Carte ${R+1} / ${e.length}`);const we=document.getElementById("reveal-btns");we&&(we.style.display=R===e.length-1?"flex":"none");const ve=ne.card_type==="player"&&((pe=ne.player)==null?void 0:pe.rarity)==="legende",Ee=!c.has(R);c.add(R);let se=0;if(ne.card_type==="player"&&ne.player){const H=ne.player,ee=H.job||"ATT";se=Number(ee==="GK"?H.note_g:ee==="DEF"?H.note_d:ee==="MIL"?H.note_m:H.note_a)||0}const ce=H=>{_e.innerHTML=`
        ...
        </div>`;const ee=document.getElementById("current-card-wrap");G!==0?(ee.style.transition="none",ee.style.transform=`translateX(${G>0?100:-100}%)`,requestAnimationFrame(()=>{ee.style.transition="transform .28s cubic-bezier(.25,1,.5,1)",ee.style.transform="translateX(0)"})):ee.animate([{opacity:0,transform:"scale(.7)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"cubic-bezier(.34,1.56,.64,1)"}),H||ve?K():re(),u()};Ee&&se>6&&ne.card_type==="player"&&ne.player?F(ne,()=>ce(!0)):ce(!1)}function F(R,G){var se;f=!0;const ne=R.player,ge=`https://flagsapi.com/${ne.country_code}/flat/64.png`,_e=(se=ne.clubs)==null?void 0:se.logo_url,we=document.getElementById("walkout-overlay"),ve=document.getElementById("walkout-stage");if(!we||!ve){f=!1,G();return}we.style.display="flex";const Ee=()=>{const ce=ve.firstElementChild;ce&&(ce.classList.remove("wo-in"),ce.classList.add("wo-out"))};ve.innerHTML=`<img class="wo-in" src="${ge}" style="height:130px;border-radius:10px;box-shadow:0 10px 36px rgba(0,0,0,.6)" onerror="this.style.display='none'">`,navigator.vibrate&&navigator.vibrate(30),setTimeout(Ee,2e3),setTimeout(()=>{var ce;ve.innerHTML=_e?`<img class="wo-in" src="${_e}" style="max-height:160px;max-width:210px;object-fit:contain">`:`<div class="wo-in" style="font-size:34px;font-weight:900;color:#fff;text-align:center">${((ce=ne.clubs)==null?void 0:ce.encoded_name)||"CLUB"}</div>`,navigator.vibrate&&navigator.vibrate(30)},2450),setTimeout(Ee,4450),setTimeout(()=>{we.style.display="none",ve.innerHTML="",f=!1,navigator.vibrate&&navigator.vibrate([40,30,80]),G()},4900)}function C(R){if(f||R<0||R>=e.length||R===_)return;const G=R>_?1:-1;_=R,M(R,G)}function q(){C(_+1)}function j(){C(_-1)}function N(){const R=document.getElementById("card-viewport");if(!R||R._swipeBound)return;R._swipeBound=!0;let G=0,ne=0,ge=0,_e=!1;const we=pe=>pe.touches?pe.touches[0].clientX:pe.clientX,ve=pe=>pe.touches?pe.touches[0].clientY:pe.clientY,Ee=pe=>{_e=!0,G=we(pe),ne=ve(pe),ge=0},se=pe=>{if(!_e)return;ge=we(pe)-G;const H=ve(pe)-ne;if(Math.abs(ge)<Math.abs(H))return;const ee=document.getElementById("current-card-wrap");ee&&(ee.style.transition="none",ee.style.transform=`translateX(${ge*.6}px) rotate(${ge*.02}deg)`)},ce=()=>{if(!_e)return;_e=!1;const pe=document.getElementById("current-card-wrap"),H=55;ge<=-H&&_<e.length-1?q():ge>=H&&_>0?j():pe&&(pe.style.transition="transform .2s ease",pe.style.transform="translateX(0)")};R.addEventListener("pointerdown",Ee),R.addEventListener("pointermove",se),R.addEventListener("pointerup",ce),R.addEventListener("pointercancel",ce),R.addEventListener("touchstart",Ee,{passive:!0}),R.addEventListener("touchmove",se,{passive:!0}),R.addEventListener("touchend",ce),R.addEventListener("click",pe=>{if(Math.abs(ge)>8)return;const H=R.getBoundingClientRect();pe.clientX-H.left>H.width/2?q():j()})}let X=null;function K(){const R=document.getElementById("fireworks-canvas");if(!R)return;R.width=window.innerWidth,R.height=window.innerHeight;const G=R.getContext("2d"),ne=[];function ge(){const we=Math.random()*R.width,ve=Math.random()*R.height*.6,Ee=["#7a28b8","#ff4081","#D4A017","#00e676","#fff","#e040fb","#40c4ff"],se=Ee[Math.floor(Math.random()*Ee.length)];for(let ce=0;ce<60;ce++){const pe=Math.PI*2/60*ce,H=2+Math.random()*5;ne.push({x:we,y:ve,vx:Math.cos(pe)*H,vy:Math.sin(pe)*H,alpha:1,color:se,size:2+Math.random()*3})}}ge(),X=setInterval(ge,600);function _e(){if(document.getElementById("fireworks-canvas")){G.clearRect(0,0,R.width,R.height);for(let we=ne.length-1;we>=0;we--){const ve=ne[we];if(ve.x+=ve.vx,ve.y+=ve.vy+.08,ve.vy*=.98,ve.alpha-=.018,ve.alpha<=0){ne.splice(we,1);continue}G.globalAlpha=ve.alpha,G.fillStyle=ve.color,G.beginPath(),G.arc(ve.x,ve.y,ve.size,0,Math.PI*2),G.fill()}G.globalAlpha=1,(X!==null||ne.length>0)&&requestAnimationFrame(_e)}}_e()}function re(){X!==null&&(clearInterval(X),X=null);const R=document.getElementById("fireworks-canvas");R&&R.getContext("2d").clearRect(0,0,R.width,R.height)}if(n){const R=document.getElementById("reveal-btns");R&&(R.innerHTML='<button class="btn btn-primary" id="reveal-next" style="flex:1">Continuer →</button>'),(Z=document.getElementById("reveal-next"))==null||Z.addEventListener("click",()=>{re(),d.remove(),n()})}else document.getElementById("reveal-collection").addEventListener("click",()=>{re(),d.remove(),i("collection")}),document.getElementById("reveal-more").addEventListener("click",()=>{re(),d.remove(),i("boosters")})}function zn(e){var t,i,n,d;if(e.card_type==="player"&&e.player)return kn(e);if(e.card_type==="game_changer"){const s=e._gcDef,r=(s==null?void 0:s.gc_type)==="ultra_game_changer",l={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"},m={purple:"#b06ce0",light_blue:"#00d4ef"},a=l[s==null?void 0:s.color]||l.purple,o=m[s==null?void 0:s.color]||m.purple,y=(s==null?void 0:s.name)||e.gc_type||"Game Changer",p=(s==null?void 0:s.effect)||((t=bi[e.gc_type])==null?void 0:t.desc)||"",x=s!=null&&s.image_url?`/icons/${s.image_url}`:null,_=((i=bi[e.gc_type])==null?void 0:i.icon)||"⚡";return`<div style="width:170px;height:240px;background:${a};border-radius:14px;border:3px solid ${o};display:flex;flex-direction:column;overflow:hidden;box-shadow:0 0 24px ${o}88;flex-shrink:0">
  ...
  <div class="match-screen" style="position:fixed;top:0;left:0;right:0;bottom:auto;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#0a3d1e;width:100%">
    ...
    ${(()=>{const G=window.innerWidth>=700,ne=(H,ee,xe)=>{var B,$;const de=(t.gcDefs||[]).find(g=>g.name===H.gc_type),me={purple:"linear-gradient(160deg,#4a0a8a,#7a28b8)",light_blue:"linear-gradient(160deg,#006080,#00bcd4)"}[de==null?void 0:de.color]||"linear-gradient(160deg,#4a0a8a,#7a28b8)",ie={purple:"#b06ce0",light_blue:"#00d4ef"}[de==null?void 0:de.color]||"#b06ce0",ue=(de==null?void 0:de.name)||H.gc_type,Le=(de==null?void 0:de.effect)||((B=He[H.gc_type])==null?void 0:B.desc)||"",Ie=de!=null&&de.image_url?`/icons/${de.image_url}`:null,Ce=(($=He[H.gc_type])==null?void 0:$.icon)||"⚡",Ae=Math.round(xe*.22),qe=Math.round(xe*.22),Ge=xe-Ae-qe,Se=ue.length>12?7:9;return`<div class="gc-mini" data-gc-id="${H.id}" data-gc-type="${H.gc_type}"
  ...
  <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:8px;animation:scoreIn 0.3s ease 1.4s both;position:relative;z-index:1">Appuyer pour continuer</div>`,document.body.appendChild(s);let l=!1;const m=()=>{l||(l=!0,s.remove(),setTimeout(()=>d(),50))};s.addEventListener("click",m),setTimeout(m,3500)}async function Gt(e,t,i){var o,y;t._timerInt&&(clearInterval(t._timerInt),t._timerInt=null),t.phase="finished";const{state:n}=i,d=t.homeScore>t.aiScore,s=t.homeScore===t.aiScore,r=d?"victoire":s?"nul":"defaite",l=en(t.mode,r);t.matchId&&await T.from("matches").update({status:"finished",home_score:t.homeScore,away_score:t.aiScore,winner_id:d?n.profile.id:null,home_credits_reward:l,played_at:new Date().toISOString()}).eq("id",t.matchId);const m={credits:(n.profile.credits||0)+l,matches_played:(n.profile.matches_played||0)+1};d?m.wins=(n.profile.wins||0)+1:s?m.draws=(n.profile.draws||0)+1:m.losses=(n.profile.losses||0)+1,await T.from("users").update(m).eq("id",n.profile.id),await i.refreshProfile();const a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.88);display:flex;align-items:center;justify-content:center;z-index:2000",a.innerHTML=`
    ...
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:18px;padding:24px;background:#0a3d1e;text-align:center">
      ...
      </div>`}function ye(le,J){return`<div id="pvp-boost-card"
        style="box-sizing:border-box;width:${le}px;height:${J}px;background:linear-gradient(135deg,#4a9fc4,#87CEEB);border:2px solid #87CEEB;border-radius:10px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Math.round(J*.04)}px;text-align:center;flex-shrink:0">
      ...
      <div class="terrain-wrapper" style="overflow:hidden;width:100%;flex:1;min-height:0;display:flex;align-items:center;justify-content:center">
        ${ct(B,f[a+"Formation"],ze,E,300,300,Q)}
    ...
    </div>`;function Ue(le){if(le.type==="duel"&&(le.homeTotal!=null||le.aiTotal!=null)){const J=(le.homeTotal||0)>=(le.aiTotal||0);return`<div style="background:rgba(255,255,255,0.05);border-radius:8px;padding:5px 6px;border:1px solid rgba(255,255,255,0.08)">
          ...
          <div style="display:flex;align-items:center;gap:3px;max-height:46px;overflow:hidden">
            ...
            <div style="text-align:center;padding:0 6px;flex-shrink:0">
              <div style="font-size:${J?20:14}px;font-weight:900;color:${J?"#FFD700":"rgba(255,255,255,0.4)"};line-height:1">${le.homeTotal}</div>
              <div style="font-size:8px;color:rgba(255,255,255,0.3);margin:1px 0">VS</div>
              <div style="font-size:${J?14:20}px;font-weight:900;color:${J?"rgba(255,255,255,0.4)":"#ff6b6b"};line-height:1">${le.aiTotal}</div>
            </div>
            <div style="flex:1;display:flex;gap:2px;justify-content:flex-start;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden">
      ...
      </div>`;function Oe(){const le=e.querySelector(".match-screen");if(!le)return;const J=Math.round(window.visualViewport&&window.visualViewport.height||window.innerHeight);le.style.height=J+"px",le.style.minHeight=J+"px",le.style.maxHeight=J+"px",le.style.overflow="hidden";const O=e.querySelector("#mobile-action-bar"),ae=e.querySelector("#mobile-play-area");O&&ae&&(ae.style.paddingBottom=O.offsetHeight+"px")}if(Oe(),setTimeout(Oe,120),setTimeout(Oe,400),F||(F=!0,window.visualViewport&&(window.visualViewport.addEventListener("resize",Oe),window.visualViewport.addEventListener("scroll",Oe)),window.addEventListener("resize",Oe)),function(){const J=e.querySelector(".terrain-wrapper svg");J&&(J.removeAttribute("width"),J.removeAttribute("height"),J.style.cssText="width:100%;height:100%;display:block;max-width:none;margin:0",J.setAttribute("viewBox","-26 -26 352 352"),J.setAttribute("preserveAspectRatio","xMidYMid meet"))}(),e.querySelectorAll(".match-slot-hit").forEach(le=>{le.addEventListener("click",()=>{if(!w&&!k)return;const J=le.dataset.cardId,O=le.dataset.role,ae=(B[O]||[]).find(Qe=>Qe.cardId===J);if(!ae||ae.used)return;const he=Q.includes(J);if(w&&!["MIL","ATT"].includes(O)&&!he)return;Array.isArray(f["selected_"+a])||(f["selected_"+a]=[]);const $e=f["selected_"+a],Ze=$e.findIndex(Qe=>Qe.cardId===J);Ze>-1?$e.splice(Ze,1):$e.length<3&&$e.push({...ae,_role:O}),ne()})}),e.querySelectorAll(".match-used-hit").forEach(le=>{le.addEventListener("click",()=>pe(le.dataset.cardId))}),e.querySelectorAll(".pvp-sub-btn").forEach(le=>{le.addEventListener("click",()=>pe())}),(Pe=e.querySelector("#pvp-sub-open"))==null||Pe.addEventListener("click",()=>pe()),e.querySelectorAll(".pvp-gc-mini").forEach(le=>{le.addEventListener("click",()=>se(le.dataset.gcId,le.dataset.gcType))}),(We=e.querySelector("#pvp-boost-card"))==null||We.addEventListener("click",()=>ce()),(ot=e.querySelector("#pvp-action"))==null||ot.addEventListener("click",le=>{w?le.currentTarget.dataset.pass==="1"||!Ce(a)?de():me():k&&ie()}),(pt=e.querySelector("#pvp-quit"))==null||pt.addEventListener("click",()=>{confirm("Quitter ? Vous perdrez par forfait.")&&K()}),(ut=e.querySelector("#pvp-view-opp"))==null||ut.addEventListener("click",()=>ee()),(ft=e.querySelector("#pvp-toggle-history"))==null||ft.addEventListener("click",()=>xe()),M&&(clearInterval(M),M=null),(w||k)&&!c){let le=30,J=!1;const O=()=>document.getElementById("pvp-timer"),ae=()=>{O()&&(O().textContent=le+"s",O().style.color=J?"#ff4444":"#fff")};ae(),M=setInterval(()=>{le--,le<0?J?(clearInterval(M),M=null,w&&!Ce(a)?de():K()):(J=!0,le=15,ae()):ae()},1e3)}}function ge(){et(e),e.innerHTML=`
    <div class="match-screen" style="display:flex;flex-direction:column;align-items:center;justify-content:flex-start;height:100%;overflow:hidden;gap:12px;padding:12px 16px;background:#0a3d1e;overflow-y:auto">
      <div style="font-size:11px;color:rgba(255,255,255,0.5);letter-spacing:3px;text-transform:uppercase;margin-top:8px">Équipe adverse</div>
