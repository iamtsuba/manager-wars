...
export function renderPlayerCard(p, opts = {}) {
  ...
  ${stadB > 0 ? `<div style="position:absolute;top:${ax(22)}px;left:50%;transform:translateX(-50%);z-index:5;font-size:${px(rectH * 0.9)};line-height:1;text-align:center">🏟️</div>` : ''}
